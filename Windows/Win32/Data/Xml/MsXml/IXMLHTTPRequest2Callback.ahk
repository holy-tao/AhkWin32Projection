 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nn-msxml6-ixmlhttprequest2callback
...
class IXMLHTTPRequest2Callback extends IUnknown{
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest2callback-onredirect
     */
     ...
     * <div class="alert"><b>Note</b>  This callback function must not throw exceptions.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest2callback-onheadersavailable
     */
     ...
     * <div class="alert"><b>Note</b>  This callback function must not throw exceptions.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest2callback-ondataavailable
     */
     ...
     * <div class="alert"><b>Note</b>  This callback function must not throw exceptions.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest2callback-onresponsereceived
     */
     ...
     * <div class="alert"><b>Note</b>  This callback function must not throw exceptions.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest2callback-onerror
     */
