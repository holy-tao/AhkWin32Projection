...
class IXMLHTTPRequest extends IDispatch{
    ...
    open(bstrMethod, bstrUrl, varAsync, bstrUser, bstrPassword) {
        ...
        result := ComCall(7, this, "ptr", bstrMethod, "ptr", bstrUrl, "ptr", varAsync, "ptr", bstrUser, "ptr", bstrPassword, "int")
        if(result != 0)
    ...
    setRequestHeader(bstrHeader, bstrValue) {
        ...
        result := ComCall(8, this, "ptr", bstrHeader, "ptr", bstrValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getResponseHeader(bstrHeader, pbstrValue) {
        ...
        result := ComCall(9, this, "ptr", bstrHeader, "ptr", pbstrValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getAllResponseHeaders(pbstrHeaders) {
        result := ComCall(10, this, "ptr", pbstrHeaders, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    send(varBody) {
        result := ComCall(11, this, "ptr", varBody, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_status(plStatus) {
        result := ComCall(13, this, "int*", plStatus, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_statusText(pbstrStatus) {
        result := ComCall(14, this, "ptr", pbstrStatus, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_responseXML(ppBody) {
        result := ComCall(15, this, "ptr", ppBody, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_responseText(pbstrBody) {
        result := ComCall(16, this, "ptr", pbstrBody, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_responseBody(pvarBody) {
        result := ComCall(17, this, "ptr", pvarBody, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_responseStream(pvarBody) {
        result := ComCall(18, this, "ptr", pvarBody, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_readyState(plState) {
        result := ComCall(19, this, "int*", plState, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IDispatch>} pReadyStateSink 
     * @returns {HRESULT} 
     */
    put_onreadystatechange(pReadyStateSink) {
        result := ComCall(20, this, "ptr", pReadyStateSink, "int")
        if(result != 0)
            throw OSError(result)
