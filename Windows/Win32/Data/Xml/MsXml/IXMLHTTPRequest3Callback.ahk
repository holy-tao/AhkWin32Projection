 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nn-msxml6-ixmlhttprequest3callback
...
class IXMLHTTPRequest3Callback extends IXMLHTTPRequest2Callback{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest3callback-onservercertificatereceived
     */
    OnServerCertificateReceived(pXHR, dwCertificateErrors, cServerCertificateChain, rgServerCertificateChain) {
        result := ComCall(8, this, "ptr", pXHR, "uint", dwCertificateErrors, "uint", cServerCertificateChain, "ptr", rgServerCertificateChain, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest3callback-onclientcertificaterequested
     */
    OnClientCertificateRequested(pXHR, cIssuerList, rgpwszIssuerList) {
        rgpwszIssuerListMarshal := rgpwszIssuerList is VarRef ? "ptr*" : "ptr"

        result := ComCall(9, this, "ptr", pXHR, "uint", cIssuerList, rgpwszIssuerListMarshal, rgpwszIssuerList, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
