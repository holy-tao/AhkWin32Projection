 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nn-msxml6-ixmlhttprequest3
...
class IXMLHTTPRequest3 extends IXMLHTTPRequest2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msxml6/nf-msxml6-ixmlhttprequest3-setclientcertificate
     */
    SetClientCertificate(cbClientCertificateHash, pbClientCertificateHash, pwszPin) {
        ...
        result := ComCall(13, this, "uint", cbClientCertificateHash, pbClientCertificateHashMarshal, pbClientCertificateHash, "ptr", pwszPin, "int")
        if(result != 0) {
