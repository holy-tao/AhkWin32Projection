 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nn-infotech-iitproplist
...
class IITPropList extends IPersistStreamInit{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-set(propid_lpvoid_dword_dword)
     */
    ...
    Set1(PropID, lpvData, cbData, dwOperation) {
        ...
        result := ComCall(10, this, "uint", PropID, lpvDataMarshal, lpvData, "uint", cbData, "uint", dwOperation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<CProperty>} Property_ The property object returned.
     * @returns {HRESULT} This method can return one of these values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-get
     */
    Get(PropID, Property_) {
        result := ComCall(13, this, "uint", PropID, "ptr", Property_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-clear
     */
    Clear() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-setpersist(propid_bool)
     */
    SetPersist(fPersist) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-getfirst
     */
    GetFirst(Property_) {
        result := ComCall(17, this, "ptr", Property_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<CProperty>} Property_ 
     ...
     */
    GetNext(Property_) {
        result := ComCall(18, this, "ptr", Property_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetPropCount(cProp) {
        ...
        result := ComCall(19, this, cPropMarshal, cProp, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-saveheader
     */
    SaveHeader(lpvData, dwHdrSize) {
        lpvDataMarshal := lpvData is VarRef ? "ptr" : "ptr"

        result := ComCall(20, this, lpvDataMarshal, lpvData, "uint", dwHdrSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-savedata
     */
    SaveData(lpvHeader, dwHdrSize, lpvData, dwBufSize) {
        lpvHeaderMarshal := lpvHeader is VarRef ? "ptr" : "ptr"
        lpvDataMarshal := lpvData is VarRef ? "ptr" : "ptr"

        result := ComCall(21, this, lpvHeaderMarshal, lpvHeader, "uint", dwHdrSize, lpvDataMarshal, lpvData, "uint", dwBufSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-getheadersize
     */
    GetHeaderSize(dwHdrSize) {
        dwHdrSizeMarshal := dwHdrSize is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, dwHdrSizeMarshal, dwHdrSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/infotech/nf-infotech-iitproplist-getdatasize
     */
    GetDataSize(lpvHeader, dwHdrSize, dwDataSize) {
        lpvHeaderMarshal := lpvHeader is VarRef ? "ptr" : "ptr"
        dwDataSizeMarshal := dwDataSize is VarRef ? "uint*" : "ptr"

        result := ComCall(23, this, lpvHeaderMarshal, lpvHeader, "uint", dwHdrSize, dwDataSizeMarshal, dwDataSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    SaveDataToStream(lpvHeader, dwHdrSize, pStream) {
        ...
        result := ComCall(24, this, lpvHeaderMarshal, lpvHeader, "uint", dwHdrSize, "ptr", pStream, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    LoadFromMem(lpvData, dwBufSize) {
        ...
        result := ComCall(25, this, lpvDataMarshal, lpvData, "uint", dwBufSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    SaveToMem(lpvData, dwBufSize) {
        ...
        result := ComCall(26, this, lpvDataMarshal, lpvData, "uint", dwBufSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
