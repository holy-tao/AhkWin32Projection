 ...
 */
export default struct IStemmerConfig extends IUnknown {
    /**
     ...
     * used for IStemmerConfig interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        ...
        LoadExternalStemmerData : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IStemmerConfig.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.LoadExternalStemmerData)
    }
}
