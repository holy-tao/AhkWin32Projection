 ...
 */
export default struct IEnumOpenServiceActivity extends IUnknown {
    /**
     ...
     * used for IEnumOpenServiceActivity interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumOpenServiceActivity.Vtbl()
        }
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IOpenServiceActivity.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
    ...
    Query(iid) {
        if (IEnumOpenServiceActivity.IID.Equals(iid)) {
            return true
        }
