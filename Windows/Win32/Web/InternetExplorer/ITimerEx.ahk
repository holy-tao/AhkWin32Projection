 ...
 */
export default struct ITimerEx extends ITimer {
    /**
     ...
     * used for ITimerEx interfaces
    */
    struct Vtbl extends ITimer.Vtbl {
        SetMode : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ITimerEx.Vtbl()
        }
