...
export default struct IUrlHistoryStg extends IUnknown {
    ...
    */
    ...
    AddUrl(pocsUrl, pocsTitle, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pocsUrl, "ptr", pocsTitle, UInt32, dwFlags, "HRESULT")
        return result
    }
    ...
    DeleteUrl(pocsUrl, dwFlags) {
        ...
        result := ComCall(4, this, "ptr", pocsUrl, UInt32, dwFlags, "HRESULT")
        return result
    }
    ...
    QueryUrl(pocsUrl, dwFlags, lpSTATURL) {
        ...
        result := ComCall(5, this, "ptr", pocsUrl, UInt32, dwFlags, STATURL.Ptr, lpSTATURL, "HRESULT")
        return result
    }
