...
class ICanvasRenderingContext2D extends IDispatch{
    ...
    createLinearGradient(x0, y0, x1, y1, ppCanvasGradient) {
        result := ComCall(23, this, "float", x0, "float", y0, "float", x1, "float", y1, "ptr", ppCanvasGradient, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createRadialGradient(x0, y0, r0, x1, y1, r1, ppCanvasGradient) {
        result := ComCall(24, this, "float", x0, "float", y0, "float", r0, "float", x1, "float", y1, "float", r1, "ptr", ppCanvasGradient, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_lineWidth(p) {
        result := ComCall(31, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_miterLimit(p) {
        result := ComCall(33, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_shadowBlur(p) {
        result := ComCall(35, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_shadowOffsetX(p) {
        result := ComCall(39, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_shadowOffsetY(p) {
        result := ComCall(41, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    isPointInPath(x, y, pResult) {
        result := ComCall(57, this, "float", x, "float", y, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    measureText(text, ppCanvasTextMetrics) {
        ...
        result := ComCall(65, this, "ptr", text, "ptr", ppCanvasTextMetrics, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createImageData(a1, a2, ppCanvasImageData) {
        result := ComCall(68, this, "ptr", a1, "ptr", a2, "ptr", ppCanvasImageData, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getImageData(sx, sy, sw, sh, ppCanvasImageData) {
        result := ComCall(69, this, "float", sx, "float", sy, "float", sw, "float", sh, "ptr", ppCanvasImageData, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ICanvasImageData>} imagedata 
     * @param {Float} dx 
     * @param {Float} dy 
