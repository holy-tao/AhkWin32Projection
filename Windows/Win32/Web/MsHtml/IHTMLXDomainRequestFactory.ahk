...
#Import ".\IHTMLXDomainRequest.ahk" { IHTMLXDomainRequest }

/**
 * @namespace Windows.Win32.Web.MsHtml
 */
export default struct IHTMLXDomainRequestFactory extends IDispatch {
    /**
     ...
     * used for IHTMLXDomainRequestFactory interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLXDomainRequestFactory.Vtbl()
        }
