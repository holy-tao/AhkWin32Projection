 ...
 */
export default struct IHTMLTableSection3 extends IDispatch {
    /**
     * The interface identifier for IHTMLTableSection3
     * @type {Guid}
     */
    static IID := Guid("{3050f82b-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLTableSection3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLTableSection3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLTableSection3.IID.Equals(iid)) {
            return true
        }
