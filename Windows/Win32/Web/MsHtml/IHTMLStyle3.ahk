 ...
 */
export default struct IHTMLStyle3 extends IDispatch {
    /**
     * The interface identifier for IHTMLStyle3
     * @type {Guid}
     */
    static IID := Guid("{3050f656-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLStyle3 interfaces
    */
