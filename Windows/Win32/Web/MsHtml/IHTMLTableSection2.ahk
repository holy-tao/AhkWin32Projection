 ...
 */
export default struct IHTMLTableSection2 extends IDispatch {
    /**
     ...
     * used for IHTMLTableSection2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLTableSection2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLTableSection2.IID.Equals(iid)) {
            return true
        }
