 ...
 */
export default struct IHTMLDListElement extends IDispatch {
    /**
     * The interface identifier for IHTMLDListElement
     * @type {Guid}
     */
    static IID := Guid("{3050f1f1-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for HTMLDListElement
     * @type {Guid}
     */
    static CLSID := Guid("{3050f27d-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLDListElement interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLDListElement.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLDListElement.IID.Equals(iid)) {
            return true
        }
