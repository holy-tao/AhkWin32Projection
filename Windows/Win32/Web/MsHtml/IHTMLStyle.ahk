...
class IHTMLStyle extends IDispatch{
    ...
    put_textDecorationNone(v) {
        result := ComCall(43, this, "short", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_textDecorationNone() {
        result := ComCall(44, this, "short*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    put_textDecorationBlink(v) {
        result := ComCall(51, this, "short", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_textDecorationBlink() {
        result := ComCall(52, this, "short*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_pixelTop(v) {
        result := ComCall(160, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_pixelTop() {
        result := ComCall(161, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_pixelLeft(v) {
        result := ComCall(162, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_pixelLeft() {
        result := ComCall(163, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_pixelWidth(v) {
        result := ComCall(164, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_pixelWidth() {
        result := ComCall(165, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_pixelHeight(v) {
        result := ComCall(166, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_pixelHeight() {
        result := ComCall(167, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_posTop(v) {
        result := ComCall(168, this, "float", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_posTop() {
        result := ComCall(169, this, "float*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_posLeft(v) {
        result := ComCall(170, this, "float", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_posLeft() {
        result := ComCall(171, this, "float*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_posWidth(v) {
        result := ComCall(172, this, "float", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_posWidth() {
        result := ComCall(173, this, "float*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_posHeight(v) {
        result := ComCall(174, this, "float", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_posHeight() {
        result := ComCall(175, this, "float*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    setAttribute(strAttributeName, AttributeValue, lFlags) {
        ...
        result := ComCall(182, this, "ptr", strAttributeName, "ptr", AttributeValue, "int", lFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    getAttribute(strAttributeName, lFlags) {
        ...
        result := ComCall(183, this, "ptr", strAttributeName, "int", lFlags, "ptr", AttributeValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    removeAttribute(strAttributeName, lFlags) {
        ...
        result := ComCall(184, this, "ptr", strAttributeName, "int", lFlags, "short*", &pfSuccess := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    toString() {
        String_ := BSTR()
        result := ComCall(185, this, "ptr", String_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
