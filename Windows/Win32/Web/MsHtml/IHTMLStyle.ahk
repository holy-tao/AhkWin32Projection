...
class IHTMLStyle extends IDispatch{
     ...
     */
    get_pixelTop(p) {
        result := ComCall(161, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pixelLeft(p) {
        result := ComCall(163, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pixelWidth(p) {
        result := ComCall(165, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pixelHeight(p) {
        result := ComCall(167, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_posTop(p) {
        result := ComCall(169, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_posLeft(p) {
        result := ComCall(171, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_posWidth(p) {
        result := ComCall(173, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_posHeight(p) {
        result := ComCall(175, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    removeAttribute(strAttributeName, lFlags, pfSuccess) {
        ...
        result := ComCall(184, this, "ptr", strAttributeName, "int", lFlags, "ptr", pfSuccess, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    toString(String) {
        result := ComCall(185, this, "ptr", String, "int")
        if(result != 0)
            throw OSError(result)
