 ...
 */
export default struct IHTMLAnchorElement3 extends IDispatch {
    /**
     ...
     * used for IHTMLAnchorElement3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLAnchorElement3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLAnchorElement3.IID.Equals(iid)) {
            return true
        }
