 ...
 */
export default struct IHTMLChangeSink extends IUnknown {
    /**
     ...
     * used for IHTMLChangeSink interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLChangeSink.Vtbl()
        }
    ...
    _Query(iid) {
        if (IHTMLChangeSink.IID.Equals(iid)) {
            return true
        }
