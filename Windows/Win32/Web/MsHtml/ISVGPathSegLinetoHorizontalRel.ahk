 ...
 */
export default struct ISVGPathSegLinetoHorizontalRel extends IDispatch {
    /**
     ...
     * used for ISVGPathSegLinetoHorizontalRel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegLinetoHorizontalRel.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegLinetoHorizontalRel.IID.Equals(iid)) {
            return true
        }
