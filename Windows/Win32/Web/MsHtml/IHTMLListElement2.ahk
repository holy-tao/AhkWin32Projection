 ...
 */
export default struct IHTMLListElement2 extends IDispatch {
    /**
     ...
     * used for IHTMLListElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLListElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLListElement2.IID.Equals(iid)) {
            return true
        }
