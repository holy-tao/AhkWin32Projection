...
class IHTMLRuleStyle extends IDispatch{
    ...
    setAttribute(strAttributeName, AttributeValue, lFlags) {
        ...
        result := ComCall(166, this, "ptr", strAttributeName, "ptr", AttributeValue, "int", lFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    getAttribute(strAttributeName, lFlags) {
        ...
        result := ComCall(167, this, "ptr", strAttributeName, "int", lFlags, "ptr", AttributeValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    removeAttribute(strAttributeName, lFlags) {
        ...
        result := ComCall(168, this, "ptr", strAttributeName, "int", lFlags, "short*", &pfSuccess := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
