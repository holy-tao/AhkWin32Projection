...
class IHTMLDocument2 extends IHTMLDocument{
    ...
    open(url, name, features, replace, pomWindowResult) {
        ...
        result := ComCall(61, this, "ptr", url, "ptr", name, "ptr", features, "ptr", replace, "ptr", pomWindowResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandSupported(cmdID, pfRet) {
        ...
        result := ComCall(64, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandEnabled(cmdID, pfRet) {
        ...
        result := ComCall(65, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandState(cmdID, pfRet) {
        ...
        result := ComCall(66, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandIndeterm(cmdID, pfRet) {
        ...
        result := ComCall(67, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    execCommand(cmdID, showUI, value, pfRet) {
        ...
        result := ComCall(70, this, "ptr", cmdID, "short", showUI, "ptr", value, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    execCommandShowHelp(cmdID, pfRet) {
        ...
        result := ComCall(71, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createElement(eTag, newElem) {
        ...
        result := ComCall(72, this, "ptr", eTag, "ptr", newElem, "int")
        if(result != 0)
            throw OSError(result)
    ...
    elementFromPoint(x, y, elementHit) {
        result := ComCall(107, this, "int", x, "int", y, "ptr", elementHit, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    toString(String) {
        result := ComCall(114, this, "ptr", String, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createStyleSheet(bstrHref, lIndex, ppnewStyleSheet) {
        ...
        result := ComCall(115, this, "ptr", bstrHref, "int", lIndex, "ptr", ppnewStyleSheet, "int")
        if(result != 0)
            throw OSError(result)
