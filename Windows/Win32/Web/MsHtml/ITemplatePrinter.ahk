...
class ITemplatePrinter extends IDispatch{
    ...
    startDoc(bstrTitle, p) {
        ...
        result := ComCall(7, this, "ptr", bstrTitle, "ptr", p, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<IDispatch>} pElemDisp 
     * @returns {HRESULT} 
     */
    printPage(pElemDisp) {
    ...
    /**
     * 
     * @param {Pointer<IUnknown>} pMarkup 
     * @param {Pointer<VARIANT_BOOL>} p 
     * @returns {HRESULT} 
     */
    printNonNative(pMarkup, p) {
        result := ComCall(14, this, "ptr", pMarkup, "ptr", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_copies(p) {
        result := ComCall(34, this, "ushort*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pageFrom(p) {
        result := ComCall(36, this, "ushort*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pageTo(p) {
        result := ComCall(38, this, "ushort*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_marginLeft(p) {
        result := ComCall(48, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_marginRight(p) {
        result := ComCall(50, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_marginTop(p) {
        result := ComCall(52, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_marginBottom(p) {
        result := ComCall(54, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_pageHeight(p) {
        result := ComCall(56, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_unprintableTop(p) {
        result := ComCall(58, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_unprintableBottom(p) {
        result := ComCall(60, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    updatePageStatus(p) {
        result := ComCall(61, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
