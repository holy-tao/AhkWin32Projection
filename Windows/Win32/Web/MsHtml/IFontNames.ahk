 ...
 */
export default struct IFontNames extends IDispatch {
    /**
     ...
     * used for IFontNames interfaces
    */
     ...
     */
    Item(pvarIndex) {
        pbstrFontName := BSTR.Owned()
        result := ComCall(9, this, VARIANT.Ptr, pvarIndex, BSTR.Ptr, pbstrFontName, "HRESULT")
        return pbstrFontName
    }

    Query(iid) {
        if (IFontNames.IID.Equals(iid)) {
            return true
        }
