 ...
 */
export default struct IHTMLLinkElement4 extends IDispatch {
    /**
     ...
     * used for IHTMLLinkElement4 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLLinkElement4.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLLinkElement4.IID.Equals(iid)) {
            return true
        }
