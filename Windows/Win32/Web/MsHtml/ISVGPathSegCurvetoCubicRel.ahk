 ...
 */
export default struct ISVGPathSegCurvetoCubicRel extends IDispatch {
    /**
     ...
     * used for ISVGPathSegCurvetoCubicRel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegCurvetoCubicRel.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegCurvetoCubicRel.IID.Equals(iid)) {
            return true
        }
