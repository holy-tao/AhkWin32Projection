 ...
 */
export default struct IElementBehaviorCategory extends IUnknown {
    /**
     ...
     * used for IElementBehaviorCategory interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IElementBehaviorCategory.Vtbl()
        }
     ...
     */
    GetCategory() {
        result := ComCall(3, this, PWSTR.Ptr, &ppchCategory := 0, "HRESULT")
        return ppchCategory
    }
