 ...
 */
export default struct IHTMLInputElement3 extends IDispatch {
    /**
     * The interface identifier for IHTMLInputElement3
     * @type {Guid}
     */
    static IID := Guid("{30510435-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLInputElement3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLInputElement3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLInputElement3.IID.Equals(iid)) {
            return true
        }
