 ...
 */
export default struct ISVGTransformList extends IDispatch {
    /**
     ...
     * used for ISVGTransformList interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGTransformList.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGTransformList.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.consolidate)
    }
}
