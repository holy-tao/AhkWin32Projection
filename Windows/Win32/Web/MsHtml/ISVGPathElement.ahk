...
class ISVGPathElement extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<Single>} pfltResult 
     * @returns {HRESULT} 
     */
    getTotalLength(pfltResult) {
        result := ComCall(9, this, "float*", pfltResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getPointAtLength(fltdistance, ppPointResult) {
        result := ComCall(10, this, "float", fltdistance, "ptr", ppPointResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getPathSegAtLength(fltdistance, plResult) {
        result := ComCall(11, this, "float", fltdistance, "int*", plResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegClosePath(ppResult) {
        result := ComCall(12, this, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegMovetoAbs(x, y, ppResult) {
        result := ComCall(13, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegMovetoRel(x, y, ppResult) {
        result := ComCall(14, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoAbs(x, y, ppResult) {
        result := ComCall(15, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoRel(x, y, ppResult) {
        result := ComCall(16, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoCubicAbs(x, y, x1, y1, x2, y2, ppResult) {
        result := ComCall(17, this, "float", x, "float", y, "float", x1, "float", y1, "float", x2, "float", y2, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoCubicRel(x, y, x1, y1, x2, y2, ppResult) {
        result := ComCall(18, this, "float", x, "float", y, "float", x1, "float", y1, "float", x2, "float", y2, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoQuadraticAbs(x, y, x1, y1, ppResult) {
        result := ComCall(19, this, "float", x, "float", y, "float", x1, "float", y1, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoQuadraticRel(x, y, x1, y1, ppResult) {
        result := ComCall(20, this, "float", x, "float", y, "float", x1, "float", y1, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegArcAbs(x, y, r1, r2, angle, largeArcFlag, sweepFlag, ppResult) {
        result := ComCall(21, this, "float", x, "float", y, "float", r1, "float", r2, "float", angle, "short", largeArcFlag, "short", sweepFlag, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegArcRel(x, y, r1, r2, angle, largeArcFlag, sweepFlag, ppResult) {
        result := ComCall(22, this, "float", x, "float", y, "float", r1, "float", r2, "float", angle, "short", largeArcFlag, "short", sweepFlag, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoHorizontalAbs(x, ppResult) {
        result := ComCall(23, this, "float", x, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoHorizontalRel(x, ppResult) {
        result := ComCall(24, this, "float", x, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoVerticalAbs(y, ppResult) {
        result := ComCall(25, this, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegLinetoVerticalRel(y, ppResult) {
        result := ComCall(26, this, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoCubicSmoothAbs(x, y, x2, y2, ppResult) {
        result := ComCall(27, this, "float", x, "float", y, "float", x2, "float", y2, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoCubicSmoothRel(x, y, x2, y2, ppResult) {
        result := ComCall(28, this, "float", x, "float", y, "float", x2, "float", y2, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoQuadraticSmoothAbs(x, y, ppResult) {
        result := ComCall(29, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPathSegCurvetoQuadraticSmoothRel(x, y, ppResult) {
        result := ComCall(30, this, "float", x, "float", y, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
