 ...
 */
export default struct ISVGPathSegCurvetoCubicAbs extends IDispatch {
    /**
     ...
     * used for ISVGPathSegCurvetoCubicAbs interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegCurvetoCubicAbs.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegCurvetoCubicAbs.IID.Equals(iid)) {
            return true
        }
