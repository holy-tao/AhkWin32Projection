 ...
 */
export default struct ISVGPathSegCurvetoCubicSmoothAbs extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegCurvetoCubicSmoothAbs
     * @type {Guid}
     */
    static IID := Guid("{3051050c-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegCurvetoCubicSmoothAbs
     * @type {Guid}
     */
    static CLSID := Guid("{305105c0-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegCurvetoCubicSmoothAbs interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegCurvetoCubicSmoothAbs.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegCurvetoCubicSmoothAbs.IID.Equals(iid)) {
            return true
        }
