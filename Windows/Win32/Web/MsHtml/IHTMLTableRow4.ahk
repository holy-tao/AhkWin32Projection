 ...
 */
export default struct IHTMLTableRow4 extends IDispatch {
    /**
     * The interface identifier for IHTMLTableRow4
     * @type {Guid}
     */
    static IID := Guid("{305106c6-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLTableRow4 interfaces
    */
    ...
    Query(iid) {
        if (IHTMLTableRow4.IID.Equals(iid)) {
            return true
        }
