 ...
 */
export default struct IHTMLMetaElement3 extends IDispatch {
    /**
     ...
     * used for IHTMLMetaElement3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLMetaElement3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLMetaElement3.IID.Equals(iid)) {
            return true
        }
