 ...
 */
export default struct ISVGPathSegMovetoAbs extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegMovetoAbs
     * @type {Guid}
     */
    static IID := Guid("{305104fe-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegMovetoAbs
     * @type {Guid}
     */
    static CLSID := Guid("{305105cc-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegMovetoAbs interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegMovetoAbs.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegMovetoAbs.IID.Equals(iid)) {
            return true
        }
