 ...
 */
export default struct IHTMLStyleSheet3 extends IDispatch {
    /**
     ...
     * used for IHTMLStyleSheet3 interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        put_href            : IntPtr
        get_href            : IntPtr
        get_isAlternate     : IntPtr
        get_isPrefAlternate : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLStyleSheet3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLStyleSheet3.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.get_isAlternate)
        CallbackFree(this.vtbl.get_isPrefAlternate)
    }
}
