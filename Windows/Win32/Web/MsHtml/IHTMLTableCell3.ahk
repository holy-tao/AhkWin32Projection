 ...
 */
export default struct IHTMLTableCell3 extends IDispatch {
    /**
     * The interface identifier for IHTMLTableCell3
     * @type {Guid}
     */
    static IID := Guid("{305106c7-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLTableCell3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLTableCell3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLTableCell3.IID.Equals(iid)) {
            return true
        }
