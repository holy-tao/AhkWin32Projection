 ...
 */
export default struct ISVGPathSegCurvetoQuadraticAbs extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegCurvetoQuadraticAbs
     * @type {Guid}
     */
    static IID := Guid("{30510504-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegCurvetoQuadraticAbs
     * @type {Guid}
     */
    static CLSID := Guid("{305105c2-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegCurvetoQuadraticAbs interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegCurvetoQuadraticAbs.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegCurvetoQuadraticAbs.IID.Equals(iid)) {
            return true
        }
