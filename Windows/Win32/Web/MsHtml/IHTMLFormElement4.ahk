 ...
 */
export default struct IHTMLFormElement4 extends IDispatch {
    /**
     ...
     * used for IHTMLFormElement4 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLFormElement4.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLFormElement4.IID.Equals(iid)) {
            return true
        }
