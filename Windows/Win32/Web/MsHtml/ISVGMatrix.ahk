...
class ISVGMatrix extends IDispatch{
    ...
    multiply(secondMatrix) {
        result := ComCall(19, this, "ptr", secondMatrix, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    translate(x, y) {
        result := ComCall(21, this, "float", x, "float", y, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    scale(scaleFactor) {
        result := ComCall(22, this, "float", scaleFactor, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    scaleNonUniform(scaleFactorX, scaleFactorY) {
        result := ComCall(23, this, "float", scaleFactorX, "float", scaleFactorY, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    rotate(angle) {
        result := ComCall(24, this, "float", angle, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    rotateFromVector(x, y) {
        result := ComCall(25, this, "float", x, "float", y, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    flipX() {
        result := ComCall(26, this, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    flipY() {
        result := ComCall(27, this, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    skewX(angle) {
        result := ComCall(28, this, "float", angle, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    skewY(angle) {
        result := ComCall(29, this, "float", angle, "ptr*", &ppResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
