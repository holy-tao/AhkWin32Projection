 ...
 */
export default struct IHTMLBaseElement extends IDispatch {
    /**
     * The interface identifier for IHTMLBaseElement
     * @type {Guid}
     */
    static IID := Guid("{3050f204-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for HTMLBaseElement
     * @type {Guid}
     */
    static CLSID := Guid("{3050f276-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLBaseElement interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLBaseElement.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLBaseElement.IID.Equals(iid)) {
            return true
        }
