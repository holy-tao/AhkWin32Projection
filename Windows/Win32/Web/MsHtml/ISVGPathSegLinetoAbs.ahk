 ...
 */
export default struct ISVGPathSegLinetoAbs extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegLinetoAbs
     * @type {Guid}
     */
    static IID := Guid("{30510500-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegLinetoAbs
     * @type {Guid}
     */
    static CLSID := Guid("{305105c6-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegLinetoAbs interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegLinetoAbs.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegLinetoAbs.IID.Equals(iid)) {
            return true
        }
