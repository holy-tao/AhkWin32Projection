 ...
 */
export default struct IHTMLElementCollection2 extends IDispatch {
    /**
     ...
     * used for IHTMLElementCollection2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLElementCollection2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLElementCollection2.IID.Equals(iid)) {
            return true
        }
