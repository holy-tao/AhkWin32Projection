...
#Import ".\ISVGNumberList.ahk" { ISVGNumberList }

/**
 * @namespace Windows.Win32.Web.MsHtml
 */
export default struct ISVGAnimatedNumberList extends IDispatch {
    /**
     * The interface identifier for ISVGAnimatedNumberList
     * @type {Guid}
     */
    static IID := Guid("{305104ce-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGAnimatedNumberList
     * @type {Guid}
     */
    static CLSID := Guid("{3051058a-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGAnimatedNumberList interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGAnimatedNumberList.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGAnimatedNumberList.IID.Equals(iid)) {
            return true
        }
