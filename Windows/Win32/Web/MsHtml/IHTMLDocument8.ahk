...
export default struct IHTMLDocument8 extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_onmscontentzoom := CallbackCreate(ObjBindMethod(implObj, "put_onmscontentzoom"), flags, 2)
        this.vtbl.get_onmscontentzoom := CallbackCreate(ObjBindMethod(implObj, "get_onmscontentzoom"), flags, 2)
        ...
        this.vtbl.elementsFromPoint := CallbackCreate(ObjBindMethod(implObj, "elementsFromPoint"), flags, 4)
        this.vtbl.elementsFromRect := CallbackCreate(ObjBindMethod(implObj, "elementsFromRect"), flags, 6)
        ...
        this.vtbl.put_msCapsLockWarningOff := CallbackCreate(ObjBindMethod(implObj, "put_msCapsLockWarningOff"), flags, 2)
        this.vtbl.get_msCapsLockWarningOff := CallbackCreate(ObjBindMethod(implObj, "get_msCapsLockWarningOff"), flags, 2)
    }
