 ...
 */
export default struct ISVGPathSegMovetoRel extends IDispatch {
    /**
     ...
     * used for ISVGPathSegMovetoRel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegMovetoRel.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegMovetoRel.IID.Equals(iid)) {
            return true
        }
