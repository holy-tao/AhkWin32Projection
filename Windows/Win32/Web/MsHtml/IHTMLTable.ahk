...
class IHTMLTable extends IDispatch{
     ...
     */
    get_dataPageSize(p) {
        result := ComCall(38, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    createTHead(head) {
        result := ComCall(45, this, "ptr", head, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    createTFoot(foot) {
        result := ComCall(47, this, "ptr", foot, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createCaption(caption) {
        result := ComCall(49, this, "ptr", caption, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    insertRow(index, row) {
        result := ComCall(51, this, "int", index, "ptr", row, "int")
        if(result != 0)
            throw OSError(result)
