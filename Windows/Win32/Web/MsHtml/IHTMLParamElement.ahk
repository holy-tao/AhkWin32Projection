 ...
 */
export default struct IHTMLParamElement extends IDispatch {
    /**
     * The interface identifier for IHTMLParamElement
     * @type {Guid}
     */
    static IID := Guid("{3050f83d-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for HTMLParamElement
     * @type {Guid}
     */
    static CLSID := Guid("{3050f83e-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLParamElement interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLParamElement.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLParamElement.IID.Equals(iid)) {
            return true
        }
