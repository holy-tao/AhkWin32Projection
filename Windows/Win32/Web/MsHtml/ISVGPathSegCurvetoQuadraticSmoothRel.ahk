 ...
 */
export default struct ISVGPathSegCurvetoQuadraticSmoothRel extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegCurvetoQuadraticSmoothRel
     * @type {Guid}
     */
    static IID := Guid("{3051050f-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegCurvetoQuadraticSmoothRel
     * @type {Guid}
     */
    static CLSID := Guid("{305105c5-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegCurvetoQuadraticSmoothRel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegCurvetoQuadraticSmoothRel.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegCurvetoQuadraticSmoothRel.IID.Equals(iid)) {
            return true
        }
