 ...
 */
export default struct IHTMLTableRow2 extends IDispatch {
    /**
     * The interface identifier for IHTMLTableRow2
     * @type {Guid}
     */
    static IID := Guid("{3050f4a1-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLTableRow2 interfaces
    */
    ...
    Query(iid) {
        if (IHTMLTableRow2.IID.Equals(iid)) {
            return true
        }
