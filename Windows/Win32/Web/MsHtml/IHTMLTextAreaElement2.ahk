 ...
 */
export default struct IHTMLTextAreaElement2 extends IDispatch {
    /**
     ...
     * used for IHTMLTextAreaElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLTextAreaElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLTextAreaElement2.IID.Equals(iid)) {
            return true
        }
