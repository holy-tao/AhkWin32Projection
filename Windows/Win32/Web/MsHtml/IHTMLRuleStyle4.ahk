 ...
 */
export default struct IHTMLRuleStyle4 extends IDispatch {
    /**
     ...
     * used for IHTMLRuleStyle4 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLRuleStyle4.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLRuleStyle4.IID.Equals(iid)) {
            return true
        }
