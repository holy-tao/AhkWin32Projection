...
class IHTMLDocument3 extends IDispatch{
    ...
    createTextNode(text, newTextNode) {
        ...
        result := ComCall(9, this, "ptr", text, "ptr", newTextNode, "int")
        if(result != 0)
            throw OSError(result)
    ...
    attachEvent(event, pDisp, pfResult) {
        ...
        result := ComCall(12, this, "ptr", event, "ptr", pDisp, "ptr", pfResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createDocumentFragment(pNewDoc) {
        result := ComCall(34, this, "ptr", pNewDoc, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementsByName(v, pelColl) {
        ...
        result := ComCall(45, this, "ptr", v, "ptr", pelColl, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementById(v, pel) {
        ...
        result := ComCall(46, this, "ptr", v, "ptr", pel, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementsByTagName(v, pelColl) {
        ...
        result := ComCall(47, this, "ptr", v, "ptr", pelColl, "int")
        if(result != 0)
            throw OSError(result)
