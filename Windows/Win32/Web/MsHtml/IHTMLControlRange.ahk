...
class IHTMLControlRange extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<IHTMLControlElement>} item 
     * @returns {HRESULT} 
     */
    add(item) {
     ...
     */
    item(index, pdisp) {
        result := ComCall(10, this, "int", index, "ptr", pdisp, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandSupported(cmdID, pfRet) {
        ...
        result := ComCall(12, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandEnabled(cmdID, pfRet) {
        ...
        result := ComCall(13, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandState(cmdID, pfRet) {
        ...
        result := ComCall(14, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    queryCommandIndeterm(cmdID, pfRet) {
        ...
        result := ComCall(15, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    execCommand(cmdID, showUI, value, pfRet) {
        ...
        result := ComCall(18, this, "ptr", cmdID, "short", showUI, "ptr", value, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    execCommandShowHelp(cmdID, pfRet) {
        ...
        result := ComCall(19, this, "ptr", cmdID, "ptr", pfRet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    commonParentElement(parent) {
        result := ComCall(20, this, "ptr", parent, "int")
        if(result != 0)
            throw OSError(result)
