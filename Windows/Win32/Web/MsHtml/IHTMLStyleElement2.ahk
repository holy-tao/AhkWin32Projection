 ...
 */
export default struct IHTMLStyleElement2 extends IDispatch {
    /**
     ...
     * used for IHTMLStyleElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLStyleElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLStyleElement2.IID.Equals(iid)) {
            return true
        }
