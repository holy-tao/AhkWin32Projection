 ...
 */
export default struct IHTMLImgElement2 extends IDispatch {
    /**
     * The interface identifier for IHTMLImgElement2
     * @type {Guid}
     */
    static IID := Guid("{3050f826-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLImgElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLImgElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLImgElement2.IID.Equals(iid)) {
            return true
        }
