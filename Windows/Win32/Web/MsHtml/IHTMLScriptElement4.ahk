 ...
 */
export default struct IHTMLScriptElement4 extends IDispatch {
    /**
     ...
     * used for IHTMLScriptElement4 interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        get_usedCharset : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLScriptElement4.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLScriptElement4.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.get_usedCharset)
    }
}
