...
class IHTMLElement6 extends IDispatch{
    ...
    getAttributeNodeNS(pvarNS, bstrname, ppretAttribute) {
        ...
        result := ComCall(10, this, "ptr", pvarNS, "ptr", bstrname, "ptr", ppretAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    setAttributeNodeNS(pattr, ppretAttribute) {
        result := ComCall(11, this, "ptr", pattr, "ptr", ppretAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    hasAttributeNS(pvarNS, name, pfHasAttribute) {
        ...
        result := ComCall(12, this, "ptr", pvarNS, "ptr", name, "ptr", pfHasAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getAttributeNode(strAttributeName, ppretAttribute) {
        ...
        result := ComCall(16, this, "ptr", strAttributeName, "ptr", ppretAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    setAttributeNode(pattr, ppretAttribute) {
        result := ComCall(17, this, "ptr", pattr, "ptr", ppretAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    removeAttributeNode(pattr, ppretAttribute) {
        result := ComCall(18, this, "ptr", pattr, "ptr", ppretAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    hasAttribute(name, pfHasAttribute) {
        ...
        result := ComCall(19, this, "ptr", name, "ptr", pfHasAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementsByTagNameNS(varNS, bstrLocalName, pelColl) {
        ...
        result := ComCall(20, this, "ptr", varNS, "ptr", bstrLocalName, "ptr", pelColl, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementsByClassName(v, pel) {
        ...
        result := ComCall(23, this, "ptr", v, "ptr", pel, "int")
        if(result != 0)
            throw OSError(result)
    ...
    msMatchesSelector(v, pfMatches) {
        ...
        result := ComCall(24, this, "ptr", v, "ptr", pfMatches, "int")
        if(result != 0)
            throw OSError(result)
    ...
    hasAttributes(pfHasAttributes) {
        result := ComCall(81, this, "ptr", pfHasAttributes, "int")
        if(result != 0)
            throw OSError(result)
