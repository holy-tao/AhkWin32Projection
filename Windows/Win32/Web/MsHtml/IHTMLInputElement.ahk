...
class IHTMLInputElement extends IDispatch{
     ...
     */
    get_size(p) {
        result := ComCall(19, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createTextRange(range) {
        result := ComCall(31, this, "ptr", range, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_vspace(p) {
        result := ComCall(41, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_width(p) {
        result := ComCall(67, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_height(p) {
        result := ComCall(69, this, "int*", p, "int")
        if(result != 0)
            throw OSError(result)
