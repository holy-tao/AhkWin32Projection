...
class IHTMLInputElement extends IDispatch{
     ...
     */
    put_disabled(v) {
        result := ComCall(15, this, "short", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_size(v) {
        result := ComCall(18, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_maxLength(v) {
        result := ComCall(20, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    createTextRange() {
        result := ComCall(31, this, "ptr*", &range := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    put_defaultChecked(v) {
        result := ComCall(34, this, "short", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_defaultChecked() {
        result := ComCall(35, this, "short*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_complete() {
        result := ComCall(55, this, "short*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_width(v) {
        result := ComCall(66, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_width() {
        result := ComCall(67, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    put_height(v) {
        result := ComCall(68, this, "int", v, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_height() {
        result := ComCall(69, this, "int*", &p := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
