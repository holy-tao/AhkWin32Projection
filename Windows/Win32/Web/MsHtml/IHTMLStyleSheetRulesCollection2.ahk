 ...
 */
export default struct IHTMLStyleSheetRulesCollection2 extends IDispatch {
    /**
     ...
     * used for IHTMLStyleSheetRulesCollection2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLStyleSheetRulesCollection2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLStyleSheetRulesCollection2.IID.Equals(iid)) {
            return true
        }
