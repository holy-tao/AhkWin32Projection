 ...
 */
export default struct ISequenceNumber extends IUnknown {
    /**
     ...
     * used for ISequenceNumber interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISequenceNumber.Vtbl()
        }
    ...
    Query(iid) {
        if (ISequenceNumber.IID.Equals(iid)) {
            return true
        }
