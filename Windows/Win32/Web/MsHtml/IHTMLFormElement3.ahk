 ...
 */
export default struct IHTMLFormElement3 extends IDispatch {
    /**
     ...
     * used for IHTMLFormElement3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLFormElement3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLFormElement3.IID.Equals(iid)) {
            return true
        }
