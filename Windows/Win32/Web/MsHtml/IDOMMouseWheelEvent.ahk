 ...
 */
export default struct IDOMMouseWheelEvent extends IDispatch {
    /**
     ...
     * used for IDOMMouseWheelEvent interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        get_wheelDelta      : IntPtr
        initMouseWheelEvent : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDOMMouseWheelEvent.Vtbl()
        }
    ...
    initMouseWheelEvent(eventType, canBubble, cancelable, viewArg, detailArg, screenXArg, screenYArg, clientXArg, clientYArg, buttonArg, relatedTargetArg, modifiersListArg, wheelDeltaArg) {
        ...
        result := ComCall(8, this, BSTR, eventType, VARIANT_BOOL, canBubble, VARIANT_BOOL, cancelable, "ptr", viewArg, Int32, detailArg, Int32, screenXArg, Int32, screenYArg, Int32, clientXArg, Int32, clientYArg, UInt16, buttonArg, "ptr", relatedTargetArg, BSTR, modifiersListArg, Int32, wheelDeltaArg, "HRESULT")
        return result
    }

    Query(iid) {
        if (IDOMMouseWheelEvent.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.initMouseWheelEvent)
    }
}
