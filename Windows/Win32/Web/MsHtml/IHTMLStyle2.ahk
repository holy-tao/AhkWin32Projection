...
class IHTMLStyle2 extends IDispatch{
    ...
    setExpression(propname, expression, language) {
        ...
        result := ComCall(15, this, "ptr", propname, "ptr", expression, "ptr", language, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getExpression(propname, expression) {
        ...
        result := ComCall(16, this, "ptr", propname, "ptr", expression, "int")
        if(result != 0)
            throw OSError(result)
    ...
    removeExpression(propname, pfSuccess) {
        ...
        result := ComCall(17, this, "ptr", propname, "ptr", pfSuccess, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    put_pixelRight(v) {
        result := ComCall(28, this, "int", v, "int")
        if(result != 0)
            throw OSError(result)
