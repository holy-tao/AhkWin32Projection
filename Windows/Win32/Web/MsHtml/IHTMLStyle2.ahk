 ...
 */
export default struct IHTMLStyle2 extends IDispatch {
    /**
     ...
     * used for IHTMLStyle2 interfaces
    */
    ...
    setExpression(propname, expression, language) {
        ...
        result := ComCall(15, this, BSTR, propname, BSTR, expression, BSTR, language, "HRESULT")
        return result
    }
    ...
    getExpression(propname) {
        ...
        expression := VARIANT()
        result := ComCall(16, this, BSTR, propname, VARIANT.Ptr, expression, "HRESULT")
        return expression
    }
    ...
    removeExpression(propname) {
        ...
        result := ComCall(17, this, BSTR, propname, VARIANT_BOOL.Ptr, &pfSuccess := 0, "HRESULT")
        return pfSuccess
    }
    ...
    put_textJustify(v) {
        ...
        result := ComCall(56, this, BSTR, v, "HRESULT")
        return result
    }
    ...
    put_overflowX(v) {
        ...
        result := ComCall(64, this, BSTR, v, "HRESULT")
        return result
    }
