 ...
 */
export default struct ISVGException extends IDispatch {
    /**
     * The interface identifier for ISVGException
     * @type {Guid}
     */
    static IID := Guid("{3051072f-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGException
     * @type {Guid}
     */
    static CLSID := Guid("{30510730-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGException interfaces
    */
    ...
    Query(iid) {
        if (ISVGException.IID.Equals(iid)) {
            return true
        }
