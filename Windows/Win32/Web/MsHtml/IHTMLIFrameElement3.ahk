 ...
 */
export default struct IHTMLIFrameElement3 extends IDispatch {
    /**
     * The interface identifier for IHTMLIFrameElement3
     * @type {Guid}
     */
    static IID := Guid("{30510433-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLIFrameElement3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLIFrameElement3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLIFrameElement3.IID.Equals(iid)) {
            return true
        }
