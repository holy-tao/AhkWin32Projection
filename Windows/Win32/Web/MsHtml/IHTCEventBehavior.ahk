 ...
 */
export default struct IHTCEventBehavior extends IDispatch {
    /**
     ...
     * used for IHTCEventBehavior interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTCEventBehavior.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTCEventBehavior.IID.Equals(iid)) {
            return true
        }
