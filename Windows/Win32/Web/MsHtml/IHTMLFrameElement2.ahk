 ...
 */
export default struct IHTMLFrameElement2 extends IDispatch {
    /**
     * The interface identifier for IHTMLFrameElement2
     * @type {Guid}
     */
    static IID := Guid("{3050f7f5-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLFrameElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLFrameElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLFrameElement2.IID.Equals(iid)) {
            return true
        }
