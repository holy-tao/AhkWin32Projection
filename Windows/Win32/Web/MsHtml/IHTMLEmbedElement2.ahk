 ...
 */
export default struct IHTMLEmbedElement2 extends IDispatch {
    /**
     * The interface identifier for IHTMLEmbedElement2
     * @type {Guid}
     */
    static IID := Guid("{30510493-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLEmbedElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLEmbedElement2.Vtbl()
        }
