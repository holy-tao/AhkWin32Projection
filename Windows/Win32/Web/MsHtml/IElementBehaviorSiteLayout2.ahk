 ...
 */
export default struct IElementBehaviorSiteLayout2 extends IUnknown {
    /**
     ...
     * used for IElementBehaviorSiteLayout2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IElementBehaviorSiteLayout2.Vtbl()
        }
    ...
    GetFontInfo() {
        plf := LOGFONTW()
        result := ComCall(3, this, LOGFONTW.Ptr, plf, "HRESULT")
        return plf
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetFontInfo)
    }
}
