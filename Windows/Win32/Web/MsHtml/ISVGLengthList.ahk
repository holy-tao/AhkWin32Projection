 ...
 */
export default struct ISVGLengthList extends IDispatch {
    /**
     * The interface identifier for ISVGLengthList
     * @type {Guid}
     */
    static IID := Guid("{305104d1-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGLengthList
     * @type {Guid}
     */
    static CLSID := Guid("{30510580-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGLengthList interfaces
    */
    ...
    Query(iid) {
        if (ISVGLengthList.IID.Equals(iid)) {
            return true
        }
