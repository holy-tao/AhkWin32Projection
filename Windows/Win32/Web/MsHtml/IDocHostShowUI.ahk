...
class IDocHostShowUI extends IUnknown{
    ...
    ShowMessage(hwnd, lpstrText, lpstrCaption, dwType, lpstrHelpFile, dwHelpContext, plResult) {
        ...
        result := ComCall(3, this, "ptr", hwnd, "ptr", lpstrText, "ptr", lpstrCaption, "uint", dwType, "ptr", lpstrHelpFile, "uint", dwHelpContext, "ptr", plResult, "int")
        if(result != 0)
     ...
     * @param {POINT} ptMouse 
     * @param {Pointer<IDispatch>} pDispatchObjectHit 
     * @returns {HRESULT} 
     */
    ShowHelp(hwnd, pszHelpFile, uCommand, dwData, ptMouse, pDispatchObjectHit) {
        ...
        result := ComCall(4, this, "ptr", hwnd, "ptr", pszHelpFile, "uint", uCommand, "uint", dwData, "ptr", ptMouse, "ptr", pDispatchObjectHit, "int")
        if(result != 0)
            throw OSError(result)
