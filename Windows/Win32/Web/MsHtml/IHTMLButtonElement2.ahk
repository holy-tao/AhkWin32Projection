 ...
 */
export default struct IHTMLButtonElement2 extends IDispatch {
    /**
     ...
     * used for IHTMLButtonElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLButtonElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLButtonElement2.IID.Equals(iid)) {
            return true
        }
