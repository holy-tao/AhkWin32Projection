...
class IDocumentTraversal extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<IDispatch>} pRootNode 
    ...
    createNodeIterator(pRootNode, ulWhatToShow, pFilter, fEntityReferenceExpansion, ppNodeIterator) {
        result := ComCall(7, this, "ptr", pRootNode, "int", ulWhatToShow, "ptr", pFilter, "short", fEntityReferenceExpansion, "ptr", ppNodeIterator, "int")
        if(result != 0)
    ...
    createTreeWalker(pRootNode, ulWhatToShow, pFilter, fEntityReferenceExpansion, ppTreeWalker) {
        result := ComCall(8, this, "ptr", pRootNode, "int", ulWhatToShow, "ptr", pFilter, "short", fEntityReferenceExpansion, "ptr", ppTreeWalker, "int")
        if(result != 0)
            throw OSError(result)
