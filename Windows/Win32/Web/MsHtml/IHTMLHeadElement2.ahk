 ...
 */
export default struct IHTMLHeadElement2 extends IDispatch {
    /**
     * The interface identifier for IHTMLHeadElement2
     * @type {Guid}
     */
    static IID := Guid("{3051042f-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLHeadElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLHeadElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLHeadElement2.IID.Equals(iid)) {
            return true
        }
