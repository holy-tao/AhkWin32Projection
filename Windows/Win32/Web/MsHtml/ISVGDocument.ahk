 ...
 */
export default struct ISVGDocument extends IDispatch {
    /**
     ...
     * used for ISVGDocument interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        get_rootElement : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGDocument.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.get_rootElement)
    }
}
