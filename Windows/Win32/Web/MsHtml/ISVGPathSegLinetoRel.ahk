 ...
 */
export default struct ISVGPathSegLinetoRel extends IDispatch {
    /**
     * The interface identifier for ISVGPathSegLinetoRel
     * @type {Guid}
     */
    static IID := Guid("{30510501-98b5-11cf-bb82-00aa00bdce0b}")

    /**
     * The class identifier for SVGPathSegLinetoRel
     * @type {Guid}
     */
    static CLSID := Guid("{305105c9-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for ISVGPathSegLinetoRel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGPathSegLinetoRel.Vtbl()
        }
    ...
    Query(iid) {
        if (ISVGPathSegLinetoRel.IID.Equals(iid)) {
            return true
        }
