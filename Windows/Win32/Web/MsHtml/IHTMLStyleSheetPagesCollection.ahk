 ...
 */
export default struct IHTMLStyleSheetPagesCollection extends IDispatch {
    /**
     ...
     * used for IHTMLStyleSheetPagesCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLStyleSheetPagesCollection.Vtbl()
        }
