 ...
 */
export default struct IHTMLFrameBase3 extends IDispatch {
    /**
     * The interface identifier for IHTMLFrameBase3
     * @type {Guid}
     */
    static IID := Guid("{3050f82e-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLFrameBase3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLFrameBase3.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLFrameBase3.IID.Equals(iid)) {
            return true
        }
