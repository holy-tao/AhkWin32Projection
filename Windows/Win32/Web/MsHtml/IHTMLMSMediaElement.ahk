 ...
 */
export default struct IHTMLMSMediaElement extends IDispatch {
    /**
     * The interface identifier for IHTMLMSMediaElement
     * @type {Guid}
     */
    static IID := Guid("{30510792-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLMSMediaElement interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLMSMediaElement.Vtbl()
        }
