 ...
 */
export default struct IHTMLScriptElement2 extends IDispatch {
    /**
     ...
     * used for IHTMLScriptElement2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IHTMLScriptElement2.Vtbl()
        }
    ...
    Query(iid) {
        if (IHTMLScriptElement2.IID.Equals(iid)) {
            return true
        }
