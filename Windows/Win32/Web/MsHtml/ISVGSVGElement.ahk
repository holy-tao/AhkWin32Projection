...
class ISVGSVGElement extends IDispatch{
    ...
    get_pixelUnitToMillimeterX(p) {
        result := ComCall(22, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_pixelUnitToMillimeterY(p) {
        result := ComCall(24, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_screenPixelToMillimeterX(p) {
        result := ComCall(26, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_screenPixelToMillimeterY(p) {
        result := ComCall(28, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_currentScale(p) {
        result := ComCall(34, this, "float*", p, "int")
        if(result != 0)
            throw OSError(result)
    ...
    suspendRedraw(maxWaitMilliseconds, pResult) {
        result := ComCall(37, this, "uint", maxWaitMilliseconds, "uint*", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    animationsPaused(pResult) {
        result := ComCall(43, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getCurrentTime(pResult) {
        result := ComCall(44, this, "float*", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ISVGRect>} rect 
     * @param {Pointer<ISVGElement>} referenceElement 
     * @param {Pointer<VARIANT>} pResult 
     * @returns {HRESULT} 
     */
    getIntersectionList(rect, referenceElement, pResult) {
        result := ComCall(46, this, "ptr", rect, "ptr", referenceElement, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getEnclosureList(rect, referenceElement, pResult) {
        result := ComCall(47, this, "ptr", rect, "ptr", referenceElement, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ISVGElement>} element 
     * @param {Pointer<ISVGRect>} rect 
     * @param {Pointer<VARIANT_BOOL>} pResult 
     * @returns {HRESULT} 
     */
    checkIntersection(element, rect, pResult) {
        result := ComCall(48, this, "ptr", element, "ptr", rect, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    checkEnclosure(element, rect, pResult) {
        result := ComCall(49, this, "ptr", element, "ptr", rect, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGNumber(pResult) {
        result := ComCall(51, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGLength(pResult) {
        result := ComCall(52, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGAngle(pResult) {
        result := ComCall(53, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGPoint(pResult) {
        result := ComCall(54, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGMatrix(pResult) {
        result := ComCall(55, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGRect(pResult) {
        result := ComCall(56, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGTransform(pResult) {
        result := ComCall(57, this, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    createSVGTransformFromMatrix(matrix, pResult) {
        result := ComCall(58, this, "ptr", matrix, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getElementById(elementId, pResult) {
        ...
        result := ComCall(59, this, "ptr", elementId, "ptr", pResult, "int")
        if(result != 0)
            throw OSError(result)
