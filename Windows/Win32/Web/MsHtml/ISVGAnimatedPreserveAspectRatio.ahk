...
#Import ".\ISVGPreserveAspectRatio.ahk" { ISVGPreserveAspectRatio }

/**
 * @namespace Windows.Win32.Web.MsHtml
 */
export default struct ISVGAnimatedPreserveAspectRatio extends IDispatch {
    /**
     ...
     * used for ISVGAnimatedPreserveAspectRatio interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISVGAnimatedPreserveAspectRatio.Vtbl()
        }
