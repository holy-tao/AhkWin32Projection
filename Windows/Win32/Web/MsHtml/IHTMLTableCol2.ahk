 ...
 */
export default struct IHTMLTableCol2 extends IDispatch {
    /**
     * The interface identifier for IHTMLTableCol2
     * @type {Guid}
     */
    static IID := Guid("{3050f82a-98b5-11cf-bb82-00aa00bdce0b}")
     ...
     * used for IHTMLTableCol2 interfaces
    */
    ...
    Query(iid) {
        if (IHTMLTableCol2.IID.Equals(iid)) {
            return true
        }
