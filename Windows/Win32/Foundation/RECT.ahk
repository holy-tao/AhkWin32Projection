...
#Import "..\Graphics\Gdi\Apis.ahk" { EqualRect, InflateRect, IntersectRect, IsRectEmpty, OffsetRect, PtInRect, SubtractRect, UnionRect }
...
export default struct RECT {
     ...
     * @returns {RECT} The intersection between this rectangle and `other`
     */
    Intersect(other) {
        intersection := RECT()
     ...
     * @returns {RECT} the union between this rectangle and `other`
     */
    Union(other) {
        union := RECT()
     ...
     * @returns {RECT} the result of subtracting `other` from this
     */
    Subtract(other) {
        diff := RECT()
