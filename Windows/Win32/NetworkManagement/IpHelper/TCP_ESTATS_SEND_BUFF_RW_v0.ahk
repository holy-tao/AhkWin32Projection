 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tcpestats/ns-tcpestats-tcp_estats_send_buff_rw_v0
 * @namespace Windows.Win32.NetworkManagement.IpHelper
 * @version v4.0.30319
 */
class TCP_ESTATS_SEND_BUFF_RW_v0 extends Win32Struct
{
    static sizeof => 1
