 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/udpmib/ns-udpmib-mib_udp6table_owner_module
 * @namespace Windows.Win32.NetworkManagement.IpHelper
 * @version v4.0.30319
 */
class MIB_UDP6TABLE_OWNER_MODULE extends Win32Struct
{
    static sizeof => 16
     ...
     * @type {Array<MIB_UDP6ROW_OWNER_MODULE>}
     */
    table{
        get {
            if(!this.HasProp("__tableProxyArray"))
                this.__tableProxyArray := Win32FixedArray(this.ptr + 8, 1, MIB_UDP6ROW_OWNER_MODULE, "")
