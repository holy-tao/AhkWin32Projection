 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ipmib/ns-ipmib-mib_ipnettable
    ...
    table{
        get {
            if(!this.HasProp("__tableProxyArray"))
                this.__tableProxyArray := Win32FixedArray(this.ptr + 8, 1, MIB_IPNETROW_LH, "")
