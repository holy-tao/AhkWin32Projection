 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwproducts
...
class INetFwProducts extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwproducts-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwproducts-register
     */
    Register(product) {
        result := ComCall(8, this, "ptr", product, "ptr*", &registration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwproducts-item
     */
    Item(index) {
        result := ComCall(9, this, "int", index, "ptr*", &product := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwproducts-get__newenum
     */
    get__NewEnum() {
