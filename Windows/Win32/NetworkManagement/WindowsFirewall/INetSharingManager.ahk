 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nn-netcon-inetsharingmanager
...
class INetSharingManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_sharinginstalled
     */
    get_SharingInstalled() {
        result := ComCall(7, this, "short*", &pbInstalled := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_enumpublicconnections
     */
    get_EnumPublicConnections(Flags) {
        result := ComCall(8, this, "int", Flags, "ptr*", &ppColl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_enumprivateconnections
     */
    get_EnumPrivateConnections(Flags) {
        result := ComCall(9, this, "int", Flags, "ptr*", &ppColl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_inetsharingconfigurationforinetconnection
     */
    get_INetSharingConfigurationForINetConnection(pNetConnection) {
        result := ComCall(10, this, "ptr", pNetConnection, "ptr*", &ppNetSharingConfiguration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_enumeveryconnection
     */
    get_EnumEveryConnection() {
        result := ComCall(11, this, "ptr*", &ppColl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingmanager-get_netconnectionprops
     */
    get_NetConnectionProps(pNetConnection) {
        result := ComCall(12, this, "ptr", pNetConnection, "ptr*", &ppProps := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
