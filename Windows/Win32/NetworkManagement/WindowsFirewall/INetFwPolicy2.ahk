 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwpolicy2
...
class INetFwPolicy2 extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_currentprofiletypes
     */
    get_CurrentProfileTypes() {
        result := ComCall(7, this, "int*", &profileTypesBitmask := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_firewallenabled
     */
    get_FirewallEnabled(profileType) {
        result := ComCall(8, this, "int", profileType, "short*", &enabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_firewallenabled
     */
     ...
     * @param {Integer} profileType 
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_excludedinterfaces
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_excludedinterfaces
     */
     ...
     * @param {Integer} profileType 
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_blockallinboundtraffic
     */
    get_BlockAllInboundTraffic(profileType) {
        result := ComCall(12, this, "int", profileType, "short*", &Block := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_blockallinboundtraffic
     */
     ...
     * @param {Integer} profileType 
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_notificationsdisabled
     */
    get_NotificationsDisabled(profileType) {
        result := ComCall(14, this, "int", profileType, "short*", &disabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_notificationsdisabled
     */
     ...
     * @param {Integer} profileType 
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_unicastresponsestomulticastbroadcastdisabled
     */
    get_UnicastResponsesToMulticastBroadcastDisabled(profileType) {
        result := ComCall(16, this, "int", profileType, "short*", &disabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} disabled 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_unicastresponsestomulticastbroadcastdisabled
     */
     ...
     * @returns {INetFwRules} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_rules
     */
    get_Rules() {
        result := ComCall(18, this, "ptr*", &rules := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_servicerestriction
     */
    get_ServiceRestriction() {
        result := ComCall(19, this, "ptr*", &ServiceRestriction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-enablerulegroup
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-isrulegroupenabled
     */
    IsRuleGroupEnabled(profileTypesBitmask, group) {
        ...
        result := ComCall(21, this, "int", profileTypesBitmask, "ptr", group, "short*", &enabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-restorelocalfirewalldefaults
     */
     ...
     * @param {Integer} profileType 
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_defaultinboundaction
     */
    get_DefaultInboundAction(profileType) {
        result := ComCall(23, this, "int", profileType, "int*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_defaultinboundaction
     */
     ...
     * @param {Integer} profileType 
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_defaultoutboundaction
     */
    get_DefaultOutboundAction(profileType) {
        result := ComCall(25, this, "int", profileType, "int*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} action 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-put_defaultoutboundaction
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_isrulegroupcurrentlyenabled
     */
    get_IsRuleGroupCurrentlyEnabled(group) {
        ...
        result := ComCall(27, this, "ptr", group, "short*", &enabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy2-get_localpolicymodifystate
     */
    get_LocalPolicyModifyState() {
        result := ComCall(28, this, "int*", &modifyState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
