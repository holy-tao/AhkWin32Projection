...
export default struct INetFwPolicy2 extends IDispatch {
    ...
    */
    ...
    EnableRuleGroup(profileTypesBitmask, group, enable) {
        ...
        result := ComCall(20, this, Int32, profileTypesBitmask, BSTR, group, VARIANT_BOOL, enable, "HRESULT")
        return result
    }
    ...
    IsRuleGroupEnabled(profileTypesBitmask, group) {
        ...
        result := ComCall(21, this, Int32, profileTypesBitmask, BSTR, group, VARIANT_BOOL.Ptr, &enabled := 0, "HRESULT")
        return enabled
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CurrentProfileTypes := CallbackCreate(ObjBindMethod(implObj, "get_CurrentProfileTypes"), flags, 2)
        this.vtbl.get_FirewallEnabled := CallbackCreate(ObjBindMethod(implObj, "get_FirewallEnabled"), flags, 3)
        this.vtbl.put_FirewallEnabled := CallbackCreate(ObjBindMethod(implObj, "put_FirewallEnabled"), flags, 3)
        this.vtbl.get_ExcludedInterfaces := CallbackCreate(ObjBindMethod(implObj, "get_ExcludedInterfaces"), flags, 3)
        this.vtbl.put_ExcludedInterfaces := CallbackCreate(ObjBindMethod(implObj, "put_ExcludedInterfaces"), flags, 3)
        this.vtbl.get_BlockAllInboundTraffic := CallbackCreate(ObjBindMethod(implObj, "get_BlockAllInboundTraffic"), flags, 3)
        this.vtbl.put_BlockAllInboundTraffic := CallbackCreate(ObjBindMethod(implObj, "put_BlockAllInboundTraffic"), flags, 3)
        this.vtbl.get_NotificationsDisabled := CallbackCreate(ObjBindMethod(implObj, "get_NotificationsDisabled"), flags, 3)
        this.vtbl.put_NotificationsDisabled := CallbackCreate(ObjBindMethod(implObj, "put_NotificationsDisabled"), flags, 3)
        this.vtbl.get_UnicastResponsesToMulticastBroadcastDisabled := CallbackCreate(ObjBindMethod(implObj, "get_UnicastResponsesToMulticastBroadcastDisabled"), flags, 3)
        this.vtbl.put_UnicastResponsesToMulticastBroadcastDisabled := CallbackCreate(ObjBindMethod(implObj, "put_UnicastResponsesToMulticastBroadcastDisabled"), flags, 3)
        this.vtbl.get_Rules := CallbackCreate(ObjBindMethod(implObj, "get_Rules"), flags, 2)
        this.vtbl.get_ServiceRestriction := CallbackCreate(ObjBindMethod(implObj, "get_ServiceRestriction"), flags, 2)
        this.vtbl.EnableRuleGroup := CallbackCreate(ObjBindMethod(implObj, "EnableRuleGroup"), flags, 4)
        this.vtbl.IsRuleGroupEnabled := CallbackCreate(ObjBindMethod(implObj, "IsRuleGroupEnabled"), flags, 4)
        this.vtbl.RestoreLocalFirewallDefaults := CallbackCreate(ObjBindMethod(implObj, "RestoreLocalFirewallDefaults"), flags, 1)
        this.vtbl.get_DefaultInboundAction := CallbackCreate(ObjBindMethod(implObj, "get_DefaultInboundAction"), flags, 3)
        this.vtbl.put_DefaultInboundAction := CallbackCreate(ObjBindMethod(implObj, "put_DefaultInboundAction"), flags, 3)
        this.vtbl.get_DefaultOutboundAction := CallbackCreate(ObjBindMethod(implObj, "get_DefaultOutboundAction"), flags, 3)
        this.vtbl.put_DefaultOutboundAction := CallbackCreate(ObjBindMethod(implObj, "put_DefaultOutboundAction"), flags, 3)
        this.vtbl.get_IsRuleGroupCurrentlyEnabled := CallbackCreate(ObjBindMethod(implObj, "get_IsRuleGroupCurrentlyEnabled"), flags, 3)
        this.vtbl.get_LocalPolicyModifyState := CallbackCreate(ObjBindMethod(implObj, "get_LocalPolicyModifyState"), flags, 2)
    }
