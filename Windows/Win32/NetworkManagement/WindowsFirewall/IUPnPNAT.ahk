 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/natupnp/nn-natupnp-iupnpnat
...
class IUPnPNAT extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/natupnp/nf-natupnp-iupnpnat-get_staticportmappingcollection
     */
    get_StaticPortMappingCollection() {
        result := ComCall(7, this, "ptr*", &ppSPMs := 0, "int")
        if(result != 0) {
    ...
    get_DynamicPortMappingCollection() {
        result := ComCall(8, this, "ptr*", &ppDPMs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/natupnp/nf-natupnp-iupnpnat-get_nateventmanager
     */
    get_NATEventManager() {
        result := ComCall(9, this, "ptr*", &ppNEM := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
