 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwservices
...
class INetFwServices extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservices-get_count
     */
    get_Count() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservices-item
     */
    Item(svcType) {
        result := ComCall(8, this, "int", svcType, "ptr*", &service := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservices-get__newenum
     */
    get__NewEnum() {
