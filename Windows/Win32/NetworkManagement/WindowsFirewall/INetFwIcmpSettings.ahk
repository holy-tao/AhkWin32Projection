...
export default struct INetFwIcmpSettings extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AllowOutboundDestinationUnreachable := CallbackCreate(ObjBindMethod(implObj, "get_AllowOutboundDestinationUnreachable"), flags, 2)
        this.vtbl.put_AllowOutboundDestinationUnreachable := CallbackCreate(ObjBindMethod(implObj, "put_AllowOutboundDestinationUnreachable"), flags, 2)
        this.vtbl.get_AllowRedirect := CallbackCreate(ObjBindMethod(implObj, "get_AllowRedirect"), flags, 2)
        this.vtbl.put_AllowRedirect := CallbackCreate(ObjBindMethod(implObj, "put_AllowRedirect"), flags, 2)
        this.vtbl.get_AllowInboundEchoRequest := CallbackCreate(ObjBindMethod(implObj, "get_AllowInboundEchoRequest"), flags, 2)
        this.vtbl.put_AllowInboundEchoRequest := CallbackCreate(ObjBindMethod(implObj, "put_AllowInboundEchoRequest"), flags, 2)
        this.vtbl.get_AllowOutboundTimeExceeded := CallbackCreate(ObjBindMethod(implObj, "get_AllowOutboundTimeExceeded"), flags, 2)
        this.vtbl.put_AllowOutboundTimeExceeded := CallbackCreate(ObjBindMethod(implObj, "put_AllowOutboundTimeExceeded"), flags, 2)
        this.vtbl.get_AllowOutboundParameterProblem := CallbackCreate(ObjBindMethod(implObj, "get_AllowOutboundParameterProblem"), flags, 2)
        this.vtbl.put_AllowOutboundParameterProblem := CallbackCreate(ObjBindMethod(implObj, "put_AllowOutboundParameterProblem"), flags, 2)
        this.vtbl.get_AllowOutboundSourceQuench := CallbackCreate(ObjBindMethod(implObj, "get_AllowOutboundSourceQuench"), flags, 2)
        this.vtbl.put_AllowOutboundSourceQuench := CallbackCreate(ObjBindMethod(implObj, "put_AllowOutboundSourceQuench"), flags, 2)
        this.vtbl.get_AllowInboundRouterRequest := CallbackCreate(ObjBindMethod(implObj, "get_AllowInboundRouterRequest"), flags, 2)
        this.vtbl.put_AllowInboundRouterRequest := CallbackCreate(ObjBindMethod(implObj, "put_AllowInboundRouterRequest"), flags, 2)
        this.vtbl.get_AllowInboundTimestampRequest := CallbackCreate(ObjBindMethod(implObj, "get_AllowInboundTimestampRequest"), flags, 2)
        this.vtbl.put_AllowInboundTimestampRequest := CallbackCreate(ObjBindMethod(implObj, "put_AllowInboundTimestampRequest"), flags, 2)
        this.vtbl.get_AllowInboundMaskRequest := CallbackCreate(ObjBindMethod(implObj, "get_AllowInboundMaskRequest"), flags, 2)
        this.vtbl.put_AllowInboundMaskRequest := CallbackCreate(ObjBindMethod(implObj, "put_AllowInboundMaskRequest"), flags, 2)
        this.vtbl.get_AllowOutboundPacketTooBig := CallbackCreate(ObjBindMethod(implObj, "get_AllowOutboundPacketTooBig"), flags, 2)
        this.vtbl.put_AllowOutboundPacketTooBig := CallbackCreate(ObjBindMethod(implObj, "put_AllowOutboundPacketTooBig"), flags, 2)
    }
