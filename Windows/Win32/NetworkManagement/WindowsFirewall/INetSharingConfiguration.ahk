 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nn-netcon-inetsharingconfiguration
...
class INetSharingConfiguration extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-get_sharingenabled
     */
    get_SharingEnabled() {
        result := ComCall(7, this, "short*", &pbEnabled := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-get_sharingconnectiontype
     */
    get_SharingConnectionType() {
        result := ComCall(8, this, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-disablesharing
     */
    DisableSharing() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-enablesharing
     */
    EnableSharing(Type) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-get_internetfirewallenabled
     */
    get_InternetFirewallEnabled() {
        result := ComCall(11, this, "short*", &pbEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-disableinternetfirewall
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-enableinternetfirewall
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-get_enumportmappings
     */
    get_EnumPortMappings(Flags) {
        result := ComCall(14, this, "int", Flags, "ptr*", &ppColl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-addportmapping
     */
    AddPortMapping(bstrName, ucIPProtocol, usExternalPort, usInternalPort, dwOptions, bstrTargetNameOrIPAddress, eTargetType) {
        ...
        if(bstrTargetNameOrIPAddress is String) {
            pin := BSTR.Alloc(bstrTargetNameOrIPAddress)
            bstrTargetNameOrIPAddress := pin.Value
        }

        result := ComCall(15, this, "ptr", bstrName, "char", ucIPProtocol, "ushort", usExternalPort, "ushort", usInternalPort, "uint", dwOptions, "ptr", bstrTargetNameOrIPAddress, "int", eTargetType, "ptr*", &ppMapping := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingconfiguration-removeportmapping
     */
