...
export default struct INetFwAuthorizedApplication extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ProcessImageFileName := CallbackCreate(ObjBindMethod(implObj, "get_ProcessImageFileName"), flags, 2)
        this.vtbl.put_ProcessImageFileName := CallbackCreate(ObjBindMethod(implObj, "put_ProcessImageFileName"), flags, 2)
