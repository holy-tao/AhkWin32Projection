 ...
 * effect immediately.
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwservice
...
class INetFwService extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_name
     */
    get_Name() {
        name := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_type
     */
    get_Type() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_customized
     */
    get_Customized() {
        result := ComCall(9, this, "short*", &customized := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_ipversion
     */
    get_IpVersion() {
        result := ComCall(10, this, "int*", &ipVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-put_ipversion
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_scope
     */
    get_Scope() {
        result := ComCall(12, this, "int*", &scope := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} scope 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-put_scope
     */
    put_Scope(scope) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_remoteaddresses
     */
    get_RemoteAddresses() {
        remoteAddrs := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-put_remoteaddresses
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_enabled
     */
    get_Enabled() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-put_enabled
     */
    put_Enabled(enabled) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservice-get_globallyopenports
     */
