 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwservicerestriction
...
class INetFwServiceRestriction extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservicerestriction-restrictservice
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservicerestriction-servicerestricted
     */
    ServiceRestricted(serviceName, appName) {
        ...
        result := ComCall(8, this, "ptr", serviceName, "ptr", appName, "short*", &serviceRestricted := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {INetFwRules} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwservicerestriction-get_rules
     */
    get_Rules() {
        result := ComCall(9, this, "ptr*", &rules := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
