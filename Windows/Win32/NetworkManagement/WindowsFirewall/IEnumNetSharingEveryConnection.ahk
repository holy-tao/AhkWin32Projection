 ...
 */
export default struct IEnumNetSharingEveryConnection extends IUnknown {
    /**
     ...
     * used for IEnumNetSharingEveryConnection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumNetSharingEveryConnection.Vtbl()
        }
