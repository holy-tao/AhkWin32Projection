 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwrule2
...
class INetFwRule2 extends INetFwRule{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwrule2-get_edgetraversaloptions
     */
    get_EdgeTraversalOptions() {
        result := ComCall(43, this, "int*", &lOptions := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwrule2-put_edgetraversaloptions
     */
