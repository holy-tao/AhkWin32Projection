...
export default struct INetFwRule extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ServiceName := CallbackCreate(ObjBindMethod(implObj, "get_ServiceName"), flags, 2)
        this.vtbl.put_ServiceName := CallbackCreate(ObjBindMethod(implObj, "put_ServiceName"), flags, 2)
        ...
        this.vtbl.get_LocalPorts := CallbackCreate(ObjBindMethod(implObj, "get_LocalPorts"), flags, 2)
        this.vtbl.put_LocalPorts := CallbackCreate(ObjBindMethod(implObj, "put_LocalPorts"), flags, 2)
        this.vtbl.get_RemotePorts := CallbackCreate(ObjBindMethod(implObj, "get_RemotePorts"), flags, 2)
        this.vtbl.put_RemotePorts := CallbackCreate(ObjBindMethod(implObj, "put_RemotePorts"), flags, 2)
        this.vtbl.get_LocalAddresses := CallbackCreate(ObjBindMethod(implObj, "get_LocalAddresses"), flags, 2)
        this.vtbl.put_LocalAddresses := CallbackCreate(ObjBindMethod(implObj, "put_LocalAddresses"), flags, 2)
        ...
        this.vtbl.get_IcmpTypesAndCodes := CallbackCreate(ObjBindMethod(implObj, "get_IcmpTypesAndCodes"), flags, 2)
        this.vtbl.put_IcmpTypesAndCodes := CallbackCreate(ObjBindMethod(implObj, "put_IcmpTypesAndCodes"), flags, 2)
        ...
        this.vtbl.get_Interfaces := CallbackCreate(ObjBindMethod(implObj, "get_Interfaces"), flags, 2)
        this.vtbl.put_Interfaces := CallbackCreate(ObjBindMethod(implObj, "put_Interfaces"), flags, 2)
        this.vtbl.get_InterfaceTypes := CallbackCreate(ObjBindMethod(implObj, "get_InterfaceTypes"), flags, 2)
        this.vtbl.put_InterfaceTypes := CallbackCreate(ObjBindMethod(implObj, "put_InterfaceTypes"), flags, 2)
        ...
        this.vtbl.get_Grouping := CallbackCreate(ObjBindMethod(implObj, "get_Grouping"), flags, 2)
        this.vtbl.put_Grouping := CallbackCreate(ObjBindMethod(implObj, "put_Grouping"), flags, 2)
        this.vtbl.get_Profiles := CallbackCreate(ObjBindMethod(implObj, "get_Profiles"), flags, 2)
        this.vtbl.put_Profiles := CallbackCreate(ObjBindMethod(implObj, "put_Profiles"), flags, 2)
        this.vtbl.get_EdgeTraversal := CallbackCreate(ObjBindMethod(implObj, "get_EdgeTraversal"), flags, 2)
        this.vtbl.put_EdgeTraversal := CallbackCreate(ObjBindMethod(implObj, "put_EdgeTraversal"), flags, 2)
