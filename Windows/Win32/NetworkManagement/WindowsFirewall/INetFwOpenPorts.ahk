 ...
 * immediately.
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwopenports
...
class INetFwOpenPorts extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwopenports-get_count
     */
    get_Count() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwopenports-add
     */
    Add(port) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwopenports-remove
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwopenports-item
     */
    Item(portNumber, ipProtocol) {
        result := ComCall(10, this, "int", portNumber, "int", ipProtocol, "ptr*", &openPort := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwopenports-get__newenum
     */
    get__NewEnum() {
