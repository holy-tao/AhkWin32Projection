 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nn-netfw-inetfwpolicy
...
class INetFwPolicy extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy-get_currentprofile
     */
    get_CurrentProfile() {
        result := ComCall(7, this, "ptr*", &profile_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return INetFwProfile(profile_)
    }
     ...
     * @returns {INetFwProfile} 
     * @see https://learn.microsoft.com/windows/win32/api//content/netfw/nf-netfw-inetfwpolicy-getprofilebytype
     */
    GetProfileByType(profileType) {
        result := ComCall(8, this, "int", profileType, "ptr*", &profile_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
