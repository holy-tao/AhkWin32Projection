 ...
 */
export NcFreeNetconProperties(pProps) {
    DllCall("Netshell.dll\NcFreeNetconProperties", NETCON_PROPERTIES.Ptr, pProps)
}
 ...
 * @since windows5.1.2600
 */
export NcIsValidConnectionName(pszwName) {
    pszwName := pszwName is String ? StrPtr(pszwName) : pszwName

    result := DllCall("Netshell.dll\NcIsValidConnectionName", "ptr", pszwName, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export NetworkIsolationSetupAppContainerBinaries(applicationContainerSid, packageFullName, packageFolder, displayName, bBinariesFullyComputed, binaries, binariesCount) {
 ...
 * @since windows8.0
 */
export NetworkIsolationUnregisterForAppContainerChanges(registrationObject) {
    result := DllCall("api-ms-win-net-isolation-l1-1-0.dll\NetworkIsolationUnregisterForAppContainerChanges", HANDLE, registrationObject, UInt32)
    return result
}
 ...
 * @since windows8.0
 */
export NetworkIsolationEnumerateAppContainerRules() {
 ...
 * @since windows8.0
 */
export NetworkIsolationFreeAppContainers(pPublicAppCs) {
    result := DllCall("api-ms-win-net-isolation-l1-1-0.dll\NetworkIsolationFreeAppContainers", INET_FIREWALL_APP_CONTAINER.Ptr, pPublicAppCs, UInt32)
    return result
}
 ...
 * @since windows10.0.10240
 */
export NetworkIsolationGetEnterpriseIdClose(hOperation, bWaitForOperation) {
    result := DllCall("Firewallapi.dll\NetworkIsolationGetEnterpriseIdClose", HANDLE, hOperation, BOOL, bWaitForOperation, UInt32)
    return result
}
