...
export default struct INetFwProfile extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_FirewallEnabled := CallbackCreate(ObjBindMethod(implObj, "get_FirewallEnabled"), flags, 2)
        this.vtbl.put_FirewallEnabled := CallbackCreate(ObjBindMethod(implObj, "put_FirewallEnabled"), flags, 2)
        this.vtbl.get_ExceptionsNotAllowed := CallbackCreate(ObjBindMethod(implObj, "get_ExceptionsNotAllowed"), flags, 2)
        this.vtbl.put_ExceptionsNotAllowed := CallbackCreate(ObjBindMethod(implObj, "put_ExceptionsNotAllowed"), flags, 2)
        this.vtbl.get_NotificationsDisabled := CallbackCreate(ObjBindMethod(implObj, "get_NotificationsDisabled"), flags, 2)
        this.vtbl.put_NotificationsDisabled := CallbackCreate(ObjBindMethod(implObj, "put_NotificationsDisabled"), flags, 2)
        this.vtbl.get_UnicastResponsesToMulticastBroadcastDisabled := CallbackCreate(ObjBindMethod(implObj, "get_UnicastResponsesToMulticastBroadcastDisabled"), flags, 2)
        this.vtbl.put_UnicastResponsesToMulticastBroadcastDisabled := CallbackCreate(ObjBindMethod(implObj, "put_UnicastResponsesToMulticastBroadcastDisabled"), flags, 2)
        this.vtbl.get_RemoteAdminSettings := CallbackCreate(ObjBindMethod(implObj, "get_RemoteAdminSettings"), flags, 2)
        this.vtbl.get_IcmpSettings := CallbackCreate(ObjBindMethod(implObj, "get_IcmpSettings"), flags, 2)
        this.vtbl.get_GloballyOpenPorts := CallbackCreate(ObjBindMethod(implObj, "get_GloballyOpenPorts"), flags, 2)
        this.vtbl.get_Services := CallbackCreate(ObjBindMethod(implObj, "get_Services"), flags, 2)
        this.vtbl.get_AuthorizedApplications := CallbackCreate(ObjBindMethod(implObj, "get_AuthorizedApplications"), flags, 2)
    }
