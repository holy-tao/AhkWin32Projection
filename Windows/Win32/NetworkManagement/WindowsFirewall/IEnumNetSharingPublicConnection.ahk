 ...
 * @see https://learn.microsoft.com/windows/win32/api/netcon/nn-netcon-ienumnetsharingpublicconnection
 * @namespace Windows.Win32.NetworkManagement.WindowsFirewall
 */
export default struct IEnumNetSharingPublicConnection extends IUnknown {
    /**
     ...
     * used for IEnumNetSharingPublicConnection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumNetSharingPublicConnection.Vtbl()
        }
     ...
     * @param {Pointer<Integer>} pceltFetched Pointer to a <b>ULONG</b> variable that, on successful return, specifies the number of publicly-shared connections actually returned.
    ...
    Next(celt, rgVar, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, VARIANT.Ptr, rgVar, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }

    /**
     * The Skip method skips the specified number of publicly-shared connections for this enumeration.
     * @param {Integer} celt Specifies the number of publicly-shared connections to skip.
     * @returns {HRESULT} If the method succeeds the return value is S_OK.
     * 
     * If the method fails, the return value is one of the following error codes.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/netcon/nf-netcon-ienumnetsharingpublicconnection-skip
     */
    Skip(celt) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/netcon/nf-netcon-ienumnetsharingpublicconnection-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api/netcon/nf-netcon-ienumnetsharingpublicconnection-clone
     */
    Clone() {
    ...
    Query(iid) {
        if (IEnumNetSharingPublicConnection.IID.Equals(iid)) {
            return true
        }
