 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nn-netcon-inetsharingportmappingcollection
...
class INetSharingPortMappingCollection extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingportmappingcollection-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netcon/nf-netcon-inetsharingportmappingcollection-get_count
     */
    get_Count() {
