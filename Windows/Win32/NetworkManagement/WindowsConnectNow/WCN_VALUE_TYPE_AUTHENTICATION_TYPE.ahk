 ...
 * @see https://learn.microsoft.com/windows/win32/api/wcntypes/ne-wcntypes-wcn_value_type_authentication_type
 * @namespace Windows.Win32.NetworkManagement.WindowsConnectNow
 */
class WCN_VALUE_TYPE_AUTHENTICATION_TYPE extends Win32Enum {

    /**
     * Specifies IEEE 802.11 Open System authentication.
     * Native name: WCN_VALUE_AT_OPEN
     * @type {Integer (Int32)}
     */
    static AT_OPEN => 1
     ...
     * <div> </div>
     * Native name: WCN_VALUE_AT_WPAPSK
     * @type {Integer (Int32)}
     */
    static AT_WPAPSK => 2
     ...
     * <div class="alert"><b>Note</b>  Not supported in WPS 2.0.</div>
     * <div> </div>
     * Native name: WCN_VALUE_AT_SHARED
     * @type {Integer (Int32)}
     */
    static AT_SHARED => 4
     ...
     * Native name: WCN_VALUE_AT_WPA2PSK
     * @type {Integer (Int32)}
     */
    static AT_WPA2PSK => 32
     ...
     * <div> </div>
     * Native name: WCN_VALUE_AT_WPAWPA2PSK_MIXED
     * @type {Integer (Int32)}
     */
    static AT_WPAWPA2PSK_MIXED => 34
}
