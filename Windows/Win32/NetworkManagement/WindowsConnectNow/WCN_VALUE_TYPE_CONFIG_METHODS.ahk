...
class WCN_VALUE_TYPE_CONFIG_METHODS extends Win32Enum {
     ...
     * <div class="alert"><b>Note</b>  Not supported in Windows 7 and later. Not supported in WPS 2.0.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_ETHERNET
     * @type {Integer (Int32)}
     */
    static CM_ETHERNET => 2
     ...
     * Native name: WCN_VALUE_CM_LABEL
     * @type {Integer (Int32)}
     */
    static CM_LABEL => 4
     ...
     * <div> </div>
     * Native name: WCN_VALUE_CM_DISPLAY
     * @type {Integer (Int32)}
     */
    static CM_DISPLAY => 8
     ...
     * <div> </div>
     * Native name: WCN_VALUE_CM_EXTERNAL_NFC
     * @type {Integer (Int32)}
     */
    static CM_EXTERNAL_NFC => 16
     ...
     * <div class="alert"><b>Note</b>  Not supported in Windows 7.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_INTEGRATED_NFC
     * @type {Integer (Int32)}
     */
    static CM_INTEGRATED_NFC => 32
     ...
     * <div class="alert"><b>Note</b>  Not supported in Windows 7.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_NFC_INTERFACE
     * @type {Integer (Int32)}
     */
    static CM_NFC_INTERFACE => 64
     ...
     * <div> </div>
     * Native name: WCN_VALUE_CM_PUSHBUTTON
     * @type {Integer (Int32)}
     */
    static CM_PUSHBUTTON => 128
     ...
     * <div class="alert"><b>Note</b>  Not supported in Windows 7.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_KEYPAD
     * @type {Integer (Int32)}
     */
    static CM_KEYPAD => 256
     ...
     * <div> </div>
     * Native name: WCN_VALUE_CM_VIRT_PUSHBUTTON
     * @type {Integer (Int32)}
     */
    static CM_VIRT_PUSHBUTTON => 640
     ...
     * <div class="alert"><b>Note</b>  Only available  in Windows 8.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_PHYS_PUSHBUTTON
     * @type {Integer (Int32)}
     */
    static CM_PHYS_PUSHBUTTON => 1152
     ...
     * <div class="alert"><b>Note</b>  Only available  in Windows 8.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_VIRT_DISPLAY
     * @type {Integer (Int32)}
     */
    static CM_VIRT_DISPLAY => 8200
     ...
     * <div class="alert"><b>Note</b>  Only available  in Windows 8.</div>
     * <div> </div>
     * Native name: WCN_VALUE_CM_PHYS_DISPLAY
     * @type {Integer (Int32)}
     */
    static CM_PHYS_DISPLAY => 16392
}
