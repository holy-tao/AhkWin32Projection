 ...
 * @see https://learn.microsoft.com/windows/win32/api/wcntypes/ne-wcntypes-wcn_value_type_encryption_type
...
class WCN_VALUE_TYPE_ENCRYPTION_TYPE extends Win32Enum {
     ...
     * <div> </div>
     * Native name: WCN_VALUE_ET_TKIP_AES_MIXED
     * @type {Integer (Int32)}
     */
    static ET_TKIP_AES_MIXED => 12
}
