...
class PEER_GRAPH_SCOPE extends Win32Enum {
     ...
     * Native name: PEER_GRAPH_SCOPE_ANY
     * @type {Integer (Int32)}
     */
    static ANY => 0
     ...
     * Native name: PEER_GRAPH_SCOPE_GLOBAL
     * @type {Integer (Int32)}
     */
    static GLOBAL => 1
     ...
     * Native name: PEER_GRAPH_SCOPE_SITELOCAL
     * @type {Integer (Int32)}
     */
    static SITELOCAL => 2
     ...
     * Native name: PEER_GRAPH_SCOPE_LINKLOCAL
     * @type {Integer (Int32)}
     */
    static LINKLOCAL => 3
     ...
     * Native name: PEER_GRAPH_SCOPE_LOOPBACK
     * @type {Integer (Int32)}
     */
    static LOOPBACK => 4
}
