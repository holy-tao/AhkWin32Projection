...
#Import ".\PEER_APP_LAUNCH_INFO.ahk" { PEER_APP_LAUNCH_INFO }
#Import ".\PEER_CREDENTIAL_INFO.ahk" { PEER_CREDENTIAL_INFO }
#Import ".\PEER_RECORD.ahk" { PEER_RECORD }
#Import ".\PEER_PNRP_CLOUD_INFO.ahk" { PEER_PNRP_CLOUD_INFO }
#Import ".\PEER_APPLICATION_REGISTRATION_TYPE.ahk" { PEER_APPLICATION_REGISTRATION_TYPE }
#Import ".\PEERDIST_PUBLICATION_OPTIONS.ahk" { PEERDIST_PUBLICATION_OPTIONS }
#Import ".\PEER_INVITATION_RESPONSE.ahk" { PEER_INVITATION_RESPONSE }
#Import "..\..\..\..\Guid.ahk" { Guid }
#Import "..\..\Foundation\HRESULT.ahk" { HRESULT }
#Import "..\..\Security\Cryptography\CERT_CONTEXT.ahk" { CERT_CONTEXT }
#Import ".\PEER_CONTACT.ahk" { PEER_CONTACT }
#Import "..\..\Foundation\FILETIME.ahk" { FILETIME }
#Import ".\PEER_APPLICATION_REGISTRATION_INFO.ahk" { PEER_APPLICATION_REGISTRATION_INFO }
#Import ".\PEER_GRAPH_EVENT_REGISTRATION.ahk" { PEER_GRAPH_EVENT_REGISTRATION }
#Import ".\PEERDIST_RETRIEVAL_OPTIONS.ahk" { PEERDIST_RETRIEVAL_OPTIONS }
#Import ".\DRT_SCOPE.ahk" { DRT_SCOPE }
#Import ".\PEERDIST_CONTENT_TAG.ahk" { PEERDIST_CONTENT_TAG }
#Import ".\PEER_GROUP_EVENT_REGISTRATION.ahk" { PEER_GROUP_EVENT_REGISTRATION }
#Import ".\PEER_PNRP_ENDPOINT_INFO.ahk" { PEER_PNRP_ENDPOINT_INFO }
#Import ".\PEER_PRESENCE_INFO.ahk" { PEER_PRESENCE_INFO }
#Import ".\DRT_SECURITY_PROVIDER.ahk" { DRT_SECURITY_PROVIDER }
#Import ".\PEER_NODE_INFO.ahk" { PEER_NODE_INFO }
#Import ".\PEER_INVITATION.ahk" { PEER_INVITATION }
#Import ".\PEER_SECURITY_INTERFACE.ahk" { PEER_SECURITY_INTERFACE }
#Import ".\PEER_PNRP_REGISTRATION_INFO.ahk" { PEER_PNRP_REGISTRATION_INFO }
#Import ".\PEER_INVITATION_INFO.ahk" { PEER_INVITATION_INFO }
#Import ".\DRT_SETTINGS.ahk" { DRT_SETTINGS }
#Import ".\PEER_GRAPH_PROPERTIES.ahk" { PEER_GRAPH_PROPERTIES }
#Import ".\PEER_ADDRESS.ahk" { PEER_ADDRESS }
#Import ".\PEER_GROUP_EVENT_DATA.ahk" { PEER_GROUP_EVENT_DATA }
#Import ".\PEER_COLLAB_EVENT_DATA.ahk" { PEER_COLLAB_EVENT_DATA }
#Import "..\..\Foundation\BOOL.ahk" { BOOL }
#Import ".\PEER_GRAPH_EVENT_DATA.ahk" { PEER_GRAPH_EVENT_DATA }
#Import ".\DRT_BOOTSTRAP_PROVIDER.ahk" { DRT_BOOTSTRAP_PROVIDER }
#Import ".\PEER_OBJECT.ahk" { PEER_OBJECT }
#Import ".\PEER_COLLAB_EVENT_REGISTRATION.ahk" { PEER_COLLAB_EVENT_REGISTRATION }
#Import "..\..\Foundation\HWND.ahk" { HWND }
#Import ".\PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS.ahk" { PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS }
#Import ".\PEER_GROUP_PROPERTIES.ahk" { PEER_GROUP_PROPERTIES }
#Import ".\DRT_REGISTRATION.ahk" { DRT_REGISTRATION }
#Import ".\PEERDIST_STATUS_INFO.ahk" { PEERDIST_STATUS_INFO }
#Import ".\PEER_ENDPOINT.ahk" { PEER_ENDPOINT }
#Import "..\..\Foundation\PWSTR.ahk" { PWSTR }
#Import "..\..\System\IO\OVERLAPPED.ahk" { OVERLAPPED }
#Import "..\..\Foundation\HANDLE.ahk" { HANDLE }
#Import ".\PEER_VERSION_DATA.ahk" { PEER_VERSION_DATA }
#Import ".\DRT_SEARCH_INFO.ahk" { DRT_SEARCH_INFO }
 ...
 */
export PeerGraphStartup(wVersionRequested, pVersionData) {
    result := DllCall("P2PGRAPH.dll\PeerGraphStartup", "ushort", wVersionRequested, PEER_VERSION_DATA.Ptr, pVersionData, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGraphShutdown() {
    result := DllCall("P2PGRAPH.dll\PeerGraphShutdown", "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGraphOpen(pwzGraphId, pwzPeerId, pwzDatabaseName, pSecurityInterface, cRecordTypeSyncPrecedence, pRecordTypeSyncPrecedence) {
    pwzGraphId := pwzGraphId is String ? StrPtr(pwzGraphId) : pwzGraphId
    pwzPeerId := pwzPeerId is String ? StrPtr(pwzPeerId) : pwzPeerId
    pwzDatabaseName := pwzDatabaseName is String ? StrPtr(pwzDatabaseName) : pwzDatabaseName

    result := DllCall("P2PGRAPH.dll\PeerGraphOpen", "ptr", pwzGraphId, "ptr", pwzPeerId, "ptr", pwzDatabaseName, PEER_SECURITY_INTERFACE.Ptr, pSecurityInterface, "uint", cRecordTypeSyncPrecedence, Guid.Ptr, pRecordTypeSyncPrecedence, "ptr*", &phGraph := 0, "HRESULT")
    return phGraph
}
...
export PeerGraphListen(hGraph, dwScope, dwScopeId, wPort) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphListen", hGraphMarshal, hGraph, "uint", dwScope, "uint", dwScopeId, "ushort", wPort, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGraphDelete(pwzGraphId, pwzPeerId, pwzDatabaseName) {
    pwzGraphId := pwzGraphId is String ? StrPtr(pwzGraphId) : pwzGraphId
    pwzPeerId := pwzPeerId is String ? StrPtr(pwzPeerId) : pwzPeerId
    pwzDatabaseName := pwzDatabaseName is String ? StrPtr(pwzDatabaseName) : pwzDatabaseName

    result := DllCall("P2PGRAPH.dll\PeerGraphDelete", "ptr", pwzGraphId, "ptr", pwzPeerId, "ptr", pwzDatabaseName, "HRESULT")
    return result
}
...
export PeerGraphRegisterEvent(hGraph, hEvent, cEventRegistrations, pEventRegistrations) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphRegisterEvent", hGraphMarshal, hGraph, HANDLE, hEvent, "uint", cEventRegistrations, PEER_GRAPH_EVENT_REGISTRATION.Ptr, pEventRegistrations, "ptr*", &phPeerEvent := 0, "HRESULT")
    return phPeerEvent
}
...
export PeerGraphValidateDeferredRecords(hGraph, cRecordIds, pRecordIds) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphValidateDeferredRecords", hGraphMarshal, hGraph, "uint", cRecordIds, Guid.Ptr, pRecordIds, "HRESULT")
    return result
}
 ...
 * @param {Integer} pvData Pointer to the  data to send.
 * @returns {HRESULT} Returns S_OK  if the operation succeeds; otherwise, the function returns one of the following values:
 * 
 * <table>
 * <tr>
...
export PeerGraphSendData(hGraph, ullConnectionId, pType, cbData, pvData) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphSendData", hGraphMarshal, hGraph, "uint", ullConnectionId, Guid.Ptr, pType, "uint", cbData, "ptr", pvData, "HRESULT")
    return result
}
...
export PeerGraphCloseDirectConnection(hGraph, ullConnectionId) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphCloseDirectConnection", hGraphMarshal, hGraph, "uint", ullConnectionId, "HRESULT")
    return result
}
...
export PeerGraphEnumConnections(hGraph, dwFlags) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphEnumConnections", hGraphMarshal, hGraph, "uint", dwFlags, "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
...
export PeerGraphGetNodeInfo(hGraph, ullNodeId) {
    ...
    result := DllCall("P2PGRAPH.dll\PeerGraphGetNodeInfo", hGraphMarshal, hGraph, "uint", ullNodeId, "ptr*", &ppNodeInfo := 0, "HRESULT")
    return ppNodeInfo
}
 ...
 * @since windows5.1.2600
 */
export PeerGroupStartup(wVersionRequested, pVersionData) {
    result := DllCall("P2P.dll\PeerGroupStartup", "ushort", wVersionRequested, PEER_VERSION_DATA.Ptr, pVersionData, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGroupShutdown() {
    result := DllCall("P2P.dll\PeerGroupShutdown", "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGroupCreate(pProperties) {
    result := DllCall("P2P.dll\PeerGroupCreate", PEER_GROUP_PROPERTIES.Ptr, pProperties, "ptr*", &phGroup := 0, "HRESULT")
    return phGroup
}
 ...
 * @since windows5.1.2600
 */
export PeerGroupOpen(pwzIdentity, pwzGroupPeerName, pwzCloud) {
 ...
 * @since windows5.1.2600
 */
export PeerGroupJoin(pwzIdentity, pwzInvitation, pwzCloud) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
 ...
 * @since windows5.1.2600
 */
export PeerGroupPasswordJoin(pwzIdentity, pwzInvitation, pwzPassword, pwzCloud) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
    pwzInvitation := pwzInvitation is String ? StrPtr(pwzInvitation) : pwzInvitation
...
export PeerGroupConnectByAddress(_hGroup, cAddresses, pAddresses) {
    ...
    result := DllCall("P2P.dll\PeerGroupConnectByAddress", _hGroupMarshal, _hGroup, "uint", cAddresses, PEER_ADDRESS.Ptr, pAddresses, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerGroupDelete(pwzIdentity, pwzGroupPeerName) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
    pwzGroupPeerName := pwzGroupPeerName is String ? StrPtr(pwzGroupPeerName) : pwzGroupPeerName

    result := DllCall("P2P.dll\PeerGroupDelete", "ptr", pwzIdentity, "ptr", pwzGroupPeerName, "HRESULT")
    return result
}
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group for which this invitation is issued. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
...
export PeerGroupCreateInvitation(_hGroup, pwzIdentityInfo, pftExpiration, cRoles, pRoles) {
    ...
    result := DllCall("P2P.dll\PeerGroupCreateInvitation", _hGroupMarshal, _hGroup, "ptr", pwzIdentityInfo, FILETIME.Ptr, pftExpiration, "uint", cRoles, Guid.Ptr, pRoles, PWSTR.Ptr, &ppwzInvitation := 0, "HRESULT")
 ...
 * @since windows5.1.2600
 */
export PeerGroupParseInvitation(pwzInvitation) {
    pwzInvitation := pwzInvitation is String ? StrPtr(pwzInvitation) : pwzInvitation

    result := DllCall("P2P.dll\PeerGroupParseInvitation", "ptr", pwzInvitation, "ptr*", &ppInvitationInfo := 0, "HRESULT")
    return ppInvitationInfo
}

/**
 * The PeerGroupGetStatus function retrieves the current status of a group.
 * @param {Pointer<Void>} _hGroup Handle to a peer group whose status is returned. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to a peer group whose properties are retrieved. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @remarks
 * For applications that utilize passwords, it is recommended the passwords are handled securely  by calling the <a href="https://docs.microsoft.com/windows/desktop/api/dpapi/nf-dpapi-cryptprotectmemory">CryptoProtectMemory</a> and <a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/aa366877(v=vs.85)">SecureZeroMemory</a> functions.
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose properties are set by a peer. This handle is returned by the  <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose members are enumerated. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group that hosts the direct connection. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group that contains the peers involved in the direct connection. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the group that contains the connections to be enumerated. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the group that contains both members of a connection. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Integer} pvData Pointer to the block of data to send. The receiving application is responsible for parsing this data. This parameter is required.
 * @returns {HRESULT} Returns <b>S_OK</b>  if the operation succeeds. Otherwise, the function returns one of the following values.
 * 
 * <table>
 * <tr>
...
export PeerGroupSendData(_hGroup, ullConnectionId, pType, cbData, pvData) {
    ...
    result := DllCall("P2P.dll\PeerGroupSendData", _hGroupMarshal, _hGroup, "uint", ullConnectionId, Guid.Ptr, pType, "uint", cbData, "ptr", pvData, "HRESULT")
    return result
}
 ...
 * @param {Pointer<Void>} _hGroup Handle of the peer group on which to monitor the specific peer events. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
...
export PeerGroupRegisterEvent(_hGroup, hEvent, cEventRegistration, pEventRegistrations) {
    ...
    result := DllCall("P2P.dll\PeerGroupRegisterEvent", _hGroupMarshal, _hGroup, HANDLE, hEvent, "uint", cEventRegistration, PEER_GROUP_EVENT_REGISTRATION.Ptr, pEventRegistrations, "ptr*", &phPeerEvent := 0, "HRESULT")
    return phPeerEvent
}
 ...
 * @param {Pointer<Void>} _hGroup Handle to a group that contains a specific record. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose record is updated. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group that contains the record. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose records are enumerated. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose local database is searched. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the peer group whose database is exported to a local file on the peer. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to a peer group whose database is imported from a local file. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to a peer group  for which a peer will issue credentials to potential invited peers. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
...
export PeerGroupIssueCredentials(_hGroup, pwzSubjectIdentity, pCredentialInfo, dwFlags) {
    ...
    result := DllCall("P2P.dll\PeerGroupIssueCredentials", _hGroupMarshal, _hGroup, "ptr", pwzSubjectIdentity, PEER_CREDENTIAL_INFO.Ptr, pCredentialInfo, "uint", dwFlags, PWSTR.Ptr, &ppwzInvitation := 0, "HRESULT")
    return ppwzInvitation
}
 ...
 * &lt;/PEERGROUPCONFIG&gt;
 * ```
 * @param {Pointer<Void>} _hGroup Handle to the group. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @since windows5.1.2600
 */
export PeerGroupImportConfig(pwzXML, pwzPassword, fOverwrite, ppwzIdentity, ppwzGroup) {
 ...
 * @param {Pointer<Void>} _hGroup Handle to the  peer group that a peer participates in. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @param {Pointer<Void>} _hGroup Handle to the  peer group a peer participates in. This handle is returned by the <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupcreate">PeerGroupCreate</a>, <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupopen">PeerGroupOpen</a>, or <a href="https://docs.microsoft.com/windows/desktop/api/p2p/nf-p2p-peergroupjoin">PeerGroupJoin</a> function. This parameter is required.
 ...
 * @since windows5.1.2600
 */
export PeerIdentityCreate(pwzClassifier, pwzFriendlyName, hCryptProv) {
    ...
    result := DllCall("P2P.dll\PeerIdentityCreate", "ptr", pwzClassifier, "ptr", pwzFriendlyName, "ptr", hCryptProv, PWSTR.Ptr, &ppwzIdentity := 0, "HRESULT")
    return ppwzIdentity
}
 ...
 * @since windows5.1.2600
 */
export PeerIdentitySetFriendlyName(pwzIdentity, pwzFriendlyName) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
    pwzFriendlyName := pwzFriendlyName is String ? StrPtr(pwzFriendlyName) : pwzFriendlyName
 ...
 * @since windows5.1.2600
 */
export PeerIdentityDelete(pwzIdentity) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity

    result := DllCall("P2P.dll\PeerIdentityDelete", "ptr", pwzIdentity, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerEnumIdentities() {
    result := DllCall("P2P.dll\PeerEnumIdentities", "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
 ...
 * @since windows5.1.2600
 */
export PeerEnumGroups(pwzIdentity) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity

    result := DllCall("P2P.dll\PeerEnumGroups", "ptr", pwzIdentity, "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
 ...
 * @since windows5.1.2600
 */
export PeerCreatePeerName(pwzIdentity, pwzClassifier) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
    pwzClassifier := pwzClassifier is String ? StrPtr(pwzClassifier) : pwzClassifier
 ...
 * @since windows5.1.2600
 */
export PeerIdentityExport(pwzIdentity, pwzPassword) {
    pwzIdentity := pwzIdentity is String ? StrPtr(pwzIdentity) : pwzIdentity
    pwzPassword := pwzPassword is String ? StrPtr(pwzPassword) : pwzPassword
 ...
 * @since windows5.1.2600
 */
export PeerIdentityImport(pwzImportXML, pwzPassword) {
    pwzImportXML := pwzImportXML is String ? StrPtr(pwzImportXML) : pwzImportXML
    pwzPassword := pwzPassword is String ? StrPtr(pwzPassword) : pwzPassword

    result := DllCall("P2P.dll\PeerIdentityImport", "ptr", pwzImportXML, "ptr", pwzPassword, PWSTR.Ptr, &ppwzIdentity := 0, "HRESULT")
    return ppwzIdentity
}
 ...
 * @since windows5.1.2600
 */
export PeerIdentityGetDefault() {
    result := DllCall("P2P.dll\PeerIdentityGetDefault", PWSTR.Ptr, &ppwzPeerName := 0, "HRESULT")
    return ppwzPeerName
}
 ...
 */
export PeerCollabStartup(wVersionRequested) {
    result := DllCall("P2P.dll\PeerCollabStartup", "ushort", wVersionRequested, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabShutdown() {
    result := DllCall("P2P.dll\PeerCollabShutdown", "HRESULT")
    return result
}
...
export PeerCollabSignin(hwndParent, dwSigninOptions) {
    result := DllCall("P2P.dll\PeerCollabSignin", HWND, hwndParent, "uint", dwSigninOptions, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabSignout(dwSigninOptions) {
    result := DllCall("P2P.dll\PeerCollabSignout", "uint", dwSigninOptions, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabGetSigninOptions() {
    result := DllCall("P2P.dll\PeerCollabGetSigninOptions", "uint*", &pdwSigninOptions := 0, "HRESULT")
 ...
 * @since windows6.0.6000
 */
export PeerCollabGetInvitationResponse(hInvitation) {
    result := DllCall("P2P.dll\PeerCollabGetInvitationResponse", HANDLE, hInvitation, "ptr*", &ppInvitationResponse := 0, "HRESULT")
 ...
 * @since windows6.0.6000
 */
export PeerCollabCancelInvitation(hInvitation) {
    result := DllCall("P2P.dll\PeerCollabCancelInvitation", HANDLE, hInvitation, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabCloseHandle(hInvitation) {
    result := DllCall("P2P.dll\PeerCollabCloseHandle", HANDLE, hInvitation, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabInviteEndpoint(pcEndpoint, pcInvitation) {
    result := DllCall("P2P.dll\PeerCollabInviteEndpoint", PEER_ENDPOINT.Ptr, pcEndpoint, PEER_INVITATION.Ptr, pcInvitation, "ptr*", &ppResponse := 0, "HRESULT")
    return ppResponse
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabGetAppLaunchInfo() {
    result := DllCall("P2P.dll\PeerCollabGetAppLaunchInfo", "ptr*", &ppLaunchInfo := 0, "HRESULT")
    return ppLaunchInfo
}
 ...
 * @param {PEER_APPLICATION_REGISTRATION_TYPE} registrationType A <a href="https://docs.microsoft.com/windows/desktop/api/p2p/ne-p2p-peer_application_registration_type">PEER_APPLICATION_REGISTRATION_TYPE</a> value that describes whether the peer's application is registered to the <b>current user</b> or <b>all users</b> of the peer's machine.
 * @returns {HRESULT} Returns S_OK if the function succeeds. Otherwise, the function returns one of the following values.
 * 
 * <table>
 * <tr>
 ...
 * @since windows6.0.6000
 */
export PeerCollabRegisterApplication(pcApplication, registrationType) {
    result := DllCall("P2P.dll\PeerCollabRegisterApplication", PEER_APPLICATION_REGISTRATION_INFO.Ptr, pcApplication, PEER_APPLICATION_REGISTRATION_TYPE, registrationType, "HRESULT")
    return result
}
 ...
 * @param {PEER_APPLICATION_REGISTRATION_TYPE} registrationType A <a href="https://docs.microsoft.com/windows/desktop/api/p2p/ne-p2p-peer_application_registration_type">PEER_APPLICATION_REGISTRATION_TYPE</a> value that describes whether the peer's application is deregistered for the current user or all users of the peer's machine.
 * @returns {HRESULT} Returns S_OK if the function succeeds. Otherwise, the function returns one of the following values.
 * 
 * <table>
 * <tr>
 ...
 * @since windows6.0.6000
 */
export PeerCollabUnregisterApplication(pApplicationId, registrationType) {
    result := DllCall("P2P.dll\PeerCollabUnregisterApplication", Guid.Ptr, pApplicationId, PEER_APPLICATION_REGISTRATION_TYPE, registrationType, "HRESULT")
    return result
}
 ...
 * @param {PEER_APPLICATION_REGISTRATION_TYPE} registrationType A <a href="https://docs.microsoft.com/windows/desktop/api/p2p/ne-p2p-peer_application_registration_type">PEER_APPLICATION_REGISTRATION_TYPE</a> enumeration value that describes whether the peer's application is registered to the current user or all users of the local machine.
 ...
 * @since windows6.0.6000
 */
export PeerCollabGetApplicationRegistrationInfo(pApplicationId, registrationType) {
    result := DllCall("P2P.dll\PeerCollabGetApplicationRegistrationInfo", Guid.Ptr, pApplicationId, PEER_APPLICATION_REGISTRATION_TYPE, registrationType, "ptr*", &ppApplication := 0, "HRESULT")
 ...
 * @param {PEER_APPLICATION_REGISTRATION_TYPE} registrationType A <a href="https://docs.microsoft.com/windows/desktop/api/p2p/ne-p2p-peer_application_registration_type">PEER_APPLICATION_REGISTRATION_TYPE</a> value that specifies whether the peer's application is registered to the <b>current user</b> or <b>all users</b> of the peer's machine.
 ...
 * @since windows6.0.6000
 */
export PeerCollabEnumApplicationRegistrationInfo(registrationType) {
    result := DllCall("P2P.dll\PeerCollabEnumApplicationRegistrationInfo", PEER_APPLICATION_REGISTRATION_TYPE, registrationType, "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabRefreshEndpointData(pcEndpoint) {
    result := DllCall("P2P.dll\PeerCollabRefreshEndpointData", PEER_ENDPOINT.Ptr, pcEndpoint, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabDeleteEndpointData(pcEndpoint) {
    result := DllCall("P2P.dll\PeerCollabDeleteEndpointData", PEER_ENDPOINT.Ptr, pcEndpoint, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabSubscribeEndpointData(pcEndpoint) {
    result := DllCall("P2P.dll\PeerCollabSubscribeEndpointData", PEER_ENDPOINT.Ptr, pcEndpoint, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabUnsubscribeEndpointData(pcEndpoint) {
    result := DllCall("P2P.dll\PeerCollabUnsubscribeEndpointData", PEER_ENDPOINT.Ptr, pcEndpoint, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabSetPresenceInfo(pcPresenceInfo) {
    result := DllCall("P2P.dll\PeerCollabSetPresenceInfo", PEER_PRESENCE_INFO.Ptr, pcPresenceInfo, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabGetEndpointName() {
    result := DllCall("P2P.dll\PeerCollabGetEndpointName", PWSTR.Ptr, &ppwzEndpointName := 0, "HRESULT")
 ...
 * @since windows6.0.6000
 */
export PeerCollabSetEndpointName(pwzEndpointName) {
    pwzEndpointName := pwzEndpointName is String ? StrPtr(pwzEndpointName) : pwzEndpointName

    result := DllCall("P2P.dll\PeerCollabSetEndpointName", "ptr", pwzEndpointName, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabSetObject(pcObject) {
    result := DllCall("P2P.dll\PeerCollabSetObject", PEER_OBJECT.Ptr, pcObject, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabDeleteObject(pObjectId) {
    result := DllCall("P2P.dll\PeerCollabDeleteObject", Guid.Ptr, pObjectId, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabRegisterEvent(hEvent, cEventRegistration, pEventRegistrations) {
    result := DllCall("P2P.dll\PeerCollabRegisterEvent", HANDLE, hEvent, "uint", cEventRegistration, PEER_COLLAB_EVENT_REGISTRATION.Ptr, pEventRegistrations, "ptr*", &phPeerEvent := 0, "HRESULT")
    return phPeerEvent
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabEnumPeopleNearMe() {
    result := DllCall("P2P.dll\PeerCollabEnumPeopleNearMe", "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabAddContact(pwzContactData) {
    pwzContactData := pwzContactData is String ? StrPtr(pwzContactData) : pwzContactData

    result := DllCall("P2P.dll\PeerCollabAddContact", "ptr", pwzContactData, "ptr*", &ppContact := 0, "HRESULT")
    return ppContact
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabDeleteContact(pwzPeerName) {
    pwzPeerName := pwzPeerName is String ? StrPtr(pwzPeerName) : pwzPeerName

    result := DllCall("P2P.dll\PeerCollabDeleteContact", "ptr", pwzPeerName, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabUpdateContact(pContact) {
    result := DllCall("P2P.dll\PeerCollabUpdateContact", PEER_CONTACT.Ptr, pContact, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabEnumContacts() {
    result := DllCall("P2P.dll\PeerCollabEnumContacts", "ptr*", &phPeerEnum := 0, "HRESULT")
    return phPeerEnum
}
 ...
 * @since windows6.0.6000
 */
export PeerCollabParseContact(pwzContactData) {
    pwzContactData := pwzContactData is String ? StrPtr(pwzContactData) : pwzContactData

    result := DllCall("P2P.dll\PeerCollabParseContact", "ptr", pwzContactData, "ptr*", &ppContact := 0, "HRESULT")
    return ppContact
}
 ...
 * @since windows5.1.2600
 */
export PeerNameToPeerHostName(pwzPeerName) {
    pwzPeerName := pwzPeerName is String ? StrPtr(pwzPeerName) : pwzPeerName

    result := DllCall("P2P.dll\PeerNameToPeerHostName", "ptr", pwzPeerName, PWSTR.Ptr, &ppwzHostName := 0, "HRESULT")
    return ppwzHostName
}
 ...
 * @since windows5.1.2600
 */
export PeerHostNameToPeerName(pwzHostName) {
    pwzHostName := pwzHostName is String ? StrPtr(pwzHostName) : pwzHostName

    result := DllCall("P2P.dll\PeerHostNameToPeerName", "ptr", pwzHostName, PWSTR.Ptr, &ppwzPeerName := 0, "HRESULT")
    return ppwzPeerName
}
 ...
 * @since windows5.1.2600
 */
export PeerPnrpStartup(wVersionRequested) {
    result := DllCall("P2P.dll\PeerPnrpStartup", "ushort", wVersionRequested, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerPnrpShutdown() {
    result := DllCall("P2P.dll\PeerPnrpShutdown", "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PeerPnrpResolve(pcwzPeerName, pcwzCloudName, pcEndpoints) {
    pcwzPeerName := pcwzPeerName is String ? StrPtr(pcwzPeerName) : pcwzPeerName
 ...
 * @since windows5.1.2600
 */
export PeerPnrpStartResolve(pcwzPeerName, pcwzCloudName, cMaxEndpoints, hEvent) {
    pcwzPeerName := pcwzPeerName is String ? StrPtr(pcwzPeerName) : pcwzPeerName
    pcwzCloudName := pcwzCloudName is String ? StrPtr(pcwzCloudName) : pcwzCloudName

    result := DllCall("P2P.dll\PeerPnrpStartResolve", "ptr", pcwzPeerName, "ptr", pcwzCloudName, "uint", cMaxEndpoints, HANDLE, hEvent, "ptr*", &phResolve := 0, "HRESULT")
    return phResolve
}
 ...
 * @since windows6.1
 */
export DrtCreatePnrpBootstrapResolver(fPublish, pwzPeerName, pwzCloudName, pwzPublishingIdentity) {
    pwzPeerName := pwzPeerName is String ? StrPtr(pwzPeerName) : pwzPeerName
 ...
 * @since windows6.1
 */
export DrtDeletePnrpBootstrapResolver(pResolver) {
    DllCall("drtprov.dll\DrtDeletePnrpBootstrapResolver", DRT_BOOTSTRAP_PROVIDER.Ptr, pResolver)
}
 ...
 * @since windows6.1
 */
export DrtCreateDnsBootstrapResolver(port, pwszAddress) {
    pwszAddress := pwszAddress is String ? StrPtr(pwszAddress) : pwszAddress

    result := DllCall("drtprov.dll\DrtCreateDnsBootstrapResolver", "ushort", port, "ptr", pwszAddress, "ptr*", &ppModule := 0, "HRESULT")
    return ppModule
}
 ...
 * @since windows6.1
 */
export DrtDeleteDnsBootstrapResolver(pResolver) {
    DllCall("drtprov.dll\DrtDeleteDnsBootstrapResolver", DRT_BOOTSTRAP_PROVIDER.Ptr, pResolver)
}
 ...
 * @param {DRT_SCOPE} scope The <b>DRT_SCOPE</b> enumeration that specifies the IPv6 scope in which the DRT is to  operate.
...
export DrtCreateIpv6UdpTransport(scope, dwScopeId, dwLocalityThreshold, pwPort) {
    ...
    result := DllCall("drttransport.dll\DrtCreateIpv6UdpTransport", DRT_SCOPE, scope, "uint", dwScopeId, "uint", dwLocalityThreshold, pwPortMarshal, pwPort, "ptr*", &phTransport := 0, "HRESULT")
    return phTransport
}
 ...
 * @since windows6.1
 */
export DrtCreateDerivedKey(pLocalCert, pKey) {
    result := DllCall("drtprov.dll\DrtCreateDerivedKey", CERT_CONTEXT.Ptr, pLocalCert, DRT_DATA.Ptr, pKey, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export DrtDeleteDerivedKeySecurityProvider(pSecurityProvider) {
    DllCall("drtprov.dll\DrtDeleteDerivedKeySecurityProvider", DRT_SECURITY_PROVIDER.Ptr, pSecurityProvider)
}
 ...
 * @since windows6.1
 */
export DrtCreateNullSecurityProvider() {
    result := DllCall("drtprov.dll\DrtCreateNullSecurityProvider", "ptr*", &ppSecurityProvider := 0, "HRESULT")
    return ppSecurityProvider
}
 ...
 * @since windows6.1
 */
export DrtDeleteNullSecurityProvider(pSecurityProvider) {
    DllCall("drtprov.dll\DrtDeleteNullSecurityProvider", DRT_SECURITY_PROVIDER.Ptr, pSecurityProvider)
}
 ...
 * @param {Integer} pEventData Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/drt/ns-drt-drt_event_data">DRT_EVENT_DATA</a> structure that contains the event data.
 * @returns {HRESULT} This function returns S_OK on success. Other possible values include:
 * 
 * <table>
 * <tr>
...
export DrtGetEventData(hDrt, ulEventDataLen, pEventData) {
    ...
    result := DllCall("drt.dll\DrtGetEventData", hDrtMarshal, hDrt, "uint", ulEventDataLen, "ptr", pEventData, "HRESULT")
    return result
}
...
export DrtStartSearch(hDrt, pKey, pInfo, timeout, hEvent, pvContext) {
    ...
    result := DllCall("drt.dll\DrtStartSearch", hDrtMarshal, hDrt, DRT_DATA.Ptr, pKey, DRT_SEARCH_INFO.Ptr, pInfo, "uint", timeout, HANDLE, hEvent, pvContextMarshal, pvContext, "ptr*", &hSearchContext := 0, "HRESULT")
 ...
 * @param {Integer} pSearchResult Receives a pointer to a DRT_SEARCH_RESULT structure containing the search results.
 * @returns {HRESULT} This function returns S_OK on success. Other possible values include:
 * 
 * <table>
 * <tr>
...
export DrtGetSearchResult(hSearchContext, ulSearchResultSize, pSearchResult) {
    ...
    result := DllCall("drt.dll\DrtGetSearchResult", hSearchContextMarshal, hSearchContext, "uint", ulSearchResultSize, "ptr", pSearchResult, "HRESULT")
    return result
}
 ...
 * @param {Integer} pSearchPath Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/drt/ns-drt-drt_address_list">DRT_ADDRESS_LIST</a> structure containing the list of addresses.
...
export DrtGetSearchPath(hSearchContext, ulSearchPathSize, pSearchPath) {
    ...
    result := DllCall("drt.dll\DrtGetSearchPath", hSearchContextMarshal, hSearchContext, "uint", ulSearchPathSize, "ptr", pSearchPath, "HRESULT")
    return result
}
 ...
 * @param {Integer} pwzDrtInstanceName Contains the complete name of the DRT instance associated with <i>hDRT</i>.
 * @returns {HRESULT} This function returns S_OK on success. Other possible values include:
 * 
 * <table>
 * <tr>
...
export DrtGetInstanceName(hDrt, ulcbInstanceNameSize, pwzDrtInstanceName) {
    ...
    result := DllCall("drt.dll\DrtGetInstanceName", hDrtMarshal, hDrt, "uint", ulcbInstanceNameSize, "ptr", pwzDrtInstanceName, "HRESULT")
    return result
}
...
export PeerDistStartup(dwVersionRequested, phPeerDist, pdwSupportedVersion) {
    ...
    result := DllCall("PeerDist.dll\PeerDistStartup", "uint", dwVersionRequested, phPeerDistMarshal, phPeerDist, pdwSupportedVersionMarshal, pdwSupportedVersion, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistShutdown(hPeerDist) {
    result := DllCall("PeerDist.dll\PeerDistShutdown", "ptr", hPeerDist, UInt32)
    return result
}
 ...
 * @param {Pointer} hPeerDist A <b>PEERDIST_INSTANCE_HANDLE</b> returned by <a href="https://docs.microsoft.com/windows/desktop/api/peerdist/nf-peerdist-peerdiststartup">PeerDistStartup</a>.
 * @param {Pointer<PEERDIST_STATUS>} pPeerDistStatus A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/peerdist/ne-peerdist-peerdist_status">PEERDIST_STATUS</a> enumeration which upon operation success receives the current status of the Peer Distribution service.
...
export PeerDistGetStatus(hPeerDist, pPeerDistStatus) {
    ...
    result := DllCall("PeerDist.dll\PeerDistGetStatus", "ptr", hPeerDist, pPeerDistStatusMarshal, pPeerDistStatus, UInt32)
    return result
}
 ...
 * @param {Pointer<PEERDIST_STATUS>} pPeerDistStatus A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/peerdist/ne-peerdist-peerdist_status">PEERDIST_STATUS</a> enumeration that indicates the current status of the Peer Distribution service.
...
export PeerDistRegisterForStatusChangeNotification(hPeerDist, hCompletionPort, ulCompletionKey, lpOverlapped, pPeerDistStatus) {
    ...
    result := DllCall("PeerDist.dll\PeerDistRegisterForStatusChangeNotification", "ptr", hPeerDist, HANDLE, hCompletionPort, "ptr", ulCompletionKey, OVERLAPPED.Ptr, lpOverlapped, pPeerDistStatusMarshal, pPeerDistStatus, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistUnregisterForStatusChangeNotification(hPeerDist) {
    A_LastError := 0

    result := DllCall("PeerDist.dll\PeerDistUnregisterForStatusChangeNotification", "ptr", hPeerDist, UInt32)
    if(A_LastError) {
 ...
 * @param {Integer} pContentIdentifier A pointer to an array that contains a content identifier data.
...
export PeerDistServerPublishStream(hPeerDist, cbContentIdentifier, pContentIdentifier, cbContentLength, pPublishOptions, hCompletionPort, ulCompletionKey, phStream) {
    ...
    result := DllCall("PeerDist.dll\PeerDistServerPublishStream", "ptr", hPeerDist, "uint", cbContentIdentifier, "ptr", pContentIdentifier, "uint", cbContentLength, PEERDIST_PUBLICATION_OPTIONS.Ptr, pPublishOptions, HANDLE, hCompletionPort, "ptr", ulCompletionKey, phStreamMarshal, phStream, UInt32)
    return result
}
 ...
 * @param {Integer} pBuffer Pointer to the buffer that contains the data to be published. This buffer must remain valid for the duration of the add operation. The caller must not use this buffer until the add operation is completed.
 ...
 * @since windows6.1
 */
export PeerDistServerPublishAddToStream(hPeerDist, hStream, cbNumberOfBytes, pBuffer, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistServerPublishAddToStream", "ptr", hPeerDist, "ptr", hStream, "uint", cbNumberOfBytes, "ptr", pBuffer, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistServerPublishCompleteStream(hPeerDist, hStream, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistServerPublishCompleteStream", "ptr", hPeerDist, "ptr", hStream, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistServerCloseStreamHandle(hPeerDist, hStream) {
    result := DllCall("PeerDist.dll\PeerDistServerCloseStreamHandle", "ptr", hPeerDist, "ptr", hStream, UInt32)
    return result
}
 ...
 * @param {Integer} pContentIdentifier Pointer to a buffer that contains the content identifier.
 * @returns {Integer} If the function succeeds, the return value is <b>ERROR_SUCCESS</b>. Otherwise, the function may return one of the following values:
 * 
 * <table>
 * <tr>
 ...
 * @since windows6.1
 */
export PeerDistServerUnpublish(hPeerDist, cbContentIdentifier, pContentIdentifier) {
    result := DllCall("PeerDist.dll\PeerDistServerUnpublish", "ptr", hPeerDist, "uint", cbContentIdentifier, "ptr", pContentIdentifier, UInt32)
    return result
}
...
export PeerDistServerOpenContentInformation(hPeerDist, cbContentIdentifier, pContentIdentifier, ullContentOffset, cbContentLength, hCompletionPort, ulCompletionKey, phContentInfo) {
    ...
    result := DllCall("PeerDist.dll\PeerDistServerOpenContentInformation", "ptr", hPeerDist, "uint", cbContentIdentifier, "ptr", pContentIdentifier, "uint", ullContentOffset, "uint", cbContentLength, HANDLE, hCompletionPort, "ptr", ulCompletionKey, phContentInfoMarshal, phContentInfo, UInt32)
    return result
}
 ...
 * @param {Integer} pBuffer Pointer to the buffer that receives the content information data.
 ...
 * @since windows6.1
 */
export PeerDistServerRetrieveContentInformation(hPeerDist, hContentInfo, cbMaxNumberOfBytes, pBuffer, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistServerRetrieveContentInformation", "ptr", hPeerDist, "ptr", hContentInfo, "uint", cbMaxNumberOfBytes, "ptr", pBuffer, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistServerCloseContentInformation(hPeerDist, hContentInfo) {
    result := DllCall("PeerDist.dll\PeerDistServerCloseContentInformation", "ptr", hPeerDist, "ptr", hContentInfo, UInt32)
    return result
}
 ...
 * @param {Pointer} hPeerDist A <b>PEERDIST_INSTANCE_HANDLE</b> returned by <a href="https://docs.microsoft.com/windows/desktop/api/peerdist/nf-peerdist-peerdiststartup">PeerDistStartup</a>.
 * @param {Integer} cbContentIdentifier The length, in bytes, of the content identifier.
 * @param {Integer} pContentIdentifier Pointer to an array that contains the content identifier.
 ...
 * @since windows6.1
 */
export PeerDistServerCancelAsyncOperation(hPeerDist, cbContentIdentifier, pContentIdentifier, pOverlapped) {
    A_LastError := 0

    result := DllCall("PeerDist.dll\PeerDistServerCancelAsyncOperation", "ptr", hPeerDist, "uint", cbContentIdentifier, "ptr", pContentIdentifier, OVERLAPPED.Ptr, pOverlapped, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export PeerDistClientOpenContent(hPeerDist, pContentTag, hCompletionPort, ulCompletionKey, phContentHandle) {
    ...
    result := DllCall("PeerDist.dll\PeerDistClientOpenContent", "ptr", hPeerDist, PEERDIST_CONTENT_TAG.Ptr, pContentTag, HANDLE, hCompletionPort, "ptr", ulCompletionKey, phContentHandleMarshal, phContentHandle, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistClientCloseContent(hPeerDist, hContentHandle) {
    result := DllCall("PeerDist.dll\PeerDistClientCloseContent", "ptr", hPeerDist, "ptr", hContentHandle, UInt32)
    return result
}
 ...
 * @param {Integer} pBuffer Pointer to the buffer that contains the content information. This buffer must remain valid for the duration of the add operation. The caller must not use this buffer until the add operation is completed.
 ...
 * @since windows6.1
 */
export PeerDistClientAddContentInformation(hPeerDist, hContentHandle, cbNumberOfBytes, pBuffer, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientAddContentInformation", "ptr", hPeerDist, "ptr", hContentHandle, "uint", cbNumberOfBytes, "ptr", pBuffer, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
 ...
 * @since windows6.1
 */
export PeerDistClientCompleteContentInformation(hPeerDist, hContentHandle, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientCompleteContentInformation", "ptr", hPeerDist, "ptr", hContentHandle, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
 ...
 * @param {Integer} pBuffer Pointer to the buffer that contains the data to be added to the local cache. This buffer must remain valid for the duration of the add operation. The caller must not use this buffer until the add operation is completed.
 ...
 * @since windows6.1
 */
export PeerDistClientAddData(hPeerDist, hContentHandle, cbNumberOfBytes, pBuffer, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientAddData", "ptr", hPeerDist, "ptr", hContentHandle, "uint", cbNumberOfBytes, "ptr", pBuffer, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
...
export PeerDistClientBlockRead(hPeerDist, hContentHandle, cbMaxNumberOfBytes, pBuffer, dwTimeoutInMilliseconds, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientBlockRead", "ptr", hPeerDist, "ptr", hContentHandle, "uint", cbMaxNumberOfBytes, "ptr", pBuffer, "uint", dwTimeoutInMilliseconds, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
...
export PeerDistClientStreamRead(hPeerDist, hContentHandle, cbMaxNumberOfBytes, pBuffer, dwTimeoutInMilliseconds, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientStreamRead", "ptr", hPeerDist, "ptr", hContentHandle, "uint", cbMaxNumberOfBytes, "ptr", pBuffer, "uint", dwTimeoutInMilliseconds, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
...
export PeerDistClientFlushContent(hPeerDist, pContentTag, hCompletionPort, ulCompletionKey, lpOverlapped) {
    result := DllCall("PeerDist.dll\PeerDistClientFlushContent", "ptr", hPeerDist, PEERDIST_CONTENT_TAG.Ptr, pContentTag, HANDLE, hCompletionPort, "ptr", ulCompletionKey, OVERLAPPED.Ptr, lpOverlapped, UInt32)
    return result
}
...
export PeerDistClientCancelAsyncOperation(hPeerDist, hContentHandle, pOverlapped) {
    ...
    result := DllCall("PeerDist.dll\PeerDistClientCancelAsyncOperation", "ptr", hPeerDist, "ptr", hContentHandle, OVERLAPPED.Ptr, pOverlapped, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows8.0
 */
export PeerDistGetStatusEx(hPeerDist, pPeerDistStatus) {
    result := DllCall("PeerDist.dll\PeerDistGetStatusEx", "ptr", hPeerDist, PEERDIST_STATUS_INFO.Ptr, pPeerDistStatus, UInt32)
    return result
}
...
export PeerDistRegisterForStatusChangeNotificationEx(hPeerDist, hCompletionPort, ulCompletionKey, lpOverlapped, pPeerDistStatus) {
    result := DllCall("PeerDist.dll\PeerDistRegisterForStatusChangeNotificationEx", "ptr", hPeerDist, HANDLE, hCompletionPort, "ptr", ulCompletionKey, OVERLAPPED.Ptr, lpOverlapped, PEERDIST_STATUS_INFO.Ptr, pPeerDistStatus, UInt32)
    return result
}
...
export PeerDistServerOpenContentInformationEx(hPeerDist, cbContentIdentifier, pContentIdentifier, ullContentOffset, cbContentLength, pRetrievalOptions, hCompletionPort, ulCompletionKey, phContentInfo) {
    ...
    result := DllCall("PeerDist.dll\PeerDistServerOpenContentInformationEx", "ptr", hPeerDist, "uint", cbContentIdentifier, "ptr", pContentIdentifier, "uint", ullContentOffset, "uint", cbContentLength, PEERDIST_RETRIEVAL_OPTIONS.Ptr, pRetrievalOptions, HANDLE, hCompletionPort, "ptr", ulCompletionKey, phContentInfoMarshal, phContentInfo, UInt32)
    return result
}
 ...
 * @param {PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS} PeerDistClientInfoClass A value from the <a href="https://docs.microsoft.com/windows/win32/api/peerdist/ne-peerdist-peerdist_client_info_by_handle_class">PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS</a> enumeration that indicates the information to retrieve.
 * @param {Integer} dwBufferSize The size, in bytes, of the buffer for the <i>lpInformation</i> parameter.
 * @param {Integer} lpInformation A buffer for the returned information. The format of this information depends on the value of the <i>PeerDistClientInfoClass</i> parameter.
 * @returns {Integer} If the function succeeds, the return value is ERROR_SUCCESS.
 * @see https://learn.microsoft.com/windows/win32/api/peerdist/nf-peerdist-peerdistclientgetinformationbyhandle
 * @since windows8.0
 */
export PeerDistClientGetInformationByHandle(hPeerDist, hContentHandle, PeerDistClientInfoClass, dwBufferSize, lpInformation) {
    result := DllCall("PeerDist.dll\PeerDistClientGetInformationByHandle", "ptr", hPeerDist, "ptr", hContentHandle, PEERDIST_CLIENT_INFO_BY_HANDLE_CLASS, PeerDistClientInfoClass, "uint", dwBufferSize, "ptr", lpInformation, UInt32)
    return result
}
