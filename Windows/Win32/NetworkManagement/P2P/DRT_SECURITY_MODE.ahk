...
class DRT_SECURITY_MODE extends Win32Enum {
     ...
     * Native name: DRT_SECURE_RESOLVE
     * @type {Integer (Int32)}
     */
    static SECURE_RESOLVE => 0
     ...
     * Native name: DRT_SECURE_MEMBERSHIP
     * @type {Integer (Int32)}
     */
    static SECURE_MEMBERSHIP => 1
     ...
     * Native name: DRT_SECURE_CONFIDENTIALPAYLOAD
     * @type {Integer (Int32)}
     */
    static SECURE_CONFIDENTIALPAYLOAD => 2
}
