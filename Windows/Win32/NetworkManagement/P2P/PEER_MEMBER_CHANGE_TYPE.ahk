 ...
 */
class PEER_MEMBER_CHANGE_TYPE extends Win32Enum {

    /**
     * A member is connected to a peer group.
     * Native name: PEER_MEMBER_CONNECTED
     * @type {Integer (Int32)}
     */
    static CONNECTED => 1
     ...
     * Native name: PEER_MEMBER_DISCONNECTED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PEER_MEMBER_UPDATED
     * @type {Integer (Int32)}
     */
    static UPDATED => 3
     ...
     * </ul>
     * Native name: PEER_MEMBER_JOINED
     * @type {Integer (Int32)}
     */
    static JOINED => 4
