...
class PNRP_RESOLVE_CRITERIA extends Win32Enum {
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_DEFAULT
     * @type {Integer (Int32)}
     */
    static DEFAULT => 0
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_REMOTE_PEER_NAME
     * @type {Integer (Int32)}
     */
    static REMOTE_PEER_NAME => 1
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_NEAREST_REMOTE_PEER_NAME
     * @type {Integer (Int32)}
     */
    static NEAREST_REMOTE_PEER_NAME => 2
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_NON_CURRENT_PROCESS_PEER_NAME
     * @type {Integer (Int32)}
     */
    static NON_CURRENT_PROCESS_PEER_NAME => 3
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_NEAREST_NON_CURRENT_PROCESS_PEER_NAME
     * @type {Integer (Int32)}
     */
    static NEAREST_NON_CURRENT_PROCESS_PEER_NAME => 4

    /**
     * Match a peer name. The matching peer name can be registered locally or remotely.
     * Native name: PNRP_RESOLVE_CRITERIA_ANY_PEER_NAME
     * @type {Integer (Int32)}
     */
    static ANY_PEER_NAME => 5
     ...
     * Native name: PNRP_RESOLVE_CRITERIA_NEAREST_PEER_NAME
     * @type {Integer (Int32)}
     */
    static NEAREST_PEER_NAME => 6
}
