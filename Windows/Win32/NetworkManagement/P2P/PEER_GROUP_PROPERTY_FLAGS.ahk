...
class PEER_GROUP_PROPERTY_FLAGS extends Win32Enum {
     ...
     * Native name: PEER_MEMBER_DATA_OPTIONAL
     * @type {Integer (Int32)}
     */
    static MEMBER_DATA_OPTIONAL => 1

    /**
     * The peer presence system is prevented from automatically publishing presence information.
     * Native name: PEER_DISABLE_PRESENCE
     * @type {Integer (Int32)}
     */
    static DISABLE_PRESENCE => 2

    /**
     * Group records are not expired until the peer  connects with a group.
     * Native name: PEER_DEFER_EXPIRATION
     * @type {Integer (Int32)}
     */
    static DEFER_EXPIRATION => 4
}
