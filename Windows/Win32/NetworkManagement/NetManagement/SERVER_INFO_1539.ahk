 ...
 * @see https://docs.microsoft.com/windows/win32/api//lmserver/ns-lmserver-server_info_1539
...
class SERVER_INFO_1539 extends Win32Struct
{
    ...
    sv1539_enableraw{
        get {
            if(!this.HasProp("__sv1539_enableraw"))
                this.__sv1539_enableraw := BOOL(this.ptr + 0)
            return this.__sv1539_enableraw
        }
    }
}
