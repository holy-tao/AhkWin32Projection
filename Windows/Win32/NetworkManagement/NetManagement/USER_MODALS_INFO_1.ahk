 ...
 * @see https://docs.microsoft.com/windows/win32/api//lmaccess/ns-lmaccess-user_modals_info_1
...
class USER_MODALS_INFO_1 extends Win32Struct
{
    ...
    usrmod1_primary{
        get {
            if(!this.HasProp("__usrmod1_primary"))
                this.__usrmod1_primary := PWSTR(this.ptr + 8)
            return this.__usrmod1_primary
        }
    }
}
