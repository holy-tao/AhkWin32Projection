 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//lmaccess/ns-lmaccess-localgroup_members_info_1
...
class LOCALGROUP_MEMBERS_INFO_1 extends Win32Struct
{
    ...
    lgrmi1_sid{
        get {
            if(!this.HasProp("__lgrmi1_sid"))
                this.__lgrmi1_sid := PSID(this.ptr + 0)
            return this.__lgrmi1_sid
        }
    }
    ...
    lgrmi1_name{
        get {
            if(!this.HasProp("__lgrmi1_name"))
                this.__lgrmi1_name := PWSTR(this.ptr + 16)
            return this.__lgrmi1_name
        }
    }
}
