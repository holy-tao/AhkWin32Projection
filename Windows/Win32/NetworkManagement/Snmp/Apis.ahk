 ...
 * @since windows5.0
 */
export SnmpUtilOidCpy(pOidDst, pOidSrc) {
    result := DllCall("snmpapi.dll\SnmpUtilOidCpy", AsnObjectIdentifier.Ptr, pOidDst, AsnObjectIdentifier.Ptr, pOidSrc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilOidAppend(pOidDst, pOidSrc) {
    A_LastError := 0

    result := DllCall("snmpapi.dll\SnmpUtilOidAppend", AsnObjectIdentifier.Ptr, pOidDst, AsnObjectIdentifier.Ptr, pOidSrc, Int32)
    if(A_LastError) {
 ...
 * @since windows5.0
 */
export SnmpUtilOidCmp(pOid1, pOid2) {
    result := DllCall("snmpapi.dll\SnmpUtilOidCmp", AsnObjectIdentifier.Ptr, pOid1, AsnObjectIdentifier.Ptr, pOid2, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilOidFree(pOid) {
    DllCall("snmpapi.dll\SnmpUtilOidFree", AsnObjectIdentifier.Ptr, pOid)
}
 ...
 * @since windows5.0
 */
export SnmpUtilOctetsCmp(pOctets1, pOctets2) {
    result := DllCall("snmpapi.dll\SnmpUtilOctetsCmp", AsnOctetString.Ptr, pOctets1, AsnOctetString.Ptr, pOctets2, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilOctetsCpy(pOctetsDst, pOctetsSrc) {
    result := DllCall("snmpapi.dll\SnmpUtilOctetsCpy", AsnOctetString.Ptr, pOctetsDst, AsnOctetString.Ptr, pOctetsSrc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilOctetsFree(pOctets) {
    DllCall("snmpapi.dll\SnmpUtilOctetsFree", AsnOctetString.Ptr, pOctets)
}
 ...
 * @since windows5.0
 */
export SnmpUtilAsnAnyCpy(pAnyDst, pAnySrc) {
    result := DllCall("snmpapi.dll\SnmpUtilAsnAnyCpy", AsnAny.Ptr, pAnyDst, AsnAny.Ptr, pAnySrc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilAsnAnyFree(pAny) {
    DllCall("snmpapi.dll\SnmpUtilAsnAnyFree", AsnAny.Ptr, pAny)
}
 ...
 * @since windows5.0
 */
export SnmpUtilVarBindCpy(pVbDst, pVbSrc) {
    result := DllCall("snmpapi.dll\SnmpUtilVarBindCpy", SnmpVarBind.Ptr, pVbDst, SnmpVarBind.Ptr, pVbSrc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilVarBindFree(pVb) {
    DllCall("snmpapi.dll\SnmpUtilVarBindFree", SnmpVarBind.Ptr, pVb)
}
 ...
 * @since windows5.0
 */
export SnmpUtilVarBindListCpy(pVblDst, pVblSrc) {
    result := DllCall("snmpapi.dll\SnmpUtilVarBindListCpy", SnmpVarBindList.Ptr, pVblDst, SnmpVarBindList.Ptr, pVblSrc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilVarBindListFree(pVbl) {
    DllCall("snmpapi.dll\SnmpUtilVarBindListFree", SnmpVarBindList.Ptr, pVbl)
}
 ...
 * @since windows5.0
 */
export SnmpUtilOidToA(Oid) {
    result := DllCall("snmpapi.dll\SnmpUtilOidToA", AsnObjectIdentifier.Ptr, Oid, PSTR)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpUtilPrintOid(Oid) {
    DllCall("snmpapi.dll\SnmpUtilPrintOid", AsnObjectIdentifier.Ptr, Oid)
}
 ...
 * @since windows5.0
 */
export SnmpUtilPrintAsnAny(pAny) {
    DllCall("snmpapi.dll\SnmpUtilPrintAsnAny", AsnAny.Ptr, pAny)
}
 ...
 * @since windows5.0
 */
export SnmpSvcGetUptime() {
    result := DllCall("snmpapi.dll\SnmpSvcGetUptime", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpSvcSetLogLevel(nLogLevel) {
    DllCall("snmpapi.dll\SnmpSvcSetLogLevel", SNMP_LOG, nLogLevel)
}
 ...
 * @since windows5.0
 */
export SnmpUtilDbgPrint(nLogLevel, szFormat, args*) {
    szFormat := szFormat is String ? StrPtr(szFormat) : szFormat

    varArgs := [args*]

    DllCall("snmpapi.dll\SnmpUtilDbgPrint", SNMP_LOG, nLogLevel, "ptr", szFormat, varArgs*)
}
 ...
 * @since windows5.0
 */
export SnmpMgrOpen(lpAgentAddress, lpAgentCommunity, nTimeOut, nRetries) {
 ...
 * @since windows5.0
 */
export SnmpMgrTrapListen(phTrapAvailable) {
    A_LastError := 0

    result := DllCall("mgmtapi.dll\SnmpMgrTrapListen", HANDLE.Ptr, phTrapAvailable, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export SnmpSetTranslateMode(nTranslateMode) {
    result := DllCall("wsnmp32.dll\SnmpSetTranslateMode", SNMP_API_TRANSLATE_MODE, nTranslateMode, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpSetRetransmitMode(nRetransmitMode) {
    result := DllCall("wsnmp32.dll\SnmpSetRetransmitMode", SNMP_STATUS, nRetransmitMode, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpGetVendorInfo(vendorInfo) {
    result := DllCall("wsnmp32.dll\SnmpGetVendorInfo", smiVENDORINFO.Ptr, vendorInfo, UInt32)
    return result
}
 ...
 */
export SnmpCleanup() {
    result := DllCall("wsnmp32.dll\SnmpCleanup", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpCleanupEx() {
    result := DllCall("wsnmp32.dll\SnmpCleanupEx", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpStrToOid(_string, dstOID) {
    _string := _string is String ? StrPtr(_string) : _string

    result := DllCall("wsnmp32.dll\SnmpStrToOid", "ptr", _string, smiOID.Ptr, dstOID, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SnmpOidCopy(srcOID, dstOID) {
    result := DllCall("wsnmp32.dll\SnmpOidCopy", smiOID.Ptr, srcOID, smiOID.Ptr, dstOID, UInt32)
    return result
}
