 ...
 * @version v4.0.30319
 */
class PNS_CONTEXT_DUMP_FN extends IUnknown {
     ...
     */
    Invoke(pwszRouter, ppwcArguments, dwArgCount, pvData) {
        pwszRouter := pwszRouter is String ? StrPtr(pwszRouter) : pwszRouter

        ppwcArgumentsMarshal := ppwcArguments is VarRef ? "ptr*" : "ptr"
        pvDataMarshal := pvData is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", pwszRouter, ppwcArgumentsMarshal, ppwcArguments, "uint", dwArgCount, pvDataMarshal, pvData, "uint")
        return result
    }
}
