 ...
 * @since windows5.1.2600
 */
export MatchToken(pwszUserToken, pwszCmdToken) {
    ...
    result := DllCall("NETSH.dll\MatchToken", "ptr", pwszUserToken, "ptr", pwszCmdToken, BOOL)
    return result
}
 ...
 * @since windows5.1.2600
 */
export PrintError(_hModule, dwErrId, args*) {
    varArgs := [args*]
    varArgs.Push(UInt32)
 ...
 * @since windows5.1.2600
 */
export PrintMessageFromModule(_hModule, dwMsgId, args*) {
    varArgs := [args*]
    varArgs.Push(UInt32)
 ...
 * @since windows5.1.2600
 */
export PrintMessage(pwszFormat, args*) {
 ...
 * @since windows5.1.2600
 */
export RegisterContext(pChildContext) {
    result := DllCall("NETSH.dll\RegisterContext", NS_CONTEXT_ATTRIBUTES.Ptr, pChildContext, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export RegisterHelper(pguidParentContext, pfnRegisterSubContext) {
    result := DllCall("NETSH.dll\RegisterHelper", Guid.Ptr, pguidParentContext, NS_HELPER_ATTRIBUTES.Ptr, pfnRegisterSubContext, UInt32)
    return result
}
