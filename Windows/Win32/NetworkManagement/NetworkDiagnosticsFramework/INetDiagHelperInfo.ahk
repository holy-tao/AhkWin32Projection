 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nn-ndhelper-inetdiaghelperinfo
...
class INetDiagHelperInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nf-ndhelper-inetdiaghelperinfo-getattributeinfo
     */
    GetAttributeInfo(pcelt, pprgAttributeInfos) {
        ...
        result := ComCall(3, this, pceltMarshal, pcelt, pprgAttributeInfosMarshal, pprgAttributeInfos, "int")
        if(result != 0) {
