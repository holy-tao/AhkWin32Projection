 ...
 * @since windows6.0.6000
 */
export NdfCreateWinSockIncident(sock, host, port, appId, userId) {
 ...
 * @since windows6.0.6000
 */
export NdfCreateWebIncident(url) {
 ...
 * @since windows6.0.6000
 */
export NdfCreateWebIncidentEx(url, useWinHTTP, moduleName) {
    url := url is String ? StrPtr(url) : url
 ...
 * @since windows6.0.6000
 */
export NdfCreateSharingIncident(UNCPath) {
 ...
 * @since windows6.0.6000
 */
export NdfCreateConnectivityIncident() {
 ...
 * @since windows8.0
 */
export NdfCreateNetConnectionIncident(id) {
    result := DllCall("NDFAPI.dll\NdfCreateNetConnectionIncident", "ptr*", &_handle := 0, Guid, id, "HRESULT")
    return _handle
}
 ...
 * @since windows6.1
 */
export NdfCreatePnrpIncident(cloudname, peername, diagnosePublish, appId) {
 ...
 * @since windows6.1
 */
export NdfCreateGroupingIncident(CloudName, GroupName, Identity, Invitation, Addresses, appId) {
    CloudName := CloudName is String ? StrPtr(CloudName) : CloudName
