 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nn-ndhelper-inetdiaghelperex
...
class INetDiagHelperEx extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nf-ndhelper-inetdiaghelperex-reconfirmlowhealth
     */
    ReconfirmLowHealth(celt, pResults, ppwszUpdatedDescription, pUpdatedStatus) {
        ...
        result := ComCall(3, this, "uint", celt, "ptr", pResults, ppwszUpdatedDescriptionMarshal, ppwszUpdatedDescription, pUpdatedStatusMarshal, pUpdatedStatus, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nf-ndhelper-inetdiaghelperex-setutilities
     */
     ...
     * This method is reserved for system use.
     * @returns {HRESULT} This method does not return a value.
     * @see https://learn.microsoft.com/windows/win32/api//content/ndhelper/nf-ndhelper-inetdiaghelperex-reproducefailure
     */
    ReproduceFailure() {
