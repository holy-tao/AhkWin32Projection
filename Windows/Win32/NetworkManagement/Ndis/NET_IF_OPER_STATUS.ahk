...
class NET_IF_OPER_STATUS extends Win32Enum {
     ...
     * Native name: NET_IF_OPER_STATUS_UP
     * @type {Integer (Int32)}
     */
    static UP => 1
     ...
     * Native name: NET_IF_OPER_STATUS_DOWN
     * @type {Integer (Int32)}
     */
    static DOWN => 2
     ...
     *      received.
     * Native name: NET_IF_OPER_STATUS_TESTING
     * @type {Integer (Int32)}
     */
    static TESTING => 3
     ...
     * Native name: NET_IF_OPER_STATUS_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 4
     ...
     * Native name: NET_IF_OPER_STATUS_DORMANT
     * @type {Integer (Int32)}
     */
    static DORMANT => 5
     ...
     * Native name: NET_IF_OPER_STATUS_NOT_PRESENT
     * @type {Integer (Int32)}
     */
    static NOT_PRESENT => 6
     ...
     *      state.
     * Native name: NET_IF_OPER_STATUS_LOWER_LAYER_DOWN
     * @type {Integer (Int32)}
     */
    static LOWER_LAYER_DOWN => 7
}
