 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windns/ns-windns-dns_recorda
        ...
        SOA{
            get {
                if(!this.HasProp("__SOA"))
                    this.__SOA := DNS_SOA_DATAA(0, this)
                return this.__SOA
            }
        }
        ...
        PTR{
            get {
                if(!this.HasProp("__PTR"))
                    this.__PTR := DNS_PTR_DATAA(0, this)
                return this.__PTR
            }
        }
        ...
        NS{
            get {
                if(!this.HasProp("__NS"))
                    this.__NS := DNS_PTR_DATAA(0, this)
                return this.__NS
            }
        }
        ...
        CNAME{
            get {
                if(!this.HasProp("__CNAME"))
                    this.__CNAME := DNS_PTR_DATAA(0, this)
                return this.__CNAME
            }
        }
        ...
        DNAME{
            get {
                if(!this.HasProp("__DNAME"))
                    this.__DNAME := DNS_PTR_DATAA(0, this)
                return this.__DNAME
            }
        }
        ...
        MB{
            get {
                if(!this.HasProp("__MB"))
                    this.__MB := DNS_PTR_DATAA(0, this)
                return this.__MB
            }
        }
        ...
        MD{
            get {
                if(!this.HasProp("__MD"))
                    this.__MD := DNS_PTR_DATAA(0, this)
                return this.__MD
            }
        }
        ...
        MF{
            get {
                if(!this.HasProp("__MF"))
                    this.__MF := DNS_PTR_DATAA(0, this)
                return this.__MF
            }
        }
        ...
        MG{
            get {
                if(!this.HasProp("__MG"))
                    this.__MG := DNS_PTR_DATAA(0, this)
                return this.__MG
            }
        }
        ...
        MR{
            get {
                if(!this.HasProp("__MR"))
                    this.__MR := DNS_PTR_DATAA(0, this)
                return this.__MR
            }
        }
        ...
        MINFO{
            get {
                if(!this.HasProp("__MINFO"))
                    this.__MINFO := DNS_MINFO_DATAA(0, this)
                return this.__MINFO
            }
        }
        ...
        RP{
            get {
                if(!this.HasProp("__RP"))
                    this.__RP := DNS_MINFO_DATAA(0, this)
                return this.__RP
            }
        }
        ...
        AFSDB{
            get {
                if(!this.HasProp("__AFSDB"))
                    this.__AFSDB := DNS_MX_DATAA(0, this)
                return this.__AFSDB
            }
        }
        ...
        HINFO{
            get {
                if(!this.HasProp("__HINFO"))
                    this.__HINFO := DNS_TXT_DATAA(0, this)
                return this.__HINFO
            }
        }
        ...
        ISDN{
            get {
                if(!this.HasProp("__ISDN"))
                    this.__ISDN := DNS_TXT_DATAA(0, this)
                return this.__ISDN
            }
        }
        ...
        TXT{
            get {
                if(!this.HasProp("__TXT"))
                    this.__TXT := DNS_TXT_DATAA(0, this)
                return this.__TXT
            }
        }
        ...
        X25{
            get {
                if(!this.HasProp("__X25"))
                    this.__X25 := DNS_TXT_DATAA(0, this)
                return this.__X25
            }
        }
        ...
        SIG{
            get {
                if(!this.HasProp("__SIG"))
                    this.__SIG := DNS_SIG_DATAA(0, this)
                return this.__SIG
            }
        }
        ...
        NXT{
            get {
                if(!this.HasProp("__NXT"))
                    this.__NXT := DNS_NXT_DATAA(0, this)
                return this.__NXT
            }
        }
        ...
        SRV{
            get {
                if(!this.HasProp("__SRV"))
                    this.__SRV := DNS_SRV_DATAA(0, this)
                return this.__SRV
            }
        }
        ...
        NAPTR{
            get {
                if(!this.HasProp("__NAPTR"))
                    this.__NAPTR := DNS_NAPTR_DATAA(0, this)
                return this.__NAPTR
            }
        }
        ...
        RRSIG{
            get {
                if(!this.HasProp("__RRSIG"))
                    this.__RRSIG := DNS_SIG_DATAA(0, this)
                return this.__RRSIG
            }
        }
        ...
        NSEC{
            get {
                if(!this.HasProp("__NSEC"))
                    this.__NSEC := DNS_NSEC_DATAA(0, this)
                return this.__NSEC
            }
        }
        ...
        TKEY{
            get {
                if(!this.HasProp("__TKEY"))
                    this.__TKEY := DNS_TKEY_DATAA(0, this)
                return this.__TKEY
            }
        }
        ...
        TSIG{
            get {
                if(!this.HasProp("__TSIG"))
                    this.__TSIG := DNS_TSIG_DATAA(0, this)
                return this.__TSIG
            }
        }
        ...
        WINSR{
            get {
                if(!this.HasProp("__WINSR"))
                    this.__WINSR := DNS_WINSR_DATAA(0, this)
                return this.__WINSR
            }
        }
        ...
        NBSTAT{
            get {
                if(!this.HasProp("__NBSTAT"))
                    this.__NBSTAT := DNS_WINSR_DATAA(0, this)
