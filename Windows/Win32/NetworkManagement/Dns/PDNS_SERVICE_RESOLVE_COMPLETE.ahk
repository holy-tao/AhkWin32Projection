 ...
 */
export default struct PDNS_SERVICE_RESOLVE_COMPLETE {
    value : IntPtr

    __value {
        set {
            if (value is PDNS_SERVICE_RESOLVE_COMPLETE) {
    ...
    /**
     * A PDNS_SERVICE_RESOLVE_COMPLETE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PDNS_SERVICE_RESOLVE_COMPLETE {
        /**
         * Creates a PDNS_SERVICE_RESOLVE_COMPLETE pointer that invokes the given AHK function when called.
