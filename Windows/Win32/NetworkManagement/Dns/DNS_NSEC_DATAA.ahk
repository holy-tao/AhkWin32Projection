 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//windns/ns-windns-dns_nsec_dataa
 * @namespace Windows.Win32.NetworkManagement.Dns
 * @version v4.0.30319
 * @charset ANSI
 */
class DNS_NSEC_DATAA extends Win32Struct
{
    static sizeof => 16
    ...
    pNextDomainName{
        get {
            if(!this.HasProp("__pNextDomainName"))
                this.__pNextDomainName := PSTR(this.ptr + 0)
