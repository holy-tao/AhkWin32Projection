 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//windns/ns-windns-dns_naptr_dataa
 * @namespace Windows.Win32.NetworkManagement.Dns
 * @version v4.0.30319
 * @charset ANSI
 */
class DNS_NAPTR_DATAA extends Win32Struct
{
    static sizeof => 40
    ...
    pService{
        get {
            if(!this.HasProp("__pService"))
                this.__pService := PSTR(this.ptr + 16)
    ...
    pRegularExpression{
        get {
            if(!this.HasProp("__pRegularExpression"))
                this.__pRegularExpression := PSTR(this.ptr + 24)
    ...
    pReplacement{
        get {
            if(!this.HasProp("__pReplacement"))
                this.__pReplacement := PSTR(this.ptr + 32)
