 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//windns/ns-windns-dns_soa_dataa
    ...
    pNamePrimaryServer{
        get {
            if(!this.HasProp("__pNamePrimaryServer"))
                this.__pNamePrimaryServer := PSTR(this.ptr + 0)
    ...
    pNameAdministrator{
        get {
            if(!this.HasProp("__pNameAdministrator"))
                this.__pNameAdministrator := PSTR(this.ptr + 8)
