 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmu/nc-fwpmu-fwpm_filter_change_callback0
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class FWPM_FILTER_CHANGE_CALLBACK0 extends IUnknown {
     ...
     * @param {Pointer<FWPM_FILTER_CHANGE0>} change 
