...
#Import ".\IPSEC_AGGREGATE_DROP_PACKET_STATISTICS1.ahk" { IPSEC_AGGREGATE_DROP_PACKET_STATISTICS1 }
...
#Import ".\IPSEC_TRAFFIC_STATISTICS1.ahk" { IPSEC_TRAFFIC_STATISTICS1 }
 ...
 */
export default struct IPSEC_STATISTICS1 {
    #StructPack 8
