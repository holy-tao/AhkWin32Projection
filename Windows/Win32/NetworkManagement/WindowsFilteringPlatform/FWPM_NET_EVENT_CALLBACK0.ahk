 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmu/nc-fwpmu-fwpm_net_event_callback0
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class FWPM_NET_EVENT_CALLBACK0 extends IUnknown {
     ...
     * @param {Pointer<FWPM_NET_EVENT1>} event 
