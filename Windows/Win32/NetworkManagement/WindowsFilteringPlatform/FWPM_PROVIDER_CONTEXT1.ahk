 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmtypes/ns-fwpmtypes-fwpm_provider_context1
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class FWPM_PROVIDER_CONTEXT1 extends Win32Struct
{
    static sizeof => 80
    ...
    /**
     * @type {Pointer<IPSEC_TRANSPORT_POLICY1>}
     */
    ...
    /**
     * @type {Pointer<IPSEC_TUNNEL_POLICY1>}
     */
    ikeQmTunnelPolicy {
        get => NumGet(this, 64, "ptr")
        set => NumPut("ptr", value, this, 64)
