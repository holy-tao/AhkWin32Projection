 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmu/nc-fwpmu-ipsec_sa_context_callback0
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class IPSEC_SA_CONTEXT_CALLBACK0 extends IUnknown {
     ...
     * @param {Pointer<IPSEC_SA_CONTEXT_CHANGE0>} change 
