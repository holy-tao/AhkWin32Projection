...
#Include .\FWPM_VSWITCH_EVENT_TYPE.ahk
    ...
    positionInfo {
        get {
            if(!this.HasProp("__positionInfo"))
                this.__positionInfo := FWPM_VSWITCH_EVENT0._positionInfo(16, this)
    ...
    reorderInfo {
        get {
            if(!this.HasProp("__reorderInfo"))
                this.__reorderInfo := FWPM_VSWITCH_EVENT0._reorderInfo(16, this)
