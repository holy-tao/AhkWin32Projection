    ...
    aggregateDropPacketStatistics{
        get {
            if(!this.HasProp("__aggregateDropPacketStatistics"))
                this.__aggregateDropPacketStatistics := IPSEC_AGGREGATE_DROP_PACKET_STATISTICS0(this.ptr + 72)
    ...
    inboundTrafficStatistics{
        get {
            if(!this.HasProp("__inboundTrafficStatistics"))
                this.__inboundTrafficStatistics := IPSEC_TRAFFIC_STATISTICS0(this.ptr + 112)
    ...
    outboundTrafficStatistics{
        get {
            if(!this.HasProp("__outboundTrafficStatistics"))
                this.__outboundTrafficStatistics := IPSEC_TRAFFIC_STATISTICS0(this.ptr + 160)
