 ...
 * @see https://docs.microsoft.com/windows/win32/api//iketypes/ns-iketypes-ikeext_keymodule_statistics0
    ...
    v4Statistics{
        get {
            if(!this.HasProp("__v4Statistics"))
                this.__v4Statistics := IKEEXT_IP_VERSION_SPECIFIC_KEYMODULE_STATISTICS0(this.ptr + 0)
    ...
    v6Statistics{
        get {
            if(!this.HasProp("__v6Statistics"))
                this.__v6Statistics := IKEEXT_IP_VERSION_SPECIFIC_KEYMODULE_STATISTICS0(this.ptr + 72)
