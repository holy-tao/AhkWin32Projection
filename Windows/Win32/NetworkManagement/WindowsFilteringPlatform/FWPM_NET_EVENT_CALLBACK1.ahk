 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmu/nc-fwpmu-fwpm_net_event_callback1
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class FWPM_NET_EVENT_CALLBACK1 extends IUnknown {
     ...
     * @param {Pointer<FWPM_NET_EVENT2>} event 
