...
class FWPM_VSWITCH_EVENT_TYPE extends Win32Enum {
     ...
     * Native name: FWPM_VSWITCH_EVENT_FILTER_ADD_TO_INCOMPLETE_LAYER
     * @type {Integer (Int32)}
     */
    static FILTER_ADD_TO_INCOMPLETE_LAYER => 0
     ...
     * Native name: FWPM_VSWITCH_EVENT_FILTER_ENGINE_NOT_IN_REQUIRED_POSITION
     * @type {Integer (Int32)}
     */
    static FILTER_ENGINE_NOT_IN_REQUIRED_POSITION => 1

    /**
     * The filter engine is being enabled for the vSwitch instance.
     * Native name: FWPM_VSWITCH_EVENT_ENABLED_FOR_INSPECTION
     * @type {Integer (Int32)}
     */
    static ENABLED_FOR_INSPECTION => 2

    /**
     * The filter engine is being disabled for the vSwitch instance.
     * Native name: FWPM_VSWITCH_EVENT_DISABLED_FOR_INSPECTION
     * @type {Integer (Int32)}
     */
    static DISABLED_FOR_INSPECTION => 3

    /**
     * The filter engine is being reordered and may not be in the
     *    required position to enforce committed filters.
     * Native name: FWPM_VSWITCH_EVENT_FILTER_ENGINE_REORDER
     * @type {Integer (Int32)}
     */
    static FILTER_ENGINE_REORDER => 4

    /**
     * Maximum value for testing purposes.
     * Native name: FWPM_VSWITCH_EVENT_MAX
     * @type {Integer (Int32)}
     */
    static MAX => 5
}
