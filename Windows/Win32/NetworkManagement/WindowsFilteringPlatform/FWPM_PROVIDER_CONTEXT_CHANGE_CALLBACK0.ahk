 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fwpmu/nc-fwpmu-fwpm_provider_context_change_callback0
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 * @version v4.0.30319
 */
class FWPM_PROVIDER_CONTEXT_CHANGE_CALLBACK0 extends IUnknown {
     ...
     * @param {Pointer<FWPM_PROVIDER_CONTEXT_CHANGE0>} change 
