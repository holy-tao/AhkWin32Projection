...
#Include .\IKEEXT_CERTIFICATE_CREDENTIAL0.ahk
 ...
 */
class IKEEXT_CREDENTIAL0 extends Win32Struct {
    static sizeof => 16
    ...
    /**
     * @type {Pointer<IKEEXT_PRESHARED_KEY_AUTHENTICATION0>}
     */
    presharedKey {
    ...
    /**
     * @type {Pointer<IKEEXT_CERTIFICATE_CREDENTIAL0>}
     */
    certificate {
        get => NumGet(this, 8, "ptr")
        set => NumPut("ptr", value, this, 8)
