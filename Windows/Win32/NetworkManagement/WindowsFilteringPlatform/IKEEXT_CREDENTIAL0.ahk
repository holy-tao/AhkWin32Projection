 ...
 * @see https://learn.microsoft.com/windows/win32/api/iketypes/ns-iketypes-ikeext_credential0
 * @namespace Windows.Win32.NetworkManagement.WindowsFilteringPlatform
 */
export default struct IKEEXT_CREDENTIAL0 {
    #StructPack 8
    ...
    presharedKey : IKEEXT_PRESHARED_KEY_AUTHENTICATION0.Ptr

    static __New() {
        DefineProp(this.Prototype, 'certificate', { type: IKEEXT_CERTIFICATE_CREDENTIAL0.Ptr, offset: 8 })
