 ...
 * @see https://learn.microsoft.com/windows/win32/api/traffic/nc-traffic-tci_mod_flow_complete_handler
 * @namespace Windows.Win32.NetworkManagement.QoS
 */
export default struct TCI_MOD_FLOW_COMPLETE_HANDLER {
    value : IntPtr

    __value {
        set {
            if (value is TCI_MOD_FLOW_COMPLETE_HANDLER) {
    ...
    /**
     * A TCI_MOD_FLOW_COMPLETE_HANDLER that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends TCI_MOD_FLOW_COMPLETE_HANDLER {
        /**
         * Creates a TCI_MOD_FLOW_COMPLETE_HANDLER pointer that invokes the given AHK function when called.
