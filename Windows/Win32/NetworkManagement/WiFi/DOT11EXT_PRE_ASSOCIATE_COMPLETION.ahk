 ...
 * @version v4.0.30319
 */
class DOT11EXT_PRE_ASSOCIATE_COMPLETION extends IUnknown {
     ...
     */
    Invoke(hDot11SvcHandle, hConnectSession, dwReasonCode, dwWin32Error) {
        ...
        result := ComCall(3, this, "ptr", hDot11SvcHandle, "ptr", hConnectSession, "uint", dwReasonCode, "uint", dwWin32Error, "uint")
        return result
    }
}
