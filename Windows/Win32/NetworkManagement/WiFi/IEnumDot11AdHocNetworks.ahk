 ...
 * @see https://learn.microsoft.com/windows/win32/api/adhoc/nn-adhoc-ienumdot11adhocnetworks
 * @namespace Windows.Win32.NetworkManagement.WiFi
 */
export default struct IEnumDot11AdHocNetworks extends IUnknown {
    /**
     ...
     * used for IEnumDot11AdHocNetworks interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumDot11AdHocNetworks.Vtbl()
        }
