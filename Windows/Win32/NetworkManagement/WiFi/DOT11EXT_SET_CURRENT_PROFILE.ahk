 ...
 * @version v4.0.30319
 */
class DOT11EXT_SET_CURRENT_PROFILE extends IUnknown {
     ...
     */
    Invoke(hDot11SvcHandle, hConnectSession, pIhvConnProfile, pIhvSecProfile) {
        ...
        result := ComCall(3, this, "ptr", hDot11SvcHandle, "ptr", hConnectSession, "ptr", pIhvConnProfile, "ptr", pIhvSecProfile, "uint")
        return result
    }
}
