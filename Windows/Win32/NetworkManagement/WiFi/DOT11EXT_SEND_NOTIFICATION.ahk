 ...
 * @version v4.0.30319
 */
class DOT11EXT_SEND_NOTIFICATION extends IUnknown {
     ...
     */
    Invoke(hDot11SvcHandle, pNotificationData) {
        hDot11SvcHandle := hDot11SvcHandle is Win32Handle ? NumGet(hDot11SvcHandle, "ptr") : hDot11SvcHandle

        result := ComCall(3, this, "ptr", hDot11SvcHandle, "ptr", pNotificationData, "uint")
        return result
    }
}
