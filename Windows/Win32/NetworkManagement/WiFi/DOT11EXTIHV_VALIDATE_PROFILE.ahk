...
export default struct DOT11EXTIHV_VALIDATE_PROFILE {
    ...
    Call(hIhvExtAdapter, pIhvProfileParams, pIhvConnProfile, pIhvSecProfile, pdwReasonCode) {
        ...
        result := DllCall(this.value, hIhvExtAdapterMarshal, hIhvExtAdapter, pIhvProfileParamsMarshal, pIhvProfileParams, DOT11EXT_IHV_CONNECTIVITY_PROFILE.Ptr, pIhvConnProfile, DOT11EXT_IHV_SECURITY_PROFILE.Ptr, pIhvSecProfile, pdwReasonCodeMarshal, pdwReasonCode, UInt32)
        return result
    }
