 ...
 * @version v4.0.30319
 */
class DOT11EXTIHV_VALIDATE_PROFILE extends IUnknown {
     ...
     */
    Invoke(hIhvExtAdapter, pIhvProfileParams, pIhvConnProfile, pIhvSecProfile, pdwReasonCode) {
        ...
        result := ComCall(3, this, "ptr", hIhvExtAdapter, "ptr", pIhvProfileParams, "ptr", pIhvConnProfile, "ptr", pIhvSecProfile, pdwReasonCodeMarshal, pdwReasonCode, "uint")
        return result
    }
}
