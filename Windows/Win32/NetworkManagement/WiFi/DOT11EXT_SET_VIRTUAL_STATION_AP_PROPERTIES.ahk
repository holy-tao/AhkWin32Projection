 ...
 * @version v4.0.30319
 */
class DOT11EXT_SET_VIRTUAL_STATION_AP_PROPERTIES extends IUnknown {
     ...
     */
    Invoke(hDot11SvcHandle, hConnectSession, dwNumProperties, pProperties) {
        ...
        result := ComCall(3, this, "ptr", hDot11SvcHandle, "ptr", hConnectSession, "uint", dwNumProperties, "ptr", pProperties, "ptr", pvReserved, "uint")
        return result
    }
}
