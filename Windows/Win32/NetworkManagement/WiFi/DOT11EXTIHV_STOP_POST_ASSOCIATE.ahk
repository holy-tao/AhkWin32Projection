 ...
 * @version v4.0.30319
 */
class DOT11EXTIHV_STOP_POST_ASSOCIATE extends IUnknown {
     ...
     */
    Invoke(hIhvExtAdapter, pPeer, dot11AssocStatus) {
        ...
        result := ComCall(3, this, "ptr", hIhvExtAdapter, pPeerMarshal, pPeer, "uint", dot11AssocStatus, "uint")
        return result
    }
}
