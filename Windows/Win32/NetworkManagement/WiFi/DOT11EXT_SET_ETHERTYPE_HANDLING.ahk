 ...
 * @version v4.0.30319
 */
class DOT11EXT_SET_ETHERTYPE_HANDLING extends IUnknown {
     ...
     */
    Invoke(hDot11SvcHandle, uMaxBackLog, uNumOfExemption, pExemption, uNumOfRegistration, pusRegistration) {
        ...
        result := ComCall(3, this, "ptr", hDot11SvcHandle, "uint", uMaxBackLog, "uint", uNumOfExemption, "ptr", pExemption, "uint", uNumOfRegistration, pusRegistrationMarshal, pusRegistration, "uint")
        return result
    }
}
