...
class WLAN_SECURABLE_OBJECT extends Win32Enum {
     ...
     * Native name: wlan_secure_permit_list
     * @type {Integer (Int32)}
     */
    static secure_permit_list => 0
     ...
     * Native name: wlan_secure_deny_list
     * @type {Integer (Int32)}
     */
    static secure_deny_list => 1
     ...
     * Native name: wlan_secure_ac_enabled
     * @type {Integer (Int32)}
     */
    static secure_ac_enabled => 2
     ...
     * Native name: wlan_secure_bc_scan_enabled
     * @type {Integer (Int32)}
     */
    static secure_bc_scan_enabled => 3
     ...
     * Native name: wlan_secure_bss_type
     * @type {Integer (Int32)}
     */
    static secure_bss_type => 4
     ...
     * Native name: wlan_secure_show_denied
     * @type {Integer (Int32)}
     */
    static secure_show_denied => 5
     ...
     * Native name: wlan_secure_interface_properties
     * @type {Integer (Int32)}
     */
    static secure_interface_properties => 6
     ...
     * Native name: wlan_secure_ihv_control
     * @type {Integer (Int32)}
     */
    static secure_ihv_control => 7
     ...
     * Native name: wlan_secure_all_user_profiles_order
     * @type {Integer (Int32)}
     */
    static secure_all_user_profiles_order => 8
     ...
     * Native name: wlan_secure_add_new_all_user_profiles
     * @type {Integer (Int32)}
     */
    static secure_add_new_all_user_profiles => 9
     ...
     * Native name: wlan_secure_add_new_per_user_profiles
     * @type {Integer (Int32)}
     */
    static secure_add_new_per_user_profiles => 10
     ...
     * Native name: wlan_secure_media_streaming_mode_enabled
     * @type {Integer (Int32)}
     */
    static secure_media_streaming_mode_enabled => 11
     ...
     * Native name: wlan_secure_current_operation_mode
     * @type {Integer (Int32)}
     */
    static secure_current_operation_mode => 12
     ...
     * Native name: wlan_secure_get_plaintext_key
     * @type {Integer (Int32)}
     */
    static secure_get_plaintext_key => 13
     ...
     * 
     * <b>Windows 7:  </b>This value is an extension to native wireless APIs added on Windows 7 and  later.
     * Native name: wlan_secure_hosted_network_elevated_access
     * @type {Integer (Int32)}
     */
    static secure_hosted_network_elevated_access => 14

    /**
     * <b>Windows 7:  </b>This value is an extension to native wireless APIs added on Windows 7 and  later.
     * Native name: wlan_secure_virtual_station_extensibility
     * @type {Integer (Int32)}
     */
    static secure_virtual_station_extensibility => 15
     ...
     * Native name: wlan_secure_wfd_elevated_access
     * @type {Integer (Int32)}
     */
    static secure_wfd_elevated_access => 16

    /**
     * Native name: WLAN_SECURABLE_OBJECT_COUNT
     * @type {Integer (Int32)}
     */
    static COUNT => 17
}
