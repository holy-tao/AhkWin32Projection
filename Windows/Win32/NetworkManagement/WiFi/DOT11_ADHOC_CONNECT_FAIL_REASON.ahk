...
class DOT11_ADHOC_CONNECT_FAIL_REASON extends Win32Enum {
     ...
     * Native name: DOT11_ADHOC_CONNECT_FAIL_DOMAIN_MISMATCH
     * @type {Integer (Int32)}
     */
    static DOMAIN_MISMATCH => 0

    /**
     * The passphrase supplied to authenticate the local machine or user on the target network is incorrect.
     * Native name: DOT11_ADHOC_CONNECT_FAIL_PASSPHRASE_MISMATCH
     * @type {Integer (Int32)}
     */
    static PASSPHRASE_MISMATCH => 1

    /**
     * The connection failed for another reason.
     * Native name: DOT11_ADHOC_CONNECT_FAIL_OTHER
     * @type {Integer (Int32)}
     */
    static OTHER => 2
}
