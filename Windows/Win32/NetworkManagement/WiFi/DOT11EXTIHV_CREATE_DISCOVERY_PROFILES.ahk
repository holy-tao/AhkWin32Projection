 ...
 * @version v4.0.30319
 */
class DOT11EXTIHV_CREATE_DISCOVERY_PROFILES extends IUnknown {
     ...
     */
    Invoke(hIhvExtAdapter, bInsecure, pIhvProfileParams, pConnectableBssid, pIhvDiscoveryProfileList, pdwReasonCode) {
        ...
        result := ComCall(3, this, "ptr", hIhvExtAdapter, "int", bInsecure, "ptr", pIhvProfileParams, "ptr", pConnectableBssid, "ptr", pIhvDiscoveryProfileList, pdwReasonCodeMarshal, pdwReasonCode, "uint")
        return result
    }
}
