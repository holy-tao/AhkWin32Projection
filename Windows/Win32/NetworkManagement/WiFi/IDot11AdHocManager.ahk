...
class IDot11AdHocManager extends IUnknown{
     ...
     * @param {Pointer<IDot11AdHocInterface>} pInterface 
     * @param {Pointer<IDot11AdHocSecuritySettings>} pSecurity 
    ...
    CreateNetwork(Name, Password, GeographicalId, pInterface, pSecurity, pContextGuid, pIAdHoc) {
        ...
        result := ComCall(3, this, "ptr", Name, "ptr", Password, "int", GeographicalId, "ptr", pInterface, "ptr", pSecurity, "ptr", pContextGuid, "ptr", pIAdHoc, "int")
        if(result != 0)
    ...
    GetIEnumDot11AdHocNetworks(pContextGuid, ppEnum) {
        result := ComCall(5, this, "ptr", pContextGuid, "ptr", ppEnum, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNetwork(NetworkSignature, pNetwork) {
        result := ComCall(7, this, "ptr", NetworkSignature, "ptr", pNetwork, "int")
        if(result != 0)
            throw OSError(result)
