 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nn-adhoc-idot11adhocmanager
...
class IDot11AdHocManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nf-adhoc-idot11adhocmanager-createnetwork
     */
    CreateNetwork(Name, Password, GeographicalId, pInterface, pSecurity, pContextGuid) {
        ...
        result := ComCall(3, this, "ptr", Name, "ptr", Password, "int", GeographicalId, "ptr", pInterface, "ptr", pSecurity, "ptr", pContextGuid, "ptr*", &pIAdHoc := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nf-adhoc-idot11adhocmanager-commitcreatednetwork
     */
    CommitCreatedNetwork(pIAdHoc, fSaveProfile, fMakeSavedProfileUserSpecific) {
        result := ComCall(4, this, "ptr", pIAdHoc, "char", fSaveProfile, "char", fMakeSavedProfileUserSpecific, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nf-adhoc-idot11adhocmanager-getienumdot11adhocnetworks
     */
    GetIEnumDot11AdHocNetworks(pContextGuid) {
        result := ComCall(5, this, "ptr", pContextGuid, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nf-adhoc-idot11adhocmanager-getienumdot11adhocinterfaces
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/adhoc/nf-adhoc-idot11adhocmanager-getnetwork
     */
    GetNetwork(NetworkSignature) {
        result := ComCall(7, this, "ptr", NetworkSignature, "ptr*", &pNetwork := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
