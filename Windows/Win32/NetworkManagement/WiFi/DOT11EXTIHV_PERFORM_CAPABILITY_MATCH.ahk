 ...
 * @version v4.0.30319
 */
class DOT11EXTIHV_PERFORM_CAPABILITY_MATCH extends IUnknown {
     ...
     */
    Invoke(hIhvExtAdapter, pIhvProfileParams, pIhvConnProfile, pIhvSecProfile, pConnectableBssid, pdwReasonCode) {
        ...
        result := ComCall(3, this, "ptr", hIhvExtAdapter, "ptr", pIhvProfileParams, "ptr", pIhvConnProfile, "ptr", pIhvSecProfile, "ptr", pConnectableBssid, pdwReasonCodeMarshal, pdwReasonCode, "uint")
        return result
    }
}
