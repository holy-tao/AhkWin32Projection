 ...
 * @version v4.0.30319
 */
class DOT11EXTIHV_INIT_ADAPTER extends IUnknown {
     ...
     */
    Invoke(pDot11Adapter, hDot11SvcHandle, phIhvExtAdapter) {
        hDot11SvcHandle := hDot11SvcHandle is Win32Handle ? NumGet(hDot11SvcHandle, "ptr") : hDot11SvcHandle

        result := ComCall(3, this, "ptr", pDot11Adapter, "ptr", hDot11SvcHandle, "ptr", phIhvExtAdapter, "uint")
        return result
    }
}
