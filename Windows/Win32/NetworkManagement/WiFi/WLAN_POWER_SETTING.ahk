...
class WLAN_POWER_SETTING extends Win32Enum {
     ...
     * Native name: wlan_power_setting_no_saving
     * @type {Integer (Int32)}
     */
    static no_saving => 0
     ...
     * Native name: wlan_power_setting_low_saving
     * @type {Integer (Int32)}
     */
    static low_saving => 1
     ...
     * Native name: wlan_power_setting_medium_saving
     * @type {Integer (Int32)}
     */
    static medium_saving => 2
     ...
     * Native name: wlan_power_setting_maximum_saving
     * @type {Integer (Int32)}
     */
    static maximum_saving => 3

    /**
     * The supplied power setting is invalid.
     * Native name: wlan_power_setting_invalid
     * @type {Integer (Int32)}
     */
    static invalid => 4
}
