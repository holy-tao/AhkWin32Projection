 ...
 */
export default struct DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA {
    value : IntPtr

    __value {
        set {
            if (value is DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA) {
     ...
     * @param {Pointer<Integer>} pdwDataSize 
    ...
    /**
     * A DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA {
        /**
         * Creates a DOT11EXT_GET_PROFILE_CUSTOM_USER_DATA pointer that invokes the given AHK function when called.
         * @param {Func(HANDLE, HANDLE, UInt32, "uint*", "ptr*") => UInt32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 5)) {
