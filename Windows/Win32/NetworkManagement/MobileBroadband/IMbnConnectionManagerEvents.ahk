 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnconnectionmanagerevents
...
class IMbnConnectionManagerEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionmanagerevents-onconnectionarrival
     */
    OnConnectionArrival(newConnection) {
        result := ComCall(3, this, "ptr", newConnection, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionmanagerevents-onconnectionremoval
     */
    OnConnectionRemoval(oldConnection) {
        result := ComCall(4, this, "ptr", oldConnection, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
