 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnconnectionprofilemanager
...
class IMbnConnectionProfileManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionprofilemanager-getconnectionprofiles
     */
    GetConnectionProfiles(mbnInterface) {
        result := ComCall(3, this, "ptr", mbnInterface, "ptr*", &connectionProfiles := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionprofilemanager-getconnectionprofile
     */
    GetConnectionProfile(mbnInterface, profileName) {
        profileName := profileName is String ? StrPtr(profileName) : profileName

        result := ComCall(4, this, "ptr", mbnInterface, "ptr", profileName, "ptr*", &connectionProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionprofilemanager-createconnectionprofile
     */
    CreateConnectionProfile(xmlProfile) {
        xmlProfile := xmlProfile is String ? StrPtr(xmlProfile) : xmlProfile

        result := ComCall(5, this, "ptr", xmlProfile, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
