 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnsignal
...
class IMbnSignal extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsignal-getsignalstrength
     */
    GetSignalStrength() {
        result := ComCall(3, this, "uint*", &signalStrength := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsignal-getsignalerror
     */
    GetSignalError() {
        result := ComCall(4, this, "uint*", &signalError := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
