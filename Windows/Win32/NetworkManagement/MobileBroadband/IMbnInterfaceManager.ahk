 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbninterfacemanager
...
class IMbnInterfaceManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterfacemanager-getinterface
     */
    GetInterface(interfaceID) {
        interfaceID := interfaceID is String ? StrPtr(interfaceID) : interfaceID

        result := ComCall(3, this, "ptr", interfaceID, "ptr*", &mbnInterface := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterfacemanager-getinterfaces
     */
    GetInterfaces() {
        result := ComCall(4, this, "ptr*", &mbnInterfaces := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
