 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnconnectionprofilemanagerevents
...
class IMbnConnectionProfileManagerEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionprofilemanagerevents-onconnectionprofilearrival
     */
    OnConnectionProfileArrival(newConnectionProfile) {
        result := ComCall(3, this, "ptr", newConnectionProfile, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectionprofilemanagerevents-onconnectionprofileremoval
     */
    OnConnectionProfileRemoval(oldConnectionProfile) {
        result := ComCall(4, this, "ptr", oldConnectionProfile, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
