 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbninterfacemanagerevents
...
class IMbnInterfaceManagerEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterfacemanagerevents-oninterfacearrival
     */
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterfacemanagerevents-oninterfaceremoval
     */
    OnInterfaceRemoval(oldInterface) {
        result := ComCall(4, this, "ptr", oldInterface, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
