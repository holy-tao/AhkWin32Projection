 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnsmsreadmsgtextcdma
...
class IMbnSmsReadMsgTextCdma extends IUnknown{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_index
     */
    get_Index() {
        result := ComCall(3, this, "uint*", &Index := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_status
     */
    get_Status() {
        result := ComCall(4, this, "int*", &Status_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_address
     */
    get_Address() {
        Address_ := BSTR()
        result := ComCall(5, this, "ptr", Address_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_timestamp
     */
    get_Timestamp() {
        Timestamp_ := BSTR()
        result := ComCall(6, this, "ptr", Timestamp_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_encodingid
     */
    get_EncodingID() {
        result := ComCall(7, this, "int*", &EncodingID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_languageid
     */
    get_LanguageID() {
        result := ComCall(8, this, "int*", &LanguageID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_sizeincharacters
     */
    get_SizeInCharacters() {
        result := ComCall(9, this, "uint*", &SizeInCharacters := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgtextcdma-get_message
     */
    get_Message() {
        result := ComCall(10, this, "ptr*", &Message := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
