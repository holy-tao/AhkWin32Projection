 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnregistrationevents
...
class IMbnRegistrationEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnregistrationevents-onregistermodeavailable
     */
     ...
     * @param {IMbnRegistration} newInterface Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbnregistration">IMbnRegistration</a> interface that represents the applicable device.
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnregistrationevents-onregisterstatechange
     */
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnregistrationevents-onpacketservicestatechange
     */
     ...
     * </table>
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnregistrationevents-onsetregistermodecomplete
     */
    OnSetRegisterModeComplete(newInterface, requestID, status_) {
        result := ComCall(6, this, "ptr", newInterface, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
