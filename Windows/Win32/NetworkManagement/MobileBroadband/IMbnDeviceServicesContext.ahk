 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbndeviceservicescontext
...
class IMbnDeviceServicesContext extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbndeviceservicescontext-enumeratedeviceservices
     */
    EnumerateDeviceServices() {
        result := ComCall(3, this, "ptr*", &deviceServices := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbndeviceservicescontext-getdeviceservice
     */
    GetDeviceService(deviceServiceID) {
        if(deviceServiceID is String) {
            pin := BSTR.Alloc(deviceServiceID)
            deviceServiceID := pin.Value
        }

        result := ComCall(4, this, "ptr", deviceServiceID, "ptr*", &mbnDeviceService := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbndeviceservicescontext-get_maxcommandsize
     */
    get_MaxCommandSize() {
        result := ComCall(5, this, "uint*", &maxCommandSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbndeviceservicescontext-get_maxdatasize
     */
    get_MaxDataSize() {
        result := ComCall(6, this, "uint*", &maxDataSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
