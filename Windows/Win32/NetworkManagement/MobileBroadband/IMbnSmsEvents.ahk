 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnsmsevents
...
class IMbnSmsEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmsconfigurationchange
     */
    OnSmsConfigurationChange(sms) {
        result := ComCall(3, this, "ptr", sms, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsetsmsconfigurationcomplete
     */
    OnSetSmsConfigurationComplete(sms, requestID, status_) {
        result := ComCall(4, this, "ptr", sms, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HRESULT} status_ A status code that indicates the outcome of the operation.
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmssendcomplete
     */
    OnSmsSendComplete(sms, requestID, status_) {
        result := ComCall(5, this, "ptr", sms, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HRESULT} status_ A status code that indicates the outcome of the operation.
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmsreadcomplete
     */
    OnSmsReadComplete(sms, smsFormat, readMsgs, moreMsgs, requestID, status_) {
        result := ComCall(6, this, "ptr", sms, "int", smsFormat, "ptr", readMsgs, "short", moreMsgs, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmsnewclass0message
     */
    OnSmsNewClass0Message(sms, smsFormat, readMsgs) {
        result := ComCall(7, this, "ptr", sms, "int", smsFormat, "ptr", readMsgs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HRESULT} status_ A status code that indicates the outcome of the operation.
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmsdeletecomplete
     */
    OnSmsDeleteComplete(sms, requestID, status_) {
        result := ComCall(8, this, "ptr", sms, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsevents-onsmsstatuschange
     */
    OnSmsStatusChange(sms) {
        result := ComCall(9, this, "ptr", sms, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
