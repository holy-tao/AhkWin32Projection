 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnmulticarrierevents
...
class IMbnMultiCarrierEvents extends IUnknown{
     ...
     * @param {HRESULT} status_ A status code that indicates the outcome of <a href="https://docs.microsoft.com/windows/desktop/api/mbnapi/nf-mbnapi-imbnmulticarrier-sethomeprovider">SetHomeProvider</a>.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnmulticarrierevents-onsethomeprovidercomplete
     */
    OnSetHomeProviderComplete(mbnInterface, requestID, status_) {
        result := ComCall(3, this, "ptr", mbnInterface, "uint", requestID, "int", status_, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnmulticarrierevents-oncurrentcellularclasschange
     */
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnmulticarrierevents-onpreferredproviderschange
     */
     ...
     * @param {HRESULT} status_ A status code that indicates the outcome of <a href="https://docs.microsoft.com/windows/desktop/api/mbnapi/nf-mbnapi-imbnmulticarrier-scannetwork">ScanNetwork</a>.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * </table>
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnmulticarrierevents-onscannetworkcomplete
     */
    OnScanNetworkComplete(mbnInterface, requestID, status_) {
        result := ComCall(6, this, "ptr", mbnInterface, "uint", requestID, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method must return <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnmulticarrierevents-oninterfacecapabilitychange
     */
