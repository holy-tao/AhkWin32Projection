 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnsmsreadmsgpdu
...
class IMbnSmsReadMsgPdu extends IUnknown{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgpdu-get_index
     */
    get_Index() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgpdu-get_status
     */
    get_Status() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgpdu-get_pdudata
     */
    get_PduData() {
        PduData := BSTR()
        result := ComCall(5, this, "ptr", PduData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnsmsreadmsgpdu-get_message
     */
    get_Message() {
        result := ComCall(6, this, "ptr*", &Message := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
