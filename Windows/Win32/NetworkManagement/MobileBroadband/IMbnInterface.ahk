 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbninterface
...
class IMbnInterface extends IUnknown{
     ...
     * The interface ID.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-get_interfaceid
     */
    get_InterfaceID() {
        InterfaceID := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getinterfacecapability
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getsubscriberinformation
     */
    GetSubscriberInformation() {
        result := ComCall(5, this, "ptr*", &subscriberInformation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getreadystate
     */
    GetReadyState() {
        result := ComCall(6, this, "int*", &readyState_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-inemergencymode
     */
    InEmergencyMode() {
        result := ComCall(7, this, "short*", &emergencyMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-gethomeprovider
     */
    GetHomeProvider() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getpreferredproviders
     */
    GetPreferredProviders() {
        result := ComCall(9, this, "ptr*", &preferredProviders := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-setpreferredproviders
     */
    SetPreferredProviders(preferredProviders) {
        result := ComCall(10, this, "ptr", preferredProviders, "uint*", &requestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getvisibleproviders
     */
    GetVisibleProviders(age) {
        ageMarshal := age is VarRef ? "uint*" : "ptr"

        result := ComCall(11, this, ageMarshal, age, "ptr*", &visibleProviders := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Pointer to the request ID set by the operating system for this request.  The asynchronous response will contain this same <i>requestID</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-scannetwork
     */
    ScanNetwork() {
        result := ComCall(12, this, "uint*", &requestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbninterface-getconnection
     */
    GetConnection() {
        result := ComCall(13, this, "ptr*", &mbnConnection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
