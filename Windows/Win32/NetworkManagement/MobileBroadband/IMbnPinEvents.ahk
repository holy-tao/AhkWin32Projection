...
class IMbnPinEvents extends IUnknown{
    ...
    OnEnableComplete(pin, pinInfo, requestID, status) {
        result := ComCall(3, this, "ptr", pin, "ptr", pinInfo, "uint", requestID, "int", status, "int")
        if(result != 0)
    ...
    OnDisableComplete(pin, pinInfo, requestID, status) {
        result := ComCall(4, this, "ptr", pin, "ptr", pinInfo, "uint", requestID, "int", status, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnEnterComplete(Pin, pinInfo, requestID, status) {
        result := ComCall(5, this, "ptr", Pin, "ptr", pinInfo, "uint", requestID, "int", status, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnChangeComplete(Pin, pinInfo, requestID, status) {
        result := ComCall(6, this, "ptr", Pin, "ptr", pinInfo, "uint", requestID, "int", status, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnUnblockComplete(Pin, pinInfo, requestID, status) {
        result := ComCall(7, this, "ptr", Pin, "ptr", pinInfo, "uint", requestID, "int", status, "int")
        if(result != 0)
            throw OSError(result)
