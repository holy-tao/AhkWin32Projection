 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnconnectioncontext
...
class IMbnConnectionContext extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectioncontext-getprovisionedcontexts
     */
    GetProvisionedContexts() {
        result := ComCall(3, this, "ptr*", &provisionedContexts := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnconnectioncontext-setprovisionedcontext
     */
    SetProvisionedContext(provisionedContexts, providerID) {
        providerID := providerID is String ? StrPtr(providerID) : providerID

        result := ComCall(4, this, "ptr", provisionedContexts, "ptr", providerID, "uint*", &requestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
