...
class IMbnServiceActivationEvents extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IMbnServiceActivation>} serviceActivation 
    ...
    OnActivationComplete(serviceActivation, vendorSpecificData, requestID, status, networkError) {
        result := ComCall(3, this, "ptr", serviceActivation, "ptr", vendorSpecificData, "uint", requestID, "int", status, "uint", networkError, "int")
        if(result != 0)
