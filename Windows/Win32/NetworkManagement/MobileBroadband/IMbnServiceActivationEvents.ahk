 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nn-mbnapi-imbnserviceactivationevents
...
class IMbnServiceActivationEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mbnapi/nf-mbnapi-imbnserviceactivationevents-onactivationcomplete
     */
    OnActivationComplete(serviceActivation, vendorSpecificData, requestID, status_, networkError) {
        result := ComCall(3, this, "ptr", serviceActivation, "ptr", vendorSpecificData, "uint", requestID, "int", status_, "uint", networkError, "int")
        if(result != 0) {
