 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nn-sdoias-isdodictionaryold
...
class ISdoDictionaryOld extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nf-sdoias-isdodictionaryold-enumattributes
     */
    EnumAttributes(Id) {
        pValues := VARIANT()
     ...
     *       information values.
     * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nf-sdoias-isdodictionaryold-getattributeinfo
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/oaidl/ns-oaidl-variant">VT_EMPTY</a> variant.
     * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nf-sdoias-isdodictionaryold-enumattributevalues
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nf-sdoias-isdodictionaryold-createattribute
     */
    CreateAttribute(Id) {
        result := ComCall(10, this, "uint", Id, "ptr*", &ppAttributeObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sdoias/nf-sdoias-isdodictionaryold-getattributeid
     */
    GetAttributeID(bstrAttributeName) {
        if(bstrAttributeName is String) {
            pin := BSTR.Alloc(bstrAttributeName)
            bstrAttributeName := pin.Value
        }

        result := ComCall(11, this, "ptr", bstrAttributeName, "uint*", &pId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
