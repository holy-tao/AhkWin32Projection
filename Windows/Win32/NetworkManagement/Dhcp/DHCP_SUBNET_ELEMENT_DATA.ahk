...
#Import ".\DHCP_IP_RESERVATION.ahk" { DHCP_IP_RESERVATION }
 ...
 */
export default struct DHCP_SUBNET_ELEMENT_DATA {
    #StructPack 8
    ...
    struct DHCP_SUBNET_ELEMENT_UNION {
        ...
        static __New() {
            ...
            DefineProp(this.Prototype, 'ReservedIp', { type: DHCP_IP_RESERVATION.Ptr, offset: 0 })
