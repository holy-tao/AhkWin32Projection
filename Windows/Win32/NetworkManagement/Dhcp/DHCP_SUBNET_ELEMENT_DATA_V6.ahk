 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dhcpsapi/ns-dhcpsapi-dhcp_subnet_element_data_v6
    ...
    Element{
        get {
            if(!this.HasProp("__Element"))
                this.__Element := %this.__Class%.DHCP_SUBNET_ELEMENT_UNION_V6(8, this)
