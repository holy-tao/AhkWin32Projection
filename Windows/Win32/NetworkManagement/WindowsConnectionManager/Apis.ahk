 ...
 * @since windows8.0
 */
export WcmQueryProperty(pInterface, strProfileName, _Property, pdwDataSize, ppData) {
 ...
 * @since windows8.0
 */
export WcmSetProperty(pInterface, strProfileName, _Property, dwDataSize, pbData) {
    static pReserved := 0 ;Reserved parameters must always be NULL
 ...
 * @since windows8.1
 */
export OnDemandGetRoutingHint(destinationHostName) {
 ...
 * @since windows8.1
 */
export OnDemandUnRegisterNotification(registrationHandle) {
    result := DllCall("OnDemandConnRouteHelper.dll\OnDemandUnRegisterNotification", HANDLE, registrationHandle, "HRESULT")
    return result
}
 ...
 */
export GetInterfaceContextTableForHostName(HostName, ProxyName, Flags, ConnectionProfileFilterRawData, ConnectionProfileFilterRawDataSize) {
 ...
 * @since windows10.0.10240
 */
export FreeInterfaceContextTable(InterfaceContextTable) {
    DllCall("OnDemandConnRouteHelper.dll\FreeInterfaceContextTable", NET_INTERFACE_CONTEXT_TABLE.Ptr, InterfaceContextTable)
}
