 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ras/nc-ras-pfnrassendbuffer
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class PFNRASSENDBUFFER extends IUnknown {
     ...
     */
    Invoke(hPort, pBuffer, dwSize) {
        hPort := hPort is Win32Handle ? NumGet(hPort, "ptr") : hPort

        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, "ptr", hPort, pBufferMarshal, pBuffer, "uint", dwSize, "uint")
        return result
    }
}
