 ...
 * @see https://learn.microsoft.com/windows/win32/api/ras/nc-ras-rasadfuncw
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @charset Unicode
 */
export default struct RASADFUNCW {
    value : IntPtr

    __value {
        set {
            if (value is RASADFUNCW) {
    ...
    /**
     * A RASADFUNCW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends RASADFUNCW {
        /**
         * Creates a RASADFUNCW pointer that invokes the given AHK function when called.
         * @param {Func(PWSTR, PWSTR, RASADPARAMS, "uint*") => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
