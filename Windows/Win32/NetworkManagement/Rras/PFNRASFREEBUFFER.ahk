 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ras/nc-ras-pfnrasfreebuffer
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class PFNRASFREEBUFFER extends IUnknown {
    ...
    Invoke(pBufer) {
        ...
        result := ComCall(3, this, pBuferMarshal, pBufer, "uint")
        return result
    }
}
