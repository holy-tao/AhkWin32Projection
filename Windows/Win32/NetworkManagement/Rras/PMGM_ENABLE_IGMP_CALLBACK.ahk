 ...
 * @see https://learn.microsoft.com/windows/win32/api/mgm/nc-mgm-pmgm_enable_igmp_callback
 * @namespace Windows.Win32.NetworkManagement.Rras
 */
export default struct PMGM_ENABLE_IGMP_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is PMGM_ENABLE_IGMP_CALLBACK) {
    ...
    /**
     * A PMGM_ENABLE_IGMP_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PMGM_ENABLE_IGMP_CALLBACK {
        /**
         * Creates a PMGM_ENABLE_IGMP_CALLBACK pointer that invokes the given AHK function when called.
