 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ras/nc-ras-rascustomdeleteentrynotifyfn
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class RasCustomDeleteEntryNotifyFn extends IUnknown {
     ...
     */
    Invoke(lpszPhonebook, lpszEntry, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", lpszPhonebook, "ptr", lpszEntry, "uint", dwFlags, "uint")
        return result
    }
}
