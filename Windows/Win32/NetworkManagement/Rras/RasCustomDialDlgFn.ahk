 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rasdlg/nc-rasdlg-rascustomdialdlgfn
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class RasCustomDialDlgFn extends IUnknown {
     ...
     * @param {PWSTR} lpszPhoneNumber 
     * @param {Pointer<RASDIALDLG>} lpInfo 
     * @param {Pointer<Void>} pvInfo 
     ...
     */
    Invoke(hInstDll, dwFlags, lpszPhonebook, lpszEntry, lpszPhoneNumber, lpInfo, pvInfo) {
        ...
        result := ComCall(3, this, "ptr", hInstDll, "uint", dwFlags, "ptr", lpszPhonebook, "ptr", lpszEntry, "ptr", lpszPhoneNumber, "ptr", lpInfo, pvInfoMarshal, pvInfo, "int")
        return result
    }
}
