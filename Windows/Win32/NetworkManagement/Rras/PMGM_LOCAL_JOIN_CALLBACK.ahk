 ...
 * @see https://learn.microsoft.com/windows/win32/api/mgm/nc-mgm-pmgm_local_join_callback
 * @namespace Windows.Win32.NetworkManagement.Rras
 */
export default struct PMGM_LOCAL_JOIN_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is PMGM_LOCAL_JOIN_CALLBACK) {
     ...
     * @param {Integer} dwIfIndex Specifies the interface on which the multicast data from the source should arrive.
    ...
    /**
     * A PMGM_LOCAL_JOIN_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PMGM_LOCAL_JOIN_CALLBACK {
        /**
         * Creates a PMGM_LOCAL_JOIN_CALLBACK pointer that invokes the given AHK function when called.
