 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mprapi/ns-mprapi-mpr_server_ex0
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class MPR_SERVER_EX0 extends Win32Struct
{
    static sizeof => 240
    ...
    ConfigParams{
        get {
            if(!this.HasProp("__ConfigParams"))
                this.__ConfigParams := MPRAPI_TUNNEL_CONFIG_PARAMS0(24, this)
