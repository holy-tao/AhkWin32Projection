 ...
 * @see https://docs.microsoft.com/windows/win32/api//mprapi/ns-mprapi-mpr_server_set_config_ex0
 * @namespace Windows.Win32.NetworkManagement.Rras
 * @version v4.0.30319
 */
class MPR_SERVER_SET_CONFIG_EX0 extends Win32Struct
{
    static sizeof => 224
    ...
    ConfigParams{
        get {
            if(!this.HasProp("__ConfigParams"))
                this.__ConfigParams := MPRAPI_TUNNEL_CONFIG_PARAMS0(this.ptr + 8)
