 ...
 * @version v4.0.30319
 */
class PF_NPEnumResource extends IUnknown {
     ...
     */
    Invoke(hEnum, lpcCount, lpBuffer, lpBufferSize) {
        ...
        result := ComCall(3, this, "ptr", hEnum, lpcCountMarshal, lpcCount, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, "uint")
        return result
    }
}
