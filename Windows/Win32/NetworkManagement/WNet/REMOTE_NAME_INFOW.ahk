 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winnetwk/ns-winnetwk-remote_name_infow
...
class REMOTE_NAME_INFOW extends Win32Struct
{
    ...
    lpConnectionName{
        get {
            if(!this.HasProp("__lpConnectionName"))
                this.__lpConnectionName := PWSTR(this.ptr + 8)
            return this.__lpConnectionName
        }
    }
    ...
    lpRemainingPath{
        get {
            if(!this.HasProp("__lpRemainingPath"))
                this.__lpRemainingPath := PWSTR(this.ptr + 16)
            return this.__lpRemainingPath
        }
    }
}
