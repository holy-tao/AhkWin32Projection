 ...
 * @version v4.0.30319
 */
class PF_NPGetConnection extends IUnknown {
     ...
     */
    Invoke(lpLocalName, lpRemoteName, lpnBufferLen) {
        ...
        result := ComCall(3, this, "ptr", lpLocalName, "ptr", lpRemoteName, lpnBufferLenMarshal, lpnBufferLen, "uint")
        return result
    }
}
