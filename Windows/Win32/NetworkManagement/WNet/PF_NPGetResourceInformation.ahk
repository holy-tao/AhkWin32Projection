 ...
 * @version v4.0.30319
 */
class PF_NPGetResourceInformation extends IUnknown {
     ...
     */
    Invoke(lpNetResource, lpBuffer, lpBufferSize, lplpSystem) {
        lpBufferSizeMarshal := lpBufferSize is VarRef ? "uint*" : "ptr"
        lplpSystemMarshal := lplpSystem is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", lpNetResource, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, lplpSystemMarshal, lplpSystem, "uint")
        return result
    }
}
