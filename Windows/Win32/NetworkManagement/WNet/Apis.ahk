 ...
 * @since windows5.0
 */
export WNetAddConnectionA(lpRemoteName, lpPassword, lpLocalName) {
 ...
 * @since windows5.0
 */
export WNetAddConnectionW(lpRemoteName, lpPassword, lpLocalName) {
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpLocalName := lpLocalName is String ? StrPtr(lpLocalName) : lpLocalName
 ...
 * @since windows5.0
 */
export WNetAddConnection2A(lpNetResource, lpPassword, lpUserName, dwFlags) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
 ...
 * @since windows5.0
 */
export WNetAddConnection2W(lpNetResource, lpPassword, lpUserName, dwFlags) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
 ...
 * @since windows5.0
 */
export WNetAddConnection3A(hwndOwner, lpNetResource, lpPassword, lpUserName, dwFlags) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
 ...
 * @since windows5.0
 */
export WNetAddConnection3W(hwndOwner, lpNetResource, lpPassword, lpUserName, dwFlags) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
...
export WNetAddConnection4A(hwndOwner, lpNetResource, pAuthBuffer, cbAuthBuffer, dwFlags, lpUseOptions, cbUseOptions) {
    result := DllCall("MPR.dll\WNetAddConnection4A", HWND, hwndOwner, NETRESOURCEA.Ptr, lpNetResource, "ptr", pAuthBuffer, "uint", cbAuthBuffer, NET_CONNECT_FLAGS, dwFlags, "ptr", lpUseOptions, "uint", cbUseOptions, WIN32_ERROR)
    return result
}
...
export WNetAddConnection4W(hwndOwner, lpNetResource, pAuthBuffer, cbAuthBuffer, dwFlags, lpUseOptions, cbUseOptions) {
    result := DllCall("MPR.dll\WNetAddConnection4W", HWND, hwndOwner, NETRESOURCEW.Ptr, lpNetResource, "ptr", pAuthBuffer, "uint", cbAuthBuffer, NET_CONNECT_FLAGS, dwFlags, "ptr", lpUseOptions, "uint", cbUseOptions, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetCancelConnectionA(lpName, fForce) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("MPR.dll\WNetCancelConnectionA", "ptr", lpName, BOOL, fForce, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetCancelConnectionW(lpName, fForce) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("MPR.dll\WNetCancelConnectionW", "ptr", lpName, BOOL, fForce, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetCancelConnection2A(lpName, dwFlags, fForce) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("MPR.dll\WNetCancelConnection2A", "ptr", lpName, NET_CONNECT_FLAGS, dwFlags, BOOL, fForce, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetCancelConnection2W(lpName, dwFlags, fForce) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("MPR.dll\WNetCancelConnection2W", "ptr", lpName, NET_CONNECT_FLAGS, dwFlags, BOOL, fForce, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetGetConnectionA(lpLocalName, lpRemoteName, lpnLength) {
    lpLocalName := lpLocalName is String ? StrPtr(lpLocalName) : lpLocalName
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName
 ...
 * @since windows5.0
 */
export WNetGetConnectionW(lpLocalName, lpRemoteName, lpnLength) {
    lpLocalName := lpLocalName is String ? StrPtr(lpLocalName) : lpLocalName
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName
 ...
 * @since windows5.0
 */
export WNetUseConnectionA(hwndOwner, lpNetResource, lpPassword, lpUserId, dwFlags, lpAccessName, lpBufferSize, lpResult) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
 ...
 * @since windows5.0
 */
export WNetUseConnectionW(hwndOwner, lpNetResource, lpPassword, lpUserId, dwFlags, lpAccessName, lpBufferSize, lpResult) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserId := lpUserId is String ? StrPtr(lpUserId) : lpUserId
    lpAccessName := lpAccessName is String ? StrPtr(lpAccessName) : lpAccessName
...
export WNetUseConnection4A(hwndOwner, lpNetResource, pAuthBuffer, cbAuthBuffer, dwFlags, lpUseOptions, cbUseOptions, lpAccessName, lpBufferSize, lpResult) {
    ...
    result := DllCall("MPR.dll\WNetUseConnection4A", HWND, hwndOwner, NETRESOURCEA.Ptr, lpNetResource, "ptr", pAuthBuffer, "uint", cbAuthBuffer, "uint", dwFlags, "ptr", lpUseOptions, "uint", cbUseOptions, "ptr", lpAccessName, lpBufferSizeMarshal, lpBufferSize, lpResultMarshal, lpResult, WIN32_ERROR)
    return result
}
...
export WNetUseConnection4W(hwndOwner, lpNetResource, pAuthBuffer, cbAuthBuffer, dwFlags, lpUseOptions, cbUseOptions, lpAccessName, lpBufferSize, lpResult) {
    ...
    result := DllCall("MPR.dll\WNetUseConnection4W", HWND, hwndOwner, NETRESOURCEW.Ptr, lpNetResource, "ptr", pAuthBuffer, "uint", cbAuthBuffer, "uint", dwFlags, "ptr", lpUseOptions, "uint", cbUseOptions, "ptr", lpAccessName, lpBufferSizeMarshal, lpBufferSize, lpResultMarshal, lpResult, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetConnectionDialog(_hwnd, dwType) {
    result := DllCall("MPR.dll\WNetConnectionDialog", HWND, _hwnd, "uint", dwType, WIN32_ERROR)
    return result
}
...
export WNetDisconnectDialog(_hwnd, dwType) {
    result := DllCall("MPR.dll\WNetDisconnectDialog", HWND, _hwnd, "uint", dwType, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetConnectionDialog1A(lpConnDlgStruct) {
    result := DllCall("MPR.dll\WNetConnectionDialog1A", CONNECTDLGSTRUCTA.Ptr, lpConnDlgStruct, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetConnectionDialog1W(lpConnDlgStruct) {
    result := DllCall("MPR.dll\WNetConnectionDialog1W", CONNECTDLGSTRUCTW.Ptr, lpConnDlgStruct, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetDisconnectDialog1A(lpConnDlgStruct) {
    result := DllCall("MPR.dll\WNetDisconnectDialog1A", DISCDLGSTRUCTA.Ptr, lpConnDlgStruct, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetDisconnectDialog1W(lpConnDlgStruct) {
    result := DllCall("MPR.dll\WNetDisconnectDialog1W", DISCDLGSTRUCTW.Ptr, lpConnDlgStruct, WIN32_ERROR)
    return result
}
...
export WNetEnumResourceA(hEnum, lpcCount, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetEnumResourceA", HANDLE, hEnum, lpcCountMarshal, lpcCount, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
...
export WNetEnumResourceW(hEnum, lpcCount, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetEnumResourceW", HANDLE, hEnum, lpcCountMarshal, lpcCount, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetCloseEnum(hEnum) {
    result := DllCall("MPR.dll\WNetCloseEnum", HANDLE, hEnum, WIN32_ERROR)
    return result
}
...
export WNetGetResourceParentA(lpNetResource, lpBuffer, lpcbBuffer) {
    ...
    result := DllCall("MPR.dll\WNetGetResourceParentA", NETRESOURCEA.Ptr, lpNetResource, "ptr", lpBuffer, lpcbBufferMarshal, lpcbBuffer, WIN32_ERROR)
    return result
}
...
export WNetGetResourceParentW(lpNetResource, lpBuffer, lpcbBuffer) {
    ...
    result := DllCall("MPR.dll\WNetGetResourceParentW", NETRESOURCEW.Ptr, lpNetResource, "ptr", lpBuffer, lpcbBufferMarshal, lpcbBuffer, WIN32_ERROR)
    return result
}
...
export WNetGetResourceInformationA(lpNetResource, lpBuffer, lpcbBuffer, lplpSystem) {
    ...
    result := DllCall("MPR.dll\WNetGetResourceInformationA", NETRESOURCEA.Ptr, lpNetResource, "ptr", lpBuffer, lpcbBufferMarshal, lpcbBuffer, lplpSystemMarshal, lplpSystem, WIN32_ERROR)
    return result
}
...
export WNetGetResourceInformationW(lpNetResource, lpBuffer, lpcbBuffer, lplpSystem) {
    ...
    result := DllCall("MPR.dll\WNetGetResourceInformationW", NETRESOURCEW.Ptr, lpNetResource, "ptr", lpBuffer, lpcbBufferMarshal, lpcbBuffer, lplpSystemMarshal, lplpSystem, WIN32_ERROR)
    return result
}
...
export WNetGetUniversalNameA(lpLocalPath, dwInfoLevel, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetGetUniversalNameA", "ptr", lpLocalPath, UNC_INFO_LEVEL, dwInfoLevel, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
...
export WNetGetUniversalNameW(lpLocalPath, dwInfoLevel, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetGetUniversalNameW", "ptr", lpLocalPath, UNC_INFO_LEVEL, dwInfoLevel, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetGetUserA(lpName, lpUserName, lpnLength) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
 ...
 * @since windows5.0
 */
export WNetGetUserW(lpName, lpUserName, lpnLength) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
...
export WNetGetProviderNameA(dwNetType, lpProviderName, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetGetProviderNameA", "uint", dwNetType, "ptr", lpProviderName, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
...
export WNetGetProviderNameW(dwNetType, lpProviderName, lpBufferSize) {
    ...
    result := DllCall("MPR.dll\WNetGetProviderNameW", "uint", dwNetType, "ptr", lpProviderName, lpBufferSizeMarshal, lpBufferSize, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetGetNetworkInformationA(lpProvider, lpNetInfoStruct) {
    lpProvider := lpProvider is String ? StrPtr(lpProvider) : lpProvider

    result := DllCall("MPR.dll\WNetGetNetworkInformationA", "ptr", lpProvider, NETINFOSTRUCT.Ptr, lpNetInfoStruct, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetGetNetworkInformationW(lpProvider, lpNetInfoStruct) {
    lpProvider := lpProvider is String ? StrPtr(lpProvider) : lpProvider

    result := DllCall("MPR.dll\WNetGetNetworkInformationW", "ptr", lpProvider, NETINFOSTRUCT.Ptr, lpNetInfoStruct, WIN32_ERROR)
    return result
}
 ...
 * @since windows5.0
 */
export WNetGetLastErrorA(lpError, lpErrorBuf, nErrorBufSize, lpNameBuf, nNameBufSize) {
    ...
    result := DllCall("MPR.dll\WNetGetLastErrorA", lpErrorMarshal, lpError, "ptr", lpErrorBuf, "uint", nErrorBufSize, "ptr", lpNameBuf, "uint", nNameBufSize, WIN32_ERROR)
    if(A_LastError) {
 ...
 * @since windows5.0
 */
export WNetGetLastErrorW(lpError, lpErrorBuf, nErrorBufSize, lpNameBuf, nNameBufSize) {
    lpErrorBuf := lpErrorBuf is String ? StrPtr(lpErrorBuf) : lpErrorBuf
    lpNameBuf := lpNameBuf is String ? StrPtr(lpNameBuf) : lpNameBuf
    ...
    result := DllCall("MPR.dll\WNetGetLastErrorW", lpErrorMarshal, lpError, "ptr", lpErrorBuf, "uint", nErrorBufSize, "ptr", lpNameBuf, "uint", nNameBufSize, WIN32_ERROR)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export MultinetGetConnectionPerformanceA(lpNetResource, lpNetConnectInfoStruct) {
    result := DllCall("MPR.dll\MultinetGetConnectionPerformanceA", NETRESOURCEA.Ptr, lpNetResource, NETCONNECTINFOSTRUCT.Ptr, lpNetConnectInfoStruct, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export MultinetGetConnectionPerformanceW(lpNetResource, lpNetConnectInfoStruct) {
    result := DllCall("MPR.dll\MultinetGetConnectionPerformanceW", NETRESOURCEW.Ptr, lpNetResource, NETCONNECTINFOSTRUCT.Ptr, lpNetConnectInfoStruct, UInt32)
    return result
}
 ...
 */
export NPAddConnection(lpNetResource, lpPassword, lpUserName) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
 ...
 * @since windows5.1.2600
 */
export NPAddConnection3(hwndOwner, lpNetResource, lpPassword, lpUserName, dwFlags) {
    lpPassword := lpPassword is String ? StrPtr(lpPassword) : lpPassword
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
...
export NPAddConnection4(hwndOwner, lpNetResource, lpAuthBuffer, cbAuthBuffer, dwFlags, lpUseOptions, cbUseOptions) {
    result := DllCall("NTLANMAN.dll\NPAddConnection4", HWND, hwndOwner, NETRESOURCEW.Ptr, lpNetResource, "ptr", lpAuthBuffer, "uint", cbAuthBuffer, "uint", dwFlags, "ptr", lpUseOptions, "uint", cbUseOptions, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPCancelConnection(lpName, fForce) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("davclnt.dll\NPCancelConnection", "ptr", lpName, BOOL, fForce, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export NPCancelConnection2(lpName, fForce, dwFlags) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("NTLANMAN.dll\NPCancelConnection2", "ptr", lpName, BOOL, fForce, "uint", dwFlags, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPGetConnection(lpLocalName, lpRemoteName, lpnBufferLen) {
    lpLocalName := lpLocalName is String ? StrPtr(lpLocalName) : lpLocalName
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName
...
export NPGetConnection3(lpLocalName, dwLevel, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("NTLANMAN.dll\NPGetConnection3", "ptr", lpLocalName, "uint", dwLevel, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, UInt32)
    return result
}
...
export NPGetUniversalName(lpLocalPath, dwInfoLevel, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("davclnt.dll\NPGetUniversalName", "ptr", lpLocalPath, UNC_INFO_LEVEL, dwInfoLevel, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPGetConnectionPerformance(lpRemoteName, lpNetConnectInfo) {
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName

    result := DllCall("NTLANMAN.dll\NPGetConnectionPerformance", "ptr", lpRemoteName, NETCONNECTINFOSTRUCT.Ptr, lpNetConnectInfo, UInt32)
    return result
}
...
export NPOpenEnum(dwScope, dwType, dwUsage, lpNetResource, lphEnum) {
    result := DllCall("davclnt.dll\NPOpenEnum", "uint", dwScope, "uint", dwType, "uint", dwUsage, NETRESOURCEW.Ptr, lpNetResource, HANDLE.Ptr, lphEnum, UInt32)
    return result
}
...
export NPEnumResource(hEnum, lpcCount, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("davclnt.dll\NPEnumResource", HANDLE, hEnum, lpcCountMarshal, lpcCount, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPCloseEnum(hEnum) {
    result := DllCall("davclnt.dll\NPCloseEnum", HANDLE, hEnum, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPGetCaps(ndex) {
    result := DllCall("davclnt.dll\NPGetCaps", "uint", ndex, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPGetUser(lpName, lpUserName, lpnBufferLen) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName
...
export NPGetPersistentUseOptionsForConnection(lpRemotePath, lpReadUseOptions, cbReadUseOptions, lpWriteUseOptions, lpSizeWriteUseOptions) {
    ...
    result := DllCall("NTLANMAN.dll\NPGetPersistentUseOptionsForConnection", "ptr", lpRemotePath, "ptr", lpReadUseOptions, "uint", cbReadUseOptions, "ptr", lpWriteUseOptions, lpSizeWriteUseOptionsMarshal, lpSizeWriteUseOptions, UInt32)
    return result
}
...
export NPGetResourceParent(lpNetResource, lpBuffer, lpBufferSize) {
    ...
    result := DllCall("davclnt.dll\NPGetResourceParent", NETRESOURCEW.Ptr, lpNetResource, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, UInt32)
    return result
}
...
export NPGetResourceInformation(lpNetResource, lpBuffer, lpBufferSize, lplpSystem) {
    ...
    result := DllCall("davclnt.dll\NPGetResourceInformation", NETRESOURCEW.Ptr, lpNetResource, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, lplpSystemMarshal, lplpSystem, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export NPFormatNetworkName(lpRemoteName, lpFormattedName, lpnLength, dwFlags, dwAveCharPerLine) {
    lpRemoteName := lpRemoteName is String ? StrPtr(lpRemoteName) : lpRemoteName
    lpFormattedName := lpFormattedName is String ? StrPtr(lpFormattedName) : lpFormattedName

    lpnLengthMarshal := lpnLength is VarRef ? "uint*" : "ptr"

    result := DllCall("davclnt.dll\NPFormatNetworkName", "ptr", lpRemoteName, "ptr", lpFormattedName, lpnLengthMarshal, lpnLength, NETWORK_NAME_FORMAT_FLAGS, dwFlags, "uint", dwAveCharPerLine, UInt32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export WNetSetLastErrorA(err, lpError, lpProviders) {
 ...
 */
export WNetSetLastErrorW(err, lpError, lpProviders) {
    lpError := lpError is String ? StrPtr(lpError) : lpError
    lpProviders := lpProviders is String ? StrPtr(lpProviders) : lpProviders
