 ...
 * @version v4.0.30319
 */
class PF_NPFormatNetworkName extends IUnknown {
     ...
     */
    Invoke(lpRemoteName, lpFormattedName, lpnLength, dwFlags, dwAveCharPerLine) {
        ...
        result := ComCall(3, this, "ptr", lpRemoteName, "ptr", lpFormattedName, lpnLengthMarshal, lpnLength, "uint", dwFlags, "uint", dwAveCharPerLine, "uint")
        return result
    }
}
