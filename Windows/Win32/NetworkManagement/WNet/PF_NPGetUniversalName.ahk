 ...
 * @version v4.0.30319
 */
class PF_NPGetUniversalName extends IUnknown {
     ...
     */
    Invoke(lpLocalPath, dwInfoLevel, lpBuffer, lpnBufferSize) {
        lpLocalPath := lpLocalPath is String ? StrPtr(lpLocalPath) : lpLocalPath

        lpnBufferSizeMarshal := lpnBufferSize is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", lpLocalPath, "uint", dwInfoLevel, "ptr", lpBuffer, lpnBufferSizeMarshal, lpnBufferSize, "uint")
        return result
    }
}
