 ...
 * @version v4.0.30319
 */
class PF_NPGetUser extends IUnknown {
     ...
     */
    Invoke(lpName, lpUserName, lpnBufferLen) {
        lpName := lpName is String ? StrPtr(lpName) : lpName
        lpUserName := lpUserName is String ? StrPtr(lpUserName) : lpUserName

        lpnBufferLenMarshal := lpnBufferLen is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", lpName, "ptr", lpUserName, lpnBufferLenMarshal, lpnBufferLen, "uint")
        return result
    }
}
