 ...
 * @version v4.0.30319
 */
class PF_NPAddConnection3 extends IUnknown {
     ...
     */
    Invoke(hwndOwner, lpNetResource, lpPassword, lpUserName, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hwndOwner, "ptr", lpNetResource, "ptr", lpPassword, "ptr", lpUserName, "uint", dwFlags, "uint")
        return result
    }
}
