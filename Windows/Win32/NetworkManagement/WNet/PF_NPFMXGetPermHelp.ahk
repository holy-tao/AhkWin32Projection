 ...
 * @version v4.0.30319
 */
class PF_NPFMXGetPermHelp extends IUnknown {
     ...
     */
    Invoke(lpDriveName, nDialogType, fDirectory, lpFileNameBuffer, lpBufferSize, lpnHelpContext) {
        ...
        result := ComCall(3, this, "ptr", lpDriveName, "uint", nDialogType, "int", fDirectory, lpFileNameBufferMarshal, lpFileNameBuffer, lpBufferSizeMarshal, lpBufferSize, lpnHelpContextMarshal, lpnHelpContext, "uint")
        return result
    }
}
