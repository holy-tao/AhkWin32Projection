 ...
 * @version v4.0.30319
 */
class PF_NPGetConnection3 extends IUnknown {
     ...
     */
    Invoke(lpLocalName, dwLevel, lpBuffer, lpBufferSize) {
        lpLocalName := lpLocalName is String ? StrPtr(lpLocalName) : lpLocalName

        lpBufferSizeMarshal := lpBufferSize is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", lpLocalName, "uint", dwLevel, "ptr", lpBuffer, lpBufferSizeMarshal, lpBufferSize, "uint")
        return result
    }
}
