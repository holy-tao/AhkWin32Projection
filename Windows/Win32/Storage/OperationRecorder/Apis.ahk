 ...
 * @since windows8.0
 */
export OperationStart(OperationStartParams) {
    result := DllCall("ADVAPI32.dll\OperationStart", OPERATION_START_PARAMETERS.Ptr, OperationStartParams, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export OperationEnd(OperationEndParams) {
    result := DllCall("ADVAPI32.dll\OperationEnd", OPERATION_END_PARAMETERS.Ptr, OperationEndParams, BOOL)
    return result
}
