...
class CF_REGISTER_FLAGS extends Win32BitflagEnum {
     ...
     * Native name: CF_REGISTER_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: CF_REGISTER_FLAG_UPDATE
     * @type {Integer (Int32)}
     */
    static FLAG_UPDATE => 1
     ...
     * Native name: CF_REGISTER_FLAG_DISABLE_ON_DEMAND_POPULATION_ON_ROOT
     * @type {Integer (Int32)}
     */
    static FLAG_DISABLE_ON_DEMAND_POPULATION_ON_ROOT => 2
     ...
     * Native name: CF_REGISTER_FLAG_MARK_IN_SYNC_ON_ROOT
     * @type {Integer (Int32)}
     */
    static FLAG_MARK_IN_SYNC_ON_ROOT => 4
}
