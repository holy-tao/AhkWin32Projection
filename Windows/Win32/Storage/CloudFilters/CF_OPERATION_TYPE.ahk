...
class CF_OPERATION_TYPE extends Win32Enum {
     ...
     * Native name: CF_OPERATION_TYPE_TRANSFER_DATA
     * @type {Integer (Int32)}
     */
    static TRANSFER_DATA => 0
     ...
     * Native name: CF_OPERATION_TYPE_RETRIEVE_DATA
     * @type {Integer (Int32)}
     */
    static RETRIEVE_DATA => 1
     ...
     * Native name: CF_OPERATION_TYPE_ACK_DATA
     * @type {Integer (Int32)}
     */
    static ACK_DATA => 2
     ...
     * Native name: CF_OPERATION_TYPE_RESTART_HYDRATION
     * @type {Integer (Int32)}
     */
    static RESTART_HYDRATION => 3
     ...
     * Native name: CF_OPERATION_TYPE_TRANSFER_PLACEHOLDERS
     * @type {Integer (Int32)}
     */
    static TRANSFER_PLACEHOLDERS => 4

    /**
     * Acknowledge and dehydrate a placeholder.
     * Native name: CF_OPERATION_TYPE_ACK_DEHYDRATE
     * @type {Integer (Int32)}
     */
    static ACK_DEHYDRATE => 5

    /**
     * Acknowledge and delete a placeholder.
     * Native name: CF_OPERATION_TYPE_ACK_DELETE
     * @type {Integer (Int32)}
     */
    static ACK_DELETE => 6
     ...
     * Native name: CF_OPERATION_TYPE_ACK_RENAME
     * @type {Integer (Int32)}
     */
    static ACK_RENAME => 7
}
