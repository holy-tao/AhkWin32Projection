...
;@region Methods
    ...
    static CfGetPlatformInfo(PlatformVersion) {
        result := DllCall("cldapi.dll\CfGetPlatformInfo", "ptr", PlatformVersion, "HRESULT")
        return result
    }
    ...
    static CfRegisterSyncRoot(SyncRootPath, Registration, Policies, RegisterFlags) {
        ...
        result := DllCall("cldapi.dll\CfRegisterSyncRoot", "ptr", SyncRootPath, "ptr", Registration, "ptr", Policies, "int", RegisterFlags, "HRESULT")
        return result
    }
    ...
    static CfUnregisterSyncRoot(SyncRootPath) {
        ...
        result := DllCall("cldapi.dll\CfUnregisterSyncRoot", "ptr", SyncRootPath, "HRESULT")
        return result
    }
    ...
    static CfDisconnectSyncRoot(ConnectionKey) {
        ...
        result := DllCall("cldapi.dll\CfDisconnectSyncRoot", "ptr", ConnectionKey, "HRESULT")
        return result
    }
    ...
    static CfGetTransferKey(FileHandle) {
        ...
        result := DllCall("cldapi.dll\CfGetTransferKey", "ptr", FileHandle, "int64*", &TransferKey := 0, "HRESULT")
        return TransferKey
    }
    ...
    static CfExecute(OpInfo, OpParams) {
        result := DllCall("cldapi.dll\CfExecute", "ptr", OpInfo, "ptr", OpParams, "HRESULT")
        return result
    }
    ...
    static CfUpdateSyncProviderStatus(ConnectionKey, ProviderStatus) {
        ...
        result := DllCall("cldapi.dll\CfUpdateSyncProviderStatus", "ptr", ConnectionKey, "uint", ProviderStatus, "HRESULT")
        return result
    }
    ...
    static CfQuerySyncProviderStatus(ConnectionKey) {
        ...
        result := DllCall("cldapi.dll\CfQuerySyncProviderStatus", "ptr", ConnectionKey, "uint*", &ProviderStatus := 0, "HRESULT")
    ...
    static CfReportSyncStatus(SyncRootPath, SyncStatus) {
        ...
        result := DllCall("cldapi.dll\CfReportSyncStatus", "ptr", SyncRootPath, "ptr", SyncStatus, "HRESULT")
        return result
    }
    ...
    static CfCreatePlaceholders(BaseDirectoryPath, PlaceholderArray, PlaceholderCount, CreateFlags) {
        ...
        result := DllCall("cldapi.dll\CfCreatePlaceholders", "ptr", BaseDirectoryPath, "ptr", PlaceholderArray, "uint", PlaceholderCount, "int", CreateFlags, "uint*", &EntriesProcessed := 0, "HRESULT")
    ...
    static CfSetInSyncState(FileHandle, InSyncState, InSyncFlags, InSyncUsn) {
        ...
        result := DllCall("cldapi.dll\CfSetInSyncState", "ptr", FileHandle, "int", InSyncState, "int", InSyncFlags, InSyncUsnMarshal, InSyncUsn, "HRESULT")
        return result
    }
    ...
    static CfSetCorrelationVector(FileHandle, CorrelationVector) {
        ...
        result := DllCall("cldapi.dll\CfSetCorrelationVector", "ptr", FileHandle, "ptr", CorrelationVector, "HRESULT")
        return result
    }
    ...
    static CfGetCorrelationVector(FileHandle, CorrelationVector) {
        ...
        result := DllCall("cldapi.dll\CfGetCorrelationVector", "ptr", FileHandle, "ptr", CorrelationVector, "HRESULT")
        return result
    }
    ...
    static CfGetPlaceholderInfo(FileHandle, InfoClass, InfoBuffer, InfoBufferLength) {
        ...
        result := DllCall("cldapi.dll\CfGetPlaceholderInfo", "ptr", FileHandle, "int", InfoClass, "ptr", InfoBuffer, "uint", InfoBufferLength, "uint*", &ReturnedLength := 0, "HRESULT")
    ...
    static CfGetSyncRootInfoByPath(FilePath, InfoClass, InfoBuffer, InfoBufferLength, ReturnedLength) {
        ...
        result := DllCall("cldapi.dll\CfGetSyncRootInfoByPath", "ptr", FilePath, "int", InfoClass, InfoBufferMarshal, InfoBuffer, "uint", InfoBufferLength, ReturnedLengthMarshal, ReturnedLength, "HRESULT")
        return result
    }
    ...
    static CfGetSyncRootInfoByHandle(FileHandle, InfoClass, InfoBuffer, InfoBufferLength, ReturnedLength) {
        ...
        result := DllCall("cldapi.dll\CfGetSyncRootInfoByHandle", "ptr", FileHandle, "int", InfoClass, InfoBufferMarshal, InfoBuffer, "uint", InfoBufferLength, ReturnedLengthMarshal, ReturnedLength, "HRESULT")
        return result
    }
    ...
    static CfGetPlaceholderRangeInfo(FileHandle, InfoClass, StartingOffset, Length, InfoBuffer, InfoBufferLength) {
        ...
        result := DllCall("cldapi.dll\CfGetPlaceholderRangeInfo", "ptr", FileHandle, "int", InfoClass, "int64", StartingOffset, "int64", Length, "ptr", InfoBuffer, "uint", InfoBufferLength, "uint*", &ReturnedLength := 0, "HRESULT")
        return ReturnedLength
    }
    ...
    static CfGetPlaceholderRangeInfoForHydration(ConnectionKey, TransferKey, FileId, InfoClass, StartingOffset, RangeLength, InfoBuffer, InfoBufferSize) {
        ...
        result := DllCall("cldapi.dll\CfGetPlaceholderRangeInfoForHydration", "ptr", ConnectionKey, "int64", TransferKey, "int64", FileId, "int", InfoClass, "int64", StartingOffset, "int64", RangeLength, "ptr", InfoBuffer, "uint", InfoBufferSize, "uint*", &InfoBufferWritten := 0, "HRESULT")
    ...
    static CfReportProviderProgress(ConnectionKey, TransferKey, ProviderProgressTotal, ProviderProgressCompleted) {
        ...
        result := DllCall("cldapi.dll\CfReportProviderProgress", "ptr", ConnectionKey, "int64", TransferKey, "int64", ProviderProgressTotal, "int64", ProviderProgressCompleted, "HRESULT")
        return result
    }
    ...
    static CfReportProviderProgress2(ConnectionKey, TransferKey, RequestKey, ProviderProgressTotal, ProviderProgressCompleted, TargetSessionId) {
        ...
        result := DllCall("cldapi.dll\CfReportProviderProgress2", "ptr", ConnectionKey, "int64", TransferKey, "int64", RequestKey, "int64", ProviderProgressTotal, "int64", ProviderProgressCompleted, "uint", TargetSessionId, "HRESULT")
        return result
    }
