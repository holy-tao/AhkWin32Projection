 ...
 */
export CfGetPlatformInfo(PlatformVersion) {
    result := DllCall("cldapi.dll\CfGetPlatformInfo", CF_PLATFORM_INFO.Ptr, PlatformVersion, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfRegisterSyncRoot(SyncRootPath, Registration, Policies, RegisterFlags) {
    SyncRootPath := SyncRootPath is String ? StrPtr(SyncRootPath) : SyncRootPath

    result := DllCall("cldapi.dll\CfRegisterSyncRoot", "ptr", SyncRootPath, CF_SYNC_REGISTRATION.Ptr, Registration, CF_SYNC_POLICIES.Ptr, Policies, CF_REGISTER_FLAGS, RegisterFlags, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfUnregisterSyncRoot(SyncRootPath) {
    SyncRootPath := SyncRootPath is String ? StrPtr(SyncRootPath) : SyncRootPath
 ...
 * @since windows10.0.16299
 */
export CfDisconnectSyncRoot(ConnectionKey) {
    result := DllCall("cldapi.dll\CfDisconnectSyncRoot", CF_CONNECTION_KEY, ConnectionKey, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfGetTransferKey(FileHandle) {
    result := DllCall("cldapi.dll\CfGetTransferKey", HANDLE, FileHandle, "int64*", &TransferKey := 0, "HRESULT")
    return TransferKey
}
 ...
 * @since windows10.0.16299
 */
export CfExecute(OpInfo, OpParams) {
    result := DllCall("cldapi.dll\CfExecute", CF_OPERATION_INFO.Ptr, OpInfo, CF_OPERATION_PARAMETERS.Ptr, OpParams, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfUpdateSyncProviderStatus(ConnectionKey, ProviderStatus) {
    result := DllCall("cldapi.dll\CfUpdateSyncProviderStatus", CF_CONNECTION_KEY, ConnectionKey, CF_SYNC_PROVIDER_STATUS, ProviderStatus, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfQuerySyncProviderStatus(ConnectionKey) {
    result := DllCall("cldapi.dll\CfQuerySyncProviderStatus", CF_CONNECTION_KEY, ConnectionKey, "uint*", &ProviderStatus := 0, "HRESULT")
 ...
 * @since windows10.0.16299
 */
export CfOpenFileWithOplock(FilePath, Flags) {
    FilePath := FilePath is String ? StrPtr(FilePath) : FilePath

    ProtectedHandle := HANDLE.OwnedWith(CfCloseHandle)()
    result := DllCall("cldapi.dll\CfOpenFileWithOplock", "ptr", FilePath, CF_OPEN_FILE_FLAGS, Flags, HANDLE.Ptr, ProtectedHandle, "HRESULT")
 ...
 * @since windows10.0.16299
 */
export CfReferenceProtectedHandle(ProtectedHandle) {
    result := DllCall("cldapi.dll\CfReferenceProtectedHandle", HANDLE, ProtectedHandle, BOOLEAN)
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfGetWin32HandleFromProtectedHandle(ProtectedHandle) {
    result := DllCall("cldapi.dll\CfGetWin32HandleFromProtectedHandle", HANDLE, ProtectedHandle, HANDLE.Owned)
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfReleaseProtectedHandle(ProtectedHandle) {
    DllCall("cldapi.dll\CfReleaseProtectedHandle", HANDLE, ProtectedHandle)
}
 ...
 * @since windows10.0.16299
 */
export CfCloseHandle(FileHandle) {
    DllCall("cldapi.dll\CfCloseHandle", HANDLE, FileHandle)
}
 ...
 * @since windows10.0.16299
 */
export CfSetCorrelationVector(FileHandle, CorrelationVector) {
    result := DllCall("cldapi.dll\CfSetCorrelationVector", HANDLE, FileHandle, CORRELATION_VECTOR.Ptr, CorrelationVector, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfGetCorrelationVector(FileHandle, CorrelationVector) {
    result := DllCall("cldapi.dll\CfGetCorrelationVector", HANDLE, FileHandle, CORRELATION_VECTOR.Ptr, CorrelationVector, "HRESULT")
    return result
}
 ...
 * @since windows10.0.16299
 */
export CfGetPlaceholderStateFromFindData(FindData) {
    result := DllCall("cldapi.dll\CfGetPlaceholderStateFromFindData", WIN32_FIND_DATAA.Ptr, FindData, CF_PLACEHOLDER_STATE)
    return result
}
