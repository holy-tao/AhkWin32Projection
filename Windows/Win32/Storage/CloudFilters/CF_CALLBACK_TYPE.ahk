...
class CF_CALLBACK_TYPE extends Win32Enum {
     ...
     * Native name: CF_CALLBACK_TYPE_FETCH_DATA
     * @type {Integer (Int32)}
     */
    static FETCH_DATA => 0
     ...
     * Native name: CF_CALLBACK_TYPE_VALIDATE_DATA
     * @type {Integer (Int32)}
     */
    static VALIDATE_DATA => 1
     ...
     * Native name: CF_CALLBACK_TYPE_CANCEL_FETCH_DATA
     * @type {Integer (Int32)}
     */
    static CANCEL_FETCH_DATA => 2
     ...
     * Native name: CF_CALLBACK_TYPE_FETCH_PLACEHOLDERS
     * @type {Integer (Int32)}
     */
    static FETCH_PLACEHOLDERS => 3
     ...
     * Native name: CF_CALLBACK_TYPE_CANCEL_FETCH_PLACEHOLDERS
     * @type {Integer (Int32)}
     */
    static CANCEL_FETCH_PLACEHOLDERS => 4
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_FILE_OPEN_COMPLETION
     * @type {Integer (Int32)}
     */
    static NOTIFY_FILE_OPEN_COMPLETION => 5
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_FILE_CLOSE_COMPLETION
     * @type {Integer (Int32)}
     */
    static NOTIFY_FILE_CLOSE_COMPLETION => 6
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_DEHYDRATE
     * @type {Integer (Int32)}
     */
    static NOTIFY_DEHYDRATE => 7
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_DEHYDRATE_COMPLETION
     * @type {Integer (Int32)}
     */
    static NOTIFY_DEHYDRATE_COMPLETION => 8
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_DELETE
     * @type {Integer (Int32)}
     */
    static NOTIFY_DELETE => 9
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_DELETE_COMPLETION
     * @type {Integer (Int32)}
     */
    static NOTIFY_DELETE_COMPLETION => 10
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_RENAME
     * @type {Integer (Int32)}
     */
    static NOTIFY_RENAME => 11
     ...
     * Native name: CF_CALLBACK_TYPE_NOTIFY_RENAME_COMPLETION
     * @type {Integer (Int32)}
     */
    static NOTIFY_RENAME_COMPLETION => 12

    /**
     * No callback type.
     * Native name: CF_CALLBACK_TYPE_NONE
     * @type {Integer (Int32)}
     */
    static NONE => -1
}
