...
class CF_CONNECT_FLAGS extends Win32BitflagEnum {
    ...
    /**
     * No connection flags.
     * Native name: CF_CONNECT_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: CF_CONNECT_FLAG_REQUIRE_PROCESS_INFO
     * @type {Integer (Int32)}
     */
    static FLAG_REQUIRE_PROCESS_INFO => 2
     ...
     * Native name: CF_CONNECT_FLAG_REQUIRE_FULL_FILE_PATH
     * @type {Integer (Int32)}
     */
    static FLAG_REQUIRE_FULL_FILE_PATH => 4
     ...
     * Native name: CF_CONNECT_FLAG_BLOCK_SELF_IMPLICIT_HYDRATION
     * @type {Integer (Int32)}
     */
    static FLAG_BLOCK_SELF_IMPLICIT_HYDRATION => 8
}
