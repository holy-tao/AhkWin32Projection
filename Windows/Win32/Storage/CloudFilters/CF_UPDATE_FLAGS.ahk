...
class CF_UPDATE_FLAGS extends Win32BitflagEnum {
     ...
     * 
     * No update flags.
     * Native name: CF_UPDATE_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: CF_UPDATE_FLAG_VERIFY_IN_SYNC
     * @type {Integer (Int32)}
     */
    static FLAG_VERIFY_IN_SYNC => 1

    /**
     * `0x00000002`
     * 
     * The platform marks the placeholder as in-sync upon a successful update placeholder operation.
     * Native name: CF_UPDATE_FLAG_MARK_IN_SYNC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: CF_UPDATE_FLAG_DEHYDRATE
     * @type {Integer (Int32)}
     */
    static FLAG_DEHYDRATE => 4
     ...
     * Native name: CF_UPDATE_FLAG_ENABLE_ON_DEMAND_POPULATION
     * @type {Integer (Int32)}
     */
    static FLAG_ENABLE_ON_DEMAND_POPULATION => 8
     ...
     * Native name: CF_UPDATE_FLAG_DISABLE_ON_DEMAND_POPULATION
     * @type {Integer (Int32)}
     */
    static FLAG_DISABLE_ON_DEMAND_POPULATION => 16
     ...
     * Native name: CF_UPDATE_FLAG_REMOVE_FILE_IDENTITY
     * @type {Integer (Int32)}
     */
    static FLAG_REMOVE_FILE_IDENTITY => 32

    /**
     * `0x00000040`
     * 
     * The platform marks the placeholder as not in-sync upon a successful update placeholder operation.
     * Native name: CF_UPDATE_FLAG_CLEAR_IN_SYNC
     * @type {Integer (Int32)}
     */
    static FLAG_CLEAR_IN_SYNC => 64
     ...
     * Native name: CF_UPDATE_FLAG_REMOVE_PROPERTY
     * @type {Integer (Int32)}
     */
    static FLAG_REMOVE_PROPERTY => 128
     ...
     * > [!NOTE]
     * > This value is available in Windows 10, version 1803 and later.
     * Native name: CF_UPDATE_FLAG_PASSTHROUGH_FS_METADATA
     * @type {Integer (Int32)}
     */
    static FLAG_PASSTHROUGH_FS_METADATA => 256
     ...
     * Native name: CF_UPDATE_FLAG_ALWAYS_FULL
     * @type {Integer (Int32)}
     */
    static FLAG_ALWAYS_FULL => 512
     ...
     * Native name: CF_UPDATE_FLAG_ALLOW_PARTIAL
     * @type {Integer (Int32)}
     */
    static FLAG_ALLOW_PARTIAL => 1024
}
