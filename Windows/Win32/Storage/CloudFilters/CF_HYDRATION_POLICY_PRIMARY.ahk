...
class CF_HYDRATION_POLICY_PRIMARY extends Win32Enum {
     ...
     * Native name: CF_HYDRATION_POLICY_PARTIAL
     * @type {Integer (UInt16)}
     */
    static PARTIAL => 0
     ...
     * Native name: CF_HYDRATION_POLICY_PROGRESSIVE
     * @type {Integer (UInt16)}
     */
     ...
     * Native name: CF_HYDRATION_POLICY_FULL
     * @type {Integer (UInt16)}
     */
    static FULL => 2
     ...
     * Native name: CF_HYDRATION_POLICY_ALWAYS_FULL
     * @type {Integer (UInt16)}
     */
    static ALWAYS_FULL => 3
}
