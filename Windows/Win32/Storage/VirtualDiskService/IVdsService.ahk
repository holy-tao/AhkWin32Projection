 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsservice
...
class IVdsService extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-isserviceready
     */
    IsServiceReady() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-waitforserviceready
     */
    WaitForServiceReady() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-queryproviders
     */
    QueryProviders(masks) {
        result := ComCall(6, this, "uint", masks, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-querymaskeddisks
     */
    QueryMaskedDisks() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-queryunallocateddisks
     */
     ...
     * @param {Guid} ObjectId_ The GUID of the desired object.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-getobject
     */
    GetObject(ObjectId_, type) {
        result := ComCall(9, this, "ptr", ObjectId_, "int", type, "ptr*", &ppObjectUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-querydriveletters
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-queryfilesystemtypes
     */
    QueryFileSystemTypes(ppFileSystemTypeProps, plNumberOfFileSystems) {
        ...
        result := ComCall(11, this, ppFileSystemTypePropsMarshal, ppFileSystemTypeProps, plNumberOfFileSystemsMarshal, plNumberOfFileSystems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-reenumerate
     */
    Reenumerate() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-refresh
     */
    Refresh() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-cleanupobsoletemountpoints
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-advise
     */
    Advise(pSink) {
        result := ComCall(15, this, "ptr", pSink, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-unadvise
     */
    Unadvise(dwCookie) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-reboot
     */
    Reboot() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-setflags
     */
    SetFlags(ulFlags) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservice-clearflags
     */
    ClearFlags(ulFlags) {
