 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdssubsystemiscsi
...
class IVdsSubSystemIscsi extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdssubsystemiscsi-querytargets
     */
    QueryTargets() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdssubsystemiscsi-queryportals
     */
    QueryPortals() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdssubsystemiscsi-createtarget
     */
    CreateTarget(pwszIscsiName, pwszFriendlyName) {
        ...
        result := ComCall(5, this, "ptr", pwszIscsiName, "ptr", pwszFriendlyName, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdssubsystemiscsi-setipsecgrouppresharedkey
     */
