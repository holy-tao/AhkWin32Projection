 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsiscsiportallocal
...
class IVdsIscsiPortalLocal extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiportallocal-setipsecsecuritylocal
     */
    SetIpsecSecurityLocal(ullSecurityFlags, pIpsecKey) {
        result := ComCall(3, this, "uint", ullSecurityFlags, "ptr", pIpsecKey, "int")
        if(result != 0) {
