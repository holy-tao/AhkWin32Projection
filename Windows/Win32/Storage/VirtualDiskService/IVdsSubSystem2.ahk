...
class IVdsSubSystem2 extends IUnknown{
    ...
    GetDrive2(sBusNumber, sSlotNumber, ulEnclosureNumber, ppDrive) {
        result := ComCall(4, this, "short", sBusNumber, "short", sSlotNumber, "uint", ulEnclosureNumber, "ptr", ppDrive, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateLun2(type, ullSizeInBytes, pDriveIdArray, lNumberOfDrives, pwszUnmaskingList, pHints2, ppAsync) {
        ...
        result := ComCall(5, this, "int", type, "uint", ullSizeInBytes, "ptr", pDriveIdArray, "int", lNumberOfDrives, "ptr", pwszUnmaskingList, "ptr", pHints2, "ptr", ppAsync, "int")
        if(result != 0)
            throw OSError(result)
    ...
    QueryMaxLunCreateSize2(type, pDriveIdArray, lNumberOfDrives, pHints2, pullMaxLunSize) {
        result := ComCall(6, this, "int", type, "ptr", pDriveIdArray, "int", lNumberOfDrives, "ptr", pHints2, "uint*", pullMaxLunSize, "int")
        if(result != 0)
            throw OSError(result)
