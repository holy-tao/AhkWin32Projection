 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvolume
...
class IVdsVolume extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-getpack
     */
    GetPack() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-queryplexes
     */
    QueryPlexes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-extend
     */
    Extend(pInputDiskArray, lNumberOfDisks) {
        result := ComCall(6, this, "ptr", pInputDiskArray, "int", lNumberOfDisks, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-shrink
     */
    Shrink(ullNumberOfBytesToRemove) {
        result := ComCall(7, this, "uint", ullNumberOfBytesToRemove, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-addplex
     */
    AddPlex(VolumeId) {
        result := ComCall(8, this, "ptr", VolumeId, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-breakplex
     */
    BreakPlex(plexId) {
        result := ComCall(9, this, "ptr", plexId, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *       initializes on return. Callers must release the interface. Use this pointer to cancel, wait for, or query the 
     *       status of the operation.
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-removeplex
     */
    RemovePlex(plexId) {
        result := ComCall(10, this, "ptr", plexId, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-delete
     */
    Delete(bForce) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-setflags
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolume-clearflags
     */
    ClearFlags(ulFlags) {
