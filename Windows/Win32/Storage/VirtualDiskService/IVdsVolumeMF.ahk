 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvolumemf
...
class IVdsVolumeMF extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-getfilesystemproperties
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-format
     */
    Format(type, pwszLabel, dwUnitAllocationSize, bForce, bQuickFormat, bEnableCompression) {
        ...
        result := ComCall(4, this, "int", type, "ptr", pwszLabel, "uint", dwUnitAllocationSize, "int", bForce, "int", bQuickFormat, "int", bEnableCompression, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-addaccesspath
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-queryaccesspaths
     */
    QueryAccessPaths(pwszPathArray, plNumberOfAccessPaths) {
        ...
        result := ComCall(6, this, pwszPathArrayMarshal, pwszPathArray, plNumberOfAccessPathsMarshal, plNumberOfAccessPaths, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-queryreparsepoints
     */
    QueryReparsePoints(ppReparsePointProps, plNumberOfReparsePointProps) {
        ...
        result := ComCall(7, this, ppReparsePointPropsMarshal, ppReparsePointProps, plNumberOfReparsePointPropsMarshal, plNumberOfReparsePointProps, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-deleteaccesspath
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-mount
     */
    Mount() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-dismount
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-setfilesystemflags
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf-clearfilesystemflags
     */
