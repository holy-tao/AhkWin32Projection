...
export default struct IVdsLun extends IUnknown {
    ...
    */
     ...
     * @param {VDS_LUN_STATUS} _status Values enumerated by <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_lun_status">VDS_LUN_STATUS</a>. Callers can 
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.QueryActiveControllers := CallbackCreate(ObjBindMethod(implObj, "QueryActiveControllers"), flags, 2)
        this.vtbl.Extend := CallbackCreate(ObjBindMethod(implObj, "Extend"), flags, 5)
        ...
        this.vtbl.SetMask := CallbackCreate(ObjBindMethod(implObj, "SetMask"), flags, 2)
        this.vtbl.Delete := CallbackCreate(ObjBindMethod(implObj, "Delete"), flags, 1)
        this.vtbl.AssociateControllers := CallbackCreate(ObjBindMethod(implObj, "AssociateControllers"), flags, 5)
        ...
        this.vtbl.QueryMaxLunExtendSize := CallbackCreate(ObjBindMethod(implObj, "QueryMaxLunExtendSize"), flags, 4)
    }
