 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvdprovider
...
class IVdsVdProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdprovider-queryvdisks
     */
    QueryVDisks() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdprovider-createvdisk
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdprovider-addvdisk
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdprovider-getdiskfromvdisk
     */
    GetDiskFromVDisk(pVDisk) {
        result := ComCall(6, this, "ptr", pVDisk, "ptr*", &ppDisk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdprovider-getvdiskfromdisk
     */
    GetVDiskFromDisk(pDisk) {
        result := ComCall(7, this, "ptr", pDisk, "ptr*", &ppVDisk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
