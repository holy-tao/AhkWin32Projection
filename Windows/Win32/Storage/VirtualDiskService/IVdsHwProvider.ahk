 ...
 */
export default struct IVdsHwProvider extends IUnknown {
    /**
     ...
     * used for IVdsHwProvider interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        QuerySubSystems : IntPtr
        Reenumerate     : IntPtr
        Refresh         : IntPtr
    }
    ...
    Query(iid) {
        if (IVdsHwProvider.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.QuerySubSystems)
