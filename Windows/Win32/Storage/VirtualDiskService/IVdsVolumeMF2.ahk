 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvolumemf2
...
class IVdsVolumeMF2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf2-getfilesystemtypename
     */
    GetFileSystemTypeName() {
        result := ComCall(3, this, "ptr*", &ppwszFileSystemTypeName := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf2-queryfilesystemformatsupport
     */
    QueryFileSystemFormatSupport(ppFileSystemSupportProps, plNumberOfFileSystems) {
        ...
        result := ComCall(4, this, ppFileSystemSupportPropsMarshal, ppFileSystemSupportProps, plNumberOfFileSystemsMarshal, plNumberOfFileSystems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumemf2-formatex
     */
    FormatEx(pwszFileSystemTypeName, usFileSystemRevision, ulDesiredUnitAllocationSize, pwszLabel, bForce, bQuickFormat, bEnableCompression) {
        ...
        result := ComCall(5, this, "ptr", pwszFileSystemTypeName, "ushort", usFileSystemRevision, "uint", ulDesiredUnitAllocationSize, "ptr", pwszLabel, "int", bForce, "int", bQuickFormat, "int", bEnableCompression, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
