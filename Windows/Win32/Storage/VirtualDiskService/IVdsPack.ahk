 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdspack
...
class IVdsPack extends IUnknown{
     ...
     *       function.
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-getprovider
     */
    GetProvider() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-queryvolumes
     */
    QueryVolumes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-querydisks
     */
    QueryDisks() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-createvolume
     */
    CreateVolume(type, pInputDiskArray, lNumberOfDisks, ulStripeSize) {
        result := ComCall(7, this, "int", type, "ptr", pInputDiskArray, "int", lNumberOfDisks, "uint", ulStripeSize, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-adddisk
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-migratedisks
     */
    MigrateDisks(pDiskArray, lNumberOfDisks, TargetPack, bForce, bQueryOnly, pResults, pbRebootNeeded) {
        ...
        result := ComCall(9, this, "ptr", pDiskArray, "int", lNumberOfDisks, "ptr", TargetPack, "int", bForce, "int", bQueryOnly, pResultsMarshal, pResults, pbRebootNeededMarshal, pbRebootNeeded, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-replacedisk
     */
    ReplaceDisk(OldDiskId, NewDiskId) {
        result := ComCall(10, this, "ptr", OldDiskId, "ptr", NewDiskId, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-removemissingdisk
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdspack-recover
     */
    Recover() {
