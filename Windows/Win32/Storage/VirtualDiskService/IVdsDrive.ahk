...
#Import ".\VDS_DRIVE_PROP.ahk" { VDS_DRIVE_PROP }
 ...
 */
export default struct IVdsDrive extends IUnknown {
    /**
    ...
    */
    ...
    GetProperties() {
        ...
        result := ComCall(3, this, VDS_DRIVE_PROP.Ptr, pDriveProp, "HRESULT")
        return pDriveProp
    }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/vdshwprv/nf-vdshwprv-ivdsdrive-setflags
     */
    SetFlags(ulFlags) {
        result := ComCall(6, this, UInt32, ulFlags, "HRESULT")
        return result
    }
     ...
     */
    ClearFlags(ulFlags) {
        result := ComCall(7, this, UInt32, ulFlags, "HRESULT")
        return result
    }
     ...
     */
    SetStatus(_status) {
        result := ComCall(8, this, VDS_DRIVE_STATUS, _status, "HRESULT")
        return result
    }

    Query(iid) {
        if (IVdsDrive.IID.Equals(iid)) {
            return true
        }
