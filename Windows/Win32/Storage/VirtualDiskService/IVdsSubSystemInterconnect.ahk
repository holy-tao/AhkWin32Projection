 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdssubsysteminterconnect
...
class IVdsSubSystemInterconnect extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdssubsysteminterconnect-getsupportedinterconnects
     */
    GetSupportedInterconnects() {
        result := ComCall(3, this, "uint*", &pulSupportedInterconnectsFlag := 0, "int")
        if(result != 0) {
