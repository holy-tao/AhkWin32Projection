 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsadvisesink
...
class IVdsAdviseSink extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvisesink-onnotify
     */
    OnNotify(lNumberOfNotifications, pNotificationArray) {
        result := ComCall(3, this, "int", lNumberOfNotifications, "ptr", pNotificationArray, "int")
        if(result != 0) {
