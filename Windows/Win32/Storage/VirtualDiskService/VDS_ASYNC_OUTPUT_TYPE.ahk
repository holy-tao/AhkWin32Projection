...
class VDS_ASYNC_OUTPUT_TYPE extends Win32Enum {
     ...
     * Native name: VDS_ASYNCOUT_UNKNOWN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_UNKNOWN => 0
     ...
     * Native name: VDS_ASYNCOUT_CREATEVOLUME
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATEVOLUME => 1
     ...
     * Native name: VDS_ASYNCOUT_EXTENDVOLUME
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_EXTENDVOLUME => 2
     ...
     * Native name: VDS_ASYNCOUT_SHRINKVOLUME
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_SHRINKVOLUME => 3
     ...
     * Native name: VDS_ASYNCOUT_ADDVOLUMEPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_ADDVOLUMEPLEX => 4
     ...
     * Native name: VDS_ASYNCOUT_BREAKVOLUMEPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_BREAKVOLUMEPLEX => 5
     ...
     * Native name: VDS_ASYNCOUT_REMOVEVOLUMEPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_REMOVEVOLUMEPLEX => 6
     ...
     * Native name: VDS_ASYNCOUT_REPAIRVOLUMEPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_REPAIRVOLUMEPLEX => 7
     ...
     * Native name: VDS_ASYNCOUT_RECOVERPACK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_RECOVERPACK => 8

    /**
     * This value is reserved for future use.
     * Native name: VDS_ASYNCOUT_REPLACEDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_REPLACEDISK => 9
     ...
     *       method.
     * Native name: VDS_ASYNCOUT_CREATEPARTITION
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATEPARTITION => 10

    /**
     * <a href="https://docs.microsoft.com/windows/desktop/api/vds/nf-vds-ivdsadvanceddisk-clean">IVdsAdvancedDisk::Clean</a>
     * Native name: VDS_ASYNCOUT_CLEAN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CLEAN => 11
     ...
     * Native name: VDS_ASYNCOUT_CREATELUN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATELUN => 50
     ...
     * Native name: VDS_ASYNCOUT_ADDLUNPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_ADDLUNPLEX => 52
     ...
     * Native name: VDS_ASYNCOUT_REMOVELUNPLEX
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_REMOVELUNPLEX => 53
     ...
     * Native name: VDS_ASYNCOUT_EXTENDLUN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_EXTENDLUN => 54
     ...
     * Native name: VDS_ASYNCOUT_SHRINKLUN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_SHRINKLUN => 55
     ...
     * Native name: VDS_ASYNCOUT_RECOVERLUN
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_RECOVERLUN => 56
     ...
     * Native name: VDS_ASYNCOUT_LOGINTOTARGET
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_LOGINTOTARGET => 60
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_LOGOUTFROMTARGET
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_LOGOUTFROMTARGET => 61
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_CREATETARGET
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATETARGET => 62
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_CREATEPORTALGROUP
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATEPORTALGROUP => 63
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_DELETETARGET
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_DELETETARGET => 64
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_ADDPORTAL
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_ADDPORTAL => 65
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_REMOVEPORTAL
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_REMOVEPORTAL => 66
     ...
     * 
     * <b>Windows Server 2003:  </b>This flag is not supported before Windows Server 2003 R2.
     * Native name: VDS_ASYNCOUT_DELETEPORTALGROUP
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_DELETEPORTALGROUP => 67
     ...
     * Native name: VDS_ASYNCOUT_FORMAT
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_FORMAT => 101
     ...
     * Native name: VDS_ASYNCOUT_CREATE_VDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_CREATE_VDISK => 200
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>Not supported.
     * Native name: VDS_ASYNCOUT_ATTACH_VDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_ATTACH_VDISK => 201
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>Not supported.
     * Native name: VDS_ASYNCOUT_COMPACT_VDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_COMPACT_VDISK => 202
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>Not supported.
     * Native name: VDS_ASYNCOUT_MERGE_VDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_MERGE_VDISK => 203
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>Not supported.
     * Native name: VDS_ASYNCOUT_EXPAND_VDISK
     * @type {Integer (Int32)}
     */
    static ASYNCOUT_EXPAND_VDISK => 204
}
