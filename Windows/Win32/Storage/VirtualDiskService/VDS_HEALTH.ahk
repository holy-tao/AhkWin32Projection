...
class VDS_HEALTH extends Win32Enum {
     ...
     * Native name: VDS_H_FAILING_REDUNDANCY
     * @type {Integer (Int32)}
     */
    static H_FAILING_REDUNDANCY => 5

    /**
     * One or more plexes have failed, but at least one plex is working. This value is valid only for volumes and LUNs.
     * Native name: VDS_H_FAILED_REDUNDANCY
     * @type {Integer (Int32)}
     */
    static H_FAILED_REDUNDANCY => 6

    /**
     * The last working plex is failing. This value is valid only for volumes and LUNs.
     * Native name: VDS_H_FAILED_REDUNDANCY_FAILING
     * @type {Integer (Int32)}
     */
    static H_FAILED_REDUNDANCY_FAILING => 7
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This value is not supported.
     * Native name: VDS_H_PENDING_FAILURE
     * @type {Integer (Int32)}
     */
    static H_PENDING_FAILURE => 10
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This value is not supported.
     * Native name: VDS_H_DEGRADED
     * @type {Integer (Int32)}
     */
    static H_DEGRADED => 11
}
