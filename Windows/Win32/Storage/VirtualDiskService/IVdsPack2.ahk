 ...
 */
export default struct IVdsPack2 extends IUnknown {
    /**
     ...
     * used for IVdsPack2 interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        CreateVolume2 : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVdsPack2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.CreateVolume2)
    }
}
