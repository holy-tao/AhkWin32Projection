 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsdisk3
...
class IVdsDisk3 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsdisk3-getproperties2
     */
    GetProperties2() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsdisk3-queryfreeextents
     */
    QueryFreeExtents(ulAlign, ppFreeExtentArray, plNumberOfFreeExtents) {
        ...
        result := ComCall(4, this, "uint", ulAlign, ppFreeExtentArrayMarshal, ppFreeExtentArray, plNumberOfFreeExtentsMarshal, plNumberOfFreeExtents, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
