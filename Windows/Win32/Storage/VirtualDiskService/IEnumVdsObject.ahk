 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ienumvdsobject
...
class IEnumVdsObject extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ienumvdsobject-next
     */
    Next(celt, ppObjectArray, pcFetched) {
        pcFetchedMarshal := pcFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "uint", celt, "ptr*", ppObjectArray, pcFetchedMarshal, pcFetched, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ienumvdsobject-skip
     */
    Skip(celt) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ienumvdsobject-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ienumvdsobject-clone
     */
    Clone() {
