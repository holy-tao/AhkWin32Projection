 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsasync
...
class IVdsAsync extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsasync-cancel
     */
    Cancel() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsasync-wait
     */
    Wait(pHrResult, pAsyncOut) {
        pHrResultMarshal := pHrResult is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, pHrResultMarshal, pHrResult, "ptr", pAsyncOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsasync-querystatus
     */
    QueryStatus(pHrResult, pulPercentCompleted) {
        pHrResultMarshal := pHrResult is VarRef ? "int*" : "ptr"
        pulPercentCompletedMarshal := pulPercentCompleted is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, pHrResultMarshal, pHrResult, pulPercentCompletedMarshal, pulPercentCompleted, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
