 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vdshwprv/nn-vdshwprv-ivdshwproviderprivatempio
...
class IVdsHwProviderPrivateMpio extends IUnknown{
     ...
     * @param {Integer} status_ The status (enumerated by the <a href="https://docs.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_path_status">VDS_PATH_STATUS</a> enumeration) to set the paths.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vdshwprv/nf-vdshwprv-ivdshwproviderprivatempio-setallpathstatusesfromhbaport
     */
    SetAllPathStatusesFromHbaPort(hbaPortProp, status_) {
        result := ComCall(3, this, "ptr", hbaPortProp, "int", status_, "int")
        if(result != 0) {
