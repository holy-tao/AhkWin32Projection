 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsiscsiinitiatorportal
...
class IVdsIscsiInitiatorPortal extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiinitiatorportal-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiinitiatorportal-getinitiatoradapter
     */
    GetInitiatorAdapter() {
        result := ComCall(4, this, "ptr*", &ppInitiatorAdapter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiinitiatorportal-setipsectunneladdress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiinitiatorportal-getipsecsecurity
     */
    GetIpsecSecurity(targetPortalId) {
        result := ComCall(6, this, "ptr", targetPortalId, "uint*", &pullSecurityFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsiscsiinitiatorportal-setipsecsecurity
     */
