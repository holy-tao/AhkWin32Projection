 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvdisk
...
class IVdsVDisk extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdisk-open
     */
    Open(AccessMask, Flags, ReadWriteDepth) {
        result := ComCall(3, this, "int", AccessMask, "int", Flags, "uint", ReadWriteDepth, "ptr*", &ppOpenVDisk := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdisk-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdisk-gethostvolume
     */
    GetHostVolume() {
        result := ComCall(5, this, "ptr*", &ppVolume := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvdisk-getdevicename
     */
    GetDeviceName() {
        result := ComCall(6, this, "ptr*", &ppDeviceName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
