 ...
 */
export default struct IVdsServiceInitialization extends IUnknown {
    /**
     ...
     * used for IVdsServiceInitialization interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVdsServiceInitialization.Vtbl()
        }
    ...
    Query(iid) {
        if (IVdsServiceInitialization.IID.Equals(iid)) {
            return true
        }
