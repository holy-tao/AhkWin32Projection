 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsservicesan
...
class IVdsServiceSAN extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservicesan-getsanpolicy
     */
    GetSANPolicy() {
        result := ComCall(3, this, "int*", &pSanPolicy := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsservicesan-setsanpolicy
     */
