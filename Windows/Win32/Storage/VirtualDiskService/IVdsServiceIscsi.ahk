 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsserviceiscsi
...
class IVdsServiceIscsi extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-getinitiatorname
     */
    GetInitiatorName() {
        result := ComCall(3, this, "ptr*", &ppwszIscsiName := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-queryinitiatoradapters
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-setipsecgrouppresharedkey
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-setallipsectunneladdresses
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-setallipsecsecurity
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-setinitiatorsharedsecret
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsserviceiscsi-remembertargetsharedsecret
     */
