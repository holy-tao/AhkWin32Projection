...
class VDS_DISK_FLAG extends Win32Enum {
     ...
     * Native name: VDS_DF_AUDIO_CD
     * @type {Integer (Int32)}
     */
    static DF_AUDIO_CD => 1

    /**
     * The disk is reserved for use only as hot spare.
     * Native name: VDS_DF_HOTSPARE
     * @type {Integer (Int32)}
     */
    static DF_HOTSPARE => 2

    /**
     * This flag is reserved for future use. Do not use.
     * Native name: VDS_DF_RESERVE_CAPABLE
     * @type {Integer (Int32)}
     */
    static DF_RESERVE_CAPABLE => 4

    /**
     * The disk is masked.
     * Native name: VDS_DF_MASKED
     * @type {Integer (Int32)}
     */
    static DF_MASKED => 8
     ...
     * Native name: VDS_DF_STYLE_CONVERTIBLE
     * @type {Integer (Int32)}
     */
    static DF_STYLE_CONVERTIBLE => 16

    /**
     * The disk is clustered.
     * Native name: VDS_DF_CLUSTERED
     * @type {Integer (Int32)}
     */
    static DF_CLUSTERED => 32
     ...
     * Native name: VDS_DF_READ_ONLY
     * @type {Integer (Int32)}
     */
    static DF_READ_ONLY => 64
     ...
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_SYSTEM_DISK
     * @type {Integer (Int32)}
     */
    static DF_SYSTEM_DISK => 128

    /**
     * The disk hosts the current boot volume.
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_BOOT_DISK
     * @type {Integer (Int32)}
     */
    static DF_BOOT_DISK => 256

    /**
     * The disk contains a pagefile.
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_PAGEFILE_DISK
     * @type {Integer (Int32)}
     */
    static DF_PAGEFILE_DISK => 512

    /**
     * The disk contains the hibernation volume.
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_HIBERNATIONFILE_DISK
     * @type {Integer (Int32)}
     */
    static DF_HIBERNATIONFILE_DISK => 1024

    /**
     * The disk contains the crashdump volume.
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_CRASHDUMP_DISK
     * @type {Integer (Int32)}
     */
    static DF_CRASHDUMP_DISK => 2048
     ...
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_HAS_ARC_PATH
     * @type {Integer (Int32)}
     */
    static DF_HAS_ARC_PATH => 4096

    /**
     * The disk is a dynamic disk.
     * 
     * <b>Windows Vista and Windows Server 2003:  </b>Not supported before Windows Vista with SP1 and Windows Server 2008.
     * Native name: VDS_DF_DYNAMIC
     * @type {Integer (Int32)}
     */
    static DF_DYNAMIC => 8192
     ...
     * Native name: VDS_DF_BOOT_FROM_DISK
     * @type {Integer (Int32)}
     */
    static DF_BOOT_FROM_DISK => 16384
     ...
     * Native name: VDS_DF_CURRENT_READ_ONLY
     * @type {Integer (Int32)}
     */
    static DF_CURRENT_READ_ONLY => 32768

    /**
     * Native name: VDS_DF_REFS_NOT_SUPPORTED
     * @type {Integer (Int32)}
     */
    static DF_REFS_NOT_SUPPORTED => 65536
}
