...
class VDS_SUB_SYSTEM_FLAG extends Win32Enum {
     ...
     * Native name: VDS_SF_LUN_MASKING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_LUN_MASKING_CAPABLE => 1

    /**
     * The provider supports LUNs with more than one plex.
     * Native name: VDS_SF_LUN_PLEXING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_LUN_PLEXING_CAPABLE => 2

    /**
     * The provider supports automatic remapping of LUN extents to drive extents.
     * Native name: VDS_SF_LUN_REMAPPING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_LUN_REMAPPING_CAPABLE => 4
     ...
     * Native name: VDS_SF_DRIVE_EXTENT_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_DRIVE_EXTENT_CAPABLE => 8
     ...
     * Native name: VDS_SF_HARDWARE_CHECKSUM_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_HARDWARE_CHECKSUM_CAPABLE => 16

    /**
     * The subsystem supports RADIUS.
     * Native name: VDS_SF_RADIUS_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_RADIUS_CAPABLE => 32

    /**
     * The subsystem supports read verification of data that has been written.
     * Native name: VDS_SF_READ_BACK_VERIFY_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_READ_BACK_VERIFY_CAPABLE => 64

    /**
     * The subsystem supports write-through caching.
     * Native name: VDS_SF_WRITE_THROUGH_CACHING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_WRITE_THROUGH_CACHING_CAPABLE => 128

    /**
     * The subsystem supports creation of automagic fault tolerant LUNs.
     * Native name: VDS_SF_SUPPORTS_FAULT_TOLERANT_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_FAULT_TOLERANT_LUNS => 512

    /**
     * The subsystem supports creation of automagic non-fault tolerant LUNs.
     * Native name: VDS_SF_SUPPORTS_NON_FAULT_TOLERANT_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_NON_FAULT_TOLERANT_LUNS => 1024

    /**
     * The subsystem supports creation of simple LUNs.
     * Native name: VDS_SF_SUPPORTS_SIMPLE_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_SIMPLE_LUNS => 2048

    /**
     * The subsystem supports creation of spanned LUNs.
     * Native name: VDS_SF_SUPPORTS_SPAN_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_SPAN_LUNS => 4096

    /**
     * The subsystem supports creation of striped LUNs.
     * Native name: VDS_SF_SUPPORTS_STRIPE_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_STRIPE_LUNS => 8192

    /**
     * The subsystem supports creation of mirrored LUNs.
     * Native name: VDS_SF_SUPPORTS_MIRROR_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_MIRROR_LUNS => 16384

    /**
     * The subsystem supports creation of striped with parity LUNs.
     * Native name: VDS_SF_SUPPORTS_PARITY_LUNS
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_PARITY_LUNS => 32768

    /**
     * The subsystem supports one-way CHAP authentication.
     * Native name: VDS_SF_SUPPORTS_AUTH_CHAP
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_AUTH_CHAP => 65536

    /**
     * The subsystem supports mutual CHAP authentication.
     * Native name: VDS_SF_SUPPORTS_AUTH_MUTUAL_CHAP
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_AUTH_MUTUAL_CHAP => 131072
     ...
     * Native name: VDS_SF_SUPPORTS_SIMPLE_TARGET_CONFIG
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_SIMPLE_TARGET_CONFIG => 262144
     ...
     * Native name: VDS_SF_SUPPORTS_LUN_NUMBER
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_LUN_NUMBER => 524288
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This flag is not supported.
     * Native name: VDS_SF_SUPPORTS_MIRRORED_CACHE
     * @type {Integer (Int32)}
     */
    static SF_SUPPORTS_MIRRORED_CACHE => 1048576
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This flag is not supported.
     * Native name: VDS_SF_READ_CACHING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_READ_CACHING_CAPABLE => 2097152
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This flag is not supported.
     * Native name: VDS_SF_WRITE_CACHING_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_WRITE_CACHING_CAPABLE => 4194304
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This flag is not supported.
     * Native name: VDS_SF_MEDIA_SCAN_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_MEDIA_SCAN_CAPABLE => 8388608
     ...
     * 
     * <b>Windows Server 2008, Windows Vista and Windows Server 2003:  </b>This flag is not supported.
     * Native name: VDS_SF_CONSISTENCY_CHECK_CAPABLE
     * @type {Integer (Int32)}
     */
    static SF_CONSISTENCY_CHECK_CAPABLE => 16777216
}
