 ...
 */
export default struct IVdsOpenVDisk extends IUnknown {
    /**
     ...
     * used for IVdsOpenVDisk interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        Attach          : IntPtr
        Detach          : IntPtr
        DetachAndDelete : IntPtr
        Compact         : IntPtr
        Merge           : IntPtr
        Expand          : IntPtr
    }
     ...
     * @param {ATTACH_VIRTUAL_DISK_FLAG} Flags A bitmask  of  [ATTACH_VIRTUAL_DISK_FLAG](../virtdisk/ne-virtdisk-attach_virtual_disk_flag.md) enumeration values specifying how the virtual disk is to be attached. Possible values include the following.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * @param {DETACH_VIRTUAL_DISK_FLAG} Flags An <b>DETACH_VIRTUAL_DISK_FLAG</b> enumeration value that specifies how the virtual disk is to be detached. Must be set to DETACH_VIRTUAL_DISK_FLAG_NONE.
     ...
     * @param {COMPACT_VIRTUAL_DISK_FLAG} Flags A <b>COMPACT_VIRTUAL_DISK_FLAG</b> enumeration value that specifies how the virtual disk is to be compacted. Must be set to COMPACT_VIRTUAL_DISK_FLAG_NONE.
     ...
     * @param {MERGE_VIRTUAL_DISK_FLAG} Flags A <b>MERGE_VIRTUAL_DISK_FLAG</b> enumeration value that specifies how the virtual disk is to be merged. Must be set to MERGE_VIRTUAL_DISK_FLAG_NONE.
     ...
     * @param {EXPAND_VIRTUAL_DISK_FLAG} Flags An <b>EXPAND_VIRTUAL_DISK_FLAG</b> enumeration value that specifies how the virtual disk is to be expanded. Must be set to EXPAND_VIRTUAL_DISK_FLAG_NONE.
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.DetachAndDelete)
