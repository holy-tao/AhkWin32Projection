 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsadvanceddisk
...
class IVdsAdvancedDisk extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-getpartitionproperties
     */
    GetPartitionProperties(ullOffset) {
        pPartitionProp := VDS_PARTITION_PROP()
        result := ComCall(3, this, "uint", ullOffset, "ptr", pPartitionProp, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-querypartitions
     */
    QueryPartitions(ppPartitionPropArray, plNumberOfPartitions) {
        ...
        result := ComCall(4, this, ppPartitionPropArrayMarshal, ppPartitionPropArray, plNumberOfPartitionsMarshal, plNumberOfPartitions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-createpartition
     */
    CreatePartition(ullOffset, ullSize, para) {
        result := ComCall(5, this, "uint", ullOffset, "uint", ullSize, "ptr", para, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-deletepartition
     */
    DeletePartition(ullOffset, bForce, bForceProtected) {
        result := ComCall(6, this, "uint", ullOffset, "int", bForce, "int", bForceProtected, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-changeattributes
     */
    ChangeAttributes(ullOffset, para) {
        result := ComCall(7, this, "uint", ullOffset, "ptr", para, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-assigndriveletter
     */
    AssignDriveLetter(ullOffset, wcLetter) {
        result := ComCall(8, this, "uint", ullOffset, "char", wcLetter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-deletedriveletter
     */
    DeleteDriveLetter(ullOffset, wcLetter) {
        result := ComCall(9, this, "uint", ullOffset, "char", wcLetter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-getdriveletter
     */
    GetDriveLetter(ullOffset, pwcLetter) {
        pwcLetter := pwcLetter is String ? StrPtr(pwcLetter) : pwcLetter

        result := ComCall(10, this, "uint", ullOffset, "ptr", pwcLetter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *       VDS initializes on return. Callers must release the interface. Use this pointer to cancel, wait for, or query 
     *       the status of the operation.
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-formatpartition
     */
    FormatPartition(ullOffset, type, pwszLabel, dwUnitAllocationSize, bForce, bQuickFormat, bEnableCompression) {
        ...
        result := ComCall(11, this, "uint", ullOffset, "int", type, "ptr", pwszLabel, "uint", dwUnitAllocationSize, "int", bForce, "int", bQuickFormat, "int", bEnableCompression, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsadvanceddisk-clean
     */
    Clean(bForce, bForceOEM, bFullClean) {
        result := ComCall(12, this, "int", bForce, "int", bForceOEM, "int", bFullClean, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
