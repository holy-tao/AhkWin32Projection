 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdsvolumeplex
...
class IVdsVolumePlex extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumeplex-getproperties
     */
    GetProperties() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumeplex-getvolume
     */
    GetVolume() {
        result := ComCall(4, this, "ptr*", &ppVolume := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumeplex-queryextents
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdsvolumeplex-repair
     */
