 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdshbaport
...
class IVdsHbaPort extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdshbaport-getproperties
     */
    GetProperties() {
     ...
     * @param {Integer} status_ The status to be assigned to the paths.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdshbaport-setallpathstatuses
     */
    SetAllPathStatuses(status_) {
