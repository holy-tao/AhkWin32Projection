 ...
 */
class VDS_CONTROLLER_STATUS extends Win32Enum {

    /**
     * The status of the controller cannot be determined.
     * Native name: VDS_CS_UNKNOWN
     * @type {Integer (Int32)}
     */
    static CS_UNKNOWN => 0
     ...
     * Native name: VDS_CS_NOT_READY
     * @type {Integer (Int32)}
     */
    static CS_NOT_READY => 2
