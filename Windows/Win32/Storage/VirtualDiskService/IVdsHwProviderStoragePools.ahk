 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vds/nn-vds-ivdshwproviderstoragepools
...
class IVdsHwProviderStoragePools extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdshwproviderstoragepools-querystoragepools
     */
    QueryStoragePools(ulFlags, ullRemainingFreeSpace, pPoolAttributes) {
        result := ComCall(3, this, "uint", ulFlags, "uint", ullRemainingFreeSpace, "ptr", pPoolAttributes, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdshwproviderstoragepools-createluninstoragepool
     */
    CreateLunInStoragePool(type, ullSizeInBytes, StoragePoolId, pwszUnmaskingList, pHints2) {
        ...
        result := ComCall(4, this, "int", type, "uint", ullSizeInBytes, "ptr", StoragePoolId, "ptr", pwszUnmaskingList, "ptr", pHints2, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vds/nf-vds-ivdshwproviderstoragepools-querymaxluncreatesizeinstoragepool
     */
    QueryMaxLunCreateSizeInStoragePool(type, StoragePoolId, pHints2) {
        result := ComCall(5, this, "int", type, "ptr", StoragePoolId, "ptr", pHints2, "uint*", &pullMaxLunSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
