 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilessimpleprogress
...
class IOfflineFilesSimpleProgress extends IOfflineFilesProgress{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessimpleprogress-itembegin
     */
    ItemBegin(pszFile) {
     ...
     * @returns {Integer} Set this parameter to a value from the <a href="https://docs.microsoft.com/windows/desktop/api/cscobj/ne-cscobj-offlinefiles_op_response">OFFLINEFILES_OP_RESPONSE</a> enumeration that indicates how the operation is to proceed.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessimpleprogress-itemresult
     */
    ItemResult(pszFile, hrResult) {
        pszFile := pszFile is String ? StrPtr(pszFile) : pszFile

        result := ComCall(7, this, "ptr", pszFile, "int", hrResult, "int*", &pResponse := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
