...
class OFFLINEFILES_SETTING_VALUE_TYPE extends Win32Enum {
     ...
     * Native name: OFFLINEFILES_SETTING_VALUE_UI4
     * @type {Integer (Int32)}
     */
    static UI4 => 0
     ...
     * Native name: OFFLINEFILES_SETTING_VALUE_BSTR
     * @type {Integer (Int32)}
     */
    static BSTR => 1
     ...
     * Native name: OFFLINEFILES_SETTING_VALUE_BSTR_DBLNULTERM
     * @type {Integer (Int32)}
     */
    static BSTR_DBLNULTERM => 2
     ...
     * Native name: OFFLINEFILES_SETTING_VALUE_2DIM_ARRAY_BSTR_UI4
     * @type {Integer (Int32)}
     */
    static 2DIM_ARRAY_BSTR_UI4 => 3
     ...
     * Native name: OFFLINEFILES_SETTING_VALUE_2DIM_ARRAY_BSTR_BSTR
     * @type {Integer (Int32)}
     */
    static 2DIM_ARRAY_BSTR_BSTR => 4
}
