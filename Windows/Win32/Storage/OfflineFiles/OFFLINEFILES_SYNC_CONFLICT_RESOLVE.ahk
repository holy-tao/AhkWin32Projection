...
class OFFLINEFILES_SYNC_CONFLICT_RESOLVE extends Win32Enum {
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPLOCAL
     * @type {Integer (Int32)}
     */
    static KEEPLOCAL => 1
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPREMOTE
     * @type {Integer (Int32)}
     */
    static KEEPREMOTE => 2
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPALLCHANGES
     * @type {Integer (Int32)}
     */
    static KEEPALLCHANGES => 3
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_KEEPLATEST
     * @type {Integer (Int32)}
     */
    static KEEPLATEST => 4
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_LOG
     * @type {Integer (Int32)}
     */
    static LOG => 5
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_SKIP
     * @type {Integer (Int32)}
     */
    static SKIP => 6
     ...
     * Native name: OFFLINEFILES_SYNC_CONFLICT_ABORT
     * @type {Integer (Int32)}
     */
    static ABORT => 7

    /**
     * Native name: OFFLINEFILES_SYNC_CONFLICT_RESOLVE_NUMCODES
     * @type {Integer (Int32)}
     */
    static NUMCODES => 8
}
