 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilesevents3
...
class IOfflineFilesEvents3 extends IOfflineFilesEvents2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesevents3-transparentcacheitemnotify
     */
    TransparentCacheItemNotify(pszPath, EventType, ItemType, bModifiedData, bModifiedAttributes, pzsOldPath) {
        ...
        result := ComCall(37, this, "ptr", pszPath, "int", EventType, "int", ItemType, "int", bModifiedData, "int", bModifiedAttributes, "ptr", pzsOldPath, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesevents3-prefetchfilebegin
     */
    PrefetchFileBegin(pszPath) {
        pszPath := pszPath is String ? StrPtr(pszPath) : pszPath

        result := ComCall(38, this, "ptr", pszPath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesevents3-prefetchfileend
     */
    PrefetchFileEnd(pszPath, hrResult) {
        pszPath := pszPath is String ? StrPtr(pszPath) : pszPath

        result := ComCall(39, this, "ptr", pszPath, "int", hrResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
