 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilessyncerrorinfo
...
class IOfflineFilesSyncErrorInfo extends IOfflineFilesErrorInfo{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-getsyncoperation
     */
    GetSyncOperation() {
        result := ComCall(5, this, "int*", &pSyncOp := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-getitemchangeflags
     */
    GetItemChangeFlags() {
        result := ComCall(6, this, "uint*", &pdwItemChangeFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-infoenumerated
     */
    InfoEnumerated(pbLocalEnumerated, pbRemoteEnumerated, pbOriginalEnumerated) {
        ...
        result := ComCall(7, this, pbLocalEnumeratedMarshal, pbLocalEnumerated, pbRemoteEnumeratedMarshal, pbRemoteEnumerated, pbOriginalEnumeratedMarshal, pbOriginalEnumerated, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-infoavailable
     */
    InfoAvailable(pbLocalInfo, pbRemoteInfo, pbOriginalInfo) {
        ...
        result := ComCall(8, this, pbLocalInfoMarshal, pbLocalInfo, pbRemoteInfoMarshal, pbRemoteInfo, pbOriginalInfoMarshal, pbOriginalInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-getlocalinfo
     */
    GetLocalInfo() {
        result := ComCall(9, this, "ptr*", &ppInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-getremoteinfo
     */
    GetRemoteInfo() {
        result := ComCall(10, this, "ptr*", &ppInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerrorinfo-getoriginalinfo
     */
    GetOriginalInfo() {
        result := ComCall(11, this, "ptr*", &ppInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
