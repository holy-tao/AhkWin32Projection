 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilespininfo
...
class IOfflineFilesPinInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilespininfo-ispinned
     */
    IsPinned() {
        result := ComCall(3, this, "int*", &pbPinned := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilespininfo-ispinnedforuser
     */
    IsPinnedForUser(pbPinnedForUser, pbInherit) {
        ...
        result := ComCall(4, this, pbPinnedForUserMarshal, pbPinnedForUser, pbInheritMarshal, pbInherit, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<BOOL>} pbInherit Receives <b>TRUE</b> if the pinned state is inherited by new child items, or <b>FALSE</b> otherwise.
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilespininfo-ispinnedforuserbypolicy
     */
    IsPinnedForUserByPolicy(pbPinnedForUser, pbInherit) {
        pbPinnedForUserMarshal := pbPinnedForUser is VarRef ? "int*" : "ptr"
        pbInheritMarshal := pbInherit is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, pbPinnedForUserMarshal, pbPinnedForUser, pbInheritMarshal, pbInherit, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<BOOL>} pbInherit Receives <b>TRUE</b> if the pinned state is inherited by new child items, or <b>FALSE</b> otherwise.
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilespininfo-ispinnedforcomputer
     */
    IsPinnedForComputer(pbPinnedForComputer, pbInherit) {
        pbPinnedForComputerMarshal := pbPinnedForComputer is VarRef ? "int*" : "ptr"
        pbInheritMarshal := pbInherit is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pbPinnedForComputerMarshal, pbPinnedForComputer, pbInheritMarshal, pbInherit, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<BOOL>} pbInherit Receives <b>TRUE</b> if the pinned state is inherited by new child items, or <b>FALSE</b> otherwise.
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilespininfo-ispinnedforfolderredirection
     */
    IsPinnedForFolderRedirection(pbPinnedForFolderRedirection, pbInherit) {
        ...
        result := ComCall(7, this, pbPinnedForFolderRedirectionMarshal, pbPinnedForFolderRedirection, pbInheritMarshal, pbInherit, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
