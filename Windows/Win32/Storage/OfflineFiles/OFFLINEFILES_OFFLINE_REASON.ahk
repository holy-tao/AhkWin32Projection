...
class OFFLINEFILES_OFFLINE_REASON extends Win32Enum {
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 0
    ...
    /**
     * The item is online.
     * Native name: OFFLINEFILES_OFFLINE_REASON_NOT_APPLICABLE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_CONNECTION_FORCED
     * @type {Integer (Int32)}
     */
    static CONNECTION_FORCED => 2
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_CONNECTION_SLOW
     * @type {Integer (Int32)}
     */
    static CONNECTION_SLOW => 3
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_CONNECTION_ERROR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_ITEM_VERSION_CONFLICT
     * @type {Integer (Int32)}
     */
    static ITEM_VERSION_CONFLICT => 5
     ...
     * Native name: OFFLINEFILES_OFFLINE_REASON_ITEM_SUSPENDED
     * @type {Integer (Int32)}
     */
    static ITEM_SUSPENDED => 6
}
