...
export default struct IOfflineFilesEvents extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.CacheMoved := CallbackCreate(ObjBindMethod(implObj, "CacheMoved"), flags, 3)
        this.vtbl.CacheIsFull := CallbackCreate(ObjBindMethod(implObj, "CacheIsFull"), flags, 1)
        this.vtbl.CacheIsCorrupted := CallbackCreate(ObjBindMethod(implObj, "CacheIsCorrupted"), flags, 1)
        this.vtbl.Enabled := CallbackCreate(ObjBindMethod(implObj, "Enabled"), flags, 2)
        this.vtbl.EncryptionChanged := CallbackCreate(ObjBindMethod(implObj, "EncryptionChanged"), flags, 5)
        this.vtbl.SyncBegin := CallbackCreate(ObjBindMethod(implObj, "SyncBegin"), flags, 2)
        this.vtbl.SyncFileResult := CallbackCreate(ObjBindMethod(implObj, "SyncFileResult"), flags, 4)
        this.vtbl.SyncConflictRecAdded := CallbackCreate(ObjBindMethod(implObj, "SyncConflictRecAdded"), flags, 4)
        this.vtbl.SyncConflictRecUpdated := CallbackCreate(ObjBindMethod(implObj, "SyncConflictRecUpdated"), flags, 4)
        this.vtbl.SyncConflictRecRemoved := CallbackCreate(ObjBindMethod(implObj, "SyncConflictRecRemoved"), flags, 4)
        this.vtbl.SyncEnd := CallbackCreate(ObjBindMethod(implObj, "SyncEnd"), flags, 3)
        this.vtbl.NetTransportArrived := CallbackCreate(ObjBindMethod(implObj, "NetTransportArrived"), flags, 1)
        this.vtbl.NoNetTransports := CallbackCreate(ObjBindMethod(implObj, "NoNetTransports"), flags, 1)
        this.vtbl.ItemDisconnected := CallbackCreate(ObjBindMethod(implObj, "ItemDisconnected"), flags, 3)
        this.vtbl.ItemReconnected := CallbackCreate(ObjBindMethod(implObj, "ItemReconnected"), flags, 3)
        this.vtbl.ItemAvailableOffline := CallbackCreate(ObjBindMethod(implObj, "ItemAvailableOffline"), flags, 3)
        this.vtbl.ItemNotAvailableOffline := CallbackCreate(ObjBindMethod(implObj, "ItemNotAvailableOffline"), flags, 3)
        this.vtbl.ItemPinned := CallbackCreate(ObjBindMethod(implObj, "ItemPinned"), flags, 3)
        this.vtbl.ItemNotPinned := CallbackCreate(ObjBindMethod(implObj, "ItemNotPinned"), flags, 3)
        this.vtbl.ItemModified := CallbackCreate(ObjBindMethod(implObj, "ItemModified"), flags, 5)
        this.vtbl.ItemAddedToCache := CallbackCreate(ObjBindMethod(implObj, "ItemAddedToCache"), flags, 3)
        this.vtbl.ItemDeletedFromCache := CallbackCreate(ObjBindMethod(implObj, "ItemDeletedFromCache"), flags, 3)
        this.vtbl.ItemRenamed := CallbackCreate(ObjBindMethod(implObj, "ItemRenamed"), flags, 4)
        this.vtbl.DataLost := CallbackCreate(ObjBindMethod(implObj, "DataLost"), flags, 1)
        this.vtbl.Ping := CallbackCreate(ObjBindMethod(implObj, "Ping"), flags, 1)
    }
