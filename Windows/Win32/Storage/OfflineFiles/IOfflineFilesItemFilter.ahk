 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilesitemfilter
...
class IOfflineFilesItemFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesitemfilter-getfilterflags
     */
    GetFilterFlags(pullFlags, pullMask) {
        ...
        result := ComCall(3, this, pullFlagsMarshal, pullFlags, pullMaskMarshal, pullMask, "int")
        if(result != 0) {
     ...
     * 
     * Any other error value causes the creation of the enumerator to fail.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesitemfilter-gettimefilter
     */
    GetTimeFilter(pftTime, pbEvalTimeOfDay, pTimeType, pCompare) {
        ...
        result := ComCall(4, this, "ptr", pftTime, pbEvalTimeOfDayMarshal, pbEvalTimeOfDay, pTimeTypeMarshal, pTimeType, pCompareMarshal, pCompare, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Any other error value causes the creation of the enumerator to fail.
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesitemfilter-getpatternfilter
     */
