 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilessyncerroriteminfo
...
class IOfflineFilesSyncErrorItemInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerroriteminfo-getfileattributes
     */
    GetFileAttributes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerroriteminfo-getfiletimes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessyncerroriteminfo-getfilesize
     */
    GetFileSize() {
        result := ComCall(5, this, "int64*", &pSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
