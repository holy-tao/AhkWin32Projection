 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilesfilesysinfo
...
class IOfflineFilesFileSysInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesfilesysinfo-getattributes
     */
    GetAttributes(copy) {
        result := ComCall(3, this, "int", copy, "uint*", &pdwAttributes := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesfilesysinfo-gettimes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesfilesysinfo-getfilesize
     */
    GetFileSize(copy) {
        result := ComCall(5, this, "int", copy, "int64*", &pSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
