 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-ienumofflinefilesitems
...
class IEnumOfflineFilesItems extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-ienumofflinefilesitems-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-ienumofflinefilesitems-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-ienumofflinefilesitems-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-ienumofflinefilesitems-clone
     */
    Clone() {
