 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilessetting
...
class IOfflineFilesSetting extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getname
     */
    GetName() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getvaluetype
     */
    GetValueType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getpreference
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getpreferencescope
     */
    GetPreferenceScope() {
        result := ComCall(6, this, "uint*", &pdwScope := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-setpreference
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-deletepreference
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getpolicy
     */
    GetPolicy(dwScope) {
        pvarValue := VARIANT()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getpolicyscope
     */
    GetPolicyScope() {
        result := ComCall(10, this, "uint*", &pdwScope := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilessetting-getvalue
     */
    GetValue(pvarValue, pbSetByPolicy) {
        pbSetByPolicyMarshal := pbSetByPolicy is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, "ptr", pvarValue, pbSetByPolicyMarshal, pbSetByPolicy, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
