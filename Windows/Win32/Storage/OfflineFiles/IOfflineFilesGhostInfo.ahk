 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nn-cscobj-iofflinefilesghostinfo
...
class IOfflineFilesGhostInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cscobj/nf-cscobj-iofflinefilesghostinfo-isghosted
     */
    IsGhosted() {
        result := ComCall(3, this, "int*", &pbGhosted := 0, "int")
        if(result != 0) {
