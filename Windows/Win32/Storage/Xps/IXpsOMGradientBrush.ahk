...
class IXpsOMGradientBrush extends IXpsOMBrush{
    ...
    GetGradientStops(gradientStops) {
        result := ComCall(7, this, "ptr", gradientStops, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<Int32>} spreadMethod 
     * @returns {HRESULT} 
     */
    GetSpreadMethod(spreadMethod) {
        result := ComCall(13, this, "int*", spreadMethod, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int32>} colorInterpolationMode 
     * @returns {HRESULT} 
     */
    GetColorInterpolationMode(colorInterpolationMode) {
        result := ComCall(15, this, "int*", colorInterpolationMode, "int")
        if(result != 0)
            throw OSError(result)
