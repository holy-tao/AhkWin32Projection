 ...
 * @see https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomcolorprofileresourcecollection
 * @namespace Windows.Win32.Storage.Xps
 */
export default struct IXpsOMColorProfileResourceCollection extends IUnknown {
    /**
     ...
     * used for IXpsOMColorProfileResourceCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IXpsOMColorProfileResourceCollection.Vtbl()
        }
    ...
    GetAt(index) {
        ...
        return IXpsOMColorProfileResource(_object)
    }
     ...
     * @param {IXpsOMColorProfileResource} _object The <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomcolorprofileresource">IXpsOMColorProfileResource</a> interface pointer that is to be inserted in the location specified by <i>index</i>.
     ...
     * @param {IXpsOMColorProfileResource} _object The <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomcolorprofileresource">IXpsOMColorProfileResource</a> interface pointer that will replace current contents at the location specified by <i>index</i>.
     * @returns {HRESULT} If the method succeeds, it returns S_OK; otherwise, it returns an <b>HRESULT</b> error code.
     ...
     * @remarks
     * For more information about the collection methods, see  <a href="https://docs.microsoft.com/previous-versions/windows/desktop/dd372931(v=vs.85)">Working with XPS OM Collection Interfaces</a>.
     * @param {IXpsOMColorProfileResource} _object A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomcolorprofileresource">IXpsOMColorProfileResource</a> interface that is to be appended to the collection.
     * @returns {HRESULT} If the method succeeds, it returns S_OK; otherwise, it returns an <b>HRESULT</b> error code.
    ...
    _Query(iid) {
        if (IXpsOMColorProfileResourceCollection.IID.Equals(iid)) {
            return true
        }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetByPartName := CallbackCreate(ObjBindMethod(implObj, "GetByPartName"), flags, 3)
    }
