 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsompath
...
class IXpsOMPath extends IXpsOMVisual{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getgeometry
     */
    GetGeometry() {
        result := ComCall(30, this, "ptr*", &geometry := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getgeometrylocal
     */
    GetGeometryLocal() {
        result := ComCall(31, this, "ptr*", &geometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setgeometrylocal
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getgeometrylookup
     */
    GetGeometryLookup() {
        result := ComCall(33, this, "ptr*", &lookup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setgeometrylookup
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getaccessibilityshortdescription
     */
    GetAccessibilityShortDescription() {
        result := ComCall(35, this, "ptr*", &shortDescription := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setaccessibilityshortdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getaccessibilitylongdescription
     */
    GetAccessibilityLongDescription() {
        result := ComCall(37, this, "ptr*", &longDescription := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK; otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setaccessibilitylongdescription
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getsnapstopixels
     */
    GetSnapsToPixels() {
        result := ComCall(39, this, "int*", &snapsToPixels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} If the method succeeds, it returns S_OK; otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setsnapstopixels
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokebrush
     */
    GetStrokeBrush() {
        result := ComCall(41, this, "ptr*", &brush := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokebrushlocal
     */
    GetStrokeBrushLocal() {
        result := ComCall(42, this, "ptr*", &brush := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokebrushlocal
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokebrushlookup
     */
    GetStrokeBrushLookup() {
        result := ComCall(44, this, "ptr*", &lookup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokebrushlookup
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokedashes
     */
    GetStrokeDashes() {
        result := ComCall(46, this, "ptr*", &strokeDashes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokedashcap
     */
    GetStrokeDashCap() {
        result := ComCall(47, this, "int*", &strokeDashCap := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokedashcap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokedashoffset
     */
    GetStrokeDashOffset() {
        result := ComCall(49, this, "float*", &strokeDashOffset := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokedashoffset
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokestartlinecap
     */
    GetStrokeStartLineCap() {
        result := ComCall(51, this, "int*", &strokeStartLineCap := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokestartlinecap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokeendlinecap
     */
    GetStrokeEndLineCap() {
        result := ComCall(53, this, "int*", &strokeEndLineCap := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokeendlinecap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokelinejoin
     */
    GetStrokeLineJoin() {
        result := ComCall(55, this, "int*", &strokeLineJoin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokelinejoin
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokemiterlimit
     */
    GetStrokeMiterLimit() {
        result := ComCall(57, this, "float*", &strokeMiterLimit := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokemiterlimit
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getstrokethickness
     */
    GetStrokeThickness() {
        result := ComCall(59, this, "float*", &strokeThickness := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setstrokethickness
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getfillbrush
     */
    GetFillBrush() {
        result := ComCall(61, this, "ptr*", &brush := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getfillbrushlocal
     */
    GetFillBrushLocal() {
        result := ComCall(62, this, "ptr*", &brush := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setfillbrushlocal
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-getfillbrushlookup
     */
    GetFillBrushLookup() {
        result := ComCall(64, this, "ptr*", &lookup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-setfillbrushlookup
     */
     ...
     * @returns {IXpsOMPath} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsompath-clone
     */
    Clone() {
        result := ComCall(66, this, "ptr*", &path_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
