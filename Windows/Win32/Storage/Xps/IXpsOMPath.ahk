...
export default struct IXpsOMPath extends IXpsOMVisual {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetGeometryLocal := CallbackCreate(ObjBindMethod(implObj, "GetGeometryLocal"), flags, 2)
        this.vtbl.SetGeometryLocal := CallbackCreate(ObjBindMethod(implObj, "SetGeometryLocal"), flags, 2)
        this.vtbl.GetGeometryLookup := CallbackCreate(ObjBindMethod(implObj, "GetGeometryLookup"), flags, 2)
        this.vtbl.SetGeometryLookup := CallbackCreate(ObjBindMethod(implObj, "SetGeometryLookup"), flags, 2)
        ...
        this.vtbl.GetSnapsToPixels := CallbackCreate(ObjBindMethod(implObj, "GetSnapsToPixels"), flags, 2)
        this.vtbl.SetSnapsToPixels := CallbackCreate(ObjBindMethod(implObj, "SetSnapsToPixels"), flags, 2)
        this.vtbl.GetStrokeBrush := CallbackCreate(ObjBindMethod(implObj, "GetStrokeBrush"), flags, 2)
        this.vtbl.GetStrokeBrushLocal := CallbackCreate(ObjBindMethod(implObj, "GetStrokeBrushLocal"), flags, 2)
        this.vtbl.SetStrokeBrushLocal := CallbackCreate(ObjBindMethod(implObj, "SetStrokeBrushLocal"), flags, 2)
        this.vtbl.GetStrokeBrushLookup := CallbackCreate(ObjBindMethod(implObj, "GetStrokeBrushLookup"), flags, 2)
        this.vtbl.SetStrokeBrushLookup := CallbackCreate(ObjBindMethod(implObj, "SetStrokeBrushLookup"), flags, 2)
        this.vtbl.GetStrokeDashes := CallbackCreate(ObjBindMethod(implObj, "GetStrokeDashes"), flags, 2)
        this.vtbl.GetStrokeDashCap := CallbackCreate(ObjBindMethod(implObj, "GetStrokeDashCap"), flags, 2)
        this.vtbl.SetStrokeDashCap := CallbackCreate(ObjBindMethod(implObj, "SetStrokeDashCap"), flags, 2)
        this.vtbl.GetStrokeDashOffset := CallbackCreate(ObjBindMethod(implObj, "GetStrokeDashOffset"), flags, 2)
        this.vtbl.SetStrokeDashOffset := CallbackCreate(ObjBindMethod(implObj, "SetStrokeDashOffset"), flags, 2)
        this.vtbl.GetStrokeStartLineCap := CallbackCreate(ObjBindMethod(implObj, "GetStrokeStartLineCap"), flags, 2)
        this.vtbl.SetStrokeStartLineCap := CallbackCreate(ObjBindMethod(implObj, "SetStrokeStartLineCap"), flags, 2)
        this.vtbl.GetStrokeEndLineCap := CallbackCreate(ObjBindMethod(implObj, "GetStrokeEndLineCap"), flags, 2)
        this.vtbl.SetStrokeEndLineCap := CallbackCreate(ObjBindMethod(implObj, "SetStrokeEndLineCap"), flags, 2)
        this.vtbl.GetStrokeLineJoin := CallbackCreate(ObjBindMethod(implObj, "GetStrokeLineJoin"), flags, 2)
        this.vtbl.SetStrokeLineJoin := CallbackCreate(ObjBindMethod(implObj, "SetStrokeLineJoin"), flags, 2)
        this.vtbl.GetStrokeMiterLimit := CallbackCreate(ObjBindMethod(implObj, "GetStrokeMiterLimit"), flags, 2)
        this.vtbl.SetStrokeMiterLimit := CallbackCreate(ObjBindMethod(implObj, "SetStrokeMiterLimit"), flags, 2)
        this.vtbl.GetStrokeThickness := CallbackCreate(ObjBindMethod(implObj, "GetStrokeThickness"), flags, 2)
        this.vtbl.SetStrokeThickness := CallbackCreate(ObjBindMethod(implObj, "SetStrokeThickness"), flags, 2)
