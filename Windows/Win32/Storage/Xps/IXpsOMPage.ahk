...
export default struct IXpsOMPage extends IXpsOMPart {
    ...
    */
     ...
     * @param {XPS_OBJECT_TYPE} type The   type of <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomshareable">IXpsOMShareable</a> object  for which  the lookup key is generated.
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetPageDimensions := CallbackCreate(ObjBindMethod(implObj, "GetPageDimensions"), flags, 2)
        this.vtbl.SetPageDimensions := CallbackCreate(ObjBindMethod(implObj, "SetPageDimensions"), flags, 2)
        this.vtbl.GetContentBox := CallbackCreate(ObjBindMethod(implObj, "GetContentBox"), flags, 2)
        this.vtbl.SetContentBox := CallbackCreate(ObjBindMethod(implObj, "SetContentBox"), flags, 2)
        this.vtbl.GetBleedBox := CallbackCreate(ObjBindMethod(implObj, "GetBleedBox"), flags, 2)
        this.vtbl.SetBleedBox := CallbackCreate(ObjBindMethod(implObj, "SetBleedBox"), flags, 2)
        ...
        this.vtbl.GenerateUnusedLookupKey := CallbackCreate(ObjBindMethod(implObj, "GenerateUnusedLookupKey"), flags, 3)
