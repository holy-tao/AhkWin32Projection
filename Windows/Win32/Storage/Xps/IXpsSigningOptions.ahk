...
export default struct IXpsSigningOptions extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetDigestMethod := CallbackCreate(ObjBindMethod(implObj, "SetDigestMethod"), flags, 2)
        ...
        this.vtbl.SetSigningTimeFormat := CallbackCreate(ObjBindMethod(implObj, "SetSigningTimeFormat"), flags, 2)
        this.vtbl.GetCustomObjects := CallbackCreate(ObjBindMethod(implObj, "GetCustomObjects"), flags, 2)
        this.vtbl.GetCustomReferences := CallbackCreate(ObjBindMethod(implObj, "GetCustomReferences"), flags, 2)
