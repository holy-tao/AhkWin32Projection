...
class IXpsOMThumbnailGenerator extends IUnknown{
     ...
     * @param {Pointer<IOpcPartUri>} imageResourcePartName 
    ...
    GenerateThumbnail(page, thumbnailType, thumbnailSize, imageResourcePartName, imageResource) {
        result := ComCall(3, this, "ptr", page, "int", thumbnailType, "int", thumbnailSize, "ptr", imageResourcePartName, "ptr", imageResource, "int")
        if(result != 0)
