 ...
 */
export default struct IXpsOMGeometryFigureCollection extends IUnknown {
    /**
     ...
     * used for IXpsOMGeometryFigureCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IXpsOMGeometryFigureCollection.Vtbl()
        }
    ...
    Query(iid) {
        if (IXpsOMGeometryFigureCollection.IID.Equals(iid)) {
            return true
        }
