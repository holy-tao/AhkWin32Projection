...
export default struct IXpsOMVisual extends IXpsOMShareable {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetClipGeometry := CallbackCreate(ObjBindMethod(implObj, "GetClipGeometry"), flags, 2)
        this.vtbl.GetClipGeometryLocal := CallbackCreate(ObjBindMethod(implObj, "GetClipGeometryLocal"), flags, 2)
        this.vtbl.SetClipGeometryLocal := CallbackCreate(ObjBindMethod(implObj, "SetClipGeometryLocal"), flags, 2)
        this.vtbl.GetClipGeometryLookup := CallbackCreate(ObjBindMethod(implObj, "GetClipGeometryLookup"), flags, 2)
        this.vtbl.SetClipGeometryLookup := CallbackCreate(ObjBindMethod(implObj, "SetClipGeometryLookup"), flags, 2)
        ...
        this.vtbl.GetOpacityMaskBrush := CallbackCreate(ObjBindMethod(implObj, "GetOpacityMaskBrush"), flags, 2)
        this.vtbl.GetOpacityMaskBrushLocal := CallbackCreate(ObjBindMethod(implObj, "GetOpacityMaskBrushLocal"), flags, 2)
        this.vtbl.SetOpacityMaskBrushLocal := CallbackCreate(ObjBindMethod(implObj, "SetOpacityMaskBrushLocal"), flags, 2)
        this.vtbl.GetOpacityMaskBrushLookup := CallbackCreate(ObjBindMethod(implObj, "GetOpacityMaskBrushLookup"), flags, 2)
        this.vtbl.SetOpacityMaskBrushLookup := CallbackCreate(ObjBindMethod(implObj, "SetOpacityMaskBrushLookup"), flags, 2)
        ...
        this.vtbl.GetIsHyperlinkTarget := CallbackCreate(ObjBindMethod(implObj, "GetIsHyperlinkTarget"), flags, 2)
        this.vtbl.SetIsHyperlinkTarget := CallbackCreate(ObjBindMethod(implObj, "SetIsHyperlinkTarget"), flags, 2)
        this.vtbl.GetHyperlinkNavigateUri := CallbackCreate(ObjBindMethod(implObj, "GetHyperlinkNavigateUri"), flags, 2)
        this.vtbl.SetHyperlinkNavigateUri := CallbackCreate(ObjBindMethod(implObj, "SetHyperlinkNavigateUri"), flags, 2)
