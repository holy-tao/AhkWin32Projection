...
export default struct IXpsOMCoreProperties extends IXpsOMPart {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetContentStatus := CallbackCreate(ObjBindMethod(implObj, "GetContentStatus"), flags, 2)
        this.vtbl.SetContentStatus := CallbackCreate(ObjBindMethod(implObj, "SetContentStatus"), flags, 2)
        this.vtbl.GetContentType := CallbackCreate(ObjBindMethod(implObj, "GetContentType"), flags, 2)
        this.vtbl.SetContentType := CallbackCreate(ObjBindMethod(implObj, "SetContentType"), flags, 2)
        this.vtbl.GetCreated := CallbackCreate(ObjBindMethod(implObj, "GetCreated"), flags, 2)
        this.vtbl.SetCreated := CallbackCreate(ObjBindMethod(implObj, "SetCreated"), flags, 2)
        ...
        this.vtbl.SetKeywords := CallbackCreate(ObjBindMethod(implObj, "SetKeywords"), flags, 2)
        ...
        this.vtbl.GetLastModifiedBy := CallbackCreate(ObjBindMethod(implObj, "GetLastModifiedBy"), flags, 2)
        this.vtbl.SetLastModifiedBy := CallbackCreate(ObjBindMethod(implObj, "SetLastModifiedBy"), flags, 2)
        this.vtbl.GetLastPrinted := CallbackCreate(ObjBindMethod(implObj, "GetLastPrinted"), flags, 2)
        this.vtbl.SetLastPrinted := CallbackCreate(ObjBindMethod(implObj, "SetLastPrinted"), flags, 2)
        this.vtbl.GetModified := CallbackCreate(ObjBindMethod(implObj, "GetModified"), flags, 2)
        this.vtbl.SetModified := CallbackCreate(ObjBindMethod(implObj, "SetModified"), flags, 2)
        this.vtbl.GetRevision := CallbackCreate(ObjBindMethod(implObj, "GetRevision"), flags, 2)
        this.vtbl.SetRevision := CallbackCreate(ObjBindMethod(implObj, "SetRevision"), flags, 2)
        this.vtbl.GetSubject := CallbackCreate(ObjBindMethod(implObj, "GetSubject"), flags, 2)
        this.vtbl.SetSubject := CallbackCreate(ObjBindMethod(implObj, "SetSubject"), flags, 2)
        ...
        this.vtbl.SetVersion := CallbackCreate(ObjBindMethod(implObj, "SetVersion"), flags, 2)
