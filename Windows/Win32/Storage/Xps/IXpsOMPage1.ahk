 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel_1/nn-xpsobjectmodel_1-ixpsompage1
...
class IXpsOMPage1 extends IXpsOMPage{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel_1/nf-xpsobjectmodel_1-ixpsompage1-getdocumenttype
     */
    GetDocumentType() {
        result := ComCall(27, this, "int*", &documentType := 0, "int")
        if(result != 0) {
