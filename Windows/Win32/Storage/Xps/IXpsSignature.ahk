 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nn-xpsdigitalsignature-ixpssignature
...
class IXpsSignature extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsignatureid
     */
    GetSignatureId() {
        result := ComCall(3, this, "ptr*", &sigId := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsignaturevalue
     */
    GetSignatureValue(signatureHashValue, count) {
        signatureHashValueMarshal := signatureHashValue is VarRef ? "ptr*" : "ptr"
        countMarshal := count is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, signatureHashValueMarshal, signatureHashValue, countMarshal, count, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getcertificateenumerator
     */
    GetCertificateEnumerator() {
        result := ComCall(5, this, "ptr*", &certificateEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsigningtime
     */
    GetSigningTime() {
        result := ComCall(6, this, "ptr*", &sigDateTimeString := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsigningtimeformat
     */
    GetSigningTimeFormat() {
        result := ComCall(7, this, "int*", &timeFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsignaturepartname
     */
    GetSignaturePartName() {
        result := ComCall(8, this, "ptr*", &signaturePartName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<CERT_CONTEXT>} x509Certificate_ The <a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-cert_context">CERT_CONTEXT</a> structure that contains the X.509 certificate that will be used for verification.
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-verify
     */
    Verify(x509Certificate_) {
        result := ComCall(9, this, "ptr", x509Certificate_, "int*", &sigStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getpolicy
     */
    GetPolicy() {
        result := ComCall(10, this, "int*", &policy := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getcustomobjectenumerator
     */
    GetCustomObjectEnumerator() {
        result := ComCall(11, this, "ptr*", &customObjectEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getcustomreferenceenumerator
     */
    GetCustomReferenceEnumerator() {
        result := ComCall(12, this, "ptr*", &customReferenceEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-getsignaturexml
     */
    GetSignatureXml(signatureXml, count) {
        signatureXmlMarshal := signatureXml is VarRef ? "ptr*" : "ptr"
        countMarshal := count is VarRef ? "uint*" : "ptr"

        result := ComCall(13, this, signatureXmlMarshal, signatureXml, countMarshal, count, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignature-setsignaturexml
     */
    SetSignatureXml(signatureXml, count) {
        signatureXmlMarshal := signatureXml is VarRef ? "char*" : "ptr"

        result := ComCall(14, this, signatureXmlMarshal, signatureXml, "uint", count, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
