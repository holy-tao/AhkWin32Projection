 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel_1/nn-xpsobjectmodel_1-ixpsomremotedictionaryresource1
...
class IXpsOMRemoteDictionaryResource1 extends IXpsOMRemoteDictionaryResource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel_1/nf-xpsobjectmodel_1-ixpsomremotedictionaryresource1-getdocumenttype
     */
    GetDocumentType() {
        result := ComCall(7, this, "int*", &documentType := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel_1/nf-xpsobjectmodel_1-ixpsomremotedictionaryresource1-write1
     */
