 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsomdictionary
...
class IXpsOMDictionary extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-getowner
     */
    GetOwner() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-getcount
     */
    GetCount() {
        result := ComCall(4, this, "uint*", &count := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-getat
     */
    GetAt(index, key) {
        keyMarshal := key is VarRef ? "ptr*" : "ptr"

        result := ComCall(5, this, "uint", index, keyMarshal, key, "ptr*", &entry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-getbykey
     */
    GetByKey(key, beforeEntry) {
        key := key is String ? StrPtr(key) : key

        result := ComCall(6, this, "ptr", key, "ptr", beforeEntry, "ptr*", &entry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-getindex
     */
    GetIndex(entry) {
        result := ComCall(7, this, "ptr", entry, "uint*", &index := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-append
     */
    Append(key, entry) {
        key := key is String ? StrPtr(key) : key
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-insertat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-removeat
     */
    RemoveAt(index) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-setat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomdictionary-clone
     */
    Clone() {
        result := ComCall(12, this, "ptr*", &dictionary := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
