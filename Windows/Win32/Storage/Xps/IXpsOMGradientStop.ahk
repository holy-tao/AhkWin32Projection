 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop
...
class IXpsOMGradientStop extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-getowner
     */
    GetOwner() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-getoffset
     */
    GetOffset() {
        result := ComCall(4, this, "float*", &offset := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-setoffset
     */
    SetOffset(offset) {
        result := ComCall(5, this, "float", offset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<XPS_COLOR>} color_ The color value of the gradient stop.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-getcolor
     */
    GetColor(color_) {
        result := ComCall(6, this, "ptr", color_, "ptr*", &colorProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<XPS_COLOR>} color_ The color value to be set at the gradient stop.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-setcolor
     */
    SetColor(color_, colorProfile) {
        result := ComCall(7, this, "ptr", color_, "ptr", colorProfile, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * This method does not update any of the resource pointers in the  <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop">IXpsOMGradientStop</a>  interface returned in <i>gradientStop</i>.
     * @returns {IXpsOMGradientStop} A pointer to the copy of the  interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgradientstop-clone
     */
    Clone() {
        result := ComCall(8, this, "ptr*", &gradientStop := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
