...
class IPrintDocumentPackageStatusEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/documenttarget/nf-documenttarget-iprintdocumentpackagestatusevent-packagestatusupdated
     */
    PackageStatusUpdated(packageStatus) {
        result := ComCall(7, this, "ptr", packageStatus, "int")
        if(result != 0) {
