...
class IPrintDocumentPackageTargetFactory extends IUnknown{
     ...
     * @param {PWSTR} jobName 
     * @param {Pointer<IStream>} jobOutputStream 
     * @param {Pointer<IStream>} jobPrintTicketStream 
    ...
    CreateDocumentPackageTargetForPrintJob(printerName, jobName, jobOutputStream, jobPrintTicketStream, docPackageTarget) {
        ...
        result := ComCall(3, this, "ptr", printerName, "ptr", jobName, "ptr", jobOutputStream, "ptr", jobPrintTicketStream, "ptr", docPackageTarget, "int")
        if(result != 0)
