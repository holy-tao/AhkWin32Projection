 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgeometry
...
class IXpsOMGeometry extends IXpsOMShareable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-getfigures
     */
    GetFigures() {
        result := ComCall(5, this, "ptr*", &figures := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-getfillrule
     */
    GetFillRule() {
        result := ComCall(6, this, "int*", &fillRule := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-setfillrule
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-gettransform
     */
    GetTransform() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-gettransformlocal
     */
    GetTransformLocal() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-settransformlocal
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-gettransformlookup
     */
    GetTransformLookup() {
        result := ComCall(11, this, "ptr*", &lookup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <tr>
     * <td>
     * Neither <a href="https://docs.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-settransformlocal">SetTransformLocal</a> nor <b>SetTransformLookup</b> has been called yet.
     * 
     * </td>
     * <td>
     * <b>NULL</b> pointer.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-settransformlookup
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomgeometry-clone
     */
    Clone() {
        result := ComCall(13, this, "ptr*", &geometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
