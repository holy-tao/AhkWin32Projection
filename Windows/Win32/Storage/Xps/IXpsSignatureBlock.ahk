 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nn-xpsdigitalsignature-ixpssignatureblock
...
class IXpsSignatureBlock extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignatureblock-getrequests
     */
    GetRequests() {
        result := ComCall(3, this, "ptr*", &requests := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignatureblock-getpartname
     */
    GetPartName() {
        result := ComCall(4, this, "ptr*", &partName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignatureblock-getdocumentindex
     */
    GetDocumentIndex() {
        result := ComCall(5, this, "uint*", &fixedDocumentIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignatureblock-getdocumentname
     */
    GetDocumentName() {
        result := ComCall(6, this, "ptr*", &fixedDocumentName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsdigitalsignature/nf-xpsdigitalsignature-ixpssignatureblock-createrequest
     */
    CreateRequest(requestId) {
        requestId := requestId is String ? StrPtr(requestId) : requestId

        result := ComCall(7, this, "ptr", requestId, "ptr*", &signatureRequest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
