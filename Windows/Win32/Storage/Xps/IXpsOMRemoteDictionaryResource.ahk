 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsomremotedictionaryresource
...
class IXpsOMRemoteDictionaryResource extends IXpsOMResource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomremotedictionaryresource-getdictionary
     */
    GetDictionary() {
        result := ComCall(5, this, "ptr*", &dictionary := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomremotedictionaryresource-setdictionary
     */
    SetDictionary(dictionary) {
        result := ComCall(6, this, "ptr", dictionary, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
