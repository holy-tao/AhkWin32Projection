...
class XPS_SIGNATURE_STATUS extends Win32Enum {
     ...
     * Native name: XPS_SIGNATURE_STATUS_INCOMPLIANT
     * @type {Integer (Int32)}
     */
    static INCOMPLIANT => 1
     ...
     * Native name: XPS_SIGNATURE_STATUS_INCOMPLETE
     * @type {Integer (Int32)}
     */
    static INCOMPLETE => 2
     ...
     * Native name: XPS_SIGNATURE_STATUS_BROKEN
     * @type {Integer (Int32)}
     */
    static BROKEN => 3
     ...
     * Native name: XPS_SIGNATURE_STATUS_QUESTIONABLE
     * @type {Integer (Int32)}
     */
    static QUESTIONABLE => 4
     ...
     * Native name: XPS_SIGNATURE_STATUS_VALID
     * @type {Integer (Int32)}
     */
    static VALID => 5
}
