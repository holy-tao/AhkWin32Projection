...
export default struct IXpsOMPageReference extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetPage := CallbackCreate(ObjBindMethod(implObj, "GetPage"), flags, 2)
        this.vtbl.SetPage := CallbackCreate(ObjBindMethod(implObj, "SetPage"), flags, 2)
        this.vtbl.DiscardPage := CallbackCreate(ObjBindMethod(implObj, "DiscardPage"), flags, 1)
        this.vtbl.IsPageLoaded := CallbackCreate(ObjBindMethod(implObj, "IsPageLoaded"), flags, 2)
        this.vtbl.GetAdvisoryPageDimensions := CallbackCreate(ObjBindMethod(implObj, "GetAdvisoryPageDimensions"), flags, 2)
        this.vtbl.SetAdvisoryPageDimensions := CallbackCreate(ObjBindMethod(implObj, "SetAdvisoryPageDimensions"), flags, 2)
        this.vtbl.GetStoryFragmentsResource := CallbackCreate(ObjBindMethod(implObj, "GetStoryFragmentsResource"), flags, 2)
        this.vtbl.SetStoryFragmentsResource := CallbackCreate(ObjBindMethod(implObj, "SetStoryFragmentsResource"), flags, 2)
        ...
        this.vtbl.CollectLinkTargets := CallbackCreate(ObjBindMethod(implObj, "CollectLinkTargets"), flags, 2)
        this.vtbl.CollectPartResources := CallbackCreate(ObjBindMethod(implObj, "CollectPartResources"), flags, 2)
        this.vtbl.HasRestrictedFonts := CallbackCreate(ObjBindMethod(implObj, "HasRestrictedFonts"), flags, 2)
