 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nn-xpsobjectmodel-ixpsomshareable
...
class IXpsOMShareable extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomshareable-getowner
     */
    GetOwner() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xpsobjectmodel/nf-xpsobjectmodel-ixpsomshareable-gettype
     */
    GetType() {
        result := ComCall(4, this, "int*", &type := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
