...
export default struct IXpsOMObjectFactory extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.CreatePackageFromFile := CallbackCreate(ObjBindMethod(implObj, "CreatePackageFromFile"), flags, 4)
        this.vtbl.CreatePackageFromStream := CallbackCreate(ObjBindMethod(implObj, "CreatePackageFromStream"), flags, 4)
        this.vtbl.CreateStoryFragmentsResource := CallbackCreate(ObjBindMethod(implObj, "CreateStoryFragmentsResource"), flags, 4)
        this.vtbl.CreateDocumentStructureResource := CallbackCreate(ObjBindMethod(implObj, "CreateDocumentStructureResource"), flags, 4)
        this.vtbl.CreateSignatureBlockResource := CallbackCreate(ObjBindMethod(implObj, "CreateSignatureBlockResource"), flags, 4)
        this.vtbl.CreateRemoteDictionaryResource := CallbackCreate(ObjBindMethod(implObj, "CreateRemoteDictionaryResource"), flags, 4)
        this.vtbl.CreateRemoteDictionaryResourceFromStream := CallbackCreate(ObjBindMethod(implObj, "CreateRemoteDictionaryResourceFromStream"), flags, 5)
        this.vtbl.CreatePartResources := CallbackCreate(ObjBindMethod(implObj, "CreatePartResources"), flags, 2)
        this.vtbl.CreateDocumentSequence := CallbackCreate(ObjBindMethod(implObj, "CreateDocumentSequence"), flags, 3)
        this.vtbl.CreateDocument := CallbackCreate(ObjBindMethod(implObj, "CreateDocument"), flags, 3)
        this.vtbl.CreatePageReference := CallbackCreate(ObjBindMethod(implObj, "CreatePageReference"), flags, 3)
        this.vtbl.CreatePage := CallbackCreate(ObjBindMethod(implObj, "CreatePage"), flags, 5)
        this.vtbl.CreatePageFromStream := CallbackCreate(ObjBindMethod(implObj, "CreatePageFromStream"), flags, 6)
        this.vtbl.CreateCanvas := CallbackCreate(ObjBindMethod(implObj, "CreateCanvas"), flags, 2)
        this.vtbl.CreateGlyphs := CallbackCreate(ObjBindMethod(implObj, "CreateGlyphs"), flags, 3)
        this.vtbl.CreatePath := CallbackCreate(ObjBindMethod(implObj, "CreatePath"), flags, 2)
        this.vtbl.CreateGeometry := CallbackCreate(ObjBindMethod(implObj, "CreateGeometry"), flags, 2)
        this.vtbl.CreateGeometryFigure := CallbackCreate(ObjBindMethod(implObj, "CreateGeometryFigure"), flags, 3)
        this.vtbl.CreateMatrixTransform := CallbackCreate(ObjBindMethod(implObj, "CreateMatrixTransform"), flags, 3)
        this.vtbl.CreateSolidColorBrush := CallbackCreate(ObjBindMethod(implObj, "CreateSolidColorBrush"), flags, 4)
        this.vtbl.CreateColorProfileResource := CallbackCreate(ObjBindMethod(implObj, "CreateColorProfileResource"), flags, 4)
        this.vtbl.CreateImageBrush := CallbackCreate(ObjBindMethod(implObj, "CreateImageBrush"), flags, 5)
        this.vtbl.CreateVisualBrush := CallbackCreate(ObjBindMethod(implObj, "CreateVisualBrush"), flags, 4)
        this.vtbl.CreateImageResource := CallbackCreate(ObjBindMethod(implObj, "CreateImageResource"), flags, 5)
        this.vtbl.CreatePrintTicketResource := CallbackCreate(ObjBindMethod(implObj, "CreatePrintTicketResource"), flags, 4)
        this.vtbl.CreateFontResource := CallbackCreate(ObjBindMethod(implObj, "CreateFontResource"), flags, 6)
        this.vtbl.CreateGradientStop := CallbackCreate(ObjBindMethod(implObj, "CreateGradientStop"), flags, 5)
        this.vtbl.CreateLinearGradientBrush := CallbackCreate(ObjBindMethod(implObj, "CreateLinearGradientBrush"), flags, 6)
        this.vtbl.CreateRadialGradientBrush := CallbackCreate(ObjBindMethod(implObj, "CreateRadialGradientBrush"), flags, 7)
        this.vtbl.CreateCoreProperties := CallbackCreate(ObjBindMethod(implObj, "CreateCoreProperties"), flags, 3)
        this.vtbl.CreateDictionary := CallbackCreate(ObjBindMethod(implObj, "CreateDictionary"), flags, 2)
        this.vtbl.CreatePartUriCollection := CallbackCreate(ObjBindMethod(implObj, "CreatePartUriCollection"), flags, 2)
        this.vtbl.CreatePackageWriterOnFile := CallbackCreate(ObjBindMethod(implObj, "CreatePackageWriterOnFile"), flags, 12)
        this.vtbl.CreatePackageWriterOnStream := CallbackCreate(ObjBindMethod(implObj, "CreatePackageWriterOnStream"), flags, 10)
        this.vtbl.CreatePartUri := CallbackCreate(ObjBindMethod(implObj, "CreatePartUri"), flags, 3)
        this.vtbl.CreateReadOnlyStreamOnFile := CallbackCreate(ObjBindMethod(implObj, "CreateReadOnlyStreamOnFile"), flags, 3)
    }
