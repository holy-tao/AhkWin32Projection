 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomvisualbrush
 * @namespace Windows.Win32.Storage.Xps
 */
export default struct IXpsOMVisualBrush extends IXpsOMTileBrush {
    /**
     ...
     * used for IXpsOMVisualBrush interfaces
    */
    struct Vtbl extends IXpsOMTileBrush.Vtbl {
        GetVisual       : IntPtr
        GetVisualLocal  : IntPtr
        SetVisualLocal  : IntPtr
        GetVisualLookup : IntPtr
        SetVisualLookup : IntPtr
        Clone           : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IXpsOMVisualBrush.Vtbl()
        }
     ...
     */
    GetVisualLookup() {
        result := ComCall(21, this, PWSTR.Ptr, &lookup := 0, "HRESULT")
        return lookup
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetVisual)
        CallbackFree(this.vtbl.GetVisualLocal)
        CallbackFree(this.vtbl.SetVisualLocal)
        CallbackFree(this.vtbl.GetVisualLookup)
        CallbackFree(this.vtbl.SetVisualLookup)
