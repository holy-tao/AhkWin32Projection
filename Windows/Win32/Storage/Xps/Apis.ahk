 ...
 * @since windows5.0
 */
export DeviceCapabilitiesA(pDevice, pPort, fwCapability, pOutput, pDevMode) {
 ...
 * @since windows5.0
 */
export DeviceCapabilitiesW(pDevice, pPort, fwCapability, pOutput, pDevMode) {
    pDevice := pDevice is String ? StrPtr(pDevice) : pDevice
    pPort := pPort is String ? StrPtr(pPort) : pPort
    pOutput := pOutput is String ? StrPtr(pOutput) : pOutput
 ...
 * @since windows5.0
 */
export StartDocA(_hdc, lpdi) {
    result := DllCall("GDI32.dll\StartDocA", HDC, _hdc, DOCINFOA.Ptr, lpdi, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export StartDocW(_hdc, lpdi) {
    result := DllCall("GDI32.dll\StartDocW", HDC, _hdc, DOCINFOW.Ptr, lpdi, Int32)
    return result
}
 ...
 */
export EndDoc(_hdc) {
    result := DllCall("GDI32.dll\EndDoc", HDC, _hdc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export StartPage(_hdc) {
    result := DllCall("GDI32.dll\StartPage", HDC, _hdc, Int32)
    return result
}
 ...
 */
export EndPage(_hdc) {
    result := DllCall("GDI32.dll\EndPage", HDC, _hdc, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export AbortDoc(_hdc) {
    result := DllCall("GDI32.dll\AbortDoc", HDC, _hdc, Int32)
    return result
}
 ...
 */
export PrintWindow(_hwnd, hdcBlt, nFlags) {
    result := DllCall("USER32.dll\PrintWindow", HWND, _hwnd, HDC, hdcBlt, PRINT_WINDOW_FLAGS, nFlags, BOOL)
    return result
}
