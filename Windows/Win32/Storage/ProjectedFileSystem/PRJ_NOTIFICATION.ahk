...
class PRJ_NOTIFICATION extends Win32Enum {
     ...
     * Native name: PRJ_NOTIFICATION_FILE_OPENED
     * @type {Integer (Int32)}
     */
     ...
     * - The provider can specify a new notification mask for this file or folder when responding to the notification.
     * Native name: PRJ_NOTIFICATION_NEW_FILE_CREATED
     * @type {Integer (Int32)}
     */
     ...
     * - The provider can specify a new notification mask for this file or folder when responding to the notification.
     * Native name: PRJ_NOTIFICATION_FILE_OVERWRITTEN
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_PRE_DELETE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_PRE_RENAME
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_PRE_SET_HARDLINK
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_FILE_RENAMED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_HARDLINK_CREATED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_FILE_HANDLE_CLOSED_NO_MODIFICATION
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_FILE_HANDLE_CLOSED_FILE_MODIFIED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_FILE_HANDLE_CLOSED_FILE_DELETED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: PRJ_NOTIFICATION_FILE_PRE_CONVERT_TO_FULL
     * @type {Integer (Int32)}
     */
