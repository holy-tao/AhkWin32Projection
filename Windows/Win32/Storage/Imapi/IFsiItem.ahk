 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ifsiitem
...
class IFsiItem extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_name
     */
    get_Name() {
        pVal := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_fullpath
     */
    get_FullPath() {
        pVal := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_creationtime
     */
    get_CreationTime() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-put_creationtime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_lastaccessedtime
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-put_lastaccessedtime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_lastmodifiedtime
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-put_lastmodifiedtime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-get_ishidden
     */
    get_IsHidden() {
        result := ComCall(15, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-put_ishidden
     */
    put_IsHidden(newVal) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-filesystemname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifsiitem-filesystempath
     */
