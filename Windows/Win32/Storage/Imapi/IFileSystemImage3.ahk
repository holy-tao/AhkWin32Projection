 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ifilesystemimage3
...
class IFileSystemImage3 extends IFileSystemImage2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimage3-get_createredundantudfmetadatafiles
     */
    get_CreateRedundantUdfMetadataFiles() {
        result := ComCall(59, this, "short*", &pVal := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimage3-put_createredundantudfmetadatafiles
     */
    put_CreateRedundantUdfMetadataFiles(newVal) {
        result := ComCall(60, this, "short", newVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimage3-probespecificfilesystem
     */
    ProbeSpecificFileSystem(fileSystemToProbe) {
        result := ComCall(61, this, "int", fileSystemToProbe, "short*", &isAppendable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
