...
export default struct IFileSystemImage extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_SessionStartBlock := CallbackCreate(ObjBindMethod(implObj, "get_SessionStartBlock"), flags, 2)
        this.vtbl.put_SessionStartBlock := CallbackCreate(ObjBindMethod(implObj, "put_SessionStartBlock"), flags, 2)
        this.vtbl.get_FreeMediaBlocks := CallbackCreate(ObjBindMethod(implObj, "get_FreeMediaBlocks"), flags, 2)
        this.vtbl.put_FreeMediaBlocks := CallbackCreate(ObjBindMethod(implObj, "put_FreeMediaBlocks"), flags, 2)
        this.vtbl.SetMaxMediaBlocksFromDevice := CallbackCreate(ObjBindMethod(implObj, "SetMaxMediaBlocksFromDevice"), flags, 2)
        this.vtbl.get_UsedBlocks := CallbackCreate(ObjBindMethod(implObj, "get_UsedBlocks"), flags, 2)
        ...
        this.vtbl.get_ImportedVolumeName := CallbackCreate(ObjBindMethod(implObj, "get_ImportedVolumeName"), flags, 2)
        this.vtbl.get_BootImageOptions := CallbackCreate(ObjBindMethod(implObj, "get_BootImageOptions"), flags, 2)
        this.vtbl.put_BootImageOptions := CallbackCreate(ObjBindMethod(implObj, "put_BootImageOptions"), flags, 2)
        this.vtbl.get_FileCount := CallbackCreate(ObjBindMethod(implObj, "get_FileCount"), flags, 2)
        this.vtbl.get_DirectoryCount := CallbackCreate(ObjBindMethod(implObj, "get_DirectoryCount"), flags, 2)
        ...
        this.vtbl.get_ChangePoint := CallbackCreate(ObjBindMethod(implObj, "get_ChangePoint"), flags, 2)
        this.vtbl.get_StrictFileSystemCompliance := CallbackCreate(ObjBindMethod(implObj, "get_StrictFileSystemCompliance"), flags, 2)
        this.vtbl.put_StrictFileSystemCompliance := CallbackCreate(ObjBindMethod(implObj, "put_StrictFileSystemCompliance"), flags, 2)
        this.vtbl.get_UseRestrictedCharacterSet := CallbackCreate(ObjBindMethod(implObj, "get_UseRestrictedCharacterSet"), flags, 2)
        this.vtbl.put_UseRestrictedCharacterSet := CallbackCreate(ObjBindMethod(implObj, "put_UseRestrictedCharacterSet"), flags, 2)
        this.vtbl.get_FileSystemsToCreate := CallbackCreate(ObjBindMethod(implObj, "get_FileSystemsToCreate"), flags, 2)
        this.vtbl.put_FileSystemsToCreate := CallbackCreate(ObjBindMethod(implObj, "put_FileSystemsToCreate"), flags, 2)
        this.vtbl.get_FileSystemsSupported := CallbackCreate(ObjBindMethod(implObj, "get_FileSystemsSupported"), flags, 2)
        this.vtbl.put_UDFRevision := CallbackCreate(ObjBindMethod(implObj, "put_UDFRevision"), flags, 2)
        this.vtbl.get_UDFRevision := CallbackCreate(ObjBindMethod(implObj, "get_UDFRevision"), flags, 2)
        this.vtbl.get_UDFRevisionsSupported := CallbackCreate(ObjBindMethod(implObj, "get_UDFRevisionsSupported"), flags, 2)
        this.vtbl.ChooseImageDefaults := CallbackCreate(ObjBindMethod(implObj, "ChooseImageDefaults"), flags, 2)
        this.vtbl.ChooseImageDefaultsForMediaType := CallbackCreate(ObjBindMethod(implObj, "ChooseImageDefaultsForMediaType"), flags, 2)
        this.vtbl.put_ISO9660InterchangeLevel := CallbackCreate(ObjBindMethod(implObj, "put_ISO9660InterchangeLevel"), flags, 2)
        this.vtbl.get_ISO9660InterchangeLevel := CallbackCreate(ObjBindMethod(implObj, "get_ISO9660InterchangeLevel"), flags, 2)
        this.vtbl.get_ISO9660InterchangeLevelsSupported := CallbackCreate(ObjBindMethod(implObj, "get_ISO9660InterchangeLevelsSupported"), flags, 2)
        this.vtbl.CreateResultImage := CallbackCreate(ObjBindMethod(implObj, "CreateResultImage"), flags, 2)
        this.vtbl.Exists := CallbackCreate(ObjBindMethod(implObj, "Exists"), flags, 3)
        this.vtbl.CalculateDiscIdentifier := CallbackCreate(ObjBindMethod(implObj, "CalculateDiscIdentifier"), flags, 2)
        this.vtbl.IdentifyFileSystemsOnDisc := CallbackCreate(ObjBindMethod(implObj, "IdentifyFileSystemsOnDisc"), flags, 3)
        this.vtbl.GetDefaultFileSystemForImport := CallbackCreate(ObjBindMethod(implObj, "GetDefaultFileSystemForImport"), flags, 3)
        this.vtbl.ImportFileSystem := CallbackCreate(ObjBindMethod(implObj, "ImportFileSystem"), flags, 2)
        this.vtbl.ImportSpecificFileSystem := CallbackCreate(ObjBindMethod(implObj, "ImportSpecificFileSystem"), flags, 2)
        this.vtbl.RollbackToChangePoint := CallbackCreate(ObjBindMethod(implObj, "RollbackToChangePoint"), flags, 2)
        this.vtbl.LockInChangePoint := CallbackCreate(ObjBindMethod(implObj, "LockInChangePoint"), flags, 1)
        this.vtbl.CreateDirectoryItem := CallbackCreate(ObjBindMethod(implObj, "CreateDirectoryItem"), flags, 3)
        this.vtbl.CreateFileItem := CallbackCreate(ObjBindMethod(implObj, "CreateFileItem"), flags, 3)
        this.vtbl.get_VolumeNameUDF := CallbackCreate(ObjBindMethod(implObj, "get_VolumeNameUDF"), flags, 2)
        this.vtbl.get_VolumeNameJoliet := CallbackCreate(ObjBindMethod(implObj, "get_VolumeNameJoliet"), flags, 2)
        this.vtbl.get_VolumeNameISO9660 := CallbackCreate(ObjBindMethod(implObj, "get_VolumeNameISO9660"), flags, 2)
        this.vtbl.get_StageFiles := CallbackCreate(ObjBindMethod(implObj, "get_StageFiles"), flags, 2)
        this.vtbl.put_StageFiles := CallbackCreate(ObjBindMethod(implObj, "put_StageFiles"), flags, 2)
        this.vtbl.get_MultisessionInterfaces := CallbackCreate(ObjBindMethod(implObj, "get_MultisessionInterfaces"), flags, 2)
        this.vtbl.put_MultisessionInterfaces := CallbackCreate(ObjBindMethod(implObj, "put_MultisessionInterfaces"), flags, 2)
    }
