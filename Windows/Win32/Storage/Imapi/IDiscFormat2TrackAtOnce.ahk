...
export default struct IDiscFormat2TrackAtOnce extends IDiscFormat2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.PrepareMedia := CallbackCreate(ObjBindMethod(implObj, "PrepareMedia"), flags, 1)
        this.vtbl.AddAudioTrack := CallbackCreate(ObjBindMethod(implObj, "AddAudioTrack"), flags, 2)
        this.vtbl.CancelAddTrack := CallbackCreate(ObjBindMethod(implObj, "CancelAddTrack"), flags, 1)
        this.vtbl.ReleaseMedia := CallbackCreate(ObjBindMethod(implObj, "ReleaseMedia"), flags, 1)
        ...
        this.vtbl.get_UsedSectorsOnMedia := CallbackCreate(ObjBindMethod(implObj, "get_UsedSectorsOnMedia"), flags, 2)
        this.vtbl.put_DoNotFinalizeMedia := CallbackCreate(ObjBindMethod(implObj, "put_DoNotFinalizeMedia"), flags, 2)
        this.vtbl.get_DoNotFinalizeMedia := CallbackCreate(ObjBindMethod(implObj, "get_DoNotFinalizeMedia"), flags, 2)
