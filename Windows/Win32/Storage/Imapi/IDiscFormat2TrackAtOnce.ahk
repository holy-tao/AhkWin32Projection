 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-idiscformat2trackatonce
...
class IDiscFormat2TrackAtOnce extends IDiscFormat2{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-preparemedia
     */
    PrepareMedia() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-addaudiotrack
     */
    AddAudioTrack(data) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-canceladdtrack
     */
    CancelAddTrack() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-releasemedia
     */
    ReleaseMedia() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-setwritespeed
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-put_recorder
     */
    put_Recorder(value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_recorder
     */
    get_Recorder() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-put_bufferunderrunfreedisabled
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_bufferunderrunfreedisabled
     */
    get_BufferUnderrunFreeDisabled() {
        result := ComCall(20, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_numberofexistingtracks
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_totalsectorsonmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_freesectorsonmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_usedsectorsonmedia
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-put_donotfinalizemedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_donotfinalizemedia
     */
    get_DoNotFinalizeMedia() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_expectedtableofcontents
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_currentphysicalmediatype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-put_clientname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_clientname
     */
    get_ClientName() {
        value := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_requestedwritespeed
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_requestedrotationtypeispurecav
     */
    get_RequestedRotationTypeIsPureCAV() {
        result := ComCall(32, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_currentwritespeed
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_currentrotationtypeispurecav
     */
    get_CurrentRotationTypeIsPureCAV() {
        result := ComCall(34, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_supportedwritespeeds
     */
    get_SupportedWriteSpeeds() {
        result := ComCall(35, this, "ptr*", &supportedSpeeds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonce-get_supportedwritespeeddescriptors
     */
    get_SupportedWriteSpeedDescriptors() {
        result := ComCall(36, this, "ptr*", &supportedSpeedDescriptors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
