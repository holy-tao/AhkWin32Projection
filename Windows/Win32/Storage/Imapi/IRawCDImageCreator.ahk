...
export default struct IRawCDImageCreator extends IDispatch {
    ...
    */
     ...
     * 
     * This method is supported in Windows Server 2003 with Service Pack 1 (SP1), Windows XP with Service Pack 2 (SP2),  and Windows Vista  via the Windows Feature Pack for Storage. All  features provided by this  update package are supported natively in Windows 7 and Windows Server 2008 R2.
     * @param {IMAPI_CD_SECTOR_TYPE} dataType A  value, defined by  <a href="https://docs.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_cd_sector_type">IMAPI_CD_SECTOR_TYPE</a>, that indicates the type of data. <b>IMAPI_CD_SECTOR_AUDIO</b> is the only value  supported by the <b>IRawCDImageCreator::AddTrack</b>  method.
     ...
     * 
     * This method is supported in Windows Server 2003 with Service Pack 1 (SP1), Windows XP with Service Pack 2 (SP2),  and Windows Vista  via the Windows Feature Pack for Storage. All  features provided by this  update package are supported natively in Windows 7 and Windows Server 2008 R2.
     * @param {IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE} value An <a href="https://docs.microsoft.com/windows/win32/api/imapi2/ne-imapi2-imapi_format2_raw_cd_data_sector_type">IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE</a> enumeration that defines the type of image file.
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation.
     ...
     * @remarks
     * This method is supported in Windows Server 2003 with Service Pack 1 (SP1), Windows XP with Service Pack 2 (SP2),  and Windows Vista  via the Windows Feature Pack for Storage. All  features provided by this  update package are supported natively in Windows 7 and Windows Server 2008 R2.
     * @returns {IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE} Pointer to an <a href="https://docs.microsoft.com/windows/win32/api/imapi2/ne-imapi2-imapi_format2_raw_cd_data_sector_type">IMAPI_FORMAT2_RAW_CD_DATA_SECTOR_TYPE</a> enumeration that defines the current type set for the  image file.
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.AddTrack := CallbackCreate(ObjBindMethod(implObj, "AddTrack"), flags, 4)
        this.vtbl.AddSpecialPregap := CallbackCreate(ObjBindMethod(implObj, "AddSpecialPregap"), flags, 2)
        this.vtbl.AddSubcodeRWGenerator := CallbackCreate(ObjBindMethod(implObj, "AddSubcodeRWGenerator"), flags, 2)
        this.vtbl.put_ResultingImageType := CallbackCreate(ObjBindMethod(implObj, "put_ResultingImageType"), flags, 2)
        this.vtbl.get_ResultingImageType := CallbackCreate(ObjBindMethod(implObj, "get_ResultingImageType"), flags, 2)
        this.vtbl.get_StartOfLeadout := CallbackCreate(ObjBindMethod(implObj, "get_StartOfLeadout"), flags, 2)
        this.vtbl.put_StartOfLeadoutLimit := CallbackCreate(ObjBindMethod(implObj, "put_StartOfLeadoutLimit"), flags, 2)
        this.vtbl.get_StartOfLeadoutLimit := CallbackCreate(ObjBindMethod(implObj, "get_StartOfLeadoutLimit"), flags, 2)
        this.vtbl.put_DisableGaplessAudio := CallbackCreate(ObjBindMethod(implObj, "put_DisableGaplessAudio"), flags, 2)
        this.vtbl.get_DisableGaplessAudio := CallbackCreate(ObjBindMethod(implObj, "get_DisableGaplessAudio"), flags, 2)
        this.vtbl.put_MediaCatalogNumber := CallbackCreate(ObjBindMethod(implObj, "put_MediaCatalogNumber"), flags, 2)
        this.vtbl.get_MediaCatalogNumber := CallbackCreate(ObjBindMethod(implObj, "get_MediaCatalogNumber"), flags, 2)
        this.vtbl.put_StartingTrackNumber := CallbackCreate(ObjBindMethod(implObj, "put_StartingTrackNumber"), flags, 2)
        this.vtbl.get_StartingTrackNumber := CallbackCreate(ObjBindMethod(implObj, "get_StartingTrackNumber"), flags, 2)
        this.vtbl.get_TrackInfo := CallbackCreate(ObjBindMethod(implObj, "get_TrackInfo"), flags, 3)
        this.vtbl.get_NumberOfExistingTracks := CallbackCreate(ObjBindMethod(implObj, "get_NumberOfExistingTracks"), flags, 2)
        this.vtbl.get_LastUsedUserSectorInImage := CallbackCreate(ObjBindMethod(implObj, "get_LastUsedUserSectorInImage"), flags, 2)
        this.vtbl.get_ExpectedTableOfContents := CallbackCreate(ObjBindMethod(implObj, "get_ExpectedTableOfContents"), flags, 2)
    }
