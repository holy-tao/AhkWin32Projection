 ...
 */
export default struct IEnumDiscMasterFormats extends IUnknown {
    /**
     ...
     * used for IEnumDiscMasterFormats interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumDiscMasterFormats.Vtbl()
        }
    ...
    Query(iid) {
        if (IEnumDiscMasterFormats.IID.Equals(iid)) {
            return true
        }
