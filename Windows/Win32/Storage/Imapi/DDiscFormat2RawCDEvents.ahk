 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-ddiscformat2rawcdevents
...
class DDiscFormat2RawCDEvents extends IDispatch{
     ...
     * @param {IDispatch} object_ The <a href="https://docs.microsoft.com/windows/desktop/api/imapi2/nn-imapi2-idiscformat2rawcd">IDiscFormat2RawCD</a> interface that initiated the write operation. 
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-ddiscformat2rawcdevents-update
     */
