...
export default struct IDiscRecorder2 extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.EjectMedia := CallbackCreate(ObjBindMethod(implObj, "EjectMedia"), flags, 1)
        this.vtbl.CloseTray := CallbackCreate(ObjBindMethod(implObj, "CloseTray"), flags, 1)
        this.vtbl.AcquireExclusiveAccess := CallbackCreate(ObjBindMethod(implObj, "AcquireExclusiveAccess"), flags, 3)
        this.vtbl.ReleaseExclusiveAccess := CallbackCreate(ObjBindMethod(implObj, "ReleaseExclusiveAccess"), flags, 1)
        this.vtbl.DisableMcn := CallbackCreate(ObjBindMethod(implObj, "DisableMcn"), flags, 1)
        this.vtbl.EnableMcn := CallbackCreate(ObjBindMethod(implObj, "EnableMcn"), flags, 1)
        this.vtbl.InitializeDiscRecorder := CallbackCreate(ObjBindMethod(implObj, "InitializeDiscRecorder"), flags, 2)
        this.vtbl.get_ActiveDiscRecorder := CallbackCreate(ObjBindMethod(implObj, "get_ActiveDiscRecorder"), flags, 2)
        ...
        this.vtbl.get_ProductRevision := CallbackCreate(ObjBindMethod(implObj, "get_ProductRevision"), flags, 2)
        this.vtbl.get_VolumeName := CallbackCreate(ObjBindMethod(implObj, "get_VolumeName"), flags, 2)
        this.vtbl.get_VolumePathNames := CallbackCreate(ObjBindMethod(implObj, "get_VolumePathNames"), flags, 2)
        this.vtbl.get_DeviceCanLoadMedia := CallbackCreate(ObjBindMethod(implObj, "get_DeviceCanLoadMedia"), flags, 2)
        this.vtbl.get_LegacyDeviceNumber := CallbackCreate(ObjBindMethod(implObj, "get_LegacyDeviceNumber"), flags, 2)
        this.vtbl.get_SupportedFeaturePages := CallbackCreate(ObjBindMethod(implObj, "get_SupportedFeaturePages"), flags, 2)
        this.vtbl.get_CurrentFeaturePages := CallbackCreate(ObjBindMethod(implObj, "get_CurrentFeaturePages"), flags, 2)
        this.vtbl.get_SupportedProfiles := CallbackCreate(ObjBindMethod(implObj, "get_SupportedProfiles"), flags, 2)
        this.vtbl.get_CurrentProfiles := CallbackCreate(ObjBindMethod(implObj, "get_CurrentProfiles"), flags, 2)
        this.vtbl.get_SupportedModePages := CallbackCreate(ObjBindMethod(implObj, "get_SupportedModePages"), flags, 2)
        this.vtbl.get_ExclusiveAccessOwner := CallbackCreate(ObjBindMethod(implObj, "get_ExclusiveAccessOwner"), flags, 2)
    }
