 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-iwritespeeddescriptor
...
class IWriteSpeedDescriptor extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-iwritespeeddescriptor-get_mediatype
     */
    get_MediaType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-iwritespeeddescriptor-get_rotationtypeispurecav
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-iwritespeeddescriptor-get_writespeed
     */
    get_WriteSpeed() {
