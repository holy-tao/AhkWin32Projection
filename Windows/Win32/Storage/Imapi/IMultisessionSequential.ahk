 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-imultisessionsequential
...
class IMultisessionSequential extends IMultisession{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisessionsequential-get_isfirstdatasession
     */
    get_IsFirstDataSession() {
        result := ComCall(11, this, "short*", &value := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisessionsequential-get_startaddressofprevioussession
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisessionsequential-get_lastwrittenaddressofprevioussession
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisessionsequential-get_nextwritableaddress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisessionsequential-get_freesectorsonmedia
     */
