 ...
 */
export default struct IFsiDirectoryItem2 extends IFsiDirectoryItem {
    /**
     ...
     * used for IFsiDirectoryItem2 interfaces
    */
    struct Vtbl extends IFsiDirectoryItem.Vtbl {
        AddTreeWithNamedStreams : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IFsiDirectoryItem2.Vtbl()
        }
    ...
    AddTreeWithNamedStreams(sourceDirectory, includeBaseDirectory) {
        ...
        result := ComCall(29, this, BSTR, sourceDirectory, VARIANT_BOOL, includeBaseDirectory, "HRESULT")
        return result
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.AddTreeWithNamedStreams)
    }
}
