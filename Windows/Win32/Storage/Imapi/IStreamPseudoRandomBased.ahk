 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-istreampseudorandombased
...
class IStreamPseudoRandomBased extends IStream{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-istreampseudorandombased-put_seed
     */
    put_Seed(value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-istreampseudorandombased-get_seed
     */
    get_Seed() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-istreampseudorandombased-put_extendedseed
     */
    put_ExtendedSeed(values, eCount) {
        valuesMarshal := values is VarRef ? "uint*" : "ptr"

        result := ComCall(16, this, valuesMarshal, values, "uint", eCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-istreampseudorandombased-get_extendedseed
     */
    get_ExtendedSeed(values, eCount) {
        valuesMarshal := values is VarRef ? "ptr*" : "ptr"
        eCountMarshal := eCount is VarRef ? "uint*" : "ptr"

        result := ComCall(17, this, valuesMarshal, values, eCountMarshal, eCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
