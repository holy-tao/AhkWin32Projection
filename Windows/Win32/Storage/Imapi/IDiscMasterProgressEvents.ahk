 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nn-imapi-idiscmasterprogressevents
...
class IDiscMasterProgressEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-querycancel
     */
    QueryCancel() {
        result := ComCall(3, this, "char*", &pbCancel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifypnpactivity
     */
    NotifyPnPActivity() {
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifyaddprogress
     */
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifyblockprogress
     */
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifytrackprogress
     */
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifypreparingburn
     */
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifyclosingdisc
     */
     ...
     * @param {HRESULT} status_ Status code to be returned from 
     * <a href="https://docs.microsoft.com/windows/desktop/api/imapi/nf-imapi-idiscmaster-recorddisc">IDiscMaster::RecordDisc</a>.
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifyburncomplete
     */
    NotifyBurnComplete(status_) {
        result := ComCall(10, this, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-idiscmasterprogressevents-notifyerasecomplete
     */
    NotifyEraseComplete(status_) {
        result := ComCall(11, this, "int", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
