 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-dwriteengine2events
...
class DWriteEngine2Events extends IDispatch{
     ...
     * @param {IDispatch} object_ The <a href="https://docs.microsoft.com/windows/desktop/api/imapi2/nn-imapi2-iwriteengine2">IWriteEngine2</a> interface that initiated the write operation. 
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-dwriteengine2events-update
     */
