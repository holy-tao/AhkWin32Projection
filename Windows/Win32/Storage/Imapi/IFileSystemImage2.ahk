 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ifilesystemimage2
...
class IFileSystemImage2 extends IFileSystemImage{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimage2-get_bootimageoptionsarray
     */
    get_BootImageOptionsArray() {
        result := ComCall(57, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimage2-put_bootimageoptionsarray
     */
    put_BootImageOptionsArray(newVal) {
        result := ComCall(58, this, "ptr", newVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
