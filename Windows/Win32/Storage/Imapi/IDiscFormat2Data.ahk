 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-idiscformat2data
...
class IDiscFormat2Data extends IDiscFormat2{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_recorder
     */
    put_Recorder(value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_recorder
     */
    get_Recorder() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_bufferunderrunfreedisabled
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_bufferunderrunfreedisabled
     */
    get_BufferUnderrunFreeDisabled() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_postgapalreadyinimage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_postgapalreadyinimage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_currentmediastatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_writeprotectstatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_totalsectorsonmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_freesectorsonmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_nextwritableaddress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_startaddressofprevioussession
     */
     ...
     * 
     * The value is -1 if the media is blank or does not support multi-session writing (indicates that no previous session could be detected).
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_lastwrittenaddressofprevioussession
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_forcemediatobeclosed
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_forcemediatobeclosed
     */
    get_ForceMediaToBeClosed() {
        result := ComCall(26, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_disableconsumerdvdcompatibilitymode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_disableconsumerdvdcompatibilitymode
     */
    get_DisableConsumerDvdCompatibilityMode() {
        result := ComCall(28, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_currentphysicalmediatype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_clientname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_clientname
     */
    get_ClientName() {
        value := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_requestedwritespeed
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_requestedrotationtypeispurecav
     */
    get_RequestedRotationTypeIsPureCAV() {
        result := ComCall(33, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_currentwritespeed
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_currentrotationtypeispurecav
     */
    get_CurrentRotationTypeIsPureCAV() {
        result := ComCall(35, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_supportedwritespeeds
     */
    get_SupportedWriteSpeeds() {
        result := ComCall(36, this, "ptr*", &supportedSpeeds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_supportedwritespeeddescriptors
     */
    get_SupportedWriteSpeedDescriptors() {
        result := ComCall(37, this, "ptr*", &supportedSpeedDescriptors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-put_forceoverwrite
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_forceoverwrite
     */
    get_ForceOverwrite() {
        result := ComCall(39, this, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-get_multisessioninterfaces
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-write
     */
    Write(data) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-cancelwrite
     */
    CancelWrite() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2data-setwritespeed
     */
