...
export default struct IDiscFormat2Data extends IDiscFormat2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_BufferUnderrunFreeDisabled := CallbackCreate(ObjBindMethod(implObj, "put_BufferUnderrunFreeDisabled"), flags, 2)
        this.vtbl.get_BufferUnderrunFreeDisabled := CallbackCreate(ObjBindMethod(implObj, "get_BufferUnderrunFreeDisabled"), flags, 2)
        this.vtbl.put_PostgapAlreadyInImage := CallbackCreate(ObjBindMethod(implObj, "put_PostgapAlreadyInImage"), flags, 2)
        this.vtbl.get_PostgapAlreadyInImage := CallbackCreate(ObjBindMethod(implObj, "get_PostgapAlreadyInImage"), flags, 2)
        this.vtbl.get_CurrentMediaStatus := CallbackCreate(ObjBindMethod(implObj, "get_CurrentMediaStatus"), flags, 2)
        this.vtbl.get_WriteProtectStatus := CallbackCreate(ObjBindMethod(implObj, "get_WriteProtectStatus"), flags, 2)
        ...
        this.vtbl.put_ForceMediaToBeClosed := CallbackCreate(ObjBindMethod(implObj, "put_ForceMediaToBeClosed"), flags, 2)
        this.vtbl.get_ForceMediaToBeClosed := CallbackCreate(ObjBindMethod(implObj, "get_ForceMediaToBeClosed"), flags, 2)
        this.vtbl.put_DisableConsumerDvdCompatibilityMode := CallbackCreate(ObjBindMethod(implObj, "put_DisableConsumerDvdCompatibilityMode"), flags, 2)
        this.vtbl.get_DisableConsumerDvdCompatibilityMode := CallbackCreate(ObjBindMethod(implObj, "get_DisableConsumerDvdCompatibilityMode"), flags, 2)
        ...
        this.vtbl.get_RequestedWriteSpeed := CallbackCreate(ObjBindMethod(implObj, "get_RequestedWriteSpeed"), flags, 2)
        this.vtbl.get_RequestedRotationTypeIsPureCAV := CallbackCreate(ObjBindMethod(implObj, "get_RequestedRotationTypeIsPureCAV"), flags, 2)
        this.vtbl.get_CurrentWriteSpeed := CallbackCreate(ObjBindMethod(implObj, "get_CurrentWriteSpeed"), flags, 2)
        this.vtbl.get_CurrentRotationTypeIsPureCAV := CallbackCreate(ObjBindMethod(implObj, "get_CurrentRotationTypeIsPureCAV"), flags, 2)
        this.vtbl.get_SupportedWriteSpeeds := CallbackCreate(ObjBindMethod(implObj, "get_SupportedWriteSpeeds"), flags, 2)
        this.vtbl.get_SupportedWriteSpeedDescriptors := CallbackCreate(ObjBindMethod(implObj, "get_SupportedWriteSpeedDescriptors"), flags, 2)
        this.vtbl.put_ForceOverwrite := CallbackCreate(ObjBindMethod(implObj, "put_ForceOverwrite"), flags, 2)
        this.vtbl.get_ForceOverwrite := CallbackCreate(ObjBindMethod(implObj, "get_ForceOverwrite"), flags, 2)
        ...
        this.vtbl.SetWriteSpeed := CallbackCreate(ObjBindMethod(implObj, "SetWriteSpeed"), flags, 3)
    }
