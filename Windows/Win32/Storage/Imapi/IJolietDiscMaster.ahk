 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nn-imapi-ijolietdiscmaster
...
class IJolietDiscMaster extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-gettotaldatablocks
     */
    GetTotalDataBlocks() {
        result := ComCall(3, this, "int*", &pnBlocks := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-getuseddatablocks
     */
    GetUsedDataBlocks() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-getdatablocksize
     */
    GetDataBlockSize() {
        result := ComCall(5, this, "int*", &pnBlockBytes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-adddata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-getjolietproperties
     */
    GetJolietProperties() {
        result := ComCall(7, this, "ptr*", &ppPropStg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-ijolietdiscmaster-setjolietproperties
     */
