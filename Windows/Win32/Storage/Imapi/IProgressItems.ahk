...
export default struct IProgressItems extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.ProgressItemFromBlock := CallbackCreate(ObjBindMethod(implObj, "ProgressItemFromBlock"), flags, 3)
        this.vtbl.ProgressItemFromDescription := CallbackCreate(ObjBindMethod(implObj, "ProgressItemFromDescription"), flags, 3)
        this.vtbl.get_EnumProgressItems := CallbackCreate(ObjBindMethod(implObj, "get_EnumProgressItems"), flags, 2)
    }
