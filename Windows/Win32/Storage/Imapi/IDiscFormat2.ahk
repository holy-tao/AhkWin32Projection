 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-idiscformat2
...
class IDiscFormat2 extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2-isrecordersupported
     */
    IsRecorderSupported(recorder) {
        result := ComCall(7, this, "ptr", recorder, "short*", &value := 0, "int")
        if(result != 0) {
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2-iscurrentmediasupported
     */
    IsCurrentMediaSupported(recorder) {
        result := ComCall(8, this, "ptr", recorder, "short*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2-get_mediaphysicallyblank
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2-get_mediaheuristicallyblank
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2-get_supportedmediatypes
     */
