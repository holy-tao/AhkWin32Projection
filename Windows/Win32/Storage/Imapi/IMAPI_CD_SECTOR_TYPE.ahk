...
class IMAPI_CD_SECTOR_TYPE extends Win32Enum {
     ...
     * Native name: IMAPI_CD_SECTOR_AUDIO
     * @type {Integer (Int32)}
     */
    static AUDIO => 0
     ...
     * Native name: IMAPI_CD_SECTOR_MODE_ZERO
     * @type {Integer (Int32)}
     */
    static MODE_ZERO => 1
     ...
     * Native name: IMAPI_CD_SECTOR_MODE1
     * @type {Integer (Int32)}
     */
    static MODE1 => 2
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM0
     * @type {Integer (Int32)}
     */
    static MODE2FORM0 => 3
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM1
     * @type {Integer (Int32)}
     */
    static MODE2FORM1 => 4
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM2
     * @type {Integer (Int32)}
     */
    static MODE2FORM2 => 5
     ...
     * Native name: IMAPI_CD_SECTOR_MODE1RAW
     * @type {Integer (Int32)}
     */
    static MODE1RAW => 6
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM0RAW
     * @type {Integer (Int32)}
     */
    static MODE2FORM0RAW => 7
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM1RAW
     * @type {Integer (Int32)}
     */
    static MODE2FORM1RAW => 8
     ...
     * Native name: IMAPI_CD_SECTOR_MODE2FORM2RAW
     * @type {Integer (Int32)}
     */
    static MODE2FORM2RAW => 9
}
