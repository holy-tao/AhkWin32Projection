 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-imultisession
...
class IMultisession extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisession-get_issupportedoncurrentmediastate
     */
    get_IsSupportedOnCurrentMediaState() {
        result := ComCall(7, this, "short*", &value := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisession-put_inuse
     */
    put_InUse(value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisession-get_inuse
     */
    get_InUse() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-imultisession-get_importrecorder
     */
    get_ImportRecorder() {
