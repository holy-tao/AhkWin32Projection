 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ienumprogressitems
...
class IEnumProgressItems extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ienumprogressitems-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ienumprogressitems-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ienumprogressitems-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ienumprogressitems-clone
     */
    Clone() {
