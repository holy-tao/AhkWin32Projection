 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nn-imapi2-idiscformat2trackatonceeventargs
...
class IDiscFormat2TrackAtOnceEventArgs extends IWriteEngine2EventArgs{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonceeventargs-get_currenttracknumber
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonceeventargs-get_currentaction
     */
    get_CurrentAction() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonceeventargs-get_elapsedtime
     */
    get_ElapsedTime() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2/nf-imapi2-idiscformat2trackatonceeventargs-get_remainingtime
     */
    get_RemainingTime() {
