...
export default struct IDiscFormat2RawCD extends IDiscFormat2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.WriteMedia := CallbackCreate(ObjBindMethod(implObj, "WriteMedia"), flags, 2)
        this.vtbl.WriteMedia2 := CallbackCreate(ObjBindMethod(implObj, "WriteMedia2"), flags, 3)
        ...
        this.vtbl.get_StartOfNextSession := CallbackCreate(ObjBindMethod(implObj, "get_StartOfNextSession"), flags, 2)
        this.vtbl.get_LastPossibleStartOfLeadout := CallbackCreate(ObjBindMethod(implObj, "get_LastPossibleStartOfLeadout"), flags, 2)
        this.vtbl.get_CurrentPhysicalMediaType := CallbackCreate(ObjBindMethod(implObj, "get_CurrentPhysicalMediaType"), flags, 2)
        this.vtbl.get_SupportedSectorTypes := CallbackCreate(ObjBindMethod(implObj, "get_SupportedSectorTypes"), flags, 2)
        this.vtbl.put_RequestedSectorType := CallbackCreate(ObjBindMethod(implObj, "put_RequestedSectorType"), flags, 2)
        this.vtbl.get_RequestedSectorType := CallbackCreate(ObjBindMethod(implObj, "get_RequestedSectorType"), flags, 2)
