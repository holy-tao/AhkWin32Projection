 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nn-imapi-iredbookdiscmaster
...
class IRedbookDiscMaster extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-gettotalaudiotracks
     */
    GetTotalAudioTracks() {
        result := ComCall(3, this, "int*", &pnTracks := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-gettotalaudioblocks
     */
    GetTotalAudioBlocks() {
        result := ComCall(4, this, "int*", &pnBlocks := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-getusedaudioblocks
     */
    GetUsedAudioBlocks() {
        result := ComCall(5, this, "int*", &pnBlocks := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-getavailableaudiotrackblocks
     */
    GetAvailableAudioTrackBlocks() {
        result := ComCall(6, this, "int*", &pnBlocks := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-getaudioblocksize
     */
    GetAudioBlockSize() {
        result := ComCall(7, this, "int*", &pnBlockBytes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-createaudiotrack
     */
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-addaudiotrackblocks
     */
    AddAudioTrackBlocks(pby, cb) {
        pbyMarshal := pby is VarRef ? "char*" : "ptr"

        result := ComCall(9, this, pbyMarshal, pby, "int", cb, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation. The following error codes are commonly returned on operation failure, but do not represent the only possible error values:
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi/nf-imapi-iredbookdiscmaster-closeaudiotrack
     */
    CloseAudioTrack() {
