 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-iisoimagemanager
...
class IIsoImageManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-iisoimagemanager-get_path
     */
    get_Path() {
        pVal := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-iisoimagemanager-get_stream
     */
    get_Stream() {
        result := ComCall(8, this, "ptr*", &data := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @remarks
     * This method is supported in Windows Server 2003 with Service Pack 1 (SP1), Windows XP with Service Pack 2 (SP2),  and Windows Vista  via the Windows Feature Pack for Storage. All  features provided by this  update package are supported natively in Windows 7 and Windows Server 2008 R2.
     * @param {BSTR} Val_ The logical path to the .iso image. For example, "c:\\path\\file.iso".
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-iisoimagemanager-setpath
     */
    SetPath(Val_) {
        if(Val_ is String) {
            pin := BSTR.Alloc(Val_)
        ...
        result := ComCall(9, this, "ptr", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} S_OK is returned on success, but other success codes may be returned as a result of implementation.
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-iisoimagemanager-setstream
     */
    SetStream(data) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-iisoimagemanager-validate
     */
    Validate() {
