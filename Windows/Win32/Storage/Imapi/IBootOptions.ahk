 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ibootoptions
...
class IBootOptions extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-get_bootimage
     */
    get_BootImage() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-get_manufacturer
     */
    get_Manufacturer() {
        pVal := BSTR()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-put_manufacturer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-get_platformid
     */
    get_PlatformId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-put_platformid
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-get_emulation
     */
    get_Emulation() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-put_emulation
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-get_imagesize
     */
    get_ImageSize() {
        result := ComCall(14, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ibootoptions-assignbootimage
     */
