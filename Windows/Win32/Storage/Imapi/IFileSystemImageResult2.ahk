 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nn-imapi2fs-ifilesystemimageresult2
...
class IFileSystemImageResult2 extends IFileSystemImageResult{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/imapi2fs/nf-imapi2fs-ifilesystemimageresult2-get_modifiedblocks
     */
    get_ModifiedBlocks() {
        result := ComCall(12, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
