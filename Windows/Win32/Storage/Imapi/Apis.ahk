...
;@region Methods
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/openimsgsession
     */
     ...
     * @param {LPMSGSESS} lpMsgSess_ > [in] Pointer to the message session object obtained using the [OpenIMsgSession](openimsgsession.md) function at the start of the message session.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/closeimsgsession
     */
    static CloseIMsgSession(lpMsgSess_) {
        lpMsgSess_ := lpMsgSess_ is Win32Handle ? NumGet(lpMsgSess_, "ptr") : lpMsgSess_

        DllCall("MAPI32.dll\CloseIMsgSession", "ptr", lpMsgSess_)
    }
     ...
     * @param {LPMSGSESS} lpMsgSess_ > [in] Pointer to a message session object within which the new **IMessage**-on- **IStorage** object is to be created.
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/openimsgonistg
     */
    static OpenIMsgOnIStg(lpMsgSess_, lpAllocateBuffer_, lpAllocateMore_, lpFreeBuffer_, lpMalloc, lpMapiSup, lpStg, lpfMsgCallRelease, ulCallerData, ulFlags, lppMsg) {
        lpMsgSess_ := lpMsgSess_ is Win32Handle ? NumGet(lpMsgSess_, "ptr") : lpMsgSess_

        lpMapiSupMarshal := lpMapiSup is VarRef ? "ptr" : "ptr"
        lpfMsgCallReleaseMarshal := lpfMsgCallRelease is VarRef ? "ptr*" : "ptr"

        result := DllCall("MAPI32.dll\OpenIMsgOnIStg", "ptr", lpMsgSess_, "ptr", lpAllocateBuffer_, "ptr", lpAllocateMore_, "ptr", lpFreeBuffer_, "ptr", lpMalloc, lpMapiSupMarshal, lpMapiSup, "ptr", lpStg, lpfMsgCallReleaseMarshal, lpfMsgCallRelease, "uint", ulCallerData, "uint", ulFlags, "ptr*", lppMsg, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/getattribimsgonistg
     */
     ...
     *   
     * > The call succeeded overall, but one or more properties could not be accessed and were returned with a property type of PT_ERROR.
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/setattribimsgonistg
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/mapstoragescode
     */
