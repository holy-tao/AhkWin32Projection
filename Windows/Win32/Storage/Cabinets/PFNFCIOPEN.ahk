 ...
 * @version v4.0.30319
 */
class PFNFCIOPEN extends IUnknown {
     ...
     */
    Invoke(pszFile, oflag, pmode, err, pv) {
        pszFile := pszFile is String ? StrPtr(pszFile) : pszFile

        errMarshal := err is VarRef ? "int*" : "ptr"
        pvMarshal := pv is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", pszFile, "int", oflag, "int", pmode, errMarshal, err, pvMarshal, pv, "ptr")
        return result
    }
}
