 ...
 */
export default struct PFNFCIREAD {
    value : IntPtr

    __value {
        set {
            if (value is PFNFCIREAD) {
    ...
    /**
     * A PFNFCIREAD that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFNFCIREAD {
        /**
         * Creates a PFNFCIREAD pointer that invokes the given AHK function when called.
