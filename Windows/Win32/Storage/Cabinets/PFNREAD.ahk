 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/Controls/readerscroll
 * @namespace Windows.Win32.Storage.Cabinets
 * @version v4.0.30319
 */
class PFNREAD extends IUnknown {
     ...
     */
    Invoke(hf, pv, cb) {
        result := ComCall(3, this, "ptr", hf, "ptr", pv, "uint", cb, "uint")
        return result
    }
}
