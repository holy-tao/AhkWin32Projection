 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dskquota/nn-dskquota-ienumdiskquotausers
...
class IEnumDiskQuotaUsers extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dskquota/nf-dskquota-ienumdiskquotausers-next
     */
    Next(cUsers, pcUsersFetched) {
        pcUsersFetchedMarshal := pcUsersFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "uint", cUsers, "ptr*", &rgUsers := 0, pcUsersFetchedMarshal, pcUsersFetched, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dskquota/nf-dskquota-ienumdiskquotausers-skip
     */
    Skip(cUsers) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dskquota/nf-dskquota-ienumdiskquotausers-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dskquota/nf-dskquota-ienumdiskquotausers-clone
     */
    Clone() {
