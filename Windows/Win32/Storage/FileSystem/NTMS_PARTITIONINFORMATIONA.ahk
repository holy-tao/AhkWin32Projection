 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntmsapi/ns-ntmsapi-ntms_partitioninformationa
...
class NTMS_PARTITIONINFORMATIONA extends Win32Struct
{
     ...
     */
    Capacity {
        get => NumGet(this, 616, "int64")
        set => NumPut("int64", value, this, 616)
    }
}
