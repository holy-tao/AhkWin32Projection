 ...
 * @version v4.0.30319
 */
class CLFS_BLOCK_ALLOCATION extends IUnknown {
     ...
     */
    Invoke(cbBufferLength, pvUserContext) {
        pvUserContextMarshal := pvUserContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "uint", cbBufferLength, pvUserContextMarshal, pvUserContext, "ptr")
        return result
    }
}
