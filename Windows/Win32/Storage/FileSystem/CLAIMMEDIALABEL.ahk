 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntmsmli/nc-ntmsmli-claimmedialabel
 * @namespace Windows.Win32.Storage.FileSystem
 * @version v4.0.30319
 */
class CLAIMMEDIALABEL extends IUnknown {
     ...
     */
    Invoke(pBuffer, nBufferSize, pLabelInfo) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, pBufferMarshal, pBuffer, "uint", nBufferSize, "ptr", pLabelInfo, "uint")
        return result
    }
}
