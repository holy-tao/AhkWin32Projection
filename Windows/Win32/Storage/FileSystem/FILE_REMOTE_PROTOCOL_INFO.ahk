            ...
            Server {
                get {
                    if(!this.HasProp("__Server"))
                        this.__Server := FILE_REMOTE_PROTOCOL_INFO._ProtocolSpecific._Smb2._Server(0, this)
            ...
            Share {
                get {
                    if(!this.HasProp("__Share"))
                        this.__Share := FILE_REMOTE_PROTOCOL_INFO._ProtocolSpecific._Smb2._Share(4, this)
                    return this.__Share
                }
            }
        }
        ...
        Smb2 {
            get {
                if(!this.HasProp("__Smb2"))
                    this.__Smb2 := FILE_REMOTE_PROTOCOL_INFO._ProtocolSpecific._Smb2(0, this)
                return this.__Smb2
            }
        }
    ...
    ProtocolSpecific {
        get {
            if(!this.HasProp("__ProtocolSpecific"))
                this.__ProtocolSpecific := FILE_REMOTE_PROTOCOL_INFO._ProtocolSpecific(52, this)
