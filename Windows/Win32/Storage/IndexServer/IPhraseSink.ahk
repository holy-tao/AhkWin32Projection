 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/indexsrv/nn-indexsrv-iphrasesink
...
class IPhraseSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/indexsrv/nf-indexsrv-iphrasesink-putsmallphrase
     */
    PutSmallPhrase(pwcNoun, cwcNoun, pwcModifier, cwcModifier, ulAttachmentType) {
        ...
        result := ComCall(3, this, "ptr", pwcNoun, "uint", cwcNoun, "ptr", pwcModifier, "uint", cwcModifier, "uint", ulAttachmentType, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/indexsrv/nf-indexsrv-iphrasesink-putphrase
     */
    PutPhrase(pwcPhrase, cwcPhrase) {
        pwcPhrase := pwcPhrase is String ? StrPtr(pwcPhrase) : pwcPhrase

        result := ComCall(4, this, "ptr", pwcPhrase, "uint", cwcPhrase, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
