 ...
 */
export default struct IVssBackupComponents extends IUnknown {
    /**
     ...
     * used for IVssBackupComponents interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetWriterComponentsCount      : IntPtr
        GetWriterComponents           : IntPtr
        InitializeForBackup           : IntPtr
        SetBackupState                : IntPtr
        InitializeForRestore          : IntPtr
        SetRestoreState               : IntPtr
        GatherWriterMetadata          : IntPtr
        GetWriterMetadataCount        : IntPtr
        GetWriterMetadata             : IntPtr
        FreeWriterMetadata            : IntPtr
        AddComponent                  : IntPtr
        PrepareForBackup              : IntPtr
        AbortBackup                   : IntPtr
        GatherWriterStatus            : IntPtr
        GetWriterStatusCount          : IntPtr
        FreeWriterStatus              : IntPtr
        GetWriterStatus               : IntPtr
        SetBackupSucceeded            : IntPtr
        SetBackupOptions              : IntPtr
        SetSelectedForRestore         : IntPtr
        SetRestoreOptions             : IntPtr
        SetAdditionalRestores         : IntPtr
        SetPreviousBackupStamp        : IntPtr
        SaveAsXML                     : IntPtr
        BackupComplete                : IntPtr
        AddAlternativeLocationMapping : IntPtr
        AddRestoreSubcomponent        : IntPtr
        SetFileRestoreStatus          : IntPtr
        AddNewTarget                  : IntPtr
        SetRangesFilePath             : IntPtr
        PreRestore                    : IntPtr
        PostRestore                   : IntPtr
        SetContext                    : IntPtr
        StartSnapshotSet              : IntPtr
        AddToSnapshotSet              : IntPtr
        DoSnapshotSet                 : IntPtr
        DeleteSnapshots               : IntPtr
        ImportSnapshots               : IntPtr
        BreakSnapshotSet              : IntPtr
        GetSnapshotProperties         : IntPtr
        Query                         : IntPtr
        IsVolumeSupported             : IntPtr
        DisableWriterClasses          : IntPtr
        EnableWriterClasses           : IntPtr
        DisableWriterInstances        : IntPtr
        ExposeSnapshot                : IntPtr
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVssBackupComponents.Vtbl()
        }
    ...
    InitializeForRestore(bstrXML) {
        ...
        result := ComCall(7, this, BSTR, bstrXML, "HRESULT")
        return result
    }
    ...
    SetRestoreState(restoreType) {
        result := ComCall(8, this, VSS_RESTORE_TYPE, restoreType, "HRESULT")
        return result
    }
    ...
    AddComponent(instanceId, writerId, ct, wszLogicalPath, wszComponentName) {
        ...
        result := ComCall(13, this, Guid, instanceId, Guid, writerId, VSS_COMPONENT_TYPE, ct, "ptr", wszLogicalPath, "ptr", wszComponentName, "HRESULT")
        return result
    }
    ...
    SetBackupOptions(writerId, ct, wszLogicalPath, wszComponentName, wszBackupOptions) {
        ...
        result := ComCall(21, this, Guid, writerId, VSS_COMPONENT_TYPE, ct, "ptr", wszLogicalPath, "ptr", wszComponentName, "ptr", wszBackupOptions, "HRESULT")
        return result
    }
    ...
    SetRestoreOptions(writerId, ct, wszLogicalPath, wszComponentName, wszRestoreOptions) {
        ...
        result := ComCall(23, this, Guid, writerId, VSS_COMPONENT_TYPE, ct, "ptr", wszLogicalPath, "ptr", wszComponentName, "ptr", wszRestoreOptions, "HRESULT")
        return result
    }
    ...
    SetPreviousBackupStamp(writerId, ct, wszLogicalPath, wszComponentName, wszPreviousBackupStamp) {
        ...
        result := ComCall(25, this, Guid, writerId, VSS_COMPONENT_TYPE, ct, "ptr", wszLogicalPath, "ptr", wszComponentName, "ptr", wszPreviousBackupStamp, "HRESULT")
        return result
    }
     ...
     */
    SaveAsXML(pbstrXML) {
        result := ComCall(26, this, BSTR.Ptr, pbstrXML, "HRESULT")
        return result
    }
    ...
    SetFileRestoreStatus(writerId, ct, wszLogicalPath, wszComponentName, _status) {
        ...
        result := ComCall(30, this, Guid, writerId, VSS_COMPONENT_TYPE, ct, "ptr", wszLogicalPath, "ptr", wszComponentName, VSS_FILE_RESTORE_STATUS, _status, "HRESULT")
        return result
    }
    ...
    StartSnapshotSet() {
        pSnapshotSetId := Guid()
        result := ComCall(36, this, Guid.Ptr, pSnapshotSetId, "HRESULT")
    ...
    BreakSnapshotSet(SnapshotSetId) {
        result := ComCall(41, this, Guid, SnapshotSetId, "HRESULT")
        return result
    }
    ...
    GetSnapshotProperties(SnapshotId) {
        ...
        result := ComCall(42, this, Guid, SnapshotId, VSS_SNAPSHOT_PROP.Ptr, pProp, "HRESULT")
        return pProp
    }
    ...
    Query(QueriedObjectId, eQueriedObjectType, eReturnedObjectsType, ppEnum) {
        result := ComCall(43, this, Guid, QueriedObjectId, VSS_OBJECT_TYPE, eQueriedObjectType, VSS_OBJECT_TYPE, eReturnedObjectsType, IVssEnumObject.Ptr, ppEnum, "HRESULT")
        return result
    }
    ...
    RevertToSnapshot(SnapshotId, bForceDismount) {
        result := ComCall(49, this, Guid, SnapshotId, BOOL, bForceDismount, "HRESULT")
        return result
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetWriterComponentsCount)
        CallbackFree(this.vtbl.GetWriterComponents)
        CallbackFree(this.vtbl.InitializeForBackup)
        CallbackFree(this.vtbl.SetBackupState)
        CallbackFree(this.vtbl.InitializeForRestore)
        CallbackFree(this.vtbl.SetRestoreState)
        CallbackFree(this.vtbl.GatherWriterMetadata)
        CallbackFree(this.vtbl.GetWriterMetadataCount)
        CallbackFree(this.vtbl.GetWriterMetadata)
        CallbackFree(this.vtbl.FreeWriterMetadata)
        CallbackFree(this.vtbl.AddComponent)
        CallbackFree(this.vtbl.PrepareForBackup)
        CallbackFree(this.vtbl.AbortBackup)
        CallbackFree(this.vtbl.GatherWriterStatus)
        CallbackFree(this.vtbl.GetWriterStatusCount)
        CallbackFree(this.vtbl.FreeWriterStatus)
        CallbackFree(this.vtbl.GetWriterStatus)
        CallbackFree(this.vtbl.SetBackupSucceeded)
        CallbackFree(this.vtbl.SetBackupOptions)
        CallbackFree(this.vtbl.SetSelectedForRestore)
        CallbackFree(this.vtbl.SetRestoreOptions)
        CallbackFree(this.vtbl.SetAdditionalRestores)
        CallbackFree(this.vtbl.SetPreviousBackupStamp)
        CallbackFree(this.vtbl.SaveAsXML)
        CallbackFree(this.vtbl.BackupComplete)
        CallbackFree(this.vtbl.AddAlternativeLocationMapping)
        CallbackFree(this.vtbl.AddRestoreSubcomponent)
        CallbackFree(this.vtbl.SetFileRestoreStatus)
        CallbackFree(this.vtbl.AddNewTarget)
        CallbackFree(this.vtbl.SetRangesFilePath)
        CallbackFree(this.vtbl.PreRestore)
        CallbackFree(this.vtbl.PostRestore)
        CallbackFree(this.vtbl.SetContext)
        CallbackFree(this.vtbl.StartSnapshotSet)
        CallbackFree(this.vtbl.AddToSnapshotSet)
        CallbackFree(this.vtbl.DoSnapshotSet)
        CallbackFree(this.vtbl.DeleteSnapshots)
        CallbackFree(this.vtbl.ImportSnapshots)
        CallbackFree(this.vtbl.BreakSnapshotSet)
        CallbackFree(this.vtbl.GetSnapshotProperties)
        CallbackFree(this.vtbl.Query)
        CallbackFree(this.vtbl.IsVolumeSupported)
        CallbackFree(this.vtbl.DisableWriterClasses)
        CallbackFree(this.vtbl.EnableWriterClasses)
        CallbackFree(this.vtbl.DisableWriterInstances)
        CallbackFree(this.vtbl.ExposeSnapshot)
