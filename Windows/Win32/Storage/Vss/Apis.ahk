...
;@region Constants
     ...
     * @type {Integer (UInt32)}
     */
    static VSS_SW_BOOTABLE_STATE => 1
...
;@region Methods
     ...
     */
    static CreateVssBackupComponentsInternal() {
     ...
     * @since windows5.1.2600
     */
    static CreateVssExamineWriterMetadataInternal(bstrXML) {
        bstrXML := bstrXML is Win32Handle ? NumGet(bstrXML, "ptr") : bstrXML

        result := DllCall("VSSAPI.dll\CreateVssExamineWriterMetadataInternal", "ptr", bstrXML, "ptr*", &ppMetadata := 0, "HRESULT")
     ...
     * @since windows5.1.2600
     */
    static IsVolumeSnapshottedInternal(pwszVolumeName, pbSnapshotsPresent, plSnapshotCapability) {
     ...
     * @since windows5.1.2600
     */
    static VssFreeSnapshotPropertiesInternal(pProp) {
        DllCall("VSSAPI.dll\VssFreeSnapshotPropertiesInternal", "ptr", pProp)
    }
     ...
     * @returns {IUnknown} 
     */
    static GetProviderMgmtInterfaceInternal(ProviderId, InterfaceId) {
        result := DllCall("VSSAPI.dll\GetProviderMgmtInterfaceInternal", "ptr", ProviderId, "ptr", InterfaceId, "ptr*", &ppItf := 0, "HRESULT")
     ...
     * @returns {Boolean} 
     */
    static ShouldBlockRevertInternal(wszVolumeName) {
