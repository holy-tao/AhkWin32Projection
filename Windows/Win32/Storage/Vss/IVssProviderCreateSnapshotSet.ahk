 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nn-vsprov-ivssprovidercreatesnapshotset
...
class IVssProviderCreateSnapshotSet extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-endpreparesnapshots
     */
     ...
     * If any other value is returned, VSS will write an event to the event log and convert the error to 
     *       <b>VSS_E_UNEXPECTED_PROVIDER_ERROR</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-precommitsnapshots
     */
     ...
     * If any other value is returned, VSS will write an event to the event log and convert the error to 
     *       <b>VSS_E_UNEXPECTED_PROVIDER_ERROR</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-commitsnapshots
     */
     ...
     * If any other value is returned, VSS will write an event to the event log and convert the error to 
     *       <b>VSS_E_UNEXPECTED_PROVIDER_ERROR</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-postcommitsnapshots
     */
     ...
     * If any other value is returned, VSS will write an event to the event log and convert the error to 
     *       <b>VSS_E_UNEXPECTED_PROVIDER_ERROR</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-prefinalcommitsnapshots
     */
     ...
     * If any other value is returned, VSS will write an event to the event log and convert the error to 
     *       <b>VSS_E_UNEXPECTED_PROVIDER_ERROR</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-postfinalcommitsnapshots
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vsprov/nf-vsprov-ivssprovidercreatesnapshotset-abortsnapshots
     */
