 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nl-vswriter-ivsscomponent
...
class IVssComponent extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getlogicalpath
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getcomponenttype
     */
    GetComponentType(pct) {
        pctMarshal := pct is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, pctMarshal, pct, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getcomponentname
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getbackupsucceeded
     */
    GetBackupSucceeded(pbSucceeded) {
        pbSucceededMarshal := pbSucceeded is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pbSucceededMarshal, pbSucceeded, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getalternatelocationmappingcount
     */
    GetAlternateLocationMappingCount(pcMappings) {
        pcMappingsMarshal := pcMappings is VarRef ? "uint*" : "ptr"

        result := ComCall(7, this, pcMappingsMarshal, pcMappings, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getalternatelocationmapping
     */
    GetAlternateLocationMapping(iMapping) {
        result := ComCall(8, this, "uint", iMapping, "ptr*", &ppFiledesc := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setbackupmetadata
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getbackupmetadata
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-addpartialfile
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getpartialfilecount
     */
    GetPartialFileCount(pcPartialFiles) {
        pcPartialFilesMarshal := pcPartialFiles is VarRef ? "uint*" : "ptr"

        result := ComCall(12, this, pcPartialFilesMarshal, pcPartialFiles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getpartialfile
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-isselectedforrestore
     */
    IsSelectedForRestore(pbSelectedForRestore) {
        pbSelectedForRestoreMarshal := pbSelectedForRestore is VarRef ? "int*" : "ptr"

        result := ComCall(14, this, pbSelectedForRestoreMarshal, pbSelectedForRestore, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getadditionalrestores
     */
    GetAdditionalRestores(pbAdditionalRestores) {
        pbAdditionalRestoresMarshal := pbAdditionalRestores is VarRef ? "int*" : "ptr"

        result := ComCall(15, this, pbAdditionalRestoresMarshal, pbAdditionalRestores, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getnewtargetcount
     */
    GetNewTargetCount(pcNewTarget) {
        pcNewTargetMarshal := pcNewTarget is VarRef ? "uint*" : "ptr"

        result := ComCall(16, this, pcNewTargetMarshal, pcNewTarget, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getnewtarget
     */
    GetNewTarget(iNewTarget) {
        result := ComCall(17, this, "uint", iNewTarget, "ptr*", &ppFiledesc := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-adddirectedtarget
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getdirectedtargetcount
     */
    GetDirectedTargetCount(pcDirectedTarget) {
        pcDirectedTargetMarshal := pcDirectedTarget is VarRef ? "uint*" : "ptr"

        result := ComCall(19, this, pcDirectedTargetMarshal, pcDirectedTarget, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getdirectedtarget
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setrestoremetadata
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getrestoremetadata
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setrestoretarget
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getrestoretarget
     */
    GetRestoreTarget(pTarget) {
        pTargetMarshal := pTarget is VarRef ? "int*" : "ptr"

        result := ComCall(24, this, pTargetMarshal, pTarget, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setprerestorefailuremsg
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getprerestorefailuremsg
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setpostrestorefailuremsg
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getpostrestorefailuremsg
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-setbackupstamp
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getbackupstamp
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getpreviousbackupstamp
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getbackupoptions
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getrestoreoptions
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getrestoresubcomponentcount
     */
    GetRestoreSubcomponentCount(pcRestoreSubcomponent) {
        pcRestoreSubcomponentMarshal := pcRestoreSubcomponent is VarRef ? "uint*" : "ptr"

        result := ComCall(34, this, pcRestoreSubcomponentMarshal, pcRestoreSubcomponent, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} iComponent_ Index of the subcomponent. The value of this parameter is an integer from 0 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getrestoresubcomponent
     */
    GetRestoreSubcomponent(iComponent_, pbstrLogicalPath, pbstrComponentName, pbRepair) {
        pbRepairMarshal := pbRepair is VarRef ? "int*" : "ptr"

        result := ComCall(35, this, "uint", iComponent_, "ptr", pbstrLogicalPath, "ptr", pbstrComponentName, pbRepairMarshal, pbRepair, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getfilerestorestatus
     */
    GetFileRestoreStatus(pStatus) {
        pStatusMarshal := pStatus is VarRef ? "int*" : "ptr"

        result := ComCall(36, this, pStatusMarshal, pStatus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-adddifferencedfilesbylastmodifytime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-adddifferencedfilesbylastmodifylsn
     */
    AddDifferencedFilesByLastModifyLSN(wszPath, wszFilespec, bRecursive, bstrLsnString) {
        wszPath := wszPath is String ? StrPtr(wszPath) : wszPath
        wszFilespec := wszFilespec is String ? StrPtr(wszFilespec) : wszFilespec
        if(bstrLsnString is String) {
            pin := BSTR.Alloc(bstrLsnString)
            bstrLsnString := pin.Value
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getdifferencedfilescount
     */
    GetDifferencedFilesCount(pcDifferencedFiles) {
        pcDifferencedFilesMarshal := pcDifferencedFiles is VarRef ? "uint*" : "ptr"

        result := ComCall(39, this, pcDifferencedFilesMarshal, pcDifferencedFiles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vswriter/nf-vswriter-ivsscomponent-getdifferencedfile
     */
    GetDifferencedFile(iDifferencedFile, pbstrPath, pbstrFilespec, pbRecursive, pbstrLsnString, pftLastModifyTime) {
        ...
        result := ComCall(40, this, "uint", iDifferencedFile, "ptr", pbstrPath, "ptr", pbstrFilespec, pbRecursiveMarshal, pbRecursive, "ptr", pbstrLsnString, "ptr", pftLastModifyTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
