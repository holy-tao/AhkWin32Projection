...
#Import ".\IVssDifferentialSoftwareSnapshotMgmt.ahk" { IVssDifferentialSoftwareSnapshotMgmt }
 ...
 * @see https://learn.microsoft.com/windows/win32/api/vsmgmt/nn-vsmgmt-ivssdifferentialsoftwaresnapshotmgmt2
 * @namespace Windows.Win32.Storage.Vss
 */
export default struct IVssDifferentialSoftwareSnapshotMgmt2 extends IVssDifferentialSoftwareSnapshotMgmt {
    /**
     ...
     * used for IVssDifferentialSoftwareSnapshotMgmt2 interfaces
    */
    struct Vtbl extends IVssDifferentialSoftwareSnapshotMgmt.Vtbl {
        ChangeDiffAreaMaximumSizeEx : IntPtr
        MigrateDiffAreas            : IntPtr
        QueryMigrationStatus        : IntPtr
        SetSnapshotPriority         : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVssDifferentialSoftwareSnapshotMgmt2.Vtbl()
        }
    ...
    SetSnapshotPriority(idSnapshot, _priority) {
        result := ComCall(12, this, Guid, idSnapshot, "char", _priority, "HRESULT")
        return result
    }

    Query(iid) {
        if (IVssDifferentialSoftwareSnapshotMgmt2.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.ChangeDiffAreaMaximumSizeEx)
        CallbackFree(this.vtbl.MigrateDiffAreas)
        CallbackFree(this.vtbl.QueryMigrationStatus)
        CallbackFree(this.vtbl.SetSnapshotPriority)
    }
}
