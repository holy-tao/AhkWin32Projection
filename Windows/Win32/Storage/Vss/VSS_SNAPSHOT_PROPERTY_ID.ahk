...
class VSS_SNAPSHOT_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: VSS_SPROPID_UNKNOWN
     * @type {Integer (Int32)}
     */
    static SPROPID_UNKNOWN => 0
     ...
     * Native name: VSS_SPROPID_SNAPSHOT_ID
     * @type {Integer (Int32)}
     */
    static SPROPID_SNAPSHOT_ID => 1
     ...
     * Native name: VSS_SPROPID_SNAPSHOT_SET_ID
     * @type {Integer (Int32)}
     */
    static SPROPID_SNAPSHOT_SET_ID => 2
     ...
     * Native name: VSS_SPROPID_SNAPSHOTS_COUNT
     * @type {Integer (Int32)}
     */
    static SPROPID_SNAPSHOTS_COUNT => 3
     ...
     * Native name: VSS_SPROPID_SNAPSHOT_DEVICE
     * @type {Integer (Int32)}
     */
    static SPROPID_SNAPSHOT_DEVICE => 4
     ...
     * Native name: VSS_SPROPID_ORIGINAL_VOLUME
     * @type {Integer (Int32)}
     */
    static SPROPID_ORIGINAL_VOLUME => 5
     ...
     * Native name: VSS_SPROPID_ORIGINATING_MACHINE
     * @type {Integer (Int32)}
     */
    static SPROPID_ORIGINATING_MACHINE => 6
     ...
     * Native name: VSS_SPROPID_SERVICE_MACHINE
     * @type {Integer (Int32)}
     */
    static SPROPID_SERVICE_MACHINE => 7
     ...
     * Native name: VSS_SPROPID_EXPOSED_NAME
     * @type {Integer (Int32)}
     */
    static SPROPID_EXPOSED_NAME => 8
     ...
     * Native name: VSS_SPROPID_EXPOSED_PATH
     * @type {Integer (Int32)}
     */
    static SPROPID_EXPOSED_PATH => 9
     ...
     * Native name: VSS_SPROPID_PROVIDER_ID
     * @type {Integer (Int32)}
     */
    static SPROPID_PROVIDER_ID => 10
     ...
     * Native name: VSS_SPROPID_SNAPSHOT_ATTRIBUTES
     * @type {Integer (Int32)}
     */
    static SPROPID_SNAPSHOT_ATTRIBUTES => 11
     ...
     * Native name: VSS_SPROPID_CREATION_TIMESTAMP
     * @type {Integer (Int32)}
     */
    static SPROPID_CREATION_TIMESTAMP => 12
     ...
     * Native name: VSS_SPROPID_STATUS
     * @type {Integer (Int32)}
     */
    static SPROPID_STATUS => 13
}
