 ...
 */
class IVssExamineWriterMetadataEx2 extends IVssExamineWriterMetadataEx {
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetVersion", "GetExcludeFromSnapshotCount", "GetExcludeFromSnapshotFile"]
