...
class VSS_HARDWARE_OPTIONS extends Win32Enum {
     ...
     * Native name: VSS_BREAKEX_FLAG_MASK_LUNS
     * @type {Integer (Int32)}
     */
    static BREAKEX_FLAG_MASK_LUNS => 1

    /**
     * The shadow copy LUN will be exposed to the host as a read-write volume.
     * Native name: VSS_BREAKEX_FLAG_MAKE_READ_WRITE
     * @type {Integer (Int32)}
     */
    static BREAKEX_FLAG_MAKE_READ_WRITE => 2
     ...
     * Native name: VSS_BREAKEX_FLAG_REVERT_IDENTITY_ALL
     * @type {Integer (Int32)}
     */
    static BREAKEX_FLAG_REVERT_IDENTITY_ALL => 4

    /**
     * None of the disk identifiers of the shadow copy LUNs will be reverted.
     * Native name: VSS_BREAKEX_FLAG_REVERT_IDENTITY_NONE
     * @type {Integer (Int32)}
     */
    static BREAKEX_FLAG_REVERT_IDENTITY_NONE => 8
     ...
     * Native name: VSS_ONLUNSTATECHANGE_NOTIFY_READ_WRITE
     * @type {Integer (Int32)}
     */
    static ONLUNSTATECHANGE_NOTIFY_READ_WRITE => 256
     ...
     * Native name: VSS_ONLUNSTATECHANGE_NOTIFY_LUN_PRE_RECOVERY
     * @type {Integer (Int32)}
     */
    static ONLUNSTATECHANGE_NOTIFY_LUN_PRE_RECOVERY => 512
     ...
     * Native name: VSS_ONLUNSTATECHANGE_NOTIFY_LUN_POST_RECOVERY
     * @type {Integer (Int32)}
     */
    static ONLUNSTATECHANGE_NOTIFY_LUN_POST_RECOVERY => 1024
     ...
     * Native name: VSS_ONLUNSTATECHANGE_DO_MASK_LUNS
     * @type {Integer (Int32)}
     */
    static ONLUNSTATECHANGE_DO_MASK_LUNS => 2048
}
