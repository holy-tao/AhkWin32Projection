 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nn-vsmgmt-ivsssnapshotmgmt2
...
class IVssSnapshotMgmt2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nf-vsmgmt-ivsssnapshotmgmt2-getmindiffareasize
     */
    GetMinDiffAreaSize() {
        result := ComCall(3, this, "int64*", &pllMinDiffAreaSize := 0, "int")
        if(result != 0) {
