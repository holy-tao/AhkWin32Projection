 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nn-vsmgmt-ivssenummgmtobject
...
class IVssEnumMgmtObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nf-vsmgmt-ivssenummgmtobject-next
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nf-vsmgmt-ivssenummgmtobject-skip
     */
    Skip(celt) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nf-vsmgmt-ivssenummgmtobject-reset
     */
    Reset() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/vsmgmt/nf-vsmgmt-ivssenummgmtobject-clone
     */
    Clone(ppenum) {
