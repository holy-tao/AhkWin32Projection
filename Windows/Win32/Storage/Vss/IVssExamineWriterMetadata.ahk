 ...
 */
class IVssExamineWriterMetadata extends IUnknown {
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetIdentity", "GetFileCounts", "GetIncludeFile", "GetExcludeFile", "GetComponent", "GetRestoreMethod", "GetAlternateLocationMapping", "GetBackupSchema", "GetDocument", "SaveAsXML", "LoadFromXML"]
    ...
    GetIdentity(pidInstance, pidWriter, pbstrWriterName, pUsage, pSource) {
        ...
        result := ComCall(3, this, "ptr", pidInstance, "ptr", pidWriter, "ptr", pbstrWriterName, pUsageMarshal, pUsage, pSourceMarshal, pSource, "HRESULT")
        return result
    }
    ...
    GetRestoreMethod(pMethod, pbstrService, pbstrUserProcedure, pwriterRestore, pbRebootRequired, pcMappings) {
        ...
        result := ComCall(8, this, pMethodMarshal, pMethod, "ptr", pbstrService, "ptr", pbstrUserProcedure, pwriterRestoreMarshal, pwriterRestore, pbRebootRequiredMarshal, pbRebootRequired, pcMappingsMarshal, pcMappings, "HRESULT")
        return result
    }
     ...
     */
    SaveAsXML(pbstrXML) {
        result := ComCall(12, this, "ptr", pbstrXML, "HRESULT")
        return result
    }
    ...
    LoadFromXML(bstrXML) {
        ...
        result := ComCall(13, this, "ptr", bstrXML, "HRESULT")
        return result
    }
}
