 ...
 * @see https://learn.microsoft.com/windows/win32/api/vsmgmt/nn-vsmgmt-ivssdifferentialsoftwaresnapshotmgmt
 * @namespace Windows.Win32.Storage.Vss
 */
export default struct IVssDifferentialSoftwareSnapshotMgmt extends IUnknown {
    /**
     ...
     * used for IVssDifferentialSoftwareSnapshotMgmt interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        AddDiffArea                       : IntPtr
        ChangeDiffAreaMaximumSize         : IntPtr
        QueryVolumesSupportedForDiffAreas : IntPtr
        QueryDiffAreasForVolume           : IntPtr
        QueryDiffAreasOnVolume            : IntPtr
        QueryDiffAreasForSnapshot         : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVssDifferentialSoftwareSnapshotMgmt.Vtbl()
        }
    ...
    QueryDiffAreasForSnapshot(SnapshotId) {
        result := ComCall(8, this, Guid, SnapshotId, "ptr*", &ppEnum := 0, "HRESULT")
        return IVssEnumMgmtObject(ppEnum)
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.AddDiffArea)
        CallbackFree(this.vtbl.ChangeDiffAreaMaximumSize)
        CallbackFree(this.vtbl.QueryVolumesSupportedForDiffAreas)
        CallbackFree(this.vtbl.QueryDiffAreasForVolume)
        CallbackFree(this.vtbl.QueryDiffAreasOnVolume)
        CallbackFree(this.vtbl.QueryDiffAreasForSnapshot)
    }
}
