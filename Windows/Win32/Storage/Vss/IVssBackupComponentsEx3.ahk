...
#Include .\IVssBackupComponentsEx2.ahk
 ...
 */
class IVssBackupComponentsEx3 extends IVssBackupComponentsEx2 {
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetWriterStatusEx", "AddSnapshotToRecoverySet", "RecoverSet", "GetSessionId"]
    ...
    GetWriterStatusEx(iWriter, pidInstance, pidWriter, pbstrWriter, pnStatus, phrFailureWriter, phrApplication, pbstrApplicationMessage) {
        ...
        result := ComCall(60, this, "uint", iWriter, "ptr", pidInstance, "ptr", pidWriter, "ptr", pbstrWriter, pnStatusMarshal, pnStatus, phrFailureWriterMarshal, phrFailureWriter, phrApplicationMarshal, phrApplication, "ptr", pbstrApplicationMessage, "HRESULT")
        return result
    }
    ...
    AddSnapshotToRecoverySet(snapshotId, dwFlags, pwszDestinationVolume) {
        ...
        result := ComCall(61, this, "ptr", snapshotId, "uint", dwFlags, pwszDestinationVolumeMarshal, pwszDestinationVolume, "HRESULT")
        return result
    }
    ...
    GetSessionId() {
        idSession := Guid()
        result := ComCall(63, this, "ptr", idSession, "HRESULT")
        return idSession
    }
}
