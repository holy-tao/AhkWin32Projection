 ...
 */
export default struct IVssComponentEx2 extends IVssComponentEx {
    /**
     ...
     * used for IVssComponentEx2 interfaces
    */
    struct Vtbl extends IVssComponentEx.Vtbl {
        SetFailure : IntPtr
        GetFailure : IntPtr
    }
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVssComponentEx2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.SetFailure)
        CallbackFree(this.vtbl.GetFailure)
    }
}
