 ...
 */
export default struct IVssBackupComponentsEx extends IVssBackupComponents {
    /**
     ...
     * used for IVssBackupComponentsEx interfaces
    */
    struct Vtbl extends IVssBackupComponents.Vtbl {
        GetWriterMetadataEx     : IntPtr
        SetSelectedForRestoreEx : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IVssBackupComponentsEx.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetWriterMetadataEx)
        CallbackFree(this.vtbl.SetSelectedForRestoreEx)
    }
}
