    ...
    PreviousTaskFile{
        get {
            if(!this.HasProp("__PreviousTaskFileProxyArray"))
                this.__PreviousTaskFileProxyArray := Win32FixedArray(this.ptr + 24, 1, Primitive, "char")
    ...
    CurrentTaskFile{
        get {
            if(!this.HasProp("__CurrentTaskFileProxyArray"))
                this.__CurrentTaskFileProxyArray := Win32FixedArray(this.ptr + 32, 1, Primitive, "char")
