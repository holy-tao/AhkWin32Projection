 ...
 */
export GetIScsiVersionInformation(VersionInfo) {
    result := DllCall("ISCSIDSC.dll\GetIScsiVersionInformation", ISCSI_VERSION_INFO.Ptr, VersionInfo, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export GetIScsiTargetInformationW(TargetName, DiscoveryMechanism, InfoClass, BufferSize, _Buffer) {
 ...
 * @since windows6.0.6000
 */
export GetIScsiTargetInformationA(TargetName, DiscoveryMechanism, InfoClass, BufferSize, _Buffer) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
    DiscoveryMechanism := DiscoveryMechanism is String ? StrPtr(DiscoveryMechanism) : DiscoveryMechanism
 ...
 * @since windows6.0.6000
 */
export RemoveIScsiConnection(UniqueSessionId, ConnectionId) {
    result := DllCall("ISCSIDSC.dll\RemoveIScsiConnection", ISCSI_UNIQUE_SESSION_ID.Ptr, UniqueSessionId, ISCSI_UNIQUE_SESSION_ID.Ptr, ConnectionId, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddIScsiStaticTargetW(TargetName, TargetAlias, TargetFlags, Persist, Mappings, LoginOptions, PortalGroup) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
 ...
 * @since windows6.0.6000
 */
export AddIScsiStaticTargetA(TargetName, TargetAlias, TargetFlags, Persist, Mappings, LoginOptions, PortalGroup) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
    TargetAlias := TargetAlias is String ? StrPtr(TargetAlias) : TargetAlias
 ...
 * @since windows6.0.6000
 */
export RemoveIScsiStaticTargetW(TargetName) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName

    result := DllCall("ISCSIDSC.dll\RemoveIScsiStaticTargetW", "ptr", TargetName, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveIScsiStaticTargetA(TargetName) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName

    result := DllCall("ISCSIDSC.dll\RemoveIScsiStaticTargetA", "ptr", TargetName, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export LoginIScsiTargetW(TargetName, IsInformationalSession, InitiatorInstance, InitiatorPortNumber, TargetPortal, SecurityFlags, Mappings, LoginOptions, KeySize, Key, IsPersistent, UniqueSessionId, UniqueConnectionId) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
    InitiatorInstance := InitiatorInstance is String ? StrPtr(InitiatorInstance) : InitiatorInstance
    Key := Key is String ? StrPtr(Key) : Key
 ...
 * @since windows6.0.6000
 */
export LoginIScsiTargetA(TargetName, IsInformationalSession, InitiatorInstance, InitiatorPortNumber, TargetPortal, SecurityFlags, Mappings, LoginOptions, KeySize, Key, IsPersistent, UniqueSessionId, UniqueConnectionId) {
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
    InitiatorInstance := InitiatorInstance is String ? StrPtr(InitiatorInstance) : InitiatorInstance
    Key := Key is String ? StrPtr(Key) : Key
 ...
 * @since windows6.0.6000
 */
export LogoutIScsiTarget(UniqueSessionId) {
    result := DllCall("ISCSIDSC.dll\LogoutIScsiTarget", ISCSI_UNIQUE_SESSION_ID.Ptr, UniqueSessionId, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveIScsiPersistentTargetW(InitiatorInstance, InitiatorPortNumber, TargetName, Portal) {
    InitiatorInstance := InitiatorInstance is String ? StrPtr(InitiatorInstance) : InitiatorInstance
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
 ...
 * @since windows6.0.6000
 */
export RemoveIScsiPersistentTargetA(InitiatorInstance, InitiatorPortNumber, TargetName, Portal) {
    InitiatorInstance := InitiatorInstance is String ? StrPtr(InitiatorInstance) : InitiatorInstance
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
 ...
 * @since windows6.0.6000
 */
export SetIScsiTunnelModeOuterAddressW(InitiatorName, InitiatorPortNumber, DestinationAddress, OuterModeAddress, Persist) {
 ...
 * @since windows6.0.6000
 */
export SetIScsiTunnelModeOuterAddressA(InitiatorName, InitiatorPortNumber, DestinationAddress, OuterModeAddress, Persist) {
    InitiatorName := InitiatorName is String ? StrPtr(InitiatorName) : InitiatorName
    DestinationAddress := DestinationAddress is String ? StrPtr(DestinationAddress) : DestinationAddress
    OuterModeAddress := OuterModeAddress is String ? StrPtr(OuterModeAddress) : OuterModeAddress
 ...
 * @since windows6.0.6000
 */
export GetIScsiInitiatorNodeNameW(InitiatorNodeName) {
    InitiatorNodeName := InitiatorNodeName is String ? StrPtr(InitiatorNodeName) : InitiatorNodeName

    result := DllCall("ISCSIDSC.dll\GetIScsiInitiatorNodeNameW", "ptr", InitiatorNodeName, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export GetIScsiInitiatorNodeNameA(InitiatorNodeName) {
    InitiatorNodeName := InitiatorNodeName is String ? StrPtr(InitiatorNodeName) : InitiatorNodeName

    result := DllCall("ISCSIDSC.dll\GetIScsiInitiatorNodeNameA", "ptr", InitiatorNodeName, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddISNSServerW(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\AddISNSServerW", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddISNSServerA(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\AddISNSServerA", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveISNSServerW(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RemoveISNSServerW", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveISNSServerA(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RemoveISNSServerA", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RefreshISNSServerW(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RefreshISNSServerW", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RefreshISNSServerA(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RefreshISNSServerA", "ptr", _Address, UInt32)
    return result
}
...
export SetupPersistentIScsiVolumes() {
    result := DllCall("ISCSIDSC.dll\SetupPersistentIScsiVolumes", UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export SetupPersistentIScsiDevices() {
    result := DllCall("ISCSIDSC.dll\SetupPersistentIScsiDevices", UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddPersistentIScsiDeviceW(DevicePath) {
    DevicePath := DevicePath is String ? StrPtr(DevicePath) : DevicePath

    result := DllCall("ISCSIDSC.dll\AddPersistentIScsiDeviceW", "ptr", DevicePath, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddPersistentIScsiDeviceA(DevicePath) {
    DevicePath := DevicePath is String ? StrPtr(DevicePath) : DevicePath

    result := DllCall("ISCSIDSC.dll\AddPersistentIScsiDeviceA", "ptr", DevicePath, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemovePersistentIScsiDeviceW(DevicePath) {
    DevicePath := DevicePath is String ? StrPtr(DevicePath) : DevicePath

    result := DllCall("ISCSIDSC.dll\RemovePersistentIScsiDeviceW", "ptr", DevicePath, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemovePersistentIScsiDeviceA(DevicePath) {
    DevicePath := DevicePath is String ? StrPtr(DevicePath) : DevicePath

    result := DllCall("ISCSIDSC.dll\RemovePersistentIScsiDeviceA", "ptr", DevicePath, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export ClearPersistentIScsiDevices() {
    result := DllCall("ISCSIDSC.dll\ClearPersistentIScsiDevices", UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export ReportIScsiTargetPortalsW(InitiatorName, TargetName, TargetPortalTag, ElementCount, Portals) {
    InitiatorName := InitiatorName is String ? StrPtr(InitiatorName) : InitiatorName
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
 ...
 * @since windows6.0.6000
 */
export ReportIScsiTargetPortalsA(InitiatorName, TargetName, TargetPortalTag, ElementCount, Portals) {
    InitiatorName := InitiatorName is String ? StrPtr(InitiatorName) : InitiatorName
    TargetName := TargetName is String ? StrPtr(TargetName) : TargetName
 ...
 * @since windows6.0.6000
 */
export AddRadiusServerW(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\AddRadiusServerW", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export AddRadiusServerA(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\AddRadiusServerA", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveRadiusServerW(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RemoveRadiusServerW", "ptr", _Address, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export RemoveRadiusServerA(_Address) {
    _Address := _Address is String ? StrPtr(_Address) : _Address

    result := DllCall("ISCSIDSC.dll\RemoveRadiusServerA", "ptr", _Address, UInt32)
    return result
}
