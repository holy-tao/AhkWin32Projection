...
export default struct IFsrmActionEmail extends IFsrmAction {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_MailReplyTo := CallbackCreate(ObjBindMethod(implObj, "get_MailReplyTo"), flags, 2)
        this.vtbl.put_MailReplyTo := CallbackCreate(ObjBindMethod(implObj, "put_MailReplyTo"), flags, 2)
        ...
        this.vtbl.get_MailCc := CallbackCreate(ObjBindMethod(implObj, "get_MailCc"), flags, 2)
        this.vtbl.put_MailCc := CallbackCreate(ObjBindMethod(implObj, "put_MailCc"), flags, 2)
        this.vtbl.get_MailBcc := CallbackCreate(ObjBindMethod(implObj, "get_MailBcc"), flags, 2)
        this.vtbl.put_MailBcc := CallbackCreate(ObjBindMethod(implObj, "put_MailBcc"), flags, 2)
        this.vtbl.get_MailSubject := CallbackCreate(ObjBindMethod(implObj, "get_MailSubject"), flags, 2)
        this.vtbl.put_MailSubject := CallbackCreate(ObjBindMethod(implObj, "put_MailSubject"), flags, 2)
