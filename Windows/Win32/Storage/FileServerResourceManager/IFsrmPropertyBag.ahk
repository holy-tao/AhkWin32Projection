...
export default struct IFsrmPropertyBag extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_RelativePath := CallbackCreate(ObjBindMethod(implObj, "get_RelativePath"), flags, 2)
        this.vtbl.get_VolumeName := CallbackCreate(ObjBindMethod(implObj, "get_VolumeName"), flags, 2)
        this.vtbl.get_RelativeNamespaceRoot := CallbackCreate(ObjBindMethod(implObj, "get_RelativeNamespaceRoot"), flags, 2)
        this.vtbl.get_VolumeIndex := CallbackCreate(ObjBindMethod(implObj, "get_VolumeIndex"), flags, 2)
        this.vtbl.get_FileId := CallbackCreate(ObjBindMethod(implObj, "get_FileId"), flags, 2)
        this.vtbl.get_ParentDirectoryId := CallbackCreate(ObjBindMethod(implObj, "get_ParentDirectoryId"), flags, 2)
        this.vtbl.get_Size := CallbackCreate(ObjBindMethod(implObj, "get_Size"), flags, 2)
        this.vtbl.get_SizeAllocated := CallbackCreate(ObjBindMethod(implObj, "get_SizeAllocated"), flags, 2)
        this.vtbl.get_CreationTime := CallbackCreate(ObjBindMethod(implObj, "get_CreationTime"), flags, 2)
        this.vtbl.get_LastAccessTime := CallbackCreate(ObjBindMethod(implObj, "get_LastAccessTime"), flags, 2)
        this.vtbl.get_LastModificationTime := CallbackCreate(ObjBindMethod(implObj, "get_LastModificationTime"), flags, 2)
        ...
        this.vtbl.get_FilePropertyNames := CallbackCreate(ObjBindMethod(implObj, "get_FilePropertyNames"), flags, 2)
        this.vtbl.get_Messages := CallbackCreate(ObjBindMethod(implObj, "get_Messages"), flags, 2)
        this.vtbl.get_PropertyBagFlags := CallbackCreate(ObjBindMethod(implObj, "get_PropertyBagFlags"), flags, 2)
        this.vtbl.GetFileProperty := CallbackCreate(ObjBindMethod(implObj, "GetFileProperty"), flags, 3)
        this.vtbl.SetFileProperty := CallbackCreate(ObjBindMethod(implObj, "SetFileProperty"), flags, 3)
        this.vtbl.AddMessage := CallbackCreate(ObjBindMethod(implObj, "AddMessage"), flags, 2)
        this.vtbl.GetFileStreamInterface := CallbackCreate(ObjBindMethod(implObj, "GetFileStreamInterface"), flags, 4)
    }
