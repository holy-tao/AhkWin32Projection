...
class IFsrmQuotaManager extends IDispatch{
    ...
    CreateQuota(path, quota) {
        ...
        result := ComCall(9, this, "ptr", path, "ptr", quota, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateAutoApplyQuota(quotaTemplateName, path, quota) {
        ...
        result := ComCall(10, this, "ptr", quotaTemplateName, "ptr", path, "ptr", quota, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetQuota(path, quota) {
        ...
        result := ComCall(11, this, "ptr", path, "ptr", quota, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAutoApplyQuota(path, quota) {
        ...
        result := ComCall(12, this, "ptr", path, "ptr", quota, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRestrictiveQuota(path, quota) {
        ...
        result := ComCall(13, this, "ptr", path, "ptr", quota, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumQuotas(path, options, quotas) {
        ...
        result := ComCall(14, this, "ptr", path, "int", options, "ptr", quotas, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumAutoApplyQuotas(path, options, quotas) {
        ...
        result := ComCall(15, this, "ptr", path, "int", options, "ptr", quotas, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumEffectiveQuotas(path, options, quotas) {
        ...
        result := ComCall(16, this, "ptr", path, "int", options, "ptr", quotas, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateQuotaCollection(collection) {
        result := ComCall(18, this, "ptr", collection, "int")
        if(result != 0)
            throw OSError(result)
