 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nn-fsrmquota-ifsrmquotamanager
...
class IFsrmQuotaManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-get_actionvariables
     */
    get_ActionVariables() {
     ...
     *     100 (percent).
     * @param {BSTR} path_ The local directory path to which the quota applies. The string is limited to 260 characters.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-createquota
     */
    CreateQuota(path_) {
        if(path_ is String) {
        ...
        result := ComCall(9, this, "ptr", path_, "ptr*", &quota := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-createautoapplyquota
     */
    CreateAutoApplyQuota(quotaTemplateName, path_) {
        ...
        result := ComCall(10, this, "ptr", quotaTemplateName, "ptr", path_, "ptr*", &quota := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} path_ The local directory path that contains the quota that you want to retrieve. The string is limited to 260 
     *       characters.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-getquota
     */
    GetQuota(path_) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
        ...
        result := ComCall(11, this, "ptr", path_, "ptr*", &quota := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *       object.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-getautoapplyquota
     */
    GetAutoApplyQuota(path_) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
            path_ := pin.Value
        }

        result := ComCall(12, this, "ptr", path_, "ptr*", &quota := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} path_ The local directory path. The string is limited to 260 characters.
     * @returns {IFsrmQuota} An <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/fsrmquota/nn-fsrmquota-ifsrmquota">IFsrmQuota</a> interface to  the quota object.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-getrestrictivequota
     */
    GetRestrictiveQuota(path_) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
            path_ := pin.Value
        }

        result := ComCall(13, this, "ptr", path_, "ptr*", &quota := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *     method.
     * @param {BSTR} path_ The local directory path that is associated with the quota that you want to enumerate. The string is limited 
     *        to 260 characters.
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-enumquotas
     */
    EnumQuotas(path_, options) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
            path_ := pin.Value
        }

        result := ComCall(14, this, "ptr", path_, "int", options, "ptr*", &quotas := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *     method.
     * @param {BSTR} path_ The local directory path that is associated with the automatic quota that you want to enumerate. The string 
     ...
     * 
     * The collection is empty if the path does not contain quotas.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-enumautoapplyquotas
     */
    EnumAutoApplyQuotas(path_, options) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
            path_ := pin.Value
        }

        result := ComCall(15, this, "ptr", path_, "int", options, "ptr*", &quotas := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} path_ A local directory path. The string is limited to 260 characters.
     * @param {Integer} options Options to use when enumerating the quotas. For possible values, see the 
     *       <a href="https://docs.microsoft.com/windows/desktop/api/fsrmenums/ne-fsrmenums-fsrmenumoptions">FsrmEnumOptions</a> enumeration.
     * @returns {IFsrmCommittableCollection} An <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/fsrm/nn-fsrm-ifsrmcommittablecollection">IFsrmCommittableCollection</a> interface 
     ...
     * 
     * The collection is empty if the path does not contain quotas.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-enumeffectivequotas
     */
    EnumEffectiveQuotas(path_, options) {
        if(path_ is String) {
            pin := BSTR.Alloc(path_)
            path_ := pin.Value
        }

        result := ComCall(16, this, "ptr", path_, "int", options, "ptr*", &quotas := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-scan
     */
    Scan(strPath) {
        ...
        result := ComCall(17, this, "ptr", strPath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotamanager-createquotacollection
     */
    CreateQuotaCollection() {
        result := ComCall(18, this, "ptr*", &collection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
