 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nn-fsrmpipeline-ifsrmrule
...
class IFsrmRule extends IFsrmObject{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_name
     */
    get_Name() {
        name := BSTR()
     ...
     * @param {BSTR} name 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-put_name
     */
    put_Name(name) {
        if(name is String) {
            pin := BSTR.Alloc(name)
     ...
     * The name and rule type properties define a unique rule.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_ruletype
     */
    get_RuleType() {
        result := ComCall(14, this, "int*", &ruleType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_moduledefinitionname
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-put_moduledefinitionname
     */
    put_ModuleDefinitionName(moduleDefinitionName) {
        if(moduleDefinitionName is String) {
            pin := BSTR.Alloc(moduleDefinitionName)
            moduleDefinitionName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_namespaceroots
     */
    get_NamespaceRoots() {
        result := ComCall(17, this, "ptr*", &namespaceRoots := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-put_namespaceroots
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_ruleflags
     */
    get_RuleFlags() {
        result := ComCall(19, this, "int*", &ruleFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-put_ruleflags
     */
     ...
     * @returns {Pointer<SAFEARRAY>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_parameters
     */
    get_Parameters() {
        result := ComCall(21, this, "ptr*", &parameters := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-put_parameters
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmrule-get_lastmodified
     */
    get_LastModified() {
