 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nn-fsrm-ifsrmcommittablecollection
...
class IFsrmCommittableCollection extends IFsrmMutableCollection{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmcommittablecollection-commit
     */
    Commit(options) {
        result := ComCall(18, this, "int", options, "ptr*", &results := 0, "int")
        if(result != 0) {
