...
export default struct IFsrmPipelineModuleDefinition extends IFsrmObject {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ModuleClsid := CallbackCreate(ObjBindMethod(implObj, "get_ModuleClsid"), flags, 2)
        this.vtbl.put_ModuleClsid := CallbackCreate(ObjBindMethod(implObj, "put_ModuleClsid"), flags, 2)
        ...
        this.vtbl.get_ModuleType := CallbackCreate(ObjBindMethod(implObj, "get_ModuleType"), flags, 2)
        ...
        this.vtbl.get_NeedsFileContent := CallbackCreate(ObjBindMethod(implObj, "get_NeedsFileContent"), flags, 2)
        this.vtbl.put_NeedsFileContent := CallbackCreate(ObjBindMethod(implObj, "put_NeedsFileContent"), flags, 2)
        ...
        this.vtbl.get_SupportedExtensions := CallbackCreate(ObjBindMethod(implObj, "get_SupportedExtensions"), flags, 2)
        this.vtbl.put_SupportedExtensions := CallbackCreate(ObjBindMethod(implObj, "put_SupportedExtensions"), flags, 2)
