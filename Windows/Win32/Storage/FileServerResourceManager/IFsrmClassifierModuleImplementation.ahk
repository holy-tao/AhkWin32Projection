 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nn-fsrmpipeline-ifsrmclassifiermoduleimplementation
...
class IFsrmClassifierModuleImplementation extends IFsrmPipelineModuleImplementation{
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-get_lastmodified
     */
    get_LastModified() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-userulesanddefinitions
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-onbeginfile
     */
     ...
     * 
     * If <b>FSRM_E_INCOMPATIBLE_FORMAT</b> or <b>FSRM_E_FILE_ENCRYPTED</b> is returned, FSRM will not indicate that the file has failed classification. If any other error value is returned, FSRM will indicate that the file has failed classification.
     * @param {BSTR} property_ Name of the property to query.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-doespropertyvalueapply
     */
    DoesPropertyValueApply(property_, value, idRule, idPropDef) {
        ...
        result := ComCall(12, this, "ptr", property_, "ptr", value, "short*", &applyValue := 0, "ptr", idRule, "ptr", idPropDef, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} property_ Name of the property.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-getpropertyvaluetoapply
     */
    GetPropertyValueToApply(property_, idRule, idPropDef) {
        if(property_ is String) {
            pin := BSTR.Alloc(property_)
            property_ := pin.Value
        }
        ...
        value := BSTR()
        result := ComCall(13, this, "ptr", property_, "ptr", value, "ptr", idRule, "ptr", idPropDef, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmpipeline/nf-fsrmpipeline-ifsrmclassifiermoduleimplementation-onendfile
     */
    OnEndFile() {
