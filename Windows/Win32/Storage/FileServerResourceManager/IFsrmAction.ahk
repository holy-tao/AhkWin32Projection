 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nn-fsrm-ifsrmaction
...
class IFsrmAction extends IDispatch{
     ...
     * @returns {Guid} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmaction-get_id
     */
    get_Id() {
        id := Guid()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmaction-get_actiontype
     */
    get_ActionType() {
        result := ComCall(8, this, "int*", &actionType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmaction-get_runlimitinterval
     */
    get_RunLimitInterval() {
        result := ComCall(9, this, "int*", &minutes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmaction-put_runlimitinterval
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmaction-delete
     */
    Delete() {
