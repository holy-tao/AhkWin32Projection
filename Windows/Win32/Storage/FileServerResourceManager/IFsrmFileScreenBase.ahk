 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nn-fsrmscreen-ifsrmfilescreenbase
...
class IFsrmFileScreenBase extends IFsrmObject{
    ...
    /**
     * Retrieves or sets the names of the file groups that contain the file name patterns used to specify the files that are blocked by this screen. (Get)
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-get_blockedfilegroups
     */
    get_BlockedFileGroups() {
        result := ComCall(12, this, "ptr*", &blockList := 0, "int")
        if(result != 0) {
    ...
    /**
     * Retrieves or sets the names of the file groups that contain the file name patterns used to specify the files that are blocked by this screen. (Put)
     * @remarks
     * To specify the blocked group names on a new screen, access this property to get an empty collection and then add the group names to the collection.
     * @param {IFsrmMutableCollection} blockList 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-put_blockedfilegroups
     */
    ...
    /**
     * Retrieves or sets the file screen flags. (Get)
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-get_filescreenflags
     */
    get_FileScreenFlags() {
        result := ComCall(14, this, "int*", &fileScreenFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Retrieves or sets the file screen flags. (Put)
     * @param {Integer} fileScreenFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-put_filescreenflags
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-createaction
     */
    CreateAction(actionType) {
        result := ComCall(16, this, "int", actionType, "ptr*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmscreen/nf-fsrmscreen-ifsrmfilescreenbase-enumactions
     */
    EnumActions() {
        result := ComCall(17, this, "ptr*", &actions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
