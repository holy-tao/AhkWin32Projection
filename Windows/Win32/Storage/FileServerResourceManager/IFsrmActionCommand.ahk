...
export default struct IFsrmActionCommand extends IFsrmAction {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ExecutablePath := CallbackCreate(ObjBindMethod(implObj, "get_ExecutablePath"), flags, 2)
        this.vtbl.put_ExecutablePath := CallbackCreate(ObjBindMethod(implObj, "put_ExecutablePath"), flags, 2)
        ...
        this.vtbl.get_Account := CallbackCreate(ObjBindMethod(implObj, "get_Account"), flags, 2)
        this.vtbl.put_Account := CallbackCreate(ObjBindMethod(implObj, "put_Account"), flags, 2)
        ...
        this.vtbl.get_MonitorCommand := CallbackCreate(ObjBindMethod(implObj, "get_MonitorCommand"), flags, 2)
        this.vtbl.put_MonitorCommand := CallbackCreate(ObjBindMethod(implObj, "put_MonitorCommand"), flags, 2)
        this.vtbl.get_KillTimeOut := CallbackCreate(ObjBindMethod(implObj, "get_KillTimeOut"), flags, 2)
        this.vtbl.put_KillTimeOut := CallbackCreate(ObjBindMethod(implObj, "put_KillTimeOut"), flags, 2)
        this.vtbl.get_LogResult := CallbackCreate(ObjBindMethod(implObj, "get_LogResult"), flags, 2)
        this.vtbl.put_LogResult := CallbackCreate(ObjBindMethod(implObj, "put_LogResult"), flags, 2)
    }
