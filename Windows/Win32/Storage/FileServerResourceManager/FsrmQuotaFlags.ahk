...
class FsrmQuotaFlags extends Win32Enum {
     ...
     * Native name: FsrmQuotaFlags_Enforce
     * @type {Integer (Int32)}
     */
    static Enforce => 256
     ...
     *      thresholds.
     * Native name: FsrmQuotaFlags_Disable
     * @type {Integer (Int32)}
     */
    static Disable => 512
     ...
     *      failed.
     * Native name: FsrmQuotaFlags_StatusIncomplete
     * @type {Integer (Int32)}
     */
    static StatusIncomplete => 65536

    /**
     * The quota is in the process of rebuilding its data from the disk.
     * Native name: FsrmQuotaFlags_StatusRebuilding
     * @type {Integer (Int32)}
     */
    static StatusRebuilding => 131072
}
