 ...
 *     "$Recycle").
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nn-fsrmreports-ifsrmfilemanagementjob
...
class IFsrmFileManagementJob extends IFsrmObject{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_name
     */
    get_Name() {
        name := BSTR()
     ...
     * @param {BSTR} name 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_name
     */
    put_Name(name) {
        if(name is String) {
            pin := BSTR.Alloc(name)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_namespaceroots
     */
    get_NamespaceRoots() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_namespaceroots
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_enabled
     */
    get_Enabled() {
        result := ComCall(16, this, "short*", &enabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_enabled
     */
    put_Enabled(enabled) {
     ...
     *     run.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_operationtype
     */
    get_OperationType() {
        result := ComCall(18, this, "int*", &operationType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_operationtype
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_expirationdirectory
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_expirationdirectory
     */
    put_ExpirationDirectory(expirationDirectory) {
        if(expirationDirectory is String) {
            pin := BSTR.Alloc(expirationDirectory)
            expirationDirectory := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_customaction
     */
    get_CustomAction() {
        result := ComCall(22, this, "ptr*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<SAFEARRAY>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_notifications
     */
    get_Notifications() {
        result := ComCall(23, this, "ptr*", &notifications := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_logging
     */
    get_Logging() {
        result := ComCall(24, this, "int*", &loggingFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_logging
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_reportenabled
     */
    get_ReportEnabled() {
        result := ComCall(26, this, "short*", &reportEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_reportenabled
     */
     ...
     * @returns {Pointer<SAFEARRAY>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_formats
     */
    get_Formats() {
        result := ComCall(28, this, "ptr*", &formats := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_formats
     */
    put_Formats(formats) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_mailto
     */
    get_MailTo() {
        mailTo := BSTR()
     ...
     * @param {BSTR} mailTo 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_mailto
     */
    put_MailTo(mailTo) {
        if(mailTo is String) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_dayssincefilecreated
     */
    get_DaysSinceFileCreated() {
        result := ComCall(32, this, "int*", &daysSinceCreation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_dayssincefilecreated
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_dayssincefilelastaccessed
     */
    get_DaysSinceFileLastAccessed() {
        result := ComCall(34, this, "int*", &daysSinceAccess := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_dayssincefilelastaccessed
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_dayssincefilelastmodified
     */
    get_DaysSinceFileLastModified() {
        result := ComCall(36, this, "int*", &daysSinceModify := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_dayssincefilelastmodified
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_propertyconditions
     */
    get_PropertyConditions() {
        result := ComCall(38, this, "ptr*", &propertyConditions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_fromdate
     */
    get_FromDate() {
        result := ComCall(39, this, "double*", &fromDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_fromdate
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_task
     */
    get_Task() {
        taskName := BSTR()
     ...
     * @param {BSTR} taskName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_task
     */
    put_Task(taskName) {
     ...
     *     "parameter=").
     * @returns {Pointer<SAFEARRAY>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_parameters
     */
    get_Parameters() {
        result := ComCall(43, this, "ptr*", &parameters := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_parameters
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_runningstatus
     */
    get_RunningStatus() {
        result := ComCall(45, this, "int*", &runningStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_lasterror
     */
    get_LastError() {
        lastError := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_lastreportpathwithoutextension
     */
    get_LastReportPathWithoutExtension() {
        path_ := BSTR()
        result := ComCall(47, this, "ptr", path_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_lastrun
     */
    get_LastRun() {
        result := ComCall(48, this, "double*", &lastRun := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_filenamepattern
     */
    get_FileNamePattern() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-put_filenamepattern
     */
    put_FileNamePattern(fileNamePattern) {
        if(fileNamePattern is String) {
            pin := BSTR.Alloc(fileNamePattern)
            fileNamePattern := pin.Value
        }
     ...
     *     property.
     * @param {Integer} context_ Specifies to which subdirectory the reports or logging are written, if enabled. For possible values, see 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-run
     */
    Run(context_) {
        result := ComCall(51, this, "int", context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *       <b>VARIANT_FALSE</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-waitforcompletion
     */
    WaitForCompletion(waitSeconds) {
        result := ComCall(52, this, "int", waitSeconds, "short*", &completed := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-cancel
     */
    Cancel() {
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-addnotification
     */
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-deletenotification
     */
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-modifynotification
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-createnotificationaction
     */
    CreateNotificationAction(days, actionType) {
        result := ComCall(57, this, "int", days, "int", actionType, "ptr*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-enumnotificationactions
     */
    EnumNotificationActions(days) {
        result := ComCall(58, this, "int", days, "ptr*", &actions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-createpropertycondition
     */
    CreatePropertyCondition(name) {
        ...
        result := ComCall(59, this, "ptr", name, "ptr*", &propertyCondition := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-createcustomaction
     */
    CreateCustomAction() {
        result := ComCall(60, this, "ptr*", &customAction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
