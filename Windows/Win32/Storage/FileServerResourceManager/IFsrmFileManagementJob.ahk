...
export default struct IFsrmFileManagementJob extends IFsrmObject {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_OperationType := CallbackCreate(ObjBindMethod(implObj, "get_OperationType"), flags, 2)
        this.vtbl.put_OperationType := CallbackCreate(ObjBindMethod(implObj, "put_OperationType"), flags, 2)
        this.vtbl.get_ExpirationDirectory := CallbackCreate(ObjBindMethod(implObj, "get_ExpirationDirectory"), flags, 2)
        this.vtbl.put_ExpirationDirectory := CallbackCreate(ObjBindMethod(implObj, "put_ExpirationDirectory"), flags, 2)
        this.vtbl.get_CustomAction := CallbackCreate(ObjBindMethod(implObj, "get_CustomAction"), flags, 2)
        this.vtbl.get_Notifications := CallbackCreate(ObjBindMethod(implObj, "get_Notifications"), flags, 2)
        this.vtbl.get_Logging := CallbackCreate(ObjBindMethod(implObj, "get_Logging"), flags, 2)
        this.vtbl.put_Logging := CallbackCreate(ObjBindMethod(implObj, "put_Logging"), flags, 2)
        this.vtbl.get_ReportEnabled := CallbackCreate(ObjBindMethod(implObj, "get_ReportEnabled"), flags, 2)
        this.vtbl.put_ReportEnabled := CallbackCreate(ObjBindMethod(implObj, "put_ReportEnabled"), flags, 2)
        this.vtbl.get_Formats := CallbackCreate(ObjBindMethod(implObj, "get_Formats"), flags, 2)
        this.vtbl.put_Formats := CallbackCreate(ObjBindMethod(implObj, "put_Formats"), flags, 2)
        ...
        this.vtbl.get_DaysSinceFileCreated := CallbackCreate(ObjBindMethod(implObj, "get_DaysSinceFileCreated"), flags, 2)
        this.vtbl.put_DaysSinceFileCreated := CallbackCreate(ObjBindMethod(implObj, "put_DaysSinceFileCreated"), flags, 2)
        this.vtbl.get_DaysSinceFileLastAccessed := CallbackCreate(ObjBindMethod(implObj, "get_DaysSinceFileLastAccessed"), flags, 2)
        this.vtbl.put_DaysSinceFileLastAccessed := CallbackCreate(ObjBindMethod(implObj, "put_DaysSinceFileLastAccessed"), flags, 2)
        this.vtbl.get_DaysSinceFileLastModified := CallbackCreate(ObjBindMethod(implObj, "get_DaysSinceFileLastModified"), flags, 2)
        this.vtbl.put_DaysSinceFileLastModified := CallbackCreate(ObjBindMethod(implObj, "put_DaysSinceFileLastModified"), flags, 2)
        this.vtbl.get_PropertyConditions := CallbackCreate(ObjBindMethod(implObj, "get_PropertyConditions"), flags, 2)
        this.vtbl.get_FromDate := CallbackCreate(ObjBindMethod(implObj, "get_FromDate"), flags, 2)
        this.vtbl.put_FromDate := CallbackCreate(ObjBindMethod(implObj, "put_FromDate"), flags, 2)
        this.vtbl.get_Task := CallbackCreate(ObjBindMethod(implObj, "get_Task"), flags, 2)
        this.vtbl.put_Task := CallbackCreate(ObjBindMethod(implObj, "put_Task"), flags, 2)
        ...
        this.vtbl.get_RunningStatus := CallbackCreate(ObjBindMethod(implObj, "get_RunningStatus"), flags, 2)
        this.vtbl.get_LastError := CallbackCreate(ObjBindMethod(implObj, "get_LastError"), flags, 2)
        this.vtbl.get_LastReportPathWithoutExtension := CallbackCreate(ObjBindMethod(implObj, "get_LastReportPathWithoutExtension"), flags, 2)
        this.vtbl.get_LastRun := CallbackCreate(ObjBindMethod(implObj, "get_LastRun"), flags, 2)
        this.vtbl.get_FileNamePattern := CallbackCreate(ObjBindMethod(implObj, "get_FileNamePattern"), flags, 2)
        this.vtbl.put_FileNamePattern := CallbackCreate(ObjBindMethod(implObj, "put_FileNamePattern"), flags, 2)
        ...
        this.vtbl.AddNotification := CallbackCreate(ObjBindMethod(implObj, "AddNotification"), flags, 2)
        this.vtbl.DeleteNotification := CallbackCreate(ObjBindMethod(implObj, "DeleteNotification"), flags, 2)
        this.vtbl.ModifyNotification := CallbackCreate(ObjBindMethod(implObj, "ModifyNotification"), flags, 3)
        this.vtbl.CreateNotificationAction := CallbackCreate(ObjBindMethod(implObj, "CreateNotificationAction"), flags, 4)
        this.vtbl.EnumNotificationActions := CallbackCreate(ObjBindMethod(implObj, "EnumNotificationActions"), flags, 3)
        this.vtbl.CreatePropertyCondition := CallbackCreate(ObjBindMethod(implObj, "CreatePropertyCondition"), flags, 3)
        this.vtbl.CreateCustomAction := CallbackCreate(ObjBindMethod(implObj, "CreateCustomAction"), flags, 2)
    }
