 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nn-fsrmreports-ifsrmfilemanagementjobmanager
...
class IFsrmFileManagementJobManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjobmanager-get_actionvariables
     */
    get_ActionVariables() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjobmanager-enumfilemanagementjobs
     */
    EnumFileManagementJobs(options) {
        result := ComCall(9, this, "int", options, "ptr*", &fileManagementJobs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjobmanager-createfilemanagementjob
     */
    CreateFileManagementJob() {
        result := ComCall(10, this, "ptr*", &fileManagementJob := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjobmanager-getfilemanagementjob
     */
    GetFileManagementJob(name) {
        ...
        result := ComCall(11, this, "ptr", name, "ptr*", &fileManagementJob := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
