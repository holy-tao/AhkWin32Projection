...
class IFsrmFileScreenManager extends IDispatch{
    ...
    CreateFileScreen(path, fileScreen) {
        ...
        result := ComCall(9, this, "ptr", path, "ptr", fileScreen, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFileScreen(path, fileScreen) {
        ...
        result := ComCall(10, this, "ptr", path, "ptr", fileScreen, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumFileScreens(path, options, fileScreens) {
        ...
        result := ComCall(11, this, "ptr", path, "int", options, "ptr", fileScreens, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateFileScreenException(path, fileScreenException) {
        ...
        result := ComCall(12, this, "ptr", path, "ptr", fileScreenException, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFileScreenException(path, fileScreenException) {
        ...
        result := ComCall(13, this, "ptr", path, "ptr", fileScreenException, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumFileScreenExceptions(path, options, fileScreenExceptions) {
        ...
        result := ComCall(14, this, "ptr", path, "int", options, "ptr", fileScreenExceptions, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateFileScreenCollection(collection) {
        result := ComCall(15, this, "ptr", collection, "int")
        if(result != 0)
            throw OSError(result)
