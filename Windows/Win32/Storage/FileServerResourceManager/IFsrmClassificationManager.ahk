...
class IFsrmClassificationManager extends IDispatch{
    ...
    get_ClassificationReportFormats(formats) {
        result := ComCall(7, this, "ptr", formats, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<Int32>} logging 
     * @returns {HRESULT} 
     */
    get_Logging(logging) {
        result := ComCall(9, this, "int*", logging, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_ClassificationReportEnabled(reportEnabled) {
        result := ComCall(13, this, "ptr", reportEnabled, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_ClassificationRunningStatus(runningStatus) {
        result := ComCall(17, this, "int*", runningStatus, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumPropertyDefinitions(options, propertyDefinitions) {
        result := ComCall(18, this, "int", options, "ptr", propertyDefinitions, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreatePropertyDefinition(propertyDefinition) {
        result := ComCall(19, this, "ptr", propertyDefinition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetPropertyDefinition(propertyName, propertyDefinition) {
        ...
        result := ComCall(20, this, "ptr", propertyName, "ptr", propertyDefinition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumRules(ruleType, options, Rules) {
        result := ComCall(21, this, "int", ruleType, "int", options, "ptr", Rules, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateRule(ruleType, Rule) {
        result := ComCall(22, this, "int", ruleType, "ptr", Rule, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRule(ruleName, ruleType, Rule) {
        ...
        result := ComCall(23, this, "ptr", ruleName, "int", ruleType, "ptr", Rule, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumModuleDefinitions(moduleType, options, moduleDefinitions) {
        result := ComCall(24, this, "int", moduleType, "int", options, "ptr", moduleDefinitions, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateModuleDefinition(moduleType, moduleDefinition) {
        result := ComCall(25, this, "int", moduleType, "ptr", moduleDefinition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleDefinition(moduleName, moduleType, moduleDefinition) {
        ...
        result := ComCall(26, this, "ptr", moduleName, "int", moduleType, "ptr", moduleDefinition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RunClassification(context, reserved) {
        ...
        result := ComCall(27, this, "int", context, "ptr", reserved, "int")
        if(result != 0)
            throw OSError(result)
    ...
    WaitForClassificationCompletion(waitSeconds, completed) {
        result := ComCall(28, this, "int", waitSeconds, "ptr", completed, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumFileProperties(filePath, options, fileProperties) {
        ...
        result := ComCall(30, this, "ptr", filePath, "int", options, "ptr", fileProperties, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFileProperty(filePath, propertyName, options, property) {
        ...
        result := ComCall(31, this, "ptr", filePath, "ptr", propertyName, "int", options, "ptr", property, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetFileProperty(filePath, propertyName, propertyValue) {
        ...
        result := ComCall(32, this, "ptr", filePath, "ptr", propertyName, "ptr", propertyValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ClearFileProperty(filePath, property) {
        ...
        result := ComCall(33, this, "ptr", filePath, "ptr", property, "int")
        if(result != 0)
            throw OSError(result)
