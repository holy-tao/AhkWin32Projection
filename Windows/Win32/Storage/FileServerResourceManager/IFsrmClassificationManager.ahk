...
export default struct IFsrmClassificationManager extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ClassificationReportFormats := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationReportFormats"), flags, 2)
        this.vtbl.put_ClassificationReportFormats := CallbackCreate(ObjBindMethod(implObj, "put_ClassificationReportFormats"), flags, 2)
        ...
        this.vtbl.get_ClassificationReportMailTo := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationReportMailTo"), flags, 2)
        this.vtbl.put_ClassificationReportMailTo := CallbackCreate(ObjBindMethod(implObj, "put_ClassificationReportMailTo"), flags, 2)
        this.vtbl.get_ClassificationReportEnabled := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationReportEnabled"), flags, 2)
        this.vtbl.put_ClassificationReportEnabled := CallbackCreate(ObjBindMethod(implObj, "put_ClassificationReportEnabled"), flags, 2)
        this.vtbl.get_ClassificationLastReportPathWithoutExtension := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationLastReportPathWithoutExtension"), flags, 2)
        this.vtbl.get_ClassificationLastError := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationLastError"), flags, 2)
        this.vtbl.get_ClassificationRunningStatus := CallbackCreate(ObjBindMethod(implObj, "get_ClassificationRunningStatus"), flags, 2)
        this.vtbl.EnumPropertyDefinitions := CallbackCreate(ObjBindMethod(implObj, "EnumPropertyDefinitions"), flags, 3)
        this.vtbl.CreatePropertyDefinition := CallbackCreate(ObjBindMethod(implObj, "CreatePropertyDefinition"), flags, 2)
        this.vtbl.GetPropertyDefinition := CallbackCreate(ObjBindMethod(implObj, "GetPropertyDefinition"), flags, 3)
        this.vtbl.EnumRules := CallbackCreate(ObjBindMethod(implObj, "EnumRules"), flags, 4)
        this.vtbl.CreateRule := CallbackCreate(ObjBindMethod(implObj, "CreateRule"), flags, 3)
        this.vtbl.GetRule := CallbackCreate(ObjBindMethod(implObj, "GetRule"), flags, 4)
        this.vtbl.EnumModuleDefinitions := CallbackCreate(ObjBindMethod(implObj, "EnumModuleDefinitions"), flags, 4)
        this.vtbl.CreateModuleDefinition := CallbackCreate(ObjBindMethod(implObj, "CreateModuleDefinition"), flags, 3)
        this.vtbl.GetModuleDefinition := CallbackCreate(ObjBindMethod(implObj, "GetModuleDefinition"), flags, 4)
        this.vtbl.RunClassification := CallbackCreate(ObjBindMethod(implObj, "RunClassification"), flags, 3)
        this.vtbl.WaitForClassificationCompletion := CallbackCreate(ObjBindMethod(implObj, "WaitForClassificationCompletion"), flags, 3)
        this.vtbl.CancelClassification := CallbackCreate(ObjBindMethod(implObj, "CancelClassification"), flags, 1)
        this.vtbl.EnumFileProperties := CallbackCreate(ObjBindMethod(implObj, "EnumFileProperties"), flags, 4)
        this.vtbl.GetFileProperty := CallbackCreate(ObjBindMethod(implObj, "GetFileProperty"), flags, 5)
        this.vtbl.SetFileProperty := CallbackCreate(ObjBindMethod(implObj, "SetFileProperty"), flags, 4)
        this.vtbl.ClearFileProperty := CallbackCreate(ObjBindMethod(implObj, "ClearFileProperty"), flags, 3)
    }
