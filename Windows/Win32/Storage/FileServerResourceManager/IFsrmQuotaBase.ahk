 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nn-fsrmquota-ifsrmquotabase
...
class IFsrmQuotaBase extends IFsrmObject{
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-get_quotalimit
     */
    get_QuotaLimit() {
        quotaLimit := VARIANT()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-put_quotalimit
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-get_quotaflags
     */
    get_QuotaFlags() {
        result := ComCall(14, this, "int*", &quotaFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-put_quotaflags
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-get_thresholds
     */
    get_Thresholds() {
        result := ComCall(16, this, "ptr*", &thresholds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-addthreshold
     */
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-deletethreshold
     */
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-modifythreshold
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-createthresholdaction
     */
    CreateThresholdAction(threshold, actionType) {
        result := ComCall(20, this, "int", threshold, "int", actionType, "ptr*", &action := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotabase-enumthresholdactions
     */
    EnumThresholdActions(threshold) {
        result := ComCall(21, this, "int", threshold, "ptr*", &actions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
