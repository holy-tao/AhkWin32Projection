...
export default struct IFsrmReportJob extends IFsrmObject {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_LastGeneratedInDirectory := CallbackCreate(ObjBindMethod(implObj, "get_LastGeneratedInDirectory"), flags, 2)
        this.vtbl.EnumReports := CallbackCreate(ObjBindMethod(implObj, "EnumReports"), flags, 2)
        this.vtbl.CreateReport := CallbackCreate(ObjBindMethod(implObj, "CreateReport"), flags, 3)
