 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nn-fsrmquota-ifsrmquotaobject
...
class IFsrmQuotaObject extends IFsrmQuotaBase{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-get_path
     */
    get_Path() {
        path_ := BSTR()
        result := ComCall(22, this, "ptr", path_, "int")
        if(result != 0) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-get_usersid
     */
    get_UserSid() {
        userSid := BSTR()
     ...
     *     <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ne-winnt-well_known_sid_type">WinNULLSid</a>.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-get_useraccount
     */
    get_UserAccount() {
        userAccount := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-get_sourcetemplatename
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-get_matchessourcetemplate
     */
    get_MatchesSourceTemplate() {
        result := ComCall(26, this, "short*", &matches := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquotaobject-applytemplate
     */
