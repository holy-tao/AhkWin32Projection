 ...
 *     program identifier.
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nn-fsrm-ifsrmexportimport
...
class IFsrmExportImport extends IDispatch{
    ...
    ExportFileGroups(filePath, fileGroupNamesSafeArray, remoteHost) {
        ...
        if(remoteHost is String) {
            pin := BSTR.Alloc(remoteHost)
            remoteHost := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmexportimport-importfilegroups
     */
    ImportFileGroups(filePath, fileGroupNamesSafeArray, remoteHost) {
        ...
        result := ComCall(8, this, "ptr", filePath, "ptr", fileGroupNamesSafeArray, "ptr", remoteHost, "ptr*", &fileGroups := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} remoteHost The name of the remote server. To specify the local server, set to an empty string.
     * @returns {HRESULT} This method can return the following error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmexportimport-exportfilescreentemplates
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmexportimport-importfilescreentemplates
     */
    ImportFileScreenTemplates(filePath, templateNamesSafeArray, remoteHost) {
        ...
        result := ComCall(10, this, "ptr", filePath, "ptr", templateNamesSafeArray, "ptr", remoteHost, "ptr*", &templates := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} remoteHost The name of the remote server. To specify the local server, set to an empty string.
     * @returns {HRESULT} This method can return the following error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmexportimport-exportquotatemplates
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrm/nf-fsrm-ifsrmexportimport-importquotatemplates
     */
    ImportQuotaTemplates(filePath, templateNamesSafeArray, remoteHost) {
        ...
        result := ComCall(12, this, "ptr", filePath, "ptr", templateNamesSafeArray, "ptr", remoteHost, "ptr*", &templates := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
