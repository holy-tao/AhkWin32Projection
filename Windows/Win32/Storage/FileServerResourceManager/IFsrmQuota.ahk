 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nn-fsrmquota-ifsrmquota
...
class IFsrmQuota extends IFsrmQuotaObject{
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquota-get_quotaused
     */
    get_QuotaUsed() {
        used := VARIANT()
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquota-get_quotapeakusage
     */
    get_QuotaPeakUsage() {
        peakUsage := VARIANT()
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquota-get_quotapeakusagetime
     */
    get_QuotaPeakUsageTime() {
        result := ComCall(30, this, "double*", &peakUsageDateTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquota-resetpeakusage
     */
    ResetPeakUsage() {
     ...
     * @returns {HRESULT} The method returns the following return values.
     * @see https://learn.microsoft.com/windows/win32/api//content/fsrmquota/nf-fsrmquota-ifsrmquota-refreshusageproperties
     */
