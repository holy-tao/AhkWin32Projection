...
class IOpcRelationship extends IUnknown{
    ...
    GetId(relationshipIdentifier) {
        result := ComCall(3, this, "ptr", relationshipIdentifier, "int")
        if(result != 0)
    ...
    GetRelationshipType(relationshipType) {
        result := ComCall(4, this, "ptr", relationshipType, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceUri(sourceUri) {
        result := ComCall(5, this, "ptr", sourceUri, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetTargetUri(targetUri) {
        result := ComCall(6, this, "ptr", targetUri, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetTargetMode(targetMode) {
        result := ComCall(7, this, "int*", targetMode, "int")
        if(result != 0)
            throw OSError(result)
