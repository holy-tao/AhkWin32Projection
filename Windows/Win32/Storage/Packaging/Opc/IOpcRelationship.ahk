 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcrelationship
...
class IOpcRelationship extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationship-getid
     */
    GetId() {
        result := ComCall(3, this, "ptr*", &relationshipIdentifier := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationship-getrelationshiptype
     */
    GetRelationshipType() {
        result := ComCall(4, this, "ptr*", &relationshipType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationship-getsourceuri
     */
    GetSourceUri() {
        result := ComCall(5, this, "ptr*", &sourceUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationship-gettargeturi
     */
    GetTargetUri() {
        result := ComCall(6, this, "ptr*", &targetUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationship-gettargetmode
     */
    GetTargetMode() {
        result := ComCall(7, this, "int*", &targetMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
