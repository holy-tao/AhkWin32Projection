 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopccertificateset
...
class IOpcCertificateSet extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopccertificateset-add
     */
    Add(certificate) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopccertificateset-remove
     */
    Remove(certificate) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopccertificateset-getenumerator
     */
    GetEnumerator() {
