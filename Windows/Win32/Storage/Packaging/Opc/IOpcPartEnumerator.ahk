 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcpartenumerator
...
class IOpcPartEnumerator extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartenumerator-movenext
     */
    MoveNext() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartenumerator-moveprevious
     */
    MovePrevious() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartenumerator-getcurrent
     */
    GetCurrent() {
        result := ComCall(5, this, "ptr*", &part := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartenumerator-clone
     */
    Clone() {
