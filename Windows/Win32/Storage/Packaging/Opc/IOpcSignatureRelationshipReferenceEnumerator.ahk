 ...
 * @see https://learn.microsoft.com/windows/win32/api/msopc/nn-msopc-iopcsignaturerelationshipreferenceenumerator
 * @namespace Windows.Win32.Storage.Packaging.Opc
 */
export default struct IOpcSignatureRelationshipReferenceEnumerator extends IUnknown {
    /**
     ...
     * used for IOpcSignatureRelationshipReferenceEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IOpcSignatureRelationshipReferenceEnumerator.Vtbl()
        }
