 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcrelationshipselectorset
...
class IOpcRelationshipSelectorSet extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipselectorset-create
     */
    Create(selector, selectionCriterion) {
        ...
        result := ComCall(3, this, "int", selector, "ptr", selectionCriterion, "ptr*", &relationshipSelector := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipselectorset-delete
     */
    Delete(relationshipSelector) {
        result := ComCall(4, this, "ptr", relationshipSelector, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipselectorset-getenumerator
     */
    GetEnumerator() {
        result := ComCall(5, this, "ptr*", &relationshipSelectorEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
