...
export default struct IOpcSigningOptions extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetSignatureId := CallbackCreate(ObjBindMethod(implObj, "SetSignatureId"), flags, 2)
        this.vtbl.GetSignatureMethod := CallbackCreate(ObjBindMethod(implObj, "GetSignatureMethod"), flags, 2)
        this.vtbl.SetSignatureMethod := CallbackCreate(ObjBindMethod(implObj, "SetSignatureMethod"), flags, 2)
        this.vtbl.GetDefaultDigestMethod := CallbackCreate(ObjBindMethod(implObj, "GetDefaultDigestMethod"), flags, 2)
        this.vtbl.SetDefaultDigestMethod := CallbackCreate(ObjBindMethod(implObj, "SetDefaultDigestMethod"), flags, 2)
        this.vtbl.GetCertificateEmbeddingOption := CallbackCreate(ObjBindMethod(implObj, "GetCertificateEmbeddingOption"), flags, 2)
        this.vtbl.SetCertificateEmbeddingOption := CallbackCreate(ObjBindMethod(implObj, "SetCertificateEmbeddingOption"), flags, 2)
        ...
        this.vtbl.GetSignaturePartReferenceSet := CallbackCreate(ObjBindMethod(implObj, "GetSignaturePartReferenceSet"), flags, 2)
        this.vtbl.GetSignatureRelationshipReferenceSet := CallbackCreate(ObjBindMethod(implObj, "GetSignatureRelationshipReferenceSet"), flags, 2)
        this.vtbl.GetCustomObjectSet := CallbackCreate(ObjBindMethod(implObj, "GetCustomObjectSet"), flags, 2)
        this.vtbl.GetCustomReferenceSet := CallbackCreate(ObjBindMethod(implObj, "GetCustomReferenceSet"), flags, 2)
        this.vtbl.GetCertificateSet := CallbackCreate(ObjBindMethod(implObj, "GetCertificateSet"), flags, 2)
        this.vtbl.GetSignaturePartName := CallbackCreate(ObjBindMethod(implObj, "GetSignaturePartName"), flags, 2)
        this.vtbl.SetSignaturePartName := CallbackCreate(ObjBindMethod(implObj, "SetSignaturePartName"), flags, 2)
    }
