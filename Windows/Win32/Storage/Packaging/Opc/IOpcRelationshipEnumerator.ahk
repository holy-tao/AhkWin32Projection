 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcrelationshipenumerator
...
class IOpcRelationshipEnumerator extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipenumerator-movenext
     */
    MoveNext() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipenumerator-moveprevious
     */
    MovePrevious() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipenumerator-getcurrent
     */
    GetCurrent() {
        result := ComCall(5, this, "ptr*", &relationship := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipenumerator-clone
     */
    Clone() {
