 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcuri
...
class IOpcUri extends IUri{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcuri-getrelationshipsparturi
     */
    GetRelationshipsPartUri() {
        result := ComCall(28, this, "ptr*", &relationshipPartUri := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcuri-getrelativeuri
     */
    GetRelativeUri(targetPartUri) {
        result := ComCall(29, this, "ptr", targetPartUri, "ptr*", &relativeUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcuri-combineparturi
     */
    CombinePartUri(relativeUri) {
        result := ComCall(30, this, "ptr", relativeUri, "ptr*", &combinedUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
