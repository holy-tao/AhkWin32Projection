 ...
 */
export default struct IOpcSignatureCustomObject extends IUnknown {
    /**
     ...
     * used for IOpcSignatureCustomObject interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IOpcSignatureCustomObject.Vtbl()
        }
    ...
    Query(iid) {
        if (IOpcSignatureCustomObject.IID.Equals(iid)) {
            return true
        }
