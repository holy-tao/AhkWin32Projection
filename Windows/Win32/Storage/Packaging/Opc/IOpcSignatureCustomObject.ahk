 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcsignaturecustomobject
...
class IOpcSignatureCustomObject extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturecustomobject-getxml
     */
    GetXml(xmlMarkup, count) {
        xmlMarkupMarshal := xmlMarkup is VarRef ? "ptr*" : "ptr"
        countMarshal := count is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, xmlMarkupMarshal, xmlMarkup, countMarshal, count, "int")
        if(result != 0) {
