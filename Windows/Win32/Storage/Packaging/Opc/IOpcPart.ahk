 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcpart
...
class IOpcPart extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpart-getrelationshipset
     */
    GetRelationshipSet() {
        result := ComCall(3, this, "ptr*", &relationshipSet := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpart-getcontentstream
     */
    GetContentStream() {
        result := ComCall(4, this, "ptr*", &stream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpart-getname
     */
    GetName() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpart-getcontenttype
     */
    GetContentType() {
        result := ComCall(6, this, "ptr*", &contentType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpart-getcompressionoptions
     */
    GetCompressionOptions() {
        result := ComCall(7, this, "int*", &compressionOptions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
