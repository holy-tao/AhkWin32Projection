...
class IOpcRelationshipSet extends IUnknown{
    ...
    GetRelationship(relationshipIdentifier, relationship) {
        ...
        result := ComCall(3, this, "ptr", relationshipIdentifier, "ptr", relationship, "int")
        if(result != 0)
    ...
    CreateRelationship(relationshipIdentifier, relationshipType, targetUri, targetMode, relationship) {
        ...
        result := ComCall(4, this, "ptr", relationshipIdentifier, "ptr", relationshipType, "ptr", targetUri, "int", targetMode, "ptr", relationship, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RelationshipExists(relationshipIdentifier, relationshipExists) {
        ...
        result := ComCall(6, this, "ptr", relationshipIdentifier, "ptr", relationshipExists, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetEnumerator(relationshipEnumerator) {
        result := ComCall(7, this, "ptr", relationshipEnumerator, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetEnumeratorForType(relationshipType, relationshipEnumerator) {
        ...
        result := ComCall(8, this, "ptr", relationshipType, "ptr", relationshipEnumerator, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRelationshipsContentStream(contents) {
        result := ComCall(9, this, "ptr", contents, "int")
        if(result != 0)
            throw OSError(result)
