 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcparturi
...
class IOpcPartUri extends IOpcUri{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcparturi-compareparturi
     */
    ComparePartUri(partUri) {
        result := ComCall(31, this, "ptr", partUri, "int*", &comparisonResult := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcparturi-getsourceuri
     */
    GetSourceUri() {
        result := ComCall(32, this, "ptr*", &sourceUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcparturi-isrelationshipsparturi
     */
    IsRelationshipsPartUri() {
        result := ComCall(33, this, "int*", &isRelationshipUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
