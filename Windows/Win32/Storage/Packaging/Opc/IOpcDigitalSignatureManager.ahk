 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcdigitalsignaturemanager
...
class IOpcDigitalSignatureManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-getsignatureoriginpartname
     */
    GetSignatureOriginPartName() {
        result := ComCall(3, this, "ptr*", &signatureOriginPartName := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-setsignatureoriginpartname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-getsignatureenumerator
     */
    GetSignatureEnumerator() {
        result := ComCall(5, this, "ptr*", &signatureEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-removesignature
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-createsigningoptions
     */
    CreateSigningOptions() {
        result := ComCall(7, this, "ptr*", &signingOptions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-validate
     */
    Validate(signature, certificate) {
        result := ComCall(8, this, "ptr", signature, "ptr", certificate, "int*", &validationResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-sign
     */
    Sign(certificate, signingOptions) {
        result := ComCall(9, this, "ptr", certificate, "ptr", signingOptions, "ptr*", &digitalSignature := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcdigitalsignaturemanager-replacesignaturexml
     */
    ReplaceSignatureXml(signaturePartName, newSignatureXml, count) {
        newSignatureXmlMarshal := newSignatureXml is VarRef ? "char*" : "ptr"

        result := ComCall(10, this, "ptr", signaturePartName, newSignatureXmlMarshal, newSignatureXml, "uint", count, "ptr*", &digitalSignature := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
