 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcrelationshipselector
...
class IOpcRelationshipSelector extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipselector-getselectortype
     */
    GetSelectorType() {
        result := ComCall(3, this, "int*", &selector := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcrelationshipselector-getselectioncriterion
     */
    GetSelectionCriterion() {
        result := ComCall(4, this, "ptr*", &selectionCriterion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
