 ...
 * </Signature>
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcsignaturereference
...
class IOpcSignatureReference extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-getid
     */
    GetId() {
        result := ComCall(3, this, "ptr*", &referenceId := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-geturi
     */
    GetUri() {
        result := ComCall(4, this, "ptr*", &referenceUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-gettype
     */
    GetType() {
        result := ComCall(5, this, "ptr*", &type := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-gettransformmethod
     */
    GetTransformMethod() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-getdigestmethod
     */
    GetDigestMethod() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcsignaturereference-getdigestvalue
     */
    GetDigestValue(digestValue, count) {
        digestValueMarshal := digestValue is VarRef ? "ptr*" : "ptr"
        countMarshal := count is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, digestValueMarshal, digestValue, countMarshal, count, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
