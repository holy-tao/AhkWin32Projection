 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nn-msopc-iopcpartset
...
class IOpcPartSet extends IUnknown{
     ...
     * 
     * The <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcpart">IOpcPart</a> interface provides access to the properties of a part. For details about these properties, see the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/opc/parts-overview">Parts Overview</a> and <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcpart">IOpcPart</a>.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartset-getpart
     */
    GetPart(name) {
        result := ComCall(3, this, "ptr", name, "ptr*", &part := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartset-createpart
     */
    CreatePart(name, contentType, compressionOptions) {
        contentType := contentType is String ? StrPtr(contentType) : contentType

        result := ComCall(4, this, "ptr", name, "ptr", contentType, "int", compressionOptions, "ptr*", &part := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @remarks
     * When an  <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcpart">IOpcPart</a> interface pointer is deleted from the set, the part it represents is not serialized when the package is serialized. Additionally, if the represented part is the source of one or more relationships, those relationships are not saved with the package when the package object is written.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartset-deletepart
     */
    DeletePart(name) {
     ...
     * @remarks
     * To retrieve the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcpart">IOpcPart</a> interface pointer of the part object that represents a specific part, call the <b>PartExists</b> method and pass in the part name to confirm that the part is represented in the set. If it is, call the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcpartset-getpart">GetPart</a> method and pass in the part name to retrieve the <b>IOpcPart</b> interface pointer.
     * 
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartset-partexists
     */
    PartExists(name) {
        result := ComCall(6, this, "ptr", name, "int*", &partExists := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msopc/nf-msopc-iopcpartset-getenumerator
     */
    GetEnumerator() {
        result := ComCall(7, this, "ptr*", &partEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
