 ...
 * 
 * <div class="code"></div>
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxblockmapreader
...
class IAppxBlockMapReader extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapreader-getfile
     */
    GetFile(filename) {
        filename := filename is String ? StrPtr(filename) : filename

        result := ComCall(3, this, "ptr", filename, "ptr*", &file_ := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapreader-getfiles
     */
    GetFiles() {
        ...
        return IAppxBlockMapFilesEnumerator(enumerator_)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapreader-gethashmethod
     */
    GetHashMethod() {
        result := ComCall(5, this, "ptr*", &hashMethod := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapreader-getstream
     */
    GetStream() {
        result := ComCall(6, this, "ptr*", &blockMapStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
