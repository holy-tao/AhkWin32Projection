 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxmanifestpackageid2
...
class IAppxManifestPackageId2 extends IAppxManifestPackageId{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxmanifestpackageid2-getarchitecture2
     */
    GetArchitecture2() {
        result := ComCall(11, this, "int*", &architecture_ := 0, "int")
        if(result != 0) {
