...
#Import ".\IAppxManifestQualifiedResource.ahk" { IAppxManifestQualifiedResource }

/**
 * @namespace Windows.Win32.Storage.Packaging.Appx
 */
export default struct IAppxManifestQualifiedResourcesEnumerator extends IUnknown {
    /**
     ...
     * used for IAppxManifestQualifiedResourcesEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxManifestQualifiedResourcesEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IAppxManifestQualifiedResourcesEnumerator.IID.Equals(iid)) {
            return true
        }
