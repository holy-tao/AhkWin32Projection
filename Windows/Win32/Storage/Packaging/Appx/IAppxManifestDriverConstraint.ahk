 ...
 */
export default struct IAppxManifestDriverConstraint extends IUnknown {
    /**
     ...
     * used for IAppxManifestDriverConstraint interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxManifestDriverConstraint.Vtbl()
        }
     ...
     */
    GetMinDate() {
        result := ComCall(5, this, PWSTR.Ptr, &minDate := 0, "HRESULT")
        return minDate
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetMinDate)
    }
}
