 ...
 */
export default struct IAppxContentGroupMapReader extends IUnknown {
    /**
     ...
     * used for IAppxContentGroupMapReader interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxContentGroupMapReader.Vtbl()
        }
    ...
    Query(iid) {
        if (IAppxContentGroupMapReader.IID.Equals(iid)) {
            return true
        }
