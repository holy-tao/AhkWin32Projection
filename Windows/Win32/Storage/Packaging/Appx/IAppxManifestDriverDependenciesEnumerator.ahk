...
#Import ".\IAppxManifestDriverDependency.ahk" { IAppxManifestDriverDependency }
 ...
 */
export default struct IAppxManifestDriverDependenciesEnumerator extends IUnknown {
    /**
     ...
     * used for IAppxManifestDriverDependenciesEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxManifestDriverDependenciesEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IAppxManifestDriverDependenciesEnumerator.IID.Equals(iid)) {
            return true
        }
