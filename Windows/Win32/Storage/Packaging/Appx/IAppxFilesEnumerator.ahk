 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxfilesenumerator
...
class IAppxFilesEnumerator extends IUnknown{
     ...
     * @returns {IAppxFile} 
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxfilesenumerator-getcurrent
     */
    GetCurrent() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxfilesenumerator-gethascurrent
     */
    GetHasCurrent() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxfilesenumerator-movenext
     */
    MoveNext() {
