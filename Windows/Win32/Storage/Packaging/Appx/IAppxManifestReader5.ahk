 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxmanifestreader5
...
class IAppxManifestReader5 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxmanifestreader5-getmainpackagedependencies
     */
    GetMainPackageDependencies() {
        result := ComCall(3, this, "ptr*", &mainPackageDependencies := 0, "int")
        if(result != 0) {
