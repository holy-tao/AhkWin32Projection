 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxmanifestpackagedependency2
...
class IAppxManifestPackageDependency2 extends IAppxManifestPackageDependency{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxmanifestpackagedependency2-getmaxmajorversiontested
     */
    GetMaxMajorVersionTested() {
        result := ComCall(6, this, "ushort*", &maxMajorVersionTested := 0, "int")
        if(result != 0) {
