...
#Import ".\IAppxManifestDriverConstraint.ahk" { IAppxManifestDriverConstraint }
 ...
 */
export default struct IAppxManifestDriverConstraintsEnumerator extends IUnknown {
    /**
     ...
     * used for IAppxManifestDriverConstraintsEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxManifestDriverConstraintsEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IAppxManifestDriverConstraintsEnumerator.IID.Equals(iid)) {
            return true
        }
