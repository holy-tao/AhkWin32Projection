 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxcontentgroupsenumerator
...
class IAppxContentGroupsEnumerator extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxcontentgroupsenumerator-getcurrent
     */
    GetCurrent() {
        result := ComCall(3, this, "ptr*", &stream := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxcontentgroupsenumerator-gethascurrent
     */
    GetHasCurrent() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxcontentgroupsenumerator-movenext
     */
    MoveNext() {
