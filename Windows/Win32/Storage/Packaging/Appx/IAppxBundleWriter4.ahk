 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxbundlewriter4
...
class IAppxBundleWriter4 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxbundlewriter4-addpayloadpackage
     */
     ...
     * @param {BOOL} isDefaultApplicablePackage A flag for whether this package is a default applicable package.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxbundlewriter4-addpackagereference
     */
     ...
     * @param {BOOL} isDefaultApplicablePackage A flag for whether this package is a default applicable package.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxbundlewriter4-addexternalpackagereference
     */
