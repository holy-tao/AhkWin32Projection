 ...
 */
export default struct IAppxBundleReader2 extends IUnknown {
    /**
     ...
     * used for IAppxBundleReader2 interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetPayloadPackageReader : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxBundleReader2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetPayloadPackageReader)
    }
}
