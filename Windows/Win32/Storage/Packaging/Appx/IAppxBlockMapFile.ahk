 ...
 * 
 * <div class="code"></div>
 * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nn-appxpackaging-iappxblockmapfile
...
class IAppxBlockMapFile extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapfile-getblocks
     */
    GetBlocks() {
        result := ComCall(3, this, "ptr*", &blocks := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapfile-getlocalfileheadersize
     */
    GetLocalFileHeaderSize() {
        result := ComCall(4, this, "uint*", &lfhSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapfile-getname
     */
    GetName() {
        result := ComCall(5, this, "ptr*", &name := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapfile-getuncompressedsize
     */
    GetUncompressedSize() {
        result := ComCall(6, this, "uint*", &size_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/appxpackaging/nf-appxpackaging-iappxblockmapfile-validatefilehash
     */
    ValidateFileHash(fileStream) {
        result := ComCall(7, this, "ptr", fileStream, "int*", &isValid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
