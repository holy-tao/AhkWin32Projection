 ...
 */
export default struct IAppxManifestPackageDependenciesEnumerator extends IUnknown {
    /**
     ...
     * used for IAppxManifestPackageDependenciesEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppxManifestPackageDependenciesEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IAppxManifestPackageDependenciesEnumerator.IID.Equals(iid)) {
            return true
        }
