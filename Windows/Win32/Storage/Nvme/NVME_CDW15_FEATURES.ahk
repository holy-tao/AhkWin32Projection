 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/nvme/ns-nvme-nvme_cdw15_features
...
class NVME_CDW15_FEATURES extends Win32Struct
{
     ...
     * @type {NVME_CDW15_FEATURE_HOST_MEMORY_BUFFER}
     */
    HostMemoryBuffer{
        get {
            if(!this.HasProp("__HostMemoryBuffer"))
                this.__HostMemoryBuffer := NVME_CDW15_FEATURE_HOST_MEMORY_BUFFER(0, this)
