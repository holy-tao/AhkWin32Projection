...
class NVME_NVM_COMMANDS extends Win32Enum {
     ...
     * Native name: NVME_NVM_COMMAND_FLUSH
     * @type {Integer (Int32)}
     */
     ...
     * Native name: NVME_NVM_COMMAND_WRITE
     * @type {Integer (Int32)}
     */
    static COMMAND_WRITE => 1
     ...
     * 
     * The command uses Command Dword 10, Command Dword 11, Command Dword 12, Command Dword 13, Command Dword 14, and Command Dword 15 fields. If the command uses PRPs for the data transfer, then the Metadata Pointer, PRP Entry 1, and PRP Entry 2 fields are used. If the command uses SGLs for the data transfer, then the Metadata SGL Segment Pointer and SGL Entry 1 fields are used.
     * Native name: NVME_NVM_COMMAND_READ
     * @type {Integer (Int32)}
     */
    static COMMAND_READ => 2
     ...
     * Native name: NVME_NVM_COMMAND_WRITE_UNCORRECTABLE
     * @type {Integer (Int32)}
     */
    static COMMAND_WRITE_UNCORRECTABLE => 4
     ...
     * Native name: NVME_NVM_COMMAND_COMPARE
     * @type {Integer (Int32)}
     */
    static COMMAND_COMPARE => 5
     ...
     * Native name: NVME_NVM_COMMAND_WRITE_ZEROES
     * @type {Integer (Int32)}
     */
    static COMMAND_WRITE_ZEROES => 8
     ...
     * Native name: NVME_NVM_COMMAND_DATASET_MANAGEMENT
     * @type {Integer (Int32)}
     */
    static COMMAND_DATASET_MANAGEMENT => 9

    /**
     * Native name: NVME_NVM_COMMAND_VERIFY
     * @type {Integer (Int32)}
     */
    static COMMAND_VERIFY => 12
     ...
     * Native name: NVME_NVM_COMMAND_RESERVATION_REGISTER
     * @type {Integer (Int32)}
     */
    static COMMAND_RESERVATION_REGISTER => 13
     ...
     * Native name: NVME_NVM_COMMAND_RESERVATION_REPORT
     * @type {Integer (Int32)}
     */
    static COMMAND_RESERVATION_REPORT => 14
     ...
     * Native name: NVME_NVM_COMMAND_RESERVATION_ACQUIRE
     * @type {Integer (Int32)}
     */
    static COMMAND_RESERVATION_ACQUIRE => 17
     ...
     * Native name: NVME_NVM_COMMAND_RESERVATION_RELEASE
     * @type {Integer (Int32)}
     */
    static COMMAND_RESERVATION_RELEASE => 21

    /**
     * Native name: NVME_NVM_COMMAND_COPY
     * @type {Integer (Int32)}
     */
    static COMMAND_COPY => 25

    /**
     * Native name: NVME_NVM_COMMAND_ZONE_MANAGEMENT_SEND
     * @type {Integer (Int32)}
     */
    static COMMAND_ZONE_MANAGEMENT_SEND => 121

    /**
     * Native name: NVME_NVM_COMMAND_ZONE_MANAGEMENT_RECEIVE
     * @type {Integer (Int32)}
     */
    static COMMAND_ZONE_MANAGEMENT_RECEIVE => 122

    /**
     * Native name: NVME_NVM_COMMAND_ZONE_APPEND
     * @type {Integer (Int32)}
     */
    static COMMAND_ZONE_APPEND => 125
}
