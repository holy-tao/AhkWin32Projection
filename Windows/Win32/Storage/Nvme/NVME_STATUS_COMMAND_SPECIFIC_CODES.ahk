...
class NVME_STATUS_COMMAND_SPECIFIC_CODES extends Win32Enum {
     ...
     * Native name: NVME_STATUS_COMPLETION_QUEUE_INVALID
     * @type {Integer (Int32)}
     */
    static COMPLETION_QUEUE_INVALID => 0
     ...
     * Native name: NVME_STATUS_INVALID_QUEUE_IDENTIFIER
     * @type {Integer (Int32)}
     */
    static INVALID_QUEUE_IDENTIFIER => 1
     ...
     * Native name: NVME_STATUS_MAX_QUEUE_SIZE_EXCEEDED
     * @type {Integer (Int32)}
     */
    static MAX_QUEUE_SIZE_EXCEEDED => 2
     ...
     * Native name: NVME_STATUS_ABORT_COMMAND_LIMIT_EXCEEDED
     * @type {Integer (Int32)}
     */
    static ABORT_COMMAND_LIMIT_EXCEEDED => 3

    /**
     * The number of concurrently outstanding Asynchronous Event Request commands has been exceeded.
     * Native name: NVME_STATUS_ASYNC_EVENT_REQUEST_LIMIT_EXCEEDED
     * @type {Integer (Int32)}
     */
    static ASYNC_EVENT_REQUEST_LIMIT_EXCEEDED => 5
     ...
     * Native name: NVME_STATUS_INVALID_FIRMWARE_SLOT
     * @type {Integer (Int32)}
     */
    static INVALID_FIRMWARE_SLOT => 6

    /**
     * The firmware image specified for activation in the Firmware Commit command is invalid and not loaded by the controller.
     * Native name: NVME_STATUS_INVALID_FIRMWARE_IMAGE
     * @type {Integer (Int32)}
     */
    static INVALID_FIRMWARE_IMAGE => 7
     ...
     * Native name: NVME_STATUS_INVALID_INTERRUPT_VECTOR
     * @type {Integer (Int32)}
     */
    static INVALID_INTERRUPT_VECTOR => 8
     ...
     * Native name: NVME_STATUS_INVALID_LOG_PAGE
     * @type {Integer (Int32)}
     */
    static INVALID_LOG_PAGE => 9
     ...
     * Native name: NVME_STATUS_INVALID_FORMAT
     * @type {Integer (Int32)}
     */
    static INVALID_FORMAT => 10
     ...
     * Native name: NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_CONVENTIONAL_RESET
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_REQUIRES_CONVENTIONAL_RESET => 11
     ...
     * Native name: NVME_STATUS_INVALID_QUEUE_DELETION
     * @type {Integer (Int32)}
     */
    static INVALID_QUEUE_DELETION => 12

    /**
     * The Feature Identifier specified in the Set Features command does not support a saveable value.
     * Native name: NVME_STATUS_FEATURE_ID_NOT_SAVEABLE
     * @type {Integer (Int32)}
     */
    static FEATURE_ID_NOT_SAVEABLE => 13

    /**
     * The Feature Identifier specified in the Set Features command may not be changed.
     * Native name: NVME_STATUS_FEATURE_NOT_CHANGEABLE
     * @type {Integer (Int32)}
     */
    static FEATURE_NOT_CHANGEABLE => 14
     ...
     * Native name: NVME_STATUS_FEATURE_NOT_NAMESPACE_SPECIFIC
     * @type {Integer (Int32)}
     */
    static FEATURE_NOT_NAMESPACE_SPECIFIC => 15

    /**
     * Indicates status for the Firmware Commit command.
     * Native name: NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_NVM_SUBSYSTEM_RESET
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_REQUIRES_NVM_SUBSYSTEM_RESET => 16
     ...
     * Native name: NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_RESET
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_REQUIRES_RESET => 17
     ...
     * Native name: NVME_STATUS_FIRMWARE_ACTIVATION_REQUIRES_MAX_TIME_VIOLATION
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_REQUIRES_MAX_TIME_VIOLATION => 18
     ...
     * Native name: NVME_STATUS_FIRMWARE_ACTIVATION_PROHIBITED
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_PROHIBITED => 19
     ...
     * Native name: NVME_STATUS_OVERLAPPING_RANGE
     * @type {Integer (Int32)}
     */
    static OVERLAPPING_RANGE => 20
     ...
     * Native name: NVME_STATUS_NAMESPACE_INSUFFICIENT_CAPACITY
     * @type {Integer (Int32)}
     */
    static NAMESPACE_INSUFFICIENT_CAPACITY => 21

    /**
     * Indicates the following status for the Namespace Management command:
     * 
     * The number of namespaces supported has been exceeded.
     * Native name: NVME_STATUS_NAMESPACE_IDENTIFIER_UNAVAILABLE
     * @type {Integer (Int32)}
     */
    static NAMESPACE_IDENTIFIER_UNAVAILABLE => 22
     ...
     * Native name: NVME_STATUS_NAMESPACE_ALREADY_ATTACHED
     * @type {Integer (Int32)}
     */
    static NAMESPACE_ALREADY_ATTACHED => 24
     ...
     * Native name: NVME_STATUS_NAMESPACE_IS_PRIVATE
     * @type {Integer (Int32)}
     */
    static NAMESPACE_IS_PRIVATE => 25

    /**
     * Indicates the following status for the Namespace Attachment command:
     * 
     * The controller is not attached to the namespace. The request to detach the controller could not be completed.
     * Native name: NVME_STATUS_NAMESPACE_NOT_ATTACHED
     * @type {Integer (Int32)}
     */
    static NAMESPACE_NOT_ATTACHED => 26

    /**
     * Native name: NVME_STATUS_NAMESPACE_THIN_PROVISIONING_NOT_SUPPORTED
     * @type {Integer (Int32)}
     */
    static NAMESPACE_THIN_PROVISIONING_NOT_SUPPORTED => 27

    /**
     * Indicates the following status for the Namespace Attachment command:
     * 
     * The controller list provided is invalid.
     * Native name: NVME_STATUS_CONTROLLER_LIST_INVALID
     * @type {Integer (Int32)}
     */
    static CONTROLLER_LIST_INVALID => 28

    /**
     * Indicates status for the Device Self-test command.
     * Native name: NVME_STATUS_DEVICE_SELF_TEST_IN_PROGRESS
     * @type {Integer (Int32)}
     */
    static DEVICE_SELF_TEST_IN_PROGRESS => 29

    /**
     * Indicates status for the Firmware Commit command.
     * Native name: NVME_STATUS_BOOT_PARTITION_WRITE_PROHIBITED
     * @type {Integer (Int32)}
     */
    static BOOT_PARTITION_WRITE_PROHIBITED => 30

    /**
     * Indicates status for the Virtualization Management command.
     * Native name: NVME_STATUS_INVALID_CONTROLLER_IDENTIFIER
     * @type {Integer (Int32)}
     */
    static INVALID_CONTROLLER_IDENTIFIER => 31

    /**
     * Indicates status for the Virtualization Management command
     * Native name: NVME_STATUS_INVALID_SECONDARY_CONTROLLER_STATE
     * @type {Integer (Int32)}
     */
    static INVALID_SECONDARY_CONTROLLER_STATE => 32

    /**
     * Indicates status for the Virtualization Management command.
     * Native name: NVME_STATUS_INVALID_NUMBER_OF_CONTROLLER_RESOURCES
     * @type {Integer (Int32)}
     */
    static INVALID_NUMBER_OF_CONTROLLER_RESOURCES => 33

    /**
     * Indicates status for the Virtualization Management command.
     * Native name: NVME_STATUS_INVALID_RESOURCE_IDENTIFIER
     * @type {Integer (Int32)}
     */
    static INVALID_RESOURCE_IDENTIFIER => 34

    /**
     * Native name: NVME_STATUS_SANITIZE_PROHIBITED_ON_PERSISTENT_MEMORY
     * @type {Integer (Int32)}
     */
    static SANITIZE_PROHIBITED_ON_PERSISTENT_MEMORY => 35

    /**
     * Native name: NVME_STATUS_INVALID_ANA_GROUP_IDENTIFIER
     * @type {Integer (Int32)}
     */
    static INVALID_ANA_GROUP_IDENTIFIER => 36

    /**
     * Native name: NVME_STATUS_ANA_ATTACH_FAILED
     * @type {Integer (Int32)}
     */
    static ANA_ATTACH_FAILED => 37

    /**
     * Native name: NVME_STATUS_INSUFFICIENT_CAPACITY
     * @type {Integer (Int32)}
     */
    static INSUFFICIENT_CAPACITY => 38

    /**
     * Native name: NVME_STATUS_NAMESPACE_ATTACHMENT_LIMIT_EXCEEDED
     * @type {Integer (Int32)}
     */
    static NAMESPACE_ATTACHMENT_LIMIT_EXCEEDED => 39

    /**
     * Native name: NVME_STATUS_PROHIBITION_NOT_SUPPORTED
     * @type {Integer (Int32)}
     */
    static PROHIBITION_NOT_SUPPORTED => 40

    /**
     * Native name: NVME_IO_COMMAND_SET_NOT_SUPPORTED
     * @type {Integer (Int32)}
     */
    static IO_COMMAND_SET_NOT_SUPPORTED => 41

    /**
     * Native name: NVME_IO_COMMAND_SET_NOT_ENABLED
     * @type {Integer (Int32)}
     */
    static IO_COMMAND_SET_NOT_ENABLED => 42

    /**
     * Native name: NVME_IO_COMMAND_SET_COMBINATION_REJECTED
     * @type {Integer (Int32)}
     */
    static IO_COMMAND_SET_COMBINATION_REJECTED => 43

    /**
     * Native name: NVME_IO_COMMAND_SET_INVALID
     * @type {Integer (Int32)}
     */
    static IO_COMMAND_SET_INVALID => 44

    /**
     * Native name: NVME_STATUS_INVALID_DISCOVERY_INFORMATION
     * @type {Integer (Int32)}
     */
    static INVALID_DISCOVERY_INFORMATION => 47

    /**
     * Native name: NVME_STATUS_INSUFFICIENT_DISCOVERY_RESOURCES
     * @type {Integer (Int32)}
     */
    static INSUFFICIENT_DISCOVERY_RESOURCES => 50

    /**
     * Indicates status for the Streams Directive command.
     * Native name: NVME_STATUS_STREAM_RESOURCE_ALLOCATION_FAILED
     * @type {Integer (Int32)}
     */
    static STREAM_RESOURCE_ALLOCATION_FAILED => 127

    /**
     * Native name: NVME_STATUS_ZONE_INVALID_FORMAT
     * @type {Integer (Int32)}
     */
    static ZONE_INVALID_FORMAT => 127
     ...
     * Native name: NVME_STATUS_NVM_CONFLICTING_ATTRIBUTES
     * @type {Integer (Int32)}
     */
    static NVM_CONFLICTING_ATTRIBUTES => 128
     ...
     * Native name: NVME_STATUS_NVM_INVALID_PROTECTION_INFORMATION
     * @type {Integer (Int32)}
     */
    static NVM_INVALID_PROTECTION_INFORMATION => 129
     ...
     * Native name: NVME_STATUS_NVM_ATTEMPTED_WRITE_TO_READ_ONLY_RANGE
     * @type {Integer (Int32)}
     */
    static NVM_ATTEMPTED_WRITE_TO_READ_ONLY_RANGE => 130

    /**
     * Native name: NVME_STATUS_NVM_COMMAND_SIZE_LIMIT_EXCEEDED
     * @type {Integer (Int32)}
     */
    static NVM_COMMAND_SIZE_LIMIT_EXCEEDED => 131

    /**
     * Native name: NVME_STATUS_ZONE_BOUNDARY_ERROR
     * @type {Integer (Int32)}
     */
    static ZONE_BOUNDARY_ERROR => 184

    /**
     * Native name: NVME_STATUS_ZONE_FULL
     * @type {Integer (Int32)}
     */
    static ZONE_FULL => 185

    /**
     * Native name: NVME_STATUS_ZONE_READ_ONLY
     * @type {Integer (Int32)}
     */
    static ZONE_READ_ONLY => 186

    /**
     * Native name: NVME_STATUS_ZONE_OFFLINE
     * @type {Integer (Int32)}
     */
    static ZONE_OFFLINE => 187

    /**
     * Native name: NVME_STATUS_ZONE_INVALID_WRITE
     * @type {Integer (Int32)}
     */
    static ZONE_INVALID_WRITE => 188

    /**
     * Native name: NVME_STATUS_ZONE_TOO_MANY_ACTIVE
     * @type {Integer (Int32)}
     */
    static ZONE_TOO_MANY_ACTIVE => 189

    /**
     * Native name: NVME_STATUS_ZONE_TOO_MANY_OPEN
     * @type {Integer (Int32)}
     */
    static ZONE_TOO_MANY_OPEN => 190

    /**
     * Native name: NVME_STATUS_ZONE_INVALID_STATE_TRANSITION
     * @type {Integer (Int32)}
     */
    static ZONE_INVALID_STATE_TRANSITION => 191
}
