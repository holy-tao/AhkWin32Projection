...
class NVME_ASYNC_EVENT_NOTICE_CODES extends Win32Enum {
     ...
     * Native name: NVME_ASYNC_NOTICE_NAMESPACE_ATTRIBUTE_CHANGED
     * @type {Integer (Int32)}
     */
    static NAMESPACE_ATTRIBUTE_CHANGED => 0
     ...
     * Native name: NVME_ASYNC_NOTICE_FIRMWARE_ACTIVATION_STARTING
     * @type {Integer (Int32)}
     */
    static FIRMWARE_ACTIVATION_STARTING => 1
     ...
     * Native name: NVME_ASYNC_NOTICE_TELEMETRY_LOG_CHANGED
     * @type {Integer (Int32)}
     */
    static TELEMETRY_LOG_CHANGED => 2

    /**
     * Native name: NVME_ASYNC_NOTICE_ASYMMETRIC_ACCESS_CHANGE
     * @type {Integer (Int32)}
     */
    static ASYMMETRIC_ACCESS_CHANGE => 3

    /**
     * Native name: NVME_ASYNC_NOTICE_PREDICTABLE_LATENCY_EVENT_AGGREGATE_LOG_CHANGE
     * @type {Integer (Int32)}
     */
    static PREDICTABLE_LATENCY_EVENT_AGGREGATE_LOG_CHANGE => 4

    /**
     * Native name: NVME_ASYNC_NOTICE_LBA_STATUS_INFORMATION_ALERT
     * @type {Integer (Int32)}
     */
    static LBA_STATUS_INFORMATION_ALERT => 5

    /**
     * Native name: NVME_ASYNC_NOTICE_ENDURANCE_GROUP_EVENT_AGGREGATE_LOG_CHANGE
     * @type {Integer (Int32)}
     */
    static ENDURANCE_GROUP_EVENT_AGGREGATE_LOG_CHANGE => 6

    /**
     * Native name: NVME_ASYNC_NOTICE_ZONE_DESCRIPTOR_CHANGED
     * @type {Integer (Int32)}
     */
    static ZONE_DESCRIPTOR_CHANGED => 239

    /**
     * Native name: NVME_ASYNC_NOTICE_DISCOVERY_LOG_PAGE_CHANGED
     * @type {Integer (Int32)}
     */
    static DISCOVERY_LOG_PAGE_CHANGED => 240
}
