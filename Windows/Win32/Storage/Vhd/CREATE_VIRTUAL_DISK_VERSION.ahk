...
class CREATE_VIRTUAL_DISK_VERSION extends Win32Enum {
    ...
    /**
     * Not supported.
     * Native name: CREATE_VIRTUAL_DISK_VERSION_UNSPECIFIED
     * @type {Integer (Int32)}
     */
     ...
     * Native name: CREATE_VIRTUAL_DISK_VERSION_1
     * @type {Integer (Int32)}
     */
    static 1 => 1
     ...
     * Native name: CREATE_VIRTUAL_DISK_VERSION_2
     * @type {Integer (Int32)}
     */
    static 2 => 2

    /**
     * Native name: CREATE_VIRTUAL_DISK_VERSION_3
     * @type {Integer (Int32)}
     */
    static 3 => 3

    /**
     * Native name: CREATE_VIRTUAL_DISK_VERSION_4
     * @type {Integer (Int32)}
     */
    static 4 => 4
}
