 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/virtdisk/ne-virtdisk-merge_virtual_disk_version
 * @namespace Windows.Win32.Storage.Vhd
 * @version v4.0.30319
 */
class MERGE_VIRTUAL_DISK_VERSION extends Win32Enum{
