 ...
 */
class RESIZE_VIRTUAL_DISK_FLAG extends Win32BitflagEnum {

    /**
     * No flags are specified.
     * Native name: RESIZE_VIRTUAL_DISK_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: RESIZE_VIRTUAL_DISK_FLAG_ALLOW_UNSAFE_VIRTUAL_SIZE
     * @type {Integer (Int32)}
     */
    static ALLOW_UNSAFE_VIRTUAL_SIZE => 1
     ...
     * Native name: RESIZE_VIRTUAL_DISK_FLAG_RESIZE_TO_SMALLEST_SAFE_VIRTUAL_SIZE
     * @type {Integer (Int32)}
     */
    static RESIZE_TO_SMALLEST_SAFE_VIRTUAL_SIZE => 2
}
