 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nn-ehstorapi-ienhancedstorageact
...
class IEnhancedStorageACT extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-authorize
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-unauthorize
     */
    Unauthorize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-getauthorizationstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-getmatchingvolume
     */
    GetMatchingVolume() {
        result := ComCall(6, this, "ptr*", &ppwszVolume := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-getuniqueidentity
     */
    GetUniqueIdentity() {
        result := ComCall(7, this, "ptr*", &ppwszIdentity := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstorageact-getsilos
     */
    GetSilos(pppIEnhancedStorageSilos, pcEnhancedStorageSilos) {
        ...
        result := ComCall(8, this, pppIEnhancedStorageSilosMarshal, pppIEnhancedStorageSilos, pcEnhancedStorageSilosMarshal, pcEnhancedStorageSilos, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
