 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nn-ehstorapi-ienumenhancedstorageact
...
class IEnumEnhancedStorageACT extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienumenhancedstorageact-getacts
     */
    GetACTs(pppIEnhancedStorageACTs, pcEnhancedStorageACTs) {
        ...
        result := ComCall(3, this, pppIEnhancedStorageACTsMarshal, pppIEnhancedStorageACTs, pcEnhancedStorageACTsMarshal, pcEnhancedStorageACTs, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienumenhancedstorageact-getmatchingact
     */
    GetMatchingACT(szVolume) {
        szVolume := szVolume is String ? StrPtr(szVolume) : szVolume

        result := ComCall(4, this, "ptr", szVolume, "ptr*", &ppIEnhancedStorageACT := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
