 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nn-ehstorapi-ienhancedstoragesilo
...
class IEnhancedStorageSilo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getinfo
     */
    GetInfo() {
        pSiloInfo := SILO_INFO()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getactions
     */
    GetActions(pppIEnhancedStorageSiloActions, pcEnhancedStorageSiloActions) {
        ...
        result := ComCall(4, this, pppIEnhancedStorageSiloActionsMarshal, pppIEnhancedStorageSiloActions, pcEnhancedStorageSiloActionsMarshal, pcEnhancedStorageSiloActions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-sendcommand
     */
    SendCommand(Command, pbCommandBuffer, cbCommandBuffer, pcbResponseBuffer) {
        ...
        result := ComCall(5, this, "char", Command, pbCommandBufferMarshal, pbCommandBuffer, "uint", cbCommandBuffer, "char*", &pbResponseBuffer := 0, pcbResponseBufferMarshal, pcbResponseBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getportabledevice
     */
    GetPortableDevice() {
        result := ComCall(6, this, "ptr*", &ppIPortableDevice := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getdevicepath
     */
    GetDevicePath() {
        result := ComCall(7, this, "ptr*", &ppwszSiloDevicePath := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
