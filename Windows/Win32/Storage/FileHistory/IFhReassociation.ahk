 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nn-fhcfg-ifhreassociation
...
class IFhReassociation extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nf-fhcfg-ifhreassociation-validatetarget
     */
    ValidateTarget(TargetUrl) {
        ...
        result := ComCall(3, this, "ptr", TargetUrl, "int*", &ValidationResult := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nf-fhcfg-ifhreassociation-scantargetforconfigurations
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nf-fhcfg-ifhreassociation-getconfigurationdetails
     */
     ...
     * 
     * If there is no File History configuration with the specified index, the <c>HRESULT_FROM_WIN32(ERROR_NOT_FOUND)</c> error code is returned.
     * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nf-fhcfg-ifhreassociation-selectconfiguration
     */
     ...
     * @returns {HRESULT} <b>S_OK</b> on success, or an unsuccessful <b>HRESULT</b> value on failure. Possible unsuccessful <b>HRESULT</b> values include values defined in the FhErrors.h header file.
     * @see https://learn.microsoft.com/windows/win32/api//content/fhcfg/nf-fhcfg-ifhreassociation-performreassociation
     */
