 ...
 */
export default struct LPDRVCALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is LPDRVCALLBACK) {
    ...
    /**
     * A LPDRVCALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPDRVCALLBACK {
        /**
         * Creates a LPDRVCALLBACK pointer that invokes the given AHK function when called.
