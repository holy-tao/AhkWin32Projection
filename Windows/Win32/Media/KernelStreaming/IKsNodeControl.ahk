 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nn-vidcap-iksnodecontrol
...
class IKsNodeControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-iksnodecontrol-put_nodeid
     */
    put_NodeId(dwNodeId) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-iksnodecontrol-put_kscontrol
     */
    put_KsControl(pKsControl) {
        pKsControlMarshal := pKsControl is VarRef ? "ptr" : "ptr"

        result := ComCall(4, this, pKsControlMarshal, pKsControl, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
