 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/ikspropertyset
...
class IKsPropertySet extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/ikspropertyset-set
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/ikspropertyset-get
     */
    Get(guidPropSet, dwPropID, pInstanceData, cbInstanceData, pPropData, cbPropData) {
        result := ComCall(4, this, "ptr", guidPropSet, "uint", dwPropID, "ptr", pInstanceData, "uint", cbInstanceData, "ptr", pPropData, "uint", cbPropData, "uint*", &pcbReturned := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/ikspropertyset-querysupported
     */
    QuerySupported(guidPropSet, dwPropID) {
        result := ComCall(5, this, "ptr", guidPropSet, "uint", dwPropID, "uint*", &pTypeSupport := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
