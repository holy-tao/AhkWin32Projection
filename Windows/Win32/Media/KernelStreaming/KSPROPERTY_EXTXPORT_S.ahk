 ...
 */
export default struct KSPROPERTY_EXTXPORT_S {
    #StructPack 8
    ...
    struct _u {
        ...
        static __New() {
            ...
            DefineProp(this.Prototype, 'Timecode', { type: KSPROPERTY_EXTXPORT_S._u._Timecode, offset: 0 })
            DefineProp(this.Prototype, 'dwTimecode', { type: UInt32, offset: 0 })
            DefineProp(this.Prototype, 'dwAbsTrackNumber', { type: UInt32, offset: 0 })
            DefineProp(this.Prototype, 'RawAVC', { type: KSPROPERTY_EXTXPORT_S._u._RawAVC, offset: 0 })
