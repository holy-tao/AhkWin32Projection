...
class IKsPinPipe extends IUnknown{
     ...
     * @param {Pointer<Int32>} FramingProp 
     * @param {Integer} Option 
     * @returns {HRESULT} 
     */
    KsGetPinFramingCache(FramingEx, FramingProp, Option) {
        result := ComCall(3, this, "ptr", FramingEx, "int*", FramingProp, "int", Option, "int")
        if(result != 0)
    ...
    KsSetPinFramingCache(FramingEx, FramingProp, Option) {
        result := ComCall(4, this, "ptr", FramingEx, "int*", FramingProp, "int", Option, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @returns {Pointer<IKsAllocatorEx>} 
     */
    KsGetPipe(Operation) {
    ...
    /**
     * 
     * @param {Pointer<IKsAllocatorEx>} KsAllocator 
     * @returns {HRESULT} 
     */
