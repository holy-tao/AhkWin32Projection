 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-iksformatsupport
...
class IKsFormatSupport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iksformatsupport-isformatsupported
     */
    IsFormatSupported(pKsFormat, cbFormat) {
        result := ComCall(3, this, "ptr", pKsFormat, "uint", cbFormat, "int*", &pbSupported := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iksformatsupport-getdevicepreferredformat
     */
    GetDevicePreferredFormat() {
        result := ComCall(4, this, "ptr*", &ppKsFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
