 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpremotemediaservices
...
class IWMPRemoteMediaServices extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpremotemediaservices-getservicetype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpremotemediaservices-getapplicationname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpremotemediaservices-getscriptableobject
     */
    GetScriptableObject(pbstrName) {
        result := ComCall(5, this, "ptr", pbstrName, "ptr*", &ppDispatch := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpremotemediaservices-getcustomuimode
     */
