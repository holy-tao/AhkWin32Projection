 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpevents3
...
class IWMPEvents3 extends IWMPEvents2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-cdromripstatechange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-cdromripmediaerror
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-cdromburnstatechange
     */
     ...
     * @param {IDispatch} pMedia Pointer to the <b>IDispatch</b> interface that represents the media item that raised the error. Call <b>QueryInterface</b> through this pointer to retrieve a pointer to <b>IWMPMedia</b>.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-cdromburnmediaerror
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-cdromburnerror
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-libraryconnect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-librarydisconnect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-folderscanstatechange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-stringcollectionchange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-mediacollectionmediaadded
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents3-mediacollectionmediaremoved
     */
