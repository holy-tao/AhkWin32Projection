...
class IWMPMediaCollection2 extends IWMPMediaCollection{
     ...
     */
    createQuery(ppQuery) {
        result := ComCall(19, this, "ptr", ppQuery, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<IWMPQuery>} pQuery 
    ...
    getPlaylistByQuery(pQuery, bstrMediaType, bstrSortAttribute, fSortAscending, ppPlaylist) {
        ...
        result := ComCall(20, this, "ptr", pQuery, "ptr", bstrMediaType, "ptr", bstrSortAttribute, "short", fSortAscending, "ptr", ppPlaylist, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getStringCollectionByQuery(bstrAttribute, pQuery, bstrMediaType, bstrSortAttribute, fSortAscending, ppStringCollection) {
        ...
        result := ComCall(21, this, "ptr", bstrAttribute, "ptr", pQuery, "ptr", bstrMediaType, "ptr", bstrSortAttribute, "short", fSortAscending, "ptr", ppStringCollection, "int")
        if(result != 0)
            throw OSError(result)
    ...
    getByAttributeAndMediaType(bstrAttribute, bstrValue, bstrMediaType, ppMediaItems) {
        ...
        result := ComCall(22, this, "ptr", bstrAttribute, "ptr", bstrValue, "ptr", bstrMediaType, "ptr", ppMediaItems, "int")
        if(result != 0)
            throw OSError(result)
