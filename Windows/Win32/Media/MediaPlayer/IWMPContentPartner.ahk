...
class IWMPContentPartner extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IWMPContentPartnerCallback>} pCallback 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<UInt32>} prgItemIDs 
     * @param {Pointer<UInt32>} pcItemIDs 
     * @param {Pointer<WMPContextMenuInfo>} pprgItems 
     * @returns {HRESULT} 
     */
    GetCommands(location, pLocationContext, itemLocation, cItemIDs, prgItemIDs, pcItemIDs, pprgItems) {
        ...
        result := ComCall(7, this, "ptr", location, "ptr", pLocationContext, "ptr", itemLocation, "uint", cItemIDs, "uint*", prgItemIDs, "uint*", pcItemIDs, "ptr", pprgItems, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {BSTR} itemLocation 
     * @param {Integer} cItemIDs 
     * @param {Pointer<UInt32>} rgItemIDs 
     * @returns {HRESULT} 
     */
    InvokeCommand(dwCommandID, location, pLocationContext, itemLocation, cItemIDs, rgItemIDs) {
        ...
        result := ComCall(8, this, "uint", dwCommandID, "ptr", location, "ptr", pLocationContext, "ptr", itemLocation, "uint", cItemIDs, "uint*", rgItemIDs, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pdwNewCatalogVersion 
    ...
    GetCatalogURL(dwCatalogVersion, dwCatalogSchemaVersion, catalogLCID, pdwNewCatalogVersion, pbstrCatalogURL, pExpirationDate) {
        result := ComCall(15, this, "uint", dwCatalogVersion, "uint", dwCatalogSchemaVersion, "uint", catalogLCID, "uint*", pdwNewCatalogVersion, "ptr", pbstrCatalogURL, "ptr", pExpirationDate, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Int32>} pTemplateSize 
     * @returns {HRESULT} 
     */
    GetTemplate(task, location, pContext, clickLocation, pClickContext, bstrFilter, bstrViewParams, pbstrTemplateURL, pTemplateSize) {
        ...
        result := ComCall(16, this, "int", task, "ptr", location, "ptr", pContext, "ptr", clickLocation, "ptr", pClickContext, "ptr", bstrFilter, "ptr", bstrViewParams, "ptr", pbstrTemplateURL, "int*", pTemplateSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetListContents(location, pContext, bstrListType, bstrParams, dwListCookie) {
        ...
        result := ComCall(18, this, "ptr", location, "ptr", pContext, "ptr", bstrListType, "ptr", bstrParams, "uint", dwListCookie, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IWMPContentContainerList>} pListBase 
     * @param {Pointer<IWMPContentContainerList>} pListCompare 
     * @param {Pointer<Int32>} pResult 
     * @returns {HRESULT} 
     */
    CompareContainerListPrices(pListBase, pListCompare, pResult) {
        result := ComCall(24, this, "ptr", pListBase, "ptr", pListCompare, "int*", pResult, "int")
        if(result != 0)
            throw OSError(result)
