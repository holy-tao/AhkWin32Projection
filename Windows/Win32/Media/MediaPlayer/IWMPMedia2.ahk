 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpmedia2
...
class IWMPMedia2 extends IWMPMedia{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmedia2-get_error
     */
    get_error() {
        result := ComCall(25, this, "ptr*", &ppIWMPErrorItem := 0, "int")
        if(result != 0) {
