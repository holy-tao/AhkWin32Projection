...
export default struct IWMPEvents extends IUnknown {
    ...
    */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api/wmp/nf-wmp-iwmpevents-error
     */
    Error() {
        ComCall(11, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api/wmp/nf-wmp-iwmpevents-warning
     */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.OpenStateChange := CallbackCreate(ObjBindMethod(implObj, "OpenStateChange"), flags, 2)
        this.vtbl.PlayStateChange := CallbackCreate(ObjBindMethod(implObj, "PlayStateChange"), flags, 2)
        this.vtbl.AudioLanguageChange := CallbackCreate(ObjBindMethod(implObj, "AudioLanguageChange"), flags, 2)
        this.vtbl.StatusChange := CallbackCreate(ObjBindMethod(implObj, "StatusChange"), flags, 1)
        this.vtbl.ScriptCommand := CallbackCreate(ObjBindMethod(implObj, "ScriptCommand"), flags, 3)
        this.vtbl.NewStream := CallbackCreate(ObjBindMethod(implObj, "NewStream"), flags, 1)
        this.vtbl.Disconnect := CallbackCreate(ObjBindMethod(implObj, "Disconnect"), flags, 2)
        this.vtbl.Buffering := CallbackCreate(ObjBindMethod(implObj, "Buffering"), flags, 2)
        this.vtbl.Error := CallbackCreate(ObjBindMethod(implObj, "Error"), flags, 1)
        this.vtbl.Warning := CallbackCreate(ObjBindMethod(implObj, "Warning"), flags, 4)
        this.vtbl.EndOfStream := CallbackCreate(ObjBindMethod(implObj, "EndOfStream"), flags, 2)
        this.vtbl.PositionChange := CallbackCreate(ObjBindMethod(implObj, "PositionChange"), flags, 3)
        this.vtbl.MarkerHit := CallbackCreate(ObjBindMethod(implObj, "MarkerHit"), flags, 2)
        this.vtbl.DurationUnitChange := CallbackCreate(ObjBindMethod(implObj, "DurationUnitChange"), flags, 2)
        this.vtbl.CdromMediaChange := CallbackCreate(ObjBindMethod(implObj, "CdromMediaChange"), flags, 2)
        this.vtbl.PlaylistChange := CallbackCreate(ObjBindMethod(implObj, "PlaylistChange"), flags, 3)
        this.vtbl.CurrentPlaylistChange := CallbackCreate(ObjBindMethod(implObj, "CurrentPlaylistChange"), flags, 2)
        this.vtbl.CurrentPlaylistItemAvailable := CallbackCreate(ObjBindMethod(implObj, "CurrentPlaylistItemAvailable"), flags, 2)
        this.vtbl.MediaChange := CallbackCreate(ObjBindMethod(implObj, "MediaChange"), flags, 2)
        this.vtbl.CurrentMediaItemAvailable := CallbackCreate(ObjBindMethod(implObj, "CurrentMediaItemAvailable"), flags, 2)
        this.vtbl.CurrentItemChange := CallbackCreate(ObjBindMethod(implObj, "CurrentItemChange"), flags, 2)
        this.vtbl.MediaCollectionChange := CallbackCreate(ObjBindMethod(implObj, "MediaCollectionChange"), flags, 1)
        this.vtbl.MediaCollectionAttributeStringAdded := CallbackCreate(ObjBindMethod(implObj, "MediaCollectionAttributeStringAdded"), flags, 3)
        this.vtbl.MediaCollectionAttributeStringRemoved := CallbackCreate(ObjBindMethod(implObj, "MediaCollectionAttributeStringRemoved"), flags, 3)
        this.vtbl.MediaCollectionAttributeStringChanged := CallbackCreate(ObjBindMethod(implObj, "MediaCollectionAttributeStringChanged"), flags, 4)
        this.vtbl.PlaylistCollectionChange := CallbackCreate(ObjBindMethod(implObj, "PlaylistCollectionChange"), flags, 1)
        this.vtbl.PlaylistCollectionPlaylistAdded := CallbackCreate(ObjBindMethod(implObj, "PlaylistCollectionPlaylistAdded"), flags, 2)
        this.vtbl.PlaylistCollectionPlaylistRemoved := CallbackCreate(ObjBindMethod(implObj, "PlaylistCollectionPlaylistRemoved"), flags, 2)
        this.vtbl.PlaylistCollectionPlaylistSetAsDeleted := CallbackCreate(ObjBindMethod(implObj, "PlaylistCollectionPlaylistSetAsDeleted"), flags, 3)
        this.vtbl.ModeChange := CallbackCreate(ObjBindMethod(implObj, "ModeChange"), flags, 3)
        this.vtbl.MediaError := CallbackCreate(ObjBindMethod(implObj, "MediaError"), flags, 2)
        this.vtbl.OpenPlaylistSwitch := CallbackCreate(ObjBindMethod(implObj, "OpenPlaylistSwitch"), flags, 2)
        this.vtbl.DomainChange := CallbackCreate(ObjBindMethod(implObj, "DomainChange"), flags, 2)
        this.vtbl.SwitchedToPlayerApplication := CallbackCreate(ObjBindMethod(implObj, "SwitchedToPlayerApplication"), flags, 1)
        this.vtbl.SwitchedToControl := CallbackCreate(ObjBindMethod(implObj, "SwitchedToControl"), flags, 1)
        this.vtbl.PlayerDockedStateChange := CallbackCreate(ObjBindMethod(implObj, "PlayerDockedStateChange"), flags, 1)
        this.vtbl.PlayerReconnect := CallbackCreate(ObjBindMethod(implObj, "PlayerReconnect"), flags, 1)
        this.vtbl.Click := CallbackCreate(ObjBindMethod(implObj, "Click"), flags, 5)
        this.vtbl.DoubleClick := CallbackCreate(ObjBindMethod(implObj, "DoubleClick"), flags, 5)
