 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpplayerapplication
...
class IWMPPlayerApplication extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayerapplication-switchtoplayerapplication
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayerapplication-switchtocontrol
     */
    switchToControl() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayerapplication-get_playerdocked
     */
    get_playerDocked(pbPlayerDocked) {
        pbPlayerDockedMarshal := pbPlayerDocked is VarRef ? "short*" : "ptr"

        result := ComCall(9, this, pbPlayerDockedMarshal, pbPlayerDocked, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayerapplication-get_hasdisplay
     */
    get_hasDisplay(pbHasDisplay) {
        pbHasDisplayMarshal := pbHasDisplay is VarRef ? "short*" : "ptr"

        result := ComCall(10, this, pbHasDisplayMarshal, pbHasDisplay, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
