 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpcdromrip
...
class IWMPCdromRip extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromrip-get_ripstate
     */
    get_ripState(pwmprs) {
        pwmprsMarshal := pwmprs is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, pwmprsMarshal, pwmprs, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromrip-get_ripprogress
     */
    get_ripProgress(plProgress) {
        plProgressMarshal := plProgress is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, plProgressMarshal, plProgress, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromrip-startrip
     */
    startRip() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromrip-stoprip
     */
    stopRip() {
