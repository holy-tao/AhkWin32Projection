 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpcdromcollection
...
class IWMPCdromCollection extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromcollection-get_count
     */
    get_count(plCount) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromcollection-item
     */
    item(lIndex) {
     ...
     * @returns {IWMPCdrom} Pointer to a pointer to an <b>IWMPCdrom</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcdromcollection-getbydrivespecifier
     */
    getByDriveSpecifier(bstrDriveSpecifier) {
        if(bstrDriveSpecifier is String) {
            pin := BSTR.Alloc(bstrDriveSpecifier)
            bstrDriveSpecifier := pin.Value
        }

        result := ComCall(9, this, "ptr", bstrDriveSpecifier, "ptr*", &ppCdrom := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
