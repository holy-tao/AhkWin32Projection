 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmplibrary
...
class IWMPLibrary extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibrary-get_name
     */
    get_name(pbstrName) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibrary-get_type
     */
    get_type(pwmplt) {
        pwmpltMarshal := pwmplt is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, pwmpltMarshal, pwmplt, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibrary-get_mediacollection
     */
    get_mediaCollection() {
        result := ComCall(5, this, "ptr*", &ppIWMPMediaCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibrary-isidentical
     */
    isIdentical(pIWMPLibrary, pvbool) {
        pvboolMarshal := pvbool is VarRef ? "short*" : "ptr"

        result := ComCall(6, this, "ptr", pIWMPLibrary, pvboolMarshal, pvbool, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
