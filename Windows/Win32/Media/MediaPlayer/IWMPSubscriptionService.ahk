 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nn-subscriptionservices-iwmpsubscriptionservice
...
class IWMPSubscriptionService extends IUnknown{
     ...
     * @param {HWND} hwnd_ A handle to a window in which the plug-in can display a user interface.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nf-subscriptionservices-iwmpsubscriptionservice-allowplay
     */
    allowPlay(hwnd_, pMedia, pfAllowPlay) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfAllowPlayMarshal := pfAllowPlay is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", hwnd_, "ptr", pMedia, pfAllowPlayMarshal, pfAllowPlay, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} The method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nf-subscriptionservices-iwmpsubscriptionservice-allowcdburn
     */
    allowCDBurn(hwnd_, pPlaylist, pfAllowBurn) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfAllowBurnMarshal := pfAllowBurn is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", hwnd_, "ptr", pPlaylist, pfAllowBurnMarshal, pfAllowBurn, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} The method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nf-subscriptionservices-iwmpsubscriptionservice-allowpdatransfer
     */
    allowPDATransfer(hwnd_, pPlaylist, pfAllowTransfer) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfAllowTransferMarshal := pfAllowTransfer is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, "ptr", hwnd_, "ptr", pPlaylist, pfAllowTransferMarshal, pfAllowTransfer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ A handle to a window in which the plug-in can display a user interface.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nf-subscriptionservices-iwmpsubscriptionservice-startbackgroundprocessing
     */
    startBackgroundProcessing(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
