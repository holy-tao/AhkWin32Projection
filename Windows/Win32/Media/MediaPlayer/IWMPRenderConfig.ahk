 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmprealestate/nn-wmprealestate-iwmprenderconfig
...
class IWMPRenderConfig extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmprealestate/nf-wmprealestate-iwmprenderconfig-put_inproconly
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmprealestate/nf-wmprealestate-iwmprenderconfig-get_inproconly
     */
    get_inProcOnly(pfInProc) {
        pfInProcMarshal := pfInProc is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, pfInProcMarshal, pfInProc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
