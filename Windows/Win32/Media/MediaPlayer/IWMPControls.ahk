 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpcontrols
...
class IWMPControls extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-get_isavailable
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-play
     */
    play() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-stop
     */
    stop() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-pause
     */
    pause() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-fastforward
     */
    fastForward() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-fastreverse
     */
    fastReverse() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-get_currentposition
     */
    get_currentPosition(pdCurrentPosition) {
        pdCurrentPositionMarshal := pdCurrentPosition is VarRef ? "double*" : "ptr"

        result := ComCall(13, this, pdCurrentPositionMarshal, pdCurrentPosition, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-put_currentposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-get_currentpositionstring
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-next
     */
    next() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-previous
     */
    previous() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-get_currentitem
     */
    get_currentItem() {
        result := ComCall(18, this, "ptr*", &ppIWMPMedia := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-put_currentitem
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-get_currentmarker
     */
    get_currentMarker(plMarker) {
        plMarkerMarshal := plMarker is VarRef ? "int*" : "ptr"

        result := ComCall(20, this, plMarkerMarshal, plMarker, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-put_currentmarker
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcontrols-playitem
     */
    playItem(pIWMPMedia) {
