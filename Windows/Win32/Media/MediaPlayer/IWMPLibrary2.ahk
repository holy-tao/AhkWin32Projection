 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmplibrary2
...
class IWMPLibrary2 extends IWMPLibrary{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibrary2-getiteminfo
     */
    getItemInfo(bstrItemName, pbstrVal) {
        ...
        result := ComCall(7, this, "ptr", bstrItemName, "ptr", pbstrVal, "int")
        if(result != 0) {
