 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpcore
...
class IWMPCore extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-close
     */
    close() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_url
     */
    get_URL(pbstrURL) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-put_url
     */
    put_URL(bstrURL) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_openstate
     */
    get_openState(pwmpos) {
        pwmposMarshal := pwmpos is VarRef ? "int*" : "ptr"

        result := ComCall(10, this, pwmposMarshal, pwmpos, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_playstate
     */
    get_playState(pwmpps) {
        pwmppsMarshal := pwmpps is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, pwmppsMarshal, pwmpps, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_controls
     */
    get_controls() {
        result := ComCall(12, this, "ptr*", &ppControl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_settings
     */
    get_settings() {
        result := ComCall(13, this, "ptr*", &ppSettings := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_currentmedia
     */
    get_currentMedia() {
        result := ComCall(14, this, "ptr*", &ppMedia := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-put_currentmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_mediacollection
     */
    get_mediaCollection() {
        result := ComCall(16, this, "ptr*", &ppMediaCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_playlistcollection
     */
    get_playlistCollection() {
        result := ComCall(17, this, "ptr*", &ppPlaylistCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_versioninfo
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-launchurl
     */
    launchURL(bstrURL) {
        if(bstrURL is String) {
            pin := BSTR.Alloc(bstrURL)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_network
     */
    get_network() {
        result := ComCall(20, this, "ptr*", &ppQNI := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_currentplaylist
     */
    get_currentPlaylist() {
        result := ComCall(21, this, "ptr*", &ppPL := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-put_currentplaylist
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_cdromcollection
     */
    get_cdromCollection() {
        result := ComCall(23, this, "ptr*", &ppCdromCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_closedcaption
     */
    get_closedCaption() {
        result := ComCall(24, this, "ptr*", &ppClosedCaption := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_isonline
     */
    get_isOnline(pfOnline) {
        pfOnlineMarshal := pfOnline is VarRef ? "short*" : "ptr"

        result := ComCall(25, this, pfOnlineMarshal, pfOnline, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_error
     */
    get_error() {
        result := ComCall(26, this, "ptr*", &ppError := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore-get_status
     */
