...
class IWMPNodeWindowedHost extends IUnknown{
     ...
     * @returns {HRESULT} 
     */
    OnWindowMessageFromRenderer(uMsg, wparam_, lparam_, plRet, pfHandled) {
        ...
        result := ComCall(3, this, "uint", uMsg, "ptr", wparam_, "ptr", lparam_, "ptr", plRet, pfHandledMarshal, pfHandled, "int")
        if(result != 0) {
