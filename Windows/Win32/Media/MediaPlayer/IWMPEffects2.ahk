 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/effects/nn-effects-iwmpeffects2
...
class IWMPEffects2 extends IWMPEffects{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-setcore
     */
    SetCore(pPlayer) {
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-create
     */
    Create(hwndParent) {
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-destroy
     */
    Destroy() {
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-notifynewmedia
     */
     ...
     * @param {Integer} msg_ <b>UINT</b> that identifies the window message.
     * @param {WPARAM} WParam_ <b>WPARAM</b> specifying a window message parameter.
     * @param {LPARAM} LParam_ <b>LPARAM</b> specifying a window message parameter.
     * @param {Pointer<LRESULT>} plResultParam Pointer to an <b>LRESULT</b> specifying the result code for the window message.
     * @returns {HRESULT} This method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-onwindowmessage
     */
    OnWindowMessage(msg_, WParam_, LParam_, plResultParam) {
        WParam_ := WParam_ is Win32Handle ? NumGet(WParam_, "ptr") : WParam_
        LParam_ := LParam_ is Win32Handle ? NumGet(LParam_, "ptr") : LParam_

        result := ComCall(18, this, "uint", msg_, "ptr", WParam_, "ptr", LParam_, "ptr", plResultParam, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/effects/nf-effects-iwmpeffects2-renderwindowed
     */
