 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nn-subscriptionservices-iwmpsubscriptionservicecallback
...
class IWMPSubscriptionServiceCallback extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/subscriptionservices/nf-subscriptionservices-iwmpsubscriptionservicecallback-oncomplete
     */
    onComplete(hrResult) {
        result := ComCall(3, this, "int", hrResult, "int")
        if(result != 0) {
