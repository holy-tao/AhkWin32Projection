 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpclosedcaption
...
class IWMPClosedCaption extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-get_samistyle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-put_samistyle
     */
    put_SAMIStyle(bstrSAMIStyle) {
        if(bstrSAMIStyle is String) {
            pin := BSTR.Alloc(bstrSAMIStyle)
            bstrSAMIStyle := pin.Value
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-get_samilang
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-put_samilang
     */
    put_SAMILang(bstrSAMILang) {
        if(bstrSAMILang is String) {
            pin := BSTR.Alloc(bstrSAMILang)
            bstrSAMILang := pin.Value
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-get_samifilename
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-put_samifilename
     */
    put_SAMIFileName(bstrSAMIFileName) {
        if(bstrSAMIFileName is String) {
            pin := BSTR.Alloc(bstrSAMIFileName)
            bstrSAMIFileName := pin.Value
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-get_captioningid
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpclosedcaption-put_captioningid
     */
    put_captioningId(bstrCaptioningID) {
        if(bstrCaptioningID is String) {
            pin := BSTR.Alloc(bstrCaptioningID)
            bstrCaptioningID := pin.Value
        }
