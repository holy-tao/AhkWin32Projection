 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpplayer4
...
class IWMPPlayer4 extends IWMPCore3{
    ...
    get_enabled(pbEnabled) {
        ...
        result := ComCall(31, this, pbEnabledMarshal, pbEnabled, "int")
        if(result != 0) {
    ...
    get_fullScreen(pbFullScreen) {
        ...
        result := ComCall(33, this, pbFullScreenMarshal, pbFullScreen, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_enableContextMenu(pbEnableContextMenu) {
        ...
        result := ComCall(35, this, pbEnableContextMenuMarshal, pbEnableContextMenu, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_windowlessVideo(pbEnabled) {
        ...
        result := ComCall(41, this, pbEnabledMarshal, pbEnabled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayer4-get_isremote
     */
    get_isRemote(pvarfIsRemote) {
        pvarfIsRemoteMarshal := pvarfIsRemote is VarRef ? "short*" : "ptr"

        result := ComCall(43, this, pvarfIsRemoteMarshal, pvarfIsRemote, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayer4-get_playerapplication
     */
    get_playerApplication() {
        result := ComCall(44, this, "ptr*", &ppIWMPPlayerApplication := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpplayer4-openplayer
     */
    openPlayer(bstrURL) {
