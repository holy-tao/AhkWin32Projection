 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpsyncdevice2
...
class IWMPSyncDevice2 extends IWMPSyncDevice{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpsyncdevice2-setiteminfo
     */
    setItemInfo(bstrItemName, bstrVal) {
        ...
        result := ComCall(19, this, "ptr", bstrItemName, "ptr", bstrVal, "int")
        if(result != 0) {
