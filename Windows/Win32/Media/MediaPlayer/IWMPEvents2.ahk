 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpevents2
...
class IWMPEvents2 extends IWMPEvents{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-deviceconnect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-devicedisconnect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-devicestatuschange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-devicesyncstatechange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-devicesyncerror
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpevents2-createpartnershipcomplete
     */
