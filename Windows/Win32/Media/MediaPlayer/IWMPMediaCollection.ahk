 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpmediacollection
...
class IWMPMediaCollection extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-add
     */
    add(bstrURL) {
        ...
        result := ComCall(7, this, "ptr", bstrURL, "ptr*", &ppItem := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getall
     */
    getAll() {
        result := ComCall(8, this, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getbyname
     */
    getByName(bstrName) {
        ...
        result := ComCall(9, this, "ptr", bstrName, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMPPlaylist} Pointer to a pointer to an <b>IWMPPlaylist</b> interface for the retrieved media items.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getbygenre
     */
    getByGenre(bstrGenre) {
        if(bstrGenre is String) {
            pin := BSTR.Alloc(bstrGenre)
            bstrGenre := pin.Value
        }

        result := ComCall(10, this, "ptr", bstrGenre, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMPPlaylist} Pointer to a pointer to an <b>IWMPPlaylist</b> interface for the retrieved media items.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getbyauthor
     */
    getByAuthor(bstrAuthor) {
        if(bstrAuthor is String) {
            pin := BSTR.Alloc(bstrAuthor)
            bstrAuthor := pin.Value
        }

        result := ComCall(11, this, "ptr", bstrAuthor, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMPPlaylist} Pointer to a pointer to an <b>IWMPPlaylist</b> interface for the retrieved media items.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getbyalbum
     */
    getByAlbum(bstrAlbum) {
        if(bstrAlbum is String) {
            pin := BSTR.Alloc(bstrAlbum)
            bstrAlbum := pin.Value
        }

        result := ComCall(12, this, "ptr", bstrAlbum, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMPPlaylist} Pointer to a pointer to an <b>IWMPPlaylist</b> interface for the retrieved media items.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getbyattribute
     */
    getByAttribute(bstrAttribute, bstrValue) {
        ...
        result := ComCall(13, this, "ptr", bstrAttribute, "ptr", bstrValue, "ptr*", &ppMediaItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-remove
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getattributestringcollection
     */
    getAttributeStringCollection(bstrAttribute, bstrMediaType) {
        ...
        result := ComCall(15, this, "ptr", bstrAttribute, "ptr", bstrMediaType, "ptr*", &ppStringCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-getmediaatom
     */
    getMediaAtom(bstrItemName, plAtom) {
        ...
        result := ComCall(16, this, "ptr", bstrItemName, plAtomMarshal, plAtom, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpmediacollection-setdeleted
     */
    ...
    isDeleted(pItem, pvarfIsDeleted) {
        ...
        result := ComCall(18, this, "ptr", pItem, pvarfIsDeletedMarshal, pvarfIsDeleted, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
