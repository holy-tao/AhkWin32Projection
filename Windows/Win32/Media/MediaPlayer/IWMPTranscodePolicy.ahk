 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmpservices/nn-wmpservices-iwmptranscodepolicy
...
class IWMPTranscodePolicy extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmpservices/nf-wmpservices-iwmptranscodepolicy-allowtranscode
     */
    allowTranscode(pvbAllow) {
        pvbAllowMarshal := pvbAllow is VarRef ? "short*" : "ptr"

        result := ComCall(3, this, pvbAllowMarshal, pvbAllow, "int")
        if(result != 0) {
