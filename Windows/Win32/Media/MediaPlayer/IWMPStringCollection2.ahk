...
class IWMPStringCollection2 extends IWMPStringCollection{
    ...
    /**
     * 
     * @param {Pointer<IWMPStringCollection2>} pIWMPStringCollection2 
     * @param {Pointer<VARIANT_BOOL>} pvbool 
     * @returns {HRESULT} 
     */
    isIdentical(pIWMPStringCollection2, pvbool) {
        result := ComCall(9, this, "ptr", pIWMPStringCollection2, "ptr", pvbool, "int")
        if(result != 0)
    ...
    getAttributeCountByType(lCollectionIndex, bstrType, bstrLanguage, plCount) {
        ...
        result := ComCall(11, this, "int", lCollectionIndex, "ptr", bstrType, "ptr", bstrLanguage, "int*", plCount, "int")
        if(result != 0)
            throw OSError(result)
