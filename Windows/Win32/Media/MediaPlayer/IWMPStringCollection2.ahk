 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpstringcollection2
...
class IWMPStringCollection2 extends IWMPStringCollection{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpstringcollection2-isidentical
     */
    isIdentical(pIWMPStringCollection2, pvbool) {
        pvboolMarshal := pvbool is VarRef ? "short*" : "ptr"

        result := ComCall(9, this, "ptr", pIWMPStringCollection2, pvboolMarshal, pvbool, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpstringcollection2-getiteminfo
     */
    getItemInfo(lCollectionIndex, bstrItemName, pbstrValue) {
        ...
        result := ComCall(10, this, "int", lCollectionIndex, "ptr", bstrItemName, "ptr", pbstrValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpstringcollection2-getattributecountbytype
     */
    getAttributeCountByType(lCollectionIndex, bstrType, bstrLanguage, plCount) {
        ...
        result := ComCall(11, this, "int", lCollectionIndex, "ptr", bstrType, "ptr", bstrLanguage, plCountMarshal, plCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpstringcollection2-getiteminfobytype
     */
    getItemInfoByType(lCollectionIndex, bstrType, bstrLanguage, lAttributeIndex, pvarValue) {
        ...
        result := ComCall(12, this, "int", lCollectionIndex, "ptr", bstrType, "ptr", bstrLanguage, "int", lAttributeIndex, "ptr", pvarValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
