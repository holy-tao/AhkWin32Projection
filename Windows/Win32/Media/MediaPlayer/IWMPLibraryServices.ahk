 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmplibraryservices
...
class IWMPLibraryServices extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibraryservices-getcountbytype
     */
    getCountByType(wmplt, plCount) {
        plCountMarshal := plCount is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "int", wmplt, plCountMarshal, plCount, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmplibraryservices-getlibrarybytype
     */
    getLibraryByType(wmplt, lIndex) {
        result := ComCall(4, this, "int", wmplt, "int", lIndex, "ptr*", &ppIWMPLibrary := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
