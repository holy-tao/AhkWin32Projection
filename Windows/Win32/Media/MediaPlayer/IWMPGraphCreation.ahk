 ...
 */
export default struct IWMPGraphCreation extends IUnknown {
    /**
     ...
     * used for IWMPGraphCreation interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GraphCreationPreRender  : IntPtr
        GraphCreationPostRender : IntPtr
        GetGraphCreationFlags   : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMPGraphCreation.Vtbl()
        }
    ...
    Query(iid) {
        if (IWMPGraphCreation.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GraphCreationPreRender)
        CallbackFree(this.vtbl.GraphCreationPostRender)
        CallbackFree(this.vtbl.GetGraphCreationFlags)
    }
}
