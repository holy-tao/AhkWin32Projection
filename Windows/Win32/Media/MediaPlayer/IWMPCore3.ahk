 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nn-wmp-iwmpcore3
...
class IWMPCore3 extends IWMPCore2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore3-newplaylist
     */
    newPlaylist(bstrName, bstrURL) {
        ...
        result := ComCall(29, this, "ptr", bstrName, "ptr", bstrURL, "ptr*", &ppPlaylist := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmp/nf-wmp-iwmpcore3-newmedia
     */
    newMedia(bstrURL) {
        if(bstrURL is String) {
            pin := BSTR.Alloc(bstrURL)
        ...
        result := ComCall(30, this, "ptr", bstrURL, "ptr*", &ppMedia := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
