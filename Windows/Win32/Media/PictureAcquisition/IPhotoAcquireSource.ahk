 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nn-photoacquire-iphotoacquiresource
...
class IPhotoAcquireSource extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getfriendlyname
     */
    GetFriendlyName() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getdeviceicons
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-initializeitemlist
     */
    InitializeItemList(fForceEnumeration, pPhotoAcquireProgressCB, pnItemCount) {
        ...
        result := ComCall(5, this, "int", fForceEnumeration, "ptr", pPhotoAcquireProgressCB, pnItemCountMarshal, pnItemCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getitemcount
     */
    GetItemCount() {
        result := ComCall(6, this, "uint*", &pnItemCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getitemat
     */
    GetItemAt(nIndex) {
        result := ComCall(7, this, "uint", nIndex, "ptr*", &ppPhotoAcquireItem := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getphotoacquiresettings
     */
    GetPhotoAcquireSettings() {
        result := ComCall(8, this, "ptr*", &ppPhotoAcquireSettings := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/photoacquire/nf-photoacquire-iphotoacquiresource-getdeviceid
     */
    GetDeviceId() {
        pbstrDeviceId := BSTR()
     ...
     */
    BindToObject(riid) {
        result := ComCall(10, this, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
