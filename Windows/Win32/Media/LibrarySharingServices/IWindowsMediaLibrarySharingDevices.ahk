 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nn-wmlss-iwindowsmedialibrarysharingdevices
...
class IWindowsMediaLibrarySharingDevices extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nf-wmlss-iwindowsmedialibrarysharingdevices-get_item
     */
    get_Item(index) {
        result := ComCall(7, this, "int", index, "ptr*", &device := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nf-wmlss-iwindowsmedialibrarysharingdevices-get_count
     */
    get_Count() {
     ...
     * @returns {IWindowsMediaLibrarySharingDevice} A pointer to a variable that receives a pointer to the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/wmlss/nn-wmlss-iwindowsmedialibrarysharingdevice">IWindowsMediaLibrarySharingDevice</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nf-wmlss-iwindowsmedialibrarysharingdevices-getdevice
     */
    GetDevice(deviceID) {
        ...
        result := ComCall(9, this, "ptr", deviceID, "ptr*", &device := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
