...
export default struct IWindowsMediaLibrarySharingServices extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.showShareMediaCPL := CallbackCreate(ObjBindMethod(implObj, "showShareMediaCPL"), flags, 2)
        this.vtbl.get_userHomeMediaSharingState := CallbackCreate(ObjBindMethod(implObj, "get_userHomeMediaSharingState"), flags, 2)
        this.vtbl.put_userHomeMediaSharingState := CallbackCreate(ObjBindMethod(implObj, "put_userHomeMediaSharingState"), flags, 2)
        this.vtbl.get_userHomeMediaSharingLibraryName := CallbackCreate(ObjBindMethod(implObj, "get_userHomeMediaSharingLibraryName"), flags, 2)
        this.vtbl.put_userHomeMediaSharingLibraryName := CallbackCreate(ObjBindMethod(implObj, "put_userHomeMediaSharingLibraryName"), flags, 2)
        this.vtbl.get_computerHomeMediaSharingAllowedState := CallbackCreate(ObjBindMethod(implObj, "get_computerHomeMediaSharingAllowedState"), flags, 2)
        this.vtbl.put_computerHomeMediaSharingAllowedState := CallbackCreate(ObjBindMethod(implObj, "put_computerHomeMediaSharingAllowedState"), flags, 2)
        this.vtbl.get_userInternetMediaSharingState := CallbackCreate(ObjBindMethod(implObj, "get_userInternetMediaSharingState"), flags, 2)
        this.vtbl.put_userInternetMediaSharingState := CallbackCreate(ObjBindMethod(implObj, "put_userInternetMediaSharingState"), flags, 2)
        this.vtbl.get_computerInternetMediaSharingAllowedState := CallbackCreate(ObjBindMethod(implObj, "get_computerInternetMediaSharingAllowedState"), flags, 2)
        this.vtbl.put_computerInternetMediaSharingAllowedState := CallbackCreate(ObjBindMethod(implObj, "put_computerInternetMediaSharingAllowedState"), flags, 2)
        this.vtbl.get_internetMediaSharingSecurityGroup := CallbackCreate(ObjBindMethod(implObj, "get_internetMediaSharingSecurityGroup"), flags, 2)
        this.vtbl.put_internetMediaSharingSecurityGroup := CallbackCreate(ObjBindMethod(implObj, "put_internetMediaSharingSecurityGroup"), flags, 2)
        this.vtbl.get_allowSharingToAllDevices := CallbackCreate(ObjBindMethod(implObj, "get_allowSharingToAllDevices"), flags, 2)
        this.vtbl.put_allowSharingToAllDevices := CallbackCreate(ObjBindMethod(implObj, "put_allowSharingToAllDevices"), flags, 2)
        this.vtbl.setDefaultAuthorization := CallbackCreate(ObjBindMethod(implObj, "setDefaultAuthorization"), flags, 4)
        this.vtbl.setAuthorizationState := CallbackCreate(ObjBindMethod(implObj, "setAuthorizationState"), flags, 3)
        this.vtbl.getAllDevices := CallbackCreate(ObjBindMethod(implObj, "getAllDevices"), flags, 2)
        this.vtbl.get_customSettingsApplied := CallbackCreate(ObjBindMethod(implObj, "get_customSettingsApplied"), flags, 2)
    }
