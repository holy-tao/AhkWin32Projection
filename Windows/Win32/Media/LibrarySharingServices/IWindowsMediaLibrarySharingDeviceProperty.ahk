 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nn-wmlss-iwindowsmedialibrarysharingdeviceproperty
...
class IWindowsMediaLibrarySharingDeviceProperty extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nf-wmlss-iwindowsmedialibrarysharingdeviceproperty-get_name
     */
    get_Name() {
        name := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmlss/nf-wmlss-iwindowsmedialibrarysharingdeviceproperty-get_value
     */
    get_Value() {
        value := VARIANT()
