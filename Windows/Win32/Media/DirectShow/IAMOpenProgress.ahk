 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamopenprogress
...
class IAMOpenProgress extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamopenprogress-queryprogress
     */
    QueryProgress(pllTotal, pllCurrent) {
        ...
        result := ComCall(3, this, pllTotalMarshal, pllTotal, pllCurrentMarshal, pllCurrent, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamopenprogress-abortoperation
     */
    AbortOperation() {
