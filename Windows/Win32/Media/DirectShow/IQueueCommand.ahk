...
class IQueueCommand extends IUnknown{
     ...
     * @param {Pointer<Int16>} puArgErr 
     * @returns {HRESULT} 
     */
    InvokeAtStreamTime(pCmd, time, iid, dispidMethod, wFlags, cArgs, pDispParams, pvarResult, puArgErr) {
        result := ComCall(3, this, "ptr", pCmd, "double", time, "ptr", iid, "int", dispidMethod, "short", wFlags, "int", cArgs, "ptr", pDispParams, "ptr", pvarResult, "short*", puArgErr, "int")
        if(result != 0)
    ...
    InvokeAtPresentationTime(pCmd, time, iid, dispidMethod, wFlags, cArgs, pDispParams, pvarResult, puArgErr) {
        result := ComCall(4, this, "ptr", pCmd, "double", time, "ptr", iid, "int", dispidMethod, "short", wFlags, "int", cArgs, "ptr", pDispParams, "ptr", pvarResult, "short*", puArgErr, "int")
        if(result != 0)
            throw OSError(result)
