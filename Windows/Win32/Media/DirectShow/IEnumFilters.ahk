 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ienumfilters
...
class IEnumFilters extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumfilters-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumfilters-skip
     */
    Skip(cFilters) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumfilters-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumfilters-clone
     */
    Clone() {
