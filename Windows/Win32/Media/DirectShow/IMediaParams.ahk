 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nn-medparam-imediaparams
...
class IMediaParams extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nf-medparam-imediaparams-getparam
     */
    GetParam(dwParamIndex) {
        result := ComCall(3, this, "uint", dwParamIndex, "float*", &pValue := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nf-medparam-imediaparams-setparam
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nf-medparam-imediaparams-addenvelope
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nf-medparam-imediaparams-flushenvelope
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/medparam/nf-medparam-imediaparams-settimeformat
     */
