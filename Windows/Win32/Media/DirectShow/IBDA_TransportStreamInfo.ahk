 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_transportstreaminfo
...
class IBDA_TransportStreamInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_transportstreaminfo-get_pattabletickcount
     */
    get_PatTableTickCount() {
        result := ComCall(3, this, "uint*", &pPatTickCount := 0, "int")
        if(result != 0) {
