...
export default struct IDvdControl2 extends IUnknown {
    ...
    */
    ...
    SelectParentalCountry(bCountry) {
        bCountryMarshal := bCountry is VarRef ? "char*" : IntPtr
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.PlayTitle := CallbackCreate(ObjBindMethod(implObj, "PlayTitle"), flags, 4)
        this.vtbl.PlayChapterInTitle := CallbackCreate(ObjBindMethod(implObj, "PlayChapterInTitle"), flags, 5)
        this.vtbl.PlayAtTimeInTitle := CallbackCreate(ObjBindMethod(implObj, "PlayAtTimeInTitle"), flags, 5)
        this.vtbl.Stop := CallbackCreate(ObjBindMethod(implObj, "Stop"), flags, 1)
        this.vtbl.ReturnFromSubmenu := CallbackCreate(ObjBindMethod(implObj, "ReturnFromSubmenu"), flags, 3)
        this.vtbl.PlayAtTime := CallbackCreate(ObjBindMethod(implObj, "PlayAtTime"), flags, 4)
        this.vtbl.PlayChapter := CallbackCreate(ObjBindMethod(implObj, "PlayChapter"), flags, 4)
        this.vtbl.PlayPrevChapter := CallbackCreate(ObjBindMethod(implObj, "PlayPrevChapter"), flags, 3)
        this.vtbl.ReplayChapter := CallbackCreate(ObjBindMethod(implObj, "ReplayChapter"), flags, 3)
        this.vtbl.PlayNextChapter := CallbackCreate(ObjBindMethod(implObj, "PlayNextChapter"), flags, 3)
        this.vtbl.PlayForwards := CallbackCreate(ObjBindMethod(implObj, "PlayForwards"), flags, 4)
        this.vtbl.PlayBackwards := CallbackCreate(ObjBindMethod(implObj, "PlayBackwards"), flags, 4)
        this.vtbl.ShowMenu := CallbackCreate(ObjBindMethod(implObj, "ShowMenu"), flags, 4)
        this.vtbl.Resume := CallbackCreate(ObjBindMethod(implObj, "Resume"), flags, 3)
        this.vtbl.SelectRelativeButton := CallbackCreate(ObjBindMethod(implObj, "SelectRelativeButton"), flags, 2)
        this.vtbl.ActivateButton := CallbackCreate(ObjBindMethod(implObj, "ActivateButton"), flags, 1)
        this.vtbl.SelectButton := CallbackCreate(ObjBindMethod(implObj, "SelectButton"), flags, 2)
        ...
        this.vtbl.SelectAudioStream := CallbackCreate(ObjBindMethod(implObj, "SelectAudioStream"), flags, 4)
        this.vtbl.SelectSubpictureStream := CallbackCreate(ObjBindMethod(implObj, "SelectSubpictureStream"), flags, 4)
        this.vtbl.SetSubpictureState := CallbackCreate(ObjBindMethod(implObj, "SetSubpictureState"), flags, 4)
        this.vtbl.SelectAngle := CallbackCreate(ObjBindMethod(implObj, "SelectAngle"), flags, 4)
        this.vtbl.SelectParentalLevel := CallbackCreate(ObjBindMethod(implObj, "SelectParentalLevel"), flags, 2)
        this.vtbl.SelectParentalCountry := CallbackCreate(ObjBindMethod(implObj, "SelectParentalCountry"), flags, 2)
        this.vtbl.SelectKaraokeAudioPresentationMode := CallbackCreate(ObjBindMethod(implObj, "SelectKaraokeAudioPresentationMode"), flags, 2)
        this.vtbl.SelectVideoModePreference := CallbackCreate(ObjBindMethod(implObj, "SelectVideoModePreference"), flags, 2)
        this.vtbl.SetDVDDirectory := CallbackCreate(ObjBindMethod(implObj, "SetDVDDirectory"), flags, 2)
        this.vtbl.ActivateAtPosition := CallbackCreate(ObjBindMethod(implObj, "ActivateAtPosition"), flags, 2)
        this.vtbl.SelectAtPosition := CallbackCreate(ObjBindMethod(implObj, "SelectAtPosition"), flags, 2)
        this.vtbl.PlayChaptersAutoStop := CallbackCreate(ObjBindMethod(implObj, "PlayChaptersAutoStop"), flags, 6)
        this.vtbl.AcceptParentalLevelChange := CallbackCreate(ObjBindMethod(implObj, "AcceptParentalLevelChange"), flags, 2)
        this.vtbl.SetOption := CallbackCreate(ObjBindMethod(implObj, "SetOption"), flags, 3)
        this.vtbl.SetState := CallbackCreate(ObjBindMethod(implObj, "SetState"), flags, 4)
        this.vtbl.PlayPeriodInTitleAutoStop := CallbackCreate(ObjBindMethod(implObj, "PlayPeriodInTitleAutoStop"), flags, 6)
        this.vtbl.SetGPRM := CallbackCreate(ObjBindMethod(implObj, "SetGPRM"), flags, 5)
        this.vtbl.SelectDefaultMenuLanguage := CallbackCreate(ObjBindMethod(implObj, "SelectDefaultMenuLanguage"), flags, 2)
