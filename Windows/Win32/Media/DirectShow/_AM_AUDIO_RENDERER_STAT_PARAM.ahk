...
class _AM_AUDIO_RENDERER_STAT_PARAM extends Win32Enum {
     ...
     * 
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_BREAK_COUNT
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_BREAK_COUNT => 1
     ...
     * </ul>
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_MODE
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_MODE => 2
     ...
     * 
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_SILENCE_DUR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SILENCE_DUR => 3

    /**
     * <i>Param1</i>: The duration of the most recent audio buffer, in milliseconds.
     * 
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_LAST_BUFFER_DUR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_LAST_BUFFER_DUR => 4

    /**
     * <i>Param1</i>: The cumulative number of discontinuities in the audio stream.
     * 
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_DISCONTINUITIES
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_DISCONTINUITIES => 5
     ...
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_RATE
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_RATE => 6
     ...
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_DROPWRITE_DUR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_DROPWRITE_DUR => 7
     ...
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_HIGHLOWERROR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_HIGHLOWERROR => 8
     ...
     * 
     * Valid only when the audio renderer is matching rates to a master clock.
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_LASTHIGHLOWERROR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_LASTHIGHLOWERROR => 9
     ...
     * Native name: AM_AUDREND_STAT_PARAM_SLAVE_ACCUMERROR
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_SLAVE_ACCUMERROR => 10

    /**
     * <i>Param1</i>: How much audio data is in the audio buffer, as a percentage.
     * 
     * <i>Param2</i>: Not used.
     * Native name: AM_AUDREND_STAT_PARAM_BUFFERFULLNESS
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_BUFFERFULLNESS => 11

    /**
     * Not implemented.
     * Native name: AM_AUDREND_STAT_PARAM_JITTER
     * @type {Integer (Int32)}
     */
    static AUDREND_STAT_PARAM_JITTER => 12
}
