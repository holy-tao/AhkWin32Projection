 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iresourceconsumer
...
class IResourceConsumer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iresourceconsumer-acquireresource
     */
    AcquireResource(idResource) {
        result := ComCall(3, this, "int", idResource, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iresourceconsumer-releaseresource
     */
    ReleaseResource(idResource) {
        result := ComCall(4, this, "int", idResource, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
