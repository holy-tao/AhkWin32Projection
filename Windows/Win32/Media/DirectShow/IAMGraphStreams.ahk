 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamgraphstreams
...
class IAMGraphStreams extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamgraphstreams-findupstreaminterface
     */
    FindUpstreamInterface(pPin, riid, dwFlags) {
        result := ComCall(3, this, "ptr", pPin, "ptr", riid, "ptr*", &ppvInterface := 0, "uint", dwFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamgraphstreams-syncusingstreamoffset
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamgraphstreams-setmaxgraphlatency
     */
