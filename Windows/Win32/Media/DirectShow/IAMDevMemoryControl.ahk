 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamdevmemorycontrol
...
class IAMDevMemoryControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemorycontrol-querywritesync
     */
    QueryWriteSync() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemorycontrol-writesync
     */
    WriteSync() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemorycontrol-getdevid
     */
    GetDevId() {
        result := ComCall(5, this, "uint*", &pdwDevId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
