 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamextdevice
...
class IAMExtDevice extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-getcapability
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-get_externaldeviceid
     */
    get_ExternalDeviceID() {
        result := ComCall(4, this, "ptr*", &ppszData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-get_externaldeviceversion
     */
    get_ExternalDeviceVersion() {
        result := ComCall(5, this, "ptr*", &ppszData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-put_devicepower
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-get_devicepower
     */
    get_DevicePower() {
        result := ComCall(7, this, "int*", &pPowerMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Mode_ Specifies a value that activates or deactivates the calibration process:
     * 
     * <table>
     * <tr>
     * <th>Value
     ...
     * </table>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-calibrate
     */
    Calibrate(hEvent, Mode_) {
        result := ComCall(8, this, "ptr", hEvent, "int", Mode_, "int*", &pStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-put_deviceport
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamextdevice-get_deviceport
     */
    get_DevicePort() {
        result := ComCall(10, this, "int*", &pDevicePort := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
