 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-idvdinfo2
...
class IDvdInfo2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentdomain
     */
    GetCurrentDomain() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentlocation
     */
    GetCurrentLocation() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-gettotaltitletime
     */
    GetTotalTitleTime(pTotalTime, ulTimeCodeFlags) {
        ulTimeCodeFlagsMarshal := ulTimeCodeFlags is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr", pTotalTime, ulTimeCodeFlagsMarshal, ulTimeCodeFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentbutton
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentangle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentaudio
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentsubpicture
     */
    GetCurrentSubpicture(pulStreamsAvailable, pulCurrentStream, pbIsDisabled) {
        ...
        result := ComCall(9, this, pulStreamsAvailableMarshal, pulStreamsAvailable, pulCurrentStreamMarshal, pulCurrentStream, pbIsDisabledMarshal, pbIsDisabled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentuops
     */
    GetCurrentUOPS() {
        result := ComCall(10, this, "uint*", &pulUOPs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getallsprms
     */
    GetAllSPRMs() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getallgprms
     */
    GetAllGPRMs() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getaudiolanguage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getsubpicturelanguage
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-gettitleattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getvmgattributes
     */
    GetVMGAttributes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcurrentvideoattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getaudioattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getkaraokeattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getsubpictureattributes
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvdvolumeinfo
     */
    GetDVDVolumeInfo(pulNumOfVolumes, pulVolume, pSide, pulNumOfTitles) {
        ...
        result := ComCall(21, this, pulNumOfVolumesMarshal, pulNumOfVolumes, pulVolumeMarshal, pulVolume, pSideMarshal, pSide, pulNumOfTitlesMarshal, pulNumOfTitles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvdtextnumberoflanguages
     */
    GetDVDTextNumberOfLanguages() {
        result := ComCall(22, this, "uint*", &pulNumOfLangs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvdtextlanguageinfo
     */
    GetDVDTextLanguageInfo(ulLangIndex, pulNumOfStrings, pLangCode, pbCharacterSet) {
        ...
        result := ComCall(23, this, "uint", ulLangIndex, pulNumOfStringsMarshal, pulNumOfStrings, pLangCodeMarshal, pLangCode, pbCharacterSetMarshal, pbCharacterSet, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvdtextstringasnative
     */
    GetDVDTextStringAsNative(ulLangIndex, ulStringIndex, pbBuffer, ulMaxBufferSize, pulActualSize, pType) {
        ...
        result := ComCall(24, this, "uint", ulLangIndex, "uint", ulStringIndex, pbBufferMarshal, pbBuffer, "uint", ulMaxBufferSize, pulActualSizeMarshal, pulActualSize, pTypeMarshal, pType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvdtextstringasunicode
     */
    GetDVDTextStringAsUnicode(ulLangIndex, ulStringIndex, pchwBuffer, ulMaxBufferSize, pulActualSize, pType) {
        ...
        result := ComCall(25, this, "uint", ulLangIndex, "uint", ulStringIndex, "ptr", pchwBuffer, "uint", ulMaxBufferSize, pulActualSizeMarshal, pulActualSize, pTypeMarshal, pType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getplayerparentallevel
     */
    GetPlayerParentalLevel(pulParentalLevel, pbCountryCode) {
        ...
        result := ComCall(26, this, pulParentalLevelMarshal, pulParentalLevel, pbCountryCodeMarshal, pbCountryCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getnumberofchapters
     */
    GetNumberOfChapters(ulTitle) {
        result := ComCall(27, this, "uint", ulTitle, "uint*", &pulNumOfChapters := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-gettitleparentallevels
     */
    GetTitleParentalLevels(ulTitle) {
        result := ComCall(28, this, "uint", ulTitle, "uint*", &pulParentalLevels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdvddirectory
     */
    GetDVDDirectory(pszwPath, ulMaxSize) {
        pszwPath := pszwPath is String ? StrPtr(pszwPath) : pszwPath

        result := ComCall(29, this, "ptr", pszwPath, "uint", ulMaxSize, "uint*", &pulActualSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-isaudiostreamenabled
     */
    IsAudioStreamEnabled(ulStreamNum) {
        result := ComCall(30, this, "uint", ulStreamNum, "int*", &pbEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdiscid
     */
    GetDiscID(pszwPath) {
        pszwPath := pszwPath is String ? StrPtr(pszwPath) : pszwPath

        result := ComCall(31, this, "ptr", pszwPath, "uint*", &pullDiscID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getstate
     */
    GetState() {
        result := ComCall(32, this, "ptr*", &pStateData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getmenulanguages
     */
    GetMenuLanguages(pLanguages, ulMaxLanguages, pulActualLanguages) {
        ...
        result := ComCall(33, this, pLanguagesMarshal, pLanguages, "uint", ulMaxLanguages, pulActualLanguagesMarshal, pulActualLanguages, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {POINT} point_ Current mouse pointer position as retrieved through the Win32 WM_MOUSEMOVE message.
     * @returns {Integer} Receives the index (from 1 through 36) of the button at the current mouse pointer position.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getbuttonatposition
     */
    GetButtonAtPosition(point_) {
        result := ComCall(34, this, "ptr", point_, "uint*", &pulButtonIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getcmdfromevent
     */
    GetCmdFromEvent(lParam1) {
        result := ComCall(35, this, "ptr", lParam1, "ptr*", &pCmdObj := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Receives the language information.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdefaultmenulanguage
     */
    GetDefaultMenuLanguage() {
        result := ComCall(36, this, "uint*", &pLanguage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdefaultaudiolanguage
     */
    GetDefaultAudioLanguage(pLanguage, pAudioExtension) {
        ...
        result := ComCall(37, this, pLanguageMarshal, pLanguage, pAudioExtensionMarshal, pAudioExtension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdefaultsubpicturelanguage
     */
    GetDefaultSubpictureLanguage(pLanguage, pSubpictureExtension) {
        ...
        result := ComCall(38, this, pLanguageMarshal, pLanguage, pSubpictureExtensionMarshal, pSubpictureExtension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getdecodercaps
     */
    GetDecoderCaps() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-getbuttonrect
     */
     ...
     * @returns {BOOL} Pointer to a variable of type BOOL that receives a value of <b>TRUE</b> if the audio stream is enabled, or <b>FALSE</b> otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdinfo2-issubpicturestreamenabled
     */
    IsSubpictureStreamEnabled(ulStreamNum) {
        result := ComCall(41, this, "uint", ulStreamNum, "int*", &pbEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
