 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ivmraspectratiocontrol
...
class IVMRAspectRatioControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmraspectratiocontrol-getaspectratiomode
     */
    GetAspectRatioMode() {
        result := ComCall(3, this, "uint*", &lpdwARMode := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmraspectratiocontrol-setaspectratiomode
     */
