 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamasyncreadertimestampscaling
...
class IAMAsyncReaderTimestampScaling extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamasyncreadertimestampscaling-gettimestampmode
     */
    GetTimestampMode() {
        result := ComCall(3, this, "int*", &pfRaw := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamasyncreadertimestampscaling-settimestampmode
     */
    SetTimestampMode(fRaw) {
        result := ComCall(4, this, "int", fRaw, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
