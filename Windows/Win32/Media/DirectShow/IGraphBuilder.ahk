 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-igraphbuilder
...
class IGraphBuilder extends IFilterGraph{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-connect
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-render
     */
    Render(ppinOut) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-renderfile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-addsourcefilter
     */
    AddSourceFilter(lpcwstrFileName, lpcwstrFilterName) {
        ...
        result := ComCall(14, this, "ptr", lpcwstrFileName, "ptr", lpcwstrFilterName, "ptr*", &ppFilter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-setlogfile
     */
    SetLogFile(hFile) {
     ...
     * @returns {HRESULT} Returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-abort
     */
    Abort() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphbuilder-shouldoperationcontinue
     */
