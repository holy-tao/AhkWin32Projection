 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ibasefilter
...
class IBaseFilter extends IMediaFilter{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ibasefilter-enumpins
     */
    EnumPins() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ibasefilter-findpin
     */
    FindPin(Id) {
        Id := Id is String ? StrPtr(Id) : Id

        result := ComCall(11, this, "ptr", Id, "ptr*", &ppPin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ibasefilter-queryfilterinfo
     */
    QueryFilterInfo() {
        pInfo := FILTER_INFO()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ibasefilter-joinfiltergraph
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ibasefilter-queryvendorinfo
     */
    QueryVendorInfo() {
        result := ComCall(14, this, "ptr*", &pVendorInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
