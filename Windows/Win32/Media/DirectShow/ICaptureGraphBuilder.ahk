 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-icapturegraphbuilder
...
class ICaptureGraphBuilder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-setfiltergraph
     */
    SetFiltergraph(pfg) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-getfiltergraph
     */
    GetFiltergraph() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-setoutputfilename
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-findinterface
     */
    FindInterface(pCategory, pf, riid) {
        result := ComCall(6, this, "ptr", pCategory, "ptr", pf, "ptr", riid, "ptr*", &ppint := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-renderstream
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-controlstream
     */
    ControlStream(pCategory, pFilter, pstart, pstop, wStartCookie, wStopCookie) {
        ...
        result := ComCall(8, this, "ptr", pCategory, "ptr", pFilter, pstartMarshal, pstart, pstopMarshal, pstop, "ushort", wStartCookie, "ushort", wStopCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-alloccapfile
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder-copycapturefile
     */
