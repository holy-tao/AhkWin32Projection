 ...
 */
export default struct IEncoderAPI extends IUnknown {
    /**
     ...
     * used for IEncoderAPI interfaces
    */
     ...
     */
    IsAvailable(Api) {
        result := ComCall(4, this, Guid.Ptr, Api, "HRESULT")
        return result
    }
