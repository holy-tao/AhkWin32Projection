 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamvfwcompressdialogs
...
class IAMVfwCompressDialogs extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvfwcompressdialogs-showdialog
     */
    ShowDialog(iDialog, hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(3, this, "int", iDialog, "ptr", hwnd_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvfwcompressdialogs-getstate
     */
    GetState(pState, pcbState) {
        pcbStateMarshal := pcbState is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", pState, pcbStateMarshal, pcbState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Return value varies depending on the implementation within each driver.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvfwcompressdialogs-setstate
     */
     ...
     * @returns {HRESULT} Return value varies depending on the implementation within each driver.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvfwcompressdialogs-senddrivermessage
     */
