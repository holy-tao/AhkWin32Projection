 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nn-qnetwork-iamchannelinfo
...
class IAMChannelInfo extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_channelname
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_channeldescription
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_channelurl
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_contactaddress
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_contactphone
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamchannelinfo-get_contactemail
     */
