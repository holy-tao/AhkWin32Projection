 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nn-mixerocx-imixerocx
...
class IMixerOCX extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-ondisplaychange
     */
     ...
     * @returns {HRESULT} Returns E_NOTIMPL.
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-getaspectratio
     */
    GetAspectRatio(pdwPictAspectRatioX, pdwPictAspectRatioY) {
        ...
        result := ComCall(4, this, pdwPictAspectRatioXMarshal, pdwPictAspectRatioX, pdwPictAspectRatioYMarshal, pdwPictAspectRatioY, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-getvideosize
     */
    GetVideoSize(pdwVideoWidth, pdwVideoHeight) {
        ...
        result := ComCall(5, this, pdwVideoWidthMarshal, pdwVideoWidth, pdwVideoHeightMarshal, pdwVideoHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-getstatus
     */
    GetStatus() {
        result := ComCall(6, this, "ptr*", &pdwStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-ondraw
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-setdrawregion
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-advise
     */
    Advise(pmdns) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/mixerocx/nf-mixerocx-imixerocx-unadvise
     */
    UnAdvise() {
