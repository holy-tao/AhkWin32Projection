 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamfiltermiscflags
...
class IAMFilterMiscFlags extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamfiltermiscflags-getmiscflags
     */
    GetMiscFlags() {
