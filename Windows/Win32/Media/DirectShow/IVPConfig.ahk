 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vpconfig/nn-vpconfig-ivpconfig
...
class IVPConfig extends IVPBaseConfig{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vpconfig/nf-vpconfig-ivpconfig-isvpdecimationallowed
     */
    IsVPDecimationAllowed(pbIsDecimationAllowed) {
        pbIsDecimationAllowedMarshal := pbIsDecimationAllowed is VarRef ? "int*" : "ptr"

        result := ComCall(16, this, pbIsDecimationAllowedMarshal, pbIsDecimationAllowed, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vpconfig/nf-vpconfig-ivpconfig-setscalingfactors
     */
    SetScalingFactors(pamvpSize) {
        result := ComCall(17, this, "ptr", pamvpSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
