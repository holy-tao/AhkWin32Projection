 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamstreamcontrol
...
class IAMStreamControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamstreamcontrol-startat
     */
    StartAt(ptStart, dwCookie) {
        ptStartMarshal := ptStart is VarRef ? "int64*" : "ptr"

        result := ComCall(3, this, ptStartMarshal, ptStart, "uint", dwCookie, "int")
        if(result != 0) {
     ...
     * @param {Integer} dwCookie Specifies a value to send along with the start notification. See Remarks.
     * @returns {HRESULT} If the method succeeds, the return value is S_OK. Otherwise, returns an <b>HRESULT</b> value indicating the cause of the failure.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamstreamcontrol-stopat
     */
    StopAt(ptStop, bSendExtra, dwCookie) {
        ptStopMarshal := ptStop is VarRef ? "int64*" : "ptr"

        result := ComCall(4, this, ptStopMarshal, ptStop, "int", bSendExtra, "uint", dwCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamstreamcontrol-getinfo
     */
    GetInfo() {
