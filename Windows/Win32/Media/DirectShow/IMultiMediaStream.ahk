 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nn-mmstream-imultimediastream
...
class IMultiMediaStream extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-getinformation
     */
    GetInformation(pdwFlags, pStreamType) {
        ...
        result := ComCall(3, this, pdwFlagsMarshal, pdwFlags, pStreamTypeMarshal, pStreamType, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-getmediastream
     */
    GetMediaStream(idPurpose) {
        result := ComCall(4, this, "ptr", idPurpose, "ptr*", &ppMediaStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-enummediastreams
     */
    EnumMediaStreams(Index) {
        result := ComCall(5, this, "int", Index, "ptr*", &ppMediaStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-getstate
     */
    GetState() {
        result := ComCall(6, this, "int*", &pCurrentState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-setstate
     */
    SetState(NewState) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-gettime
     */
    GetTime() {
        result := ComCall(8, this, "int64*", &pCurrentTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-getduration
     */
    GetDuration() {
        result := ComCall(9, this, "int64*", &pDuration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-seek
     */
    Seek(SeekTime) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmstream/nf-mmstream-imultimediastream-getendofstreameventhandle
     */
