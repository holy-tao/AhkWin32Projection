 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-icapturegraphbuilder2
...
class ICaptureGraphBuilder2 extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-setfiltergraph
     */
    SetFiltergraph(pfg) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-getfiltergraph
     */
    GetFiltergraph() {
        result := ComCall(4, this, "ptr*", &ppfg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-setoutputfilename
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-findinterface
     */
    FindInterface(pCategory, pType, pf, riid) {
        result := ComCall(6, this, "ptr", pCategory, "ptr", pType, "ptr", pf, "ptr", riid, "ptr*", &ppint := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-renderstream
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-controlstream
     */
    ControlStream(pCategory, pType, pFilter, pstart, pstop, wStartCookie, wStopCookie) {
        ...
        result := ComCall(8, this, "ptr", pCategory, "ptr", pType, "ptr", pFilter, pstartMarshal, pstart, pstopMarshal, pstop, "ushort", wStartCookie, "ushort", wStopCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-alloccapfile
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-copycapturefile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-icapturegraphbuilder2-findpin
     */
    FindPin(pSource, pindir, pCategory, pType, fUnconnected, num) {
        result := ComCall(11, this, "ptr", pSource, "int", pindir, "ptr", pCategory, "ptr", pType, "int", fUnconnected, "int", num, "ptr*", &ppPin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
