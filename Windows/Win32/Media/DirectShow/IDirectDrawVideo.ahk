 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nn-amvideo-idirectdrawvideo
...
class IDirectDrawVideo extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getswitches
     */
    GetSwitches() {
        result := ComCall(3, this, "uint*", &pSwitches := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-setswitches
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getcaps
     */
    GetCaps() {
        pCaps := DDCAPS_DX7()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getemulatedcaps
     */
    GetEmulatedCaps() {
        pCaps := DDCAPS_DX7()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getsurfacedesc
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getfourcccodes
     */
    GetFourCCCodes(pCount, pCodes) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pCodesMarshal := pCodes is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, pCountMarshal, pCount, pCodesMarshal, pCodes, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-setdirectdraw
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getdirectdraw
     */
    GetDirectDraw() {
        result := ComCall(10, this, "ptr*", &ppDirectDraw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-getsurfacetype
     */
    GetSurfaceType() {
        result := ComCall(11, this, "uint*", &pSurfaceType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-setdefault
     */
    SetDefault() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-usescanline
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-canusescanline
     */
    CanUseScanLine() {
        result := ComCall(14, this, "int*", &UseScanLine := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-useoverlaystretch
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-canuseoverlaystretch
     */
    CanUseOverlayStretch() {
        result := ComCall(16, this, "int*", &UseOverlayStretch := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-usewhenfullscreen
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-idirectdrawvideo-willusefullscreen
     */
    WillUseFullScreen() {
        result := ComCall(18, this, "int*", &UseWhenFullScreen := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
