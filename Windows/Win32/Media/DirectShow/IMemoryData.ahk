 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/austream/nn-austream-imemorydata
...
class IMemoryData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/austream/nf-austream-imemorydata-setbuffer
     */
    SetBuffer(cbSize, pbData, dwFlags) {
        pbDataMarshal := pbData is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, "uint", cbSize, pbDataMarshal, pbData, "uint", dwFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/austream/nf-austream-imemorydata-getinfo
     */
    GetInfo(pdwLength, ppbData, pcbActualData) {
        ...
        result := ComCall(4, this, pdwLengthMarshal, pdwLength, ppbDataMarshal, ppbData, pcbActualDataMarshal, pcbActualData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/austream/nf-austream-imemorydata-setactual
     */
