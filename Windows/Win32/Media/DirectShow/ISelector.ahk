...
class ISelector extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-iselector-get_numsources
     */
    get_NumSources() {
        result := ComCall(3, this, "uint*", &pdwNumSources := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-iselector-get_sourcenodeid
     */
    get_SourceNodeId() {
        result := ComCall(4, this, "uint*", &pdwPinId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-iselector-put_sourcenodeid
     */
    put_SourceNodeId(dwPinId) {
        result := ComCall(5, this, "uint", dwPinId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
