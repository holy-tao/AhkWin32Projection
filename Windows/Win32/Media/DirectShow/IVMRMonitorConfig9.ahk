 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nn-vmr9-ivmrmonitorconfig9
...
class IVMRMonitorConfig9 extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmonitorconfig9-setmonitor
     */
    SetMonitor(uDev) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmonitorconfig9-getmonitor
     */
    GetMonitor() {
        result := ComCall(4, this, "uint*", &puDev := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmonitorconfig9-setdefaultmonitor
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmonitorconfig9-getdefaultmonitor
     */
    GetDefaultMonitor() {
        result := ComCall(6, this, "uint*", &puDev := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmonitorconfig9-getavailablemonitors
     */
