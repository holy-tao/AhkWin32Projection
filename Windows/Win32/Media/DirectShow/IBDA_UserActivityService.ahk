 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_useractivityservice
...
class IBDA_UserActivityService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_useractivityservice-setcurrenttunerusereason
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_useractivityservice-getuseractivityinterval
     */
    GetUserActivityInterval() {
        result := ComCall(4, this, "uint*", &pdwActivityInterval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_useractivityservice-useractivitydetected
     */
