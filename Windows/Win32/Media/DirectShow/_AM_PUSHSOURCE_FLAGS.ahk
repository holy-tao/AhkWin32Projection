...
class _AM_PUSHSOURCE_FLAGS extends Win32Enum {
     ...
     * Native name: AM_PUSHSOURCECAPS_INTERNAL_RM
     * @type {Integer (Int32)}
     */
    static PUSHSOURCECAPS_INTERNAL_RM => 1
     ...
     * Native name: AM_PUSHSOURCECAPS_NOT_LIVE
     * @type {Integer (Int32)}
     */
    static PUSHSOURCECAPS_NOT_LIVE => 2
     ...
     * Native name: AM_PUSHSOURCECAPS_PRIVATE_CLOCK
     * @type {Integer (Int32)}
     */
    static PUSHSOURCECAPS_PRIVATE_CLOCK => 4

    /**
     * Reserved; do not use.
     * Native name: AM_PUSHSOURCEREQS_USE_STREAM_CLOCK
     * @type {Integer (Int32)}
     */
    static PUSHSOURCEREQS_USE_STREAM_CLOCK => 65536

    /**
     * Native name: AM_PUSHSOURCEREQS_USE_CLOCK_CHAIN
     * @type {Integer (Int32)}
     */
    static PUSHSOURCEREQS_USE_CLOCK_CHAIN => 131072
}
