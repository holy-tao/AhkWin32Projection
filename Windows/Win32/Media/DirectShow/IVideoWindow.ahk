 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/control/nn-control-ivideowindow
...
class IVideoWindow extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_caption
     */
    put_Caption(strCaption) {
        if(strCaption is String) {
            pin := BSTR.Alloc(strCaption)
            strCaption := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_caption
     */
    get_Caption() {
        strCaption := BSTR()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_windowstyle
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_windowstyle
     */
    get_WindowStyle() {
        result := ComCall(10, this, "int*", &WindowStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_windowstyleex
     */
     ...
     * @returns {Integer} Receives the window style flags.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_windowstyleex
     */
    get_WindowStyleEx() {
        result := ComCall(12, this, "int*", &WindowStyleEx := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_autoshow
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_autoshow
     */
    get_AutoShow() {
        result := ComCall(14, this, "int*", &AutoShow := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_windowstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_windowstate
     */
    get_WindowState() {
        result := ComCall(16, this, "int*", &WindowState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_backgroundpalette
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_backgroundpalette
     */
    get_BackgroundPalette() {
        result := ComCall(18, this, "int*", &pBackgroundPalette := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_visible
     */
    put_Visible(Visible) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_visible
     */
    get_Visible() {
        result := ComCall(20, this, "int*", &pVisible := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_left
     */
    put_Left(Left) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_left
     */
    get_Left() {
        result := ComCall(22, this, "int*", &pLeft := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_width
     */
    put_Width(Width) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_width
     */
    get_Width() {
        result := ComCall(24, this, "int*", &pWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_top
     */
    put_Top(Top) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_top
     */
    get_Top() {
        result := ComCall(26, this, "int*", &pTop := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_height
     */
    put_Height(Height) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_height
     */
    get_Height() {
        result := ComCall(28, this, "int*", &pHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_owner
     */
    put_Owner(Owner) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_owner
     */
    get_Owner() {
        result := ComCall(30, this, "ptr*", &Owner := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_messagedrain
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_messagedrain
     */
    get_MessageDrain() {
        result := ComCall(32, this, "ptr*", &Drain := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_bordercolor
     */
    get_BorderColor() {
        result := ComCall(33, this, "int*", &Color_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Color_ The border color, specified as a <b>COLORREF</b> value.
     * @returns {HRESULT} Possible return values include the following:
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_bordercolor
     */
    put_BorderColor(Color_) {
        result := ComCall(34, this, "int", Color_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-get_fullscreenmode
     */
    get_FullScreenMode() {
        result := ComCall(35, this, "int*", &FullScreenMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-put_fullscreenmode
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-setwindowforeground
     */
     ...
     * </ul>
     * @param {Pointer} hwnd_ A handle to the window, as an <a href="https://docs.microsoft.com/windows/desktop/DirectShow/oahwnd">OAHWND</a> value.
     * @param {Integer} uMsg Specifies the message.
     * @param {Pointer} wParam_ Message parameter.
     * @param {Pointer} lParam_ Message parameter.
     * @returns {HRESULT} Possible return values include the following:
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-notifyownermessage
     */
    NotifyOwnerMessage(hwnd_, uMsg, wParam_, lParam_) {
        result := ComCall(38, this, "ptr", hwnd_, "int", uMsg, "ptr", wParam_, "ptr", lParam_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-setwindowposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-getwindowposition
     */
    GetWindowPosition(pLeft, pTop, pWidth, pHeight) {
        ...
        result := ComCall(40, this, pLeftMarshal, pLeft, pTopMarshal, pTop, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-getminidealimagesize
     */
    GetMinIdealImageSize(pWidth, pHeight) {
        pWidthMarshal := pWidth is VarRef ? "int*" : "ptr"
        pHeightMarshal := pHeight is VarRef ? "int*" : "ptr"

        result := ComCall(41, this, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-getmaxidealimagesize
     */
    GetMaxIdealImageSize(pWidth, pHeight) {
        pWidthMarshal := pWidth is VarRef ? "int*" : "ptr"
        pHeightMarshal := pHeight is VarRef ? "int*" : "ptr"

        result := ComCall(42, this, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-getrestoreposition
     */
    GetRestorePosition(pLeft, pTop, pWidth, pHeight) {
        ...
        result := ComCall(43, this, pLeftMarshal, pLeft, pTopMarshal, pTop, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-hidecursor
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ivideowindow-iscursorhidden
     */
    IsCursorHidden() {
        result := ComCall(45, this, "int*", &CursorHidden := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
