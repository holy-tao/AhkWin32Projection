 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_autodemodulateex
...
class IBDA_AutoDemodulateEx extends IBDA_AutoDemodulate{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_autodemodulateex-get_supporteddevicenodetypes
     */
    get_SupportedDeviceNodeTypes(ulcDeviceNodeTypesMax, pguidDeviceNodeTypes) {
        result := ComCall(4, this, "uint", ulcDeviceNodeTypesMax, "uint*", &pulcDeviceNodeTypes := 0, "ptr", pguidDeviceNodeTypes, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_autodemodulateex-get_supportedvideoformats
     */
    get_SupportedVideoFormats(pulAMTunerModeType, pulAnalogVideoStandard) {
        ...
        result := ComCall(5, this, pulAMTunerModeTypeMarshal, pulAMTunerModeType, pulAnalogVideoStandardMarshal, pulAnalogVideoStandard, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_autodemodulateex-get_auxinputcount
     */
    get_AuxInputCount(pulCompositeCount, pulSvideoCount) {
        ...
        result := ComCall(6, this, pulCompositeCountMarshal, pulCompositeCount, pulSvideoCountMarshal, pulSvideoCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
