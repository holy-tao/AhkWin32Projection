 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nn-amvideo-iqualprop
...
class IQualProp extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_framesdroppedinrenderer
     */
    get_FramesDroppedInRenderer() {
        result := ComCall(3, this, "int*", &pcFrames := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_framesdrawn
     */
    get_FramesDrawn() {
        result := ComCall(4, this, "int*", &pcFramesDrawn := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_avgframerate
     */
    get_AvgFrameRate() {
        result := ComCall(5, this, "int*", &piAvgFrameRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_jitter
     */
    get_Jitter() {
        result := ComCall(6, this, "int*", &iJitter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_avgsyncoffset
     */
    get_AvgSyncOffset() {
        result := ComCall(7, this, "int*", &piAvg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amvideo/nf-amvideo-iqualprop-get_devsyncoffset
     */
    get_DevSyncOffset() {
        result := ComCall(8, this, "int*", &piDev := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
