 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nn-iwstdec-iamwstdecoder
...
class IAMWstDecoder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getdecoderlevel
     */
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getcurrentservice
     */
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getservicestate
     */
    GetServiceState(lpState) {
        lpStateMarshal := lpState is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, lpStateMarshal, lpState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setservicestate
     */
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getoutputformat
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setoutputformat
     */
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getbackgroundcolor
     */
    GetBackgroundColor(pdwPhysColor) {
        pdwPhysColorMarshal := pdwPhysColor is VarRef ? "uint*" : "ptr"

        result := ComCall(9, this, pdwPhysColorMarshal, pdwPhysColor, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setbackgroundcolor
     */
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getredrawalways
     */
    GetRedrawAlways(lpbOption) {
        lpbOptionMarshal := lpbOption is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, lpbOptionMarshal, lpbOption, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setredrawalways
     */
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getdrawbackgroundmode
     */
    GetDrawBackgroundMode(lpMode) {
        lpModeMarshal := lpMode is VarRef ? "int*" : "ptr"

        result := ComCall(13, this, lpModeMarshal, lpMode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Mode_ A member of the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/iwstdec/ne-iwstdec-am_wst_drawbgmode">AM_WST_DRAWBGMODE</a> enumeration that specifies whether the caption text background is to be opaque or transparent.
     * 
     * <table>
     * <tr>
     * <th>Value
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setdrawbackgroundmode
     */
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setanswermode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getanswermode
     */
    GetAnswerMode(pbAnswer) {
        pbAnswerMarshal := pbAnswer is VarRef ? "int*" : "ptr"

        result := ComCall(16, this, pbAnswerMarshal, pbAnswer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setholdpage
     */
     ...
     * </table>
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getholdpage
     */
    GetHoldPage(pbHoldPage) {
        pbHoldPageMarshal := pbHoldPage is VarRef ? "int*" : "ptr"

        result := ComCall(18, this, pbHoldPageMarshal, pbHoldPage, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-getcurrentpage
     */
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/iwstdec/nf-iwstdec-iamwstdecoder-setcurrentpage
     */
