 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamtvtuner
...
class IAMTVTuner extends IAMTuner{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_availabletvformats
     */
    get_AvailableTVFormats() {
        result := ComCall(18, this, "int*", &lAnalogVideoStandard := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_tvformat
     */
    get_TVFormat() {
        result := ComCall(19, this, "int*", &plAnalogVideoStandard := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-autotune
     */
    AutoTune(lChannel) {
        result := ComCall(20, this, "int", lChannel, "int*", &plFoundSignal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-storeautotune
     */
    StoreAutoTune() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_numinputconnections
     */
    get_NumInputConnections() {
        result := ComCall(22, this, "int*", &plNumInputConnections := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-put_inputtype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_inputtype
     */
    get_InputType(lIndex) {
        result := ComCall(24, this, "int", lIndex, "int*", &pInputType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-put_connectinput
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_connectinput
     */
    get_ConnectInput() {
        result := ComCall(26, this, "int*", &plIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_videofrequency
     */
    get_VideoFrequency() {
        result := ComCall(27, this, "int*", &lFreq := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtvtuner-get_audiofrequency
     */
    get_AudioFrequency() {
        result := ComCall(28, this, "int*", &lFreq := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
