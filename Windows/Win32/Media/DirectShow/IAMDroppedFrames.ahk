 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamdroppedframes
...
class IAMDroppedFrames extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdroppedframes-getnumdropped
     */
    GetNumDropped() {
        result := ComCall(3, this, "int*", &plDropped := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdroppedframes-getnumnotdropped
     */
    GetNumNotDropped() {
        result := ComCall(4, this, "int*", &plNotDropped := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdroppedframes-getdroppedinfo
     */
    GetDroppedInfo(lSize, plArray, plNumCopied) {
        ...
        result := ComCall(5, this, "int", lSize, plArrayMarshal, plArray, plNumCopiedMarshal, plNumCopied, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdroppedframes-getaverageframesize
     */
    GetAverageFrameSize() {
        result := ComCall(6, this, "int*", &plAverageSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
