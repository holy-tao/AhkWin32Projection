 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-imediasample2config
...
class IMediaSample2Config extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediasample2config-getsurface
     */
    GetSurface() {
        result := ComCall(3, this, "ptr*", &ppDirect3DSurface9 := 0, "int")
        if(result != 0) {
