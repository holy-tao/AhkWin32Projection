 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iconfiginterleaving
...
class IConfigInterleaving extends IUnknown{
     ...
     * @param {Integer} mode_ Interleaving quality setting specified in the <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ne-strmif-interleavingmode">InterleavingMode</a> enumeration.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfiginterleaving-put_mode
     */
    put_Mode(mode_) {
        result := ComCall(3, this, "int", mode_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfiginterleaving-get_mode
     */
    get_Mode() {
        result := ComCall(4, this, "int*", &pMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfiginterleaving-put_interleaving
     */
    put_Interleaving(prtInterleave, prtPreroll) {
        ...
        result := ComCall(5, this, prtInterleaveMarshal, prtInterleave, prtPrerollMarshal, prtPreroll, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfiginterleaving-get_interleaving
     */
    get_Interleaving(prtInterleave, prtPreroll) {
        prtInterleaveMarshal := prtInterleave is VarRef ? "int64*" : "ptr"
        prtPrerollMarshal := prtPreroll is VarRef ? "int64*" : "ptr"

        result := ComCall(6, this, prtInterleaveMarshal, prtInterleave, prtPrerollMarshal, prtPreroll, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
