 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-imediaseeking
...
class IMediaSeeking extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getcapabilities
     */
    GetCapabilities() {
        result := ComCall(3, this, "uint*", &pCapabilities := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-checkcapabilities
     */
    CheckCapabilities(pCapabilities) {
        pCapabilitiesMarshal := pCapabilities is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, pCapabilitiesMarshal, pCapabilities, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-isformatsupported
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-querypreferredformat
     */
     ...
     * @returns {Guid} Pointer to a variable that receives a GUID specifying the time format. See <a href="https://docs.microsoft.com/windows/desktop/DirectShow/time-format-guids">Time Format GUIDs</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-gettimeformat
     */
    GetTimeFormat() {
        pFormat := Guid()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-isusingtimeformat
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-settimeformat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getduration
     */
    GetDuration() {
        result := ComCall(10, this, "int64*", &pDuration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getstopposition
     */
    GetStopPosition() {
        result := ComCall(11, this, "int64*", &pStop := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getcurrentposition
     */
    GetCurrentPosition() {
        result := ComCall(12, this, "int64*", &pCurrent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-converttimeformat
     */
    ConvertTimeFormat(pTargetFormat, Source, pSourceFormat) {
        result := ComCall(13, this, "int64*", &pTarget := 0, "ptr", pTargetFormat, "int64", Source, "ptr", pSourceFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-setpositions
     */
    SetPositions(pCurrent, dwCurrentFlags, pStop, dwStopFlags) {
        ...
        result := ComCall(14, this, pCurrentMarshal, pCurrent, "uint", dwCurrentFlags, pStopMarshal, pStop, "uint", dwStopFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getpositions
     */
    GetPositions(pCurrent, pStop) {
        pCurrentMarshal := pCurrent is VarRef ? "int64*" : "ptr"
        pStopMarshal := pStop is VarRef ? "int64*" : "ptr"

        result := ComCall(15, this, pCurrentMarshal, pCurrent, pStopMarshal, pStop, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getavailable
     */
    GetAvailable(pEarliest, pLatest) {
        pEarliestMarshal := pEarliest is VarRef ? "int64*" : "ptr"
        pLatestMarshal := pLatest is VarRef ? "int64*" : "ptr"

        result := ComCall(16, this, pEarliestMarshal, pEarliest, pLatestMarshal, pLatest, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-setrate
     */
    SetRate(dRate) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getrate
     */
    GetRate() {
        result := ComCall(18, this, "double*", &pdRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imediaseeking-getpreroll
     */
    GetPreroll() {
        result := ComCall(19, this, "int64*", &pllPreroll := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
