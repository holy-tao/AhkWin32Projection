 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamanalogvideoencoder
...
class IAMAnalogVideoEncoder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-get_availabletvformats
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-put_tvformat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-get_tvformat
     */
    get_TVFormat() {
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-put_copyprotection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-get_copyprotection
     */
    get_CopyProtection() {
        result := ComCall(7, this, "int*", &lVideoCopyProtection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-put_ccenable
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamanalogvideoencoder-get_ccenable
     */
    get_CCEnable() {
        result := ComCall(9, this, "int*", &lCCEnable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
