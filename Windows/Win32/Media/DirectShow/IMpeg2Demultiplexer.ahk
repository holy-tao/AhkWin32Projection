 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-impeg2demultiplexer
...
class IMpeg2Demultiplexer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-impeg2demultiplexer-createoutputpin
     */
    CreateOutputPin(pMediaType, pszPinName) {
        pszPinName := pszPinName is String ? StrPtr(pszPinName) : pszPinName

        result := ComCall(3, this, "ptr", pMediaType, "ptr", pszPinName, "ptr*", &ppIPin := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-impeg2demultiplexer-setoutputpinmediatype
     */
     ...
     * @param {PWSTR} pszPinName The friendly name of the pin as specified when the pin was created in a call to <b>CreateOutputPin</b>.
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-impeg2demultiplexer-deleteoutputpin
     */
