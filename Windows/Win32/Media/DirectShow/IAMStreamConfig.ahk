...
class IAMStreamConfig extends IUnknown{
     ...
     */
    GetFormat(ppmt) {
        result := ComCall(4, this, "ptr", ppmt, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int32>} piCount 
     * @param {Pointer<Int32>} piSize 
     * @returns {HRESULT} 
     */
    GetNumberOfCapabilities(piCount, piSize) {
        result := ComCall(5, this, "int*", piCount, "int*", piSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<AM_MEDIA_TYPE>} ppmt 
     * @param {Pointer<Byte>} pSCC 
     * @returns {HRESULT} 
     */
    GetStreamCaps(iIndex, ppmt, pSCC) {
        result := ComCall(6, this, "int", iIndex, "ptr", ppmt, "char*", pSCC, "int")
        if(result != 0)
            throw OSError(result)
