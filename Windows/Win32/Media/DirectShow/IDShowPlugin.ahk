 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nn-qnetwork-idshowplugin
...
class IDShowPlugin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-idshowplugin-get_url
     */
    get_URL(pURL) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-idshowplugin-get_useragent
     */
