 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-imemallocatorcallbacktemp
...
class IMemAllocatorCallbackTemp extends IMemAllocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocatorcallbacktemp-setnotify
     */
    SetNotify(pNotify) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocatorcallbacktemp-getfreecount
     */
    GetFreeCount() {
        result := ComCall(10, this, "int*", &plBuffersFree := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
