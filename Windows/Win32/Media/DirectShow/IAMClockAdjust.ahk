 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamclockadjust
...
class IAMClockAdjust extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamclockadjust-setclockdelta
     */
    SetClockDelta(rtDelta) {
        result := ComCall(3, this, "int64", rtDelta, "int")
        if(result != 0) {
