 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamresourcecontrol
...
class IAMResourceControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamresourcecontrol-reserve
     */
    Reserve(dwFlags) {
        static pvReserved := 0 ;Reserved parameters must always be NULL

        result := ComCall(3, this, "uint", dwFlags, "ptr", pvReserved, "int")
        if(result != 0) {
