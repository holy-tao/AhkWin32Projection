 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_eventingservice
...
class IBDA_EventingService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_eventingservice-completeevent
     */
    CompleteEvent(ulEventID, ulEventResult) {
        result := ComCall(3, this, "uint", ulEventID, "uint", ulEventResult, "int")
        if(result != 0) {
