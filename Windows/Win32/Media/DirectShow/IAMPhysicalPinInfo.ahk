 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamphysicalpininfo
...
class IAMPhysicalPinInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamphysicalpininfo-getphysicaltype
     */
    GetPhysicalType(pType, ppszType) {
        pTypeMarshal := pType is VarRef ? "int*" : "ptr"
        ppszTypeMarshal := ppszType is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, pTypeMarshal, pType, ppszTypeMarshal, ppszType, "int")
        if(result != 0) {
