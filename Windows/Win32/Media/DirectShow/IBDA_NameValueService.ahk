 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_namevalueservice
...
class IBDA_NameValueService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_namevalueservice-getvaluenamebyindex
     */
    GetValueNameByIndex(ulIndex) {
        pbstrName := BSTR()
        result := ComCall(3, this, "uint", ulIndex, "ptr", pbstrName, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_namevalueservice-getvalue
     */
    GetValue(bstrName, bstrLanguage) {
        ...
        pbstrValue := BSTR()
        result := ComCall(4, this, "ptr", bstrName, "ptr", bstrLanguage, "ptr", pbstrValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_namevalueservice-setvalue
     */
    SetValue(ulDialogRequest, bstrLanguage, bstrName, bstrValue, ulReserved) {
        ...
        result := ComCall(5, this, "uint", ulDialogRequest, "ptr", bstrLanguage, "ptr", bstrName, "ptr", bstrValue, "uint", ulReserved, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
