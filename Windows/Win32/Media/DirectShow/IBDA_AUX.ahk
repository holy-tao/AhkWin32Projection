 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_aux
...
class IBDA_AUX extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_aux-querycapabilities
     */
    QueryCapabilities() {
        result := ComCall(3, this, "uint*", &pdwNumAuxInputsBSTR := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_aux-enumcapability
     */
    EnumCapability(dwIndex, dwInputID, pConnectorType, ConnTypeNum, NumVideoStds, AnalogStds) {
        ...
        result := ComCall(4, this, "uint", dwIndex, dwInputIDMarshal, dwInputID, "ptr", pConnectorType, ConnTypeNumMarshal, ConnTypeNum, NumVideoStdsMarshal, NumVideoStds, AnalogStdsMarshal, AnalogStds, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
