 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ienumpins
...
class IEnumPins extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumpins-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumpins-skip
     */
    Skip(cPins) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumpins-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ienumpins-clone
     */
    Clone() {
