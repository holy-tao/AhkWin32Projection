 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nn-qnetwork-iamnetshowconfig
...
class IAMNetShowConfig extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_bufferingtime
     */
    get_BufferingTime(pBufferingTime) {
        pBufferingTimeMarshal := pBufferingTime is VarRef ? "double*" : "ptr"

        result := ComCall(7, this, pBufferingTimeMarshal, pBufferingTime, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_bufferingtime
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_usefixedudpport
     */
    get_UseFixedUDPPort(pUseFixedUDPPort) {
        pUseFixedUDPPortMarshal := pUseFixedUDPPort is VarRef ? "short*" : "ptr"

        result := ComCall(9, this, pUseFixedUDPPortMarshal, pUseFixedUDPPort, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_usefixedudpport
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_fixedudpport
     */
    get_FixedUDPPort(pFixedUDPPort) {
        pFixedUDPPortMarshal := pFixedUDPPort is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, pFixedUDPPortMarshal, pFixedUDPPort, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_fixedudpport
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_usehttpproxy
     */
    get_UseHTTPProxy(pUseHTTPProxy) {
        pUseHTTPProxyMarshal := pUseHTTPProxy is VarRef ? "short*" : "ptr"

        result := ComCall(13, this, pUseHTTPProxyMarshal, pUseHTTPProxy, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_usehttpproxy
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_enableautoproxy
     */
    get_EnableAutoProxy(pEnableAutoProxy) {
        pEnableAutoProxyMarshal := pEnableAutoProxy is VarRef ? "short*" : "ptr"

        result := ComCall(15, this, pEnableAutoProxyMarshal, pEnableAutoProxy, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_enableautoproxy
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_httpproxyhost
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_httpproxyhost
     */
    put_HTTPProxyHost(bstrHTTPProxyHost) {
        if(bstrHTTPProxyHost is String) {
            pin := BSTR.Alloc(bstrHTTPProxyHost)
            bstrHTTPProxyHost := pin.Value
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_httpproxyport
     */
    get_HTTPProxyPort(pHTTPProxyPort) {
        pHTTPProxyPortMarshal := pHTTPProxyPort is VarRef ? "int*" : "ptr"

        result := ComCall(19, this, pHTTPProxyPortMarshal, pHTTPProxyPort, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_httpproxyport
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_enablemulticast
     */
    get_EnableMulticast(pEnableMulticast) {
        pEnableMulticastMarshal := pEnableMulticast is VarRef ? "short*" : "ptr"

        result := ComCall(21, this, pEnableMulticastMarshal, pEnableMulticast, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_enablemulticast
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_enableudp
     */
    get_EnableUDP(pEnableUDP) {
        pEnableUDPMarshal := pEnableUDP is VarRef ? "short*" : "ptr"

        result := ComCall(23, this, pEnableUDPMarshal, pEnableUDP, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_enableudp
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_enabletcp
     */
    get_EnableTCP(pEnableTCP) {
        pEnableTCPMarshal := pEnableTCP is VarRef ? "short*" : "ptr"

        result := ComCall(25, this, pEnableTCPMarshal, pEnableTCP, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_enabletcp
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-get_enablehttp
     */
    get_EnableHTTP(pEnableHTTP) {
        pEnableHTTPMarshal := pEnableHTTP is VarRef ? "short*" : "ptr"

        result := ComCall(27, this, pEnableHTTPMarshal, pEnableHTTP, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowconfig-put_enablehttp
     */
