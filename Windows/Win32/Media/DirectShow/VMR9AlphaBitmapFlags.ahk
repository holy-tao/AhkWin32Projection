...
class VMR9AlphaBitmapFlags extends Win32Enum {
     ...
     * Native name: VMR9AlphaBitmap_Disable
     * @type {Integer (Int32)}
     */
    static Disable => 1
     ...
     * Native name: VMR9AlphaBitmap_hDC
     * @type {Integer (Int32)}
     */
    static hDC => 2
     ...
     * Native name: VMR9AlphaBitmap_EntireDDS
     * @type {Integer (Int32)}
     */
    static EntireDDS => 4
     ...
     * Native name: VMR9AlphaBitmap_SrcColorKey
     * @type {Integer (Int32)}
     */
    static SrcColorKey => 8
     ...
     * Native name: VMR9AlphaBitmap_SrcRect
     * @type {Integer (Int32)}
     */
    static SrcRect => 16
     ...
     * Native name: VMR9AlphaBitmap_FilterMode
     * @type {Integer (Int32)}
     */
    static FilterMode => 32
}
