 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-idvdcmd
...
class IDvdCmd extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdcmd-waitforstart
     */
    WaitForStart() {
     ...
     * @returns {HRESULT} Returns S_OK if successful or an <b>HRESULT</b> error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdcmd-waitforend
     */
    WaitForEnd() {
