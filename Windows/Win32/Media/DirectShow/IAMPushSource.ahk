...
class IAMPushSource extends IAMLatency{
     ...
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-getpushsourceflags
     */
    GetPushSourceFlags() {
     ...
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-setpushsourceflags
     */
     ...
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-setstreamoffset
     */
     ...
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-getstreamoffset
     */
    GetStreamOffset() {
     ...
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-getmaxstreamoffset
     */
    GetMaxStreamOffset() {
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://docs.microsoft.com/windows/win32/api//strmif/nf-strmif-iampushsource-setmaxstreamoffset
     */
