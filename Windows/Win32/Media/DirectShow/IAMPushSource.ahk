...
class IAMPushSource extends IAMLatency{
    ...
    SetPushSourceFlags(Flags) {
        result := ComCall(5, this, "uint", Flags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetStreamOffset(rtOffset) {
        result := ComCall(6, this, "int64", rtOffset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int64>} prtOffset 
     * @returns {HRESULT} 
     */
    GetStreamOffset(prtOffset) {
        result := ComCall(7, this, "int64*", prtOffset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int64>} prtMaxOffset 
     * @returns {HRESULT} 
     */
    GetMaxStreamOffset(prtMaxOffset) {
        result := ComCall(8, this, "int64*", prtMaxOffset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetMaxStreamOffset(rtMaxOffset) {
        result := ComCall(9, this, "int64", rtMaxOffset, "int")
        if(result != 0)
            throw OSError(result)
