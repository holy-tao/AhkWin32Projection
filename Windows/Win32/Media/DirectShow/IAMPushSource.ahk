 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iampushsource
...
class IAMPushSource extends IAMLatency{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-getpushsourceflags
     */
    GetPushSourceFlags() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-setpushsourceflags
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-setstreamoffset
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-getstreamoffset
     */
    GetStreamOffset() {
        result := ComCall(7, this, "int64*", &prtOffset := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-getmaxstreamoffset
     */
    GetMaxStreamOffset() {
        result := ComCall(8, this, "int64*", &prtMaxOffset := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iampushsource-setmaxstreamoffset
     */
