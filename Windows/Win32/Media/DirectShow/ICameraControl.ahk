 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nn-vidcap-icameracontrol
...
class ICameraControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_exposure
     */
    get_Exposure(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_exposure
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_exposure
     */
    getRange_Exposure(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(5, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_focus
     */
    get_Focus(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_focus
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_focus
     */
    getRange_Focus(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(8, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_iris
     */
    get_Iris(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(9, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_iris
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_iris
     */
    getRange_Iris(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(11, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_zoom
     */
    get_Zoom(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(12, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_zoom
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_zoom
     */
    getRange_Zoom(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(14, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_focallengths
     */
    get_FocalLengths(plOcularFocalLength, plObjectiveFocalLengthMin, plObjectiveFocalLengthMax) {
        ...
        result := ComCall(15, this, plOcularFocalLengthMarshal, plOcularFocalLength, plObjectiveFocalLengthMinMarshal, plObjectiveFocalLengthMin, plObjectiveFocalLengthMaxMarshal, plObjectiveFocalLengthMax, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_pan
     */
    get_Pan(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(16, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_pan
     */
    put_Pan(Value, Flags) {
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_pan
     */
    getRange_Pan(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(18, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_tilt
     */
    get_Tilt(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(19, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_tilt
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_tilt
     */
    getRange_Tilt(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(21, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_pantilt
     */
    get_PanTilt(pPanValue, pTiltValue, pFlags) {
        ...
        result := ComCall(22, this, pPanValueMarshal, pPanValue, pTiltValueMarshal, pTiltValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_pantilt
     */
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_roll
     */
    get_Roll(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(24, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_roll
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_roll
     */
    getRange_Roll(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(26, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_exposurerelative
     */
    get_ExposureRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(27, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_exposurerelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_exposurerelative
     */
    getRange_ExposureRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(29, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_focusrelative
     */
    get_FocusRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(30, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_focusrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_focusrelative
     */
    getRange_FocusRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(32, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_irisrelative
     */
    get_IrisRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(33, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_irisrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_irisrelative
     */
    getRange_IrisRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(35, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_zoomrelative
     */
    get_ZoomRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(36, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_zoomrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_zoomrelative
     */
    getRange_ZoomRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(38, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_panrelative
     */
    get_PanRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(39, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_panrelative
     */
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_tiltrelative
     */
    get_TiltRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(41, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_tiltrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_tiltrelative
     */
    getRange_TiltRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(43, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_pantiltrelative
     */
    get_PanTiltRelative(pPanValue, pTiltValue, pFlags) {
        ...
        result := ComCall(44, this, pPanValueMarshal, pPanValue, pTiltValueMarshal, pTiltValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_pantiltrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_panrelative
     */
    getRange_PanRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(46, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_rollrelative
     */
    get_RollRelative(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(47, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_rollrelative
     */
     ...
     * @param {Pointer<Integer>} pCapsFlag Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-getrange_rollrelative
     */
    getRange_RollRelative(pMin, pMax, pSteppingDelta, pDefault, pCapsFlag) {
        ...
        result := ComCall(49, this, pMinMarshal, pMin, pMaxMarshal, pMax, pSteppingDeltaMarshal, pSteppingDelta, pDefaultMarshal, pDefault, pCapsFlagMarshal, pCapsFlag, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_scanmode
     */
    get_ScanMode(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(50, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_scanmode
     */
     ...
     * @param {Pointer<Integer>} pFlags Receives one or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-get_privacymode
     */
    get_PrivacyMode(pValue, pFlags) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pFlagsMarshal := pFlags is VarRef ? "int*" : "ptr"

        result := ComCall(52, this, pValueMarshal, pValue, pFlagsMarshal, pFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Flags Zero or more flags. See <a href="https://docs.microsoft.com/windows/win32/api/strmif/ne-strmif-cameracontrolflags">CameraControlFlags</a>. If the CameraControl_Flags_Auto flag is used, the <i>Value</i> parameter is ignored and the camera sets the default value.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/vidcap/nf-vidcap-icameracontrol-put_privacymode
     */
