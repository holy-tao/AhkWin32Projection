...
class IMediaControl extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-run
     */
    Run() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-pause
     */
    Pause() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-stop
     */
    Stop() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-getstate
     */
    GetState(msTimeout) {
        result := ComCall(10, this, "int", msTimeout, "int*", &pfs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-renderfile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-addsourcefilter
     */
    AddSourceFilter(strFilename) {
        ...
        result := ComCall(12, this, "ptr", strFilename, "ptr*", &ppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-get_filtercollection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-get_regfiltercollection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediacontrol-stopwhenready
     */
    StopWhenReady() {
