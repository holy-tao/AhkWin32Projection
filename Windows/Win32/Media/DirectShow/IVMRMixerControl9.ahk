 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nn-vmr9-ivmrmixercontrol9
...
class IVMRMixerControl9 extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setalpha
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getalpha
     */
    GetAlpha(dwStreamID) {
        result := ComCall(4, this, "uint", dwStreamID, "float*", &pAlpha := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setzorder
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getzorder
     */
    GetZOrder(dwStreamID) {
        result := ComCall(6, this, "uint", dwStreamID, "uint*", &pZ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setoutputrect
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getoutputrect
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setbackgroundclr
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getbackgroundclr
     */
    GetBackgroundClr(lpClrBkg) {
        lpClrBkgMarshal := lpClrBkg is VarRef ? "uint*" : "ptr"

        result := ComCall(10, this, lpClrBkgMarshal, lpClrBkg, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setmixingprefs
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getmixingprefs
     */
    GetMixingPrefs() {
        result := ComCall(12, this, "uint*", &pdwMixerPrefs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-setprocampcontrol
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getprocampcontrol
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrmixercontrol9-getprocampcontrolrange
     */
