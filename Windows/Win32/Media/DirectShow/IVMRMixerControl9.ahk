...
export default struct IVMRMixerControl9 extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetProcAmpControl := CallbackCreate(ObjBindMethod(implObj, "SetProcAmpControl"), flags, 3)
        this.vtbl.GetProcAmpControl := CallbackCreate(ObjBindMethod(implObj, "GetProcAmpControl"), flags, 3)
        this.vtbl.GetProcAmpControlRange := CallbackCreate(ObjBindMethod(implObj, "GetProcAmpControlRange"), flags, 3)
    }
