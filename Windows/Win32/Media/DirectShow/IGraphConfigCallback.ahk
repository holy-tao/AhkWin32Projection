 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-igraphconfigcallback
...
class IGraphConfigCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-igraphconfigcallback-reconfigure
     */
    Reconfigure(pvContext, dwFlags) {
        pvContextMarshal := pvContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, pvContextMarshal, pvContext, "uint", dwFlags, "int")
        if(result != 0) {
