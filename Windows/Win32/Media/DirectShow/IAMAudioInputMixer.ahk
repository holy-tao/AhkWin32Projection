 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamaudioinputmixer
...
class IAMAudioInputMixer extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_enable
     */
    put_Enable(fEnable) {
     ...
     * This method applies to specific input pins on the <a href="https://docs.microsoft.com/windows/desktop/DirectShow/audio-capture-filter">Audio Capture Filter</a>, so the filter itself returns E_NOTIMPL.
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_enable
     */
    get_Enable() {
        result := ComCall(4, this, "int*", &pfEnable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_mono
     */
    put_Mono(fMono) {
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_mono
     */
    get_Mono() {
        result := ComCall(6, this, "int*", &pfMono := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_mixlevel
     */
    put_MixLevel(Level) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_mixlevel
     */
    get_MixLevel() {
        result := ComCall(8, this, "double*", &pLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_pan
     */
    put_Pan(Pan) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_pan
     */
    get_Pan() {
        result := ComCall(10, this, "double*", &pPan := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_loudness
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_loudness
     */
    get_Loudness() {
        result := ComCall(12, this, "int*", &pfLoudness := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_treble
     */
    put_Treble(Treble) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_treble
     */
    get_Treble() {
        result := ComCall(14, this, "double*", &pTreble := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_treblerange
     */
    get_TrebleRange() {
        result := ComCall(15, this, "double*", &pRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-put_bass
     */
    put_Bass(Bass) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_bass
     */
    get_Bass() {
        result := ComCall(17, this, "double*", &pBass := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamaudioinputmixer-get_bassrange
     */
    get_BassRange() {
        result := ComCall(18, this, "double*", &pRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
