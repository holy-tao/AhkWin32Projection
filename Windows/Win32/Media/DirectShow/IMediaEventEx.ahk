 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/control/nn-control-imediaeventex
...
class IMediaEventEx extends IMediaEvent{
     ...
     * @param {Pointer} hwnd_ Handle to the window, or <b>NULL</b> to stop receiving event messages.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaeventex-setnotifywindow
     */
    SetNotifyWindow(hwnd_, lMsg, lInstanceData) {
        result := ComCall(13, this, "ptr", hwnd_, "int", lMsg, "ptr", lInstanceData, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaeventex-setnotifyflags
     */
     ...
     * If event notifications are disabled, the handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/control/nf-control-imediaevent-geteventhandle">IMediaEvent::GetEventHandle</a> method is signaled at the end of each stream—that is, whenever the Filter Graph Manager receives an <a href="https://docs.microsoft.com/windows/desktop/DirectShow/ec-complete">EC_COMPLETE</a> event.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaeventex-getnotifyflags
     */
    GetNotifyFlags() {
        result := ComCall(15, this, "int*", &lplNoNotifyFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
