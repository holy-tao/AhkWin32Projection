 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/control/nn-control-imediaevent
...
class IMediaEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-geteventhandle
     */
    GetEventHandle() {
        result := ComCall(7, this, "ptr*", &hEvent := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-getevent
     */
    GetEvent(lEventCode, lParam1, lParam2, msTimeout) {
        ...
        result := ComCall(8, this, lEventCodeMarshal, lEventCode, lParam1Marshal, lParam1, lParam2Marshal, lParam2, "int", msTimeout, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-waitforcompletion
     */
    WaitForCompletion(msTimeout) {
        result := ComCall(9, this, "int", msTimeout, "int*", &pEvCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-canceldefaulthandling
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-restoredefaulthandling
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-imediaevent-freeeventparams
     */
