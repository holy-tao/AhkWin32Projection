 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iipdvdec
...
class IIPDVDec extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iipdvdec-get_ipdisplay
     */
    get_IPDisplay() {
        result := ComCall(3, this, "int*", &displayPix := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iipdvdec-put_ipdisplay
     */
