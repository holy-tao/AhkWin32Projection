 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamexttransport
...
class IAMExtTransport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-getcapability
     */
    GetCapability(Capability, pValue, pdblValue) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pdblValueMarshal := pdblValue is VarRef ? "double*" : "ptr"

        result := ComCall(3, this, "int", Capability, pValueMarshal, pValue, pdblValueMarshal, pdblValue, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_mediastate
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_mediastate
     */
    get_MediaState() {
     ...
     * </table>
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_localcontrol
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/DirectShow/msdv-driver">MSDV</a> does not support this method. It returns E_NOTIMPL.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_localcontrol
     */
    get_LocalControl() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-getstatus
     */
    GetStatus(StatusItem) {
        result := ComCall(8, this, "int", StatusItem, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-gettransportbasicparameters
     */
    GetTransportBasicParameters(Param, pValue, ppszData) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        ppszDataMarshal := ppszData is VarRef ? "ptr*" : "ptr"

        result := ComCall(9, this, "int", Param, pValueMarshal, pValue, ppszDataMarshal, ppszData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-settransportbasicparameters
     */
    SetTransportBasicParameters(Param, Value, pszData) {
        pszData := pszData is String ? StrPtr(pszData) : pszData

        result := ComCall(10, this, "int", Param, "int", Value, "ptr", pszData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-gettransportvideoparameters
     */
    GetTransportVideoParameters(Param) {
        result := ComCall(11, this, "int", Param, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-settransportvideoparameters
     */
    SetTransportVideoParameters(Param, Value) {
        result := ComCall(12, this, "int", Param, "int", Value, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-gettransportaudioparameters
     */
    GetTransportAudioParameters(Param) {
        result := ComCall(13, this, "int", Param, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-settransportaudioparameters
     */
    SetTransportAudioParameters(Param, Value) {
        result := ComCall(14, this, "int", Param, "int", Value, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_mode
     */
    put_Mode(Mode_) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_mode
     */
    get_Mode() {
        result := ComCall(16, this, "int*", &pMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_rate
     */
    put_Rate(dblRate) {
        result := ComCall(17, this, "double", dblRate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_rate
     */
    get_Rate() {
        result := ComCall(18, this, "double*", &pdblRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-getchase
     */
    GetChase(pEnabled, pOffset, phEvent) {
        ...
        result := ComCall(19, this, pEnabledMarshal, pEnabled, pOffsetMarshal, pOffset, phEventMarshal, phEvent, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-setchase
     */
    SetChase(Enable, Offset, hEvent) {
        result := ComCall(20, this, "int", Enable, "int", Offset, "ptr", hEvent, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-getbump
     */
    GetBump(pSpeed, pDuration) {
        pSpeedMarshal := pSpeed is VarRef ? "int*" : "ptr"
        pDurationMarshal := pDuration is VarRef ? "int*" : "ptr"

        result := ComCall(21, this, pSpeedMarshal, pSpeed, pDurationMarshal, pDuration, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-setbump
     */
    SetBump(Speed, Duration) {
        result := ComCall(22, this, "int", Speed, "int", Duration, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_anticlogcontrol
     */
    get_AntiClogControl() {
        result := ComCall(23, this, "int*", &pEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_anticlogcontrol
     */
    put_AntiClogControl(Enable) {
        result := ComCall(24, this, "int", Enable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-geteditpropertyset
     */
    GetEditPropertySet(EditID) {
        result := ComCall(25, this, "int", EditID, "int*", &pState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-seteditpropertyset
     */
    SetEditPropertySet(pEditID, State) {
        pEditIDMarshal := pEditID is VarRef ? "int*" : "ptr"

        result := ComCall(26, this, pEditIDMarshal, pEditID, "int", State, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-geteditproperty
     */
    GetEditProperty(EditID, Param) {
        result := ComCall(27, this, "int", EditID, "int", Param, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-seteditproperty
     */
    SetEditProperty(EditID, Param, Value) {
        result := ComCall(28, this, "int", EditID, "int", Param, "int", Value, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-get_editstart
     */
    get_EditStart() {
        result := ComCall(29, this, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} When this method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamexttransport-put_editstart
     */
    put_EditStart(Value) {
