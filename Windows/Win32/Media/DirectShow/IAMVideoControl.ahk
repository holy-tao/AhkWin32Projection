 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamvideocontrol
...
class IAMVideoControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-getcaps
     */
    GetCaps(pPin) {
        result := ComCall(3, this, "ptr", pPin, "int*", &pCapsFlags := 0, "int")
        if(result != 0) {
     ...
     * @param {Integer} Mode_ Value specifying a combination of the flags from the [VideoControlFlags](/windows/desktop/api/strmif/ne-strmif-videocontrolflags) enumeration to set the video control mode.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-setmode
     */
    SetMode(pPin, Mode_) {
        result := ComCall(4, this, "ptr", pPin, "int", Mode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-getmode
     */
    GetMode(pPin) {
        result := ComCall(5, this, "ptr", pPin, "int*", &Mode_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-getcurrentactualframerate
     */
    GetCurrentActualFrameRate(pPin) {
        result := ComCall(6, this, "ptr", pPin, "int64*", &ActualFrameRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-getmaxavailableframerate
     */
    GetMaxAvailableFrameRate(pPin, iIndex, Dimensions) {
        result := ComCall(7, this, "ptr", pPin, "int", iIndex, "ptr", Dimensions, "int64*", &MaxAvailableFrameRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value that depends on the implementation of the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideocontrol-getframeratelist
     */
    GetFrameRateList(pPin, iIndex, Dimensions, ListSize, FrameRates) {
        ...
        result := ComCall(8, this, "ptr", pPin, "int", iIndex, "ptr", Dimensions, ListSizeMarshal, ListSize, FrameRatesMarshal, FrameRates, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
