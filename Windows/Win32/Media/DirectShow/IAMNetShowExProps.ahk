 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nn-qnetwork-iamnetshowexprops
...
class IAMNetShowExProps extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_sourceprotocol
     */
    get_SourceProtocol(pSourceProtocol) {
        pSourceProtocolMarshal := pSourceProtocol is VarRef ? "int*" : "ptr"

        result := ComCall(7, this, pSourceProtocolMarshal, pSourceProtocol, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_bandwidth
     */
    get_Bandwidth(pBandwidth) {
        pBandwidthMarshal := pBandwidth is VarRef ? "int*" : "ptr"

        result := ComCall(8, this, pBandwidthMarshal, pBandwidth, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_errorcorrection
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_codeccount
     */
    get_CodecCount(pCodecCount) {
        pCodecCountMarshal := pCodecCount is VarRef ? "int*" : "ptr"

        result := ComCall(10, this, pCodecCountMarshal, pCodecCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-getcodecinstalled
     */
    GetCodecInstalled(CodecNum, pCodecInstalled) {
        pCodecInstalledMarshal := pCodecInstalled is VarRef ? "short*" : "ptr"

        result := ComCall(11, this, "int", CodecNum, pCodecInstalledMarshal, pCodecInstalled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-getcodecdescription
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-getcodecurl
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_creationdate
     */
    get_CreationDate(pCreationDate) {
        pCreationDateMarshal := pCreationDate is VarRef ? "double*" : "ptr"

        result := ComCall(14, this, pCreationDateMarshal, pCreationDate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/qnetwork/nf-qnetwork-iamnetshowexprops-get_sourcelink
     */
