 ...
 */
export default struct IAMCollection extends IDispatch {
    /**
     ...
     * used for IAMCollection interfaces
    */
     ...
     */
    Item(_lItem) {
        result := ComCall(8, this, Int32, _lItem, "ptr*", &ppUnk := 0, "HRESULT")
    ...
    Query(iid) {
        if (IAMCollection.IID.Equals(iid)) {
            return true
        }
