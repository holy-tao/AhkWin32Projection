 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ifiltergraph
...
class IFilterGraph extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-addfilter
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-removefilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-enumfilters
     */
    EnumFilters() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-findfilterbyname
     */
    FindFilterByName(pName) {
        pName := pName is String ? StrPtr(pName) : pName

        result := ComCall(6, this, "ptr", pName, "ptr*", &ppFilter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-connectdirect
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-reconnect
     */
    Reconnect(ppin) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-disconnect
     */
    Disconnect(ppin) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltergraph-setdefaultsyncsource
     */
