 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nn-amstream-imediastreamfilter
...
class IMediaStreamFilter extends IBaseFilter{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-addmediastream
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-getmediastream
     */
    GetMediaStream(idPurpose) {
        result := ComCall(16, this, "ptr", idPurpose, "ptr*", &ppMediaStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IMediaStream} Address of a variable that receives an <a href="https://docs.microsoft.com/windows/desktop/api/mmstream/nn-mmstream-imediastream">IMediaStream</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-enummediastreams
     */
    EnumMediaStreams(Index) {
        result := ComCall(17, this, "int", Index, "ptr*", &ppMediaStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-supportseeking
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-referencetimetostreamtime
     */
    ReferenceTimeToStreamTime(pTime) {
        pTimeMarshal := pTime is VarRef ? "int64*" : "ptr"

        result := ComCall(19, this, pTimeMarshal, pTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-getcurrentstreamtime
     */
    GetCurrentStreamTime() {
        result := ComCall(20, this, "int64*", &pCurrentStreamTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-waituntil
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-flush
     */
    Flush(bCancelEOS) {
     ...
     * @returns {HRESULT} Returns S_OK if successful, or an error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-imediastreamfilter-endofstream
     */
    EndOfStream() {
