 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-idvdstate
...
class IDvdState extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdstate-getdiscid
     */
    GetDiscID() {
        result := ComCall(3, this, "uint*", &pullUniqueID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvdstate-getparentallevel
     */
    GetParentalLevel() {
        result := ComCall(4, this, "uint*", &pulParentalLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
