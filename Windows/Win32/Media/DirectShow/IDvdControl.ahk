...
export default struct IDvdControl extends IUnknown {
    ...
    */
     ...
     */
    TitlePlay(ulTitle) {
        result := ComCall(3, this, UInt32, ulTitle, "HRESULT")
        return result
    }
    ...
    ChapterPlay(ulTitle, ulChapter) {
        result := ComCall(4, this, UInt32, ulTitle, UInt32, ulChapter, "HRESULT")
        return result
    }
    ...
    TimePlay(ulTitle, bcdTime) {
        result := ComCall(5, this, UInt32, ulTitle, UInt32, bcdTime, "HRESULT")
        return result
    }
     ...
     */
    TimeSearch(bcdTime) {
        result := ComCall(8, this, UInt32, bcdTime, "HRESULT")
        return result
    }
    ...
    ChapterSearch(ulChapter) {
        result := ComCall(9, this, UInt32, ulChapter, "HRESULT")
        return result
    }
     ...
     */
    ForwardScan(dwSpeed) {
        result := ComCall(13, this, Float64, dwSpeed, "HRESULT")
        return result
    }
    ...
    BackwardScan(dwSpeed) {
        result := ComCall(14, this, Float64, dwSpeed, "HRESULT")
        return result
    }
    ...
    ButtonSelectAndActivate(ulButton) {
        result := ComCall(22, this, UInt32, ulButton, "HRESULT")
        return result
    }
    ...
    MenuLanguageSelect(Language) {
        result := ComCall(26, this, UInt32, Language, "HRESULT")
        return result
    }
    ...
    AudioStreamChange(ulAudio) {
        result := ComCall(27, this, UInt32, ulAudio, "HRESULT")
        return result
    }
    ...
    SubpictureStreamChange(ulSubPicture, bDisplay) {
        result := ComCall(28, this, UInt32, ulSubPicture, BOOL, bDisplay, "HRESULT")
        return result
    }
     ...
     */
    AngleChange(ulAngle) {
        result := ComCall(29, this, UInt32, ulAngle, "HRESULT")
        return result
    }
    ...
    ParentalLevelSelect(ulParentalLevel) {
        result := ComCall(30, this, UInt32, ulParentalLevel, "HRESULT")
        return result
    }
    ...
    ParentalCountrySelect(wCountry) {
        result := ComCall(31, this, UInt16, wCountry, "HRESULT")
        return result
    }
    ...
    KaraokeAudioPresentationModeChange(ulMode) {
        result := ComCall(32, this, UInt32, ulMode, "HRESULT")
        return result
    }
    ...
    VideoModePreferrence(ulPreferredDisplayMode) {
        result := ComCall(33, this, UInt32, ulPreferredDisplayMode, "HRESULT")
        return result
    }
    ...
    ChapterPlayAutoStop(ulTitle, ulChapter, ulChaptersToPlay) {
        result := ComCall(37, this, UInt32, ulTitle, UInt32, ulChapter, UInt32, ulChaptersToPlay, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.TitlePlay := CallbackCreate(ObjBindMethod(implObj, "TitlePlay"), flags, 2)
        this.vtbl.ChapterPlay := CallbackCreate(ObjBindMethod(implObj, "ChapterPlay"), flags, 3)
        this.vtbl.TimePlay := CallbackCreate(ObjBindMethod(implObj, "TimePlay"), flags, 3)
        this.vtbl.StopForResume := CallbackCreate(ObjBindMethod(implObj, "StopForResume"), flags, 1)
        this.vtbl.GoUp := CallbackCreate(ObjBindMethod(implObj, "GoUp"), flags, 1)
        this.vtbl.TimeSearch := CallbackCreate(ObjBindMethod(implObj, "TimeSearch"), flags, 2)
        this.vtbl.ChapterSearch := CallbackCreate(ObjBindMethod(implObj, "ChapterSearch"), flags, 2)
        this.vtbl.PrevPGSearch := CallbackCreate(ObjBindMethod(implObj, "PrevPGSearch"), flags, 1)
        this.vtbl.TopPGSearch := CallbackCreate(ObjBindMethod(implObj, "TopPGSearch"), flags, 1)
        this.vtbl.NextPGSearch := CallbackCreate(ObjBindMethod(implObj, "NextPGSearch"), flags, 1)
        this.vtbl.ForwardScan := CallbackCreate(ObjBindMethod(implObj, "ForwardScan"), flags, 2)
        this.vtbl.BackwardScan := CallbackCreate(ObjBindMethod(implObj, "BackwardScan"), flags, 2)
        this.vtbl.MenuCall := CallbackCreate(ObjBindMethod(implObj, "MenuCall"), flags, 2)
        this.vtbl.Resume := CallbackCreate(ObjBindMethod(implObj, "Resume"), flags, 1)
        this.vtbl.UpperButtonSelect := CallbackCreate(ObjBindMethod(implObj, "UpperButtonSelect"), flags, 1)
        this.vtbl.LowerButtonSelect := CallbackCreate(ObjBindMethod(implObj, "LowerButtonSelect"), flags, 1)
        this.vtbl.LeftButtonSelect := CallbackCreate(ObjBindMethod(implObj, "LeftButtonSelect"), flags, 1)
        this.vtbl.RightButtonSelect := CallbackCreate(ObjBindMethod(implObj, "RightButtonSelect"), flags, 1)
        this.vtbl.ButtonActivate := CallbackCreate(ObjBindMethod(implObj, "ButtonActivate"), flags, 1)
        this.vtbl.ButtonSelectAndActivate := CallbackCreate(ObjBindMethod(implObj, "ButtonSelectAndActivate"), flags, 2)
        this.vtbl.StillOff := CallbackCreate(ObjBindMethod(implObj, "StillOff"), flags, 1)
        this.vtbl.PauseOn := CallbackCreate(ObjBindMethod(implObj, "PauseOn"), flags, 1)
        this.vtbl.PauseOff := CallbackCreate(ObjBindMethod(implObj, "PauseOff"), flags, 1)
        this.vtbl.MenuLanguageSelect := CallbackCreate(ObjBindMethod(implObj, "MenuLanguageSelect"), flags, 2)
        this.vtbl.AudioStreamChange := CallbackCreate(ObjBindMethod(implObj, "AudioStreamChange"), flags, 2)
        this.vtbl.SubpictureStreamChange := CallbackCreate(ObjBindMethod(implObj, "SubpictureStreamChange"), flags, 3)
        this.vtbl.AngleChange := CallbackCreate(ObjBindMethod(implObj, "AngleChange"), flags, 2)
        this.vtbl.ParentalLevelSelect := CallbackCreate(ObjBindMethod(implObj, "ParentalLevelSelect"), flags, 2)
        this.vtbl.ParentalCountrySelect := CallbackCreate(ObjBindMethod(implObj, "ParentalCountrySelect"), flags, 2)
        this.vtbl.KaraokeAudioPresentationModeChange := CallbackCreate(ObjBindMethod(implObj, "KaraokeAudioPresentationModeChange"), flags, 2)
        this.vtbl.VideoModePreferrence := CallbackCreate(ObjBindMethod(implObj, "VideoModePreferrence"), flags, 2)
        this.vtbl.SetRoot := CallbackCreate(ObjBindMethod(implObj, "SetRoot"), flags, 2)
        this.vtbl.MouseActivate := CallbackCreate(ObjBindMethod(implObj, "MouseActivate"), flags, 2)
        this.vtbl.MouseSelect := CallbackCreate(ObjBindMethod(implObj, "MouseSelect"), flags, 2)
        this.vtbl.ChapterPlayAutoStop := CallbackCreate(ObjBindMethod(implObj, "ChapterPlayAutoStop"), flags, 4)
    }
