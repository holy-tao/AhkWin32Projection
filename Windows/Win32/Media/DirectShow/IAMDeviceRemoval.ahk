 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamdeviceremoval
...
class IAMDeviceRemoval extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdeviceremoval-deviceinfo
     */
    DeviceInfo(pclsidInterfaceClass, pwszSymbolicLink) {
        pwszSymbolicLinkMarshal := pwszSymbolicLink is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pclsidInterfaceClass, pwszSymbolicLinkMarshal, pwszSymbolicLink, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdeviceremoval-reassociate
     */
    Reassociate() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdeviceremoval-disassociate
     */
    Disassociate() {
