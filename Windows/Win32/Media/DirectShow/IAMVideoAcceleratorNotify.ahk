 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/videoacc/nn-videoacc-iamvideoacceleratornotify
...
class IAMVideoAcceleratorNotify extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/videoacc/nf-videoacc-iamvideoacceleratornotify-getuncompsurfacesinfo
     */
    GetUncompSurfacesInfo(pGuid, pUncompBufferInfo) {
        result := ComCall(3, this, "ptr", pGuid, "ptr", pUncompBufferInfo, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/videoacc/nf-videoacc-iamvideoacceleratornotify-setuncompsurfacesinfo
     */
    SetUncompSurfacesInfo(dwActualUncompSurfacesAllocated) {
        result := ComCall(4, this, "uint", dwActualUncompSurfacesAllocated, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/videoacc/nf-videoacc-iamvideoacceleratornotify-getcreatevideoacceleratordata
     */
    GetCreateVideoAcceleratorData(pGuid, pdwSizeMiscData, ppMiscData) {
        ...
        result := ComCall(5, this, "ptr", pGuid, pdwSizeMiscDataMarshal, pdwSizeMiscData, ppMiscDataMarshal, ppMiscData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
