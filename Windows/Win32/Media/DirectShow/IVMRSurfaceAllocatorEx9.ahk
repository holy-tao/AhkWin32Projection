 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nn-vmr9-ivmrsurfaceallocatorex9
...
class IVMRSurfaceAllocatorEx9 extends IVMRSurfaceAllocator9{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatorex9-getsurfaceex
     */
    GetSurfaceEx(dwUserID, SurfaceIndex, SurfaceFlags, lplpSurface, lprcDst) {
        result := ComCall(7, this, "ptr", dwUserID, "uint", SurfaceIndex, "uint", SurfaceFlags, "ptr*", lplpSurface, "ptr", lprcDst, "int")
        if(result != 0) {
