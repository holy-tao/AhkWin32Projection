 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/control/nn-control-ibasicaudio
...
class IBasicAudio extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicaudio-put_volume
     */
    put_Volume(lVolume) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicaudio-get_volume
     */
    get_Volume() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicaudio-put_balance
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicaudio-get_balance
     */
    get_Balance() {
