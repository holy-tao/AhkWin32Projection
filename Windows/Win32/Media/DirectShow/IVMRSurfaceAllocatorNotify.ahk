 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ivmrsurfaceallocatornotify
...
class IVMRSurfaceAllocatorNotify extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-advisesurfaceallocator
     */
     ...
     * @param {HMONITOR} hMonitor_ Handle to the monitor associated with the DirectDraw device.
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-setddrawdevice
     */
    SetDDrawDevice(lpDDrawDevice, hMonitor_) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(4, this, "ptr", lpDDrawDevice, "ptr", hMonitor_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The VMR needs to know which DirectDraw device is being used at any given time in order to associate the Direct3D surfaces being created in the mixer component with that device.
     * @param {IDirectDraw7} lpDDrawDevice Specifies the DirectDraw device.
     * @param {HMONITOR} hMonitor_ Specifies the handle to the monitor associated with the DirectDraw device.
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-changeddrawdevice
     */
    ChangeDDrawDevice(lpDDrawDevice, hMonitor_) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(5, this, "ptr", lpDDrawDevice, "ptr", hMonitor_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-restoreddrawsurfaces
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-notifyevent
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrsurfaceallocatornotify-setbordercolor
     */
