 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamcrossbar
...
class IAMCrossbar extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamcrossbar-get_pincounts
     */
    get_PinCounts(OutputPinCount, InputPinCount) {
        ...
        result := ComCall(3, this, OutputPinCountMarshal, OutputPinCount, InputPinCountMarshal, InputPinCount, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamcrossbar-canroute
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamcrossbar-route
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamcrossbar-get_isroutedto
     */
    get_IsRoutedTo(OutputPinIndex) {
        result := ComCall(6, this, "int", OutputPinIndex, "int*", &InputPinIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamcrossbar-get_crossbarpininfo
     */
    get_CrossbarPinInfo(IsInputPin, PinIndex, PinIndexRelated, PhysicalType) {
        ...
        result := ComCall(7, this, "int", IsInputPin, "int", PinIndex, PinIndexRelatedMarshal, PinIndexRelated, PhysicalTypeMarshal, PhysicalType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
