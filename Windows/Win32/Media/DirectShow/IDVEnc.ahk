 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-idvenc
...
class IDVEnc extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvenc-get_iformatresolution
     */
    get_IFormatResolution(VideoFormat, DVFormat, Resolution, fDVInfo, sDVInfo) {
        ...
        result := ComCall(3, this, VideoFormatMarshal, VideoFormat, DVFormatMarshal, DVFormat, ResolutionMarshal, Resolution, "char", fDVInfo, "ptr", sDVInfo, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} Returns S_OK if successful. Otherwise, returns E_FAIL or another error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-idvenc-put_iformatresolution
     */
