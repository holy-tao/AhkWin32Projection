 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nn-vmr9-ivmrsurfaceallocatornotify9
...
class IVMRSurfaceAllocatorNotify9 extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatornotify9-advisesurfaceallocator
     */
     ...
     * @param {HMONITOR} hMonitor_ Handle to a monitor.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>. Possible values include those in the following table.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatornotify9-setd3ddevice
     */
    SetD3DDevice(lpD3DDevice, hMonitor_) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(4, this, "ptr", lpD3DDevice, "ptr", hMonitor_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HMONITOR} hMonitor_ Handle to the monitor associated with the new device.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>. Possible values include those in the following table.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatornotify9-changed3ddevice
     */
    ChangeD3DDevice(lpD3DDevice, hMonitor_) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(5, this, "ptr", lpD3DDevice, "ptr", hMonitor_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatornotify9-allocatesurfacehelper
     */
    AllocateSurfaceHelper(lpAllocInfo, lpNumBuffers) {
        lpNumBuffersMarshal := lpNumBuffers is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, "ptr", lpAllocInfo, lpNumBuffersMarshal, lpNumBuffers, "ptr*", &lplpSurface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/vmr9/nf-vmr9-ivmrsurfaceallocatornotify9-notifyevent
     */
