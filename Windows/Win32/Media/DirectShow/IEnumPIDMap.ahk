 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ienumpidmap
...
class IEnumPIDMap extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ienumpidmap-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ienumpidmap-skip
     */
    Skip(cRecords) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ienumpidmap-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ienumpidmap-clone
     */
    Clone() {
        result := ComCall(6, this, "ptr*", &ppIEnumPIDMap := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
