 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iconfigavimux
...
class IConfigAviMux extends IUnknown{
     ...
     * @param {Integer} iStream_ Specifies the index of the stream, or –1 to indicate no master stream. The AVI Mux writes one stream for each connected input pin. Stream numbers are indexed from zero.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfigavimux-setmasterstream
     */
    SetMasterStream(iStream_) {
        result := ComCall(3, this, "int", iStream_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfigavimux-getmasterstream
     */
    GetMasterStream() {
        result := ComCall(4, this, "int*", &pStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfigavimux-setoutputcompatibilityindex
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iconfigavimux-getoutputcompatibilityindex
     */
    GetOutputCompatibilityIndex() {
        result := ComCall(6, this, "int*", &pfOldIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
