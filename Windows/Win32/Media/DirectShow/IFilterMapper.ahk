 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ifiltermapper
...
class IFilterMapper extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-registerfilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-registerfilterinstance
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-registerpin
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-registerpintype
     */
     ...
     * @param {Guid} Filter GUID of the filter.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-unregisterfilter
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-unregisterfilterinstance
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-unregisterpin
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ifiltermapper-enummatchingfilters
     */
    EnumMatchingFilters(dwMerit, bInputNeeded, clsInMaj, clsInSub, bRender, bOututNeeded, clsOutMaj, clsOutSub) {
        result := ComCall(10, this, "ptr*", &ppEnum := 0, "uint", dwMerit, "int", bInputNeeded, "ptr", clsInMaj, "ptr", clsInSub, "int", bRender, "int", bOututNeeded, "ptr", clsOutMaj, "ptr", clsOutSub, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
