 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nn-bdaiface-ibda_signalstatistics
...
class IBDA_SignalStatistics extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-put_signalstrength
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-get_signalstrength
     */
    get_SignalStrength(plDbStrength) {
        plDbStrengthMarshal := plDbStrength is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, plDbStrengthMarshal, plDbStrength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-put_signalquality
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-get_signalquality
     */
    get_SignalQuality(plPercentQuality) {
        plPercentQualityMarshal := plPercentQuality is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, plPercentQualityMarshal, plPercentQuality, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-put_signalpresent
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-get_signalpresent
     */
    get_SignalPresent(pfPresent) {
        pfPresentMarshal := pfPresent is VarRef ? "char*" : "ptr"

        result := ComCall(8, this, pfPresentMarshal, pfPresent, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-put_signallocked
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-get_signallocked
     */
    get_SignalLocked(pfLocked) {
        pfLockedMarshal := pfLocked is VarRef ? "char*" : "ptr"

        result := ComCall(10, this, pfLockedMarshal, pfLocked, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-put_sampletime
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdaiface/nf-bdaiface-ibda_signalstatistics-get_sampletime
     */
    get_SampleTime(plmsSampleTime) {
        plmsSampleTimeMarshal := plmsSampleTime is VarRef ? "int*" : "ptr"

        result := ComCall(12, this, plmsSampleTimeMarshal, plmsSampleTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
