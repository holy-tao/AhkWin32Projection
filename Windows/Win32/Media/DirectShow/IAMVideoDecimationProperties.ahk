 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamvideodecimationproperties
...
class IAMVideoDecimationProperties extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideodecimationproperties-querydecimationusage
     */
    QueryDecimationUsage() {
        result := ComCall(3, this, "int*", &lpUsage := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamvideodecimationproperties-setdecimationusage
     */
