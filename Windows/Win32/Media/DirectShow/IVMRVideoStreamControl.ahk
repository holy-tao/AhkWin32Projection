 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ivmrvideostreamcontrol
...
class IVMRVideoStreamControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrvideostreamcontrol-setcolorkey
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrvideostreamcontrol-getcolorkey
     */
    GetColorKey() {
        lpClrKey := DDCOLORKEY()
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrvideostreamcontrol-setstreamactivestate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrvideostreamcontrol-getstreamactivestate
     */
    GetStreamActiveState() {
        result := ComCall(6, this, "int*", &lpfActive := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
