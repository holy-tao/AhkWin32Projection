 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-imemallocator
...
class IMemAllocator extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-setproperties
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-getproperties
     */
    GetProperties() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-commit
     */
    Commit() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-decommit
     */
    Decommit() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-getbuffer
     */
    GetBuffer(pStartTime, pEndTime, dwFlags) {
        ...
        result := ComCall(7, this, "ptr*", &ppBuffer := 0, pStartTimeMarshal, pStartTime, pEndTimeMarshal, pEndTime, "uint", dwFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful, or an <b>HRESULT</b> value indicating the cause of the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imemallocator-releasebuffer
     */
