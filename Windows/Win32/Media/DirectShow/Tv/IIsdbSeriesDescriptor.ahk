 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-iisdbseriesdescriptor
...
class IIsdbSeriesDescriptor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-gettag
     */
    GetTag() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getlength
     */
    GetLength() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getseriesid
     */
    GetSeriesId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getrepeatlabel
     */
    GetRepeatLabel() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getprogrampattern
     */
    GetProgramPattern() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getexpiredate
     */
    GetExpireDate(pfValid, pmdtVal) {
        pfValidMarshal := pfValid is VarRef ? "int*" : "ptr"

        result := ComCall(8, this, pfValidMarshal, pfValid, "ptr", pmdtVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getepisodenumber
     */
    GetEpisodeNumber() {
        result := ComCall(9, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getlastepisodenumber
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbseriesdescriptor-getseriesnamew
     */
