 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nn-mpeg2psiparser-itsdt
...
class ITSDT extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-getversionnumber
     */
    GetVersionNumber() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-getcountoftabledescriptors
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-gettabledescriptorbyindex
     */
     ...
     * @returns {IGenericDescriptor} Address of a variable that receives an <a href="https://docs.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-igenericdescriptor">IGenericDescriptor</a> interface pointer. Use this interface to retrieve the information in the descriptor. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-gettabledescriptorbytag
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-registerfornexttable
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-getnexttable
     */
    GetNextTable() {
        result := ComCall(9, this, "ptr*", &ppTSDT := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-registerforwhencurrent
     */
     ...
     * This topic applies to Update Rollup 2 for Microsoft Windows XP Media Center Edition 2005.
     * @remarks
     * This method applies only to <i>next</i> tables that have become current. Before calling this method, call <a href="https://docs.microsoft.com/windows/desktop/api/mpeg2psiparser/nf-mpeg2psiparser-itsdt-registerforwhencurrent">ITSDT::RegisterForWhenCurrent</a> and wait for the event to be signaled.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>. Possible values include those in the following table.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-itsdt-convertnexttocurrent
     */
