 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nn-tvratings-ievalrat
...
class IEvalRat extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-get_blockedratingattributes
     */
    get_BlockedRatingAttributes(enSystem, enLevel) {
        result := ComCall(7, this, "int", enSystem, "int", enLevel, "int*", &plbfAttrs := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-put_blockedratingattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-get_blockunrated
     */
    get_BlockUnRated() {
        result := ComCall(9, this, "int*", &pfBlockUnRatedShows := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-put_blockunrated
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-mostrestrictiverating
     */
    MostRestrictiveRating(enSystem1, enEnLevel1, lbfEnAttr1, enSystem2, enEnLevel2, lbfEnAttr2, penSystem, penEnLevel, plbfEnAttr) {
        ...
        result := ComCall(11, this, "int", enSystem1, "int", enEnLevel1, "int", lbfEnAttr1, "int", enSystem2, "int", enEnLevel2, "int", lbfEnAttr2, penSystemMarshal, penSystem, penEnLevelMarshal, penEnLevel, plbfEnAttrMarshal, plbfEnAttr, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ievalrat-testrating
     */
