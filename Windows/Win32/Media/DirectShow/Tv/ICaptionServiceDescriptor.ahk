 ...
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nn-atscpsipparser-icaptionservicedescriptor
...
class ICaptionServiceDescriptor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-getnumberofservices
     */
    GetNumberOfServices() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-getlanguagecode
     */
    GetLanguageCode(bIndex) {
        result := ComCall(4, this, "char", bIndex, "char*", &LangCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-getcaptionservicenumber
     */
    GetCaptionServiceNumber(bIndex) {
        result := ComCall(5, this, "char", bIndex, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-getcctype
     */
    GetCCType(bIndex) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-geteasyreader
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-icaptionservicedescriptor-getwideaspectratio
     */
    GetWideAspectRatio(bIndex) {
        result := ComCall(8, this, "char", bIndex, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
