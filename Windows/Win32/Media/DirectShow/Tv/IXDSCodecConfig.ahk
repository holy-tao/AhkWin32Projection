 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nn-encdec-ixdscodecconfig
...
class IXDSCodecConfig extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ixdscodecconfig-getsecurechannelobject
     */
    GetSecureChannelObject() {
        result := ComCall(3, this, "ptr*", &ppUnkDRMSecureChannel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ixdscodecconfig-setpausebuffertime
     */
