 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iatsclocator2
...
class IATSCLocator2 extends IATSCLocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator2-get_programnumber
     */
    get_ProgramNumber() {
        result := ComCall(26, this, "int*", &ProgramNumber := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator2-put_programnumber
     */
