 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nn-atscpsipparser-iatsc_ett
...
class IATSC_ETT extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iatsc_ett-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iatsc_ett-getversionnumber
     */
    GetVersionNumber() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iatsc_ett-getprotocolversion
     */
    GetProtocolVersion() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iatsc_ett-getetmid
     */
    GetEtmId() {
     ...
     * @param {Pointer<Pointer<Integer>>} ppText Receives a pointer to the title text buffer. The method allocates the buffer and fills it with the title text, which is formatted as a Multiple String Structure as defined by ATSC PSIP Standard A/65. The caller must free the buffer by calling <b>CoTaskMemFree</b>.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>. Possible values include those in the following table.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iatsc_ett-getextendedmessagetext
     */
    GetExtendedMessageText(pdwLength, ppText) {
        ...
        result := ComCall(7, this, pdwLengthMarshal, pdwLength, ppTextMarshal, ppText, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
