 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-idvbtlocator2
...
class IDVBTLocator2 extends IDVBTLocator{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator2-get_physicallayerpipeid
     */
    get_PhysicalLayerPipeId() {
        result := ComCall(36, this, "int*", &PhysicalLayerPipeIdVal := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator2-put_physicallayerpipeid
     */
    put_PhysicalLayerPipeId(PhysicalLayerPipeIdVal) {
        result := ComCall(37, this, "int", PhysicalLayerPipeIdVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
