 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-idvbslocator
...
class IDVBSLocator extends IDigitalLocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-get_signalpolarisation
     */
    get_SignalPolarisation() {
        result := ComCall(22, this, "int*", &PolarisationVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-put_signalpolarisation
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-get_westposition
     */
    get_WestPosition() {
        result := ComCall(24, this, "short*", &WestLongitude := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-put_westposition
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-get_orbitalposition
     */
    get_OrbitalPosition() {
        result := ComCall(26, this, "int*", &longitude := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-put_orbitalposition
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-get_azimuth
     */
    get_Azimuth() {
        result := ComCall(28, this, "int*", &Azimuth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-put_azimuth
     */
    put_Azimuth(Azimuth) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-get_elevation
     */
    get_Elevation() {
        result := ComCall(30, this, "int*", &Elevation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbslocator-put_elevation
     */
