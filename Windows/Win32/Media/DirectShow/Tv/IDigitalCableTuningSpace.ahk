...
class IDigitalCableTuningSpace extends IATSCTuningSpace{
    ...
    /**
     * 
     * @param {Pointer<Int32>} MinMajorChannelVal 
     * @returns {HRESULT} 
     */
    get_MinMajorChannel(MinMajorChannelVal) {
        result := ComCall(42, this, "int*", MinMajorChannelVal, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<Int32>} MaxMajorChannelVal 
     * @returns {HRESULT} 
     */
    get_MaxMajorChannel(MaxMajorChannelVal) {
        result := ComCall(44, this, "int*", MaxMajorChannelVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int32>} MinSourceIDVal 
     * @returns {HRESULT} 
     */
    get_MinSourceID(MinSourceIDVal) {
        result := ComCall(46, this, "int*", MinSourceIDVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int32>} MaxSourceIDVal 
     * @returns {HRESULT} 
     */
    get_MaxSourceID(MaxSourceIDVal) {
        result := ComCall(48, this, "int*", MaxSourceIDVal, "int")
        if(result != 0)
            throw OSError(result)
