 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-icomponents
...
class IComponents extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-enumcomponents
     */
    EnumComponents() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-get_item
     */
    get_Item(Index) {
     ...
     * @param {IComponent} Component_ Pointer to the <b>Component</b> object to be added.
     * @returns {VARIANT} Pointer to a <b>VARIANT</b> that will receive the index of the <b>Component</b> object after it has been added.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-add
     */
    Add(Component_) {
        NewIndex := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-remove
     */
    Remove(Index) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-clone
     */
    Clone() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponents-put_item
     */
