...
export default struct ILocator extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CarrierFrequency := CallbackCreate(ObjBindMethod(implObj, "get_CarrierFrequency"), flags, 2)
        this.vtbl.put_CarrierFrequency := CallbackCreate(ObjBindMethod(implObj, "put_CarrierFrequency"), flags, 2)
        this.vtbl.get_InnerFEC := CallbackCreate(ObjBindMethod(implObj, "get_InnerFEC"), flags, 2)
        this.vtbl.put_InnerFEC := CallbackCreate(ObjBindMethod(implObj, "put_InnerFEC"), flags, 2)
        ...
        this.vtbl.get_OuterFEC := CallbackCreate(ObjBindMethod(implObj, "get_OuterFEC"), flags, 2)
        this.vtbl.put_OuterFEC := CallbackCreate(ObjBindMethod(implObj, "put_OuterFEC"), flags, 2)
        ...
        this.vtbl.get_Modulation := CallbackCreate(ObjBindMethod(implObj, "get_Modulation"), flags, 2)
        this.vtbl.put_Modulation := CallbackCreate(ObjBindMethod(implObj, "put_Modulation"), flags, 2)
