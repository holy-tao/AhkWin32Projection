 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ilocator
...
class ILocator extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_carrierfrequency
     */
    get_CarrierFrequency() {
        result := ComCall(7, this, "int*", &Frequency := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_carrierfrequency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_innerfec
     */
    get_InnerFEC() {
        result := ComCall(9, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_innerfec
     */
    put_InnerFEC(FEC) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_innerfecrate
     */
    get_InnerFECRate() {
        result := ComCall(11, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_innerfecrate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_outerfec
     */
    get_OuterFEC() {
        result := ComCall(13, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_outerfec
     */
    put_OuterFEC(FEC) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_outerfecrate
     */
    get_OuterFECRate() {
        result := ComCall(15, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_outerfecrate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_modulation
     */
    get_Modulation() {
        result := ComCall(17, this, "int*", &Modulation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_modulation
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-get_symbolrate
     */
    get_SymbolRate() {
        result := ComCall(19, this, "int*", &Rate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-put_symbolrate
     */
    put_SymbolRate(Rate) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ilocator-clone
     */
    Clone() {
        result := ComCall(21, this, "ptr*", &NewLocator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
