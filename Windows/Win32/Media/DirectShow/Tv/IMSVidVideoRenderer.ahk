 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidvideorenderer
...
class IMSVidVideoRenderer extends IMSVidOutputDevice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_customcompositorclass
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_customcompositorclass
     */
    put_CustomCompositorClass(CompositorCLSID) {
        if(CompositorCLSID is String) {
            pin := BSTR.Alloc(CompositorCLSID)
            CompositorCLSID := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get__customcompositorclass
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put__customcompositorclass
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get__customcompositor
     */
    get__CustomCompositor() {
        result := ComCall(20, this, "ptr*", &Compositor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put__customcompositor
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_mixerbitmap
     */
    get_MixerBitmap() {
        result := ComCall(22, this, "ptr*", &MixerPictureDisp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get__mixerbitmap
     */
    get__MixerBitmap() {
        result := ComCall(23, this, "ptr*", &MixerPicture := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_mixerbitmap
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put__mixerbitmap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_mixerbitmappositionrect
     */
    get_MixerBitmapPositionRect() {
        result := ComCall(26, this, "ptr*", &rDest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_mixerbitmappositionrect
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_mixerbitmapopacity
     */
    get_MixerBitmapOpacity() {
        result := ComCall(28, this, "int*", &opacity := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_mixerbitmapopacity
     */
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-setupmixerbitmap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_sourcesize
     */
    get_SourceSize() {
        result := ComCall(31, this, "int*", &CurrentSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_sourcesize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_overscan
     */
    get_OverScan() {
        result := ComCall(33, this, "int*", &plPercent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_overscan
     */
     ...
     * The returned <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface has an outstanding reference count. The caller must release the interface.
     * @returns {IMSVidRect} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_availablesourcerect
     */
    get_AvailableSourceRect() {
        result := ComCall(35, this, "ptr*", &pRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The returned <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface has an outstanding reference count. The caller must release the interface.
     * @returns {IMSVidRect} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_maxvidrect
     */
    get_MaxVidRect() {
        result := ComCall(36, this, "ptr*", &ppVidRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The returned <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface has an outstanding reference count. The caller must release the interface.
     * @returns {IMSVidRect} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_minvidrect
     */
    get_MinVidRect() {
        result := ComCall(37, this, "ptr*", &ppVidRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The returned <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface has an outstanding reference count. The caller must release the interface.
     * @returns {IMSVidRect} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidrect">IMSVidRect</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_clippedsourcerect
     */
    get_ClippedSourceRect() {
        result := ComCall(38, this, "ptr*", &pRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_clippedsourcerect
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_usingoverlay
     */
    get_UsingOverlay() {
        result := ComCall(40, this, "short*", &UseOverlayVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_usingoverlay
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-capture
     */
    Capture() {
        result := ComCall(42, this, "ptr*", &currentImage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_framespersecond
     */
    get_FramesPerSecond() {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-get_decimateinput
     */
    get_DecimateInput() {
        result := ComCall(44, this, "short*", &pDeci := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvideorenderer-put_decimateinput
     */
