...
export default struct IMSVidVideoRenderer extends IMSVidOutputDevice {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CustomCompositorClass := CallbackCreate(ObjBindMethod(implObj, "get_CustomCompositorClass"), flags, 2)
        this.vtbl.put_CustomCompositorClass := CallbackCreate(ObjBindMethod(implObj, "put_CustomCompositorClass"), flags, 2)
        this.vtbl.get__CustomCompositorClass := CallbackCreate(ObjBindMethod(implObj, "get__CustomCompositorClass"), flags, 2)
        this.vtbl.put__CustomCompositorClass := CallbackCreate(ObjBindMethod(implObj, "put__CustomCompositorClass"), flags, 2)
        this.vtbl.get__CustomCompositor := CallbackCreate(ObjBindMethod(implObj, "get__CustomCompositor"), flags, 2)
        this.vtbl.put__CustomCompositor := CallbackCreate(ObjBindMethod(implObj, "put__CustomCompositor"), flags, 2)
        this.vtbl.get_MixerBitmap := CallbackCreate(ObjBindMethod(implObj, "get_MixerBitmap"), flags, 2)
        this.vtbl.get__MixerBitmap := CallbackCreate(ObjBindMethod(implObj, "get__MixerBitmap"), flags, 2)
        this.vtbl.put_MixerBitmap := CallbackCreate(ObjBindMethod(implObj, "put_MixerBitmap"), flags, 2)
        this.vtbl.put__MixerBitmap := CallbackCreate(ObjBindMethod(implObj, "put__MixerBitmap"), flags, 2)
        this.vtbl.get_MixerBitmapPositionRect := CallbackCreate(ObjBindMethod(implObj, "get_MixerBitmapPositionRect"), flags, 2)
        this.vtbl.put_MixerBitmapPositionRect := CallbackCreate(ObjBindMethod(implObj, "put_MixerBitmapPositionRect"), flags, 2)
        this.vtbl.get_MixerBitmapOpacity := CallbackCreate(ObjBindMethod(implObj, "get_MixerBitmapOpacity"), flags, 2)
        this.vtbl.put_MixerBitmapOpacity := CallbackCreate(ObjBindMethod(implObj, "put_MixerBitmapOpacity"), flags, 2)
        this.vtbl.SetupMixerBitmap := CallbackCreate(ObjBindMethod(implObj, "SetupMixerBitmap"), flags, 4)
        this.vtbl.get_SourceSize := CallbackCreate(ObjBindMethod(implObj, "get_SourceSize"), flags, 2)
        this.vtbl.put_SourceSize := CallbackCreate(ObjBindMethod(implObj, "put_SourceSize"), flags, 2)
        this.vtbl.get_OverScan := CallbackCreate(ObjBindMethod(implObj, "get_OverScan"), flags, 2)
        this.vtbl.put_OverScan := CallbackCreate(ObjBindMethod(implObj, "put_OverScan"), flags, 2)
        this.vtbl.get_AvailableSourceRect := CallbackCreate(ObjBindMethod(implObj, "get_AvailableSourceRect"), flags, 2)
        this.vtbl.get_MaxVidRect := CallbackCreate(ObjBindMethod(implObj, "get_MaxVidRect"), flags, 2)
        this.vtbl.get_MinVidRect := CallbackCreate(ObjBindMethod(implObj, "get_MinVidRect"), flags, 2)
        this.vtbl.get_ClippedSourceRect := CallbackCreate(ObjBindMethod(implObj, "get_ClippedSourceRect"), flags, 2)
        this.vtbl.put_ClippedSourceRect := CallbackCreate(ObjBindMethod(implObj, "put_ClippedSourceRect"), flags, 2)
        this.vtbl.get_UsingOverlay := CallbackCreate(ObjBindMethod(implObj, "get_UsingOverlay"), flags, 2)
        this.vtbl.put_UsingOverlay := CallbackCreate(ObjBindMethod(implObj, "put_UsingOverlay"), flags, 2)
        this.vtbl.Capture := CallbackCreate(ObjBindMethod(implObj, "Capture"), flags, 2)
        this.vtbl.get_FramesPerSecond := CallbackCreate(ObjBindMethod(implObj, "get_FramesPerSecond"), flags, 2)
        this.vtbl.get_DecimateInput := CallbackCreate(ObjBindMethod(implObj, "get_DecimateInput"), flags, 2)
        this.vtbl.put_DecimateInput := CallbackCreate(ObjBindMethod(implObj, "put_DecimateInput"), flags, 2)
    }
