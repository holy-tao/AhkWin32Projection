...
export default struct IMSVidStreamBufferSink3 extends IMSVidStreamBufferSink2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetMinSeek := CallbackCreate(ObjBindMethod(implObj, "SetMinSeek"), flags, 2)
        ...
        this.vtbl.put_AudioAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put_AudioAnalysisFilter"), flags, 2)
        this.vtbl.get_AudioAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get_AudioAnalysisFilter"), flags, 2)
        this.vtbl.put__AudioAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put__AudioAnalysisFilter"), flags, 2)
        this.vtbl.get__AudioAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get__AudioAnalysisFilter"), flags, 2)
        this.vtbl.put_VideoAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put_VideoAnalysisFilter"), flags, 2)
        this.vtbl.get_VideoAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get_VideoAnalysisFilter"), flags, 2)
        this.vtbl.put__VideoAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put__VideoAnalysisFilter"), flags, 2)
        this.vtbl.get__VideoAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get__VideoAnalysisFilter"), flags, 2)
        this.vtbl.put_DataAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put_DataAnalysisFilter"), flags, 2)
        this.vtbl.get_DataAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get_DataAnalysisFilter"), flags, 2)
        this.vtbl.put__DataAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "put__DataAnalysisFilter"), flags, 2)
        this.vtbl.get__DataAnalysisFilter := CallbackCreate(ObjBindMethod(implObj, "get__DataAnalysisFilter"), flags, 2)
        this.vtbl.get_LicenseErrorCode := CallbackCreate(ObjBindMethod(implObj, "get_LicenseErrorCode"), flags, 2)
    }
