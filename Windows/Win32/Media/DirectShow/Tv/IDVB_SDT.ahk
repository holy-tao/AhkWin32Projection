...
export default struct IDVB_SDT extends IUnknown {
    ...
    */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/dvbsiparser/nf-dvbsiparser-idvb_sdt-initialize
     */
    ...
    GetRecordEITScheduleFlag(dwRecordIndex) {
        result := ComCall(9, this, UInt32, dwRecordIndex, BOOL.Ptr, &pfVal := 0, "HRESULT")
        return pfVal
    }
    ...
    GetRecordEITPresentFollowingFlag(dwRecordIndex) {
        result := ComCall(10, this, UInt32, dwRecordIndex, BOOL.Ptr, &pfVal := 0, "HRESULT")
        return pfVal
    }
    ...
    GetRecordFreeCAMode(dwRecordIndex) {
        result := ComCall(12, this, UInt32, dwRecordIndex, BOOL.Ptr, &pfVal := 0, "HRESULT")
        return pfVal
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetRecordEITScheduleFlag := CallbackCreate(ObjBindMethod(implObj, "GetRecordEITScheduleFlag"), flags, 3)
        this.vtbl.GetRecordEITPresentFollowingFlag := CallbackCreate(ObjBindMethod(implObj, "GetRecordEITPresentFollowingFlag"), flags, 3)
