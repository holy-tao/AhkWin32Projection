 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iauxintuningspace2
...
class IAuxInTuningSpace2 extends IAuxInTuningSpace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iauxintuningspace2-get_countrycode
     */
    get_CountryCode() {
        result := ComCall(26, this, "int*", &CountryCodeVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iauxintuningspace2-put_countrycode
     */
