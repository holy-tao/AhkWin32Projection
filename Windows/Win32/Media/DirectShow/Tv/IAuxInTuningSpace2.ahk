...
#Import ".\IAuxInTuningSpace.ahk" { IAuxInTuningSpace }
 ...
 * @see https://learn.microsoft.com/windows/win32/api/tuner/nn-tuner-iauxintuningspace2
 * @namespace Windows.Win32.Media.DirectShow.Tv
 */
export default struct IAuxInTuningSpace2 extends IAuxInTuningSpace {
    /**
     ...
     * used for IAuxInTuningSpace2 interfaces
    */
    struct Vtbl extends IAuxInTuningSpace.Vtbl {
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAuxInTuningSpace2.Vtbl()
        }
    ...
    put_CountryCode(NewCountryCodeVal) {
        result := ComCall(27, this, Int32, NewCountryCodeVal, "HRESULT")
        return result
    }
