 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidclosedcaptioning3
...
class IMSVidClosedCaptioning3 extends IMSVidClosedCaptioning2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidclosedcaptioning3-get_teletextfilter
     */
    get_TeleTextFilter() {
        result := ComCall(20, this, "ptr*", &punkTTFilter := 0, "int")
        if(result != 0) {
