 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-idvbtuningspace2
...
class IDVBTuningSpace2 extends IDVBTuningSpace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtuningspace2-get_networkid
     */
    get_NetworkID() {
        result := ComCall(28, this, "int*", &NetworkID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtuningspace2-put_networkid
     */
