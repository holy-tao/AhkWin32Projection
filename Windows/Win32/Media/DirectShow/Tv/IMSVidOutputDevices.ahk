 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidoutputdevices
...
class IMSVidOutputDevices extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidoutputdevices-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidoutputdevices-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidoutputdevices-get_item
     */
    get_Item(v) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidoutputdevices-add
     */
    Add(pDB) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidoutputdevices-remove
     */
    Remove(v) {
