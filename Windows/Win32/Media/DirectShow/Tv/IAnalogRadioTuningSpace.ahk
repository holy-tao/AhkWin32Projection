 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ianalogradiotuningspace
...
class IAnalogRadioTuningSpace extends ITuningSpace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-get_minfrequency
     */
    get_MinFrequency() {
        result := ComCall(26, this, "int*", &MinFrequencyVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-put_minfrequency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-get_maxfrequency
     */
    get_MaxFrequency() {
        result := ComCall(28, this, "int*", &MaxFrequencyVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns E_NOTIMPL.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-put_maxfrequency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-get_step
     */
    get_Step() {
        result := ComCall(30, this, "int*", &StepVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns E_NOTIMPL.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianalogradiotuningspace-put_step
     */
    put_Step(NewStepVal) {
