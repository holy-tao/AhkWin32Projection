 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nn-tvratings-ixdstorat
...
class IXDSToRat extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ixdstorat-init
     */
    Init() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tvratings/nf-tvratings-ixdstorat-parsexdsbytepair
     */
    ParseXDSBytePair(byte1, byte2, pEnSystem, pEnLevel, plBfEnAttributes) {
        ...
        result := ComCall(8, this, "char", byte1, "char", byte2, pEnSystemMarshal, pEnSystem, pEnLevelMarshal, pEnLevel, plBfEnAttributesMarshal, plBfEnAttributes, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
