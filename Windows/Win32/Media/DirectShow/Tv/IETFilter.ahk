 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nn-encdec-ietfilter
...
class IETFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ietfilter-get_evalratobjok
     */
    get_EvalRatObjOK() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ietfilter-getcurrrating
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ietfilter-getcurrlicenseexpdate
     */
    GetCurrLicenseExpDate(protType_) {
        protType_Marshal := protType_ is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, protType_Marshal, protType_, "int*", &lpDateTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ietfilter-getlasterrorcode
     */
    GetLastErrorCode() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-ietfilter-setrecordingon
     */
