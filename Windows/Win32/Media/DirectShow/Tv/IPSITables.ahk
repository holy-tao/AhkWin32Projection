 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nn-mpeg2psiparser-ipsitables
...
class IPSITables extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2psiparser/nf-mpeg2psiparser-ipsitables-gettable
     */
    GetTable(dwTSID, dwTID_PID, dwHashedVer, dwPara4) {
        result := ComCall(3, this, "uint", dwTSID, "uint", dwTID_PID, "uint", dwHashedVer, "uint", dwPara4, "ptr*", &ppIUnknown := 0, "int")
        if(result != 0) {
