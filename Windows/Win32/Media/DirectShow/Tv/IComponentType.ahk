 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-icomponenttype
...
class IComponentType extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get_category
     */
    get_Category() {
        result := ComCall(7, this, "int*", &Category := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put_category
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get_mediamajortype
     */
    get_MediaMajorType() {
        MediaMajorType := BSTR()
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put_mediamajortype
     */
    put_MediaMajorType(MediaMajorType) {
        if(MediaMajorType is String) {
            pin := BSTR.Alloc(MediaMajorType)
            MediaMajorType := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get__mediamajortype
     */
    get__MediaMajorType() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put__mediamajortype
     */
     ...
     * @returns {BSTR} Pointer to a <b>BSTR</b> that will receive the GUID.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get_mediasubtype
     */
    get_MediaSubType() {
        MediaSubType := BSTR()
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put_mediasubtype
     */
    put_MediaSubType(MediaSubType) {
        if(MediaSubType is String) {
            pin := BSTR.Alloc(MediaSubType)
            MediaSubType := pin.Value
        }
     ...
     * This method is available through C++ only. Note the two underscores in the method name as compared to the one underscore for the method that uses a <b>BSTR</b> as a parameter.
     * @returns {Guid} Pointer to a GUID that will receive the major type.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get__mediasubtype
     */
    get__MediaSubType() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put__mediasubtype
     */
     ...
     * @returns {BSTR} Pointer to a <b>BSTR</b> that will receive the GUID.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get_mediaformattype
     */
    get_MediaFormatType() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put_mediaformattype
     */
    put_MediaFormatType(MediaFormatType) {
        if(MediaFormatType is String) {
            pin := BSTR.Alloc(MediaFormatType)
            MediaFormatType := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get__mediaformattype
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put__mediaformattype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-get_mediatype
     */
    get_MediaType() {
        MediaType_ := AM_MEDIA_TYPE()
        result := ComCall(21, this, "ptr", MediaType_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<AM_MEDIA_TYPE>} MediaType_ An <a href="https://docs.microsoft.com/windows/desktop/api/strmif/ns-strmif-am_media_type">AM_MEDIA_TYPE</a> structure that specifies the major type, subtype, format, and so on.
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-put_mediatype
     */
    put_MediaType(MediaType_) {
        result := ComCall(22, this, "ptr", MediaType_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttype-clone
     */
    Clone() {
        result := ComCall(23, this, "ptr*", &NewCT := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
