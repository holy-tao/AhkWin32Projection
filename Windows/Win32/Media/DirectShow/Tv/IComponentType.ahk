...
export default struct IComponentType extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_Category := CallbackCreate(ObjBindMethod(implObj, "put_Category"), flags, 2)
        this.vtbl.get_MediaMajorType := CallbackCreate(ObjBindMethod(implObj, "get_MediaMajorType"), flags, 2)
        this.vtbl.put_MediaMajorType := CallbackCreate(ObjBindMethod(implObj, "put_MediaMajorType"), flags, 2)
        this.vtbl.get__MediaMajorType := CallbackCreate(ObjBindMethod(implObj, "get__MediaMajorType"), flags, 2)
        this.vtbl.put__MediaMajorType := CallbackCreate(ObjBindMethod(implObj, "put__MediaMajorType"), flags, 2)
        this.vtbl.get_MediaSubType := CallbackCreate(ObjBindMethod(implObj, "get_MediaSubType"), flags, 2)
        this.vtbl.put_MediaSubType := CallbackCreate(ObjBindMethod(implObj, "put_MediaSubType"), flags, 2)
        this.vtbl.get__MediaSubType := CallbackCreate(ObjBindMethod(implObj, "get__MediaSubType"), flags, 2)
        this.vtbl.put__MediaSubType := CallbackCreate(ObjBindMethod(implObj, "put__MediaSubType"), flags, 2)
        this.vtbl.get_MediaFormatType := CallbackCreate(ObjBindMethod(implObj, "get_MediaFormatType"), flags, 2)
        this.vtbl.put_MediaFormatType := CallbackCreate(ObjBindMethod(implObj, "put_MediaFormatType"), flags, 2)
        this.vtbl.get__MediaFormatType := CallbackCreate(ObjBindMethod(implObj, "get__MediaFormatType"), flags, 2)
        this.vtbl.put__MediaFormatType := CallbackCreate(ObjBindMethod(implObj, "put__MediaFormatType"), flags, 2)
        this.vtbl.get_MediaType := CallbackCreate(ObjBindMethod(implObj, "get_MediaType"), flags, 2)
        this.vtbl.put_MediaType := CallbackCreate(ObjBindMethod(implObj, "put_MediaType"), flags, 2)
