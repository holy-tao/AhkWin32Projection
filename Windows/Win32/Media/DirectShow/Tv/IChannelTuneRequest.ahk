 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ichanneltunerequest
...
class IChannelTuneRequest extends ITuneRequest{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ichanneltunerequest-get_channel
     */
    get_Channel() {
        result := ComCall(12, this, "int*", &Channel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ichanneltunerequest-put_channel
     */
    put_Channel(Channel) {
