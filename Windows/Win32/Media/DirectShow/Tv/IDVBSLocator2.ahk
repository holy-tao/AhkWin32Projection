...
export default struct IDVBSLocator2 extends IDVBSLocator {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_DiseqLNBSource := CallbackCreate(ObjBindMethod(implObj, "get_DiseqLNBSource"), flags, 2)
        this.vtbl.put_DiseqLNBSource := CallbackCreate(ObjBindMethod(implObj, "put_DiseqLNBSource"), flags, 2)
        this.vtbl.get_LocalOscillatorOverrideLow := CallbackCreate(ObjBindMethod(implObj, "get_LocalOscillatorOverrideLow"), flags, 2)
        this.vtbl.put_LocalOscillatorOverrideLow := CallbackCreate(ObjBindMethod(implObj, "put_LocalOscillatorOverrideLow"), flags, 2)
        this.vtbl.get_LocalOscillatorOverrideHigh := CallbackCreate(ObjBindMethod(implObj, "get_LocalOscillatorOverrideHigh"), flags, 2)
        this.vtbl.put_LocalOscillatorOverrideHigh := CallbackCreate(ObjBindMethod(implObj, "put_LocalOscillatorOverrideHigh"), flags, 2)
        this.vtbl.get_LocalLNBSwitchOverride := CallbackCreate(ObjBindMethod(implObj, "get_LocalLNBSwitchOverride"), flags, 2)
        this.vtbl.put_LocalLNBSwitchOverride := CallbackCreate(ObjBindMethod(implObj, "put_LocalLNBSwitchOverride"), flags, 2)
        this.vtbl.get_LocalSpectralInversionOverride := CallbackCreate(ObjBindMethod(implObj, "get_LocalSpectralInversionOverride"), flags, 2)
        this.vtbl.put_LocalSpectralInversionOverride := CallbackCreate(ObjBindMethod(implObj, "put_LocalSpectralInversionOverride"), flags, 2)
        this.vtbl.get_SignalRollOff := CallbackCreate(ObjBindMethod(implObj, "get_SignalRollOff"), flags, 2)
        this.vtbl.put_SignalRollOff := CallbackCreate(ObjBindMethod(implObj, "put_SignalRollOff"), flags, 2)
        this.vtbl.get_SignalPilot := CallbackCreate(ObjBindMethod(implObj, "get_SignalPilot"), flags, 2)
        this.vtbl.put_SignalPilot := CallbackCreate(ObjBindMethod(implObj, "put_SignalPilot"), flags, 2)
    }
