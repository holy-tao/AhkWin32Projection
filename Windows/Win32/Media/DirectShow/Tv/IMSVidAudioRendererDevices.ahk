 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidaudiorendererdevices
...
class IMSVidAudioRendererDevices extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorendererdevices-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorendererdevices-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorendererdevices-get_item
     */
    get_Item(v) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorendererdevices-add
     */
    Add(pDB) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorendererdevices-remove
     */
    Remove(v) {
