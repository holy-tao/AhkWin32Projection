 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-istreambufferrecordingattribute
...
class IStreamBufferRecordingAttribute extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferrecordingattribute-setattribute
     */
    SetAttribute(ulReserved, pszAttributeName, StreamBufferAttributeType, pbAttribute, cbAttributeLength) {
        ...
        result := ComCall(3, this, "uint", ulReserved, "ptr", pszAttributeName, "int", StreamBufferAttributeType, pbAttributeMarshal, pbAttribute, "ushort", cbAttributeLength, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferrecordingattribute-getattributecount
     */
    GetAttributeCount(ulReserved) {
        result := ComCall(4, this, "uint", ulReserved, "ushort*", &pcAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferrecordingattribute-getattributebyname
     */
    GetAttributeByName(pszAttributeName, pulReserved, pStreamBufferAttributeType, pbAttribute, pcbLength) {
        ...
        result := ComCall(5, this, "ptr", pszAttributeName, pulReservedMarshal, pulReserved, pStreamBufferAttributeTypeMarshal, pStreamBufferAttributeType, pbAttributeMarshal, pbAttribute, pcbLengthMarshal, pcbLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferrecordingattribute-getattributebyindex
     */
    GetAttributeByIndex(wIndex, pulReserved, pszAttributeName, pcchNameLength, pStreamBufferAttributeType, pbAttribute, pcbLength) {
        ...
        result := ComCall(6, this, "ushort", wIndex, pulReservedMarshal, pulReserved, "ptr", pszAttributeName, pcchNameLengthMarshal, pcchNameLength, pStreamBufferAttributeTypeMarshal, pStreamBufferAttributeType, pbAttributeMarshal, pbAttribute, pcbLengthMarshal, pcbLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferrecordingattribute-enumattributes
     */
    EnumAttributes() {
        result := ComCall(7, this, "ptr*", &ppIEnumStreamBufferAttrib := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
