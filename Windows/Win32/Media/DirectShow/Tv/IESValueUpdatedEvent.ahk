 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iesvalueupdatedevent
...
class IESValueUpdatedEvent extends IESEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesvalueupdatedevent-getvaluenames
     */
    GetValueNames() {
        result := ComCall(8, this, "ptr*", &pbstrNames := 0, "int")
        if(result != 0) {
