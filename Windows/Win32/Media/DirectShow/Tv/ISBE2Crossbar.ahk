 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-isbe2crossbar
...
class ISBE2Crossbar extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2crossbar-enabledefaultmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2crossbar-getinitialprofile
     */
    GetInitialProfile() {
        result := ComCall(4, this, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2crossbar-setoutputprofile
     */
    SetOutputProfile(pProfile, pcOutputPins, ppOutputPins) {
        pcOutputPinsMarshal := pcOutputPins is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr", pProfile, pcOutputPinsMarshal, pcOutputPins, "ptr*", ppOutputPins, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2crossbar-enumstreams
     */
    EnumStreams() {
        result := ComCall(6, this, "ptr*", &ppStreams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
