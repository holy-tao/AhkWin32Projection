...
export default struct IIsdbAudioComponentDescriptor extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetSimulcastGroupTag := CallbackCreate(GetMethod(implObj, "GetSimulcastGroupTag"), flags, 2)
        this.vtbl.GetESMultiLingualFlag := CallbackCreate(GetMethod(implObj, "GetESMultiLingualFlag"), flags, 2)
        this.vtbl.GetMainComponentFlag := CallbackCreate(GetMethod(implObj, "GetMainComponentFlag"), flags, 2)
        this.vtbl.GetQualityIndicator := CallbackCreate(GetMethod(implObj, "GetQualityIndicator"), flags, 2)
        this.vtbl.GetSamplingRate := CallbackCreate(GetMethod(implObj, "GetSamplingRate"), flags, 2)
        this.vtbl.GetLanguageCode := CallbackCreate(GetMethod(implObj, "GetLanguageCode"), flags, 2)
        this.vtbl.GetLanguageCode2 := CallbackCreate(GetMethod(implObj, "GetLanguageCode2"), flags, 2)
