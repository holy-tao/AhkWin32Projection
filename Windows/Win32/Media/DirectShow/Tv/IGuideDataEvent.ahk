 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nn-bdatif-iguidedataevent
...
class IGuideDataEvent extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-guidedataacquired
     */
    GuideDataAcquired() {
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-programchanged
     */
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-servicechanged
     */
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-scheduleentrychanged
     */
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-programdeleted
     */
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-servicedeleted
     */
     ...
     * @returns {HRESULT} Return S_OK if successful, or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataevent-scheduledeleted
     */
