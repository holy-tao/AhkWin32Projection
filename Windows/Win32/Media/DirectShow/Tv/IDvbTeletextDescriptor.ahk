 ...
 */
export default struct IDvbTeletextDescriptor extends IUnknown {
    /**
     ...
     * used for IDvbTeletextDescriptor interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        ...
        GetRecordTeletextType   : IntPtr
        GetRecordMagazineNumber : IntPtr
        GetRecordPageNumber     : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDvbTeletextDescriptor.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetRecordTeletextType)
        CallbackFree(this.vtbl.GetRecordMagazineNumber)
        CallbackFree(this.vtbl.GetRecordPageNumber)
    }
}
