...
export default struct IPBDA_EIT extends IUnknown {
    ...
    */
    ...
    GetRecordEventId(dwRecordIndex) {
        result := ComCall(8, this, UInt32, dwRecordIndex, "uint*", &plwVal := 0, "HRESULT")
        return plwVal
    }
    ...
    GetRecordDuration(dwRecordIndex) {
        pmdVal := MPEG_TIME()
        result := ComCall(10, this, UInt32, dwRecordIndex, MPEG_TIME.Ptr, pmdVal, "HRESULT")
        return pmdVal
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetTableId := CallbackCreate(ObjBindMethod(implObj, "GetTableId"), flags, 2)
        this.vtbl.GetVersionNumber := CallbackCreate(ObjBindMethod(implObj, "GetVersionNumber"), flags, 2)
        this.vtbl.GetServiceIdx := CallbackCreate(ObjBindMethod(implObj, "GetServiceIdx"), flags, 2)
