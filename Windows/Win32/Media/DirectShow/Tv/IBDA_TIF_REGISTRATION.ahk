 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nn-bdatif-ibda_tif_registration
...
class IBDA_TIF_REGISTRATION extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-ibda_tif_registration-registertifex
     */
    RegisterTIFEx(pTIFInputPin, ppvRegistrationContext, ppMpeg2DataControl) {
        ...
        result := ComCall(3, this, "ptr", pTIFInputPin, ppvRegistrationContextMarshal, ppvRegistrationContext, "ptr*", ppMpeg2DataControl, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} The method returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-ibda_tif_registration-unregistertif
     */
