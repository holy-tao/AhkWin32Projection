 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iscanningtunerex
...
class IScanningTunerEx extends IScanningTuner{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-getcurrentlocator
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-performexhaustivescan
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-terminatecurrentscan
     */
    TerminateCurrentScan() {
        result := ComCall(20, this, "int*", &pcurrentFreq := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-resumecurrentscan
     */
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-gettunerscanningcapability
     */
    GetTunerScanningCapability(HardwareAssistedScanning, NumStandardsSupported, BroadcastStandards) {
        ...
        result := ComCall(22, this, HardwareAssistedScanningMarshal, HardwareAssistedScanning, NumStandardsSupportedMarshal, NumStandardsSupported, "ptr", BroadcastStandards, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-gettunerstatus
     */
    GetTunerStatus(SecondsLeft, CurrentLockType, AutoDetect, CurrentFreq) {
        ...
        result := ComCall(23, this, SecondsLeftMarshal, SecondsLeft, CurrentLockTypeMarshal, CurrentLockType, AutoDetectMarshal, AutoDetect, CurrentFreqMarshal, CurrentFreq, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtunerex-getcurrenttunerstandardcapability
     */
    GetCurrentTunerStandardCapability(CurrentBroadcastStandard, SettlingTime, TvStandardsSupported) {
        ...
        result := ComCall(24, this, "ptr", CurrentBroadcastStandard, SettlingTimeMarshal, SettlingTime, TvStandardsSupportedMarshal, TvStandardsSupported, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
