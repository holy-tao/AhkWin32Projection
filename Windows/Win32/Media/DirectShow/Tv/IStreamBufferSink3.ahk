 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-istreambuffersink3
...
class IStreamBufferSink3 extends IStreamBufferSink2{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambuffersink3-setavailablefilter
     */
    SetAvailableFilter(prtMin) {
        prtMinMarshal := prtMin is VarRef ? "int64*" : "ptr"

        result := ComCall(7, this, prtMinMarshal, prtMin, "int")
        if(result != 0) {
