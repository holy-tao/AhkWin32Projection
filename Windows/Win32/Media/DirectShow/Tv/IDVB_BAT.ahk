 ...
 * @see https://learn.microsoft.com/windows/win32/api/dvbsiparser/nn-dvbsiparser-idvb_bat
 * @namespace Windows.Win32.Media.DirectShow.Tv
 */
export default struct IDVB_BAT extends IUnknown {
    /**
    ...
    */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/dvbsiparser/nf-dvbsiparser-idvb_bat-initialize
     */
    ...
    GetTableDescriptorByIndex(dwIndex, ppDescriptor) {
        result := ComCall(7, this, UInt32, dwIndex, IGenericDescriptor.Ptr, ppDescriptor, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetBouquetId := CallbackCreate(ObjBindMethod(implObj, "GetBouquetId"), flags, 2)
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetBouquetId)
