 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidvmr9
...
class IMSVidVMR9 extends IMSVidVideoRenderer{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvmr9-get_allocator_id
     */
    get_Allocator_ID() {
        result := ComCall(46, this, "int*", &ID := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvmr9-setallocator
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvmr9-put_suppresseffects
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvmr9-get_suppresseffects
     */
    get_SuppressEffects() {
        result := ComCall(49, this, "short*", &bSuppress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidvmr9-get_allocator
     */
    get_Allocator() {
        result := ComCall(50, this, "ptr*", &AllocPresent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
