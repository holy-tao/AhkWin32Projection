 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nn-bdatif-iguidedata
...
class IGuideData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getservices
     */
    GetServices() {
        result := ComCall(3, this, "ptr*", &ppEnumTuneRequests := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getserviceproperties
     */
    GetServiceProperties(pTuneRequest) {
        result := ComCall(4, this, "ptr", pTuneRequest, "ptr*", &ppEnumProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getguideprogramids
     */
    GetGuideProgramIDs() {
        result := ComCall(5, this, "ptr*", &pEnumPrograms := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IEnumGuideDataProperties} Pointer to a variable that receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/bdatif/nn-bdatif-ienumguidedataproperties">IEnumGuideDataProperties</a> interface pointer. Use this interface to enumerate the properties. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getprogramproperties
     */
    GetProgramProperties(varProgramDescriptionID) {
        result := ComCall(6, this, "ptr", varProgramDescriptionID, "ptr*", &ppEnumProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The returned <b>IEnumVARIANT</b> interface is not thread safe. Clients should not call methods on the interface from more than one thread.
     * @returns {IEnumVARIANT} Receives a pointer to the <b>IEnumVARIANT</b> interface. Use this interface to enumerate the collection. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getscheduleentryids
     */
    GetScheduleEntryIDs() {
        result := ComCall(7, this, "ptr*", &pEnumScheduleEntries := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IEnumGuideDataProperties} Pointer to a variable that receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/bdatif/nn-bdatif-ienumguidedataproperties">IEnumGuideDataProperties</a> interface pointer. Use this interface to enumerate the properties. The caller must release the interface
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedata-getscheduleentryproperties
     */
    GetScheduleEntryProperties(varScheduleEntryDescriptionID) {
        result := ComCall(8, this, "ptr", varScheduleEntryDescriptionID, "ptr*", &ppEnumProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
