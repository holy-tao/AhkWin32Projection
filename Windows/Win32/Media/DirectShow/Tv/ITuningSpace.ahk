 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ituningspace
...
class ITuningSpace extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_uniquename
     */
    get_UniqueName() {
        Name := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_uniquename
     */
    put_UniqueName(Name) {
        if(Name is String) {
            pin := BSTR.Alloc(Name)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_friendlyname
     */
    get_FriendlyName() {
        Name := BSTR()
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_friendlyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_clsid
     */
    get_CLSID() {
        SpaceCLSID := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_networktype
     */
    get_NetworkType() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_networktype
     */
    put_NetworkType(NetworkTypeGuid) {
        if(NetworkTypeGuid is String) {
            pin := BSTR.Alloc(NetworkTypeGuid)
            NetworkTypeGuid := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get__networktype
     */
    get__NetworkType() {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put__networktype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-createtunerequest
     */
    CreateTuneRequest() {
        result := ComCall(16, this, "ptr*", &TuneRequest_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-enumcategoryguids
     */
    EnumCategoryGUIDs() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-enumdevicemonikers
     */
    EnumDeviceMonikers() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_defaultpreferredcomponenttypes
     */
    get_DefaultPreferredComponentTypes() {
        result := ComCall(19, this, "ptr*", &ComponentTypes_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IComponentTypes(ComponentTypes_)
    }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_defaultpreferredcomponenttypes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_frequencymapping
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_frequencymapping
     */
    put_FrequencyMapping(Mapping) {
        if(Mapping is String) {
            pin := BSTR.Alloc(Mapping)
            Mapping := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-get_defaultlocator
     */
    get_DefaultLocator() {
        result := ComCall(23, this, "ptr*", &LocatorVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-put_defaultlocator
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspace-clone
     */
    Clone() {
        result := ComCall(25, this, "ptr*", &NewTS := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
