...
export default struct ITuningSpace extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_UniqueName := CallbackCreate(ObjBindMethod(implObj, "put_UniqueName"), flags, 2)
        ...
        this.vtbl.get_NetworkType := CallbackCreate(ObjBindMethod(implObj, "get_NetworkType"), flags, 2)
        this.vtbl.put_NetworkType := CallbackCreate(ObjBindMethod(implObj, "put_NetworkType"), flags, 2)
        this.vtbl.get__NetworkType := CallbackCreate(ObjBindMethod(implObj, "get__NetworkType"), flags, 2)
        this.vtbl.put__NetworkType := CallbackCreate(ObjBindMethod(implObj, "put__NetworkType"), flags, 2)
        this.vtbl.CreateTuneRequest := CallbackCreate(ObjBindMethod(implObj, "CreateTuneRequest"), flags, 2)
        this.vtbl.EnumCategoryGUIDs := CallbackCreate(ObjBindMethod(implObj, "EnumCategoryGUIDs"), flags, 2)
        this.vtbl.EnumDeviceMonikers := CallbackCreate(ObjBindMethod(implObj, "EnumDeviceMonikers"), flags, 2)
        this.vtbl.get_DefaultPreferredComponentTypes := CallbackCreate(ObjBindMethod(implObj, "get_DefaultPreferredComponentTypes"), flags, 2)
        this.vtbl.put_DefaultPreferredComponentTypes := CallbackCreate(ObjBindMethod(implObj, "put_DefaultPreferredComponentTypes"), flags, 2)
        this.vtbl.get_FrequencyMapping := CallbackCreate(ObjBindMethod(implObj, "get_FrequencyMapping"), flags, 2)
        this.vtbl.put_FrequencyMapping := CallbackCreate(ObjBindMethod(implObj, "put_FrequencyMapping"), flags, 2)
        this.vtbl.get_DefaultLocator := CallbackCreate(ObjBindMethod(implObj, "get_DefaultLocator"), flags, 2)
        this.vtbl.put_DefaultLocator := CallbackCreate(ObjBindMethod(implObj, "put_DefaultLocator"), flags, 2)
