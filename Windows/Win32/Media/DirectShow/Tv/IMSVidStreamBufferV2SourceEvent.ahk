 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidstreambufferv2sourceevent
...
class IMSVidStreamBufferV2SourceEvent extends IMSVidFilePlaybackEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-ratingschanged
     */
    RatingsChanged() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-timehole
     */
    TimeHole(StreamOffsetMS, SizeMS) {
        result := ComCall(9, this, "int", StreamOffsetMS, "int", SizeMS, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-staledataread
     */
    StaleDataRead() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-contentbecomingstale
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-stalefiledeleted
     */
    StaleFileDeleted() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-ratechange
     */
    RateChange(qwNewRate, qwOldRate) {
        result := ComCall(13, this, "double", qwNewRate, "double", qwOldRate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-broadcastevent
     */
    BroadcastEvent(Guid) {
        if(Guid is String) {
            pin := BSTR.Alloc(Guid)
        ...
        result := ComCall(14, this, "ptr", Guid, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-broadcasteventex
     */
    BroadcastEventEx(Guid, Param1, Param2, Param3, Param4) {
        ...
        result := ComCall(15, this, "ptr", Guid, "uint", Param1, "uint", Param2, "uint", Param3, "uint", Param4, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambufferv2sourceevent-contentprimarilyaudio
     */
