 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ianaloglocator
...
class IAnalogLocator extends ILocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianaloglocator-get_videostandard
     */
    get_VideoStandard() {
        result := ComCall(22, this, "int*", &AVS := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ianaloglocator-put_videostandard
     */
