 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor
...
class IIsdbTerrestrialDeliverySystemDescriptor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-gettag
     */
    GetTag() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-getlength
     */
    GetLength() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-getareacode
     */
    GetAreaCode() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-getguardinterval
     */
    GetGuardInterval() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-gettransmissionmode
     */
    GetTransmissionMode() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-getcountofrecords
     */
    GetCountOfRecords() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdbterrestrialdeliverysystemdescriptor-getrecordfrequency
     */
    GetRecordFrequency(bRecordIndex) {
        result := ComCall(9, this, "char", bRecordIndex, "uint*", &pdwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
