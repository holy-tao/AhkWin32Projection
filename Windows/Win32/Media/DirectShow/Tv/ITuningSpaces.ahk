 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ituningspaces
...
class ITuningSpaces extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspaces-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspaces-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspaces-get_item
     */
    get_Item(varIndex) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituningspaces-get_enumtuningspaces
     */
