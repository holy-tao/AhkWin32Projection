 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nn-mpeg2data-impeg2tablefilter
...
class IMpeg2TableFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-addpid
     */
    AddPID(p) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-addtable
     */
    AddTable(p, t) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-addextension
     */
    AddExtension(p, t, e) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-removepid
     */
    RemovePID(p) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-removetable
     */
    RemoveTable(p, t) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2tablefilter-removeextension
     */
