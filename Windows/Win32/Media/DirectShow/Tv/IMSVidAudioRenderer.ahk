 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidaudiorenderer
...
class IMSVidAudioRenderer extends IMSVidOutputDevice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorenderer-put_volume
     */
    put_Volume(lVol) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorenderer-get_volume
     */
    get_Volume() {
        result := ComCall(17, this, "int*", &lVol := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorenderer-put_balance
     */
    put_Balance(lBal) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidaudiorenderer-get_balance
     */
    get_Balance() {
        result := ComCall(19, this, "int*", &lBal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
