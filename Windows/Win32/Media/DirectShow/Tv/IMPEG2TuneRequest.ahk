 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-impeg2tunerequest
...
class IMPEG2TuneRequest extends ITuneRequest{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-impeg2tunerequest-get_tsid
     */
    get_TSID() {
        result := ComCall(12, this, "int*", &TSID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-impeg2tunerequest-put_tsid
     */
    put_TSID(TSID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-impeg2tunerequest-get_progno
     */
    get_ProgNo() {
        result := ComCall(14, this, "int*", &ProgNo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-impeg2tunerequest-put_progno
     */
    put_ProgNo(ProgNo) {
