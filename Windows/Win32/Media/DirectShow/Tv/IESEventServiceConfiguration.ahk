 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ieseventserviceconfiguration
...
class IESEventServiceConfiguration extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-setparent
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-removeparent
     */
    RemoveParent() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-setowner
     */
    SetOwner(pESEvents) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-removeowner
     */
    RemoveOwner() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-setgraph
     */
    SetGraph(pGraph) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ieseventserviceconfiguration-removegraph
     */
    RemoveGraph(pGraph) {
