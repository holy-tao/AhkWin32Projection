...
class IMSVidStreamBufferSink extends IMSVidOutputDevice{
    ...
    get_ContentRecorder(pszFilename, pRecordingIUnknown) {
        ...
        result := ComCall(16, this, "ptr", pszFilename, "ptr", pRecordingIUnknown, "int")
        if(result != 0)
    ...
    get_ReferenceRecorder(pszFilename, pRecordingIUnknown) {
        ...
        result := ComCall(17, this, "ptr", pszFilename, "ptr", pRecordingIUnknown, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SBESink(sbeConfig) {
        result := ComCall(21, this, "ptr", sbeConfig, "int")
        if(result != 0)
            throw OSError(result)
