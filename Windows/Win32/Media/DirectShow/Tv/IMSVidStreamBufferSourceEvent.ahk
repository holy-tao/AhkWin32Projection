 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidstreambuffersourceevent
...
class IMSVidStreamBufferSourceEvent extends IMSVidFilePlaybackEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-certificatefailure
     */
    CertificateFailure() {
     ...
     * This topic applies to Windows XP Service Pack 1 or later.
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-certificatesuccess
     */
    CertificateSuccess() {
     ...
     * This topic applies to Windows XP Service Pack 1 or later.
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-ratingsblocked
     */
    RatingsBlocked() {
     ...
     * This topic applies to Windows XP Service Pack 1 or later.
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-ratingsunblocked
     */
    RatingsUnblocked() {
     ...
     * This topic applies to Windows XP Service Pack 1 or later.
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-ratingschanged
     */
    RatingsChanged() {
     ...
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-timehole
     */
     ...
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-staledataread
     */
    StaleDataRead() {
     ...
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-contentbecomingstale
     */
     ...
     * @returns {HRESULT} Return S_OK or an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidstreambuffersourceevent-stalefiledeleted
     */
    StaleFileDeleted() {
