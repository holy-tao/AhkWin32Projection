 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ipersisttunexmlutility2
...
class IPersistTuneXmlUtility2 extends IPersistTuneXmlUtility{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ipersisttunexmlutility2-serialize
     */
    Serialize(piTuneRequest) {
        pString := BSTR()
        result := ComCall(4, this, "ptr", piTuneRequest, "ptr", pString, "int")
        if(result != 0) {
