 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidwebdvd2
...
class IMSVidWebDVD extends IMSVidPlayback{
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/playchaptersautostop-method
     */
     ...
     */
    PlayAtTime(strTime) {
        if(strTime is String) {
            pin := BSTR.Alloc(strTime)
            strTime := pin.Value
        }
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/playperiodintitleautostop-method
     */
    PlayPeriodInTitleAutoStop(lTitle, strStartTime, strEndTime) {
        if(strStartTime is String) {
            pin := BSTR.Alloc(strStartTime)
            strStartTime := pin.Value
        }
        if(strEndTime is String) {
            pin := BSTR.Alloc(strEndTime)
            strEndTime := pin.Value
        }
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectandactivatebutton-method
     */
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/activatebutton-method
     */
    ActivateButton() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectrightbutton-method
     */
    SelectRightButton() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectleftbutton-method
     */
    SelectLeftButton() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectlowerbutton-method
     */
    SelectLowerButton() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectupperbutton-method
     */
    SelectUpperButton() {
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/activateatposition-method
     */
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectatposition-method
     */
    ...
    get_ButtonAtPosition(xPos, yPos) {
        result := ComCall(58, this, "int", xPos, "int", yPos, "int*", &plButton := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_NumberOfChapters(lTitle) {
        result := ComCall(59, this, "int", lTitle, "int*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_CurrentDiscSide() {
        result := ComCall(64, this, "int*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} timeCode_ 
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/dvdtimecode2bstr-method
     */
    DVDTimeCode2bstr(timeCode_) {
        pTimeStr := BSTR()
        result := ComCall(69, this, "int", timeCode_, "ptr", pTimeStr, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/issubpicturestreamenabled-method
     */
    IsSubpictureStreamEnabled(lstream) {
        result := ComCall(72, this, "int", lstream, "short*", &fEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} lstream 
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/isaudiostreamenabled-method
     */
    IsAudioStreamEnabled(lstream) {
        result := ComCall(73, this, "int", lstream, "short*", &fEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_SubpictureStreamsAvailable() {
        result := ComCall(83, this, "int*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_SubpictureOn() {
        result := ComCall(84, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/acceptparentallevelchange-method
     */
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectparentalcountry-method
     */
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectparentallevel-method
     */
    ...
    get_TitleParentalLevels(lTitle) {
        result := ComCall(91, this, "int", lTitle, "int*", &plParentalLevels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_PlayerParentalCountry() {
        result := ComCall(92, this, "int*", &plCountryCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_PlayerParentalLevel() {
        result := ComCall(93, this, "int*", &plParentalLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/eject-method
     */
    Eject() {
     ...
     * @param {Integer} lUOP 
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/uopvalid-method
     */
    UOPValid(lUOP) {
        result := ComCall(95, this, "int", lUOP, "short*", &pfValid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_SPRM(lIndex) {
        result := ComCall(96, this, "int", lIndex, "short*", &psSPRM := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_GPRM(lIndex) {
        result := ComCall(97, this, "int", lIndex, "short*", &psSPRM := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DVDTextStringType(lLangIndex, lStringIndex) {
        result := ComCall(99, this, "int", lLangIndex, "int", lStringIndex, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DVDTextNumberOfStrings(lLangIndex) {
        result := ComCall(101, this, "int", lLangIndex, "int*", &plNumOfStrings := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DVDTextNumberOfLanguages() {
        result := ComCall(102, this, "int*", &plNumOfLangs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DVDTextLanguageLCID(lLangIndex) {
        result := ComCall(103, this, "int", lLangIndex, "int*", &lcid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_DVDAdm() {
        result := ComCall(105, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/deletebookmark-method
     */
    DeleteBookmark() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/restorebookmark-method
     */
    RestoreBookmark() {
     ...
     * @returns {HRESULT} No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/savebookmark-method
     */
    SaveBookmark() {
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectdefaultaudiolanguage-method
     */
     ...
     * 
     * No return value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/DirectShow/selectdefaultsubpicturelanguage-method
     */
    ...
    get_PreferredSubpictureStream() {
        result := ComCall(111, this, "int*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_DefaultMenuLanguage() {
        result := ComCall(112, this, "int*", &lang := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DefaultSubpictureLanguage() {
        result := ComCall(114, this, "int*", &lang := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DefaultAudioLanguage() {
        result := ComCall(115, this, "int*", &lang := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DefaultSubpictureLanguageExt() {
        result := ComCall(116, this, "int*", &ext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DefaultAudioLanguageExt() {
        result := ComCall(117, this, "int*", &ext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_KaraokeAudioPresentationMode() {
        result := ComCall(119, this, "int*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_KaraokeChannelContent(lStream, lChan) {
        result := ComCall(121, this, "int", lStream, "int", lChan, "int*", &lContent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_KaraokeChannelAssignment(lStream) {
        result := ComCall(122, this, "int", lStream, "int*", &lChannelAssignment := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_ButtonRect(lButton) {
        result := ComCall(124, this, "int", lButton, "ptr*", &pRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_DVDScreenInMouseCoordinates() {
        result := ComCall(125, this, "ptr*", &ppRect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
