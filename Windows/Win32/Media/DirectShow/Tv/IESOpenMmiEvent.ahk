 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iesopenmmievent
...
class IESOpenMmiEvent extends IESEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesopenmmievent-getdialognumber
     */
    GetDialogNumber(pDialogRequest) {
        pDialogRequestMarshal := pDialogRequest is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, pDialogRequestMarshal, pDialogRequest, "uint*", &pDialogNumber := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesopenmmievent-getdialogtype
     */
    GetDialogType() {
        guidDialogType := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesopenmmievent-getdialogdata
     */
    GetDialogData() {
        result := ComCall(10, this, "ptr*", &pbData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesopenmmievent-getdialogstringdata
     */
