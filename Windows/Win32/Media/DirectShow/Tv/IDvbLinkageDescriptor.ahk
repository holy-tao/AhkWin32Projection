 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-idvblinkagedescriptor
...
class IDvbLinkageDescriptor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-gettag
     */
    GetTag() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getlength
     */
    GetLength() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-gettsid
     */
    GetTSId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getonid
     */
    GetONId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getserviceid
     */
    GetServiceId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getlinkagetype
     */
    GetLinkageType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getprivatedatalength
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblinkagedescriptor-getprivatedata
     */
    GetPrivateData(pbLen) {
        pbLenMarshal := pbLen is VarRef ? "char*" : "ptr"

        result := ComCall(10, this, pbLenMarshal, pbLen, "char*", &pbData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
