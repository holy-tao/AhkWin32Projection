 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidinputdevice
...
class IMSVidInputDevice extends IMSVidDevice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidinputdevice-isviewable
     */
    IsViewable(v) {
        result := ComCall(16, this, "ptr", v, "short*", &pfViewable := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidinputdevice-view
     */
    View(v) {
