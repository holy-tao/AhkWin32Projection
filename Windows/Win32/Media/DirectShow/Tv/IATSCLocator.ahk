 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iatsclocator
...
class IATSCLocator extends IDigitalLocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator-get_physicalchannel
     */
    get_PhysicalChannel() {
        result := ComCall(22, this, "int*", &PhysicalChannel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator-put_physicalchannel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator-get_tsid
     */
    get_TSID() {
        result := ComCall(24, this, "int*", &TSID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsclocator-put_tsid
     */
    put_TSID(TSID) {
