 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iesisdbcasresponseevent
...
class IESIsdbCasResponseEvent extends IESEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesisdbcasresponseevent-getrequestid
     */
    GetRequestId() {
        result := ComCall(8, this, "uint*", &pRequestId := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesisdbcasresponseevent-getstatus
     */
    GetStatus() {
        result := ComCall(9, this, "uint*", &pStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesisdbcasresponseevent-getdatalength
     */
    GetDataLength() {
        result := ComCall(10, this, "uint*", &pRequestLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesisdbcasresponseevent-getresponsedata
     */
    GetResponseData() {
        result := ComCall(11, this, "ptr*", &pbData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
