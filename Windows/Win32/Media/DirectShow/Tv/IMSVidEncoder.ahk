 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidencoder
...
class IMSVidEncoder extends IMSVidFeature{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidencoder-get_videoencoderinterface
     */
    get_VideoEncoderInterface() {
        result := ComCall(16, this, "ptr*", &ppEncInt := 0, "int")
        if(result != 0) {
     ...
     * If the method succeeds, the caller must release the <b>IUnknown</b> interface.
     * @returns {IUnknown} Pointer to a variable that receives an <b>IUnknown</b> interface pointer. The caller can query this interface for the <a href="https://docs.microsoft.com/windows/desktop/api/strmif/nn-strmif-iencoderapi">IEncoderAPI</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidencoder-get_audioencoderinterface
     */
    get_AudioEncoderInterface() {
        result := ComCall(17, this, "ptr*", &ppEncInt := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
