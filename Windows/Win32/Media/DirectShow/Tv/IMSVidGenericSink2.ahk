 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidgenericsink2
...
class IMSVidGenericSink2 extends IMSVidGenericSink{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidgenericsink2-addfilter
     */
    AddFilter(bstrName) {
        ...
        result := ComCall(19, this, "ptr", bstrName, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidgenericsink2-resetfilterlist
     */
    ResetFilterList() {
