 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ienumcomponents
...
class IEnumComponents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponents-next
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponents-skip
     */
    Skip(celt) {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponents-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponents-clone
     */
    Clone() {
