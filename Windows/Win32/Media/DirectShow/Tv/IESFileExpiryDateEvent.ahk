 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iesfileexpirydateevent
...
class IESFileExpiryDateEvent extends IESEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-gettunerid
     */
    GetTunerId() {
        pguidTunerId := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-getexpirydate
     */
    GetExpiryDate() {
        result := ComCall(9, this, "uint*", &pqwExpiryDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-getfinalexpirydate
     */
    GetFinalExpiryDate() {
        result := ComCall(10, this, "uint*", &pqwExpiryDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-getmaxrenewalcount
     */
    GetMaxRenewalCount() {
        result := ComCall(11, this, "uint*", &dwMaxRenewalCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-isentitlementtokenpresent
     */
    IsEntitlementTokenPresent() {
        result := ComCall(12, this, "int*", &pfEntTokenPresent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesfileexpirydateevent-doesexpireafterfirstuse
     */
    DoesExpireAfterFirstUse() {
        result := ComCall(13, this, "int*", &pfExpireAfterFirstUse := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
