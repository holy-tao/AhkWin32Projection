 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ienumcomponenttypes
...
class IEnumComponentTypes extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponenttypes-next
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponenttypes-skip
     */
    Skip(celt) {
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponenttypes-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ienumcomponenttypes-clone
     */
    Clone() {
