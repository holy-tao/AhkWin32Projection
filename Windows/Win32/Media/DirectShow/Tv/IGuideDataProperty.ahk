 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nn-bdatif-iguidedataproperty
...
class IGuideDataProperty extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataproperty-get_name
     */
    get_Name() {
        pbstrName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataproperty-get_language
     */
    get_Language() {
        result := ComCall(4, this, "int*", &idLang := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bdatif/nf-bdatif-iguidedataproperty-get_value
     */
    get_Value() {
        pvar := VARIANT()
