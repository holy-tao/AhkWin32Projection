 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-isbe2globalevent
...
class ISBE2GlobalEvent extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2globalevent-getevent
     */
    GetEvent(idEvt, param1, param2, param3, param4, pSpanning, pcb, pb) {
        ...
        result := ComCall(3, this, "ptr", idEvt, "uint", param1, "uint", param2, "uint", param3, "uint", param4, pSpanningMarshal, pSpanning, pcbMarshal, pcb, pbMarshal, pb, "int")
        if(result != 0) {
