...
class ISBE2GlobalEvent2 extends ISBE2GlobalEvent{
     ...
     * @param {Pointer<Int64>} pStreamTime 
     * @returns {HRESULT} 
     */
    GetEventEx(idEvt, param1, param2, param3, param4, pSpanning, pcb, pb, pStreamTime) {
        result := ComCall(4, this, "ptr", idEvt, "uint", param1, "uint", param2, "uint", param3, "uint", param4, "ptr", pSpanning, "uint*", pcb, "char*", pb, "int64*", pStreamTime, "int")
        if(result != 0)
