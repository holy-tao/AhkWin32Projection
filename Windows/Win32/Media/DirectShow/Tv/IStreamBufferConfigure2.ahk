 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-istreambufferconfigure2
...
class IStreamBufferConfigure2 extends IStreamBufferConfigure{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferconfigure2-setmultiplexedpacketsize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferconfigure2-getmultiplexedpacketsize
     */
    GetMultiplexedPacketSize() {
        result := ComCall(10, this, "uint*", &pcbBytesPerPacket := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferconfigure2-setfftransitionrates
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-istreambufferconfigure2-getfftransitionrates
     */
    GetFFTransitionRates(pdwMaxFullFrameRate, pdwMaxNonSkippingRate) {
        ...
        result := ComCall(12, this, pdwMaxFullFrameRateMarshal, pdwMaxFullFrameRate, pdwMaxNonSkippingRateMarshal, pdwMaxNonSkippingRate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
