 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nn-sbe-isbe2enumstream
...
class ISBE2EnumStream extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2enumstream-next
     */
    Next(cRequest, pStreamDesc) {
        result := ComCall(3, this, "uint", cRequest, "ptr", pStreamDesc, "uint*", &pcReceived := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2enumstream-skip
     */
    Skip(cRecords) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2enumstream-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbe/nf-sbe-isbe2enumstream-clone
     */
    Clone() {
        result := ComCall(6, this, "ptr*", &ppIEnumStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
