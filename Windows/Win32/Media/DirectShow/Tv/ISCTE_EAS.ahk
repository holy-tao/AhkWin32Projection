 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nn-atscpsipparser-iscte_eas
...
class ISCTE_EAS extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getversionnumber
     */
    GetVersionNumber() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getsequencynumber
     */
    GetSequencyNumber() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getprotocolversion
     */
    GetProtocolVersion() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-geteaseventid
     */
    GetEASEventID() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getoriginatorcode
     */
    GetOriginatorCode() {
        result := ComCall(8, this, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-geteaseventcodelen
     */
    GetEASEventCodeLen() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-geteaseventcode
     */
    GetEASEventCode() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getrawnatureofactivationtextlen
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getrawnatureofactivationtext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getnatureofactivationtext
     */
    GetNatureOfActivationText(bstrIS0639code) {
        if(bstrIS0639code is String) {
            pin := BSTR.Alloc(bstrIS0639code)
            bstrIS0639code := pin.Value
        }

        pbstrString := BSTR()
        result := ComCall(13, this, "ptr", bstrIS0639code, "ptr", pbstrString, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-gettimeremaining
     */
    GetTimeRemaining() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getstarttime
     */
    GetStartTime() {
        result := ComCall(15, this, "uint*", &pdwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getduration
     */
    GetDuration() {
        result := ComCall(16, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getalertpriority
     */
    GetAlertPriority() {
        result := ComCall(17, this, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getdetailsoobsourceid
     */
    GetDetailsOOBSourceID() {
        result := ComCall(18, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getdetailsmajor
     */
    GetDetailsMajor() {
        result := ComCall(19, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getdetailsminor
     */
    GetDetailsMinor() {
        result := ComCall(20, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getdetailsaudiooobsourceid
     */
    GetDetailsAudioOOBSourceID() {
        result := ComCall(21, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getalerttext
     */
    GetAlertText(bstrIS0639code) {
        ...
        pbstrString := BSTR()
        result := ComCall(22, this, "ptr", bstrIS0639code, "ptr", pbstrString, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getrawalerttextlen
     */
    GetRawAlertTextLen() {
        result := ComCall(23, this, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getrawalerttext
     */
    GetRawAlertText() {
        result := ComCall(24, this, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getlocationcount
     */
    GetLocationCount() {
        result := ComCall(25, this, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getlocationcodes
     */
    GetLocationCodes(bIndex, pbState, pbCountySubdivision, pwCounty) {
        ...
        result := ComCall(26, this, "char", bIndex, pbStateMarshal, pbState, pbCountySubdivisionMarshal, pbCountySubdivision, pwCountyMarshal, pwCounty, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getexceptioncount
     */
    GetExceptionCount() {
        result := ComCall(27, this, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getexceptionservice
     */
    GetExceptionService(bIndex, pbIBRef, pwFirst, pwSecond) {
        ...
        result := ComCall(28, this, "char", bIndex, pbIBRefMarshal, pbIBRef, pwFirstMarshal, pwFirst, pwSecondMarshal, pwSecond, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-getcountoftabledescriptors
     */
    GetCountOfTableDescriptors() {
        result := ComCall(29, this, "uint*", &pdwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-gettabledescriptorbyindex
     */
    GetTableDescriptorByIndex(dwIndex) {
        result := ComCall(30, this, "uint", dwIndex, "ptr*", &ppDescriptor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/atscpsipparser/nf-atscpsipparser-iscte_eas-gettabledescriptorbytag
     */
    GetTableDescriptorByTag(bTag, pdwCookie) {
        pdwCookieMarshal := pdwCookie is VarRef ? "uint*" : "ptr"

        result := ComCall(31, this, "char", bTag, pdwCookieMarshal, pdwCookie, "ptr*", &ppDescriptor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
