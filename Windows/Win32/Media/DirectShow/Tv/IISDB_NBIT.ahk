...
class IISDB_NBIT extends IUnknown{
    ...
    GetRecordInformationType(dwRecordIndex, pbVal) {
        result := ComCall(8, this, "uint", dwRecordIndex, "char*", pbVal, "HRESULT")
        return result
    }
    ...
    GetRecordNumberOfKeys(dwRecordIndex, pbVal) {
        result := ComCall(12, this, "uint", dwRecordIndex, "char*", pbVal, "HRESULT")
        return result
    }
    ...
    GetRecordCountOfDescriptors(dwRecordIndex, pdwVal) {
        result := ComCall(14, this, "uint", dwRecordIndex, "uint*", pdwVal, "HRESULT")
        return result
    }
    ...
    GetRecordDescriptorByTag(dwRecordIndex, bTag, pdwCookie, ppDescriptor) {
        result := ComCall(16, this, "uint", dwRecordIndex, "char", bTag, "uint*", pdwCookie, "ptr*", ppDescriptor, "HRESULT")
        return result
    }
    ...
    GetVersionHash(pdwVersionHash) {
        result := ComCall(17, this, "uint*", pdwVersionHash, "HRESULT")
        return result
    }
}
