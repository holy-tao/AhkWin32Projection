 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidxdsevent
...
class IMSVidXDSEvent extends IMSVidFeatureEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidxdsevent-ratingchange
     */
    RatingChange(PrevRatingSystem, PrevLevel, PrevAttributes, NewRatingSystem, NewLevel, NewAttributes) {
        result := ComCall(8, this, "int", PrevRatingSystem, "int", PrevLevel, "int", PrevAttributes, "int", NewRatingSystem, "int", NewLevel, "int", NewAttributes, "int")
        if(result != 0) {
