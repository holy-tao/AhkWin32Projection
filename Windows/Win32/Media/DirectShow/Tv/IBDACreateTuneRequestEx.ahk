 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ibdacreatetunerequestex
...
class IBDACreateTuneRequestEx extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ibdacreatetunerequestex-createtunerequestex
     */
    CreateTuneRequestEx(TuneRequestIID) {
        result := ComCall(3, this, "ptr", TuneRequestIID, "ptr*", &TuneRequest_ := 0, "int")
        if(result != 0) {
