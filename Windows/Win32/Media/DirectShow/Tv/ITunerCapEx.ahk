 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-itunercapex
...
class ITunerCapEx extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-itunercapex-get_has608_708caption
     */
    get_Has608_708Caption() {
        result := ComCall(3, this, "short*", &pbHasCaption := 0, "int")
        if(result != 0) {
