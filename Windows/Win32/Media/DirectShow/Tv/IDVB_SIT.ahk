 ...
 * @see https://learn.microsoft.com/windows/win32/api/dvbsiparser/nn-dvbsiparser-idvb_sit
 * @namespace Windows.Win32.Media.DirectShow.Tv
 */
export default struct IDVB_SIT extends IUnknown {
    /**
    ...
    */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/dvbsiparser/nf-dvbsiparser-idvb_sit-initialize
     */
    ...
    GetTableDescriptorByIndex(dwIndex) {
        result := ComCall(6, this, UInt32, dwIndex, "ptr*", &ppDescriptor := 0, "HRESULT")
    ...
    GetRecordCountOfDescriptors(dwRecordIndex) {
        result := ComCall(11, this, UInt32, dwRecordIndex, "uint*", &pdwVal := 0, "HRESULT")
        return pdwVal
    }
    ...
    GetRecordDescriptorByIndex(dwRecordIndex, dwIndex) {
        result := ComCall(12, this, UInt32, dwRecordIndex, UInt32, dwIndex, "ptr*", &ppDescriptor := 0, "HRESULT")
        return IGenericDescriptor(ppDescriptor)
    }
    ...
    GetRecordDescriptorByTag(dwRecordIndex, bTag, pdwCookie) {
        ...
        result := ComCall(13, this, UInt32, dwRecordIndex, Int8, bTag, pdwCookieMarshal, pdwCookie, "ptr*", &ppDescriptor := 0, "HRESULT")
        return IGenericDescriptor(ppDescriptor)
    }
    ...
    RegisterForNextTable(hNextTableAvailable) {
        result := ComCall(14, this, HANDLE, hNextTableAvailable, "HRESULT")
        return result
    }
    ...
    GetNextTable(dwTimeout) {
        result := ComCall(15, this, UInt32, dwTimeout, "ptr*", &ppSIT := 0, "HRESULT")
    ...
    RegisterForWhenCurrent(hNextTableIsCurrent) {
        result := ComCall(16, this, HANDLE, hNextTableIsCurrent, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetNextTable := CallbackCreate(ObjBindMethod(implObj, "GetNextTable"), flags, 3)
