 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ituner
...
class ITuner extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-get_tuningspace
     */
    get_TuningSpace() {
        result := ComCall(3, this, "ptr*", &TuningSpace_ := 0, "int")
        if(result != 0) {
     ...
     * @param {ITuningSpace} TuningSpace_ Pointer to the tuning space that will be set in the Network Provider.
     * @returns {HRESULT} When the method is successful, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-put_tuningspace
     */
    put_TuningSpace(TuningSpace_) {
        result := ComCall(4, this, "ptr", TuningSpace_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-enumtuningspaces
     */
    EnumTuningSpaces() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-get_tunerequest
     */
    get_TuneRequest() {
        result := ComCall(6, this, "ptr*", &TuneRequest_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {ITuneRequest} TuneRequest_ Pointer to an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-itunerequest">ITuneRequest</a> object that will be used to set the Network Provider.
     * @returns {HRESULT} When the method is successful, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-put_tunerequest
     */
    put_TuneRequest(TuneRequest_) {
        result := ComCall(7, this, "ptr", TuneRequest_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {ITuneRequest} TuneRequest_ Pointer to the tune request object.
     * @returns {HRESULT} When the method is successful, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-validate
     */
    Validate(TuneRequest_) {
        result := ComCall(8, this, "ptr", TuneRequest_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-get_preferredcomponenttypes
     */
    get_PreferredComponentTypes() {
        result := ComCall(9, this, "ptr*", &ComponentTypes_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IComponentTypes} ComponentTypes_ Pointer to an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-icomponenttypes">IComponentTypes</a> interface that contains the collection of ComponentType objects.
     * @returns {HRESULT} When the method is successful, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-put_preferredcomponenttypes
     */
    put_PreferredComponentTypes(ComponentTypes_) {
        result := ComCall(10, this, "ptr", ComponentTypes_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-get_signalstrength
     */
    get_SignalStrength() {
        result := ComCall(11, this, "int*", &Strength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Interval_ Specifies the time-out interval in milliseconds.
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ituner-triggersignalevents
     */
    TriggerSignalEvents(Interval_) {
        result := ComCall(12, this, "int", Interval_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
