 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nn-msvidctl-imsvidctl
...
class IMSVidCtl extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_autosize
     */
    get_AutoSize() {
        result := ComCall(7, this, "short*", &pbool := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_autosize
     */
    put_AutoSize(vbool) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_backcolor
     */
    get_BackColor() {
        result := ComCall(9, this, "uint*", &backcolor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_backcolor
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_enabled
     */
    get_Enabled() {
        result := ComCall(11, this, "short*", &pbool := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_enabled
     */
    put_Enabled(vbool) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_tabstop
     */
    get_TabStop() {
        result := ComCall(13, this, "short*", &pbool := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} vbool 
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_tabstop
     */
    put_TabStop(vbool) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_window
     */
    get_Window() {
        phwnd := HWND()
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-refresh
     */
    Refresh() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_displaysize
     */
    get_DisplaySize() {
        result := ComCall(17, this, "int*", &CurrentValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_displaysize
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_maintainaspectratio
     */
    get_MaintainAspectRatio() {
        result := ComCall(19, this, "short*", &CurrentValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_maintainaspectratio
     */
     ...
     * @returns {Integer} Receives an <b>OLE_COLOR</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_colorkey
     */
    get_ColorKey() {
        result := ComCall(21, this, "uint*", &CurrentValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_colorkey
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_inputsavailable
     */
    get_InputsAvailable(CategoryGuid) {
        if(CategoryGuid is String) {
            pin := BSTR.Alloc(CategoryGuid)
            CategoryGuid := pin.Value
        }

        result := ComCall(23, this, "ptr", CategoryGuid, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_outputsavailable
     */
    get_OutputsAvailable(CategoryGuid) {
        ...
        result := ComCall(24, this, "ptr", CategoryGuid, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {IMSVidInputDevices} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidinputdevices">IMSVidInputDevices</a> interface pointer. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get__inputsavailable
     */
    get__InputsAvailable(CategoryGuid) {
        result := ComCall(25, this, "ptr", CategoryGuid, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IMSVidOutputDevices} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidoutputdevices">IMSVidOutputDevices</a> interface pointer. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get__outputsavailable
     */
    get__OutputsAvailable(CategoryGuid) {
        result := ComCall(26, this, "ptr", CategoryGuid, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_videorenderersavailable
     */
    get_VideoRenderersAvailable() {
        result := ComCall(27, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_audiorenderersavailable
     */
    get_AudioRenderersAvailable() {
        result := ComCall(28, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_featuresavailable
     */
    get_FeaturesAvailable() {
        result := ComCall(29, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_inputactive
     */
    get_InputActive() {
        result := ComCall(30, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_inputactive
     */
     ...
     * @returns {IMSVidOutputDevices} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidoutputdevices">IMSVidOutputDevices</a> interface pointer. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_outputsactive
     */
    get_OutputsActive() {
        result := ComCall(32, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_outputsactive
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_videorendereractive
     */
    get_VideoRendererActive() {
        result := ComCall(34, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_videorendereractive
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_audiorendereractive
     */
    get_AudioRendererActive() {
        result := ComCall(36, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_audiorendereractive
     */
     ...
     * @returns {IMSVidFeatures} Receives an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/msvidfeatures">IMSVidFeatures</a> interface pointer. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_featuresactive
     */
    get_FeaturesActive() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-put_featuresactive
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-get_state
     */
    get_State() {
        result := ComCall(40, this, "int*", &lState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-view
     */
    View(v) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-build
     */
    Build() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-pause
     */
    Pause() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-run
     */
    Run() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-stop
     */
    Stop() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-decompose
     */
    Decompose() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-disablevideo
     */
    DisableVideo() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-disableaudio
     */
    DisableAudio() {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msvidctl/nf-msvidctl-imsvidctl-viewnext
     */
    ViewNext(v) {
