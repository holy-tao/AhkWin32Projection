...
export default struct IMSVidCtl extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AutoSize := CallbackCreate(ObjBindMethod(implObj, "get_AutoSize"), flags, 2)
        this.vtbl.put_AutoSize := CallbackCreate(ObjBindMethod(implObj, "put_AutoSize"), flags, 2)
        ...
        this.vtbl.get_DisplaySize := CallbackCreate(ObjBindMethod(implObj, "get_DisplaySize"), flags, 2)
        this.vtbl.put_DisplaySize := CallbackCreate(ObjBindMethod(implObj, "put_DisplaySize"), flags, 2)
        ...
        this.vtbl.get_InputsAvailable := CallbackCreate(ObjBindMethod(implObj, "get_InputsAvailable"), flags, 3)
        this.vtbl.get_OutputsAvailable := CallbackCreate(ObjBindMethod(implObj, "get_OutputsAvailable"), flags, 3)
        this.vtbl.get__InputsAvailable := CallbackCreate(ObjBindMethod(implObj, "get__InputsAvailable"), flags, 3)
        this.vtbl.get__OutputsAvailable := CallbackCreate(ObjBindMethod(implObj, "get__OutputsAvailable"), flags, 3)
        this.vtbl.get_VideoRenderersAvailable := CallbackCreate(ObjBindMethod(implObj, "get_VideoRenderersAvailable"), flags, 2)
        this.vtbl.get_AudioRenderersAvailable := CallbackCreate(ObjBindMethod(implObj, "get_AudioRenderersAvailable"), flags, 2)
        this.vtbl.get_FeaturesAvailable := CallbackCreate(ObjBindMethod(implObj, "get_FeaturesAvailable"), flags, 2)
        this.vtbl.get_InputActive := CallbackCreate(ObjBindMethod(implObj, "get_InputActive"), flags, 2)
        this.vtbl.put_InputActive := CallbackCreate(ObjBindMethod(implObj, "put_InputActive"), flags, 2)
        this.vtbl.get_OutputsActive := CallbackCreate(ObjBindMethod(implObj, "get_OutputsActive"), flags, 2)
        this.vtbl.put_OutputsActive := CallbackCreate(ObjBindMethod(implObj, "put_OutputsActive"), flags, 2)
        this.vtbl.get_VideoRendererActive := CallbackCreate(ObjBindMethod(implObj, "get_VideoRendererActive"), flags, 2)
        this.vtbl.put_VideoRendererActive := CallbackCreate(ObjBindMethod(implObj, "put_VideoRendererActive"), flags, 2)
        this.vtbl.get_AudioRendererActive := CallbackCreate(ObjBindMethod(implObj, "get_AudioRendererActive"), flags, 2)
        this.vtbl.put_AudioRendererActive := CallbackCreate(ObjBindMethod(implObj, "put_AudioRendererActive"), flags, 2)
        this.vtbl.get_FeaturesActive := CallbackCreate(ObjBindMethod(implObj, "get_FeaturesActive"), flags, 2)
        this.vtbl.put_FeaturesActive := CallbackCreate(ObjBindMethod(implObj, "put_FeaturesActive"), flags, 2)
        ...
        this.vtbl.DisableVideo := CallbackCreate(ObjBindMethod(implObj, "DisableVideo"), flags, 1)
        this.vtbl.DisableAudio := CallbackCreate(ObjBindMethod(implObj, "DisableAudio"), flags, 1)
        this.vtbl.ViewNext := CallbackCreate(ObjBindMethod(implObj, "ViewNext"), flags, 2)
    }
