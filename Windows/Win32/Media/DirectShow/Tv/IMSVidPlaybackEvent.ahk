 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidplaybackevent
...
class IMSVidPlaybackEvent extends IMSVidInputDeviceEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplaybackevent-endofmedia
     */
    EndOfMedia(lpd) {
