 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidxds
...
class IMSVidXDS extends IMSVidFeature{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidxds-get_channelchangeinterface
     */
    get_ChannelChangeInterface() {
        result := ComCall(16, this, "ptr*", &punkCC := 0, "int")
        if(result != 0) {
