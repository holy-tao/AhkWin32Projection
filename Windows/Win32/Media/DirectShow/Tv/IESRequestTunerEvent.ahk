 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iesrequesttunerevent
...
class IESRequestTunerEvent extends IESEvent{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesrequesttunerevent-getpriority
     */
    GetPriority() {
        result := ComCall(8, this, "char*", &pbyPriority := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesrequesttunerevent-getreason
     */
    GetReason() {
        result := ComCall(9, this, "char*", &pbyReason := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesrequesttunerevent-getconsequences
     */
    GetConsequences() {
        result := ComCall(10, this, "char*", &pbyConsequences := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iesrequesttunerevent-getestimatedtime
     */
    GetEstimatedTime() {
        result := ComCall(11, this, "uint*", &pdwEstimatedTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
