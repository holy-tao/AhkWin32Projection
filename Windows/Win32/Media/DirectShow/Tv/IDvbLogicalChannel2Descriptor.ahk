 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-idvblogicalchannel2descriptor
...
class IDvbLogicalChannel2Descriptor extends IDvbLogicalChannelDescriptor2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getcountoflists
     */
    GetCountOfLists() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistid
     */
    GetListId(bListIndex) {
        result := ComCall(10, this, "char", bListIndex, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistnamew
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistcountrycode
     */
    GetListCountryCode(bListIndex) {
        result := ComCall(12, this, "char", bListIndex, "char*", &pszCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistcountofrecords
     */
    GetListCountOfRecords(bChannelListIndex) {
        result := ComCall(13, this, "char", bChannelListIndex, "char*", &pbVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistrecordserviceid
     */
    GetListRecordServiceId(bListIndex, bRecordIndex) {
        result := ComCall(14, this, "char", bListIndex, "char", bRecordIndex, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *   indexed from zero. Call the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistcountofrecords">IDvbLogicalChannel2Descriptor::GetListCountOfRecords</a> method to get the number of service records in the logical channel descriptor.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistrecordlogicalchannelnumber
     */
    GetListRecordLogicalChannelNumber(bListIndex, bRecordIndex) {
        result := ComCall(15, this, "char", bListIndex, "char", bRecordIndex, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvblogicalchannel2descriptor-getlistrecordlogicalchannelandvisibility
     */
    GetListRecordLogicalChannelAndVisibility(bListIndex, bRecordIndex) {
        result := ComCall(16, this, "char", bListIndex, "char", bRecordIndex, "ushort*", &pwVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
