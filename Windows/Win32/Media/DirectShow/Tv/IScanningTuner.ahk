 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iscanningtuner
...
class IScanningTuner extends ITuner{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtuner-seekup
     */
    SeekUp() {
     ...
     * Currently the DVB-C and DVB-S Network Provider filters do not implement this method, and return E_NOTIMPL. The method is implemented for DVB-T.
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtuner-seekdown
     */
    SeekDown() {
     ...
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtuner-scanup
     */
     ...
     * @param {Integer} MillisecondsPause The number of milliseconds to pause.
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtuner-scandown
     */
     ...
     * Currently the DVB-C and DVB-S Network Provider filters do not implement this method, and return E_NOTIMPL. The method is implemented for DVB-T.
     * @returns {HRESULT} When the method succeeds, it returns S_OK. Otherwise it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iscanningtuner-autoprogram
     */
    AutoProgram() {
