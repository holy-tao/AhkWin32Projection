 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nn-encdec-idtfilter3
...
class IDTFilter3 extends IDTFilter2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-idtfilter3-getprotectiontype
     */
    GetProtectionType() {
        result := ComCall(14, this, "int*", &pProtectionType := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-idtfilter3-licensehasexpirationdate
     */
    LicenseHasExpirationDate() {
        result := ComCall(15, this, "int*", &pfLicenseHasExpirationDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/encdec/nf-encdec-idtfilter3-setrights
     */
    SetRights(bstrRights) {
        if(bstrRights is String) {
            pin := BSTR.Alloc(bstrRights)
            bstrRights := pin.Value
        }
