 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-iatsctuningspace
...
class IATSCTuningSpace extends IAnalogTVTuningSpace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-get_minminorchannel
     */
    get_MinMinorChannel() {
        result := ComCall(34, this, "int*", &MinMinorChannelVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-put_minminorchannel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-get_maxminorchannel
     */
    get_MaxMinorChannel() {
        result := ComCall(36, this, "int*", &MaxMinorChannelVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-put_maxminorchannel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-get_minphysicalchannel
     */
    get_MinPhysicalChannel() {
        result := ComCall(38, this, "int*", &MinPhysicalChannelVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-put_minphysicalchannel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-get_maxphysicalchannel
     */
    get_MaxPhysicalChannel() {
        result := ComCall(40, this, "int*", &MaxPhysicalChannelVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-iatsctuningspace-put_maxphysicalchannel
     */
