 ...
 */
export default struct IDvbSubtitlingDescriptor extends IUnknown {
    /**
     ...
     * used for IDvbSubtitlingDescriptor interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        ...
        GetRecordSubtitlingType    : IntPtr
        GetRecordCompositionPageID : IntPtr
        GetRecordAncillaryPageID   : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDvbSubtitlingDescriptor.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetRecordSubtitlingType)
        CallbackFree(this.vtbl.GetRecordCompositionPageID)
        CallbackFree(this.vtbl.GetRecordAncillaryPageID)
    }
}
