 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-ipersisttunexml
...
class IPersistTuneXml extends IPersist{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ipersisttunexml-initnew
     */
    InitNew() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ipersisttunexml-load
     */
    Load(varValue) {
        result := ComCall(5, this, "ptr", varValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-ipersisttunexml-save
     */
    Save() {
        pvarFragment := VARIANT()
        result := ComCall(6, this, "ptr", pvarFragment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
