 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nn-mpeg2data-impeg2data
...
class IMpeg2Data extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2data-getsection
     */
    GetSection(pid, tid, pFilter, dwTimeout) {
        result := ComCall(3, this, "ushort", pid, "char", tid, "ptr", pFilter, "uint", dwTimeout, "ptr*", &ppSectionList := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2data-gettable
     */
    GetTable(pid, tid, pFilter, dwTimeout) {
        result := ComCall(4, this, "ushort", pid, "char", tid, "ptr", pFilter, "uint", dwTimeout, "ptr*", &ppSectionList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mpeg2data/nf-mpeg2data-impeg2data-getstreamofsections
     */
    GetStreamOfSections(pid, tid, pFilter, hDataReadyEvent) {
        ...
        result := ComCall(5, this, "ushort", pid, "char", tid, "ptr", pFilter, "ptr", hDataReadyEvent, "ptr*", &ppMpegStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
