 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-idvbtlocator
...
class IDVBTLocator extends IDigitalLocator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_bandwidth
     */
    get_Bandwidth() {
        result := ComCall(22, this, "int*", &BandWidthVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_bandwidth
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_lpinnerfec
     */
    get_LPInnerFEC() {
        result := ComCall(24, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_lpinnerfec
     */
    put_LPInnerFEC(FEC) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_lpinnerfecrate
     */
    get_LPInnerFECRate() {
        result := ComCall(26, this, "int*", &FEC := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_lpinnerfecrate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_halpha
     */
    get_HAlpha() {
        result := ComCall(28, this, "int*", &Alpha := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_halpha
     */
    put_HAlpha(Alpha) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_guard
     */
    get_Guard() {
        result := ComCall(30, this, "int*", &GI := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_guard
     */
    put_Guard(GI) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_mode
     */
    get_Mode() {
        result := ComCall(32, this, "int*", &mode_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} mode_ Specifies the transmission mode as a member of the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/mstv/transmissionmode">TransmissionMode</a> enumeration.
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_mode
     */
    put_Mode(mode_) {
        result := ComCall(33, this, "int", mode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-get_otherfrequencyinuse
     */
    get_OtherFrequencyInUse() {
        result := ComCall(34, this, "short*", &OtherFrequencyInUseVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-idvbtlocator-put_otherfrequencyinuse
     */
