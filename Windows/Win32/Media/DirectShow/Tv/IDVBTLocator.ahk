...
export default struct IDVBTLocator extends IDigitalLocator {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_LPInnerFEC := CallbackCreate(ObjBindMethod(implObj, "get_LPInnerFEC"), flags, 2)
        this.vtbl.put_LPInnerFEC := CallbackCreate(ObjBindMethod(implObj, "put_LPInnerFEC"), flags, 2)
        this.vtbl.get_LPInnerFECRate := CallbackCreate(ObjBindMethod(implObj, "get_LPInnerFECRate"), flags, 2)
        this.vtbl.put_LPInnerFECRate := CallbackCreate(ObjBindMethod(implObj, "put_LPInnerFECRate"), flags, 2)
        this.vtbl.get_HAlpha := CallbackCreate(ObjBindMethod(implObj, "get_HAlpha"), flags, 2)
        this.vtbl.put_HAlpha := CallbackCreate(ObjBindMethod(implObj, "put_HAlpha"), flags, 2)
        this.vtbl.get_Guard := CallbackCreate(ObjBindMethod(implObj, "get_Guard"), flags, 2)
        this.vtbl.put_Guard := CallbackCreate(ObjBindMethod(implObj, "put_Guard"), flags, 2)
        ...
        this.vtbl.get_OtherFrequencyInUse := CallbackCreate(ObjBindMethod(implObj, "get_OtherFrequencyInUse"), flags, 2)
        this.vtbl.put_OtherFrequencyInUse := CallbackCreate(ObjBindMethod(implObj, "put_OtherFrequencyInUse"), flags, 2)
    }
