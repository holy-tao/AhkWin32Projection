 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nn-tuner-icomponenttypes
...
class IComponentTypes extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-enumcomponenttypes
     */
    EnumComponentTypes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-get_item
     */
    get_Item(Index) {
        result := ComCall(10, this, "ptr", Index, "ptr*", &ComponentType_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IComponentType(ComponentType_)
    }
     ...
     * @param {IComponentType} ComponentType_ Pointer to the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-icomponenttype">IComponentType</a> object that will be inserted into the collection.
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-put_item
     */
    put_Item(Index, ComponentType_) {
        result := ComCall(11, this, "ptr", Index, "ptr", ComponentType_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IComponentType} ComponentType_ Pointer to the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-icomponenttype">IComponentType</a> object that will be added to the collection.
     * @returns {VARIANT} The index number of the component type after it has been added to the collection.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-add
     */
    Add(ComponentType_) {
        NewIndex := VARIANT()
        result := ComCall(12, this, "ptr", ComponentType_, "ptr", NewIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful. If the method fails, error information can be retrieved using the standard COM <b>IErrorInfo</b> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-remove
     */
    Remove(Index) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tuner/nf-tuner-icomponenttypes-clone
     */
    Clone() {
        result := ComCall(14, this, "ptr*", &NewList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
