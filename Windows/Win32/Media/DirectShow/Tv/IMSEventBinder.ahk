...
class IMSEventBinder extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<IDispatch>} pEventObject 
     * @param {BSTR} EventName 
     * @param {BSTR} EventHandler 
     * @param {Pointer<Int32>} CancelID 
     * @returns {HRESULT} 
     */
    Bind(pEventObject, EventName, EventHandler, CancelID) {
        ...
        result := ComCall(7, this, "ptr", pEventObject, "ptr", EventName, "ptr", EventHandler, "int*", CancelID, "int")
        if(result != 0)
