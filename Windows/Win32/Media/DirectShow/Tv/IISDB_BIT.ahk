 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-iisdb_bit
...
class IISDB_BIT extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getversionnumber
     */
    GetVersionNumber() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getoriginalnetworkid
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getbroadcastviewpropriety
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getcountoftabledescriptors
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-gettabledescriptorbyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-gettabledescriptorbytag
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getcountofrecords
     */
    GetCountOfRecords() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getrecordbroadcasterid
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getrecordcountofdescriptors
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getrecorddescriptorbyindex
     */
     ...
     *   </a> interface pointer. Use this interface to retrieve the information
     *   in the descriptor. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getrecorddescriptorbytag
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-iisdb_bit-getversionhash
     */
    GetVersionHash() {
        result := ComCall(15, this, "uint*", &pdwVersionHash := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
