 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nn-dvbsiparser-idvbdefaultauthoritydescriptor
...
class IDvbDefaultAuthorityDescriptor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvbdefaultauthoritydescriptor-gettag
     */
    GetTag() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvbdefaultauthoritydescriptor-getlength
     */
    GetLength() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dvbsiparser/nf-dvbsiparser-idvbdefaultauthoritydescriptor-getdefaultauthority
     */
    GetDefaultAuthority(pbLength, ppbBytes) {
        ...
        result := ComCall(5, this, pbLengthMarshal, pbLength, ppbBytesMarshal, ppbBytes, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
