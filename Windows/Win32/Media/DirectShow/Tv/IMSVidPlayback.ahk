 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/segment/nn-segment-imsvidplayback
...
class IMSVidPlayback extends IMSVidInputDevice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_enableresetonstop
     */
    get_EnableResetOnStop() {
        result := ComCall(18, this, "short*", &pVal := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-put_enableresetonstop
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-run
     */
    Run() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-pause
     */
    Pause() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-stop
     */
    Stop() {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_canstep
     */
    get_CanStep(fBackwards) {
        result := ComCall(23, this, "short", fBackwards, "short*", &pfCan := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-step
     */
    Step(lStep) {
     ...
     * <div class="alert"><b>Note</b>  The value ERROR_INVALID_STATE is converted to an <b>HRESULT</b> with the <b>HRESULT_FROM_WIN32</b> macro.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-put_rate
     */
    put_Rate(plRate) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_rate
     */
    get_Rate() {
        result := ComCall(26, this, "double*", &plRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div class="alert"><b>Note</b>  The value ERROR_INVALID_STATE is converted to an <b>HRESULT</b> with the <b>HRESULT_FROM_WIN32</b> macro.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-put_currentposition
     */
     ...
     * 
     * To set the position mode, call <a href="https://docs.microsoft.com/windows/desktop/api/segment/nf-segment-imsvidplayback-put_positionmode">IMSVidPlayback::put_PositionMode</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_currentposition
     */
    get_CurrentPosition() {
        result := ComCall(28, this, "int*", &lPosition := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div class="alert"><b>Note</b>  The value ERROR_INVALID_STATE is converted to an <b>HRESULT</b> with the <b>HRESULT_FROM_WIN32</b> macro.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-put_positionmode
     */
     ...
     * Call the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msvidctl/nf-msvidctl-imsvidctl-build">IMSVidCtl::Build</a> or <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msvidctl/nf-msvidctl-imsvidctl-view">IMSVidCtl::View</a> method before calling this method.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_positionmode
     */
    get_PositionMode() {
        result := ComCall(30, this, "int*", &lPositionMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * To set the position mode, call <a href="https://docs.microsoft.com/windows/desktop/api/segment/nf-segment-imsvidplayback-put_positionmode">IMSVidPlayback::put_PositionMode</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/segment/nf-segment-imsvidplayback-get_length
     */
    get_Length() {
        result := ComCall(31, this, "int*", &lLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
