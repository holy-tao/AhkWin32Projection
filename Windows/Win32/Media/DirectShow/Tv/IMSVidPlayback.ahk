...
export default struct IMSVidPlayback extends IMSVidInputDevice {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_EnableResetOnStop := CallbackCreate(ObjBindMethod(implObj, "get_EnableResetOnStop"), flags, 2)
        this.vtbl.put_EnableResetOnStop := CallbackCreate(ObjBindMethod(implObj, "put_EnableResetOnStop"), flags, 2)
        ...
        this.vtbl.get_CanStep := CallbackCreate(ObjBindMethod(implObj, "get_CanStep"), flags, 3)
        ...
        this.vtbl.put_PositionMode := CallbackCreate(ObjBindMethod(implObj, "put_PositionMode"), flags, 2)
        this.vtbl.get_PositionMode := CallbackCreate(ObjBindMethod(implObj, "get_PositionMode"), flags, 2)
