 ...
 */
export default struct PDXVA2SW_GETPROCAMPRANGE {
    value : IntPtr

    __value {
        set {
            if (value is PDXVA2SW_GETPROCAMPRANGE) {
     ...
     * @returns {HRESULT} 
     */
    Call(pVideoDesc, RenderTargetFormat, ProcAmpCap, pRange) {
        result := DllCall(this.value, DXVA2_VideoDesc.Ptr, pVideoDesc, D3DFORMAT, RenderTargetFormat, UInt32, ProcAmpCap, DXVA2_ValueRange.Ptr, pRange, "HRESULT")
        return result
    }

    /**
     * A PDXVA2SW_GETPROCAMPRANGE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PDXVA2SW_GETPROCAMPRANGE {
        /**
         * Creates a PDXVA2SW_GETPROCAMPRANGE pointer that invokes the given AHK function when called.
