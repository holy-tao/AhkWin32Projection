 ...
 * @version v4.0.30319
 */
class PDXVA2SW_GETPROCAMPRANGE extends IUnknown {
     ...
     */
    Invoke(pVideoDesc, RenderTargetFormat, ProcAmpCap) {
        pRange := DXVA2_ValueRange()
        result := ComCall(3, this, "ptr", pVideoDesc, "uint", RenderTargetFormat, "uint", ProcAmpCap, "ptr", pRange, "int")
        if(result != 0) {
