 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-imeminputpin
...
class IMemInputPin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-getallocator
     */
    GetAllocator() {
        result := ComCall(3, this, "ptr*", &ppAllocator := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-notifyallocator
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-getallocatorrequirements
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-receive
     */
    Receive(pSample) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-receivemultiple
     */
    ReceiveMultiple(pSamples, nSamples) {
        result := ComCall(7, this, "ptr*", pSamples, "int", nSamples, "int*", &nSamplesProcessed := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-imeminputpin-receivecanblock
     */
    ReceiveCanBlock() {
