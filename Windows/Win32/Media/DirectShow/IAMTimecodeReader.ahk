 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamtimecodereader
...
class IAMTimecodeReader extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtimecodereader-gettcrmode
     */
    GetTCRMode(Param) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtimecodereader-settcrmode
     */
     ...
     * @returns {HRESULT} Returns E_NOTIMPL.
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtimecodereader-put_vitcline
     */
    put_VITCLine(Line) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtimecodereader-get_vitcline
     */
    get_VITCLine() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamtimecodereader-gettimecode
     */
    GetTimecode() {
