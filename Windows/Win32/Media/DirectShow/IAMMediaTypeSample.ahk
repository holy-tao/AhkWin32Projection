 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nn-amstream-iammediatypesample
...
class IAMMediaTypeSample extends IStreamSample{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setpointer
     */
    SetPointer(pBuffer, lSize) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(8, this, pBufferMarshal, pBuffer, "int", lSize, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-getpointer
     */
    GetPointer() {
        result := ComCall(9, this, "ptr*", &ppBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-getsize
     */
    GetSize() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-gettime
     */
    GetTime(pTimeStart, pTimeEnd) {
        pTimeStartMarshal := pTimeStart is VarRef ? "int64*" : "ptr"
        pTimeEndMarshal := pTimeEnd is VarRef ? "int64*" : "ptr"

        result := ComCall(11, this, pTimeStartMarshal, pTimeStart, pTimeEndMarshal, pTimeEnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-settime
     */
    SetTime(pTimeStart, pTimeEnd) {
        pTimeStartMarshal := pTimeStart is VarRef ? "int64*" : "ptr"
        pTimeEndMarshal := pTimeEnd is VarRef ? "int64*" : "ptr"

        result := ComCall(12, this, pTimeStartMarshal, pTimeStart, pTimeEndMarshal, pTimeEnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-issyncpoint
     */
    IsSyncPoint() {
     ...
     * @returns {HRESULT} Returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setsyncpoint
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-ispreroll
     */
    IsPreroll() {
     ...
     * @returns {HRESULT} Returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setpreroll
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-getactualdatalength
     */
    GetActualDataLength() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setactualdatalength
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-getmediatype
     */
    GetMediaType() {
        result := ComCall(19, this, "ptr*", &ppMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setmediatype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-isdiscontinuity
     */
    IsDiscontinuity() {
     ...
     * @returns {HRESULT} Returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setdiscontinuity
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-getmediatime
     */
    GetMediaTime(pTimeStart, pTimeEnd) {
        pTimeStartMarshal := pTimeStart is VarRef ? "int64*" : "ptr"
        pTimeEndMarshal := pTimeEnd is VarRef ? "int64*" : "ptr"

        result := ComCall(23, this, pTimeStartMarshal, pTimeStart, pTimeEndMarshal, pTimeEnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/amstream/nf-amstream-iammediatypesample-setmediatime
     */
    SetMediaTime(pTimeStart, pTimeEnd) {
        pTimeStartMarshal := pTimeStart is VarRef ? "int64*" : "ptr"
        pTimeEndMarshal := pTimeEnd is VarRef ? "int64*" : "ptr"

        result := ComCall(24, this, pTimeStartMarshal, pTimeStart, pTimeEndMarshal, pTimeEnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
