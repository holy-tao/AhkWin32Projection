 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamoverlayfx
...
class IAMOverlayFX extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamoverlayfx-queryoverlayfxcaps
     */
    QueryOverlayFXCaps() {
        result := ComCall(3, this, "uint*", &lpdwOverlayFXCaps := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamoverlayfx-setoverlayfx
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamoverlayfx-getoverlayfx
     */
    GetOverlayFX() {
        result := ComCall(5, this, "uint*", &lpdwOverlayFX := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
