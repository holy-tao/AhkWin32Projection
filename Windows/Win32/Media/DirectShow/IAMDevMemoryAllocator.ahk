 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-iamdevmemoryallocator
...
class IAMDevMemoryAllocator extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemoryallocator-getinfo
     */
    GetInfo(pdwcbTotalFree, pdwcbLargestFree, pdwcbTotalMemory, pdwcbMinimumChunk) {
        ...
        result := ComCall(3, this, pdwcbTotalFreeMarshal, pdwcbTotalFree, pdwcbLargestFreeMarshal, pdwcbLargestFree, pdwcbTotalMemoryMarshal, pdwcbTotalMemory, pdwcbMinimumChunkMarshal, pdwcbMinimumChunk, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemoryallocator-checkmemory
     */
    CheckMemory(pBuffer) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(4, this, pBufferMarshal, pBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemoryallocator-alloc
     */
    Alloc(pdwcbBuffer) {
        pdwcbBufferMarshal := pdwcbBuffer is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr*", &ppBuffer := 0, pdwcbBufferMarshal, pdwcbBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemoryallocator-free
     */
    Free(pBuffer) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(6, this, pBufferMarshal, pBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-iamdevmemoryallocator-getdevmemoryobject
     */
    GetDevMemoryObject(pUnkOuter) {
        result := ComCall(7, this, "ptr*", &ppUnkInnner := 0, "ptr", pUnkOuter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
