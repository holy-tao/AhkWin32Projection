 ...
 */
export default struct IAMDevMemoryAllocator extends IUnknown {
    /**
     ...
     * used for IAMDevMemoryAllocator interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        ...
        Alloc              : IntPtr
        Free               : IntPtr
        GetDevMemoryObject : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAMDevMemoryAllocator.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.CheckMemory)
        CallbackFree(this.vtbl.Alloc)
        CallbackFree(this.vtbl.Free)
        CallbackFree(this.vtbl.GetDevMemoryObject)
    }
}
