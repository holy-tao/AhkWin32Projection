 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/control/nn-control-ibasicvideo
...
class IBasicVideo extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_avgtimeperframe
     */
    get_AvgTimePerFrame() {
        result := ComCall(7, this, "double*", &pAvgTimePerFrame := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_bitrate
     */
    get_BitRate() {
        result := ComCall(8, this, "int*", &pBitRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_biterrorrate
     */
    get_BitErrorRate() {
        result := ComCall(9, this, "int*", &pBitErrorRate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_videowidth
     */
    get_VideoWidth() {
        result := ComCall(10, this, "int*", &pVideoWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_videoheight
     */
    get_VideoHeight() {
        result := ComCall(11, this, "int*", &pVideoHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_sourceleft
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_sourceleft
     */
    get_SourceLeft() {
        result := ComCall(13, this, "int*", &pSourceLeft := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_sourcewidth
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_sourcewidth
     */
    get_SourceWidth() {
        result := ComCall(15, this, "int*", &pSourceWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_sourcetop
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_sourcetop
     */
    get_SourceTop() {
        result := ComCall(17, this, "int*", &pSourceTop := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_sourceheight
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_sourceheight
     */
    get_SourceHeight() {
        result := ComCall(19, this, "int*", &pSourceHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_destinationleft
     */
     ...
     * @returns {Integer} Pointer to a variable that receives the x-coordinate, in pixels.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_destinationleft
     */
    get_DestinationLeft() {
        result := ComCall(21, this, "int*", &pDestinationLeft := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_destinationwidth
     */
     ...
     * @returns {Integer} Pointer to a variable that receives the width, in pixels.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_destinationwidth
     */
    get_DestinationWidth() {
        result := ComCall(23, this, "int*", &pDestinationWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_destinationtop
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_destinationtop
     */
    get_DestinationTop() {
        result := ComCall(25, this, "int*", &pDestinationTop := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-put_destinationheight
     */
     ...
     * @returns {Integer} Pointer to a variable that receives the height, in pixels.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-get_destinationheight
     */
    get_DestinationHeight() {
        result := ComCall(27, this, "int*", &pDestinationHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-setsourceposition
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-getsourceposition
     */
    GetSourcePosition(pLeft, pTop, pWidth, pHeight) {
        ...
        result := ComCall(29, this, pLeftMarshal, pLeft, pTopMarshal, pTop, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-setdefaultsourceposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-setdestinationposition
     */
     ...
     * @param {Pointer<Integer>} pHeight Pointer to a variable that receives the height, in pixels.
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-getdestinationposition
     */
    GetDestinationPosition(pLeft, pTop, pWidth, pHeight) {
        ...
        result := ComCall(32, this, pLeftMarshal, pLeft, pTopMarshal, pTop, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-setdefaultdestinationposition
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value.
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-getvideosize
     */
    GetVideoSize(pWidth, pHeight) {
        pWidthMarshal := pWidth is VarRef ? "int*" : "ptr"
        pHeightMarshal := pHeight is VarRef ? "int*" : "ptr"

        result := ComCall(34, this, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-getvideopaletteentries
     */
    GetVideoPaletteEntries(StartIndex, Entries, pRetrieved, pPalette) {
        ...
        result := ComCall(35, this, "int", StartIndex, "int", Entries, pRetrievedMarshal, pRetrieved, pPaletteMarshal, pPalette, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-getcurrentimage
     */
    GetCurrentImage(pBufferSize) {
        pBufferSizeMarshal := pBufferSize is VarRef ? "int*" : "ptr"

        result := ComCall(36, this, pBufferSizeMarshal, pBufferSize, "int*", &pDIBImage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-isusingdefaultsource
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/control/nf-control-ibasicvideo-isusingdefaultdestination
     */
