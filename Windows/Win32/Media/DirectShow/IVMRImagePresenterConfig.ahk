 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ivmrimagepresenterconfig
...
class IVMRImagePresenterConfig extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrimagepresenterconfig-setrenderingprefs
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ivmrimagepresenterconfig-getrenderingprefs
     */
    GetRenderingPrefs() {
        result := ComCall(4, this, "uint*", &dwRenderFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
