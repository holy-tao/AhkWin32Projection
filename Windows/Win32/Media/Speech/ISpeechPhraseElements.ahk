...
#Import ".\ISpeechPhraseElement.ahk" { ISpeechPhraseElement }
 ...
 */
export default struct ISpeechPhraseElements extends IDispatch {
    /**
     ...
     * used for ISpeechPhraseElements interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISpeechPhraseElements.Vtbl()
        }
     ...
     */
    Item(Index) {
        result := ComCall(8, this, Int32, Index, "ptr*", &Element := 0, "HRESULT")
    ...
    Query(iid) {
        if (ISpeechPhraseElements.IID.Equals(iid)) {
            return true
        }
