...
#Import ".\ISpeechPhraseProperty.ahk" { ISpeechPhraseProperty }

/**
 * @namespace Windows.Win32.Media.Speech
 */
export default struct ISpeechPhraseProperties extends IDispatch {
    /**
     ...
     * used for ISpeechPhraseProperties interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISpeechPhraseProperties.Vtbl()
        }
     ...
     */
    Item(Index) {
        result := ComCall(8, this, Int32, Index, "ptr*", &_Property := 0, "HRESULT")
    ...
    Query(iid) {
        if (ISpeechPhraseProperties.IID.Equals(iid)) {
            return true
        }
