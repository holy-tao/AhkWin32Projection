...
#Import ".\ISpeechLexiconWord.ahk" { ISpeechLexiconWord }
 ...
 */
export default struct ISpeechLexiconWords extends IDispatch {
    /**
     ...
     * used for ISpeechLexiconWords interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISpeechLexiconWords.Vtbl()
        }
     ...
     */
    Item(Index) {
        result := ComCall(8, this, Int32, Index, "ptr*", &Word := 0, "HRESULT")
    ...
    Query(iid) {
        if (ISpeechLexiconWords.IID.Equals(iid)) {
            return true
        }
