...
class ISpStreamFormatConverter extends ISpStreamFormat{
    ...
    /**
     * 
     * @param {Pointer<ISpStreamFormat>} pStream 
    ...
    GetBaseStream(ppStream) {
        result := ComCall(16, this, "ptr", ppStream, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt64>} pullOffsetBaseStream 
     * @returns {HRESULT} 
     */
    ScaleConvertedToBaseOffset(ullOffsetConvertedStream, pullOffsetBaseStream) {
        result := ComCall(19, this, "uint", ullOffsetConvertedStream, "uint*", pullOffsetBaseStream, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt64>} pullOffsetConvertedStream 
     * @returns {HRESULT} 
     */
    ScaleBaseToConvertedOffset(ullOffsetBaseStream, pullOffsetConvertedStream) {
        result := ComCall(20, this, "uint", ullOffsetBaseStream, "uint*", pullOffsetConvertedStream, "int")
        if(result != 0)
            throw OSError(result)
