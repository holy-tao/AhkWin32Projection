...
class ISpeechRecognizer extends IDispatch{
    ...
    get_Recognizer(Recognizer) {
        result := ComCall(8, this, "ptr", Recognizer, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_AllowAudioInputFormatChangesOnNextSet(Allow) {
        result := ComCall(10, this, "ptr", Allow, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_AudioInput(AudioInput) {
        result := ComCall(12, this, "ptr", AudioInput, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_AudioInputStream(AudioInputStream) {
        result := ComCall(14, this, "ptr", AudioInputStream, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_IsShared(Shared) {
        result := ComCall(15, this, "ptr", Shared, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_Status(Status) {
        result := ComCall(18, this, "ptr", Status, "int")
        if(result != 0)
            throw OSError(result)
    ...
    putref_Profile(Profile) {
        result := ComCall(19, this, "ptr", Profile, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_Profile(Profile) {
        result := ComCall(20, this, "ptr", Profile, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateRecoContext(NewContext) {
        result := ComCall(22, this, "ptr", NewContext, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFormat(Type, Format) {
        result := ComCall(23, this, "int", Type, "ptr", Format, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetPropertyNumber(Name, Value, Supported) {
        ...
        result := ComCall(24, this, "ptr", Name, "int", Value, "ptr", Supported, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetPropertyNumber(Name, Value, Supported) {
        ...
        result := ComCall(25, this, "ptr", Name, "int*", Value, "ptr", Supported, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetPropertyString(Name, Value, Supported) {
        ...
        result := ComCall(26, this, "ptr", Name, "ptr", Value, "ptr", Supported, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetPropertyString(Name, Value, Supported) {
        ...
        result := ComCall(27, this, "ptr", Name, "ptr", Value, "ptr", Supported, "int")
        if(result != 0)
            throw OSError(result)
    ...
    IsUISupported(TypeOfUI, ExtraData, Supported) {
        ...
        result := ComCall(28, this, "ptr", TypeOfUI, "ptr", ExtraData, "ptr", Supported, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRecognizers(RequiredAttributes, OptionalAttributes, ObjectTokens) {
        ...
        result := ComCall(30, this, "ptr", RequiredAttributes, "ptr", OptionalAttributes, "ptr", ObjectTokens, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAudioInputs(RequiredAttributes, OptionalAttributes, ObjectTokens) {
        ...
        result := ComCall(31, this, "ptr", RequiredAttributes, "ptr", OptionalAttributes, "ptr", ObjectTokens, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetProfiles(RequiredAttributes, OptionalAttributes, ObjectTokens) {
        ...
        result := ComCall(32, this, "ptr", RequiredAttributes, "ptr", OptionalAttributes, "ptr", ObjectTokens, "int")
        if(result != 0)
            throw OSError(result)
