...
export default struct IMFSample extends IMFAttributes {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetSampleFlags := CallbackCreate(ObjBindMethod(implObj, "GetSampleFlags"), flags, 2)
        this.vtbl.SetSampleFlags := CallbackCreate(ObjBindMethod(implObj, "SetSampleFlags"), flags, 2)
        this.vtbl.GetSampleTime := CallbackCreate(ObjBindMethod(implObj, "GetSampleTime"), flags, 2)
        this.vtbl.SetSampleTime := CallbackCreate(ObjBindMethod(implObj, "SetSampleTime"), flags, 2)
        this.vtbl.GetSampleDuration := CallbackCreate(ObjBindMethod(implObj, "GetSampleDuration"), flags, 2)
        this.vtbl.SetSampleDuration := CallbackCreate(ObjBindMethod(implObj, "SetSampleDuration"), flags, 2)
        this.vtbl.GetBufferCount := CallbackCreate(ObjBindMethod(implObj, "GetBufferCount"), flags, 2)
        this.vtbl.GetBufferByIndex := CallbackCreate(ObjBindMethod(implObj, "GetBufferByIndex"), flags, 3)
        this.vtbl.ConvertToContiguousBuffer := CallbackCreate(ObjBindMethod(implObj, "ConvertToContiguousBuffer"), flags, 2)
        this.vtbl.AddBuffer := CallbackCreate(ObjBindMethod(implObj, "AddBuffer"), flags, 2)
        this.vtbl.RemoveBufferByIndex := CallbackCreate(ObjBindMethod(implObj, "RemoveBufferByIndex"), flags, 2)
        this.vtbl.RemoveAllBuffers := CallbackCreate(ObjBindMethod(implObj, "RemoveAllBuffers"), flags, 1)
        this.vtbl.GetTotalLength := CallbackCreate(ObjBindMethod(implObj, "GetTotalLength"), flags, 2)
        this.vtbl.CopyToBuffer := CallbackCreate(ObjBindMethod(implObj, "CopyToBuffer"), flags, 2)
    }
