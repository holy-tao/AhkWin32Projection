...
export default struct IMFAsyncResult extends IUnknown {
    ...
    */
     ...
     * @see https://learn.microsoft.com/windows/win32/api/mfobjects/nf-mfobjects-imfasyncresult-getobject
     */
    GetObject() {
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetStateNoAddRef := CallbackCreate(ObjBindMethod(implObj, "GetStateNoAddRef"), flags, 1)
    }
