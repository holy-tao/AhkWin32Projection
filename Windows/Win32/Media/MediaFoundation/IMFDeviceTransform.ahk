 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nn-mftransform-imfdevicetransform
...
class IMFDeviceTransform extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-initializetransform
     */
     ...
     * @returns {Pointer<IMFMediaType>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getinputavailabletype
     */
    GetInputAvailableType(dwInputStreamID, dwTypeIndex) {
        result := ComCall(4, this, "uint", dwInputStreamID, "uint", dwTypeIndex, "ptr*", &pMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFMediaType>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface that represents the current type used by that stream.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getinputcurrenttype
     */
    GetInputCurrentType(dwInputStreamID) {
        result := ComCall(5, this, "uint", dwInputStreamID, "ptr*", &pMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getinputstreamattributes
     */
    GetInputStreamAttributes(dwInputStreamID) {
        result := ComCall(6, this, "uint", dwInputStreamID, "ptr*", &ppAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwTypeIndex Index of the media type to retrieve. Media types are indexed from zero and returned in approximate order of preference.
     * @returns {Pointer<IMFMediaType>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getoutputavailabletype
     */
    GetOutputAvailableType(dwOutputStreamID, dwTypeIndex) {
        result := ComCall(7, this, "uint", dwOutputStreamID, "uint", dwTypeIndex, "ptr*", &pMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwOutputStreamID Output stream identifier. To get the list of stream identifiers, call <a href="https://docs.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imfdevicetransform-getstreamids">IMFDeviceTransform::GetStreamIDs</a>.
     * @returns {Pointer<IMFMediaType>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface that represents the current type used by that stream.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getoutputcurrenttype
     */
    GetOutputCurrentType(dwOutputStreamID) {
        result := ComCall(8, this, "uint", dwOutputStreamID, "ptr*", &pMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFAttributes>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getoutputstreamattributes
     */
    GetOutputStreamAttributes(dwOutputStreamID) {
        result := ComCall(9, this, "uint", dwOutputStreamID, "ptr*", &ppAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getstreamcount
     */
    GetStreamCount(pcInputStreams, pcOutputStreams) {
        ...
        result := ComCall(10, this, pcInputStreamsMarshal, pcInputStreams, pcOutputStreamsMarshal, pcOutputStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getstreamids
     */
    GetStreamIDs(dwInputIDArraySize, pdwInputStreamIds, dwOutputIDArraySize, pdwOutputStreamIds) {
        ...
        result := ComCall(11, this, "uint", dwInputIDArraySize, pdwInputStreamIdsMarshal, pdwInputStreamIds, "uint", dwOutputIDArraySize, pdwOutputStreamIdsMarshal, pdwOutputStreamIds, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-processevent
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-processinput
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-processmessage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-processoutput
     */
    ProcessOutput(dwFlags, cOutputBufferCount, pOutputSample) {
        result := ComCall(15, this, "uint", dwFlags, "uint", cOutputBufferCount, "ptr", pOutputSample, "uint*", &pdwStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-setinputstreamstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getinputstreamstate
     */
    GetInputStreamState(dwStreamID) {
        result := ComCall(17, this, "uint", dwStreamID, "int*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-setoutputstreamstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getoutputstreamstate
     */
    GetOutputStreamState(dwStreamID) {
        result := ComCall(19, this, "uint", dwStreamID, "int*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Pointer<IMFMediaType>>} ppMediaType Preferred media type for the input stream is passed in through this parameter.
     * @returns {HRESULT} The method returns an <b>HRESULT</b>. Possible values include but not limited to values given in the following table.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-getinputstreampreferredstate
     */
    GetInputStreamPreferredState(dwStreamID, value, ppMediaType) {
        valueMarshal := value is VarRef ? "int*" : "ptr"

        result := ComCall(20, this, "uint", dwStreamID, valueMarshal, value, "ptr*", ppMediaType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-flushinputstream
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imfdevicetransform-flushoutputstream
     */
