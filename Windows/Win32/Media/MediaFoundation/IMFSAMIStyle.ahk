 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsamistyle
...
class IMFSAMIStyle extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsamistyle-getstylecount
     */
    GetStyleCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsamistyle-getstyles
     */
    GetStyles() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsamistyle-setselectedstyle
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsamistyle-getselectedstyle
     */
    GetSelectedStyle() {
        result := ComCall(6, this, "ptr*", &ppwszStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
