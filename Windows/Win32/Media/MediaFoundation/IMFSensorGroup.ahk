 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsensorgroup
...
class IMFSensorGroup extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getsymboliclink
     */
    GetSymbolicLink(SymbolicLink, cchSymbolicLink) {
        SymbolicLink := SymbolicLink is String ? StrPtr(SymbolicLink) : SymbolicLink

        result := ComCall(3, this, "ptr", SymbolicLink, "int", cchSymbolicLink, "int*", &pcchWritten := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getflags
     */
    GetFlags() {
     ...
     * @returns {Pointer<IMFAttributes>} The <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface representing the internal attribute store of the sensor group.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getsensorgroupattributes
     */
    GetSensorGroupAttributes() {
        result := ComCall(5, this, "ptr*", &ppAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getsensordevicecount
     */
     ...
     * @returns {Pointer<IMFSensorDevice>} If the call is successful, <i>ppDevice</i> will contain the retrieved sensor device.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getsensordevice
     */
    GetSensorDevice(dwIndex) {
        result := ComCall(7, this, "uint", dwIndex, "ptr*", &ppDevice := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-setdefaultsensordeviceindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-getdefaultsensordeviceindex
     */
    GetDefaultSensorDeviceIndex() {
        result := ComCall(9, this, "uint*", &pdwIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFMediaSource>} Receives a pointer to the created media source.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorgroup-createmediasource
     */
    CreateMediaSource() {
        result := ComCall(10, this, "ptr*", &ppSource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
