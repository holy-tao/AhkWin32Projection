...
export default struct IMFCaptureSource extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetCaptureDeviceSource := CallbackCreate(ObjBindMethod(implObj, "GetCaptureDeviceSource"), flags, 3)
        this.vtbl.GetCaptureDeviceActivate := CallbackCreate(ObjBindMethod(implObj, "GetCaptureDeviceActivate"), flags, 3)
        this.vtbl.GetService := CallbackCreate(ObjBindMethod(implObj, "GetService"), flags, 4)
        this.vtbl.AddEffect := CallbackCreate(ObjBindMethod(implObj, "AddEffect"), flags, 3)
        this.vtbl.RemoveEffect := CallbackCreate(ObjBindMethod(implObj, "RemoveEffect"), flags, 3)
        this.vtbl.RemoveAllEffects := CallbackCreate(ObjBindMethod(implObj, "RemoveAllEffects"), flags, 2)
        this.vtbl.GetAvailableDeviceMediaType := CallbackCreate(ObjBindMethod(implObj, "GetAvailableDeviceMediaType"), flags, 4)
        this.vtbl.SetCurrentDeviceMediaType := CallbackCreate(ObjBindMethod(implObj, "SetCurrentDeviceMediaType"), flags, 3)
        this.vtbl.GetCurrentDeviceMediaType := CallbackCreate(ObjBindMethod(implObj, "GetCurrentDeviceMediaType"), flags, 3)
        this.vtbl.GetDeviceStreamCount := CallbackCreate(ObjBindMethod(implObj, "GetDeviceStreamCount"), flags, 2)
        this.vtbl.GetDeviceStreamCategory := CallbackCreate(ObjBindMethod(implObj, "GetDeviceStreamCategory"), flags, 3)
        this.vtbl.GetMirrorState := CallbackCreate(ObjBindMethod(implObj, "GetMirrorState"), flags, 3)
        this.vtbl.SetMirrorState := CallbackCreate(ObjBindMethod(implObj, "SetMirrorState"), flags, 3)
        this.vtbl.GetStreamIndexFromFriendlyName := CallbackCreate(ObjBindMethod(implObj, "GetStreamIndexFromFriendlyName"), flags, 3)
    }
