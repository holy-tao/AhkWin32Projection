 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfworkqueueservices
...
class IMFWorkQueueServices extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-beginregistertopologyworkqueueswithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-endregistertopologyworkqueueswithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-beginunregistertopologyworkqueueswithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-endunregistertopologyworkqueueswithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-gettopologyworkqueuemmcssclass
     */
    GetTopologyWorkQueueMMCSSClass(dwTopologyWorkQueueId, pwszClass, pcchClass) {
        ...
        result := ComCall(7, this, "uint", dwTopologyWorkQueueId, "ptr", pwszClass, pcchClassMarshal, pcchClass, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-gettopologyworkqueuemmcsstaskid
     */
    GetTopologyWorkQueueMMCSSTaskId(dwTopologyWorkQueueId) {
        result := ComCall(8, this, "uint", dwTopologyWorkQueueId, "uint*", &pdwTaskId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IUnknown} pState A pointer to the <b>IUnknown</b> interface of a state object, defined by the caller. This parameter can be <b>NULL</b>. You can use this object to hold state information. The object is returned to the caller when the callback is invoked.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-beginregisterplatformworkqueuewithmmcss
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-endregisterplatformworkqueuewithmmcss
     */
    EndRegisterPlatformWorkQueueWithMMCSS(pResult) {
        result := ComCall(10, this, "ptr", pResult, "uint*", &pdwTaskId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-beginunregisterplatformworkqueuewithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-endunregisterplatformworkqueuewithmmcss
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-getplaftormworkqueuemmcssclass
     */
    GetPlaftormWorkQueueMMCSSClass(dwPlatformWorkQueueId, pwszClass, pcchClass) {
        ...
        result := ComCall(13, this, "uint", dwPlatformWorkQueueId, "ptr", pwszClass, pcchClassMarshal, pcchClass, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwPlatformWorkQueueId Platform work queue to query. See <a href="https://docs.microsoft.com/windows/desktop/api/mfidl/nf-mfidl-imfworkqueueservices-beginregisterplatformworkqueuewithmmcss">IMFWorkQueueServices::BeginRegisterPlatformWorkQueueWithMMCSS</a>.
     * @returns {Integer} Receives the task identifier.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservices-getplatformworkqueuemmcsstaskid
     */
    GetPlatformWorkQueueMMCSSTaskId(dwPlatformWorkQueueId) {
        result := ComCall(14, this, "uint", dwPlatformWorkQueueId, "uint*", &pdwTaskId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
