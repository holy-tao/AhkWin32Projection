 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfqualityadvise2
...
class IMFQualityAdvise2 extends IMFQualityAdvise{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfqualityadvise2-notifyqualityevent
     */
    NotifyQualityEvent(pEvent) {
        result := ComCall(8, this, "ptr", pEvent, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
