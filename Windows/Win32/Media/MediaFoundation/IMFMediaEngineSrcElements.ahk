 ...
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imfmediaenginesrcelements
...
class IMFMediaEngineSrcElements extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-getlength
     */
    GetLength() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-geturl
     */
    GetURL(index) {
        pURL := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-gettype
     */
    GetType(index) {
        pType := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-getmedia
     */
    GetMedia(index) {
        pMedia := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-addelement
     */
    AddElement(pURL, pType, pMedia) {
        ...
        if(pType is String) {
            pin := BSTR.Alloc(pType)
            pType := pin.Value
        }
        if(pMedia is String) {
            pin := BSTR.Alloc(pMedia)
            pMedia := pin.Value
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelements-removeallelements
     */
    RemoveAllElements() {
