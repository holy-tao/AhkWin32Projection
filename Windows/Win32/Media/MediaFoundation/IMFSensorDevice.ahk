 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsensordevice
...
class IMFSensorDevice extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getdeviceid
     */
    GetDeviceId() {
        result := ComCall(3, this, "uint*", &pDeviceId := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getdevicetype
     */
    GetDeviceType() {
        result := ComCall(4, this, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getflags
     */
    GetFlags() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getsymboliclink
     */
    GetSymbolicLink(SymbolicLink, cchSymbolicLink) {
        SymbolicLink := SymbolicLink is String ? StrPtr(SymbolicLink) : SymbolicLink

        result := ComCall(6, this, "ptr", SymbolicLink, "int", cchSymbolicLink, "int*", &pcchWritten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFAttributes>} The <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface representing the internal attribute store of the sensor device.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getdeviceattributes
     */
    GetDeviceAttributes() {
        result := ComCall(7, this, "ptr*", &ppAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getstreamattributescount
     */
    GetStreamAttributesCount(eType) {
        result := ComCall(8, this, "int", eType, "uint*", &pdwCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFAttributes>} The <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface representing a copy internal attribute store of the stream.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getstreamattributes
     */
    GetStreamAttributes(eType, dwIndex) {
        result := ComCall(9, this, "int", eType, "uint", dwIndex, "ptr*", &ppAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-setsensordevicemode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensordevice-getsensordevicemode
     */
    GetSensorDeviceMode() {
        result := ComCall(11, this, "int*", &peMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
