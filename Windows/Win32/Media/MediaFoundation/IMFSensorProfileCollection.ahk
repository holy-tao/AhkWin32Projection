 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsensorprofilecollection
...
class IMFSensorProfileCollection extends IUnknown{
     ...
     * @returns {Pointer<IMFSensorProfile>} On success, returns a double pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/mfidl/nn-mfidl-imfsensorprofile">IMFSensorProfile</a> object that describes the specified sensor profile.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofilecollection-getprofile
     */
    GetProfile(Index) {
        result := ComCall(4, this, "uint", Index, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofilecollection-addprofile
     */
    AddProfile(pProfile) {
     ...
     * @returns {Pointer<IMFSensorProfile>} On success, returns a double pointer to the profile.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofilecollection-findprofile
     */
    FindProfile(ProfileId) {
        result := ComCall(6, this, "ptr", ProfileId, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofilecollection-removeprofilebyindex
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofilecollection-removeprofile
     */
