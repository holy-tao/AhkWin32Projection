 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imftimer
...
class IMFTimer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftimer-settimer
     */
    SetTimer(dwFlags, llClockTime, pCallback, punkState) {
        result := ComCall(3, this, "uint", dwFlags, "int64", llClockTime, "ptr", pCallback, "ptr", punkState, "ptr*", &ppunkKey := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftimer-canceltimer
     */
    CancelTimer(punkKey) {
