 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfbytestreamcachecontrol2
...
class IMFByteStreamCacheControl2 extends IMFByteStreamCacheControl{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfbytestreamcachecontrol2-getbyteranges
     */
    GetByteRanges(pcRanges, ppRanges) {
        pcRangesMarshal := pcRanges is VarRef ? "uint*" : "ptr"
        ppRangesMarshal := ppRanges is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, pcRangesMarshal, pcRanges, ppRangesMarshal, ppRanges, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfbytestreamcachecontrol2-setcachelimit
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfbytestreamcachecontrol2-isbackgroundtransferactive
     */
    IsBackgroundTransferActive() {
        result := ComCall(6, this, "int*", &pfActive := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
