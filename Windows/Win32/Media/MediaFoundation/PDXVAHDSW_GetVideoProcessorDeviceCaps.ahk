 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxvahd/nc-dxvahd-pdxvahdsw_getvideoprocessordevicecaps
 * @namespace Windows.Win32.Media.MediaFoundation
 * @version v4.0.30319
 */
class PDXVAHDSW_GetVideoProcessorDeviceCaps extends IUnknown {
     ...
     */
    Invoke(hDevice, pContentDesc, Usage) {
        hDevice := hDevice is Win32Handle ? NumGet(hDevice, "ptr") : hDevice

        pCaps := DXVAHD_VPDEVCAPS()
        result := ComCall(3, this, "ptr", hDevice, "ptr", pContentDesc, "int", Usage, "ptr", pCaps, "int")
        if(result != 0) {
