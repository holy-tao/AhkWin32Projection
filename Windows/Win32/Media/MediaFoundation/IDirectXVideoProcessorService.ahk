 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nn-dxva2api-idirectxvideoprocessorservice
...
class IDirectXVideoProcessorService extends IDirectXVideoAccelerationService{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-registervideoprocessorsoftwaredevice
     */
    RegisterVideoProcessorSoftwareDevice(pCallbacks) {
        pCallbacksMarshal := pCallbacks is VarRef ? "ptr" : "ptr"

        result := ComCall(4, this, pCallbacksMarshal, pCallbacks, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getvideoprocessordeviceguids
     */
    GetVideoProcessorDeviceGuids(pVideoDesc, pCount, pGuids) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pGuidsMarshal := pGuids is VarRef ? "ptr*" : "ptr"

        result := ComCall(5, this, "ptr", pVideoDesc, pCountMarshal, pCount, pGuidsMarshal, pGuids, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getvideoprocessorrendertargets
     */
    GetVideoProcessorRenderTargets(VideoProcDeviceGuid, pVideoDesc, pCount, pFormats) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pFormatsMarshal := pFormats is VarRef ? "ptr*" : "ptr"

        result := ComCall(6, this, "ptr", VideoProcDeviceGuid, "ptr", pVideoDesc, pCountMarshal, pCount, pFormatsMarshal, pFormats, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getvideoprocessorsubstreamformats
     */
    GetVideoProcessorSubStreamFormats(VideoProcDeviceGuid, pVideoDesc, RenderTargetFormat, pCount, pFormats) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pFormatsMarshal := pFormats is VarRef ? "ptr*" : "ptr"

        result := ComCall(7, this, "ptr", VideoProcDeviceGuid, "ptr", pVideoDesc, "uint", RenderTargetFormat, pCountMarshal, pCount, pFormatsMarshal, pFormats, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getvideoprocessorcaps
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getprocamprange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-getfilterpropertyrange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoprocessorservice-createvideoprocessor
     */
    CreateVideoProcessor(VideoProcDeviceGuid, pVideoDesc, RenderTargetFormat, MaxNumSubStreams) {
        result := ComCall(11, this, "ptr", VideoProcDeviceGuid, "ptr", pVideoDesc, "uint", RenderTargetFormat, "uint", MaxNumSubStreams, "ptr*", &ppVidProcess := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
