 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxvahd/nc-dxvahd-pdxvahdsw_createvideoprocessor
 * @namespace Windows.Win32.Media.MediaFoundation
 * @version v4.0.30319
 */
class PDXVAHDSW_CreateVideoProcessor extends IUnknown {
     ...
     */
    Invoke(hDevice, pVPGuid) {
        hDevice := hDevice is Win32Handle ? NumGet(hDevice, "ptr") : hDevice

        phVideoProcessor := HANDLE()
        result := ComCall(3, this, "ptr", hDevice, "ptr", pVPGuid, "ptr", phVideoProcessor, "int")
        if(result != 0) {
