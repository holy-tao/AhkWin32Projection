...
class IMFCaptureSink extends IUnknown{
    ...
    GetOutputMediaType(dwSinkStreamIndex, ppMediaType) {
        result := ComCall(3, this, "uint", dwSinkStreamIndex, "ptr", ppMediaType, "int")
        if(result != 0)
    ...
    GetService(dwSinkStreamIndex, rguidService, riid, ppUnknown) {
        result := ComCall(4, this, "uint", dwSinkStreamIndex, "ptr", rguidService, "ptr", riid, "ptr", ppUnknown, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pdwSinkStreamIndex 
     * @returns {HRESULT} 
     */
    AddStream(dwSourceStreamIndex, pMediaType, pAttributes, pdwSinkStreamIndex) {
        result := ComCall(5, this, "uint", dwSourceStreamIndex, "ptr", pMediaType, "ptr", pAttributes, "uint*", pdwSinkStreamIndex, "int")
        if(result != 0)
            throw OSError(result)
