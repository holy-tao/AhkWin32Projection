 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfcameracontroldefaultscollection
...
class IMFCameraControlDefaultsCollection extends IMFAttributes{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-getcontrolcount
     */
    GetControlCount() {
     ...
     * @returns {Pointer<IMFCameraControlDefaults>} Receives a pointer to a [IMFCameraControlDefaults](nn-mfidl-imfcameracontroldefaults.md) instance representing the retrieved control.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-getcontrol
     */
    GetControl(index) {
        result := ComCall(34, this, "uint", index, "ptr*", &configuration := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<IMFCameraControlDefaults>} Receives a pointer to a [IMFCameraControlDefaults](nn-mfidl-imfcameracontroldefaults.md) instance representing the added control.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-getoraddextendedcontrol
     */
    GetOrAddExtendedControl(configType, constrolId, streamId, dataSize) {
        result := ComCall(35, this, "int", configType, "uint", constrolId, "uint", streamId, "uint", dataSize, "ptr*", &defaults := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dataSize The size of the data payload for the control, in bytes.
     * @returns {Pointer<IMFCameraControlDefaults>} Receives a pointer to a [IMFCameraControlDefaults](nn-mfidl-imfcameracontroldefaults.md) instance representing the added control.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-getoraddcontrol
     */
    GetOrAddControl(configType, controlSet, constrolId, controlSize, dataSize) {
        result := ComCall(36, this, "int", configType, "ptr", controlSet, "uint", constrolId, "uint", controlSize, "uint", dataSize, "ptr*", &defaults := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-removecontrol
     */
     ...
     * @returns {HRESULT} S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontroldefaultscollection-removeallcontrols
     */
    RemoveAllControls() {
