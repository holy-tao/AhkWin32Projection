 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12video/nn-d3d12video-id3d12videoprocessor1
...
class ID3D12VideoProcessor1 extends ID3D12VideoProcessor{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12video/nf-d3d12video-id3d12videoprocessor1-getprotectedresourcesession
     */
    GetProtectedResourceSession(riid) {
        result := ComCall(12, this, "ptr", riid, "ptr*", &ppProtectedSession := 0, "int")
        if(result != 0) {
