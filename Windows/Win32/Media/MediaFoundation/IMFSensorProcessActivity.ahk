 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsensorprocessactivity
...
class IMFSensorProcessActivity extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprocessactivity-getprocessid
     */
    GetProcessId() {
        result := ComCall(3, this, "uint*", &pPID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprocessactivity-getstreamingstate
     */
    GetStreamingState() {
        result := ComCall(4, this, "int*", &pfStreaming := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprocessactivity-getstreamingmode
     */
    GetStreamingMode() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprocessactivity-getreporttime
     */
    GetReportTime() {
        pft := FILETIME()
