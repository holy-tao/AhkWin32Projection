 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfgetservice
...
class IMFGetService extends IUnknown{
     ...
     * @returns {Pointer<Pointer<Void>>} Receives the interface pointer. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfgetservice-getservice
     */
