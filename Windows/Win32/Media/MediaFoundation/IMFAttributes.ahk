 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imfattributes
...
class IMFAttributes extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getitem
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getitemtype
     */
    GetItemType(guidKey) {
        result := ComCall(4, this, "ptr", guidKey, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-compareitem
     */
    CompareItem(guidKey, Value) {
        result := ComCall(5, this, "ptr", guidKey, "ptr", Value, "int*", &pbResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-compare
     */
    Compare(pTheirs, MatchType) {
        result := ComCall(6, this, "ptr", pTheirs, "int", MatchType, "int*", &pbResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getuint32
     */
    GetUINT32(guidKey) {
        result := ComCall(7, this, "ptr", guidKey, "uint*", &punValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getuint64
     */
    GetUINT64(guidKey) {
        result := ComCall(8, this, "ptr", guidKey, "uint*", &punValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getdouble
     */
    GetDouble(guidKey) {
        result := ComCall(9, this, "ptr", guidKey, "double*", &pfValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getguid
     */
    GetGUID(guidKey) {
        pguidValue := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getstringlength
     */
    GetStringLength(guidKey) {
        result := ComCall(11, this, "ptr", guidKey, "uint*", &pcchLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getstring
     */
    GetString(guidKey, pwszValue, cchBufSize, pcchLength) {
        ...
        result := ComCall(12, this, "ptr", guidKey, "ptr", pwszValue, "uint", cchBufSize, pcchLengthMarshal, pcchLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getallocatedstring
     */
    GetAllocatedString(guidKey, ppwszValue, pcchLength) {
        ppwszValueMarshal := ppwszValue is VarRef ? "ptr*" : "ptr"
        pcchLengthMarshal := pcchLength is VarRef ? "uint*" : "ptr"

        result := ComCall(13, this, "ptr", guidKey, ppwszValueMarshal, ppwszValue, pcchLengthMarshal, pcchLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getblobsize
     */
    GetBlobSize(guidKey) {
        result := ComCall(14, this, "ptr", guidKey, "uint*", &pcbBlobSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getblob
     */
    GetBlob(guidKey, cbBufSize, pcbBlobSize) {
        pcbBlobSizeMarshal := pcbBlobSize is VarRef ? "uint*" : "ptr"

        result := ComCall(15, this, "ptr", guidKey, "char*", &pBuf := 0, "uint", cbBufSize, pcbBlobSizeMarshal, pcbBlobSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getallocatedblob
     */
    GetAllocatedBlob(guidKey, ppBuf, pcbSize) {
        ppBufMarshal := ppBuf is VarRef ? "ptr*" : "ptr"
        pcbSizeMarshal := pcbSize is VarRef ? "uint*" : "ptr"

        result := ComCall(16, this, "ptr", guidKey, ppBufMarshal, ppBuf, pcbSizeMarshal, pcbSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getunknown
     */
    GetUnknown(guidKey, riid) {
        result := ComCall(17, this, "ptr", guidKey, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setitem
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-deleteitem
     */
    DeleteItem(guidKey) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-deleteallitems
     */
    DeleteAllItems() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setuint32
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setuint64
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setdouble
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setguid
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setstring
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setblob
     */
    SetBlob(guidKey, pBuf, cbBufSize) {
        pBufMarshal := pBuf is VarRef ? "char*" : "ptr"

        result := ComCall(26, this, "ptr", guidKey, pBufMarshal, pBuf, "uint", cbBufSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-setunknown
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-lockstore
     */
    LockStore() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-unlockstore
     */
    UnlockStore() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getcount
     */
    GetCount() {
        result := ComCall(30, this, "uint*", &pcItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-getitembyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfattributes-copyallitems
     */
    CopyAllItems(pDest) {
