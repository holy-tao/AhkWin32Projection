 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfvideosampleallocator
...
class IMFVideoSampleAllocator extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideosampleallocator-setdirectxmanager
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideosampleallocator-uninitializesampleallocator
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideosampleallocator-initializesampleallocator
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideosampleallocator-allocatesample
     */
    AllocateSample() {
        result := ComCall(6, this, "ptr*", &ppSample := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
