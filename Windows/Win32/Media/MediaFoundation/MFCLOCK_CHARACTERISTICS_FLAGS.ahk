...
class MFCLOCK_CHARACTERISTICS_FLAGS extends Win32Enum {
     ...
     * Native name: MFCLOCK_CHARACTERISTICS_FLAG_FREQUENCY_10MHZ
     * @type {Integer (Int32)}
     */
    static FLAG_FREQUENCY_10MHZ => 2
     ...
     * Native name: MFCLOCK_CHARACTERISTICS_FLAG_ALWAYS_RUNNING
     * @type {Integer (Int32)}
     */
    static FLAG_ALWAYS_RUNNING => 4

    /**
     * The clock times are generated from the system clock.
     * Native name: MFCLOCK_CHARACTERISTICS_FLAG_IS_SYSTEM_CLOCK
     * @type {Integer (Int32)}
     */
    static FLAG_IS_SYSTEM_CLOCK => 8
}
