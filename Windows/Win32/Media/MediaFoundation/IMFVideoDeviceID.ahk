 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-imfvideodeviceid
...
class IMFVideoDeviceID extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideodeviceid-getdeviceid
     */
    GetDeviceID() {
        pDeviceID := Guid()
