 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-imfvideomixercontrol2
...
class IMFVideoMixerControl2 extends IMFVideoMixerControl{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol2-setmixingprefs
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol2-getmixingprefs
     */
    GetMixingPrefs() {
        result := ComCall(8, this, "uint*", &pdwMixFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
