...
class DXVAHD_STREAM_STATE extends Win32Enum {
     ...
     * Native name: DXVAHD_STREAM_STATE_D3DFORMAT
     * @type {Integer (Int32)}
     */
    static D3DFORMAT => 0
     ...
     * Native name: DXVAHD_STREAM_STATE_FRAME_FORMAT
     * @type {Integer (Int32)}
     */
    static FRAME_FORMAT => 1
     ...
     * Native name: DXVAHD_STREAM_STATE_INPUT_COLOR_SPACE
     * @type {Integer (Int32)}
     */
    static INPUT_COLOR_SPACE => 2
     ...
     * Native name: DXVAHD_STREAM_STATE_OUTPUT_RATE
     * @type {Integer (Int32)}
     */
    static OUTPUT_RATE => 3
     ...
     * Native name: DXVAHD_STREAM_STATE_SOURCE_RECT
     * @type {Integer (Int32)}
     */
    static SOURCE_RECT => 4
     ...
     * Native name: DXVAHD_STREAM_STATE_DESTINATION_RECT
     * @type {Integer (Int32)}
     */
    static DESTINATION_RECT => 5
     ...
     * Native name: DXVAHD_STREAM_STATE_ALPHA
     * @type {Integer (Int32)}
     */
    static ALPHA => 6
     ...
     * Native name: DXVAHD_STREAM_STATE_PALETTE
     * @type {Integer (Int32)}
     */
    static PALETTE => 7
     ...
     * Native name: DXVAHD_STREAM_STATE_LUMA_KEY
     * @type {Integer (Int32)}
     */
    static LUMA_KEY => 8
     ...
     * Native name: DXVAHD_STREAM_STATE_ASPECT_RATIO
     * @type {Integer (Int32)}
     */
    static ASPECT_RATIO => 9
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_BRIGHTNESS
     * @type {Integer (Int32)}
     */
    static FILTER_BRIGHTNESS => 100
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_CONTRAST
     * @type {Integer (Int32)}
     */
    static FILTER_CONTRAST => 101
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_HUE
     * @type {Integer (Int32)}
     */
    static FILTER_HUE => 102
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_SATURATION
     * @type {Integer (Int32)}
     */
    static FILTER_SATURATION => 103
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_NOISE_REDUCTION
     * @type {Integer (Int32)}
     */
    static FILTER_NOISE_REDUCTION => 104
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_EDGE_ENHANCEMENT
     * @type {Integer (Int32)}
     */
    static FILTER_EDGE_ENHANCEMENT => 105
     ...
     * Native name: DXVAHD_STREAM_STATE_FILTER_ANAMORPHIC_SCALING
     * @type {Integer (Int32)}
     */
    static FILTER_ANAMORPHIC_SCALING => 106
     ...
     * Native name: DXVAHD_STREAM_STATE_PRIVATE
     * @type {Integer (Int32)}
     */
    static PRIVATE => 1000
}
