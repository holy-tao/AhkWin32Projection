 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imfdxgibuffer
...
class IMFDXGIBuffer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfdxgibuffer-getresource
     */
    GetResource(riid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfdxgibuffer-getsubresourceindex
     */
    GetSubresourceIndex() {
        result := ComCall(4, this, "uint*", &puSubresource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Guid>} riid The interface identifier (IID) of the interface being requested.
     * @returns {Pointer<Void>} Receives a pointer to the interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfdxgibuffer-getunknown
     */
    GetUnknown(guid, riid) {
        result := ComCall(5, this, "ptr", guid, "ptr", riid, "ptr*", &ppvObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfdxgibuffer-setunknown
     */
