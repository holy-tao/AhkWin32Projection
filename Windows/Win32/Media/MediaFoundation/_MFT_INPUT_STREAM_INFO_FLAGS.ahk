 ...
 */
class _MFT_INPUT_STREAM_INFO_FLAGS extends Win32Enum {
     ...
     * Native name: MFT_INPUT_STREAM_WHOLE_SAMPLES
     * @type {Integer (Int32)}
     */
    static WHOLE_SAMPLES => 1
     ...
     * Native name: MFT_INPUT_STREAM_SINGLE_SAMPLE_PER_BUFFER
     * @type {Integer (Int32)}
     */
    static SINGLE_SAMPLE_PER_BUFFER => 2
     ...
     * Native name: MFT_INPUT_STREAM_FIXED_SAMPLE_SIZE
     * @type {Integer (Int32)}
     */
    static FIXED_SAMPLE_SIZE => 4
     ...
     * Native name: MFT_INPUT_STREAM_HOLDS_BUFFERS
     * @type {Integer (Int32)}
     */
    static HOLDS_BUFFERS => 8
     ...
     * Native name: MFT_INPUT_STREAM_DOES_NOT_ADDREF
     * @type {Integer (Int32)}
     */
    static DOES_NOT_ADDREF => 256
     ...
     * Native name: MFT_INPUT_STREAM_REMOVABLE
     * @type {Integer (Int32)}
     */
    static REMOVABLE => 512
     ...
     * Native name: MFT_INPUT_STREAM_OPTIONAL
     * @type {Integer (Int32)}
     */
    static OPTIONAL => 1024
     ...
     * Native name: MFT_INPUT_STREAM_PROCESSES_IN_PLACE
     * @type {Integer (Int32)}
     */
    static PROCESSES_IN_PLACE => 2048
}
