 ...
 */
export default struct MFASYNCRESULT extends IMFAsyncResult {
     ...
     * used for MFASYNCRESULT interfaces
    */
    struct Vtbl extends IMFAsyncResult.Vtbl {
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := MFASYNCRESULT.Vtbl()
        }
