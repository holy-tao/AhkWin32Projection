 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imfmediaenginesrcelementsex
...
class IMFMediaEngineSrcElementsEx extends IMFMediaEngineSrcElements{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelementsex-addelementex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesrcelementsex-getkeysystem
     */
    GetKeySystem(index) {
        pType := BSTR()
