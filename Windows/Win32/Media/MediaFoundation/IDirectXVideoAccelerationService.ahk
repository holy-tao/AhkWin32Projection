 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nn-dxva2api-idirectxvideoaccelerationservice
...
class IDirectXVideoAccelerationService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideoaccelerationservice-createsurface
     */
    CreateSurface(Width, Height, BackBuffers, Format, Pool, Usage, DxvaType, pSharedHandle) {
        result := ComCall(3, this, "uint", Width, "uint", Height, "uint", BackBuffers, "uint", Format, "int", Pool, "uint", Usage, "uint", DxvaType, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
