 ...
 * @see https://learn.microsoft.com/windows/win32/api/dxvahd/nc-dxvahd-pdxvahdsw_getvideoprocessoroutputformats
 * @namespace Windows.Win32.Media.MediaFoundation
 */
export default struct PDXVAHDSW_GetVideoProcessorOutputFormats {
    value : IntPtr

    __value {
        set {
            if (value is PDXVAHDSW_GetVideoProcessorOutputFormats) {
     ...
     * @returns {D3DFORMAT} A pointer to an array of <b>D3DFORMAT</b> values. The <i>Count</i> parameter specifies the number of elements in the array. The function fills the array with a list of output formats.
     */
    ...
    /**
     * A PDXVAHDSW_GetVideoProcessorOutputFormats that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PDXVAHDSW_GetVideoProcessorOutputFormats {
        /**
         * Creates a PDXVAHDSW_GetVideoProcessorOutputFormats pointer that invokes the given AHK function when called.
