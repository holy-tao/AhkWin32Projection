...
class _MFT_OUTPUT_STREAM_INFO_FLAGS extends Win32Enum {
     ...
     * Native name: MFT_OUTPUT_STREAM_WHOLE_SAMPLES
     * @type {Integer (Int32)}
     */
     ...
     * Native name: MFT_OUTPUT_STREAM_SINGLE_SAMPLE_PER_BUFFER
     * @type {Integer (Int32)}
     */
     ...
     * Native name: MFT_OUTPUT_STREAM_FIXED_SAMPLE_SIZE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: MFT_OUTPUT_STREAM_DISCARDABLE
     * @type {Integer (Int32)}
     */
    static DISCARDABLE => 8
     ...
     * Native name: MFT_OUTPUT_STREAM_OPTIONAL
     * @type {Integer (Int32)}
     */
    static OPTIONAL => 16
     ...
     * Native name: MFT_OUTPUT_STREAM_PROVIDES_SAMPLES
     * @type {Integer (Int32)}
     */
    static PROVIDES_SAMPLES => 256
     ...
     * Native name: MFT_OUTPUT_STREAM_CAN_PROVIDE_SAMPLES
     * @type {Integer (Int32)}
     */
    static CAN_PROVIDE_SAMPLES => 512
     ...
     * Native name: MFT_OUTPUT_STREAM_LAZY_READ
     * @type {Integer (Int32)}
     */
    static LAZY_READ => 1024
     ...
     * Native name: MFT_OUTPUT_STREAM_REMOVABLE
     * @type {Integer (Int32)}
     */
    static REMOVABLE => 2048
}
