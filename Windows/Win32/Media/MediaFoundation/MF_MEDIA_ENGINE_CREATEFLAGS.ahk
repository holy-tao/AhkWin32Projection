...
class MF_MEDIA_ENGINE_CREATEFLAGS extends Win32Enum {
     ...
     * Native name: MF_MEDIA_ENGINE_AUDIOONLY
     * @type {Integer (Int32)}
     */
    static AUDIOONLY => 1
     ...
     * Native name: MF_MEDIA_ENGINE_WAITFORSTABLE_STATE
     * @type {Integer (Int32)}
     */
    static WAITFORSTABLE_STATE => 2

    /**
     * Always mute the audio.
     * Native name: MF_MEDIA_ENGINE_FORCEMUTE
     * @type {Integer (Int32)}
     */
    static FORCEMUTE => 4
     ...
     * Native name: MF_MEDIA_ENGINE_REAL_TIME_MODE
     * @type {Integer (Int32)}
     */
    static REAL_TIME_MODE => 8
     ...
     * Native name: MF_MEDIA_ENGINE_DISABLE_LOCAL_PLUGINS
     * @type {Integer (Int32)}
     */
    static DISABLE_LOCAL_PLUGINS => 16

    /**
     * Reserved.
     * Native name: MF_MEDIA_ENGINE_CREATEFLAGS_MASK
     * @type {Integer (Int32)}
     */
    static MASK => 31
}
