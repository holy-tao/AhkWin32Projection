 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmp2dlna/nn-mfmp2dlna-imfdlnasinkinit
...
class IMFDLNASinkInit extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmp2dlna/nf-mfmp2dlna-imfdlnasinkinit-initialize
     */
    Initialize(pByteStream, fPal) {
        result := ComCall(3, this, "ptr", pByteStream, "int", fPal, "int")
        if(result != 0) {
