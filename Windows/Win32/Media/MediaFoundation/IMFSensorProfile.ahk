 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsensorprofile
...
class IMFSensorProfile extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofile-getprofileid
     */
    GetProfileId() {
        pId := SENSORPROFILEID()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofile-addprofilefilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofile-ismediatypesupported
     */
    IsMediaTypeSupported(StreamId, pMediaType) {
        result := ComCall(5, this, "uint", StreamId, "ptr", pMediaType, "int*", &pfSupported := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsensorprofile-addblockedcontrol
     */
