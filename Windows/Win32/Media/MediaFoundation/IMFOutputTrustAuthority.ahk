 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfoutputtrustauthority
...
class IMFOutputTrustAuthority extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfoutputtrustauthority-getaction
     */
    GetAction() {
        result := ComCall(3, this, "int*", &pAction := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfoutputtrustauthority-setpolicy
     */
    SetPolicy(ppPolicy, nPolicy, ppbTicket, pcbTicket) {
        ...
        result := ComCall(4, this, "ptr*", ppPolicy, "uint", nPolicy, ppbTicketMarshal, ppbTicket, pcbTicketMarshal, pcbTicket, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
