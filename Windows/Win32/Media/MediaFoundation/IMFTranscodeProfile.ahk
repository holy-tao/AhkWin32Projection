 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imftranscodeprofile
...
class IMFTranscodeProfile extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-setaudioattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-getaudioattributes
     */
    GetAudioAttributes() {
        result := ComCall(4, this, "ptr*", &ppAttrs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * To create the attribute store, call <a href="https://docs.microsoft.com/windows/desktop/api/mfapi/nf-mfapi-mfcreateattributes">MFCreateAttributes</a>. To set a specific attribute value in the attribute store, the caller must call the appropriate <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> methods depending on the data type of the attribute.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-setvideoattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-getvideoattributes
     */
    GetVideoAttributes() {
        result := ComCall(6, this, "ptr*", &ppAttrs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * To create the attribute store, call <a href="https://docs.microsoft.com/windows/desktop/api/mfapi/nf-mfapi-mfcreateattributes">MFCreateAttributes</a>. To set a specific attribute value in the attribute store, the caller must call the appropriate <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> methods depending on the data type of the attribute.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-setcontainerattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftranscodeprofile-getcontainerattributes
     */
    GetContainerAttributes() {
        result := ComCall(8, this, "ptr*", &ppAttrs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
