 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfcameracontrolmonitor
...
class IMFCameraControlMonitor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolmonitor-start
     */
    Start() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolmonitor-stop
     */
    Stop() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolmonitor-addcontrolsubscription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolmonitor-removecontrolsubscription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolmonitor-shutdown
     */
    Shutdown() {
        ComCall(7, this)
    }
