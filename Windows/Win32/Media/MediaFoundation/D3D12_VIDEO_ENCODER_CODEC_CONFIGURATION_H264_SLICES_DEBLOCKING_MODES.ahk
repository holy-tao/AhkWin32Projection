...
class D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODES extends Win32Enum {
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_0_ALL_LUMA_CHROMA_SLICE_BLOCK_EDGES_ALWAYS_FILTERED
     * @type {Integer (Int32)}
     */
    static MODE_0_ALL_LUMA_CHROMA_SLICE_BLOCK_EDGES_ALWAYS_FILTERED => 0

    /**
     * *disable_deblocking_filter_idc* value of 1. Deblocking is disabled for all block edges of the slice.
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_1_DISABLE_ALL_SLICE_BLOCK_EDGES
     * @type {Integer (Int32)}
     */
    static MODE_1_DISABLE_ALL_SLICE_BLOCK_EDGES => 1
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_2_DISABLE_SLICE_BOUNDARIES_BLOCKS
     * @type {Integer (Int32)}
     */
    static MODE_2_DISABLE_SLICE_BOUNDARIES_BLOCKS => 2
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_3_USE_TWO_STAGE_DEBLOCKING
     * @type {Integer (Int32)}
     */
    static MODE_3_USE_TWO_STAGE_DEBLOCKING => 3
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_4_DISABLE_CHROMA_BLOCK_EDGES
     * @type {Integer (Int32)}
     */
    static MODE_4_DISABLE_CHROMA_BLOCK_EDGES => 4
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_5_DISABLE_CHROMA_BLOCK_EDGES_AND_LUMA_BOUNDARIES
     * @type {Integer (Int32)}
     */
    static MODE_5_DISABLE_CHROMA_BLOCK_EDGES_AND_LUMA_BOUNDARIES => 5
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_6_DISABLE_CHROMA_BLOCK_EDGES_AND_USE_LUMA_TWO_STAGE_DEBLOCKING
     * @type {Integer (Int32)}
     */
    static MODE_6_DISABLE_CHROMA_BLOCK_EDGES_AND_USE_LUMA_TWO_STAGE_DEBLOCKING => 6
}
