 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imfmediatype
...
class IMFMediaType extends IMFAttributes{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediatype-getmajortype
     */
    GetMajorType() {
        pguidMajorType := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediatype-iscompressedformat
     */
    IsCompressedFormat() {
        result := ComCall(34, this, "int*", &pfCompressed := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediatype-isequal
     */
    IsEqual(pIMediaType) {
        result := ComCall(35, this, "ptr", pIMediaType, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediatype-getrepresentation
     */
    GetRepresentation(guidRepresentation) {
        result := ComCall(36, this, "ptr", guidRepresentation, "ptr*", &ppvRepresentation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediatype-freerepresentation
     */
    FreeRepresentation(guidRepresentation, pvRepresentation) {
        pvRepresentationMarshal := pvRepresentation is VarRef ? "ptr" : "ptr"

        result := ComCall(37, this, "ptr", guidRepresentation, pvRepresentationMarshal, pvRepresentation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
