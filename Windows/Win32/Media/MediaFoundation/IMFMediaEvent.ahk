 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api/mfobjects/nn-mfobjects-imfmediaevent
 * @namespace Windows.Win32.Media.MediaFoundation
 */
export default struct IMFMediaEvent extends IMFAttributes {
    /**
     ...
     * used for IMFMediaEvent interfaces
    */
    ...
    GetExtendedType() {
        ...
        result := ComCall(34, this, Guid.Ptr, pguidExtendedType, "HRESULT")
    ...
    GetValue() {
        pvValue := PROPVARIANT()
        result := ComCall(36, this, PROPVARIANT.Ptr, pvValue, "HRESULT")
        return pvValue
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetExtendedType := CallbackCreate(ObjBindMethod(implObj, "GetExtendedType"), flags, 2)
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetExtendedType)
