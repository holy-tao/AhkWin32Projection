 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imfmediaevent
...
class IMFMediaEvent extends IMFAttributes{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediaevent-gettype
     */
    GetType() {
        result := ComCall(33, this, "uint*", &pmet := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediaevent-getextendedtype
     */
    GetExtendedType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediaevent-getstatus
     */
    GetStatus() {
        result := ComCall(35, this, "int*", &phrStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmediaevent-getvalue
     */
    GetValue() {
        pvValue := PROPVARIANT()
