 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsampleprotection
...
class IMFSampleProtection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsampleprotection-getinputprotectionversion
     */
    GetInputProtectionVersion() {
        result := ComCall(3, this, "uint*", &pdwVersion := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} Receives a member of the <a href="https://docs.microsoft.com/windows/desktop/api/mfidl/ne-mfidl-sample_protection_version">SAMPLE_PROTECTION_VERSION</a> enumeration.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsampleprotection-getoutputprotectionversion
     */
    GetOutputProtectionVersion() {
        result := ComCall(4, this, "uint*", &pdwVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsampleprotection-getprotectioncertificate
     */
    GetProtectionCertificate(dwVersion, ppCert, pcbCert) {
        ...
        result := ComCall(5, this, "uint", dwVersion, ppCertMarshal, ppCert, pcbCertMarshal, pcbCert, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsampleprotection-initoutputprotection
     */
    InitOutputProtection(dwVersion, dwOutputId, pbCert, cbCert, ppbSeed, pcbSeed) {
        ...
        result := ComCall(6, this, "uint", dwVersion, "uint", dwOutputId, pbCertMarshal, pbCert, "uint", cbCert, ppbSeedMarshal, ppbSeed, pcbSeedMarshal, pcbSeed, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsampleprotection-initinputprotection
     */
    InitInputProtection(dwVersion, dwInputId, pbSeed, cbSeed) {
        pbSeedMarshal := pbSeed is VarRef ? "char*" : "ptr"

        result := ComCall(7, this, "uint", dwVersion, "uint", dwInputId, pbSeedMarshal, pbSeed, "uint", cbSeed, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
