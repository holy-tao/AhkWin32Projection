 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nn-mfreadwrite-imfsourcereadercallback
...
class IMFSourceReaderCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nf-mfreadwrite-imfsourcereadercallback-onreadsample
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value. Currently, the source reader ignores the return value.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nf-mfreadwrite-imfsourcereadercallback-onflush
     */
     ...
     * @returns {HRESULT} Returns an <b>HRESULT</b> value. Currently, the source reader ignores the return value.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nf-mfreadwrite-imfsourcereadercallback-onevent
     */
