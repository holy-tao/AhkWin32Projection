 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfnetcrossoriginsupport
...
class IMFNetCrossOriginSupport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfnetcrossoriginsupport-getcrossoriginpolicy
     */
    GetCrossOriginPolicy() {
        result := ComCall(3, this, "int*", &pPolicy := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfnetcrossoriginsupport-getsourceorigin
     */
    GetSourceOrigin() {
        result := ComCall(4, this, "ptr*", &wszSourceOrigin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    IsSameOrigin(wszURL) {
        ...
        result := ComCall(5, this, "ptr", wszURL, "int*", &pfIsSameOrigin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
