 ...
 */
class DXVAHD_BLT_STATE extends Win32Enum {
     ...
     * Native name: DXVAHD_BLT_STATE_TARGET_RECT
     * @type {Integer (Int32)}
     */
    static TARGET_RECT => 0
     ...
     * Native name: DXVAHD_BLT_STATE_BACKGROUND_COLOR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_BLT_STATE_OUTPUT_COLOR_SPACE
     * @type {Integer (Int32)}
     */
    static OUTPUT_COLOR_SPACE => 2
     ...
     * Native name: DXVAHD_BLT_STATE_ALPHA_FILL
     * @type {Integer (Int32)}
     */
    static ALPHA_FILL => 3
     ...
     * Native name: DXVAHD_BLT_STATE_CONSTRICTION
     * @type {Integer (Int32)}
     */
    static CONSTRICTION => 4
     ...
     * Native name: DXVAHD_BLT_STATE_PRIVATE
     * @type {Integer (Int32)}
     */
    static PRIVATE => 1000
}
