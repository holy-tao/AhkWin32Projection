 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nn-mfspatialaudio-imfspatialaudiosample
...
class IMFSpatialAudioSample extends IMFSample{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudiosample-getobjectcount
     */
    GetObjectCount() {
        result := ComCall(47, this, "uint*", &pdwObjectCount := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudiosample-addspatialaudioobject
     */
     ...
     * @returns {Pointer<IMFSpatialAudioObjectBuffer>} A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/mfspatialaudio/nn-mfspatialaudio-imfspatialaudioobjectbuffer">IMFSpatialAudioObjectBuffer</a> object in which the spatial audio object corresponding with the specified index will be stored.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudiosample-getspatialaudioobjectbyindex
     */
    GetSpatialAudioObjectByIndex(dwIndex) {
        result := ComCall(49, this, "uint", dwIndex, "ptr*", &ppAudioObjBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppAudioObjBuffer
    }
}
