 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imf2dbuffer2
...
class IMF2DBuffer2 extends IMF2DBuffer{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imf2dbuffer2-lock2dsize
     */
    Lock2DSize(lockFlags, ppbScanline0, plPitch, ppbBufferStart, pcbBufferLength) {
        ...
        result := ComCall(10, this, "int", lockFlags, ppbScanline0Marshal, ppbScanline0, plPitchMarshal, plPitch, ppbBufferStartMarshal, ppbBufferStart, pcbBufferLengthMarshal, pcbBufferLength, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imf2dbuffer2-copy2dto
     */
