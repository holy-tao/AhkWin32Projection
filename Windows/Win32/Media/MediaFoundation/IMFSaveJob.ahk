 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsavejob
...
class IMFSaveJob extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsavejob-beginsave
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsavejob-endsave
     */
    EndSave(pResult) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsavejob-cancelsave
     */
    CancelSave() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsavejob-getprogress
     */
    GetProgress() {
        result := ComCall(6, this, "uint*", &pdwPercentComplete := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
