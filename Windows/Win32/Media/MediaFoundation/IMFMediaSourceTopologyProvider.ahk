 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfmediasourcetopologyprovider
...
class IMFMediaSourceTopologyProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfmediasourcetopologyprovider-getmediasourcetopology
     */
    GetMediaSourceTopology(pPresentationDescriptor) {
        result := ComCall(3, this, "ptr", pPresentationDescriptor, "ptr*", &ppTopology := 0, "int")
        if(result != 0) {
