 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfsharingengine/nn-mfsharingengine-iplaytocontrolwithcapabilities
...
class IPlayToControlWithCapabilities extends IPlayToControl{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfsharingengine/nf-mfsharingengine-iplaytocontrolwithcapabilities-getcapabilities
     */
    GetCapabilities() {
        result := ComCall(5, this, "int*", &pCapabilities := 0, "int")
        if(result != 0) {
