 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imfmediaenginesupportssourcetransfer
...
class IMFMediaEngineSupportsSourceTransfer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesupportssourcetransfer-shouldtransfersource
     */
    ShouldTransferSource() {
        result := ComCall(3, this, "int*", &pfShouldTransfer := 0, "int")
        if(result != 0) {
     ...
     * @param {Pointer<Pointer<IMFByteStream>>} ppByteStream Receives the byte stream.
     * @param {Pointer<Pointer<IMFMediaSource>>} ppMediaSource Receives the media source.
     * @param {Pointer<Pointer<IMFMediaSourceExtension>>} ppMSE Receives the media source extension.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesupportssourcetransfer-detachmediasource
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediaenginesupportssourcetransfer-attachmediasource
     */
