...
class D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAGS extends Win32BitflagEnum {
    ...
    /**
     * None.
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_RESOLUTION_CHANGE
     * @type {Integer (Int32)}
     */
    static FLAG_RESOLUTION_CHANGE => 1
     ...
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_RATE_CONTROL_CHANGE
     * @type {Integer (Int32)}
     */
    static FLAG_RATE_CONTROL_CHANGE => 2
     ...
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_SUBREGION_LAYOUT_CHANGE
     * @type {Integer (Int32)}
     */
    static FLAG_SUBREGION_LAYOUT_CHANGE => 4
     ...
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_REQUEST_INTRA_REFRESH
     * @type {Integer (Int32)}
     */
    static FLAG_REQUEST_INTRA_REFRESH => 8
     ...
     * Native name: D3D12_VIDEO_ENCODER_SEQUENCE_CONTROL_FLAG_GOP_SEQUENCE_CHANGE
     * @type {Integer (Int32)}
     */
    static FLAG_GOP_SEQUENCE_CHANGE => 16
}
