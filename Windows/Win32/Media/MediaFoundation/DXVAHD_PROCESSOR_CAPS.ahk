 ...
 * @see https://learn.microsoft.com/windows/win32/api/dxvahd/ne-dxvahd-dxvahd_processor_caps
...
class DXVAHD_PROCESSOR_CAPS extends Win32Enum {
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_DEINTERLACE_BLEND
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_DEINTERLACE_BOB
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_DEINTERLACE_ADAPTIVE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_DEINTERLACE_MOTION_COMPENSATION
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_INVERSE_TELECINE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXVAHD_PROCESSOR_CAPS_FRAME_RATE_CONVERSION
     * @type {Integer (Int32)}
     */
