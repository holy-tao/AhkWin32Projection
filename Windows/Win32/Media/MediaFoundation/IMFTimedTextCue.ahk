 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imftimedtextcue
...
class IMFTimedTextCue extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getid
     */
    GetId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getoriginalid
     */
    GetOriginalId() {
        result := ComCall(4, this, "ptr*", &originalId := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getcuekind
     */
    GetCueKind() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getstarttime
     */
    GetStartTime() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getduration
     */
    GetDuration() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-gettrackid
     */
    GetTrackId() {
     ...
     * @returns {Pointer<IMFTimedTextBinary>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/mfmediaengine/nn-mfmediaengine-imftimedtextbinary">IMFTimedTextBinary</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getdata
     */
    GetData() {
        result := ComCall(9, this, "ptr*", &data := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFTimedTextRegion>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getregion
     */
    GetRegion() {
        result := ComCall(10, this, "ptr*", &region_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IMFTimedTextStyle>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/mfmediaengine/nn-mfmediaengine-imftimedtextstyle">IMFTimedTextStyle</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getstyle
     */
    GetStyle() {
        result := ComCall(11, this, "ptr*", &style := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getlinecount
     */
    GetLineCount() {
     ...
     * @returns {Pointer<IMFTimedTextFormattedText>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/mfmediaengine/nn-mfmediaengine-imftimedtextformattedtext">IMFTimedTextFormattedText</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imftimedtextcue-getline
     */
    GetLine(index) {
        result := ComCall(13, this, "uint", index, "ptr*", &line := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
