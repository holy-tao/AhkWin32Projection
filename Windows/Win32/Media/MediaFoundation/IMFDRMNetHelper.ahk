...
class IMFDRMNetHelper extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<Byte>} pLicenseRequest 
     * @param {Integer} cbLicenseRequest 
     * @param {Pointer<Byte>} ppLicenseResponse 
     * @param {Pointer<UInt32>} pcbLicenseResponse 
    ...
    ProcessLicenseRequest(pLicenseRequest, cbLicenseRequest, ppLicenseResponse, pcbLicenseResponse, pbstrKID) {
        result := ComCall(3, this, "char*", pLicenseRequest, "uint", cbLicenseRequest, "char*", ppLicenseResponse, "uint*", pcbLicenseResponse, "ptr", pbstrKID, "int")
        if(result != 0)
    ...
    GetChainedLicenseResponse(ppLicenseResponse, pcbLicenseResponse) {
        result := ComCall(4, this, "char*", ppLicenseResponse, "uint*", pcbLicenseResponse, "int")
        if(result != 0)
            throw OSError(result)
