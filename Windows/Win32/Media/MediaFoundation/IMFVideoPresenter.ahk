 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-imfvideopresenter
...
class IMFVideoPresenter extends IMFClockStateSink{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideopresenter-processmessage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideopresenter-getcurrentmediatype
     */
    GetCurrentMediaType() {
        result := ComCall(9, this, "ptr*", &ppMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
