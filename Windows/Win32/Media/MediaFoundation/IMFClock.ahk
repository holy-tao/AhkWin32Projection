 ...
 */
export default struct IMFClock extends IUnknown {
    /**
     ...
     * used for IMFClock interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetClockCharacteristics : IntPtr
        GetCorrelatedTime       : IntPtr
        GetContinuityKey        : IntPtr
        GetState                : IntPtr
    ...
    GetProperties() {
        ...
        result := ComCall(7, this, MFCLOCK_PROPERTIES.Ptr, pClockProperties, "HRESULT")
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetClockCharacteristics)
        CallbackFree(this.vtbl.GetCorrelatedTime)
        CallbackFree(this.vtbl.GetContinuityKey)
