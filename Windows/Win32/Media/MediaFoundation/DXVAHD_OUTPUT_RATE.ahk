 ...
 * @see https://learn.microsoft.com/windows/win32/api/dxvahd/ne-dxvahd-dxvahd_output_rate
...
class DXVAHD_OUTPUT_RATE extends Win32Enum {
     ...
     * Native name: DXVAHD_OUTPUT_RATE_NORMAL
     * @type {Integer (Int32)}
     */
    static NORMAL => 0
     ...
     * Native name: DXVAHD_OUTPUT_RATE_HALF
     * @type {Integer (Int32)}
     */
    static HALF => 1
     ...
     * Native name: DXVAHD_OUTPUT_RATE_CUSTOM
     * @type {Integer (Int32)}
     */
    static CUSTOM => 2
}
