 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nn-mfcaptureengine-imfcapturepreviewsink
...
class IMFCapturePreviewSink extends IMFCaptureSink{
     ...
     * @param {HANDLE} handle_ A handle to the window. The preview sink draws the video frames inside this window.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setrenderhandle
     */
    SetRenderHandle(handle_) {
        handle_ := handle_ is Win32Handle ? NumGet(handle_, "ptr") : handle_

        result := ComCall(8, this, "ptr", handle_, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setrendersurface
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-updatevideo
     */
    UpdateVideo(pSrc, pDst, pBorderClr) {
        pBorderClrMarshal := pBorderClr is VarRef ? "uint*" : "ptr"

        result := ComCall(10, this, "ptr", pSrc, "ptr", pDst, pBorderClrMarshal, pBorderClr, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @remarks
     * Calling this method overrides any previous call to <a href="https://docs.microsoft.com/windows/desktop/api/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setrenderhandle">IMFCapturePreviewSink::SetRenderHandle</a>.
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setsamplecallback
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-getmirrorstate
     */
    GetMirrorState() {
        result := ComCall(12, this, "int*", &pfMirrorState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setmirrorstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-getrotation
     */
    GetRotation(dwStreamIndex) {
        result := ComCall(14, this, "uint", dwStreamIndex, "uint*", &pdwRotationValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setrotation
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcaptureengine/nf-mfcaptureengine-imfcapturepreviewsink-setcustomsink
     */
