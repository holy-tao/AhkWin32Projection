...
class MF_MEDIA_ENGINE_STATISTIC extends Win32Enum {
     ...
     * Native name: MF_MEDIA_ENGINE_STATISTIC_FRAMES_RENDERED
     * @type {Integer (Int32)}
     */
    static FRAMES_RENDERED => 0

    /**
     * The number of dropped video frames. (<b>ULONG</b>, <b>VT_UI4</b>)
     * Native name: MF_MEDIA_ENGINE_STATISTIC_FRAMES_DROPPED
     * @type {Integer (Int32)}
     */
    static FRAMES_DROPPED => 1

    /**
     * The number of bytes that have been downloaded since the last HTTP range request. (<b>ULARGE_INTEGER</b>, <b>VT_UI8</b>).
     * Native name: MF_MEDIA_ENGINE_STATISTIC_BYTES_DOWNLOADED
     * @type {Integer (Int32)}
     */
    static BYTES_DOWNLOADED => 2
     ...
     * Native name: MF_MEDIA_ENGINE_STATISTIC_BUFFER_PROGRESS
     * @type {Integer (Int32)}
     */
    static BUFFER_PROGRESS => 3

    /**
     * The frames per second. (<b>FLOAT</b>, <b>VT_R4</b>)
     * Native name: MF_MEDIA_ENGINE_STATISTIC_FRAMES_PER_SECOND
     * @type {Integer (Int32)}
     */
    static FRAMES_PER_SECOND => 4

    /**
     * The amount of playback jitter. (<b>DOUBLE</b>, <b>VT_R8</b>)
     * 
     * Supported in Windows 8.1 and later.
     * Native name: MF_MEDIA_ENGINE_STATISTIC_PLAYBACK_JITTER
     * @type {Integer (Int32)}
     */
    static PLAYBACK_JITTER => 5

    /**
     * The number of corrupted frames. (<b>ULONG</b>, <b>VT_UI4</b>)
     * 
     * Supported in Windows 8.1 and later.
     * Native name: MF_MEDIA_ENGINE_STATISTIC_FRAMES_CORRUPTED
     * @type {Integer (Int32)}
     */
    static FRAMES_CORRUPTED => 6

    /**
     * The total amount of frame delay.  (<b>DOUBLE</b>, <b>VT_R8</b>)
     * 
     * Supported in Windows 8.1 and later.
     * Native name: MF_MEDIA_ENGINE_STATISTIC_TOTAL_FRAME_DELAY
     * @type {Integer (Int32)}
     */
    static TOTAL_FRAME_DELAY => 7
}
