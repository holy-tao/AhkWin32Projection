 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-imfvideomixercontrol
...
class IMFVideoMixerControl extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol-setstreamzorder
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol-getstreamzorder
     */
    GetStreamZOrder(dwStreamID) {
        result := ComCall(4, this, "uint", dwStreamID, "uint*", &pdwZ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol-setstreamoutputrect
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfvideomixercontrol-getstreamoutputrect
     */
