 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfworkqueueservicesex
...
class IMFWorkQueueServicesEx extends IMFWorkQueueServices{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservicesex-gettopologyworkqueuemmcsspriority
     */
    GetTopologyWorkQueueMMCSSPriority(dwTopologyWorkQueueId) {
        result := ComCall(15, this, "uint", dwTopologyWorkQueueId, "int*", &plPriority := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservicesex-beginregisterplatformworkqueuewithmmcssex
     */
    BeginRegisterPlatformWorkQueueWithMMCSSEx(dwPlatformWorkQueue, wszClass, dwTaskId, lPriority, pCallback, pState) {
        ...
        result := ComCall(16, this, "uint", dwPlatformWorkQueue, "ptr", wszClass, "uint", dwTaskId, "int", lPriority, "ptr", pCallback, "ptr", pState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfworkqueueservicesex-getplatformworkqueuemmcsspriority
     */
    GetPlatformWorkQueueMMCSSPriority(dwPlatformWorkQueueId) {
        result := ComCall(17, this, "uint", dwPlatformWorkQueueId, "int*", &plPriority := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
