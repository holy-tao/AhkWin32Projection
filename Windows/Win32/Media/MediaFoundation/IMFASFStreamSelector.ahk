 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nn-wmcontainer-imfasfstreamselector
...
class IMFASFStreamSelector extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getstreamcount
     */
    GetStreamCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputcount
     */
    GetOutputCount() {
        result := ComCall(4, this, "uint*", &pcOutputs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputstreamcount
     */
    GetOutputStreamCount(dwOutputNum) {
        result := ComCall(5, this, "uint", dwOutputNum, "uint*", &pcStreams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputstreamnumbers
     */
    GetOutputStreamNumbers(dwOutputNum) {
        result := ComCall(6, this, "uint", dwOutputNum, "ushort*", &rgwStreamNumbers := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputfromstream
     */
    GetOutputFromStream(wStreamNum) {
        result := ComCall(7, this, "ushort", wStreamNum, "uint*", &pdwOutput := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputoverride
     */
    GetOutputOverride(dwOutputNum) {
        result := ComCall(8, this, "uint", dwOutputNum, "int*", &pSelection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-setoutputoverride
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputmutexcount
     */
    GetOutputMutexCount(dwOutputNum) {
        result := ComCall(10, this, "uint", dwOutputNum, "uint*", &pcMutexes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getoutputmutex
     */
    GetOutputMutex(dwOutputNum, dwMutexNum) {
        result := ComCall(11, this, "uint", dwOutputNum, "uint", dwMutexNum, "ptr*", &ppMutex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-setoutputmutexselection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getbandwidthstepcount
     */
    GetBandwidthStepCount() {
        result := ComCall(13, this, "uint*", &pcStepCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-getbandwidthstep
     */
    GetBandwidthStep(dwStepNum, pdwBitrate, rgwStreamNumbers, rgSelections) {
        ...
        result := ComCall(14, this, "uint", dwStepNum, pdwBitrateMarshal, pdwBitrate, rgwStreamNumbersMarshal, rgwStreamNumbers, rgSelectionsMarshal, rgSelections, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-bitratetostepnumber
     */
    BitrateToStepNumber(dwBitrate) {
        result := ComCall(15, this, "uint", dwBitrate, "uint*", &pdwStepNum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfstreamselector-setstreamselectorflags
     */
