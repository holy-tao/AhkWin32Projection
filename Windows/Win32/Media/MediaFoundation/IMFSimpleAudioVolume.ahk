 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsimpleaudiovolume
...
class IMFSimpleAudioVolume extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsimpleaudiovolume-setmastervolume
     */
    SetMasterVolume(fLevel) {
        result := ComCall(3, this, "float", fLevel, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsimpleaudiovolume-getmastervolume
     */
    GetMasterVolume() {
        result := ComCall(4, this, "float*", &pfLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsimpleaudiovolume-setmute
     */
    SetMute(bMute) {
        result := ComCall(5, this, "int", bMute, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsimpleaudiovolume-getmute
     */
    GetMute() {
        result := ComCall(6, this, "int*", &pbMute := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
