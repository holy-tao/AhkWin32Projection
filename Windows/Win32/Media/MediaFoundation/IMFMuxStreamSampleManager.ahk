 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nn-mfobjects-imfmuxstreamsamplemanager
...
class IMFMuxStreamSampleManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmuxstreamsamplemanager-getstreamcount
     */
    GetStreamCount() {
     ...
     * @returns {Pointer<IMFSample>} The retrieved sample.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmuxstreamsamplemanager-getsample
     */
    GetSample(dwMuxStreamIndex) {
        result := ComCall(4, this, "uint", dwMuxStreamIndex, "ptr*", &ppSample := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfobjects/nf-mfobjects-imfmuxstreamsamplemanager-getstreamconfiguration
     */
