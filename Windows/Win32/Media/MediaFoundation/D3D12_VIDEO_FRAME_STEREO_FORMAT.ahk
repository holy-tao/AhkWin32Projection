...
class D3D12_VIDEO_FRAME_STEREO_FORMAT extends Win32Enum {
     ...
     * Native name: D3D12_VIDEO_FRAME_STEREO_FORMAT_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: D3D12_VIDEO_FRAME_STEREO_FORMAT_MONO
     * @type {Integer (Int32)}
     */
    static MONO => 1
     ...
     * Native name: D3D12_VIDEO_FRAME_STEREO_FORMAT_HORIZONTAL
     * @type {Integer (Int32)}
     */
    static HORIZONTAL => 2
     ...
     * Native name: D3D12_VIDEO_FRAME_STEREO_FORMAT_VERTICAL
     * @type {Integer (Int32)}
     */
    static VERTICAL => 3
     ...
     * Native name: D3D12_VIDEO_FRAME_STEREO_FORMAT_SEPARATE
     * @type {Integer (Int32)}
     */
    static SEPARATE => 4
}
