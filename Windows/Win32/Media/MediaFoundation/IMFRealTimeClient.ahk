 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfrealtimeclient
...
class IMFRealTimeClient extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfrealtimeclient-registerthreads
     */
    RegisterThreads(dwTaskIndex, wszClass) {
        wszClass := wszClass is String ? StrPtr(wszClass) : wszClass

        result := ComCall(3, this, "uint", dwTaskIndex, "ptr", wszClass, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfrealtimeclient-unregisterthreads
     */
    UnregisterThreads() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfrealtimeclient-setworkqueue
     */
    SetWorkQueue(dwWorkQueueId) {
        result := ComCall(5, this, "uint", dwWorkQueueId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
