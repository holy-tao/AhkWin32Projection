 ...
 */
export default struct IMFSourceReaderEx extends IMFSourceReader {
    /**
     ...
     * used for IMFSourceReaderEx interfaces
    */
    struct Vtbl extends IMFSourceReader.Vtbl {
        SetNativeMediaType           : IntPtr
        AddTransformForStream        : IntPtr
        RemoveAllTransformsForStream : IntPtr
        GetTransformForStream        : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMFSourceReaderEx.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.SetNativeMediaType)
        CallbackFree(this.vtbl.AddTransformForStream)
        CallbackFree(this.vtbl.RemoveAllTransformsForStream)
