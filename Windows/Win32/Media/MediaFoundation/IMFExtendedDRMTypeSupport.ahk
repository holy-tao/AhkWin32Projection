 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imfextendeddrmtypesupport
...
class IMFExtendedDRMTypeSupport extends IUnknown{
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["IsTypeSupportedEx"]
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfextendeddrmtypesupport-istypesupportedex
     */
    IsTypeSupportedEx(type, keySystem) {
        ...
        result := ComCall(3, this, "ptr", type, "ptr", keySystem, "int*", &pAnswer := 0, "int")
        if(result != 0) {
