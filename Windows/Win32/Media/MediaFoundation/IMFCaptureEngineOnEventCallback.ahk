 ...
 */
export default struct IMFCaptureEngineOnEventCallback extends IUnknown {
    /**
     ...
     * used for IMFCaptureEngineOnEventCallback interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMFCaptureEngineOnEventCallback.Vtbl()
        }
    ...
    Query(iid) {
        if (IMFCaptureEngineOnEventCallback.IID.Equals(iid)) {
            return true
        }
