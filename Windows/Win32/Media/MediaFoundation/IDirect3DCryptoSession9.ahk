 ...
 */
export default struct IDirect3DCryptoSession9 extends IUnknown {
    /**
     ...
     * used for IDirect3DCryptoSession9 interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetCertificateSize      : IntPtr
        GetCertificate          : IntPtr
        NegotiateKeyExchange    : IntPtr
        EncryptionBlt           : IntPtr
        DecryptionBlt           : IntPtr
        GetSurfacePitch         : IntPtr
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirect3DCryptoSession9.Vtbl()
        }
    ...
    Query(iid) {
        if (IDirect3DCryptoSession9.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.NegotiateKeyExchange)
        CallbackFree(this.vtbl.EncryptionBlt)
        CallbackFree(this.vtbl.DecryptionBlt)
        CallbackFree(this.vtbl.GetSurfacePitch)
