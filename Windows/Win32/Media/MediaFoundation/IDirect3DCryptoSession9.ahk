 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dcryptosession9
...
class IDirect3DCryptoSession9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-getcertificatesize
     */
    GetCertificateSize(pCertificateSize) {
        pCertificateSizeMarshal := pCertificateSize is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, pCertificateSizeMarshal, pCertificateSize, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-getcertificate
     */
    GetCertificate(CertifacteSize, ppCertificate) {
        ppCertificateMarshal := ppCertificate is VarRef ? "char*" : "ptr"

        result := ComCall(4, this, "uint", CertifacteSize, ppCertificateMarshal, ppCertificate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-negotiatekeyexchange
     */
    NegotiateKeyExchange(DataSize, pData) {
        pDataMarshal := pData is VarRef ? "ptr" : "ptr"

        result := ComCall(5, this, "uint", DataSize, pDataMarshal, pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-encryptionblt
     */
    EncryptionBlt(pSrcSurface, pDstSurface, DstSurfaceSize, pIV) {
        pIVMarshal := pIV is VarRef ? "ptr" : "ptr"

        result := ComCall(6, this, "ptr", pSrcSurface, "ptr", pDstSurface, "uint", DstSurfaceSize, pIVMarshal, pIV, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * For other encryption types, a different structure might be used, or the encryption might not use an IV.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-decryptionblt
     */
    DecryptionBlt(pSrcSurface, pDstSurface, SrcSurfaceSize, pEncryptedBlockInfo, pContentKey, pIV) {
        ...
        result := ComCall(7, this, "ptr", pSrcSurface, "ptr", pDstSurface, "uint", SrcSurfaceSize, "ptr", pEncryptedBlockInfo, pContentKeyMarshal, pContentKey, pIVMarshal, pIV, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-getsurfacepitch
     */
    GetSurfacePitch(pSrcSurface, pSurfacePitch) {
        pSurfacePitchMarshal := pSurfacePitch is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, "ptr", pSrcSurface, pSurfacePitchMarshal, pSurfacePitch, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-startsessionkeyrefresh
     */
    StartSessionKeyRefresh(pRandomNumber, RandomNumberSize) {
        pRandomNumberMarshal := pRandomNumber is VarRef ? "ptr" : "ptr"

        result := ComCall(9, this, pRandomNumberMarshal, pRandomNumber, "uint", RandomNumberSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-finishsessionkeyrefresh
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dcryptosession9-getencryptionbltkey
     */
    GetEncryptionBltKey(pReadbackKey, KeySize) {
        pReadbackKeyMarshal := pReadbackKey is VarRef ? "ptr" : "ptr"

        result := ComCall(11, this, pReadbackKeyMarshal, pReadbackKey, "uint", KeySize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
