 ...
 * </li>
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nn-evr9-imfvideoprocessor
...
class IMFVideoProcessor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getavailablevideoprocessormodes
     */
    GetAvailableVideoProcessorModes(lpdwNumProcessingModes) {
        ...
        result := ComCall(3, this, lpdwNumProcessingModesMarshal, lpdwNumProcessingModes, "ptr*", &ppVideoProcessingModes := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getvideoprocessorcaps
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getvideoprocessormode
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-setvideoprocessormode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getprocamprange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getprocampvalues
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-setprocampvalues
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getfilteringrange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getfilteringvalue
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-setfilteringvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-getbackgroundcolor
     */
    GetBackgroundColor() {
        result := ComCall(13, this, "uint*", &lpClrBkg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr9/nf-evr9-imfvideoprocessor-setbackgroundcolor
     */
