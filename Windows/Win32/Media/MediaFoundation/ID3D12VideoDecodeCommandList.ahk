...
#Import ".\D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS.ahk" { D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS }
#Import ".\ID3D12VideoDecoder.ahk" { ID3D12VideoDecoder }

/**
 * Encapsulates a list of graphics commands for video decoding.
 * @see https://learn.microsoft.com/windows/win32/api/d3d12video/nn-d3d12video-id3d12videodecodecommandlist
 * @namespace Windows.Win32.Media.MediaFoundation
 */
export default struct ID3D12VideoDecodeCommandList extends ID3D12CommandList {
    /**
     ...
     * used for ID3D12VideoDecodeCommandList interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D12VideoDecodeCommandList.Vtbl()
        }
    ...
    DecodeFrame(pDecoder, pOutputArguments, pInputArguments) {
        ComCall(21, this, "ptr", pDecoder, D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS.Ptr, pOutputArguments, D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS.Ptr, pInputArguments)
    }
    ...
    _Query(iid) {
        if (ID3D12VideoDecodeCommandList.IID.Equals(iid)) {
            return true
        }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.DecodeFrame := CallbackCreate(ObjBindMethod(implObj, "DecodeFrame"), flags, 4)
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.DecodeFrame)
