...
#Import ".\ID3D12VideoProcessCommandList1.ahk" { ID3D12VideoProcessCommandList1 }

/**
 * Adds support for video extension commands. (ID3D12VideoProcessCommandList2)
 * @see https://learn.microsoft.com/windows/win32/api/d3d12video/nn-d3d12video-id3d12videoprocesscommandlist2
 * @namespace Windows.Win32.Media.MediaFoundation
 */
export default struct ID3D12VideoProcessCommandList2 extends ID3D12VideoProcessCommandList1 {
    /**
     ...
     * used for ID3D12VideoProcessCommandList2 interfaces
    */
    struct Vtbl extends ID3D12VideoProcessCommandList1.Vtbl {
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D12VideoProcessCommandList2.Vtbl()
        }
    ...
    Query(iid) {
        if (ID3D12VideoProcessCommandList2.IID.Equals(iid)) {
            return true
        }
