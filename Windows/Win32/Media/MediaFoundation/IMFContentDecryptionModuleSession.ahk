 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nn-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession
...
class IMFContentDecryptionModuleSession extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-getsessionid
     */
    GetSessionId() {
        result := ComCall(3, this, "ptr*", &sessionId := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-getexpiration
     */
    GetExpiration() {
        result := ComCall(4, this, "double*", &expiration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-getkeystatuses
     */
    GetKeyStatuses(keyStatuses, numKeyStatuses) {
        ...
        result := ComCall(5, this, keyStatusesMarshal, keyStatuses, numKeyStatusesMarshal, numKeyStatuses, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-load
     */
    Load(sessionId) {
        sessionId := sessionId is String ? StrPtr(sessionId) : sessionId

        result := ComCall(6, this, "ptr", sessionId, "int*", &loaded := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-generaterequest
     */
    GenerateRequest(initDataType, initData, initDataSize) {
        ...
        result := ComCall(7, this, "ptr", initDataType, initDataMarshal, initData, "uint", initDataSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-update
     */
    Update(response, responseSize) {
        responseMarshal := response is VarRef ? "char*" : "ptr"

        result := ComCall(8, this, responseMarshal, response, "uint", responseSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-close
     */
    Close() {
     ...
     * @returns {HRESULT} Returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfcontentdecryptionmodule/nf-mfcontentdecryptionmodule-imfcontentdecryptionmodulesession-remove
     */
    Remove() {
