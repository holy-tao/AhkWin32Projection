 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nn-mfreadwrite-imfsinkwriterencoderconfig
...
class IMFSinkWriterEncoderConfig extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nf-mfreadwrite-imfsinkwriterencoderconfig-settargetmediatype
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfreadwrite/nf-mfreadwrite-imfsinkwriterencoderconfig-placeencodingparameters
     */
