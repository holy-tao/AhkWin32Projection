 ...
 */
class D3D12_VIDEO_PROCESS_DEINTERLACE_FLAGS extends Win32BitflagEnum {

    /**
     * No deinterlacing capabilities are available.
     * Native name: D3D12_VIDEO_PROCESS_DEINTERLACE_FLAG_NONE
     * @type {Integer (UInt32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_VIDEO_PROCESS_DEINTERLACE_FLAG_BOB
     * @type {Integer (UInt32)}
     */
    static FLAG_BOB => 1
     ...
     * Native name: D3D12_VIDEO_PROCESS_DEINTERLACE_FLAG_CUSTOM
     * @type {Integer (UInt32)}
     */
