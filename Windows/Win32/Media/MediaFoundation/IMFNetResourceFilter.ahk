 ...
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfnetresourcefilter
...
class IMFNetResourceFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfnetresourcefilter-onredirect
     */
    OnRedirect(pszUrl) {
        pszUrl := pszUrl is String ? StrPtr(pszUrl) : pszUrl

        result := ComCall(3, this, "ptr", pszUrl, "short*", &pvbCancel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfnetresourcefilter-onsendingrequest
     */
