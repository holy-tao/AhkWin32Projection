 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-ievrfilterconfig
...
class IEVRFilterConfig extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrfilterconfig-setnumberofstreams
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrfilterconfig-getnumberofstreams
     */
    GetNumberOfStreams() {
        result := ComCall(4, this, "uint*", &pdwMaxStreams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
