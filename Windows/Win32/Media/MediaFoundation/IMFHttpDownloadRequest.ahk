 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfhttpdownloadrequest
...
class IMFHttpDownloadRequest extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-addheader
     */
    AddHeader(szHeader) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-beginsendrequest
     */
    BeginSendRequest(pbPayload, cbPayload, pCallback, punkState) {
        pbPayloadMarshal := pbPayload is VarRef ? "char*" : "ptr"

        result := ComCall(4, this, pbPayloadMarshal, pbPayload, "uint", cbPayload, "ptr", pCallback, "ptr", punkState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-endsendrequest
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-beginreceiveresponse
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-endreceiveresponse
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-beginreadpayload
     */
    BeginReadPayload(cb, pCallback, punkState) {
        result := ComCall(8, this, "char*", &pb := 0, "uint", cb, "ptr", pCallback, "ptr", punkState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-endreadpayload
     */
    EndReadPayload(pResult, pqwOffset, pcbRead) {
        ...
        result := ComCall(9, this, "ptr", pResult, pqwOffsetMarshal, pqwOffset, pcbReadMarshal, pcbRead, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-queryheader
     */
    QueryHeader(szHeaderName, dwIndex) {
        szHeaderName := szHeaderName is String ? StrPtr(szHeaderName) : szHeaderName

        result := ComCall(10, this, "ptr", szHeaderName, "uint", dwIndex, "ptr*", &ppszHeaderValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-geturl
     */
    GetURL() {
        result := ComCall(11, this, "ptr*", &ppszURL := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-hasnullsourceorigin
     */
    HasNullSourceOrigin() {
        result := ComCall(12, this, "int*", &pfNullSourceOrigin := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-gettimeseekresult
     */
    GetTimeSeekResult(pqwStartTime, pqwStopTime, pqwDuration) {
        ...
        result := ComCall(13, this, pqwStartTimeMarshal, pqwStartTime, pqwStopTimeMarshal, pqwStopTime, pqwDurationMarshal, pqwDuration, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-gethttpstatus
     */
    GetHttpStatus() {
        result := ComCall(14, this, "uint*", &pdwHttpStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-getatendofpayload
     */
    GetAtEndOfPayload() {
        result := ComCall(15, this, "int*", &pfAtEndOfPayload := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-gettotallength
     */
    GetTotalLength() {
        result := ComCall(16, this, "uint*", &pqwTotalLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-getrangeendoffset
     */
    GetRangeEndOffset() {
        result := ComCall(17, this, "uint*", &pqwRangeEnd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfhttpdownloadrequest-close
     */
    Close() {
