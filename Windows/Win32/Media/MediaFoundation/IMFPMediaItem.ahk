 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nn-mfplay-imfpmediaitem
...
class IMFPMediaItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getmediaplayer
     */
    GetMediaPlayer() {
        result := ComCall(3, this, "ptr*", &ppMediaPlayer := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-geturl
     */
    GetURL() {
        result := ComCall(4, this, "ptr*", &ppwszURL := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getobject
     */
    GetObject() {
        result := ComCall(5, this, "ptr*", &ppIUnknown := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getuserdata
     */
    GetUserData() {
        result := ComCall(6, this, "ptr*", &pdwUserData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-setuserdata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getstartstopposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-setstartstopposition
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-hasvideo
     */
    HasVideo(pfHasVideo, pfSelected) {
        ...
        result := ComCall(10, this, pfHasVideoMarshal, pfHasVideo, pfSelectedMarshal, pfSelected, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-hasaudio
     */
    HasAudio(pfHasAudio, pfSelected) {
        pfHasAudioMarshal := pfHasAudio is VarRef ? "int*" : "ptr"
        pfSelectedMarshal := pfSelected is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, pfHasAudioMarshal, pfHasAudio, pfSelectedMarshal, pfSelected, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-isprotected
     */
    IsProtected() {
        result := ComCall(12, this, "int*", &pfProtected := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getduration
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getnumberofstreams
     */
    GetNumberOfStreams() {
        result := ComCall(14, this, "uint*", &pdwStreamCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getstreamselection
     */
    GetStreamSelection(dwStreamIndex) {
        result := ComCall(15, this, "uint", dwStreamIndex, "int*", &pfEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-setstreamselection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getstreamattribute
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getpresentationattribute
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getcharacteristics
     */
    GetCharacteristics() {
        result := ComCall(19, this, "uint*", &pCharacteristics := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-setstreamsink
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfplay/nf-mfplay-imfpmediaitem-getmetadata
     */
    GetMetadata() {
        result := ComCall(21, this, "ptr*", &ppMetadataStore := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
