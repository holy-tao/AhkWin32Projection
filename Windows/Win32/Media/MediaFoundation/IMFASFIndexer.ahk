 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nn-wmcontainer-imfasfindexer
...
class IMFASFIndexer extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-setflags
     */
    SetFlags(dwFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getflags
     */
    GetFlags() {
        result := ComCall(4, this, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-initialize
     */
    Initialize(pIContentInfo) {
        result := ComCall(5, this, "ptr", pIContentInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getindexposition
     */
    GetIndexPosition(pIContentInfo) {
        result := ComCall(6, this, "ptr", pIContentInfo, "uint*", &pcbIndexOffset := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-setindexbytestreams
     */
    SetIndexByteStreams(ppIByteStreams, cByteStreams) {
        result := ComCall(7, this, "ptr*", ppIByteStreams, "uint", cByteStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getindexbytestreamcount
     */
    GetIndexByteStreamCount() {
        result := ComCall(8, this, "uint*", &pcByteStreams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getindexstatus
     */
    GetIndexStatus(pIndexIdentifier, pfIsIndexed, pbIndexDescriptor, pcbIndexDescriptor) {
        ...
        result := ComCall(9, this, "ptr", pIndexIdentifier, pfIsIndexedMarshal, pfIsIndexed, pbIndexDescriptorMarshal, pbIndexDescriptor, pcbIndexDescriptorMarshal, pcbIndexDescriptor, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-setindexstatus
     */
    SetIndexStatus(pbIndexDescriptor, cbIndexDescriptor, fGenerateIndex) {
        pbIndexDescriptorMarshal := pbIndexDescriptor is VarRef ? "char*" : "ptr"

        result := ComCall(10, this, pbIndexDescriptorMarshal, pbIndexDescriptor, "uint", cbIndexDescriptor, "int", fGenerateIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getseekpositionforvalue
     */
    GetSeekPositionForValue(pvarValue, pIndexIdentifier, phnsApproxTime, pdwPayloadNumberOfStreamWithinPacket) {
        ...
        result := ComCall(11, this, "ptr", pvarValue, "ptr", pIndexIdentifier, "uint*", &pcbOffsetWithinData := 0, phnsApproxTimeMarshal, phnsApproxTime, pdwPayloadNumberOfStreamWithinPacketMarshal, pdwPayloadNumberOfStreamWithinPacket, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-generateindexentries
     */
    GenerateIndexEntries(pIASFPacketSample) {
        result := ComCall(12, this, "ptr", pIASFPacketSample, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-commitindex
     */
    CommitIndex(pIContentInfo) {
        result := ComCall(13, this, "ptr", pIContentInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getindexwritespace
     */
    GetIndexWriteSpace() {
        result := ComCall(14, this, "uint*", &pcbIndexWriteSpace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfindexer-getcompletedindex
     */
    GetCompletedIndex(pIIndexBuffer, cbOffsetWithinIndex) {
        result := ComCall(15, this, "ptr", pIIndexBuffer, "uint", cbOffsetWithinIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
