...
class IMFASFIndexer extends IUnknown{
     ...
     * @param {Pointer<IMFASFContentInfo>} pIContentInfo 
     * @returns {HRESULT} <ul>
     ...
     * 
     * @param {Pointer<IMFASFContentInfo>} pIContentInfo 
     * @param {Pointer<UInt64>} pcbIndexOffset 
     * @returns {HRESULT} 
     */
    GetIndexPosition(pIContentInfo, pcbIndexOffset) {
        result := ComCall(6, this, "ptr", pIContentInfo, "uint*", pcbIndexOffset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pcByteStreams 
     * @returns {HRESULT} 
     */
    GetIndexByteStreamCount(pcByteStreams) {
        result := ComCall(8, this, "uint*", pcByteStreams, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Byte>} pbIndexDescriptor 
     * @param {Pointer<UInt32>} pcbIndexDescriptor 
     * @returns {HRESULT} 
     */
    GetIndexStatus(pIndexIdentifier, pfIsIndexed, pbIndexDescriptor, pcbIndexDescriptor) {
        result := ComCall(9, this, "ptr", pIndexIdentifier, "ptr", pfIsIndexed, "char*", pbIndexDescriptor, "uint*", pcbIndexDescriptor, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetIndexStatus(pbIndexDescriptor, cbIndexDescriptor, fGenerateIndex) {
        result := ComCall(10, this, "char*", pbIndexDescriptor, "uint", cbIndexDescriptor, "int", fGenerateIndex, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<ASF_INDEX_IDENTIFIER>} pIndexIdentifier 
     * @param {Pointer<UInt64>} pcbOffsetWithinData 
     * @param {Pointer<Int64>} phnsApproxTime 
     * @param {Pointer<UInt32>} pdwPayloadNumberOfStreamWithinPacket 
     * @returns {HRESULT} 
     */
    GetSeekPositionForValue(pvarValue, pIndexIdentifier, pcbOffsetWithinData, phnsApproxTime, pdwPayloadNumberOfStreamWithinPacket) {
        result := ComCall(11, this, "ptr", pvarValue, "ptr", pIndexIdentifier, "uint*", pcbOffsetWithinData, "int64*", phnsApproxTime, "uint*", pdwPayloadNumberOfStreamWithinPacket, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMFSample>} pIASFPacketSample 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<UInt64>} pcbIndexWriteSpace 
     * @returns {HRESULT} 
     */
    GetIndexWriteSpace(pcbIndexWriteSpace) {
        result := ComCall(14, this, "uint*", pcbIndexWriteSpace, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMFMediaBuffer>} pIIndexBuffer 
