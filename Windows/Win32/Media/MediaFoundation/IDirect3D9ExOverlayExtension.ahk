 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3d9exoverlayextension
...
class IDirect3D9ExOverlayExtension extends IUnknown{
     ...
     * @param {Integer} Adapter_ An ordinal number that denotes the display adapter. <b>D3DADAPTER_DEFAULT</b> is always the primary display adapter.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9exoverlayextension-checkdeviceoverlaytype
     */
    CheckDeviceOverlayType(Adapter_, DevType, OverlayWidth, OverlayHeight, OverlayFormat, pDisplayMode, DisplayRotation, pOverlayCaps) {
        result := ComCall(3, this, "uint", Adapter_, "int", DevType, "uint", OverlayWidth, "uint", OverlayHeight, "uint", OverlayFormat, "ptr", pDisplayMode, "int", DisplayRotation, "ptr", pOverlayCaps, "int")
        if(result != 0) {
