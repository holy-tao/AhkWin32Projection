 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nn-mfspatialaudio-imfspatialaudioobjectbuffer
...
class IMFSpatialAudioObjectBuffer extends IMFMediaBuffer{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudioobjectbuffer-setid
     */
    SetID(u32ID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudioobjectbuffer-getid
     */
    GetID() {
        result := ComCall(9, this, "uint*", &pu32ID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudioobjectbuffer-settype
     */
    SetType(type) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudioobjectbuffer-gettype
     */
    GetType() {
        result := ComCall(11, this, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfspatialaudio/nf-mfspatialaudio-imfspatialaudioobjectbuffer-getmetadataitems
     */
    GetMetadataItems() {
        result := ComCall(12, this, "ptr*", &ppMetadataItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
