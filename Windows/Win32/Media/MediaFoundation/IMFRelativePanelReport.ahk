 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfrelativepanelreport
...
class IMFRelativePanelReport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfrelativepanelreport-getrelativepanel
     */
    GetRelativePanel() {
        result := ComCall(3, this, "uint*", &panel := 0, "int")
        if(result != 0) {
