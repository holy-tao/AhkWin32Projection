 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nn-wmcontainer-imfasfsplitter
...
class IMFASFSplitter extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-initialize
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-setflags
     */
    SetFlags(dwFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-getflags
     */
    GetFlags() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-selectstreams
     */
    SelectStreams(pwStreamNumbers, wNumStreams) {
        pwStreamNumbersMarshal := pwStreamNumbers is VarRef ? "ushort*" : "ptr"

        result := ComCall(6, this, pwStreamNumbersMarshal, pwStreamNumbers, "ushort", wNumStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-getselectedstreams
     */
    GetSelectedStreams(pwNumStreams) {
        pwNumStreamsMarshal := pwNumStreams is VarRef ? "ushort*" : "ptr"

        result := ComCall(7, this, "ushort*", &pwStreamNumbers := 0, pwNumStreamsMarshal, pwNumStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-parsedata
     */
    ParseData(pIBuffer, cbBufferOffset, cbLength) {
        result := ComCall(8, this, "ptr", pIBuffer, "uint", cbBufferOffset, "uint", cbLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-getnextsample
     */
    GetNextSample(pdwStatusFlags, pwStreamNumber, ppISample) {
        ...
        result := ComCall(9, this, pdwStatusFlagsMarshal, pdwStatusFlags, pwStreamNumberMarshal, pwStreamNumber, "ptr*", ppISample, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-flush
     */
    Flush() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmcontainer/nf-wmcontainer-imfasfsplitter-getlastsendtime
     */
    GetLastSendTime() {
        result := ComCall(11, this, "uint*", &pdwLastSendTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
