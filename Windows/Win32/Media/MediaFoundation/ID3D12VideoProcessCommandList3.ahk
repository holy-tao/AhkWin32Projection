 ...
 */
export default struct ID3D12VideoProcessCommandList3 extends ID3D12VideoProcessCommandList2 {
    /**
     ...
     * used for ID3D12VideoProcessCommandList3 interfaces
    */
    struct Vtbl extends ID3D12VideoProcessCommandList2.Vtbl {
        Barrier : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D12VideoProcessCommandList3.Vtbl()
        }
