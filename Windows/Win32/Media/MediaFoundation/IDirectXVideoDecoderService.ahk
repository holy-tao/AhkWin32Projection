 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nn-dxva2api-idirectxvideodecoderservice
...
class IDirectXVideoDecoderService extends IDirectXVideoAccelerationService{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideodecoderservice-getdecoderdeviceguids
     */
    GetDecoderDeviceGuids(pCount, pGuids) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pGuidsMarshal := pGuids is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, pCountMarshal, pCount, pGuidsMarshal, pGuids, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideodecoderservice-getdecoderrendertargets
     */
    GetDecoderRenderTargets(Guid, pCount, pFormats) {
        pCountMarshal := pCount is VarRef ? "uint*" : "ptr"
        pFormatsMarshal := pFormats is VarRef ? "ptr*" : "ptr"

        result := ComCall(5, this, "ptr", Guid, pCountMarshal, pCount, pFormatsMarshal, pFormats, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideodecoderservice-getdecoderconfigurations
     */
    GetDecoderConfigurations(Guid, pVideoDesc, pCount, ppConfigs) {
        ...
        result := ComCall(6, this, "ptr", Guid, "ptr", pVideoDesc, "ptr", pReserved, pCountMarshal, pCount, ppConfigsMarshal, ppConfigs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideodecoderservice-createvideodecoder
     */
    CreateVideoDecoder(Guid, pVideoDesc, pConfig, ppDecoderRenderTargets, NumRenderTargets) {
        result := ComCall(7, this, "ptr", Guid, "ptr", pVideoDesc, "ptr", pConfig, "ptr*", ppDecoderRenderTargets, "uint", NumRenderTargets, "ptr*", &ppDecode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
