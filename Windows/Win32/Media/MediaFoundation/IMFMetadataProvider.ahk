 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfmetadataprovider
...
class IMFMetadataProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfmetadataprovider-getmfmetadata
     */
    GetMFMetadata(pPresentationDescriptor, dwStreamIdentifier, dwFlags) {
        result := ComCall(3, this, "ptr", pPresentationDescriptor, "uint", dwStreamIdentifier, "uint", dwFlags, "ptr*", &ppMFMetadata := 0, "int")
        if(result != 0) {
