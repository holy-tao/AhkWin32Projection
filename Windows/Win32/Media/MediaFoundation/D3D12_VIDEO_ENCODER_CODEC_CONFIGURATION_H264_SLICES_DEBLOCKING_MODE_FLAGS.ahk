...
class D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAGS extends Win32BitflagEnum {
    ...
    /**
     * None.
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_0_ALL_LUMA_CHROMA_SLICE_BLOCK_EDGES_ALWAYS_FILTERED
     * @type {Integer (Int32)}
     */
    static FLAG_0_ALL_LUMA_CHROMA_SLICE_BLOCK_EDGES_ALWAYS_FILTERED => 1

    /**
     * *disable_deblocking_filter_idc* value of 1. Deblocking is disabled for all block edges of the slice.
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_1_DISABLE_ALL_SLICE_BLOCK_EDGES
     * @type {Integer (Int32)}
     */
    static FLAG_1_DISABLE_ALL_SLICE_BLOCK_EDGES => 2
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_2_DISABLE_SLICE_BOUNDARIES_BLOCKS
     * @type {Integer (Int32)}
     */
    static FLAG_2_DISABLE_SLICE_BOUNDARIES_BLOCKS => 4
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_3_USE_TWO_STAGE_DEBLOCKING
     * @type {Integer (Int32)}
     */
    static FLAG_3_USE_TWO_STAGE_DEBLOCKING => 8
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_4_DISABLE_CHROMA_BLOCK_EDGES
     * @type {Integer (Int32)}
     */
    static FLAG_4_DISABLE_CHROMA_BLOCK_EDGES => 16
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_5_DISABLE_CHROMA_BLOCK_EDGES_AND_LUMA_BOUNDARIES
     * @type {Integer (Int32)}
     */
    static FLAG_5_DISABLE_CHROMA_BLOCK_EDGES_AND_LUMA_BOUNDARIES => 32
     ...
     * Native name: D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION_H264_SLICES_DEBLOCKING_MODE_FLAG_6_DISABLE_CHROMA_BLOCK_EDGES_AND_USE_LUMA_TWO_STAGE_DEBLOCKING
     * @type {Integer (Int32)}
     */
    static FLAG_6_DISABLE_CHROMA_BLOCK_EDGES_AND_USE_LUMA_TWO_STAGE_DEBLOCKING => 64
}
