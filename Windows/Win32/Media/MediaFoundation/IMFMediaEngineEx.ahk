...
export default struct IMFMediaEngineEx extends IMFMediaEngine {
    ...
    */
    ...
    UpdateVideoStream(pSrc, pDst, pBorderClr) {
        ...
        result := ComCall(47, this, pSrcMarshal, pSrc, pDstMarshal, pDst, pBorderClrMarshal, pBorderClr, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetSourceFromByteStream := CallbackCreate(ObjBindMethod(implObj, "SetSourceFromByteStream"), flags, 3)
        this.vtbl.GetStatistics := CallbackCreate(ObjBindMethod(implObj, "GetStatistics"), flags, 3)
        this.vtbl.UpdateVideoStream := CallbackCreate(ObjBindMethod(implObj, "UpdateVideoStream"), flags, 4)
        this.vtbl.GetBalance := CallbackCreate(ObjBindMethod(implObj, "GetBalance"), flags, 1)
        this.vtbl.SetBalance := CallbackCreate(ObjBindMethod(implObj, "SetBalance"), flags, 2)
        this.vtbl.IsPlaybackRateSupported := CallbackCreate(ObjBindMethod(implObj, "IsPlaybackRateSupported"), flags, 2)
        this.vtbl.FrameStep := CallbackCreate(ObjBindMethod(implObj, "FrameStep"), flags, 2)
        this.vtbl.GetResourceCharacteristics := CallbackCreate(ObjBindMethod(implObj, "GetResourceCharacteristics"), flags, 2)
        ...
        this.vtbl.ApplyStreamSelections := CallbackCreate(ObjBindMethod(implObj, "ApplyStreamSelections"), flags, 1)
        this.vtbl.IsProtected := CallbackCreate(ObjBindMethod(implObj, "IsProtected"), flags, 2)
        this.vtbl.InsertVideoEffect := CallbackCreate(ObjBindMethod(implObj, "InsertVideoEffect"), flags, 3)
        this.vtbl.InsertAudioEffect := CallbackCreate(ObjBindMethod(implObj, "InsertAudioEffect"), flags, 3)
        this.vtbl.RemoveAllEffects := CallbackCreate(ObjBindMethod(implObj, "RemoveAllEffects"), flags, 1)
        this.vtbl.SetTimelineMarkerTimer := CallbackCreate(ObjBindMethod(implObj, "SetTimelineMarkerTimer"), flags, 2)
        this.vtbl.GetTimelineMarkerTimer := CallbackCreate(ObjBindMethod(implObj, "GetTimelineMarkerTimer"), flags, 2)
        this.vtbl.CancelTimelineMarkerTimer := CallbackCreate(ObjBindMethod(implObj, "CancelTimelineMarkerTimer"), flags, 1)
        this.vtbl.IsStereo3D := CallbackCreate(ObjBindMethod(implObj, "IsStereo3D"), flags, 1)
        this.vtbl.GetStereo3DFramePackingMode := CallbackCreate(ObjBindMethod(implObj, "GetStereo3DFramePackingMode"), flags, 2)
        this.vtbl.SetStereo3DFramePackingMode := CallbackCreate(ObjBindMethod(implObj, "SetStereo3DFramePackingMode"), flags, 2)
        this.vtbl.GetStereo3DRenderMode := CallbackCreate(ObjBindMethod(implObj, "GetStereo3DRenderMode"), flags, 2)
        this.vtbl.SetStereo3DRenderMode := CallbackCreate(ObjBindMethod(implObj, "SetStereo3DRenderMode"), flags, 2)
        this.vtbl.EnableWindowlessSwapchainMode := CallbackCreate(ObjBindMethod(implObj, "EnableWindowlessSwapchainMode"), flags, 2)
        this.vtbl.GetVideoSwapchainHandle := CallbackCreate(ObjBindMethod(implObj, "GetVideoSwapchainHandle"), flags, 2)
        this.vtbl.EnableHorizontalMirrorMode := CallbackCreate(ObjBindMethod(implObj, "EnableHorizontalMirrorMode"), flags, 2)
        this.vtbl.GetAudioStreamCategory := CallbackCreate(ObjBindMethod(implObj, "GetAudioStreamCategory"), flags, 2)
        this.vtbl.SetAudioStreamCategory := CallbackCreate(ObjBindMethod(implObj, "SetAudioStreamCategory"), flags, 2)
        this.vtbl.GetAudioEndpointRole := CallbackCreate(ObjBindMethod(implObj, "GetAudioEndpointRole"), flags, 2)
        this.vtbl.SetAudioEndpointRole := CallbackCreate(ObjBindMethod(implObj, "SetAudioEndpointRole"), flags, 2)
        this.vtbl.GetRealTimeMode := CallbackCreate(ObjBindMethod(implObj, "GetRealTimeMode"), flags, 2)
        this.vtbl.SetRealTimeMode := CallbackCreate(ObjBindMethod(implObj, "SetRealTimeMode"), flags, 2)
        this.vtbl.SetCurrentTimeEx := CallbackCreate(ObjBindMethod(implObj, "SetCurrentTimeEx"), flags, 3)
        this.vtbl.EnableTimeUpdateTimer := CallbackCreate(ObjBindMethod(implObj, "EnableTimeUpdateTimer"), flags, 2)
    }
