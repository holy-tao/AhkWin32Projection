 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfcameracontrolnotify
...
class IMFCameraControlNotify extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolnotify-onchange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfcameracontrolnotify-onerror
     */
    OnError(hrStatus) {
