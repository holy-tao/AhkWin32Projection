 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfvideoprocessorcontrol2
...
class IMFVideoProcessorControl2 extends IMFVideoProcessorControl{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideoprocessorcontrol2-setrotationoverride
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideoprocessorcontrol2-enablehardwareeffects
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfvideoprocessorcontrol2-getsupportedhardwareeffects
     */
    GetSupportedHardwareEffects() {
        result := ComCall(11, this, "uint*", &puiSupport := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
