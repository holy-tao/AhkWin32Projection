 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfqualityadviselimits
...
class IMFQualityAdviseLimits extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfqualityadviselimits-getmaximumdropmode
     */
    GetMaximumDropMode() {
        result := ComCall(3, this, "int*", &peDropMode := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfqualityadviselimits-getminimumqualitylevel
     */
    GetMinimumQualityLevel() {
        result := ComCall(4, this, "int*", &peQualityLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
