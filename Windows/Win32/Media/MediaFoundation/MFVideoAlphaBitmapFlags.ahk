...
class MFVideoAlphaBitmapFlags extends Win32Enum {
     ...
     * Native name: MFVideoAlphaBitmap_EntireDDS
     * @type {Integer (Int32)}
     */
    static EntireDDS => 1
     ...
     * Native name: MFVideoAlphaBitmap_SrcColorKey
     * @type {Integer (Int32)}
     */
    static SrcColorKey => 2
     ...
     * Native name: MFVideoAlphaBitmap_SrcRect
     * @type {Integer (Int32)}
     */
    static SrcRect => 4
     ...
     * Native name: MFVideoAlphaBitmap_DestRect
     * @type {Integer (Int32)}
     */
    static DestRect => 8
     ...
     * Native name: MFVideoAlphaBitmap_FilterMode
     * @type {Integer (Int32)}
     */
    static FilterMode => 16
     ...
     * Native name: MFVideoAlphaBitmap_Alpha
     * @type {Integer (Int32)}
     */
    static Alpha => 32
     ...
     * Native name: MFVideoAlphaBitmap_BitMask
     * @type {Integer (Int32)}
     */
    static BitMask => 63
}
