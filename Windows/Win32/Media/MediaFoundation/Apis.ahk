...
#Include .\MFPERIODICCALLBACK.ahk
...
;@region Methods
    ...
    static DXVAHD_CreateDevice(pD3DDevice, pContentDesc, Usage, pPlugin) {
        result := DllCall("dxva2.dll\DXVAHD_CreateDevice", "ptr", pD3DDevice, "ptr", pContentDesc, "int", Usage, "ptr", pPlugin, "ptr*", &ppDevice := 0, "HRESULT")
    ...
    static DXVA2CreateDirect3DDeviceManager9(pResetToken, ppDeviceManager) {
        ...
        result := DllCall("dxva2.dll\DXVA2CreateDirect3DDeviceManager9", pResetTokenMarshal, pResetToken, "ptr*", ppDeviceManager, "HRESULT")
        return result
    }
    ...
    static DXVA2CreateVideoService(pDD, riid) {
        result := DllCall("dxva2.dll\DXVA2CreateVideoService", "ptr", pDD, "ptr", riid, "ptr*", &ppService := 0, "HRESULT")
        return ppService
    }
    ...
    static OPMGetVideoOutputForTarget(pAdapterLuid, VidPnTarget, vos) {
        result := DllCall("dxva2.dll\OPMGetVideoOutputForTarget", "ptr", pAdapterLuid, "uint", VidPnTarget, "int", vos, "ptr*", &ppOPMVideoOutput := 0, "HRESULT")
    ...
    static OPMGetVideoOutputsFromIDirect3DDevice9Object(pDirect3DDevice9, vos, pulNumVideoOutputs, pppOPMVideoOutputArray) {
        ...
        result := DllCall("dxva2.dll\OPMGetVideoOutputsFromIDirect3DDevice9Object", "ptr", pDirect3DDevice9, "int", vos, pulNumVideoOutputsMarshal, pulNumVideoOutputs, pppOPMVideoOutputArrayMarshal, pppOPMVideoOutputArray, "HRESULT")
        return result
    }
    ...
    static MFCreatePMPMediaSession(dwCreationFlags, pConfiguration, ppMediaSession, ppEnablerActivate) {
        result := DllCall("MF.dll\MFCreatePMPMediaSession", "uint", dwCreationFlags, "ptr", pConfiguration, "ptr*", ppMediaSession, "ptr*", ppEnablerActivate, "HRESULT")
        return result
    }
    ...
    static MFGetSupportedSchemes(pPropVarSchemeArray) {
        result := DllCall("MFPlat.dll\MFGetSupportedSchemes", "ptr", pPropVarSchemeArray, "HRESULT")
        return result
    }
    ...
    static MFGetSupportedMimeTypes(pPropVarMimeTypeArray) {
        result := DllCall("MFPlat.dll\MFGetSupportedMimeTypes", "ptr", pPropVarMimeTypeArray, "HRESULT")
        return result
    }
    ...
    static MFCreateTopologyNode(NodeType) {
        result := DllCall("MF.dll\MFCreateTopologyNode", "int", NodeType, "ptr*", &ppNode := 0, "HRESULT")
    ...
    static MFGetTopoNodeCurrentType(pNode, dwStreamIndex, fOutput) {
        result := DllCall("MF.dll\MFGetTopoNodeCurrentType", "ptr", pNode, "uint", dwStreamIndex, "int", fOutput, "ptr*", &ppType := 0, "HRESULT")
    ...
    static MFGetService(punkObject, guidService, riid) {
        result := DllCall("MF.dll\MFGetService", "ptr", punkObject, "ptr", guidService, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
    ...
    static MFCreatePresentationDescriptor(cStreamDescriptors, apStreamDescriptors) {
        result := DllCall("MFPlat.dll\MFCreatePresentationDescriptor", "uint", cStreamDescriptors, "ptr*", apStreamDescriptors, "ptr*", &ppPresentationDescriptor := 0, "HRESULT")
    ...
    static MFCreateStreamDescriptor(dwStreamIdentifier, cMediaTypes, apMediaTypes) {
        result := DllCall("MFPlat.dll\MFCreateStreamDescriptor", "uint", dwStreamIdentifier, "uint", cMediaTypes, "ptr*", apMediaTypes, "ptr*", &ppDescriptor := 0, "HRESULT")
    ...
    static MFCreateVideoRendererActivate(hwndVideo) {
        ...
        result := DllCall("MF.dll\MFCreateVideoRendererActivate", "ptr", hwndVideo, "ptr*", &ppActivate := 0, "HRESULT")
        return IMFActivate(ppActivate)
    }
    ...
    static MFCreateMuxSink(guidOutputSubType, pOutputAttributes, pOutputByteStream) {
        result := DllCall("MF.dll\MFCreateMuxSink", "ptr", guidOutputSubType, "ptr", pOutputAttributes, "ptr", pOutputByteStream, "ptr*", &ppMuxSink := 0, "HRESULT")
    ...
    static MFCreateSequencerSegmentOffset(dwId, hnsOffset, pvarSegmentOffset) {
        result := DllCall("MF.dll\MFCreateSequencerSegmentOffset", "uint", dwId, "int64", hnsOffset, "ptr", pvarSegmentOffset, "HRESULT")
        return result
    }
    ...
    static MFCreateNetSchemePlugin(riid, ppvHandler) {
        ...
        result := DllCall("MF.dll\MFCreateNetSchemePlugin", "ptr", riid, ppvHandlerMarshal, ppvHandler, "HRESULT")
        return result
    }
    ...
    static MFTranscodeGetAudioOutputAvailableTypes(guidSubType, dwMFTFlags, pCodecConfig) {
        result := DllCall("MF.dll\MFTranscodeGetAudioOutputAvailableTypes", "ptr", guidSubType, "uint", dwMFTFlags, "ptr", pCodecConfig, "ptr*", &ppAvailableTypes := 0, "HRESULT")
    ...
    static MFCreateStreamOnMFByteStreamEx(pByteStream, riid) {
        result := DllCall("MFPlat.dll\MFCreateStreamOnMFByteStreamEx", "ptr", pByteStream, "ptr", riid, "ptr*", &ppv := 0, "HRESULT")
        return ppv
    }
    ...
    static MFCreatePropertiesFromMediaType(pMediaType, riid) {
        result := DllCall("MFPlat.dll\MFCreatePropertiesFromMediaType", "ptr", pMediaType, "ptr", riid, "ptr*", &ppv := 0, "HRESULT")
        return ppv
    }
    ...
    static MFCreateContentProtectionDevice(ProtectionSystemId) {
        result := DllCall("MFPlat.dll\MFCreateContentProtectionDevice", "ptr", ProtectionSystemId, "ptr*", &ContentProtectionDevice := 0, "HRESULT")
    ...
    static MFIsContentProtectionDeviceSupported(ProtectionSystemId) {
        result := DllCall("MFPlat.dll\MFIsContentProtectionDeviceSupported", "ptr", ProtectionSystemId, "int*", &isSupported := 0, "HRESULT")
        return isSupported
    }
    ...
    static MFCreateContentDecryptorContext(guidMediaProtectionSystemId, pD3DManager, pContentProtectionDevice) {
        result := DllCall("MFPlat.dll\MFCreateContentDecryptorContext", "ptr", guidMediaProtectionSystemId, "ptr", pD3DManager, "ptr", pContentProtectionDevice, "ptr*", &ppContentDecryptorContext := 0, "HRESULT")
    ...
    static MFCreateSensorProfile(ProfileType, ProfileIndex, Constraints) {
        ...
        result := DllCall("MFSENSORGROUP.dll\MFCreateSensorProfile", "ptr", ProfileType, "uint", ProfileIndex, "ptr", Constraints, "ptr*", &ppProfile := 0, "HRESULT")
    ...
    static MFCreateExtendedCameraIntrinsicModel(distortionModelType) {
        result := DllCall("MFCORE.dll\MFCreateExtendedCameraIntrinsicModel", "int", distortionModelType, "ptr*", &ppExtendedCameraIntrinsicModel := 0, "HRESULT")
    ...
    static MFCreateD3D12SynchronizationObject(pDevice, riid) {
        result := DllCall("MFPlat.dll\MFCreateD3D12SynchronizationObject", "ptr", pDevice, "ptr", riid, "ptr*", &ppvSyncObject := 0, "HRESULT")
    ...
    static MFAllocateWorkQueueEx(WorkQueueType) {
        result := DllCall("MFPlat.dll\MFAllocateWorkQueueEx", "int", WorkQueueType, "uint*", &pdwWorkQueue := 0, "HRESULT")
        return pdwWorkQueue
    }
    ...
    static MFCreateFile(AccessMode, OpenMode, fFlags, pwszFileURL) {
        ...
        result := DllCall("MFPlat.dll\MFCreateFile", "int", AccessMode, "int", OpenMode, "int", fFlags, "ptr", pwszFileURL, "ptr*", &ppIByteStream := 0, "HRESULT")
    ...
    static MFCreateTempFile(AccessMode, OpenMode, fFlags) {
        result := DllCall("MFPlat.dll\MFCreateTempFile", "int", AccessMode, "int", OpenMode, "int", fFlags, "ptr*", &ppIByteStream := 0, "HRESULT")
        return IMFByteStream(ppIByteStream)
    }
    ...
    static MFBeginCreateFile(AccessMode, OpenMode, fFlags, pwszFilePath, pCallback, pState) {
        ...
        result := DllCall("MFPlat.dll\MFBeginCreateFile", "int", AccessMode, "int", OpenMode, "int", fFlags, "ptr", pwszFilePath, "ptr", pCallback, "ptr", pState, "ptr*", &ppCancelCookie := 0, "HRESULT")
    ...
    static MFLockDXGIDeviceManager(pResetToken, ppManager) {
        ...
        result := DllCall("MFPlat.dll\MFLockDXGIDeviceManager", pResetTokenMarshal, pResetToken, "ptr*", ppManager, "HRESULT")
        return result
    }
    ...
    static MFCreateDXSurfaceBuffer(riid, punkSurface, fBottomUpWhenLinear) {
        result := DllCall("MFPlat.dll\MFCreateDXSurfaceBuffer", "ptr", riid, "ptr", punkSurface, "int", fBottomUpWhenLinear, "ptr*", &ppBuffer := 0, "HRESULT")
        return IMFMediaBuffer(ppBuffer)
    }
    ...
    static MFCreateWICBitmapBuffer(riid, punkSurface) {
        result := DllCall("MFPlat.dll\MFCreateWICBitmapBuffer", "ptr", riid, "ptr", punkSurface, "ptr*", &ppBuffer := 0, "HRESULT")
        return IMFMediaBuffer(ppBuffer)
    }
    ...
    static MFCreateDXGISurfaceBuffer(riid, punkSurface, uSubresourceIndex, fBottomUpWhenLinear) {
        result := DllCall("MFPlat.dll\MFCreateDXGISurfaceBuffer", "ptr", riid, "ptr", punkSurface, "uint", uSubresourceIndex, "int", fBottomUpWhenLinear, "ptr*", &ppBuffer := 0, "HRESULT")
        return IMFMediaBuffer(ppBuffer)
    }
    ...
    static MFCreateDXGICrossAdapterBuffer(riid, punkDevice, pMediaType, uSubresource) {
        result := DllCall("MFPlat.DLL\MFCreateDXGICrossAdapterBuffer", "ptr", riid, "ptr", punkDevice, "ptr", pMediaType, "uint", uSubresource, "ptr*", &ppBuffer := 0, "HRESULT")
        return IMFMediaBuffer(ppBuffer)
    }
    ...
    static MFCreateVideoSampleAllocatorEx(riid) {
        result := DllCall("MFPlat.dll\MFCreateVideoSampleAllocatorEx", "ptr", riid, "ptr*", &ppSampleAllocator := 0, "HRESULT")
    ...
    static MFCreateDXGIDeviceManager(resetToken, ppDeviceManager) {
        ...
        result := DllCall("MFPlat.dll\MFCreateDXGIDeviceManager", resetTokenMarshal, resetToken, "ptr*", ppDeviceManager, "HRESULT")
        return result
    }
    ...
    static MFCreateMediaEvent(met, guidExtendedType, hrStatus, pvValue) {
        result := DllCall("MFPlat.dll\MFCreateMediaEvent", "uint", met, "ptr", guidExtendedType, "int", hrStatus, "ptr", pvValue, "ptr*", &ppEvent := 0, "HRESULT")
    ...
    static MFTRegister(clsidMFT, guidCategory, pszName, Flags, cInputTypes, pInputTypes, cOutputTypes, pOutputTypes, pAttributes) {
        ...
        result := DllCall("MFPlat.dll\MFTRegister", "ptr", clsidMFT, "ptr", guidCategory, "ptr", pszName, "uint", Flags, "uint", cInputTypes, "ptr", pInputTypes, "uint", cOutputTypes, "ptr", pOutputTypes, "ptr", pAttributes, "HRESULT")
        return result
    }
    ...
    static MFTUnregister(clsidMFT) {
        result := DllCall("MFPlat.dll\MFTUnregister", "ptr", clsidMFT, "HRESULT")
        return result
    }
    ...
    static MFTRegisterLocal(pClassFactory, guidCategory, pszName, Flags, cInputTypes, pInputTypes, cOutputTypes, pOutputTypes) {
        ...
        result := DllCall("MFPlat.dll\MFTRegisterLocal", "ptr", pClassFactory, "ptr", guidCategory, "ptr", pszName, "uint", Flags, "uint", cInputTypes, "ptr", pInputTypes, "uint", cOutputTypes, "ptr", pOutputTypes, "HRESULT")
        return result
    }
    ...
    static MFTRegisterLocalByCLSID(clisdMFT, guidCategory, pszName, Flags, cInputTypes, pInputTypes, cOutputTypes, pOutputTypes) {
        ...
        result := DllCall("MFPlat.dll\MFTRegisterLocalByCLSID", "ptr", clisdMFT, "ptr", guidCategory, "ptr", pszName, "uint", Flags, "uint", cInputTypes, "ptr", pInputTypes, "uint", cOutputTypes, "ptr", pOutputTypes, "HRESULT")
        return result
    }
    ...
    static MFTUnregisterLocalByCLSID(clsidMFT) {
        result := DllCall("MFPlat.dll\MFTUnregisterLocalByCLSID", "ptr", clsidMFT, "HRESULT")
        return result
    }
    ...
    static MFTEnum(guidCategory, Flags, pInputType, pOutputType, pAttributes, ppclsidMFT, pcMFTs) {
        ...
        result := DllCall("MFPlat.dll\MFTEnum", "ptr", guidCategory, "uint", Flags, "ptr", pInputType, "ptr", pOutputType, "ptr", pAttributes, ppclsidMFTMarshal, ppclsidMFT, pcMFTsMarshal, pcMFTs, "HRESULT")
        return result
    }
    ...
    static MFTEnumEx(guidCategory, Flags, pInputType, pOutputType, pppMFTActivate, pnumMFTActivate) {
        ...
        result := DllCall("MFPlat.dll\MFTEnumEx", "ptr", guidCategory, "uint", Flags, "ptr", pInputType, "ptr", pOutputType, pppMFTActivateMarshal, pppMFTActivate, pnumMFTActivateMarshal, pnumMFTActivate, "HRESULT")
        return result
    }
    ...
    static MFTEnum2(guidCategory, Flags, pInputType, pOutputType, pAttributes, pppMFTActivate, pnumMFTActivate) {
        ...
        result := DllCall("MFPlat.dll\MFTEnum2", "ptr", guidCategory, "uint", Flags, "ptr", pInputType, "ptr", pOutputType, "ptr", pAttributes, pppMFTActivateMarshal, pppMFTActivate, pnumMFTActivateMarshal, pnumMFTActivate, "HRESULT")
        return result
    }
    ...
    static MFTGetInfo(clsidMFT, pszName, ppInputTypes, pcInputTypes, ppOutputTypes, pcOutputTypes, ppAttributes) {
        ...
        result := DllCall("MFPlat.dll\MFTGetInfo", "ptr", clsidMFT, pszNameMarshal, pszName, ppInputTypesMarshal, ppInputTypes, pcInputTypesMarshal, pcInputTypes, ppOutputTypesMarshal, ppOutputTypes, pcOutputTypesMarshal, pcOutputTypes, "ptr*", ppAttributes, "HRESULT")
        return result
    }
    ...
    static MFCreateMediaExtensionActivate(szActivatableClassId, pConfiguration, riid) {
        ...
        result := DllCall("MFPlat.dll\MFCreateMediaExtensionActivate", "ptr", szActivatableClassId, "ptr", pConfiguration, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
    ...
    static MFValidateMediaTypeSize(FormatType, pBlock, cbSize) {
        result := DllCall("MFPlat.dll\MFValidateMediaTypeSize", "ptr", FormatType, "ptr", pBlock, "uint", cbSize, "HRESULT")
        return result
    }
    ...
    static MFInitMediaTypeFromVideoInfoHeader(pMFType, pVIH, cbBufSize, pSubtype) {
        result := DllCall("MFPlat.dll\MFInitMediaTypeFromVideoInfoHeader", "ptr", pMFType, "ptr", pVIH, "uint", cbBufSize, "ptr", pSubtype, "HRESULT")
        return result
    }
    ...
    static MFInitMediaTypeFromVideoInfoHeader2(pMFType, pVIH2, cbBufSize, pSubtype) {
        result := DllCall("MFPlat.dll\MFInitMediaTypeFromVideoInfoHeader2", "ptr", pMFType, "ptr", pVIH2, "uint", cbBufSize, "ptr", pSubtype, "HRESULT")
        return result
    }
    ...
    static MFInitMediaTypeFromMPEG1VideoInfo(pMFType, pMP1VI, cbBufSize, pSubtype) {
        result := DllCall("MFPlat.dll\MFInitMediaTypeFromMPEG1VideoInfo", "ptr", pMFType, "ptr", pMP1VI, "uint", cbBufSize, "ptr", pSubtype, "HRESULT")
        return result
    }
    ...
    static MFInitMediaTypeFromMPEG2VideoInfo(pMFType, pMP2VI, cbBufSize, pSubtype) {
        result := DllCall("MFPlat.dll\MFInitMediaTypeFromMPEG2VideoInfo", "ptr", pMFType, "ptr", pMP2VI, "uint", cbBufSize, "ptr", pSubtype, "HRESULT")
        return result
    }
    ...
    static MFCalculateImageSize(guidSubtype, unWidth, unHeight) {
        result := DllCall("MFPlat.dll\MFCalculateImageSize", "ptr", guidSubtype, "uint", unWidth, "uint", unHeight, "uint*", &pcbImageSize := 0, "HRESULT")
        return pcbImageSize
    }
    ...
    static MFInitMediaTypeFromAMMediaType(pMFType, pAMType) {
        result := DllCall("MFPlat.dll\MFInitMediaTypeFromAMMediaType", "ptr", pMFType, "ptr", pAMType, "HRESULT")
        return result
    }
    ...
    static MFInitAMMediaTypeFromMFMediaType(pMFType, guidFormatBlockType, pAMType) {
        result := DllCall("MFPlat.dll\MFInitAMMediaTypeFromMFMediaType", "ptr", pMFType, "ptr", guidFormatBlockType, "ptr", pAMType, "HRESULT")
        return result
    }
    ...
    static MFCreateAMMediaTypeFromMFMediaType(pMFType, guidFormatBlockType, ppAMType) {
        ...
        result := DllCall("MFPlat.dll\MFCreateAMMediaTypeFromMFMediaType", "ptr", pMFType, "ptr", guidFormatBlockType, ppAMTypeMarshal, ppAMType, "HRESULT")
        return result
    }
    ...
    static MFWrapMediaType(pOrig, MajorType, SubType) {
        result := DllCall("MFPlat.dll\MFWrapMediaType", "ptr", pOrig, "ptr", MajorType, "ptr", SubType, "ptr*", &ppWrap := 0, "HRESULT")
    ...
    static MFCreateVideoMediaType(pVideoFormat) {
        result := DllCall("MFPlat.dll\MFCreateVideoMediaType", "ptr", pVideoFormat, "ptr*", &ppIVideoMediaType := 0, "HRESULT")
    ...
    static MFCreateVideoMediaTypeFromSubtype(pAMSubtype) {
        result := DllCall("MFPlat.dll\MFCreateVideoMediaTypeFromSubtype", "ptr", pAMSubtype, "ptr*", &ppIVideoMediaType := 0, "HRESULT")
        return IMFVideoMediaType(ppIVideoMediaType)
    }
    ...
    static MFCreateVideoMediaTypeFromBitMapInfoHeader(pbmihBitMapInfoHeader, dwPixelAspectRatioX, dwPixelAspectRatioY, InterlaceMode, VideoFlags, qwFramesPerSecondNumerator, qwFramesPerSecondDenominator, dwMaxBitRate) {
        result := DllCall("MFPlat.dll\MFCreateVideoMediaTypeFromBitMapInfoHeader", "ptr", pbmihBitMapInfoHeader, "uint", dwPixelAspectRatioX, "uint", dwPixelAspectRatioY, "int", InterlaceMode, "uint", VideoFlags, "uint", qwFramesPerSecondNumerator, "uint", qwFramesPerSecondDenominator, "uint", dwMaxBitRate, "ptr*", &ppIVideoMediaType := 0, "HRESULT")
        return IMFVideoMediaType(ppIVideoMediaType)
    }
    ...
    static MFCreateMediaTypeFromRepresentation(guidRepresentation, pvRepresentation) {
        ...
        result := DllCall("MFPlat.dll\MFCreateMediaTypeFromRepresentation", "ptr", guidRepresentation, pvRepresentationMarshal, pvRepresentation, "ptr*", &ppIMediaType := 0, "HRESULT")
    ...
    static MFCreateAudioMediaType(pAudioFormat) {
        result := DllCall("MFPlat.dll\MFCreateAudioMediaType", "ptr", pAudioFormat, "ptr*", &ppIAudioMediaType := 0, "HRESULT")
    ...
    static MFInitVideoFormat(pVideoFormat, type) {
        result := DllCall("MFPlat.dll\MFInitVideoFormat", "ptr", pVideoFormat, "int", type, "HRESULT")
        return result
    }
    ...
    static MFInitVideoFormat_RGB(pVideoFormat, dwWidth, dwHeight, D3Dfmt) {
        result := DllCall("MFPlat.dll\MFInitVideoFormat_RGB", "ptr", pVideoFormat, "uint", dwWidth, "uint", dwHeight, "uint", D3Dfmt, "HRESULT")
        return result
    }
    ...
    static MFConvertColorInfoToDXVA(pFromFormat) {
        result := DllCall("MFPlat.dll\MFConvertColorInfoToDXVA", "uint*", &pdwToDXVA := 0, "ptr", pFromFormat, "HRESULT")
        return pdwToDXVA
    }
    ...
    static MFConvertColorInfoFromDXVA(pToFormat, dwFromDXVA) {
        result := DllCall("MFPlat.dll\MFConvertColorInfoFromDXVA", "ptr", pToFormat, "uint", dwFromDXVA, "HRESULT")
        return result
    }
    ...
    static MFCreate2DMediaBuffer(dwWidth, dwHeight, dwFourCC, fBottomUp) {
        result := DllCall("MFPlat.dll\MFCreate2DMediaBuffer", "uint", dwWidth, "uint", dwHeight, "uint", dwFourCC, "int", fBottomUp, "ptr*", &ppBuffer := 0, "HRESULT")
        return IMFMediaBuffer(ppBuffer)
    }
    ...
    static MFGetContentProtectionSystemCLSID(guidProtectionSystemID, pclsid) {
        result := DllCall("MFPlat.dll\MFGetContentProtectionSystemCLSID", "ptr", guidProtectionSystemID, "ptr", pclsid, "HRESULT")
        return result
    }
    ...
    static MFCombineSamples(pSample, pSampleToAdd, dwMaxMergedDurationInMS) {
        result := DllCall("MFPlat.dll\MFCombineSamples", "ptr", pSample, "ptr", pSampleToAdd, "uint", dwMaxMergedDurationInMS, "int*", &pMerged := 0, "HRESULT")
        return pMerged
    }
    ...
    static MFSplitSample(pSample, pOutputSamples, dwOutputSampleMaxCount, pdwOutputSampleCount) {
        ...
        result := DllCall("MFPlat.dll\MFSplitSample", "ptr", pSample, "ptr*", pOutputSamples, "uint", dwOutputSampleMaxCount, pdwOutputSampleCountMarshal, pdwOutputSampleCount, "HRESULT")
        return result
    }
    ...
    static MFCreateVideoPresenter(pOwner, riidDevice, riid) {
        result := DllCall("EVR.dll\MFCreateVideoPresenter", "ptr", pOwner, "ptr", riidDevice, "ptr", riid, "ptr*", &ppVideoPresenter := 0, "HRESULT")
    ...
    static MFCreateVideoMixer(pOwner, riidDevice, riid) {
        result := DllCall("EVR.dll\MFCreateVideoMixer", "ptr", pOwner, "ptr", riidDevice, "ptr", riid, "ptr*", &ppv := 0, "HRESULT")
        return ppv
    }
    ...
    static MFCreateVideoMixerAndPresenter(pMixerOwner, pPresenterOwner, riidMixer, ppvVideoMixer, riidPresenter, ppvVideoPresenter) {
        ...
        result := DllCall("EVR.dll\MFCreateVideoMixerAndPresenter", "ptr", pMixerOwner, "ptr", pPresenterOwner, "ptr", riidMixer, ppvVideoMixerMarshal, ppvVideoMixer, "ptr", riidPresenter, ppvVideoPresenterMarshal, ppvVideoPresenter, "HRESULT")
        return result
    }
    ...
    static MFCreateVideoRenderer(riidRenderer) {
        result := DllCall("MF.dll\MFCreateVideoRenderer", "ptr", riidRenderer, "ptr*", &ppVideoRenderer := 0, "HRESULT")
    ...
    static MFCreateVideoSampleAllocator(riid) {
        result := DllCall("EVR.dll\MFCreateVideoSampleAllocator", "ptr", riid, "ptr*", &ppSampleAllocator := 0, "HRESULT")
        return ppSampleAllocator
    }
    ...
    static MFCreateVirtualCamera(type, lifetime, access, friendlyName, sourceId, categories, categoryCount) {
        ...
        result := DllCall("MFSENSORGROUP.dll\MFCreateVirtualCamera", "int", type, "int", lifetime, "int", access, "ptr", friendlyName, "ptr", sourceId, "ptr", categories, "uint", categoryCount, "ptr*", &virtualCamera := 0, "HRESULT")
    ...
    static MFIsVirtualCameraTypeSupported(type) {
        result := DllCall("MFSENSORGROUP.dll\MFIsVirtualCameraTypeSupported", "int", type, "int*", &supported := 0, "HRESULT")
        return supported
    }
    ...
    static OPMXboxEnableHDCP(HDCPType) {
        result := DllCall("OPMXbox.dll\OPMXboxEnableHDCP", "int", HDCPType, "HRESULT")
        return result
    }
