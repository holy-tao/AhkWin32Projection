 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nn-mftransform-imftransform
...
class IMFTransform extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getstreamlimits
     */
    GetStreamLimits(pdwInputMinimum, pdwInputMaximum, pdwOutputMinimum, pdwOutputMaximum) {
        ...
        result := ComCall(3, this, pdwInputMinimumMarshal, pdwInputMinimum, pdwInputMaximumMarshal, pdwInputMaximum, pdwOutputMinimumMarshal, pdwOutputMinimum, pdwOutputMaximumMarshal, pdwOutputMaximum, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getstreamcount
     */
    GetStreamCount(pcInputStreams, pcOutputStreams) {
        ...
        result := ComCall(4, this, pcInputStreamsMarshal, pcInputStreams, pcOutputStreamsMarshal, pcOutputStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getstreamids
     */
    GetStreamIDs(dwInputIDArraySize, pdwInputIDs, dwOutputIDArraySize, pdwOutputIDs) {
        ...
        result := ComCall(5, this, "uint", dwInputIDArraySize, pdwInputIDsMarshal, pdwInputIDs, "uint", dwOutputIDArraySize, pdwOutputIDsMarshal, pdwOutputIDs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getinputstreaminfo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getoutputstreaminfo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getattributes
     */
    GetAttributes() {
        result := ComCall(8, this, "ptr*", &pAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwInputStreamID Input stream identifier. To get the list of stream identifiers, call <a href="https://docs.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imftransform-getstreamids">IMFTransform::GetStreamIDs</a>.
     * @returns {IMFAttributes} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getinputstreamattributes
     */
    GetInputStreamAttributes(dwInputStreamID) {
        result := ComCall(9, this, "uint", dwInputStreamID, "ptr*", &pAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwOutputStreamID Output stream identifier. To get the list of stream identifiers, call <a href="https://docs.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imftransform-getstreamids">IMFTransform::GetStreamIDs</a>.
     * @returns {IMFAttributes} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes">IMFAttributes</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getoutputstreamattributes
     */
    GetOutputStreamAttributes(dwOutputStreamID) {
        result := ComCall(10, this, "uint", dwOutputStreamID, "ptr*", &pAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-deleteinputstream
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-addinputstreams
     */
    AddInputStreams(cStreams, adwStreamIDs) {
        adwStreamIDsMarshal := adwStreamIDs is VarRef ? "uint*" : "ptr"

        result := ComCall(12, this, "uint", cStreams, adwStreamIDsMarshal, adwStreamIDs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getinputavailabletype
     */
    GetInputAvailableType(dwInputStreamID, dwTypeIndex) {
        result := ComCall(13, this, "uint", dwInputStreamID, "uint", dwTypeIndex, "ptr*", &ppType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getoutputavailabletype
     */
    GetOutputAvailableType(dwOutputStreamID, dwTypeIndex) {
        result := ComCall(14, this, "uint", dwOutputStreamID, "uint", dwTypeIndex, "ptr*", &ppType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-setinputtype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-setoutputtype
     */
     ...
     * @param {Integer} dwInputStreamID Input stream identifier. To get the list of stream identifiers, call <a href="https://docs.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imftransform-getstreamids">IMFTransform::GetStreamIDs</a>.
     * @returns {IMFMediaType} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getinputcurrenttype
     */
    GetInputCurrentType(dwInputStreamID) {
        result := ComCall(17, this, "uint", dwInputStreamID, "ptr*", &ppType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwOutputStreamID Output stream identifier. To get the list of stream identifiers, call <a href="https://docs.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imftransform-getstreamids">IMFTransform::GetStreamIDs</a>.
     * @returns {IMFMediaType} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype">IMFMediaType</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getoutputcurrenttype
     */
    GetOutputCurrentType(dwOutputStreamID) {
        result := ComCall(18, this, "uint", dwOutputStreamID, "ptr*", &ppType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getinputstatus
     */
    GetInputStatus(dwInputStreamID) {
        result := ComCall(19, this, "uint", dwInputStreamID, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-getoutputstatus
     */
    GetOutputStatus() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-setoutputbounds
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-processevent
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-processmessage
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-processinput
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mftransform/nf-mftransform-imftransform-processoutput
     */
    ProcessOutput(dwFlags, cOutputBufferCount, pOutputSamples) {
        result := ComCall(25, this, "uint", dwFlags, "uint", cOutputBufferCount, "ptr", pOutputSamples, "uint*", &pdwStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
