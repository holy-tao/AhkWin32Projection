...
class MF_ATTRIBUTES_MATCH_TYPE extends Win32Enum {
     ...
     * Native name: MF_ATTRIBUTES_MATCH_OUR_ITEMS
     * @type {Integer (Int32)}
     */
    static OUR_ITEMS => 0
     ...
     * Native name: MF_ATTRIBUTES_MATCH_THEIR_ITEMS
     * @type {Integer (Int32)}
     */
    static THEIR_ITEMS => 1

    /**
     * Check whether both objects have identical attributes with the same data.
     * Native name: MF_ATTRIBUTES_MATCH_ALL_ITEMS
     * @type {Integer (Int32)}
     */
    static ALL_ITEMS => 2
     ...
     * Native name: MF_ATTRIBUTES_MATCH_INTERSECTION
     * @type {Integer (Int32)}
     */
     ...
     * Native name: MF_ATTRIBUTES_MATCH_SMALLER
     * @type {Integer (Int32)}
     */
    static SMALLER => 4
}
