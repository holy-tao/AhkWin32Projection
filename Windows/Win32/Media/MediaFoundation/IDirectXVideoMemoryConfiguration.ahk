 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nn-dxva2api-idirectxvideomemoryconfiguration
...
class IDirectXVideoMemoryConfiguration extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideomemoryconfiguration-getavailablesurfacetypebyindex
     */
    GetAvailableSurfaceTypeByIndex(dwTypeIndex) {
        result := ComCall(3, this, "uint", dwTypeIndex, "int*", &pdwType := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxva2api/nf-dxva2api-idirectxvideomemoryconfiguration-setsurfacetype
     */
