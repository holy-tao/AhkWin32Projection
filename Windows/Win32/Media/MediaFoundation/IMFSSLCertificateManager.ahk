 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfsslcertificatemanager
...
class IMFSSLCertificateManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsslcertificatemanager-getclientcertificate
     */
    GetClientCertificate(pszURL, ppbData, pcbData) {
        ...
        result := ComCall(3, this, "ptr", pszURL, ppbDataMarshal, ppbData, pcbDataMarshal, pcbData, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsslcertificatemanager-begingetclientcertificate
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsslcertificatemanager-endgetclientcertificate
     */
    EndGetClientCertificate(pResult, ppbData, pcbData) {
        ppbDataMarshal := ppbData is VarRef ? "ptr*" : "ptr"
        pcbDataMarshal := pcbData is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr", pResult, ppbDataMarshal, ppbData, pcbDataMarshal, pcbData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsslcertificatemanager-getcertificatepolicy
     */
    GetCertificatePolicy(pszURL, pfOverrideAutomaticCheck, pfClientCertificateAvailable) {
        ...
        result := ComCall(6, this, "ptr", pszURL, pfOverrideAutomaticCheckMarshal, pfOverrideAutomaticCheck, pfClientCertificateAvailableMarshal, pfClientCertificateAvailable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfsslcertificatemanager-onservercertificate
     */
    OnServerCertificate(pszURL, pbData, cbData) {
        pszURL := pszURL is String ? StrPtr(pszURL) : pszURL

        result := ComCall(7, this, "ptr", pszURL, "ptr", pbData, "uint", cbData, "int*", &pfIsGood := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
