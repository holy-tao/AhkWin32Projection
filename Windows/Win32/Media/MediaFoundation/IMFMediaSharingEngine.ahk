 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfsharingengine/nn-mfsharingengine-imfmediasharingengine
...
class IMFMediaSharingEngine extends IMFMediaEngine{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfsharingengine/nf-mfsharingengine-imfmediasharingengine-getdevice
     */
    GetDevice() {
        pDevice := DEVICE_INFO()
        result := ComCall(45, this, "ptr", pDevice, "int")
        if(result != 0) {
