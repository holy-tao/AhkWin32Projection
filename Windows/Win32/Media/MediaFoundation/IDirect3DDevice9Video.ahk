 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3ddevice9video
...
class IDirect3DDevice9Video extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9video-getcontentprotectioncaps
     */
     ...
     * @param {Integer} ChannelType_ Specifies the type of channel, as a member of the <a href="https://docs.microsoft.com/windows/desktop/medfound/d3dauthenticatedchanneltype">D3DAUTHENTICATEDCHANNELTYPE</a> enumeration.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9video-createauthenticatedchannel
     */
    CreateAuthenticatedChannel(ChannelType_, pChannelHandle) {
        result := ComCall(4, this, "int", ChannelType_, "ptr*", &ppAuthenticatedChannel := 0, "ptr", pChannelHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9video-createcryptosession
     */
    CreateCryptoSession(pCryptoType, pDecodeProfile, pCryptoHandle) {
        result := ComCall(5, this, "ptr", pCryptoType, "ptr", pDecodeProfile, "ptr*", &ppCryptoSession := 0, "ptr", pCryptoHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
