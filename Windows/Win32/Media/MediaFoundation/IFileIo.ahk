...
class IFileIo extends IUnknown{
    ...
    IsEndOfStream(pbEndOfStream) {
        result := ComCall(8, this, "ptr", pbEndOfStream, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Byte>} pbt 
     * @param {Integer} ul 
     * @param {Pointer<UInt32>} pulRead 
     * @returns {HRESULT} 
     */
    Read(pbt, ul, pulRead) {
        result := ComCall(9, this, "char*", pbt, "uint", ul, "uint*", pulRead, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Byte>} pbt 
     * @param {Integer} ul 
     * @param {Pointer<UInt32>} pulWritten 
     * @returns {HRESULT} 
     */
    Write(pbt, ul, pulWritten) {
        result := ComCall(10, this, "char*", pbt, "uint", ul, "uint*", pulWritten, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Seek(eSeekOrigin, qwSeekOffset, dwSeekFlags, pqwCurrentPosition) {
        result := ComCall(11, this, "int", eSeekOrigin, "uint", qwSeekOffset, "uint", dwSeekFlags, "uint*", pqwCurrentPosition, "int")
        if(result != 0)
            throw OSError(result)
