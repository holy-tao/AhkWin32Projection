 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-ievrtrustedvideoplugin
...
class IEVRTrustedVideoPlugin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrtrustedvideoplugin-isintrustedvideomode
     */
    IsInTrustedVideoMode() {
        result := ComCall(3, this, "int*", &pYes := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrtrustedvideoplugin-canconstrict
     */
    CanConstrict() {
        result := ComCall(4, this, "int*", &pYes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrtrustedvideoplugin-setconstriction
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-ievrtrustedvideoplugin-disableimageexport
     */
