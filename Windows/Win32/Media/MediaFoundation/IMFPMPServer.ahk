 ...
 */
export default struct IMFPMPServer extends IUnknown {
    /**
     ...
     * used for IMFPMPServer interfaces
    */
    ...
    CreateObjectByCLSID(clsid, riid) {
        result := ComCall(5, this, Guid.Ptr, clsid, Guid.Ptr, riid, "ptr*", &ppObject := 0, "HRESULT")
        return ppObject
    }
