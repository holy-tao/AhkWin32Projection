 ...
 */
export default struct IDirect3DAuthenticatedChannel9 extends IUnknown {
    /**
     ...
     * used for IDirect3DAuthenticatedChannel9 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirect3DAuthenticatedChannel9.Vtbl()
        }
    ...
    Query(iid) {
        if (IDirect3DAuthenticatedChannel9.IID.Equals(iid)) {
            return true
        }
