 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfstreamdescriptor
...
class IMFStreamDescriptor extends IMFAttributes{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamdescriptor-getstreamidentifier
     */
    GetStreamIdentifier() {
        result := ComCall(33, this, "uint*", &pdwStreamIdentifier := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamdescriptor-getmediatypehandler
     */
    GetMediaTypeHandler() {
        result := ComCall(34, this, "ptr*", &ppMediaTypeHandler := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
