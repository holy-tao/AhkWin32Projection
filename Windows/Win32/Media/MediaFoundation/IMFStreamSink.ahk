 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imfstreamsink
...
class IMFStreamSink extends IMFMediaEventGenerator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-getmediasink
     */
    GetMediaSink() {
        result := ComCall(7, this, "ptr*", &ppMediaSink := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-getidentifier
     */
    GetIdentifier() {
        result := ComCall(8, this, "uint*", &pdwIdentifier := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-getmediatypehandler
     */
    GetMediaTypeHandler() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-processsample
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-placemarker
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imfstreamsink-flush
     */
    Flush() {
