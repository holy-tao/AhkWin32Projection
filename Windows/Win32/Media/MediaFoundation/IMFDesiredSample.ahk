 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/evr/nn-evr-imfdesiredsample
...
class IMFDesiredSample extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfdesiredsample-getdesiredsampletimeandduration
     */
    GetDesiredSampleTimeAndDuration(phnsSampleTime, phnsSampleDuration) {
        ...
        result := ComCall(3, this, phnsSampleTimeMarshal, phnsSampleTime, phnsSampleDurationMarshal, phnsSampleDuration, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfdesiredsample-setdesiredsampletimeandduration
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/evr/nf-evr-imfdesiredsample-clear
     */
    Clear() {
        ComCall(5, this)
    }
