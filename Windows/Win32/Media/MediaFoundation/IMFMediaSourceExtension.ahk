 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nn-mfmediaengine-imfmediasourceextension
...
class IMFMediaSourceExtension extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-getsourcebuffers
     */
    GetSourceBuffers() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-getactivesourcebuffers
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-getreadystate
     */
    GetReadyState() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-getduration
     */
    GetDuration() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-setduration
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-addsourcebuffer
     */
    AddSourceBuffer(type, pNotify) {
        ...
        result := ComCall(8, this, "ptr", type, "ptr", pNotify, "ptr*", &ppSourceBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-removesourcebuffer
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-setendofstream
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-istypesupported
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfmediaengine/nf-mfmediaengine-imfmediasourceextension-getsourcebuffer
     */
