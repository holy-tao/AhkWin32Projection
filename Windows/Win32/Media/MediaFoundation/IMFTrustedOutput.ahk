 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nn-mfidl-imftrustedoutput
...
class IMFTrustedOutput extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftrustedoutput-getoutputtrustauthoritycount
     */
    GetOutputTrustAuthorityCount() {
        result := ComCall(3, this, "uint*", &pcOutputTrustAuthorities := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftrustedoutput-getoutputtrustauthoritybyindex
     */
    GetOutputTrustAuthorityByIndex(dwIndex) {
        result := ComCall(4, this, "uint", dwIndex, "ptr*", &ppauthority := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mfidl/nf-mfidl-imftrustedoutput-isfinal
     */
    IsFinal() {
        result := ComCall(5, this, "int*", &pfIsFinal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
