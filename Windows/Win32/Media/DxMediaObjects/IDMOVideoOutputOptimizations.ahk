 ...
 */
export default struct IDMOVideoOutputOptimizations extends IUnknown {
    /**
     ...
     * used for IDMOVideoOutputOptimizations interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        QueryOperationModePreferences : IntPtr
        SetOperationMode              : IntPtr
        GetCurrentOperationMode       : IntPtr
        GetCurrentSampleRequirements  : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDMOVideoOutputOptimizations.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.QueryOperationModePreferences)
        CallbackFree(this.vtbl.SetOperationMode)
        CallbackFree(this.vtbl.GetCurrentOperationMode)
        CallbackFree(this.vtbl.GetCurrentSampleRequirements)
    }
}
