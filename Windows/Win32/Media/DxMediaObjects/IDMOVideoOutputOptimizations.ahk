...
class IDMOVideoOutputOptimizations extends IUnknown{
     ...
     * @param {Pointer<UInt32>} pdwRequestedCapabilities 
     * @returns {HRESULT} 
     */
    QueryOperationModePreferences(ulOutputStreamIndex, pdwRequestedCapabilities) {
        result := ComCall(3, this, "uint", ulOutputStreamIndex, "uint*", pdwRequestedCapabilities, "int")
        if(result != 0)
     ...
     * 
     * @param {Integer} ulOutputStreamIndex 
     * @param {Pointer<UInt32>} pdwEnabledFeatures 
     * @returns {HRESULT} 
     */
    GetCurrentOperationMode(ulOutputStreamIndex, pdwEnabledFeatures) {
        result := ComCall(5, this, "uint", ulOutputStreamIndex, "uint*", pdwEnabledFeatures, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Integer} ulOutputStreamIndex 
     * @param {Pointer<UInt32>} pdwRequestedFeatures 
     * @returns {HRESULT} 
     */
    GetCurrentSampleRequirements(ulOutputStreamIndex, pdwRequestedFeatures) {
        result := ComCall(6, this, "uint", ulOutputStreamIndex, "uint*", pdwRequestedFeatures, "int")
        if(result != 0)
            throw OSError(result)
