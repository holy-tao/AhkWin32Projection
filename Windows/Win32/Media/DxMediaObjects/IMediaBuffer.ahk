 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nn-mediaobj-imediabuffer
...
class IMediaBuffer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediabuffer-setlength
     */
    SetLength(cbLength) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediabuffer-getmaxlength
     */
    GetMaxLength() {
        result := ComCall(4, this, "uint*", &pcbMaxLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediabuffer-getbufferandlength
     */
    GetBufferAndLength(ppBuffer, pcbLength) {
        ...
        result := ComCall(5, this, ppBufferMarshal, ppBuffer, pcbLengthMarshal, pcbLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
