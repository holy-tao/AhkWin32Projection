 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nn-mediaobj-idmoqualitycontrol
...
class IDMOQualityControl extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-idmoqualitycontrol-setnow
     */
    SetNow(rtNow) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-idmoqualitycontrol-setstatus
     */
    SetStatus(dwFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-idmoqualitycontrol-getstatus
     */
    GetStatus() {
