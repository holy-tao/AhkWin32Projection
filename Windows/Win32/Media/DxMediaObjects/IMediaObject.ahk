 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nn-mediaobj-imediaobject
...
class IMediaObject extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getstreamcount
     */
    GetStreamCount(pcInputStreams, pcOutputStreams) {
        ...
        result := ComCall(3, this, pcInputStreamsMarshal, pcInputStreams, pcOutputStreamsMarshal, pcOutputStreams, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputstreaminfo
     */
    GetInputStreamInfo(dwInputStreamIndex) {
        result := ComCall(4, this, "uint", dwInputStreamIndex, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getoutputstreaminfo
     */
    GetOutputStreamInfo(dwOutputStreamIndex) {
        result := ComCall(5, this, "uint", dwOutputStreamIndex, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputtype
     */
     ...
     * @param {Integer} dwTypeIndex Zero-based index on the set of acceptable media types.
     * @returns {DMO_MEDIA_TYPE} Pointer to a <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mediaobj/ns-mediaobj-dmo_media_type">DMO_MEDIA_TYPE</a> structure allocated by the caller, or <b>NULL</b>. If this parameter is non-<b>NULL</b>, the method fills the structure with the media type. You can use the value <b>NULL</b> to test whether the type index is in range, by checking the return code.
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getoutputtype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-setinputtype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-setoutputtype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputcurrenttype
     */
     ...
     * @param {Integer} dwOutputStreamIndex Zero-based index of an output stream on the DMO.
     * @returns {DMO_MEDIA_TYPE} Pointer to a <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/mediaobj/ns-mediaobj-dmo_media_type">DMO_MEDIA_TYPE</a> structure allocated by the caller. The method fills the structure with the media type.
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getoutputcurrenttype
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputsizeinfo
     */
    GetInputSizeInfo(dwInputStreamIndex, pcbSize, pcbMaxLookahead, pcbAlignment) {
        ...
        result := ComCall(12, this, "uint", dwInputStreamIndex, pcbSizeMarshal, pcbSize, pcbMaxLookaheadMarshal, pcbMaxLookahead, pcbAlignmentMarshal, pcbAlignment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getoutputsizeinfo
     */
    GetOutputSizeInfo(dwOutputStreamIndex, pcbSize, pcbAlignment) {
        pcbSizeMarshal := pcbSize is VarRef ? "uint*" : "ptr"
        pcbAlignmentMarshal := pcbAlignment is VarRef ? "uint*" : "ptr"

        result := ComCall(13, this, "uint", dwOutputStreamIndex, pcbSizeMarshal, pcbSize, pcbAlignmentMarshal, pcbAlignment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputmaxlatency
     */
    GetInputMaxLatency(dwInputStreamIndex) {
        result := ComCall(14, this, "uint", dwInputStreamIndex, "int64*", &prtMaxLatency := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-setinputmaxlatency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-flush
     */
    Flush() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-discontinuity
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. Otherwise, returns an <b>HRESULT</b> value indicating the cause of the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-allocatestreamingresources
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful. Otherwise, returns an <b>HRESULT</b> value indicating the cause of the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-freestreamingresources
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-getinputstatus
     */
    GetInputStatus(dwInputStreamIndex) {
        result := ComCall(20, this, "uint", dwInputStreamIndex, "uint*", &dwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-processinput
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-processoutput
     */
    ProcessOutput(dwFlags, cOutputBufferCount, pOutputBuffers, pdwStatus) {
        pdwStatusMarshal := pdwStatus is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, "uint", dwFlags, "uint", cOutputBufferCount, "ptr", pOutputBuffers, pdwStatusMarshal, pdwStatus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mediaobj/nf-mediaobj-imediaobject-lock
     */
    Lock(bLock) {
