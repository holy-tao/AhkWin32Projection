 ...
 */
export DMOUnregister(clsidDMO, guidCategory) {
    result := DllCall("msdmo.dll\DMOUnregister", Guid.Ptr, clsidDMO, Guid.Ptr, guidCategory, "HRESULT")
    return result
}
 ...
 */
export DMOGetName(clsidDMO, szName) {
    szName := szName is String ? StrPtr(szName) : szName

    result := DllCall("msdmo.dll\DMOGetName", Guid.Ptr, clsidDMO, "ptr", szName, "HRESULT")
    return result
}
 ...
 */
export MoFreeMediaType(pmt) {
    result := DllCall("msdmo.dll\MoFreeMediaType", DMO_MEDIA_TYPE.Ptr, pmt, "HRESULT")
    return result
}
 ...
 */
export MoCopyMediaType(pmtDest, pmtSrc) {
    result := DllCall("msdmo.dll\MoCopyMediaType", DMO_MEDIA_TYPE.Ptr, pmtDest, DMO_MEDIA_TYPE.Ptr, pmtSrc, "HRESULT")
    return result
}
 ...
 */
export MoDeleteMediaType(pmt) {
    result := DllCall("msdmo.dll\MoDeleteMediaType", DMO_MEDIA_TYPE.Ptr, pmt, "HRESULT")
    return result
}
