 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nn-dmusics-idirectmusicsynthsink
...
class IDirectMusicSynthSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-init
     */
    Init(pSynth) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-setmasterclock
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-getlatencyclock
     */
    GetLatencyClock() {
        result := ComCall(5, this, "ptr*", &ppClock := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-activate
     */
    Activate(fEnable) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-sampletoreftime
     */
    SampleToRefTime(llSampleTime, prfTime) {
        prfTimeMarshal := prfTime is VarRef ? "int64*" : "ptr"

        result := ComCall(7, this, "int64", llSampleTime, prfTimeMarshal, prfTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-reftimetosample
     */
    RefTimeToSample(rfTime, pllSampleTime) {
        pllSampleTimeMarshal := pllSampleTime is VarRef ? "int64*" : "ptr"

        result := ComCall(8, this, "int64", rfTime, pllSampleTimeMarshal, pllSampleTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-setdirectsound
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynthsink-getdesiredbuffersize
     */
    GetDesiredBufferSize(pdwBufferSizeInSamples) {
        pdwBufferSizeInSamplesMarshal := pdwBufferSizeInSamples is VarRef ? "uint*" : "ptr"

        result := ComCall(10, this, pdwBufferSizeInSamplesMarshal, pdwBufferSizeInSamples, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
