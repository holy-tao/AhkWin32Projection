...
class IDirectMusicPort extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IDirectMusicBuffer>} pBuffer 
     * @returns {HRESULT} 
     */
    PlayBuffer(pBuffer) {
    ...
    /**
     * 
     * @param {Pointer<IDirectMusicInstrument>} pInstrument 
    ...
    DownloadInstrument(pInstrument, ppDownloadedInstrument, pNoteRanges, dwNumNoteRanges) {
        result := ComCall(6, this, "ptr", pInstrument, "ptr", ppDownloadedInstrument, "ptr", pNoteRanges, "uint", dwNumNoteRanges, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IDirectMusicDownloadedInstrument>} pDownloadedInstrument 
     * @returns {HRESULT} 
     */
    ...
    GetLatencyClock(ppClock) {
        result := ComCall(8, this, "ptr", ppClock, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DeviceIoControl(dwIoControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpOverlapped) {
        result := ComCall(12, this, "uint", dwIoControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, "uint*", lpBytesReturned, "ptr", lpOverlapped, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pdwChannelGroups 
     * @returns {HRESULT} 
     */
    GetNumChannelGroups(pdwChannelGroups) {
        result := ComCall(14, this, "uint*", pdwChannelGroups, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFormat(pWaveFormatEx, pdwWaveFormatExSize, pdwBufferSize) {
        result := ComCall(19, this, "ptr", pWaveFormatEx, "uint*", pdwWaveFormatExSize, "uint*", pdwBufferSize, "int")
        if(result != 0)
            throw OSError(result)
