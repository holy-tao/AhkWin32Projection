 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nn-dmusics-idirectmusicsynth8
...
class IDirectMusicSynth8 extends IDirectMusicSynth{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth8-playvoice
     */
     ...
     * @param {Integer} dwVoiceId 
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth8-stopvoice
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth8-getvoicestate
     */
    GetVoiceState(dwVoice, cbVoice, dwVoiceState) {
        dwVoiceMarshal := dwVoice is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, dwVoiceMarshal, dwVoice, "uint", cbVoice, "ptr", dwVoiceState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth8-refresh
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth8-assignchanneltobuses
     */
    AssignChannelToBuses(dwChannelGroup, dwChannel, pdwBuses, cBuses) {
        pdwBusesMarshal := pdwBuses is VarRef ? "uint*" : "ptr"

        result := ComCall(24, this, "uint", dwChannelGroup, "uint", dwChannel, pdwBusesMarshal, pdwBuses, "uint", cBuses, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
