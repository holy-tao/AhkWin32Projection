...
class IDirectMusicSynth extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-open
     */
    Open(pPortParams) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-close
     */
    Close() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-setnumchannelgroups
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-download
     */
    Download(phDownload, pvData, pbFree) {
        pvDataMarshal := pvData is VarRef ? "ptr" : "ptr"
        pbFreeMarshal := pbFree is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, "ptr", phDownload, pvDataMarshal, pvData, pbFreeMarshal, pbFree, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-unload
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-playbuffer
     */
    PlayBuffer(rt, pbBuffer, cbBuffer) {
        pbBufferMarshal := pbBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(8, this, "int64", rt, pbBufferMarshal, pbBuffer, "uint", cbBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getrunningstats
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getportcaps
     */
    GetPortCaps(pCaps) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-setmasterclock
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getlatencyclock
     */
    GetLatencyClock() {
        result := ComCall(12, this, "ptr*", &ppClock := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-activate
     */
    Activate(fEnable) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-setsynthsink
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-render
     */
    Render(pBuffer, dwLength, llPosition) {
        pBufferMarshal := pBuffer is VarRef ? "short*" : "ptr"

        result := ComCall(15, this, pBufferMarshal, pBuffer, "uint", dwLength, "int64", llPosition, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-setchannelpriority
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getchannelpriority
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getformat
     */
    GetFormat(pWaveFormatEx, pdwWaveFormatExSize) {
        pdwWaveFormatExSizeMarshal := pdwWaveFormatExSize is VarRef ? "uint*" : "ptr"

        result := ComCall(18, this, "ptr", pWaveFormatEx, pdwWaveFormatExSizeMarshal, pdwWaveFormatExSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dmusics/nf-dmusics-idirectmusicsynth-getappend
     */
    GetAppend(pdwAppend) {
        pdwAppendMarshal := pdwAppend is VarRef ? "uint*" : "ptr"

        result := ComCall(19, this, pdwAppendMarshal, pdwAppend, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
