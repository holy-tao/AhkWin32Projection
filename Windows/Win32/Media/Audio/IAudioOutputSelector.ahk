 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-iaudiooutputselector
...
class IAudioOutputSelector extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiooutputselector-getselection
     */
    GetSelection() {
        result := ComCall(3, this, "uint*", &pnIdSelected := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiooutputselector-setselection
     */
