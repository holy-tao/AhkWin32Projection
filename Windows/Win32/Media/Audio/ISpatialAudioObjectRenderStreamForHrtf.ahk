 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiohrtf/nn-spatialaudiohrtf-ispatialaudioobjectrenderstreamforhrtf
...
class ISpatialAudioObjectRenderStreamForHrtf extends ISpatialAudioObjectRenderStreamBase{
     ...
     * @returns {Pointer<ISpatialAudioObjectForHrtf>} Receives a pointer to the activated interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiohrtf/nf-spatialaudiohrtf-ispatialaudioobjectrenderstreamforhrtf-activatespatialaudioobjectforhrtf
     */
