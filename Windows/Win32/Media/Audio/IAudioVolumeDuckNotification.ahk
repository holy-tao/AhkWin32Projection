 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nn-audiopolicy-iaudiovolumeducknotification
...
class IAudioVolumeDuckNotification extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiovolumeducknotification-onvolumeducknotification
     */
    OnVolumeDuckNotification(sessionID, countCommunicationSessions) {
        sessionID := sessionID is String ? StrPtr(sessionID) : sessionID

        result := ComCall(3, this, "ptr", sessionID, "uint", countCommunicationSessions, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiovolumeducknotification-onvolumeunducknotification
     */
    OnVolumeUnduckNotification(sessionID) {
        sessionID := sessionID is String ? StrPtr(sessionID) : sessionID

        result := ComCall(4, this, "ptr", sessionID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
