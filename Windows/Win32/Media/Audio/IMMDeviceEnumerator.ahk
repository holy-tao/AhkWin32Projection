 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nn-mmdeviceapi-immdeviceenumerator
...
class IMMDeviceEnumerator extends IUnknown{
     ...
     * @param {Integer} dataFlow_ The data-flow direction for the endpoint devices in the collection. The caller should set this parameter to one of the following <a href="https://docs.microsoft.com/windows/win32/api/mmdeviceapi/ne-mmdeviceapi-edataflow">EDataFlow</a> enumeration values:
     * 
     * eRender
     * 
     * eCapture
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-immdeviceenumerator-enumaudioendpoints
     */
    EnumAudioEndpoints(dataFlow_, dwStateMask) {
        result := ComCall(3, this, "int", dataFlow_, "uint", dwStateMask, "ptr*", &ppDevices := 0, "int")
        if(result != 0) {
     ...
     * </li>
     * </ul>
     * @param {Integer} dataFlow_ The data-flow direction for the endpoint device. The caller should set this parameter to one of the following two <a href="https://docs.microsoft.com/windows/win32/api/mmdeviceapi/ne-mmdeviceapi-edataflow">EDataFlow</a> enumeration values:
     * 
     * eRender
     * 
     * eCapture
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-immdeviceenumerator-getdefaultaudioendpoint
     */
    GetDefaultAudioEndpoint(dataFlow_, role) {
        result := ComCall(4, this, "int", dataFlow_, "int", role, "ptr*", &ppEndpoint := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-immdeviceenumerator-getdevice
     */
    GetDevice(pwstrId) {
        pwstrId := pwstrId is String ? StrPtr(pwstrId) : pwstrId

        result := ComCall(5, this, "ptr", pwstrId, "ptr*", &ppDevice := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-immdeviceenumerator-registerendpointnotificationcallback
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-immdeviceenumerator-unregisterendpointnotificationcallback
     */
