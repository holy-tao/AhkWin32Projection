 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-ipartslist
...
class IPartsList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipartslist-getcount
     */
    GetCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipartslist-getpart
     */
    GetPart(nIndex) {
        result := ComCall(4, this, "uint", nIndex, "ptr*", &ppPart := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
