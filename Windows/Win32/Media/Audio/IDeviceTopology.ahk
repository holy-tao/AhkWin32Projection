 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-idevicetopology
...
class IDeviceTopology extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getconnectorcount
     */
    GetConnectorCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getconnector
     */
    GetConnector(nIndex) {
        result := ComCall(4, this, "uint", nIndex, "ptr*", &ppConnector := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getsubunitcount
     */
    GetSubunitCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getsubunit
     */
    GetSubunit(nIndex) {
        result := ComCall(6, this, "uint", nIndex, "ptr*", &ppSubunit := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getpartbyid
     */
    GetPartById(nId) {
        result := ComCall(7, this, "uint", nId, "ptr*", &ppPart := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getdeviceid
     */
    GetDeviceId() {
        result := ComCall(8, this, "ptr*", &ppwstrDeviceId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-idevicetopology-getsignalpath
     */
    GetSignalPath(pIPartFrom, pIPartTo, bRejectMixedPaths) {
        result := ComCall(9, this, "ptr", pIPartFrom, "ptr", pIPartTo, "int", bRejectMixedPaths, "ptr*", &ppParts := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
