...
class IAudioSessionManager2 extends IAudioSessionManager{
    ...
    GetSessionEnumerator(SessionEnum) {
        result := ComCall(5, this, "ptr", SessionEnum, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<IAudioSessionNotification>} SessionNotification 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<IAudioVolumeDuckNotification>} duckNotification 
     * @returns {HRESULT} 
     */
