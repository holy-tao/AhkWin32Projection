 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nn-mmdeviceapi-iaudiosystemeffectspropertystore
...
class IAudioSystemEffectsPropertyStore extends IUnknown{
     ...
     * @returns {Pointer<IPropertyStore>} Receives a pointer to an [IPropertyStore](../propsys/nn-propsys-ipropertystore.md) representing the default property store.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-opendefaultpropertystore
     */
    OpenDefaultPropertyStore(stgmAccess) {
        result := ComCall(3, this, "uint", stgmAccess, "ptr*", &propStore := 0, "int")
        if(result != 0) {
     ...
     * 
     * The method permits a client running as an administrator to open a store for read-only, write-only, or read/write access. A client that is not running as an administrator is restricted to read-only access.
     * @returns {Pointer<IPropertyStore>} Receives a pointer to an [IPropertyStore](../propsys/nn-propsys-ipropertystore.md) representing the user property store.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-openuserpropertystore
     */
    OpenUserPropertyStore(stgmAccess) {
        result := ComCall(4, this, "uint", stgmAccess, "ptr*", &propStore := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The method permits a client running as an administrator to open a store for read-only, write-only, or read/write access. A client that is not running as an administrator is restricted to read-only access.
     * @returns {Pointer<IPropertyStore>} Receives a pointer to an [IPropertyStore](../propsys/nn-propsys-ipropertystore.md) representing the volatile property store.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-openvolatilepropertystore
     */
    OpenVolatilePropertyStore(stgmAccess) {
        result := ComCall(5, this, "uint", stgmAccess, "ptr*", &propStore := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-resetuserpropertystore
     */
     ...
     * For more information on the Windows 11 APIs for the Audio Processing Objects (APOs) that can ship with audio drivers, see [Windows 11 APIs for Audio Processing Objects](/windows-hardware/drivers/audio/windows-11-apis-for-audio-processing-objects).
     * @returns {HRESULT} S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-resetvolatilepropertystore
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-registerpropertychangenotification
     */
     ...
     * @returns {HRESULT} Returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmdeviceapi/nf-mmdeviceapi-iaudiosystemeffectspropertystore-unregisterpropertychangenotification
     */
