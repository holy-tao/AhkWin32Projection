 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nn-spatialaudiometadata-ispatialaudiometadataitemsbuffer
...
class ISpatialAudioMetadataItemsBuffer extends IUnknown{
     ...
     * @param {Pointer} buffer_ A pointer to memory to use for storage.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataitemsbuffer-attachtobuffer
     */
    AttachToBuffer(buffer_, bufferLength) {
        result := ComCall(3, this, "ptr", buffer_, "uint", bufferLength, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataitemsbuffer-attachtopopulatedbuffer
     */
    AttachToPopulatedBuffer(buffer_, bufferLength) {
        result := ComCall(4, this, "ptr", buffer_, "uint", bufferLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataitemsbuffer-detachbuffer
     */
    DetachBuffer() {
