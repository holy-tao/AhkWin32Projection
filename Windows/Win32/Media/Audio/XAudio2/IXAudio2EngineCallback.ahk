 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nn-xaudio2-ixaudio2enginecallback
...
class IXAudio2EngineCallback extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2enginecallback-onprocessingpassstart
     */
     ...
     * Windows 10 (XAudio2.9); Windows 8, Windows Phone 8 (XAudio 2.8); DirectX SDK (XAudio 2.7)
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2enginecallback-onprocessingpassend
     */
    OnProcessingPassEnd() {
        ComCall(1, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2enginecallback-oncriticalerror
     */
