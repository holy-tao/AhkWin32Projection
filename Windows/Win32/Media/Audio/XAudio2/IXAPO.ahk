 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nn-xapo-ixapo
...
class IXAPO extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-getregistrationproperties
     */
    GetRegistrationProperties() {
        result := ComCall(3, this, "ptr*", &ppRegistrationProperties := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-isinputformatsupported
     */
    IsInputFormatSupported(pOutputFormat, pRequestedInputFormat) {
        result := ComCall(4, this, "ptr", pOutputFormat, "ptr", pRequestedInputFormat, "ptr*", &ppSupportedInputFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-isoutputformatsupported
     */
    IsOutputFormatSupported(pInputFormat, pRequestedOutputFormat) {
        result := ComCall(5, this, "ptr", pInputFormat, "ptr", pRequestedOutputFormat, "ptr*", &ppSupportedOutputFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-reset
     */
    Reset() {
        ComCall(7, this)
    }
     ...
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-lockforprocess
     */
     ...
     * Windows 10 (XAudio2.9); Windows 8, Windows Phone 8 (XAudio 2.8); DirectX SDK (XAudio 2.7)
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-unlockforprocess
     */
    UnlockForProcess() {
        ComCall(9, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-process
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-calcinputframes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xapo/nf-xapo-ixapo-calcoutputframes
     */
