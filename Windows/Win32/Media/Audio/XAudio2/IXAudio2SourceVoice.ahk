 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nn-xaudio2-ixaudio2sourcevoice
...
class IXAudio2SourceVoice extends IXAudio2Voice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-start
     */
     ...
     * @param {Integer} OperationSet Identifies this call as part of a deferred batch. See the <a href="https://docs.microsoft.com/windows/desktop/xaudio2/xaudio2-operation-sets">XAudio2 Operation Sets</a> overview for more information.
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise. See <a href="https://docs.microsoft.com/windows/desktop/xaudio2/xaudio2-error-codes">XAudio2 Error Codes</a> for descriptions of XAudio2 specific error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-stop
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise. See <a href="https://docs.microsoft.com/windows/desktop/xaudio2/xaudio2-error-codes">XAudio2 Error Codes</a> for descriptions of XAudio2 specific error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-submitsourcebuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-flushsourcebuffers
     */
    FlushSourceBuffers() {
     ...
     * Windows 10 (XAudio2.9); Windows 8, Windows Phone 8 (XAudio 2.8); DirectX SDK (XAudio 2.7)
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-discontinuity
     */
    Discontinuity() {
     ...
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise. See <a href="https://docs.microsoft.com/windows/desktop/xaudio2/xaudio2-error-codes">XAudio2 Error Codes</a> for descriptions of XAudio2 specific error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-exitloop
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-getstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-setfrequencyratio
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-getfrequencyratio
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful, an error code otherwise. See <a href="https://docs.microsoft.com/windows/desktop/xaudio2/xaudio2-error-codes">XAudio2 Error Codes</a> for descriptions of error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2sourcevoice-setsourcesamplerate
     */
