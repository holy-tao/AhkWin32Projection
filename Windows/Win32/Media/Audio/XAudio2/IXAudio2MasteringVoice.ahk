 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nn-xaudio2-ixaudio2masteringvoice
...
class IXAudio2MasteringVoice extends IXAudio2Voice{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xaudio2/nf-xaudio2-ixaudio2masteringvoice-getchannelmask
     */
    GetChannelMask() {
        result := ComCall(19, this, "uint*", &pChannelmask := 0, "int")
        if(result != 0) {
