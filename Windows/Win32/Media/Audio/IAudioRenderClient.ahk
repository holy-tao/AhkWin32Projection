 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nn-audioclient-iaudiorenderclient
...
class IAudioRenderClient extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudiorenderclient-getbuffer
     */
    GetBuffer(NumFramesRequested) {
        result := ComCall(3, this, "uint", NumFramesRequested, "ptr*", &ppData := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudiorenderclient-releasebuffer
     */
