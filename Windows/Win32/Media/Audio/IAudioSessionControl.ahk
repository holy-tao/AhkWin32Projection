 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nn-audiopolicy-iaudiosessioncontrol
...
class IAudioSessionControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-getstate
     */
    GetState() {
        result := ComCall(3, this, "int*", &pRetVal := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-getdisplayname
     */
    GetDisplayName() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-setdisplayname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-geticonpath
     */
    GetIconPath() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-seticonpath
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-getgroupingparam
     */
    GetGroupingParam() {
        pRetVal := Guid()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-setgroupingparam
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-registeraudiosessionnotification
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessioncontrol-unregisteraudiosessionnotification
     */
