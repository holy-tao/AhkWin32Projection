 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmformatenumcbw
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset Unicode
 */
class ACMFORMATENUMCBW extends IUnknown {
     ...
     * @param {Pointer<tACMFORMATDETAILSW>} pafd 
     ...
     */
    Invoke(hadid, pafd, dwInstance, fdwSupport) {
        hadid := hadid is Win32Handle ? NumGet(hadid, "ptr") : hadid

        result := ComCall(3, this, "ptr", hadid, "ptr", pafd, "ptr", dwInstance, "uint", fdwSupport, "int")
        return result
    }
}
