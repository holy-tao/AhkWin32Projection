 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudioclient/nn-spatialaudioclient-iaudioformatenumerator
...
class IAudioFormatEnumerator extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudioclient/nf-spatialaudioclient-iaudioformatenumerator-getcount
     */
    GetCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudioclient/nf-spatialaudioclient-iaudioformatenumerator-getformat
     */
    GetFormat(index) {
        result := ComCall(4, this, "uint", index, "ptr*", &format := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
