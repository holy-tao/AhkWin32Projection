 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmformattagenumcba
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset ANSI
 */
class ACMFORMATTAGENUMCBA extends IUnknown {
     ...
     * @param {Pointer<ACMFORMATTAGDETAILSA>} paftd 
