 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmfilterenumcbw
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset Unicode
 */
class ACMFILTERENUMCBW extends IUnknown {
     ...
     * @param {Pointer<ACMFILTERDETAILSW>} pafd 
