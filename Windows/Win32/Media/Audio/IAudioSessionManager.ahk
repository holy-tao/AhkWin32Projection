 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nn-audiopolicy-iaudiosessionmanager
...
class IAudioSessionManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessionmanager-getaudiosessioncontrol
     */
    GetAudioSessionControl(AudioSessionGuid, StreamFlags) {
        result := ComCall(3, this, "ptr", AudioSessionGuid, "uint", StreamFlags, "ptr*", &SessionControl := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiopolicy/nf-audiopolicy-iaudiosessionmanager-getsimpleaudiovolume
     */
    GetSimpleAudioVolume(AudioSessionGuid, StreamFlags) {
        result := ComCall(4, this, "ptr", AudioSessionGuid, "uint", StreamFlags, "ptr*", &AudioVolume := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
