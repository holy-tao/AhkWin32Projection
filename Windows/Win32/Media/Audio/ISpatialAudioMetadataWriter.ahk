 ...
 */
export default struct ISpatialAudioMetadataWriter extends IUnknown {
    /**
     ...
     * used for ISpatialAudioMetadataWriter interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        Open                 : IntPtr
        WriteNextItem        : IntPtr
        WriteNextItemCommand : IntPtr
        Close                : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISpatialAudioMetadataWriter.Vtbl()
        }
    ...
    Query(iid) {
        if (ISpatialAudioMetadataWriter.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.WriteNextItem)
        CallbackFree(this.vtbl.WriteNextItemCommand)
