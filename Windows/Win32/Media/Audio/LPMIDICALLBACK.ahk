 ...
 */
export default struct LPMIDICALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is LPMIDICALLBACK) {
    ...
    /**
     * A LPMIDICALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPMIDICALLBACK {
        /**
         * Creates a LPMIDICALLBACK pointer that invokes the given AHK function when called.
