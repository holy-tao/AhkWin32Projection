 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudioclient/nn-spatialaudioclient-ispatialaudioobjectrenderstream
...
class ISpatialAudioObjectRenderStream extends ISpatialAudioObjectRenderStreamBase{
     ...
     * @returns {Pointer<ISpatialAudioObject>} Receives a pointer to the activated interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudioclient/nf-spatialaudioclient-ispatialaudioobjectrenderstream-activatespatialaudioobject
     */
