 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmfiltertagenumcba
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset ANSI
 */
class ACMFILTERTAGENUMCBA extends IUnknown {
     ...
     * @param {Pointer<ACMFILTERTAGDETAILSA>} paftd 
