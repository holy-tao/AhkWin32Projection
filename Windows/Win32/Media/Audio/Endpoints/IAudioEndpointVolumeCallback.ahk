 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nn-endpointvolume-iaudioendpointvolumecallback
...
class IAudioEndpointVolumeCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolumecallback-onnotify
     */
    OnNotify(pNotify) {
