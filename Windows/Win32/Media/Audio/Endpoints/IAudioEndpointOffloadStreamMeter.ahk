 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nn-audioengineendpoint-iaudioendpointoffloadstreammeter
...
class IAudioEndpointOffloadStreamMeter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointoffloadstreammeter-getmeterchannelcount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointoffloadstreammeter-getmeteringdata
     */
    GetMeteringData(u32ChannelCount) {
        result := ComCall(4, this, "uint", u32ChannelCount, "float*", &pf32PeakValues := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
