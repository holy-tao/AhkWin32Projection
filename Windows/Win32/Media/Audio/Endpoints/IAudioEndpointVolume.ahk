 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nn-endpointvolume-iaudioendpointvolume
...
class IAudioEndpointVolume extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-registercontrolchangenotify
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-unregistercontrolchangenotify
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getchannelcount
     */
    GetChannelCount() {
        result := ComCall(5, this, "uint*", &pnChannelCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-setmastervolumelevel
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-setmastervolumelevelscalar
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getmastervolumelevel
     */
    GetMasterVolumeLevel() {
        result := ComCall(8, this, "float*", &pfLevelDB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getmastervolumelevelscalar
     */
    GetMasterVolumeLevelScalar() {
        result := ComCall(9, this, "float*", &pfLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-setchannelvolumelevel
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-setchannelvolumelevelscalar
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getchannelvolumelevel
     */
    GetChannelVolumeLevel(nChannel) {
        result := ComCall(12, this, "uint", nChannel, "float*", &pfLevelDB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getchannelvolumelevelscalar
     */
    GetChannelVolumeLevelScalar(nChannel) {
        result := ComCall(13, this, "uint", nChannel, "float*", &pfLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-setmute
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getmute
     */
    GetMute() {
        result := ComCall(15, this, "int*", &pbMute := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getvolumestepinfo
     */
    GetVolumeStepInfo(pnStep, pnStepCount) {
        ...
        result := ComCall(16, this, pnStepMarshal, pnStep, pnStepCountMarshal, pnStepCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-volumestepup
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-volumestepdown
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-queryhardwaresupport
     */
    QueryHardwareSupport() {
        result := ComCall(19, this, "uint*", &pdwHardwareSupportMask := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/endpointvolume/nf-endpointvolume-iaudioendpointvolume-getvolumerange
     */
    GetVolumeRange(pflVolumeMindB, pflVolumeMaxdB, pflVolumeIncrementdB) {
        ...
        result := ComCall(20, this, pflVolumeMindBMarshal, pflVolumeMindB, pflVolumeMaxdBMarshal, pflVolumeMaxdB, pflVolumeIncrementdBMarshal, pflVolumeIncrementdB, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
