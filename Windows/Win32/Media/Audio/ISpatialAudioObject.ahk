 ...
 */
export default struct ISpatialAudioObject extends ISpatialAudioObjectBase {
    /**
     ...
     * used for ISpatialAudioObject interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISpatialAudioObject.Vtbl()
        }
    ...
    Query(iid) {
        if (ISpatialAudioObject.IID.Equals(iid)) {
            return true
        }
