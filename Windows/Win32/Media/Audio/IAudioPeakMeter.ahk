 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-iaudiopeakmeter
...
class IAudioPeakMeter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiopeakmeter-getchannelcount
     */
    GetChannelCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiopeakmeter-getlevel
     */
    GetLevel(nChannel) {
        result := ComCall(4, this, "uint", nChannel, "float*", &pfLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
