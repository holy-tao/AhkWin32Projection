 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nn-spatialaudiometadata-ispatialaudioobjectformetadataitems
...
class ISpatialAudioObjectForMetadataItems extends ISpatialAudioObjectBase{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudioobjectformetadataitems-getspatialaudiometadataitems
     */
    GetSpatialAudioMetadataItems() {
        result := ComCall(7, this, "ptr*", &metadataItems := 0, "int")
        if(result != 0) {
