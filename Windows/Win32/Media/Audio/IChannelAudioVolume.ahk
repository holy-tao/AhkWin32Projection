...
export default struct IChannelAudioVolume extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetChannelVolume := CallbackCreate(ObjBindMethod(implObj, "SetChannelVolume"), flags, 4)
        this.vtbl.GetChannelVolume := CallbackCreate(ObjBindMethod(implObj, "GetChannelVolume"), flags, 3)
        this.vtbl.SetAllVolumes := CallbackCreate(ObjBindMethod(implObj, "SetAllVolumes"), flags, 4)
