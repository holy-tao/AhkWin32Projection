...
#Import ".\DataFlow.ahk" { DataFlow }
#Import "..\..\Foundation\BOOL.ahk" { BOOL }
#Import "..\..\Foundation\PWSTR.ahk" { PWSTR }
#Import ".\ConnectorType.ahk" { ConnectorType }
 ...
 */
export default struct IConnector extends IUnknown {
    /**
     ...
     * used for IConnector interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        ...
        Disconnect                : IntPtr
        IsConnected               : IntPtr
        GetConnectedTo            : IntPtr
        GetConnectorIdConnectedTo : IntPtr
        GetDeviceIdConnectedTo    : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IConnector.Vtbl()
        }
     ...
     */
    IsConnected() {
        result := ComCall(7, this, BOOL.Ptr, &pbConnected := 0, "HRESULT")
        return pbConnected
    }
    ...
    GetConnectorIdConnectedTo() {
        result := ComCall(9, this, PWSTR.Ptr, &ppwstrConnectorId := 0, "HRESULT")
    ...
    GetDeviceIdConnectedTo() {
        result := ComCall(10, this, PWSTR.Ptr, &ppwstrDeviceId := 0, "HRESULT")
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetConnectedTo)
        CallbackFree(this.vtbl.GetConnectorIdConnectedTo)
        CallbackFree(this.vtbl.GetDeviceIdConnectedTo)
    }
}
