 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nn-audioclient-iaudioclock
...
class IAudioClock extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudioclock-getfrequency
     */
    GetFrequency() {
        result := ComCall(3, this, "uint*", &pu64Frequency := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudioclock-getposition
     */
    GetPosition(pu64Position, pu64QPCPosition) {
        ...
        result := ComCall(4, this, pu64PositionMarshal, pu64Position, pu64QPCPositionMarshal, pu64QPCPosition, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudioclock-getcharacteristics
     */
    GetCharacteristics() {
        result := ComCall(5, this, "uint*", &pdwCharacteristics := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
