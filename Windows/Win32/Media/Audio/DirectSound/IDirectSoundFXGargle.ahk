...
#Import ".\DSFXGargle.ahk" { DSFXGargle }
#Import "..\..\..\System\Com\IUnknown.ahk" { IUnknown }

/**
 * @namespace Windows.Win32.Media.Audio.DirectSound
 */
export default struct IDirectSoundFXGargle extends IUnknown {
    /**
     ...
     * used for IDirectSoundFXGargle interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirectSoundFXGargle.Vtbl()
        }
    ...
    SetAllParameters(pcDsFxGargle) {
        result := ComCall(3, this, DSFXGargle.Ptr, pcDsFxGargle, "HRESULT")
        return result
    }
    ...
    GetAllParameters() {
        ...
        result := ComCall(4, this, DSFXGargle.Ptr, pDsFxGargle, "HRESULT")
        return pDsFxGargle
    }

    Query(iid) {
        if (IDirectSoundFXGargle.IID.Equals(iid)) {
            return true
        }
