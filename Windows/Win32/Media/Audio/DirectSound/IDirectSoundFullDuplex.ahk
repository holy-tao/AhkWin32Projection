...
class IDirectSoundFullDuplex extends IUnknown{
    ...
    Initialize(pCaptureGuid, pRenderGuid, lpDscBufferDesc, lpDsBufferDesc, hWnd, dwLevel, lplpDirectSoundCaptureBuffer8, lplpDirectSoundBuffer8) {
        ...
        result := ComCall(3, this, "ptr", pCaptureGuid, "ptr", pRenderGuid, "ptr", lpDscBufferDesc, "ptr", lpDsBufferDesc, "ptr", hWnd, "uint", dwLevel, "ptr", lplpDirectSoundCaptureBuffer8, "ptr", lplpDirectSoundBuffer8, "int")
        if(result != 0)
