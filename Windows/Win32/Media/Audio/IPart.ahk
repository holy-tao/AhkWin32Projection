 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-ipart
...
class IPart extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getname
     */
    GetName() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getlocalid
     */
    GetLocalId() {
        result := ComCall(4, this, "uint*", &pnId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getglobalid
     */
    GetGlobalId() {
        result := ComCall(5, this, "ptr*", &ppwstrGlobalId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Subunit
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getparttype
     */
    GetPartType() {
        result := ComCall(6, this, "int*", &pPartType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getsubtype
     */
    GetSubType() {
        pSubType := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getcontrolinterfacecount
     */
    GetControlInterfaceCount() {
        result := ComCall(8, this, "uint*", &pCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-getcontrolinterface
     */
    GetControlInterface(nIndex) {
        result := ComCall(9, this, "uint", nIndex, "ptr*", &ppInterfaceDesc := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-enumpartsincoming
     */
    EnumPartsIncoming() {
        result := ComCall(10, this, "ptr*", &ppParts := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-enumpartsoutgoing
     */
    EnumPartsOutgoing() {
        result := ComCall(11, this, "ptr*", &ppParts := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-gettopologyobject
     */
    GetTopologyObject() {
        result := ComCall(12, this, "ptr*", &ppTopology := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-activate
     */
    Activate(dwClsContext, refiid) {
        result := ComCall(13, this, "uint", dwClsContext, "ptr", refiid, "ptr*", &ppvObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-registercontrolchangecallback
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-ipart-unregistercontrolchangecallback
     */
