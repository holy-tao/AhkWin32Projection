 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nn-audioclient-iaudioviewmanagerservice
...
class IAudioViewManagerService extends IUnknown{
     ...
     * 
     * ```cpp
     * @param {HWND} hwnd_ The [HWND](https://docs.microsoft.com/en-us/windows/win32/winprog/windows-data-types) with which the audio stream wll be associated.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudioviewmanagerservice-setaudiostreamwindow
     */
    SetAudioStreamWindow(hwnd_) {
