 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-iaudiomute
...
class IAudioMute extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiomute-setmute
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iaudiomute-getmute
     */
    GetMute() {
        result := ComCall(4, this, "int*", &pbMuted := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
