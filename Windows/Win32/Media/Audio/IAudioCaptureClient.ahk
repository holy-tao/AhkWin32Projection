 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nn-audioclient-iaudiocaptureclient
...
class IAudioCaptureClient extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudiocaptureclient-getbuffer
     */
    GetBuffer(ppData, pNumFramesToRead, pdwFlags, pu64DevicePosition, pu64QPCPosition) {
        ...
        result := ComCall(3, this, ppDataMarshal, ppData, pNumFramesToReadMarshal, pNumFramesToRead, pdwFlagsMarshal, pdwFlags, pu64DevicePositionMarshal, pu64DevicePosition, pu64QPCPositionMarshal, pu64QPCPosition, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudiocaptureclient-releasebuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioclient/nf-audioclient-iaudiocaptureclient-getnextpacketsize
     */
    GetNextPacketSize() {
        result := ComCall(5, this, "uint*", &pNumFramesInNextPacket := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
