 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmfilterenumcba
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset ANSI
 */
class ACMFILTERENUMCBA extends IUnknown {
     ...
     * @param {Pointer<ACMFILTERDETAILSA>} pafd 
