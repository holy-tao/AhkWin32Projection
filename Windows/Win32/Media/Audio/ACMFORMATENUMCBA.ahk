 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msacm/nc-msacm-acmformatenumcba
 * @namespace Windows.Win32.Media.Audio
 * @version v4.0.30319
 * @charset ANSI
 */
class ACMFORMATENUMCBA extends IUnknown {
     ...
     * @param {Pointer<ACMFORMATDETAILSA>} pafd 
