 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nn-spatialaudiometadata-ispatialaudiometadataclient
...
class ISpatialAudioMetadataClient extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-activatespatialaudiometadataitems
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-getspatialaudiometadataitemsbufferlength
     */
    GetSpatialAudioMetadataItemsBufferLength(maxItemCount) {
        result := ComCall(4, this, "ushort", maxItemCount, "uint*", &bufferLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-activatespatialaudiometadatawriter
     */
    ActivateSpatialAudioMetadataWriter(overflowMode) {
        result := ComCall(5, this, "int", overflowMode, "ptr*", &metadataWriter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-activatespatialaudiometadatacopier
     */
    ActivateSpatialAudioMetadataCopier() {
        result := ComCall(6, this, "ptr*", &metadataCopier := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadataclient-activatespatialaudiometadatareader
     */
    ActivateSpatialAudioMetadataReader() {
        result := ComCall(7, this, "ptr*", &metadataReader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
