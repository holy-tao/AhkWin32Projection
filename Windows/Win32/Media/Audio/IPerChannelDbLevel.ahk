 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nn-devicetopology-iperchanneldblevel
...
class IPerChannelDbLevel extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-getchannelcount
     */
    GetChannelCount() {
        result := ComCall(3, this, "uint*", &pcChannels := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-getlevelrange
     */
    GetLevelRange(nChannel, pfMinLevelDB, pfMaxLevelDB, pfStepping) {
        ...
        result := ComCall(4, this, "uint", nChannel, pfMinLevelDBMarshal, pfMinLevelDB, pfMaxLevelDBMarshal, pfMaxLevelDB, pfSteppingMarshal, pfStepping, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-getlevel
     */
    GetLevel(nChannel) {
        result := ComCall(5, this, "uint", nChannel, "float*", &pfLevelDB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-setlevel
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-setleveluniform
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/devicetopology/nf-devicetopology-iperchanneldblevel-setlevelallchannels
     */
    SetLevelAllChannels(aLevelsDB, cChannels, pguidEventContext) {
        aLevelsDBMarshal := aLevelsDB is VarRef ? "float*" : "ptr"

        result := ComCall(8, this, aLevelsDBMarshal, aLevelsDB, "uint", cChannels, "ptr", pguidEventContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
