 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioenginebaseapo/nn-audioenginebaseapo-iaudiosystemeffects2
...
class IAudioSystemEffects2 extends IAudioSystemEffects{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioenginebaseapo/nf-audioenginebaseapo-iaudiosystemeffects2-geteffectslist
     */
    GetEffectsList(ppEffectsIds, pcEffects, Event) {
        ...
        result := ComCall(3, this, ppEffectsIdsMarshal, ppEffectsIds, pcEffectsMarshal, pcEffects, "ptr", Event, "int")
        if(result != 0) {
