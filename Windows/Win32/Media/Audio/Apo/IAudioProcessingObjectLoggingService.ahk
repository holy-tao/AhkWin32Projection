 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nn-audioengineextensionapo-iaudioprocessingobjectloggingservice
...
class IAudioProcessingObjectLoggingService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nf-audioengineextensionapo-iaudioprocessingobjectloggingservice-apolog
     */
    ApoLog(level, format) {
