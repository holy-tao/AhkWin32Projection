 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nn-audioengineextensionapo-iaudioprocessingobjectnotifications2
...
class IAudioProcessingObjectNotifications2 extends IAudioProcessingObjectNotifications{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nf-audioengineextensionapo-iaudioprocessingobjectnotifications2-getaponotificationregistrationinfo2
     */
    GetApoNotificationRegistrationInfo2(maxApoNotificationTypeSupported, apoNotifications, count) {
        ...
        result := ComCall(5, this, "int", maxApoNotificationTypeSupported, apoNotificationsMarshal, apoNotifications, countMarshal, count, "int")
        if(result != 0) {
