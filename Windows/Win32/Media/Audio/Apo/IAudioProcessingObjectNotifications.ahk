 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nn-audioengineextensionapo-iaudioprocessingobjectnotifications
...
class IAudioProcessingObjectNotifications extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nf-audioengineextensionapo-iaudioprocessingobjectnotifications-getaponotificationregistrationinfo
     */
    GetApoNotificationRegistrationInfo(apoNotifications, count) {
        ...
        result := ComCall(3, this, apoNotificationsMarshal, apoNotifications, countMarshal, count, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineextensionapo/nf-audioengineextensionapo-iaudioprocessingobjectnotifications-handlenotification
     */
