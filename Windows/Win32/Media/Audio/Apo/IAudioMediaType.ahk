 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/audiomediatype/nn-audiomediatype-iaudiomediatype
...
class IAudioMediaType extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiomediatype/nf-audiomediatype-iaudiomediatype-iscompressedformat
     */
    IsCompressedFormat() {
        result := ComCall(3, this, "int*", &pfCompressed := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/audiomediatype/nf-audiomediatype-iaudiomediatype-isequal
     */
    IsEqual(pIAudioType) {
        result := ComCall(4, this, "ptr", pIAudioType, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiomediatype/nf-audiomediatype-iaudiomediatype-getaudioformat
     */
    GetAudioFormat() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audiomediatype/nf-audiomediatype-iaudiomediatype-getuncompressedaudioformat
     */
