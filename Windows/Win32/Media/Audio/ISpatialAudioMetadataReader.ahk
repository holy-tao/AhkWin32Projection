 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nn-spatialaudiometadata-ispatialaudiometadatareader
...
class ISpatialAudioMetadataReader extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadatareader-open
     */
    Open(metadataItems) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadatareader-readnextitem
     */
    ReadNextItem(commandCount, frameOffset) {
        ...
        result := ComCall(4, this, commandCountMarshal, commandCount, frameOffsetMarshal, frameOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadatareader-readnextitemcommand
     */
    ReadNextItemCommand(commandID, valueBuffer, maxValueBufferLength, valueBufferLength) {
        ...
        result := ComCall(5, this, commandIDMarshal, commandID, "ptr", valueBuffer, "uint", maxValueBufferLength, valueBufferLengthMarshal, valueBufferLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/spatialaudiometadata/nf-spatialaudiometadata-ispatialaudiometadatareader-close
     */
    Close() {
