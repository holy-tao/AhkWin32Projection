...
export waveOutGetNumDevs() {
    result := DllCall("WINMM.dll\waveOutGetNumDevs", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveOutClose(hwo) {
    result := DllCall("WINMM.dll\waveOutClose", HWAVEOUT, hwo, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveOutPause(hwo) {
    result := DllCall("WINMM.dll\waveOutPause", HWAVEOUT, hwo, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveOutRestart(hwo) {
    result := DllCall("WINMM.dll\waveOutRestart", HWAVEOUT, hwo, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveOutReset(hwo) {
    result := DllCall("WINMM.dll\waveOutReset", HWAVEOUT, hwo, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveOutBreakLoop(hwo) {
    result := DllCall("WINMM.dll\waveOutBreakLoop", HWAVEOUT, hwo, UInt32)
    return result
}
...
export waveInGetNumDevs() {
    result := DllCall("WINMM.dll\waveInGetNumDevs", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveInClose(hwi) {
    result := DllCall("WINMM.dll\waveInClose", HWAVEIN, hwi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveInStart(hwi) {
    result := DllCall("WINMM.dll\waveInStart", HWAVEIN, hwi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveInStop(hwi) {
    result := DllCall("WINMM.dll\waveInStop", HWAVEIN, hwi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export waveInReset(hwi) {
    result := DllCall("WINMM.dll\waveInReset", HWAVEIN, hwi, UInt32)
    return result
}
...
export midiOutGetNumDevs() {
    result := DllCall("WINMM.dll\midiOutGetNumDevs", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiStreamClose(hms) {
    result := DllCall("WINMM.dll\midiStreamClose", HMIDISTRM, hms, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiStreamPause(hms) {
    result := DllCall("WINMM.dll\midiStreamPause", HMIDISTRM, hms, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiStreamRestart(hms) {
    result := DllCall("WINMM.dll\midiStreamRestart", HMIDISTRM, hms, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiStreamStop(hms) {
    result := DllCall("WINMM.dll\midiStreamStop", HMIDISTRM, hms, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiOutClose(hmo) {
    result := DllCall("WINMM.dll\midiOutClose", HMIDIOUT, hmo, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiOutReset(hmo) {
    result := DllCall("WINMM.dll\midiOutReset", HMIDIOUT, hmo, UInt32)
    return result
}
...
export midiInGetNumDevs() {
    result := DllCall("WINMM.dll\midiInGetNumDevs", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiInClose(hmi) {
    result := DllCall("WINMM.dll\midiInClose", HMIDIIN, hmi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiInStart(hmi) {
    result := DllCall("WINMM.dll\midiInStart", HMIDIIN, hmi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiInStop(hmi) {
    result := DllCall("WINMM.dll\midiInStop", HMIDIIN, hmi, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export midiInReset(hmi) {
    result := DllCall("WINMM.dll\midiInReset", HMIDIIN, hmi, UInt32)
    return result
}
...
export auxGetNumDevs() {
    result := DllCall("WINMM.dll\auxGetNumDevs", UInt32)
    return result
}
...
export mixerGetNumDevs() {
    result := DllCall("WINMM.dll\mixerGetNumDevs", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export mixerClose(hmx) {
    result := DllCall("WINMM.dll\mixerClose", HMIXER, hmx, UInt32)
    return result
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateRenderAudioStateMonitorForCategory(category) {
    result := DllCall("Windows.Media.MediaControl.dll\CreateRenderAudioStateMonitorForCategory", AUDIO_STREAM_CATEGORY, category, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateRenderAudioStateMonitorForCategoryAndDeviceRole(category, role) {
    result := DllCall("Windows.Media.MediaControl.dll\CreateRenderAudioStateMonitorForCategoryAndDeviceRole", AUDIO_STREAM_CATEGORY, category, ERole, role, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateRenderAudioStateMonitorForCategoryAndDeviceId(category, deviceId) {
    deviceId := deviceId is String ? StrPtr(deviceId) : deviceId

    result := DllCall("Windows.Media.MediaControl.dll\CreateRenderAudioStateMonitorForCategoryAndDeviceId", AUDIO_STREAM_CATEGORY, category, "ptr", deviceId, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateCaptureAudioStateMonitorForCategory(category) {
    result := DllCall("Windows.Media.MediaControl.dll\CreateCaptureAudioStateMonitorForCategory", AUDIO_STREAM_CATEGORY, category, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateCaptureAudioStateMonitorForCategoryAndDeviceRole(category, role) {
    result := DllCall("Windows.Media.MediaControl.dll\CreateCaptureAudioStateMonitorForCategoryAndDeviceRole", AUDIO_STREAM_CATEGORY, category, ERole, role, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @returns {IAudioStateMonitor} 
 */
export CreateCaptureAudioStateMonitorForCategoryAndDeviceId(category, deviceId) {
    deviceId := deviceId is String ? StrPtr(deviceId) : deviceId

    result := DllCall("Windows.Media.MediaControl.dll\CreateCaptureAudioStateMonitorForCategoryAndDeviceId", AUDIO_STREAM_CATEGORY, category, "ptr", deviceId, "ptr*", &audioStateMonitor := 0, "HRESULT")
    return IAudioStateMonitor(audioStateMonitor)
}
 ...
 * @since windows5.0
 */
export acmGetVersion() {
    result := DllCall("MSACM32.dll\acmGetVersion", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export acmFormatChooseA(pafmtc) {
    result := DllCall("MSACM32.dll\acmFormatChooseA", ACMFORMATCHOOSEA_struct.Ptr, pafmtc, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export acmFormatChooseW(pafmtc) {
    result := DllCall("MSACM32.dll\acmFormatChooseW", ACMFORMATCHOOSEW_struct.Ptr, pafmtc, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export acmFilterChooseA(pafltrc) {
    result := DllCall("MSACM32.dll\acmFilterChooseA", ACMFILTERCHOOSEA_struct.Ptr, pafltrc, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export acmFilterChooseW(pafltrc) {
    result := DllCall("MSACM32.dll\acmFilterChooseW", ACMFILTERCHOOSEW_struct.Ptr, pafltrc, UInt32)
    return result
}
