 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vfw/nc-vfw-capyieldcallback
 * @namespace Windows.Win32.Media.Multimedia
 * @version v4.0.30319
 */
class CAPYIELDCALLBACK extends IUnknown {
    ...
    Invoke(hWnd_) {
        ...
        result := ComCall(3, this, "ptr", hWnd_, "ptr")
