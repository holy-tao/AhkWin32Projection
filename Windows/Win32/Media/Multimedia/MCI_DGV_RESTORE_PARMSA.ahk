...
/**
 * The MCI_DGV_RESTORE_PARMSA (ANSI) structure (digitalv.h) contains information for the MCI_RESTORE command for digital-video devices.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/digitalv/ns-digitalv-mci_dgv_restore_parmsa
 * @namespace Windows.Win32.Media.Multimedia
 * @version v4.0.30319
 * @charset ANSI
 */
class MCI_DGV_RESTORE_PARMSA extends Win32Struct
{
    static sizeof => 32
