 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vfw/nc-vfw-capwavecallback
 * @namespace Windows.Win32.Media.Multimedia
 * @version v4.0.30319
 */
class CAPWAVECALLBACK extends IUnknown {
    ...
    Invoke(hWnd_, lpWHdr) {
        ...
        result := ComCall(3, this, "ptr", hWnd_, "ptr", lpWHdr, "ptr")
