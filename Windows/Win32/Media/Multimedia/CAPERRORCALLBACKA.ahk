 ...
 * @see https://learn.microsoft.com/windows/win32/api/vfw/nc-vfw-caperrorcallbacka
 * @namespace Windows.Win32.Media.Multimedia
 * @charset ANSI
 */
export default struct CAPERRORCALLBACKA {
    value : IntPtr

    __value {
        set {
            if (value is CAPERRORCALLBACKA) {
     ...
     * @param {PSTR} lpsz Pointer to a textual description of the returned error.
     * @returns {LRESULT} 
     */
    Call(_hWnd, nID, lpsz) {
    ...
    /**
     * A CAPERRORCALLBACKA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends CAPERRORCALLBACKA {
        /**
         * Creates a CAPERRORCALLBACKA pointer that invokes the given AHK function when called.
