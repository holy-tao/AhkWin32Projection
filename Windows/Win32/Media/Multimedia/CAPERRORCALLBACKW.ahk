 ...
 * @see https://learn.microsoft.com/windows/win32/api/vfw/nc-vfw-caperrorcallbackw
 * @namespace Windows.Win32.Media.Multimedia
 * @charset Unicode
 */
export default struct CAPERRORCALLBACKW {
    value : IntPtr

    __value {
        set {
            if (value is CAPERRORCALLBACKW) {
    ...
    /**
     * A CAPERRORCALLBACKW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends CAPERRORCALLBACKW {
        /**
         * Creates a CAPERRORCALLBACKW pointer that invokes the given AHK function when called.
