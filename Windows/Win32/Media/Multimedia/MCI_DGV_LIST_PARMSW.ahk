...
/**
 * The MCI_DGV_LIST_PARMSW (Unicode) structure (digitalv.h) contains the information for the MCI_LIST command for digital-video devices.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api/digitalv/ns-digitalv-mci_dgv_list_parmsw
 * @namespace Windows.Win32.Media.Multimedia
 * @version v4.0.30319
 * @charset Unicode
 */
class MCI_DGV_LIST_PARMSW extends Win32Struct
{
    static sizeof => 36
    ...
    lpstrAlgorithm{
        get {
            if(!this.HasProp("__lpstrAlgorithm"))
                this.__lpstrAlgorithm := PWSTR(this.ptr + 28)
