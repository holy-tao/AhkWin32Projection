 ...
 * @see https://learn.microsoft.com/windows/win32/api/vfw/nc-vfw-capstatuscallbacka
 * @namespace Windows.Win32.Media.Multimedia
 * @charset ANSI
 */
export default struct CAPSTATUSCALLBACKA {
    value : IntPtr

    __value {
        set {
            if (value is CAPSTATUSCALLBACKA) {
     ...
     * @param {PSTR} lpsz Pointer to a textual description of the returned status.
     * @returns {LRESULT} 
     */
    Call(_hWnd, nID, lpsz) {
    ...
    /**
     * A CAPSTATUSCALLBACKA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends CAPSTATUSCALLBACKA {
        /**
         * Creates a CAPSTATUSCALLBACKA pointer that invokes the given AHK function when called.
         * @param {Func(HWND, Int32, PSTR) => LRESULT} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
