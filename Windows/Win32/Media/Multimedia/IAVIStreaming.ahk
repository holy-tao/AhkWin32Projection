 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vfw/nn-vfw-iavistreaming
...
class IAVIStreaming extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vfw/nf-vfw-iavistreaming-begin
     */
     ...
     * ```
     * @returns {HRESULT} Returns the HRESULT defined by OLE.
     * @see https://learn.microsoft.com/windows/win32/api//content/vfw/nf-vfw-iavistreaming-end
     */
    End() {
