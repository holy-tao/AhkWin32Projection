 ...
 * @version v4.0.30319
 */
class VFWWDMExtensionProc extends IUnknown {
     ...
     */
    Invoke(pfnDeviceIoControl, pfnAddPropertyPage, lParam_) {
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        pfnDeviceIoControlMarshal := pfnDeviceIoControl is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, pfnDeviceIoControlMarshal, pfnDeviceIoControl, "ptr", pfnAddPropertyPage, "ptr", lParam_, "uint")
        return result
    }
}
