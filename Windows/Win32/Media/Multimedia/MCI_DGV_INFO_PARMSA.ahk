...
/**
 * The MCI_DGV_INFO_PARMS structure contains parameters for the MCI_INFO command for digital-video devices.
 * @remarks
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//digitalv/ns-digitalv-mci_dgv_info_parmsa
