...
/**
 * The MCI_DGV_RESTORE_PARMSW (Unicode) structure (digitalv.h) contains information for the MCI_RESTORE command for digital-video devices.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api/digitalv/ns-digitalv-mci_dgv_restore_parmsw
 * @namespace Windows.Win32.Media.Multimedia
 * @version v4.0.30319
 * @charset Unicode
 */
class MCI_DGV_RESTORE_PARMSW extends Win32Struct
{
    static sizeof => 32
    ...
    lpstrFileName{
        get {
            if(!this.HasProp("__lpstrFileName"))
                this.__lpstrFileName := PWSTR(this.ptr + 8)
