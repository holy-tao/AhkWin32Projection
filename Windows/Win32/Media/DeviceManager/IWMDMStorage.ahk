 ...
 */
export default struct IWMDMStorage extends IUnknown {
    /**
     ...
     * used for IWMDMStorage interfaces
    */
    ...
    SendOpaqueCommand(pCommand) {
        result := ComCall(11, this, OPAQUECOMMAND.Ptr, pCommand, "HRESULT")
        return result
    }

    Query(iid) {
        if (IWMDMStorage.IID.Equals(iid)) {
            return true
        }
