 ...
 */
export default struct IWMDMStorageControl3 extends IWMDMStorageControl2 {
    /**
     ...
     * used for IWMDMStorageControl3 interfaces
    */
    struct Vtbl extends IWMDMStorageControl2.Vtbl {
        Insert3 : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMDMStorageControl3.Vtbl()
        }
    ...
    Query(iid) {
        if (IWMDMStorageControl3.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.Insert3)
    }
}
