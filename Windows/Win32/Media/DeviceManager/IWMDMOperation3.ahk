 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-iwmdmoperation3
...
class IWMDMOperation3 extends IWMDMOperation{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmoperation3-transferobjectdataonclearchannel
     */
    TransferObjectDataOnClearChannel(pData, pdwSize) {
        pDataMarshal := pData is VarRef ? "char*" : "ptr"
        pdwSizeMarshal := pdwSize is VarRef ? "uint*" : "ptr"

        result := ComCall(13, this, pDataMarshal, pData, pdwSizeMarshal, pdwSize, "int")
        if(result != 0) {
