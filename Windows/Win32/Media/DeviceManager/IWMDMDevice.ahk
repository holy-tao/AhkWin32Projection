 ...
 */
export default struct IWMDMDevice extends IUnknown {
    /**
     ...
     * used for IWMDMDevice interfaces
    */
     ...
     * @see https://learn.microsoft.com/windows/win32/api/mswmdm/nf-mswmdm-iwmdmdevice-getversion
     */
    GetVersion() {
