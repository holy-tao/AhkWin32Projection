 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-imdserviceprovider2
...
class IMDServiceProvider2 extends IMDServiceProvider{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-imdserviceprovider2-createdevice
     */
    CreateDevice(pwszDevicePath, pdwCount, pppDeviceArray) {
        ...
        result := ComCall(5, this, "ptr", pwszDevicePath, pdwCountMarshal, pdwCount, pppDeviceArrayMarshal, pppDeviceArray, "int")
        if(result != 0) {
