...
class IWMDMDevice3 extends IWMDMDevice2 {
     ...
     * @param {WMDM_FORMATCODE} format Value from the <a href="https://docs.microsoft.com/windows/desktop/WMDM/wmdm-formatcode">WMDM_FORMATCODE</a> enumeration representing the queried format.
     ...
     * @param {WMDM_FIND_SCOPE} findScope A <a href="https://docs.microsoft.com/windows/desktop/WMDM/wmdm-find-scope">WMDM_FIND_SCOPE</a> enumeration specifying the scope of the find operation.
