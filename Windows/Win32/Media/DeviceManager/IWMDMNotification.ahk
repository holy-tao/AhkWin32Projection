 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-iwmdmnotification
...
class IWMDMNotification extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmnotification-wmdmmessage
     */
    WMDMMessage(dwMessageType, pwszCanonicalName) {
        ...
        result := ComCall(3, this, "uint", dwMessageType, "ptr", pwszCanonicalName, "int")
        if(result != 0) {
