 ...
 */
export default struct IMDSPDevice2 extends IMDSPDevice {
    /**
     ...
     * used for IMDSPDevice2 interfaces
    */
    struct Vtbl extends IMDSPDevice.Vtbl {
        GetStorage              : IntPtr
    ...
    Query(iid) {
        if (IMDSPDevice2.IID.Equals(iid)) {
            return true
        }
