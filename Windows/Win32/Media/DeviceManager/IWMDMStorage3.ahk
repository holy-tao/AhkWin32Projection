 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-iwmdmstorage3
...
class IWMDMStorage3 extends IWMDMStorage2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmstorage3-getmetadata
     */
    GetMetadata() {
        result := ComCall(15, this, "ptr*", &ppMetadata := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmstorage3-setmetadata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmstorage3-createemptymetadataobject
     */
    CreateEmptyMetadataObject() {
        result := ComCall(17, this, "ptr*", &ppMetadata := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmstorage3-setenumpreference
     */
    SetEnumPreference(pMode, nViews, pViews) {
        pModeMarshal := pMode is VarRef ? "int*" : "ptr"

        result := ComCall(18, this, pModeMarshal, pMode, "uint", nViews, "ptr", pViews, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
