 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-imdsprevoked
...
class IMDSPRevoked extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-imdsprevoked-getrevocationurl
     */
    GetRevocationURL(ppwszRevocationURL, pdwBufferLen) {
        ...
        result := ComCall(3, this, ppwszRevocationURLMarshal, ppwszRevocationURL, pdwBufferLenMarshal, pdwBufferLen, "int")
        if(result != 0) {
