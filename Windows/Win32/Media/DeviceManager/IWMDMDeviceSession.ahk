 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-iwmdmdevicesession
...
class IWMDMDeviceSession extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmdevicesession-beginsession
     */
    BeginSession(type, pCtx, dwSizeCtx) {
        pCtxMarshal := pCtx is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, "int", type, pCtxMarshal, pCtx, "uint", dwSizeCtx, "int")
        if(result != 0) {
     ...
     * </ul>
     * For an extensive list of possible error codes, see <a href="https://docs.microsoft.com/windows/desktop/WMDM/error-codes">Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-iwmdmdevicesession-endsession
     */
    EndSession(type, pCtx, dwSizeCtx) {
        pCtxMarshal := pCtx is VarRef ? "char*" : "ptr"

        result := ComCall(4, this, "int", type, pCtxMarshal, pCtx, "uint", dwSizeCtx, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
