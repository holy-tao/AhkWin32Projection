 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nn-mswmdm-imdspstorage3
...
class IMDSPStorage3 extends IMDSPStorage2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-imdspstorage3-getmetadata
     */
    GetMetadata(pMetadata) {
        result := ComCall(17, this, "ptr", pMetadata, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mswmdm/nf-mswmdm-imdspstorage3-setmetadata
     */
    SetMetadata(pMetadata) {
        result := ComCall(18, this, "ptr", pMetadata, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
