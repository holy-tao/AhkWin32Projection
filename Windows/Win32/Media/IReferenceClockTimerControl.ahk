 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nn-strmif-ireferenceclocktimercontrol
...
class IReferenceClockTimerControl extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ireferenceclocktimercontrol-setdefaulttimerresolution
     */
    SetDefaultTimerResolution(timerResolution) {
        result := ComCall(3, this, "int64", timerResolution, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/strmif/nf-strmif-ireferenceclocktimercontrol-getdefaulttimerresolution
     */
    GetDefaultTimerResolution() {
        result := ComCall(4, this, "int64*", &pTimerResolution := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
