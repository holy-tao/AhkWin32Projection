 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmaddressaccess
...
class IWMAddressAccess extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess-getaccessentrycount
     */
    GetAccessEntryCount(aeType) {
        result := ComCall(3, this, "int", aeType, "uint*", &pcEntries := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess-getaccessentry
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess-addaccessentry
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess-removeaccessentry
     */
