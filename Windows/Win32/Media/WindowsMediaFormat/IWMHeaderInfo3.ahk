 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmheaderinfo3
...
class IWMHeaderInfo3 extends IWMHeaderInfo2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-getattributecountex
     */
    GetAttributeCountEx(wStreamNum) {
        result := ComCall(17, this, "ushort", wStreamNum, "ushort*", &pcAttributes := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-getattributeindices
     */
    GetAttributeIndices(wStreamNum, pwszName, pwLangIndex, pwCount) {
        ...
        result := ComCall(18, this, "ushort", wStreamNum, "ptr", pwszName, pwLangIndexMarshal, pwLangIndex, "ushort*", &pwIndices := 0, pwCountMarshal, pwCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-getattributebyindexex
     */
    GetAttributeByIndexEx(wStreamNum, wIndex, pwszName, pwNameLen, pType, pwLangIndex, pValue, pdwDataLength) {
        ...
        result := ComCall(19, this, "ushort", wStreamNum, "ushort", wIndex, "ptr", pwszName, pwNameLenMarshal, pwNameLen, pTypeMarshal, pType, pwLangIndexMarshal, pwLangIndex, pValueMarshal, pValue, pdwDataLengthMarshal, pdwDataLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-modifyattribute
     */
    ModifyAttribute(wStreamNum, wIndex, Type, wLangIndex, pValue, dwLength) {
        pValueMarshal := pValue is VarRef ? "char*" : "ptr"

        result := ComCall(20, this, "ushort", wStreamNum, "ushort", wIndex, "int", Type, "ushort", wLangIndex, pValueMarshal, pValue, "uint", dwLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-addattribute
     */
    AddAttribute(wStreamNum, pszName, Type, wLangIndex, pValue, dwLength) {
        ...
        result := ComCall(21, this, "ushort", wStreamNum, "ptr", pszName, "ushort*", &pwIndex := 0, "int", Type, "ushort", wLangIndex, pValueMarshal, pValue, "uint", dwLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-deleteattribute
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmheaderinfo3-addcodecinfo
     */
    AddCodecInfo(pwszName, pwszDescription, codecType, cbCodecInfo, pbCodecInfo) {
        ...
        result := ComCall(23, this, "ptr", pwszName, "ptr", pwszDescription, "int", codecType, "ushort", cbCodecInfo, pbCodecInfoMarshal, pbCodecInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
