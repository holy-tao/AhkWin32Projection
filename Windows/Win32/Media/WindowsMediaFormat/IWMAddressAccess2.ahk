 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmaddressaccess2
...
class IWMAddressAccess2 extends IWMAddressAccess{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess2-getaccessentryex
     */
    GetAccessEntryEx(aeType, dwEntryNum, pbstrAddress, pbstrMask) {
        result := ComCall(7, this, "int", aeType, "uint", dwEntryNum, "ptr", pbstrAddress, "ptr", pbstrMask, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmaddressaccess2-addaccessentryex
     */
    AddAccessEntryEx(aeType, bstrAddress, bstrMask) {
        ...
        if(bstrMask is String) {
            pin := BSTR.Alloc(bstrMask)
            bstrMask := pin.Value
        }

        result := ComCall(8, this, "int", aeType, "ptr", bstrAddress, "ptr", bstrMask, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
