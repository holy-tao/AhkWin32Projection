 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmindexer2
...
class IWMIndexer2 extends IWMIndexer{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmindexer2-configure
     */
    Configure(wStreamNum, nIndexerType, pvInterval, pvIndexType) {
        ...
        result := ComCall(5, this, "ushort", wStreamNum, "int", nIndexerType, pvIntervalMarshal, pvInterval, pvIndexTypeMarshal, pvIndexType, "int")
        if(result != 0) {
