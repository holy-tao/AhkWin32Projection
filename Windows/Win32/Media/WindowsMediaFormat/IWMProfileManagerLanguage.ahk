 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmprofilemanagerlanguage
...
class IWMProfileManagerLanguage extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanagerlanguage-getuserlanguageid
     */
    GetUserLanguageID(wLangID) {
        wLangIDMarshal := wLangID is VarRef ? "ushort*" : "ptr"

        result := ComCall(3, this, wLangIDMarshal, wLangID, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanagerlanguage-setuserlanguageid
     */
