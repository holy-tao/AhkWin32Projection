...
class WMT_RIGHTS extends Win32Enum {
     ...
     * Native name: WMT_RIGHT_PLAYBACK
     * @type {Integer (Int32)}
     */
    static RIGHT_PLAYBACK => 1
     ...
     * Native name: WMT_RIGHT_COPY_TO_NON_SDMI_DEVICE
     * @type {Integer (Int32)}
     */
    static RIGHT_COPY_TO_NON_SDMI_DEVICE => 2

    /**
     * Specifies the right to copy content to a CD.
     * Native name: WMT_RIGHT_COPY_TO_CD
     * @type {Integer (Int32)}
     */
    static RIGHT_COPY_TO_CD => 8

    /**
     * Specifies the right to copy content to a device compliant with the Secure Digital Music Initiative (SDMI).
     * Native name: WMT_RIGHT_COPY_TO_SDMI_DEVICE
     * @type {Integer (Int32)}
     */
    static RIGHT_COPY_TO_SDMI_DEVICE => 16

    /**
     * Specifies the right to play content one time only.
     * Native name: WMT_RIGHT_ONE_TIME
     * @type {Integer (Int32)}
     */
    static RIGHT_ONE_TIME => 32

    /**
     * Specifies the right to save content from a server.
     * Native name: WMT_RIGHT_SAVE_STREAM_PROTECTED
     * @type {Integer (Int32)}
     */
    static RIGHT_SAVE_STREAM_PROTECTED => 64
     ...
     * Native name: WMT_RIGHT_COPY
     * @type {Integer (Int32)}
     */
    static RIGHT_COPY => 128
     ...
     * Native name: WMT_RIGHT_COLLABORATIVE_PLAY
     * @type {Integer (Int32)}
     */
    static RIGHT_COLLABORATIVE_PLAY => 256

    /**
     * Reserved for future use. Do not use.
     * Native name: WMT_RIGHT_SDMI_TRIGGER
     * @type {Integer (Int32)}
     */
    static RIGHT_SDMI_TRIGGER => 65536

    /**
     * Reserved for future use. Do not use.
     * Native name: WMT_RIGHT_SDMI_NOMORECOPIES
     * @type {Integer (Int32)}
     */
    static RIGHT_SDMI_NOMORECOPIES => 131072
}
