...
class IWMWriterPostViewCallback extends IWMStatusCallback{
    ...
    OnPostViewSample(wStreamNumber, cnsSampleTime, cnsSampleDuration, dwFlags, pSample, pvContext) {
        result := ComCall(4, this, "ushort", wStreamNumber, "uint", cnsSampleTime, "uint", cnsSampleDuration, "uint", dwFlags, "ptr", pSample, "ptr", pvContext, "int")
        if(result != 0)
    ...
    AllocateForPostView(wStreamNum, cbBuffer, ppBuffer, pvContext) {
        result := ComCall(5, this, "ushort", wStreamNum, "uint", cbBuffer, "ptr", ppBuffer, "ptr", pvContext, "int")
        if(result != 0)
            throw OSError(result)
