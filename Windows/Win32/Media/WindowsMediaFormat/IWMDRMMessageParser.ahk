...
class IWMDRMMessageParser extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<Byte>} pbRegistrationReqMsg 
    ...
    ParseRegistrationReqMsg(pbRegistrationReqMsg, cbRegistrationReqMsg, ppDeviceCert, pDeviceSerialNumber) {
        result := ComCall(3, this, "char*", pbRegistrationReqMsg, "uint", cbRegistrationReqMsg, "ptr", ppDeviceCert, "ptr", pDeviceSerialNumber, "int")
        if(result != 0)
    ...
    ParseLicenseRequestMsg(pbLicenseRequestMsg, cbLicenseRequestMsg, ppDeviceCert, pDeviceSerialNumber, pbstrAction) {
        result := ComCall(4, this, "char*", pbLicenseRequestMsg, "uint", cbLicenseRequestMsg, "ptr", ppDeviceCert, "ptr", pDeviceSerialNumber, "ptr", pbstrAction, "int")
        if(result != 0)
            throw OSError(result)
