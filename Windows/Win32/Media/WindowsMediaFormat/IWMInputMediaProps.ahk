 ...
 */
export default struct IWMInputMediaProps extends IWMMediaProps {
    /**
     ...
     * used for IWMInputMediaProps interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMInputMediaProps.Vtbl()
        }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetGroupName := CallbackCreate(ObjBindMethod(implObj, "GetGroupName"), flags, 3)
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetGroupName)
    }
}
