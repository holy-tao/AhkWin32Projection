 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmdxva/nn-wmdxva-iwmplayertimestamphook
...
class IWMPlayerTimestampHook extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmdxva/nf-wmdxva-iwmplayertimestamphook-maptimestamp
     */
    MapTimestamp(rtIn) {
        result := ComCall(3, this, "int64", rtIn, "int64*", &prtOut := 0, "int")
        if(result != 0) {
