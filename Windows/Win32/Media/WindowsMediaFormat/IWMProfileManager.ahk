 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmprofilemanager
...
class IWMProfileManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-createemptyprofile
     */
    CreateEmptyProfile(dwVersion) {
        result := ComCall(3, this, "int", dwVersion, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
     ...
     * @returns {IWMProfile} Pointer to a pointer to an <a href="https://docs.microsoft.com/windows/desktop/wmformat/iwmprofile">IWMProfile</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-loadprofilebyid
     */
    LoadProfileByID(guidProfile) {
        result := ComCall(4, this, "ptr", guidProfile, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMProfile} Pointer to a pointer to an <a href="https://docs.microsoft.com/windows/desktop/wmformat/iwmprofile">IWMProfile</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-loadprofilebydata
     */
    LoadProfileByData(pwszProfile) {
        pwszProfile := pwszProfile is String ? StrPtr(pwszProfile) : pwszProfile

        result := ComCall(5, this, "ptr", pwszProfile, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-saveprofile
     */
    SaveProfile(pIWMProfile, pwszProfile, pdwLength) {
        ...
        result := ComCall(6, this, "ptr", pIWMProfile, "ptr", pwszProfile, pdwLengthMarshal, pdwLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-getsystemprofilecount
     */
    GetSystemProfileCount() {
        result := ComCall(7, this, "uint*", &pcProfiles := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMProfile} Pointer to a pointer to an <a href="https://docs.microsoft.com/windows/desktop/wmformat/iwmprofile">IWMProfile</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofilemanager-loadsystemprofile
     */
    LoadSystemProfile(dwProfileIndex) {
        result := ComCall(8, this, "uint", dwProfileIndex, "ptr*", &ppProfile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
