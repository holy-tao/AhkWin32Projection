...
export default struct IWMRegisteredDevice extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetDeviceSerialNumber := CallbackCreate(ObjBindMethod(implObj, "GetDeviceSerialNumber"), flags, 2)
        this.vtbl.GetDeviceCertificate := CallbackCreate(ObjBindMethod(implObj, "GetDeviceCertificate"), flags, 2)
        ...
        this.vtbl.GetAttributeByIndex := CallbackCreate(ObjBindMethod(implObj, "GetAttributeByIndex"), flags, 4)
        this.vtbl.GetAttributeByName := CallbackCreate(ObjBindMethod(implObj, "GetAttributeByName"), flags, 3)
        this.vtbl.SetAttributeByName := CallbackCreate(ObjBindMethod(implObj, "SetAttributeByName"), flags, 3)
        this.vtbl.Approve := CallbackCreate(ObjBindMethod(implObj, "Approve"), flags, 2)
        this.vtbl.IsValid := CallbackCreate(ObjBindMethod(implObj, "IsValid"), flags, 2)
        this.vtbl.IsApproved := CallbackCreate(ObjBindMethod(implObj, "IsApproved"), flags, 2)
        this.vtbl.IsWmdrmCompliant := CallbackCreate(ObjBindMethod(implObj, "IsWmdrmCompliant"), flags, 2)
        this.vtbl.IsOpened := CallbackCreate(ObjBindMethod(implObj, "IsOpened"), flags, 2)
