 ...
 * @see https://learn.microsoft.com/windows/win32/api/wmsdkidl/nn-wmsdkidl-iwmdeviceregistration
 * @namespace Windows.Win32.Media.WindowsMediaFormat
 */
export default struct IWMDeviceRegistration extends IUnknown {
    /**
     ...
     * used for IWMDeviceRegistration interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        RegisterDevice           : IntPtr
        UnregisterDevice         : IntPtr
        GetRegistrationStats     : IntPtr
        GetFirstRegisteredDevice : IntPtr
        GetNextRegisteredDevice  : IntPtr
        GetRegisteredDeviceByID  : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMDeviceRegistration.Vtbl()
        }
    ...
    Query(iid) {
        if (IWMDeviceRegistration.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetRegistrationStats)
        CallbackFree(this.vtbl.GetFirstRegisteredDevice)
        CallbackFree(this.vtbl.GetNextRegisteredDevice)
        CallbackFree(this.vtbl.GetRegisteredDeviceByID)
    }
}
