 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmmutualexclusion
...
class IWMMutualExclusion extends IWMStreamList{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion-gettype
     */
    GetType() {
        pguidType := Guid()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion-settype
     */
    SetType(guidType) {
