 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmreaderadvanced4
...
class IWMReaderAdvanced4 extends IWMReaderAdvanced3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-getlanguagecount
     */
    GetLanguageCount(dwOutputNum) {
        result := ComCall(40, this, "uint", dwOutputNum, "ushort*", &pwLanguageCount := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-getlanguage
     */
    GetLanguage(dwOutputNum, wLanguage, pwszLanguageString, pcchLanguageStringLength) {
        ...
        result := ComCall(41, this, "uint", dwOutputNum, "ushort", wLanguage, "ptr", pwszLanguageString, pcchLanguageStringLengthMarshal, pcchLanguageStringLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-getmaxspeedfactor
     */
    GetMaxSpeedFactor() {
        result := ComCall(42, this, "double*", &pdblFactor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-isusingfastcache
     */
    IsUsingFastCache() {
        result := ComCall(43, this, "int*", &pfUsingFastCache := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-addlogparam
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-sendlogparams
     */
    SendLogParams() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-cansavefileas
     */
    CanSaveFileAs() {
        result := ComCall(46, this, "int*", &pfCanSave := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-cancelsavefileas
     */
    CancelSaveFileAs() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmreaderadvanced4-geturl
     */
    GetURL(pwszURL, pcchURL) {
        ...
        result := ComCall(48, this, "ptr", pwszURL, pcchURLMarshal, pcchURL, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
