 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsecure/nn-wmsecure-iwmgetsecurechannel
...
class IWMGetSecureChannel extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsecure/nf-wmsecure-iwmgetsecurechannel-getpeersecurechannelinterface
     */
    GetPeerSecureChannelInterface() {
        result := ComCall(3, this, "ptr*", &ppPeer := 0, "int")
        if(result != 0) {
