 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmvideomediaprops
...
class IWMVideoMediaProps extends IWMMediaProps{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmvideomediaprops-getmaxkeyframespacing
     */
    GetMaxKeyFrameSpacing() {
        result := ComCall(6, this, "int64*", &pllTime := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmvideomediaprops-setmaxkeyframespacing
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmvideomediaprops-getquality
     */
    GetQuality() {
        result := ComCall(8, this, "uint*", &pdwQuality := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method always returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmvideomediaprops-setquality
     */
