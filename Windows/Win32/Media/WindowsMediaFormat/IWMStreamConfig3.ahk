 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmstreamconfig3
...
class IWMStreamConfig3 extends IWMStreamConfig2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmstreamconfig3-getlanguage
     */
    GetLanguage(pwszLanguageString, pcchLanguageStringLength) {
        ...
        result := ComCall(20, this, "ptr", pwszLanguageString, pcchLanguageStringLengthMarshal, pcchLanguageStringLength, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmstreamconfig3-setlanguage
     */
