 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmdrmreader3
...
class IWMDRMReader3 extends IWMDRMReader2{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmdrmreader3-getinclusionlist
     */
    GetInclusionList(ppGuids, pcGuids) {
        ppGuidsMarshal := ppGuids is VarRef ? "ptr*" : "ptr"
        pcGuidsMarshal := pcGuids is VarRef ? "uint*" : "ptr"

        result := ComCall(15, this, ppGuidsMarshal, ppGuids, pcGuidsMarshal, pcGuids, "int")
        if(result != 0) {
