 ...
 */
export default struct IWMLicenseRevocationAgent extends IUnknown {
    /**
     ...
     * used for IWMLicenseRevocationAgent interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetLRBChallenge : IntPtr
        ProcessLRB      : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMLicenseRevocationAgent.Vtbl()
        }
    ...
    Query(iid) {
        if (IWMLicenseRevocationAgent.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetLRBChallenge)
        CallbackFree(this.vtbl.ProcessLRB)
    }
}
