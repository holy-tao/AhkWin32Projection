 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmcodecinfo2
...
class IWMCodecInfo2 extends IWMCodecInfo{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmcodecinfo2-getcodecname
     */
    GetCodecName(guidType, dwCodecIndex, wszName, pcchName) {
        ...
        result := ComCall(6, this, "ptr", guidType, "uint", dwCodecIndex, "ptr", wszName, pcchNameMarshal, pcchName, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmcodecinfo2-getcodecformatdesc
     */
    GetCodecFormatDesc(guidType, dwCodecIndex, dwFormatIndex, wszDesc, pcchDesc) {
        ...
        result := ComCall(7, this, "ptr", guidType, "uint", dwCodecIndex, "uint", dwFormatIndex, "ptr*", &ppIStreamConfig := 0, "ptr", wszDesc, pcchDescMarshal, pcchDesc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
