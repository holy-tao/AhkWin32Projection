 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmprofile
...
class IWMProfile extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getversion
     */
    GetVersion() {
        result := ComCall(3, this, "int*", &pdwVersion := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getname
     */
    GetName(pwszName, pcchName) {
        ...
        result := ComCall(4, this, "ptr", pwszName, pcchNameMarshal, pcchName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-setname
     */
    SetName(pwszName) {
        pwszName := pwszName is String ? StrPtr(pwszName) : pwszName
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getdescription
     */
    GetDescription(pwszDescription, pcchDescription) {
        ...
        result := ComCall(6, this, "ptr", pwszDescription, pcchDescriptionMarshal, pcchDescription, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-setdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getstreamcount
     */
    GetStreamCount() {
        result := ComCall(8, this, "uint*", &pcStreams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getstream
     */
    GetStream(dwStreamIndex) {
        result := ComCall(9, this, "uint", dwStreamIndex, "ptr*", &ppConfig := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IWMStreamConfig} Pointer to a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmstreamconfig">IWMStreamConfig</a> interface of the stream configuration object that describes the specified stream.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getstreambynumber
     */
    GetStreamByNumber(wStreamNum) {
        result := ComCall(10, this, "ushort", wStreamNum, "ptr*", &ppConfig := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-removestream
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-removestreambynumber
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-addstream
     */
    AddStream(pConfig) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-reconfigstream
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-createnewstream
     */
    CreateNewStream(guidStreamType) {
        result := ComCall(15, this, "ptr", guidStreamType, "ptr*", &ppConfig := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getmutualexclusioncount
     */
    GetMutualExclusionCount() {
        result := ComCall(16, this, "uint*", &pcME := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-getmutualexclusion
     */
    GetMutualExclusion(dwMEIndex) {
        result := ComCall(17, this, "uint", dwMEIndex, "ptr*", &ppME := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-removemutualexclusion
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-addmutualexclusion
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmprofile-createnewmutualexclusion
     */
    CreateNewMutualExclusion() {
        result := ComCall(20, this, "ptr*", &ppME := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
