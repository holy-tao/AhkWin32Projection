 ...
 */
export default struct IWMCredentialCallback extends IUnknown {
    /**
     ...
     * used for IWMCredentialCallback interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        AcquireCredentials : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMCredentialCallback.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.AcquireCredentials)
    }
}
