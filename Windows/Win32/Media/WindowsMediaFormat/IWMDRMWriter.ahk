 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmdrmwriter
...
class IWMDRMWriter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmdrmwriter-generatekeyseed
     */
    GenerateKeySeed(pwszKeySeed, pcwchLength) {
        ...
        result := ComCall(3, this, "ptr", pwszKeySeed, pcwchLengthMarshal, pcwchLength, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmdrmwriter-generatekeyid
     */
    GenerateKeyID(pwszKeyID, pcwchLength) {
        ...
        result := ComCall(4, this, "ptr", pwszKeyID, pcwchLengthMarshal, pcwchLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmdrmwriter-generatesigningkeypair
     */
    GenerateSigningKeyPair(pwszPrivKey, pcwchPrivKeyLength, pwszPubKey, pcwchPubKeyLength) {
        ...
        result := ComCall(5, this, "ptr", pwszPrivKey, pcwchPrivKeyLengthMarshal, pcwchPrivKeyLength, "ptr", pwszPubKey, pcwchPubKeyLengthMarshal, pcwchPubKeyLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, it returns S_OK. If it fails, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmdrmwriter-setdrmattribute
     */
