 ...
 */
export default struct IWMLanguageList extends IUnknown {
    /**
     ...
     * used for IWMLanguageList interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetLanguageCount           : IntPtr
        GetLanguageDetails         : IntPtr
        AddLanguageByRFC1766String : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWMLanguageList.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetLanguageDetails)
        CallbackFree(this.vtbl.AddLanguageByRFC1766String)
    }
}
