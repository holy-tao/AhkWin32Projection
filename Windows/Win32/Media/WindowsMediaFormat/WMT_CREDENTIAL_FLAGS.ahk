...
class WMT_CREDENTIAL_FLAGS extends Win32Enum {
     ...
     * Native name: WMT_CREDENTIAL_SAVE
     * @type {Integer (Int32)}
     */
    static SAVE => 1
     ...
     * Native name: WMT_CREDENTIAL_DONT_CACHE
     * @type {Integer (Int32)}
     */
    static DONT_CACHE => 2
     ...
     * Native name: WMT_CREDENTIAL_CLEAR_TEXT
     * @type {Integer (Int32)}
     */
    static CLEAR_TEXT => 4
     ...
     * Native name: WMT_CREDENTIAL_PROXY
     * @type {Integer (Int32)}
     */
    static PROXY => 8
     ...
     * Native name: WMT_CREDENTIAL_ENCRYPT
     * @type {Integer (Int32)}
     */
    static ENCRYPT => 16
}
