 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmpacketsize2
...
class IWMPacketSize2 extends IWMPacketSize{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmpacketsize2-getminpacketsize
     */
    GetMinPacketSize() {
        result := ComCall(5, this, "uint*", &pdwMinPacketSize := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmpacketsize2-setminpacketsize
     */
