 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nn-wmsdkidl-iwmmutualexclusion2
...
class IWMMutualExclusion2 extends IWMMutualExclusion{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-getname
     */
    GetName(pwszName, pcchName) {
        ...
        result := ComCall(8, this, "ptr", pwszName, pcchNameMarshal, pcchName, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-setname
     */
    SetName(pwszName) {
        pwszName := pwszName is String ? StrPtr(pwszName) : pwszName
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-getrecordcount
     */
    GetRecordCount() {
        result := ComCall(10, this, "ushort*", &pwRecordCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-addrecord
     */
    AddRecord() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-removerecord
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-getrecordname
     */
    GetRecordName(wRecordNumber, pwszRecordName, pcchRecordName) {
        ...
        result := ComCall(13, this, "ushort", wRecordNumber, "ptr", pwszRecordName, pcchRecordNameMarshal, pcchRecordName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-setrecordname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-getstreamsforrecord
     */
    GetStreamsForRecord(wRecordNumber, pcStreams) {
        pcStreamsMarshal := pcStreams is VarRef ? "ushort*" : "ptr"

        result := ComCall(15, this, "ushort", wRecordNumber, "ushort*", &pwStreamNumArray := 0, pcStreamsMarshal, pcStreams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-addstreamforrecord
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wmsdkidl/nf-wmsdkidl-iwmmutualexclusion2-removestreamforrecord
     */
