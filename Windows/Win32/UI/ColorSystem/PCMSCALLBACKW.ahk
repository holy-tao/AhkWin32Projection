 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/icm/nc-icm-pcmscallbackw
 * @namespace Windows.Win32.UI.ColorSystem
 * @version v4.0.30319
 * @charset Unicode
 */
class PCMSCALLBACKW extends IUnknown {
     ...
     * @param {Pointer<COLORMATCHSETUPW>} param0 
     * @param {LPARAM} param1 
