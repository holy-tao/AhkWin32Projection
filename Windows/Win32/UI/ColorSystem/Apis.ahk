...
#Import ".\WCS_DEVICE_CAPABILITIES_TYPE.ahk" { WCS_DEVICE_CAPABILITIES_TYPE }
#Import ".\COLOR.ahk" { COLOR }
#Import ".\WCS_PROFILE_MANAGEMENT_SCOPE.ahk" { WCS_PROFILE_MANAGEMENT_SCOPE }
#Import ".\HCOLORSPACE.ahk" { HCOLORSPACE }
#Import "..\..\Graphics\Gdi\RGBTRIPLE.ahk" { RGBTRIPLE }
#Import ".\COLORPROFILETYPE.ahk" { COLORPROFILETYPE }
#Import ".\ENUMTYPEW.ahk" { ENUMTYPEW }
#Import "..\..\Foundation\LUID.ahk" { LUID }
#Import ".\ENUMTYPEA.ahk" { ENUMTYPEA }
#Import "..\..\Foundation\LPARAM.ahk" { LPARAM }
#Import ".\PROFILE.ahk" { PROFILE }
#Import ".\COLOR_MATCH_TO_TARGET_ACTION.ahk" { COLOR_MATCH_TO_TARGET_ACTION }
#Import ".\COLORTYPE.ahk" { COLORTYPE }
...
#Import ".\COLORPROFILESUBTYPE.ahk" { COLORPROFILESUBTYPE }
...
#Import ".\BMFORMAT.ahk" { BMFORMAT }
#Import "..\..\Foundation\COLORREF.ahk" { COLORREF }
#Import ".\ICM_COMMAND.ahk" { ICM_COMMAND }
#Import ".\COLORDATATYPE.ahk" { COLORDATATYPE }
 ...
 * @param {HDC} _hdc Identifies handle to the device context.
 * @param {ICM_MODE} _mode Turns on and off image color management. This parameter can take one of the following constant values.<div> </div>
 * 
 * 
 * <table>
 * <tr>
 ...
 * @since windows5.0
 */
export SetICMMode(_hdc, _mode) {
    result := DllCall("GDI32.dll\SetICMMode", HDC, _hdc, ICM_MODE, _mode, Int32)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context whose output gamut to be checked.
 * @param {Pointer<RGBTRIPLE>} lpRGBTriple Pointer to an array of RGB triples to check.
 * @param {Integer} dlpBuffer Pointer to the buffer in which the results are to be placed. This buffer must be at least as large as <i>nCount</i> bytes.
 ...
 * @since windows5.0
 */
export CheckColorsInGamut(_hdc, lpRGBTriple, dlpBuffer, nCount) {
    result := DllCall("GDI32.dll\CheckColorsInGamut", HDC, _hdc, RGBTRIPLE.Ptr, lpRGBTriple, "ptr", dlpBuffer, "uint", nCount, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Specifies a device context that is to have its input color space handle retrieved.
 ...
 * @since windows5.0
 */
export GetColorSpace(_hdc) {
    result := DllCall("GDI32.dll\GetColorSpace", HDC, _hdc, HCOLORSPACE.Owned)
    return result
}
 ...
 * @param {HCOLORSPACE} _hColorSpace Specifies the handle to a color space.
 * @param {Integer} lpBuffer Points to a buffer to receive the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-logcolorspacea">LOGCOLORSPACE</a> structure.
 ...
 * @since windows5.0
 */
export GetLogColorSpaceA(_hColorSpace, lpBuffer, nSize) {
    result := DllCall("GDI32.dll\GetLogColorSpaceA", HCOLORSPACE, _hColorSpace, "ptr", lpBuffer, "uint", nSize, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetLogColorSpaceW(_hColorSpace, lpBuffer, nSize) {
    result := DllCall("GDI32.dll\GetLogColorSpaceW", HCOLORSPACE, _hColorSpace, "ptr", lpBuffer, "uint", nSize, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export CreateColorSpaceA(lplcs) {
    result := DllCall("GDI32.dll\CreateColorSpaceA", LOGCOLORSPACEA.Ptr, lplcs, HCOLORSPACE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateColorSpaceW(lplcs) {
    result := DllCall("GDI32.dll\CreateColorSpaceW", LOGCOLORSPACEW.Ptr, lplcs, HCOLORSPACE.Owned)
    return result
}

/**
 * The SetColorSpace function defines the input color space for a given device context.
 * @param {HDC} _hdc Specifies the handle to a device context.
 ...
 * @since windows5.0
 */
export SetColorSpace(_hdc, hcs) {
    result := DllCall("GDI32.dll\SetColorSpace", HDC, _hdc, HCOLORSPACE, hcs, HCOLORSPACE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export DeleteColorSpace(hcs) {
    result := DllCall("GDI32.dll\DeleteColorSpace", HCOLORSPACE, hcs, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Specifies a device context from which to retrieve the color profile.
 ...
 * @param {HDC} _hdc Specifies a device context in which to set the color profile.
 ...
 * @since windows5.0
 */
export SetICMProfileA(_hdc, lpFileName) {
    lpFileName := lpFileName is String ? StrPtr(lpFileName) : lpFileName

    result := DllCall("GDI32.dll\SetICMProfileA", HDC, _hdc, "ptr", lpFileName, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetICMProfileW(_hdc, lpFileName) {
    lpFileName := lpFileName is String ? StrPtr(lpFileName) : lpFileName

    result := DllCall("GDI32.dll\SetICMProfileW", HDC, _hdc, "ptr", lpFileName, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Specifies the device context of the direct color display board in question.
 ...
 * @param {HDC} _hdc Specifies the device context for previewing, generally the screen.
 * @param {HDC} hdcTarget Specifies the target device context, generally a printer.
 * @param {COLOR_MATCH_TO_TARGET_ACTION} action 
 * @returns {BOOL} If this function succeeds, the return value is <b>TRUE</b>.
 * 
 * If this function fails, the return value is <b>FALSE</b>.
 ...
 * @since windows5.0
 */
export ColorMatchToTarget(_hdc, hdcTarget, action) {
    result := DllCall("GDI32.dll\ColorMatchToTarget", HDC, _hdc, HDC, hdcTarget, COLOR_MATCH_TO_TARGET_ACTION, action, BOOL)
    return result
}
 ...
 * @param {Pointer<ICMENUMPROCA>} _proc Specifies the procedure instance address of a callback function defined by the application. (See <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nc-wingdi-icmenumproca">EnumICMProfilesProcCallback</a>.)
 * @param {LPARAM} param2 
 ...
 * > The wingdi.h header defines EnumICMProfiles as an alias which automatically selects the ANSI or Unicode version of this function based on the definition of the UNICODE preprocessor constant. Mixing usage of the encoding-neutral alias with code that not encoding-neutral can lead to mismatches that result in compilation or runtime errors. For more information, see [Conventions for Function Prototypes](/windows/win32/intl/conventions-for-function-prototypes).
 * @param {HDC} _hdc Specifies the device context.
 * @param {Pointer<ICMENUMPROCW>} _proc Specifies the procedure instance address of a callback function defined by the application. (See <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nc-wingdi-icmenumproca">EnumICMProfilesProcCallback</a>.)
 * @param {LPARAM} param2 
 * @returns {Integer} This function returns zero if the application interrupted the enumeration. The return value is -1 if there are no color profiles to enumerate. Otherwise, the return value is the last value returned by the callback function.
 ...
 * @since windows5.0
 */
export UpdateICMRegKeyA(lpszCMID, lpszFileName, command) {
    static reserved := 0 ;Reserved parameters must always be NULL

    lpszCMID := lpszCMID is String ? StrPtr(lpszCMID) : lpszCMID
    lpszFileName := lpszFileName is String ? StrPtr(lpszFileName) : lpszFileName

    result := DllCall("GDI32.dll\UpdateICMRegKeyA", "uint", reserved, "ptr", lpszCMID, "ptr", lpszFileName, ICM_COMMAND, command, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export UpdateICMRegKeyW(lpszCMID, lpszFileName, command) {
    static reserved := 0 ;Reserved parameters must always be NULL

    lpszCMID := lpszCMID is String ? StrPtr(lpszCMID) : lpszCMID
    lpszFileName := lpszFileName is String ? StrPtr(lpszFileName) : lpszFileName

    result := DllCall("GDI32.dll\UpdateICMRegKeyW", "uint", reserved, "ptr", lpszCMID, "ptr", lpszFileName, ICM_COMMAND, command, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Specifies a device context whose WCS parameters to use.
 ...
 * @since windows5.0
 */
export ColorCorrectPalette(_hdc, hPal, deFirst, num) {
    result := DllCall("GDI32.dll\ColorCorrectPalette", HDC, _hdc, HPALETTE, hPal, "uint", deFirst, "uint", num, BOOL)
    return result
}
 ...
 */
export OpenColorProfileA(pProfile, dwDesiredAccess, dwShareMode, dwCreationMode) {
    result := DllCall("mscms.dll\OpenColorProfileA", PROFILE.Ptr, pProfile, "uint", dwDesiredAccess, "uint", dwShareMode, "uint", dwCreationMode, IntPtr)
    return result
}
 ...
 */
export OpenColorProfileW(pProfile, dwDesiredAccess, dwShareMode, dwCreationMode) {
    result := DllCall("mscms.dll\OpenColorProfileW", PROFILE.Ptr, pProfile, "uint", dwDesiredAccess, "uint", dwShareMode, "uint", dwCreationMode, IntPtr)
    return result
}
...
export CloseColorProfile(hProfile) {
    result := DllCall("mscms.dll\CloseColorProfile", "ptr", hProfile, BOOL)
    return result
}
 ...
 * @param {Integer} pProfile Pointer to buffer to receive raw ICC or DMP profile data. Can be **NULL**. If it is, the size required for the buffer will be stored in the memory location pointed to by *pcbSize*. The buffer can be allocated to the appropriate size, and this function called again with *pBuffer* containing the address of the buffer.
 * @param {Pointer<Integer>} pcbProfile Pointer to a **DWORD** that holds the size of buffer pointed at by *pBuffer*. On return it is filled with size of buffer that was actually used if the function succeeds. If this function is called with *pBuffer* set to **NULL**, this parameter will contain the size of the buffer required.
...
export GetColorProfileFromHandle(hProfile, pProfile, pcbProfile) {
    ...
    result := DllCall("mscms.dll\GetColorProfileFromHandle", "ptr", hProfile, "ptr", pProfile, pcbProfileMarshal, pcbProfile, BOOL)
    return result
}
...
export IsColorProfileValid(hProfile, pbValid) {
    ...
    result := DllCall("mscms.dll\IsColorProfileValid", "ptr", hProfile, pbValidMarshal, pbValid, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer<Integer>>} pProfile A pointer to a pointer to a buffer where the device profile will be created. This function allocates the buffer and fills it with profile information if it is successful. If not, the pointer is set to **NULL**. The caller is responsible for freeing this buffer when it is no longer needed.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 ...
 * @param {Pointer<Integer>} pnElementCount Pointer to a variable in which to place the number of tagged elements in the profile.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export GetCountColorProfileElements(hProfile, pnElementCount) {
    ...
    result := DllCall("mscms.dll\GetCountColorProfileElements", "ptr", hProfile, pnElementCountMarshal, pnElementCount, BOOL)
    return result
}
 ...
 */
export GetColorProfileHeader(hProfile, pHeader) {
    result := DllCall("mscms.dll\GetColorProfileHeader", "ptr", hProfile, PROFILEHEADER.Ptr, pHeader, BOOL)
    return result
}
 ...
 * @param {Pointer<Integer>} pTag Pointer to a variable in which the tag name is to be placed.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export GetColorProfileElementTag(hProfile, dwIndex, pTag) {
    ...
    result := DllCall("mscms.dll\GetColorProfileElementTag", "ptr", hProfile, "uint", dwIndex, pTagMarshal, pTag, BOOL)
    return result
}
...
export IsColorProfileTagPresent(hProfile, tag, pbPresent) {
    ...
    result := DllCall("mscms.dll\IsColorProfileTagPresent", "ptr", hProfile, "uint", tag, pbPresentMarshal, pbPresent, BOOL)
    return result
}
 ...
 * @param {Pointer<Integer>} pcbElement Pointer to a variable specifying the number of bytes to copy. On return, the variable contains the number of bytes actually copied.
 * @param {Integer} pElement Pointer to a buffer into which the tagged element data is to be copied. The buffer must contain at least as many bytes as are specified by the variable pointed to by *pcbSize*. If the *pBuffer* pointer is set to **NULL**, the size of the entire tagged element data in bytes is returned in the memory location pointed to by *pcbSize,* and *dwOffset* is ignored. In this case, the function will return **FALSE**.
...
export GetColorProfileElement(hProfile, tag, dwOffset, pcbElement, pElement, pbReference) {
    ...
    result := DllCall("mscms.dll\GetColorProfileElement", "ptr", hProfile, "uint", tag, "uint", dwOffset, pcbElementMarshal, pcbElement, "ptr", pElement, pbReferenceMarshal, pbReference, BOOL)
    return result
}
 ...
 */
export SetColorProfileHeader(hProfile, pHeader) {
    result := DllCall("mscms.dll\SetColorProfileHeader", "ptr", hProfile, PROFILEHEADER.Ptr, pHeader, BOOL)
    return result
}
 ...
 */
export SetColorProfileElementSize(hProfile, tagType, pcbElement) {
    result := DllCall("mscms.dll\SetColorProfileElementSize", "ptr", hProfile, "uint", tagType, "uint", pcbElement, BOOL)
    return result
}
 ...
 * @param {Pointer<Integer>} pcbElement Pointer to a variable containing the number of bytes of data to write. On return, it contains the number of bytes actually written.
...
export SetColorProfileElement(hProfile, tag, dwOffset, pcbElement, pElement) {
    ...
    result := DllCall("mscms.dll\SetColorProfileElement", "ptr", hProfile, "uint", tag, "uint", dwOffset, pcbElementMarshal, pcbElement, pElementMarshal, pElement, BOOL)
    return result
}
 ...
 */
export SetColorProfileElementReference(hProfile, newTag, refTag) {
    result := DllCall("mscms.dll\SetColorProfileElementReference", "ptr", hProfile, "uint", newTag, "uint", refTag, BOOL)
    return result
}
 ...
 * @param {Integer} pPS2ColorSpaceArray Pointer to a buffer in which the color space array is to be placed. If the *pBuffer* pointer is set to **NULL**, the function returns the required size of the buffer in the memory location pointed to by *pcbSize*.
 * @param {Pointer<Integer>} pcbPS2ColorSpaceArray Pointer to a variable containing the size of the buffer in bytes. On return, it contains the number of bytes copied into the buffer.
...
export GetPS2ColorSpaceArray(hProfile, dwIntent, dwCSAType, pPS2ColorSpaceArray, pcbPS2ColorSpaceArray, pbBinary) {
    ...
    result := DllCall("mscms.dll\GetPS2ColorSpaceArray", "ptr", hProfile, "uint", dwIntent, "uint", dwCSAType, "ptr", pPS2ColorSpaceArray, pcbPS2ColorSpaceArrayMarshal, pcbPS2ColorSpaceArray, pbBinaryMarshal, pbBinary, BOOL)
    return result
}
 ...
 * @param {Integer} pBuffer Points to a buffer in which the color rendering intent is to be placed. If the *pBuffer* pointer is set to **NULL**, the buffer size required is returned in *\*pcbSize*.
 * @param {Pointer<Integer>} pcbPS2ColorRenderingIntent Points to a variable containing the buffer size in bytes. On return, this variable contains the number of bytes actually copied.
...
export GetPS2ColorRenderingIntent(hProfile, dwIntent, pBuffer, pcbPS2ColorRenderingIntent) {
    ...
    result := DllCall("mscms.dll\GetPS2ColorRenderingIntent", "ptr", hProfile, "uint", dwIntent, "ptr", pBuffer, pcbPS2ColorRenderingIntentMarshal, pcbPS2ColorRenderingIntent, BOOL)
    return result
}
 ...
 * 
 * For more information, see [Rendering intents](/windows/win32/wcs/rendering-intents).
 * @param {Integer} pPS2ColorRenderingDictionary Pointer to a buffer in which the color rendering dictionary is to be placed. If the *pBuffer* pointer is set to **NULL**, the required buffer size is returned in *\*pcbSize*.
 * @param {Pointer<Integer>} pcbPS2ColorRenderingDictionary Pointer to a variable containing the size of the buffer in bytes. On return, the variable contains the number of bytes actually copied.
...
export GetPS2ColorRenderingDictionary(hProfile, dwIntent, pPS2ColorRenderingDictionary, pcbPS2ColorRenderingDictionary, pbBinary) {
    ...
    result := DllCall("mscms.dll\GetPS2ColorRenderingDictionary", "ptr", hProfile, "uint", dwIntent, "ptr", pPS2ColorRenderingDictionary, pcbPS2ColorRenderingDictionaryMarshal, pcbPS2ColorRenderingDictionary, pbBinaryMarshal, pbBinary, BOOL)
    return result
}
 ...
 */
export GetNamedProfileInfo(hProfile, pNamedProfileInfo) {
    result := DllCall("mscms.dll\GetNamedProfileInfo", "ptr", hProfile, NAMED_PROFILE_INFO.Ptr, pNamedProfileInfo, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer<Integer>>} paColorName Pointer to an array of color name structures.
 * @param {Pointer<Integer>} paIndex Pointer to an array of **DWORDS** that this function fills with the indices. The indices begin with one, not zero.
...
export ConvertColorNameToIndex(hProfile, paColorName, paIndex, dwCount) {
    ...
    result := DllCall("mscms.dll\ConvertColorNameToIndex", "ptr", hProfile, paColorNameMarshal, paColorName, paIndexMarshal, paIndex, "uint", dwCount, BOOL)
    return result
}
 ...
 * @param {Pointer<Integer>} paIndex Pointer to an array of color-space index numbers. The indices begin with one, not zero.
 * @param {Pointer<Pointer<Integer>>} paColorName Pointer to an array of color name structures.
...
export ConvertIndexToColorName(hProfile, paIndex, paColorName, dwCount) {
    ...
    result := DllCall("mscms.dll\ConvertIndexToColorName", "ptr", hProfile, paIndexMarshal, paIndex, paColorNameMarshal, paColorName, "uint", dwCount, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer>} hProfile Pointer to an array of handles of the color profiles to be used. The function determines whether the HPROFILEs contain ICC profile information and, if so, it processes them appropriately.
 * @param {Integer} nProfiles Specifies the number of profiles in the array pointed to by *hProfile*.
 * @param {Pointer<Integer>} padwIntent Pointer to an array of **DWORDS** containing the intents to be used. See [Rendering intents](/windows/win32/wcs/rendering-intents).
 ...
 * @param {Pointer<Pointer<Integer>>} pProfileData Pointer to a pointer to a buffer. If successful, this function allocates the buffer, places its address in *\*pProfileData*, and fills it with a device link profile. If the function succeeds, the calling application must free the buffer after it is no longer needed.
...
export CreateDeviceLinkProfile(hProfile, nProfiles, padwIntent, nIntents, dwFlags, pProfileData, indexPreferredCMM) {
    ...
    result := DllCall("mscms.dll\CreateDeviceLinkProfile", hProfileMarshal, hProfile, "uint", nProfiles, padwIntentMarshal, padwIntent, "uint", nIntents, "uint", dwFlags, pProfileDataMarshal, pProfileData, "uint", indexPreferredCMM, BOOL)
    return result
}
 ...
 */
export CreateColorTransformA(pLogColorSpace, hDestProfile, hTargetProfile, dwFlags) {
    result := DllCall("mscms.dll\CreateColorTransformA", LOGCOLORSPACEA.Ptr, pLogColorSpace, "ptr", hDestProfile, "ptr", hTargetProfile, "uint", dwFlags, IntPtr)
    return result
}
 ...
 */
export CreateColorTransformW(pLogColorSpace, hDestProfile, hTargetProfile, dwFlags) {
    result := DllCall("mscms.dll\CreateColorTransformW", LOGCOLORSPACEW.Ptr, pLogColorSpace, "ptr", hDestProfile, "ptr", hTargetProfile, "uint", dwFlags, IntPtr)
    return result
}
...
export CreateMultiProfileTransform(pahProfiles, nProfiles, padwIntent, nIntents, dwFlags, indexPreferredCMM) {
    ...
    result := DllCall("mscms.dll\CreateMultiProfileTransform", pahProfilesMarshal, pahProfiles, "uint", nProfiles, padwIntentMarshal, padwIntent, "uint", nIntents, "uint", dwFlags, "uint", indexPreferredCMM, IntPtr)
    return result
}
 ...
 */
export DeleteColorTransform(hxform) {
    result := DllCall("mscms.dll\DeleteColorTransform", "ptr", hxform, BOOL)
    return result
}
 ...
 * @param {BMFORMAT} bmInput Specifies the format of the input bitmap. Must be set to one of the values of the [**BMFORMAT**](/windows/win32/api/icm/ne-icm-bmformat) enumerated type.
 * 
 * > [!Note]  
 ...
 * @param {BMFORMAT} bmOutput Specifies the format of the output bitmap. Must be set to one of the values of the [**BMFORMAT**](/windows/win32/api/icm/ne-icm-bmformat) enumerated type.
 ...
 * @param {Pointer<LPBMCALLBACKFN>} _pfnCallBack Pointer to a callback function called periodically by **TranslateBitmapBits** to report progress and allow the calling process to cancel the translation. (See [**ICMProgressProcCallback**](/windows/win32/wcs/icmprogressproccallback) )
...
export TranslateBitmapBits(hColorTransform, pSrcBits, bmInput, dwWidth, dwHeight, dwInputStride, pDestBits, bmOutput, dwOutputStride, _pfnCallBack, ulCallbackData) {
    ...
    result := DllCall("mscms.dll\TranslateBitmapBits", "ptr", hColorTransform, pSrcBitsMarshal, pSrcBits, BMFORMAT, bmInput, "uint", dwWidth, "uint", dwHeight, "uint", dwInputStride, pDestBitsMarshal, pDestBits, BMFORMAT, bmOutput, "uint", dwOutputStride, "ptr", _pfnCallBack, LPARAM, ulCallbackData, BOOL)
    return result
}
 ...
 * @param {BMFORMAT} bmInput Specifies the format of the bitmap. Must be set to one of the values of the [**BMFORMAT**](/windows/win32/api/icm/ne-icm-bmformat) enumerated type.
 ...
 * @param {Pointer<LPBMCALLBACKFN>} _pfnCallback Pointer to a callback function called periodically by **CheckBitmapBits** to report progress and allow the calling process to cancel the bitmap test. (See [**ICMProgressProcCallback**](/windows/win32/wcs/icmprogressproccallback)).
...
export CheckBitmapBits(hColorTransform, pSrcBits, bmInput, dwWidth, dwHeight, dwStride, paResult, _pfnCallback, lpCallbackData) {
    ...
    result := DllCall("mscms.dll\CheckBitmapBits", "ptr", hColorTransform, pSrcBitsMarshal, pSrcBits, BMFORMAT, bmInput, "uint", dwWidth, "uint", dwHeight, "uint", dwStride, paResultMarshal, paResult, "ptr", _pfnCallback, LPARAM, lpCallbackData, BOOL)
    return result
}
 ...
 * @param {COLORTYPE} ctInput Specifies the input color type.
 * @param {Pointer<COLOR>} paOutputColors Pointer to an array of *nColors* **COLOR** structures that receive the translated colors.
 * @param {COLORTYPE} ctOutput Specifies the output color type.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
 * @see https://learn.microsoft.com/windows/win32/api/icm/nf-icm-translatecolors
 */
export TranslateColors(hColorTransform, paInputColors, nColors, ctInput, paOutputColors, ctOutput) {
    result := DllCall("mscms.dll\TranslateColors", "ptr", hColorTransform, COLOR.Ptr, paInputColors, "uint", nColors, COLORTYPE, ctInput, COLOR.Ptr, paOutputColors, COLORTYPE, ctOutput, BOOL)
    return result
}
 ...
 * @param {COLORTYPE} ctInput Specifies the input color type.
 * @param {Pointer<Integer>} paResult Pointer to an array of *nColors* bytes that receives the results of the test.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export CheckColors(hColorTransform, paInputColors, nColors, ctInput, paResult) {
    ...
    result := DllCall("mscms.dll\CheckColors", "ptr", hColorTransform, COLOR.Ptr, paInputColors, "uint", nColors, COLORTYPE, ctInput, paResultMarshal, paResult, BOOL)
    return result
}
 ...
 */
export GetCMMInfo(hColorTransform, param1) {
    result := DllCall("mscms.dll\GetCMMInfo", "ptr", hColorTransform, "uint", param1, UInt32)
    return result
}
 ...
 */
export RegisterCMMA(pMachineName, cmmID, pCMMdll) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pCMMdll := pCMMdll is String ? StrPtr(pCMMdll) : pCMMdll

    result := DllCall("mscms.dll\RegisterCMMA", "ptr", pMachineName, "uint", cmmID, "ptr", pCMMdll, BOOL)
    return result
}
 ...
 */
export RegisterCMMW(pMachineName, cmmID, pCMMdll) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pCMMdll := pCMMdll is String ? StrPtr(pCMMdll) : pCMMdll

    result := DllCall("mscms.dll\RegisterCMMW", "ptr", pMachineName, "uint", cmmID, "ptr", pCMMdll, BOOL)
    return result
}
...
export UnregisterCMMA(pMachineName, cmmID) {
    ...
    result := DllCall("mscms.dll\UnregisterCMMA", "ptr", pMachineName, "uint", cmmID, BOOL)
    return result
}
...
export UnregisterCMMW(pMachineName, cmmID) {
    ...
    result := DllCall("mscms.dll\UnregisterCMMW", "ptr", pMachineName, "uint", cmmID, BOOL)
    return result
}
 ...
 */
export SelectCMM(dwCMMType) {
    result := DllCall("mscms.dll\SelectCMM", "uint", dwCMMType, BOOL)
    return result
}
 ...
 * @param {Integer} pBuffer Points to the buffer in which the color directory path is to be placed.
 * @param {Pointer<Integer>} pdwSize Points to a variable containing the size in bytes of the buffer pointed to by *pBuffer*. On return, the variable contains the size of the buffer actually used or needed.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export GetColorDirectoryA(pMachineName, pBuffer, pdwSize) {
    ...
    result := DllCall("mscms.dll\GetColorDirectoryA", "ptr", pMachineName, "ptr", pBuffer, pdwSizeMarshal, pdwSize, BOOL)
    return result
}
...
export GetColorDirectoryW(pMachineName, pBuffer, pdwSize) {
    ...
    result := DllCall("mscms.dll\GetColorDirectoryW", "ptr", pMachineName, "ptr", pBuffer, pdwSizeMarshal, pdwSize, BOOL)
    return result
}
 ...
 */
export InstallColorProfileA(pMachineName, pProfileName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
 ...
 */
export InstallColorProfileW(pMachineName, pProfileName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
 ...
 */
export UninstallColorProfileA(pMachineName, pProfileName, bDelete) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
 ...
 */
export UninstallColorProfileW(pMachineName, pProfileName, bDelete) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
 ...
 * @param {Integer} pEnumerationBuffer Pointer to a buffer in which the profiles are to be enumerated. A MULTI\_SZ string of profile names satisfying the criteria specified in *\*pEnumRecord* will be placed in this buffer.
 * @param {Pointer<Integer>} pdwSizeOfEnumerationBuffer Pointer to a variable containing the size of the buffer pointed to by *pBuffer*. On return, *\*pdwSize* contains the size of buffer actually used or needed.
 * @param {Pointer<Integer>} pnProfiles Pointer to a variable that will contain, on return, the number of profile names actually copied to the buffer.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call [GetLastError](/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror).
...
export EnumColorProfilesA(pMachineName, pEnumRecord, pEnumerationBuffer, pdwSizeOfEnumerationBuffer, pnProfiles) {
    ...
    result := DllCall("mscms.dll\EnumColorProfilesA", "ptr", pMachineName, ENUMTYPEA.Ptr, pEnumRecord, "ptr", pEnumerationBuffer, pdwSizeOfEnumerationBufferMarshal, pdwSizeOfEnumerationBuffer, pnProfilesMarshal, pnProfiles, BOOL)
    return result
}
...
export EnumColorProfilesW(pMachineName, pEnumRecord, pEnumerationBuffer, pdwSizeOfEnumerationBuffer, pnProfiles) {
    ...
    result := DllCall("mscms.dll\EnumColorProfilesW", "ptr", pMachineName, ENUMTYPEW.Ptr, pEnumRecord, "ptr", pEnumerationBuffer, pdwSizeOfEnumerationBufferMarshal, pdwSizeOfEnumerationBuffer, pnProfilesMarshal, pnProfiles, BOOL)
    return result
}
 ...
 */
export SetStandardColorSpaceProfileA(pMachineName, dwProfileID, pProfilename) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfilename := pProfilename is String ? StrPtr(pProfilename) : pProfilename

    result := DllCall("mscms.dll\SetStandardColorSpaceProfileA", "ptr", pMachineName, "uint", dwProfileID, "ptr", pProfilename, BOOL)
    return result
}
 ...
 */
export SetStandardColorSpaceProfileW(pMachineName, dwProfileID, pProfileName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName

    result := DllCall("mscms.dll\SetStandardColorSpaceProfileW", "ptr", pMachineName, "uint", dwProfileID, "ptr", pProfileName, BOOL)
    return result
}
 ...
 * @param {Integer} pBuffer Pointer to the buffer in which the name of the profile is to be placed. If **NULL**, the call will return **TRUE** and the required size of the buffer is placed in *pdwSize.*
 * @param {Pointer<Integer>} pcbSize Pointer to a variable containing the size in bytes of the buffer pointed to by *pProfileName*. On return, the variable contains the size of the buffer actually used or needed.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export GetStandardColorSpaceProfileA(pMachineName, dwSCS, pBuffer, pcbSize) {
    ...
    result := DllCall("mscms.dll\GetStandardColorSpaceProfileA", "ptr", pMachineName, "uint", dwSCS, "ptr", pBuffer, pcbSizeMarshal, pcbSize, BOOL)
    return result
}
...
export GetStandardColorSpaceProfileW(pMachineName, dwSCS, pBuffer, pcbSize) {
    ...
    result := DllCall("mscms.dll\GetStandardColorSpaceProfileW", "ptr", pMachineName, "uint", dwSCS, "ptr", pBuffer, pcbSizeMarshal, pcbSize, BOOL)
    return result
}
 ...
 */
export AssociateColorProfileWithDeviceA(pMachineName, pProfileName, pDeviceName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
 ...
 */
export AssociateColorProfileWithDeviceW(pMachineName, pProfileName, pDeviceName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName
 ...
 */
export DisassociateColorProfileFromDeviceA(pMachineName, pProfileName, pDeviceName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName
 ...
 */
export DisassociateColorProfileFromDeviceW(pMachineName, pProfileName, pDeviceName) {
    pMachineName := pMachineName is String ? StrPtr(pMachineName) : pMachineName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName
 ...
 */
export SetupColorMatchingW(pcms) {
    result := DllCall("ICMUI.dll\SetupColorMatchingW", COLORMATCHSETUPW.Ptr, pcms, BOOL)
    return result
}
 ...
 */
export SetupColorMatchingA(pcms) {
    result := DllCall("ICMUI.dll\SetupColorMatchingA", COLORMATCHSETUPA.Ptr, pcms, BOOL)
    return result
}
 ...
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope A [**WCS\_PROFILE\_MANAGEMENT\_SCOPE**](/windows/win32/api/icm/ne-icm-wcs_profile_management_scope) value that specifies the scope of this profile management operation, which could be system-wide or for the current user.
 ...
 */
export WcsAssociateColorProfileWithDevice(scope, pProfileName, pDeviceName) {
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName

    result := DllCall("mscms.dll\WcsAssociateColorProfileWithDevice", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", pProfileName, "ptr", pDeviceName, BOOL)
    return result
}
 ...
 */
export WcsDisassociateColorProfileFromDevice(scope, pProfileName, pDeviceName) {
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName

    result := DllCall("mscms.dll\WcsDisassociateColorProfileFromDevice", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", pProfileName, "ptr", pDeviceName, BOOL)
    return result
}
 ...
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope A [**WCS\_PROFILE\_MANAGEMENT\_SCOPE**](/windows/win32/api/icm/ne-icm-wcs_profile_management_scope) value that specifies the scope of the profile management operation that is performed by this function.
 * @param {Pointer<ENUMTYPEW>} pEnumRecord A pointer to a structure that specifies the enumeration criteria.
 * @param {Pointer<Integer>} pdwSize A pointer to a variable that receives the size of the buffer that is required to receive all enumerated profile names. This value is used by the *dwSize* parameter of the [**WcsEnumColorProfiles**](/windows/win32/api/icm/nf-icm-wcsenumcolorprofiles) function.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
 ...
 * 
 * This function is executable in Least-Privileged User Account (LUA) context.
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope A [**WCS\_PROFILE\_MANAGEMENT\_SCOPE**](/windows/win32/api/icm/ne-icm-wcs_profile_management_scope) value specifying the scope of this profile management operation.
 * @param {Pointer<ENUMTYPEW>} pEnumRecord A pointer to a structure specifying the enumeration criteria.
 * @param {Integer} pBuffer A pointer to a buffer in which the profile names are to be enumerated. The **WcsEnumColorProfiles** function places, in this buffer, a MULTI\_SZ string that consists of profile names that satisfy the criteria specified in *\*pEnumRecord*.
 * @param {Integer} dwSize A variable that contains the size, in bytes, of the buffer that is pointed to by *pBuffer*. See **Remarks**.
 * @param {Pointer<Integer>} pnProfiles An optional pointer to a variable that receives the number of profile names that are copied to the buffer to which *pBuffer* points. Can be **NULL** if this information is not needed.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export WcsEnumColorProfiles(scope, pEnumRecord, pBuffer, dwSize, pnProfiles) {
    ...
    result := DllCall("mscms.dll\WcsEnumColorProfiles", WCS_PROFILE_MANAGEMENT_SCOPE, scope, ENUMTYPEW.Ptr, pEnumRecord, "ptr", pBuffer, "uint", dwSize, pnProfilesMarshal, pnProfiles, BOOL)
    return result
}
 ...
 * 
 * This function is executable in Least-Privileged User Account (LUA) context.
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope A [**WCS\_PROFILE\_MANAGEMENT\_SCOPE**](/windows/win32/api/icm/ne-icm-wcs_profile_management_scope) value that specifies the scope of this profile management operation.
 ...
 * @param {COLORPROFILETYPE} cptColorProfileType A [**COLORPROFILETYPE**](/windows/win32/api/icm/ne-icm-colorprofiletype) value specifying the color profile type.
 * @param {COLORPROFILESUBTYPE} cpstColorProfileSubType A [**COLORPROFILESUBTYPE**](/windows/win32/api/icm/ne-icm-colorprofilesubtype) value specifying the color profile subtype.
 * @param {Integer} dwProfileID The ID of the color space that the color profile represents.
 * @param {Pointer<Integer>} pcbProfileName A pointer to a location that receives the size, in bytes, of the path name of the default color profile, including the **NULL** terminator.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export WcsGetDefaultColorProfileSize(scope, pDeviceName, cptColorProfileType, cpstColorProfileSubType, dwProfileID, pcbProfileName) {
    ...
    result := DllCall("mscms.dll\WcsGetDefaultColorProfileSize", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", pDeviceName, COLORPROFILETYPE, cptColorProfileType, COLORPROFILESUBTYPE, cpstColorProfileSubType, "uint", dwProfileID, pcbProfileNameMarshal, pcbProfileName, BOOL)
    return result
}
 ...
 * 
 * This function is executable in Least-Privileged User Account (LUA) context.
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope A [**WCS_PROFILE_MANAGEMENT_SCOPE**](/windows/win32/api/icm/ne-icm-wcs_profile_management_scope) value specifying the scope of this profile management operation.
 ...
 * @param {Integer} pProfileName A pointer to a buffer to receive the name of the color profile. The size of the buffer, in bytes, will be the indicated by *cbProfileName*.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export WcsGetDefaultColorProfile(scope, pDeviceName, cptColorProfileType, cpstColorProfileSubType, dwProfileID, cbProfileName, pProfileName) {
    ...
    result := DllCall("mscms.dll\WcsGetDefaultColorProfile", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", pDeviceName, COLORPROFILETYPE, cptColorProfileType, COLORPROFILESUBTYPE, cpstColorProfileSubType, "uint", dwProfileID, "uint", cbProfileName, "ptr", pProfileName, BOOL)
    return result
}
 ...
 * @param {COLORPROFILETYPE} cptColorProfileType A [**COLORPROFILETYPE**](/windows/win32/api/icm/ne-icm-colorprofiletype) value that specifies the color profile type.
 * @param {COLORPROFILESUBTYPE} cpstColorProfileSubType A [**COLORPROFILESUBTYPE**](/windows/win32/api/icm/ne-icm-colorprofilesubtype) value that specifies the color profile subtype.
 ...
 */
export WcsSetDefaultColorProfile(scope, pDeviceName, cptColorProfileType, cpstColorProfileSubType, dwProfileID, pProfileName) {
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName
    pProfileName := pProfileName is String ? StrPtr(pProfileName) : pProfileName

    result := DllCall("mscms.dll\WcsSetDefaultColorProfile", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", pDeviceName, COLORPROFILETYPE, cptColorProfileType, COLORPROFILESUBTYPE, cpstColorProfileSubType, "uint", dwProfileID, "ptr", pProfileName, BOOL)
    return result
}

/**
 * Sets the default rendering intent in the specified profile management scope.
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope The profile management scope for this operation, which can be system-wide or the current user only.
 ...
 */
export WcsSetDefaultRenderingIntent(scope, dwRenderingIntent) {
    result := DllCall("mscms.dll\WcsSetDefaultRenderingIntent", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "uint", dwRenderingIntent, BOOL)
    return result
}
 ...
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope The profile management scope for this operation, which can be system-wide or the current user only.
 * @param {Pointer<Integer>} pdwRenderingIntent A pointer to the variable that will hold the rendering intent.
 * 
 * For more information, see [Rendering intents](/windows/win32/wcs/rendering-intents).
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
...
export WcsGetUsePerUserProfiles(pDeviceName, dwDeviceClass, pUsePerUserProfiles) {
    ...
    result := DllCall("mscms.dll\WcsGetUsePerUserProfiles", "ptr", pDeviceName, "uint", dwDeviceClass, pUsePerUserProfilesMarshal, pUsePerUserProfiles, BOOL)
    return result
}
 ...
 */
export WcsSetUsePerUserProfiles(pDeviceName, dwDeviceClass, usePerUserProfiles) {
    pDeviceName := pDeviceName is String ? StrPtr(pDeviceName) : pDeviceName

    result := DllCall("mscms.dll\WcsSetUsePerUserProfiles", "ptr", pDeviceName, "uint", dwDeviceClass, BOOL, usePerUserProfiles, BOOL)
    return result
}
 ...
 * @param {COLORDATATYPE} cdtInput The input [**COLORDATATYPE**](/windows/win32/api/icm/ne-icm-colordatatype) color data type.
 * @param {Integer} cbInput The buffer size, in bytes, of *pInputData*.
 * @param {Integer} pInputData A pointer to an array of input colors. The size of the buffer for this array, in bytes, is the **DWORD** value of *cbInput*.
 * @param {Integer} nOutputChannels The number of channels per element in the array to which *pOutputData* points.
 * @param {COLORDATATYPE} cdtOutput The [**COLORDATATYPE**](/windows/win32/api/icm/ne-icm-colordatatype) output that specified the color data type.
 * @param {Integer} cbOutput The buffer size, in bytes, of *pOutputData*.
 * @param {Integer} pOutputData A pointer to an array of colors that receives the results of the color translation.The size of the buffer for this array, in bytes, is the **DWORD** value of *cbOutput*.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
 * @see https://learn.microsoft.com/windows/win32/api/icm/nf-icm-wcstranslatecolors
 */
export WcsTranslateColors(hColorTransform, nColors, nInputChannels, cdtInput, cbInput, pInputData, nOutputChannels, cdtOutput, cbOutput, pOutputData) {
    result := DllCall("mscms.dll\WcsTranslateColors", "ptr", hColorTransform, "uint", nColors, "uint", nInputChannels, COLORDATATYPE, cdtInput, "uint", cbInput, "ptr", pInputData, "uint", nOutputChannels, COLORDATATYPE, cdtOutput, "uint", cbOutput, "ptr", pOutputData, BOOL)
    return result
}
 ...
 * @param {COLORDATATYPE} cdtInput The input COLORDATATYPE color data type.
 * @param {Integer} cbInput The buffer size of *pInputData*.
 * @param {Integer} pInputData A pointer to an array of input colors. Colors in this array correspond to the color space of the source profile. The size of the buffer for this array will be the number of bytes indicated by *cbInput*.
 * @param {Pointer<Integer>} paResult A pointer to an array of *nColors* bytes that receives the results of the test.
 * @returns {BOOL} If this function succeeds, the return value is **TRUE**.
 * 
 * If this function fails, the return value is **FALSE**. For extended error information, call **GetLastError**.
...
export WcsCheckColors(hColorTransform, nColors, nInputChannels, cdtInput, cbInput, pInputData, paResult) {
    ...
    result := DllCall("mscms.dll\WcsCheckColors", "ptr", hColorTransform, "uint", nColors, "uint", nInputChannels, COLORDATATYPE, cdtInput, "uint", cbInput, "ptr", pInputData, paResultMarshal, paResult, BOOL)
    return result
}
...
export CMCheckColors(hcmTransform, lpaInputColors, nColors, ctInput, lpaResult) {
    ...
    result := DllCall("ICM32.dll\CMCheckColors", "ptr", hcmTransform, COLOR.Ptr, lpaInputColors, "uint", nColors, COLORTYPE, ctInput, lpaResultMarshal, lpaResult, BOOL)
    return result
}
...
export CMCheckRGBs(hcmTransform, lpSrcBits, bmInput, dwWidth, dwHeight, dwStride, lpaResult, _pfnCallback, ulCallbackData) {
    ...
    result := DllCall("ICM32.dll\CMCheckRGBs", "ptr", hcmTransform, lpSrcBitsMarshal, lpSrcBits, BMFORMAT, bmInput, "uint", dwWidth, "uint", dwHeight, "uint", dwStride, lpaResultMarshal, lpaResult, "ptr", _pfnCallback, LPARAM, ulCallbackData, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer<Integer>>} paColorName Pointer to an array of color name structures.
 * @param {Pointer<Integer>} paIndex Pointer to an array of **DWORDS** that this function fills with the indices.
 * @param {Integer} dwCount The number of color names to convert.
 * @returns {BOOL} If this function succeeds with the conversion, the return value is **TRUE**.
 * 
...
export CMConvertColorNameToIndex(hProfile, paColorName, paIndex, dwCount) {
    ...
    result := DllCall("ICM32.dll\CMConvertColorNameToIndex", "ptr", hProfile, paColorNameMarshal, paColorName, paIndexMarshal, paIndex, "uint", dwCount, BOOL)
    return result
}
 ...
 * @param {Pointer<Integer>} paIndex Pointer to an array of color-space index numbers.
 * @param {Pointer<Pointer<Integer>>} paColorName Pointer to an array of color name structures.
 * @param {Integer} dwCount The number of indices to convert.
 * @returns {BOOL} If this conversion function succeeds, the return value is TRUE.
 * 
...
export CMConvertIndexToColorName(hProfile, paIndex, paColorName, dwCount) {
    ...
    result := DllCall("ICM32.dll\CMConvertIndexToColorName", "ptr", hProfile, paIndexMarshal, paIndex, paColorNameMarshal, paColorName, "uint", dwCount, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer>} pahProfiles Pointer to an array of profile handles.
 * @param {Integer} nProfiles Specifies the number of profiles in the array.
 * @param {Pointer<Integer>} padwIntents An array of rendering intents.
 * @param {Integer} nIntents The number of elements in the array of intents.
 * @param {Integer} dwFlags Specifies flags to used control creation of the transform. For details, see [CMM Transform Creation Flags](/windows/win32/wcs/cmm-transform-creation-flags).
 * @param {Pointer<Pointer<Integer>>} lpProfileData Pointer to a pointer to a buffer. If successful the function allocates and fills this buffer. The calling application must free this buffer when it is no longer needed. Use the **GlobalFree** function to free this buffer.
...
export CMCreateDeviceLinkProfile(pahProfiles, nProfiles, padwIntents, nIntents, dwFlags, lpProfileData) {
    ...
    result := DllCall("ICM32.dll\CMCreateDeviceLinkProfile", pahProfilesMarshal, pahProfiles, "uint", nProfiles, padwIntentsMarshal, padwIntents, "uint", nIntents, "uint", dwFlags, lpProfileDataMarshal, lpProfileData, BOOL)
    return result
}
 ...
 * @param {Pointer<Pointer>} pahProfiles Points to an array of profile handles.
 * @param {Integer} nProfiles Specifies the number of profiles in the array.
 * @param {Pointer<Integer>} padwIntents 
...
export CMCreateMultiProfileTransform(pahProfiles, nProfiles, padwIntents, nIntents, dwFlags) {
    ...
    result := DllCall("ICM32.dll\CMCreateMultiProfileTransform", pahProfilesMarshal, pahProfiles, "uint", nProfiles, padwIntentsMarshal, padwIntents, "uint", nIntents, "uint", dwFlags, IntPtr)
    return result
}
 ...
 * @param {Pointer<Pointer<Void>>} lpProfileData Pointer to a pointer to a buffer. If successful the function allocates and fills this buffer. It is the calling application's responsibility to free this buffer when it is no longer needed.
...
export CMCreateTransformExt(lpColorSpace, lpDevCharacter, lpTargetDevCharacter, dwFlags) {
    ...
    result := DllCall("ICM32.dll\CMCreateTransformExt", LOGCOLORSPACEA.Ptr, lpColorSpace, lpDevCharacterMarshal, lpDevCharacter, lpTargetDevCharacterMarshal, lpTargetDevCharacter, "uint", dwFlags, IntPtr)
    return result
}
 ...
 * @param {Integer} lpaResult Points to the buffer in which to put results.
 *     
 ...
 */
export CMCheckColorsInGamut(hcmTransform, lpaRGBTriple, lpaResult, nCount) {
    result := DllCall("ICM32.dll\CMCheckColorsInGamut", "ptr", hcmTransform, RGBTRIPLE.Ptr, lpaRGBTriple, "ptr", lpaResult, "uint", nCount, BOOL)
    return result
}
 ...
 * @param {COLORREF} _ColorRef The RGBQuad to translate.
...
export CMTranslateRGB(hcmTransform, _ColorRef, lpColorRef, dwFlags) {
    ...
    result := DllCall("ICM32.dll\CMTranslateRGB", "ptr", hcmTransform, COLORREF, _ColorRef, lpColorRefMarshal, lpColorRef, "uint", dwFlags, BOOL)
    return result
}
 ...
 * @param {BMFORMAT} bmInput Specifies the input bitmap format.
 * @param {Integer} dwWidth Specifies the number of pixels per scan line in the input bitmap.
 * @param {Integer} dwHeight Specifies the number of scan lines in the input bitmap.
 ...
 * @param {BMFORMAT} bmOutput Specifies the output bitmap format.
...
export CMTranslateRGBs(hcmTransform, lpSrcBits, bmInput, dwWidth, dwHeight, dwStride, lpDestBits, bmOutput, dwTranslateDirection) {
    ...
    result := DllCall("ICM32.dll\CMTranslateRGBs", "ptr", hcmTransform, lpSrcBitsMarshal, lpSrcBits, BMFORMAT, bmInput, "uint", dwWidth, "uint", dwHeight, "uint", dwStride, lpDestBitsMarshal, lpDestBits, BMFORMAT, bmOutput, "uint", dwTranslateDirection, BOOL)
    return result
}
...
export CMCreateTransformExtW(lpColorSpace, lpDevCharacter, lpTargetDevCharacter, dwFlags) {
    ...
    result := DllCall("ICM32.dll\CMCreateTransformExtW", LOGCOLORSPACEW.Ptr, lpColorSpace, lpDevCharacterMarshal, lpDevCharacter, lpTargetDevCharacterMarshal, lpTargetDevCharacter, "uint", dwFlags, IntPtr)
    return result
}
 ...
 */
export CMDeleteTransform(hcmTransform) {
    result := DllCall("ICM32.dll\CMDeleteTransform", "ptr", hcmTransform, BOOL)
    return result
}
 ...
 */
export CMGetInfo(dwInfo) {
    result := DllCall("ICM32.dll\CMGetInfo", "uint", dwInfo, UInt32)
    return result
}
 ...
 */
export CMGetNamedProfileInfo(hProfile, pNamedProfileInfo) {
    result := DllCall("ICM32.dll\CMGetNamedProfileInfo", "ptr", hProfile, NAMED_PROFILE_INFO.Ptr, pNamedProfileInfo, BOOL)
    return result
}
...
export CMIsProfileValid(hProfile, lpbValid) {
    ...
    result := DllCall("ICM32.dll\CMIsProfileValid", "ptr", hProfile, lpbValidMarshal, lpbValid, BOOL)
    return result
}
 ...
 * @param {Integer} nColors Specifies the number of elements in the array.
 * @param {COLORTYPE} ctInput Specifies the color type of the input.
 ...
 */
export CMTranslateColors(hcmTransform, lpaInputColors, nColors, ctInput, lpaOutputColors, ctOutput) {
    result := DllCall("ICM32.dll\CMTranslateColors", "ptr", hcmTransform, COLOR.Ptr, lpaInputColors, "uint", nColors, COLORTYPE, ctInput, COLOR.Ptr, lpaOutputColors, COLORTYPE, ctOutput, BOOL)
    return result
}
...
export CMTranslateRGBsExt(hcmTransform, lpSrcBits, bmInput, dwWidth, dwHeight, dwInputStride, lpDestBits, bmOutput, dwOutputStride, lpfnCallback, ulCallbackData) {
    ...
    result := DllCall("ICM32.dll\CMTranslateRGBsExt", "ptr", hcmTransform, lpSrcBitsMarshal, lpSrcBits, BMFORMAT, bmInput, "uint", dwWidth, "uint", dwHeight, "uint", dwInputStride, lpDestBitsMarshal, lpDestBits, BMFORMAT, bmOutput, "uint", dwOutputStride, "ptr", lpfnCallback, LPARAM, ulCallbackData, BOOL)
    return result
}
...
export WcsOpenColorProfileA(pCDMPProfile, pCAMPProfile, pGMMPProfile, dwDesireAccess, dwShareMode, dwCreationMode, dwFlags) {
    result := DllCall("mscms.dll\WcsOpenColorProfileA", PROFILE.Ptr, pCDMPProfile, PROFILE.Ptr, pCAMPProfile, PROFILE.Ptr, pGMMPProfile, "uint", dwDesireAccess, "uint", dwShareMode, "uint", dwCreationMode, "uint", dwFlags, IntPtr)
    return result
}
...
export WcsOpenColorProfileW(pCDMPProfile, pCAMPProfile, pGMMPProfile, dwDesireAccess, dwShareMode, dwCreationMode, dwFlags) {
    result := DllCall("mscms.dll\WcsOpenColorProfileW", PROFILE.Ptr, pCDMPProfile, PROFILE.Ptr, pCAMPProfile, PROFILE.Ptr, pGMMPProfile, "uint", dwDesireAccess, "uint", dwShareMode, "uint", dwCreationMode, "uint", dwFlags, IntPtr)
    return result
}
 ...
 */
export WcsCreateIccProfile(hWcsProfile, dwOptions) {
    result := DllCall("mscms.dll\WcsCreateIccProfile", "ptr", hWcsProfile, "uint", dwOptions, IntPtr)
    return result
}
 ...
 */
export WcsSetCalibrationManagementState(bIsEnabled) {
    result := DllCall("mscms.dll\WcsSetCalibrationManagementState", BOOL, bIsEnabled, BOOL)
    return result
}
 ...
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope Specifies the association as system-wide or the current user.
 ...
 */
export ColorProfileAddDisplayAssociation(scope, profileName, targetAdapterID, sourceID, setAsDefault, associateAsAdvancedColor) {
    profileName := profileName is String ? StrPtr(profileName) : profileName

    result := DllCall("mscms.dll\ColorProfileAddDisplayAssociation", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", profileName, LUID, targetAdapterID, "uint", sourceID, BOOL, setAsDefault, BOOL, associateAsAdvancedColor, "HRESULT")
    return result
}
 ...
 */
export ColorProfileRemoveDisplayAssociation(scope, profileName, targetAdapterID, sourceID, dissociateAdvancedColor) {
    profileName := profileName is String ? StrPtr(profileName) : profileName

    result := DllCall("mscms.dll\ColorProfileRemoveDisplayAssociation", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", profileName, LUID, targetAdapterID, "uint", sourceID, BOOL, dissociateAdvancedColor, "HRESULT")
    return result
}
 ...
 * @param {WCS_PROFILE_MANAGEMENT_SCOPE} scope Specifies the association as system-wide or the current user.
 * @param {PWSTR} profileName Identifies the installed profile to associate.
 * @param {COLORPROFILETYPE} profileType The type of color profile to set as default (currently only CPT_ICC is supported).
 * @param {COLORPROFILESUBTYPE} profileSubType The subtype of the color profile to set as default.
 * @param {LUID} targetAdapterID An identifier assigned to the adapter (e.g. GPU) of the target display. See [Remarks](#remarks) for more details.
 * @param {Integer} sourceID An identifier assigned to the source of the display. See [Remarks](#remarks) for more details.
 * @returns {HRESULT} **S_OK** for success, or a failure **HRESULT** value
 * @see https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilesetdisplaydefaultassociation
 */
export ColorProfileSetDisplayDefaultAssociation(scope, profileName, profileType, profileSubType, targetAdapterID, sourceID) {
    profileName := profileName is String ? StrPtr(profileName) : profileName

    result := DllCall("mscms.dll\ColorProfileSetDisplayDefaultAssociation", WCS_PROFILE_MANAGEMENT_SCOPE, scope, "ptr", profileName, COLORPROFILETYPE, profileType, COLORPROFILESUBTYPE, profileSubType, LUID, targetAdapterID, "uint", sourceID, "HRESULT")
    return result
}
...
export ColorProfileGetDisplayList(scope, targetAdapterID, sourceID, profileList, profileCount) {
    ...
    result := DllCall("mscms.dll\ColorProfileGetDisplayList", WCS_PROFILE_MANAGEMENT_SCOPE, scope, LUID, targetAdapterID, "uint", sourceID, profileListMarshal, profileList, profileCountMarshal, profileCount, "HRESULT")
    return result
}
 ...
 * @param {LUID} targetAdapterID An identifier assigned to the adapter (e.g. GPU) of the target display. See [Remarks](#remarks) for more details.
 * @param {Integer} sourceID An identifier assigned to the source of the display. See [Remarks](#remarks) for more details.
 * @param {COLORPROFILETYPE} profileType The type of color profile to return (currently only CPT_ICC is supported).
 * @param {COLORPROFILESUBTYPE} profileSubType The subtype of the color profile to return.
 ...
 */
export ColorProfileGetDisplayDefault(scope, targetAdapterID, sourceID, profileType, profileSubType) {
    result := DllCall("mscms.dll\ColorProfileGetDisplayDefault", WCS_PROFILE_MANAGEMENT_SCOPE, scope, LUID, targetAdapterID, "uint", sourceID, COLORPROFILETYPE, profileType, COLORPROFILESUBTYPE, profileSubType, PWSTR.Ptr, &profileName := 0, "HRESULT")
    return profileName
}
 ...
 * @param {LUID} targetAdapterID An identifier assigned to the adapter (e.g. GPU) of the target display. See [Remarks](#remarks) for more details.
 * @param {Integer} sourceID An identifier assigned to the source of the display. See [Remarks](#remarks) for more details.
 * @returns {WCS_PROFILE_MANAGEMENT_SCOPE} Returns the scope of the currently selected color profile - either the current user or system.
 * @see https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilegetdisplayuserscope
 */
export ColorProfileGetDisplayUserScope(targetAdapterID, sourceID) {
    result := DllCall("mscms.dll\ColorProfileGetDisplayUserScope", LUID, targetAdapterID, "uint", sourceID, "int*", &scope := 0, "HRESULT")
    return scope
}
 ...
 * @param {WCS_DEVICE_CAPABILITIES_TYPE} capsType 
 * @returns {Void} 
 */
export ColorProfileGetDeviceCapabilities(scope, targetAdapterID, sourceID, capsType) {
    result := DllCall("mscms.dll\ColorProfileGetDeviceCapabilities", WCS_PROFILE_MANAGEMENT_SCOPE, scope, LUID, targetAdapterID, "uint", sourceID, WCS_DEVICE_CAPABILITIES_TYPE, capsType, "ptr", &outputCapabilities := 0, "HRESULT")
