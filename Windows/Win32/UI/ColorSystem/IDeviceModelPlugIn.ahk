 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nn-wcsplugin-idevicemodelplugin
...
class IDeviceModelPlugIn extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getnumchannels
     */
    GetNumChannels() {
        result := ComCall(4, this, "uint*", &pNumChannels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-devicetocolorimetriccolors
     */
    DeviceToColorimetricColors(cColors, cChannels, pDeviceValues) {
        ...
        result := ComCall(5, this, "uint", cColors, "uint", cChannels, pDeviceValuesMarshal, pDeviceValues, "ptr", pXYZColors, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-colorimetrictodevicecolors
     */
    ColorimetricToDeviceColors(cColors, cChannels, pXYZColors) {
        result := ComCall(6, this, "uint", cColors, "uint", cChannels, "ptr", pXYZColors, "float*", &pDeviceValues := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-colorimetrictodevicecolorswithblack
     */
    ColorimetricToDeviceColorsWithBlack(cColors, cChannels, pXYZColors, pBlackInformation) {
        result := ComCall(7, this, "uint", cColors, "uint", cChannels, "ptr", pXYZColors, "ptr", pBlackInformation, "float*", &pDeviceValues := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this function fails, the return value is E_FAIL.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-settransformdevicemodelinfo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getprimarysamples
     */
    GetPrimarySamples() {
     ...
     * 
     * If this function fails, the return value is E_FAIL.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getgamutboundarymeshsize
     */
    GetGamutBoundaryMeshSize(pNumVertices, pNumTriangles) {
        ...
        result := ComCall(10, this, pNumVerticesMarshal, pNumVertices, pNumTrianglesMarshal, pNumTriangles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this function fails, the return value is E_FAIL.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getgamutboundarymesh
     */
    GetGamutBoundaryMesh(cChannels, cVertices, cTriangles, pVertices, pTriangles) {
        pVerticesMarshal := pVertices is VarRef ? "float*" : "ptr"

        result := ComCall(11, this, "uint", cChannels, "uint", cVertices, "uint", cTriangles, pVerticesMarshal, pVertices, "ptr", pTriangles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getneutralaxissize
     */
    GetNeutralAxisSize() {
        result := ComCall(12, this, "uint*", &pcColors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcsplugin/nf-wcsplugin-idevicemodelplugin-getneutralaxis
     */
