 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nn-xamlom-ivisualtreeservicecallback2
...
class IVisualTreeServiceCallback2 extends IVisualTreeServiceCallback{
     ...
     * @param {PWSTR} context_ The path to the element.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nf-xamlom-ivisualtreeservicecallback2-onelementstatechanged
     */
    OnElementStateChanged(element, elementState, context_) {
        context_ := context_ is String ? StrPtr(context_) : context_

        result := ComCall(4, this, "uint", element, "int", elementState, "ptr", context_, "int")
        if(result != 0) {
