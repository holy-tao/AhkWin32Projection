...
class IVisualTreeService2 extends IVisualTreeService{
    ...
    GetProperty(object, propertyIndex, pValue) {
        result := ComCall(16, this, "uint", object, "uint", propertyIndex, "uint*", pValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RenderTargetBitmap(handle, options, maxPixelWidth, maxPixelHeight, ppBitmapData) {
        result := ComCall(18, this, "uint", handle, "int", options, "uint", maxPixelWidth, "uint", maxPixelHeight, "ptr", ppBitmapData, "int")
        if(result != 0)
            throw OSError(result)
