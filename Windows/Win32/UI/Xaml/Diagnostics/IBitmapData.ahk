 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nn-xamlom-ibitmapdata
...
class IBitmapData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nf-xamlom-ibitmapdata-copybytesto
     */
    CopyBytesTo(sourceOffsetInBytes, maxBytesToCopy, pvBytes, numberOfBytesCopied) {
        ...
        result := ComCall(3, this, "uint", sourceOffsetInBytes, "uint", maxBytesToCopy, pvBytesMarshal, pvBytes, numberOfBytesCopiedMarshal, numberOfBytesCopied, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nf-xamlom-ibitmapdata-getstride
     */
    GetStride() {
        result := ComCall(4, this, "uint*", &pStride := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nf-xamlom-ibitmapdata-getbitmapdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xamlom/nf-xamlom-ibitmapdata-getsourcebitmapdescription
     */
