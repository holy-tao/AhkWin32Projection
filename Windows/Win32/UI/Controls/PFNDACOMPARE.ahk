 ...
 * @see https://learn.microsoft.com/windows/win32/api/dpa_dsa/nc-dpa_dsa-pfndacompare
 * @namespace Windows.Win32.UI.Controls
 */
export default struct PFNDACOMPARE {
    value : IntPtr

    __value {
        set {
            if (value is PFNDACOMPARE) {
     ...
     * @param {Pointer<Void>} p2 Type: <b>void*</b>
     * 
     ...
     * 
     * The meaning of the return values depends on the function that uses this callback prototype. The return values for <a href="https://docs.microsoft.com/windows/desktop/api/dpa_dsa/nf-dpa_dsa-dsa_sort">DSA_Sort</a> are the following.
     *                         
     *                         
     * 
     * 
    ...
    /**
     * A PFNDACOMPARE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFNDACOMPARE {
        /**
         * Creates a PFNDACOMPARE pointer that invokes the given AHK function when called.
