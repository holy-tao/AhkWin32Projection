...
export default struct ITextFont extends IDispatch {
    ...
    */
    ...
    SetDuplicate(pFont) {
        ...
        result := ComCall(8, this, pFontMarshal, pFont, "HRESULT")
        return result
    }
    ...
    IsEqual(pFont) {
        ...
        result := ComCall(10, this, pFontMarshal, pFont, "int*", &pValue := 0, "HRESULT")
        return pValue
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetAllCaps := CallbackCreate(ObjBindMethod(implObj, "GetAllCaps"), flags, 2)
        this.vtbl.SetAllCaps := CallbackCreate(ObjBindMethod(implObj, "SetAllCaps"), flags, 2)
        this.vtbl.GetAnimation := CallbackCreate(ObjBindMethod(implObj, "GetAnimation"), flags, 2)
        this.vtbl.SetAnimation := CallbackCreate(ObjBindMethod(implObj, "SetAnimation"), flags, 2)
        this.vtbl.GetBackColor := CallbackCreate(ObjBindMethod(implObj, "GetBackColor"), flags, 2)
        this.vtbl.SetBackColor := CallbackCreate(ObjBindMethod(implObj, "SetBackColor"), flags, 2)
        this.vtbl.GetBold := CallbackCreate(ObjBindMethod(implObj, "GetBold"), flags, 2)
        this.vtbl.SetBold := CallbackCreate(ObjBindMethod(implObj, "SetBold"), flags, 2)
        this.vtbl.GetEmboss := CallbackCreate(ObjBindMethod(implObj, "GetEmboss"), flags, 2)
        this.vtbl.SetEmboss := CallbackCreate(ObjBindMethod(implObj, "SetEmboss"), flags, 2)
        this.vtbl.GetForeColor := CallbackCreate(ObjBindMethod(implObj, "GetForeColor"), flags, 2)
        this.vtbl.SetForeColor := CallbackCreate(ObjBindMethod(implObj, "SetForeColor"), flags, 2)
        this.vtbl.GetHidden := CallbackCreate(ObjBindMethod(implObj, "GetHidden"), flags, 2)
        this.vtbl.SetHidden := CallbackCreate(ObjBindMethod(implObj, "SetHidden"), flags, 2)
        this.vtbl.GetEngrave := CallbackCreate(ObjBindMethod(implObj, "GetEngrave"), flags, 2)
        this.vtbl.SetEngrave := CallbackCreate(ObjBindMethod(implObj, "SetEngrave"), flags, 2)
        this.vtbl.GetItalic := CallbackCreate(ObjBindMethod(implObj, "GetItalic"), flags, 2)
        this.vtbl.SetItalic := CallbackCreate(ObjBindMethod(implObj, "SetItalic"), flags, 2)
        this.vtbl.GetKerning := CallbackCreate(ObjBindMethod(implObj, "GetKerning"), flags, 2)
        this.vtbl.SetKerning := CallbackCreate(ObjBindMethod(implObj, "SetKerning"), flags, 2)
        this.vtbl.GetLanguageID := CallbackCreate(ObjBindMethod(implObj, "GetLanguageID"), flags, 2)
        ...
        this.vtbl.GetOutline := CallbackCreate(ObjBindMethod(implObj, "GetOutline"), flags, 2)
        this.vtbl.SetOutline := CallbackCreate(ObjBindMethod(implObj, "SetOutline"), flags, 2)
        ...
        this.vtbl.GetProtected := CallbackCreate(ObjBindMethod(implObj, "GetProtected"), flags, 2)
        this.vtbl.SetProtected := CallbackCreate(ObjBindMethod(implObj, "SetProtected"), flags, 2)
        this.vtbl.GetShadow := CallbackCreate(ObjBindMethod(implObj, "GetShadow"), flags, 2)
        this.vtbl.SetShadow := CallbackCreate(ObjBindMethod(implObj, "SetShadow"), flags, 2)
        ...
        this.vtbl.GetSmallCaps := CallbackCreate(ObjBindMethod(implObj, "GetSmallCaps"), flags, 2)
        this.vtbl.SetSmallCaps := CallbackCreate(ObjBindMethod(implObj, "SetSmallCaps"), flags, 2)
        this.vtbl.GetSpacing := CallbackCreate(ObjBindMethod(implObj, "GetSpacing"), flags, 2)
        this.vtbl.SetSpacing := CallbackCreate(ObjBindMethod(implObj, "SetSpacing"), flags, 2)
        this.vtbl.GetStrikeThrough := CallbackCreate(ObjBindMethod(implObj, "GetStrikeThrough"), flags, 2)
        this.vtbl.SetStrikeThrough := CallbackCreate(ObjBindMethod(implObj, "SetStrikeThrough"), flags, 2)
        this.vtbl.GetSubscript := CallbackCreate(ObjBindMethod(implObj, "GetSubscript"), flags, 2)
        this.vtbl.SetSubscript := CallbackCreate(ObjBindMethod(implObj, "SetSubscript"), flags, 2)
        this.vtbl.GetSuperscript := CallbackCreate(ObjBindMethod(implObj, "GetSuperscript"), flags, 2)
        this.vtbl.SetSuperscript := CallbackCreate(ObjBindMethod(implObj, "SetSuperscript"), flags, 2)
        this.vtbl.GetUnderline := CallbackCreate(ObjBindMethod(implObj, "GetUnderline"), flags, 2)
        this.vtbl.SetUnderline := CallbackCreate(ObjBindMethod(implObj, "SetUnderline"), flags, 2)
        this.vtbl.GetWeight := CallbackCreate(ObjBindMethod(implObj, "GetWeight"), flags, 2)
        this.vtbl.SetWeight := CallbackCreate(ObjBindMethod(implObj, "SetWeight"), flags, 2)
    }
