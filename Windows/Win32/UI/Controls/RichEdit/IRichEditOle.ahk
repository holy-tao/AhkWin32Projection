...
export default struct IRichEditOle extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetObjectCount := CallbackCreate(ObjBindMethod(implObj, "GetObjectCount"), flags, 1)
        this.vtbl.GetLinkCount := CallbackCreate(ObjBindMethod(implObj, "GetLinkCount"), flags, 1)
        this.vtbl.GetObject := CallbackCreate(ObjBindMethod(implObj, "GetObject"), flags, 4)
        this.vtbl.InsertObject := CallbackCreate(ObjBindMethod(implObj, "InsertObject"), flags, 2)
        this.vtbl.ConvertObject := CallbackCreate(ObjBindMethod(implObj, "ConvertObject"), flags, 4)
        this.vtbl.ActivateAs := CallbackCreate(ObjBindMethod(implObj, "ActivateAs"), flags, 3)
        this.vtbl.SetHostNames := CallbackCreate(ObjBindMethod(implObj, "SetHostNames"), flags, 3)
        this.vtbl.SetLinkAvailable := CallbackCreate(ObjBindMethod(implObj, "SetLinkAvailable"), flags, 3)
        this.vtbl.SetDvaspect := CallbackCreate(ObjBindMethod(implObj, "SetDvaspect"), flags, 3)
        this.vtbl.HandsOffStorage := CallbackCreate(ObjBindMethod(implObj, "HandsOffStorage"), flags, 2)
        ...
        this.vtbl.ImportDataObject := CallbackCreate(ObjBindMethod(implObj, "ImportDataObject"), flags, 4)
    }
