...
class ITextSelection extends ITextRange{
     ...
     */
    GetFlags(pFlags) {
        result := ComCall(58, this, "int*", pFlags, "int")
        if(result != 0)
     ...
     */
    GetType(pType) {
        result := ComCall(60, this, "int*", pType, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveLeft(Unit, Count, Extend, pDelta) {
        result := ComCall(61, this, "int", Unit, "int", Count, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveRight(Unit, Count, Extend, pDelta) {
        result := ComCall(62, this, "int", Unit, "int", Count, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveUp(Unit, Count, Extend, pDelta) {
        result := ComCall(63, this, "int", Unit, "int", Count, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveDown(Unit, Count, Extend, pDelta) {
        result := ComCall(64, this, "int", Unit, "int", Count, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    HomeKey(Unit, Extend, pDelta) {
        result := ComCall(65, this, "int", Unit, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EndKey(Unit, Extend, pDelta) {
        result := ComCall(66, this, "int", Unit, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    TypeText(bstr) {
        ...
        result := ComCall(67, this, "ptr", bstr, "int")
        if(result != 0)
            throw OSError(result)
