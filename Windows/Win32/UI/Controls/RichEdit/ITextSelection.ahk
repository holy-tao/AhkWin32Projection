 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tom/nn-tom-itextselection
...
class ITextSelection extends ITextRange{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextselection-getflags
     */
    GetFlags() {
        result := ComCall(58, this, "int*", &pFlags := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextselection-setflags
     */
    SetFlags(Flags) {
        result := ComCall(59, this, "int", Flags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextselection-gettype
     */
    GetType() {
        result := ComCall(60, this, "int*", &pType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    MoveLeft(Unit_, Count, Extend) {
        result := ComCall(61, this, "int", Unit_, "int", Count, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    MoveRight(Unit_, Count, Extend) {
        result := ComCall(62, this, "int", Unit_, "int", Count, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    MoveUp(Unit_, Count, Extend) {
        result := ComCall(63, this, "int", Unit_, "int", Count, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    MoveDown(Unit_, Count, Extend) {
        result := ComCall(64, this, "int", Unit_, "int", Count, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    HomeKey(Unit_, Extend) {
        result := ComCall(65, this, "int", Unit_, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    EndKey(Unit_, Extend) {
        result := ComCall(66, this, "int", Unit_, "int", Extend, "int*", &pDelta := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextselection-typetext
     */
    TypeText(bstr_) {
        if(bstr_ is String) {
        ...
        result := ComCall(67, this, "ptr", bstr_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
