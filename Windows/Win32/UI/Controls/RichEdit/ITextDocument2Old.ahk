...
class ITextDocument2Old extends ITextDocument{
    ...
    GetEffectColor(Index) {
        result := ComCall(28, this, "int", Index, "uint*", &pcr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetCaretType() {
        result := ComCall(29, this, "int*", &pCaretType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetImmContext() {
        result := ComCall(31, this, "int64*", &pContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    ReleaseImmContext(Context_) {
        result := ComCall(32, this, "int64", Context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetPreferredFont(cp, CharRep, Option, CharRepCur, curFontSize, pbstr, pPitchAndFamily, pNewFontSize) {
        ...
        result := ComCall(33, this, "int", cp, "int", CharRep, "int", Option, "int", CharRepCur, "int", curFontSize, "ptr", pbstr, pPitchAndFamilyMarshal, pPitchAndFamily, pNewFontSizeMarshal, pNewFontSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetNotificationMode() {
        result := ComCall(34, this, "int*", &pMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     */
    SetNotificationMode(Mode_) {
        result := ComCall(35, this, "int", Mode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getclientrect
     */
    GetClientRect(Type, pLeft, pTop, pRight, pBottom) {
        ...
        result := ComCall(36, this, "int", Type, pLeftMarshal, pLeft, pTopMarshal, pTop, pRightMarshal, pRight, pBottomMarshal, pBottom, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetSelection2() {
        result := ComCall(37, this, "ptr*", &ppSel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetWindow() {
        result := ComCall(38, this, "int*", &phWnd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetFEFlags() {
        result := ComCall(39, this, "int*", &pFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-updatewindow
     */
    UpdateWindow() {
    ...
    CheckTextLimit(cch, pcch) {
        ...
        result := ComCall(41, this, "int", cch, pcchMarshal, pcch, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    Update(Mode_) {
        result := ComCall(44, this, "int", Mode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetDocumentFont() {
        result := ComCall(46, this, "ptr*", &ppITextFont := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetDocumentPara() {
        result := ComCall(47, this, "ptr*", &ppITextPara := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetCallManager() {
        result := ComCall(48, this, "ptr*", &ppVoid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
