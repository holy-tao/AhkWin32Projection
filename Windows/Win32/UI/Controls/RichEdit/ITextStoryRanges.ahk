 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tom/nn-tom-itextstoryranges
...
class ITextStoryRanges extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextstoryranges-_newenum
     */
    _NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextstoryranges-item
     */
    Item(Index) {
        result := ComCall(8, this, "int", Index, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextstoryranges-getcount
     */
    GetCount() {
