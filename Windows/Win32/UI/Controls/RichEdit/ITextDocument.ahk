...
export default struct ITextDocument extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetStoryCount := CallbackCreate(ObjBindMethod(implObj, "GetStoryCount"), flags, 2)
        this.vtbl.GetStoryRanges := CallbackCreate(ObjBindMethod(implObj, "GetStoryRanges"), flags, 2)
        this.vtbl.GetSaved := CallbackCreate(ObjBindMethod(implObj, "GetSaved"), flags, 2)
        this.vtbl.SetSaved := CallbackCreate(ObjBindMethod(implObj, "SetSaved"), flags, 2)
        this.vtbl.GetDefaultTabStop := CallbackCreate(ObjBindMethod(implObj, "GetDefaultTabStop"), flags, 2)
        this.vtbl.SetDefaultTabStop := CallbackCreate(ObjBindMethod(implObj, "SetDefaultTabStop"), flags, 2)
        this.vtbl.New := CallbackCreate(ObjBindMethod(implObj, "New"), flags, 1)
        ...
        this.vtbl.BeginEditCollection := CallbackCreate(ObjBindMethod(implObj, "BeginEditCollection"), flags, 1)
        this.vtbl.EndEditCollection := CallbackCreate(ObjBindMethod(implObj, "EndEditCollection"), flags, 1)
        this.vtbl.Undo := CallbackCreate(ObjBindMethod(implObj, "Undo"), flags, 3)
        this.vtbl.Redo := CallbackCreate(ObjBindMethod(implObj, "Redo"), flags, 3)
        this.vtbl.Range := CallbackCreate(ObjBindMethod(implObj, "Range"), flags, 4)
        this.vtbl.RangeFromPoint := CallbackCreate(ObjBindMethod(implObj, "RangeFromPoint"), flags, 4)
    }
