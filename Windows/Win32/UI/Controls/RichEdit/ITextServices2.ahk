 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/textserv/nl-textserv-itextservices2
...
class ITextServices2 extends ITextServices{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textserv/nf-textserv-itextservices2-txgetnaturalsize2
     */
    TxGetNaturalSize2(dwAspect, hdcDraw, hicTargetDev, ptd, dwMode, psizelExtent, pwidth, pheight, pascent) {
        ...
        result := ComCall(21, this, "uint", dwAspect, "ptr", hdcDraw, "ptr", hicTargetDev, "ptr", ptd, "uint", dwMode, "ptr", psizelExtent, pwidthMarshal, pwidth, pheightMarshal, pheight, pascentMarshal, pascent, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textserv/nf-textserv-itextservices2-txdrawd2d
     */
