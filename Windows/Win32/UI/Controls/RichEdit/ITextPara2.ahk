 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tom/nn-tom-itextpara2
...
class ITextPara2 extends ITextPara{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-getborders
     */
    GetBorders() {
        result := ComCall(55, this, "ptr*", &ppBorders := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-getduplicate2
     */
    GetDuplicate2() {
        result := ComCall(56, this, "ptr*", &ppPara := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-setduplicate2
     */
    SetDuplicate2(pPara) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-getfontalignment
     */
    GetFontAlignment() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-setfontalignment
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-gethangingpunctuation
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-sethangingpunctuation
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-getsnaptogrid
     */
    GetSnapToGrid() {
        result := ComCall(62, this, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-setsnaptogrid
     */
    SetSnapToGrid(Value) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-gettrimpunctuationatstart
     */
    GetTrimPunctuationAtStart() {
        result := ComCall(64, this, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-settrimpunctuationatstart
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-geteffects
     */
    GetEffects(pValue, pMask) {
        pValueMarshal := pValue is VarRef ? "int*" : "ptr"
        pMaskMarshal := pMask is VarRef ? "int*" : "ptr"

        result := ComCall(66, this, pValueMarshal, pValue, pMaskMarshal, pMask, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The property value.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-getproperty
     */
    GetProperty(Type) {
        result := ComCall(67, this, "int", Type, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-isequal2
     */
    IsEqual2(pPara) {
        result := ComCall(68, this, "ptr", pPara, "int*", &pB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-seteffects
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextpara2-setproperty
     */
