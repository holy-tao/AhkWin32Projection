...
class ITextRange extends IDispatch{
    ...
    SetText(bstr) {
        ...
        result := ComCall(8, this, "ptr", bstr, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetChar(pChar) {
        result := ComCall(9, this, "int*", pChar, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    SetChar(Char) {
        result := ComCall(10, this, "int", Char, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetDuplicate(ppRange) {
        result := ComCall(11, this, "ptr", ppRange, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFormattedText(ppRange) {
        result := ComCall(12, this, "ptr", ppRange, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ITextRange>} pRange 
     * @returns {HRESULT} 
     */
     ...
     */
    GetStart(pcpFirst) {
        result := ComCall(14, this, "int*", pcpFirst, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetEnd(pcpLim) {
        result := ComCall(16, this, "int*", pcpLim, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetFont(ppFont) {
        result := ComCall(18, this, "ptr", ppFont, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetPara(ppPara) {
        result := ComCall(20, this, "ptr", ppPara, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetStoryLength(pCount) {
        result := ComCall(22, this, "int*", pCount, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    Expand(Unit, pDelta) {
        result := ComCall(25, this, "int", Unit, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetIndex(Unit, pIndex) {
        result := ComCall(26, this, "int", Unit, "int*", pIndex, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetIndex(Unit, Index, Extend) {
        result := ComCall(27, this, "int", Unit, "int", Index, "int", Extend, "int")
        if(result != 0)
            throw OSError(result)
    ...
    InRange(pRange, pValue) {
        result := ComCall(29, this, "ptr", pRange, "int*", pValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    InStory(pRange, pValue) {
        result := ComCall(30, this, "ptr", pRange, "int*", pValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    IsEqual(pRange, pValue) {
        result := ComCall(31, this, "ptr", pRange, "int*", pValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    StartOf(Unit, Extend, pDelta) {
        result := ComCall(33, this, "int", Unit, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EndOf(Unit, Extend, pDelta) {
        result := ComCall(34, this, "int", Unit, "int", Extend, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Move(Unit, Count, pDelta) {
        result := ComCall(35, this, "int", Unit, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveStart(Unit, Count, pDelta) {
        result := ComCall(36, this, "int", Unit, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveEnd(Unit, Count, pDelta) {
        result := ComCall(37, this, "int", Unit, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveWhile(Cset, Count, pDelta) {
        result := ComCall(38, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveStartWhile(Cset, Count, pDelta) {
        result := ComCall(39, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveEndWhile(Cset, Count, pDelta) {
        result := ComCall(40, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveUntil(Cset, Count, pDelta) {
        result := ComCall(41, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveStartUntil(Cset, Count, pDelta) {
        result := ComCall(42, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MoveEndUntil(Cset, Count, pDelta) {
        result := ComCall(43, this, "ptr", Cset, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FindText(bstr, Count, Flags, pLength) {
        ...
        result := ComCall(44, this, "ptr", bstr, "int", Count, "int", Flags, "int*", pLength, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FindTextStart(bstr, Count, Flags, pLength) {
        ...
        result := ComCall(45, this, "ptr", bstr, "int", Count, "int", Flags, "int*", pLength, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FindTextEnd(bstr, Count, Flags, pLength) {
        ...
        result := ComCall(46, this, "ptr", bstr, "int", Count, "int", Flags, "int*", pLength, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Delete(Unit, Count, pDelta) {
        result := ComCall(47, this, "int", Unit, "int", Count, "int*", pDelta, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CanPaste(pVar, Format, pValue) {
        result := ComCall(51, this, "ptr", pVar, "int", Format, "int*", pValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Integer} Type 
     * @param {Pointer<Int32>} px 
     * @param {Pointer<Int32>} py 
     * @returns {HRESULT} 
     */
    GetPoint(Type, px, py) {
        result := ComCall(54, this, "int", Type, "int*", px, "int*", py, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetEmbeddedObject(ppObject) {
        result := ComCall(57, this, "ptr", ppObject, "int")
        if(result != 0)
            throw OSError(result)
