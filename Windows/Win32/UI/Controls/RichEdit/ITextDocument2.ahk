...
class ITextDocument2 extends ITextDocument{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getcarettype
     */
    GetCaretType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setcarettype
     */
    SetCaretType(Value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getdisplays
     */
    GetDisplays() {
        result := ComCall(28, this, "ptr*", &ppDisplays := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getdocumentfont
     */
    GetDocumentFont() {
        result := ComCall(29, this, "ptr*", &ppFont := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setdocumentfont
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getdocumentpara
     */
    GetDocumentPara() {
        result := ComCall(31, this, "ptr*", &ppPara := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setdocumentpara
     */
     ...
     * @returns {Integer} Type: <b>long*</b>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-geteastasianflags
     */
    GetEastAsianFlags() {
        result := ComCall(33, this, "int*", &pFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getgenerator
     */
    GetGenerator() {
        pbstr := BSTR()
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setimeinprogress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getnotificationmode
     */
    GetNotificationMode() {
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setnotificationmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getselection2
     */
    GetSelection2() {
        result := ComCall(38, this, "ptr*", &ppSel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getstoryranges2
     */
    GetStoryRanges2() {
        result := ComCall(39, this, "ptr*", &ppStories := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-gettypographyoptions
     */
    GetTypographyOptions() {
        result := ComCall(40, this, "int*", &pOptions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getversion
     */
    GetVersion() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getwindow
     */
    GetWindow() {
        result := ComCall(42, this, "int64*", &pHwnd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-attachmsgfilter
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-checktextlimit
     */
    CheckTextLimit(cch, pcch) {
        pcchMarshal := pcch is VarRef ? "int*" : "ptr"

        result := ComCall(44, this, "int", cch, pcchMarshal, pcch, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getcallmanager
     */
    GetCallManager() {
        result := ComCall(45, this, "ptr*", &ppVoid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getclientrect
     */
    GetClientRect(Type, pLeft, pTop, pRight, pBottom) {
        ...
        result := ComCall(46, this, "int", Type, pLeftMarshal, pLeft, pTopMarshal, pTop, pRightMarshal, pRight, pBottomMarshal, pBottom, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-geteffectcolor
     */
    GetEffectColor(Index) {
        result := ComCall(47, this, "int", Index, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getimmcontext
     */
    GetImmContext() {
        result := ComCall(48, this, "int64*", &pContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getpreferredfont
     */
    GetPreferredFont(cp, CharRep, Options, curCharRep, curFontSize, pbstr, pPitchAndFamily, pNewFontSize) {
        ...
        result := ComCall(49, this, "int", cp, "int", CharRep, "int", Options, "int", curCharRep, "int", curFontSize, "ptr", pbstr, pPitchAndFamilyMarshal, pPitchAndFamily, pNewFontSizeMarshal, pNewFontSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getproperty
     */
    GetProperty(Type) {
        result := ComCall(50, this, "int", Type, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getstrings
     */
    GetStrings() {
        result := ComCall(51, this, "ptr*", &ppStrs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-notify
     */
    Notify(Notify) {
     ...
     * 
     * The new text range.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-range2
     */
    Range2(cpActive, cpAnchor) {
        result := ComCall(53, this, "int", cpActive, "int", cpAnchor, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-rangefrompoint2
     */
    RangeFromPoint2(x, y, Type) {
        result := ComCall(54, this, "int", x, "int", y, "int", Type, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-releasecallmanager
     */
     ...
     * @param {Integer} Context_ Type: <b>int64</b>
     * 
     * The IMM input context to release.
     * @returns {HRESULT} Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">HRESULT</a></b>
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-releaseimmcontext
     */
    ReleaseImmContext(Context_) {
        result := ComCall(56, this, "int64", Context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-seteffectcolor
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setproperty
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-settypographyoptions
     */
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-sysbeep
     */
    SysBeep() {
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-update
     */
    Update(Value) {
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-updatewindow
     */
    UpdateWindow() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getmathproperties
     */
    GetMathProperties() {
        result := ComCall(63, this, "int*", &pOptions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setmathproperties
     */
     ...
     * 
     * The active story.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getactivestory
     */
    GetActiveStory() {
        result := ComCall(65, this, "ptr*", &ppStory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, it returns <b>NOERROR</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-setactivestory
     */
     ...
     * 
     * The main story.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getmainstory
     */
    GetMainStory() {
        result := ComCall(67, this, "ptr*", &ppStory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The new story.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getnewstory
     */
    GetNewStory() {
        result := ComCall(68, this, "ptr*", &ppStory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The story.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextdocument2-getstory
     */
    GetStory(Index) {
        result := ComCall(69, this, "int", Index, "ptr*", &ppStory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
