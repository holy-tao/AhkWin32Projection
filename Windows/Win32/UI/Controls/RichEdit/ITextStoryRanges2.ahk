 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tom/nn-tom-itextstoryranges2
...
class ITextStoryRanges2 extends ITextStoryRanges{
     ...
     * 
     * The range.
     * @see https://learn.microsoft.com/windows/win32/api//content/tom/nf-tom-itextstoryranges2-item2
     */
    Item2(Index) {
        result := ComCall(10, this, "int", Index, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
