...
#Import ".\COMBOBOXEXITEMW.ahk" { COMBOBOXEXITEMW }
 ...
 * @see https://learn.microsoft.com/windows/win32/api/commctrl/ns-commctrl-nmcomboboxexw
 * @namespace Windows.Win32.UI.Controls
 * @charset Unicode
 */
export default struct NMCOMBOBOXEXW {
    #StructPack 8
