...
class IImageList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-add
     */
    Add(hbmImage, hbmMask) {
        ...
        result := ComCall(3, this, "ptr", hbmImage, "ptr", hbmMask, "int*", &pi := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-replaceicon
     */
    ReplaceIcon(i, hicon_) {
        hicon_ := hicon_ is Win32Handle ? NumGet(hicon_, "ptr") : hicon_

        result := ComCall(4, this, "int", i, "ptr", hicon_, "int*", &pi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-setoverlayimage
     */
    SetOverlayImage(iImage, iOverlay_) {
        result := ComCall(5, this, "int", iImage, "int", iOverlay_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-replace
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-addmasked
     */
    AddMasked(hbmImage, crMask) {
        hbmImage := hbmImage is Win32Handle ? NumGet(hbmImage, "ptr") : hbmImage

        result := ComCall(7, this, "ptr", hbmImage, "uint", crMask, "int*", &pi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-draw
     */
    Draw(pimldp) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-remove
     */
    Remove(i) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-geticon
     */
    GetIcon(i, flags) {
        picon := HICON()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getimageinfo
     */
    GetImageInfo(i) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-copy
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-merge
     */
    Merge(i1, punk2, i2, dx, dy, riid) {
        result := ComCall(13, this, "int", i1, "ptr", punk2, "int", i2, "int", dx, "int", dy, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-clone
     */
    Clone(riid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getimagerect
     */
    GetImageRect(i) {
        prc := RECT()
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-geticonsize
     */
    GetIconSize(cx, cy_) {
        cxMarshal := cx is VarRef ? "int*" : "ptr"
        cy_Marshal := cy_ is VarRef ? "int*" : "ptr"

        result := ComCall(16, this, cxMarshal, cx, cy_Marshal, cy_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-seticonsize
     */
    SetIconSize(cx, cy_) {
        result := ComCall(17, this, "int", cx, "int", cy_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getimagecount
     */
    GetImageCount() {
        result := ComCall(18, this, "int*", &pi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-setimagecount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-setbkcolor
     */
    SetBkColor(clrBk) {
        result := ComCall(20, this, "uint", clrBk, "uint*", &pclr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getbkcolor
     */
    GetBkColor() {
        result := ComCall(21, this, "uint*", &pclr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-begindrag
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-enddrag
     */
    EndDrag() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-dragenter
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-dragleave
     */
    DragLeave(hwndLock) {
        hwndLock := hwndLock is Win32Handle ? NumGet(hwndLock, "ptr") : hwndLock
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-dragmove
     */
    DragMove(x, y) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-setdragcursorimage
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-dragshownolock
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getdragimage
     */
    GetDragImage(ppt, pptHotspot, riid, ppv) {
        ppvMarshal := ppv is VarRef ? "ptr*" : "ptr"

        result := ComCall(29, this, "ptr", ppt, "ptr", pptHotspot, "ptr", riid, ppvMarshal, ppv, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getitemflags
     */
    GetItemFlags(i) {
        result := ComCall(30, this, "int", i, "uint*", &dwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commoncontrols/nf-commoncontrols-iimagelist-getoverlayimage
     */
    GetOverlayImage(iOverlay_) {
        result := ComCall(31, this, "int", iOverlay_, "int*", &piIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
