 ...
 * @see https://learn.microsoft.com/windows/win32/api/winuser/nc-winuser-editwordbreakproca
 * @namespace Windows.Win32.UI.Controls
 * @charset ANSI
 */
export default struct EDITWORDBREAKPROCA {
    value : IntPtr

    __value {
        set {
            if (value is EDITWORDBREAKPROCA) {
    ...
    /**
     * 
     * @param {PSTR} lpch Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">LPTSTR</a></b>
     * 
    ...
    /**
     * A EDITWORDBREAKPROCA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends EDITWORDBREAKPROCA {
        /**
         * Creates a EDITWORDBREAKPROCA pointer that invokes the given AHK function when called.
         * @param {Func(PSTR, Int32, Int32, WORD_BREAK_ACTION) => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 4 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [PSTR, Int32, Int32, WORD_BREAK_ACTION, Int32])
        }
