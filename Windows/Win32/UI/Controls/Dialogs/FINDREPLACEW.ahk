 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/ns-commdlg-findreplacew
    ...
    lpstrFindWhat{
        get {
            if(!this.HasProp("__lpstrFindWhat"))
                this.__lpstrFindWhat := PWSTR(this.ptr + 24)
    ...
    lpstrReplaceWith{
        get {
            if(!this.HasProp("__lpstrReplaceWith"))
                this.__lpstrReplaceWith := PWSTR(this.ptr + 32)
    ...
    lpTemplateName{
        get {
            if(!this.HasProp("__lpTemplateName"))
                this.__lpTemplateName := PWSTR(this.ptr + 60)
