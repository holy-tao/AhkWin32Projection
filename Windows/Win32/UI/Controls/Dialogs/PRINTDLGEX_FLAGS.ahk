 ...
 * @version v4.0.30319
 */
class PRINTDLGEX_FLAGS extends Win32BitflagEnum{
     ...
     * @type {Integer (UInt32)}
     */
    static PD_EXCLUSIONFLAGS => 16777216
     ...
     * @type {Integer (UInt32)}
     */
    static PD_NOCURRENTPAGE => 8388608
     ...
     * @type {Integer (UInt32)}
     */
    static PD_USELARGETEMPLATE => 268435456
