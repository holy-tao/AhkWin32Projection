 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/nc-commdlg-lpcchookproc
 * @namespace Windows.Win32.UI.Controls.Dialogs
 */
export default struct LPCCHOOKPROC {
    value : IntPtr

    __value {
        set {
            if (value is LPCCHOOKPROC) {
    ...
    /**
     * 
     * @param {HWND} param0 A handle to the <b>Color</b> dialog box for which the message is intended.
    ...
    /**
     * A LPCCHOOKPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPCCHOOKPROC {
        /**
         * Creates a LPCCHOOKPROC pointer that invokes the given AHK function when called.
