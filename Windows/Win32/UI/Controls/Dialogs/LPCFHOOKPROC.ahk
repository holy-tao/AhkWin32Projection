 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/nc-commdlg-lpcfhookproc
 * @namespace Windows.Win32.UI.Controls.Dialogs
 */
export default struct LPCFHOOKPROC {
    value : IntPtr

    __value {
        set {
            if (value is LPCFHOOKPROC) {
    ...
    /**
     * A LPCFHOOKPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPCFHOOKPROC {
        /**
         * Creates a LPCFHOOKPROC pointer that invokes the given AHK function when called.
