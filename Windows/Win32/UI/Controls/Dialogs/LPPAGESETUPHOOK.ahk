 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/nc-commdlg-lppagesetuphook
 * @namespace Windows.Win32.UI.Controls.Dialogs
 */
export default struct LPPAGESETUPHOOK {
    value : IntPtr

    __value {
        set {
            if (value is LPPAGESETUPHOOK) {
    ...
    /**
     * 
     * @param {HWND} param0 A handle to the <b>Page Setup</b> dialog box for which the message is intended.
     ...
     * 
     * If the <i>unnamedParam2</i> parameter indicates the <a href="https://docs.microsoft.com/windows/desktop/dlgbox/wm-initdialog">WM_INITDIALOG</a> message, <i>unnamedParam4</i> is a pointer to a <a href="https://docs.microsoft.com/windows/win32/api/commdlg/ns-commdlg-pagesetupdlga">PAGESETUPDLG</a> structure containing the values specified when the dialog box was created.
    ...
    /**
     * A LPPAGESETUPHOOK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPPAGESETUPHOOK {
        /**
         * Creates a LPPAGESETUPHOOK pointer that invokes the given AHK function when called.
