 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/nc-commdlg-lpfrhookproc
 * @namespace Windows.Win32.UI.Controls.Dialogs
 */
export default struct LPFRHOOKPROC {
    value : IntPtr

    __value {
        set {
            if (value is LPFRHOOKPROC) {
    ...
    /**
     * 
     * @param {HWND} param0 A handle to the <b>Find</b> or <b>Replace</b> dialog box for which the message is intended.
    ...
    /**
     * A LPFRHOOKPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPFRHOOKPROC {
        /**
         * Creates a LPFRHOOKPROC pointer that invokes the given AHK function when called.
