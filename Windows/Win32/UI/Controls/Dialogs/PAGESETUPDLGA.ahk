 ...
 * @see https://learn.microsoft.com/windows/win32/api/commdlg/ns-commdlg-pagesetupdlga
    ...
    lpPageSetupTemplateName{
        get {
            if(!this.HasProp("__lpPageSetupTemplateName"))
                this.__lpPageSetupTemplateName := PSTR(this.ptr + 104)
    ...
    hPageSetupTemplate{
        get {
            if(!this.HasProp("__hPageSetupTemplate"))
                this.__hPageSetupTemplate := HGLOBAL(this.ptr + 112)
