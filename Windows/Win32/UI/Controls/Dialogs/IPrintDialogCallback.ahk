 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/commdlg/nn-commdlg-iprintdialogcallback
...
class IPrintDialogCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commdlg/nf-commdlg-iprintdialogcallback-initdone
     */
    InitDone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commdlg/nf-commdlg-iprintdialogcallback-selectionchange
     */
    SelectionChange() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/commdlg/nf-commdlg-iprintdialogcallback-handlemessage
     */
    HandleMessage(hDlg, uMsg, wParam_, lParam_, pResult) {
        ...
        result := ComCall(5, this, "ptr", hDlg, "uint", uMsg, "ptr", wParam_, "ptr", lParam_, "ptr", pResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
