 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//commdlg/ns-commdlg-printdlga
    ...
    lpPrintTemplateName{
        get {
            if(!this.HasProp("__lpPrintTemplateName"))
                this.__lpPrintTemplateName := PSTR(this.ptr + 88)
    ...
    lpSetupTemplateName{
        get {
            if(!this.HasProp("__lpSetupTemplateName"))
                this.__lpSetupTemplateName := PSTR(this.ptr + 96)
