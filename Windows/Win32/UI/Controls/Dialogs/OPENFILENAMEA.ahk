 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/commdlg/ns-commdlg-openfilenamea
...
class OPENFILENAMEA extends Win32Struct
{
     ...
     * 
     * The first string in each pair is a display string that describes the filter (for example, "Text Files"), and the second string specifies the filter pattern (for example, <c>"*.TXT"</code>). To specify multiple filter patterns for a single display string, use a semicolon to separate the patterns (for example, <code>"*.TXT;*.DOC;*.BAK"</c>). A pattern string can be a combination of valid file name characters and the asterisk (\*) wildcard character. Do not include spaces in the pattern string.
     * 
