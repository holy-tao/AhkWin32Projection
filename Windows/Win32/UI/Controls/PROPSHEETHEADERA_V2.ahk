 ...
 */
export default struct PROPSHEETHEADERA_V2 {
    #StructPack 8
    ...
    static __New() {
        ...
        DefineProp(this.Prototype, 'pszbmWatermark', { type: PSTR, offset: 72 })
        DefineProp(this.Prototype, 'pszbmHeader', { type: PSTR, offset: 88 })
