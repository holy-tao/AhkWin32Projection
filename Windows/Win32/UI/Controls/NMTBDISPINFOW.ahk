 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//commctrl/ns-commctrl-nmtbdispinfow
 * @namespace Windows.Win32.UI.Controls
 * @version v4.0.30319
 * @charset Unicode
 */
class NMTBDISPINFOW extends Win32Struct
{
    static sizeof => 64
    ...
    pszText{
        get {
            if(!this.HasProp("__pszText"))
                this.__pszText := PWSTR(this.ptr + 48)
