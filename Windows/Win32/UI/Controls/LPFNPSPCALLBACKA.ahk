 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/prsht/nc-prsht-lpfnpspcallbacka
 * @namespace Windows.Win32.UI.Controls
 * @version v4.0.30319
 * @charset ANSI
 */
class LPFNPSPCALLBACKA extends IUnknown {
     ...
     * @param {HWND} hwnd_ 
     * @param {Integer} uMsg 
     * @param {Pointer<PROPSHEETPAGEA>} ppsp 
