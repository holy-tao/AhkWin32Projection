 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomationelement6
...
class IUIAutomationElement6 extends IUIAutomationElement5{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationelement6-get_currentfulldescription
     */
    get_CurrentFullDescription() {
        retVal := BSTR()
        result := ComCall(108, this, "ptr", retVal, "int")
        if(result != 0) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationelement6-get_cachedfulldescription
     */
    get_CachedFullDescription() {
        retVal := BSTR()
        result := ComCall(109, this, "ptr", retVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
