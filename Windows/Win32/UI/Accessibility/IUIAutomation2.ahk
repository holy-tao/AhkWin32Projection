 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomation2
...
class IUIAutomation2 extends IUIAutomation{
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-get_autosetfocus
     */
    get_AutoSetFocus() {
        result := ComCall(58, this, "int*", &autoSetFocus := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-put_autosetfocus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-get_connectiontimeout
     */
    get_ConnectionTimeout() {
        result := ComCall(60, this, "uint*", &timeout := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The duration of the time-out period, in milliseconds.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-put_connectiontimeout
     */
     ...
     * 
     * The duration of the time-out period, in milliseconds.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-get_transactiontimeout
     */
    get_TransactionTimeout() {
        result := ComCall(62, this, "uint*", &timeout := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The duration of the time-out period, in milliseconds.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation2-put_transactiontimeout
     */
