 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomation3
...
class IUIAutomation3 extends IUIAutomation2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation3-addtextedittextchangedeventhandler
     */
    AddTextEditTextChangedEventHandler(element, scope, textEditChangeType_, cacheRequest, handler) {
        result := ComCall(64, this, "ptr", element, "int", scope, "int", textEditChangeType_, "ptr", cacheRequest, "ptr", handler, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomation3-removetextedittextchangedeventhandler
     */
