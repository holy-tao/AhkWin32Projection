 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-irawelementprovidersimple3
...
class IRawElementProviderSimple3 extends IRawElementProviderSimple2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovidersimple3-getmetadatavalue
     */
    GetMetadataValue(targetId, metadataId) {
        returnVal := VARIANT()
        result := ComCall(8, this, "int", targetId, "int", metadataId, "ptr", returnVal, "int")
        if(result != 0) {
