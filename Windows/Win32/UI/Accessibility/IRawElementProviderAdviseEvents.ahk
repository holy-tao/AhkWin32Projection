 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-irawelementprovideradviseevents
...
class IRawElementProviderAdviseEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovideradviseevents-adviseeventadded
     */
    AdviseEventAdded(eventId, propertyIDs) {
        result := ComCall(3, this, "int", eventId, "ptr", propertyIDs, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovideradviseevents-adviseeventremoved
     */
    AdviseEventRemoved(eventId, propertyIDs) {
        result := ComCall(4, this, "int", eventId, "ptr", propertyIDs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
