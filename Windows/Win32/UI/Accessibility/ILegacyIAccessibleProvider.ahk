...
export default struct ILegacyIAccessibleProvider extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ChildId := CallbackCreate(ObjBindMethod(implObj, "get_ChildId"), flags, 2)
        ...
        this.vtbl.get_Help := CallbackCreate(ObjBindMethod(implObj, "get_Help"), flags, 2)
        this.vtbl.get_KeyboardShortcut := CallbackCreate(ObjBindMethod(implObj, "get_KeyboardShortcut"), flags, 2)
        this.vtbl.GetSelection := CallbackCreate(ObjBindMethod(implObj, "GetSelection"), flags, 2)
        this.vtbl.get_DefaultAction := CallbackCreate(ObjBindMethod(implObj, "get_DefaultAction"), flags, 2)
    }
