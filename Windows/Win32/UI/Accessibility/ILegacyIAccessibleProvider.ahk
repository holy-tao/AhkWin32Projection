 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-ilegacyiaccessibleprovider
...
class ILegacyIAccessibleProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-select
     */
    Select(flagsSelect) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-dodefaultaction
     */
    DoDefaultAction() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-setvalue
     */
    SetValue(szValue) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-getiaccessible
     */
    GetIAccessible() {
        result := ComCall(6, this, "ptr*", &ppAccessible := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_childid
     */
    get_ChildId() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_name
     */
    get_Name() {
        pszName := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_value
     */
    get_Value() {
        pszValue := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_description
     */
    get_Description() {
        pszDescription := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_role
     */
    get_Role() {
        result := ComCall(11, this, "uint*", &pdwRole := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_state
     */
    get_State() {
        result := ComCall(12, this, "uint*", &pdwState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_help
     */
    get_Help() {
        pszHelp := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_keyboardshortcut
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-getselection
     */
    GetSelection() {
        result := ComCall(15, this, "ptr*", &pvarSelectedChildren := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-ilegacyiaccessibleprovider-get_defaultaction
     */
    get_DefaultAction() {
