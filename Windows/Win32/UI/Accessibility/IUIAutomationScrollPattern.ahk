...
export default struct IUIAutomationScrollPattern extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CurrentHorizontalScrollPercent := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHorizontalScrollPercent"), flags, 2)
        this.vtbl.get_CurrentVerticalScrollPercent := CallbackCreate(ObjBindMethod(implObj, "get_CurrentVerticalScrollPercent"), flags, 2)
        this.vtbl.get_CurrentHorizontalViewSize := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHorizontalViewSize"), flags, 2)
        this.vtbl.get_CurrentVerticalViewSize := CallbackCreate(ObjBindMethod(implObj, "get_CurrentVerticalViewSize"), flags, 2)
        this.vtbl.get_CurrentHorizontallyScrollable := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHorizontallyScrollable"), flags, 2)
        this.vtbl.get_CurrentVerticallyScrollable := CallbackCreate(ObjBindMethod(implObj, "get_CurrentVerticallyScrollable"), flags, 2)
        this.vtbl.get_CachedHorizontalScrollPercent := CallbackCreate(ObjBindMethod(implObj, "get_CachedHorizontalScrollPercent"), flags, 2)
        this.vtbl.get_CachedVerticalScrollPercent := CallbackCreate(ObjBindMethod(implObj, "get_CachedVerticalScrollPercent"), flags, 2)
        this.vtbl.get_CachedHorizontalViewSize := CallbackCreate(ObjBindMethod(implObj, "get_CachedHorizontalViewSize"), flags, 2)
        this.vtbl.get_CachedVerticalViewSize := CallbackCreate(ObjBindMethod(implObj, "get_CachedVerticalViewSize"), flags, 2)
        this.vtbl.get_CachedHorizontallyScrollable := CallbackCreate(ObjBindMethod(implObj, "get_CachedHorizontallyScrollable"), flags, 2)
        this.vtbl.get_CachedVerticallyScrollable := CallbackCreate(ObjBindMethod(implObj, "get_CachedVerticallyScrollable"), flags, 2)
    }
