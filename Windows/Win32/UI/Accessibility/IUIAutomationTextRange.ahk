 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomationtextrange
...
class IUIAutomationTextRange extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-clone
     */
    Clone() {
        result := ComCall(3, this, "ptr*", &clonedRange := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-compare
     */
    Compare(range) {
        result := ComCall(4, this, "ptr", range, "int*", &areSame := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-compareendpoints
     */
    CompareEndpoints(srcEndPoint, range, targetEndPoint) {
        result := ComCall(5, this, "int", srcEndPoint, "ptr", range, "int", targetEndPoint, "int*", &compValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} textUnit_ 
     * @returns {HRESULT} Type: **[HRESULT](/windows/desktop/WinProg/windows-data-types)**
     * 
     * If this method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-expandtoenclosingunit
     */
    ExpandToEnclosingUnit(textUnit_) {
        result := ComCall(6, this, "int", textUnit_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT} val_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/oaidl/ns-oaidl-variant">VARIANT</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-findattribute
     */
    FindAttribute(attr, val_, backward) {
        result := ComCall(7, this, "int", attr, "ptr", val_, "int", backward, "ptr*", &found := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-findtext
     */
    FindText(text, backward, ignoreCase) {
        ...
        result := ComCall(8, this, "ptr", text, "int", backward, "int", ignoreCase, "ptr*", &found := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-getattributevalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-getboundingrectangles
     */
    GetBoundingRectangles() {
        result := ComCall(10, this, "ptr*", &boundingRects := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-getenclosingelement
     */
    GetEnclosingElement() {
        result := ComCall(11, this, "ptr*", &enclosingElement := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-gettext
     */
    GetText(maxLength) {
        text := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-move
     */
    Move(unit_, count) {
        result := ComCall(13, this, "int", unit_, "int", count, "int*", &moved := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-moveendpointbyunit
     */
    MoveEndpointByUnit(endpoint, unit_, count) {
        result := ComCall(14, this, "int", endpoint, "int", unit_, "int", count, "int*", &moved := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-moveendpointbyrange
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-select
     */
    Select() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-addtoselection
     */
    AddToSelection() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-removefromselection
     */
    RemoveFromSelection() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-scrollintoview
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextrange-getchildren
     */
    GetChildren() {
        result := ComCall(20, this, "ptr*", &children := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
