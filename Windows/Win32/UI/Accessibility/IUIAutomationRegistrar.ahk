 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-iuiautomationregistrar
...
class IUIAutomationRegistrar extends IUnknown{
     ...
     * @param {Pointer<UIAutomationPropertyInfo>} property_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/uiautomationcore/ns-uiautomationcore-uiautomationpropertyinfo">UIAutomationPropertyInfo</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-iuiautomationregistrar-registerproperty
     */
    RegisterProperty(property_) {
        result := ComCall(3, this, "ptr", property_, "int*", &propertyId := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-iuiautomationregistrar-registerevent
     */
    RegisterEvent(event) {
        result := ComCall(4, this, "ptr", event, "int*", &eventId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-iuiautomationregistrar-registerpattern
     */
    RegisterPattern(pattern, pPatternId, pPatternAvailablePropertyId, propertyIdCount, pPropertyIds, eventIdCount, pEventIds) {
        ...
        result := ComCall(5, this, "ptr", pattern, pPatternIdMarshal, pPatternId, pPatternAvailablePropertyIdMarshal, pPatternAvailablePropertyId, "uint", propertyIdCount, pPropertyIdsMarshal, pPropertyIds, "uint", eventIdCount, pEventIdsMarshal, pEventIds, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
