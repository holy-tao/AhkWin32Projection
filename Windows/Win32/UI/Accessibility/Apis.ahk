...
;@region Methods
     ...
     * @since windows5.0
     */
    static LresultFromObject(riid, _wParam, punk) {
        result := DllCall("OLEACC.dll\LresultFromObject", "ptr", riid, "ptr", _wParam, "ptr", punk, "ptr")
        return result
    }
     ...
     */
    static ObjectFromLresult(_lResult, riid, _wParam) {
        result := DllCall("OLEACC.dll\ObjectFromLresult", "ptr", _lResult, "ptr", riid, "ptr", _wParam, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
    ...
    static WindowFromAccessibleObject(param0) {
        phwnd := HWND()
        result := DllCall("OLEACC.dll\WindowFromAccessibleObject", "ptr", param0, "ptr", phwnd, "HRESULT")
        return phwnd
    }
     ...
     * @since windows5.0
     */
    static AccessibleObjectFromWindow(_hwnd, dwId, riid) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("OLEACC.dll\AccessibleObjectFromWindow", "ptr", _hwnd, "uint", dwId, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
     ...
     * @since windows5.0
     */
    static AccessibleObjectFromEvent(_hwnd, dwId, dwChildId, pvarChild) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("OLEACC.dll\AccessibleObjectFromEvent", "ptr", _hwnd, "uint", dwId, "uint", dwChildId, "ptr*", &ppacc := 0, "ptr", pvarChild, "HRESULT")
    ...
    static AccessibleObjectFromPoint(ptScreen, pvarChild) {
        result := DllCall("OLEACC.dll\AccessibleObjectFromPoint", "ptr", ptScreen, "ptr*", &ppacc := 0, "ptr", pvarChild, "HRESULT")
        return IAccessible(ppacc)
    }
    ...
    static AccessibleChildren(paccContainer, iChildStart, cChildren, rgvarChildren) {
        result := DllCall("OLEACC.dll\AccessibleChildren", "ptr", paccContainer, "int", iChildStart, "int", cChildren, "ptr", rgvarChildren, "int*", &pcObtained := 0, "HRESULT")
        return pcObtained
    }
     ...
     * @since windows5.0
     */
    static CreateStdAccessibleObject(_hwnd, idObject, riid) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("OLEACC.dll\CreateStdAccessibleObject", "ptr", _hwnd, "int", idObject, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
     ...
     * @since windows5.0
     */
    static CreateStdAccessibleProxyA(_hwnd, pClassName, idObject, riid) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd
        pClassName := pClassName is String ? StrPtr(pClassName) : pClassName

        result := DllCall("OLEACC.dll\CreateStdAccessibleProxyA", "ptr", _hwnd, "ptr", pClassName, "int", idObject, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
     ...
     * @since windows5.0
     */
    static CreateStdAccessibleProxyW(_hwnd, pClassName, idObject, riid) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd
        pClassName := pClassName is String ? StrPtr(pClassName) : pClassName

        result := DllCall("OLEACC.dll\CreateStdAccessibleProxyW", "ptr", _hwnd, "ptr", pClassName, "int", idObject, "ptr", riid, "ptr*", &ppvObject := 0, "HRESULT")
        return ppvObject
    }
    ...
    static AccSetRunningUtilityState(hwndApp, dwUtilityStateMask, dwUtilityState) {
        ...
        result := DllCall("OLEACC.dll\AccSetRunningUtilityState", "ptr", hwndApp, "uint", dwUtilityStateMask, "uint", dwUtilityState, "HRESULT")
        return result
    }
    ...
    static AccNotifyTouchInteraction(hwndApp, hwndTarget, ptTarget) {
        ...
        result := DllCall("OLEACC.dll\AccNotifyTouchInteraction", "ptr", hwndApp, "ptr", hwndTarget, "ptr", ptTarget, "HRESULT")
        return result
    }
    ...
    static UiaHUiaNodeFromVariant(pvar, phnode) {
        result := DllCall("UIAutomationCore.dll\UiaHUiaNodeFromVariant", "ptr", pvar, "ptr", phnode, "HRESULT")
        return result
    }
    ...
    static UiaHPatternObjectFromVariant(pvar, phobj) {
        result := DllCall("UIAutomationCore.dll\UiaHPatternObjectFromVariant", "ptr", pvar, "ptr", phobj, "HRESULT")
        return result
    }
    ...
    static UiaHTextRangeFromVariant(pvar, phtextrange) {
        result := DllCall("UIAutomationCore.dll\UiaHTextRangeFromVariant", "ptr", pvar, "ptr", phtextrange, "HRESULT")
        return result
    }

    /**
     * Deletes a node from memory.
     * @param {HUIANODE} _hnode 
     * @returns {BOOL} Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">BOOL</a></b>
     * 
     ...
     * @since windows5.1.2600
     */
    static UiaNodeRelease(_hnode) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        result := DllCall("UIAutomationCore.dll\UiaNodeRelease", "ptr", _hnode, "int")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaGetPropertyValue(_hnode, propertyId, pValue) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        result := DllCall("UIAutomationCore.dll\UiaGetPropertyValue", "ptr", _hnode, "int", propertyId, "ptr", pValue, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaGetPatternProvider(_hnode, patternId, phobj) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        result := DllCall("UIAutomationCore.dll\UiaGetPatternProvider", "ptr", _hnode, "int", patternId, "ptr", phobj, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaGetRuntimeId(_hnode, pruntimeId) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        pruntimeIdMarshal := pruntimeId is VarRef ? "ptr*" : "ptr"

        result := DllCall("UIAutomationCore.dll\UiaGetRuntimeId", "ptr", _hnode, pruntimeIdMarshal, pruntimeId, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaSetFocus(_hnode) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        result := DllCall("UIAutomationCore.dll\UiaSetFocus", "ptr", _hnode, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaNavigate(_hnode, _direction, pCondition, pRequest, ppRequestedData, ppTreeStructure) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        ppRequestedDataMarshal := ppRequestedData is VarRef ? "ptr*" : "ptr"

        result := DllCall("UIAutomationCore.dll\UiaNavigate", "ptr", _hnode, "int", _direction, "ptr", pCondition, "ptr", pRequest, ppRequestedDataMarshal, ppRequestedData, "ptr", ppTreeStructure, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaGetUpdatedCache(_hnode, pRequest, _normalizeState, pNormalizeCondition, ppRequestedData, ppTreeStructure) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        ppRequestedDataMarshal := ppRequestedData is VarRef ? "ptr*" : "ptr"

        result := DllCall("UIAutomationCore.dll\UiaGetUpdatedCache", "ptr", _hnode, "ptr", pRequest, "int", _normalizeState, "ptr", pNormalizeCondition, ppRequestedDataMarshal, ppRequestedData, "ptr", ppTreeStructure, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaFind(_hnode, pParams, pRequest, ppRequestedData, ppOffsets, ppTreeStructures) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode
        ...
        result := DllCall("UIAutomationCore.dll\UiaFind", "ptr", _hnode, "ptr", pParams, "ptr", pRequest, ppRequestedDataMarshal, ppRequestedData, ppOffsetsMarshal, ppOffsets, ppTreeStructuresMarshal, ppTreeStructures, "HRESULT")
        return result
    }
    ...
    static UiaNodeFromPoint(x, y, pRequest, ppRequestedData, ppTreeStructure) {
        ...
        result := DllCall("UIAutomationCore.dll\UiaNodeFromPoint", "double", x, "double", y, "ptr", pRequest, ppRequestedDataMarshal, ppRequestedData, "ptr", ppTreeStructure, "HRESULT")
        return result
    }
    ...
    static UiaNodeFromFocus(pRequest, ppRequestedData, ppTreeStructure) {
        ...
        result := DllCall("UIAutomationCore.dll\UiaNodeFromFocus", "ptr", pRequest, ppRequestedDataMarshal, ppRequestedData, "ptr", ppTreeStructure, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaNodeFromHandle(_hwnd, phnode) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaNodeFromHandle", "ptr", _hwnd, "ptr", phnode, "HRESULT")
        return result
    }
    ...
    static UiaNodeFromProvider(pProvider, phnode) {
        result := DllCall("UIAutomationCore.dll\UiaNodeFromProvider", "ptr", pProvider, "ptr", phnode, "HRESULT")
        return result
    }
    ...
    static UiaGetRootNode(phnode) {
        result := DllCall("UIAutomationCore.dll\UiaGetRootNode", "ptr", phnode, "HRESULT")
        return result
    }
    ...
    static UiaRaiseAutomationPropertyChangedEvent(pProvider, id, oldValue, newValue) {
        result := DllCall("UIAutomationCore.dll\UiaRaiseAutomationPropertyChangedEvent", "ptr", pProvider, "int", id, "ptr", oldValue, "ptr", newValue, "HRESULT")
        return result
    }
    ...
    static UiaRaiseAutomationEvent(pProvider, id) {
        result := DllCall("UIAutomationCore.dll\UiaRaiseAutomationEvent", "ptr", pProvider, "int", id, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaRaiseStructureChangedEvent(pProvider, _structureChangeType, pRuntimeId, cRuntimeIdLen) {
        pRuntimeIdMarshal := pRuntimeId is VarRef ? "int*" : "ptr"

        result := DllCall("UIAutomationCore.dll\UiaRaiseStructureChangedEvent", "ptr", pProvider, "int", _structureChangeType, pRuntimeIdMarshal, pRuntimeId, "int", cRuntimeIdLen, "HRESULT")
        return result
    }
     ...
     * @param {Integer} _asyncContentLoadedState 
     ...
     * @since windows5.1.2600
     */
    static UiaRaiseAsyncContentLoadedEvent(pProvider, _asyncContentLoadedState, percentComplete) {
        result := DllCall("UIAutomationCore.dll\UiaRaiseAsyncContentLoadedEvent", "ptr", pProvider, "int", _asyncContentLoadedState, "double", percentComplete, "HRESULT")
        return result
    }
     ...
     * @since windows8.1
     */
    static UiaRaiseTextEditTextChangedEvent(pProvider, _textEditChangeType, pChangedData) {
        result := DllCall("UIAutomationCore.dll\UiaRaiseTextEditTextChangedEvent", "ptr", pProvider, "int", _textEditChangeType, "ptr", pChangedData, "HRESULT")
        return result
    }
    ...
    static UiaRaiseChangesEvent(pProvider, eventIdCount, pUiaChanges) {
        result := DllCall("UIAutomationCore.dll\UiaRaiseChangesEvent", "ptr", pProvider, "int", eventIdCount, "ptr", pUiaChanges, "HRESULT")
        return result
    }
     ...
     */
    static UiaRaiseNotificationEvent(provider, _notificationKind, _notificationProcessing, displayString, activityId) {
        ...
        result := DllCall("UIAutomationCore.dll\UiaRaiseNotificationEvent", "ptr", provider, "int", _notificationKind, "int", _notificationProcessing, "ptr", displayString, "ptr", activityId, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaAddEvent(_hnode, eventId, pCallback, scope, pProperties, cProperties, pRequest, phEvent) {
        _hnode := _hnode is Win32Handle ? NumGet(_hnode, "ptr") : _hnode

        pCallbackMarshal := pCallback is VarRef ? "ptr*" : "ptr"
        pPropertiesMarshal := pProperties is VarRef ? "int*" : "ptr"

        result := DllCall("UIAutomationCore.dll\UiaAddEvent", "ptr", _hnode, "int", eventId, pCallbackMarshal, pCallback, "int", scope, pPropertiesMarshal, pProperties, "int", cProperties, "ptr", pRequest, "ptr", phEvent, "HRESULT")
        return result
    }
    ...
    static UiaRemoveEvent(hEvent) {
        ...
        result := DllCall("UIAutomationCore.dll\UiaRemoveEvent", "ptr", hEvent, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaEventAddWindow(hEvent, _hwnd) {
        hEvent := hEvent is Win32Handle ? NumGet(hEvent, "ptr") : hEvent
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaEventAddWindow", "ptr", hEvent, "ptr", _hwnd, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaEventRemoveWindow(hEvent, _hwnd) {
        hEvent := hEvent is Win32Handle ? NumGet(hEvent, "ptr") : hEvent
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaEventRemoveWindow", "ptr", hEvent, "ptr", _hwnd, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static DockPattern_SetDockPosition(hobj, _dockPosition) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\DockPattern_SetDockPosition", "ptr", hobj, "int", _dockPosition, "HRESULT")
        return result
    }
    ...
    static ExpandCollapsePattern_Collapse(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\ExpandCollapsePattern_Collapse", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static ExpandCollapsePattern_Expand(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\ExpandCollapsePattern_Expand", "ptr", hobj, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static GridPattern_GetItem(hobj, row, _column, pResult) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\GridPattern_GetItem", "ptr", hobj, "int", row, "int", _column, "ptr", pResult, "HRESULT")
        return result
    }
    ...
    static InvokePattern_Invoke(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\InvokePattern_Invoke", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static MultipleViewPattern_GetViewName(hobj, viewId, ppStr) {
        ...
        result := DllCall("UIAutomationCore.dll\MultipleViewPattern_GetViewName", "ptr", hobj, "int", viewId, "ptr", ppStr, "HRESULT")
        return result
    }
    ...
    static MultipleViewPattern_SetCurrentView(hobj, viewId) {
        ...
        result := DllCall("UIAutomationCore.dll\MultipleViewPattern_SetCurrentView", "ptr", hobj, "int", viewId, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static RangeValuePattern_SetValue(hobj, _val) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\RangeValuePattern_SetValue", "ptr", hobj, "double", _val, "HRESULT")
        return result
    }
    ...
    static ScrollItemPattern_ScrollIntoView(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\ScrollItemPattern_ScrollIntoView", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static ScrollPattern_Scroll(hobj, horizontalAmount, verticalAmount) {
        ...
        result := DllCall("UIAutomationCore.dll\ScrollPattern_Scroll", "ptr", hobj, "int", horizontalAmount, "int", verticalAmount, "HRESULT")
        return result
    }
    ...
    static ScrollPattern_SetScrollPercent(hobj, horizontalPercent, verticalPercent) {
        ...
        result := DllCall("UIAutomationCore.dll\ScrollPattern_SetScrollPercent", "ptr", hobj, "double", horizontalPercent, "double", verticalPercent, "HRESULT")
        return result
    }
    ...
    static SelectionItemPattern_AddToSelection(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\SelectionItemPattern_AddToSelection", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static SelectionItemPattern_RemoveFromSelection(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\SelectionItemPattern_RemoveFromSelection", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static SelectionItemPattern_Select(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\SelectionItemPattern_Select", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static TogglePattern_Toggle(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\TogglePattern_Toggle", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static TransformPattern_Move(hobj, x, y) {
        ...
        result := DllCall("UIAutomationCore.dll\TransformPattern_Move", "ptr", hobj, "double", x, "double", y, "HRESULT")
        return result
    }
    ...
    static TransformPattern_Resize(hobj, width, height) {
        ...
        result := DllCall("UIAutomationCore.dll\TransformPattern_Resize", "ptr", hobj, "double", width, "double", height, "HRESULT")
        return result
    }
    ...
    static TransformPattern_Rotate(hobj, degrees) {
        ...
        result := DllCall("UIAutomationCore.dll\TransformPattern_Rotate", "ptr", hobj, "double", degrees, "HRESULT")
        return result
    }
    ...
    static ValuePattern_SetValue(hobj, pVal) {
        ...
        result := DllCall("UIAutomationCore.dll\ValuePattern_SetValue", "ptr", hobj, "ptr", pVal, "HRESULT")
        return result
    }
    ...
    static WindowPattern_Close(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\WindowPattern_Close", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static WindowPattern_SetWindowVisualState(hobj, state) {
        ...
        result := DllCall("UIAutomationCore.dll\WindowPattern_SetWindowVisualState", "ptr", hobj, "int", state, "HRESULT")
        return result
    }
    ...
    static WindowPattern_WaitForInputIdle(hobj, milliseconds, pResult) {
        ...
        result := DllCall("UIAutomationCore.dll\WindowPattern_WaitForInputIdle", "ptr", hobj, "int", milliseconds, pResultMarshal, pResult, "HRESULT")
        return result
    }
    ...
    static TextPattern_GetSelection(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextPattern_GetSelection", "ptr", hobj, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextPattern_GetVisibleRanges(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextPattern_GetVisibleRanges", "ptr", hobj, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextPattern_RangeFromChild(hobj, hnodeChild, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextPattern_RangeFromChild", "ptr", hobj, "ptr", hnodeChild, "ptr", pRetVal, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextPattern_RangeFromPoint(hobj, _point, pRetVal) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\TextPattern_RangeFromPoint", "ptr", hobj, "ptr", _point, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextPattern_get_DocumentRange(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextPattern_get_DocumentRange", "ptr", hobj, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextPattern_get_SupportedTextSelection(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextPattern_get_SupportedTextSelection", "ptr", hobj, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_Clone(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_Clone", "ptr", hobj, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_Compare(hobj, range, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_Compare", "ptr", hobj, "ptr", range, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_CompareEndpoints(hobj, endpoint, targetRange, targetEndpoint, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_CompareEndpoints", "ptr", hobj, "int", endpoint, "ptr", targetRange, "int", targetEndpoint, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextRange_ExpandToEnclosingUnit(hobj, _unit) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\TextRange_ExpandToEnclosingUnit", "ptr", hobj, "int", _unit, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextRange_GetAttributeValue(hobj, _attributeId, pRetVal) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\TextRange_GetAttributeValue", "ptr", hobj, "int", _attributeId, "ptr", pRetVal, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextRange_FindAttribute(hobj, _attributeId, _val, backward, pRetVal) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        result := DllCall("UIAutomationCore.dll\TextRange_FindAttribute", "ptr", hobj, "int", _attributeId, "ptr", _val, "int", backward, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_FindText(hobj, text, backward, ignoreCase, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_FindText", "ptr", hobj, "ptr", text, "int", backward, "int", ignoreCase, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_GetBoundingRectangles(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_GetBoundingRectangles", "ptr", hobj, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_GetEnclosingElement(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_GetEnclosingElement", "ptr", hobj, "ptr", pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_GetText(hobj, maxLength, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_GetText", "ptr", hobj, "int", maxLength, "ptr", pRetVal, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextRange_Move(hobj, _unit, count, pRetVal) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        pRetValMarshal := pRetVal is VarRef ? "int*" : "ptr"

        result := DllCall("UIAutomationCore.dll\TextRange_Move", "ptr", hobj, "int", _unit, "int", count, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static TextRange_MoveEndpointByUnit(hobj, endpoint, _unit, count, pRetVal) {
        hobj := hobj is Win32Handle ? NumGet(hobj, "ptr") : hobj

        pRetValMarshal := pRetVal is VarRef ? "int*" : "ptr"

        result := DllCall("UIAutomationCore.dll\TextRange_MoveEndpointByUnit", "ptr", hobj, "int", endpoint, "int", _unit, "int", count, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static TextRange_MoveEndpointByRange(hobj, endpoint, targetRange, targetEndpoint) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_MoveEndpointByRange", "ptr", hobj, "int", endpoint, "ptr", targetRange, "int", targetEndpoint, "HRESULT")
        return result
    }
    ...
    static TextRange_Select(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_Select", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static TextRange_AddToSelection(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_AddToSelection", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static TextRange_RemoveFromSelection(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_RemoveFromSelection", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static TextRange_ScrollIntoView(hobj, alignToTop) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_ScrollIntoView", "ptr", hobj, "int", alignToTop, "HRESULT")
        return result
    }
    ...
    static TextRange_GetChildren(hobj, pRetVal) {
        ...
        result := DllCall("UIAutomationCore.dll\TextRange_GetChildren", "ptr", hobj, pRetValMarshal, pRetVal, "HRESULT")
        return result
    }
    ...
    static ItemContainerPattern_FindItemByProperty(hobj, hnodeStartAfter, propertyId, value, pFound) {
        ...
        result := DllCall("UIAutomationCore.dll\ItemContainerPattern_FindItemByProperty", "ptr", hobj, "ptr", hnodeStartAfter, "int", propertyId, "ptr", value, "ptr", pFound, "HRESULT")
        return result
    }
    ...
    static LegacyIAccessiblePattern_Select(hobj, flagsSelect) {
        ...
        result := DllCall("UIAutomationCore.dll\LegacyIAccessiblePattern_Select", "ptr", hobj, "int", flagsSelect, "HRESULT")
        return result
    }
    ...
    static LegacyIAccessiblePattern_DoDefaultAction(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\LegacyIAccessiblePattern_DoDefaultAction", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static LegacyIAccessiblePattern_SetValue(hobj, szValue) {
        ...
        result := DllCall("UIAutomationCore.dll\LegacyIAccessiblePattern_SetValue", "ptr", hobj, "ptr", szValue, "HRESULT")
        return result
    }
    ...
    static LegacyIAccessiblePattern_GetIAccessible(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\LegacyIAccessiblePattern_GetIAccessible", "ptr", hobj, "ptr*", &pAccessible := 0, "HRESULT")
    ...
    static SynchronizedInputPattern_StartListening(hobj, inputType) {
        ...
        result := DllCall("UIAutomationCore.dll\SynchronizedInputPattern_StartListening", "ptr", hobj, "int", inputType, "HRESULT")
        return result
    }
    ...
    static SynchronizedInputPattern_Cancel(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\SynchronizedInputPattern_Cancel", "ptr", hobj, "HRESULT")
        return result
    }
    ...
    static VirtualizedItemPattern_Realize(hobj) {
        ...
        result := DllCall("UIAutomationCore.dll\VirtualizedItemPattern_Realize", "ptr", hobj, "HRESULT")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaReturnRawElementProvider(_hwnd, _wParam, _lParam, el) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaReturnRawElementProvider", "ptr", _hwnd, "ptr", _wParam, "ptr", _lParam, "ptr", el, "ptr")
        return result
    }
     ...
     * @since windows5.1.2600
     */
    static UiaHostProviderFromHwnd(_hwnd) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaHostProviderFromHwnd", "ptr", _hwnd, "ptr*", &ppProvider := 0, "HRESULT")
     ...
     * @since windows8.0
     */
    static UiaProviderForNonClient(_hwnd, idObject, idChild) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaProviderForNonClient", "ptr", _hwnd, "int", idObject, "int", idChild, "ptr*", &ppProvider := 0, "HRESULT")
        return IRawElementProviderSimple(ppProvider)
    }
    ...
    static UiaIAccessibleFromProvider(pProvider, dwFlags, pvarChild) {
        result := DllCall("UIAutomationCore.dll\UiaIAccessibleFromProvider", "ptr", pProvider, "uint", dwFlags, "ptr*", &ppAccessible := 0, "ptr", pvarChild, "HRESULT")
     ...
     * @since windows5.1.2600
     */
    static UiaHasServerSideProvider(_hwnd) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("UIAutomationCore.dll\UiaHasServerSideProvider", "ptr", _hwnd, "int")
        return result
    }
     ...
     * @since windows8.0
     */
    static RegisterPointerInputTarget(_hwnd, pointerType) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        A_LastError := 0

        result := DllCall("USER32.dll\RegisterPointerInputTarget", "ptr", _hwnd, "int", pointerType, "int")
     ...
     * @since windows8.0
     */
    static UnregisterPointerInputTarget(_hwnd, pointerType) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        A_LastError := 0

        result := DllCall("USER32.dll\UnregisterPointerInputTarget", "ptr", _hwnd, "int", pointerType, "int")
        if(!result && A_LastError) {
            throw OSError(A_LastError)
        }
     ...
     * @since windows10.0.10240
     */
    static RegisterPointerInputTargetEx(_hwnd, pointerType, fObserve) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("USER32.dll\RegisterPointerInputTargetEx", "ptr", _hwnd, "int", pointerType, "int", fObserve, "int")
        return result
    }
     ...
     * @since windows10.0.10240
     */
    static UnregisterPointerInputTargetEx(_hwnd, pointerType) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        result := DllCall("USER32.dll\UnregisterPointerInputTargetEx", "ptr", _hwnd, "int", pointerType, "int")
        return result
    }
     ...
     * @since windows5.0
     */
    static NotifyWinEvent(event, _hwnd, idObject, idChild) {
        _hwnd := _hwnd is Win32Handle ? NumGet(_hwnd, "ptr") : _hwnd

        DllCall("USER32.dll\NotifyWinEvent", "uint", event, "ptr", _hwnd, "int", idObject, "int", idChild)
    }
     ...
     * @param {HWINEVENTHOOK} _hWinEventHook 
     * @returns {BOOL} Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">BOOL</a></b>
     * 
     ...
     * @since windows5.0
     */
    static UnhookWinEvent(_hWinEventHook) {
        _hWinEventHook := _hWinEventHook is Win32Handle ? NumGet(_hWinEventHook, "ptr") : _hWinEventHook

        result := DllCall("USER32.dll\UnhookWinEvent", "ptr", _hWinEventHook, "int")
        return result
    }
