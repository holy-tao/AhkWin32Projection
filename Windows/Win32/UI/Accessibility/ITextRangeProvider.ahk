 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-itextrangeprovider
...
class ITextRangeProvider extends IUnknown{
     ...
     */
    Clone() {
        result := ComCall(3, this, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
     ...
     */
    Compare(range) {
        result := ComCall(4, this, "ptr", range, "int*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    CompareEndpoints(endpoint, targetRange, targetEndpoint) {
        result := ComCall(5, this, "int", endpoint, "ptr", targetRange, "int", targetEndpoint, "int*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-itextrangeprovider-expandtoenclosingunit
     */
    ExpandToEnclosingUnit(unit_) {
        result := ComCall(6, this, "int", unit_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    FindAttribute(attributeId_, val_, backward) {
        result := ComCall(7, this, "int", attributeId_, "ptr", val_, "int", backward, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    FindText(text, backward, ignoreCase) {
        ...
        result := ComCall(8, this, "ptr", text, "int", backward, "int", ignoreCase, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetAttributeValue(attributeId_) {
        pRetVal := VARIANT()
        result := ComCall(9, this, "int", attributeId_, "ptr", pRetVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * This parameter is passed uninitialized.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-itextrangeprovider-getboundingrectangles
     */
    GetBoundingRectangles() {
        result := ComCall(10, this, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetEnclosingElement() {
        result := ComCall(11, this, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    Move(unit_, count) {
        result := ComCall(13, this, "int", unit_, "int", count, "int*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    MoveEndpointByUnit(endpoint, unit_, count) {
        result := ComCall(14, this, "int", endpoint, "int", unit_, "int", count, "int*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-itextrangeprovider-moveendpointbyrange
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-itextrangeprovider-scrollintoview
     */
     ...
     */
    GetChildren() {
        result := ComCall(20, this, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
