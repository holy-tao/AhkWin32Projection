 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomationstructurechangedeventhandler
...
class IUIAutomationStructureChangedEventHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationstructurechangedeventhandler-handlestructurechangedevent
     */
    HandleStructureChangedEvent(sender, changeType_, runtimeId) {
        result := ComCall(3, this, "ptr", sender, "int", changeType_, "ptr", runtimeId, "int")
        if(result != 0) {
