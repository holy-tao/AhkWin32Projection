 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-irawelementprovidersimple
...
class IRawElementProviderSimple extends IUnknown{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovidersimple-get_provideroptions
     */
    get_ProviderOptions() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovidersimple-getpatternprovider
     */
    GetPatternProvider(patternId) {
        result := ComCall(4, this, "int", patternId, "ptr*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovidersimple-getpropertyvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-irawelementprovidersimple-get_hostrawelementprovider
     */
