 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomationboolcondition
...
class IUIAutomationBoolCondition extends IUIAutomationCondition{
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationboolcondition-get_booleanvalue
     */
    get_BooleanValue() {
        result := ComCall(3, this, "int*", &boolVal := 0, "int")
        if(result != 0) {
