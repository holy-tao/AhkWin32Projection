 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nn-uiautomationcore-idockprovider
...
class IDockProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationcore/nf-uiautomationcore-idockprovider-setdockposition
     */
    SetDockPosition(dockPosition_) {
        result := ComCall(3, this, "int", dockPosition_, "int")
        if(result != 0) {
     ...
     */
    get_DockPosition() {
        result := ComCall(4, this, "int*", &pRetVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
