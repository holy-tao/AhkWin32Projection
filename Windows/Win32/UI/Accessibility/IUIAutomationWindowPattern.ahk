...
export default struct IUIAutomationWindowPattern extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetWindowVisualState := CallbackCreate(ObjBindMethod(implObj, "SetWindowVisualState"), flags, 2)
        this.vtbl.get_CurrentCanMaximize := CallbackCreate(ObjBindMethod(implObj, "get_CurrentCanMaximize"), flags, 2)
        this.vtbl.get_CurrentCanMinimize := CallbackCreate(ObjBindMethod(implObj, "get_CurrentCanMinimize"), flags, 2)
        this.vtbl.get_CurrentIsModal := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsModal"), flags, 2)
        this.vtbl.get_CurrentIsTopmost := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsTopmost"), flags, 2)
        this.vtbl.get_CurrentWindowVisualState := CallbackCreate(ObjBindMethod(implObj, "get_CurrentWindowVisualState"), flags, 2)
        this.vtbl.get_CurrentWindowInteractionState := CallbackCreate(ObjBindMethod(implObj, "get_CurrentWindowInteractionState"), flags, 2)
        this.vtbl.get_CachedCanMaximize := CallbackCreate(ObjBindMethod(implObj, "get_CachedCanMaximize"), flags, 2)
        this.vtbl.get_CachedCanMinimize := CallbackCreate(ObjBindMethod(implObj, "get_CachedCanMinimize"), flags, 2)
        this.vtbl.get_CachedIsModal := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsModal"), flags, 2)
        this.vtbl.get_CachedIsTopmost := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsTopmost"), flags, 2)
        this.vtbl.get_CachedWindowVisualState := CallbackCreate(ObjBindMethod(implObj, "get_CachedWindowVisualState"), flags, 2)
        this.vtbl.get_CachedWindowInteractionState := CallbackCreate(ObjBindMethod(implObj, "get_CachedWindowInteractionState"), flags, 2)
    }
