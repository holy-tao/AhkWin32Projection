 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oleacc/nn-oleacc-iaccessiblewindowlesssite
...
class IAccessibleWindowlessSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleacc/nf-oleacc-iaccessiblewindowlesssite-acquireobjectidrange
     */
    AcquireObjectIdRange(rangeSize, pRangeOwner) {
        result := ComCall(3, this, "int", rangeSize, "ptr", pRangeOwner, "int*", &pRangeBase := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleacc/nf-oleacc-iaccessiblewindowlesssite-releaseobjectidrange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleacc/nf-oleacc-iaccessiblewindowlesssite-queryobjectidranges
     */
    QueryObjectIdRanges(pRangesOwner) {
        result := ComCall(5, this, "ptr", pRangesOwner, "ptr*", &psaRanges := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleacc/nf-oleacc-iaccessiblewindowlesssite-getparentaccessible
     */
    GetParentAccessible() {
        result := ComCall(6, this, "ptr*", &ppParent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
