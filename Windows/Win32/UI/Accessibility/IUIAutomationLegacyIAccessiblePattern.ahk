...
export default struct IUIAutomationLegacyIAccessiblePattern extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.DoDefaultAction := CallbackCreate(ObjBindMethod(implObj, "DoDefaultAction"), flags, 1)
        this.vtbl.SetValue := CallbackCreate(ObjBindMethod(implObj, "SetValue"), flags, 2)
        this.vtbl.get_CurrentChildId := CallbackCreate(ObjBindMethod(implObj, "get_CurrentChildId"), flags, 2)
        ...
        this.vtbl.get_CurrentDescription := CallbackCreate(ObjBindMethod(implObj, "get_CurrentDescription"), flags, 2)
        this.vtbl.get_CurrentRole := CallbackCreate(ObjBindMethod(implObj, "get_CurrentRole"), flags, 2)
        this.vtbl.get_CurrentState := CallbackCreate(ObjBindMethod(implObj, "get_CurrentState"), flags, 2)
        this.vtbl.get_CurrentHelp := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHelp"), flags, 2)
        this.vtbl.get_CurrentKeyboardShortcut := CallbackCreate(ObjBindMethod(implObj, "get_CurrentKeyboardShortcut"), flags, 2)
        this.vtbl.GetCurrentSelection := CallbackCreate(ObjBindMethod(implObj, "GetCurrentSelection"), flags, 2)
        this.vtbl.get_CurrentDefaultAction := CallbackCreate(ObjBindMethod(implObj, "get_CurrentDefaultAction"), flags, 2)
        this.vtbl.get_CachedChildId := CallbackCreate(ObjBindMethod(implObj, "get_CachedChildId"), flags, 2)
        ...
        this.vtbl.get_CachedDescription := CallbackCreate(ObjBindMethod(implObj, "get_CachedDescription"), flags, 2)
        this.vtbl.get_CachedRole := CallbackCreate(ObjBindMethod(implObj, "get_CachedRole"), flags, 2)
        this.vtbl.get_CachedState := CallbackCreate(ObjBindMethod(implObj, "get_CachedState"), flags, 2)
        this.vtbl.get_CachedHelp := CallbackCreate(ObjBindMethod(implObj, "get_CachedHelp"), flags, 2)
        this.vtbl.get_CachedKeyboardShortcut := CallbackCreate(ObjBindMethod(implObj, "get_CachedKeyboardShortcut"), flags, 2)
        this.vtbl.GetCachedSelection := CallbackCreate(ObjBindMethod(implObj, "GetCachedSelection"), flags, 2)
        this.vtbl.get_CachedDefaultAction := CallbackCreate(ObjBindMethod(implObj, "get_CachedDefaultAction"), flags, 2)
        this.vtbl.GetIAccessible := CallbackCreate(ObjBindMethod(implObj, "GetIAccessible"), flags, 2)
    }
