...
export default struct IUIAutomationElement extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.FindFirst := CallbackCreate(ObjBindMethod(implObj, "FindFirst"), flags, 4)
        this.vtbl.FindAll := CallbackCreate(ObjBindMethod(implObj, "FindAll"), flags, 4)
        this.vtbl.FindFirstBuildCache := CallbackCreate(ObjBindMethod(implObj, "FindFirstBuildCache"), flags, 5)
        this.vtbl.FindAllBuildCache := CallbackCreate(ObjBindMethod(implObj, "FindAllBuildCache"), flags, 5)
        this.vtbl.BuildUpdatedCache := CallbackCreate(ObjBindMethod(implObj, "BuildUpdatedCache"), flags, 3)
        this.vtbl.GetCurrentPropertyValue := CallbackCreate(ObjBindMethod(implObj, "GetCurrentPropertyValue"), flags, 3)
        this.vtbl.GetCurrentPropertyValueEx := CallbackCreate(ObjBindMethod(implObj, "GetCurrentPropertyValueEx"), flags, 4)
        this.vtbl.GetCachedPropertyValue := CallbackCreate(ObjBindMethod(implObj, "GetCachedPropertyValue"), flags, 3)
        this.vtbl.GetCachedPropertyValueEx := CallbackCreate(ObjBindMethod(implObj, "GetCachedPropertyValueEx"), flags, 4)
        this.vtbl.GetCurrentPatternAs := CallbackCreate(ObjBindMethod(implObj, "GetCurrentPatternAs"), flags, 4)
        this.vtbl.GetCachedPatternAs := CallbackCreate(ObjBindMethod(implObj, "GetCachedPatternAs"), flags, 4)
        this.vtbl.GetCurrentPattern := CallbackCreate(ObjBindMethod(implObj, "GetCurrentPattern"), flags, 3)
        this.vtbl.GetCachedPattern := CallbackCreate(ObjBindMethod(implObj, "GetCachedPattern"), flags, 3)
        this.vtbl.GetCachedParent := CallbackCreate(ObjBindMethod(implObj, "GetCachedParent"), flags, 2)
        this.vtbl.GetCachedChildren := CallbackCreate(ObjBindMethod(implObj, "GetCachedChildren"), flags, 2)
        this.vtbl.get_CurrentProcessId := CallbackCreate(ObjBindMethod(implObj, "get_CurrentProcessId"), flags, 2)
        this.vtbl.get_CurrentControlType := CallbackCreate(ObjBindMethod(implObj, "get_CurrentControlType"), flags, 2)
        this.vtbl.get_CurrentLocalizedControlType := CallbackCreate(ObjBindMethod(implObj, "get_CurrentLocalizedControlType"), flags, 2)
        this.vtbl.get_CurrentName := CallbackCreate(ObjBindMethod(implObj, "get_CurrentName"), flags, 2)
        this.vtbl.get_CurrentAcceleratorKey := CallbackCreate(ObjBindMethod(implObj, "get_CurrentAcceleratorKey"), flags, 2)
        this.vtbl.get_CurrentAccessKey := CallbackCreate(ObjBindMethod(implObj, "get_CurrentAccessKey"), flags, 2)
        this.vtbl.get_CurrentHasKeyboardFocus := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHasKeyboardFocus"), flags, 2)
        this.vtbl.get_CurrentIsKeyboardFocusable := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsKeyboardFocusable"), flags, 2)
        this.vtbl.get_CurrentIsEnabled := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsEnabled"), flags, 2)
        this.vtbl.get_CurrentAutomationId := CallbackCreate(ObjBindMethod(implObj, "get_CurrentAutomationId"), flags, 2)
        this.vtbl.get_CurrentClassName := CallbackCreate(ObjBindMethod(implObj, "get_CurrentClassName"), flags, 2)
        this.vtbl.get_CurrentHelpText := CallbackCreate(ObjBindMethod(implObj, "get_CurrentHelpText"), flags, 2)
        this.vtbl.get_CurrentCulture := CallbackCreate(ObjBindMethod(implObj, "get_CurrentCulture"), flags, 2)
        this.vtbl.get_CurrentIsControlElement := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsControlElement"), flags, 2)
        this.vtbl.get_CurrentIsContentElement := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsContentElement"), flags, 2)
        this.vtbl.get_CurrentIsPassword := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsPassword"), flags, 2)
        this.vtbl.get_CurrentNativeWindowHandle := CallbackCreate(ObjBindMethod(implObj, "get_CurrentNativeWindowHandle"), flags, 2)
        this.vtbl.get_CurrentItemType := CallbackCreate(ObjBindMethod(implObj, "get_CurrentItemType"), flags, 2)
        this.vtbl.get_CurrentIsOffscreen := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsOffscreen"), flags, 2)
        this.vtbl.get_CurrentOrientation := CallbackCreate(ObjBindMethod(implObj, "get_CurrentOrientation"), flags, 2)
        this.vtbl.get_CurrentFrameworkId := CallbackCreate(ObjBindMethod(implObj, "get_CurrentFrameworkId"), flags, 2)
        this.vtbl.get_CurrentIsRequiredForForm := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsRequiredForForm"), flags, 2)
        this.vtbl.get_CurrentItemStatus := CallbackCreate(ObjBindMethod(implObj, "get_CurrentItemStatus"), flags, 2)
        this.vtbl.get_CurrentBoundingRectangle := CallbackCreate(ObjBindMethod(implObj, "get_CurrentBoundingRectangle"), flags, 2)
        this.vtbl.get_CurrentLabeledBy := CallbackCreate(ObjBindMethod(implObj, "get_CurrentLabeledBy"), flags, 2)
        this.vtbl.get_CurrentAriaRole := CallbackCreate(ObjBindMethod(implObj, "get_CurrentAriaRole"), flags, 2)
        this.vtbl.get_CurrentAriaProperties := CallbackCreate(ObjBindMethod(implObj, "get_CurrentAriaProperties"), flags, 2)
        this.vtbl.get_CurrentIsDataValidForForm := CallbackCreate(ObjBindMethod(implObj, "get_CurrentIsDataValidForForm"), flags, 2)
        this.vtbl.get_CurrentControllerFor := CallbackCreate(ObjBindMethod(implObj, "get_CurrentControllerFor"), flags, 2)
        this.vtbl.get_CurrentDescribedBy := CallbackCreate(ObjBindMethod(implObj, "get_CurrentDescribedBy"), flags, 2)
        this.vtbl.get_CurrentFlowsTo := CallbackCreate(ObjBindMethod(implObj, "get_CurrentFlowsTo"), flags, 2)
        this.vtbl.get_CurrentProviderDescription := CallbackCreate(ObjBindMethod(implObj, "get_CurrentProviderDescription"), flags, 2)
        this.vtbl.get_CachedProcessId := CallbackCreate(ObjBindMethod(implObj, "get_CachedProcessId"), flags, 2)
        this.vtbl.get_CachedControlType := CallbackCreate(ObjBindMethod(implObj, "get_CachedControlType"), flags, 2)
        this.vtbl.get_CachedLocalizedControlType := CallbackCreate(ObjBindMethod(implObj, "get_CachedLocalizedControlType"), flags, 2)
        this.vtbl.get_CachedName := CallbackCreate(ObjBindMethod(implObj, "get_CachedName"), flags, 2)
        this.vtbl.get_CachedAcceleratorKey := CallbackCreate(ObjBindMethod(implObj, "get_CachedAcceleratorKey"), flags, 2)
        this.vtbl.get_CachedAccessKey := CallbackCreate(ObjBindMethod(implObj, "get_CachedAccessKey"), flags, 2)
        this.vtbl.get_CachedHasKeyboardFocus := CallbackCreate(ObjBindMethod(implObj, "get_CachedHasKeyboardFocus"), flags, 2)
        this.vtbl.get_CachedIsKeyboardFocusable := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsKeyboardFocusable"), flags, 2)
        this.vtbl.get_CachedIsEnabled := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsEnabled"), flags, 2)
        this.vtbl.get_CachedAutomationId := CallbackCreate(ObjBindMethod(implObj, "get_CachedAutomationId"), flags, 2)
        this.vtbl.get_CachedClassName := CallbackCreate(ObjBindMethod(implObj, "get_CachedClassName"), flags, 2)
        this.vtbl.get_CachedHelpText := CallbackCreate(ObjBindMethod(implObj, "get_CachedHelpText"), flags, 2)
        this.vtbl.get_CachedCulture := CallbackCreate(ObjBindMethod(implObj, "get_CachedCulture"), flags, 2)
        this.vtbl.get_CachedIsControlElement := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsControlElement"), flags, 2)
        this.vtbl.get_CachedIsContentElement := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsContentElement"), flags, 2)
        this.vtbl.get_CachedIsPassword := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsPassword"), flags, 2)
        this.vtbl.get_CachedNativeWindowHandle := CallbackCreate(ObjBindMethod(implObj, "get_CachedNativeWindowHandle"), flags, 2)
        this.vtbl.get_CachedItemType := CallbackCreate(ObjBindMethod(implObj, "get_CachedItemType"), flags, 2)
        this.vtbl.get_CachedIsOffscreen := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsOffscreen"), flags, 2)
        this.vtbl.get_CachedOrientation := CallbackCreate(ObjBindMethod(implObj, "get_CachedOrientation"), flags, 2)
        this.vtbl.get_CachedFrameworkId := CallbackCreate(ObjBindMethod(implObj, "get_CachedFrameworkId"), flags, 2)
        this.vtbl.get_CachedIsRequiredForForm := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsRequiredForForm"), flags, 2)
        this.vtbl.get_CachedItemStatus := CallbackCreate(ObjBindMethod(implObj, "get_CachedItemStatus"), flags, 2)
        this.vtbl.get_CachedBoundingRectangle := CallbackCreate(ObjBindMethod(implObj, "get_CachedBoundingRectangle"), flags, 2)
        this.vtbl.get_CachedLabeledBy := CallbackCreate(ObjBindMethod(implObj, "get_CachedLabeledBy"), flags, 2)
        this.vtbl.get_CachedAriaRole := CallbackCreate(ObjBindMethod(implObj, "get_CachedAriaRole"), flags, 2)
        this.vtbl.get_CachedAriaProperties := CallbackCreate(ObjBindMethod(implObj, "get_CachedAriaProperties"), flags, 2)
        this.vtbl.get_CachedIsDataValidForForm := CallbackCreate(ObjBindMethod(implObj, "get_CachedIsDataValidForForm"), flags, 2)
        this.vtbl.get_CachedControllerFor := CallbackCreate(ObjBindMethod(implObj, "get_CachedControllerFor"), flags, 2)
        this.vtbl.get_CachedDescribedBy := CallbackCreate(ObjBindMethod(implObj, "get_CachedDescribedBy"), flags, 2)
        this.vtbl.get_CachedFlowsTo := CallbackCreate(ObjBindMethod(implObj, "get_CachedFlowsTo"), flags, 2)
        this.vtbl.get_CachedProviderDescription := CallbackCreate(ObjBindMethod(implObj, "get_CachedProviderDescription"), flags, 2)
        this.vtbl.GetClickablePoint := CallbackCreate(ObjBindMethod(implObj, "GetClickablePoint"), flags, 3)
    }
