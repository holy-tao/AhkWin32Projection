 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nn-uiautomationclient-iuiautomationtextpattern
...
class IUIAutomationTextPattern extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-rangefrompoint
     */
    RangeFromPoint(pt) {
        result := ComCall(3, this, "ptr", pt, "ptr*", &range := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-rangefromchild
     */
    RangeFromChild(child) {
        result := ComCall(4, this, "ptr", child, "ptr*", &range := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-getselection
     */
    GetSelection() {
        result := ComCall(5, this, "ptr*", &ranges := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-getvisibleranges
     */
    GetVisibleRanges() {
        result := ComCall(6, this, "ptr*", &ranges := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-get_documentrange
     */
    get_DocumentRange() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/uiautomationclient/nf-uiautomationclient-iuiautomationtextpattern-get_supportedtextselection
     */
    get_SupportedTextSelection() {
        result := ComCall(8, this, "int*", &supportedTextSelection_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return supportedTextSelection_
    }
}
