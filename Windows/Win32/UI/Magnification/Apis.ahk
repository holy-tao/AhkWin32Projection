 ...
 */
export MagInitialize() {
    result := DllCall("MAGNIFICATION.dll\MagInitialize", BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagUninitialize() {
    result := DllCall("MAGNIFICATION.dll\MagUninitialize", BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagSetWindowSource(_hwnd, _rect) {
    result := DllCall("MAGNIFICATION.dll\MagSetWindowSource", HWND, _hwnd, RECT, _rect, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagGetWindowSource(_hwnd, pRect) {
    result := DllCall("MAGNIFICATION.dll\MagGetWindowSource", HWND, _hwnd, RECT.Ptr, pRect, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagSetWindowTransform(_hwnd, pTransform) {
    result := DllCall("MAGNIFICATION.dll\MagSetWindowTransform", HWND, _hwnd, MAGTRANSFORM.Ptr, pTransform, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagGetWindowTransform(_hwnd, pTransform) {
    result := DllCall("MAGNIFICATION.dll\MagGetWindowTransform", HWND, _hwnd, MAGTRANSFORM.Ptr, pTransform, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagSetWindowFilterList(_hwnd, dwFilterMode, count, pHWND) {
    result := DllCall("MAGNIFICATION.dll\MagSetWindowFilterList", HWND, _hwnd, MW_FILTERMODE, dwFilterMode, "int", count, HWND.Ptr, pHWND, BOOL)
    return result
}
...
export MagGetWindowFilterList(_hwnd, pdwFilterMode, count, pHWND) {
    ...
    result := DllCall("MAGNIFICATION.dll\MagGetWindowFilterList", HWND, _hwnd, pdwFilterModeMarshal, pdwFilterMode, "int", count, HWND.Ptr, pHWND, Int32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagSetColorEffect(_hwnd, pEffect) {
    result := DllCall("MAGNIFICATION.dll\MagSetColorEffect", HWND, _hwnd, MAGCOLOREFFECT.Ptr, pEffect, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export MagGetColorEffect(_hwnd, pEffect) {
    result := DllCall("MAGNIFICATION.dll\MagGetColorEffect", HWND, _hwnd, MAGCOLOREFFECT.Ptr, pEffect, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export MagSetFullscreenTransform(magLevel, xOffset, yOffset) {
    result := DllCall("MAGNIFICATION.dll\MagSetFullscreenTransform", "float", magLevel, "int", xOffset, "int", yOffset, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export MagSetFullscreenColorEffect(pEffect) {
    result := DllCall("MAGNIFICATION.dll\MagSetFullscreenColorEffect", MAGCOLOREFFECT.Ptr, pEffect, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export MagGetFullscreenColorEffect(pEffect) {
    result := DllCall("MAGNIFICATION.dll\MagGetFullscreenColorEffect", MAGCOLOREFFECT.Ptr, pEffect, BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export MagSetInputTransform(fEnabled, pRectSource, pRectDest) {
    A_LastError := 0

    result := DllCall("MAGNIFICATION.dll\MagSetInputTransform", BOOL, fEnabled, RECT.Ptr, pRectSource, RECT.Ptr, pRectDest, BOOL)
 ...
 * @since windows8.0
 */
export MagShowSystemCursor(fShowCursor) {
    result := DllCall("MAGNIFICATION.dll\MagShowSystemCursor", BOOL, fShowCursor, BOOL)
    return result
}
