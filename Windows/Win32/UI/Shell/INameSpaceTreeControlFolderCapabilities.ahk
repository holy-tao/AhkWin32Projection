 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-inamespacetreecontrolfoldercapabilities
...
class INameSpaceTreeControlFolderCapabilities extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-inamespacetreecontrolfoldercapabilities-getfoldercapabilities
     */
    GetFolderCapabilities(nfcMask) {
        result := ComCall(3, this, "int", nfcMask, "int*", &pnfcValue := 0, "int")
        if(result != 0) {
