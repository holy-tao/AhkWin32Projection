 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-itaskbarlist3
...
class ITaskbarList3 extends ITaskbarList2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-setprogressvalue
     */
    SetProgressValue(hwnd_, ullCompleted, ullTotal) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(9, this, "ptr", hwnd_, "uint", ullCompleted, "uint", ullTotal, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-setprogressstate
     */
    SetProgressState(hwnd_, tbpFlags) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(10, this, "ptr", hwnd_, "int", tbpFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-registertab
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-unregistertab
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-settaborder
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-settabactive
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-thumbbaraddbuttons
     */
    ThumbBarAddButtons(hwnd_, cButtons, pButton) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(15, this, "ptr", hwnd_, "uint", cButtons, "ptr", pButton, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-thumbbarupdatebuttons
     */
    ThumbBarUpdateButtons(hwnd_, cButtons, pButton) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(16, this, "ptr", hwnd_, "uint", cButtons, "ptr", pButton, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-thumbbarsetimagelist
     */
    ThumbBarSetImageList(hwnd_, himl) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        himl := himl is Win32Handle ? NumGet(himl, "ptr") : himl

        result := ComCall(17, this, "ptr", hwnd_, "ptr", himl, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-setoverlayicon
     */
    SetOverlayIcon(hwnd_, hIcon_, pszDescription) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        ...
        result := ComCall(18, this, "ptr", hwnd_, "ptr", hIcon_, "ptr", pszDescription, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-setthumbnailtooltip
     */
    SetThumbnailTooltip(hwnd_, pszTip) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        pszTip := pszTip is String ? StrPtr(pszTip) : pszTip

        result := ComCall(19, this, "ptr", hwnd_, "ptr", pszTip, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist3-setthumbnailclip
     */
    SetThumbnailClip(hwnd_, prcClip) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(20, this, "ptr", hwnd_, "ptr", prcClip, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
