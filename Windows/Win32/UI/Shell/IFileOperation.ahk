...
class IFileOperation extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IFileOperationProgressSink>} pfops 
     * @param {Pointer<UInt32>} pdwCookie 
     * @returns {HRESULT} 
     */
    Advise(pfops, pdwCookie) {
        result := ComCall(3, this, "ptr", pfops, "uint*", pdwCookie, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<IOperationsProgressDialog>} popd 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<IPropertyChangeArray>} pproparray 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<IUnknown>} punkItems 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<IFileOperationProgressSink>} pfopsItem 
     * @returns {HRESULT} 
     */
     ...
     * 
     * @param {Pointer<IShellItem>} psiItem 
     * @param {Pointer<IShellItem>} psiDestinationFolder 
     * @param {PWSTR} pszNewName 
     * @param {Pointer<IFileOperationProgressSink>} pfopsItem 
     * @returns {HRESULT} 
     */
    ...
    GetAnyOperationsAborted(pfAnyOperationsAborted) {
        result := ComCall(22, this, "ptr", pfAnyOperationsAborted, "int")
        if(result != 0)
            throw OSError(result)
