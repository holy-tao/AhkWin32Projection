...
export default struct IFileOperation extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetOperationFlags := CallbackCreate(ObjBindMethod(implObj, "SetOperationFlags"), flags, 2)
        this.vtbl.SetProgressMessage := CallbackCreate(ObjBindMethod(implObj, "SetProgressMessage"), flags, 2)
        this.vtbl.SetProgressDialog := CallbackCreate(ObjBindMethod(implObj, "SetProgressDialog"), flags, 2)
        ...
        this.vtbl.ApplyPropertiesToItem := CallbackCreate(ObjBindMethod(implObj, "ApplyPropertiesToItem"), flags, 2)
        this.vtbl.ApplyPropertiesToItems := CallbackCreate(ObjBindMethod(implObj, "ApplyPropertiesToItems"), flags, 2)
        this.vtbl.RenameItem := CallbackCreate(ObjBindMethod(implObj, "RenameItem"), flags, 4)
        this.vtbl.RenameItems := CallbackCreate(ObjBindMethod(implObj, "RenameItems"), flags, 3)
        this.vtbl.MoveItem := CallbackCreate(ObjBindMethod(implObj, "MoveItem"), flags, 5)
        this.vtbl.MoveItems := CallbackCreate(ObjBindMethod(implObj, "MoveItems"), flags, 3)
        this.vtbl.CopyItem := CallbackCreate(ObjBindMethod(implObj, "CopyItem"), flags, 5)
        this.vtbl.CopyItems := CallbackCreate(ObjBindMethod(implObj, "CopyItems"), flags, 3)
        this.vtbl.DeleteItem := CallbackCreate(ObjBindMethod(implObj, "DeleteItem"), flags, 3)
        this.vtbl.DeleteItems := CallbackCreate(ObjBindMethod(implObj, "DeleteItems"), flags, 2)
        this.vtbl.NewItem := CallbackCreate(ObjBindMethod(implObj, "NewItem"), flags, 6)
        this.vtbl.PerformOperations := CallbackCreate(ObjBindMethod(implObj, "PerformOperations"), flags, 1)
        this.vtbl.GetAnyOperationsAborted := CallbackCreate(ObjBindMethod(implObj, "GetAnyOperationsAborted"), flags, 2)
    }
