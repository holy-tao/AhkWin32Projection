 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch
...
class IShellDispatch extends IDispatch{
     ...
     * @returns {Folder} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-namespace
     */
    NameSpace(vDir) {
        result := ComCall(9, this, "ptr", vDir, "ptr*", &ppsdf := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Hwnd_ Type: **Integer**
     * 
     ...
     * @returns {Folder} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-browseforfolder
     */
    BrowseForFolder(Hwnd_, Title, Options, RootFolder) {
        if(Title is String) {
            pin := BSTR.Alloc(Title)
            Title := pin.Value
        }

        result := ComCall(10, this, "int", Hwnd_, "ptr", Title, "int", Options, "ptr", RootFolder, "ptr*", &ppsdf := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IDispatch} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-windows
     */
    Windows() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-open
     */
    Open(vDir) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-explore
     */
    Explore(vDir) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-minimizeall
     */
    MinimizeAll() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-undominimizeall
     */
    UndoMinimizeALL() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-filerun
     */
    FileRun() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-cascadewindows
     */
    CascadeWindows() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-tilevertically
     */
    TileVertically() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-tilehorizontally
     */
    TileHorizontally() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-shutdownwindows
     */
    ShutdownWindows() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-suspend
     */
    Suspend() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-ejectpc
     */
    EjectPC() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-settime
     */
    SetTime() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-trayproperties
     */
    TrayProperties() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-help
     */
    Help() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-findfiles
     */
    FindFiles() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-findcomputer
     */
    FindComputer() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-refreshmenu
     */
    RefreshMenu() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch-controlpanelitem
     */
    ControlPanelItem(bstrDir) {
        if(bstrDir is String) {
            pin := BSTR.Alloc(bstrDir)
            bstrDir := pin.Value
        }
