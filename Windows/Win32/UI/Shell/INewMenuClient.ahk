 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-inewmenuclient
...
class INewMenuClient extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-inewmenuclient-includeitems
     */
    IncludeItems() {
        result := ComCall(3, this, "int*", &pflags := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-inewmenuclient-selectandedititem
     */
