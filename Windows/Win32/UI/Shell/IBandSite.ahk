 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ibandsite
...
class IBandSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-addband
     */
    AddBand(punk) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-enumbands
     */
    EnumBands(uBand) {
        result := ComCall(4, this, "uint", uBand, "uint*", &pdwBandID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-queryband
     */
    QueryBand(dwBandID, ppstb, pdwState, pszName, cchName) {
        ...
        result := ComCall(5, this, "uint", dwBandID, "ptr*", ppstb, pdwStateMarshal, pdwState, "ptr", pszName, "int", cchName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-setbandstate
     */
     ...
     * 
     * Returns S_OK if successful, or a COM-defined error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-removeband
     */
    RemoveBand(dwBandID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-getbandobject
     */
    GetBandObject(dwBandID, riid) {
        result := ComCall(8, this, "uint", dwBandID, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns S_OK if successful, or a COM-defined error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-setbandsiteinfo
     */
     ...
     * 
     * Returns S_OK if successful, or a COM-defined error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibandsite-getbandsiteinfo
     */
