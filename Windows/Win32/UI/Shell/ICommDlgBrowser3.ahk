 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-icommdlgbrowser3
...
class ICommDlgBrowser3 extends ICommDlgBrowser2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-icommdlgbrowser3-oncolumnclicked
     */
    OnColumnClicked(ppshv, iColumn) {
        result := ComCall(9, this, "ptr", ppshv, "int", iColumn, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-icommdlgbrowser3-getcurrentfilter
     */
    GetCurrentFilter(pszFileSpec, cchFileSpec) {
        pszFileSpec := pszFileSpec is String ? StrPtr(pszFileSpec) : pszFileSpec

        result := ComCall(10, this, "ptr", pszFileSpec, "int", cchFileSpec, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-icommdlgbrowser3-onpreviewcreated
     */
    OnPreViewCreated(ppshv) {
        result := ComCall(11, this, "ptr", ppshv, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
