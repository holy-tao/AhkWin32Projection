 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nn-shappmgr-iapppublisher
...
class IAppPublisher extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-iapppublisher-getnumberofcategories
     */
    GetNumberOfCategories() {
        result := ComCall(3, this, "uint*", &pdwCat := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-iapppublisher-getcategories
     */
    GetCategories() {
     ...
     * @returns {Integer} This parameter is unused.
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-iapppublisher-getnumberofapps
     */
    GetNumberOfApps() {
        result := ComCall(5, this, "uint*", &pdwApps := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-iapppublisher-enumapps
     */
    EnumApps(pAppCategoryId) {
        result := ComCall(6, this, "ptr", pAppCategoryId, "ptr*", &ppepa := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
