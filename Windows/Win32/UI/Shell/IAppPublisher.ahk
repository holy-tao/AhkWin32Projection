...
#Import ".\IEnumPublishedApps.ahk" { IEnumPublishedApps }
#Import "..\..\Foundation\HRESULT.ahk" { HRESULT }
#Import "..\..\System\Com\IUnknown.ahk" { IUnknown }
#Import ".\APPCATEGORYINFOLIST.ahk" { APPCATEGORYINFOLIST }
 ...
 * @see https://learn.microsoft.com/windows/win32/api/shappmgr/nn-shappmgr-iapppublisher
 * @namespace Windows.Win32.UI.Shell
 */
export default struct IAppPublisher extends IUnknown {
    /**
     ...
     * used for IAppPublisher interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetNumberOfCategories : IntPtr
        GetCategories         : IntPtr
        GetNumberOfApps       : IntPtr
        EnumApps              : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAppPublisher.Vtbl()
        }
    ...
    GetCategories() {
        ...
        result := ComCall(4, this, APPCATEGORYINFOLIST.Ptr, pAppCategoryList, "HRESULT")
     ...
     * @remarks
     * <div class="alert"><b>Note</b>  <a href="https://docs.microsoft.com/windows/desktop/api/shappmgr/nn-shappmgr-ienumpublishedapps">IEnumPublishedApps</a> is not a standard enumeration interface. It does not support a Skip method nor does its Next method support retrieval of multiple items.</div>
     * <div> </div>
    ...
    EnumApps(pAppCategoryId) {
        result := ComCall(6, this, Guid.Ptr, pAppCategoryId, "ptr*", &ppepa := 0, "HRESULT")
        return IEnumPublishedApps(ppepa)
    }

    Query(iid) {
        if (IAppPublisher.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetNumberOfCategories)
        CallbackFree(this.vtbl.GetCategories)
        CallbackFree(this.vtbl.GetNumberOfApps)
        CallbackFree(this.vtbl.EnumApps)
    }
}
