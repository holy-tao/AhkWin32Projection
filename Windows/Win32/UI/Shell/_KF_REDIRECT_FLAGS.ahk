...
class _KF_REDIRECT_FLAGS extends Win32Enum {
     ...
     * Native name: KF_REDIRECT_USER_EXCLUSIVE
     * @type {Integer (Int32)}
     */
    static USER_EXCLUSIVE => 1

    /**
     * Copy the DACL of the source folder to the target to maintain current access permissions.
     * Native name: KF_REDIRECT_COPY_SOURCE_DACL
     * @type {Integer (Int32)}
     */
    static COPY_SOURCE_DACL => 2
     ...
     * Native name: KF_REDIRECT_OWNER_USER
     * @type {Integer (Int32)}
     */
    static OWNER_USER => 4
     ...
     * Native name: KF_REDIRECT_SET_OWNER_EXPLICIT
     * @type {Integer (Int32)}
     */
    static SET_OWNER_EXPLICIT => 8
     ...
     * Native name: KF_REDIRECT_CHECK_ONLY
     * @type {Integer (Int32)}
     */
    static CHECK_ONLY => 16

    /**
     * Display UI during the redirection.
     * Native name: KF_REDIRECT_WITH_UI
     * @type {Integer (Int32)}
     */
    static WITH_UI => 32
     ...
     * Native name: KF_REDIRECT_COPY_CONTENTS
     * @type {Integer (Int32)}
     */
    static COPY_CONTENTS => 512
     ...
     * Native name: KF_REDIRECT_DEL_SOURCE_CONTENTS
     * @type {Integer (Int32)}
     */
    static DEL_SOURCE_CONTENTS => 1024

    /**
     * Reserved. Do not use.
     * Native name: KF_REDIRECT_EXCLUDE_ALL_KNOWN_SUBFOLDERS
     * @type {Integer (Int32)}
     */
    static EXCLUDE_ALL_KNOWN_SUBFOLDERS => 2048
}
