...
class IShellItemArray extends IUnknown{
    ...
    BindToHandler(pbc, bhid, riid, ppvOut) {
        result := ComCall(3, this, "ptr", pbc, "ptr", bhid, "ptr", riid, "ptr", ppvOut, "int")
        if(result != 0)
    ...
    GetPropertyStore(flags, riid, ppv) {
        result := ComCall(4, this, "int", flags, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetPropertyDescriptionList(keyType, riid, ppv) {
        result := ComCall(5, this, "ptr", keyType, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAttributes(AttribFlags, sfgaoMask, psfgaoAttribs) {
        result := ComCall(6, this, "int", AttribFlags, "uint", sfgaoMask, "uint*", psfgaoAttribs, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pdwNumItems 
     * @returns {HRESULT} 
     */
    GetCount(pdwNumItems) {
        result := ComCall(7, this, "uint*", pdwNumItems, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetItemAt(dwIndex, ppsi) {
        result := ComCall(8, this, "uint", dwIndex, "ptr", ppsi, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumItems(ppenumShellItems) {
        result := ComCall(9, this, "ptr", ppenumShellItems, "int")
        if(result != 0)
            throw OSError(result)
