 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ishellitemarray
...
class IShellItemArray extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-bindtohandler
     */
    BindToHandler(pbc, bhid, riid) {
        result := ComCall(3, this, "ptr", pbc, "ptr", bhid, "ptr", riid, "ptr*", &ppvOut := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-getpropertystore
     */
    GetPropertyStore(flags, riid) {
        result := ComCall(4, this, "int", flags, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-getpropertydescriptionlist
     */
    GetPropertyDescriptionList(keyType, riid) {
        result := ComCall(5, this, "ptr", keyType, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-getattributes
     */
    GetAttributes(AttribFlags, sfgaoMask) {
        result := ComCall(6, this, "int", AttribFlags, "uint", sfgaoMask, "uint*", &psfgaoAttribs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-getcount
     */
    GetCount() {
        result := ComCall(7, this, "uint*", &pdwNumItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-getitemat
     */
    GetItemAt(dwIndex) {
        result := ComCall(8, this, "uint", dwIndex, "ptr*", &ppsi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitemarray-enumitems
     */
    EnumItems() {
        result := ComCall(9, this, "ptr*", &ppenumShellItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
