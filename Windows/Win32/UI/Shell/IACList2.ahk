 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-iaclist2
...
class IACList2 extends IACList{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iaclist2-setoptions
     */
    SetOptions(dwFlag) {
        result := ComCall(4, this, "uint", dwFlag, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iaclist2-getoptions
     */
    GetOptions() {
        result := ComCall(5, this, "uint*", &pdwFlag := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
