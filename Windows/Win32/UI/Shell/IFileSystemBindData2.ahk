 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ifilesystembinddata2
...
class IFileSystemBindData2 extends IFileSystemBindData{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifilesystembinddata2-setfileid
     */
    SetFileID(liFileID) {
        result := ComCall(5, this, "int64", liFileID, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifilesystembinddata2-getfileid
     */
    GetFileID() {
        result := ComCall(6, this, "int64*", &pliFileID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifilesystembinddata2-setjunctionclsid
     */
    SetJunctionCLSID(clsid) {
        result := ComCall(7, this, "ptr", clsid, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifilesystembinddata2-getjunctionclsid
     */
    GetJunctionCLSID() {
        pclsid := Guid()
