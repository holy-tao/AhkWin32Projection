 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ishellitem
...
class IShellItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitem-bindtohandler
     */
    BindToHandler(pbc, bhid, riid) {
        result := ComCall(3, this, "ptr", pbc, "ptr", bhid, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitem-getparent
     */
    GetParent() {
        result := ComCall(4, this, "ptr*", &ppsi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitem-getdisplayname
     */
    GetDisplayName(sigdnName) {
        result := ComCall(5, this, "int", sigdnName, "ptr*", &ppszName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitem-getattributes
     */
    GetAttributes(sfgaoMask) {
        result := ComCall(6, this, "uint", sfgaoMask, "uint*", &psfgaoAttribs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellitem-compare
     */
    Compare(psi, hint) {
        result := ComCall(7, this, "ptr", psi, "uint", hint, "int*", &piOrder := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
