 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-idragsourcehelper2
...
class IDragSourceHelper2 extends IDragSourceHelper{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-idragsourcehelper2-setflags
     */
    SetFlags(dwFlags) {
