...
#Import ".\SYNCMGRITEM.ahk" { SYNCMGRITEM }
 ...
 */
export default struct ISyncMgrEnumItems extends IUnknown {
    /**
     ...
     * used for ISyncMgrEnumItems interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISyncMgrEnumItems.Vtbl()
        }
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, SYNCMGRITEM.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
    ...
    _Query(iid) {
        if (ISyncMgrEnumItems.IID.Equals(iid)) {
            return true
        }
