 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ihomegroup
...
class IHomeGroup extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ihomegroup-ismember
     */
    IsMember() {
        result := ComCall(3, this, "int*", &member := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ihomegroup-showsharingwizard
     */
    ShowSharingWizard(owner) {
        owner := owner is Win32Handle ? NumGet(owner, "ptr") : owner

        result := ComCall(4, this, "ptr", owner, "int*", &sharingchoices := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
