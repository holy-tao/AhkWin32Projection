...
export default struct IShellLibrary extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.LoadLibraryFromItem := CallbackCreate(ObjBindMethod(implObj, "LoadLibraryFromItem"), flags, 3)
        this.vtbl.LoadLibraryFromKnownFolder := CallbackCreate(ObjBindMethod(implObj, "LoadLibraryFromKnownFolder"), flags, 3)
        this.vtbl.AddFolder := CallbackCreate(ObjBindMethod(implObj, "AddFolder"), flags, 2)
        this.vtbl.RemoveFolder := CallbackCreate(ObjBindMethod(implObj, "RemoveFolder"), flags, 2)
        this.vtbl.GetFolders := CallbackCreate(ObjBindMethod(implObj, "GetFolders"), flags, 4)
        this.vtbl.ResolveFolder := CallbackCreate(ObjBindMethod(implObj, "ResolveFolder"), flags, 5)
        this.vtbl.GetDefaultSaveFolder := CallbackCreate(ObjBindMethod(implObj, "GetDefaultSaveFolder"), flags, 4)
        this.vtbl.SetDefaultSaveFolder := CallbackCreate(ObjBindMethod(implObj, "SetDefaultSaveFolder"), flags, 3)
        ...
        this.vtbl.SetFolderType := CallbackCreate(ObjBindMethod(implObj, "SetFolderType"), flags, 2)
        ...
        this.vtbl.SaveInKnownFolder := CallbackCreate(ObjBindMethod(implObj, "SaveInKnownFolder"), flags, 5)
    }
