 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-inamespacewalkcb2
...
class INamespaceWalkCB2 extends INamespaceWalkCB{
     ...
     * 
     * Always returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-inamespacewalkcb2-walkcomplete
     */
    WalkComplete(hr) {
        result := ComCall(7, this, "int", hr, "int")
        if(result != 0) {
