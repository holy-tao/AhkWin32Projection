 ...
 */
export default struct IOpenControlPanel extends IUnknown {
    /**
     ...
     * used for IOpenControlPanel interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IOpenControlPanel.Vtbl()
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api/shobjidl_core/nf-shobjidl_core-iopencontrolpanel-getpath
     */
    ...
    Query(iid) {
        if (IOpenControlPanel.IID.Equals(iid)) {
            return true
        }
