 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iopencontrolpanel
...
class IOpenControlPanel extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iopencontrolpanel-open
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iopencontrolpanel-getpath
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iopencontrolpanel-getcurrentview
     */
    GetCurrentView() {
        result := ComCall(5, this, "int*", &pView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
