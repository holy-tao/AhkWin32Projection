 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-ienumsyncmgrconflict
...
class IEnumSyncMgrConflict extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-ienumsyncmgrconflict-next
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-ienumsyncmgrconflict-skip
     */
    Skip(celt) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-ienumsyncmgrconflict-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-ienumsyncmgrconflict-clone
     */
    Clone() {
