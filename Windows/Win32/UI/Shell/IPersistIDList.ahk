 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ipersistidlist
...
class IPersistIDList extends IPersist{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ipersistidlist-setidlist
     */
    SetIDList(pidl) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ipersistidlist-getidlist
     */
    GetIDList() {
