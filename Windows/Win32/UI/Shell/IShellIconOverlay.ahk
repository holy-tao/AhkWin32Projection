 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-ishelliconoverlay
...
class IShellIconOverlay extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-ishelliconoverlay-getoverlayindex
     */
    GetOverlayIndex(pidl, pIndex) {
        pIndexMarshal := pIndex is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", pidl, pIndexMarshal, pIndex, "int")
        if(result != 0) {
     ...
     * 
     * Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/shtypes/ns-shtypes-itemidlist">ITEMIDLIST</a> structure that identifies the object whose icon is being displayed.
     * @param {Pointer<Integer>} pIconIndex Type: <b>int*</b>
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-ishelliconoverlay-getoverlayiconindex
     */
    GetOverlayIconIndex(pidl, pIconIndex) {
        pIconIndexMarshal := pIconIndex is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", pidl, pIconIndexMarshal, pIconIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
