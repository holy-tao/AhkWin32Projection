...
export default struct IShellFolderViewCB extends IUnknown {
    ...
    */
     ...
     * </td>
     * <td>Allows the callback object to provide the details for an item in a Shell folder. Use only if a call to <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ishellfolder2-getdetailsof">GetDetailsOf</a> fails and there is no <a href="https://docs.microsoft.com/windows/desktop/api/shlobj_core/nf-shlobj_core-ishelldetails-getdetailsof">GetDetailsOf</a> method available to call.</td>
     * </tr>
     * <tr>
     * <td>
     ...
     * </td>
     * <td>Specifies which events will generate an <a href="https://docs.microsoft.com/windows/desktop/shell/sfvm-fsnotify">SFVM_FSNOTIFY</a> message for a given item.</td>
     * </tr>
     * <tr>
     * <td>
     ...
     * </td>
     * <td>Allows the callback object to specify a <a href="https://docs.microsoft.com/windows/desktop/Controls/tooltip-controls">tooltip</a> text string for menu items or toolbar buttons.</td>
     * </tr>
     * <tr>
     * <td>
     ...
     * </td>
     * <td>Allows the callback object to specify the view's PIDL. This is used only when <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ipersistidlist-setidlist">SetIDList</a> and <a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/nf-shobjidl_core-ipersistfolder2-getcurfolder">IPersistFolder2::GetCurFolder</a> have failed.</td>
     * </tr>
     * <tr>
     * <td>
    ...
    MessageSFVCB(uMsg, _wParam, _lParam) {
        result := ComCall(3, this, UInt32, uMsg, WPARAM, _wParam, LPARAM, _lParam, "HRESULT")
        return result
    }
