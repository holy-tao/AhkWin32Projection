 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nn-shdeprecated-ibrowserservice2
...
class IBrowserService2 extends IBrowserService{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-wndprocbs
     */
    WndProcBS(hwnd_, uMsg, wParam_, lParam_) {
        ...
        result := ComCall(33, this, "ptr", hwnd_, "uint", uMsg, "ptr", wParam_, "ptr", lParam_, "ptr")
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-setasdeffoldersettings
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-getviewrect
     */
    GetViewRect() {
        prc := RECT()
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-onsize
     */
    OnSize(wParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_

        result := ComCall(36, this, "ptr", wParam_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-oncreate
     */
    OnCreate(pcs) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-oncommand
     */
    OnCommand(wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(38, this, "ptr", wParam_, "ptr", lParam_, "ptr")
        resultHandle := LRESULT({Value: result}, True)
        return resultHandle
    }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-ondestroy
     */
    OnDestroy() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-onnotify
     */
    OnNotify(pnm) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-onsetfocus
     */
    OnSetFocus() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-onframewindowactivatebs
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-releaseshellview
     */
    ReleaseShellView() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-activatependingview
     */
    ActivatePendingView() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-createviewwindow
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-createbrowserpropsheetext
     */
    CreateBrowserPropSheetExt(riid) {
        result := ComCall(46, this, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-getviewwindow
     */
    GetViewWindow() {
        phwndView := HWND()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-getbasebrowserdata
     */
    GetBaseBrowserData() {
        result := ComCall(48, this, "ptr*", &pbbd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-putbasebrowserdata
     */
    PutBaseBrowserData() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-initializetravellog
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-settopbrowser
     */
    SetTopBrowser() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-offline
     */
    Offline(iCmd) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-allowviewresize
     */
    AllowViewResize(f) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-setactivatestate
     */
    SetActivateState(u) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-updatesecurelockicon
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-initializedownloadmanager
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-initializetransitionsite
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_initialize
     */
    _Initialize(hwnd_, pauto) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(58, this, "ptr", hwnd_, "ptr", pauto, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_cancelpendingnavigationasync
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_cancelpendingview
     */
    _CancelPendingView() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_maysavechanges
     */
    _MaySaveChanges() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_pauseorresumeview
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_disablemodeless
     */
    _DisableModeless() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_tryshell2rename
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_switchactivationnow
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_execchildren
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_sendchildren
     */
    _SendChildren(hwndBar, fBroadcast, uMsg, wParam_, lParam_) {
        hwndBar := hwndBar is Win32Handle ? NumGet(hwndBar, "ptr") : hwndBar
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(68, this, "ptr", hwndBar, "int", fBroadcast, "uint", uMsg, "ptr", wParam_, "ptr", lParam_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-getfoldersetdata
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_onfocuschange
     */
    _OnFocusChange(itb) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-v_showhidechildwindows
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_get_itblastfocus
     */
    _get_itbLastFocus() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_put_itblastfocus
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_uiactivateview
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_getviewborderrect
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_updateviewrectsize
     */
    _UpdateViewRectSize() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_resizenextborder
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_resizeview
     */
    _ResizeView() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_geteffectiveclientarea
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-v_getviewstream
     */
     ...
     * 
     * The return value specifies the result of the message processing; it depends on the message sent.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-forwardviewmsg
     */
    ForwardViewMsg(uMsg, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(81, this, "uint", uMsg, "ptr", wParam_, "ptr", lParam_, "ptr")
        resultHandle := LRESULT({Value: result}, True)
        return resultHandle
    }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-setacceleratormenu
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_gettoolbarcount
     */
    _GetToolbarCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_gettoolbaritem
     */
    _GetToolbarItem(itb) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_savetoolbars
     */
    _SaveToolbars(pstm) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_loadtoolbars
     */
    _LoadToolbars(pstm) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_closeandreleasetoolbars
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-v_maygetnexttoolbarfocus
     */
    v_MayGetNextToolbarFocus(lpMsg, itbNext, citb, pptbi, phwnd) {
        pptbiMarshal := pptbi is VarRef ? "ptr*" : "ptr"

        result := ComCall(88, this, "ptr", lpMsg, "uint", itbNext, "int", citb, pptbiMarshal, pptbi, "ptr", phwnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_resizenextborderhelper
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_findtbar
     */
    _FindTBar(punkSrc) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_setfocus
     */
    _SetFocus(ptbi, hwnd_, lpMsg) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(91, this, "ptr", ptbi, "ptr", hwnd_, "ptr", lpMsg, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-v_maytranslateaccelerator
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-_getborderdwhelper
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice2-v_checkzonecrossing
     */
