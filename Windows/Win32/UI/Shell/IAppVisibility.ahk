 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iappvisibility
...
class IAppVisibility extends IUnknown{
     ...
     * @param {HMONITOR} hMonitor_ The monitor to query.
     * @returns {Integer} The current mode of <i>hMonitor</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibility-getappvisibilityonmonitor
     */
    GetAppVisibilityOnMonitor(hMonitor_) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(3, this, "ptr", hMonitor_, "int*", &pMode := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibility-islaunchervisible
     */
    IsLauncherVisible() {
        result := ComCall(4, this, "int*", &pfVisible := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibility-advise
     */
    Advise(pCallback) {
        result := ComCall(5, this, "ptr", pCallback, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibility-unadvise
     */
    Unadvise(dwCookie) {
