...
class SYNCMGR_ITEM_POLICIES extends Win32Enum {
     ...
     * Native name: SYNCMGR_IPM_PREVENT_ENABLE
     * @type {Integer (Int32)}
     */
    static IPM_PREVENT_ENABLE => 1
     ...
     * Native name: SYNCMGR_IPM_PREVENT_DISABLE
     * @type {Integer (Int32)}
     */
    static IPM_PREVENT_DISABLE => 2
     ...
     * Native name: SYNCMGR_IPM_PREVENT_START_SYNC
     * @type {Integer (Int32)}
     */
    static IPM_PREVENT_START_SYNC => 4
     ...
     * Native name: SYNCMGR_IPM_PREVENT_STOP_SYNC
     * @type {Integer (Int32)}
     */
    static IPM_PREVENT_STOP_SYNC => 8
     ...
     * Native name: SYNCMGR_IPM_DISABLE_ENABLE
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_ENABLE => 16
     ...
     * Native name: SYNCMGR_IPM_DISABLE_DISABLE
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_DISABLE => 32
     ...
     * Native name: SYNCMGR_IPM_DISABLE_START_SYNC
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_START_SYNC => 64
     ...
     * Native name: SYNCMGR_IPM_DISABLE_STOP_SYNC
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_STOP_SYNC => 128
     ...
     * Native name: SYNCMGR_IPM_DISABLE_BROWSE
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_BROWSE => 256
     ...
     * Native name: SYNCMGR_IPM_DISABLE_DELETE
     * @type {Integer (Int32)}
     */
    static IPM_DISABLE_DELETE => 512
     ...
     * Native name: SYNCMGR_IPM_HIDDEN_BY_DEFAULT
     * @type {Integer (Int32)}
     */
    static IPM_HIDDEN_BY_DEFAULT => 65536
     ...
     * Native name: SYNCMGR_IPM_VALID_MASK
     * @type {Integer (Int32)}
     */
    static IPM_VALID_MASK => 66303
}
