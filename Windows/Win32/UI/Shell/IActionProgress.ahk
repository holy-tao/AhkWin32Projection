 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iactionprogress
...
class IActionProgress extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-begin
     */
    Begin(action, flags) {
        result := ComCall(3, this, "int", action, "uint", flags, "int")
        if(result != 0) {
     ...
     * 
     * Return S_OK if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-updateprogress
     */
    UpdateProgress(ulCompleted, ulTotal) {
        result := ComCall(4, this, "uint", ulCompleted, "uint", ulTotal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} sptext_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/ne-shobjidl_core-sptext">SPTEXT</a></b>
     * 
     ...
     * 
     * Return S_OK if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-updatetext
     */
    UpdateText(sptext_, pszText, fMayCompact) {
        pszText := pszText is String ? StrPtr(pszText) : pszText

        result := ComCall(5, this, "int", sptext_, "ptr", pszText, "int", fMayCompact, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-querycancel
     */
    QueryCancel() {
        result := ComCall(6, this, "int*", &pfCancelled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Return S_OK if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-resetcancel
     */
    ResetCancel() {
     ...
     * 
     * Return S_OK if successful, or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iactionprogress-end
     */
    End() {
