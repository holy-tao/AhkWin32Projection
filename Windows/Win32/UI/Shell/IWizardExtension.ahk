 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-iwizardextension
...
class IWizardExtension extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-iwizardextension-addpages
     */
    AddPages(aPages, cPages, pnPagesAdded) {
        pnPagesAddedMarshal := pnPagesAdded is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", aPages, "uint", cPages, pnPagesAddedMarshal, pnPagesAdded, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-iwizardextension-getfirstpage
     */
    GetFirstPage() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-iwizardextension-getlastpage
     */
    GetLastPage() {
        phpage := HPROPSHEETPAGE()
