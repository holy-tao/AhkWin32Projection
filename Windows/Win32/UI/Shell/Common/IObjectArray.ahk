 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objectarray/nn-objectarray-iobjectarray
...
class IObjectArray extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objectarray/nf-objectarray-iobjectarray-getcount
     */
    GetCount() {
        result := ComCall(3, this, "uint*", &pcObjects := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objectarray/nf-objectarray-iobjectarray-getat
     */
    GetAt(uiIndex, riid) {
