 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-isharingconfigurationmanager
...
class ISharingConfigurationManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-createshare
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-deleteshare
     */
    DeleteShare(dsid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-shareexists
     */
    ShareExists(dsid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-getsharepermissions
     */
    GetSharePermissions(dsid) {
        result := ComCall(6, this, "int", dsid, "int*", &pRole := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-shareprinters
     */
    SharePrinters() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-stopsharingprinters
     */
    StopSharingPrinters() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-isharingconfigurationmanager-areprintersshared
     */
    ArePrintersShared() {
