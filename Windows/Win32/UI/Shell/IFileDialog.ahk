...
export default struct IFileDialog extends IModalWindow {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetFileTypes := CallbackCreate(ObjBindMethod(implObj, "SetFileTypes"), flags, 3)
        this.vtbl.SetFileTypeIndex := CallbackCreate(ObjBindMethod(implObj, "SetFileTypeIndex"), flags, 2)
        this.vtbl.GetFileTypeIndex := CallbackCreate(ObjBindMethod(implObj, "GetFileTypeIndex"), flags, 2)
        ...
        this.vtbl.SetDefaultFolder := CallbackCreate(ObjBindMethod(implObj, "SetDefaultFolder"), flags, 2)
        this.vtbl.SetFolder := CallbackCreate(ObjBindMethod(implObj, "SetFolder"), flags, 2)
        this.vtbl.GetFolder := CallbackCreate(ObjBindMethod(implObj, "GetFolder"), flags, 2)
        ...
        this.vtbl.SetOkButtonLabel := CallbackCreate(ObjBindMethod(implObj, "SetOkButtonLabel"), flags, 2)
        this.vtbl.SetFileNameLabel := CallbackCreate(ObjBindMethod(implObj, "SetFileNameLabel"), flags, 2)
        this.vtbl.GetResult := CallbackCreate(ObjBindMethod(implObj, "GetResult"), flags, 2)
        this.vtbl.AddPlace := CallbackCreate(ObjBindMethod(implObj, "AddPlace"), flags, 3)
        this.vtbl.SetDefaultExtension := CallbackCreate(ObjBindMethod(implObj, "SetDefaultExtension"), flags, 2)
        ...
        this.vtbl.ClearClientData := CallbackCreate(ObjBindMethod(implObj, "ClearClientData"), flags, 1)
