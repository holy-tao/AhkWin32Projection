 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ifiledialog
...
class IFileDialog extends IModalWindow{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfiletypes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfiletypeindex
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getfiletypeindex
     */
    GetFileTypeIndex() {
        result := ComCall(6, this, "uint*", &piFileType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-advise
     */
    Advise(pfde) {
        result := ComCall(7, this, "ptr", pfde, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-unadvise
     */
    Unadvise(dwCookie) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setoptions
     */
    SetOptions(fos) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getoptions
     */
    GetOptions() {
        result := ComCall(10, this, "uint*", &pfos := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setdefaultfolder
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfolder
     */
    SetFolder(psi) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getfolder
     */
    GetFolder() {
        result := ComCall(13, this, "ptr*", &ppsi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getcurrentselection
     */
    GetCurrentSelection() {
        result := ComCall(14, this, "ptr*", &ppsi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfilename
     */
    SetFileName(pszName) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getfilename
     */
    GetFileName() {
        result := ComCall(16, this, "ptr*", &pszName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-settitle
     */
    SetTitle(pszTitle) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setokbuttonlabel
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfilenamelabel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-getresult
     */
    GetResult() {
        result := ComCall(20, this, "ptr*", &ppsi := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} fdap_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/shobjidl_core/ne-shobjidl_core-fdap">FDAP</a></b>
     * 
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-addplace
     */
    AddPlace(psi, fdap_) {
        result := ComCall(21, this, "ptr", psi, "int", fdap_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setdefaultextension
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-close
     */
    Close(hr) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setclientguid
     */
    SetClientGuid(guid) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-clearclientdata
     */
    ClearClientData() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifiledialog-setfilter
     */
    SetFilter(pFilter) {
