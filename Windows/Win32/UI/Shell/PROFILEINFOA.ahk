...
/**
 * Contains information used when loading or unloading a user profile. (ANSI)
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/profinfo/ns-profinfo-profileinfoa
