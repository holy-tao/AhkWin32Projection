 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-idroptargethelper
...
class IDropTargetHelper extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idroptargethelper-dragenter
     */
     ...
     * 
     * Returns S_OK if successful, or a COM error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idroptargethelper-dragleave
     */
    DragLeave() {
     ...
     * 
     * Returns S_OK if successful, or a COM error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idroptargethelper-dragover
     */
     ...
     * 
     * Returns S_OK if successful, or a COM error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idroptargethelper-drop
     */
     ...
     * 
     * Returns S_OK if successful, or a COM error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idroptargethelper-show
     */
    Show(fShow) {
