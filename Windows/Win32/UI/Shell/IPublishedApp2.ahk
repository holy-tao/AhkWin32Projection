 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nn-shappmgr-ipublishedapp2
...
class IPublishedApp2 extends IPublishedApp{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ipublishedapp2-install2
     */
    Install2(pstInstall, hwndParent) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(11, this, "ptr", pstInstall, "ptr", hwndParent, "int")
        if(result != 0) {
