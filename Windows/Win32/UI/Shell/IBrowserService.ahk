...
export default struct IBrowserService extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetParentSite := CallbackCreate(ObjBindMethod(implObj, "GetParentSite"), flags, 2)
        this.vtbl.SetTitle := CallbackCreate(ObjBindMethod(implObj, "SetTitle"), flags, 3)
        this.vtbl.GetTitle := CallbackCreate(ObjBindMethod(implObj, "GetTitle"), flags, 4)
        this.vtbl.GetOleObject := CallbackCreate(ObjBindMethod(implObj, "GetOleObject"), flags, 2)
        this.vtbl.GetTravelLog := CallbackCreate(ObjBindMethod(implObj, "GetTravelLog"), flags, 2)
        this.vtbl.ShowControlWindow := CallbackCreate(ObjBindMethod(implObj, "ShowControlWindow"), flags, 3)
        this.vtbl.IsControlWindowShown := CallbackCreate(ObjBindMethod(implObj, "IsControlWindowShown"), flags, 3)
        this.vtbl.IEGetDisplayName := CallbackCreate(ObjBindMethod(implObj, "IEGetDisplayName"), flags, 4)
        this.vtbl.IEParseDisplayName := CallbackCreate(ObjBindMethod(implObj, "IEParseDisplayName"), flags, 4)
        this.vtbl.DisplayParseError := CallbackCreate(ObjBindMethod(implObj, "DisplayParseError"), flags, 3)
        this.vtbl.NavigateToPidl := CallbackCreate(ObjBindMethod(implObj, "NavigateToPidl"), flags, 3)
        this.vtbl.SetNavigateState := CallbackCreate(ObjBindMethod(implObj, "SetNavigateState"), flags, 2)
        this.vtbl.GetNavigateState := CallbackCreate(ObjBindMethod(implObj, "GetNavigateState"), flags, 2)
        this.vtbl.NotifyRedirect := CallbackCreate(ObjBindMethod(implObj, "NotifyRedirect"), flags, 4)
        this.vtbl.UpdateWindowList := CallbackCreate(ObjBindMethod(implObj, "UpdateWindowList"), flags, 1)
        this.vtbl.UpdateBackForwardState := CallbackCreate(ObjBindMethod(implObj, "UpdateBackForwardState"), flags, 1)
        ...
        this.vtbl.CanNavigateNow := CallbackCreate(ObjBindMethod(implObj, "CanNavigateNow"), flags, 1)
        ...
        this.vtbl.GetBrowserIndex := CallbackCreate(ObjBindMethod(implObj, "GetBrowserIndex"), flags, 1)
        this.vtbl.GetBrowserByIndex := CallbackCreate(ObjBindMethod(implObj, "GetBrowserByIndex"), flags, 3)
        this.vtbl.GetHistoryObject := CallbackCreate(ObjBindMethod(implObj, "GetHistoryObject"), flags, 4)
        this.vtbl.SetHistoryObject := CallbackCreate(ObjBindMethod(implObj, "SetHistoryObject"), flags, 3)
        this.vtbl.CacheOLEServer := CallbackCreate(ObjBindMethod(implObj, "CacheOLEServer"), flags, 2)
        this.vtbl.GetSetCodePage := CallbackCreate(ObjBindMethod(implObj, "GetSetCodePage"), flags, 3)
        this.vtbl.OnHttpEquiv := CallbackCreate(ObjBindMethod(implObj, "OnHttpEquiv"), flags, 5)
        this.vtbl.GetPalette := CallbackCreate(ObjBindMethod(implObj, "GetPalette"), flags, 2)
        this.vtbl.RegisterWindow := CallbackCreate(ObjBindMethod(implObj, "RegisterWindow"), flags, 3)
    }
