 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iinputobject
...
class IInputObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iinputobject-uiactivateio
     */
    UIActivateIO(fActivate, pMsg) {
        result := ComCall(3, this, "int", fActivate, "ptr", pMsg, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iinputobject-hasfocusio
     */
    HasFocusIO() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iinputobject-translateacceleratorio
     */
