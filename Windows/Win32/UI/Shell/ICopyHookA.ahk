 ...
 * @charset ANSI
 */
export default struct ICopyHookA extends IUnknown {
    /**
     ...
     * used for ICopyHookA interfaces
    */
    ...
    CopyCallback(_hwnd, wFunc, wFlags, pszSrcFile, dwSrcAttribs, pszDestFile, dwDestAttribs) {
        ...
        pszDestFileMarshal := pszDestFile == 0 ? IntPtr : PSTR
