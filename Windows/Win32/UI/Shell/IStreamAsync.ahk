 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-istreamasync
...
class IStreamAsync extends IStream{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-istreamasync-readasync
     */
    ReadAsync(pv, cb, lpOverlapped) {
        result := ComCall(14, this, "ptr", pv, "uint", cb, "uint*", &pcbRead := 0, "ptr", lpOverlapped, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-istreamasync-writeasync
     */
    WriteAsync(lpBuffer, cb, lpOverlapped) {
        result := ComCall(15, this, "ptr", lpBuffer, "uint", cb, "uint*", &pcbWritten := 0, "ptr", lpOverlapped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-istreamasync-overlappedresult
     */
    OverlappedResult(lpOverlapped, bWait) {
        result := ComCall(16, this, "ptr", lpOverlapped, "uint*", &lpNumberOfBytesTransferred := 0, "int", bWait, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-istreamasync-cancelio
     */
    CancelIo() {
