 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/folderitems2-object
...
class FolderItems2 extends FolderItems{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/folderitems2-invokeverbex
     */
