...
class IShellFolder extends IUnknown{
    ...
    ParseDisplayName(hwnd, pbc, pszDisplayName, ppidl, pdwAttributes) {
        ...
        result := ComCall(3, this, "ptr", hwnd, "ptr", pbc, "ptr", pszDisplayName, "uint*", pchEaten, "ptr", ppidl, "uint*", pdwAttributes, "int")
        if(result != 0)
    ...
    BindToObject(pidl, pbc, riid, ppv) {
        result := ComCall(5, this, "ptr", pidl, "ptr", pbc, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    BindToStorage(pidl, pbc, riid, ppv) {
        result := ComCall(6, this, "ptr", pidl, "ptr", pbc, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateViewObject(hwndOwner, riid, ppv) {
        ...
        result := ComCall(8, this, "ptr", hwndOwner, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} rgfInOut 
     * @returns {HRESULT} 
     */
    GetAttributesOf(cidl, apidl, rgfInOut) {
        result := ComCall(9, this, "uint", cidl, "ptr", apidl, "uint*", rgfInOut, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetUIObjectOf(hwndOwner, cidl, apidl, riid, ppv) {
        ...
        result := ComCall(10, this, "ptr", hwndOwner, "uint", cidl, "ptr", apidl, "ptr", riid, "uint*", rgfReserved, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetNameOf(hwnd, pidl, pszName, uFlags, ppidlOut) {
        ...
        result := ComCall(12, this, "ptr", hwnd, "ptr", pidl, "ptr", pszName, "uint", uFlags, "ptr", ppidlOut, "int")
        if(result != 0)
            throw OSError(result)
