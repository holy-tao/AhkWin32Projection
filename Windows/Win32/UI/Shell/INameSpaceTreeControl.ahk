...
export default struct INameSpaceTreeControl extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.TreeAdvise := CallbackCreate(ObjBindMethod(implObj, "TreeAdvise"), flags, 3)
        this.vtbl.TreeUnadvise := CallbackCreate(ObjBindMethod(implObj, "TreeUnadvise"), flags, 2)
        this.vtbl.AppendRoot := CallbackCreate(ObjBindMethod(implObj, "AppendRoot"), flags, 5)
        this.vtbl.InsertRoot := CallbackCreate(ObjBindMethod(implObj, "InsertRoot"), flags, 6)
        this.vtbl.RemoveRoot := CallbackCreate(ObjBindMethod(implObj, "RemoveRoot"), flags, 2)
        this.vtbl.RemoveAllRoots := CallbackCreate(ObjBindMethod(implObj, "RemoveAllRoots"), flags, 1)
        this.vtbl.GetRootItems := CallbackCreate(ObjBindMethod(implObj, "GetRootItems"), flags, 2)
        this.vtbl.SetItemState := CallbackCreate(ObjBindMethod(implObj, "SetItemState"), flags, 4)
        this.vtbl.GetItemState := CallbackCreate(ObjBindMethod(implObj, "GetItemState"), flags, 4)
        this.vtbl.GetSelectedItems := CallbackCreate(ObjBindMethod(implObj, "GetSelectedItems"), flags, 2)
        this.vtbl.GetItemCustomState := CallbackCreate(ObjBindMethod(implObj, "GetItemCustomState"), flags, 3)
        this.vtbl.SetItemCustomState := CallbackCreate(ObjBindMethod(implObj, "SetItemCustomState"), flags, 3)
        this.vtbl.EnsureItemVisible := CallbackCreate(ObjBindMethod(implObj, "EnsureItemVisible"), flags, 2)
        this.vtbl.SetTheme := CallbackCreate(ObjBindMethod(implObj, "SetTheme"), flags, 2)
        this.vtbl.GetNextItem := CallbackCreate(ObjBindMethod(implObj, "GetNextItem"), flags, 4)
        this.vtbl.HitTest := CallbackCreate(ObjBindMethod(implObj, "HitTest"), flags, 3)
        this.vtbl.GetItemRect := CallbackCreate(ObjBindMethod(implObj, "GetItemRect"), flags, 3)
        this.vtbl.CollapseAll := CallbackCreate(ObjBindMethod(implObj, "CollapseAll"), flags, 1)
    }
