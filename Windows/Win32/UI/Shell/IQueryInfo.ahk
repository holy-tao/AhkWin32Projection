 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-iqueryinfo
...
class IQueryInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iqueryinfo-getinfotip
     */
    GetInfoTip(dwFlags) {
        result := ComCall(3, this, "uint", dwFlags, "ptr*", &ppwszTip := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iqueryinfo-getinfoflags
     */
    GetInfoFlags() {
