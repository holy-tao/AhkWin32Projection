 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-itransfersource
...
class ITransferSource extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-advise
     */
    Advise(psink) {
        result := ComCall(3, this, "ptr", psink, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-unadvise
     */
    Unadvise(dwCookie) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-setproperties
     */
    SetProperties(pproparray) {
        result := ComCall(5, this, "ptr", pproparray, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-openitem
     */
    OpenItem(psi, flags, riid) {
        result := ComCall(6, this, "ptr", psi, "uint", flags, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-moveitem
     */
    MoveItem(psi, psiParentDst, pszNameDst, flags) {
        pszNameDst := pszNameDst is String ? StrPtr(pszNameDst) : pszNameDst

        result := ComCall(7, this, "ptr", psi, "ptr", psiParentDst, "ptr", pszNameDst, "uint", flags, "ptr*", &ppsiNew := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-recycleitem
     */
    RecycleItem(psiSource, psiParentDest, flags) {
        result := ComCall(8, this, "ptr", psiSource, "ptr", psiParentDest, "uint", flags, "ptr*", &ppsiNewDest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-removeitem
     */
    RemoveItem(psiSource, flags) {
        result := ComCall(9, this, "ptr", psiSource, "uint", flags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-renameitem
     */
    RenameItem(psiSource, pszNewName, flags) {
        pszNewName := pszNewName is String ? StrPtr(pszNewName) : pszNewName

        result := ComCall(10, this, "ptr", psiSource, "ptr", pszNewName, "uint", flags, "ptr*", &ppsiNewDest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-linkitem
     */
    LinkItem(psiSource, psiParentDest, pszNewName, flags) {
        pszNewName := pszNewName is String ? StrPtr(pszNewName) : pszNewName

        result := ComCall(11, this, "ptr", psiSource, "ptr", psiParentDest, "ptr", pszNewName, "uint", flags, "ptr*", &ppsiNewDest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-applypropertiestoitem
     */
    ApplyPropertiesToItem(psiSource) {
        result := ComCall(12, this, "ptr", psiSource, "ptr*", &ppsiNew := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-getdefaultdestinationname
     */
    GetDefaultDestinationName(psiSource, psiParentDest) {
        result := ComCall(13, this, "ptr", psiSource, "ptr", psiParentDest, "ptr*", &ppszDestinationName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-enterfolder
     */
    EnterFolder(psiChildFolderDest) {
        result := ComCall(14, this, "ptr", psiChildFolderDest, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransfersource-leavefolder
     */
    LeaveFolder(psiChildFolderDest) {
        result := ComCall(15, this, "ptr", psiChildFolderDest, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
