 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nn-credentialprovider-icredentialproviderevents
...
class ICredentialProviderEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nf-credentialprovider-icredentialproviderevents-credentialschanged
     */
    CredentialsChanged(upAdviseContext) {
        result := ComCall(3, this, "ptr", upAdviseContext, "int")
        if(result != 0) {
