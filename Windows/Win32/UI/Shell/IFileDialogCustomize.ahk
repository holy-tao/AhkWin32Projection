...
export default struct IFileDialogCustomize extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.EnableOpenDropDown := CallbackCreate(ObjBindMethod(implObj, "EnableOpenDropDown"), flags, 2)
        this.vtbl.AddMenu := CallbackCreate(ObjBindMethod(implObj, "AddMenu"), flags, 3)
        this.vtbl.AddPushButton := CallbackCreate(ObjBindMethod(implObj, "AddPushButton"), flags, 3)
        this.vtbl.AddComboBox := CallbackCreate(ObjBindMethod(implObj, "AddComboBox"), flags, 2)
        this.vtbl.AddRadioButtonList := CallbackCreate(ObjBindMethod(implObj, "AddRadioButtonList"), flags, 2)
        this.vtbl.AddCheckButton := CallbackCreate(ObjBindMethod(implObj, "AddCheckButton"), flags, 4)
        this.vtbl.AddEditBox := CallbackCreate(ObjBindMethod(implObj, "AddEditBox"), flags, 3)
        this.vtbl.AddSeparator := CallbackCreate(ObjBindMethod(implObj, "AddSeparator"), flags, 2)
        this.vtbl.AddText := CallbackCreate(ObjBindMethod(implObj, "AddText"), flags, 3)
        this.vtbl.SetControlLabel := CallbackCreate(ObjBindMethod(implObj, "SetControlLabel"), flags, 3)
        this.vtbl.GetControlState := CallbackCreate(ObjBindMethod(implObj, "GetControlState"), flags, 3)
        this.vtbl.SetControlState := CallbackCreate(ObjBindMethod(implObj, "SetControlState"), flags, 3)
        this.vtbl.GetEditBoxText := CallbackCreate(ObjBindMethod(implObj, "GetEditBoxText"), flags, 3)
        this.vtbl.SetEditBoxText := CallbackCreate(ObjBindMethod(implObj, "SetEditBoxText"), flags, 3)
        this.vtbl.GetCheckButtonState := CallbackCreate(ObjBindMethod(implObj, "GetCheckButtonState"), flags, 3)
        this.vtbl.SetCheckButtonState := CallbackCreate(ObjBindMethod(implObj, "SetCheckButtonState"), flags, 3)
        this.vtbl.AddControlItem := CallbackCreate(ObjBindMethod(implObj, "AddControlItem"), flags, 4)
        this.vtbl.RemoveControlItem := CallbackCreate(ObjBindMethod(implObj, "RemoveControlItem"), flags, 3)
        this.vtbl.RemoveAllControlItems := CallbackCreate(ObjBindMethod(implObj, "RemoveAllControlItems"), flags, 2)
        this.vtbl.GetControlItemState := CallbackCreate(ObjBindMethod(implObj, "GetControlItemState"), flags, 4)
        this.vtbl.SetControlItemState := CallbackCreate(ObjBindMethod(implObj, "SetControlItemState"), flags, 4)
        this.vtbl.GetSelectedControlItem := CallbackCreate(ObjBindMethod(implObj, "GetSelectedControlItem"), flags, 3)
        this.vtbl.SetSelectedControlItem := CallbackCreate(ObjBindMethod(implObj, "SetSelectedControlItem"), flags, 3)
        this.vtbl.StartVisualGroup := CallbackCreate(ObjBindMethod(implObj, "StartVisualGroup"), flags, 3)
        this.vtbl.EndVisualGroup := CallbackCreate(ObjBindMethod(implObj, "EndVisualGroup"), flags, 1)
        this.vtbl.MakeProminent := CallbackCreate(ObjBindMethod(implObj, "MakeProminent"), flags, 2)
        this.vtbl.SetControlItemText := CallbackCreate(ObjBindMethod(implObj, "SetControlItemText"), flags, 4)
    }
