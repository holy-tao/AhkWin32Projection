...
class ISyncMgrHandler extends IUnknown{
    ...
    GetObject(rguidObjectID, riid, ppv) {
        result := ComCall(5, this, "ptr", rguidObjectID, "ptr", riid, "ptr*", ppv, "HRESULT")
        return result
    }
    ...
    GetCapabilities(pmCapabilities) {
        result := ComCall(6, this, "int*", pmCapabilities, "HRESULT")
        return result
    }
    ...
    GetPolicies(pmPolicies) {
        result := ComCall(7, this, "int*", pmPolicies, "HRESULT")
        return result
    }
