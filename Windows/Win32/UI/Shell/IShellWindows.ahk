...
class IShellWindows extends IDispatch{
     ...
     */
    Item(index, Folder) {
        result := ComCall(8, this, "ptr", index, "ptr", Folder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Register(pid, hwnd, swClass, plCookie) {
        result := ComCall(10, this, "ptr", pid, "int", hwnd, "int", swClass, "int*", plCookie, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RegisterPending(lThreadId, pvarloc, pvarlocRoot, swClass, plCookie) {
        result := ComCall(11, this, "int", lThreadId, "ptr", pvarloc, "ptr", pvarlocRoot, "int", swClass, "int*", plCookie, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FindWindowSW(pvarLoc, pvarLocRoot, swClass, phwnd, swfwOptions, ppdispOut) {
        result := ComCall(15, this, "ptr", pvarLoc, "ptr", pvarLocRoot, "int", swClass, "int*", phwnd, "int", swfwOptions, "ptr", ppdispOut, "int")
        if(result != 0)
            throw OSError(result)
