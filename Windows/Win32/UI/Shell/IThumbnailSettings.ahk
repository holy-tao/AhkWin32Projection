 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nn-thumbcache-ithumbnailsettings
...
class IThumbnailSettings extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nf-thumbcache-ithumbnailsettings-setcontext
     */
    SetContext(dwContext) {
        result := ComCall(3, this, "int", dwContext, "int")
        if(result != 0) {
