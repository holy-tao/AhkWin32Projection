 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nn-shldisp-idataobjectasynccapability
...
class IDataObjectAsyncCapability extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nf-shldisp-idataobjectasynccapability-setasyncmode
     */
    SetAsyncMode(fDoOpAsync) {
        result := ComCall(3, this, "int", fDoOpAsync, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nf-shldisp-idataobjectasynccapability-getasyncmode
     */
    GetAsyncMode() {
        result := ComCall(4, this, "int*", &pfIsOpAsync := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nf-shldisp-idataobjectasynccapability-startoperation
     */
    StartOperation(pbcReserved) {
        result := ComCall(5, this, "ptr", pbcReserved, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nf-shldisp-idataobjectasynccapability-inoperation
     */
    InOperation() {
        result := ComCall(6, this, "int*", &pfInAsyncOp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shldisp/nf-shldisp-idataobjectasynccapability-endoperation
     */
    EndOperation(hResult_, pbcReserved, dwEffects) {
        result := ComCall(7, this, "int", hResult_, "ptr", pbcReserved, "uint", dwEffects, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
