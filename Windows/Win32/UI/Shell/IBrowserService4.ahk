 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nn-shdeprecated-ibrowserservice4
...
class IBrowserService4 extends IBrowserService3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice4-activateview
     */
    ActivateView(fPendingView) {
        result := ComCall(97, this, "int", fPendingView, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice4-saveviewstate
     */
    SaveViewState() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ibrowserservice4-_resizeallborders
     */
    _ResizeAllBorders() {
