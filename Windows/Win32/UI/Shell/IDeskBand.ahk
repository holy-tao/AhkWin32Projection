 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ideskband
...
class IDeskBand extends IDockingWindow{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ideskband-getbandinfo
     */
    GetBandInfo(dwBandID, dwViewMode, pdbi) {
        result := ComCall(8, this, "uint", dwBandID, "uint", dwViewMode, "ptr", pdbi, "int")
        if(result != 0) {
