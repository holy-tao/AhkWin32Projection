 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nn-credentialprovider-iquerycontinuewithstatus
...
class IQueryContinueWithStatus extends IQueryContinue{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nf-credentialprovider-iquerycontinuewithstatus-setstatusmessage
     */
    SetStatusMessage(psz) {
        psz := psz is String ? StrPtr(psz) : psz

        result := ComCall(4, this, "ptr", psz, "int")
        if(result != 0) {
