...
class IThumbnailCache extends IUnknown{
    ...
    GetThumbnail(pShellItem, cxyRequestedThumbSize, flags, ppvThumb, pOutFlags, pThumbnailID) {
        result := ComCall(3, this, "ptr", pShellItem, "uint", cxyRequestedThumbSize, "int", flags, "ptr", ppvThumb, "int*", pOutFlags, "ptr", pThumbnailID, "int")
        if(result != 0)
    ...
    GetThumbnailByID(thumbnailID, cxyRequestedThumbSize, ppvThumb, pOutFlags) {
        result := ComCall(4, this, "ptr", thumbnailID, "uint", cxyRequestedThumbSize, "ptr", ppvThumb, "int*", pOutFlags, "int")
        if(result != 0)
            throw OSError(result)
