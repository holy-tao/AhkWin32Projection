...
class IThumbnailCache extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nf-thumbcache-ithumbnailcache-getthumbnail
     */
    GetThumbnail(pShellItem, cxyRequestedThumbSize, flags, ppvThumb, pOutFlags, pThumbnailID) {
        ...
        result := ComCall(3, this, "ptr", pShellItem, "uint", cxyRequestedThumbSize, "int", flags, "ptr*", ppvThumb, pOutFlagsMarshal, pOutFlags, "ptr", pThumbnailID, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nf-thumbcache-ithumbnailcache-getthumbnailbyid
     */
    GetThumbnailByID(thumbnailID, cxyRequestedThumbSize, ppvThumb, pOutFlags) {
        pOutFlagsMarshal := pOutFlags is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", thumbnailID, "uint", cxyRequestedThumbSize, "ptr*", ppvThumb, pOutFlagsMarshal, pOutFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
