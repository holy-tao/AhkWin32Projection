 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgrsyncitem
...
class ISyncMgrSyncItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getitemid
     */
    GetItemID() {
        result := ComCall(3, this, "ptr*", &ppszItemID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getname
     */
    GetName() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getiteminfo
     */
    GetItemInfo() {
        result := ComCall(5, this, "ptr*", &ppItemInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getobject
     */
    GetObject(rguidObjectID, riid) {
        result := ComCall(6, this, "ptr", rguidObjectID, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getcapabilities
     */
    GetCapabilities() {
        result := ComCall(7, this, "int*", &pmCapabilities := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-getpolicies
     */
    GetPolicies() {
        result := ComCall(8, this, "int*", &pmPolicies := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-enable
     */
    Enable(fEnable) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsyncitem-delete
     */
    Delete() {
