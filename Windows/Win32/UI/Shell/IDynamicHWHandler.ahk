 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-idynamichwhandler
...
class IDynamicHWHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-idynamichwhandler-getdynamicinfo
     */
    GetDynamicInfo(pszDeviceID, dwContentType) {
        pszDeviceID := pszDeviceID is String ? StrPtr(pszDeviceID) : pszDeviceID

        result := ComCall(3, this, "ptr", pszDeviceID, "uint", dwContentType, "ptr*", &ppszAction := 0, "int")
        if(result != 0) {
