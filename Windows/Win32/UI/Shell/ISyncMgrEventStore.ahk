 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgreventstore
...
class ISyncMgrEventStore extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgreventstore-geteventenumerator
     */
    GetEventEnumerator() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgreventstore-geteventcount
     */
    GetEventCount() {
        result := ComCall(4, this, "uint*", &pcEvents := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgreventstore-getevent
     */
    GetEvent(rguidEventID) {
        result := ComCall(5, this, "ptr", rguidEventID, "ptr*", &ppEvent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgreventstore-removeevent
     */
