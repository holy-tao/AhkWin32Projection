 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nn-shlobj-inewshortcuthookw
...
class INewShortcutHookW extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-setreferent
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-getreferent
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-setfolder
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-getfolder
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-getname
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj/nf-shlobj-inewshortcuthookw-getextension
     */
