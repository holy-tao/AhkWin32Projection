 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iremotecomputer
...
class IRemoteComputer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iremotecomputer-initialize
     */
    Initialize(pszMachine, bEnumerating) {
        pszMachine := pszMachine is String ? StrPtr(pszMachine) : pszMachine

        result := ComCall(3, this, "ptr", pszMachine, "int", bEnumerating, "int")
        if(result != 0) {
