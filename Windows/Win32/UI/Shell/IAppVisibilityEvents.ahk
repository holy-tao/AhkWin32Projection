 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iappvisibilityevents
...
class IAppVisibilityEvents extends IUnknown{
     ...
     * @param {HMONITOR} hMonitor_ The display that has a changing mode.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibilityevents-appvisibilityonmonitorchanged
     */
    AppVisibilityOnMonitorChanged(hMonitor_, previousMode, currentMode) {
        hMonitor_ := hMonitor_ is Win32Handle ? NumGet(hMonitor_, "ptr") : hMonitor_

        result := ComCall(3, this, "ptr", hMonitor_, "int", previousMode, "int", currentMode, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} The return value is ignored.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iappvisibilityevents-launchervisibilitychange
     */
