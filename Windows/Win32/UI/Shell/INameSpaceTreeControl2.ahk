...
class INameSpaceTreeControl2 extends INameSpaceTreeControl{
     ...
     * 
     * @param {Integer} nstcsMask 
     * @param {Pointer<UInt32>} pnstcsStyle 
     * @returns {HRESULT} 
     */
    GetControlStyle(nstcsMask, pnstcsStyle) {
        result := ComCall(23, this, "uint", nstcsMask, "uint*", pnstcsStyle, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Integer} nstcsMask 
     * @param {Pointer<Int32>} pnstcsStyle 
     * @returns {HRESULT} 
     */
    GetControlStyle2(nstcsMask, pnstcsStyle) {
        result := ComCall(25, this, "int", nstcsMask, "int*", pnstcsStyle, "int")
        if(result != 0)
            throw OSError(result)
