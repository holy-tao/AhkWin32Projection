 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iapplicationdocumentlists
...
class IApplicationDocumentLists extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iapplicationdocumentlists-setappid
     */
    SetAppID(pszAppID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iapplicationdocumentlists-getlist
     */
    GetList(listtype, cItemsDesired, riid) {
        result := ComCall(4, this, "int", listtype, "uint", cItemsDesired, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
