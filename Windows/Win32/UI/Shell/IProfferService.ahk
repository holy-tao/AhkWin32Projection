 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iprofferservice
...
class IProfferService extends IUnknown{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iprofferservice-profferservice
     */
    ProfferService(serviceId, serviceProvider) {
        result := ComCall(3, this, "ptr", serviceId, "ptr", serviceProvider, "uint*", &cookie := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iprofferservice-revokeservice
     */
