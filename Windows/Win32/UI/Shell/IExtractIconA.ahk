 ...
 * @see https://learn.microsoft.com/windows/win32/api/shlobj_core/nn-shlobj_core-iextracticona
 * @namespace Windows.Win32.UI.Shell
 * @charset ANSI
 */
export default struct IExtractIconA extends IUnknown {
    /**
     ...
     * used for IExtractIconA interfaces
    */
    ...
    Query(iid) {
        if (IExtractIconA.IID.Equals(iid)) {
            return true
        }
