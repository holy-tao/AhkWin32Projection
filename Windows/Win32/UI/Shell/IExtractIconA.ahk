 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//shlobj_core/nn-shlobj_core-iextracticona
...
class IExtractIconA extends IUnknown{
     ...
     * @param {PSTR} pszIconFile 
     * @param {Integer} cchMax 
     * @param {Pointer<Int32>} piIndex 
     * @param {Pointer<UInt32>} pwFlags 
     * @returns {HRESULT} 
     */
    GetIconLocation(uFlags, pszIconFile, cchMax, piIndex, pwFlags) {
        result := ComCall(3, this, "uint", uFlags, "ptr", pszIconFile, "uint", cchMax, "int*", piIndex, "uint*", pwFlags, "int")
        if(result != 0)
