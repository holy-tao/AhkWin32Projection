 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-iextracticona
 * @namespace Windows.Win32.UI.Shell
 * @version v4.0.30319
 * @charset ANSI
 */
class IExtractIconA extends IUnknown{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IExtractIconA
     * @type {Guid}
     */
    static IID => Guid("{000214eb-0000-0000-c000-000000000046}")
     ...
     * @param {PSTR} pszIconFile Type: <b>PTSTR</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iextracticona-geticonlocation
     */
    GetIconLocation(uFlags, pszIconFile, cchMax, piIndex, pwFlags) {
        ...
        result := ComCall(3, this, "uint", uFlags, "ptr", pszIconFile, "uint", cchMax, piIndexMarshal, piIndex, pwFlagsMarshal, pwFlags, "int")
        if(result != 0) {
     ...
     * @param {PSTR} pszFile Type: <b>PCTSTR</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iextracticona-extract
     */
    Extract(pszFile, nIconIndex, phiconLarge, phiconSmall, nIconSize) {
        pszFile := pszFile is String ? StrPtr(pszFile) : pszFile

        result := ComCall(4, this, "ptr", pszFile, "uint", nIconIndex, "ptr", phiconLarge, "ptr", phiconSmall, "uint", nIconSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
