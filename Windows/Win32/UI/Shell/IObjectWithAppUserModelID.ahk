 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iobjectwithappusermodelid
...
class IObjectWithAppUserModelID extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithappusermodelid-setappid
     */
    SetAppID(pszAppID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithappusermodelid-getappid
     */
    GetAppID() {
        result := ComCall(4, this, "ptr*", &ppszAppID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
