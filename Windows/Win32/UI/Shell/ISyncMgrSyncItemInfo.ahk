 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgrsynciteminfo
...
class ISyncMgrSyncItemInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsynciteminfo-gettypelabel
     */
    GetTypeLabel() {
        result := ComCall(3, this, "ptr*", &ppszTypeLabel := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsynciteminfo-getcomment
     */
    GetComment() {
        result := ComCall(4, this, "ptr*", &ppszComment := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsynciteminfo-getlastsynctime
     */
    GetLastSyncTime() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsynciteminfo-isenabled
     */
    IsEnabled() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrsynciteminfo-isconnected
     */
    IsConnected() {
