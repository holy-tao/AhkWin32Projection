 ...
 * @charset ANSI
 */
export default struct IShellLinkA extends IUnknown {
    /**
     ...
     * used for IShellLinkA interfaces
    */
    ...
    GetPath(pszFile, cch, pfd, fFlags) {
        ...
        result := ComCall(3, this, "ptr", pszFile, Int32, cch, WIN32_FIND_DATAA.Ptr, pfd, UInt32, fFlags, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetPath := CallbackCreate(ObjBindMethod(implObj, "GetPath"), flags, 5)
        ...
        this.vtbl.GetWorkingDirectory := CallbackCreate(ObjBindMethod(implObj, "GetWorkingDirectory"), flags, 3)
        this.vtbl.SetWorkingDirectory := CallbackCreate(ObjBindMethod(implObj, "SetWorkingDirectory"), flags, 2)
        this.vtbl.GetArguments := CallbackCreate(ObjBindMethod(implObj, "GetArguments"), flags, 3)
        this.vtbl.SetArguments := CallbackCreate(ObjBindMethod(implObj, "SetArguments"), flags, 2)
        this.vtbl.GetHotkey := CallbackCreate(ObjBindMethod(implObj, "GetHotkey"), flags, 2)
        this.vtbl.SetHotkey := CallbackCreate(ObjBindMethod(implObj, "SetHotkey"), flags, 2)
        this.vtbl.GetShowCmd := CallbackCreate(ObjBindMethod(implObj, "GetShowCmd"), flags, 2)
        this.vtbl.SetShowCmd := CallbackCreate(ObjBindMethod(implObj, "SetShowCmd"), flags, 2)
        this.vtbl.GetIconLocation := CallbackCreate(ObjBindMethod(implObj, "GetIconLocation"), flags, 4)
        this.vtbl.SetIconLocation := CallbackCreate(ObjBindMethod(implObj, "SetIconLocation"), flags, 3)
        this.vtbl.SetRelativePath := CallbackCreate(ObjBindMethod(implObj, "SetRelativePath"), flags, 3)
