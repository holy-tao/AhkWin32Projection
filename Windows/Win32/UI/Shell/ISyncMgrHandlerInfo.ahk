 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgrhandlerinfo
...
class ISyncMgrHandlerInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-gettype
     */
    GetType() {
        result := ComCall(3, this, "int*", &pnType := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-gettypelabel
     */
    GetTypeLabel() {
        result := ComCall(4, this, "ptr*", &ppszTypeLabel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-getcomment
     */
    GetComment() {
        result := ComCall(5, this, "ptr*", &ppszComment := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-getlastsynctime
     */
    GetLastSyncTime() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-isactive
     */
    IsActive() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-isenabled
     */
    IsEnabled() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrhandlerinfo-isconnected
     */
    IsConnected() {
