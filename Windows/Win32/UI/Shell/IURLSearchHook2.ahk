 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-iurlsearchhook2
...
class IURLSearchHook2 extends IURLSearchHook{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iurlsearchhook2-translatewithsearchcontext
     */
    TranslateWithSearchContext(pwszSearchURL, cchBufferSize, pSearchContext) {
        ...
        result := ComCall(4, this, "ptr", pwszSearchURL, "uint", cchBufferSize, "ptr", pSearchContext, "int")
        if(result != 0) {
