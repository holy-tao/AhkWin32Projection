 ...
 */
export default struct IURLSearchHook2 extends IURLSearchHook {
    /**
     ...
     * used for IURLSearchHook2 interfaces
    */
    struct Vtbl extends IURLSearchHook.Vtbl {
        TranslateWithSearchContext : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IURLSearchHook2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.TranslateWithSearchContext)
    }
}
