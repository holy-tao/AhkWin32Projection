 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iobjectprovider
...
class IObjectProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectprovider-queryobject
     */
    QueryObject(guidObject, riid) {
        result := ComCall(3, this, "ptr", guidObject, "ptr", riid, "ptr*", &ppvOut := 0, "int")
        if(result != 0) {
