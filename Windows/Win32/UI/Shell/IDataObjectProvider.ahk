 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-idataobjectprovider
...
class IDataObjectProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idataobjectprovider-getdataobject
     */
    GetDataObject() {
        result := ComCall(3, this, "ptr*", &dataObject := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idataobjectprovider-setdataobject
     */
