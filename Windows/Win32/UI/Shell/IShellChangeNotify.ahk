 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-ishellchangenotify
...
class IShellChangeNotify extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-ishellchangenotify-onchange
     */
    OnChange(lEvent, pidl1, pidl2) {
        result := ComCall(3, this, "int", lEvent, "ptr", pidl1, "ptr", pidl2, "int")
        if(result != 0) {
