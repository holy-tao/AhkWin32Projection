 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ivirtualdesktopmanager
...
class IVirtualDesktopManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ivirtualdesktopmanager-iswindowoncurrentvirtualdesktop
     */
    IsWindowOnCurrentVirtualDesktop(topLevelWindow) {
        ...
        result := ComCall(3, this, "ptr", topLevelWindow, "int*", &onCurrentDesktop := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ivirtualdesktopmanager-getwindowdesktopid
     */
    GetWindowDesktopId(topLevelWindow) {
        topLevelWindow := topLevelWindow is Win32Handle ? NumGet(topLevelWindow, "ptr") : topLevelWindow

        desktopId := Guid()
        result := ComCall(4, this, "ptr", topLevelWindow, "ptr", desktopId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ivirtualdesktopmanager-movewindowtodesktop
     */
    MoveWindowToDesktop(topLevelWindow, desktopId) {
        topLevelWindow := topLevelWindow is Win32Handle ? NumGet(topLevelWindow, "ptr") : topLevelWindow

        result := ComCall(5, this, "ptr", topLevelWindow, "ptr", desktopId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
