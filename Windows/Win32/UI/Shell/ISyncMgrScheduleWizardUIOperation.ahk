 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgrschedulewizarduioperation
...
class ISyncMgrScheduleWizardUIOperation extends ISyncMgrUIOperation{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgrschedulewizarduioperation-initwizard
     */
    InitWizard(pszHandlerID) {
        pszHandlerID := pszHandlerID is String ? StrPtr(pszHandlerID) : pszHandlerID

        result := ComCall(4, this, "ptr", pszHandlerID, "int")
        if(result != 0) {
