 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iobjectwithselection
...
class IObjectWithSelection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithselection-setselection
     */
    SetSelection(psia) {
        result := ComCall(3, this, "ptr", psia, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithselection-getselection
     */
    GetSelection(riid) {
