 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ishellpropsheetext
...
class IShellPropSheetExt extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellpropsheetext-addpages
     */
    AddPages(pfnAddPage, lParam_) {
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(3, this, "ptr", pfnAddPage, "ptr", lParam_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishellpropsheetext-replacepage
     */
    ReplacePage(uPageID, pfnReplaceWith, lParam_) {
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(4, this, "uint", uPageID, "ptr", pfnReplaceWith, "ptr", lParam_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
