 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ibrowserframeoptions
...
class IBrowserFrameOptions extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ibrowserframeoptions-getframeoptions
     */
    GetFrameOptions(dwMask) {
        result := ComCall(3, this, "uint", dwMask, "uint*", &pdwOptions := 0, "int")
        if(result != 0) {
