 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-ifolderviewhost
...
class IFolderViewHost extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-ifolderviewhost-initialize
     */
    Initialize(hwndParent, pdo, prc) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(3, this, "ptr", hwndParent, "ptr", pdo, "ptr", prc, "int")
        if(result != 0) {
