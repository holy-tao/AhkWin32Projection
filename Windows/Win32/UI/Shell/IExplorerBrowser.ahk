...
class IExplorerBrowser extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IExplorerBrowserEvents>} psbe 
     * @param {Pointer<UInt32>} pdwCookie 
     * @returns {HRESULT} 
     */
    Advise(psbe, pdwCookie) {
        result := ComCall(9, this, "ptr", psbe, "uint*", pdwCookie, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Int32>} pdwFlag 
     * @returns {HRESULT} 
     */
    GetOptions(pdwFlag) {
        result := ComCall(12, this, "int*", pdwFlag, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCurrentView(riid, ppv) {
        result := ComCall(17, this, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
