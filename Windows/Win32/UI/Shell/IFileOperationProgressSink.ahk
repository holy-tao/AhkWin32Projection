...
export default struct IFileOperationProgressSink extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.StartOperations := CallbackCreate(ObjBindMethod(implObj, "StartOperations"), flags, 1)
        this.vtbl.FinishOperations := CallbackCreate(ObjBindMethod(implObj, "FinishOperations"), flags, 2)
        this.vtbl.PreRenameItem := CallbackCreate(ObjBindMethod(implObj, "PreRenameItem"), flags, 4)
        this.vtbl.PostRenameItem := CallbackCreate(ObjBindMethod(implObj, "PostRenameItem"), flags, 6)
        this.vtbl.PreMoveItem := CallbackCreate(ObjBindMethod(implObj, "PreMoveItem"), flags, 5)
        this.vtbl.PostMoveItem := CallbackCreate(ObjBindMethod(implObj, "PostMoveItem"), flags, 7)
        this.vtbl.PreCopyItem := CallbackCreate(ObjBindMethod(implObj, "PreCopyItem"), flags, 5)
        this.vtbl.PostCopyItem := CallbackCreate(ObjBindMethod(implObj, "PostCopyItem"), flags, 7)
        this.vtbl.PreDeleteItem := CallbackCreate(ObjBindMethod(implObj, "PreDeleteItem"), flags, 3)
        this.vtbl.PostDeleteItem := CallbackCreate(ObjBindMethod(implObj, "PostDeleteItem"), flags, 5)
        this.vtbl.PreNewItem := CallbackCreate(ObjBindMethod(implObj, "PreNewItem"), flags, 4)
        this.vtbl.PostNewItem := CallbackCreate(ObjBindMethod(implObj, "PostNewItem"), flags, 8)
