 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-ishelldetails
...
class IShellDetails extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-ishelldetails-getdetailsof
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-ishelldetails-columnclick
     */
    ColumnClick(iColumn) {
