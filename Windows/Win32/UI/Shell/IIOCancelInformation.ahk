 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iiocancelinformation
...
class IIOCancelInformation extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iiocancelinformation-setcancelinformation
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iiocancelinformation-getcancelinformation
     */
    GetCancelInformation(pdwThreadID, puMsgCancel) {
        ...
        result := ComCall(4, this, pdwThreadIDMarshal, pdwThreadID, puMsgCancelMarshal, puMsgCancel, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
