 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-idockingwindowsite
...
class IDockingWindowSite extends IOleWindow{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-idockingwindowsite-getborderdw
     */
    GetBorderDW(punkObj) {
        prcBorder := RECT()
        result := ComCall(5, this, "ptr", punkObj, "ptr", prcBorder, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-idockingwindowsite-requestborderspacedw
     */
    RequestBorderSpaceDW(punkObj, pbw) {
        result := ComCall(6, this, "ptr", punkObj, "ptr", pbw, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-idockingwindowsite-setborderspacedw
     */
    SetBorderSpaceDW(punkObj, pbw) {
        result := ComCall(7, this, "ptr", punkObj, "ptr", pbw, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
