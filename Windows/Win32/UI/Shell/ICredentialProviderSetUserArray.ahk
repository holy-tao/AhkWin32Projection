 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nn-credentialprovider-icredentialprovidersetuserarray
...
class ICredentialProviderSetUserArray extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/credentialprovider/nf-credentialprovider-icredentialprovidersetuserarray-setuserarray
     */
    SetUserArray(users) {
        result := ComCall(3, this, "ptr", users, "int")
        if(result != 0) {
