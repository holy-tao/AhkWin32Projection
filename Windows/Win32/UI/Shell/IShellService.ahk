 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nn-shdeprecated-ishellservice
...
class IShellService extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shdeprecated/nf-shdeprecated-ishellservice-setowner
     */
    SetOwner(punkOwner) {
