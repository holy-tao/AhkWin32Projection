 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iobjectwithfolderenummode
...
class IObjectWithFolderEnumMode extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithfolderenummode-setmode
     */
    SetMode(feMode) {
        result := ComCall(3, this, "int", feMode, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iobjectwithfolderenummode-getmode
     */
    GetMode() {
        result := ComCall(4, this, "int*", &pfeMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
