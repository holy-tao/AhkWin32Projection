 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-itaskbarlist4
...
class ITaskbarList4 extends ITaskbarList3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itaskbarlist4-settabproperties
     */
    SetTabProperties(hwndTab, stpFlags) {
        hwndTab := hwndTab is Win32Handle ? NumGet(hwndTab, "ptr") : hwndTab

        result := ComCall(21, this, "ptr", hwndTab, "int", stpFlags, "int")
        if(result != 0) {
