 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-icommdlgbrowser2
...
class ICommDlgBrowser2 extends ICommDlgBrowser{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icommdlgbrowser2-notify
     */
    Notify(ppshv, dwNotifyType) {
        result := ComCall(6, this, "ptr", ppshv, "uint", dwNotifyType, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icommdlgbrowser2-getdefaultmenutext
     */
    GetDefaultMenuText(ppshv, pszText, cchMax) {
        pszText := pszText is String ? StrPtr(pszText) : pszText

        result := ComCall(7, this, "ptr", ppshv, "ptr", pszText, "int", cchMax, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icommdlgbrowser2-getviewflags
     */
    GetViewFlags() {
        result := ComCall(8, this, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
