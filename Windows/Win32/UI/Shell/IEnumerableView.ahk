 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-ienumerableview
...
class IEnumerableView extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-ienumerableview-setenumreadycallback
     */
    SetEnumReadyCallback(percb) {
        result := ComCall(3, this, "ptr", percb, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-ienumerableview-createenumidlistfromcontents
     */
    CreateEnumIDListFromContents(pidlFolder, dwEnumFlags) {
        result := ComCall(4, this, "ptr", pidlFolder, "uint", dwEnumFlags, "ptr*", &ppEnumIDList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
