...
class ISyncMgrSyncCallback extends IUnknown{
     ...
     * @param {Pointer<Int32>} pnCancelRequest 
     * @returns {HRESULT} 
     */
    ReportProgress(pszItemID, pszProgressText, nStatus, uCurrentStep, uMaxStep, pnCancelRequest) {
        ...
        result := ComCall(3, this, "ptr", pszItemID, "ptr", pszProgressText, "int", nStatus, "uint", uCurrentStep, "uint", uMaxStep, "int*", pnCancelRequest, "int")
        if(result != 0)
    ...
    SetHandlerProgressText(pszProgressText, pnCancelRequest) {
        ...
        result := ComCall(4, this, "ptr", pszProgressText, "int*", pnCancelRequest, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ISyncMgrSyncItem>} pNewItem 
     * @returns {HRESULT} 
     */
