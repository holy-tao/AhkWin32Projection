 ...
 * @see https://learn.microsoft.com/windows/win32/api/shlobj/nn-shlobj-icopyhookw
 * @namespace Windows.Win32.UI.Shell
 * @charset Unicode
 */
export default struct ICopyHookW extends IUnknown {
    /**
     * The interface identifier for ICopyHookW
     * @type {Guid}
     */
    static IID := Guid("{000214fc-0000-0000-c000-000000000046}")
     ...
     * used for ICopyHookW interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ICopyHookW.Vtbl()
        }
        super.__New(implObj, flags)
    }

    /**
     * Determines whether the Shell will be allowed to move, copy, delete, or rename a folder or printer object. (Unicode)
     * @remarks
     ...
     * @param {PWSTR} pszSrcFile A pointer to a string that contains the name of the source folder.
     ...
     * @param {PWSTR} pszDestFile A pointer to a string that contains the name of the destination folder.
     ...
     * @see https://learn.microsoft.com/windows/win32/api/shlobj/nf-shlobj-icopyhookw-copycallback
     */
