 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iinitializewithitem
...
class IInitializeWithItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iinitializewithitem-initialize
     */
    Initialize(psi, grfMode) {
        result := ComCall(3, this, "ptr", psi, "uint", grfMode, "int")
        if(result != 0) {
