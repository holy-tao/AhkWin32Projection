 ...
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ifolderfilter
...
class IFolderFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifolderfilter-shouldshow
     */
    ShouldShow(psf, pidlFolder, pidlItem) {
        result := ComCall(3, this, "ptr", psf, "ptr", pidlFolder, "ptr", pidlItem, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ifolderfilter-getenumflags
     */
    GetEnumFlags(psf, pidlFolder, pgrfFlags) {
        pgrfFlagsMarshal := pgrfFlags is VarRef ? "uint*" : "ptr"

        phwnd := HWND()
        result := ComCall(4, this, "ptr", psf, "ptr", pidlFolder, "ptr", phwnd, pgrfFlagsMarshal, pgrfFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
