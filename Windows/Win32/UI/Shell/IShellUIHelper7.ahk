...
class IShellUIHelper7 extends IShellUIHelper6{
    ...
    GetExperimentalFlag(bstrFlagString, vfFlag) {
        ...
        result := ComCall(89, this, "ptr", bstrFlagString, "ptr", vfFlag, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetExperimentalValue(bstrValueString, pdwValue) {
        ...
        result := ComCall(91, this, "ptr", bstrValueString, "uint*", pdwValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNeedIEAutoLaunchFlag(bstrUrl, flag) {
        ...
        result := ComCall(93, this, "ptr", bstrUrl, "ptr", flag, "int")
        if(result != 0)
            throw OSError(result)
    ...
    HasNeedIEAutoLaunchFlag(bstrUrl, exists) {
        ...
        result := ComCall(95, this, "ptr", bstrUrl, "ptr", exists, "int")
        if(result != 0)
            throw OSError(result)
