 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shimgdata/nn-shimgdata-ishellimagedatafactory
...
class IShellImageDataFactory extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shimgdata/nf-shimgdata-ishellimagedatafactory-createishellimagedata
     */
    CreateIShellImageData() {
        result := ComCall(3, this, "ptr*", &ppshimg := 0, "int")
        if(result != 0) {
     ...
     * 
     * The address of a pointer to an instance of <a href="https://docs.microsoft.com/windows/desktop/api/shimgdata/nn-shimgdata-ishellimagedata">IShellImageData</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/shimgdata/nf-shimgdata-ishellimagedatafactory-createimagefromfile
     */
    CreateImageFromFile(pszPath) {
        pszPath := pszPath is String ? StrPtr(pszPath) : pszPath

        result := ComCall(4, this, "ptr", pszPath, "ptr*", &ppshimg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The address of a pointer to an instance of <a href="https://docs.microsoft.com/windows/desktop/api/shimgdata/nn-shimgdata-ishellimagedata">IShellImageData</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/shimgdata/nf-shimgdata-ishellimagedatafactory-createimagefromstream
     */
    CreateImageFromStream(pStream) {
        result := ComCall(5, this, "ptr", pStream, "ptr*", &ppshimg := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shimgdata/nf-shimgdata-ishellimagedatafactory-getdataformatfrompath
     */
