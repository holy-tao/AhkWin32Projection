 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-idestinationstreamfactory
...
class IDestinationStreamFactory extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-idestinationstreamfactory-getdestinationstream
     */
    GetDestinationStream() {
        result := ComCall(3, this, "ptr*", &ppstm := 0, "int")
        if(result != 0) {
