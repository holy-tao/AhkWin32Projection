 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nn-shappmgr-ienumpublishedapps
...
class IEnumPublishedApps extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ienumpublishedapps-next
     */
    Next() {
        result := ComCall(3, this, "ptr*", &pia := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ienumpublishedapps-reset
     */
    Reset() {
