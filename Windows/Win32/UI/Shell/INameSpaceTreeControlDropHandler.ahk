...
class INameSpaceTreeControlDropHandler extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<IShellItem>} psiOver 
     * @param {Pointer<IShellItemArray>} psiaData 
    ...
    OnDragEnter(psiOver, psiaData, fOutsideSource, grfKeyState, pdwEffect) {
        result := ComCall(3, this, "ptr", psiOver, "ptr", psiaData, "int", fOutsideSource, "uint", grfKeyState, "uint*", pdwEffect, "int")
        if(result != 0)
    ...
    OnDragOver(psiOver, psiaData, grfKeyState, pdwEffect) {
        result := ComCall(4, this, "ptr", psiOver, "ptr", psiaData, "uint", grfKeyState, "uint*", pdwEffect, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnDrop(psiOver, psiaData, iPosition, grfKeyState, pdwEffect) {
        result := ComCall(6, this, "ptr", psiOver, "ptr", psiaData, "int", iPosition, "uint", grfKeyState, "uint*", pdwEffect, "int")
        if(result != 0)
            throw OSError(result)
