 ...
 * @charset ANSI
 */
export default struct INewShortcutHookA extends IUnknown {
    /**
     ...
     * used for INewShortcutHookA interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := INewShortcutHookA.Vtbl()
        }
    ...
    Query(iid) {
        if (INewShortcutHookA.IID.Equals(iid)) {
            return true
        }
