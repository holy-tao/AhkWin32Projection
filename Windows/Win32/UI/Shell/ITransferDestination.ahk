 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-itransferdestination
...
class ITransferDestination extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransferdestination-advise
     */
    Advise(psink) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransferdestination-unadvise
     */
    Unadvise(dwCookie) {
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-itransferdestination-createitem
     */
    CreateItem(pszName, dwAttributes, ullSize, flags, riidItem, ppvItem, riidResources, ppvResources) {
        ...
        result := ComCall(5, this, "ptr", pszName, "uint", dwAttributes, "uint", ullSize, "uint", flags, "ptr", riidItem, ppvItemMarshal, ppvItem, "ptr", riidResources, ppvResourcesMarshal, ppvResources, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
