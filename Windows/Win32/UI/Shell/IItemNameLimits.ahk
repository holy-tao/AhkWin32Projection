 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iitemnamelimits
...
class IItemNameLimits extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iitemnamelimits-getvalidcharacters
     */
    GetValidCharacters(ppwszValidChars, ppwszInvalidChars) {
        ...
        result := ComCall(3, this, ppwszValidCharsMarshal, ppwszValidChars, ppwszInvalidCharsMarshal, ppwszInvalidChars, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iitemnamelimits-getmaxlength
     */
    GetMaxLength(pszName) {
        pszName := pszName is String ? StrPtr(pszName) : pszName

        result := ComCall(4, this, "ptr", pszName, "int*", &piMaxNameLen := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
