 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ishelllinkdatalist
...
class IShellLinkDataList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishelllinkdatalist-adddatablock
     */
    AddDataBlock(pDataBlock) {
        pDataBlockMarshal := pDataBlock is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, pDataBlockMarshal, pDataBlock, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishelllinkdatalist-copydatablock
     */
    CopyDataBlock(dwSig) {
        result := ComCall(4, this, "uint", dwSig, "ptr*", &ppDataBlock := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns S_OK if successful, or a COM error code otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishelllinkdatalist-removedatablock
     */
    RemoveDataBlock(dwSig) {
        result := ComCall(5, this, "uint", dwSig, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishelllinkdatalist-getflags
     */
    GetFlags() {
        result := ComCall(6, this, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ishelllinkdatalist-setflags
     */
    SetFlags(dwFlags) {
