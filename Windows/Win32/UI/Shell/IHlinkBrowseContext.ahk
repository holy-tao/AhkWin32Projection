...
class IHlinkBrowseContext extends IUnknown{
     ...
     * @param {Pointer<IMoniker>} pimk 
     * @param {Pointer<UInt32>} pdwRegister 
     * @returns {HRESULT} 
     */
    Register(reserved, piunk, pimk, pdwRegister) {
        result := ComCall(3, this, "uint", reserved, "ptr", piunk, "ptr", pimk, "uint*", pdwRegister, "int")
        if(result != 0)
    ...
    GetObject(pimk, fBindIfRootRegistered, ppiunk) {
        result := ComCall(4, this, "ptr", pimk, "int", fBindIfRootRegistered, "ptr", ppiunk, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnNavigateHlink(grfHLNF, pimkTarget, pwzLocation, pwzFriendlyName, puHLID) {
        ...
        result := ComCall(9, this, "uint", grfHLNF, "ptr", pimkTarget, "ptr", pwzLocation, "ptr", pwzFriendlyName, "uint*", puHLID, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumNavigationStack(dwReserved, grfHLFNAMEF, ppienumhlitem) {
        result := ComCall(11, this, "uint", dwReserved, "uint", grfHLFNAMEF, "ptr", ppienumhlitem, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetHlink(uHLID, ppihl) {
        result := ComCall(13, this, "uint", uHLID, "ptr", ppihl, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Clone(piunkOuter, riid, ppiunkObj) {
        result := ComCall(15, this, "ptr", piunkOuter, "ptr", riid, "ptr", ppiunkObj, "int")
        if(result != 0)
            throw OSError(result)
