 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-inewwindowmanager
...
class INewWindowManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-inewwindowmanager-evaluatenewwindow
     */
    EvaluateNewWindow(pszUrl, pszName, pszUrlContext, pszFeatures, fReplace, dwFlags, dwUserActionTime) {
        ...
        result := ComCall(3, this, "ptr", pszUrl, "ptr", pszName, "ptr", pszUrlContext, "ptr", pszFeatures, "int", fReplace, "uint", dwFlags, "uint", dwUserActionTime, "int")
        if(result != 0) {
