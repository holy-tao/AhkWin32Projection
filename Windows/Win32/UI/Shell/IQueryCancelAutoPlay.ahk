 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nn-shobjidl-iquerycancelautoplay
...
class IQueryCancelAutoPlay extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl/nf-shobjidl-iquerycancelautoplay-allowautoplay
     */
    AllowAutoPlay(pszPath, dwContentType, pszLabel, dwSerialNumber) {
        pszPath := pszPath is String ? StrPtr(pszPath) : pszPath
        pszLabel := pszLabel is String ? StrPtr(pszLabel) : pszLabel

        result := ComCall(3, this, "ptr", pszPath, "uint", dwContentType, "ptr", pszLabel, "uint", dwSerialNumber, "int")
        if(result != 0) {
