...
class IDefaultFolderMenuInitialize extends IUnknown{
    ...
    Initialize(hwnd, pcmcb, pidlFolder, psf, cidl, apidl, punkAssociation, cKeys, aKeys) {
        ...
        result := ComCall(3, this, "ptr", hwnd, "ptr", pcmcb, "ptr", pidlFolder, "ptr", psf, "uint", cidl, "ptr", apidl, "ptr", punkAssociation, "uint", cKeys, "ptr", aKeys, "int")
        if(result != 0)
     ...
     * @param {Pointer<Int32>} pdfmrValues 
     * @returns {HRESULT} 
     */
    GetMenuRestrictions(dfmrMask, pdfmrValues) {
        result := ComCall(5, this, "int", dfmrMask, "int*", pdfmrValues, "int")
        if(result != 0)
            throw OSError(result)
