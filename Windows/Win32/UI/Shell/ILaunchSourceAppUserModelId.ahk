 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ilaunchsourceappusermodelid
...
class ILaunchSourceAppUserModelId extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ilaunchsourceappusermodelid-getappusermodelid
     */
    GetAppUserModelId() {
        result := ComCall(3, this, "ptr*", &launchingApp := 0, "int")
        if(result != 0) {
