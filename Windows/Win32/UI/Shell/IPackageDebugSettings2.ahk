...
class IPackageDebugSettings2 extends IPackageDebugSettings{
     ...
     * @param {Pointer<UInt32>} appCount 
     * @param {Pointer<PWSTR>} appUserModelIds 
     * @param {Pointer<PWSTR>} appDisplayNames 
     * @returns {HRESULT} 
     */
    EnumerateApps(packageFullName, appCount, appUserModelIds, appDisplayNames) {
        ...
        result := ComCall(18, this, "ptr", packageFullName, "uint*", appCount, "ptr", appUserModelIds, "ptr", appDisplayNames, "int")
        if(result != 0)
