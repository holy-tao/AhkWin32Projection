 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nn-shlobj_core-iurlsearchhook
...
class IURLSearchHook extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shlobj_core/nf-shlobj_core-iurlsearchhook-translate
     */
    Translate(pwszSearchURL, cchBufferSize) {
        pwszSearchURL := pwszSearchURL is String ? StrPtr(pwszSearchURL) : pwszSearchURL

        result := ComCall(3, this, "ptr", pwszSearchURL, "uint", cchBufferSize, "int")
        if(result != 0) {
