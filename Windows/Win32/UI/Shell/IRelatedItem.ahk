 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-irelateditem
...
class IRelatedItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-irelateditem-getitemidlist
     */
    GetItemIDList() {
        result := ComCall(3, this, "ptr*", &ppidl := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-irelateditem-getitem
     */
    GetItem() {
