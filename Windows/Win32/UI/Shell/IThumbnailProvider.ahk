 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nn-thumbcache-ithumbnailprovider
...
class IThumbnailProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/thumbcache/nf-thumbcache-ithumbnailprovider-getthumbnail
     */
    GetThumbnail(cx, phbmp, pdwAlpha) {
        pdwAlphaMarshal := pdwAlpha is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "uint", cx, "ptr", phbmp, pdwAlphaMarshal, pdwAlpha, "int")
        if(result != 0) {
