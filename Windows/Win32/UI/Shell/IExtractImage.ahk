 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iextractimage
...
class IExtractImage extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iextractimage-getlocation
     */
    GetLocation(pszPathBuffer, cch, pdwPriority, prgSize, dwRecClrDepth, pdwFlags) {
        ...
        result := ComCall(3, this, "ptr", pszPathBuffer, "uint", cch, pdwPriorityMarshal, pdwPriority, "ptr", prgSize, "uint", dwRecClrDepth, pdwFlagsMarshal, pdwFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iextractimage-extract
     */
    Extract() {
