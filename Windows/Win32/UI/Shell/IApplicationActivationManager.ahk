...
class IApplicationActivationManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iapplicationactivationmanager-activateapplication
     */
    ActivateApplication(appUserModelId, arguments, options) {
        ...
        result := ComCall(3, this, "ptr", appUserModelId, "ptr", arguments, "int", options, "uint*", &processId := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} A pointer to a value that, when this method returns successfully, receives the process ID of the app instance that fulfills this contract.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iapplicationactivationmanager-activateforfile
     */
    ActivateForFile(appUserModelId, itemArray, verb) {
        appUserModelId := appUserModelId is String ? StrPtr(appUserModelId) : appUserModelId
        verb := verb is String ? StrPtr(verb) : verb

        result := ComCall(4, this, "ptr", appUserModelId, "ptr", itemArray, "ptr", verb, "uint*", &processId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} A pointer to a value that, when this method returns successfully, receives the process ID of the app instance that fulfills this contract.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iapplicationactivationmanager-activateforprotocol
     */
    ActivateForProtocol(appUserModelId, itemArray) {
        appUserModelId := appUserModelId is String ? StrPtr(appUserModelId) : appUserModelId

        result := ComCall(5, this, "ptr", appUserModelId, "ptr", itemArray, "uint*", &processId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
