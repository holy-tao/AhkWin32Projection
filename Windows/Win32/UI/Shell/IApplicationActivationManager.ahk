...
class IApplicationActivationManager extends IUnknown{
    ...
    ActivateApplication(appUserModelId, arguments, options, processId) {
        ...
        result := ComCall(3, this, "ptr", appUserModelId, "ptr", arguments, "int", options, "uint*", processId, "int")
        if(result != 0)
     ...
     * 
     * @param {PWSTR} appUserModelId 
     * @param {Pointer<IShellItemArray>} itemArray 
     * @param {PWSTR} verb 
     * @param {Pointer<UInt32>} processId 
     * @returns {HRESULT} 
     */
    ActivateForFile(appUserModelId, itemArray, verb, processId) {
        ...
        result := ComCall(4, this, "ptr", appUserModelId, "ptr", itemArray, "ptr", verb, "uint*", processId, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ActivateForProtocol(appUserModelId, itemArray, processId) {
        ...
        result := ComCall(5, this, "ptr", appUserModelId, "ptr", itemArray, "uint*", processId, "int")
        if(result != 0)
            throw OSError(result)
