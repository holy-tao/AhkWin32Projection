 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nn-shlwapi-iqueryassociations
...
class IQueryAssociations extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nf-shlwapi-iqueryassociations-init
     */
    Init(flags, pszAssoc, hkProgid, hwnd_) {
        ...
        result := ComCall(3, this, "uint", flags, "ptr", pszAssoc, "ptr", hkProgid, "ptr", hwnd_, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nf-shlwapi-iqueryassociations-getstring
     */
    GetString(flags, str, pszExtra, pszOut, pcchOut) {
        ...
        result := ComCall(4, this, "uint", flags, "int", str, "ptr", pszExtra, "ptr", pszOut, pcchOutMarshal, pcchOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nf-shlwapi-iqueryassociations-getkey
     */
    GetKey(flags, key, pszExtra) {
        pszExtra := pszExtra is String ? StrPtr(pszExtra) : pszExtra

        phkeyOut := HKEY()
        result := ComCall(5, this, "uint", flags, "int", key, "ptr", pszExtra, "ptr", phkeyOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nf-shlwapi-iqueryassociations-getdata
     */
    GetData(flags, data, pszExtra, pvOut, pcbOut) {
        ...
        result := ComCall(6, this, "uint", flags, "int", data, "ptr", pszExtra, "ptr", pvOut, pcbOutMarshal, pcbOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} assocenum_ TBD
     * @param {PWSTR} pszExtra TBD
     * @param {Pointer<Guid>} riid TBD
     * @returns {Pointer<Void>} TBD
     * @see https://learn.microsoft.com/windows/win32/api//content/shlwapi/nf-shlwapi-iqueryassociations-getenum
     */
    GetEnum(flags, assocenum_, pszExtra, riid) {
        pszExtra := pszExtra is String ? StrPtr(pszExtra) : pszExtra

        result := ComCall(7, this, "uint", flags, "int", assocenum_, "ptr", pszExtra, "ptr", riid, "ptr*", &ppvOut := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
