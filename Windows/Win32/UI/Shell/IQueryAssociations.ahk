...
class IQueryAssociations extends IUnknown{
    ...
    Init(flags, pszAssoc, hkProgid, hwnd) {
        ...
        result := ComCall(3, this, "uint", flags, "ptr", pszAssoc, "ptr", hkProgid, "ptr", hwnd, "int")
        if(result != 0)
    ...
    GetString(flags, str, pszExtra, pszOut, pcchOut) {
        ...
        result := ComCall(4, this, "uint", flags, "int", str, "ptr", pszExtra, "ptr", pszOut, "uint*", pcchOut, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetData(flags, data, pszExtra, pvOut, pcbOut) {
        ...
        result := ComCall(6, this, "uint", flags, "int", data, "ptr", pszExtra, "ptr", pvOut, "uint*", pcbOut, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetEnum(flags, assocenum, pszExtra, riid, ppvOut) {
        ...
        result := ComCall(7, this, "uint", flags, "int", assocenum, "ptr", pszExtra, "ptr", riid, "ptr", ppvOut, "int")
        if(result != 0)
            throw OSError(result)
