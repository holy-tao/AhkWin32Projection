 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nn-shappmgr-ipublishedapp
...
class IPublishedApp extends IShellApp{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ipublishedapp-install
     */
    Install(pstInstall) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ipublishedapp-getpublishedappinfo
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shappmgr/nf-shappmgr-ipublishedapp-unschedule
     */
    Unschedule() {
