...
export default struct IContextMenu3 extends IContextMenu2 {
    ...
    */
    ...
    HandleMenuMsg2(uMsg, _wParam, _lParam) {
        result := ComCall(7, this, UInt32, uMsg, WPARAM, _wParam, LPARAM, _lParam, LRESULT.Ptr, &plResult := 0, "HRESULT")
        return plResult
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.HandleMenuMsg2 := CallbackCreate(ObjBindMethod(implObj, "HandleMenuMsg2"), flags, 5)
    }
