 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iexecutecommandhost
...
class IExecuteCommandHost extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iexecutecommandhost-getuimode
     */
    GetUIMode() {
        result := ComCall(3, this, "int*", &pUIMode := 0, "int")
        if(result != 0) {
