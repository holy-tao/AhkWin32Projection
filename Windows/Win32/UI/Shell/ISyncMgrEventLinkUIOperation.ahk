 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nn-syncmgr-isyncmgreventlinkuioperation
...
class ISyncMgrEventLinkUIOperation extends ISyncMgrUIOperation{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncmgr/nf-syncmgr-isyncmgreventlinkuioperation-init
     */
    Init(rguidEventID, pEvent) {
        result := ComCall(4, this, "ptr", rguidEventID, "ptr", pEvent, "int")
        if(result != 0) {
