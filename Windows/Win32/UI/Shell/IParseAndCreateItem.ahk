 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iparseandcreateitem
...
class IParseAndCreateItem extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iparseandcreateitem-setitem
     */
    SetItem(psi) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iparseandcreateitem-getitem
     */
    GetItem(riid) {
