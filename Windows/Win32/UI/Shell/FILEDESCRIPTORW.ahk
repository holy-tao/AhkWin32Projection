 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//shlobj_core/ns-shlobj_core-filedescriptorw
...
class FILEDESCRIPTORW extends Win32Struct
{
     ...
     */
    cFileName {
        get => StrGet(this.ptr + 72, 259, "UTF-16")
        set => StrPut(value, this.ptr + 72, 259, "UTF-16")
    }
}
