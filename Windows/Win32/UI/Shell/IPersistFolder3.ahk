 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-ipersistfolder3
...
class IPersistFolder3 extends IPersistFolder2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ipersistfolder3-initializeex
     */
    InitializeEx(pbc, pidlRoot, ppfti) {
        result := ComCall(6, this, "ptr", pbc, "ptr", pidlRoot, "ptr", ppfti, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-ipersistfolder3-getfoldertargetinfo
     */
    GetFolderTargetInfo() {
        ppfti := PERSIST_FOLDER_TARGET_INFO()
        result := ComCall(7, this, "ptr", ppfti, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
