 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch4
...
class IShellDispatch4 extends IShellDispatch3{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch4-windowssecurity
     */
    WindowsSecurity() {
     ...
     * @returns {HRESULT} This method has no parameters.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch4-toggledesktop
     */
    ToggleDesktop() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch4-explorerpolicy
     */
    ExplorerPolicy(bstrPolicyName) {
        if(bstrPolicyName is String) {
            pin := BSTR.Alloc(bstrPolicyName)
            bstrPolicyName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/shell/ishelldispatch4-getsetting
     */
    GetSetting(lSetting) {
        result := ComCall(43, this, "int", lSetting, "short*", &pResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
