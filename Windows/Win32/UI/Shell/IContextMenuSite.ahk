 ...
 * }
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-icontextmenusite
...
class IContextMenuSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icontextmenusite-docontextmenupopup
     */
    DoContextMenuPopup(punkContextMenu, fFlags, pt) {
        result := ComCall(3, this, "ptr", punkContextMenu, "uint", fFlags, "ptr", pt, "int")
        if(result != 0) {
