 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertyenumtype2
...
class IPropertyEnumType2 extends IPropertyEnumType{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype2-getimagereference
     */
    GetImageReference() {
        result := ComCall(8, this, "ptr*", &ppszImageRes := 0, "int")
        if(result != 0) {
