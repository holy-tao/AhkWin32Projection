 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipersistserializedpropstorage
...
class IPersistSerializedPropStorage extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipersistserializedpropstorage-setflags
     */
    SetFlags(flags) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipersistserializedpropstorage-setpropertystorage
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipersistserializedpropstorage-getpropertystorage
     */
    GetPropertyStorage(ppsps, pcb) {
        ppspsMarshal := ppsps is VarRef ? "ptr*" : "ptr"
        pcbMarshal := pcb is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, ppspsMarshal, ppsps, pcbMarshal, pcb, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
