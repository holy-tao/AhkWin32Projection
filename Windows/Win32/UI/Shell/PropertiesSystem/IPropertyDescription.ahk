 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertydescription
...
class IPropertyDescription extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getpropertykey
     */
    GetPropertyKey() {
        pkey := PROPERTYKEY()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getcanonicalname
     */
    GetCanonicalName() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getpropertytype
     */
    GetPropertyType() {
        result := ComCall(5, this, "ushort*", &pvartype := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getdisplayname
     */
    GetDisplayName() {
        result := ComCall(6, this, "ptr*", &ppszName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-geteditinvitation
     */
    GetEditInvitation() {
        result := ComCall(7, this, "ptr*", &ppszInvite := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-gettypeflags
     */
    GetTypeFlags(mask) {
        result := ComCall(8, this, "uint", mask, "uint*", &ppdtFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getviewflags
     */
    GetViewFlags() {
        result := ComCall(9, this, "int*", &ppdvFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getdefaultcolumnwidth
     */
    GetDefaultColumnWidth() {
        result := ComCall(10, this, "uint*", &pcxChars := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getdisplaytype
     */
    GetDisplayType() {
        result := ComCall(11, this, "int*", &pdisplaytype := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getcolumnstate
     */
    GetColumnState() {
        result := ComCall(12, this, "uint*", &pcsFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getgroupingrange
     */
    GetGroupingRange() {
        result := ComCall(13, this, "int*", &pgr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getrelativedescriptiontype
     */
    GetRelativeDescriptionType() {
        result := ComCall(14, this, "int*", &prdt := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getrelativedescription
     */
    GetRelativeDescription(propvar1, propvar2, ppszDesc1, ppszDesc2) {
        ...
        result := ComCall(15, this, "ptr", propvar1, "ptr", propvar2, ppszDesc1Marshal, ppszDesc1, ppszDesc2Marshal, ppszDesc2, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getsortdescription
     */
    GetSortDescription() {
        result := ComCall(16, this, "int*", &psd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getsortdescriptionlabel
     */
    GetSortDescriptionLabel(fDescending) {
        result := ComCall(17, this, "int", fDescending, "ptr*", &ppszDescription := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getaggregationtype
     */
    GetAggregationType() {
        result := ComCall(18, this, "int*", &paggtype := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getconditiontype
     */
    GetConditionType(pcontype, popDefault) {
        ...
        result := ComCall(19, this, pcontypeMarshal, pcontype, popDefaultMarshal, popDefault, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-getenumtypelist
     */
    GetEnumTypeList(riid) {
        result := ComCall(20, this, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-coercetocanonicalvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-formatfordisplay
     */
    FormatForDisplay(propvar, pdfFlags) {
        result := ComCall(22, this, "ptr", propvar, "int", pdfFlags, "ptr*", &ppszDisplay := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription-isvaluecanonical
     */
