 ...
 * @since windows6.0.6000
 */
export PSFormatForDisplayAlloc(key, propvar, pdff) {
    result := DllCall("PROPSYS.dll\PSFormatForDisplayAlloc", PROPERTYKEY.Ptr, key, PROPVARIANT.Ptr, propvar, PROPDESC_FORMAT_FLAGS, pdff, PWSTR.Ptr, &ppszDisplay := 0, "HRESULT")
    return ppszDisplay
}
 ...
 * @since windows6.0.6000
 */
export PSFormatPropertyValue(pps, ppd, pdff) {
    result := DllCall("PROPSYS.dll\PSFormatPropertyValue", "ptr", pps, "ptr", ppd, PROPDESC_FORMAT_FLAGS, pdff, PWSTR.Ptr, &ppszDisplay := 0, "HRESULT")
    return ppszDisplay
}
 ...
 * @since windows6.1
 */
export PSGetImageReferenceForValue(propkey, propvar) {
    result := DllCall("PROPSYS.dll\PSGetImageReferenceForValue", PROPERTYKEY.Ptr, propkey, PROPVARIANT.Ptr, propvar, PWSTR.Ptr, &ppszImageRes := 0, "HRESULT")
    return ppszImageRes
}
 ...
 * @since windows5.1.2600
 */
export PSPropertyKeyFromString(pszString, pkey) {
    pszString := pszString is String ? StrPtr(pszString) : pszString

    result := DllCall("PROPSYS.dll\PSPropertyKeyFromString", "ptr", pszString, PROPERTYKEY.Ptr, pkey, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSCreateMemoryPropertyStore(riid) {
    result := DllCall("PROPSYS.dll\PSCreateMemoryPropertyStore", Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSCreateSimplePropertyChange(flags, key, propvar, riid) {
    result := DllCall("PROPSYS.dll\PSCreateSimplePropertyChange", PKA_FLAGS, flags, PROPERTYKEY.Ptr, key, PROPVARIANT.Ptr, propvar, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertyDescription(propkey, riid) {
    result := DllCall("PROPSYS.dll\PSGetPropertyDescription", PROPERTYKEY.Ptr, propkey, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertyDescriptionByName(pszCanonicalName, riid) {
    pszCanonicalName := pszCanonicalName is String ? StrPtr(pszCanonicalName) : pszCanonicalName

    result := DllCall("PROPSYS.dll\PSGetPropertyDescriptionByName", "ptr", pszCanonicalName, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSLookupPropertyHandlerCLSID(pszFilePath, pclsid) {
    pszFilePath := pszFilePath is String ? StrPtr(pszFilePath) : pszFilePath

    result := DllCall("PROPSYS.dll\PSLookupPropertyHandlerCLSID", "ptr", pszFilePath, Guid.Ptr, pclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSGetItemPropertyHandler(punkItem, fReadWrite, riid) {
    result := DllCall("PROPSYS.dll\PSGetItemPropertyHandler", "ptr", punkItem, BOOL, fReadWrite, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetItemPropertyHandlerWithCreateObject(punkItem, fReadWrite, punkCreateObject, riid) {
    result := DllCall("PROPSYS.dll\PSGetItemPropertyHandlerWithCreateObject", "ptr", punkItem, BOOL, fReadWrite, "ptr", punkCreateObject, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertyValue(pps, ppd, ppropvar) {
    result := DllCall("PROPSYS.dll\PSGetPropertyValue", "ptr", pps, "ptr", ppd, PROPVARIANT.Ptr, ppropvar, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSSetPropertyValue(pps, ppd, propvar) {
    result := DllCall("PROPSYS.dll\PSSetPropertyValue", "ptr", pps, "ptr", ppd, PROPVARIANT.Ptr, propvar, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSRegisterPropertySchema(pszPath) {
 ...
 * @since windows5.1.2600
 */
export PSUnregisterPropertySchema(pszPath) {
    pszPath := pszPath is String ? StrPtr(pszPath) : pszPath
 ...
 * @since windows5.1.2600
 */
export PSRefreshPropertySchema() {
 ...
 * @since windows5.1.2600
 */
export PSEnumeratePropertyDescriptions(filterOn, riid) {
    result := DllCall("PROPSYS.dll\PSEnumeratePropertyDescriptions", PROPDESC_ENUMFILTER, filterOn, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertyKeyFromName(pszName, ppropkey) {
    pszName := pszName is String ? StrPtr(pszName) : pszName

    result := DllCall("PROPSYS.dll\PSGetPropertyKeyFromName", "ptr", pszName, PROPERTYKEY.Ptr, ppropkey, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSGetNameFromPropertyKey(propkey) {
    result := DllCall("PROPSYS.dll\PSGetNameFromPropertyKey", PROPERTYKEY.Ptr, propkey, PWSTR.Ptr, &ppszCanonicalName := 0, "HRESULT")
 ...
 * @since windows5.1.2600
 */
export PSCoerceToCanonicalValue(key, ppropvar) {
    result := DllCall("PROPSYS.dll\PSCoerceToCanonicalValue", PROPERTYKEY.Ptr, key, PROPVARIANT.Ptr, ppropvar, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertyDescriptionListFromString(pszPropList, riid) {
    pszPropList := pszPropList is String ? StrPtr(pszPropList) : pszPropList

    result := DllCall("PROPSYS.dll\PSGetPropertyDescriptionListFromString", "ptr", pszPropList, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSCreateAdapterFromPropertyStore(pps, riid) {
    result := DllCall("PROPSYS.dll\PSCreateAdapterFromPropertyStore", "ptr", pps, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export PSGetPropertySystem(riid) {
    result := DllCall("PROPSYS.dll\PSGetPropertySystem", Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadType(propBag, propName, var, type) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadType", "ptr", propBag, "ptr", propName, VARIANT.Ptr, var, VARENUM, type, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadStr(propBag, propName, value, characterCount) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadStrAlloc(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadStrAlloc", "ptr", propBag, "ptr", propName, PWSTR.Ptr, &value := 0, "HRESULT")
    return value
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadBSTR(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName

    value := BSTR.Owned()
    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadBSTR", "ptr", propBag, "ptr", propName, BSTR.Ptr, value, "HRESULT")
    return value
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteStr(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName
    value := value is String ? StrPtr(value) : value
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteBSTR(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WriteBSTR", "ptr", propBag, "ptr", propName, BSTR, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadInt(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadSHORT(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadLONG(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadDWORD(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadBOOL(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadBOOL", "ptr", propBag, "ptr", propName, BOOL.Ptr, &value := 0, "HRESULT")
    return value
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteBOOL(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WriteBOOL", "ptr", propBag, "ptr", propName, BOOL, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadPOINTL(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadPOINTL", "ptr", propBag, "ptr", propName, POINTL.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WritePOINTL(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WritePOINTL", "ptr", propBag, "ptr", propName, POINTL.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadPOINTS(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadPOINTS", "ptr", propBag, "ptr", propName, POINTS.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WritePOINTS(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WritePOINTS", "ptr", propBag, "ptr", propName, POINTS.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadRECTL(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadRECTL", "ptr", propBag, "ptr", propName, RECTL.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteRECTL(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WriteRECTL", "ptr", propBag, "ptr", propName, RECTL.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadStream(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteStream(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_Delete(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadULONGLONG(propBag, propName) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadUnknown(propBag, propName, riid) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadUnknown", "ptr", propBag, "ptr", propName, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteUnknown(propBag, propName, punk) {
    propName := propName is String ? StrPtr(propName) : propName
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadGUID(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadGUID", "ptr", propBag, "ptr", propName, Guid.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WriteGUID(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WriteGUID", "ptr", propBag, "ptr", propName, Guid.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_ReadPropertyKey(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_ReadPropertyKey", "ptr", propBag, "ptr", propName, PROPERTYKEY.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export PSPropertyBag_WritePropertyKey(propBag, propName, value) {
    propName := propName is String ? StrPtr(propName) : propName

    result := DllCall("PROPSYS.dll\PSPropertyBag_WritePropertyKey", "ptr", propBag, "ptr", propName, PROPERTYKEY.Ptr, value, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export SHGetPropertyStoreFromIDList(pidl, flags, riid) {
    result := DllCall("SHELL32.dll\SHGetPropertyStoreFromIDList", ITEMIDLIST.Ptr, pidl, GETPROPERTYSTOREFLAGS, flags, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows6.0.6000
 */
export SHAddDefaultPropertiesByExt(pszExt, pPropStore) {
 ...
 * @since windows5.0
 */
export PifMgr_OpenProperties(pszApp, pszPIF, hInf, flOpt) {
 ...
 * @since windows6.1
 */
export SHGetPropertyStoreForWindow(_hwnd, riid) {
    result := DllCall("SHELL32.dll\SHGetPropertyStoreForWindow", HWND, _hwnd, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
