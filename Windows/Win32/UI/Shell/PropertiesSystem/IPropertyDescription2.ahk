 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertydescription2
...
class IPropertyDescription2 extends IPropertyDescription{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescription2-getimagereferenceforvalue
     */
    GetImageReferenceForValue(propvar) {
        result := ComCall(24, this, "ptr", propvar, "ptr*", &ppszImageRes := 0, "int")
        if(result != 0) {
