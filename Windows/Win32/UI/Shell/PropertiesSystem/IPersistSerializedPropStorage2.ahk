 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipersistserializedpropstorage2
...
class IPersistSerializedPropStorage2 extends IPersistSerializedPropStorage{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipersistserializedpropstorage2-getpropertystoragesize
     */
    GetPropertyStorageSize() {
        result := ComCall(6, this, "uint*", &pcb := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipersistserializedpropstorage2-getpropertystoragebuffer
     */
    GetPropertyStorageBuffer(psps, cb) {
        result := ComCall(7, this, "ptr", psps, "uint", cb, "uint*", &pcbWritten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
