 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-idelayedpropertystorefactory
...
class IDelayedPropertyStoreFactory extends IPropertyStoreFactory{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-idelayedpropertystorefactory-getdelayedpropertystore
     */
    GetDelayedPropertyStore(flags, dwStoreId, riid) {
        result := ComCall(5, this, "int", flags, "uint", dwStoreId, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
