 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertyenumtype
...
class IPropertyEnumType extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype-getenumtype
     */
    GetEnumType() {
        result := ComCall(3, this, "int*", &penumtype := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype-getvalue
     */
    GetValue() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype-getrangeminvalue
     */
    GetRangeMinValue() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype-getrangesetvalue
     */
    GetRangeSetValue() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertyenumtype-getdisplaytext
     */
    GetDisplayText() {
        result := ComCall(7, this, "ptr*", &ppszDisplay := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
