 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertydescriptionsearchinfo
...
class IPropertyDescriptionSearchInfo extends IPropertyDescription{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionsearchinfo-getsearchinfoflags
     */
    GetSearchInfoFlags() {
        result := ComCall(24, this, "int*", &ppdsiFlags := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionsearchinfo-getcolumnindextype
     */
    GetColumnIndexType() {
        result := ComCall(25, this, "int*", &ppdciType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionsearchinfo-getprojectionstring
     */
    GetProjectionString() {
        result := ComCall(26, this, "ptr*", &ppszProjection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionsearchinfo-getmaxsize
     */
    GetMaxSize() {
        result := ComCall(27, this, "uint*", &pcbMaxSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
