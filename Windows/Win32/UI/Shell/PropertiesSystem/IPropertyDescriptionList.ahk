 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nn-propsys-ipropertydescriptionlist
...
class IPropertyDescriptionList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionlist-getcount
     */
    GetCount() {
        result := ComCall(3, this, "uint*", &pcElem := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propsys/nf-propsys-ipropertydescriptionlist-getat
     */
    GetAt(iElem, riid) {
        result := ComCall(4, this, "uint", iElem, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
