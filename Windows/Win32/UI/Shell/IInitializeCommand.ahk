 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-iinitializecommand
...
class IInitializeCommand extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-iinitializecommand-initialize
     */
    Initialize(pszCommandName, ppb) {
        pszCommandName := pszCommandName is String ? StrPtr(pszCommandName) : pszCommandName

        result := ComCall(3, this, "ptr", pszCommandName, "ptr", ppb, "int")
        if(result != 0) {
