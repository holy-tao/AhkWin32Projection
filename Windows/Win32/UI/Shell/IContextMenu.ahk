 ...
 * <div></div>
 * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nn-shobjidl_core-icontextmenu
...
class IContextMenu extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icontextmenu-querycontextmenu
     */
    QueryContextMenu(hmenu_, indexMenu, idCmdFirst, idCmdLast, uFlags) {
        hmenu_ := hmenu_ is Win32Handle ? NumGet(hmenu_, "ptr") : hmenu_

        result := ComCall(3, this, "ptr", hmenu_, "uint", indexMenu, "uint", idCmdFirst, "uint", idCmdLast, "uint", uFlags, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icontextmenu-invokecommand
     */
    InvokeCommand(pici) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/shobjidl_core/nf-shobjidl_core-icontextmenu-getcommandstring
     */
