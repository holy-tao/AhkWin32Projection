 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nn-mileffects-imilbitmapeffectoutputconnector
...
class IMILBitmapEffectOutputConnector extends IMILBitmapEffectConnector{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectoutputconnector-getnumberconnections
     */
    GetNumberConnections() {
        result := ComCall(9, this, "uint*", &puiNumberConnections := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectoutputconnector-getconnection
     */
    GetConnection(uiIndex) {
        result := ComCall(10, this, "uint", uiIndex, "ptr*", &ppConnection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
