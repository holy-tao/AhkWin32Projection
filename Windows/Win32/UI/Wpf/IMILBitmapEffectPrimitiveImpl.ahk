 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nn-mileffects-imilbitmapeffectprimitiveimpl
...
class IMILBitmapEffectPrimitiveImpl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectprimitiveimpl-isdirty
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectprimitiveimpl-isvolatile
     */
    IsVolatile(uiOutputIndex) {
        result := ComCall(4, this, "uint", uiOutputIndex, "short*", &pfVolatile := 0, "int")
        if(result != 0) {
