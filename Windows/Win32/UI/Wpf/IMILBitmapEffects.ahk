 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nn-mileffects-imilbitmapeffects
...
class IMILBitmapEffects extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffects-_newenum
     */
    _NewEnum() {
        result := ComCall(3, this, "ptr*", &ppiuReturn := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffects-get_parent
     */
    get_Parent() {
        result := ComCall(4, this, "ptr*", &ppEffect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffects-item
     */
    Item(uindex) {
        result := ComCall(5, this, "uint", uindex, "ptr*", &ppEffect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffects-get_count
     */
    get_Count() {
        result := ComCall(6, this, "uint*", &puiCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
