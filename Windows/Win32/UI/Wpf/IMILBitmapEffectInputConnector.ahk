 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nn-mileffects-imilbitmapeffectinputconnector
...
class IMILBitmapEffectInputConnector extends IMILBitmapEffectConnector{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectinputconnector-connectto
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectinputconnector-getconnection
     */
    GetConnection() {
        result := ComCall(10, this, "ptr*", &ppConnector := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
