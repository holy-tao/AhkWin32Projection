 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nn-mileffects-imilbitmapeffectfactory
...
class IMILBitmapEffectFactory extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectfactory-createeffect
     */
    CreateEffect(pguidEffect) {
        result := ComCall(3, this, "ptr", pguidEffect, "ptr*", &ppEffect := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectfactory-createcontext
     */
    CreateContext() {
        result := ComCall(4, this, "ptr*", &ppContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mileffects/nf-mileffects-imilbitmapeffectfactory-createeffectouter
     */
    CreateEffectOuter() {
        result := ComCall(5, this, "ptr*", &ppEffect := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
