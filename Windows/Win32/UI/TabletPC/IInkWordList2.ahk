 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkwordlist2
...
class IInkWordList2 extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkwordlist2-addwords
     */
    AddWords(NewWords) {
        if(NewWords is String) {
            pin := BSTR.Alloc(NewWords)
            NewWords := pin.Value
        }
