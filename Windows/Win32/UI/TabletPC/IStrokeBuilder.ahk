 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nn-rtscom-istrokebuilder
...
class IStrokeBuilder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istrokebuilder-createstroke
     */
    CreateStroke(cPktBuffLength, pPackets, cPacketProperties, pPacketProperties, fInkToDeviceScaleX, fInkToDeviceScaleY, ppIInkStroke) {
        ...
        result := ComCall(3, this, "uint", cPktBuffLength, pPacketsMarshal, pPackets, "uint", cPacketProperties, "ptr", pPacketProperties, "float", fInkToDeviceScaleX, "float", fInkToDeviceScaleY, "ptr*", ppIInkStroke, "int")
        if(result != 0) {
     ...
     * @param {Integer} sid_ The stylus identifier.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istrokebuilder-beginstroke
     */
    BeginStroke(tcid, sid_, pPacket, cPacketProperties, pPacketProperties, fInkToDeviceScaleX, fInkToDeviceScaleY, ppIInkStroke) {
        pPacketMarshal := pPacket is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "uint", tcid, "uint", sid_, pPacketMarshal, pPacket, "uint", cPacketProperties, "ptr", pPacketProperties, "float", fInkToDeviceScaleX, "float", fInkToDeviceScaleY, "ptr*", ppIInkStroke, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} sid_ The identifier of the stylus object.
     ...
     * @returns {HRESULT} For a description of the return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istrokebuilder-appendpackets
     */
    AppendPackets(tcid, sid_, cPktBuffLength, pPackets) {
        pPacketsMarshal := pPackets is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, "uint", tcid, "uint", sid_, "uint", cPktBuffLength, pPacketsMarshal, pPackets, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>..
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istrokebuilder-endstroke
     */
    EndStroke(tcid, sid_, ppIInkStroke, pDirtyRect) {
        result := ComCall(6, this, "uint", tcid, "uint", sid_, "ptr*", ppIInkStroke, "ptr", pDirtyRect, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IInkDisp} 
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istrokebuilder-get_ink
     */
    get_Ink() {
        result := ComCall(7, this, "ptr*", &ppiInkObj := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
