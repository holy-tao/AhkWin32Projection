 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkrecognitionalternate
...
class IInkRecognitionAlternate extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_string
     */
    get_String() {
        RecoString := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_confidence
     */
    get_Confidence() {
        result := ComCall(8, this, "int*", &Confidence := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_baseline
     */
    get_Baseline() {
        Baseline := VARIANT()
     ...
     * <div> </div>
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_midline
     */
    get_Midline() {
        Midline := VARIANT()
     ...
     * <div> </div>
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_ascender
     */
    get_Ascender() {
        Ascender := VARIANT()
     ...
     * <div> </div>
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_descender
     */
    get_Descender() {
        Descender := VARIANT()
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_linenumber
     */
    get_LineNumber() {
        result := ComCall(13, this, "int*", &LineNumber := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_strokes
     */
    get_Strokes() {
        result := ComCall(14, this, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_linealternates
     */
    get_LineAlternates() {
        result := ComCall(15, this, "ptr*", &LineAlternates := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IInkRecognitionAlternates} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-get_confidencealternates
     */
    get_ConfidenceAlternates() {
        result := ComCall(16, this, "ptr*", &ConfidenceAlternates := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-getstrokesfromstrokeranges
     */
    GetStrokesFromStrokeRanges(Strokes) {
        result := ComCall(17, this, "ptr", Strokes, "ptr*", &GetStrokesFromStrokeRanges := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-getstrokesfromtextrange
     */
    GetStrokesFromTextRange(selectionStart, selectionLength) {
        ...
        result := ComCall(18, this, selectionStartMarshal, selectionStart, selectionLengthMarshal, selectionLength, "ptr*", &GetStrokesFromTextRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-gettextrangefromstrokes
     */
    GetTextRangeFromStrokes(Strokes, selectionStart, selectionLength) {
        selectionStartMarshal := selectionStart is VarRef ? "int*" : "ptr"
        selectionLengthMarshal := selectionLength is VarRef ? "int*" : "ptr"

        result := ComCall(19, this, "ptr", Strokes, selectionStartMarshal, selectionStart, selectionLengthMarshal, selectionLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-alternateswithconstantpropertyvalues
     */
    AlternatesWithConstantPropertyValues(PropertyType) {
        if(PropertyType is String) {
            pin := BSTR.Alloc(PropertyType)
            PropertyType := pin.Value
        }

        result := ComCall(20, this, "ptr", PropertyType, "ptr*", &AlternatesWithConstantPropertyValues := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * For more information about the BSTR data type, see <a href="https://docs.microsoft.com/windows/desktop/tablet/using-the-com-library">Using the COM Library</a>.
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternate-getpropertyvalue
     */
    GetPropertyValue(PropertyType) {
        ...
        result := ComCall(21, this, "ptr", PropertyType, "ptr", PropertyValue_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
