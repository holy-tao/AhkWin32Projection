 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nn-rtscom-istylusplugin
...
class IStylusPlugin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-realtimestylusenabled
     */
    RealTimeStylusEnabled(piRtsSrc, cTcidCount, pTcids) {
        pTcidsMarshal := pTcids is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", piRtsSrc, "uint", cTcidCount, pTcidsMarshal, pTcids, "int")
        if(result != 0) {
     ...
     * @param {Pointer<Integer>} pTcids The tablet context identifiers.
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-realtimestylusdisabled
     */
    RealTimeStylusDisabled(piRtsSrc, cTcidCount, pTcids) {
        pTcidsMarshal := pTcids is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, "ptr", piRtsSrc, "uint", cTcidCount, pTcidsMarshal, pTcids, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} sid_ Stylus identifier.
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusinrange
     */
    StylusInRange(piRtsSrc, tcid, sid_) {
        result := ComCall(5, this, "ptr", piRtsSrc, "uint", tcid, "uint", sid_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} sid_ Stylus identifier.
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusoutofrange
     */
    StylusOutOfRange(piRtsSrc, tcid, sid_) {
        result := ComCall(6, this, "ptr", piRtsSrc, "uint", tcid, "uint", sid_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusdown
     */
    StylusDown(piRtsSrc, pStylusInfo, cPropCountPerPkt, pPacket, ppInOutPkt) {
        ...
        result := ComCall(7, this, "ptr", piRtsSrc, "ptr", pStylusInfo, "uint", cPropCountPerPkt, pPacketMarshal, pPacket, ppInOutPktMarshal, ppInOutPkt, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Pointer<Integer>>} ppInOutPkt A pointer to the modified stylus data packet. The plug-in can use this parameter to feed modified packet data to downstream packets. A value other than <b>NULL</b> indicates that the packet has been modified and RTS will send this data down to plug-ins by using the <i>pPacket</i> parameter.
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusup
     */
    StylusUp(piRtsSrc, pStylusInfo, cPropCountPerPkt, pPacket, ppInOutPkt) {
        pPacketMarshal := pPacket is VarRef ? "int*" : "ptr"
        ppInOutPktMarshal := ppInOutPkt is VarRef ? "ptr*" : "ptr"

        result := ComCall(8, this, "ptr", piRtsSrc, "ptr", pStylusInfo, "uint", cPropCountPerPkt, pPacketMarshal, pPacket, ppInOutPktMarshal, ppInOutPkt, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IRealTimeStylus} piRtsSrc The <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-class">RealTimeStylus Class</a> object that sent the notification.
     * @param {Integer} sid_ Security identifier.
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusbuttondown
     */
    StylusButtonDown(piRtsSrc, sid_, pGuidStylusButton, pStylusPos) {
        result := ComCall(9, this, "ptr", piRtsSrc, "uint", sid_, "ptr", pGuidStylusButton, "ptr", pStylusPos, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-stylusbuttonup
     */
    StylusButtonUp(piRtsSrc, sid_, pGuidStylusButton, pStylusPos) {
        result := ComCall(10, this, "ptr", piRtsSrc, "uint", sid_, "ptr", pGuidStylusButton, "ptr", pStylusPos, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-inairpackets
     */
    InAirPackets(piRtsSrc, pStylusInfo, cPktCount, cPktBuffLength, pPackets, pcInOutPkts, ppInOutPkts) {
        ...
        result := ComCall(11, this, "ptr", piRtsSrc, "ptr", pStylusInfo, "uint", cPktCount, "uint", cPktBuffLength, pPacketsMarshal, pPackets, pcInOutPktsMarshal, pcInOutPkts, ppInOutPktsMarshal, ppInOutPkts, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-packets
     */
    Packets(piRtsSrc, pStylusInfo, cPktCount, cPktBuffLength, pPackets, pcInOutPkts, ppInOutPkts) {
        ...
        result := ComCall(12, this, "ptr", piRtsSrc, "ptr", pStylusInfo, "uint", cPktCount, "uint", cPktBuffLength, pPacketsMarshal, pPackets, pcInOutPktsMarshal, pcInOutPkts, ppInOutPktsMarshal, ppInOutPkts, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-customstylusdataadded
     */
    CustomStylusDataAdded(piRtsSrc, pGuidId, cbData, pbData) {
        pbDataMarshal := pbData is VarRef ? "char*" : "ptr"

        result := ComCall(13, this, "ptr", piRtsSrc, "ptr", pGuidId, "uint", cbData, pbDataMarshal, pbData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} sid_ The security identifier.
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/classes-and-interfaces---ink-analysis">Classes and Interfaces - Ink Analysis</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-systemevent
     */
    SystemEvent(piRtsSrc, tcid, sid_, event, eventdata) {
        result := ComCall(14, this, "ptr", piRtsSrc, "uint", tcid, "uint", sid_, "ushort", event, "ptr", eventdata, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-tabletadded
     */
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-tabletremoved
     */
     ...
     * @returns {HRESULT} For a description of return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/classes-and-interfaces---ink-analysis">Classes and Interfaces - Ink Analysis</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-error
     */
    Error(piRtsSrc, piPlugin, dataInterest, hrErrorCode, lptrKey) {
        lptrKeyMarshal := lptrKey is VarRef ? "ptr*" : "ptr"

        result := ComCall(17, this, "ptr", piRtsSrc, "ptr", piPlugin, "int", dataInterest, "int", hrErrorCode, lptrKeyMarshal, lptrKey, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-updatemapping
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-istylusplugin-datainterest
     */
    DataInterest() {
        result := ComCall(19, this, "int*", &pDataInterest := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
