 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nn-msinkaut15-iinkdivisionunit
...
class IInkDivisionUnit extends IDispatch{
     ...
     * <div> </div>
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivisionunit-get_strokes
     */
    get_Strokes() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivisionunit-get_divisiontype
     */
    get_DivisionType() {
        result := ComCall(8, this, "int*", &divisionType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_RecognizedString() {
        RecoString := BSTR()
        result := ComCall(9, this, "ptr", RecoString, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivisionunit-get_rotationtransform
     */
    get_RotationTransform() {
        result := ComCall(10, this, "ptr*", &RotationTransform := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
