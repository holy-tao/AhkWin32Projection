 ...
 */
export default struct IInkRecognitionResult extends IDispatch {
    /**
     ...
     * used for IInkRecognitionResult interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        get_TopString           : IntPtr
        get_TopAlternate        : IntPtr
        get_TopConfidence       : IntPtr
        get_Strokes             : IntPtr
        AlternatesFromSelection : IntPtr
        ModifyTopAlternate      : IntPtr
        SetResultOnStrokes      : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IInkRecognitionResult.Vtbl()
        }
     ...
     */
    get_TopString() {
        TopString := BSTR.Owned()
        result := ComCall(7, this, BSTR.Ptr, TopString, "HRESULT")
        return TopString
    }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.get_TopString)
        CallbackFree(this.vtbl.get_TopAlternate)
        CallbackFree(this.vtbl.get_TopConfidence)
        CallbackFree(this.vtbl.get_Strokes)
        CallbackFree(this.vtbl.AlternatesFromSelection)
        CallbackFree(this.vtbl.ModifyTopAlternate)
        CallbackFree(this.vtbl.SetResultOnStrokes)
    }
}
