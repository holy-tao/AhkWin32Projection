 ...
 */
export default struct IInkCustomStrokes extends IDispatch {
    /**
     ...
     * used for IInkCustomStrokes interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IInkCustomStrokes.Vtbl()
        }
     ...
     */
    Item(Identifier) {
        result := ComCall(9, this, VARIANT, Identifier, "ptr*", &Strokes := 0, "HRESULT")
    ...
    Add(Name, Strokes) {
        ...
        result := ComCall(10, this, BSTR, Name, StrokesMarshal, Strokes, "HRESULT")
        return result
    }
    ...
    _Query(iid) {
        if (IInkCustomStrokes.IID.Equals(iid)) {
            return true
        }
