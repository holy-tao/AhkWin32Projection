 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nn-rtscom-irealtimestylussynchronization
...
class IRealTimeStylusSynchronization extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-irealtimestylussynchronization-acquirelock
     */
    AcquireLock(lock) {
     ...
     * @returns {HRESULT} For a description of the return values, see <a href="https://docs.microsoft.com/windows/desktop/tablet/realtimestylus-classes-and-interfaces">RealTimeStylus Classes and Interfaces</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-irealtimestylussynchronization-releaselock
     */
    ReleaseLock(lock) {
