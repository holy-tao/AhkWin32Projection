 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nn-peninputpanel-itextinputpanel
...
class ITextInputPanel extends IUnknown{
     ...
     * @returns {HWND} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_attachededitwindow
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_attachededitwindow
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_currentinteractionmode
     */
    get_CurrentInteractionMode() {
        result := ComCall(5, this, "int*", &CurrentInteractionMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_defaultinplacestate
     */
    get_DefaultInPlaceState() {
        result := ComCall(6, this, "int*", &State := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} State 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_defaultinplacestate
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_currentinplacestate
     */
    get_CurrentInPlaceState() {
        result := ComCall(8, this, "int*", &State := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_defaultinputarea
     */
    get_DefaultInputArea() {
        result := ComCall(9, this, "int*", &Area := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Area 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_defaultinputarea
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_currentinputarea
     */
    get_CurrentInputArea() {
        result := ComCall(11, this, "int*", &Area := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_currentcorrectionmode
     */
    get_CurrentCorrectionMode() {
        result := ComCall(12, this, "int*", &Mode_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_preferredinplacedirection
     */
    get_PreferredInPlaceDirection() {
        result := ComCall(13, this, "int*", &Direction_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_preferredinplacedirection
     */
    put_PreferredInPlaceDirection(Direction_) {
        result := ComCall(14, this, "int", Direction_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_expandpostinsertioncorrection
     */
    get_ExpandPostInsertionCorrection() {
        result := ComCall(15, this, "int*", &Expand := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BOOL} Expand 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_expandpostinsertioncorrection
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_inplacevisibleonfocus
     */
    get_InPlaceVisibleOnFocus() {
        result := ComCall(17, this, "int*", &Visible := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BOOL} Visible 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-put_inplacevisibleonfocus
     */
     ...
     * @returns {RECT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_inplaceboundingrectangle
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_popupcorrectionheight
     */
    get_PopUpCorrectionHeight() {
        result := ComCall(20, this, "int*", &Height := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-get_popdowncorrectionheight
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-commitpendinginput
     */
    CommitPendingInput() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-setinplacevisibility
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-setinplaceposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-setinplacehovertargetposition
     */
     ...
     * @param {Integer} EventMask_ A bitwise value of the <a href="https://docs.microsoft.com/windows/win32/api/peninputpanel/ne-peninputpanel-eventmask">EventMask Enumeration</a>, indicating the events of interest.
     * @returns {HRESULT} This method can return one of these values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-advise
     */
    Advise(EventSink, EventMask_) {
        result := ComCall(26, this, "ptr", EventSink, "uint", EventMask_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/peninputpanel/nf-peninputpanel-itextinputpanel-unadvise
     */
    Unadvise(EventSink) {
