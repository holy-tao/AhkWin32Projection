...
export default struct IInkRecognizers extends IDispatch {
    ...
    */
    ...
    GetDefaultRecognizer(lcid) {
        result := ComCall(9, this, Int32, lcid, "ptr*", &DefaultRecognizer := 0, "HRESULT")
     ...
     */
    Item(Index) {
        result := ComCall(10, this, Int32, Index, "ptr*", &InkRecognizer := 0, "HRESULT")
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetDefaultRecognizer := CallbackCreate(ObjBindMethod(implObj, "GetDefaultRecognizer"), flags, 3)
