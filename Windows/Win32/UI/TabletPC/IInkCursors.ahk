 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkcursors
...
class IInkCursors extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkcursors-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkcursors-item
     */
    Item(Index) {
        result := ComCall(9, this, "int", Index, "ptr*", &Cursor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
