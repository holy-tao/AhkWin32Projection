...
/**
 * . (IInkDisp)
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkdisp
...
class IInkDisp extends IDispatch{
     ...
     * <div> </div>
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-get_strokes
     */
    get_Strokes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-get_extendedproperties
     */
    get_ExtendedProperties() {
        result := ComCall(8, this, "ptr*", &Properties_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-get_dirty
     */
    get_Dirty() {
        result := ComCall(9, this, "short*", &Dirty := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-put_dirty
     */
    put_Dirty(Dirty) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-get_customstrokes
     */
    get_CustomStrokes() {
        result := ComCall(11, this, "ptr*", &ppunkInkCustomStrokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-getboundingbox
     */
    GetBoundingBox(BoundingBoxMode) {
        result := ComCall(12, this, "int", BoundingBoxMode, "ptr*", &Rectangle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-deletestrokes
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-deletestroke
     */
    DeleteStroke(Stroke) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-extractstrokes
     */
    ExtractStrokes(Strokes, ExtractFlags) {
        result := ComCall(15, this, "ptr", Strokes, "int", ExtractFlags, "ptr*", &ExtractedInk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-extractwithrectangle
     */
    ExtractWithRectangle(Rectangle, extractFlags) {
        result := ComCall(16, this, "ptr", Rectangle, "int", extractFlags, "ptr*", &ExtractedInk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-clip
     */
    Clip(Rectangle) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-clone
     */
    Clone() {
        result := ComCall(18, this, "ptr*", &NewInk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-hittestcircle
     */
    HitTestCircle(X, Y, radius) {
        result := ComCall(19, this, "int", X, "int", Y, "float", radius, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-hittestwithrectangle
     */
    HitTestWithRectangle(SelectionRectangle, IntersectPercent) {
        result := ComCall(20, this, "ptr", SelectionRectangle, "float", IntersectPercent, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * For more information about the VARIANT structure, see <a href="https://docs.microsoft.com/windows/desktop/tablet/using-the-com-library">Using the COM Library</a>.
     * @returns {IInkStrokes} When this method returns, contains a pointer to the collection of strokes that makes up the ink.
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-hittestwithlasso
     */
    HitTestWithLasso(Points_, IntersectPercent, LassoPoints) {
        result := ComCall(21, this, "ptr", Points_, "float", IntersectPercent, "ptr", LassoPoints, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-nearestpoint
     */
    NearestPoint(X, Y, PointOnStroke, DistanceFromPacket) {
        ...
        result := ComCall(22, this, "int", X, "int", Y, PointOnStrokeMarshal, PointOnStroke, DistanceFromPacketMarshal, DistanceFromPacket, "ptr*", &Stroke := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-createstrokes
     */
    CreateStrokes(StrokeIds) {
        result := ComCall(23, this, "ptr", StrokeIds, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-addstrokesatrectangle
     */
     ...
     * 
     * For more information about the VARIANT structure, see <a href="https://docs.microsoft.com/windows/desktop/tablet/using-the-com-library">Using the COM Library</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-save
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-load
     */
    Load(Data) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-createstroke
     */
    CreateStroke(PacketData, PacketDescription) {
        result := ComCall(27, this, "ptr", PacketData, "ptr", PacketDescription, "ptr*", &Stroke := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-clipboardcopywithrectangle
     */
    ClipboardCopyWithRectangle(Rectangle, ClipboardFormats, ClipboardModes) {
        result := ComCall(28, this, "ptr", Rectangle, "int", ClipboardFormats, "int", ClipboardModes, "ptr*", &DataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IDataObject} When this method returns, contains a pointer to the newly create data object.
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-clipboardcopy
     */
    ClipboardCopy(strokes, ClipboardFormats, ClipboardModes) {
        result := ComCall(29, this, "ptr", strokes, "int", ClipboardFormats, "int", ClipboardModes, "ptr*", &DataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-canpaste
     */
    CanPaste(DataObject) {
        result := ComCall(30, this, "ptr", DataObject, "short*", &CanPaste := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdisp-clipboardpaste
     */
    ClipboardPaste(x, y, DataObject) {
        result := ComCall(31, this, "int", x, "int", y, "ptr", DataObject, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
