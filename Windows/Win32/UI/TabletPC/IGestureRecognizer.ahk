...
class IGestureRecognizer extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<Int32>} pcStrokes 
     * @returns {HRESULT} 
     */
    get_MaxStrokeCount(pcStrokes) {
        result := ComCall(5, this, "int*", pcStrokes, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Int32>} pGestures 
     * @returns {HRESULT} 
     */
    EnableGestures(cGestures, pGestures) {
        result := ComCall(7, this, "uint", cGestures, "int*", pGestures, "int")
        if(result != 0)
            throw OSError(result)
