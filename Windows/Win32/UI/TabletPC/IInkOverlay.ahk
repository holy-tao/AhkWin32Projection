 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkoverlay
...
class IInkOverlay extends IDispatch{
     ...
     * @returns {Pointer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_hwnd
     */
    get_hWnd() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_hwnd
     */
    put_hWnd(NewWindow) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_enabled
     */
    get_Enabled() {
        result := ComCall(9, this, "short*", &Collecting := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_enabled
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_defaultdrawingattributes
     */
    get_DefaultDrawingAttributes() {
        result := ComCall(11, this, "ptr*", &CurrentAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_renderer
     */
    get_Renderer() {
        result := ComCall(13, this, "ptr*", &CurrentInkRenderer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IInkDisp} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_ink
     */
    get_Ink() {
        result := ComCall(15, this, "ptr*", &Ink_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_autoredraw
     */
    get_AutoRedraw() {
        result := ComCall(17, this, "short*", &AutoRedraw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_autoredraw
     */
     ...
     * <div> </div>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_collectingink
     */
    get_CollectingInk() {
        result := ComCall(19, this, "short*", &Collecting := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ol>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_collectionmode
     */
    get_CollectionMode() {
        result := ComCall(20, this, "int*", &Mode_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Mode_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_collectionmode
     */
    put_CollectionMode(Mode_) {
        result := ComCall(21, this, "int", Mode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_dynamicrendering
     */
    get_DynamicRendering() {
        result := ComCall(22, this, "short*", &Enabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_dynamicrendering
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_desiredpacketdescription
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_desiredpacketdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_mouseicon
     */
    get_MouseIcon() {
        result := ComCall(26, this, "ptr*", &MouseIcon := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_mouseicon
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_mousepointer
     */
    get_MousePointer() {
        result := ComCall(29, this, "int*", &MousePointer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_mousepointer
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_editingmode
     */
    get_EditingMode() {
        result := ComCall(31, this, "int*", &EditingMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_editingmode
     */
     ...
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_selection
     */
    get_Selection() {
        result := ComCall(33, this, "ptr*", &Selection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_selection
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_erasermode
     */
    get_EraserMode() {
        result := ComCall(35, this, "int*", &EraserMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_erasermode
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_eraserwidth
     */
    get_EraserWidth() {
        result := ComCall(37, this, "int*", &EraserWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_eraserwidth
     */
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_attachmode
     */
    get_AttachMode() {
        result := ComCall(39, this, "int*", &AttachMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_attachmode
     */
     ...
     * </ul>
     * @returns {IInkCursors} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_cursors
     */
    get_Cursors() {
        result := ComCall(41, this, "ptr*", &Cursors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_marginx
     */
    get_MarginX() {
        result := ComCall(42, this, "int*", &MarginX := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_marginx
     */
    put_MarginX(MarginX) {
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_marginy
     */
    get_MarginY() {
        result := ComCall(44, this, "int*", &MarginY := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_marginy
     */
    put_MarginY(MarginY) {
     ...
     * @returns {IInkTablet} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_tablet
     */
    get_Tablet() {
        result := ComCall(46, this, "ptr*", &SingleTablet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_supporthighcontrastink
     */
    get_SupportHighContrastInk() {
        result := ComCall(47, this, "short*", &Support := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_supporthighcontrastink
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-get_supporthighcontrastselectionui
     */
     ...
     * @param {VARIANT_BOOL} Support 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-put_supporthighcontrastselectionui
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-hittestselection
     */
    HitTestSelection(x, y) {
        result := ComCall(51, this, "int", x, "int", y, "int*", &SelArea := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IInkRectangle} Rect_ The rectangle on which to draw, in pixel coordinates. When this parameter is <b>NULL</b>, the entire window is redrawn.
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-draw
     */
    Draw(Rect_) {
        result := ComCall(52, this, "ptr", Rect_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-setgesturestatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-getgesturestatus
     */
    GetGestureStatus(Gesture) {
        result := ComCall(54, this, "int", Gesture, "short*", &Listening := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-getwindowinputrectangle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-setwindowinputrectangle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-setalltabletsmode
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-setsingletabletintegratedmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-geteventinterest
     */
    GetEventInterest(EventId) {
        result := ComCall(59, this, "int", EventId, "short*", &Listen := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkoverlay-seteventinterest
     */
