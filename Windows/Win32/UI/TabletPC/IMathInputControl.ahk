 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nn-micaut-imathinputcontrol
...
class IMathInputControl extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-show
     */
    Show() {
     ...
     * Hides the control.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-hide
     */
    Hide() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-isvisible
     */
    IsVisible() {
        result := ComCall(9, this, "short*", &pvbShown := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-getposition
     */
    GetPosition(Left, Top, Right, Bottom) {
        ...
        result := ComCall(10, this, LeftMarshal, Left, TopMarshal, Top, RightMarshal, Right, BottomMarshal, Bottom, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-setposition
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-clear
     */
    Clear() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-setcustompaint
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-setcaptiontext
     */
    SetCaptionText(CaptionText) {
        if(CaptionText is String) {
            pin := BSTR.Alloc(CaptionText)
            CaptionText := pin.Value
        }
     ...
     * @param {IInkDisp} Ink_ The ink object.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-loadink
     */
    LoadInk(Ink_) {
        result := ComCall(15, this, "ptr", Ink_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-setownerwindow
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-enableextendedbuttons
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-getpreviewheight
     */
    GetPreviewHeight() {
        result := ComCall(18, this, "int*", &Height := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-setpreviewheight
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-enableautogrow
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-addfunctionname
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-removefunctionname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/micaut/nf-micaut-imathinputcontrol-gethovericon
     */
    GetHoverIcon() {
        result := ComCall(23, this, "ptr*", &HoverImage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
