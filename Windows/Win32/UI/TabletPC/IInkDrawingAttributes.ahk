...
class IInkDrawingAttributes extends IDispatch{
     ...
     */
    get_Color() {
        result := ComCall(7, this, "int*", &CurrentColor := 0, "int")
        if(result != 0) {
    ...
    /**
     * Gets or sets the y-axis dimension, or width, of the pen tip when drawing ink. (Get)
     * @remarks
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_width
     */
    get_Width() {
        result := ComCall(9, this, "float*", &CurrentWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets the y-axis dimension, or width, of the pen tip when drawing ink. (Put)
     * @remarks
     * If the tablet reports pen pressure (if the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkdrawingattributes-get_ignorepressure">IgnorePressure</a> property is false), the actual width of the ink varies depending on the amount of pressure applied to the drawing surface. When maximum pressure is applied, the width is 150% of the value of the <c>Width</code> property. When minimum pressure is applied, the width is 50% of the value of the <code>Width</c> property. By default, this property is set to true, so that pressure from the pen is reported. To specify that pressure should not be reported (that the width of ink does not change), set the <b>IgnorePressure</b> property to true.
     * 
     * Precision is limited to one one-thousandth of a HIMETRIC unit (three digits to the right of the decimal point). For example, if you specify a value of 2.0006, the most precise measurement is 2.001.
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-put_width
     */
    put_Width(NewWidth) {
    ...
    /**
     * Gets or sets the height of the pen when drawing ink with the InkDrawingAttributes object. (Get)
     * @remarks
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_height
     */
    get_Height() {
        result := ComCall(11, this, "float*", &CurrentHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets the height of the pen when drawing ink with the InkDrawingAttributes object. (Put)
     * @remarks
     * This property applies only to the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/ne-msinkaut-inkpentip">Rectangle</a> pen tip. The value represents the height of the side of the rectangle. If using the <b>Ball</b> pen tip then the height of the pen tip is equal to the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkdrawingattributes-get_width">Width</a> property, and the <b>Height</b> property is ignored.
     * 
     * Precision is limited to 1/1000 (three digits to the right of the decimal point). For example, if you specify a value of 2.0006, the most precise measurement is 2.001.
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-put_height
     */
     ...
     */
    get_FitToCurve() {
        result := ComCall(13, this, "short*", &Flag := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_IgnorePressure() {
        result := ComCall(15, this, "short*", &Flag := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets the value that indicates whether a stroke is antialiased. (Get)
     * @remarks
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_antialiased
     */
    get_AntiAliased() {
        result := ComCall(17, this, "short*", &Flag := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets the value that indicates whether a stroke is antialiased. (Put)
     * @remarks
     * If a stroke is antialiased, the foreground and background colors along the edge of the ink are blended to increase the visible smoothness.
     * 
     * Antialiasing improves the quality of rendering by making ink appear smoother and sharper, especially on lower resolution displays. However, antialiasing incurs added performance. Use it judiciously.
     * @param {VARIANT_BOOL} Flag 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-put_antialiased
     */
    ...
    /**
     * Gets or sets a value that indicates the transparency value of ink. (Get)
     * @remarks
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_transparency
     */
    get_Transparency() {
        result := ComCall(19, this, "int*", &CurrentTransparency := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets a value that indicates the transparency value of ink. (Put)
     * @remarks
     * <div class="alert"><b>Note</b>  The transparent rendering effect may be different between dynamic and static rendering. In dynamic rendering the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/nn-msinkaut-iinkstrokedisp">IInkStrokeDisp</a> object is rendered as it is drawn, as it is in the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkoverlay-get_dynamicrendering">DynamicRendering</a> property, for example. In static rendering, you use the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkrenderer-draw">Draw</a> method of the <a href="https://docs.microsoft.com/windows/desktop/tablet/inkrenderer-class">InkRenderer</a> object to render the <b>IInkStrokeDisp</b> object.</div>
     * <div> </div>
     * @param {Integer} NewTransparency 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-put_transparency
     */
    ...
    /**
     * Gets or sets a value that defines how the colors of the pen and background interact. (Get)
     * @remarks
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_rasteroperation
     */
    get_RasterOperation() {
        result := ComCall(21, this, "int*", &CurrentRasterOperation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets or sets a value that defines how the colors of the pen and background interact. (Put)
     * @remarks
     * The <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/ne-msinkaut-inkrasteroperation">InkRasterOperation</a> enumeration defines values for performing raster operations on drawn ink. For example, if you want to perform subtractive transparency, set the raster value to MaskPen.
     * 
     * For a complete list of available raster operations, see the <a href="https://docs.microsoft.com/windows/desktop/api/msinkaut/ne-msinkaut-inkrasteroperation">InkRasterOperation</a> enumeration type.
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-put_rasteroperation
     */
     ...
     */
    get_PenTip() {
        result := ComCall(23, this, "int*", &CurrentPenTip := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets the collection of application-defined data that are stored in an object. (IInkDrawingAttributes.get_ExtendedProperties)
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-get_extendedproperties
     */
    get_ExtendedProperties() {
        result := ComCall(25, this, "ptr*", &Properties_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkdrawingattributes-clone
     */
    Clone() {
        result := ComCall(26, this, "ptr*", &DrawingAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
