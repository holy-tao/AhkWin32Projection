...
export default struct IInkDrawingAttributes extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_FitToCurve := CallbackCreate(ObjBindMethod(implObj, "get_FitToCurve"), flags, 2)
        this.vtbl.put_FitToCurve := CallbackCreate(ObjBindMethod(implObj, "put_FitToCurve"), flags, 2)
        this.vtbl.get_IgnorePressure := CallbackCreate(ObjBindMethod(implObj, "get_IgnorePressure"), flags, 2)
        this.vtbl.put_IgnorePressure := CallbackCreate(ObjBindMethod(implObj, "put_IgnorePressure"), flags, 2)
        this.vtbl.get_AntiAliased := CallbackCreate(ObjBindMethod(implObj, "get_AntiAliased"), flags, 2)
        this.vtbl.put_AntiAliased := CallbackCreate(ObjBindMethod(implObj, "put_AntiAliased"), flags, 2)
        this.vtbl.get_Transparency := CallbackCreate(ObjBindMethod(implObj, "get_Transparency"), flags, 2)
        this.vtbl.put_Transparency := CallbackCreate(ObjBindMethod(implObj, "put_Transparency"), flags, 2)
        this.vtbl.get_RasterOperation := CallbackCreate(ObjBindMethod(implObj, "get_RasterOperation"), flags, 2)
        this.vtbl.put_RasterOperation := CallbackCreate(ObjBindMethod(implObj, "put_RasterOperation"), flags, 2)
        this.vtbl.get_PenTip := CallbackCreate(ObjBindMethod(implObj, "get_PenTip"), flags, 2)
        this.vtbl.put_PenTip := CallbackCreate(ObjBindMethod(implObj, "put_PenTip"), flags, 2)
