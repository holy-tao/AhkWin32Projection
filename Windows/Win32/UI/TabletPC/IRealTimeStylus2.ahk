 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nn-rtscom-irealtimestylus2
...
class IRealTimeStylus2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-irealtimestylus2-get_flicksenabled
     */
    get_FlicksEnabled() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rtscom/nf-rtscom-irealtimestylus2-put_flicksenabled
     */
