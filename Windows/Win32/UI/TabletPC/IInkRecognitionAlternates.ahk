 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkrecognitionalternates
...
class IInkRecognitionAlternates extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternates-get_count
     */
    get_Count() {
     ...
     * <div> </div>
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternates-get_strokes
     */
    get_Strokes() {
        result := ComCall(9, this, "ptr*", &Strokes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognitionalternates-item
     */
    Item(Index) {
        result := ComCall(10, this, "int", Index, "ptr*", &InkRecoAlternate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
