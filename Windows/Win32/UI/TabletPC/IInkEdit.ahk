...
/**
 * . (IInkEdit)
 * @see https://learn.microsoft.com/windows/win32/api//content/inked/nn-inked-iinkedit
...
class IInkEdit extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_status
     */
    get_Status() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_usemouseforinput
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_usemouseforinput
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_inkmode
     */
    get_InkMode() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_inkmode
     */
    put_InkMode(newVal) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_inkinsertmode
     */
    get_InkInsertMode() {
     ...
     * @param {Integer} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_inkinsertmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_drawingattributes
     */
    get_DrawingAttributes() {
        result := ComCall(14, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-putref_drawingattributes
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_recognitiontimeout
     */
     ...
     * @param {Integer} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_recognitiontimeout
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_recognizer
     */
    get_Recognizer() {
     ...
     * @param {IInkRecognizer} newVal Type: **[IInkRecognizer](../msinkaut/nn-msinkaut-iinkrecognizer.md)\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-putref_recognizer
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_factoid
     */
    get_Factoid() {
        pVal := BSTR()
     ...
     * @param {BSTR} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_factoid
     */
    put_Factoid(newVal) {
        if(newVal is String) {
     ...
     * This property is run time only.
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selinks
     */
    get_SelInks() {
        pSelInk := VARIANT()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selinks
     */
    put_SelInks(SelInk) {
     ...
     * This property is run time only.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selinksdisplaymode
     */
    get_SelInksDisplayMode() {
        result := ComCall(24, this, "int*", &pInkDisplayMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @remarks
     * This property is run time only.
     * @param {Integer} InkDisplayMode_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selinksdisplaymode
     */
    put_SelInksDisplayMode(InkDisplayMode_) {
        result := ComCall(25, this, "int", InkDisplayMode_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-recognize
     */
    Recognize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-getgesturestatus
     */
    GetGestureStatus(Gesture) {
        result := ComCall(27, this, "int", Gesture, "short*", &pListen := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-setgesturestatus
     */
     ...
     * @param {Integer} clr 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_backcolor
     */
    put_BackColor(clr) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_backcolor
     */
    get_BackColor() {
        result := ComCall(30, this, "uint*", &pclr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_appearance
     */
    get_Appearance() {
        result := ComCall(31, this, "int*", &pAppearance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_appearance
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_borderstyle
     */
    get_BorderStyle() {
        result := ComCall(33, this, "int*", &pBorderStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_borderstyle
     */
     ...
     * <div> </div>
     * @returns {OLE_HANDLE} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_hwnd
     */
    get_Hwnd() {
        pohHwnd := OLE_HANDLE()
     ...
     * @returns {IFontDisp} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_font
     */
    get_Font() {
        result := ComCall(36, this, "ptr*", &ppFont := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IFontDisp} ppFont Type: **[IFontDisp](../ocidl/nn-ocidl-ifontdisp.md)\*\***
     * 
     * The pointer to an [IFontDisp interface](../ocidl/nn-ocidl-ifontdisp.md) object.
     * @returns {HRESULT} If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-putref_font
     */
    putref_Font(ppFont) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_text
     */
    get_Text() {
        pbstrText := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_text
     */
    put_Text(pbstrText) {
        if(pbstrText is String) {
            pin := BSTR.Alloc(pbstrText)
            pbstrText := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_mouseicon
     */
    get_MouseIcon() {
        result := ComCall(40, this, "ptr*", &MouseIcon := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_mouseicon
     */
     ...
     * @param {IPictureDisp} MouseIcon Type: **[IPictureDisp interface](../ocidl/nn-ocidl-ipicturedisp.md)**
     * 
     * An [IPictureDisp interface](../ocidl/nn-ocidl-ipicturedisp.md) object.
     * @returns {HRESULT} If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-putref_mouseicon
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_mousepointer
     */
    get_MousePointer() {
        result := ComCall(43, this, "int*", &MousePointer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_mousepointer
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_locked
     */
    get_Locked() {
        result := ComCall(45, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_locked
     */
    put_Locked(newVal) {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_enabled
     */
    get_Enabled() {
        result := ComCall(47, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_enabled
     */
    put_Enabled(newVal) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_maxlength
     */
    get_MaxLength() {
        result := ComCall(49, this, "int*", &plMaxLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_maxlength
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_multiline
     */
    get_MultiLine() {
        result := ComCall(51, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_multiline
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_scrollbars
     */
    get_ScrollBars() {
     ...
     * @param {Integer} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_scrollbars
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_disablenoscroll
     */
    get_DisableNoScroll() {
        result := ComCall(55, this, "short*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_disablenoscroll
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selalignment
     */
    get_SelAlignment() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selalignment
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selbold
     */
    get_SelBold() {
        pvarSelBold := VARIANT()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selbold
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selitalic
     */
    get_SelItalic() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selitalic
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selunderline
     */
    get_SelUnderline() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selunderline
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selcolor
     */
    get_SelColor() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selcolor
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selfontname
     */
    get_SelFontName() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selfontname
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selfontsize
     */
    get_SelFontSize() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selfontsize
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selcharoffset
     */
    get_SelCharOffset() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selcharoffset
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_textrtf
     */
    get_TextRTF() {
        pbstrTextRTF := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_textrtf
     */
    put_TextRTF(pbstrTextRTF) {
        if(pbstrTextRTF is String) {
            pin := BSTR.Alloc(pbstrTextRTF)
            pbstrTextRTF := pin.Value
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selstart
     */
    get_SelStart() {
        result := ComCall(75, this, "int*", &plSelStart := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selstart
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_sellength
     */
    get_SelLength() {
        result := ComCall(77, this, "int*", &plSelLength := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_sellength
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_seltext
     */
    get_SelText() {
        pbstrSelText := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_seltext
     */
    put_SelText(pbstrSelText) {
        if(pbstrSelText is String) {
            pin := BSTR.Alloc(pbstrSelText)
            pbstrSelText := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-get_selrtf
     */
    get_SelRTF() {
        pbstrSelRTF := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-put_selrtf
     */
    put_SelRTF(pbstrSelRTF) {
        if(pbstrSelRTF is String) {
            pin := BSTR.Alloc(pbstrSelRTF)
            pbstrSelRTF := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inked/nf-inked-iinkedit-refresh
     */
    Refresh() {
