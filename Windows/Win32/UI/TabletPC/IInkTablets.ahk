 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinktablets
...
class IInkTablets extends IDispatch{
     ...
     * <div> </div>
     * @returns {IInkTablet} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinktablets-get_defaulttablet
     */
    get_DefaultTablet() {
        result := ComCall(9, this, "ptr*", &DefaultTablet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinktablets-item
     */
    Item(Index) {
        result := ComCall(10, this, "int", Index, "ptr*", &Tablet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinktablets-ispacketpropertysupported
     */
