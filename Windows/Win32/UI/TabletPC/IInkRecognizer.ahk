 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkrecognizer
...
class IInkRecognizer extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-get_vendor
     */
    get_Vendor() {
        Vendor := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-get_capabilities
     */
    get_Capabilities() {
        result := ComCall(9, this, "int*", &CapabilitiesFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-get_languages
     */
    get_Languages() {
        Languages := VARIANT()
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-get_supportedproperties
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-get_preferredpacketdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkrecognizer-createrecognizercontext
     */
    CreateRecognizerContext() {
        result := ComCall(13, this, "ptr*", &Context_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IInkRecognizerContext(Context_)
    }
}
