...
/**
 * . (IInkPicture)
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nn-msinkaut-iinkpicture
...
class IInkPicture extends IDispatch{
     ...
     * @returns {Pointer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_hwnd
     */
    get_hWnd() {
        result := ComCall(7, this, "ptr*", &CurrentWindow := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_defaultdrawingattributes
     */
    get_DefaultDrawingAttributes() {
        result := ComCall(8, this, "ptr*", &CurrentAttributes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkcollector-putref_defaultdrawingattributes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_renderer
     */
    get_Renderer() {
        result := ComCall(10, this, "ptr*", &CurrentInkRenderer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IInkDisp} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_ink
     */
    get_Ink() {
        result := ComCall(12, this, "ptr*", &Ink_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_autoredraw
     */
    get_AutoRedraw() {
        result := ComCall(14, this, "short*", &AutoRedraw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_autoredraw
     */
     ...
     * <div> </div>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_collectingink
     */
    get_CollectingInk() {
        result := ComCall(16, this, "short*", &Collecting := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_collectionmode
     */
    get_CollectionMode() {
     ...
     * @param {Integer} Mode_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_collectionmode
     */
    put_CollectionMode(Mode_) {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_dynamicrendering
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_dynamicrendering
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_desiredpacketdescription
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_desiredpacketdescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_mouseicon
     */
    get_MouseIcon() {
        result := ComCall(23, this, "ptr*", &MouseIcon := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_mouseicon
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_mousepointer
     */
    get_MousePointer() {
        result := ComCall(26, this, "int*", &MousePointer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_mousepointer
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_editingmode
     */
    get_EditingMode() {
        result := ComCall(28, this, "int*", &EditingMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_editingmode
     */
     ...
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_selection
     */
    get_Selection() {
        result := ComCall(30, this, "ptr*", &Selection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_selection
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_erasermode
     */
    get_EraserMode() {
        result := ComCall(32, this, "int*", &EraserMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_erasermode
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_eraserwidth
     */
    get_EraserWidth() {
        result := ComCall(34, this, "int*", &EraserWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_eraserwidth
     */
     ...
     * @param {IPictureDisp} pPicture 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_picture
     */
     ...
     * @returns {IPictureDisp} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_picture
     */
    get_Picture() {
        result := ComCall(38, this, "ptr*", &ppPicture := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_sizemode
     */
     ...
     * Using the <b>IPSM_AutoSize</b> value causes the control to resize to always fit the picture. Using the <b>IPSM_CenterImage</b> value causes the picture to be centered in the control.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_sizemode
     */
    get_SizeMode() {
        result := ComCall(40, this, "int*", &smSizeMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_backcolor
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_backcolor
     */
    get_BackColor() {
        result := ComCall(42, this, "uint*", &pColor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {IInkCursors} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_cursors
     */
    get_Cursors() {
        result := ComCall(43, this, "ptr*", &Cursors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_marginx
     */
    get_MarginX() {
        result := ComCall(44, this, "int*", &MarginX := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_marginx
     */
    put_MarginX(MarginX) {
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_marginy
     */
    get_MarginY() {
        result := ComCall(46, this, "int*", &MarginY := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_marginy
     */
    put_MarginY(MarginY) {
     ...
     * @returns {IInkTablet} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_tablet
     */
    get_Tablet() {
        result := ComCall(48, this, "ptr*", &SingleTablet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_supporthighcontrastink
     */
    get_SupportHighContrastInk() {
        result := ComCall(49, this, "short*", &Support := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_supporthighcontrastink
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_supporthighcontrastselectionui
     */
    get_SupportHighContrastSelectionUI() {
        result := ComCall(51, this, "short*", &Support := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {VARIANT_BOOL} Support 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_supporthighcontrastselectionui
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-hittestselection
     */
    HitTestSelection(x, y) {
        result := ComCall(53, this, "int", x, "int", y, "int*", &SelArea := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-setgesturestatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-getgesturestatus
     */
    GetGestureStatus(Gesture) {
        result := ComCall(55, this, "int", Gesture, "short*", &Listening := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-getwindowinputrectangle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-setwindowinputrectangle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-setalltabletsmode
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-setsingletabletintegratedmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-geteventinterest
     */
    GetEventInterest(EventId) {
        result := ComCall(60, this, "int", EventId, "short*", &Listen := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-seteventinterest
     */
     ...
     * </ol>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_inkenabled
     */
    get_InkEnabled() {
        result := ComCall(62, this, "short*", &Collecting := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_inkenabled
     */
     ...
     * <div> </div>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-get_enabled
     */
    get_Enabled() {
        result := ComCall(64, this, "short*", &pbool := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut/nf-msinkaut-iinkpicture-put_enabled
     */
    put_Enabled(vbool) {
