...
/**
 * . (IInkDivider)
 * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nn-msinkaut15-iinkdivider
...
class IInkDivider extends IDispatch{
     ...
     * <div> </div>
     * @returns {IInkStrokes} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-get_strokes
     */
    get_Strokes() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-putref_strokes
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-get_recognizercontext
     */
    get_RecognizerContext() {
        result := ComCall(9, this, "ptr*", &RecognizerContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-putref_recognizercontext
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-get_lineheight
     */
    get_LineHeight() {
        result := ComCall(11, this, "int*", &LineHeight := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-put_lineheight
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msinkaut15/nf-msinkaut15-iinkdivider-divide
     */
    Divide() {
        result := ComCall(13, this, "ptr*", &InkDivisionResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
