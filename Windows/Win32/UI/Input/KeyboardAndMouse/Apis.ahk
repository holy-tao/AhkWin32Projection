 ...
 * @since windows5.0
 */
export _TrackMouseEvent(lpEventTrack) {
    result := DllCall("COMCTL32.dll\_TrackMouseEvent", TRACKMOUSEEVENT_struct.Ptr, lpEventTrack, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export LoadKeyboardLayoutA(pwszKLID, Flags) {
    pwszKLID := pwszKLID is String ? StrPtr(pwszKLID) : pwszKLID

    A_LastError := 0

    result := DllCall("USER32.dll\LoadKeyboardLayoutA", "ptr", pwszKLID, ACTIVATE_KEYBOARD_LAYOUT_FLAGS, Flags, HKL.Owned)
    if(A_LastError) {
 ...
 * @since windows5.0
 */
export LoadKeyboardLayoutW(pwszKLID, Flags) {
    pwszKLID := pwszKLID is String ? StrPtr(pwszKLID) : pwszKLID

    A_LastError := 0

    result := DllCall("USER32.dll\LoadKeyboardLayoutW", "ptr", pwszKLID, ACTIVATE_KEYBOARD_LAYOUT_FLAGS, Flags, HKL.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export ActivateKeyboardLayout(_hkl, Flags) {
    A_LastError := 0

    result := DllCall("USER32.dll\ActivateKeyboardLayout", HKL, _hkl, ACTIVATE_KEYBOARD_LAYOUT_FLAGS, Flags, HKL.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export UnloadKeyboardLayout(_hkl) {
    A_LastError := 0

    result := DllCall("USER32.dll\UnloadKeyboardLayout", HKL, _hkl, BOOL)
 ...
 * @since windows5.0
 */
export GetKeyboardLayoutNameA(pwszKLID) {
    pwszKLID := pwszKLID is String ? StrPtr(pwszKLID) : pwszKLID

    A_LastError := 0

    result := DllCall("USER32.dll\GetKeyboardLayoutNameA", "ptr", pwszKLID, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export GetKeyboardLayoutNameW(pwszKLID) {
    pwszKLID := pwszKLID is String ? StrPtr(pwszKLID) : pwszKLID

    A_LastError := 0

    result := DllCall("USER32.dll\GetKeyboardLayoutNameW", "ptr", pwszKLID, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export TrackMouseEvent(lpEventTrack) {
    A_LastError := 0

    result := DllCall("USER32.dll\TrackMouseEvent", TRACKMOUSEEVENT_struct.Ptr, lpEventTrack, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export SwapMouseButton(fSwap) {
    result := DllCall("USER32.dll\SwapMouseButton", BOOL, fSwap, BOOL)
    return result
}
...
export GetDoubleClickTime() {
    result := DllCall("USER32.dll\GetDoubleClickTime", UInt32)
    return result
}
...
export GetActiveWindow() {
    result := DllCall("USER32.dll\GetActiveWindow", HWND)
    return result
}
 ...
 */
export GetFocus() {
    result := DllCall("USER32.dll\GetFocus", HWND)
    return result
}
...
export GetKBCodePage() {
    result := DllCall("USER32.dll\GetKBCodePage", UInt32)
    return result
}
...
export GetKeyboardState(lpKeyState) {
    ...
    result := DllCall("USER32.dll\GetKeyboardState", lpKeyStateMarshal, lpKeyState, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export SetKeyboardState(lpKeyState) {
    ...
    result := DllCall("USER32.dll\SetKeyboardState", lpKeyStateMarshal, lpKeyState, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export GetKeyNameTextA(_lParam, lpString, cchSize) {
 ...
 * @since windows5.0
 */
export GetKeyNameTextW(_lParam, lpString, cchSize) {
    lpString := lpString is String ? StrPtr(lpString) : lpString
 ...
 * @since windows5.0
 */
export VkKeyScanA(ch) {
    result := DllCall("USER32.dll\VkKeyScanA", CHAR, ch, Int16)
    return result
}
 ...
 * @since windows5.0
 */
export VkKeyScanExA(ch, dwhkl) {
    result := DllCall("USER32.dll\VkKeyScanExA", CHAR, ch, HKL, dwhkl, Int16)
    return result
}
 ...
 * @since windows5.0
 */
export GetLastInputInfo(plii) {
    result := DllCall("USER32.dll\GetLastInputInfo", LASTINPUTINFO.Ptr, plii, BOOL)
    return result
}
 ...
 */
export GetCapture() {
    result := DllCall("USER32.dll\GetCapture", HWND)
    return result
}
 ...
 * @since windows5.0
 */
export SetCapture(_hWnd) {
    result := DllCall("USER32.dll\SetCapture", HWND, _hWnd, HWND)
    return result
}
...
export ReleaseCapture() {
    ...
    result := DllCall("USER32.dll\ReleaseCapture", BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export EnableWindow(_hWnd, bEnable) {
    result := DllCall("USER32.dll\EnableWindow", HWND, _hWnd, BOOL, bEnable, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export IsWindowEnabled(_hWnd) {
    result := DllCall("USER32.dll\IsWindowEnabled", HWND, _hWnd, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DragDetect(_hwnd, pt) {
    result := DllCall("USER32.dll\DragDetect", HWND, _hwnd, POINT, pt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetActiveWindow(_hWnd) {
    A_LastError := 0

    result := DllCall("USER32.dll\SetActiveWindow", HWND, _hWnd, HWND)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export BlockInput(fBlockIt) {
    A_LastError := 0

    result := DllCall("USER32.dll\BlockInput", BOOL, fBlockIt, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
