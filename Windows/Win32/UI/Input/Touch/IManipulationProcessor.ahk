...
export default struct IManipulationProcessor extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_SupportedManipulations := CallbackCreate(ObjBindMethod(implObj, "get_SupportedManipulations"), flags, 2)
        this.vtbl.put_SupportedManipulations := CallbackCreate(ObjBindMethod(implObj, "put_SupportedManipulations"), flags, 2)
        this.vtbl.get_PivotPointX := CallbackCreate(ObjBindMethod(implObj, "get_PivotPointX"), flags, 2)
        this.vtbl.put_PivotPointX := CallbackCreate(ObjBindMethod(implObj, "put_PivotPointX"), flags, 2)
        this.vtbl.get_PivotPointY := CallbackCreate(ObjBindMethod(implObj, "get_PivotPointY"), flags, 2)
        this.vtbl.put_PivotPointY := CallbackCreate(ObjBindMethod(implObj, "put_PivotPointY"), flags, 2)
        this.vtbl.get_PivotRadius := CallbackCreate(ObjBindMethod(implObj, "get_PivotRadius"), flags, 2)
        this.vtbl.put_PivotRadius := CallbackCreate(ObjBindMethod(implObj, "put_PivotRadius"), flags, 2)
        this.vtbl.CompleteManipulation := CallbackCreate(ObjBindMethod(implObj, "CompleteManipulation"), flags, 1)
        this.vtbl.ProcessDown := CallbackCreate(ObjBindMethod(implObj, "ProcessDown"), flags, 4)
        this.vtbl.ProcessMove := CallbackCreate(ObjBindMethod(implObj, "ProcessMove"), flags, 4)
        this.vtbl.ProcessUp := CallbackCreate(ObjBindMethod(implObj, "ProcessUp"), flags, 4)
        this.vtbl.ProcessDownWithTime := CallbackCreate(ObjBindMethod(implObj, "ProcessDownWithTime"), flags, 5)
        this.vtbl.ProcessMoveWithTime := CallbackCreate(ObjBindMethod(implObj, "ProcessMoveWithTime"), flags, 5)
        this.vtbl.ProcessUpWithTime := CallbackCreate(ObjBindMethod(implObj, "ProcessUpWithTime"), flags, 5)
        this.vtbl.GetVelocityX := CallbackCreate(ObjBindMethod(implObj, "GetVelocityX"), flags, 2)
        this.vtbl.GetVelocityY := CallbackCreate(ObjBindMethod(implObj, "GetVelocityY"), flags, 2)
        this.vtbl.GetExpansionVelocity := CallbackCreate(ObjBindMethod(implObj, "GetExpansionVelocity"), flags, 2)
        this.vtbl.GetAngularVelocity := CallbackCreate(ObjBindMethod(implObj, "GetAngularVelocity"), flags, 2)
        this.vtbl.get_MinimumScaleRotateRadius := CallbackCreate(ObjBindMethod(implObj, "get_MinimumScaleRotateRadius"), flags, 2)
        this.vtbl.put_MinimumScaleRotateRadius := CallbackCreate(ObjBindMethod(implObj, "put_MinimumScaleRotateRadius"), flags, 2)
    }
