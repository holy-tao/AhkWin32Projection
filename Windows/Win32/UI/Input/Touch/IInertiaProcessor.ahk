...
export default struct IInertiaProcessor extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_InitialOriginX := CallbackCreate(ObjBindMethod(implObj, "get_InitialOriginX"), flags, 2)
        this.vtbl.put_InitialOriginX := CallbackCreate(ObjBindMethod(implObj, "put_InitialOriginX"), flags, 2)
        this.vtbl.get_InitialOriginY := CallbackCreate(ObjBindMethod(implObj, "get_InitialOriginY"), flags, 2)
        this.vtbl.put_InitialOriginY := CallbackCreate(ObjBindMethod(implObj, "put_InitialOriginY"), flags, 2)
        this.vtbl.get_InitialVelocityX := CallbackCreate(ObjBindMethod(implObj, "get_InitialVelocityX"), flags, 2)
        this.vtbl.put_InitialVelocityX := CallbackCreate(ObjBindMethod(implObj, "put_InitialVelocityX"), flags, 2)
        this.vtbl.get_InitialVelocityY := CallbackCreate(ObjBindMethod(implObj, "get_InitialVelocityY"), flags, 2)
        this.vtbl.put_InitialVelocityY := CallbackCreate(ObjBindMethod(implObj, "put_InitialVelocityY"), flags, 2)
        this.vtbl.get_InitialAngularVelocity := CallbackCreate(ObjBindMethod(implObj, "get_InitialAngularVelocity"), flags, 2)
        this.vtbl.put_InitialAngularVelocity := CallbackCreate(ObjBindMethod(implObj, "put_InitialAngularVelocity"), flags, 2)
        this.vtbl.get_InitialExpansionVelocity := CallbackCreate(ObjBindMethod(implObj, "get_InitialExpansionVelocity"), flags, 2)
        this.vtbl.put_InitialExpansionVelocity := CallbackCreate(ObjBindMethod(implObj, "put_InitialExpansionVelocity"), flags, 2)
        this.vtbl.get_InitialRadius := CallbackCreate(ObjBindMethod(implObj, "get_InitialRadius"), flags, 2)
        this.vtbl.put_InitialRadius := CallbackCreate(ObjBindMethod(implObj, "put_InitialRadius"), flags, 2)
        this.vtbl.get_BoundaryLeft := CallbackCreate(ObjBindMethod(implObj, "get_BoundaryLeft"), flags, 2)
        this.vtbl.put_BoundaryLeft := CallbackCreate(ObjBindMethod(implObj, "put_BoundaryLeft"), flags, 2)
        this.vtbl.get_BoundaryTop := CallbackCreate(ObjBindMethod(implObj, "get_BoundaryTop"), flags, 2)
        this.vtbl.put_BoundaryTop := CallbackCreate(ObjBindMethod(implObj, "put_BoundaryTop"), flags, 2)
        this.vtbl.get_BoundaryRight := CallbackCreate(ObjBindMethod(implObj, "get_BoundaryRight"), flags, 2)
        this.vtbl.put_BoundaryRight := CallbackCreate(ObjBindMethod(implObj, "put_BoundaryRight"), flags, 2)
        this.vtbl.get_BoundaryBottom := CallbackCreate(ObjBindMethod(implObj, "get_BoundaryBottom"), flags, 2)
        this.vtbl.put_BoundaryBottom := CallbackCreate(ObjBindMethod(implObj, "put_BoundaryBottom"), flags, 2)
        this.vtbl.get_ElasticMarginLeft := CallbackCreate(ObjBindMethod(implObj, "get_ElasticMarginLeft"), flags, 2)
        this.vtbl.put_ElasticMarginLeft := CallbackCreate(ObjBindMethod(implObj, "put_ElasticMarginLeft"), flags, 2)
        this.vtbl.get_ElasticMarginTop := CallbackCreate(ObjBindMethod(implObj, "get_ElasticMarginTop"), flags, 2)
        this.vtbl.put_ElasticMarginTop := CallbackCreate(ObjBindMethod(implObj, "put_ElasticMarginTop"), flags, 2)
        this.vtbl.get_ElasticMarginRight := CallbackCreate(ObjBindMethod(implObj, "get_ElasticMarginRight"), flags, 2)
        this.vtbl.put_ElasticMarginRight := CallbackCreate(ObjBindMethod(implObj, "put_ElasticMarginRight"), flags, 2)
        this.vtbl.get_ElasticMarginBottom := CallbackCreate(ObjBindMethod(implObj, "get_ElasticMarginBottom"), flags, 2)
        this.vtbl.put_ElasticMarginBottom := CallbackCreate(ObjBindMethod(implObj, "put_ElasticMarginBottom"), flags, 2)
        this.vtbl.get_DesiredDisplacement := CallbackCreate(ObjBindMethod(implObj, "get_DesiredDisplacement"), flags, 2)
        this.vtbl.put_DesiredDisplacement := CallbackCreate(ObjBindMethod(implObj, "put_DesiredDisplacement"), flags, 2)
        this.vtbl.get_DesiredRotation := CallbackCreate(ObjBindMethod(implObj, "get_DesiredRotation"), flags, 2)
        this.vtbl.put_DesiredRotation := CallbackCreate(ObjBindMethod(implObj, "put_DesiredRotation"), flags, 2)
        this.vtbl.get_DesiredExpansion := CallbackCreate(ObjBindMethod(implObj, "get_DesiredExpansion"), flags, 2)
        this.vtbl.put_DesiredExpansion := CallbackCreate(ObjBindMethod(implObj, "put_DesiredExpansion"), flags, 2)
        this.vtbl.get_DesiredDeceleration := CallbackCreate(ObjBindMethod(implObj, "get_DesiredDeceleration"), flags, 2)
        this.vtbl.put_DesiredDeceleration := CallbackCreate(ObjBindMethod(implObj, "put_DesiredDeceleration"), flags, 2)
        this.vtbl.get_DesiredAngularDeceleration := CallbackCreate(ObjBindMethod(implObj, "get_DesiredAngularDeceleration"), flags, 2)
        this.vtbl.put_DesiredAngularDeceleration := CallbackCreate(ObjBindMethod(implObj, "put_DesiredAngularDeceleration"), flags, 2)
        this.vtbl.get_DesiredExpansionDeceleration := CallbackCreate(ObjBindMethod(implObj, "get_DesiredExpansionDeceleration"), flags, 2)
        this.vtbl.put_DesiredExpansionDeceleration := CallbackCreate(ObjBindMethod(implObj, "put_DesiredExpansionDeceleration"), flags, 2)
        this.vtbl.get_InitialTimestamp := CallbackCreate(ObjBindMethod(implObj, "get_InitialTimestamp"), flags, 2)
        this.vtbl.put_InitialTimestamp := CallbackCreate(ObjBindMethod(implObj, "put_InitialTimestamp"), flags, 2)
        this.vtbl.Reset := CallbackCreate(ObjBindMethod(implObj, "Reset"), flags, 1)
        this.vtbl.Process := CallbackCreate(ObjBindMethod(implObj, "Process"), flags, 2)
        this.vtbl.ProcessTime := CallbackCreate(ObjBindMethod(implObj, "ProcessTime"), flags, 3)
        this.vtbl.Complete := CallbackCreate(ObjBindMethod(implObj, "Complete"), flags, 1)
        this.vtbl.CompleteTime := CallbackCreate(ObjBindMethod(implObj, "CompleteTime"), flags, 2)
    }
