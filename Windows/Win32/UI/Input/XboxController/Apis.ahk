 ...
 */
export XInputEnable(enable) {
    DllCall("xinput1_4.dll\XInputEnable", BOOL, enable)
}
 ...
 */
export XInputGetAudioDeviceIds(dwUserIndex, pRenderDeviceId, pRenderCount, pCaptureDeviceId, pCaptureCount) {
