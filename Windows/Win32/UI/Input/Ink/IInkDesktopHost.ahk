 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/inkpresenterdesktop/nn-inkpresenterdesktop-iinkdesktophost
...
class IInkDesktopHost extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inkpresenterdesktop/nf-inkpresenterdesktop-iinkdesktophost-queueworkitem
     */
     ...
     * @returns {Pointer<Pointer<Void>>} Address of a pointer variable that receives the interface pointer identified by <i>riid</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/inkpresenterdesktop/nf-inkpresenterdesktop-iinkdesktophost-createinkpresenter
     */
     ...
     * @param {Pointer<Guid>} riid A reference to the interface identifier of an <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/inkpresenterdesktop/nn-inkpresenterdesktop-iinkpresenterdesktop">IInkPresenterDesktop</a> object.
     * @returns {Pointer<Pointer<Void>>} Address of a pointer variable that receives the interface pointer identified by <i>riid</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/inkpresenterdesktop/nf-inkpresenterdesktop-iinkdesktophost-createandinitializeinkpresenter
     */
    CreateAndInitializeInkPresenter(rootVisual, width, height, riid) {
        result := ComCall(5, this, "ptr", rootVisual, "float", width, "float", height, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
