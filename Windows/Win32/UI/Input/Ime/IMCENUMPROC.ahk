...
/**
 * IMCENUMPROC (imm.h) is an application-defined callback function that processes input contexts provided by the ImmEnumInputContext function.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/nc-imm-imcenumproc
 * @namespace Windows.Win32.UI.Input.Ime
 * @version v4.0.30319
 */
class IMCENUMPROC extends IUnknown {
