...
/**
 * The IMEMENUITEMINFOA (ANSI) structure (imm.h) contains information about IME menu items.
 * @remarks
 * > [!NOTE]
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/ns-imm-imemenuiteminfoa
