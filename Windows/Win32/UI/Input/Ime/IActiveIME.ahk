...
class IActiveIME extends IUnknown{
     ...
     * @param {Pointer<UInt32>} pdwPrivate 
     * @returns {HRESULT} 
     */
    Inquire(dwSystemInfoFlags, pIMEInfo, szWndClass, pdwPrivate) {
        szWndClass := szWndClass is String ? StrPtr(szWndClass) : szWndClass

        result := ComCall(3, this, "uint", dwSystemInfoFlags, "ptr", pIMEInfo, "ptr", szWndClass, "uint*", pdwPrivate, "int")
        if(result != 0)
    ...
    ConversionList(hIMC, szSource, uFlag, uBufLen, pDest, puCopied) {
        ...
        result := ComCall(4, this, "ptr", hIMC, "ptr", szSource, "uint", uFlag, "uint", uBufLen, "ptr", pDest, "uint*", puCopied, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Configure(hKL, hWnd, dwMode, pRegisterWord) {
        ...
        result := ComCall(5, this, "ptr", hKL, "ptr", hWnd, "uint", dwMode, "ptr", pRegisterWord, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Escape(hIMC, uEscape, pData, plResult) {
        ...
        result := ComCall(7, this, "ptr", hIMC, "uint", uEscape, "ptr", pData, "ptr", plResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetActiveContext(hIMC, fFlag) {
        ...
        result := ComCall(8, this, "ptr", hIMC, "int", fFlag, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Byte>} pbKeyState 
     * @returns {HRESULT} 
     */
    ProcessKey(hIMC, uVirKey, lParam, pbKeyState) {
        hIMC := hIMC is Win32Handle ? NumGet(hIMC, "ptr") : hIMC

        result := ComCall(9, this, "ptr", hIMC, "uint", uVirKey, "uint", lParam, "char*", pbKeyState, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Notify(hIMC, dwAction, dwIndex, dwValue) {
        ...
        result := ComCall(10, this, "ptr", hIMC, "uint", dwAction, "uint", dwIndex, "uint", dwValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Select(hIMC, fSelect) {
        ...
        result := ComCall(11, this, "ptr", hIMC, "int", fSelect, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetCompositionString(hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen) {
        ...
        result := ComCall(12, this, "ptr", hIMC, "uint", dwIndex, "ptr", pComp, "uint", dwCompLen, "ptr", pRead, "uint", dwReadLen, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HIMC} hIMC 
     * @param {Pointer<UInt32>} pdwTransBuf 
    ...
    ToAsciiEx(uVirKey, uScanCode, pbKeyState, fuState, hIMC, pdwTransBuf, puSize) {
        ...
        result := ComCall(13, this, "uint", uVirKey, "uint", uScanCode, "char*", pbKeyState, "uint", fuState, "ptr", hIMC, "uint*", pdwTransBuf, "uint*", puSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} puBufSize 
     * @returns {HRESULT} 
     */
    GetRegisterWordStyle(nItem, pStyleBuf, puBufSize) {
        result := ComCall(16, this, "uint", nItem, "ptr", pStyleBuf, "uint*", puBufSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumRegisterWord(szReading, dwStyle, szRegister, pData, ppEnum) {
        ...
        result := ComCall(17, this, "ptr", szReading, "uint", dwStyle, "ptr", szRegister, "ptr", pData, "ptr", ppEnum, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCodePageA(uCodePage) {
        result := ComCall(18, this, "uint*", uCodePage, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetLangId(plid) {
        result := ComCall(19, this, "ushort*", plid, "int")
        if(result != 0)
            throw OSError(result)
