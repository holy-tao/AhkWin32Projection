 ...
 * @charset Unicode
 */
export default struct IEnumRegisterWordW extends IUnknown {
    /**
     ...
     * used for IEnumRegisterWordW interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumRegisterWordW.Vtbl()
        }
    ...
    Query(iid) {
        if (IEnumRegisterWordW.IID.Equals(iid)) {
            return true
        }
