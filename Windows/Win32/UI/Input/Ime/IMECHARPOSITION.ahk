...
/**
 * The IMECHARPOSITION (imm.h) structure contains information about the character position in the composition window.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/ns-imm-imecharposition
