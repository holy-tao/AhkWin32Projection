...
/**
 * The REGISTERWORDW (Unicode) structure (imm.h) contains reading information or a word to register.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/ns-imm-registerwordw
