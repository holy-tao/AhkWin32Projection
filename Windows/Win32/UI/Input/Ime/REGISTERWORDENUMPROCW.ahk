...
/**
 * REGISTERWORDENUMPROCW (Unicode) (imm.h) is an application-defined callback function used with the ImmEnumRegisterWord function.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/nc-imm-registerwordenumprocw
 * @namespace Windows.Win32.UI.Input.Ime
 * @version v4.0.30319
 * @charset Unicode
 */
class REGISTERWORDENUMPROCW extends IUnknown {
