...
/**
 * The STYLEBUFW (Unicode) structure (imm.h) contains the identifier and name of a style.
 * @remarks
 * > [!NOTE]
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/ns-imm-stylebufw
