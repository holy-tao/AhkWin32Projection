 ...
 */
export default struct IFELanguage extends IUnknown {
    /**
     ...
     * used for IFELanguage interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        Open                  : IntPtr
        Close                 : IntPtr
        GetJMorphResult       : IntPtr
        GetConversionModeCaps : IntPtr
        GetPhonetic           : IntPtr
        GetConversion         : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IFELanguage.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetJMorphResult)
        CallbackFree(this.vtbl.GetConversionModeCaps)
        CallbackFree(this.vtbl.GetPhonetic)
        CallbackFree(this.vtbl.GetConversion)
    }
}
