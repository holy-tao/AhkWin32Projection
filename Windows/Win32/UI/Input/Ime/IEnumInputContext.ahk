 ...
 */
export default struct IEnumInputContext extends IUnknown {
    /**
     ...
     * used for IEnumInputContext interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumInputContext.Vtbl()
        }
    ...
    Query(iid) {
        if (IEnumInputContext.IID.Equals(iid)) {
            return true
        }
