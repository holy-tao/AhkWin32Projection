...
/**
 * The RECONVERTSTRING (imm.h) structure defines the strings for IME reconversion. It is the first item in a memory block that contains the strings for reconversion.
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/imm/ns-imm-reconvertstring
