...
class IGameInputDevice extends IUnknown{
    ...
    CreateForceFeedbackEffect(motorIndex, params, effect) {
        result := ComCall(6, this, "uint", motorIndex, "ptr", params, "ptr", effect, "int")
        if(result != 0)
    ...
    CreateRawDeviceReport(reportId, reportKind, report) {
        result := ComCall(14, this, "uint", reportId, "int", reportKind, "ptr", report, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRawDeviceFeature(reportId, report) {
        result := ComCall(15, this, "uint", reportId, "ptr", report, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IGameInputRawDeviceReport>} requestReport 
     * @param {Pointer<IGameInputRawDeviceReport>} responseReport 
     * @returns {HRESULT} 
     */
    SendRawDeviceOutputWithResponse(requestReport, responseReport) {
        result := ComCall(18, this, "ptr", requestReport, "ptr", responseReport, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UIntPtr>} outputSize 
     * @returns {HRESULT} 
     */
    ExecuteRawDeviceIoControl(controlCode, inputBufferSize, inputBuffer, outputBufferSize, outputBuffer, outputSize) {
        result := ComCall(19, this, "uint", controlCode, "ptr", inputBufferSize, "ptr", inputBuffer, "ptr", outputBufferSize, "ptr", outputBuffer, "ptr*", outputSize, "int")
        if(result != 0)
            throw OSError(result)
