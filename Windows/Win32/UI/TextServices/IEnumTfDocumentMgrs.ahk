 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-ienumtfdocumentmgrs
...
class IEnumTfDocumentMgrs extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-ienumtfdocumentmgrs-clone
     */
    Clone() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-ienumtfdocumentmgrs-next
     */
    Next(ulCount, rgDocumentMgr, pcFetched) {
        pcFetchedMarshal := pcFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, "uint", ulCount, "ptr*", rgDocumentMgr, pcFetchedMarshal, pcFetched, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-ienumtfdocumentmgrs-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-ienumtfdocumentmgrs-skip
     */
    Skip(ulCount) {
