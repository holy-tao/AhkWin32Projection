 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfmessagepump
...
class ITfMessagePump extends IUnknown{
     ...
     * @param {HWND} hwnd_ Handle to the window whose messages are obtained. The window must belong to the current thread. If this value is <b>NULL</b>, this method obtains messages for any window owned by the calling thread.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfmessagepump-peekmessagea
     */
    PeekMessageA(pMsg, hwnd_, wMsgFilterMin, wMsgFilterMax, wRemoveMsg, pfResult) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfResultMarshal := pfResult is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", pMsg, "ptr", hwnd_, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "uint", wRemoveMsg, pfResultMarshal, pfResult, "int")
        if(result != 0) {
     ...
     * If <i>wMsgFilterMin</i> and <i>wMsgFilterMax</i> are both zero, this method returns all available messages; that is, no range filtering is performed.
     * @param {Pointer<MSG>} pMsg Pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/winuser/ns-winuser-msg">MSG</a> structure that receives message data.
     * @param {HWND} hwnd_ Handle to the window whose messages are obtained. The window must belong to the current thread. If this value is <b>NULL</b>, this method obtains messages for any window that belongs to the calling thread.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfmessagepump-getmessagea
     */
    GetMessageA(pMsg, hwnd_, wMsgFilterMin, wMsgFilterMax, pfResult) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfResultMarshal := pfResult is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", pMsg, "ptr", hwnd_, "uint", wMsgFilterMin, "uint", wMsgFilterMax, pfResultMarshal, pfResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfmessagepump-peekmessagew
     */
    PeekMessageW(pMsg, hwnd_, wMsgFilterMin, wMsgFilterMax, wRemoveMsg, pfResult) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfResultMarshal := pfResult is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, "ptr", pMsg, "ptr", hwnd_, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "uint", wRemoveMsg, pfResultMarshal, pfResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfmessagepump-getmessagew
     */
    GetMessageW(pMsg, hwnd_, wMsgFilterMin, wMsgFilterMax, pfResult) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        pfResultMarshal := pfResult is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, "ptr", pMsg, "ptr", hwnd_, "uint", wMsgFilterMin, "uint", wMsgFilterMax, pfResultMarshal, pfResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
