...
class ITfMessagePump extends IUnknown{
    ...
    PeekMessageA(pMsg, hwnd, wMsgFilterMin, wMsgFilterMax, wRemoveMsg, pfResult) {
        ...
        result := ComCall(3, this, "ptr", pMsg, "ptr", hwnd, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "uint", wRemoveMsg, "ptr", pfResult, "int")
        if(result != 0)
    ...
    GetMessageA(pMsg, hwnd, wMsgFilterMin, wMsgFilterMax, pfResult) {
        ...
        result := ComCall(4, this, "ptr", pMsg, "ptr", hwnd, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "ptr", pfResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekMessageW(pMsg, hwnd, wMsgFilterMin, wMsgFilterMax, wRemoveMsg, pfResult) {
        ...
        result := ComCall(5, this, "ptr", pMsg, "ptr", hwnd, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "uint", wRemoveMsg, "ptr", pfResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetMessageW(pMsg, hwnd, wMsgFilterMin, wMsgFilterMax, pfResult) {
        ...
        result := ComCall(6, this, "ptr", pMsg, "ptr", hwnd, "uint", wMsgFilterMin, "uint", wMsgFilterMax, "ptr", pfResult, "int")
        if(result != 0)
            throw OSError(result)
