...
class ITfIntegratableCandidateListUIElement extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<Guid>} guidIntegrationStyle 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<Int32>} ptfSelectionStyle 
     * @returns {HRESULT} 
     */
    GetSelectionStyle(ptfSelectionStyle) {
        result := ComCall(4, this, "int*", ptfSelectionStyle, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ShowCandidateNumbers(pfShow) {
        result := ComCall(6, this, "ptr", pfShow, "int")
        if(result != 0)
            throw OSError(result)
