 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itfintegratablecandidatelistuielement
...
class ITfIntegratableCandidateListUIElement extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfintegratablecandidatelistuielement-setintegrationstyle
     */
    SetIntegrationStyle(guidIntegrationStyle) {
        result := ComCall(3, this, "ptr", guidIntegrationStyle, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfintegratablecandidatelistuielement-getselectionstyle
     */
    GetSelectionStyle() {
        result := ComCall(4, this, "int*", &ptfSelectionStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfintegratablecandidatelistuielement-onkeydown
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfintegratablecandidatelistuielement-showcandidatenumbers
     */
    ShowCandidateNumbers() {
        result := ComCall(6, this, "int*", &pfShow := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfintegratablecandidatelistuielement-finalizeexactcompositionstring
     */
