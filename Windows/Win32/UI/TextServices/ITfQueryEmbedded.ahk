 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfqueryembedded
...
class ITfQueryEmbedded extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfqueryembedded-queryinsertembedded
     */
    QueryInsertEmbedded(pguidService, pFormatEtc) {
        result := ComCall(3, this, "ptr", pguidService, "ptr", pFormatEtc, "int*", &pfInsertable := 0, "int")
        if(result != 0) {
