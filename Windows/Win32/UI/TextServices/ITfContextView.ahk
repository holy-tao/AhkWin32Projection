 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcontextview
...
class ITfContextView extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextview-getrangefrompoint
     */
    GetRangeFromPoint(ec, ppt, dwFlags) {
        result := ComCall(3, this, "uint", ec, "ptr", ppt, "uint", dwFlags, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextview-gettextext
     */
    GetTextExt(ec, pRange, prc, pfClipped) {
        pfClippedMarshal := pfClipped is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "uint", ec, "ptr", pRange, "ptr", prc, pfClippedMarshal, pfClipped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextview-getscreenext
     */
    GetScreenExt() {
        prc := RECT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextview-getwnd
     */
    GetWnd() {
        phwnd := HWND()
