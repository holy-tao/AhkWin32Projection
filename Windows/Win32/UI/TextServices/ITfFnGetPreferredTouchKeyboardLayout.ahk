 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itffngetpreferredtouchkeyboardlayout
...
class ITfFnGetPreferredTouchKeyboardLayout extends ITfFunction{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffngetpreferredtouchkeyboardlayout-getlayout
     */
    GetLayout(pwPreferredLayoutId) {
        pwPreferredLayoutIdMarshal := pwPreferredLayoutId is VarRef ? "ushort*" : "ptr"

        result := ComCall(4, this, "int*", &pTKBLayoutType := 0, pwPreferredLayoutIdMarshal, pwPreferredLayoutId, "int")
        if(result != 0) {
