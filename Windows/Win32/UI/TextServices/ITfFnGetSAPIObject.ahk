 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itffngetsapiobject
...
class ITfFnGetSAPIObject extends ITfFunction{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffngetsapiobject-get
     */
    Get(sObj) {
        result := ComCall(4, this, "int", sObj, "ptr*", &ppunk := 0, "int")
        if(result != 0) {
