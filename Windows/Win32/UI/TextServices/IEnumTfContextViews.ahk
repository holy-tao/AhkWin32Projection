 ...
 */
export default struct IEnumTfContextViews extends IUnknown {
    /**
     ...
     * used for IEnumTfContextViews interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumTfContextViews.Vtbl()
        }
    ...
    _Query(iid) {
        if (IEnumTfContextViews.IID.Equals(iid)) {
            return true
        }
