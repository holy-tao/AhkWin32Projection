 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-ienumtfcontextviews
...
class IEnumTfContextViews extends IUnknown{
    ...
    Next(ulCount, rgViews, pcFetched) {
        ...
        result := ComCall(4, this, "uint", ulCount, "ptr*", rgViews, pcFetchedMarshal, pcFetched, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
