 ...
 */
export default struct IEnumTfInputProcessorProfiles extends IUnknown {
    /**
     ...
     * used for IEnumTfInputProcessorProfiles interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumTfInputProcessorProfiles.Vtbl()
        }
    ...
    _Query(iid) {
        if (IEnumTfInputProcessorProfiles.IID.Equals(iid)) {
            return true
        }
