 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfuielement
...
class ITfUIElement extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielement-getdescription
     */
    GetDescription() {
        pbstrDescription := BSTR()
        result := ComCall(3, this, "ptr", pbstrDescription, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielement-getguid
     */
    GetGUID() {
        pguid := Guid()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielement-show
     */
    Show(bShow) {
        result := ComCall(5, this, "int", bShow, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielement-isshown
     */
    IsShown() {
        result := ComCall(6, this, "int*", &pbShow := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
