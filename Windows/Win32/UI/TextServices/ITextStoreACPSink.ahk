...
export default struct ITextStoreACPSink extends IUnknown {
    ...
    */
    ...
    OnAttrsChange(acpStart, acpEnd, cAttrs, paAttrs) {
        result := ComCall(7, this, Int32, acpStart, Int32, acpEnd, UInt32, cAttrs, Guid.Ptr, paAttrs, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.OnTextChange := CallbackCreate(ObjBindMethod(implObj, "OnTextChange"), flags, 3)
