 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcontextcomposition
...
class ITfContextComposition extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextcomposition-startcomposition
     */
    StartComposition(ecWrite, pCompositionRange, pSink) {
        result := ComCall(3, this, "uint", ecWrite, "ptr", pCompositionRange, "ptr", pSink, "ptr*", &ppComposition := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextcomposition-enumcompositions
     */
    EnumCompositions() {
     ...
     * @returns {IEnumITfCompositionView} Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/msctf/nn-msctf-ienumitfcompositionview">IEnumITfCompositionView</a> interface pointer that receives the enumerator object.
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextcomposition-findcomposition
     */
    FindComposition(ecRead, pTestRange) {
        result := ComCall(5, this, "uint", ecRead, "ptr", pTestRange, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextcomposition-takeownership
     */
    TakeOwnership(ecWrite, pComposition, pSink) {
        result := ComCall(6, this, "uint", ecWrite, "ptr", pComposition, "ptr", pSink, "ptr*", &ppComposition := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
