 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcreatepropertystore
...
class ITfCreatePropertyStore extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcreatepropertystore-isstoreserializable
     */
    IsStoreSerializable(guidProp, pRange, pPropStore) {
        result := ComCall(3, this, "ptr", guidProp, "ptr", pRange, "ptr", pPropStore, "int*", &pfSerializable := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcreatepropertystore-createpropertystore
     */
    CreatePropertyStore(guidProp, pRange, cb, pStream) {
        result := ComCall(4, this, "ptr", guidProp, "ptr", pRange, "uint", cb, "ptr", pStream, "ptr*", &ppStore := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
