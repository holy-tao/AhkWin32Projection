 ...
 */
export default struct IEnumTfLangBarItems extends IUnknown {
    /**
     ...
     * used for IEnumTfLangBarItems interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumTfLangBarItems.Vtbl()
        }
    ...
    Query(iid) {
        if (IEnumTfLangBarItems.IID.Equals(iid)) {
            return true
        }
