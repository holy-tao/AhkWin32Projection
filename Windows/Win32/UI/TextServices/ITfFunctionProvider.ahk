 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itffunctionprovider
...
class ITfFunctionProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itffunctionprovider-gettype
     */
    GetType() {
        pguid := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itffunctionprovider-getdescription
     */
    GetDescription() {
        pbstrDesc := BSTR()
     ...
     * @returns {Pointer<IUnknown>} Pointer to an <b>IUnknown</b> interface pointer that receives the requested function interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itffunctionprovider-getfunction
     */
    GetFunction(rguid, riid) {
        result := ComCall(5, this, "ptr", rguid, "ptr", riid, "ptr*", &ppunk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
