 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msaatext/nn-msaatext-iaccserverdocmgr
...
class IAccServerDocMgr extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msaatext/nf-msaatext-iaccserverdocmgr-newdocument
     */
     ...
     * 
     * If successful, returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/msaatext/nf-msaatext-iaccserverdocmgr-revokedocument
     */
    RevokeDocument(punk) {
     ...
     * 
     * If successful, returns S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/msaatext/nf-msaatext-iaccserverdocmgr-ondocumentfocus
     */
