 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nn-textstor-itextstoreacp
...
class ITextStoreACP extends IUnknown{
    ...
    /**
     * The interface identifier for ITextStoreACP
     * @type {Guid}
     */
    static IID => Guid("{28888fe3-c2a0-483a-a3ea-8cb1ce51ff3d}")
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-advisesink
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-unadvisesink
     */
    UnadviseSink(punk) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-requestlock
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getstatus
     */
    GetStatus() {
        pdcs := TS_STATUS()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-queryinsert
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-setselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-gettext
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-settext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getformattedtext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getembedded
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-queryinsertembedded
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-insertembedded
     */
     ...
     * @param {Pointer<Integer>} pacpStart Pointer to the starting application character position where the text insertion occurs.
     * @param {Pointer<Integer>} pacpEnd Pointer to the ending application character position where the text insertion occurs. This parameter value is the same as the value of the <i>pacpStart</i> parameter for an insertion point.
     * @param {Pointer<TS_TEXTCHANGE>} pChange Pointer to a <b>TS_TEXTCHANGE</b> structure with the following members.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-inserttextatselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-insertembeddedatselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-requestsupportedattrs
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-requestattrsatposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-requestattrstransitioningatposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-findnextattrtransition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-retrieverequestedattrs
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getendacp
     */
    GetEndACP() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getactiveview
     */
    GetActiveView() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getacpfrompoint
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-gettextext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getscreenext
     */
    GetScreenExt(vcView) {
        prc := RECT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp-getwnd
     */
    GetWnd(vcView) {
        phwnd := HWND()
        result := ComCall(28, this, "uint", vcView, "ptr", phwnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
