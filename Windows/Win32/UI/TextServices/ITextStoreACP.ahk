 ...
 */
export default struct ITextStoreACP extends IUnknown {
    /**
     ...
     * used for ITextStoreACP interfaces
    */
    ...
    GetWnd(vcView) {
        phwnd := HWND()
        result := ComCall(28, this, UInt32, vcView, HWND.Ptr, phwnd, "HRESULT")
        return phwnd
    }

    _Query(iid) {
        if (ITextStoreACP.IID.Equals(iid)) {
            return true
        }
