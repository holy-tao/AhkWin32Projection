 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfproperty
...
class ITfProperty extends ITfReadOnlyProperty{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfproperty-findrange
     */
    FindRange(ec, pRange, aPos) {
        result := ComCall(7, this, "uint", ec, "ptr", pRange, "ptr*", &ppRange := 0, "int", aPos, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfproperty-setvaluestore
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfproperty-setvalue
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfproperty-clear
     */
    Clear(ec, pRange) {
