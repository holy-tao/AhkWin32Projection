 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcontextownercompositionservices
...
class ITfContextOwnerCompositionServices extends ITfContextComposition{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextownercompositionservices-terminatecomposition
     */
    TerminateComposition(pComposition) {
        result := ComCall(7, this, "ptr", pComposition, "int")
        if(result != 0) {
