...
class ITfInputProcessorProfileMgr extends IUnknown{
    ...
    ActivateProfile(dwProfileType, langid, clsid, guidProfile, hkl, dwFlags) {
        ...
        result := ComCall(3, this, "uint", dwProfileType, "ushort", langid, "ptr", clsid, "ptr", guidProfile, "ptr", hkl, "uint", dwFlags, "int")
        if(result != 0)
    ...
    DeactivateProfile(dwProfileType, langid, clsid, guidProfile, hkl, dwFlags) {
        ...
        result := ComCall(4, this, "uint", dwProfileType, "ushort", langid, "ptr", clsid, "ptr", guidProfile, "ptr", hkl, "uint", dwFlags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetProfile(dwProfileType, langid, clsid, guidProfile, hkl, pProfile) {
        ...
        result := ComCall(5, this, "uint", dwProfileType, "ushort", langid, "ptr", clsid, "ptr", guidProfile, "ptr", hkl, "ptr", pProfile, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumProfiles(langid, ppEnum) {
        result := ComCall(6, this, "ushort", langid, "ptr", ppEnum, "int")
        if(result != 0)
            throw OSError(result)
