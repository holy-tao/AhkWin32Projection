 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itflanguageprofilenotifysink
...
class ITfLanguageProfileNotifySink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itflanguageprofilenotifysink-onlanguagechange
     */
    OnLanguageChange(langid) {
        result := ComCall(3, this, "ushort", langid, "int*", &pfAccept := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itflanguageprofilenotifysink-onlanguagechanged
     */
    OnLanguageChanged() {
