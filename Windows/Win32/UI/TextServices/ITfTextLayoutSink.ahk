 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itftextlayoutsink
...
class ITfTextLayoutSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itftextlayoutsink-onlayoutchange
     */
    OnLayoutChange(pic, lcode, pView) {
        result := ComCall(3, this, "ptr", pic, "int", lcode, "ptr", pView, "int")
        if(result != 0) {
