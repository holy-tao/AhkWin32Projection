 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itffnlmprocessor
...
class ITfFnLMProcessor extends ITfFunction{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-queryrange
     */
    QueryRange(pRange, ppNewRange, pfAccepted) {
        pfAcceptedMarshal := pfAccepted is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", pRange, "ptr*", ppNewRange, pfAcceptedMarshal, pfAccepted, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-querylangid
     */
    QueryLangID(langid) {
        result := ComCall(5, this, "ushort", langid, "int*", &pfAccepted := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-getreconversion
     */
    GetReconversion(pRange) {
        result := ComCall(6, this, "ptr", pRange, "ptr*", &ppCandList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-reconvert
     */
    Reconvert(pRange) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-querykey
     */
    QueryKey(fUp, vKey, lparamKeydata) {
        vKey := vKey is Win32Handle ? NumGet(vKey, "ptr") : vKey
        lparamKeydata := lparamKeydata is Win32Handle ? NumGet(lparamKeydata, "ptr") : lparamKeydata

        result := ComCall(8, this, "int", fUp, "ptr", vKey, "ptr", lparamKeydata, "int*", &pfInterested := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-invokekey
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnlmprocessor-invokefunc
     */
