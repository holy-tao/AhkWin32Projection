 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itffnreconversion
...
class ITfFnReconversion extends ITfFunction{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnreconversion-queryrange
     */
    QueryRange(pRange, ppNewRange) {
        result := ComCall(4, this, "ptr", pRange, "ptr*", ppNewRange, "int*", &pfConvertable := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnreconversion-getreconversion
     */
    GetReconversion(pRange) {
        result := ComCall(5, this, "ptr", pRange, "ptr*", &ppCandList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itffnreconversion-reconvert
     */
    Reconvert(pRange) {
        result := ComCall(6, this, "ptr", pRange, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
