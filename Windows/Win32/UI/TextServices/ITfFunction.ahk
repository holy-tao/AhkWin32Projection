 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itffunction
...
class ITfFunction extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itffunction-getdisplayname
     */
    GetDisplayName() {
        pbstrName := BSTR()
