 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcleanupcontextsink
...
class ITfCleanupContextSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcleanupcontextsink-oncleanupcontext
     */
    OnCleanupContext(ecWrite, pic) {
        result := ComCall(3, this, "uint", ecWrite, "ptr", pic, "int")
        if(result != 0) {
