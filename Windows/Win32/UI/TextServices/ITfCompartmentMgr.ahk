 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcompartmentmgr
...
class ITfCompartmentMgr extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcompartmentmgr-getcompartment
     */
    GetCompartment(rguid) {
        result := ComCall(3, this, "ptr", rguid, "ptr*", &ppcomp := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcompartmentmgr-clearcompartment
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcompartmentmgr-enumcompartments
     */
    EnumCompartments() {
