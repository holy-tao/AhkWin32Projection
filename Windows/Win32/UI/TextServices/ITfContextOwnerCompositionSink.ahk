 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcontextownercompositionsink
...
class ITfContextOwnerCompositionSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextownercompositionsink-onstartcomposition
     */
    OnStartComposition(pComposition) {
        result := ComCall(3, this, "ptr", pComposition, "int*", &pfOk := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextownercompositionsink-onupdatecomposition
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextownercompositionsink-onendcomposition
     */
