 ...
 * @see https://learn.microsoft.com/windows/win32/api/msctf/nn-msctf-ienumtfcontexts
 * @namespace Windows.Win32.UI.TextServices
 */
export default struct IEnumTfContexts extends IUnknown {
    /**
     ...
     * used for IEnumTfContexts interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumTfContexts.Vtbl()
        }
    ...
    Next(ulCount, rgContext, pcFetched) {
        ...
        result := ComCall(4, this, UInt32, ulCount, ITfContext.Ptr, rgContext, pcFetchedMarshal, pcFetched, "HRESULT")
        return result
    }
    ...
    Query(iid) {
        if (IEnumTfContexts.IID.Equals(iid)) {
            return true
        }
