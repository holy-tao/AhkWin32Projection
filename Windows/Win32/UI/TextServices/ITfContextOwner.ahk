 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcontextowner
...
class ITfContextOwner extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-getacpfrompoint
     */
    GetACPFromPoint(ptScreen, dwFlags) {
        result := ComCall(3, this, "ptr", ptScreen, "uint", dwFlags, "int*", &pacp := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-gettextext
     */
    GetTextExt(acpStart, acpEnd, prc, pfClipped) {
        pfClippedMarshal := pfClipped is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "int", acpStart, "int", acpEnd, "ptr", prc, pfClippedMarshal, pfClipped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-getscreenext
     */
    GetScreenExt() {
        prc := RECT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-getstatus
     */
    GetStatus() {
        pdcs := TS_STATUS()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-getwnd
     */
    GetWnd() {
        phwnd := HWND()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcontextowner-getattribute
     */
