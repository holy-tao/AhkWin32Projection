 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itflmlattice
...
class ITfLMLattice extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itflmlattice-querytype
     */
    QueryType(rguidType) {
        result := ComCall(3, this, "ptr", rguidType, "int*", &pfSupported := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itflmlattice-enumlatticeelements
     */
    EnumLatticeElements(dwFrameStart, rguidType) {
        result := ComCall(4, this, "uint", dwFrameStart, "ptr", rguidType, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
