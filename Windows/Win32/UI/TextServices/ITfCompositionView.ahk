 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfcompositionview
...
class ITfCompositionView extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcompositionview-getownerclsid
     */
    GetOwnerClsid() {
        pclsid := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfcompositionview-getrange
     */
    GetRange() {
        result := ComCall(4, this, "ptr*", &ppRange := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
