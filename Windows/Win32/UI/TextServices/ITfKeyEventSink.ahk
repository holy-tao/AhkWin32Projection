 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfkeyeventsink
...
class ITfKeyEventSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-onsetfocus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-ontestkeydown
     */
    OnTestKeyDown(pic, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(4, this, "ptr", pic, "ptr", wParam_, "ptr", lParam_, "int*", &pfEaten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-ontestkeyup
     */
    OnTestKeyUp(pic, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(5, this, "ptr", pic, "ptr", wParam_, "ptr", lParam_, "int*", &pfEaten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-onkeydown
     */
    OnKeyDown(pic, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(6, this, "ptr", pic, "ptr", wParam_, "ptr", lParam_, "int*", &pfEaten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-onkeyup
     */
    OnKeyUp(pic, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(7, this, "ptr", pic, "ptr", wParam_, "ptr", lParam_, "int*", &pfEaten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfkeyeventsink-onpreservedkey
     */
    OnPreservedKey(pic, rguid) {
        result := ComCall(8, this, "ptr", pic, "ptr", rguid, "int*", &pfEaten := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
