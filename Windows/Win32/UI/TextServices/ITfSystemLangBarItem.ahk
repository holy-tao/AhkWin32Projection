 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nn-ctfutb-itfsystemlangbaritem
...
class ITfSystemLangBarItem extends IUnknown{
     ...
     * @param {HICON} hIcon_ Contains the handle to the new icon.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itfsystemlangbaritem-seticon
     */
    SetIcon(hIcon_) {
        hIcon_ := hIcon_ is Win32Handle ? NumGet(hIcon_, "ptr") : hIcon_

        result := ComCall(3, this, "ptr", hIcon_, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itfsystemlangbaritem-settooltipstring
     */
    SetTooltipString(pchToolTip, cch) {
        pchToolTip := pchToolTip is String ? StrPtr(pchToolTip) : pchToolTip

        result := ComCall(4, this, "ptr", pchToolTip, "uint", cch, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
