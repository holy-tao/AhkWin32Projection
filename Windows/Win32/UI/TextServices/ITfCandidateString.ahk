 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nn-ctffunc-itfcandidatestring
...
class ITfCandidateString extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfcandidatestring-getstring
     */
    GetString() {
        pbstr := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctffunc/nf-ctffunc-itfcandidatestring-getindex
     */
    GetIndex() {
        result := ComCall(4, this, "uint*", &pnIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
