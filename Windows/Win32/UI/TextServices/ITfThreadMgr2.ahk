...
export default struct ITfThreadMgr2 extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SuspendKeystrokeHandling := CallbackCreate(ObjBindMethod(implObj, "SuspendKeystrokeHandling"), flags, 1)
        this.vtbl.ResumeKeystrokeHandling := CallbackCreate(ObjBindMethod(implObj, "ResumeKeystrokeHandling"), flags, 1)
    }
