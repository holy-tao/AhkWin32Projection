 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nn-textstor-itextstoreacp2
...
class ITextStoreACP2 extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-advisesink
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-unadvisesink
     */
    UnadviseSink(punk) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-requestlock
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getstatus
     */
    GetStatus() {
        pdcs := TS_STATUS()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-queryinsert
     */
    QueryInsert(acpTestStart, acpTestEnd, cch, pacpResultStart, pacpResultEnd) {
        ...
        result := ComCall(7, this, "int", acpTestStart, "int", acpTestEnd, "uint", cch, pacpResultStartMarshal, pacpResultStart, pacpResultEndMarshal, pacpResultEnd, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-setselection
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-gettext
     */
    GetText(acpStart, acpEnd, pchPlain, cchPlainReq, pcchPlainRet, prgRunInfo, cRunInfoReq, pcRunInfoRet, pacpNext) {
        ...
        result := ComCall(10, this, "int", acpStart, "int", acpEnd, "ptr", pchPlain, "uint", cchPlainReq, pcchPlainRetMarshal, pcchPlainRet, "ptr", prgRunInfo, "uint", cRunInfoReq, pcRunInfoRetMarshal, pcRunInfoRet, pacpNextMarshal, pacpNext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * This method should call the <a href="https://docs.microsoft.com/windows/desktop/api/textstor/nf-textstor-itextstoreacp2-setselection">SetSelection</a> method to select the text to be changed. After successfully executing the <b>SetSelection</b> method, this method then calls the <a href="https://docs.microsoft.com/windows/desktop/api/textstor/nf-textstor-itextstoreacp2-inserttextatselection">InsertTextAtSelection</a> method to perform the actual text change.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-settext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getformattedtext
     */
    GetFormattedText(acpStart, acpEnd) {
        result := ComCall(12, this, "int", acpStart, "int", acpEnd, "ptr*", &ppDataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets an embedded document. (ITextStoreACP2.GetEmbedded)
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getembedded
     */
    GetEmbedded(acpPos, rguidService, riid) {
        result := ComCall(13, this, "int", acpPos, "ptr", rguidService, "ptr", riid, "ptr*", &ppunk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets a value indicating whether the specified object can be inserted into the document. (ITextStoreACP2.QueryInsertEmbedded)
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-queryinsertembedded
     */
    QueryInsertEmbedded(pguidService, pFormatEtc) {
        result := ComCall(14, this, "ptr", pguidService, "ptr", pFormatEtc, "int*", &pfInsertable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Inserts an embedded object at the specified character. (ITextStoreACP2.InsertEmbedded)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-insertembedded
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-inserttextatselection
     */
    InsertTextAtSelection(dwFlags, pchText, cch, pacpStart, pacpEnd, pChange) {
        ...
        result := ComCall(16, this, "uint", dwFlags, "ptr", pchText, "uint", cch, pacpStartMarshal, pacpStart, pacpEndMarshal, pacpEnd, "ptr", pChange, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-insertembeddedatselection
     */
    InsertEmbeddedAtSelection(dwFlags, pDataObject, pacpStart, pacpEnd, pChange) {
        pacpStartMarshal := pacpStart is VarRef ? "int*" : "ptr"
        pacpEndMarshal := pacpEnd is VarRef ? "int*" : "ptr"

        result := ComCall(17, this, "uint", dwFlags, "ptr", pDataObject, pacpStartMarshal, pacpStart, pacpEndMarshal, pacpEnd, "ptr", pChange, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Get the attributes that are supported in the document. (ITextStoreACP2.RequestSupportedAttrs)
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-requestsupportedattrs
     */
    ...
    /**
     * Gets text attributes at the specified character position. (ITextStoreACP2.RequestAttrsAtPosition)
     * @remarks
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-requestattrsatposition
     */
    ...
    /**
     * Gets text attributes transitioning at the specified character position. (ITextStoreACP2.RequestAttrsTransitioningAtPosition)
     * @remarks
     * In the sentence, "This is <i>italic text</i>.", the italic attribute starts before the word <i>italic</i> and ends after the word <i>text</i>.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-requestattrstransitioningatposition
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-findnextattrtransition
     */
    FindNextAttrTransition(acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext, pfFound, plFoundOffset) {
        ...
        result := ComCall(21, this, "int", acpStart, "int", acpHalt, "uint", cFilterAttrs, "ptr", paFilterAttrs, "uint", dwFlags, pacpNextMarshal, pacpNext, pfFoundMarshal, pfFound, plFoundOffsetMarshal, plFoundOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Gets the attributes returned by a call to an attribute request method. (ITextStoreACP2.RetrieveRequestedAttrs)
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-retrieverequestedattrs
     */
    RetrieveRequestedAttrs(ulCount, paAttrVals, pcFetched) {
        pcFetchedMarshal := pcFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, "uint", ulCount, "ptr", paAttrVals, pcFetchedMarshal, pcFetched, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getendacp
     */
    GetEndACP() {
        result := ComCall(23, this, "int*", &pacp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getactiveview
     */
    GetActiveView() {
        result := ComCall(24, this, "uint*", &pvcView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getacpfrompoint
     */
    GetACPFromPoint(vcView, ptScreen, dwFlags) {
        result := ComCall(25, this, "uint", vcView, "ptr", ptScreen, "uint", dwFlags, "int*", &pacp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-gettextext
     */
    GetTextExt(vcView, acpStart, acpEnd, prc, pfClipped) {
        pfClippedMarshal := pfClipped is VarRef ? "int*" : "ptr"

        result := ComCall(26, this, "uint", vcView, "int", acpStart, "int", acpEnd, "ptr", prc, pfClippedMarshal, pfClipped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/textstor/nf-textstor-itextstoreacp2-getscreenext
     */
    GetScreenExt(vcView) {
        prc := RECT()
