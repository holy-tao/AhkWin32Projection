 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfedittransactionsink
...
class ITfEditTransactionSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfedittransactionsink-onstartedittransaction
     */
     ...
     * @param {ITfContext} pic Pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/msctf/nn-msctf-itfcontext">ITfContext</a> interface involved in the transaction.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfedittransactionsink-onendedittransaction
     */
