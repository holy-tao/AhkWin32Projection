 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nn-ctfutb-itflangbaritembutton
...
class ITfLangBarItemButton extends ITfLangBarItem{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itflangbaritembutton-onclick
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itflangbaritembutton-initmenu
     */
    InitMenu(pMenu) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itflangbaritembutton-onmenuselect
     */
    OnMenuSelect(wID) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itflangbaritembutton-geticon
     */
    GetIcon() {
        phIcon := HICON()
        result := ComCall(10, this, "ptr", phIcon, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itflangbaritembutton-gettext
     */
    GetText() {
        pbstrText := BSTR()
        result := ComCall(11, this, "ptr", pbstrText, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
