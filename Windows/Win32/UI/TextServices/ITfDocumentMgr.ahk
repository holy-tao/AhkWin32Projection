 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfdocumentmgr
...
class ITfDocumentMgr extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-createcontext
     */
    CreateContext(tidOwner, dwFlags, punk, ppic, pecTextStore) {
        pecTextStoreMarshal := pecTextStore is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "uint", tidOwner, "uint", dwFlags, "ptr", punk, "ptr*", ppic, pecTextStoreMarshal, pecTextStore, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-push
     */
    Push(pic) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-pop
     */
    Pop(dwFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-gettop
     */
    GetTop() {
        result := ComCall(6, this, "ptr*", &ppic := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {ITfContext} Address of an <a href="https://docs.microsoft.com/windows/desktop/api/msctf/nn-msctf-itfcontext">ITfContext</a> pointer that receives the context.
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-getbase
     */
    GetBase() {
        result := ComCall(7, this, "ptr*", &ppic := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfdocumentmgr-enumcontexts
     */
    EnumContexts() {
