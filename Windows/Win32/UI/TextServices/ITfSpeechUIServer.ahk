 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctfspui/nn-ctfspui-itfspeechuiserver
...
class ITfSpeechUIServer extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfspui/nf-ctfspui-itfspeechuiserver-initialize
     */
    Initialize() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfspui/nf-ctfspui-itfspeechuiserver-showui
     */
    ShowUI(fShow) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfspui/nf-ctfspui-itfspeechuiserver-updateballoon
     */
    UpdateBalloon(style, pch, cch) {
        pch := pch is String ? StrPtr(pch) : pch

        result := ComCall(5, this, "int", style, "ptr", pch, "uint", cch, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
