 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfthreadmgr
...
class ITfThreadMgr extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-activate
     */
    Activate() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-deactivate
     */
    Deactivate() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-createdocumentmgr
     */
    CreateDocumentMgr() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-enumdocumentmgrs
     */
    EnumDocumentMgrs() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-getfocus
     */
    GetFocus() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-setfocus
     */
    SetFocus(pdimFocus) {
     ...
     * 
     * ```
     * @param {HWND} hwnd_ Handle of the window to associate the focus with.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-associatefocus
     */
    AssociateFocus(hwnd_, pdimNew) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := ComCall(9, this, "ptr", hwnd_, "ptr", pdimNew, "ptr*", &ppdimPrev := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-isthreadfocus
     */
    IsThreadFocus() {
        result := ComCall(10, this, "int*", &pfThreadFocus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-getfunctionprovider
     */
    GetFunctionProvider(clsid) {
        result := ComCall(11, this, "ptr", clsid, "ptr*", &ppFuncProv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-enumfunctionproviders
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfthreadmgr-getglobalcompartment
     */
    GetGlobalCompartment() {
        result := ComCall(13, this, "ptr*", &ppCompMgr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
