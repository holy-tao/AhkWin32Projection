 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfpersistentpropertyloaderacp
...
class ITfPersistentPropertyLoaderACP extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfpersistentpropertyloaderacp-loadproperty
     */
    LoadProperty(pHdr) {
        result := ComCall(3, this, "ptr", pHdr, "ptr*", &ppStream := 0, "int")
        if(result != 0) {
