 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfuielementmgr
...
class ITfUIElementMgr extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielementmgr-beginuielement
     */
    BeginUIElement(pElement, pbShow) {
        pbShowMarshal := pbShow is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", pElement, pbShowMarshal, pbShow, "uint*", &pdwUIElementId := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielementmgr-updateuielement
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielementmgr-enduielement
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielementmgr-getuielement
     */
    GetUIElement(dwUIELementId) {
        result := ComCall(6, this, "uint", dwUIELementId, "ptr*", &ppElement := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfuielementmgr-enumuielements
     */
    EnumUIElements() {
