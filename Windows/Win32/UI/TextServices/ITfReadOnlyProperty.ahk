 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfreadonlyproperty
...
class ITfReadOnlyProperty extends IUnknown{
     ...
     * @returns {Guid} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfreadonlyproperty-gettype
     */
    GetType() {
        pguid := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfreadonlyproperty-enumranges
     */
    EnumRanges(ec, pTargetRange) {
        result := ComCall(4, this, "uint", ec, "ptr*", &ppEnum := 0, "ptr", pTargetRange, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfreadonlyproperty-getvalue
     */
    GetValue(ec, pRange) {
        pvarValue := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfreadonlyproperty-getcontext
     */
    GetContext() {
        result := ComCall(6, this, "ptr*", &ppContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
