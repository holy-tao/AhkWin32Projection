 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nn-msctf-itfsource
...
class ITfSource extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfsource-advisesink
     */
    AdviseSink(riid, punk) {
        result := ComCall(3, this, "ptr", riid, "ptr", punk, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msctf/nf-msctf-itfsource-unadvisesink
     */
