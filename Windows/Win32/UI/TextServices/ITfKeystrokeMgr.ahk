...
export default struct ITfKeystrokeMgr extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.AdviseKeyEventSink := CallbackCreate(ObjBindMethod(implObj, "AdviseKeyEventSink"), flags, 4)
        this.vtbl.UnadviseKeyEventSink := CallbackCreate(ObjBindMethod(implObj, "UnadviseKeyEventSink"), flags, 2)
        this.vtbl.GetForeground := CallbackCreate(ObjBindMethod(implObj, "GetForeground"), flags, 2)
        this.vtbl.TestKeyDown := CallbackCreate(ObjBindMethod(implObj, "TestKeyDown"), flags, 4)
        this.vtbl.TestKeyUp := CallbackCreate(ObjBindMethod(implObj, "TestKeyUp"), flags, 4)
        this.vtbl.KeyDown := CallbackCreate(ObjBindMethod(implObj, "KeyDown"), flags, 4)
        this.vtbl.KeyUp := CallbackCreate(ObjBindMethod(implObj, "KeyUp"), flags, 4)
        this.vtbl.GetPreservedKey := CallbackCreate(ObjBindMethod(implObj, "GetPreservedKey"), flags, 4)
        this.vtbl.IsPreservedKey := CallbackCreate(ObjBindMethod(implObj, "IsPreservedKey"), flags, 4)
        this.vtbl.PreserveKey := CallbackCreate(ObjBindMethod(implObj, "PreserveKey"), flags, 6)
        this.vtbl.UnpreserveKey := CallbackCreate(ObjBindMethod(implObj, "UnpreserveKey"), flags, 3)
        this.vtbl.SetPreservedKeyDescription := CallbackCreate(ObjBindMethod(implObj, "SetPreservedKeyDescription"), flags, 4)
        this.vtbl.GetPreservedKeyDescription := CallbackCreate(ObjBindMethod(implObj, "GetPreservedKeyDescription"), flags, 3)
        this.vtbl.SimulatePreservedKey := CallbackCreate(ObjBindMethod(implObj, "SimulatePreservedKey"), flags, 4)
    }
