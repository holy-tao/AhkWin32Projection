 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nn-ctfutb-itfsystemdevicetypelangbaritem
...
class ITfSystemDeviceTypeLangBarItem extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itfsystemdevicetypelangbaritem-seticonmode
     */
    SetIconMode(dwFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctfutb/nf-ctfutb-itfsystemdevicetypelangbaritem-geticonmode
     */
    GetIconMode() {
