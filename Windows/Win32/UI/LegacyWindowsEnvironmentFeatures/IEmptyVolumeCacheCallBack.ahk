 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nn-emptyvc-iemptyvolumecachecallback
...
class IEmptyVolumeCacheCallBack extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecachecallback-scanprogress
     */
    ScanProgress(dwlSpaceUsed, dwFlags, pcwszStatus) {
        pcwszStatus := pcwszStatus is String ? StrPtr(pcwszStatus) : pcwszStatus

        result := ComCall(3, this, "uint", dwlSpaceUsed, "uint", dwFlags, "ptr", pcwszStatus, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecachecallback-purgeprogress
     */
    PurgeProgress(dwlSpaceFreed, dwlSpaceToFree, dwFlags, pcwszStatus) {
        pcwszStatus := pcwszStatus is String ? StrPtr(pcwszStatus) : pcwszStatus

        result := ComCall(4, this, "uint", dwlSpaceFreed, "uint", dwlSpaceToFree, "uint", dwFlags, "ptr", pcwszStatus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
