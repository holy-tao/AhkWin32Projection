 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nn-emptyvc-iemptyvolumecache
...
class IEmptyVolumeCache extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecache-initialize
     */
    Initialize(hkRegKey, pcwszVolume, ppwszDisplayName, ppwszDescription, pdwFlags) {
        ...
        result := ComCall(3, this, "ptr", hkRegKey, "ptr", pcwszVolume, ppwszDisplayNameMarshal, ppwszDisplayName, ppwszDescriptionMarshal, ppwszDescription, pdwFlagsMarshal, pdwFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecache-getspaceused
     */
    GetSpaceUsed(picb) {
        result := ComCall(4, this, "uint*", &pdwlSpaceUsed := 0, "ptr", picb, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecache-purge
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecache-showproperties
     */
    ShowProperties(hwnd_) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/emptyvc/nf-emptyvc-iemptyvolumecache-deactivate
     */
    Deactivate() {
