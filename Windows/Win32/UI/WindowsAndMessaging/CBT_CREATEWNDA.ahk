...
#Import ".\CREATESTRUCTA.ahk" { CREATESTRUCTA }
 ...
 * @see https://learn.microsoft.com/windows/win32/api/winuser/ns-winuser-cbt_createwnda
 * @namespace Windows.Win32.UI.WindowsAndMessaging
 * @charset ANSI
 */
export default struct CBT_CREATEWNDA {
    #StructPack 8
