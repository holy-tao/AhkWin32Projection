 ...
 * @see https://learn.microsoft.com/windows/win32/api/winuser/nc-winuser-propenumprocexa
 * @namespace Windows.Win32.UI.WindowsAndMessaging
 * @charset ANSI
 */
export default struct PROPENUMPROCEXA {
    value : IntPtr

    __value {
        set {
            if (value is PROPENUMPROCEXA) {
     ...
     * @param {PSTR} param1 Type: <b>LPTSTR</b>
     * 
     ...
     * @param {Pointer} param3 Type: <b>ULONG_PTR</b>
     * 
    ...
    Call(param0, param1, param2, param3) {
        ...
        result := DllCall(this.value, HWND, param0, "ptr", param1, HANDLE, param2, IntPtr, param3, BOOL)
        return result
    }

    /**
     * A PROPENUMPROCEXA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROPENUMPROCEXA {
        /**
         * Creates a PROPENUMPROCEXA pointer that invokes the given AHK function when called.
         * @param {Func(HWND, PSTR, HANDLE, IntPtr) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 4 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [HWND, PSTR, HANDLE, IntPtr, BOOL])
        }
