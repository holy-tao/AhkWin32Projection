 ...
 * @see https://learn.microsoft.com/windows/win32/api/winuser/nc-winuser-propenumprocexw
 * @namespace Windows.Win32.UI.WindowsAndMessaging
 * @charset Unicode
 */
export default struct PROPENUMPROCEXW {
    value : IntPtr

    __value {
        set {
            if (value is PROPENUMPROCEXW) {
     ...
     * @param {PWSTR} param1 Type: <b>LPTSTR</b>
     * 
    ...
    /**
     * A PROPENUMPROCEXW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROPENUMPROCEXW {
        /**
         * Creates a PROPENUMPROCEXW pointer that invokes the given AHK function when called.
         * @param {Func(HWND, PWSTR, HANDLE, IntPtr) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
