...
export default struct IUIAnimationStoryboard extends IUnknown {
    ...
    */
    ...
    SetTag(_object, id) {
        ...
        result := ComCall(15, this, _objectMarshal, _object, UInt32, id, "HRESULT")
        return result
    }
    ...
    GetTag(_object, id) {
        ...
        result := ComCall(16, this, _objectMarshal, _object, idMarshal, id, "HRESULT")
        return result
    }
    ...
    SetStoryboardEventHandler(handler) {
        ...
        result := ComCall(19, this, handlerMarshal, handler, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.RepeatBetweenKeyframes := CallbackCreate(ObjBindMethod(implObj, "RepeatBetweenKeyframes"), flags, 4)
        ...
        this.vtbl.SetStoryboardEventHandler := CallbackCreate(ObjBindMethod(implObj, "SetStoryboardEventHandler"), flags, 2)
    }
