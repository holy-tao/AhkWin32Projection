...
class IUIAnimationTransitionLibrary extends IUnknown{
    ...
    CreateConstantTransition(duration, transition) {
        result := ComCall(4, this, "double", duration, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDiscreteTransition(delay, finalValue, hold, transition) {
        result := ComCall(5, this, "double", delay, "double", finalValue, "double", hold, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateLinearTransition(duration, finalValue, transition) {
        result := ComCall(6, this, "double", duration, "double", finalValue, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateLinearTransitionFromSpeed(speed, finalValue, transition) {
        result := ComCall(7, this, "double", speed, "double", finalValue, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSinusoidalTransitionFromVelocity(duration, period, transition) {
        result := ComCall(8, this, "double", duration, "double", period, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSinusoidalTransitionFromRange(duration, minimumValue, maximumValue, period, slope, transition) {
        result := ComCall(9, this, "double", duration, "double", minimumValue, "double", maximumValue, "double", period, "int", slope, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateAccelerateDecelerateTransition(duration, finalValue, accelerationRatio, decelerationRatio, transition) {
        result := ComCall(10, this, "double", duration, "double", finalValue, "double", accelerationRatio, "double", decelerationRatio, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateReversalTransition(duration, transition) {
        result := ComCall(11, this, "double", duration, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateCubicTransition(duration, finalValue, finalVelocity, transition) {
        result := ComCall(12, this, "double", duration, "double", finalValue, "double", finalVelocity, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSmoothStopTransition(maximumDuration, finalValue, transition) {
        result := ComCall(13, this, "double", maximumDuration, "double", finalValue, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateParabolicTransitionFromAcceleration(finalValue, finalVelocity, acceleration, transition) {
        result := ComCall(14, this, "double", finalValue, "double", finalVelocity, "double", acceleration, "ptr", transition, "int")
        if(result != 0)
            throw OSError(result)
