 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nn-uianimation-iuianimationinterpolator2
...
class IUIAnimationInterpolator2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-getdimension
     */
    GetDimension() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-setinitialvalueandvelocity
     */
    SetInitialValueAndVelocity(initialValue, initialVelocity, cDimension) {
        ...
        result := ComCall(4, this, initialValueMarshal, initialValue, initialVelocityMarshal, initialVelocity, "uint", cDimension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if successful; otherwise an <b>HRESULT</b> error code. See <a href="https://docs.microsoft.com/windows/desktop/UIAnimation/uianimation-error-codes">Windows Animation Error Codes</a> for a list of error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-setduration
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-getduration
     */
    GetDuration() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-getfinalvalue
     */
    GetFinalValue(cDimension) {
        result := ComCall(7, this, "double*", &value := 0, "uint", cDimension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-interpolatevalue
     */
    InterpolateValue(offset, cDimension) {
        result := ComCall(8, this, "double", offset, "double*", &value := 0, "uint", cDimension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-interpolatevelocity
     */
    InterpolateVelocity(offset, cDimension) {
        result := ComCall(9, this, "double", offset, "double*", &velocity := 0, "uint", cDimension, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-getprimitiveinterpolation
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns S_OK. Otherwise, it returns an  <b>HRESULT</b> error code. See <a href="https://docs.microsoft.com/windows/desktop/UIAnimation/uianimation-error-codes">Windows Animation Error Codes</a> for a list of error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationinterpolator2-getdependencies
     */
    GetDependencies(initialValueDependencies, initialVelocityDependencies, durationDependencies) {
        ...
        result := ComCall(11, this, initialValueDependenciesMarshal, initialValueDependencies, initialVelocityDependenciesMarshal, initialVelocityDependencies, durationDependenciesMarshal, durationDependencies, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
