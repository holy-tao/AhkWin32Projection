 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nn-uianimation-iuianimationvariablechangehandler
...
class IUIAnimationVariableChangeHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationvariablechangehandler-onvaluechanged
     */
    OnValueChanged(storyboard, variable, newValue, previousValue) {
        result := ComCall(3, this, "ptr", storyboard, "ptr", variable, "double", newValue, "double", previousValue, "int")
        if(result != 0) {
