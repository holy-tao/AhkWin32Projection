 ...
 * @see https://learn.microsoft.com/windows/win32/api/uianimation/ne-uianimation-ui_animation_scheduling_result
 * @namespace Windows.Win32.UI.Animation
 */
export default struct UI_ANIMATION_SCHEDULING_RESULT {
    value : Int32
