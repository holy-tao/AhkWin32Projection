 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nn-uianimation-iuianimationtransitionfactory2
...
class IUIAnimationTransitionFactory2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uianimation/nf-uianimation-iuianimationtransitionfactory2-createtransition
     */
    CreateTransition(interpolator) {
        result := ComCall(3, this, "ptr", interpolator, "ptr*", &transition := 0, "int")
        if(result != 0) {
