 ...
 */
export default struct IUIAnimationVariableIntegerChangeHandler extends IUnknown {
    /**
     ...
     * used for IUIAnimationVariableIntegerChangeHandler interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IUIAnimationVariableIntegerChangeHandler.Vtbl()
        }
    ...
    Query(iid) {
        if (IUIAnimationVariableIntegerChangeHandler.IID.Equals(iid)) {
            return true
        }
