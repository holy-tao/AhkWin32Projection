...
export default struct IUIAnimationManager2 extends IUnknown {
    ...
    */
    ...
    GetVariableFromTag(_object, id) {
        ...
        result := ComCall(10, this, _objectMarshal, _object, UInt32, id, "ptr*", &variable := 0, "HRESULT")
        return IUIAnimationVariable2(variable)
    }
    ...
    GetStoryboardFromTag(_object, id) {
        ...
        result := ComCall(11, this, _objectMarshal, _object, UInt32, id, "ptr*", &storyboard := 0, "HRESULT")
        return IUIAnimationStoryboard2(storyboard)
    }
    ...
    SetManagerEventHandler(handler, fRegisterForNextAnimationEvent) {
        ...
        result := ComCall(17, this, handlerMarshal, handler, BOOL, fRegisterForNextAnimationEvent, "HRESULT")
        return result
    }
    ...
    SetCompressPriorityComparison(comparison) {
        ...
        result := ComCall(20, this, comparisonMarshal, comparison, "HRESULT")
        return result
    }
    ...
    SetConcludePriorityComparison(comparison) {
        ...
        result := ComCall(21, this, comparisonMarshal, comparison, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.CreateAnimationVectorVariable := CallbackCreate(ObjBindMethod(implObj, "CreateAnimationVectorVariable"), flags, 4)
        ...
        this.vtbl.EstimateNextEventTime := CallbackCreate(ObjBindMethod(implObj, "EstimateNextEventTime"), flags, 2)
        ...
        this.vtbl.SetManagerEventHandler := CallbackCreate(ObjBindMethod(implObj, "SetManagerEventHandler"), flags, 3)
