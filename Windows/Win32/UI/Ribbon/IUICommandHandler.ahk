 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nn-uiribbon-iuicommandhandler
...
class IUICommandHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nf-uiribbon-iuicommandhandler-execute
     */
    Execute(commandId, verb, key, currentValue, commandExecutionProperties) {
        result := ComCall(3, this, "uint", commandId, "int", verb, "ptr", key, "ptr", currentValue, "ptr", commandExecutionProperties, "int")
        if(result != 0) {
     ...
     * 					<i>key</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nf-uiribbon-iuicommandhandler-updateproperty
     */
    UpdateProperty(commandId, key, currentValue) {
        newValue := PROPVARIANT()
        result := ComCall(4, this, "uint", commandId, "ptr", key, "ptr", currentValue, "ptr", newValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
