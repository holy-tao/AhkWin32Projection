 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nn-uiribbon-iuicollectionchangedevent
...
class IUICollectionChangedEvent extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nf-uiribbon-iuicollectionchangedevent-onchanged
     */
    OnChanged(action, oldIndex, oldItem, newIndex, newItem) {
        result := ComCall(3, this, "int", action, "uint", oldIndex, "ptr", oldItem, "uint", newIndex, "ptr", newItem, "int")
        if(result != 0) {
