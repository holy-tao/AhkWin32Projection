 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nn-uiribbon-iuisimplepropertyset
...
class IUISimplePropertySet extends IUnknown{
     ...
     * 					<i>key</i>.
     * @see https://learn.microsoft.com/windows/win32/api//content/uiribbon/nf-uiribbon-iuisimplepropertyset-getvalue
     */
    GetValue(key) {
        value := PROPVARIANT()
