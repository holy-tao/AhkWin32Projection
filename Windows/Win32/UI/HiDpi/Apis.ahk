 ...
 * @since windows10.0.15063
 */
export SetDialogControlDpiChangeBehavior(_hWnd, mask, values) {
    A_LastError := 0

    result := DllCall("USER32.dll\SetDialogControlDpiChangeBehavior", HWND, _hWnd, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, mask, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, values, BOOL)
 ...
 * @since windows10.0.15063
 */
export GetDialogControlDpiChangeBehavior(_hWnd) {
    A_LastError := 0

    result := DllCall("USER32.dll\GetDialogControlDpiChangeBehavior", HWND, _hWnd, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows10.0.15063
 */
export SetDialogDpiChangeBehavior(hDlg, mask, values) {
    A_LastError := 0

    result := DllCall("USER32.dll\SetDialogDpiChangeBehavior", HWND, hDlg, DIALOG_DPI_CHANGE_BEHAVIORS, mask, DIALOG_DPI_CHANGE_BEHAVIORS, values, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows10.0.15063
 */
export GetDialogDpiChangeBehavior(hDlg) {
    A_LastError := 0

    result := DllCall("USER32.dll\GetDialogDpiChangeBehavior", HWND, hDlg, DIALOG_DPI_CHANGE_BEHAVIORS)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows10.0.14393
 */
export SetThreadDpiAwarenessContext(dpiContext) {
    result := DllCall("USER32.dll\SetThreadDpiAwarenessContext", DPI_AWARENESS_CONTEXT, dpiContext, DPI_AWARENESS_CONTEXT)
    return result
}
...
export GetThreadDpiAwarenessContext() {
    result := DllCall("USER32.dll\GetThreadDpiAwarenessContext", DPI_AWARENESS_CONTEXT)
    return result
}
 ...
 * @since windows10.0.14393
 */
export GetWindowDpiAwarenessContext(_hwnd) {
    result := DllCall("USER32.dll\GetWindowDpiAwarenessContext", HWND, _hwnd, DPI_AWARENESS_CONTEXT)
    return result
}
 ...
 * @since windows10.0.14393
 */
export GetAwarenessFromDpiAwarenessContext(value) {
    result := DllCall("USER32.dll\GetAwarenessFromDpiAwarenessContext", DPI_AWARENESS_CONTEXT, value, DPI_AWARENESS)
    return result
}
 ...
 */
export GetDpiFromDpiAwarenessContext(value) {
    result := DllCall("USER32.dll\GetDpiFromDpiAwarenessContext", DPI_AWARENESS_CONTEXT, value, UInt32)
    return result
}
 ...
 * @since windows10.0.14393
 */
export AreDpiAwarenessContextsEqual(dpiContextA, dpiContextB) {
    result := DllCall("USER32.dll\AreDpiAwarenessContextsEqual", DPI_AWARENESS_CONTEXT, dpiContextA, DPI_AWARENESS_CONTEXT, dpiContextB, BOOL)
    return result
}
 ...
 * @since windows10.0.14393
 */
export IsValidDpiAwarenessContext(value) {
    result := DllCall("USER32.dll\IsValidDpiAwarenessContext", DPI_AWARENESS_CONTEXT, value, BOOL)
    return result
}
 ...
 * @since windows10.0.14393
 */
export GetDpiForWindow(_hwnd) {
    result := DllCall("USER32.dll\GetDpiForWindow", HWND, _hwnd, UInt32)
    return result
}
...
export GetDpiForSystem() {
    result := DllCall("USER32.dll\GetDpiForSystem", UInt32)
    return result
}
 ...
 * @since windows10.0.17134
 */
export GetSystemDpiForProcess(hProcess) {
    result := DllCall("USER32.dll\GetSystemDpiForProcess", HANDLE, hProcess, UInt32)
    return result
}
 ...
 * @since windows10.0.14393
 */
export EnableNonClientDpiScaling(_hwnd) {
    A_LastError := 0

    result := DllCall("USER32.dll\EnableNonClientDpiScaling", HWND, _hwnd, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows10.0.15063
 */
export SetProcessDpiAwarenessContext(value) {
    A_LastError := 0

    result := DllCall("USER32.dll\SetProcessDpiAwarenessContext", DPI_AWARENESS_CONTEXT, value, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export GetDpiAwarenessContextForProcess(hProcess) {
    result := DllCall("USER32.dll\GetDpiAwarenessContextForProcess", HANDLE, hProcess, DPI_AWARENESS_CONTEXT)
    return result
}
 ...
 * @since windows10.0.17134
 */
export SetThreadDpiHostingBehavior(value) {
    result := DllCall("USER32.dll\SetThreadDpiHostingBehavior", DPI_HOSTING_BEHAVIOR, value, DPI_HOSTING_BEHAVIOR)
    return result
}
 ...
 * @since windows10.0.17134
 */
export GetThreadDpiHostingBehavior() {
    result := DllCall("USER32.dll\GetThreadDpiHostingBehavior", DPI_HOSTING_BEHAVIOR)
    return result
}
 ...
 * @since windows10.0.17134
 */
export GetWindowDpiHostingBehavior(_hwnd) {
    result := DllCall("USER32.dll\GetWindowDpiHostingBehavior", HWND, _hwnd, DPI_HOSTING_BEHAVIOR)
    return result
}
 ...
 * @since windows8.1
 */
export SetProcessDpiAwareness(value) {
    result := DllCall("api-ms-win-shcore-scaling-l1-1-1.dll\SetProcessDpiAwareness", PROCESS_DPI_AWARENESS, value, "HRESULT")
    return result
}
