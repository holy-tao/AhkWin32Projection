...
;@region Methods
     ...
     * @param {HWND} hwnd_ The handle of the window for which theme data is required.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/uxtheme/nf-uxtheme-openthemedatafordpi
     * @since windows10.0.15063
     */
    static OpenThemeDataForDpi(hwnd_, pszClassList, dpi) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        pszClassList := pszClassList is String ? StrPtr(pszClassList) : pszClassList

        result := DllCall("UxTheme.dll\OpenThemeDataForDpi", "ptr", hwnd_, "ptr", pszClassList, "uint", dpi, "ptr")
     ...
     * @param {HWND} hWnd_ A handle for the window whose behavior will be modified.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-setdialogcontroldpichangebehavior
     * @since windows10.0.15063
     */
    static SetDialogControlDpiChangeBehavior(hWnd_, mask, values) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        A_LastError := 0

        result := DllCall("USER32.dll\SetDialogControlDpiChangeBehavior", "ptr", hWnd_, "int", mask, "int", values, "int")
     ...
     * @param {HWND} hWnd_ The handle for the window to examine.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getdialogcontroldpichangebehavior
     * @since windows10.0.15063
     */
    static GetDialogControlDpiChangeBehavior(hWnd_) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        A_LastError := 0

        result := DllCall("USER32.dll\GetDialogControlDpiChangeBehavior", "ptr", hWnd_, "int")
        if(A_LastError) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-setdialogdpichangebehavior
     * @since windows10.0.15063
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getdialogdpichangebehavior
     * @since windows10.0.15063
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getsystemmetricsfordpi
     ...
     * 
     * If the function fails, the return value is zero. To get extended error information, call <a href="https://docs.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror">GetLastError</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-adjustwindowrectexfordpi
     * @since windows10.0.14393
     */
     ...
     * </div>
     * <div> </div>
     * @param {HWND} hWnd_ A handle to the window whose transform is used for the conversion.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-logicaltophysicalpointforpermonitordpi
     * @since windows8.1
     */
    static LogicalToPhysicalPointForPerMonitorDPI(hWnd_, lpPoint) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        result := DllCall("USER32.dll\LogicalToPhysicalPointForPerMonitorDPI", "ptr", hWnd_, "ptr", lpPoint, "int")
        return result
    }
     ...
     * @returns {BOOL} Returns <b>TRUE</b> if successful, or <b>FALSE</b> otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-physicaltologicalpointforpermonitordpi
     * @since windows8.1
     */
    static PhysicalToLogicalPointForPerMonitorDPI(hWnd_, lpPoint) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        result := DllCall("USER32.dll\PhysicalToLogicalPointForPerMonitorDPI", "ptr", hWnd_, "ptr", lpPoint, "int")
        return result
    }
     ...
     * 
     * If the function fails, the return value is zero. To get extended error information, call <a href="https://docs.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror">GetLastError</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-systemparametersinfofordpi
     * @since windows10.0.14393
     */
     ...
     * @param {DPI_AWARENESS_CONTEXT} dpiContext The new <a href="https://docs.microsoft.com/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> for the current thread. This context includes the <a href="https://docs.microsoft.com/windows/desktop/api/windef/ne-windef-dpi_awareness">DPI_AWARENESS</a> value.
     * @returns {DPI_AWARENESS_CONTEXT} The old <a href="https://docs.microsoft.com/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> for the thread. If the <i>dpiContext</i> is invalid, the thread will not be updated and the return value will be <b>NULL</b>. You can use this value to restore the old <b>DPI_AWARENESS_CONTEXT</b> after overriding it with a predefined value.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-setthreaddpiawarenesscontext
     * @since windows10.0.14393
     */
     ...
     * @returns {DPI_AWARENESS_CONTEXT} The current <a href="https://docs.microsoft.com/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> for the thread.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getthreaddpiawarenesscontext
     * @since windows10.0.14393
     */
     ...
     * </div>
     * <div> </div>
     * @param {HWND} hwnd_ The window to query.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getwindowdpiawarenesscontext
     * @since windows10.0.14393
     */
    static GetWindowDpiAwarenessContext(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("USER32.dll\GetWindowDpiAwarenessContext", "ptr", hwnd_, "ptr")
        resultHandle := DPI_AWARENESS_CONTEXT({Value: result}, True)
        return resultHandle
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getawarenessfromdpiawarenesscontext
     * @since windows10.0.14393
     */
     ...
     * @param {DPI_AWARENESS_CONTEXT} value The <b>DPI_AWARENESS_CONTEXT</b> handle to examine.
     * @returns {Integer} The DPI value associated with the <b>DPI_AWARENESS_CONTEXT</b> handle.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getdpifromdpiawarenesscontext
     ...
     * @param {DPI_AWARENESS_CONTEXT} dpiContextA The first value to compare.
     * @param {DPI_AWARENESS_CONTEXT} dpiContextB The second value to compare.
     * @returns {BOOL} Returns <b>TRUE</b> if the values are equal, otherwise <b>FALSE</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-aredpiawarenesscontextsequal
     * @since windows10.0.14393
     */
     ...
     * @param {DPI_AWARENESS_CONTEXT} value The context that you want to determine if it is supported.
     * @returns {BOOL} <b>TRUE</b> if the provided context is supported, otherwise <b>FALSE</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-isvaliddpiawarenesscontext
     * @since windows10.0.14393
     */
     ...
     * </tr>
     * </table>
     * @param {HWND} hwnd_ The window that you want to get information about.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getdpiforwindow
     * @since windows10.0.14393
     */
    static GetDpiForWindow(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("USER32.dll\GetDpiForWindow", "ptr", hwnd_, "uint")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getdpiforsystem
     * @since windows10.0.14393
     */
     ...
     * @param {HANDLE} hProcess The handle for the process to examine. If this value is null, this API behaves identically to <a href="https://docs.microsoft.com/windows/desktop/api/winuser/nf-winuser-getdpiforsystem">GetDpiForSystem</a>.
     * @returns {Integer} The process's system DPI value.
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getsystemdpiforprocess
     * @since windows10.0.17134
     */
     ...
     * }
     * ```
     * @param {HWND} hwnd_ The window that should have automatic scaling enabled.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-enablenonclientdpiscaling
     * @since windows10.0.14393
     */
    static EnableNonClientDpiScaling(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        A_LastError := 0

        result := DllCall("USER32.dll\EnableNonClientDpiScaling", "ptr", hwnd_, "int")
        if((!result && A_LastError)) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {DPI_AWARENESS_CONTEXT} value A <a href="https://docs.microsoft.com/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> handle to set.
     * @returns {BOOL} This function returns TRUE if the operation was successful, and FALSE otherwise. To get extended error information, call <a href="https://docs.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror">GetLastError</a>.
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-setprocessdpiawarenesscontext
     * @since windows10.0.15063
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-setthreaddpihostingbehavior
     * @since windows10.0.17134
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getthreaddpihostingbehavior
     * @since windows10.0.17134
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winuser/nf-winuser-getwindowdpihostingbehavior
     * @since windows10.0.17134
     */
    static GetWindowDpiHostingBehavior(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("USER32.dll\GetWindowDpiHostingBehavior", "ptr", hwnd_, "int")
        return result
    }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shellscalingapi/nf-shellscalingapi-setprocessdpiawareness
     * @since windows8.1
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/shellscalingapi/nf-shellscalingapi-getprocessdpiawareness
     * @since windows8.1
     */
     ...
     * @param {HMONITOR} hmonitor_ Handle of the monitor being queried.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/shellscalingapi/nf-shellscalingapi-getdpiformonitor
     * @since windows8.1
     */
    static GetDpiForMonitor(hmonitor_, dpiType, dpiX, dpiY) {
        ...
        result := DllCall("api-ms-win-shcore-scaling-l1-1-1.dll\GetDpiForMonitor", "ptr", hmonitor_, "int", dpiType, dpiXMarshal, dpiX, dpiYMarshal, dpiY, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
