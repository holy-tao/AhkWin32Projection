...
;@region Methods
     ...
     * @returns {HTHEME} See <a href="/windows/desktop/api/uxtheme/nf-uxtheme-openthemedata">OpenThemeData</a>.
     ...
     * @returns {BOOL} This function returns TRUE if the operation was successful, and FALSE otherwise. To get extended error information, call <a href="/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror">GetLastError</a>.
     * 
     ...
     * @returns {DPI_AWARENESS_CONTEXT} The current <a href="/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> for the thread.
     ...
     * @returns {DPI_AWARENESS_CONTEXT} The <a href="/windows/desktop/hidpi/dpi-awareness-context">DPI_AWARENESS_CONTEXT</a> for the provided window. If the window is not valid, the return value is <b>NULL</b>.
     ...
     * @param {HWND} hwnd The window you want to get information about.
