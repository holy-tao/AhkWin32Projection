 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nn-wsmandisp-iwsmanresourcelocator
...
class IWSManResourceLocator extends IDispatch{
     ...
     * @param {BSTR} uri 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-put_resourceuri
     */
    put_ResourceURI(uri) {
        if(uri is String) {
            pin := BSTR.Alloc(uri)
        ...
        result := ComCall(7, this, "ptr", uri, "int")
        if(result != 0) {
     ...
     * The corresponding scripting method is <a href="https://docs.microsoft.com/windows/desktop/WinRM/resourcelocator-resourceuri">ResourceLocator.ResourceURI</a>.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-get_resourceuri
     */
    get_ResourceURI() {
        uri := BSTR()
        result := ComCall(8, this, "ptr", uri, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-addselector
     */
    AddSelector(resourceSelName, selValue) {
        if(resourceSelName is String) {
            pin := BSTR.Alloc(resourceSelName)
            resourceSelName := pin.Value
        }

        result := ComCall(9, this, "ptr", resourceSelName, "ptr", selValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-clearselectors
     */
    ClearSelectors() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-get_fragmentpath
     */
    get_FragmentPath() {
        text := BSTR()
     ...
     * @param {BSTR} text 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-put_fragmentpath
     */
    put_FragmentPath(text) {
        ...
        result := ComCall(12, this, "ptr", text, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-get_fragmentdialect
     */
    get_FragmentDialect() {
        text := BSTR()
        result := ComCall(13, this, "ptr", text, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BSTR} text 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-put_fragmentdialect
     */
    put_FragmentDialect(text) {
        ...
        result := ComCall(14, this, "ptr", text, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-addoption
     */
    AddOption(OptionName, OptionValue, mustComply) {
        ...
        result := ComCall(15, this, "ptr", OptionName, "ptr", OptionValue, "int", mustComply, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-put_mustunderstandoptions
     */
    put_MustUnderstandOptions(mustUnderstand) {
        result := ComCall(16, this, "int", mustUnderstand, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-get_mustunderstandoptions
     */
    get_MustUnderstandOptions() {
        result := ComCall(17, this, "int*", &mustUnderstand := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-clearoptions
     */
    ClearOptions() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanresourcelocator-get_error
     */
    get_Error() {
        value := BSTR()
