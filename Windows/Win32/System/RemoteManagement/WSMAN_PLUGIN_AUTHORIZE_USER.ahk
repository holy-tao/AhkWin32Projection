 ...
 * @see https://learn.microsoft.com/windows/win32/api/wsman/nc-wsman-wsman_plugin_authorize_user
 * @namespace Windows.Win32.System.RemoteManagement
 */
export default struct WSMAN_PLUGIN_AUTHORIZE_USER {
    value : IntPtr

    __value {
        set {
            if (value is WSMAN_PLUGIN_AUTHORIZE_USER) {
     ...
     * @param {Pointer<WSMAN_SENDER_DETAILS>} senderDetails A pointer  to the <a href="https://docs.microsoft.com/windows/desktop/api/wsman/ns-wsman-wsman_sender_details">WSMAN_SENDER_DETAILS</a> structure that specifies the identification information of the user to be authorized.
    ...
    /**
     * A WSMAN_PLUGIN_AUTHORIZE_USER that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WSMAN_PLUGIN_AUTHORIZE_USER {
        /**
         * Creates a WSMAN_PLUGIN_AUTHORIZE_USER pointer that invokes the given AHK function when called.
