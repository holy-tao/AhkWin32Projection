 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nn-wsmandisp-iwsmanconnectionoptionsex2
...
class IWSManConnectionOptionsEx2 extends IWSManConnectionOptionsEx{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-setproxy
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxyieconfig
     */
    ProxyIEConfig() {
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxywinhttpconfig
     */
    ProxyWinHttpConfig() {
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxyautodetect
     */
    ProxyAutoDetect() {
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxynoproxyserver
     */
    ProxyNoProxyServer() {
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxyauthenticationusenegotiate
     */
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxyauthenticationusebasic
     */
     ...
     * @returns {Integer} Specifies the value of the constant.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptionsex2-proxyauthenticationusedigest
     */
