...
export default struct IWSManEx extends IWSMan {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.CreateResourceLocator := CallbackCreate(ObjBindMethod(implObj, "CreateResourceLocator"), flags, 3)
        this.vtbl.SessionFlagUTF8 := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUTF8"), flags, 2)
        this.vtbl.SessionFlagCredUsernamePassword := CallbackCreate(ObjBindMethod(implObj, "SessionFlagCredUsernamePassword"), flags, 2)
        this.vtbl.SessionFlagSkipCACheck := CallbackCreate(ObjBindMethod(implObj, "SessionFlagSkipCACheck"), flags, 2)
        this.vtbl.SessionFlagSkipCNCheck := CallbackCreate(ObjBindMethod(implObj, "SessionFlagSkipCNCheck"), flags, 2)
        this.vtbl.SessionFlagUseDigest := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUseDigest"), flags, 2)
        this.vtbl.SessionFlagUseNegotiate := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUseNegotiate"), flags, 2)
        this.vtbl.SessionFlagUseBasic := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUseBasic"), flags, 2)
        this.vtbl.SessionFlagUseKerberos := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUseKerberos"), flags, 2)
        this.vtbl.SessionFlagNoEncryption := CallbackCreate(ObjBindMethod(implObj, "SessionFlagNoEncryption"), flags, 2)
        this.vtbl.SessionFlagEnableSPNServerPort := CallbackCreate(ObjBindMethod(implObj, "SessionFlagEnableSPNServerPort"), flags, 2)
        this.vtbl.SessionFlagUseNoAuthentication := CallbackCreate(ObjBindMethod(implObj, "SessionFlagUseNoAuthentication"), flags, 2)
        this.vtbl.EnumerationFlagNonXmlText := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagNonXmlText"), flags, 2)
        this.vtbl.EnumerationFlagReturnEPR := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagReturnEPR"), flags, 2)
        this.vtbl.EnumerationFlagReturnObjectAndEPR := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagReturnObjectAndEPR"), flags, 2)
        this.vtbl.GetErrorMessage := CallbackCreate(ObjBindMethod(implObj, "GetErrorMessage"), flags, 3)
        this.vtbl.EnumerationFlagHierarchyDeep := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagHierarchyDeep"), flags, 2)
        this.vtbl.EnumerationFlagHierarchyShallow := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagHierarchyShallow"), flags, 2)
        this.vtbl.EnumerationFlagHierarchyDeepBasePropsOnly := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagHierarchyDeepBasePropsOnly"), flags, 2)
        this.vtbl.EnumerationFlagReturnObject := CallbackCreate(ObjBindMethod(implObj, "EnumerationFlagReturnObject"), flags, 2)
    }
