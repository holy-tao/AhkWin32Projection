...
class WSManProxyAuthenticationFlags extends Win32Enum {
     ...
     * Native name: WSManFlagProxyAuthenticationUseNegotiate
     * @type {Integer (Int32)}
     */
    static FlagProxyAuthenticationUseNegotiate => 1
     ...
     * Native name: WSManFlagProxyAuthenticationUseBasic
     * @type {Integer (Int32)}
     */
    static FlagProxyAuthenticationUseBasic => 2
     ...
     * Native name: WSManFlagProxyAuthenticationUseDigest
     * @type {Integer (Int32)}
     */
    static FlagProxyAuthenticationUseDigest => 4
}
