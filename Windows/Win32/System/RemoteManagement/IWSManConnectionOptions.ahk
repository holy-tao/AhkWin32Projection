 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nn-wsmandisp-iwsmanconnectionoptions
...
class IWSManConnectionOptions extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptions-get_username
     */
    get_UserName() {
        name := BSTR()
     ...
     * @param {BSTR} name 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptions-put_username
     */
    put_UserName(name) {
        if(name is String) {
            pin := BSTR.Alloc(name)
     ...
     * @param {BSTR} password 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wsmandisp/nf-wsmandisp-iwsmanconnectionoptions-put_password
     */
