 ...
 * @version v4.0.30319
 */
class HDV_PCI_READ_CONFIG_SPACE extends IUnknown {
     ...
     */
    Invoke(deviceContext, offset) {
        deviceContextMarshal := deviceContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, deviceContextMarshal, deviceContext, "uint", offset, "uint*", &value := 0, "int")
        if(result != 0) {
