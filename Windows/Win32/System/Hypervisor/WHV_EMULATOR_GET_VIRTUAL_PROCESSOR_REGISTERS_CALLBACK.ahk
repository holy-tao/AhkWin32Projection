 ...
 */
export default struct WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK) {
    ...
    /**
     * A WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK {
        /**
         * Creates a WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK pointer that invokes the given AHK function when called.
