 ...
 * @version v4.0.30319
 */
class HDV_PCI_WRITE_CONFIG_SPACE extends IUnknown {
     ...
     */
    Invoke(deviceContext, offset, value) {
        deviceContextMarshal := deviceContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, deviceContextMarshal, deviceContext, "uint", offset, "uint", value, "int")
        if(result != 0) {
