...
#Import ".\IDtcLuRecovery.ahk" { IDtcLuRecovery }
 ...
 */
export default struct IDtcLuRecoveryFactory extends IUnknown {
    /**
     ...
     * used for IDtcLuRecoveryFactory interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDtcLuRecoveryFactory.Vtbl()
        }
