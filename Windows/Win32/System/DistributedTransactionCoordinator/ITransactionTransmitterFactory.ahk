...
#Import ".\ITransactionTransmitter.ahk" { ITransactionTransmitter }
#Import "..\Com\IUnknown.ahk" { IUnknown }

/**
 * @namespace Windows.Win32.System.DistributedTransactionCoordinator
 */
export default struct ITransactionTransmitterFactory extends IUnknown {
    /**
     ...
     * used for ITransactionTransmitterFactory interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ITransactionTransmitterFactory.Vtbl()
        }
    ...
    Query(iid) {
        if (ITransactionTransmitterFactory.IID.Equals(iid)) {
            return true
        }
