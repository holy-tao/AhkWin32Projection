 ...
 */
export default struct ITipPullSink extends IUnknown {
    /**
     ...
     * used for ITipPullSink interfaces
    */
    ...
    Query(iid) {
        if (ITipPullSink.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.PullComplete)
    }
}
