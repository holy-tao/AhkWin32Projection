...
;@region Methods
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ual/nf-ual-ualstart
     * @since windows8.0
     */
     ...
     * Only the <b>RoleGuid</b> property of the <a href="https://docs.microsoft.com/windows/desktop/api/ual/ns-ual-ual_data_blob">UAL_DATA_BLOB</a> structure is required. All other members can be null.
     * @returns {HRESULT} If the function succeeds, it returns <b>S_OK</b>. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/ual/nf-ual-ualstop
     * @since windows8.0
     */
    static UalStop(Data) {
     ...
     * @returns {HRESULT} If the function succeeds, it returns <b>S_OK</b>. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/ual/nf-ual-ualinstrument
     * @since windows8.0
     */
     ...
     * @returns {HRESULT} If the function succeeds, it returns <b>S_OK</b>. If it fails, it returns an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/ual/nf-ual-ualregisterproduct
     * @since windows8.0
     */
