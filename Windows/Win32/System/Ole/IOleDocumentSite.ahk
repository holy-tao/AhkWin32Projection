 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nn-docobj-ioledocumentsite
...
class IOleDocumentSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nf-docobj-ioledocumentsite-activateme
     */
    ActivateMe(pViewToActivate) {
        result := ComCall(3, this, "ptr", pViewToActivate, "int")
        if(result != 0) {
