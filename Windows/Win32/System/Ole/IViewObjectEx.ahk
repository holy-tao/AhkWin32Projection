 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-iviewobjectex
...
class IViewObjectEx extends IViewObject2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iviewobjectex-getrect
     */
    GetRect(dwAspect) {
        pRect := RECTL()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iviewobjectex-getviewstatus
     */
    GetViewStatus() {
        result := ComCall(11, this, "uint*", &pdwStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iviewobjectex-queryhitpoint
     */
    QueryHitPoint(dwAspect, pRectBounds, ptlLoc, lCloseHint) {
        result := ComCall(12, this, "uint", dwAspect, "ptr", pRectBounds, "ptr", ptlLoc, "int", lCloseHint, "uint*", &pHitResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iviewobjectex-queryhitrect
     */
    QueryHitRect(dwAspect, pRectBounds, pRectLoc, lCloseHint) {
        result := ComCall(13, this, "uint", dwAspect, "ptr", pRectBounds, "ptr", pRectLoc, "int", lCloseHint, "uint*", &pHitResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iviewobjectex-getnaturalextent
     */
