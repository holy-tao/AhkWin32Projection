...
export default struct IFont extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_Bold := CallbackCreate(ObjBindMethod(implObj, "put_Bold"), flags, 2)
        this.vtbl.get_Italic := CallbackCreate(ObjBindMethod(implObj, "get_Italic"), flags, 2)
        this.vtbl.put_Italic := CallbackCreate(ObjBindMethod(implObj, "put_Italic"), flags, 2)
        this.vtbl.get_Underline := CallbackCreate(ObjBindMethod(implObj, "get_Underline"), flags, 2)
        this.vtbl.put_Underline := CallbackCreate(ObjBindMethod(implObj, "put_Underline"), flags, 2)
        this.vtbl.get_Strikethrough := CallbackCreate(ObjBindMethod(implObj, "get_Strikethrough"), flags, 2)
        this.vtbl.put_Strikethrough := CallbackCreate(ObjBindMethod(implObj, "put_Strikethrough"), flags, 2)
        this.vtbl.get_Weight := CallbackCreate(ObjBindMethod(implObj, "get_Weight"), flags, 2)
        this.vtbl.put_Weight := CallbackCreate(ObjBindMethod(implObj, "put_Weight"), flags, 2)
        ...
        this.vtbl.get_hFont := CallbackCreate(ObjBindMethod(implObj, "get_hFont"), flags, 2)
        ...
        this.vtbl.SetRatio := CallbackCreate(ObjBindMethod(implObj, "SetRatio"), flags, 3)
        this.vtbl.QueryTextMetrics := CallbackCreate(ObjBindMethod(implObj, "QueryTextMetrics"), flags, 2)
        this.vtbl.AddRefHfont := CallbackCreate(ObjBindMethod(implObj, "AddRefHfont"), flags, 2)
        this.vtbl.ReleaseHfont := CallbackCreate(ObjBindMethod(implObj, "ReleaseHfont"), flags, 2)
        this.vtbl.SetHdc := CallbackCreate(ObjBindMethod(implObj, "SetHdc"), flags, 2)
    }
