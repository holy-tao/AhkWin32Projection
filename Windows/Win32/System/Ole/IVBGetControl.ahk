 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/vbinterf/nn-vbinterf-ivbgetcontrol
...
class IVBGetControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/vbinterf/nf-vbinterf-ivbgetcontrol-enumcontrols
     */
    EnumControls(dwOleContF, dwWhich) {
        result := ComCall(3, this, "uint", dwOleContF, "uint", dwWhich, "ptr*", &ppenumUnk := 0, "int")
        if(result != 0) {
