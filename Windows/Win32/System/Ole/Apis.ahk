 ...
 */
export SafeArrayAllocData(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayAllocData", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayCopyData(psaSource, psaTarget) {
    result := DllCall("OLEAUT32.dll\SafeArrayCopyData", SAFEARRAY.Ptr, psaSource, SAFEARRAY.Ptr, psaTarget, "HRESULT")
    return result
}
 ...
 */
export SafeArrayReleaseDescriptor(psa) {
    DllCall("OLEAUT32.dll\SafeArrayReleaseDescriptor", SAFEARRAY.Ptr, psa)
}
 ...
 */
export SafeArrayDestroyDescriptor(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayDestroyDescriptor", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayDestroyData(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayDestroyData", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 * @since windows5.1.2600
 */
export SafeArrayAddRef(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayAddRef", SAFEARRAY.Ptr, psa, "ptr*", &ppDataToRelease := 0, "HRESULT")
 ...
 */
export SafeArrayDestroy(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayDestroy", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayRedim(psa, psaboundNew) {
    result := DllCall("OLEAUT32.dll\SafeArrayRedim", SAFEARRAY.Ptr, psa, SAFEARRAYBOUND.Ptr, psaboundNew, "HRESULT")
    return result
}
 ...
 */
export SafeArrayGetDim(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayGetDim", SAFEARRAY.Ptr, psa, UInt32)
    return result
}
 ...
 */
export SafeArrayGetElemsize(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayGetElemsize", SAFEARRAY.Ptr, psa, UInt32)
    return result
}
 ...
 */
export SafeArrayLock(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayLock", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayUnlock(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayUnlock", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayAccessData(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayAccessData", SAFEARRAY.Ptr, psa, "ptr*", &ppvData := 0, "HRESULT")
    return ppvData
}
 ...
 */
export SafeArrayUnaccessData(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayUnaccessData", SAFEARRAY.Ptr, psa, "HRESULT")
    return result
}
 ...
 */
export SafeArrayCopy(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayCopy", SAFEARRAY.Ptr, psa, "ptr*", &ppsaOut := 0, "HRESULT")
    return ppsaOut
}
 ...
 */
export SafeArraySetRecordInfo(psa, prinfo) {
    result := DllCall("OLEAUT32.dll\SafeArraySetRecordInfo", SAFEARRAY.Ptr, psa, "ptr", prinfo, "HRESULT")
    return result
}
 ...
 */
export SafeArrayGetRecordInfo(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayGetRecordInfo", SAFEARRAY.Ptr, psa, "ptr*", &prinfo := 0, "HRESULT")
 ...
 */
export SafeArraySetIID(psa, guid) {
    result := DllCall("OLEAUT32.dll\SafeArraySetIID", SAFEARRAY.Ptr, psa, Guid.Ptr, guid, "HRESULT")
    return result
}
 ...
 */
export SafeArrayGetIID(psa, pguid) {
    result := DllCall("OLEAUT32.dll\SafeArrayGetIID", SAFEARRAY.Ptr, psa, Guid.Ptr, pguid, "HRESULT")
    return result
}
 ...
 */
export SafeArrayGetVartype(psa) {
    result := DllCall("OLEAUT32.dll\SafeArrayGetVartype", SAFEARRAY.Ptr, psa, "ushort*", &pvt := 0, "HRESULT")
    return pvt
}
 ...
 */
export VectorFromBstr(_bstr) {
    result := DllCall("OLEAUT32.dll\VectorFromBstr", BSTR, _bstr, "ptr*", &ppsa := 0, "HRESULT")
    return ppsa
}
 ...
 */
export BstrFromVector(psa) {
    pbstr := BSTR.Owned()
    result := DllCall("OLEAUT32.dll\BstrFromVector", SAFEARRAY.Ptr, psa, BSTR.Ptr, pbstr, "HRESULT")
    return pbstr
}
 ...
 */
export VarUI1FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarUI1FromCy", CY, cyIn, "char*", &pbOut := 0, "HRESULT")
    return pbOut
}
 ...
 */
export VarUI1FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarUI1FromBool", VARIANT_BOOL, boolIn, "char*", &pbOut := 0, "HRESULT")
    return pbOut
}
 ...
 */
export VarUI1FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarUI1FromI1", CHAR, cIn, "char*", &pbOut := 0, "HRESULT")
    return pbOut
}
 ...
 */
export VarUI1FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarUI1FromDec", DECIMAL.Ptr, pdecIn, "char*", &pbOut := 0, "HRESULT")
    return pbOut
}
 ...
 */
export VarI2FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarI2FromBool", VARIANT_BOOL, boolIn, "short*", &psOut := 0, "HRESULT")
    return psOut
}
 ...
 */
export VarI2FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarI2FromI1", CHAR, cIn, "short*", &psOut := 0, "HRESULT")
    return psOut
}
 ...
 */
export VarI2FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarI2FromDec", DECIMAL.Ptr, pdecIn, "short*", &psOut := 0, "HRESULT")
    return psOut
}
 ...
 */
export VarI4FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarI4FromCy", CY, cyIn, "int*", &plOut := 0, "HRESULT")
    return plOut
}
 ...
 */
export VarI4FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarI4FromBool", VARIANT_BOOL, boolIn, "int*", &plOut := 0, "HRESULT")
    return plOut
}
 ...
 */
export VarI4FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarI4FromI1", CHAR, cIn, "int*", &plOut := 0, "HRESULT")
    return plOut
}
 ...
 */
export VarI4FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarI4FromDec", DECIMAL.Ptr, pdecIn, "int*", &plOut := 0, "HRESULT")
    return plOut
}
 ...
 */
export VarI8FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarI8FromCy", CY, cyIn, "int64*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarI8FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarI8FromBool", VARIANT_BOOL, boolIn, "int64*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarI8FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarI8FromI1", CHAR, cIn, "int64*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarI8FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarI8FromDec", DECIMAL.Ptr, pdecIn, "int64*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarR4FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarR4FromBool", VARIANT_BOOL, boolIn, "float*", &pfltOut := 0, "HRESULT")
    return pfltOut
}
 ...
 */
export VarR4FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarR4FromI1", CHAR, cIn, "float*", &pfltOut := 0, "HRESULT")
    return pfltOut
}
 ...
 */
export VarR4FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarR4FromDec", DECIMAL.Ptr, pdecIn, "float*", &pfltOut := 0, "HRESULT")
    return pfltOut
}
 ...
 */
export VarR8FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarR8FromBool", VARIANT_BOOL, boolIn, "double*", &pdblOut := 0, "HRESULT")
    return pdblOut
}
 ...
 */
export VarR8FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarR8FromDec", DECIMAL.Ptr, pdecIn, "double*", &pdblOut := 0, "HRESULT")
    return pdblOut
}
 ...
 */
export VarDateFromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarDateFromCy", CY, cyIn, "double*", &pdateOut := 0, "HRESULT")
    return pdateOut
}
 ...
 */
export VarDateFromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarDateFromBool", VARIANT_BOOL, boolIn, "double*", &pdateOut := 0, "HRESULT")
    return pdateOut
}
 ...
 */
export VarDateFromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarDateFromI1", CHAR, cIn, "double*", &pdateOut := 0, "HRESULT")
    return pdateOut
}
 ...
 */
export VarDateFromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarDateFromDec", DECIMAL.Ptr, pdecIn, "double*", &pdateOut := 0, "HRESULT")
    return pdateOut
}
 ...
 */
export VarCyFromBool(boolIn, pcyOut) {
    result := DllCall("OLEAUT32.dll\VarCyFromBool", VARIANT_BOOL, boolIn, CY.Ptr, pcyOut, "HRESULT")
    return result
}
 ...
 */
export VarCyFromI1(cIn, pcyOut) {
    result := DllCall("OLEAUT32.dll\VarCyFromI1", CHAR, cIn, CY.Ptr, pcyOut, "HRESULT")
    return result
}
 ...
 */
export VarCyFromDec(pdecIn, pcyOut) {
    result := DllCall("OLEAUT32.dll\VarCyFromDec", DECIMAL.Ptr, pdecIn, CY.Ptr, pcyOut, "HRESULT")
    return result
}
 ...
 */
export VarBoolFromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarBoolFromCy", CY, cyIn, VARIANT_BOOL.Ptr, &pboolOut := 0, "HRESULT")
    return pboolOut
}
 ...
 */
export VarBoolFromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarBoolFromI1", CHAR, cIn, VARIANT_BOOL.Ptr, &pboolOut := 0, "HRESULT")
    return pboolOut
}
 ...
 */
export VarBoolFromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarBoolFromDec", DECIMAL.Ptr, pdecIn, VARIANT_BOOL.Ptr, &pboolOut := 0, "HRESULT")
    return pboolOut
}
 ...
 */
export VarI1FromCy(cyIn, pcOut) {
    pcOut := pcOut is String ? StrPtr(pcOut) : pcOut

    result := DllCall("OLEAUT32.dll\VarI1FromCy", CY, cyIn, "ptr", pcOut, "HRESULT")
    return result
}
 ...
 */
export VarI1FromStr(strIn, lcid, dwFlags, pcOut) {
    strIn := strIn is String ? StrPtr(strIn) : strIn
    pcOut := pcOut is String ? StrPtr(pcOut) : pcOut
 ...
 */
export VarI1FromBool(boolIn, pcOut) {
    pcOut := pcOut is String ? StrPtr(pcOut) : pcOut

    result := DllCall("OLEAUT32.dll\VarI1FromBool", VARIANT_BOOL, boolIn, "ptr", pcOut, "HRESULT")
    return result
}
 ...
 */
export VarI1FromDec(pdecIn, pcOut) {
    pcOut := pcOut is String ? StrPtr(pcOut) : pcOut

    result := DllCall("OLEAUT32.dll\VarI1FromDec", DECIMAL.Ptr, pdecIn, "ptr", pcOut, "HRESULT")
    return result
}
 ...
 */
export VarUI2FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarUI2FromCy", CY, cyIn, "ushort*", &puiOut := 0, "HRESULT")
    return puiOut
}
 ...
 */
export VarUI2FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarUI2FromBool", VARIANT_BOOL, boolIn, "ushort*", &puiOut := 0, "HRESULT")
    return puiOut
}
 ...
 */
export VarUI2FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarUI2FromI1", CHAR, cIn, "ushort*", &puiOut := 0, "HRESULT")
    return puiOut
}
 ...
 */
export VarUI2FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarUI2FromDec", DECIMAL.Ptr, pdecIn, "ushort*", &puiOut := 0, "HRESULT")
    return puiOut
}
 ...
 */
export VarUI4FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarUI4FromCy", CY, cyIn, "uint*", &pulOut := 0, "HRESULT")
    return pulOut
}
 ...
 */
export VarUI4FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarUI4FromBool", VARIANT_BOOL, boolIn, "uint*", &pulOut := 0, "HRESULT")
    return pulOut
}
 ...
 */
export VarUI4FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarUI4FromI1", CHAR, cIn, "uint*", &pulOut := 0, "HRESULT")
    return pulOut
}
 ...
 */
export VarUI4FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarUI4FromDec", DECIMAL.Ptr, pdecIn, "uint*", &pulOut := 0, "HRESULT")
    return pulOut
}
 ...
 */
export VarUI8FromCy(cyIn) {
    result := DllCall("OLEAUT32.dll\VarUI8FromCy", CY, cyIn, "uint*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarUI8FromBool(boolIn) {
    result := DllCall("OLEAUT32.dll\VarUI8FromBool", VARIANT_BOOL, boolIn, "uint*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarUI8FromI1(cIn) {
    result := DllCall("OLEAUT32.dll\VarUI8FromI1", CHAR, cIn, "uint*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarUI8FromDec(pdecIn) {
    result := DllCall("OLEAUT32.dll\VarUI8FromDec", DECIMAL.Ptr, pdecIn, "uint*", &pi64Out := 0, "HRESULT")
    return pi64Out
}
 ...
 */
export VarDecFromCy(cyIn, pdecOut) {
    result := DllCall("OLEAUT32.dll\VarDecFromCy", CY, cyIn, DECIMAL.Ptr, pdecOut, "HRESULT")
    return result
}
 ...
 */
export VarDecFromBool(boolIn, pdecOut) {
    result := DllCall("OLEAUT32.dll\VarDecFromBool", VARIANT_BOOL, boolIn, DECIMAL.Ptr, pdecOut, "HRESULT")
    return result
}
 ...
 */
export VarDecFromI1(cIn, pdecOut) {
    result := DllCall("OLEAUT32.dll\VarDecFromI1", CHAR, cIn, DECIMAL.Ptr, pdecOut, "HRESULT")
    return result
}
 ...
 */
export VarAdd(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarAdd", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarAnd(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarAnd", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarCat(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarCat", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarDiv(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarDiv", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarEqv(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarEqv", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarIdiv(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarIdiv", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarImp(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarImp", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarMod(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarMod", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarMul(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarMul", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarOr(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarOr", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarPow(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarPow", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarSub(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarSub", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarXor(pvarLeft, pvarRight, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarXor", VARIANT.Ptr, pvarLeft, VARIANT.Ptr, pvarRight, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarAbs(pvarIn, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarAbs", VARIANT.Ptr, pvarIn, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarFix(pvarIn, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarFix", VARIANT.Ptr, pvarIn, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarInt(pvarIn, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarInt", VARIANT.Ptr, pvarIn, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarNeg(pvarIn, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarNeg", VARIANT.Ptr, pvarIn, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarNot(pvarIn, pvarResult) {
    result := DllCall("OLEAUT32.dll\VarNot", VARIANT.Ptr, pvarIn, VARIANT.Ptr, pvarResult, "HRESULT")
    return result
}
 ...
 */
export VarDecAdd(pdecLeft, pdecRight, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecAdd", DECIMAL.Ptr, pdecLeft, DECIMAL.Ptr, pdecRight, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecDiv(pdecLeft, pdecRight, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecDiv", DECIMAL.Ptr, pdecLeft, DECIMAL.Ptr, pdecRight, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecMul(pdecLeft, pdecRight, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecMul", DECIMAL.Ptr, pdecLeft, DECIMAL.Ptr, pdecRight, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecSub(pdecLeft, pdecRight, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecSub", DECIMAL.Ptr, pdecLeft, DECIMAL.Ptr, pdecRight, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecAbs(pdecIn, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecAbs", DECIMAL.Ptr, pdecIn, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecFix(pdecIn, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecFix", DECIMAL.Ptr, pdecIn, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecInt(pdecIn, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecInt", DECIMAL.Ptr, pdecIn, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecNeg(pdecIn, pdecResult) {
    result := DllCall("OLEAUT32.dll\VarDecNeg", DECIMAL.Ptr, pdecIn, DECIMAL.Ptr, pdecResult, "HRESULT")
    return result
}
 ...
 */
export VarDecCmp(pdecLeft, pdecRight) {
    result := DllCall("OLEAUT32.dll\VarDecCmp", DECIMAL.Ptr, pdecLeft, DECIMAL.Ptr, pdecRight, VARCMP_enum)
    return result
}
 ...
 */
export VarCyAdd(cyLeft, cyRight, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyAdd", CY, cyLeft, CY, cyRight, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyMul(cyLeft, cyRight, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyMul", CY, cyLeft, CY, cyRight, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCySub(cyLeft, cyRight, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCySub", CY, cyLeft, CY, cyRight, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyAbs(cyIn, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyAbs", CY, cyIn, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyFix(cyIn, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyFix", CY, cyIn, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyInt(cyIn, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyInt", CY, cyIn, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyNeg(cyIn, pcyResult) {
    result := DllCall("OLEAUT32.dll\VarCyNeg", CY, cyIn, CY.Ptr, pcyResult, "HRESULT")
    return result
}
 ...
 */
export VarCyCmp(cyLeft, cyRight) {
    result := DllCall("OLEAUT32.dll\VarCyCmp", CY, cyLeft, CY, cyRight, VARCMP_enum)
    return result
}
 ...
 */
export VarBstrCat(bstrLeft, bstrRight) {
    pbstrResult := BSTR.Owned()
    result := DllCall("OLEAUT32.dll\VarBstrCat", BSTR, bstrLeft, BSTR, bstrRight, BSTR.Ptr, pbstrResult, "HRESULT")
    return pbstrResult
}
 ...
 */
export LoadTypeLib(szFile) {
    szFile := szFile is String ? StrPtr(szFile) : szFile

    result := DllCall("OLEAUT32.dll\LoadTypeLib", "ptr", szFile, "ptr*", &pptlib := 0, "HRESULT")
 ...
 */
export LoadTypeLibEx(szFile, _regkind) {
    szFile := szFile is String ? StrPtr(szFile) : szFile

    result := DllCall("OLEAUT32.dll\LoadTypeLibEx", "ptr", szFile, REGKIND, _regkind, "ptr*", &pptlib := 0, "HRESULT")
    return ITypeLib(pptlib)
}
 ...
 */
export RegisterTypeLib(ptlib, szFullPath, szHelpDir) {
 ...
 */
export RegisterTypeLibForUser(ptlib, szFullPath, szHelpDir) {
    szFullPath := szFullPath is String ? StrPtr(szFullPath) : szFullPath
    szHelpDir := szHelpDir is String ? StrPtr(szHelpDir) : szHelpDir
 ...
 */
export CreateTypeLib(_syskind, szFile) {
    szFile := szFile is String ? StrPtr(szFile) : szFile

    result := DllCall("OLEAUT32.dll\CreateTypeLib", SYSKIND, _syskind, "ptr", szFile, "ptr*", &ppctlib := 0, "HRESULT")
 ...
 */
export CreateTypeLib2(_syskind, szFile) {
    szFile := szFile is String ? StrPtr(szFile) : szFile

    result := DllCall("OLEAUT32.dll\CreateTypeLib2", SYSKIND, _syskind, "ptr", szFile, "ptr*", &ppctlib := 0, "HRESULT")
 ...
 */
export GetActiveObject(rclsid) {
    static pvReserved := 0 ;Reserved parameters must always be NULL

    result := DllCall("OLEAUT32.dll\GetActiveObject", Guid.Ptr, rclsid, "ptr", pvReserved, "ptr*", &ppunk := 0, "HRESULT")
 ...
 */
export CreateErrorInfo() {
    result := DllCall("OLEAUT32.dll\CreateErrorInfo", "ptr*", &pperrinfo := 0, "HRESULT")
 ...
 */
export GetRecordInfoFromTypeInfo(pTypeInfo) {
    result := DllCall("OLEAUT32.dll\GetRecordInfoFromTypeInfo", "ptr", pTypeInfo, "ptr*", &ppRecInfo := 0, "HRESULT")
 ...
 */
export OaBuildVersion() {
    result := DllCall("OLEAUT32.dll\OaBuildVersion", UInt32)
    return result
}
 ...
 */
export ClearCustData(pCustData) {
    DllCall("OLEAUT32.dll\ClearCustData", CUSTDATA.Ptr, pCustData)
}
 ...
 */
export OaEnablePerUserTLibRegistration() {
 ...
 */
export OleBuildVersion() {
    result := DllCall("ole32.dll\OleBuildVersion", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleInitialize() {
    static pvReserved := 0 ;Reserved parameters must always be NULL

    result := DllCall("OLE32.dll\OleInitialize", "ptr", pvReserved, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleQueryLinkFromData(pSrcDataObject) {
    result := DllCall("OLE32.dll\OleQueryLinkFromData", "ptr", pSrcDataObject, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleQueryCreateFromData(pSrcDataObject) {
    result := DllCall("OLE32.dll\OleQueryCreateFromData", "ptr", pSrcDataObject, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleLoad(pStg, riid, pClientSite) {
    result := DllCall("OLE32.dll\OleLoad", "ptr", pStg, Guid.Ptr, riid, "ptr", pClientSite, "ptr*", &ppvObj := 0, "HRESULT")
    return ppvObj
}
 ...
 * @since windows5.0
 */
export OleSave(pPS, pStg, fSameAsLoad) {
    result := DllCall("OLE32.dll\OleSave", "ptr", pPS, "ptr", pStg, BOOL, fSameAsLoad, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleLoadFromStream(pStm, iidInterface) {
    result := DllCall("OLE32.dll\OleLoadFromStream", "ptr", pStm, Guid.Ptr, iidInterface, "ptr*", &ppvObj := 0, "HRESULT")
    return ppvObj
}
 ...
 * @since windows5.0
 */
export OleSaveToStream(pPStm, pStm) {
    result := DllCall("OLE32.dll\OleSaveToStream", "ptr", pPStm, "ptr", pStm, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleSetContainedObject(pUnknown, fContained) {
    result := DllCall("OLE32.dll\OleSetContainedObject", "ptr", pUnknown, BOOL, fContained, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleNoteObjectVisible(pUnknown, fVisible) {
    result := DllCall("ole32.dll\OleNoteObjectVisible", "ptr", pUnknown, BOOL, fVisible, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export RegisterDragDrop(_hwnd, pDropTarget) {
    result := DllCall("OLE32.dll\RegisterDragDrop", HWND, _hwnd, "ptr", pDropTarget, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export RevokeDragDrop(_hwnd) {
    result := DllCall("OLE32.dll\RevokeDragDrop", HWND, _hwnd, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export DoDragDrop(pDataObj, pDropSource, dwOKEffects) {
    result := DllCall("OLE32.dll\DoDragDrop", "ptr", pDataObj, "ptr", pDropSource, DROPEFFECT, dwOKEffects, "uint*", &pdwEffect := 0, Int32)
    return pdwEffect
}
 ...
 * @since windows5.0
 */
export OleSetClipboard(pDataObj) {
    result := DllCall("OLE32.dll\OleSetClipboard", "ptr", pDataObj, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleGetClipboard() {
    result := DllCall("OLE32.dll\OleGetClipboard", "ptr*", &ppDataObj := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export OleFlushClipboard() {
    result := DllCall("OLE32.dll\OleFlushClipboard", "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleIsCurrentClipboard(pDataObj) {
    result := DllCall("OLE32.dll\OleIsCurrentClipboard", "ptr", pDataObj, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleCreateMenuDescriptor(hmenuCombined, lpMenuWidths) {
    result := DllCall("OLE32.dll\OleCreateMenuDescriptor", HMENU, hmenuCombined, OLEMENUGROUPWIDTHS.Ptr, lpMenuWidths, IntPtr)
    return result
}
 ...
 * @since windows5.0
 */
export OleTranslateAccelerator(lpFrame, lpFrameInfo, lpmsg) {
    result := DllCall("OLE32.dll\OleTranslateAccelerator", "ptr", lpFrame, OLEINPLACEFRAMEINFO.Ptr, lpFrameInfo, MSG.Ptr, lpmsg, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleDuplicateData(hSrc, cfFormat, uiFlags) {
    result := DllCall("OLE32.dll\OleDuplicateData", HANDLE, hSrc, CLIPBOARD_FORMAT, cfFormat, GLOBAL_ALLOC_FLAGS, uiFlags, HANDLE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export OleRun(pUnknown) {
    result := DllCall("OLE32.dll\OleRun", "ptr", pUnknown, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleIsRunning(pObject) {
    result := DllCall("OLE32.dll\OleIsRunning", "ptr", pObject, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export OleLockRunning(pUnknown, fLock, fLastUnlockCloses) {
    result := DllCall("OLE32.dll\OleLockRunning", "ptr", pUnknown, BOOL, fLock, BOOL, fLastUnlockCloses, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export ReleaseStgMedium(param0) {
    DllCall("OLE32.dll\ReleaseStgMedium", STGMEDIUM.Ptr, param0)
}
 ...
 * @since windows5.0
 */
export CreateOleAdviseHolder() {
    result := DllCall("OLE32.dll\CreateOleAdviseHolder", "ptr*", &ppOAHolder := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export OleCreateDefaultHandler(clsid, pUnkOuter, riid) {
    result := DllCall("ole32.dll\OleCreateDefaultHandler", Guid.Ptr, clsid, "ptr", pUnkOuter, Guid.Ptr, riid, "ptr*", &lplpObj := 0, "HRESULT")
    return lplpObj
}
 ...
 * @since windows5.0
 */
export OleCreateEmbeddingHelper(clsid, pUnkOuter, flags, pCF, riid) {
    result := DllCall("OLE32.dll\OleCreateEmbeddingHelper", Guid.Ptr, clsid, "ptr", pUnkOuter, EMBDHLP_FLAGS, flags, "ptr", pCF, Guid.Ptr, riid, "ptr*", &lplpObj := 0, "HRESULT")
    return lplpObj
}
 ...
 * @since windows5.0
 */
export OleGetIconOfFile(lpszPath, fUseFileAsLabel) {
    lpszPath := lpszPath is String ? StrPtr(lpszPath) : lpszPath

    result := DllCall("ole32.dll\OleGetIconOfFile", "ptr", lpszPath, BOOL, fUseFileAsLabel, HGLOBAL.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export OleMetafilePictFromIconAndLabel(_hIcon, lpszLabel, lpszSourceFile, iIconIndex) {
    lpszLabel := lpszLabel is String ? StrPtr(lpszLabel) : lpszLabel
 ...
 * @since windows5.0
 */
export OleRegEnumVerbs(clsid) {
    result := DllCall("OLE32.dll\OleRegEnumVerbs", Guid.Ptr, clsid, "ptr*", &ppenum := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export OleDoAutoConvert(pStg, pClsidNew) {
    result := DllCall("ole32.dll\OleDoAutoConvert", "ptr", pStg, Guid.Ptr, pClsidNew, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleGetAutoConvert(clsidOld, pClsidNew) {
    result := DllCall("OLE32.dll\OleGetAutoConvert", Guid.Ptr, clsidOld, Guid.Ptr, pClsidNew, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleSetAutoConvert(clsidOld, clsidNew) {
    result := DllCall("ole32.dll\OleSetAutoConvert", Guid.Ptr, clsidOld, Guid.Ptr, clsidNew, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleCreatePropertyFrame(hwndOwner, x, y, lpszCaption, cObjects, ppUnk, cPages, pPageClsID, lcid) {
 ...
 * @since windows5.0
 */
export OleCreatePropertyFrameIndirect(lpParams) {
    result := DllCall("OLEAUT32.dll\OleCreatePropertyFrameIndirect", OCPFIPARAMS.Ptr, lpParams, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleCreateFontIndirect(lpFontDesc, riid) {
    result := DllCall("OLEAUT32.dll\OleCreateFontIndirect", FONTDESC.Ptr, lpFontDesc, Guid.Ptr, riid, "ptr*", &lplpvObj := 0, "HRESULT")
    return lplpvObj
}
 ...
 * @since windows5.0
 */
export OleCreatePictureIndirect(lpPictDesc, riid, fOwn) {
    result := DllCall("OLEAUT32.dll\OleCreatePictureIndirect", PICTDESC.Ptr, lpPictDesc, Guid.Ptr, riid, BOOL, fOwn, "ptr*", &lplpvObj := 0, "HRESULT")
    return lplpvObj
}
 ...
 * @since windows5.0
 */
export OleLoadPicturePath(szURLorPath, punkCaller, clrReserved, riid) {
 ...
 */
export OleLoadPictureFile(varFileName) {
    result := DllCall("OLEAUT32.dll\OleLoadPictureFile", VARIANT, varFileName, "ptr*", &lplpdispPicture := 0, "HRESULT")
 ...
 */
export OleSavePictureFile(lpdispPicture, bstrFileName) {
    result := DllCall("OLEAUT32.dll\OleSavePictureFile", "ptr", lpdispPicture, BSTR, bstrFileName, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export OleIconToCursor(hinstExe, _hIcon) {
    result := DllCall("OLEAUT32.dll\OleIconToCursor", HINSTANCE, hinstExe, HICON, _hIcon, HCURSOR.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIInsertObjectW(param0) {
    result := DllCall("oledlg.dll\OleUIInsertObjectW", OLEUIINSERTOBJECTW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIInsertObjectA(param0) {
    result := DllCall("oledlg.dll\OleUIInsertObjectA", OLEUIINSERTOBJECTA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIPasteSpecialW(param0) {
    result := DllCall("oledlg.dll\OleUIPasteSpecialW", OLEUIPASTESPECIALW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIPasteSpecialA(param0) {
    result := DllCall("oledlg.dll\OleUIPasteSpecialA", OLEUIPASTESPECIALA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIEditLinksW(param0) {
    result := DllCall("oledlg.dll\OleUIEditLinksW", OLEUIEDITLINKSW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIEditLinksA(param0) {
    result := DllCall("oledlg.dll\OleUIEditLinksA", OLEUIEDITLINKSA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIChangeIconW(param0) {
    result := DllCall("oledlg.dll\OleUIChangeIconW", OLEUICHANGEICONW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIChangeIconA(param0) {
    result := DllCall("oledlg.dll\OleUIChangeIconA", OLEUICHANGEICONA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIConvertW(param0) {
    result := DllCall("oledlg.dll\OleUIConvertW", OLEUICONVERTW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIConvertA(param0) {
    result := DllCall("oledlg.dll\OleUIConvertA", OLEUICONVERTA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIBusyW(param0) {
    result := DllCall("oledlg.dll\OleUIBusyW", OLEUIBUSYW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIBusyA(param0) {
    result := DllCall("oledlg.dll\OleUIBusyA", OLEUIBUSYA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIChangeSourceW(param0) {
    result := DllCall("oledlg.dll\OleUIChangeSourceW", OLEUICHANGESOURCEW_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIChangeSourceA(param0) {
    result := DllCall("oledlg.dll\OleUIChangeSourceA", OLEUICHANGESOURCEA_struct.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIObjectPropertiesW(param0) {
    result := DllCall("oledlg.dll\OleUIObjectPropertiesW", OLEUIOBJECTPROPSW.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIObjectPropertiesA(param0) {
    result := DllCall("oledlg.dll\OleUIObjectPropertiesA", OLEUIOBJECTPROPSA.Ptr, param0, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export OleUIPromptUserW(nTemplate, hwndParent, args*) {
    varArgs := [args*]
    varArgs.Push(Int32)
 ...
 * @since windows5.0
 */
export OleUIPromptUserA(nTemplate, hwndParent, args*) {
    varArgs := [args*]
    varArgs.Push(Int32)
