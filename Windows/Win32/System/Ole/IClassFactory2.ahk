 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-iclassfactory2
...
class IClassFactory2 extends IClassFactory{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iclassfactory2-getlicinfo
     */
    GetLicInfo(pLicInfo) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iclassfactory2-requestlickey
     */
     ...
     * @returns {Pointer<Pointer<Void>>} Address of pointer variable that receives the interface pointer requested in <i>riid</i>. Upon successful return, *<i>ppvObj</i> contains the requested interface pointer. If an error occurs, the implementation must set *<i>ppvObj</i> to <b>NULL</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iclassfactory2-createinstancelic
     */
    CreateInstanceLic(pUnkOuter, riid, bstrKey) {
        ...
        result := ComCall(7, this, "ptr", pUnkOuter, "ptr", pUnkReserved, "ptr", riid, "ptr", bstrKey, "ptr*", &ppvObj := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
