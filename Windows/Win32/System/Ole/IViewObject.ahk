 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nn-oleidl-iviewobject
...
class IViewObject extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-draw
     */
    Draw(dwDrawAspect, lindex, pvAspect, ptd, hdcTargetDev, hdcDraw, lprcBounds, lprcWBounds, pfnContinue, dwContinue) {
        ...
        result := ComCall(3, this, "uint", dwDrawAspect, "int", lindex, pvAspectMarshal, pvAspect, "ptr", ptd, "ptr", hdcTargetDev, "ptr", hdcDraw, "ptr", lprcBounds, "ptr", lprcWBounds, "ptr", pfnContinue, "ptr", dwContinue, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-getcolorset
     */
    GetColorSet(dwDrawAspect, lindex, pvAspect, ptd, hicTargetDev) {
        ...
        result := ComCall(4, this, "uint", dwDrawAspect, "int", lindex, pvAspectMarshal, pvAspect, "ptr", ptd, "ptr", hicTargetDev, "ptr*", &ppColorSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-freeze
     */
    Freeze(dwDrawAspect, lindex, pvAspect) {
        pvAspectMarshal := pvAspect is VarRef ? "ptr" : "ptr"

        result := ComCall(5, this, "uint", dwDrawAspect, "int", lindex, pvAspectMarshal, pvAspect, "uint*", &pdwFreeze := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-unfreeze
     */
    Unfreeze(dwFreeze) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-setadvise
     */
    SetAdvise(aspects, advf_, pAdvSink) {
        result := ComCall(7, this, "uint", aspects, "uint", advf_, "ptr", pAdvSink, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject-getadvise
     */
    GetAdvise(pAspects, pAdvf, ppAdvSink) {
        pAspectsMarshal := pAspects is VarRef ? "uint*" : "ptr"
        pAdvfMarshal := pAdvf is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, pAspectsMarshal, pAspects, pAdvfMarshal, pAdvf, "ptr*", ppAdvSink, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
