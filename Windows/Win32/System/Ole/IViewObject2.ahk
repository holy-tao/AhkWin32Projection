 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nn-oleidl-iviewobject2
...
class IViewObject2 extends IViewObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-iviewobject2-getextent
     */
    GetExtent(dwDrawAspect, lindex, ptd) {
        lpsizel := SIZE()
        result := ComCall(9, this, "uint", dwDrawAspect, "int", lindex, "ptr", ptd, "ptr", lpsizel, "int")
        if(result != 0) {
