 ...
 * @see https://learn.microsoft.com/windows/win32/api/oledlg/ns-oledlg-oleuiconvertw
    ...
    lpszUserType{
        get {
            if(!this.HasProp("__lpszUserType"))
                this.__lpszUserType := PWSTR(this.ptr + 120)
    ...
    lpszDefLabel{
        get {
            if(!this.HasProp("__lpszDefLabel"))
                this.__lpszDefLabel := PWSTR(this.ptr + 136)
