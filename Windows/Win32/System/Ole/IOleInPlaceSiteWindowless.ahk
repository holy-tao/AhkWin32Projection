 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ioleinplacesitewindowless
...
class IOleInPlaceSiteWindowless extends IOleInPlaceSiteEx{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-canwindowlessactivate
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-getcapture
     */
    GetCapture() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-setcapture
     */
    SetCapture(fCapture) {
        result := ComCall(20, this, "int", fCapture, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-getfocus
     */
    GetFocus() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-setfocus
     */
    SetFocus(fFocus) {
        result := ComCall(22, this, "int", fFocus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-getdc
     */
    GetDC(pRect, grfFlags) {
        phDC := HDC()
        result := ComCall(23, this, "ptr", pRect, "uint", grfFlags, "ptr", phDC, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HDC} hDC_ The device context to be released.
     * @returns {HRESULT} This method returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-releasedc
     */
    ReleaseDC(hDC_) {
        hDC_ := hDC_ is Win32Handle ? NumGet(hDC_, "ptr") : hDC_

        result := ComCall(24, this, "ptr", hDC_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-invalidaterect
     */
    InvalidateRect(pRect, fErase) {
        result := ComCall(25, this, "ptr", pRect, "int", fErase, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HRGN} hRGN_ The region to invalidate, in client coordinates of the containing window. If this parameter is <b>NULL</b>, the object's full extent is invalidated.
     * @param {BOOL} fErase Specifies whether the background within the update region is to be erased when the region is updated. If this parameter is <b>TRUE</b>, the background is erased. If this parameter is <b>FALSE</b>, the background remains unchanged.
     * @returns {HRESULT} This method returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-invalidatergn
     */
    InvalidateRgn(hRGN_, fErase) {
        hRGN_ := hRGN_ is Win32Handle ? NumGet(hRGN_, "ptr") : hRGN_

        result := ComCall(26, this, "ptr", hRGN_, "int", fErase, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns S_OK on success.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-scrollrect
     */
    ScrollRect(dx, dy, pRectScroll, pRectClip) {
        result := ComCall(27, this, "int", dx, "int", dy, "ptr", pRectScroll, "ptr", pRectClip, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-adjustrect
     */
    AdjustRect(prc) {
        result := ComCall(28, this, "ptr", prc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} msg_ The identifier for the window message provided to the container by Windows.
     * @param {WPARAM} wParam_ A parameter for the window message provided to the container by Windows.
     * @param {LPARAM} lParam_ A parameter for the window message provided to the container by Windows.
     * @returns {LRESULT} A pointer to result code for the window message.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplacesitewindowless-ondefwindowmessage
     */
    OnDefWindowMessage(msg_, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        plResult := LRESULT()
        result := ComCall(29, this, "uint", msg_, "ptr", wParam_, "ptr", lParam_, "ptr", plResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
