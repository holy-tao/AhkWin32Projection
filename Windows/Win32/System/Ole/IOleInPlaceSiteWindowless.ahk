...
class IOleInPlaceSiteWindowless extends IOleInPlaceSiteEx{
    ...
    ReleaseDC(hDC) {
        ...
        result := ComCall(24, this, "ptr", hDC, "int")
        if(result != 0)
            throw OSError(result)
    ...
    InvalidateRgn(hRGN, fErase) {
        ...
        result := ComCall(26, this, "ptr", hRGN, "int", fErase, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OnDefWindowMessage(msg, wParam, lParam, plResult) {
        result := ComCall(29, this, "uint", msg, "ptr", wParam, "ptr", lParam, "ptr", plResult, "int")
        if(result != 0)
            throw OSError(result)
