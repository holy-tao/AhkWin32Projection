...
export default struct IOleUILinkContainerW extends IUnknown {
    ...
    */
    ...
    GetLinkSource(dwLink, lplpszDisplayName, lplenFileName, lplpszFullLinkType, lplpszShortLinkType, lpfSourceAvailable, lpfIsSelected) {
        ...
        lplpszDisplayNameMarshal := lplpszDisplayName == 0 ? IntPtr : PWSTR.Ptr
        ...
        lplpszFullLinkTypeMarshal := lplpszFullLinkType == 0 ? IntPtr : PWSTR.Ptr
        lplpszShortLinkTypeMarshal := lplpszShortLinkType is VarRef ? "ptr*" : IntPtr
        lplpszShortLinkTypeMarshal := lplpszShortLinkType == 0 ? IntPtr : PWSTR.Ptr
