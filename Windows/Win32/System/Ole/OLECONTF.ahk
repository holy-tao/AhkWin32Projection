...
class OLECONTF extends Win32Enum {
     ...
     * Native name: OLECONTF_EMBEDDINGS
     * @type {Integer (Int32)}
     */
    static EMBEDDINGS => 1
     ...
     *        container.
     * Native name: OLECONTF_ONLYIFRUNNING
     * @type {Integer (Int32)}
     */
    static ONLYIFRUNNING => 16
}
