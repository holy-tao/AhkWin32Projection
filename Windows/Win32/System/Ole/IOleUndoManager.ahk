 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ioleundomanager
...
class IOleUndoManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-open
     */
    Open(pPUU) {
        result := ComCall(3, this, "ptr", pPUU, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-close
     */
    Close(pPUU, fCommit) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-add
     */
    Add(pUU) {
        result := ComCall(5, this, "ptr", pUU, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-getopenparentstate
     */
    GetOpenParentState() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-discardfrom
     */
    DiscardFrom(pUU) {
        result := ComCall(7, this, "ptr", pUU, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-undoto
     */
    UndoTo(pUU) {
        result := ComCall(8, this, "ptr", pUU, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-redoto
     */
    RedoTo(pUU) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-enumundoable
     */
    EnumUndoable() {
     ...
     * This method calls <a href="https://docs.microsoft.com/windows/desktop/api/unknwn/nf-unknwn-iunknown-addref">IUnknown::AddRef</a> on the new enumerator object to increment its reference count. The caller is responsible for calling <a href="https://docs.microsoft.com/windows/desktop/api/unknwn/nf-unknwn-iunknown-release">IUnknown::Release</a> on the enumerator object when it is no longer needed.
     * @returns {IEnumOleUndoUnits} Address of <a href="https://docs.microsoft.com/windows/desktop/api/ocidl/nn-ocidl-ienumoleundounits">IEnumOleUndoUnits</a> pointer variable that receives the interface pointer to the enumerator object.
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-enumredoable
     */
    EnumRedoable() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-getlastundodescription
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-getlastredodescription
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleundomanager-enable
     */
    Enable(fEnable) {
        result := ComCall(14, this, "int", fEnable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
