 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ioleinplaceobjectwindowless
...
class IOleInPlaceObjectWindowless extends IOleInPlaceObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplaceobjectwindowless-onwindowmessage
     */
    OnWindowMessage(msg_, wParam_, lParam_) {
        wParam_ := wParam_ is Win32Handle ? NumGet(wParam_, "ptr") : wParam_
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        plResult := LRESULT()
        result := ComCall(9, this, "uint", msg_, "ptr", wParam_, "ptr", lParam_, "ptr", plResult, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ioleinplaceobjectwindowless-getdroptarget
     */
    GetDropTarget() {
        result := ComCall(10, this, "ptr*", &ppDropTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
