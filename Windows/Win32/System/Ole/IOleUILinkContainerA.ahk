 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nn-oledlg-ioleuilinkcontainera
...
class IOleUILinkContainerA extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-getnextlink
     */
    GetNextLink(dwLink) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-setlinkupdateoptions
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-getlinkupdateoptions
     */
    GetLinkUpdateOptions(dwLink) {
        result := ComCall(5, this, "uint", dwLink, "uint*", &lpdwUpdateOpt := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-setlinksource
     */
    SetLinkSource(dwLink, lpszDisplayName, lenFileName, fValidateSource) {
        ...
        result := ComCall(6, this, "uint", dwLink, "ptr", lpszDisplayName, "uint", lenFileName, "uint*", &pchEaten := 0, "int", fValidateSource, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-getlinksource
     */
    GetLinkSource(dwLink, lplpszDisplayName, lplenFileName, lplpszFullLinkType, lplpszShortLinkType, lpfSourceAvailable, lpfIsSelected) {
        ...
        result := ComCall(7, this, "uint", dwLink, lplpszDisplayNameMarshal, lplpszDisplayName, lplenFileNameMarshal, lplenFileName, lplpszFullLinkTypeMarshal, lplpszFullLinkType, lplpszShortLinkTypeMarshal, lplpszShortLinkType, lpfSourceAvailableMarshal, lpfSourceAvailable, lpfIsSelectedMarshal, lpfIsSelected, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-openlinksource
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-updatelink
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oledlg/nf-oledlg-ioleuilinkcontainera-cancellink
     */
    CancelLink(dwLink) {
