 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ipropertypagesite
...
class IPropertyPageSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipropertypagesite-getlocaleid
     */
    GetLocaleID() {
        result := ComCall(4, this, "uint*", &pLocaleID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipropertypagesite-getpagecontainer
     */
    GetPageContainer() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipropertypagesite-translateaccelerator
     */
    TranslateAccelerator(pMsg) {
        result := ComCall(6, this, "ptr", pMsg, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
