...
class OLEMISC extends Win32Enum {
     ...
     * Native name: OLEMISC_RECOMPOSEONRESIZE
     * @type {Integer (Int32)}
     */
    static RECOMPOSEONRESIZE => 1
     ...
     * Native name: OLEMISC_ONLYICONIC
     * @type {Integer (Int32)}
     */
    static ONLYICONIC => 2
     ...
     * Native name: OLEMISC_INSERTNOTREPLACE
     * @type {Integer (Int32)}
     */
    static INSERTNOTREPLACE => 4
     ...
     * Native name: OLEMISC_CANTLINKINSIDE
     * @type {Integer (Int32)}
     */
    static CANTLINKINSIDE => 16
     ...
     * Native name: OLEMISC_CANLINKBYOLE1
     * @type {Integer (Int32)}
     */
    static CANLINKBYOLE1 => 32
     ...
     * Native name: OLEMISC_ISLINKOBJECT
     * @type {Integer (Int32)}
     */
    static ISLINKOBJECT => 64
     ...
     * Native name: OLEMISC_INSIDEOUT
     * @type {Integer (Int32)}
     */
    static INSIDEOUT => 128
     ...
     * Native name: OLEMISC_ACTIVATEWHENVISIBLE
     * @type {Integer (Int32)}
     */
    static ACTIVATEWHENVISIBLE => 256

    /**
     * This object does not pay any attention to target devices. Its presentation data will be the same in all cases.
     * Native name: OLEMISC_RENDERINGISDEVICEINDEPENDENT
     * @type {Integer (Int32)}
     */
    static RENDERINGISDEVICEINDEPENDENT => 512
     ...
     * Native name: OLEMISC_INVISIBLEATRUNTIME
     * @type {Integer (Int32)}
     */
    static INVISIBLEATRUNTIME => 1024
     ...
     * Native name: OLEMISC_ALWAYSRUN
     * @type {Integer (Int32)}
     */
    static ALWAYSRUN => 2048
     ...
     * Native name: OLEMISC_ACTSLIKEBUTTON
     * @type {Integer (Int32)}
     */
    static ACTSLIKEBUTTON => 4096
     ...
     * Native name: OLEMISC_ACTSLIKELABEL
     * @type {Integer (Int32)}
     */
    static ACTSLIKELABEL => 8192
     ...
     * Native name: OLEMISC_NOUIACTIVATE
     * @type {Integer (Int32)}
     */
    static NOUIACTIVATE => 16384
     ...
     * Native name: OLEMISC_ALIGNABLE
     * @type {Integer (Int32)}
     */
    static ALIGNABLE => 32768
     ...
     * Native name: OLEMISC_SIMPLEFRAME
     * @type {Integer (Int32)}
     */
    static SIMPLEFRAME => 65536
     ...
     * Native name: OLEMISC_SETCLIENTSITEFIRST
     * @type {Integer (Int32)}
     */
    static SETCLIENTSITEFIRST => 131072
     ...
     * Native name: OLEMISC_IMEMODE
     * @type {Integer (Int32)}
     */
    static IMEMODE => 262144
     ...
     * Native name: OLEMISC_IGNOREACTIVATEWHENVISIBLE
     * @type {Integer (Int32)}
     */
    static IGNOREACTIVATEWHENVISIBLE => 524288

    /**
     * A control that can merge its menu with its container sets this value.
     * Native name: OLEMISC_WANTSTOMENUMERGE
     * @type {Integer (Int32)}
     */
    static WANTSTOMENUMERGE => 1048576

    /**
     * A control that supports multi-level undo sets this value.
     * Native name: OLEMISC_SUPPORTSMULTILEVELUNDO
     * @type {Integer (Int32)}
     */
    static SUPPORTSMULTILEVELUNDO => 2097152
}
