 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nn-oleidl-ioleitemcontainer
...
class IOleItemContainer extends IOleContainer{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleitemcontainer-isrunning
     */
    IsRunning(pszItem) {
        pszItem := pszItem is String ? StrPtr(pszItem) : pszItem

        result := ComCall(8, this, "ptr", pszItem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
