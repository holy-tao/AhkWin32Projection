...
class IPointerInactive extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipointerinactive-getactivationpolicy
     */
    GetActivationPolicy() {
        result := ComCall(3, this, "int*", &pdwPolicy := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipointerinactive-oninactivemousemove
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipointerinactive-oninactivesetcursor
     */
