 ...
 */
export default struct ICreateErrorInfo extends IUnknown {
    /**
     ...
     * used for ICreateErrorInfo interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ICreateErrorInfo.Vtbl()
        }
    ...
    SetHelpContext(dwHelpContext) {
        result := ComCall(7, this, UInt32, dwHelpContext, "HRESULT")
        return result
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.SetHelpFile)
