 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ipersistpropertybag
...
class IPersistPropertyBag extends IPersist{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipersistpropertybag-initnew
     */
    InitNew() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipersistpropertybag-load
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ipersistpropertybag-save
     */
