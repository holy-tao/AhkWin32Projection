 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//oledlg/ns-oledlg-oleuichangesourcea
    ...
    lpszDisplayName{
        get {
            if(!this.HasProp("__lpszDisplayName"))
                this.__lpszDisplayName := PSTR(this.ptr + 104)
    ...
    lpszFrom{
        get {
            if(!this.HasProp("__lpszFrom"))
                this.__lpszFrom := PSTR(this.ptr + 120)
    ...
    lpszTo{
        get {
            if(!this.HasProp("__lpszTo"))
                this.__lpszTo := PSTR(this.ptr + 128)
