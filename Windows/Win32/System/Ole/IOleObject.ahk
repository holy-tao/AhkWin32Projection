 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nn-oleidl-ioleobject
...
class IOleObject extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-setclientsite
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getclientsite
     */
    GetClientSite() {
        result := ComCall(4, this, "ptr*", &ppClientSite := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-sethostnames
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-close
     */
    Close(dwSaveOption) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-setmoniker
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getmoniker
     */
    GetMoniker(dwAssign, dwWhichMoniker) {
        result := ComCall(8, this, "uint", dwAssign, "uint", dwWhichMoniker, "ptr*", &ppmk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-initfromdata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getclipboarddata
     */
    GetClipboardData(dwReserved) {
        result := ComCall(10, this, "uint", dwReserved, "ptr*", &ppDataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-doverb
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-enumverbs
     */
    EnumVerbs() {
        result := ComCall(12, this, "ptr*", &ppEnumOleVerb := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-update
     */
    Update() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-isuptodate
     */
    IsUpToDate() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getuserclassid
     */
    GetUserClassID() {
        pClsid := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getusertype
     */
    GetUserType(dwFormOfType) {
        result := ComCall(16, this, "uint", dwFormOfType, "ptr*", &pszUserType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-setextent
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getextent
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-advise
     */
    Advise(pAdvSink) {
        result := ComCall(19, this, "ptr", pAdvSink, "uint*", &pdwConnection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-unadvise
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-enumadvise
     */
    EnumAdvise() {
        result := ComCall(21, this, "ptr*", &ppenumAdvise := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-getmiscstatus
     */
    GetMiscStatus(dwAspect) {
        result := ComCall(22, this, "uint", dwAspect, "int*", &pdwStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oleidl/nf-oleidl-ioleobject-setcolorscheme
     */
