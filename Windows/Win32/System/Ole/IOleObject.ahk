...
export default struct IOleObject extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetClientSite := CallbackCreate(ObjBindMethod(implObj, "SetClientSite"), flags, 2)
        this.vtbl.GetClientSite := CallbackCreate(ObjBindMethod(implObj, "GetClientSite"), flags, 2)
        this.vtbl.SetHostNames := CallbackCreate(ObjBindMethod(implObj, "SetHostNames"), flags, 3)
        this.vtbl.Close := CallbackCreate(ObjBindMethod(implObj, "Close"), flags, 2)
        this.vtbl.SetMoniker := CallbackCreate(ObjBindMethod(implObj, "SetMoniker"), flags, 3)
        this.vtbl.GetMoniker := CallbackCreate(ObjBindMethod(implObj, "GetMoniker"), flags, 4)
        this.vtbl.InitFromData := CallbackCreate(ObjBindMethod(implObj, "InitFromData"), flags, 4)
        this.vtbl.GetClipboardData := CallbackCreate(ObjBindMethod(implObj, "GetClipboardData"), flags, 3)
        this.vtbl.DoVerb := CallbackCreate(ObjBindMethod(implObj, "DoVerb"), flags, 7)
        this.vtbl.EnumVerbs := CallbackCreate(ObjBindMethod(implObj, "EnumVerbs"), flags, 2)
        this.vtbl.Update := CallbackCreate(ObjBindMethod(implObj, "Update"), flags, 1)
        this.vtbl.IsUpToDate := CallbackCreate(ObjBindMethod(implObj, "IsUpToDate"), flags, 1)
        this.vtbl.GetUserClassID := CallbackCreate(ObjBindMethod(implObj, "GetUserClassID"), flags, 2)
        this.vtbl.GetUserType := CallbackCreate(ObjBindMethod(implObj, "GetUserType"), flags, 3)
        ...
        this.vtbl.GetMiscStatus := CallbackCreate(ObjBindMethod(implObj, "GetMiscStatus"), flags, 3)
        this.vtbl.SetColorScheme := CallbackCreate(ObjBindMethod(implObj, "SetColorScheme"), flags, 2)
    }
