 ...
 */
export default struct IEnumOLEVERB extends IUnknown {
    /**
     ...
     * used for IEnumOLEVERB interfaces
    */
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, OLEVERB.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
    ...
    Query(iid) {
        if (IEnumOLEVERB.IID.Equals(iid)) {
            return true
        }
