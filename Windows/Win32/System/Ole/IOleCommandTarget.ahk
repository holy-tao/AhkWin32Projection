 ...
 */
export default struct IOleCommandTarget extends IUnknown {
    /**
     ...
     * used for IOleCommandTarget interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IOleCommandTarget.Vtbl()
        }
    ...
    Query(iid) {
        if (IOleCommandTarget.IID.Equals(iid)) {
            return true
        }
