 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nn-docobj-ioledocument
...
class IOleDocument extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nf-docobj-ioledocument-createview
     */
    CreateView(pIPSite, pstm, dwReserved) {
        result := ComCall(3, this, "ptr", pIPSite, "ptr", pstm, "uint", dwReserved, "ptr*", &ppView := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nf-docobj-ioledocument-getdocmiscstatus
     */
    GetDocMiscStatus() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/docobj/nf-docobj-ioledocument-enumviews
     */
