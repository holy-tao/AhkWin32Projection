 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nn-icontact-icontactmanager
...
class IContactManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-initialize
     */
    Initialize(pszAppName, pszAppVersion) {
        ...
        result := ComCall(3, this, "ptr", pszAppName, "ptr", pszAppVersion, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-load
     */
    Load(pszContactID) {
        pszContactID := pszContactID is String ? StrPtr(pszContactID) : pszContactID

        result := ComCall(4, this, "ptr", pszContactID, "ptr*", &ppContact := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-mergecontactids
     */
    MergeContactIDs(pszNewContactID, pszOldContactID) {
        ...
        result := ComCall(5, this, "ptr", pszNewContactID, "ptr", pszOldContactID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-getmecontact
     */
    GetMeContact() {
        result := ComCall(6, this, "ptr*", &ppMeContact := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-setmecontact
     */
    SetMeContact(pMeContact) {
        result := ComCall(7, this, "ptr", pMeContact, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/icontact/nf-icontact-icontactmanager-getcontactcollection
     */
    GetContactCollection() {
        result := ComCall(8, this, "ptr*", &ppContactCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
