...
class IContactAggregationServerPersonCollection extends IUnknown{
     ...
     */
    FindFirst() {
        result := ComCall(3, this, "ptr*", &ppServerPerson := 0, "int")
        if(result != 0) {
    ...
    FindFirstByServerId(pServerId) {
        ...
        result := ComCall(4, this, "ptr", pServerId, "ptr*", &ppServerPerson := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    FindFirstByAggregateId(pAggregateId) {
        ...
        result := ComCall(5, this, "ptr", pAggregateId, "ptr*", &ppServerPerson := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    FindFirstByLinkedAggregateId(pAggregateId) {
        ...
        result := ComCall(6, this, "ptr", pAggregateId, "ptr*", &ppServerPerson := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    FindNext() {
        result := ComCall(7, this, "ptr*", &ppServerPerson := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
