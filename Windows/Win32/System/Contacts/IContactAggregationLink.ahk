...
class IContactAggregationLink extends IUnknown{
     ...
     */
    get_AccountId() {
        result := ComCall(5, this, "ptr*", &ppAccountId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_Id() {
        result := ComCall(7, this, "ptr*", &ppItemId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_IsLinkResolved() {
        result := ComCall(8, this, "int*", &pIsLinkResolved := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_NetworkSourceIdString() {
        result := ComCall(10, this, "ptr*", &ppNetworkSourceId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_RemoteObjectId() {
        result := ComCall(12, this, "ptr*", &ppRemoteObjectId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    get_ServerPerson() {
        result := ComCall(14, this, "ptr*", &ppServerPersonId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_ServerPersonBaseline() {
        result := ComCall(16, this, "ptr*", &ppServerPersonId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    get_SyncIdentityHash() {
        result := ComCall(18, this, "ptr*", &ppSyncIdentityHash := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
