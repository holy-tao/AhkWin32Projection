 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wpcapi/nn-wpcapi-iwpcproviderstate
...
class IWPCProviderState extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wpcapi/nf-wpcapi-iwpcproviderstate-enable
     */
    Enable() {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wpcapi/nf-wpcapi-iwpcproviderstate-disable
     */
    Disable() {
