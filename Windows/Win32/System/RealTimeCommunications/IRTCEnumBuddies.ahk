 ...
 */
export default struct IRTCEnumBuddies extends IUnknown {
    /**
     ...
     * used for IRTCEnumBuddies interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IRTCEnumBuddies.Vtbl()
        }
    ...
    Query(iid) {
        if (IRTCEnumBuddies.IID.Equals(iid)) {
            return true
        }
