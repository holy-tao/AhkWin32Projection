 ...
 * @version v4.0.30319
 */
class LPMAPIRESOLVENAME extends IUnknown {
     ...
     */
    Invoke(lhSession, ulUIParam, lpszName, flFlags, ulReserved, lppRecip) {
        lpszName := lpszName is String ? StrPtr(lpszName) : lpszName

        lppRecipMarshal := lppRecip is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", lhSession, "ptr", ulUIParam, "ptr", lpszName, "uint", flFlags, "uint", ulReserved, lppRecipMarshal, lppRecip, "uint")
        return result
    }
}
