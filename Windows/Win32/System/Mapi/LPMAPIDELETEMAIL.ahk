 ...
 * @version v4.0.30319
 */
class LPMAPIDELETEMAIL extends IUnknown {
     ...
     */
    Invoke(lhSession, ulUIParam, lpszMessageID, flFlags, ulReserved) {
        lpszMessageID := lpszMessageID is String ? StrPtr(lpszMessageID) : lpszMessageID

        result := ComCall(3, this, "ptr", lhSession, "ptr", ulUIParam, "ptr", lpszMessageID, "uint", flFlags, "uint", ulReserved, "uint")
        return result
    }
}
