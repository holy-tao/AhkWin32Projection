 ...
 * @version v4.0.30319
 */
class LPMAPISAVEMAIL extends IUnknown {
     ...
     */
    Invoke(lhSession, ulUIParam, lpMessage, flFlags, ulReserved, lpszMessageID) {
        lpszMessageID := lpszMessageID is String ? StrPtr(lpszMessageID) : lpszMessageID

        result := ComCall(3, this, "ptr", lhSession, "ptr", ulUIParam, "ptr", lpMessage, "uint", flFlags, "uint", ulReserved, "ptr", lpszMessageID, "uint")
        return result
    }
}
