 ...
 * @version v4.0.30319
 */
class LPMAPISENDDOCUMENTS extends IUnknown {
     ...
     */
    Invoke(ulUIParam, lpszDelimChar, lpszFilePaths, lpszFileNames, ulReserved) {
        ...
        result := ComCall(3, this, "ptr", ulUIParam, "ptr", lpszDelimChar, "ptr", lpszFilePaths, "ptr", lpszFileNames, "uint", ulReserved, "uint")
        return result
    }
}
