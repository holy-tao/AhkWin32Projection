 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nn-winsync-iclockvector
...
class IClockVector extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iclockvector-getclockvectorelements
     */
    GetClockVectorElements(riid, ppiEnumClockVector) {
        ppiEnumClockVectorMarshal := ppiEnumClockVector is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", riid, ppiEnumClockVectorMarshal, ppiEnumClockVector, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iclockvector-getclockvectorelementcount
     */
    GetClockVectorElementCount(pdwCount) {
        pdwCountMarshal := pdwCount is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, pdwCountMarshal, pdwCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
