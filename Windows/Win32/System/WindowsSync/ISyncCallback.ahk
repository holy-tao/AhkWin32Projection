 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nn-winsync-isynccallback
...
class ISyncCallback extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback-onprogress
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback-onchange
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback-onconflict
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback-onfullenumerationneeded
     */
    OnFullEnumerationNeeded(pFullEnumerationAction) {
        pFullEnumerationActionMarshal := pFullEnumerationAction is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pFullEnumerationActionMarshal, pFullEnumerationAction, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback-onrecoverableerror
     */
