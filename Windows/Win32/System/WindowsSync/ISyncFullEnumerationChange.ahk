 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nn-winsync-isyncfullenumerationchange
...
class ISyncFullEnumerationChange extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isyncfullenumerationchange-getlearnedknowledgeafterrecoverycomplete
     */
    GetLearnedKnowledgeAfterRecoveryComplete() {
        result := ComCall(3, this, "ptr*", &ppLearnedKnowledge := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isyncfullenumerationchange-getlearnedforgottenknowledge
     */
    GetLearnedForgottenKnowledge() {
        result := ComCall(4, this, "ptr*", &ppLearnedForgottenKnowledge := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
