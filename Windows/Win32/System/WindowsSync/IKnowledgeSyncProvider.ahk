 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nn-winsync-iknowledgesyncprovider
...
class IKnowledgeSyncProvider extends ISyncProvider{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-beginsession
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-getsyncbatchparameters
     */
    GetSyncBatchParameters(pdwRequestedBatchSize) {
        pdwRequestedBatchSizeMarshal := pdwRequestedBatchSize is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr*", &ppSyncKnowledge := 0, pdwRequestedBatchSizeMarshal, pdwRequestedBatchSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-getchangebatch
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-getfullenumerationchangebatch
     */
    GetFullEnumerationChangeBatch(dwBatchSize, pbLowerEnumerationBound, pSyncKnowledge, ppSyncChangeBatch, ppUnkDataRetriever) {
        ...
        result := ComCall(7, this, "uint", dwBatchSize, pbLowerEnumerationBoundMarshal, pbLowerEnumerationBound, "ptr", pSyncKnowledge, "ptr*", ppSyncChangeBatch, "ptr*", ppUnkDataRetriever, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-processchangebatch
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-processfullenumerationchangebatch
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-iknowledgesyncprovider-endsession
     */
