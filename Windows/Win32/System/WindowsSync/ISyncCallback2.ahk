 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nn-winsync-isynccallback2
...
class ISyncCallback2 extends ISyncCallback{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback2-onchangeapplied
     */
    OnChangeApplied(dwChangesApplied, dwChangesFailed) {
        result := ComCall(8, this, "uint", dwChangesApplied, "uint", dwChangesFailed, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isynccallback2-onchangefailed
     */
    OnChangeFailed(dwChangesApplied, dwChangesFailed) {
        result := ComCall(9, this, "uint", dwChangesApplied, "uint", dwChangesFailed, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
