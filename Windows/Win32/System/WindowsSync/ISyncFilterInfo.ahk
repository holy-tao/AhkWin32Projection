...
class ISyncFilterInfo extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsync/nf-winsync-isyncfilterinfo-serialize
     */
    Serialize(pbBuffer, pcbBuffer) {
        pbBufferMarshal := pbBuffer is VarRef ? "char*" : "ptr"
        pcbBufferMarshal := pcbBuffer is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, pbBufferMarshal, pbBuffer, pcbBufferMarshal, pcbBuffer, "int")
        if(result != 0) {
