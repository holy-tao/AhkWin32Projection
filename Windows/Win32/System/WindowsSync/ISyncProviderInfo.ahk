 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nn-syncregistration-isyncproviderinfo
...
class ISyncProviderInfo extends IPropertyStore{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nf-syncregistration-isyncproviderinfo-getsyncprovider
     */
    GetSyncProvider(dwClsContext) {
        result := ComCall(8, this, "uint", dwClsContext, "ptr*", &ppSyncProvider := 0, "int")
        if(result != 0) {
