 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nn-syncregistration-isyncproviderconfigui
...
class ISyncProviderConfigUI extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nf-syncregistration-isyncproviderconfigui-init
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nf-syncregistration-isyncproviderconfigui-getregisteredproperties
     */
    GetRegisteredProperties() {
        result := ComCall(4, this, "ptr*", &ppConfigUIProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nf-syncregistration-isyncproviderconfigui-createandregisternewsyncprovider
     */
    CreateAndRegisterNewSyncProvider(hwndParent, pUnkContext) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(5, this, "ptr", hwndParent, "ptr", pUnkContext, "ptr*", &ppProviderInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/syncregistration/nf-syncregistration-isyncproviderconfigui-modifysyncprovider
     */
