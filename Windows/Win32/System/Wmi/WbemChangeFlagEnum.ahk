...
class WbemChangeFlagEnum extends Win32Enum {
     ...
     * Native name: wbemChangeFlagCreateOrUpdate
     * @type {Integer (Int32)}
     */
    static CreateOrUpdate => 0

    /**
     * Causes the call to update. The class or instance must exist for the call to be successful.
     * Native name: wbemChangeFlagUpdateOnly
     * @type {Integer (Int32)}
     */
    static UpdateOnly => 1
     ...
     * Native name: wbemChangeFlagCreateOnly
     * @type {Integer (Int32)}
     */
    static CreateOnly => 2
     ...
     * Native name: wbemChangeFlagUpdateCompatible
     * @type {Integer (Int32)}
     */
    static UpdateCompatible => 0
     ...
     * Native name: wbemChangeFlagUpdateSafeMode
     * @type {Integer (Int32)}
     */
    static UpdateSafeMode => 32
     ...
     * Native name: wbemChangeFlagUpdateForceMode
     * @type {Integer (Int32)}
     */
    static UpdateForceMode => 64
     ...
     * Native name: wbemChangeFlagStrongValidation
     * @type {Integer (Int32)}
     */
    static StrongValidation => 128

    /**
     * Native name: wbemChangeFlagAdvisory
     * @type {Integer (Int32)}
     */
