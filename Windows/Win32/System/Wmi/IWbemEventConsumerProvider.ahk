 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nn-wbemprov-iwbemeventconsumerprovider
...
class IWbemEventConsumerProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nf-wbemprov-iwbemeventconsumerprovider-findconsumer
     */
    FindConsumer(pLogicalConsumer) {
        result := ComCall(3, this, "ptr", pLogicalConsumer, "ptr*", &ppConsumer := 0, "int")
        if(result != 0) {
