 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_CreateInstance extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, newInstance) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, "ptr", newInstance)
    }
}
