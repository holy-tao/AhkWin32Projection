...
class IWbemQuery extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmiutils/nf-wmiutils-iwbemquery-empty
     */
    Empty() {
    ...
    SetLanguageFeatures(uFlags, uArraySize, puFeatures) {
        ...
        result := ComCall(4, this, "uint", uFlags, "uint", uArraySize, puFeaturesMarshal, puFeatures, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    TestLanguageFeatures(uFlags, uArraySize) {
        ...
        result := ComCall(5, this, "uint", uFlags, uArraySizeMarshal, uArraySize, "uint*", &puFeatures := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmiutils/nf-wmiutils-iwbemquery-parse
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wmiutils/nf-wmiutils-iwbemquery-getanalysis
     */
    GetAnalysis(uAnalysisType, uFlags) {
        result := ComCall(7, this, "uint", uAnalysisType, "uint", uFlags, "ptr*", &pAnalysis := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call.
     * @see https://learn.microsoft.com/windows/win32/api//content/wmiutils/nf-wmiutils-iwbemquery-freememory
     */
    FreeMemory(pMem) {
        pMemMarshal := pMem is VarRef ? "ptr" : "ptr"

        result := ComCall(8, this, pMemMarshal, pMem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetQueryInfo(uAnalysisType, uInfoId, uBufSize) {
        result := ComCall(9, this, "uint", uAnalysisType, "uint", uInfoId, "uint", uBufSize, "ptr", &pDestBuf := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
