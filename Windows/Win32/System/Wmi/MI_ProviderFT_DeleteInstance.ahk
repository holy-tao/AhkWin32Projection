 ...
 */
export default struct MI_ProviderFT_DeleteInstance {
    value : IntPtr

    __value {
        set {
            if (value is MI_ProviderFT_DeleteInstance) {
     ...
     */
    Call(self, _context, nameSpace, className, instanceName) {
        ...
        DllCall(this.value, selfMarshal, self, MI_Context.Ptr, _context, nameSpaceMarshal, nameSpace, classNameMarshal, className, MI_Instance.Ptr, instanceName)
    }

    /**
     * A MI_ProviderFT_DeleteInstance that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MI_ProviderFT_DeleteInstance {
        /**
         * Creates a MI_ProviderFT_DeleteInstance pointer that invokes the given AHK function when called.
