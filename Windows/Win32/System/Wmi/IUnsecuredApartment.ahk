 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iunsecuredapartment
...
class IUnsecuredApartment extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iunsecuredapartment-createobjectstub
     */
    CreateObjectStub(pObject) {
        result := ComCall(3, this, "ptr", pObject, "ptr*", &ppStub := 0, "int")
        if(result != 0) {
