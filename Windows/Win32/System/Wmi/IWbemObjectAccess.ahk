 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemobjectaccess
...
class IWbemObjectAccess extends IWbemClassObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-getpropertyhandle
     */
    GetPropertyHandle(wszPropertyName, pType, plHandle) {
        ...
        result := ComCall(27, this, "ptr", wszPropertyName, pTypeMarshal, pType, plHandleMarshal, plHandle, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-writepropertyvalue
     */
    WritePropertyValue(lHandle, lNumBytes, aData) {
        aDataMarshal := aData is VarRef ? "char*" : "ptr"

        result := ComCall(28, this, "int", lHandle, "int", lNumBytes, aDataMarshal, aData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-readpropertyvalue
     */
    ReadPropertyValue(lHandle, lBufferSize, plNumBytes, aData) {
        plNumBytesMarshal := plNumBytes is VarRef ? "int*" : "ptr"
        aDataMarshal := aData is VarRef ? "char*" : "ptr"

        result := ComCall(29, this, "int", lHandle, "int", lBufferSize, plNumBytesMarshal, plNumBytes, aDataMarshal, aData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-readdword
     */
    ReadDWORD(lHandle) {
        result := ComCall(30, this, "int", lHandle, "uint*", &pdw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-writedword
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-readqword
     */
    ReadQWORD(lHandle) {
        result := ComCall(32, this, "int", lHandle, "uint*", &pqw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns <b>WBEM_S_NO_ERROR</b> if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-writeqword
     */
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-getpropertyinfobyhandle
     */
    GetPropertyInfoByHandle(lHandle, pstrName, pType) {
        pTypeMarshal := pType is VarRef ? "int*" : "ptr"

        result := ComCall(34, this, "int", lHandle, "ptr", pstrName, pTypeMarshal, pType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns <b>WBEM_S_NO_ERROR</b> if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-lock
     */
    Lock(lFlags) {
     ...
     * @param {Integer} lFlags Reserved. This parameter is currently ignored and is reserved for future use.
     * @returns {HRESULT} This method returns <b>WBEM_S_NO_ERROR</b> if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemobjectaccess-unlock
     */
    Unlock(lFlags) {
