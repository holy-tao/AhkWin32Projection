 ...
 */
export default struct MI_ProviderFT_Unload {
    value : IntPtr

    __value {
        set {
            if (value is MI_ProviderFT_Unload) {
    ...
    /**
     * A MI_ProviderFT_Unload that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MI_ProviderFT_Unload {
        /**
         * Creates a MI_ProviderFT_Unload pointer that invokes the given AHK function when called.
