 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_AssociatorInstances extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, instanceName, resultClass, role, resultRole, propertySet, keysOnly, filter) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, "ptr", instanceName, resultClassMarshal, resultClass, roleMarshal, role, resultRoleMarshal, resultRole, "ptr", propertySet, "char", keysOnly, "ptr", filter)
    }
}
