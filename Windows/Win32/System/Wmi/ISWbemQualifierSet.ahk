...
class ISWbemQualifierSet extends IDispatch{
    ...
    Item(name, iFlags, objWbemQualifier) {
        ...
        result := ComCall(8, this, "ptr", name, "int", iFlags, "ptr", objWbemQualifier, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Add(strName, varVal, bPropagatesToSubclass, bPropagatesToInstance, bIsOverridable, iFlags, objWbemQualifier) {
        ...
        result := ComCall(10, this, "ptr", strName, "ptr", varVal, "short", bPropagatesToSubclass, "short", bPropagatesToInstance, "short", bIsOverridable, "int", iFlags, "ptr", objWbemQualifier, "int")
        if(result != 0)
            throw OSError(result)
