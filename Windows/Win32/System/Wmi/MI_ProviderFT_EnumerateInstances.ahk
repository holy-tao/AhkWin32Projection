 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_EnumerateInstances extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, propertySet, keysOnly, filter) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, "ptr", propertySet, "char", keysOnly, "ptr", filter)
    }
}
