 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_DisableIndications extends IUnknown {
     ...
     */
    Invoke(self, indicationsContext, nameSpace, className) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", indicationsContext, nameSpaceMarshal, nameSpace, classNameMarshal, className)
    }
}
