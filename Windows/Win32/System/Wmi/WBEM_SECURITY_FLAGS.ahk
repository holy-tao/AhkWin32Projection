...
class WBEM_SECURITY_FLAGS extends Win32Enum {
     ...
     * Native name: WBEM_METHOD_EXECUTE
     * @type {Integer (Int32)}
     */
    static METHOD_EXECUTE => 2
     ...
     * Native name: WBEM_FULL_WRITE_REP
     * @type {Integer (Int32)}
     */
    static FULL_WRITE_REP => 4
     ...
     * Native name: WBEM_PARTIAL_WRITE_REP
     * @type {Integer (Int32)}
     */
    static PARTIAL_WRITE_REP => 8
     ...
     * Native name: WBEM_WRITE_PROVIDER
     * @type {Integer (Int32)}
     */
    static WRITE_PROVIDER => 16
     ...
     * Native name: WBEM_REMOTE_ACCESS
     * @type {Integer (Int32)}
     */
    static REMOTE_ACCESS => 32
     ...
     * Native name: WBEM_RIGHT_SUBSCRIBE
     * @type {Integer (Int32)}
     */
    static RIGHT_SUBSCRIBE => 64
     ...
     * Native name: WBEM_RIGHT_PUBLISH
     * @type {Integer (Int32)}
     */
    static RIGHT_PUBLISH => 128
}
