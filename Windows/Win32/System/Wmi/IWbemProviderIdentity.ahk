 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nn-wbemprov-iwbemprovideridentity
...
class IWbemProviderIdentity extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nf-wbemprov-iwbemprovideridentity-setregistrationobject
     */
    SetRegistrationObject(lFlags, pProvReg) {
        result := ComCall(3, this, "int", lFlags, "ptr", pProvReg, "int")
        if(result != 0) {
