 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemcontext
...
class IWbemContext extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-clone
     */
    Clone() {
        result := ComCall(3, this, "ptr*", &ppNewCopy := 0, "int")
        if(result != 0) {
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-getnames
     */
    GetNames(lFlags) {
        result := ComCall(4, this, "int", lFlags, "ptr*", &pNames := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-beginenumeration
     */
     ...
     * <div> </div>
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-next
     */
    Next(lFlags, pstrName, pValue) {
        result := ComCall(6, this, "int", lFlags, "ptr", pstrName, "ptr", pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-endenumeration
     */
    EndEnumeration() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-setvalue
     */
    SetValue(wszName, lFlags, pValue) {
        wszName := wszName is String ? StrPtr(wszName) : wszName

        result := ComCall(8, this, "ptr", wszName, "int", lFlags, "ptr", pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <b>IWbemClassObject</b> pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-getvalue
     */
    GetValue(wszName, lFlags) {
        wszName := wszName is String ? StrPtr(wszName) : wszName

        pValue := VARIANT()
        result := ComCall(9, this, "ptr", wszName, "int", lFlags, "ptr", pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} lFlags Reserved. This parameter must be 0.
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-deletevalue
     */
    DeleteValue(wszName, lFlags) {
        wszName := wszName is String ? StrPtr(wszName) : wszName

        result := ComCall(10, this, "ptr", wszName, "int", lFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemcontext-deleteall
     */
    DeleteAll() {
