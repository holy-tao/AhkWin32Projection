 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemqualifierset
...
class IWbemQualifierSet extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-get
     */
    Get(wszName, lFlags, pVal, plFlavor) {
        ...
        result := ComCall(3, this, "ptr", wszName, "int", lFlags, "ptr", pVal, plFlavorMarshal, plFlavor, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-put
     */
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-delete
     */
    Delete(wszName) {
        wszName := wszName is String ? StrPtr(wszName) : wszName
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-getnames
     */
    GetNames(lFlags) {
        result := ComCall(6, this, "int", lFlags, "ptr*", &pNames := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-beginenumeration
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/WmiSdk/qualifier-flavors">Qualifier Flavors</a> and <a href="https://docs.microsoft.com/windows/win32/api/wbemcli/ne-wbemcli-wbem_flavor_type">WBEM_FLAVOR_TYPE</a>.
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-next
     */
    Next(lFlags, pstrName, pVal, plFlavor) {
        plFlavorMarshal := plFlavor is VarRef ? "int*" : "ptr"

        result := ComCall(8, this, "int", lFlags, "ptr", pstrName, "ptr", pVal, plFlavorMarshal, plFlavor, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemqualifierset-endenumeration
     */
    EndEnumeration() {
