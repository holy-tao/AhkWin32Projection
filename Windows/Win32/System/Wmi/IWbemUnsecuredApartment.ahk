 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemunsecuredapartment
...
class IWbemUnsecuredApartment extends IUnsecuredApartment{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemunsecuredapartment-createsinkstub
     */
    CreateSinkStub(pSink, dwFlags, wszReserved) {
        wszReserved := wszReserved is String ? StrPtr(wszReserved) : wszReserved

        result := ComCall(4, this, "ptr", pSink, "uint", dwFlags, "ptr", wszReserved, "ptr*", &ppStub := 0, "int")
        if(result != 0) {
