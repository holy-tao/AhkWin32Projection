...
class ISWbemPropertySet extends IDispatch{
    ...
    Item(strName, iFlags, objWbemProperty) {
        ...
        result := ComCall(8, this, "ptr", strName, "int", iFlags, "ptr", objWbemProperty, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Add(strName, iCIMType, bIsArray, iFlags, objWbemProperty) {
        ...
        result := ComCall(10, this, "ptr", strName, "int", iCIMType, "short", bIsArray, "int", iFlags, "ptr", objWbemProperty, "int")
        if(result != 0)
            throw OSError(result)
