 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_ReferenceInstances extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, instanceName, role, propertySet, keysOnly, filter) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, "ptr", instanceName, roleMarshal, role, "ptr", propertySet, "char", keysOnly, "ptr", filter)
    }
}
