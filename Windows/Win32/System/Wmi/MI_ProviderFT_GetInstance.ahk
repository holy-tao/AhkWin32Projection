 ...
 */
export default struct MI_ProviderFT_GetInstance {
    value : IntPtr

    __value {
        set {
            if (value is MI_ProviderFT_GetInstance) {
    ...
    /**
     * A MI_ProviderFT_GetInstance that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MI_ProviderFT_GetInstance {
        /**
         * Creates a MI_ProviderFT_GetInstance pointer that invokes the given AHK function when called.
