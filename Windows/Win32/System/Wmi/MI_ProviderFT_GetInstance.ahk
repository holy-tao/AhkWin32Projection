 ...
 * @version v4.0.30319
 */
class MI_ProviderFT_GetInstance extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, instanceName, propertySet) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, "ptr", instanceName, "ptr", propertySet)
    }
}
