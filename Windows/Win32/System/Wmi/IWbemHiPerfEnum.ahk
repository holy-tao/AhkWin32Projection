 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemhiperfenum
...
class IWbemHiPerfEnum extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemhiperfenum-addobjects
     */
    AddObjects(lFlags, uNumObjects, apIds, apObj) {
        apIdsMarshal := apIds is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "int", lFlags, "uint", uNumObjects, apIdsMarshal, apIds, "ptr*", apObj, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemhiperfenum-removeobjects
     */
    RemoveObjects(lFlags, uNumObjects, apIds) {
        apIdsMarshal := apIds is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "int", lFlags, "uint", uNumObjects, apIdsMarshal, apIds, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an <b>HRESULT</b> indicating the status of the method call. The following list lists the value contained within an <b>HRESULT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemhiperfenum-getobjects
     */
    GetObjects(lFlags, uNumObjects, apObj, puReturned) {
        puReturnedMarshal := puReturned is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "int", lFlags, "uint", uNumObjects, "ptr*", apObj, puReturnedMarshal, puReturned, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemhiperfenum-removeall
     */
    RemoveAll(lFlags) {
