 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nn-wbemprov-iwbemeventprovidersecurity
...
class IWbemEventProviderSecurity extends IUnknown{
     ...
     * @param {Pointer<Integer>} pSid_ Pointer to the constant byte integer type that contains the SID, or <b>NULL</b> if the subscription builder's token is available.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemprov/nf-wbemprov-iwbemeventprovidersecurity-accesscheck
     */
    AccessCheck(wszQueryLanguage, wszQuery, lSidLength, pSid_) {
        ...
        result := ComCall(3, this, wszQueryLanguageMarshal, wszQueryLanguage, wszQueryMarshal, wszQuery, "int", lSidLength, pSid_Marshal, pSid_, "int")
        if(result != 0) {
