 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-imofcompiler
...
class IMofCompiler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-imofcompiler-compilefile
     */
    CompileFile(FileName, ServerAndNamespace, User, Authority, Password, lOptionFlags, lClassFlags, lInstanceFlags, pInfo) {
        ...
        result := ComCall(3, this, "ptr", FileName, "ptr", ServerAndNamespace, "ptr", User, "ptr", Authority, "ptr", Password, "int", lOptionFlags, "int", lClassFlags, "int", lInstanceFlags, "ptr", pInfo, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-imofcompiler-compilebuffer
     */
    CompileBuffer(BuffSize, pBuffer, ServerAndNamespace, User, Authority, Password, lOptionFlags, lClassFlags, lInstanceFlags, pInfo) {
        ...
        result := ComCall(4, this, "int", BuffSize, "ptr", pBuffer, "ptr", ServerAndNamespace, "ptr", User, "ptr", Authority, "ptr", Password, "int", lOptionFlags, "int", lClassFlags, "int", lInstanceFlags, "ptr", pInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the parameter value is not <b>NULL</b>, an error has occurred, and the structure is filled  with error information.
     * @returns {HRESULT} This method returns <b>WBEM_S_NO_ERROR</b> if successful. If the method is unsuccessful, it returns <b>WBEM_S_FALSE</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-imofcompiler-createbmof
     */
    CreateBMOF(TextFileName, BMOFFileName, ServerAndNamespace, lOptionFlags, lClassFlags, lInstanceFlags, pInfo) {
        ...
        result := ComCall(5, this, "ptr", TextFileName, "ptr", BMOFFileName, "ptr", ServerAndNamespace, "int", lOptionFlags, "int", lClassFlags, "int", lInstanceFlags, "ptr", pInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
