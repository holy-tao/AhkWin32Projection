 ...
 */
export default struct MI_ProviderFT_EnableIndications {
    value : IntPtr

    __value {
        set {
            if (value is MI_ProviderFT_EnableIndications) {
    ...
    /**
     * A MI_ProviderFT_EnableIndications that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MI_ProviderFT_EnableIndications {
        /**
         * Creates a MI_ProviderFT_EnableIndications pointer that invokes the given AHK function when called.
