 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nn-wbemcli-iwbemservices
...
class IWbemServices extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-opennamespace
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-cancelasynccall
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-queryobjectsink
     */
    QueryObjectSink(lFlags) {
        result := ComCall(5, this, "int", lFlags, "ptr*", &ppResponseHandler := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-getobject
     */
     ...
     * 
     * COM-specific error codes can also be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-getobjectasync
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-putclass
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-putclassasync
     */
     ...
     * 
     * COM-specific error codes may also be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-deleteclass
     */
     ...
     * 
     * COM-specific error codes also may be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-deleteclassasync
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-createclassenum
     */
    CreateClassEnum(strSuperclass, lFlags, pCtx) {
        ...
        result := ComCall(12, this, "ptr", strSuperclass, "int", lFlags, "ptr", pCtx, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-createclassenumasync
     */
     ...
     * 
     * COM-specific error codes also may be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-putinstance
     */
     ...
     * 
     * COM-specific error codes also may be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-putinstanceasync
     */
     ...
     * 
     * COM-specific error codes also may be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-deleteinstance
     */
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-deleteinstanceasync
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/WmiSdk/making-calls-to-wmi">Making Calls to WMI</a>.
     * @returns {Pointer<IEnumWbemClassObject>} Receives the pointer to the enumerator, which has a positive reference count. The caller must call <b>IUnknown::Release</b> on the pointer after it is no longer required.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-createinstanceenum
     */
    CreateInstanceEnum(strFilter, lFlags, pCtx) {
        if(strFilter is String) {
            pin := BSTR.Alloc(strFilter)
            strFilter := pin.Value
        }

        result := ComCall(18, this, "ptr", strFilter, "int", lFlags, "ptr", pCtx, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-createinstanceenumasync
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execquery
     */
    ExecQuery(strQueryLanguage, strQuery, lFlags, pCtx) {
        ...
        result := ComCall(20, this, "ptr", strQueryLanguage, "ptr", strQuery, "int", lFlags, "ptr", pCtx, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/wbemcli/nf-wbemcli-iwbemobjectsink-setstatus">SetStatus</a> made through <i>pResponseHandler</i>. If you choose to call 
     * <b>SetStatus</b>, the return code sent through <i>pResponseHandler</i> takes precedence.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execqueryasync
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execnotificationquery
     */
    ExecNotificationQuery(strQueryLanguage, strQuery, lFlags, pCtx) {
        ...
        result := ComCall(22, this, "ptr", strQueryLanguage, "ptr", strQuery, "int", lFlags, "ptr", pCtx, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execnotificationqueryasync
     */
     ...
     * 
     * COM-specific error codes also may be returned if network problems cause you to lose the remote connection to Windows Management.
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execmethod
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wbemcli/nf-wbemcli-iwbemservices-execmethodasync
     */
