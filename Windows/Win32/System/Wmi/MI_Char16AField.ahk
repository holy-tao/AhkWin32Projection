 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mi/ns-mi-mi_char16afield
 * @namespace Windows.Win32.System.Wmi
 * @version v4.0.30319
 */
class MI_Char16AField extends Win32Struct
{
    static sizeof => 24
    ...
    value{
        get {
            if(!this.HasProp("__value"))
                this.__value := MI_Char16A(0, this)
            return this.__value
        }
    }
