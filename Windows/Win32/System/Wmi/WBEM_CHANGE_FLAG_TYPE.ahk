...
class WBEM_CHANGE_FLAG_TYPE extends Win32Enum {
     ...
     * Native name: WBEM_FLAG_CREATE_OR_UPDATE
     * @type {Integer (Int32)}
     */
    static CREATE_OR_UPDATE => 0
     ...
     * Native name: WBEM_FLAG_UPDATE_ONLY
     * @type {Integer (Int32)}
     */
    static UPDATE_ONLY => 1

    /**
     * This flag is used for creation only. The call fails if the class already exists.
     * Native name: WBEM_FLAG_CREATE_ONLY
     * @type {Integer (Int32)}
     */
    static CREATE_ONLY => 2
     ...
     * Native name: WBEM_FLAG_UPDATE_COMPATIBLE
     * @type {Integer (Int32)}
     */
    static UPDATE_COMPATIBLE => 0
     ...
     * Native name: WBEM_FLAG_UPDATE_SAFE_MODE
     * @type {Integer (Int32)}
     */
    static UPDATE_SAFE_MODE => 32
     ...
     * Native name: WBEM_FLAG_UPDATE_FORCE_MODE
     * @type {Integer (Int32)}
     */
    static UPDATE_FORCE_MODE => 64

    /**
     * A mask value that can be used to simplify testing for the other flag values.
     * Native name: WBEM_MASK_UPDATE_MODE
     * @type {Integer (Int32)}
     */
    static MASK_UPDATE_MODE => 96

    /**
     * Reserved for future use.
     * Native name: WBEM_FLAG_ADVISORY
     * @type {Integer (Int32)}
     */
    static ADVISORY => 65536
}
