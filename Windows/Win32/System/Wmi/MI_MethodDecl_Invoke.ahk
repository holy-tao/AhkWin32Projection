 ...
 * @version v4.0.30319
 */
class MI_MethodDecl_Invoke extends IUnknown {
     ...
     */
    Invoke(self, context_, nameSpace, className, methodName, instanceName, parameters) {
        ...
        ComCall(3, this, selfMarshal, self, "ptr", context_, nameSpaceMarshal, nameSpace, classNameMarshal, className, methodNameMarshal, methodName, "ptr", instanceName, "ptr", parameters)
    }
}
