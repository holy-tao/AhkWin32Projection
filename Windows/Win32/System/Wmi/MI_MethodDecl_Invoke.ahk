 ...
 */
export default struct MI_MethodDecl_Invoke {
    value : IntPtr

    __value {
        set {
            if (value is MI_MethodDecl_Invoke) {
     ...
     * @param {Pointer<MI_Instance>} parameters 
     * @returns {String} Nothing - always returns an empty string
     */
    Call(self, _context, nameSpace, className, methodName, instanceName, parameters) {
        ...
        methodNameMarshal := methodName is VarRef ? "ushort*" : IntPtr

        DllCall(this.value, selfMarshal, self, MI_Context.Ptr, _context, nameSpaceMarshal, nameSpace, classNameMarshal, className, methodNameMarshal, methodName, MI_Instance.Ptr, instanceName, MI_Instance.Ptr, parameters)
    }

    /**
     * A MI_MethodDecl_Invoke that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MI_MethodDecl_Invoke {
        /**
         * Creates a MI_MethodDecl_Invoke pointer that invokes the given AHK function when called.
