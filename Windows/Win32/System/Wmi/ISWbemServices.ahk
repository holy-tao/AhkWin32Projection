...
class ISWbemServices extends IDispatch{
    ...
    Get(strObjectPath, iFlags, objWbemNamedValueSet, objWbemObject) {
        ...
        result := ComCall(7, this, "ptr", strObjectPath, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObject, "int")
        if(result != 0)
    ...
    InstancesOf(strClass, iFlags, objWbemNamedValueSet, objWbemObjectSet) {
        ...
        result := ComCall(11, this, "ptr", strClass, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObjectSet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SubclassesOf(strSuperclass, iFlags, objWbemNamedValueSet, objWbemObjectSet) {
        ...
        result := ComCall(13, this, "ptr", strSuperclass, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObjectSet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ExecQuery(strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet, objWbemObjectSet) {
        ...
        result := ComCall(15, this, "ptr", strQuery, "ptr", strQueryLanguage, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObjectSet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    AssociatorsOf(strObjectPath, strAssocClass, strResultClass, strResultRole, strRole, bClassesOnly, bSchemaOnly, strRequiredAssocQualifier, strRequiredQualifier, iFlags, objWbemNamedValueSet, objWbemObjectSet) {
        ...
        result := ComCall(17, this, "ptr", strObjectPath, "ptr", strAssocClass, "ptr", strResultClass, "ptr", strResultRole, "ptr", strRole, "short", bClassesOnly, "short", bSchemaOnly, "ptr", strRequiredAssocQualifier, "ptr", strRequiredQualifier, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObjectSet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReferencesTo(strObjectPath, strResultClass, strRole, bClassesOnly, bSchemaOnly, strRequiredQualifier, iFlags, objWbemNamedValueSet, objWbemObjectSet) {
        ...
        result := ComCall(19, this, "ptr", strObjectPath, "ptr", strResultClass, "ptr", strRole, "short", bClassesOnly, "short", bSchemaOnly, "ptr", strRequiredQualifier, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemObjectSet, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ExecNotificationQuery(strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet, objWbemEventSource) {
        ...
        result := ComCall(21, this, "ptr", strQuery, "ptr", strQueryLanguage, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemEventSource, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ExecMethod(strObjectPath, strMethodName, objWbemInParameters, iFlags, objWbemNamedValueSet, objWbemOutParameters) {
        ...
        result := ComCall(23, this, "ptr", strObjectPath, "ptr", strMethodName, "ptr", objWbemInParameters, "int", iFlags, "ptr", objWbemNamedValueSet, "ptr", objWbemOutParameters, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_Security_(objWbemSecurity) {
        result := ComCall(25, this, "ptr", objWbemSecurity, "int")
        if(result != 0)
            throw OSError(result)
