...
class IRowsetEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-irowsetevents-onnewitem
     */
    OnNewItem(itemID, newItemState) {
        result := ComCall(3, this, "ptr", itemID, "int", newItemState, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-irowsetevents-onchangeditem
     */
    OnChangedItem(itemID, rowsetItemState, changedItemState) {
        result := ComCall(4, this, "ptr", itemID, "int", rowsetItemState, "int", changedItemState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-irowsetevents-ondeleteditem
     */
    OnDeletedItem(itemID, deletedItemState) {
        result := ComCall(5, this, "ptr", itemID, "int", deletedItemState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-irowsetevents-onrowsetevent
     */
    OnRowsetEvent(eventType, eventData) {
        result := ComCall(6, this, "int", eventType, "ptr", eventData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
