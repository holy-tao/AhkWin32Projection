 ...
 */
export default struct IProvideMoniker extends IUnknown {
    /**
     ...
     * used for IProvideMoniker interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IProvideMoniker.Vtbl()
        }
    ...
    Query(iid) {
        if (IProvideMoniker.IID.Equals(iid)) {
            return true
        }
