 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nn-structuredquery-inamedentity
...
class INamedEntity extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-inamedentity-getvalue
     */
    GetValue() {
        result := ComCall(3, this, "ptr*", &ppszValue := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-inamedentity-defaultphrase
     */
    DefaultPhrase() {
        result := ComCall(4, this, "ptr*", &ppszPhrase := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
