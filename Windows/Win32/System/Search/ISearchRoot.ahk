...
export default struct ISearchRoot extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_Schedule := CallbackCreate(ObjBindMethod(implObj, "put_Schedule"), flags, 2)
        this.vtbl.get_Schedule := CallbackCreate(ObjBindMethod(implObj, "get_Schedule"), flags, 2)
        this.vtbl.put_RootURL := CallbackCreate(ObjBindMethod(implObj, "put_RootURL"), flags, 2)
        this.vtbl.get_RootURL := CallbackCreate(ObjBindMethod(implObj, "get_RootURL"), flags, 2)
        this.vtbl.put_IsHierarchical := CallbackCreate(ObjBindMethod(implObj, "put_IsHierarchical"), flags, 2)
        this.vtbl.get_IsHierarchical := CallbackCreate(ObjBindMethod(implObj, "get_IsHierarchical"), flags, 2)
        this.vtbl.put_ProvidesNotifications := CallbackCreate(ObjBindMethod(implObj, "put_ProvidesNotifications"), flags, 2)
        this.vtbl.get_ProvidesNotifications := CallbackCreate(ObjBindMethod(implObj, "get_ProvidesNotifications"), flags, 2)
        this.vtbl.put_UseNotificationsOnly := CallbackCreate(ObjBindMethod(implObj, "put_UseNotificationsOnly"), flags, 2)
        this.vtbl.get_UseNotificationsOnly := CallbackCreate(ObjBindMethod(implObj, "get_UseNotificationsOnly"), flags, 2)
        this.vtbl.put_EnumerationDepth := CallbackCreate(ObjBindMethod(implObj, "put_EnumerationDepth"), flags, 2)
        this.vtbl.get_EnumerationDepth := CallbackCreate(ObjBindMethod(implObj, "get_EnumerationDepth"), flags, 2)
        this.vtbl.put_HostDepth := CallbackCreate(ObjBindMethod(implObj, "put_HostDepth"), flags, 2)
        this.vtbl.get_HostDepth := CallbackCreate(ObjBindMethod(implObj, "get_HostDepth"), flags, 2)
        this.vtbl.put_FollowDirectories := CallbackCreate(ObjBindMethod(implObj, "put_FollowDirectories"), flags, 2)
        this.vtbl.get_FollowDirectories := CallbackCreate(ObjBindMethod(implObj, "get_FollowDirectories"), flags, 2)
        this.vtbl.put_AuthenticationType := CallbackCreate(ObjBindMethod(implObj, "put_AuthenticationType"), flags, 2)
        this.vtbl.get_AuthenticationType := CallbackCreate(ObjBindMethod(implObj, "get_AuthenticationType"), flags, 2)
        this.vtbl.put_User := CallbackCreate(ObjBindMethod(implObj, "put_User"), flags, 2)
