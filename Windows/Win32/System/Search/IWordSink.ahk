 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink
...
class IWordSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink-putword
     */
     ...
     * | <dl> <dt>**LANGUAGE\_S\_LARGE\_WORD** </dt> </dl> | Value of *cwc* is larger than the value for *ulMaxTokenSize* that is specified in [**IWordBreaker::Init**](/windows/win32/api/indexsrv/nf-indexsrv-iwordbreaker-init). <br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink-putaltword
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink-startaltphrase
     */
    StartAltPhrase() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink-endaltphrase
     */
    EndAltPhrase() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/search/iwordsink-putbreak
     */
    PutBreak(breakType) {
