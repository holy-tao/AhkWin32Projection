...
class IScopedOperations extends IBindResource{
     ...
     * @param {Pointer<UInt32>} rgdwStatus 
    ...
    Copy(cRows, rgpwszSourceURLs, rgpwszDestURLs, dwCopyFlags, pAuthenticate, rgdwStatus, rgpwszNewURLs, ppStringsBuffer) {
        result := ComCall(4, this, "ptr", cRows, "ptr", rgpwszSourceURLs, "ptr", rgpwszDestURLs, "uint", dwCopyFlags, "ptr", pAuthenticate, "uint*", rgdwStatus, "ptr", rgpwszNewURLs, "ushort*", ppStringsBuffer, "int")
        if(result != 0)
    ...
    Move(cRows, rgpwszSourceURLs, rgpwszDestURLs, dwMoveFlags, pAuthenticate, rgdwStatus, rgpwszNewURLs, ppStringsBuffer) {
        result := ComCall(5, this, "ptr", cRows, "ptr", rgpwszSourceURLs, "ptr", rgpwszDestURLs, "uint", dwMoveFlags, "ptr", pAuthenticate, "uint*", rgdwStatus, "ptr", rgpwszNewURLs, "ushort*", ppStringsBuffer, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Delete(cRows, rgpwszURLs, dwDeleteFlags, rgdwStatus) {
        result := ComCall(6, this, "ptr", cRows, "ptr", rgpwszURLs, "uint", dwDeleteFlags, "uint*", rgdwStatus, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OpenRowset(pUnkOuter, pTableID, pIndexID, riid, cPropertySets, rgPropertySets, ppRowset) {
        result := ComCall(7, this, "ptr", pUnkOuter, "ptr", pTableID, "ptr", pIndexID, "ptr", riid, "uint", cPropertySets, "ptr", rgPropertySets, "ptr", ppRowset, "int")
        if(result != 0)
            throw OSError(result)
