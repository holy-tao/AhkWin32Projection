 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nn-searchapi-isearchcatalogmanager
...
class ISearchCatalogManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-get_name
     */
    get_Name() {
        result := ComCall(3, this, "ptr*", &pszName := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getparameter
     */
    GetParameter(pszName) {
        pszName := pszName is String ? StrPtr(pszName) : pszName

        result := ComCall(4, this, "ptr", pszName, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-setparameter
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getcatalogstatus
     */
    GetCatalogStatus(pStatus, pPausedReason) {
        pStatusMarshal := pStatus is VarRef ? "int*" : "ptr"
        pPausedReasonMarshal := pPausedReason is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pStatusMarshal, pStatus, pPausedReasonMarshal, pPausedReason, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-reset
     */
    Reset() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-reindex
     */
    Reindex() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-reindexmatchingurls
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-reindexsearchroot
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-put_connecttimeout
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-get_connecttimeout
     */
    get_ConnectTimeout() {
        result := ComCall(12, this, "uint*", &pdwConnectTimeout := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-put_datatimeout
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-get_datatimeout
     */
    get_DataTimeout() {
        result := ComCall(14, this, "uint*", &pdwDataTimeout := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-numberofitems
     */
    NumberOfItems() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-numberofitemstoindex
     */
    NumberOfItemsToIndex(plIncrementalCount, plNotificationQueue, plHighPriorityQueue) {
        ...
        result := ComCall(16, this, plIncrementalCountMarshal, plIncrementalCount, plNotificationQueueMarshal, plNotificationQueue, plHighPriorityQueueMarshal, plHighPriorityQueue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-urlbeingindexed
     */
    URLBeingIndexed() {
        result := ComCall(17, this, "ptr*", &pszUrl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Type: <b>DWORD*</b>
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-geturlindexingstate
     */
    GetURLIndexingState(pszURL) {
        pszURL := pszURL is String ? StrPtr(pszURL) : pszURL

        result := ComCall(18, this, "ptr", pszURL, "uint*", &pdwState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getpersistentitemschangedsink
     */
    GetPersistentItemsChangedSink() {
        result := ComCall(19, this, "ptr*", &ppISearchPersistentItemsChangedSink := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Type: <b>DWORD*</b>
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-registerviewfornotification
     */
    RegisterViewForNotification(pszView, pViewChangedSink) {
        pszView := pszView is String ? StrPtr(pszView) : pszView

        result := ComCall(20, this, "ptr", pszView, "ptr", pViewChangedSink, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getitemschangedsink
     */
    GetItemsChangedSink(pISearchNotifyInlineSite, riid, ppv, pGUIDCatalogResetSignature, pGUIDCheckPointSignature, pdwLastCheckPointNumber) {
        ...
        result := ComCall(21, this, "ptr", pISearchNotifyInlineSite, "ptr", riid, ppvMarshal, ppv, "ptr", pGUIDCatalogResetSignature, "ptr", pGUIDCheckPointSignature, pdwLastCheckPointNumberMarshal, pdwLastCheckPointNumber, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-unregisterviewfornotification
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-setextensionclusion
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-enumerateexcludedextensions
     */
    EnumerateExcludedExtensions() {
        result := ComCall(24, this, "ptr*", &ppExtensions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getqueryhelper
     */
    GetQueryHelper() {
        result := ComCall(25, this, "ptr*", &ppSearchQueryHelper := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-put_diacriticsensitivity
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-get_diacriticsensitivity
     */
    get_DiacriticSensitivity() {
        result := ComCall(27, this, "int*", &pfDiacriticSensitive := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcatalogmanager-getcrawlscopemanager
     */
    GetCrawlScopeManager() {
        result := ComCall(28, this, "ptr*", &ppCrawlScopeManager := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
