...
class IConditionGenerator extends IUnknown{
     ...
     * @param {Pointer<ISchemaProvider>} pSchemaProvider 
     * @returns {HRESULT} <ul>
     ...
     * @param {Pointer<INamedEntityCollector>} pNamedEntities 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<IConditionFactory>} pConditionFactory 
    ...
    GenerateForLeaf(pConditionFactory, pszPropertyName, cop, pszValueType, pszValue, pszValue2, pPropertyNameTerm, pOperationTerm, pValueTerm, automaticWildcard, pNoStringQuery, ppQueryExpression) {
        ...
        result := ComCall(5, this, "ptr", pConditionFactory, "ptr", pszPropertyName, "int", cop, "ptr", pszValueType, "ptr", pszValue, "ptr", pszValue2, "ptr", pPropertyNameTerm, "ptr", pOperationTerm, "ptr", pValueTerm, "int", automaticWildcard, "ptr", pNoStringQuery, "ptr", ppQueryExpression, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefaultPhrase(pszValueType, ppropvar, fUseEnglish, ppszPhrase) {
        ...
        result := ComCall(6, this, "ptr", pszValueType, "ptr", ppropvar, "int", fUseEnglish, "ptr", ppszPhrase, "int")
        if(result != 0)
            throw OSError(result)
