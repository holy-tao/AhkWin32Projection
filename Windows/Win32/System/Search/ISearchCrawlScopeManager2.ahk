 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nn-searchapi-isearchcrawlscopemanager2
...
class ISearchCrawlScopeManager2 extends ISearchCrawlScopeManager{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchcrawlscopemanager2-getversion
     */
    GetVersion(plVersion, phFileMapping) {
        plVersionMarshal := plVersion is VarRef ? "ptr*" : "ptr"

        result := ComCall(19, this, plVersionMarshal, plVersion, "ptr", phFileMapping, "int")
        if(result != 0) {
