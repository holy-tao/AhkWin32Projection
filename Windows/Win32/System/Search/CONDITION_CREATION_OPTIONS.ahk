...
class CONDITION_CREATION_OPTIONS extends Win32BitflagEnum {
     ...
     * Native name: CONDITION_CREATION_DEFAULT
     * @type {Integer (Int32)}
     */
    static DEFAULT => 0
     ...
     * Native name: CONDITION_CREATION_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: CONDITION_CREATION_SIMPLIFY
     * @type {Integer (Int32)}
     */
    static SIMPLIFY => 1
     ...
     * Native name: CONDITION_CREATION_VECTOR_AND
     * @type {Integer (Int32)}
     */
    static VECTOR_AND => 2
     ...
     * Native name: CONDITION_CREATION_VECTOR_OR
     * @type {Integer (Int32)}
     */
    static VECTOR_OR => 4
     ...
     * Native name: CONDITION_CREATION_VECTOR_LEAF
     * @type {Integer (Int32)}
     */
    static VECTOR_LEAF => 8
     ...
     * Native name: CONDITION_CREATION_USE_CONTENT_LOCALE
     * @type {Integer (Int32)}
     */
    static USE_CONTENT_LOCALE => 16
}
