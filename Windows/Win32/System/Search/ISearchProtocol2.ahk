 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nn-searchapi-isearchprotocol2
...
class ISearchProtocol2 extends ISearchProtocol{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-isearchprotocol2-createaccessorex
     */
    CreateAccessorEx(pcwszURL, pAuthenticationInfo, pIncrementalAccessInfo, pItemInfo, pUserData) {
        ...
        result := ComCall(7, this, "ptr", pcwszURL, "ptr", pAuthenticationInfo, "ptr", pIncrementalAccessInfo, "ptr", pItemInfo, "ptr", pUserData, "ptr*", &ppAccessor := 0, "int")
        if(result != 0) {
