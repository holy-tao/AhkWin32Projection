 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nn-structuredquery-imetadata
...
class IMetaData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-imetadata-getdata
     */
    GetData(ppszKey, ppszValue) {
        ppszKeyMarshal := ppszKey is VarRef ? "ptr*" : "ptr"
        ppszValueMarshal := ppszValue is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, ppszKeyMarshal, ppszKey, ppszValueMarshal, ppszValue, "int")
        if(result != 0) {
