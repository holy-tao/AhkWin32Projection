...
class ILoadFilter extends IUnknown{
     ...
     * @param {Pointer<Int32>} SearchDecSize 
     * @param {Pointer<UInt16>} pwcsSearchDesc 
    ...
    LoadIFilter(pwcsPath, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid, SearchDecSize, pwcsSearchDesc, ppIFilt) {
        ...
        result := ComCall(3, this, "ptr", pwcsPath, "ptr", pFilteredSources, "ptr", pUnkOuter, "int", fUseDefault, "ptr", pFilterClsid, "int*", SearchDecSize, "ushort*", pwcsSearchDesc, "ptr", ppIFilt, "int")
        if(result != 0)
    ...
    LoadIFilterFromStorage(pStg, pUnkOuter, pwcsOverride, fUseDefault, pFilterClsid, SearchDecSize, pwcsSearchDesc, ppIFilt) {
        ...
        result := ComCall(4, this, "ptr", pStg, "ptr", pUnkOuter, "ptr", pwcsOverride, "int", fUseDefault, "ptr", pFilterClsid, "int*", SearchDecSize, "ushort*", pwcsSearchDesc, "ptr", ppIFilt, "int")
        if(result != 0)
            throw OSError(result)
    ...
    LoadIFilterFromStream(pStm, pFilteredSources, pUnkOuter, fUseDefault, pFilterClsid, SearchDecSize, pwcsSearchDesc, ppIFilt) {
        result := ComCall(5, this, "ptr", pStm, "ptr", pFilteredSources, "ptr", pUnkOuter, "int", fUseDefault, "ptr", pFilterClsid, "int*", SearchDecSize, "ushort*", pwcsSearchDesc, "ptr", ppIFilt, "int")
        if(result != 0)
            throw OSError(result)
