 ...
 */
export default struct IRowsetNextRowset extends IUnknown {
    /**
     ...
     * used for IRowsetNextRowset interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetNextRowset : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IRowsetNextRowset.Vtbl()
        }
    ...
    GetNextRowset(pUnkOuter, riid) {
        result := ComCall(3, this, "ptr", pUnkOuter, Guid.Ptr, riid, "ptr*", &ppNextRowset := 0, "HRESULT")
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetNextRowset)
    }
}
