 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nn-searchapi-iprotocolhandlersite
...
class IProtocolHandlerSite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-iprotocolhandlersite-getfilter
     */
    GetFilter(pclsidObj, pcwszContentType, pcwszExtension) {
        ...
        result := ComCall(3, this, "ptr", pclsidObj, "ptr", pcwszContentType, "ptr", pcwszExtension, "ptr*", &ppFilter := 0, "int")
        if(result != 0) {
