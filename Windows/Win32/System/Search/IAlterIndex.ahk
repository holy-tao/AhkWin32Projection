 ...
 */
export default struct IAlterIndex extends IUnknown {
    /**
     ...
     * used for IAlterIndex interfaces
    */
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.AlterIndex)
    }
}
