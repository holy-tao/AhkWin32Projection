...
export default struct ISearchQueryHelper extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_QueryContentLocale := CallbackCreate(ObjBindMethod(implObj, "put_QueryContentLocale"), flags, 2)
        this.vtbl.get_QueryContentLocale := CallbackCreate(ObjBindMethod(implObj, "get_QueryContentLocale"), flags, 2)
        this.vtbl.put_QueryKeywordLocale := CallbackCreate(ObjBindMethod(implObj, "put_QueryKeywordLocale"), flags, 2)
        this.vtbl.get_QueryKeywordLocale := CallbackCreate(ObjBindMethod(implObj, "get_QueryKeywordLocale"), flags, 2)
        this.vtbl.put_QueryTermExpansion := CallbackCreate(ObjBindMethod(implObj, "put_QueryTermExpansion"), flags, 2)
        this.vtbl.get_QueryTermExpansion := CallbackCreate(ObjBindMethod(implObj, "get_QueryTermExpansion"), flags, 2)
        this.vtbl.put_QuerySyntax := CallbackCreate(ObjBindMethod(implObj, "put_QuerySyntax"), flags, 2)
        this.vtbl.get_QuerySyntax := CallbackCreate(ObjBindMethod(implObj, "get_QuerySyntax"), flags, 2)
        this.vtbl.put_QueryContentProperties := CallbackCreate(ObjBindMethod(implObj, "put_QueryContentProperties"), flags, 2)
        this.vtbl.get_QueryContentProperties := CallbackCreate(ObjBindMethod(implObj, "get_QueryContentProperties"), flags, 2)
        this.vtbl.put_QuerySelectColumns := CallbackCreate(ObjBindMethod(implObj, "put_QuerySelectColumns"), flags, 2)
        this.vtbl.get_QuerySelectColumns := CallbackCreate(ObjBindMethod(implObj, "get_QuerySelectColumns"), flags, 2)
        this.vtbl.put_QueryWhereRestrictions := CallbackCreate(ObjBindMethod(implObj, "put_QueryWhereRestrictions"), flags, 2)
        this.vtbl.get_QueryWhereRestrictions := CallbackCreate(ObjBindMethod(implObj, "get_QueryWhereRestrictions"), flags, 2)
        this.vtbl.put_QuerySorting := CallbackCreate(ObjBindMethod(implObj, "put_QuerySorting"), flags, 2)
        this.vtbl.get_QuerySorting := CallbackCreate(ObjBindMethod(implObj, "get_QuerySorting"), flags, 2)
        this.vtbl.GenerateSQLFromUserQuery := CallbackCreate(ObjBindMethod(implObj, "GenerateSQLFromUserQuery"), flags, 3)
        this.vtbl.WriteProperties := CallbackCreate(ObjBindMethod(implObj, "WriteProperties"), flags, 6)
        this.vtbl.put_QueryMaxResults := CallbackCreate(ObjBindMethod(implObj, "put_QueryMaxResults"), flags, 2)
        this.vtbl.get_QueryMaxResults := CallbackCreate(ObjBindMethod(implObj, "get_QueryMaxResults"), flags, 2)
    }
