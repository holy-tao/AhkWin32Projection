 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nn-structuredquery-inamedentitycollector
...
class INamedEntityCollector extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-inamedentitycollector-add
     */
    Add(beginSpan, endSpan, beginActual, endActual, pType, pszValue, certainty) {
        pszValue := pszValue is String ? StrPtr(pszValue) : pszValue

        result := ComCall(3, this, "uint", beginSpan, "uint", endSpan, "uint", beginActual, "uint", endActual, "ptr", pType, "ptr", pszValue, "int", certainty, "int")
        if(result != 0) {
