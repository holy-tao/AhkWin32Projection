 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nn-structuredquerycondition-icondition
...
class ICondition extends IPersistStream{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getconditiontype
     */
    GetConditionType() {
        result := ComCall(8, this, "int*", &pNodeType := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getsubconditions
     */
    GetSubConditions(riid) {
        result := ComCall(9, this, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getcomparisoninfo
     */
    GetComparisonInfo(ppszPropertyName, pcop, ppropvar) {
        ...
        result := ComCall(10, this, ppszPropertyNameMarshal, ppszPropertyName, pcopMarshal, pcop, "ptr", ppropvar, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getvaluetype
     */
    GetValueType() {
        result := ComCall(11, this, "ptr*", &ppszValueTypeName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getvaluenormalization
     */
    GetValueNormalization() {
        result := ComCall(12, this, "ptr*", &ppszNormalization := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-getinputterms
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquerycondition/nf-structuredquerycondition-icondition-clone
     */
    Clone() {
        result := ComCall(14, this, "ptr*", &ppc := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
