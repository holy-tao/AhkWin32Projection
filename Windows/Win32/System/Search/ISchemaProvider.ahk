 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nn-structuredquery-ischemaprovider
...
class ISchemaProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-entities
     */
    Entities(riid) {
        result := ComCall(3, this, "ptr", riid, "ptr*", &pEntities := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-rootentity
     */
    RootEntity() {
        result := ComCall(4, this, "ptr*", &pRootEntity := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-getentity
     */
    GetEntity(pszEntityName) {
        pszEntityName := pszEntityName is String ? StrPtr(pszEntityName) : pszEntityName

        result := ComCall(5, this, "ptr", pszEntityName, "ptr*", &pEntity := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-metadata
     */
    MetaData(riid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-localize
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-savebinary
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/structuredquery/nf-structuredquery-ischemaprovider-lookupauthorednamedentity
     */
    LookupAuthoredNamedEntity(pEntity, pszInputString, pTokenCollection, cTokensBegin, pcTokensLength, ppszValue) {
        ...
        result := ComCall(9, this, "ptr", pEntity, "ptr", pszInputString, "ptr", pTokenCollection, "uint", cTokensBegin, pcTokensLengthMarshal, pcTokensLength, ppszValueMarshal, ppszValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
