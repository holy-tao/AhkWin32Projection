 ...
 */
export default struct ISQLErrorInfo extends IUnknown {
    /**
     ...
     * used for ISQLErrorInfo interfaces
    */
    ...
    Query(iid) {
        if (ISQLErrorInfo.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetSQLInfo)
    }
}
