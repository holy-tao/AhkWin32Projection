 ...
 */
export default struct IEnumSubscription extends IUnknown {
    /**
     ...
     * used for IEnumSubscription interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumSubscription.Vtbl()
        }
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, Guid.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
    ...
    Clone() {
        ...
        return IEnumSubscription(ppenum)
    }
