 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nn-searchapi-ienumsearchscoperules
...
class IEnumSearchScopeRules extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-ienumsearchscoperules-next
     */
    Next(celt, pceltFetched) {
        pceltFetchedMarshal := pceltFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "uint", celt, "ptr*", &pprgelt := 0, pceltFetchedMarshal, pceltFetched, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-ienumsearchscoperules-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-ienumsearchscoperules-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/searchapi/nf-searchapi-ienumsearchscoperules-clone
     */
    Clone() {
