 ...
 */
export WslIsDistributionRegistered(distributionName) {
    distributionName := distributionName is String ? StrPtr(distributionName) : distributionName

    result := DllCall("Api-ms-win-wsl-api-l1-1-0.dll\WslIsDistributionRegistered", "ptr", distributionName, BOOL)
    return result
}
 ...
 */
export WslRegisterDistribution(distributionName, tarGzFilename) {
    distributionName := distributionName is String ? StrPtr(distributionName) : distributionName
 ...
 */
export WslUnregisterDistribution(distributionName) {
    distributionName := distributionName is String ? StrPtr(distributionName) : distributionName
 ...
 */
export WslLaunchInteractive(distributionName, command, useCurrentWorkingDirectory) {
    distributionName := distributionName is String ? StrPtr(distributionName) : distributionName
 ...
 */
export WslLaunch(distributionName, command, useCurrentWorkingDirectory, stdIn, stdOut, stdErr) {
    distributionName := distributionName is String ? StrPtr(distributionName) : distributionName
    command := command is String ? StrPtr(command) : command
