 ...
 * @since windows5.1.2600
 */
export EmptyWorkingSet(hProcess) {
    A_LastError := 0

    result := DllCall("PSAPI.dll\EmptyWorkingSet", HANDLE, hProcess, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export InitializeProcessForWsWatch(hProcess) {
    A_LastError := 0

    result := DllCall("PSAPI.dll\InitializeProcessForWsWatch", HANDLE, hProcess, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export GetProcessImageFileNameA(hProcess, lpImageFileName, nSize) {
 ...
 * @since windows5.1.2600
 */
export GetProcessImageFileNameW(hProcess, lpImageFileName, nSize) {
    lpImageFileName := lpImageFileName is String ? StrPtr(lpImageFileName) : lpImageFileName
 ...
 * @see https://learn.microsoft.com/windows/win32/api/psapi/nf-psapi-emptyworkingset
 */
export K32EmptyWorkingSet(hProcess) {
    result := DllCall("KERNEL32.dll\K32EmptyWorkingSet", HANDLE, hProcess, BOOL)
    return result
}
 ...
 * @see https://learn.microsoft.com/windows/win32/api/psapi/nf-psapi-initializeprocessforwswatch
 */
export K32InitializeProcessForWsWatch(hProcess) {
    result := DllCall("KERNEL32.dll\K32InitializeProcessForWsWatch", HANDLE, hProcess, BOOL)
    return result
}
