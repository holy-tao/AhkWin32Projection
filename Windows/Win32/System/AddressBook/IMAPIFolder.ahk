 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolderimapicontainer
...
class IMAPIFolder extends IMAPIContainer{
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-createmessage
     */
    CreateMessage(lpInterface, ulFlags) {
        result := ComCall(19, this, "ptr", lpInterface, "uint", ulFlags, "ptr*", &lppMessage := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-copymessages
     */
    CopyMessages(lpMsgList, lpInterface, lpDestFolder, ulUIParam, lpProgress, ulFlags) {
        ...
        result := ComCall(20, this, "ptr", lpMsgList, "ptr", lpInterface, lpDestFolderMarshal, lpDestFolder, "ptr", ulUIParam, "ptr", lpProgress, "uint", ulFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-deletemessages
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-createfolder
     */
    CreateFolder(ulFolderType, lpszFolderName, lpszFolderComment, lpInterface, ulFlags) {
        ...
        result := ComCall(22, this, "uint", ulFolderType, lpszFolderNameMarshal, lpszFolderName, lpszFolderCommentMarshal, lpszFolderComment, "ptr", lpInterface, "uint", ulFlags, "ptr*", &lppFolder := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-copyfolder
     */
    CopyFolder(cbEntryID, lpEntryID, lpInterface, lpDestFolder, lpszNewFolderName, ulUIParam, lpProgress, ulFlags) {
        ...
        result := ComCall(23, this, "uint", cbEntryID, "ptr", lpEntryID, "ptr", lpInterface, lpDestFolderMarshal, lpDestFolder, lpszNewFolderNameMarshal, lpszNewFolderName, "ptr", ulUIParam, "ptr", lpProgress, "uint", ulFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-deletefolder
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-setreadflags
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-getmessagestatus
     */
    GetMessageStatus(cbEntryID, lpEntryID, ulFlags) {
        result := ComCall(26, this, "uint", cbEntryID, "ptr", lpEntryID, "uint", ulFlags, "uint*", &lpulMessageStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-setmessagestatus
     */
    SetMessageStatus(cbEntryID, lpEntryID, ulNewStatus, ulNewStatusMask) {
        result := ComCall(27, this, "uint", cbEntryID, "ptr", lpEntryID, "uint", ulNewStatus, "uint", ulNewStatusMask, "uint*", &lpulOldStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-savecontentssort
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapifolder-emptyfolder
     */
