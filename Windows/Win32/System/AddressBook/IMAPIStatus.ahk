 ...
 */
export default struct IMAPIStatus extends IMAPIProp {
     ...
     * used for IMAPIStatus interfaces
    */
    struct Vtbl extends IMAPIProp.Vtbl {
        ValidateState  : IntPtr
        SettingsDialog : IntPtr
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.ValidateState)
        CallbackFree(this.vtbl.SettingsDialog)
        CallbackFree(this.vtbl.ChangePassword)
        CallbackFree(this.vtbl.FlushQueues)
    }
}
