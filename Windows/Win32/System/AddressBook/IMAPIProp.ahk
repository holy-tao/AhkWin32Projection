 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapipropiunknown
...
class IMAPIProp extends IUnknown{
     ...
     * @param {HRESULT} hResult_ > [in] A handle to the error code generated in the previous method call.
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-getlasterror
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-savechanges
     */
    SaveChanges(ulFlags) {
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-getprops
     */
    GetProps(lpPropTagArray, ulFlags, lpcValues, lppPropArray) {
        ...
        result := ComCall(5, this, "ptr", lpPropTagArray, "uint", ulFlags, lpcValuesMarshal, lpcValues, lppPropArrayMarshal, lppPropArray, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *   
     * > Either the MAPI_UNICODE flag was set and the implementation does not support Unicode, or MAPI_UNICODE was not set and the implementation supports only Unicode.
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-getproplist
     */
    GetPropList(ulFlags, lppPropTagArray) {
        lppPropTagArrayMarshal := lppPropTagArray is VarRef ? "ptr*" : "ptr"

        result := ComCall(6, this, "uint", ulFlags, lppPropTagArrayMarshal, lppPropTagArray, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-openproperty
     */
    OpenProperty(ulPropTag, lpiid, ulInterfaceOptions, ulFlags) {
        result := ComCall(7, this, "uint", ulPropTag, "ptr", lpiid, "uint", ulInterfaceOptions, "uint", ulFlags, "ptr*", &lppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-setprops
     */
    SetProps(cValues, lpPropArray, lppProblems) {
        lppProblemsMarshal := lppProblems is VarRef ? "ptr*" : "ptr"

        result := ComCall(8, this, "uint", cValues, "ptr", lpPropArray, lppProblemsMarshal, lppProblems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-deleteprops
     */
    DeleteProps(lpPropTagArray, lppProblems) {
        lppProblemsMarshal := lppProblems is VarRef ? "ptr*" : "ptr"

        result := ComCall(9, this, "ptr", lpPropTagArray, lppProblemsMarshal, lppProblems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-copyto
     */
    CopyTo(ciidExclude, rgiidExclude, lpExcludeProps, ulUIParam, lpProgress, lpInterface, lpDestObj, ulFlags, lppProblems) {
        ...
        result := ComCall(10, this, "uint", ciidExclude, "ptr", rgiidExclude, "ptr", lpExcludeProps, "ptr", ulUIParam, "ptr", lpProgress, "ptr", lpInterface, lpDestObjMarshal, lpDestObj, "uint", ulFlags, lppProblemsMarshal, lppProblems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *   
     * > The property type is not the type expected by the caller.
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-copyprops
     */
    CopyProps(lpIncludeProps, ulUIParam, lpProgress, lpInterface, lpDestObj, ulFlags, lppProblems) {
        lpDestObjMarshal := lpDestObj is VarRef ? "ptr" : "ptr"
        lppProblemsMarshal := lppProblems is VarRef ? "ptr*" : "ptr"

        result := ComCall(11, this, "ptr", lpIncludeProps, "ptr", ulUIParam, "ptr", lpProgress, "ptr", lpInterface, lpDestObjMarshal, lpDestObj, "uint", ulFlags, lppProblemsMarshal, lppProblems, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-getnamesfromids
     */
    GetNamesFromIDs(lppPropTags, lpPropSetGuid, ulFlags, lpcPropNames, lpppPropNames) {
        ...
        result := ComCall(12, this, lppPropTagsMarshal, lppPropTags, "ptr", lpPropSetGuid, "uint", ulFlags, lpcPropNamesMarshal, lpcPropNames, lpppPropNamesMarshal, lpppPropNames, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprop-getidsfromnames
     */
    GetIDsFromNames(cPropNames, lppPropNames, ulFlags, lppPropTags) {
        lppPropNamesMarshal := lppPropNames is VarRef ? "ptr*" : "ptr"
        lppPropTagsMarshal := lppPropTags is VarRef ? "ptr*" : "ptr"

        result := ComCall(13, this, "uint", cPropNames, lppPropNamesMarshal, lppPropNames, "uint", ulFlags, lppPropTagsMarshal, lppPropTags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
