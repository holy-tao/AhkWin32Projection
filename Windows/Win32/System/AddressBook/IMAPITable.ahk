 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wabdefs/nn-wabdefs-imapitable
...
class IMAPITable extends IUnknown{
     ...
     * @param {HRESULT} hResult_ > [in] HRESULT containing the error generated in the previous method call.
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-getlasterror
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-advise
     */
    Advise(ulEventMask, lpAdviseSink, lpulConnection) {
        lpulConnectionMarshal := lpulConnection is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, "uint", ulEventMask, "ptr", lpAdviseSink, lpulConnectionMarshal, lpulConnection, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *   
     * > The call succeeded.
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-unadvise
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-getstatus
     */
    GetStatus(lpulTableStatus, lpulTableType) {
        ...
        result := ComCall(6, this, lpulTableStatusMarshal, lpulTableStatus, lpulTableTypeMarshal, lpulTableType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-setcolumns
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-querycolumns
     */
    QueryColumns(ulFlags, lpPropTagArray) {
        lpPropTagArrayMarshal := lpPropTagArray is VarRef ? "ptr*" : "ptr"

        result := ComCall(8, this, "uint", ulFlags, lpPropTagArrayMarshal, lpPropTagArray, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-getrowcount
     */
    GetRowCount(ulFlags, lpulCount) {
        lpulCountMarshal := lpulCount is VarRef ? "uint*" : "ptr"

        result := ComCall(9, this, "uint", ulFlags, lpulCountMarshal, lpulCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-seekrow
     */
    SeekRow(bkOrigin, lRowCount, lplRowsSought) {
        lplRowsSoughtMarshal := lplRowsSought is VarRef ? "int*" : "ptr"

        result := ComCall(10, this, "uint", bkOrigin, "int", lRowCount, lplRowsSoughtMarshal, lplRowsSought, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *   
     * > Another operation is in progress that prevents the row seeking operation from starting. Either the operation in progress should be allowed to complete or it should be stopped.
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-seekrowapprox
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-queryposition
     */
    QueryPosition(lpulRow, lpulNumerator, lpulDenominator) {
        ...
        result := ComCall(12, this, lpulRowMarshal, lpulRow, lpulNumeratorMarshal, lpulNumerator, lpulDenominatorMarshal, lpulDenominator, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-findrow
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-restrict
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-createbookmark
     */
    CreateBookmark(lpbkPosition) {
        lpbkPositionMarshal := lpbkPosition is VarRef ? "uint*" : "ptr"

        result := ComCall(15, this, lpbkPositionMarshal, lpbkPosition, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-freebookmark
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-sorttable
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-querysortorder
     */
    QuerySortOrder(lppSortCriteria) {
        lppSortCriteriaMarshal := lppSortCriteria is VarRef ? "ptr*" : "ptr"

        result := ComCall(18, this, lppSortCriteriaMarshal, lppSortCriteria, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-queryrows
     */
    QueryRows(lRowCount, ulFlags, lppRows) {
        lppRowsMarshal := lppRows is VarRef ? "ptr*" : "ptr"

        result := ComCall(19, this, "int", lRowCount, "uint", ulFlags, lppRowsMarshal, lppRows, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-abort
     */
    Abort() {
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-expandrow
     */
    ExpandRow(cbInstanceKey, pbInstanceKey, ulRowCount, ulFlags, lppRows, lpulMoreRows) {
        ...
        result := ComCall(21, this, "uint", cbInstanceKey, pbInstanceKeyMarshal, pbInstanceKey, "uint", ulRowCount, "uint", ulFlags, lppRowsMarshal, lppRows, lpulMoreRowsMarshal, lpulMoreRows, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-collapserow
     */
    CollapseRow(cbInstanceKey, pbInstanceKey, ulFlags, lpulRowCount) {
        pbInstanceKeyMarshal := pbInstanceKey is VarRef ? "char*" : "ptr"
        lpulRowCountMarshal := lpulRowCount is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, "uint", cbInstanceKey, pbInstanceKeyMarshal, pbInstanceKey, "uint", ulFlags, lpulRowCountMarshal, lpulRowCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-waitforcompletion
     */
    WaitForCompletion(ulFlags, ulTimeout, lpulTableStatus) {
        lpulTableStatusMarshal := lpulTableStatus is VarRef ? "uint*" : "ptr"

        result := ComCall(23, this, "uint", ulFlags, "uint", ulTimeout, lpulTableStatusMarshal, lpulTableStatus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-getcollapsestate
     */
    GetCollapseState(ulFlags, cbInstanceKey, lpbInstanceKey, lpcbCollapseState, lppbCollapseState) {
        ...
        result := ComCall(24, this, "uint", ulFlags, "uint", cbInstanceKey, lpbInstanceKeyMarshal, lpbInstanceKey, lpcbCollapseStateMarshal, lpcbCollapseState, lppbCollapseStateMarshal, lppbCollapseState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapitable-setcollapsestate
     */
    SetCollapseState(ulFlags, cbCollapseState, pbCollapseState, lpbkLocation) {
        ...
        result := ComCall(25, this, "uint", ulFlags, "uint", cbCollapseState, pbCollapseStateMarshal, pbCollapseState, lpbkLocationMarshal, lpbkLocation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
