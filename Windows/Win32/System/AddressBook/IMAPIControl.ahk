 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontroliunknown
...
class IMAPIControl extends IUnknown{
     ...
     * @param {HRESULT} hResult_ > [in] A handle to the error value generated in the previous method call.
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontrol-getlasterror
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontrol-activate
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontrol-getstate
     */
    GetState(ulFlags, lpulState) {
        lpulStateMarshal := lpulState is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "uint", ulFlags, lpulStateMarshal, lpulState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
