 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstoreimapiprop
...
class IMsgStore extends IMAPIProp{
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-advise
     */
    Advise(cbEntryID, lpEntryID, ulEventMask, lpAdviseSink) {
        result := ComCall(14, this, "uint", cbEntryID, "ptr", lpEntryID, "uint", ulEventMask, "ptr", lpAdviseSink, "uint*", &lpulConnection := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-unadvise
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-compareentryids
     */
    CompareEntryIDs(cbEntryID1, lpEntryID1, cbEntryID2, lpEntryID2, ulFlags) {
        result := ComCall(16, this, "uint", cbEntryID1, "ptr", lpEntryID1, "uint", cbEntryID2, "ptr", lpEntryID2, "uint", ulFlags, "uint*", &lpulResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-openentry
     */
    OpenEntry(cbEntryID, lpEntryID, lpInterface, ulFlags, lpulObjType, ppUnk) {
        lpulObjTypeMarshal := lpulObjType is VarRef ? "uint*" : "ptr"

        result := ComCall(17, this, "uint", cbEntryID, "ptr", lpEntryID, "ptr", lpInterface, "uint", ulFlags, lpulObjTypeMarshal, lpulObjType, "ptr*", ppUnk, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-setreceivefolder
     */
    SetReceiveFolder(lpszMessageClass, ulFlags, cbEntryID, lpEntryID) {
        lpszMessageClassMarshal := lpszMessageClass is VarRef ? "char*" : "ptr"

        result := ComCall(18, this, lpszMessageClassMarshal, lpszMessageClass, "uint", ulFlags, "uint", cbEntryID, "ptr", lpEntryID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-getreceivefolder
     */
    GetReceiveFolder(lpszMessageClass, ulFlags, lpcbEntryID, lppEntryID, lppszExplicitClass) {
        ...
        result := ComCall(19, this, lpszMessageClassMarshal, lpszMessageClass, "uint", ulFlags, lpcbEntryIDMarshal, lpcbEntryID, lppEntryIDMarshal, lppEntryID, lppszExplicitClassMarshal, lppszExplicitClass, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-getreceivefoldertable
     */
    GetReceiveFolderTable(ulFlags) {
        result := ComCall(20, this, "uint", ulFlags, "ptr*", &lppTable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-storelogoff
     */
    StoreLogoff(lpulFlags) {
        lpulFlagsMarshal := lpulFlags is VarRef ? "uint*" : "ptr"

        result := ComCall(21, this, lpulFlagsMarshal, lpulFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-abortsubmit
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-getoutgoingqueue
     */
    GetOutgoingQueue(ulFlags) {
        result := ComCall(23, this, "uint", ulFlags, "ptr*", &lppTable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-setlockstate
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-finishedmsg
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imsgstore-notifynewmail
     */
