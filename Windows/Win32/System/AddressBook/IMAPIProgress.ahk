 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogressiunknown
...
class IMAPIProgress extends IUnknown{
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogress-progress
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogress-getflags
     */
    GetFlags(lpulFlags) {
        lpulFlagsMarshal := lpulFlags is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, lpulFlagsMarshal, lpulFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogress-getmax
     */
    GetMax(lpulMax) {
        lpulMaxMarshal := lpulMax is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, lpulMaxMarshal, lpulMax, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogress-getmin
     */
    GetMin(lpulMin) {
        lpulMinMarshal := lpulMin is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, lpulMinMarshal, lpulMin, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapiprogress-setlimits
     */
    SetLimits(lpulMin, lpulMax, lpulFlags) {
        ...
        result := ComCall(7, this, lpulMinMarshal, lpulMin, lpulMaxMarshal, lpulMax, lpulFlagsMarshal, lpulFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
