 ...
 * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainerimapiprop
...
class IMAPIContainer extends IMAPIProp{
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainer-getcontentstable
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainer-gethierarchytable
     */
    GetHierarchyTable(ulFlags) {
        result := ComCall(15, this, "uint", ulFlags, "ptr*", &lppTable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainer-openentry
     */
    OpenEntry(cbEntryID, lpEntryID, lpInterface, ulFlags, lpulObjType, lppUnk) {
        lpulObjTypeMarshal := lpulObjType is VarRef ? "uint*" : "ptr"

        result := ComCall(16, this, "uint", cbEntryID, "ptr", lpEntryID, "ptr", lpInterface, "uint", ulFlags, lpulObjTypeMarshal, lpulObjType, "ptr*", lppUnk, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainer-setsearchcriteria
     */
     ...
     * @see https://learn.microsoft.com/office/client-developer/ocs/docs/outlook/mapi/imapicontainer-getsearchcriteria
     */
    GetSearchCriteria(ulFlags, lppRestriction, lppContainerList, lpulSearchState) {
        ...
        result := ComCall(18, this, "uint", ulFlags, lppRestrictionMarshal, lppRestriction, lppContainerListMarshal, lppContainerList, lpulSearchStateMarshal, lpulSearchState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
