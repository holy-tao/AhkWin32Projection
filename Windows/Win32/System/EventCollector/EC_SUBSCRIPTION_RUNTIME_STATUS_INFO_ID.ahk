...
class EC_SUBSCRIPTION_RUNTIME_STATUS_INFO_ID extends Win32Enum {
     ...
     * Native name: EcSubscriptionRunTimeStatusActive
     * @type {Integer (Int32)}
     */
    static RunTimeStatusActive => 0
     ...
     * Native name: EcSubscriptionRunTimeStatusLastError
     * @type {Integer (Int32)}
     */
    static RunTimeStatusLastError => 1
     ...
     * Native name: EcSubscriptionRunTimeStatusLastErrorMessage
     * @type {Integer (Int32)}
     */
    static RunTimeStatusLastErrorMessage => 2
     ...
     * Native name: EcSubscriptionRunTimeStatusLastErrorTime
     * @type {Integer (Int32)}
     */
    static RunTimeStatusLastErrorTime => 3
     ...
     * Native name: EcSubscriptionRunTimeStatusNextRetryTime
     * @type {Integer (Int32)}
     */
    static RunTimeStatusNextRetryTime => 4
     ...
     * Native name: EcSubscriptionRunTimeStatusEventSources
     * @type {Integer (Int32)}
     */
    static RunTimeStatusEventSources => 5
     ...
     * Native name: EcSubscriptionRunTimeStatusLastHeartbeatTime
     * @type {Integer (Int32)}
     */
    static RunTimeStatusLastHeartbeatTime => 6

    /**
     * Native name: EcSubscriptionRunTimeStatusInfoIdEND
     * @type {Integer (Int32)}
     */
    static RunTimeStatusInfoIdEND => 7
}
