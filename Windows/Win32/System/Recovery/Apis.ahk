 ...
 * @since windows6.0.6000
 */
export UnregisterApplicationRecoveryCallback() {
 ...
 * @since windows6.0.6000
 */
export UnregisterApplicationRestart() {
 ...
 * @since windows6.0.6000
 */
export ApplicationRecoveryInProgress() {
    result := DllCall("KERNEL32.dll\ApplicationRecoveryInProgress", BOOL.Ptr, &pbCancelled := 0, "HRESULT")
    return pbCancelled
}
 ...
 * @since windows6.0.6000
 */
export ApplicationRecoveryFinished(bSuccess) {
    DllCall("KERNEL32.dll\ApplicationRecoveryFinished", BOOL, bSuccess)
}
