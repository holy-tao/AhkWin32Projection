 ...
 */
export default struct IWsbApplicationBackupSupport extends IUnknown {
    /**
     ...
     * used for IWsbApplicationBackupSupport interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        CheckConsistency : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWsbApplicationBackupSupport.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.CheckConsistency)
    }
}
