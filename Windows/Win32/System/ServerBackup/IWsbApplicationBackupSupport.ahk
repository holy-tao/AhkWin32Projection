 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nn-wsbapp-iwsbapplicationbackupsupport
...
class IWsbApplicationBackupSupport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nf-wsbapp-iwsbapplicationbackupsupport-checkconsistency
     */
    CheckConsistency(wszWriterMetadata, wszComponentName, wszComponentLogicalPath, cVolumes, rgwszSourceVolumePath, rgwszSnapshotVolumePath) {
        ...
        result := ComCall(3, this, "ptr", wszWriterMetadata, "ptr", wszComponentName, "ptr", wszComponentLogicalPath, "uint", cVolumes, rgwszSourceVolumePathMarshal, rgwszSourceVolumePath, rgwszSnapshotVolumePathMarshal, rgwszSnapshotVolumePath, "ptr*", &ppAsync := 0, "int")
        if(result != 0) {
