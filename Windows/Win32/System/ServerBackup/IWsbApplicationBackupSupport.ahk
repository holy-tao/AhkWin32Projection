...
class IWsbApplicationBackupSupport extends IUnknown{
    ...
    CheckConsistency(wszWriterMetadata, wszComponentName, wszComponentLogicalPath, cVolumes, rgwszSourceVolumePath, rgwszSnapshotVolumePath, ppAsync) {
        ...
        result := ComCall(3, this, "ptr", wszWriterMetadata, "ptr", wszComponentName, "ptr", wszComponentLogicalPath, "uint", cVolumes, "ptr", rgwszSourceVolumePath, "ptr", rgwszSnapshotVolumePath, "ptr", ppAsync, "int")
        if(result != 0)
