 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nn-wsbapp-iwsbapplicationrestoresupport
...
class IWsbApplicationRestoreSupport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nf-wsbapp-iwsbapplicationrestoresupport-prerestore
     */
     ...
     * @param {BOOLEAN} bNoRollForward Set to <b>TRUE</b> if a previous point-in-time recovery operation is in progress and no application rollforward should be performed. The previous logs for the application will be deleted before the application restore operation is performed.
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise. Possible return values include the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nf-wsbapp-iwsbapplicationrestoresupport-postrestore
     */
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if successful, or an error value otherwise. Possible return values include the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nf-wsbapp-iwsbapplicationrestoresupport-ordercomponents
     */
    OrderComponents(cComponents, rgComponentName, rgComponentLogicalPaths, prgComponentName, prgComponentLogicalPath) {
        ...
        result := ComCall(5, this, "uint", cComponents, rgComponentNameMarshal, rgComponentName, rgComponentLogicalPathsMarshal, rgComponentLogicalPaths, prgComponentNameMarshal, prgComponentName, prgComponentLogicalPathMarshal, prgComponentLogicalPath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *       <b>FALSE</b> otherwise.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsbapp/nf-wsbapp-iwsbapplicationrestoresupport-isrollforwardsupported
     */
    IsRollForwardSupported() {
        result := ComCall(6, this, "char*", &pbRollForwardSupported := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
