 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-istdmarshalinfo
...
class IStdMarshalInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istdmarshalinfo-getclassforhandler
     */
    GetClassForHandler(dwDestContext) {
        static pvDestContext := 0 ;Reserved parameters must always be NULL

        pClsid := Guid()
        result := ComCall(3, this, "uint", dwDestContext, "ptr", pvDestContext, "ptr", pClsid, "int")
        if(result != 0) {
