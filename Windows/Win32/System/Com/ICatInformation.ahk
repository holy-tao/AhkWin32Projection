 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nn-comcat-icatinformation
...
class ICatInformation extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-enumcategories
     */
    EnumCategories(lcid) {
        result := ComCall(3, this, "uint", lcid, "ptr*", &ppenumCategoryInfo := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-getcategorydesc
     */
    GetCategoryDesc(rcatid, lcid) {
        result := ComCall(4, this, "ptr", rcatid, "uint", lcid, "ptr*", &pszDesc := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-enumclassesofcategories
     */
    EnumClassesOfCategories(cImplemented, rgcatidImpl, cRequired, rgcatidReq) {
        result := ComCall(5, this, "uint", cImplemented, "ptr", rgcatidImpl, "uint", cRequired, "ptr", rgcatidReq, "ptr*", &ppenumClsid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-isclassofcategories
     */
    IsClassOfCategories(rclsid, cImplemented, rgcatidImpl, cRequired, rgcatidReq) {
        result := ComCall(6, this, "ptr", rclsid, "uint", cImplemented, "ptr", rgcatidImpl, "uint", cRequired, "ptr", rgcatidReq, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-enumimplcategoriesofclass
     */
    EnumImplCategoriesOfClass(rclsid) {
        result := ComCall(7, this, "ptr", rclsid, "ptr*", &ppenumCatid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-icatinformation-enumreqcategoriesofclass
     */
    EnumReqCategoriesOfClass(rclsid) {
        result := ComCall(8, this, "ptr", rclsid, "ptr*", &ppenumCatid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
