...
class CLSCTX extends Win32BitflagEnum {
     ...
     * Native name: CLSCTX_INPROC_SERVER
     * @type {Integer (UInt32)}
     */
     ...
     * Native name: CLSCTX_INPROC_HANDLER
     * @type {Integer (UInt32)}
     */
    static INPROC_HANDLER => 2

    /**
     * The EXE code that creates and manages objects of this class runs on same machine but is loaded in a separate process space.
     * Native name: CLSCTX_LOCAL_SERVER
     * @type {Integer (UInt32)}
     */
    static LOCAL_SERVER => 4

    /**
     * Obsolete.
     * Native name: CLSCTX_INPROC_SERVER16
     * @type {Integer (UInt32)}
     */
    static INPROC_SERVER16 => 8
     ...
     * Native name: CLSCTX_REMOTE_SERVER
     * @type {Integer (UInt32)}
     */
    static REMOTE_SERVER => 16

    /**
     * Obsolete.
     * Native name: CLSCTX_INPROC_HANDLER16
     * @type {Integer (UInt32)}
     */
    static INPROC_HANDLER16 => 32

    /**
     * Reserved.
     * Native name: CLSCTX_RESERVED1
     * @type {Integer (UInt32)}
     */
    static RESERVED1 => 64
     ...
     * Native name: CLSCTX_NO_CODE_DOWNLOAD
     * @type {Integer (UInt32)}
     */
    static NO_CODE_DOWNLOAD => 1024

    /**
     * Reserved.
     * Native name: CLSCTX_RESERVED5
     * @type {Integer (UInt32)}
     */
     ...
     * Native name: CLSCTX_NO_CUSTOM_MARSHAL
     * @type {Integer (UInt32)}
     */
    static NO_CUSTOM_MARSHAL => 4096
     ...
     * Native name: CLSCTX_ENABLE_CODE_DOWNLOAD
     * @type {Integer (UInt32)}
     */
    static ENABLE_CODE_DOWNLOAD => 8192
     ...
     * </li>
     * </ul>
     * Native name: CLSCTX_NO_FAILURE_LOG
     * @type {Integer (UInt32)}
     */
    static NO_FAILURE_LOG => 16384
     ...
     * Native name: CLSCTX_DISABLE_AAA
     * @type {Integer (UInt32)}
     */
    static DISABLE_AAA => 32768
     ...
     * 
     * <b>Windows 2000:  </b>This flag is not supported.
     * Native name: CLSCTX_ENABLE_AAA
     * @type {Integer (UInt32)}
     */
    static ENABLE_AAA => 65536

    /**
     * Begin this activation from the default context of the current apartment.
     * Native name: CLSCTX_FROM_DEFAULT_CONTEXT
     * @type {Integer (UInt32)}
     */
    static FROM_DEFAULT_CONTEXT => 131072

    /**
     * Native name: CLSCTX_ACTIVATE_X86_SERVER
     * @type {Integer (UInt32)}
     */
    static ACTIVATE_X86_SERVER => 262144

    /**
     * Activate or connect to a 32-bit version of the server; fail if one is not registered.
     * Native name: CLSCTX_ACTIVATE_32_BIT_SERVER
     * @type {Integer (UInt32)}
     */
    static ACTIVATE_32_BIT_SERVER => 262144

    /**
     * Activate or connect to a 64 bit version of the server; fail if one is not registered.
     * Native name: CLSCTX_ACTIVATE_64_BIT_SERVER
     * @type {Integer (UInt32)}
     */
    static ACTIVATE_64_BIT_SERVER => 524288
     ...
     * Native name: CLSCTX_ENABLE_CLOAKING
     * @type {Integer (UInt32)}
     */
    static ENABLE_CLOAKING => 1048576
     ...
     * <div> </div>
     * Native name: CLSCTX_APPCONTAINER
     * @type {Integer (UInt32)}
     */
    static APPCONTAINER => 4194304
     ...
     * Native name: CLSCTX_ACTIVATE_AAA_AS_IU
     * @type {Integer (UInt32)}
     */
    static ACTIVATE_AAA_AS_IU => 8388608

    /**
     * Native name: CLSCTX_RESERVED6
     * @type {Integer (UInt32)}
     */
    static RESERVED6 => 16777216

    /**
     * Native name: CLSCTX_ACTIVATE_ARM32_SERVER
     * @type {Integer (UInt32)}
     */
    static ACTIVATE_ARM32_SERVER => 33554432

    /**
     * Native name: CLSCTX_ALLOW_LOWER_TRUST_REGISTRATION
     * @type {Integer (UInt32)}
     */
    static ALLOW_LOWER_TRUST_REGISTRATION => 67108864

    /**
     * Native name: CLSCTX_SERVER_MUST_BE_EQUAL_OR_GREATER_PRIVILEGE
     * @type {Integer (UInt32)}
     */
    static SERVER_MUST_BE_EQUAL_OR_GREATER_PRIVILEGE => 134217728

    /**
     * Native name: CLSCTX_DO_NOT_ELEVATE_SERVER
     * @type {Integer (UInt32)}
     */
    static DO_NOT_ELEVATE_SERVER => 268435456
     ...
     * <div class="alert"><b>Note</b>  This flag is reserved for internal use and is not intended to be used directly from your code.</div>
     * <div> </div>
     * Native name: CLSCTX_PS_DLL
     * @type {Integer (UInt32)}
     */
    static PS_DLL => 2147483648

    /**
     * Native name: CLSCTX_ALL
     * @type {Integer (UInt32)}
     */
    static ALL => 23

    /**
     * Native name: CLSCTX_SERVER
     * @type {Integer (UInt32)}
     */
    static SERVER => 21
}
