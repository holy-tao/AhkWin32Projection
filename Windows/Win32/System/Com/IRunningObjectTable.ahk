 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-irunningobjecttable
...
class IRunningObjectTable extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-register
     */
    Register(grfFlags, punkObject, pmkObjectName) {
        result := ComCall(3, this, "uint", grfFlags, "ptr", punkObject, "ptr", pmkObjectName, "uint*", &pdwRegister := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-revoke
     */
    Revoke(dwRegister) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-isrunning
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-getobject
     */
    GetObject(pmkObjectName) {
        result := ComCall(6, this, "ptr", pmkObjectName, "ptr*", &ppunkObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-notechangetime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-gettimeoflastchange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irunningobjecttable-enumrunning
     */
    EnumRunning() {
        result := ComCall(9, this, "ptr*", &ppenumMoniker := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
