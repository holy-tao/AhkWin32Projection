 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-ienumconnectionpoints
...
class IEnumConnectionPoints extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ienumconnectionpoints-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ienumconnectionpoints-skip
     */
    Skip(cConnections) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ienumconnectionpoints-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-ienumconnectionpoints-clone
     */
    Clone() {
