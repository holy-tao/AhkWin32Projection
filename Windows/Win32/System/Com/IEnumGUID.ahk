 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nn-comcat-ienumguid
...
class IEnumGUID extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumguid-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumguid-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumguid-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumguid-clone
     */
    Clone() {
