...
export default struct IOplockStorage extends IUnknown {
    ...
    */
    ...
    CreateStorageEx(pwcsName, grfMode, _stgfmt, grfAttrs, riid) {
        ...
        result := ComCall(3, this, "ptr", pwcsName, UInt32, grfMode, UInt32, _stgfmt, UInt32, grfAttrs, Guid.Ptr, riid, "ptr*", &ppstgOpen := 0, "HRESULT")
        return ppstgOpen
    }
    ...
    OpenStorageEx(pwcsName, grfMode, _stgfmt, grfAttrs, riid) {
        ...
        result := ComCall(4, this, "ptr", pwcsName, UInt32, grfMode, UInt32, _stgfmt, UInt32, grfAttrs, Guid.Ptr, riid, "ptr*", &ppstgOpen := 0, "HRESULT")
        return ppstgOpen
    }
