...
class IUri extends IUnknown{
    ...
    GetPropertyLength(uriProp, dwFlags) {
        result := ComCall(4, this, "int", uriProp, "uint*", &pcchProperty := 0, "uint", dwFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetPropertyDWORD(uriProp, dwFlags) {
        result := ComCall(5, this, "int", uriProp, "uint*", &pdwProperty := 0, "uint", dwFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    HasProperty(uriProp) {
        result := ComCall(6, this, "int", uriProp, "int*", &pfHasProperty := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetHostType() {
        result := ComCall(22, this, "uint*", &pdwHostType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetPort() {
        result := ComCall(23, this, "uint*", &pdwPort := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetScheme() {
        result := ComCall(24, this, "uint*", &pdwScheme := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetZone() {
        result := ComCall(25, this, "uint*", &pdwZone := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetProperties() {
        result := ComCall(26, this, "uint*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    IsEqual(pUri) {
        result := ComCall(27, this, "ptr", pUri, "int*", &pfEqual := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
