 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-iadvisesink2
...
class IAdviseSink2 extends IAdviseSink{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iadvisesink2-onlinksrcchange
     */
    OnLinkSrcChange(pmk) {
