 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-iinitializespy
...
class IInitializeSpy extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iinitializespy-preinitialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iinitializespy-postinitialize
     */
     ...
     * @param {Integer} dwCurThreadAptRefs The number of times <a href="https://docs.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-coinitializeex">CoInitializeEx</a> has been called on this thread.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iinitializespy-preuninitialize
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iinitializespy-postuninitialize
     */
