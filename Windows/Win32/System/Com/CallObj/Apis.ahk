 ...
 * @see https://learn.microsoft.com/windows/win32/api/callobj/nf-callobj-cogetinterceptor
 * @since windows5.0
 */
export CoGetInterceptor(iidIntercepted, punkOuter, iid) {
    result := DllCall("ole32.dll\CoGetInterceptor", Guid.Ptr, iidIntercepted, "ptr", punkOuter, Guid.Ptr, iid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 */
export CoGetInterceptorFromTypeInfo(iidIntercepted, punkOuter, typeInfo, iid) {
    result := DllCall("ole32.dll\CoGetInterceptorFromTypeInfo", Guid.Ptr, iidIntercepted, "ptr", punkOuter, "ptr", typeInfo, Guid.Ptr, iid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
