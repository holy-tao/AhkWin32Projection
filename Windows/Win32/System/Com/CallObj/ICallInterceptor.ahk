 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/callobj/nn-callobj-icallinterceptor
...
class ICallInterceptor extends ICallIndirect{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/callobj/nf-callobj-icallinterceptor-registersink
     */
    RegisterSink(psink) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/callobj/nf-callobj-icallinterceptor-getregisteredsink
     */
    GetRegisteredSink() {
        result := ComCall(8, this, "ptr*", &ppsink := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
