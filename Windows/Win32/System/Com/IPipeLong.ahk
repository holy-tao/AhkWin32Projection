 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ipipelong
...
class IPipeLong extends IUnknown{
    ...
    /**
     * The IPipeLong::Pull method (objidl.h) retrieves data of the long integer type from the pipe source.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipipelong-pull
     */
    ...
    /**
     * The IPipeLong::Push method (objidl.h) sends data of the long integer type to the pipe source.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipipelong-push
     */
    Push(buf, cSent) {
        bufMarshal := buf is VarRef ? "int*" : "ptr"
