 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-irpcproxybuffer
...
class IRpcProxyBuffer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irpcproxybuffer-connect
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irpcproxybuffer-disconnect
     */
    Disconnect() {
        ComCall(4, this)
    }
