 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nn-unknwn-iclassfactory
...
class IClassFactory extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nf-unknwn-iclassfactory-createinstance
     */
    CreateInstance(pUnkOuter, riid) {
        result := ComCall(3, this, "ptr", pUnkOuter, "ptr", riid, "ptr*", &ppvObject := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nf-unknwn-iclassfactory-lockserver
     */
    LockServer(fLock) {
