 ...
 */
export default struct IInternetSecurityMgrSite extends IUnknown {
    /**
     ...
     * used for IInternetSecurityMgrSite interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IInternetSecurityMgrSite.Vtbl()
        }
    ...
    Query(iid) {
        if (IInternetSecurityMgrSite.IID.Equals(iid)) {
            return true
        }
