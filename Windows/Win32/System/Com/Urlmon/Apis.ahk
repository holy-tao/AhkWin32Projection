...
;@region Methods
    ...
    static GetClassURL(szURL, pClsID) {
        ...
        result := DllCall("urlmon.dll\GetClassURL", "ptr", szURL, "ptr", pClsID, "HRESULT")
        return result
    }
    ...
    static MkParseDisplayNameEx(pbc, szDisplayName, pchEaten, ppmk) {
        ...
        result := DllCall("urlmon.dll\MkParseDisplayNameEx", "ptr", pbc, "ptr", szDisplayName, pchEatenMarshal, pchEaten, "ptr*", ppmk, "HRESULT")
        return result
    }
    ...
    static GetClassFileOrMime(pBC, szFilename, pBuffer, cbSize, szMime, dwReserved, pclsid) {
        ...
        result := DllCall("urlmon.dll\GetClassFileOrMime", "ptr", pBC, "ptr", szFilename, "ptr", pBuffer, "uint", cbSize, "ptr", szMime, "uint", dwReserved, "ptr", pclsid, "HRESULT")
        return result
    }
    ...
    static CoGetClassObjectFromURL(rCLASSID, szCODE, dwFileVersionMS, dwFileVersionLS, szTYPE, pBindCtx, dwClsContext, riid) {
        ...
        result := DllCall("urlmon.dll\CoGetClassObjectFromURL", "ptr", rCLASSID, "ptr", szCODE, "uint", dwFileVersionMS, "uint", dwFileVersionLS, "ptr", szTYPE, "ptr", pBindCtx, "uint", dwClsContext, "ptr", pvReserved, "ptr", riid, "ptr*", &ppv := 0, "HRESULT")
        return ppv
    }
    ...
    static GetComponentIDFromCLSSPEC(pClassspec) {
        result := DllCall("urlmon.dll\GetComponentIDFromCLSSPEC", "ptr", pClassspec, "ptr*", &ppszComponentID := 0, "HRESULT")
    ...
    static CreateFormatEnumerator(cfmtetc, rgfmtetc) {
        result := DllCall("urlmon.dll\CreateFormatEnumerator", "uint", cfmtetc, "ptr", rgfmtetc, "ptr*", &ppenumfmtetc := 0, "HRESULT")
    ...
    static RegisterMediaTypeClass(pBC, ctypes, rgszTypes, rgclsID, reserved) {
        ...
        result := DllCall("urlmon.dll\RegisterMediaTypeClass", "ptr", pBC, "uint", ctypes, rgszTypesMarshal, rgszTypes, "ptr", rgclsID, "uint", reserved, "HRESULT")
        return result
    }
    ...
    static FindMediaTypeClass(pBC, szType, pclsID, reserved) {
        ...
        result := DllCall("urlmon.dll\FindMediaTypeClass", "ptr", pBC, "ptr", szType, "ptr", pclsID, "uint", reserved, "HRESULT")
        return result
    }
    ...
    static FindMimeFromData(pBC, pwzUrl, pBuffer, cbSize, pwzMimeProposed, dwMimeFlags) {
        ...
        result := DllCall("urlmon.dll\FindMimeFromData", "ptr", pBC, "ptr", pwzUrl, "ptr", pBuffer, "uint", cbSize, "ptr", pwzMimeProposed, "uint", dwMimeFlags, "ptr*", &ppwzMimeOut := 0, "uint", dwReserved, "HRESULT")
        return ppwzMimeOut
    }
    ...
    static CompatFlagsFromClsid(pclsid, pdwCompatFlags, pdwMiscStatusFlags) {
        ...
        result := DllCall("urlmon.dll\CompatFlagsFromClsid", "ptr", pclsid, pdwCompatFlagsMarshal, pdwCompatFlags, pdwMiscStatusFlagsMarshal, pdwMiscStatusFlags, "HRESULT")
        return result
    }
    ...
    static CoInternetQueryInfo(pwzUrl, QueryOptions, dwQueryFlags, pvBuffer, cbBuffer, dwReserved) {
        ...
        result := DllCall("urlmon.dll\CoInternetQueryInfo", "ptr", pwzUrl, "int", QueryOptions, "uint", dwQueryFlags, "ptr", pvBuffer, "uint", cbBuffer, "uint*", &pcbBuffer := 0, "uint", dwReserved, "HRESULT")
        return pcbBuffer
    }
    ...
    static CoInternetSetFeatureEnabled(FeatureEntry, dwFlags, fEnable) {
        result := DllCall("urlmon.dll\CoInternetSetFeatureEnabled", "int", FeatureEntry, "uint", dwFlags, "int", fEnable, "HRESULT")
        return result
    }
    ...
    static CoInternetIsFeatureEnabled(FeatureEntry, dwFlags) {
        result := DllCall("urlmon.dll\CoInternetIsFeatureEnabled", "int", FeatureEntry, "uint", dwFlags, "HRESULT")
        return result
    }
    ...
    static CoInternetIsFeatureEnabledForUrl(FeatureEntry, dwFlags, szURL, pSecMgr) {
        ...
        result := DllCall("urlmon.dll\CoInternetIsFeatureEnabledForUrl", "int", FeatureEntry, "uint", dwFlags, "ptr", szURL, "ptr", pSecMgr, "HRESULT")
        return result
    }
    ...
    static CoInternetIsFeatureEnabledForIUri(FeatureEntry, dwFlags, pIUri, pSecMgr) {
        result := DllCall("urlmon.dll\CoInternetIsFeatureEnabledForIUri", "int", FeatureEntry, "uint", dwFlags, "ptr", pIUri, "ptr", pSecMgr, "HRESULT")
        return result
    }
    ...
    static CopyStgMedium(pcstgmedSrc, pstgmedDest) {
        result := DllCall("urlmon.dll\CopyStgMedium", "ptr", pcstgmedSrc, "ptr", pstgmedDest, "HRESULT")
        return result
    }
    ...
    static CopyBindInfo(pcbiSrc, pbiDest) {
        result := DllCall("urlmon.dll\CopyBindInfo", "ptr", pcbiSrc, "ptr", pbiDest, "HRESULT")
        return result
    }
    ...
    static GetSoftwareUpdateInfo(szDistUnit, psdi) {
        ...
        result := DllCall("urlmon.dll\GetSoftwareUpdateInfo", "ptr", szDistUnit, "ptr", psdi, "HRESULT")
        return result
    }
