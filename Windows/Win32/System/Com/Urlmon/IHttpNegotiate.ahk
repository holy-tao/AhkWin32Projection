...
class IHttpNegotiate extends IUnknown{
    ...
    BeginningTransaction(szURL, szHeaders, dwReserved, pszAdditionalHeaders) {
        ...
        result := ComCall(3, this, "ptr", szURL, "ptr", szHeaders, "uint", dwReserved, "ptr", pszAdditionalHeaders, "int")
        if(result != 0)
    ...
    OnResponse(dwResponseCode, szResponseHeaders, szRequestHeaders, pszAdditionalRequestHeaders) {
        ...
        result := ComCall(4, this, "uint", dwResponseCode, "ptr", szResponseHeaders, "ptr", szRequestHeaders, "ptr", pszAdditionalRequestHeaders, "int")
        if(result != 0)
            throw OSError(result)
