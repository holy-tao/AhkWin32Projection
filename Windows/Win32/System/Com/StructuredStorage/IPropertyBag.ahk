 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nn-oaidl-ipropertybag
...
class IPropertyBag extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ipropertybag-read
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ipropertybag-write
     */
