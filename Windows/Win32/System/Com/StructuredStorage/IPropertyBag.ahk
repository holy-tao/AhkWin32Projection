 ...
 */
export default struct IPropertyBag extends IUnknown {
    /**
     ...
     * used for IPropertyBag interfaces
    */
    ...
    Read(pszPropName, pVar, pErrorLog) {
        ...
        result := ComCall(3, this, "ptr", pszPropName, VARIANT.Ptr, pVar, "ptr", pErrorLog, "HRESULT")
        return result
    }
    ...
    Write(pszPropName, pVar) {
        ...
        result := ComCall(4, this, "ptr", pszPropName, VARIANT.Ptr, pVar, "HRESULT")
        return result
    }

    Query(iid) {
        if (IPropertyBag.IID.Equals(iid)) {
            return true
        }
