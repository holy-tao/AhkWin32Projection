 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nn-propidl-ipropertystorage
...
class IPropertyStorage extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-readmultiple
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-writemultiple
     */
     ...
     * @returns {HRESULT} This method supports the standard return value E_UNEXPECTED, in addition to the following:
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-deletemultiple
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-readpropertynames
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-writepropertynames
     */
     ...
     * @returns {HRESULT} This method supports the standard return value E_UNEXPECTED, in addition to the following:
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-deletepropertynames
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-commit
     */
     ...
     * @returns {HRESULT} This method supports the standard return value E_UNEXPECTED, in addition to the following:
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-revert
     */
    Revert() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-enum
     */
    Enum() {
     ...
     * @returns {HRESULT} This method supports the standard return value E_UNEXPECTED, in addition to the following:
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-settimes
     */
     ...
     * @returns {HRESULT} This method supports the standard return value E_UNEXPECTED, in addition to the following:
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-setclass
     */
    SetClass(clsid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/propidl/nf-propidl-ipropertystorage-stat
     */
    Stat() {
