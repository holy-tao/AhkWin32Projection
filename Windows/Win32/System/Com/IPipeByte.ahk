 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ipipebyte
...
class IPipeByte extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipipebyte-pull
     */
    ...
    /**
     * The IPipeByte::Push method (objidl.h) sends data of the byte type to the pipe source.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipipebyte-push
     */
    Push(buf, cSent) {
        bufMarshal := buf is VarRef ? "char*" : "ptr"
