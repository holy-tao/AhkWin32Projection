 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-iexternalconnection
...
class IExternalConnection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iexternalconnection-addconnection
     */
    AddConnection(extconn_, reserved) {
        result := ComCall(3, this, "uint", extconn_, "uint", reserved, "uint")
        return result
    }

    /**
     * The IExternalConnection::ReleaseConnection method (objidl.h) decrements the count of an object's strong external connections.
     * @remarks
     ...
     * @returns {Integer} The method returns the count of connections. This value is intended to be used only for debugging purposes.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iexternalconnection-releaseconnection
     */
    ReleaseConnection(extconn_, reserved, fLastReleaseCloses) {
        result := ComCall(4, this, "uint", extconn_, "uint", reserved, "int", fLastReleaseCloses, "uint")
        return result
    }
}
