...
class IMarshal extends IUnknown{
    ...
    /**
     * The IMarshal::UnmarshalInterface (objidlbase.h) method unmarshals an interface pointer.
     * @remarks
    ...
    /**
     * The IMarshal::ReleaseMarshalData (objidlbase.h) method destroys a marshaled data packet.
     * @remarks
    ...
    /**
     * The IMarshal::DisconnectObject (objidlbase.h) method releases all connections to an object whose server calls the object's implementation of this method.
     * @remarks
