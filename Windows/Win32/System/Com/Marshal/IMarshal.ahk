 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//objidl/nn-objidl-imarshal
...
class IMarshal extends IUnknown{
    ...
    GetUnmarshalClass(riid, pv, dwDestContext, mshlflags, pCid) {
        ...
        result := ComCall(3, this, "ptr", riid, "ptr", pv, "uint", dwDestContext, "ptr", pvDestContext, "uint", mshlflags, "ptr", pCid, "int")
        if(result != 0)
    ...
    GetMarshalSizeMax(riid, pv, dwDestContext, mshlflags, pSize) {
        ...
        result := ComCall(4, this, "ptr", riid, "ptr", pv, "uint", dwDestContext, "ptr", pvDestContext, "uint", mshlflags, "uint*", pSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    MarshalInterface(pStm, riid, pv, dwDestContext, mshlflags) {
        ...
        result := ComCall(5, this, "ptr", pStm, "ptr", riid, "ptr", pv, "uint", dwDestContext, "ptr", pvDestContext, "uint", mshlflags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    UnmarshalInterface(pStm, riid, ppv) {
        result := ComCall(6, this, "ptr", pStm, "ptr", riid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
