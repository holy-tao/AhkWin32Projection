 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ctxtcall/nn-ctxtcall-icontextcallback
...
class IContextCallback extends IUnknown{
     ...
     * @param {Pointer<PFNCONTEXTCALL>} pfnCallback_ The function to be called inside the object context.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ctxtcall/nf-ctxtcall-icontextcallback-contextcallback
     */
    ContextCallback(pfnCallback_, pParam, riid, iMethod, pUnk) {
        result := ComCall(3, this, "ptr", pfnCallback_, "ptr", pParam, "ptr", riid, "int", iMethod, "ptr", pUnk, "int")
        if(result != 0) {
