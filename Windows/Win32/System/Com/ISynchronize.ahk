 ...
 */
export default struct ISynchronize extends IUnknown {
    /**
     ...
     * used for ISynchronize interfaces
    */
    ...
    Wait(dwFlags, dwMilliseconds) {
        result := ComCall(3, this, UInt32, dwFlags, UInt32, dwMilliseconds, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.Signal := CallbackCreate(ObjBindMethod(implObj, "Signal"), flags, 1)
