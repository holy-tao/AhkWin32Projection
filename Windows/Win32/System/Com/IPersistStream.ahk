 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ipersiststream
...
class IPersistStream extends IPersist{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersiststream-isdirty
     */
    IsDirty() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersiststream-load
     */
    Load(pStm) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersiststream-save
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersiststream-getsizemax
     */
    GetSizeMax() {
