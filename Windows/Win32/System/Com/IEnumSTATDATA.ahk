...
#Import ".\STATDATA.ahk" { STATDATA }

/**
 * Enumerates the advisory connection information for a data object.
 * @see https://learn.microsoft.com/windows/win32/api/objidl/nn-objidl-ienumstatdata
 * @namespace Windows.Win32.System.Com
 */
export default struct IEnumSTATDATA extends IUnknown {
    /**
     * The interface identifier for IEnumSTATDATA
     * @type {Guid}
     */
    static IID := Guid("{00000105-0000-0000-c000-000000000046}")
     ...
     * used for IEnumSTATDATA interfaces
    */
     ...
     * @param {Pointer<STATDATA>} rgelt An array of enumerated items.
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api/objidl/nf-objidl-ienumstatdata-next
     */
    Next(celt, rgelt, pceltFetched) {
        pceltFetchedMarshal := pceltFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, UInt32, celt, STATDATA.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api/objidl/nf-objidl-ienumstatdata-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api/objidl/nf-objidl-ienumstatdata-reset
     */
    Reset() {
     ...
     * @returns {IEnumSTATDATA} A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-ienumstatdata">IEnumSTATDATA</a> pointer variable that receives the interface pointer to the enumeration object. If the method is unsuccessful, the value of this output variable is undefined.
     * @see https://learn.microsoft.com/windows/win32/api/objidl/nf-objidl-ienumstatdata-clone
     */
    Clone() {
        result := ComCall(6, this, "ptr*", &ppenum := 0, "HRESULT")
        return IEnumSTATDATA(ppenum)
    }

    Query(iid) {
        if (IEnumSTATDATA.IID.Equals(iid)) {
            return true
        }
