 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ienumstatdata
...
class IEnumSTATDATA extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstatdata-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstatdata-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstatdata-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstatdata-clone
     */
    Clone() {
