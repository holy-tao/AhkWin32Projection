 ...
 * @see https://docs.microsoft.com/windows/win32/api//objidl/nn-objidl-ienumstatdata
...
class IEnumSTATDATA extends IUnknown{
     ...
     * @see https://docs.microsoft.com/windows/win32/api//objidl/nf-objidl-ienumstatdata-next
     */
     ...
     * @see https://docs.microsoft.com/windows/win32/api//objidl/nf-objidl-ienumstatdata-skip
     */
    Skip(celt) {
     ...
     * @see https://docs.microsoft.com/windows/win32/api//objidl/nf-objidl-ienumstatdata-reset
     */
    Reset() {
     ...
     * @see https://docs.microsoft.com/windows/win32/api//objidl/nf-objidl-ienumstatdata-clone
     */
    Clone() {
