 ...
 */
export default struct IMalloc extends IUnknown {
    /**
    ...
    */
    ...
    /**
     * The IMalloc::Realloc (objidlbase.h) method changes the size of a previously allocated block of memory.
     * @remarks
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.Realloc)
        CallbackFree(this.vtbl.Free)
        CallbackFree(this.vtbl.GetSize)
        CallbackFree(this.vtbl.DidAlloc)
        CallbackFree(this.vtbl.HeapMinimize)
    }
}
