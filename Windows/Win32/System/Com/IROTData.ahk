 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-irotdata
...
class IROTData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-irotdata-getcomparisondata
     */
    GetComparisonData(pbData, cbMax, pcbData) {
        pbDataMarshal := pbData is VarRef ? "char*" : "ptr"
        pcbDataMarshal := pcbData is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, pbDataMarshal, pbData, "uint", cbMax, pcbDataMarshal, pcbData, "int")
        if(result != 0) {
