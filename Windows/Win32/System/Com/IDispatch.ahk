 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nn-oaidl-idispatch
...
class IDispatch extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-idispatch-gettypeinfocount
     */
    GetTypeInfoCount() {
        result := ComCall(3, this, "uint*", &pctinfo := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-idispatch-gettypeinfo
     */
    GetTypeInfo(iTInfo, lcid) {
        result := ComCall(4, this, "uint", iTInfo, "uint", lcid, "ptr*", &ppTInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-idispatch-getidsofnames
     */
    GetIDsOfNames(riid, rgszNames, cNames, lcid) {
        rgszNamesMarshal := rgszNames is VarRef ? "ptr*" : "ptr"

        result := ComCall(5, this, "ptr", riid, rgszNamesMarshal, rgszNames, "uint", cNames, "uint", lcid, "int*", &rgDispId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-idispatch-invoke
     */
    Invoke(dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr) {
        puArgErrMarshal := puArgErr is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, "int", dispIdMember, "ptr", riid, "uint", lcid, "ushort", wFlags, "ptr", pDispParams, "ptr", pVarResult, "ptr", pExcepInfo, puArgErrMarshal, puArgErr, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
