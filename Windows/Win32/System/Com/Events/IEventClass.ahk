...
export default struct IEventClass extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_EventClassName := CallbackCreate(ObjBindMethod(implObj, "get_EventClassName"), flags, 2)
        this.vtbl.put_EventClassName := CallbackCreate(ObjBindMethod(implObj, "put_EventClassName"), flags, 2)
        ...
        this.vtbl.get_FiringInterfaceID := CallbackCreate(ObjBindMethod(implObj, "get_FiringInterfaceID"), flags, 2)
        this.vtbl.put_FiringInterfaceID := CallbackCreate(ObjBindMethod(implObj, "put_FiringInterfaceID"), flags, 2)
        ...
        this.vtbl.get_CustomConfigCLSID := CallbackCreate(ObjBindMethod(implObj, "get_CustomConfigCLSID"), flags, 2)
        this.vtbl.put_CustomConfigCLSID := CallbackCreate(ObjBindMethod(implObj, "put_CustomConfigCLSID"), flags, 2)
        this.vtbl.get_TypeLib := CallbackCreate(ObjBindMethod(implObj, "get_TypeLib"), flags, 2)
        this.vtbl.put_TypeLib := CallbackCreate(ObjBindMethod(implObj, "put_TypeLib"), flags, 2)
    }
