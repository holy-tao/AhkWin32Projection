 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nn-eventsys-ieventcontrol
...
class IEventControl extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ieventcontrol-setpublisherfilter
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ieventcontrol-get_allowinprocactivation
     */
    get_AllowInprocActivation() {
        result := ComCall(8, this, "int*", &pfAllowInprocActivation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ieventcontrol-put_allowinprocactivation
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ieventcontrol-getsubscriptions
     */
    GetSubscriptions(methodName, optionalCriteria, optionalErrorIndex) {
        ...
        result := ComCall(10, this, "ptr", methodName, "ptr", optionalCriteria, optionalErrorIndexMarshal, optionalErrorIndex, "ptr*", &ppCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ieventcontrol-setdefaultquery
     */
    SetDefaultQuery(methodName, criteria) {
        ...
        result := ComCall(11, this, "ptr", methodName, "ptr", criteria, "int*", &errorIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
