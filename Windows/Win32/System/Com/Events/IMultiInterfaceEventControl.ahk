 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nn-eventsys-imultiinterfaceeventcontrol
...
class IMultiInterfaceEventControl extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-setmultiinterfacepublisherfilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-getsubscriptions
     */
    GetSubscriptions(eventIID, bstrMethodName, optionalCriteria, optionalErrorIndex) {
        ...
        if(optionalCriteria is String) {
            pin := BSTR.Alloc(optionalCriteria)
            optionalCriteria := pin.Value
        }

        optionalErrorIndexMarshal := optionalErrorIndex is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", eventIID, "ptr", bstrMethodName, "ptr", optionalCriteria, optionalErrorIndexMarshal, optionalErrorIndex, "ptr*", &ppCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-setdefaultquery
     */
    SetDefaultQuery(eventIID, bstrMethodName, bstrCriteria) {
        ...
        if(bstrCriteria is String) {
            pin := BSTR.Alloc(bstrCriteria)
            bstrCriteria := pin.Value
        }

        result := ComCall(5, this, "ptr", eventIID, "ptr", bstrMethodName, "ptr", bstrCriteria, "int*", &errorIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-get_allowinprocactivation
     */
    get_AllowInprocActivation() {
        result := ComCall(6, this, "int*", &pfAllowInprocActivation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-put_allowinprocactivation
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-get_fireinparallel
     */
    get_FireInParallel() {
        result := ComCall(8, this, "int*", &pfFireInParallel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-imultiinterfaceeventcontrol-put_fireinparallel
     */
