 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nn-eventsys-ienumeventobject
...
class IEnumEventObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ienumeventobject-clone
     */
    Clone() {
        result := ComCall(3, this, "ptr*", &ppInterface := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ienumeventobject-next
     */
    Next(cReqElem, ppInterface, cRetElem) {
        cRetElemMarshal := cRetElem is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, "uint", cReqElem, "ptr*", ppInterface, cRetElemMarshal, cRetElem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ienumeventobject-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/eventsys/nf-eventsys-ienumeventobject-skip
     */
    Skip(cSkipElem) {
