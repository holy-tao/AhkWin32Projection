...
export default struct IEventSubscription extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_SubscriptionID := CallbackCreate(ObjBindMethod(implObj, "get_SubscriptionID"), flags, 2)
        this.vtbl.put_SubscriptionID := CallbackCreate(ObjBindMethod(implObj, "put_SubscriptionID"), flags, 2)
        this.vtbl.get_SubscriptionName := CallbackCreate(ObjBindMethod(implObj, "get_SubscriptionName"), flags, 2)
        this.vtbl.put_SubscriptionName := CallbackCreate(ObjBindMethod(implObj, "put_SubscriptionName"), flags, 2)
        ...
        this.vtbl.get_EventClassID := CallbackCreate(ObjBindMethod(implObj, "get_EventClassID"), flags, 2)
        this.vtbl.put_EventClassID := CallbackCreate(ObjBindMethod(implObj, "put_EventClassID"), flags, 2)
        this.vtbl.get_MethodName := CallbackCreate(ObjBindMethod(implObj, "get_MethodName"), flags, 2)
        this.vtbl.put_MethodName := CallbackCreate(ObjBindMethod(implObj, "put_MethodName"), flags, 2)
        this.vtbl.get_SubscriberCLSID := CallbackCreate(ObjBindMethod(implObj, "get_SubscriberCLSID"), flags, 2)
        this.vtbl.put_SubscriberCLSID := CallbackCreate(ObjBindMethod(implObj, "put_SubscriberCLSID"), flags, 2)
        this.vtbl.get_SubscriberInterface := CallbackCreate(ObjBindMethod(implObj, "get_SubscriberInterface"), flags, 2)
        this.vtbl.put_SubscriberInterface := CallbackCreate(ObjBindMethod(implObj, "put_SubscriberInterface"), flags, 2)
        this.vtbl.get_PerUser := CallbackCreate(ObjBindMethod(implObj, "get_PerUser"), flags, 2)
        this.vtbl.put_PerUser := CallbackCreate(ObjBindMethod(implObj, "put_PerUser"), flags, 2)
        ...
        this.vtbl.get_MachineName := CallbackCreate(ObjBindMethod(implObj, "get_MachineName"), flags, 2)
        this.vtbl.put_MachineName := CallbackCreate(ObjBindMethod(implObj, "put_MachineName"), flags, 2)
        this.vtbl.GetPublisherProperty := CallbackCreate(ObjBindMethod(implObj, "GetPublisherProperty"), flags, 3)
        this.vtbl.PutPublisherProperty := CallbackCreate(ObjBindMethod(implObj, "PutPublisherProperty"), flags, 3)
        this.vtbl.RemovePublisherProperty := CallbackCreate(ObjBindMethod(implObj, "RemovePublisherProperty"), flags, 2)
        this.vtbl.GetPublisherPropertyCollection := CallbackCreate(ObjBindMethod(implObj, "GetPublisherPropertyCollection"), flags, 2)
        this.vtbl.GetSubscriberProperty := CallbackCreate(ObjBindMethod(implObj, "GetSubscriberProperty"), flags, 3)
        this.vtbl.PutSubscriberProperty := CallbackCreate(ObjBindMethod(implObj, "PutSubscriberProperty"), flags, 3)
        this.vtbl.RemoveSubscriberProperty := CallbackCreate(ObjBindMethod(implObj, "RemoveSubscriberProperty"), flags, 2)
        this.vtbl.GetSubscriberPropertyCollection := CallbackCreate(ObjBindMethod(implObj, "GetSubscriberPropertyCollection"), flags, 2)
        this.vtbl.get_InterfaceID := CallbackCreate(ObjBindMethod(implObj, "get_InterfaceID"), flags, 2)
        this.vtbl.put_InterfaceID := CallbackCreate(ObjBindMethod(implObj, "put_InterfaceID"), flags, 2)
    }
