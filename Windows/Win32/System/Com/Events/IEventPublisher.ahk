...
class IEventPublisher extends IDispatch{
    ...
    GetDefaultProperty(bstrPropertyName, propertyValue) {
        ...
        result := ComCall(17, this, "ptr", bstrPropertyName, "ptr", propertyValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PutDefaultProperty(bstrPropertyName, propertyValue) {
        ...
        result := ComCall(18, this, "ptr", bstrPropertyName, "ptr", propertyValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetDefaultPropertyCollection(collection) {
        result := ComCall(20, this, "ptr", collection, "int")
        if(result != 0)
            throw OSError(result)
