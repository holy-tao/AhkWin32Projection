 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-iserversecurity
...
class IServerSecurity extends IUnknown{
    ...
    /**
     * The IServerSecurity::QueryBlanket method (objidl.h) retrieves information about the client that invoked one of the server's methods.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iserversecurity-queryblanket
     */
    QueryBlanket(pAuthnSvc, pAuthzSvc, pServerPrincName, pAuthnLevel, pImpLevel, pPrivs, pCapabilities) {
        ...
        result := ComCall(3, this, pAuthnSvcMarshal, pAuthnSvc, pAuthzSvcMarshal, pAuthzSvc, pServerPrincNameMarshal, pServerPrincName, pAuthnLevelMarshal, pAuthnLevel, pImpLevelMarshal, pImpLevel, pPrivsMarshal, pPrivs, pCapabilitiesMarshal, pCapabilities, "int")
        if(result != 0) {
    ...
    /**
     * The IServerSecurity::ImpersonateClient method (objidl.h) enables a server to impersonate a client for the duration of a call.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iserversecurity-impersonateclient
     */
    ImpersonateClient() {
    ...
    /**
     * The IServerSecurity::RevertToSelf method (objidl.h) restores the authentication information of a thread to what it was before impersonation began.
     * @remarks
     ...
     * @returns {HRESULT} If the method succeeds, the return value is S_OK. Otherwise, it is E_FAIL.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iserversecurity-reverttoself
     */
    RevertToSelf() {
    ...
    /**
     * The IServerSecurity::IsImpersonating method (objidl.h) indicates whether the server is currently impersonating the client.
     * @returns {BOOL} If the thread is currently impersonating, the return value is <b>TRUE</b>. Otherwise, it is <b>FALSE</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iserversecurity-isimpersonating
     */
    IsImpersonating() {
