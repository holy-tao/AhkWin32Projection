 ...
 */
export default struct IEnumFORMATETC extends IUnknown {
    /**
     ...
     * used for IEnumFORMATETC interfaces
    */
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, FORMATETC.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, Int32)
        return result
    }
