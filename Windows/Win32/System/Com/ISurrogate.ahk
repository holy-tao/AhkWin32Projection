 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-isurrogate
...
class ISurrogate extends IUnknown{
    ...
    /**
     * The ISurrogate::LoadDllServer method (objidl.h) loads a DLL server into the implementing surrogate.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-isurrogate-loaddllserver
     */
    LoadDllServer(Clsid) {
    ...
    /**
     * The ISurrogate::FreeSurrogate method (objidl.h) unloads a DLL server.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-isurrogate-freesurrogate
     */
    FreeSurrogate() {
