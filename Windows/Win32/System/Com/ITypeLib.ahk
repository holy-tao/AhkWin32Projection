 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nn-oaidl-itypelib
...
class ITypeLib extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-gettypeinfocount
     */
    GetTypeInfoCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-gettypeinfo
     */
    GetTypeInfo(index) {
        result := ComCall(4, this, "uint", index, "ptr*", &ppTInfo := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-gettypeinfotype
     */
    GetTypeInfoType(index) {
        result := ComCall(5, this, "uint", index, "int*", &pTKind := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-gettypeinfoofguid
     */
    GetTypeInfoOfGuid(guid) {
        result := ComCall(6, this, "ptr", guid, "ptr*", &ppTinfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-getlibattr
     */
    GetLibAttr() {
        result := ComCall(7, this, "ptr*", &ppTLibAttr := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-gettypecomp
     */
    GetTypeComp() {
        result := ComCall(8, this, "ptr*", &ppTComp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-getdocumentation
     */
    GetDocumentation(index, pBstrName, pBstrDocString, pdwHelpContext, pBstrHelpFile) {
        ...
        result := ComCall(9, this, "int", index, "ptr", pBstrName, "ptr", pBstrDocString, pdwHelpContextMarshal, pdwHelpContext, "ptr", pBstrHelpFile, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-isname
     */
    IsName(szNameBuf, lHashVal) {
        szNameBuf := szNameBuf is String ? StrPtr(szNameBuf) : szNameBuf

        result := ComCall(10, this, "ptr", szNameBuf, "uint", lHashVal, "int*", &pfName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-findname
     */
    FindName(szNameBuf, lHashVal, ppTInfo, rgMemId, pcFound) {
        ...
        result := ComCall(11, this, "ptr", szNameBuf, "uint", lHashVal, "ptr*", ppTInfo, rgMemIdMarshal, rgMemId, pcFoundMarshal, pcFound, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-itypelib-releasetlibattr
     */
