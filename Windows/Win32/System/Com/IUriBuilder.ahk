...
class IUriBuilder extends IUnknown{
    ...
    CreateUriSimple(dwAllowEncodingPropertyMask, dwReserved) {
        result := ComCall(3, this, "uint", dwAllowEncodingPropertyMask, "ptr", dwReserved, "ptr*", &ppIUri := 0, "int")
        if(result != 0) {
    ...
    CreateUri(dwCreateFlags, dwAllowEncodingPropertyMask, dwReserved) {
        result := ComCall(4, this, "uint", dwCreateFlags, "uint", dwAllowEncodingPropertyMask, "ptr", dwReserved, "ptr*", &ppIUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    CreateUriWithFlags(dwCreateFlags, dwUriBuilderFlags, dwAllowEncodingPropertyMask, dwReserved) {
        result := ComCall(5, this, "uint", dwCreateFlags, "uint", dwUriBuilderFlags, "uint", dwAllowEncodingPropertyMask, "ptr", dwReserved, "ptr*", &ppIUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetIUri() {
        result := ComCall(6, this, "ptr*", &ppIUri := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetFragment(pcchFragment, ppwzFragment) {
        ...
        result := ComCall(8, this, pcchFragmentMarshal, pcchFragment, ppwzFragmentMarshal, ppwzFragment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/winsock2/nf-winsock2-gethostnamew
     */
    GetHost(pcchHost, ppwzHost) {
        pcchHostMarshal := pcchHost is VarRef ? "uint*" : "ptr"
        ppwzHostMarshal := ppwzHost is VarRef ? "ptr*" : "ptr"

        result := ComCall(9, this, pcchHostMarshal, pcchHost, ppwzHostMarshal, ppwzHost, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetPassword(pcchPassword, ppwzPassword) {
        ...
        result := ComCall(10, this, pcchPasswordMarshal, pcchPassword, ppwzPasswordMarshal, ppwzPassword, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wingdi/nf-wingdi-getpath
     */
    GetPath(pcchPath, ppwzPath) {
        pcchPathMarshal := pcchPath is VarRef ? "uint*" : "ptr"
        ppwzPathMarshal := ppwzPath is VarRef ? "ptr*" : "ptr"

        result := ComCall(11, this, pcchPathMarshal, pcchPath, ppwzPathMarshal, ppwzPath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetPort(pfHasPort, pdwPort) {
        ...
        result := ComCall(12, this, pfHasPortMarshal, pfHasPort, pdwPortMarshal, pdwPort, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetQuery(pcchQuery, ppwzQuery) {
        ...
        result := ComCall(13, this, pcchQueryMarshal, pcchQuery, ppwzQueryMarshal, ppwzQuery, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetSchemeName(pcchSchemeName, ppwzSchemeName) {
        ...
        result := ComCall(14, this, pcchSchemeNameMarshal, pcchSchemeName, ppwzSchemeNameMarshal, ppwzSchemeName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetUserName(pcchUserName, ppwzUserName) {
        ...
        result := ComCall(15, this, pcchUserNameMarshal, pcchUserName, ppwzUserNameMarshal, ppwzUserName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    HasBeenModified() {
        result := ComCall(25, this, "int*", &pfModified := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
