 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ibindctx
...
class IBindCtx extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-registerobjectbound
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-revokeobjectbound
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-releaseboundobjects
     */
    ReleaseBoundObjects() {
     ...
     * @returns {HRESULT} This method can return the standard return values E_OUTOFMEMORY and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-setbindoptions
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-getbindoptions
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-getrunningobjecttable
     */
    GetRunningObjectTable() {
        result := ComCall(8, this, "ptr*", &pprot := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_OUTOFMEMORY and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-registerobjectparam
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-getobjectparam
     */
    GetObjectParam(pszKey) {
        pszKey := pszKey is String ? StrPtr(pszKey) : pszKey

        result := ComCall(10, this, "ptr", pszKey, "ptr*", &ppunk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-enumobjectparam
     */
    EnumObjectParam() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ibindctx-revokeobjectparam
     */
