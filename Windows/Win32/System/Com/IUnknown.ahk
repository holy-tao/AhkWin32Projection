 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nn-unknwn-iunknown
...
class IUnknown extends Win32ComInterface{
     ...
     * @param {Pointer<Pointer<Pointer<Void>>>} ppvObject Type: **[void](/windows/desktop/winprog/windows-data-types)\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nf-unknwn-iunknown-queryinterface(refiid_void)
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nf-unknwn-iunknown-addref
     */
    AddRef() {
     ...
     * @returns {Integer} The method returns the new reference count. This value is intended to be used only for test purposes.
     * @see https://learn.microsoft.com/windows/win32/api//content/unknwn/nf-unknwn-iunknown-release
     */
    Release() {
