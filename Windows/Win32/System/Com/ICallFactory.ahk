 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-icallfactory
...
class ICallFactory extends IUnknown{
    ...
    /**
     * The ICallFactory::CreateCall method (objidl.h) creates an instance of the call object that corresponds to a specified asynchronous interface.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-icallfactory-createcall
     */
    CreateCall(riid, pCtrlUnk, riid2) {
        result := ComCall(3, this, "ptr", riid, "ptr", pCtrlUnk, "ptr", riid2, "ptr*", &ppv := 0, "int")
        if(result != 0) {
