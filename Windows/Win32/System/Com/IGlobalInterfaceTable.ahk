 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-iglobalinterfacetable
...
class IGlobalInterfaceTable extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iglobalinterfacetable-registerinterfaceinglobal
     */
    RegisterInterfaceInGlobal(pUnk, riid) {
        result := ComCall(3, this, "ptr", pUnk, "ptr", riid, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iglobalinterfacetable-revokeinterfacefromglobal
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-iglobalinterfacetable-getinterfacefromglobal
     */
    GetInterfaceFromGlobal(dwCookie, riid) {
        result := ComCall(5, this, "uint", dwCookie, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
