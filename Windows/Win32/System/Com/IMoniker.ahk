...
class IMoniker extends IPersistStream{
     ...
     * @param {Pointer<IMoniker>} pmkToLeft 
     * @param {Pointer<Guid>} riidResult 
     * @param {Pointer<Void>} ppvResult 
     * @returns {HRESULT} 
     */
    BindToObject(pbc, pmkToLeft, riidResult, ppvResult) {
        result := ComCall(8, this, "ptr", pbc, "ptr", pmkToLeft, "ptr", riidResult, "ptr", ppvResult, "int")
        if(result != 0)
    ...
    BindToStorage(pbc, pmkToLeft, riid, ppvObj) {
        result := ComCall(9, this, "ptr", pbc, "ptr", pmkToLeft, "ptr", riid, "ptr", ppvObj, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Reduce(pbc, dwReduceHowFar, ppmkToLeft, ppmkReduced) {
        result := ComCall(10, this, "ptr", pbc, "uint", dwReduceHowFar, "ptr", ppmkToLeft, "ptr", ppmkReduced, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Enum(fForward, ppenumMoniker) {
        result := ComCall(12, this, "int", fForward, "ptr", ppenumMoniker, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMoniker>} pmkOtherMoniker 
     * @returns {HRESULT} 
     */
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pdwHash 
     * @returns {HRESULT} 
     */
    Hash(pdwHash) {
        result := ComCall(14, this, "uint*", pdwHash, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<IBindCtx>} pbc 
     * @param {Pointer<IMoniker>} pmkToLeft 
     * @param {Pointer<IMoniker>} pmkNewlyRunning 
     * @returns {HRESULT} 
     */
     ...
     */
    Inverse(ppmk) {
        result := ComCall(17, this, "ptr", ppmk, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMoniker>} pmkOther 
     * @param {Pointer<IMoniker>} ppmkPrefix 
     * @returns {HRESULT} 
     */
    CommonPrefixWith(pmkOther, ppmkPrefix) {
        result := ComCall(18, this, "ptr", pmkOther, "ptr", ppmkPrefix, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RelativePathTo(pmkOther, ppmkRelPath) {
        result := ComCall(19, this, "ptr", pmkOther, "ptr", ppmkRelPath, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetDisplayName(pbc, pmkToLeft, ppszDisplayName) {
        result := ComCall(20, this, "ptr", pbc, "ptr", pmkToLeft, "ptr", ppszDisplayName, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ParseDisplayName(pbc, pmkToLeft, pszDisplayName, pchEaten, ppmkOut) {
        ...
        result := ComCall(21, this, "ptr", pbc, "ptr", pmkToLeft, "ptr", pszDisplayName, "uint*", pchEaten, "ptr", ppmkOut, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pdwMksys 
     * @returns {HRESULT} 
     */
    IsSystemMoniker(pdwMksys) {
        result := ComCall(22, this, "uint*", pdwMksys, "int")
        if(result != 0)
            throw OSError(result)
