 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ienummoniker
...
class IEnumMoniker extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienummoniker-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienummoniker-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienummoniker-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienummoniker-clone
     */
    Clone() {
