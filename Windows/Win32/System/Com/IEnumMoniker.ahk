 ...
 */
export default struct IEnumMoniker extends IUnknown {
    /**
     ...
     * used for IEnumMoniker interfaces
    */
    ...
    Next(celt, rgelt, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IMoniker.Ptr, rgelt, pceltFetchedMarshal, pceltFetched, Int32)
        return result
    }
    ...
    Query(iid) {
        if (IEnumMoniker.IID.Equals(iid)) {
            return true
        }
