 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nn-comcat-ienumcategoryinfo
...
class IEnumCATEGORYINFO extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumcategoryinfo-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumcategoryinfo-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumcategoryinfo-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comcat/nf-comcat-ienumcategoryinfo-clone
     */
    Clone() {
