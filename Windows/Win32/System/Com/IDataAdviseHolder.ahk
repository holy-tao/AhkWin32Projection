 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-idataadviseholder
...
class IDataAdviseHolder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-idataadviseholder-advise
     */
    Advise(pDataObject, pFetc, advf_, pAdvise) {
        result := ComCall(3, this, "ptr", pDataObject, "ptr", pFetc, "uint", advf_, "ptr", pAdvise, "uint*", &pdwConnection := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-idataadviseholder-unadvise
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-idataadviseholder-enumadvise
     */
    EnumAdvise() {
