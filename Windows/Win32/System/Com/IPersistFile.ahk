 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ipersistfile
...
class IPersistFile extends IPersist{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersistfile-isdirty
     */
    IsDirty() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersistfile-load
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersistfile-save
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersistfile-savecompleted
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ipersistfile-getcurfile
     */
    GetCurFile() {
        result := ComCall(8, this, "ptr*", &ppszFileName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
