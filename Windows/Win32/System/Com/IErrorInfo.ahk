 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nn-oaidl-ierrorinfo
...
class IErrorInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ierrorinfo-getguid
     */
    GetGUID() {
        pGUID := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ierrorinfo-getsource
     */
    GetSource() {
        pBstrSource := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ierrorinfo-getdescription
     */
    GetDescription() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ierrorinfo-gethelpfile
     */
    GetHelpFile() {
        pBstrHelpFile := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/oaidl/nf-oaidl-ierrorinfo-gethelpcontext
     */
    GetHelpContext() {
        result := ComCall(7, this, "uint*", &pdwHelpContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
