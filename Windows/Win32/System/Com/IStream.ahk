 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-istream
...
class IStream extends ISequentialStream{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-seek
     */
    Seek(dlibMove, dwOrigin) {
        result := ComCall(5, this, "int64", dlibMove, "uint", dwOrigin, "uint*", &plibNewPosition := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-setsize
     */
    SetSize(libNewSize) {
     ...
     * |STG_E_REVERTED | The object has been invalidated by a revert operation above it in the transaction tree.|
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-copyto
     */
    CopyTo(pstm, cb, pcbRead, pcbWritten) {
        ...
        result := ComCall(7, this, "ptr", pstm, "uint", cb, pcbReadMarshal, pcbRead, pcbWrittenMarshal, pcbWritten, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |STG_E_REVERTED | The object has been invalidated by a revert operation above it in the transaction tree.|
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-commit
     */
     ...
     * |E_PENDING | Asynchronous Storage only: Part or all of the stream's data is currently unavailable. |
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-revert
     */
    Revert() {
     ...
     * |STG_E_REVERTED | The object has been invalidated by a revert operation above it in the transaction tree.|
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-lockregion
     */
     ...
     * |STG_E_REVERTED | The object has been invalidated by a revert operation above it in the transaction tree.|
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-unlockregion
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-stat
     */
    Stat(grfStatFlag) {
        pstatstg := STATSTG()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-istream-clone
     */
    Clone() {
        result := ComCall(13, this, "ptr*", &ppstm := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
