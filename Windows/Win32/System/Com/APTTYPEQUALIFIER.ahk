...
class APTTYPEQUALIFIER extends Win32Enum {
     ...
     * Native name: APTTYPEQUALIFIER_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: APTTYPEQUALIFIER_IMPLICIT_MTA
     * @type {Integer (Int32)}
     */
    static IMPLICIT_MTA => 1
     ...
     * Native name: APTTYPEQUALIFIER_NA_ON_MTA
     * @type {Integer (Int32)}
     */
    static NA_ON_MTA => 2
     ...
     * Native name: APTTYPEQUALIFIER_NA_ON_STA
     * @type {Integer (Int32)}
     */
    static NA_ON_STA => 3
     ...
     * Native name: APTTYPEQUALIFIER_NA_ON_IMPLICIT_MTA
     * @type {Integer (Int32)}
     */
    static NA_ON_IMPLICIT_MTA => 4
     ...
     * Native name: APTTYPEQUALIFIER_NA_ON_MAINSTA
     * @type {Integer (Int32)}
     */
    static NA_ON_MAINSTA => 5

    /**
     * Native name: APTTYPEQUALIFIER_APPLICATION_STA
     * @type {Integer (Int32)}
     */
    static APPLICATION_STA => 6

    /**
     * Native name: APTTYPEQUALIFIER_RESERVED_1
     * @type {Integer (Int32)}
     */
    static RESERVED_1 => 7
}
