 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nn-ocidl-iconnectionpointcontainer
...
class IConnectionPointContainer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iconnectionpointcontainer-enumconnectionpoints
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ocidl/nf-ocidl-iconnectionpointcontainer-findconnectionpoint
     */
    FindConnectionPoint(riid) {
        result := ComCall(4, this, "ptr", riid, "ptr*", &ppCP := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
