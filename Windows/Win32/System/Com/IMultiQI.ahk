 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-imultiqi
...
class IMultiQI extends IUnknown{
    ...
    /**
     * The IMultiQI::QueryMultipleInterfaces method (objidl.h) retrieves pointers to multiple supported interfaces on an object.
     * @remarks
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-imultiqi-querymultipleinterfaces
     */
