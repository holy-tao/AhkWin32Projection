 ...
 */
export default struct IMultiQI extends IUnknown {
    /**
     ...
     * used for IMultiQI interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        QueryMultipleInterfaces : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMultiQI.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.QueryMultipleInterfaces)
    }
}
