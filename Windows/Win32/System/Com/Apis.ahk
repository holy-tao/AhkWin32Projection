...
;@region Methods
     ...
     * @param {Pointer<Char>} lpsz The string representation of the CLSID.
     ...
     * @param {Pointer<Char>} lpsz A pointer to the string representation of the IID.
    ...
    /**
     * 
     * @param {Pointer<Char>} deviceInstanceId 
