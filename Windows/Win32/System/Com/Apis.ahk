...
export CoBuildVersion() {
    result := DllCall("ole32.dll\CoBuildVersion", UInt32)
    return result
}
...
export CoInitialize() {
    ...
    result := DllCall("OLE32.dll\CoInitialize", "ptr", pvReserved, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export CoRegisterMallocSpy(pMallocSpy) {
    result := DllCall("OLE32.dll\CoRegisterMallocSpy", "ptr", pMallocSpy, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoRevokeMallocSpy() {
    result := DllCall("OLE32.dll\CoRevokeMallocSpy", "HRESULT")
    return result
}
 ...
 */
export CoRegisterInitializeSpy(pSpy) {
    result := DllCall("OLE32.dll\CoRegisterInitializeSpy", "ptr", pSpy, "uint*", &puliCookie := 0, "HRESULT")
    return puliCookie
}
 ...
 * @param {COMSD} comSDType A value from the <a href="https://docs.microsoft.com/windows/desktop/api/objbase/ne-objbase-comsd">COMSD</a> enumeration. Specifies the type of the requested system security permissions, such as launch permissions, access permissions, launch restrictions, and access restrictions.
 ...
 * @since windows5.0
 */
export CoGetSystemSecurityPermissions(comSDType, ppSD) {
    result := DllCall("OLE32.dll\CoGetSystemSecurityPermissions", COMSD, comSDType, PSECURITY_DESCRIPTOR.Ptr, ppSD, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoLoadLibrary(lpszLibName, bAutoFree) {
    lpszLibName := lpszLibName is String ? StrPtr(lpszLibName) : lpszLibName

    result := DllCall("OLE32.dll\CoLoadLibrary", "ptr", lpszLibName, BOOL, bAutoFree, HINSTANCE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CoFreeLibrary(hInst) {
    DllCall("OLE32.dll\CoFreeLibrary", HINSTANCE, hInst)
}
 ...
 * @since windows5.0
 */
export CoAllowSetForegroundWindow(pUnk) {
    static lpvReserved := 0 ;Reserved parameters must always be NULL

    result := DllCall("OLE32.dll\CoAllowSetForegroundWindow", "ptr", pUnk, "ptr", lpvReserved, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoIsOle1Class(rclsid) {
    result := DllCall("ole32.dll\CoIsOle1Class", Guid.Ptr, rclsid, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export CLSIDFromProgIDEx(lpszProgID, lpclsid) {
    lpszProgID := lpszProgID is String ? StrPtr(lpszProgID) : lpszProgID

    result := DllCall("OLE32.dll\CLSIDFromProgIDEx", "ptr", lpszProgID, Guid.Ptr, lpclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoFileTimeNow(lpFileTime) {
    result := DllCall("OLE32.dll\CoFileTimeNow", FILETIME.Ptr, lpFileTime, "HRESULT")
    return result
}
 ...
 */
export CoRegisterChannelHook(ExtensionUuid, pChannelHook) {
    result := DllCall("ole32.dll\CoRegisterChannelHook", Guid.Ptr, ExtensionUuid, "ptr", pChannelHook, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoTreatAsClass(clsidOld, clsidNew) {
    result := DllCall("OLE32.dll\CoTreatAsClass", Guid.Ptr, clsidOld, Guid.Ptr, clsidNew, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CreateDataAdviseHolder() {
    result := DllCall("OLE32.dll\CreateDataAdviseHolder", "ptr*", &ppDAHolder := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export MonikerRelativePathTo(pmkSrc, pmkDest, dwReserved) {
    result := DllCall("ole32.dll\MonikerRelativePathTo", "ptr", pmkSrc, "ptr", pmkDest, "ptr*", &ppmkRelPath := 0, BOOL, dwReserved, "HRESULT")
 ...
 * @since windows5.0
 */
export MonikerCommonPrefixWith(pmkThis, pmkOther) {
    result := DllCall("ole32.dll\MonikerCommonPrefixWith", "ptr", pmkThis, "ptr", pmkOther, "ptr*", &ppmkCommon := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export GetClassFile(szFilename, pclsid) {
    szFilename := szFilename is String ? StrPtr(szFilename) : szFilename

    result := DllCall("OLE32.dll\GetClassFile", "ptr", szFilename, Guid.Ptr, pclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CreateClassMoniker(rclsid) {
    result := DllCall("OLE32.dll\CreateClassMoniker", Guid.Ptr, rclsid, "ptr*", &ppmk := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export CreateFileMoniker(lpszPathName) {
    lpszPathName := lpszPathName is String ? StrPtr(lpszPathName) : lpszPathName

    result := DllCall("OLE32.dll\CreateFileMoniker", "ptr", lpszPathName, "ptr*", &ppmk := 0, "HRESULT")
    return IMoniker(ppmk)
}
 ...
 * @since windows5.0
 */
export CreateItemMoniker(lpszDelim, lpszItem) {
    lpszDelim := lpszDelim is String ? StrPtr(lpszDelim) : lpszDelim
    lpszItem := lpszItem is String ? StrPtr(lpszItem) : lpszItem

    result := DllCall("OLE32.dll\CreateItemMoniker", "ptr", lpszDelim, "ptr", lpszItem, "ptr*", &ppmk := 0, "HRESULT")
    return IMoniker(ppmk)
}
 ...
 * @since windows5.0
 */
export CreateAntiMoniker() {
    result := DllCall("OLE32.dll\CreateAntiMoniker", "ptr*", &ppmk := 0, "HRESULT")
    return IMoniker(ppmk)
}
 ...
 */
export CreateStdProgressIndicator(hwndParent, pszTitle, pIbscCaller) {
    pszTitle := pszTitle is String ? StrPtr(pszTitle) : pszTitle

    result := DllCall("ole32.dll\CreateStdProgressIndicator", HWND, hwndParent, "ptr", pszTitle, "ptr", pIbscCaller, "ptr*", &ppIbsc := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export CoGetCurrentProcess() {
    result := DllCall("OLE32.dll\CoGetCurrentProcess", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export CoGetCallerTID() {
    result := DllCall("OLE32.dll\CoGetCallerTID", "uint*", &lpdwTID := 0, "HRESULT")
    return lpdwTID
}
 ...
 * @since windows5.0
 */
export CoGetCurrentLogicalThreadId(pguid) {
    result := DllCall("OLE32.dll\CoGetCurrentLogicalThreadId", Guid.Ptr, pguid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoGetContextToken() {
    result := DllCall("OLE32.dll\CoGetContextToken", "ptr*", &pToken := 0, "HRESULT")
    return pToken
}
 ...
 * @param {Pointer<APTTYPE>} pAptType <a href="https://docs.microsoft.com/windows/desktop/api/objidl/ne-objidl-apttype">APTTYPE</a> enumeration value that specifies the type of the current apartment.
 * @param {Pointer<APTTYPEQUALIFIER>} pAptQualifier <a href="https://docs.microsoft.com/windows/desktop/api/objidl/ne-objidl-apttypequalifier">APTTYPEQUALIFIER</a> enumeration value that specifies the type qualifier of the current apartment.
 ...
 */
export CoIncrementMTAUsage() {
    pCookie := CO_MTA_USAGE_COOKIE.Owned()
    result := DllCall("OLE32.dll\CoIncrementMTAUsage", CO_MTA_USAGE_COOKIE.Ptr, pCookie, "HRESULT")
    return pCookie
}
 ...
 */
export CoDecrementMTAUsage(Cookie) {
    result := DllCall("OLE32.dll\CoDecrementMTAUsage", CO_MTA_USAGE_COOKIE, Cookie, "HRESULT")
    return result
}
 ...
 * @since windows8.0
 */
export CoAllowUnmarshalerCLSID(clsid) {
    result := DllCall("OLE32.dll\CoAllowUnmarshalerCLSID", Guid.Ptr, clsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoGetObjectContext(riid) {
    result := DllCall("OLE32.dll\CoGetObjectContext", Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @param {CLSCTX} dwClsContext The context in which the executable code is to be run. For information on these context values, see the <a href="https://docs.microsoft.com/windows/desktop/api/wtypesbase/ne-wtypesbase-clsctx">CLSCTX</a> enumeration.
 ...
 * @since windows5.0
 */
export CoResumeClassObjects() {
    result := DllCall("OLE32.dll\CoResumeClassObjects", "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoSuspendClassObjects() {
    result := DllCall("OLE32.dll\CoSuspendClassObjects", "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoAddRefServerProcess() {
    result := DllCall("OLE32.dll\CoAddRefServerProcess", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export CoReleaseServerProcess() {
    result := DllCall("OLE32.dll\CoReleaseServerProcess", UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export CoGetPSClsid(riid, pClsid) {
    result := DllCall("OLE32.dll\CoGetPSClsid", Guid.Ptr, riid, Guid.Ptr, pClsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoRegisterPSClsid(riid, rclsid) {
    result := DllCall("OLE32.dll\CoRegisterPSClsid", Guid.Ptr, riid, Guid.Ptr, rclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoRegisterSurrogate(pSurrogate) {
    result := DllCall("OLE32.dll\CoRegisterSurrogate", "ptr", pSurrogate, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoLockObjectExternal(pUnk, fLock, fLastUnlockReleases) {
    result := DllCall("OLE32.dll\CoLockObjectExternal", "ptr", pUnk, BOOL, fLock, BOOL, fLastUnlockReleases, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoIsHandlerConnected(pUnk) {
    result := DllCall("OLE32.dll\CoIsHandlerConnected", "ptr", pUnk, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export CoGetCallContext(riid) {
    result := DllCall("OLE32.dll\CoGetCallContext", Guid.Ptr, riid, "ptr*", &ppInterface := 0, "HRESULT")
    return ppInterface
}
 ...
 * @since windows5.0
 */
export CoCopyProxy(pProxy) {
    result := DllCall("OLE32.dll\CoCopyProxy", "ptr", pProxy, "ptr*", &ppCopy := 0, "HRESULT")
 ...
 * @since windows5.0
 */
export CoImpersonateClient() {
    result := DllCall("OLE32.dll\CoImpersonateClient", "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoRevertToSelf() {
    result := DllCall("OLE32.dll\CoRevertToSelf", "HRESULT")
    return result
}
 ...
 * @param {CLSCTX} dwClsContext Context in which the code that manages the newly created object will run. The values are taken from the enumeration <a href="https://docs.microsoft.com/windows/desktop/api/wtypesbase/ne-wtypesbase-clsctx">CLSCTX</a>.
 ...
 * @param {CLSCTX} dwClsCtx A value from the <a href="https://docs.microsoft.com/windows/desktop/api/wtypesbase/ne-wtypesbase-clsctx">CLSCTX</a> enumeration.
 ...
 * @since windows5.1.2600
 */
export CoRegisterActivationFilter(pActivationFilter) {
    result := DllCall("OLE32.dll\CoRegisterActivationFilter", "ptr", pActivationFilter, "HRESULT")
    return result
}
 ...
 */
export CoTestCancel() {
    result := DllCall("OLE32.dll\CoTestCancel", "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoEnableCallCancellation() {
    static pReserved := 0 ;Reserved parameters must always be NULL

    result := DllCall("OLE32.dll\CoEnableCallCancellation", "ptr", pReserved, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoDisableCallCancellation() {
    static pReserved := 0 ;Reserved parameters must always be NULL

    result := DllCall("OLE32.dll\CoDisableCallCancellation", "ptr", pReserved, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export StringFromCLSID(rclsid) {
    result := DllCall("OLE32.dll\StringFromCLSID", Guid.Ptr, rclsid, PWSTR.Ptr, &lplpsz := 0, "HRESULT")
    return lplpsz
}
 ...
 * @param {PWSTR} lpsz The zero terminated string representation of the CLSID or the <a href="https://docs.microsoft.com/windows/win32/com/progid">ProgID</a> or <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CLSIDFromString(lpsz, pclsid) {
    lpsz := lpsz is String ? StrPtr(lpsz) : lpsz

    result := DllCall("OLE32.dll\CLSIDFromString", "ptr", lpsz, Guid.Ptr, pclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export StringFromIID(rclsid) {
    result := DllCall("OLE32.dll\StringFromIID", Guid.Ptr, rclsid, PWSTR.Ptr, &lplpsz := 0, "HRESULT")
    return lplpsz
}
 ...
 * @since windows5.0
 */
export IIDFromString(lpsz, lpiid) {
    lpsz := lpsz is String ? StrPtr(lpsz) : lpsz

    result := DllCall("OLE32.dll\IIDFromString", "ptr", lpsz, Guid.Ptr, lpiid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export ProgIDFromCLSID(clsid) {
    result := DllCall("OLE32.dll\ProgIDFromCLSID", Guid.Ptr, clsid, PWSTR.Ptr, &lplpszProgID := 0, "HRESULT")
    return lplpszProgID
}
 ...
 * @since windows5.0
 */
export CLSIDFromProgID(lpszProgID, lpclsid) {
    lpszProgID := lpszProgID is String ? StrPtr(lpszProgID) : lpszProgID

    result := DllCall("OLE32.dll\CLSIDFromProgID", "ptr", lpszProgID, Guid.Ptr, lpclsid, "HRESULT")
    return result
}
 ...
 * @since windows5.0
 */
export CoCreateGuid(pguid) {
    result := DllCall("OLE32.dll\CoCreateGuid", Guid.Ptr, pguid, "HRESULT")
    return result
}
 ...
 * @returns {HRESULT} This function can return the following values, as well as any error values returned by the <a href="https://docs.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-clsidfromstring">CLSIDFromString</a> function.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export CoGetTreatAsClass(clsidOld, pClsidNew) {
    result := DllCall("OLE32.dll\CoGetTreatAsClass", Guid.Ptr, clsidOld, Guid.Ptr, pClsidNew, Int32)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CoInvalidateRemoteMachineBindings(pszMachineName) {
    pszMachineName := pszMachineName is String ? StrPtr(pszMachineName) : pszMachineName

    result := DllCall("OLE32.dll\CoInvalidateRemoteMachineBindings", "ptr", pszMachineName, "HRESULT")
    return result
}
 ...
 */
export CoRegisterDeviceCatalog(deviceInstanceId) {
    deviceInstanceId := deviceInstanceId is String ? StrPtr(deviceInstanceId) : deviceInstanceId

    cookie := CO_DEVICE_CATALOG_COOKIE.Owned()
    result := DllCall("OLE32.dll\CoRegisterDeviceCatalog", "ptr", deviceInstanceId, CO_DEVICE_CATALOG_COOKIE.Ptr, cookie, "HRESULT")
    return cookie
}
 ...
 * @param {CO_DEVICE_CATALOG_COOKIE} cookie Type: \_In\_ **CO_DEVICE_CATALOG_COOKIE**
 * 
 ...
 */
export CoRevokeDeviceCatalog(cookie) {
    result := DllCall("OLE32.dll\CoRevokeDeviceCatalog", CO_DEVICE_CATALOG_COOKIE, cookie, "HRESULT")
    return result
}
 ...
 * @returns {IUri} 
 */
export CreateUri(pwzURI, dwFlags) {
    static dwReserved := 0 ;Reserved parameters must always be NULL
 ...
 * @returns {IUri} 
 */
export CreateUriWithFragment(pwzURI, pwzFragment, dwFlags) {
    static dwReserved := 0 ;Reserved parameters must always be NULL
 ...
 * @returns {IUri} 
 */
export CreateUriFromMultiByteString(pszANSIInputUri, dwEncodingFlags, dwCodePage, dwCreateFlags) {
    static dwReserved := 0 ;Reserved parameters must always be NULL
