 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nn-objidl-ienumstring
...
class IEnumString extends IUnknown{
    ...
    /**
     * The IEnumString::Next method (objidl.h) retrieves the specified number of items in the enumeration sequence.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstring-next
     */
    ...
    /**
     * The IEnumString::Skip method (objidl.h) skips over the specified number of items in the enumeration sequence.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstring-skip
     */
    Skip(celt) {
    ...
    /**
     * The IEnumString::Reset method (objidl.h) resets the enumeration sequence to the beginning.
     * @remarks
     * There is no guarantee that the same set of objects will be enumerated after the reset operation has completed. A static collection is reset to the beginning, but it can be too expensive for some collections, such as files in a directory, to guarantee this condition.
     * @returns {HRESULT} The return value is S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstring-reset
     */
    Reset() {
    ...
    /**
     * The IEnumString::Clone method (objidl.h) creates a new enumerator that contains the same enumeration state as the current one.
     * @returns {IEnumString} A pointer to the cloned enumerator object.
     * @see https://learn.microsoft.com/windows/win32/api//content/objidl/nf-objidl-ienumstring-clone
     */
    Clone() {
