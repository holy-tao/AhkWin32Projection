 ...
 */
export default struct IHostGCManager extends IUnknown {
    /**
     ...
     * used for IHostGCManager interfaces
    */
    ...
    SuspensionEnding(Generation) {
        result := ComCall(5, this, UInt32, Generation, "HRESULT")
        return result
    }

    _Query(iid) {
        if (IHostGCManager.IID.Equals(iid)) {
            return true
        }
