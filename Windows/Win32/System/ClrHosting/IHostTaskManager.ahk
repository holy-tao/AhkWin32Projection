...
class IHostTaskManager extends IUnknown{
    ...
    CreateTask(dwStackSize, pStartAddress, pParameter, ppTask) {
        result := ComCall(4, this, "uint", dwStackSize, "ptr", pStartAddress, "ptr", pParameter, "ptr", ppTask, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CallNeedsHostHook(target, pbCallNeedsHostHook) {
        result := ComCall(9, this, "ptr", target, "ptr", pbCallNeedsHostHook, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pGuarantee 
     * @returns {HRESULT} 
     */
    GetStackGuarantee(pGuarantee) {
        result := ComCall(19, this, "uint*", pGuarantee, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ICLRTaskManager>} ppManager 
     * @returns {HRESULT} 
     */
