...
class ICorThreadpool extends IUnknown{
    ...
    CorRegisterWaitForSingleObject(phNewWaitObject, hWaitObject, Callback, Context, timeout, executeOnlyOnce, result) {
        ...
        result := ComCall(3, this, "ptr", phNewWaitObject, "ptr", hWaitObject, "ptr", Callback, "ptr", Context, "uint", timeout, "int", executeOnlyOnce, "ptr", result, "int")
        if(result != 0)
    ...
    CorUnregisterWait(hWaitObject, CompletionEvent, result) {
        ...
        result := ComCall(4, this, "ptr", hWaitObject, "ptr", CompletionEvent, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CorQueueUserWorkItem(Function, Context, executeOnlyOnce, result) {
        result := ComCall(5, this, "ptr", Function, "ptr", Context, "int", executeOnlyOnce, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CorCreateTimer(phNewTimer, Callback, Parameter, DueTime, Period, result) {
        result := ComCall(6, this, "ptr", phNewTimer, "ptr", Callback, "ptr", Parameter, "uint", DueTime, "uint", Period, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CorChangeTimer(Timer, DueTime, Period, result) {
        ...
        result := ComCall(7, this, "ptr", Timer, "uint", DueTime, "uint", Period, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CorDeleteTimer(Timer, CompletionEvent, result) {
        ...
        result := ComCall(8, this, "ptr", Timer, "ptr", CompletionEvent, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CorCallOrQueueUserWorkItem(Function, Context, result) {
        result := ComCall(10, this, "ptr", Function, "ptr", Context, "ptr", result, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} MaxWorkerThreads 
     * @param {Pointer<UInt32>} MaxIOCompletionThreads 
     * @returns {HRESULT} 
     */
    CorGetMaxThreads(MaxWorkerThreads, MaxIOCompletionThreads) {
        result := ComCall(12, this, "uint*", MaxWorkerThreads, "uint*", MaxIOCompletionThreads, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} AvailableWorkerThreads 
     * @param {Pointer<UInt32>} AvailableIOCompletionThreads 
     * @returns {HRESULT} 
     */
    CorGetAvailableThreads(AvailableWorkerThreads, AvailableIOCompletionThreads) {
        result := ComCall(13, this, "uint*", AvailableWorkerThreads, "uint*", AvailableIOCompletionThreads, "int")
        if(result != 0)
            throw OSError(result)
