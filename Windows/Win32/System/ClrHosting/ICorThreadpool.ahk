...
export default struct ICorThreadpool extends IUnknown {
    ...
    */
    ...
    CorChangeTimer(Timer, DueTime, Period) {
        result := ComCall(7, this, HANDLE, Timer, UInt32, DueTime, UInt32, Period, BOOL.Ptr, &result := 0, "HRESULT")
        return result
    }
    ...
    CorSetMaxThreads(MaxWorkerThreads, MaxIOCompletionThreads) {
        result := ComCall(11, this, UInt32, MaxWorkerThreads, UInt32, MaxIOCompletionThreads, "HRESULT")
        return result
    }
