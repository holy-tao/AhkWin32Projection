 ...
 */
export default struct CreateInterfaceFnPtr {
    value : IntPtr

    __value {
        set {
            if (value is CreateInterfaceFnPtr) {
    ...
    /**
     * A CreateInterfaceFnPtr that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends CreateInterfaceFnPtr {
        /**
         * Creates a CreateInterfaceFnPtr pointer that invokes the given AHK function when called.
