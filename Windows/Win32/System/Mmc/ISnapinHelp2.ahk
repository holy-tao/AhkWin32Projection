 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-isnapinhelp2
...
class ISnapinHelp2 extends ISnapinHelp{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinhelp2-getlinkedtopics
     */
    GetLinkedTopics() {
        result := ComCall(4, this, "ptr*", &lpCompiledHelpFiles := 0, "int")
        if(result != 0) {
