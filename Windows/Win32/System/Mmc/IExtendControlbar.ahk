 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iextendcontrolbar
...
class IExtendControlbar extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendcontrolbar-setcontrolbar
     */
     ...
     * @param {LPARAM} param2 
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendcontrolbar-controlbarnotify
     */
