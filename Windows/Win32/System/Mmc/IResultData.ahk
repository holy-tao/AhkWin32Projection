...
export default struct IResultData extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.FindItemByLParam := CallbackCreate(ObjBindMethod(implObj, "FindItemByLParam"), flags, 3)
        this.vtbl.DeleteAllRsltItems := CallbackCreate(ObjBindMethod(implObj, "DeleteAllRsltItems"), flags, 1)
        ...
        this.vtbl.GetNextItem := CallbackCreate(ObjBindMethod(implObj, "GetNextItem"), flags, 2)
        this.vtbl.ModifyItemState := CallbackCreate(ObjBindMethod(implObj, "ModifyItemState"), flags, 5)
        this.vtbl.ModifyViewStyle := CallbackCreate(ObjBindMethod(implObj, "ModifyViewStyle"), flags, 3)
        this.vtbl.SetViewMode := CallbackCreate(ObjBindMethod(implObj, "SetViewMode"), flags, 2)
        this.vtbl.GetViewMode := CallbackCreate(ObjBindMethod(implObj, "GetViewMode"), flags, 2)
        this.vtbl.UpdateItem := CallbackCreate(ObjBindMethod(implObj, "UpdateItem"), flags, 2)
        this.vtbl.Sort := CallbackCreate(ObjBindMethod(implObj, "Sort"), flags, 4)
        this.vtbl.SetDescBarText := CallbackCreate(ObjBindMethod(implObj, "SetDescBarText"), flags, 2)
        this.vtbl.SetItemCount := CallbackCreate(ObjBindMethod(implObj, "SetItemCount"), flags, 3)
    }
