 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsolenamespace2
...
class IConsoleNameSpace2 extends IConsoleNameSpace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace2-expand
     */
    Expand(hItem) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace2-addextension
     */
