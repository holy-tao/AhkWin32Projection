 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsolepowersink
...
class IConsolePowerSink extends IUnknown{
     ...
     * @param {LPARAM} lParam_ Function-specific data. For most events, this parameter is reserved and not used. However, if <i>nEvent</i> is one of the resume events (PBT_APMRESUME*), the <i>lParam</i> parameter can specify the PBTF_APMRESUMEFROMFAILURE flag. This flag indicates that a suspend operation failed after the <a href="https://docs.microsoft.com/windows/desktop/Power/pbt-apmsuspend">PBT_APMSUSPEND</a> event was broadcast.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolepowersink-onpowerbroadcast
     */
    OnPowerBroadcast(nEvent, lParam_) {
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        plReturn := LRESULT()
        result := ComCall(3, this, "uint", nEvent, "ptr", lParam_, "ptr", plReturn, "int")
        if(result != 0) {
