 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsole
...
class IConsole extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-setheader
     */
    SetHeader(pHeader) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-settoolbar
     */
    SetToolbar(pToolbar) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-queryresultview
     */
    QueryResultView() {
        result := ComCall(5, this, "ptr*", &pUnknown := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-queryscopeimagelist
     */
    QueryScopeImageList() {
        result := ComCall(6, this, "ptr*", &ppImageList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/mmc/nn-mmc-iimagelist">IImageList</a> interface pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-queryresultimagelist
     */
    QueryResultImageList() {
        result := ComCall(7, this, "ptr*", &ppImageList := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-updateallviews
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-messagebox
     */
    MessageBox(lpszText, lpszTitle, fuStyle) {
        ...
        result := ComCall(9, this, "ptr", lpszText, "ptr", lpszTitle, "uint", fuStyle, "int*", &piRetval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-queryconsoleverb
     */
    QueryConsoleVerb() {
        result := ComCall(10, this, "ptr*", &ppConsoleVerb := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-selectscopeitem
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-getmainwindow
     */
    GetMainWindow() {
        phwnd := HWND()
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole-newwindow
     */
