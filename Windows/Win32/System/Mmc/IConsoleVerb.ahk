 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsoleverb
...
class IConsoleVerb extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsoleverb-getverbstate
     */
    GetVerbState(eCmdID, nState) {
        result := ComCall(3, this, "int", eCmdID, "int", nState, "int*", &pState := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsoleverb-setverbstate
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsoleverb-setdefaultverb
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsoleverb-getdefaultverb
     */
    GetDefaultVerb() {
        result := ComCall(6, this, "int*", &peCmdID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
