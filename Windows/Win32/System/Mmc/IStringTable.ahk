 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-istringtable
...
class IStringTable extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-addstring
     */
    AddString(pszAdd) {
        pszAdd := pszAdd is String ? StrPtr(pszAdd) : pszAdd

        result := ComCall(3, this, "ptr", pszAdd, "uint*", &pStringID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-getstring
     */
    GetString(StringID, cchBuffer, lpBuffer) {
        lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer

        result := ComCall(4, this, "uint", StringID, "uint", cchBuffer, "ptr", lpBuffer, "uint*", &pcchOut := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-getstringlength
     */
    GetStringLength(StringID) {
        result := ComCall(5, this, "uint", StringID, "uint*", &pcchString := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-deletestring
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-deleteallstrings
     */
    DeleteAllStrings() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-findstring
     */
    FindString(pszFind) {
        pszFind := pszFind is String ? StrPtr(pszFind) : pszFind

        result := ComCall(8, this, "ptr", pszFind, "uint*", &pStringID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-istringtable-enumerate
     */
    Enumerate() {
