 ...
 */
export default struct IStringTable extends IUnknown {
    /**
     ...
     * used for IStringTable interfaces
    */
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.DeleteString)
        CallbackFree(this.vtbl.DeleteAllStrings)
        CallbackFree(this.vtbl.FindString)
