 ...
 */
export default struct Nodes extends IDispatch {
    /**
    ...
    */
     ...
     */
    Item(Index) {
        result := ComCall(8, this, Int32, Index, "ptr*", &_Node := 0, "HRESULT")
        return Node(_Node)
    }
