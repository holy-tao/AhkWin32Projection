 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsole2
...
class IConsole2 extends IConsole{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole2-expand
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole2-istaskpadviewpreferred
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole2-setstatustext
     */
