 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-icontextmenucallback2
...
class IContextMenuCallback2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icontextmenucallback2-additem
     */
    AddItem(pItem) {
