 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-isnapinabout
...
class ISnapinAbout extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinabout-getsnapindescription
     */
    GetSnapinDescription() {
        result := ComCall(3, this, "ptr*", &lpDescription := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinabout-getprovider
     */
    GetProvider() {
        result := ComCall(4, this, "ptr*", &lpName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinabout-getsnapinversion
     */
    GetSnapinVersion() {
        result := ComCall(5, this, "ptr*", &lpVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinabout-getsnapinimage
     */
    GetSnapinImage() {
        hAppIcon := HICON()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-isnapinabout-getstaticfolderimage
     */
    GetStaticFolderImage(hSmallImage, hSmallImageOpen, hLargeImage, cMask) {
        cMaskMarshal := cMask is VarRef ? "uint*" : "ptr"

        result := ComCall(7, this, "ptr", hSmallImage, "ptr", hSmallImageOpen, "ptr", hLargeImage, cMaskMarshal, cMask, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
