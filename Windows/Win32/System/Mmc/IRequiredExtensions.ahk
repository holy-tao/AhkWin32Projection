 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-irequiredextensions
...
class IRequiredExtensions extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-irequiredextensions-enableallextensions
     */
    EnableAllExtensions() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-irequiredextensions-getfirstextension
     */
    GetFirstExtension() {
        pExtCLSID := Guid()
        result := ComCall(4, this, "ptr", pExtCLSID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-irequiredextensions-getnextextension
     */
    GetNextExtension() {
        pExtCLSID := Guid()
        result := ComCall(5, this, "ptr", pExtCLSID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
