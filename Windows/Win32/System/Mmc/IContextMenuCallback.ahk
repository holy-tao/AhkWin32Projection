 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-icontextmenucallback
...
class IContextMenuCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icontextmenucallback-additem
     */
    AddItem(pItem) {
