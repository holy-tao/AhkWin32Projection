 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iresultownerdata
...
class IResultOwnerData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iresultownerdata-finditem
     */
    FindItem(pFindInfo) {
        result := ComCall(3, this, "ptr", pFindInfo, "int*", &pnFoundIndex := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iresultownerdata-cachehint
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iresultownerdata-sortitems
     */
