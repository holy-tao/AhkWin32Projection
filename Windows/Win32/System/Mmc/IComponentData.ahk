 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-icomponentdata
...
class IComponentData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-initialize
     */
    Initialize(pUnknown) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-createcomponent
     */
    CreateComponent() {
        result := ComCall(4, this, "ptr*", &ppComponent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {LPARAM} param3 
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-notify
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-destroy
     */
    Destroy() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-querydataobject
     */
    QueryDataObject(cookie, type) {
        result := ComCall(7, this, "ptr", cookie, "int", type, "ptr*", &ppDataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-getdisplayinfo
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponentdata-compareobjects
     */
