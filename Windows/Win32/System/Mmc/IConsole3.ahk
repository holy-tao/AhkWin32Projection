 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsole3
...
class IConsole3 extends IConsole2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsole3-renamescopeitem
     */
    RenameScopeItem(hScopeItem) {
        result := ComCall(17, this, "ptr", hScopeItem, "int")
        if(result != 0) {
