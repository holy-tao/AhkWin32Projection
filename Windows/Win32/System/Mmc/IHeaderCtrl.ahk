 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iheaderctrl
...
class IHeaderCtrl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-insertcolumn
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-deletecolumn
     */
    DeleteColumn(nCol) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-setcolumntext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-getcolumntext
     */
    GetColumnText(nCol) {
        result := ComCall(6, this, "int", nCol, "ptr*", &pText := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-setcolumnwidth
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iheaderctrl-getcolumnwidth
     */
    GetColumnWidth(nCol) {
        result := ComCall(8, this, "int", nCol, "int*", &pWidth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
