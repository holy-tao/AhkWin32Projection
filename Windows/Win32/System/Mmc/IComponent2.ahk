 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-icomponent2
...
class IComponent2 extends IComponent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent2-querydispatch
     */
    QueryDispatch(cookie, type) {
        result := ComCall(10, this, "ptr", cookie, "int", type, "ptr*", &ppDispatch := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent2-getresultviewtype2
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent2-restoreresultview
     */
