 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iextendpropertysheet
...
class IExtendPropertySheet extends IUnknown{
     ...
     * @param {Pointer} handle_ A value that specifies the handle used to route the 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendpropertysheet-createpropertypages
     */
    CreatePropertyPages(lpProvider, handle_, lpIDataObject) {
        result := ComCall(3, this, "ptr", lpProvider, "ptr", handle_, "ptr", lpIDataObject, "int")
        if(result != 0) {
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-idataobject">IDataObject</a> interface on the object that contains context information about the scope or result item.
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendpropertysheet-querypagesfor
     */
