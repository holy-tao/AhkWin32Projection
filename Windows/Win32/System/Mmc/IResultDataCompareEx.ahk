 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iresultdatacompareex
...
class IResultDataCompareEx extends IUnknown{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iresultdatacompareex-compare
     */
    Compare(prdc) {
        result := ComCall(3, this, "ptr", prdc, "int*", &pnResult := 0, "int")
        if(result != 0) {
