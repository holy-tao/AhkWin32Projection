 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iextendview
...
class IExtendView extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendview-getviews
     */
