 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-imenubutton
...
class IMenuButton extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-imenubutton-addbutton
     */
     ...
     * @param {PWSTR} lpTooltipText A pointer to the text value (a null-terminated string) to be displayed when the user places the mouse pointer on the button.
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-imenubutton-setbutton
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-imenubutton-setbuttonstate
     */
