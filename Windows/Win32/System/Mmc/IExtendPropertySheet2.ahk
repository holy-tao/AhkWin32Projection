 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iextendpropertysheet2
...
class IExtendPropertySheet2 extends IExtendPropertySheet{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendpropertysheet2-getwatermarks
     */
    GetWatermarks(lpIDataObject, lphWatermark, lphHeader, lphPalette, bStretch) {
        bStretchMarshal := bStretch is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, "ptr", lpIDataObject, "ptr", lphWatermark, "ptr", lphHeader, "ptr", lphPalette, bStretchMarshal, bStretch, "int")
        if(result != 0) {
