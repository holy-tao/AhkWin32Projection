...
export default struct ISnapinProperties extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.QueryPropertyNames := CallbackCreate(ObjBindMethod(implObj, "QueryPropertyNames"), flags, 2)
        this.vtbl.PropertiesChanged := CallbackCreate(ObjBindMethod(implObj, "PropertiesChanged"), flags, 3)
    }
