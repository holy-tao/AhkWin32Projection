 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iconsolenamespace
...
class IConsoleNameSpace extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-insertitem
     */
    InsertItem(item) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-deleteitem
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-setitem
     */
    SetItem(item) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-getitem
     */
    GetItem(item) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-getchilditem
     */
    GetChildItem(item, pItemChild, pCookie) {
        ...
        result := ComCall(7, this, "ptr", item, pItemChildMarshal, pItemChild, pCookieMarshal, pCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-getnextitem
     */
    GetNextItem(item, pItemNext, pCookie) {
        pItemNextMarshal := pItemNext is VarRef ? "ptr*" : "ptr"
        pCookieMarshal := pCookie is VarRef ? "ptr*" : "ptr"

        result := ComCall(8, this, "ptr", item, pItemNextMarshal, pItemNext, pCookieMarshal, pCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iconsolenamespace-getparentitem
     */
    GetParentItem(item, pItemParent, pCookie) {
        pItemParentMarshal := pItemParent is VarRef ? "ptr*" : "ptr"
        pCookieMarshal := pCookie is VarRef ? "ptr*" : "ptr"

        result := ComCall(9, this, "ptr", item, pItemParentMarshal, pItemParent, pCookieMarshal, pCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
