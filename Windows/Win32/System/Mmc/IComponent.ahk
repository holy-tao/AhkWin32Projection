...
class IComponent extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-initialize
     */
    Initialize(lpConsole) {
        result := ComCall(3, this, "ptr", lpConsole, "int")
        if(result != 0) {
     ...
     * @param {LPARAM} param3 
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-notify
     */
    Notify(lpDataObject, event, arg, param3) {
        arg := arg is Win32Handle ? NumGet(arg, "ptr") : arg
        param3 := param3 is Win32Handle ? NumGet(param3, "ptr") : param3

        result := ComCall(4, this, "ptr", lpDataObject, "int", event, "ptr", arg, "ptr", param3, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-destroy
     */
    Destroy(cookie) {
        result := ComCall(5, this, "ptr", cookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-querydataobject
     */
    QueryDataObject(cookie, type) {
        result := ComCall(6, this, "ptr", cookie, "int", type, "ptr*", &ppDataObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-getresultviewtype
     */
    GetResultViewType(cookie, ppViewType, pViewOptions) {
        ...
        result := ComCall(7, this, "ptr", cookie, ppViewTypeMarshal, ppViewType, pViewOptionsMarshal, pViewOptions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-getdisplayinfo
     */
    GetDisplayInfo(pResultDataItem) {
        result := ComCall(8, this, "ptr", pResultDataItem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icomponent-compareobjects
     */
