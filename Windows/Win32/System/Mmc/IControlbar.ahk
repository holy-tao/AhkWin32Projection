...
class IControlbar extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icontrolbar-create
     */
    Create(nType, pExtendControlbar) {
        result := ComCall(3, this, "int", nType, "ptr", pExtendControlbar, "ptr*", &ppUnknown := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icontrolbar-attach
     */
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-icontrolbar-detach
     */
    Detach(lpUnknown) {
