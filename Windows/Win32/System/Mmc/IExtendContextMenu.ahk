 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nn-mmc-iextendcontextmenu
...
class IExtendContextMenu extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendcontextmenu-addmenuitems
     */
    AddMenuItems(piDataObject, piCallback, pInsertionAllowed) {
        pInsertionAllowedMarshal := pInsertionAllowed is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", piDataObject, "ptr", piCallback, pInsertionAllowedMarshal, pInsertionAllowed, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method can return one of these values.
     * @see https://learn.microsoft.com/windows/win32/api//content/mmc/nf-mmc-iextendcontextmenu-command
     */
