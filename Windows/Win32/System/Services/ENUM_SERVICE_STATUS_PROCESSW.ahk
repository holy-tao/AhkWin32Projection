 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsvc/ns-winsvc-enum_service_status_processw
 * @namespace Windows.Win32.System.Services
 * @version v4.0.30319
 * @charset Unicode
 */
class ENUM_SERVICE_STATUS_PROCESSW extends Win32Struct
{
    static sizeof => 56
    ...
    ServiceStatusProcess{
        get {
            if(!this.HasProp("__ServiceStatusProcess"))
                this.__ServiceStatusProcess := SERVICE_STATUS_PROCESS(16, this)
