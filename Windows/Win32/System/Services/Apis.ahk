 ...
 * @since windows5.1.2600
 */
export ChangeServiceConfigA(hService, dwServiceType, dwStartType, dwErrorControl, lpBinaryPathName, lpLoadOrderGroup, lpdwTagId, lpDependencies, lpServiceStartName, lpPassword, lpDisplayName) {
 ...
 * @since windows5.1.2600
 */
export ChangeServiceConfigW(hService, dwServiceType, dwStartType, dwErrorControl, lpBinaryPathName, lpLoadOrderGroup, lpdwTagId, lpDependencies, lpServiceStartName, lpPassword, lpDisplayName) {
    lpBinaryPathName := lpBinaryPathName is String ? StrPtr(lpBinaryPathName) : lpBinaryPathName
    lpLoadOrderGroup := lpLoadOrderGroup is String ? StrPtr(lpLoadOrderGroup) : lpLoadOrderGroup
    lpDependencies := lpDependencies is String ? StrPtr(lpDependencies) : lpDependencies
    lpServiceStartName := lpServiceStartName is String ? StrPtr(lpServiceStartName) : lpServiceStartName
...
export ChangeServiceConfig2A(hService, dwInfoLevel, lpInfo) {
    ...
    result := DllCall("ADVAPI32.dll\ChangeServiceConfig2A", SC_HANDLE, hService, SERVICE_CONFIG, dwInfoLevel, lpInfoMarshal, lpInfo, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export ChangeServiceConfig2W(hService, dwInfoLevel, lpInfo) {
    ...
    result := DllCall("ADVAPI32.dll\ChangeServiceConfig2W", SC_HANDLE, hService, SERVICE_CONFIG, dwInfoLevel, lpInfoMarshal, lpInfo, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CloseServiceHandle(hSCObject) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\CloseServiceHandle", SC_HANDLE, hSCObject, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CreateServiceA(hSCManager, lpServiceName, lpDisplayName, dwDesiredAccess, dwServiceType, dwStartType, dwErrorControl, lpBinaryPathName, lpLoadOrderGroup, lpdwTagId, lpDependencies, lpServiceStartName, lpPassword) {
 ...
 * @since windows5.1.2600
 */
export CreateServiceW(hSCManager, lpServiceName, lpDisplayName, dwDesiredAccess, dwServiceType, dwStartType, dwErrorControl, lpBinaryPathName, lpLoadOrderGroup, lpdwTagId, lpDependencies, lpServiceStartName, lpPassword) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
    lpDisplayName := lpDisplayName is String ? StrPtr(lpDisplayName) : lpDisplayName
    lpBinaryPathName := lpBinaryPathName is String ? StrPtr(lpBinaryPathName) : lpBinaryPathName
    lpLoadOrderGroup := lpLoadOrderGroup is String ? StrPtr(lpLoadOrderGroup) : lpLoadOrderGroup
 ...
 * @since windows5.1.2600
 */
export DeleteService(hService) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\DeleteService", SC_HANDLE, hService, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export GetServiceKeyNameA(hSCManager, lpDisplayName, lpServiceName, lpcchBuffer) {
    lpDisplayName := lpDisplayName is String ? StrPtr(lpDisplayName) : lpDisplayName
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export GetServiceKeyNameW(hSCManager, lpDisplayName, lpServiceName, lpcchBuffer) {
    lpDisplayName := lpDisplayName is String ? StrPtr(lpDisplayName) : lpDisplayName
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export GetServiceDisplayNameA(hSCManager, lpServiceName, lpDisplayName, lpcchBuffer) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
    lpDisplayName := lpDisplayName is String ? StrPtr(lpDisplayName) : lpDisplayName
 ...
 * @since windows5.1.2600
 */
export GetServiceDisplayNameW(hSCManager, lpServiceName, lpDisplayName, lpcchBuffer) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
    lpDisplayName := lpDisplayName is String ? StrPtr(lpDisplayName) : lpDisplayName
 ...
 * @since windows5.1.2600
 */
export LockServiceDatabase(hSCManager) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\LockServiceDatabase", SC_HANDLE, hSCManager, IntPtr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export NotifyBootConfigStatus(BootAcceptable) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\NotifyBootConfigStatus", BOOL, BootAcceptable, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export OpenSCManagerA(lpMachineName, lpDatabaseName, dwDesiredAccess) {
 ...
 * @since windows5.1.2600
 */
export OpenSCManagerW(lpMachineName, lpDatabaseName, dwDesiredAccess) {
    lpMachineName := lpMachineName is String ? StrPtr(lpMachineName) : lpMachineName
    lpDatabaseName := lpDatabaseName is String ? StrPtr(lpDatabaseName) : lpDatabaseName
 ...
 * @since windows5.1.2600
 */
export OpenServiceA(hSCManager, lpServiceName, dwDesiredAccess) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export OpenServiceW(hSCManager, lpServiceName, dwDesiredAccess) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export QueryServiceStatus(hService, lpServiceStatus) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\QueryServiceStatus", SC_HANDLE, hService, SERVICE_STATUS.Ptr, lpServiceStatus, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export RegisterServiceCtrlHandlerA(lpServiceName, lpHandlerProc) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export RegisterServiceCtrlHandlerW(lpServiceName, lpHandlerProc) {
    lpServiceName := lpServiceName is String ? StrPtr(lpServiceName) : lpServiceName
 ...
 * @since windows5.1.2600
 */
export SetServiceObjectSecurity(hService, dwSecurityInformation, lpSecurityDescriptor) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\SetServiceObjectSecurity", SC_HANDLE, hService, OBJECT_SECURITY_INFORMATION, dwSecurityInformation, PSECURITY_DESCRIPTOR, lpSecurityDescriptor, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export SetServiceStatus(hServiceStatus, lpServiceStatus) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\SetServiceStatus", SERVICE_STATUS_HANDLE, hServiceStatus, SERVICE_STATUS.Ptr, lpServiceStatus, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export StartServiceCtrlDispatcherA(lpServiceStartTable) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\StartServiceCtrlDispatcherA", SERVICE_TABLE_ENTRYA.Ptr, lpServiceStartTable, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export StartServiceCtrlDispatcherW(lpServiceStartTable) {
    A_LastError := 0

    result := DllCall("ADVAPI32.dll\StartServiceCtrlDispatcherW", SERVICE_TABLE_ENTRYW.Ptr, lpServiceStartTable, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export UnlockServiceDatabase(ScLock) {
    ...
    result := DllCall("ADVAPI32.dll\UnlockServiceDatabase", ScLockMarshal, ScLock, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export NotifyServiceStatusChangeA(hService, dwNotifyMask, pNotifyBuffer) {
    result := DllCall("ADVAPI32.dll\NotifyServiceStatusChangeA", SC_HANDLE, hService, SERVICE_NOTIFY, dwNotifyMask, SERVICE_NOTIFY_2A.Ptr, pNotifyBuffer, UInt32)
    return result
}
 ...
 * @since windows6.0.6000
 */
export NotifyServiceStatusChangeW(hService, dwNotifyMask, pNotifyBuffer) {
    result := DllCall("ADVAPI32.dll\NotifyServiceStatusChangeW", SC_HANDLE, hService, SERVICE_NOTIFY, dwNotifyMask, SERVICE_NOTIFY_2W.Ptr, pNotifyBuffer, UInt32)
    return result
}
 ...
 * @param {Pointer<PSC_NOTIFICATION_REGISTRATION>} pSubscription Returns a pointer to the subscription resulting from the notification callback registration. The caller is responsible for calling [**UnsubscribeServiceChangeNotifications**](unsubscribeservicechangenotifications.md) to stop receiving notifications.
 ...
 */
export UnsubscribeServiceChangeNotifications(pSubscription) {
    DllCall("SecHost.dll\UnsubscribeServiceChangeNotifications", PSC_NOTIFICATION_REGISTRATION, pSubscription)
}
