 ...
 * @see https://learn.microsoft.com/windows/win32/api/winsvc/nc-winsvc-lpservice_main_functionw
 * @namespace Windows.Win32.System.Services
 * @charset Unicode
 */
export default struct LPSERVICE_MAIN_FUNCTIONW {
    value : IntPtr

    __value {
        set {
            if (value is LPSERVICE_MAIN_FUNCTIONW) {
     ...
     * @param {Pointer<PWSTR>} lpServiceArgVectors The null-terminated argument strings passed to the service by the call to the 
    ...
    /**
     * A LPSERVICE_MAIN_FUNCTIONW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPSERVICE_MAIN_FUNCTIONW {
        /**
         * Creates a LPSERVICE_MAIN_FUNCTIONW pointer that invokes the given AHK function when called.
