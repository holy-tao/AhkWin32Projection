 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winsvc/ns-winsvc-query_service_configa
    ...
    lpBinaryPathName{
        get {
            if(!this.HasProp("__lpBinaryPathName"))
                this.__lpBinaryPathName := PSTR(this.ptr + 16)
    ...
    lpLoadOrderGroup{
        get {
            if(!this.HasProp("__lpLoadOrderGroup"))
                this.__lpLoadOrderGroup := PSTR(this.ptr + 24)
    ...
    lpDependencies{
        get {
            if(!this.HasProp("__lpDependencies"))
                this.__lpDependencies := PSTR(this.ptr + 40)
    ...
    lpServiceStartName{
        get {
            if(!this.HasProp("__lpServiceStartName"))
                this.__lpServiceStartName := PSTR(this.ptr + 48)
    ...
    lpDisplayName{
        get {
            if(!this.HasProp("__lpDisplayName"))
                this.__lpDisplayName := PSTR(this.ptr + 56)
