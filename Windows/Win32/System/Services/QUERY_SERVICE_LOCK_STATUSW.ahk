 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winsvc/ns-winsvc-query_service_lock_statusw
 * @namespace Windows.Win32.System.Services
 * @version v4.0.30319
 * @charset Unicode
 */
class QUERY_SERVICE_LOCK_STATUSW extends Win32Struct
{
    static sizeof => 24
    ...
    lpLockOwner{
        get {
            if(!this.HasProp("__lpLockOwner"))
                this.__lpLockOwner := PWSTR(this.ptr + 8)
