    ...
    MftWritesUserLevel {
        get {
            if(!this.HasProp("__MftWritesUserLevel"))
                this.__MftWritesUserLevel := NTFS_STATISTICS_EX._MftWritesUserLevel(40, this)
    ...
    Mft2WritesUserLevel {
        get {
            if(!this.HasProp("__Mft2WritesUserLevel"))
                this.__Mft2WritesUserLevel := NTFS_STATISTICS_EX._Mft2WritesUserLevel(88, this)
    ...
    BitmapWritesUserLevel {
        get {
            if(!this.HasProp("__BitmapWritesUserLevel"))
                this.__BitmapWritesUserLevel := NTFS_STATISTICS_EX._BitmapWritesUserLevel(196, this)
    ...
    MftBitmapWritesUserLevel {
        get {
            if(!this.HasProp("__MftBitmapWritesUserLevel"))
                this.__MftBitmapWritesUserLevel := NTFS_STATISTICS_EX._MftBitmapWritesUserLevel(260, this)
    ...
    Allocate {
        get {
            if(!this.HasProp("__Allocate"))
                this.__Allocate := NTFS_STATISTICS_EX._Allocate(344, this)
