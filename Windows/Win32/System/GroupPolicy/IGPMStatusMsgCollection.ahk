 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpmstatusmsgcollection
...
class IGPMStatusMsgCollection extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmstatusmsgcollection-get_count
     */
    get_Count() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmstatusmsgcollection-get_item
     */
    get_Item(lIndex) {
        pVal := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmstatusmsgcollection-get__newenum
     */
    get__NewEnum() {
