...
class IGPMStarterGPO extends IDispatch{
    ...
    get_ModifiedTime(pVal) {
        result := ComCall(15, this, "double*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt16>} pVal 
     * @returns {HRESULT} 
     */
    get_ComputerVersion(pVal) {
        result := ComCall(17, this, "ushort*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_UserVersion(pVal) {
        result := ComCall(18, this, "ushort*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Save(bstrSaveFile, bOverwrite, bSaveAsSystem, bstrLanguage, bstrAuthor, bstrProduct, bstrUniqueID, bstrVersion, pvarGPMProgress, pvarGPMCancel, ppIGPMResult) {
        ...
        result := ComCall(21, this, "ptr", bstrSaveFile, "short", bOverwrite, "short", bSaveAsSystem, "ptr", bstrLanguage, "ptr", bstrAuthor, "ptr", bstrProduct, "ptr", bstrUniqueID, "ptr", bstrVersion, "ptr", pvarGPMProgress, "ptr", pvarGPMCancel, "ptr", ppIGPMResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Backup(bstrBackupDir, bstrComment, pvarGPMProgress, pvarGPMCancel, ppIGPMResult) {
        ...
        result := ComCall(22, this, "ptr", bstrBackupDir, "ptr", bstrComment, "ptr", pvarGPMProgress, "ptr", pvarGPMCancel, "ptr", ppIGPMResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CopyTo(pvarNewDisplayName, pvarGPMProgress, pvarGPMCancel, ppIGPMResult) {
        result := ComCall(23, this, "ptr", pvarNewDisplayName, "ptr", pvarGPMProgress, "ptr", pvarGPMCancel, "ptr", ppIGPMResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GenerateReport(gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult) {
        result := ComCall(24, this, "int", gpmReportType, "ptr", pvarGPMProgress, "ptr", pvarGPMCancel, "ptr", ppIGPMResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GenerateReportToFile(gpmReportType, bstrTargetFilePath, ppIGPMResult) {
        ...
        result := ComCall(25, this, "int", gpmReportType, "ptr", bstrTargetFilePath, "ptr", ppIGPMResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSecurityInfo(ppSecurityInfo) {
        result := ComCall(26, this, "ptr", ppSecurityInfo, "int")
        if(result != 0)
            throw OSError(result)
