...
class IGPMSecurityInfo extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-get_count
     */
    get_Count() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-get_item
     */
    get_Item(lIndex) {
        pVal := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-get__newenum
     */
    get__NewEnum() {
     ...
     * <h3>VB</h3>
     * Returns <b>S_OK</b> if successful. Returns a failure code if an error occurs.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-add
     */
    Add(pPerm) {
        result := ComCall(10, this, "ptr", pPerm, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <h3>VB</h3>
     * Returns <b>S_OK</b> if successful. Returns a failure code if an error occurs.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-remove
     */
    Remove(pPerm) {
        result := ComCall(11, this, "ptr", pPerm, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <h3>VB</h3>
     * Returns <b>S_OK</b> if successful. Returns a failure code if an error occurs.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsecurityinfo-removetrustee
     */
    RemoveTrustee(bstrTrustee) {
        ...
        result := ComCall(12, this, "ptr", bstrTrustee, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
