...
class IGPMConstants extends IDispatch{
    ...
    get_PermSOMGPOCreate(pVal) {
        result := ComCall(18, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchPropertyGPOWMIFilter(pVal) {
        result := ComCall(24, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchPropertyGPOID(pVal) {
        result := ComCall(25, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchPropertyGPOComputerExtensions(pVal) {
        result := ComCall(26, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchPropertyGPOUserExtensions(pVal) {
        result := ComCall(27, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchOpNotContains(pVal) {
        result := ComCall(33, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SearchOpNotEquals(pVal) {
        result := ComCall(34, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_UsePDC(pVal) {
        result := ComCall(35, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_UseAnyDC(pVal) {
        result := ComCall(36, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_SOMSite(pVal) {
        result := ComCall(38, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_SOMDomain(pVal) {
        result := ComCall(39, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_SOMOU(pVal) {
        result := ComCall(40, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_SecurityFlags(vbOwner, vbGroup, vbDACL, vbSACL, pVal) {
        result := ComCall(41, this, "short", vbOwner, "short", vbGroup, "short", vbDACL, "short", vbSACL, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_DoNotValidateDC(pVal) {
        result := ComCall(42, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_ReportXML(pVal) {
        result := ComCall(44, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_RSOPModeUnknown(pVal) {
        result := ComCall(45, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_RSOPModePlanning(pVal) {
        result := ComCall(46, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_RSOPModeLogging(pVal) {
        result := ComCall(47, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_EntryTypeLocalGroup(pVal) {
        result := ComCall(50, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_EntryTypeGlobalGroup(pVal) {
        result := ComCall(51, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_EntryTypeUniversalGroup(pVal) {
        result := ComCall(52, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_EntryTypeUnknown(pVal) {
        result := ComCall(54, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_DestinationOptionSameAsSource(pVal) {
        result := ComCall(55, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_DestinationOptionNone(pVal) {
        result := ComCall(56, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_DestinationOptionByRelativeName(pVal) {
        result := ComCall(57, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_DestinationOptionSet(pVal) {
        result := ComCall(58, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_MigrationTableOnly(pVal) {
        result := ComCall(59, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_ProcessSecurity(pVal) {
        result := ComCall(60, this, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_RsopPlanningLoopbackOption(vbMerge, pVal) {
        result := ComCall(64, this, "short", vbMerge, "int*", pVal, "int")
        if(result != 0)
            throw OSError(result)
