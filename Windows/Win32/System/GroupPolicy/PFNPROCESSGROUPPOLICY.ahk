 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/userenv/nc-userenv-pfnprocessgrouppolicy
 * @namespace Windows.Win32.System.GroupPolicy
 * @version v4.0.30319
 */
class PFNPROCESSGROUPPOLICY extends IUnknown {
     ...
     */
    Invoke(dwFlags, hToken, hKeyRoot, pDeletedGPOList, pChangedGPOList, pHandle, pbAbort, pStatusCallback) {
        ...
        result := ComCall(3, this, "uint", dwFlags, "ptr", hToken, "ptr", hKeyRoot, "ptr", pDeletedGPOList, "ptr", pChangedGPOList, "ptr", pHandle, pbAbortMarshal, pbAbort, "ptr", pStatusCallback, "uint")
        return result
    }
}
