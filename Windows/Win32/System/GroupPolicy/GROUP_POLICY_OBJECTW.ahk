 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/userenv/ns-userenv-group_policy_objectw
    ...
    lParam2{
        get {
            if(!this.HasProp("__lParam2"))
                this.__lParam2 := LPARAM(168, this)
