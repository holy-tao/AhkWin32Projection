 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpmsom
...
class IGPMSOM extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsom-creategpolink
     */
    CreateGPOLink(lLinkPos, pGPO) {
        result := ComCall(11, this, "int", lLinkPos, "ptr", pGPO, "ptr*", &ppNewGPOLink := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsom-getgpolinks
     */
    GetGPOLinks() {
        result := ComCall(13, this, "ptr*", &ppGPOLinks := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IGPMGPOLinksCollection} Address of a pointer to an 
     * <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/gpmgmt/nn-gpmgmt-igpmgpolinkscollection">IGPMGPOLinksCollection</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsom-getinheritedgpolinks
     */
    GetInheritedGPOLinks() {
        result := ComCall(14, this, "ptr*", &ppGPOLinks := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsom-getsecurityinfo
     */
    GetSecurityInfo() {
        result := ComCall(15, this, "ptr*", &ppSecurityInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <h3>VB</h3>
     * Returns <b>S_OK</b> if successful. Returns a failure code if an error occurs.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmsom-setsecurityinfo
     */
