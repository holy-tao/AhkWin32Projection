 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpmasyncprogress
...
class IGPMAsyncProgress extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmasyncprogress-status
     */
    Status(lProgressNumerator, lProgressDenominator, hrStatus, pResult, ppIGPMStatusMsgCollection) {
        result := ComCall(7, this, "int", lProgressNumerator, "int", lProgressDenominator, "int", hrStatus, "ptr", pResult, "ptr", ppIGPMStatusMsgCollection, "int")
        if(result != 0) {
