 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpmbackup
...
class IGPMBackup extends IDispatch{
     ...
     * <h3>VB</h3>
     * Returns <b>S_OK</b> if successful. Returns a failure code if an error occurs.
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmbackup-delete
     */
    Delete() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmbackup-generatereport
     */
    GenerateReport(gpmReportType_, pvarGPMProgress, pvarGPMCancel) {
        result := ComCall(15, this, "int", gpmReportType_, "ptr", pvarGPMProgress, "ptr", pvarGPMCancel, "ptr*", &ppIGPMResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmbackup-generatereporttofile
     */
    GenerateReportToFile(gpmReportType_, bstrTargetFilePath) {
        ...
        result := ComCall(16, this, "int", gpmReportType_, "ptr", bstrTargetFilePath, "ptr*", &ppIGPMResult := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
