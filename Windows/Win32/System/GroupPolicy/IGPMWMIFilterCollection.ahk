 ...
 */
export default struct IGPMWMIFilterCollection extends IDispatch {
    /**
     ...
     * used for IGPMWMIFilterCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IGPMWMIFilterCollection.Vtbl()
        }
    ...
    Query(iid) {
        if (IGPMWMIFilterCollection.IID.Equals(iid)) {
            return true
        }
