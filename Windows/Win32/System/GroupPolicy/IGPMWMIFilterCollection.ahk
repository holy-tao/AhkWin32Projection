 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpmwmifiltercollection
...
class IGPMWMIFilterCollection extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmwmifiltercollection-get_count
     */
    get_Count() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmwmifiltercollection-get_item
     */
    get_Item(lIndex) {
        pVal := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpmwmifiltercollection-get__newenum
     */
    get__NewEnum() {
