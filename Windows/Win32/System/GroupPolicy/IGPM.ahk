...
class IGPM extends IDispatch{
    ...
    GetDomain(bstrDomain, bstrDomainController, lDCFlags, pIGPMDomain) {
        ...
        result := ComCall(7, this, "ptr", bstrDomain, "ptr", bstrDomainController, "int", lDCFlags, "ptr", pIGPMDomain, "int")
        if(result != 0)
    ...
    GetBackupDir(bstrBackupDir, pIGPMBackupDir) {
        ...
        result := ComCall(8, this, "ptr", bstrBackupDir, "ptr", pIGPMBackupDir, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSitesContainer(bstrForest, bstrDomain, bstrDomainController, lDCFlags, ppIGPMSitesContainer) {
        ...
        result := ComCall(9, this, "ptr", bstrForest, "ptr", bstrDomain, "ptr", bstrDomainController, "int", lDCFlags, "ptr", ppIGPMSitesContainer, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetRSOP(gpmRSoPMode, bstrNamespace, lFlags, ppIGPMRSOP) {
        ...
        result := ComCall(10, this, "int", gpmRSoPMode, "ptr", bstrNamespace, "int", lFlags, "ptr", ppIGPMRSOP, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreatePermission(bstrTrustee, perm, bInheritable, ppPerm) {
        ...
        result := ComCall(11, this, "ptr", bstrTrustee, "int", perm, "short", bInheritable, "ptr", ppPerm, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSearchCriteria(ppIGPMSearchCriteria) {
        result := ComCall(12, this, "ptr", ppIGPMSearchCriteria, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateTrustee(bstrTrustee, ppIGPMTrustee) {
        ...
        result := ComCall(13, this, "ptr", bstrTrustee, "ptr", ppIGPMTrustee, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetClientSideExtensions(ppIGPMCSECollection) {
        result := ComCall(14, this, "ptr", ppIGPMCSECollection, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetConstants(ppIGPMConstants) {
        result := ComCall(15, this, "ptr", ppIGPMConstants, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetMigrationTable(bstrMigrationTablePath, ppMigrationTable) {
        ...
        result := ComCall(16, this, "ptr", bstrMigrationTablePath, "ptr", ppMigrationTable, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateMigrationTable(ppMigrationTable) {
        result := ComCall(17, this, "ptr", ppMigrationTable, "int")
        if(result != 0)
            throw OSError(result)
