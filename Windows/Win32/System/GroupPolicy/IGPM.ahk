 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nn-gpmgmt-igpm
...
class IGPM extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getdomain
     */
    GetDomain(bstrDomain, bstrDomainController, lDCFlags) {
        ...
        if(bstrDomainController is String) {
            pin := BSTR.Alloc(bstrDomainController)
            bstrDomainController := pin.Value
        }

        result := ComCall(7, this, "ptr", bstrDomain, "ptr", bstrDomainController, "int", lDCFlags, "ptr*", &pIGPMDomain := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getbackupdir
     */
    GetBackupDir(bstrBackupDir) {
        ...
        result := ComCall(8, this, "ptr", bstrBackupDir, "ptr*", &pIGPMBackupDir := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getsitescontainer
     */
    GetSitesContainer(bstrForest, bstrDomain, bstrDomainController, lDCFlags) {
        if(bstrForest is String) {
            pin := BSTR.Alloc(bstrForest)
            bstrForest := pin.Value
        }
        if(bstrDomain is String) {
            pin := BSTR.Alloc(bstrDomain)
            bstrDomain := pin.Value
        ...
        result := ComCall(9, this, "ptr", bstrForest, "ptr", bstrDomain, "ptr", bstrDomainController, "int", lDCFlags, "ptr*", &ppIGPMSitesContainer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} gpmRSoPMode_ Required. Mode in which to open the object. The following modes are supported.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getrsop
     */
    GetRSOP(gpmRSoPMode_, bstrNamespace, lFlags) {
        if(bstrNamespace is String) {
            pin := BSTR.Alloc(bstrNamespace)
            bstrNamespace := pin.Value
        }

        result := ComCall(10, this, "int", gpmRSoPMode_, "ptr", bstrNamespace, "int", lFlags, "ptr*", &ppIGPMRSOP := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-createpermission
     */
    CreatePermission(bstrTrustee, perm, bInheritable) {
        ...
        result := ComCall(11, this, "ptr", bstrTrustee, "int", perm, "short", bInheritable, "ptr*", &ppPerm := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-createsearchcriteria
     */
    CreateSearchCriteria() {
        result := ComCall(12, this, "ptr*", &ppIGPMSearchCriteria := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-createtrustee
     */
    CreateTrustee(bstrTrustee) {
        ...
        result := ComCall(13, this, "ptr", bstrTrustee, "ptr*", &ppIGPMTrustee := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getclientsideextensions
     */
    GetClientSideExtensions() {
        result := ComCall(14, this, "ptr*", &ppIGPMCSECollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getconstants
     */
    GetConstants() {
        result := ComCall(15, this, "ptr*", &ppIGPMConstants := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-getmigrationtable
     */
    GetMigrationTable(bstrMigrationTablePath) {
        ...
        result := ComCall(16, this, "ptr", bstrMigrationTablePath, "ptr*", &ppMigrationTable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-createmigrationtable
     */
    CreateMigrationTable() {
        result := ComCall(17, this, "ptr*", &ppMigrationTable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/gpmgmt/nf-gpmgmt-igpm-initializereporting
     */
    InitializeReporting(bstrAdmPath) {
        if(bstrAdmPath is String) {
            pin := BSTR.Alloc(bstrAdmPath)
            bstrAdmPath := pin.Value
        }

        result := ComCall(18, this, "ptr", bstrAdmPath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
