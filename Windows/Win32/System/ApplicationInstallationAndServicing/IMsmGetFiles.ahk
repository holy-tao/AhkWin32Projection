 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mergemod/nn-mergemod-imsmgetfiles
...
class IMsmGetFiles extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mergemod/nf-mergemod-imsmgetfiles-get_modulefiles
     */
    get_ModuleFiles() {
        result := ComCall(7, this, "ptr*", &Files := 0, "int")
        if(result != 0) {
