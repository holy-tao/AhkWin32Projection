 ...
 */
export default struct IPMApplicationInfoEnumerator extends IUnknown {
    /**
     ...
     * used for IPMApplicationInfoEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPMApplicationInfoEnumerator.Vtbl()
        }
