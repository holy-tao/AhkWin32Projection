 ...
 */
export default struct IEnumMsmString extends IUnknown {
    /**
     ...
     * used for IEnumMsmString interfaces
    */
     ...
     */
    Clone() {
        result := ComCall(6, this, "ptr*", &pemsmStrings := 0, "HRESULT")
