 ...
 */
export default struct IMsmStrings extends IDispatch {
    /**
     ...
     * used for IMsmStrings interfaces
    */
    ...
    get_Item(Item, _Return) {
        result := ComCall(7, this, Int32, Item, BSTR.Ptr, _Return, "HRESULT")
        return result
    }
