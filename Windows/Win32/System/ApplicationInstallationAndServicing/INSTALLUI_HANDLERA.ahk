 ...
 * @see https://learn.microsoft.com/windows/win32/api/msi/nc-msi-installui_handlera
 * @namespace Windows.Win32.System.ApplicationInstallationAndServicing
 * @charset ANSI
 */
export default struct INSTALLUI_HANDLERA {
    value : IntPtr

    __value {
        set {
            if (value is INSTALLUI_HANDLERA) {
     ...
     * @param {PSTR} szMessage Specifies the message text.
    ...
    /**
     * A INSTALLUI_HANDLERA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends INSTALLUI_HANDLERA {
        /**
         * Creates a INSTALLUI_HANDLERA pointer that invokes the given AHK function when called.
         * @param {Func("ptr", UInt32, PSTR) => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
