 ...
 */
export default struct IPMTileInfoEnumerator extends IUnknown {
    /**
     ...
     * used for IPMTileInfoEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPMTileInfoEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IPMTileInfoEnumerator.IID.Equals(iid)) {
            return true
        }
