 ...
 */
export default struct IMsmDependencies extends IDispatch {
    /**
     ...
     * used for IMsmDependencies interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMsmDependencies.Vtbl()
        }
    ...
    Query(iid) {
        if (IMsmDependencies.IID.Equals(iid)) {
            return true
        }
