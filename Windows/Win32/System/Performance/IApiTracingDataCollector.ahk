...
export default struct IApiTracingDataCollector extends IDataCollector {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_LogApiNamesOnly := CallbackCreate(ObjBindMethod(implObj, "get_LogApiNamesOnly"), flags, 2)
        this.vtbl.put_LogApiNamesOnly := CallbackCreate(ObjBindMethod(implObj, "put_LogApiNamesOnly"), flags, 2)
        this.vtbl.get_LogApisRecursively := CallbackCreate(ObjBindMethod(implObj, "get_LogApisRecursively"), flags, 2)
        this.vtbl.put_LogApisRecursively := CallbackCreate(ObjBindMethod(implObj, "put_LogApisRecursively"), flags, 2)
        this.vtbl.get_ExePath := CallbackCreate(ObjBindMethod(implObj, "get_ExePath"), flags, 2)
        this.vtbl.put_ExePath := CallbackCreate(ObjBindMethod(implObj, "put_ExePath"), flags, 2)
        this.vtbl.get_LogFilePath := CallbackCreate(ObjBindMethod(implObj, "get_LogFilePath"), flags, 2)
        this.vtbl.put_LogFilePath := CallbackCreate(ObjBindMethod(implObj, "put_LogFilePath"), flags, 2)
        this.vtbl.get_IncludeModules := CallbackCreate(ObjBindMethod(implObj, "get_IncludeModules"), flags, 2)
        this.vtbl.put_IncludeModules := CallbackCreate(ObjBindMethod(implObj, "put_IncludeModules"), flags, 2)
        this.vtbl.get_IncludeApis := CallbackCreate(ObjBindMethod(implObj, "get_IncludeApis"), flags, 2)
        this.vtbl.put_IncludeApis := CallbackCreate(ObjBindMethod(implObj, "put_IncludeApis"), flags, 2)
        this.vtbl.get_ExcludeApis := CallbackCreate(ObjBindMethod(implObj, "get_ExcludeApis"), flags, 2)
        this.vtbl.put_ExcludeApis := CallbackCreate(ObjBindMethod(implObj, "put_ExcludeApis"), flags, 2)
    }
