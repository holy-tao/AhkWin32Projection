...
class PerfRegInfoType extends Win32Enum {
     ...
     * Native name: PERF_REG_COUNTERSET_STRUCT
     * @type {Integer (Int32)}
     */
    static COUNTERSET_STRUCT => 1
     ...
     * Native name: PERF_REG_COUNTER_STRUCT
     * @type {Integer (Int32)}
     */
    static COUNTER_STRUCT => 2
     ...
     * Native name: PERF_REG_COUNTERSET_NAME_STRING
     * @type {Integer (Int32)}
     */
    static COUNTERSET_NAME_STRING => 3

    /**
     * Gets a null-terminated UTF16-LE string that contains the help string for the counter set.  
     * 
     *         Use the <i>requestLangId</i> parameter of the <a href="https://docs.microsoft.com/windows/desktop/api/perflib/nf-perflib-perfquerycountersetregistrationinfo">PerfQueryCounterSetRegistrationInfo</a> function to specify the preferred locale of the result.
     * Native name: PERF_REG_COUNTERSET_HELP_STRING
     * @type {Integer (Int32)}
     */
    static COUNTERSET_HELP_STRING => 4
     ...
     * 
     *         Use the <i>requestLangId</i> parameter of the <a href="https://docs.microsoft.com/windows/desktop/api/perflib/nf-perflib-perfquerycountersetregistrationinfo">PerfQueryCounterSetRegistrationInfo</a> function to specify the preferred locale of the result.
     * Native name: PERF_REG_COUNTER_NAME_STRINGS
     * @type {Integer (Int32)}
     */
    static COUNTER_NAME_STRINGS => 5
     ...
     * 
     *         Use the <i>requestLangId</i> parameter of the <a href="https://docs.microsoft.com/windows/desktop/api/perflib/nf-perflib-perfquerycountersetregistrationinfo">PerfQueryCounterSetRegistrationInfo</a> function to specify the preferred locale of the result.
     * Native name: PERF_REG_COUNTER_HELP_STRINGS
     * @type {Integer (Int32)}
     */
    static COUNTER_HELP_STRINGS => 6

    /**
     * Gets a null-terminated UTF-16LE string that indicates the name of the provider for the counter set.
     * Native name: PERF_REG_PROVIDER_NAME
     * @type {Integer (Int32)}
     */
    static PROVIDER_NAME => 7

    /**
     * Gets the GUID of the provider for the counter set.
     * Native name: PERF_REG_PROVIDER_GUID
     * @type {Integer (Int32)}
     */
    static PROVIDER_GUID => 8
     ...
     * Native name: PERF_REG_COUNTERSET_ENGLISH_NAME
     * @type {Integer (Int32)}
     */
    static COUNTERSET_ENGLISH_NAME => 9
     ...
     * Native name: PERF_REG_COUNTER_ENGLISH_NAMES
     * @type {Integer (Int32)}
     */
    static COUNTER_ENGLISH_NAMES => 10
}
