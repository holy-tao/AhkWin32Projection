 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-ischedule
...
class ISchedule extends IDispatch{
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-get_startdate
     */
    get_StartDate() {
        start := VARIANT()
     ...
     * @param {VARIANT} start 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-put_startdate
     */
    put_StartDate(start) {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-get_enddate
     */
    get_EndDate() {
        end := VARIANT()
     ...
     * @param {VARIANT} end 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-put_enddate
     */
    put_EndDate(end) {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-get_starttime
     */
    get_StartTime() {
        start := VARIANT()
     ...
     * @param {VARIANT} start 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-put_starttime
     */
    put_StartTime(start) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-get_days
     */
    get_Days() {
        result := ComCall(13, this, "int*", &days := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} days 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ischedule-put_days
     */
    put_Days(days) {
