...
export default struct IConfigurationDataCollector extends IDataCollector {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_FileMaxCount := CallbackCreate(ObjBindMethod(implObj, "get_FileMaxCount"), flags, 2)
        this.vtbl.put_FileMaxCount := CallbackCreate(ObjBindMethod(implObj, "put_FileMaxCount"), flags, 2)
        this.vtbl.get_FileMaxRecursiveDepth := CallbackCreate(ObjBindMethod(implObj, "get_FileMaxRecursiveDepth"), flags, 2)
        this.vtbl.put_FileMaxRecursiveDepth := CallbackCreate(ObjBindMethod(implObj, "put_FileMaxRecursiveDepth"), flags, 2)
        this.vtbl.get_FileMaxTotalSize := CallbackCreate(ObjBindMethod(implObj, "get_FileMaxTotalSize"), flags, 2)
        this.vtbl.put_FileMaxTotalSize := CallbackCreate(ObjBindMethod(implObj, "put_FileMaxTotalSize"), flags, 2)
        this.vtbl.get_Files := CallbackCreate(ObjBindMethod(implObj, "get_Files"), flags, 2)
        this.vtbl.put_Files := CallbackCreate(ObjBindMethod(implObj, "put_Files"), flags, 2)
        this.vtbl.get_ManagementQueries := CallbackCreate(ObjBindMethod(implObj, "get_ManagementQueries"), flags, 2)
        this.vtbl.put_ManagementQueries := CallbackCreate(ObjBindMethod(implObj, "put_ManagementQueries"), flags, 2)
        this.vtbl.get_QueryNetworkAdapters := CallbackCreate(ObjBindMethod(implObj, "get_QueryNetworkAdapters"), flags, 2)
        this.vtbl.put_QueryNetworkAdapters := CallbackCreate(ObjBindMethod(implObj, "put_QueryNetworkAdapters"), flags, 2)
        this.vtbl.get_RegistryKeys := CallbackCreate(ObjBindMethod(implObj, "get_RegistryKeys"), flags, 2)
        this.vtbl.put_RegistryKeys := CallbackCreate(ObjBindMethod(implObj, "put_RegistryKeys"), flags, 2)
        this.vtbl.get_RegistryMaxRecursiveDepth := CallbackCreate(ObjBindMethod(implObj, "get_RegistryMaxRecursiveDepth"), flags, 2)
        this.vtbl.put_RegistryMaxRecursiveDepth := CallbackCreate(ObjBindMethod(implObj, "put_RegistryMaxRecursiveDepth"), flags, 2)
        this.vtbl.get_SystemStateFile := CallbackCreate(ObjBindMethod(implObj, "get_SystemStateFile"), flags, 2)
        this.vtbl.put_SystemStateFile := CallbackCreate(ObjBindMethod(implObj, "put_SystemStateFile"), flags, 2)
    }
