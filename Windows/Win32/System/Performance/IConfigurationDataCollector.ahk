 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-iconfigurationdatacollector
...
class IConfigurationDataCollector extends IDataCollector{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_filemaxcount
     */
    get_FileMaxCount() {
        result := ComCall(32, this, "uint*", &count := 0, "int")
        if(result != 0) {
     ...
     * @param {Integer} count 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_filemaxcount
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_filemaxrecursivedepth
     */
    get_FileMaxRecursiveDepth() {
        result := ComCall(34, this, "uint*", &depth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} depth 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_filemaxrecursivedepth
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_filemaxtotalsize
     */
    get_FileMaxTotalSize() {
        result := ComCall(36, this, "uint*", &size_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} size_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_filemaxtotalsize
     */
    put_FileMaxTotalSize(size_) {
        result := ComCall(37, this, "uint", size_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_files
     */
    get_Files() {
        result := ComCall(38, this, "ptr*", &Files := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_files
     */
    put_Files(Files) {
     ...
     * @returns {Pointer<SAFEARRAY>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_managementqueries
     */
    get_ManagementQueries() {
        result := ComCall(40, this, "ptr*", &Queries := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_managementqueries
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_querynetworkadapters
     */
    get_QueryNetworkAdapters() {
        result := ComCall(42, this, "short*", &network := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_querynetworkadapters
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_registrykeys
     */
    get_RegistryKeys() {
        result := ComCall(44, this, "ptr*", &query := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_registrykeys
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_registrymaxrecursivedepth
     */
    get_RegistryMaxRecursiveDepth() {
        result := ComCall(46, this, "uint*", &depth := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} depth 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_registrymaxrecursivedepth
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-get_systemstatefile
     */
    get_SystemStateFile() {
        FileName := BSTR()
     ...
     * @param {BSTR} FileName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-iconfigurationdatacollector-put_systemstatefile
     */
