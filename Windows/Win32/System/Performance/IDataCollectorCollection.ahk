 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-idatacollectorcollection
...
class IDataCollectorCollection extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-get_item
     */
    get_Item(index) {
        result := ComCall(8, this, "ptr", index, "ptr*", &collector := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-get__newenum
     */
    get__NewEnum() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-add
     */
    Add(collector) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-remove
     */
    Remove(collector) {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-clear
     */
    Clear() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-addrange
     */
    AddRange(collectors) {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-createdatacollectorfromxml
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatacollectorcollection-createdatacollector
     */
    CreateDataCollector(Type) {
        result := ComCall(15, this, "int", Type, "ptr*", &Collector := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
