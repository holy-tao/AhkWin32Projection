 ...
 */
export default struct DISystemMonitorInternal extends IDispatch {
    /**
     ...
     * used for DISystemMonitorInternal interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := DISystemMonitorInternal.Vtbl()
        }
        super.__New(implObj, flags)
    }

    Query(iid) {
        if (DISystemMonitorInternal.IID.Equals(iid)) {
            return true
        }
