...
export default struct IDataManager extends IDispatch {
    ...
    */
    ...
    put_MinFreeDisk(MinFreeDisk) {
        result := ComCall(12, this, UInt32, MinFreeDisk, "HRESULT")
        return result
    }
    ...
    put_MaxSize(ulMaxSize) {
        result := ComCall(14, this, UInt32, ulMaxSize, "HRESULT")
        return result
    }
    ...
    put_MaxFolderCount(ulMaxFolderCount) {
        result := ComCall(16, this, UInt32, ulMaxFolderCount, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CheckBeforeRunning := CallbackCreate(ObjBindMethod(implObj, "get_CheckBeforeRunning"), flags, 2)
        this.vtbl.put_CheckBeforeRunning := CallbackCreate(ObjBindMethod(implObj, "put_CheckBeforeRunning"), flags, 2)
        this.vtbl.get_MinFreeDisk := CallbackCreate(ObjBindMethod(implObj, "get_MinFreeDisk"), flags, 2)
        this.vtbl.put_MinFreeDisk := CallbackCreate(ObjBindMethod(implObj, "put_MinFreeDisk"), flags, 2)
        this.vtbl.get_MaxSize := CallbackCreate(ObjBindMethod(implObj, "get_MaxSize"), flags, 2)
        this.vtbl.put_MaxSize := CallbackCreate(ObjBindMethod(implObj, "put_MaxSize"), flags, 2)
        this.vtbl.get_MaxFolderCount := CallbackCreate(ObjBindMethod(implObj, "get_MaxFolderCount"), flags, 2)
        this.vtbl.put_MaxFolderCount := CallbackCreate(ObjBindMethod(implObj, "put_MaxFolderCount"), flags, 2)
        this.vtbl.get_ResourcePolicy := CallbackCreate(ObjBindMethod(implObj, "get_ResourcePolicy"), flags, 2)
        this.vtbl.put_ResourcePolicy := CallbackCreate(ObjBindMethod(implObj, "put_ResourcePolicy"), flags, 2)
        this.vtbl.get_FolderActions := CallbackCreate(ObjBindMethod(implObj, "get_FolderActions"), flags, 2)
        this.vtbl.get_ReportSchema := CallbackCreate(ObjBindMethod(implObj, "get_ReportSchema"), flags, 2)
        this.vtbl.put_ReportSchema := CallbackCreate(ObjBindMethod(implObj, "put_ReportSchema"), flags, 2)
        this.vtbl.get_ReportFileName := CallbackCreate(ObjBindMethod(implObj, "get_ReportFileName"), flags, 2)
        this.vtbl.put_ReportFileName := CallbackCreate(ObjBindMethod(implObj, "put_ReportFileName"), flags, 2)
        this.vtbl.get_RuleTargetFileName := CallbackCreate(ObjBindMethod(implObj, "get_RuleTargetFileName"), flags, 2)
        this.vtbl.put_RuleTargetFileName := CallbackCreate(ObjBindMethod(implObj, "put_RuleTargetFileName"), flags, 2)
        this.vtbl.get_EventsFileName := CallbackCreate(ObjBindMethod(implObj, "get_EventsFileName"), flags, 2)
        this.vtbl.put_EventsFileName := CallbackCreate(ObjBindMethod(implObj, "put_EventsFileName"), flags, 2)
        ...
        this.vtbl.Run := CallbackCreate(ObjBindMethod(implObj, "Run"), flags, 4)
        this.vtbl.Extract := CallbackCreate(ObjBindMethod(implObj, "Extract"), flags, 3)
    }
