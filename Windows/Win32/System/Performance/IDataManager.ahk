 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-idatamanager
...
class IDataManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_enabled
     */
    get_Enabled() {
        result := ComCall(7, this, "short*", &pfEnabled := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_enabled
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_checkbeforerunning
     */
    get_CheckBeforeRunning() {
        result := ComCall(9, this, "short*", &pfCheck := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_checkbeforerunning
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_minfreedisk
     */
    get_MinFreeDisk() {
        result := ComCall(11, this, "uint*", &MinFreeDisk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_minfreedisk
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_maxsize
     */
    get_MaxSize() {
        result := ComCall(13, this, "uint*", &pulMaxSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_maxsize
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_maxfoldercount
     */
    get_MaxFolderCount() {
        result := ComCall(15, this, "uint*", &pulMaxFolderCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_maxfoldercount
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_resourcepolicy
     */
    get_ResourcePolicy() {
        result := ComCall(17, this, "int*", &pPolicy := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_resourcepolicy
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_folderactions
     */
    get_FolderActions() {
        result := ComCall(19, this, "ptr*", &Actions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_reportschema
     */
    get_ReportSchema() {
        ReportSchema := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_reportschema
     */
    put_ReportSchema(ReportSchema) {
        if(ReportSchema is String) {
            pin := BSTR.Alloc(ReportSchema)
            ReportSchema := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_reportfilename
     */
    get_ReportFileName() {
        pbstrFilename := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_reportfilename
     */
    put_ReportFileName(pbstrFilename) {
        if(pbstrFilename is String) {
            pin := BSTR.Alloc(pbstrFilename)
            pbstrFilename := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_ruletargetfilename
     */
     ...
     * @param {BSTR} Filename 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_ruletargetfilename
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_eventsfilename
     */
    get_EventsFileName() {
        pbstrFilename := BSTR()
     ...
     * @param {BSTR} pbstrFilename 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_eventsfilename
     */
     ...
     * ```
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-get_rules
     */
    get_Rules() {
        pbstrXml := BSTR()
     ...
     * @param {BSTR} bstrXml 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-put_rules
     */
    put_Rules(bstrXml) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-run
     */
    Run(Steps, bstrFolder) {
        ...
        result := ComCall(30, this, "int", Steps, "ptr", bstrFolder, "ptr*", &Errors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-idatamanager-extract
     */
    Extract(CabFilename, DestinationPath) {
        if(CabFilename is String) {
            pin := BSTR.Alloc(CabFilename)
            CabFilename := pin.Value
        }
        if(DestinationPath is String) {
            pin := BSTR.Alloc(DestinationPath)
            DestinationPath := pin.Value
        }
