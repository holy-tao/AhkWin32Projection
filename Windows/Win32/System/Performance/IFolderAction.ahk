 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-ifolderaction
...
class IFolderAction extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-get_age
     */
    get_Age() {
        result := ComCall(7, this, "uint*", &pulAge := 0, "int")
        if(result != 0) {
     ...
     * @param {Integer} ulAge 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-put_age
     */
    put_Age(ulAge) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-get_size
     */
    get_Size() {
        result := ComCall(9, this, "uint*", &pulAge := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} ulAge 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-put_size
     */
    put_Size(ulAge) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-get_actions
     */
    get_Actions() {
        result := ComCall(11, this, "int*", &Steps := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Steps 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-put_actions
     */
    put_Actions(Steps) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-get_sendcabto
     */
    get_SendCabTo() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ifolderaction-put_sendcabto
     */
