 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-itracedataprovider
...
class ITraceDataProvider extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_displayname
     */
    get_DisplayName() {
        name := BSTR()
     ...
     * @param {BSTR} name 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-put_displayname
     */
     ...
     * @returns {Guid} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_guid
     */
    get_Guid() {
        guid := Guid()
     ...
     * @param {Guid} guid 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-put_guid
     */
    put_Guid(guid) {
     ...
     * @returns {IValueMap} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_level
     */
    get_Level() {
        result := ComCall(11, this, "ptr*", &ppLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IValueMap} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_keywordsany
     */
    get_KeywordsAny() {
        result := ComCall(12, this, "ptr*", &ppKeywords := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IValueMap} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_keywordsall
     */
    get_KeywordsAll() {
        result := ComCall(13, this, "ptr*", &ppKeywords := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IValueMap} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_properties
     */
    get_Properties() {
        result := ComCall(14, this, "ptr*", &ppProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_filterenabled
     */
    get_FilterEnabled() {
        result := ComCall(15, this, "short*", &FilterEnabled := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-put_filterenabled
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_filtertype
     */
    get_FilterType() {
        result := ComCall(17, this, "uint*", &pulType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-put_filtertype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-get_filterdata
     */
    get_FilterData() {
        result := ComCall(19, this, "ptr*", &ppData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-put_filterdata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-query
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-resolve
     */
    Resolve(pFrom) {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-setsecurity
     */
    SetSecurity(Sddl) {
        if(Sddl is String) {
            pin := BSTR.Alloc(Sddl)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-getsecurity
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-itracedataprovider-getregisteredprocesses
     */
    GetRegisteredProcesses() {
        result := ComCall(25, this, "ptr*", &Processes := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
