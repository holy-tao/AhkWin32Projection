...
export default struct IAlertDataCollector extends IDataCollector {
    ...
    */
    ...
    put_SampleInterval(_interval) {
        result := ComCall(37, this, UInt32, _interval, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AlertThresholds := CallbackCreate(ObjBindMethod(implObj, "get_AlertThresholds"), flags, 2)
        this.vtbl.put_AlertThresholds := CallbackCreate(ObjBindMethod(implObj, "put_AlertThresholds"), flags, 2)
        this.vtbl.get_EventLog := CallbackCreate(ObjBindMethod(implObj, "get_EventLog"), flags, 2)
        this.vtbl.put_EventLog := CallbackCreate(ObjBindMethod(implObj, "put_EventLog"), flags, 2)
        ...
        this.vtbl.get_TriggerDataCollectorSet := CallbackCreate(ObjBindMethod(implObj, "get_TriggerDataCollectorSet"), flags, 2)
        this.vtbl.put_TriggerDataCollectorSet := CallbackCreate(ObjBindMethod(implObj, "put_TriggerDataCollectorSet"), flags, 2)
    }
