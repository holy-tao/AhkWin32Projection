 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/pla/nn-pla-ivaluemap
...
class IValueMap extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get_item
     */
    get_Item(index) {
        result := ComCall(8, this, "ptr", index, "ptr*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get__newenum
     */
    get__NewEnum() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get_description
     */
    get_Description() {
        description := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-put_description
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get_value
     */
    get_Value() {
        Value := VARIANT()
     ...
     * @param {VARIANT} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-put_value
     */
    put_Value(Value) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-get_valuemaptype
     */
    get_ValueMapType() {
     ...
     * @param {Integer} type 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-put_valuemaptype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-add
     */
    Add(value) {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-remove
     */
    Remove(value) {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-clear
     */
    Clear() {
     ...
     * @returns {HRESULT} Returns S_OK if successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-addrange
     */
    AddRange(map) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/pla/nf-pla-ivaluemap-createvaluemapitem
     */
    CreateValueMapItem() {
