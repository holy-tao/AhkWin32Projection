...
export default struct IDataCollectorSet extends IDispatch {
    ...
    */
    ...
    Query(name, server) {
        ...
        result := ComCall(59, this, BSTR, name, serverMarshal, server, "HRESULT")
        return result
    }
    ...
    Commit(name, server, _mode) {
        ...
        result := ComCall(60, this, BSTR, name, serverMarshal, server, CommitMode, _mode, "ptr*", &validation := 0, "HRESULT")
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_DataCollectors := CallbackCreate(ObjBindMethod(implObj, "get_DataCollectors"), flags, 2)
        ...
        this.vtbl.get_DescriptionUnresolved := CallbackCreate(ObjBindMethod(implObj, "get_DescriptionUnresolved"), flags, 2)
        ...
        this.vtbl.get_DisplayNameUnresolved := CallbackCreate(ObjBindMethod(implObj, "get_DisplayNameUnresolved"), flags, 2)
        this.vtbl.get_Keywords := CallbackCreate(ObjBindMethod(implObj, "get_Keywords"), flags, 2)
        this.vtbl.put_Keywords := CallbackCreate(ObjBindMethod(implObj, "put_Keywords"), flags, 2)
        ...
        this.vtbl.get_RootPath := CallbackCreate(ObjBindMethod(implObj, "get_RootPath"), flags, 2)
        this.vtbl.put_RootPath := CallbackCreate(ObjBindMethod(implObj, "put_RootPath"), flags, 2)
        this.vtbl.get_Segment := CallbackCreate(ObjBindMethod(implObj, "get_Segment"), flags, 2)
        this.vtbl.put_Segment := CallbackCreate(ObjBindMethod(implObj, "put_Segment"), flags, 2)
        this.vtbl.get_SegmentMaxDuration := CallbackCreate(ObjBindMethod(implObj, "get_SegmentMaxDuration"), flags, 2)
        this.vtbl.put_SegmentMaxDuration := CallbackCreate(ObjBindMethod(implObj, "put_SegmentMaxDuration"), flags, 2)
        this.vtbl.get_SegmentMaxSize := CallbackCreate(ObjBindMethod(implObj, "get_SegmentMaxSize"), flags, 2)
        this.vtbl.put_SegmentMaxSize := CallbackCreate(ObjBindMethod(implObj, "put_SegmentMaxSize"), flags, 2)
        this.vtbl.get_SerialNumber := CallbackCreate(ObjBindMethod(implObj, "get_SerialNumber"), flags, 2)
        this.vtbl.put_SerialNumber := CallbackCreate(ObjBindMethod(implObj, "put_SerialNumber"), flags, 2)
        ...
        this.vtbl.get_Subdirectory := CallbackCreate(ObjBindMethod(implObj, "get_Subdirectory"), flags, 2)
        this.vtbl.put_Subdirectory := CallbackCreate(ObjBindMethod(implObj, "put_Subdirectory"), flags, 2)
        this.vtbl.get_SubdirectoryFormat := CallbackCreate(ObjBindMethod(implObj, "get_SubdirectoryFormat"), flags, 2)
        this.vtbl.put_SubdirectoryFormat := CallbackCreate(ObjBindMethod(implObj, "put_SubdirectoryFormat"), flags, 2)
        this.vtbl.get_SubdirectoryFormatPattern := CallbackCreate(ObjBindMethod(implObj, "get_SubdirectoryFormatPattern"), flags, 2)
        this.vtbl.put_SubdirectoryFormatPattern := CallbackCreate(ObjBindMethod(implObj, "put_SubdirectoryFormatPattern"), flags, 2)
        ...
        this.vtbl.get_TaskRunAsSelf := CallbackCreate(ObjBindMethod(implObj, "get_TaskRunAsSelf"), flags, 2)
        this.vtbl.put_TaskRunAsSelf := CallbackCreate(ObjBindMethod(implObj, "put_TaskRunAsSelf"), flags, 2)
        this.vtbl.get_TaskArguments := CallbackCreate(ObjBindMethod(implObj, "get_TaskArguments"), flags, 2)
        this.vtbl.put_TaskArguments := CallbackCreate(ObjBindMethod(implObj, "put_TaskArguments"), flags, 2)
        this.vtbl.get_TaskUserTextArguments := CallbackCreate(ObjBindMethod(implObj, "get_TaskUserTextArguments"), flags, 2)
        this.vtbl.put_TaskUserTextArguments := CallbackCreate(ObjBindMethod(implObj, "put_TaskUserTextArguments"), flags, 2)
        this.vtbl.get_Schedules := CallbackCreate(ObjBindMethod(implObj, "get_Schedules"), flags, 2)
        this.vtbl.get_SchedulesEnabled := CallbackCreate(ObjBindMethod(implObj, "get_SchedulesEnabled"), flags, 2)
        this.vtbl.put_SchedulesEnabled := CallbackCreate(ObjBindMethod(implObj, "put_SchedulesEnabled"), flags, 2)
        ...
        this.vtbl.get_StopOnCompletion := CallbackCreate(ObjBindMethod(implObj, "get_StopOnCompletion"), flags, 2)
        this.vtbl.put_StopOnCompletion := CallbackCreate(ObjBindMethod(implObj, "put_StopOnCompletion"), flags, 2)
        this.vtbl.get_DataManager := CallbackCreate(ObjBindMethod(implObj, "get_DataManager"), flags, 2)
