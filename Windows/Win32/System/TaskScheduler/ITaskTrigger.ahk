 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nn-mstask-itasktrigger
...
class ITaskTrigger extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itasktrigger-settrigger
     */
    SetTrigger(pTrigger) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itasktrigger-gettrigger
     */
    GetTrigger() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itasktrigger-gettriggerstring
     */
    GetTriggerString() {
        result := ComCall(5, this, "ptr*", &ppwszTrigger := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
