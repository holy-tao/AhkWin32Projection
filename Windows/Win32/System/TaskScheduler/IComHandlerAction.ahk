 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-icomhandleraction
...
class IComHandlerAction extends IAction{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-icomhandleraction-get_classid
     */
    get_ClassId(pClsid) {
     ...
     * @param {BSTR} clsid 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-icomhandleraction-put_classid
     */
    put_ClassId(clsid) {
        if(clsid is String) {
            pin := BSTR.Alloc(clsid)
            clsid := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-icomhandleraction-get_data
     */
    get_Data(pData) {
     ...
     * @param {BSTR} data 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-icomhandleraction-put_data
     */
    put_Data(data) {
        if(data is String) {
            pin := BSTR.Alloc(data)
