 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-imaintenancesettings
...
class IMaintenanceSettings extends IDispatch{
     ...
     * @param {BSTR} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-put_period
     */
    put_Period(value) {
        if(value is String) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-get_period
     */
    get_Period(target) {
     ...
     * @param {BSTR} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-put_deadline
     */
    put_Deadline(value) {
        if(value is String) {
            pin := BSTR.Alloc(value)
     ...
     * @param {Pointer<BSTR>} target 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-get_deadline
     */
    get_Deadline(target) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-put_exclusive
     */
    put_Exclusive(value) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imaintenancesettings-get_exclusive
     */
    get_Exclusive(target) {
        targetMarshal := target is VarRef ? "short*" : "ptr"

        result := ComCall(12, this, targetMarshal, target, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
