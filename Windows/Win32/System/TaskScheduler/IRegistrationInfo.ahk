...
export default struct IRegistrationInfo extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_Author := CallbackCreate(ObjBindMethod(implObj, "put_Author"), flags, 2)
        ...
        this.vtbl.put_Date := CallbackCreate(ObjBindMethod(implObj, "put_Date"), flags, 2)
        this.vtbl.get_Documentation := CallbackCreate(ObjBindMethod(implObj, "get_Documentation"), flags, 2)
        this.vtbl.put_Documentation := CallbackCreate(ObjBindMethod(implObj, "put_Documentation"), flags, 2)
        ...
        this.vtbl.get_URI := CallbackCreate(ObjBindMethod(implObj, "get_URI"), flags, 2)
        this.vtbl.put_URI := CallbackCreate(ObjBindMethod(implObj, "put_URI"), flags, 2)
