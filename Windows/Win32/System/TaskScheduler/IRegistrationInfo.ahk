 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iregistrationinfo
...
class IRegistrationInfo extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_description
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_description
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_author
     */
    get_Author(pAuthor) {
     ...
     * @param {BSTR} author 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_author
     */
    put_Author(author) {
        if(author is String) {
            pin := BSTR.Alloc(author)
            author := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_version
     */
     ...
     * @param {BSTR} version_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_version
     */
    put_Version(version_) {
        ...
        result := ComCall(12, this, "ptr", version_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_date
     */
    get_Date(pDate) {
     ...
     * @param {BSTR} date 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_date
     */
    put_Date(date) {
        if(date is String) {
            pin := BSTR.Alloc(date)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_documentation
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_documentation
     */
    put_Documentation(documentation) {
        if(documentation is String) {
            pin := BSTR.Alloc(documentation)
            documentation := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_xmltext
     */
    get_XmlText(pText) {
     ...
     * @param {BSTR} text 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_xmltext
     */
    put_XmlText(text) {
        if(text is String) {
            pin := BSTR.Alloc(text)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_uri
     */
    get_URI(pUri) {
     ...
     * @param {BSTR} uri 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_uri
     */
    put_URI(uri) {
        if(uri is String) {
            pin := BSTR.Alloc(uri)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_securitydescriptor
     */
     ...
     * @param {VARIANT} sddl 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_securitydescriptor
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-get_source
     */
    get_Source(pSource) {
     ...
     * @param {BSTR} source 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationinfo-put_source
     */
    put_Source(source) {
        if(source is String) {
            pin := BSTR.Alloc(source)
            source := pin.Value
        }
