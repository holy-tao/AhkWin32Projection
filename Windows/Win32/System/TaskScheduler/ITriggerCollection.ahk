 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-itriggercollection
...
class ITriggerCollection extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-get_count
     */
    get_Count(pCount) {
     ...
     * @param {Integer} index 
     * @returns {ITrigger} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-get_item
     */
    get_Item(index) {
        result := ComCall(8, this, "int", index, "ptr*", &ppTrigger := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-create
     */
    Create(type) {
        result := ComCall(10, this, "int", type, "ptr*", &ppTrigger := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-remove
     */
    Remove(index) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itriggercollection-clear
     */
    Clear() {
