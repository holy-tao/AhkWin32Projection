 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-irunningtask
...
class IRunningTask extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_name
     */
    get_Name() {
        pName := BSTR()
     ...
     * The <a href="https://docs.microsoft.com/windows/desktop/api/taskschd/nf-taskschd-irunningtask-refresh">IRunningTask::Refresh</a> method is called before the property value is returned.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_instanceguid
     */
    get_InstanceGuid() {
        pGuid := BSTR()
     ...
     * The <a href="https://docs.microsoft.com/windows/desktop/api/taskschd/nf-taskschd-irunningtask-refresh">IRunningTask::Refresh</a> method is called before the property value is returned.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_path
     */
    get_Path() {
        pPath := BSTR()
     ...
     * The <a href="https://docs.microsoft.com/windows/desktop/api/taskschd/nf-taskschd-irunningtask-refresh">IRunningTask::Refresh</a> method is called before the property value is returned.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_state
     */
    get_State() {
     ...
     * The <a href="https://docs.microsoft.com/windows/desktop/api/taskschd/nf-taskschd-irunningtask-refresh">IRunningTask::Refresh</a> method is called before the property value is returned.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_currentaction
     */
    get_CurrentAction() {
        pName := BSTR()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-stop
     */
    Stop() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-refresh
     */
    Refresh() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-irunningtask-get_enginepid
     */
    get_EnginePID() {
        result := ComCall(14, this, "uint*", &pPID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
