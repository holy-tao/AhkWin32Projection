 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iprincipal
...
class IPrincipal extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_id
     */
    get_Id(pId) {
     ...
     * @param {BSTR} Id 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_id
     */
    put_Id(Id) {
        if(Id is String) {
            pin := BSTR.Alloc(Id)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_displayname
     */
     ...
     * @param {BSTR} name 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_displayname
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_userid
     */
    get_UserId(pUser) {
     ...
     * @param {BSTR} user 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_userid
     */
    put_UserId(user) {
        if(user is String) {
            pin := BSTR.Alloc(user)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_logontype
     */
    get_LogonType(pLogon) {
        pLogonMarshal := pLogon is VarRef ? "int*" : "ptr"

        result := ComCall(13, this, pLogonMarshal, pLogon, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} logon 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_logontype
     */
    put_LogonType(logon) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_groupid
     */
    get_GroupId(pGroup) {
     ...
     * @param {BSTR} group 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_groupid
     */
    put_GroupId(group) {
        if(group is String) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-get_runlevel
     */
    get_RunLevel(pRunLevel) {
        pRunLevelMarshal := pRunLevel is VarRef ? "int*" : "ptr"

        result := ComCall(17, this, pRunLevelMarshal, pRunLevel, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal-put_runlevel
     */
