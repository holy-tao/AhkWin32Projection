 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iidlesettings
...
class IIdleSettings extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-get_idleduration
     */
     ...
     * @param {BSTR} delay 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-put_idleduration
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-get_waittimeout
     */
     ...
     * @param {BSTR} timeout 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-put_waittimeout
     */
    put_WaitTimeout(timeout) {
        if(timeout is String) {
            pin := BSTR.Alloc(timeout)
            timeout := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-get_stoponidleend
     */
    get_StopOnIdleEnd(pStop) {
        pStopMarshal := pStop is VarRef ? "short*" : "ptr"

        result := ComCall(11, this, pStopMarshal, pStop, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-put_stoponidleend
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-get_restartonidle
     */
    get_RestartOnIdle(pRestart) {
        pRestartMarshal := pRestart is VarRef ? "short*" : "ptr"

        result := ComCall(13, this, pRestartMarshal, pRestart, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iidlesettings-put_restartonidle
     */
