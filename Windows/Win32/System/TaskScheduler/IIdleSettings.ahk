...
class IIdleSettings extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-get_idleduration
     */
     ...
     * @param {BSTR} delay 
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-put_idleduration
     */
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-get_waittimeout
     */
     ...
     * @param {BSTR} timeout 
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-put_waittimeout
     */
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-get_stoponidleend
     */
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-put_stoponidleend
     */
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-get_restartonidle
     */
     ...
     * @returns {HRESULT} 
     * @see https://docs.microsoft.com/windows/win32/api//taskschd/nf-taskschd-iidlesettings-put_restartonidle
     */
