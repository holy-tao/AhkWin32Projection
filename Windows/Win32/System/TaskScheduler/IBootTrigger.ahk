 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iboottrigger
...
class IBootTrigger extends ITrigger{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iboottrigger-get_delay
     */
    get_Delay(pDelay) {
     ...
     * @param {BSTR} delay 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iboottrigger-put_delay
     */
    put_Delay(delay) {
        if(delay is String) {
