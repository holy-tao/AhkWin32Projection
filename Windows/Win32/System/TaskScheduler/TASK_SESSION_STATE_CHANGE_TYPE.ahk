 ...
 * @see https://learn.microsoft.com/windows/win32/api/taskschd/ne-taskschd-task_session_state_change_type
...
class TASK_SESSION_STATE_CHANGE_TYPE extends Win32Enum {
     ...
     * Native name: TASK_CONSOLE_CONNECT
     * @type {Integer (Int32)}
     */
    static CONSOLE_CONNECT => 1
     ...
     * Native name: TASK_CONSOLE_DISCONNECT
     * @type {Integer (Int32)}
     */
    static CONSOLE_DISCONNECT => 2
     ...
     * Native name: TASK_REMOTE_CONNECT
     * @type {Integer (Int32)}
     */
    static REMOTE_CONNECT => 3
     ...
     * Native name: TASK_REMOTE_DISCONNECT
     * @type {Integer (Int32)}
     */
    static REMOTE_DISCONNECT => 4
     ...
     * Native name: TASK_SESSION_UNLOCK
     * @type {Integer (Int32)}
     */
    static UNLOCK => 8
}
