...
class ITimeTrigger extends ITrigger{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itimetrigger-get_randomdelay
     */
    get_RandomDelay(pRandomDelay) {
        result := ComCall(20, this, "ptr", pRandomDelay, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itimetrigger-put_randomdelay
     */
    put_RandomDelay(randomDelay) {
        ...
        result := ComCall(21, this, "ptr", randomDelay, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
