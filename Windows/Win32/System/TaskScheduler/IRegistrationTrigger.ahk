 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iregistrationtrigger
...
class IRegistrationTrigger extends ITrigger{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationtrigger-get_delay
     */
    get_Delay(pDelay) {
     ...
     * @param {BSTR} delay 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iregistrationtrigger-put_delay
     */
    put_Delay(delay) {
        if(delay is String) {
