 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nn-mstask-itaskscheduler
...
class ITaskScheduler extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-settargetcomputer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-gettargetcomputer
     */
    GetTargetComputer() {
        result := ComCall(4, this, "ptr*", &ppwszComputer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-enum
     */
    Enum() {
        result := ComCall(5, this, "ptr*", &ppEnumWorkItems := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-activate
     */
    Activate(pwszName, riid) {
        pwszName := pwszName is String ? StrPtr(pwszName) : pwszName

        result := ComCall(6, this, "ptr", pwszName, "ptr", riid, "ptr*", &ppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-delete
     */
    Delete(pwszName) {
        pwszName := pwszName is String ? StrPtr(pwszName) : pwszName
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-newworkitem
     */
    NewWorkItem(pwszTaskName, rclsid, riid) {
        pwszTaskName := pwszTaskName is String ? StrPtr(pwszTaskName) : pwszTaskName

        result := ComCall(8, this, "ptr", pwszTaskName, "ptr", rclsid, "ptr", riid, "ptr*", &ppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-addworkitem
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-itaskscheduler-isoftype
     */
