 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-imonthlytrigger
...
class IMonthlyTrigger extends ITrigger{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-get_daysofmonth
     */
     ...
     * @param {Integer} days 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-put_daysofmonth
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-get_monthsofyear
     */
    get_MonthsOfYear(pMonths) {
        pMonthsMarshal := pMonths is VarRef ? "short*" : "ptr"

        result := ComCall(22, this, pMonthsMarshal, pMonths, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-put_monthsofyear
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-get_runonlastdayofmonth
     */
    get_RunOnLastDayOfMonth(pLastDay) {
        pLastDayMarshal := pLastDay is VarRef ? "short*" : "ptr"

        result := ComCall(24, this, pLastDayMarshal, pLastDay, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-put_runonlastdayofmonth
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-get_randomdelay
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-imonthlytrigger-put_randomdelay
     */
