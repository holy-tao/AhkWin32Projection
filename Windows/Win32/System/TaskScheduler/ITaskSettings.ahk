 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-itasksettings
...
class ITaskSettings extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_allowdemandstart
     */
    get_AllowDemandStart(pAllowDemandStart) {
        pAllowDemandStartMarshal := pAllowDemandStart is VarRef ? "short*" : "ptr"

        result := ComCall(7, this, pAllowDemandStartMarshal, pAllowDemandStart, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_allowdemandstart
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_restartinterval
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_restartinterval
     */
    put_RestartInterval(restartInterval) {
        if(restartInterval is String) {
            pin := BSTR.Alloc(restartInterval)
            restartInterval := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_restartcount
     */
    get_RestartCount(pRestartCount) {
        pRestartCountMarshal := pRestartCount is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, pRestartCountMarshal, pRestartCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_restartcount
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_multipleinstances
     */
    get_MultipleInstances(pPolicy) {
        pPolicyMarshal := pPolicy is VarRef ? "int*" : "ptr"

        result := ComCall(13, this, pPolicyMarshal, pPolicy, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_multipleinstances
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_stopifgoingonbatteries
     */
    get_StopIfGoingOnBatteries(pStopIfOnBatteries) {
        pStopIfOnBatteriesMarshal := pStopIfOnBatteries is VarRef ? "short*" : "ptr"

        result := ComCall(15, this, pStopIfOnBatteriesMarshal, pStopIfOnBatteries, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_stopifgoingonbatteries
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_disallowstartifonbatteries
     */
    get_DisallowStartIfOnBatteries(pDisallowStart) {
        pDisallowStartMarshal := pDisallowStart is VarRef ? "short*" : "ptr"

        result := ComCall(17, this, pDisallowStartMarshal, pDisallowStart, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_disallowstartifonbatteries
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_allowhardterminate
     */
    get_AllowHardTerminate(pAllowHardTerminate) {
        pAllowHardTerminateMarshal := pAllowHardTerminate is VarRef ? "short*" : "ptr"

        result := ComCall(19, this, pAllowHardTerminateMarshal, pAllowHardTerminate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_allowhardterminate
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_startwhenavailable
     */
    get_StartWhenAvailable(pStartWhenAvailable) {
        pStartWhenAvailableMarshal := pStartWhenAvailable is VarRef ? "short*" : "ptr"

        result := ComCall(21, this, pStartWhenAvailableMarshal, pStartWhenAvailable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_startwhenavailable
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_xmltext
     */
    get_XmlText(pText) {
     ...
     * @param {BSTR} text 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_xmltext
     */
    put_XmlText(text) {
        if(text is String) {
            pin := BSTR.Alloc(text)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_runonlyifnetworkavailable
     */
    get_RunOnlyIfNetworkAvailable(pRunOnlyIfNetworkAvailable) {
        ...
        result := ComCall(25, this, pRunOnlyIfNetworkAvailableMarshal, pRunOnlyIfNetworkAvailable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_runonlyifnetworkavailable
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_executiontimelimit
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_executiontimelimit
     */
    put_ExecutionTimeLimit(executionTimeLimit) {
        if(executionTimeLimit is String) {
            pin := BSTR.Alloc(executionTimeLimit)
            executionTimeLimit := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_enabled
     */
    get_Enabled(pEnabled) {
        pEnabledMarshal := pEnabled is VarRef ? "short*" : "ptr"

        result := ComCall(29, this, pEnabledMarshal, pEnabled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_deleteexpiredtaskafter
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_deleteexpiredtaskafter
     */
    put_DeleteExpiredTaskAfter(expirationDelay) {
        if(expirationDelay is String) {
            pin := BSTR.Alloc(expirationDelay)
            expirationDelay := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_priority
     */
    get_Priority(pPriority) {
        pPriorityMarshal := pPriority is VarRef ? "int*" : "ptr"

        result := ComCall(33, this, pPriorityMarshal, pPriority, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_priority
     */
    put_Priority(priority_) {
        result := ComCall(34, this, "int", priority_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_compatibility
     */
    get_Compatibility(pCompatLevel) {
        pCompatLevelMarshal := pCompatLevel is VarRef ? "int*" : "ptr"

        result := ComCall(35, this, pCompatLevelMarshal, pCompatLevel, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_compatibility
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_hidden
     */
    get_Hidden(pHidden) {
        pHiddenMarshal := pHidden is VarRef ? "short*" : "ptr"

        result := ComCall(37, this, pHiddenMarshal, pHidden, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_hidden
     */
    put_Hidden(hidden) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_idlesettings
     */
    get_IdleSettings() {
        result := ComCall(39, this, "ptr*", &ppIdleSettings := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_idlesettings
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_runonlyifidle
     */
    get_RunOnlyIfIdle(pRunOnlyIfIdle) {
        pRunOnlyIfIdleMarshal := pRunOnlyIfIdle is VarRef ? "short*" : "ptr"

        result := ComCall(41, this, pRunOnlyIfIdleMarshal, pRunOnlyIfIdle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_runonlyifidle
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_waketorun
     */
    get_WakeToRun(pWake) {
        pWakeMarshal := pWake is VarRef ? "short*" : "ptr"

        result := ComCall(43, this, pWakeMarshal, pWake, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_waketorun
     */
    put_WakeToRun(wake) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-get_networksettings
     */
    get_NetworkSettings() {
        result := ComCall(45, this, "ptr*", &ppNetworkSettings := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-itasksettings-put_networksettings
     */
