 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iactioncollection
...
class IActionCollection extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-get_count
     */
    get_Count(pCount) {
     ...
     * @param {Integer} index 
     * @returns {IAction} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-get_item
     */
    get_Item(index) {
        result := ComCall(8, this, "int", index, "ptr*", &ppAction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-get__newenum
     */
    get__NewEnum() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-get_xmltext
     */
    get_XmlText(pText) {
     ...
     * @param {BSTR} text 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-put_xmltext
     */
    put_XmlText(text) {
        if(text is String) {
            pin := BSTR.Alloc(text)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-create
     */
    Create(type) {
        result := ComCall(12, this, "int", type, "ptr*", &ppAction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-remove
     */
    Remove(index) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-clear
     */
    Clear() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-get_context
     */
     ...
     * @param {BSTR} context_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iactioncollection-put_context
     */
    put_Context(context_) {
        if(context_ is String) {
            pin := BSTR.Alloc(context_)
            context_ := pin.Value
        }

        result := ComCall(16, this, "ptr", context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
