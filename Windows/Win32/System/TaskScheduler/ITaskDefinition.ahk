...
export default struct ITaskDefinition extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_RegistrationInfo := CallbackCreate(ObjBindMethod(implObj, "get_RegistrationInfo"), flags, 2)
        this.vtbl.put_RegistrationInfo := CallbackCreate(ObjBindMethod(implObj, "put_RegistrationInfo"), flags, 2)
        this.vtbl.get_Triggers := CallbackCreate(ObjBindMethod(implObj, "get_Triggers"), flags, 2)
        this.vtbl.put_Triggers := CallbackCreate(ObjBindMethod(implObj, "put_Triggers"), flags, 2)
        this.vtbl.get_Settings := CallbackCreate(ObjBindMethod(implObj, "get_Settings"), flags, 2)
        this.vtbl.put_Settings := CallbackCreate(ObjBindMethod(implObj, "put_Settings"), flags, 2)
        ...
        this.vtbl.get_Principal := CallbackCreate(ObjBindMethod(implObj, "get_Principal"), flags, 2)
        this.vtbl.put_Principal := CallbackCreate(ObjBindMethod(implObj, "put_Principal"), flags, 2)
