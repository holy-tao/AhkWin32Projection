 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nn-mstask-iprovidetaskpage
...
class IProvideTaskPage extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mstask/nf-mstask-iprovidetaskpage-getpage
     */
    GetPage(tpType, fPersistChanges) {
        phPage := HPROPSHEETPAGE()
        result := ComCall(3, this, "int", tpType, "int", fPersistChanges, "ptr", phPage, "int")
        if(result != 0) {
