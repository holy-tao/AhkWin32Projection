 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nn-taskschd-iprincipal2
...
class IPrincipal2 extends IDispatch{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal2-get_processtokensidtype
     */
    get_ProcessTokenSidType(pProcessTokenSidType) {
        pProcessTokenSidTypeMarshal := pProcessTokenSidType is VarRef ? "int*" : "ptr"

        result := ComCall(7, this, pProcessTokenSidTypeMarshal, pProcessTokenSidType, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal2-put_processtokensidtype
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal2-get_requiredprivilegecount
     */
    get_RequiredPrivilegeCount(pCount) {
        pCountMarshal := pCount is VarRef ? "int*" : "ptr"

        result := ComCall(9, this, pCountMarshal, pCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal2-get_requiredprivilege
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/taskschd/nf-taskschd-iprincipal2-addrequiredprivilege
     */
    AddRequiredPrivilege(privilege) {
        if(privilege is String) {
            pin := BSTR.Alloc(privilege)
            privilege := pin.Value
        }
