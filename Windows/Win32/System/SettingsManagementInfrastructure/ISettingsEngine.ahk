 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nn-wcmconfig-isettingsengine
...
class ISettingsEngine extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-getnamespaces
     */
    GetNamespaces(Flags, Reserved) {
        ReservedMarshal := Reserved is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "int", Flags, ReservedMarshal, Reserved, "ptr*", &Namespaces := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-getnamespace
     */
    GetNamespace(SettingsID, Access, Reserved) {
        ReservedMarshal := Reserved is VarRef ? "ptr" : "ptr"

        result := ComCall(4, this, "ptr", SettingsID, "int", Access, ReservedMarshal, Reserved, "ptr*", &NamespaceItem := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} HResult_ The HRESULT code for which this method retrieves the error description.
     * @returns {BSTR} The text message that corresponds to the HRESULT code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-geterrordescription
     */
    GetErrorDescription(HResult_) {
        Message := BSTR()
        result := ComCall(5, this, "int", HResult_, "ptr", Message, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-createsettingsidentity
     */
    CreateSettingsIdentity() {
        result := ComCall(6, this, "ptr*", &SettingsID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Void>} Reserved Reserved. Must be <b>NULL</b>.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-getstorestatus
     */
    GetStoreStatus(Reserved) {
        ReservedMarshal := Reserved is VarRef ? "ptr" : "ptr"

        result := ComCall(7, this, ReservedMarshal, Reserved, "int*", &Status_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-loadstore
     */
    LoadStore(Flags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-unloadstore
     */
    UnloadStore(Reserved) {
        ReservedMarshal := Reserved is VarRef ? "ptr" : "ptr"

        result := ComCall(9, this, ReservedMarshal, Reserved, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-registernamespace
     */
     ...
     * @returns {HRESULT} This method returns an HRESULT value. <b>S_OK</b> indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-unregisternamespace
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-createtargetinfo
     */
    CreateTargetInfo() {
        result := ComCall(12, this, "ptr*", &Target := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-gettargetinfo
     */
    GetTargetInfo() {
        result := ComCall(13, this, "ptr*", &Target := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns an HRESULT value. <b>S_OK</b> indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-settargetinfo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-createsettingscontext
     */
    CreateSettingsContext(Flags, Reserved) {
        ReservedMarshal := Reserved is VarRef ? "ptr" : "ptr"

        result := ComCall(15, this, "uint", Flags, ReservedMarshal, Reserved, "ptr*", &SettingsContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wcmconfig/nf-wcmconfig-isettingsengine-applysettingscontext
     */
    ApplySettingsContext(SettingsContext, pppwzIdentities) {
        pppwzIdentitiesMarshal := pppwzIdentities is VarRef ? "ptr*" : "ptr"

        result := ComCall(17, this, "ptr", SettingsContext, pppwzIdentitiesMarshal, pppwzIdentities, "ptr*", &pcIdentities := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetSettingsContext() {
        result := ComCall(18, this, "ptr*", &SettingsContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
