...
#Include .\HCN_NOTIFICATION_CALLBACK.ahk
...
;@region Methods
    ...
    static HcnCreateNetwork(Id, Settings, Network, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnCreateNetwork", "ptr", Id, "ptr", Settings, NetworkMarshal, Network, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnOpenNetwork(Id, Network, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnOpenNetwork", "ptr", Id, NetworkMarshal, Network, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnModifyNetwork(Network, Settings) {
        ...
        result := DllCall("computenetwork.dll\HcnModifyNetwork", NetworkMarshal, Network, "ptr", Settings, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnDeleteNetwork(Id) {
        result := DllCall("computenetwork.dll\HcnDeleteNetwork", "ptr", Id, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnCreateNamespace(Id, Settings, Namespace, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnCreateNamespace", "ptr", Id, "ptr", Settings, NamespaceMarshal, Namespace, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnOpenNamespace(Id, Namespace, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnOpenNamespace", "ptr", Id, NamespaceMarshal, Namespace, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnModifyNamespace(Namespace, Settings) {
        ...
        result := DllCall("computenetwork.dll\HcnModifyNamespace", NamespaceMarshal, Namespace, "ptr", Settings, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnDeleteNamespace(Id) {
        result := DllCall("computenetwork.dll\HcnDeleteNamespace", "ptr", Id, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnCreateEndpoint(Network, Id, Settings, Endpoint, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnCreateEndpoint", NetworkMarshal, Network, "ptr", Id, "ptr", Settings, EndpointMarshal, Endpoint, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnOpenEndpoint(Id, Endpoint, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnOpenEndpoint", "ptr", Id, EndpointMarshal, Endpoint, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnModifyEndpoint(Endpoint, Settings) {
        ...
        result := DllCall("computenetwork.dll\HcnModifyEndpoint", EndpointMarshal, Endpoint, "ptr", Settings, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnDeleteEndpoint(Id) {
        result := DllCall("computenetwork.dll\HcnDeleteEndpoint", "ptr", Id, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnCreateLoadBalancer(Id, Settings, LoadBalancer, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnCreateLoadBalancer", "ptr", Id, "ptr", Settings, LoadBalancerMarshal, LoadBalancer, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnOpenLoadBalancer(Id, LoadBalancer, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnOpenLoadBalancer", "ptr", Id, LoadBalancerMarshal, LoadBalancer, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnModifyLoadBalancer(LoadBalancer, Settings) {
        ...
        result := DllCall("computenetwork.dll\HcnModifyLoadBalancer", LoadBalancerMarshal, LoadBalancer, "ptr", Settings, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnDeleteLoadBalancer(Id) {
        result := DllCall("computenetwork.dll\HcnDeleteLoadBalancer", "ptr", Id, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnCreateGuestNetworkService(Id, Settings, GuestNetworkService, ErrorRecord) {
        ...
        result := DllCall("computenetwork.dll\HcnCreateGuestNetworkService", "ptr", Id, "ptr", Settings, GuestNetworkServiceMarshal, GuestNetworkService, ErrorRecordMarshal, ErrorRecord, "HRESULT")
        return result
    }
    ...
    static HcnModifyGuestNetworkService(GuestNetworkService, Settings) {
        ...
        result := DllCall("computenetwork.dll\HcnModifyGuestNetworkService", GuestNetworkServiceMarshal, GuestNetworkService, "ptr", Settings, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnDeleteGuestNetworkService(Id) {
        result := DllCall("computenetwork.dll\HcnDeleteGuestNetworkService", "ptr", Id, "ptr*", &ErrorRecord := 0, "HRESULT")
        return ErrorRecord
    }
    ...
    static HcnReleaseGuestNetworkServicePortReservationHandle(PortReservationHandle) {
        ...
        result := DllCall("computenetwork.dll\HcnReleaseGuestNetworkServicePortReservationHandle", "ptr", PortReservationHandle, "HRESULT")
        return result
    }
