 ...
 */
export default struct PWRSCHEMESENUMPROC_V1 {
    value : IntPtr

    __value {
        set {
            if (value is PWRSCHEMESENUMPROC_V1) {
    ...
    /**
     * A PWRSCHEMESENUMPROC_V1 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWRSCHEMESENUMPROC_V1 {
        /**
         * Creates a PWRSCHEMESENUMPROC_V1 pointer that invokes the given AHK function when called.
