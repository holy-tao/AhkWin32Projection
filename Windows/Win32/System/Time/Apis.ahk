 ...
 * @since windows5.1.2600
 */
export FileTimeToSystemTime(lpFileTime, lpSystemTime) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\FileTimeToSystemTime", FILETIME.Ptr, lpFileTime, SYSTEMTIME.Ptr, lpSystemTime, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export SystemTimeToFileTime(lpSystemTime, lpFileTime) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\SystemTimeToFileTime", SYSTEMTIME.Ptr, lpSystemTime, FILETIME.Ptr, lpFileTime, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export GetTimeZoneInformation(lpTimeZoneInformation) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\GetTimeZoneInformation", TIME_ZONE_INFORMATION.Ptr, lpTimeZoneInformation, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export SetTimeZoneInformation(lpTimeZoneInformation) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\SetTimeZoneInformation", TIME_ZONE_INFORMATION.Ptr, lpTimeZoneInformation, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export SetDynamicTimeZoneInformation(lpTimeZoneInformation) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\SetDynamicTimeZoneInformation", DYNAMIC_TIME_ZONE_INFORMATION.Ptr, lpTimeZoneInformation, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows6.0.6000
 */
export GetDynamicTimeZoneInformation(pTimeZoneInformation) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\GetDynamicTimeZoneInformation", DYNAMIC_TIME_ZONE_INFORMATION.Ptr, pTimeZoneInformation, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
