 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nn-rendezvoussession-irendezvoussession
...
class IRendezvousSession extends IUnknown{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nf-rendezvoussession-irendezvoussession-get_state
     */
    get_State() {
        result := ComCall(3, this, "int*", &pSessionState := 0, "int")
        if(result != 0) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nf-rendezvoussession-irendezvoussession-get_remoteuser
     */
    get_RemoteUser() {
        bstrUserName := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nf-rendezvoussession-irendezvoussession-get_flags
     */
    get_Flags() {
        result := ComCall(5, this, "int*", &pFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nf-rendezvoussession-irendezvoussession-sendcontextdata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rendezvoussession/nf-rendezvoussession-irendezvoussession-terminate
     */
    Terminate(hr, bstrAppData) {
        if(bstrAppData is String) {
            pin := BSTR.Alloc(bstrAppData)
            bstrAppData := pin.Value
        }
