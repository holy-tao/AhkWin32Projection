 ...
 * @since windows5.0
 */
export DdeSetQualityOfService(hwndClient, pqosNew, pqosPrev) {
    A_LastError := 0

    result := DllCall("USER32.dll\DdeSetQualityOfService", HWND, hwndClient, SECURITY_QUALITY_OF_SERVICE.Ptr, pqosNew, SECURITY_QUALITY_OF_SERVICE.Ptr, pqosPrev, BOOL)
 ...
 * @since windows5.0
 */
export ImpersonateDdeClientWindow(hWndClient, hWndServer) {
    A_LastError := 0

    result := DllCall("USER32.dll\ImpersonateDdeClientWindow", HWND, hWndClient, HWND, hWndServer, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export DdeQueryNextServer(_hConvList, hConvPrev) {
    result := DllCall("USER32.dll\DdeQueryNextServer", HCONVLIST, _hConvList, HCONV, hConvPrev, HCONV.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export DdeDisconnectList(_hConvList) {
    result := DllCall("USER32.dll\DdeDisconnectList", HCONVLIST, _hConvList, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DdeDisconnect(_hConv) {
    result := DllCall("USER32.dll\DdeDisconnect", HCONV, _hConv, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DdeReconnect(_hConv) {
    result := DllCall("USER32.dll\DdeReconnect", HCONV, _hConv, HCONV.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export DdeImpersonateClient(_hConv) {
    A_LastError := 0

    result := DllCall("USER32.dll\DdeImpersonateClient", HCONV, _hConv, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export DdeUnaccessData(hData) {
    result := DllCall("USER32.dll\DdeUnaccessData", HDDEDATA, hData, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DdeFreeDataHandle(hData) {
    result := DllCall("USER32.dll\DdeFreeDataHandle", HDDEDATA, hData, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DdeCmpStringHandles(hsz1, hsz2) {
    result := DllCall("USER32.dll\DdeCmpStringHandles", HSZ, hsz1, HSZ, hsz2, Int32)
    return result
}
...
export CloseClipboard() {
    ...
    result := DllCall("USER32.dll\CloseClipboard", BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export GetClipboardSequenceNumber() {
    result := DllCall("USER32.dll\GetClipboardSequenceNumber", UInt32)
    return result
}
...
export GetClipboardOwner() {
    ...
    result := DllCall("USER32.dll\GetClipboardOwner", HWND)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export SetClipboardViewer(hWndNewViewer) {
    A_LastError := 0

    result := DllCall("USER32.dll\SetClipboardViewer", HWND, hWndNewViewer, HWND)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export GetClipboardViewer() {
    ...
    result := DllCall("USER32.dll\GetClipboardViewer", HWND)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export ChangeClipboardChain(hWndRemove, hWndNewNext) {
    result := DllCall("USER32.dll\ChangeClipboardChain", HWND, hWndRemove, HWND, hWndNewNext, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RegisterClipboardFormatA(lpszFormat) {
    lpszFormat := lpszFormat is String ? StrPtr(lpszFormat) : lpszFormat

    A_LastError := 0

    result := DllCall("USER32.dll\RegisterClipboardFormatA", "ptr", lpszFormat, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export RegisterClipboardFormatW(lpszFormat) {
    lpszFormat := lpszFormat is String ? StrPtr(lpszFormat) : lpszFormat

    A_LastError := 0

    result := DllCall("USER32.dll\RegisterClipboardFormatW", "ptr", lpszFormat, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export CountClipboardFormats() {
    ...
    result := DllCall("USER32.dll\CountClipboardFormats", Int32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export GetClipboardFormatNameA(format, lpszFormatName, cchMaxCount) {
 ...
 * @since windows5.0
 */
export GetClipboardFormatNameW(format, lpszFormatName, cchMaxCount) {
    lpszFormatName := lpszFormatName is String ? StrPtr(lpszFormatName) : lpszFormatName
...
export EmptyClipboard() {
    ...
    result := DllCall("USER32.dll\EmptyClipboard", BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export GetOpenClipboardWindow() {
    ...
    result := DllCall("USER32.dll\GetOpenClipboardWindow", HWND)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export AddClipboardFormatListener(_hwnd) {
    A_LastError := 0

    result := DllCall("USER32.dll\AddClipboardFormatListener", HWND, _hwnd, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows6.0.6000
 */
export RemoveClipboardFormatListener(_hwnd) {
    A_LastError := 0

    result := DllCall("USER32.dll\RemoveClipboardFormatListener", HWND, _hwnd, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export GlobalGetAtomNameA(nAtom, lpBuffer, nSize) {
 ...
 * @since windows5.0
 */
export GlobalGetAtomNameW(nAtom, lpBuffer, nSize) {
    lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer
 ...
 * @since windows5.0
 */
export GetAtomNameA(nAtom, lpBuffer, nSize) {
    lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer
 ...
 * @since windows5.0
 */
export GetAtomNameW(nAtom, lpBuffer, nSize) {
    lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer
