 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iwscapi/nn-iwscapi-iwscproductlist
...
class IWSCProductList extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwscapi/nf-iwscapi-iwscproductlist-initialize
     */
    Initialize(provider) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwscapi/nf-iwscapi-iwscproductlist-get_count
     */
    get_Count() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iwscapi/nf-iwscapi-iwscproductlist-get_item
     */
    get_Item(index) {
        result := ComCall(9, this, "uint", index, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
