 ...
 */
export default struct VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD {
    value : IntPtr

    __value {
        set {
            if (value is VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD) {
    ...
    /**
     * A VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD {
        /**
         * Creates a VBS_BASIC_ENCLAVE_BASIC_CALL_TERMINATE_THREAD pointer that invokes the given AHK function when called.
