 ...
 */
export SetEnvironmentStringsW(NewEnvironment) {
    NewEnvironment := NewEnvironment is String ? StrPtr(NewEnvironment) : NewEnvironment

    result := DllCall("KERNEL32.dll\SetEnvironmentStringsW", "ptr", NewEnvironment, BOOL)
    return result
}
...
export GetCommandLineA() {
    result := DllCall("KERNEL32.dll\GetCommandLineA", PSTR)
    return result
}
...
export GetCommandLineW() {
    result := DllCall("KERNEL32.dll\GetCommandLineW", PWSTR)
    return result
}
...
export GetEnvironmentStrings() {
    result := DllCall("KERNEL32.dll\GetEnvironmentStrings", PSTR)
    return result
}
...
export GetEnvironmentStringsW() {
    result := DllCall("KERNEL32.dll\GetEnvironmentStringsW", PWSTR)
    return result
}
 ...
 * @since windows5.1.2600
 */
export FreeEnvironmentStringsA(penv) {
    penv := penv is String ? StrPtr(penv) : penv

    A_LastError := 0

    result := DllCall("KERNEL32.dll\FreeEnvironmentStringsA", "ptr", penv, BOOL)
 ...
 * @since windows5.1.2600
 */
export FreeEnvironmentStringsW(penv) {
    penv := penv is String ? StrPtr(penv) : penv

    A_LastError := 0

    result := DllCall("KERNEL32.dll\FreeEnvironmentStringsW", "ptr", penv, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export GetEnvironmentVariableA(lpName, lpBuffer, nSize) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer

    A_LastError := 0

    result := DllCall("KERNEL32.dll\GetEnvironmentVariableA", "ptr", lpName, "ptr", lpBuffer, "uint", nSize, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export GetEnvironmentVariableW(lpName, lpBuffer, nSize) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpBuffer := lpBuffer is String ? StrPtr(lpBuffer) : lpBuffer

    A_LastError := 0

    result := DllCall("KERNEL32.dll\GetEnvironmentVariableW", "ptr", lpName, "ptr", lpBuffer, "uint", nSize, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export SetEnvironmentVariableA(lpName, lpValue) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
 ...
 * @since windows5.1.2600
 */
export SetEnvironmentVariableW(lpName, lpValue) {
    lpName := lpName is String ? StrPtr(lpName) : lpName
    lpValue := lpValue is String ? StrPtr(lpValue) : lpValue
 ...
 * @since windows5.0
 */
export ExpandEnvironmentStringsA(lpSrc, lpDst, nSize) {
    lpSrc := lpSrc is String ? StrPtr(lpSrc) : lpSrc
    lpDst := lpDst is String ? StrPtr(lpDst) : lpDst

    A_LastError := 0

    result := DllCall("KERNEL32.dll\ExpandEnvironmentStringsA", "ptr", lpSrc, "ptr", lpDst, "uint", nSize, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export ExpandEnvironmentStringsW(lpSrc, lpDst, nSize) {
    lpSrc := lpSrc is String ? StrPtr(lpSrc) : lpSrc
    lpDst := lpDst is String ? StrPtr(lpDst) : lpDst

    A_LastError := 0

    result := DllCall("KERNEL32.dll\ExpandEnvironmentStringsW", "ptr", lpSrc, "ptr", lpDst, "uint", nSize, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export SetCurrentDirectoryA(lpPathName) {
    lpPathName := lpPathName is String ? StrPtr(lpPathName) : lpPathName

    result := DllCall("KERNEL32.dll\SetCurrentDirectoryA", "ptr", lpPathName, BOOL)
    return result
}
 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-setcurrentdirectory
 */
export SetCurrentDirectoryW(lpPathName) {
    lpPathName := lpPathName is String ? StrPtr(lpPathName) : lpPathName

    result := DllCall("KERNEL32.dll\SetCurrentDirectoryW", "ptr", lpPathName, BOOL)
    return result
}
...
export GetCurrentDirectoryA(nBufferLength, lpBuffer) {
    ...
    result := DllCall("KERNEL32.dll\GetCurrentDirectoryA", "uint", nBufferLength, "ptr", lpBuffer, UInt32)
    return result
}
...
export GetCurrentDirectoryW(nBufferLength, lpBuffer) {
    ...
    result := DllCall("KERNEL32.dll\GetCurrentDirectoryW", "uint", nBufferLength, "ptr", lpBuffer, UInt32)
    return result
}
 ...
 */
export NeedCurrentDirectoryForExePathA(ExeName) {
    ExeName := ExeName is String ? StrPtr(ExeName) : ExeName

    result := DllCall("KERNEL32.dll\NeedCurrentDirectoryForExePathA", "ptr", ExeName, BOOL)
    return result
}
 ...
 * @since windows6.0.6000
 */
export NeedCurrentDirectoryForExePathW(ExeName) {
    ExeName := ExeName is String ? StrPtr(ExeName) : ExeName

    result := DllCall("KERNEL32.dll\NeedCurrentDirectoryForExePathW", "ptr", ExeName, BOOL)
    return result
}
...
export DestroyEnvironmentBlock(lpEnvironment) {
    ...
    result := DllCall("USERENV.dll\DestroyEnvironmentBlock", lpEnvironmentMarshal, lpEnvironment, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export ExpandEnvironmentStringsForUserA(hToken, lpSrc, lpDest, dwSize) {
    lpSrc := lpSrc is String ? StrPtr(lpSrc) : lpSrc
    lpDest := lpDest is String ? StrPtr(lpDest) : lpDest

    A_LastError := 0

    result := DllCall("USERENV.dll\ExpandEnvironmentStringsForUserA", HANDLE, hToken, "ptr", lpSrc, "ptr", lpDest, "uint", dwSize, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export ExpandEnvironmentStringsForUserW(hToken, lpSrc, lpDest, dwSize) {
    lpSrc := lpSrc is String ? StrPtr(lpSrc) : lpSrc
    lpDest := lpDest is String ? StrPtr(lpDest) : lpDest

    A_LastError := 0

    result := DllCall("USERENV.dll\ExpandEnvironmentStringsForUserW", HANDLE, hToken, "ptr", lpSrc, "ptr", lpDest, "uint", dwSize, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 */
export IsEnclaveTypeSupported(flEnclaveType) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\IsEnclaveTypeSupported", "uint", flEnclaveType, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export CreateEnclave(hProcess, lpAddress, dwSize, dwInitialCommitment, flEnclaveType, lpEnclaveInformation, dwInfoLength, lpEnclaveError) {
    ...
    result := DllCall("KERNEL32.dll\CreateEnclave", HANDLE, hProcess, lpAddressMarshal, lpAddress, "ptr", dwSize, "ptr", dwInitialCommitment, "uint", flEnclaveType, "ptr", lpEnclaveInformation, "uint", dwInfoLength, lpEnclaveErrorMarshal, lpEnclaveError, IntPtr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export LoadEnclaveData(hProcess, lpAddress, lpBuffer, nSize, flProtect, lpPageInformation, dwInfoLength, lpNumberOfBytesWritten, lpEnclaveError) {
    ...
    result := DllCall("KERNEL32.dll\LoadEnclaveData", HANDLE, hProcess, lpAddressMarshal, lpAddress, "ptr", lpBuffer, "ptr", nSize, "uint", flProtect, "ptr", lpPageInformation, "uint", dwInfoLength, lpNumberOfBytesWrittenMarshal, lpNumberOfBytesWritten, lpEnclaveErrorMarshal, lpEnclaveError, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export InitializeEnclave(hProcess, lpAddress, lpEnclaveInformation, dwInfoLength, lpEnclaveError) {
    ...
    result := DllCall("KERNEL32.dll\InitializeEnclave", HANDLE, hProcess, lpAddressMarshal, lpAddress, "ptr", lpEnclaveInformation, "uint", dwInfoLength, lpEnclaveErrorMarshal, lpEnclaveError, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export LoadEnclaveImageW(lpEnclaveAddress, lpImageName) {
    ...
    result := DllCall("api-ms-win-core-enclave-l1-1-1.dll\LoadEnclaveImageW", lpEnclaveAddressMarshal, lpEnclaveAddress, "ptr", lpImageName, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export CallEnclave(lpRoutine, lpParameter, fWaitForThread, lpReturnValue) {
    ...
    result := DllCall("vertdll.dll\CallEnclave", "ptr", lpRoutine, lpParameterMarshal, lpParameter, BOOL, fWaitForThread, lpReturnValueMarshal, lpReturnValue, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export TerminateEnclave(lpAddress, fWait) {
    ...
    result := DllCall("vertdll.dll\TerminateEnclave", lpAddressMarshal, lpAddress, BOOL, fWait, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export DeleteEnclave(lpAddress) {
    ...
    result := DllCall("api-ms-win-core-enclave-l1-1-1.dll\DeleteEnclave", lpAddressMarshal, lpAddress, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
...
export EnclaveGetAttestationReport(EnclaveData, Report, BufferSize) {
    ...
    result := DllCall("vertdll.dll\EnclaveGetAttestationReport", EnclaveDataMarshal, EnclaveData, "ptr", Report, "uint", BufferSize, "uint*", &OutputSize := 0, "HRESULT")
    return OutputSize
}
 ...
 * @since windows10.0.16299
 */
export EnclaveVerifyAttestationReport(EnclaveType, Report, ReportSize) {
    result := DllCall("vertdll.dll\EnclaveVerifyAttestationReport", "uint", EnclaveType, "ptr", Report, "uint", ReportSize, "HRESULT")
    return result
}
...
export EnclaveSealData(DataToEncrypt, DataToEncryptSize, IdentityPolicy, RuntimePolicy, ProtectedBlob, BufferSize) {
    result := DllCall("vertdll.dll\EnclaveSealData", "ptr", DataToEncrypt, "uint", DataToEncryptSize, ENCLAVE_SEALING_IDENTITY_POLICY, IdentityPolicy, "uint", RuntimePolicy, "ptr", ProtectedBlob, "uint", BufferSize, "uint*", &ProtectedBlobSize := 0, "HRESULT")
...
export EnclaveUnsealData(ProtectedBlob, ProtectedBlobSize, DecryptedData, BufferSize, DecryptedDataSize, SealingIdentity, UnsealingFlags) {
    ...
    result := DllCall("vertdll.dll\EnclaveUnsealData", "ptr", ProtectedBlob, "uint", ProtectedBlobSize, "ptr", DecryptedData, "uint", BufferSize, DecryptedDataSizeMarshal, DecryptedDataSize, ENCLAVE_IDENTITY.Ptr, SealingIdentity, UnsealingFlagsMarshal, UnsealingFlags, "HRESULT")
    return result
}
...
export EnclaveEncryptDataForTrustlet(DataToEncrypt, DataToEncryptSize, TrustletBindingData, EncryptedData, BufferSize) {
    result := DllCall("vertdll.dll\EnclaveEncryptDataForTrustlet", "ptr", DataToEncrypt, "uint", DataToEncryptSize, TRUSTLET_BINDING_DATA.Ptr, TrustletBindingData, "ptr", EncryptedData, "uint", BufferSize, "uint*", &EncryptedDataSize := 0, "HRESULT")
 ...
 * @since windows10.0.16299
 */
export EnclaveGetEnclaveInformation(InformationSize, EnclaveInformation) {
    result := DllCall("vertdll.dll\EnclaveGetEnclaveInformation", "uint", InformationSize, "ptr", EnclaveInformation, "HRESULT")
    return result
}
...
export EnclaveUsesAttestedKeys() {
    result := DllCall("vertdll.dll\EnclaveUsesAttestedKeys", BOOLEAN)
    return result
}
 ...
 * @returns {BOOL} 
 */
export EnclaveRestrictContainingProcessAccess(RestrictAccess) {
    result := DllCall("vertdll.dll\EnclaveRestrictContainingProcessAccess", BOOL, RestrictAccess, BOOL.Ptr, &PreviouslyRestricted := 0, "HRESULT")
 ...
 * @returns {HRESULT} 
 */
export EnclaveCopyIntoEnclave(EnclaveAddress, UnsecureAddress, NumberOfBytes) {
    result := DllCall("vertdll.dll\EnclaveCopyIntoEnclave", "ptr", EnclaveAddress, "ptr", UnsecureAddress, "ptr", NumberOfBytes, "HRESULT")
    return result
}
 ...
 * @returns {HRESULT} 
 */
export EnclaveCopyOutOfEnclave(UnsecureAddress, EnclaveAddress, NumberOfBytes) {
    result := DllCall("vertdll.dll\EnclaveCopyOutOfEnclave", "ptr", UnsecureAddress, "ptr", EnclaveAddress, "ptr", NumberOfBytes, "HRESULT")
    return result
}
