...
/**
 * Documentation varies per use. Refer to each: <see href="https://learn.microsoft.com/windows/win32/api//content/dbghelp/ns-dbghelp-image_debug_information">IMAGE_DEBUG_INFORMATION</see>, <see href="https://learn.microsoft.com/windows/win32/api//content/winnt/ns-winnt-image_file_header">IMAGE_FILE_HEADER</see>.
 * @see 
