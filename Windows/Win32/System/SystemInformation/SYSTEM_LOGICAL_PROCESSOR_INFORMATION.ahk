 ...
 */
export default struct SYSTEM_LOGICAL_PROCESSOR_INFORMATION {
    #StructPack 8


    struct _ProcessorCore {
        Flags : Int8
    ...
    ProcessorCore : SYSTEM_LOGICAL_PROCESSOR_INFORMATION._ProcessorCore

    static __New() {
        DefineProp(this.Prototype, 'NumaNode', { type: SYSTEM_LOGICAL_PROCESSOR_INFORMATION._NumaNode, offset: 16 })
        DefineProp(this.Prototype, 'Cache', { type: CACHE_DESCRIPTOR, offset: 16 })
        DefineProp(this.Prototype, 'Reserved', { type: Int64[2], offset: 16 })
