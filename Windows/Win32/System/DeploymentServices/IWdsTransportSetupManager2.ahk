 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nn-wdstptmgmt-iwdstransportsetupmanager2
...
class IWdsTransportSetupManager2 extends IWdsTransportSetupManager{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportsetupmanager2-get_tftpcapabilities
     */
    get_TftpCapabilities() {
        result := ComCall(12, this, "uint*", &pulTftpCapabilities := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportsetupmanager2-get_contentproviders
     */
    get_ContentProviders() {
        result := ComCall(13, this, "ptr*", &ppProviderCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
