 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nn-wdstptmgmt-iwdstransportserver
...
class IWdsTransportServer extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportserver-get_name
     */
    get_Name() {
        pbszName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportserver-get_setupmanager
     */
    get_SetupManager() {
        result := ComCall(8, this, "ptr*", &ppWdsTransportSetupManager := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportserver-get_configurationmanager
     */
    get_ConfigurationManager() {
        result := ComCall(9, this, "ptr*", &ppWdsTransportConfigurationManager := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportserver-get_namespacemanager
     */
    get_NamespaceManager() {
        result := ComCall(10, this, "ptr*", &ppWdsTransportNamespaceManager := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportserver-disconnectclient
     */
