 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nn-wdstptmgmt-iwdstransportcontent
...
class IWdsTransportContent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportcontent-get_namespace
     */
    get_Namespace() {
        result := ComCall(7, this, "ptr*", &ppWdsTransportNamespace := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportcontent-get_id
     */
    get_Id() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportcontent-get_name
     */
    get_Name() {
        pbszName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportcontent-retrievesessions
     */
    RetrieveSessions() {
        result := ComCall(10, this, "ptr*", &ppWdsTransportSessions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportcontent-terminate
     */
    Terminate() {
