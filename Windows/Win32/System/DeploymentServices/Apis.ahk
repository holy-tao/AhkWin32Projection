...
;@region Methods
     ...
     * @param {Pointer<Integer>} pdwFlags A pointer to a value that receives the enumeration flag value.
     * 
     * 
    ...
    static WdsCliGetEnumerationFlags(Handle, pdwFlags) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetEnumerationFlags", "ptr", Handle, pdwFlagsMarshal, pdwFlags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    static WdsCliGetImageType(hIfh, pImageType) {
        ...
        pImageTypeMarshal := pImageType is VarRef ? "int*" : "ptr"

        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageType", "ptr", hIfh, pImageTypeMarshal, pImageType, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HANDLE} hIfh A find handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindfirstimage">WdsCliFindFirstImage</a> function. The image referenced by the find handle can be advanced using the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindnextimage">WdsCliFindNextImage</a> function.
     * @param {Pointer<Integer>} pdwValue A pointer to a 
    ...
    static WdsCliGetImageIndex(hIfh, pdwValue) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageIndex", "ptr", hIfh, pdwValueMarshal, pdwValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HANDLE} hIfh A find handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindfirstimage">WdsCliFindFirstImage</a> function. The image referenced by the find handle can be advanced using the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindnextimage">WdsCliFindNextImage</a> function.
     * @param {Pointer<Integer>} pdwValue Pointer to a value that describes the processor architecture of the current image.
     * @returns {HRESULT} If the function succeeds, the return is <b>S_OK</b>.
    ...
    static WdsCliGetImageArchitecture(hIfh, pdwValue) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageArchitecture", "ptr", hIfh, pdwValueMarshal, pdwValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HANDLE} hIfh A find handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindfirstimage">WdsCliFindFirstImage</a> function. The image referenced by the find handle can be advanced using the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindnextimage">WdsCliFindNextImage</a> function.
     * @param {Pointer<Pointer<SYSTEMTIME>>} ppSysTimeValue A pointer to a pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/minwinbase/ns-minwinbase-systemtime">SYSTEMTIME</a> structure that contains the last-modified time of the current image.
     * @returns {HRESULT} If the function succeeds, the return is <b>S_OK</b>.
    ...
    static WdsCliGetImageLastModifiedTime(hIfh, ppSysTimeValue) {
        ...
        ppSysTimeValueMarshal := ppSysTimeValue is VarRef ? "ptr*" : "ptr"

        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageLastModifiedTime", "ptr", hIfh, ppSysTimeValueMarshal, ppSysTimeValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HANDLE} hIfh A find handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindfirstimage">WdsCliFindFirstImage</a> function. The image referenced by the find handle can be advanced using the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindnextimage">WdsCliFindNextImage</a> function.
     * @param {Pointer<Integer>} pullValue A pointer to a value that contains the size of the current image.
     * @returns {HRESULT} If the function succeeds, the return is <b>S_OK</b>.
    ...
    static WdsCliGetImageSize(hIfh, pullValue) {
        ...
        pullValueMarshal := pullValue is VarRef ? "uint*" : "ptr"

        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageSize", "ptr", hIfh, pullValueMarshal, pullValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {HANDLE} hIfh A find handle returned by the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindfirstimage">WdsCliFindFirstImage</a> function. The image referenced by the find handle can be advanced using the <a href="https://docs.microsoft.com/windows/desktop/api/wdsclientapi/nf-wdsclientapi-wdsclifindnextimage">WdsCliFindNextImage</a> function.
     * @param {Pointer<Integer>} pullValue A pointer to a value that contains the size of the current transfer.
     * @returns {HRESULT} If the function succeeds, the return is <b>S_OK</b>.
    ...
    static WdsCliGetTransferSize(hIfh, pullValue) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetTransferSize", "ptr", hIfh, pullValueMarshal, pullValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    static WdsCliObtainDriverPackages(hImage, ppwszServerName, pppwszDriverPackages, pulCount) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliObtainDriverPackages", "ptr", hImage, "ptr", ppwszServerName, pppwszDriverPackagesMarshal, pppwszDriverPackages, pulCountMarshal, pulCount, "int")
        if(result != 0)
            throw OSError(result)
    ...
    static WdsCliObtainDriverPackagesEx(hSession, pwszMachineInfo, ppwszServerName, pppwszDriverPackages, pulCount) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliObtainDriverPackagesEx", "ptr", hSession, "ptr", pwszMachineInfo, "ptr", ppwszServerName, pppwszDriverPackagesMarshal, pppwszDriverPackages, pulCountMarshal, pulCount, "int")
        if(result != 0)
            throw OSError(result)
