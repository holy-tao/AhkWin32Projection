...
;@region Methods
     ...
     */
    static WdsCliClose(_Handle) {
        _Handle := _Handle is Win32Handle ? NumGet(_Handle, "ptr") : _Handle

        result := DllCall("WDSCLIENTAPI.dll\WdsCliClose", "ptr", _Handle, "HRESULT")
        return result
    }
     ...
     * @since windows6.0.6000
     */
    static WdsCliRegisterTrace(_pfn) {
     ...
     * @since windows6.0.6000
     */
    static WdsCliFindNextImage(_Handle) {
        _Handle := _Handle is Win32Handle ? NumGet(_Handle, "ptr") : _Handle

        result := DllCall("WDSCLIENTAPI.dll\WdsCliFindNextImage", "ptr", _Handle, "HRESULT")
        return result
    }
     ...
     * @since windows6.0.6000
     */
    static WdsCliGetEnumerationFlags(_Handle) {
        _Handle := _Handle is Win32Handle ? NumGet(_Handle, "ptr") : _Handle

        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetEnumerationFlags", "ptr", _Handle, "uint*", &pdwFlags := 0, "HRESULT")
        return pdwFlags
    }
    ...
    static WdsCliAuthorizeSession(hSession, pCred) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliAuthorizeSession", "ptr", hSession, "ptr", pCred, "HRESULT")
        return result
    }
    ...
    static WdsCliInitializeLog(hSession, ulClientArchitecture, pwszClientId, pwszClientAddress) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliInitializeLog", "ptr", hSession, "uint", ulClientArchitecture, "ptr", pwszClientId, "ptr", pwszClientAddress, "HRESULT")
        return result
    }
    ...
    static WdsCliGetImageName(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageName", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageDescription(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageDescription", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageType(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageType", "ptr", hIfh, "int*", &pImageType := 0, "HRESULT")
        return pImageType
    }
    ...
    static WdsCliGetImageFiles(hIfh, pppwszFiles, pdwCount) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageFiles", "ptr", hIfh, pppwszFilesMarshal, pppwszFiles, pdwCountMarshal, pdwCount, "HRESULT")
        return result
    }
    ...
    static WdsCliGetImageLanguage(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageLanguage", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageLanguages(hIfh, pppszValues, pdwNumValues) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageLanguages", "ptr", hIfh, pppszValuesMarshal, pppszValues, pdwNumValuesMarshal, pdwNumValues, "HRESULT")
        return result
    }
    ...
    static WdsCliGetImageVersion(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageVersion", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImagePath(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImagePath", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageIndex(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageIndex", "ptr", hIfh, "uint*", &pdwValue := 0, "HRESULT")
        return pdwValue
    }
    ...
    static WdsCliGetImageArchitecture(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageArchitecture", "ptr", hIfh, "uint*", &pdwValue := 0, "HRESULT")
        return pdwValue
    }
    ...
    static WdsCliGetImageLastModifiedTime(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageLastModifiedTime", "ptr", hIfh, "ptr*", &ppSysTimeValue := 0, "HRESULT")
    ...
    static WdsCliGetImageSize(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageSize", "ptr", hIfh, "uint*", &pullValue := 0, "HRESULT")
        return pullValue
    }
    ...
    static WdsCliGetImageHalName(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageHalName", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageGroup(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageGroup", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageNamespace(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageNamespace", "ptr", hIfh, "ptr*", &ppwszValue := 0, "HRESULT")
        return ppwszValue
    }
    ...
    static WdsCliGetImageParameter(hIfh, ParamType, pResponse, uResponseLen) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetImageParameter", "ptr", hIfh, "int", ParamType, "ptr", pResponse, "uint", uResponseLen, "HRESULT")
        return result
    }
    ...
    static WdsCliGetTransferSize(hIfh) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetTransferSize", "ptr", hIfh, "uint*", &pullValue := 0, "HRESULT")
        return pullValue
    }
    ...
    static WdsCliCancelTransfer(hTransfer) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliCancelTransfer", "ptr", hTransfer, "HRESULT")
        return result
    }
    ...
    static WdsCliWaitForTransfer(hTransfer) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliWaitForTransfer", "ptr", hTransfer, "HRESULT")
        return result
    }
    ...
    static WdsCliObtainDriverPackages(hImage, ppwszServerName, pppwszDriverPackages, pulCount) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliObtainDriverPackages", "ptr", hImage, ppwszServerNameMarshal, ppwszServerName, pppwszDriverPackagesMarshal, pppwszDriverPackages, pulCountMarshal, pulCount, "HRESULT")
        return result
    }
    ...
    static WdsCliObtainDriverPackagesEx(hSession, pwszMachineInfo, ppwszServerName, pppwszDriverPackages, pulCount) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliObtainDriverPackagesEx", "ptr", hSession, "ptr", pwszMachineInfo, ppwszServerNameMarshal, ppwszServerName, pppwszDriverPackagesMarshal, pppwszDriverPackages, pulCountMarshal, pulCount, "HRESULT")
        return result
    }
    ...
    static WdsCliGetDriverQueryXml(pwszWinDirPath) {
        ...
        result := DllCall("WDSCLIENTAPI.dll\WdsCliGetDriverQueryXml", "ptr", pwszWinDirPath, "ptr*", &ppwszDriverQuery := 0, "HRESULT")
    ...
    static PxeProviderQueryIndex(pszProviderName, puIndex) {
        ...
        result := DllCall("WDSPXE.dll\PxeProviderQueryIndex", "ptr", pszProviderName, puIndexMarshal, puIndex, "uint")
        return result
    }
    ...
    static PxeProviderEnumNext(hEnum, ppProvider) {
        ...
        result := DllCall("WDSPXE.dll\PxeProviderEnumNext", "ptr", hEnum, ppProviderMarshal, ppProvider, "uint")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static PxeRegisterCallback(_hProvider, CallbackType, pCallbackFunction, pContext) {
        ...
        result := DllCall("WDSPXE.dll\PxeRegisterCallback", "ptr", _hProvider, "uint", CallbackType, pCallbackFunctionMarshal, pCallbackFunction, pContextMarshal, pContext, "uint")
        return result
    }
     ...
     * @returns {Integer} 
     */
    static PxeTraceV(_hProvider, Severity, pszFormat, Params) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider
        pszFormat := pszFormat is String ? StrPtr(pszFormat) : pszFormat

        ParamsMarshal := Params is VarRef ? "char*" : "ptr"

        result := DllCall("WDSPXE.dll\PxeTraceV", "ptr", _hProvider, "uint", Severity, "ptr", pszFormat, ParamsMarshal, Params, "uint")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static PxePacketAllocate(_hProvider, hClientRequest, uSize) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider
        hClientRequest := hClientRequest is Win32Handle ? NumGet(hClientRequest, "ptr") : hClientRequest

        A_LastError := 0

        result := DllCall("WDSPXE.dll\PxePacketAllocate", "ptr", _hProvider, "ptr", hClientRequest, "uint", uSize, "ptr")
        if(A_LastError) {
            throw OSError(A_LastError)
        }
     ...
     * @since windowsserver2008
     */
    static PxePacketFree(_hProvider, hClientRequest, pPacket) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider
        hClientRequest := hClientRequest is Win32Handle ? NumGet(hClientRequest, "ptr") : hClientRequest

        pPacketMarshal := pPacket is VarRef ? "ptr" : "ptr"

        result := DllCall("WDSPXE.dll\PxePacketFree", "ptr", _hProvider, "ptr", hClientRequest, pPacketMarshal, pPacket, "uint")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static PxeProviderSetAttribute(_hProvider, Attribute, pParameterBuffer, uParamLen) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider

        result := DllCall("WDSPXE.dll\PxeProviderSetAttribute", "ptr", _hProvider, "uint", Attribute, "ptr", pParameterBuffer, "uint", uParamLen, "uint")
        return result
    }
    ...
    static PxeDhcpInitialize(pRecvPacket, uRecvPacketLen, pReplyPacket, uMaxReplyPacketLen, puReplyPacketLen) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpInitialize", "ptr", pRecvPacket, "uint", uRecvPacketLen, "ptr", pReplyPacket, "uint", uMaxReplyPacketLen, puReplyPacketLenMarshal, puReplyPacketLen, "uint")
        return result
    }
    ...
    static PxeDhcpv6Initialize(pRequest, cbRequest, pReply, cbReply, pcbReplyUsed) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6Initialize", "ptr", pRequest, "uint", cbRequest, "ptr", pReply, "uint", cbReply, pcbReplyUsedMarshal, pcbReplyUsed, "uint")
        return result
    }
    ...
    static PxeDhcpAppendOption(pReplyPacket, uMaxReplyPacketLen, puReplyPacketLen, bOption, bOptionLen, pValue) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpAppendOption", "ptr", pReplyPacket, "uint", uMaxReplyPacketLen, puReplyPacketLenMarshal, puReplyPacketLen, "char", bOption, "char", bOptionLen, "ptr", pValue, "uint")
        return result
    }
    ...
    static PxeDhcpv6AppendOption(pReply, cbReply, pcbReplyUsed, wOptionType, cbOption, pOption) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6AppendOption", "ptr", pReply, "uint", cbReply, pcbReplyUsedMarshal, pcbReplyUsed, "ushort", wOptionType, "ushort", cbOption, "ptr", pOption, "uint")
        return result
    }
    ...
    static PxeDhcpAppendOptionRaw(pReplyPacket, uMaxReplyPacketLen, puReplyPacketLen, uBufferLen, pBuffer) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpAppendOptionRaw", "ptr", pReplyPacket, "uint", uMaxReplyPacketLen, puReplyPacketLenMarshal, puReplyPacketLen, "ushort", uBufferLen, "ptr", pBuffer, "uint")
        return result
    }
    ...
    static PxeDhcpv6AppendOptionRaw(pReply, cbReply, pcbReplyUsed, cbBuffer, pBuffer) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6AppendOptionRaw", "ptr", pReply, "uint", cbReply, pcbReplyUsedMarshal, pcbReplyUsed, "ushort", cbBuffer, "ptr", pBuffer, "uint")
        return result
    }
    ...
    static PxeDhcpIsValid(pPacket, uPacketLen, bRequestPacket, pbPxeOptionPresent) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpIsValid", "ptr", pPacket, "uint", uPacketLen, "int", bRequestPacket, pbPxeOptionPresentMarshal, pbPxeOptionPresent, "uint")
        return result
    }
    ...
    static PxeDhcpv6IsValid(pPacket, uPacketLen, bRequestPacket, pbPxeOptionPresent) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6IsValid", "ptr", pPacket, "uint", uPacketLen, "int", bRequestPacket, pbPxeOptionPresentMarshal, pbPxeOptionPresent, "uint")
        return result
    }
    ...
    static PxeDhcpGetOptionValue(pPacket, uPacketLen, uInstance, bOption, pbOptionLen, ppOptionValue) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpGetOptionValue", "ptr", pPacket, "uint", uPacketLen, "uint", uInstance, "char", bOption, pbOptionLenMarshal, pbOptionLen, ppOptionValueMarshal, ppOptionValue, "uint")
        return result
    }
    ...
    static PxeDhcpv6GetOptionValue(pPacket, uPacketLen, uInstance, wOption, pwOptionLen, ppOptionValue) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6GetOptionValue", "ptr", pPacket, "uint", uPacketLen, "uint", uInstance, "ushort", wOption, pwOptionLenMarshal, pwOptionLen, ppOptionValueMarshal, ppOptionValue, "uint")
        return result
    }
    ...
    static PxeDhcpGetVendorOptionValue(pPacket, uPacketLen, bOption, uInstance, pbOptionLen, ppOptionValue) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpGetVendorOptionValue", "ptr", pPacket, "uint", uPacketLen, "char", bOption, "uint", uInstance, pbOptionLenMarshal, pbOptionLen, ppOptionValueMarshal, ppOptionValue, "uint")
        return result
    }
    ...
    static PxeDhcpv6GetVendorOptionValue(pPacket, uPacketLen, dwEnterpriseNumber, wOption, uInstance, pwOptionLen, ppOptionValue) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6GetVendorOptionValue", "ptr", pPacket, "uint", uPacketLen, "uint", dwEnterpriseNumber, "ushort", wOption, "uint", uInstance, pwOptionLenMarshal, pwOptionLen, ppOptionValueMarshal, ppOptionValue, "uint")
        return result
    }
    ...
    static PxeDhcpv6ParseRelayForw(pRelayForwPacket, uRelayForwPacketLen, pRelayMessages, nRelayMessages, pnRelayMessages, ppInnerPacket, pcbInnerPacket) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6ParseRelayForw", "ptr", pRelayForwPacket, "uint", uRelayForwPacketLen, "ptr", pRelayMessages, "uint", nRelayMessages, pnRelayMessagesMarshal, pnRelayMessages, ppInnerPacketMarshal, ppInnerPacket, pcbInnerPacketMarshal, pcbInnerPacket, "uint")
        return result
    }
    ...
    static PxeDhcpv6CreateRelayRepl(pRelayMessages, nRelayMessages, pInnerPacket, cbInnerPacket, pReplyBuffer, cbReplyBuffer, pcbReplyBuffer) {
        ...
        result := DllCall("WDSPXE.dll\PxeDhcpv6CreateRelayRepl", "ptr", pRelayMessages, "uint", nRelayMessages, "ptr", pInnerPacket, "uint", cbInnerPacket, "ptr", pReplyBuffer, "uint", cbReplyBuffer, pcbReplyBufferMarshal, pcbReplyBuffer, "uint")
        return result
    }
    ...
    static PxeGetServerInfoEx(uInfoType, pBuffer, uBufferLen, puBufferUsed) {
        ...
        result := DllCall("WDSPXE.dll\PxeGetServerInfoEx", "uint", uInfoType, "ptr", pBuffer, "uint", uBufferLen, puBufferUsedMarshal, puBufferUsed, "uint")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static WdsTransportServerRegisterCallback(_hProvider, CallbackId, _pfnCallback) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider

        _pfnCallbackMarshal := _pfnCallback is VarRef ? "ptr" : "ptr"

        result := DllCall("WDSMC.dll\WdsTransportServerRegisterCallback", "ptr", _hProvider, "int", CallbackId, _pfnCallbackMarshal, _pfnCallback, "HRESULT")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static WdsTransportServerCompleteRead(_hProvider, ulBytesRead, pvUserData, hReadResult) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider

        pvUserDataMarshal := pvUserData is VarRef ? "ptr" : "ptr"

        result := DllCall("WDSMC.dll\WdsTransportServerCompleteRead", "ptr", _hProvider, "uint", ulBytesRead, pvUserDataMarshal, pvUserData, "int", hReadResult, "HRESULT")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static WdsTransportServerTraceV(_hProvider, Severity, pwszFormat, Params) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider
        pwszFormat := pwszFormat is String ? StrPtr(pwszFormat) : pwszFormat

        ParamsMarshal := Params is VarRef ? "char*" : "ptr"

        result := DllCall("WDSMC.dll\WdsTransportServerTraceV", "ptr", _hProvider, "uint", Severity, "ptr", pwszFormat, ParamsMarshal, Params, "HRESULT")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static WdsTransportServerAllocateBuffer(_hProvider, ulBufferSize) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider

        result := DllCall("WDSMC.dll\WdsTransportServerAllocateBuffer", "ptr", _hProvider, "uint", ulBufferSize, "ptr")
        return result
    }
     ...
     * @since windowsserver2008
     */
    static WdsTransportServerFreeBuffer(_hProvider, pvBuffer) {
        _hProvider := _hProvider is Win32Handle ? NumGet(_hProvider, "ptr") : _hProvider

        pvBufferMarshal := pvBuffer is VarRef ? "ptr" : "ptr"

        result := DllCall("WDSMC.dll\WdsTransportServerFreeBuffer", "ptr", _hProvider, pvBufferMarshal, pvBuffer, "HRESULT")
        return result
    }
    ...
    static WdsTransportClientInitializeSession(pSessionRequest, pCallerData, hSessionKey) {
        ...
        result := DllCall("WDSTPTC.dll\WdsTransportClientInitializeSession", "ptr", pSessionRequest, pCallerDataMarshal, pCallerData, "ptr", hSessionKey, "uint")
        return result
    }
     ...
     * @since windows6.0.6000
     */
    static WdsTransportClientRegisterCallback(hSessionKey, CallbackId, _pfnCallback) {
        hSessionKey := hSessionKey is Win32Handle ? NumGet(hSessionKey, "ptr") : hSessionKey

        _pfnCallbackMarshal := _pfnCallback is VarRef ? "ptr" : "ptr"

        result := DllCall("WDSTPTC.dll\WdsTransportClientRegisterCallback", "ptr", hSessionKey, "int", CallbackId, _pfnCallbackMarshal, _pfnCallback, "uint")
        return result
    }
    ...
    static WdsTransportClientCompleteReceive(hSessionKey, ulSize, pullOffset) {
        ...
        result := DllCall("WDSTPTC.dll\WdsTransportClientCompleteReceive", "ptr", hSessionKey, "uint", ulSize, pullOffsetMarshal, pullOffset, "uint")
        return result
    }
    ...
    static WdsTransportClientQueryStatus(hSessionKey, puStatus, puErrorCode) {
        ...
        result := DllCall("WDSTPTC.dll\WdsTransportClientQueryStatus", "ptr", hSessionKey, puStatusMarshal, puStatus, puErrorCodeMarshal, puErrorCode, "uint")
        return result
    }
    ...
    static WdsTransportClientAddRefBuffer(pvBuffer) {
        ...
        result := DllCall("WDSTPTC.dll\WdsTransportClientAddRefBuffer", pvBufferMarshal, pvBuffer, "uint")
        return result
    }
    ...
    static WdsTransportClientReleaseBuffer(pvBuffer) {
        ...
        result := DllCall("WDSTPTC.dll\WdsTransportClientReleaseBuffer", pvBufferMarshal, pvBuffer, "uint")
        return result
    }
    ...
    static WdsBpParseInitialize(pPacket, uPacketLen, pbPacketType, phHandle) {
        ...
        result := DllCall("WDSBP.dll\WdsBpParseInitialize", "ptr", pPacket, "uint", uPacketLen, pbPacketTypeMarshal, pbPacketType, "ptr", phHandle, "uint")
        return result
    }
    ...
    static WdsBpParseInitializev6(pPacket, uPacketLen, pbPacketType, phHandle) {
        ...
        result := DllCall("WDSBP.dll\WdsBpParseInitializev6", "ptr", pPacket, "uint", uPacketLen, pbPacketTypeMarshal, pbPacketType, "ptr", phHandle, "uint")
        return result
    }
    ...
    static WdsBpQueryOption(hHandle, uOption, uValueLen, pValue, puBytes) {
        ...
        result := DllCall("WDSBP.dll\WdsBpQueryOption", "ptr", hHandle, "uint", uOption, "uint", uValueLen, "ptr", pValue, puBytesMarshal, puBytes, "uint")
        return result
    }
    ...
    static WdsBpGetOptionBuffer(hHandle, uBufferLen, pBuffer, puBytes) {
        ...
        result := DllCall("WDSBP.dll\WdsBpGetOptionBuffer", "ptr", hHandle, "uint", uBufferLen, "ptr", pBuffer, puBytesMarshal, puBytes, "uint")
        return result
    }
