 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nn-wdstptmgmt-iwdstransporttftpmanager
...
class IWdsTransportTftpManager extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransporttftpmanager-retrievetftpclients
     */
    RetrieveTftpClients() {
        result := ComCall(7, this, "ptr*", &ppWdsTransportTftpClients := 0, "int")
        if(result != 0) {
