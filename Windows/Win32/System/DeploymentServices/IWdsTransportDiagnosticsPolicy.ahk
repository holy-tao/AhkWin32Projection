 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nn-wdstptmgmt-iwdstransportdiagnosticspolicy
...
class IWdsTransportDiagnosticsPolicy extends IWdsTransportCacheable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportdiagnosticspolicy-get_enabled
     */
    get_Enabled() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportdiagnosticspolicy-put_enabled
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportdiagnosticspolicy-get_components
     */
    get_Components() {
        result := ComCall(13, this, "uint*", &pulComponents := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wdstptmgmt/nf-wdstptmgmt-iwdstransportdiagnosticspolicy-put_components
     */
