...
export default struct IWdsTransportNamespace extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ContentProvider := CallbackCreate(ObjBindMethod(implObj, "get_ContentProvider"), flags, 2)
        this.vtbl.put_ContentProvider := CallbackCreate(ObjBindMethod(implObj, "put_ContentProvider"), flags, 2)
        this.vtbl.get_Configuration := CallbackCreate(ObjBindMethod(implObj, "get_Configuration"), flags, 2)
        this.vtbl.put_Configuration := CallbackCreate(ObjBindMethod(implObj, "put_Configuration"), flags, 2)
        this.vtbl.get_Registered := CallbackCreate(ObjBindMethod(implObj, "get_Registered"), flags, 2)
        this.vtbl.get_Tombstoned := CallbackCreate(ObjBindMethod(implObj, "get_Tombstoned"), flags, 2)
        this.vtbl.get_TombstoneTime := CallbackCreate(ObjBindMethod(implObj, "get_TombstoneTime"), flags, 2)
        this.vtbl.get_TransmissionStarted := CallbackCreate(ObjBindMethod(implObj, "get_TransmissionStarted"), flags, 2)
        this.vtbl.Register := CallbackCreate(ObjBindMethod(implObj, "Register"), flags, 1)
        this.vtbl.Deregister := CallbackCreate(ObjBindMethod(implObj, "Deregister"), flags, 2)
        ...
        this.vtbl.RetrieveContents := CallbackCreate(ObjBindMethod(implObj, "RetrieveContents"), flags, 2)
    }
