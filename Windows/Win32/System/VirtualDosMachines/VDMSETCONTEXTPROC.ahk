 ...
 */
export default struct VDMSETCONTEXTPROC {
    value : IntPtr

    __value {
        set {
            if (value is VDMSETCONTEXTPROC) {
    ...
    /**
     * A VDMSETCONTEXTPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends VDMSETCONTEXTPROC {
        /**
         * Creates a VDMSETCONTEXTPROC pointer that invokes the given AHK function when called.
