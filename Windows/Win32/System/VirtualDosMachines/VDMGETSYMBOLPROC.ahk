 ...
 * @version v4.0.30319
 */
class VDMGETSYMBOLPROC extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6) {
        ...
        result := ComCall(3, this, "ptr", param0, "ushort", param1, "uint", param2, "int", param3, "int", param4, "ptr", param5, param6Marshal, param6, "int")
        return result
    }
}
