 ...
 * @version v4.0.30319
 */
class VDMGETADDREXPRESSIONPROC extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, param2Marshal, param2, param3Marshal, param3, param4Marshal, param4, "int")
        return result
    }
}
