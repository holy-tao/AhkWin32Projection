 ...
 * @version v4.0.30319
 */
class TASKENUMPROCEX extends IUnknown {
     ...
     * @param {Pointer<Integer>} pszModName 
     ...
     */
    Invoke(dwThreadId, hMod16, hTask16, pszModName, pszFileName, lpUserDefined) {
        ...
        result := ComCall(3, this, "uint", dwThreadId, "ushort", hMod16, "ushort", hTask16, pszModNameMarshal, pszModName, pszFileNameMarshal, pszFileName, "ptr", lpUserDefined, "int")
        return result
    }
}
