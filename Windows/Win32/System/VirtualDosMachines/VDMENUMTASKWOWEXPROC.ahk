...
#Import ".\TASKENUMPROCEX.ahk" { TASKENUMPROCEX }
...
export default struct VDMENUMTASKWOWEXPROC {
    ...
    Call(param0, param1, param2) {
        result := DllCall(this.value, UInt32, param0, TASKENUMPROCEX, param1, LPARAM, param2, Int32)
        return result
    }
    ...
    struct From extends VDMENUMTASKWOWEXPROC {
         ...
         * @param {Func(UInt32, TASKENUMPROCEX, LPARAM) => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 3 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [UInt32, TASKENUMPROCEX, LPARAM, Int32])
        }
