 ...
 * @version v4.0.30319
 */
class VDMGETSELECTORMODULEPROC extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ushort", param2, param3Marshal, param3, "ptr", param4, "uint", param5, "ptr", param6, "uint", param7, "int")
        return result
    }
}
