 ...
 * @charset ANSI
 */
class ENUMRESLANGPROCA extends IUnknown {
     ...
     */
    Invoke(hModule_, lpType, lpName, wLanguage, lParam_) {
        hModule_ := hModule_ is Win32Handle ? NumGet(hModule_, "ptr") : hModule_
        lpType := lpType is String ? StrPtr(lpType) : lpType
        lpName := lpName is String ? StrPtr(lpName) : lpName

        result := ComCall(3, this, "ptr", hModule_, "ptr", lpType, "ptr", lpName, "ushort", wLanguage, "ptr", lParam_, "int")
        return result
    }
}
