 ...
 * @see https://learn.microsoft.com/windows/win32/api/libloaderapi/nc-libloaderapi-enumrestypeprocw
 * @namespace Windows.Win32.System.LibraryLoader
 * @charset Unicode
 */
export default struct ENUMRESTYPEPROCW {
    value : IntPtr

    __value {
        set {
            if (value is ENUMRESTYPEPROCW) {
     ...
     * @param {PWSTR} lpType Type: <b>LPTSTR</b>
     * 
    ...
    /**
     * A ENUMRESTYPEPROCW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends ENUMRESTYPEPROCW {
        /**
         * Creates a ENUMRESTYPEPROCW pointer that invokes the given AHK function when called.
         * @param {Func(HMODULE, PWSTR, IntPtr) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
