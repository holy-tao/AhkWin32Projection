...
export GetMailslotInfo(hMailslot, lpMaxMessageSize, lpNextSize, lpMessageCount, lpReadTimeout) {
    ...
    result := DllCall("KERNEL32.dll\GetMailslotInfo", HANDLE, hMailslot, lpMaxMessageSizeMarshal, lpMaxMessageSize, lpNextSizeMarshal, lpNextSize, lpMessageCountMarshal, lpMessageCount, lpReadTimeoutMarshal, lpReadTimeout, BOOL)
