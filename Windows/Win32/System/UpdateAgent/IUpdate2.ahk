 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdate2
...
class IUpdate2 extends IUpdate{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdate2-get_rebootrequired
     */
    get_RebootRequired() {
        result := ComCall(52, this, "short*", &retval := 0, "int")
        if(result != 0) {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdate2-get_ispresent
     */
    get_IsPresent() {
        result := ComCall(53, this, "short*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdate2-get_cveids
     */
    get_CveIDs() {
        result := ComCall(54, this, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdate2-copytocache
     */
    CopyToCache(pFiles) {
        result := ComCall(55, this, "ptr", pFiles, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
