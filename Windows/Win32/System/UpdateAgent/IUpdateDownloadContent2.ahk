 ...
 * @see https://learn.microsoft.com/windows/win32/api/wuapi/nn-wuapi-iupdatedownloadcontent2
 * @namespace Windows.Win32.System.UpdateAgent
 */
export default struct IUpdateDownloadContent2 extends IUpdateDownloadContent {
    /**
     ...
     * used for IUpdateDownloadContent2 interfaces
    */
    struct Vtbl extends IUpdateDownloadContent.Vtbl {
        get_IsDeltaCompressedContent : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IUpdateDownloadContent2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.get_IsDeltaCompressedContent)
    }
}
