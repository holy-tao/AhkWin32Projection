 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdatesession2
...
class IUpdateSession2 extends IUpdateSession{
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesession2-get_userlocale
     */
    get_UserLocale() {
        result := ComCall(15, this, "uint*", &retval := 0, "int")
        if(result != 0) {
     ...
     * @param {Integer} lcid 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesession2-put_userlocale
     */
    put_UserLocale(lcid) {
        result := ComCall(16, this, "uint", lcid, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
