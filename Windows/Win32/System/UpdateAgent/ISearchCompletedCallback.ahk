 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-isearchcompletedcallback
...
class ISearchCompletedCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-isearchcompletedcallback-invoke
     */
    Invoke(searchJob, callbackArgs) {
        result := ComCall(3, this, "ptr", searchJob, "ptr", callbackArgs, "int")
        if(result != 0) {
