 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-idownloadprogress
...
class IDownloadProgress extends IDispatch{
     ...
     * @returns {DECIMAL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_currentupdatebytesdownloaded
     */
     ...
     * @returns {DECIMAL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_currentupdatebytestodownload
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_currentupdateindex
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_percentcomplete
     */
    get_PercentComplete() {
     ...
     * @returns {DECIMAL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_totalbytesdownloaded
     */
     ...
     * @returns {DECIMAL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_totalbytestodownload
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-getupdateresult
     */
    GetUpdateResult(updateIndex) {
        result := ComCall(13, this, "int", updateIndex, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_currentupdatedownloadphase
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogress-get_currentupdatepercentcomplete
     */
