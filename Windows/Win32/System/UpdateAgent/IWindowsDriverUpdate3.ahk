 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iwindowsdriverupdate3
...
class IWindowsDriverUpdate3 extends IWindowsDriverUpdate2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate3-get_browseonly
     */
    get_BrowseOnly() {
        result := ComCall(64, this, "short*", &retval := 0, "int")
        if(result != 0) {
