 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iinstallationprogresschangedcallbackargs
...
class IInstallationProgressChangedCallbackArgs extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iinstallationprogresschangedcallbackargs-get_progress
     */
    get_Progress() {
