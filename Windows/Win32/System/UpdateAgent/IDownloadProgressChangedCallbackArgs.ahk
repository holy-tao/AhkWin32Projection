 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-idownloadprogresschangedcallbackargs
...
class IDownloadProgressChangedCallbackArgs extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadprogresschangedcallbackargs-get_progress
     */
    get_Progress() {
