 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdate4
...
class IUpdate4 extends IUpdate3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdate4-get_peruser
     */
    get_PerUser() {
        result := ComCall(57, this, "short*", &retval := 0, "int")
        if(result != 0) {
