...
export default struct IUpdateHistoryEntry extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_Operation := CallbackCreate(ObjBindMethod(implObj, "get_Operation"), flags, 2)
        ...
        this.vtbl.get_Date := CallbackCreate(ObjBindMethod(implObj, "get_Date"), flags, 2)
        this.vtbl.get_UpdateIdentity := CallbackCreate(ObjBindMethod(implObj, "get_UpdateIdentity"), flags, 2)
        ...
        this.vtbl.get_UnmappedResultCode := CallbackCreate(ObjBindMethod(implObj, "get_UnmappedResultCode"), flags, 2)
