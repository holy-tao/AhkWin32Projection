 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-icategory
...
class ICategory extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_name
     */
    get_Name() {
        retval := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_categoryid
     */
    get_CategoryID() {
        retval := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_children
     */
    get_Children() {
     ...
     * If the <a href="https://docs.microsoft.com/windows/desktop/api/wuapi/nn-wuapi-icategory">ICategory</a> interface is returned from the <a href="https://docs.microsoft.com/windows/desktop/api/wuapi/nf-wuapi-iupdatehistoryentry2-get_categories">Categories</a> property of the <a href="https://docs.microsoft.com/windows/desktop/api/wuapi/nn-wuapi-iupdatehistoryentry2">IUpdateHistoryEntry2</a> interface, the <b>ICategory</b> interface follows the localization rules of the <b>IUpdateHistoryEntry2</b> interface. The information  that   this property returns is for the default UI language of the user. If the default UI language of the user is unavailable, WUA uses the default UI language of the computer.   If the default language of the computer is unavailable, WUA uses the language  that the provider of the  update recommends.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_description
     */
    get_Description() {
        retval := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_image
     */
    get_Image() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_order
     */
    get_Order() {
     ...
     * @returns {ICategory} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_parent
     */
    get_Parent() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_type
     */
    get_Type() {
        retval := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-icategory-get_updates
     */
    get_Updates() {
