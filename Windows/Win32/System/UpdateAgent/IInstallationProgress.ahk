 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iinstallationprogress
...
class IInstallationProgress extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iinstallationprogress-get_currentupdateindex
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iinstallationprogress-get_currentupdatepercentcomplete
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iinstallationprogress-get_percentcomplete
     */
    get_PercentComplete() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iinstallationprogress-getupdateresult
     */
