 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdateinstaller3
...
class IUpdateInstaller3 extends IUpdateInstaller2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdateinstaller3-get_attemptcloseappsifnecessary
     */
    get_AttemptCloseAppsIfNecessary() {
        result := ComCall(30, this, "short*", &retval := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdateinstaller3-put_attemptcloseappsifnecessary
     */
