 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iautomaticupdatesresults
...
class IAutomaticUpdatesResults extends IDispatch{
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iautomaticupdatesresults-get_lastsearchsuccessdate
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iautomaticupdatesresults-get_lastinstallationsuccessdate
     */
