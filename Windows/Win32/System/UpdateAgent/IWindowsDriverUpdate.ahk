 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iwindowsdriverupdate
...
class IWindowsDriverUpdate extends IUpdate{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_driverclass
     */
    get_DriverClass() {
        retval := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_driverhardwareid
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_drivermanufacturer
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_drivermodel
     */
    get_DriverModel() {
        retval := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_driverprovider
     */
    get_DriverProvider() {
        retval := BSTR()
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_driververdate
     */
    get_DriverVerDate() {
        result := ComCall(57, this, "double*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_deviceproblemnumber
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate-get_devicestatus
     */
    get_DeviceStatus() {
