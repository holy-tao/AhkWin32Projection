 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iwindowsdriverupdate5
...
class IWindowsDriverUpdate5 extends IWindowsDriverUpdate4{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate5-get_autoselection
     */
    get_AutoSelection() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iwindowsdriverupdate5-get_autodownload
     */
    get_AutoDownload() {
        result := ComCall(68, this, "int*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
