 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-idownloadresult
...
class IDownloadResult extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadresult-get_hresult
     */
    get_HResult() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadresult-get_resultcode
     */
    get_ResultCode() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-idownloadresult-getupdateresult
     */
    GetUpdateResult(updateIndex) {
        result := ComCall(9, this, "int", updateIndex, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
