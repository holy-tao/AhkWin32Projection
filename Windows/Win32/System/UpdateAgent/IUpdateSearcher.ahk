 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdatesearcher
...
class IUpdateSearcher extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_canautomaticallyupgradeservice
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_canautomaticallyupgradeservice
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_clientapplicationid
     */
     ...
     * @param {BSTR} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_clientapplicationid
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_includepotentiallysupersededupdates
     */
     ...
     * @param {VARIANT_BOOL} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_includepotentiallysupersededupdates
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_serverselection
     */
    get_ServerSelection() {
     ...
     * @param {Integer} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_serverselection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-beginsearch
     */
    BeginSearch(criteria, onCompleted, state) {
        ...
        result := ComCall(15, this, "ptr", criteria, "ptr", onCompleted, "ptr", state, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-endsearch
     */
    EndSearch(searchJob) {
        result := ComCall(16, this, "ptr", searchJob, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-escapestring
     */
    EscapeString(unescaped) {
        if(unescaped is String) {
            pin := BSTR.Alloc(unescaped)
            unescaped := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-queryhistory
     */
    QueryHistory(startIndex, count) {
        result := ComCall(18, this, "int", startIndex, "int", count, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <li>A collection of updates that match the search criteria</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-search
     */
    Search(criteria) {
        if(criteria is String) {
            pin := BSTR.Alloc(criteria)
        ...
        result := ComCall(19, this, "ptr", criteria, "ptr*", &retval := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_online
     */
    get_Online() {
     ...
     * @param {VARIANT_BOOL} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_online
     */
    put_Online(value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-gettotalhistorycount
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-get_serviceid
     */
    get_ServiceID() {
        retval := BSTR()
     ...
     * @param {BSTR} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdatesearcher-put_serviceid
     */
    put_ServiceID(value) {
        if(value is String) {
            pin := BSTR.Alloc(value)
