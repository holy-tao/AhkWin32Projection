...
export default struct IUpdateSearcher extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CanAutomaticallyUpgradeService := CallbackCreate(ObjBindMethod(implObj, "get_CanAutomaticallyUpgradeService"), flags, 2)
        this.vtbl.put_CanAutomaticallyUpgradeService := CallbackCreate(ObjBindMethod(implObj, "put_CanAutomaticallyUpgradeService"), flags, 2)
        ...
        this.vtbl.get_IncludePotentiallySupersededUpdates := CallbackCreate(ObjBindMethod(implObj, "get_IncludePotentiallySupersededUpdates"), flags, 2)
        this.vtbl.put_IncludePotentiallySupersededUpdates := CallbackCreate(ObjBindMethod(implObj, "put_IncludePotentiallySupersededUpdates"), flags, 2)
        this.vtbl.get_ServerSelection := CallbackCreate(ObjBindMethod(implObj, "get_ServerSelection"), flags, 2)
        this.vtbl.put_ServerSelection := CallbackCreate(ObjBindMethod(implObj, "put_ServerSelection"), flags, 2)
        this.vtbl.BeginSearch := CallbackCreate(ObjBindMethod(implObj, "BeginSearch"), flags, 5)
        this.vtbl.EndSearch := CallbackCreate(ObjBindMethod(implObj, "EndSearch"), flags, 3)
        this.vtbl.EscapeString := CallbackCreate(ObjBindMethod(implObj, "EscapeString"), flags, 3)
        this.vtbl.QueryHistory := CallbackCreate(ObjBindMethod(implObj, "QueryHistory"), flags, 4)
        this.vtbl.Search := CallbackCreate(ObjBindMethod(implObj, "Search"), flags, 3)
        this.vtbl.get_Online := CallbackCreate(ObjBindMethod(implObj, "get_Online"), flags, 2)
        this.vtbl.put_Online := CallbackCreate(ObjBindMethod(implObj, "put_Online"), flags, 2)
        this.vtbl.GetTotalHistoryCount := CallbackCreate(ObjBindMethod(implObj, "GetTotalHistoryCount"), flags, 2)
        this.vtbl.get_ServiceID := CallbackCreate(ObjBindMethod(implObj, "get_ServiceID"), flags, 2)
        this.vtbl.put_ServiceID := CallbackCreate(ObjBindMethod(implObj, "put_ServiceID"), flags, 2)
    }
