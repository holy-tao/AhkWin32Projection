...
export default struct IWebProxy extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_BypassList := CallbackCreate(ObjBindMethod(implObj, "put_BypassList"), flags, 2)
        this.vtbl.get_BypassProxyOnLocal := CallbackCreate(ObjBindMethod(implObj, "get_BypassProxyOnLocal"), flags, 2)
        this.vtbl.put_BypassProxyOnLocal := CallbackCreate(ObjBindMethod(implObj, "put_BypassProxyOnLocal"), flags, 2)
        ...
        this.vtbl.PromptForCredentials := CallbackCreate(ObjBindMethod(implObj, "PromptForCredentials"), flags, 3)
        this.vtbl.PromptForCredentialsFromHwnd := CallbackCreate(ObjBindMethod(implObj, "PromptForCredentialsFromHwnd"), flags, 3)
        this.vtbl.get_AutoDetect := CallbackCreate(ObjBindMethod(implObj, "get_AutoDetect"), flags, 2)
        this.vtbl.put_AutoDetect := CallbackCreate(ObjBindMethod(implObj, "put_AutoDetect"), flags, 2)
    }
