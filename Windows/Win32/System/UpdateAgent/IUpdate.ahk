...
export default struct IUpdate extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AutoSelectOnWebSites := CallbackCreate(ObjBindMethod(implObj, "get_AutoSelectOnWebSites"), flags, 2)
        this.vtbl.get_BundledUpdates := CallbackCreate(ObjBindMethod(implObj, "get_BundledUpdates"), flags, 2)
        this.vtbl.get_CanRequireSource := CallbackCreate(ObjBindMethod(implObj, "get_CanRequireSource"), flags, 2)
        ...
        this.vtbl.get_DeltaCompressedContentAvailable := CallbackCreate(ObjBindMethod(implObj, "get_DeltaCompressedContentAvailable"), flags, 2)
        this.vtbl.get_DeltaCompressedContentPreferred := CallbackCreate(ObjBindMethod(implObj, "get_DeltaCompressedContentPreferred"), flags, 2)
        this.vtbl.get_Description := CallbackCreate(ObjBindMethod(implObj, "get_Description"), flags, 2)
        this.vtbl.get_EulaAccepted := CallbackCreate(ObjBindMethod(implObj, "get_EulaAccepted"), flags, 2)
        this.vtbl.get_EulaText := CallbackCreate(ObjBindMethod(implObj, "get_EulaText"), flags, 2)
        this.vtbl.get_HandlerID := CallbackCreate(ObjBindMethod(implObj, "get_HandlerID"), flags, 2)
        this.vtbl.get_Identity := CallbackCreate(ObjBindMethod(implObj, "get_Identity"), flags, 2)
        this.vtbl.get_Image := CallbackCreate(ObjBindMethod(implObj, "get_Image"), flags, 2)
        this.vtbl.get_InstallationBehavior := CallbackCreate(ObjBindMethod(implObj, "get_InstallationBehavior"), flags, 2)
        this.vtbl.get_IsBeta := CallbackCreate(ObjBindMethod(implObj, "get_IsBeta"), flags, 2)
        this.vtbl.get_IsDownloaded := CallbackCreate(ObjBindMethod(implObj, "get_IsDownloaded"), flags, 2)
        ...
        this.vtbl.get_IsInstalled := CallbackCreate(ObjBindMethod(implObj, "get_IsInstalled"), flags, 2)
        this.vtbl.get_IsMandatory := CallbackCreate(ObjBindMethod(implObj, "get_IsMandatory"), flags, 2)
        ...
        this.vtbl.get_LastDeploymentChangeTime := CallbackCreate(ObjBindMethod(implObj, "get_LastDeploymentChangeTime"), flags, 2)
        this.vtbl.get_MaxDownloadSize := CallbackCreate(ObjBindMethod(implObj, "get_MaxDownloadSize"), flags, 2)
        this.vtbl.get_MinDownloadSize := CallbackCreate(ObjBindMethod(implObj, "get_MinDownloadSize"), flags, 2)
        this.vtbl.get_MoreInfoUrls := CallbackCreate(ObjBindMethod(implObj, "get_MoreInfoUrls"), flags, 2)
        this.vtbl.get_MsrcSeverity := CallbackCreate(ObjBindMethod(implObj, "get_MsrcSeverity"), flags, 2)
        this.vtbl.get_RecommendedCpuSpeed := CallbackCreate(ObjBindMethod(implObj, "get_RecommendedCpuSpeed"), flags, 2)
        this.vtbl.get_RecommendedHardDiskSpace := CallbackCreate(ObjBindMethod(implObj, "get_RecommendedHardDiskSpace"), flags, 2)
        this.vtbl.get_RecommendedMemory := CallbackCreate(ObjBindMethod(implObj, "get_RecommendedMemory"), flags, 2)
        this.vtbl.get_ReleaseNotes := CallbackCreate(ObjBindMethod(implObj, "get_ReleaseNotes"), flags, 2)
        this.vtbl.get_SecurityBulletinIDs := CallbackCreate(ObjBindMethod(implObj, "get_SecurityBulletinIDs"), flags, 2)
        this.vtbl.get_SupersededUpdateIDs := CallbackCreate(ObjBindMethod(implObj, "get_SupersededUpdateIDs"), flags, 2)
        this.vtbl.get_SupportUrl := CallbackCreate(ObjBindMethod(implObj, "get_SupportUrl"), flags, 2)
        this.vtbl.get_Type := CallbackCreate(ObjBindMethod(implObj, "get_Type"), flags, 2)
        this.vtbl.get_UninstallationNotes := CallbackCreate(ObjBindMethod(implObj, "get_UninstallationNotes"), flags, 2)
        this.vtbl.get_UninstallationBehavior := CallbackCreate(ObjBindMethod(implObj, "get_UninstallationBehavior"), flags, 2)
        this.vtbl.get_UninstallationSteps := CallbackCreate(ObjBindMethod(implObj, "get_UninstallationSteps"), flags, 2)
        this.vtbl.get_KBArticleIDs := CallbackCreate(ObjBindMethod(implObj, "get_KBArticleIDs"), flags, 2)
        this.vtbl.AcceptEula := CallbackCreate(ObjBindMethod(implObj, "AcceptEula"), flags, 1)
        this.vtbl.get_DeploymentAction := CallbackCreate(ObjBindMethod(implObj, "get_DeploymentAction"), flags, 2)
        this.vtbl.CopyFromCache := CallbackCreate(ObjBindMethod(implObj, "CopyFromCache"), flags, 3)
        this.vtbl.get_DownloadPriority := CallbackCreate(ObjBindMethod(implObj, "get_DownloadPriority"), flags, 2)
        this.vtbl.get_DownloadContents := CallbackCreate(ObjBindMethod(implObj, "get_DownloadContents"), flags, 2)
    }
