...
export default struct IUpdateInstaller extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ParentHwnd := CallbackCreate(ObjBindMethod(implObj, "get_ParentHwnd"), flags, 2)
        this.vtbl.put_ParentHwnd := CallbackCreate(ObjBindMethod(implObj, "put_ParentHwnd"), flags, 2)
        ...
        this.vtbl.BeginInstall := CallbackCreate(ObjBindMethod(implObj, "BeginInstall"), flags, 5)
        this.vtbl.BeginUninstall := CallbackCreate(ObjBindMethod(implObj, "BeginUninstall"), flags, 5)
        this.vtbl.EndInstall := CallbackCreate(ObjBindMethod(implObj, "EndInstall"), flags, 3)
        this.vtbl.EndUninstall := CallbackCreate(ObjBindMethod(implObj, "EndUninstall"), flags, 3)
        this.vtbl.Install := CallbackCreate(ObjBindMethod(implObj, "Install"), flags, 2)
        this.vtbl.RunWizard := CallbackCreate(ObjBindMethod(implObj, "RunWizard"), flags, 3)
        this.vtbl.get_IsBusy := CallbackCreate(ObjBindMethod(implObj, "get_IsBusy"), flags, 2)
        this.vtbl.Uninstall := CallbackCreate(ObjBindMethod(implObj, "Uninstall"), flags, 2)
        this.vtbl.get_AllowSourcePrompts := CallbackCreate(ObjBindMethod(implObj, "get_AllowSourcePrompts"), flags, 2)
        this.vtbl.put_AllowSourcePrompts := CallbackCreate(ObjBindMethod(implObj, "put_AllowSourcePrompts"), flags, 2)
        this.vtbl.get_RebootRequiredBeforeInstallation := CallbackCreate(ObjBindMethod(implObj, "get_RebootRequiredBeforeInstallation"), flags, 2)
    }
