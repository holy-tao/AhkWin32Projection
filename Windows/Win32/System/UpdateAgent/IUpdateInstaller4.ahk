 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nn-wuapi-iupdateinstaller4
...
class IUpdateInstaller4 extends IUpdateInstaller3{
     ...
     * 
     * error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wuapi/nf-wuapi-iupdateinstaller4-commit
     */
    Commit(dwFlags) {
