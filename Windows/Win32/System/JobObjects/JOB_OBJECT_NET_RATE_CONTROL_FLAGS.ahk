...
class JOB_OBJECT_NET_RATE_CONTROL_FLAGS extends Win32BitflagEnum {
     ...
     * Native name: JOB_OBJECT_NET_RATE_CONTROL_ENABLE
     * @type {Integer (Int32)}
     */
    static ENABLE => 1

    /**
     * Native name: JOB_OBJECT_NET_RATE_CONTROL_MAX_BANDWIDTH
     * @type {Integer (Int32)}
     */
    static MAX_BANDWIDTH => 2
     ...
     * Native name: JOB_OBJECT_NET_RATE_CONTROL_DSCP_TAG
     * @type {Integer (Int32)}
     */
    static DSCP_TAG => 4
     ...
     * Native name: JOB_OBJECT_NET_RATE_CONTROL_VALID_FLAGS
     * @type {Integer (Int32)}
     */
    static VALID_FLAGS => 7
}
