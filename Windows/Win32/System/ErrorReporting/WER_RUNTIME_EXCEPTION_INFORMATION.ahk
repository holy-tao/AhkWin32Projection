...
class WER_RUNTIME_EXCEPTION_INFORMATION extends Win32Struct {
     ...
     */
    pwszReportId {
        get => NumGet(this, 3136, "ptr")
        set => NumPut("ptr", value, this, 3136)
    }
     ...
     */
    bIsFatal {
        get => NumGet(this, 3144, "int")
        set => NumPut("int", value, this, 3144)
    }
     ...
     */
    dwReserved {
        get => NumGet(this, 3148, "uint")
        set => NumPut("uint", value, this, 3148)
    }
}
