 ...
 * @version v4.0.30319
 */
class JsMemoryAllocationCallback extends IUnknown {
     ...
     */
    Invoke(callbackState, allocationEvent, allocationSize) {
        callbackStateMarshal := callbackState is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, callbackStateMarshal, callbackState, "int", allocationEvent, "ptr", allocationSize, "int")
        return result
    }
}
