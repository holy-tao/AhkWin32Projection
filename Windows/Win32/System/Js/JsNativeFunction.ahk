 ...
 * @version v4.0.30319
 */
class JsNativeFunction extends IUnknown {
     ...
     */
    Invoke(callee, isConstructCall, arguments, argumentCount, callbackState) {
        ...
        result := ComCall(3, this, calleeMarshal, callee, "int", isConstructCall, argumentsMarshal, arguments, "ushort", argumentCount, callbackStateMarshal, callbackState, "ptr")
        return result
    }
}
