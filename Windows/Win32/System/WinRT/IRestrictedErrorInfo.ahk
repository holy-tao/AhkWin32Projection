 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nn-restrictederrorinfo-irestrictederrorinfo
...
class IRestrictedErrorInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nf-restrictederrorinfo-irestrictederrorinfo-geterrordetails
     */
    GetErrorDetails(description, error, restrictedDescription, capabilitySid) {
        errorMarshal := error is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", description, errorMarshal, error, "ptr", restrictedDescription, "ptr", capabilitySid, "int")
        if(result != 0) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nf-restrictederrorinfo-irestrictederrorinfo-getreference
     */
    GetReference() {
        reference_ := BSTR()
