...
class IPrintManagerInterop extends IInspectable{
     ...
     * @returns {Pointer<Pointer<Void>>} The <a href="https://docs.microsoft.com/uwp/api/Windows.Graphics.Printing.PrintManager">PrintManager</a> instance for the specified window.
     * @see https://learn.microsoft.com/windows/win32/api//content/printmanagerinterop/nf-printmanagerinterop-iprintmanagerinterop-getforwindow
     */
     ...
     * @param {Pointer<Guid>} riid The reference ID of the specified window.
     * @returns {Pointer<Pointer<Void>>} The asynchronous operation that reports completion.
     * @see https://learn.microsoft.com/windows/win32/api//content/printmanagerinterop/nf-printmanagerinterop-iprintmanagerinterop-showprintuiforwindowasync
     */
