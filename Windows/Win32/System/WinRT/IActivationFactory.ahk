 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/activation/nn-activation-iactivationfactory
...
class IActivationFactory extends IInspectable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/activation/nf-activation-iactivationfactory-activateinstance
     */
    ActivateInstance() {
