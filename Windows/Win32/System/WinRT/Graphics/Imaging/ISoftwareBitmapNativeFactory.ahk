 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.imaging.interop/nn-windows-graphics-imaging-interop-isoftwarebitmapnativefactory
...
class ISoftwareBitmapNativeFactory extends IInspectable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.imaging.interop/nf-windows-graphics-imaging-interop-isoftwarebitmapnativefactory-createfromwicbitmap
     */
     ...
     * 
     * When this method returns successfully, contains the requested interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.imaging.interop/nf-windows-graphics-imaging-interop-isoftwarebitmapnativefactory-createfrommf2dbuffer2
     */
    CreateFromMF2DBuffer2(data, subtype, width, height, forceReadOnly, minDisplayAperture, riid) {
        result := ComCall(7, this, "ptr", data, "ptr", subtype, "uint", width, "uint", height, "int", forceReadOnly, "ptr", minDisplayAperture, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
