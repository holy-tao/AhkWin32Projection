 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nn-windows-graphics-effects-interop-igraphicseffectd2d1interop
...
class IGraphicsEffectD2D1Interop extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-geteffectid
     */
    GetEffectId() {
        id := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-getnamedpropertymapping
     */
    GetNamedPropertyMapping(name, index, mapping) {
        ...
        result := ComCall(4, this, "ptr", name, indexMarshal, index, mappingMarshal, mapping, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-getpropertycount
     */
    GetPropertyCount() {
        result := ComCall(5, this, "uint*", &count := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IPropertyValue} Type: <b>Windows::Foundation::IPropertyValue**</b>
     * 
     * When this method returns, this parameter will contain the retrieved property.
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-getproperty
     */
    GetProperty(index) {
        result := ComCall(6, this, "uint", index, "ptr*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IGraphicsEffectSource} Type: <b>IGraphicsEffectSource**</b>
     * 
     * When the method returns, this parameter will contain the source at the specified index.
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-getsource
     */
    GetSource(index) {
        result := ComCall(7, this, "uint", index, "ptr*", &source := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IGraphicsEffectSource(source)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.effects.interop/nf-windows-graphics-effects-interop-igraphicseffectd2d1interop-getsourcecount
     */
    GetSourceCount() {
        result := ComCall(8, this, "uint*", &count := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
