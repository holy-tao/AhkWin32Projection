 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/inspectable/nn-inspectable-iinspectable
...
class IInspectable extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/inspectable/nf-inspectable-iinspectable-getiids
     */
    GetIids(iidCount, iids) {
        iidCountMarshal := iidCount is VarRef ? "uint*" : "ptr"
        iidsMarshal := iids is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, iidCountMarshal, iidCount, iidsMarshal, iids, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/inspectable/nf-inspectable-iinspectable-getruntimeclassname
     */
    GetRuntimeClassName() {
        className := HSTRING()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/inspectable/nf-inspectable-iinspectable-gettrustlevel
     */
    GetTrustLevel() {
        result := ComCall(5, this, "int*", &trustLevel_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
