 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/sharewindowcommandsourceinterop/nn-sharewindowcommandsourceinterop-isharewindowcommandsourceinterop
...
class IShareWindowCommandSourceInterop extends IUnknown{
     ...
     * @returns {Pointer<Pointer<Void>>} Type: **[void](/windows/win32/winprog/windows-data-types)\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sharewindowcommandsourceinterop/nf-sharewindowcommandsourceinterop-isharewindowcommandsourceinterop-getforwindow
     */
    GetForWindow(appWindow, riid) {
        appWindow := appWindow is Win32Handle ? NumGet(appWindow, "ptr") : appWindow

        result := ComCall(3, this, "ptr", appWindow, "ptr", riid, "ptr*", &shareWindowCommandSource := 0, "int")
        if(result != 0) {
