 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nn-windowsstoragecom-ioplockbreakinghandler
...
class IOplockBreakingHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nf-windowsstoragecom-ioplockbreakinghandler-oplockbreaking
     */
    OplockBreaking() {
