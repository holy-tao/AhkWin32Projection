 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nn-windowsstoragecom-iunbufferedfilehandleprovider
...
class IUnbufferedFileHandleProvider extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nf-windowsstoragecom-iunbufferedfilehandleprovider-openunbufferedfilehandle
     */
    OpenUnbufferedFileHandle(oplockBreakCallback) {
        result := ComCall(3, this, "ptr", oplockBreakCallback, "ptr*", &fileHandle := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nf-windowsstoragecom-iunbufferedfilehandleprovider-closeunbufferedfilehandle
     */
