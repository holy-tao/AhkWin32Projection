 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nn-windowsstoragecom-iunbufferedfilehandleoplockcallback
...
class IUnbufferedFileHandleOplockCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nf-windowsstoragecom-iunbufferedfilehandleoplockcallback-onbrokencallback
     */
    OnBrokenCallback() {
