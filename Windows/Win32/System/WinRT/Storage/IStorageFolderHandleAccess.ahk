 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nn-windowsstoragecom-istoragefolderhandleaccess
...
class IStorageFolderHandleAccess extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windowsstoragecom/nf-windowsstoragecom-istoragefolderhandleaccess-create
     */
    Create(fileName, creationOptions, accessOptions, sharingOptions, options, oplockBreakingHandler) {
        fileName := fileName is String ? StrPtr(fileName) : fileName

        interopHandle := HANDLE()
        result := ComCall(3, this, "ptr", fileName, "int", creationOptions, "int", accessOptions, "int", sharingOptions, "uint", options, "ptr", oplockBreakingHandler, "ptr", interopHandle, "int")
        if(result != 0) {
