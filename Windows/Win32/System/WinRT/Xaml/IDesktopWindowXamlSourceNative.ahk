...
class IDesktopWindowXamlSourceNative extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.ui.xaml.hosting.desktopwindowxamlsource/nf-windows-ui-xaml-hosting-desktopwindowxamlsource-idesktopwindowxamlsourcenative-attachtowindow
     */
     ...
     * @returns {HWND} 
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.ui.xaml.hosting.desktopwindowxamlsource/nf-windows-ui-xaml-hosting-desktopwindowxamlsource-idesktopwindowxamlsourcenative-get_windowhandle
     */
    get_WindowHandle() {
        hWnd_ := HWND()
