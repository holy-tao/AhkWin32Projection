 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windows.ui.xaml.hosting.desktopwindowxamlsource/nn-windows-ui-xaml-hosting-desktopwindowxamlsource-idesktopwindowxamlsourcenative2
...
class IDesktopWindowXamlSourceNative2 extends IDesktopWindowXamlSourceNative{
     ...
     * @param {Pointer<BOOL>} result_ Type: **BOOL\***
     * 
     * True if the message was processed; otherwise, false.
     * @returns {HRESULT} If this method succeeds, it returns S_OK. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.ui.xaml.hosting.desktopwindowxamlsource/nf-windows-ui-xaml-hosting-desktopwindowxamlsource-idesktopwindowxamlsourcenative2-pretranslatemessage
     */
    PreTranslateMessage(message, result_) {
        result_Marshal := result_ is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, "ptr", message, result_Marshal, result_, "int")
        if(result != 0) {
