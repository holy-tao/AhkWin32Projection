 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nn-restrictederrorinfo-ilanguageexceptionerrorinfo2
...
class ILanguageExceptionErrorInfo2 extends ILanguageExceptionErrorInfo{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nf-restrictederrorinfo-ilanguageexceptionerrorinfo2-getpreviouslanguageexceptionerrorinfo
     */
    GetPreviousLanguageExceptionErrorInfo() {
        result := ComCall(4, this, "ptr*", &previousLanguageExceptionErrorInfo := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nf-restrictederrorinfo-ilanguageexceptionerrorinfo2-capturepropagationcontext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/restrictederrorinfo/nf-restrictederrorinfo-ilanguageexceptionerrorinfo2-getpropagationcontexthead
     */
    GetPropagationContextHead() {
        result := ComCall(6, this, "ptr*", &propagatedLanguageExceptionErrorInfoHead := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
