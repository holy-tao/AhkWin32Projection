 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nn-rometadataapi-imetadatatables
...
class IMetaDataTables extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getstringheapsize
     */
    GetStringHeapSize(pcbStrings) {
        pcbStringsMarshal := pcbStrings is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, pcbStringsMarshal, pcbStrings, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getblobheapsize
     */
    GetBlobHeapSize(pcbBlobs) {
        pcbBlobsMarshal := pcbBlobs is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, pcbBlobsMarshal, pcbBlobs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getguidheapsize
     */
    GetGuidHeapSize(pcbGuids) {
        pcbGuidsMarshal := pcbGuids is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, pcbGuidsMarshal, pcbGuids, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getuserstringheapsize
     */
    GetUserStringHeapSize(pcbBlobs) {
        pcbBlobsMarshal := pcbBlobs is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, pcbBlobsMarshal, pcbBlobs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getnumtables
     */
    GetNumTables(pcTables) {
        pcTablesMarshal := pcTables is VarRef ? "uint*" : "ptr"

        result := ComCall(7, this, pcTablesMarshal, pcTables, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-gettableindex
     */
    GetTableIndex(token, pixTbl) {
        pixTblMarshal := pixTbl is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, "uint", token, pixTblMarshal, pixTbl, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-gettableinfo
     */
    GetTableInfo(ixTbl, pcbRow, pcRows, pcCols, piKey, ppName) {
        ...
        result := ComCall(9, this, "uint", ixTbl, pcbRowMarshal, pcbRow, pcRowsMarshal, pcRows, pcColsMarshal, pcCols, piKeyMarshal, piKey, ppNameMarshal, ppName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getcolumninfo
     */
    GetColumnInfo(ixTbl, ixCol, poCol, pcbCol, pType, ppName) {
        ...
        result := ComCall(10, this, "uint", ixTbl, "uint", ixCol, poColMarshal, poCol, pcbColMarshal, pcbCol, pTypeMarshal, pType, ppNameMarshal, ppName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getcodedtokeninfo
     */
    GetCodedTokenInfo(ixCdTkn, pcTokens, ppTokens, ppName) {
        ...
        result := ComCall(11, this, "uint", ixCdTkn, pcTokensMarshal, pcTokens, ppTokensMarshal, ppTokens, ppNameMarshal, ppName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getrow
     */
    GetRow(ixTbl, rid, ppRow) {
        ppRowMarshal := ppRow is VarRef ? "ptr*" : "ptr"

        result := ComCall(12, this, "uint", ixTbl, "uint", rid, ppRowMarshal, ppRow, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getcolumn
     */
    GetColumn(ixTbl, ixCol, rid, pVal) {
        pValMarshal := pVal is VarRef ? "uint*" : "ptr"

        result := ComCall(13, this, "uint", ixTbl, "uint", ixCol, "uint", rid, pValMarshal, pVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getstring
     */
    GetString(ixString, ppString) {
        ppStringMarshal := ppString is VarRef ? "ptr*" : "ptr"

        result := ComCall(14, this, "uint", ixString, ppStringMarshal, ppString, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getblob
     */
    GetBlob(ixBlob, pcbData, ppData) {
        pcbDataMarshal := pcbData is VarRef ? "uint*" : "ptr"
        ppDataMarshal := ppData is VarRef ? "ptr*" : "ptr"

        result := ComCall(15, this, "uint", ixBlob, pcbDataMarshal, pcbData, ppDataMarshal, ppData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getguid
     */
    GetGuid(ixGuid, ppGUID) {
        ppGUIDMarshal := ppGUID is VarRef ? "ptr*" : "ptr"

        result := ComCall(16, this, "uint", ixGuid, ppGUIDMarshal, ppGUID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getuserstring
     */
    GetUserString(ixUserString, pcbData, ppData) {
        pcbDataMarshal := pcbData is VarRef ? "uint*" : "ptr"
        ppDataMarshal := ppData is VarRef ? "ptr*" : "ptr"

        result := ComCall(17, this, "uint", ixUserString, pcbDataMarshal, pcbData, ppDataMarshal, ppData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getnextstring
     */
    GetNextString(ixString, pNext) {
        pNextMarshal := pNext is VarRef ? "uint*" : "ptr"

        result := ComCall(18, this, "uint", ixString, pNextMarshal, pNext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getnextblob
     */
    GetNextBlob(ixBlob, pNext) {
        pNextMarshal := pNext is VarRef ? "uint*" : "ptr"

        result := ComCall(19, this, "uint", ixBlob, pNextMarshal, pNext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getnextguid
     */
    GetNextGuid(ixGuid, pNext) {
        pNextMarshal := pNext is VarRef ? "uint*" : "ptr"

        result := ComCall(20, this, "uint", ixGuid, pNextMarshal, pNext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables-getnextuserstring
     */
    GetNextUserString(ixUserString, pNext) {
        pNextMarshal := pNext is VarRef ? "uint*" : "ptr"

        result := ComCall(21, this, "uint", ixUserString, pNextMarshal, pNext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
