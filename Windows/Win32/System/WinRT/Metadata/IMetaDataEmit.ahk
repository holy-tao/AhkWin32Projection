...
class IMetaDataEmit extends IUnknown{
    ...
    GetSaveSize(fSave, pdwSaveSize) {
        result := ComCall(6, this, "int", fSave, "uint*", pdwSaveSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} rtkImplements 
    ...
    DefineTypeDef(szTypeDef, dwTypeDefFlags, tkExtends, rtkImplements, ptd) {
        ...
        result := ComCall(7, this, "ptr", szTypeDef, "uint", dwTypeDefFlags, "uint", tkExtends, "uint*", rtkImplements, "uint*", ptd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineNestedType(szTypeDef, dwTypeDefFlags, tkExtends, rtkImplements, tdEncloser, ptd) {
        ...
        result := ComCall(8, this, "ptr", szTypeDef, "uint", dwTypeDefFlags, "uint", tkExtends, "uint*", rtkImplements, "uint", tdEncloser, "uint*", ptd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineMethod(td, szName, dwMethodFlags, pvSigBlob, cbSigBlob, ulCodeRVA, dwImplFlags, pmd) {
        ...
        result := ComCall(10, this, "uint", td, "ptr", szName, "uint", dwMethodFlags, "char*", pvSigBlob, "uint", cbSigBlob, "uint", ulCodeRVA, "uint", dwImplFlags, "uint*", pmd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineTypeRefByName(tkResolutionScope, szName, ptr) {
        ...
        result := ComCall(12, this, "uint", tkResolutionScope, "ptr", szName, "uint*", ptr, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMetaDataAssemblyImport>} pAssemImport 
     * @param {Pointer<Void>} pbHashValue 
     * @param {Integer} cbHashValue 
     * @param {Pointer<IMetaDataImport>} pImport 
     * @param {Integer} tdImport 
     * @param {Pointer<IMetaDataAssemblyEmit>} pAssemEmit 
     * @param {Pointer<UInt32>} ptr 
     * @returns {HRESULT} 
     */
    DefineImportType(pAssemImport, pbHashValue, cbHashValue, pImport, tdImport, pAssemEmit, ptr) {
        result := ComCall(13, this, "ptr", pAssemImport, "ptr", pbHashValue, "uint", cbHashValue, "ptr", pImport, "uint", tdImport, "ptr", pAssemEmit, "uint*", ptr, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineMemberRef(tkImport, szName, pvSigBlob, cbSigBlob, pmr) {
        ...
        result := ComCall(14, this, "uint", tkImport, "ptr", szName, "char*", pvSigBlob, "uint", cbSigBlob, "uint*", pmr, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineImportMember(pAssemImport, pbHashValue, cbHashValue, pImport, mbMember, pAssemEmit, tkParent, pmr) {
        result := ComCall(15, this, "ptr", pAssemImport, "ptr", pbHashValue, "uint", cbHashValue, "ptr", pImport, "uint", mbMember, "ptr", pAssemEmit, "uint", tkParent, "uint*", pmr, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} rmdOtherMethods 
     * @param {Pointer<UInt32>} pmdEvent 
     * @returns {HRESULT} 
     */
    DefineEvent(td, szEvent, dwEventFlags, tkEventType, mdAddOn, mdRemoveOn, mdFire, rmdOtherMethods, pmdEvent) {
        ...
        result := ComCall(16, this, "uint", td, "ptr", szEvent, "uint", dwEventFlags, "uint", tkEventType, "uint", mdAddOn, "uint", mdRemoveOn, "uint", mdFire, "uint*", rmdOtherMethods, "uint*", pmdEvent, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Integer} tk 
     * @param {Pointer<Byte>} pvNativeType 
     * @param {Integer} cbNativeType 
     * @returns {HRESULT} 
     */
    SetFieldMarshal(tk, pvNativeType, cbNativeType) {
        result := ComCall(19, this, "uint", tk, "char*", pvNativeType, "uint", cbNativeType, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} ppm 
     * @returns {HRESULT} 
     */
    DefinePermissionSet(tk, dwAction, pvPermission, cbPermission, ppm) {
        result := ComCall(21, this, "uint", tk, "uint", dwAction, "ptr", pvPermission, "uint", cbPermission, "uint*", ppm, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<Byte>} pvSig 
     * @param {Integer} cbSig 
     * @param {Pointer<UInt32>} pmsig 
     * @returns {HRESULT} 
     */
    GetTokenFromSig(pvSig, cbSig, pmsig) {
        result := ComCall(23, this, "char*", pvSig, "uint", cbSig, "uint*", pmsig, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {PWSTR} szName 
     * @param {Pointer<UInt32>} pmur 
     * @returns {HRESULT} 
     */
    DefineModuleRef(szName, pmur) {
        szName := szName is String ? StrPtr(szName) : szName

        result := ComCall(24, this, "ptr", szName, "uint*", pmur, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Byte>} pvSig 
     * @param {Integer} cbSig 
     * @param {Pointer<UInt32>} ptypespec 
     * @returns {HRESULT} 
     */
    GetTokenFromTypeSpec(pvSig, cbSig, ptypespec) {
        result := ComCall(26, this, "char*", pvSig, "uint", cbSig, "uint*", ptypespec, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SaveToMemory(pbData, cbData) {
        result := ComCall(27, this, "ptr", pbData, "uint", cbData, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetTypeDefProps(td, dwTypeDefFlags, tkExtends, rtkImplements) {
        result := ComCall(31, this, "uint", td, "uint", dwTypeDefFlags, "uint", tkExtends, "uint*", rtkImplements, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetEventProps(ev, dwEventFlags, tkEventType, mdAddOn, mdRemoveOn, mdFire, rmdOtherMethods) {
        result := ComCall(32, this, "uint", ev, "uint", dwEventFlags, "uint", tkEventType, "uint", mdAddOn, "uint", mdRemoveOn, "uint", mdFire, "uint*", rmdOtherMethods, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetPermissionSetProps(tk, dwAction, pvPermission, cbPermission, ppm) {
        result := ComCall(33, this, "uint", tk, "uint", dwAction, "ptr", pvPermission, "uint", cbPermission, "uint*", ppm, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pcv 
     * @returns {HRESULT} 
     */
    DefineCustomAttribute(tkOwner, tkCtor, pCustomAttribute, cbCustomAttribute, pcv) {
        result := ComCall(37, this, "uint", tkOwner, "uint", tkCtor, "ptr", pCustomAttribute, "uint", cbCustomAttribute, "uint*", pcv, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetCustomAttributeValue(pcv, pCustomAttribute, cbCustomAttribute) {
        result := ComCall(38, this, "uint", pcv, "ptr", pCustomAttribute, "uint", cbCustomAttribute, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineField(td, szName, dwFieldFlags, pvSigBlob, cbSigBlob, dwCPlusTypeFlag, pValue, cchValue, pmd) {
        ...
        result := ComCall(39, this, "uint", td, "ptr", szName, "uint", dwFieldFlags, "char*", pvSigBlob, "uint", cbSigBlob, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "uint*", pmd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineProperty(td, szProperty, dwPropFlags, pvSig, cbSig, dwCPlusTypeFlag, pValue, cchValue, mdSetter, mdGetter, rmdOtherMethods, pmdProp) {
        ...
        result := ComCall(40, this, "uint", td, "ptr", szProperty, "uint", dwPropFlags, "char*", pvSig, "uint", cbSig, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "uint", mdSetter, "uint", mdGetter, "uint*", rmdOtherMethods, "uint*", pmdProp, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DefineParam(md, ulParamSeq, szName, dwParamFlags, dwCPlusTypeFlag, pValue, cchValue, ppd) {
        ...
        result := ComCall(41, this, "uint", md, "uint", ulParamSeq, "ptr", szName, "uint", dwParamFlags, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "uint*", ppd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetFieldProps(fd, dwFieldFlags, dwCPlusTypeFlag, pValue, cchValue) {
        result := ComCall(42, this, "uint", fd, "uint", dwFieldFlags, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetPropertyProps(pr, dwPropFlags, dwCPlusTypeFlag, pValue, cchValue, mdSetter, mdGetter, rmdOtherMethods) {
        result := ComCall(43, this, "uint", pr, "uint", dwPropFlags, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "uint", mdSetter, "uint", mdGetter, "uint*", rmdOtherMethods, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetParamProps(pd, szName, dwParamFlags, dwCPlusTypeFlag, pValue, cchValue) {
        ...
        result := ComCall(44, this, "uint", pd, "ptr", szName, "uint", dwParamFlags, "uint", dwCPlusTypeFlag, "ptr", pValue, "uint", cchValue, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pulErrorAttr 
     * @returns {HRESULT} 
     */
    DefineSecurityAttributeSet(tkObj, rSecAttrs, cSecAttrs, pulErrorAttr) {
        result := ComCall(45, this, "uint", tkObj, "ptr", rSecAttrs, "uint", cSecAttrs, "uint*", pulErrorAttr, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IUnknown>} pImport 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<Void>} pbHashValue 
     * @param {Integer} cbHashValue 
     * @param {Pointer<IMetaDataImport>} import 
     * @param {Pointer<Byte>} pbSigBlob 
     * @param {Integer} cbSigBlob 
     * @param {Pointer<IMetaDataAssemblyEmit>} pAssemEmit 
     * @param {Pointer<IMetaDataEmit>} emit 
     * @param {Pointer<Byte>} pvTranslatedSig 
     * @param {Integer} cbTranslatedSigMax 
     * @param {Pointer<UInt32>} pcbTranslatedSig 
     * @returns {HRESULT} 
     */
    TranslateSigWithScope(pAssemImport, pbHashValue, cbHashValue, import, pbSigBlob, cbSigBlob, pAssemEmit, emit, pvTranslatedSig, cbTranslatedSigMax, pcbTranslatedSig) {
        result := ComCall(47, this, "ptr", pAssemImport, "ptr", pbHashValue, "uint", cbHashValue, "ptr", import, "char*", pbSigBlob, "uint", cbSigBlob, "ptr", pAssemEmit, "ptr", emit, "char*", pvTranslatedSig, "uint", cbTranslatedSigMax, "uint*", pcbTranslatedSig, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Pointer<IMetaDataImport>} pImport 
     * @param {Pointer<IMapToken>} pHostMapToken 
     * @param {Pointer<IUnknown>} pHandler 
     * @returns {HRESULT} 
     */
