...
class IRoSimpleMetaDataBuilder extends Win32ComInterface{
    ...
    SetInterfaceGroupParameterizedDefault(name, elementCount, defaultInterfaceNameElements) {
        ...
        result := ComCall(3, this, "ptr", name, "uint", elementCount, "ptr", defaultInterfaceNameElements, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetRuntimeClassParameterizedDefault(name, elementCount, defaultInterfaceNameElements) {
        ...
        result := ComCall(5, this, "ptr", name, "uint", elementCount, "ptr", defaultInterfaceNameElements, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetStruct(name, numFields, fieldTypeNames) {
        ...
        result := ComCall(6, this, "ptr", name, "uint", numFields, "ptr", fieldTypeNames, "int")
        if(result != 0)
            throw OSError(result)
