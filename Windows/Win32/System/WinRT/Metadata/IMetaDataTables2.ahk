 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nn-rometadataapi-imetadatatables2
...
class IMetaDataTables2 extends IMetaDataTables{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables2-getmetadatastorage
     */
    GetMetaDataStorage(ppvMd, pcbMd) {
        ppvMdMarshal := ppvMd is VarRef ? "ptr*" : "ptr"
        pcbMdMarshal := pcbMd is VarRef ? "uint*" : "ptr"

        result := ComCall(22, this, ppvMdMarshal, ppvMd, pcbMdMarshal, pcbMd, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadatatables2-getmetadatastreaminfo
     */
    GetMetaDataStreamInfo(ix, ppchName, ppv, pcb) {
        ...
        result := ComCall(23, this, "uint", ix, ppchNameMarshal, ppchName, ppvMarshal, ppv, pcbMarshal, pcb, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
