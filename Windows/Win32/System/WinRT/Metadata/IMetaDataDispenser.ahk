...
class IMetaDataDispenser extends IUnknown{
    ...
    DefineScope(rclsid, dwCreateFlags, riid, ppIUnk) {
        result := ComCall(3, this, "ptr", rclsid, "uint", dwCreateFlags, "ptr", riid, "ptr", ppIUnk, "int")
        if(result != 0)
    ...
    OpenScope(szScope, dwOpenFlags, riid, ppIUnk) {
        ...
        result := ComCall(4, this, "ptr", szScope, "uint", dwOpenFlags, "ptr", riid, "ptr", ppIUnk, "int")
        if(result != 0)
            throw OSError(result)
    ...
    OpenScopeOnMemory(pData, cbData, dwOpenFlags, riid, ppIUnk) {
        result := ComCall(5, this, "ptr", pData, "uint", cbData, "uint", dwOpenFlags, "ptr", riid, "ptr", ppIUnk, "int")
        if(result != 0)
            throw OSError(result)
