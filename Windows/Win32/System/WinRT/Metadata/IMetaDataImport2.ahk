 ...
 */
export default struct IMetaDataImport2 extends IMetaDataImport {
    /**
     ...
     * used for IMetaDataImport2 interfaces
    */
    struct Vtbl extends IMetaDataImport.Vtbl {
        EnumGenericParams              : IntPtr
        GetGenericParamProps           : IntPtr
        GetMethodSpecProps             : IntPtr
        EnumGenericParamConstraints    : IntPtr
        GetGenericParamConstraintProps : IntPtr
        GetPEKind                      : IntPtr
        GetVersionString               : IntPtr
        EnumMethodSpecs                : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMetaDataImport2.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.EnumGenericParams)
        CallbackFree(this.vtbl.GetGenericParamProps)
        CallbackFree(this.vtbl.GetMethodSpecProps)
        CallbackFree(this.vtbl.EnumGenericParamConstraints)
        CallbackFree(this.vtbl.GetGenericParamConstraintProps)
        CallbackFree(this.vtbl.GetPEKind)
        CallbackFree(this.vtbl.GetVersionString)
        CallbackFree(this.vtbl.EnumMethodSpecs)
    }
}
