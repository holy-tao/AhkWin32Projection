 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nn-rometadataapi-imetadataimport2
...
class IMetaDataImport2 extends IMetaDataImport{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-enumgenericparams
     */
    EnumGenericParams(phEnum, tk, rGenericParams, cMax, pcGenericParams) {
        ...
        result := ComCall(65, this, phEnumMarshal, phEnum, "uint", tk, rGenericParamsMarshal, rGenericParams, "uint", cMax, pcGenericParamsMarshal, pcGenericParams, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-getgenericparamprops
     */
    GetGenericParamProps(gp, pulParamSeq, pdwParamFlags, ptOwner, reserved, wzname, cchName, pchName) {
        ...
        result := ComCall(66, this, "uint", gp, pulParamSeqMarshal, pulParamSeq, pdwParamFlagsMarshal, pdwParamFlags, ptOwnerMarshal, ptOwner, reservedMarshal, reserved, "ptr", wzname, "uint", cchName, pchNameMarshal, pchName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-getmethodspecprops
     */
    GetMethodSpecProps(mi, tkParent, ppvSigBlob, pcbSigBlob) {
        ...
        result := ComCall(67, this, "uint", mi, tkParentMarshal, tkParent, ppvSigBlobMarshal, ppvSigBlob, pcbSigBlobMarshal, pcbSigBlob, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-enumgenericparamconstraints
     */
    EnumGenericParamConstraints(phEnum, tk, rGenericParamConstraints, cMax, pcGenericParamConstraints) {
        ...
        result := ComCall(68, this, phEnumMarshal, phEnum, "uint", tk, rGenericParamConstraintsMarshal, rGenericParamConstraints, "uint", cMax, pcGenericParamConstraintsMarshal, pcGenericParamConstraints, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-getgenericparamconstraintprops
     */
    GetGenericParamConstraintProps(gpc, ptGenericParam, ptkConstraintType) {
        ...
        result := ComCall(69, this, "uint", gpc, ptGenericParamMarshal, ptGenericParam, ptkConstraintTypeMarshal, ptkConstraintType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-getpekind
     */
    GetPEKind(pdwPEKind, pdwMAchine) {
        ...
        result := ComCall(70, this, pdwPEKindMarshal, pdwPEKind, pdwMAchineMarshal, pdwMAchine, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-getversionstring
     */
    GetVersionString(pwzBuf, ccBufSize, pccBufSize) {
        ...
        result := ComCall(71, this, "ptr", pwzBuf, "uint", ccBufSize, pccBufSizeMarshal, pccBufSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rometadataapi/nf-rometadataapi-imetadataimport2-enummethodspecs
     */
    EnumMethodSpecs(phEnum, tk, rMethodSpecs, cMax, pcMethodSpecs) {
        ...
        result := ComCall(72, this, phEnumMarshal, phEnum, "uint", tk, rMethodSpecsMarshal, rMethodSpecs, "uint", cMax, pcMethodSpecsMarshal, pcMethodSpecs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
