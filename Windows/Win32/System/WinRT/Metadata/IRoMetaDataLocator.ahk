 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/roparameterizediid/ns-roparameterizediid-irometadatalocator
...
class IRoMetaDataLocator extends Win32ComInterface{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/ntquery/nf-ntquery-locatecatalogsw
     */
    Locate(nameElement, metaDataDestination) {
        nameElement := nameElement is String ? StrPtr(nameElement) : nameElement

        result := ComCall(0, this, "ptr", nameElement, "ptr", metaDataDestination, "int")
        if(result != 0) {
