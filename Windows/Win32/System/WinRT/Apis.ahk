 ...
 * @param {AgileReferenceOptions} options The registration options.
 ...
 * @since windows8.1
 */
export RoGetAgileReference(options, riid, pUnk) {
    result := DllCall("OLE32.dll\RoGetAgileReference", AgileReferenceOptions, options, Guid.Ptr, riid, "ptr", pUnk, "ptr*", &ppAgileReference := 0, "HRESULT")
 ...
 * @param {HSTRING} _string Type: [in] **[HSTRING](/windows/win32/winrt/hstring)**
 * 
 ...
 * @param {HSTRING} _string Type: [in, optional] **[HSTRING](/windows/win32/winrt/hstring)**
 * 
 ...
 * @returns {Integer} Type: [out] <b>INT32*</b>
 * 
 ...
 * @since windows8.0
 */
export WindowsPromoteStringBuffer(bufferHandle) {
    _string := HSTRING.Owned()
    result := DllCall("api-ms-win-core-winrt-string-l1-1-0.dll\WindowsPromoteStringBuffer", HSTRING_BUFFER, bufferHandle, HSTRING.Ptr, _string, "HRESULT")
    return _string
}
 ...
 * @param {Pointer<Void>} _context [in, optional]
 * 
 ...
 */
export CreateDispatcherQueueController(options) {
    result := DllCall("CoreMessaging.dll\CreateDispatcherQueueController", DispatcherQueueOptions, options, "ptr*", &dispatcherQueueController := 0, "HRESULT")
 ...
 * @param {RO_INIT_TYPE} initType Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/roapi/ne-roapi-ro_init_type">RO_INIT_TYPE</a></b>
 * 
 ...
 * @since windows8.0
 */
export RoInitialize(initType) {
    result := DllCall("api-ms-win-core-winrt-l1-1-0.dll\RoInitialize", RO_INIT_TYPE, initType, "HRESULT")
    return result
}
 ...
 * @since windows8.0
 */
export RoActivateInstance(activatableClassId) {
    result := DllCall("api-ms-win-core-winrt-l1-1-0.dll\RoActivateInstance", HSTRING, activatableClassId, "ptr*", &instance := 0, "HRESULT")
 ...
 * @since windows8.0
 */
export RoRevokeActivationFactories(cookie) {
    DllCall("api-ms-win-core-winrt-l1-1-0.dll\RoRevokeActivationFactories", RO_REGISTRATION_COOKIE, cookie)
}
 ...
 * @since windows8.0
 */
export RoGetActivationFactory(activatableClassId, iid) {
    result := DllCall("api-ms-win-core-winrt-l1-1-0.dll\RoGetActivationFactory", HSTRING, activatableClassId, Guid.Ptr, iid, "ptr*", &factory := 0, "HRESULT")
    return factory
}
 ...
 * @since windows8.0
 */
export RoUnregisterForApartmentShutdown(regCookie) {
    result := DllCall("api-ms-win-core-winrt-l1-1-0.dll\RoUnregisterForApartmentShutdown", APARTMENT_SHUTDOWN_REGISTRATION_COOKIE, regCookie, "HRESULT")
    return result
}
 ...
 * @since windows8.0
 */
export RoGetApartmentIdentifier() {
 ...
 * @since windows8.0
 */
export RoGetErrorReportingFlags() {
 ...
 * @param {PWSTR} _reference Type: <b>PCWSTR</b>
 * 
 ...
 * @since windows8.0
 */
export RoResolveRestrictedErrorInfoReference(_reference) {
 ...
 * <div> </div>
 * @param {HRESULT} _error Type: <b>HRESULT</b>
 * 
 ...
 * @since windows8.0
 */
export RoCaptureErrorContext(hr) {
 ...
 * @since windows8.0
 */
export RoFailFastWithErrorContext(hrError) {
 ...
 * @param {HRESULT} _error The error code associated with the error condition. If <i>error</i> is a success code, like <b>S_OK</b>, the function has no effect and returns <b>FALSE</b>. This behavior enables calling the function when no error has occurred without causing an unwanted error message.
 ...
 */
export RoReportUnhandledError(pRestrictedErrorInfo) {
 ...
 * @param {Pointer<Void>} _context Custom context data.
 ...
 */
export RoGetMatchingRestrictedErrorInfo(hrIn) {
 ...
 */
export RoReportFailedDelegate(punkDelegate, pRestrictedErrorInfo) {
 ...
 * @since windows8.0
 */
export IsErrorPropagationEnabled() {
    result := DllCall("api-ms-win-core-winrt-error-l1-1-1.dll\IsErrorPropagationEnabled", BOOL)
    return result
}
 ...
 * @since windows8.0
 */
export CreateRandomAccessStreamOverStream(stream, options, riid) {
    result := DllCall("api-ms-win-shcore-stream-winrt-l1-1-0.dll\CreateRandomAccessStreamOverStream", "ptr", stream, BSOS_OPTIONS, options, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows8.0
 */
export CreateStreamOverRandomAccessStream(randomAccessStream, riid) {
    result := DllCall("api-ms-win-shcore-stream-winrt-l1-1-0.dll\CreateStreamOverRandomAccessStream", "ptr", randomAccessStream, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 */
export CreateControlInput(riid) {
    result := DllCall("Windows.UI.dll\CreateControlInput", Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 */
export CreateControlInputEx(pCoreWindow, riid) {
    result := DllCall("Windows.UI.dll\CreateControlInputEx", "ptr", pCoreWindow, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
