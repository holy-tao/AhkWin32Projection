 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/corewindow/nn-corewindow-icoreinputinterop
...
class ICoreInputInterop extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/corewindow/nf-corewindow-icoreinputinterop-setinputsource
     */
     ...
     * @param {Integer} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/corewindow/nf-corewindow-icoreinputinterop-put_messagehandled
     */
