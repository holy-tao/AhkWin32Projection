...
class IDDEInitializer extends IUnknown{
     ...
     * @param {Pointer<IShellItem>} execTarget 
     * @param {Pointer<IUnknown>} site 
    ...
    Initialize(fileExtensionOrProtocol, method, currentDirectory, execTarget, site, application, targetFile, arguments, verb) {
        ...
        result := ComCall(3, this, "ptr", fileExtensionOrProtocol, "int", method, "ptr", currentDirectory, "ptr", execTarget, "ptr", site, "ptr", application, "ptr", targetFile, "ptr", arguments, "ptr", verb, "int")
        if(result != 0)
