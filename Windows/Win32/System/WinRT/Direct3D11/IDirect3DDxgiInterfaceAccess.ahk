 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.directx.direct3d11.interop/ns-windows-graphics-directx-direct3d11-interop-idirect3ddxgiinterfaceaccess
...
class IDirect3DDxgiInterfaceAccess extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/windows.graphics.directx.direct3d11.interop/nf-windows-graphics-directx-direct3d11-interop-idirect3ddxgiinterfaceaccess-getinterface
     */
    GetInterface(iid) {
        result := ComCall(3, this, "ptr", iid, "ptr*", &p := 0, "int")
        if(result != 0) {
