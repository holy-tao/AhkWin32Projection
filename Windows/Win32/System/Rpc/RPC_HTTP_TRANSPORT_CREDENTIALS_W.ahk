 ...
 * @see https://learn.microsoft.com/windows/win32/api/rpcdce/ns-rpcdce-rpc_http_transport_credentials_w
 * @namespace Windows.Win32.System.Rpc
 * @charset Unicode
 */
export default struct RPC_HTTP_TRANSPORT_CREDENTIALS_W {
    #StructPack 8
