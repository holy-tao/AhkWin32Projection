 ...
 */
export default struct MIDL_ES_READ {
    value : IntPtr

    __value {
        set {
            if (value is MIDL_ES_READ) {
    ...
    /**
     * A MIDL_ES_READ that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MIDL_ES_READ {
        /**
         * Creates a MIDL_ES_READ pointer that invokes the given AHK function when called.
