 ...
 * @see https://learn.microsoft.com/windows/win32/api/rpcdce/ns-rpcdce-rpc_endpoint_templatew
    ...
    ProtSeq{
        get {
            if(!this.HasProp("__ProtSeq"))
                this.__ProtSeq := PWSTR(this.ptr + 8)
    ...
    Endpoint{
        get {
            if(!this.HasProp("__Endpoint"))
                this.__Endpoint := PWSTR(this.ptr + 16)
