 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api/rpcdce/ns-rpcdce-rpc_security_qos_v2_a
 * @namespace Windows.Win32.System.Rpc
 * @charset ANSI
 */
class RPC_SECURITY_QOS_V2_A extends Win32Struct {
    static sizeof => 32
    ...
    u {
        get {
            if(!this.HasProp("__u"))
                this.__u := RPC_SECURITY_QOS_V2_A._u_e__Union(24, this)
            return this.__u
        }
    }
}
