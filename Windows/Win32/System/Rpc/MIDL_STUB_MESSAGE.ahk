 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rpcndr/ns-rpcndr-midl_stub_message
    ...
    pAsyncMsg{
        get {
            if(!this.HasProp("__pAsyncMsg"))
                this.__pAsyncMsg := PNDR_ASYNC_MESSAGE(288, this)
    ...
    pCorrInfo{
        get {
            if(!this.HasProp("__pCorrInfo"))
                this.__pCorrInfo := PNDR_CORRELATION_INFO(296, this)
