...
/**
 * The RPC_HTTP_TRANSPORT_CREDENTIALS_V2 structure defines additional credentials to authenticate to an RPC proxy server or HTTP proxy server when using RPC/HTTP.RPC_HTTP_TRANSPORT_CREDENTIALS_V2 extends RPC_HTTP_TRANSPORT_CREDENTIALS by allowing authentication against an HTTP proxy server.
 * @remarks
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//rpcdce/ns-rpcdce-rpc_http_transport_credentials_v2_w
 * @namespace Windows.Win32.System.Rpc
 * @version v4.0.30319
 * @charset Unicode
 */
class RPC_HTTP_TRANSPORT_CREDENTIALS_V2_W extends Win32Struct
{
    static sizeof => 64
