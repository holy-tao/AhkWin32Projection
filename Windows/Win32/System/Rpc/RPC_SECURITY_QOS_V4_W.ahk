 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api/rpcdce/ns-rpcdce-rpc_security_qos_v4_w
 * @namespace Windows.Win32.System.Rpc
 * @charset Unicode
 */
export default struct RPC_SECURITY_QOS_V4_W {
    #StructPack 8
