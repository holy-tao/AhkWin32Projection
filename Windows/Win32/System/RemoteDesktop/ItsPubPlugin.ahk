 ...
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nn-tspubplugincom-itspubplugin
...
class ItsPubPlugin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-getresourcelist
     */
    GetResourceList(userID, pceAppListSize, resourceList) {
        ...
        result := ComCall(3, this, "ptr", userID, pceAppListSizeMarshal, pceAppListSize, resourceListMarshal, resourceList, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-getresource
     */
    GetResource(alias, flags) {
        alias := alias is String ? StrPtr(alias) : alias

        resource := pluginResource()
        result := ComCall(4, this, "ptr", alias, "int", flags, "ptr", resource, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-getcachelastupdatetime
     */
    GetCacheLastUpdateTime() {
        result := ComCall(5, this, "uint*", &lastUpdateTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-get_pluginname
     */
    get_pluginName() {
        pVal := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-get_pluginversion
     */
    get_pluginVersion() {
        pVal := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugincom/nf-tspubplugincom-itspubplugin-resolveresource
     */
    ResolveResource(resourceLocation, endPointName, userID, alias) {
        ...
        result := ComCall(8, this, "uint*", &resourceType_ := 0, "ptr", resourceLocation, "ptr", endPointName, "ptr", userID, "ptr", alias, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
