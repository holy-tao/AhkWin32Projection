 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nn-wtsprotocol-iwrdsprotocolconnectioncallback
...
class IWRdsProtocolConnectionCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocolconnectioncallback-onready
     */
    OnReady() {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocolconnectioncallback-brokenconnection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocolconnectioncallback-stopscreenupdates
     */
    StopScreenUpdates() {
     ...
     * <li>Do not block on this method before replying to another call by the Remote Desktop Services service.</li>
     * </ul>
     * @param {Pointer<WTS_SMALL_RECT>} rect_ A <a href="https://docs.microsoft.com/windows/desktop/api/wtsdefs/ns-wtsdefs-wts_small_rect">WRDS_SMALL_RECT</a> structure that contains the x and y coordinates of the screen to redraw. A value of <b>NULL</b> requests that the entire screen be redrawn.
     * @returns {HRESULT} If the function succeeds, the function returns <b>S_OK</b>.
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. Possible values include, but are not limited to, those in the following list. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocolconnectioncallback-redrawwindow
     */
    RedrawWindow(rect_) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocolconnectioncallback-getconnectionid
     */
    GetConnectionId() {
        result := ComCall(7, this, "uint*", &pConnectionId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
