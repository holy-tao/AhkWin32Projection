 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tsgpolicyengine/nn-tsgpolicyengine-itsgauthorizeconnectionsink
...
class ITSGAuthorizeConnectionSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tsgpolicyengine/nf-tsgpolicyengine-itsgauthorizeconnectionsink-onconnectionauthorized
     */
    OnConnectionAuthorized(hrIn, mainSessionId, cbSoHResponse, pbSoHResponse, idleTimeout, sessionTimeout, sessionTimeoutAction, trustClass, policyAttributes) {
        ...
        result := ComCall(3, this, "int", hrIn, "ptr", mainSessionId, "uint", cbSoHResponse, pbSoHResponseMarshal, pbSoHResponse, "uint", idleTimeout, "uint", sessionTimeout, "int", sessionTimeoutAction, "int", trustClass, policyAttributesMarshal, policyAttributes, "int")
        if(result != 0) {
