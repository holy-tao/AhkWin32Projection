 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//wtsapi32/ns-wtsapi32-wts_session_infow
 * @namespace Windows.Win32.System.RemoteDesktop
 * @version v4.0.30319
 * @charset Unicode
 */
class WTS_SESSION_INFOW extends Win32Struct
{
    static sizeof => 24
    ...
    pWinStationName{
        get {
            if(!this.HasProp("__pWinStationName"))
                this.__pWinStationName := PWSTR(this.ptr + 8)
