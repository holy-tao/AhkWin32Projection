 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/workspaceruntime/nn-workspaceruntime-iworkspaceregistration
...
class IWorkspaceRegistration extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceruntime/nf-workspaceruntime-iworkspaceregistration-addresource
     */
    AddResource(pUnk) {
        result := ComCall(3, this, "ptr", pUnk, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceruntime/nf-workspaceruntime-iworkspaceregistration-removeresource
     */
    RemoveResource(dwCookieConnection) {
        result := ComCall(4, this, "uint", dwCookieConnection, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
