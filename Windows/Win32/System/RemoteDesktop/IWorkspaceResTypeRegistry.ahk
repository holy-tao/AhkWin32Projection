 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nn-workspaceax-iworkspacerestyperegistry
...
class IWorkspaceResTypeRegistry extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nf-workspaceax-iworkspacerestyperegistry-addresourcetype
     */
    AddResourceType(fMachineWide, bstrFileExtension, bstrLauncher) {
        if(bstrFileExtension is String) {
            pin := BSTR.Alloc(bstrFileExtension)
            bstrFileExtension := pin.Value
        }
        if(bstrLauncher is String) {
            pin := BSTR.Alloc(bstrLauncher)
            bstrLauncher := pin.Value
        }
     ...
     *    for example, ".txt".
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nf-workspaceax-iworkspacerestyperegistry-deleteresourcetype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nf-workspaceax-iworkspacerestyperegistry-getregisteredfileextensions
     */
    GetRegisteredFileExtensions(fMachineWide) {
        result := ComCall(9, this, "short", fMachineWide, "ptr*", &psaFileExtensions := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nf-workspaceax-iworkspacerestyperegistry-getresourcetypeinfo
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/workspaceax/nf-workspaceax-iworkspacerestyperegistry-modifyresourcetype
     */
