 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wrdsgraphicschannels/nn-wrdsgraphicschannels-iwrdsgraphicschannelmanager
...
class IWRdsGraphicsChannelManager extends IUnknown{
     ...
     * @param {Integer} channelType_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/wrdsgraphicschannels/ne-wrdsgraphicschannels-wrdsgraphicschanneltype">WRdsGraphicsChannelType</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wrdsgraphicschannels/nf-wrdsgraphicschannels-iwrdsgraphicschannelmanager-createchannel
     */
    CreateChannel(pszChannelName, channelType_) {
        pszChannelNameMarshal := pszChannelName is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, pszChannelNameMarshal, pszChannelName, "int", channelType_, "ptr*", &ppVirtualChannel := 0, "int")
        if(result != 0) {
