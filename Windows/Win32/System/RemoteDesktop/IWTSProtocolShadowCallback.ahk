 ...
 * @see https://learn.microsoft.com/windows/win32/api/wtsprotocol/nn-wtsprotocol-iwtsprotocolshadowcallback
 * @namespace Windows.Win32.System.RemoteDesktop
 */
export default struct IWTSProtocolShadowCallback extends IUnknown {
    /**
     ...
     * used for IWTSProtocolShadowCallback interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWTSProtocolShadowCallback.Vtbl()
        }
    ...
    Query(iid) {
        if (IWTSProtocolShadowCallback.IID.Equals(iid)) {
            return true
        }
