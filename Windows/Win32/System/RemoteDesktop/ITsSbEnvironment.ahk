 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nn-sbtsv-itssbenvironment
...
class ITsSbEnvironment extends IUnknown{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nf-sbtsv-itssbenvironment-get_name
     */
    get_Name() {
        pVal := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nf-sbtsv-itssbenvironment-get_serverweight
     */
    get_ServerWeight() {
        result := ComCall(4, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nf-sbtsv-itssbenvironment-get_environmentpropertyset
     */
    get_EnvironmentPropertySet() {
        result := ComCall(5, this, "ptr*", &ppPropertySet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nf-sbtsv-itssbenvironment-put_environmentpropertyset
     */
