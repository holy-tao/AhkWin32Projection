 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nn-sbtsv-itssbplacementnotifysink
...
class ITsSbPlacementNotifySink extends ITsSbBaseNotifySink{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sbtsv/nf-sbtsv-itssbplacementnotifysink-onqueryenvironmentcompleted
     */
    OnQueryEnvironmentCompleted(pEnvironment) {
        result := ComCall(5, this, "ptr", pEnvironment, "int")
        if(result != 0) {
