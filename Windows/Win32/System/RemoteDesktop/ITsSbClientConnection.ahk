...
export default struct ITsSbClientConnection extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_LoadBalanceResult := CallbackCreate(ObjBindMethod(implObj, "get_LoadBalanceResult"), flags, 2)
        this.vtbl.get_FarmName := CallbackCreate(ObjBindMethod(implObj, "get_FarmName"), flags, 2)
        this.vtbl.PutContext := CallbackCreate(ObjBindMethod(implObj, "PutContext"), flags, 4)
        this.vtbl.GetContext := CallbackCreate(ObjBindMethod(implObj, "GetContext"), flags, 3)
        this.vtbl.get_Environment := CallbackCreate(ObjBindMethod(implObj, "get_Environment"), flags, 2)
        this.vtbl.get_ConnectionError := CallbackCreate(ObjBindMethod(implObj, "get_ConnectionError"), flags, 1)
        this.vtbl.get_SamUserAccount := CallbackCreate(ObjBindMethod(implObj, "get_SamUserAccount"), flags, 2)
        this.vtbl.get_ClientConnectionPropertySet := CallbackCreate(ObjBindMethod(implObj, "get_ClientConnectionPropertySet"), flags, 2)
        this.vtbl.get_IsFirstAssignment := CallbackCreate(ObjBindMethod(implObj, "get_IsFirstAssignment"), flags, 2)
        this.vtbl.get_RdFarmType := CallbackCreate(ObjBindMethod(implObj, "get_RdFarmType"), flags, 2)
        this.vtbl.get_UserSidString := CallbackCreate(ObjBindMethod(implObj, "get_UserSidString"), flags, 2)
        this.vtbl.GetDisconnectedSession := CallbackCreate(ObjBindMethod(implObj, "GetDisconnectedSession"), flags, 2)
    }
