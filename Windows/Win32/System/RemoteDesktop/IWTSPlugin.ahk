 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tsvirtualchannels/nn-tsvirtualchannels-iwtsplugin
...
class IWTSPlugin extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tsvirtualchannels/nf-tsvirtualchannels-iwtsplugin-initialize
     */
    Initialize(pChannelMgr) {
        result := ComCall(3, this, "ptr", pChannelMgr, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tsvirtualchannels/nf-tsvirtualchannels-iwtsplugin-connected
     */
    Connected() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tsvirtualchannels/nf-tsvirtualchannels-iwtsplugin-disconnected
     */
    Disconnected(dwDisconnectCode) {
        result := ComCall(5, this, "uint", dwDisconnectCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns <b>S_OK</b> if the call completes successfully. Results in no action if the call fails.
     * @see https://learn.microsoft.com/windows/win32/api//content/tsvirtualchannels/nf-tsvirtualchannels-iwtsplugin-terminated
     */
    Terminated() {
