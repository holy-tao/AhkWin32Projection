...
#Include .\WTSINFOEX_LEVEL_W.ahk

/**
 * Contains a WTSINFOEX_LEVEL union that contains extended information about a Remote Desktop Services session. (Unicode)
 * @remarks
 * > [!NOTE]
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wtsapi32/ns-wtsapi32-wtsinfoexw
 * @namespace Windows.Win32.System.RemoteDesktop
 * @version v4.0.30319
 * @charset Unicode
 */
class WTSINFOEXW extends Win32Struct
{
    static sizeof => 232
    ...
    Data{
        get {
            if(!this.HasProp("__Data"))
                this.__Data := WTSINFOEX_LEVEL_W(8, this)
            return this.__Data
        }
    }
}
