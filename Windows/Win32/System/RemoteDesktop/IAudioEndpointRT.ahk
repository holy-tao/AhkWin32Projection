 ...
 *     applications.
 * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nn-audioengineendpoint-iaudioendpointrt
...
class IAudioEndpointRT extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointrt-getcurrentpadding
     */
     ...
     * The Remote Desktop Services AudioEndpoint API is for use in Remote Desktop scenarios; it is not for client applications.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointrt-processingcomplete
     */
    ProcessingComplete() {
        ComCall(4, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointrt-setpininactive
     */
    SetPinInactive() {
     ...
     * The Remote Desktop Services AudioEndpoint API is for use in Remote Desktop scenarios; it is not for client applications.
     * @returns {HRESULT} If the method succeeds, it returns <b>S_OK</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/audioengineendpoint/nf-audioengineendpoint-iaudioendpointrt-setpinactive
     */
    SetPinActive() {
