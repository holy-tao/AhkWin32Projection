 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nn-wtsprotocol-iwrdsprotocollistenercallback
...
class IWRdsProtocolListenerCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wtsprotocol/nf-wtsprotocol-iwrdsprotocollistenercallback-onconnected
     */
    OnConnected(pConnection, pWRdsConnectionSettings) {
        result := ComCall(3, this, "ptr", pConnection, "ptr", pWRdsConnectionSettings, "ptr*", &pCallback := 0, "int")
        if(result != 0) {
