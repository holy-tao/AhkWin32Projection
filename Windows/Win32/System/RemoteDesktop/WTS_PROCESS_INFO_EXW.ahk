...
/**
 * Contains extended information about a process running on a Remote Desktop Session Host (RD Session Host) server. (Unicode)
 * @remarks
 * > [!NOTE]
 ...
 * @see https://learn.microsoft.com/windows/win32/api/wtsapi32/ns-wtsapi32-wts_process_info_exw
 * @namespace Windows.Win32.System.RemoteDesktop
 * @version v4.0.30319
 * @charset Unicode
 */
class WTS_PROCESS_INFO_EXW extends Win32Struct
{
    static sizeof => 64
    ...
    pProcessName{
        get {
            if(!this.HasProp("__pProcessName"))
                this.__pProcessName := PWSTR(this.ptr + 8)
