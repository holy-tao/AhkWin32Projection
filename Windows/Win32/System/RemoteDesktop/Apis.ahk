...
;@region Methods
    ...
    static WTSIsChildSessionsEnabled(pbEnabled) {
        ...
        result := DllCall("WTSAPI32.dll\WTSIsChildSessionsEnabled", pbEnabledMarshal, pbEnabled, "int")
        return result
    }
    ...
    static WTSSetRenderHint(pRenderHintID, hwndOwner, renderHintType, cbHintDataLength, pHintData) {
        ...
        result := DllCall("WTSAPI32.dll\WTSSetRenderHint", pRenderHintIDMarshal, pRenderHintID, "ptr", hwndOwner, "uint", renderHintType, "uint", cbHintDataLength, "ptr", pHintData, "HRESULT")
        return result
    }
