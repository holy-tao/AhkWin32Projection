 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tsgauthenticationengine/nn-tsgauthenticationengine-itsgauthenticateusersink
...
class ITSGAuthenticateUserSink extends IUnknown{
     ...
     * @param {Pointer} context_ A pointer to  a <b>ULONG</b> that contains  a value that identifies this connection. Use the value that was passed by the <a href="https://docs.microsoft.com/windows/desktop/api/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticationengine-authenticateuser">AuthenticateUser</a> method.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticateusersink-onuserauthenticated
     */
    OnUserAuthenticated(userName, userDomain, context_, userToken) {
        ...
        result := ComCall(3, this, "ptr", userName, "ptr", userDomain, "ptr", context_, "ptr", userToken, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticateusersink-onuserauthenticationfailed
     */
    OnUserAuthenticationFailed(context_, genericErrorCode, specificErrorCode) {
        result := ComCall(4, this, "ptr", context_, "int", genericErrorCode, "int", specificErrorCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer} context_ A pointer to  a <b>ULONG</b> that contains  a value specific to this connection. Use 
     ...
     *        method.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticateusersink-reauthenticateuser
     */
    ReauthenticateUser(context_) {
        result := ComCall(5, this, "ptr", context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer} context_ A pointer to  a <b>ULONG</b> that contains  a value that identifies the connection to disconnect. Use the value that was passed by the <a href="https://docs.microsoft.com/windows/desktop/api/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticationengine-authenticateuser">AuthenticateUser</a> method.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tsgauthenticationengine/nf-tsgauthenticationengine-itsgauthenticateusersink-disconnectuser
     */
    DisconnectUser(context_) {
        result := ComCall(6, this, "ptr", context_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
