 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugin2com/nn-tspubplugin2com-itspubplugin2
...
class ItsPubPlugin2 extends ItsPubPlugin{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugin2com/nf-tspubplugin2com-itspubplugin2-getresource2list
     */
    GetResource2List(userID, pceAppListSize, resourceList) {
        ...
        result := ComCall(9, this, "ptr", userID, pceAppListSizeMarshal, pceAppListSize, resourceListMarshal, resourceList, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugin2com/nf-tspubplugin2com-itspubplugin2-getresource2
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugin2com/nf-tspubplugin2com-itspubplugin2-resolvepersonaldesktop
     */
    ResolvePersonalDesktop(userId, poolId, ePdResolutionType, endPointName) {
        ...
        result := ComCall(11, this, "ptr", userId, "ptr", poolId, "int", ePdResolutionType, "int*", &pPdAssignmentType := 0, "ptr", endPointName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tspubplugin2com/nf-tspubplugin2com-itspubplugin2-deletepersonaldesktopassignment
     */
