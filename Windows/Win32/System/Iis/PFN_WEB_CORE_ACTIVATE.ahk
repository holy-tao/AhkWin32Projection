 ...
 * @version v4.0.30319
 */
class PFN_WEB_CORE_ACTIVATE extends IUnknown {
     ...
     */
    Invoke(pszAppHostConfigFile, pszRootWebConfigFile, pszInstanceName) {
        ...
        result := ComCall(3, this, "ptr", pszAppHostConfigFile, "ptr", pszRootWebConfigFile, "ptr", pszInstanceName, "int")
        if(result != 0) {
