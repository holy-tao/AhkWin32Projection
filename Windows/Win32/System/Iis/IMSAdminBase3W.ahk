...
class IMSAdminBase3W extends IMSAdminBase2W{
     ...
     * @param {Pointer<UInt32>} pcchMDRequiredBufferSize 
     * @returns {HRESULT} 
     */
    GetChildPaths(hMDHandle, pszMDPath, cchMDBufferSize, pszBuffer, pcchMDRequiredBufferSize) {
        ...
        result := ComCall(40, this, "uint", hMDHandle, "ptr", pszMDPath, "uint", cchMDBufferSize, "ptr", pszBuffer, "uint*", pcchMDRequiredBufferSize, "int")
        if(result != 0)
