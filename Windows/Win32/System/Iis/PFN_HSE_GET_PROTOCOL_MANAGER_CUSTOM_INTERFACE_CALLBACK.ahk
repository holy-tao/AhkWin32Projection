 ...
 * @version v4.0.30319
 */
class PFN_HSE_GET_PROTOCOL_MANAGER_CUSTOM_INTERFACE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(pszProtocolManagerDll, pszProtocolManagerDllInitFunction, dwCustomInterfaceId, ppCustomInterface) {
        ...
        result := ComCall(3, this, "ptr", pszProtocolManagerDll, "ptr", pszProtocolManagerDllInitFunction, "uint", dwCustomInterfaceId, ppCustomInterfaceMarshal, ppCustomInterface, "int")
        if(result != 0) {
