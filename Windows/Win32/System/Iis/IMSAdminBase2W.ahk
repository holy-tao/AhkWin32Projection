...
class IMSAdminBase2W extends IMSAdminBaseW{
    ...
    EnumHistory(pszMDHistoryLocation, pdwMDMajorVersion, pdwMDMinorVersion, pftMDHistoryTime, dwMDEnumIndex) {
        ...
        result := ComCall(39, this, "ptr", pszMDHistoryLocation, pdwMDMajorVersionMarshal, pdwMDMajorVersion, pdwMDMinorVersionMarshal, pdwMDMinorVersion, "ptr", pftMDHistoryTime, "uint", dwMDEnumIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
