 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nn-winsatcominterfacei-iwinsatinitiateevents
...
class IWinSATInitiateEvents extends IUnknown{
     ...
     * @param {HRESULT} hresult_ The return value of the assessment. The following are the possible return values of the assessment.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iwinsatinitiateevents-winsatcomplete
     */
    WinSATComplete(hresult_, strDescription) {
        strDescription := strDescription is String ? StrPtr(strDescription) : strDescription

        result := ComCall(3, this, "int", hresult_, "ptr", strDescription, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method should return  S_OK; the value is ignored.
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iwinsatinitiateevents-winsatupdate
     */
    WinSATUpdate(uCurrentTick, uTickTotal, strCurrentState) {
        ...
        result := ComCall(4, this, "uint", uCurrentTick, "uint", uTickTotal, "ptr", strCurrentState, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
