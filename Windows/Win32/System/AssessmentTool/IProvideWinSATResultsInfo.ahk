 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nn-winsatcominterfacei-iprovidewinsatresultsinfo
...
class IProvideWinSATResultsInfo extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iprovidewinsatresultsinfo-getassessmentinfo
     */
    GetAssessmentInfo(assessment) {
        result := ComCall(7, this, "int", assessment, "ptr*", &ppinfo := 0, "int")
        if(result != 0) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iprovidewinsatresultsinfo-get_assessmentstate
     */
    get_AssessmentState() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iprovidewinsatresultsinfo-get_assessmentdatetime
     */
    get_AssessmentDateTime() {
        fileTime_ := VARIANT()
        result := ComCall(9, this, "ptr", fileTime_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iprovidewinsatresultsinfo-get_systemrating
     */
    get_SystemRating() {
        result := ComCall(10, this, "float*", &level := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/winsatcominterfacei/nf-winsatcominterfacei-iprovidewinsatresultsinfo-get_ratingstatedesc
     */
    get_RatingStateDesc() {
        description := BSTR()
