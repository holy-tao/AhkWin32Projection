 ...
 * @version v4.0.30319
 */
class PWLDP_CANEXECUTEFILE_API extends IUnknown {
     ...
     */
    Invoke(host, options, fileHandle, auditInfo) {
        ...
        result := ComCall(3, this, "ptr", host, "int", options, "ptr", fileHandle, "ptr", auditInfo, "int*", &result_ := 0, "int")
        if(result != 0) {
