 ...
 * @version v4.0.30319
 */
class PDELAYLOAD_FAILURE_DLL_CALLBACK extends IUnknown {
     ...
     */
    Invoke(NotificationReason, DelayloadInfo) {
        result := ComCall(3, this, "uint", NotificationReason, "ptr", DelayloadInfo, "ptr")
        return result
    }
}
