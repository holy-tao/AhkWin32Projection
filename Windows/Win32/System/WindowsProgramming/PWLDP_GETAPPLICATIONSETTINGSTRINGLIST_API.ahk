 ...
 */
export default struct PWLDP_GETAPPLICATIONSETTINGSTRINGLIST_API {
    value : IntPtr

    __value {
        set {
            if (value is PWLDP_GETAPPLICATIONSETTINGSTRINGLIST_API) {
    ...
    /**
     * A PWLDP_GETAPPLICATIONSETTINGSTRINGLIST_API that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWLDP_GETAPPLICATIONSETTINGSTRINGLIST_API {
        /**
         * Creates a PWLDP_GETAPPLICATIONSETTINGSTRINGLIST_API pointer that invokes the given AHK function when called.
