 ...
 * @version v4.0.30319
 */
class PWINSTATIONQUERYINFORMATIONW extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5) {
        ...
        result := ComCall(3, this, "ptr", param0, "uint", param1, "int", param2, param3Marshal, param3, "uint", param4, param5Marshal, param5, "char")
        return result
    }
}
