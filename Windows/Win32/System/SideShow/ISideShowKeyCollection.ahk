 ...
 */
export default struct ISideShowKeyCollection extends IUnknown {
    /**
     ...
     * used for ISideShowKeyCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISideShowKeyCollection.Vtbl()
        }
    ...
    Query(iid) {
        if (ISideShowKeyCollection.IID.Equals(iid)) {
            return true
        }
