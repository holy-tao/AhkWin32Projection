...
class ISideShowSession extends IUnknown{
    ...
    RegisterContent(in_applicationId, in_endpointId, out_ppIContent) {
        result := ComCall(3, this, "ptr", in_applicationId, "ptr", in_endpointId, "ptr", out_ppIContent, "int")
        if(result != 0)
    ...
    RegisterNotifications(in_applicationId, out_ppINotification) {
        result := ComCall(4, this, "ptr", in_applicationId, "ptr", out_ppINotification, "int")
        if(result != 0)
            throw OSError(result)
