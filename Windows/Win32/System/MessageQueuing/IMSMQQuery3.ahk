...
#Import ".\IMSMQQueueInfos3.ahk" { IMSMQQueueInfos3 }
 ...
 */
export default struct IMSMQQuery3 extends IDispatch {
    /**
     ...
     * used for IMSMQQuery3 interfaces
    */
