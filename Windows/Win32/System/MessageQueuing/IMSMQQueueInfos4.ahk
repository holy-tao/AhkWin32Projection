 ...
 */
export default struct IMSMQQueueInfos4 extends IDispatch {
    /**
     ...
     * used for IMSMQQueueInfos4 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMSMQQueueInfos4.Vtbl()
        }
    ...
    Query(iid) {
        if (IMSMQQueueInfos4.IID.Equals(iid)) {
            return true
        }
