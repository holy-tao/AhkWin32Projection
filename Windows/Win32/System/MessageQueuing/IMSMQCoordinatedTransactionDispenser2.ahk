 ...
 */
export default struct IMSMQCoordinatedTransactionDispenser2 extends IDispatch {
    /**
     ...
     * used for IMSMQCoordinatedTransactionDispenser2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMSMQCoordinatedTransactionDispenser2.Vtbl()
        }
    ...
    Query(iid) {
        if (IMSMQCoordinatedTransactionDispenser2.IID.Equals(iid)) {
            return true
        }
