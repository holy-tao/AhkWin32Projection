 ...
 */
export default struct IMSMQTransactionDispenser3 extends IDispatch {
    /**
     * The interface identifier for IMSMQTransactionDispenser3
     * @type {Guid}
     */
    static IID := Guid("{eba96b15-2168-11d3-898c-00e02c074f6b}")
     ...
     * used for IMSMQTransactionDispenser3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMSMQTransactionDispenser3.Vtbl()
        }
    ...
    Query(iid) {
        if (IMSMQTransactionDispenser3.IID.Equals(iid)) {
            return true
        }
