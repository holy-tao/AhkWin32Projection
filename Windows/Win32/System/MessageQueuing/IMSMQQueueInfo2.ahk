 ...
 */
export default struct IMSMQQueueInfo2 extends IDispatch {
    /**
     ...
     * used for IMSMQQueueInfo2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMSMQQueueInfo2.Vtbl()
        }
    ...
    Query(iid) {
        if (IMSMQQueueInfo2.IID.Equals(iid)) {
            return true
        }
