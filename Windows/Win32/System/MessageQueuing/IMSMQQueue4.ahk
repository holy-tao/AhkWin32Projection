...
class IMSMQQueue4 extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<IMSMQEvent3>} Event 
    ...
    ReceiveByLookupId(LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(27, this, "ptr", LookupId, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReceiveNextByLookupId(LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(28, this, "ptr", LookupId, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReceivePreviousByLookupId(LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(29, this, "ptr", LookupId, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReceiveFirstByLookupId(Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(30, this, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReceiveLastByLookupId(Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(31, this, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekByLookupId(LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(32, this, "ptr", LookupId, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekNextByLookupId(LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(33, this, "ptr", LookupId, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekPreviousByLookupId(LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(34, this, "ptr", LookupId, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekFirstByLookupId(WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(35, this, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PeekLastByLookupId(WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(36, this, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_IsOpen2(pisOpen) {
        result := ComCall(38, this, "ptr", pisOpen, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReceiveByLookupIdAllowPeek(LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg) {
        result := ComCall(39, this, "ptr", LookupId, "ptr", Transaction, "ptr", WantDestinationQueue, "ptr", WantBody, "ptr", WantConnectorType, "ptr", ppmsg, "int")
        if(result != 0)
            throw OSError(result)
