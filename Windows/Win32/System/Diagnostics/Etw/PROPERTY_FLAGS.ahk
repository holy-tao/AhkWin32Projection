...
class PROPERTY_FLAGS extends Win32Enum {
     ...
     * Native name: PropertyParamLength
     * @type {Integer (Int32)}
     */
    static ParamLength => 2
     ...
     * Native name: PropertyParamCount
     * @type {Integer (Int32)}
     */
    static ParamCount => 4
     ...
     * Native name: PropertyParamFixedLength
     * @type {Integer (Int32)}
     */
    static ParamFixedLength => 16
     ...
     * <div> </div>
     * Native name: PropertyParamFixedCount
     * @type {Integer (Int32)}
     */
    static ParamFixedCount => 32

    /**
     * Indicates that the <b>Tags</b> field contains valid field tag data.
     * Native name: PropertyHasTags
     * @type {Integer (Int32)}
     */
    static HasTags => 64
     ...
     * <div> </div>
     * Native name: PropertyHasCustomSchema
     * @type {Integer (Int32)}
     */
    static HasCustomSchema => 128
}
