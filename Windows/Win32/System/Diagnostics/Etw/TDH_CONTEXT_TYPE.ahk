...
class TDH_CONTEXT_TYPE extends Win32Enum {
     ...
     * Native name: TDH_CONTEXT_WPP_TMFFILE
     * @type {Integer (Int32)}
     */
    static WPP_TMFFILE => 0
     ...
     * </ul>
     * Native name: TDH_CONTEXT_WPP_TMFSEARCHPATH
     * @type {Integer (Int32)}
     */
    static WPP_TMFSEARCHPATH => 1
     ...
     * Native name: TDH_CONTEXT_WPP_GMT
     * @type {Integer (Int32)}
     */
    static WPP_GMT => 2
     ...
     * Native name: TDH_CONTEXT_POINTERSIZE
     * @type {Integer (Int32)}
     */
    static POINTERSIZE => 3
     ...
     * <div> </div>
     * Native name: TDH_CONTEXT_PDB_PATH
     * @type {Integer (Int32)}
     */
    static PDB_PATH => 4
    ...
    /**
     * Reserved.
     * Native name: TDH_CONTEXT_MAXIMUM
     * @type {Integer (Int32)}
     */
    static MAXIMUM => 5
}
