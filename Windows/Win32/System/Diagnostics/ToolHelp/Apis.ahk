 ...
 * @since windows5.1.2600
 */
export Heap32ListFirst(hSnapshot, lphl) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Heap32ListFirst", HANDLE, hSnapshot, HEAPLIST32.Ptr, lphl, BOOL)
 ...
 * @since windows5.1.2600
 */
export Heap32ListNext(hSnapshot, lphl) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Heap32ListNext", HANDLE, hSnapshot, HEAPLIST32.Ptr, lphl, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Heap32Next(lphe) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Heap32Next", HEAPENTRY32.Ptr, lphe, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Process32FirstW(hSnapshot, lppe) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Process32FirstW", HANDLE, hSnapshot, PROCESSENTRY32W.Ptr, lppe, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Process32NextW(hSnapshot, lppe) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Process32NextW", HANDLE, hSnapshot, PROCESSENTRY32W.Ptr, lppe, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Process32First(hSnapshot, lppe) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Process32First", HANDLE, hSnapshot, PROCESSENTRY32.Ptr, lppe, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Process32Next(hSnapshot, lppe) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Process32Next", HANDLE, hSnapshot, PROCESSENTRY32.Ptr, lppe, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Thread32First(hSnapshot, lpte) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Thread32First", HANDLE, hSnapshot, THREADENTRY32.Ptr, lpte, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Thread32Next(hSnapshot, lpte) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Thread32Next", HANDLE, hSnapshot, THREADENTRY32.Ptr, lpte, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Module32FirstW(hSnapshot, lpme) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Module32FirstW", HANDLE, hSnapshot, MODULEENTRY32W.Ptr, lpme, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Module32NextW(hSnapshot, lpme) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Module32NextW", HANDLE, hSnapshot, MODULEENTRY32W.Ptr, lpme, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Module32First(hSnapshot, lpme) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Module32First", HANDLE, hSnapshot, MODULEENTRY32.Ptr, lpme, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export Module32Next(hSnapshot, lpme) {
    A_LastError := 0

    result := DllCall("KERNEL32.dll\Module32Next", HANDLE, hSnapshot, MODULEENTRY32.Ptr, lpme, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
