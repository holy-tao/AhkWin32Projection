...
class PSS_WALK_INFORMATION_CLASS extends Win32Enum {
     ...
     * Native name: PSS_WALK_AUXILIARY_PAGES
     * @type {Integer (Int32)}
     */
    static AUXILIARY_PAGES => 0
     ...
     * Native name: PSS_WALK_THREADS
     * @type {Integer (Int32)}
     */
    static THREADS => 3

    /**
     * Native name: PSS_WALK_THREAD_NAME
     * @type {Integer (Int32)}
     */
    static THREAD_NAME => 4
}
