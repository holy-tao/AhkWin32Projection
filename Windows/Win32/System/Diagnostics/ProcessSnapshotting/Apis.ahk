 ...
 * @since windows8.1
 */
export PssFreeSnapshot(ProcessHandle, SnapshotHandle) {
    result := DllCall("KERNEL32.dll\PssFreeSnapshot", HANDLE, ProcessHandle, HPSS, SnapshotHandle, UInt32)
    return result
}
 ...
 * @since windows8.1
 */
export PssWalkMarkerFree(WalkMarkerHandle) {
    result := DllCall("KERNEL32.dll\PssWalkMarkerFree", HPSSWALK, WalkMarkerHandle, UInt32)
    return result
}
 ...
 * @since windows8.1
 */
export PssWalkMarkerSeekToBeginning(WalkMarkerHandle) {
    result := DllCall("KERNEL32.dll\PssWalkMarkerSeekToBeginning", HPSSWALK, WalkMarkerHandle, UInt32)
    return result
}
