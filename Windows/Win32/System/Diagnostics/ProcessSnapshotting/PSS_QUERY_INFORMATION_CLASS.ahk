...
class PSS_QUERY_INFORMATION_CLASS extends Win32Enum {
     ...
     * Native name: PSS_QUERY_PROCESS_INFORMATION
     * @type {Integer (Int32)}
     */
    static PROCESS_INFORMATION => 0
     ...
     * Native name: PSS_QUERY_VA_CLONE_INFORMATION
     * @type {Integer (Int32)}
     */
    static VA_CLONE_INFORMATION => 1
     ...
     * Native name: PSS_QUERY_AUXILIARY_PAGES_INFORMATION
     * @type {Integer (Int32)}
     */
    static AUXILIARY_PAGES_INFORMATION => 2
     ...
     * Native name: PSS_QUERY_VA_SPACE_INFORMATION
     * @type {Integer (Int32)}
     */
    static VA_SPACE_INFORMATION => 3
     ...
     * Native name: PSS_QUERY_HANDLE_INFORMATION
     * @type {Integer (Int32)}
     */
    static HANDLE_INFORMATION => 4
     ...
     * Native name: PSS_QUERY_THREAD_INFORMATION
     * @type {Integer (Int32)}
     */
    static THREAD_INFORMATION => 5
     ...
     * Native name: PSS_QUERY_HANDLE_TRACE_INFORMATION
     * @type {Integer (Int32)}
     */
    static HANDLE_TRACE_INFORMATION => 6
     ...
     * Native name: PSS_QUERY_PERFORMANCE_COUNTERS
     * @type {Integer (Int32)}
     */
    static PERFORMANCE_COUNTERS => 7
}
