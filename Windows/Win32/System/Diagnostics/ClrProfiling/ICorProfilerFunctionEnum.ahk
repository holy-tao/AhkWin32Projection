 ...
 */
class ICorProfilerFunctionEnum extends IUnknown {
    ...
    Next(celt, ids, pceltFetched) {
        ...
        result := ComCall(7, this, "uint", celt, "ptr", ids, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
}
