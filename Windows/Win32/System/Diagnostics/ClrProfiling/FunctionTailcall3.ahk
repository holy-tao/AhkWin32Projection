 ...
 */
export default struct FunctionTailcall3 {
    value : IntPtr

    __value {
        set {
            if (value is FunctionTailcall3) {
    ...
    /**
     * A FunctionTailcall3 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FunctionTailcall3 {
        /**
         * Creates a FunctionTailcall3 pointer that invokes the given AHK function when called.
