 ...
 */
export default struct FunctionTailcall3WithInfo {
    value : IntPtr

    __value {
        set {
            if (value is FunctionTailcall3WithInfo) {
    ...
    /**
     * A FunctionTailcall3WithInfo that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FunctionTailcall3WithInfo {
        /**
         * Creates a FunctionTailcall3WithInfo pointer that invokes the given AHK function when called.
