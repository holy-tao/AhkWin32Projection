 ...
 * @version v4.0.30319
 */
class FunctionIDMapper2 extends IUnknown {
     ...
     */
    Invoke(funcId, clientData, pbHookFunction) {
        clientDataMarshal := clientData is VarRef ? "ptr" : "ptr"
        pbHookFunctionMarshal := pbHookFunction is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", funcId, clientDataMarshal, clientData, pbHookFunctionMarshal, pbHookFunction, "ptr")
        return result
    }
}
