...
class ICorProfilerCallback10 extends ICorProfilerCallback9{
    ...
    EventPipeEventDelivered(provider, eventId, eventVersion, cbMetadataBlob, metadataBlob, cbEventData, eventData, pActivityId, pRelatedActivityId, eventThread, numStackFrames, stackFrames) {
        result := ComCall(95, this, "ptr", provider, "uint", eventId, "uint", eventVersion, "uint", cbMetadataBlob, "char*", metadataBlob, "uint", cbEventData, "char*", eventData, "ptr", pActivityId, "ptr", pRelatedActivityId, "ptr", eventThread, "uint", numStackFrames, "ptr*", stackFrames, "int")
        if(result != 0)
