 ...
 */
export default struct FunctionEnter3WithInfo {
    value : IntPtr

    __value {
        set {
            if (value is FunctionEnter3WithInfo) {
    ...
    /**
     * A FunctionEnter3WithInfo that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FunctionEnter3WithInfo {
        /**
         * Creates a FunctionEnter3WithInfo pointer that invokes the given AHK function when called.
