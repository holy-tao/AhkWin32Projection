 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api//content/dbghelp/nc-dbghelp-pread_process_memory_routine64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class PREAD_PROCESS_MEMORY_ROUTINE64 extends IUnknown {
     ...
     */
    Invoke(hProcess, qwBaseAddress, lpBuffer, nSize, lpNumberOfBytesRead) {
        hProcess := hProcess is Win32Handle ? NumGet(hProcess, "ptr") : hProcess

        lpNumberOfBytesReadMarshal := lpNumberOfBytesRead is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", hProcess, "uint", qwBaseAddress, "ptr", lpBuffer, "uint", nSize, lpNumberOfBytesReadMarshal, lpNumberOfBytesRead, "int")
        return result
    }
}
