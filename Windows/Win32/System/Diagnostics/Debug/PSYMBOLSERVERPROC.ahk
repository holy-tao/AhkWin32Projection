 ...
 * @charset ANSI
 */
export default struct PSYMBOLSERVERPROC {
    value : IntPtr

    __value {
        set {
            if (value is PSYMBOLSERVERPROC) {
    ...
    /**
     * A PSYMBOLSERVERPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSYMBOLSERVERPROC {
        /**
         * Creates a PSYMBOLSERVERPROC pointer that invokes the given AHK function when called.
