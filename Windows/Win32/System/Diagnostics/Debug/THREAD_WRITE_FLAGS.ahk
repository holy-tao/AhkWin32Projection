...
class THREAD_WRITE_FLAGS extends Win32Enum {
     ...
     * Native name: ThreadWriteContext
     * @type {Integer (Int32)}
     */
    static Context => 4
     ...
     * Native name: ThreadWriteBackingStore
     * @type {Integer (Int32)}
     */
    static BackingStore => 8
     ...
     * Native name: ThreadWriteInstructionWindow
     * @type {Integer (Int32)}
     */
    static InstructionWindow => 16
     ...
     * Native name: ThreadWriteThreadData
     * @type {Integer (Int32)}
     */
    static ThreadData => 32
     ...
     * Native name: ThreadWriteThreadInfo
     * @type {Integer (Int32)}
     */
    static ThreadInfo => 64
}
