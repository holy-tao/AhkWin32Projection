...
class MODULE_WRITE_FLAGS extends Win32Enum {
     ...
     * Native name: ModuleWriteDataSeg
     * @type {Integer (Int32)}
     */
    static DataSeg => 2
     ...
     * Native name: ModuleWriteMiscRecord
     * @type {Integer (Int32)}
     */
    static MiscRecord => 4
     ...
     * Native name: ModuleWriteCvRecord
     * @type {Integer (Int32)}
     */
    static CvRecord => 8
     ...
     * Native name: ModuleReferencedByMemory
     * @type {Integer (Int32)}
     */
    static ReferencedByMemory => 16
     ...
     * Native name: ModuleWriteTlsData
     * @type {Integer (Int32)}
     */
    static TlsData => 32
     ...
     * 
     * <b>DbgHelp 6.1 and earlier:  </b>This value is not supported.
     * Native name: ModuleWriteCodeSegs
     * @type {Integer (Int32)}
     */
    static CodeSegs => 64
}
