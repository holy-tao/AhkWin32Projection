    ...
    BasicInfo{
        get {
            if(!this.HasProp("__BasicInfo"))
                this.__BasicInfo := MINIDUMP_SYSTEM_BASIC_INFORMATION(this.ptr + 4)
    ...
    FileCacheInfo{
        get {
            if(!this.HasProp("__FileCacheInfo"))
                this.__FileCacheInfo := MINIDUMP_SYSTEM_FILECACHE_INFORMATION(this.ptr + 56)
    ...
    BasicPerfInfo{
        get {
            if(!this.HasProp("__BasicPerfInfo"))
                this.__BasicPerfInfo := MINIDUMP_SYSTEM_BASIC_PERFORMANCE_INFORMATION(this.ptr + 116)
    ...
    PerfInfo{
        get {
            if(!this.HasProp("__PerfInfo"))
                this.__PerfInfo := MINIDUMP_SYSTEM_PERFORMANCE_INFORMATION(this.ptr + 148)
