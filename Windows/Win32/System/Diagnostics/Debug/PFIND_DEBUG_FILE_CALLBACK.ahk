 ...
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-pfind_debug_file_callback
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @charset ANSI
 */
export default struct PFIND_DEBUG_FILE_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is PFIND_DEBUG_FILE_CALLBACK) {
    ...
    /**
     * A PFIND_DEBUG_FILE_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFIND_DEBUG_FILE_CALLBACK {
        /**
         * Creates a PFIND_DEBUG_FILE_CALLBACK pointer that invokes the given AHK function when called.
