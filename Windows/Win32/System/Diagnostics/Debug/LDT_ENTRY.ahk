 ...
 */
export default struct LDT_ENTRY {
    #StructPack 4
    ...
    struct _HighWord {
        ...
        Bytes : LDT_ENTRY._HighWord._Bytes

        static __New() {
            DefineProp(this.Prototype, 'Bits', { type: LDT_ENTRY._HighWord._Bits, offset: 0 })
