 ...
 */
export default struct IDebugOutputCallbacksWide extends IUnknown {
    /**
     ...
     * used for IDebugOutputCallbacksWide interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugOutputCallbacksWide.Vtbl()
        }
    ...
    Query(iid) {
        if (IDebugOutputCallbacksWide.IID.Equals(iid)) {
            return true
        }
