 ...
 */
export default struct IActionableConcept extends IUnknown {
    /**
     ...
     * used for IActionableConcept interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IActionableConcept.Vtbl()
        }
    ...
    Query(iid) {
        if (IActionableConcept.IID.Equals(iid)) {
            return true
        }
