 ...
 */
export default struct IDataModelScriptDebugBreakpointEnumerator extends IUnknown {
    /**
     ...
     * used for IDataModelScriptDebugBreakpointEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDataModelScriptDebugBreakpointEnumerator.Vtbl()
        }
