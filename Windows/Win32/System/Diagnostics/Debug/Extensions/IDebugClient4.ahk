 ...
 */
export default struct IDebugClient4 extends IUnknown {
    /**
     * The interface identifier for IDebugClient4
     * @type {Guid}
     */
    static IID := Guid("{ca83c3de-5089-4cf8-93c8-d892387f2a5e}")
     ...
     * used for IDebugClient4 interfaces
    */
    ...
    _Query(iid) {
        if (IDebugClient4.IID.Equals(iid)) {
            return true
        }
