 ...
 */
export default struct PWINDBG_DISASM32 {
    value : IntPtr

    __value {
        set {
            if (value is PWINDBG_DISASM32) {
    ...
    Call(lpOffset, lpBuffer, fShowEffectiveAddress) {
        ...
        lpOffsetMarshal := lpOffset is VarRef ? "uint*" : IntPtr
    ...
    /**
     * A PWINDBG_DISASM32 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWINDBG_DISASM32 {
        /**
         * Creates a PWINDBG_DISASM32 pointer that invokes the given AHK function when called.
