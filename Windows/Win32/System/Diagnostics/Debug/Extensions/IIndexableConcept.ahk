...
class IIndexableConcept extends IUnknown{
     ...
     */
    GetAt(contextObject, indexerCount, indexers, object_, metadata) {
        result := ComCall(4, this, "ptr", contextObject, "uint", indexerCount, "ptr*", indexers, "ptr*", object_, "ptr*", metadata, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
