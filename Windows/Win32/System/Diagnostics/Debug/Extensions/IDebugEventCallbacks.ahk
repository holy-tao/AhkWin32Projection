...
class IDebugEventCallbacks extends IUnknown{
    ...
    CreateThread(Handle, DataOffset, StartOffset) {
        result := ComCall(6, this, "uint", Handle, "uint", DataOffset, "uint", StartOffset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateProcessA(ImageFileHandle, Handle, BaseOffset, ModuleSize, ModuleName, ImageName, CheckSum, TimeDateStamp, InitialThreadHandle, ThreadDataOffset, StartOffset) {
        result := ComCall(8, this, "uint", ImageFileHandle, "uint", Handle, "uint", BaseOffset, "uint", ModuleSize, "ptr", ModuleName, "ptr", ImageName, "uint", CheckSum, "uint", TimeDateStamp, "uint", InitialThreadHandle, "uint", ThreadDataOffset, "uint", StartOffset, "int")
        if(result != 0)
            throw OSError(result)
