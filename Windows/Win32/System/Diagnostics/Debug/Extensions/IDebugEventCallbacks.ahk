...
class IDebugEventCallbacks extends IUnknown{
     ...
     */
    Breakpoint(Bp) {
        result := ComCall(4, this, "ptr", Bp, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    Exception(Exception, FirstChance) {
        result := ComCall(5, this, "ptr", Exception, "uint", FirstChance, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    CreateThread(Handle_, DataOffset, StartOffset) {
        result := ComCall(6, this, "uint", Handle_, "uint", DataOffset, "uint", StartOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    ExitThread(ExitCode) {
        result := ComCall(7, this, "uint", ExitCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    CreateProcessA(ImageFileHandle, Handle_, BaseOffset, ModuleSize, ModuleName, ImageName, CheckSum, TimeDateStamp, InitialThreadHandle, ThreadDataOffset, StartOffset) {
        ModuleName := ModuleName is String ? StrPtr(ModuleName) : ModuleName
        ImageName := ImageName is String ? StrPtr(ImageName) : ImageName

        result := ComCall(8, this, "uint", ImageFileHandle, "uint", Handle_, "uint", BaseOffset, "uint", ModuleSize, "ptr", ModuleName, "ptr", ImageName, "uint", CheckSum, "uint", TimeDateStamp, "uint", InitialThreadHandle, "uint", ThreadDataOffset, "uint", StartOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    ExitProcess(ExitCode) {
        result := ComCall(9, this, "uint", ExitCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    LoadModule(ImageFileHandle, BaseOffset, ModuleSize, ModuleName, ImageName, CheckSum, TimeDateStamp) {
        ...
        result := ComCall(10, this, "uint", ImageFileHandle, "uint", BaseOffset, "uint", ModuleSize, "ptr", ModuleName, "ptr", ImageName, "uint", CheckSum, "uint", TimeDateStamp, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    UnloadModule(ImageBaseName, BaseOffset) {
        ...
        result := ComCall(11, this, "ptr", ImageBaseName, "uint", BaseOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    SystemError(Error, Level) {
        result := ComCall(12, this, "uint", Error, "uint", Level, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    ChangeDebuggeeState(Flags, Argument) {
        result := ComCall(14, this, "uint", Flags, "uint", Argument, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    ChangeEngineState(Flags, Argument) {
        result := ComCall(15, this, "uint", Flags, "uint", Argument, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
