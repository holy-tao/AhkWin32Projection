 ...
 */
export default struct PWINDBG_EXTENSION_ROUTINE32 {
    value : IntPtr

    __value {
        set {
            if (value is PWINDBG_EXTENSION_ROUTINE32) {
    ...
    /**
     * A PWINDBG_EXTENSION_ROUTINE32 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWINDBG_EXTENSION_ROUTINE32 {
        /**
         * Creates a PWINDBG_EXTENSION_ROUTINE32 pointer that invokes the given AHK function when called.
