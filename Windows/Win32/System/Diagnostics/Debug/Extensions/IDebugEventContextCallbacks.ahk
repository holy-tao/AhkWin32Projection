...
class IDebugEventContextCallbacks extends IUnknown{
    ...
    Breakpoint(Bp, Context, ContextSize) {
        result := ComCall(4, this, "ptr", Bp, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    Exception(Exception, FirstChance, Context, ContextSize) {
        result := ComCall(5, this, "ptr", Exception, "uint", FirstChance, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateThread(Handle, DataOffset, StartOffset, Context, ContextSize) {
        result := ComCall(6, this, "uint", Handle, "uint", DataOffset, "uint", StartOffset, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ExitThread(ExitCode, Context, ContextSize) {
        result := ComCall(7, this, "uint", ExitCode, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateProcessA(ImageFileHandle, Handle, BaseOffset, ModuleSize, ModuleName, ImageName, CheckSum, TimeDateStamp, InitialThreadHandle, ThreadDataOffset, StartOffset, Context, ContextSize) {
        ...
        result := ComCall(8, this, "uint", ImageFileHandle, "uint", Handle, "uint", BaseOffset, "uint", ModuleSize, "ptr", ModuleName, "ptr", ImageName, "uint", CheckSum, "uint", TimeDateStamp, "uint", InitialThreadHandle, "uint", ThreadDataOffset, "uint", StartOffset, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ExitProcess(ExitCode, Context, ContextSize) {
        result := ComCall(9, this, "uint", ExitCode, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    LoadModule(ImageFileHandle, BaseOffset, ModuleSize, ModuleName, ImageName, CheckSum, TimeDateStamp, Context, ContextSize) {
        ...
        result := ComCall(10, this, "uint", ImageFileHandle, "uint", BaseOffset, "uint", ModuleSize, "ptr", ModuleName, "ptr", ImageName, "uint", CheckSum, "uint", TimeDateStamp, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    UnloadModule(ImageBaseName, BaseOffset, Context, ContextSize) {
        ...
        result := ComCall(11, this, "ptr", ImageBaseName, "uint", BaseOffset, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SystemError(Error, Level, Context, ContextSize) {
        result := ComCall(12, this, "uint", Error, "uint", Level, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SessionStatus(Status) {
        result := ComCall(13, this, "uint", Status, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ChangeDebuggeeState(Flags, Argument, Context, ContextSize) {
        result := ComCall(14, this, "uint", Flags, "uint", Argument, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ChangeEngineState(Flags, Argument, Context, ContextSize) {
        result := ComCall(15, this, "uint", Flags, "uint", Argument, "ptr", Context, "uint", ContextSize, "int")
        if(result != 0)
            throw OSError(result)
