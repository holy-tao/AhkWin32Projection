 ...
 */
export default struct IDebugControl extends IUnknown {
    /**
     * The interface identifier for IDebugControl
     * @type {Guid}
     */
    static IID := Guid("{5182e668-105e-416e-ad92-24ef800424ba}")
     ...
     * used for IDebugControl interfaces
    */
    ...
    Query(iid) {
        if (IDebugControl.IID.Equals(iid)) {
            return true
        }
