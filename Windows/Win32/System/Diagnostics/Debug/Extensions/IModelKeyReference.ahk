...
class IModelKeyReference extends IUnknown{
    ...
    GetOriginalObject(originalObject) {
        result := ComCall(4, this, "ptr", originalObject, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetContextObject(containingObject) {
        result := ComCall(5, this, "ptr", containingObject, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @returns {HRESULT} 
     */
    GetKey(object, metadata) {
        result := ComCall(6, this, "ptr", object, "ptr", metadata, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @returns {HRESULT} 
     */
    GetKeyValue(object, metadata) {
        result := ComCall(7, this, "ptr", object, "ptr", metadata, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @returns {HRESULT} 
     */
    SetKey(object, metadata) {
        result := ComCall(8, this, "ptr", object, "ptr", metadata, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    SetKeyValue(object) {
        result := ComCall(9, this, "ptr", object, "int")
        if(result != 0)
            throw OSError(result)
