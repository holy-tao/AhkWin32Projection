 ...
 */
export default struct IDebugHostSymbolEnumerator extends IUnknown {
    /**
     ...
     * used for IDebugHostSymbolEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugHostSymbolEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IDebugHostSymbolEnumerator.IID.Equals(iid)) {
            return true
        }
