 ...
 */
export default struct IDebugBreakpoint3 extends IUnknown {
    /**
     ...
     * used for IDebugBreakpoint3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugBreakpoint3.Vtbl()
        }
    ...
    GetGuid() {
        Guid := Guid()
        result := ComCall(28, this, Guid.Ptr, Guid, "HRESULT")
        return Guid
    }
