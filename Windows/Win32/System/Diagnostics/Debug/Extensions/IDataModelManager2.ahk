...
class IDataModelManager2 extends IDataModelManager{
    ...
    AcquireSubNamespace(modelName, subNamespaceModelName, accessName, metadata, namespaceModelObject) {
        ...
        result := ComCall(23, this, "ptr", modelName, "ptr", subNamespaceModelName, "ptr", accessName, "ptr", metadata, "ptr", namespaceModelObject, "int")
        if(result != 0)
    ...
    CreateTypedIntrinsicObjectEx(context, intrinsicData, type, object) {
        result := ComCall(24, this, "ptr", context, "ptr", intrinsicData, "ptr", type, "ptr", object, "int")
        if(result != 0)
            throw OSError(result)
