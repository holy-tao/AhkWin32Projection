...
class IKeyStore extends IUnknown{
    ...
    GetKey(key, object_R, metadata) {
        ...
        result := ComCall(3, this, "ptr", key, "ptr*", object_R, "ptr*", metadata, "HRESULT")
        return result
    }
    ...
    SetKey(key, object_R, metadata) {
        ...
        result := ComCall(4, this, "ptr", key, "ptr", object_R, "ptr", metadata, "HRESULT")
        return result
    }
    ...
    GetKeyValue(key, object_R, metadata) {
        ...
        result := ComCall(5, this, "ptr", key, "ptr*", object_R, "ptr*", metadata, "HRESULT")
        return result
    }
    ...
    SetKeyValue(key, object_R) {
        ...
        result := ComCall(6, this, "ptr", key, "ptr", object_R, "HRESULT")
        return result
    }
