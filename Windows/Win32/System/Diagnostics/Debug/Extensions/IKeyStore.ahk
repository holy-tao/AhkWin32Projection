...
class IKeyStore extends IUnknown{
    ...
    GetKey(key, object, metadata) {
        ...
        result := ComCall(3, this, "ptr", key, "ptr*", object, "ptr*", metadata, "HRESULT")
        return result
    }
    ...
    SetKey(key, object, metadata) {
        ...
        result := ComCall(4, this, "ptr", key, "ptr", object, "ptr", metadata, "HRESULT")
        return result
    }
    ...
    GetKeyValue(key, object, metadata) {
        ...
        result := ComCall(5, this, "ptr", key, "ptr*", object, "ptr*", metadata, "HRESULT")
        return result
    }
    ...
    SetKeyValue(key, object) {
        ...
        result := ComCall(6, this, "ptr", key, "ptr", object, "HRESULT")
        return result
    }
