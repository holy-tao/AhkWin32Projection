...
class IDebugSymbols5 extends IUnknown{
     ...
     * @param {Pointer} Buffer 
     * @param {Integer} BufferSize 
     * @param {Pointer<UInt32>} VerInfoSize 
     * @returns {HRESULT} 
     */
    GetModuleVersionInformation(Index, Base, Item, Buffer, BufferSize, VerInfoSize) {
        result := ComCall(52, this, "uint", Index, "uint", Base, "ptr", Item, "ptr", Buffer, "uint", BufferSize, "uint*", VerInfoSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleNameString(Which, Index, Base, Buffer, BufferSize, NameSize) {
        result := ComCall(53, this, "uint", Which, "uint", Index, "uint", Base, "ptr", Buffer, "uint", BufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetConstantName(Module, TypeId, Value, NameBuffer, NameBufferSize, NameSize) {
        result := ComCall(54, this, "uint", Module, "uint", TypeId, "uint", Value, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFieldName(Module, TypeId, FieldIndex, NameBuffer, NameBufferSize, NameSize) {
        result := ComCall(55, this, "uint", Module, "uint", TypeId, "uint", FieldIndex, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNameByOffsetWide(Offset, NameBuffer, NameBufferSize, NameSize, Displacement) {
        ...
        result := ComCall(60, this, "uint", Offset, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetOffsetByNameWide(Symbol, Offset) {
        ...
        result := ComCall(61, this, "ptr", Symbol, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNearNameByOffsetWide(Offset, Delta, NameBuffer, NameBufferSize, NameSize, Displacement) {
        ...
        result := ComCall(62, this, "uint", Offset, "int", Delta, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetLineByOffsetWide(Offset, Line, FileBuffer, FileBufferSize, FileSize, Displacement) {
        ...
        result := ComCall(63, this, "uint", Offset, "uint*", Line, "ptr", FileBuffer, "uint", FileBufferSize, "uint*", FileSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetOffsetByLineWide(Line, File, Offset) {
        ...
        result := ComCall(64, this, "uint", Line, "ptr", File, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleByModuleNameWide(Name, StartIndex, Index, Base) {
        ...
        result := ComCall(65, this, "ptr", Name, "uint", StartIndex, "uint*", Index, "uint*", Base, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolModuleWide(Symbol, Base) {
        ...
        result := ComCall(66, this, "ptr", Symbol, "uint*", Base, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetTypeNameWide(Module, TypeId, NameBuffer, NameBufferSize, NameSize) {
        ...
        result := ComCall(67, this, "uint", Module, "uint", TypeId, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetTypeIdWide(Module, Name, TypeId) {
        ...
        result := ComCall(68, this, "uint", Module, "ptr", Name, "uint*", TypeId, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFieldOffsetWide(Module, TypeId, Field, Offset) {
        ...
        result := ComCall(69, this, "uint", Module, "uint", TypeId, "ptr", Field, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolTypeIdWide(Symbol, TypeId, Module) {
        ...
        result := ComCall(70, this, "ptr", Symbol, "uint*", TypeId, "uint*", Module, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {Integer} Flags 
     * @param {Pointer<IDebugSymbolGroup2>} Update 
     * @param {Pointer<IDebugSymbolGroup2>} Symbols 
     * @returns {HRESULT} 
     */
    GetScopeSymbolGroup2(Flags, Update, Symbols) {
        result := ComCall(71, this, "uint", Flags, "ptr", Update, "ptr", Symbols, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSymbolGroup2(Group) {
        result := ComCall(72, this, "ptr", Group, "int")
        if(result != 0)
            throw OSError(result)
    ...
    StartSymbolMatchWide(Pattern, Handle) {
        ...
        result := ComCall(73, this, "ptr", Pattern, "uint*", Handle, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNextSymbolMatchWide(Handle, Buffer, BufferSize, MatchSize, Offset) {
        ...
        result := ComCall(74, this, "uint", Handle, "ptr", Buffer, "uint", BufferSize, "uint*", MatchSize, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolPathWide(Buffer, BufferSize, PathSize) {
        ...
        result := ComCall(76, this, "ptr", Buffer, "uint", BufferSize, "uint*", PathSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetSymbolPathWide(Path) {
        ...
        result := ComCall(77, this, "ptr", Path, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetImagePathWide(Buffer, BufferSize, PathSize) {
        ...
        result := ComCall(79, this, "ptr", Buffer, "uint", BufferSize, "uint*", PathSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetImagePathWide(Path) {
        ...
        result := ComCall(80, this, "ptr", Path, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourcePathWide(Buffer, BufferSize, PathSize) {
        ...
        result := ComCall(82, this, "ptr", Buffer, "uint", BufferSize, "uint*", PathSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourcePathElementWide(Index, Buffer, BufferSize, ElementSize) {
        ...
        result := ComCall(83, this, "uint", Index, "ptr", Buffer, "uint", BufferSize, "uint*", ElementSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetSourcePathWide(Path) {
        ...
        result := ComCall(84, this, "ptr", Path, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FindSourceFileWide(StartElement, File, Flags, FoundElement, Buffer, BufferSize, FoundSize) {
        ...
        result := ComCall(86, this, "uint", StartElement, "ptr", File, "uint", Flags, "uint*", FoundElement, "ptr", Buffer, "uint", BufferSize, "uint*", FoundSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceFileLineOffsetsWide(File, Buffer, BufferLines, FileLines) {
        ...
        result := ComCall(87, this, "ptr", File, "uint*", Buffer, "uint", BufferLines, "uint*", FileLines, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleVersionInformationWide(Index, Base, Item, Buffer, BufferSize, VerInfoSize) {
        ...
        result := ComCall(88, this, "uint", Index, "uint", Base, "ptr", Item, "ptr", Buffer, "uint", BufferSize, "uint*", VerInfoSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleNameStringWide(Which, Index, Base, Buffer, BufferSize, NameSize) {
        ...
        result := ComCall(89, this, "uint", Which, "uint", Index, "uint", Base, "ptr", Buffer, "uint", BufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetConstantNameWide(Module, TypeId, Value, NameBuffer, NameBufferSize, NameSize) {
        ...
        result := ComCall(90, this, "uint", Module, "uint", TypeId, "uint", Value, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFieldNameWide(Module, TypeId, FieldIndex, NameBuffer, NameBufferSize, NameSize) {
        ...
        result := ComCall(91, this, "uint", Module, "uint", TypeId, "uint", FieldIndex, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleByModuleName2(Name, StartIndex, Flags, Index, Base) {
        result := ComCall(93, this, "ptr", Name, "uint", StartIndex, "uint", Flags, "uint*", Index, "uint*", Base, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleByModuleName2Wide(Name, StartIndex, Flags, Index, Base) {
        ...
        result := ComCall(94, this, "ptr", Name, "uint", StartIndex, "uint", Flags, "uint*", Index, "uint*", Base, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetModuleByOffset2(Offset, StartIndex, Flags, Index, Base) {
        result := ComCall(95, this, "uint", Offset, "uint", StartIndex, "uint", Flags, "uint*", Index, "uint*", Base, "int")
        if(result != 0)
            throw OSError(result)
    ...
    AddSyntheticModule(Base, Size, ImagePath, ModuleName, Flags) {
        result := ComCall(96, this, "uint", Base, "uint", Size, "ptr", ImagePath, "ptr", ModuleName, "uint", Flags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    AddSyntheticModuleWide(Base, Size, ImagePath, ModuleName, Flags) {
        ...
        result := ComCall(97, this, "uint", Base, "uint", Size, "ptr", ImagePath, "ptr", ModuleName, "uint", Flags, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCurrentScopeFrameIndex(Index) {
        result := ComCall(99, this, "uint*", Index, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer} Buffer 
     * @param {Integer} BufferSize 
     * @param {Pointer<UInt32>} BufferNeeded 
     * @returns {HRESULT} 
     */
    GetFunctionEntryByOffset(Offset, Flags, Buffer, BufferSize, BufferNeeded) {
        result := ComCall(104, this, "uint", Offset, "uint", Flags, "ptr", Buffer, "uint", BufferSize, "uint*", BufferNeeded, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {PSTR} Field 
     * @param {Pointer<UInt32>} FieldTypeId 
     * @param {Pointer<UInt32>} Offset 
     * @returns {HRESULT} 
     */
    GetFieldTypeAndOffset(Module, ContainerTypeId, Field, FieldTypeId, Offset) {
        result := ComCall(105, this, "uint", Module, "uint", ContainerTypeId, "ptr", Field, "uint*", FieldTypeId, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFieldTypeAndOffsetWide(Module, ContainerTypeId, Field, FieldTypeId, Offset) {
        ...
        result := ComCall(106, this, "uint", Module, "uint", ContainerTypeId, "ptr", Field, "uint*", FieldTypeId, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
    ...
    AddSyntheticSymbol(Offset, Size, Name, Flags, Id) {
        result := ComCall(107, this, "uint", Offset, "uint", Size, "ptr", Name, "uint", Flags, "ptr", Id, "int")
        if(result != 0)
            throw OSError(result)
    ...
    AddSyntheticSymbolWide(Offset, Size, Name, Flags, Id) {
        ...
        result := ComCall(108, this, "uint", Offset, "uint", Size, "ptr", Name, "uint", Flags, "ptr", Id, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt64>} Displacements 
     * @param {Integer} IdsCount 
     * @param {Pointer<UInt32>} Entries 
     * @returns {HRESULT} 
     */
    GetSymbolEntriesByOffset(Offset, Flags, Ids, Displacements, IdsCount, Entries) {
        result := ComCall(110, this, "uint", Offset, "uint", Flags, "ptr", Ids, "uint*", Displacements, "uint", IdsCount, "uint*", Entries, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolEntriesByName(Symbol, Flags, Ids, IdsCount, Entries) {
        result := ComCall(111, this, "ptr", Symbol, "uint", Flags, "ptr", Ids, "uint", IdsCount, "uint*", Entries, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolEntriesByNameWide(Symbol, Flags, Ids, IdsCount, Entries) {
        ...
        result := ComCall(112, this, "ptr", Symbol, "uint", Flags, "ptr", Ids, "uint", IdsCount, "uint*", Entries, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolEntryString(Id, Which, Buffer, BufferSize, StringSize) {
        result := ComCall(115, this, "ptr", Id, "uint", Which, "ptr", Buffer, "uint", BufferSize, "uint*", StringSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSymbolEntryStringWide(Id, Which, Buffer, BufferSize, StringSize) {
        ...
        result := ComCall(116, this, "ptr", Id, "uint", Which, "ptr", Buffer, "uint", BufferSize, "uint*", StringSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} RegionsAvail 
     * @returns {HRESULT} 
     */
    GetSymbolEntryOffsetRegions(Id, Flags, Regions, RegionsCount, RegionsAvail) {
        result := ComCall(117, this, "ptr", Id, "uint", Flags, "ptr", Regions, "uint", RegionsCount, "uint*", RegionsAvail, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} EntriesAvail 
     * @returns {HRESULT} 
     */
    GetSourceEntriesByOffset(Offset, Flags, Entries, EntriesCount, EntriesAvail) {
        result := ComCall(119, this, "uint", Offset, "uint", Flags, "ptr", Entries, "uint", EntriesCount, "uint*", EntriesAvail, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceEntriesByLine(Line, File, Flags, Entries, EntriesCount, EntriesAvail) {
        result := ComCall(120, this, "uint", Line, "ptr", File, "uint", Flags, "ptr", Entries, "uint", EntriesCount, "uint*", EntriesAvail, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceEntriesByLineWide(Line, File, Flags, Entries, EntriesCount, EntriesAvail) {
        ...
        result := ComCall(121, this, "uint", Line, "ptr", File, "uint", Flags, "ptr", Entries, "uint", EntriesCount, "uint*", EntriesAvail, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceEntryString(Entry, Which, Buffer, BufferSize, StringSize) {
        result := ComCall(122, this, "ptr", Entry, "uint", Which, "ptr", Buffer, "uint", BufferSize, "uint*", StringSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceEntryStringWide(Entry, Which, Buffer, BufferSize, StringSize) {
        ...
        result := ComCall(123, this, "ptr", Entry, "uint", Which, "ptr", Buffer, "uint", BufferSize, "uint*", StringSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSourceEntryOffsetRegions(Entry, Flags, Regions, RegionsCount, RegionsAvail) {
        result := ComCall(124, this, "ptr", Entry, "uint", Flags, "ptr", Regions, "uint", RegionsCount, "uint*", RegionsAvail, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetScopeEx(InstructionOffset, ScopeFrame, ScopeContext, ScopeContextSize) {
        result := ComCall(126, this, "uint*", InstructionOffset, "ptr", ScopeFrame, "ptr", ScopeContext, "uint", ScopeContextSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNameByInlineContext(Offset, InlineContext, NameBuffer, NameBufferSize, NameSize, Displacement) {
        result := ComCall(128, this, "uint", Offset, "uint", InlineContext, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetNameByInlineContextWide(Offset, InlineContext, NameBuffer, NameBufferSize, NameSize, Displacement) {
        ...
        result := ComCall(129, this, "uint", Offset, "uint", InlineContext, "ptr", NameBuffer, "uint", NameBufferSize, "uint*", NameSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetLineByInlineContext(Offset, InlineContext, Line, FileBuffer, FileBufferSize, FileSize, Displacement) {
        result := ComCall(130, this, "uint", Offset, "uint", InlineContext, "uint*", Line, "ptr", FileBuffer, "uint", FileBufferSize, "uint*", FileSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetLineByInlineContextWide(Offset, InlineContext, Line, FileBuffer, FileBufferSize, FileSize, Displacement) {
        ...
        result := ComCall(131, this, "uint", Offset, "uint", InlineContext, "uint*", Line, "ptr", FileBuffer, "uint", FileBufferSize, "uint*", FileSize, "uint*", Displacement, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @returns {HRESULT} 
     */
    GetCurrentScopeFrameIndexEx(Flags, Index) {
        result := ComCall(133, this, "uint", Flags, "uint*", Index, "int")
        if(result != 0)
            throw OSError(result)
