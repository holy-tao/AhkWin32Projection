 ...
 * @version v4.0.30319
 */
class KDEXT_DUMP_HANDLE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(HandleInfo, Flags, Context_) {
        Context_Marshal := Context_ is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", HandleInfo, "uint", Flags, Context_Marshal, Context_, "char")
        return result
    }
}
