 ...
 */
export default struct PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY {
    value : IntPtr

    __value {
        set {
            if (value is PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY) {
    ...
    /**
     * A PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY {
        /**
         * Creates a PWINDBG_OLDKD_WRITE_PHYSICAL_MEMORY pointer that invokes the given AHK function when called.
