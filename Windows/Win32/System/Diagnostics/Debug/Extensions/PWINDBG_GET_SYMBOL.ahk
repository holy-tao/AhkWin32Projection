 ...
 * @version v4.0.30319
 */
class PWINDBG_GET_SYMBOL extends IUnknown {
     ...
     */
    Invoke(offset, pchBuffer, pDisplacement) {
        ...
        ComCall(3, this, offsetMarshal, offset, "ptr", pchBuffer, pDisplacementMarshal, pDisplacement)
    }
}
