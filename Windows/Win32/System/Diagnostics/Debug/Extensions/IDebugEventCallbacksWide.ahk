 ...
 */
export default struct IDebugEventCallbacksWide extends IUnknown {
    /**
     ...
     * used for IDebugEventCallbacksWide interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugEventCallbacksWide.Vtbl()
        }
    ...
    _Query(iid) {
        if (IDebugEventCallbacksWide.IID.Equals(iid)) {
            return true
        }
