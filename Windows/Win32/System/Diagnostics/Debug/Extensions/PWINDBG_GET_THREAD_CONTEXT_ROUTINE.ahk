 ...
 */
export default struct PWINDBG_GET_THREAD_CONTEXT_ROUTINE {
    value : IntPtr

    __value {
        set {
            if (value is PWINDBG_GET_THREAD_CONTEXT_ROUTINE) {
    ...
    /**
     * A PWINDBG_GET_THREAD_CONTEXT_ROUTINE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWINDBG_GET_THREAD_CONTEXT_ROUTINE {
        /**
         * Creates a PWINDBG_GET_THREAD_CONTEXT_ROUTINE pointer that invokes the given AHK function when called.
