 ...
 */
export default struct IDebugClient2 extends IUnknown {
    /**
     * The interface identifier for IDebugClient2
     * @type {Guid}
     */
    static IID := Guid("{edbed635-372e-4dab-bbfe-ed0d2f63be81}")
     ...
     * used for IDebugClient2 interfaces
    */
    ...
    Query(iid) {
        if (IDebugClient2.IID.Equals(iid)) {
            return true
        }
