 ...
 */
export default struct IDebugSystemObjects3 extends IUnknown {
    /**
     ...
     * used for IDebugSystemObjects3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugSystemObjects3.Vtbl()
        }
    ...
    Query(iid) {
        if (IDebugSystemObjects3.IID.Equals(iid)) {
            return true
        }
