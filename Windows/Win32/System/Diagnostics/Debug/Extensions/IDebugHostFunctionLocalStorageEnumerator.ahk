...
#Import ".\IDebugHostFunctionLocalStorage.ahk" { IDebugHostFunctionLocalStorage }
#Import "..\..\..\Com\IUnknown.ahk" { IUnknown }

/**
 * @namespace Windows.Win32.System.Diagnostics.Debug.Extensions
 */
export default struct IDebugHostFunctionLocalStorageEnumerator extends IUnknown {
    /**
     ...
     * used for IDebugHostFunctionLocalStorageEnumerator interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugHostFunctionLocalStorageEnumerator.Vtbl()
        }
    ...
    Query(iid) {
        if (IDebugHostFunctionLocalStorageEnumerator.IID.Equals(iid)) {
            return true
        }
