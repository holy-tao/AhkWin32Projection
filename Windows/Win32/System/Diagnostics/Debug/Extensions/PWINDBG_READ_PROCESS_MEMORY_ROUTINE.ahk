 ...
 */
export default struct PWINDBG_READ_PROCESS_MEMORY_ROUTINE {
    value : IntPtr

    __value {
        set {
            if (value is PWINDBG_READ_PROCESS_MEMORY_ROUTINE) {
    ...
    /**
     * A PWINDBG_READ_PROCESS_MEMORY_ROUTINE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWINDBG_READ_PROCESS_MEMORY_ROUTINE {
        /**
         * Creates a PWINDBG_READ_PROCESS_MEMORY_ROUTINE pointer that invokes the given AHK function when called.
