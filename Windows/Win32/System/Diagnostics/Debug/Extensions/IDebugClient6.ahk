 ...
 */
export default struct IDebugClient6 extends IUnknown {
    /**
     * The interface identifier for IDebugClient6
     * @type {Guid}
     */
    static IID := Guid("{fd28b4c5-c498-4686-a28e-62cad2154eb3}")
     ...
     * used for IDebugClient6 interfaces
    */
