...
class IDebugBreakpoint2 extends IUnknown{
    ...
    /**
     * 
     * @param {Pointer<UInt32>} BreakType 
     * @param {Pointer<UInt32>} ProcType 
     * @returns {HRESULT} 
     */
    GetType(BreakType, ProcType) {
        result := ComCall(4, this, "uint*", BreakType, "uint*", ProcType, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetAdder(Adder) {
        result := ComCall(5, this, "ptr", Adder, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetOffset(Offset) {
        result := ComCall(10, this, "uint*", Offset, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} AccessType 
     * @returns {HRESULT} 
     */
    GetDataParameters(Size, AccessType) {
        result := ComCall(12, this, "uint*", Size, "uint*", AccessType, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetDataParameters(Size, AccessType) {
        result := ComCall(13, this, "uint", Size, "uint", AccessType, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetPassCount(Count) {
        result := ComCall(14, this, "uint*", Count, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCurrentPassCount(Count) {
        result := ComCall(16, this, "uint*", Count, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetMatchThreadId(Id) {
        result := ComCall(17, this, "uint*", Id, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCommand(Buffer, BufferSize, CommandSize) {
        result := ComCall(19, this, "ptr", Buffer, "uint", BufferSize, "uint*", CommandSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {PSTR} Buffer 
     * @param {Integer} BufferSize 
     * @param {Pointer<UInt32>} ExpressionSize 
     * @returns {HRESULT} 
     */
    GetOffsetExpression(Buffer, BufferSize, ExpressionSize) {
        result := ComCall(21, this, "ptr", Buffer, "uint", BufferSize, "uint*", ExpressionSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCommandWide(Buffer, BufferSize, CommandSize) {
        ...
        result := ComCall(24, this, "ptr", Buffer, "uint", BufferSize, "uint*", CommandSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetOffsetExpressionWide(Buffer, BufferSize, ExpressionSize) {
        ...
        result := ComCall(26, this, "ptr", Buffer, "uint", BufferSize, "uint*", ExpressionSize, "int")
        if(result != 0)
            throw OSError(result)
