 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-penumloaded_modules_callbackw64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 */
export default struct PENUMLOADED_MODULES_CALLBACKW64 {
    value : IntPtr

    __value {
        set {
            if (value is PENUMLOADED_MODULES_CALLBACKW64) {
    ...
    /**
     * 
     * @param {PWSTR} ModuleName The name of the enumerated module.
    ...
    /**
     * A PENUMLOADED_MODULES_CALLBACKW64 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PENUMLOADED_MODULES_CALLBACKW64 {
        /**
         * Creates a PENUMLOADED_MODULES_CALLBACKW64 pointer that invokes the given AHK function when called.
