...
/**
 * PSYM_ENUMMODULES_CALLBACKW64 (Unicode) is an application-defined callback function used with the SymEnumerateModules64 function.
 * @remarks
 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-psym_enummodules_callbackw64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 */
export default struct PSYM_ENUMMODULES_CALLBACKW64 {
    value : IntPtr

    __value {
        set {
            if (value is PSYM_ENUMMODULES_CALLBACKW64) {
    ...
    /**
     * A PSYM_ENUMMODULES_CALLBACKW64 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSYM_ENUMMODULES_CALLBACKW64 {
        /**
         * Creates a PSYM_ENUMMODULES_CALLBACKW64 pointer that invokes the given AHK function when called.
         * @param {Func(PWSTR, Int64, "ptr") => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
