 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api//content/dbghelp/nc-dbghelp-psymbol_registered_callback64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class PSYMBOL_REGISTERED_CALLBACK64 extends IUnknown {
    ...
    Invoke(hProcess, ActionCode, CallbackData, UserContext) {
        ...
        result := ComCall(3, this, "ptr", hProcess, "uint", ActionCode, "uint", CallbackData, "uint", UserContext, "int")
        return result
    }
}
