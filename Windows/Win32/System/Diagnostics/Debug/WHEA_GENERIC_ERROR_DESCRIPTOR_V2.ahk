 ...
 */
export default struct WHEA_GENERIC_ERROR_DESCRIPTOR_V2 {
    #StructPack 8
    ...
    ReadAckAddressSpaceID : Int8

    ReadAckAddressBitWidth : Int8

    ReadAckAddressBitOffset : Int8

    ReadAckAddressAccessSize : Int8

    ReadAckAddress : Int64

    ReadAckPreserveMask : Int64

    ReadAckWriteMask : Int64
