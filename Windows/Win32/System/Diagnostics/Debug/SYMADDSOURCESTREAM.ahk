 ...
 */
export default struct SYMADDSOURCESTREAM {
    value : IntPtr

    __value {
        set {
            if (value is SYMADDSOURCESTREAM) {
    ...
    /**
     * A SYMADDSOURCESTREAM that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SYMADDSOURCESTREAM {
        /**
         * Creates a SYMADDSOURCESTREAM pointer that invokes the given AHK function when called.
