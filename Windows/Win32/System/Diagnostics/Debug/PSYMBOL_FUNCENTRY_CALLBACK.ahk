...
/**
 * PSYMBOL_FUNCENTRY_CALLBACK (dbghelp.h) is an application-defined callback function used with the SymRegisterFunctionEntryCallback64 function.
 * @remarks
 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-psymbol_funcentry_callback
 * @namespace Windows.Win32.System.Diagnostics.Debug
 */
export default struct PSYMBOL_FUNCENTRY_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is PSYMBOL_FUNCENTRY_CALLBACK) {
    ...
    /**
     * A PSYMBOL_FUNCENTRY_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSYMBOL_FUNCENTRY_CALLBACK {
        /**
         * Creates a PSYMBOL_FUNCENTRY_CALLBACK pointer that invokes the given AHK function when called.
         * @param {Func(HANDLE, UInt32, "ptr") => "ptr"} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
