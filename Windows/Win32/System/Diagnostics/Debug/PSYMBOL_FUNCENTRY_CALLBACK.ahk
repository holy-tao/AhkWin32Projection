 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api//content/dbghelp/nc-dbghelp-psymbol_funcentry_callback
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class PSYMBOL_FUNCENTRY_CALLBACK extends IUnknown {
    ...
    Invoke(hProcess, AddrBase, UserContext) {
        ...
        result := ComCall(3, this, "ptr", hProcess, "uint", AddrBase, UserContextMarshal, UserContext, "ptr")
        return result
    }
}
