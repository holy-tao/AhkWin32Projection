...
/**
 * Contains duplicate symbol information. (IMAGEHLP_DUPLICATE_SYMBOL)
 * @remarks
 * This structure supersedes the <b>IMAGEHLP_DUPLICATE_SYMBOL</b> structure. For more information, see 
  ...
  * 
  * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/ns-dbghelp-imagehlp_duplicate_symbol
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class IMAGEHLP_DUPLICATE_SYMBOL extends Win32Struct
{
    static sizeof => 24
