 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api//content/dbghelp/nc-dbghelp-pfunction_table_access_routine64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class PFUNCTION_TABLE_ACCESS_ROUTINE64 extends IUnknown {
     ...
     */
    Invoke(ahProcess, AddrBase) {
        ahProcess := ahProcess is Win32Handle ? NumGet(ahProcess, "ptr") : ahProcess

        result := ComCall(3, this, "ptr", ahProcess, "uint", AddrBase, "ptr")
        return result
    }
}
