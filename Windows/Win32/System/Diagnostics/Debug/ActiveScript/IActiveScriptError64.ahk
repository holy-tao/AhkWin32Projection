 ...
 */
export default struct IActiveScriptError64 extends IActiveScriptError {
    /**
     ...
     * used for IActiveScriptError64 interfaces
    */
    struct Vtbl extends IActiveScriptError.Vtbl {
        GetSourcePosition64 : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IActiveScriptError64.Vtbl()
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetSourcePosition64)
    }
}
