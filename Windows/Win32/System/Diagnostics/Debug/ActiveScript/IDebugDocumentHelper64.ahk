 ...
 */
export default struct IDebugDocumentHelper64 extends IUnknown {
    /**
     ...
     * used for IDebugDocumentHelper64 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDebugDocumentHelper64.Vtbl()
        }
    ...
    Query(iid) {
        if (IDebugDocumentHelper64.IID.Equals(iid)) {
            return true
        }
