 ...
 */
export default struct IMachineDebugManager extends IUnknown {
    /**
     ...
     * used for IMachineDebugManager interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IMachineDebugManager.Vtbl()
        }
    ...
    RemoveApplication(dwAppCookie) {
        result := ComCall(4, this, UInt32, dwAppCookie, "HRESULT")
        return result
    }
