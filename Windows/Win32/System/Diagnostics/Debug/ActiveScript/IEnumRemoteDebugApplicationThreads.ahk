 ...
 */
export default struct IEnumRemoteDebugApplicationThreads extends IUnknown {
    /**
     ...
     * used for IEnumRemoteDebugApplicationThreads interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumRemoteDebugApplicationThreads.Vtbl()
        }
