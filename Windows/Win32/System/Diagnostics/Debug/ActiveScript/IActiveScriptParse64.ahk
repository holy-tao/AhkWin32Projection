 ...
 */
export default struct IActiveScriptParse64 extends IUnknown {
    /**
     ...
     * used for IActiveScriptParse64 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IActiveScriptParse64.Vtbl()
        }
    ...
    AddScriptlet(pstrDefaultName, pstrCode, pstrItemName, pstrSubItemName, pstrEventName, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, pbstrName, pexcepinfo) {
        ...
        result := ComCall(4, this, "ptr", pstrDefaultName, "ptr", pstrCode, "ptr", pstrItemName, "ptr", pstrSubItemName, "ptr", pstrEventName, "ptr", pstrDelimiter, Int64, dwSourceContextCookie, UInt32, ulStartingLineNumber, UInt32, dwFlags, BSTR.Ptr, pbstrName, EXCEPINFO.Ptr, pexcepinfo, "HRESULT")
        return result
    }
    ...
    ParseScriptText(pstrCode, pstrItemName, punkContext, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, pvarResult, pexcepinfo) {
        ...
        result := ComCall(5, this, "ptr", pstrCode, "ptr", pstrItemName, "ptr", punkContext, "ptr", pstrDelimiter, Int64, dwSourceContextCookie, UInt32, ulStartingLineNumber, UInt32, dwFlags, VARIANT.Ptr, pvarResult, EXCEPINFO.Ptr, pexcepinfo, "HRESULT")
        return result
    }

    Query(iid) {
        if (IActiveScriptParse64.IID.Equals(iid)) {
            return true
        }
