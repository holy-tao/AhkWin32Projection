...
export default struct IActiveScriptParseProcedureOld32 extends IUnknown {
    ...
    */
    ...
    ParseProcedureText(pstrCode, pstrFormalParams, pstrItemName, punkContext, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pstrCode, "ptr", pstrFormalParams, "ptr", pstrItemName, "ptr", punkContext, "ptr", pstrDelimiter, UInt32, dwSourceContextCookie, UInt32, ulStartingLineNumber, UInt32, dwFlags, "ptr*", &ppdisp := 0, "HRESULT")
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.ParseProcedureText := CallbackCreate(ObjBindMethod(implObj, "ParseProcedureText"), flags, 10)
    }
