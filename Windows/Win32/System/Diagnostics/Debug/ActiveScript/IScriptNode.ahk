...
class IScriptNode extends IUnknown{
    ...
    GetParent(ppsnParent) {
        result := ComCall(5, this, "ptr", ppsnParent, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pisn 
     * @returns {HRESULT} 
     */
    GetIndexInParent(pisn) {
        result := ComCall(6, this, "uint*", pisn, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetCookie(pdwCookie) {
        result := ComCall(7, this, "uint*", pdwCookie, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<UInt32>} pcsn 
     * @returns {HRESULT} 
     */
    GetNumberOfChildren(pcsn) {
        result := ComCall(8, this, "uint*", pcsn, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetChild(isn, ppsn) {
        result := ComCall(9, this, "uint", isn, "ptr", ppsn, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateChildEntry(isn, dwCookie, pszDelimiter, ppse) {
        ...
        result := ComCall(11, this, "uint", isn, "uint", dwCookie, "ptr", pszDelimiter, "ptr", ppse, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {PWSTR} pszDelimiter 
     * @param {Pointer<ITypeInfo>} ptiSignature 
    ...
    CreateChildHandler(pszDefaultName, prgpszNames, cpszNames, pszEvent, pszDelimiter, ptiSignature, iMethodSignature, isn, dwCookie, ppse) {
        ...
        result := ComCall(12, this, "ptr", pszDefaultName, "ptr", prgpszNames, "uint", cpszNames, "ptr", pszEvent, "ptr", pszDelimiter, "ptr", ptiSignature, "uint", iMethodSignature, "uint", isn, "uint", dwCookie, "ptr", ppse, "int")
        if(result != 0)
            throw OSError(result)
