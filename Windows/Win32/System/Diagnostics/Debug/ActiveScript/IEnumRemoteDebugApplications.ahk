 ...
 */
export default struct IEnumRemoteDebugApplications extends IUnknown {
    /**
     ...
     * used for IEnumRemoteDebugApplications interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumRemoteDebugApplications.Vtbl()
        }
    ...
    Next(celt, ppda, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IRemoteDebugApplication.Ptr, ppda, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
    ...
    Query(iid) {
        if (IEnumRemoteDebugApplications.IID.Equals(iid)) {
            return true
        }
