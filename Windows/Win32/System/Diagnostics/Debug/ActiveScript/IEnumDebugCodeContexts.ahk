 ...
 */
export default struct IEnumDebugCodeContexts extends IUnknown {
    /**
     ...
     * used for IEnumDebugCodeContexts interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumDebugCodeContexts.Vtbl()
        }
    ...
    Next(celt, pscc, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IDebugCodeContext.Ptr, pscc, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
