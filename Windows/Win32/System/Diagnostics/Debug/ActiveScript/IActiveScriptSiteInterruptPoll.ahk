 ...
 */
export default struct IActiveScriptSiteInterruptPoll extends IUnknown {
    /**
     ...
     * used for IActiveScriptSiteInterruptPoll interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IActiveScriptSiteInterruptPoll.Vtbl()
        }
    ...
    Query(iid) {
        if (IActiveScriptSiteInterruptPoll.IID.Equals(iid)) {
            return true
        }
