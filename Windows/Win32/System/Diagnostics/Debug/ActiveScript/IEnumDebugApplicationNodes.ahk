 ...
 */
export default struct IEnumDebugApplicationNodes extends IUnknown {
    /**
     ...
     * used for IEnumDebugApplicationNodes interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumDebugApplicationNodes.Vtbl()
        }
    ...
    Next(celt, pprddp, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IDebugApplicationNode.Ptr, pprddp, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
