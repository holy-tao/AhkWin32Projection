 ...
 */
export default struct IEnumDebugExpressionContexts extends IUnknown {
    /**
     ...
     * used for IEnumDebugExpressionContexts interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumDebugExpressionContexts.Vtbl()
        }
    ...
    Next(celt, ppdec, pceltFetched) {
        ...
        result := ComCall(3, this, UInt32, celt, IDebugExpressionContext.Ptr, ppdec, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return result
    }
