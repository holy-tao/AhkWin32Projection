...
class IActiveScriptDebug64 extends IUnknown{
    ...
    GetScriptTextAttributes(pstrCode, uNumCodeChars, pstrDelimiter, dwFlags, pattr) {
        ...
        result := ComCall(3, this, "ptr", pstrCode, "uint", uNumCodeChars, "ptr", pstrDelimiter, "uint", dwFlags, "ushort*", pattr, "int")
        if(result != 0)
    ...
    EnumCodeContextsOfPosition(dwSourceContext, uCharacterOffset, uNumChars, ppescc) {
        result := ComCall(5, this, "uint", dwSourceContext, "uint", uCharacterOffset, "uint", uNumChars, "ptr", ppescc, "int")
        if(result != 0)
            throw OSError(result)
