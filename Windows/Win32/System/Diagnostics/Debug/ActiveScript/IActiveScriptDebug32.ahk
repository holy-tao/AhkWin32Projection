 ...
 */
export default struct IActiveScriptDebug32 extends IUnknown {
    /**
     ...
     * used for IActiveScriptDebug32 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IActiveScriptDebug32.Vtbl()
        }
    ...
    Query(iid) {
        if (IActiveScriptDebug32.IID.Equals(iid)) {
            return true
        }
