 ...
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-psym_enumlines_callbackw
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @charset Unicode
 */
export default struct PSYM_ENUMLINES_CALLBACKW {
    value : IntPtr

    __value {
        set {
            if (value is PSYM_ENUMLINES_CALLBACKW) {
    ...
    /**
     * A PSYM_ENUMLINES_CALLBACKW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSYM_ENUMLINES_CALLBACKW {
        /**
         * Creates a PSYM_ENUMLINES_CALLBACKW pointer that invokes the given AHK function when called.
         * @param {Func(SRCCODEINFOW, "ptr") => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 2)) {
