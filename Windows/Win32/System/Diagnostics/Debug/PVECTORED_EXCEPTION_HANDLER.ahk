 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winnt/nc-winnt-pvectored_exception_handler
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @version v4.0.30319
 */
class PVECTORED_EXCEPTION_HANDLER extends IUnknown {
    ...
    Invoke(ExceptionInfo) {
        result := ComCall(3, this, "ptr", ExceptionInfo, "int")
        return result
    }
}
