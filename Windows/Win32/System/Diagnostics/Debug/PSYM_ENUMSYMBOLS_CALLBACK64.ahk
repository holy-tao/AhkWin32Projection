 ...
 * 
 * ```cpp
 * @see https://learn.microsoft.com/windows/win32/api/dbghelp/nc-dbghelp-psym_enumsymbols_callback64
 * @namespace Windows.Win32.System.Diagnostics.Debug
 * @charset ANSI
 */
export default struct PSYM_ENUMSYMBOLS_CALLBACK64 {
    value : IntPtr

    __value {
        set {
            if (value is PSYM_ENUMSYMBOLS_CALLBACK64) {
    ...
    /**
     * A PSYM_ENUMSYMBOLS_CALLBACK64 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSYM_ENUMSYMBOLS_CALLBACK64 {
        /**
         * Creates a PSYM_ENUMSYMBOLS_CALLBACK64 pointer that invokes the given AHK function when called.
