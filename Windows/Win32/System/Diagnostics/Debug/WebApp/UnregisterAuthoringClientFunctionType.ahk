 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webapplication/nc-webapplication-unregisterauthoringclientfunctiontype
 * @namespace Windows.Win32.System.Diagnostics.Debug.WebApp
 * @version v4.0.30319
 */
class UnregisterAuthoringClientFunctionType extends IUnknown {
     ...
     */
    Invoke(host) {
        result := ComCall(3, this, "ptr", host, "int")
        if(result != 0) {
