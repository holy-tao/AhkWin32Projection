 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/winnt/ns-winnt-image_load_config_directory64
    ...
    CodeIntegrity{
        get {
            if(!this.HasProp("__CodeIntegrity"))
                this.__CodeIntegrity := IMAGE_LOAD_CONFIG_CODE_INTEGRITY(148, this)
