...
export default struct IRDPSRAPIViewer extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_SmartSizing := CallbackCreate(ObjBindMethod(implObj, "put_SmartSizing"), flags, 2)
        this.vtbl.get_SmartSizing := CallbackCreate(ObjBindMethod(implObj, "get_SmartSizing"), flags, 2)
        this.vtbl.RequestControl := CallbackCreate(ObjBindMethod(implObj, "RequestControl"), flags, 2)
        this.vtbl.put_DisconnectedText := CallbackCreate(ObjBindMethod(implObj, "put_DisconnectedText"), flags, 2)
        this.vtbl.get_DisconnectedText := CallbackCreate(ObjBindMethod(implObj, "get_DisconnectedText"), flags, 2)
        this.vtbl.RequestColorDepthChange := CallbackCreate(ObjBindMethod(implObj, "RequestColorDepthChange"), flags, 2)
        this.vtbl.get_Properties := CallbackCreate(ObjBindMethod(implObj, "get_Properties"), flags, 2)
        this.vtbl.StartReverseConnectListener := CallbackCreate(ObjBindMethod(implObj, "StartReverseConnectListener"), flags, 5)
    }
