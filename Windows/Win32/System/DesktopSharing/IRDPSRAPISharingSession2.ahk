 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rdpencomapi/nn-rdpencomapi-irdpsrapisharingsession2
...
class IRDPSRAPISharingSession2 extends IRDPSRAPISharingSession{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rdpencomapi/nf-rdpencomapi-irdpsrapisharingsession2-connectusingtransportstream
     */
    ConnectUsingTransportStream(pStream, bstrGroup, bstrAuthenticatedAttendeeName) {
        ...
        if(bstrAuthenticatedAttendeeName is String) {
            pin := BSTR.Alloc(bstrAuthenticatedAttendeeName)
            bstrAuthenticatedAttendeeName := pin.Value
        }

        result := ComCall(21, this, "ptr", pStream, "ptr", bstrGroup, "ptr", bstrAuthenticatedAttendeeName, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rdpencomapi/nf-rdpencomapi-irdpsrapisharingsession2-get_framebuffer
     */
    get_FrameBuffer() {
        result := ComCall(22, this, "ptr*", &ppVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If the method succeeds, the return value is <b>S_OK</b>. Otherwise, the return value is an error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/rdpencomapi/nf-rdpencomapi-irdpsrapisharingsession2-sendcontrollevelchangeresponse
     */
    SendControlLevelChangeResponse(pAttendee, RequestedLevel, ReasonCode) {
        result := ComCall(23, this, "ptr", pAttendee, "int", RequestedLevel, "int", ReasonCode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
