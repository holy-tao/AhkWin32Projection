...
class IRDPSRAPITcpConnectionInfo extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<Int32>} plProtocol 
     * @returns {HRESULT} 
     */
    get_Protocol(plProtocol) {
        result := ComCall(7, this, "int*", plProtocol, "int")
        if(result != 0)
    ...
    /**
     * 
     * @param {Pointer<Int32>} plPort 
     * @returns {HRESULT} 
     */
    get_LocalPort(plPort) {
        result := ComCall(8, this, "int*", plPort, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    get_PeerPort(plPort) {
        result := ComCall(10, this, "int*", plPort, "int")
        if(result != 0)
            throw OSError(result)
