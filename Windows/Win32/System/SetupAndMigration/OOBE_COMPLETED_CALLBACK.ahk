 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/oobenotification/nc-oobenotification-oobe_completed_callback
 * @namespace Windows.Win32.System.SetupAndMigration
 * @version v4.0.30319
 */
class OOBE_COMPLETED_CALLBACK extends IUnknown {
    ...
    Invoke(CallbackContext) {
        ...
        ComCall(3, this, CallbackContextMarshal, CallbackContext)
    }
}
