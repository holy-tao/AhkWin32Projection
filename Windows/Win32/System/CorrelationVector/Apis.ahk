...
;@region Methods
     ...
     * @returns {Integer} 
     */
    static RtlInitializeCorrelationVector(CorrelationVector, Version_, Guid) {
        result := DllCall("ntdll.dll\RtlInitializeCorrelationVector", "ptr", CorrelationVector, "int", Version_, "ptr", Guid, "uint")
        return result
    }
