 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-ithreadpoolknobs
...
class IThreadPoolKnobs extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-getmaxthreads
     */
    GetMaxThreads(plcMaxThreads) {
        plcMaxThreadsMarshal := plcMaxThreads is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, plcMaxThreadsMarshal, plcMaxThreads, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-getcurrentthreads
     */
    GetCurrentThreads(plcCurrentThreads) {
        plcCurrentThreadsMarshal := plcCurrentThreads is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, plcCurrentThreadsMarshal, plcCurrentThreads, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-setmaxthreads
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-getdeletedelay
     */
    GetDeleteDelay(pmsecDeleteDelay) {
        pmsecDeleteDelayMarshal := pmsecDeleteDelay is VarRef ? "int*" : "ptr"

        result := ComCall(6, this, pmsecDeleteDelayMarshal, pmsecDeleteDelay, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-setdeletedelay
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-getmaxqueuedrequests
     */
    GetMaxQueuedRequests(plcMaxQueuedRequests) {
        plcMaxQueuedRequestsMarshal := plcMaxQueuedRequests is VarRef ? "int*" : "ptr"

        result := ComCall(8, this, plcMaxQueuedRequestsMarshal, plcMaxQueuedRequests, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-getcurrentqueuedrequests
     */
    GetCurrentQueuedRequests(plcCurrentQueuedRequests) {
        ...
        result := ComCall(9, this, plcCurrentQueuedRequestsMarshal, plcCurrentQueuedRequests, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-setmaxqueuedrequests
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-setminthreads
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-ithreadpoolknobs-setqueuedepth
     */
