...
export default struct ICOMAdminCatalog2 extends ICOMAdminCatalog {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetCollectionByQuery2 := CallbackCreate(ObjBindMethod(implObj, "GetCollectionByQuery2"), flags, 4)
        this.vtbl.GetApplicationInstanceIDFromProcessID := CallbackCreate(ObjBindMethod(implObj, "GetApplicationInstanceIDFromProcessID"), flags, 3)
        this.vtbl.ShutdownApplicationInstances := CallbackCreate(ObjBindMethod(implObj, "ShutdownApplicationInstances"), flags, 2)
        this.vtbl.PauseApplicationInstances := CallbackCreate(ObjBindMethod(implObj, "PauseApplicationInstances"), flags, 2)
        this.vtbl.ResumeApplicationInstances := CallbackCreate(ObjBindMethod(implObj, "ResumeApplicationInstances"), flags, 2)
        this.vtbl.RecycleApplicationInstances := CallbackCreate(ObjBindMethod(implObj, "RecycleApplicationInstances"), flags, 3)
        this.vtbl.AreApplicationInstancesPaused := CallbackCreate(ObjBindMethod(implObj, "AreApplicationInstancesPaused"), flags, 3)
        this.vtbl.DumpApplicationInstance := CallbackCreate(ObjBindMethod(implObj, "DumpApplicationInstance"), flags, 5)
        this.vtbl.get_IsApplicationInstanceDumpSupported := CallbackCreate(ObjBindMethod(implObj, "get_IsApplicationInstanceDumpSupported"), flags, 2)
        this.vtbl.CreateServiceForApplication := CallbackCreate(ObjBindMethod(implObj, "CreateServiceForApplication"), flags, 9)
        this.vtbl.DeleteServiceForApplication := CallbackCreate(ObjBindMethod(implObj, "DeleteServiceForApplication"), flags, 2)
        this.vtbl.GetPartitionID := CallbackCreate(ObjBindMethod(implObj, "GetPartitionID"), flags, 3)
        this.vtbl.GetPartitionName := CallbackCreate(ObjBindMethod(implObj, "GetPartitionName"), flags, 3)
        this.vtbl.put_CurrentPartition := CallbackCreate(ObjBindMethod(implObj, "put_CurrentPartition"), flags, 2)
        this.vtbl.get_CurrentPartitionID := CallbackCreate(ObjBindMethod(implObj, "get_CurrentPartitionID"), flags, 2)
        this.vtbl.get_CurrentPartitionName := CallbackCreate(ObjBindMethod(implObj, "get_CurrentPartitionName"), flags, 2)
        this.vtbl.get_GlobalPartitionID := CallbackCreate(ObjBindMethod(implObj, "get_GlobalPartitionID"), flags, 2)
        this.vtbl.FlushPartitionCache := CallbackCreate(ObjBindMethod(implObj, "FlushPartitionCache"), flags, 1)
        this.vtbl.CopyApplications := CallbackCreate(ObjBindMethod(implObj, "CopyApplications"), flags, 4)
        this.vtbl.CopyComponents := CallbackCreate(ObjBindMethod(implObj, "CopyComponents"), flags, 4)
        this.vtbl.MoveComponents := CallbackCreate(ObjBindMethod(implObj, "MoveComponents"), flags, 4)
        this.vtbl.AliasComponent := CallbackCreate(ObjBindMethod(implObj, "AliasComponent"), flags, 6)
        this.vtbl.IsSafeToDelete := CallbackCreate(ObjBindMethod(implObj, "IsSafeToDelete"), flags, 3)
        this.vtbl.ImportUnconfiguredComponents := CallbackCreate(ObjBindMethod(implObj, "ImportUnconfiguredComponents"), flags, 4)
        this.vtbl.PromoteUnconfiguredComponents := CallbackCreate(ObjBindMethod(implObj, "PromoteUnconfiguredComponents"), flags, 4)
        this.vtbl.ImportComponents := CallbackCreate(ObjBindMethod(implObj, "ImportComponents"), flags, 4)
        this.vtbl.get_Is64BitCatalogServer := CallbackCreate(ObjBindMethod(implObj, "get_Is64BitCatalogServer"), flags, 2)
        this.vtbl.ExportPartition := CallbackCreate(ObjBindMethod(implObj, "ExportPartition"), flags, 4)
        this.vtbl.InstallPartition := CallbackCreate(ObjBindMethod(implObj, "InstallPartition"), flags, 7)
        this.vtbl.QueryApplicationFile2 := CallbackCreate(ObjBindMethod(implObj, "QueryApplicationFile2"), flags, 3)
        this.vtbl.GetComponentVersionCount := CallbackCreate(ObjBindMethod(implObj, "GetComponentVersionCount"), flags, 3)
    }
