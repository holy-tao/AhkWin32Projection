 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icomobjectpoolevents
...
class IComObjectPoolEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomobjectpoolevents-onobjpoolputobject
     */
     ...
     * @param {Integer} oid The unique identifier for this object.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomobjectpoolevents-onobjpoolgetobject
     */
     ...
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomobjectpoolevents-onobjpoolrecycletotx
     */
     ...
     * @param {Integer} objid The unique identifier for this object.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomobjectpoolevents-onobjpoolgetfromtx
     */
