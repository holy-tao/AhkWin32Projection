 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iselectcomlbserver
...
class ISelectCOMLBServer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iselectcomlbserver-init
     */
    Init() {
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iselectcomlbserver-getlbserver
     */
    GetLBServer(pUnk) {
