 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-isecurityproperty
...
class ISecurityProperty extends IUnknown{
     ...
     * @param {Pointer<PSID>} pSID_ A reference to the security ID of the process that directly created the current object.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isecurityproperty-getdirectcreatorsid
     */
    GetDirectCreatorSID(pSID_) {
        pSID_Marshal := pSID_ is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, pSID_Marshal, pSID_, "int")
        if(result != 0) {
     ...
     * @param {Pointer<PSID>} pSID_ A reference to the security ID of the base process that initiated the activity in which the current object is executing.
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, and E_FAIL, as well as the following values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isecurityproperty-getoriginalcreatorsid
     */
    GetOriginalCreatorSID(pSID_) {
        pSID_Marshal := pSID_ is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, pSID_Marshal, pSID_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<PSID>} pSID_ A reference to the security ID of the process from which the current method was invoked.
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, and E_FAIL, as well as the following values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isecurityproperty-getdirectcallersid
     */
    GetDirectCallerSID(pSID_) {
        pSID_Marshal := pSID_ is VarRef ? "ptr*" : "ptr"

        result := ComCall(5, this, pSID_Marshal, pSID_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<PSID>} pSID_ A reference to the security ID of the base process that initiated the call sequence from which the current 
     *       method was called.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isecurityproperty-getoriginalcallersid
     */
    GetOriginalCallerSID(pSID_) {
        pSID_Marshal := pSID_ is VarRef ? "ptr*" : "ptr"

        result := ComCall(6, this, pSID_Marshal, pSID_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {PSID} pSID_ A reference to a security ID.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isecurityproperty-releasesid
     */
    ReleaseSID(pSID_) {
        result := ComCall(7, this, "ptr", pSID_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
