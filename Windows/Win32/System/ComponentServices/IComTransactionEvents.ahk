 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icomtransactionevents
...
class IComTransactionEvents extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomtransactionevents-ontransactionstart
     */
     ...
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomtransactionevents-ontransactionprepare
     */
     ...
     * @param {Pointer<Guid>} guidTx The transaction identifier.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomtransactionevents-ontransactionabort
     */
     ...
     * @param {Pointer<Guid>} guidTx The transaction identifier.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icomtransactionevents-ontransactioncommit
     */
