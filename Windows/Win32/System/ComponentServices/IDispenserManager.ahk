 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-idispensermanager
...
class IDispenserManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-idispensermanager-registerdispenser
     */
    RegisterDispenser(__MIDL__IDispenserManager0000, szDispenserName) {
        ...
        result := ComCall(3, this, "ptr", __MIDL__IDispenserManager0000, "ptr", szDispenserName, "ptr*", &__MIDL__IDispenserManager0001 := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-idispensermanager-getcontext
     */
    GetContext(__MIDL__IDispenserManager0002, __MIDL__IDispenserManager0003) {
        ...
        result := ComCall(4, this, __MIDL__IDispenserManager0002Marshal, __MIDL__IDispenserManager0002, __MIDL__IDispenserManager0003Marshal, __MIDL__IDispenserManager0003, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
