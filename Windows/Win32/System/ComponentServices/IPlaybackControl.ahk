 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iplaybackcontrol
...
class IPlaybackControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iplaybackcontrol-finalclientretry
     */
    FinalClientRetry() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iplaybackcontrol-finalserverretry
     */
    FinalServerRetry() {
