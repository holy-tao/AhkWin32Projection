...
export default struct IComCRMEvents extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.OnCRMRecoveryStart := CallbackCreate(ObjBindMethod(implObj, "OnCRMRecoveryStart"), flags, 3)
        this.vtbl.OnCRMRecoveryDone := CallbackCreate(ObjBindMethod(implObj, "OnCRMRecoveryDone"), flags, 3)
        this.vtbl.OnCRMCheckpoint := CallbackCreate(ObjBindMethod(implObj, "OnCRMCheckpoint"), flags, 3)
        this.vtbl.OnCRMBegin := CallbackCreate(ObjBindMethod(implObj, "OnCRMBegin"), flags, 7)
        this.vtbl.OnCRMPrepare := CallbackCreate(ObjBindMethod(implObj, "OnCRMPrepare"), flags, 3)
        this.vtbl.OnCRMCommit := CallbackCreate(ObjBindMethod(implObj, "OnCRMCommit"), flags, 3)
        this.vtbl.OnCRMAbort := CallbackCreate(ObjBindMethod(implObj, "OnCRMAbort"), flags, 3)
        this.vtbl.OnCRMIndoubt := CallbackCreate(ObjBindMethod(implObj, "OnCRMIndoubt"), flags, 3)
        this.vtbl.OnCRMDone := CallbackCreate(ObjBindMethod(implObj, "OnCRMDone"), flags, 3)
        this.vtbl.OnCRMRelease := CallbackCreate(ObjBindMethod(implObj, "OnCRMRelease"), flags, 3)
        this.vtbl.OnCRMAnalyze := CallbackCreate(ObjBindMethod(implObj, "OnCRMAnalyze"), flags, 5)
        this.vtbl.OnCRMWrite := CallbackCreate(ObjBindMethod(implObj, "OnCRMWrite"), flags, 5)
        this.vtbl.OnCRMForget := CallbackCreate(ObjBindMethod(implObj, "OnCRMForget"), flags, 3)
        this.vtbl.OnCRMForce := CallbackCreate(ObjBindMethod(implObj, "OnCRMForce"), flags, 3)
        this.vtbl.OnCRMDeliver := CallbackCreate(ObjBindMethod(implObj, "OnCRMDeliver"), flags, 5)
    }
