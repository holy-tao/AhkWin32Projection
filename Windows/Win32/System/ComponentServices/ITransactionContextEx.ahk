 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-itransactioncontextex
...
class ITransactionContextEx extends IUnknown{
     ...
     * @returns {Pointer<Pointer<Void>>} A reference to a new object of the type specified by the <i>rclsid</i> parameter, through the interface specified by the <i>riid</i> parameter.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactioncontextex-createinstance
     */
    CreateInstance(rclsid, riid) {
        result := ComCall(3, this, "ptr", rclsid, "ptr", riid, "ptr*", &pObject := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactioncontextex-commit
     */
    Commit() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactioncontextex-abort
     */
    Abort() {
