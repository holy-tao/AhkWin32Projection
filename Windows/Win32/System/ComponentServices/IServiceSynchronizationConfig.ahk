 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iservicesynchronizationconfig
...
class IServiceSynchronizationConfig extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iservicesynchronizationconfig-configuresynchronization
     */
    ConfigureSynchronization(synchConfig) {
        result := ComCall(3, this, "int", synchConfig, "int")
        if(result != 0) {
