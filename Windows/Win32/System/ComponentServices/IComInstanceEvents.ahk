...
export default struct IComInstanceEvents extends IUnknown {
    ...
    */
    ...
    OnObjectCreate(pInfo, guidActivity, clsid, tsid, CtxtID, _ObjectID) {
        result := ComCall(3, this, COMSVCSEVENTINFO.Ptr, pInfo, Guid.Ptr, guidActivity, Guid.Ptr, clsid, Guid.Ptr, tsid, Int64, CtxtID, Int64, _ObjectID, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.OnObjectCreate := CallbackCreate(ObjBindMethod(implObj, "OnObjectCreate"), flags, 7)
        this.vtbl.OnObjectDestroy := CallbackCreate(ObjBindMethod(implObj, "OnObjectDestroy"), flags, 3)
    }
