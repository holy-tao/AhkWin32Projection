 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icommethod2events
...
class IComMethod2Events extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icommethod2events-onmethodcall2
     */
    OnMethodCall2(pInfo, oid, guidCid, guidRid, dwThread, iMeth) {
        result := ComCall(3, this, "ptr", pInfo, "uint", oid, "ptr", guidCid, "ptr", guidRid, "uint", dwThread, "uint", iMeth, "int")
        if(result != 0) {
     ...
     * @param {Integer} dwThread The identifier of the thread executing the call.
     * @param {Integer} iMeth The v-table index of the method.
     * @param {HRESULT} hresult_ The result of the method call.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icommethod2events-onmethodreturn2
     */
    OnMethodReturn2(pInfo, oid, guidCid, guidRid, dwThread, iMeth, hresult_) {
        result := ComCall(4, this, "ptr", pInfo, "uint", oid, "ptr", guidCid, "ptr", guidRid, "uint", dwThread, "uint", iMeth, "int", hresult_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} iMeth The v-table index of the method.
     * @returns {HRESULT} The user verifies the return values from this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icommethod2events-onmethodexception2
     */
    OnMethodException2(pInfo, oid, guidCid, guidRid, dwThread, iMeth) {
        result := ComCall(5, this, "ptr", pInfo, "uint", oid, "ptr", guidCid, "ptr", guidRid, "uint", dwThread, "uint", iMeth, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
