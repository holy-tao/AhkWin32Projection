 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-objectcontrol
...
class ObjectControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-objectcontrol-activate
     */
    Activate() {
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-objectcontrol-deactivate
     */
    Deactivate() {
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-objectcontrol-canbepooled
     */
    CanBePooled(pbPoolable) {
        pbPoolableMarshal := pbPoolable is VarRef ? "short*" : "ptr"

        result := ComCall(5, this, pbPoolableMarshal, pbPoolable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
