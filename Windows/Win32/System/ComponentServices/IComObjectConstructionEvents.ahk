...
export default struct IComObjectConstructionEvents extends IUnknown {
    ...
    */
    ...
    OnObjectConstruct(pInfo, guidObject, sConstructString, oid) {
        ...
        result := ComCall(3, this, COMSVCSEVENTINFO.Ptr, pInfo, Guid.Ptr, guidObject, "ptr", sConstructString, Int64, oid, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.OnObjectConstruct := CallbackCreate(ObjBindMethod(implObj, "OnObjectConstruct"), flags, 5)
    }
