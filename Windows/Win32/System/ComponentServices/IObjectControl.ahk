 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iobjectcontrol
...
class IObjectControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjectcontrol-activate
     */
    Activate() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjectcontrol-deactivate
     */
    Deactivate() {
        ComCall(4, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjectcontrol-canbepooled
     */
    CanBePooled() {
