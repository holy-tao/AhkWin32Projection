 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-isharedpropertygroup
...
class ISharedPropertyGroup extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isharedpropertygroup-createpropertybyposition
     */
    CreatePropertyByPosition(Index, fExists, ppProp) {
        fExistsMarshal := fExists is VarRef ? "short*" : "ptr"

        result := ComCall(7, this, "int", Index, fExistsMarshal, fExists, "ptr*", ppProp, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isharedpropertygroup-get_propertybyposition
     */
    get_PropertyByPosition(Index) {
        result := ComCall(8, this, "int", Index, "ptr*", &ppProperty := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isharedpropertygroup-createproperty
     */
    CreateProperty(Name, fExists, ppProp) {
        ...
        result := ComCall(9, this, "ptr", Name, fExistsMarshal, fExists, "ptr*", ppProp, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-isharedpropertygroup-get_property
     */
    get_Property(Name) {
        if(Name is String) {
            pin := BSTR.Alloc(Name)
        ...
        result := ComCall(10, this, "ptr", Name, "ptr*", &ppProperty := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
