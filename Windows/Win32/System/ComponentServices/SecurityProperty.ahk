 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-securityproperty
...
class SecurityProperty extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-securityproperty-getdirectcallername
     */
    GetDirectCallerName() {
        bstrUserName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-securityproperty-getdirectcreatorname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-securityproperty-getoriginalcallername
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-securityproperty-getoriginalcreatorname
     */
