 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iservicetrackerconfig
...
class IServiceTrackerConfig extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iservicetrackerconfig-trackerconfig
     */
    TrackerConfig(trackerConfig, szTrackerAppName, szTrackerCtxName) {
        ...
        result := ComCall(3, this, "int", trackerConfig, "ptr", szTrackerAppName, "ptr", szTrackerCtxName, "int")
        if(result != 0) {
