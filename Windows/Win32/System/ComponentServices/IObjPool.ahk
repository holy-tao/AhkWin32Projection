 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iobjpool
...
class IObjPool extends IUnknown{
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjpool-putendtx
     */
    PutEndTx(pObj) {
