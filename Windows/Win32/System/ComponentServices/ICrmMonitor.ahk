 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icrmmonitor
...
class ICrmMonitor extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmmonitor-getclerks
     */
    GetClerks() {
        result := ComCall(3, this, "ptr*", &pClerks := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmmonitor-holdclerk
     */
    HoldClerk(Index) {
        pItem := VARIANT()
        result := ComCall(4, this, "ptr", Index, "ptr", pItem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
