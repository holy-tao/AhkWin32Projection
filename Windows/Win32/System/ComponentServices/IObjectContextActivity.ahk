 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iobjectcontextactivity
...
class IObjectContextActivity extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjectcontextactivity-getactivityid
     */
    GetActivityId(pGUID) {
