 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-itransactionproxy
...
class ITransactionProxy extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-commit
     */
    Commit(guid) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-abort
     */
    Abort() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-promote
     */
    Promote() {
        result := ComCall(5, this, "ptr*", &pTransaction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-createvoter
     */
    CreateVoter(pTxAsync) {
        result := ComCall(6, this, "ptr", pTxAsync, "ptr*", &ppBallot := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-getisolationlevel
     */
    GetIsolationLevel(__MIDL__ITransactionProxy0000) {
        ...
        result := ComCall(7, this, __MIDL__ITransactionProxy0000Marshal, __MIDL__ITransactionProxy0000, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-getidentifier
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_UNEXPECTED, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionproxy-isreusable
     */
    IsReusable(pfIsReusable) {
        pfIsReusableMarshal := pfIsReusable is VarRef ? "int*" : "ptr"

        result := ComCall(9, this, pfIsReusableMarshal, pfIsReusable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
