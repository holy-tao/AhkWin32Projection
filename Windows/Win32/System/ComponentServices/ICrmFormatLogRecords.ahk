 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icrmformatlogrecords
...
class ICrmFormatLogRecords extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmformatlogrecords-getcolumncount
     */
    GetColumnCount() {
        result := ComCall(3, this, "int*", &plColumnCount := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmformatlogrecords-getcolumnheaders
     */
    GetColumnHeaders() {
        pHeaders := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmformatlogrecords-getcolumn
     */
    GetColumn(CrmLogRec) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icrmformatlogrecords-getcolumnvariants
     */
