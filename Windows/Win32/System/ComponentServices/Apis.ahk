 ...
 */
export CoGetDefaultContext(_aptType, riid) {
    result := DllCall("OLE32.dll\CoGetDefaultContext", APTTYPE, _aptType, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 * @since windows5.1.2600
 */
export CoEnterServiceDomain(pConfigObject) {
 ...
 * @since windows5.1.2600
 */
export CoLeaveServiceDomain(pUnkStatus) {
 ...
 * @since windows5.0
 */
export SafeRef(rid, pUnk) {
    result := DllCall("comsvcs.dll\SafeRef", Guid.Ptr, rid, "ptr", pUnk, IntPtr)
    return result
}
 ...
 * @since windows5.0
 */
export GetDispenserManager() {
    result := DllCall("MTxDM.dll\GetDispenserManager", "ptr*", &param0 := 0, "HRESULT")
