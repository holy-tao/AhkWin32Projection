 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-iobjectcontexttip
...
class IObjectContextTip extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-iobjectcontexttip-gettipurl
     */
    GetTipUrl(pTipUrl) {
