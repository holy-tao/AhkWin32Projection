...
class IComSecurityEvents extends IUnknown {
    ...
    OnAuthenticate(pInfo, guidActivity, _ObjectID, guidIID, iMeth, cbByteOrig, pSidOriginalUser, cbByteCur, pSidCurrentUser, bCurrentUserInpersonatingInProc) {
        ...
        result := ComCall(3, this, "ptr", pInfo, "ptr", guidActivity, "uint", _ObjectID, "ptr", guidIID, "uint", iMeth, "uint", cbByteOrig, pSidOriginalUserMarshal, pSidOriginalUser, "uint", cbByteCur, pSidCurrentUserMarshal, pSidCurrentUser, "int", bCurrentUserInpersonatingInProc, "HRESULT")
        return result
    }
    ...
    OnAuthenticateFail(pInfo, guidActivity, _ObjectID, guidIID, iMeth, cbByteOrig, pSidOriginalUser, cbByteCur, pSidCurrentUser, bCurrentUserInpersonatingInProc) {
        ...
        result := ComCall(4, this, "ptr", pInfo, "ptr", guidActivity, "uint", _ObjectID, "ptr", guidIID, "uint", iMeth, "uint", cbByteOrig, pSidOriginalUserMarshal, pSidOriginalUser, "uint", cbByteCur, pSidCurrentUserMarshal, pSidCurrentUser, "int", bCurrentUserInpersonatingInProc, "HRESULT")
        return result
    }
}
