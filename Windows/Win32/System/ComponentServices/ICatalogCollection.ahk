...
export default struct ICatalogCollection extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.Populate := CallbackCreate(ObjBindMethod(implObj, "Populate"), flags, 1)
        this.vtbl.SaveChanges := CallbackCreate(ObjBindMethod(implObj, "SaveChanges"), flags, 2)
        this.vtbl.GetCollection := CallbackCreate(ObjBindMethod(implObj, "GetCollection"), flags, 4)
        this.vtbl.get_Name := CallbackCreate(ObjBindMethod(implObj, "get_Name"), flags, 2)
        this.vtbl.get_AddEnabled := CallbackCreate(ObjBindMethod(implObj, "get_AddEnabled"), flags, 2)
        this.vtbl.get_RemoveEnabled := CallbackCreate(ObjBindMethod(implObj, "get_RemoveEnabled"), flags, 2)
        this.vtbl.GetUtilInterface := CallbackCreate(ObjBindMethod(implObj, "GetUtilInterface"), flags, 2)
        this.vtbl.get_DataStoreMajorVersion := CallbackCreate(ObjBindMethod(implObj, "get_DataStoreMajorVersion"), flags, 2)
        this.vtbl.get_DataStoreMinorVersion := CallbackCreate(ObjBindMethod(implObj, "get_DataStoreMinorVersion"), flags, 2)
        this.vtbl.PopulateByKey := CallbackCreate(ObjBindMethod(implObj, "PopulateByKey"), flags, 2)
        this.vtbl.PopulateByQuery := CallbackCreate(ObjBindMethod(implObj, "PopulateByQuery"), flags, 3)
    }
