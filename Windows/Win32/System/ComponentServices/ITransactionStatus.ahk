 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-itransactionstatus
...
class ITransactionStatus extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionstatus-settransactionstatus
     */
     ...
     * @returns {HRESULT} This method can return the standard return values E_INVALIDARG, E_OUTOFMEMORY, E_FAIL, and S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-itransactionstatus-gettransactionstatus
     */
    GetTransactionStatus(pHrStatus) {
        pHrStatusMarshal := pHrStatus is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, pHrStatusMarshal, pHrStatus, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
