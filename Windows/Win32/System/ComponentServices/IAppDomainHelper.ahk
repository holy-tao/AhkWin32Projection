...
class IAppDomainHelper extends IDispatch{
    ...
    Initialize(pUnkAD, __MIDL__IAppDomainHelper0000, pPool) {
        result := ComCall(7, this, "ptr", pUnkAD, "ptr", __MIDL__IAppDomainHelper0000, "ptr", pPool, "int")
        if(result != 0)
    ...
    DoCallback(pUnkAD, __MIDL__IAppDomainHelper0001, pPool) {
        result := ComCall(8, this, "ptr", pUnkAD, "ptr", __MIDL__IAppDomainHelper0001, "ptr", pPool, "int")
        if(result != 0)
            throw OSError(result)
