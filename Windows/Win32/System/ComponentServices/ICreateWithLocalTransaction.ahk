 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nn-comsvcs-icreatewithlocaltransaction
...
class ICreateWithLocalTransaction extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/comsvcs/nf-comsvcs-icreatewithlocaltransaction-createinstancewithsystx
     */
    CreateInstanceWithSysTx(pTransaction, rclsid, riid, pObject) {
        pObjectMarshal := pObject is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pTransaction, "ptr", rclsid, "ptr", riid, pObjectMarshal, pObject, "int")
        if(result != 0) {
