 ...
 */
export default struct PFN_FREEDEFUSAGE {
    value : IntPtr

    __value {
        set {
            if (value is PFN_FREEDEFUSAGE) {
    ...
    /**
     * A PFN_FREEDEFUSAGE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_FREEDEFUSAGE {
        /**
         * Creates a PFN_FREEDEFUSAGE pointer that invokes the given AHK function when called.
