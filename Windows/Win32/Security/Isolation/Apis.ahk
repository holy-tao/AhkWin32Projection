 ...
 */
export IsProcessInIsolatedContainer() {
    result := DllCall("api-ms-win-security-isolatedcontainer-l1-1-0.dll\IsProcessInIsolatedContainer", BOOL.Ptr, &isProcessInIsolatedContainer := 0, "HRESULT")
 ...
 */
export IsProcessInIsolatedWindowsEnvironment() {
    result := DllCall("IsolatedWindowsEnvironmentUtils.dll\IsProcessInIsolatedWindowsEnvironment", BOOL.Ptr, &isProcessInIsolatedWindowsEnvironment := 0, "HRESULT")
 ...
 */
export IsCrossIsolatedEnvironmentClipboardContent() {
    result := DllCall("IsolatedWindowsEnvironmentUtils.dll\IsCrossIsolatedEnvironmentClipboardContent", BOOL.Ptr, &isCrossIsolatedEnvironmentClipboardContent := 0, "HRESULT")
 ...
 * @since windows8.0
 */
export CreateAppContainerProfile(pszAppContainerName, pszDisplayName, pszDescription, pCapabilities, dwCapabilityCount) {
 ...
 * @since windows8.0
 */
export DeleteAppContainerProfile(pszAppContainerName) {
    pszAppContainerName := pszAppContainerName is String ? StrPtr(pszAppContainerName) : pszAppContainerName
 ...
 * @since windows8.0
 */
export GetAppContainerFolderPath(pszAppContainerSid) {
    pszAppContainerSid := pszAppContainerSid is String ? StrPtr(pszAppContainerSid) : pszAppContainerSid

    result := DllCall("USERENV.dll\GetAppContainerFolderPath", "ptr", pszAppContainerSid, PWSTR.Ptr, &ppszPath := 0, "HRESULT")
    return ppszPath
}
 ...
 */
export DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName(psidAppContainerSid, pszRestrictedAppContainerName) {
    ...
    result := DllCall("USERENV.dll\DeriveRestrictedAppContainerSidFromAppContainerSidAndRestrictedName", PSID, psidAppContainerSid, "ptr", pszRestrictedAppContainerName, PSID.Ptr, &ppsidRestrictedAppContainerSid := 0, "HRESULT")
 ...
 * @since windows8.0
 */
export DeriveAppContainerSidFromAppContainerName(pszAppContainerName) {
    pszAppContainerName := pszAppContainerName is String ? StrPtr(pszAppContainerName) : pszAppContainerName

    result := DllCall("USERENV.dll\DeriveAppContainerSidFromAppContainerName", "ptr", pszAppContainerName, PSID.Ptr, &ppsidAppContainerSid := 0, "HRESULT")
    return ppsidAppContainerSid
}
