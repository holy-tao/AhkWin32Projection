 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spfreecredentialshandlefn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpFreeCredentialsHandleFn extends IUnknown {
     ...
     */
    Invoke(CredentialHandle) {
        result := ComCall(3, this, "ptr", CredentialHandle, "int")
        return result
    }
}
