 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spcompleteauthtokenfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpCompleteAuthTokenFn extends IUnknown {
     ...
     */
    Invoke(ContextHandle, InputBuffer) {
        result := ComCall(3, this, "ptr", ContextHandle, "ptr", InputBuffer, "int")
        return result
    }
}
