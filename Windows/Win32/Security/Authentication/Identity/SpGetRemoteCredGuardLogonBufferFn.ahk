 ...
 * @version v4.0.30319
 */
class SpGetRemoteCredGuardLogonBufferFn extends IUnknown {
     ...
     */
    Invoke(CredHandle, ContextHandle, TargetName, RedirectedLogonHandle, Callback, CleanupCallback, LogonBufferSize, LogonBuffer) {
        ...
        result := ComCall(3, this, "ptr", CredHandle, "ptr", ContextHandle, "ptr", TargetName, "ptr", RedirectedLogonHandle, CallbackMarshal, Callback, CleanupCallbackMarshal, CleanupCallback, LogonBufferSizeMarshal, LogonBufferSize, LogonBufferMarshal, LogonBuffer, "int")
        return result
    }
}
