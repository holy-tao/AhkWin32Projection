 ...
 * @version v4.0.30319
 */
class PLSA_GET_USER_CREDENTIALS extends IUnknown {
     ...
     */
    Invoke(UserHandle, PrimaryCreds, PrimaryCredsSize, SupplementalCreds, SupplementalCredsSize) {
        ...
        result := ComCall(3, this, UserHandleMarshal, UserHandle, PrimaryCredsMarshal, PrimaryCreds, PrimaryCredsSizeMarshal, PrimaryCredsSize, SupplementalCredsMarshal, SupplementalCreds, SupplementalCredsSizeMarshal, SupplementalCredsSize, "int")
        return result
    }
}
