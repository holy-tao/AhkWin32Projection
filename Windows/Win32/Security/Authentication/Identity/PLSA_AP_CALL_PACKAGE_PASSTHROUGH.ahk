 ...
 * @version v4.0.30319
 */
class PLSA_AP_CALL_PACKAGE_PASSTHROUGH extends IUnknown {
     ...
     */
    Invoke(ClientRequest, ProtocolSubmitBuffer, ClientBufferBase, SubmitBufferLength, ProtocolReturnBuffer, ReturnBufferLength, ProtocolStatus) {
        ...
        result := ComCall(3, this, ClientRequestMarshal, ClientRequest, "ptr", ProtocolSubmitBuffer, ClientBufferBaseMarshal, ClientBufferBase, "uint", SubmitBufferLength, ProtocolReturnBufferMarshal, ProtocolReturnBuffer, ReturnBufferLengthMarshal, ReturnBufferLength, ProtocolStatusMarshal, ProtocolStatus, "int")
        return result
    }
}
