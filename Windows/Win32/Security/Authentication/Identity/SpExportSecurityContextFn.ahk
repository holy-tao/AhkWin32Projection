 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spexportsecuritycontextfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpExportSecurityContextFn extends IUnknown {
     ...
     * @param {Pointer} phContext 
     * @param {Integer} fFlags 
     * @param {Pointer<SecBuffer>} pPackedContext 
     * @param {Pointer<HANDLE>} pToken 
     ...
     */
    Invoke(phContext, fFlags, pPackedContext, pToken) {
        result := ComCall(3, this, "ptr", phContext, "uint", fFlags, "ptr", pPackedContext, "ptr", pToken, "int")
        return result
    }
}
