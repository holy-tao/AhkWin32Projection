 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spformatcredentialsfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpFormatCredentialsFn extends IUnknown {
     ...
     * @param {Pointer<SecBuffer>} Credentials 
     * @param {Pointer<SecBuffer>} FormattedCredentials 
     ...
     */
    Invoke(Credentials, FormattedCredentials) {
        result := ComCall(3, this, "ptr", Credentials, "ptr", FormattedCredentials, "int")
        return result
    }
}
