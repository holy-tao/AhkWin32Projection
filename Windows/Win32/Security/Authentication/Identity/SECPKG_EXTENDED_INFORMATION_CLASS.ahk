...
class SECPKG_EXTENDED_INFORMATION_CLASS extends Win32Enum {
     ...
     * Native name: SecpkgContextThunks
     * @type {Integer (Int32)}
     */
    static ContextThunks => 2
     ...
     * Native name: SecpkgMutualAuthLevel
     * @type {Integer (Int32)}
     */
    static MutualAuthLevel => 3
     ...
     * Native name: SecpkgWowClientDll
     * @type {Integer (Int32)}
     */
    static WowClientDll => 4

    /**
     * Identifies that extra object identifiers (OIDs) are available.
     * Native name: SecpkgExtraOids
     * @type {Integer (Int32)}
     */
    static ExtraOids => 5
