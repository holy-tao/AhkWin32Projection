 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-splsamodeinitializefn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpLsaModeInitializeFn extends IUnknown {
     ...
     * @param {Pointer<Pointer<SECPKG_FUNCTION_TABLE>>} ppTables 
