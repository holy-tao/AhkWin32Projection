 ...
 * @charset Unicode
 */
export default struct SET_CONTEXT_ATTRIBUTES_FN_W {
    value : IntPtr

    __value {
        set {
            if (value is SET_CONTEXT_ATTRIBUTES_FN_W) {
    ...
    /**
     * A SET_CONTEXT_ATTRIBUTES_FN_W that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SET_CONTEXT_ATTRIBUTES_FN_W {
        /**
         * Creates a SET_CONTEXT_ATTRIBUTES_FN_W pointer that invokes the given AHK function when called.
