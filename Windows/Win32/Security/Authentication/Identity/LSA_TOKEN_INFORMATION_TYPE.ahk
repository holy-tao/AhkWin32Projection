...
class LSA_TOKEN_INFORMATION_TYPE extends Win32Enum {
     ...
     * Native name: LsaTokenInformationNull
     * @type {Integer (Int32)}
     */
    static Null => 0
     ...
     * Native name: LsaTokenInformationV1
     * @type {Integer (Int32)}
     */
    static InformationV1 => 1

    /**
     * Native name: LsaTokenInformationV2
     * @type {Integer (Int32)}
     */
    static InformationV2 => 2

    /**
     * Native name: LsaTokenInformationV3
     * @type {Integer (Int32)}
     */
    static InformationV3 => 3
}
