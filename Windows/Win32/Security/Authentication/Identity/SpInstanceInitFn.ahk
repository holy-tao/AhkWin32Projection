 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spinstanceinitfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpInstanceInitFn extends IUnknown {
     ...
     * @param {Pointer<SECPKG_DLL_FUNCTIONS>} FunctionTable 
     * @param {Pointer<Pointer<Void>>} UserFunctions 
     ...
     */
    Invoke(Version_, FunctionTable, UserFunctions) {
        UserFunctionsMarshal := UserFunctions is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "uint", Version_, "ptr", FunctionTable, UserFunctionsMarshal, UserFunctions, "int")
        return result
    }
}
