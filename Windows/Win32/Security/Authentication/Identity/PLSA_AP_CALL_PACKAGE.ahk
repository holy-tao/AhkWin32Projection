 ...
 */
export default struct PLSA_AP_CALL_PACKAGE {
    value : IntPtr

    __value {
        set {
            if (value is PLSA_AP_CALL_PACKAGE) {
    ...
    /**
     * A PLSA_AP_CALL_PACKAGE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PLSA_AP_CALL_PACKAGE {
        /**
         * Creates a PLSA_AP_CALL_PACKAGE pointer that invokes the given AHK function when called.
