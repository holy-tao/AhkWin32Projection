 ...
 * @version v4.0.30319
 */
class PLSA_AP_PRE_LOGON_USER_SURROGATE extends IUnknown {
     ...
     */
    Invoke(ClientRequest, LogonType, ProtocolSubmitBuffer, ClientBufferBase, SubmitBufferSize, SurrogateLogon, SubStatus) {
        ...
        result := ComCall(3, this, ClientRequestMarshal, ClientRequest, "int", LogonType, "ptr", ProtocolSubmitBuffer, ClientBufferBaseMarshal, ClientBufferBase, "uint", SubmitBufferSize, "ptr", SurrogateLogon, SubStatusMarshal, SubStatus, "int")
        return result
    }
}
