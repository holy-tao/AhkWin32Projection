 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spaddcredentialsfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpAddCredentialsFn extends IUnknown {
     ...
     * @param {Pointer<LSA_UNICODE_STRING>} Package 
     ...
     */
    Invoke(CredentialHandle, PrincipalName, Package, CredentialUseFlags, AuthorizationData, GetKeyFunciton, GetKeyArgument, ExpirationTime) {
        ...
        result := ComCall(3, this, "ptr", CredentialHandle, "ptr", PrincipalName, "ptr", Package, "uint", CredentialUseFlags, AuthorizationDataMarshal, AuthorizationData, GetKeyFuncitonMarshal, GetKeyFunciton, GetKeyArgumentMarshal, GetKeyArgument, ExpirationTimeMarshal, ExpirationTime, "int")
        return result
    }
}
