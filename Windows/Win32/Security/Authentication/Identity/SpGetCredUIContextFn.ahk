 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spgetcreduicontextfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpGetCredUIContextFn extends IUnknown {
     ...
     * @param {Pointer<Integer>} FlatCredUIContextLength 
     * @param {Pointer<Pointer<Integer>>} FlatCredUIContext 
     ...
     */
    Invoke(ContextHandle, CredType, FlatCredUIContextLength, FlatCredUIContext) {
        ...
        result := ComCall(3, this, "ptr", ContextHandle, "ptr", CredType, FlatCredUIContextLengthMarshal, FlatCredUIContextLength, FlatCredUIContextMarshal, FlatCredUIContext, "int")
        return result
    }
}
