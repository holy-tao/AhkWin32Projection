 ...
 */
export default struct PLSA_CALL_PACKAGEEX {
    value : IntPtr

    __value {
        set {
            if (value is PLSA_CALL_PACKAGEEX) {
    ...
    /**
     * A PLSA_CALL_PACKAGEEX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PLSA_CALL_PACKAGEEX {
        /**
         * Creates a PLSA_CALL_PACKAGEEX pointer that invokes the given AHK function when called.
