 ...
 */
export default struct VERIFY_SIGNATURE_FN {
    value : IntPtr

    __value {
        set {
            if (value is VERIFY_SIGNATURE_FN) {
    ...
    /**
     * A VERIFY_SIGNATURE_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends VERIFY_SIGNATURE_FN {
        /**
         * Creates a VERIFY_SIGNATURE_FN pointer that invokes the given AHK function when called.
