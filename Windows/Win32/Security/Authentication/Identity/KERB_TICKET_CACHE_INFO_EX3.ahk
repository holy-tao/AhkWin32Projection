 ...
 * @version v4.0.30319
 */
class KERB_TICKET_CACHE_INFO_EX3 extends Win32Struct
{
    static sizeof => 128
    ...
    KdcCalled{
        get {
            if(!this.HasProp("__KdcCalled"))
                this.__KdcCalled := LSA_UNICODE_STRING(this.ptr + 112)
            return this.__KdcCalled
        }
    }
}
