 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-kspmakesignaturefn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class KspMakeSignatureFn extends IUnknown {
     ...
     */
    Invoke(ContextId, fQOP, Message, MessageSeqNo) {
        result := ComCall(3, this, "ptr", ContextId, "uint", fQOP, "ptr", Message, "uint", MessageSeqNo, "int")
        return result
    }
}
