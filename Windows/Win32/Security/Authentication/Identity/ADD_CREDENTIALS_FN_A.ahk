...
export default struct ADD_CREDENTIALS_FN_A {
    ...
    Call(param0, param1, param2, param3, param4, param5, param6, param7) {
        ...
        param7Marshal := param7 is VarRef ? "int64*" : IntPtr
    ...
    struct From extends ADD_CREDENTIALS_FN_A {
         ...
         * @param {Func(SecHandle, "char*", "char*", UInt32, "ptr", SEC_GET_KEY_FN, "ptr", "int64*") => "int"} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 8)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 8 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [SecHandle.Ptr, "char*", "char*", UInt32, "ptr", SEC_GET_KEY_FN, "ptr", "int64*", "int"])
        }
