 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-kspdeletecontextfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class KspDeleteContextFn extends IUnknown {
     ...
     */
    Invoke(ContextId, LsaContextId) {
        LsaContextIdMarshal := LsaContextId is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", ContextId, LsaContextIdMarshal, LsaContextId, "int")
        return result
    }
}
