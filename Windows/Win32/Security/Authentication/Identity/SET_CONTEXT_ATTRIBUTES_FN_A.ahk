 ...
 * @charset ANSI
 */
export default struct SET_CONTEXT_ATTRIBUTES_FN_A {
    value : IntPtr

    __value {
        set {
            if (value is SET_CONTEXT_ATTRIBUTES_FN_A) {
    ...
    /**
     * A SET_CONTEXT_ATTRIBUTES_FN_A that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SET_CONTEXT_ATTRIBUTES_FN_A {
        /**
         * Creates a SET_CONTEXT_ATTRIBUTES_FN_A pointer that invokes the given AHK function when called.
