 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spdeletecredentialsfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpDeleteCredentialsFn extends IUnknown {
     ...
     */
    Invoke(CredentialHandle, Key) {
        result := ComCall(3, this, "ptr", CredentialHandle, "ptr", Key, "int")
        return result
    }
}
