 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/ccgplugins/nn-ccgplugins-iccgdomainauthcredentials
...
class ICcgDomainAuthCredentials extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ccgplugins/nf-ccgplugins-iccgdomainauthcredentials-getpasswordcredentials
     */
    GetPasswordCredentials(pluginInput, domainName, username, password) {
        ...
        result := ComCall(3, this, "ptr", pluginInput, domainNameMarshal, domainName, usernameMarshal, username, passwordMarshal, password, "int")
        if(result != 0) {
