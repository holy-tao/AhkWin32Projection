 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spimportsecuritycontextfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpImportSecurityContextFn extends IUnknown {
     ...
     * @param {HANDLE} Token 
     * @param {Pointer<Pointer>} phContext 
     ...
     */
    Invoke(pPackedContext, Token, phContext) {
        Token := Token is Win32Handle ? NumGet(Token, "ptr") : Token

        phContextMarshal := phContext is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pPackedContext, "ptr", Token, phContextMarshal, phContext, "int")
        return result
    }
}
