 ...
 * @charset Unicode
 */
export default struct ACQUIRE_CREDENTIALS_HANDLE_FN_W {
    value : IntPtr

    __value {
        set {
            if (value is ACQUIRE_CREDENTIALS_HANDLE_FN_W) {
    ...
    /**
     * A ACQUIRE_CREDENTIALS_HANDLE_FN_W that invokes the given AHK function when called.
