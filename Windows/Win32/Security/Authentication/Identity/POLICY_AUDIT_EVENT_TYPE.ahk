...
class POLICY_AUDIT_EVENT_TYPE extends Win32Enum {
     ...
     * </ul>
     * Native name: AuditCategorySystem
     * @type {Integer (Int32)}
     */
    static CategorySystem => 0
     ...
     * Native name: AuditCategoryLogon
     * @type {Integer (Int32)}
     */
    static CategoryLogon => 1
     ...
     * Native name: AuditCategoryObjectAccess
     * @type {Integer (Int32)}
     */
    static CategoryObjectAccess => 2
     ...
     * Native name: AuditCategoryPrivilegeUse
     * @type {Integer (Int32)}
     */
    static CategoryPrivilegeUse => 3
     ...
     * Native name: AuditCategoryDetailedTracking
     * @type {Integer (Int32)}
     */
    static CategoryDetailedTracking => 4
     ...
     * Native name: AuditCategoryPolicyChange
     * @type {Integer (Int32)}
     */
    static CategoryPolicyChange => 5
     ...
     * Native name: AuditCategoryAccountManagement
     * @type {Integer (Int32)}
     */
    static CategoryAccountManagement => 6
     ...
     * Native name: AuditCategoryDirectoryServiceAccess
     * @type {Integer (Int32)}
     */
    static CategoryDirectoryServiceAccess => 7
     ...
     * Native name: AuditCategoryAccountLogon
     * @type {Integer (Int32)}
     */
    static CategoryAccountLogon => 8
}
