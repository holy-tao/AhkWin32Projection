 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spgetcontexttokenfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpGetContextTokenFn extends IUnknown {
     ...
     */
    Invoke(ContextHandle, ImpersonationToken) {
        result := ComCall(3, this, "ptr", ContextHandle, "ptr", ImpersonationToken, "int")
        return result
    }
}
