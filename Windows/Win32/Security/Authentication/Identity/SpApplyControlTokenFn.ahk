 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spapplycontroltokenfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpApplyControlTokenFn extends IUnknown {
     ...
     * @param {Pointer<SecBufferDesc>} ControlToken 
     ...
     */
    Invoke(ContextHandle, ControlToken) {
        result := ComCall(3, this, "ptr", ContextHandle, "ptr", ControlToken, "int")
        return result
    }
}
