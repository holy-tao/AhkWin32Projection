 ...
 * @version v4.0.30319
 */
class PLSA_CALL_PACKAGE extends IUnknown {
     ...
     */
    Invoke(AuthenticationPackage, ProtocolSubmitBuffer, SubmitBufferLength, ProtocolReturnBuffer, ReturnBufferLength, ProtocolStatus) {
        ...
        result := ComCall(3, this, "ptr", AuthenticationPackage, "ptr", ProtocolSubmitBuffer, "uint", SubmitBufferLength, ProtocolReturnBufferMarshal, ProtocolReturnBuffer, ReturnBufferLengthMarshal, ReturnBufferLength, ProtocolStatusMarshal, ProtocolStatus, "int")
        return result
    }
}
