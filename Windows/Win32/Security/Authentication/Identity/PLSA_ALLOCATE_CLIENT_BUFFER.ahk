 ...
 */
export default struct PLSA_ALLOCATE_CLIENT_BUFFER {
    value : IntPtr

    __value {
        set {
            if (value is PLSA_ALLOCATE_CLIENT_BUFFER) {
    ...
    /**
     * A PLSA_ALLOCATE_CLIENT_BUFFER that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PLSA_ALLOCATE_CLIENT_BUFFER {
        /**
         * Creates a PLSA_ALLOCATE_CLIENT_BUFFER pointer that invokes the given AHK function when called.
