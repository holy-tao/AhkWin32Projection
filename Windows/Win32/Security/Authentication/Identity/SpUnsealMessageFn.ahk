 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spunsealmessagefn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpUnsealMessageFn extends IUnknown {
     ...
     */
    Invoke(ContextHandle, MessageBuffers, MessageSequenceNumber, QualityOfProtection) {
        QualityOfProtectionMarshal := QualityOfProtection is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", ContextHandle, "ptr", MessageBuffers, "uint", MessageSequenceNumber, QualityOfProtectionMarshal, QualityOfProtection, "int")
        return result
    }
}
