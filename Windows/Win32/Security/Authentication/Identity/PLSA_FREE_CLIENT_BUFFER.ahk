 ...
 * @version v4.0.30319
 */
class PLSA_FREE_CLIENT_BUFFER extends IUnknown {
     ...
     */
    Invoke(ClientRequest, ClientBaseAddress) {
        ClientRequestMarshal := ClientRequest is VarRef ? "ptr*" : "ptr"
        ClientBaseAddressMarshal := ClientBaseAddress is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, ClientRequestMarshal, ClientRequest, ClientBaseAddressMarshal, ClientBaseAddress, "int")
        return result
    }
}
