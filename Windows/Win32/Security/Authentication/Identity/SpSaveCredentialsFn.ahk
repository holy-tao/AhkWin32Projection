 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spsavecredentialsfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpSaveCredentialsFn extends IUnknown {
     ...
     */
    Invoke(CredentialHandle, Credentials) {
        result := ComCall(3, this, "ptr", CredentialHandle, "ptr", Credentials, "int")
        return result
    }
}
