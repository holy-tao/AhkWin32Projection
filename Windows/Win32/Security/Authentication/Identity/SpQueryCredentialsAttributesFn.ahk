 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntsecpkg/nc-ntsecpkg-spquerycredentialsattributesfn
 * @namespace Windows.Win32.Security.Authentication.Identity
 * @version v4.0.30319
 */
class SpQueryCredentialsAttributesFn extends IUnknown {
     ...
     */
    Invoke(CredentialHandle, CredentialAttribute, Buffer_) {
        Buffer_Marshal := Buffer_ is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", CredentialHandle, "uint", CredentialAttribute, Buffer_Marshal, Buffer_, "int")
        return result
    }
}
