 ...
 */
export default struct APPLY_CONTROL_TOKEN_FN {
    value : IntPtr

    __value {
        set {
            if (value is APPLY_CONTROL_TOKEN_FN) {
    ...
    /**
     * A APPLY_CONTROL_TOKEN_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends APPLY_CONTROL_TOKEN_FN {
        /**
         * Creates a APPLY_CONTROL_TOKEN_FN pointer that invokes the given AHK function when called.
