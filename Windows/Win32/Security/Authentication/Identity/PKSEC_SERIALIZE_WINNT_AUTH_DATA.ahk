 ...
 */
export default struct PKSEC_SERIALIZE_WINNT_AUTH_DATA {
    value : IntPtr

    __value {
        set {
            if (value is PKSEC_SERIALIZE_WINNT_AUTH_DATA) {
    ...
    /**
     * A PKSEC_SERIALIZE_WINNT_AUTH_DATA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PKSEC_SERIALIZE_WINNT_AUTH_DATA {
        /**
         * Creates a PKSEC_SERIALIZE_WINNT_AUTH_DATA pointer that invokes the given AHK function when called.
