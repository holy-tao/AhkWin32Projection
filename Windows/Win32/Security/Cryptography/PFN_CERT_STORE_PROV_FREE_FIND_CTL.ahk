 ...
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_FREE_FIND_CTL extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pCtlContext, pvStoreProvFindInfo, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pCtlContext, pvStoreProvFindInfoMarshal, pvStoreProvFindInfo, "uint", dwFlags, "int")
        return result
    }
}
