 ...
 * @version v4.0.30319
 */
class SslComputeClientAuthHashFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hMasterKey, hHandshakeHash, pszAlgId, pbOutput, cbOutput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hMasterKey, "ptr", hHandshakeHash, "ptr", pszAlgId, "ptr", pbOutput, "uint", cbOutput, "uint*", &pcbResult := 0, "uint", dwFlags, "int")
        if(result != 0) {
