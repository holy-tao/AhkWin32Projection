 ...
 * @version v4.0.30319
 */
class BCryptImportKeyPairFn extends IUnknown {
     ...
     */
    Invoke(hAlgorithm, hImportKey, pszBlobType, phKey, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hAlgorithm, "ptr", hImportKey, "ptr", pszBlobType, "ptr", phKey, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "int")
        return result
    }
}
