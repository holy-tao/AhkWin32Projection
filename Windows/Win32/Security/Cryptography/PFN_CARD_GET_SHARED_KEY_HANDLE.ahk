 ...
 * @version v4.0.30319
 */
class PFN_CARD_GET_SHARED_KEY_HANDLE extends IUnknown {
     ...
     */
    Invoke(pCardData, pbInput, cbInput, ppbOutput, pcbOutput, phKey) {
        ...
        result := ComCall(3, this, "ptr", pCardData, "ptr", pbInput, "uint", cbInput, ppbOutputMarshal, ppbOutput, pcbOutputMarshal, pcbOutput, phKeyMarshal, phKey, "uint")
        return result
    }
}
