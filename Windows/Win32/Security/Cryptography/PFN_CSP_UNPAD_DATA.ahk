 ...
 * @version v4.0.30319
 */
class PFN_CSP_UNPAD_DATA extends IUnknown {
     ...
     */
    Invoke(pRSADecryptInfo, pcbUnpaddedData, ppbUnpaddedData) {
        pcbUnpaddedDataMarshal := pcbUnpaddedData is VarRef ? "uint*" : "ptr"
        ppbUnpaddedDataMarshal := ppbUnpaddedData is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pRSADecryptInfo, pcbUnpaddedDataMarshal, pcbUnpaddedData, ppbUnpaddedDataMarshal, ppbUnpaddedData, "uint")
        return result
    }
}
