 ...
 */
export default struct NCryptDeleteKeyFn {
    value : IntPtr

    __value {
        set {
            if (value is NCryptDeleteKeyFn) {
    ...
    /**
     * A NCryptDeleteKeyFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends NCryptDeleteKeyFn {
        /**
         * Creates a NCryptDeleteKeyFn pointer that invokes the given AHK function when called.
