 ...
 * @version v4.0.30319
 */
class SslOpenPrivateKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, pCertContext, dwFlags) {
        hSslProvider := hSslProvider is Win32Handle ? NumGet(hSslProvider, "ptr") : hSslProvider

        phPrivateKey := NCRYPT_KEY_HANDLE()
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", phPrivateKey, "ptr", pCertContext, "uint", dwFlags, "int")
        if(result != 0) {
