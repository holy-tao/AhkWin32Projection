...
export default struct ICertSrvSetup extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CAErrorId := CallbackCreate(ObjBindMethod(implObj, "get_CAErrorId"), flags, 2)
        this.vtbl.get_CAErrorString := CallbackCreate(ObjBindMethod(implObj, "get_CAErrorString"), flags, 2)
        this.vtbl.InitializeDefaults := CallbackCreate(ObjBindMethod(implObj, "InitializeDefaults"), flags, 3)
        this.vtbl.GetCASetupProperty := CallbackCreate(ObjBindMethod(implObj, "GetCASetupProperty"), flags, 3)
        this.vtbl.SetCASetupProperty := CallbackCreate(ObjBindMethod(implObj, "SetCASetupProperty"), flags, 3)
        this.vtbl.IsPropertyEditable := CallbackCreate(ObjBindMethod(implObj, "IsPropertyEditable"), flags, 3)
        this.vtbl.GetSupportedCATypes := CallbackCreate(ObjBindMethod(implObj, "GetSupportedCATypes"), flags, 2)
        this.vtbl.GetProviderNameList := CallbackCreate(ObjBindMethod(implObj, "GetProviderNameList"), flags, 2)
        this.vtbl.GetKeyLengthList := CallbackCreate(ObjBindMethod(implObj, "GetKeyLengthList"), flags, 3)
        this.vtbl.GetHashAlgorithmList := CallbackCreate(ObjBindMethod(implObj, "GetHashAlgorithmList"), flags, 3)
        this.vtbl.GetPrivateKeyContainerList := CallbackCreate(ObjBindMethod(implObj, "GetPrivateKeyContainerList"), flags, 3)
        this.vtbl.GetExistingCACertificates := CallbackCreate(ObjBindMethod(implObj, "GetExistingCACertificates"), flags, 2)
        this.vtbl.CAImportPFX := CallbackCreate(ObjBindMethod(implObj, "CAImportPFX"), flags, 5)
        this.vtbl.SetCADistinguishedName := CallbackCreate(ObjBindMethod(implObj, "SetCADistinguishedName"), flags, 5)
        this.vtbl.SetDatabaseInformation := CallbackCreate(ObjBindMethod(implObj, "SetDatabaseInformation"), flags, 5)
        this.vtbl.SetParentCAInformation := CallbackCreate(ObjBindMethod(implObj, "SetParentCAInformation"), flags, 2)
        this.vtbl.SetWebCAInformation := CallbackCreate(ObjBindMethod(implObj, "SetWebCAInformation"), flags, 2)
        this.vtbl.Install := CallbackCreate(ObjBindMethod(implObj, "Install"), flags, 1)
        this.vtbl.PreUnInstall := CallbackCreate(ObjBindMethod(implObj, "PreUnInstall"), flags, 2)
