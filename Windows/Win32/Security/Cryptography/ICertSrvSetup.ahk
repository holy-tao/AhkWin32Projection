 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nn-casetup-icertsrvsetup
...
class ICertSrvSetup extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-get_caerrorid
     */
    get_CAErrorId() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-get_caerrorstring
     */
    get_CAErrorString() {
        pVal := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-initializedefaults
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getcasetupproperty
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-setcasetupproperty
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-ispropertyeditable
     */
    IsPropertyEditable(propertyId) {
        result := ComCall(12, this, "int", propertyId, "short*", &pbEditable := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getsupportedcatypes
     */
    GetSupportedCATypes() {
        pCATypes := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getprovidernamelist
     */
    GetProviderNameList() {
        pVal := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getkeylengthlist
     */
     ...
     * @returns {VARIANT} A pointer to a <b>VARIANT</b> array of <b>VT_BSTR</b> types, where each string represents the name of a hash algorithm supported by the CSP.
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-gethashalgorithmlist
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getprivatekeycontainerlist
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-getexistingcacertificates
     */
    GetExistingCACertificates() {
        result := ComCall(18, this, "ptr*", &ppVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-caimportpfx
     */
    CAImportPFX(bstrFileName, bstrPasswd, bOverwriteExistingKey) {
        ...
        if(bstrPasswd is String) {
            pin := BSTR.Alloc(bstrPasswd)
            bstrPasswd := pin.Value
        }

        result := ComCall(19, this, "ptr", bstrFileName, "ptr", bstrPasswd, "short", bOverwriteExistingKey, "ptr*", &ppVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-setcadistinguishedname
     */
    SetCADistinguishedName(bstrCADN, bIgnoreUnicode, bOverwriteExistingKey, bOverwriteExistingCAInDS) {
        if(bstrCADN is String) {
            pin := BSTR.Alloc(bstrCADN)
            bstrCADN := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-setdatabaseinformation
     */
    SetDatabaseInformation(bstrDBDirectory, bstrLogDirectory, bstrSharedFolder, bForceOverwrite) {
        if(bstrDBDirectory is String) {
            pin := BSTR.Alloc(bstrDBDirectory)
            bstrDBDirectory := pin.Value
        }
        if(bstrLogDirectory is String) {
            pin := BSTR.Alloc(bstrLogDirectory)
            bstrLogDirectory := pin.Value
        }
        if(bstrSharedFolder is String) {
            pin := BSTR.Alloc(bstrSharedFolder)
            bstrSharedFolder := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-setparentcainformation
     */
    SetParentCAInformation(bstrCAConfiguration) {
        if(bstrCAConfiguration is String) {
            pin := BSTR.Alloc(bstrCAConfiguration)
            bstrCAConfiguration := pin.Value
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-setwebcainformation
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-install
     */
    Install() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-preuninstall
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetup-postuninstall
     */
    PostUnInstall() {
