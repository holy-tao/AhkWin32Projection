 ...
 * @version v4.0.30319
 */
class SslExtractHandshakeKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hPrivateKey, hPublicKey, hEarlyKey, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hPrivateKey, "ptr", hPublicKey, "ptr", hEarlyKey, "ptr", phHandshakeKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
