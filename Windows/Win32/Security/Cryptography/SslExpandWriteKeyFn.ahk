 ...
 */
export default struct SslExpandWriteKeyFn {
    value : IntPtr

    __value {
        set {
            if (value is SslExpandWriteKeyFn) {
    ...
    /**
     * A SslExpandWriteKeyFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SslExpandWriteKeyFn {
        /**
         * Creates a SslExpandWriteKeyFn pointer that invokes the given AHK function when called.
