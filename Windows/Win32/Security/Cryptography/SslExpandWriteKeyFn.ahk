 ...
 * @version v4.0.30319
 */
class SslExpandWriteKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hBaseTrafficKey, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hBaseTrafficKey, "ptr", phWriteKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
