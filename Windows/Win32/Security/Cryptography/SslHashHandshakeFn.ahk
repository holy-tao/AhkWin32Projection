 ...
 * @version v4.0.30319
 */
class SslHashHandshakeFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hHandshakeHash, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hHandshakeHash, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "int")
        if(result != 0) {
