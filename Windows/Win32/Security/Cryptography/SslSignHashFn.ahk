 ...
 * @version v4.0.30319
 */
class SslSignHashFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hPrivateKey, pbHashValue, cbHashValue, pbSignature, cbSignature, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hPrivateKey, "ptr", pbHashValue, "uint", cbHashValue, "ptr", pbSignature, "uint", cbSignature, "uint*", &pcbResult := 0, "uint", dwFlags, "int")
        if(result != 0) {
