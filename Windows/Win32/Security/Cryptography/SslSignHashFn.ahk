 ...
 */
export default struct SslSignHashFn {
    value : IntPtr

    __value {
        set {
            if (value is SslSignHashFn) {
    ...
    /**
     * A SslSignHashFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SslSignHashFn {
        /**
         * Creates a SslSignHashFn pointer that invokes the given AHK function when called.
