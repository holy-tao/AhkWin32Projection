 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/ns-wincrypt-cert_dss_parameters
...
class CERT_DSS_PARAMETERS extends Win32Struct
{
    ...
    q{
        get {
            if(!this.HasProp("__q"))
                this.__q := CRYPT_INTEGER_BLOB(16, this)
            return this.__q
        }
    }
    ...
    g{
        get {
            if(!this.HasProp("__g"))
                this.__g := CRYPT_INTEGER_BLOB(32, this)
            return this.__g
        }
    }
}
