 ...
 */
export default struct GetKeyDerivationInterfaceFn {
    value : IntPtr

    __value {
        set {
            if (value is GetKeyDerivationInterfaceFn) {
    ...
    /**
     * A GetKeyDerivationInterfaceFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends GetKeyDerivationInterfaceFn {
        /**
         * Creates a GetKeyDerivationInterfaceFn pointer that invokes the given AHK function when called.
