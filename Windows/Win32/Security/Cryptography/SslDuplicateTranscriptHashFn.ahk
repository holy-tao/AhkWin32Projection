 ...
 * @version v4.0.30319
 */
class SslDuplicateTranscriptHashFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hTranscriptHash, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hTranscriptHash, "ptr", phDuplicateTranscriptHash, "uint", dwFlags, "int")
        if(result != 0) {
