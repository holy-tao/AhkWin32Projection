 ...
 * @see https://learn.microsoft.com/windows/win32/api/wincrypt/nc-wincrypt-pfn_cert_store_prov_write_crl
 * @namespace Windows.Win32.Security.Cryptography
 */
export default struct PFN_CERT_STORE_PROV_WRITE_CRL {
    value : IntPtr

    __value {
        set {
            if (value is PFN_CERT_STORE_PROV_WRITE_CRL) {
     ...
     * @param {Integer} dwFlags CERT_STORE_PROV_WRITE_ADD_FLAG is used to specify when this function is called by the following functions that add a <a href="https://docs.microsoft.com/windows/desktop/SecGloss/c-gly">CRL</a> to the store: 
     * 
     * 
     * 
     * 
    ...
    /**
     * A PFN_CERT_STORE_PROV_WRITE_CRL that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_CERT_STORE_PROV_WRITE_CRL {
        /**
         * Creates a PFN_CERT_STORE_PROV_WRITE_CRL pointer that invokes the given AHK function when called.
