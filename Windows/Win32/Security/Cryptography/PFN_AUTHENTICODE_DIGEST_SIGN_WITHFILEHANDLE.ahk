...
export default struct PFN_AUTHENTICODE_DIGEST_SIGN_WITHFILEHANDLE {
    ...
    Call(pSigningCert, pMetadataBlob, digestAlgId, pbToBeSignedDigest, cbToBeSignedDigest, hFile, pSignedDigest) {
        ...
        result := DllCall(this.value, CERT_CONTEXT.Ptr, pSigningCert, pMetadataBlobMarshal, pMetadataBlob, ALG_ID, digestAlgId, pbToBeSignedDigestMarshal, pbToBeSignedDigest, UInt32, cbToBeSignedDigest, HANDLE, hFile, CRYPT_INTEGER_BLOB.Ptr, pSignedDigest, "HRESULT")
        return result
    }
