 ...
 * @version v4.0.30319
 */
class BCryptSignHashFn extends IUnknown {
     ...
     */
    Invoke(hKey_, pPaddingInfo, pbInput, cbInput, pbOutput, cbOutput, pcbResult, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hKey_, pPaddingInfoMarshal, pPaddingInfo, "ptr", pbInput, "uint", cbInput, "ptr", pbOutput, "uint", cbOutput, pcbResultMarshal, pcbResult, "uint", dwFlags, "int")
        return result
    }
}
