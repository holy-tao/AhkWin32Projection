 ...
 * @version v4.0.30319
 */
class SslImportKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, pszBlobType, pbKeyBlob, cbKeyBlob, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", phKey, "ptr", pszBlobType, "ptr", pbKeyBlob, "uint", cbKeyBlob, "uint", dwFlags, "int")
        if(result != 0) {
