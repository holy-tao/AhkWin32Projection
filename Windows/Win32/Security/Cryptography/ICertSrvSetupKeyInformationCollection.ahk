 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nn-casetup-icertsrvsetupkeyinformationcollection
...
class ICertSrvSetupKeyInformationCollection extends IDispatch{
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformationcollection-get__newenum
     */
    get__NewEnum() {
     ...
     * @param {Integer} Index 
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformationcollection-get_item
     */
    get_Item(Index) {
        pVal := VARIANT()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformationcollection-get_count
     */
    get_Count() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformationcollection-add
     */
