 ...
 * @version v4.0.30319
 */
class NCryptImportKeyFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, hImportKey, pszBlobType, pParameterList, pbData, cbData, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hImportKey, "ptr", pszBlobType, "ptr", pParameterList, "ptr", phKey, "ptr", pbData, "uint", cbData, "uint", dwFlags, "int")
        if(result != 0) {
