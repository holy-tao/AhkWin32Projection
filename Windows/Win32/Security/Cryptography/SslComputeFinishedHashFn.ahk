 ...
 * @version v4.0.30319
 */
class SslComputeFinishedHashFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hMasterKey, hHandshakeHash, pbOutput, cbOutput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hMasterKey, "ptr", hHandshakeHash, "ptr", pbOutput, "uint", cbOutput, "uint", dwFlags, "int")
        if(result != 0) {
