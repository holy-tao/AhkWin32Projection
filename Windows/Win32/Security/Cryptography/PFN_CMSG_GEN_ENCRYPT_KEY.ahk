 ...
 * @version v4.0.30319
 */
class PFN_CMSG_GEN_ENCRYPT_KEY extends IUnknown {
     ...
     * @param {Pointer<PFN_CMSG_ALLOC>} pfnAlloc_ 
     ...
     */
    Invoke(phCryptProv, paiEncrypt, pvEncryptAuxInfo, pPublicKeyInfo, pfnAlloc_, phEncryptKey, ppbEncryptParameters, pcbEncryptParameters) {
        ...
        result := ComCall(3, this, phCryptProvMarshal, phCryptProv, "ptr", paiEncrypt, pvEncryptAuxInfoMarshal, pvEncryptAuxInfo, "ptr", pPublicKeyInfo, "ptr", pfnAlloc_, phEncryptKeyMarshal, phEncryptKey, ppbEncryptParametersMarshal, ppbEncryptParameters, pcbEncryptParametersMarshal, pcbEncryptParameters, "int")
        return result
    }
}
