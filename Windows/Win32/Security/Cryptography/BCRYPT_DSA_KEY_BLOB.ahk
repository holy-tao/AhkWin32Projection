    ...
    Count{
        get {
            if(!this.HasProp("__CountProxyArray"))
                this.__CountProxyArray := Win32FixedArray(this.ptr + 8, 1, Primitive, "char")
    ...
    Seed{
        get {
            if(!this.HasProp("__SeedProxyArray"))
                this.__SeedProxyArray := Win32FixedArray(this.ptr + 12, 1, Primitive, "char")
    ...
    q{
        get {
            if(!this.HasProp("__qProxyArray"))
                this.__qProxyArray := Win32FixedArray(this.ptr + 32, 1, Primitive, "char")
