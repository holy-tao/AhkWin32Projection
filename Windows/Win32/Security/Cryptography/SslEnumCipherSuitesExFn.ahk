 ...
 * @version v4.0.30319
 */
class SslEnumCipherSuitesExFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hPrivateKey, ppEnumState, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hPrivateKey, "ptr*", &ppCipherSuite := 0, ppEnumStateMarshal, ppEnumState, "uint", dwFlags, "int")
        if(result != 0) {
