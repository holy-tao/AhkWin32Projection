 ...
 * @version v4.0.30319
 */
class GetAsymmetricEncryptionInterfaceFn extends IUnknown {
     ...
     */
    Invoke(pszProviderName, pszAlgId, ppFunctionTable, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pszProviderName, "ptr", pszAlgId, ppFunctionTableMarshal, ppFunctionTable, "uint", dwFlags, "int")
        return result
    }
}
