 ...
 * @version v4.0.30319
 */
class NCryptEnumAlgorithmsFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, dwAlgClass, pdwAlgCount, ppAlgList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "uint", dwAlgClass, pdwAlgCountMarshal, pdwAlgCount, ppAlgListMarshal, ppAlgList, "uint", dwFlags, "int")
        if(result != 0) {
