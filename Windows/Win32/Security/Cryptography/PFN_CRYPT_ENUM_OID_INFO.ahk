 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/nc-wincrypt-pfn_crypt_enum_oid_info
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_CRYPT_ENUM_OID_INFO extends IUnknown {
     ...
     * @param {Pointer<CRYPT_OID_INFO>} pInfo 
