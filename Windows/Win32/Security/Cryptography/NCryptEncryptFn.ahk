 ...
 */
export default struct NCryptEncryptFn {
    value : IntPtr

    __value {
        set {
            if (value is NCryptEncryptFn) {
    ...
    /**
     * A NCryptEncryptFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends NCryptEncryptFn {
        /**
         * Creates a NCryptEncryptFn pointer that invokes the given AHK function when called.
