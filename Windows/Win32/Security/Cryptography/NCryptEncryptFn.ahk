 ...
 * @version v4.0.30319
 */
class NCryptEncryptFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, hKey_, pbInput, cbInput, pPaddingInfo, pbOutput, cbOutput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hKey_, "ptr", pbInput, "uint", cbInput, pPaddingInfoMarshal, pPaddingInfo, "ptr", pbOutput, "uint", cbOutput, "uint*", &pcbResult := 0, "uint", dwFlags, "int")
        if(result != 0) {
