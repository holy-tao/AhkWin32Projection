 ...
 * @version v4.0.30319
 */
class PFN_CSP_CACHE_LOOKUP_FILE extends IUnknown {
     ...
     */
    Invoke(pvCacheContext, wszTag, dwFlags, ppbData, pcbData) {
        ...
        result := ComCall(3, this, pvCacheContextMarshal, pvCacheContext, "ptr", wszTag, "uint", dwFlags, ppbDataMarshal, ppbData, pcbDataMarshal, pcbData, "uint")
        return result
    }
}
