 ...
 * @version v4.0.30319
 */
class NCryptSetKeyPropertyFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, hKey_, pszProperty, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hKey_, "ptr", pszProperty, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "int")
        if(result != 0) {
