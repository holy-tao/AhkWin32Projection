 ...
 * @version v4.0.30319
 */
class NCryptCreatePersistedKeyFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, pszAlgId, pszKeyName, dwLegacyKeySpec, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", phKey, "ptr", pszAlgId, "ptr", pszKeyName, "uint", dwLegacyKeySpec, "uint", dwFlags, "int")
        if(result != 0) {
