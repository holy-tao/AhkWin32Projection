 ...
 */
export default struct GetCipherInterfaceFn {
    value : IntPtr

    __value {
        set {
            if (value is GetCipherInterfaceFn) {
    ...
    /**
     * A GetCipherInterfaceFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends GetCipherInterfaceFn {
        /**
         * Creates a GetCipherInterfaceFn pointer that invokes the given AHK function when called.
