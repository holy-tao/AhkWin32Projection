 ...
 * @version v4.0.30319
 */
class SslExpandResumptionMasterKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hMasterKey, hHashValue, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hMasterKey, "ptr", hHashValue, "ptr", phResumptionMasterKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
