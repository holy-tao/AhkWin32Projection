 ...
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_FIND_CERT extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pFindInfo, pPrevCertContext, dwFlags, ppvStoreProvFindInfo, ppProvCertContext) {
        ...
        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pFindInfo, "ptr", pPrevCertContext, "uint", dwFlags, ppvStoreProvFindInfoMarshal, ppvStoreProvFindInfo, ppProvCertContextMarshal, ppProvCertContext, "int")
        return result
    }
}
