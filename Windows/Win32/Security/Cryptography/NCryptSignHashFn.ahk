 ...
 */
export default struct NCryptSignHashFn {
    value : IntPtr

    __value {
        set {
            if (value is NCryptSignHashFn) {
    ...
    /**
     * A NCryptSignHashFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends NCryptSignHashFn {
        /**
         * Creates a NCryptSignHashFn pointer that invokes the given AHK function when called.
