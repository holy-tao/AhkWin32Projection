 ...
 */
export default struct NCryptGetKeyPropertyFn {
    value : IntPtr

    __value {
        set {
            if (value is NCryptGetKeyPropertyFn) {
    ...
    /**
     * A NCryptGetKeyPropertyFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends NCryptGetKeyPropertyFn {
        /**
         * Creates a NCryptGetKeyPropertyFn pointer that invokes the given AHK function when called.
