 ...
 * @version v4.0.30319
 */
class NCryptGetKeyPropertyFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, hKey_, pszProperty, pbOutput, cbOutput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hKey_, "ptr", pszProperty, "ptr", pbOutput, "uint", cbOutput, "uint*", &pcbResult := 0, "uint", dwFlags, "int")
        if(result != 0) {
