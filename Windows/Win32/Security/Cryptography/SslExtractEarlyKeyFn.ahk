 ...
 * @version v4.0.30319
 */
class SslExtractEarlyKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hPreSharedKey, dwProtocol, dwCipherSuite, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hPreSharedKey, "ptr", phEarlyKey, "uint", dwProtocol, "uint", dwCipherSuite, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
