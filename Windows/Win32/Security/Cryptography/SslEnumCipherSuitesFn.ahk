 ...
 */
export default struct SslEnumCipherSuitesFn {
    value : IntPtr

    __value {
        set {
            if (value is SslEnumCipherSuitesFn) {
    ...
    /**
     * A SslEnumCipherSuitesFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SslEnumCipherSuitesFn {
        /**
         * Creates a SslEnumCipherSuitesFn pointer that invokes the given AHK function when called.
