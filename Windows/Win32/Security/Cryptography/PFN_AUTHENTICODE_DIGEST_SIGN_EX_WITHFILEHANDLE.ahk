 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/SecCrypto/pfn-authenticode-digest-sign-ex-withfilehandle
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_AUTHENTICODE_DIGEST_SIGN_EX_WITHFILEHANDLE extends IUnknown {
     ...
     */
    Invoke(pMetadataBlob, digestAlgId, pbToBeSignedDigest, cbToBeSignedDigest, hFile, pSignedDigest, ppSignerCert, hCertChainStore) {
        ...
        result := ComCall(3, this, "ptr", pMetadataBlob, "uint", digestAlgId, pbToBeSignedDigestMarshal, pbToBeSignedDigest, "uint", cbToBeSignedDigest, "ptr", hFile, "ptr", pSignedDigest, ppSignerCertMarshal, ppSignerCert, "ptr", hCertChainStore, "int")
        if(result != 0) {
