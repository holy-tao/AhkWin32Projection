 ...
 * @version v4.0.30319
 */
class SslComputeSessionHashFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hHandshakeHash, dwProtocol, pbOutput, cbOutput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hHandshakeHash, "uint", dwProtocol, "ptr", pbOutput, "uint", cbOutput, "uint*", &pcbResult := 0, "uint", dwFlags, "int")
        if(result != 0) {
