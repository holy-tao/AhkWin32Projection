 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/nc-wincrypt-pfn_cmsg_cng_import_key_trans
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_CMSG_CNG_IMPORT_KEY_TRANS extends IUnknown {
     ...
     */
    Invoke(pCNGContentDecryptInfo, pKeyTransDecryptPara, dwFlags) {
        static pvReserved := 0 ;Reserved parameters must always be NULL

        result := ComCall(3, this, "ptr", pCNGContentDecryptInfo, "ptr", pKeyTransDecryptPara, "uint", dwFlags, "ptr", pvReserved, "int")
        return result
    }
}
