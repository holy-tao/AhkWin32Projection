 ...
 */
export default struct SslDecryptPacketFn {
    value : IntPtr

    __value {
        set {
            if (value is SslDecryptPacketFn) {
    ...
    /**
     * A SslDecryptPacketFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SslDecryptPacketFn {
        /**
         * Creates a SslDecryptPacketFn pointer that invokes the given AHK function when called.
         * @param {Func(NCRYPT_PROV_HANDLE, NCRYPT_KEY_HANDLE, IntPtr, UInt32, IntPtr, UInt32, Int64, UInt32) => "int"} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 8)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 8 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [NCRYPT_PROV_HANDLE, NCRYPT_KEY_HANDLE, IntPtr, UInt32, IntPtr, UInt32, Int64, UInt32, "int"])
        }
