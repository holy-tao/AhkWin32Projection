 ...
 * @version v4.0.30319
 */
class PFN_CARD_ENUM_FILES extends IUnknown {
     ...
     */
    Invoke(pCardData, pszDirectoryName, pmszFileNames, pdwcbFileName, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pCardData, "ptr", pszDirectoryName, pmszFileNamesMarshal, pmszFileNames, pdwcbFileNameMarshal, pdwcbFileName, "uint", dwFlags, "uint")
        return result
    }
}
