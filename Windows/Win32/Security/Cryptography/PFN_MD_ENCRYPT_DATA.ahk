 ...
 * @version v4.0.30319
 */
class PFN_MD_ENCRYPT_DATA extends IUnknown {
     ...
     */
    Invoke(pCardData, hKey_, pwszSecureFunction, pbInput, cbInput, dwFlags, ppEncryptedData, pcEncryptedData) {
        ...
        result := ComCall(3, this, "ptr", pCardData, "ptr", hKey_, "ptr", pwszSecureFunction, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, ppEncryptedDataMarshal, ppEncryptedData, pcEncryptedDataMarshal, pcEncryptedData, "uint")
        return result
    }
}
