 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nn-casetup-icertificateenrollmentpolicyserversetup
...
class ICertificateEnrollmentPolicyServerSetup extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-get_errorstring
     */
    get_ErrorString() {
        pVal := BSTR()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-initializeinstalldefaults
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-getproperty
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-setproperty
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-install
     */
    Install() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertificateenrollmentpolicyserversetup-uninstall
     */
