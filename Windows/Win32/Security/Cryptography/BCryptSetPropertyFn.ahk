 ...
 * @version v4.0.30319
 */
class BCryptSetPropertyFn extends IUnknown {
     ...
     */
    Invoke(hObject, pszProperty, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hObject, "ptr", pszProperty, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "int")
        return result
    }
}
