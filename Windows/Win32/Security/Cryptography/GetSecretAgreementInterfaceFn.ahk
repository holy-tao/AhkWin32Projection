 ...
 */
export default struct GetSecretAgreementInterfaceFn {
    value : IntPtr

    __value {
        set {
            if (value is GetSecretAgreementInterfaceFn) {
    ...
    /**
     * A GetSecretAgreementInterfaceFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends GetSecretAgreementInterfaceFn {
        /**
         * Creates a GetSecretAgreementInterfaceFn pointer that invokes the given AHK function when called.
