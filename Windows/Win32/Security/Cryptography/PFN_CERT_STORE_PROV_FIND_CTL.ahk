 ...
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_FIND_CTL extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pFindInfo, pPrevCtlContext, dwFlags, ppvStoreProvFindInfo, ppProvCtlContext) {
        ...
        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pFindInfo, "ptr", pPrevCtlContext, "uint", dwFlags, ppvStoreProvFindInfoMarshal, ppvStoreProvFindInfo, ppProvCtlContextMarshal, ppProvCtlContext, "int")
        return result
    }
}
