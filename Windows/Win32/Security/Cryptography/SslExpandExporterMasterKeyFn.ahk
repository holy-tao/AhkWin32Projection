 ...
 */
export default struct SslExpandExporterMasterKeyFn {
    value : IntPtr

    __value {
        set {
            if (value is SslExpandExporterMasterKeyFn) {
    ...
    /**
     * A SslExpandExporterMasterKeyFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends SslExpandExporterMasterKeyFn {
        /**
         * Creates a SslExpandExporterMasterKeyFn pointer that invokes the given AHK function when called.
