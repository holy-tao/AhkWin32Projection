 ...
 * @version v4.0.30319
 */
class SslExpandExporterMasterKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hBaseKey, hHashValue, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hBaseKey, "ptr", hHashValue, "ptr", phExporterMasterKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
