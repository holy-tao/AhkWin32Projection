 ...
 * @version v4.0.30319
 */
class PFN_CARD_IMPORT_SESSION_KEY extends IUnknown {
     ...
     */
    Invoke(pCardData, bContainerIndex, pPaddingInfo, pwszBlobType, pwszAlgId, phKey, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pCardData, "char", bContainerIndex, pPaddingInfoMarshal, pPaddingInfo, "ptr", pwszBlobType, "ptr", pwszAlgId, phKeyMarshal, phKey, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "uint")
        return result
    }
}
