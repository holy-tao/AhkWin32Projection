 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/nc-wincrypt-pfn_cert_store_prov_write_ctl
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_WRITE_CTL extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pCtlContext, dwFlags) {
        hStoreProv := hStoreProv is Win32Handle ? NumGet(hStoreProv, "ptr") : hStoreProv

        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pCtlContext, "uint", dwFlags, "int")
        return result
    }
}
