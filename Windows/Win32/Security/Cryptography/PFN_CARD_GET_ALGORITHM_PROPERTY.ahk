 ...
 * @version v4.0.30319
 */
class PFN_CARD_GET_ALGORITHM_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pCardData, pwszAlgId, pwszProperty, pbData, cbData, pdwDataLen, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pCardData, "ptr", pwszAlgId, "ptr", pwszProperty, "ptr", pbData, "uint", cbData, pdwDataLenMarshal, pdwDataLen, "uint", dwFlags, "uint")
        return result
    }
}
