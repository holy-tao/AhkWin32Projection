 ...
 * @version v4.0.30319
 */
class NCryptVerifySignatureFn extends IUnknown {
    ...
    Invoke(hProvider_, hKey_, pPaddingInfo, pbHashValue, cbHashValue, pbSignature, cbSignature, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hKey_, pPaddingInfoMarshal, pPaddingInfo, "ptr", pbHashValue, "uint", cbHashValue, "ptr", pbSignature, "uint", cbSignature, "uint", dwFlags, "int")
        if(result != 0) {
