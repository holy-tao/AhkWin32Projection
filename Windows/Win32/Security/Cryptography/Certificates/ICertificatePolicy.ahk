 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icertificatepolicy
...
class ICertificatePolicy extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertificatepolicy-initialize
     */
    Initialize(pValue) {
     ...
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertificatepolicy-get_objectid
     */
    get_ObjectId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertificatepolicy-get_policyqualifiers
     */
