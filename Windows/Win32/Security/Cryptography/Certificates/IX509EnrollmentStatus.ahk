 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509enrollmentstatus
...
class IX509EnrollmentStatus extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-appendtext
     */
    AppendText(strText) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_text
     */
    get_Text() {
        pValue := BSTR()
     ...
     * @param {BSTR} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-put_text
     */
    put_Text(Value) {
        if(Value is String) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_selected
     */
    get_Selected() {
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-put_selected
     */
    put_Selected(Value) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_display
     */
    get_Display() {
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-put_display
     */
    put_Display(Value) {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_status
     */
    get_Status() {
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-put_status
     */
    put_Status(Value) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_error
     */
    get_Error() {
     ...
     * @param {HRESULT} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-put_error
     */
    put_Error(Value) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentstatus-get_errortext
     */
    get_ErrorText() {
        pValue := BSTR()
