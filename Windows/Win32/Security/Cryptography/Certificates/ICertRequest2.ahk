 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nn-certcli-icertrequest2
...
class ICertRequest2 extends ICertRequest{
    ...
    GetIssuedCertificate(strConfig, RequestId, strSerialNumber) {
        ...
        result := ComCall(14, this, "ptr", strConfig, "int", RequestId, "ptr", strSerialNumber, "uint*", &pDisposition := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest2-geterrormessagetext
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest2-getcaproperty
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest2-getcapropertyflags
     */
    GetCAPropertyFlags(strConfig, PropId) {
        ...
        result := ComCall(17, this, "ptr", strConfig, "int", PropId, "int*", &pPropFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest2-getcapropertydisplayname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest2-getfullresponseproperty
     */
