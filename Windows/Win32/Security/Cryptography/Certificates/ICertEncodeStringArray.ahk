 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nn-certenc-icertencodestringarray
...
class ICertEncodeStringArray extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-getstringtype
     */
    GetStringType() {
        result := ComCall(8, this, "int*", &pStringType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-getcount
     */
    GetCount() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-getvalue
     */
    GetValue(Index) {
        pstr_ := BSTR()
        result := ComCall(10, this, "int", Index, "ptr", pstr_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-reset
     */
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-setvalue
     */
    SetValue(Index, str) {
        if(str is String) {
            pin := BSTR.Alloc(str)
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodestringarray-encode
     */
    Encode() {
        pstrBinary := BSTR()
