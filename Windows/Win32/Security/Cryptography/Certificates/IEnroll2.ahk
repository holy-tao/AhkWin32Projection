 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nn-xenroll-ienroll2
...
class IEnroll2 extends IEnroll{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-installpkcs7blob
     */
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-getsupportedkeyspec
     */
    GetSupportedKeySpec(pdwKeySpec) {
        pdwKeySpecMarshal := pdwKeySpec is VarRef ? "int*" : "ptr"

        result := ComCall(75, this, pdwKeySpecMarshal, pdwKeySpec, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-getkeylen
     */
    GetKeyLen(fMin, fExchange, pdwKeySize) {
        pdwKeySizeMarshal := pdwKeySize is VarRef ? "int*" : "ptr"

        result := ComCall(76, this, "int", fMin, "int", fExchange, pdwKeySizeMarshal, pdwKeySize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-enumalgs
     */
    EnumAlgs(dwIndex, algClass, pdwAlgID) {
        pdwAlgIDMarshal := pdwAlgID is VarRef ? "int*" : "ptr"

        result := ComCall(77, this, "int", dwIndex, "int", algClass, pdwAlgIDMarshal, pdwAlgID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-getalgnamewstr
     */
    GetAlgNameWStr(algID, ppwsz) {
        ppwszMarshal := ppwsz is VarRef ? "ptr*" : "ptr"

        result := ComCall(78, this, "int", algID, ppwszMarshal, ppwsz, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-put_reusehardwarekeyifunabletogennew
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-get_reusehardwarekeyifunabletogennew
     */
    get_ReuseHardwareKeyIfUnableToGenNew(fReuseHardwareKeyIfUnableToGenNew) {
        ...
        result := ComCall(80, this, fReuseHardwareKeyIfUnableToGenNewMarshal, fReuseHardwareKeyIfUnableToGenNew, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-put_hashalgid
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-get_hashalgid
     */
    get_HashAlgID(hashAlgID) {
        hashAlgIDMarshal := hashAlgID is VarRef ? "int*" : "ptr"

        result := ComCall(82, this, hashAlgIDMarshal, hashAlgID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-sethstoremy
     */
    SetHStoreMy(hStore) {
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-sethstoreca
     */
    SetHStoreCA(hStore) {
        hStore := hStore is Win32Handle ? NumGet(hStore, "ptr") : hStore
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-sethstoreroot
     */
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-sethstorerequest
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-put_limitexchangekeytoencipherment
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-get_limitexchangekeytoencipherment
     */
    get_LimitExchangeKeyToEncipherment(fLimitExchangeKeyToEncipherment) {
        ...
        result := ComCall(88, this, fLimitExchangeKeyToEnciphermentMarshal, fLimitExchangeKeyToEncipherment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-put_enablesmimecapabilities
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll2-get_enablesmimecapabilities
     */
    get_EnableSMIMECapabilities(fEnableSMIMECapabilities) {
        ...
        result := ComCall(90, this, fEnableSMIMECapabilitiesMarshal, fEnableSMIMECapabilities, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
