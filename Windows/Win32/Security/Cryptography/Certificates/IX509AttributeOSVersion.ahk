 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509attributeosversion
...
class IX509AttributeOSVersion extends IX509Attribute{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributeosversion-initializeencode
     */
    InitializeEncode(strOSVersion) {
        if(strOSVersion is String) {
            pin := BSTR.Alloc(strOSVersion)
            strOSVersion := pin.Value
        }

        result := ComCall(10, this, "ptr", strOSVersion, "int")
        if(result != 0) {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributeosversion-initializedecode
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributeosversion-get_osversion
     */
    get_OSVersion() {
        pValue := BSTR()
