 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509publickey
...
class IX509PublicKey extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-initialize
     */
    Initialize(pObjectId, strEncodedKey, strEncodedParameters, Encoding) {
        ...
        if(strEncodedParameters is String) {
            pin := BSTR.Alloc(strEncodedParameters)
            strEncodedParameters := pin.Value
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-initializefromencodedpublickeyinfo
     */
    InitializeFromEncodedPublicKeyInfo(strEncodedPublicKeyInfo, Encoding) {
        if(strEncodedPublicKeyInfo is String) {
            pin := BSTR.Alloc(strEncodedPublicKeyInfo)
            strEncodedPublicKeyInfo := pin.Value
        }
     ...
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-get_algorithm
     */
    get_Algorithm() {
     ...
     * Call the <a href="https://docs.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-ix509publickey-initializefromencodedpublickeyinfo">InitializeFromEncodedPublicKeyInfo</a> method or the <a href="https://docs.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-ix509publickey-initialize">Initialize</a> method to initialize the public key object before calling this property.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-get_length
     */
    get_Length() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-get_encodedkey
     */
     ...
     * @param {Integer} Encoding 
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-get_encodedparameters
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509publickey-computekeyidentifier
     */
