 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certview/nn-certview-ienumcertviewattribute
...
class IEnumCERTVIEWATTRIBUTE extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-next
     */
    Next(pIndex) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-getname
     */
    GetName(pstrOut) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-getvalue
     */
    GetValue(pstrOut) {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-skip
     */
    Skip(celt) {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewattribute-clone
     */
    Clone() {
