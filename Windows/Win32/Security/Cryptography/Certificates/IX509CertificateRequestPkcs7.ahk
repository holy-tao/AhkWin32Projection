 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509certificaterequestpkcs7
...
class IX509CertificateRequestPkcs7 extends IX509CertificateRequest{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-initializefromtemplatename
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-initializefromcertificate
     */
    InitializeFromCertificate(Context_, RenewalRequest, strCertificate, Encoding, InheritOptions) {
        if(strCertificate is String) {
            pin := BSTR.Alloc(strCertificate)
            strCertificate := pin.Value
        }

        result := ComCall(33, this, "int", Context_, "short", RenewalRequest, "ptr", strCertificate, "int", Encoding, "int", InheritOptions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-initializefrominnerrequest
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-initializedecode
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-get_requestername
     */
    get_RequesterName() {
        pValue := BSTR()
     ...
     * @param {BSTR} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-put_requestername
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-get_signercertificate
     */
    get_SignerCertificate() {
        result := ComCall(38, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs7-put_signercertificate
     */
