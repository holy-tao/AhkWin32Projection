 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nn-certcli-icertconfig
...
class ICertConfig extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertconfig-reset
     */
    Reset(Index) {
        result := ComCall(7, this, "int", Index, "int*", &pCount := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertconfig-next
     */
    Next() {
        result := ComCall(8, this, "int*", &pIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertconfig-getfield
     */
    GetField(strFieldName) {
        if(strFieldName is String) {
            pin := BSTR.Alloc(strFieldName)
            strFieldName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertconfig-getconfig
     */
    GetConfig(Flags) {
        pstrOut := BSTR()
