 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icspinformation
...
class ICspInformation extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-initializefromname
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-initializefromtype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_cspalgorithms
     */
    get_CspAlgorithms() {
        result := ComCall(9, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_hashardwarerandomnumbergenerator
     */
    get_HasHardwareRandomNumberGenerator() {
        result := ComCall(10, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_ishardwaredevice
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_isremovable
     */
    get_IsRemovable() {
        result := ComCall(12, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_issoftwaredevice
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_valid
     */
    get_Valid() {
        result := ComCall(14, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </table>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_maxkeycontainernamelength
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_name
     */
    get_Name() {
        pValue := BSTR()
     ...
     * </table>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_type
     */
    get_Type() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_version
     */
    get_Version() {
     ...
     * </table>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_keyspec
     */
    get_KeySpec() {
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_issmartcard
     */
    get_IsSmartCard() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-getdefaultsecuritydescriptor
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-get_legacycsp
     */
    get_LegacyCsp() {
        result := ComCall(22, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspinformation-getcspstatusfromoperations
     */
    GetCspStatusFromOperations(pAlgorithm, Operations) {
        result := ComCall(23, this, "ptr", pAlgorithm, "int", Operations, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
