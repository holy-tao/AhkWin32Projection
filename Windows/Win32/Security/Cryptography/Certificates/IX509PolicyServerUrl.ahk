...
export default struct IX509PolicyServerUrl extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AuthFlags := CallbackCreate(ObjBindMethod(implObj, "get_AuthFlags"), flags, 2)
        this.vtbl.put_AuthFlags := CallbackCreate(ObjBindMethod(implObj, "put_AuthFlags"), flags, 2)
        ...
        this.vtbl.SetStringProperty := CallbackCreate(ObjBindMethod(implObj, "SetStringProperty"), flags, 3)
        this.vtbl.UpdateRegistry := CallbackCreate(ObjBindMethod(implObj, "UpdateRegistry"), flags, 2)
        this.vtbl.RemoveFromRegistry := CallbackCreate(ObjBindMethod(implObj, "RemoveFromRegistry"), flags, 2)
    }
