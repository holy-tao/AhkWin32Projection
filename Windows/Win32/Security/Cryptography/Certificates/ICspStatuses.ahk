 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icspstatuses
...
class ICspStatuses extends IDispatch{
     ...
     * @param {Integer} Index 
     * @returns {ICspStatus} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_itembyindex
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_count
     */
    get_Count() {
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-add
     */
    Add(pVal) {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-remove
     */
    Remove(Index) {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-clear
     */
    Clear() {
     ...
     * @returns {ICspStatus} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_itembyname
     */
    get_ItemByName(strCspName, strAlgorithmName) {
        if(strCspName is String) {
            pin := BSTR.Alloc(strCspName)
            strCspName := pin.Value
        }
        ...
        result := ComCall(13, this, "ptr", strCspName, "ptr", strAlgorithmName, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {ICspStatus} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_itembyordinal
     */
    get_ItemByOrdinal(Ordinal) {
        result := ComCall(14, this, "int", Ordinal, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {ICspStatus} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_itembyoperations
     */
    get_ItemByOperations(strCspName, strAlgorithmName, Operations) {
        ...
        result := ComCall(15, this, "ptr", strCspName, "ptr", strAlgorithmName, "int", Operations, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {ICspStatus} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatuses-get_itembyprovider
     */
    get_ItemByProvider(pCspStatus) {
        result := ComCall(16, this, "ptr", pCspStatus, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
