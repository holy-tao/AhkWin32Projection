 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nn-certcli-icertrequest
...
class ICertRequest extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-submit
     */
    Submit(Flags, strRequest, strAttributes, strConfig) {
        if(strRequest is String) {
            pin := BSTR.Alloc(strRequest)
            strRequest := pin.Value
        }
        ...
        result := ComCall(7, this, "int", Flags, "ptr", strRequest, "ptr", strAttributes, "ptr", strConfig, "int*", &pDisposition := 0, "int")
        if(result != 0) {
     ...
     * <b>Windows Server 2008, Windows Vista, Windows Server 2003 and Windows XP:  </b>An HTTPS URL is not supported as an input.
     * @returns {Integer} A pointer to the request's disposition value.
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-retrievepending
     */
    RetrievePending(RequestId, strConfig) {
        ...
        result := ComCall(8, this, "int", RequestId, "ptr", strConfig, "int*", &pDisposition := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-getlaststatus
     */
    GetLastStatus() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-getrequestid
     */
    GetRequestId() {
        result := ComCall(10, this, "int*", &pRequestId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-getdispositionmessage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-getcacertificate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certcli/nf-certcli-icertrequest-getcertificate
     */
