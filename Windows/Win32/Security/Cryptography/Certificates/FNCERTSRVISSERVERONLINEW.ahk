 ...
 * @version v4.0.30319
 */
class FNCERTSRVISSERVERONLINEW extends IUnknown {
     ...
     */
    Invoke(pwszServerName, pfServerOnline) {
        ...
        result := ComCall(3, this, "ptr", pwszServerName, pfServerOnlineMarshal, pfServerOnline, "int")
        if(result != 0) {
