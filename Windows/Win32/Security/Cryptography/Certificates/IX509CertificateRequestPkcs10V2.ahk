 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509certificaterequestpkcs10v2
...
class IX509CertificateRequestPkcs10V2 extends IX509CertificateRequestPkcs10{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs10v2-initializefromtemplate
     */
    InitializeFromTemplate(context_, pPolicyServer, pTemplate) {
        result := ComCall(60, this, "int", context_, "ptr", pPolicyServer, "ptr", pTemplate, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs10v2-initializefromprivatekeytemplate
     */
    InitializeFromPrivateKeyTemplate(Context_, pPrivateKey, pPolicyServer, pTemplate) {
        result := ComCall(61, this, "int", Context_, "ptr", pPrivateKey, "ptr", pPolicyServer, "ptr", pTemplate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <li>Adds the extensions specified in the template, if any, to the <a href="https://docs.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-ix509extensions">IX509Extensions</a> collection.</li>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs10v2-initializefrompublickeytemplate
     */
    InitializeFromPublicKeyTemplate(Context_, pPublicKey, pPolicyServer, pTemplate) {
        result := ComCall(62, this, "int", Context_, "ptr", pPublicKey, "ptr", pPolicyServer, "ptr", pTemplate, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs10v2-get_policyserver
     */
    get_PolicyServer() {
        result := ComCall(63, this, "ptr*", &ppPolicyServer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestpkcs10v2-get_template
     */
    get_Template() {
        result := ComCall(64, this, "ptr*", &ppTemplate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
