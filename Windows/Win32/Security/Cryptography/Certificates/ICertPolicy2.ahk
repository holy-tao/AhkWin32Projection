 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nn-certpol-icertpolicy2
...
class ICertPolicy2 extends ICertPolicy{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-icertpolicy2-getmanagemodule
     */
    GetManageModule() {
        result := ComCall(11, this, "ptr*", &ppManageModule := 0, "int")
        if(result != 0) {
