...
export default struct ISmimeCapabilities extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.AddFromCsp := CallbackCreate(ObjBindMethod(implObj, "AddFromCsp"), flags, 2)
        this.vtbl.AddAvailableSmimeCapabilities := CallbackCreate(ObjBindMethod(implObj, "AddAvailableSmimeCapabilities"), flags, 2)
    }
