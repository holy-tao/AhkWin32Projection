 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icspstatus
...
class ICspStatus extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-initialize
     */
    Initialize(pCsp, pAlgorithm) {
        result := ComCall(7, this, "ptr", pCsp, "ptr", pAlgorithm, "int")
        if(result != 0) {
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-get_ordinal
     */
    get_Ordinal() {
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-put_ordinal
     */
    put_Ordinal(Value) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-get_cspalgorithm
     */
    get_CspAlgorithm() {
        result := ComCall(10, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-get_cspinformation
     */
    get_CspInformation() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-get_enrollmentstatus
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspstatus-get_displayname
     */
    get_DisplayName() {
        pValue := BSTR()
