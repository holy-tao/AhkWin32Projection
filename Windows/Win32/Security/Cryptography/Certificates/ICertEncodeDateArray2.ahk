...
#Import ".\ICertEncodeDateArray.ahk" { ICertEncodeDateArray }

/**
 * @namespace Windows.Win32.Security.Cryptography.Certificates
 */
export default struct ICertEncodeDateArray2 extends ICertEncodeDateArray {
    /**
     ...
     * used for ICertEncodeDateArray2 interfaces
    */
    struct Vtbl extends ICertEncodeDateArray.Vtbl {
        DecodeBlob : IntPtr
        EncodeBlob : IntPtr
    }
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ICertEncodeDateArray2.Vtbl()
        }
    ...
    Query(iid) {
        if (ICertEncodeDateArray2.IID.Equals(iid)) {
            return true
        }
