 ...
 */
export default struct ICertRequest3 extends ICertRequest2 {
    /**
     ...
     * used for ICertRequest3 interfaces
    */
    struct Vtbl extends ICertRequest2.Vtbl {
        SetCredential         : IntPtr
        GetRequestIdString    : IntPtr
        GetIssuedCertificate2 : IntPtr
        GetRefreshPolicy      : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ICertRequest3.Vtbl()
        }
    ...
    GetRequestIdString() {
        ...
        result := ComCall(21, this, BSTR.Ptr, pstrRequestId, "HRESULT")
    ...
    GetIssuedCertificate2(strConfig, strRequestId, strSerialNumber) {
        ...
        result := ComCall(22, this, BSTR, strConfig, BSTR, strRequestId, BSTR, strSerialNumber, "uint*", &pDisposition := 0, "HRESULT")
        return pDisposition
    }
     ...
     */
    GetRefreshPolicy() {
        result := ComCall(23, this, VARIANT_BOOL.Ptr, &pValue := 0, "HRESULT")
        return pValue
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetIssuedCertificate2)
        CallbackFree(this.vtbl.GetRefreshPolicy)
    }
}
