...
class ICertRequest3 extends ICertRequest2{
    ...
    SetCredential(hWnd, AuthType, strCredential, strPassword) {
        ...
        result := ComCall(20, this, "int", hWnd, "int", AuthType, "ptr", strCredential, "ptr", strPassword, "int")
        if(result != 0)
    ...
    GetIssuedCertificate2(strConfig, strRequestId, strSerialNumber, pDisposition) {
        ...
        result := ComCall(22, this, "ptr", strConfig, "ptr", strRequestId, "ptr", strSerialNumber, "uint*", pDisposition, "int")
        if(result != 0)
            throw OSError(result)
