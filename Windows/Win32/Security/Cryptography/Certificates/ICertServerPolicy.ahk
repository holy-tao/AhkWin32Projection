...
export default struct ICertServerPolicy extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetRequestProperty := CallbackCreate(ObjBindMethod(implObj, "GetRequestProperty"), flags, 4)
        this.vtbl.GetRequestAttribute := CallbackCreate(ObjBindMethod(implObj, "GetRequestAttribute"), flags, 3)
        this.vtbl.GetCertificateProperty := CallbackCreate(ObjBindMethod(implObj, "GetCertificateProperty"), flags, 4)
        this.vtbl.SetCertificateProperty := CallbackCreate(ObjBindMethod(implObj, "SetCertificateProperty"), flags, 4)
        this.vtbl.GetCertificateExtension := CallbackCreate(ObjBindMethod(implObj, "GetCertificateExtension"), flags, 4)
        this.vtbl.GetCertificateExtensionFlags := CallbackCreate(ObjBindMethod(implObj, "GetCertificateExtensionFlags"), flags, 2)
        this.vtbl.SetCertificateExtension := CallbackCreate(ObjBindMethod(implObj, "SetCertificateExtension"), flags, 5)
        this.vtbl.EnumerateExtensionsSetup := CallbackCreate(ObjBindMethod(implObj, "EnumerateExtensionsSetup"), flags, 2)
        this.vtbl.EnumerateExtensions := CallbackCreate(ObjBindMethod(implObj, "EnumerateExtensions"), flags, 2)
        this.vtbl.EnumerateExtensionsClose := CallbackCreate(ObjBindMethod(implObj, "EnumerateExtensionsClose"), flags, 1)
        this.vtbl.EnumerateAttributesSetup := CallbackCreate(ObjBindMethod(implObj, "EnumerateAttributesSetup"), flags, 2)
        this.vtbl.EnumerateAttributes := CallbackCreate(ObjBindMethod(implObj, "EnumerateAttributes"), flags, 2)
        this.vtbl.EnumerateAttributesClose := CallbackCreate(ObjBindMethod(implObj, "EnumerateAttributesClose"), flags, 1)
    }
