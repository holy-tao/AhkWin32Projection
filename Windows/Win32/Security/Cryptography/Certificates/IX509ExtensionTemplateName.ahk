 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509extensiontemplatename
...
class IX509ExtensionTemplateName extends IX509Extension{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extensiontemplatename-initializeencode
     */
    InitializeEncode(strTemplateName) {
        ...
        result := ComCall(12, this, "ptr", strTemplateName, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extensiontemplatename-initializedecode
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extensiontemplatename-get_templatename
     */
    get_TemplateName() {
        pValue := BSTR()
