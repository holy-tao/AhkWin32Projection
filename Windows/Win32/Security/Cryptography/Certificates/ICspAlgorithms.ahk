 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icspalgorithms
...
class ICspAlgorithms extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-get_itembyindex
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-get_count
     */
    get_Count() {
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-add
     */
    Add(pVal) {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-remove
     */
    Remove(Index) {
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-clear
     */
    Clear() {
     ...
     * @param {BSTR} strName 
     * @returns {ICspAlgorithm} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-get_itembyname
     */
    get_ItemByName(strName) {
        ...
        result := ComCall(13, this, "ptr", strName, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icspalgorithms-get_indexbyobjectid
     */
    get_IndexByObjectId(pObjectId) {
        result := ComCall(14, this, "ptr", pObjectId, "int*", &pIndex := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
