 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509certificaterequestcmc
...
class IX509CertificateRequestCmc extends IX509CertificateRequestPkcs7{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-initializefrominnerrequesttemplatename
     */
     ...
     * </ul>
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_templateobjectid
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_nullsigned
     */
    get_NullSigned() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_cryptattributes
     */
    get_CryptAttributes() {
        result := ComCall(43, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_namevaluepairs
     */
    get_NameValuePairs() {
        result := ComCall(44, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_x509extensions
     */
    get_X509Extensions() {
     ...
     * </ul>
     * @returns {IObjectIds} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_criticalextensions
     */
    get_CriticalExtensions() {
        result := ComCall(46, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {IObjectIds} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_suppressoids
     */
    get_SuppressOids() {
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_transactionid
     */
    get_TransactionId() {
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_transactionid
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_sendernonce
     */
     ...
     * @param {BSTR} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_sendernonce
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_signatureinformation
     */
    get_SignatureInformation() {
        result := ComCall(52, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_archiveprivatekey
     */
    get_ArchivePrivateKey() {
        result := ComCall(53, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_archiveprivatekey
     */
     ...
     * @param {Integer} Encoding 
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_keyarchivalcertificate
     */
     ...
     * @param {BSTR} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_keyarchivalcertificate
     */
     ...
     * </ul>
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_encryptionalgorithm
     */
    get_EncryptionAlgorithm() {
        result := ComCall(57, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_encryptionalgorithm
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_encryptionstrength
     */
    get_EncryptionStrength() {
        result := ComCall(59, this, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-put_encryptionstrength
     */
     ...
     * @param {Integer} Encoding 
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_encryptedkeyhash
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509certificaterequestcmc-get_signercertificates
     */
    get_SignerCertificates() {
        result := ComCall(62, this, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
