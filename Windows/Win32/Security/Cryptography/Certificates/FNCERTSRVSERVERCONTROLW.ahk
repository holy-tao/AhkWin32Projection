 ...
 * @version v4.0.30319
 */
class FNCERTSRVSERVERCONTROLW extends IUnknown {
     ...
     */
    Invoke(pwszServerName, dwControlFlags, pcbOut, ppbOut) {
        ...
        result := ComCall(3, this, "ptr", pwszServerName, "uint", dwControlFlags, pcbOutMarshal, pcbOut, ppbOutMarshal, ppbOut, "int")
        if(result != 0) {
