 ...
 * @version v4.0.30319
 */
class FNCERTSRVRESTOREREGISTERW extends IUnknown {
     ...
     */
    Invoke(hbc, pwszCheckPointFilePath, pwszLogPath, rgrstmap, crstmap, pwszBackupLogPath, genLow, genHigh) {
        ...
        result := ComCall(3, this, hbcMarshal, hbc, "ptr", pwszCheckPointFilePath, "ptr", pwszLogPath, "ptr", rgrstmap, "int", crstmap, "ptr", pwszBackupLogPath, "uint", genLow, "uint", genHigh, "int")
        if(result != 0) {
