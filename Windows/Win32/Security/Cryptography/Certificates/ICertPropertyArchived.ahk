 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icertpropertyarchived
...
class ICertPropertyArchived extends ICertProperty{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertpropertyarchived-initialize
     */
    Initialize(ArchivedValue) {
        result := ComCall(14, this, "short", ArchivedValue, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertpropertyarchived-get_archived
     */
    get_Archived() {
