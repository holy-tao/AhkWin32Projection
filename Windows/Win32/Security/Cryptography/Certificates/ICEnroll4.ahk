...
export default struct ICEnroll4 extends ICEnroll3 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.put_PrivateKeyArchiveCertificate := CallbackCreate(ObjBindMethod(implObj, "put_PrivateKeyArchiveCertificate"), flags, 2)
        this.vtbl.get_PrivateKeyArchiveCertificate := CallbackCreate(ObjBindMethod(implObj, "get_PrivateKeyArchiveCertificate"), flags, 2)
        this.vtbl.put_ThumbPrint := CallbackCreate(ObjBindMethod(implObj, "put_ThumbPrint"), flags, 2)
        this.vtbl.get_ThumbPrint := CallbackCreate(ObjBindMethod(implObj, "get_ThumbPrint"), flags, 2)
        this.vtbl.binaryToString := CallbackCreate(ObjBindMethod(implObj, "binaryToString"), flags, 4)
        this.vtbl.stringToBinary := CallbackCreate(ObjBindMethod(implObj, "stringToBinary"), flags, 4)
        this.vtbl.addExtensionToRequest := CallbackCreate(ObjBindMethod(implObj, "addExtensionToRequest"), flags, 4)
        this.vtbl.addAttributeToRequest := CallbackCreate(ObjBindMethod(implObj, "addAttributeToRequest"), flags, 4)
        this.vtbl.addNameValuePairToRequest := CallbackCreate(ObjBindMethod(implObj, "addNameValuePairToRequest"), flags, 4)
        ...
        this.vtbl.createRequest := CallbackCreate(ObjBindMethod(implObj, "createRequest"), flags, 5)
        this.vtbl.createFileRequest := CallbackCreate(ObjBindMethod(implObj, "createFileRequest"), flags, 5)
        this.vtbl.acceptResponse := CallbackCreate(ObjBindMethod(implObj, "acceptResponse"), flags, 2)
        this.vtbl.acceptFileResponse := CallbackCreate(ObjBindMethod(implObj, "acceptFileResponse"), flags, 2)
        this.vtbl.getCertFromResponse := CallbackCreate(ObjBindMethod(implObj, "getCertFromResponse"), flags, 3)
        this.vtbl.getCertFromFileResponse := CallbackCreate(ObjBindMethod(implObj, "getCertFromFileResponse"), flags, 3)
        this.vtbl.createPFX := CallbackCreate(ObjBindMethod(implObj, "createPFX"), flags, 3)
        this.vtbl.createFilePFX := CallbackCreate(ObjBindMethod(implObj, "createFilePFX"), flags, 3)
        this.vtbl.setPendingRequestInfo := CallbackCreate(ObjBindMethod(implObj, "setPendingRequestInfo"), flags, 5)
        this.vtbl.enumPendingRequest := CallbackCreate(ObjBindMethod(implObj, "enumPendingRequest"), flags, 4)
        this.vtbl.removePendingRequest := CallbackCreate(ObjBindMethod(implObj, "removePendingRequest"), flags, 2)
        this.vtbl.GetKeyLenEx := CallbackCreate(ObjBindMethod(implObj, "GetKeyLenEx"), flags, 4)
        this.vtbl.InstallPKCS7Ex := CallbackCreate(ObjBindMethod(implObj, "InstallPKCS7Ex"), flags, 3)
        this.vtbl.addCertTypeToRequestEx := CallbackCreate(ObjBindMethod(implObj, "addCertTypeToRequestEx"), flags, 6)
        this.vtbl.getProviderType := CallbackCreate(ObjBindMethod(implObj, "getProviderType"), flags, 3)
        ...
        this.vtbl.addBlobPropertyToCertificate := CallbackCreate(ObjBindMethod(implObj, "addBlobPropertyToCertificate"), flags, 4)
        this.vtbl.resetBlobProperties := CallbackCreate(ObjBindMethod(implObj, "resetBlobProperties"), flags, 1)
