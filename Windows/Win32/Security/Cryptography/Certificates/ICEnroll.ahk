...
export default struct ICEnroll extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.createFilePKCS10 := CallbackCreate(ObjBindMethod(implObj, "createFilePKCS10"), flags, 4)
        this.vtbl.acceptFilePKCS7 := CallbackCreate(ObjBindMethod(implObj, "acceptFilePKCS7"), flags, 2)
        this.vtbl.createPKCS10 := CallbackCreate(ObjBindMethod(implObj, "createPKCS10"), flags, 4)
        this.vtbl.acceptPKCS7 := CallbackCreate(ObjBindMethod(implObj, "acceptPKCS7"), flags, 2)
        this.vtbl.getCertFromPKCS7 := CallbackCreate(ObjBindMethod(implObj, "getCertFromPKCS7"), flags, 3)
        this.vtbl.enumProviders := CallbackCreate(ObjBindMethod(implObj, "enumProviders"), flags, 4)
        this.vtbl.enumContainers := CallbackCreate(ObjBindMethod(implObj, "enumContainers"), flags, 3)
        this.vtbl.freeRequestInfo := CallbackCreate(ObjBindMethod(implObj, "freeRequestInfo"), flags, 2)
        this.vtbl.get_MyStoreName := CallbackCreate(ObjBindMethod(implObj, "get_MyStoreName"), flags, 2)
        this.vtbl.put_MyStoreName := CallbackCreate(ObjBindMethod(implObj, "put_MyStoreName"), flags, 2)
        this.vtbl.get_MyStoreType := CallbackCreate(ObjBindMethod(implObj, "get_MyStoreType"), flags, 2)
        this.vtbl.put_MyStoreType := CallbackCreate(ObjBindMethod(implObj, "put_MyStoreType"), flags, 2)
        ...
        this.vtbl.get_CAStoreName := CallbackCreate(ObjBindMethod(implObj, "get_CAStoreName"), flags, 2)
        this.vtbl.put_CAStoreName := CallbackCreate(ObjBindMethod(implObj, "put_CAStoreName"), flags, 2)
        this.vtbl.get_CAStoreType := CallbackCreate(ObjBindMethod(implObj, "get_CAStoreType"), flags, 2)
        this.vtbl.put_CAStoreType := CallbackCreate(ObjBindMethod(implObj, "put_CAStoreType"), flags, 2)
        ...
        this.vtbl.get_RootStoreName := CallbackCreate(ObjBindMethod(implObj, "get_RootStoreName"), flags, 2)
        this.vtbl.put_RootStoreName := CallbackCreate(ObjBindMethod(implObj, "put_RootStoreName"), flags, 2)
        this.vtbl.get_RootStoreType := CallbackCreate(ObjBindMethod(implObj, "get_RootStoreType"), flags, 2)
        this.vtbl.put_RootStoreType := CallbackCreate(ObjBindMethod(implObj, "put_RootStoreType"), flags, 2)
        ...
        this.vtbl.get_RequestStoreName := CallbackCreate(ObjBindMethod(implObj, "get_RequestStoreName"), flags, 2)
        this.vtbl.put_RequestStoreName := CallbackCreate(ObjBindMethod(implObj, "put_RequestStoreName"), flags, 2)
        this.vtbl.get_RequestStoreType := CallbackCreate(ObjBindMethod(implObj, "get_RequestStoreType"), flags, 2)
        this.vtbl.put_RequestStoreType := CallbackCreate(ObjBindMethod(implObj, "put_RequestStoreType"), flags, 2)
        ...
        this.vtbl.get_SPCFileName := CallbackCreate(ObjBindMethod(implObj, "get_SPCFileName"), flags, 2)
        this.vtbl.put_SPCFileName := CallbackCreate(ObjBindMethod(implObj, "put_SPCFileName"), flags, 2)
        this.vtbl.get_PVKFileName := CallbackCreate(ObjBindMethod(implObj, "get_PVKFileName"), flags, 2)
        this.vtbl.put_PVKFileName := CallbackCreate(ObjBindMethod(implObj, "put_PVKFileName"), flags, 2)
