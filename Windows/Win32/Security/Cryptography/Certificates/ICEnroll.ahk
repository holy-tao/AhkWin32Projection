 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nn-xenroll-icenroll
...
class ICEnroll extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-createfilepkcs10
     */
    createFilePKCS10(DNName, Usage, wszPKCS10FileName) {
        if(DNName is String) {
            pin := BSTR.Alloc(DNName)
            DNName := pin.Value
        }
        if(Usage is String) {
        ...
        if(wszPKCS10FileName is String) {
            pin := BSTR.Alloc(wszPKCS10FileName)
            wszPKCS10FileName := pin.Value
        }
    ...
    acceptFilePKCS7(wszPKCS7FileName) {
        if(wszPKCS7FileName is String) {
            pin := BSTR.Alloc(wszPKCS7FileName)
            wszPKCS7FileName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-createpkcs10
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-acceptpkcs7
     */
    acceptPKCS7(PKCS7) {
        if(PKCS7 is String) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-getcertfrompkcs7
     */
    getCertFromPKCS7(wszPKCS7) {
        if(wszPKCS7 is String) {
            pin := BSTR.Alloc(wszPKCS7)
            wszPKCS7 := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-enumproviders
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-enumcontainers
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-freerequestinfo
     */
    freeRequestInfo(PKCS7OrPKCS10) {
        if(PKCS7OrPKCS10 is String) {
            pin := BSTR.Alloc(PKCS7OrPKCS10)
            PKCS7OrPKCS10 := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_mystorename
     */
    get_MyStoreName() {
        pbstrName := BSTR()
     ...
     * @param {BSTR} bstrName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_mystorename
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_mystoretype
     */
    get_MyStoreType() {
        pbstrType := BSTR()
     ...
     * @param {BSTR} bstrType 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_mystoretype
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_mystoreflags
     */
    get_MyStoreFlags() {
        result := ComCall(19, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_mystoreflags
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_castorename
     */
    get_CAStoreName() {
        pbstrName := BSTR()
     ...
     * @param {BSTR} bstrName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_castorename
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_castoretype
     */
    get_CAStoreType() {
        pbstrType := BSTR()
     ...
     * @param {BSTR} bstrType 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_castoretype
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_castoreflags
     */
    get_CAStoreFlags() {
        result := ComCall(25, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_castoreflags
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_rootstorename
     */
    get_RootStoreName() {
        pbstrName := BSTR()
     ...
     * @param {BSTR} bstrName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_rootstorename
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_rootstoretype
     */
    get_RootStoreType() {
        pbstrType := BSTR()
     ...
     * @param {BSTR} bstrType 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_rootstoretype
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_rootstoreflags
     */
    get_RootStoreFlags() {
        result := ComCall(31, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_rootstoreflags
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_requeststorename
     */
     ...
     * @param {BSTR} bstrName 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_requeststorename
     */
     ...
     * The ability to set this property is disabled when  the Certificate Enrollment Control is executed as a scripted control.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_requeststoretype
     */
     ...
     * @param {BSTR} bstrType 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_requeststoretype
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_requeststoreflags
     */
    get_RequestStoreFlags() {
        result := ComCall(37, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_requeststoreflags
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_containername
     */
    get_ContainerName() {
        pbstrContainer := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_containername
     */
    put_ContainerName(bstrContainer) {
        if(bstrContainer is String) {
            pin := BSTR.Alloc(bstrContainer)
            bstrContainer := pin.Value
        }
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_providername
     */
    get_ProviderName() {
        pbstrProvider := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_providername
     */
    put_ProviderName(bstrProvider) {
        if(bstrProvider is String) {
            pin := BSTR.Alloc(bstrProvider)
            bstrProvider := pin.Value
        }
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_providertype
     */
    get_ProviderType() {
        result := ComCall(43, this, "int*", &pdwType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_providertype
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_keyspec
     */
    get_KeySpec() {
        result := ComCall(45, this, "int*", &pdw := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dw 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_keyspec
     */
    put_KeySpec(dw) {
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_providerflags
     */
    get_ProviderFlags() {
        result := ComCall(47, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_providerflags
     */
     ...
     * </ul>
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_useexistingkeyset
     */
    get_UseExistingKeySet() {
        result := ComCall(49, this, "int*", &fUseExistingKeys := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_useexistingkeyset
     */
     ...
     * <div> </div>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_genkeyflags
     */
    get_GenKeyFlags() {
        result := ComCall(51, this, "int*", &pdwFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} dwFlags 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_genkeyflags
     */
     ...
     * </ul>
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_deleterequestcert
     */
    get_DeleteRequestCert() {
        result := ComCall(53, this, "int*", &fDelete := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BOOL} fDelete 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_deleterequestcert
     */
     ...
     * </ul>
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_writecerttocsp
     */
    get_WriteCertToCSP() {
        result := ComCall(55, this, "int*", &fBool := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BOOL} fBool 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_writecerttocsp
     */
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_spcfilename
     */
    get_SPCFileName() {
        pbstr := BSTR()
     ...
     * @param {BSTR} bstr_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_spcfilename
     */
    put_SPCFileName(bstr_) {
        if(bstr_ is String) {
            pin := BSTR.Alloc(bstr_)
            bstr_ := pin.Value
        }

        result := ComCall(58, this, "ptr", bstr_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_pvkfilename
     */
    get_PVKFileName() {
        pbstr := BSTR()
     ...
     * @param {BSTR} bstr_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_pvkfilename
     */
    put_PVKFileName(bstr_) {
        if(bstr_ is String) {
            pin := BSTR.Alloc(bstr_)
            bstr_ := pin.Value
        }

        result := ComCall(60, this, "ptr", bstr_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-get_hashalgorithm
     */
    get_HashAlgorithm() {
        pbstr := BSTR()
     ...
     * @param {BSTR} bstr_ 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll-put_hashalgorithm
     */
    put_HashAlgorithm(bstr_) {
        if(bstr_ is String) {
            pin := BSTR.Alloc(bstr_)
            bstr_ := pin.Value
        }

        result := ComCall(62, this, "ptr", bstr_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
