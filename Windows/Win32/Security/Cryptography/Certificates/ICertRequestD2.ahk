...
class ICertRequestD2 extends ICertRequestD{
    ...
    Request2(pwszAuthority, dwFlags, pwszSerialNumber, pdwRequestId, pdwDisposition, pwszAttributes, pctbRequest, pctbFullResponse, pctbEncodedCert, pctbDispositionMessage) {
        ...
        result := ComCall(6, this, "ptr", pwszAuthority, "uint", dwFlags, "ptr", pwszSerialNumber, "uint*", pdwRequestId, "uint*", pdwDisposition, "ptr", pwszAttributes, "ptr", pctbRequest, "ptr", pctbFullResponse, "ptr", pctbEncodedCert, "ptr", pctbDispositionMessage, "int")
        if(result != 0)
     ...
     * 
     * @param {PWSTR} pwszAuthority 
     * @param {Pointer<Int32>} pcProperty 
    ...
    GetCAPropertyInfo(pwszAuthority, pcProperty, pctbPropInfo) {
        ...
        result := ComCall(8, this, "ptr", pwszAuthority, "int*", pcProperty, "ptr", pctbPropInfo, "int")
        if(result != 0)
            throw OSError(result)
