...
#Import ".\IPolicyQualifier.ahk" { IPolicyQualifier }

/**
 * Defines methods and properties that enable you to manage a collection of IPolicyQualifier objects.
 * @see https://learn.microsoft.com/windows/win32/api/certenroll/nn-certenroll-ipolicyqualifiers
 * @namespace Windows.Win32.Security.Cryptography.Certificates
 */
export default struct IPolicyQualifiers extends IDispatch {
    /**
     ...
     * used for IPolicyQualifiers interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPolicyQualifiers.Vtbl()
        }
    ...
    Query(iid) {
        if (IPolicyQualifiers.IID.Equals(iid)) {
            return true
        }
