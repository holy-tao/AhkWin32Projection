 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nn-xenroll-ienroll4
...
class IEnroll4 extends IEnroll2{
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-put_thumbprintwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-get_thumbprintwstr
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-setprivatekeyarchivecertificate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-getprivatekeyarchivecertificate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-binaryblobtostring
     */
    binaryBlobToString(Flags, pblobBinary, ppwszString) {
        ppwszStringMarshal := ppwszString is VarRef ? "ptr*" : "ptr"

        result := ComCall(95, this, "int", Flags, "ptr", pblobBinary, ppwszStringMarshal, ppwszString, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-stringtobinaryblob
     */
    stringToBinaryBlob(Flags, pwszString, pblobBinary, pdwSkip, pdwFlags) {
        ...
        result := ComCall(96, this, "int", Flags, "ptr", pwszString, "ptr", pblobBinary, pdwSkipMarshal, pdwSkip, pdwFlagsMarshal, pdwFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-addextensiontorequestwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-addattributetorequestwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-addnamevaluepairtorequestwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-resetextensions
     */
    resetExtensions() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-resetattributes
     */
    resetAttributes() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-createrequestwstr
     */
     ...
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see 
     * <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-createfilerequestwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-acceptresponseblob
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-acceptfileresponsewstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-getcertcontextfromresponseblob
     */
    getCertContextFromResponseBlob(pblobResponse, ppCertContext) {
        ppCertContextMarshal := ppCertContext is VarRef ? "ptr*" : "ptr"

        result := ComCall(106, this, "ptr", pblobResponse, ppCertContextMarshal, ppCertContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<Pointer<CERT_CONTEXT>>} ppCertContext A pointer to a pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-cert_context">CERT_CONTEXT</a> structure that receives the certificate retrieved from the response.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-getcertcontextfromfileresponsewstr
     */
    getCertContextFromFileResponseWStr(pwszResponseFileName, ppCertContext) {
        ...
        result := ComCall(107, this, "ptr", pwszResponseFileName, ppCertContextMarshal, ppCertContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-createpfxwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-createfilepfxwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-setpendingrequestinfowstr
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-enumpendingrequestwstr
     */
    enumPendingRequestWStr(lIndex, lDesiredProperty, ppProperty) {
        ppPropertyMarshal := ppProperty is VarRef ? "ptr" : "ptr"

        result := ComCall(111, this, "int", lIndex, "int", lDesiredProperty, ppPropertyMarshal, ppProperty, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-removependingrequestwstr
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-getkeylenex
     */
    GetKeyLenEx(lSizeSpec, lKeySpec, pdwKeySize) {
        pdwKeySizeMarshal := pdwKeySize is VarRef ? "int*" : "ptr"

        result := ComCall(113, this, "int", lSizeSpec, "int", lKeySpec, pdwKeySizeMarshal, pdwKeySize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-installpkcs7blobex
     */
    InstallPKCS7BlobEx(pBlobPKCS7, plCertInstalled) {
        plCertInstalledMarshal := plCertInstalled is VarRef ? "int*" : "ptr"

        result := ComCall(114, this, "ptr", pBlobPKCS7, plCertInstalledMarshal, plCertInstalled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>, with S_OK returned if the call is successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-addcerttypetorequestwstrex
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-getprovidertypewstr
     */
    getProviderTypeWStr(pwszProvName, plProvType) {
        ...
        result := ComCall(116, this, "ptr", pwszProvName, plProvTypeMarshal, plProvType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-addblobpropertytocertificatewstr
     */
     ...
     * @returns {HRESULT} The return value is an <b>HRESULT</b>. A value of S_OK indicates success.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-setsignercertificate
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-put_clientid
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-get_clientid
     */
    get_ClientId(plClientId) {
        plClientIdMarshal := plClientId is VarRef ? "int*" : "ptr"

        result := ComCall(120, this, plClientIdMarshal, plClientId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {BOOL} fInclude 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-put_includesubjectkeyid
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-ienroll4-get_includesubjectkeyid
     */
    get_IncludeSubjectKeyID(pfInclude) {
        pfIncludeMarshal := pfInclude is VarRef ? "int*" : "ptr"

        result := ComCall(122, this, pfIncludeMarshal, pfInclude, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
