...
export default struct IOCSPCAConfiguration extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CACertificate := CallbackCreate(ObjBindMethod(implObj, "get_CACertificate"), flags, 2)
        ...
        this.vtbl.get_SigningFlags := CallbackCreate(ObjBindMethod(implObj, "get_SigningFlags"), flags, 2)
        this.vtbl.put_SigningFlags := CallbackCreate(ObjBindMethod(implObj, "put_SigningFlags"), flags, 2)
        this.vtbl.get_SigningCertificate := CallbackCreate(ObjBindMethod(implObj, "get_SigningCertificate"), flags, 2)
        this.vtbl.put_SigningCertificate := CallbackCreate(ObjBindMethod(implObj, "put_SigningCertificate"), flags, 2)
        this.vtbl.get_ReminderDuration := CallbackCreate(ObjBindMethod(implObj, "get_ReminderDuration"), flags, 2)
        this.vtbl.put_ReminderDuration := CallbackCreate(ObjBindMethod(implObj, "put_ReminderDuration"), flags, 2)
        this.vtbl.get_ErrorCode := CallbackCreate(ObjBindMethod(implObj, "get_ErrorCode"), flags, 2)
        this.vtbl.get_CSPName := CallbackCreate(ObjBindMethod(implObj, "get_CSPName"), flags, 2)
        this.vtbl.get_KeySpec := CallbackCreate(ObjBindMethod(implObj, "get_KeySpec"), flags, 2)
        this.vtbl.get_ProviderCLSID := CallbackCreate(ObjBindMethod(implObj, "get_ProviderCLSID"), flags, 2)
        this.vtbl.put_ProviderCLSID := CallbackCreate(ObjBindMethod(implObj, "put_ProviderCLSID"), flags, 2)
        this.vtbl.get_ProviderProperties := CallbackCreate(ObjBindMethod(implObj, "get_ProviderProperties"), flags, 2)
        this.vtbl.put_ProviderProperties := CallbackCreate(ObjBindMethod(implObj, "put_ProviderProperties"), flags, 2)
        this.vtbl.get_Modified := CallbackCreate(ObjBindMethod(implObj, "get_Modified"), flags, 2)
        this.vtbl.get_LocalRevocationInformation := CallbackCreate(ObjBindMethod(implObj, "get_LocalRevocationInformation"), flags, 2)
        this.vtbl.put_LocalRevocationInformation := CallbackCreate(ObjBindMethod(implObj, "put_LocalRevocationInformation"), flags, 2)
        this.vtbl.get_SigningCertificateTemplate := CallbackCreate(ObjBindMethod(implObj, "get_SigningCertificateTemplate"), flags, 2)
        this.vtbl.put_SigningCertificateTemplate := CallbackCreate(ObjBindMethod(implObj, "put_SigningCertificateTemplate"), flags, 2)
        this.vtbl.get_CAConfig := CallbackCreate(ObjBindMethod(implObj, "get_CAConfig"), flags, 2)
        this.vtbl.put_CAConfig := CallbackCreate(ObjBindMethod(implObj, "put_CAConfig"), flags, 2)
    }
