 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nn-certadm-iocspcaconfiguration
...
class IOCSPCAConfiguration extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_identifier
     */
    get_Identifier() {
        pVal := BSTR()
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_cacertificate
     */
    get_CACertificate() {
        pVal := VARIANT()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_hashalgorithm
     */
    get_HashAlgorithm() {
        pVal := BSTR()
     ...
     * @param {BSTR} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_hashalgorithm
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_signingflags
     */
    get_SigningFlags() {
        result := ComCall(11, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_signingflags
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_signingcertificate
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_signingcertificate
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_reminderduration
     */
    get_ReminderDuration() {
        result := ComCall(15, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_reminderduration
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_errorcode
     */
    get_ErrorCode() {
        result := ComCall(17, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_cspname
     */
    get_CSPName() {
        pVal := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_keyspec
     */
    get_KeySpec() {
        result := ComCall(19, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_providerclsid
     */
    get_ProviderCLSID() {
        pVal := BSTR()
     ...
     * @param {BSTR} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_providerclsid
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_providerproperties
     */
     ...
     * @param {VARIANT} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_providerproperties
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_modified
     */
    get_Modified() {
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_localrevocationinformation
     */
     ...
     * @param {VARIANT} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_localrevocationinformation
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_signingcertificatetemplate
     */
     ...
     * @param {BSTR} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_signingcertificatetemplate
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-get_caconfig
     */
    get_CAConfig() {
        pVal := BSTR()
     ...
     * @param {BSTR} newVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspcaconfiguration-put_caconfig
     */
    put_CAConfig(newVal) {
        if(newVal is String) {
            pin := BSTR.Alloc(newVal)
