 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-icertpropertyfriendlyname
...
class ICertPropertyFriendlyName extends ICertProperty{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertpropertyfriendlyname-initialize
     */
    Initialize(strFriendlyName) {
        ...
        result := ComCall(14, this, "ptr", strFriendlyName, "int")
        if(result != 0) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-icertpropertyfriendlyname-get_friendlyname
     */
    get_FriendlyName() {
        pValue := BSTR()
