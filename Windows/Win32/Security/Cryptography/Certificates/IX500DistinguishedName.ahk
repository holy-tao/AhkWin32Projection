 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix500distinguishedname
...
class IX500DistinguishedName extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix500distinguishedname-decode
     */
    Decode(strEncodedName, Encoding, NameFlags) {
        if(strEncodedName is String) {
            pin := BSTR.Alloc(strEncodedName)
            strEncodedName := pin.Value
        }

        result := ComCall(7, this, "ptr", strEncodedName, "int", Encoding, "int", NameFlags, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix500distinguishedname-encode
     */
    Encode(strName, NameFlags) {
        ...
        result := ComCall(8, this, "ptr", strName, "int", NameFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix500distinguishedname-get_name
     */
    get_Name() {
        pValue := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix500distinguishedname-get_encodedname
     */
