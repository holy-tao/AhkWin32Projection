 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nn-certpol-indespolicy
...
class INDESPolicy extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-indespolicy-initialize
     */
    Initialize() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-indespolicy-uninitialize
     */
    Uninitialize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-indespolicy-generatechallenge
     */
    GenerateChallenge(pwszTemplate, pwszParams) {
        ...
        result := ComCall(5, this, "ptr", pwszTemplate, "ptr", pwszParams, "ptr*", &ppwszResponse := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-indespolicy-verifyrequest
     */
    VerifyRequest(pctbRequest, pctbSigningCertEncoded, pwszTemplate, pwszTransactionId) {
        ...
        result := ComCall(6, this, "ptr", pctbRequest, "ptr", pctbSigningCertEncoded, "ptr", pwszTemplate, "ptr", pwszTransactionId, "int*", &pfVerified := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/certpol/nf-certpol-indespolicy-notify
     */
