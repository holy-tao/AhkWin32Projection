 ...
 */
export default struct IX509EnrollmentWebClassFactory extends IDispatch {
    /**
     ...
     * used for IX509EnrollmentWebClassFactory interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IX509EnrollmentWebClassFactory.Vtbl()
        }
    ...
    CreateObject(strProgID) {
        ...
        result := ComCall(7, this, BSTR, strProgID, "ptr*", &ppIUnknown := 0, "HRESULT")
