 ...
 * @see https://learn.microsoft.com/windows/win32/api/certenroll/nn-certenroll-ix509extensionauthoritykeyidentifier
 * @namespace Windows.Win32.Security.Cryptography.Certificates
 */
export default struct IX509ExtensionAuthorityKeyIdentifier extends IX509Extension {
    /**
     ...
     * used for IX509ExtensionAuthorityKeyIdentifier interfaces
    */
    struct Vtbl extends IX509Extension.Vtbl {
        InitializeEncode           : IntPtr
        InitializeDecode           : IntPtr
        get_AuthorityKeyIdentifier : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IX509ExtensionAuthorityKeyIdentifier.Vtbl()
        }
     ...
     * </ul>
     * @param {EncodingType} Encoding An <a href="https://docs.microsoft.com/windows/desktop/api/certenroll/ne-certenroll-encodingtype">EncodingType</a> enumeration value that specifies the type of Unicode encoding applied to the <i>strKeyIdentifier</i> value.
    ...
    InitializeEncode(Encoding, strKeyIdentifier) {
        ...
        result := ComCall(12, this, EncodingType, Encoding, BSTR, strKeyIdentifier, "HRESULT")
        return result
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.get_AuthorityKeyIdentifier)
    }
}
