 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509extension
...
class IX509Extension extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extension-initialize
     */
    Initialize(pObjectId, Encoding, strEncodedData) {
        ...
        result := ComCall(7, this, "ptr", pObjectId, "int", Encoding, "ptr", strEncodedData, "int")
        if(result != 0) {
     ...
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extension-get_objectid
     */
    get_ObjectId() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extension-get_rawdata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extension-get_critical
     */
    get_Critical() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509extension-put_critical
     */
    put_Critical(Value) {
