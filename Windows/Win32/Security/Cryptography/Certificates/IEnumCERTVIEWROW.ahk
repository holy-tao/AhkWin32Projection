 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certview/nn-certview-ienumcertviewrow
...
class IEnumCERTVIEWROW extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-next
     */
    Next(pIndex) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-enumcertviewcolumn
     */
    EnumCertViewColumn() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-enumcertviewattribute
     */
    EnumCertViewAttribute(Flags) {
        result := ComCall(9, this, "int", Flags, "ptr*", &ppenum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-enumcertviewextension
     */
    EnumCertViewExtension(Flags) {
        result := ComCall(10, this, "int", Flags, "ptr*", &ppenum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-skip
     */
    Skip(celt) {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certview/nf-certview-ienumcertviewrow-getmaxindex
     */
    GetMaxIndex(pIndex) {
        pIndexMarshal := pIndex is VarRef ? "int*" : "ptr"

        result := ComCall(14, this, pIndexMarshal, pIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
