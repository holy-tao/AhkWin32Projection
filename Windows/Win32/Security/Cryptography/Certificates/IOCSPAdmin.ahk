 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nn-certadm-iocspadmin
...
class IOCSPAdmin extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-get_ocspserviceproperties
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-get_ocspcaconfigurationcollection
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-getconfiguration
     */
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-setconfiguration
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-getmyroles
     */
    GetMyRoles(bstrServerName) {
        ...
        result := ComCall(11, this, "ptr", bstrServerName, "int*", &pRoles := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-ping
     */
    Ping(bstrServerName) {
        if(bstrServerName is String) {
            pin := BSTR.Alloc(bstrServerName)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-setsecurity
     */
     ...
     * @param {BSTR} bstrServerName A string that contains the responder-server name.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-getsecurity
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-getsigningcertificates
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certadm/nf-certadm-iocspadmin-gethashalgorithms
     */
    GetHashAlgorithms(bstrServerName, bstrCAId) {
        ...
        if(bstrCAId is String) {
            pin := BSTR.Alloc(bstrCAId)
            bstrCAId := pin.Value
        }
