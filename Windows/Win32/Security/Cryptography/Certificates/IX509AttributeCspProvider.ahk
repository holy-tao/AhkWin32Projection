 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509attributecspprovider
...
class IX509AttributeCspProvider extends IX509Attribute{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributecspprovider-initializeencode
     */
    InitializeEncode(KeySpec, strProviderName, Encoding, strSignature) {
        ...
        if(strSignature is String) {
            pin := BSTR.Alloc(strSignature)
            strSignature := pin.Value
        }
     ...
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributecspprovider-initializedecode
     */
     ...
     * </ul>
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributecspprovider-get_keyspec
     */
    get_KeySpec() {
     ...
     * </ul>
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributecspprovider-get_providername
     */
    get_ProviderName() {
        pValue := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509attributecspprovider-get_signature
     */
