...
export default struct ICEnroll3 extends ICEnroll2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.InstallPKCS7 := CallbackCreate(ObjBindMethod(implObj, "InstallPKCS7"), flags, 2)
        ...
        this.vtbl.GetAlgName := CallbackCreate(ObjBindMethod(implObj, "GetAlgName"), flags, 3)
