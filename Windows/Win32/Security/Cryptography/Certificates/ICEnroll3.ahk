 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nn-xenroll-icenroll3
...
class ICEnroll3 extends ICEnroll2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-installpkcs7
     */
    InstallPKCS7(PKCS7) {
        if(PKCS7 is String) {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-getsupportedkeyspec
     */
    GetSupportedKeySpec() {
        result := ComCall(71, this, "int*", &pdwKeySpec := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-getkeylen
     */
    GetKeyLen(fMin, fExchange) {
        result := ComCall(72, this, "int", fMin, "int", fExchange, "int*", &pdwKeySize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-enumalgs
     */
    EnumAlgs(dwIndex, algClass) {
        result := ComCall(73, this, "int", dwIndex, "int", algClass, "int*", &pdwAlgID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-getalgname
     */
    GetAlgName(algID) {
        pbstr := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-put_reusehardwarekeyifunabletogennew
     */
     ...
     * This property is a Boolean value. This property affects only <a href="https://docs.microsoft.com/windows/desktop/SecGloss/c-gly">cryptographic service providers</a> that return NTE_TOKEN_KEYSET_STORAGE_FULL. These CSPs are typically hardware-based; an example is a smart card. If this property is true and an error is encountered while generating a new key, the certificate enrollment control object will reuse the existing hardware key. If this property is false and an error is encountered while generating a new key, the certificate enrollment control object will not reuse the existing hardware key but will instead pass an error to the caller.
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-get_reusehardwarekeyifunabletogennew
     */
    get_ReuseHardwareKeyIfUnableToGenNew() {
        result := ComCall(76, this, "int*", &fReuseHardwareKeyIfUnableToGenNew := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-put_hashalgid
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/xenroll/nf-xenroll-icenroll-get_hashalgorithm">HashAlgorithm</a> properties are set, whichever has been updated most recently determines the hash algorithm used to sign the PKCS #10 request.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-get_hashalgid
     */
    get_HashAlgID() {
        result := ComCall(78, this, "int*", &hashAlgID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-put_limitexchangekeytoencipherment
     */
     ...
     * </ul>
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-get_limitexchangekeytoencipherment
     */
    get_LimitExchangeKeyToEncipherment() {
        result := ComCall(80, this, "int*", &fLimitExchangeKeyToEncipherment := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-put_enablesmimecapabilities
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/xenroll/nf-xenroll-icenroll3-get_enablesmimecapabilities
     */
    get_EnableSMIMECapabilities() {
        result := ComCall(82, this, "int*", &fEnableSMIMECapabilities := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
