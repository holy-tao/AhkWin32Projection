 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nn-certenc-icertencodebitstring
...
class ICertEncodeBitString extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodebitstring-decode
     */
    Decode(strBinary) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodebitstring-getbitcount
     */
    GetBitCount() {
        result := ComCall(8, this, "int*", &pBitCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodebitstring-getbitstring
     */
    GetBitString() {
        pstrBitString := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodebitstring-encode
     */
