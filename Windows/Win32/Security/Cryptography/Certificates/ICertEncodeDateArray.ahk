 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nn-certenc-icertencodedatearray
...
class ICertEncodeDateArray extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodedatearray-getcount
     */
    GetCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodedatearray-getvalue
     */
    GetValue(Index) {
        result := ComCall(9, this, "int", Index, "double*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodedatearray-reset
     */
    Reset(Count) {
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodedatearray-setvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenc/nf-certenc-icertencodedatearray-encode
     */
    Encode() {
        pstrBinary := BSTR()
