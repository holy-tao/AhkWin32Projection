 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certexit/nn-certexit-icertexit2
...
class ICertExit2 extends ICertExit{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certexit/nf-certexit-icertexit2-getmanagemodule
     */
    GetManageModule() {
        result := ComCall(10, this, "ptr*", &ppManageModule := 0, "int")
        if(result != 0) {
