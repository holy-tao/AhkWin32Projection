 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509signatureinformation
...
class IX509SignatureInformation extends IDispatch{
     ...
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_hashalgorithm
     */
    get_HashAlgorithm() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-put_hashalgorithm
     */
     ...
     * @returns {IObjectId} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_publickeyalgorithm
     */
     ...
     * @param {IObjectId} pValue 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-put_publickeyalgorithm
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_parameters
     */
     ...
     * @param {BSTR} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-put_parameters
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_alternatesignaturealgorithm
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-put_alternatesignaturealgorithm
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_alternatesignaturealgorithmset
     */
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-get_nullsigned
     */
    get_NullSigned() {
     ...
     * @param {VARIANT_BOOL} Value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-put_nullsigned
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-getsignaturealgorithm
     */
    GetSignatureAlgorithm(Pkcs7Signature, SignatureKey) {
        result := ComCall(18, this, "short", Pkcs7Signature, "short", SignatureKey, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509signatureinformation-setdefaultvalues
     */
    SetDefaultValues() {
