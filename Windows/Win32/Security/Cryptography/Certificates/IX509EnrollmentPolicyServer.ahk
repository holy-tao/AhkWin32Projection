 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nn-certenroll-ix509enrollmentpolicyserver
...
class IX509EnrollmentPolicyServer extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-initialize
     */
    Initialize(bstrPolicyServerUrl, bstrPolicyServerId, authFlags, fIsUnTrusted, context_) {
        if(bstrPolicyServerUrl is String) {
            pin := BSTR.Alloc(bstrPolicyServerUrl)
            bstrPolicyServerUrl := pin.Value
        }
        if(bstrPolicyServerId is String) {
            pin := BSTR.Alloc(bstrPolicyServerId)
            bstrPolicyServerId := pin.Value
        }

        result := ComCall(7, this, "ptr", bstrPolicyServerUrl, "ptr", bstrPolicyServerId, "int", authFlags, "short", fIsUnTrusted, "int", context_, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-loadpolicy
     */
    LoadPolicy(option) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-gettemplates
     */
    GetTemplates() {
        result := ComCall(9, this, "ptr*", &pTemplates := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getcasfortemplate
     */
    GetCAsForTemplate(pTemplate) {
        result := ComCall(10, this, "ptr", pTemplate, "ptr*", &ppCAs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getcas
     */
    GetCAs() {
        result := ComCall(11, this, "ptr*", &ppCAs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-validate
     */
    Validate() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getcustomoids
     */
    GetCustomOids() {
        result := ComCall(13, this, "ptr*", &ppObjectIds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getnextupdatetime
     */
    GetNextUpdateTime() {
        result := ComCall(14, this, "double*", &pDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The date is stored as an 8-byte real value that represents a Coordinated Universal Time (Greenwich Mean Time) value between January 1, 1900 and December 31, 9999, inclusive. The value 2.0 represents January 1, 1900; 3.0 represents January 2, 1900. Adding 1 to the value increments the date by a day. The fractional part of the value represents the time of day. Therefore, 2.5 represents 12:00 on January 1, 1900; 3.25 represents 06:00 on January 2, 1900.
     * @returns {Float} Pointer to a <b>DATE</b> value that identifies the time.
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getlastupdatetime
     */
    GetLastUpdateTime() {
        result := ComCall(15, this, "double*", &pDate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getpolicyserverurl
     */
    GetPolicyServerUrl() {
        pValue := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getpolicyserverid
     */
    GetPolicyServerId() {
        pValue := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getfriendlyname
     */
    GetFriendlyName() {
        pValue := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getisdefaultcep
     */
    GetIsDefaultCEP() {
        result := ComCall(19, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getuseclientid
     */
    GetUseClientId() {
        result := ComCall(20, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getallowuntrustedca
     */
    GetAllowUnTrustedCA() {
        result := ComCall(21, this, "short*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getcachepath
     */
    GetCachePath() {
        pValue := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getcachedir
     */
    GetCacheDir() {
        pValue := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-getauthflags
     */
    GetAuthFlags() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-setcredential
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-querychanges
     */
    QueryChanges() {
     ...
     * @param {VARIANT} val_ A <b>VARIANT</b> of type <b>VT_ARRAY|VT_UI1</b> that contains the templates and object identifiers.
     * @returns {HRESULT} If the function succeeds, the function returns <b>S_OK</b>.
     * 
     * If the function fails, it returns an <b>HRESULT</b> value that indicates the error. Possible values include, but are not limited to, those in the following table.  For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-initializeimport
     */
    InitializeImport(val_) {
        result := ComCall(27, this, "ptr", val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-export
     */
    Export(exportFlags) {
        pVal := VARIANT()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-get_cost
     */
    get_Cost() {
        result := ComCall(29, this, "uint*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} value 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/certenroll/nf-certenroll-ix509enrollmentpolicyserver-put_cost
     */
    put_Cost(value) {
