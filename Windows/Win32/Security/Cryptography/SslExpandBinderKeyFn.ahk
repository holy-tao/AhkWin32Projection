 ...
 * @version v4.0.30319
 */
class SslExpandBinderKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hEarlyKey, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hEarlyKey, "ptr", phBinderKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
