 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//cryptdlg/ns-cryptdlg-cert_select_struct_w
    ...
    pTemplateName{
        get {
            if(!this.HasProp("__pTemplateName"))
                this.__pTemplateName := PWSTR(this.ptr + 24)
    ...
    szTitle{
        get {
            if(!this.HasProp("__szTitle"))
                this.__szTitle := PWSTR(this.ptr + 40)
    ...
    szHelpFileName{
        get {
            if(!this.HasProp("__szHelpFileName"))
                this.__szHelpFileName := PWSTR(this.ptr + 112)
