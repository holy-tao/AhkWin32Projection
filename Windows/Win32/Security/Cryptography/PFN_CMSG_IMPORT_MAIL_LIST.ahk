 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/nc-wincrypt-pfn_cmsg_import_mail_list
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_CMSG_IMPORT_MAIL_LIST extends IUnknown {
     ...
     * @param {Pointer<CMSG_CTRL_MAIL_LIST_DECRYPT_PARA>} pMailListDecryptPara 
     ...
     */
    Invoke(pContentEncryptionAlgorithm, pMailListDecryptPara, dwFlags, phContentEncryptKey) {
        static pvReserved := 0 ;Reserved parameters must always be NULL

        phContentEncryptKeyMarshal := phContentEncryptKey is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pContentEncryptionAlgorithm, "ptr", pMailListDecryptPara, "uint", dwFlags, "ptr", pvReserved, phContentEncryptKeyMarshal, phContentEncryptKey, "int")
        return result
    }
}
