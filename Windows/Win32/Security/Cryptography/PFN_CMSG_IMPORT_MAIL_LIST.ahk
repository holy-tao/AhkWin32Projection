...
#Import ".\CMSG_CTRL_MAIL_LIST_DECRYPT_PARA.ahk" { CMSG_CTRL_MAIL_LIST_DECRYPT_PARA }
 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api/wincrypt/nc-wincrypt-pfn_cmsg_import_mail_list
 * @namespace Windows.Win32.Security.Cryptography
 */
export default struct PFN_CMSG_IMPORT_MAIL_LIST {
    value : IntPtr

    __value {
        set {
            if (value is PFN_CMSG_IMPORT_MAIL_LIST) {
    ...
    /**
     * A PFN_CMSG_IMPORT_MAIL_LIST that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_CMSG_IMPORT_MAIL_LIST {
        /**
         * Creates a PFN_CMSG_IMPORT_MAIL_LIST pointer that invokes the given AHK function when called.
         * @param {Func(CRYPT_ALGORITHM_IDENTIFIER, CMSG_CTRL_MAIL_LIST_DECRYPT_PARA, UInt32, "ptr*") => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
