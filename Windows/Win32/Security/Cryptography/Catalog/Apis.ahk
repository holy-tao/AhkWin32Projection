...
#Import ".\CRYPTCATATTRIBUTE.ahk" { CRYPTCATATTRIBUTE }
...
#Import ".\CATALOG_INFO.ahk" { CATALOG_INFO }
#Import ".\CRYPTCATCDF.ahk" { CRYPTCATCDF }
 ...
 */
export CryptCATOpen(pwszFileName, fdwOpenFlags, hProv, dwPublicVersion, dwEncodingType) {
    pwszFileName := pwszFileName is String ? StrPtr(pwszFileName) : pwszFileName

    result := DllCall("WINTRUST.dll\CryptCATOpen", "ptr", pwszFileName, CRYPTCAT_OPEN_FLAGS, fdwOpenFlags, "ptr", hProv, CRYPTCAT_VERSION, dwPublicVersion, "uint", dwEncodingType, HANDLE.Owned)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATClose(hCatalog) {
    result := DllCall("WINTRUST.dll\CryptCATClose", HANDLE, hCatalog, BOOL)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATStoreFromHandle(hCatalog) {
    result := DllCall("WINTRUST.dll\CryptCATStoreFromHandle", HANDLE, hCatalog, CRYPTCATSTORE.Ptr)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATHandleFromStore(pCatStore) {
    result := DllCall("WINTRUST.dll\CryptCATHandleFromStore", CRYPTCATSTORE.Ptr, pCatStore, HANDLE.Owned)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATPersistStore(hCatalog) {
    A_LastError := 0

    result := DllCall("WINTRUST.dll\CryptCATPersistStore", HANDLE, hCatalog, BOOL)
 ...
 */
export CryptCATGetCatAttrInfo(hCatalog, pwszReferenceTag) {
    pwszReferenceTag := pwszReferenceTag is String ? StrPtr(pwszReferenceTag) : pwszReferenceTag

    result := DllCall("WINTRUST.dll\CryptCATGetCatAttrInfo", HANDLE, hCatalog, "ptr", pwszReferenceTag, CRYPTCATATTRIBUTE.Ptr)
    return result
}
...
export CryptCATPutCatAttrInfo(hCatalog, pwszReferenceTag, dwAttrTypeAndAction, cbData, pbData) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATPutCatAttrInfo", HANDLE, hCatalog, "ptr", pwszReferenceTag, "uint", dwAttrTypeAndAction, "uint", cbData, pbDataMarshal, pbData, CRYPTCATATTRIBUTE.Ptr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATEnumerateCatAttr(hCatalog, pPrevAttr) {
    result := DllCall("WINTRUST.dll\CryptCATEnumerateCatAttr", HANDLE, hCatalog, CRYPTCATATTRIBUTE.Ptr, pPrevAttr, CRYPTCATATTRIBUTE.Ptr)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATGetMemberInfo(hCatalog, pwszReferenceTag) {
    pwszReferenceTag := pwszReferenceTag is String ? StrPtr(pwszReferenceTag) : pwszReferenceTag

    result := DllCall("WINTRUST.dll\CryptCATGetMemberInfo", HANDLE, hCatalog, "ptr", pwszReferenceTag, CRYPTCATMEMBER.Ptr)
    return result
}
 ...
 */
export CryptCATAllocSortedMemberInfo(hCatalog, pwszReferenceTag) {
    pwszReferenceTag := pwszReferenceTag is String ? StrPtr(pwszReferenceTag) : pwszReferenceTag

    result := DllCall("WINTRUST.dll\CryptCATAllocSortedMemberInfo", HANDLE, hCatalog, "ptr", pwszReferenceTag, CRYPTCATMEMBER.Ptr)
    return result
}
 ...
 */
export CryptCATFreeSortedMemberInfo(hCatalog, pCatMember) {
    DllCall("WINTRUST.dll\CryptCATFreeSortedMemberInfo", HANDLE, hCatalog, CRYPTCATMEMBER.Ptr, pCatMember)
}
 ...
 * @since windows5.1.2600
 */
export CryptCATGetAttrInfo(hCatalog, pCatMember, pwszReferenceTag) {
    pwszReferenceTag := pwszReferenceTag is String ? StrPtr(pwszReferenceTag) : pwszReferenceTag

    A_LastError := 0

    result := DllCall("WINTRUST.dll\CryptCATGetAttrInfo", HANDLE, hCatalog, CRYPTCATMEMBER.Ptr, pCatMember, "ptr", pwszReferenceTag, CRYPTCATATTRIBUTE.Ptr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATPutMemberInfo(hCatalog, pwszFileName, pwszReferenceTag, pgSubjectType, dwCertVersion, cbSIPIndirectData, pbSIPIndirectData) {
    pwszFileName := pwszFileName is String ? StrPtr(pwszFileName) : pwszFileName
    pwszReferenceTag := pwszReferenceTag is String ? StrPtr(pwszReferenceTag) : pwszReferenceTag
    ...
    result := DllCall("WINTRUST.dll\CryptCATPutMemberInfo", HANDLE, hCatalog, "ptr", pwszFileName, "ptr", pwszReferenceTag, Guid.Ptr, pgSubjectType, "uint", dwCertVersion, "uint", cbSIPIndirectData, pbSIPIndirectDataMarshal, pbSIPIndirectData, CRYPTCATMEMBER.Ptr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export CryptCATPutAttrInfo(hCatalog, pCatMember, pwszReferenceTag, dwAttrTypeAndAction, cbData, pbData) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATPutAttrInfo", HANDLE, hCatalog, CRYPTCATMEMBER.Ptr, pCatMember, "ptr", pwszReferenceTag, "uint", dwAttrTypeAndAction, "uint", cbData, pbDataMarshal, pbData, CRYPTCATATTRIBUTE.Ptr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATEnumerateMember(hCatalog, pPrevMember) {
    result := DllCall("WINTRUST.dll\CryptCATEnumerateMember", HANDLE, hCatalog, CRYPTCATMEMBER.Ptr, pPrevMember, CRYPTCATMEMBER.Ptr)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATEnumerateAttr(hCatalog, pCatMember, pPrevAttr) {
    result := DllCall("WINTRUST.dll\CryptCATEnumerateAttr", HANDLE, hCatalog, CRYPTCATMEMBER.Ptr, pCatMember, CRYPTCATATTRIBUTE.Ptr, pPrevAttr, CRYPTCATATTRIBUTE.Ptr)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATCDFClose(pCDF) {
    result := DllCall("WINTRUST.dll\CryptCATCDFClose", CRYPTCATCDF.Ptr, pCDF, BOOL)
    return result
}
...
export CryptCATAdminAcquireContext(phCatAdmin, pgSubsystem) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminAcquireContext", phCatAdminMarshal, phCatAdmin, Guid.Ptr, pgSubsystem, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows8.0
 */
export CryptCATAdminAcquireContext2(phCatAdmin, pgSubsystem, pwszHashAlgorithm, pStrongHashPolicy) {
    static dwFlags := 0 ;Reserved parameters must always be NULL
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminAcquireContext2", phCatAdminMarshal, phCatAdmin, Guid.Ptr, pgSubsystem, "ptr", pwszHashAlgorithm, CERT_STRONG_SIGN_PARA.Ptr, pStrongHashPolicy, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATAdminReleaseContext(hCatAdmin, dwFlags) {
    result := DllCall("WINTRUST.dll\CryptCATAdminReleaseContext", "ptr", hCatAdmin, "uint", dwFlags, BOOL)
    return result
}
 ...
 * @since windows5.1.2600
 */
export CryptCATAdminReleaseCatalogContext(hCatAdmin, hCatInfo, dwFlags) {
    result := DllCall("WINTRUST.dll\CryptCATAdminReleaseCatalogContext", "ptr", hCatAdmin, "ptr", hCatInfo, "uint", dwFlags, BOOL)
    return result
}
...
export CryptCATAdminEnumCatalogFromHash(hCatAdmin, pbHash, cbHash, phPrevCatInfo) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminEnumCatalogFromHash", "ptr", hCatAdmin, "ptr", pbHash, "uint", cbHash, "uint", dwFlags, phPrevCatInfoMarshal, phPrevCatInfo, IntPtr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export CryptCATAdminCalcHashFromFileHandle(hFile, pcbHash, pbHash) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminCalcHashFromFileHandle", HANDLE, hFile, pcbHashMarshal, pcbHash, "ptr", pbHash, "uint", dwFlags, BOOL)
    return result
}
...
export CryptCATAdminCalcHashFromFileHandle2(hCatAdmin, hFile, pcbHash, pbHash) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminCalcHashFromFileHandle2", "ptr", hCatAdmin, HANDLE, hFile, pcbHashMarshal, pcbHash, "ptr", pbHash, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATAdminAddCatalog(hCatAdmin, pwszCatalogFile, pwszSelectBaseName, dwFlags) {
    ...
    result := DllCall("WINTRUST.dll\CryptCATAdminAddCatalog", "ptr", hCatAdmin, "ptr", pwszCatalogFile, "ptr", pwszSelectBaseName, "uint", dwFlags, IntPtr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATAdminRemoveCatalog(hCatAdmin, pwszCatalogFile, dwFlags) {
    pwszCatalogFile := pwszCatalogFile is String ? StrPtr(pwszCatalogFile) : pwszCatalogFile

    A_LastError := 0

    result := DllCall("WINTRUST.dll\CryptCATAdminRemoveCatalog", "ptr", hCatAdmin, "ptr", pwszCatalogFile, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATCatalogInfoFromContext(hCatInfo, psCatInfo, dwFlags) {
    A_LastError := 0

    result := DllCall("WINTRUST.dll\CryptCATCatalogInfoFromContext", "ptr", hCatInfo, CATALOG_INFO.Ptr, psCatInfo, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.1.2600
 */
export CryptCATAdminResolveCatalogPath(hCatAdmin, pwszCatalogFile, psCatInfo, dwFlags) {
    pwszCatalogFile := pwszCatalogFile is String ? StrPtr(pwszCatalogFile) : pwszCatalogFile

    A_LastError := 0

    result := DllCall("WINTRUST.dll\CryptCATAdminResolveCatalogPath", "ptr", hCatAdmin, "ptr", pwszCatalogFile, CATALOG_INFO.Ptr, psCatInfo, "uint", dwFlags, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @returns {BOOL} 
 */
export CryptCATAdminPauseServiceForBackup(dwFlags, fResume) {
    result := DllCall("WINTRUST.dll\CryptCATAdminPauseServiceForBackup", "uint", dwFlags, BOOL, fResume, BOOL)
    return result
}
 ...
 * @param {PWSTR} pwszPrevCDFTag A pointer to a **null**-terminated string that identifies the catalog file member.
 * @param {Pointer<PFN_CDF_PARSE_ERROR_CALLBACK>} pfnParseError A pointer to a user-defined function to handle file parse errors.
 * @param {Pointer<Pointer<CRYPTCATMEMBER>>} ppMember A pointer to a [**CRYPTCATMEMBER**](/windows/win32/api/mscat/ns-mscat-cryptcatmember) structure that contains the file member information.
 ...
 * @param {Pointer<CRYPTCATCDF>} pCDF A pointer to a [**CRYPTCATCDF**](/windows/win32/api/mscat/ns-mscat-cryptcatcdf) structure.
 * @param {PWSTR} pwszMemberTag A pointer to a **null**-terminated string that identifies the catalog file member.
