...
#Include .\PFN_CDF_PARSE_ERROR_CALLBACK.ahk
...
;@region Methods
    ...
    static CryptCATAdminCalcHashFromFileHandle(hFile, pcbHash, pbHash) {
        ...
        result := DllCall("WINTRUST.dll\CryptCATAdminCalcHashFromFileHandle", "ptr", hFile, pcbHashMarshal, pcbHash, "ptr", pbHash, "uint", dwFlags, "int")
        return result
    }
