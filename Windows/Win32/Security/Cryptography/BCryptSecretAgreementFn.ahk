 ...
 * @version v4.0.30319
 */
class BCryptSecretAgreementFn extends IUnknown {
     ...
     */
    Invoke(hPrivKey, hPubKey, phAgreedSecret, dwFlags) {
        hPrivKey := hPrivKey is Win32Handle ? NumGet(hPrivKey, "ptr") : hPrivKey
        hPubKey := hPubKey is Win32Handle ? NumGet(hPubKey, "ptr") : hPubKey

        result := ComCall(3, this, "ptr", hPrivKey, "ptr", hPubKey, "ptr", phAgreedSecret, "uint", dwFlags, "int")
        return result
    }
}
