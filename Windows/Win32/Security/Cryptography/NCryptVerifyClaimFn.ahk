 ...
 * @version v4.0.30319
 */
class NCryptVerifyClaimFn extends IUnknown {
    ...
    Invoke(hProv, hSubjectKey, hAuthorityKey, dwClaimType, pParameterList, pbClaimBlob, cbClaimBlob, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProv, "ptr", hSubjectKey, "ptr", hAuthorityKey, "uint", dwClaimType, "ptr", pParameterList, "ptr", pbClaimBlob, "uint", cbClaimBlob, "ptr", pOutput, "uint", dwFlags, "int")
        if(result != 0) {
