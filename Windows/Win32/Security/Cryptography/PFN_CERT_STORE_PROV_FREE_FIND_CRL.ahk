 ...
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_FREE_FIND_CRL extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pCrlContext, pvStoreProvFindInfo, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pCrlContext, pvStoreProvFindInfoMarshal, pvStoreProvFindInfo, "uint", dwFlags, "int")
        return result
    }
}
