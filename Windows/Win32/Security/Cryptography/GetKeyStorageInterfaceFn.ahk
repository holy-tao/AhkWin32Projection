 ...
 * @version v4.0.30319
 */
class GetKeyStorageInterfaceFn extends IUnknown {
     ...
     */
    Invoke(pszProviderName, ppFunctionTable, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pszProviderName, ppFunctionTableMarshal, ppFunctionTable, "uint", dwFlags, "int")
        return result
    }
}
