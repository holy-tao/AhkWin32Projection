 ...
 * @version v4.0.30319
 */
class NCryptSetProviderPropertyFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, pszProperty, pbInput, cbInput, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", pszProperty, "ptr", pbInput, "uint", cbInput, "uint", dwFlags, "int")
        if(result != 0) {
