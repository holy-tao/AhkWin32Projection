 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincrypt/nc-wincrypt-pfn_cert_store_prov_delete_cert
 * @namespace Windows.Win32.Security.Cryptography
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_DELETE_CERT extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pCertContext, dwFlags) {
        hStoreProv := hStoreProv is Win32Handle ? NumGet(hStoreProv, "ptr") : hStoreProv

        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pCertContext, "uint", dwFlags, "int")
        return result
    }
}
