 ...
 * @version v4.0.30319
 */
class pCryptSIPGetSignedDataMsg extends IUnknown {
     ...
     */
    Invoke(pSubjectInfo, pdwEncodingType, dwIndex, pcbSignedDataMsg, pbSignedDataMsg) {
        ...
        result := ComCall(3, this, "ptr", pSubjectInfo, pdwEncodingTypeMarshal, pdwEncodingType, "uint", dwIndex, pcbSignedDataMsgMarshal, pcbSignedDataMsg, pbSignedDataMsgMarshal, pbSignedDataMsg, "int")
        return result
    }
}
