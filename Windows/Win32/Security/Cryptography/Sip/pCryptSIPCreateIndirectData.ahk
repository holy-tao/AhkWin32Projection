 ...
 * @version v4.0.30319
 */
class pCryptSIPCreateIndirectData extends IUnknown {
     ...
     */
    Invoke(pSubjectInfo, pcbIndirectData, pIndirectData) {
        pcbIndirectDataMarshal := pcbIndirectData is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", pSubjectInfo, pcbIndirectDataMarshal, pcbIndirectData, "ptr", pIndirectData, "int")
        return result
    }
}
