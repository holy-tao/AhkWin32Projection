 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nn-casetup-icertsrvsetupkeyinformation
...
class ICertSrvSetupKeyInformation extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_providername
     */
    get_ProviderName() {
        pVal := BSTR()
     ...
     * @param {BSTR} bstrVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_providername
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_length
     */
    get_Length() {
     ...
     * @param {Integer} lVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_length
     */
    put_Length(lVal) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_existing
     */
    get_Existing() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_existing
     */
    put_Existing(bVal) {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_containername
     */
    get_ContainerName() {
        pVal := BSTR()
     ...
     * @param {BSTR} bstrVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_containername
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_hashalgorithm
     */
    get_HashAlgorithm() {
        pVal := BSTR()
     ...
     * @param {BSTR} bstrVal 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_hashalgorithm
     */
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-get_existingcacertificate
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/casetup/nf-casetup-icertsrvsetupkeyinformation-put_existingcacertificate
     */
