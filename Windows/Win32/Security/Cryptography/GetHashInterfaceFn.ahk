 ...
 */
export default struct GetHashInterfaceFn {
    value : IntPtr

    __value {
        set {
            if (value is GetHashInterfaceFn) {
    ...
    /**
     * A GetHashInterfaceFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends GetHashInterfaceFn {
        /**
         * Creates a GetHashInterfaceFn pointer that invokes the given AHK function when called.
