 ...
 * @version v4.0.30319
 */
class SslVerifySignatureFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hPublicKey, pbHashValue, cbHashValue, pbSignature, cbSignature, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hPublicKey, "ptr", pbHashValue, "uint", cbHashValue, "ptr", pbSignature, "uint", cbSignature, "uint", dwFlags, "int")
        if(result != 0) {
