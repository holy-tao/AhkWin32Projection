 ...
 * @version v4.0.30319
 */
class BCryptEncryptFn extends IUnknown {
     ...
     */
    Invoke(hKey_, pbInput, cbInput, pPaddingInfo, pbIV, cbIV, pbOutput, cbOutput, pcbResult, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "ptr", pbInput, "uint", cbInput, pPaddingInfoMarshal, pPaddingInfo, "ptr", pbIV, "uint", cbIV, "ptr", pbOutput, "uint", cbOutput, pcbResultMarshal, pcbResult, "uint", dwFlags, "int")
        return result
    }
}
