 ...
 */
export default struct BCryptEncryptFn {
    value : IntPtr

    __value {
        set {
            if (value is BCryptEncryptFn) {
    ...
    /**
     * A BCryptEncryptFn that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends BCryptEncryptFn {
        /**
         * Creates a BCryptEncryptFn pointer that invokes the given AHK function when called.
