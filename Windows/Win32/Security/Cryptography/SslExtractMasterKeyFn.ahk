 ...
 * @version v4.0.30319
 */
class SslExtractMasterKeyFn extends IUnknown {
     ...
     */
    Invoke(hSslProvider, hHandshakeKey, pParameterList, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hSslProvider, "ptr", hHandshakeKey, "ptr", phMasterKey, "ptr", pParameterList, "uint", dwFlags, "int")
        if(result != 0) {
