 ...
 * @version v4.0.30319
 */
class PFN_CSP_PAD_DATA extends IUnknown {
     ...
     */
    Invoke(pSigningInfo, cbMaxWidth, pcbPaddedBuffer, ppbPaddedBuffer) {
        pcbPaddedBufferMarshal := pcbPaddedBuffer is VarRef ? "uint*" : "ptr"
        ppbPaddedBufferMarshal := ppbPaddedBuffer is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", pSigningInfo, "uint", cbMaxWidth, pcbPaddedBufferMarshal, pcbPaddedBuffer, ppbPaddedBufferMarshal, ppbPaddedBuffer, "uint")
        return result
    }
}
