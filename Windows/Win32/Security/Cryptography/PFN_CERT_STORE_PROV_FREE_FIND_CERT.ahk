 ...
 * @version v4.0.30319
 */
class PFN_CERT_STORE_PROV_FREE_FIND_CERT extends IUnknown {
     ...
     */
    Invoke(hStoreProv, pCertContext, pvStoreProvFindInfo, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hStoreProv, "ptr", pCertContext, pvStoreProvFindInfoMarshal, pvStoreProvFindInfo, "uint", dwFlags, "int")
        return result
    }
}
