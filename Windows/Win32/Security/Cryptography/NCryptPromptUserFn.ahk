 ...
 * @version v4.0.30319
 */
class NCryptPromptUserFn extends IUnknown {
     ...
     */
    Invoke(hProvider_, hKey_, pszOperation, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hProvider_, "ptr", hKey_, "ptr", pszOperation, "uint", dwFlags, "int")
        if(result != 0) {
