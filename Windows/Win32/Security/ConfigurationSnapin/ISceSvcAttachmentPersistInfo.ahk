 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/scesvc/nn-scesvc-iscesvcattachmentpersistinfo
...
class ISceSvcAttachmentPersistInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/scesvc/nf-scesvc-iscesvcattachmentpersistinfo-save
     */
    Save(lpTemplateName, scesvcHandle, ppvData, pbOverwriteAll) {
        ...
        result := ComCall(3, this, lpTemplateNameMarshal, lpTemplateName, scesvcHandleMarshal, scesvcHandle, ppvDataMarshal, ppvData, pbOverwriteAllMarshal, pbOverwriteAll, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} The return value is an HRESULT. A value of S_OK indicates the method was successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/scesvc/nf-scesvc-iscesvcattachmentpersistinfo-isdirty
     */
     ...
     * @returns {HRESULT} The return value is an HRESULT. A value of S_OK indicates the method was successful.
     * @see https://learn.microsoft.com/windows/win32/api//content/scesvc/nf-scesvc-iscesvcattachmentpersistinfo-freebuffer
     */
    FreeBuffer(pvData) {
