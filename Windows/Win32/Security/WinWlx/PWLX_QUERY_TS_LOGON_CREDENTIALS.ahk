 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winwlx/nc-winwlx-pwlx_query_ts_logon_credentials
 * @namespace Windows.Win32.Security.WinWlx
 * @version v4.0.30319
 */
class PWLX_QUERY_TS_LOGON_CREDENTIALS extends IUnknown {
     ...
     * @param {Pointer<WLX_CLIENT_CREDENTIALS_INFO_V2_0>} pCred 
