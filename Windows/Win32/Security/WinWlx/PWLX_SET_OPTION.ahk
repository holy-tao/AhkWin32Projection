 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winwlx/nc-winwlx-pwlx_set_option
 * @namespace Windows.Win32.Security.WinWlx
 * @version v4.0.30319
 */
class PWLX_SET_OPTION extends IUnknown {
     ...
     * @param {Pointer} Value 
     * @param {Pointer<Pointer>} OldValue 
     ...
     */
    Invoke(hWlx, Option, Value, OldValue) {
        hWlx := hWlx is Win32Handle ? NumGet(hWlx, "ptr") : hWlx

        OldValueMarshal := OldValue is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", hWlx, "uint", Option, "ptr", Value, OldValueMarshal, OldValue, "int")
        return result
    }
}
