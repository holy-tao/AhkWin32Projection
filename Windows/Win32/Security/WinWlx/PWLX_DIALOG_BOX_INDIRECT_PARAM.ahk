 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winwlx/nc-winwlx-pwlx_dialog_box_indirect_param
 * @namespace Windows.Win32.Security.WinWlx
 * @version v4.0.30319
 */
class PWLX_DIALOG_BOX_INDIRECT_PARAM extends IUnknown {
     ...
     */
    Invoke(hWlx, hInst, hDialogTemplate, hwndOwner, dlgprc, dwInitParam) {
        ...
        result := ComCall(3, this, "ptr", hWlx, "ptr", hInst, "ptr", hDialogTemplate, "ptr", hwndOwner, "ptr", dlgprc, "ptr", dwInitParam, "int")
        return result
    }
}
