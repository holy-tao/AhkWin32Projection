 ...
 * @see https://learn.microsoft.com/windows/win32/api/winwlx/nc-winwlx-pwlx_switch_desktop_to_user
 * @namespace Windows.Win32.Security.WinWlx
 */
export default struct PWLX_SWITCH_DESKTOP_TO_USER {
    value : IntPtr

    __value {
        set {
            if (value is PWLX_SWITCH_DESKTOP_TO_USER) {
    ...
    /**
     * A PWLX_SWITCH_DESKTOP_TO_USER that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PWLX_SWITCH_DESKTOP_TO_USER {
        /**
         * Creates a PWLX_SWITCH_DESKTOP_TO_USER pointer that invokes the given AHK function when called.
