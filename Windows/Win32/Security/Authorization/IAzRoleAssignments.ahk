 ...
 * @see https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazroleassignments
 * @namespace Windows.Win32.Security.Authorization
 */
export default struct IAzRoleAssignments extends IDispatch {
    /**
     ...
     * used for IAzRoleAssignments interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAzRoleAssignments.Vtbl()
        }
    ...
    _Query(iid) {
        if (IAzRoleAssignments.IID.Equals(iid)) {
            return true
        }
