...
export default struct IAzScope extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_CanBeDelegated := CallbackCreate(ObjBindMethod(implObj, "get_CanBeDelegated"), flags, 2)
        this.vtbl.get_BizrulesWritable := CallbackCreate(ObjBindMethod(implObj, "get_BizrulesWritable"), flags, 2)
