 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazclientcontext2
...
class IAzClientContext2 extends IAzClientContext{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-getassignedscopespage
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-addroles
     */
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-addapplicationgroups
     */
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-addstringsids
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-put_ldapquerydn
     */
    put_LDAPQueryDN(bstrLDAPQueryDN) {
        if(bstrLDAPQueryDN is String) {
            pin := BSTR.Alloc(bstrLDAPQueryDN)
            bstrLDAPQueryDN := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazclientcontext2-get_ldapquerydn
     */
    get_LDAPQueryDN() {
