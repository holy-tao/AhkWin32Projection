 ...
 * @see https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazscopes
 * @namespace Windows.Win32.Security.Authorization
 */
export default struct IAzScopes extends IDispatch {
    /**
    ...
    */
     ...
     * @param {Integer} Index 
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api/azroles/nf-azroles-iazscopes-get_item
     */
    get_Item(Index) {
        pvarObtPtr := VARIANT()
        result := ComCall(7, this, Int32, Index, VARIANT.Ptr, pvarObtPtr, "HRESULT")
        return pvarObtPtr
    }
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api/azroles/nf-azroles-iazscopes-get__newenum
     */
    get__NewEnum() {
