...
class IAzApplication2 extends IAzApplication{
    ...
    InitializeClientContextFromToken2(ulTokenHandleLowPart, ulTokenHandleHighPart, varReserved, ppClientContext) {
        result := ComCall(68, this, "uint", ulTokenHandleLowPart, "uint", ulTokenHandleHighPart, "ptr", varReserved, "ptr", ppClientContext, "int")
        if(result != 0)
    ...
    InitializeClientContext2(IdentifyingString, varReserved, ppClientContext) {
        ...
        result := ComCall(69, this, "ptr", IdentifyingString, "ptr", varReserved, "ptr", ppClientContext, "int")
        if(result != 0)
            throw OSError(result)
