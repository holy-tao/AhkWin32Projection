 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazapplication2
...
class IAzApplication2 extends IAzApplication{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazapplication2-initializeclientcontextfromtoken2
     */
    InitializeClientContextFromToken2(ulTokenHandleLowPart, ulTokenHandleHighPart, varReserved) {
        result := ComCall(68, this, "uint", ulTokenHandleLowPart, "uint", ulTokenHandleHighPart, "ptr", varReserved, "ptr*", &ppClientContext := 0, "int")
        if(result != 0) {
     ...
     * @param {VARIANT} varReserved Reserved for future use.
     * @returns {IAzClientContext2} A pointer to a pointer to the returned <a href="https://docs.microsoft.com/windows/desktop/api/azroles/nn-azroles-iazclientcontext2">IAzClientContext2</a> object.
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazapplication2-initializeclientcontext2
     */
    InitializeClientContext2(IdentifyingString, varReserved) {
        if(IdentifyingString is String) {
            pin := BSTR.Alloc(IdentifyingString)
            IdentifyingString := pin.Value
        }

        result := ComCall(69, this, "ptr", IdentifyingString, "ptr", varReserved, "ptr*", &ppClientContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
