 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazoperation2
...
class IAzOperation2 extends IAzOperation{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazoperation2-roleassignments
     */
    RoleAssignments(bstrScopeName, bRecursive) {
        ...
        result := ComCall(19, this, "ptr", bstrScopeName, "short", bRecursive, "ptr*", &ppRoleAssignments := 0, "int")
        if(result != 0) {
