 ...
 * @see https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iaztasks
 * @namespace Windows.Win32.Security.Authorization
 */
export default struct IAzTasks extends IDispatch {
    /**
