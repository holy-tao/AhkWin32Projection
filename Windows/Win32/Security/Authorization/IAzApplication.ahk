 ...
 */
export default struct IAzApplication extends IDispatch {
    /**
     ...
     * used for IAzApplication interfaces
    */
    struct Vtbl extends IDispatch.Vtbl {
        ...
        get_AuthzInterfaceClsid              : IntPtr
        put_AuthzInterfaceClsid              : IntPtr
        get_Version                          : IntPtr
        put_Version                          : IntPtr
        ...
        OpenOperation                        : IntPtr
        CreateOperation                      : IntPtr
    ...
    put_AuthzInterfaceClsid(bstrProp) {
        ...
        result := ComCall(14, this, BSTR, bstrProp, "HRESULT")
        return result
    }
    ...
    put_Version(bstrProp) {
        ...
        result := ComCall(16, this, BSTR, bstrProp, "HRESULT")
        return result
    }
     ...
     */
    get_ApplyStoreSacl() {
        result := ComCall(19, this, BOOL.Ptr, &pbProp := 0, "HRESULT")
        return pbProp
    }
    ...
    put_ApplyStoreSacl(bProp) {
        result := ComCall(20, this, BOOL, bProp, "HRESULT")
        return result
    }
    ...
    OpenScope(bstrScopeName, varReserved) {
        ...
        result := ComCall(31, this, BSTR, bstrScopeName, VARIANT, varReserved, "ptr*", &ppScope := 0, "HRESULT")
    ...
    CreateScope(bstrScopeName, varReserved) {
        ...
        result := ComCall(32, this, BSTR, bstrScopeName, VARIANT, varReserved, "ptr*", &ppScope := 0, "HRESULT")
        return IAzScope(ppScope)
    }
    ...
    DeleteScope(bstrScopeName, varReserved) {
        ...
        result := ComCall(33, this, BSTR, bstrScopeName, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    OpenOperation(bstrOperationName, varReserved) {
        ...
        result := ComCall(35, this, BSTR, bstrOperationName, VARIANT, varReserved, "ptr*", &ppOperation := 0, "HRESULT")
    ...
    CreateOperation(bstrOperationName, varReserved) {
        ...
        result := ComCall(36, this, BSTR, bstrOperationName, VARIANT, varReserved, "ptr*", &ppOperation := 0, "HRESULT")
        return IAzOperation(ppOperation)
    }
    ...
    DeleteOperation(bstrOperationName, varReserved) {
        ...
        result := ComCall(37, this, BSTR, bstrOperationName, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    OpenTask(bstrTaskName, varReserved) {
        ...
        result := ComCall(39, this, BSTR, bstrTaskName, VARIANT, varReserved, "ptr*", &ppTask := 0, "HRESULT")
    ...
    CreateTask(bstrTaskName, varReserved) {
        ...
        result := ComCall(40, this, BSTR, bstrTaskName, VARIANT, varReserved, "ptr*", &ppTask := 0, "HRESULT")
        return IAzTask(ppTask)
    }
    ...
    DeleteTask(bstrTaskName, varReserved) {
        ...
        result := ComCall(41, this, BSTR, bstrTaskName, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    OpenApplicationGroup(bstrGroupName, varReserved) {
        ...
        result := ComCall(43, this, BSTR, bstrGroupName, VARIANT, varReserved, "ptr*", &ppGroup := 0, "HRESULT")
    ...
    CreateApplicationGroup(bstrGroupName, varReserved) {
        ...
        result := ComCall(44, this, BSTR, bstrGroupName, VARIANT, varReserved, "ptr*", &ppGroup := 0, "HRESULT")
        return IAzApplicationGroup(ppGroup)
    }
    ...
    DeleteApplicationGroup(bstrGroupName, varReserved) {
        ...
        result := ComCall(45, this, BSTR, bstrGroupName, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    OpenRole(bstrRoleName, varReserved) {
        ...
        result := ComCall(47, this, BSTR, bstrRoleName, VARIANT, varReserved, "ptr*", &ppRole := 0, "HRESULT")
    ...
    CreateRole(bstrRoleName, varReserved) {
        ...
        result := ComCall(48, this, BSTR, bstrRoleName, VARIANT, varReserved, "ptr*", &ppRole := 0, "HRESULT")
        return IAzRole(ppRole)
    }
    ...
    DeleteRole(bstrRoleName, varReserved) {
        ...
        result := ComCall(49, this, BSTR, bstrRoleName, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    InitializeClientContextFromName(ClientName, DomainName, varReserved) {
        ...
        result := ComCall(54, this, BSTR, ClientName, BSTR, DomainName, VARIANT, varReserved, "ptr*", &ppClientContext := 0, "HRESULT")
        return IAzClientContext(ppClientContext)
    }
    ...
    get_DelegatedPolicyUsers() {
        ...
        result := ComCall(55, this, VARIANT.Ptr, pvarDelegatedPolicyUsers, "HRESULT")
    ...
    DeleteDelegatedPolicyUser(bstrDelegatedPolicyUser, varReserved) {
        ...
        result := ComCall(57, this, BSTR, bstrDelegatedPolicyUser, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    get_PolicyAdministratorsName() {
        pvarAdmins := VARIANT()
        result := ComCall(59, this, VARIANT.Ptr, pvarAdmins, "HRESULT")
        return pvarAdmins
    }
    ...
    get_PolicyReadersName() {
        pvarReaders := VARIANT()
        result := ComCall(60, this, VARIANT.Ptr, pvarReaders, "HRESULT")
        return pvarReaders
    }
    ...
    AddPolicyAdministratorName(bstrAdmin, varReserved) {
        ...
        result := ComCall(61, this, BSTR, bstrAdmin, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    DeletePolicyAdministratorName(bstrAdmin, varReserved) {
        ...
        result := ComCall(62, this, BSTR, bstrAdmin, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    AddPolicyReaderName(bstrReader, varReserved) {
        ...
        result := ComCall(63, this, BSTR, bstrReader, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    DeletePolicyReaderName(bstrReader, varReserved) {
        ...
        result := ComCall(64, this, BSTR, bstrReader, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    get_DelegatedPolicyUsersName() {
        pvarDelegatedPolicyUsers := VARIANT()
        result := ComCall(65, this, VARIANT.Ptr, pvarDelegatedPolicyUsers, "HRESULT")
        return pvarDelegatedPolicyUsers
    }
    ...
    AddDelegatedPolicyUserName(bstrDelegatedPolicyUser, varReserved) {
        ...
        result := ComCall(66, this, BSTR, bstrDelegatedPolicyUser, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    DeleteDelegatedPolicyUserName(bstrDelegatedPolicyUser, varReserved) {
        ...
        result := ComCall(67, this, BSTR, bstrDelegatedPolicyUser, VARIANT, varReserved, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AuthzInterfaceClsid := CallbackCreate(ObjBindMethod(implObj, "get_AuthzInterfaceClsid"), flags, 2)
        this.vtbl.put_AuthzInterfaceClsid := CallbackCreate(ObjBindMethod(implObj, "put_AuthzInterfaceClsid"), flags, 2)
        ...
        this.vtbl.get_GenerateAudits := CallbackCreate(ObjBindMethod(implObj, "get_GenerateAudits"), flags, 2)
        this.vtbl.put_GenerateAudits := CallbackCreate(ObjBindMethod(implObj, "put_GenerateAudits"), flags, 2)
        this.vtbl.get_ApplyStoreSacl := CallbackCreate(ObjBindMethod(implObj, "get_ApplyStoreSacl"), flags, 2)
        this.vtbl.put_ApplyStoreSacl := CallbackCreate(ObjBindMethod(implObj, "put_ApplyStoreSacl"), flags, 2)
        ...
        this.vtbl.get_PolicyAdministrators := CallbackCreate(ObjBindMethod(implObj, "get_PolicyAdministrators"), flags, 2)
        this.vtbl.get_PolicyReaders := CallbackCreate(ObjBindMethod(implObj, "get_PolicyReaders"), flags, 2)
        this.vtbl.AddPolicyAdministrator := CallbackCreate(ObjBindMethod(implObj, "AddPolicyAdministrator"), flags, 3)
        this.vtbl.DeletePolicyAdministrator := CallbackCreate(ObjBindMethod(implObj, "DeletePolicyAdministrator"), flags, 3)
        this.vtbl.AddPolicyReader := CallbackCreate(ObjBindMethod(implObj, "AddPolicyReader"), flags, 3)
        this.vtbl.DeletePolicyReader := CallbackCreate(ObjBindMethod(implObj, "DeletePolicyReader"), flags, 3)
        this.vtbl.get_Scopes := CallbackCreate(ObjBindMethod(implObj, "get_Scopes"), flags, 2)
        this.vtbl.OpenScope := CallbackCreate(ObjBindMethod(implObj, "OpenScope"), flags, 4)
        this.vtbl.CreateScope := CallbackCreate(ObjBindMethod(implObj, "CreateScope"), flags, 4)
        this.vtbl.DeleteScope := CallbackCreate(ObjBindMethod(implObj, "DeleteScope"), flags, 3)
        this.vtbl.get_Operations := CallbackCreate(ObjBindMethod(implObj, "get_Operations"), flags, 2)
        this.vtbl.OpenOperation := CallbackCreate(ObjBindMethod(implObj, "OpenOperation"), flags, 4)
        this.vtbl.CreateOperation := CallbackCreate(ObjBindMethod(implObj, "CreateOperation"), flags, 4)
        this.vtbl.DeleteOperation := CallbackCreate(ObjBindMethod(implObj, "DeleteOperation"), flags, 3)
        this.vtbl.get_Tasks := CallbackCreate(ObjBindMethod(implObj, "get_Tasks"), flags, 2)
        this.vtbl.OpenTask := CallbackCreate(ObjBindMethod(implObj, "OpenTask"), flags, 4)
        this.vtbl.CreateTask := CallbackCreate(ObjBindMethod(implObj, "CreateTask"), flags, 4)
        this.vtbl.DeleteTask := CallbackCreate(ObjBindMethod(implObj, "DeleteTask"), flags, 3)
        this.vtbl.get_ApplicationGroups := CallbackCreate(ObjBindMethod(implObj, "get_ApplicationGroups"), flags, 2)
        this.vtbl.OpenApplicationGroup := CallbackCreate(ObjBindMethod(implObj, "OpenApplicationGroup"), flags, 4)
        this.vtbl.CreateApplicationGroup := CallbackCreate(ObjBindMethod(implObj, "CreateApplicationGroup"), flags, 4)
        this.vtbl.DeleteApplicationGroup := CallbackCreate(ObjBindMethod(implObj, "DeleteApplicationGroup"), flags, 3)
        this.vtbl.get_Roles := CallbackCreate(ObjBindMethod(implObj, "get_Roles"), flags, 2)
        this.vtbl.OpenRole := CallbackCreate(ObjBindMethod(implObj, "OpenRole"), flags, 4)
        this.vtbl.CreateRole := CallbackCreate(ObjBindMethod(implObj, "CreateRole"), flags, 4)
        this.vtbl.DeleteRole := CallbackCreate(ObjBindMethod(implObj, "DeleteRole"), flags, 3)
        this.vtbl.InitializeClientContextFromToken := CallbackCreate(ObjBindMethod(implObj, "InitializeClientContextFromToken"), flags, 4)
        this.vtbl.AddPropertyItem := CallbackCreate(ObjBindMethod(implObj, "AddPropertyItem"), flags, 4)
        this.vtbl.DeletePropertyItem := CallbackCreate(ObjBindMethod(implObj, "DeletePropertyItem"), flags, 4)
        this.vtbl.Submit := CallbackCreate(ObjBindMethod(implObj, "Submit"), flags, 3)
        this.vtbl.InitializeClientContextFromName := CallbackCreate(ObjBindMethod(implObj, "InitializeClientContextFromName"), flags, 5)
        this.vtbl.get_DelegatedPolicyUsers := CallbackCreate(ObjBindMethod(implObj, "get_DelegatedPolicyUsers"), flags, 2)
        this.vtbl.AddDelegatedPolicyUser := CallbackCreate(ObjBindMethod(implObj, "AddDelegatedPolicyUser"), flags, 3)
        this.vtbl.DeleteDelegatedPolicyUser := CallbackCreate(ObjBindMethod(implObj, "DeleteDelegatedPolicyUser"), flags, 3)
        this.vtbl.InitializeClientContextFromStringSid := CallbackCreate(ObjBindMethod(implObj, "InitializeClientContextFromStringSid"), flags, 5)
        this.vtbl.get_PolicyAdministratorsName := CallbackCreate(ObjBindMethod(implObj, "get_PolicyAdministratorsName"), flags, 2)
        this.vtbl.get_PolicyReadersName := CallbackCreate(ObjBindMethod(implObj, "get_PolicyReadersName"), flags, 2)
        this.vtbl.AddPolicyAdministratorName := CallbackCreate(ObjBindMethod(implObj, "AddPolicyAdministratorName"), flags, 3)
        this.vtbl.DeletePolicyAdministratorName := CallbackCreate(ObjBindMethod(implObj, "DeletePolicyAdministratorName"), flags, 3)
        this.vtbl.AddPolicyReaderName := CallbackCreate(ObjBindMethod(implObj, "AddPolicyReaderName"), flags, 3)
        this.vtbl.DeletePolicyReaderName := CallbackCreate(ObjBindMethod(implObj, "DeletePolicyReaderName"), flags, 3)
        this.vtbl.get_DelegatedPolicyUsersName := CallbackCreate(ObjBindMethod(implObj, "get_DelegatedPolicyUsersName"), flags, 2)
        this.vtbl.AddDelegatedPolicyUserName := CallbackCreate(ObjBindMethod(implObj, "AddDelegatedPolicyUserName"), flags, 3)
        this.vtbl.DeleteDelegatedPolicyUserName := CallbackCreate(ObjBindMethod(implObj, "DeleteDelegatedPolicyUserName"), flags, 3)
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.get_AuthzInterfaceClsid)
        CallbackFree(this.vtbl.put_AuthzInterfaceClsid)
        ...
        CallbackFree(this.vtbl.CreateScope)
        CallbackFree(this.vtbl.DeleteScope)
        CallbackFree(this.vtbl.get_Operations)
        CallbackFree(this.vtbl.OpenOperation)
        CallbackFree(this.vtbl.CreateOperation)
        ...
        CallbackFree(this.vtbl.InitializeClientContextFromToken)
        CallbackFree(this.vtbl.AddPropertyItem)
        CallbackFree(this.vtbl.DeletePropertyItem)
        CallbackFree(this.vtbl.Submit)
        CallbackFree(this.vtbl.InitializeClientContextFromName)
        ...
        CallbackFree(this.vtbl.InitializeClientContextFromStringSid)
