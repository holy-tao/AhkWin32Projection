 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazoperations
...
class IAzOperations extends IDispatch{
     ...
     * @param {Integer} Index 
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazoperations-get_item
     */
    get_Item(Index) {
        pvarObtPtr := VARIANT()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazoperations-get_count
     */
    get_Count() {
     ...
     * @returns {IUnknown} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazoperations-get__newenum
     */
    get__NewEnum() {
