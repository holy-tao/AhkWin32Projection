 ...
 * @see https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazoperations
 * @namespace Windows.Win32.Security.Authorization
 */
export default struct IAzOperations extends IDispatch {
    /**
     ...
     * used for IAzOperations interfaces
    */
    ...
    Query(iid) {
        if (IAzOperations.IID.Equals(iid)) {
            return true
        }
