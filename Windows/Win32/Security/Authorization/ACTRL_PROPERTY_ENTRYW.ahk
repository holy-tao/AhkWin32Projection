 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//accctrl/ns-accctrl-actrl_property_entryw
 * @namespace Windows.Win32.Security.Authorization
 * @version v4.0.30319
 * @charset Unicode
 */
class ACTRL_PROPERTY_ENTRYW extends Win32Struct
{
    static sizeof => 24
    ...
    lpProperty{
        get {
            if(!this.HasProp("__lpProperty"))
                this.__lpProperty := PWSTR(this.ptr + 0)
     ...
     * @type {Pointer<ACTRL_ACCESS_ENTRY_LISTW>}
     */
    pAccessEntryList {
