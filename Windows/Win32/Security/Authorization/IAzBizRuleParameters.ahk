 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazbizruleparameters
...
class IAzBizRuleParameters extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-addparameter
     */
    AddParameter(bstrParameterName, varParameterValue) {
        if(bstrParameterName is String) {
            pin := BSTR.Alloc(bstrParameterName)
            bstrParameterName := pin.Value
        }
     ...
     * 
     * If the method fails, it returns an error code. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-addparameters
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-getparametervalue
     */
     ...
     * 
     * If the method fails, it returns an error code. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-remove
     */
    Remove(varParameterName) {
        if(varParameterName is String) {
            pin := BSTR.Alloc(varParameterName)
            varParameterName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-removeall
     */
    RemoveAll() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazbizruleparameters-get_count
     */
    get_Count() {
