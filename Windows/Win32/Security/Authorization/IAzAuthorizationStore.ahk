...
export default struct IAzAuthorizationStore extends IDispatch {
    ...
    */
     ...
     * 
     * If the method fails, it returns an <b>HRESULT</b> value that indicates the error. For a list of common error codes, see <a href="https://docs.microsoft.com/windows/desktop/SecCrypto/common-hresult-values">Common HRESULT Values</a>.
     * @see https://learn.microsoft.com/windows/win32/api/azroles/nf-azroles-iazauthorizationstore-initialize
     */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_DomainTimeout := CallbackCreate(ObjBindMethod(implObj, "get_DomainTimeout"), flags, 2)
        this.vtbl.put_DomainTimeout := CallbackCreate(ObjBindMethod(implObj, "put_DomainTimeout"), flags, 2)
        this.vtbl.get_ScriptEngineTimeout := CallbackCreate(ObjBindMethod(implObj, "get_ScriptEngineTimeout"), flags, 2)
        this.vtbl.put_ScriptEngineTimeout := CallbackCreate(ObjBindMethod(implObj, "put_ScriptEngineTimeout"), flags, 2)
        this.vtbl.get_MaxScriptEngines := CallbackCreate(ObjBindMethod(implObj, "get_MaxScriptEngines"), flags, 2)
        this.vtbl.put_MaxScriptEngines := CallbackCreate(ObjBindMethod(implObj, "put_MaxScriptEngines"), flags, 2)
        ...
        this.vtbl.UpdateCache := CallbackCreate(ObjBindMethod(implObj, "UpdateCache"), flags, 2)
        ...
        this.vtbl.OpenApplication := CallbackCreate(ObjBindMethod(implObj, "OpenApplication"), flags, 4)
        this.vtbl.CreateApplication := CallbackCreate(ObjBindMethod(implObj, "CreateApplication"), flags, 4)
        this.vtbl.DeleteApplication := CallbackCreate(ObjBindMethod(implObj, "DeleteApplication"), flags, 3)
        ...
        this.vtbl.get_TargetMachine := CallbackCreate(ObjBindMethod(implObj, "get_TargetMachine"), flags, 2)
        ...
        this.vtbl.CloseApplication := CallbackCreate(ObjBindMethod(implObj, "CloseApplication"), flags, 3)
    }
