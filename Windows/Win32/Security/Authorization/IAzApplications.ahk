 ...
 * @see https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazapplications
 * @namespace Windows.Win32.Security.Authorization
 */
export default struct IAzApplications extends IDispatch {
    /**
     ...
     * used for IAzApplications interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAzApplications.Vtbl()
        }
    ...
    Query(iid) {
        if (IAzApplications.IID.Equals(iid)) {
            return true
        }
