 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nn-aclui-isecurityobjecttypeinfo
...
class ISecurityObjectTypeInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nf-aclui-isecurityobjecttypeinfo-getinheritsource
     */
    GetInheritSource(si, pACL, ppInheritArray) {
        ppInheritArrayMarshal := ppInheritArray is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "uint", si, "ptr", pACL, ppInheritArrayMarshal, ppInheritArray, "int")
        if(result != 0) {
