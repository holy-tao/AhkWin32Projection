 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nn-aclui-ieffectivepermission2
...
class IEffectivePermission2 extends IUnknown{
     ...
     * @param {PSID} pSid_ A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/winnt/ns-winnt-sid">SID</a> structure that represents the security principal whose effective permission is being determined.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nf-aclui-ieffectivepermission2-computeeffectivepermissionwithsecondarysecurity
     */
    ComputeEffectivePermissionWithSecondarySecurity(pSid_, pDeviceSid, pszServerName, pSecurityObjects, dwSecurityObjectCount, pUserGroups, pAuthzUserGroupsOperations, pDeviceGroups, pAuthzDeviceGroupsOperations, pAuthzUserClaims, pAuthzUserClaimsOperations, pAuthzDeviceClaims, pAuthzDeviceClaimsOperations, pEffpermResultLists) {
