 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nn-aclui-isecurityinformation2
...
class ISecurityInformation2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nf-aclui-isecurityinformation2-isdaclcanonical
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nf-aclui-isecurityinformation2-lookupsids
     */
    LookupSids(cSids, rgpSids) {
        rgpSidsMarshal := rgpSids is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, "uint", cSids, rgpSidsMarshal, rgpSids, "ptr*", &ppdo := 0, "int")
        if(result != 0) {
