...
class IEffectivePermission extends IUnknown{
    ...
    GetEffectivePermission(pguidObjectType, pUserSid, pszServerName, pSD, ppObjectTypeList, pcObjectTypeListLength, ppGrantedAccessList, pcGrantedAccessListLength) {
        ...
        result := ComCall(3, this, "ptr", pguidObjectType, "ptr", pUserSid, "ptr", pszServerName, "ptr", pSD, "ptr*", ppObjectTypeList, "uint*", pcObjectTypeListLength, "ptr*", ppGrantedAccessList, "uint*", pcGrantedAccessListLength, "HRESULT")
        return result
    }
}
