 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nn-aclui-isecurityinformation4
...
class ISecurityInformation4 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/aclui/nf-aclui-isecurityinformation4-getsecondarysecurity
     */
    GetSecondarySecurity(pSecurityObjects, pSecurityObjectCount) {
        ...
        result := ComCall(3, this, pSecurityObjectsMarshal, pSecurityObjects, pSecurityObjectCountMarshal, pSecurityObjectCount, "int")
        if(result != 0) {
