 ...
 * @version v4.0.30319
 */
class PFN_AUTHZ_DYNAMIC_ACCESS_CHECK extends IUnknown {
     ...
     */
    Invoke(hAuthzClientContext, pAce, pArgs, pbAceApplicable) {
        ...
        result := ComCall(3, this, "ptr", hAuthzClientContext, "ptr", pAce, pArgsMarshal, pArgs, pbAceApplicableMarshal, pbAceApplicable, "int")
        return result
    }
}
