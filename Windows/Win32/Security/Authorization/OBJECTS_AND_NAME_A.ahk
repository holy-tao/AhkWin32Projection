 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//accctrl/ns-accctrl-objects_and_name_a
    ...
    ObjectTypeName{
        get {
            if(!this.HasProp("__ObjectTypeName"))
                this.__ObjectTypeName := PSTR(this.ptr + 8)
    ...
    InheritedObjectTypeName{
        get {
            if(!this.HasProp("__InheritedObjectTypeName"))
                this.__InheritedObjectTypeName := PSTR(this.ptr + 16)
    ...
    ptstrName{
        get {
            if(!this.HasProp("__ptstrName"))
                this.__ptstrName := PSTR(this.ptr + 24)
