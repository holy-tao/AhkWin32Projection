...
export default struct IAzApplication3 extends IAzApplication2 {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.ScopeExists := CallbackCreate(ObjBindMethod(implObj, "ScopeExists"), flags, 3)
        this.vtbl.OpenScope2 := CallbackCreate(ObjBindMethod(implObj, "OpenScope2"), flags, 3)
        this.vtbl.CreateScope2 := CallbackCreate(ObjBindMethod(implObj, "CreateScope2"), flags, 3)
        this.vtbl.DeleteScope2 := CallbackCreate(ObjBindMethod(implObj, "DeleteScope2"), flags, 2)
        ...
        this.vtbl.get_BizRulesEnabled := CallbackCreate(ObjBindMethod(implObj, "get_BizRulesEnabled"), flags, 2)
        this.vtbl.put_BizRulesEnabled := CallbackCreate(ObjBindMethod(implObj, "put_BizRulesEnabled"), flags, 2)
    }
