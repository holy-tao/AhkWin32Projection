 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nn-azroles-iazprincipallocator
...
class IAzPrincipalLocator extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazprincipallocator-get_nameresolver
     */
    get_NameResolver() {
        result := ComCall(7, this, "ptr*", &ppNameResolver := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/azroles/nf-azroles-iazprincipallocator-get_objectpicker
     */
    get_ObjectPicker() {
        result := ComCall(8, this, "ptr*", &ppObjectPicker := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
