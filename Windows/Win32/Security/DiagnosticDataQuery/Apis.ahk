 ...
 */
export DdqCreateSession(accessLevel) {
    hSession := HDIAGNOSTIC_DATA_QUERY_SESSION.Owned()
    result := DllCall("DiagnosticDataQuery.dll\DdqCreateSession", DdqAccessLevel, accessLevel, HDIAGNOSTIC_DATA_QUERY_SESSION.Ptr, hSession, "HRESULT")
    return hSession
}
 ...
 * @since windows10.0.19041
 */
export DdqCloseSession(hSession) {
    result := DllCall("DiagnosticDataQuery.dll\DdqCloseSession", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetSessionAccessLevel(hSession) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetSessionAccessLevel", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, "int*", &accessLevel := 0, "HRESULT")
    return accessLevel
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticDataAccessLevelAllowed() {
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordLocaleTags(hSession, locale) {
    locale := locale is String ? StrPtr(locale) : locale

    hTagDescription := HDIAGNOSTIC_EVENT_TAG_DESCRIPTION.Owned()
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordLocaleTags", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, "ptr", locale, HDIAGNOSTIC_EVENT_TAG_DESCRIPTION.Ptr, hTagDescription, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqFreeDiagnosticRecordLocaleTags(hTagDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqFreeDiagnosticRecordLocaleTags", HDIAGNOSTIC_EVENT_TAG_DESCRIPTION, hTagDescription, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordLocaleTagCount(hTagDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordLocaleTagCount", HDIAGNOSTIC_EVENT_TAG_DESCRIPTION, hTagDescription, "uint*", &tagDescriptionCount := 0, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordProducers(hSession) {
    hProducerDescription := HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION.Owned()
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordProducers", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION.Ptr, hProducerDescription, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqFreeDiagnosticRecordProducers(hProducerDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqFreeDiagnosticRecordProducers", HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION, hProducerDescription, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordProducerCount(hProducerDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordProducerCount", HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION, hProducerDescription, "uint*", &producerDescriptionCount := 0, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordProducerCategories(hSession, producerName) {
    producerName := producerName is String ? StrPtr(producerName) : producerName

    hCategoryDescription := HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION.Owned()
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordProducerCategories", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, "ptr", producerName, HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION.Ptr, hCategoryDescription, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqFreeDiagnosticRecordProducerCategories(hCategoryDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqFreeDiagnosticRecordProducerCategories", HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION, hCategoryDescription, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordCategoryCount(hCategoryDescription) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordCategoryCount", HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION, hCategoryDescription, "uint*", &categoryDescriptionCount := 0, "HRESULT")
 ...
 * @since windows10.0.19041
 */
export DdqIsDiagnosticRecordSampledIn(hSession, providerGroup, providerId, providerName, eventId, eventName, eventVersion, eventKeywords) {
 ...
 * @since windows10.0.19041
 */
export DdqFreeDiagnosticRecordPage(hRecord) {
    result := DllCall("DiagnosticDataQuery.dll\DdqFreeDiagnosticRecordPage", HDIAGNOSTIC_RECORD, hRecord, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticRecordCount(hRecord) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticRecordCount", HDIAGNOSTIC_RECORD, hRecord, "uint*", &recordCount := 0, "HRESULT")
    return recordCount
}
 ...
 * @since windows10.0.19041
 */
export DdqCancelDiagnosticRecordOperation(hSession) {
    result := DllCall("DiagnosticDataQuery.dll\DdqCancelDiagnosticRecordOperation", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqFreeDiagnosticReport(_hReport) {
    result := DllCall("DiagnosticDataQuery.dll\DdqFreeDiagnosticReport", HDIAGNOSTIC_REPORT, _hReport, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetDiagnosticReportCount(_hReport) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetDiagnosticReportCount", HDIAGNOSTIC_REPORT, _hReport, "uint*", &reportCount := 0, "HRESULT")
    return reportCount
}
 ...
 * @since windows10.0.19041
 */
export DdqExtractDiagnosticReport(hSession, reportStoreType, reportKey, destinationPath) {
 ...
 * @since windows10.0.19041
 */
export DdqSetTranscriptConfiguration(hSession, desiredConfig) {
    result := DllCall("DiagnosticDataQuery.dll\DdqSetTranscriptConfiguration", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, DIAGNOSTIC_DATA_EVENT_TRANSCRIPT_CONFIGURATION.Ptr, desiredConfig, "HRESULT")
    return result
}
 ...
 * @since windows10.0.19041
 */
export DdqGetTranscriptConfiguration(hSession, currentConfig) {
    result := DllCall("DiagnosticDataQuery.dll\DdqGetTranscriptConfiguration", HDIAGNOSTIC_DATA_QUERY_SESSION, hSession, DIAGNOSTIC_DATA_EVENT_TRANSCRIPT_CONFIGURATION.Ptr, currentConfig, "HRESULT")
    return result
}
