...
;@region Methods
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpcreatethreadnetworkcontext
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpclosethreadnetworkcontext
     * @since windows10.0.10240
     */
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpsettokenenterpriseid
     * @since windows10.0.10240
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpgetenterpriseids
     * @since windows10.0.10240
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpenablepermissivemodefileencryption
     * @since windows10.0.10240
     */
     ...
     * 
     * HRESULT_FROM_WIN32 (ERROR_INVALID_STATE) indicates that thread tagging cannot be performed due to either process or thread context.
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpdisablepermissivemodefileencryption
     * @since windows10.0.10240
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpgetenterprisepolicy
     * @since windows10.0.10240
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpistokenservice
     * @since windows10.0.10240
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/srpapi/nf-srpapi-srpdoespolicyallowappexecution
     * @since windows10.0.10240
     */
     ...
     * @returns {HRESULT} 
     */
    static SrpHostingInitialize(Version_, Type, pvData, cbData) {
        pvDataMarshal := pvData is VarRef ? "ptr" : "ptr"

        result := DllCall("srpapi.dll\SrpHostingInitialize", "int", Version_, "int", Type, pvDataMarshal, pvData, "uint", cbData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/edpwin32/nf-edpwin32-protectfiletoenterpriseidentity
     * @since windows10.0.10240
     */
