...
class IProtectionPolicyManagerInterop3 extends IInspectable{
    ...
    RequestAccessWithBehaviorForWindowAsync(appWindow, sourceIdentity, targetIdentity, auditInfoUnk, messageFromApp, behavior, riid, asyncOperation) {
        ...
        result := ComCall(6, this, "ptr", appWindow, "ptr", sourceIdentity, "ptr", targetIdentity, "ptr", auditInfoUnk, "ptr", messageFromApp, "uint", behavior, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
    ...
    RequestAccessForAppWithBehaviorForWindowAsync(appWindow, sourceIdentity, appPackageFamilyName, auditInfoUnk, messageFromApp, behavior, riid, asyncOperation) {
        ...
        result := ComCall(7, this, "ptr", appWindow, "ptr", sourceIdentity, "ptr", appPackageFamilyName, "ptr", auditInfoUnk, "ptr", messageFromApp, "uint", behavior, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * 
     * @param {HWND} appWindow 
     * @param {Pointer<IUnknown>} sourceItemListUnk 
     * @param {HSTRING} appPackageFamilyName 
     * @param {Pointer<IUnknown>} auditInfoUnk 
     * @param {Pointer<Guid>} riid 
     * @param {Pointer<Void>} asyncOperation 
    ...
    RequestAccessToFilesForAppForWindowAsync(appWindow, sourceItemListUnk, appPackageFamilyName, auditInfoUnk, riid, asyncOperation) {
        ...
        result := ComCall(8, this, "ptr", appWindow, "ptr", sourceItemListUnk, "ptr", appPackageFamilyName, "ptr", auditInfoUnk, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RequestAccessToFilesForAppWithMessageAndBehaviorForWindowAsync(appWindow, sourceItemListUnk, appPackageFamilyName, auditInfoUnk, messageFromApp, behavior, riid, asyncOperation) {
        ...
        result := ComCall(9, this, "ptr", appWindow, "ptr", sourceItemListUnk, "ptr", appPackageFamilyName, "ptr", auditInfoUnk, "ptr", messageFromApp, "uint", behavior, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RequestAccessToFilesForProcessForWindowAsync(appWindow, sourceItemListUnk, processId, auditInfoUnk, riid, asyncOperation) {
        ...
        result := ComCall(10, this, "ptr", appWindow, "ptr", sourceItemListUnk, "uint", processId, "ptr", auditInfoUnk, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
            throw OSError(result)
    ...
    RequestAccessToFilesForProcessWithMessageAndBehaviorForWindowAsync(appWindow, sourceItemListUnk, processId, auditInfoUnk, messageFromApp, behavior, riid, asyncOperation) {
        ...
        result := ComCall(11, this, "ptr", appWindow, "ptr", sourceItemListUnk, "uint", processId, "ptr", auditInfoUnk, "ptr", messageFromApp, "uint", behavior, "ptr", riid, "ptr", asyncOperation, "int")
        if(result != 0)
            throw OSError(result)
