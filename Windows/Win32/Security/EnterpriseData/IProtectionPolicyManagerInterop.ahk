...
class IProtectionPolicyManagerInterop extends IInspectable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/efswrtinterop/nf-efswrtinterop-iprotectionpolicymanagerinterop-requestaccessforwindowasync
     */
    RequestAccessForWindowAsync(appWindow, sourceIdentity, targetIdentity, riid) {
        ...
        result := ComCall(6, this, "ptr", appWindow, "ptr", sourceIdentity, "ptr", targetIdentity, "ptr", riid, "ptr*", &asyncOperation := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/efswrtinterop/nf-efswrtinterop-iprotectionpolicymanagerinterop-getforwindow
     */
    GetForWindow(appWindow, riid) {
        appWindow := appWindow is Win32Handle ? NumGet(appWindow, "ptr") : appWindow

        result := ComCall(7, this, "ptr", appWindow, "ptr", riid, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
