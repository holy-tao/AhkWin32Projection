...
class IRouterProtocolConfig extends IUnknown{
     ...
     * @param {Pointer<IUnknown>} pRouter 
    ...
    AddProtocol(pszMachineName, dwTransportId, dwProtocolId, hWnd, dwFlags, pRouter, uReserved1) {
        ...
        result := ComCall(3, this, "ptr", pszMachineName, "uint", dwTransportId, "uint", dwProtocolId, "ptr", hWnd, "uint", dwFlags, "ptr", pRouter, "ptr", uReserved1, "int")
        if(result != 0)
    ...
    RemoveProtocol(pszMachineName, dwTransportId, dwProtocolId, hWnd, dwFlags, pRouter, uReserved1) {
        ...
        result := ComCall(4, this, "ptr", pszMachineName, "uint", dwTransportId, "uint", dwProtocolId, "ptr", hWnd, "uint", dwFlags, "ptr", pRouter, "ptr", uReserved1, "int")
        if(result != 0)
            throw OSError(result)
