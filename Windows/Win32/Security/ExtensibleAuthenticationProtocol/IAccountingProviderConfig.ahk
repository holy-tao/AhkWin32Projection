 ...
 */
export default struct IAccountingProviderConfig extends IUnknown {
    /**
     ...
     * used for IAccountingProviderConfig interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IAccountingProviderConfig.Vtbl()
        }
    ...
    Query(iid) {
        if (IAccountingProviderConfig.IID.Equals(iid)) {
            return true
        }
