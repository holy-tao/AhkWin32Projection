...
class IAccountingProviderConfig extends IUnknown{
    ...
    Initialize(pszMachineName, puConnectionParam) {
        ...
        result := ComCall(3, this, "ptr", pszMachineName, "ptr*", puConnectionParam, "int")
        if(result != 0)
    ...
    Configure(uConnectionParam, hWnd, dwFlags, uReserved1, uReserved2) {
        ...
        result := ComCall(5, this, "ptr", uConnectionParam, "ptr", hWnd, "uint", dwFlags, "ptr", uReserved1, "ptr", uReserved2, "int")
        if(result != 0)
            throw OSError(result)
