 ...
 */
export default struct PLSA_AP_CALL_PACKAGE_UNTRUSTED {
    value : IntPtr

    __value {
        set {
            if (value is PLSA_AP_CALL_PACKAGE_UNTRUSTED) {
    ...
    /**
     * A PLSA_AP_CALL_PACKAGE_UNTRUSTED that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PLSA_AP_CALL_PACKAGE_UNTRUSTED {
        /**
         * Creates a PLSA_AP_CALL_PACKAGE_UNTRUSTED pointer that invokes the given AHK function when called.
