 ...
 * @see https://learn.microsoft.com/windows/win32/api/winscard/ns-winscard-opencard_search_criteriaa
 * @namespace Windows.Win32.Security.Credentials
 * @version v4.0.30319
 * @charset ANSI
 */
class OPENCARD_SEARCH_CRITERIAA extends Win32Struct
{
    static sizeof => 96
    ...
    lpstrGroupNames{
        get {
            if(!this.HasProp("__lpstrGroupNames"))
                this.__lpstrGroupNames := PSTR(this.ptr + 8)
