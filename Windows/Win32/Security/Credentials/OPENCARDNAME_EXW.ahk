 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winscard/ns-winscard-opencardname_exw
    ...
    lpstrTitle{
        get {
            if(!this.HasProp("__lpstrTitle"))
                this.__lpstrTitle := PWSTR(this.ptr + 32)
    ...
    lpstrSearchDesc{
        get {
            if(!this.HasProp("__lpstrSearchDesc"))
                this.__lpstrSearchDesc := PWSTR(this.ptr + 40)
    ...
    lpstrRdr{
        get {
            if(!this.HasProp("__lpstrRdr"))
                this.__lpstrRdr := PWSTR(this.ptr + 88)
    ...
    lpstrCard{
        get {
            if(!this.HasProp("__lpstrCard"))
                this.__lpstrCard := PWSTR(this.ptr + 104)
