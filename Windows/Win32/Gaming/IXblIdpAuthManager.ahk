 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nn-xblidpauthmanager-ixblidpauthmanager
...
class IXblIdpAuthManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-setgameraccount
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-getgameraccount
     */
    GetGamerAccount(msaAccountId, xuid) {
        msaAccountIdMarshal := msaAccountId is VarRef ? "ptr*" : "ptr"
        xuidMarshal := xuid is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, msaAccountIdMarshal, msaAccountId, xuidMarshal, xuid, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-setappviewinitialized
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-getenvironment
     */
    GetEnvironment() {
        result := ComCall(6, this, "ptr*", &environment := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {PWSTR} Type: <b>__RPC__deref_out_opt_string*</b>
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-getsandbox
     */
    GetSandbox() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/xblidpauthmanager/nf-xblidpauthmanager-ixblidpauthmanager-gettokenandsignaturewithtokenresult
     */
    GetTokenAndSignatureWithTokenResult(msaAccountId, appSid, msaTarget, msaPolicy, httpMethod, uri, headers, body, bodySize, forceRefresh) {
        ...
        result := ComCall(8, this, "ptr", msaAccountId, "ptr", appSid, "ptr", msaTarget, "ptr", msaPolicy, "ptr", httpMethod, "ptr", uri, "ptr", headers, bodyMarshal, body, "uint", bodySize, "int", forceRefresh, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
