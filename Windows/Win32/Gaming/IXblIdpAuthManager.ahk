...
class IXblIdpAuthManager extends IUnknown{
    ...
    GetTokenAndSignatureWithTokenResult(msaAccountId, appSid, msaTarget, msaPolicy, httpMethod, uri, headers, body, bodySize, forceRefresh, result) {
        ...
        result := ComCall(8, this, "ptr", msaAccountId, "ptr", appSid, "ptr", msaTarget, "ptr", msaPolicy, "ptr", httpMethod, "ptr", uri, "ptr", headers, "char*", body, "uint", bodySize, "int", forceRefresh, "ptr*", result, "HRESULT")
        return result
    }
}
