...
export default struct IXblIdpAuthTokenResult extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetToken := CallbackCreate(ObjBindMethod(implObj, "GetToken"), flags, 2)
        ...
        this.vtbl.GetMsaAccountId := CallbackCreate(ObjBindMethod(implObj, "GetMsaAccountId"), flags, 2)
        this.vtbl.GetXuid := CallbackCreate(ObjBindMethod(implObj, "GetXuid"), flags, 2)
        this.vtbl.GetGamertag := CallbackCreate(ObjBindMethod(implObj, "GetGamertag"), flags, 2)
        this.vtbl.GetAgeGroup := CallbackCreate(ObjBindMethod(implObj, "GetAgeGroup"), flags, 2)
        this.vtbl.GetPrivileges := CallbackCreate(ObjBindMethod(implObj, "GetPrivileges"), flags, 2)
        this.vtbl.GetMsaTarget := CallbackCreate(ObjBindMethod(implObj, "GetMsaTarget"), flags, 2)
        this.vtbl.GetMsaPolicy := CallbackCreate(ObjBindMethod(implObj, "GetMsaPolicy"), flags, 2)
        this.vtbl.GetMsaAppId := CallbackCreate(ObjBindMethod(implObj, "GetMsaAppId"), flags, 2)
        this.vtbl.GetRedirect := CallbackCreate(ObjBindMethod(implObj, "GetRedirect"), flags, 2)
        this.vtbl.GetMessage := CallbackCreate(ObjBindMethod(implObj, "GetMessage"), flags, 2)
        this.vtbl.GetHelpId := CallbackCreate(ObjBindMethod(implObj, "GetHelpId"), flags, 2)
        this.vtbl.GetEnforcementBans := CallbackCreate(ObjBindMethod(implObj, "GetEnforcementBans"), flags, 2)
        this.vtbl.GetRestrictions := CallbackCreate(ObjBindMethod(implObj, "GetRestrictions"), flags, 2)
        this.vtbl.GetTitleRestrictions := CallbackCreate(ObjBindMethod(implObj, "GetTitleRestrictions"), flags, 2)
    }
