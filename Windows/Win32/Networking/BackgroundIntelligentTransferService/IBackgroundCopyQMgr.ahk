 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/qmgr/nn-qmgr-ibackgroundcopyqmgr
...
class IBackgroundCopyQMgr extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qmgr/nf-qmgr-ibackgroundcopyqmgr-creategroup
     */
    CreateGroup(guidGroupID) {
        result := ComCall(3, this, "ptr", guidGroupID, "ptr*", &ppGroup := 0, "int")
        if(result != 0) {
     ...
     * @returns {IBackgroundCopyGroup} Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/qmgr/nn-qmgr-ibackgroundcopygroup">IBackgroundCopyGroup</a> interface pointer. Use this interface to manage the group. For example, add a job to the group and set the properties of the group.
     * @see https://learn.microsoft.com/windows/win32/api//content/qmgr/nf-qmgr-ibackgroundcopyqmgr-getgroup
     */
    GetGroup(groupID) {
        result := ComCall(4, this, "ptr", groupID, "ptr*", &ppGroup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/qmgr/nf-qmgr-ibackgroundcopyqmgr-enumgroups
     */
    EnumGroups(dwFlags) {
        result := ComCall(5, this, "uint", dwFlags, "ptr*", &ppEnumGroups := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
