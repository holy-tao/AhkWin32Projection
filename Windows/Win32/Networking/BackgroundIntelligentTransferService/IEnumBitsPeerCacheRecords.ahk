 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nn-bits3_0-ienumbitspeercacherecords
...
class IEnumBitsPeerCacheRecords extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ienumbitspeercacherecords-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ienumbitspeercacherecords-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ienumbitspeercacherecords-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ienumbitspeercacherecords-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ienumbitspeercacherecords-getcount
     */
    GetCount() {
        result := ComCall(7, this, "uint*", &puCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
