 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nn-bits2_0-ibackgroundcopyjob3
...
class IBackgroundCopyJob3 extends IBackgroundCopyJob2{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyjob3-replaceremoteprefix
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyjob3-addfilewithranges
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyjob3-setfileaclflags
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyjob3-getfileaclflags
     */
    GetFileACLFlags() {
        result := ComCall(46, this, "uint*", &Flags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
