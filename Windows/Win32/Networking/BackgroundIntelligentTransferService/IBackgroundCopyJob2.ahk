 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nn-bits1_5-ibackgroundcopyjob2
...
class IBackgroundCopyJob2 extends IBackgroundCopyJob{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-setnotifycmdline
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-getnotifycmdline
     */
    GetNotifyCmdLine(pProgram, pParameters) {
        ...
        result := ComCall(36, this, pProgramMarshal, pProgram, pParametersMarshal, pParameters, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-getreplyprogress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-getreplydata
     */
    GetReplyData(pLength) {
        pLengthMarshal := pLength is VarRef ? "uint*" : "ptr"

        result := ComCall(38, this, "ptr*", &ppBuffer := 0, pLengthMarshal, pLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-setreplyfilename
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-getreplyfilename
     */
    GetReplyFileName() {
        result := ComCall(40, this, "ptr*", &pReplyFileName := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-setcredentials
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits1_5/nf-bits1_5-ibackgroundcopyjob2-removecredentials
     */
