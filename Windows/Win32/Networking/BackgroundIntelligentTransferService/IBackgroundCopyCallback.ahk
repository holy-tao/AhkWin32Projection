 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/bits/nn-bits-ibackgroundcopycallback
...
class IBackgroundCopyCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopycallback-jobtransferred
     */
    JobTransferred(pJob) {
     ...
     * 
     * Note that if this method fails and you   called the <a href="https://docs.microsoft.com/windows/desktop/api/bits1_5/nf-bits1_5-ibackgroundcopyjob2-setnotifycmdline">IBackgroundCopyJob2::SetNotifyCmdLine</a> method, the command line is executed and this method is not called again.
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopycallback-joberror
     */
    JobError(pJob, pError) {
        result := ComCall(4, this, "ptr", pJob, "ptr", pError, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopycallback-jobmodification
     */
    JobModification(pJob, dwReserved) {
        result := ComCall(5, this, "ptr", pJob, "uint", dwReserved, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
