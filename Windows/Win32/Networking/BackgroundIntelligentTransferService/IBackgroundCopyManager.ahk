 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits/nn-bits-ibackgroundcopymanager
...
class IBackgroundCopyManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopymanager-createjob
     */
    CreateJob(DisplayName, Type, pJobId, ppJob) {
        DisplayName := DisplayName is String ? StrPtr(DisplayName) : DisplayName

        result := ComCall(3, this, "ptr", DisplayName, "int", Type, "ptr", pJobId, "ptr*", ppJob, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopymanager-getjob
     */
    GetJob(jobID) {
        result := ComCall(4, this, "ptr", jobID, "ptr*", &ppJob := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopymanager-enumjobs
     */
    EnumJobs(dwFlags) {
        result := ComCall(5, this, "uint", dwFlags, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HRESULT} hResult_ Error code from a previous call to a BITS method.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopymanager-geterrordescription
     */
    GetErrorDescription(hResult_, LanguageId) {
        result := ComCall(6, this, "int", hResult_, "uint", LanguageId, "ptr*", &pErrorDescription := 0, "int")
        if(result != 0) {
