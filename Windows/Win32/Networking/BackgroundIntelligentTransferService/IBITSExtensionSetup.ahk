 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bitscfg/nn-bitscfg-ibitsextensionsetup
...
class IBITSExtensionSetup extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bitscfg/nf-bitscfg-ibitsextensionsetup-enablebitsuploads
     */
    EnableBITSUploads() {
     ...
     * @returns {HRESULT} This method returns <b>S_OK</b> for success. Otherwise, the method failed.
     * @see https://learn.microsoft.com/windows/win32/api//content/bitscfg/nf-bitscfg-ibitsextensionsetup-disablebitsuploads
     */
    DisableBITSUploads() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bitscfg/nf-bitscfg-ibitsextensionsetup-getcleanuptaskname
     */
    GetCleanupTaskName() {
        pTaskName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bitscfg/nf-bitscfg-ibitsextensionsetup-getcleanuptask
     */
    GetCleanupTask(riid) {
        result := ComCall(10, this, "ptr", riid, "ptr*", &ppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
