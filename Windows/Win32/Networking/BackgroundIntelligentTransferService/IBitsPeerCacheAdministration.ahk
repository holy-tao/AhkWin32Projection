...
export default struct IBitsPeerCacheAdministration extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.GetMaximumCacheSize := CallbackCreate(ObjBindMethod(implObj, "GetMaximumCacheSize"), flags, 2)
        this.vtbl.SetMaximumCacheSize := CallbackCreate(ObjBindMethod(implObj, "SetMaximumCacheSize"), flags, 2)
        this.vtbl.GetMaximumContentAge := CallbackCreate(ObjBindMethod(implObj, "GetMaximumContentAge"), flags, 2)
        this.vtbl.SetMaximumContentAge := CallbackCreate(ObjBindMethod(implObj, "SetMaximumContentAge"), flags, 2)
        this.vtbl.GetConfigurationFlags := CallbackCreate(ObjBindMethod(implObj, "GetConfigurationFlags"), flags, 2)
        this.vtbl.SetConfigurationFlags := CallbackCreate(ObjBindMethod(implObj, "SetConfigurationFlags"), flags, 2)
        this.vtbl.EnumRecords := CallbackCreate(ObjBindMethod(implObj, "EnumRecords"), flags, 2)
        this.vtbl.GetRecord := CallbackCreate(ObjBindMethod(implObj, "GetRecord"), flags, 3)
        this.vtbl.ClearRecords := CallbackCreate(ObjBindMethod(implObj, "ClearRecords"), flags, 1)
        this.vtbl.DeleteRecord := CallbackCreate(ObjBindMethod(implObj, "DeleteRecord"), flags, 2)
        this.vtbl.DeleteUrl := CallbackCreate(ObjBindMethod(implObj, "DeleteUrl"), flags, 2)
        this.vtbl.EnumPeers := CallbackCreate(ObjBindMethod(implObj, "EnumPeers"), flags, 2)
        this.vtbl.ClearPeers := CallbackCreate(ObjBindMethod(implObj, "ClearPeers"), flags, 1)
        this.vtbl.DiscoverPeers := CallbackCreate(ObjBindMethod(implObj, "DiscoverPeers"), flags, 1)
    }
