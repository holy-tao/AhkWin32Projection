 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nn-bits3_0-ibitspeercacheadministration
...
class IBitsPeerCacheAdministration extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-getmaximumcachesize
     */
    GetMaximumCacheSize() {
        result := ComCall(3, this, "uint*", &pBytes := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-setmaximumcachesize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-getmaximumcontentage
     */
    GetMaximumContentAge() {
        result := ComCall(5, this, "uint*", &pSeconds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-setmaximumcontentage
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-getconfigurationflags
     */
    GetConfigurationFlags() {
        result := ComCall(7, this, "uint*", &pFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-setconfigurationflags
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-enumrecords
     */
    EnumRecords() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-getrecord
     */
    GetRecord(id) {
        result := ComCall(10, this, "ptr", id, "ptr*", &ppRecord := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-clearrecords
     */
    ClearRecords() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-deleterecord
     */
    DeleteRecord(id) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-deleteurl
     */
    DeleteUrl(url) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-enumpeers
     */
    EnumPeers() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-clearpeers
     */
    ClearPeers() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacheadministration-discoverpeers
     */
    DiscoverPeers() {
