 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits/nn-bits-ienumbackgroundcopyfiles
...
class IEnumBackgroundCopyFiles extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ienumbackgroundcopyfiles-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ienumbackgroundcopyfiles-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ienumbackgroundcopyfiles-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ienumbackgroundcopyfiles-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ienumbackgroundcopyfiles-getcount
     */
    GetCount() {
