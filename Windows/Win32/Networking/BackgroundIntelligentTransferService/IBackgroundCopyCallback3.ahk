 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nn-bits10_1-ibackgroundcopycallback3
...
class IBackgroundCopyCallback3 extends IBackgroundCopyCallback2{
     ...
     * @param {IBackgroundCopyFile} file_ An <a href="https://docs.microsoft.com/windows/desktop/api/bits/nn-bits-ibackgroundcopyfile">IBackgroundCopyFile</a> object that contains information about the file whose ranges have changed. Do not release <i>pFile</i>; BITS releases the interface when the method returns.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nf-bits10_1-ibackgroundcopycallback3-filerangestransferred
     */
    FileRangesTransferred(job, file_, rangeCount, ranges) {
        result := ComCall(7, this, "ptr", job, "ptr", file_, "uint", rangeCount, "ptr", ranges, "int")
        if(result != 0) {
