 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nn-bits2_0-ibackgroundcopyfile2
...
class IBackgroundCopyFile2 extends IBackgroundCopyFile{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyfile2-getfileranges
     */
     ...
     * </tr>
     * </table>
     * @param {PWSTR} Val_ Null-terminated string that contains the name of the file on the server. For information on specifying the remote name, see the <b>RemoteName</b> member and Remarks section of the <a href="https://docs.microsoft.com/windows/desktop/api/bits/ns-bits-bg_file_info">BG_FILE_INFO</a> structure.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits2_0/nf-bits2_0-ibackgroundcopyfile2-setremotename
     */
    SetRemoteName(Val_) {
        Val_ := Val_ is String ? StrPtr(Val_) : Val_

        result := ComCall(7, this, "ptr", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
