 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nn-bits3_0-ibitspeercacherecord
...
class IBitsPeerCacheRecord extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getid
     */
    GetId() {
        pVal := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getoriginurl
     */
    GetOriginUrl() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getfilesize
     */
    GetFileSize() {
        result := ComCall(5, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getfilemodificationtime
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/minwinbase/ns-minwinbase-filetime">FILETIME</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getlastaccesstime
     */
    GetLastAccessTime() {
        pVal := FILETIME()
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-isfilevalidated
     */
    IsFileValidated() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits3_0/nf-bits3_0-ibitspeercacherecord-getfileranges
     */
    GetFileRanges(pRangeCount, ppRanges) {
        ...
        result := ComCall(9, this, pRangeCountMarshal, pRangeCount, ppRangesMarshal, ppRanges, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
