...
class BITS_JOB_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: BITS_JOB_PROPERTY_ID_COST_FLAGS
     * @type {Integer (Int32)}
     */
    static COST_FLAGS => 1
     ...
     * Native name: BITS_JOB_PROPERTY_DYNAMIC_CONTENT
     * @type {Integer (Int32)}
     */
    static DYNAMIC_CONTENT => 3
     ...
     * Native name: BITS_JOB_PROPERTY_HIGH_PERFORMANCE
     * @type {Integer (Int32)}
     */
    static HIGH_PERFORMANCE => 4
     ...
     * Native name: BITS_JOB_PROPERTY_MAX_DOWNLOAD_SIZE
     * @type {Integer (Int32)}
     */
    static MAX_DOWNLOAD_SIZE => 5

    /**
     * The ID for marking a BITS job as being willing to include default credentials in requests to proxy servers. Enabling this property is equivalent to setting a <a href="https://docs.microsoft.com/windows/desktop/WinHttp/authentication-in-winhttp">WinHTTP security level</a> of <b>WINHTTP_AUTOLOGON_SECURITY_LEVEL_MEDIUM</b> on the requests that BITS makes on the user’s behalf. The user BITS retrieves stored credentials from the is the same as the one it makes network requests on behalf of: BITS will normally use the job owner’s credentials, unless you have explicitly provided a network <a href="https://docs.microsoft.com/windows/desktop/Bits/helper-tokens-for-bits-transfer-jobs">helper token</a>, in which case BITS will use the network helper token’s credentials.
     * 
     ...
     * Native name: BITS_JOB_PROPERTY_ON_DEMAND_MODE
     * @type {Integer (Int32)}
     */
    static ON_DEMAND_MODE => 10
}
