 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nn-bits10_1-ibackgroundcopyfile6
...
class IBackgroundCopyFile6 extends IBackgroundCopyFile5{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nf-bits10_1-ibackgroundcopyfile6-updatedownloadposition
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nf-bits10_1-ibackgroundcopyfile6-requestfileranges
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits10_1/nf-bits10_1-ibackgroundcopyfile6-getfilledfileranges
     */
    GetFilledFileRanges(rangeCount, ranges) {
        ...
        result := ComCall(17, this, rangeCountMarshal, rangeCount, rangesMarshal, ranges, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
