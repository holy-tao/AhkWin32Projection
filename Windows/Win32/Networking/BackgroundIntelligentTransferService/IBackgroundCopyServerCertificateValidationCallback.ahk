 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/bits10_3/nn-bits10_3-ibackgroundcopyservercertificatevalidationcallback
...
class IBackgroundCopyServerCertificateValidationCallback extends IUnknown{
     ...
     * 
     * The job.
     * @param {IBackgroundCopyFile} file_ Type: **[IBackgroundCopyFile](/windows/desktop/api/bits/nn-bits-ibackgroundcopyfile)\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits10_3/nf-bits10_3-ibackgroundcopyservercertificatevalidationcallback-validateservercertificate
     */
    ValidateServerCertificate(job, file_, certLength, certData, certEncodingType, certStoreLength, certStoreData) {
        certDataMarshal := certData is VarRef ? "char*" : "ptr"
        certStoreDataMarshal := certStoreData is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, "ptr", job, "ptr", file_, "uint", certLength, certDataMarshal, certData, "uint", certEncodingType, "uint", certStoreLength, certStoreDataMarshal, certStoreData, "int")
        if(result != 0) {
