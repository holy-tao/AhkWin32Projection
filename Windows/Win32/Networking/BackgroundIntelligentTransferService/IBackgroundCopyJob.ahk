 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bits/nn-bits-ibackgroundcopyjob
...
class IBackgroundCopyJob extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-addfileset
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-addfile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-enumfiles
     */
    EnumFiles() {
        result := ComCall(5, this, "ptr*", &pEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-suspend
     */
    Suspend() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-resume
     */
    Resume() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-cancel
     */
    Cancel() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-complete
     */
    Complete() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getid
     */
    GetId() {
        pVal := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-gettype
     */
    GetType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getprogress
     */
    GetProgress() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-gettimes
     */
    GetTimes() {
        pVal := BG_JOB_TIMES()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getstate
     */
    GetState() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-geterror
     */
    GetError() {
        result := ComCall(15, this, "ptr*", &ppError := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getowner
     */
    GetOwner() {
     ...
     * @param {PWSTR} Val_ Null-terminated string that identifies the job. Must not be <b>NULL</b>. The length of the string is limited to 256 characters, not including the null terminator.
     * @returns {HRESULT} This method returns the following <b>HRESULT</b> values, as well as others.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setdisplayname
     */
    SetDisplayName(Val_) {
        Val_ := Val_ is String ? StrPtr(Val_) : Val_

        result := ComCall(17, this, "ptr", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getdisplayname
     */
    GetDisplayName() {
     ...
     * @param {PWSTR} Val_ Null-terminated string that provides additional information about the job. The length of the string is limited to 1,024 characters, not including the null terminator.
     * @returns {HRESULT} This method returns the following <b>HRESULT</b> values, as well as others.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setdescription
     */
    SetDescription(Val_) {
        Val_ := Val_ is String ? StrPtr(Val_) : Val_

        result := ComCall(19, this, "ptr", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getdescription
     */
    GetDescription() {
     ...
     * @param {Integer} Val_ Specifies the priority level of your job relative to other jobs in the transfer queue. The default is BG_JOB_PRIORITY_NORMAL. For a list of priority levels, see the 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setpriority
     */
    SetPriority(Val_) {
        result := ComCall(21, this, "int", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getpriority
     */
    GetPriority() {
     ...
     * @param {Integer} Val_ Set one or more of the following flags to identify the events that you want to receive.  
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setnotifyflags
     */
    SetNotifyFlags(Val_) {
        result := ComCall(23, this, "uint", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getnotifyflags
     */
    GetNotifyFlags() {
        result := ComCall(24, this, "uint*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setnotifyinterface
     */
    SetNotifyInterface(Val_) {
        result := ComCall(25, this, "ptr", Val_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getnotifyinterface
     */
    GetNotifyInterface() {
        result := ComCall(26, this, "ptr*", &pVal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setminimumretrydelay
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getminimumretrydelay
     */
    GetMinimumRetryDelay() {
        result := ComCall(28, this, "uint*", &Seconds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setnoprogresstimeout
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getnoprogresstimeout
     */
    GetNoProgressTimeout() {
        result := ComCall(30, this, "uint*", &Seconds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-geterrorcount
     */
    GetErrorCount() {
        result := ComCall(31, this, "uint*", &Errors := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-setproxysettings
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-getproxysettings
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/bits/nf-bits-ibackgroundcopyjob-takeownership
     */
    TakeOwnership() {
