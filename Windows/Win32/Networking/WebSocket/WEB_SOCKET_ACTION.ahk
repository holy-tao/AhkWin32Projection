...
class WEB_SOCKET_ACTION extends Win32Enum {
     ...
     * Native name: WEB_SOCKET_NO_ACTION
     * @type {Integer (Int32)}
     */
    static NO_ACTION => 0
     ...
     * Native name: WEB_SOCKET_SEND_TO_NETWORK_ACTION
     * @type {Integer (Int32)}
     */
    static SEND_TO_NETWORK_ACTION => 1
     ...
     * Native name: WEB_SOCKET_INDICATE_SEND_COMPLETE_ACTION
     * @type {Integer (Int32)}
     */
    static INDICATE_SEND_COMPLETE_ACTION => 2

    /**
     * Indicates the application should fill the buffers with data from a network.
     * Native name: WEB_SOCKET_RECEIVE_FROM_NETWORK_ACTION
     * @type {Integer (Int32)}
     */
    static RECEIVE_FROM_NETWORK_ACTION => 3
     ...
     * Native name: WEB_SOCKET_INDICATE_RECEIVE_COMPLETE_ACTION
     * @type {Integer (Int32)}
     */
    static INDICATE_RECEIVE_COMPLETE_ACTION => 4
}
