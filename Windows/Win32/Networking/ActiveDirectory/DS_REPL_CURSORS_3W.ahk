 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntdsapi/ns-ntdsapi-ds_repl_cursors_3w
    ...
    rgCursor{
        get {
            if(!this.HasProp("__rgCursorProxyArray"))
                this.__rgCursorProxyArray := Win32FixedArray(this.ptr + 8, 1, DS_REPL_CURSOR_3W, "")
