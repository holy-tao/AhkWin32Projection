 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nn-dsadmin-idsadmincreateobj
...
class IDsAdminCreateObj extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nf-dsadmin-idsadmincreateobj-initialize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nf-dsadmin-idsadmincreateobj-createmodal
     */
    CreateModal(hwndParent) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(4, this, "ptr", hwndParent, "ptr*", &ppADsObj := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
