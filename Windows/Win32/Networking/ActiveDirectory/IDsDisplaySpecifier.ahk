 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nn-dsclient-idsdisplayspecifier
...
class IDsDisplaySpecifier extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-setserver
     */
    SetServer(pszServer, pszUserName, pszPassword, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", pszServer, "ptr", pszUserName, "ptr", pszPassword, "uint", dwFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-setlanguageid
     */
     ...
     * @returns {HRESULT} Returns a standard <b>HRESULT</b> value including the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-getdisplayspecifier
     */
    GetDisplaySpecifier(pszObjectClass, riid, ppv) {
        ...
        result := ComCall(5, this, "ptr", pszObjectClass, "ptr", riid, ppvMarshal, ppv, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-geticonlocation
     */
    GetIconLocation(pszObjectClass, dwFlags, pszBuffer, cchBuffer) {
        pszObjectClass := pszObjectClass is String ? StrPtr(pszObjectClass) : pszObjectClass
        pszBuffer := pszBuffer is String ? StrPtr(pszBuffer) : pszBuffer

        result := ComCall(6, this, "ptr", pszObjectClass, "uint", dwFlags, "ptr", pszBuffer, "int", cchBuffer, "int*", &presid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-geticon
     */
     ...
     * @returns {HRESULT} Returns a standard  <b>HRESULT</b> value, including the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-getfriendlyclassname
     */
    GetFriendlyClassName(pszObjectClass, pszBuffer, cchBuffer) {
        pszObjectClass := pszObjectClass is String ? StrPtr(pszObjectClass) : pszObjectClass
        pszBuffer := pszBuffer is String ? StrPtr(pszBuffer) : pszBuffer

        result := ComCall(8, this, "ptr", pszObjectClass, "ptr", pszBuffer, "int", cchBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} cchBuffer Contains the size of the <i>pszBuffer</i> buffer, in wide characters, including the terminating <b>NULL</b> character. If the name exceeds this number of characters, the name is truncated.
     * @returns {HRESULT} Returns a standard  <b>HRESULT</b> value, including the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-getfriendlyattributename
     */
    GetFriendlyAttributeName(pszObjectClass, pszAttributeName, pszBuffer, cchBuffer) {
        ...
        result := ComCall(9, this, "ptr", pszObjectClass, "ptr", pszAttributeName, "ptr", pszBuffer, "uint", cchBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-isclasscontainer
     */
     ...
     * @returns {HRESULT} Returns a standard <b>HRESULT</b> value including the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-getclasscreationinfo
     */
    GetClassCreationInfo(pszObjectClass, ppdscci) {
        ...
        result := ComCall(11, this, "ptr", pszObjectClass, ppdscciMarshal, ppdscci, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {LPARAM} lParam_ Contains an application-defined  parameter passed as the <i>lParam</i> parameter in the <a href="https://docs.microsoft.com/windows/desktop/api/dsclient/nc-dsclient-lpdsenumattributes">DSEnumAttributesCallback</a> function.
     * @returns {HRESULT} Returns a standard <b>HRESULT</b> value including the following.
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-enumclassattributes
     */
    EnumClassAttributes(pszObjectClass, pcbEnum, lParam_) {
        pszObjectClass := pszObjectClass is String ? StrPtr(pszObjectClass) : pszObjectClass
        lParam_ := lParam_ is Win32Handle ? NumGet(lParam_, "ptr") : lParam_

        result := ComCall(12, this, "ptr", pszObjectClass, "ptr", pcbEnum, "ptr", lParam_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nf-dsclient-idsdisplayspecifier-getattributeadstype
     */
