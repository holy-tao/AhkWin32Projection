 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/objsel/nn-objsel-idsobjectpicker
...
class IDsObjectPicker extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objsel/nf-objsel-idsobjectpicker-initialize
     */
    Initialize(pInitInfo) {
        result := ComCall(3, this, "ptr", pInitInfo, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/objsel/nf-objsel-idsobjectpicker-invokedialog
     */
    InvokeDialog(hwndParent) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(4, this, "ptr", hwndParent, "ptr*", &ppdoSelections := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
