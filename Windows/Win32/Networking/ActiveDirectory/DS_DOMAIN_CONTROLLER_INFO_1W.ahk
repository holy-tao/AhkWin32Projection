 ...
 * @see https://learn.microsoft.com/windows/win32/api/ntdsapi/ns-ntdsapi-ds_domain_controller_info_1w
    ...
    ComputerObjectName{
        get {
            if(!this.HasProp("__ComputerObjectName"))
                this.__ComputerObjectName := PWSTR(this.ptr + 24)
    ...
    ServerObjectName{
        get {
            if(!this.HasProp("__ServerObjectName"))
                this.__ServerObjectName := PWSTR(this.ptr + 32)
