 ...
 * @see https://learn.microsoft.com/windows/win32/api/ntdsapi/ns-ntdsapi-ds_domain_controller_info_3a
 * @namespace Windows.Win32.Networking.ActiveDirectory
 * @charset ANSI
 */
class DS_DOMAIN_CONTROLLER_INFO_3A extends Win32Struct {
    static sizeof => 136
    ...
    SiteObjectGuid {
        get {
            if(!this.HasProp("__SiteObjectGuid"))
                this.__SiteObjectGuid := Guid(72, this)
    ...
    ComputerObjectGuid {
        get {
            if(!this.HasProp("__ComputerObjectGuid"))
                this.__ComputerObjectGuid := Guid(88, this)
    ...
    ServerObjectGuid {
        get {
            if(!this.HasProp("__ServerObjectGuid"))
                this.__ServerObjectGuid := Guid(104, this)
    ...
    NtdsDsaObjectGuid {
        get {
            if(!this.HasProp("__NtdsDsaObjectGuid"))
                this.__NtdsDsaObjectGuid := Guid(120, this)
