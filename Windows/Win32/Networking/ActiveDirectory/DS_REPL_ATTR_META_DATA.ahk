 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntdsapi/ns-ntdsapi-ds_repl_attr_meta_data
 * @namespace Windows.Win32.Networking.ActiveDirectory
 * @version v4.0.30319
 */
class DS_REPL_ATTR_META_DATA extends Win32Struct
{
    static sizeof => 48
    ...
    ftimeLastOriginatingChange{
        get {
            if(!this.HasProp("__ftimeLastOriginatingChange"))
                this.__ftimeLastOriginatingChange := FILETIME(12, this)
