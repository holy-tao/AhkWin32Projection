 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-iadspropertylist
...
class IADsPropertyList extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-next
     */
    Next() {
        pVariant := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-skip
     */
    Skip(cElements) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-item
     */
    Item(varIndex) {
        pVariant := VARIANT()
        result := ComCall(11, this, "ptr", varIndex, "ptr", pVariant, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-getpropertyitem
     */
    GetPropertyItem(bstrName, lnADsType) {
        ...
        pVariant := VARIANT()
        result := ComCall(12, this, "ptr", bstrName, "int", lnADsType, "ptr", pVariant, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method supports the standard HRESULT return values, including S_OK. For more information and other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-putpropertyitem
     */
    PutPropertyItem(varData) {
        result := ComCall(13, this, "ptr", varData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-resetpropertyitem
     */
    ResetPropertyItem(varEntry) {
        result := ComCall(14, this, "ptr", varEntry, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method supports the standard HRESULT return values, including S_OK. For more information and other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertylist-purgepropertylist
     */
    PurgePropertyList() {
