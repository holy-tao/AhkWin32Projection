...
class ADS_SEARCHPREF_ENUM extends Win32Enum {
     ...
     * Native name: ADS_SEARCHPREF_ASYNCHRONOUS
     * @type {Integer (Int32)}
     */
     ...
     * Native name: ADS_SEARCHPREF_DEREF_ALIASES
     * @type {Integer (Int32)}
     */
    static DEREF_ALIASES => 1
     ...
     * Native name: ADS_SEARCHPREF_SIZE_LIMIT
     * @type {Integer (Int32)}
     */
    static SIZE_LIMIT => 2
     ...
     * Native name: ADS_SEARCHPREF_TIME_LIMIT
     * @type {Integer (Int32)}
     */
    static TIME_LIMIT => 3
     ...
     * Native name: ADS_SEARCHPREF_ATTRIBTYPES_ONLY
     * @type {Integer (Int32)}
     */
    static ATTRIBTYPES_ONLY => 4
     ...
     * Native name: ADS_SEARCHPREF_SEARCH_SCOPE
     * @type {Integer (Int32)}
     */
    static SEARCH_SCOPE => 5
     ...
     * Native name: ADS_SEARCHPREF_TIMEOUT
     * @type {Integer (Int32)}
     */
    static TIMEOUT => 6
     ...
     * Native name: ADS_SEARCHPREF_PAGESIZE
     * @type {Integer (Int32)}
     */
    static PAGESIZE => 7
     ...
     * Native name: ADS_SEARCHPREF_PAGED_TIME_LIMIT
     * @type {Integer (Int32)}
     */
    static PAGED_TIME_LIMIT => 8
     ...
     * Native name: ADS_SEARCHPREF_CHASE_REFERRALS
     * @type {Integer (Int32)}
     */
    static CHASE_REFERRALS => 9
     ...
     * Native name: ADS_SEARCHPREF_SORT_ON
     * @type {Integer (Int32)}
     */
    static SORT_ON => 10
     ...
     * Native name: ADS_SEARCHPREF_CACHE_RESULTS
     * @type {Integer (Int32)}
     */
    static CACHE_RESULTS => 11
     ...
     * Native name: ADS_SEARCHPREF_DIRSYNC
     * @type {Integer (Int32)}
     */
    static DIRSYNC => 12
     ...
     * Native name: ADS_SEARCHPREF_TOMBSTONE
     * @type {Integer (Int32)}
     */
    static TOMBSTONE => 13
     ...
     * Native name: ADS_SEARCHPREF_VLV
     * @type {Integer (Int32)}
     */
    static VLV => 14
     ...
     * Native name: ADS_SEARCHPREF_ATTRIBUTE_QUERY
     * @type {Integer (Int32)}
     */
    static ATTRIBUTE_QUERY => 15

    /**
     * Native name: ADS_SEARCHPREF_SECURITY_MASK
     * @type {Integer (Int32)}
     */
    static SECURITY_MASK => 16

    /**
     * Native name: ADS_SEARCHPREF_DIRSYNC_FLAG
     * @type {Integer (Int32)}
     */
    static DIRSYNC_FLAG => 17
     ...
     * Native name: ADS_SEARCHPREF_EXTENDED_DN
     * @type {Integer (Int32)}
     */
    static EXTENDED_DN => 18
}
