...
class DS_REPL_INFO_TYPE extends Win32Enum {
     ...
     * Native name: DS_REPL_INFO_NEIGHBORS
     * @type {Integer (Int32)}
     */
    static NEIGHBORS => 0
     ...
     * Native name: DS_REPL_INFO_CURSORS_FOR_NC
     * @type {Integer (Int32)}
     */
    static CURSORS_FOR_NC => 1
     ...
     * Native name: DS_REPL_INFO_METADATA_FOR_OBJ
     * @type {Integer (Int32)}
     */
    static METADATA_FOR_OBJ => 2
     ...
     * Native name: DS_REPL_INFO_KCC_DSA_CONNECT_FAILURES
     * @type {Integer (Int32)}
     */
    static KCC_DSA_CONNECT_FAILURES => 3
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/ntdsapi/ns-ntdsapi-ds_repl_kcc_dsa_failuresw">DS_REPL_KCC_DSA_FAILURES</a> structure.
     * Native name: DS_REPL_INFO_KCC_DSA_LINK_FAILURES
     * @type {Integer (Int32)}
     */
    static KCC_DSA_LINK_FAILURES => 4
     ...
     * Native name: DS_REPL_INFO_PENDING_OPS
     * @type {Integer (Int32)}
     */
    static PENDING_OPS => 5
     ...
     * Native name: DS_REPL_INFO_METADATA_2_FOR_OBJ
     * @type {Integer (Int32)}
     */
    static METADATA_2_FOR_OBJ => 9
     ...
     * Native name: DS_REPL_INFO_METADATA_2_FOR_ATTR_VALUE
     * @type {Integer (Int32)}
     */
    static METADATA_2_FOR_ATTR_VALUE => 10

    /**
     * Native name: DS_REPL_INFO_METADATA_EXT_FOR_ATTR_VALUE
     * @type {Integer (Int32)}
     */
    static METADATA_EXT_FOR_ATTR_VALUE => 11

    /**
     * Native name: DS_REPL_INFO_TYPE_MAX
     * @type {Integer (Int32)}
     */
    static MAX => 12
}
