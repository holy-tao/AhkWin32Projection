 ...
 * @charset Unicode
 */
class DS_REPSYNCALL_ERRINFOW extends Win32Struct
{
    static sizeof => 24
    ...
    pszSvrId{
        get {
            if(!this.HasProp("__pszSvrId"))
                this.__pszSvrId := PWSTR(this.ptr + 0)
            return this.__pszSvrId
        }
    }
    ...
    pszSrcId{
        get {
            if(!this.HasProp("__pszSrcId"))
                this.__pszSrcId := PWSTR(this.ptr + 16)
