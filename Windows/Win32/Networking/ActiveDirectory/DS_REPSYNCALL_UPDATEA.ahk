 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ntdsapi/ns-ntdsapi-ds_repsyncall_updatea
 * @namespace Windows.Win32.Networking.ActiveDirectory
 * @version v4.0.30319
 * @charset ANSI
 */
class DS_REPSYNCALL_UPDATEA extends Win32Struct
{
    static sizeof => 24
     ...
     * @type {Pointer<DS_REPSYNCALL_ERRINFOA>}
     */
    pErrInfo {
     ...
     * @type {Pointer<DS_REPSYNCALL_SYNCA>}
     */
    pSync {
