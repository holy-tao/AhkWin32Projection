...
class IADsUser extends IADs{
    ...
    get_LastLogin(retval) {
        result := ComCall(22, this, "double*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_LastFailedLogin(retval) {
        result := ComCall(24, this, "double*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_PasswordLastChanged(retval) {
        result := ComCall(25, this, "double*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_AccountExpirationDate(retval) {
        result := ComCall(70, this, "double*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_GraceLoginsAllowed(retval) {
        result := ComCall(72, this, "int*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_GraceLoginsRemaining(retval) {
        result := ComCall(74, this, "int*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_MaxLogins(retval) {
        result := ComCall(82, this, "int*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_MaxStorage(retval) {
        result := ComCall(84, this, "int*", retval, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_PasswordExpirationDate(retval) {
        result := ComCall(86, this, "double*", retval, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    Groups(ppGroups) {
        result := ComCall(108, this, "ptr", ppGroups, "int")
        if(result != 0)
            throw OSError(result)
