 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//dsgetdc/ns-dsgetdc-domain_controller_infoa
    ...
    DomainControllerName{
        get {
            if(!this.HasProp("__DomainControllerName"))
                this.__DomainControllerName := PSTR(this.ptr + 0)
    ...
    DomainControllerAddress{
        get {
            if(!this.HasProp("__DomainControllerAddress"))
                this.__DomainControllerAddress := PSTR(this.ptr + 8)
    ...
    DomainName{
        get {
            if(!this.HasProp("__DomainName"))
                this.__DomainName := PSTR(this.ptr + 32)
    ...
    DnsForestName{
        get {
            if(!this.HasProp("__DnsForestName"))
                this.__DnsForestName := PSTR(this.ptr + 40)
    ...
    DcSiteName{
        get {
            if(!this.HasProp("__DcSiteName"))
                this.__DcSiteName := PSTR(this.ptr + 56)
    ...
    ClientSiteName{
        get {
            if(!this.HasProp("__ClientSiteName"))
                this.__ClientSiteName := PSTR(this.ptr + 64)
