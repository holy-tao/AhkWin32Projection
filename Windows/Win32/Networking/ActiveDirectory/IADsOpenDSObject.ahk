 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-iadsopendsobject
...
class IADsOpenDSObject extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadsopendsobject-opendsobject
     */
    OpenDSObject(lpszDNName, lpszUserName, lpszPassword, lnReserved) {
        if(lpszDNName is String) {
            pin := BSTR.Alloc(lpszDNName)
            lpszDNName := pin.Value
        }
        ...
        result := ComCall(7, this, "ptr", lpszDNName, "ptr", lpszUserName, "ptr", lpszPassword, "int", lnReserved, "ptr*", &ppOleDsObj := 0, "int")
        if(result != 0) {
