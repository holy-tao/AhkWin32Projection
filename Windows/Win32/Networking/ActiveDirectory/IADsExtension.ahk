 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-iadsextension
...
class IADsExtension extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadsextension-operate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadsextension-privategetidsofnames
     */
    PrivateGetIDsOfNames(riid, rgszNames, cNames, lcid) {
        rgszNamesMarshal := rgszNames is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, "ptr", riid, rgszNamesMarshal, rgszNames, "uint", cNames, "uint", lcid, "int*", &rgDispid := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * For more information about other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadsextension-privateinvoke
     */
    PrivateInvoke(dispidMember, riid, lcid, wFlags, pdispparams, pvarResult, pexcepinfo, puArgErr) {
        ...
        result := ComCall(5, this, "int", dispidMember, "ptr", riid, "uint", lcid, "ushort", wFlags, "ptr", pdispparams, "ptr", pvarResult, "ptr", pexcepinfo, puArgErrMarshal, puArgErr, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
