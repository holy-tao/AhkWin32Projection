 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-iadspropertyvalue2
...
class IADsPropertyValue2 extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertyvalue2-getobjectproperty
     */
    GetObjectProperty(lnADsType) {
        lnADsTypeMarshal := lnADsType is VarRef ? "int*" : "ptr"

        pvProp := VARIANT()
        result := ComCall(7, this, lnADsTypeMarshal, lnADsType, "ptr", pvProp, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspropertyvalue2-putobjectproperty
     */
    PutObjectProperty(lnADsType, vProp) {
        result := ComCall(8, this, "int", lnADsType, "ptr", vProp, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
