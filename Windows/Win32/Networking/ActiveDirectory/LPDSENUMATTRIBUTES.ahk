 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dsclient/nc-dsclient-lpdsenumattributes
 * @namespace Windows.Win32.Networking.ActiveDirectory
 * @version v4.0.30319
 */
class LPDSENUMATTRIBUTES extends IUnknown {
     ...
     */
    Invoke(lParam_, pszAttributeName, pszDisplayName, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", lParam_, "ptr", pszAttributeName, "ptr", pszDisplayName, "uint", dwFlags, "int")
        if(result != 0) {
