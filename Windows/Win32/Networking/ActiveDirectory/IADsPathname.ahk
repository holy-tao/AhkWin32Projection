...
class IADsPathname extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-set
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-setdisplaytype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-retrieve
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-getnumelements
     */
    GetNumElements() {
        result := ComCall(10, this, "int*", &plnNumPathElements := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-getelement
     */
     ...
     * 
     * For more information and other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-addleafelement
     */
    AddLeafElement(bstrLeafElement) {
        if(bstrLeafElement is String) {
            pin := BSTR.Alloc(bstrLeafElement)
            bstrLeafElement := pin.Value
        }
     ...
     * 
     * For more information and  other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-removeleafelement
     */
    RemoveLeafElement() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-copypath
     */
    CopyPath() {
        result := ComCall(14, this, "ptr*", &ppAdsPath := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadspathname-getescapedelement
     */
    GetEscapedElement(lnReserved, bstrInStr) {
        if(bstrInStr is String) {
            pin := BSTR.Alloc(bstrInStr)
            bstrInStr := pin.Value
        }
