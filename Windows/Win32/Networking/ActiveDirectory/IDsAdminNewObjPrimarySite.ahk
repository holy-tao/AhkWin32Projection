 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nn-dsadmin-idsadminnewobjprimarysite
...
class IDsAdminNewObjPrimarySite extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nf-dsadmin-idsadminnewobjprimarysite-createnew
     */
    CreateNew(pszName) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dsadmin/nf-dsadmin-idsadminnewobjprimarysite-commit
     */
    Commit() {
