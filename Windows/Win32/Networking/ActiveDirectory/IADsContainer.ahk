 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-iadscontainer
...
class IADsContainer extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-get__newenum
     */
    get__NewEnum() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-getobject
     */
    GetObject(ClassName, RelativeName) {
        if(ClassName is String) {
            pin := BSTR.Alloc(ClassName)
            ClassName := pin.Value
        }
        if(RelativeName is String) {
            pin := BSTR.Alloc(RelativeName)
            RelativeName := pin.Value
        }

        result := ComCall(13, this, "ptr", ClassName, "ptr", RelativeName, "ptr*", &ppObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-create
     */
    Create(ClassName, RelativeName) {
        ...
        result := ComCall(14, this, "ptr", ClassName, "ptr", RelativeName, "ptr*", &ppObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-delete
     */
    Delete(bstrClassName, bstrRelativeName) {
        if(bstrClassName is String) {
            pin := BSTR.Alloc(bstrClassName)
            bstrClassName := pin.Value
        }
        if(bstrRelativeName is String) {
            pin := BSTR.Alloc(bstrRelativeName)
            bstrRelativeName := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-copyhere
     */
    CopyHere(SourceName, NewName) {
        if(SourceName is String) {
            pin := BSTR.Alloc(SourceName)
            SourceName := pin.Value
        }
        ...
        result := ComCall(16, this, "ptr", SourceName, "ptr", NewName, "ptr*", &ppObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *     object.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-iadscontainer-movehere
     */
    MoveHere(SourceName, NewName) {
        ...
        result := ComCall(17, this, "ptr", SourceName, "ptr", NewName, "ptr*", &ppObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
