 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-idirectorysearch
...
class IDirectorySearch extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-setsearchpreference
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-executesearch
     */
    ExecuteSearch(pszSearchFilter, pAttributeNames, dwNumberAttributes) {
        ...
        result := ComCall(4, this, "ptr", pszSearchFilter, pAttributeNamesMarshal, pAttributeNames, "uint", dwNumberAttributes, "ptr", phSearchResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-abandonsearch
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-getfirstrow
     */
     ...
     * 
     * For more information, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-getnextrow
     */
     ...
     * 
     * For other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-getpreviousrow
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-getnextcolumnname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-getcolumn
     */
     ...
     * 
     * For other return values, see <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-freecolumn
     */
     ...
     * 
     * For other return values, see  <a href="https://docs.microsoft.com/windows/desktop/ADSI/adsi-error-codes">ADSI Error Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectorysearch-closesearchhandle
     */
