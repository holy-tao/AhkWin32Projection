...
#Include .\DS_REPL_VALUE_META_DATA_2.ahk

/**
 * Used with the DsReplicaGetInfo2 function to provide metadata for a collection of attribute values.
 * @see https://learn.microsoft.com/windows/win32/api//content/ntdsapi/ns-ntdsapi-ds_repl_attr_value_meta_data_2
 * @namespace Windows.Win32.Networking.ActiveDirectory
 * @version v4.0.30319
 */
class DS_REPL_ATTR_VALUE_META_DATA_2 extends Win32Struct
{
    static sizeof => 16
     ...
     * @type {Array<DS_REPL_VALUE_META_DATA_2>}
     */
    rgMetaData{
        get {
            if(!this.HasProp("__rgMetaDataProxyArray"))
                this.__rgMetaDataProxyArray := Win32FixedArray(this.ptr + 8, 1, DS_REPL_VALUE_META_DATA_2, "")
