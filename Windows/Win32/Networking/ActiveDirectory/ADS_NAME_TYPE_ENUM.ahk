...
class ADS_NAME_TYPE_ENUM extends Win32Enum {
     ...
     * Native name: ADS_NAME_TYPE_1779
     * @type {Integer (Int32)}
     */
    static 1779 => 1
     ...
     * Native name: ADS_NAME_TYPE_CANONICAL
     * @type {Integer (Int32)}
     */
    static CANONICAL => 2
     ...
     * Native name: ADS_NAME_TYPE_DISPLAY
     * @type {Integer (Int32)}
     */
    static DISPLAY => 4
     ...
     * Native name: ADS_NAME_TYPE_DOMAIN_SIMPLE
     * @type {Integer (Int32)}
     */
    static DOMAIN_SIMPLE => 5

    /**
     * Simple enterprise name format. For example, "JeffSmith@Fabrikam.com".
     * Native name: ADS_NAME_TYPE_ENTERPRISE_SIMPLE
     * @type {Integer (Int32)}
     */
    static ENTERPRISE_SIMPLE => 6

    /**
     * Global Unique Identifier format. For example, "{95ee9fff-3436-11d1-b2b0-d15ae3ac8436}".
     * Native name: ADS_NAME_TYPE_GUID
     * @type {Integer (Int32)}
     */
    static GUID => 7
     ...
     * Native name: ADS_NAME_TYPE_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 8
     ...
     * Native name: ADS_NAME_TYPE_USER_PRINCIPAL_NAME
     * @type {Integer (Int32)}
     */
    static USER_PRINCIPAL_NAME => 9

    /**
     * Extended canonical name format. For example, "Fabrikam.com/Users Jeff Smith".
     * Native name: ADS_NAME_TYPE_CANONICAL_EX
     * @type {Integer (Int32)}
     */
    static CANONICAL_EX => 10

    /**
     * Service principal name format. For example, "www/www.fabrikam.com@fabrikam.com".
     * Native name: ADS_NAME_TYPE_SERVICE_PRINCIPAL_NAME
     * @type {Integer (Int32)}
     */
    static SERVICE_PRINCIPAL_NAME => 11
     ...
     * Native name: ADS_NAME_TYPE_SID_OR_SID_HISTORY_NAME
     * @type {Integer (Int32)}
     */
    static SID_OR_SID_HISTORY_NAME => 12
}
