 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cmnquery/nn-cmnquery-icommonquery
...
class ICommonQuery extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cmnquery/nf-cmnquery-icommonquery-openquerywindow
     */
    OpenQueryWindow(hwndParent, pQueryWnd) {
        hwndParent := hwndParent is Win32Handle ? NumGet(hwndParent, "ptr") : hwndParent

        result := ComCall(3, this, "ptr", hwndParent, "ptr", pQueryWnd, "ptr*", &ppDataObject := 0, "int")
        if(result != 0) {
