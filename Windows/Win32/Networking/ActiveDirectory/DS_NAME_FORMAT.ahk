...
class DS_NAME_FORMAT extends Win32Enum {
     ...
     * Native name: DS_UNKNOWN_NAME
     * @type {Integer (Int32)}
     */
    static UNKNOWN_NAME => 0
     ...
     * Native name: DS_FQDN_1779_NAME
     * @type {Integer (Int32)}
     */
    static FQDN_1779_NAME => 1
     ...
     * Native name: DS_NT4_ACCOUNT_NAME
     * @type {Integer (Int32)}
     */
    static NT4_ACCOUNT_NAME => 2
     ...
     * Native name: DS_DISPLAY_NAME
     * @type {Integer (Int32)}
     */
    static DISPLAY_NAME => 3
     ...
     * Native name: DS_UNIQUE_ID_NAME
     * @type {Integer (Int32)}
     */
    static UNIQUE_ID_NAME => 6
     ...
     * Native name: DS_CANONICAL_NAME
     * @type {Integer (Int32)}
     */
    static CANONICAL_NAME => 7

    /**
     * Indicates that it is using the user principal name (UPN). For example:
     * 
     * someone@engineering.fabrikam.com
     * Native name: DS_USER_PRINCIPAL_NAME
     * @type {Integer (Int32)}
     */
    static USER_PRINCIPAL_NAME => 8
     ...
     * Native name: DS_CANONICAL_NAME_EX
     * @type {Integer (Int32)}
     */
    static CANONICAL_NAME_EX => 9

    /**
     * Indicates it is using a generalized service principal name. For example:
     * 
     * www/www.fabrikam.com@fabrikam.com
     * Native name: DS_SERVICE_PRINCIPAL_NAME
     * @type {Integer (Int32)}
     */
    static SERVICE_PRINCIPAL_NAME => 10
     ...
     * Native name: DS_SID_OR_SID_HISTORY_NAME
     * @type {Integer (Int32)}
     */
    static SID_OR_SID_HISTORY_NAME => 11

    /**
     * Not supported by the Directory Service (DS) APIs.
     * Native name: DS_DNS_DOMAIN_NAME
     * @type {Integer (Int32)}
     */
    static DNS_DOMAIN_NAME => 12
}
