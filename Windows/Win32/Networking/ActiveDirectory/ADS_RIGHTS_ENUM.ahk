...
class ADS_RIGHTS_ENUM extends Win32Enum {
     ...
     * Native name: ADS_RIGHT_WRITE_OWNER
     * @type {Integer (Int32)}
     */
    static RIGHT_WRITE_OWNER => 524288

    /**
     * The right to use the object for synchronization. This enables a thread to wait until the object is in the signaled state.
     * Native name: ADS_RIGHT_SYNCHRONIZE
     * @type {Integer (Int32)}
     */
    static RIGHT_SYNCHRONIZE => 1048576

    /**
     * The right to get or set the SACL in the object security descriptor.
     * Native name: ADS_RIGHT_ACCESS_SYSTEM_SECURITY
     * @type {Integer (Int32)}
     */
    static RIGHT_ACCESS_SYSTEM_SECURITY => 16777216
     ...
     * Native name: ADS_RIGHT_GENERIC_READ
     * @type {Integer (Int32)}
     */
    static RIGHT_GENERIC_READ => -2147483648
     ...
     * Native name: ADS_RIGHT_GENERIC_WRITE
     * @type {Integer (Int32)}
     */
    static RIGHT_GENERIC_WRITE => 1073741824

    /**
     * The right to read permissions on, and list the contents of,  a container object.
     * Native name: ADS_RIGHT_GENERIC_EXECUTE
     * @type {Integer (Int32)}
     */
    static RIGHT_GENERIC_EXECUTE => 536870912
     ...
     * Native name: ADS_RIGHT_GENERIC_ALL
     * @type {Integer (Int32)}
     */
    static RIGHT_GENERIC_ALL => 268435456
     ...
     * Native name: ADS_RIGHT_DS_CREATE_CHILD
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_CREATE_CHILD => 1
     ...
     * Native name: ADS_RIGHT_DS_DELETE_CHILD
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_DELETE_CHILD => 2
     ...
     * Native name: ADS_RIGHT_ACTRL_DS_LIST
     * @type {Integer (Int32)}
     */
    static RIGHT_ACTRL_DS_LIST => 4
     ...
     * Native name: ADS_RIGHT_DS_SELF
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_SELF => 8
     ...
     * Native name: ADS_RIGHT_DS_READ_PROP
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_READ_PROP => 16
     ...
     * Native name: ADS_RIGHT_DS_WRITE_PROP
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_WRITE_PROP => 32

    /**
     * The right to delete all child objects of this object, regardless of the permissions of the child objects.
     * Native name: ADS_RIGHT_DS_DELETE_TREE
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_DELETE_TREE => 64
     ...
     * Native name: ADS_RIGHT_DS_LIST_OBJECT
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_LIST_OBJECT => 128
     ...
     * Native name: ADS_RIGHT_DS_CONTROL_ACCESS
     * @type {Integer (Int32)}
     */
    static RIGHT_DS_CONTROL_ACCESS => 256
}
