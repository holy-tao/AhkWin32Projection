 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/iads/nn-iads-idirectoryobject
...
class IDirectoryObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectoryobject-getobjectinformation
     */
    GetObjectInformation() {
        result := ComCall(3, this, "ptr*", &ppObjInfo := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectoryobject-getobjectattributes
     */
    GetObjectAttributes(pAttributeNames, dwNumberAttributes, ppAttributeEntries, pdwNumAttributesReturned) {
        ...
        result := ComCall(4, this, pAttributeNamesMarshal, pAttributeNames, "uint", dwNumberAttributes, ppAttributeEntriesMarshal, ppAttributeEntries, pdwNumAttributesReturnedMarshal, pdwNumAttributesReturned, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectoryobject-setobjectattributes
     */
    SetObjectAttributes(pAttributeEntries, dwNumAttributes) {
        result := ComCall(5, this, "ptr", pAttributeEntries, "uint", dwNumAttributes, "uint*", &pdwNumAttributesModified := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectoryobject-createdsobject
     */
    CreateDSObject(pszRDNName, pAttributeEntries, dwNumAttributes) {
        pszRDNName := pszRDNName is String ? StrPtr(pszRDNName) : pszRDNName

        result := ComCall(6, this, "ptr", pszRDNName, "ptr", pAttributeEntries, "uint", dwNumAttributes, "ptr*", &ppObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/iads/nf-iads-idirectoryobject-deletedsobject
     */
