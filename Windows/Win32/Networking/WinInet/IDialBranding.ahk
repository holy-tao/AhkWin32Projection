 ...
 */
export default struct IDialBranding extends IUnknown {
    /**
     ...
     * used for IDialBranding interfaces
    */
    ...
    Initialize(pwzConnectoid) {
        ...
        result := ComCall(3, this, "ptr", pwzConnectoid, "HRESULT")
        return result
    }
    ...
    GetBitmap(dwIndex) {
        ...
        result := ComCall(4, this, UInt32, dwIndex, HBITMAP.Ptr, phBitmap, "HRESULT")
        return phBitmap
    }

    _Query(iid) {
        if (IDialBranding.IID.Equals(iid)) {
            return true
        }
