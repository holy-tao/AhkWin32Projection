...
/**
 * Contains the information for a particular cache group. (Unicode)
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wininet/ns-wininet-internet_cache_group_infow
...
class INTERNET_CACHE_GROUP_INFOW extends Win32Struct
{
     ...
     */
    szGroupName {
        get => StrGet(this.ptr + 36, 119, "UTF-16")
        set => StrPut(value, this.ptr + 36, 119, "UTF-16")
    }
}
