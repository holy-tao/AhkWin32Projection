 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/proofofpossessioncookieinfo/nn-proofofpossessioncookieinfo-iproofofpossessioncookieinfomanager2
...
class IProofOfPossessionCookieInfoManager2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/proofofpossessioncookieinfo/nf-proofofpossessioncookieinfo-iproofofpossessioncookieinfomanager2-getcookieinfowithuriforaccount
     */
    GetCookieInfoWithUriForAccount(webAccount, uri, cookieInfoCount, cookieInfo) {
        ...
        result := ComCall(3, this, "ptr", webAccount, "ptr", uri, cookieInfoCountMarshal, cookieInfoCount, cookieInfoMarshal, cookieInfo, "int")
        if(result != 0) {
