 ...
 */
export default struct IDialEventSink extends IUnknown {
    /**
     ...
     * used for IDialEventSink interfaces
    */
    ...
    OnEvent(dwEvent, dwStatus) {
        result := ComCall(3, this, UInt32, dwEvent, UInt32, dwStatus, "HRESULT")
        return result
    }

    Query(iid) {
        if (IDialEventSink.IID.Equals(iid)) {
            return true
        }
