...
/**
 * Contains both the data and header information. (Unicode)
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wininet/ns-wininet-internet_buffersw
 * @namespace Windows.Win32.Networking.WinInet
 * @version v4.0.30319
 * @charset Unicode
 */
class INTERNET_BUFFERSW extends Win32Struct
{
    static sizeof => 56
     ...
     * @type {Pointer<INTERNET_BUFFERSW>}
     */
    Next {
