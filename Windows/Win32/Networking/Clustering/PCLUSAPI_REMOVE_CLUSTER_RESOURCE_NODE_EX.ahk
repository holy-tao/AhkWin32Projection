 ...
 * @version v4.0.30319
 */
class PCLUSAPI_REMOVE_CLUSTER_RESOURCE_NODE_EX extends IUnknown {
     ...
     */
    Invoke(hResource_, hNode_, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", hNode_, "ptr", lpszReason, "uint")
        return result
    }
}
