 ...
 * @version v4.0.30319
 */
class PCLUSAPI_DESTROY_CLUSTER extends IUnknown {
     ...
     */
    Invoke(hCluster_, pfnProgressCallback, pvCallbackArg, fdeleteVirtualComputerObjects) {
        hCluster_ := hCluster_ is Win32Handle ? NumGet(hCluster_, "ptr") : hCluster_

        pvCallbackArgMarshal := pvCallbackArg is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", hCluster_, "ptr", pfnProgressCallback, pvCallbackArgMarshal, pvCallbackArg, "int", fdeleteVirtualComputerObjects, "uint")
        return result
    }
}
