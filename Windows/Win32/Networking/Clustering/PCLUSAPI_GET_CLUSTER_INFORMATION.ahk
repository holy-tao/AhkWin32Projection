 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_INFORMATION extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszClusterName, lpcchClusterName, lpClusterInfo) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszClusterName, lpcchClusterNameMarshal, lpcchClusterName, "ptr", lpClusterInfo, "uint")
        return result
    }
}
