 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nn-cluadmex-igetclusterobjectinfo
...
class IGetClusterObjectInfo extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-igetclusterobjectinfo-getobjectname
     */
    GetObjectName(lObjIndex, lpszName, pcchName) {
        ...
        result := ComCall(3, this, "int", lObjIndex, "ptr", lpszName, pcchNameMarshal, pcchName, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-igetclusterobjectinfo-getobjecttype
     */
