 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_DWORD_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, pdwOutValue, dwDefaultValue) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, pdwOutValueMarshal, pdwOutValue, "uint", dwDefaultValue, "uint")
        return result
    }
}
