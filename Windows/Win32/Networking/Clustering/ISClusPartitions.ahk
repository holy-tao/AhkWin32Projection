 ...
 */
export default struct ISClusPartitions extends IDispatch {
    /**
     ...
     * used for ISClusPartitions interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISClusPartitions.Vtbl()
        }
     ...
     */
    get_Item(varIndex) {
        result := ComCall(9, this, VARIANT, varIndex, "ptr*", &ppPartition := 0, "HRESULT")
