 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nn-cluadmex-iwccontextmenucallback
...
class IWCContextMenuCallback extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-iwccontextmenucallback-addextensionmenuitem
     */
    AddExtensionMenuItem(lpszName, lpszStatusBarText, nCommandID, nSubmenuCommandID, uFlags) {
        ...
        if(lpszStatusBarText is String) {
            pin := BSTR.Alloc(lpszStatusBarText)
            lpszStatusBarText := pin.Value
        }

        result := ComCall(3, this, "ptr", lpszName, "ptr", lpszStatusBarText, "uint", nCommandID, "uint", nSubmenuCommandID, "uint", uFlags, "int")
        if(result != 0) {
