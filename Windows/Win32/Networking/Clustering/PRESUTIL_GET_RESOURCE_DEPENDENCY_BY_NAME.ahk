 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_NAME extends IUnknown {
     ...
     */
    Invoke(hCluster_, hSelf, lpszResourceType, bRecurse) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", hSelf, "ptr", lpszResourceType, "int", bRecurse, "ptr")
