 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL_AS_USER_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszResourceTypeName, "ptr", hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, "uint")
        return result
    }
}
