 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_PROPERTIES_TO_PARAMETER_BLOCK extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pPropertyTable, pOutParams, bCheckForRequiredProperties, pszNameOfPropInError) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pPropertyTable, pOutParamsMarshal, pOutParams, "int", bCheckForRequiredProperties, pszNameOfPropInErrorMarshal, pszNameOfPropInError, "uint")
        return result
    }
}
