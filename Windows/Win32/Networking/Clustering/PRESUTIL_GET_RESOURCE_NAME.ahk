 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_RESOURCE_NAME extends IUnknown {
     ...
     */
    Invoke(hResource_, pszResourceName, pcchResourceNameInOut) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", pszResourceName, pcchResourceNameInOutMarshal, pcchResourceNameInOut, "uint")
        return result
    }
}
