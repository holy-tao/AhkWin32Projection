 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_MULTI_SZ_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, pszNewValue, cbNewValueSize, ppszOutValue, pcbOutValueSize) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, "ptr", pszNewValue, "uint", cbNewValueSize, ppszOutValueMarshal, ppszOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, "uint")
        return result
    }
}
