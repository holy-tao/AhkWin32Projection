 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/resapi/nc-resapi-plooks_alive_routine
 * @namespace Windows.Win32.Networking.Clustering
 * @version v4.0.30319
 */
class PLOOKS_ALIVE_ROUTINE extends IUnknown {
    ...
    Invoke(Resource) {
        ...
        result := ComCall(3, this, ResourceMarshal, Resource, "int")
        return result
    }
}
