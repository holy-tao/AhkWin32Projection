 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_RESOURCE_SERVICE_START_PARAMETERS_EX extends IUnknown {
     ...
     */
    Invoke(pszServiceName, schSCMHandle, phService, dwDesiredAccess, pfnLogEvent, hResourceHandle) {
        ...
        result := ComCall(3, this, "ptr", pszServiceName, "ptr", schSCMHandle, "ptr", phService, "uint", dwDesiredAccess, "ptr", pfnLogEvent, "ptr", hResourceHandle, "uint")
        return result
    }
}
