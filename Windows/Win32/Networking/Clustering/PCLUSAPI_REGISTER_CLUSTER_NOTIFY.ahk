 ...
 * @version v4.0.30319
 */
class PCLUSAPI_REGISTER_CLUSTER_NOTIFY extends IUnknown {
     ...
     */
    Invoke(hChange_, dwFilterType, hObject, dwNotifyKey) {
        hChange_ := hChange_ is Win32Handle ? NumGet(hChange_, "ptr") : hChange_
        hObject := hObject is Win32Handle ? NumGet(hObject, "ptr") : hObject

        result := ComCall(3, this, "ptr", hChange_, "uint", dwFilterType, "ptr", hObject, "ptr", dwNotifyKey, "uint")
        return result
    }
}
