 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_ENUM_VALUE extends IUnknown {
     ...
     */
    Invoke(hKey_, dwIndex, lpszValueName, lpcchValueName, lpdwType, lpData, lpcbData) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "uint", dwIndex, "ptr", lpszValueName, lpcchValueNameMarshal, lpcchValueName, lpdwTypeMarshal, lpdwType, "ptr", lpData, lpcbDataMarshal, lpcbData, "uint")
        return result
    }
}
