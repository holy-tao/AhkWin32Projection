 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_SET_VALUE_EX extends IUnknown {
     ...
     */
    Invoke(hKey_, lpszValueName, dwType, lpData, cbData, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "ptr", lpszValueName, "uint", dwType, lpDataMarshal, lpData, "uint", cbData, "ptr", lpszReason, "uint")
        return result
    }
}
