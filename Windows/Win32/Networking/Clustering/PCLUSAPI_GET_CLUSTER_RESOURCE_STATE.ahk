 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_RESOURCE_STATE extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszNodeName, lpcchNodeName, lpszGroupName, lpcchGroupName) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszNodeName, lpcchNodeNameMarshal, lpcchNodeName, "ptr", lpszGroupName, lpcchGroupNameMarshal, lpcchGroupName, "int")
        return result
    }
}
