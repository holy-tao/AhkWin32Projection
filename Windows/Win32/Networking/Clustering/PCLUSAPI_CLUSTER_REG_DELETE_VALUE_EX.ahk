 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_DELETE_VALUE_EX extends IUnknown {
     ...
     */
    Invoke(hKey_, lpszValueName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "ptr", lpszValueName, "ptr", lpszReason, "uint")
        return result
    }
}
