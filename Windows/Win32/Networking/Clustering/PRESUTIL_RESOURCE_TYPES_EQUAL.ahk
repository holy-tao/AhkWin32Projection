 ...
 * @version v4.0.30319
 */
class PRESUTIL_RESOURCE_TYPES_EQUAL extends IUnknown {
     ...
     */
    Invoke(lpszResourceTypeName, hResource_) {
        ...
        result := ComCall(3, this, "ptr", lpszResourceTypeName, "ptr", hResource_, "int")
        return result
    }
}
