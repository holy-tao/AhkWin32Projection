 ...
 * @see https://learn.microsoft.com/windows/win32/api/resapi/nc-resapi-pextend_res_control_call
 * @namespace Windows.Win32.Networking.Clustering
 */
export default struct PEXTEND_RES_CONTROL_CALL {
    value : IntPtr

    __value {
        set {
            if (value is PEXTEND_RES_CONTROL_CALL) {
    ...
    /**
     * A PEXTEND_RES_CONTROL_CALL that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PEXTEND_RES_CONTROL_CALL {
        /**
         * Creates a PEXTEND_RES_CONTROL_CALL pointer that invokes the given AHK function when called.
