 ...
 */
export default struct ISClusResGroupResources extends IDispatch {
    /**
     ...
     * used for ISClusResGroupResources interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISClusResGroupResources.Vtbl()
        }
    ...
    _Query(iid) {
        if (ISClusResGroupResources.IID.Equals(iid)) {
            return true
        }
