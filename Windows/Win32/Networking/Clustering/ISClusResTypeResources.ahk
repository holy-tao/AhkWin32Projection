 ...
 * @version v4.0.30319
 */
class ISClusResTypeResources extends IDispatch{
     ...
     * @returns {HRESULT} 
     */
    CreateItem(bstrResourceName, bstrGroupName, dwFlags, ppClusterResource) {
        ...
        result := ComCall(11, this, "ptr", bstrResourceName, "ptr", bstrGroupName, "int", dwFlags, "ptr*", ppClusterResource, "HRESULT")
        return result
    }
