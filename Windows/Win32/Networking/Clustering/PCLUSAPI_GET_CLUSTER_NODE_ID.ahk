 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_NODE_ID extends IUnknown {
     ...
     */
    Invoke(hNode_, lpszNodeId, lpcchName) {
        ...
        result := ComCall(3, this, "ptr", hNode_, "ptr", lpszNodeId, lpcchNameMarshal, lpcchName, "uint")
        return result
    }
}
