 ...
 */
export default struct PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY) {
    ...
    /**
     * A PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY {
        /**
         * Creates a PCLUSAPI_REMOVE_CROSS_CLUSTER_GROUPSET_DEPENDENCY pointer that invokes the given AHK function when called.
