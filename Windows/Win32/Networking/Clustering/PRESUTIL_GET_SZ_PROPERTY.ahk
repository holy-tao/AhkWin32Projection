 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_SZ_PROPERTY extends IUnknown {
     ...
     */
    Invoke(ppszOutValue, pValueStruct, pszOldValue, ppPropertyList, pcbPropertyListSize) {
        ...
        result := ComCall(3, this, ppszOutValueMarshal, ppszOutValue, "ptr", pValueStruct, "ptr", pszOldValue, "ptr", ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, "uint")
        return result
    }
}
