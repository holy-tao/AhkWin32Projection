...
/**
 * CLUSTER_RESOURCE_ENUM_ITEM represents the properties of a cluster resource and is used to enumerate cluster resources in the ClusterResourceEnumEx function.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ns-clusapi-cluster_resource_enum_item
