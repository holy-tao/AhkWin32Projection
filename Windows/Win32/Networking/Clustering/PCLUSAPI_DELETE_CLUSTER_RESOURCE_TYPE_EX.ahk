 ...
 * @version v4.0.30319
 */
class PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszTypeName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszTypeName, "ptr", lpszReason, "uint")
        return result
    }
}
