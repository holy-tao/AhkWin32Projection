 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_ENUM extends IUnknown {
     ...
     */
    Invoke(hEnum, dwIndex, lpdwType, lpszName, lpcchName) {
        ...
        result := ComCall(3, this, "ptr", hEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, "uint")
        return result
    }
}
