 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_RESOURCE_DEPENDENCY_EX extends IUnknown {
     ...
     */
    Invoke(hSelf, lpszResourceType, dwDesiredAccess) {
        ...
        result := ComCall(3, this, "ptr", hSelf, "ptr", lpszResourceType, "uint", dwDesiredAccess, "ptr")
