 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_RESOURCE_NAME extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszResourceName) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszResourceName, "uint")
        return result
    }
}
