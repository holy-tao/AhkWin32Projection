 ...
 */
export default struct PRESUTIL_GET_PRIVATE_PROPERTIES {
    value : IntPtr

    __value {
        set {
            if (value is PRESUTIL_GET_PRIVATE_PROPERTIES) {
    ...
    /**
     * A PRESUTIL_GET_PRIVATE_PROPERTIES that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PRESUTIL_GET_PRIVATE_PROPERTIES {
        /**
         * Creates a PRESUTIL_GET_PRIVATE_PROPERTIES pointer that invokes the given AHK function when called.
