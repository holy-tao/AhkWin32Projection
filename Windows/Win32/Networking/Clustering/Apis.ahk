 ...
 */
export ClusapiSetReasonHandler(lpHandler) {
    result := DllCall("CLUSAPI.dll\ClusapiSetReasonHandler", CLUSAPI_REASON_HANDLER.Ptr, lpHandler, CLUSAPI_REASON_HANDLER.Ptr)
    return result
}
...
export OpenClusterEx(lpszClusterName, DesiredAccess, GrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterEx", "ptr", lpszClusterName, "uint", DesiredAccess, GrantedAccessMarshal, GrantedAccess, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export CloseCluster(_hCluster) {
    result := DllCall("CLUSAPI.dll\CloseCluster", HCLUSTER, _hCluster, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export SetClusterName(_hCluster, lpszNewClusterName) {
    lpszNewClusterName := lpszNewClusterName is String ? StrPtr(lpszNewClusterName) : lpszNewClusterName

    result := DllCall("CLUSAPI.dll\SetClusterName", HCLUSTER, _hCluster, "ptr", lpszNewClusterName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterNameEx(_hCluster, lpszNewClusterName, lpszReason) {
    lpszNewClusterName := lpszNewClusterName is String ? StrPtr(lpszNewClusterName) : lpszNewClusterName
 ...
 * @since windowsserver2008
 */
export GetClusterQuorumResource(_hCluster, lpszResourceName, lpcchResourceName, lpszDeviceName, lpcchDeviceName, lpdwMaxQuorumLogSize) {
...
export SetClusterQuorumResource(_hResource, lpszDeviceName, dwMaxQuoLogSize) {
    ...
    result := DllCall("CLUSAPI.dll\SetClusterQuorumResource", HRESOURCE, _hResource, "ptr", lpszDeviceName, "uint", dwMaxQuoLogSize, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterQuorumResourceEx(_hResource, lpszDeviceName, dwMaxQuorumLogSize, lpszReason) {
    lpszDeviceName := lpszDeviceName is String ? StrPtr(lpszDeviceName) : lpszDeviceName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    result := DllCall("CLUSAPI.dll\SetClusterQuorumResourceEx", HRESOURCE, _hResource, "ptr", lpszDeviceName, "uint", dwMaxQuorumLogSize, "ptr", lpszReason, UInt32)
    return result
}
 ...
 */
export BackupClusterDatabase(_hCluster, lpszPathName) {
    lpszPathName := lpszPathName is String ? StrPtr(lpszPathName) : lpszPathName

    result := DllCall("CLUSAPI.dll\BackupClusterDatabase", HCLUSTER, _hCluster, "ptr", lpszPathName, UInt32)
    return result
}
 ...
 * @since windowsserver2003
 */
export RestoreClusterDatabase(lpszPathName, bForce, lpszQuorumDriveLetter) {
    lpszPathName := lpszPathName is String ? StrPtr(lpszPathName) : lpszPathName
...
export SetClusterNetworkPriorityOrder(_hCluster, NetworkCount, NetworkList) {
    ...
    result := DllCall("CLUSAPI.dll\SetClusterNetworkPriorityOrder", HCLUSTER, _hCluster, "uint", NetworkCount, NetworkListMarshal, NetworkList, UInt32)
    return result
}
 ...
 * @since windowsserver2003
 */
export SetClusterServiceAccountPassword(lpszClusterName, lpszNewPassword, dwFlags, lpReturnStatusBuffer, lpcbReturnStatusBufferSize) {
    lpszClusterName := lpszClusterName is String ? StrPtr(lpszClusterName) : lpszClusterName
    ...
    result := DllCall("CLUSAPI.dll\SetClusterServiceAccountPassword", "ptr", lpszClusterName, "ptr", lpszNewPassword, "uint", dwFlags, "ptr", lpReturnStatusBuffer, lpcbReturnStatusBufferSizeMarshal, lpcbReturnStatusBufferSize, UInt32)
    return result
}
...
export ClusterControl(_hCluster, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterControl", HCLUSTER, _hCluster, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterControlEx(_hCluster, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterControlEx", HCLUSTER, _hCluster, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 */
export CreateClusterNotifyPortV2(_hChange, _hCluster, Filters, dwFilterCount, dwNotifyKey) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CreateClusterNotifyPortV2", HCHANGE, _hChange, HCLUSTER, _hCluster, NOTIFY_FILTER_AND_TYPE.Ptr, Filters, "uint", dwFilterCount, "ptr", dwNotifyKey, HCHANGE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2016
 */
export RegisterClusterNotifyV2(_hChange, Filter, hObject, dwNotifyKey) {
    result := DllCall("CLUSAPI.dll\RegisterClusterNotifyV2", HCHANGE, _hChange, NOTIFY_FILTER_AND_TYPE, Filter, HANDLE, hObject, "ptr", dwNotifyKey, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export GetNotifyEventHandle(_hChange, lphTargetEvent) {
    result := DllCall("CLUSAPI.dll\GetNotifyEventHandle", HCHANGE, _hChange, HANDLE.Ptr, lphTargetEvent, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export GetClusterNotifyV2(_hChange, lpdwNotifyKey, pFilterAndType, _buffer, lpbBufferSize, lpszObjectId, lpcchObjectId, lpszParentId, lpcchParentId, lpszName, lpcchName, lpszType, lpcchType, dwMilliseconds) {
 ...
 * @since windowsserver2008
 */
export CreateClusterNotifyPort(_hChange, _hCluster, dwFilter, dwNotifyKey) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CreateClusterNotifyPort", HCHANGE, _hChange, HCLUSTER, _hCluster, "uint", dwFilter, "ptr", dwNotifyKey, HCHANGE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export RegisterClusterNotify(_hChange, dwFilterType, hObject, dwNotifyKey) {
    result := DllCall("CLUSAPI.dll\RegisterClusterNotify", HCHANGE, _hChange, "uint", dwFilterType, HANDLE, hObject, "ptr", dwNotifyKey, UInt32)
    return result
}
...
export GetClusterNotify(_hChange, lpdwNotifyKey, lpdwFilterType, lpszName, lpcchName, dwMilliseconds) {
    ...
    result := DllCall("CLUSAPI.dll\GetClusterNotify", HCHANGE, _hChange, lpdwNotifyKeyMarshal, lpdwNotifyKey, lpdwFilterTypeMarshal, lpdwFilterType, "ptr", lpszName, lpcchNameMarshal, lpcchName, "uint", dwMilliseconds, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export CloseClusterNotifyPort(_hChange) {
    result := DllCall("CLUSAPI.dll\CloseClusterNotifyPort", HCHANGE, _hChange, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterOpenEnum(_hCluster, dwType) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterOpenEnum", HCLUSTER, _hCluster, "uint", dwType, HCLUSENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterGetEnumCount(hEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGetEnumCount", HCLUSENUM, hEnum, UInt32)
    return result
}
...
export ClusterEnum(hEnum, dwIndex, lpdwType, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterEnum", HCLUSENUM, hEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterCloseEnum(hEnum) {
    result := DllCall("CLUSAPI.dll\ClusterCloseEnum", HCLUSENUM, hEnum, UInt32)
    return result
}
...
export ClusterOpenEnumEx(_hCluster, dwType, pOptions) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterOpenEnumEx", HCLUSTER, _hCluster, "uint", dwType, pOptionsMarshal, pOptions, HCLUSENUMEX)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterGetEnumCountEx(hClusterEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGetEnumCountEx", HCLUSENUMEX, hClusterEnum, UInt32)
    return result
}
...
export ClusterEnumEx(hClusterEnum, dwIndex, pItem, cbItem) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterEnumEx", HCLUSENUMEX, hClusterEnum, "uint", dwIndex, CLUSTER_ENUM_ITEM.Ptr, pItem, cbItemMarshal, cbItem, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterCloseEnumEx(hClusterEnum) {
    result := DllCall("CLUSAPI.dll\ClusterCloseEnumEx", HCLUSENUMEX, hClusterEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export CreateClusterGroupSet(_hCluster, groupSetName) {
    groupSetName := groupSetName is String ? StrPtr(groupSetName) : groupSetName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CreateClusterGroupSet", HCLUSTER, _hCluster, "ptr", groupSetName, HGROUPSET)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2016
 */
export OpenClusterGroupSet(_hCluster, lpszGroupSetName) {
    lpszGroupSetName := lpszGroupSetName is String ? StrPtr(lpszGroupSetName) : lpszGroupSetName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterGroupSet", HCLUSTER, _hCluster, "ptr", lpszGroupSetName, HGROUPSET)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2016
 */
export CloseClusterGroupSet(_hGroupSet) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterGroupSet", HGROUPSET, _hGroupSet, BOOL)
 ...
 * @since windowsserver2016
 */
export DeleteClusterGroupSet(_hGroupSet) {
    result := DllCall("CLUSAPI.dll\DeleteClusterGroupSet", HGROUPSET, _hGroupSet, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterAddGroupToGroupSet(_hGroupSet, _hGroup) {
    result := DllCall("CLUSAPI.dll\ClusterAddGroupToGroupSet", HGROUPSET, _hGroupSet, HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterAddGroupToGroupSetWithDomains(_hGroupSet, _hGroup, faultDomain, updateDomain) {
    result := DllCall("CLUSAPI.dll\ClusterAddGroupToGroupSetWithDomains", HGROUPSET, _hGroupSet, HGROUP, _hGroup, "uint", faultDomain, "uint", updateDomain, UInt32)
    return result
}
...
export ClusterAddGroupToGroupSetWithDomainsEx(_hGroupSet, _hGroup, faultDomain, updateDomain, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterAddGroupToGroupSetWithDomainsEx", HGROUPSET, _hGroupSet, HGROUP, _hGroup, "uint", faultDomain, "uint", updateDomain, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterRemoveGroupFromGroupSet(_hGroup) {
    result := DllCall("CLUSAPI.dll\ClusterRemoveGroupFromGroupSet", HGROUP, _hGroup, UInt32)
    return result
}
...
export ClusterGroupSetControl(_hGroupSet, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupSetControl", HGROUPSET, _hGroupSet, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterGroupSetControlEx(_hGroupSet, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupSetControlEx", HGROUPSET, _hGroupSet, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export AddClusterGroupDependency(hDependentGroup, hProviderGroup) {
    result := DllCall("CLUSAPI.dll\AddClusterGroupDependency", HGROUP, hDependentGroup, HGROUP, hProviderGroup, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export SetGroupDependencyExpression(_hGroup, lpszDependencyExpression) {
    lpszDependencyExpression := lpszDependencyExpression is String ? StrPtr(lpszDependencyExpression) : lpszDependencyExpression

    result := DllCall("CLUSAPI.dll\SetGroupDependencyExpression", HGROUP, _hGroup, "ptr", lpszDependencyExpression, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetGroupDependencyExpressionEx(_hGroup, lpszDependencyExpression, lpszReason) {
    lpszDependencyExpression := lpszDependencyExpression is String ? StrPtr(lpszDependencyExpression) : lpszDependencyExpression
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
 ...
 * @since windowsserver2016
 */
export RemoveClusterGroupDependency(_hGroup, hDependsOn) {
    result := DllCall("CLUSAPI.dll\RemoveClusterGroupDependency", HGROUP, _hGroup, HGROUP, hDependsOn, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export AddClusterGroupSetDependency(hDependentGroupSet, hProviderGroupSet) {
    result := DllCall("CLUSAPI.dll\AddClusterGroupSetDependency", HGROUPSET, hDependentGroupSet, HGROUPSET, hProviderGroupSet, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export SetClusterGroupSetDependencyExpression(_hGroupSet, lpszDependencyExprssion) {
    lpszDependencyExprssion := lpszDependencyExprssion is String ? StrPtr(lpszDependencyExprssion) : lpszDependencyExprssion

    result := DllCall("CLUSAPI.dll\SetClusterGroupSetDependencyExpression", HGROUPSET, _hGroupSet, "ptr", lpszDependencyExprssion, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterGroupSetDependencyExpressionEx(_hGroupSet, lpszDependencyExpression, lpszReason) {
    lpszDependencyExpression := lpszDependencyExpression is String ? StrPtr(lpszDependencyExpression) : lpszDependencyExpression
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
 ...
 * @since windowsserver2016
 */
export RemoveClusterGroupSetDependency(_hGroupSet, hDependsOn) {
    result := DllCall("CLUSAPI.dll\RemoveClusterGroupSetDependency", HGROUPSET, _hGroupSet, HGROUPSET, hDependsOn, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export AddClusterGroupToGroupSetDependency(hDependentGroup, hProviderGroupSet) {
    result := DllCall("CLUSAPI.dll\AddClusterGroupToGroupSetDependency", HGROUP, hDependentGroup, HGROUPSET, hProviderGroupSet, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export RemoveClusterGroupToGroupSetDependency(_hGroup, hDependsOn) {
    result := DllCall("CLUSAPI.dll\RemoveClusterGroupToGroupSetDependency", HGROUP, _hGroup, HGROUPSET, hDependsOn, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterGroupSetOpenEnum(_hCluster) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterGroupSetOpenEnum", HCLUSTER, _hCluster, HGROUPSETENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2016
 */
export ClusterGroupSetGetEnumCount(_hGroupSetEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGroupSetGetEnumCount", HGROUPSETENUM, _hGroupSetEnum, UInt32)
    return result
}
...
export ClusterGroupSetEnum(_hGroupSetEnum, dwIndex, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupSetEnum", HGROUPSETENUM, _hGroupSetEnum, "uint", dwIndex, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterGroupSetCloseEnum(_hGroupSetEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGroupSetCloseEnum", HGROUPSETENUM, _hGroupSetEnum, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export AddCrossClusterGroupSetDependency(hDependentGroupSet, lpRemoteClusterName, lpRemoteGroupSetName) {
    ...
    result := DllCall("CLUSAPI.dll\AddCrossClusterGroupSetDependency", HGROUPSET, hDependentGroupSet, "ptr", lpRemoteClusterName, "ptr", lpRemoteGroupSetName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export RemoveCrossClusterGroupSetDependency(hDependentGroupSet, lpRemoteClusterName, lpRemoteGroupSetName) {
    lpRemoteClusterName := lpRemoteClusterName is String ? StrPtr(lpRemoteClusterName) : lpRemoteClusterName
    lpRemoteGroupSetName := lpRemoteGroupSetName is String ? StrPtr(lpRemoteGroupSetName) : lpRemoteGroupSetName

    result := DllCall("CLUSAPI.dll\RemoveCrossClusterGroupSetDependency", HGROUPSET, hDependentGroupSet, "ptr", lpRemoteClusterName, "ptr", lpRemoteGroupSetName, UInt32)
    return result
}
 ...
 * @returns {HGROUPSET} 
 */
export CreateClusterAvailabilitySet(_hCluster, lpAvailabilitySetName, pAvailabilitySetConfig) {
    lpAvailabilitySetName := lpAvailabilitySetName is String ? StrPtr(lpAvailabilitySetName) : lpAvailabilitySetName

    result := DllCall("CLUSAPI.dll\CreateClusterAvailabilitySet", HCLUSTER, _hCluster, "ptr", lpAvailabilitySetName, CLUSTER_AVAILABILITY_SET_CONFIG.Ptr, pAvailabilitySetConfig, HGROUPSET)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterNodeReplacement(_hCluster, lpszNodeNameCurrent, lpszNodeNameNew) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeReplacement", HCLUSTER, _hCluster, "ptr", lpszNodeNameCurrent, "ptr", lpszNodeNameNew, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterCreateAffinityRule(_hCluster, ruleName, ruleType) {
    ruleName := ruleName is String ? StrPtr(ruleName) : ruleName

    result := DllCall("CLUSAPI.dll\ClusterCreateAffinityRule", HCLUSTER, _hCluster, "ptr", ruleName, CLUS_AFFINITY_RULE_TYPE, ruleType, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRemoveAffinityRule(_hCluster, ruleName) {
    ruleName := ruleName is String ? StrPtr(ruleName) : ruleName

    result := DllCall("CLUSAPI.dll\ClusterRemoveAffinityRule", HCLUSTER, _hCluster, "ptr", ruleName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterAddGroupToAffinityRule(_hCluster, ruleName, _hGroup) {
    ruleName := ruleName is String ? StrPtr(ruleName) : ruleName

    result := DllCall("CLUSAPI.dll\ClusterAddGroupToAffinityRule", HCLUSTER, _hCluster, "ptr", ruleName, HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRemoveGroupFromAffinityRule(_hCluster, ruleName, _hGroup) {
    ruleName := ruleName is String ? StrPtr(ruleName) : ruleName

    result := DllCall("CLUSAPI.dll\ClusterRemoveGroupFromAffinityRule", HCLUSTER, _hCluster, "ptr", ruleName, HGROUP, _hGroup, UInt32)
    return result
}
...
export ClusterAffinityRuleControl(_hCluster, affinityRuleName, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterAffinityRuleControl", HCLUSTER, _hCluster, "ptr", affinityRuleName, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OpenClusterNode(_hCluster, lpszNodeName) {
    lpszNodeName := lpszNodeName is String ? StrPtr(lpszNodeName) : lpszNodeName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterNode", HCLUSTER, _hCluster, "ptr", lpszNodeName, HNODE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export OpenClusterNodeEx(_hCluster, lpszNodeName, dwDesiredAccess, lpdwGrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterNodeEx", HCLUSTER, _hCluster, "ptr", lpszNodeName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, HNODE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @returns {HNODE} 
 */
export OpenClusterNodeById(_hCluster, nodeId) {
    result := DllCall("CLUSAPI.dll\OpenClusterNodeById", HCLUSTER, _hCluster, "uint", nodeId, HNODE)
    return result
}
 ...
 * @since windowsserver2008
 */
export CloseClusterNode(_hNode) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterNode", HNODE, _hNode, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNodeState(_hNode) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNodeState", HNODE, _hNode, CLUSTER_NODE_STATE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterFromNode(_hNode) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterFromNode", HNODE, _hNode, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export PauseClusterNode(_hNode) {
    result := DllCall("CLUSAPI.dll\PauseClusterNode", HNODE, _hNode, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResumeClusterNode(_hNode) {
    result := DllCall("CLUSAPI.dll\ResumeClusterNode", HNODE, _hNode, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export EvictClusterNode(_hNode) {
    result := DllCall("CLUSAPI.dll\EvictClusterNode", HNODE, _hNode, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterNetInterfaceOpenEnum(_hCluster, lpszNodeName, lpszNetworkName) {
    lpszNodeName := lpszNodeName is String ? StrPtr(lpszNodeName) : lpszNodeName
...
export ClusterNetInterfaceEnum(_hNetInterfaceEnum, dwIndex, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetInterfaceEnum", HNETINTERFACEENUM, _hNetInterfaceEnum, "uint", dwIndex, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterNetInterfaceCloseEnum(_hNetInterfaceEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNetInterfaceCloseEnum", HNETINTERFACEENUM, _hNetInterfaceEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterNodeOpenEnum(_hNode, dwType) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterNodeOpenEnum", HNODE, _hNode, "uint", dwType, HNODEENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ClusterNodeOpenEnumEx(_hNode, dwType, pOptions) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeOpenEnumEx", HNODE, _hNode, "uint", dwType, pOptionsMarshal, pOptions, HNODEENUMEX)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterNodeGetEnumCountEx(_hNodeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNodeGetEnumCountEx", HNODEENUMEX, _hNodeEnum, UInt32)
    return result
}
...
export ClusterNodeEnumEx(_hNodeEnum, dwIndex, pItem, cbItem) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeEnumEx", HNODEENUMEX, _hNodeEnum, "uint", dwIndex, CLUSTER_ENUM_ITEM.Ptr, pItem, cbItemMarshal, cbItem, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterNodeCloseEnumEx(_hNodeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNodeCloseEnumEx", HNODEENUMEX, _hNodeEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterNodeGetEnumCount(_hNodeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNodeGetEnumCount", HNODEENUM, _hNodeEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterNodeCloseEnum(_hNodeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNodeCloseEnum", HNODEENUM, _hNodeEnum, UInt32)
    return result
}
...
export ClusterNodeEnum(_hNodeEnum, dwIndex, lpdwType, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeEnum", HNODEENUM, _hNodeEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
...
export EvictClusterNodeEx(_hNode, dwTimeOut, phrCleanupStatus) {
    ...
    result := DllCall("CLUSAPI.dll\EvictClusterNodeEx", HNODE, _hNode, "uint", dwTimeOut, phrCleanupStatusMarshal, phrCleanupStatus, UInt32)
    return result
}
...
export EvictClusterNodeEx2(_hNode, dwTimeout, phrCleanupStatus, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\EvictClusterNodeEx2", HNODE, _hNode, "uint", dwTimeout, phrCleanupStatusMarshal, phrCleanupStatus, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export GetClusterResourceTypeKey(_hCluster, lpszTypeName, samDesired) {
    lpszTypeName := lpszTypeName is String ? StrPtr(lpszTypeName) : lpszTypeName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterResourceTypeKey", HCLUSTER, _hCluster, "ptr", lpszTypeName, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export CreateClusterGroup(_hCluster, lpszGroupName) {
    lpszGroupName := lpszGroupName is String ? StrPtr(lpszGroupName) : lpszGroupName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CreateClusterGroup", HCLUSTER, _hCluster, "ptr", lpszGroupName, HGROUP)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export OpenClusterGroup(_hCluster, lpszGroupName) {
    lpszGroupName := lpszGroupName is String ? StrPtr(lpszGroupName) : lpszGroupName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterGroup", HCLUSTER, _hCluster, "ptr", lpszGroupName, HGROUP)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export OpenClusterGroupEx(_hCluster, lpszGroupName, dwDesiredAccess, lpdwGrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterGroupEx", HCLUSTER, _hCluster, "ptr", lpszGroupName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, HGROUP)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export PauseClusterNodeEx(_hNode, bDrainNode, dwPauseFlags, hNodeDrainTarget) {
    result := DllCall("CLUSAPI.dll\PauseClusterNodeEx", HNODE, _hNode, BOOL, bDrainNode, "uint", dwPauseFlags, HNODE, hNodeDrainTarget, UInt32)
    return result
}
...
export PauseClusterNodeEx2(_hNode, bDrainNode, dwPauseFlags, hNodeDrainTarget, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\PauseClusterNodeEx2", HNODE, _hNode, BOOL, bDrainNode, "uint", dwPauseFlags, HNODE, hNodeDrainTarget, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ResumeClusterNodeEx(_hNode, eResumeFailbackType, dwResumeFlagsReserved) {
    result := DllCall("CLUSAPI.dll\ResumeClusterNodeEx", HNODE, _hNode, CLUSTER_NODE_RESUME_FAILBACK_TYPE, eResumeFailbackType, "uint", dwResumeFlagsReserved, UInt32)
    return result
}
...
export ResumeClusterNodeEx2(_hNode, eResumeFailbackType, dwResumeFlagsReserved, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ResumeClusterNodeEx2", HNODE, _hNode, CLUSTER_NODE_RESUME_FAILBACK_TYPE, eResumeFailbackType, "uint", dwResumeFlagsReserved, "ptr", lpszReason, UInt32)
    return result
}
...
export ClusterGroupOpenEnumEx(_hCluster, lpszProperties, cbProperties, lpszRoProperties, cbRoProperties, dwFlags) {
    result := DllCall("CLUSAPI.dll\ClusterGroupOpenEnumEx", HCLUSTER, _hCluster, "ptr", lpszProperties, "uint", cbProperties, "ptr", lpszRoProperties, "uint", cbRoProperties, "uint", dwFlags, HGROUPENUMEX)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterGroupGetEnumCountEx(_hGroupEnumEx) {
    result := DllCall("CLUSAPI.dll\ClusterGroupGetEnumCountEx", HGROUPENUMEX, _hGroupEnumEx, UInt32)
    return result
}
...
export ClusterGroupEnumEx(_hGroupEnumEx, dwIndex, pItem, cbItem) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupEnumEx", HGROUPENUMEX, _hGroupEnumEx, "uint", dwIndex, CLUSTER_GROUP_ENUM_ITEM.Ptr, pItem, cbItemMarshal, cbItem, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterGroupCloseEnumEx(_hGroupEnumEx) {
    result := DllCall("CLUSAPI.dll\ClusterGroupCloseEnumEx", HGROUPENUMEX, _hGroupEnumEx, UInt32)
    return result
}
...
export ClusterResourceOpenEnumEx(_hCluster, lpszProperties, cbProperties, lpszRoProperties, cbRoProperties, dwFlags) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceOpenEnumEx", HCLUSTER, _hCluster, "ptr", lpszProperties, "uint", cbProperties, "ptr", lpszRoProperties, "uint", cbRoProperties, "uint", dwFlags, HRESENUMEX)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2012
 */
export ClusterResourceGetEnumCountEx(hResourceEnumEx) {
    result := DllCall("CLUSAPI.dll\ClusterResourceGetEnumCountEx", HRESENUMEX, hResourceEnumEx, UInt32)
    return result
}
...
export ClusterResourceEnumEx(hResourceEnumEx, dwIndex, pItem, cbItem) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceEnumEx", HRESENUMEX, hResourceEnumEx, "uint", dwIndex, CLUSTER_RESOURCE_ENUM_ITEM.Ptr, pItem, cbItemMarshal, cbItem, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterResourceCloseEnumEx(hResourceEnumEx) {
    result := DllCall("CLUSAPI.dll\ClusterResourceCloseEnumEx", HRESENUMEX, hResourceEnumEx, UInt32)
    return result
}
...
export OnlineClusterGroupEx(_hGroup, hDestinationNode, dwOnlineFlags, lpInBuffer, cbInBufferSize) {
    result := DllCall("CLUSAPI.dll\OnlineClusterGroupEx", HGROUP, _hGroup, HNODE, hDestinationNode, "uint", dwOnlineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, UInt32)
    return result
}
...
export OfflineClusterGroupEx(_hGroup, dwOfflineFlags, lpInBuffer, cbInBufferSize) {
    result := DllCall("CLUSAPI.dll\OfflineClusterGroupEx", HGROUP, _hGroup, "uint", dwOfflineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, UInt32)
    return result
}
...
export OnlineClusterGroupEx2(_hGroup, hDestinationNode, dwOnlineFlags, lpInBuffer, cbInBufferSize, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\OnlineClusterGroupEx2", HGROUP, _hGroup, HNODE, hDestinationNode, "uint", dwOnlineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpszReason, UInt32)
    return result
}
...
export OfflineClusterGroupEx2(_hGroup, dwOfflineFlags, lpInBuffer, cbInBufferSize, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\OfflineClusterGroupEx2", HGROUP, _hGroup, "uint", dwOfflineFlags, lpInBufferMarshal, lpInBuffer, "uint", cbInBufferSize, "ptr", lpszReason, UInt32)
    return result
}
...
export OnlineClusterResourceEx(_hResource, dwOnlineFlags, lpInBuffer, cbInBufferSize) {
    result := DllCall("CLUSAPI.dll\OnlineClusterResourceEx", HRESOURCE, _hResource, "uint", dwOnlineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, UInt32)
    return result
}
...
export OnlineClusterResourceEx2(_hResource, dwOnlineFlags, lpInBuffer, cbInBufferSize, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\OnlineClusterResourceEx2", HRESOURCE, _hResource, "uint", dwOnlineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpszReason, UInt32)
    return result
}
...
export OfflineClusterResourceEx(_hResource, dwOfflineFlags, lpInBuffer, cbInBufferSize) {
    result := DllCall("CLUSAPI.dll\OfflineClusterResourceEx", HRESOURCE, _hResource, "uint", dwOfflineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, UInt32)
    return result
}
...
export OfflineClusterResourceEx2(_hResource, dwOfflineFlags, lpInBuffer, cbInBufferSize, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\OfflineClusterResourceEx2", HRESOURCE, _hResource, "uint", dwOfflineFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpszReason, UInt32)
    return result
}
...
export MoveClusterGroupEx(_hGroup, hDestinationNode, dwMoveFlags, lpInBuffer, cbInBufferSize) {
    result := DllCall("CLUSAPI.dll\MoveClusterGroupEx", HGROUP, _hGroup, HNODE, hDestinationNode, "uint", dwMoveFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, UInt32)
    return result
}
...
export MoveClusterGroupEx2(_hGroup, hDestinationNode, dwMoveFlags, lpInBuffer, cbInBufferSize, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\MoveClusterGroupEx2", HGROUP, _hGroup, HNODE, hDestinationNode, "uint", dwMoveFlags, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export CancelClusterGroupOperation(_hGroup, dwCancelFlags_RESERVED) {
    result := DllCall("CLUSAPI.dll\CancelClusterGroupOperation", HGROUP, _hGroup, "uint", dwCancelFlags_RESERVED, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export RestartClusterResource(_hResource, dwFlags) {
    result := DllCall("CLUSAPI.dll\RestartClusterResource", HRESOURCE, _hResource, "uint", dwFlags, UInt32)
    return result
}
...
export RestartClusterResourceEx(_hResource, dwFlags, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\RestartClusterResourceEx", HRESOURCE, _hResource, "uint", dwFlags, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export CloseClusterGroup(_hGroup) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterGroup", HGROUP, _hGroup, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterFromGroup(_hGroup) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterFromGroup", HGROUP, _hGroup, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export SetClusterGroupName(_hGroup, lpszGroupName) {
    lpszGroupName := lpszGroupName is String ? StrPtr(lpszGroupName) : lpszGroupName

    result := DllCall("CLUSAPI.dll\SetClusterGroupName", HGROUP, _hGroup, "ptr", lpszGroupName, UInt32)
    return result
}
...
export SetClusterGroupNodeList(_hGroup, NodeCount, NodeList) {
    ...
    result := DllCall("CLUSAPI.dll\SetClusterGroupNodeList", HGROUP, _hGroup, "uint", NodeCount, NodeListMarshal, NodeList, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterGroupNameEx(_hGroup, lpszGroupName, lpszReason) {
    lpszGroupName := lpszGroupName is String ? StrPtr(lpszGroupName) : lpszGroupName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
...
export SetClusterGroupNodeListEx(_hGroup, NodeCount, NodeList, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\SetClusterGroupNodeListEx", HGROUP, _hGroup, "uint", NodeCount, NodeListMarshal, NodeList, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OfflineClusterGroup(_hGroup) {
    result := DllCall("CLUSAPI.dll\OfflineClusterGroup", HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export DeleteClusterGroup(_hGroup) {
    result := DllCall("CLUSAPI.dll\DeleteClusterGroup", HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export DestroyClusterGroup(_hGroup) {
    result := DllCall("CLUSAPI.dll\DestroyClusterGroup", HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterGroupOpenEnum(_hGroup, dwType) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterGroupOpenEnum", HGROUP, _hGroup, "uint", dwType, HGROUPENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterGroupGetEnumCount(_hGroupEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGroupGetEnumCount", HGROUPENUM, _hGroupEnum, UInt32)
    return result
}
...
export ClusterGroupEnum(_hGroupEnum, dwIndex, lpdwType, lpszResourceName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupEnum", HGROUPENUM, _hGroupEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszResourceName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterGroupCloseEnum(_hGroupEnum) {
    result := DllCall("CLUSAPI.dll\ClusterGroupCloseEnum", HGROUPENUM, _hGroupEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export CreateClusterResource(_hGroup, lpszResourceName, lpszResourceType, dwFlags) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CreateClusterResource", HGROUP, _hGroup, "ptr", lpszResourceName, "ptr", lpszResourceType, "uint", dwFlags, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @returns {HRESOURCE} 
 */
export CreateClusterResourceEx(_hGroup, lpszResourceName, lpszResourceType, dwFlags, lpszReason) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    result := DllCall("CLUSAPI.dll\CreateClusterResourceEx", HGROUP, _hGroup, "ptr", lpszResourceName, "ptr", lpszResourceType, "uint", dwFlags, "ptr", lpszReason, HRESOURCE)
    return result
}
 ...
 * @since windowsserver2008
 */
export OpenClusterResource(_hCluster, lpszResourceName) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterResource", HCLUSTER, _hCluster, "ptr", lpszResourceName, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export OpenClusterResourceEx(_hCluster, lpszResourceName, dwDesiredAccess, lpdwGrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterResourceEx", HCLUSTER, _hCluster, "ptr", lpszResourceName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export CloseClusterResource(_hResource) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterResource", HRESOURCE, _hResource, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterFromResource(_hResource) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterFromResource", HRESOURCE, _hResource, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export DeleteClusterResource(_hResource) {
    result := DllCall("CLUSAPI.dll\DeleteClusterResource", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export GetClusterResourceState(_hResource, lpszNodeName, lpcchNodeName, lpszGroupName, lpcchGroupName) {
    lpszNodeName := lpszNodeName is String ? StrPtr(lpszNodeName) : lpszNodeName
    lpszGroupName := lpszGroupName is String ? StrPtr(lpszGroupName) : lpszGroupName
 ...
 * @since windowsserver2008
 */
export SetClusterResourceName(_hResource, lpszResourceName) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName

    result := DllCall("CLUSAPI.dll\SetClusterResourceName", HRESOURCE, _hResource, "ptr", lpszResourceName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterResourceNameEx(_hResource, lpszResourceName, lpszReason) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
 ...
 * @since windowsserver2008
 */
export FailClusterResource(_hResource) {
    result := DllCall("CLUSAPI.dll\FailClusterResource", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OnlineClusterResource(_hResource) {
    result := DllCall("CLUSAPI.dll\OnlineClusterResource", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OfflineClusterResource(_hResource) {
    result := DllCall("CLUSAPI.dll\OfflineClusterResource", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ChangeClusterResourceGroup(_hResource, _hGroup) {
    result := DllCall("CLUSAPI.dll\ChangeClusterResourceGroup", HRESOURCE, _hResource, HGROUP, _hGroup, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ChangeClusterResourceGroupEx(_hResource, _hGroup, Flags) {
    result := DllCall("CLUSAPI.dll\ChangeClusterResourceGroupEx", HRESOURCE, _hResource, HGROUP, _hGroup, "uint", Flags, UInt32)
    return result
}
...
export ChangeClusterResourceGroupEx2(_hResource, _hGroup, Flags, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ChangeClusterResourceGroupEx2", HRESOURCE, _hResource, HGROUP, _hGroup, "uint", Flags, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export AddClusterResourceNode(_hResource, _hNode) {
    result := DllCall("CLUSAPI.dll\AddClusterResourceNode", HRESOURCE, _hResource, HNODE, _hNode, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export RemoveClusterResourceNode(_hResource, _hNode) {
    result := DllCall("CLUSAPI.dll\RemoveClusterResourceNode", HRESOURCE, _hResource, HNODE, _hNode, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export AddClusterResourceDependency(_hResource, hDependsOn) {
    result := DllCall("CLUSAPI.dll\AddClusterResourceDependency", HRESOURCE, _hResource, HRESOURCE, hDependsOn, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export RemoveClusterResourceDependency(_hResource, hDependsOn) {
    result := DllCall("CLUSAPI.dll\RemoveClusterResourceDependency", HRESOURCE, _hResource, HRESOURCE, hDependsOn, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export SetClusterResourceDependencyExpression(_hResource, lpszDependencyExpression) {
    lpszDependencyExpression := lpszDependencyExpression is String ? StrPtr(lpszDependencyExpression) : lpszDependencyExpression

    result := DllCall("CLUSAPI.dll\SetClusterResourceDependencyExpression", HRESOURCE, _hResource, "ptr", lpszDependencyExpression, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export AddResourceToClusterSharedVolumes(_hResource) {
    result := DllCall("CLUSAPI.dll\AddResourceToClusterSharedVolumes", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export RemoveResourceFromClusterSharedVolumes(_hResource) {
    result := DllCall("CLUSAPI.dll\RemoveResourceFromClusterSharedVolumes", HRESOURCE, _hResource, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterSharedVolumeSetSnapshotState(guidSnapshotSet, lpszVolumeName, state) {
    lpszVolumeName := lpszVolumeName is String ? StrPtr(lpszVolumeName) : lpszVolumeName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterSharedVolumeSetSnapshotState", Guid, guidSnapshotSet, "ptr", lpszVolumeName, CLUSTER_SHARED_VOLUME_SNAPSHOT_STATE, state, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export CanResourceBeDependent(_hResource, hResourceDependent) {
    result := DllCall("CLUSAPI.dll\CanResourceBeDependent", HRESOURCE, _hResource, HRESOURCE, hResourceDependent, BOOL)
    return result
}
...
export ClusterResourceControl(_hResource, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceControl", HRESOURCE, _hResource, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterResourceControlAsUser(_hResource, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceControlAsUser", HRESOURCE, _hResource, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterResourceTypeControl(_hCluster, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceTypeControl", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterResourceTypeControlAsUser(_hCluster, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceTypeControlAsUser", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterGroupControl(_hGroup, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupControl", HGROUP, _hGroup, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterResourceControlEx(_hResource, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceControlEx", HRESOURCE, _hResource, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
...
export ClusterResourceControlAsUserEx(_hResource, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceControlAsUserEx", HRESOURCE, _hResource, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", cbInBufferSize, "ptr", lpOutBuffer, "uint", cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterResourceTypeControlEx(_hCluster, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    lpBytesReturnedMarshal := lpBytesReturned is VarRef ? "uint*" : "ptr"

    result := DllCall("CLUSAPI.dll\ClusterResourceTypeControlEx", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterResourceTypeControlAsUserEx(_hCluster, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    lpBytesReturnedMarshal := lpBytesReturned is VarRef ? "uint*" : "ptr"

    result := DllCall("CLUSAPI.dll\ClusterResourceTypeControlAsUserEx", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
...
export ClusterGroupControlEx(_hGroup, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterGroupControlEx", HGROUP, _hGroup, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
...
export ClusterNodeControl(_hNode, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeControl", HNODE, _hNode, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterNodeControlEx(_hNode, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNodeControlEx", HNODE, _hNode, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
...
export GetClusterResourceNetworkName(_hResource, lpBuffer, nSize) {
    ...
    result := DllCall("CLUSAPI.dll\GetClusterResourceNetworkName", HRESOURCE, _hResource, "ptr", lpBuffer, nSizeMarshal, nSize, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterResourceOpenEnum(_hResource, dwType) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterResourceOpenEnum", HRESOURCE, _hResource, "uint", dwType, HRESENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterResourceGetEnumCount(_hResEnum) {
    result := DllCall("CLUSAPI.dll\ClusterResourceGetEnumCount", HRESENUM, _hResEnum, UInt32)
    return result
}
...
export ClusterResourceEnum(_hResEnum, dwIndex, lpdwType, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceEnum", HRESENUM, _hResEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterResourceCloseEnum(_hResEnum) {
    result := DllCall("CLUSAPI.dll\ClusterResourceCloseEnum", HRESENUM, _hResEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export CreateClusterResourceType(_hCluster, lpszResourceTypeName, lpszDisplayName, lpszResourceTypeDll, dwLooksAlivePollInterval, dwIsAlivePollInterval) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName
    ...
    result := DllCall("CLUSAPI.dll\CreateClusterResourceType", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, "ptr", lpszDisplayName, "ptr", lpszResourceTypeDll, "uint", dwLooksAlivePollInterval, "uint", dwIsAlivePollInterval, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export DeleteClusterResourceType(_hCluster, lpszResourceTypeName) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName

    result := DllCall("CLUSAPI.dll\DeleteClusterResourceType", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export CreateClusterResourceTypeEx(_hCluster, lpszResourceTypeName, lpszDisplayName, lpszResourceTypeDll, dwLooksAlivePollInterval, dwIsAlivePollInterval, lpszReason) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName
    lpszDisplayName := lpszDisplayName is String ? StrPtr(lpszDisplayName) : lpszDisplayName
    lpszResourceTypeDll := lpszResourceTypeDll is String ? StrPtr(lpszResourceTypeDll) : lpszResourceTypeDll
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    result := DllCall("CLUSAPI.dll\CreateClusterResourceTypeEx", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, "ptr", lpszDisplayName, "ptr", lpszResourceTypeDll, "uint", dwLooksAlivePollInterval, "uint", dwIsAlivePollInterval, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export DeleteClusterResourceTypeEx(_hCluster, lpszTypeName, lpszReason) {
    lpszTypeName := lpszTypeName is String ? StrPtr(lpszTypeName) : lpszTypeName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
 ...
 * @since windowsserver2008
 */
export ClusterResourceTypeOpenEnum(_hCluster, lpszResourceTypeName, dwType) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterResourceTypeOpenEnum", HCLUSTER, _hCluster, "ptr", lpszResourceTypeName, "uint", dwType, HRESTYPEENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterResourceTypeGetEnumCount(_hResTypeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterResourceTypeGetEnumCount", HRESTYPEENUM, _hResTypeEnum, UInt32)
    return result
}
...
export ClusterResourceTypeEnum(_hResTypeEnum, dwIndex, lpdwType, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterResourceTypeEnum", HRESTYPEENUM, _hResTypeEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterResourceTypeCloseEnum(_hResTypeEnum) {
    result := DllCall("CLUSAPI.dll\ClusterResourceTypeCloseEnum", HRESTYPEENUM, _hResTypeEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OpenClusterNetwork(_hCluster, lpszNetworkName) {
    lpszNetworkName := lpszNetworkName is String ? StrPtr(lpszNetworkName) : lpszNetworkName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterNetwork", HCLUSTER, _hCluster, "ptr", lpszNetworkName, HNETWORK)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export OpenClusterNetworkEx(_hCluster, lpszNetworkName, dwDesiredAccess, lpdwGrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterNetworkEx", HCLUSTER, _hCluster, "ptr", lpszNetworkName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, HNETWORK)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export CloseClusterNetwork(_hNetwork) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterNetwork", HNETWORK, _hNetwork, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterFromNetwork(_hNetwork) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterFromNetwork", HNETWORK, _hNetwork, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterNetworkOpenEnum(_hNetwork, dwType) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\ClusterNetworkOpenEnum", HNETWORK, _hNetwork, "uint", dwType, HNETWORKENUM)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterNetworkGetEnumCount(_hNetworkEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNetworkGetEnumCount", HNETWORKENUM, _hNetworkEnum, UInt32)
    return result
}
...
export ClusterNetworkEnum(_hNetworkEnum, dwIndex, lpdwType, lpszName, lpcchName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetworkEnum", HNETWORKENUM, _hNetworkEnum, "uint", dwIndex, lpdwTypeMarshal, lpdwType, "ptr", lpszName, lpcchNameMarshal, lpcchName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterNetworkCloseEnum(_hNetworkEnum) {
    result := DllCall("CLUSAPI.dll\ClusterNetworkCloseEnum", HNETWORKENUM, _hNetworkEnum, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export GetClusterNetworkState(_hNetwork) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNetworkState", HNETWORK, _hNetwork, CLUSTER_NETWORK_STATE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export SetClusterNetworkName(_hNetwork, lpszName) {
    lpszName := lpszName is String ? StrPtr(lpszName) : lpszName

    result := DllCall("CLUSAPI.dll\SetClusterNetworkName", HNETWORK, _hNetwork, "ptr", lpszName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export SetClusterNetworkNameEx(_hNetwork, lpszName, lpszReason) {
    lpszName := lpszName is String ? StrPtr(lpszName) : lpszName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
...
export ClusterNetworkControl(_hNetwork, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetworkControl", HNETWORK, _hNetwork, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterNetworkControlEx(_hNetwork, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetworkControlEx", HNETWORK, _hNetwork, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export OpenClusterNetInterface(_hCluster, lpszInterfaceName) {
    lpszInterfaceName := lpszInterfaceName is String ? StrPtr(lpszInterfaceName) : lpszInterfaceName

    A_LastError := 0

    result := DllCall("CLUSAPI.dll\OpenClusterNetInterface", HCLUSTER, _hCluster, "ptr", lpszInterfaceName, HNETINTERFACE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export OpenClusterNetInterfaceEx(_hCluster, lpszInterfaceName, dwDesiredAccess, lpdwGrantedAccess) {
    ...
    result := DllCall("CLUSAPI.dll\OpenClusterNetInterfaceEx", HCLUSTER, _hCluster, "ptr", lpszInterfaceName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, HNETINTERFACE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNetInterface(_hCluster, lpszNodeName, lpszNetworkName, lpszInterfaceName, lpcchInterfaceName) {
    lpszNodeName := lpszNodeName is String ? StrPtr(lpszNodeName) : lpszNodeName
    lpszNetworkName := lpszNetworkName is String ? StrPtr(lpszNetworkName) : lpszNetworkName
    lpszInterfaceName := lpszInterfaceName is String ? StrPtr(lpszInterfaceName) : lpszInterfaceName
 ...
 * @since windowsserver2008
 */
export CloseClusterNetInterface(_hNetInterface) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\CloseClusterNetInterface", HNETINTERFACE, _hNetInterface, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterFromNetInterface(_hNetInterface) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterFromNetInterface", HNETINTERFACE, _hNetInterface, HCLUSTER)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNetInterfaceState(_hNetInterface) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNetInterfaceState", HNETINTERFACE, _hNetInterface, CLUSTER_NETINTERFACE_STATE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ClusterNetInterfaceControl(_hNetInterface, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetInterfaceControl", HNETINTERFACE, _hNetInterface, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
    return result
}
...
export ClusterNetInterfaceControlEx(_hNetInterface, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterNetInterfaceControlEx", HNETINTERFACE, _hNetInterface, HNODE, hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export GetClusterKey(_hCluster, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterKey", HCLUSTER, _hCluster, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterGroupKey(_hGroup, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterGroupKey", HGROUP, _hGroup, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterResourceKey(_hResource, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterResourceKey", HRESOURCE, _hResource, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNodeKey(_hNode, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNodeKey", HNODE, _hNode, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNetworkKey(_hNetwork, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNetworkKey", HNETWORK, _hNetwork, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export GetClusterNetInterfaceKey(_hNetInterface, samDesired) {
    A_LastError := 0

    result := DllCall("CLUSAPI.dll\GetClusterNetInterfaceKey", HNETINTERFACE, _hNetInterface, "uint", samDesired, HKEY.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ClusterRegCreateKey(_hKey, lpszSubKey, dwOptions, samDesired, lpSecurityAttributes, phkResult, lpdwDisposition) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegCreateKey", HKEY, _hKey, "ptr", lpszSubKey, "uint", dwOptions, "uint", samDesired, SECURITY_ATTRIBUTES.Ptr, lpSecurityAttributes, HKEY.Ptr, phkResult, lpdwDispositionMarshal, lpdwDisposition, Int32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRegCreateKeyEx(_hKey, lpSubKey, dwOptions, samDesired, lpSecurityAttributes, phkResult, lpdwDisposition, lpszReason) {
    lpSubKey := lpSubKey is String ? StrPtr(lpSubKey) : lpSubKey
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    lpdwDispositionMarshal := lpdwDisposition is VarRef ? "uint*" : "ptr"

    result := DllCall("CLUSAPI.dll\ClusterRegCreateKeyEx", HKEY, _hKey, "ptr", lpSubKey, "uint", dwOptions, "uint", samDesired, SECURITY_ATTRIBUTES.Ptr, lpSecurityAttributes, HKEY.Ptr, phkResult, lpdwDispositionMarshal, lpdwDisposition, "ptr", lpszReason, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegOpenKey(_hKey, lpszSubKey, samDesired, phkResult) {
    lpszSubKey := lpszSubKey is String ? StrPtr(lpszSubKey) : lpszSubKey

    result := DllCall("CLUSAPI.dll\ClusterRegOpenKey", HKEY, _hKey, "ptr", lpszSubKey, "uint", samDesired, HKEY.Ptr, phkResult, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegDeleteKey(_hKey, lpszSubKey) {
    lpszSubKey := lpszSubKey is String ? StrPtr(lpszSubKey) : lpszSubKey

    result := DllCall("CLUSAPI.dll\ClusterRegDeleteKey", HKEY, _hKey, "ptr", lpszSubKey, Int32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRegDeleteKeyEx(_hKey, lpSubKey, lpszReason) {
    lpSubKey := lpSubKey is String ? StrPtr(lpSubKey) : lpSubKey
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
 ...
 * @since windowsserver2008
 */
export ClusterRegCloseKey(_hKey) {
    result := DllCall("CLUSAPI.dll\ClusterRegCloseKey", HKEY, _hKey, Int32)
    return result
}
...
export ClusterRegEnumKey(_hKey, dwIndex, lpszName, lpcchName, lpftLastWriteTime) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegEnumKey", HKEY, _hKey, "uint", dwIndex, "ptr", lpszName, lpcchNameMarshal, lpcchName, FILETIME.Ptr, lpftLastWriteTime, Int32)
    return result
}
...
export ClusterRegSetValue(_hKey, lpszValueName, dwType, lpData, cbData) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegSetValue", HKEY, _hKey, "ptr", lpszValueName, "uint", dwType, lpDataMarshal, lpData, "uint", cbData, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterRegDeleteValue(_hKey, lpszValueName) {
    lpszValueName := lpszValueName is String ? StrPtr(lpszValueName) : lpszValueName

    result := DllCall("CLUSAPI.dll\ClusterRegDeleteValue", HKEY, _hKey, "ptr", lpszValueName, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRegSetValueEx(_hKey, lpszValueName, dwType, lpData, cbData, lpszReason) {
    lpszValueName := lpszValueName is String ? StrPtr(lpszValueName) : lpszValueName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

    lpDataMarshal := lpData is VarRef ? "char*" : "ptr"

    result := DllCall("CLUSAPI.dll\ClusterRegSetValueEx", HKEY, _hKey, "ptr", lpszValueName, "uint", dwType, lpDataMarshal, lpData, "uint", cbData, "ptr", lpszReason, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ClusterRegDeleteValueEx(_hKey, lpszValueName, lpszReason) {
    lpszValueName := lpszValueName is String ? StrPtr(lpszValueName) : lpszValueName
    lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason
...
export ClusterRegQueryValue(_hKey, lpszValueName, lpdwValueType, lpData, lpcbData) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegQueryValue", HKEY, _hKey, "ptr", lpszValueName, lpdwValueTypeMarshal, lpdwValueType, "ptr", lpData, lpcbDataMarshal, lpcbData, Int32)
    return result
}
...
export ClusterRegEnumValue(_hKey, dwIndex, lpszValueName, lpcchValueName, lpdwType, lpData, lpcbData) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegEnumValue", HKEY, _hKey, "uint", dwIndex, "ptr", lpszValueName, lpcchValueNameMarshal, lpcchValueName, lpdwTypeMarshal, lpdwType, "ptr", lpData, lpcbDataMarshal, lpcbData, UInt32)
    return result
}
...
export ClusterRegGetKeySecurity(_hKey, RequestedInformation, pSecurityDescriptor, lpcbSecurityDescriptor) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegGetKeySecurity", HKEY, _hKey, "uint", RequestedInformation, "ptr", pSecurityDescriptor, lpcbSecurityDescriptorMarshal, lpcbSecurityDescriptor, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegSetKeySecurity(_hKey, SecurityInformation, pSecurityDescriptor) {
    result := DllCall("CLUSAPI.dll\ClusterRegSetKeySecurity", HKEY, _hKey, "uint", SecurityInformation, PSECURITY_DESCRIPTOR, pSecurityDescriptor, Int32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterRegSyncDatabase(_hCluster, flags) {
    result := DllCall("CLUSAPI.dll\ClusterRegSyncDatabase", HCLUSTER, _hCluster, "uint", flags, Int32)
    return result
}
...
export ClusterRegBatchAddCommand(_hRegBatch, dwCommand, wzName, dwOptions, lpData, cbData) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegBatchAddCommand", HREGBATCH, _hRegBatch, CLUSTER_REG_COMMAND, dwCommand, "ptr", wzName, "uint", dwOptions, "ptr", lpData, "uint", cbData, Int32)
    return result
}
...
export ClusterRegCloseBatchEx(_hRegBatch, flags, failedCommandNumber) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegCloseBatchEx", HREGBATCH, _hRegBatch, "uint", flags, failedCommandNumberMarshal, failedCommandNumber, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegBatchReadCommand(hBatchNotification, pBatchCommand) {
    result := DllCall("CLUSAPI.dll\ClusterRegBatchReadCommand", HREGBATCHNOTIFICATION, hBatchNotification, CLUSTER_BATCH_COMMAND.Ptr, pBatchCommand, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegBatchCloseNotification(hBatchNotification) {
    result := DllCall("CLUSAPI.dll\ClusterRegBatchCloseNotification", HREGBATCHNOTIFICATION, hBatchNotification, Int32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterRegCloseBatchNotifyPort(hBatchNotifyPort) {
    result := DllCall("CLUSAPI.dll\ClusterRegCloseBatchNotifyPort", HREGBATCHPORT, hBatchNotifyPort, Int32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterRegReadBatchAddCommand(_hRegReadBatch, wzSubkeyName, wzValueName) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegReadBatchAddCommand", HREGREADBATCH, _hRegReadBatch, "ptr", wzSubkeyName, "ptr", wzValueName, Int32)
    return result
}
...
export ClusterRegCloseReadBatchEx(_hRegReadBatch, flags, phRegReadBatchReply) {
    ...
    result := DllCall("CLUSAPI.dll\ClusterRegCloseReadBatchEx", HREGREADBATCH, _hRegReadBatch, "uint", flags, phRegReadBatchReplyMarshal, phRegReadBatchReply, Int32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterRegReadBatchReplyNextCommand(_hRegReadBatchReply, pBatchCommand) {
    result := DllCall("CLUSAPI.dll\ClusterRegReadBatchReplyNextCommand", HREGREADBATCHREPLY, _hRegReadBatchReply, CLUSTER_READ_BATCH_COMMAND.Ptr, pBatchCommand, Int32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ClusterRegCloseReadBatchReply(_hRegReadBatchReply) {
    result := DllCall("CLUSAPI.dll\ClusterRegCloseReadBatchReply", HREGREADBATCHREPLY, _hRegReadBatchReply, Int32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusterSetAccountAccess(_hCluster, szAccountSID, dwAccess, dwControlType) {
    szAccountSID := szAccountSID is String ? StrPtr(szAccountSID) : szAccountSID

    result := DllCall("CLUSAPI.dll\ClusterSetAccountAccess", HCLUSTER, _hCluster, "ptr", szAccountSID, "uint", dwAccess, "uint", dwControlType, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export RemoveClusterNameAccount(_hCluster, bDeleteComputerObjects) {
    result := DllCall("CLUSAPI.dll\RemoveClusterNameAccount", HCLUSTER, _hCluster, BOOL, bDeleteComputerObjects, UInt32)
    return result
}
...
export DetermineCNOResTypeFromNodelist(cNodes, ppszNodeNames, pCNOResType) {
    ...
    result := DllCall("CLUSAPI.dll\DetermineCNOResTypeFromNodelist", "uint", cNodes, ppszNodeNamesMarshal, ppszNodeNames, pCNOResTypeMarshal, pCNOResType, UInt32)
    return result
}
...
export DetermineClusterCloudTypeFromNodelist(cNodes, ppszNodeNames, pCloudType) {
    ...
    result := DllCall("CLUSAPI.dll\DetermineClusterCloudTypeFromNodelist", "uint", cNodes, ppszNodeNamesMarshal, ppszNodeNames, pCloudTypeMarshal, pCloudType, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export RegisterClusterResourceTypeNotifyV2(_hChange, _hCluster, Flags, resTypeName, dwNotifyKey) {
    resTypeName := resTypeName is String ? StrPtr(resTypeName) : resTypeName

    result := DllCall("CLUSAPI.dll\RegisterClusterResourceTypeNotifyV2", HCHANGE, _hChange, HCLUSTER, _hCluster, "int64", Flags, "ptr", resTypeName, "ptr", dwNotifyKey, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export AddClusterStorageNode(_hCluster, lpszNodeName, pfnProgressCallback, pvCallbackArg, lpszClusterStorageNodeDescription, lpszClusterStorageNodeLocation) {
    lpszNodeName := lpszNodeName is String ? StrPtr(lpszNodeName) : lpszNodeName
...
export AddClusterNodeEx(_hCluster, lpszNodeName, dwFlags, pfnProgressCallback, pvCallbackArg) {
    ...
    result := DllCall("CLUSAPI.dll\AddClusterNodeEx", HCLUSTER, _hCluster, "ptr", lpszNodeName, "uint", dwFlags, "ptr", pfnProgressCallback, pvCallbackArgMarshal, pvCallbackArg, HNODE)
    return result
}
 ...
 * @returns {Integer} 
 */
export RemoveClusterStorageNode(_hCluster, lpszClusterStorageEnclosureName, dwTimeout, dwFlags) {
    ...
    result := DllCall("CLUSAPI.dll\RemoveClusterStorageNode", HCLUSTER, _hCluster, "ptr", lpszClusterStorageEnclosureName, "uint", dwTimeout, "uint", dwFlags, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export InitializeClusterHealthFault(clusterHealthFault) {
    result := DllCall("RESUTILS.dll\InitializeClusterHealthFault", CLUSTER_HEALTH_FAULT.Ptr, clusterHealthFault, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export InitializeClusterHealthFaultArray(clusterHealthFaultArray) {
    result := DllCall("RESUTILS.dll\InitializeClusterHealthFaultArray", CLUSTER_HEALTH_FAULT_ARRAY.Ptr, clusterHealthFaultArray, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export FreeClusterHealthFault(clusterHealthFault) {
    result := DllCall("RESUTILS.dll\FreeClusterHealthFault", CLUSTER_HEALTH_FAULT.Ptr, clusterHealthFault, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export FreeClusterHealthFaultArray(clusterHealthFaultArray) {
    result := DllCall("RESUTILS.dll\FreeClusterHealthFaultArray", CLUSTER_HEALTH_FAULT_ARRAY.Ptr, clusterHealthFaultArray, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusGetClusterHealthFaults(_hCluster, objects, flags) {
    result := DllCall("RESUTILS.dll\ClusGetClusterHealthFaults", HCLUSTER, _hCluster, CLUSTER_HEALTH_FAULT_ARRAY.Ptr, objects, "uint", flags, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusRemoveClusterHealthFault(_hCluster, id, flags) {
    id := id is String ? StrPtr(id) : id

    result := DllCall("RESUTILS.dll\ClusRemoveClusterHealthFault", HCLUSTER, _hCluster, "ptr", id, "uint", flags, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ClusAddClusterHealthFault(_hCluster, failure, param2) {
    result := DllCall("RESUTILS.dll\ClusAddClusterHealthFault", HCLUSTER, _hCluster, CLUSTER_HEALTH_FAULT.Ptr, failure, "uint", param2, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilStartResourceService(pszServiceName, phServiceHandle) {
    pszServiceName := pszServiceName is String ? StrPtr(pszServiceName) : pszServiceName

    result := DllCall("RESUTILS.dll\ResUtilStartResourceService", "ptr", pszServiceName, SC_HANDLE.Ptr, phServiceHandle, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilVerifyResourceService(pszServiceName) {
    pszServiceName := pszServiceName is String ? StrPtr(pszServiceName) : pszServiceName

    result := DllCall("RESUTILS.dll\ResUtilVerifyResourceService", "ptr", pszServiceName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilStopResourceService(pszServiceName) {
    pszServiceName := pszServiceName is String ? StrPtr(pszServiceName) : pszServiceName

    result := DllCall("RESUTILS.dll\ResUtilStopResourceService", "ptr", pszServiceName, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilVerifyService(hServiceHandle) {
    result := DllCall("RESUTILS.dll\ResUtilVerifyService", SC_HANDLE, hServiceHandle, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilStopService(hServiceHandle) {
    result := DllCall("RESUTILS.dll\ResUtilStopService", SC_HANDLE, hServiceHandle, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilCreateDirectoryTree(pszPath) {
    pszPath := pszPath is String ? StrPtr(pszPath) : pszPath

    result := DllCall("RESUTILS.dll\ResUtilCreateDirectoryTree", "ptr", pszPath, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilIsPathValid(pszPath) {
    pszPath := pszPath is String ? StrPtr(pszPath) : pszPath

    result := DllCall("RESUTILS.dll\ResUtilIsPathValid", "ptr", pszPath, BOOL)
    return result
}
...
export ResUtilEnumProperties(pPropertyTable, pszOutProperties, cbOutPropertiesSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilEnumProperties", RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pszOutProperties, "uint", cbOutPropertiesSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilEnumPrivateProperties(hkeyClusterKey, pszOutProperties, cbOutPropertiesSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilEnumPrivateProperties", HKEY, hkeyClusterKey, "ptr", pszOutProperties, "uint", cbOutPropertiesSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilGetProperties(hkeyClusterKey, pPropertyTable, pOutPropertyList, cbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetProperties", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pOutPropertyList, "uint", cbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilGetAllProperties(hkeyClusterKey, pPropertyTable, pOutPropertyList, cbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetAllProperties", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pOutPropertyList, "uint", cbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilGetPrivateProperties(hkeyClusterKey, pOutPropertyList, cbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetPrivateProperties", HKEY, hkeyClusterKey, "ptr", pOutPropertyList, "uint", cbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilGetProperty(hkeyClusterKey, pPropertyTableItem, pOutPropertyItem, pcbOutPropertyItemSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetProperty", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTableItem, "ptr", pOutPropertyItem, pcbOutPropertyItemSizeMarshal, pcbOutPropertyItemSize, UInt32)
    return result
}
...
export ResUtilVerifyPropertyTable(pPropertyTable, bAllowUnknownProperties, pInPropertyList, cbInPropertyListSize, pOutParams) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilVerifyPropertyTable", RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", Reserved, BOOL, bAllowUnknownProperties, "ptr", pInPropertyList, "uint", cbInPropertyListSize, pOutParamsMarshal, pOutParams, UInt32)
    return result
}
...
export ResUtilSetPropertyTable(hkeyClusterKey, pPropertyTable, bAllowUnknownProperties, pInPropertyList, cbInPropertyListSize, pOutParams) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetPropertyTable", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", Reserved, BOOL, bAllowUnknownProperties, "ptr", pInPropertyList, "uint", cbInPropertyListSize, pOutParamsMarshal, pOutParams, UInt32)
    return result
}
...
export ResUtilSetPropertyTableEx(hkeyClusterKey, pPropertyTable, Reserved, bAllowUnknownProperties, pInPropertyList, cbInPropertyListSize, bForceWrite, pOutParams) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetPropertyTableEx", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, ReservedMarshal, Reserved, BOOL, bAllowUnknownProperties, pInPropertyListMarshal, pInPropertyList, "uint", cbInPropertyListSize, BOOL, bForceWrite, pOutParamsMarshal, pOutParams, UInt32)
    return result
}
...
export ResUtilSetPropertyParameterBlock(hkeyClusterKey, pPropertyTable, Reserved, pInParams, pInPropertyList, cbInPropertyListSize, pOutParams) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetPropertyParameterBlock", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, ReservedMarshal, Reserved, pInParamsMarshal, pInParams, pInPropertyListMarshal, pInPropertyList, "uint", cbInPropertyListSize, pOutParamsMarshal, pOutParams, UInt32)
    return result
}
...
export ResUtilSetPropertyParameterBlockEx(hkeyClusterKey, pPropertyTable, Reserved, pInParams, pInPropertyList, cbInPropertyListSize, bForceWrite, pOutParams) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetPropertyParameterBlockEx", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, ReservedMarshal, Reserved, pInParamsMarshal, pInParams, pInPropertyListMarshal, pInPropertyList, "uint", cbInPropertyListSize, BOOL, bForceWrite, pOutParamsMarshal, pOutParams, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilSetUnknownProperties(hkeyClusterKey, pPropertyTable, pInPropertyList, cbInPropertyListSize) {
    result := DllCall("RESUTILS.dll\ResUtilSetUnknownProperties", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pInPropertyList, "uint", cbInPropertyListSize, UInt32)
    return result
}
...
export ResUtilPropertyListFromParameterBlock(pPropertyTable, pOutPropertyList, pcbOutPropertyListSize, pInParams, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilPropertyListFromParameterBlock", RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pOutPropertyList, pcbOutPropertyListSizeMarshal, pcbOutPropertyListSize, pInParamsMarshal, pInParams, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
...
export ResUtilAddUnknownProperties(hkeyClusterKey, pPropertyTable, pOutPropertyList, pcbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilAddUnknownProperties", HKEY, hkeyClusterKey, RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, pOutPropertyListMarshal, pOutPropertyList, "uint", pcbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilSetPrivatePropertyList(hkeyClusterKey, pInPropertyList, cbInPropertyListSize) {
    result := DllCall("RESUTILS.dll\ResUtilSetPrivatePropertyList", HKEY, hkeyClusterKey, "ptr", pInPropertyList, "uint", cbInPropertyListSize, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilVerifyPrivatePropertyList(pInPropertyList, cbInPropertyListSize) {
    result := DllCall("RESUTILS.dll\ResUtilVerifyPrivatePropertyList", "ptr", pInPropertyList, "uint", cbInPropertyListSize, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilDupString(pszInString) {
    pszInString := pszInString is String ? StrPtr(pszInString) : pszInString

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilDupString", "ptr", pszInString, PWSTR)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilGetSzValue(hkeyClusterKey, pszValueName) {
    pszValueName := pszValueName is String ? StrPtr(pszValueName) : pszValueName

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetSzValue", HKEY, hkeyClusterKey, "ptr", pszValueName, PWSTR)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ResUtilGetDwordValue(hkeyClusterKey, pszValueName, pdwOutValue, dwDefaultValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetDwordValue", HKEY, hkeyClusterKey, "ptr", pszValueName, pdwOutValueMarshal, pdwOutValue, "uint", dwDefaultValue, UInt32)
    return result
}
...
export ResUtilGetQwordValue(hkeyClusterKey, pszValueName, pqwOutValue, qwDefaultValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetQwordValue", HKEY, hkeyClusterKey, "ptr", pszValueName, pqwOutValueMarshal, pqwOutValue, "uint", qwDefaultValue, UInt32)
    return result
}
...
export ResUtilSetBinaryValue(hkeyClusterKey, pszValueName, pbNewValue, cbNewValueSize, ppbOutValue, pcbOutValueSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetBinaryValue", HKEY, hkeyClusterKey, "ptr", pszValueName, "ptr", pbNewValue, "uint", cbNewValueSize, "ptr", ppbOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilSetSzValue(hkeyClusterKey, pszValueName, pszNewValue, ppszOutString) {
    pszValueName := pszValueName is String ? StrPtr(pszValueName) : pszValueName
 ...
 * @since windowsserver2008
 */
export ResUtilSetExpandSzValue(hkeyClusterKey, pszValueName, pszNewValue, ppszOutString) {
    pszValueName := pszValueName is String ? StrPtr(pszValueName) : pszValueName
    pszNewValue := pszNewValue is String ? StrPtr(pszNewValue) : pszNewValue
...
export ResUtilSetMultiSzValue(hkeyClusterKey, pszValueName, pszNewValue, cbNewValueSize, ppszOutValue, pcbOutValueSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetMultiSzValue", HKEY, hkeyClusterKey, "ptr", pszValueName, "ptr", pszNewValue, "uint", cbNewValueSize, ppszOutValueMarshal, ppszOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, UInt32)
    return result
}
...
export ResUtilSetDwordValue(hkeyClusterKey, pszValueName, dwNewValue, pdwOutValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetDwordValue", HKEY, hkeyClusterKey, "ptr", pszValueName, "uint", dwNewValue, pdwOutValueMarshal, pdwOutValue, UInt32)
    return result
}
...
export ResUtilSetQwordValue(hkeyClusterKey, pszValueName, qwNewValue, pqwOutValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetQwordValue", HKEY, hkeyClusterKey, "ptr", pszValueName, "uint", qwNewValue, pqwOutValueMarshal, pqwOutValue, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ResUtilSetValueEx(hkeyClusterKey, _valueName, valueType, valueData, valueSize, flags) {
    _valueName := _valueName is String ? StrPtr(_valueName) : _valueName

    result := DllCall("RESUTILS.dll\ResUtilSetValueEx", HKEY, hkeyClusterKey, "ptr", _valueName, "uint", valueType, "ptr", valueData, "uint", valueSize, "uint", flags, UInt32)
    return result
}
...
export ResUtilGetBinaryProperty(ppbOutValue, pcbOutValueSize, pValueStruct, pbOldValue, cbOldValueSize, ppPropertyList, pcbPropertyListSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetBinaryProperty", ppbOutValueMarshal, ppbOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, CLUSPROP_BINARY.Ptr, pValueStruct, "ptr", pbOldValue, "uint", cbOldValueSize, "ptr", ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, UInt32)
    return result
}
...
export ResUtilGetSzProperty(ppszOutValue, pValueStruct, pszOldValue, ppPropertyList, pcbPropertyListSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetSzProperty", ppszOutValueMarshal, ppszOutValue, CLUSPROP_SZ.Ptr, pValueStruct, "ptr", pszOldValue, "ptr", ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, UInt32)
    return result
}
...
export ResUtilGetMultiSzProperty(ppszOutValue, pcbOutValueSize, pValueStruct, pszOldValue, cbOldValueSize, ppPropertyList, pcbPropertyListSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetMultiSzProperty", ppszOutValueMarshal, ppszOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, CLUSPROP_SZ.Ptr, pValueStruct, "ptr", pszOldValue, "uint", cbOldValueSize, "ptr", ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, UInt32)
    return result
}
...
export ResUtilGetDwordProperty(pdwOutValue, pValueStruct, dwOldValue, dwMinimum, dwMaximum, ppPropertyList, pcbPropertyListSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetDwordProperty", pdwOutValueMarshal, pdwOutValue, CLUSPROP_DWORD.Ptr, pValueStruct, "uint", dwOldValue, "uint", dwMinimum, "uint", dwMaximum, ppPropertyListMarshal, ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, UInt32)
    return result
}
...
export ResUtilGetLongProperty(plOutValue, pValueStruct, lOldValue, lMinimum, lMaximum, ppPropertyList, pcbPropertyListSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetLongProperty", plOutValueMarshal, plOutValue, CLUSPROP_LONG.Ptr, pValueStruct, "int", lOldValue, "int", lMinimum, "int", lMaximum, ppPropertyListMarshal, ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilGetEnvironmentWithNetName(_hResource) {
    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetEnvironmentWithNetName", HRESOURCE, _hResource, IntPtr)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilExpandEnvironmentStrings(pszSrc) {
    pszSrc := pszSrc is String ? StrPtr(pszSrc) : pszSrc

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilExpandEnvironmentStrings", "ptr", pszSrc, PWSTR)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ResUtilSetResourceServiceEnvironment(pszServiceName, _hResource, pfnLogEvent, hResourceHandle) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetResourceServiceEnvironment", "ptr", pszServiceName, HRESOURCE, _hResource, "ptr", pfnLogEvent, "ptr", hResourceHandle, UInt32)
    return result
}
...
export ResUtilRemoveResourceServiceEnvironment(pszServiceName, pfnLogEvent, hResourceHandle) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilRemoveResourceServiceEnvironment", "ptr", pszServiceName, "ptr", pfnLogEvent, "ptr", hResourceHandle, UInt32)
    return result
}
...
export ResUtilSetResourceServiceStartParameters(pszServiceName, schSCMHandle, phService, pfnLogEvent, hResourceHandle) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetResourceServiceStartParameters", "ptr", pszServiceName, SC_HANDLE, schSCMHandle, SC_HANDLE.Ptr, phService, "ptr", pfnLogEvent, "ptr", hResourceHandle, UInt32)
    return result
}
...
export ResUtilFindSzProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindSzProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, UInt32)
    return result
}
...
export ResUtilFindExpandSzProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindExpandSzProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, UInt32)
    return result
}
...
export ResUtilFindExpandedSzProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindExpandedSzProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, UInt32)
    return result
}
...
export ResUtilFindDwordProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pdwPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindDwordProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pdwPropertyValueMarshal, pdwPropertyValue, UInt32)
    return result
}
...
export ResUtilFindBinaryProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pbPropertyValue, pcbPropertyValueSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindBinaryProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pbPropertyValueMarshal, pbPropertyValue, pcbPropertyValueSizeMarshal, pcbPropertyValueSize, UInt32)
    return result
}
...
export ResUtilFindMultiSzProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue, pcbPropertyValueSize) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindMultiSzProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, pcbPropertyValueSizeMarshal, pcbPropertyValueSize, UInt32)
    return result
}
...
export ResUtilFindLongProperty(pPropertyList, cbPropertyListSize, pszPropertyName, plPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindLongProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, plPropertyValueMarshal, plPropertyValue, UInt32)
    return result
}
...
export ResUtilFindULargeIntegerProperty(pPropertyList, cbPropertyListSize, pszPropertyName, plPropertyValue) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindULargeIntegerProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, plPropertyValueMarshal, plPropertyValue, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilFindFileTimeProperty(pPropertyList, cbPropertyListSize, pszPropertyName, pftPropertyValue) {
    pszPropertyName := pszPropertyName is String ? StrPtr(pszPropertyName) : pszPropertyName

    result := DllCall("RESUTILS.dll\ResUtilFindFileTimeProperty", "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, FILETIME.Ptr, pftPropertyValue, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusWorkerCheckTerminate(lpWorker) {
    result := DllCall("RESUTILS.dll\ClusWorkerCheckTerminate", CLUS_WORKER.Ptr, lpWorker, BOOL)
    return result
}
 ...
 */
export ClusWorkerTerminate(lpWorker) {
    DllCall("RESUTILS.dll\ClusWorkerTerminate", CLUS_WORKER.Ptr, lpWorker)
}
 ...
 * @since windowsserver2016
 */
export ClusWorkerTerminateEx(ClusWorker, TimeoutInMilliseconds, WaitOnly) {
    result := DllCall("RESUTILS.dll\ClusWorkerTerminateEx", CLUS_WORKER.Ptr, ClusWorker, "uint", TimeoutInMilliseconds, BOOL, WaitOnly, UInt32)
    return result
}
...
export ClusWorkersTerminate(ClusWorkers, ClusWorkersCount, TimeoutInMilliseconds, WaitOnly) {
    ...
    result := DllCall("RESUTILS.dll\ClusWorkersTerminate", ClusWorkersMarshal, ClusWorkers, "ptr", ClusWorkersCount, "uint", TimeoutInMilliseconds, BOOL, WaitOnly, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilResourcesEqual(hSelf, _hResource) {
    result := DllCall("RESUTILS.dll\ResUtilResourcesEqual", HRESOURCE, hSelf, HRESOURCE, _hResource, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilResourceTypesEqual(lpszResourceTypeName, _hResource) {
    lpszResourceTypeName := lpszResourceTypeName is String ? StrPtr(lpszResourceTypeName) : lpszResourceTypeName

    result := DllCall("RESUTILS.dll\ResUtilResourceTypesEqual", "ptr", lpszResourceTypeName, HRESOURCE, _hResource, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilIsResourceClassEqual(prci, _hResource) {
    result := DllCall("RESUTILS.dll\ResUtilIsResourceClassEqual", CLUS_RESOURCE_CLASS_INFO.Ptr, prci, HRESOURCE, _hResource, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilGetResourceDependency(hSelf, lpszResourceType) {
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependency", HANDLE, hSelf, "ptr", lpszResourceType, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilGetResourceDependencyByName(_hCluster, hSelf, lpszResourceType, bRecurse) {
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependencyByName", HCLUSTER, _hCluster, HANDLE, hSelf, "ptr", lpszResourceType, BOOL, bRecurse, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilGetResourceDependencyByClass(_hCluster, hSelf, prci, bRecurse) {
    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependencyByClass", HCLUSTER, _hCluster, HANDLE, hSelf, CLUS_RESOURCE_CLASS_INFO.Ptr, prci, BOOL, bRecurse, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilGetResourceNameDependency(lpszResourceName, lpszResourceType) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceNameDependency", "ptr", lpszResourceName, "ptr", lpszResourceType, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ResUtilGetResourceDependentIPAddressProps(_hResource, pszAddress, pcchAddress, pszSubnetMask, pcchSubnetMask, pszNetwork, pcchNetwork) {
...
export ResUtilFindDependentDiskResourceDriveLetter(_hCluster, _hResource, pszDriveLetter, pcchDriveLetter) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilFindDependentDiskResourceDriveLetter", HCLUSTER, _hCluster, HRESOURCE, _hResource, "ptr", pszDriveLetter, pcchDriveLetterMarshal, pcchDriveLetter, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ResUtilTerminateServiceProcessFromResDll(dwServicePid, bOffline, pdwResourceState, pfnLogEvent, hResourceHandle) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilTerminateServiceProcessFromResDll", "uint", dwServicePid, BOOL, bOffline, pdwResourceStateMarshal, pdwResourceState, "ptr", pfnLogEvent, "ptr", hResourceHandle, UInt32)
    return result
}
...
export ResUtilGetPropertyFormats(pPropertyTable, pOutPropertyFormatList, cbPropertyFormatListSize, pcbBytesReturned, pcbRequired) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetPropertyFormats", RESUTIL_PROPERTY_ITEM.Ptr, pPropertyTable, "ptr", pOutPropertyFormatList, "uint", cbPropertyFormatListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, UInt32)
    return result
}
 ...
 * @since windowsserver2008
 */
export ResUtilGetClusterRoleState(_hCluster, eClusterRole) {
    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetClusterRoleState", HCLUSTER, _hCluster, CLUSTER_ROLE, eClusterRole, CLUSTER_ROLE_STATE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterIsPathOnSharedVolume(lpszPathName) {
    lpszPathName := lpszPathName is String ? StrPtr(lpszPathName) : lpszPathName

    result := DllCall("RESUTILS.dll\ClusterIsPathOnSharedVolume", "ptr", lpszPathName, BOOL)
    return result
}
 ...
 * @since windowsserver2008
 */
export ClusterGetVolumePathName(lpszFileName, lpszVolumePathName, cchBufferLength) {
    lpszFileName := lpszFileName is String ? StrPtr(lpszFileName) : lpszFileName
    lpszVolumePathName := lpszVolumePathName is String ? StrPtr(lpszVolumePathName) : lpszVolumePathName

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ClusterGetVolumePathName", "ptr", lpszFileName, "ptr", lpszVolumePathName, "uint", cchBufferLength, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterGetVolumeNameForVolumeMountPoint(lpszVolumeMountPoint, lpszVolumeName, cchBufferLength) {
    lpszVolumeMountPoint := lpszVolumeMountPoint is String ? StrPtr(lpszVolumeMountPoint) : lpszVolumeMountPoint
    lpszVolumeName := lpszVolumeName is String ? StrPtr(lpszVolumeName) : lpszVolumeName

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ClusterGetVolumeNameForVolumeMountPoint", "ptr", lpszVolumeMountPoint, "ptr", lpszVolumeName, "uint", cchBufferLength, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2008
 */
export ClusterPrepareSharedVolumeForBackup(lpszFileName, lpszVolumePathName, lpcchVolumePathName, lpszVolumeName, lpcchVolumeName) {
    lpszFileName := lpszFileName is String ? StrPtr(lpszFileName) : lpszFileName
    lpszVolumePathName := lpszVolumePathName is String ? StrPtr(lpszVolumePathName) : lpszVolumePathName
    lpszVolumeName := lpszVolumeName is String ? StrPtr(lpszVolumeName) : lpszVolumeName
 ...
 * @since windowsserver2008
 */
export ClusterClearBackupStateForSharedVolume(lpszVolumePathName) {
    lpszVolumePathName := lpszVolumePathName is String ? StrPtr(lpszVolumePathName) : lpszVolumePathName

    result := DllCall("RESUTILS.dll\ClusterClearBackupStateForSharedVolume", "ptr", lpszVolumePathName, UInt32)
    return result
}
...
export ResUtilSetResourceServiceStartParametersEx(pszServiceName, schSCMHandle, phService, dwDesiredAccess, pfnLogEvent, hResourceHandle) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilSetResourceServiceStartParametersEx", "ptr", pszServiceName, SC_HANDLE, schSCMHandle, SC_HANDLE.Ptr, phService, "uint", dwDesiredAccess, "ptr", pfnLogEvent, "ptr", hResourceHandle, UInt32)
    return result
}
...
export ResUtilEnumResourcesEx2(_hCluster, hSelf, lpszResTypeName, pResCallBack, pParameter, dwDesiredAccess) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilEnumResourcesEx2", HCLUSTER, _hCluster, HRESOURCE, hSelf, "ptr", lpszResTypeName, "ptr", pResCallBack, pParameterMarshal, pParameter, "uint", dwDesiredAccess, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export ResUtilGetResourceDependencyEx(hSelf, lpszResourceType, dwDesiredAccess) {
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependencyEx", HANDLE, hSelf, "ptr", lpszResourceType, "uint", dwDesiredAccess, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2012
 */
export ResUtilGetResourceDependencyByNameEx(_hCluster, hSelf, lpszResourceType, bRecurse, dwDesiredAccess) {
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependencyByNameEx", HCLUSTER, _hCluster, HANDLE, hSelf, "ptr", lpszResourceType, BOOL, bRecurse, "uint", dwDesiredAccess, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2012
 */
export ResUtilGetResourceDependencyByClassEx(_hCluster, hSelf, prci, bRecurse, dwDesiredAccess) {
    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceDependencyByClassEx", HCLUSTER, _hCluster, HANDLE, hSelf, CLUS_RESOURCE_CLASS_INFO.Ptr, prci, BOOL, bRecurse, "uint", dwDesiredAccess, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windowsserver2012
 */
export ResUtilGetResourceNameDependencyEx(lpszResourceName, lpszResourceType, dwDesiredAccess) {
    lpszResourceName := lpszResourceName is String ? StrPtr(lpszResourceName) : lpszResourceName
    lpszResourceType := lpszResourceType is String ? StrPtr(lpszResourceType) : lpszResourceType

    A_LastError := 0

    result := DllCall("RESUTILS.dll\ResUtilGetResourceNameDependencyEx", "ptr", lpszResourceName, "ptr", lpszResourceType, "uint", dwDesiredAccess, HRESOURCE)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
...
export ResUtilGetCoreClusterResourcesEx(hClusterIn, phClusterNameResourceOut, phClusterQuorumResourceOut, dwDesiredAccess) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilGetCoreClusterResourcesEx", HCLUSTER, hClusterIn, phClusterNameResourceOutMarshal, phClusterNameResourceOut, phClusterQuorumResourceOutMarshal, phClusterQuorumResourceOut, "uint", dwDesiredAccess, UInt32)
    return result
}
...
export OpenClusterCryptProvider(lpszResource, lpszProvider, dwType, dwFlags) {
    ...
    result := DllCall("RESUTILS.dll\OpenClusterCryptProvider", "ptr", lpszResource, lpszProviderMarshal, lpszProvider, "uint", dwType, "uint", dwFlags, HCLUSCRYPTPROVIDER)
    return result
}
 ...
 */
export OpenClusterCryptProviderEx(lpszResource, lpszKeyname, lpszProvider, dwType, dwFlags) {
    lpszResource := lpszResource is String ? StrPtr(lpszResource) : lpszResource
    lpszKeyname := lpszKeyname is String ? StrPtr(lpszKeyname) : lpszKeyname

    lpszProviderMarshal := lpszProvider is VarRef ? "char*" : "ptr"

    result := DllCall("RESUTILS.dll\OpenClusterCryptProviderEx", "ptr", lpszResource, "ptr", lpszKeyname, lpszProviderMarshal, lpszProvider, "uint", dwType, "uint", dwFlags, HCLUSCRYPTPROVIDER)
    return result
}
 ...
 * @since windowsserver2012
 */
export CloseClusterCryptProvider(_hClusCryptProvider) {
    result := DllCall("RESUTILS.dll\CloseClusterCryptProvider", HCLUSCRYPTPROVIDER, _hClusCryptProvider, UInt32)
    return result
}
...
export ClusterEncrypt(_hClusCryptProvider, pData, cbData, ppData, pcbData) {
    ...
    result := DllCall("RESUTILS.dll\ClusterEncrypt", HCLUSCRYPTPROVIDER, _hClusCryptProvider, pDataMarshal, pData, "uint", cbData, ppDataMarshal, ppData, pcbDataMarshal, pcbData, UInt32)
    return result
}
...
export ClusterDecrypt(_hClusCryptProvider, pCryptInput, cbCryptInput, ppCryptOutput, pcbCryptOutput) {
    ...
    result := DllCall("RESUTILS.dll\ClusterDecrypt", HCLUSCRYPTPROVIDER, _hClusCryptProvider, pCryptInputMarshal, pCryptInput, "uint", cbCryptInput, ppCryptOutputMarshal, ppCryptOutput, pcbCryptOutputMarshal, pcbCryptOutput, UInt32)
    return result
}
...
export ResUtilVerifyShutdownSafe(flags, reason, pResult) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilVerifyShutdownSafe", "uint", flags, "uint", reason, pResultMarshal, pResult, UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export ResUtilPaxosComparer(left, right) {
    result := DllCall("RESUTILS.dll\ResUtilPaxosComparer", PaxosTagCStruct.Ptr, left, PaxosTagCStruct.Ptr, right, BOOL)
    return result
}
 ...
 * @since windowsserver2016
 */
export ResUtilLeftPaxosIsLessThanRight(left, right) {
    result := DllCall("RESUTILS.dll\ResUtilLeftPaxosIsLessThanRight", PaxosTagCStruct.Ptr, left, PaxosTagCStruct.Ptr, right, BOOL)
    return result
}
 ...
 * @returns {Integer} 
 */
export ResUtilsDeleteKeyTree(key, keyName, treatNoKeyAsError) {
    keyName := keyName is String ? StrPtr(keyName) : keyName

    result := DllCall("RESUTILS.dll\ResUtilsDeleteKeyTree", HKEY, key, "ptr", keyName, BOOL, treatNoKeyAsError, UInt32)
    return result
}
 ...
 * @returns {HGROUP} 
 */
export ResUtilGetCoreGroup(_hCluster) {
    result := DllCall("RESUTILS.dll\ResUtilGetCoreGroup", HCLUSTER, _hCluster, HGROUP)
    return result
}
...
export ResUtilResourceDepEnum(hSelf, _enumType, pResCallBack, pParameter) {
    ...
    result := DllCall("RESUTILS.dll\ResUtilResourceDepEnum", HRESOURCE, hSelf, "uint", _enumType, "ptr", pResCallBack, pParameterMarshal, pParameter, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export ResUtilGetClusterId(_hCluster, guid) {
    result := DllCall("RESUTILS.dll\ResUtilGetClusterId", HCLUSTER, _hCluster, Guid.Ptr, guid, UInt32)
    return result
}
 ...
 * @since windowsserver2012
 */
export RegisterAppInstance(ProcessHandle, AppInstanceId, ChildrenInheritAppInstance) {
    result := DllCall("NTLANMAN.dll\RegisterAppInstance", HANDLE, ProcessHandle, Guid.Ptr, AppInstanceId, BOOL, ChildrenInheritAppInstance, UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export RegisterAppInstanceVersion(AppInstanceId, InstanceVersionHigh, InstanceVersionLow) {
    result := DllCall("NTLANMAN.dll\RegisterAppInstanceVersion", Guid.Ptr, AppInstanceId, "uint", InstanceVersionHigh, "uint", InstanceVersionLow, UInt32)
    return result
}
...
export ResetAllAppInstanceVersions() {
    result := DllCall("NTLANMAN.dll\ResetAllAppInstanceVersions", UInt32)
    return result
}
 ...
 * @since windowsserver2016
 */
export SetAppInstanceCsvFlags(ProcessHandle, Mask, Flags) {
    result := DllCall("NTLANMAN.dll\SetAppInstanceCsvFlags", HANDLE, ProcessHandle, "uint", Mask, "uint", Flags, UInt32)
    return result
}
