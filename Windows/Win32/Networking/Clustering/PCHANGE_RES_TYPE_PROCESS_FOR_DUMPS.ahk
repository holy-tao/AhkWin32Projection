 ...
 * @version v4.0.30319
 */
class PCHANGE_RES_TYPE_PROCESS_FOR_DUMPS extends IUnknown {
     ...
     */
    Invoke(resourceTypeName, processName, processId, isAdd) {
        ...
        result := ComCall(3, this, "ptr", resourceTypeName, "ptr", processName, "uint", processId, "int", isAdd, "uint")
        return result
    }
}
