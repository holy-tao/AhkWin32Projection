 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_RESOURCE_NAME_DEPENDENCY extends IUnknown {
     ...
     */
    Invoke(lpszResourceName, lpszResourceType) {
        ...
        result := ComCall(3, this, "ptr", lpszResourceName, "ptr", lpszResourceType, "ptr")
