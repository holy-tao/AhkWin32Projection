 ...
 * @version v4.0.30319
 */
class PBEGIN_RESCALL_AS_USER_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Resource, TokenHandle, ControlCode, InBuffer, InBufferSize, OutBuffer, OutBufferSize, BytesReturned, context_, ReturnedAsynchronously) {
        ...
        result := ComCall(3, this, ResourceMarshal, Resource, "ptr", TokenHandle, "uint", ControlCode, InBufferMarshal, InBuffer, "uint", InBufferSize, OutBufferMarshal, OutBuffer, "uint", OutBufferSize, BytesReturnedMarshal, BytesReturned, "int64", context_, ReturnedAsynchronouslyMarshal, ReturnedAsynchronously, "uint")
        return result
    }
}
