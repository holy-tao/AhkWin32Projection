...
/**
 * CLUSTER_CHANGE_GROUPSET_V2 (clusapi.h) defines the list of notifications that are generated for a groupset.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-cluster_change_groupset_v2
