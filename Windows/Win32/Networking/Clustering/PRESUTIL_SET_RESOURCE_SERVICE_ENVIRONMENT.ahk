 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_RESOURCE_SERVICE_ENVIRONMENT extends IUnknown {
     ...
     */
    Invoke(pszServiceName, hResource_, pfnLogEvent, hResourceHandle) {
        ...
        result := ComCall(3, this, "ptr", pszServiceName, "ptr", hResource_, "ptr", pfnLogEvent, "ptr", hResourceHandle, "uint")
        return result
    }
}
