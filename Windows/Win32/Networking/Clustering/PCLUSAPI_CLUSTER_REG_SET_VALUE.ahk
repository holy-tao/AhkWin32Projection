 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_SET_VALUE extends IUnknown {
     ...
     */
    Invoke(hKey_, lpszValueName, dwType, lpData, cbData) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "ptr", lpszValueName, "uint", dwType, lpDataMarshal, lpData, "uint", cbData, "uint")
        return result
    }
}
