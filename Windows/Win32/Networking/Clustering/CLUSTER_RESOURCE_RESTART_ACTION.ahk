...
/**
 * CLUSTER_RESOURCE_RESTART_ACTION (clusapi.h) is used by the RestartAction resource common property to specify the action to be taken by the cluster service if the resource fails.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-cluster_resource_restart_action
