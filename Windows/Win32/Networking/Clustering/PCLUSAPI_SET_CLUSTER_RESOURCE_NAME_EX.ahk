 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_RESOURCE_NAME_EX extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszResourceName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszResourceName, "ptr", lpszReason, "uint")
        return result
    }
}
