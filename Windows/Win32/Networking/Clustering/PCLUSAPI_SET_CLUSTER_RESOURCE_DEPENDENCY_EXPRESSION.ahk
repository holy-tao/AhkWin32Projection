 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszDependencyExpression) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszDependencyExpression, "uint")
        return result
    }
}
