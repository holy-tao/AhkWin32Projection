...
/**
 * CLUSTER_NETWORK_ROLE (clusapi.h) describes the role a network plays in the cluster.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-cluster_network_role
