...
class CLUSTER_RESOURCE_CREATE_FLAGS extends Win32Enum {
     ...
     *       assigned.
     * Native name: CLUSTER_RESOURCE_DEFAULT_MONITOR
     * @type {Integer (Int32)}
     */
    static DEFAULT_MONITOR => 0

    /**
     * Causes the Cluster service to create a separate Resource Monitor dedicated exclusively to the new 
     *       resource.
     * Native name: CLUSTER_RESOURCE_SEPARATE_MONITOR
     * @type {Integer (Int32)}
     */
    static SEPARATE_MONITOR => 1
     ...
     *       enumeration.
     * Native name: CLUSTER_RESOURCE_VALID_FLAGS
     * @type {Integer (Int32)}
     */
    static VALID_FLAGS => 1
}
