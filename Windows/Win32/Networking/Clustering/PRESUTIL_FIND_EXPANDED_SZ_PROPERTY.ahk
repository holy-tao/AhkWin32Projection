 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_EXPANDED_SZ_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue) {
        ...
        result := ComCall(3, this, "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, "uint")
        return result
    }
}
