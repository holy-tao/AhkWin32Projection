...
/**
 * The GROUP_FAILURE_INFO (clusapi.h) structure represents information about the Failover attempts for a group failure.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ns-clusapi-group_failure_info
