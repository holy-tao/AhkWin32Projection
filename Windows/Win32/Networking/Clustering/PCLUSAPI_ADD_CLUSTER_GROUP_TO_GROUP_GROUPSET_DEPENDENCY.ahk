 ...
 * @version v4.0.30319
 */
class PCLUSAPI_ADD_CLUSTER_GROUP_TO_GROUP_GROUPSET_DEPENDENCY extends IUnknown {
     ...
     */
    Invoke(hDependentGroup, hProviderGroupSet) {
        ...
        result := ComCall(3, this, "ptr", hDependentGroup, "ptr", hProviderGroupSet, "uint")
        return result
    }
}
