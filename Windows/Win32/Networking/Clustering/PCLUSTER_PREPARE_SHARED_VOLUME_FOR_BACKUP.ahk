 ...
 * @version v4.0.30319
 */
class PCLUSTER_PREPARE_SHARED_VOLUME_FOR_BACKUP extends IUnknown {
     ...
     */
    Invoke(lpszFileName, lpszVolumePathName, lpcchVolumePathName, lpszVolumeName, lpcchVolumeName) {
        ...
        result := ComCall(3, this, "ptr", lpszFileName, "ptr", lpszVolumePathName, lpcchVolumePathNameMarshal, lpcchVolumePathName, "ptr", lpszVolumeName, lpcchVolumeNameMarshal, lpcchVolumeName, "uint")
        return result
    }
}
