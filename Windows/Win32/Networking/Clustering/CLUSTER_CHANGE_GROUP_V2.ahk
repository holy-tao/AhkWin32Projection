...
/**
 * CLUSTER_CHANGE_GROUP_V2 (clusapi.h) defines the list of notifications that are generated for a group.
 * @remarks
 * Protocol version 2.0 servers do not support this enumeration.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-cluster_change_group_v2
