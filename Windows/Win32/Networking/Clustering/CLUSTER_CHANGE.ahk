...
class CLUSTER_CHANGE extends Win32Enum {
     ...
     * Native name: CLUSTER_CHANGE_NODE_STATE
     * @type {Integer (Int32)}
     */
    static NODE_STATE => 1
     ...
     * Native name: CLUSTER_CHANGE_NODE_DELETED
     * @type {Integer (Int32)}
     */
     ...
     *        node.
     * Native name: CLUSTER_CHANGE_NODE_ADDED
     * @type {Integer (Int32)}
     */
    static NODE_ADDED => 4
     ...
     * Native name: CLUSTER_CHANGE_NODE_PROPERTY
     * @type {Integer (Int32)}
     */
    static NODE_PROPERTY => 8

    /**
     * The queue receives a notification when the name of a cluster database key has changed.
     * Native name: CLUSTER_CHANGE_REGISTRY_NAME
     * @type {Integer (Int32)}
     */
    static REGISTRY_NAME => 16
     ...
     * Native name: CLUSTER_CHANGE_REGISTRY_ATTRIBUTES
     * @type {Integer (Int32)}
     */
    static REGISTRY_ATTRIBUTES => 32
     ...
     * Native name: CLUSTER_CHANGE_REGISTRY_VALUE
     * @type {Integer (Int32)}
     */
    static REGISTRY_VALUE => 64
     ...
     * Native name: CLUSTER_CHANGE_REGISTRY_SUBTREE
     * @type {Integer (Int32)}
     */
    static REGISTRY_SUBTREE => 128
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_STATE
     * @type {Integer (Int32)}
     */
    static RESOURCE_STATE => 256

    /**
     * The queue receives a notification when a resource is deleted.
     * Native name: CLUSTER_CHANGE_RESOURCE_DELETED
     * @type {Integer (Int32)}
     */
    static RESOURCE_DELETED => 512
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_ADDED
     * @type {Integer (Int32)}
     */
    static RESOURCE_ADDED => 1024
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_PROPERTY
     * @type {Integer (Int32)}
     */
    static RESOURCE_PROPERTY => 2048
     ...
     * Native name: CLUSTER_CHANGE_GROUP_STATE
     * @type {Integer (Int32)}
     */
    static GROUP_STATE => 4096

    /**
     * The queue receives a notification when an existing group is deleted.
     * Native name: CLUSTER_CHANGE_GROUP_DELETED
     * @type {Integer (Int32)}
     */
    static GROUP_DELETED => 8192
     ...
     *        in the cluster.
     * Native name: CLUSTER_CHANGE_GROUP_ADDED
     * @type {Integer (Int32)}
     */
    static GROUP_ADDED => 16384
     ...
     * Native name: CLUSTER_CHANGE_GROUP_PROPERTY
     * @type {Integer (Int32)}
     */
    static GROUP_PROPERTY => 32768

    /**
     * The queue receives a notification when an existing resource type is deleted.
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_DELETED
     * @type {Integer (Int32)}
     */
    static RESOURCE_TYPE_DELETED => 65536
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_ADDED
     * @type {Integer (Int32)}
     */
    static RESOURCE_TYPE_ADDED => 131072
     ...
     *        change.
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_PROPERTY
     * @type {Integer (Int32)}
     */
    static RESOURCE_TYPE_PROPERTY => 262144
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_RECONNECT
     * @type {Integer (Int32)}
     */
    static CLUSTER_RECONNECT => 524288
     ...
     * Native name: CLUSTER_CHANGE_NETWORK_STATE
     * @type {Integer (Int32)}
     */
    static NETWORK_STATE => 1048576

    /**
     * The queue receives a notification when a network is permanently removed from the cluster environment.
     * Native name: CLUSTER_CHANGE_NETWORK_DELETED
     * @type {Integer (Int32)}
     */
    static NETWORK_DELETED => 2097152
     ...
     * Native name: CLUSTER_CHANGE_NETWORK_ADDED
     * @type {Integer (Int32)}
     */
    static NETWORK_ADDED => 4194304
     ...
     * Native name: CLUSTER_CHANGE_NETWORK_PROPERTY
     * @type {Integer (Int32)}
     */
    static NETWORK_PROPERTY => 8388608
     ...
     * Native name: CLUSTER_CHANGE_NETINTERFACE_STATE
     * @type {Integer (Int32)}
     */
    static NETINTERFACE_STATE => 16777216

    /**
     * The queue receives a notification when a network interface is permanently removed from a cluster node.
     * Native name: CLUSTER_CHANGE_NETINTERFACE_DELETED
     * @type {Integer (Int32)}
     */
    static NETINTERFACE_DELETED => 33554432
     ...
     * Native name: CLUSTER_CHANGE_NETINTERFACE_ADDED
     * @type {Integer (Int32)}
     */
    static NETINTERFACE_ADDED => 67108864
     ...
     *        interface change.
     * Native name: CLUSTER_CHANGE_NETINTERFACE_PROPERTY
     * @type {Integer (Int32)}
     */
    static NETINTERFACE_PROPERTY => 134217728

    /**
     * This notification is reserved for future use.
     * Native name: CLUSTER_CHANGE_QUORUM_STATE
     * @type {Integer (Int32)}
     */
    static QUORUM_STATE => 268435456
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_STATE
     * @type {Integer (Int32)}
     */
    static CLUSTER_STATE => 536870912
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_PROPERTY
     * @type {Integer (Int32)}
     */
    static CLUSTER_PROPERTY => 1073741824
     ...
     * Native name: CLUSTER_CHANGE_HANDLE_CLOSE
     * @type {Integer (Int32)}
     */
    static HANDLE_CLOSE => -2147483648

    /**
     * Native name: CLUSTER_CHANGE_ALL
     * @type {Integer (Int32)}
     */
    static ALL => -1
}
