 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/resapi/nc-resapi-presource_control_routine
 * @namespace Windows.Win32.Networking.Clustering
 * @version v4.0.30319
 */
class PRESOURCE_CONTROL_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Resource, ControlCode, InBuffer, InBufferSize, OutBuffer, OutBufferSize, BytesReturned) {
        ...
        result := ComCall(3, this, ResourceMarshal, Resource, "uint", ControlCode, InBufferMarshal, InBuffer, "uint", InBufferSize, OutBufferMarshal, OutBuffer, "uint", OutBufferSize, BytesReturnedMarshal, BytesReturned, "uint")
        return result
    }
}
