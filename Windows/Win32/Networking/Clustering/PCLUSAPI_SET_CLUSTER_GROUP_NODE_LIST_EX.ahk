 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_GROUP_NODE_LIST_EX extends IUnknown {
     ...
     */
    Invoke(hGroup_, NodeCount, NodeList, lpszReason) {
        hGroup_ := hGroup_ is Win32Handle ? NumGet(hGroup_, "ptr") : hGroup_
        lpszReason := lpszReason is String ? StrPtr(lpszReason) : lpszReason

        result := ComCall(3, this, "ptr", hGroup_, "uint", NodeCount, "ptr", NodeList, "ptr", lpszReason, "uint")
        return result
    }
}
