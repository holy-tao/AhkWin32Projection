 ...
 * @version v4.0.30319
 */
class PCLUSAPI_IS_FILE_ON_CLUSTER_SHARED_VOLUME extends IUnknown {
     ...
     */
    Invoke(lpszPathName, pbFileIsOnSharedVolume) {
        ...
        result := ComCall(3, this, "ptr", lpszPathName, pbFileIsOnSharedVolumeMarshal, pbFileIsOnSharedVolume, "uint")
        return result
    }
}
