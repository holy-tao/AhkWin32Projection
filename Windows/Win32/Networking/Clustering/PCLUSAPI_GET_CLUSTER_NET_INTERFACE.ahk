 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_NET_INTERFACE extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszNodeName, lpszNetworkName, lpszInterfaceName, lpcchInterfaceName) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszNodeName, "ptr", lpszNetworkName, "ptr", lpszInterfaceName, lpcchInterfaceNameMarshal, lpcchInterfaceName, "uint")
        return result
    }
}
