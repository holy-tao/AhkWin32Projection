 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_RESOURCE_TYPE_KEY extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszTypeName, samDesired) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszTypeName, "uint", samDesired, "ptr")
