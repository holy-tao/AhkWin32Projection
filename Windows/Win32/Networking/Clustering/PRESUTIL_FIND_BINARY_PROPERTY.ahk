 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_BINARY_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pPropertyList, cbPropertyListSize, pszPropertyName, pbPropertyValue, pcbPropertyValueSize) {
        ...
        result := ComCall(3, this, "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pbPropertyValueMarshal, pbPropertyValue, pcbPropertyValueSizeMarshal, pcbPropertyValueSize, "uint")
        return result
    }
}
