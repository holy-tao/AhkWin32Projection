 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX extends IUnknown {
     ...
     */
    Invoke(hResource_, hGroup_, Flags) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", hGroup_, "uint", Flags, "uint")
        return result
    }
}
