 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_MULTI_SZ_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pPropertyList, cbPropertyListSize, pszPropertyName, pszPropertyValue, pcbPropertyValueSize) {
        ...
        result := ComCall(3, this, "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pszPropertyValueMarshal, pszPropertyValue, pcbPropertyValueSizeMarshal, pcbPropertyValueSize, "uint")
        return result
    }
}
