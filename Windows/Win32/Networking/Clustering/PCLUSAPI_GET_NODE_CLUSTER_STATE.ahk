 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_NODE_CLUSTER_STATE extends IUnknown {
     ...
     */
    Invoke(lpszNodeName, pdwClusterState) {
        ...
        result := ComCall(3, this, "ptr", lpszNodeName, pdwClusterStateMarshal, pdwClusterState, "uint")
        return result
    }
}
