 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_DEPENDENT_DISK_RESOURCE_DRIVE_LETTER extends IUnknown {
     ...
     */
    Invoke(hCluster_, hResource_, pszDriveLetter, pcchDriveLetter) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", hResource_, "ptr", pszDriveLetter, pcchDriveLetterMarshal, pcchDriveLetter, "uint")
        return result
    }
}
