 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_DWORD_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pPropertyList, cbPropertyListSize, pszPropertyName, pdwPropertyValue) {
        ...
        result := ComCall(3, this, "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, pdwPropertyValueMarshal, pdwPropertyValue, "uint")
        return result
    }
}
