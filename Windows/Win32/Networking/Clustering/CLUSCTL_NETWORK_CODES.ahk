...
/**
 * CLUSCTL_NETWORK_CODES (clusapi.h) enumerates network control codes.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-clusctl_network_codes
