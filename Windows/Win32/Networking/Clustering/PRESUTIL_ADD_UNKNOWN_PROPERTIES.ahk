 ...
 * @version v4.0.30319
 */
class PRESUTIL_ADD_UNKNOWN_PROPERTIES extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pPropertyTable, pOutPropertyList, pcbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pPropertyTable, pOutPropertyListMarshal, pOutPropertyList, "uint", pcbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, "uint")
        return result
    }
}
