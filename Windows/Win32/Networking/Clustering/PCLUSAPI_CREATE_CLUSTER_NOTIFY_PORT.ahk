 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CREATE_CLUSTER_NOTIFY_PORT extends IUnknown {
     ...
     */
    Invoke(hChange_, hCluster_, dwFilter, dwNotifyKey) {
        ...
        result := ComCall(3, this, "ptr", hChange_, "ptr", hCluster_, "uint", dwFilter, "ptr", dwNotifyKey, "ptr")
