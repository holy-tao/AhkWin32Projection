 ...
 * @version v4.0.30319
 */
class PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY_EX extends IUnknown {
     ...
     */
    Invoke(hDependentGroupSet, hProviderGroupSet, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hDependentGroupSet, "ptr", hProviderGroupSet, "ptr", lpszReason, "uint")
        return result
    }
}
