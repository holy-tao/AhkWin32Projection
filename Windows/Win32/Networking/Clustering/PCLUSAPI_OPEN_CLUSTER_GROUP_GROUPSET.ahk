 ...
 */
export default struct PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET) {
    ...
    /**
     * A PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET {
        /**
         * Creates a PCLUSAPI_OPEN_CLUSTER_GROUP_GROUPSET pointer that invokes the given AHK function when called.
