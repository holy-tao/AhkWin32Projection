 ...
 * @see https://learn.microsoft.com/windows/win32/api/resapi/ns-resapi-clres_v3_functions
 * @namespace Windows.Win32.Networking.Clustering
 */
export default struct CLRES_V3_FUNCTIONS {
    #StructPack 8
     ...
     *       point.
     */
    BeginResourceTypeControl : IntPtr
