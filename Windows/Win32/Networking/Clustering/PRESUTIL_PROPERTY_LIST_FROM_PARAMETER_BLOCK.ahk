 ...
 * @version v4.0.30319
 */
class PRESUTIL_PROPERTY_LIST_FROM_PARAMETER_BLOCK extends IUnknown {
     ...
     */
    Invoke(pPropertyTable, pOutPropertyList, pcbOutPropertyListSize, pInParams, pcbBytesReturned, pcbRequired) {
        ...
        result := ComCall(3, this, "ptr", pPropertyTable, "ptr", pOutPropertyList, pcbOutPropertyListSizeMarshal, pcbOutPropertyListSize, pInParamsMarshal, pInParams, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, "uint")
        return result
    }
}
