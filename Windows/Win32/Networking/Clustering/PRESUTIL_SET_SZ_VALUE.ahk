 ...
 */
export default struct PRESUTIL_SET_SZ_VALUE {
    value : IntPtr

    __value {
        set {
            if (value is PRESUTIL_SET_SZ_VALUE) {
    ...
    /**
     * A PRESUTIL_SET_SZ_VALUE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PRESUTIL_SET_SZ_VALUE {
        /**
         * Creates a PRESUTIL_SET_SZ_VALUE pointer that invokes the given AHK function when called.
