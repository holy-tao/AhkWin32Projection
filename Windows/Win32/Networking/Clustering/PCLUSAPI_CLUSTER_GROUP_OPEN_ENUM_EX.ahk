 ...
 */
export default struct PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX) {
    ...
    /**
     * A PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX {
        /**
         * Creates a PCLUSAPI_CLUSTER_GROUP_OPEN_ENUM_EX pointer that invokes the given AHK function when called.
         * @param {Func(HCLUSTER, IntPtr, UInt32, IntPtr, UInt32, UInt32) => HGROUPENUMEX} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 6)) {
