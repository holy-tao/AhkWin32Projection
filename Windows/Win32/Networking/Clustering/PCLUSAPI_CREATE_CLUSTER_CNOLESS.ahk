 ...
 */
export default struct PCLUSAPI_CREATE_CLUSTER_CNOLESS {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_CREATE_CLUSTER_CNOLESS) {
    ...
    /**
     * A PCLUSAPI_CREATE_CLUSTER_CNOLESS that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_CREATE_CLUSTER_CNOLESS {
        /**
         * Creates a PCLUSAPI_CREATE_CLUSTER_CNOLESS pointer that invokes the given AHK function when called.
