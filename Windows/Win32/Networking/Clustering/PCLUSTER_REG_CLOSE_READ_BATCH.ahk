 ...
 * @version v4.0.30319
 */
class PCLUSTER_REG_CLOSE_READ_BATCH extends IUnknown {
     ...
     */
    Invoke(hRegReadBatch_, phRegReadBatchReply) {
        hRegReadBatch_ := hRegReadBatch_ is Win32Handle ? NumGet(hRegReadBatch_, "ptr") : hRegReadBatch_

        result := ComCall(3, this, "ptr", hRegReadBatch_, "ptr", phRegReadBatchReply, "int")
        return result
    }
}
