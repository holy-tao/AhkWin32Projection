 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_CREATE_KEY extends IUnknown {
     ...
     */
    Invoke(hKey_, lpszSubKey, dwOptions, samDesired, lpSecurityAttributes, phkResult, lpdwDisposition) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "ptr", lpszSubKey, "uint", dwOptions, "uint", samDesired, "ptr", lpSecurityAttributes, "ptr", phkResult, lpdwDispositionMarshal, lpdwDisposition, "int")
        return result
    }
}
