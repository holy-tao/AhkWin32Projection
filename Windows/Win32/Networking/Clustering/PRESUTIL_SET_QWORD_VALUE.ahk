 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_QWORD_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, qwNewValue, pqwOutValue) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, "uint", qwNewValue, pqwOutValueMarshal, pqwOutValue, "uint")
        return result
    }
}
