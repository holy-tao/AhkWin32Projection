 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/resapi/nc-resapi-pbegin_restypecall_routine
 * @namespace Windows.Win32.Networking.Clustering
 * @version v4.0.30319
 */
class PBEGIN_RESTYPECALL_ROUTINE extends IUnknown {
     ...
     */
    Invoke(ResourceTypeName, ControlCode, InBuffer, InBufferSize, OutBuffer, OutBufferSize, BytesReturned, context_, ReturnedAsynchronously) {
        ...
        result := ComCall(3, this, "ptr", ResourceTypeName, "uint", ControlCode, InBufferMarshal, InBuffer, "uint", InBufferSize, OutBufferMarshal, OutBuffer, "uint", OutBufferSize, BytesReturnedMarshal, BytesReturned, "int64", context_, ReturnedAsynchronouslyMarshal, ReturnedAsynchronously, "uint")
        return result
    }
}
