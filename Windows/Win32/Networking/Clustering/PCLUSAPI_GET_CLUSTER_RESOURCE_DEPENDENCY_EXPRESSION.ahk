 ...
 * @version v4.0.30319
 */
class PCLUSAPI_GET_CLUSTER_RESOURCE_DEPENDENCY_EXPRESSION extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszDependencyExpression, lpcchDependencyExpression) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszDependencyExpression, lpcchDependencyExpressionMarshal, lpcchDependencyExpression, "uint")
        return result
    }
}
