...
class CLUSTER_CHANGE_CLUSTER_V2 extends Win32Enum {
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_RECONNECT_V2
     * @type {Integer (Int32)}
     */
    static RECONNECT_V2 => 1

    /**
     * Indicates that a cluster state changed. This notification applies to clients only.
     * Native name: CLUSTER_CHANGE_CLUSTER_STATE_V2
     * @type {Integer (Int32)}
     */
    static STATE_V2 => 2
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_GROUP_ADDED_V2
     * @type {Integer (Int32)}
     */
    static GROUP_ADDED_V2 => 4

    /**
     * Indicates that a context handle was closed. This notification applies to clients only.
     * Native name: CLUSTER_CHANGE_CLUSTER_HANDLE_CLOSE_V2
     * @type {Integer (Int32)}
     */
    static HANDLE_CLOSE_V2 => 8

    /**
     * Indicates that a cluster network was added to the cluster.
     * Native name: CLUSTER_CHANGE_CLUSTER_NETWORK_ADDED_V2
     * @type {Integer (Int32)}
     */
    static NETWORK_ADDED_V2 => 16

    /**
     * Indicates that a node was added to the cluster. Nodes are added to a cluster in an implementation-specific way.
     * Native name: CLUSTER_CHANGE_CLUSTER_NODE_ADDED_V2
     * @type {Integer (Int32)}
     */
    static NODE_ADDED_V2 => 32

    /**
     * Indicates that a new resource type was added to the cluster.
     * Native name: CLUSTER_CHANGE_CLUSTER_RESOURCE_TYPE_ADDED_V2
     * @type {Integer (Int32)}
     */
    static RESOURCE_TYPE_ADDED_V2 => 64

    /**
     * Indicates that a cluster common property changed.
     * Native name: CLUSTER_CHANGE_CLUSTER_COMMON_PROPERTY_V2
     * @type {Integer (Int32)}
     */
    static COMMON_PROPERTY_V2 => 128

    /**
     * Indicates that a cluster private property changed.
     * Native name: CLUSTER_CHANGE_CLUSTER_PRIVATE_PROPERTY_V2
     * @type {Integer (Int32)}
     */
    static PRIVATE_PROPERTY_V2 => 256

    /**
     * Indicates that notifications might have been lost due to a transient condition on the server.
     * Native name: CLUSTER_CHANGE_CLUSTER_LOST_NOTIFICATIONS_V2
     * @type {Integer (Int32)}
     */
    static LOST_NOTIFICATIONS_V2 => 512

    /**
     * Indicates that the cluster's name changed.
     * Native name: CLUSTER_CHANGE_CLUSTER_RENAME_V2
     * @type {Integer (Int32)}
     */
    static RENAME_V2 => 1024

    /**
     * Indicates that the cluster's membership changed.
     * Native name: CLUSTER_CHANGE_CLUSTER_MEMBERSHIP_V2
     * @type {Integer (Int32)}
     */
    static MEMBERSHIP_V2 => 2048
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_UPGRADED_V2
     * @type {Integer (Int32)}
     */
    static UPGRADED_V2 => 4096
     ...
     * Native name: CLUSTER_CHANGE_CLUSTER_ALL_V2
     * @type {Integer (Int32)}
     */
    static ALL_V2 => 8191
}
