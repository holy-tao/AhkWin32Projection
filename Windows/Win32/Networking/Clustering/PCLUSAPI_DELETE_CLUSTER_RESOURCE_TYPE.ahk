 ...
 * @version v4.0.30319
 */
class PCLUSAPI_DELETE_CLUSTER_RESOURCE_TYPE extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszResourceTypeName) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszResourceTypeName, "uint")
        return result
    }
}
