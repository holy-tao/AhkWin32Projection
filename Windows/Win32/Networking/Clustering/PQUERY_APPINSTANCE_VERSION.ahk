 ...
 * @version v4.0.30319
 */
class PQUERY_APPINSTANCE_VERSION extends IUnknown {
     ...
     */
    Invoke(AppInstanceId, InstanceVersionHigh, InstanceVersionLow, VersionStatus) {
        ...
        result := ComCall(3, this, "ptr", AppInstanceId, InstanceVersionHighMarshal, InstanceVersionHigh, InstanceVersionLowMarshal, InstanceVersionLow, VersionStatusMarshal, VersionStatus, "uint")
        return result
    }
}
