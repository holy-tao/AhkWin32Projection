 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_QUORUM_RESOURCE extends IUnknown {
     ...
     */
    Invoke(hResource_, lpszDeviceName, dwMaxQuoLogSize) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", lpszDeviceName, "uint", dwMaxQuoLogSize, "uint")
        return result
    }
}
