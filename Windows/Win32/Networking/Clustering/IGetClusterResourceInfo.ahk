 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nn-cluadmex-igetclusterresourceinfo
...
class IGetClusterResourceInfo extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-igetclusterresourceinfo-getresourcehandle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-igetclusterresourceinfo-getresourcetypename
     */
    GetResourceTypeName(lObjIndex, lpszResTypeName, pcchResTypeName) {
        if(lpszResTypeName is String) {
            pin := BSTR.Alloc(lpszResTypeName)
            lpszResTypeName := pin.Value
        }

        pcchResTypeNameMarshal := pcchResTypeName is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "int", lObjIndex, "ptr", lpszResTypeName, pcchResTypeNameMarshal, pcchResTypeName, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cluadmex/nf-cluadmex-igetclusterresourceinfo-getresourcenetworkname
     */
    GetResourceNetworkName(lObjIndex, lpszNetName, pcchNetName) {
        if(lpszNetName is String) {
            pin := BSTR.Alloc(lpszNetName)
            lpszNetName := pin.Value
        }
