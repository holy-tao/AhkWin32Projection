 ...
 */
export default struct ISClusResPossibleOwnerNodes extends IDispatch {
    /**
     ...
     * used for ISClusResPossibleOwnerNodes interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISClusResPossibleOwnerNodes.Vtbl()
        }
