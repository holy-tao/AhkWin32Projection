 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY_EX extends IUnknown {
     ...
     */
    Invoke(hKey_, SecurityInformation, pSecurityDescriptor, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "uint", SecurityInformation, "ptr", pSecurityDescriptor, "ptr", lpszReason, "int")
        return result
    }
}
