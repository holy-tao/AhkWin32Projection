...
/**
 * The RESOURCE_FAILURE_INFO (clusapi.h) structure represents information about the Failover attempts for a resource.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ns-clusapi-resource_failure_info
