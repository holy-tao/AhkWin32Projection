 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_PROPERTY_TABLE_EX extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pPropertyTable, Reserved, bAllowUnknownProperties, pInPropertyList, cbInPropertyListSize, bForceWrite, pOutParams) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pPropertyTable, ReservedMarshal, Reserved, "int", bAllowUnknownProperties, pInPropertyListMarshal, pInPropertyList, "uint", cbInPropertyListSize, "int", bForceWrite, pOutParamsMarshal, pOutParams, "uint")
        return result
    }
}
