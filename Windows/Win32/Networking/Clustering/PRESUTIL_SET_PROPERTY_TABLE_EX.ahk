 ...
 */
export default struct PRESUTIL_SET_PROPERTY_TABLE_EX {
    value : IntPtr

    __value {
        set {
            if (value is PRESUTIL_SET_PROPERTY_TABLE_EX) {
    ...
    /**
     * A PRESUTIL_SET_PROPERTY_TABLE_EX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PRESUTIL_SET_PROPERTY_TABLE_EX {
        /**
         * Creates a PRESUTIL_SET_PROPERTY_TABLE_EX pointer that invokes the given AHK function when called.
         * @param {Func(HKEY, RESUTIL_PROPERTY_ITEM, "ptr", BOOL, "ptr", UInt32, BOOL, "char*") => UInt32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 8)) {
