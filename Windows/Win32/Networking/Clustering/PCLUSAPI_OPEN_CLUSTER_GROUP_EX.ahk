 ...
 * @version v4.0.30319
 */
class PCLUSAPI_OPEN_CLUSTER_GROUP_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszGroupName, dwDesiredAccess, lpdwGrantedAccess) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszGroupName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, "ptr")
