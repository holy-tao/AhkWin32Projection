...
/**
 * CLUSTER_CHANGE_RESOURCE_TYPE_V2 (clusapi.h) defines the set of notifications that are generated for a resource type.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-cluster_change_resource_type_v2
