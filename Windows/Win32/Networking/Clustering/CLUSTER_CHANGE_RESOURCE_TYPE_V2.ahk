 ...
 * @see https://learn.microsoft.com/windows/win32/api/msclus/ne-msclus-cluster_change_resource_type_v2
 * @namespace Windows.Win32.Networking.Clustering
 */
class CLUSTER_CHANGE_RESOURCE_TYPE_V2 extends Win32Enum {

    /**
     * Indicates that the resource type has been deleted.
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_DELETED_V2
     * @type {Integer (Int32)}
     */
    static DELETED_V2 => 1
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_COMMON_PROPERTY_V2
     * @type {Integer (Int32)}
     */
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_PRIVATE_PROPERTY_V2
     * @type {Integer (Int32)}
     */
     ...
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_POSSIBLE_OWNERS_V2
     * @type {Integer (Int32)}
     */
    static POSSIBLE_OWNERS_V2 => 8

    /**
     * Indicates that the resource type DLL has been upgraded.
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_DLL_UPGRADED_V2
     * @type {Integer (Int32)}
     */
    static DLL_UPGRADED_V2 => 16
     ...
     * Native name: CLUSTER_RESOURCE_TYPE_SPECIFIC_V2
     * @type {Integer (Int32)}
     */
    static SPECIFIC_V2 => 32

    /**
     * Indicates all V2 resource type notifications.
     * Native name: CLUSTER_CHANGE_RESOURCE_TYPE_ALL_V2
     * @type {Integer (Int32)}
     */
    static ALL_V2 => 63
}
