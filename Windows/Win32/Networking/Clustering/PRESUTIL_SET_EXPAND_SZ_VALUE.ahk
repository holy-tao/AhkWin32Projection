 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_EXPAND_SZ_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, pszNewValue, ppszOutString) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, "ptr", pszNewValue, ppszOutStringMarshal, ppszOutString, "uint")
        return result
    }
}
