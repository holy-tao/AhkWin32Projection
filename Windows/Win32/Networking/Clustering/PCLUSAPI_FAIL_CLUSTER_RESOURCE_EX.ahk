 ...
 */
export default struct PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX) {
    ...
    /**
     * A PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX {
        /**
         * Creates a PCLUSAPI_FAIL_CLUSTER_RESOURCE_EX pointer that invokes the given AHK function when called.
