...
export default struct PCLUSAPI_CLUSTER_GROUP_GROUPSET_CONTROL_EX {
    ...
    Call(_hGroupSet, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned, lpszReason) {
        ...
        result := DllCall(this.value, HGROUPSET, _hGroupSet, hHostNodeMarshal, hHostNode, UInt32, dwControlCode, lpInBufferMarshal, lpInBuffer, UInt32, cbInBufferSize, lpOutBufferMarshal, lpOutBuffer, UInt32, cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, lpszReasonMarshal, lpszReason, UInt32)
        return result
    }
