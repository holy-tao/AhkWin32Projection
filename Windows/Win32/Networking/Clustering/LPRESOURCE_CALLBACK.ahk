 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/resapi/nc-resapi-lpresource_callback
 * @namespace Windows.Win32.Networking.Clustering
 * @version v4.0.30319
 */
class LPRESOURCE_CALLBACK extends IUnknown {
    ...
    Invoke(param0, param1, param2) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, param2Marshal, param2, "uint")
        return result
    }
}
