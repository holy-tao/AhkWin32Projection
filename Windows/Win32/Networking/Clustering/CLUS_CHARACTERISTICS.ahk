...
/**
 * CLUS_CHARACTERISTICS (clusapi.h) enumerates characteristics of resource types and resources.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ne-clusapi-clus_characteristics
