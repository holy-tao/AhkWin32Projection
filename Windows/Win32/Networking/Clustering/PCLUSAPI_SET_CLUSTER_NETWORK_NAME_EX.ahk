 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_NETWORK_NAME_EX extends IUnknown {
     ...
     */
    Invoke(hNetwork_, lpszName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hNetwork_, "ptr", lpszName, "ptr", lpszReason, "uint")
        return result
    }
}
