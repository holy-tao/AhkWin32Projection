 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_SET_KEY_SECURITY extends IUnknown {
     ...
     */
    Invoke(hKey_, SecurityInformation, pSecurityDescriptor) {
        ...
        result := ComCall(3, this, "ptr", hKey_, "uint", SecurityInformation, "ptr", pSecurityDescriptor, "int")
        return result
    }
}
