 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_LONG_PROPERTY extends IUnknown {
     ...
     */
    Invoke(plOutValue, pValueStruct, lOldValue, lMinimum, lMaximum, ppPropertyList, pcbPropertyListSize) {
        ...
        result := ComCall(3, this, plOutValueMarshal, plOutValue, "ptr", pValueStruct, "int", lOldValue, "int", lMinimum, "int", lMaximum, ppPropertyListMarshal, ppPropertyList, pcbPropertyListSizeMarshal, pcbPropertyListSize, "uint")
        return result
    }
}
