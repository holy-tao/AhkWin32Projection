 ...
 */
export default struct PCLUSAPI_OPEN_CLUSTER_GROUP {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_OPEN_CLUSTER_GROUP) {
    ...
    /**
     * A PCLUSAPI_OPEN_CLUSTER_GROUP that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_OPEN_CLUSTER_GROUP {
        /**
         * Creates a PCLUSAPI_OPEN_CLUSTER_GROUP pointer that invokes the given AHK function when called.
