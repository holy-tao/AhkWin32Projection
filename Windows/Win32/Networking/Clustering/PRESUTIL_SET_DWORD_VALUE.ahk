 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_DWORD_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, dwNewValue, pdwOutValue) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, "uint", dwNewValue, pdwOutValueMarshal, pdwOutValue, "uint")
        return result
    }
}
