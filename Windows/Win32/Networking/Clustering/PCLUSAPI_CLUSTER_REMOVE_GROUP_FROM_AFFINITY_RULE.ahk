 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REMOVE_GROUP_FROM_AFFINITY_RULE extends IUnknown {
     ...
     */
    Invoke(hCluster_, ruleName, hGroup_) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", ruleName, "ptr", hGroup_, "uint")
        return result
    }
}
