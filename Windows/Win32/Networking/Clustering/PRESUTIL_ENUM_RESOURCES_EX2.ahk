 ...
 * @version v4.0.30319
 */
class PRESUTIL_ENUM_RESOURCES_EX2 extends IUnknown {
     ...
     */
    Invoke(hCluster_, hSelf, lpszResTypeName, pResCallBack, pParameter, dwDesiredAccess) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", hSelf, "ptr", lpszResTypeName, "ptr", pResCallBack, pParameterMarshal, pParameter, "uint", dwDesiredAccess, "uint")
        return result
    }
}
