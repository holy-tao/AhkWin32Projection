 ...
 * @version v4.0.30319
 */
class POPEN_V2_ROUTINE extends IUnknown {
     ...
     */
    Invoke(ResourceName, ResourceKey, ResourceHandle, OpenFlags) {
        ...
        result := ComCall(3, this, "ptr", ResourceName, "ptr", ResourceKey, "ptr", ResourceHandle, "uint", OpenFlags, "ptr")
        return result
    }
}
