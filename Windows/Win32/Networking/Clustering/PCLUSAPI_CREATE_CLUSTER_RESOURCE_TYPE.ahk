 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CREATE_CLUSTER_RESOURCE_TYPE extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszResourceTypeName, lpszDisplayName, lpszResourceTypeDll, dwLooksAlivePollInterval, dwIsAlivePollInterval) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszResourceTypeName, "ptr", lpszDisplayName, "ptr", lpszResourceTypeDll, "uint", dwLooksAlivePollInterval, "uint", dwIsAlivePollInterval, "uint")
        return result
    }
}
