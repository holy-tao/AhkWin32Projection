 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_NAME_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszNewClusterName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszNewClusterName, "ptr", lpszReason, "uint")
        return result
    }
}
