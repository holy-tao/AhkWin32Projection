...
class ISClusNode extends IDispatch{
    ...
    /**
     * 
     * @param {Pointer<BSTR>} pbstrNodeID 
     * @returns {HRESULT} 
     */
    get_NodeID(pbstrNodeID) {
        result := ComCall(13, this, "ptr", pbstrNodeID, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ISClusResGroups>} ppResourceGroups 
     * @returns {HRESULT} 
     */
    get_ResourceGroups(ppResourceGroups) {
        result := ComCall(18, this, "ptr", ppResourceGroups, "int")
        if(result != 0)
            throw OSError(result)
    ...
    get_Cluster(ppCluster) {
        result := ComCall(19, this, "ptr", ppCluster, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<ISClusNodeNetInterfaces>} ppClusNetInterfaces 
     * @returns {HRESULT} 
     */
    get_NetInterfaces(ppClusNetInterfaces) {
        result := ComCall(20, this, "ptr", ppClusNetInterfaces, "int")
        if(result != 0)
            throw OSError(result)
