...
export default struct PCLUSAPI_CLUSTER_AFFINITY_RULE_CONTROL {
    ...
    Call(_hCluster, affinityRuleName, hHostNode, dwControlCode, lpInBuffer, cbInBufferSize, lpOutBuffer, cbOutBufferSize, lpBytesReturned) {
        ...
        result := DllCall(this.value, HCLUSTER, _hCluster, "ptr", affinityRuleName, hHostNodeMarshal, hHostNode, UInt32, dwControlCode, lpInBufferMarshal, lpInBuffer, UInt32, cbInBufferSize, lpOutBufferMarshal, lpOutBuffer, UInt32, cbOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, UInt32)
        return result
    }
