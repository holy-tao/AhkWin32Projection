 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_PROPERTY_PARAMETER_BLOCK_EX extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pPropertyTable, Reserved, pInParams, pInPropertyList, cbInPropertyListSize, bForceWrite, pOutParams) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pPropertyTable, ReservedMarshal, Reserved, pInParamsMarshal, pInParams, pInPropertyListMarshal, pInPropertyList, "uint", cbInPropertyListSize, "int", bForceWrite, pOutParamsMarshal, pOutParams, "uint")
        return result
    }
}
