 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX extends IUnknown {
     ...
     */
    Invoke(hGroup_, lpszDependencyExpression, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hGroup_, "ptr", lpszDependencyExpression, "ptr", lpszReason, "uint")
        return result
    }
}
