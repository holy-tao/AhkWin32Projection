 ...
 */
export default struct PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX {
    value : IntPtr

    __value {
        set {
            if (value is PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX) {
     ...
     * @returns {Integer} 
     */
    Call(_hGroup, lpszDependencyExpression, lpszReason) {
    ...
    /**
     * A PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX {
        /**
         * Creates a PCLUSAPI_SET_GROUP_DEPENDENCY_EXPRESSION_EX pointer that invokes the given AHK function when called.
