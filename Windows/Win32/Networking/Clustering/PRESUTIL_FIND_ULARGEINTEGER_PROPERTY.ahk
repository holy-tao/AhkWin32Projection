 ...
 * @version v4.0.30319
 */
class PRESUTIL_FIND_ULARGEINTEGER_PROPERTY extends IUnknown {
     ...
     */
    Invoke(pPropertyList, cbPropertyListSize, pszPropertyName, plPropertyValue) {
        ...
        result := ComCall(3, this, "ptr", pPropertyList, "uint", cbPropertyListSize, "ptr", pszPropertyName, plPropertyValueMarshal, plPropertyValue, "uint")
        return result
    }
}
