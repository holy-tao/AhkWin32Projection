 ...
 * @version v4.0.30319
 */
class PCLUSAPI_SET_CLUSTER_GROUP_NAME_EX extends IUnknown {
     ...
     */
    Invoke(hGroup_, lpszGroupName, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hGroup_, "ptr", lpszGroupName, "ptr", lpszReason, "uint")
        return result
    }
}
