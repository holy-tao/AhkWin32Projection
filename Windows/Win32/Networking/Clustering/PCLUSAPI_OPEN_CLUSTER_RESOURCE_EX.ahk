 ...
 * @version v4.0.30319
 */
class PCLUSAPI_OPEN_CLUSTER_RESOURCE_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszResourceName, dwDesiredAccess, lpdwGrantedAccess) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszResourceName, "uint", dwDesiredAccess, lpdwGrantedAccessMarshal, lpdwGrantedAccess, "ptr")
