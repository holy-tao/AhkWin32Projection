 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_RESOURCE_TYPE_CONTROL extends IUnknown {
     ...
     */
    Invoke(hCluster_, lpszResourceTypeName, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", lpszResourceTypeName, "ptr", hHostNode, "uint", dwControlCode, "ptr", lpInBuffer, "uint", nInBufferSize, "ptr", lpOutBuffer, "uint", nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, "uint")
        return result
    }
}
