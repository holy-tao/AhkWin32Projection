...
class CLUSTER_NODE_ENUM extends Win32Enum {
     ...
     * Native name: CLUSTER_NODE_ENUM_NETINTERFACES
     * @type {Integer (Int32)}
     */
     ...
     * Native name: CLUSTER_NODE_ENUM_GROUPS
     * @type {Integer (Int32)}
     */
    static GROUPS => 2
     ...
     * Native name: CLUSTER_NODE_ENUM_PREFERRED_GROUPS
     * @type {Integer (Int32)}
     */
    static PREFERRED_GROUPS => 4

    /**
     * Network interfaces on the node, groups on the node, and groups that list the node as their preferred owner..
     * Native name: CLUSTER_NODE_ENUM_ALL
     * @type {Integer (Int32)}
     */
    static ALL => 3
}
