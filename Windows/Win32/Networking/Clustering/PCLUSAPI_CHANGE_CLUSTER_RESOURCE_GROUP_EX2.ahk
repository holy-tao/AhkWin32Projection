 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CHANGE_CLUSTER_RESOURCE_GROUP_EX2 extends IUnknown {
     ...
     */
    Invoke(hResource_, hGroup_, Flags, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hResource_, "ptr", hGroup_, "uint", Flags, "ptr", lpszReason, "uint")
        return result
    }
}
