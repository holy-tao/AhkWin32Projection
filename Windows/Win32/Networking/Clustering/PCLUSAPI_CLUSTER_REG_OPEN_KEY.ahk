 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CLUSTER_REG_OPEN_KEY extends IUnknown {
     ...
     */
    Invoke(hKey_, lpszSubKey, samDesired, phkResult) {
        hKey_ := hKey_ is Win32Handle ? NumGet(hKey_, "ptr") : hKey_
        lpszSubKey := lpszSubKey is String ? StrPtr(lpszSubKey) : lpszSubKey

        result := ComCall(3, this, "ptr", hKey_, "ptr", lpszSubKey, "uint", samDesired, "ptr", phkResult, "int")
        return result
    }
}
