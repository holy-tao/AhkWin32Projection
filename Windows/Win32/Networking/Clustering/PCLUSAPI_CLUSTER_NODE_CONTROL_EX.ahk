...
export default struct PCLUSAPI_CLUSTER_NODE_CONTROL_EX {
    ...
    Call(_hNode, hHostNode, dwControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpszReason) {
        ...
        result := DllCall(this.value, HNODE, _hNode, hHostNodeMarshal, hHostNode, UInt32, dwControlCode, lpInBufferMarshal, lpInBuffer, UInt32, nInBufferSize, lpOutBufferMarshal, lpOutBuffer, UInt32, nOutBufferSize, lpBytesReturnedMarshal, lpBytesReturned, lpszReasonMarshal, lpszReason, UInt32)
        return result
    }
