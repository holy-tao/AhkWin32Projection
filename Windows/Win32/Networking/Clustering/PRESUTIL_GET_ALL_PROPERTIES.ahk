 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_ALL_PROPERTIES extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pPropertyTable, pOutPropertyList, cbOutPropertyListSize, pcbBytesReturned, pcbRequired) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pPropertyTable, "ptr", pOutPropertyList, "uint", cbOutPropertyListSize, pcbBytesReturnedMarshal, pcbBytesReturned, pcbRequiredMarshal, pcbRequired, "uint")
        return result
    }
}
