 ...
 * @version v4.0.30319
 */
class PCLUSAPI_EVICT_CLUSTER_NODE_EX2 extends IUnknown {
     ...
     */
    Invoke(hNode_, dwTimeout, phrCleanupStatus, lpszReason) {
        ...
        result := ComCall(3, this, "ptr", hNode_, "uint", dwTimeout, phrCleanupStatusMarshal, phrCleanupStatus, "ptr", lpszReason, "uint")
        return result
    }
}
