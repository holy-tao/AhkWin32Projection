 ...
 * @version v4.0.30319
 */
class PRESUTIL_DUP_PARAMETER_BLOCK extends IUnknown {
    ...
    Invoke(pOutParams, pInParams, pPropertyTable) {
        ...
        result := ComCall(3, this, pOutParamsMarshal, pOutParams, pInParamsMarshal, pInParams, "ptr", pPropertyTable, "uint")
        return result
    }
}
