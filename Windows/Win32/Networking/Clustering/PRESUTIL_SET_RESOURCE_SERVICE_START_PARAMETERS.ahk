 ...
 * @version v4.0.30319
 */
class PRESUTIL_SET_RESOURCE_SERVICE_START_PARAMETERS extends IUnknown {
     ...
     */
    Invoke(pszServiceName, schSCMHandle, phService, pfnLogEvent, hResourceHandle) {
        ...
        result := ComCall(3, this, "ptr", pszServiceName, "ptr", schSCMHandle, "ptr", phService, "ptr", pfnLogEvent, "ptr", hResourceHandle, "uint")
        return result
    }
}
