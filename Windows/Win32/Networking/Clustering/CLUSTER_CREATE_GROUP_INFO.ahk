...
/**
 * CLUSTER_CREATE_GROUP_INFO allows the caller to provide additional properties when creating a new group.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ns-clusapi-cluster_create_group_info
