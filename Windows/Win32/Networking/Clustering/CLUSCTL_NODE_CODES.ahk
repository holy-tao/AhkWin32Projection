...
class CLUSCTL_NODE_CODES extends Win32Enum {
     ...
     * Native name: CLUSCTL_NODE_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 67108864
     ...
     * Native name: CLUSCTL_NODE_GET_CHARACTERISTICS
     * @type {Integer (Int32)}
     */
    static GET_CHARACTERISTICS => 67108869
     ...
     * Native name: CLUSCTL_NODE_ENUM_COMMON_PROPERTIES
     * @type {Integer (Int32)}
     */
    static ENUM_COMMON_PROPERTIES => 67108945
     ...
     * Native name: CLUSCTL_NODE_GET_RO_COMMON_PROPERTIES
     * @type {Integer (Int32)}
     */
    static GET_RO_COMMON_PROPERTIES => 67108949
     ...
     * Native name: CLUSCTL_NODE_GET_COMMON_PROPERTIES
     * @type {Integer (Int32)}
     */
    static GET_COMMON_PROPERTIES => 67108953
     ...
     * Native name: CLUSCTL_NODE_SET_COMMON_PROPERTIES
     * @type {Integer (Int32)}
     */
    static SET_COMMON_PROPERTIES => 71303262
     ...
     * Native name: CLUSCTL_NODE_VALIDATE_COMMON_PROPERTIES
     * @type {Integer (Int32)}
     */
    static VALIDATE_COMMON_PROPERTIES => 67108961
     ...
     * Native name: CLUSCTL_NODE_ENUM_PRIVATE_PROPERTIES
     * @type {Integer (Int32)}
     */
    static ENUM_PRIVATE_PROPERTIES => 67108985
     ...
     * Native name: CLUSCTL_NODE_GET_RO_PRIVATE_PROPERTIES
     * @type {Integer (Int32)}
     */
    static GET_RO_PRIVATE_PROPERTIES => 67108989
     ...
     * Native name: CLUSCTL_NODE_GET_PRIVATE_PROPERTIES
     * @type {Integer (Int32)}
     */
    static GET_PRIVATE_PROPERTIES => 67108993
     ...
     * Native name: CLUSCTL_NODE_SET_PRIVATE_PROPERTIES
     * @type {Integer (Int32)}
     */
    static SET_PRIVATE_PROPERTIES => 71303302
     ...
     * Native name: CLUSCTL_NODE_VALIDATE_PRIVATE_PROPERTIES
     * @type {Integer (Int32)}
     */
    static VALIDATE_PRIVATE_PROPERTIES => 67109001
     ...
     * Native name: CLUSCTL_NODE_GET_COMMON_PROPERTY_FMTS
     * @type {Integer (Int32)}
     */
    static GET_COMMON_PROPERTY_FMTS => 67108965
     ...
     * Native name: CLUSCTL_NODE_GET_PRIVATE_PROPERTY_FMTS
     * @type {Integer (Int32)}
     */
    static GET_PRIVATE_PROPERTY_FMTS => 67109005
     ...
     * Native name: CLUSCTL_NODE_GET_CLUSTER_SERVICE_ACCOUNT_NAME
     * @type {Integer (Int32)}
     */
    static GET_CLUSTER_SERVICE_ACCOUNT_NAME => 67108929

    /**
     * Native name: CLUSCTL_NODE_GET_STUCK_NODES
     * @type {Integer (Int32)}
     */
    static GET_STUCK_NODES => 67109565
     ...
     * Native name: CLUSCTL_NODE_INJECT_GEM_FAULT
     * @type {Integer (Int32)}
     */
    static INJECT_GEM_FAULT => 67109569
     ...
     * 
     * <b>Windows Server 2008 R2 and Windows Server 2012:  </b>This control code is not supported before Windows Server 2012 R2.
     * Native name: CLUSCTL_NODE_INTRODUCE_GEM_REPAIR_DELAY
     * @type {Integer (Int32)}
     */
    static INTRODUCE_GEM_REPAIR_DELAY => 67109573
     ...
     * 
     * <b>Windows Server 2008 R2 and Windows Server 2012:  </b>This control code is not supported before Windows Server 2012 R2.
     * Native name: CLUSCTL_NODE_SEND_DUMMY_GEM_MESSAGES
     * @type {Integer (Int32)}
     */
    static SEND_DUMMY_GEM_MESSAGES => 67109577
     ...
     * 
     * <b>Windows Server 2008 R2 and Windows Server 2012:  </b>This control code is not supported before Windows Server 2012 R2.
     * Native name: CLUSCTL_NODE_BLOCK_GEM_SEND_RECV
     * @type {Integer (Int32)}
     */
    static BLOCK_GEM_SEND_RECV => 67109581
     ...
     * 
     * <b>Windows Server 2008 R2 and Windows Server 2012:  </b>This control code is not supported before Windows Server 2012 R2.
     * Native name: CLUSCTL_NODE_GET_GEMID_VECTOR
     * @type {Integer (Int32)}
     */
    static GET_GEMID_VECTOR => 67109585
}
