 ...
 * @version v4.0.30319
 */
class PCLUSAPI_ADD_CLUSTER_GROUP_GROUPSET_DEPENDENCY extends IUnknown {
     ...
     */
    Invoke(hDependentGroupSet, hProviderGroupSet) {
        ...
        result := ComCall(3, this, "ptr", hDependentGroupSet, "ptr", hProviderGroupSet, "uint")
        return result
    }
}
