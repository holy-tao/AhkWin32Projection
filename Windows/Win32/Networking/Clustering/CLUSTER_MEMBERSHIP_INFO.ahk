...
/**
 * The CLUSTER_MEMBERSHIP_INFO (clusapi.h) structure represents the membership information for a cluster.
 * @see https://learn.microsoft.com/windows/win32/api//content/clusapi/ns-clusapi-cluster_membership_info
