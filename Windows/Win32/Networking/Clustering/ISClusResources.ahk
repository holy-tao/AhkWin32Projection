...
class ISClusResources extends IDispatch{
     ...
     * @returns {HRESULT} 
     */
    CreateItem(bstrResourceName, bstrResourceType, bstrGroupName, dwFlags, ppClusterResource) {
        ...
        result := ComCall(11, this, "ptr", bstrResourceName, "ptr", bstrResourceType, "ptr", bstrGroupName, "int", dwFlags, "ptr*", ppClusterResource, "HRESULT")
        return result
    }
