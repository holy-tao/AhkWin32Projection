 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_RESOURCE_DEPENDENCY_BY_NAME_EX extends IUnknown {
     ...
     */
    Invoke(hCluster_, hSelf, lpszResourceType, bRecurse, dwDesiredAccess) {
        ...
        result := ComCall(3, this, "ptr", hCluster_, "ptr", hSelf, "ptr", lpszResourceType, "int", bRecurse, "uint", dwDesiredAccess, "ptr")
