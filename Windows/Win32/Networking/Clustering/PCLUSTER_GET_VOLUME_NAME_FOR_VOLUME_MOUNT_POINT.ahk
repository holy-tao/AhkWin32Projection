 ...
 * @version v4.0.30319
 */
class PCLUSTER_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT extends IUnknown {
     ...
     */
    Invoke(lpszVolumeMountPoint, lpszVolumeName, cchBufferLength) {
        ...
        result := ComCall(3, this, "ptr", lpszVolumeMountPoint, "ptr", lpszVolumeName, "uint", cchBufferLength, "int")
        return result
    }
}
