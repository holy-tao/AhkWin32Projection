 ...
 * @version v4.0.30319
 */
class PCLUSAPI_CREATE_CLUSTER_RESOURCE extends IUnknown {
     ...
     */
    Invoke(hGroup_, lpszResourceName, lpszResourceType, dwFlags) {
        ...
        result := ComCall(3, this, "ptr", hGroup_, "ptr", lpszResourceName, "ptr", lpszResourceType, "uint", dwFlags, "ptr")
