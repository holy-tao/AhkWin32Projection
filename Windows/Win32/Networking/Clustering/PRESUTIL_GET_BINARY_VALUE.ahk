 ...
 * @version v4.0.30319
 */
class PRESUTIL_GET_BINARY_VALUE extends IUnknown {
     ...
     */
    Invoke(hkeyClusterKey, pszValueName, ppbOutValue, pcbOutValueSize) {
        ...
        result := ComCall(3, this, "ptr", hkeyClusterKey, "ptr", pszValueName, ppbOutValueMarshal, ppbOutValue, pcbOutValueSizeMarshal, pcbOutValueSize, "uint")
        return result
    }
}
