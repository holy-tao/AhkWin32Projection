 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nn-deliveryoptimization-idodownload
...
class IDODownload extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-start
     */
    Start(ranges) {
        result := ComCall(3, this, "ptr", ranges, "int")
        if(result != 0) {
     ...
     * Pauses the download.
     * @returns {HRESULT} If the function succeeds, it returns **S_OK**. Otherwise, it returns an [**HRESULT**](/windows/win32/com/structure-of-com-error-codes) [error code](/windows/win32/com/com-error-codes-10).
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-pause
     */
    Pause() {
     ...
     * Aborts the download.
     * @returns {HRESULT} If the function succeeds, it returns **S_OK**. Otherwise, it returns an [**HRESULT**](/windows/win32/com/structure-of-com-error-codes) [error code](/windows/win32/com/com-error-codes-10).
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-abort
     */
    Abort() {
     ...
     * @returns {HRESULT} If the function succeeds, it returns **S_OK**. Otherwise, it returns an [**HRESULT**](/windows/win32/com/structure-of-com-error-codes) [error code](/windows/win32/com/com-error-codes-10).
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-finalize
     */
    Finalize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-getstatus
     */
    GetStatus() {
        status_ := DO_DOWNLOAD_STATUS()
        result := ComCall(7, this, "ptr", status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-getproperty
     */
    GetProperty(propId) {
        propVal := VARIANT()
        result := ComCall(8, this, "int", propId, "ptr", propVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownload-setproperty
     */
    SetProperty(propId, propVal) {
        result := ComCall(9, this, "int", propId, "ptr", propVal, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
