 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nn-deliveryoptimization-idodownloadstatuscallback
...
class IDODownloadStatusCallback extends IUnknown{
     ...
     * @param {Pointer<DO_DOWNLOAD_STATUS>} status_ A pointer to a **DO_DOWNLOAD_STATUS** structure containing the download's status.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idodownloadstatuscallback-onstatuschange
     */
    OnStatusChange(download, status_) {
        result := ComCall(3, this, "ptr", download, "ptr", status_, "int")
        if(result != 0) {
