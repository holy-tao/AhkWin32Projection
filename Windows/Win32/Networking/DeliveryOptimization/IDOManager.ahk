 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nn-deliveryoptimization-idomanager
...
class IDOManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idomanager-createdownload
     */
    CreateDownload() {
        result := ComCall(3, this, "ptr*", &download := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deliveryoptimization/nf-deliveryoptimization-idomanager-enumdownloads
     */
    EnumDownloads(category) {
        result := ComCall(4, this, "ptr", category, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
