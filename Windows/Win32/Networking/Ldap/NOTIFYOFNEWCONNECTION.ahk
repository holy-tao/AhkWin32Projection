 ...
 * @version v4.0.30319
 */
class NOTIFYOFNEWCONNECTION extends IUnknown {
     ...
     */
    Invoke(PrimaryConnection, ReferralFromConnection, NewDN, HostName, NewConnection, PortNumber, SecAuthIdentity, CurrentUser, ErrorCodeFromBind) {
        ...
        result := ComCall(3, this, "ptr", PrimaryConnection, "ptr", ReferralFromConnection, "ptr", NewDN, "ptr", HostName, "ptr", NewConnection, "uint", PortNumber, SecAuthIdentityMarshal, SecAuthIdentity, CurrentUserMarshal, CurrentUser, "uint", ErrorCodeFromBind, "char")
        return result
    }
}
