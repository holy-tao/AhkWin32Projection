 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winldap/ns-winldap-ldapapiinfow
 * @namespace Windows.Win32.Networking.Ldap
 * @version v4.0.30319
 * @charset Unicode
 */
class LDAPAPIInfoW extends Win32Struct
{
    static sizeof => 40
    ...
    ldapai_vendor_name{
        get {
            if(!this.HasProp("__ldapai_vendor_name"))
                this.__ldapai_vendor_name := PWSTR(this.ptr + 24)
