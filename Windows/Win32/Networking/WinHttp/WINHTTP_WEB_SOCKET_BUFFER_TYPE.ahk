...
class WINHTTP_WEB_SOCKET_BUFFER_TYPE extends Win32Enum {
     ...
     * Native name: WINHTTP_WEB_SOCKET_BINARY_MESSAGE_BUFFER_TYPE
     * @type {Integer (Int32)}
     */
    static BINARY_MESSAGE_BUFFER_TYPE => 0

    /**
     * Buffer contains only part of a binary message.
     * Native name: WINHTTP_WEB_SOCKET_BINARY_FRAGMENT_BUFFER_TYPE
     * @type {Integer (Int32)}
     */
    static BINARY_FRAGMENT_BUFFER_TYPE => 1

    /**
     * Buffer contains either the entire UTF-8 message or the last part of it.
     * Native name: WINHTTP_WEB_SOCKET_UTF8_MESSAGE_BUFFER_TYPE
     * @type {Integer (Int32)}
     */
    static UTF8_MESSAGE_BUFFER_TYPE => 2

    /**
     * Buffer contains only part of a UTF-8 message.
     * Native name: WINHTTP_WEB_SOCKET_UTF8_FRAGMENT_BUFFER_TYPE
     * @type {Integer (Int32)}
     */
    static UTF8_FRAGMENT_BUFFER_TYPE => 3

    /**
     * The server sent a close frame.
     * Native name: WINHTTP_WEB_SOCKET_CLOSE_BUFFER_TYPE
     * @type {Integer (Int32)}
     */
    static CLOSE_BUFFER_TYPE => 4
}
