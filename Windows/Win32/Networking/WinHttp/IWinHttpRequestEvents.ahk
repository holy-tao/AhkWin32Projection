 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequestevents-interface
...
class IWinHttpRequestEvents extends IUnknown{
     ...
     * > [!Note]  
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @param {Integer} Status_ Receives the standard status code returned with the response data. Status codes are defined in [RFC 2616](https://www.ietf.org/rfc/rfc2616.txt).
     * @param {BSTR} ContentType Specifies the type of content received, such as "text/html" or "image/gif".
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequestevents-onresponsestart
     */
    OnResponseStart(Status_, ContentType) {
        if(ContentType is String) {
            pin := BSTR.Alloc(ContentType)
            ContentType := pin.Value
        }

        ComCall(3, this, "int", Status_, "ptr", ContentType)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequestevents-onresponsedataavailable
     */
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequestevents-onresponsefinished
     */
    OnResponseFinished() {
        ComCall(5, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequestevents-onerror
     */
    OnError(ErrorNumber, ErrorDescription) {
        if(ErrorDescription is String) {
            pin := BSTR.Alloc(ErrorDescription)
            ErrorDescription := pin.Value
        }
