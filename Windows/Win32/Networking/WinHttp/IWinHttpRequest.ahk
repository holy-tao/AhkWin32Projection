 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-interface
...
class IWinHttpRequest extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-setproxy
     */
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-setcredentials
     */
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-open
     */
    Open(Method, Url, Async) {
        if(Method is String) {
            pin := BSTR.Alloc(Method)
            Method := pin.Value
        }
        if(Url is String) {
            pin := BSTR.Alloc(Url)
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-setrequestheader
     */
    SetRequestHeader(Header, Value) {
        if(Header is String) {
            pin := BSTR.Alloc(Header)
            Header := pin.Value
        }
        if(Value is String) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-getresponseheader
     */
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @returns {BSTR} Receives the resulting header information.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-getallresponseheaders
     */
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-send
     */
    Send(Body) {
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHttp start page.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-status
     */
    get_Status() {
        result := ComCall(14, this, "int*", &Status_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-statustext
     */
    get_StatusText() {
        Status_ := BSTR()
        result := ComCall(15, this, "ptr", Status_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-responsetext
     */
    get_ResponseText() {
        Body := BSTR()
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-responsebody
     */
    get_ResponseBody() {
        Body := VARIANT()
     ...
     * > For Windows XP and Windows 2000, see the [Run-Time Requirements](winhttp-start-page.md) section of the WinHTTP Start Page.
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-responsestream
     */
    get_ResponseStream() {
        Body := VARIANT()
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-option
     */
    get_Option(Option) {
        Value := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-waitforresponse
     */
    WaitForResponse(Timeout) {
        result := ComCall(21, this, "ptr", Timeout, "short*", &Succeeded := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-abort
     */
    Abort() {
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-settimeouts
     */
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-setclientcertificate
     */
    SetClientCertificate(ClientCertificate) {
        if(ClientCertificate is String) {
            pin := BSTR.Alloc(ClientCertificate)
            ClientCertificate := pin.Value
        }
     ...
     * @returns {HRESULT} The return value is **S\_OK** on success or an error value otherwise.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/WinHttp/iwinhttprequest-setautologonpolicy
     */
