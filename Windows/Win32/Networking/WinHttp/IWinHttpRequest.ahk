...
export default struct IWinHttpRequest extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_Option := CallbackCreate(ObjBindMethod(implObj, "get_Option"), flags, 3)
        this.vtbl.put_Option := CallbackCreate(ObjBindMethod(implObj, "put_Option"), flags, 3)
        ...
        this.vtbl.SetClientCertificate := CallbackCreate(ObjBindMethod(implObj, "SetClientCertificate"), flags, 2)
        this.vtbl.SetAutoLogonPolicy := CallbackCreate(ObjBindMethod(implObj, "SetAutoLogonPolicy"), flags, 2)
    }
