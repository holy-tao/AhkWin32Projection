 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_reset_channel_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_RESET_CHANNEL_CALLBACK extends IUnknown {
     ...
     */
    Invoke(channelInstance, error) {
        channelInstanceMarshal := channelInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, channelInstanceMarshal, channelInstance, "ptr", error, "int")
        if(result != 0) {
