...
class WS_XML_WRITER_ENCODING_TYPE extends Win32Enum {
    ...
    /**
     * Native name: WS_XML_WRITER_ENCODING_TYPE_TEXT
     * @type {Integer (Int32)}
     */
    static TEXT => 1

    /**
     * Native name: WS_XML_WRITER_ENCODING_TYPE_BINARY
     * @type {Integer (Int32)}
     */
    static BINARY => 2

    /**
     * Native name: WS_XML_WRITER_ENCODING_TYPE_MTOM
     * @type {Integer (Int32)}
     */
    static MTOM => 3

    /**
     * Native name: WS_XML_WRITER_ENCODING_TYPE_RAW
     * @type {Integer (Int32)}
     */
    static RAW => 4
}
