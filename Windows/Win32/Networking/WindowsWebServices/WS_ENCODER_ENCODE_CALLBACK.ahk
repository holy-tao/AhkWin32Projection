 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_encoder_encode_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_ENCODER_ENCODE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(encoderContext, buffers, count, asyncContext, error) {
        encoderContextMarshal := encoderContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, encoderContextMarshal, encoderContext, "ptr", buffers, "uint", count, "ptr", asyncContext, "ptr", error, "int")
        if(result != 0) {
