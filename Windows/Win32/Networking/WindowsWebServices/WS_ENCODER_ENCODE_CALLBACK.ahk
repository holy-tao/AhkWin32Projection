 ...
 * @see https://learn.microsoft.com/windows/win32/api/webservices/nc-webservices-ws_encoder_encode_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_ENCODER_ENCODE_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WS_ENCODER_ENCODE_CALLBACK) {
    ...
    /**
     * A WS_ENCODER_ENCODE_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WS_ENCODER_ENCODE_CALLBACK {
        /**
         * Creates a WS_ENCODER_ENCODE_CALLBACK pointer that invokes the given AHK function when called.
