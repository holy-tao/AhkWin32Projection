 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_abandon_message_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_ABANDON_MESSAGE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(channelInstance, message, error) {
        channelInstanceMarshal := channelInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, channelInstanceMarshal, channelInstance, "ptr", message, "ptr", error, "int")
        if(result != 0) {
