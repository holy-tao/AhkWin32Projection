 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_operation_free_state_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_OPERATION_FREE_STATE_CALLBACK extends IUnknown {
    ...
    Invoke(state) {
        ...
        ComCall(3, this, stateMarshal, state)
    }
}
