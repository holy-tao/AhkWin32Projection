 ...
 * @remarks
 * See <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wssetlistenerproperty">WsSetListenerProperty</a> for information about the contract
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api/webservices/nc-webservices-ws_set_listener_property_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_SET_LISTENER_PROPERTY_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WS_SET_LISTENER_PROPERTY_CALLBACK) {
    ...
    /**
     * A WS_SET_LISTENER_PROPERTY_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WS_SET_LISTENER_PROPERTY_CALLBACK {
        /**
         * Creates a WS_SET_LISTENER_PROPERTY_CALLBACK pointer that invokes the given AHK function when called.
