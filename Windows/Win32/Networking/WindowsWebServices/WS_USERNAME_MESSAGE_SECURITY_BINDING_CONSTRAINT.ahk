 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/ns-webservices-ws_username_message_security_binding_constraint
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_USERNAME_MESSAGE_SECURITY_BINDING_CONSTRAINT extends Win32Struct
{
    static sizeof => 32
