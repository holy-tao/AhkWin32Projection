 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api/webservices/nc-webservices-ws_reset_listener_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_RESET_LISTENER_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WS_RESET_LISTENER_CALLBACK) {
    ...
    /**
     * A WS_RESET_LISTENER_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WS_RESET_LISTENER_CALLBACK {
        /**
         * Creates a WS_RESET_LISTENER_CALLBACK pointer that invokes the given AHK function when called.
