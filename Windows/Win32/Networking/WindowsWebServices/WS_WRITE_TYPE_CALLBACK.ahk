 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_write_type_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_WRITE_TYPE_CALLBACK extends IUnknown {
     ...
     * @param {Pointer<WS_XML_WRITER>} writer 
     ...
     */
    Invoke(writer, typeMapping, descriptionData, value, valueSize, error) {
        descriptionDataMarshal := descriptionData is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", writer, "int", typeMapping, descriptionDataMarshal, descriptionData, "ptr", value, "uint", valueSize, "ptr", error, "int")
        if(result != 0) {
