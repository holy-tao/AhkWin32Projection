...
class WS_XML_CANONICALIZATION_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: WS_XML_CANONICALIZATION_PROPERTY_ALGORITHM
     * @type {Integer (Int32)}
     */
    static ALGORITHM => 0
     ...
     * Native name: WS_XML_CANONICALIZATION_PROPERTY_INCLUSIVE_PREFIXES
     * @type {Integer (Int32)}
     */
    static INCLUSIVE_PREFIXES => 1
     ...
     *           output.
     * Native name: WS_XML_CANONICALIZATION_PROPERTY_OMITTED_ELEMENT
     * @type {Integer (Int32)}
     */
    static OMITTED_ELEMENT => 2
     ...
     * Native name: WS_XML_CANONICALIZATION_PROPERTY_OUTPUT_BUFFER_SIZE
     * @type {Integer (Int32)}
     */
    static OUTPUT_BUFFER_SIZE => 3
}
