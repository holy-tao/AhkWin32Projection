...
class WS_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE extends Win32Enum {
     ...
     * Native name: WS_STRING_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE
     * @type {Integer (Int32)}
     */
    static STRING_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE => 1
     ...
     * Native name: WS_DEFAULT_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE
     * @type {Integer (Int32)}
     */
    static DEFAULT_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE => 2
     ...
     * Native name: WS_OPAQUE_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE
     * @type {Integer (Int32)}
     */
    static OPAQUE_WINDOWS_INTEGRATED_AUTH_CREDENTIAL_TYPE => 3
}
