 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_accept_channel_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_ACCEPT_CHANNEL_CALLBACK extends IUnknown {
     ...
     */
    Invoke(listenerInstance, channelInstance, asyncContext, error) {
        listenerInstanceMarshal := listenerInstance is VarRef ? "ptr" : "ptr"
        channelInstanceMarshal := channelInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, listenerInstanceMarshal, listenerInstance, channelInstanceMarshal, channelInstance, "ptr", asyncContext, "ptr", error, "int")
        if(result != 0) {
