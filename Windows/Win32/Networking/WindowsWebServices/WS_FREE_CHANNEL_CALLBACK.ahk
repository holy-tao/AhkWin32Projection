 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_free_channel_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_FREE_CHANNEL_CALLBACK extends IUnknown {
     ...
     */
    Invoke(channelInstance) {
        channelInstanceMarshal := channelInstance is VarRef ? "ptr" : "ptr"

        ComCall(3, this, channelInstanceMarshal, channelInstance)
    }
}
