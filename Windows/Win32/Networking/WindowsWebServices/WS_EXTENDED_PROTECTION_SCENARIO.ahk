...
class WS_EXTENDED_PROTECTION_SCENARIO extends Win32Enum {
     ...
     * Native name: WS_EXTENDED_PROTECTION_SCENARIO_BOUND_SERVER
     * @type {Integer (Int32)}
     */
    static BOUND_SERVER => 1
     ...
     * Native name: WS_EXTENDED_PROTECTION_SCENARIO_TERMINATED_SSL
     * @type {Integer (Int32)}
     */
    static TERMINATED_SSL => 2
}
