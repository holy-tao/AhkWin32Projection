 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_open_listener_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_OPEN_LISTENER_CALLBACK extends IUnknown {
     ...
     */
    Invoke(listenerInstance, url, asyncContext, error) {
        listenerInstanceMarshal := listenerInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, listenerInstanceMarshal, listenerInstance, "ptr", url, "ptr", asyncContext, "ptr", error, "int")
        if(result != 0) {
