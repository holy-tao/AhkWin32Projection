 ...
 * @see https://learn.microsoft.com/windows/win32/api/webservices/ns-webservices-ws_saml_message_security_binding
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_SAML_MESSAGE_SECURITY_BINDING {
    #StructPack 8
     ...
     * required.
     */
    authenticator : WS_SAML_AUTHENTICATOR.Ptr
