...
class WS_BINDING_TEMPLATE_TYPE extends Win32Enum {
     ...
     * Native name: WS_HTTP_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_BINDING_TEMPLATE_TYPE => 0
     ...
     * Native name: WS_HTTP_SSL_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_BINDING_TEMPLATE_TYPE => 1
     ...
     * Native name: WS_HTTP_HEADER_AUTH_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_HEADER_AUTH_BINDING_TEMPLATE_TYPE => 2
     ...
     * Native name: WS_HTTP_SSL_HEADER_AUTH_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_HEADER_AUTH_BINDING_TEMPLATE_TYPE => 3
     ...
     * Native name: WS_HTTP_SSL_USERNAME_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_USERNAME_BINDING_TEMPLATE_TYPE => 4
     ...
     * Native name: WS_HTTP_SSL_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE => 5

    /**
     * The policy specifies TCP channel binding.
     * Native name: WS_TCP_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_BINDING_TEMPLATE_TYPE => 6
     ...
     * Native name: WS_TCP_SSPI_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_SSPI_BINDING_TEMPLATE_TYPE => 7
     ...
     * Native name: WS_TCP_SSPI_USERNAME_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_SSPI_USERNAME_BINDING_TEMPLATE_TYPE => 8
     ...
     * Native name: WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE_TYPE => 9
     ...
     *           <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_username_message_security_binding">WS_USERNAME_MESSAGE_SECURITY_BINDING</a>.
     * Native name: WS_HTTP_SSL_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE => 10
     ...
     *           with HTTP channel binding, <b>WS_SSL_TRANSPORT_SECURITY_BINDING</b> and
     *           <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_kerberos_apreq_message_security_binding">WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING</a>.
     * Native name: WS_HTTP_SSL_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static HTTP_SSL_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE => 11
     ...
     *           <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_username_message_security_binding">WS_USERNAME_MESSAGE_SECURITY_BINDING</a>.
     * Native name: WS_TCP_SSPI_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_SSPI_USERNAME_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE => 12
     ...
     *           with TCP channel binding, <b>WS_SSL_TRANSPORT_SECURITY_BINDING</b> and
     *           <a href="https://docs.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_kerberos_apreq_message_security_binding">WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING</a>.
     * Native name: WS_TCP_SSPI_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE
     * @type {Integer (Int32)}
     */
    static TCP_SSPI_KERBEROS_APREQ_SECURITY_CONTEXT_BINDING_TEMPLATE_TYPE => 13
}
