 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_proxy_message_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_PROXY_MESSAGE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(message, heap, state, error) {
        stateMarshal := state is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", message, "ptr", heap, stateMarshal, state, "ptr", error, "int")
        if(result != 0) {
