...
class WS_OPERATION_CONTEXT_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_CHANNEL
     * @type {Integer (Int32)}
     */
    static CHANNEL => 0
     ...
     *                     to the <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nc-webservices-ws_service_message_receive_callback">WS_SERVICE_MESSAGE_RECEIVE_CALLBACK</a>, <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nc-webservices-ws_service_accept_channel_callback">WS_SERVICE_ACCEPT_CHANNEL_CALLBACK</a> and 
     *                     <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nc-webservices-ws_service_close_channel_callback">WS_SERVICE_CLOSE_CHANNEL_CALLBACK</a>.
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_CONTRACT_DESCRIPTION
     * @type {Integer (Int32)}
     */
    static CONTRACT_DESCRIPTION => 1
     ...
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_HOST_USER_STATE
     * @type {Integer (Int32)}
     */
    static HOST_USER_STATE => 2
     ...
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_CHANNEL_USER_STATE
     * @type {Integer (Int32)}
     */
    static CHANNEL_USER_STATE => 3
     ...
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_INPUT_MESSAGE
     * @type {Integer (Int32)}
     */
    static INPUT_MESSAGE => 4

    /**
     * The value is a pointer to the underlying output message. This property is available only to service operations.
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_OUTPUT_MESSAGE
     * @type {Integer (Int32)}
     */
    static OUTPUT_MESSAGE => 5
     ...
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_HEAP
     * @type {Integer (Int32)}
     */
    static HEAP => 6

    /**
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_LISTENER
     * @type {Integer (Int32)}
     */
    static LISTENER => 7

    /**
     * Native name: WS_OPERATION_CONTEXT_PROPERTY_ENDPOINT_ADDRESS
     * @type {Integer (Int32)}
     */
    static ENDPOINT_ADDRESS => 8
}
