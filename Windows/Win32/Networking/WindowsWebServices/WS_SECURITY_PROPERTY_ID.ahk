...
class WS_SECURITY_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: WS_SECURITY_PROPERTY_TRANSPORT_PROTECTION_LEVEL
     * @type {Integer (Int32)}
     */
    static TRANSPORT_PROTECTION_LEVEL => 1
     ...
     * Native name: WS_SECURITY_PROPERTY_ALGORITHM_SUITE
     * @type {Integer (Int32)}
     */
    static ALGORITHM_SUITE => 2
     ...
     *           <b>WS_SECURITY_ALGORITHM_SUITE_NAME_BASIC256</b> otherwise.
     * Native name: WS_SECURITY_PROPERTY_ALGORITHM_SUITE_NAME
     * @type {Integer (Int32)}
     */
    static ALGORITHM_SUITE_NAME => 3
     ...
     * Native name: WS_SECURITY_PROPERTY_MAX_ALLOWED_LATENCY
     * @type {Integer (Int32)}
     */
    static MAX_ALLOWED_LATENCY => 4
     ...
     * Native name: WS_SECURITY_PROPERTY_TIMESTAMP_VALIDITY_DURATION
     * @type {Integer (Int32)}
     */
    static TIMESTAMP_VALIDITY_DURATION => 5
     ...
     * Native name: WS_SECURITY_PROPERTY_MAX_ALLOWED_CLOCK_SKEW
     * @type {Integer (Int32)}
     */
    static MAX_ALLOWED_CLOCK_SKEW => 6
     ...
     * Native name: WS_SECURITY_PROPERTY_TIMESTAMP_USAGE
     * @type {Integer (Int32)}
     */
    static TIMESTAMP_USAGE => 7
     ...
     * Native name: WS_SECURITY_PROPERTY_SECURITY_HEADER_LAYOUT
     * @type {Integer (Int32)}
     */
    static SECURITY_HEADER_LAYOUT => 8
     ...
     * Native name: WS_SECURITY_PROPERTY_SECURITY_HEADER_VERSION
     * @type {Integer (Int32)}
     */
    static SECURITY_HEADER_VERSION => 9
     ...
     * Native name: WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_POLICY
     * @type {Integer (Int32)}
     */
    static EXTENDED_PROTECTION_POLICY => 10
     ...
     * Supported by default on Windows 7 and above. May require an update on systems running earlier versions of Windows. If the operating system was not updated,
     *                   this property is still available but has no effect.
     * Native name: WS_SECURITY_PROPERTY_EXTENDED_PROTECTION_SCENARIO
     * @type {Integer (Int32)}
     */
    static EXTENDED_PROTECTION_SCENARIO => 11
     ...
     *                   this property is still available but has no effect.
     * Native name: WS_SECURITY_PROPERTY_SERVICE_IDENTITIES
     * @type {Integer (Int32)}
     */
    static SERVICE_IDENTITIES => 12
}
