...
class WS_SECURITY_TOKEN_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_KEY_TYPE
     * @type {Integer (Int32)}
     */
    static KEY_TYPE => 1
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_VALID_FROM_TIME
     * @type {Integer (Int32)}
     */
    static VALID_FROM_TIME => 2
     ...
     * <b>WS_DATETIME</b> with a tick count of 0 is returned.
     * Native name: WS_SECURITY_TOKEN_PROPERTY_VALID_TILL_TIME
     * @type {Integer (Int32)}
     */
    static VALID_TILL_TIME => 3
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_SERIALIZED_XML
     * @type {Integer (Int32)}
     */
    static SERIALIZED_XML => 4
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_ATTACHED_REFERENCE_XML
     * @type {Integer (Int32)}
     */
    static ATTACHED_REFERENCE_XML => 5
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_UNATTACHED_REFERENCE_XML
     * @type {Integer (Int32)}
     */
    static UNATTACHED_REFERENCE_XML => 6
     ...
     * Native name: WS_SECURITY_TOKEN_PROPERTY_SYMMETRIC_KEY
     * @type {Integer (Int32)}
     */
    static SYMMETRIC_KEY => 7
}
