 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_http_redirect_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_HTTP_REDIRECT_CALLBACK extends IUnknown {
     ...
     * @param {Pointer<WS_STRING>} originalUrl 
     * @param {Pointer<WS_STRING>} newUrl 
     ...
     */
    Invoke(state, originalUrl, newUrl) {
        stateMarshal := state is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, stateMarshal, state, "ptr", originalUrl, "ptr", newUrl, "int")
        if(result != 0) {
