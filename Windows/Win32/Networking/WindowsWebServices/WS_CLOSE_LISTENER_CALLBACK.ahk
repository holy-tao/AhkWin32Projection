 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_close_listener_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_CLOSE_LISTENER_CALLBACK extends IUnknown {
     ...
     */
    Invoke(listenerInstance, asyncContext, error) {
        listenerInstanceMarshal := listenerInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, listenerInstanceMarshal, listenerInstance, "ptr", asyncContext, "ptr", error, "int")
        if(result != 0) {
