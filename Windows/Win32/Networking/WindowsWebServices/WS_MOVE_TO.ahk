...
class WS_MOVE_TO extends Win32Enum {
     ...
     * Native name: WS_MOVE_TO_ROOT_ELEMENT
     * @type {Integer (Int32)}
     */
    static ROOT_ELEMENT => 0
     ...
     * Native name: WS_MOVE_TO_NEXT_ELEMENT
     * @type {Integer (Int32)}
     */
    static NEXT_ELEMENT => 1
     ...
     *           is found, then the position is left unchanged.
     * Native name: WS_MOVE_TO_PREVIOUS_ELEMENT
     * @type {Integer (Int32)}
     */
    static PREVIOUS_ELEMENT => 2
     ...
     * Native name: WS_MOVE_TO_CHILD_ELEMENT
     * @type {Integer (Int32)}
     */
    static CHILD_ELEMENT => 3

    /**
     * If the current node is an element, then moves to its corresponding end element.  Otherwise, the position is left
     *           unchanged.
     * Native name: WS_MOVE_TO_END_ELEMENT
     * @type {Integer (Int32)}
     */
    static END_ELEMENT => 4
     ...
     *           is left unchanged.
     * Native name: WS_MOVE_TO_PREVIOUS_NODE
     * @type {Integer (Int32)}
     */
    static PREVIOUS_NODE => 7

    /**
     * Moves to the first child of the parent of the current node.
     * Native name: WS_MOVE_TO_FIRST_NODE
     * @type {Integer (Int32)}
     */
    static FIRST_NODE => 8
     ...
     * Native name: WS_MOVE_TO_CHILD_NODE
     * @type {Integer (Int32)}
     */
    static CHILD_NODE => 11
}
