 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/ns-webservices-ws_tcp_sspi_kerberos_apreq_binding_template
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE extends Win32Struct
{
    static sizeof => 80
