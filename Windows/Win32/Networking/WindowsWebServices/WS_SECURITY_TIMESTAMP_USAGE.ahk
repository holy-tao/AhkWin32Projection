...
class WS_SECURITY_TIMESTAMP_USAGE extends Win32Enum {
     ...
     * Native name: WS_SECURITY_TIMESTAMP_USAGE_ALWAYS
     * @type {Integer (Int32)}
     */
    static ALWAYS => 1
     ...
     * Native name: WS_SECURITY_TIMESTAMP_USAGE_NEVER
     * @type {Integer (Int32)}
     */
    static NEVER => 2
     ...
     * mixed-mode security.
     * Native name: WS_SECURITY_TIMESTAMP_USAGE_REQUESTS_ONLY
     * @type {Integer (Int32)}
     */
    static REQUESTS_ONLY => 3
}
