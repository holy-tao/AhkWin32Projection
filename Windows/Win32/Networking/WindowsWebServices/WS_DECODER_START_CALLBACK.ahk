 ...
 * @see https://learn.microsoft.com/windows/win32/api/webservices/nc-webservices-ws_decoder_start_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_DECODER_START_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WS_DECODER_START_CALLBACK) {
    ...
    /**
     * A WS_DECODER_START_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WS_DECODER_START_CALLBACK {
        /**
         * Creates a WS_DECODER_START_CALLBACK pointer that invokes the given AHK function when called.
