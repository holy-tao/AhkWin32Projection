 ...
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/nc-webservices-ws_abort_listener_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_ABORT_LISTENER_CALLBACK extends IUnknown {
     ...
     */
    Invoke(listenerInstance, error) {
        listenerInstanceMarshal := listenerInstance is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, listenerInstanceMarshal, listenerInstance, "ptr", error, "int")
        if(result != 0) {
