...
class WS_SECURITY_CONTEXT_PROPERTY_ID extends Win32Enum {
     ...
     * Native name: WS_SECURITY_CONTEXT_PROPERTY_IDENTIFIER
     * @type {Integer (Int32)}
     */
    static IDENTIFIER => 1
     ...
     * Native name: WS_SECURITY_CONTEXT_PROPERTY_USERNAME
     * @type {Integer (Int32)}
     */
    static USERNAME => 2
     ...
     * Native name: WS_SECURITY_CONTEXT_PROPERTY_MESSAGE_SECURITY_WINDOWS_TOKEN
     * @type {Integer (Int32)}
     */
    static MESSAGE_SECURITY_WINDOWS_TOKEN => 3
     ...
     * Native name: WS_SECURITY_CONTEXT_PROPERTY_SAML_ASSERTION
     * @type {Integer (Int32)}
     */
    static SAML_ASSERTION => 4
}
