 ...
 * @remarks
 * See <a href="https://docs.microsoft.com/windows/desktop/api/webservices/nf-webservices-wsreadmessageend">WsReadMessageEnd</a> for information about the contract
 *                 of this API.
 * @see https://learn.microsoft.com/windows/win32/api/webservices/nc-webservices-ws_read_message_end_callback
 * @namespace Windows.Win32.Networking.WindowsWebServices
 */
export default struct WS_READ_MESSAGE_END_CALLBACK {
    value : IntPtr

    __value {
        set {
            if (value is WS_READ_MESSAGE_END_CALLBACK) {
    ...
    /**
     * A WS_READ_MESSAGE_END_CALLBACK that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends WS_READ_MESSAGE_END_CALLBACK {
        /**
         * Creates a WS_READ_MESSAGE_END_CALLBACK pointer that invokes the given AHK function when called.
