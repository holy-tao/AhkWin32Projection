...
class IContentPrefetcherTaskTrigger extends IInspectable{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/icontentprefetchertasktrigger/nf-icontentprefetchertasktrigger-icontentprefetchertasktrigger-triggercontentprefetchertask
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/icontentprefetchertasktrigger/nf-icontentprefetchertasktrigger-icontentprefetchertasktrigger-isregisteredforcontentprefetch
     */
    IsRegisteredForContentPrefetch(packageFullName) {
        packageFullName := packageFullName is String ? StrPtr(packageFullName) : packageFullName

        result := ComCall(7, this, "ptr", packageFullName, "char*", &isRegistered := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
