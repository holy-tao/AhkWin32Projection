...
/**
 * Describes the policy specifying TCP channel binding with windows SSPI transport security, and kerberos message security.
 * @see https://learn.microsoft.com/windows/win32/api//content/webservices/ns-webservices-ws_tcp_sspi_kerberos_apreq_policy_description
 * @namespace Windows.Win32.Networking.WindowsWebServices
 * @version v4.0.30319
 */
class WS_TCP_SSPI_KERBEROS_APREQ_POLICY_DESCRIPTION extends Win32Struct
{
    static sizeof => 72
