...
;@region Methods
     ...
     * @param {Pointer<IntPtr>} message Pointer to a <a href="https://docs.microsoft.com/windows/desktop/wsw/ws-message">WS_MESSAGE</a> structure respresenting the  message to be addressed.
    ...
    /**
     * 
     * @param {Pointer<Int32>} pbIsUserVerifyingPlatformAuthenticatorAvailable 
     * @returns {HRESULT} 
     */
