...
class HTTP_RESPONSE_INFO_TYPE extends Win32Enum {
     ...
     * Native name: HttpResponseInfoTypeMultipleKnownHeaders
     * @type {Integer (Int32)}
     */
    static MultipleKnownHeaders => 0

    /**
     * Reserved for future use.
     * Native name: HttpResponseInfoTypeAuthenticationProperty
     * @type {Integer (Int32)}
     */
    static AuthenticationProperty => 1
     ...
     * Native name: HttpResponseInfoTypeQoSProperty
     * @type {Integer (Int32)}
     */
     ...
     * Native name: HttpResponseInfoTypeChannelBind
     * @type {Integer (Int32)}
     */
    static ChannelBind => 3
}
