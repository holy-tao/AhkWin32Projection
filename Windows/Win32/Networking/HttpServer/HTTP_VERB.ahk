...
class HTTP_VERB extends Win32Enum {
     ...
     * Native name: HttpVerbOPTIONS
     * @type {Integer (Int32)}
     */
    static VerbOPTIONS => 3
     ...
     * Native name: HttpVerbPROPFIND
     * @type {Integer (Int32)}
     */
    static VerbPROPFIND => 14
     ...
     * Native name: HttpVerbPROPPATCH
     * @type {Integer (Int32)}
     */
    static VerbPROPPATCH => 15
     ...
     * Native name: HttpVerbUNLOCK
     * @type {Integer (Int32)}
     */
    static VerbUNLOCK => 18
     ...
     * Native name: HttpVerbSEARCH
     * @type {Integer (Int32)}
     */
    static VerbSEARCH => 19

    /**
     * Terminates the enumeration; is not used to define a verb.
     * Native name: HttpVerbMaximum
     * @type {Integer (Int32)}
     */
    static Maximum => 20
}
