 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ws2spi/nc-ws2spi-lpwspclosesocket
 * @namespace Windows.Win32.Networking.WinSock
 * @version v4.0.30319
 */
class LPWSPCLOSESOCKET extends IUnknown {
    ...
    Invoke(s, lpErrno) {
        ...
        result := ComCall(3, this, "ptr", s, lpErrnoMarshal, lpErrno, "int")
        return result
    }
}
