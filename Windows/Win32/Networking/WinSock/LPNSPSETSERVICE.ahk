 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpnspsetservice
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPNSPSETSERVICE {
    value : IntPtr

    __value {
        set {
            if (value is LPNSPSETSERVICE) {
     ...
     * </tr>
     * </table>
     * @param {Integer} dwControlFlags A set of flags that controls the service operation requested. 
     * 
     ...
     * </table>
     */
    Call(lpProviderId, lpServiceClassInfo, lpqsRegInfo, essOperation, dwControlFlags) {
        result := DllCall(this.value, Guid.Ptr, lpProviderId, WSASERVICECLASSINFOW.Ptr, lpServiceClassInfo, WSAQUERYSETW.Ptr, lpqsRegInfo, WSAESETSERVICEOP, essOperation, UInt32, dwControlFlags, Int32)
        return result
    }

    /**
     * A LPNSPSETSERVICE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPNSPSETSERVICE {
        /**
         * Creates a LPNSPSETSERVICE pointer that invokes the given AHK function when called.
         * @param {Func(Guid, WSASERVICECLASSINFOW, WSAQUERYSETW, WSAESETSERVICEOP, UInt32) => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 5)) {
