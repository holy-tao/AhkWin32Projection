 ...
 */
export default struct LPWPUGETPROVIDERPATH {
    value : IntPtr

    __value {
        set {
            if (value is LPWPUGETPROVIDERPATH) {
    ...
    /**
     * A LPWPUGETPROVIDERPATH that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWPUGETPROVIDERPATH {
        /**
         * Creates a LPWPUGETPROVIDERPATH pointer that invokes the given AHK function when called.
