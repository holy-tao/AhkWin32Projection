 ...
 * @see https://learn.microsoft.com/windows/win32/api/mswsock/nc-mswsock-lpfn_disconnectex
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPFN_DISCONNECTEX {
    value : IntPtr

    __value {
        set {
            if (value is LPFN_DISCONNECTEX) {
     ...
     * @param {Integer} dwReserved Reserved. Must be zero. If nonzero, [WSAEINVAL](/windows/win32/winsock/windows-sockets-error-codes-2#wsaeinval) is returned.
     * @returns {BOOL} On success, the **DisconnectEx** function returns **TRUE**. On failure, the function returns **FALSE**. Use the [**WSAGetLastError**](../winsock/nf-winsock-wsagetlasterror.md) function to get extended error information. If a call to the **WSAGetLastError** function returns **ERROR\_IO\_PENDING**, the operation initiated successfully and is in progress. Under such circumstances, the call may still fail when the operation completes.
     * 
     * | Error code                                                                                                                                 | Description                                                                                                                                                                                                                                                                                                                         |
     * |--------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
     * | <dl> <dt>**[WSAEFAULT](/windows/win32/winsock/windows-sockets-error-codes-2#wsaefault)**</dt> </dl>    | The system detected an invalid pointer address in attempting to use a pointer argument. This error is returned if an invalid pointer value was passed in the <i>lpOverlapped</i> parameter.<br/>                                                                                                                                   |
    ...
    /**
     * A LPFN_DISCONNECTEX that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPFN_DISCONNECTEX {
        /**
         * Creates a LPFN_DISCONNECTEX pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, OVERLAPPED, UInt32, UInt32) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
