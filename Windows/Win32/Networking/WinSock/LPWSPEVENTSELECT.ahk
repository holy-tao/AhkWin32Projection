 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspeventselect
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPEVENTSELECT {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPEVENTSELECT) {
     ...
     * </tr>
     * </table>
     * @param {Pointer<Integer>} lpErrno A pointer to the error code. See the **Return value** section for more info.
     * @returns {Integer} The return value is zero if the Windows Sockets SPI client's specification of the network events and the associated event object was successful. Otherwise, the value **SOCKET_ERROR** is returned, and a specific error number is available in *lpErrno*.
     * 
     * <table>
     * <tr>
     * <th>Error Code</th>
    ...
    /**
     * A LPWSPEVENTSELECT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPEVENTSELECT {
        /**
         * Creates a LPWSPEVENTSELECT pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, WSAEVENT, Int32, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
