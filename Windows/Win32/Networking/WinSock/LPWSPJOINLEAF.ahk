 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspjoinleaf
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPJOINLEAF {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPJOINLEAF) {
     ...
     * @param {Integer} dwFlags Flags to indicate that the socket is acting as a sender, receiver, or both.
     ...
     * <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspcancelblockingcall">WSPCancelBlockingCall</a>.
     * 
     * </td>
     * </tr>
     * <tr>
    ...
    /**
     * A LPWSPJOINLEAF that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPJOINLEAF {
        /**
         * Creates a LPWSPJOINLEAF pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, IntPtr, Int32, WSABUF, WSABUF, QOS, QOS, UInt32, "int*") => SOCKET} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 9)) {
