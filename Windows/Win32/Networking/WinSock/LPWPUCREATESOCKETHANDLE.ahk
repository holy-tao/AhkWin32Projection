 ...
 * @version v4.0.30319
 */
class LPWPUCREATESOCKETHANDLE extends IUnknown {
     ...
     */
    Invoke(dwCatalogEntryId, dwContext, lpErrno) {
        lpErrnoMarshal := lpErrno is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "uint", dwCatalogEntryId, "ptr", dwContext, lpErrnoMarshal, lpErrno, "ptr")
