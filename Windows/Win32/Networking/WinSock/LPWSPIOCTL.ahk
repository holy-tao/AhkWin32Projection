 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ws2spi/nc-ws2spi-lpwspioctl
 * @namespace Windows.Win32.Networking.WinSock
 * @version v4.0.30319
 */
class LPWSPIOCTL extends IUnknown {
     ...
     */
    Invoke(s, dwIoControlCode, lpvInBuffer, cbInBuffer, lpvOutBuffer, cbOutBuffer, lpcbBytesReturned, lpOverlapped, lpCompletionRoutine, lpThreadId, lpErrno) {
        s := s is Win32Handle ? NumGet(s, "ptr") : s

        lpcbBytesReturnedMarshal := lpcbBytesReturned is VarRef ? "uint*" : "ptr"
        lpErrnoMarshal := lpErrno is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", s, "uint", dwIoControlCode, "ptr", lpvInBuffer, "uint", cbInBuffer, "ptr", lpvOutBuffer, "uint", cbOutBuffer, lpcbBytesReturnedMarshal, lpcbBytesReturned, "ptr", lpOverlapped, "ptr", lpCompletionRoutine, "ptr", lpThreadId, lpErrnoMarshal, lpErrno, "int")
        return result
    }
}
