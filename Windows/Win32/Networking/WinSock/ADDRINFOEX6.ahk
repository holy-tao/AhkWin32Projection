 ...
 * @remarks
 * The <b>ADDRINFOEX6</b> structure is an extension of the <a href="https://docs.microsoft.com/windows/win32/api/ws2def/ns-ws2def-addrinfoex5">ADDRINFOEX5</a> structure. In addition to all fields from the <a href="https://docs.microsoft.com/windows/win32/api/ws2def/ns-ws2def-addrinfoex5">ADDRINFOEX5</a> structure, it holds the *ai_numservers* and *ai_servers* members, enabling the use of custom per-query DNS servers. It also holds the *ai_responseflags* member, which contains information about the origin of the DNS responses.
 * 
 ...
 */
export default struct ADDRINFOEX6 {
    #StructPack 8
     ...
     * <td width="40%">
     * <dl>
     * <dt><b>AI_EXCLUSIVE_CUSTOM_SERVERS</b></dt>
     * <dt>0x0080</dt>
     * </dl>
     * </td>
     * <td width="60%">
     * By default, the servers specified in the <i>ai_servers</i> member are used as fallback to the system DNS servers.
     * If this option is specified, then the DNS query will use the custom servers specified in <i>ai_server</i> exclusively.
     * </td>
     * </tr>
     * 
     * </tr>
     ...
     * <td width="40%">
     * <dl>
     * <dt><b>AI_RETURN_RESPONSE_FLAGS</b></dt>
     * <dt>0x0080</dt>
     * </dl>
     * </td>
     * <td width="60%">
     * Requests extra information about the DNS results. If this flag is present, the <b>GetAddrInfoEx</b> <i>ppResult</i> parameter will return a list of <b>addrinfoex6</b> structures, where the <i>ai_responseflags</i> member will contain information about the origin of the DNS results.
     * </td>
     * </tr>
     * 
     * </table>
    ...
    /**
     * An array of N (where N == *ai_numservers*) <a href="https://docs.microsoft.com/windows/desktop/api/ws2def/ns-ws2def-addrinfo_dns_server">ADDRINFO_DNS_SERVER</a> objects. If *ai_numservers* is 0, then *ai_servers* must be <b>NULL</b>.
     */
