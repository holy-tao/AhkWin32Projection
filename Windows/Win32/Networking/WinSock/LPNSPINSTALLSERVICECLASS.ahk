 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ws2spi/nc-ws2spi-lpnspinstallserviceclass
 * @namespace Windows.Win32.Networking.WinSock
 * @version v4.0.30319
 */
class LPNSPINSTALLSERVICECLASS extends IUnknown {
     ...
     */
    Invoke(lpProviderId, lpServiceClassInfo) {
        result := ComCall(3, this, "ptr", lpProviderId, "ptr", lpServiceClassInfo, "int")
        return result
    }
}
