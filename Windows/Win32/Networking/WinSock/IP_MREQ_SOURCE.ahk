 ...
 * 
  ...
  * 
  * For less configurable multicast capabilities with IPv4, use the <a href="https://docs.microsoft.com/windows/desktop/api/ws2ipdef/ns-ws2ipdef-ip_mreq">ip_mreq</a> structure. For IPv6, use the <a href="https://docs.microsoft.com/windows/desktop/api/ws2ipdef/ns-ws2ipdef-ipv6_mreq">ipv6_mreq</a> structure.
  * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//ws2ipdef/ns-ws2ipdef-ip_mreq_source
    ...
    imr_sourceaddr{
        get {
            if(!this.HasProp("__imr_sourceaddr"))
                this.__imr_sourceaddr := IN_ADDR(this.ptr + 4)
    ...
    imr_interface{
        get {
            if(!this.HasProp("__imr_interface"))
                this.__imr_interface := IN_ADDR(this.ptr + 8)
