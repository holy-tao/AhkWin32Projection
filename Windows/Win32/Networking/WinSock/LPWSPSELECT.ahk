 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ws2spi/nc-ws2spi-lpwspselect
 * @namespace Windows.Win32.Networking.WinSock
 * @version v4.0.30319
 */
class LPWSPSELECT extends IUnknown {
     ...
     * @param {Integer} nfds 
     * @param {Pointer<FD_SET>} readfds 
     * @param {Pointer<FD_SET>} writefds 
     * @param {Pointer<FD_SET>} exceptfds 
     * @param {Pointer<TIMEVAL>} timeout 
     ...
     */
    Invoke(nfds, readfds, writefds, exceptfds, timeout, lpErrno) {
        lpErrnoMarshal := lpErrno is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "int", nfds, "ptr", readfds, "ptr", writefds, "ptr", exceptfds, "ptr", timeout, lpErrnoMarshal, lpErrno, "int")
        return result
    }
}
