 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspbind
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPBIND {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPBIND) {
    ...
    /**
     * A LPWSPBIND that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPBIND {
        /**
         * Creates a LPWSPBIND pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, IntPtr, Int32, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
