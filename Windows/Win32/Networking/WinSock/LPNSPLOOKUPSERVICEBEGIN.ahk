 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpnsplookupservicebegin
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPNSPLOOKUPSERVICEBEGIN {
    value : IntPtr

    __value {
        set {
            if (value is LPNSPLOOKUPSERVICEBEGIN) {
     ...
     * @param {Integer} dwControlFlags A value that controls the depth of the search.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/ws2spi/nc-ws2spi-lpnsplookupservicenext">NSPLookupServiceNext</a>, and each alias returned will have the **RESULT_IS_ALIAS** flag set.
     * 
     * </td>
     * </tr>
     * <tr>
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/nspapi/ns-nspapi-csaddr_info">CSADDR_INFO</a> structure. The other part must be usable in either case. This option applies only to service instance requests.
     * 
     * </td>
     * </tr>
     * <tr>
     ...
     * </table>
     */
    Call(lpProviderId, lpqsRestrictions, lpServiceClassInfo, dwControlFlags, lphLookup) {
        result := DllCall(this.value, Guid.Ptr, lpProviderId, WSAQUERYSETW.Ptr, lpqsRestrictions, WSASERVICECLASSINFOW.Ptr, lpServiceClassInfo, UInt32, dwControlFlags, HANDLE.Ptr, lphLookup, Int32)
        return result
    }

    /**
     * A LPNSPLOOKUPSERVICEBEGIN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPNSPLOOKUPSERVICEBEGIN {
        /**
         * Creates a LPNSPLOOKUPSERVICEBEGIN pointer that invokes the given AHK function when called.
         * @param {Func(Guid, WSAQUERYSETW, WSASERVICECLASSINFOW, UInt32, HANDLE) => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 5)) {
