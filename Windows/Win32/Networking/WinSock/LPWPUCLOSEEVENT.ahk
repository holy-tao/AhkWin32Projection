 ...
 */
export default struct LPWPUCLOSEEVENT {
    value : IntPtr

    __value {
        set {
            if (value is LPWPUCLOSEEVENT) {
    ...
    /**
     * A LPWPUCLOSEEVENT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWPUCLOSEEVENT {
        /**
         * Creates a LPWPUCLOSEEVENT pointer that invokes the given AHK function when called.
