 ...
 * @see https://learn.microsoft.com/windows/win32/api/mswsock/nc-mswsock-lpfn_rioreceive
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPFN_RIORECEIVE {
    value : IntPtr

    __value {
        set {
            if (value is LPFN_RIORECEIVE) {
     ...
     * @returns {BOOL} If no error occurs, the **RIOReceive** function returns **TRUE**. In this case, the receive operation is successfully initiated and the completion will have already been queued or the operation has been successfully initiated and the completion will be queued at a later time.
     * 
    ...
    /**
     * A LPFN_RIORECEIVE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPFN_RIORECEIVE {
        /**
         * Creates a LPFN_RIORECEIVE pointer that invokes the given AHK function when called.
