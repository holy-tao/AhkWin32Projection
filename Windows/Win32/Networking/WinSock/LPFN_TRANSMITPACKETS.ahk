 ...
 * @see https://learn.microsoft.com/windows/win32/api/mswsock/nc-mswsock-lpfn_transmitpackets
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPFN_TRANSMITPACKETS {
    value : IntPtr

    __value {
        set {
            if (value is LPFN_TRANSMITPACKETS) {
     ...
     * @param {Pointer<TRANSMIT_PACKETS_ELEMENT>} lpPacketArray An array of type <a href="https://docs.microsoft.com/windows/desktop/api/mswsock/ns-mswsock-transmit_packets_element">TRANSMIT_PACKETS_ELEMENT</a>, describing the data to be transmitted.
     * @param {Integer} nElementCount The number of elements in <i>lpPacketArray</i>.
     * @param {Integer} nSendSize The size, in bytes, of the data block used in the 
     ...
     * @param {Integer} dwFlags A set of flags used to customize processing of the 
    ...
    /**
     * A LPFN_TRANSMITPACKETS that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPFN_TRANSMITPACKETS {
        /**
         * Creates a LPFN_TRANSMITPACKETS pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, TRANSMIT_PACKETS_ELEMENT, UInt32, UInt32, OVERLAPPED, UInt32) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 6)) {
