 ...
 */
export default struct LPWPUOPENCURRENTTHREAD {
    value : IntPtr

    __value {
        set {
            if (value is LPWPUOPENCURRENTTHREAD) {
    ...
    /**
     * A LPWPUOPENCURRENTTHREAD that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWPUOPENCURRENTTHREAD {
        /**
         * Creates a LPWPUOPENCURRENTTHREAD pointer that invokes the given AHK function when called.
