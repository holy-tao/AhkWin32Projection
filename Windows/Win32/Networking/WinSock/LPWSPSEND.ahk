 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspsend
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPSEND {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPSEND) {
     ...
     * @returns {Integer} If no error occurs and the send operation has completed immediately, **LPWSPSend** returns zero. Note that in this case the completion routine, if specified, will have already been queued. Otherwise, a value of SOCKET_ERROR is returned, and a specific error code is available in <i>lpErrno</i>. The error code [WSA_IO_PENDING](/windows/win32/winsock/windows-sockets-error-codes-2#wsa-io-pending) indicates that the overlapped operation has been successfully initiated and that completion will be indicated at a later time. Any other error code indicates that no overlapped operation was initiated and no completion indication will occur.
     * 
     * <table>
     * <tr>
     * <th>Error Code</th>
     ...
     * </td>
     * <td width="60%">
     * Socket has been shut down; it is not possible to <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspsend">LPWSPSend</a></b> on a socket after <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspshutdown">LPWSPShutdown</a></b> has been invoked with how set to SD_SEND or SD_BOTH.
     * </td>
     * </tr>
     * 
     * <tr>
    ...
    /**
     * A LPWSPSEND that invokes the given AHK function when called.
