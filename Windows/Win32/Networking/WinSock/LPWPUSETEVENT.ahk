 ...
 */
export default struct LPWPUSETEVENT {
    value : IntPtr

    __value {
        set {
            if (value is LPWPUSETEVENT) {
    ...
    /**
     * A LPWPUSETEVENT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWPUSETEVENT {
        /**
         * Creates a LPWPUSETEVENT pointer that invokes the given AHK function when called.
