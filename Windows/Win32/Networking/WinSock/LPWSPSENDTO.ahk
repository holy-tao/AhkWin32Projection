 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspsendto
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPSENDTO {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPSENDTO) {
     ...
     * @param {Pointer<Integer>} lpNumberOfBytesSent A pointer to the number of bytes sent by this call.
     * @param {Integer} dwFlags A set of flags that specifies the way in which the call is made.
     * @param {Integer} lpTo An optional pointer to the address of the target socket in the <b><a href="https://docs.microsoft.com/windows/win32/winsock/sockaddr-2">sockaddr</a></b> structure.
     * @param {Integer} iTolen The size, in bytes, of the address pointed to by the <i>lpTo</i> parameter.
     * @param {Pointer<OVERLAPPED>} lpOverlapped A pointer to a <b><a href="https://docs.microsoft.com/windows/win32/api/winsock2/ns-winsock2-wsaoverlapped">WSAOverlapped</a></b> structure (ignored for nonoverlapped sockets).
     ...
     * @param {Pointer<WSATHREADID>} lpThreadId A pointer to a <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/ns-ws2spi-wsathreadid">WSATHREADID</a></b> structure to be used by the provider in a subsequent call to <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nf-ws2spi-wpuqueueapc">WPUQueueApc</a></b>. The provider should store the referenced **WSATHREADID** structure (not the pointer to same) until after the **WPUQueueApc** function returns.
     * @param {Pointer<Integer>} lpErrno A pointer to the error code.
     * @returns {Integer} If no error occurs and the receive operation has completed immediately, **LPWSPSendTo** returns zero. Note that in this case the completion routine, if specified, will have already been queued. Otherwise, a value of SOCKET_ERROR is returned, and a specific error code is available in <i>lpErrno</i>. The error code [WSA_IO_PENDING](/windows/win32/winsock/windows-sockets-error-codes-2#wsa-io-pending) indicates that the overlapped operation has been successfully initiated and that completion will be indicated at a later time. Any other error code indicates that no overlapped operation was initiated and no completion indication will occur.
     * 
     * <table>
     * <tr>
     * <th>Error Code</th>
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEACCES">WSAEACCES</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAESHUTDOWN">WSAESHUTDOWN</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * Socket has been shut down; it is not possible to use <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspsendto">LPWSPSendTo</a></b> on a socket after <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspshutdown">LPWSPShutdown</a></b> has been invoked with <i>how</i> set to SD_SEND or SD_BOTH.
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEWOULDBLOCK">WSAEWOULDBLOCK</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEMSGSIZE">WSAEMSGSIZE</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEINVAL">WSAEINVAL</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * Socket has not been bound with <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspbind">LPWSPBind</a></b>, or the socket is not created with the overlapped flag.
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNABORTED">WSAECONNABORTED</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNABORTED">WSAECONNRESET</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEADDRNOTAVAIL">WSAEADDRNOTAVAIL</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEAFNOSUPPORT">WSAEAFNOSUPPORT</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEDESTADDRREQ">WSAEDESTADDRREQ</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAENETUNREACH">WSAENETUNREACH</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSA_OPERATION_ABORTED">WSA_OPERATION_ABORTED</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * Overlapped operation has been canceled due to the closure of the socket, or the execution of the SIO_FLUSH command in <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a></b>.
     * </td>
     * </tr>
     * </table>
     */
    Call(s, lpBuffers, dwBufferCount, lpNumberOfBytesSent, dwFlags, lpTo, iTolen, lpOverlapped, lpCompletionRoutine, lpThreadId, lpErrno) {
        ...
        lpToMarshal := lpTo == 0 ? IntPtr : IntPtr
        ...
        result := DllCall(this.value, SOCKET, s, WSABUF.Ptr, lpBuffers, UInt32, dwBufferCount, lpNumberOfBytesSentMarshal, lpNumberOfBytesSent, UInt32, dwFlags, lpToMarshal, lpTo, Int32, iTolen, lpOverlappedMarshal, lpOverlapped, lpCompletionRoutineMarshal, lpCompletionRoutine, lpThreadIdMarshal, lpThreadId, lpErrnoMarshal, lpErrno, Int32)
        return result
    }

    /**
     * A LPWSPSENDTO that invokes the given AHK function when called.
