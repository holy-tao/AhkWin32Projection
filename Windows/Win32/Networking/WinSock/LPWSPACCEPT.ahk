 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspaccept
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPACCEPT {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPACCEPT) {
     ...
     * @param {Pointer<LPCONDITIONPROC>} lpfnCondition Procedure instance address of an optional-condition function furnished by Windows Sockets. This function is used in the accept or reject decision based on the caller information passed in as parameters.
     * @param {Pointer} dwCallbackData Callback data to be passed back to the Windows Socket 2 client as the value of the <i>dwCallbackData</i> parameter of the condition function. This parameter is not interpreted by the service provider.
     * @param {Pointer<Integer>} lpErrno Pointer to the error code.
     * @returns {SOCKET} If no error occurs, **LPWSPAccept** returns a value of type SOCKET that is a descriptor for the accepted socket. Otherwise, a value of INVALID_SOCKET is returned, and a specific error code is available in <i>lpErrno</i>.
     * 
     * <table>
     * <tr>
     * <th> Error Code </th>
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNRESET">WSAECONNRESET</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * </td>
     * <td width="60%">
     * A (blocking) call was canceled through <a href="https://docs.microsoft.com/windows/win32/api/winsock2/nf-winsock2-wsacancelblockingcall">LPWSPCancelBlockingCall</a>.
     * </td>
     * </tr>
     * 
     * <tr>
     ...
     * </td>
     * <td width="60%">
     * <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwsplisten">LPWSPListen</a> was not invoked prior to LPWSPAccept, parameter <i>g</i> specified in the condition function is not a valid value, the return value of the condition function is not a valid one, or any case where the specified socket is in an invalid state.
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEMFILE">WSAEMFILE</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSATRY_AGAIN">WSATRY_AGAIN</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
    ...
    /**
     * A LPWSPACCEPT that invokes the given AHK function when called.
