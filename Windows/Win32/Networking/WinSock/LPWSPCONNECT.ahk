 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspconnect
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPCONNECT {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPCONNECT) {
     ...
     * @param {Pointer<WSABUF>} lpCallerData Pointer to the user data that is to be transferred to the peer during connection establishment.
     * @param {Pointer<WSABUF>} lpCalleeData Pointer to a buffer into which any user data received from the peer during connection establishment can be copied.
     * @param {Pointer<QOS>} lpSQOS Pointer to the flow specifications for socket <i>s</i>, one for each direction.
     * @param {Pointer<QOS>} lpGQOS Reserved.
     * @param {Pointer<Integer>} lpErrno Pointer to the error code.
     * @returns {Integer} If no error occurs, **LPWSPConnect** returns zero. Otherwise, it returns SOCKET_ERROR, and a specific error code is available in <i>lpErrno</i>.
     * 
     * On a blocking socket, the return value indicates success or failure of the connection attempt. If the return error code indicates the connection attempt failed (that is, <a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNREFUSED">WSAECONNREFUSED</a>, <a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAENETUNREACH">WSAENETUNREACH</a>, <a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAETIMEDOUT">WSAETIMEDOUT</a>) the Winsock SPI client can call **LPWSPConnect** again for the same socket.
     * 
     * <table>
     * <tr>
     * <th> Error Code </th>
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEADDRINUSE">WSAEADDRINUSE</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEINTR">WSAEINTR</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEALREADY">WSAEALREADY</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * Nonblocking <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspconnect">LPWSPConnect</a></b> call is in progress on the specified socket. <br/> In order to preserve backward compatibility, this error is reported as WSAEINVAL to Windows Sockets 1.1 applications that link to either Winsock.dll or Wsock32.dll. 
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEADDRNOTAVAIL">WSAEADDRNOTAVAIL</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEAFNOSUPPORT">WSAEAFNOSUPPORT</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNREFUSED">WSAECONNREFUSED</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEISCONN">WSAEISCONN</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAENETUNREACH">WSAENETUNREACH</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAENOBUFS">WSAENOBUFS</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEOPNOTSUPP">WSAEOPNOTSUPP</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEPROTONOSUPPORT">WSAEPROTONOSUPPORT</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAETIMEDOUT">WSAETIMEDOUT</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEWOULDBLOCK">WSAEWOULDBLOCK</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * Socket is marked as nonblocking and the connection cannot be completed immediately. It is possible to select the socket using the <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspselect">LPWSPSelect</a></b> function while it is connecting by using the **WSPSelect** function to select it for writing.
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><b><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEACCES">WSAEACCES</a></b></dl>
     * </dl>
     * </td>
     * <td width="60%">
     * An attempt to connect datagram socket to broadcast address failed because <b><a href="https://docs.microsoft.com/previous-versions/windows/hardware/network/ff566318(v=vs.85)">WSPSetSockOpt</a></b> SO_BROADCAST is not enabled.
     * </td>
     * </tr>
     * </table>
     */
    ...
    /**
     * A LPWSPCONNECT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPCONNECT {
        /**
         * Creates a LPWSPCONNECT pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, IntPtr, Int32, WSABUF, WSABUF, QOS, QOS, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 8)) {
