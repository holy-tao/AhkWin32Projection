 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ws2spi/nc-ws2spi-lpwspasyncselect
 * @namespace Windows.Win32.Networking.WinSock
 * @version v4.0.30319
 */
class LPWSPASYNCSELECT extends IUnknown {
     ...
     */
    Invoke(s, hWnd_, wMsg, lEvent, lpErrno) {
        s := s is Win32Handle ? NumGet(s, "ptr") : s
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        lpErrnoMarshal := lpErrno is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "ptr", s, "ptr", hWnd_, "uint", wMsg, "int", lEvent, lpErrnoMarshal, lpErrno, "int")
        return result
    }
}
