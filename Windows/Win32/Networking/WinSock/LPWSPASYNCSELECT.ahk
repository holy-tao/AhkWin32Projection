 ...
 * @remarks
 * This function is used to request that the service provider send a Windows message to the client's window <i>hWnd</i> whenever the service provider detects any of the network events specified by the <i>lEvent</i> argument. The service provider should use the <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nf-ws2spi-wpupostmessage">WPUPostMessage</a> function to post the message. The message to be sent is specified by the <i>wMsg</i> parameter. The socket for which notification is required is identified by <i>s</i>.
 * 
 * This function automatically sets socket <i>s</i> to nonblocking mode, regardless of the value of <i>lEvent</i>. See <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a></b> about how to set the socket back to blocking mode.
 * 
 ...
 * 
 * When one of the nominated network events occurs on the specified socket *s*, the service provider uses <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nf-ws2spi-wpupostmessage">WPUPostMessage</a> to send message *wMsg* to the Windows Sockets SPI client's window *hWnd*. In the posted message, the *wParam* argument identifies the socket on which a network event has occurred. The low word of *lParam* specifies the network event that has occurred. The possible network event codes that may be indicated are as follows.
 * 
 * |Value|Meaning|
 * |-|-|
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEAFNOSUPPORT">WSAEAFNOSUPPORT</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNREFUSED">WSAECONNREFUSED</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAENETUNREACH">WSAENETUNREACH</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAETIMEDOUT">WSAETIMEDOUT</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNRESET">WSAECONNRESET</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * <td width="40%">
 * <dl>                                              
 * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAECONNABORTED">WSAECONNABORTED</a></dt>
 * </dl>
 * </td>
 * <td width="60%">
 ...
 * 
 * The FD_QOS or FD_GROUP_QOS message is posted when there has been a change to any field in the flow spec associated with socket *s*, or the socket group that *s* belongs to, respectively. The service provider must update the QOS information available to the client via <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_GET_QOS and/or SIO_GET_GROUP_QOS.
 * 
 * The FD_ROUTING_INTERFACE_CHANGE message is posted when the local interface that should be used to reach the destination specified in <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_ROUTING_INTERFACE_CHANGE changes *after* such IOCTL has been issued.
 * 
 * The FD_ADDRESS_LIST_CHANGE message is posted when the list of addresses to which the Windows Sockets SPI client can bind changes *after* <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_ADDRESS_LIST_CHANGE has been issued.
 * 
 ...
 * 2. After <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_GET_QOS is called, when the QOS is changed.
 * 
 * **FD_GROUP_QOS**
 * 
 ...
 * 2. After <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_GET_GROUP_QOS is called, when the group QOS is changed.
 * 
 * **FD_ROUTING_INTERFACE_CHANGE**
 * 
 * 1) after <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_ROUTING_INTERFACE_CHANGE is called, when the local interface that should be used to reach the destination specified in the IOCTL changes.
 * 
 * **FD_ADDRESS_LIST_CHANGE**
 * 
 * 1) after <a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspioctl">LPWSPIoctl</a> with SIO_ADDRESS_LIST_CHANGE is called, when the list of local addresses to which the Windows Sockets SPI client can bind changes.
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspasyncselect
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPASYNCSELECT {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPASYNCSELECT) {
     ...
     * @param {Integer} lEvent Bitmask that specifies a combination of network events in which the Windows Sockets service provider interface (SPI) client is interested. Constructed by using the bitwise OR operator with any of these values.
     * 
     * <table>
     * <tr>
     * <th>Value</th>
     ...
     * </tr>
     * </table>
     * @param {Pointer<Integer>} lpErrno Pointer to the error code. See the **Return value** section for more info.
     * @returns {Integer} The return value is zero if the Windows Sockets SPI client's declaration of interest in the network event set was successful. Otherwise, the value SOCKET_ERROR is returned, and a specific error code is available in <i>lpErrno</i>.
     * 
     * <table>
     * <tr>
     * <th>Error Code </th>
    ...
    /**
     * A LPWSPASYNCSELECT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPASYNCSELECT {
        /**
         * Creates a LPWSPASYNCSELECT pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, HWND, UInt32, Int32, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 5)) {
