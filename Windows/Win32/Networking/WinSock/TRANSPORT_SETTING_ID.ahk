...
/**
 * Specifies the transport setting ID used by the SIO_APPLY_TRANSPORT_SETTING and SIO_QUERY_TRANSPORT_SETTING IOCTLs to apply or query the transport setting for a socket.
 * @remarks
 * 
 ...
 * 
 * 
 * @see https://docs.microsoft.com/windows/win32/api//mstcpip/ns-mstcpip-transport_setting_id
