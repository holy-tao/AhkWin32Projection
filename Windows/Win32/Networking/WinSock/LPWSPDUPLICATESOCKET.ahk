 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspduplicatesocket
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPDUPLICATESOCKET {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPDUPLICATESOCKET) {
     ...
     * @returns {Integer} If no error occurs, **LPWSPDuplicateSocket** returns zero. Otherwise, the value of SOCKET_ERROR is returned, and a specific error number is available in <i>lpErrno</i>.
     * 
     * <table>
     * <tr>
     * <th> Error Code </th>
    ...
    /**
     * A LPWSPDUPLICATESOCKET that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPDUPLICATESOCKET {
        /**
         * Creates a LPWSPDUPLICATESOCKET pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, UInt32, WSAPROTOCOL_INFOW, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
