        ...
        irdaAttribOctetSeq {
            get {
                if(!this.HasProp("__irdaAttribOctetSeq"))
                    this.__irdaAttribOctetSeq := WINDOWS_IAS_SET._irdaAttribute._irdaAttribOctetSeq(0, this)
        ...
        irdaAttribUsrStr {
            get {
                if(!this.HasProp("__irdaAttribUsrStr"))
                    this.__irdaAttribUsrStr := WINDOWS_IAS_SET._irdaAttribute._irdaAttribUsrStr(0, this)
    ...
    irdaAttribute {
        get {
            if(!this.HasProp("__irdaAttribute"))
                this.__irdaAttribute := WINDOWS_IAS_SET._irdaAttribute(324, this)
