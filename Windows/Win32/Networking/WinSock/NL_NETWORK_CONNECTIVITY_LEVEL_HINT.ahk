...
class NL_NETWORK_CONNECTIVITY_LEVEL_HINT extends Win32Enum {
     ...
     * Native name: NetworkConnectivityLevelHintUnknown
     * @type {Integer (Int32)}
     */
    static Unknown => 0
     ...
     * Native name: NetworkConnectivityLevelHintNone
     * @type {Integer (Int32)}
     */
    static None => 1
     ...
     * Native name: NetworkConnectivityLevelHintLocalAccess
     * @type {Integer (Int32)}
     */
    static LocalAccess => 2

    /**
     * Specifies a hint for local and internet access.
     * Native name: NetworkConnectivityLevelHintInternetAccess
     * @type {Integer (Int32)}
     */
     ...
     * Native name: NetworkConnectivityLevelHintConstrainedInternetAccess
     * @type {Integer (Int32)}
     */
    static ConstrainedInternetAccess => 4
     ...
     * Native name: NetworkConnectivityLevelHintHidden
     * @type {Integer (Int32)}
     */
    static Hidden => 5
}
