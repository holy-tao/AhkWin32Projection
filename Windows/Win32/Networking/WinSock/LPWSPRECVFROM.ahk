 ...
 * @see https://learn.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwsprecvfrom
 * @namespace Windows.Win32.Networking.WinSock
 */
export default struct LPWSPRECVFROM {
    value : IntPtr

    __value {
        set {
            if (value is LPWSPRECVFROM) {
     ...
     * @param {Pointer<Integer>} lpNumberOfBytesRecvd Pointer to the number of bytes received by this call.
     * @param {Pointer<Integer>} lpFlags Pointer to flags.
     * @param {Integer} lpFrom Optional pointer to a buffer in the <b><a href="https://docs.microsoft.com/windows/win32/winsock/sockaddr-2">sockaddr</a></b> structure that will hold the source address upon the completion of the overlapped operation.
     * @param {Pointer<Integer>} lpFromlen Pointer to the size of the <i>lpFrom</i> buffer, in bytes, required only if <i>lpFrom</i> is specified.
     * @param {Pointer<OVERLAPPED>} lpOverlapped Pointer to a <b><a href="https://docs.microsoft.com/windows/win32/api/winsock2/ns-winsock2-wsaoverlapped">WSAOverlapped</a></b> structure (ignored for nonoverlapped sockets).
     ...
     * @returns {Integer} If no error occurs and the receive operation has completed immediately, **LPWSPRecvFrom** returns zero. Note that in this case the completion routine, if specified will have already been queued. Otherwise, a value of SOCKET_ERROR is returned, and a specific error code is available in <i>lpErrno</i>. The error code WSA_IO_PENDING indicates that the overlapped operation has been successfully initiated and that completion will be indicated at a later time. Any other error code indicates that no overlapped operations was initiated and no completion indication will occur.
     * 
     * <table>
     * <tr>
     * <th>Error Code</th>
     ...
     * </td>
     * <td width="60%">
     * Socket has not been bound (for example, with <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspbind">LPWSPBind</a></b>) or the socket is not created with the overlapped flag.
     * </td>
     * </tr>
     * 
     * <tr>
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAESHUTDOWN">WSAESHUTDOWN</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     * Socket has been shut down; it is not possible to run <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwsprecvfrom">LPWSPRecvFrom</a></b> on a socket after <b><a href="https://docs.microsoft.com/windows/win32/api/ws2spi/nc-ws2spi-lpwspshutdown">LPWSPShutdown</a></b> has been invoked with <i>how</i> set to SD_RECEIVE or SD_BOTH.
     * </td>
     * </tr>
     * 
     * <tr>
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEWOULDBLOCK">WSAEWOULDBLOCK</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEMSGSIZE">WSAEMSGSIZE</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSAEDISCON">WSAEDISCON</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSA_IO_PENDING">WSA_IO_PENDING</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
     ...
     * <td width="40%">
     * <dl>                                              
     * <dt><a href="https://docs.microsoft.com/windows/win32/winsock/windows-sockets-error-codes-2#WSA_OPERATION_ABORTED">WSA_OPERATION_ABORTED</a></dt>
     * </dl>
     * </td>
     * <td width="60%">
    ...
    Call(s, lpBuffers, dwBufferCount, lpNumberOfBytesRecvd, lpFlags, lpFrom, lpFromlen, lpOverlapped, lpCompletionRoutine, lpThreadId, lpErrno) {
        ...
        result := DllCall(this.value, SOCKET, s, WSABUF.Ptr, lpBuffers, UInt32, dwBufferCount, lpNumberOfBytesRecvdMarshal, lpNumberOfBytesRecvd, lpFlagsMarshal, lpFlags, IntPtr, lpFrom, lpFromlenMarshal, lpFromlen, OVERLAPPED.Ptr, lpOverlapped, "ptr", lpCompletionRoutine, WSATHREADID.Ptr, lpThreadId, lpErrnoMarshal, lpErrno, Int32)
        return result
    }

    /**
     * A LPWSPRECVFROM that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPWSPRECVFROM {
        /**
         * Creates a LPWSPRECVFROM pointer that invokes the given AHK function when called.
         * @param {Func(SOCKET, WSABUF, UInt32, "uint*", "uint*", IntPtr, "int*", OVERLAPPED, "ptr", WSATHREADID, "int*") => Int32} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 11)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 11 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [SOCKET, WSABUF.Ptr, UInt32, "uint*", "uint*", IntPtr, "int*", OVERLAPPED.Ptr, "ptr", WSATHREADID.Ptr, "int*", Int32])
        }
