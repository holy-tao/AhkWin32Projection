 ...
 * @version v4.0.30319
 */
class LPWSCGETPROVIDERPATH extends IUnknown {
     ...
     */
    Invoke(lpProviderId, lpszProviderDllPath, lpProviderDllPathLen, lpErrno) {
        ...
        result := ComCall(3, this, "ptr", lpProviderId, "ptr", lpszProviderDllPath, lpProviderDllPathLenMarshal, lpProviderDllPathLen, lpErrnoMarshal, lpErrno, "int")
        return result
    }
}
