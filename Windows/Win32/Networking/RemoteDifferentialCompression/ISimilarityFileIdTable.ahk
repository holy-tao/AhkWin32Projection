 ...
 */
export default struct ISimilarityFileIdTable extends IUnknown {
    /**
     ...
     * used for ISimilarityFileIdTable interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ISimilarityFileIdTable.Vtbl()
        }
    ...
    Append(_similarityFileId) {
        result := ComCall(6, this, SimilarityFileId.Ptr, _similarityFileId, "uint*", &similarityFileIndex := 0, "HRESULT")
