 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nn-msrdc-isimilaritytraitsmapping
...
class ISimilarityTraitsMapping extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-closemapping
     */
    CloseMapping() {
        ComCall(3, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-setfilesize
     */
    SetFileSize(fileSize) {
        result := ComCall(4, this, "uint", fileSize, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-getfilesize
     */
    GetFileSize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-openmapping
     */
    OpenMapping(accessMode, begin, end) {
        result := ComCall(6, this, "int", accessMode, "uint", begin, "uint", end, "uint*", &actualEnd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} end File offset, in bytes, where the file mapping is to end.
     * @returns {Integer} Pointer to a location that receives the file offset, in bytes, of the actual end of the file mapping, rounded up to the nearest block size.
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-resizemapping
     */
    ResizeMapping(accessMode, begin, end) {
        result := ComCall(7, this, "int", accessMode, "uint", begin, "uint", end, "uint*", &actualEnd := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-getpagesize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilaritytraitsmapping-createview
     */
    CreateView(minimumMappedPages, accessMode) {
        result := ComCall(9, this, "uint", minimumMappedPages, "int", accessMode, "ptr*", &mappedView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
