...
class ISimilarityTraitsMapping extends IUnknown{
     ...
     * @param {Integer} begin 
     * @param {Integer} end 
     * @param {Pointer<UInt64>} actualEnd 
     * @returns {HRESULT} 
     */
    OpenMapping(accessMode, begin, end, actualEnd) {
        result := ComCall(6, this, "int", accessMode, "uint", begin, "uint", end, "uint*", actualEnd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ResizeMapping(accessMode, begin, end, actualEnd) {
        result := ComCall(7, this, "int", accessMode, "uint", begin, "uint", end, "uint*", actualEnd, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateView(minimumMappedPages, accessMode, mappedView) {
        result := ComCall(9, this, "uint", minimumMappedPages, "int", accessMode, "ptr", mappedView, "int")
        if(result != 0)
            throw OSError(result)
