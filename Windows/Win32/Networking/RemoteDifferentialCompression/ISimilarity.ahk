 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nn-msrdc-isimilarity
...
class ISimilarity extends IUnknown{
     ...
     * @param {PWSTR} path_ A pointer to a null-terminated string that specifies the name of the file that will contain the tables. The similarity traits table and the similarity file ID table will be created in two alternate file streams of this file. For more information, see the <i>path</i> parameter of the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msrdc/nf-msrdc-isimilarityfileidtable-createtable">ISimilarityFileIdTable::CreateTable</a> and <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/msrdc/nf-msrdc-isimilaritytraitstable-createtable">ISimilarityTraitsTable::CreateTable</a> methods.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-createtable
     */
     ...
     * @param {Integer} recordSize The size, in bytes, of each file ID to be stored in the similarity file ID table. All similarity file IDs must be the same size. The valid range is from <b>SimilarityFileIdMinSize</b> to <b>SimilarityFileIdMaxSize</b>. If existing tables are being opened, the value of this parameter must match the file ID size of the existing similarity file ID table. Otherwise, the existing tables are assumed to be not valid and will be overwritten.
     * @returns {Integer} A pointer to  a variable that receives an  <a href="https://docs.microsoft.com/windows/win32/api/msrdc/ne-msrdc-rdccreatedtables">RdcCreatedTables</a> enumeration value that describes the state of the tables. If new tables are created, this variable receives <b>RDCTABLE_New</b>. If existing tables are used, this variable receives <b>RDCTABLE_Existing</b>. If this method fails, this variable receives <b>RDCTABLE_InvalidOrUnknown</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-createtableindirect
     */
    CreateTableIndirect(mapping, fileIdFile, truncate, recordSize) {
        result := ComCall(4, this, "ptr", mapping, "ptr", fileIdFile, "int", truncate, "uint", recordSize, "int*", &isNew := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-closetable
     */
    CloseTable(isValid) {
     ...
     * @param {Pointer<SimilarityFileId>} similarityFileId_ A pointer to the <a href="https://docs.microsoft.com/windows/win32/api/msrdc/ns-msrdc-similarityfileid">SimilarityFileId</a> structure to be added to the similarity file ID table.
     * @param {Pointer<SimilarityData>} similarityData_ A pointer to the <a href="https://docs.microsoft.com/windows/win32/api/msrdc/ns-msrdc-similaritydata">SimilarityData</a> structure to be added to the similarity traits table.
     * @returns {HRESULT} Returns <b>S_OK</b> on success, or an error <b>HRESULT</b> on failure.
     * 
     * This method can also return the following error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-append
     */
    Append(similarityFileId_, similarityData_) {
        result := ComCall(6, this, "ptr", similarityFileId_, "ptr", similarityData_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-findsimilarfileid
     */
    FindSimilarFileId(similarityData_, numberOfMatchesRequired, resultsSize) {
        result := ComCall(7, this, "ptr", similarityData_, "ushort", numberOfMatchesRequired, "uint", resultsSize, "ptr*", &findSimilarResults_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IFindSimilarResults(findSimilarResults_)
    }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-copyandswap
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-isimilarity-getrecordcount
     */
    GetRecordCount() {
