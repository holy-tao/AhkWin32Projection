 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nn-msrdc-irdcgeneratorparameters
...
class IRdcGeneratorParameters extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-irdcgeneratorparameters-getgeneratorparameterstype
     */
    GetGeneratorParametersType() {
        result := ComCall(3, this, "int*", &parametersType := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-irdcgeneratorparameters-getparametersversion
     */
    GetParametersVersion(currentVersion, minimumCompatibleAppVersion) {
        ...
        result := ComCall(4, this, currentVersionMarshal, currentVersion, minimumCompatibleAppVersionMarshal, minimumCompatibleAppVersion, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-irdcgeneratorparameters-getserializesize
     */
    GetSerializeSize() {
        result := ComCall(5, this, "uint*", &size_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} size_ The size of the buffer pointed to by the <i>parametersBlob</i> parameter.
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/msrdc/nf-msrdc-irdcgeneratorparameters-serialize
     */
    Serialize(size_, parametersBlob, bytesWritten) {
        parametersBlobMarshal := parametersBlob is VarRef ? "char*" : "ptr"
        bytesWrittenMarshal := bytesWritten is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, "uint", size_, parametersBlobMarshal, parametersBlob, bytesWrittenMarshal, bytesWritten, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
