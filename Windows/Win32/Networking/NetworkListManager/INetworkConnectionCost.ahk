 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nn-netlistmgr-inetworkconnectioncost
...
class INetworkConnectionCost extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nf-netlistmgr-inetworkconnectioncost-getcost
     */
    GetCost() {
        result := ComCall(3, this, "uint*", &pCost := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nf-netlistmgr-inetworkconnectioncost-getdataplanstatus
     */
    GetDataPlanStatus() {
