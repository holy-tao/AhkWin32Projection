 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nn-netlistmgr-inetworkcostmanager
...
class INetworkCostManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nf-netlistmgr-inetworkcostmanager-getcost
     */
    GetCost(pDestIPAddr) {
        result := ComCall(3, this, "uint*", &pCost := 0, "ptr", pDestIPAddr, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nf-netlistmgr-inetworkcostmanager-getdataplanstatus
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/netlistmgr/nf-netlistmgr-inetworkcostmanager-setdestinationaddresses
     */
