 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/directmanipulation/nn-directmanipulation-idirectmanipulationmanager3
...
class IDirectManipulationManager3 extends IDirectManipulationManager2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directmanipulation/nf-directmanipulation-idirectmanipulationmanager3-getservice
     */
    GetService(clsid, riid) {
        result := ComCall(11, this, "ptr", clsid, "ptr", riid, "ptr*", &object_ := 0, "int")
        if(result != 0) {
