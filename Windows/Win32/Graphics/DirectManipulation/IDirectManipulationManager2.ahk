 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/directmanipulation/nn-directmanipulation-idirectmanipulationmanager2
...
class IDirectManipulationManager2 extends IDirectManipulationManager{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directmanipulation/nf-directmanipulation-idirectmanipulationmanager2-createbehavior
     */
    CreateBehavior(clsid, riid) {
        result := ComCall(10, this, "ptr", clsid, "ptr", riid, "ptr*", &object_ := 0, "int")
        if(result != 0) {
