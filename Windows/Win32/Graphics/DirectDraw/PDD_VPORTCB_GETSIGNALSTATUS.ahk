 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddrawint/nc-ddrawint-pdd_vportcb_getsignalstatus
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDD_VPORTCB_GETSIGNALSTATUS extends IUnknown {
     ...
     * @param {Pointer<DD_GETVPORTSIGNALDATA>} param0 
