 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddrawint/nc-ddrawint-pdd_fliptogdisurface
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDD_FLIPTOGDISURFACE extends IUnknown {
     ...
     * @param {Pointer<DD_FLIPTOGDISURFACEDATA>} param0 
