 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxmini/nc-dxmini-pdx_getirqinfo
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDX_GETIRQINFO extends IUnknown {
     ...
     * @param {Pointer<DDGETIRQINFO>} param2 
