 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddrawint/nc-ddrawint-pdd_getdriverstate
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDD_GETDRIVERSTATE extends IUnknown {
     ...
     * @param {Pointer<DD_GETDRIVERSTATEDATA>} param0 
