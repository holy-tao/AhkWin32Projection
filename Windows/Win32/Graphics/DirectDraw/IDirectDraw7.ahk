...
export default struct IDirectDraw7 extends IUnknown {
    ...
    */
    ...
    GetDeviceIdentifier(param0, param1) {
        result := ComCall(27, this, DDDEVICEIDENTIFIER2.Ptr, param0, UInt32, param1, "HRESULT")
        return result
    }
    ...
    StartModeTest(param0, param1, param2) {
        result := ComCall(28, this, SIZE.Ptr, param0, UInt32, param1, UInt32, param2, "HRESULT")
        return result
    }
    ...
    EvaluateMode(param0, param1) {
        ...
        result := ComCall(29, this, UInt32, param0, param1Marshal, param1, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.StartModeTest := CallbackCreate(ObjBindMethod(implObj, "StartModeTest"), flags, 4)
        this.vtbl.EvaluateMode := CallbackCreate(ObjBindMethod(implObj, "EvaluateMode"), flags, 3)
    }
