...
class IDirectDraw7 extends IUnknown{
     ...
     * @param {Pointer<IUnknown>} param2 
     * @returns {HRESULT} 
     */
    CreateClipper(param0, param1, param2) {
        result := ComCall(4, this, "uint", param0, "ptr", param1, "ptr", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreatePalette(param0, param1, param2, param3) {
        result := ComCall(5, this, "uint", param0, "ptr", param1, "ptr", param2, "ptr", param3, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateSurface(param0, param1, param2) {
        result := ComCall(6, this, "ptr", param0, "ptr", param1, "ptr", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IDirectDrawSurface7>} param0 
     * @param {Pointer<IDirectDrawSurface7>} param1 
     * @returns {HRESULT} 
     */
    ...
    EnumDisplayModes(param0, param1, param2, param3) {
        result := ComCall(8, this, "uint", param0, "ptr", param1, "ptr", param2, "ptr", param3, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumSurfaces(param0, param1, param2, param3) {
        result := ComCall(9, this, "uint", param0, "ptr", param1, "ptr", param2, "ptr", param3, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFourCCCodes(param0, param1) {
        result := ComCall(13, this, "uint*", param0, "uint*", param1, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetMonitorFrequency(param0) {
        result := ComCall(15, this, "uint*", param0, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetScanLine(param0) {
        result := ComCall(16, this, "uint*", param0, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAvailableVidMem(param0, param1, param2) {
        result := ComCall(23, this, "ptr", param0, "uint*", param1, "uint*", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSurfaceFromDC(param0, param1) {
        ...
        result := ComCall(24, this, "ptr", param0, "ptr", param1, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EvaluateMode(param0, param1) {
        result := ComCall(29, this, "uint", param0, "uint*", param1, "int")
        if(result != 0)
            throw OSError(result)
