...
class IDirectDraw7 extends IUnknown{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-compact
     */
    Compact() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-createclipper
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-createpalette
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-createsurface
     */
     ...
     * @returns {IDirectDrawSurface7} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-duplicatesurface
     */
     ...
     * <li>DDERR_INVALIDPARAMS</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-enumdisplaymodes
     */
     ...
     * <li>DDERR_INVALIDPARAMS</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-enumsurfaces
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-fliptogdisurface
     */
    FlipToGDISurface() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getcaps
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getdisplaymode
     */
     ...
     * <li>DDERR_INVALIDPARAMS</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getfourcccodes
     */
     ...
     * @returns {IDirectDrawSurface7} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getgdisurface
     */
    GetGDISurface() {
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getmonitorfrequency
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getscanline
     */
    GetScanLine(param0) {
        param0Marshal := param0 is VarRef ? "uint*" : "ptr"
     ...
     * <li>DDERR_INVALIDPARAMS</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getverticalblankstatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-initialize
     */
    Initialize(param0) {
     ...
     * <li>DDERR_NOEXCLUSIVEMODE</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-restoredisplaymode
     */
    RestoreDisplayMode() {
     ...
     * <li>DDERR_OUTOFMEMORY</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-setcooperativelevel
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-setdisplaymode
     */
     ...
     * <li>DDERR_WASSTILLDRAWING</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-waitforverticalblank
     */
     ...
     * <li>DDERR_NODIRECTDRAWHW</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getavailablevidmem
     */
     ...
     * @param {HDC} param0 
     * @returns {IDirectDrawSurface7} 
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getsurfacefromdc
     */
     ...
     * <li>DDERR_INVALIDPARAMS</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-restoreallsurfaces
     */
    RestoreAllSurfaces() {
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-testcooperativelevel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-getdeviceidentifier
     */
     ...
     * <li>DDERR_TESTFINISHED</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-startmodetest
     */
    StartModeTest(param0, param1, param2) {
        result := ComCall(28, this, "ptr", param0, "uint", param1, "uint", param2, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <li>DDERR_NOTFOUND </li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdraw7-evaluatemode
     */
    EvaluateMode(param0, param1) {
        param1Marshal := param1 is VarRef ? "uint*" : "ptr"

        result := ComCall(29, this, "uint", param0, param1Marshal, param1, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
