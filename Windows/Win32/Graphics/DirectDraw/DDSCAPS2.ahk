...
class DDSCAPS2 extends Win32Struct
{
     ...
     * <p>Indicates that subordinate heads of a multiple-head card are no longer in control of their video memory after surfaces are created for those subordinate heads with this bit set. Once such surfaces are destroyed, subordinate heads regain control of their memory. For more information, see <a href="https://docs.microsoft.com/windows-hardware/drivers/display/managing-multiple-head-memory">Managing Multiple-Head Memory</a>.</p></td>
     * </tr>
     * <tr class="even">
     ...
     * <p>Indicates to create surfaces that are part of a primary flipping chain or that are on stand-alone back buffers. This flag turns on the alpha channel. For more information, see <a href="https://docs.microsoft.com/windows-hardware/drivers/display/enabling-alpha-channels-on-full-screen-back-buffers">Enabling Alpha Channels On Full-Screen Back Buffers</a>.</p></td>
     * </tr>
     * <tr class="odd">
     * <td><p>DDSCAPS2_EXTENDEDFORMATPRIMARY</p></td>
     * <td><p><strong>DirectX 9.0 and later versions only.</strong></p>
     * <p>Indicates to create a dummy primary surface for use with a nonstandard display mode. For more information, see <a href="https://docs.microsoft.com/windows-hardware/drivers/display/switching-between-standard-and-nonstandard-modes">Switching Between Standard and Nonstandard Modes</a>.</p></td>
     * </tr>
     * <tr class="even">
