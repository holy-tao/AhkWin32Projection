 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddrawint/nc-ddrawint-pdd_surfcb_setoverlayposition
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDD_SURFCB_SETOVERLAYPOSITION extends IUnknown {
     ...
     * @param {Pointer<DD_SETOVERLAYPOSITIONDATA>} param0 
