 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddrawint/nc-ddrawint-pdd_mocompcb_destroy
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class PDD_MOCOMPCB_DESTROY extends IUnknown {
     ...
     * @param {Pointer<DD_DESTROYMOCOMPDATA>} param0 
