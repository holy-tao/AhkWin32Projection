...
class IDirectDrawSurface4 extends IUnknown{
    ...
    /**
     * For current documentation on Windows Media codecs and digital signal processors, see Windows Media Audio and Video Codec and DSP APIs. | GetPrivateData
     * @param {Pointer<Guid>} param0 
     * @param {Pointer<Void>} param1 
     * @param {Pointer<Integer>} param2 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wmformat/iwmcodecprivatedata-getprivatedata
     */
    ...
    /**
     * Frees a PrivateData data structure.
     * @remarks
     ...
     * @param {Pointer<Guid>} param0 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/NAP/freeprivatedata-func
     */
