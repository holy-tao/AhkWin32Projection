...
class IDirectDrawSurface2 extends IUnknown{
    /**
     * The interface identifier for IDirectDrawSurface2
     * @type {Guid}
     */
    static IID => Guid("{57805885-6eec-11cf-9441-a82303c10e27}")
    ...
    /**
     * 
     * @param {Pointer<IDirectDrawSurface2>} param0 
     * @returns {HRESULT} 
     */
     ...
     * 
     * @param {Pointer<RECT>} param0 
     * @param {Pointer<IDirectDrawSurface2>} param1 
     ...
     * @param {Integer} param1 
     * @param {Pointer<IDirectDrawSurface2>} param2 
