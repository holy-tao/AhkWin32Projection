 ...
 */
export default struct IDirectDrawSurface2 extends IUnknown {
    /**
     ...
     * used for IDirectDrawSurface2 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirectDrawSurface2.Vtbl()
        }
    ...
    GetAttachedSurface(param0) {
        ...
        return IDirectDrawSurface2(param1)
    }
    ...
    Lock(param0, param1, param2, param3) {
        result := ComCall(25, this, RECT.Ptr, param0, DDSURFACEDESC.Ptr, param1, UInt32, param2, HANDLE, param3, "HRESULT")
        return result
    }
    ...
    Query(iid) {
        if (IDirectDrawSurface2.IID.Equals(iid)) {
            return true
        }
