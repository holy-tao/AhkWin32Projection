 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nn-ddraw-idirectdrawpalette
...
class IDirectDrawPalette extends IUnknown{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdrawpalette-getcaps
     */
    GetCaps(param0) {
        param0Marshal := param0 is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, param0Marshal, param0, "int")
        if(result != 0) {
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdrawpalette-getentries
     */
    GetEntries(param0, param1, param2, param3) {
        result := ComCall(4, this, "uint", param0, "uint", param1, "uint", param2, "ptr", param3, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdrawpalette-initialize
     */
    Initialize(param0, param1, param2) {
        result := ComCall(5, this, "ptr", param0, "uint", param1, "ptr", param2, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nf-ddraw-idirectdrawpalette-setentries
     */
    SetEntries(param0, param1, param2, param3) {
        result := ComCall(6, this, "uint", param0, "uint", param1, "uint", param2, "ptr", param3, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
