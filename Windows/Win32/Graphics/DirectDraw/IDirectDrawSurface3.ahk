 ...
 */
export default struct IDirectDrawSurface3 extends IUnknown {
    /**
     ...
     * used for IDirectDrawSurface3 interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirectDrawSurface3.Vtbl()
        }
    ...
    SetSurfaceDesc(param0, param1) {
        result := ComCall(39, this, DDSURFACEDESC.Ptr, param0, UInt32, param1, "HRESULT")
        return result
    }

    Query(iid) {
        if (IDirectDrawSurface3.IID.Equals(iid)) {
            return true
        }
