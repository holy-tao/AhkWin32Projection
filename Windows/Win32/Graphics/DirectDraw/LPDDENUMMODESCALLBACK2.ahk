 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nc-ddraw-lpddenummodescallback2
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 */
class LPDDENUMMODESCALLBACK2 extends IUnknown {
    ...
    Invoke(param0, param1) {
        ...
        result := ComCall(3, this, "ptr", param0, param1Marshal, param1, "int")
        if(result != 0) {
