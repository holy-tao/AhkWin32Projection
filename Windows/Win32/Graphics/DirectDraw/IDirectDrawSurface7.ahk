...
class IDirectDrawSurface7 extends IUnknown{
     ...
     * @param {Integer} param1 
     * @param {Pointer<IDirectDrawSurface7>} param2 
    ...
    EnumOverlayZOrders(param0, param1, param2) {
        result := ComCall(10, this, "uint", param0, "ptr", param1, "ptr", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAttachedSurface(param0, param1) {
        result := ComCall(12, this, "ptr", param0, "ptr", param1, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetOverlayPosition(param0, param1) {
        result := ComCall(19, this, "int*", param0, "int*", param1, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetPalette(param0) {
        result := ComCall(20, this, "ptr", param0, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<IDirectDraw>} param0 
    ...
    GetDDInterface(param0) {
        result := ComCall(36, this, "ptr", param0, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetPrivateData(param0, param1, param2, param3) {
        result := ComCall(40, this, "ptr", param0, "ptr", param1, "uint", param2, "uint", param3, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetPrivateData(param0, param1, param2) {
        result := ComCall(41, this, "ptr", param0, "ptr", param1, "uint*", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetUniquenessValue(param0) {
        result := ComCall(43, this, "uint*", param0, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetPriority(param0) {
        result := ComCall(46, this, "uint*", param0, "int")
        if(result != 0)
            throw OSError(result)
     ...
     */
    GetLOD(param0) {
        result := ComCall(48, this, "uint*", param0, "int")
        if(result != 0)
            throw OSError(result)
