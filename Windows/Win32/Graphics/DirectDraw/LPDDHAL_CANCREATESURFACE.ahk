 ...
 */
export default struct LPDDHAL_CANCREATESURFACE {
    value : IntPtr

    __value {
        set {
            if (value is LPDDHAL_CANCREATESURFACE) {
    ...
    /**
     * A LPDDHAL_CANCREATESURFACE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPDDHAL_CANCREATESURFACE {
        /**
         * Creates a LPDDHAL_CANCREATESURFACE pointer that invokes the given AHK function when called.
