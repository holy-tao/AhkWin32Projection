 ...
 * @see https://learn.microsoft.com/windows/win32/api/ddraw/nc-ddraw-lpddenumcallbackexw
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @charset Unicode
 */
export default struct LPDDENUMCALLBACKEXW {
    value : IntPtr

    __value {
        set {
            if (value is LPDDENUMCALLBACKEXW) {
    ...
    /**
     * A LPDDENUMCALLBACKEXW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LPDDENUMCALLBACKEXW {
        /**
         * Creates a LPDDENUMCALLBACKEXW pointer that invokes the given AHK function when called.
         * @param {Func(Guid, PWSTR, PWSTR, "ptr", HMONITOR) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 5)) {
