 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/ddraw/nc-ddraw-lpddenumcallbackexw
 * @namespace Windows.Win32.Graphics.DirectDraw
 * @version v4.0.30319
 * @charset Unicode
 */
class LPDDENUMCALLBACKEXW extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ptr", param2, param3Marshal, param3, "ptr", param4, "int")
        return result
    }
}
