 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nn-dxgi1_2-idxgiswapchain1
...
class IDXGISwapChain1 extends IDXGISwapChain{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getdesc1
     */
    GetDesc1() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getfullscreendesc
     */
    GetFullscreenDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-gethwnd
     */
    GetHwnd() {
        pHwnd := HWND()
     ...
     * @returns {Pointer<Pointer<Void>>} A pointer to a variable that receives a pointer to the <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Core.CoreWindow">CoreWindow</a> object.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getcorewindow
     */
    GetCoreWindow(refiid) {
        result := ComCall(21, this, "ptr", refiid, "ptr*", &ppUnk := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-present1
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-istemporarymonosupported
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getrestricttooutput
     */
    GetRestrictToOutput() {
        result := ComCall(24, this, "ptr*", &ppRestrictToOutput := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-setbackgroundcolor
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getbackgroundcolor
     */
    GetBackgroundColor() {
        pColor := DXGI_RGBA()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-setrotation
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgiswapchain1-getrotation
     */
    GetRotation() {
        result := ComCall(28, this, "int*", &pRotation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
