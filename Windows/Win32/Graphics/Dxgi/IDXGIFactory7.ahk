 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_6/nn-dxgi1_6-idxgifactory7
...
class IDXGIFactory7 extends IDXGIFactory6{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_6/nf-dxgi1_6-idxgifactory7-registeradapterschangedevent
     */
    RegisterAdaptersChangedEvent(hEvent) {
        hEvent := hEvent is Win32Handle ? NumGet(hEvent, "ptr") : hEvent

        result := ComCall(30, this, "ptr", hEvent, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_6/nf-dxgi1_6-idxgifactory7-unregisteradapterschangedevent
     */
