...
class DXGI_SWAP_CHAIN_FLAG extends Win32BitflagEnum {
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_NONPREROTATED
     * @type {Integer (Int32)}
     */
    static NONPREROTATED => 1
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH
     * @type {Integer (Int32)}
     */
    static ALLOW_MODE_SWITCH => 2
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_GDI_COMPATIBLE
     * @type {Integer (Int32)}
     */
    static GDI_COMPATIBLE => 4
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_RESTRICTED_CONTENT
     * @type {Integer (Int32)}
     */
    static RESTRICTED_CONTENT => 8
     ...
     * 
     * <b>Direct3D 11:  </b>This enumeration value is supported starting with Windows 8.
     * Native name: DXGI_SWAP_CHAIN_FLAG_RESTRICT_SHARED_RESOURCE_DRIVER
     * @type {Integer (Int32)}
     */
    static RESTRICT_SHARED_RESOURCE_DRIVER => 16
     ...
     * 
     * <b>Direct3D 11:  </b>This enumeration value is supported starting with Windows 8.
     * Native name: DXGI_SWAP_CHAIN_FLAG_DISPLAY_ONLY
     * @type {Integer (Int32)}
     */
    static DISPLAY_ONLY => 32
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_FRAME_LATENCY_WAITABLE_OBJECT
     * @type {Integer (Int32)}
     */
    static FRAME_LATENCY_WAITABLE_OBJECT => 64
     ...
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 8.1.
     * Native name: DXGI_SWAP_CHAIN_FLAG_FOREGROUND_LAYER
     * @type {Integer (Int32)}
     */
    static FOREGROUND_LAYER => 128

    /**
     * Set this flag to create a swap chain for full-screen video. 
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 8.1.
     * Native name: DXGI_SWAP_CHAIN_FLAG_FULLSCREEN_VIDEO
     * @type {Integer (Int32)}
     */
    static FULLSCREEN_VIDEO => 256

    /**
     * Set this flag to create a swap chain for YUV video.
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 8.1.
     * Native name: DXGI_SWAP_CHAIN_FLAG_YUV_VIDEO
     * @type {Integer (Int32)}
     */
    static YUV_VIDEO => 512
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_HW_PROTECTED
     * @type {Integer (Int32)}
     */
    static HW_PROTECTED => 1024
     ...
     * Native name: DXGI_SWAP_CHAIN_FLAG_ALLOW_TEARING
     * @type {Integer (Int32)}
     */
    static ALLOW_TEARING => 2048

    /**
     * Native name: DXGI_SWAP_CHAIN_FLAG_RESTRICTED_TO_ALL_HOLOGRAPHIC_DISPLAYS
     * @type {Integer (Int32)}
     */
    static RESTRICTED_TO_ALL_HOLOGRAPHIC_DISPLAYS => 4096
}
