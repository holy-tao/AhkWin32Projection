 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nn-dxgi1_3-idxgiswapchain2
...
class IDXGISwapChain2 extends IDXGISwapChain1{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-setsourcesize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-getsourcesize
     */
    GetSourceSize(pWidth, pHeight) {
        pWidthMarshal := pWidth is VarRef ? "uint*" : "ptr"
        pHeightMarshal := pHeight is VarRef ? "uint*" : "ptr"

        result := ComCall(30, this, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-setmaximumframelatency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-getmaximumframelatency
     */
    GetMaximumFrameLatency() {
        result := ComCall(32, this, "uint*", &pMaxLatency := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-getframelatencywaitableobject
     */
     ...
     * <li>Possibly other error codes that are described in the <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a> topic.</li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-setmatrixtransform
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchain2-getmatrixtransform
     */
    GetMatrixTransform() {
