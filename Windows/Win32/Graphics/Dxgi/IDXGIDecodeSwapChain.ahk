 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nn-dxgi1_3-idxgidecodeswapchain
...
class IDXGIDecodeSwapChain extends IUnknown{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-presentbuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-setsourcerect
     */
    SetSourceRect(pRect) {
     ...
     * @returns {HRESULT} This method returns S_OK on success, or it returns one of the error codes that are described in the <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a> topic.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-settargetrect
     */
    SetTargetRect(pRect) {
     ...
     * @returns {HRESULT} This method returns S_OK on success, or it returns one of the error codes that are described in the <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a> topic.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-setdestsize
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-getsourcerect
     */
    GetSourceRect() {
        pRect := RECT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-gettargetrect
     */
    GetTargetRect() {
        pRect := RECT()
     ...
     * @returns {HRESULT} This method returns S_OK on success, or it returns one of the error codes that are described in the <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a> topic.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-getdestsize
     */
    GetDestSize(pWidth, pHeight) {
        pWidthMarshal := pWidth is VarRef ? "uint*" : "ptr"
        pHeightMarshal := pHeight is VarRef ? "uint*" : "ptr"

        result := ComCall(9, this, pWidthMarshal, pWidth, pHeightMarshal, pHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} This method returns S_OK on success, or it returns one of the error codes that are described in the <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a> topic.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-setcolorspace
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgidecodeswapchain-getcolorspace
     */
    GetColorSpace() {
