 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgifactory1
...
class IDXGIFactory1 extends IDXGIFactory{
     ...
     * @param {Pointer<Pointer<IDXGIAdapter1>>} ppAdapter Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgiadapter1">IDXGIAdapter1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgifactory1-enumadapters1
     */
    EnumAdapters1(Adapter_, ppAdapter) {
        result := ComCall(12, this, "uint", Adapter_, "ptr*", ppAdapter, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgifactory1-iscurrent
     */
    IsCurrent() {
