 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nn-dxgi1_2-idxgisurface2
...
class IDXGISurface2 extends IDXGISurface1{
     ...
     * @param {Pointer<Pointer<Pointer<Void>>>} ppParentResource A pointer to a buffer that receives a pointer to the parent resource object for the subresource surface.
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_2/nf-dxgi1_2-idxgisurface2-getresource
     */
    GetResource(riid, ppParentResource, pSubresourceIndex) {
        ...
        result := ComCall(13, this, "ptr", riid, ppParentResourceMarshal, ppParentResource, pSubresourceIndexMarshal, pSubresourceIndex, "int")
        if(result != 0) {
