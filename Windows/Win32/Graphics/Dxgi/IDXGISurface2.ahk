...
class IDXGISurface2 extends IDXGISurface1{
     ...
     * @param {Pointer<Void>} ppParentResource 
     * @param {Pointer<UInt32>} pSubresourceIndex 
     * @returns {HRESULT} 
     */
    GetResource(riid, ppParentResource, pSubresourceIndex) {
        result := ComCall(13, this, "ptr", riid, "ptr", ppParentResource, "uint*", pSubresourceIndex, "int")
        if(result != 0)
