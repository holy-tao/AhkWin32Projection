 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_6/nn-dxgi1_6-idxgifactory6
...
class IDXGIFactory6 extends IDXGIFactory5{
     ...
     * <dd>3. iGPUs</dd>
     * </dl>
     * @param {Integer} Adapter_ Type: <b>UINT</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_6/nf-dxgi1_6-idxgifactory6-enumadapterbygpupreference
     */
    EnumAdapterByGpuPreference(Adapter_, GpuPreference, riid) {
        result := ComCall(29, this, "uint", Adapter_, "int", GpuPreference, "ptr", riid, "ptr*", &ppvAdapter := 0, "int")
        if(result != 0) {
