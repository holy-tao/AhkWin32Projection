 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgidevice
...
class IDXGIDevice extends IDXGIObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgidevice-getadapter
     */
    GetAdapter() {
        result := ComCall(7, this, "ptr*", &pAdapter := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgidevice-createsurface
     */
    CreateSurface(pDesc, NumSurfaces, Usage, pSharedResource) {
        result := ComCall(8, this, "ptr", pDesc, "uint", NumSurfaces, "uint", Usage, "ptr", pSharedResource, "ptr*", &ppSurface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgidevice-queryresourceresidency
     */
    QueryResourceResidency(ppResources, NumResources) {
        result := ComCall(9, this, "ptr*", ppResources, "int*", &pResidencyStatus := 0, "uint", NumResources, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgidevice-setgputhreadpriority
     */
    SetGPUThreadPriority(Priority_) {
        result := ComCall(10, this, "int", Priority_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgidevice-getgputhreadpriority
     */
