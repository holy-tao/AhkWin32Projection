...
class DXGI_GRAPHICS_PREEMPTION_GRANULARITY extends Win32Enum {
     ...
     * Native name: DXGI_GRAPHICS_PREEMPTION_DMA_BUFFER_BOUNDARY
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DXGI_GRAPHICS_PREEMPTION_PRIMITIVE_BOUNDARY
     * @type {Integer (Int32)}
     */
    static PRIMITIVE_BOUNDARY => 1

    /**
     * Indicates the preemption granularity as a triangle. A triangle is a part of a primitive.
     * Native name: DXGI_GRAPHICS_PREEMPTION_TRIANGLE_BOUNDARY
     * @type {Integer (Int32)}
     */
    static TRIANGLE_BOUNDARY => 2

    /**
     * Indicates the preemption granularity as a pixel. A pixel is a part of a triangle.
     * Native name: DXGI_GRAPHICS_PREEMPTION_PIXEL_BOUNDARY
     * @type {Integer (Int32)}
     */
    static PIXEL_BOUNDARY => 3

    /**
     * Indicates the preemption granularity as a graphics instruction. A graphics instruction operates on a pixel.
     * Native name: DXGI_GRAPHICS_PREEMPTION_INSTRUCTION_BOUNDARY
     * @type {Integer (Int32)}
     */
