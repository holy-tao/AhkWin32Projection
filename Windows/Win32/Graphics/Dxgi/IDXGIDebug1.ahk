 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nn-dxgidebug-idxgidebug1
...
class IDXGIDebug1 extends IDXGIDebug{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgidebug1-enableleaktrackingforthread
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgidebug1-disableleaktrackingforthread
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgidebug1-isleaktrackingenabledforthread
     */
