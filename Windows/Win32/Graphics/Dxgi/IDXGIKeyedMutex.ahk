 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgikeyedmutex
...
class IDXGIKeyedMutex extends IDXGIDeviceSubObject{
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgikeyedmutex-acquiresync
     */
    AcquireSync(Key, dwMilliseconds) {
        result := ComCall(8, this, "uint", Key, "uint", dwMilliseconds, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgikeyedmutex-releasesync
     */
    ReleaseSync(Key) {
        result := ComCall(9, this, "uint", Key, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
