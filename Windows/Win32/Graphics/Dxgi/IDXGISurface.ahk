 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgisurface
...
class IDXGISurface extends IDXGIDeviceSubObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgisurface-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgisurface-map
     */
    Map(MapFlags) {
        pLockedRect := DXGI_MAPPED_RECT()
        result := ComCall(9, this, "ptr", pLockedRect, "uint", MapFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgisurface-unmap
     */
    Unmap() {
