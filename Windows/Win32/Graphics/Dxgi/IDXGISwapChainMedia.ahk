 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nn-dxgi1_3-idxgiswapchainmedia
...
class IDXGISwapChainMedia extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchainmedia-getframestatisticsmedia
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchainmedia-setpresentduration
     */
     ...
     * @returns {HRESULT} This method returns S_OK on success, or a DXGI error code on failure.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgiswapchainmedia-checkpresentdurationsupport
     */
    CheckPresentDurationSupport(DesiredPresentDuration, pClosestSmallerPresentDuration, pClosestLargerPresentDuration) {
        ...
        result := ComCall(5, this, "uint", DesiredPresentDuration, pClosestSmallerPresentDurationMarshal, pClosestSmallerPresentDuration, pClosestLargerPresentDurationMarshal, pClosestLargerPresentDuration, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
