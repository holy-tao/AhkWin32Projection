...
class IDXGIFactoryMedia extends IUnknown{
    ...
    CreateSwapChainForCompositionSurfaceHandle(pDevice, hSurface, pDesc, pRestrictToOutput, ppSwapChain) {
        ...
        result := ComCall(3, this, "ptr", pDevice, "ptr", hSurface, "ptr", pDesc, "ptr", pRestrictToOutput, "ptr", ppSwapChain, "int")
        if(result != 0)
     ...
     * @param {Pointer<IDXGIResource>} pYuvDecodeBuffers 
     * @param {Pointer<IDXGIOutput>} pRestrictToOutput 
    ...
    CreateDecodeSwapChainForCompositionSurfaceHandle(pDevice, hSurface, pDesc, pYuvDecodeBuffers, pRestrictToOutput, ppSwapChain) {
        ...
        result := ComCall(4, this, "ptr", pDevice, "ptr", hSurface, "ptr", pDesc, "ptr", pYuvDecodeBuffers, "ptr", pRestrictToOutput, "ptr", ppSwapChain, "int")
        if(result != 0)
            throw OSError(result)
