 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgiswapchain
...
class IDXGISwapChain extends IDXGIDeviceSubObject{
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-present
     */
     ...
     * @param {Integer} Buffer_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">UINT</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getbuffer
     */
    GetBuffer(Buffer_, riid) {
        result := ComCall(9, this, "uint", Buffer_, "ptr", riid, "ptr*", &ppSurface := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-setfullscreenstate
     */
     ...
     * </ul>
     * @param {Pointer<Pointer<IDXGIOutput>>} ppTarget Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgioutput">IDXGIOutput</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getfullscreenstate
     */
    GetFullscreenState(pFullscreen, ppTarget) {
        pFullscreenMarshal := pFullscreen is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, pFullscreenMarshal, pFullscreen, "ptr*", ppTarget, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-resizebuffers
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-resizetarget
     */
     ...
     * @returns {Pointer<IDXGIOutput>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgioutput">IDXGIOutput</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getcontainingoutput
     */
    GetContainingOutput() {
        result := ComCall(15, this, "ptr*", &ppOutput := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getframestatistics
     */
    GetFrameStatistics() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiswapchain-getlastpresentcount
     */
    GetLastPresentCount() {
        result := ComCall(17, this, "uint*", &pLastPresentCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
