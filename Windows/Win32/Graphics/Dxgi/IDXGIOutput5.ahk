...
class IDXGIOutput5 extends IDXGIOutput4{
     ...
     * @param {Pointer<Int32>} pSupportedFormats 
    ...
    DuplicateOutput1(pDevice, Flags, SupportedFormatsCount, pSupportedFormats, ppOutputDuplication) {
        result := ComCall(26, this, "ptr", pDevice, "uint", Flags, "uint", SupportedFormatsCount, "int*", pSupportedFormats, "ptr", ppOutputDuplication, "int")
        if(result != 0)
