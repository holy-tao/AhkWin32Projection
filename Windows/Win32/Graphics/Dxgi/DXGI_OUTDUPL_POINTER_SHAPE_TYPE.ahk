...
class DXGI_OUTDUPL_POINTER_SHAPE_TYPE extends Win32Enum {
     ...
     * Native name: DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MONOCHROME
     * @type {Integer (Int32)}
     */
    static MONOCHROME => 1
     ...
     * Native name: DXGI_OUTDUPL_POINTER_SHAPE_TYPE_COLOR
     * @type {Integer (Int32)}
     */
    static COLOR => 2
     ...
     * Native name: DXGI_OUTDUPL_POINTER_SHAPE_TYPE_MASKED_COLOR
     * @type {Integer (Int32)}
     */
