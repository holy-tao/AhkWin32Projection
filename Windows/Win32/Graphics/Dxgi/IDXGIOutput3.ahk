 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nn-dxgi1_3-idxgioutput3
...
class IDXGIOutput3 extends IDXGIOutput2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_3/nf-dxgi1_3-idxgioutput3-checkoverlaysupport
     */
    CheckOverlaySupport(EnumFormat, pConcernedDevice) {
        result := ComCall(24, this, "int", EnumFormat, "ptr", pConcernedDevice, "uint*", &pFlags := 0, "int")
        if(result != 0) {
