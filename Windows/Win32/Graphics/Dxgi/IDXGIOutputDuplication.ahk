...
class IDXGIOutputDuplication extends IDXGIObject{
     ...
     * @param {Pointer<UInt32>} pDirtyRectsBufferSizeRequired 
     * @returns {HRESULT} 
     */
    GetFrameDirtyRects(DirtyRectsBufferSize, pDirtyRectsBuffer, pDirtyRectsBufferSizeRequired) {
        result := ComCall(9, this, "uint", DirtyRectsBufferSize, "ptr", pDirtyRectsBuffer, "uint*", pDirtyRectsBufferSizeRequired, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pMoveRectsBufferSizeRequired 
     * @returns {HRESULT} 
     */
    GetFrameMoveRects(MoveRectsBufferSize, pMoveRectBuffer, pMoveRectsBufferSizeRequired) {
        result := ComCall(10, this, "uint", MoveRectsBufferSize, "ptr", pMoveRectBuffer, "uint*", pMoveRectsBufferSizeRequired, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pPointerShapeBufferSizeRequired 
    ...
    GetFramePointerShape(PointerShapeBufferSize, pPointerShapeBuffer, pPointerShapeBufferSizeRequired, pPointerShapeInfo) {
        result := ComCall(11, this, "uint", PointerShapeBufferSize, "ptr", pPointerShapeBuffer, "uint*", pPointerShapeBufferSizeRequired, "ptr", pPointerShapeInfo, "int")
        if(result != 0)
            throw OSError(result)
