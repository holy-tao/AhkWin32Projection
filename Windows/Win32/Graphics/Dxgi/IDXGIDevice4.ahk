...
class IDXGIDevice4 extends IDXGIDevice3{
    ...
    OfferResources1(NumResources, ppResources, Priority, Flags) {
        result := ComCall(18, this, "uint", NumResources, "ptr", ppResources, "int", Priority, "uint", Flags, "int")
        if(result != 0)
     ...
     * @param {Integer} NumResources 
     * @param {Pointer<IDXGIResource>} ppResources 
     * @param {Pointer<Int32>} pResults 
     * @returns {HRESULT} 
     */
    ReclaimResources1(NumResources, ppResources, pResults) {
        result := ComCall(19, this, "uint", NumResources, "ptr", ppResources, "int*", pResults, "int")
        if(result != 0)
            throw OSError(result)
