 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nn-dxgidebug-idxgiinfoqueue
...
class IDXGIInfoQueue extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setmessagecountlimit
     */
    SetMessageCountLimit(Producer, MessageCountLimit) {
        result := ComCall(3, this, "ptr", Producer, "uint", MessageCountLimit, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearstoredmessages
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmessage
     */
    GetMessage(Producer, MessageIndex, pMessage, pMessageByteLength) {
        ...
        result := ComCall(5, this, "ptr", Producer, "uint", MessageIndex, "ptr", pMessage, pMessageByteLengthMarshal, pMessageByteLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnumstoredmessagesallowedbyretrievalfilters
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnumstoredmessages
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesdiscardedbymessagecountlimit
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmessagecountlimit
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesallowedbystoragefilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getnummessagesdeniedbystoragefilter
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addstoragefilterentries
     */
    AddStorageFilterEntries(Producer, pFilter) {
        result := ComCall(12, this, "ptr", Producer, "ptr", pFilter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getstoragefilter
     */
    GetStorageFilter(Producer, pFilter, pFilterByteLength) {
        pFilterByteLengthMarshal := pFilterByteLength is VarRef ? "ptr*" : "ptr"

        result := ComCall(13, this, "ptr", Producer, "ptr", pFilter, pFilterByteLengthMarshal, pFilterByteLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearstoragefilter
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushemptystoragefilter
     */
    PushEmptyStorageFilter(Producer) {
        result := ComCall(15, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushdenyallstoragefilter
     */
    PushDenyAllStorageFilter(Producer) {
        result := ComCall(16, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushcopyofstoragefilter
     */
    PushCopyOfStorageFilter(Producer) {
        result := ComCall(17, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushstoragefilter
     */
    PushStorageFilter(Producer, pFilter) {
        result := ComCall(18, this, "ptr", Producer, "ptr", pFilter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-popstoragefilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getstoragefilterstacksize
     */
     ...
     * @param {Pointer<DXGI_INFO_QUEUE_FILTER>} pFilter An array of <a href="https://docs.microsoft.com/windows/desktop/api/dxgidebug/ns-dxgidebug-dxgi_info_queue_filter">DXGI_INFO_QUEUE_FILTER</a> structures that describe the filters.
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addretrievalfilterentries
     */
    AddRetrievalFilterEntries(Producer, pFilter) {
        result := ComCall(21, this, "ptr", Producer, "ptr", pFilter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getretrievalfilter
     */
    GetRetrievalFilter(Producer, pFilter, pFilterByteLength) {
        pFilterByteLengthMarshal := pFilterByteLength is VarRef ? "ptr*" : "ptr"

        result := ComCall(22, this, "ptr", Producer, "ptr", pFilter, pFilterByteLengthMarshal, pFilterByteLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Guid} Producer A <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-debug-id">DXGI_DEBUG_ID</a> value that identifies the entity that removes the filter.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-clearretrievalfilter
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushemptyretrievalfilter
     */
    PushEmptyRetrievalFilter(Producer) {
        result := ComCall(24, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushdenyallretrievalfilter
     */
    PushDenyAllRetrievalFilter(Producer) {
        result := ComCall(25, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushcopyofretrievalfilter
     */
    PushCopyOfRetrievalFilter(Producer) {
        result := ComCall(26, this, "ptr", Producer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Pointer<DXGI_INFO_QUEUE_FILTER>} pFilter A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/dxgidebug/ns-dxgidebug-dxgi_info_queue_filter">DXGI_INFO_QUEUE_FILTER</a> structure that describes the filter.
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-pushretrievalfilter
     */
    PushRetrievalFilter(Producer, pFilter) {
        result := ComCall(27, this, "ptr", Producer, "ptr", pFilter, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Guid} Producer A <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-debug-id">DXGI_DEBUG_ID</a> value that identifies the entity that pops the filter.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-popretrievalfilter
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getretrievalfilterstacksize
     */
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addmessage
     */
    AddMessage(Producer, Category, Severity, ID, pDescription) {
        ...
        result := ComCall(30, this, "ptr", Producer, "int", Category, "int", Severity, "int", ID, "ptr", pDescription, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {PSTR} pDescription The message string.
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-addapplicationmessage
     */
    AddApplicationMessage(Severity, pDescription) {
        pDescription := pDescription is String ? StrPtr(pDescription) : pDescription

        result := ComCall(31, this, "int", Severity, "ptr", pDescription, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakoncategory
     */
    SetBreakOnCategory(Producer, Category, bEnable) {
        result := ComCall(32, this, "ptr", Producer, "int", Category, "int", bEnable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakonseverity
     */
    SetBreakOnSeverity(Producer, Severity, bEnable) {
        result := ComCall(33, this, "ptr", Producer, "int", Severity, "int", bEnable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} Returns S_OK if successful; an error code otherwise. For a list of error codes, see <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setbreakonid
     */
    SetBreakOnID(Producer, ID, bEnable) {
        result := ComCall(34, this, "ptr", Producer, "int", ID, "int", bEnable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakoncategory
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakonseverity
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getbreakonid
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-setmutedebugoutput
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgiinfoqueue-getmutedebugoutput
     */
