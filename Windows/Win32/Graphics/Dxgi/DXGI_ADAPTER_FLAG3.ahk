...
class DXGI_ADAPTER_FLAG3 extends Win32BitflagEnum {
    ...
    /**
     * Specifies no flags.
     * Native name: DXGI_ADAPTER_FLAG3_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: DXGI_ADAPTER_FLAG3_REMOTE
     * @type {Integer (Int32)}
     */
    static REMOTE => 1
     ...
     * Native name: DXGI_ADAPTER_FLAG3_SOFTWARE
     * @type {Integer (Int32)}
     */
    static SOFTWARE => 2
     ...
     * Native name: DXGI_ADAPTER_FLAG3_ACG_COMPATIBLE
     * @type {Integer (Int32)}
     */
    static ACG_COMPATIBLE => 4
     ...
     * Native name: DXGI_ADAPTER_FLAG3_SUPPORT_MONITORED_FENCES
     * @type {Integer (Int32)}
     */
    static SUPPORT_MONITORED_FENCES => 8
     ...
     * <div> </div>
     * Native name: DXGI_ADAPTER_FLAG3_SUPPORT_NON_MONITORED_FENCES
     * @type {Integer (Int32)}
     */
    static SUPPORT_NON_MONITORED_FENCES => 16
     ...
     * Native name: DXGI_ADAPTER_FLAG3_KEYED_MUTEX_CONFORMANCE
     * @type {Integer (Int32)}
     */
    static KEYED_MUTEX_CONFORMANCE => 32
}
