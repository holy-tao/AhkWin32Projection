 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nn-dxgi1_4-idxgioutput4
...
class IDXGIOutput4 extends IDXGIOutput3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nf-dxgi1_4-idxgioutput4-checkoverlaycolorspacesupport
     */
    CheckOverlayColorSpaceSupport(Format, ColorSpace, pConcernedDevice) {
        result := ComCall(25, this, "int", Format, "int", ColorSpace, "ptr", pConcernedDevice, "uint*", &pFlags := 0, "int")
        if(result != 0) {
