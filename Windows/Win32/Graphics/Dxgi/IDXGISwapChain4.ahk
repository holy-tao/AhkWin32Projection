 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_5/nn-dxgi1_5-idxgiswapchain4
...
class IDXGISwapChain4 extends IDXGISwapChain3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_5/nf-dxgi1_5-idxgiswapchain4-sethdrmetadata
     */
    SetHDRMetaData(Type, Size_, pMetaData) {
        pMetaDataMarshal := pMetaData is VarRef ? "ptr" : "ptr"

        result := ComCall(40, this, "int", Type, "uint", Size_, pMetaDataMarshal, pMetaData, "int")
        if(result != 0) {
