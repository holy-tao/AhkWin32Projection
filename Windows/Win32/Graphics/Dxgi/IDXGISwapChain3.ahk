 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nn-dxgi1_4-idxgiswapchain3
...
class IDXGISwapChain3 extends IDXGISwapChain2{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nf-dxgi1_4-idxgiswapchain3-getcurrentbackbufferindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nf-dxgi1_4-idxgiswapchain3-checkcolorspacesupport
     */
    CheckColorSpaceSupport(ColorSpace) {
        result := ComCall(37, this, "int", ColorSpace, "uint*", &pColorSpaceSupport := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nf-dxgi1_4-idxgiswapchain3-setcolorspace1
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi1_4/nf-dxgi1_4-idxgiswapchain3-resizebuffers1
     */
    ResizeBuffers1(BufferCount, Width, Height, Format, SwapChainFlags, pCreationNodeMask, ppPresentQueue) {
        ...
        result := ComCall(39, this, "uint", BufferCount, "uint", Width, "uint", Height, "int", Format, "uint", SwapChainFlags, pCreationNodeMaskMarshal, pCreationNodeMask, "ptr*", ppPresentQueue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
