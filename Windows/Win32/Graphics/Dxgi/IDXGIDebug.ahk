 ...
 *       </div>
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nn-dxgidebug-idxgidebug
...
class IDXGIDebug extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgidebug/nf-dxgidebug-idxgidebug-reportliveobjects
     */
    ReportLiveObjects(apiid, flags) {
        result := ComCall(3, this, "ptr", apiid, "int", flags, "int")
        if(result != 0) {
