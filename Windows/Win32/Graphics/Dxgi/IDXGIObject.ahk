 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nn-dxgi-idxgiobject
...
class IDXGIObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiobject-setprivatedata
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiobject-setprivatedatainterface
     */
     ...
     * 
     * Returns one of the following <a href="https://docs.microsoft.com/windows/desktop/direct3ddxgi/dxgi-error">DXGI_ERROR</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiobject-getprivatedata
     */
    GetPrivateData(Name, pDataSize, pData) {
        pDataSizeMarshal := pDataSize is VarRef ? "uint*" : "ptr"

        result := ComCall(5, this, "ptr", Name, pDataSizeMarshal, pDataSize, "ptr", pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxgi/nf-dxgi-idxgiobject-getparent
     */
    GetParent(riid) {
        result := ComCall(6, this, "ptr", riid, "ptr*", &ppParent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
