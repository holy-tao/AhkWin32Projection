...
class DXGI_FRAME_PRESENTATION_MODE extends Win32Enum {
     ...
     * Native name: DXGI_FRAME_PRESENTATION_MODE_COMPOSED
     * @type {Integer (Int32)}
     */
    static COMPOSED => 0
     ...
     * Native name: DXGI_FRAME_PRESENTATION_MODE_OVERLAY
     * @type {Integer (Int32)}
     */
    static OVERLAY => 1
     ...
     * Native name: DXGI_FRAME_PRESENTATION_MODE_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 2
     ...
     * Native name: DXGI_FRAME_PRESENTATION_MODE_COMPOSITION_FAILURE
     * @type {Integer (Int32)}
     */
    static COMPOSITION_FAILURE => 3
}
