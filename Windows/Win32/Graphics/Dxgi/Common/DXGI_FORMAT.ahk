...
class DXGI_FORMAT extends Win32Enum {
     ...
     * Native name: DXGI_FORMAT_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 0
     ...
     * Native name: DXGI_FORMAT_R32G32B32A32_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32G32B32A32_TYPELESS => 1

    /**
     * A four-component, 128-bit floating-point format that supports 32 bits per channel including alpha. <sup>1,5,8</sup>
     * Native name: DXGI_FORMAT_R32G32B32A32_FLOAT
     * @type {Integer (Int32)}
     */
    static R32G32B32A32_FLOAT => 2

    /**
     * A four-component, 128-bit unsigned-integer format that supports 32 bits per channel including alpha. ¹
     * Native name: DXGI_FORMAT_R32G32B32A32_UINT
     * @type {Integer (Int32)}
     */
    static R32G32B32A32_UINT => 3

    /**
     * A four-component, 128-bit signed-integer format that supports 32 bits per channel including alpha. ¹
     * Native name: DXGI_FORMAT_R32G32B32A32_SINT
     * @type {Integer (Int32)}
     */
    static R32G32B32A32_SINT => 4

    /**
     * A three-component, 96-bit typeless format that supports 32 bits per color channel.
     * Native name: DXGI_FORMAT_R32G32B32_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32G32B32_TYPELESS => 5

    /**
     * A three-component, 96-bit floating-point format that supports 32 bits per color channel.<sup>5,8</sup>
     * Native name: DXGI_FORMAT_R32G32B32_FLOAT
     * @type {Integer (Int32)}
     */
    static R32G32B32_FLOAT => 6

    /**
     * A three-component, 96-bit unsigned-integer format that supports 32 bits per color channel.
     * Native name: DXGI_FORMAT_R32G32B32_UINT
     * @type {Integer (Int32)}
     */
    static R32G32B32_UINT => 7

    /**
     * A three-component, 96-bit signed-integer format that supports 32 bits per color channel.
     * Native name: DXGI_FORMAT_R32G32B32_SINT
     * @type {Integer (Int32)}
     */
    static R32G32B32_SINT => 8

    /**
     * A four-component, 64-bit typeless format that supports 16 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R16G16B16A16_TYPELESS
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_TYPELESS => 9

    /**
     * A four-component, 64-bit floating-point format that supports 16 bits per channel including alpha.<sup>5,7</sup>
     * Native name: DXGI_FORMAT_R16G16B16A16_FLOAT
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_FLOAT => 10

    /**
     * A four-component, 64-bit unsigned-normalized-integer format that supports 16 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R16G16B16A16_UNORM
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_UNORM => 11

    /**
     * A four-component, 64-bit unsigned-integer format that supports 16 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R16G16B16A16_UINT
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_UINT => 12

    /**
     * A four-component, 64-bit signed-normalized-integer format that supports 16 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R16G16B16A16_SNORM
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_SNORM => 13

    /**
     * A four-component, 64-bit signed-integer format that supports 16 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R16G16B16A16_SINT
     * @type {Integer (Int32)}
     */
    static R16G16B16A16_SINT => 14

    /**
     * A two-component, 64-bit typeless format that supports 32 bits for the red channel and 32 bits for the green channel.
     * Native name: DXGI_FORMAT_R32G32_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32G32_TYPELESS => 15
     ...
     * Native name: DXGI_FORMAT_R32G32_FLOAT
     * @type {Integer (Int32)}
     */
    static R32G32_FLOAT => 16

    /**
     * A two-component, 64-bit unsigned-integer format that supports 32 bits for the red channel and 32 bits for the green channel.
     * Native name: DXGI_FORMAT_R32G32_UINT
     * @type {Integer (Int32)}
     */
    static R32G32_UINT => 17

    /**
     * A two-component, 64-bit signed-integer format that supports 32 bits for the red channel and 32 bits for the green channel.
     * Native name: DXGI_FORMAT_R32G32_SINT
     * @type {Integer (Int32)}
     */
    static R32G32_SINT => 18
     ...
     * Native name: DXGI_FORMAT_R32G8X24_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32G8X24_TYPELESS => 19
     ...
     * Native name: DXGI_FORMAT_D32_FLOAT_S8X24_UINT
     * @type {Integer (Int32)}
     */
    static D32_FLOAT_S8X24_UINT => 20
     ...
     * Native name: DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32_FLOAT_X8X24_TYPELESS => 21
     ...
     * Native name: DXGI_FORMAT_X32_TYPELESS_G8X24_UINT
     * @type {Integer (Int32)}
     */
    static X32_TYPELESS_G8X24_UINT => 22

    /**
     * A four-component, 32-bit typeless format that supports 10 bits for each color and 2 bits for alpha.
     * Native name: DXGI_FORMAT_R10G10B10A2_TYPELESS
     * @type {Integer (Int32)}
     */
    static R10G10B10A2_TYPELESS => 23

    /**
     * A four-component, 32-bit unsigned-normalized-integer format that supports 10 bits for each color and 2 bits for alpha.
     * Native name: DXGI_FORMAT_R10G10B10A2_UNORM
     * @type {Integer (Int32)}
     */
    static R10G10B10A2_UNORM => 24

    /**
     * A four-component, 32-bit unsigned-integer format that supports 10 bits for each color and 2 bits for alpha.
     * Native name: DXGI_FORMAT_R10G10B10A2_UINT
     * @type {Integer (Int32)}
     */
    static R10G10B10A2_UINT => 25
     ...
     * Native name: DXGI_FORMAT_R11G11B10_FLOAT
     * @type {Integer (Int32)}
     */
    static R11G11B10_FLOAT => 26

    /**
     * A four-component, 32-bit typeless format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_TYPELESS
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_TYPELESS => 27

    /**
     * A four-component, 32-bit unsigned-normalized-integer format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_UNORM
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_UNORM => 28

    /**
     * A four-component, 32-bit unsigned-normalized integer sRGB format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_UNORM_SRGB => 29

    /**
     * A four-component, 32-bit unsigned-integer format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_UINT
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_UINT => 30

    /**
     * A four-component, 32-bit signed-normalized-integer format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_SNORM
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_SNORM => 31

    /**
     * A four-component, 32-bit signed-integer format that supports 8 bits per channel including alpha.
     * Native name: DXGI_FORMAT_R8G8B8A8_SINT
     * @type {Integer (Int32)}
     */
    static R8G8B8A8_SINT => 32

    /**
     * A two-component, 32-bit typeless format that supports 16 bits for the red channel and 16 bits for the green channel.
     * Native name: DXGI_FORMAT_R16G16_TYPELESS
     * @type {Integer (Int32)}
     */
    static R16G16_TYPELESS => 33
     ...
     * Native name: DXGI_FORMAT_R16G16_FLOAT
     * @type {Integer (Int32)}
     */
    static R16G16_FLOAT => 34

    /**
     * A two-component, 32-bit unsigned-normalized-integer format that supports 16 bits each for the green and red channels.
     * Native name: DXGI_FORMAT_R16G16_UNORM
     * @type {Integer (Int32)}
     */
    static R16G16_UNORM => 35

    /**
     * A two-component, 32-bit unsigned-integer format that supports 16 bits for the red channel and 16 bits for the green channel.
     * Native name: DXGI_FORMAT_R16G16_UINT
     * @type {Integer (Int32)}
     */
    static R16G16_UINT => 36

    /**
     * A two-component, 32-bit signed-normalized-integer format that supports 16 bits for the red channel and 16 bits for the green channel.
     * Native name: DXGI_FORMAT_R16G16_SNORM
     * @type {Integer (Int32)}
     */
    static R16G16_SNORM => 37

    /**
     * A two-component, 32-bit signed-integer format that supports 16 bits for the red channel and 16 bits for the green channel.
     * Native name: DXGI_FORMAT_R16G16_SINT
     * @type {Integer (Int32)}
     */
    static R16G16_SINT => 38

    /**
     * A single-component, 32-bit typeless format that supports 32 bits for the red channel.
     * Native name: DXGI_FORMAT_R32_TYPELESS
     * @type {Integer (Int32)}
     */
    static R32_TYPELESS => 39

    /**
     * A single-component, 32-bit floating-point format that supports 32 bits for depth.<sup>5,8</sup>
     * Native name: DXGI_FORMAT_D32_FLOAT
     * @type {Integer (Int32)}
     */
    static D32_FLOAT => 40
     ...
     * Native name: DXGI_FORMAT_R32_FLOAT
     * @type {Integer (Int32)}
     */
    static R32_FLOAT => 41
     ...
     * Native name: DXGI_FORMAT_R32_UINT
     * @type {Integer (Int32)}
     */
    static R32_UINT => 42
     ...
     * Native name: DXGI_FORMAT_R32_SINT
     * @type {Integer (Int32)}
     */
    static R32_SINT => 43
     ...
     * Native name: DXGI_FORMAT_R24G8_TYPELESS
     * @type {Integer (Int32)}
     */
    static R24G8_TYPELESS => 44

    /**
     * A 32-bit z-buffer format that supports 24 bits for depth and 8 bits for stencil.
     * Native name: DXGI_FORMAT_D24_UNORM_S8_UINT
     * @type {Integer (Int32)}
     */
    static D24_UNORM_S8_UINT => 45
     ...
     * Native name: DXGI_FORMAT_R24_UNORM_X8_TYPELESS
     * @type {Integer (Int32)}
     */
    static R24_UNORM_X8_TYPELESS => 46
     ...
     * Native name: DXGI_FORMAT_X24_TYPELESS_G8_UINT
     * @type {Integer (Int32)}
     */
    static X24_TYPELESS_G8_UINT => 47

    /**
     * A two-component, 16-bit typeless format that supports 8 bits for the red channel and 8 bits for the green channel.
     * Native name: DXGI_FORMAT_R8G8_TYPELESS
     * @type {Integer (Int32)}
     */
    static R8G8_TYPELESS => 48

    /**
     * A two-component, 16-bit unsigned-normalized-integer format that supports 8 bits for the red channel and 8 bits for the green channel.
     * Native name: DXGI_FORMAT_R8G8_UNORM
     * @type {Integer (Int32)}
     */
    static R8G8_UNORM => 49

    /**
     * A two-component, 16-bit unsigned-integer format that supports 8 bits for the red channel and 8 bits for the green channel.
     * Native name: DXGI_FORMAT_R8G8_UINT
     * @type {Integer (Int32)}
     */
    static R8G8_UINT => 50
     ...
     * Native name: DXGI_FORMAT_R8G8_SNORM
     * @type {Integer (Int32)}
     */
    static R8G8_SNORM => 51

    /**
     * A two-component, 16-bit signed-integer format that supports 8 bits for the red channel and 8 bits for the green channel.
     * Native name: DXGI_FORMAT_R8G8_SINT
     * @type {Integer (Int32)}
     */
    static R8G8_SINT => 52
     ...
     * Native name: DXGI_FORMAT_D16_UNORM
     * @type {Integer (Int32)}
     */
    static D16_UNORM => 55
     ...
     * Native name: DXGI_FORMAT_R16_UNORM
     * @type {Integer (Int32)}
     */
    static R16_UNORM => 56
     ...
     * Native name: DXGI_FORMAT_R16_UINT
     * @type {Integer (Int32)}
     */
    static R16_UINT => 57
     ...
     * Native name: DXGI_FORMAT_R16_SNORM
     * @type {Integer (Int32)}
     */
    static R16_SNORM => 58
     ...
     * Native name: DXGI_FORMAT_R16_SINT
     * @type {Integer (Int32)}
     */
    static R16_SINT => 59
     ...
     * Native name: DXGI_FORMAT_R8_TYPELESS
     * @type {Integer (Int32)}
     */
    static R8_TYPELESS => 60

    /**
     * A single-component, 8-bit unsigned-normalized-integer format that supports 8 bits for the red channel.
     * Native name: DXGI_FORMAT_R8_UNORM
     * @type {Integer (Int32)}
     */
    static R8_UNORM => 61
     ...
     * Native name: DXGI_FORMAT_R8_UINT
     * @type {Integer (Int32)}
     */
    static R8_UINT => 62
     ...
     * Native name: DXGI_FORMAT_R8_SNORM
     * @type {Integer (Int32)}
     */
    static R8_SNORM => 63
     ...
     * Native name: DXGI_FORMAT_R8_SINT
     * @type {Integer (Int32)}
     */
    static R8_SINT => 64
     ...
     * Native name: DXGI_FORMAT_A8_UNORM
     * @type {Integer (Int32)}
     */
    static A8_UNORM => 65
     ...
     * Native name: DXGI_FORMAT_R1_UNORM
     * @type {Integer (Int32)}
     */
    static R1_UNORM => 66
     ...
     * Native name: DXGI_FORMAT_R9G9B9E5_SHAREDEXP
     * @type {Integer (Int32)}
     */
    static R9G9B9E5_SHAREDEXP => 67
     ...
     * 
     * Width must be even.
     * Native name: DXGI_FORMAT_R8G8_B8G8_UNORM
     * @type {Integer (Int32)}
     */
    static R8G8_B8G8_UNORM => 68
     ...
     * 
     * Width must be even.
     * Native name: DXGI_FORMAT_G8R8_G8B8_UNORM
     * @type {Integer (Int32)}
     */
    static G8R8_G8B8_UNORM => 69
     ...
     * Native name: DXGI_FORMAT_BC1_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC1_TYPELESS => 70
     ...
     * Native name: DXGI_FORMAT_BC1_UNORM
     * @type {Integer (Int32)}
     */
    static BC1_UNORM => 71
     ...
     * Native name: DXGI_FORMAT_BC1_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static BC1_UNORM_SRGB => 72

    /**
     * Four-component typeless block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC2_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC2_TYPELESS => 73

    /**
     * Four-component block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC2_UNORM
     * @type {Integer (Int32)}
     */
    static BC2_UNORM => 74
    ...
    /**
     * Four-component block-compression format for sRGB data. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC2_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static BC2_UNORM_SRGB => 75

    /**
     * Four-component typeless block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC3_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC3_TYPELESS => 76

    /**
     * Four-component block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC3_UNORM
     * @type {Integer (Int32)}
     */
    static BC3_UNORM => 77
    ...
    /**
     * Four-component block-compression format for sRGB data. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC3_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static BC3_UNORM_SRGB => 78
     ...
     * Native name: DXGI_FORMAT_BC4_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC4_TYPELESS => 79
     ...
     * Native name: DXGI_FORMAT_BC4_UNORM
     * @type {Integer (Int32)}
     */
    static BC4_UNORM => 80
    ...
    /**
     * One-component block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC4_SNORM
     * @type {Integer (Int32)}
     */
    static BC4_SNORM => 81
     ...
     * Native name: DXGI_FORMAT_BC5_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC5_TYPELESS => 82
     ...
     * Native name: DXGI_FORMAT_BC5_UNORM
     * @type {Integer (Int32)}
     */
    static BC5_UNORM => 83
    ...
    /**
     * Two-component block-compression format. For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC5_SNORM
     * @type {Integer (Int32)}
     */
    static BC5_SNORM => 84
     ...
     * Native name: DXGI_FORMAT_B5G6R5_UNORM
     * @type {Integer (Int32)}
     */
    static B5G6R5_UNORM => 85
     ...
     * 
     * <b>Direct3D 11.1:  </b>This value is not supported until Windows 8.
     * Native name: DXGI_FORMAT_B5G5R5A1_UNORM
     * @type {Integer (Int32)}
     */
    static B5G5R5A1_UNORM => 86

    /**
     * A four-component, 32-bit unsigned-normalized-integer format that supports 8 bits for each color channel and 8-bit alpha.
     * Native name: DXGI_FORMAT_B8G8R8A8_UNORM
     * @type {Integer (Int32)}
     */
    static B8G8R8A8_UNORM => 87

    /**
     * A four-component, 32-bit unsigned-normalized-integer format that supports 8 bits for each color channel and 8 bits unused.
     * Native name: DXGI_FORMAT_B8G8R8X8_UNORM
     * @type {Integer (Int32)}
     */
    static B8G8R8X8_UNORM => 88

    /**
     * A four-component, 32-bit 2.8-biased fixed-point format that supports 10 bits for each color channel and 2-bit alpha.
     * Native name: DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM
     * @type {Integer (Int32)}
     */
    static R10G10B10_XR_BIAS_A2_UNORM => 89

    /**
     * A four-component, 32-bit typeless format that supports 8 bits for each channel including alpha. ⁴
     * Native name: DXGI_FORMAT_B8G8R8A8_TYPELESS
     * @type {Integer (Int32)}
     */
    static B8G8R8A8_TYPELESS => 90

    /**
     * A four-component, 32-bit unsigned-normalized standard RGB format that supports 8 bits for each channel including alpha. ⁴
     * Native name: DXGI_FORMAT_B8G8R8A8_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static B8G8R8A8_UNORM_SRGB => 91

    /**
     * A four-component, 32-bit typeless format that supports 8 bits for each color channel, and 8 bits are unused. ⁴
     * Native name: DXGI_FORMAT_B8G8R8X8_TYPELESS
     * @type {Integer (Int32)}
     */
    static B8G8R8X8_TYPELESS => 92
     ...
     * Native name: DXGI_FORMAT_B8G8R8X8_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static B8G8R8X8_UNORM_SRGB => 93
     ...
     * Native name: DXGI_FORMAT_BC6H_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC6H_TYPELESS => 94
     ...
     * Native name: DXGI_FORMAT_BC6H_UF16
     * @type {Integer (Int32)}
     */
    static BC6H_UF16 => 95
    ...
    /**
     * A block-compression format. ⁴ For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.⁵
     * Native name: DXGI_FORMAT_BC6H_SF16
     * @type {Integer (Int32)}
     */
    static BC6H_SF16 => 96
    ...
    /**
     * A typeless block-compression format. ⁴ For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC7_TYPELESS
     * @type {Integer (Int32)}
     */
    static BC7_TYPELESS => 97

    /**
     * A block-compression format. ⁴ For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC7_UNORM
     * @type {Integer (Int32)}
     */
    static BC7_UNORM => 98
    ...
    /**
     * A block-compression format. ⁴ For information about block-compression formats, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/texture-block-compression-in-direct3d-11">Texture Block Compression in Direct3D 11</a>.
     * Native name: DXGI_FORMAT_BC7_UNORM_SRGB
     * @type {Integer (Int32)}
     */
    static BC7_UNORM_SRGB => 99
     ...
     * 
     * <b>Direct3D 11.1:  </b>This value is not supported until Windows 8.
     * Native name: DXGI_FORMAT_420_OPAQUE
     * @type {Integer (Int32)}
     */
    static 420_OPAQUE => 106
     ...
     * 
     * <b>Direct3D 11.1:  </b>This value is not supported until Windows 8.
     * Native name: DXGI_FORMAT_B4G4R4A4_UNORM
     * @type {Integer (Int32)}
     */
    static B4G4R4A4_UNORM => 115

    /**
     * A video format; an 8-bit version of a hybrid planar 4:2:2 format.
     * Native name: DXGI_FORMAT_P208
     * @type {Integer (Int32)}
     */
    static P208 => 130
     ...
     * Native name: DXGI_FORMAT_V408
     * @type {Integer (Int32)}
     */
    static V408 => 132

    /**
     * Native name: DXGI_FORMAT_SAMPLER_FEEDBACK_MIN_MIP_OPAQUE
     * @type {Integer (Int32)}
     */
    static SAMPLER_FEEDBACK_MIN_MIP_OPAQUE => 189

    /**
     * Native name: DXGI_FORMAT_SAMPLER_FEEDBACK_MIP_REGION_USED_OPAQUE
     * @type {Integer (Int32)}
     */
    static SAMPLER_FEEDBACK_MIP_REGION_USED_OPAQUE => 190

    /**
     * Native name: DXGI_FORMAT_A4B4G4R4_UNORM
     * @type {Integer (Int32)}
     */
    static A4B4G4R4_UNORM => 191
}
