 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapdecoderinfo
...
class IWICBitmapDecoderInfo extends IWICBitmapCodecInfo{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoderinfo-getpatterns
     */
    GetPatterns(cbSizePatterns, pPatterns, pcPatterns, pcbPatternsActual) {
        ...
        result := ComCall(23, this, "uint", cbSizePatterns, "ptr", pPatterns, pcPatternsMarshal, pcPatterns, pcbPatternsActualMarshal, pcbPatternsActual, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoderinfo-matchespattern
     */
    MatchesPattern(pIStream) {
        result := ComCall(24, this, "ptr", pIStream, "int*", &pfMatches := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IWICBitmapDecoder>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwicbitmapdecoder">IWICBitmapDecoder</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoderinfo-createinstance
     */
    CreateInstance() {
        result := ComCall(25, this, "ptr*", &ppIBitmapDecoder := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppIBitmapDecoder
    }
}
