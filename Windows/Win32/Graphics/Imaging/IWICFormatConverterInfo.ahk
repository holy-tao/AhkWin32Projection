 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicformatconverterinfo
...
class IWICFormatConverterInfo extends IWICComponentInfo{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicformatconverterinfo-getpixelformats
     */
    GetPixelFormats(cFormats, pPixelFormatGUIDs) {
        result := ComCall(11, this, "uint", cFormats, "ptr", pPixelFormatGUIDs, "uint*", &pcActual := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicformatconverterinfo-createinstance
     */
    CreateInstance() {
        result := ComCall(12, this, "ptr*", &ppIConverter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
