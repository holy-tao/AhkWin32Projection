 ...
 */
export default struct IWICFormatConverterInfo extends IWICComponentInfo {
    /**
     ...
     * used for IWICFormatConverterInfo interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWICFormatConverterInfo.Vtbl()
        }
