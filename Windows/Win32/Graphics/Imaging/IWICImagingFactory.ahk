...
class IWICImagingFactory extends IUnknown{
    ...
    CreateDecoderFromFilename(wzFilename, pguidVendor, dwDesiredAccess, metadataOptions, ppIDecoder) {
        ...
        result := ComCall(3, this, "ptr", wzFilename, "ptr", pguidVendor, "uint", dwDesiredAccess, "int", metadataOptions, "ptr", ppIDecoder, "int")
        if(result != 0)
    ...
    CreateDecoderFromStream(pIStream, pguidVendor, metadataOptions, ppIDecoder) {
        result := ComCall(4, this, "ptr", pIStream, "ptr", pguidVendor, "int", metadataOptions, "ptr", ppIDecoder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDecoderFromFileHandle(hFile, pguidVendor, metadataOptions, ppIDecoder) {
        result := ComCall(5, this, "ptr", hFile, "ptr", pguidVendor, "int", metadataOptions, "ptr", ppIDecoder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateComponentInfo(clsidComponent, ppIInfo) {
        result := ComCall(6, this, "ptr", clsidComponent, "ptr", ppIInfo, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDecoder(guidContainerFormat, pguidVendor, ppIDecoder) {
        result := ComCall(7, this, "ptr", guidContainerFormat, "ptr", pguidVendor, "ptr", ppIDecoder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateEncoder(guidContainerFormat, pguidVendor, ppIEncoder) {
        result := ComCall(8, this, "ptr", guidContainerFormat, "ptr", pguidVendor, "ptr", ppIEncoder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreatePalette(ppIPalette) {
        result := ComCall(9, this, "ptr", ppIPalette, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateFormatConverter(ppIFormatConverter) {
        result := ComCall(10, this, "ptr", ppIFormatConverter, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapScaler(ppIBitmapScaler) {
        result := ComCall(11, this, "ptr", ppIBitmapScaler, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapClipper(ppIBitmapClipper) {
        result := ComCall(12, this, "ptr", ppIBitmapClipper, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapFlipRotator(ppIBitmapFlipRotator) {
        result := ComCall(13, this, "ptr", ppIBitmapFlipRotator, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateStream(ppIWICStream) {
        result := ComCall(14, this, "ptr", ppIWICStream, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateColorContext(ppIWICColorContext) {
        result := ComCall(15, this, "ptr", ppIWICColorContext, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateColorTransformer(ppIWICColorTransform) {
        result := ComCall(16, this, "ptr", ppIWICColorTransform, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmap(uiWidth, uiHeight, pixelFormat, option, ppIBitmap) {
        result := ComCall(17, this, "uint", uiWidth, "uint", uiHeight, "ptr", pixelFormat, "int", option, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IWICBitmapSource>} pIBitmapSource 
     * @param {Integer} option 
     * @param {Pointer<IWICBitmap>} ppIBitmap 
     * @returns {HRESULT} 
     */
    CreateBitmapFromSource(pIBitmapSource, option, ppIBitmap) {
        result := ComCall(18, this, "ptr", pIBitmapSource, "int", option, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapFromSourceRect(pIBitmapSource, x, y, width, height, ppIBitmap) {
        result := ComCall(19, this, "ptr", pIBitmapSource, "uint", x, "uint", y, "uint", width, "uint", height, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapFromMemory(uiWidth, uiHeight, pixelFormat, cbStride, cbBufferSize, pbBuffer, ppIBitmap) {
        result := ComCall(20, this, "uint", uiWidth, "uint", uiHeight, "ptr", pixelFormat, "uint", cbStride, "uint", cbBufferSize, "char*", pbBuffer, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapFromHBITMAP(hBitmap, hPalette, options, ppIBitmap) {
        ...
        result := ComCall(21, this, "ptr", hBitmap, "ptr", hPalette, "int", options, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateBitmapFromHICON(hIcon, ppIBitmap) {
        ...
        result := ComCall(22, this, "ptr", hIcon, "ptr", ppIBitmap, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateComponentEnumerator(componentTypes, options, ppIEnumUnknown) {
        result := ComCall(23, this, "uint", componentTypes, "uint", options, "ptr", ppIEnumUnknown, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IWICBitmapFrameDecode>} pIFrameDecoder 
     * @param {Pointer<IWICFastMetadataEncoder>} ppIFastEncoder 
     * @returns {HRESULT} 
     */
    CreateFastMetadataEncoderFromFrameDecode(pIFrameDecoder, ppIFastEncoder) {
        result := ComCall(25, this, "ptr", pIFrameDecoder, "ptr", ppIFastEncoder, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateQueryWriter(guidMetadataFormat, pguidVendor, ppIQueryWriter) {
        result := ComCall(26, this, "ptr", guidMetadataFormat, "ptr", pguidVendor, "ptr", ppIQueryWriter, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IWICMetadataQueryReader>} pIQueryReader 
     * @param {Pointer<Guid>} pguidVendor 
     * @param {Pointer<IWICMetadataQueryWriter>} ppIQueryWriter 
     * @returns {HRESULT} 
     */
    CreateQueryWriterFromReader(pIQueryReader, pguidVendor, ppIQueryWriter) {
        result := ComCall(27, this, "ptr", pIQueryReader, "ptr", pguidVendor, "ptr", ppIQueryWriter, "int")
        if(result != 0)
            throw OSError(result)
