 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapencoderinfo
...
class IWICBitmapEncoderInfo extends IWICBitmapCodecInfo{
     ...
     * @returns {Pointer<IWICBitmapEncoder>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwicbitmapencoder">IWICBitmapEncoder</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoderinfo-createinstance
     */
    CreateInstance() {
        result := ComCall(23, this, "ptr*", &ppIBitmapEncoder := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppIBitmapEncoder
    }
}
