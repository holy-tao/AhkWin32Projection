 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapencoder
...
class IWICBitmapEncoder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-initialize
     */
    Initialize(pIStream, cacheOption) {
        result := ComCall(3, this, "ptr", pIStream, "int", cacheOption, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-getcontainerformat
     */
    GetContainerFormat() {
        pguidContainerFormat := Guid()
        result := ComCall(4, this, "ptr", pguidContainerFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-getencoderinfo
     */
    GetEncoderInfo() {
        result := ComCall(5, this, "ptr*", &ppIEncoderInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-setcolorcontexts
     */
    SetColorContexts(cCount, ppIColorContext) {
        result := ComCall(6, this, "uint", cCount, "ptr*", ppIColorContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-setpalette
     */
     ...
     * 
     * Returns WINCODEC_ERR_UNSUPPORTEDOPERATION if the feature is not supported by the encoder.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-setthumbnail
     */
    SetThumbnail(pIThumbnail) {
        result := ComCall(8, this, "ptr", pIThumbnail, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns WINCODEC_ERR_UNSUPPORTEDOPERATION if the feature is not supported by the encoder.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-setpreview
     */
    SetPreview(pIPreview) {
        result := ComCall(9, this, "ptr", pIPreview, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-createnewframe
     */
    CreateNewFrame(ppIEncoderOptions) {
        result := ComCall(10, this, "ptr*", &ppIFrameEncode := 0, "ptr*", ppIEncoderOptions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-commit
     */
    Commit() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapencoder-getmetadataquerywriter
     */
    GetMetadataQueryWriter() {
        result := ComCall(12, this, "ptr*", &ppIMetadataQueryWriter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
