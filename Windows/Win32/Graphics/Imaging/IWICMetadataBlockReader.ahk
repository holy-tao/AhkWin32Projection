 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nn-wincodecsdk-iwicmetadatablockreader
...
class IWICMetadataBlockReader extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatablockreader-getcontainerformat
     */
    GetContainerFormat() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatablockreader-getcount
     */
    GetCount() {
        result := ComCall(4, this, "uint*", &pcCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatablockreader-getreaderbyindex
     */
    GetReaderByIndex(nIndex) {
        result := ComCall(5, this, "uint", nIndex, "ptr*", &ppIMetadataReader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatablockreader-getenumerator
     */
    GetEnumerator() {
        result := ComCall(6, this, "ptr*", &ppIEnumMetadata := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
