 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapfliprotator
...
class IWICBitmapFlipRotator extends IWICBitmapSource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapfliprotator-initialize
     */
    Initialize(pISource, options) {
        result := ComCall(8, this, "ptr", pISource, "int", options, "int")
        if(result != 0) {
