 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nn-wincodecsdk-iwicmetadatareader
...
class IWICMetadataReader extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getmetadataformat
     */
    GetMetadataFormat() {
        pguidMetadataFormat := Guid()
        result := ComCall(3, this, "ptr", pguidMetadataFormat, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getmetadatahandlerinfo
     */
    GetMetadataHandlerInfo() {
        result := ComCall(4, this, "ptr*", &ppIHandler := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getcount
     */
    GetCount() {
        result := ComCall(5, this, "uint*", &pcCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getvaluebyindex
     */
    GetValueByIndex(nIndex, pvarSchema, pvarId, pvarValue) {
        result := ComCall(6, this, "uint", nIndex, "ptr", pvarSchema, "ptr", pvarId, "ptr", pvarValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getvalue
     */
    GetValue(pvarSchema, pvarId, pvarValue) {
        result := ComCall(7, this, "ptr", pvarSchema, "ptr", pvarId, "ptr", pvarValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodecsdk/nf-wincodecsdk-iwicmetadatareader-getenumerator
     */
    GetEnumerator() {
        result := ComCall(8, this, "ptr*", &ppIEnumMetadata := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
