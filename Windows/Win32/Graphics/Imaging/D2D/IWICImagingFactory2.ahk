 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicimagingfactory2
...
class IWICImagingFactory2 extends IWICImagingFactory{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicimagingfactory2-createimageencoder
     */
    CreateImageEncoder(pD2DDevice) {
        result := ComCall(28, this, "ptr", pD2DDevice, "ptr*", &ppWICImageEncoder := 0, "int")
        if(result != 0) {
