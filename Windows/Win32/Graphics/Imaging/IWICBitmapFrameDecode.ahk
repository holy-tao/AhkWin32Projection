 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapframedecode
...
class IWICBitmapFrameDecode extends IWICBitmapSource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframedecode-getmetadataqueryreader
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframedecode-getcolorcontexts
     */
    GetColorContexts(cCount, ppIColorContexts) {
        result := ComCall(9, this, "uint", cCount, "ptr*", ppIColorContexts, "uint*", &pcActualCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframedecode-getthumbnail
     */
    GetThumbnail() {
        result := ComCall(10, this, "ptr*", &ppIThumbnail := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
