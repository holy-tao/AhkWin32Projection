 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicjpegframedecode
...
class IWICJpegFrameDecode extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-doessupportindexing
     */
    DoesSupportIndexing() {
        result := ComCall(3, this, "int*", &pfIndexingSupported := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-setindexing
     */
     ...
     * 
     * Returns S_OK upon successful completion.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-clearindexing
     */
    ClearIndexing() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-getachuffmantable
     */
     ...
     * 
     * A pointer that receives the table data. This parameter must not be NULL.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-getdchuffmantable
     */
     ...
     * 
     * A pointer that receives the table data. This parameter must not be NULL.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-getquantizationtable
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-getframeheader
     */
    GetFrameHeader() {
     ...
     * 
     * A pointer that receives the frame header data.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-getscanheader
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicjpegframedecode-copyscan
     */
    CopyScan(scanIndex, scanOffset, cbScanData, pbScanData, pcbScanDataActual) {
        ...
        result := ComCall(11, this, "uint", scanIndex, "uint", scanOffset, "uint", cbScanData, pbScanDataMarshal, pbScanData, pcbScanDataActualMarshal, pcbScanDataActual, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    CopyMinimalStream(streamOffset, cbStreamData, pbStreamData, pcbStreamDataActual) {
        ...
        result := ComCall(12, this, "uint", streamOffset, "uint", cbStreamData, pbStreamDataMarshal, pbStreamData, pcbStreamDataActualMarshal, pcbStreamDataActual, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
