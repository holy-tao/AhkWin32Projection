 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapdecoder
...
class IWICBitmapDecoder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-querycapability
     */
    QueryCapability(pIStream) {
        result := ComCall(3, this, "ptr", pIStream, "uint*", &pdwCapability := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-initialize
     */
    Initialize(pIStream, cacheOptions) {
        result := ComCall(4, this, "ptr", pIStream, "int", cacheOptions, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getcontainerformat
     */
    GetContainerFormat() {
        pguidContainerFormat := Guid()
        result := ComCall(5, this, "ptr", pguidContainerFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getdecoderinfo
     */
    GetDecoderInfo() {
        result := ComCall(6, this, "ptr*", &ppIDecoderInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-copypalette
     */
    CopyPalette(pIPalette) {
        result := ComCall(7, this, "ptr", pIPalette, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getmetadataqueryreader
     */
    GetMetadataQueryReader() {
        result := ComCall(8, this, "ptr*", &ppIMetadataQueryReader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getpreview
     */
    GetPreview() {
        result := ComCall(9, this, "ptr*", &ppIBitmapSource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getcolorcontexts
     */
    GetColorContexts(cCount, ppIColorContexts) {
        result := ComCall(10, this, "uint", cCount, "ptr*", ppIColorContexts, "uint*", &pcActualCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getthumbnail
     */
    GetThumbnail() {
        result := ComCall(11, this, "ptr*", &ppIThumbnail := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getframecount
     */
    GetFrameCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapdecoder-getframe
     */
    GetFrame(index) {
        result := ComCall(13, this, "uint", index, "ptr*", &ppIBitmapFrame := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
