 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicplanarbitmapframeencode
...
class IWICPlanarBitmapFrameEncode extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicplanarbitmapframeencode-writepixels
     */
     ...
     * 
     * If the <a href="https://docs.microsoft.com/windows/desktop/api/wincodec/nn-wincodec-iwicbitmapsource">IWICBitmapSource</a> format does not meet the encoder requirements, this method fails with <b>WINCODEC_ERR_UNSUPPORTEDPIXELFORMAT</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicplanarbitmapframeencode-writesource
     */
