 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicddsdecoder
...
class IWICDdsDecoder extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicddsdecoder-getparameters
     */
    GetParameters() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicddsdecoder-getframe
     */
    GetFrame(arrayIndex, mipLevel, sliceIndex) {
        result := ComCall(4, this, "uint", arrayIndex, "uint", mipLevel, "uint", sliceIndex, "ptr*", &ppIBitmapFrame := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
