 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicpalette
...
class IWICPalette extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-initializepredefined
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-initializecustom
     */
    InitializeCustom(pColors, cCount) {
        pColorsMarshal := pColors is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, pColorsMarshal, pColors, "uint", cCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-initializefrombitmap
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-initializefrompalette
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-gettype
     */
    GetType() {
        result := ComCall(7, this, "int*", &pePaletteType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-getcolorcount
     */
    GetColorCount() {
        result := ComCall(8, this, "uint*", &pcCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-getcolors
     */
    GetColors(cCount, pColors, pcActualColors) {
        pColorsMarshal := pColors is VarRef ? "uint*" : "ptr"
        pcActualColorsMarshal := pcActualColors is VarRef ? "uint*" : "ptr"

        result := ComCall(9, this, "uint", cCount, pColorsMarshal, pColors, pcActualColorsMarshal, pcActualColors, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-isblackwhite
     */
    IsBlackWhite() {
        result := ComCall(10, this, "int*", &pfIsBlackWhite := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-isgrayscale
     */
    IsGrayscale() {
        result := ComCall(11, this, "int*", &pfIsGrayscale := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicpalette-hasalpha
     */
    HasAlpha() {
        result := ComCall(12, this, "int*", &pfHasAlpha := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
