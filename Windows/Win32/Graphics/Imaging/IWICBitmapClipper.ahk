 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapclipper
...
class IWICBitmapClipper extends IWICBitmapSource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapclipper-initialize
     */
    Initialize(pISource, prc) {
        result := ComCall(8, this, "ptr", pISource, "ptr", prc, "int")
        if(result != 0) {
