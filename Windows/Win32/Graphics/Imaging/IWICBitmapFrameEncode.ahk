 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapframeencode
...
class IWICBitmapFrameEncode extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-initialize
     */
    Initialize(pIEncoderOptions) {
        result := ComCall(3, this, "ptr", pIEncoderOptions, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setsize
     */
    SetSize(uiWidth, uiHeight) {
        result := ComCall(4, this, "uint", uiWidth, "uint", uiHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setresolution
     */
    SetResolution(dpiX, dpiY) {
        result := ComCall(5, this, "double", dpiX, "double", dpiY, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setpixelformat
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setcolorcontexts
     */
    SetColorContexts(cCount, ppIColorContext) {
        result := ComCall(7, this, "uint", cCount, "ptr*", ppIColorContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setpalette
     */
    SetPalette(pIPalette) {
        result := ComCall(8, this, "ptr", pIPalette, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-setthumbnail
     */
    SetThumbnail(pIThumbnail) {
        result := ComCall(9, this, "ptr", pIThumbnail, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-writepixels
     */
    WritePixels(lineCount, cbStride, cbBufferSize, pbPixels) {
        pbPixelsMarshal := pbPixels is VarRef ? "char*" : "ptr"

        result := ComCall(10, this, "uint", lineCount, "uint", cbStride, "uint", cbBufferSize, pbPixelsMarshal, pbPixels, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-writesource
     */
    WriteSource(pIBitmapSource, prc) {
        result := ComCall(11, this, "ptr", pIBitmapSource, "ptr", prc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-commit
     */
    Commit() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapframeencode-getmetadataquerywriter
     */
    GetMetadataQueryWriter() {
        result := ComCall(13, this, "ptr*", &ppIMetadataQueryWriter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
