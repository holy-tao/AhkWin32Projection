 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapcodecprogressnotification
...
class IWICBitmapCodecProgressNotification extends IUnknown{
     ...
     * @param {Pointer<PFNProgressNotification>} pfnProgressNotification_ Type: <b>PFNProgressNotification</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapcodecprogressnotification-registerprogressnotification
     */
    RegisterProgressNotification(pfnProgressNotification_, pvData, dwProgressFlags) {
        pvDataMarshal := pvData is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", pfnProgressNotification_, pvDataMarshal, pvData, "uint", dwProgressFlags, "int")
        if(result != 0) {
