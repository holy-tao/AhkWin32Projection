 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nn-wincodec-iwicbitmapsourcetransform
...
class IWICBitmapSourceTransform extends IUnknown{
     ...
     * 
     * The output buffer.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapsourcetransform-copypixels
     */
    CopyPixels(prc, uiWidth, uiHeight, pguidDstFormat, dstTransform, nStride, cbBufferSize) {
        result := ComCall(3, this, "ptr", prc, "uint", uiWidth, "uint", uiHeight, "ptr", pguidDstFormat, "int", dstTransform, "uint", nStride, "uint", cbBufferSize, "char*", &pbBuffer := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapsourcetransform-getclosestsize
     */
    GetClosestSize(puiWidth, puiHeight) {
        ...
        result := ComCall(4, this, puiWidthMarshal, puiWidth, puiHeightMarshal, puiHeight, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapsourcetransform-getclosestpixelformat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wincodec/nf-wincodec-iwicbitmapsourcetransform-doessupporttransform
     */
    DoesSupportTransform(dstTransform) {
        result := ComCall(6, this, "int", dstTransform, "int*", &pfIsSupported := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
