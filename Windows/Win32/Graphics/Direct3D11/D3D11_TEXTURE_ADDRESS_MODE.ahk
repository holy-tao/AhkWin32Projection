 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/ne-d3d11-d3d11_texture_address_mode
 * @namespace Windows.Win32.Graphics.Direct3D11
 * @version v4.0.30319
 */
class D3D11_TEXTURE_ADDRESS_MODE extends Win32Enum{

    /**
     * Tile the texture at every (u,v) integer junction. For example, for u values between 0 and 3, the texture is repeated three times.
     * @type {Integer (Int32)}
     */
    static D3D11_TEXTURE_ADDRESS_WRAP => 1
     ...
     * @type {Integer (Int32)}
     */
    static D3D11_TEXTURE_ADDRESS_MIRROR => 2

    /**
     * Texture coordinates outside the range [0.0, 1.0] are set to the texture color at 0.0 or 1.0, respectively.
     * @type {Integer (Int32)}
     */
    static D3D11_TEXTURE_ADDRESS_CLAMP => 3
     ...
     * @type {Integer (Int32)}
     */
    static D3D11_TEXTURE_ADDRESS_BORDER => 4
     ...
     * @type {Integer (Int32)}
     */
    static D3D11_TEXTURE_ADDRESS_MIRROR_ONCE => 5
}
