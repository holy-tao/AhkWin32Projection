 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nn-d3d11shader-id3d11shaderreflectionconstantbuffer
...
class ID3D11ShaderReflectionConstantBuffer extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectionconstantbuffer-getdesc
     */
    GetDesc(pDesc) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectionconstantbuffer-getvariablebyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectionconstantbuffer-getvariablebyname
     */
