 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11videodevice
...
class ID3D11VideoDevice extends IUnknown{
     ...
     * @returns {Pointer<ID3D11VideoDecoder>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11videodecoder">ID3D11VideoDecoder</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-createvideodecoder
     */
    CreateVideoDecoder(pVideoDesc, pConfig) {
        result := ComCall(3, this, "ptr", pVideoDesc, "ptr", pConfig, "ptr*", &ppDecoder := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<ID3D11VideoProcessor>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11videoprocessor">ID3D11VideoProcessor</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-createvideoprocessor
     */
    CreateVideoProcessor(pEnum, RateConversionIndex) {
        result := ComCall(4, this, "ptr", pEnum, "uint", RateConversionIndex, "ptr*", &ppVideoProcessor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} ChannelType_ Specifies the type of channel, as a member of the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_authenticated_channel_type">D3D11_AUTHENTICATED_CHANNEL_TYPE</a> enumeration.
     * @returns {Pointer<ID3D11AuthenticatedChannel>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11authenticatedchannel">ID3D11AuthenticatedChannel</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-createauthenticatedchannel
     */
    CreateAuthenticatedChannel(ChannelType_) {
        result := ComCall(5, this, "int", ChannelType_, "ptr*", &ppAuthenticatedChannel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppAuthenticatedChannel
    }
     ...
     * </tr>
     * </table>
     * @returns {Pointer<ID3D11CryptoSession>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11cryptosession">ID3D11CryptoSession</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-createcryptosession
     */
    CreateCryptoSession(pCryptoType, pDecoderProfile, pKeyExchangeType) {
        result := ComCall(6, this, "ptr", pCryptoType, "ptr", pDecoderProfile, "ptr", pKeyExchangeType, "ptr*", &ppCryptoSession := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppCryptoSession
    }
     ...
     * @returns {Pointer<ID3D11VideoProcessorEnumerator>} Receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11videoprocessorenumerator">ID3D11VideoProcessorEnumerator</a> interface. The caller must release the interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-createvideoprocessorenumerator
     */
    CreateVideoProcessorEnumerator(pDesc) {
        result := ComCall(10, this, "ptr", pDesc, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-getvideodecoderprofilecount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-getvideodecoderprofile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-checkvideodecoderformat
     */
    CheckVideoDecoderFormat(pDecoderProfile, Format) {
        result := ComCall(13, this, "ptr", pDecoderProfile, "int", Format, "int*", &pSupported := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-getvideodecoderconfigcount
     */
    GetVideoDecoderConfigCount(pDesc) {
        result := ComCall(14, this, "ptr", pDesc, "uint*", &pCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-getvideodecoderconfig
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-getcontentprotectioncaps
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-checkcryptokeyexchange
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-setprivatedata
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodevice-setprivatedatainterface
     */
