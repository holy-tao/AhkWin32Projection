 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/ns-d3d11-d3d11_authenticated_configure_protection_input
    ...
    Protections{
        get {
            if(!this.HasProp("__Protections"))
                this.__Protections := D3D11_AUTHENTICATED_PROTECTION_FLAGS(40, this)
