 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/nn-d3d11-id3d11hullshader
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
export default struct ID3D11HullShader extends ID3D11DeviceChild {
    /**
     ...
     * used for ID3D11HullShader interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D11HullShader.Vtbl()
        }
        super.__New(implObj, flags)
    }

    Query(iid) {
        if (ID3D11HullShader.IID.Equals(iid)) {
            return true
        }
