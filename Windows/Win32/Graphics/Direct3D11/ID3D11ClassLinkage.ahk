 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11classlinkage
...
class ID3D11ClassLinkage extends ID3D11DeviceChild{
     ...
     * @returns {Pointer<ID3D11ClassInstance>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classinstance">ID3D11ClassInstance</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11classlinkage-getclassinstance
     */
    GetClassInstance(pClassInstanceName, InstanceIndex) {
        ...
        result := ComCall(7, this, "ptr", pClassInstanceName, "uint", InstanceIndex, "ptr*", &ppInstance := 0, "int")
        if(result != 0) {
     ...
     * 
     * The address of a pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classinstance">ID3D11ClassInstance</a> interface to initialize.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11classlinkage-createclassinstance
     */
    CreateClassInstance(pClassTypeName, ConstantBufferOffset, ConstantVectorOffset, TextureOffset, SamplerOffset) {
        ...
        result := ComCall(8, this, "ptr", pClassTypeName, "uint", ConstantBufferOffset, "uint", ConstantVectorOffset, "uint", TextureOffset, "uint", SamplerOffset, "ptr*", &ppInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
