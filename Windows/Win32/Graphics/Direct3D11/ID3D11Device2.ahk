 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_2/nn-d3d11_2-id3d11device2
...
class ID3D11Device2 extends ID3D11Device1{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_2/nf-d3d11_2-id3d11device2-getimmediatecontext2
     */
     ...
     *             Pass 0.
     * @returns {Pointer<ID3D11DeviceContext2>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_2/nn-d3d11_2-id3d11devicecontext2">ID3D11DeviceContext2</a>**</b>
     * 
     * Upon completion of the method, the passed pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/d3d11_2/nn-d3d11_2-id3d11devicecontext2">ID3D11DeviceContext2</a> interface pointer is initialized.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_2/nf-d3d11_2-id3d11device2-createdeferredcontext2
     */
    CreateDeferredContext2(ContextFlags) {
        result := ComCall(51, this, "uint", ContextFlags, "ptr*", &ppDeferredContext := 0, "int")
        if(result != 0) {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_2/nf-d3d11_2-id3d11device2-getresourcetiling
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_2/nf-d3d11_2-id3d11device2-checkmultisamplequalitylevels1
     */
    CheckMultisampleQualityLevels1(Format, SampleCount, Flags) {
        result := ComCall(53, this, "int", Format, "uint", SampleCount, "uint", Flags, "uint*", &pNumQualityLevels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
