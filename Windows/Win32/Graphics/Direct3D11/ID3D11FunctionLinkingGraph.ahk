 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nn-d3d11shader-id3d11functionlinkinggraph
...
class ID3D11FunctionLinkingGraph extends IUnknown{
     ...
     * @param {Pointer<Pointer<ID3D11ModuleInstance>>} ppModuleInstance Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11shader/nn-d3d11shader-id3d11moduleinstance">ID3D11ModuleInstance</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-createmoduleinstance
     */
    CreateModuleInstance(ppModuleInstance, ppErrorBuffer) {
        result := ComCall(3, this, "ptr*", ppModuleInstance, "ptr*", ppErrorBuffer, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<ID3D11LinkingNode>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11shader/nn-d3d11shader-id3d11linkingnode">ID3D11LinkingNode</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-setinputsignature
     */
    SetInputSignature(pInputParameters, cInputParameters) {
        result := ComCall(4, this, "ptr", pInputParameters, "uint", cInputParameters, "ptr*", &ppInputNode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-setoutputsignature
     */
    SetOutputSignature(pOutputParameters, cOutputParameters) {
        result := ComCall(5, this, "ptr", pOutputParameters, "uint", cOutputParameters, "ptr*", &ppOutputNode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-callfunction
     */
    CallFunction(pModuleInstanceNamespace, pModuleWithFunctionPrototype, pFunctionName) {
        ...
        result := ComCall(6, this, "ptr", pModuleInstanceNamespace, "ptr", pModuleWithFunctionPrototype, "ptr", pFunctionName, "ptr*", &ppCallNode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns S_OK if successful; otherwise, returns one of the <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-passvalue
     */
    PassValue(pSrcNode, SrcParameterIndex, pDstNode, DstParameterIndex) {
        result := ComCall(7, this, "ptr", pSrcNode, "int", SrcParameterIndex, "ptr", pDstNode, "int", DstParameterIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns S_OK if successful; otherwise, returns one of the <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-passvaluewithswizzle
     */
    PassValueWithSwizzle(pSrcNode, SrcParameterIndex, pSrcSwizzle, pDstNode, DstParameterIndex, pDstSwizzle) {
        ...
        result := ComCall(8, this, "ptr", pSrcNode, "int", SrcParameterIndex, "ptr", pSrcSwizzle, "ptr", pDstNode, "int", DstParameterIndex, "ptr", pDstSwizzle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-getlasterror
     */
    GetLastError() {
        result := ComCall(9, this, "ptr*", &ppErrorBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Reserved
     * @returns {Pointer<ID3DBlob>} Type: <b><a href="https://docs.microsoft.com/previous-versions/windows/desktop/legacy/ff728743(v=vs.85)">ID3DBlob</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11functionlinkinggraph-generatehlsl
     */
    GenerateHlsl(uFlags) {
        result := ComCall(10, this, "uint", uFlags, "ptr*", &ppBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
