 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11authenticatedchannel
...
class ID3D11AuthenticatedChannel extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11authenticatedchannel-getcertificatesize
     */
    GetCertificateSize() {
        result := ComCall(7, this, "uint*", &pCertificateSize := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11authenticatedchannel-getcertificate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11authenticatedchannel-getchannelhandle
     */
