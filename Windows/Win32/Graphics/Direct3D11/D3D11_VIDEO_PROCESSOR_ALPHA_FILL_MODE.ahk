 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_video_processor_alpha_fill_mode
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
class D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE extends Win32Enum {

    /**
     * Alpha values inside the target rectangle are set to opaque.
     * Native name: D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE_OPAQUE
     * @type {Integer (Int32)}
     */
    static OPAQUE => 0
     ...
     * Native name: D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE_BACKGROUND
     * @type {Integer (Int32)}
     */
    static BACKGROUND => 1
     ...
     * Native name: D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE_DESTINATION
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE_SOURCE_STREAM
     * @type {Integer (Int32)}
     */
