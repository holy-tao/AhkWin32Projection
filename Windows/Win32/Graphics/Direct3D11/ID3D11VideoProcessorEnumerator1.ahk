 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nn-d3d11_1-id3d11videoprocessorenumerator1
...
class ID3D11VideoProcessorEnumerator1 extends ID3D11VideoProcessorEnumerator{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nf-d3d11_1-id3d11videoprocessorenumerator1-checkvideoprocessorformatconversion
     */
    CheckVideoProcessorFormatConversion(InputFormat, InputColorSpace, OutputFormat, OutputColorSpace) {
        result := ComCall(13, this, "int", InputFormat, "int", InputColorSpace, "int", OutputFormat, "int", OutputColorSpace, "int*", &pSupported := 0, "int")
        if(result != 0) {
