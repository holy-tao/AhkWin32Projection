 ...
 * 
 * 
 * @see https://docs.microsoft.com/windows/win32/api//d3d11/nn-d3d11-id3d11texture3d
...
class ID3D11Texture3D extends ID3D11Resource{
     ...
     * @see https://docs.microsoft.com/windows/win32/api//d3d11/nf-d3d11-id3d11texture3d-getdesc
     */
    GetDesc(pDesc) {
