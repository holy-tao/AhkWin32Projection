 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11_1/nn-d3d11_1-id3d11rasterizerstate1
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
export default struct ID3D11RasterizerState1 extends ID3D11RasterizerState {
    /**
     ...
     * used for ID3D11RasterizerState1 interfaces
    */
    struct Vtbl extends ID3D11RasterizerState.Vtbl {
        GetDesc1 : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D11RasterizerState1.Vtbl()
        }
