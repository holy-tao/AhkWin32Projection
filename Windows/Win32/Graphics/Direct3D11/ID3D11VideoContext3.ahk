...
class ID3D11VideoContext3 extends ID3D11VideoContext2{
     ...
     * @param {Pointer<UInt32>} pHistogramOffsets 
    ...
    DecoderBeginFrame1(pDecoder, pView, ContentKeySize, pContentKey, NumComponentHistograms, pHistogramOffsets, ppHistogramBuffers) {
        result := ComCall(83, this, "ptr", pDecoder, "ptr", pView, "uint", ContentKeySize, "ptr", pContentKey, "uint", NumComponentHistograms, "uint*", pHistogramOffsets, "ptr", ppHistogramBuffers, "int")
        if(result != 0)
