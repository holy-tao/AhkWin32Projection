...
class D3D11_CREATE_DEVICE_FLAG extends Win32BitflagEnum {
     ...
     * Native name: D3D11_CREATE_DEVICE_SINGLETHREADED
     * @type {Integer (UInt32)}
     */
     ...
     * Native name: D3D11_CREATE_DEVICE_DEBUG
     * @type {Integer (UInt32)}
     */
    static DEBUG => 2
     ...
     * <div> </div>
     * Native name: D3D11_CREATE_DEVICE_SWITCH_TO_REF
     * @type {Integer (UInt32)}
     */
     ...
     * Native name: D3D11_CREATE_DEVICE_PREVENT_INTERNAL_THREADING_OPTIMIZATIONS
     * @type {Integer (UInt32)}
     */
     ...
     * <div> </div>
     * Native name: D3D11_CREATE_DEVICE_BGRA_SUPPORT
     * @type {Integer (UInt32)}
     */
     ...
     * Native name: D3D11_CREATE_DEVICE_DEBUGGABLE
     * @type {Integer (UInt32)}
     */
    static DEBUGGABLE => 64
     ...
     * 
     * <b>Direct3D 11:  </b>This value is not supported until Direct3D 11.1.
     * Native name: D3D11_CREATE_DEVICE_PREVENT_ALTERING_LAYER_SETTINGS_FROM_REGISTRY
     * @type {Integer (UInt32)}
     */
     ...
     * 
     * <b>Direct3D 11:  </b>This value is not supported until Direct3D 11.1.
     * Native name: D3D11_CREATE_DEVICE_DISABLE_GPU_TIMEOUT
     * @type {Integer (UInt32)}
     */
    static DISABLE_GPU_TIMEOUT => 256
     ...
     * 
     * <b>Direct3D 11:  </b>This value is not supported until Direct3D 11.1.
     * Native name: D3D11_CREATE_DEVICE_VIDEO_SUPPORT
     * @type {Integer (UInt32)}
     */
    static VIDEO_SUPPORT => 2048
}
