 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/ne-d3d11-d3d11_blend_op
...
class D3D11_BLEND_OP extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static D3D11_BLEND_OP_ADD => 1

    /**
     * Subtract source 1 from source 2.
     * @type {Integer (Int32)}
     */
    static D3D11_BLEND_OP_SUBTRACT => 2

    /**
     * Subtract source 2 from source 1.
     * @type {Integer (Int32)}
     */
    static D3D11_BLEND_OP_REV_SUBTRACT => 3

    /**
     * Find the minimum of source 1 and source 2.
     * @type {Integer (Int32)}
     */
    static D3D11_BLEND_OP_MIN => 4

    /**
     * Find the maximum of source 1 and source 2.
     * @type {Integer (Int32)}
     */
    static D3D11_BLEND_OP_MAX => 5
}
