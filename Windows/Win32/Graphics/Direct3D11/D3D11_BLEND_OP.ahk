 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_blend_op
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
class D3D11_BLEND_OP extends Win32Enum {

    /**
     * Add source 1 and source 2.
     * Native name: D3D11_BLEND_OP_ADD
     * @type {Integer (Int32)}
     */
    static ADD => 1
     ...
     * Native name: D3D11_BLEND_OP_SUBTRACT
     * @type {Integer (Int32)}
     */
    static SUBTRACT => 2
     ...
     * Native name: D3D11_BLEND_OP_REV_SUBTRACT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D11_BLEND_OP_MIN
     * @type {Integer (Int32)}
     */
    static MIN => 4
     ...
     * Native name: D3D11_BLEND_OP_MAX
     * @type {Integer (Int32)}
     */
    static MAX => 5
}
