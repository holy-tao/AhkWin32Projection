 ...
 * @remarks
 * To create an empty 1D texture, call <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11device-createtexture1d">ID3D11Device::CreateTexture1D</a>. For info about how to create a 2D texture, which is similar to creating a 1D texture, see <a href="https://docs.microsoft.com/windows/desktop/direct3d11/overviews-direct3d-11-resources-textures-create">How to: Create a Texture</a>. 
 * 
 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/nn-d3d11-id3d11texture1d
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
export default struct ID3D11Texture1D extends ID3D11Resource {
    /**
     * The interface identifier for ID3D11Texture1D
     * @type {Guid}
     */
    static IID := Guid("{f8fb5c27-c6b3-4f75-a4c8-439af2ef564c}")
     ...
     * used for ID3D11Texture1D interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D11Texture1D.Vtbl()
        }
     ...
     * @param {Pointer<D3D11_TEXTURE1D_DESC>} pDesc Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_texture1d_desc">D3D11_TEXTURE1D_DESC</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api/d3d11/nf-d3d11-id3d11texture1d-getdesc
     */
    GetDesc(pDesc) {
        ComCall(10, this, D3D11_TEXTURE1D_DESC.Ptr, pDesc)
    }

    Query(iid) {
        if (ID3D11Texture1D.IID.Equals(iid)) {
            return true
        }
