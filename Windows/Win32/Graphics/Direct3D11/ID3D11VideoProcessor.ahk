 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11videoprocessor
...
class ID3D11VideoProcessor extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessor-getcontentdesc
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessor-getrateconversioncaps
     */
