 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_counter_type
...
class D3D11_COUNTER_TYPE extends Win32Enum {
     ...
     * Native name: D3D11_COUNTER_TYPE_FLOAT32
     * @type {Integer (Int32)}
     */
    static FLOAT32 => 0
     ...
     * Native name: D3D11_COUNTER_TYPE_UINT16
     * @type {Integer (Int32)}
     */
    static UINT16 => 1
     ...
     * Native name: D3D11_COUNTER_TYPE_UINT32
     * @type {Integer (Int32)}
     */
    static UINT32 => 2
     ...
     * Native name: D3D11_COUNTER_TYPE_UINT64
     * @type {Integer (Int32)}
     */
    static UINT64 => 3
}
