 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11_2/ne-d3d11_2-d3d11_tile_copy_flag
 * @namespace Windows.Win32.Graphics.Direct3D11
 */
class D3D11_TILE_COPY_FLAG extends Win32Enum {

    /**
     * Indicates that the GPU isn't currently referencing any of the 
     *  portions of destination memory being written.
     * Native name: D3D11_TILE_COPY_NO_OVERWRITE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D11_TILE_COPY_LINEAR_BUFFER_TO_SWIZZLED_TILED_RESOURCE
     * @type {Integer (Int32)}
     */
    static LINEAR_BUFFER_TO_SWIZZLED_TILED_RESOURCE => 2
     ...
     * Native name: D3D11_TILE_COPY_SWIZZLED_TILED_RESOURCE_TO_LINEAR_BUFFER
     * @type {Integer (Int32)}
     */
    static SWIZZLED_TILED_RESOURCE_TO_LINEAR_BUFFER => 4
}
