 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nn-d3d11_1-id3duserdefinedannotation
...
class ID3DUserDefinedAnnotation extends IUnknown{
     ...
     * @returns {Integer} Returns the number of previous calls to <b>BeginEvent</b> that have not yet been finalized by calls to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-endevent">ID3DUserDefinedAnnotation::EndEvent</a> method.
     * 
     * The return value is –1 if the calling application is not running under a Direct3D profiling tool.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-beginevent
     */
    BeginEvent(Name) {
     ...
     * @remarks
     * You call the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-beginevent">BeginEvent</a> method to mark the beginning of the section of event code.
     * 
     * A user can visualize the event when the calling application is running under an enabled Direct3D profiling tool such as Microsoft Visual Studio Ultimate 2012.
     * 
     * <b>EndEvent</b> has no effect if the calling application is not running under an enabled Direct3D profiling tool.
     * @returns {Integer} Returns the number of previous calls to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-beginevent">ID3DUserDefinedAnnotation::BeginEvent</a> method that have not yet been finalized by calls to <b>EndEvent</b>.
     * 
     * The return value is –1 if the calling application is not running under a Direct3D profiling tool.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-endevent
     */
    EndEvent() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-setmarker
     */
    SetMarker(Name) {
        Name := Name is String ? StrPtr(Name) : Name
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_1/nf-d3d11_1-id3duserdefinedannotation-getstatus
     */
    GetStatus() {
