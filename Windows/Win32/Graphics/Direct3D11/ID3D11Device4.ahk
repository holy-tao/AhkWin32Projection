 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nn-d3d11_4-id3d11device4
...
class ID3D11Device4 extends ID3D11Device3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11device4-registerdeviceremovedevent
     */
    RegisterDeviceRemovedEvent(hEvent) {
        hEvent := hEvent is Win32Handle ? NumGet(hEvent, "ptr") : hEvent

        result := ComCall(65, this, "ptr", hEvent, "uint*", &pdwCookie := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11device4-unregisterdeviceremoved
     */
