 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11videodecoderoutputview
...
class ID3D11VideoDecoderOutputView extends ID3D11View{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videodecoderoutputview-getdesc
     */
    GetDesc(pDesc) {
