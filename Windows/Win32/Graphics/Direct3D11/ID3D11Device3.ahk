 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nn-d3d11_3-id3d11device3
...
class ID3D11Device3 extends ID3D11Device2{
     ...
     * @returns {Pointer<ID3D11Texture2D1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11texture2d1">ID3D11Texture2D1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createtexture2d1
     */
    CreateTexture2D1(pDesc1, pInitialData) {
        result := ComCall(54, this, "ptr", pDesc1, "ptr", pInitialData, "ptr*", &ppTexture2D := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<ID3D11Texture3D1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11texture3d1">ID3D11Texture3D1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createtexture3d1
     */
    CreateTexture3D1(pDesc1, pInitialData) {
        result := ComCall(55, this, "ptr", pDesc1, "ptr", pInitialData, "ptr*", &ppTexture3D := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11RasterizerState2>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11rasterizerstate2">ID3D11RasterizerState2</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createrasterizerstate2
     */
    CreateRasterizerState2(pRasterizerDesc) {
        result := ComCall(56, this, "ptr", pRasterizerDesc, "ptr*", &ppRasterizerState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11ShaderResourceView1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11shaderresourceview1">ID3D11ShaderResourceView1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createshaderresourceview1
     */
    CreateShaderResourceView1(pResource, pDesc1) {
        result := ComCall(57, this, "ptr", pResource, "ptr", pDesc1, "ptr*", &ppSRView1 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11UnorderedAccessView1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11unorderedaccessview1">ID3D11UnorderedAccessView1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createunorderedaccessview1
     */
    CreateUnorderedAccessView1(pResource, pDesc1) {
        result := ComCall(58, this, "ptr", pResource, "ptr", pDesc1, "ptr*", &ppUAView1 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11RenderTargetView1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11rendertargetview1">ID3D11RenderTargetView1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createrendertargetview1
     */
    CreateRenderTargetView1(pResource, pDesc1) {
        result := ComCall(59, this, "ptr", pResource, "ptr", pDesc1, "ptr*", &ppRTView1 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11Query1>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11query1">ID3D11Query1</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createquery1
     */
    CreateQuery1(pQueryDesc1) {
        result := ComCall(60, this, "ptr", pQueryDesc1, "ptr*", &ppQuery1 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-getimmediatecontext3
     */
     ...
     * @returns {Pointer<ID3D11DeviceContext3>} Type: <b>ID3D11DeviceContext3**</b>
     * 
     * Upon completion of the method, the passed pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/d3d11_3/nn-d3d11_3-id3d11devicecontext3">ID3D11DeviceContext3</a> interface pointer is initialized.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-createdeferredcontext3
     */
    CreateDeferredContext3(ContextFlags) {
        result := ComCall(62, this, "uint", ContextFlags, "ptr*", &ppDeferredContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-writetosubresource
     */
     ...
     *               When the box is empty, this method doesn't perform any operation.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_3/nf-d3d11_3-id3d11device3-readfromsubresource
     */
