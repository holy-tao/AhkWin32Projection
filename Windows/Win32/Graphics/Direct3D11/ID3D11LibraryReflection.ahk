 ...
 *       </div>
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nn-d3d11shader-id3d11libraryreflection
...
class ID3D11LibraryReflection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11libraryreflection-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11libraryreflection-getfunctionbyindex
     */
