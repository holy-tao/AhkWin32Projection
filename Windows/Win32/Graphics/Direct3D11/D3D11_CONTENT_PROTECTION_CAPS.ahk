...
class D3D11_CONTENT_PROTECTION_CAPS extends Win32Enum {
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_SOFTWARE
     * @type {Integer (Int32)}
     */
    static SOFTWARE => 1
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE
     * @type {Integer (Int32)}
     */
    static HARDWARE => 2
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_PROTECTION_ALWAYS_ON
     * @type {Integer (Int32)}
     */
    static PROTECTION_ALWAYS_ON => 4
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_PARTIAL_DECRYPTION
     * @type {Integer (Int32)}
     */
    static PARTIAL_DECRYPTION => 8

    /**
     * The driver can encrypt data using a separate content key that is encrypted using the session key.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_CONTENT_KEY
     * @type {Integer (Int32)}
     */
    static CONTENT_KEY => 16

    /**
     * The driver can refresh the session key without renegotiating the key.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_FRESHEN_SESSION_KEY
     * @type {Integer (Int32)}
     */
    static FRESHEN_SESSION_KEY => 32
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_ENCRYPTED_READ_BACK
     * @type {Integer (Int32)}
     */
    static ENCRYPTED_READ_BACK => 64

    /**
     * The driver requires a separate key to read encrypted data from a protected surface.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_ENCRYPTED_READ_BACK_KEY
     * @type {Integer (Int32)}
     */
    static ENCRYPTED_READ_BACK_KEY => 128
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_SEQUENTIAL_CTR_IV
     * @type {Integer (Int32)}
     */
    static SEQUENTIAL_CTR_IV => 256
     ...
     * <div> </div>
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_ENCRYPT_SLICEDATA_ONLY
     * @type {Integer (Int32)}
     */
    static ENCRYPT_SLICEDATA_ONLY => 512

    /**
     * The driver can copy encrypted data from one resource to another, decrypting the data as part of the process.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_DECRYPTION_BLT
     * @type {Integer (Int32)}
     */
    static DECRYPTION_BLT => 1024
     ...
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE_PROTECT_UNCOMPRESSED
     * @type {Integer (Int32)}
     */
    static HARDWARE_PROTECT_UNCOMPRESSED => 2048
     ...
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 10.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE_PROTECTED_MEMORY_PAGEABLE
     * @type {Integer (Int32)}
     */
    static HARDWARE_PROTECTED_MEMORY_PAGEABLE => 4096
     ...
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 10.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE_TEARDOWN
     * @type {Integer (Int32)}
     */
    static HARDWARE_TEARDOWN => 8192
     ...
     * 
     * <b>Note</b>  This enumeration value is supported starting with Windows 10.
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE_DRM_COMMUNICATION
     * @type {Integer (Int32)}
     */
    static HARDWARE_DRM_COMMUNICATION => 16384

    /**
     * Native name: D3D11_CONTENT_PROTECTION_CAPS_HARDWARE_DRM_COMMUNICATION_MULTI_THREADED
     * @type {Integer (Int32)}
     */
    static HARDWARE_DRM_COMMUNICATION_MULTI_THREADED => 32768
}
