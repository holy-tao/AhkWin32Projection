 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nn-d3d11_4-id3d11multithread
...
class ID3D11Multithread extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11multithread-enter
     */
    Enter() {
        ComCall(3, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11multithread-leave
     */
    Leave() {
        ComCall(4, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11multithread-setmultithreadprotected
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11_4/nf-d3d11_4-id3d11multithread-getmultithreadprotected
     */
