 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nn-d3d11shader-id3d11shaderreflectiontype
...
class ID3D11ShaderReflectionType extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getmembertypebyindex
     */
     ...
     * 
     * A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d11shader/nn-d3d11shader-id3d11shaderreflectiontype">ID3D11ShaderReflectionType Interface</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getmembertypebyname
     */
     ...
     * 
     * The variable type.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getmembertypename
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-isequal
     */
    IsEqual(pType) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getsubtype
     */
    GetSubType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getbaseclass
     */
    GetBaseClass() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getnuminterfaces
     */
    GetNumInterfaces() {
     ...
     * 
     * A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d11shader/nn-d3d11shader-id3d11shaderreflectiontype">ID3D11ShaderReflectionType Interface</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-getinterfacebyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-isoftype
     */
    IsOfType(pType) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shader/nf-d3d11shader-id3d11shaderreflectiontype-implementsinterface
     */
