...
class D3D11_FEATURE_DATA_D3D11_OPTIONS extends Win32Struct
{
    ...
    OutputMergerLogicOp{
        get {
            if(!this.HasProp("__OutputMergerLogicOp"))
                this.__OutputMergerLogicOp := BOOL(this.ptr + 0)
    ...
    UAVOnlyRenderingForcedSampleCount{
        get {
            if(!this.HasProp("__UAVOnlyRenderingForcedSampleCount"))
                this.__UAVOnlyRenderingForcedSampleCount := BOOL(this.ptr + 4)
            return this.__UAVOnlyRenderingForcedSampleCount
        }
    }
    ...
    DiscardAPIsSeenByDriver{
        get {
            if(!this.HasProp("__DiscardAPIsSeenByDriver"))
                this.__DiscardAPIsSeenByDriver := BOOL(this.ptr + 8)
            return this.__DiscardAPIsSeenByDriver
        }
    }
    ...
    FlagsForUpdateAndCopySeenByDriver{
        get {
            if(!this.HasProp("__FlagsForUpdateAndCopySeenByDriver"))
                this.__FlagsForUpdateAndCopySeenByDriver := BOOL(this.ptr + 12)
            return this.__FlagsForUpdateAndCopySeenByDriver
        }
    }
    ...
    ClearView{
        get {
            if(!this.HasProp("__ClearView"))
                this.__ClearView := BOOL(this.ptr + 16)
            return this.__ClearView
        }
    }
    ...
    CopyWithOverlap{
        get {
            if(!this.HasProp("__CopyWithOverlap"))
                this.__CopyWithOverlap := BOOL(this.ptr + 20)
            return this.__CopyWithOverlap
        }
    }
    ...
    ConstantBufferPartialUpdate{
        get {
            if(!this.HasProp("__ConstantBufferPartialUpdate"))
                this.__ConstantBufferPartialUpdate := BOOL(this.ptr + 24)
            return this.__ConstantBufferPartialUpdate
        }
    }
    ...
    ConstantBufferOffsetting{
        get {
            if(!this.HasProp("__ConstantBufferOffsetting"))
                this.__ConstantBufferOffsetting := BOOL(this.ptr + 28)
            return this.__ConstantBufferOffsetting
        }
    }
    ...
    MapNoOverwriteOnDynamicConstantBuffer{
        get {
            if(!this.HasProp("__MapNoOverwriteOnDynamicConstantBuffer"))
                this.__MapNoOverwriteOnDynamicConstantBuffer := BOOL(this.ptr + 32)
            return this.__MapNoOverwriteOnDynamicConstantBuffer
        }
    }
    ...
    MapNoOverwriteOnDynamicBufferSRV{
        get {
            if(!this.HasProp("__MapNoOverwriteOnDynamicBufferSRV"))
                this.__MapNoOverwriteOnDynamicBufferSRV := BOOL(this.ptr + 36)
            return this.__MapNoOverwriteOnDynamicBufferSRV
        }
    }
    ...
    MultisampleRTVWithForcedSampleCountOne{
        get {
            if(!this.HasProp("__MultisampleRTVWithForcedSampleCountOne"))
                this.__MultisampleRTVWithForcedSampleCountOne := BOOL(this.ptr + 40)
            return this.__MultisampleRTVWithForcedSampleCountOne
        }
    }
    ...
    SAD4ShaderInstructions{
        get {
            if(!this.HasProp("__SAD4ShaderInstructions"))
                this.__SAD4ShaderInstructions := BOOL(this.ptr + 44)
            return this.__SAD4ShaderInstructions
        }
    }
    ...
    ExtendedDoublesShaderInstructions{
        get {
            if(!this.HasProp("__ExtendedDoublesShaderInstructions"))
                this.__ExtendedDoublesShaderInstructions := BOOL(this.ptr + 48)
            return this.__ExtendedDoublesShaderInstructions
        }
    }
    ...
    ExtendedResourceSharing{
        get {
            if(!this.HasProp("__ExtendedResourceSharing"))
                this.__ExtendedResourceSharing := BOOL(this.ptr + 52)
            return this.__ExtendedResourceSharing
        }
    }
}
