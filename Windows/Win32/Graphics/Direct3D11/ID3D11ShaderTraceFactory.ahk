 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shadertracing/nn-d3d11shadertracing-id3d11shadertracefactory
...
class ID3D11ShaderTraceFactory extends IUnknown{
     ...
     * @returns {Pointer<ID3D11ShaderTrace>} A pointer to a variable that receives a pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11shadertracing/nn-d3d11shadertracing-id3d11shadertrace">ID3D11ShaderTrace</a> interface for the shader-trace object that <b>CreateShaderTrace</b> creates.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11shadertracing/nf-d3d11shadertracing-id3d11shadertracefactory-createshadertrace
     */
    CreateShaderTrace(pShader, pTraceDesc) {
        result := ComCall(3, this, "ptr", pShader, "ptr", pTraceDesc, "ptr*", &ppShaderTrace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppShaderTrace
    }
}
