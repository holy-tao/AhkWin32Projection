 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11cryptosession
...
class ID3D11CryptoSession extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11cryptosession-getcryptotype
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11cryptosession-getdecoderprofile
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11cryptosession-getcertificatesize
     */
    GetCertificateSize() {
        result := ComCall(9, this, "uint*", &pCertificateSize := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11cryptosession-getcertificate
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11cryptosession-getcryptosessionhandle
     */
