 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11rasterizerstate
...
class ID3D11RasterizerState extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11rasterizerstate-getdesc
     */
    GetDesc(pDesc) {
