...
class D3D11_SHARED_RESOURCE_TIER extends Win32Enum {
     ...
     * Native name: D3D11_SHARED_RESOURCE_TIER_0
     * @type {Integer (Int32)}
     */
    static 0 => 0
     ...
     * Native name: D3D11_SHARED_RESOURCE_TIER_1
     * @type {Integer (Int32)}
     */
    static 1 => 1
     ...
     * Native name: D3D11_SHARED_RESOURCE_TIER_2
     * @type {Integer (Int32)}
     */
    static 2 => 2
     ...
     * Native name: D3D11_SHARED_RESOURCE_TIER_3
     * @type {Integer (Int32)}
     */
    static 3 => 3
}
