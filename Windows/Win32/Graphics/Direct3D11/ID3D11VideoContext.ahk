 ...
 * </li>
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11videocontext
...
class ID3D11VideoContext extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-getdecoderbuffer
     */
    GetDecoderBuffer(pDecoder, Type, pBufferSize, ppBuffer) {
        ...
        result := ComCall(7, this, "ptr", pDecoder, "int", Type, pBufferSizeMarshal, pBufferSize, ppBufferMarshal, ppBuffer, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-releasedecoderbuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-decoderbeginframe
     */
     ...
     * @param {ID3D11VideoDecoder} pDecoder A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11videodecoder">ID3D11VideoDecoder</a> interface. To get this pointer, call <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11videodevice-createvideodecoder">ID3D11VideoDevice::CreateVideoDecoder</a>.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-decoderendframe
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-submitdecoderbuffers
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-decoderextension
     */
     ...
     * @param {Pointer<RECT>} pRect A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that specifies the target rectangle.  If <i>Enable</i> is <b>FALSE</b>, this parameter is ignored.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputtargetrect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputbackgroundcolor
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputcolorspace
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputalphafillmode
     */
     ...
     * @param {SIZE} Size_ The sampling size.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputconstriction
     */
    VideoProcessorSetOutputConstriction(pVideoProcessor, Enable, Size_) {
        ComCall(17, this, "ptr", pVideoProcessor, "int", Enable, "ptr", Size_)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputstereomode
     */
     ...
     * @returns {Integer} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetoutputextension
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputtargetrect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputbackgroundcolor
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputcolorspace
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputalphafillmode
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputconstriction
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputstereomode
     */
     ...
     * @returns {Integer} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetoutputextension
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamframeformat
     */
     ...
     * @param {Pointer<D3D11_VIDEO_PROCESSOR_COLOR_SPACE>} pColorSpace A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_video_processor_color_space">D3D11_VIDEO_PROCESSOR_COLOR_SPACE</a> structure that specifies the color space.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamcolorspace
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamoutputrate
     */
     ...
     * @param {Pointer<RECT>} pRect A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that specifies the source rectangle. If <i>Enable</i> is <b>FALSE</b>, this parameter is ignored.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamsourcerect
     */
     ...
     * @param {Pointer<RECT>} pRect A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that specifies the destination rectangle. If <i>Enable</i> is <b>FALSE</b>, this parameter is ignored.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamdestrect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamalpha
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreampalette
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreampixelaspectratio
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamlumakey
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamstereoformat
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamautoprocessingmode
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamfilter
     */
     ...
     * @param {Pointer<Void>} pData A pointer to a buffer that contains private state data. The method passes this buffer directly to the driver without validation. It is the responsibility of the driver to validate the data.
     * @returns {Integer} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamextension
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamframeformat
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamcolorspace
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamoutputrate
     */
     ...
     * @param {Pointer<RECT>} pRect A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that receives the source rectangle.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamsourcerect
     */
     ...
     * @param {Pointer<RECT>} pRect A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that receives the destination rectangle.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamdestrect
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamalpha
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreampalette
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreampixelaspectratio
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamlumakey
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamstereoformat
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamautoprocessingmode
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamfilter
     */
     ...
     * @param {Pointer} pData A pointer to a buffer that receives the private state data.
     * @returns {Integer} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamextension
     */
     ...
     * <li>The stereo format cannot be <a href="https://docs.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_video_processor_stereo_format">D3D11_VIDEO_PROCESSOR_STEREO_FORMAT_MONO</a> .</li>
     * </ul>
     * This function does not honor a D3D11 predicate that may have been set.
     * 
     * If the application uses <a href="https://docs.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_query">D3D11 queries</a>, this function may not be accounted for with <b>D3D11_QUERY_EVENT</b> and <b>D3D11_QUERY_TIMESTAMP</b> when using feature levels lower than 11. <b>D3D11_QUERY_PIPELINE_STATISTICS</b> will not include this function for any feature level.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorblt
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-negotiatecryptosessionkeyexchange
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-encryptionblt
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-decryptionblt
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-startsessionkeyrefresh
     */
     ...
     * @remarks
     * This function can only be called when the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_content_protection_caps">D3D11_CONTENT_PROTECTION_CAPS_FRESHEN_SESSION_KEY</a> cap is reported.
     * 
     * Before calling this method, call <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11videocontext-startsessionkeyrefresh">ID3D11VideoContext::StartSessionKeyRefresh</a>. The <b>StartSessionKeyRefresh</b> method gets a random number from the driver, which is used to create a new session key. The new session key does not become active until the application calls <b>FinishSessionKeyRefresh</b>. After the application calls <b>FinishSessionKeyRefresh</b>, all protected surfaces are encrypted using the new session key.
     * @param {ID3D11CryptoSession} pCryptoSession A pointer to the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11cryptosession">ID3D11CryptoSession</a> interface.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-finishsessionkeyrefresh
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-getencryptionbltkey
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-negotiateauthenticatedchannelkeyexchange
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-queryauthenticatedchannel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-configureauthenticatedchannel
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorsetstreamrotation
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videocontext-videoprocessorgetstreamrotation
     */
