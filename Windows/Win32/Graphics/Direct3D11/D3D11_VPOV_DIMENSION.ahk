 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d11/ne-d3d11-d3d11_vpov_dimension
...
class D3D11_VPOV_DIMENSION extends Win32Enum {
    ...
    /**
     * Not a valid value.
     * Native name: D3D11_VPOV_DIMENSION_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 0
     ...
     * Native name: D3D11_VPOV_DIMENSION_TEXTURE2D
     * @type {Integer (Int32)}
     */
    static TEXTURE2D => 1
     ...
     * Native name: D3D11_VPOV_DIMENSION_TEXTURE2DARRAY
     * @type {Integer (Int32)}
     */
    static TEXTURE2DARRAY => 2
}
