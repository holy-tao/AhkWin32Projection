 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11videoprocessorenumerator
...
class ID3D11VideoProcessorEnumerator extends ID3D11DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-getvideoprocessorcontentdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-checkvideoprocessorformat
     */
    CheckVideoProcessorFormat(Format) {
        result := ComCall(8, this, "int", Format, "uint*", &pFlags := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-getvideoprocessorcaps
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-getvideoprocessorrateconversioncaps
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-getvideoprocessorcustomrate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11videoprocessorenumerator-getvideoprocessorfilterrange
     */
