 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11device
...
class ID3D11Device extends IUnknown{
     ...
     * @returns {Pointer<ID3D11Buffer>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11buffer">ID3D11Buffer</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createbuffer
     */
    CreateBuffer(pDesc, pInitialData) {
        result := ComCall(3, this, "ptr", pDesc, "ptr", pInitialData, "ptr*", &ppBuffer := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<ID3D11Texture1D>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11texture1d">ID3D11Texture1D</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createtexture1d
     */
    CreateTexture1D(pDesc, pInitialData) {
        result := ComCall(4, this, "ptr", pDesc, "ptr", pInitialData, "ptr*", &ppTexture1D := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * For more information about this array size, see Remarks.
     * @returns {Pointer<ID3D11Texture2D>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11texture2d">ID3D11Texture2D</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createtexture2d
     */
    CreateTexture2D(pDesc, pInitialData) {
        result := ComCall(5, this, "ptr", pDesc, "ptr", pInitialData, "ptr*", &ppTexture2D := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * For more information about this array size, see Remarks.
     * @returns {Pointer<ID3D11Texture3D>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11texture3d">ID3D11Texture3D</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createtexture3d
     */
    CreateTexture3D(pDesc, pInitialData) {
        result := ComCall(6, this, "ptr", pDesc, "ptr", pInitialData, "ptr*", &ppTexture3D := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11ShaderResourceView>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11shaderresourceview">ID3D11ShaderResourceView</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createshaderresourceview
     */
    CreateShaderResourceView(pResource, pDesc) {
        result := ComCall(7, this, "ptr", pResource, "ptr", pDesc, "ptr*", &ppSRView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11UnorderedAccessView>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11unorderedaccessview">ID3D11UnorderedAccessView</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createunorderedaccessview
     */
    CreateUnorderedAccessView(pResource, pDesc) {
        result := ComCall(8, this, "ptr", pResource, "ptr", pDesc, "ptr*", &ppUAView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11RenderTargetView>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11rendertargetview">ID3D11RenderTargetView</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createrendertargetview
     */
    CreateRenderTargetView(pResource, pDesc) {
        result := ComCall(9, this, "ptr", pResource, "ptr", pDesc, "ptr*", &ppRTView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11DepthStencilView>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11depthstencilview">ID3D11DepthStencilView</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createdepthstencilview
     */
    CreateDepthStencilView(pResource, pDesc) {
        result := ComCall(10, this, "ptr", pResource, "ptr", pDesc, "ptr*", &ppDepthStencilView := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppDepthStencilView
    }
     ...
     * @returns {Pointer<ID3D11InputLayout>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11inputlayout">ID3D11InputLayout</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createinputlayout
     */
    CreateInputLayout(pInputElementDescs, NumElements, pShaderBytecodeWithInputSignature, BytecodeLength) {
        ...
        result := ComCall(11, this, "ptr", pInputElementDescs, "uint", NumElements, pShaderBytecodeWithInputSignatureMarshal, pShaderBytecodeWithInputSignature, "ptr", BytecodeLength, "ptr*", &ppInputLayout := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11VertexShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11vertexshader">ID3D11VertexShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createvertexshader
     */
    CreateVertexShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(12, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppVertexShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * A pointer to a class linkage interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classlinkage">ID3D11ClassLinkage</a>); the value can be <b>NULL</b>.
     * @returns {Pointer<ID3D11GeometryShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11geometryshader">ID3D11GeometryShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-creategeometryshader
     */
    CreateGeometryShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(13, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppGeometryShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppGeometryShader
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-creategeometryshaderwithstreamoutput
     */
    CreateGeometryShaderWithStreamOutput(pShaderBytecode, BytecodeLength, pSODeclaration, NumEntries, pBufferStrides, NumStrides, RasterizedStream, pClassLinkage) {
        ...
        result := ComCall(14, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pSODeclaration, "uint", NumEntries, pBufferStridesMarshal, pBufferStrides, "uint", NumStrides, "uint", RasterizedStream, "ptr", pClassLinkage, "ptr*", &ppGeometryShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * A pointer to a class linkage interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classlinkage">ID3D11ClassLinkage</a>); the value can be <b>NULL</b>.
     * @returns {Pointer<ID3D11PixelShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11pixelshader">ID3D11PixelShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createpixelshader
     */
    CreatePixelShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(15, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppPixelShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * A pointer to a class linkage interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classlinkage">ID3D11ClassLinkage</a>); the value can be <b>NULL</b>.
     * @returns {Pointer<ID3D11HullShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11hullshader">ID3D11HullShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createhullshader
     */
    CreateHullShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(16, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppHullShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * A pointer to a class linkage interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classlinkage">ID3D11ClassLinkage</a>); the value can be <b>NULL</b>.
     * @returns {Pointer<ID3D11DomainShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11domainshader">ID3D11DomainShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createdomainshader
     */
    CreateDomainShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(17, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppDomainShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppDomainShader
    }
     ...
     * @returns {Pointer<ID3D11ComputeShader>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11computeshader">ID3D11ComputeShader</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createcomputeshader
     */
    CreateComputeShader(pShaderBytecode, BytecodeLength, pClassLinkage) {
        pShaderBytecodeMarshal := pShaderBytecode is VarRef ? "ptr" : "ptr"

        result := ComCall(18, this, pShaderBytecodeMarshal, pShaderBytecode, "ptr", BytecodeLength, "ptr", pClassLinkage, "ptr*", &ppComputeShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppComputeShader
    }
     ...
     * @returns {Pointer<ID3D11ClassLinkage>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11classlinkage">ID3D11ClassLinkage</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createclasslinkage
     */
    CreateClassLinkage() {
        result := ComCall(19, this, "ptr*", &ppLinkage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11BlendState>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11blendstate">ID3D11BlendState</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createblendstate
     */
    CreateBlendState(pBlendStateDesc) {
        result := ComCall(20, this, "ptr", pBlendStateDesc, "ptr*", &ppBlendState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11DepthStencilState>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11depthstencilstate">ID3D11DepthStencilState</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createdepthstencilstate
     */
    CreateDepthStencilState(pDepthStencilDesc) {
        result := ComCall(21, this, "ptr", pDepthStencilDesc, "ptr*", &ppDepthStencilState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppDepthStencilState
    }
     ...
     * @returns {Pointer<ID3D11RasterizerState>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11rasterizerstate">ID3D11RasterizerState</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createrasterizerstate
     */
    CreateRasterizerState(pRasterizerDesc) {
        result := ComCall(22, this, "ptr", pRasterizerDesc, "ptr*", &ppRasterizerState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11SamplerState>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11samplerstate">ID3D11SamplerState</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createsamplerstate
     */
    CreateSamplerState(pSamplerDesc) {
        result := ComCall(23, this, "ptr", pSamplerDesc, "ptr*", &ppSamplerState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return ppSamplerState
    }
     ...
     * @returns {Pointer<ID3D11Query>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11query">ID3D11Query</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createquery
     */
    CreateQuery(pQueryDesc) {
        result := ComCall(24, this, "ptr", pQueryDesc, "ptr*", &ppQuery := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11Predicate>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11predicate">ID3D11Predicate</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createpredicate
     */
    CreatePredicate(pPredicateDesc) {
        result := ComCall(25, this, "ptr", pPredicateDesc, "ptr*", &ppPredicate := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID3D11Counter>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11counter">ID3D11Counter</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createcounter
     */
    CreateCounter(pCounterDesc) {
        result := ComCall(26, this, "ptr", pCounterDesc, "ptr*", &ppCounter := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     *             Pass 0.
     * @returns {Pointer<ID3D11DeviceContext>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11devicecontext">ID3D11DeviceContext</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-createdeferredcontext
     */
    CreateDeferredContext(ContextFlags) {
        result := ComCall(27, this, "uint", ContextFlags, "ptr*", &ppDeferredContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-opensharedresource
     */
    OpenSharedResource(hResource_, ReturnedInterface) {
        hResource_ := hResource_ is Win32Handle ? NumGet(hResource_, "ptr") : hResource_

        result := ComCall(28, this, "ptr", hResource_, "ptr", ReturnedInterface, "ptr*", &ppResource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-checkformatsupport
     */
    CheckFormatSupport(Format) {
        result := ComCall(29, this, "int", Format, "uint*", &pFormatSupport := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-checkmultisamplequalitylevels
     */
    CheckMultisampleQualityLevels(Format, SampleCount) {
        result := ComCall(30, this, "int", Format, "uint", SampleCount, "uint*", &pNumQualityLevels := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-checkcounterinfo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-checkcounter
     */
    CheckCounter(pDesc, pType, pActiveCounters, szName, pNameLength, szUnits, pUnitsLength, szDescription, pDescriptionLength) {
        ...
        result := ComCall(32, this, "ptr", pDesc, pTypeMarshal, pType, pActiveCountersMarshal, pActiveCounters, "ptr", szName, pNameLengthMarshal, pNameLength, "ptr", szUnits, pUnitsLengthMarshal, pUnitsLength, "ptr", szDescription, pDescriptionLengthMarshal, pDescriptionLength, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-checkfeaturesupport
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getprivatedata
     */
    GetPrivateData(guid, pDataSize, pData) {
        pDataSizeMarshal := pDataSize is VarRef ? "uint*" : "ptr"

        result := ComCall(34, this, "ptr", guid, pDataSizeMarshal, pDataSize, "ptr", pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * This method returns one of the following <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-setprivatedata
     */
     ...
     * 
     * This method returns one of the following <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-setprivatedatainterface
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getfeaturelevel
     */
    GetFeatureLevel() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getcreationflags
     */
    GetCreationFlags() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getdeviceremovedreason
     */
     ...
     * Upon completion of the method, the passed pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11devicecontext">ID3D11DeviceContext</a> interface pointer is initialized.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getimmediatecontext
     */
     ...
     * 
     * This method returns one of the following <a href="https://docs.microsoft.com/windows/desktop/direct3d11/d3d11-graphics-reference-returnvalues">Direct3D 11 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-setexceptionmode
     */
     ...
     * 
     * A value that contains one or more exception flags; each flag specifies a condition which will cause an exception to be raised. The flags are listed in <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_raise_flag">D3D11_RAISE_FLAG</a>. A default value of 0 means there are no flags.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11device-getexceptionmode
     */
    GetExceptionMode() {
