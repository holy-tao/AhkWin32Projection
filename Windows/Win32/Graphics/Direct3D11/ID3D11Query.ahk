 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nn-d3d11-id3d11query
...
class ID3D11Query extends ID3D11Asynchronous{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11/nf-d3d11-id3d11query-getdesc
     */
    GetDesc(pDesc) {
