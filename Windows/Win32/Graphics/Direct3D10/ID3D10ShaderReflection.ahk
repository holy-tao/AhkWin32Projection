 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nn-d3d10shader-id3d10shaderreflection
...
class ID3D10ShaderReflection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getconstantbufferbyindex
     */
     ...
     * 
     * A pointer to a constant buffer (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d10shader/nn-d3d10shader-id3d10shaderreflectionconstantbuffer">ID3D10ShaderReflectionConstantBuffer Interface</a>).
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getconstantbufferbyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getresourcebindingdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getinputparameterdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflection-getoutputparameterdesc
     */
