 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10asynchronous
...
class ID3D10Asynchronous extends ID3D10DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10asynchronous-begin
     */
    Begin() {
        ComCall(7, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10asynchronous-end
     */
    End() {
        ComCall(8, this)
    }
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10asynchronous-getdata
     */
    GetData(pData, DataSize, GetDataFlags) {
        result := ComCall(9, this, "ptr", pData, "uint", DataSize, "uint", GetDataFlags, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10asynchronous-getdatasize
     */
    GetDataSize() {
