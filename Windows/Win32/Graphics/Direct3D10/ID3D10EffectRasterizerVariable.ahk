 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nn-d3d10effect-id3d10effectrasterizervariable
...
class ID3D10EffectRasterizerVariable extends ID3D10EffectVariable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectrasterizervariable-getrasterizerstate
     */
    GetRasterizerState(Index) {
        result := ComCall(25, this, "uint", Index, "ptr*", &ppRasterizerState := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectrasterizervariable-getbackingstore
     */
    GetBackingStore(Index) {
        pRasterizerDesc := D3D10_RASTERIZER_DESC()
        result := ComCall(26, this, "uint", Index, "ptr", pRasterizerDesc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
