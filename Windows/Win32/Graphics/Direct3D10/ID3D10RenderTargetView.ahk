 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10rendertargetview
...
class ID3D10RenderTargetView extends ID3D10View{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10rendertargetview-getdesc
     */
    GetDesc(pDesc) {
