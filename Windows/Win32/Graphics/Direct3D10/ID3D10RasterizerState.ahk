 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10rasterizerstate
...
class ID3D10RasterizerState extends ID3D10DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10rasterizerstate-getdesc
     */
    GetDesc(pDesc) {
