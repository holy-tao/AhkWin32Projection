 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nn-d3d10effect-id3d10effectblendvariable
...
class ID3D10EffectBlendVariable extends ID3D10EffectVariable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectblendvariable-getblendstate
     */
    GetBlendState(Index) {
        result := ComCall(25, this, "uint", Index, "ptr*", &ppBlendState := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectblendvariable-getbackingstore
     */
    GetBackingStore(Index, pBlendDesc) {
        result := ComCall(26, this, "uint", Index, "ptr", pBlendDesc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
