 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/ne-d3d10-d3d10_comparison_func
...
class D3D10_COMPARISON_FUNC extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_NEVER => 1

    /**
     * If the source data is less than the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_LESS => 2

    /**
     * If the source data is equal to the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_EQUAL => 3

    /**
     * If the source data is less than or equal to the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_LESS_EQUAL => 4

    /**
     * If the source data is greater than the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_GREATER => 5

    /**
     * If the source data is not equal to the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_NOT_EQUAL => 6

    /**
     * If the source data is greater than or equal to the destination data, the comparison passes.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_GREATER_EQUAL => 7

    /**
     * Always pass the comparison.
     * @type {Integer (Int32)}
     */
    static D3D10_COMPARISON_ALWAYS => 8
}
