 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nn-d3d10shader-id3d10shaderreflectiontype
...
class ID3D10ShaderReflectionType extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectiontype-getdesc
     */
    GetDesc(pDesc) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectiontype-getmembertypebyindex
     */
     ...
     * 
     * A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d10shader/nn-d3d10shader-id3d10shaderreflectiontype">ID3D10ShaderReflectionType Interface</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectiontype-getmembertypebyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectiontype-getmembertypename
     */
