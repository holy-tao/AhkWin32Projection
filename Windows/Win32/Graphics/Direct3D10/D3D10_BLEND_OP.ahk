...
class D3D10_BLEND_OP extends Win32Enum {
     ...
     * Native name: D3D10_BLEND_OP_ADD
     * @type {Integer (Int32)}
     */
    static ADD => 1
     ...
     * Native name: D3D10_BLEND_OP_SUBTRACT
     * @type {Integer (Int32)}
     */
    static SUBTRACT => 2
     ...
     * Native name: D3D10_BLEND_OP_REV_SUBTRACT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D10_BLEND_OP_MIN
     * @type {Integer (Int32)}
     */
    static MIN => 4
     ...
     * Native name: D3D10_BLEND_OP_MAX
     * @type {Integer (Int32)}
     */
    static MAX => 5
}
