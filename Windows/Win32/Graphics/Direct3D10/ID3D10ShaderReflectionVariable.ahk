 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nn-d3d10shader-id3d10shaderreflectionvariable
...
class ID3D10ShaderReflectionVariable extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectionvariable-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectionvariable-gettype
     */
    GetType() {
