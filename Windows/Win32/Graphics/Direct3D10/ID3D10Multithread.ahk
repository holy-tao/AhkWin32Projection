 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10multithread
...
class ID3D10Multithread extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10multithread-enter
     */
    Enter() {
        ComCall(3, this)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10multithread-leave
     */
    Leave() {
        ComCall(4, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10multithread-setmultithreadprotected
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10multithread-getmultithreadprotected
     */
