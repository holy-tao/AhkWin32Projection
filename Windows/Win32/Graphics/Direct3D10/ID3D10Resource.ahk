 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10resource
...
class ID3D10Resource extends ID3D10DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10resource-gettype
     */
    GetType(rType) {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10resource-setevictionpriority
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10resource-getevictionpriority
     */
    GetEvictionPriority() {
