 ...
 * </div>
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nn-d3d10effect-id3d10effect
...
class ID3D10Effect extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-isvalid
     */
    IsValid() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-ispool
     */
    IsPool() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getdevice
     */
    GetDevice() {
        result := ComCall(5, this, "ptr*", &ppDevice := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getconstantbufferbyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getconstantbufferbyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getvariablebyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getvariablebyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-getvariablebysemantic
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-gettechniquebyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-gettechniquebyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-optimize
     */
    Optimize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effect-isoptimized
     */
    IsOptimized() {
