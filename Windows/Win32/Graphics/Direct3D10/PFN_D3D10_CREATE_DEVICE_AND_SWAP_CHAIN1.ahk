 ...
 * @version v4.0.30319
 */
class PFN_D3D10_CREATE_DEVICE_AND_SWAP_CHAIN1 extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
        ...
        result := ComCall(3, this, "ptr", param0, "int", param1, "ptr", param2, "uint", param3, "int", param4, "uint", param5, "ptr", param6, "ptr*", param7, "ptr*", param8, "int")
        if(result != 0) {
