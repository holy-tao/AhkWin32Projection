 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10texture3d
...
class ID3D10Texture3D extends ID3D10Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture3d-map
     */
    Map(Subresource, MapType, MapFlags) {
        pMappedTex3D := D3D10_MAPPED_TEXTURE3D()
        result := ComCall(10, this, "uint", Subresource, "int", MapType, "uint", MapFlags, "ptr", pMappedTex3D, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture3d-unmap
     */
    Unmap(Subresource) {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture3d-getdesc
     */
    GetDesc(pDesc) {
