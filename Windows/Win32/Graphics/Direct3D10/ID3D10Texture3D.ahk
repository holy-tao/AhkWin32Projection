...
export default struct ID3D10Texture3D extends ID3D10Resource {
    ...
    */
    ...
    Map(Subresource, MapType, MapFlags) {
        ...
        result := ComCall(10, this, UInt32, Subresource, D3D10_MAP, MapType, UInt32, MapFlags, D3D10_MAPPED_TEXTURE3D.Ptr, pMappedTex3D, "HRESULT")
        return pMappedTex3D
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.Map := CallbackCreate(ObjBindMethod(implObj, "Map"), flags, 5)
        this.vtbl.Unmap := CallbackCreate(ObjBindMethod(implObj, "Unmap"), flags, 2)
