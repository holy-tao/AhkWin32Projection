 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10texture1d
...
class ID3D10Texture1D extends ID3D10Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture1d-map
     */
    Map(Subresource, MapType, MapFlags) {
        result := ComCall(10, this, "uint", Subresource, "int", MapType, "uint", MapFlags, "ptr*", &ppData := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture1d-unmap
     */
    Unmap(Subresource) {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10texture1d-getdesc
     */
    GetDesc(pDesc) {
