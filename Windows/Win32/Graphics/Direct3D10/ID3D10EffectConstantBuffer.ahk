 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nn-d3d10effect-id3d10effectconstantbuffer
...
class ID3D10EffectConstantBuffer extends ID3D10EffectVariable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectconstantbuffer-setconstantbuffer
     */
    SetConstantBuffer(pConstantBuffer) {
        result := ComCall(25, this, "ptr", pConstantBuffer, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectconstantbuffer-getconstantbuffer
     */
    GetConstantBuffer() {
        result := ComCall(26, this, "ptr*", &ppConstantBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns one of the following <a href="https://docs.microsoft.com/windows/desktop/direct3d10/d3d10-graphics-reference-returnvalues">Direct3D 10 Return Codes</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectconstantbuffer-settexturebuffer
     */
    SetTextureBuffer(pTextureBuffer) {
        result := ComCall(27, this, "ptr", pTextureBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectconstantbuffer-gettexturebuffer
     */
    GetTextureBuffer() {
        result := ComCall(28, this, "ptr*", &ppTextureBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
