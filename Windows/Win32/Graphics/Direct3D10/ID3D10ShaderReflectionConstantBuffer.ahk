 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nn-d3d10shader-id3d10shaderreflectionconstantbuffer
...
class ID3D10ShaderReflectionConstantBuffer extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectionconstantbuffer-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectionconstantbuffer-getvariablebyindex
     */
     ...
     * 
     * A pointer to a shader-reflection variable interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d10shader/nn-d3d10shader-id3d10shaderreflectionvariable">ID3D10ShaderReflectionVariable Interface</a>).
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10shader/nf-d3d10shader-id3d10shaderreflectionconstantbuffer-getvariablebyname
     */
