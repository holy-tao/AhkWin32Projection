 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nn-d3d10-id3d10counter
...
class ID3D10Counter extends ID3D10Asynchronous{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10/nf-d3d10-id3d10counter-getdesc
     */
    GetDesc(pDesc) {
