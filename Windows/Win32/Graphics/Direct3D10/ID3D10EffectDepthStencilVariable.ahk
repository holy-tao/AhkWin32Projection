 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nn-d3d10effect-id3d10effectdepthstencilvariable
...
class ID3D10EffectDepthStencilVariable extends ID3D10EffectVariable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectdepthstencilvariable-getdepthstencilstate
     */
    GetDepthStencilState(Index) {
        result := ComCall(25, this, "uint", Index, "ptr*", &ppDepthStencilState := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10effect/nf-d3d10effect-id3d10effectdepthstencilvariable-getbackingstore
     */
    GetBackingStore(Index) {
        pDepthStencilDesc := D3D10_DEPTH_STENCIL_DESC()
        result := ComCall(26, this, "uint", Index, "ptr", pDepthStencilDesc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
