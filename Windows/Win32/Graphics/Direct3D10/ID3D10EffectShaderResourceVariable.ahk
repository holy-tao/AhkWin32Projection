 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d10effect/nn-d3d10effect-id3d10effectshaderresourcevariable
 * @namespace Windows.Win32.Graphics.Direct3D10
 */
export default struct ID3D10EffectShaderResourceVariable extends ID3D10EffectVariable {
    /**
     ...
     * used for ID3D10EffectShaderResourceVariable interfaces
    */
    struct Vtbl extends ID3D10EffectVariable.Vtbl {
        SetResource      : IntPtr
        GetResource      : IntPtr
        SetResourceArray : IntPtr
        GetResourceArray : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D10EffectShaderResourceVariable.Vtbl()
        }
    ...
    Query(iid) {
        if (ID3D10EffectShaderResourceVariable.IID.Equals(iid)) {
            return true
        }
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.SetResource)
        CallbackFree(this.vtbl.GetResource)
        CallbackFree(this.vtbl.SetResourceArray)
        CallbackFree(this.vtbl.GetResourceArray)
    }
}
