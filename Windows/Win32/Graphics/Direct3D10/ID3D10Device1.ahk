 ...
 */
export default struct ID3D10Device1 extends ID3D10Device {
    /**
     ...
     * used for ID3D10Device1 interfaces
    */
    struct Vtbl extends ID3D10Device.Vtbl {
    ...
    CreateBlendState1(pBlendStateDesc) {
        result := ComCall(99, this, D3D10_BLEND_DESC1.Ptr, pBlendStateDesc, "ptr*", &ppBlendState := 0, "HRESULT")
     ...
     */
    GetFeatureLevel() {
        result := ComCall(100, this, D3D10_FEATURE_LEVEL1)
        return result
    }
