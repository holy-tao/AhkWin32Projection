 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d10_1/nn-d3d10_1-id3d10device1
...
class ID3D10Device1 extends ID3D10Device{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10_1/nf-d3d10_1-id3d10device1-createshaderresourceview1
     */
    CreateShaderResourceView1(pResource, pDesc) {
        result := ComCall(98, this, "ptr", pResource, "ptr", pDesc, "ptr*", &ppSRView := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10_1/nf-d3d10_1-id3d10device1-createblendstate1
     */
    CreateBlendState1(pBlendStateDesc) {
        result := ComCall(99, this, "ptr", pBlendStateDesc, "ptr*", &ppBlendState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d10_1/nf-d3d10_1-id3d10device1-getfeaturelevel
     */
    GetFeatureLevel() {
