...
#Import ".\D3D10_TEXCUBE_ARRAY_SRV1.ahk" { D3D10_TEXCUBE_ARRAY_SRV1 }
 ...
 */
export default struct D3D10_SHADER_RESOURCE_VIEW_DESC1 {
    #StructPack 4
    ...
    static __New() {
        ...
        DefineProp(this.Prototype, 'TextureCubeArray', { type: D3D10_TEXCUBE_ARRAY_SRV1, offset: 8 })
