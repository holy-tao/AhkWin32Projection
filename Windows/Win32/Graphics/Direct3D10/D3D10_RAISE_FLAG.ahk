 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d10/ne-d3d10-d3d10_raise_flag
 * @namespace Windows.Win32.Graphics.Direct3D10
 */
class D3D10_RAISE_FLAG extends Win32Enum {

    /**
     * Raise an internal driver error to a non-continuable exception.
     * Native name: D3D10_RAISE_FLAG_DRIVER_INTERNAL_ERROR
     * @type {Integer (Int32)}
     */
