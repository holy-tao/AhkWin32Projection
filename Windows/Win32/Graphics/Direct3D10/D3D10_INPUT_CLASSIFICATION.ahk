 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d10/ne-d3d10-d3d10_input_classification
 * @namespace Windows.Win32.Graphics.Direct3D10
 */
class D3D10_INPUT_CLASSIFICATION extends Win32Enum {

    /**
     * Input data is per-vertex data.
     * Native name: D3D10_INPUT_PER_VERTEX_DATA
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D10_INPUT_PER_INSTANCE_DATA
     * @type {Integer (Int32)}
     */
