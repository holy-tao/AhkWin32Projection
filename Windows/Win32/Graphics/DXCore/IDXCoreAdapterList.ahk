 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nn-dxcore_interface-idxcoreadapterlist
...
class IDXCoreAdapterList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-getadapter
     */
    GetAdapter(index, riid) {
        result := ComCall(3, this, "uint", index, "ptr", riid, "ptr*", &ppvAdapter := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-getadaptercount
     */
    GetAdapterCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-isstale
     */
    IsStale() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-getfactory
     */
    GetFactory(riid) {
        result := ComCall(6, this, "ptr", riid, "ptr*", &ppvFactory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-sort
     */
    Sort(numPreferences, preferences) {
        preferencesMarshal := preferences is VarRef ? "uint*" : "ptr"

        result := ComCall(7, this, "uint", numPreferences, preferencesMarshal, preferences, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapterlist-isadapterpreferencesupported
     */
