...
class IDXCoreAdapter extends IUnknown{
    ...
    GetProperty(property, bufferSize, propertyData) {
        result := ComCall(6, this, "uint", property, "ptr", bufferSize, "ptr", propertyData, "int")
        if(result != 0)
     ...
     * 
     * @param {Integer} property 
     * @param {Pointer<UIntPtr>} bufferSize 
     * @returns {HRESULT} 
     */
    GetPropertySize(property, bufferSize) {
        result := ComCall(7, this, "uint", property, "ptr*", bufferSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFactory(riid, ppvFactory) {
        result := ComCall(12, this, "ptr", riid, "ptr", ppvFactory, "int")
        if(result != 0)
            throw OSError(result)
