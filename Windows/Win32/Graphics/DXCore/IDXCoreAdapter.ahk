 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nn-dxcore_interface-idxcoreadapter
...
class IDXCoreAdapter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-isvalid
     */
    IsValid() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-isattributesupported
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-ispropertysupported
     */
    IsPropertySupported(property_) {
        result := ComCall(5, this, "uint", property_, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-getproperty
     */
    GetProperty(property_, bufferSize, propertyData) {
        result := ComCall(6, this, "uint", property_, "ptr", bufferSize, "ptr", propertyData, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-getpropertysize
     */
    GetPropertySize(property_) {
        result := ComCall(7, this, "uint", property_, "ptr*", &bufferSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-isquerystatesupported
     */
    IsQueryStateSupported(property_) {
        result := ComCall(8, this, "uint", property_, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-querystate
     */
    QueryState(state, inputStateDetailsSize, inputStateDetails, outputBufferSize, outputBuffer) {
        result := ComCall(9, this, "uint", state, "ptr", inputStateDetailsSize, "ptr", inputStateDetails, "ptr", outputBufferSize, "ptr", outputBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-issetstatesupported
     */
    IsSetStateSupported(property_) {
        result := ComCall(10, this, "uint", property_, "int")
        return result
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-setstate
     */
    SetState(state, inputStateDetailsSize, inputStateDetails, inputDataSize, inputData) {
        result := ComCall(11, this, "uint", state, "ptr", inputStateDetailsSize, "ptr", inputStateDetails, "ptr", inputDataSize, "ptr", inputData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dxcore_interface/nf-dxcore_interface-idxcoreadapter-getfactory
     */
    GetFactory(riid) {
        result := ComCall(12, this, "ptr", riid, "ptr*", &ppvFactory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
