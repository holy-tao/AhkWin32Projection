 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nn-dwrite_2-idwritefactory2
...
class IDWriteFactory2 extends IDWriteFactory1{
     ...
     * @returns {Pointer<IDWriteFontFallback>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite_2/nn-dwrite_2-idwritefontfallback">IDWriteFontFallback</a>**</b>
     * 
     * Contains an address of a pointer to the newly created font fallback object.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritefactory2-getsystemfontfallback
     */
    GetSystemFontFallback() {
        result := ComCall(26, this, "ptr*", &fontFallback := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<IDWriteFontFallbackBuilder>} Type: <b><a href="https://docs.microsoft.com/windows/win32/DirectWrite/idwritefontfallbackbuilder">IDWriteFontFallbackBuilder</a>**</b>
     * 
     * Contains an address of a pointer to the newly created font fallback builder object.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritefactory2-createfontfallbackbuilder
     */
    CreateFontFallbackBuilder() {
        result := ComCall(27, this, "ptr*", &fontFallbackBuilder := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return fontFallbackBuilder
    }
     ...
     * @returns {Pointer<IDWriteColorGlyphRunEnumerator>} Type: <b><a href="https://docs.microsoft.com/windows/win32/DirectWrite/idwritecolorglyphrunenumerator">IDWriteColorGlyphRunEnumerator</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritefactory2-translatecolorglyphrun
     */
    TranslateColorGlyphRun(baselineOriginX, baselineOriginY, glyphRun_, glyphRunDescription, measuringMode, worldToDeviceTransform, colorPaletteIndex) {
        result := ComCall(28, this, "float", baselineOriginX, "float", baselineOriginY, "ptr", glyphRun_, "ptr", glyphRunDescription, "int", measuringMode, "ptr", worldToDeviceTransform, "uint", colorPaletteIndex, "ptr*", &colorLayers := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IDWriteRenderingParams2>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite_2/nn-dwrite_2-idwriterenderingparams2">IDWriteRenderingParams2</a>**</b>
     * 
     * Holds the newly created rendering parameters object, or NULL in case of failure.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritefactory2-createcustomrenderingparams
     */
    CreateCustomRenderingParams(gamma, enhancedContrast, grayscaleEnhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, gridFitMode) {
        result := ComCall(29, this, "float", gamma, "float", enhancedContrast, "float", grayscaleEnhancedContrast, "float", clearTypeLevel, "int", pixelGeometry, "int", renderingMode, "int", gridFitMode, "ptr*", &renderingParams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritefactory2-createglyphrunanalysis
     */
    CreateGlyphRunAnalysis(glyphRun_, transform, renderingMode, measuringMode, gridFitMode, antialiasMode, baselineOriginX, baselineOriginY) {
        result := ComCall(30, this, "ptr", glyphRun_, "ptr", transform, "int", renderingMode, "int", measuringMode, "int", gridFitMode, "int", antialiasMode, "float", baselineOriginX, "float", baselineOriginY, "ptr*", &glyphRunAnalysis := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
