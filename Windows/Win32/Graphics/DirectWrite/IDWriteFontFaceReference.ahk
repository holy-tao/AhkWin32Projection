 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontfacereference
...
class IDWriteFontFaceReference extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-createfontface
     */
    CreateFontFace() {
        result := ComCall(3, this, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
     ...
     * 
     * Newly created font face object, or nullptr in the case of failure.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-createfontfacewithsimulations
     */
    CreateFontFaceWithSimulations(fontFaceSimulationFlags) {
        result := ComCall(4, this, "int", fontFaceSimulationFlags, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getfontfaceindex
     */
    GetFontFaceIndex() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getsimulations
     */
    GetSimulations() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getfontfile
     */
    GetFontFile() {
        result := ComCall(8, this, "ptr*", &fontFile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getlocalfilesize
     */
    GetLocalFileSize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getfilesize
     */
    GetFileSize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getfiletime
     */
    GetFileTime() {
        lastWriteTime := FILETIME()
        result := ComCall(11, this, "ptr", lastWriteTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-getlocality
     */
    GetLocality() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-enqueuefontdownloadrequest
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-enqueuecharacterdownloadrequest
     */
    EnqueueCharacterDownloadRequest(characters, characterCount) {
        characters := characters is String ? StrPtr(characters) : characters

        result := ComCall(14, this, "ptr", characters, "uint", characterCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-enqueueglyphdownloadrequest
     */
    EnqueueGlyphDownloadRequest(glyphIndices, glyphCount) {
        glyphIndicesMarshal := glyphIndices is VarRef ? "ushort*" : "ptr"

        result := ComCall(15, this, glyphIndicesMarshal, glyphIndices, "uint", glyphCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference-enqueuefilefragmentdownloadrequest
     */
    EnqueueFileFragmentDownloadRequest(fileOffset, fragmentSize) {
        result := ComCall(16, this, "uint", fileOffset, "uint", fragmentSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
