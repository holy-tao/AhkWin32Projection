 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nn-dwrite_1-idwritetextanalysissink1
...
class IDWriteTextAnalysisSink1 extends IDWriteTextAnalysisSink{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritetextanalysissink1-setglyphorientation
     */
    SetGlyphOrientation(textPosition, textLength, glyphOrientationAngle, adjustedBidiLevel, isSideways, isRightToLeft) {
        result := ComCall(7, this, "uint", textPosition, "uint", textLength, "int", glyphOrientationAngle, "char", adjustedBidiLevel, "int", isSideways, "int", isRightToLeft, "int")
        if(result != 0) {
