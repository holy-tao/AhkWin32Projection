...
class DWRITE_BREAK_CONDITION extends Win32Enum {
     ...
     * Native name: DWRITE_BREAK_CONDITION_NEUTRAL
     * @type {Integer (Int32)}
     */
    static NEUTRAL => 0
     ...
     * Native name: DWRITE_BREAK_CONDITION_CAN_BREAK
     * @type {Integer (Int32)}
     */
    static CAN_BREAK => 1
     ...
     * Native name: DWRITE_BREAK_CONDITION_MAY_NOT_BREAK
     * @type {Integer (Int32)}
     */
    static MAY_NOT_BREAK => 2

    /**
     * Indicates that the line break must happen, regardless of the condition of the adjacent
     *      text span or inline object.
     * Native name: DWRITE_BREAK_CONDITION_MUST_BREAK
     * @type {Integer (Int32)}
     */
    static MUST_BREAK => 3
}
