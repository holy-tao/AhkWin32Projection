 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontface4
...
class IDWriteFontFace4 extends IDWriteFontFace3{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontface4-getglyphimageformats
     */
    GetGlyphImageFormats(glyphId, pixelsPerEmFirst, pixelsPerEmLast) {
        result := ComCall(49, this, "ushort", glyphId, "uint", pixelsPerEmFirst, "uint", pixelsPerEmLast, "int*", &glyphImageFormats := 0, "int")
        if(result != 0) {
     ...
     * @param {Pointer<DWRITE_GLYPH_IMAGE_DATA>} glyphData_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite_3/ns-dwrite_3-dwrite_glyph_image_data">DWRITE_GLYPH_IMAGE_DATA</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontface4-getglyphimagedata
     */
    GetGlyphImageData(glyphId, pixelsPerEm, glyphImageFormat, glyphData_, glyphDataContext) {
        glyphDataContextMarshal := glyphDataContext is VarRef ? "ptr*" : "ptr"

        result := ComCall(51, this, "ushort", glyphId, "uint", pixelsPerEm, "int", glyphImageFormat, "ptr", glyphData_, glyphDataContextMarshal, glyphDataContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontface4-releaseglyphimagedata
     */
