...
#Import ".\DWRITE_FACTORY_TYPE.ahk" { DWRITE_FACTORY_TYPE }
 ...
 * @since windows6.1
 */
export DWriteCreateFactory(factoryType, iid) {
    result := DllCall("DWrite.dll\DWriteCreateFactory", DWRITE_FACTORY_TYPE, factoryType, Guid.Ptr, iid, "ptr*", &factory := 0, "HRESULT")
    return factory
}
