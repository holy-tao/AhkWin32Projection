 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nn-dwrite-idwritefont
...
class IDWriteFont extends IUnknown{
     ...
     * @returns {Pointer<IDWriteFontFamily>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getfontfamily
     */
    GetFontFamily() {
        result := ComCall(3, this, "ptr*", &fontFamily_ := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getweight
     */
    GetWeight() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getstretch
     */
    GetStretch() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getstyle
     */
    GetStyle() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-issymbolfont
     */
    IsSymbolFont() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getfacenames
     */
    GetFaceNames() {
        result := ComCall(8, this, "ptr*", &names := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getinformationalstrings
     */
    GetInformationalStrings(informationalStringID, informationalStrings, exists) {
        existsMarshal := exists is VarRef ? "int*" : "ptr"

        result := ComCall(9, this, "int", informationalStringID, "ptr*", informationalStrings, existsMarshal, exists, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getsimulations
     */
    GetSimulations() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-getmetrics
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-hascharacter
     */
    HasCharacter(unicodeValue) {
        result := ComCall(12, this, "uint", unicodeValue, "int*", &exists := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritefont-createfontface
     */
    CreateFontFace() {
        result := ComCall(13, this, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
