 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nn-dwrite-idwritegdiinterop
...
class IDWriteGdiInterop extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritegdiinterop-createfontfromlogfont
     */
    CreateFontFromLOGFONT(logFont) {
        result := ComCall(3, this, "ptr", logFont, "ptr*", &font_ := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritegdiinterop-convertfonttologfont
     */
    ConvertFontToLOGFONT(font_, logFont, isSystemFont) {
        isSystemFontMarshal := isSystemFont is VarRef ? "int*" : "ptr"

        result := ComCall(4, this, "ptr", font_, "ptr", logFont, isSystemFontMarshal, isSystemFont, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {IDWriteFontFace} font_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite/nn-dwrite-idwritefontface">IDWriteFontFace</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritegdiinterop-convertfontfacetologfont
     */
    ConvertFontFaceToLOGFONT(font_) {
        logFont := LOGFONTW()
        result := ComCall(5, this, "ptr", font_, "ptr", logFont, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritegdiinterop-createfontfacefromhdc
     */
    CreateFontFaceFromHdc(hdc_) {
        hdc_ := hdc_ is Win32Handle ? NumGet(hdc_, "ptr") : hdc_

        result := ComCall(6, this, "ptr", hdc_, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<IDWriteBitmapRenderTarget>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite/nn-dwrite-idwritebitmaprendertarget">IDWriteBitmapRenderTarget</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritegdiinterop-createbitmaprendertarget
     */
    CreateBitmapRenderTarget(hdc_, width, height) {
        hdc_ := hdc_ is Win32Handle ? NumGet(hdc_, "ptr") : hdc_

        result := ComCall(7, this, "ptr", hdc_, "uint", width, "uint", height, "ptr*", &renderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
