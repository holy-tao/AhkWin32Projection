 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontsetbuilder2
...
class IDWriteFontSetBuilder2 extends IDWriteFontSetBuilder1{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontsetbuilder2-addfont
     */
    AddFont(fontFile, fontFaceIndex, fontSimulations, fontAxisValues, fontAxisValueCount, fontAxisRanges, fontAxisRangeCount, properties_, propertyCount) {
        result := ComCall(8, this, "ptr", fontFile, "uint", fontFaceIndex, "int", fontSimulations, "ptr", fontAxisValues, "uint", fontAxisValueCount, "ptr", fontAxisRanges, "uint", fontAxisRangeCount, "ptr", properties_, "uint", propertyCount, "int")
        if(result != 0) {
     ...
     * 
     * If the function succeeds, it returns **S_OK**. Otherwise, it returns an [**HRESULT**](/windows/win32/com/structure-of-com-error-codes) [error code](/windows/win32/com/com-error-codes-10).
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontsetbuilder2-addfontfile
     */
    AddFontFile(filePath) {
        filePath := filePath is String ? StrPtr(filePath) : filePath

        result := ComCall(9, this, "ptr", filePath, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
