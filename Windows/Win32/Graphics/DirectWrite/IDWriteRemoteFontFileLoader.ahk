 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwriteremotefontfileloader
...
class IDWriteRemoteFontFileLoader extends IDWriteFontFileLoader{
     ...
     * @returns {Pointer<IDWriteRemoteFontFileStream>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite_3/nn-dwrite_3-idwriteremotefontfilestream">IDWriteRemoteFontFileStream</a>**</b>
     * 
     * Pointer to the newly created font file stream.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwriteremotefontfileloader-createremotestreamfromkey
     */
    CreateRemoteStreamFromKey(fontFileReferenceKey, fontFileReferenceKeySize) {
        result := ComCall(4, this, "ptr", fontFileReferenceKey, "uint", fontFileReferenceKeySize, "ptr*", &fontFileStream := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwriteremotefontfileloader-getlocalityfromkey
     */
    GetLocalityFromKey(fontFileReferenceKey, fontFileReferenceKeySize) {
        result := ComCall(5, this, "ptr", fontFileReferenceKey, "uint", fontFileReferenceKeySize, "int*", &locality := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwriteremotefontfileloader-createfontfilereferencefromurl
     */
    CreateFontFileReferenceFromUrl(factory, baseUrl, fontFileUrl) {
        ...
        result := ComCall(6, this, "ptr", factory, "ptr", baseUrl, "ptr", fontFileUrl, "ptr*", &fontFile := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
