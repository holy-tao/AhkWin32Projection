 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontlist1
...
class IDWriteFontList1 extends IDWriteFontList{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontlist1-getfontlocality
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontlist1-getfont
     */
    GetFont(listIndex) {
        result := ComCall(7, this, "uint", listIndex, "ptr*", &font_ := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontlist1-getfontfacereference
     */
    GetFontFaceReference(listIndex) {
        result := ComCall(8, this, "uint", listIndex, "ptr*", &fontFaceReference := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
