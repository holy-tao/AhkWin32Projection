...
export default struct IDWriteTextFormat3 extends IDWriteTextFormat2 {
    ...
    */
    ...
    SetFontAxisValues(fontAxisValues, fontAxisValueCount) {
        result := ComCall(38, this, DWRITE_FONT_AXIS_VALUE.Ptr, fontAxisValues, UInt32, fontAxisValueCount, "HRESULT")
        return result
    }
    ...
    GetFontAxisValues(fontAxisValueCount) {
        ...
        result := ComCall(40, this, DWRITE_FONT_AXIS_VALUE.Ptr, fontAxisValues, UInt32, fontAxisValueCount, "HRESULT")
