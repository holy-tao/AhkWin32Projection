 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontresource
...
class IDWriteFontResource extends IUnknown{
     ...
     * @returns {Pointer<IDWriteFontFile>} Type: **[IDWriteFontFile](../dwrite/nn-dwrite-idwritefontfile.md)\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getfontfile
     */
    GetFontFile() {
        result := ComCall(3, this, "ptr*", &fontFile := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getfontfaceindex
     */
    GetFontFaceIndex() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getfontaxiscount
     */
    GetFontAxisCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getdefaultfontaxisvalues
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getfontaxisranges
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getfontaxisattributes
     */
     ...
     * 
     * Font axis, from 0 to [GetFontAxisCount](./nf-dwrite_3-idwritefontresource-getfontaxiscount.md) minus 1.
     * @returns {Pointer<IDWriteLocalizedStrings>} Type: **[IDWriteLocalizedStrings](../dwrite/nn-dwrite-idwritelocalizedstrings.md)\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getaxisnames
     */
    GetAxisNames(axisIndex) {
        result := ComCall(9, this, "uint", axisIndex, "ptr*", &names := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getaxisvaluenamecount
     */
     ...
     * @param {Pointer<Pointer<IDWriteLocalizedStrings>>} names Type: **[IDWriteLocalizedStrings](../dwrite/nn-dwrite-idwritelocalizedstrings.md)\*\***
     * 
     * The address of a pointer to an [IDWriteLocalizedStrings](../dwrite/nn-dwrite-idwritelocalizedstrings.md) interface. On successful completion, the function sets the pointer to a newly created localized strings object.
     * @returns {HRESULT} Type: **[HRESULT](/windows/win32/com/structure-of-com-error-codes)**
     * 
     * If the function succeeds, it returns **S_OK**. Otherwise, it returns an [**HRESULT**](/windows/win32/com/structure-of-com-error-codes) [error code](/windows/win32/com/com-error-codes-10).
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-getaxisvaluenames
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-hasvariations
     */
    HasVariations() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-createfontface
     */
    CreateFontFace(fontSimulations, fontAxisValues, fontAxisValueCount) {
        result := ComCall(13, this, "int", fontSimulations, "ptr", fontAxisValues, "uint", fontAxisValueCount, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontresource-createfontfacereference
     */
    CreateFontFaceReference(fontSimulations, fontAxisValues, fontAxisValueCount) {
        result := ComCall(14, this, "int", fontSimulations, "ptr", fontAxisValues, "uint", fontAxisValueCount, "ptr*", &fontFaceReference := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
