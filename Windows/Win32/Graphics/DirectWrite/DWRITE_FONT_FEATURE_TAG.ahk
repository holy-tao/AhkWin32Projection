...
class DWRITE_FONT_FEATURE_TAG extends Win32Enum {
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_ALTERNATIVE_FRACTIONS
     * @type {Integer (UInt32)}
     */
    static ALTERNATIVE_FRACTIONS => 1668441697
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_PETITE_CAPITALS_FROM_CAPITALS
     * @type {Integer (UInt32)}
     */
    static PETITE_CAPITALS_FROM_CAPITALS => 1668297315
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SMALL_CAPITALS_FROM_CAPITALS
     * @type {Integer (UInt32)}
     */
    static SMALL_CAPITALS_FROM_CAPITALS => 1668493923
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_CONTEXTUAL_ALTERNATES
     * @type {Integer (UInt32)}
     */
    static CONTEXTUAL_ALTERNATES => 1953259875
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_CASE_SENSITIVE_FORMS
     * @type {Integer (UInt32)}
     */
    static CASE_SENSITIVE_FORMS => 1702060387
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_GLYPH_COMPOSITION_DECOMPOSITION
     * @type {Integer (UInt32)}
     */
    static GLYPH_COMPOSITION_DECOMPOSITION => 1886217059
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_CONTEXTUAL_LIGATURES
     * @type {Integer (UInt32)}
     */
    static CONTEXTUAL_LIGATURES => 1734962275
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_CAPITAL_SPACING
     * @type {Integer (UInt32)}
     */
    static CAPITAL_SPACING => 1886613603
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_CONTEXTUAL_SWASH
     * @type {Integer (UInt32)}
     */
    static CONTEXTUAL_SWASH => 1752658787

    /**
     * In cursive scripts like Arabic, this feature cursively positions adjacent glyphs.
     * 
     * <b>Equivalent OpenType tag:</b> 'curs'
     * Native name: DWRITE_FONT_FEATURE_TAG_CURSIVE_POSITIONING
     * @type {Integer (UInt32)}
     */
    static CURSIVE_POSITIONING => 1936880995

    /**
     * The default.
     * Native name: DWRITE_FONT_FEATURE_TAG_DEFAULT
     * @type {Integer (UInt32)}
     */
    static DEFAULT => 1953261156
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_DISCRETIONARY_LIGATURES
     * @type {Integer (UInt32)}
     */
    static DISCRETIONARY_LIGATURES => 1734962276
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_EXPERT_FORMS
     * @type {Integer (UInt32)}
     */
    static EXPERT_FORMS => 1953527909

    /**
     * Replaces figures separated by a slash with 'common' (diagonal) fractions.
     * 
     * <b>Equivalent OpenType tag:</b> 'frac'
     * Native name: DWRITE_FONT_FEATURE_TAG_FRACTIONS
     * @type {Integer (UInt32)}
     */
    static FRACTIONS => 1667330662
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_FULL_WIDTH
     * @type {Integer (UInt32)}
     */
    static FULL_WIDTH => 1684633446
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HALF_FORMS
     * @type {Integer (UInt32)}
     */
    static HALF_FORMS => 1718378856
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HALANT_FORMS
     * @type {Integer (UInt32)}
     */
    static HALANT_FORMS => 1852596584
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_ALTERNATE_HALF_WIDTH
     * @type {Integer (UInt32)}
     */
    static ALTERNATE_HALF_WIDTH => 1953259880
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HISTORICAL_FORMS
     * @type {Integer (UInt32)}
     */
    static HISTORICAL_FORMS => 1953720680
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HORIZONTAL_KANA_ALTERNATES
     * @type {Integer (UInt32)}
     */
    static HORIZONTAL_KANA_ALTERNATES => 1634626408
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HISTORICAL_LIGATURES
     * @type {Integer (UInt32)}
     */
    static HISTORICAL_LIGATURES => 1734962280
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HALF_WIDTH
     * @type {Integer (UInt32)}
     */
    static HALF_WIDTH => 1684633448
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_HOJO_KANJI_FORMS
     * @type {Integer (UInt32)}
     */
    static HOJO_KANJI_FORMS => 1869246312
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_JIS04_FORMS
     * @type {Integer (UInt32)}
     */
    static JIS04_FORMS => 875589738
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_JIS78_FORMS
     * @type {Integer (UInt32)}
     */
    static JIS78_FORMS => 943157354
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_JIS83_FORMS
     * @type {Integer (UInt32)}
     */
    static JIS83_FORMS => 859336810
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_JIS90_FORMS
     * @type {Integer (UInt32)}
     */
    static JIS90_FORMS => 809070698
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_KERNING
     * @type {Integer (UInt32)}
     */
    static KERNING => 1852990827
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_STANDARD_LIGATURES
     * @type {Integer (UInt32)}
     */
    static STANDARD_LIGATURES => 1634167148
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_LINING_FIGURES
     * @type {Integer (UInt32)}
     */
    static LINING_FIGURES => 1836412524
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_LOCALIZED_FORMS
     * @type {Integer (UInt32)}
     */
    static LOCALIZED_FORMS => 1818455916
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_MARK_POSITIONING
     * @type {Integer (UInt32)}
     */
    static MARK_POSITIONING => 1802658157
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_MATHEMATICAL_GREEK
     * @type {Integer (UInt32)}
     */
    static MATHEMATICAL_GREEK => 1802659693
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_MARK_TO_MARK_POSITIONING
     * @type {Integer (UInt32)}
     */
    static MARK_TO_MARK_POSITIONING => 1802333037
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_ALTERNATE_ANNOTATION_FORMS
     * @type {Integer (UInt32)}
     */
    static ALTERNATE_ANNOTATION_FORMS => 1953259886
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_NLC_KANJI_FORMS
     * @type {Integer (UInt32)}
     */
    static NLC_KANJI_FORMS => 1801677934
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_OLD_STYLE_FIGURES
     * @type {Integer (UInt32)}
     */
    static OLD_STYLE_FIGURES => 1836412527
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_ORDINALS
     * @type {Integer (UInt32)}
     */
    static ORDINALS => 1852076655
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_PROPORTIONAL_ALTERNATE_WIDTH
     * @type {Integer (UInt32)}
     */
    static PROPORTIONAL_ALTERNATE_WIDTH => 1953259888
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_PETITE_CAPITALS
     * @type {Integer (UInt32)}
     */
    static PETITE_CAPITALS => 1885430640
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_PROPORTIONAL_FIGURES
     * @type {Integer (UInt32)}
     */
    static PROPORTIONAL_FIGURES => 1836412528
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_PROPORTIONAL_WIDTHS
     * @type {Integer (UInt32)}
     */
    static PROPORTIONAL_WIDTHS => 1684633456
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_QUARTER_WIDTHS
     * @type {Integer (UInt32)}
     */
    static QUARTER_WIDTHS => 1684633457
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_REQUIRED_LIGATURES
     * @type {Integer (UInt32)}
     */
    static REQUIRED_LIGATURES => 1734962290
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_RUBY_NOTATION_FORMS
     * @type {Integer (UInt32)}
     */
    static RUBY_NOTATION_FORMS => 2036495730
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_ALTERNATES
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_ALTERNATES => 1953259891
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SCIENTIFIC_INFERIORS
     * @type {Integer (UInt32)}
     */
    static SCIENTIFIC_INFERIORS => 1718511987
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SMALL_CAPITALS
     * @type {Integer (UInt32)}
     */
    static SMALL_CAPITALS => 1885564275

    /**
     * Replaces 'traditional' Chinese or Japanese forms with the corresponding 'simplified' forms.
     * 
     * <b>Equivalent OpenType tag:</b> 'smpl'
     * Native name: DWRITE_FONT_FEATURE_TAG_SIMPLIFIED_FORMS
     * @type {Integer (UInt32)}
     */
    static SIMPLIFIED_FORMS => 1819307379
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_1 => 825258867
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_2
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_2 => 842036083

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss03'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_3
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_3 => 858813299

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss04'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_4
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_4 => 875590515

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss05'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_5
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_5 => 892367731

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss06'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_6
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_6 => 909144947

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss07'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_7
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_7 => 925922163

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss08'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_8
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_8 => 942699379

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss09'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_9
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_9 => 959476595

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss10'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_10
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_10 => 808547187

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss11'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_11
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_11 => 825324403

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss12'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_12
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_12 => 842101619

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss13'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_13
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_13 => 858878835

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss14'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_14
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_14 => 875656051

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss15'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_15
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_15 => 892433267

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss16'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_16
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_16 => 909210483

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss17'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_17
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_17 => 925987699

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss18'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_18
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_18 => 942764915

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss19'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_19
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_19 => 959542131

    /**
     * See the description for <a href="https://docs.microsoft.com/windows/win32/api/dwrite/ne-dwrite-dwrite_font_feature_tag">DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_1</a>.
     * 
     * <b>Equivalent OpenType tag:</b> 'ss20'
     * Native name: DWRITE_FONT_FEATURE_TAG_STYLISTIC_SET_20
     * @type {Integer (UInt32)}
     */
    static STYLISTIC_SET_20 => 808612723
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SUBSCRIPT
     * @type {Integer (UInt32)}
     */
    static SUBSCRIPT => 1935832435
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SUPERSCRIPT
     * @type {Integer (UInt32)}
     */
    static SUPERSCRIPT => 1936749939
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SWASH
     * @type {Integer (UInt32)}
     */
    static SWASH => 1752397683
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_TITLING
     * @type {Integer (UInt32)}
     */
    static TITLING => 1819568500
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_TRADITIONAL_NAME_FORMS
     * @type {Integer (UInt32)}
     */
    static TRADITIONAL_NAME_FORMS => 1835101812
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_TABULAR_FIGURES
     * @type {Integer (UInt32)}
     */
    static TABULAR_FIGURES => 1836412532
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_TRADITIONAL_FORMS
     * @type {Integer (UInt32)}
     */
    static TRADITIONAL_FORMS => 1684107892
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_THIRD_WIDTHS
     * @type {Integer (UInt32)}
     */
    static THIRD_WIDTHS => 1684633460
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_UNICASE
     * @type {Integer (UInt32)}
     */
    static UNICASE => 1667853941

    /**
     * Indicates that the font is displayed vertically.
     * Native name: DWRITE_FONT_FEATURE_TAG_VERTICAL_WRITING
     * @type {Integer (UInt32)}
     */
    static VERTICAL_WRITING => 1953654134

    /**
     * Replaces normal figures with figures adjusted for vertical display.
     * Native name: DWRITE_FONT_FEATURE_TAG_VERTICAL_ALTERNATES_AND_ROTATION
     * @type {Integer (UInt32)}
     */
    static VERTICAL_ALTERNATES_AND_ROTATION => 846492278
     ...
     * Native name: DWRITE_FONT_FEATURE_TAG_SLASHED_ZERO
     * @type {Integer (UInt32)}
     */
    static SLASHED_ZERO => 1869768058
}
