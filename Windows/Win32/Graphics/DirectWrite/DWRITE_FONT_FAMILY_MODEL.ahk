...
class DWRITE_FONT_FAMILY_MODEL extends Win32Enum {
     ...
     * Native name: DWRITE_FONT_FAMILY_MODEL_TYPOGRAPHIC
     * @type {Integer (Int32)}
     */
    static TYPOGRAPHIC => 0
     ...
     * Native name: DWRITE_FONT_FAMILY_MODEL_WEIGHT_STRETCH_STYLE
     * @type {Integer (Int32)}
     */
    static WEIGHT_STRETCH_STYLE => 1
}
