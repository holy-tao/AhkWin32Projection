 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nn-dwrite_1-idwritefactory1
...
class IDWriteFactory1 extends IDWriteFactory{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefactory1-geteudcfontcollection
     */
    GetEudcFontCollection(checkForUpdates) {
        result := ComCall(24, this, "ptr*", &fontCollection_ := 0, "int", checkForUpdates, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<IDWriteRenderingParams1>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite_1/nn-dwrite_1-idwriterenderingparams1">IDWriteRenderingParams1</a>**</b>
     * 
     * When this method returns, contains an address of a pointer to the newly created rendering parameters object.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefactory1-createcustomrenderingparams
     */
    CreateCustomRenderingParams(gamma, enhancedContrast, enhancedContrastGrayscale, clearTypeLevel, pixelGeometry, renderingMode) {
        result := ComCall(25, this, "float", gamma, "float", enhancedContrast, "float", enhancedContrastGrayscale, "float", clearTypeLevel, "int", pixelGeometry, "int", renderingMode, "ptr*", &renderingParams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
