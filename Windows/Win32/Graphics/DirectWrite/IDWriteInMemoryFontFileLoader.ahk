 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwriteinmemoryfontfileloader
...
class IDWriteInMemoryFontFileLoader extends IDWriteFontFileLoader{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwriteinmemoryfontfileloader-createinmemoryfontfilereference
     */
    CreateInMemoryFontFileReference(factory, fontData, fontDataSize, ownerObject) {
        result := ComCall(4, this, "ptr", factory, "ptr", fontData, "uint", fontDataSize, "ptr", ownerObject, "ptr*", &fontFile := 0, "int")
        if(result != 0) {
     ...
     * 
     * Returns the number of font file references that have been created using this loader instance.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwriteinmemoryfontfileloader-getfilecount
     */
    GetFileCount() {
