 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nn-dwrite_2-idwritetextlayout2
...
class IDWriteTextLayout2 extends IDWriteTextLayout1{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-getmetrics
     */
    GetMetrics() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-setverticalglyphorientation
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-getverticalglyphorientation
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-setlastlinewrapping
     */
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-getlastlinewrapping
     */
    GetLastLineWrapping() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-setopticalalignment
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-getopticalalignment
     */
    GetOpticalAlignment() {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-setfontfallback
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_2/nf-dwrite_2-idwritetextlayout2-getfontfallback
     */
    GetFontFallback() {
        result := ComCall(79, this, "ptr*", &fontFallback := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
