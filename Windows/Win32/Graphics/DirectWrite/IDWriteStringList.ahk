 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritestringlist
...
class IDWriteStringList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritestringlist-getcount
     */
    GetCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritestringlist-getlocalenamelength
     */
    GetLocaleNameLength(listIndex) {
        result := ComCall(4, this, "uint", listIndex, "uint*", &length := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritestringlist-getlocalename
     */
    GetLocaleName(listIndex, localeName, size_) {
        localeName := localeName is String ? StrPtr(localeName) : localeName

        result := ComCall(5, this, "uint", listIndex, "ptr", localeName, "uint", size_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritestringlist-getstringlength
     */
    GetStringLength(listIndex) {
        result := ComCall(6, this, "uint", listIndex, "uint*", &length := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritestringlist-getstring
     */
