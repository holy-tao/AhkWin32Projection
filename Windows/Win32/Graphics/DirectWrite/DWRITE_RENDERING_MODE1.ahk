...
class DWRITE_RENDERING_MODE1 extends Win32Enum {
     ...
     * Native name: DWRITE_RENDERING_MODE1_DEFAULT
     * @type {Integer (Int32)}
     */
    static DEFAULT => 0
     ...
     * Native name: DWRITE_RENDERING_MODE1_ALIASED
     * @type {Integer (Int32)}
     */
    static ALIASED => 1
     ...
     * Native name: DWRITE_RENDERING_MODE1_GDI_CLASSIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DWRITE_RENDERING_MODE1_GDI_NATURAL
     * @type {Integer (Int32)}
     */
     ...
     *             The antialiasing may be either ClearType or grayscale depending on the text antialiasing mode.
     * Native name: DWRITE_RENDERING_MODE1_NATURAL
     * @type {Integer (Int32)}
     */
    static NATURAL => 4
     ...
     *           The antialiasing may be either ClearType or grayscale depending on the text antialiasing mode.
     * Native name: DWRITE_RENDERING_MODE1_NATURAL_SYMMETRIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: DWRITE_RENDERING_MODE1_OUTLINE
     * @type {Integer (Int32)}
     */
    static OUTLINE => 6
     ...
     * Native name: DWRITE_RENDERING_MODE1_NATURAL_SYMMETRIC_DOWNSAMPLED
     * @type {Integer (Int32)}
     */
    static NATURAL_SYMMETRIC_DOWNSAMPLED => 7
}
