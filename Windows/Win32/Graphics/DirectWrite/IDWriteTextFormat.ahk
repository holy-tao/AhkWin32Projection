 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nn-dwrite-idwritetextformat
...
class IDWriteTextFormat extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-settextalignment
     */
    SetTextAlignment(textAlignment) {
        result := ComCall(3, this, "int", textAlignment, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setparagraphalignment
     */
    SetParagraphAlignment(paragraphAlignment) {
        result := ComCall(4, this, "int", paragraphAlignment, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setwordwrapping
     */
    SetWordWrapping(wordWrapping) {
        result := ComCall(5, this, "int", wordWrapping, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setreadingdirection
     */
    SetReadingDirection(readingDirection) {
        result := ComCall(6, this, "int", readingDirection, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setflowdirection
     */
    SetFlowDirection(flowDirection) {
        result := ComCall(7, this, "int", flowDirection, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setincrementaltabstop
     */
    SetIncrementalTabStop(incrementalTabStop) {
        result := ComCall(8, this, "float", incrementalTabStop, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-settrimming
     */
    SetTrimming(trimmingOptions, trimmingSign) {
        result := ComCall(9, this, "ptr", trimmingOptions, "ptr", trimmingSign, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-setlinespacing
     */
    SetLineSpacing(lineSpacingMethod, lineSpacing, baseline) {
        result := ComCall(10, this, "int", lineSpacingMethod, "float", lineSpacing, "float", baseline, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-gettextalignment
     */
    GetTextAlignment() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getparagraphalignment
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getwordwrapping
     */
    GetWordWrapping() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getreadingdirection
     */
    GetReadingDirection() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getflowdirection
     */
    GetFlowDirection() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getincrementaltabstop
     */
     ...
     * @param {Pointer<Pointer<IDWriteInlineObject>>} trimmingSign Type: <b><a href="https://docs.microsoft.com/windows/win32/api/dwrite/nn-dwrite-idwriteinlineobject">IDWriteInlineObject</a>**</b>
     * 
     * When this method returns, contains an address of a pointer to a trimming omission sign. This parameter may be <b>NULL</b>.
     * @returns {HRESULT} Type: <b>HRESULT</b>
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-gettrimming
     */
    GetTrimming(trimmingOptions, trimmingSign) {
        result := ComCall(17, this, "ptr", trimmingOptions, "ptr*", trimmingSign, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getlinespacing
     */
    GetLineSpacing(lineSpacingMethod, lineSpacing, baseline) {
        ...
        result := ComCall(18, this, lineSpacingMethodMarshal, lineSpacingMethod, lineSpacingMarshal, lineSpacing, baselineMarshal, baseline, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontcollection
     */
    GetFontCollection() {
        result := ComCall(19, this, "ptr*", &fontCollection_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontfamilynamelength
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontfamilyname
     */
    GetFontFamilyName(fontFamilyName, nameSize) {
        fontFamilyName := fontFamilyName is String ? StrPtr(fontFamilyName) : fontFamilyName

        result := ComCall(21, this, "ptr", fontFamilyName, "uint", nameSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontweight
     */
    GetFontWeight() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontstyle
     */
    GetFontStyle() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontstretch
     */
    GetFontStretch() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getfontsize
     */
    GetFontSize() {
     ...
     * 
     * The size of the character array in character count, not including the terminated <b>NULL</b> character.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getlocalenamelength
     */
    GetLocaleNameLength() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite/nf-dwrite-idwritetextformat-getlocalename
     */
    GetLocaleName(localeName, nameSize) {
        localeName := localeName is String ? StrPtr(localeName) : localeName

        result := ComCall(27, this, "ptr", localeName, "uint", nameSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
