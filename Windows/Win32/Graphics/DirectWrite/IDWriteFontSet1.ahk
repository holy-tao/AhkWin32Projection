 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontset1
...
class IDWriteFontSet1 extends IDWriteFontSet{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getmatchingfonts
     */
    GetMatchingFonts(fontProperty, fontAxisValues, fontAxisValueCount) {
        result := ComCall(13, this, "ptr", fontProperty, "ptr", fontAxisValues, "uint", fontAxisValueCount, "ptr*", &matchingFonts := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfirstfontresources
     */
    GetFirstFontResources() {
        result := ComCall(14, this, "ptr*", &filteredFontSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfilteredfonts(uint32const_uint32_idwritefontset1)
     */
    GetFilteredFonts(indices, indexCount) {
        indicesMarshal := indices is VarRef ? "uint*" : "ptr"

        result := ComCall(15, this, indicesMarshal, indices, "uint", indexCount, "ptr*", &filteredFontSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetFilteredFonts1(fontAxisRanges, fontAxisRangeCount, selectAnyRange) {
        result := ComCall(16, this, "ptr", fontAxisRanges, "uint", fontAxisRangeCount, "int", selectAnyRange, "ptr*", &filteredFontSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfilteredfonts(uint32const_uint32_idwritefontset1)
     */
    GetFilteredFonts2(properties_, propertyCount, selectAnyProperty) {
        result := ComCall(17, this, "ptr", properties_, "uint", propertyCount, "int", selectAnyProperty, "ptr*", &filteredFontSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfilteredfontindices
     */
    GetFilteredFontIndices(fontAxisRanges, fontAxisRangeCount, selectAnyRange, indices, maxIndexCount, actualIndexCount) {
        ...
        result := ComCall(18, this, "ptr", fontAxisRanges, "uint", fontAxisRangeCount, "int", selectAnyRange, indicesMarshal, indices, "uint", maxIndexCount, actualIndexCountMarshal, actualIndexCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * Retrieves all the item indices, filtered by the given properties.
     * @param {Pointer<DWRITE_FONT_PROPERTY>} properties_ Type: **[DWRITE_FONT_PROPERTY](./ns-dwrite_3-dwrite_font_property.md) const \***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfilteredfontindices
     */
    GetFilteredFontIndices1(properties_, propertyCount, selectAnyProperty, indices, maxIndexCount, actualIndexCount) {
        indicesMarshal := indices is VarRef ? "uint*" : "ptr"
        actualIndexCountMarshal := actualIndexCount is VarRef ? "uint*" : "ptr"

        result := ComCall(19, this, "ptr", properties_, "uint", propertyCount, "int", selectAnyProperty, indicesMarshal, indices, "uint", maxIndexCount, actualIndexCountMarshal, actualIndexCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfontaxisranges
     */
    GetFontAxisRanges(listIndex, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount) {
        ...
        result := ComCall(20, this, "uint", listIndex, "ptr", fontAxisRanges, "uint", maxFontAxisRangeCount, actualFontAxisRangeCountMarshal, actualFontAxisRangeCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetFontAxisRanges1(fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount) {
        ...
        result := ComCall(21, this, "ptr", fontAxisRanges, "uint", maxFontAxisRangeCount, actualFontAxisRangeCountMarshal, actualFontAxisRangeCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfontfacereference
     */
    GetFontFaceReference(listIndex) {
        result := ComCall(22, this, "uint", listIndex, "ptr*", &fontFaceReference := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-createfontresource
     */
    CreateFontResource(listIndex) {
        result := ComCall(23, this, "uint", listIndex, "ptr*", &fontResource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Zero-based index of the font item in the set.
     * @returns {Pointer<IDWriteFontFace5>} Type: **[IDWriteFontFace5](./nn-dwrite_3-idwritefontface5.md)\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-createfontface
     */
    CreateFontFace(listIndex) {
        result := ComCall(24, this, "uint", listIndex, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontset1-getfontlocality
     */
