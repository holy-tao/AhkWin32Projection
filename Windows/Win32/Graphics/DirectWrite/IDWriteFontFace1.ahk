 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nn-dwrite_1-idwritefontface1
...
class IDWriteFontFace1 extends IDWriteFontFace{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getmetrics
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getgdicompatiblemetrics
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getcaretmetrics
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getunicoderanges
     */
    GetUnicodeRanges(maxRangeCount, unicodeRanges, actualRangeCount) {
        actualRangeCountMarshal := actualRangeCount is VarRef ? "uint*" : "ptr"

        result := ComCall(21, this, "uint", maxRangeCount, "ptr", unicodeRanges, actualRangeCountMarshal, actualRangeCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-ismonospacedfont
     */
    IsMonospacedFont() {
     ...
     *     each glyph.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getdesignglyphadvances
     */
    GetDesignGlyphAdvances(glyphCount, glyphIndices, isSideways) {
        glyphIndicesMarshal := glyphIndices is VarRef ? "ushort*" : "ptr"

        result := ComCall(23, this, "uint", glyphCount, glyphIndicesMarshal, glyphIndices, "int*", &glyphAdvances := 0, "int", isSideways, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The returned advances in font design units for
     *     each glyph.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getgdicompatibleglyphadvances
     */
    GetGdiCompatibleGlyphAdvances(emSize, pixelsPerDip, transform, useGdiNatural, isSideways, glyphCount, glyphIndices) {
        glyphIndicesMarshal := glyphIndices is VarRef ? "ushort*" : "ptr"

        result := ComCall(24, this, "float", emSize, "float", pixelsPerDip, "ptr", transform, "int", useGdiNatural, "int", isSideways, "uint", glyphCount, glyphIndicesMarshal, glyphIndices, "int*", &glyphAdvances := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getkerningpairadjustments
     */
    GetKerningPairAdjustments(glyphCount, glyphIndices) {
        glyphIndicesMarshal := glyphIndices is VarRef ? "ushort*" : "ptr"

        result := ComCall(25, this, "uint", glyphCount, glyphIndicesMarshal, glyphIndices, "int*", &glyphAdvanceAdjustments := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-haskerningpairs
     */
    HasKerningPairs() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getrecommendedrenderingmode
     */
    GetRecommendedRenderingMode(fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode) {
        result := ComCall(27, this, "float", fontEmSize, "float", dpiX, "float", dpiY, "ptr", transform, "int", isSideways, "int", outlineThreshold, "int", measuringMode, "int*", &renderingMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-getverticalglyphvariants
     */
    GetVerticalGlyphVariants(glyphCount, nominalGlyphIndices) {
        ...
        result := ComCall(28, this, "uint", glyphCount, nominalGlyphIndicesMarshal, nominalGlyphIndices, "ushort*", &verticalGlyphIndices := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_1/nf-dwrite_1-idwritefontface1-hasverticalglyphvariants
     */
