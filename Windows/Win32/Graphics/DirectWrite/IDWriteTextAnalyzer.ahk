...
class IDWriteTextAnalyzer extends IUnknown{
     ...
     * @param {Pointer<IDWriteTextAnalysisSink>} analysisSink 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<DWRITE_TYPOGRAPHIC_FEATURES>} features 
     * @param {Pointer<UInt32>} featureRangeLengths 
