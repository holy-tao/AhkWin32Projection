 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nn-dwrite_3-idwritefontfacereference1
...
class IDWriteFontFaceReference1 extends IDWriteFontFaceReference{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference1-createfontface
     */
    CreateFontFace() {
        result := ComCall(17, this, "ptr*", &fontFace := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference1-getfontaxisvaluecount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwrite_3/nf-dwrite_3-idwritefontfacereference1-getfontaxisvalues
     */
    GetFontAxisValues(fontAxisValueCount) {
        fontAxisValues := DWRITE_FONT_AXIS_VALUE()
        result := ComCall(19, this, "ptr", fontAxisValues, "uint", fontAxisValueCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
