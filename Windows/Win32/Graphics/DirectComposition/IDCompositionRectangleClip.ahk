...
export default struct IDCompositionRectangleClip extends IDCompositionClip {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetLeft := CallbackCreate(ObjBindMethod(implObj, "SetLeft"), flags, 2)
        this.vtbl.SetLeft1 := CallbackCreate(ObjBindMethod(implObj, "SetLeft1"), flags, 2)
        this.vtbl.SetTop := CallbackCreate(ObjBindMethod(implObj, "SetTop"), flags, 2)
        this.vtbl.SetTop1 := CallbackCreate(ObjBindMethod(implObj, "SetTop1"), flags, 2)
        this.vtbl.SetRight := CallbackCreate(ObjBindMethod(implObj, "SetRight"), flags, 2)
        this.vtbl.SetRight1 := CallbackCreate(ObjBindMethod(implObj, "SetRight1"), flags, 2)
        this.vtbl.SetBottom := CallbackCreate(ObjBindMethod(implObj, "SetBottom"), flags, 2)
        this.vtbl.SetBottom1 := CallbackCreate(ObjBindMethod(implObj, "SetBottom1"), flags, 2)
        this.vtbl.SetTopLeftRadiusX := CallbackCreate(ObjBindMethod(implObj, "SetTopLeftRadiusX"), flags, 2)
        this.vtbl.SetTopLeftRadiusX1 := CallbackCreate(ObjBindMethod(implObj, "SetTopLeftRadiusX1"), flags, 2)
        this.vtbl.SetTopLeftRadiusY := CallbackCreate(ObjBindMethod(implObj, "SetTopLeftRadiusY"), flags, 2)
        this.vtbl.SetTopLeftRadiusY1 := CallbackCreate(ObjBindMethod(implObj, "SetTopLeftRadiusY1"), flags, 2)
        this.vtbl.SetTopRightRadiusX := CallbackCreate(ObjBindMethod(implObj, "SetTopRightRadiusX"), flags, 2)
        this.vtbl.SetTopRightRadiusX1 := CallbackCreate(ObjBindMethod(implObj, "SetTopRightRadiusX1"), flags, 2)
        this.vtbl.SetTopRightRadiusY := CallbackCreate(ObjBindMethod(implObj, "SetTopRightRadiusY"), flags, 2)
        this.vtbl.SetTopRightRadiusY1 := CallbackCreate(ObjBindMethod(implObj, "SetTopRightRadiusY1"), flags, 2)
        this.vtbl.SetBottomLeftRadiusX := CallbackCreate(ObjBindMethod(implObj, "SetBottomLeftRadiusX"), flags, 2)
        this.vtbl.SetBottomLeftRadiusX1 := CallbackCreate(ObjBindMethod(implObj, "SetBottomLeftRadiusX1"), flags, 2)
        this.vtbl.SetBottomLeftRadiusY := CallbackCreate(ObjBindMethod(implObj, "SetBottomLeftRadiusY"), flags, 2)
        this.vtbl.SetBottomLeftRadiusY1 := CallbackCreate(ObjBindMethod(implObj, "SetBottomLeftRadiusY1"), flags, 2)
        this.vtbl.SetBottomRightRadiusX := CallbackCreate(ObjBindMethod(implObj, "SetBottomRightRadiusX"), flags, 2)
        this.vtbl.SetBottomRightRadiusX1 := CallbackCreate(ObjBindMethod(implObj, "SetBottomRightRadiusX1"), flags, 2)
        this.vtbl.SetBottomRightRadiusY := CallbackCreate(ObjBindMethod(implObj, "SetBottomRightRadiusY"), flags, 2)
        this.vtbl.SetBottomRightRadiusY1 := CallbackCreate(ObjBindMethod(implObj, "SetBottomRightRadiusY1"), flags, 2)
    }
