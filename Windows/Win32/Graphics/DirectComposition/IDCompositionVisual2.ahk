 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nn-dcomp-idcompositionvisual2
...
class IDCompositionVisual2 extends IDCompositionVisual{
     ...
     * @param {Integer} mode_ The opacity mode to use when composing the visual to the screen.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nf-dcomp-idcompositionvisual2-setopacitymode
     */
    SetOpacityMode(mode_) {
        result := ComCall(20, this, "int", mode_, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the function succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code. See <a href="https://docs.microsoft.com/windows/desktop/directcomp/directcomposition-error-codes">DirectComposition Error Codes</a>  for a list of error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nf-dcomp-idcompositionvisual2-setbackfacevisibility
     */
