 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nn-dcomp-idcompositionmatrixtransform
...
class IDCompositionMatrixTransform extends IDCompositionTransform{
     ...
     * @param {Pointer<D2D_MATRIX_3X2_F>} matrix_ Type: <b>const <a href="https://docs.microsoft.com/windows/desktop/api/dcommon/ns-dcommon-d2d_matrix_3x2_f">D2D_MATRIX_3X2_F</a></b>
     * 
     * The new matrix for this 2D transform.
     * @returns {HRESULT} Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">HRESULT</a></b>
     * 
     * If the function succeeds, it returns S_OK. Otherwise, it returns an <b>HRESULT</b> error code. See <a href="https://docs.microsoft.com/windows/desktop/directcomp/directcomposition-error-codes">DirectComposition Error Codes</a>  for a list of error codes.
     * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nf-dcomp-idcompositionmatrixtransform-setmatrix
     */
    SetMatrix(matrix_) {
        result := ComCall(3, this, "ptr", matrix_, "int")
        if(result != 0) {
     ...
     * @param {Integer} column_ The column index of the element to change. This value must be between 0 and 1, inclusive.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dcomp/nf-dcomp-idcompositionmatrixtransform-setmatrixelement(int_int_idcompositionanimation)
     */
    SetMatrixElement(row, column_, animation) {
        result := ComCall(4, this, "int", row, "int", column_, "ptr", animation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    SetMatrixElement1(row, column_, value) {
        result := ComCall(5, this, "int", row, "int", column_, "float", value, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
