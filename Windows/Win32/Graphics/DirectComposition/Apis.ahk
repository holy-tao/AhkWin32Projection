 ...
 */
export DCompositionAttachMouseWheelToHwnd(visual, _hwnd, enable) {
    result := DllCall("dcomp.dll\DCompositionAttachMouseWheelToHwnd", "ptr", visual, HWND, _hwnd, BOOL, enable, "HRESULT")
    return result
}
 ...
 */
export DCompositionAttachMouseDragToHwnd(visual, _hwnd, enable) {
    result := DllCall("dcomp.dll\DCompositionAttachMouseDragToHwnd", "ptr", visual, HWND, _hwnd, BOOL, enable, "HRESULT")
    return result
}
 ...
 */
export DCompositionGetFrameId(frameIdType) {
    result := DllCall("dcomp.dll\DCompositionGetFrameId", COMPOSITION_FRAME_ID_TYPE, frameIdType, "uint*", &frameId := 0, "HRESULT")
    return frameId
}
 ...
 */
export DCompositionBoostCompositorClock(enable) {
    result := DllCall("dcomp.dll\DCompositionBoostCompositorClock", BOOL, enable, "HRESULT")
    return result
}
