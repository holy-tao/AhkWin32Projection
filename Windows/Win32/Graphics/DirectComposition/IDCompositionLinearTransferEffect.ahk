...
export default struct IDCompositionLinearTransferEffect extends IDCompositionFilterEffect {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetRedYIntercept := CallbackCreate(ObjBindMethod(implObj, "SetRedYIntercept"), flags, 2)
        this.vtbl.SetRedYIntercept1 := CallbackCreate(ObjBindMethod(implObj, "SetRedYIntercept1"), flags, 2)
        this.vtbl.SetRedSlope := CallbackCreate(ObjBindMethod(implObj, "SetRedSlope"), flags, 2)
        this.vtbl.SetRedSlope1 := CallbackCreate(ObjBindMethod(implObj, "SetRedSlope1"), flags, 2)
        this.vtbl.SetRedDisable := CallbackCreate(ObjBindMethod(implObj, "SetRedDisable"), flags, 2)
        this.vtbl.SetGreenYIntercept := CallbackCreate(ObjBindMethod(implObj, "SetGreenYIntercept"), flags, 2)
        this.vtbl.SetGreenYIntercept1 := CallbackCreate(ObjBindMethod(implObj, "SetGreenYIntercept1"), flags, 2)
        this.vtbl.SetGreenSlope := CallbackCreate(ObjBindMethod(implObj, "SetGreenSlope"), flags, 2)
        this.vtbl.SetGreenSlope1 := CallbackCreate(ObjBindMethod(implObj, "SetGreenSlope1"), flags, 2)
        this.vtbl.SetGreenDisable := CallbackCreate(ObjBindMethod(implObj, "SetGreenDisable"), flags, 2)
        this.vtbl.SetBlueYIntercept := CallbackCreate(ObjBindMethod(implObj, "SetBlueYIntercept"), flags, 2)
        this.vtbl.SetBlueYIntercept1 := CallbackCreate(ObjBindMethod(implObj, "SetBlueYIntercept1"), flags, 2)
        this.vtbl.SetBlueSlope := CallbackCreate(ObjBindMethod(implObj, "SetBlueSlope"), flags, 2)
        this.vtbl.SetBlueSlope1 := CallbackCreate(ObjBindMethod(implObj, "SetBlueSlope1"), flags, 2)
        this.vtbl.SetBlueDisable := CallbackCreate(ObjBindMethod(implObj, "SetBlueDisable"), flags, 2)
        this.vtbl.SetAlphaYIntercept := CallbackCreate(ObjBindMethod(implObj, "SetAlphaYIntercept"), flags, 2)
        this.vtbl.SetAlphaYIntercept1 := CallbackCreate(ObjBindMethod(implObj, "SetAlphaYIntercept1"), flags, 2)
        this.vtbl.SetAlphaSlope := CallbackCreate(ObjBindMethod(implObj, "SetAlphaSlope"), flags, 2)
        this.vtbl.SetAlphaSlope1 := CallbackCreate(ObjBindMethod(implObj, "SetAlphaSlope1"), flags, 2)
