...
export default struct IDCompositionDevice2 extends IUnknown {
    ...
    */
    ...
    CreateTransformGroup(transforms, elements) {
        result := ComCall(15, this, IDCompositionTransform.Ptr, transforms, UInt32, elements, "ptr*", &transformGroup := 0, "HRESULT")
    ...
    CreateTransform3DGroup(transforms3D, elements) {
        result := ComCall(20, this, IDCompositionTransform3D.Ptr, transforms3D, UInt32, elements, "ptr*", &transform3DGroup := 0, "HRESULT")
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.WaitForCommitCompletion := CallbackCreate(ObjBindMethod(implObj, "WaitForCommitCompletion"), flags, 1)
        this.vtbl.GetFrameStatistics := CallbackCreate(ObjBindMethod(implObj, "GetFrameStatistics"), flags, 2)
        this.vtbl.CreateVisual := CallbackCreate(ObjBindMethod(implObj, "CreateVisual"), flags, 2)
        this.vtbl.CreateSurfaceFactory := CallbackCreate(ObjBindMethod(implObj, "CreateSurfaceFactory"), flags, 3)
        ...
        this.vtbl.CreateTranslateTransform := CallbackCreate(ObjBindMethod(implObj, "CreateTranslateTransform"), flags, 2)
        this.vtbl.CreateScaleTransform := CallbackCreate(ObjBindMethod(implObj, "CreateScaleTransform"), flags, 2)
        this.vtbl.CreateRotateTransform := CallbackCreate(ObjBindMethod(implObj, "CreateRotateTransform"), flags, 2)
        this.vtbl.CreateSkewTransform := CallbackCreate(ObjBindMethod(implObj, "CreateSkewTransform"), flags, 2)
        this.vtbl.CreateMatrixTransform := CallbackCreate(ObjBindMethod(implObj, "CreateMatrixTransform"), flags, 2)
        this.vtbl.CreateTransformGroup := CallbackCreate(ObjBindMethod(implObj, "CreateTransformGroup"), flags, 4)
        this.vtbl.CreateTranslateTransform3D := CallbackCreate(ObjBindMethod(implObj, "CreateTranslateTransform3D"), flags, 2)
        this.vtbl.CreateScaleTransform3D := CallbackCreate(ObjBindMethod(implObj, "CreateScaleTransform3D"), flags, 2)
        this.vtbl.CreateRotateTransform3D := CallbackCreate(ObjBindMethod(implObj, "CreateRotateTransform3D"), flags, 2)
        this.vtbl.CreateMatrixTransform3D := CallbackCreate(ObjBindMethod(implObj, "CreateMatrixTransform3D"), flags, 2)
        this.vtbl.CreateTransform3DGroup := CallbackCreate(ObjBindMethod(implObj, "CreateTransform3DGroup"), flags, 4)
        this.vtbl.CreateEffectGroup := CallbackCreate(ObjBindMethod(implObj, "CreateEffectGroup"), flags, 2)
        this.vtbl.CreateRectangleClip := CallbackCreate(ObjBindMethod(implObj, "CreateRectangleClip"), flags, 2)
        this.vtbl.CreateAnimation := CallbackCreate(ObjBindMethod(implObj, "CreateAnimation"), flags, 2)
    }
