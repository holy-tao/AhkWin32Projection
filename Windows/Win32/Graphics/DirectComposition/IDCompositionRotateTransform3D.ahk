...
export default struct IDCompositionRotateTransform3D extends IDCompositionTransform3D {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetAxisX := CallbackCreate(ObjBindMethod(implObj, "SetAxisX"), flags, 2)
        this.vtbl.SetAxisX1 := CallbackCreate(ObjBindMethod(implObj, "SetAxisX1"), flags, 2)
        this.vtbl.SetAxisY := CallbackCreate(ObjBindMethod(implObj, "SetAxisY"), flags, 2)
        this.vtbl.SetAxisY1 := CallbackCreate(ObjBindMethod(implObj, "SetAxisY1"), flags, 2)
        this.vtbl.SetAxisZ := CallbackCreate(ObjBindMethod(implObj, "SetAxisZ"), flags, 2)
        this.vtbl.SetAxisZ1 := CallbackCreate(ObjBindMethod(implObj, "SetAxisZ1"), flags, 2)
        ...
        this.vtbl.SetCenterZ := CallbackCreate(ObjBindMethod(implObj, "SetCenterZ"), flags, 2)
        this.vtbl.SetCenterZ1 := CallbackCreate(ObjBindMethod(implObj, "SetCenterZ1"), flags, 2)
    }
