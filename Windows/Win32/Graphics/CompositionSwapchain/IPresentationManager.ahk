 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nn-presentation-ipresentationmanager
...
class IPresentationManager extends IUnknown{
    ...
    AddBufferFromResource(resource) {
        result := ComCall(3, this, "ptr", resource, "ptr*", &presentationBuffer := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-createpresentationsurface
     */
    CreatePresentationSurface(compositionSurfaceHandle) {
        ...
        result := ComCall(4, this, "ptr", compositionSurfaceHandle, "ptr*", &presentationSurface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-getnextpresentid
     */
    GetNextPresentId() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-settargettime
     */
    SetTargetTime(targetTime) {
        targetTime := targetTime is Win32Handle ? NumGet(targetTime, "ptr") : targetTime
     ...
     * 
     * If the function succeeds, it returns `S_OK`; otherwise, it returns an `HRESULT` value that indicates the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-setpreferredpresentduration
     */
    SetPreferredPresentDuration(preferredDuration, deviationTolerance) {
        preferredDuration := preferredDuration is Win32Handle ? NumGet(preferredDuration, "ptr") : preferredDuration
        deviationTolerance := deviationTolerance is Win32Handle ? NumGet(deviationTolerance, "ptr") : deviationTolerance
     ...
     * 
     * If the function succeeds, it returns `S_OK`; otherwise, it returns an `HRESULT` value that indicates the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-forcevsyncinterrupt
     */
     ...
     * 
     * If the function succeeds, it returns `S_OK`; otherwise, it returns an `HRESULT` value that indicates the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-present
     */
    Present() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-getpresentretiringfence
     */
    GetPresentRetiringFence(riid) {
        result := ComCall(10, this, "ptr", riid, "ptr*", &fence := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the function succeeds, it returns `S_OK`; otherwise, it returns an `HRESULT` value that indicates the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-cancelpresentsfrom
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-getlostevent
     */
    GetLostEvent() {
     ...
     * 
     * A handle to the event.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-getpresentstatisticsavailableevent
     */
     ...
     * @param {Integer} presentStatisticsKind_ Type: **[PresentStatisticsKind](../presentationtypes/ne-presentationtypes-presentstatisticskind.md)**
     * 
     ...
     * 
     * If the function succeeds, it returns `S_OK`; otherwise, it returns an `HRESULT` value that indicates the error.
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-enablepresentstatisticskind
     */
    EnablePresentStatisticsKind(presentStatisticsKind_, enabled) {
        result := ComCall(14, this, "int", presentStatisticsKind_, "char", enabled, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/presentation/nf-presentation-ipresentationmanager-getnextpresentstatistics
     */
    GetNextPresentStatistics() {
        result := ComCall(15, this, "ptr*", &nextPresentStatistics := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
