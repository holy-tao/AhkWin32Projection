...
export GetObjectA(h, c, pv) {
    result := DllCall("GDI32.dll\GetObjectA", HGDIOBJ, h, "int", c, "ptr", pv, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export AddFontResourceA(param0) {
    param0 := param0 is String ? StrPtr(param0) : param0

    result := DllCall("GDI32.dll\AddFontResourceA", "ptr", param0, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export AddFontResourceW(param0) {
    param0 := param0 is String ? StrPtr(param0) : param0

    result := DllCall("GDI32.dll\AddFontResourceW", "ptr", param0, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export AnimatePalette(hPal, iStartIndex, cEntries, ppe) {
    result := DllCall("GDI32.dll\AnimatePalette", HPALETTE, hPal, "uint", iStartIndex, "uint", cEntries, PALETTEENTRY.Ptr, ppe, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context where drawing takes place.
 ...
 * @since windows5.0
 */
export Arc(_hdc, x1, y1, x2, y2, x3, y3, x4, y4) {
    result := DllCall("GDI32.dll\Arc", HDC, _hdc, "int", x1, "int", y1, "int", x2, "int", y2, "int", x3, "int", y3, "int", x4, "int", y4, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the destination device context.
 ...
 * @param {Integer} _cy The height, in logical units, of the source and the destination rectangles.
 ...
 * @param {ROP_CODE} rop A raster-operation code. These codes define how the color data for the source rectangle is to be combined with the color data for the destination rectangle to achieve the final color.
 * 
...
export BitBlt(_hdc, x, y, cx, _cy, hdcSrc, x1, y1, rop) {
    ...
    result := DllCall("GDI32.dll\BitBlt", HDC, _hdc, "int", x, "int", y, "int", cx, "int", _cy, HDC, hdcSrc, "int", x1, "int", y1, ROP_CODE, rop, BOOL)
 ...
 * @param {HDC} _hdc A handle to the DC.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export CancelDC(_hdc) {
    result := DllCall("GDI32.dll\CancelDC", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context in which the chord appears.
 ...
 * @since windows5.0
 */
export Chord(_hdc, x1, y1, x2, y2, x3, y3, x4, y4) {
    result := DllCall("GDI32.dll\Chord", HDC, _hdc, "int", x1, "int", y1, "int", x2, "int", y2, "int", x3, "int", y3, "int", x4, "int", y4, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a metafile device context used to create a Windows-format metafile.
 ...
 * @since windows5.0
 */
export CloseMetaFile(_hdc) {
    result := DllCall("GDI32.dll\CloseMetaFile", HDC, _hdc, HMETAFILE.Owned)
    return result
}
 ...
 * @param {RGN_COMBINE_MODE} iMode 
 * @returns {GDI_REGION_TYPE} The return value specifies the type of the resulting region. It can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
...
export CreateBitmap(nWidth, nHeight, nPlanes, nBitCount, lpBits) {
    ...
    result := DllCall("GDI32.dll\CreateBitmap", "int", nWidth, "int", nHeight, "uint", nPlanes, "uint", nBitCount, lpBitsMarshal, lpBits, HBITMAP.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateBitmapIndirect(pbm) {
    result := DllCall("GDI32.dll\CreateBitmapIndirect", BITMAP.Ptr, pbm, HBITMAP.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateBrushIndirect(plbrush) {
    result := DllCall("GDI32.dll\CreateBrushIndirect", LOGBRUSH.Ptr, plbrush, HBRUSH.Owned)
    return result
}
 ...
 * 
 * When you no longer need the bitmap, call the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-deleteobject">DeleteObject</a> function to delete it.
 * @param {HDC} _hdc A handle to a device context.
 * @param {Integer} cx The bitmap width, in pixels.
 * @param {Integer} _cy The bitmap height, in pixels.
 ...
 * @since windows5.0
 */
export CreateCompatibleBitmap(_hdc, cx, _cy) {
    result := DllCall("GDI32.dll\CreateCompatibleBitmap", HDC, _hdc, "int", cx, "int", _cy, HBITMAP.Owned)
    return result
}
 ...
 * @param {Integer} _cy The height, in pixels, of the bitmap.
 * @returns {HBITMAP} If the function succeeds, the return value is a handle to the compatible bitmap (DDB).
 * 
 * If the function fails, the return value is <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CreateDiscardableBitmap(_hdc, cx, _cy) {
    result := DllCall("GDI32.dll\CreateDiscardableBitmap", HDC, _hdc, "int", cx, "int", _cy, HBITMAP.Owned)
    return result
}
 ...
 * @param {HDC} _hdc A handle to an existing DC. If this handle is <b>NULL</b>, the function creates a memory DC compatible with the application's current screen.
 ...
 * @since windows5.0
 */
export CreateDCA(pwszDriver, pwszDevice, pszPort, pdm) {
 ...
 * @since windows5.0
 */
export CreateDCW(pwszDriver, pwszDevice, pszPort, pdm) {
    pwszDriver := pwszDriver is String ? StrPtr(pwszDriver) : pwszDriver
    pwszDevice := pwszDevice is String ? StrPtr(pwszDevice) : pwszDevice
    pszPort := pszPort is String ? StrPtr(pszPort) : pszPort
...
export CreateDIBitmap(_hdc, pbmih, flInit, pjBits, pbmi, iUsage) {
    ...
    result := DllCall("GDI32.dll\CreateDIBitmap", HDC, _hdc, BITMAPINFOHEADER.Ptr, pbmih, "uint", flInit, pjBitsMarshal, pjBits, BITMAPINFO.Ptr, pbmi, DIB_USAGE, iUsage, HBITMAP.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateDIBPatternBrush(h, iUsage) {
    result := DllCall("GDI32.dll\CreateDIBPatternBrush", HGLOBAL, h, DIB_USAGE, iUsage, HBRUSH.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateEllipticRgn(x1, y1, x2, y2) {
    result := DllCall("GDI32.dll\CreateEllipticRgn", "int", x1, "int", y1, "int", x2, "int", y2, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateEllipticRgnIndirect(lprect) {
    result := DllCall("GDI32.dll\CreateEllipticRgnIndirect", RECT.Ptr, lprect, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateFontIndirectA(lplf) {
    result := DllCall("GDI32.dll\CreateFontIndirectA", LOGFONTA.Ptr, lplf, HFONT.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateFontIndirectW(lplf) {
    result := DllCall("GDI32.dll\CreateFontIndirectW", LOGFONTW.Ptr, lplf, HFONT.Owned)
    return result
}
...
export CreateFontA(cHeight, cWidth, cEscapement, cOrientation, cWeight, bItalic, bUnderline, bStrikeOut, iCharSet, iOutPrecision, iClipPrecision, iQuality, iPitchAndFamily, pszFaceName) {
    ...
    result := DllCall("GDI32.dll\CreateFontA", "int", cHeight, "int", cWidth, "int", cEscapement, "int", cOrientation, "int", cWeight, "uint", bItalic, "uint", bUnderline, "uint", bStrikeOut, "uint", iCharSet, "uint", iOutPrecision, "uint", iClipPrecision, "uint", iQuality, "uint", iPitchAndFamily, "ptr", pszFaceName, HFONT.Owned)
    return result
}
...
export CreateFontW(cHeight, cWidth, cEscapement, cOrientation, cWeight, bItalic, bUnderline, bStrikeOut, iCharSet, iOutPrecision, iClipPrecision, iQuality, iPitchAndFamily, pszFaceName) {
    ...
    result := DllCall("GDI32.dll\CreateFontW", "int", cHeight, "int", cWidth, "int", cEscapement, "int", cOrientation, "int", cWeight, "uint", bItalic, "uint", bUnderline, "uint", bStrikeOut, "uint", iCharSet, "uint", iOutPrecision, "uint", iClipPrecision, "uint", iQuality, "uint", iPitchAndFamily, "ptr", pszFaceName, HFONT.Owned)
    return result
}
 ...
 * @param {HATCH_BRUSH_STYLE} iHatch 
 * @param {COLORREF} _color The foreground color of the brush that is used for the hatches. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 * @returns {HBRUSH} If the function succeeds, the return value identifies a logical brush.
 * 
 * If the function fails, the return value is <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CreateHatchBrush(iHatch, _color) {
    result := DllCall("GDI32.dll\CreateHatchBrush", HATCH_BRUSH_STYLE, iHatch, COLORREF, _color, HBRUSH.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateICA(pszDriver, pszDevice, pszPort, pdm) {
 ...
 * @since windows5.0
 */
export CreateICW(pszDriver, pszDevice, pszPort, pdm) {
    pszDriver := pszDriver is String ? StrPtr(pszDriver) : pszDriver
    pszDevice := pszDevice is String ? StrPtr(pszDevice) : pszDevice
    pszPort := pszPort is String ? StrPtr(pszPort) : pszPort
 ...
 * @since windows5.0
 */
export CreatePalette(plpal) {
    result := DllCall("GDI32.dll\CreatePalette", LOGPALETTE.Ptr, plpal, HPALETTE.Owned)
    return result
}
 ...
 * @param {COLORREF} _color A color reference for the pen color. To generate a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> structure, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 ...
 * @since windows5.0
 */
export CreatePen(iStyle, cWidth, _color) {
    result := DllCall("GDI32.dll\CreatePen", PEN_STYLE, iStyle, "int", cWidth, COLORREF, _color, HPEN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreatePenIndirect(plpen) {
    result := DllCall("GDI32.dll\CreatePenIndirect", LOGPEN.Ptr, plpen, HPEN.Owned)
    return result
}
 ...
 * @param {CREATE_POLYGON_RGN_MODE} iMode 
 * @returns {HRGN} If the function succeeds, the return value is the handle to the region.
 * 
 * If the function fails, the return value is zero.
...
export CreatePolyPolygonRgn(pptl, pc, cPoly, iMode) {
    ...
    result := DllCall("GDI32.dll\CreatePolyPolygonRgn", POINT.Ptr, pptl, pcMarshal, pc, "int", cPoly, CREATE_POLYGON_RGN_MODE, iMode, HRGN.Owned)
    return result
}
 ...
 * 
 * <b>ICM:</b> No color is done at brush creation. However, color management is performed when the brush is selected into an ICM-enabled device context.
 * @param {HBITMAP} _hbm A handle to the bitmap to be used to create the logical brush.
 * @returns {HBRUSH} If the function succeeds, the return value identifies a logical brush.
 * 
 * If the function fails, the return value is <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CreatePatternBrush(_hbm) {
    result := DllCall("GDI32.dll\CreatePatternBrush", HBITMAP, _hbm, HBRUSH.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateRectRgn(x1, y1, x2, y2) {
    result := DllCall("GDI32.dll\CreateRectRgn", "int", x1, "int", y1, "int", x2, "int", y2, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateRectRgnIndirect(lprect) {
    result := DllCall("GDI32.dll\CreateRectRgnIndirect", RECT.Ptr, lprect, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateRoundRectRgn(x1, y1, x2, y2, w, h) {
    result := DllCall("GDI32.dll\CreateRoundRectRgn", "int", x1, "int", y1, "int", x2, "int", y2, "int", w, "int", h, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateScalableFontResourceA(fdwHidden, lpszFont, lpszFile, lpszPath) {
    ...
    result := DllCall("GDI32.dll\CreateScalableFontResourceA", "uint", fdwHidden, "ptr", lpszFont, "ptr", lpszFile, "ptr", lpszPath, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export CreateScalableFontResourceW(fdwHidden, lpszFont, lpszFile, lpszPath) {
    lpszFont := lpszFont is String ? StrPtr(lpszFont) : lpszFont
    lpszFile := lpszFile is String ? StrPtr(lpszFile) : lpszFile
    lpszPath := lpszPath is String ? StrPtr(lpszPath) : lpszPath
    ...
    result := DllCall("GDI32.dll\CreateScalableFontResourceW", "uint", fdwHidden, "ptr", lpszFont, "ptr", lpszFile, "ptr", lpszPath, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @param {COLORREF} _color The color of the brush. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 * @returns {HBRUSH} If the function succeeds, the return value identifies a logical brush.
 * 
 * If the function fails, the return value is <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CreateSolidBrush(_color) {
    result := DllCall("GDI32.dll\CreateSolidBrush", COLORREF, _color, HBRUSH.Owned)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export DeleteDC(_hdc) {
    result := DllCall("GDI32.dll\DeleteDC", HDC, _hdc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DeleteMetaFile(hmf) {
    result := DllCall("GDI32.dll\DeleteMetaFile", HMETAFILE, hmf, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DeleteObject(ho) {
    result := DllCall("GDI32.dll\DeleteObject", HGDIOBJ, ho, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the DC for the specified video display.
 ...
 * @param {Integer} lpIn A pointer to the input structure required for the specified escape.
...
export DrawEscape(_hdc, iEscape, cjIn, lpIn) {
    result := DllCall("GDI32.dll\DrawEscape", HDC, _hdc, "int", iEscape, "int", cjIn, "ptr", lpIn, Int32)
    return result
}
 ...
 * @since windows6.1
 */
export Ellipse(_hdc, left, top, right, bottom) {
    result := DllCall("GDI32.dll\Ellipse", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context from which to enumerate the fonts.
 ...
 * @param {LPARAM} _lParam An application defined value. The function passes this value to the callback function along with font information.
...
export EnumFontFamiliesExA(_hdc, lpLogfont, lpProc, _lParam, dwFlags) {
    result := DllCall("GDI32.dll\EnumFontFamiliesExA", HDC, _hdc, LOGFONTA.Ptr, lpLogfont, "ptr", lpProc, LPARAM, _lParam, "uint", dwFlags, Int32)
    return result
}
...
export EnumFontFamiliesExW(_hdc, lpLogfont, lpProc, _lParam, dwFlags) {
    result := DllCall("GDI32.dll\EnumFontFamiliesExW", HDC, _hdc, LOGFONTW.Ptr, lpLogfont, "ptr", lpProc, LPARAM, _lParam, "uint", dwFlags, Int32)
    return result
}
 ...
 * @param {LPARAM} _lParam A pointer to application-supplied data. The data is passed to the callback function along with the font information.
 ...
 * @param {LPARAM} _lParam A pointer to any application-defined data. The data is passed to the callback function along with the font information.
 ...
 * @param {HDC} _hdc A handle to the DC.
 * @param {OBJ_TYPE} nType The object type. This parameter can be OBJ_BRUSH or OBJ_PEN.
 ...
 * @param {LPARAM} _lParam A pointer to the application-defined data. The data is passed to the callback function along with the object information.
 ...
 * @since windows5.0
 */
export EqualRgn(hrgn1, hrgn2) {
    result := DllCall("GDI32.dll\EqualRgn", HRGN, hrgn1, HRGN, hrgn2, BOOL)
    return result
}
 ...
 * @returns {GDI_REGION_TYPE} The return value specifies the new clipping region's complexity; it can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export ExcludeClipRect(_hdc, left, top, right, bottom) {
    result := DllCall("GDI32.dll\ExcludeClipRect", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {Integer} lpData A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-rgndata">RGNDATA</a> structure that contains the region data in logical units.
...
export ExtCreateRegion(lpx, nCount, lpData) {
    result := DllCall("GDI32.dll\ExtCreateRegion", XFORM.Ptr, lpx, "uint", nCount, "ptr", lpData, HRGN.Owned)
    return result
}
 ...
 * @param {COLORREF} _color The color of the boundary or of the area to be filled. The interpretation of <i>color</i> depends on the value of the <i>fuFillType</i> parameter. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 * @param {EXT_FLOOD_FILL_TYPE} type 
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export ExtFloodFill(_hdc, x, y, _color, type) {
    result := DllCall("GDI32.dll\ExtFloodFill", HDC, _hdc, "int", x, "int", y, COLORREF, _color, EXT_FLOOD_FILL_TYPE, type, BOOL)
    return result
}

/**
 * The FillRgn function fills a region by using the specified brush.
 * @param {HDC} _hdc Handle to the device context.
 * @param {HRGN} _hrgn Handle to the region to be filled. The region's coordinates are presumed to be in logical units.
 ...
 * @since windows5.0
 */
export FillRgn(_hdc, _hrgn, hbr) {
    result := DllCall("GDI32.dll\FillRgn", HDC, _hdc, HRGN, _hrgn, HBRUSH, hbr, BOOL)
    return result
}
 ...
 * @param {Integer} x The x-coordinate, in logical units, of the point where filling is to start.
 * @param {Integer} y The y-coordinate, in logical units, of the point where filling is to start.
 * @param {COLORREF} _color The color of the boundary or the area to be filled. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export FloodFill(_hdc, x, y, _color) {
    result := DllCall("GDI32.dll\FloodFill", HDC, _hdc, "int", x, "int", y, COLORREF, _color, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context.
 * @param {HRGN} _hrgn Handle to the region to be enclosed in a border. The region's coordinates are presumed to be in logical units.
 ...
 * @since windows5.0
 */
export FrameRgn(_hdc, _hrgn, hbr, w, h) {
    result := DllCall("GDI32.dll\FrameRgn", HDC, _hdc, HRGN, _hrgn, HBRUSH, hbr, "int", w, "int", h, BOOL)
    return result
}
 ...
 * </table>
 * @param {HDC} _hdc Handle to the device context.
 * @returns {R2_MODE} If the function succeeds, the return value specifies the foreground mix mode.
 * 
 * If the function fails, the return value is zero.
 ...
 */
export GetROP2(_hdc) {
    result := DllCall("GDI32.dll\GetROP2", HDC, _hdc, R2_MODE)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a device context.
 ...
 * @since windows5.0
 */
export GetAspectRatioFilterEx(_hdc, lpsize) {
    result := DllCall("GDI32.dll\GetAspectRatioFilterEx", HDC, _hdc, SIZE.Ptr, lpsize, BOOL)
    return result
}

/**
 * The GetBkColor function returns the current background color for the specified device context.
 * @param {HDC} _hdc Handle to the device context whose background color is to be returned.
 ...
 * @since windows5.0
 */
export GetBkColor(_hdc) {
    result := DllCall("GDI32.dll\GetBkColor", HDC, _hdc, COLORREF)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the DC whose brush color is to be returned.
 ...
 * @since windows5.0
 */
export GetDCBrushColor(_hdc) {
    result := DllCall("GDI32.dll\GetDCBrushColor", HDC, _hdc, COLORREF)
    return result
}
 ...
 * @since windows5.0
 */
export GetDCPenColor(_hdc) {
    result := DllCall("GDI32.dll\GetDCPenColor", HDC, _hdc, COLORREF)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context whose background mode is to be returned.
 ...
 * @since windows5.0
 */
export GetBkMode(_hdc) {
    result := DllCall("GDI32.dll\GetBkMode", HDC, _hdc, Int32)
    return result
}
 ...
 * @param {Integer} lpvBits A pointer to a buffer to receive the bitmap bits. The bits are stored as an array of byte values.
 ...
 * @since windows5.0
 */
export GetBitmapBits(hbit, cb, lpvBits) {
    result := DllCall("GDI32.dll\GetBitmapBits", HBITMAP, hbit, "int", cb, "ptr", lpvBits, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export GetBitmapDimensionEx(hbit, lpsize) {
    result := DllCall("GDI32.dll\GetBitmapDimensionEx", HBITMAP, hbit, SIZE.Ptr, lpsize, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context whose bounding rectangle the function will return.
 ...
 * @since windows5.0
 */
export GetBoundsRect(_hdc, lprect, flags) {
    result := DllCall("GDI32.dll\GetBoundsRect", HDC, _hdc, RECT.Ptr, lprect, "uint", flags, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetBrushOrgEx(_hdc, lppt) {
    result := DllCall("GDI32.dll\GetBrushOrgEx", HDC, _hdc, POINT.Ptr, lppt, BOOL)
    return result
}
...
export GetCharWidthA(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidthA", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
...
export GetCharWidthW(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidthW", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
...
export GetCharWidth32A(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidth32A", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
...
export GetCharWidth32W(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidth32W", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
...
export GetCharWidthFloatA(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidthFloatA", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
...
export GetCharWidthFloatW(_hdc, iFirst, iLast, lpBuffer) {
    ...
    result := DllCall("GDI32.dll\GetCharWidthFloatW", HDC, _hdc, "uint", iFirst, "uint", iLast, lpBufferMarshal, lpBuffer, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetCharABCWidthsA(_hdc, wFirst, wLast, lpABC) {
    result := DllCall("GDI32.dll\GetCharABCWidthsA", HDC, _hdc, "uint", wFirst, "uint", wLast, ABC.Ptr, lpABC, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetCharABCWidthsW(_hdc, wFirst, wLast, lpABC) {
    result := DllCall("GDI32.dll\GetCharABCWidthsW", HDC, _hdc, "uint", wFirst, "uint", wLast, ABC.Ptr, lpABC, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetCharABCWidthsFloatA(_hdc, iFirst, iLast, lpABC) {
    result := DllCall("GDI32.dll\GetCharABCWidthsFloatA", HDC, _hdc, "uint", iFirst, "uint", iLast, ABCFLOAT.Ptr, lpABC, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetCharABCWidthsFloatW(_hdc, iFirst, iLast, lpABC) {
    result := DllCall("GDI32.dll\GetCharABCWidthsFloatW", HDC, _hdc, "uint", iFirst, "uint", iLast, ABCFLOAT.Ptr, lpABC, BOOL)
    return result
}
 ...
 * @returns {GDI_REGION_TYPE} If the function succeeds, the return value specifies the clipping box's complexity and can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export GetClipBox(_hdc, lprect) {
    result := DllCall("GDI32.dll\GetClipBox", HDC, _hdc, RECT.Ptr, lprect, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HRGN} _hrgn A handle to an existing region before the function is called. After the function returns, this parameter is a handle to a copy of the current clipping region.
 ...
 * @since windows5.0
 */
export GetClipRgn(_hdc, _hrgn) {
    result := DllCall("GDI32.dll\GetClipRgn", HDC, _hdc, HRGN, _hrgn, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HRGN} _hrgn A handle to an existing region before the function is called. After the function returns, this parameter is a handle to a copy of the current metaregion.
 ...
 * @since windows5.0
 */
export GetMetaRgn(_hdc, _hrgn) {
    result := DllCall("GDI32.dll\GetMetaRgn", HDC, _hdc, HRGN, _hrgn, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export GetCurrentObject(_hdc, type) {
    result := DllCall("GDI32.dll\GetCurrentObject", HDC, _hdc, "uint", type, HGDIOBJ.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export GetCurrentPositionEx(_hdc, lppt) {
    result := DllCall("GDI32.dll\GetCurrentPositionEx", HDC, _hdc, POINT.Ptr, lppt, BOOL)
    return result
}
...
export GetDeviceCaps(_hdc, index) {
    result := DllCall("GDI32.dll\GetDeviceCaps", HDC, _hdc, "int", index, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HBITMAP} _hbm A handle to the bitmap. This must be a compatible bitmap (DDB).
...
export GetDIBits(_hdc, _hbm, start, cLines, lpvBits, lpbmi, usage) {
    ...
    result := DllCall("GDI32.dll\GetDIBits", HDC, _hdc, HBITMAP, _hbm, "uint", start, "uint", cLines, lpvBitsMarshal, lpvBits, BITMAPINFO.Ptr, lpbmi, DIB_USAGE, usage, Int32)
    return result
}
 ...
 * @param {Integer} pvBuffer A pointer to a buffer that receives the font information. If this parameter is <b>NULL</b>, the function returns the size of the buffer required for the font data.
...
export GetFontData(_hdc, dwTable, dwOffset, pvBuffer, cjBuffer) {
    result := DllCall("GDI32.dll\GetFontData", HDC, _hdc, "uint", dwTable, "uint", dwOffset, "ptr", pvBuffer, "uint", cjBuffer, UInt32)
    return result
}
 ...
 * @param {GET_GLYPH_OUTLINE_FORMAT} fuFormat 
 ...
 * @param {Integer} pvBuffer A pointer to the buffer that receives information about the outline character. If this value is <b>NULL</b>, the function returns the required size of the buffer.
...
export GetGlyphOutlineA(_hdc, uChar, fuFormat, lpgm, cjBuffer, pvBuffer, lpmat2) {
    result := DllCall("GDI32.dll\GetGlyphOutlineA", HDC, _hdc, "uint", uChar, GET_GLYPH_OUTLINE_FORMAT, fuFormat, GLYPHMETRICS.Ptr, lpgm, "uint", cjBuffer, "ptr", pvBuffer, MAT2.Ptr, lpmat2, UInt32)
    return result
}
...
export GetGlyphOutlineW(_hdc, uChar, fuFormat, lpgm, cjBuffer, pvBuffer, lpmat2) {
    result := DllCall("GDI32.dll\GetGlyphOutlineW", HDC, _hdc, "uint", uChar, GET_GLYPH_OUTLINE_FORMAT, fuFormat, GLYPHMETRICS.Ptr, lpgm, "uint", cjBuffer, "ptr", pvBuffer, MAT2.Ptr, lpmat2, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetGraphicsMode(_hdc) {
    result := DllCall("GDI32.dll\GetGraphicsMode", HDC, _hdc, Int32)
    return result
}
 ...
 * </table>
 * @param {HDC} _hdc A handle to the device context.
 * @returns {HDC_MAP_MODE} If the function succeeds, the return value specifies the mapping mode.
 * 
 * If the function fails, the return value is zero.
 * @see https://learn.microsoft.com/windows/win32/api/wingdi/nf-wingdi-getmapmode
 * @since windows5.0
 */
export GetMapMode(_hdc) {
    result := DllCall("GDI32.dll\GetMapMode", HDC, _hdc, HDC_MAP_MODE)
    return result
}
 ...
 * @param {Integer} lpData A pointer to a buffer that receives the metafile data. The buffer must be sufficiently large to contain the data. If <i>lpvData</i> is <b>NULL</b>, the function returns the number of bytes required to hold the data.
...
export GetMetaFileBitsEx(hMF, cbBuffer, lpData) {
    result := DllCall("GDI32.dll\GetMetaFileBitsEx", HMETAFILE, hMF, "uint", cbBuffer, "ptr", lpData, UInt32)
    return result
}
 ...
 */
export GetMetaFileA(lpName) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("GDI32.dll\GetMetaFileA", "ptr", lpName, HMETAFILE.Owned)
    return result
}
 ...
 */
export GetMetaFileW(lpName) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("GDI32.dll\GetMetaFileW", "ptr", lpName, HMETAFILE.Owned)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {COLORREF} _color A color value that identifies a requested color. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 ...
 * @since windows5.0
 */
export GetNearestColor(_hdc, _color) {
    result := DllCall("GDI32.dll\GetNearestColor", HDC, _hdc, COLORREF, _color, COLORREF)
    return result
}
 ...
 * @param {COLORREF} _color A color to be matched. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 ...
 * @since windows5.0
 */
export GetNearestPaletteIndex(h, _color) {
    result := DllCall("GDI32.dll\GetNearestPaletteIndex", HPALETTE, h, COLORREF, _color, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetObjectType(h) {
    result := DllCall("GDI32.dll\GetObjectType", HGDIOBJ, h, UInt32)
    return result
}
 ...
 * @param {Integer} potm A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-outlinetextmetrica">OUTLINETEXTMETRIC</a> structure. If this parameter is <b>NULL</b>, the function returns the size of the buffer required for the retrieved metric data.
...
export GetOutlineTextMetricsA(_hdc, cjCopy, potm) {
    result := DllCall("GDI32.dll\GetOutlineTextMetricsA", HDC, _hdc, "uint", cjCopy, "ptr", potm, UInt32)
    return result
}
...
export GetOutlineTextMetricsW(_hdc, cjCopy, potm) {
    result := DllCall("GDI32.dll\GetOutlineTextMetricsW", HDC, _hdc, "uint", cjCopy, "ptr", potm, UInt32)
    return result
}
...
export GetPaletteEntries(hpal, iStart, cEntries, pPalEntries) {
    result := DllCall("GDI32.dll\GetPaletteEntries", HPALETTE, hpal, "uint", iStart, "uint", cEntries, PALETTEENTRY.Ptr, pPalEntries, UInt32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the [device context](/windows/win32/gdi/device-contexts).
 ...
 * @since windows5.0
 */
export GetPixel(_hdc, x, y) {
    result := DllCall("GDI32.dll\GetPixel", HDC, _hdc, "int", x, "int", y, COLORREF)
    return result
}
 ...
 * @since windows5.0
 */
export GetPolyFillMode(_hdc) {
    result := DllCall("GDI32.dll\GetPolyFillMode", HDC, _hdc, Int32)
    return result
}
 ...
 * @param {Integer} lpraststat A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-rasterizer_status">RASTERIZER_STATUS</a> structure that receives information about the rasterizer.
 ...
 * @since windows5.0
 */
export GetRasterizerCaps(lpraststat, cjBytes) {
    result := DllCall("GDI32.dll\GetRasterizerCaps", "ptr", lpraststat, "uint", cjBytes, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HRGN} _hrgn A handle to a region. Before the function is called, this identifies an existing region. After the function returns, this identifies a copy of the current system region. The old region identified by <i>hrgn</i> is overwritten.
 ...
 * @since windows5.0
 */
export GetRandomRgn(_hdc, _hrgn, i) {
    result := DllCall("GDI32.dll\GetRandomRgn", HDC, _hdc, HRGN, _hrgn, "int", i, Int32)
    return result
}
...
export GetRegionData(_hrgn, nCount, lpRgnData) {
    result := DllCall("GDI32.dll\GetRegionData", HRGN, _hrgn, "uint", nCount, "ptr", lpRgnData, UInt32)
    return result
}
 ...
 * @returns {GDI_REGION_TYPE} The return value specifies the region's complexity. It can be one of the following values:
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * @since windows5.0
 */
export GetRgnBox(_hrgn, lprc) {
    result := DllCall("GDI32.dll\GetRgnBox", HRGN, _hrgn, RECT.Ptr, lprc, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {GET_STOCK_OBJECT_FLAGS} i 
 ...
 * @since windows5.0
 */
export GetStockObject(i) {
    result := DllCall("GDI32.dll\GetStockObject", GET_STOCK_OBJECT_FLAGS, i, HGDIOBJ.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export GetStretchBltMode(_hdc) {
    result := DllCall("GDI32.dll\GetStretchBltMode", HDC, _hdc, Int32)
    return result
}
...
export GetSystemPaletteEntries(_hdc, iStart, cEntries, pPalEntries) {
    result := DllCall("GDI32.dll\GetSystemPaletteEntries", HDC, _hdc, "uint", iStart, "uint", cEntries, PALETTEENTRY.Ptr, pPalEntries, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetSystemPaletteUse(_hdc) {
    result := DllCall("GDI32.dll\GetSystemPaletteUse", HDC, _hdc, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextCharacterExtra(_hdc) {
    result := DllCall("GDI32.dll\GetTextCharacterExtra", HDC, _hdc, Int32)
    return result
}
 ...
 * </ol>
 * @param {HDC} _hdc A handle to the device context.
 * @returns {TEXT_ALIGN_OPTIONS} If the function succeeds, the return value is the status of the text-alignment flags. For more information about the return value, see the Remarks section. The return value is a combination of the following values.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * @since windows5.0
 */
export GetTextAlign(_hdc) {
    result := DllCall("GDI32.dll\GetTextAlign", HDC, _hdc, TEXT_ALIGN_OPTIONS)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextColor(_hdc) {
    result := DllCall("GDI32.dll\GetTextColor", HDC, _hdc, COLORREF)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextExtentPointA(_hdc, lpString, c, lpsz) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetTextExtentPointA", HDC, _hdc, "ptr", lpString, "int", c, SIZE.Ptr, lpsz, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextExtentPointW(_hdc, lpString, c, lpsz) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetTextExtentPointW", HDC, _hdc, "ptr", lpString, "int", c, SIZE.Ptr, lpsz, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextExtentPoint32A(_hdc, lpString, c, psizl) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetTextExtentPoint32A", HDC, _hdc, "ptr", lpString, "int", c, SIZE.Ptr, psizl, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextExtentPoint32W(_hdc, lpString, c, psizl) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetTextExtentPoint32W", HDC, _hdc, "ptr", lpString, "int", c, SIZE.Ptr, psizl, BOOL)
    return result
}
...
export GetTextExtentExPointA(_hdc, lpszString, cchString, nMaxExtent, lpnFit, lpnDx, lpSize) {
    ...
    result := DllCall("GDI32.dll\GetTextExtentExPointA", HDC, _hdc, "ptr", lpszString, "int", cchString, "int", nMaxExtent, lpnFitMarshal, lpnFit, lpnDxMarshal, lpnDx, SIZE.Ptr, lpSize, BOOL)
    return result
}
...
export GetTextExtentExPointW(_hdc, lpszString, cchString, nMaxExtent, lpnFit, lpnDx, lpSize) {
    ...
    result := DllCall("GDI32.dll\GetTextExtentExPointW", HDC, _hdc, "ptr", lpszString, "int", cchString, "int", nMaxExtent, lpnFitMarshal, lpnFit, lpnDxMarshal, lpnDx, SIZE.Ptr, lpSize, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a display device context.
 ...
 * @since windows5.0
 */
export GetFontLanguageInfo(_hdc) {
    result := DllCall("GDI32.dll\GetFontLanguageInfo", HDC, _hdc, UInt32)
    return result
}
 ...
 * @param {GET_CHARACTER_PLACEMENT_FLAGS} dwFlags 
 ...
 * @since windows5.0
 */
export GetCharacterPlacementA(_hdc, lpString, nCount, nMexExtent, lpResults, dwFlags) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetCharacterPlacementA", HDC, _hdc, "ptr", lpString, "int", nCount, "int", nMexExtent, GCP_RESULTSA.Ptr, lpResults, GET_CHARACTER_PLACEMENT_FLAGS, dwFlags, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetCharacterPlacementW(_hdc, lpString, nCount, nMexExtent, lpResults, dwFlags) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\GetCharacterPlacementW", HDC, _hdc, "ptr", lpString, "int", nCount, "int", nMexExtent, GCP_RESULTSW.Ptr, lpResults, GET_CHARACTER_PLACEMENT_FLAGS, dwFlags, UInt32)
    return result
}
...
export GetGlyphIndicesA(_hdc, lpstr, c, pgi, fl) {
    ...
    result := DllCall("GDI32.dll\GetGlyphIndicesA", HDC, _hdc, "ptr", lpstr, "int", c, pgiMarshal, pgi, "uint", fl, UInt32)
    return result
}
...
export GetGlyphIndicesW(_hdc, lpstr, c, pgi, fl) {
    ...
    result := DllCall("GDI32.dll\GetGlyphIndicesW", HDC, _hdc, "ptr", lpstr, "int", c, pgiMarshal, pgi, "uint", fl, UInt32)
    return result
}
...
export GetTextExtentPointI(_hdc, pgiIn, cgi, psize) {
    ...
    result := DllCall("GDI32.dll\GetTextExtentPointI", HDC, _hdc, pgiInMarshal, pgiIn, "int", cgi, SIZE.Ptr, psize, BOOL)
    return result
}
...
export GetTextExtentExPointI(_hdc, lpwszString, cwchString, nMaxExtent, lpnFit, lpnDx, lpSize) {
    ...
    result := DllCall("GDI32.dll\GetTextExtentExPointI", HDC, _hdc, lpwszStringMarshal, lpwszString, "int", cwchString, "int", nMaxExtent, lpnFitMarshal, lpnFit, lpnDxMarshal, lpnDx, SIZE.Ptr, lpSize, BOOL)
    return result
}
...
export GetCharWidthI(_hdc, giFirst, cgi, pgi, piWidths) {
    ...
    result := DllCall("GDI32.dll\GetCharWidthI", HDC, _hdc, "uint", giFirst, "uint", cgi, pgiMarshal, pgi, piWidthsMarshal, piWidths, BOOL)
    return result
}
...
export GetCharABCWidthsI(_hdc, giFirst, cgi, pgi, pabc) {
    ...
    result := DllCall("GDI32.dll\GetCharABCWidthsI", HDC, _hdc, "uint", giFirst, "uint", cgi, pgiMarshal, pgi, ABC.Ptr, pabc, BOOL)
    return result
}
 ...
 * @param {FONT_RESOURCE_CHARACTERISTICS} fl 
 * @returns {Integer} If the function succeeds, the return value specifies the number of fonts added.
 * 
 * If the function fails, the return value is zero. No extended error information is available.
 ...
 * @since windows5.0
 */
export AddFontResourceExA(name, fl) {
    static res := 0 ;Reserved parameters must always be NULL

    name := name is String ? StrPtr(name) : name

    result := DllCall("GDI32.dll\AddFontResourceExA", "ptr", name, FONT_RESOURCE_CHARACTERISTICS, fl, "ptr", res, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export AddFontResourceExW(name, fl) {
    static res := 0 ;Reserved parameters must always be NULL

    name := name is String ? StrPtr(name) : name

    result := DllCall("GDI32.dll\AddFontResourceExW", "ptr", name, FONT_RESOURCE_CHARACTERISTICS, fl, "ptr", res, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export RemoveFontResourceExA(name, fl) {
    static pdv := 0 ;Reserved parameters must always be NULL

    name := name is String ? StrPtr(name) : name

    result := DllCall("GDI32.dll\RemoveFontResourceExA", "ptr", name, "uint", fl, "ptr", pdv, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RemoveFontResourceExW(name, fl) {
    static pdv := 0 ;Reserved parameters must always be NULL

    name := name is String ? StrPtr(name) : name

    result := DllCall("GDI32.dll\RemoveFontResourceExW", "ptr", name, "uint", fl, "ptr", pdv, BOOL)
    return result
}
 ...
 * @param {Integer} pFileView A pointer to a font resource.
...
export AddFontMemResourceEx(pFileView, cjSize, pNumFonts) {
    ...
    result := DllCall("GDI32.dll\AddFontMemResourceEx", "ptr", pFileView, "uint", cjSize, "ptr", pvResrved, pNumFontsMarshal, pNumFonts, HANDLE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export RemoveFontMemResourceEx(h) {
    result := DllCall("GDI32.dll\RemoveFontMemResourceEx", HANDLE, h, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export CreateFontIndirectExA(param0) {
    result := DllCall("GDI32.dll\CreateFontIndirectExA", ENUMLOGFONTEXDVA.Ptr, param0, HFONT.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export CreateFontIndirectExW(param0) {
    result := DllCall("GDI32.dll\CreateFontIndirectExW", ENUMLOGFONTEXDVW.Ptr, param0, HFONT.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export GetViewportExtEx(_hdc, lpsize) {
    result := DllCall("GDI32.dll\GetViewportExtEx", HDC, _hdc, SIZE.Ptr, lpsize, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetViewportOrgEx(_hdc, lppoint) {
    result := DllCall("GDI32.dll\GetViewportOrgEx", HDC, _hdc, POINT.Ptr, lppoint, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetWindowExtEx(_hdc, lpsize) {
    result := DllCall("GDI32.dll\GetWindowExtEx", HDC, _hdc, SIZE.Ptr, lpsize, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetWindowOrgEx(_hdc, lppoint) {
    result := DllCall("GDI32.dll\GetWindowOrgEx", HDC, _hdc, POINT.Ptr, lppoint, BOOL)
    return result
}
 ...
 * @param {Integer} right The x-coordinate, in logical units, of the lower-right corner of the rectangle.
 * @param {Integer} bottom The y-coordinate, in logical units, of the lower-right corner of the rectangle.
 * @returns {GDI_REGION_TYPE} The return value specifies the new clipping region's type and can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export IntersectClipRect(_hdc, left, top, right, bottom) {
    result := DllCall("GDI32.dll\IntersectClipRect", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context.
 * @param {HRGN} _hrgn Handle to the region for which colors are inverted. The region's coordinates are presumed to be logical coordinates.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export InvertRgn(_hdc, _hrgn) {
    result := DllCall("GDI32.dll\InvertRgn", HDC, _hdc, HRGN, _hrgn, BOOL)
    return result
}
...
export LineDDA(xStart, yStart, xEnd, yEnd, lpProc, data) {
    result := DllCall("GDI32.dll\LineDDA", "int", xStart, "int", yStart, "int", xEnd, "int", yEnd, "ptr", lpProc, LPARAM, data, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export LineTo(_hdc, x, y) {
    result := DllCall("GDI32.dll\LineTo", HDC, _hdc, "int", x, "int", y, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export MaskBlt(hdcDest, xDest, yDest, width, height, hdcSrc, xSrc, ySrc, hbmMask, xMask, yMask, rop) {
    result := DllCall("GDI32.dll\MaskBlt", HDC, hdcDest, "int", xDest, "int", yDest, "int", width, "int", height, HDC, hdcSrc, "int", xSrc, "int", ySrc, HBITMAP, hbmMask, "int", xMask, "int", yMask, "uint", rop, BOOL)
    return result
}
...
export PlgBlt(hdcDest, lpPoint, hdcSrc, xSrc, ySrc, width, height, hbmMask, xMask, yMask) {
    result := DllCall("GDI32.dll\PlgBlt", HDC, hdcDest, POINT.Ptr, lpPoint, HDC, hdcSrc, "int", xSrc, "int", ySrc, "int", width, "int", height, HBITMAP, hbmMask, "int", xMask, "int", yMask, BOOL)
    return result
}
 ...
 * @returns {GDI_REGION_TYPE} The return value specifies the new region's complexity and can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export OffsetClipRgn(_hdc, x, y) {
    result := DllCall("GDI32.dll\OffsetClipRgn", HDC, _hdc, "int", x, "int", y, GDI_REGION_TYPE)
    return result
}

/**
 * The OffsetRgn function moves a region by the specified offsets.
 * @param {HRGN} _hrgn Handle to the region to be moved.
 ...
 * @returns {GDI_REGION_TYPE} The return value specifies the new region's complexity. It can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * @since windows5.0
 */
export OffsetRgn(_hrgn, x, y) {
    result := DllCall("GDI32.dll\OffsetRgn", HRGN, _hrgn, "int", x, "int", y, GDI_REGION_TYPE)
    return result
}
 ...
 * @since windows5.0
 */
export PatBlt(_hdc, x, y, w, h, rop) {
    result := DllCall("GDI32.dll\PatBlt", HDC, _hdc, "int", x, "int", y, "int", w, "int", h, ROP_CODE, rop, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export Pie(_hdc, left, top, right, bottom, xr1, yr1, xr2, yr2) {
    result := DllCall("GDI32.dll\Pie", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, "int", xr1, "int", yr1, "int", xr2, "int", yr2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PlayMetaFile(_hdc, hmf) {
    result := DllCall("GDI32.dll\PlayMetaFile", HDC, _hdc, HMETAFILE, hmf, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context.
 * @param {HRGN} _hrgn Handle to the region to be filled. The region's coordinates are presumed to be logical coordinates.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export PaintRgn(_hdc, _hrgn) {
    result := DllCall("GDI32.dll\PaintRgn", HDC, _hdc, HRGN, _hrgn, BOOL)
    return result
}
...
export PolyPolygon(_hdc, apt, asz, csz) {
    ...
    result := DllCall("GDI32.dll\PolyPolygon", HDC, _hdc, POINT.Ptr, apt, aszMarshal, asz, "int", csz, BOOL)
    return result
}

/**
 * The PtInRegion function determines whether the specified point is inside the specified region.
 * @param {HRGN} _hrgn Handle to the region to be examined.
 ...
 * @since windows5.0
 */
export PtInRegion(_hrgn, x, y) {
    result := DllCall("GDI32.dll\PtInRegion", HRGN, _hrgn, "int", x, "int", y, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PtVisible(_hdc, x, y) {
    result := DllCall("GDI32.dll\PtVisible", HDC, _hdc, "int", x, "int", y, BOOL)
    return result
}

/**
 * The RectInRegion function determines whether any part of the specified rectangle is within the boundaries of a region.
 * @param {HRGN} _hrgn Handle to the region.
 ...
 * @since windows5.0
 */
export RectInRegion(_hrgn, lprect) {
    result := DllCall("GDI32.dll\RectInRegion", HRGN, _hrgn, RECT.Ptr, lprect, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RectVisible(_hdc, lprect) {
    result := DllCall("GDI32.dll\RectVisible", HDC, _hdc, RECT.Ptr, lprect, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export Rectangle(_hdc, left, top, right, bottom) {
    result := DllCall("GDI32.dll\Rectangle", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RestoreDC(_hdc, nSavedDC) {
    result := DllCall("GDI32.dll\RestoreDC", HDC, _hdc, "int", nSavedDC, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the DC to update.
 ...
 * @since windows5.0
 */
export ResetDCA(_hdc, lpdm) {
    result := DllCall("GDI32.dll\ResetDCA", HDC, _hdc, DEVMODEA.Ptr, lpdm, HDC)
    return result
}
 ...
 * @since windows5.0
 */
export ResetDCW(_hdc, lpdm) {
    result := DllCall("GDI32.dll\ResetDCW", HDC, _hdc, DEVMODEW.Ptr, lpdm, HDC)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context into which a logical palette has been selected.
 ...
 * @since windows5.0
 */
export RealizePalette(_hdc) {
    result := DllCall("GDI32.dll\RealizePalette", HDC, _hdc, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export RemoveFontResourceA(lpFileName) {
    lpFileName := lpFileName is String ? StrPtr(lpFileName) : lpFileName

    result := DllCall("GDI32.dll\RemoveFontResourceA", "ptr", lpFileName, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RemoveFontResourceW(lpFileName) {
    lpFileName := lpFileName is String ? StrPtr(lpFileName) : lpFileName

    result := DllCall("GDI32.dll\RemoveFontResourceW", "ptr", lpFileName, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export RoundRect(_hdc, left, top, right, bottom, width, height) {
    result := DllCall("GDI32.dll\RoundRect", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, "int", width, "int", height, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export ResizePalette(hpal, n) {
    result := DllCall("GDI32.dll\ResizePalette", HPALETTE, hpal, "uint", n, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the DC whose state is to be saved.
 ...
 */
export SaveDC(_hdc) {
    result := DllCall("GDI32.dll\SaveDC", HDC, _hdc, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HRGN} _hrgn A handle to the region to be selected.
 * @returns {GDI_REGION_TYPE} The return value specifies the region's complexity and can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {HRGN} _hrgn A handle to the region to be selected. This handle must not be <b>NULL</b> unless the RGN_COPY mode is specified.
 * @param {RGN_COMBINE_MODE} _mode 
 * @returns {GDI_REGION_TYPE} The return value specifies the new clipping region's complexity; it can be one of the following values.
 * 
 * <table>
 * <tr>
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @returns {GDI_REGION_TYPE} The return value specifies the new clipping region's complexity and can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export SetMetaRgn(_hdc) {
    result := DllCall("GDI32.dll\SetMetaRgn", HDC, _hdc, GDI_REGION_TYPE)
    return result
}
 ...
 * @since windows5.0
 */
export SelectObject(_hdc, h) {
    result := DllCall("GDI32.dll\SelectObject", HDC, _hdc, HGDIOBJ, h, HGDIOBJ.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export SelectPalette(_hdc, hPal, bForceBkgd) {
    result := DllCall("GDI32.dll\SelectPalette", HDC, _hdc, HPALETTE, hPal, BOOL, bForceBkgd, HPALETTE.Owned)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {COLORREF} _color The new background color. To make a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 ...
 * @since windows5.0
 */
export SetBkColor(_hdc, _color) {
    result := DllCall("GDI32.dll\SetBkColor", HDC, _hdc, COLORREF, _color, COLORREF)
    return result
}
 ...
 * <b>ICM:</b> Color management is performed if ICM is enabled.
 * @param {HDC} _hdc A handle to the DC.
 * @param {COLORREF} _color The new brush color.
 ...
 * @since windows5.0
 */
export SetDCBrushColor(_hdc, _color) {
    result := DllCall("GDI32.dll\SetDCBrushColor", HDC, _hdc, COLORREF, _color, COLORREF)
    return result
}
 ...
 * <b>ICM:</b> Color management is performed if ICM is enabled.
 * @param {HDC} _hdc A handle to the DC.
 * @param {COLORREF} _color The new pen color.
 ...
 * @since windows5.0
 */
export SetDCPenColor(_hdc, _color) {
    result := DllCall("GDI32.dll\SetDCPenColor", HDC, _hdc, COLORREF, _color, COLORREF)
    return result
}
 ...
 * @since windows5.0
 */
export SetBkMode(_hdc, _mode) {
    result := DllCall("GDI32.dll\SetBkMode", HDC, _hdc, "int", _mode, Int32)
    return result
}
 ...
 * @param {HBITMAP} _hbm A handle to the bitmap to be set. This must be a compatible bitmap (DDB).
 * @param {Integer} cb The number of bytes pointed to by the <i>lpBits</i> parameter.
 * @param {Integer} pvBits A pointer to an array of bytes that contain color data for the specified bitmap.
 ...
 * @since windows5.0
 */
export SetBitmapBits(_hbm, cb, pvBits) {
    result := DllCall("GDI32.dll\SetBitmapBits", HBITMAP, _hbm, "uint", cb, "ptr", pvBits, Int32)
    return result
}
 ...
 * @remarks
 * The DCB_SET value is a combination of the bit values DCB_ACCUMULATE and DCB_RESET. Applications that check the DCB_RESET bit to determine whether the bounding rectangle is empty must also check the DCB_ACCUMULATE bit. The bounding rectangle is empty only if the DCB_RESET bit is 1 and the DCB_ACCUMULATE bit is 0.
 * @param {HDC} _hdc A handle to the device context for which to accumulate bounding rectangles.
 ...
 * @param {SET_BOUNDS_RECT_FLAGS} flags 
 ...
 * @param {HDC} _hdc A handle to a device context.
 * @param {HBITMAP} _hbm A handle to the compatible bitmap (DDB) that is to be altered using the color data from the specified DIB.
...
export SetDIBits(_hdc, _hbm, start, cLines, lpBits, lpbmi, ColorUse) {
    ...
    result := DllCall("GDI32.dll\SetDIBits", HDC, _hdc, HBITMAP, _hbm, "uint", start, "uint", cLines, lpBitsMarshal, lpBits, BITMAPINFO.Ptr, lpbmi, DIB_USAGE, ColorUse, Int32)
    return result
}
...
export SetDIBitsToDevice(_hdc, xDest, yDest, w, h, xSrc, ySrc, StartScan, cLines, lpvBits, lpbmi, ColorUse) {
    ...
    result := DllCall("GDI32.dll\SetDIBitsToDevice", HDC, _hdc, "int", xDest, "int", yDest, "uint", w, "uint", h, "int", xSrc, "int", ySrc, "uint", StartScan, "uint", cLines, lpvBitsMarshal, lpvBits, BITMAPINFO.Ptr, lpbmi, DIB_USAGE, ColorUse, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context that contains the font-mapper flag.
 ...
 * @since windows5.0
 */
export SetMapperFlags(_hdc, flags) {
    result := DllCall("GDI32.dll\SetMapperFlags", HDC, _hdc, "uint", flags, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SetGraphicsMode(_hdc, iMode) {
    result := DllCall("GDI32.dll\SetGraphicsMode", HDC, _hdc, GRAPHICS_MODE, iMode, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SetMapMode(_hdc, iMode) {
    result := DllCall("GDI32.dll\SetMapMode", HDC, _hdc, HDC_MAP_MODE, iMode, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SetLayout(_hdc, l) {
    result := DllCall("GDI32.dll\SetLayout", HDC, _hdc, DC_LAYOUT, l, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GetLayout(_hdc) {
    A_LastError := 0

    result := DllCall("GDI32.dll\GetLayout", HDC, _hdc, UInt32)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @param {Integer} lpData Pointer to a buffer that contains the Windows-format metafile. (It is assumed that the data was obtained by using the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-getmetafilebitsex">GetMetaFileBitsEx</a> function.)
 ...
 * @since windows5.0
 */
export SetMetaFileBitsEx(cbBuffer, lpData) {
    result := DllCall("GDI32.dll\SetMetaFileBitsEx", "uint", cbBuffer, "ptr", lpData, HMETAFILE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export SetPaletteEntries(hpal, iStart, cEntries, pPalEntries) {
    result := DllCall("GDI32.dll\SetPaletteEntries", HPALETTE, hpal, "uint", iStart, "uint", cEntries, PALETTEENTRY.Ptr, pPalEntries, UInt32)
    return result
}
 ...
 * @param {COLORREF} _color The color to be used to paint the point. To create a <a href="https://docs.microsoft.com/windows/desktop/gdi/colorref">COLORREF</a> color value, use the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb">RGB</a> macro.
 ...
 * @since windows5.0
 */
export SetPixel(_hdc, x, y, _color) {
    result := DllCall("GDI32.dll\SetPixel", HDC, _hdc, "int", x, "int", y, COLORREF, _color, COLORREF)
    return result
}
 ...
 * @since windows5.0
 */
export SetPixelV(_hdc, x, y, _color) {
    result := DllCall("GDI32.dll\SetPixelV", HDC, _hdc, "int", x, "int", y, COLORREF, _color, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {CREATE_POLYGON_RGN_MODE} _mode 
 ...
 * @since windows5.0
 */
export SetPolyFillMode(_hdc, _mode) {
    result := DllCall("GDI32.dll\SetPolyFillMode", HDC, _hdc, CREATE_POLYGON_RGN_MODE, _mode, Int32)
    return result
}
 ...
 * @param {ROP_CODE} rop The raster operation to be performed. Raster operation codes define how the system combines colors in output operations that involve a brush, a source bitmap, and a destination bitmap.
 * 
...
export StretchBlt(hdcDest, xDest, yDest, wDest, hDest, hdcSrc, xSrc, ySrc, wSrc, hSrc, rop) {
    result := DllCall("GDI32.dll\StretchBlt", HDC, hdcDest, "int", xDest, "int", yDest, "int", wDest, "int", hDest, HDC, hdcSrc, "int", xSrc, "int", ySrc, "int", wSrc, "int", hSrc, ROP_CODE, rop, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetRectRgn(_hrgn, left, top, right, bottom) {
    result := DllCall("GDI32.dll\SetRectRgn", HRGN, _hrgn, "int", left, "int", top, "int", right, "int", bottom, BOOL)
    return result
}
 ...
 * @param {Pointer<BITMAPINFO>} lpbmi A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-bitmapinfo">BITMAPINFO</a> structure that contains information about the DIB.
 * @param {DIB_USAGE} iUsage 
 * @param {ROP_CODE} rop A raster-operation code that specifies how the source pixels, the destination device context's current brush, and the destination pixels are to be combined to form the new image. For a list of some common raster operation codes, see <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-bitblt">BitBlt</a>.
...
export StretchDIBits(_hdc, xDest, yDest, DestWidth, DestHeight, xSrc, ySrc, SrcWidth, SrcHeight, lpBits, lpbmi, iUsage, rop) {
    ...
    result := DllCall("GDI32.dll\StretchDIBits", HDC, _hdc, "int", xDest, "int", yDest, "int", DestWidth, "int", DestHeight, "int", xSrc, "int", ySrc, "int", SrcWidth, "int", SrcHeight, lpBitsMarshal, lpBits, BITMAPINFO.Ptr, lpbmi, DIB_USAGE, iUsage, ROP_CODE, rop, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SetROP2(_hdc, rop2) {
    result := DllCall("GDI32.dll\SetROP2", HDC, _hdc, R2_MODE, rop2, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export SetStretchBltMode(_hdc, _mode) {
    result := DllCall("GDI32.dll\SetStretchBltMode", HDC, _hdc, STRETCH_BLT_MODE, _mode, Int32)
    return result
}
 ...
 * </ol>
 * @param {HDC} _hdc A handle to the device context. This device context must refer to a device that supports color palettes.
 * @param {SYSTEM_PALETTE_USE} use 
 ...
 * @since windows5.0
 */
export SetSystemPaletteUse(_hdc, use) {
    result := DllCall("GDI32.dll\SetSystemPaletteUse", HDC, _hdc, SYSTEM_PALETTE_USE, use, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SetTextCharacterExtra(_hdc, extra) {
    result := DllCall("GDI32.dll\SetTextCharacterExtra", HDC, _hdc, "int", extra, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context.
 * @param {COLORREF} _color The color of the text.
 ...
 * @since windows5.0
 */
export SetTextColor(_hdc, _color) {
    result := DllCall("GDI32.dll\SetTextColor", HDC, _hdc, COLORREF, _color, COLORREF)
    return result
}
 ...
 * <div> </div>
 * @param {HDC} _hdc A handle to the device context.
 * @param {TEXT_ALIGN_OPTIONS} align The text alignment by using a mask of the values in the following list. Only one flag can be chosen from those that affect horizontal and vertical alignment. In addition, only one of the two flags that alter the current position can be chosen.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * @since windows5.0
 */
export SetTextAlign(_hdc, align) {
    result := DllCall("GDI32.dll\SetTextAlign", HDC, _hdc, TEXT_ALIGN_OPTIONS, align, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SetTextJustification(_hdc, extra, count) {
    result := DllCall("GDI32.dll\SetTextJustification", HDC, _hdc, "int", extra, "int", count, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export UpdateColors(_hdc) {
    result := DllCall("GDI32.dll\UpdateColors", HDC, _hdc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export AlphaBlend(hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, ftn) {
    result := DllCall("MSIMG32.dll\AlphaBlend", HDC, hdcDest, "int", xoriginDest, "int", yoriginDest, "int", wDest, "int", hDest, HDC, hdcSrc, "int", xoriginSrc, "int", yoriginSrc, "int", wSrc, "int", hSrc, BLENDFUNCTION, ftn, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export TransparentBlt(hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, crTransparent) {
    result := DllCall("MSIMG32.dll\TransparentBlt", HDC, hdcDest, "int", xoriginDest, "int", yoriginDest, "int", wDest, "int", hDest, HDC, hdcSrc, "int", xoriginSrc, "int", yoriginSrc, "int", wSrc, "int", hSrc, "uint", crTransparent, BOOL)
    return result
}
...
export GradientFill(_hdc, pVertex, nVertex, pMesh, nMesh, ulMode) {
    ...
    result := DllCall("MSIMG32.dll\GradientFill", HDC, _hdc, TRIVERTEX.Ptr, pVertex, "uint", nVertex, pMeshMarshal, pMesh, "uint", nMesh, GRADIENT_FILL, ulMode, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GdiAlphaBlend(hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, ftn) {
    result := DllCall("GDI32.dll\GdiAlphaBlend", HDC, hdcDest, "int", xoriginDest, "int", yoriginDest, "int", wDest, "int", hDest, HDC, hdcSrc, "int", xoriginSrc, "int", yoriginSrc, "int", wSrc, "int", hSrc, BLENDFUNCTION, ftn, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GdiTransparentBlt(hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, crTransparent) {
    result := DllCall("GDI32.dll\GdiTransparentBlt", HDC, hdcDest, "int", xoriginDest, "int", yoriginDest, "int", wDest, "int", hDest, HDC, hdcSrc, "int", xoriginSrc, "int", yoriginSrc, "int", wSrc, "int", hSrc, "uint", crTransparent, BOOL)
    return result
}
...
export GdiGradientFill(_hdc, pVertex, nVertex, pMesh, nCount, ulMode) {
    ...
    result := DllCall("GDI32.dll\GdiGradientFill", HDC, _hdc, TRIVERTEX.Ptr, pVertex, "uint", nVertex, pMeshMarshal, pMesh, "uint", nCount, GRADIENT_FILL, ulMode, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PlayMetaFileRecord(_hdc, lpHandleTable, lpMR, noObjs) {
    result := DllCall("GDI32.dll\PlayMetaFileRecord", HDC, _hdc, HANDLETABLE.Ptr, lpHandleTable, METARECORD.Ptr, lpMR, "uint", noObjs, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a device context. This handle is passed to the callback function.
 * @param {HMETAFILE} hmf Handle to a Windows-format metafile.
 * @param {Pointer<MFENUMPROC>} _proc Pointer to an application-supplied callback function. For more information, see <a href="https://docs.microsoft.com/previous-versions/dd162630(v=vs.85)">EnumMetaFileProc</a>.
 * @param {LPARAM} param3 
 ...
 * @param {HDC} _hdc Handle to an enhanced-metafile device context.
 ...
 * @since windows5.0
 */
export CloseEnhMetaFile(_hdc) {
    result := DllCall("GDI32.dll\CloseEnhMetaFile", HDC, _hdc, HENHMETAFILE.Owned)
    return result
}
 ...
 * @param {HDC} _hdc A handle to a reference device for the enhanced metafile. This parameter can be <b>NULL</b>; for more information, see Remarks.
 ...
 * @since windows5.0
 */
export CreateEnhMetaFileA(_hdc, lpFilename, lprc, lpDesc) {
    lpFilename := lpFilename is String ? StrPtr(lpFilename) : lpFilename
 ...
 * @since windows5.0
 */
export CreateEnhMetaFileW(_hdc, lpFilename, lprc, lpDesc) {
    lpFilename := lpFilename is String ? StrPtr(lpFilename) : lpFilename
    lpDesc := lpDesc is String ? StrPtr(lpDesc) : lpDesc
 ...
 * @param {HDC} _hdc A handle to a device context. This handle is passed to the callback function.
 * @param {HENHMETAFILE} hmf A handle to an enhanced metafile.
 * @param {Pointer<ENHMFENUMPROC>} _proc A pointer to the application-supplied callback function. For more information, see the <a href="https://docs.microsoft.com/previous-versions/dd162606(v=vs.85)">EnhMetaFileProc</a> function.
 ...
 * @since windows5.0
 */
export GetEnhMetaFileA(lpName) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("GDI32.dll\GetEnhMetaFileA", "ptr", lpName, HENHMETAFILE.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export GetEnhMetaFileW(lpName) {
    lpName := lpName is String ? StrPtr(lpName) : lpName

    result := DllCall("GDI32.dll\GetEnhMetaFileW", "ptr", lpName, HENHMETAFILE.Owned)
    return result
}
 ...
 * @param {Integer} lpData A pointer to a buffer that receives the metafile data. The buffer must be sufficiently large to contain the data. If <i>lpbBuffer</i> is <b>NULL</b>, the function returns the size necessary to hold the data.
...
export GetEnhMetaFileBits(hEMF, nSize, lpData) {
    result := DllCall("GDI32.dll\GetEnhMetaFileBits", HENHMETAFILE, hEMF, "uint", nSize, "ptr", lpData, UInt32)
    return result
}
...
export GetEnhMetaFileDescriptionA(hemf, cchBuffer, lpDescription) {
    ...
    result := DllCall("GDI32.dll\GetEnhMetaFileDescriptionA", HENHMETAFILE, hemf, "uint", cchBuffer, "ptr", lpDescription, UInt32)
    return result
}
...
export GetEnhMetaFileDescriptionW(hemf, cchBuffer, lpDescription) {
    ...
    result := DllCall("GDI32.dll\GetEnhMetaFileDescriptionW", HENHMETAFILE, hemf, "uint", cchBuffer, "ptr", lpDescription, UInt32)
    return result
}
 ...
 * @param {Integer} lpEnhMetaHeader A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-enhmetaheader">ENHMETAHEADER</a> structure that receives the header record. If this parameter is <b>NULL</b>, the function returns the size of the header record.
...
export GetEnhMetaFileHeader(hemf, nSize, lpEnhMetaHeader) {
    result := DllCall("GDI32.dll\GetEnhMetaFileHeader", HENHMETAFILE, hemf, "uint", nSize, "ptr", lpEnhMetaHeader, UInt32)
    return result
}
...
export GetEnhMetaFilePaletteEntries(hemf, nNumEntries, lpPaletteEntries) {
    result := DllCall("GDI32.dll\GetEnhMetaFilePaletteEntries", HENHMETAFILE, hemf, "uint", nNumEntries, PALETTEENTRY.Ptr, lpPaletteEntries, UInt32)
    return result
}
 ...
 * @param {Integer} pData16 A pointer to the buffer that receives the converted records. If <i>lpbBuffer</i> is <b>NULL</b>, <b>GetWinMetaFileBits</b> returns the number of bytes required to store the converted metafile records.
...
export GetWinMetaFileBits(hemf, cbData16, pData16, iMapMode, hdcRef) {
    result := DllCall("GDI32.dll\GetWinMetaFileBits", HENHMETAFILE, hemf, "uint", cbData16, "ptr", pData16, "int", iMapMode, HDC, hdcRef, UInt32)
    return result
}
 ...
 * 
 * To stop this function, an application can call the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-canceldc">CancelDC</a> function from another thread to terminate the operation. In this case, the function returns <b>FALSE</b>.
 * @param {HDC} _hdc A handle to the device context for the output device on which the picture will appear.
 ...
 * @since windows5.0
 */
export PlayEnhMetaFile(_hdc, hmf, lprect) {
    result := DllCall("GDI32.dll\PlayEnhMetaFile", HDC, _hdc, HENHMETAFILE, hmf, RECT.Ptr, lprect, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context passed to the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-enumenhmetafile">EnumEnhMetaFile</a> function.
 ...
 * @since windows5.0
 */
export PlayEnhMetaFileRecord(_hdc, pht, pmr, cht) {
    result := DllCall("GDI32.dll\PlayEnhMetaFileRecord", HDC, _hdc, HANDLETABLE.Ptr, pht, ENHMETARECORD.Ptr, pmr, "uint", cht, BOOL)
    return result
}
 ...
 * @param {Integer} pb Pointer to a buffer that contains enhanced-metafile data. (It is assumed that the data in the buffer was obtained by calling the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-getenhmetafilebits">GetEnhMetaFileBits</a> function.)
 ...
 * @since windows5.0
 */
export SetEnhMetaFileBits(nSize, pb) {
    result := DllCall("GDI32.dll\SetEnhMetaFileBits", "uint", nSize, "ptr", pb, HENHMETAFILE.Owned)
    return result
}
 ...
 * 
 * ```
 * @param {HDC} _hdc A handle to an enhanced-metafile device context.
 * @param {Integer} nSize The length of the comment buffer, in bytes.
 * @param {Integer} lpData A pointer to the buffer that contains the comment.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export GdiComment(_hdc, nSize, lpData) {
    result := DllCall("GDI32.dll\GdiComment", HDC, _hdc, "uint", nSize, "ptr", lpData, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextMetricsA(_hdc, lptm) {
    result := DllCall("GDI32.dll\GetTextMetricsA", HDC, _hdc, TEXTMETRICA.Ptr, lptm, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetTextMetricsW(_hdc, lptm) {
    result := DllCall("GDI32.dll\GetTextMetricsW", HDC, _hdc, TEXTMETRICW.Ptr, lptm, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export AngleArc(_hdc, x, y, r, StartAngle, SweepAngle) {
    result := DllCall("GDI32.dll\AngleArc", HDC, _hdc, "int", x, "int", y, "uint", r, "float", StartAngle, "float", SweepAngle, BOOL)
    return result
}
...
export PolyPolyline(_hdc, apt, asz, csz) {
    ...
    result := DllCall("GDI32.dll\PolyPolyline", HDC, _hdc, POINT.Ptr, apt, aszMarshal, asz, "uint", csz, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetWorldTransform(_hdc, lpxf) {
    result := DllCall("GDI32.dll\GetWorldTransform", HDC, _hdc, XFORM.Ptr, lpxf, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetWorldTransform(_hdc, lpxf) {
    result := DllCall("GDI32.dll\SetWorldTransform", HDC, _hdc, XFORM.Ptr, lpxf, BOOL)
    return result
}
 ...
 * @param {MODIFY_WORLD_TRANSFORM_MODE} _mode 
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export CombineTransform(lpxfOut, lpxf1, lpxf2) {
    result := DllCall("GDI32.dll\CombineTransform", XFORM.Ptr, lpxfOut, XFORM.Ptr, lpxf1, XFORM.Ptr, lpxf2, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to a device context. If the value of <i>iUsage</i> is DIB_PAL_COLORS, the function uses this device context's logical palette to initialize the DIB colors.
 ...
 * @param {DIB_USAGE} usage The type of data contained in the <b>bmiColors</b> array member of the <a href="https://docs.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-bitmapinfo">BITMAPINFO</a> structure pointed to by <i>pbmi</i> (either logical palette indexes or literal RGB values). The following values are defined.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
...
export CreateDIBSection(_hdc, pbmi, usage, ppvBits, hSection, offset) {
    ...
    result := DllCall("GDI32.dll\CreateDIBSection", HDC, _hdc, BITMAPINFO.Ptr, pbmi, DIB_USAGE, usage, ppvBitsMarshal, ppvBits, HANDLE, hSection, "uint", offset, HBITMAP.Owned)
    if(A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @param {HDC} _hdc A handle to a device context. A DIB section bitmap must be selected into this device context.
 ...
 * @since windows5.0
 */
export GetDIBColorTable(_hdc, iStart, cEntries, prgbq) {
    result := DllCall("GDI32.dll\GetDIBColorTable", HDC, _hdc, "uint", iStart, "uint", cEntries, RGBQUAD.Ptr, prgbq, UInt32)
    return result
}
 ...
 * @param {HDC} _hdc A device context. A DIB must be selected into this device context.
 ...
 * @since windows5.0
 */
export SetDIBColorTable(_hdc, iStart, cEntries, prgbq) {
    result := DllCall("GDI32.dll\SetDIBColorTable", HDC, _hdc, "uint", iStart, "uint", cEntries, RGBQUAD.Ptr, prgbq, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export SetColorAdjustment(_hdc, lpca) {
    result := DllCall("GDI32.dll\SetColorAdjustment", HDC, _hdc, COLORADJUSTMENT.Ptr, lpca, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetColorAdjustment(_hdc, lpca) {
    result := DllCall("GDI32.dll\GetColorAdjustment", HDC, _hdc, COLORADJUSTMENT.Ptr, lpca, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context from which a path will be discarded.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export AbortPath(_hdc) {
    result := DllCall("GDI32.dll\AbortPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export ArcTo(_hdc, left, top, right, bottom, xr1, yr1, xr2, yr2) {
    result := DllCall("GDI32.dll\ArcTo", HDC, _hdc, "int", left, "int", top, "int", right, "int", bottom, "int", xr1, "int", yr1, "int", xr2, "int", yr2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export BeginPath(_hdc) {
    result := DllCall("GDI32.dll\BeginPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to the device context in which the figure will be closed.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export CloseFigure(_hdc) {
    result := DllCall("GDI32.dll\CloseFigure", HDC, _hdc, BOOL)
    return result
}

/**
 * The EndPath function closes a path bracket and selects the path defined by the bracket into the specified device context.
 * @param {HDC} _hdc A handle to the device context into which the new path is selected.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 */
export EndPath(_hdc) {
    result := DllCall("GDI32.dll\EndPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to a device context that contains a valid path.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export FillPath(_hdc) {
    result := DllCall("GDI32.dll\FillPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to a DC that contains a valid path.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export FlattenPath(_hdc) {
    result := DllCall("GDI32.dll\FlattenPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to a device context that contains a closed path.
...
export GetPath(_hdc, apt, aj, cpt) {
    ...
    result := DllCall("GDI32.dll\GetPath", HDC, _hdc, POINT.Ptr, apt, ajMarshal, aj, "int", cpt, Int32)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a device context that contains a closed path.
 ...
 * @since windows5.0
 */
export PathToRegion(_hdc) {
    result := DllCall("GDI32.dll\PathToRegion", HDC, _hdc, HRGN.Owned)
    return result
}
...
export PolyDraw(_hdc, apt, aj, cpt) {
    ...
    result := DllCall("GDI32.dll\PolyDraw", HDC, _hdc, POINT.Ptr, apt, ajMarshal, aj, "int", cpt, BOOL)
    return result
}
 ...
 * @remarks
 * The device context identified by the <i>hdc</i> parameter must contain a closed path.
 * @param {HDC} _hdc A handle to the device context of the path.
 * @param {RGN_COMBINE_MODE} _mode 
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export SelectClipPath(_hdc, _mode) {
    result := DllCall("GDI32.dll\SelectClipPath", HDC, _hdc, RGN_COMBINE_MODE, _mode, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetArcDirection(_hdc, dir) {
    result := DllCall("GDI32.dll\SetArcDirection", HDC, _hdc, ARC_DIRECTION, dir, Int32)
    return result
}
...
export SetMiterLimit(_hdc, limit, old) {
    ...
    result := DllCall("GDI32.dll\SetMiterLimit", HDC, _hdc, "float", limit, oldMarshal, old, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export StrokeAndFillPath(_hdc) {
    result := DllCall("GDI32.dll\StrokeAndFillPath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc Handle to a device context that contains the completed path.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export StrokePath(_hdc) {
    result := DllCall("GDI32.dll\StrokePath", HDC, _hdc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export WidenPath(_hdc) {
    result := DllCall("GDI32.dll\WidenPath", HDC, _hdc, BOOL)
    return result
}
...
export ExtCreatePen(iPenStyle, cWidth, plbrush, cStyle, pstyle) {
    ...
    result := DllCall("GDI32.dll\ExtCreatePen", "uint", iPenStyle, "uint", cWidth, LOGBRUSH.Ptr, plbrush, "uint", cStyle, pstyleMarshal, pstyle, HPEN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export GetArcDirection(_hdc) {
    result := DllCall("GDI32.dll\GetArcDirection", HDC, _hdc, Int32)
    return result
}
...
export GetObjectW(h, c, pv) {
    result := DllCall("GDI32.dll\GetObjectW", HGDIOBJ, h, "int", c, "ptr", pv, Int32)
    return result
}
...
export MoveToEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\MoveToEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export TextOutA(_hdc, x, y, lpString, c) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\TextOutA", HDC, _hdc, "int", x, "int", y, "ptr", lpString, "int", c, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export TextOutW(_hdc, x, y, lpString, c) {
    lpString := lpString is String ? StrPtr(lpString) : lpString

    result := DllCall("GDI32.dll\TextOutW", HDC, _hdc, "int", x, "int", y, "ptr", lpString, "int", c, BOOL)
    return result
}
...
export ExtTextOutA(_hdc, x, y, options, lprect, lpString, c, lpDx) {
    ...
    result := DllCall("GDI32.dll\ExtTextOutA", HDC, _hdc, "int", x, "int", y, ETO_OPTIONS, options, RECT.Ptr, lprect, "ptr", lpString, "uint", c, lpDxMarshal, lpDx, BOOL)
    return result
}
...
export ExtTextOutW(_hdc, x, y, options, lprect, lpString, c, lpDx) {
    ...
    result := DllCall("GDI32.dll\ExtTextOutW", HDC, _hdc, "int", x, "int", y, ETO_OPTIONS, options, RECT.Ptr, lprect, "ptr", lpString, "uint", c, lpDxMarshal, lpDx, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PolyTextOutA(_hdc, ppt, nstrings) {
    result := DllCall("GDI32.dll\PolyTextOutA", HDC, _hdc, POLYTEXTA.Ptr, ppt, "int", nstrings, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PolyTextOutW(_hdc, ppt, nstrings) {
    result := DllCall("GDI32.dll\PolyTextOutW", HDC, _hdc, POLYTEXTW.Ptr, ppt, "int", nstrings, BOOL)
    return result
}
 ...
 * @param {Integer} _cPoint The number of points in the array.
 * @param {CREATE_POLYGON_RGN_MODE} iMode 
 * @returns {HRGN} If the function succeeds, the return value is the handle to the region.
 * 
 * If the function fails, the return value is <b>NULL</b>.
 ...
 * @since windows5.0
 */
export CreatePolygonRgn(pptl, _cPoint, iMode) {
    result := DllCall("GDI32.dll\CreatePolygonRgn", POINT.Ptr, pptl, "int", _cPoint, CREATE_POLYGON_RGN_MODE, iMode, HRGN.Owned)
    return result
}
 ...
 * @since windows5.0
 */
export DPtoLP(_hdc, lppt, c) {
    result := DllCall("GDI32.dll\DPtoLP", HDC, _hdc, POINT.Ptr, lppt, "int", c, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export LPtoDP(_hdc, lppt, c) {
    result := DllCall("GDI32.dll\LPtoDP", HDC, _hdc, POINT.Ptr, lppt, "int", c, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export Polygon(_hdc, apt, cpt) {
    result := DllCall("GDI32.dll\Polygon", HDC, _hdc, POINT.Ptr, apt, "int", cpt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export Polyline(_hdc, apt, cpt) {
    result := DllCall("GDI32.dll\Polyline", HDC, _hdc, POINT.Ptr, apt, "int", cpt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PolyBezier(_hdc, apt, cpt) {
    result := DllCall("GDI32.dll\PolyBezier", HDC, _hdc, POINT.Ptr, apt, "uint", cpt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PolyBezierTo(_hdc, apt, cpt) {
    result := DllCall("GDI32.dll\PolyBezierTo", HDC, _hdc, POINT.Ptr, apt, "uint", cpt, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PolylineTo(_hdc, apt, cpt) {
    result := DllCall("GDI32.dll\PolylineTo", HDC, _hdc, POINT.Ptr, apt, "uint", cpt, BOOL)
    return result
}
...
export SetViewportExtEx(_hdc, x, y, lpsz) {
    result := DllCall("GDI32.dll\SetViewportExtEx", HDC, _hdc, "int", x, "int", y, SIZE.Ptr, lpsz, BOOL)
    return result
}
...
export SetViewportOrgEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\SetViewportOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
...
export SetWindowExtEx(_hdc, x, y, lpsz) {
    result := DllCall("GDI32.dll\SetWindowExtEx", HDC, _hdc, "int", x, "int", y, SIZE.Ptr, lpsz, BOOL)
    return result
}
...
export SetWindowOrgEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\SetWindowOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
...
export OffsetViewportOrgEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\OffsetViewportOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
...
export OffsetWindowOrgEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\OffsetWindowOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
...
export ScaleViewportExtEx(_hdc, xn, dx, yn, yd, lpsz) {
    result := DllCall("GDI32.dll\ScaleViewportExtEx", HDC, _hdc, "int", xn, "int", dx, "int", yn, "int", yd, SIZE.Ptr, lpsz, BOOL)
    return result
}
...
export ScaleWindowExtEx(_hdc, xn, xd, yn, yd, lpsz) {
    result := DllCall("GDI32.dll\ScaleWindowExtEx", HDC, _hdc, "int", xn, "int", xd, "int", yn, "int", yd, SIZE.Ptr, lpsz, BOOL)
    return result
}
 ...
 * @param {HBITMAP} _hbm A handle to the bitmap. The bitmap cannot be a DIB-section bitmap.
...
export SetBitmapDimensionEx(_hbm, w, h, lpsz) {
    result := DllCall("GDI32.dll\SetBitmapDimensionEx", HBITMAP, _hbm, "int", w, "int", h, SIZE.Ptr, lpsz, BOOL)
    return result
}
...
export SetBrushOrgEx(_hdc, x, y, lppt) {
    result := DllCall("GDI32.dll\SetBrushOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, lppt, BOOL)
    return result
}
...
export GetTextFaceA(_hdc, c, lpName) {
    ...
    result := DllCall("GDI32.dll\GetTextFaceA", HDC, _hdc, "int", c, "ptr", lpName, Int32)
    return result
}
...
export GetTextFaceW(_hdc, c, lpName) {
    ...
    result := DllCall("GDI32.dll\GetTextFaceW", HDC, _hdc, "int", c, "ptr", lpName, Int32)
    return result
}
...
export GetKerningPairsA(_hdc, nPairs, lpKernPair) {
    result := DllCall("GDI32.dll\GetKerningPairsA", HDC, _hdc, "uint", nPairs, KERNINGPAIR.Ptr, lpKernPair, UInt32)
    return result
}
...
export GetKerningPairsW(_hdc, nPairs, lpKernPair) {
    result := DllCall("GDI32.dll\GetKerningPairsW", HDC, _hdc, "uint", nPairs, KERNINGPAIR.Ptr, lpKernPair, UInt32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the DC whose final translation origin is to be retrieved.
 ...
 * @since windows5.0
 */
export GetDCOrgEx(_hdc, lppt) {
    result := DllCall("GDI32.dll\GetDCOrgEx", HDC, _hdc, POINT.Ptr, lppt, BOOL)
    return result
}
...
export FixBrushOrgEx(_hdc, x, y, ptl) {
    result := DllCall("GDI32.dll\FixBrushOrgEx", HDC, _hdc, "int", x, "int", y, POINT.Ptr, ptl, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export UnrealizeObject(h) {
    result := DllCall("GDI32.dll\UnrealizeObject", HGDIOBJ, h, BOOL)
    return result
}
 ...
 */
export GdiFlush() {
    result := DllCall("GDI32.dll\GdiFlush", BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GdiSetBatchLimit(dw) {
    result := DllCall("GDI32.dll\GdiSetBatchLimit", "uint", dw, UInt32)
    return result
}
 ...
 * @since windows5.0
 */
export GdiGetBatchLimit() {
    result := DllCall("GDI32.dll\GdiGetBatchLimit", UInt32)
    return result
}
 ...
 * @returns {Integer} 
 */
export wglSwapMultipleBuffers(param0, param1) {
    result := DllCall("OPENGL32.dll\wglSwapMultipleBuffers", "uint", param0, WGLSWAP.Ptr, param1, UInt32)
    return result
}
 ...
 * @param {CREATE_FONT_PACKAGE_SUBSET_PLATFORM} usSubsetPlatform In conjunction with <i>usSubsetEncoding</i>, specifies which CMAP to use. Used only if *<i>pusSubsetKeepList</i> is a list of characters: that is, used only if TTFCFP_FLAGS_GLYPHLIST is not set in <i>usFlags</i>. In that case, by this CMAP subtable is applied to <i>pusSubsetKeepList</i> to create a list of glyphs to retain in the output font or font package.
 * @param {CREATE_FONT_PACKAGE_SUBSET_ENCODING} usSubsetEncoding In conjunction with <i>usSubsetPlatform</i>, specifies which CMAP to use. Used only if *<i>pusSubsetKeepList</i> is a list of characters: that is, used only if TTFCFP_FLAGS_GLYPHLIST is not set in <i>usFlags</i>.
...
export CreateFontPackage(puchSrcBuffer, ulSrcBufferSize, ppuchFontPackageBuffer, pulFontPackageBufferSize, pulBytesWritten, usFlag, usTTCIndex, usSubsetFormat, usSubsetLanguage, usSubsetPlatform, usSubsetEncoding, pusSubsetKeepList, usSubsetListCount, lpfnAllocate, lpfnReAllocate, lpfnFree, lpvReserved) {
    ...
    result := DllCall("FONTSUB.dll\CreateFontPackage", puchSrcBufferMarshal, puchSrcBuffer, "uint", ulSrcBufferSize, ppuchFontPackageBufferMarshal, ppuchFontPackageBuffer, pulFontPackageBufferSizeMarshal, pulFontPackageBufferSize, pulBytesWrittenMarshal, pulBytesWritten, "ushort", usFlag, "ushort", usTTCIndex, "ushort", usSubsetFormat, "ushort", usSubsetLanguage, CREATE_FONT_PACKAGE_SUBSET_PLATFORM, usSubsetPlatform, CREATE_FONT_PACKAGE_SUBSET_ENCODING, usSubsetEncoding, pusSubsetKeepListMarshal, pusSubsetKeepList, "ushort", usSubsetListCount, "ptr", lpfnAllocate, "ptr", lpfnReAllocate, "ptr", lpfnFree, lpvReservedMarshal, lpvReserved, UInt32)
    return result
}
 ...
 * @param {HDC} _hDC Device context handle.
 * @param {TTEMBED_FLAGS} ulFlags 
 * @param {EMBED_FONT_CHARSET} ulCharSet 
 * @param {Pointer<EMBEDDED_FONT_PRIV_STATUS>} pulPrivStatus 
...
export TTEmbedFont(_hDC, ulFlags, ulCharSet, pulPrivStatus, pulStatus, lpfnWriteToStream, lpvWriteStream, pusCharCodeSet, usCharCodeCount, usLanguage, pTTEmbedInfo) {
    ...
    result := DllCall("t2embed.dll\TTEmbedFont", HDC, _hDC, TTEMBED_FLAGS, ulFlags, EMBED_FONT_CHARSET, ulCharSet, pulPrivStatusMarshal, pulPrivStatus, pulStatusMarshal, pulStatus, "ptr", lpfnWriteToStream, lpvWriteStreamMarshal, lpvWriteStream, pusCharCodeSetMarshal, pusCharCodeSet, "ushort", usCharCodeCount, "ushort", usLanguage, TTEMBEDINFO.Ptr, pTTEmbedInfo, Int32)
    return result
}
...
export TTEmbedFontFromFileA(_hDC, szFontFileName, usTTCIndex, ulFlags, ulCharSet, pulPrivStatus, pulStatus, lpfnWriteToStream, lpvWriteStream, pusCharCodeSet, usCharCodeCount, usLanguage, pTTEmbedInfo) {
    ...
    result := DllCall("t2embed.dll\TTEmbedFontFromFileA", HDC, _hDC, "ptr", szFontFileName, "ushort", usTTCIndex, TTEMBED_FLAGS, ulFlags, EMBED_FONT_CHARSET, ulCharSet, pulPrivStatusMarshal, pulPrivStatus, pulStatusMarshal, pulStatus, "ptr", lpfnWriteToStream, lpvWriteStreamMarshal, lpvWriteStream, pusCharCodeSetMarshal, pusCharCodeSet, "ushort", usCharCodeCount, "ushort", usLanguage, TTEMBEDINFO.Ptr, pTTEmbedInfo, Int32)
    return result
}
 ...
 * </table>
 * @param {Pointer<EMBEDDED_FONT_PRIV_STATUS>} pulPrivStatus 
 * @param {FONT_LICENSE_PRIVS} ulPrivs 
 * @param {Pointer<TTLOAD_EMBEDDED_FONT_STATUS>} pulStatus 
 ...
 * @since windows5.0
 */
export TTLoadEmbeddedFont(phFontReference, ulFlags, pulPrivStatus, ulPrivs, pulStatus, lpfnReadFromStream, lpvReadStream, szWinFamilyName, szMacFamilyName, pTTLoadInfo) {
    ...
    result := DllCall("t2embed.dll\TTLoadEmbeddedFont", HANDLE.Ptr, phFontReference, "uint", ulFlags, pulPrivStatusMarshal, pulPrivStatus, FONT_LICENSE_PRIVS, ulPrivs, pulStatusMarshal, pulStatus, "ptr", lpfnReadFromStream, lpvReadStreamMarshal, lpvReadStream, "ptr", szWinFamilyName, "ptr", szMacFamilyName, TTLOADINFO.Ptr, pTTLoadInfo, Int32)
    return result
}
 ...
 * </tr>
 * </table>
 * @param {FONT_LICENSE_PRIVS} ulPrivs Flag indicating a further restriction of embedding privileges, imposed by the client. See <a href="https://docs.microsoft.com/windows/desktop/api/t2embapi/nf-t2embapi-ttloadembeddedfont">TTLoadEmbeddedFont</a> for additional information.
...
export TTDeleteEmbeddedFont(hFontReference, ulFlags, pulStatus) {
    ...
    result := DllCall("t2embed.dll\TTDeleteEmbeddedFont", HANDLE, hFontReference, "uint", ulFlags, pulStatusMarshal, pulStatus, Int32)
    return result
}
 ...
 * @param {HDC} _hDC Device context handle.
 * @param {Pointer<EMBEDDED_FONT_PRIV_STATUS>} pulEmbedType 
 * @returns {Integer} If successful, returns E_NONE.
 * 
 ...
 * @param {HDC} _hDC A device context handle.
...
export TTCharToUnicode(_hDC, pucCharCodes, ulCharCodeSize, pusShortCodes, ulShortCodeSize, ulFlags) {
    ...
    result := DllCall("t2embed.dll\TTCharToUnicode", HDC, _hDC, pucCharCodesMarshal, pucCharCodes, "uint", ulCharCodeSize, pusShortCodesMarshal, pusShortCodes, "uint", ulShortCodeSize, "uint", ulFlags, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export TTRunValidationTests(_hDC, pTestParam) {
    result := DllCall("t2embed.dll\TTRunValidationTests", HDC, _hDC, TTVALIDATIONTESTSPARAMS.Ptr, pTestParam, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export TTEnableEmbeddingForFacename(lpszFacename, bEnable) {
    lpszFacename := lpszFacename is String ? StrPtr(lpszFacename) : lpszFacename

    result := DllCall("t2embed.dll\TTEnableEmbeddingForFacename", "ptr", lpszFacename, BOOL, bEnable, Int32)
    return result
}
...
export TTEmbedFontEx(_hDC, ulFlags, ulCharSet, pulPrivStatus, pulStatus, lpfnWriteToStream, lpvWriteStream, pulCharCodeSet, usCharCodeCount, usLanguage, pTTEmbedInfo) {
    ...
    result := DllCall("t2embed.dll\TTEmbedFontEx", HDC, _hDC, TTEMBED_FLAGS, ulFlags, EMBED_FONT_CHARSET, ulCharSet, pulPrivStatusMarshal, pulPrivStatus, pulStatusMarshal, pulStatus, "ptr", lpfnWriteToStream, lpvWriteStreamMarshal, lpvWriteStream, pulCharCodeSetMarshal, pulCharCodeSet, "ushort", usCharCodeCount, "ushort", usLanguage, TTEMBEDINFO.Ptr, pTTEmbedInfo, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export TTRunValidationTestsEx(_hDC, pTestParam) {
    result := DllCall("t2embed.dll\TTRunValidationTestsEx", HDC, _hDC, TTVALIDATIONTESTSPARAMSEX.Ptr, pTestParam, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export TTGetNewFontName(phFontReference, wzWinFamilyName, cchMaxWinName, szMacFamilyName, cchMaxMacName) {
    wzWinFamilyName := wzWinFamilyName is String ? StrPtr(wzWinFamilyName) : wzWinFamilyName
    szMacFamilyName := szMacFamilyName is String ? StrPtr(szMacFamilyName) : szMacFamilyName

    result := DllCall("t2embed.dll\TTGetNewFontName", HANDLE.Ptr, phFontReference, "ptr", wzWinFamilyName, "int", cchMaxWinName, "ptr", szMacFamilyName, "int", cchMaxMacName, Int32)
    return result
}
 ...
 * @param {DRAWEDGE_FLAGS} edge The type of inner and outer edges to draw. This parameter must be a combination of one inner-border flag and one outer-border flag. The inner-border flags are as follows.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * </tr>
 * </table>
 * @param {DRAW_EDGE_FLAGS} grfFlags 
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export DrawEdge(_hdc, qrc, edge, grfFlags) {
    result := DllCall("USER32.dll\DrawEdge", HDC, _hdc, RECT.Ptr, qrc, DRAWEDGE_FLAGS, edge, DRAW_EDGE_FLAGS, grfFlags, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DrawFrameControl(_hdc, lprc, uType, uState) {
    result := DllCall("USER32.dll\DrawFrameControl", HDC, _hdc, RECT.Ptr, lprc, "uint", uType, "uint", uState, BOOL)
    return result
}

/**
 * The DrawCaption function draws a window caption.
 * @param {HWND} _hwnd A handle to a window that supplies text and an icon for the window caption.
 * @param {HDC} _hdc A handle to a device context. The function draws the window caption into this device context.
 ...
 * @param {DRAW_CAPTION_FLAGS} flags 
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export DrawCaption(_hwnd, _hdc, lprect, flags) {
    result := DllCall("USER32.dll\DrawCaption", HWND, _hwnd, HDC, _hdc, RECT.Ptr, lprect, DRAW_CAPTION_FLAGS, flags, BOOL)
    return result
}

/**
 * Animates the caption of a window to indicate the opening of an icon or the minimizing or maximizing of a window.
 * @param {HWND} _hwnd A handle to the window whose caption should be animated on the screen. The animation will be clipped to the parent of this window.
...
export DrawAnimatedRects(_hwnd, idAni, lprcFrom, lprcTo) {
    result := DllCall("USER32.dll\DrawAnimatedRects", HWND, _hwnd, "int", idAni, RECT.Ptr, lprcFrom, RECT.Ptr, lprcTo, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export DrawTextA(_hdc, lpchText, cchText, lprc, format) {
    lpchText := lpchText is String ? StrPtr(lpchText) : lpchText

    result := DllCall("USER32.dll\DrawTextA", HDC, _hdc, "ptr", lpchText, "int", cchText, RECT.Ptr, lprc, DRAW_TEXT_FORMAT, format, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export DrawTextW(_hdc, lpchText, cchText, lprc, format) {
    lpchText := lpchText is String ? StrPtr(lpchText) : lpchText

    result := DllCall("USER32.dll\DrawTextW", HDC, _hdc, "ptr", lpchText, "int", cchText, RECT.Ptr, lprc, DRAW_TEXT_FORMAT, format, Int32)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context in which to draw.
...
export DrawTextExA(_hdc, lpchText, cchText, lprc, format, lpdtp) {
    ...
    result := DllCall("USER32.dll\DrawTextExA", HDC, _hdc, "ptr", lpchText, "int", cchText, RECT.Ptr, lprc, DRAW_TEXT_FORMAT, format, DRAWTEXTPARAMS.Ptr, lpdtp, Int32)
    return result
}
...
export DrawTextExW(_hdc, lpchText, cchText, lprc, format, lpdtp) {
    ...
    result := DllCall("USER32.dll\DrawTextExW", HDC, _hdc, "ptr", lpchText, "int", cchText, RECT.Ptr, lprc, DRAW_TEXT_FORMAT, format, DRAWTEXTPARAMS.Ptr, lpdtp, Int32)
    return result
}
 ...
 * @param {HDC} _hDC A handle to the device context.
 * @param {HBRUSH} _hBrush A handle to the brush to be used for graying. If this parameter is <b>NULL</b>, the text is grayed with the same brush that was used to draw window text.
...
export GrayStringA(_hDC, _hBrush, lpOutputFunc, lpData, nCount, X, Y, nWidth, nHeight) {
    result := DllCall("USER32.dll\GrayStringA", HDC, _hDC, HBRUSH, _hBrush, "ptr", lpOutputFunc, LPARAM, lpData, "int", nCount, "int", X, "int", Y, "int", nWidth, "int", nHeight, BOOL)
    return result
}
...
export GrayStringW(_hDC, _hBrush, lpOutputFunc, lpData, nCount, X, Y, nWidth, nHeight) {
    result := DllCall("USER32.dll\GrayStringW", HDC, _hDC, HBRUSH, _hBrush, "ptr", lpOutputFunc, LPARAM, lpData, "int", nCount, "int", X, "int", Y, "int", nWidth, "int", nHeight, BOOL)
    return result
}
 ...
 * @param {HDC} _hdc A handle to the device context to draw in.
 ...
 * @param {Integer} _cy The height of the image, in device units. This parameter is required if the image type is DST_COMPLEX. Otherwise, it can be zero to calculate the height of the image.
 * @param {DRAWSTATE_FLAGS} uFlags The image type and state. This parameter can be one of the following type values.
 * 
 * <table>
 * <tr>
 * <th>Value (type)</th>
...
export DrawStateA(_hdc, hbrFore, qfnCallBack, lData, wData, x, y, cx, _cy, uFlags) {
    result := DllCall("USER32.dll\DrawStateA", HDC, _hdc, HBRUSH, hbrFore, "ptr", qfnCallBack, LPARAM, lData, WPARAM, wData, "int", x, "int", y, "int", cx, "int", _cy, DRAWSTATE_FLAGS, uFlags, BOOL)
    return result
}
...
export DrawStateW(_hdc, hbrFore, qfnCallBack, lData, wData, x, y, cx, _cy, uFlags) {
    result := DllCall("USER32.dll\DrawStateW", HDC, _hdc, HBRUSH, hbrFore, "ptr", qfnCallBack, LPARAM, lData, WPARAM, wData, "int", x, "int", y, "int", cx, "int", _cy, DRAWSTATE_FLAGS, uFlags, BOOL)
    return result
}
...
export TabbedTextOutA(_hdc, x, y, lpString, chCount, nTabPositions, lpnTabStopPositions, nTabOrigin) {
    ...
    result := DllCall("USER32.dll\TabbedTextOutA", HDC, _hdc, "int", x, "int", y, "ptr", lpString, "int", chCount, "int", nTabPositions, lpnTabStopPositionsMarshal, lpnTabStopPositions, "int", nTabOrigin, Int32)
    return result
}
...
export TabbedTextOutW(_hdc, x, y, lpString, chCount, nTabPositions, lpnTabStopPositions, nTabOrigin) {
    ...
    result := DllCall("USER32.dll\TabbedTextOutW", HDC, _hdc, "int", x, "int", y, "ptr", lpString, "int", chCount, "int", nTabPositions, lpnTabStopPositionsMarshal, lpnTabStopPositions, "int", nTabOrigin, Int32)
    return result
}
...
export GetTabbedTextExtentA(_hdc, lpString, chCount, nTabPositions, lpnTabStopPositions) {
    ...
    result := DllCall("USER32.dll\GetTabbedTextExtentA", HDC, _hdc, "ptr", lpString, "int", chCount, "int", nTabPositions, lpnTabStopPositionsMarshal, lpnTabStopPositions, UInt32)
    return result
}
...
export GetTabbedTextExtentW(_hdc, lpString, chCount, nTabPositions, lpnTabStopPositions) {
    ...
    result := DllCall("USER32.dll\GetTabbedTextExtentW", HDC, _hdc, "ptr", lpString, "int", chCount, "int", nTabPositions, lpnTabStopPositionsMarshal, lpnTabStopPositions, UInt32)
    return result
}
 ...
 * @param {HWND} _hWnd Handle to the window to be updated.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @since windows5.0
 */
export UpdateWindow(_hWnd) {
    result := DllCall("USER32.dll\UpdateWindow", HWND, _hWnd, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PaintDesktop(_hdc) {
    result := DllCall("USER32.dll\PaintDesktop", HDC, _hdc, BOOL)
    return result
}
 ...
 * @param {HDC} _hDC Handle to the device context from which a handle to the associated window is to be retrieved.
 ...
 * @since windows5.0
 */
export WindowFromDC(_hDC) {
    result := DllCall("USER32.dll\WindowFromDC", HDC, _hDC, HWND)
    return result
}
 ...
 * @param {HWND} _hWnd A handle to the window whose DC is to be retrieved. If this value is <b>NULL</b>, <b>GetDC</b> retrieves the DC for the entire screen.
 ...
 * @param {HWND} _hWnd A handle to the window whose DC is to be retrieved. If this value is <b>NULL</b>, <b>GetDCEx</b> retrieves the DC for the entire screen.
 ...
 * @param {HWND} _hWnd A handle to the window with a device context that is to be retrieved. If this value is <b>NULL</b>, <b>GetWindowDC</b> retrieves the device context for the entire screen.
 * 
 ...
 * @param {HWND} _hWnd A handle to the window whose DC is to be released.
 * @param {HDC} _hDC A handle to the DC to be released.
 ...
 * @param {HWND} _hWnd Handle to the window to be repainted.
 ...
 * @since windows5.0
 */
export BeginPaint(_hWnd, lpPaint) {
    result := DllCall("USER32.dll\BeginPaint", HWND, _hWnd, PAINTSTRUCT.Ptr, lpPaint, HDC)
    return result
}
 ...
 * @param {HWND} _hWnd Handle to the window that has been repainted.
 ...
 * @since windows5.0
 */
export EndPaint(_hWnd, lpPaint) {
    result := DllCall("USER32.dll\EndPaint", HWND, _hWnd, PAINTSTRUCT.Ptr, lpPaint, BOOL)
    return result
}
 ...
 * @param {HWND} _hWnd Handle to the window whose update region is to be retrieved.
 ...
 * @param {HWND} _hWnd Handle to the window with an update region that is to be retrieved.
 * @param {HRGN} _hRgn Handle to the region to receive the update region.
 ...
 * @returns {GDI_REGION_TYPE} The return value indicates the complexity of the resulting region; it can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
 ...
 * @since windows5.0
 */
export GetUpdateRgn(_hWnd, _hRgn, bErase) {
    result := DllCall("USER32.dll\GetUpdateRgn", HWND, _hWnd, HRGN, _hRgn, BOOL, bErase, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {HWND} _hWnd A handle to the window whose window region is to be set.
 * @param {HRGN} _hRgn A handle to a region. The function sets the window region of the window to this region.
 * 
 ...
 * @param {HWND} _hWnd Handle to the window whose window region is to be obtained.
 * @param {HRGN} _hRgn Handle to the region which will be modified to represent the window region.
 * @returns {GDI_REGION_TYPE} The return value specifies the type of the region that the function obtains. It can be one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export GetWindowRgn(_hWnd, _hRgn) {
    result := DllCall("USER32.dll\GetWindowRgn", HWND, _hWnd, HRGN, _hRgn, GDI_REGION_TYPE)
    return result
}
 ...
 * @since windows5.0
 */
export GetWindowRgnBox(_hWnd, lprc) {
    result := DllCall("USER32.dll\GetWindowRgnBox", HWND, _hWnd, RECT.Ptr, lprc, GDI_REGION_TYPE)
    return result
}
 ...
 * @param {HDC} _hDC Handle to the device context associated with the clipping region.
 * @param {HWND} _hWnd Handle to the window to update.
 ...
 * @since windows5.0
 */
export ExcludeUpdateRgn(_hDC, _hWnd) {
    result := DllCall("USER32.dll\ExcludeUpdateRgn", HDC, _hDC, HWND, _hWnd, Int32)
    return result
}
 ...
 * @param {HWND} _hWnd Handle to the window whose update region is to be modified. If this parameter is <b>NULL</b>, the system invalidates and redraws all windows and sends the <b>WM_ERASEBKGND</b> and <b>WM_NCPAINT</b> messages to the window procedure before the function returns.
 ...
 * @param {HWND} _hWnd A handle to the window with an update region that is to be modified.
 * @param {HRGN} _hRgn A handle to the region to be added to the update region. The region is assumed to have client coordinates. If this parameter is <b>NULL</b>, the entire client area is added to the update region.
 ...
 * @param {HWND} _hWnd Handle to the window whose update region is to be modified.
 * @param {HRGN} _hRgn Handle to a region that defines the area to be removed from the update region. If this parameter is <b>NULL</b>, the entire client area is removed.
 * @returns {BOOL} If the function succeeds, the return value is nonzero.
 * 
 * If the function fails, the return value is zero.
 ...
 * @param {HWND} _hWnd A handle to the window to be redrawn. If this parameter is <b>NULL</b>, the desktop window is updated.
 ...
 * @param {REDRAW_WINDOW_FLAGS} flags One or more redraw flags. This parameter can be used to invalidate or validate a window, control repainting, and control which windows are affected by <b>RedrawWindow</b>.
 * 
 ...
 * @param {HWND} _hWnd A handle to the window whose client area is used for the conversion.
 ...
 * @since windows5.0
 */
export ClientToScreen(_hWnd, lpPoint) {
    result := DllCall("USER32.dll\ClientToScreen", HWND, _hWnd, POINT.Ptr, lpPoint, BOOL)
    return result
}
 ...
 * @param {HWND} _hWnd A handle to the window whose client area will be used for the conversion.
 ...
 * @since windows5.0
 */
export ScreenToClient(_hWnd, lpPoint) {
    result := DllCall("USER32.dll\ScreenToClient", HWND, _hWnd, POINT.Ptr, lpPoint, BOOL)
    return result
}
...
export MapWindowPoints(hWndFrom, hWndTo, lpPoints, cPoints) {
    result := DllCall("USER32.dll\MapWindowPoints", HWND, hWndFrom, HWND, hWndTo, POINT.Ptr, lpPoints, "uint", cPoints, Int32)
    return result
}
 ...
 * @param {SYS_COLOR_INDEX} nIndex Type: <b>int</b>
 ...
 * @since windows5.0
 */
export GetSysColor(nIndex) {
    result := DllCall("USER32.dll\GetSysColor", SYS_COLOR_INDEX, nIndex, UInt32)
    return result
}
 ...
 * @param {SYS_COLOR_INDEX} nIndex A color index. This value corresponds to the color used to paint one of the window elements. See <a href="https://docs.microsoft.com/windows/desktop/api/winuser/nf-winuser-getsyscolor">GetSysColor</a> for system color index values.
 ...
 * @since windows5.0
 */
export GetSysColorBrush(nIndex) {
    result := DllCall("USER32.dll\GetSysColorBrush", SYS_COLOR_INDEX, nIndex, HBRUSH.Owned)
    return result
}
...
export SetSysColors(cElements, lpaElements, lpaRgbValues) {
    ...
    result := DllCall("USER32.dll\SetSysColors", "int", cElements, lpaElementsMarshal, lpaElements, lpaRgbValuesMarshal, lpaRgbValues, BOOL)
    if(!result && A_LastError) {
        throw OSError(A_LastError)
    }
 ...
 * @since windows5.0
 */
export DrawFocusRect(_hDC, lprc) {
    result := DllCall("USER32.dll\DrawFocusRect", HDC, _hDC, RECT.Ptr, lprc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export FillRect(_hDC, lprc, hbr) {
    result := DllCall("USER32.dll\FillRect", HDC, _hDC, RECT.Ptr, lprc, HBRUSH, hbr, Int32)
    return result
}
 ...
 * @param {HDC} _hDC A handle to the device context in which the border is drawn.
 ...
 * @since windows5.0
 */
export FrameRect(_hDC, lprc, hbr) {
    result := DllCall("USER32.dll\FrameRect", HDC, _hDC, RECT.Ptr, lprc, HBRUSH, hbr, Int32)
    return result
}
 ...
 * @since windows5.0
 */
export InvertRect(_hDC, lprc) {
    result := DllCall("USER32.dll\InvertRect", HDC, _hDC, RECT.Ptr, lprc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetRect(lprc, xLeft, yTop, xRight, yBottom) {
    result := DllCall("USER32.dll\SetRect", RECT.Ptr, lprc, "int", xLeft, "int", yTop, "int", xRight, "int", yBottom, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SetRectEmpty(lprc) {
    result := DllCall("USER32.dll\SetRectEmpty", RECT.Ptr, lprc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export CopyRect(lprcDst, lprcSrc) {
    result := DllCall("USER32.dll\CopyRect", RECT.Ptr, lprcDst, RECT.Ptr, lprcSrc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export InflateRect(lprc, dx, dy) {
    result := DllCall("USER32.dll\InflateRect", RECT.Ptr, lprc, "int", dx, "int", dy, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export IntersectRect(lprcDst, lprcSrc1, lprcSrc2) {
    result := DllCall("USER32.dll\IntersectRect", RECT.Ptr, lprcDst, RECT.Ptr, lprcSrc1, RECT.Ptr, lprcSrc2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export UnionRect(lprcDst, lprcSrc1, lprcSrc2) {
    result := DllCall("USER32.dll\UnionRect", RECT.Ptr, lprcDst, RECT.Ptr, lprcSrc1, RECT.Ptr, lprcSrc2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export SubtractRect(lprcDst, lprcSrc1, lprcSrc2) {
    result := DllCall("USER32.dll\SubtractRect", RECT.Ptr, lprcDst, RECT.Ptr, lprcSrc1, RECT.Ptr, lprcSrc2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export OffsetRect(lprc, dx, dy) {
    result := DllCall("USER32.dll\OffsetRect", RECT.Ptr, lprc, "int", dx, "int", dy, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export IsRectEmpty(lprc) {
    result := DllCall("USER32.dll\IsRectEmpty", RECT.Ptr, lprc, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export EqualRect(lprc1, lprc2) {
    result := DllCall("USER32.dll\EqualRect", RECT.Ptr, lprc1, RECT.Ptr, lprc2, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export PtInRect(lprc, pt) {
    result := DllCall("USER32.dll\PtInRect", RECT.Ptr, lprc, POINT, pt, BOOL)
    return result
}
 ...
 * @param {HINSTANCE} _hInstance A handle to the instance of the module whose executable file contains the bitmap to be loaded.
 ...
 * </tr>
 * </table>
 * @param {CDS_TYPE} dwFlags 
 * @returns {DISP_CHANGE} The <b>ChangeDisplaySettings</b> function returns one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * </table>
 * @param {CDS_TYPE} dwflags 
 * @param {Pointer<Void>} _lParam If <i>dwFlags</i> is <b>CDS_VIDEOPARAMETERS</b>, <i>lParam</i> is a pointer to a <a href="https://docs.microsoft.com/previous-versions/dd145196(v=vs.85)">VIDEOPARAMETERS</a> structure. Otherwise <i>lParam</i> must be <b>NULL</b>.
 * @returns {DISP_CHANGE} The <b>ChangeDisplaySettingsEx</b> function returns one of the following values.
 * 
 * <table>
 * <tr>
 * <th>Return code</th>
 ...
 * @since windows5.0
 */
export ChangeDisplaySettingsExA(lpszDeviceName, lpDevMode, dwflags, _lParam) {
 ...
 * @since windows5.0
 */
export ChangeDisplaySettingsExW(lpszDeviceName, lpDevMode, dwflags, _lParam) {
    static _hwnd := 0 ;Reserved parameters must always be NULL
 ...
 * @param {ENUM_DISPLAY_SETTINGS_MODE} iModeNum 
 ...
 * </ul>
 * @param {ENUM_DISPLAY_SETTINGS_FLAGS} dwFlags This parameter can be the following value.
 * 
 * <table>
 * <tr>
 * <th>Value</th>
...
export EnumDisplayDevicesA(lpDevice, iDevNum, lpDisplayDevice, dwFlags) {
    ...
    result := DllCall("USER32.dll\EnumDisplayDevicesA", "ptr", lpDevice, "uint", iDevNum, DISPLAY_DEVICEA.Ptr, lpDisplayDevice, "uint", dwFlags, BOOL)
    return result
}
...
export EnumDisplayDevicesW(lpDevice, iDevNum, lpDisplayDevice, dwFlags) {
    ...
    result := DllCall("USER32.dll\EnumDisplayDevicesW", "ptr", lpDevice, "uint", iDevNum, DISPLAY_DEVICEW.Ptr, lpDisplayDevice, "uint", dwFlags, BOOL)
    return result
}
 ...
 * @param {MONITOR_FROM_FLAGS} dwFlags Determines the function's return value if the point is not contained within any display monitor.
 ...
 * @since windows5.0
 */
export MonitorFromPoint(pt, dwFlags) {
    result := DllCall("USER32.dll\MonitorFromPoint", POINT, pt, MONITOR_FROM_FLAGS, dwFlags, HMONITOR)
    return result
}
 ...
 * @param {MONITOR_FROM_FLAGS} dwFlags Determines the function's return value if the rectangle does not intersect any display monitor.
 ...
 * @since windows5.0
 */
export MonitorFromRect(lprc, dwFlags) {
    result := DllCall("USER32.dll\MonitorFromRect", RECT.Ptr, lprc, MONITOR_FROM_FLAGS, dwFlags, HMONITOR)
    return result
}
 ...
 * @param {HWND} _hwnd A handle to the window of interest.
 * @param {MONITOR_FROM_FLAGS} dwFlags Determines the function's return value if the window does not intersect any display monitor.
 ...
 * @since windows5.0
 */
export MonitorFromWindow(_hwnd, dwFlags) {
    result := DllCall("USER32.dll\MonitorFromWindow", HWND, _hwnd, MONITOR_FROM_FLAGS, dwFlags, HMONITOR)
    return result
}
 ...
 * @param {HMONITOR} _hMonitor A handle to the display monitor of interest.
 ...
 * @since windows5.0
 */
export GetMonitorInfoA(_hMonitor, lpmi) {
    result := DllCall("USER32.dll\GetMonitorInfoA", HMONITOR, _hMonitor, MONITORINFO.Ptr, lpmi, BOOL)
    return result
}
 ...
 * @since windows5.0
 */
export GetMonitorInfoW(_hMonitor, lpmi) {
    result := DllCall("USER32.dll\GetMonitorInfoW", HMONITOR, _hMonitor, MONITORINFO.Ptr, lpmi, BOOL)
    return result
}
 ...
 * </tr>
 * </table>
 * @param {HDC} _hdc A handle to a display device context that defines the visible region of interest.
 * 
