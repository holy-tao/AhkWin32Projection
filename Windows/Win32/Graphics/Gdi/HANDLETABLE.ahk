 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wingdi/ns-wingdi-handletable
    ...
    objectHandle{
        get {
            if(!this.HasProp("__objectHandleProxyArray"))
                this.__objectHandleProxyArray := Win32FixedArray(this.ptr + 0, 1, HGDIOBJ, "")
