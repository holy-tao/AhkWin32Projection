 ...
 * </li>
 * </ol>
 * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nn-prnasnot-iprintasyncnotifychannel
...
class IPrintAsyncNotifyChannel extends IUnknown{
     ...
     * 
     * ```
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifychannel-sendnotification
     */
    SendNotification(pData) {
        result := ComCall(3, this, "ptr", pData, "int")
        if(result != 0) {
     ...
     * 
     * ```
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifychannel-closechannel
     */
    CloseChannel(pData) {
        result := ComCall(4, this, "ptr", pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
