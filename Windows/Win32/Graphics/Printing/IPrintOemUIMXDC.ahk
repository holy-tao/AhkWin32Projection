...
class IPrintOemUIMXDC extends IUnknown{
    ...
    AdjustImageableArea(hPrinter, cbDevMode, pDevMode, cbOEMDM, pOEMDM, prclImageableArea) {
        ...
        result := ComCall(3, this, "ptr", hPrinter, "uint", cbDevMode, "ptr", pDevMode, "uint", cbOEMDM, "ptr", pOEMDM, "ptr", prclImageableArea, "int")
        if(result != 0)
     ...
     * @param {Integer} cbOEMDM 
     * @param {Pointer<Void>} pOEMDM 
     * @param {Pointer<Int32>} pCompressionMode 
     * @returns {HRESULT} 
     */
    AdjustImageCompression(hPrinter, cbDevMode, pDevMode, cbOEMDM, pOEMDM, pCompressionMode) {
        hPrinter := hPrinter is Win32Handle ? NumGet(hPrinter, "ptr") : hPrinter

        result := ComCall(4, this, "ptr", hPrinter, "uint", cbDevMode, "ptr", pDevMode, "uint", cbOEMDM, "ptr", pOEMDM, "int*", pCompressionMode, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Integer} cbOEMDM 
     * @param {Pointer<Void>} pOEMDM 
     * @param {Pointer<Int32>} pDPI 
     * @returns {HRESULT} 
     */
    AdjustDPI(hPrinter, cbDevMode, pDevMode, cbOEMDM, pOEMDM, pDPI) {
        hPrinter := hPrinter is Win32Handle ? NumGet(hPrinter, "ptr") : hPrinter

        result := ComCall(5, this, "ptr", hPrinter, "uint", cbDevMode, "ptr", pDevMode, "uint", cbOEMDM, "ptr", pOEMDM, "int*", pDPI, "int")
        if(result != 0)
            throw OSError(result)
