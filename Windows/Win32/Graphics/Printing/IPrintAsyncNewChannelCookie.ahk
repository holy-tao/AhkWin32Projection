 ...
 */
export default struct IPrintAsyncNewChannelCookie extends IPrintAsyncCookie {
     ...
     * used for IPrintAsyncNewChannelCookie interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPrintAsyncNewChannelCookie.Vtbl()
        }
    ...
    Query(iid) {
        if (IPrintAsyncNewChannelCookie.IID.Equals(iid)) {
            return true
        }
