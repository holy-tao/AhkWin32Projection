...
class IPrintOemUI2 extends IPrintOemUI{
    ...
    QueryJobAttributes(hPrinter, pDevmode, dwLevel, lpAttributeInfo) {
        ...
        result := ComCall(17, this, "ptr", hPrinter, "ptr", pDevmode, "uint", dwLevel, lpAttributeInfoMarshal, lpAttributeInfo, "int")
        if(result != 0) {
    ...
    HideStandardUI(dwMode) {
        result := ComCall(18, this, "uint", dwMode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HDC} hdc_ A device context handle that is generated by a call of [**CreateDC**](/windows/desktop/api/wingdi/nf-wingdi-createdca). This is zero if *iEsc* is set to DOCUMENTEVENT\_CREATEDCPRE. For restrictions on printing from a 32-bit application on a 64-bit version of Windows, see Remarks.
     * @param {Integer} iEsc An escape code that identifies the event to be handled. This parameter can be one of the following integer constants.
     * 
     * 
     * 
     * | Constant                                                                                                                                                                                                                                                                                                                                               | Event                                                                                                                                                                                                                                                                                                           |
     ...
     * @param {Integer} cbIn The size, in bytes, of the buffer pointed to by *pvIn*.
     * @param {Pointer<Void>} pvIn A pointer to a buffer. What the buffer contains depends on the value of *iEsc*, as shown in the following table.
     * 
     * 
     * 
     ...
     * @param {Integer} cbOut 
     * @param {Pointer<Void>} pvOut A pointer to a buffer. The contents of the buffer depend on the value supplied for *iEsc*, as shown in the following table.
     * 
     * 
     * 
     ...
     * @returns {HRESULT} The function's return value is dependent on the escape supplied for *iEsc*. For some escape codes, the return value is not used (see below). If the function supplies a return value, it must be one of the following.
     * 
     * 
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/printdocs/documentevent
     */
    DocumentEvent(hPrinter, hdc_, iEsc, cbIn, pvIn, cbOut, pvOut, piResult) {
        hPrinter := hPrinter is Win32Handle ? NumGet(hPrinter, "ptr") : hPrinter
        ...
        result := ComCall(19, this, "ptr", hPrinter, "ptr", hdc_, "int", iEsc, "uint", cbIn, pvInMarshal, pvIn, "uint", cbOut, pvOutMarshal, pvOut, piResultMarshal, piResult, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
