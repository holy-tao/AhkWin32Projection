...
class IPrintOemUI2 extends IPrintOemUI{
     ...
     * @param {Pointer<Byte>} lpAttributeInfo 
     * @returns {HRESULT} 
     */
    QueryJobAttributes(hPrinter, pDevmode, dwLevel, lpAttributeInfo) {
        ...
        result := ComCall(17, this, "ptr", hPrinter, "ptr", pDevmode, "uint", dwLevel, "char*", lpAttributeInfo, "int")
        if(result != 0)
    ...
    DocumentEvent(hPrinter, hdc, iEsc, cbIn, pvIn, cbOut, pvOut, piResult) {
        ...
        result := ComCall(19, this, "ptr", hPrinter, "ptr", hdc, "int", iEsc, "uint", cbIn, "ptr", pvIn, "uint", cbOut, "ptr", pvOut, "int*", piResult, "int")
        if(result != 0)
            throw OSError(result)
