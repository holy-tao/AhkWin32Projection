 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nn-prnasnot-iprintasyncnotifydataobject
...
class IPrintAsyncNotifyDataObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifydataobject-acquiredata
     */
    AcquireData(ppNotificationData, pSize, ppSchema) {
        ...
        result := ComCall(3, this, ppNotificationDataMarshal, ppNotificationData, pSizeMarshal, pSize, ppSchemaMarshal, ppSchema, "int")
        if(result != 0) {
     ...
     * 
     * For more information about COM error codes, see <a href="https://docs.microsoft.com/windows/desktop/SetupApi/error-handling">Error Handling</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifydataobject-releasedata
     */
    ReleaseData() {
