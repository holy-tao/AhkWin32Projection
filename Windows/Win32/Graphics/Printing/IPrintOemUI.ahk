...
class IPrintOemUI extends IPrintOemCommon{
    ...
    DocumentPropertySheets(pPSUIInfo, lParam) {
        result := ComCall(7, this, "ptr", pPSUIInfo, "ptr", lParam, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DevicePropertySheets(pPSUIInfo, lParam) {
        result := ComCall(8, this, "ptr", pPSUIInfo, "ptr", lParam, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DevQueryPrintEx(poemuiobj, pDQPInfo, pPublicDM, pOEMDM) {
        result := ComCall(9, this, "ptr", poemuiobj, "ptr", pDQPInfo, "ptr", pPublicDM, "ptr", pOEMDM, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DeviceCapabilitiesA(poemuiobj, hPrinter, pDeviceName, wCapability, pOutput, pPublicDM, pOEMDM, dwOld, dwResult) {
        ...
        result := ComCall(10, this, "ptr", poemuiobj, "ptr", hPrinter, "ptr", pDeviceName, "ushort", wCapability, "ptr", pOutput, "ptr", pPublicDM, "ptr", pOEMDM, "uint", dwOld, "uint*", dwResult, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Byte>} pDriverUpgradeInfo 
     * @returns {HRESULT} 
     */
    UpgradePrinter(dwLevel, pDriverUpgradeInfo) {
        result := ComCall(11, this, "uint", dwLevel, "char*", pDriverUpgradeInfo, "int")
        if(result != 0)
            throw OSError(result)
    ...
    PrinterEvent(pPrinterName, iDriverEvent, dwFlags, lParam) {
        ...
        result := ComCall(12, this, "ptr", pPrinterName, "int", iDriverEvent, "uint", dwFlags, "ptr", lParam, "int")
        if(result != 0)
            throw OSError(result)
    ...
    DriverEvent(dwDriverEvent, dwLevel, pDriverInfo, lParam) {
        result := ComCall(13, this, "uint", dwDriverEvent, "uint", dwLevel, "char*", pDriverInfo, "ptr", lParam, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pcbProfileData 
     * @param {Pointer<UInt32>} pflProfileData 
     * @returns {HRESULT} 
     */
    QueryColorProfile(hPrinter, poemuiobj, pPublicDM, pOEMDM, ulQueryMode, pvProfileData, pcbProfileData, pflProfileData) {
        hPrinter := hPrinter is Win32Handle ? NumGet(hPrinter, "ptr") : hPrinter

        result := ComCall(14, this, "ptr", hPrinter, "ptr", poemuiobj, "ptr", pPublicDM, "ptr", pOEMDM, "uint", ulQueryMode, "ptr", pvProfileData, "uint*", pcbProfileData, "uint*", pflProfileData, "int")
        if(result != 0)
            throw OSError(result)
    ...
    FontInstallerDlgProc(hWnd, usMsg, wParam, lParam) {
        ...
        result := ComCall(15, this, "ptr", hWnd, "uint", usMsg, "ptr", wParam, "ptr", lParam, "int")
        if(result != 0)
            throw OSError(result)
