...
#Import ".\IPrintJob.ahk" { IPrintJob }
 ...
 */
export default struct IPrintJobCollection extends IDispatch {
    /**
     ...
     * used for IPrintJobCollection interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPrintJobCollection.Vtbl()
        }
     ...
     */
    GetAt(ulIndex) {
        result := ComCall(8, this, UInt32, ulIndex, "ptr*", &ppJob := 0, "HRESULT")
