...
class IPrintCoreHelperUni2 extends IPrintCoreHelperUni{
     ...
     * @param {Pointer<Byte>} ppCommandBytes 
     * @param {Pointer<UInt32>} pcbCommandSize 
     * @returns {HRESULT} 
     */
    GetNamedCommand(pDevmode, cbSize, pszCommandName, ppCommandBytes, pcbCommandSize) {
        ...
        result := ComCall(14, this, "ptr", pDevmode, "uint", cbSize, "ptr", pszCommandName, "char*", ppCommandBytes, "uint*", pcbCommandSize, "int")
        if(result != 0)
