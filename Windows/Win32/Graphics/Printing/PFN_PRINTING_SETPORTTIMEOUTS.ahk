 ...
 */
export default struct PFN_PRINTING_SETPORTTIMEOUTS {
    value : IntPtr

    __value {
        set {
            if (value is PFN_PRINTING_SETPORTTIMEOUTS) {
    ...
    /**
     * A PFN_PRINTING_SETPORTTIMEOUTS that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_PRINTING_SETPORTTIMEOUTS {
        /**
         * Creates a PFN_PRINTING_SETPORTTIMEOUTS pointer that invokes the given AHK function when called.
