 ...
 */
export PTQuerySchemaVersionSupport(pszPrinterName) {
 ...
 * @since windows5.1.2600
 */
export PTOpenProvider(pszPrinterName, dwVersion) {
    pszPrinterName := pszPrinterName is String ? StrPtr(pszPrinterName) : pszPrinterName
 ...
 * @since windows5.1.2600
 */
export PTCloseProvider(_hProvider) {
    result := DllCall("prntvpt.dll\PTCloseProvider", HPTPROVIDER, _hProvider, "HRESULT")
    return result
}
