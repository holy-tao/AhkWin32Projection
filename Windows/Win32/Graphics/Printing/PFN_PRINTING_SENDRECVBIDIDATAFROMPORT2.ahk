 ...
 * @version v4.0.30319
 */
class PFN_PRINTING_SENDRECVBIDIDATAFROMPORT2 extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4) {
        ...
        result := ComCall(3, this, "ptr", param0, "uint", param1, "ptr", param2, "ptr", param3, param4Marshal, param4, "uint")
        return result
    }
}
