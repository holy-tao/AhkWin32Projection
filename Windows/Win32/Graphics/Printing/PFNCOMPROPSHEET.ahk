 ...
 * @version v4.0.30319
 */
class PFNCOMPROPSHEET extends IUnknown {
     ...
     */
    Invoke(hComPropSheet, Function, lParam1, lParam2) {
        hComPropSheet := hComPropSheet is Win32Handle ? NumGet(hComPropSheet, "ptr") : hComPropSheet
        lParam1 := lParam1 is Win32Handle ? NumGet(lParam1, "ptr") : lParam1
        lParam2 := lParam2 is Win32Handle ? NumGet(lParam2, "ptr") : lParam2

        result := ComCall(3, this, "ptr", hComPropSheet, "uint", Function, "ptr", lParam1, "ptr", lParam2, "ptr")
        return result
    }
}
