 ...
 */
export default struct PFN_PRINTING_GETPRINTERDATAFROMPORT {
    value : IntPtr

    __value {
        set {
            if (value is PFN_PRINTING_GETPRINTERDATAFROMPORT) {
    ...
    /**
     * A PFN_PRINTING_GETPRINTERDATAFROMPORT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_PRINTING_GETPRINTERDATAFROMPORT {
        /**
         * Creates a PFN_PRINTING_GETPRINTERDATAFROMPORT pointer that invokes the given AHK function when called.
