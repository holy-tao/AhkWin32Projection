 ...
 */
export default struct PFN_PRINTING_STARTDOCPORT2 {
    value : IntPtr

    __value {
        set {
            if (value is PFN_PRINTING_STARTDOCPORT2) {
    ...
    /**
     * A PFN_PRINTING_STARTDOCPORT2 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_PRINTING_STARTDOCPORT2 {
        /**
         * Creates a PFN_PRINTING_STARTDOCPORT2 pointer that invokes the given AHK function when called.
