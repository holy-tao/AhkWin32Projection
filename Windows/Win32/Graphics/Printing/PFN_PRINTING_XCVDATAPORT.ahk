 ...
 */
export default struct PFN_PRINTING_XCVDATAPORT {
    value : IntPtr

    __value {
        set {
            if (value is PFN_PRINTING_XCVDATAPORT) {
    ...
    /**
     * A PFN_PRINTING_XCVDATAPORT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_PRINTING_XCVDATAPORT {
        /**
         * Creates a PFN_PRINTING_XCVDATAPORT pointer that invokes the given AHK function when called.
