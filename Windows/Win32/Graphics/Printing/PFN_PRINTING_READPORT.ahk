 ...
 */
export default struct PFN_PRINTING_READPORT {
    value : IntPtr

    __value {
        set {
            if (value is PFN_PRINTING_READPORT) {
    ...
    /**
     * A PFN_PRINTING_READPORT that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_PRINTING_READPORT {
        /**
         * Creates a PFN_PRINTING_READPORT pointer that invokes the given AHK function when called.
