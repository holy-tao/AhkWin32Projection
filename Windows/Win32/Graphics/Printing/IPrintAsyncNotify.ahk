...
class IPrintAsyncNotify extends IUnknown{
    ...
    CreatePrintAsyncNotifyChannel(param0, param1, param2, param3, param4) {
        result := ComCall(3, this, "uint", param0, "ptr", param1, "int", param2, "int", param3, "ptr", param4, "ptr*", &param5 := 0, "int")
        if(result != 0) {
    ...
    CreatePrintAsyncNotifyRegistration(param0, param1, param2, param3) {
        result := ComCall(4, this, "ptr", param0, "int", param1, "int", param2, "ptr", param3, "ptr*", &param4 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
