...
class IPrintAsyncNotify extends IUnknown{
     ...
     * @param {Pointer<IPrintAsyncNotifyCallback>} param4 
    ...
    CreatePrintAsyncNotifyChannel(param0, param1, param2, param3, param4, param5) {
        result := ComCall(3, this, "uint", param0, "ptr", param1, "int", param2, "int", param3, "ptr", param4, "ptr", param5, "int")
        if(result != 0)
     ...
     * @param {Integer} param2 
     * @param {Pointer<IPrintAsyncNotifyCallback>} param3 
     * @param {Pointer<IPrintAsyncNotifyRegistration>} param4 
     * @returns {HRESULT} 
     */
    CreatePrintAsyncNotifyRegistration(param0, param1, param2, param3, param4) {
        result := ComCall(4, this, "ptr", param0, "int", param1, "int", param2, "ptr", param3, "ptr", param4, "int")
        if(result != 0)
            throw OSError(result)
