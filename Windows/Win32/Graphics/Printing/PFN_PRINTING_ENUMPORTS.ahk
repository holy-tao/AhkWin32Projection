 ...
 * @version v4.0.30319
 */
class PFN_PRINTING_ENUMPORTS extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5) {
        ...
        result := ComCall(3, this, "ptr", param0, "uint", param1, param2Marshal, param2, "uint", param3, param4Marshal, param4, param5Marshal, param5, "int")
        return result
    }
}
