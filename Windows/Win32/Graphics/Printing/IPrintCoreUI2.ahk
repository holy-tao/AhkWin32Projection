...
class IPrintCoreUI2 extends IPrintOemDriverUI{
    ...
    GetOptions(poemuiobj, pmszFeaturesRequested, cbIn, pmszFeatureOptionBuf, cbSize, pcbNeeded) {
        ...
        result := ComCall(6, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pmszFeaturesRequested, "uint", cbIn, "ptr", pmszFeatureOptionBuf, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
    ...
    SetOptions(poemuiobj, dwFlags, pmszFeatureOptionBuf, cbIn, pdwResult) {
        result := ComCall(7, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pmszFeatureOptionBuf, "uint", cbIn, "uint*", pdwResult, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumConstrainedOptions(poemuiobj, pszFeatureKeyword, pmszConstrainedOptionList, cbSize, pcbNeeded) {
        ...
        result := ComCall(8, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszFeatureKeyword, "ptr", pmszConstrainedOptionList, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    WhyConstrained(poemuiobj, pszFeatureKeyword, pszOptionKeyword, pmszReasonList, cbSize, pcbNeeded) {
        ...
        result := ComCall(9, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszFeatureKeyword, "ptr", pszOptionKeyword, "ptr", pmszReasonList, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetGlobalAttribute(poemuiobj, pszAttribute, pdwDataType, pbData, cbSize, pcbNeeded) {
        ...
        result := ComCall(10, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszAttribute, "uint*", pdwDataType, "ptr", pbData, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetFeatureAttribute(poemuiobj, pszFeatureKeyword, pszAttribute, pdwDataType, pbData, cbSize, pcbNeeded) {
        ...
        result := ComCall(11, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszFeatureKeyword, "ptr", pszAttribute, "uint*", pdwDataType, "ptr", pbData, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetOptionAttribute(poemuiobj, pszFeatureKeyword, pszOptionKeyword, pszAttribute, pdwDataType, pbData, cbSize, pcbNeeded) {
        ...
        result := ComCall(12, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszFeatureKeyword, "ptr", pszOptionKeyword, "ptr", pszAttribute, "uint*", pdwDataType, "ptr", pbData, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumFeatures(poemuiobj, pmszFeatureList, cbSize, pcbNeeded) {
        ...
        result := ComCall(13, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pmszFeatureList, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumOptions(poemuiobj, pszFeatureKeyword, pmszOptionList, cbSize, pcbNeeded) {
        ...
        result := ComCall(14, this, "ptr", poemuiobj, "uint", dwFlags, "ptr", pszFeatureKeyword, "ptr", pmszOptionList, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
    ...
    QuerySimulationSupport(hPrinter, dwLevel, pCaps, cbSize, pcbNeeded) {
        ...
        result := ComCall(15, this, "ptr", hPrinter, "uint", dwLevel, "ptr", pCaps, "uint", cbSize, "uint*", pcbNeeded, "int")
        if(result != 0)
            throw OSError(result)
