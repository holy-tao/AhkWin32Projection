 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nn-prnasnot-iprintasyncnotifycallback
...
class IPrintAsyncNotifyCallback extends IUnknown{
     ...
     * 
     * ```
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifycallback-oneventnotify
     */
    OnEventNotify(pChannel, pData) {
        result := ComCall(3, this, "ptr", pChannel, "ptr", pData, "int")
        if(result != 0) {
     ...
     * 
     * ```
     * @see https://learn.microsoft.com/windows/win32/api//content/prnasnot/nf-prnasnot-iprintasyncnotifycallback-channelclosed
     */
    ChannelClosed(pChannel, pData) {
        result := ComCall(4, this, "ptr", pChannel, "ptr", pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
