 ...
 */
export default struct PFNGLVERTEXPOINTEREXTPROC {
    value : IntPtr

    __value {
        set {
            if (value is PFNGLVERTEXPOINTEREXTPROC) {
    ...
    /**
     * A PFNGLVERTEXPOINTEREXTPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFNGLVERTEXPOINTEREXTPROC {
        /**
         * Creates a PFNGLVERTEXPOINTEREXTPROC pointer that invokes the given AHK function when called.
