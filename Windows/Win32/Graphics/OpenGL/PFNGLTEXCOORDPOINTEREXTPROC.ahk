 ...
 */
export default struct PFNGLTEXCOORDPOINTEREXTPROC {
    value : IntPtr

    __value {
        set {
            if (value is PFNGLTEXCOORDPOINTEREXTPROC) {
    ...
    /**
     * A PFNGLTEXCOORDPOINTEREXTPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFNGLTEXCOORDPOINTEREXTPROC {
        /**
         * Creates a PFNGLTEXCOORDPOINTEREXTPROC pointer that invokes the given AHK function when called.
