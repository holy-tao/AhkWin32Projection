 ...
 */
export default struct PFNGLNORMALPOINTEREXTPROC {
    value : IntPtr

    __value {
        set {
            if (value is PFNGLNORMALPOINTEREXTPROC) {
    ...
    /**
     * A PFNGLNORMALPOINTEREXTPROC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFNGLNORMALPOINTEREXTPROC {
        /**
         * Creates a PFNGLNORMALPOINTEREXTPROC pointer that invokes the given AHK function when called.
