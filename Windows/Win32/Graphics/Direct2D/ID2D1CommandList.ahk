 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nn-d2d1_1-id2d1commandlist
...
class ID2D1CommandList extends ID2D1Image{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1commandlist-stream
     */
    Stream(sink) {
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1commandlist-close
     */
    Close() {
