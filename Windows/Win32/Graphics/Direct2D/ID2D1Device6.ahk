 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1device6
...
class ID2D1Device6 extends ID2D1Device5{
     ...
     * @returns {Pointer<ID2D1DeviceContext6>} Type: <b>ID2D1DeviceContext6**</b>
     * 
     * The created device context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device6-createdevicecontext
     */
    CreateDeviceContext(options) {
        result := ComCall(20, this, "int", options, "ptr*", &deviceContext6 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return deviceContext6
    }
}
