 ...
 */
class D2D1_POSTERIZE_PROP extends Win32Enum {
     ...
     * Native name: D2D1_POSTERIZE_PROP_RED_VALUE_COUNT
     * @type {Integer (Int32)}
     */
    static RED_VALUE_COUNT => 0
     ...
     *           For example, a value of 4 generates a table with 4 steps, [0.0, 0.33, 0.67, 1.0].  The allowed range for this property is 2 to 16.  The default value is 4.
     * Native name: D2D1_POSTERIZE_PROP_GREEN_VALUE_COUNT
     * @type {Integer (Int32)}
     */
    static GREEN_VALUE_COUNT => 1
     ...
     *           For example, a value of 4 generates a table with 4 steps, [0.0, 0.33, 0.67, 1.0].  The allowed range for this property is 2 to 16.  The default value is 4.
     * Native name: D2D1_POSTERIZE_PROP_BLUE_VALUE_COUNT
     * @type {Integer (Int32)}
     */
    static BLUE_VALUE_COUNT => 2
}
