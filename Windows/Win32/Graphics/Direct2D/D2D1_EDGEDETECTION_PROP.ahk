...
class D2D1_EDGEDETECTION_PROP extends Win32Enum {
     ...
     * Native name: D2D1_EDGEDETECTION_PROP_STRENGTH
     * @type {Integer (Int32)}
     */
    static STRENGTH => 0
     ...
     * Native name: D2D1_EDGEDETECTION_PROP_BLUR_RADIUS
     * @type {Integer (Int32)}
     */
    static BLUR_RADIUS => 1
     ...
     * Native name: D2D1_EDGEDETECTION_PROP_MODE
     * @type {Integer (Int32)}
     */
    static MODE => 2
     ...
     * Native name: D2D1_EDGEDETECTION_PROP_OVERLAY_EDGES
     * @type {Integer (Int32)}
     */
    static OVERLAY_EDGES => 3
     ...
     * Native name: D2D1_EDGEDETECTION_PROP_ALPHA_MODE
     * @type {Integer (Int32)}
     */
    static ALPHA_MODE => 4
}
