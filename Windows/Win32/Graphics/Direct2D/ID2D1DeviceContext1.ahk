 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nn-d2d1_2-id2d1devicecontext1
...
class ID2D1DeviceContext1 extends ID2D1DeviceContext{
     ...
     * @returns {Pointer<ID2D1GeometryRealization>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_2/nn-d2d1_2-id2d1geometryrealization">ID2D1GeometryRealization</a>**</b>
     * 
     * When this method returns, contains the address of a pointer to a new geometry realization object.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createfilledgeometryrealization
     */
    CreateFilledGeometryRealization(geometry, flatteningTolerance) {
        result := ComCall(92, this, "ptr", geometry, "float", flatteningTolerance, "ptr*", &geometryRealization := 0, "int")
        if(result != 0) {
     ...
     * 
     * When this method returns, contains the address of a pointer to a new geometry realization object.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1devicecontext1-createstrokedgeometryrealization
     */
    CreateStrokedGeometryRealization(geometry, flatteningTolerance, strokeWidth, strokeStyle) {
        result := ComCall(93, this, "ptr", geometry, "float", flatteningTolerance, "float", strokeWidth, "ptr", strokeStyle, "ptr*", &geometryRealization := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1devicecontext1-drawgeometryrealization
     */
