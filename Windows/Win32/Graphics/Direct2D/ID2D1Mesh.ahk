 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1mesh
...
class ID2D1Mesh extends ID2D1Resource{
     ...
     * @returns {Pointer<ID2D1TessellationSink>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1tessellationsink">ID2D1TessellationSink</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1mesh-open
     */
    Open() {
        result := ComCall(4, this, "ptr*", &tessellationSink := 0, "int")
        if(result != 0) {
