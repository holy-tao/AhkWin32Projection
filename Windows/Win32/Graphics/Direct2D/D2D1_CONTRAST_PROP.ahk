 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1effects_2/ne-d2d1effects_2-d2d1_contrast_prop
 * @namespace Windows.Win32.Graphics.Direct2D
 */
class D2D1_CONTRAST_PROP extends Win32Enum {
     ...
     * Native name: D2D1_CONTRAST_PROP_CONTRAST
     * @type {Integer (Int32)}
     */
    static CONTRAST => 0
     ...
     * Native name: D2D1_CONTRAST_PROP_CLAMP_INPUT
     * @type {Integer (Int32)}
     */
    static CLAMP_INPUT => 1
}
