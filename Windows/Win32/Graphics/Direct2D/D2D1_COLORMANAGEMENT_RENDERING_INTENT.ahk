...
class D2D1_COLORMANAGEMENT_RENDERING_INTENT extends Win32Enum {
     ...
     * Native name: D2D1_COLORMANAGEMENT_RENDERING_INTENT_PERCEPTUAL
     * @type {Integer (Int32)}
     */
    static PERCEPTUAL => 0
     ...
     * Native name: D2D1_COLORMANAGEMENT_RENDERING_INTENT_RELATIVE_COLORIMETRIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_COLORMANAGEMENT_RENDERING_INTENT_SATURATION
     * @type {Integer (Int32)}
     */
    static SATURATION => 2
     ...
     * Native name: D2D1_COLORMANAGEMENT_RENDERING_INTENT_ABSOLUTE_COLORIMETRIC
     * @type {Integer (Int32)}
     */
