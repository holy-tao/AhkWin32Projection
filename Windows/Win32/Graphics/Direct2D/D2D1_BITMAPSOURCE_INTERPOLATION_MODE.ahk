 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1effects/ne-d2d1effects-d2d1_bitmapsource_interpolation_mode
 * @namespace Windows.Win32.Graphics.Direct2D
 */
export default struct D2D1_BITMAPSOURCE_INTERPOLATION_MODE {
    value : Int32
