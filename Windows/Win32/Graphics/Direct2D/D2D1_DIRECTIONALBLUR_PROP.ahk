 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effects/ne-d2d1effects-d2d1_directionalblur_prop
 * @namespace Windows.Win32.Graphics.Direct2D
 * @version v4.0.30319
 */
class D2D1_DIRECTIONALBLUR_PROP extends Win32Enum{
