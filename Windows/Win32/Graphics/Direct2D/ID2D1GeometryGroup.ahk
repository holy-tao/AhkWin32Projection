 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1geometrygroup
...
class ID2D1GeometryGroup extends ID2D1Geometry{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1geometrygroup-getfillmode
     */
    GetFillMode() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1geometrygroup-getsourcegeometrycount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1geometrygroup-getsourcegeometries
     */
