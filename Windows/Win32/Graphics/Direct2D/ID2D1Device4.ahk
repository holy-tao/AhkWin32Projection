 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1device4
...
class ID2D1Device4 extends ID2D1Device3{
     ...
     * @returns {Pointer<ID2D1DeviceContext4>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1devicecontext4">ID2D1DeviceContext4</a>**</b>
     * 
     * When this method returns, contains a pointer to the new device context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device4-createdevicecontext
     */
    CreateDeviceContext(options) {
        result := ComCall(16, this, "int", options, "ptr*", &deviceContext4 := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device4-setmaximumcolorglyphcachememory
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device4-getmaximumcolorglyphcachememory
     */
