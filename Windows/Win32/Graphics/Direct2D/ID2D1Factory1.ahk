 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nn-d2d1_1-id2d1factory1
...
class ID2D1Factory1 extends ID2D1Factory{
     ...
     * @returns {Pointer<ID2D1Device>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a>**</b>
     * 
     * The requested <a href="https://docs.microsoft.com/windows/desktop/api/d2d1_1/nn-d2d1_1-id2d1device">ID2D1Device</a> object.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-createdevice
     */
    CreateDevice(dxgiDevice) {
        result := ComCall(17, this, "ptr", dxgiDevice, "ptr*", &d2dDevice := 0, "int")
        if(result != 0) {
     ...
     * @returns {Pointer<ID2D1StrokeStyle1>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory1-createstrokestyle-overload
     */
    CreateStrokeStyle(strokeStyleProperties, dashes, dashesCount) {
        dashesMarshal := dashes is VarRef ? "float*" : "ptr"

        result := ComCall(18, this, "ptr", strokeStyleProperties, dashesMarshal, dashes, "uint", dashesCount, "ptr*", &strokeStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1PathGeometry1>} Type: <b>const **</b>
     * 
     * When this method returns, contains the address of a pointer to the newly created path geometry.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-createpathgeometry
     */
    CreatePathGeometry() {
        result := ComCall(19, this, "ptr*", &pathGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1DrawingStateBlock1>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory1-createdrawingstateblock-overload
     */
    CreateDrawingStateBlock(drawingStateDescription, textRenderingParams) {
        result := ComCall(20, this, "ptr", drawingStateDescription, "ptr", textRenderingParams, "ptr*", &drawingStateBlock := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1GdiMetafile>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-creategdimetafile
     */
    CreateGdiMetafile(metafileStream) {
        result := ComCall(21, this, "ptr", metafileStream, "ptr*", &metafile_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstream
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-registereffectfromstring
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-unregistereffect
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-getregisteredeffects
     */
    GetRegisteredEffects(effects, effectsCount, effectsReturned, effectsRegistered) {
        ...
        result := ComCall(25, this, "ptr", effects, "uint", effectsCount, effectsReturnedMarshal, effectsReturned, effectsRegisteredMarshal, effectsRegistered, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1factory1-geteffectproperties
     */
    GetEffectProperties(effectId) {
        result := ComCall(26, this, "ptr", effectId, "ptr*", &properties_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
