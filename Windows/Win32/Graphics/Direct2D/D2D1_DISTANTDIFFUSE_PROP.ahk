...
class D2D1_DISTANTDIFFUSE_PROP extends Win32Enum {
     ...
     * Native name: D2D1_DISTANTDIFFUSE_PROP_AZIMUTH
     * @type {Integer (Int32)}
     */
    static AZIMUTH => 0
     ...
     * 
     * The default value is 0.0f.
     * Native name: D2D1_DISTANTDIFFUSE_PROP_ELEVATION
     * @type {Integer (Int32)}
     */
    static ELEVATION => 1
     ...
     * Native name: D2D1_DISTANTDIFFUSE_PROP_DIFFUSE_CONSTANT
     * @type {Integer (Int32)}
     */
    static DIFFUSE_CONSTANT => 2
     ...
     * 
     * The default value is 1.0f.
     * Native name: D2D1_DISTANTDIFFUSE_PROP_SURFACE_SCALE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_DISTANTDIFFUSE_PROP_COLOR
     * @type {Integer (Int32)}
     */
    static COLOR => 4
     ...
     * Native name: D2D1_DISTANTDIFFUSE_PROP_KERNEL_UNIT_LENGTH
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_DISTANTDIFFUSE_PROP_SCALE_MODE
     * @type {Integer (Int32)}
     */
    static SCALE_MODE => 6
}
