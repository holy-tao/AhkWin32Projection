...
class ID2D1Device extends ID2D1Resource{
    ...
    CreateDeviceContext(options, deviceContext) {
        result := ComCall(4, this, "int", options, "ptr*", deviceContext, "HRESULT")
        return result
    }
    ...
    CreatePrintControl(wicFactory, documentTarget, printControlProperties, printControl) {
        result := ComCall(5, this, "ptr", wicFactory, "ptr", documentTarget, "ptr", printControlProperties, "ptr*", printControl, "HRESULT")
        return result
    }
