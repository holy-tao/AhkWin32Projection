 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1lineargradientbrush
...
class ID2D1LinearGradientBrush extends ID2D1Brush{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1lineargradientbrush-setstartpoint
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1lineargradientbrush-setendpoint
     */
     ...
     * 
     * The starting two-dimensional coordinates of the linear gradient, in the brush's coordinate space.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1lineargradientbrush-getstartpoint
     */
    GetStartPoint() {
     ...
     * 
     * The ending two-dimensional coordinates of the linear gradient, in the brush's coordinate space.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1lineargradientbrush-getendpoint
     */
    GetEndPoint() {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1lineargradientbrush-getgradientstopcollection
     */
