 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1gdiinteroprendertarget
...
class ID2D1GdiInteropRenderTarget extends IUnknown{
     ...
     * @param {Integer} mode_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/ne-d2d1-d2d1_dc_initialize_mode">D2D1_DC_INITIALIZE_MODE</a></b>
     * 
     * A value that specifies whether the device context should be cleared.
     * @returns {HDC} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gdiinteroprendertarget-getdc
     */
    GetDC(mode_) {
        hdc_ := HDC()
        result := ComCall(3, this, "int", mode_, "ptr", hdc_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gdiinteroprendertarget-releasedc
     */
    ReleaseDC(update) {
        result := ComCall(4, this, "ptr", update, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
