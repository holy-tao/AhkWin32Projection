 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1device2
...
class ID2D1Device2 extends ID2D1Device1{
     ...
     * @returns {Pointer<ID2D1DeviceContext2>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1devicecontext2">ID2D1DeviceContext2</a>**</b>
     * 
     * When this method returns, contains the address of a pointer to the new device context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device2-createdevicecontext
     */
    CreateDeviceContext(options) {
        result := ComCall(12, this, "int", options, "ptr*", &deviceContext2 := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device2-flushdevicecontexts
     */
    FlushDeviceContexts(bitmap_) {
        ComCall(13, this, "ptr", bitmap_)
    }

    /**
     * Returns the DXGI device associated with this Direct2D device.
     * @returns {Pointer<IDXGIDevice>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgidevice">IDXGIDevice</a>**</b>
     * 
     * The DXGI device associated with this Direct2D device.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device2-getdxgidevice
     */
    GetDxgiDevice() {
        result := ComCall(14, this, "ptr*", &dxgiDevice := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
