 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nn-d2d1effectauthor-id2d1analysistransform
...
class ID2D1AnalysisTransform extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1analysistransform-processanalysisresults
     */
    ProcessAnalysisResults(analysisData, analysisDataCount) {
        analysisDataMarshal := analysisData is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, analysisDataMarshal, analysisData, "uint", analysisDataCount, "int")
        if(result != 0) {
