...
class D2D1_HIGHLIGHTSANDSHADOWS_PROP extends Win32Enum {
     ...
     * Native name: D2D1_HIGHLIGHTSANDSHADOWS_PROP_HIGHLIGHTS
     * @type {Integer (Int32)}
     */
    static HIGHLIGHTS => 0
     ...
     * Native name: D2D1_HIGHLIGHTSANDSHADOWS_PROP_SHADOWS
     * @type {Integer (Int32)}
     */
    static SHADOWS => 1
     ...
     * Native name: D2D1_HIGHLIGHTSANDSHADOWS_PROP_CLARITY
     * @type {Integer (Int32)}
     */
    static CLARITY => 2
     ...
     * Native name: D2D1_HIGHLIGHTSANDSHADOWS_PROP_INPUT_GAMMA
     * @type {Integer (Int32)}
     */
    static INPUT_GAMMA => 3
     ...
     * Native name: D2D1_HIGHLIGHTSANDSHADOWS_PROP_MASK_BLUR_RADIUS
     * @type {Integer (Int32)}
     */
    static MASK_BLUR_RADIUS => 4
}
