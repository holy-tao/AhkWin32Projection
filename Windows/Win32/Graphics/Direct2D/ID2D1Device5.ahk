 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1device5
...
class ID2D1Device5 extends ID2D1Device4{
     ...
     * @returns {Pointer<ID2D1DeviceContext5>} Type: <b>ID2D1DeviceContext5**</b>
     * 
     * The created device context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device5-createdevicecontext
     */
    CreateDeviceContext(options) {
        result := ComCall(19, this, "int", options, "ptr*", &deviceContext5 := 0, "int")
        if(result != 0) {
