 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nn-d2d1svg-id2d1svgpathdata
...
class ID2D1SvgPathData extends ID2D1SvgAttribute{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-removesegmentdataatend
     */
     ...
     * 
     * This method returns an HRESULT success or error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-updatesegmentdata
     */
    UpdateSegmentData(data, dataCount, startIndex) {
        dataMarshal := data is VarRef ? "float*" : "ptr"

        result := ComCall(7, this, dataMarshal, data, "uint", dataCount, "uint", startIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-getsegmentdata
     */
    GetSegmentData(dataCount, startIndex) {
        result := ComCall(8, this, "float*", &data := 0, "uint", dataCount, "uint", startIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-getsegmentdatacount
     */
    GetSegmentDataCount() {
     ...
     * 
     * This method returns an HRESULT success or error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-removecommandsatend
     */
     ...
     * 
     * This method returns an HRESULT success or error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-updatecommands
     */
    UpdateCommands(commands, commandsCount, startIndex) {
        commandsMarshal := commands is VarRef ? "int*" : "ptr"

        result := ComCall(11, this, commandsMarshal, commands, "uint", commandsCount, "uint", startIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-getcommands
     */
    GetCommands(commandsCount, startIndex) {
        result := ComCall(12, this, "int*", &commands := 0, "uint", commandsCount, "uint", startIndex, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-getcommandscount
     */
    GetCommandsCount() {
     ...
     * @param {Integer} fillMode_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_fill_mode">D2D1_FILL_MODE</a></b>
     * 
     * Fill mode for the path geometry object.
     * @returns {Pointer<ID2D1PathGeometry1>} Type: <b>ID2D1PathGeometry1**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1svg/nf-d2d1svg-id2d1svgpathdata-createpathgeometry
     */
    CreatePathGeometry(fillMode_) {
        result := ComCall(14, this, "int", fillMode_, "ptr*", &pathGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
