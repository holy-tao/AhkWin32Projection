 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1effects_2/ne-d2d1effects_2-d2d1_chromakey_prop
 * @namespace Windows.Win32.Graphics.Direct2D
 */
class D2D1_CHROMAKEY_PROP extends Win32Enum {
     ...
     * Native name: D2D1_CHROMAKEY_PROP_COLOR
     * @type {Integer (Int32)}
     */
    static COLOR => 0
     ...
     * Native name: D2D1_CHROMAKEY_PROP_TOLERANCE
     * @type {Integer (Int32)}
     */
    static TOLERANCE => 1
     ...
     * Native name: D2D1_CHROMAKEY_PROP_INVERT_ALPHA
     * @type {Integer (Int32)}
     */
    static INVERT_ALPHA => 2
     ...
     * Native name: D2D1_CHROMAKEY_PROP_FEATHER
     * @type {Integer (Int32)}
     */
    static FEATHER => 3
}
