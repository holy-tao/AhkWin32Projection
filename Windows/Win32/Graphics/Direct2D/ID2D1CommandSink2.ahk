 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1commandsink2
...
class ID2D1CommandSink2 extends ID2D1CommandSink1{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1commandsink2-drawink
     */
    DrawInk(ink_, brush, inkStyle) {
        result := ComCall(29, this, "ptr", ink_, "ptr", brush, "ptr", inkStyle, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} This method does not return a value.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1commandsink2-drawgradientmesh
     */
     ...
     * @returns {HRESULT} This method does not return a value.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1commandsink2-drawgdimetafile
     */
