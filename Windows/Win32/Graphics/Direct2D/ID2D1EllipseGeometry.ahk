 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1ellipsegeometry
...
class ID2D1EllipseGeometry extends ID2D1Geometry{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1ellipsegeometry-getellipse
     */
    GetEllipse(ellipse) {
