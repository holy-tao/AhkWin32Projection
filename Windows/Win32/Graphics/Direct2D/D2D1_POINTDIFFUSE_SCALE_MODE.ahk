 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effects/ne-d2d1effects-d2d1_pointdiffuse_scale_mode
...
class D2D1_POINTDIFFUSE_SCALE_MODE extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_POINTDIFFUSE_SCALE_MODE_CUBIC => 2
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_POINTDIFFUSE_SCALE_MODE_MULTI_SAMPLE_LINEAR => 3

    /**
     * Uses anisotropic filtering to sample a pattern according to the transformed shape of the bitmap.
     * @type {Integer (Int32)}
     */
    static D2D1_POINTDIFFUSE_SCALE_MODE_ANISOTROPIC => 4
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_POINTDIFFUSE_SCALE_MODE_HIGH_QUALITY_CUBIC => 5
}
