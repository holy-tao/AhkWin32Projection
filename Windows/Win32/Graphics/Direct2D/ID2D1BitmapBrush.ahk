 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1bitmapbrush
...
class ID2D1BitmapBrush extends ID2D1Brush{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-setextendmodex
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-setextendmodey
     */
     ...
     * @param {Integer} interpolationMode_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/ne-d2d1-d2d1_bitmap_interpolation_mode">D2D1_BITMAP_INTERPOLATION_MODE</a></b>
     * 
     * The interpolation mode used when the brush bitmap is scaled or rotated.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-setinterpolationmode
     */
    SetInterpolationMode(interpolationMode_) {
        ComCall(10, this, "int", interpolationMode_)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-setbitmap
     */
    SetBitmap(bitmap_) {
        ComCall(11, this, "ptr", bitmap_)
    }
     ...
     * 
     * A value that specifies how the brush horizontally tiles those areas that extend past its bitmap.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-getextendmodex
     */
    GetExtendModeX() {
     ...
     * 
     * A value that specifies how the brush vertically tiles those areas that extend past its bitmap.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-getextendmodey
     */
    GetExtendModeY() {
     ...
     * @returns {Integer} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/ne-d2d1-d2d1_bitmap_interpolation_mode">D2D1_BITMAP_INTERPOLATION_MODE</a></b>
     * 
     * The interpolation method used when the brush bitmap is scaled or rotated.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-getinterpolationmode
     */
     ...
     * @param {Pointer<ID2D1Bitmap>} bitmap_ Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1bitmap">ID2D1Bitmap</a>**</b>
     * 
     * When this method returns, contains the address to a pointer to the bitmap with which this brush paints.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmapbrush-getbitmap
     */
    GetBitmap(bitmap_) {
        ComCall(15, this, "ptr*", bitmap_)
    }
}
