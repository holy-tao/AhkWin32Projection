...
class D2D1_YCBCR_PROP extends Win32Enum {
     ...
     * Native name: D2D1_YCBCR_PROP_CHROMA_SUBSAMPLING
     * @type {Integer (Int32)}
     */
    static CHROMA_SUBSAMPLING => 0
     ...
     * Native name: D2D1_YCBCR_PROP_TRANSFORM_MATRIX
     * @type {Integer (Int32)}
     */
    static TRANSFORM_MATRIX => 1
     ...
     * Native name: D2D1_YCBCR_PROP_INTERPOLATION_MODE
     * @type {Integer (Int32)}
     */
