 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1strokestyle
...
class ID2D1StrokeStyle extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getstartcap
     */
    GetStartCap() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getendcap
     */
    GetEndCap() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getdashcap
     */
    GetDashCap() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getmiterlimit
     */
    GetMiterLimit() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getlinejoin
     */
    GetLineJoin() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getdashoffset
     */
    GetDashOffset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getdashstyle
     */
    GetDashStyle() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getdashescount
     */
    GetDashesCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1strokestyle-getdashes
     */
