 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nn-d2d1_2-id2d1device1
...
class ID2D1Device1 extends ID2D1Device{
     ...
     * @returns {Integer} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_2/ne-d2d1_2-d2d1_rendering_priority">D2D1_RENDERING_PRIORITY</a></b>
     * 
     * The current rendering priority of the device.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1device1-getrenderingpriority
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1device1-setrenderingpriority
     */
     ...
     * @returns {Pointer<ID2D1DeviceContext1>} 
     */
    CreateDeviceContext(options) {
        result := ComCall(11, this, "int", options, "ptr*", &deviceContext1 := 0, "int")
        if(result != 0) {
