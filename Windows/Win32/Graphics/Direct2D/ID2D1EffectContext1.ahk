 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor_1/nn-d2d1effectauthor_1-id2d1effectcontext1
...
class ID2D1EffectContext1 extends ID2D1EffectContext{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor_1/nf-d2d1effectauthor_1-id2d1effectcontext1-createlookuptable3d
     */
    CreateLookupTable3D(precision, extents, data, dataCount, strides) {
        ...
        result := ComCall(24, this, "int", precision, extentsMarshal, extents, dataMarshal, data, "uint", dataCount, stridesMarshal, strides, "ptr*", &lookupTable := 0, "int")
        if(result != 0) {
