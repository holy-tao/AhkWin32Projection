 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1drawingstateblock
...
class ID2D1DrawingStateBlock extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1drawingstateblock-getdescription
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1drawingstateblock-setdescription
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1drawingstateblock-settextrenderingparams
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1drawingstateblock-gettextrenderingparams
     */
