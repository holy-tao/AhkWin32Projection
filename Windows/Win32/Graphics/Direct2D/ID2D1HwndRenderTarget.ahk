 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1hwndrendertarget
...
class ID2D1HwndRenderTarget extends ID2D1RenderTarget{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1hwndrendertarget-checkwindowstate
     */
    CheckWindowState() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1hwndrendertarget-resize
     */
    Resize(pixelSize) {
        result := ComCall(58, this, "ptr", pixelSize, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1hwndrendertarget-gethwnd
     */
    GetHwnd() {
