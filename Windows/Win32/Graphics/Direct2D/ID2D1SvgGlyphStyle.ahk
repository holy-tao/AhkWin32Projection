 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1svgglyphstyle
...
class ID2D1SvgGlyphStyle extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1svgglyphstyle-setfill
     */
    SetFill(brush) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1svgglyphstyle-getfill
     */
    GetFill(brush) {
     ...
     * 
     * This method returns an HRESULT success or error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1svgglyphstyle-setstroke
     */
    SetStroke(brush, strokeWidth, dashes, dashesCount, dashOffset) {
        dashesMarshal := dashes is VarRef ? "float*" : "ptr"

        result := ComCall(6, this, "ptr", brush, "float", strokeWidth, dashesMarshal, dashes, "uint", dashesCount, "float", dashOffset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Returns the number of dashes in the dash array.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1svgglyphstyle-getstrokedashescount
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1svgglyphstyle-getstroke
     */
