 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1rectanglegeometry
...
class ID2D1RectangleGeometry extends ID2D1Geometry{
     ...
     * @param {Pointer<D2D_RECT_F>} rect_ Type: <b><a href="https://docs.microsoft.com/windows/win32/Direct2D/d2d1-rect-f">D2D1_RECT_F</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1rectanglegeometry-getrect
     */
    GetRect(rect_) {
        ComCall(17, this, "ptr", rect_)
    }
}
