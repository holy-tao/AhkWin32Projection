 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nn-d2d1effectauthor-id2d1drawtransform
...
class ID2D1DrawTransform extends ID2D1Transform{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1drawtransform-setdrawinfo
     */
