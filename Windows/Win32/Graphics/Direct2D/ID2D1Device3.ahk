 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1device3
...
class ID2D1Device3 extends ID2D1Device2{
     ...
     * @returns {Pointer<ID2D1DeviceContext3>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1devicecontext3">ID2D1DeviceContext3</a>**</b>
     * 
     * When this method returns, contains a pointer to the new device context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1device3-createdevicecontext
     */
    CreateDeviceContext(options) {
        result := ComCall(15, this, "int", options, "ptr*", &deviceContext3 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return deviceContext3
    }
}
