 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1resource
...
class ID2D1Resource extends IUnknown{
     ...
     * @param {Pointer<Pointer<ID2D1Factory>>} factory Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1factory">ID2D1Factory</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1resource-getfactory
     */
    GetFactory(factory) {
