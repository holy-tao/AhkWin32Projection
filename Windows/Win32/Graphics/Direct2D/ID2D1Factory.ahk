...
class ID2D1Factory extends IUnknown{
    ...
    CreateRectangleGeometry(rectangle, rectangleGeometry) {
        result := ComCall(5, this, "ptr", rectangle, "ptr", rectangleGeometry, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateRoundedRectangleGeometry(roundedRectangle, roundedRectangleGeometry) {
        result := ComCall(6, this, "ptr", roundedRectangle, "ptr", roundedRectangleGeometry, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateEllipseGeometry(ellipse, ellipseGeometry) {
        result := ComCall(7, this, "ptr", ellipse, "ptr", ellipseGeometry, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateGeometryGroup(fillMode, geometries, geometriesCount, geometryGroup) {
        result := ComCall(8, this, "int", fillMode, "ptr", geometries, "uint", geometriesCount, "ptr", geometryGroup, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateTransformedGeometry(sourceGeometry, transform, transformedGeometry) {
        result := ComCall(9, this, "ptr", sourceGeometry, "ptr", transform, "ptr", transformedGeometry, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreatePathGeometry(pathGeometry) {
        result := ComCall(10, this, "ptr", pathGeometry, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateStrokeStyle(strokeStyleProperties, dashes, dashesCount, strokeStyle) {
        result := ComCall(11, this, "ptr", strokeStyleProperties, "float*", dashes, "uint", dashesCount, "ptr", strokeStyle, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDrawingStateBlock(drawingStateDescription, textRenderingParams, drawingStateBlock) {
        result := ComCall(12, this, "ptr", drawingStateDescription, "ptr", textRenderingParams, "ptr", drawingStateBlock, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IWICBitmap>} target 
    ...
    CreateWicBitmapRenderTarget(target, renderTargetProperties, renderTarget) {
        result := ComCall(13, this, "ptr", target, "ptr", renderTargetProperties, "ptr", renderTarget, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateHwndRenderTarget(renderTargetProperties, hwndRenderTargetProperties, hwndRenderTarget) {
        result := ComCall(14, this, "ptr", renderTargetProperties, "ptr", hwndRenderTargetProperties, "ptr", hwndRenderTarget, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDxgiSurfaceRenderTarget(dxgiSurface, renderTargetProperties, renderTarget) {
        result := ComCall(15, this, "ptr", dxgiSurface, "ptr", renderTargetProperties, "ptr", renderTarget, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateDCRenderTarget(renderTargetProperties, dcRenderTarget) {
        result := ComCall(16, this, "ptr", renderTargetProperties, "ptr", dcRenderTarget, "int")
        if(result != 0)
            throw OSError(result)
