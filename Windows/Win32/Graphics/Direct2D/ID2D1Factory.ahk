 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1factory
...
class ID2D1Factory extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-reloadsystemmetrics
     */
    ReloadSystemMetrics() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-getdesktopdpi
     ...
     * @returns {Pointer<ID2D1RectangleGeometry>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createrectanglegeometry
     */
    CreateRectangleGeometry(rectangle) {
        result := ComCall(5, this, "ptr", rectangle, "ptr*", &rectangleGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1RoundedRectangleGeometry>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createroundedrectanglegeometry
     */
    CreateRoundedRectangleGeometry(roundedRectangle) {
        result := ComCall(6, this, "ptr", roundedRectangle, "ptr*", &roundedRectangleGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1EllipseGeometry>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createellipsegeometry
     */
    CreateEllipseGeometry(ellipse) {
        result := ComCall(7, this, "ptr", ellipse, "ptr*", &ellipseGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1GeometryGroup>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1geometrygroup">ID2D1GeometryGroup</a>**</b>
     * 
     * When this method returns, contains the address of a pointer to the geometry group created by this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-creategeometrygroup
     */
    CreateGeometryGroup(fillMode_, geometries, geometriesCount) {
        result := ComCall(8, this, "int", fillMode_, "ptr*", geometries, "uint", geometriesCount, "ptr*", &geometryGroup := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1TransformedGeometry>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createtransformedgeometry
     */
    CreateTransformedGeometry(sourceGeometry, transform) {
        result := ComCall(9, this, "ptr", sourceGeometry, "ptr", transform, "ptr*", &transformedGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1PathGeometry>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1pathgeometry">ID2D1PathGeometry</a>**</b>
     * 
     * When this method returns, contains the address to a pointer to the path geometry created by this method.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-createpathgeometry
     */
    CreatePathGeometry() {
        result := ComCall(10, this, "ptr*", &pathGeometry := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1StrokeStyle>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createstrokestyle
     */
    CreateStrokeStyle(strokeStyleProperties, dashes, dashesCount) {
        dashesMarshal := dashes is VarRef ? "float*" : "ptr"

        result := ComCall(11, this, "ptr", strokeStyleProperties, dashesMarshal, dashes, "uint", dashesCount, "ptr*", &strokeStyle := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1DrawingStateBlock>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createdrawingstateblock
     */
    CreateDrawingStateBlock(drawingStateDescription, textRenderingParams) {
        result := ComCall(12, this, "ptr", drawingStateDescription, "ptr", textRenderingParams, "ptr*", &drawingStateBlock := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1RenderTarget>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createwicbitmaprendertarget
     */
    CreateWicBitmapRenderTarget(target, renderTargetProperties) {
        result := ComCall(13, this, "ptr", target, "ptr", renderTargetProperties, "ptr*", &renderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1HwndRenderTarget>} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1factory-createhwndrendertarget
     */
    CreateHwndRenderTarget(renderTargetProperties, hwndRenderTargetProperties) {
        result := ComCall(14, this, "ptr", renderTargetProperties, "ptr", hwndRenderTargetProperties, "ptr*", &hwndRenderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1RenderTarget>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1rendertarget">ID2D1RenderTarget</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-createdxgisurfacerendertarget(idxgisurface_constd2d1_render_target_properties__id2d1rendertarget)
     */
    CreateDxgiSurfaceRenderTarget(dxgiSurface, renderTargetProperties) {
        result := ComCall(15, this, "ptr", dxgiSurface, "ptr", renderTargetProperties, "ptr*", &renderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1DCRenderTarget>} Type: <b><a href="https://docs.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1dcrendertarget">ID2D1DCRenderTarget</a>**</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1factory-createdcrendertarget
     */
    CreateDCRenderTarget(renderTargetProperties) {
        result := ComCall(16, this, "ptr", renderTargetProperties, "ptr*", &dcRenderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
