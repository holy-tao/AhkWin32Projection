 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1inkstyle
...
class ID2D1InkStyle extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1inkstyle-setnibtransform-overload
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1inkstyle-getnibtransform
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1inkstyle-setnibshape
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1inkstyle-getnibshape
     */
    GetNibShape() {
