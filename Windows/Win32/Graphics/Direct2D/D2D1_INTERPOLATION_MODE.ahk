 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1_1/ne-d2d1_1-d2d1_interpolation_mode
...
class D2D1_INTERPOLATION_MODE extends Win32Enum {
     ...
     * Native name: D2D1_INTERPOLATION_MODE_NEAREST_NEIGHBOR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_INTERPOLATION_MODE_LINEAR
     * @type {Integer (Int32)}
     */
    static LINEAR => 1
     ...
     * Native name: D2D1_INTERPOLATION_MODE_CUBIC
     * @type {Integer (Int32)}
     */
    static CUBIC => 2
     ...
     * Native name: D2D1_INTERPOLATION_MODE_MULTI_SAMPLE_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_INTERPOLATION_MODE_ANISOTROPIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_INTERPOLATION_MODE_HIGH_QUALITY_CUBIC
     * @type {Integer (Int32)}
     */
