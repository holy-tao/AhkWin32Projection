 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1commandsink5
...
class ID2D1CommandSink5 extends ID2D1CommandSink4{
     ...
     * @param {ID2D1Image} image_ Type: <b>ID2D1Image*</b>
     * 
     ...
     * @param {Integer} interpolationMode_ Type: <b>D2D1_INTERPOLATION_MODE</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1commandsink5-blendimage
     */
    BlendImage(image_, blendMode, targetOffset, imageRectangle, interpolationMode_) {
        result := ComCall(34, this, "ptr", image_, "int", blendMode, "ptr", targetOffset, "ptr", imageRectangle, "int", interpolationMode_, "int")
        if(result != 0) {
