 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nn-d2d1effectauthor-id2d1offsettransform
...
class ID2D1OffsetTransform extends ID2D1TransformNode{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1offsettransform-setoffset
     */
    SetOffset(offset) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1offsettransform-getoffset
     */
    GetOffset() {
