 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1geometrysink
...
class ID2D1GeometrySink extends ID2D1SimplifiedGeometrySink{
     ...
     * @param {D2D_POINT_2F} point_ Type: <b><a href="https://docs.microsoft.com/windows/win32/Direct2D/d2d1-point-2f">D2D1_POINT_2F</a></b>
     * 
     * The end point of the line to draw.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1geometrysink-addline
     */
    AddLine(point_) {
        ComCall(10, this, "ptr", point_)
    }
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1geometrysink-addbezier
     */
    AddBezier(bezier) {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1geometrysink-addquadraticbezier
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1geometrysink-addquadraticbeziers
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/Direct2D/id2d1geometrysink-addarc
     */
    AddArc(arc) {
