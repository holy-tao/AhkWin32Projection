...
class ID2D1ComputeTransform extends ID2D1Transform{
    ...
    /**
     * 
     * @param {Pointer<ID2D1ComputeInfo>} computeInfo 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<UInt32>} dimensionX 
     * @param {Pointer<UInt32>} dimensionY 
     * @param {Pointer<UInt32>} dimensionZ 
     * @returns {HRESULT} 
     */
    CalculateThreadgroups(outputRect, dimensionX, dimensionY, dimensionZ) {
        result := ComCall(8, this, "ptr", outputRect, "uint*", dimensionX, "uint*", dimensionY, "uint*", dimensionZ, "int")
        if(result != 0)
            throw OSError(result)
