 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effects/ne-d2d1effects-d2d1_scale_interpolation_mode
...
class D2D1_SCALE_INTERPOLATION_MODE extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_NEAREST_NEIGHBOR => 0
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_LINEAR => 1
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_CUBIC => 2
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_MULTI_SAMPLE_LINEAR => 3

    /**
     * Uses anisotropic filtering to sample a pattern according to the transformed shape of the bitmap.
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_ANISOTROPIC => 4
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SCALE_INTERPOLATION_MODE_HIGH_QUALITY_CUBIC => 5
}
