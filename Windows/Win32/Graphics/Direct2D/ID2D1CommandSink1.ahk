 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nn-d2d1_2-id2d1commandsink1
...
class ID2D1CommandSink1 extends ID2D1CommandSink{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_2/nf-d2d1_2-id2d1commandsink1-setprimitiveblend1
     */
    SetPrimitiveBlend1(primitiveBlend) {
        result := ComCall(28, this, "int", primitiveBlend, "int")
        if(result != 0) {
