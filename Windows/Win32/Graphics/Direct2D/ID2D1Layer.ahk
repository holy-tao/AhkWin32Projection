 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1layer
...
class ID2D1Layer extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1layer-getsize
     */
    GetSize() {
