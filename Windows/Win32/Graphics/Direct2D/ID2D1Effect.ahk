 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nn-d2d1_1-id2d1effect
...
class ID2D1Effect extends ID2D1Properties{
     ...
     * @param {ID2D1Image} input_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1effect-setinput
     */
    SetInput(index, input_, invalidate) {
        ComCall(14, this, "uint", index, "ptr", input_, "int", invalidate)
    }

    /**
     * Allows the application to change the number of inputs to an effect.
     * @remarks
     * Most effects do not support a variable number of inputs. Use <a href="https://docs.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1properties-getvalue(uint32_byte_uint32)">ID2D1Properties::GetValue</a> with the <b>D2D1_PROPERTY_MIN_INPUTS</b> and <b>D2D1_PROPERTY_MAX_INPUTS</b> values to determine the number of inputs supported by an effect.
     * 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1effect-setinputcount
     */
     ...
     * @param {Pointer<ID2D1Image>} input_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1image">ID2D1Image</a>**</b>
     * 
     * When this method returns, contains the address of a pointer to the image that is identified by <i>Index</i>.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1effect-getinput
     */
    GetInput(index, input_) {
        ComCall(16, this, "uint", index, "ptr*", input_)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1effect-getinputcount
     */
    GetInputCount() {
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_1/nf-d2d1_1-id2d1effect-getoutput
     */
