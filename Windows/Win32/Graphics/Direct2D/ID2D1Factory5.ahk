 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1factory5
...
class ID2D1Factory5 extends ID2D1Factory4{
     ...
     * @returns {Pointer<ID2D1Device4>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1device4">ID2D1Device4</a>**</b>
     * 
     * The requested <a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1device4">ID2D1Device4</a> object.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1factory5-createdevice
     */
    CreateDevice(dxgiDevice) {
        result := ComCall(30, this, "ptr", dxgiDevice, "ptr*", &d2dDevice4 := 0, "int")
        if(result != 0) {
