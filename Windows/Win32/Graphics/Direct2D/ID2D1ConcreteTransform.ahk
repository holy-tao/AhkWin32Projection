 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nn-d2d1effectauthor-id2d1concretetransform
...
class ID2D1ConcreteTransform extends ID2D1TransformNode{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1concretetransform-setoutputbuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1concretetransform-setcached
     */
    SetCached(isCached) {
