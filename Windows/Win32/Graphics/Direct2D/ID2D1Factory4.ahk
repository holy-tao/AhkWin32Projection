 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1_3/nn-d2d1_3-id2d1factory4
 * @namespace Windows.Win32.Graphics.Direct2D
 */
export default struct ID2D1Factory4 extends ID2D1Factory3 {
    /**
     ...
     * used for ID2D1Factory4 interfaces
    */
    struct Vtbl extends ID2D1Factory3.Vtbl {
        CreateDevice : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID2D1Factory4.Vtbl()
        }
     ...
     * @returns {ID2D1Device3} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1_3/nn-d2d1_3-id2d1device3">ID2D1Device3</a>**</b>
     * 
    ...
    Query(iid) {
        if (ID2D1Factory4.IID.Equals(iid)) {
            return true
        }
