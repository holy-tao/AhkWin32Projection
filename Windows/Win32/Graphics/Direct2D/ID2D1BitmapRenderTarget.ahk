 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1bitmaprendertarget
...
class ID2D1BitmapRenderTarget extends ID2D1RenderTarget{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1bitmaprendertarget-getbitmap
     */
    GetBitmap() {
        result := ComCall(57, this, "ptr*", &bitmap_ := 0, "int")
        if(result != 0) {
