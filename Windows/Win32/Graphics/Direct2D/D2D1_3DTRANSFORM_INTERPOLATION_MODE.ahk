 ...
 * @see https://learn.microsoft.com/windows/win32/api/d2d1effects/ne-d2d1effects-d2d1_3dtransform_interpolation_mode
 * @namespace Windows.Win32.Graphics.Direct2D
 */
class D2D1_3DTRANSFORM_INTERPOLATION_MODE extends Win32Enum {

    /**
     * Samples the nearest single point and uses that. This mode uses less processing time, but outputs the lowest quality image.
     * Native name: D2D1_3DTRANSFORM_INTERPOLATION_MODE_NEAREST_NEIGHBOR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_3DTRANSFORM_INTERPOLATION_MODE_LINEAR
     * @type {Integer (Int32)}
     */
    static LINEAR => 1
     ...
     * Native name: D2D1_3DTRANSFORM_INTERPOLATION_MODE_CUBIC
     * @type {Integer (Int32)}
     */
    static CUBIC => 2
     ...
     * Native name: D2D1_3DTRANSFORM_INTERPOLATION_MODE_MULTI_SAMPLE_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D2D1_3DTRANSFORM_INTERPOLATION_MODE_ANISOTROPIC
     * @type {Integer (Int32)}
     */
