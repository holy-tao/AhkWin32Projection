 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nn-d2d1-id2d1gradientstopcollection
...
class ID2D1GradientStopCollection extends ID2D1Resource{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gradientstopcollection-getgradientstopcount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gradientstopcollection-getgradientstops
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gradientstopcollection-getcolorinterpolationgamma
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1/nf-d2d1-id2d1gradientstopcollection-getextendmode
     */
    GetExtendMode() {
