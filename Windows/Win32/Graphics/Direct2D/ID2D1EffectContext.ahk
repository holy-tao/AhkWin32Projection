 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nn-d2d1effectauthor-id2d1effectcontext
...
class ID2D1EffectContext extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-getdpi
     */
    GetDpi(dpiX, dpiY) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createeffect
     */
    CreateEffect(effectId) {
        result := ComCall(4, this, "ptr", effectId, "ptr*", &effect_ := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-getmaximumsupportedfeaturelevel
     */
    GetMaximumSupportedFeatureLevel(featureLevels, featureLevelsCount) {
        featureLevelsMarshal := featureLevels is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, featureLevelsMarshal, featureLevels, "uint", featureLevelsCount, "int*", &maximumSupportedFeatureLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1TransformNode>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1transformnode">ID2D1TransformNode</a>**</b>
     * 
     * The returned transform node that encapsulates the effect graph.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createtransformnodefromeffect
     */
    CreateTransformNodeFromEffect(effect_) {
        result := ComCall(6, this, "ptr", effect_, "ptr*", &transformNode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1BlendTransform>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1blendtransform">ID2D1BlendTransform</a>**</b>
     * 
     * The returned blend transform.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createblendtransform
     */
    CreateBlendTransform(numInputs, blendDescription) {
        result := ComCall(7, this, "uint", numInputs, "ptr", blendDescription, "ptr*", &transform := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1BorderTransform>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1bordertransform">ID2D1BorderTransform</a>**</b>
     * 
     * The returned transform.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createbordertransform
     */
    CreateBorderTransform(extendModeX, extendModeY) {
        result := ComCall(8, this, "int", extendModeX, "int", extendModeY, "ptr*", &transform := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The offset amount.
     * @returns {Pointer<ID2D1OffsetTransform>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1offsettransform">ID2D1OffsetTransform</a>**</b>
     * 
     * When this method returns, contains the address of a pointer to an offset transform object.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createoffsettransform
     */
    CreateOffsetTransform(offset) {
        result := ComCall(9, this, "ptr", offset, "ptr*", &transform := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1BoundsAdjustmentTransform>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1boundsadjustmenttransform">ID2D1BoundsAdjustmentTransform</a>**</b>
     * 
     * The returned bounds adjustment transform.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createboundsadjustmenttransform
     */
    CreateBoundsAdjustmentTransform(outputRectangle) {
        result := ComCall(10, this, "ptr", outputRectangle, "ptr*", &transform := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-loadpixelshader
     */
    LoadPixelShader(shaderId, shaderBuffer, shaderBufferCount) {
        shaderBufferMarshal := shaderBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(11, this, "ptr", shaderId, shaderBufferMarshal, shaderBuffer, "uint", shaderBufferCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-loadvertexshader
     */
    LoadVertexShader(resourceId, shaderBuffer, shaderBufferCount) {
        shaderBufferMarshal := shaderBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(12, this, "ptr", resourceId, shaderBufferMarshal, shaderBuffer, "uint", shaderBufferCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-loadcomputeshader
     */
    LoadComputeShader(resourceId, shaderBuffer, shaderBufferCount) {
        shaderBufferMarshal := shaderBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(13, this, "ptr", resourceId, shaderBufferMarshal, shaderBuffer, "uint", shaderBufferCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-isshaderloaded
     */
     ...
     * @returns {Pointer<ID2D1ResourceTexture>} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d2d1effectauthor/nn-d2d1effectauthor-id2d1resourcetexture">ID2D1ResourceTexture</a>**</b>
     * 
     * The returned texture that can be used as a resource in a Direct2D effect.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createresourcetexture
     */
    CreateResourceTexture(resourceId, resourceTextureProperties, data, strides, dataSize) {
        ...
        result := ComCall(15, this, "ptr", resourceId, "ptr", resourceTextureProperties, dataMarshal, data, stridesMarshal, strides, "uint", dataSize, "ptr*", &resourceTexture := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * The returned texture that can be used as a resource in a Direct2D effect.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-findresourcetexture
     */
    FindResourceTexture(resourceId) {
        result := ComCall(16, this, "ptr", resourceId, "ptr*", &resourceTexture := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Pointer<ID2D1VertexBuffer>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createvertexbuffer
     */
    CreateVertexBuffer(vertexBufferProperties, resourceId, customVertexBufferProperties) {
        result := ComCall(17, this, "ptr", vertexBufferProperties, "ptr", resourceId, "ptr", customVertexBufferProperties, "ptr*", &buffer_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The unique id that identifies the vertex buffer.
     * @returns {Pointer<ID2D1VertexBuffer>} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-findvertexbuffer
     */
    FindVertexBuffer(resourceId) {
        result := ComCall(18, this, "ptr", resourceId, "ptr*", &buffer_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createcolorcontext
     */
    CreateColorContext(space, profile_, profileSize) {
        profile_Marshal := profile_ is VarRef ? "char*" : "ptr"

        result := ComCall(19, this, "int", space, profile_Marshal, profile_, "uint", profileSize, "ptr*", &colorContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createcolorcontextfromfilename
     */
    CreateColorContextFromFilename(filename) {
        filename := filename is String ? StrPtr(filename) : filename

        result := ComCall(20, this, "ptr", filename, "ptr*", &colorContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * When this method returns, contains the address of a pointer to a new color context.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-createcolorcontextfromwiccolorcontext
     */
    CreateColorContextFromWicColorContext(wicColorContext) {
        result := ComCall(21, this, "ptr", wicColorContext, "ptr*", &colorContext := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-checkfeaturesupport
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effectauthor/nf-d2d1effectauthor-id2d1effectcontext-isbufferprecisionsupported
     */
