 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1gdimetafile1
...
class ID2D1GdiMetafile1 extends ID2D1GdiMetafile{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1gdimetafile1-getdpi
     */
    GetDpi(dpiX, dpiY) {
        dpiXMarshal := dpiX is VarRef ? "float*" : "ptr"
        dpiYMarshal := dpiY is VarRef ? "float*" : "ptr"

        result := ComCall(6, this, dpiXMarshal, dpiX, dpiYMarshal, dpiY, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1gdimetafile1-getsourcebounds
     */
    GetSourceBounds() {
        bounds := D2D_RECT_F()
