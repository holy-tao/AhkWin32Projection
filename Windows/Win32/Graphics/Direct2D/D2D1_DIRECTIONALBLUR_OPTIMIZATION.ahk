 ...
 */
class D2D1_DIRECTIONALBLUR_OPTIMIZATION extends Win32Enum {

    /**
     * Applies internal optimizations such as pre-scaling at relatively small radii. Uses linear filtering.
     * Native name: D2D1_DIRECTIONALBLUR_OPTIMIZATION_SPEED
     * @type {Integer (Int32)}
     */
    static SPEED => 0
     ...
     * Native name: D2D1_DIRECTIONALBLUR_OPTIMIZATION_BALANCED
     * @type {Integer (Int32)}
     */
    static BALANCED => 1
     ...
     * Native name: D2D1_DIRECTIONALBLUR_OPTIMIZATION_QUALITY
     * @type {Integer (Int32)}
     */
    static QUALITY => 2
}
