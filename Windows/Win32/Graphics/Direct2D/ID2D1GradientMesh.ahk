 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nn-d2d1_3-id2d1gradientmesh
...
class ID2D1GradientMesh extends ID2D1Resource{
     ...
     * 
     * Returns the number of patches that make up this gradient mesh.
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1gradientmesh-getpatchcount
     */
    GetPatchCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d2d1_3/nf-d2d1_3-id2d1gradientmesh-getpatches
     */
