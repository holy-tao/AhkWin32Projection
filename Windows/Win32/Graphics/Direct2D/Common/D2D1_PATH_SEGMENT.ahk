...
class D2D1_PATH_SEGMENT extends Win32BitflagEnum {
     ...
     * Native name: D2D1_PATH_SEGMENT_NONE
     * @type {Integer (Int32)}
     */
    static NONE => 0
     ...
     * Native name: D2D1_PATH_SEGMENT_FORCE_UNSTROKED
     * @type {Integer (Int32)}
     */
    static FORCE_UNSTROKED => 1
     ...
     * Native name: D2D1_PATH_SEGMENT_FORCE_ROUND_LINE_JOIN
     * @type {Integer (Int32)}
     */
    static FORCE_ROUND_LINE_JOIN => 2
}
