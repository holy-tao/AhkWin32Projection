...
class D2D1_DISTANTSPECULAR_PROP extends Win32Enum {
     ...
     * Native name: D2D1_DISTANTSPECULAR_PROP_AZIMUTH
     * @type {Integer (Int32)}
     */
    static AZIMUTH => 0
     ...
     * 
     * The default value is 0.0f.
     * Native name: D2D1_DISTANTSPECULAR_PROP_ELEVATION
     * @type {Integer (Int32)}
     */
    static ELEVATION => 1
     ...
     * Native name: D2D1_DISTANTSPECULAR_PROP_SPECULAR_EXPONENT
     * @type {Integer (Int32)}
     */
    static SPECULAR_EXPONENT => 2
     ...
     * 
     * The default value is 1.0f.
     * Native name: D2D1_DISTANTSPECULAR_PROP_SPECULAR_CONSTANT
     * @type {Integer (Int32)}
     */
    static SPECULAR_CONSTANT => 3
     ...
     * 
     * The default value is 1.0f.
     * Native name: D2D1_DISTANTSPECULAR_PROP_SURFACE_SCALE
     * @type {Integer (Int32)}
     */
    static SURFACE_SCALE => 4
     ...
     * Native name: D2D1_DISTANTSPECULAR_PROP_COLOR
     * @type {Integer (Int32)}
     */
    static COLOR => 5
     ...
     * Native name: D2D1_DISTANTSPECULAR_PROP_KERNEL_UNIT_LENGTH
     * @type {Integer (Int32)}
     */
    static KERNEL_UNIT_LENGTH => 6
     ...
     * Native name: D2D1_DISTANTSPECULAR_PROP_SCALE_MODE
     * @type {Integer (Int32)}
     */
    static SCALE_MODE => 7
}
