 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d2d1effects/ne-d2d1effects-d2d1_spotdiffuse_scale_mode
 * @namespace Windows.Win32.Graphics.Direct2D
 * @version v4.0.30319
 */
class D2D1_SPOTDIFFUSE_SCALE_MODE extends Win32Enum{

    /**
     * Samples the nearest single point and uses that. This mode uses less processing time, but outputs the lowest quality image.
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_NEAREST_NEIGHBOR => 0

    /**
     * Uses a four point sample and linear interpolation. This mode outputs a higher quality image than nearest neighbor.
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_LINEAR => 1
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_CUBIC => 2
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_MULTI_SAMPLE_LINEAR => 3

    /**
     * Uses anisotropic filtering to sample a pattern according to the transformed shape of the bitmap.
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_ANISOTROPIC => 4
     ...
     * @type {Integer (Int32)}
     */
    static D2D1_SPOTDIFFUSE_SCALE_MODE_HIGH_QUALITY_CUBIC => 5
}
