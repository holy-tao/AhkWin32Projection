...
class ID2D1Properties extends IUnknown{
    ...
    SetValueByName(name, type, data, dataSize) {
        ...
        result := ComCall(8, this, "ptr", name, "int", type, "char*", data, "uint", dataSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    SetValue(index, type, data, dataSize) {
        result := ComCall(9, this, "uint", index, "int", type, "char*", data, "uint", dataSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetValueByName(name, type, data, dataSize) {
        ...
        result := ComCall(10, this, "ptr", name, "int", type, "char*", data, "uint", dataSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetValue(index, type, data, dataSize) {
        result := ComCall(11, this, "uint", index, "int", type, "char*", data, "uint", dataSize, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetSubProperties(index, subProperties) {
        result := ComCall(13, this, "uint", index, "ptr", subProperties, "int")
        if(result != 0)
            throw OSError(result)
