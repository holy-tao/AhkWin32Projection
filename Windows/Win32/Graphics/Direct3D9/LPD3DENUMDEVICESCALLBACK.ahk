 ...
 * @version v4.0.30319
 */
class LPD3DENUMDEVICESCALLBACK extends IUnknown {
     ...
     */
    Invoke(lpGuid, lpDeviceDescription, lpDeviceName, param3, param4, param5) {
        ...
        result := ComCall(3, this, "ptr", lpGuid, "ptr", lpDeviceDescription, "ptr", lpDeviceName, "ptr", param3, "ptr", param4, param5Marshal, param5, "int")
        if(result != 0) {
