 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dsurface9
...
class IDirect3DSurface9 extends IDirect3DResource9{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-getcontainer
     */
    GetContainer(riid, ppContainer) {
        ppContainerMarshal := ppContainer is VarRef ? "ptr*" : "ptr"

        result := ComCall(11, this, "ptr", riid, ppContainerMarshal, ppContainer, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-getdesc
     */
    GetDesc(pDesc) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-lockrect
     */
    LockRect(pLockedRect, pRect, Flags) {
        result := ComCall(13, this, "ptr", pLockedRect, "ptr", pRect, "uint", Flags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-unlockrect
     */
    UnlockRect() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-getdc
     */
    GetDC(phdc) {
        result := ComCall(15, this, "ptr", phdc, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. D3DERR_INVALIDCALL is returned if the argument is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dsurface9-releasedc
     */
    ReleaseDC(hdc_) {
        hdc_ := hdc_ is Win32Handle ? NumGet(hdc_, "ptr") : hdc_

        result := ComCall(16, this, "ptr", hdc_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
