 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dvertexdeclaration9
...
class IDirect3DVertexDeclaration9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvertexdeclaration9-getdevice
     */
    GetDevice() {
     ...
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvertexdeclaration9-getdeclaration
     */
    GetDeclaration(pElement, pNumElements) {
        pNumElementsMarshal := pNumElements is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, "ptr", pElement, pNumElementsMarshal, pNumElements, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
