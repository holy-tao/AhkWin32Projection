 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dvolumetexture9
...
class IDirect3DVolumeTexture9 extends IDirect3DBaseTexture9{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvolumetexture9-getleveldesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvolumetexture9-getvolumelevel
     */
    GetVolumeLevel(Level) {
        result := ComCall(18, this, "uint", Level, "ptr*", &ppVolumeLevel := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvolumetexture9-lockbox
     */
    LockBox(Level, pLockedVolume, pBox, Flags) {
        result := ComCall(19, this, "uint", Level, "ptr", pLockedVolume, "ptr", pBox, "uint", Flags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvolumetexture9-unlockbox
     */
    UnlockBox(Level) {
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvolumetexture9-adddirtybox
     */
    AddDirtyBox(pDirtyBox) {
        result := ComCall(21, this, "ptr", pDirtyBox, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
