 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dvertexshader9
...
class IDirect3DVertexShader9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvertexshader9-getdevice
     */
    GetDevice() {
     ...
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dvertexshader9-getfunction
     */
    GetFunction(param0, pSizeOfData) {
        param0Marshal := param0 is VarRef ? "ptr" : "ptr"
        pSizeOfDataMarshal := pSizeOfData is VarRef ? "uint*" : "ptr"

        result := ComCall(4, this, param0Marshal, param0, pSizeOfDataMarshal, pSizeOfData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
