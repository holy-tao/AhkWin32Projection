 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3d9
...
class IDirect3D9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-registersoftwaredevice
     */
    RegisterSoftwareDevice(pInitializeFunction) {
        pInitializeFunctionMarshal := pInitializeFunction is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, pInitializeFunctionMarshal, pInitializeFunction, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getadaptercount
     */
    GetAdapterCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getadapteridentifier
     */
    GetAdapterIdentifier(Adapter_, Flags, pIdentifier) {
        result := ComCall(5, this, "uint", Adapter_, "uint", Flags, "ptr", pIdentifier, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getadaptermodecount
     */
    GetAdapterModeCount(Adapter_, Format) {
        result := ComCall(6, this, "uint", Adapter_, "uint", Format, "uint")
        return result
    }
     ...
     * @param {Integer} Mode_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">UINT</a></b>
     * 
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-enumadaptermodes
     */
    EnumAdapterModes(Adapter_, Format, Mode_, pMode) {
        result := ComCall(7, this, "uint", Adapter_, "uint", Format, "uint", Mode_, "ptr", pMode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getadapterdisplaymode
     */
    GetAdapterDisplayMode(Adapter_, pMode) {
        result := ComCall(8, this, "uint", Adapter_, "ptr", pMode, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-checkdevicetype
     */
    CheckDeviceType(Adapter_, DevType, AdapterFormat, BackBufferFormat, bWindowed) {
        result := ComCall(9, this, "uint", Adapter_, "int", DevType, "uint", AdapterFormat, "uint", BackBufferFormat, "int", bWindowed, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-checkdeviceformat
     */
    CheckDeviceFormat(Adapter_, DeviceType, AdapterFormat, Usage, RType, CheckFormat) {
        result := ComCall(10, this, "uint", Adapter_, "int", DeviceType, "uint", AdapterFormat, "uint", Usage, "int", RType, "uint", CheckFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-checkdevicemultisampletype
     */
    CheckDeviceMultiSampleType(Adapter_, DeviceType, SurfaceFormat, Windowed, MultiSampleType, pQualityLevels) {
        pQualityLevelsMarshal := pQualityLevels is VarRef ? "uint*" : "ptr"

        result := ComCall(11, this, "uint", Adapter_, "int", DeviceType, "uint", SurfaceFormat, "int", Windowed, "int", MultiSampleType, pQualityLevelsMarshal, pQualityLevels, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-checkdepthstencilmatch
     */
    CheckDepthStencilMatch(Adapter_, DeviceType, AdapterFormat, RenderTargetFormat, DepthStencilFormat) {
        result := ComCall(12, this, "uint", Adapter_, "int", DeviceType, "uint", AdapterFormat, "uint", RenderTargetFormat, "uint", DepthStencilFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-checkdeviceformatconversion
     */
    CheckDeviceFormatConversion(Adapter_, DeviceType, SourceFormat, TargetFormat) {
        result := ComCall(13, this, "uint", Adapter_, "int", DeviceType, "uint", SourceFormat, "uint", TargetFormat, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getdevicecaps
     */
    GetDeviceCaps(Adapter_, DeviceType, pCaps) {
        result := ComCall(14, this, "uint", Adapter_, "int", DeviceType, "ptr", pCaps, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-getadaptermonitor
     */
    GetAdapterMonitor(Adapter_) {
        result := ComCall(15, this, "uint", Adapter_, "ptr")
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3d9-createdevice
     */
    CreateDevice(Adapter_, DeviceType, hFocusWindow, BehaviorFlags, pPresentationParameters) {
        hFocusWindow := hFocusWindow is Win32Handle ? NumGet(hFocusWindow, "ptr") : hFocusWindow

        result := ComCall(16, this, "uint", Adapter_, "int", DeviceType, "ptr", hFocusWindow, "uint", BehaviorFlags, "ptr", pPresentationParameters, "ptr*", &ppReturnedDeviceInterface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
