 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dbasetexture9
...
class IDirect3DBaseTexture9 extends IDirect3DResource9{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-setlod
     */
    SetLOD(LODNew) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-getlod
     */
    GetLOD() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-getlevelcount
     */
    GetLevelCount() {
     ...
     * @param {Integer} FilterType_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dtexturefiltertype">D3DTEXTUREFILTERTYPE</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-setautogenfiltertype
     */
    SetAutoGenFilterType(FilterType_) {
        result := ComCall(14, this, "int", FilterType_, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-getautogenfiltertype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dbasetexture9-generatemipsublevels
     */
