...
class IDirect3DPixelShader9 extends IUnknown{
     ...
     * @see https://docs.microsoft.com/windows/win32/api//d3d9helper/nf-d3d9helper-idirect3dpixelshader9-getdevice
     */
    GetDevice() {
     ...
     *      D3DERR_INVALIDCALL.
     * @see https://docs.microsoft.com/windows/win32/api//d3d9helper/nf-d3d9helper-idirect3dpixelshader9-getfunction
     */
