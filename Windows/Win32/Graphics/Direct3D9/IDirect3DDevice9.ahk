 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3ddevice9
...
class IDirect3DDevice9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-testcooperativelevel
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getavailabletexturemem
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-evictmanagedresources
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getdirect3d
     */
    GetDirect3D() {
        result := ComCall(6, this, "ptr*", &ppD3D9 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getdevicecaps
     */
    GetDeviceCaps(pCaps) {
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getdisplaymode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getcreationparameters
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setcursorproperties
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setcursorposition
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-showcursor
     */
    ShowCursor(bShow) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createadditionalswapchain
     */
    CreateAdditionalSwapChain(pPresentationParameters) {
        result := ComCall(13, this, "ptr", pPresentationParameters, "ptr*", &pSwapChain := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getswapchain
     */
    GetSwapChain(iSwapChain) {
        result := ComCall(14, this, "uint", iSwapChain, "ptr*", &pSwapChain := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getnumberofswapchains
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-reset
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-present
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getbackbuffer
     */
    GetBackBuffer(iSwapChain, iBackBuffer, Type) {
        result := ComCall(18, this, "uint", iSwapChain, "uint", iBackBuffer, "int", Type, "ptr*", &ppBackBuffer := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getrasterstatus
     */
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setdialogboxmode
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setgammaramp
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getgammaramp
     */
     ...
     *         pixel dimension (independently). Each dimension clamps at a size of 1 pixel. Thus, if the division by 2 results in 0, 1 will be taken instead.
     * @param {Integer} Levels_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">UINT</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createtexture
     */
    CreateTexture(Width, Height, Levels_, Usage, Format, Pool, pSharedHandle) {
        result := ComCall(23, this, "uint", Width, "uint", Height, "uint", Levels_, "uint", Usage, "uint", Format, "int", Pool, "ptr*", &ppTexture := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createvolumetexture
     */
    CreateVolumeTexture(Width, Height, Depth, Levels_, Usage, Format, Pool, pSharedHandle) {
        result := ComCall(24, this, "uint", Width, "uint", Height, "uint", Depth, "uint", Levels_, "uint", Usage, "uint", Format, "int", Pool, "ptr*", &ppVolumeTexture := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createcubetexture
     */
    CreateCubeTexture(EdgeLength, Levels_, Usage, Format, Pool, pSharedHandle) {
        result := ComCall(25, this, "uint", EdgeLength, "uint", Levels_, "uint", Usage, "uint", Format, "int", Pool, "ptr*", &ppCubeTexture := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createvertexbuffer
     */
    CreateVertexBuffer(Length, Usage, FVF, Pool, pSharedHandle) {
        result := ComCall(26, this, "uint", Length, "uint", Usage, "uint", FVF, "int", Pool, "ptr*", &ppVertexBuffer := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createindexbuffer
     */
    CreateIndexBuffer(Length, Usage, Format, Pool, pSharedHandle) {
        result := ComCall(27, this, "uint", Length, "uint", Usage, "uint", Format, "int", Pool, "ptr*", &ppIndexBuffer := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createrendertarget
     */
    CreateRenderTarget(Width, Height, Format, MultiSample, MultisampleQuality, Lockable, pSharedHandle) {
        result := ComCall(28, this, "uint", Width, "uint", Height, "uint", Format, "int", MultiSample, "uint", MultisampleQuality, "int", Lockable, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createdepthstencilsurface
     */
    CreateDepthStencilSurface(Width, Height, Format, MultiSample, MultisampleQuality, Discard, pSharedHandle) {
        result := ComCall(29, this, "uint", Width, "uint", Height, "uint", Format, "int", MultiSample, "uint", MultisampleQuality, "int", Discard, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-updatesurface
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-updatetexture
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getrendertargetdata
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be one of the following: D3DERR_DRIVERINTERNALERROR, D3DERR_DEVICELOST, D3DERR_INVALIDCALL
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getfrontbufferdata
     */
     ...
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-stretchrect
     */
     ...
     * @param {Integer} color_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3dcolor">D3DCOLOR</a></b>
     * 
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-colorfill
     */
    ColorFill(pSurface, pRect, color_) {
        result := ComCall(35, this, "ptr", pSurface, "ptr", pRect, "uint", color_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createoffscreenplainsurface
     */
    CreateOffscreenPlainSurface(Width, Height, Format, Pool, pSharedHandle) {
        result := ComCall(36, this, "uint", Width, "uint", Height, "uint", Format, "int", Pool, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setrendertarget
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getrendertarget
     */
    GetRenderTarget(RenderTargetIndex) {
        result := ComCall(38, this, "uint", RenderTargetIndex, "ptr*", &ppRenderTarget := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setdepthstencilsurface
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getdepthstencilsurface
     */
    GetDepthStencilSurface() {
        result := ComCall(40, this, "ptr*", &ppZStencilSurface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-beginscene
     */
    BeginScene() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-endscene
     */
    EndScene() {
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be: D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-clear
     */
    Clear(Count, pRects, Flags, Color_, Z, Stencil) {
        result := ComCall(43, this, "uint", Count, "ptr", pRects, "uint", Flags, "uint", Color_, "float", Z, "uint", Stencil, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-settransform
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-gettransform
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. D3DERR_INVALIDCALL if one of the arguments is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-multiplytransform
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setviewport
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getviewport
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setmaterial
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. D3DERR_INVALIDCALL if the pMaterial parameter is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getmaterial
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setlight
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getlight
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-lightenable
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getlightenable
     */
    GetLightEnable(Index, pEnable) {
        pEnableMarshal := pEnable is VarRef ? "int*" : "ptr"

        result := ComCall(54, this, "uint", Index, pEnableMarshal, pEnable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setclipplane
     */
    SetClipPlane(Index, pPlane) {
        pPlaneMarshal := pPlane is VarRef ? "float*" : "ptr"

        result := ComCall(55, this, "uint", Index, pPlaneMarshal, pPlane, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value is D3DERR_INVALIDCALL. This error indicates that the value in Index exceeds the maximum clipping plane index supported by the device, or that the array at pPlane is not large enough to contain four floating-point values.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getclipplane
     */
    GetClipPlane(Index, pPlane) {
        pPlaneMarshal := pPlane is VarRef ? "float*" : "ptr"

        result := ComCall(56, this, "uint", Index, pPlaneMarshal, pPlane, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. D3DERR_INVALIDCALL is returned if one of the arguments is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setrenderstate
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. D3DERR_INVALIDCALL if one of the arguments is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getrenderstate
     */
    GetRenderState(State, pValue) {
        pValueMarshal := pValue is VarRef ? "uint*" : "ptr"

        result := ComCall(58, this, "int", State, pValueMarshal, pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createstateblock
     */
    CreateStateBlock(Type) {
        result := ComCall(59, this, "int", Type, "ptr*", &ppSB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-beginstateblock
     */
    BeginStateBlock() {
     ...
     * 
     * Pointer to a state block interface. See <a href="https://docs.microsoft.com/windows/desktop/api/d3d9helper/nn-d3d9helper-idirect3dstateblock9">IDirect3DStateBlock9</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-endstateblock
     */
    EndStateBlock() {
        result := ComCall(61, this, "ptr*", &ppSB := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setclipstatus
     */
     ...
     * 
     * D3DERR_INVALIDCALL is returned if the argument is invalid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getclipstatus
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-gettexture
     */
    GetTexture(Stage) {
        result := ComCall(64, this, "uint", Stage, "ptr*", &ppTexture := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-settexture
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-gettexturestagestate
     */
    GetTextureStageState(Stage, Type, pValue) {
        pValueMarshal := pValue is VarRef ? "uint*" : "ptr"

        result := ComCall(66, this, "uint", Stage, "int", Type, pValueMarshal, pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-settexturestagestate
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getsamplerstate
     */
    GetSamplerState(Sampler, Type, pValue) {
        pValueMarshal := pValue is VarRef ? "uint*" : "ptr"

        result := ComCall(68, this, "uint", Sampler, "int", Type, pValueMarshal, pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setsamplerstate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-validatedevice
     */
    ValidateDevice(pNumPasses) {
        pNumPassesMarshal := pNumPasses is VarRef ? "uint*" : "ptr"

        result := ComCall(70, this, pNumPassesMarshal, pNumPasses, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setpaletteentries
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getpaletteentries
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setcurrenttexturepalette
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be: D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getcurrenttexturepalette
     */
    GetCurrentTexturePalette(PaletteNumber) {
        PaletteNumberMarshal := PaletteNumber is VarRef ? "uint*" : "ptr"

        result := ComCall(74, this, PaletteNumberMarshal, PaletteNumber, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setscissorrect
     */
     ...
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getscissorrect
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setsoftwarevertexprocessing
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getsoftwarevertexprocessing
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setnpatchmode
     */
     ...
     * 
     * Specifies the number of subdivision segments. If the number of segments is less than 1.0, N-patches are disabled. The default value is 0.0.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getnpatchmode
     */
    GetNPatchMode() {
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be 
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawprimitive
     */
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be the following:
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawindexedprimitive
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be: D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawprimitiveup
     */
    DrawPrimitiveUP(PrimitiveType, PrimitiveCount, pVertexStreamZeroData, VertexStreamZeroStride) {
        ...
        result := ComCall(83, this, "int", PrimitiveType, "uint", PrimitiveCount, pVertexStreamZeroDataMarshal, pVertexStreamZeroData, "uint", VertexStreamZeroStride, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be the following:
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawindexedprimitiveup
     */
    DrawIndexedPrimitiveUP(PrimitiveType, MinVertexIndex, NumVertices, PrimitiveCount, pIndexData, IndexDataFormat, pVertexStreamZeroData, VertexStreamZeroStride) {
        ...
        result := ComCall(84, this, "int", PrimitiveType, "uint", MinVertexIndex, "uint", NumVertices, "uint", PrimitiveCount, pIndexDataMarshal, pIndexData, "uint", IndexDataFormat, pVertexStreamZeroDataMarshal, pVertexStreamZeroData, "uint", VertexStreamZeroStride, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-processvertices
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createvertexdeclaration
     */
    CreateVertexDeclaration(pVertexElements) {
        result := ComCall(86, this, "ptr", pVertexElements, "ptr*", &ppDecl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setvertexdeclaration
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getvertexdeclaration
     */
    GetVertexDeclaration() {
        result := ComCall(88, this, "ptr*", &ppDecl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be:
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setfvf
     */
    SetFVF(FVF) {
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getfvf
     */
    GetFVF(pFVF) {
        pFVFMarshal := pFVF is VarRef ? "uint*" : "ptr"

        result := ComCall(90, this, pFVFMarshal, pFVF, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createvertexshader
     */
    CreateVertexShader(pFunction) {
        pFunctionMarshal := pFunction is VarRef ? "uint*" : "ptr"

        result := ComCall(91, this, pFunctionMarshal, pFunction, "ptr*", &ppShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setvertexshader
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getvertexshader
     */
    GetVertexShader() {
        result := ComCall(93, this, "ptr*", &ppShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setvertexshaderconstantf
     */
    SetVertexShaderConstantF(StartRegister, pConstantData, Vector4fCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "float*" : "ptr"

        result := ComCall(94, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4fCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getvertexshaderconstantf
     */
    GetVertexShaderConstantF(StartRegister, pConstantData, Vector4fCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "float*" : "ptr"

        result := ComCall(95, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4fCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setvertexshaderconstanti
     */
    SetVertexShaderConstantI(StartRegister, pConstantData, Vector4iCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(96, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4iCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getvertexshaderconstanti
     */
    GetVertexShaderConstantI(StartRegister, pConstantData, Vector4iCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(97, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4iCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setvertexshaderconstantb
     */
    SetVertexShaderConstantB(StartRegister, pConstantData, BoolCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(98, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", BoolCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getvertexshaderconstantb
     */
    GetVertexShaderConstantB(StartRegister, pConstantData, BoolCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(99, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", BoolCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setstreamsource
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getstreamsource
     */
    GetStreamSource(StreamNumber, pOffsetInBytes, pStride) {
        ...
        result := ComCall(101, this, "uint", StreamNumber, "ptr*", &ppStreamData := 0, pOffsetInBytesMarshal, pOffsetInBytes, pStrideMarshal, pStride, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setstreamsourcefreq
     */
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getstreamsourcefreq
     */
    GetStreamSourceFreq(StreamNumber, pSetting) {
        pSettingMarshal := pSetting is VarRef ? "uint*" : "ptr"

        result := ComCall(103, this, "uint", StreamNumber, pSettingMarshal, pSetting, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be: D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setindices
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getindices
     */
    GetIndices() {
        result := ComCall(105, this, "ptr*", &ppIndexData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createpixelshader
     */
    CreatePixelShader(pFunction) {
        pFunctionMarshal := pFunction is VarRef ? "uint*" : "ptr"

        result := ComCall(106, this, pFunctionMarshal, pFunction, "ptr*", &ppShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setpixelshader
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getpixelshader
     */
    GetPixelShader() {
        result := ComCall(108, this, "ptr*", &ppShader := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setpixelshaderconstantf
     */
    SetPixelShaderConstantF(StartRegister, pConstantData, Vector4fCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "float*" : "ptr"

        result := ComCall(109, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4fCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getpixelshaderconstantf
     */
    GetPixelShaderConstantF(StartRegister, pConstantData, Vector4fCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "float*" : "ptr"

        result := ComCall(110, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4fCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setpixelshaderconstanti
     */
    SetPixelShaderConstantI(StartRegister, pConstantData, Vector4iCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(111, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4iCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getpixelshaderconstanti
     */
    GetPixelShaderConstantI(StartRegister, pConstantData, Vector4iCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(112, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", Vector4iCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-setpixelshaderconstantb
     */
    SetPixelShaderConstantB(StartRegister, pConstantData, BoolCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(113, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", BoolCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-getpixelshaderconstantb
     */
    GetPixelShaderConstantB(StartRegister, pConstantData, BoolCount) {
        pConstantDataMarshal := pConstantData is VarRef ? "int*" : "ptr"

        result := ComCall(114, this, "uint", StartRegister, pConstantDataMarshal, pConstantData, "uint", BoolCount, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Handle_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">UINT</a></b>
     * 
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be 
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawrectpatch
     */
    DrawRectPatch(Handle_, pNumSegs, pRectPatchInfo) {
        pNumSegsMarshal := pNumSegs is VarRef ? "float*" : "ptr"

        result := ComCall(115, this, "uint", Handle_, pNumSegsMarshal, pNumSegs, "ptr", pRectPatchInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be 
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-drawtripatch
     */
    DrawTriPatch(Handle_, pNumSegs, pTriPatchInfo) {
        pNumSegsMarshal := pNumSegs is VarRef ? "float*" : "ptr"

        result := ComCall(116, this, "uint", Handle_, pNumSegsMarshal, pNumSegs, "ptr", pTriPatchInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * If the method succeeds, the return value is D3D_OK. If the method fails, the return value can be 
     *      D3DERR_INVALIDCALL.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-deletepatch
     */
    DeletePatch(Handle_) {
        result := ComCall(117, this, "uint", Handle_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9-createquery
     */
    CreateQuery(Type) {
        result := ComCall(118, this, "int", Type, "ptr*", &ppQuery := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
