 ...
 * 
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3ddevice9ex
...
class IDirect3DDevice9Ex extends IDirect3DDevice9{
     ...
     * @param {Pointer<Float>} columns_ Type: <b>float*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-setconvolutionmonokernel
     */
    SetConvolutionMonoKernel(width, height, rows, columns_) {
        rowsMarshal := rows is VarRef ? "float*" : "ptr"
        columns_Marshal := columns_ is VarRef ? "float*" : "ptr"

        result := ComCall(119, this, "uint", width, "uint", height, rowsMarshal, rows, columns_Marshal, columns_, "int")
        if(result != 0) {
     ...
     * 
     * If the method succeeds, the return value is D3D_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-composerects
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-presentex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-getgputhreadpriority
     */
    GetGPUThreadPriority(pPriority) {
        pPriorityMarshal := pPriority is VarRef ? "int*" : "ptr"

        result := ComCall(122, this, pPriorityMarshal, pPriority, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Priority_ Type: <b><a href="https://docs.microsoft.com/windows/desktop/WinProg/windows-data-types">INT</a></b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-setgputhreadpriority
     */
    SetGPUThreadPriority(Priority_) {
        result := ComCall(123, this, "int", Priority_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-waitforvblank
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-checkresourceresidency
     */
    CheckResourceResidency(NumResources) {
        result := ComCall(125, this, "ptr*", &pResourceArray := 0, "uint", NumResources, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Possible return values include: D3D_OK or D3DERR_DEVICEREMOVED (see <a href="https://docs.microsoft.com/windows/desktop/direct3d9/d3derr">D3DERR</a>).
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-setmaximumframelatency
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-getmaximumframelatency
     */
    GetMaximumFrameLatency(pMaxLatency) {
        pMaxLatencyMarshal := pMaxLatency is VarRef ? "uint*" : "ptr"

        result := ComCall(127, this, pMaxLatencyMarshal, pMaxLatency, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-checkdevicestate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-createrendertargetex
     */
    CreateRenderTargetEx(Width, Height, Format, MultiSample, MultisampleQuality, Lockable, pSharedHandle, Usage) {
        result := ComCall(129, this, "uint", Width, "uint", Height, "uint", Format, "int", MultiSample, "uint", MultisampleQuality, "int", Lockable, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "uint", Usage, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-createoffscreenplainsurfaceex
     */
    CreateOffscreenPlainSurfaceEx(Width, Height, Format, Pool, pSharedHandle, Usage) {
        result := ComCall(130, this, "uint", Width, "uint", Height, "uint", Format, "int", Pool, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "uint", Usage, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-createdepthstencilsurfaceex
     */
    CreateDepthStencilSurfaceEx(Width, Height, Format, MultiSample, MultisampleQuality, Discard, pSharedHandle, Usage) {
        result := ComCall(131, this, "uint", Width, "uint", Height, "uint", Format, "int", MultiSample, "uint", MultisampleQuality, "int", Discard, "ptr*", &ppSurface := 0, "ptr", pSharedHandle, "uint", Usage, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-resetex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3ddevice9ex-getdisplaymodeex
     */
    GetDisplayModeEx(iSwapChain, pMode, pRotation) {
        pRotationMarshal := pRotation is VarRef ? "int*" : "ptr"

        result := ComCall(133, this, "uint", iSwapChain, "ptr", pMode, pRotationMarshal, pRotation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
