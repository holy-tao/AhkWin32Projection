 ...
 * ```
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nn-d3d9-idirect3dstateblock9
...
class IDirect3DStateBlock9 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dstateblock9-getdevice
     */
    GetDevice() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dstateblock9-capture
     */
    Capture() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d9/nf-d3d9-idirect3dstateblock9-apply
     */
    Apply() {
