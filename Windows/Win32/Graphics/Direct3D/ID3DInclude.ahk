 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nn-d3dcommon-id3dinclude
...
class ID3DInclude extends Win32ComInterface{
     ...
     *               </li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nf-d3dcommon-id3dinclude-open
     */
    Open(IncludeType, pFileName, pParentData, ppData, pBytes) {
        ...
        result := ComCall(0, this, "int", IncludeType, "ptr", pFileName, pParentDataMarshal, pParentData, ppDataMarshal, ppData, pBytesMarshal, pBytes, "int")
        if(result != 0) {
     ...
     *               </li>
     * </ul>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nf-d3dcommon-id3dinclude-close
     */
    Close(pData) {
        pDataMarshal := pData is VarRef ? "ptr" : "ptr"

        result := ComCall(1, this, pDataMarshal, pData, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
