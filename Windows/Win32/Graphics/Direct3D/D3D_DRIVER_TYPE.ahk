 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3dcommon/ne-d3dcommon-d3d_driver_type
 * @namespace Windows.Win32.Graphics.Direct3D
 */
class D3D_DRIVER_TYPE extends Win32Enum {

    /**
     * The driver type is unknown.
     * Native name: D3D_DRIVER_TYPE_UNKNOWN
     * @type {Integer (Int32)}
     */
    static UNKNOWN => 0
     ...
     * Native name: D3D_DRIVER_TYPE_HARDWARE
     * @type {Integer (Int32)}
     */
    static HARDWARE => 1
     ...
     * <div> </div>
     * Native name: D3D_DRIVER_TYPE_REFERENCE
     * @type {Integer (Int32)}
     */
    static REFERENCE => 2
     ...
     * Native name: D3D_DRIVER_TYPE_NULL
     * @type {Integer (Int32)}
     */
    static NULL => 3
     ...
     * Native name: D3D_DRIVER_TYPE_SOFTWARE
     * @type {Integer (Int32)}
     */
    static SOFTWARE => 4
     ...
     * <div> </div>
     * Native name: D3D_DRIVER_TYPE_WARP
     * @type {Integer (Int32)}
     */
    static WARP => 5
}
