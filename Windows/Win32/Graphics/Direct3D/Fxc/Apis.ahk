 ...
 */
export D3DReadFileToBlob(pFileName) {
 ...
 */
export D3DWriteBlobToFile(pBlob, pFileName, bOverwrite) {
    pFileName := pFileName is String ? StrPtr(pFileName) : pFileName

    result := DllCall("D3DCOMPILER_47.dll\D3DWriteBlobToFile", "ptr", pBlob, "ptr", pFileName, BOOL, bOverwrite, "HRESULT")
    return result
}
 ...
 */
export D3DCompile(pSrcData, SrcDataSize, pSourceName, pDefines, pInclude, pEntrypoint, pTarget, Flags1, Flags2, ppCode, ppErrorMsgs) {
 ...
 */
export D3DCompile2(pSrcData, SrcDataSize, pSourceName, pDefines, pInclude, pEntrypoint, pTarget, Flags1, Flags2, SecondaryDataFlags, pSecondaryData, SecondaryDataSize, ppCode, ppErrorMsgs) {
    pSourceName := pSourceName is String ? StrPtr(pSourceName) : pSourceName
    pEntrypoint := pEntrypoint is String ? StrPtr(pEntrypoint) : pEntrypoint
    pTarget := pTarget is String ? StrPtr(pTarget) : pTarget
 ...
 */
export D3DCompileFromFile(pFileName, pDefines, pInclude, pEntrypoint, pTarget, Flags1, Flags2, ppCode, ppErrorMsgs) {
    pFileName := pFileName is String ? StrPtr(pFileName) : pFileName
    pEntrypoint := pEntrypoint is String ? StrPtr(pEntrypoint) : pEntrypoint
    pTarget := pTarget is String ? StrPtr(pTarget) : pTarget
