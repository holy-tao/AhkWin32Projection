 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nn-d3dcommon-id3ddestructionotifier
...
class ID3DDestructionNotifier extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nf-d3dcommon-id3ddestructionotifier-registerdestructioncallback
     */
    RegisterDestructionCallback(callbackFn, pData) {
        pDataMarshal := pData is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", callbackFn, pDataMarshal, pData, "uint*", &pCallbackID := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3dcommon/nf-d3dcommon-id3ddestructionotifier-unregisterdestructioncallback
     */
