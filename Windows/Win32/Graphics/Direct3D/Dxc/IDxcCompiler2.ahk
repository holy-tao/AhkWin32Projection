...
class IDxcCompiler2 extends IDxcCompiler{
    ...
    CompileWithDebug(pSource, pSourceName, pEntryPoint, pTargetProfile, pArguments, argCount, pDefines, defineCount, pIncludeHandler, ppResult, ppDebugBlobName, ppDebugBlob) {
        ...
        result := ComCall(6, this, "ptr", pSource, "ptr", pSourceName, "ptr", pEntryPoint, "ptr", pTargetProfile, "ptr", pArguments, "uint", argCount, "ptr", pDefines, "uint", defineCount, "ptr", pIncludeHandler, "ptr", ppResult, "ptr", ppDebugBlobName, "ptr", ppDebugBlob, "int")
        if(result != 0)
