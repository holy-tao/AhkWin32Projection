...
class IDxcLinker extends IUnknown{
    ...
    Link(pEntryName, pTargetProfile, pLibNames, libCount, pArguments, argCount, ppResult) {
        ...
        result := ComCall(4, this, "ptr", pEntryName, "ptr", pTargetProfile, "ptr", pLibNames, "uint", libCount, "ptr", pArguments, "uint", argCount, "ptr", ppResult, "int")
        if(result != 0)
            throw OSError(result)
