 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d11on12/nn-d3d11on12-id3d11on12device
...
class ID3D11On12Device extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11on12/nf-d3d11on12-id3d11on12device-createwrappedresource
     */
    CreateWrappedResource(pResource12, pFlags11, InState, OutState, riid) {
        result := ComCall(3, this, "ptr", pResource12, "ptr", pFlags11, "int", InState, "int", OutState, "ptr", riid, "ptr*", &ppResource11 := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11on12/nf-d3d11on12-id3d11on12device-releasewrappedresources
     */
     ...
     * Count of the number of resources.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d11on12/nf-d3d11on12-id3d11on12device-acquirewrappedresources
     */
