 ...
 */
export default struct PFN_D3D12_SERIALIZE_VERSIONED_ROOT_SIGNATURE {
    value : IntPtr

    __value {
        set {
            if (value is PFN_D3D12_SERIALIZE_VERSIONED_ROOT_SIGNATURE) {
    ...
    /**
     * A PFN_D3D12_SERIALIZE_VERSIONED_ROOT_SIGNATURE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_D3D12_SERIALIZE_VERSIONED_ROOT_SIGNATURE {
        /**
         * Creates a PFN_D3D12_SERIALIZE_VERSIONED_ROOT_SIGNATURE pointer that invokes the given AHK function when called.
