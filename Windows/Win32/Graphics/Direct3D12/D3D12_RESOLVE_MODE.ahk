...
class D3D12_RESOLVE_MODE extends Win32Enum {
     ...
     * Native name: D3D12_RESOLVE_MODE_DECOMPRESS
     * @type {Integer (Int32)}
     */
    static DECOMPRESS => 0
     ...
     * Native name: D3D12_RESOLVE_MODE_MIN
     * @type {Integer (Int32)}
     */
    static MIN => 1
     ...
     * Native name: D3D12_RESOLVE_MODE_MAX
     * @type {Integer (Int32)}
     */
    static MAX => 2
     ...
     * Native name: D3D12_RESOLVE_MODE_AVERAGE
     * @type {Integer (Int32)}
     */
    static AVERAGE => 3

    /**
     * Native name: D3D12_RESOLVE_MODE_ENCODE_SAMPLER_FEEDBACK
     * @type {Integer (Int32)}
     */
    static ENCODE_SAMPLER_FEEDBACK => 4

    /**
     * Native name: D3D12_RESOLVE_MODE_DECODE_SAMPLER_FEEDBACK
     * @type {Integer (Int32)}
     */
    static DECODE_SAMPLER_FEEDBACK => 5
}
