...
class D3D12_BLEND extends Win32Enum {
     ...
     * Native name: D3D12_BLEND_SRC_COLOR
     * @type {Integer (Int32)}
     */
    static SRC_COLOR => 3
     ...
     * Native name: D3D12_BLEND_INV_SRC_ALPHA
     * @type {Integer (Int32)}
     */
    static INV_SRC_ALPHA => 6
     ...
     * Native name: D3D12_BLEND_DEST_ALPHA
     * @type {Integer (Int32)}
     */
    static DEST_ALPHA => 7
     ...
     * Native name: D3D12_BLEND_INV_DEST_ALPHA
     * @type {Integer (Int32)}
     */
    static INV_DEST_ALPHA => 8
     ...
     * Native name: D3D12_BLEND_DEST_COLOR
     * @type {Integer (Int32)}
     */
    static DEST_COLOR => 9
     ...
     * Native name: D3D12_BLEND_INV_DEST_COLOR
     * @type {Integer (Int32)}
     */
    static INV_DEST_COLOR => 10

    /**
     * The blend factor is (f, f, f, 1); where f = min(Aₛ, 1
     *     - A<sub>d</sub>). The pre-blend operation clamps the data to 1 or less.
     * Native name: D3D12_BLEND_SRC_ALPHA_SAT
     * @type {Integer (Int32)}
     */
    static SRC_ALPHA_SAT => 11
     ...
     * Native name: D3D12_BLEND_BLEND_FACTOR
     * @type {Integer (Int32)}
     */
    static BLEND_FACTOR => 14
     ...
     * Native name: D3D12_BLEND_INV_BLEND_FACTOR
     * @type {Integer (Int32)}
     */
    static INV_BLEND_FACTOR => 15
     ...
     * Native name: D3D12_BLEND_SRC1_COLOR
     * @type {Integer (Int32)}
     */
    static SRC1_COLOR => 16
     ...
     * Native name: D3D12_BLEND_INV_SRC1_COLOR
     * @type {Integer (Int32)}
     */
    static INV_SRC1_COLOR => 17
     ...
     * Native name: D3D12_BLEND_SRC1_ALPHA
     * @type {Integer (Int32)}
     */
    static SRC1_ALPHA => 18
     ...
     * Native name: D3D12_BLEND_INV_SRC1_ALPHA
     * @type {Integer (Int32)}
     */
    static INV_SRC1_ALPHA => 19
     ...
     * Native name: D3D12_BLEND_ALPHA_FACTOR
     * @type {Integer (Int32)}
     */
    static ALPHA_FACTOR => 20
     ...
     * 
     * To successfully use this constant on a target machine, the [D3D12_FEATURE_DATA_D3D12_OPTIONS13](ns-d3d12-d3d12_feature_data_d3d12_options13.md) returned from [capability querying](/windows/win32/direct3d12/capability-querying) must have its *AlphaBlendFactorSupported* set to `TRUE`.
     * Native name: D3D12_BLEND_INV_ALPHA_FACTOR
     * @type {Integer (Int32)}
     */
    static INV_ALPHA_FACTOR => 21
}
