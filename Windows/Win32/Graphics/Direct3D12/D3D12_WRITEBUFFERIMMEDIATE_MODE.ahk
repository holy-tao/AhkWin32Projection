...
class D3D12_WRITEBUFFERIMMEDIATE_MODE extends Win32Enum {
     ...
     * Native name: D3D12_WRITEBUFFERIMMEDIATE_MODE_DEFAULT
     * @type {Integer (Int32)}
     */
    static DEFAULT => 0
     ...
     * Native name: D3D12_WRITEBUFFERIMMEDIATE_MODE_MARKER_IN
     * @type {Integer (Int32)}
     */
    static MARKER_IN => 1
     ...
     * Native name: D3D12_WRITEBUFFERIMMEDIATE_MODE_MARKER_OUT
     * @type {Integer (Int32)}
     */
    static MARKER_OUT => 2
}
