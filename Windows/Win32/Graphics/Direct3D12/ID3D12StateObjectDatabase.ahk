...
export default struct ID3D12StateObjectDatabase extends IUnknown {
    ...
    */
    ...
    FindPipelineStateDesc(pKey, KeySize, CallbackFunc, pContext) {
        ...
        result := ComCall(6, this, pKeyMarshal, pKey, UInt32, KeySize, "ptr", CallbackFunc, pContextMarshal, pContext, "HRESULT")
        return result
    }
    ...
    FindStateObjectDesc(pKey, KeySize, CallbackFunc, pContext) {
        ...
        result := ComCall(8, this, pKeyMarshal, pKey, UInt32, KeySize, "ptr", CallbackFunc, pContextMarshal, pContext, "HRESULT")
        return result
    }
