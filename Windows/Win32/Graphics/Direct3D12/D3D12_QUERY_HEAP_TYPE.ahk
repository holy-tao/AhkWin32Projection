...
class D3D12_QUERY_HEAP_TYPE extends Win32Enum {
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_OCCLUSION
     * @type {Integer (Int32)}
     */
    static OCCLUSION => 0
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_TIMESTAMP
     * @type {Integer (Int32)}
     */
    static TIMESTAMP => 1
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_PIPELINE_STATISTICS
     * @type {Integer (Int32)}
     */
    static PIPELINE_STATISTICS => 2
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_SO_STATISTICS
     * @type {Integer (Int32)}
     */
    static SO_STATISTICS => 3
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_VIDEO_DECODE_STATISTICS
     * @type {Integer (Int32)}
     */
    static VIDEO_DECODE_STATISTICS => 4
     ...
     * Native name: D3D12_QUERY_HEAP_TYPE_COPY_QUEUE_TIMESTAMP
     * @type {Integer (Int32)}
     */
    static COPY_QUEUE_TIMESTAMP => 5

    /**
     * Native name: D3D12_QUERY_HEAP_TYPE_PIPELINE_STATISTICS1
     * @type {Integer (Int32)}
     */
    static PIPELINE_STATISTICS1 => 7
}
