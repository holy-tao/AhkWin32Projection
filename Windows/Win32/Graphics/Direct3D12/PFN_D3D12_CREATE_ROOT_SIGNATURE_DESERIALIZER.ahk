 ...
 */
export default struct PFN_D3D12_CREATE_ROOT_SIGNATURE_DESERIALIZER {
    value : IntPtr

    __value {
        set {
            if (value is PFN_D3D12_CREATE_ROOT_SIGNATURE_DESERIALIZER) {
    ...
    /**
     * A PFN_D3D12_CREATE_ROOT_SIGNATURE_DESERIALIZER that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_D3D12_CREATE_ROOT_SIGNATURE_DESERIALIZER {
        /**
         * Creates a PFN_D3D12_CREATE_ROOT_SIGNATURE_DESERIALIZER pointer that invokes the given AHK function when called.
