...
class D3D12_SHADER_CACHE_KIND_FLAGS extends Win32BitflagEnum {
     ...
     * Native name: D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_D3D_CACHE_FOR_DRIVER
     * @type {Integer (Int32)}
     */
    static FLAG_IMPLICIT_D3D_CACHE_FOR_DRIVER => 1
     ...
     * Native name: D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_D3D_CONVERSIONS
     * @type {Integer (Int32)}
     */
    static FLAG_IMPLICIT_D3D_CONVERSIONS => 2

    /**
     * Specifies a cache that's managed by the driver. Operations for this cache are hints.
     * Native name: D3D12_SHADER_CACHE_KIND_FLAG_IMPLICIT_DRIVER_MANAGED
     * @type {Integer (Int32)}
     */
    static FLAG_IMPLICIT_DRIVER_MANAGED => 4
     ...
     * Native name: D3D12_SHADER_CACHE_KIND_FLAG_APPLICATION_MANAGED
     * @type {Integer (Int32)}
     */
    static FLAG_APPLICATION_MANAGED => 8
}
