 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12device4
...
class ID3D12Device4 extends ID3D12Device3{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-createcommandlist1
     */
    CreateCommandList1(nodeMask, type, flags, riid) {
        result := ComCall(51, this, "uint", nodeMask, "int", type, "int", flags, "ptr", riid, "ptr*", &ppCommandList := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-createprotectedresourcesession
     */
    CreateProtectedResourceSession(pDesc, riid) {
        result := ComCall(52, this, "ptr", pDesc, "ptr", riid, "ptr*", &ppSession := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-createcommittedresource1
     */
    CreateCommittedResource1(pHeapProperties, HeapFlags, pDesc, InitialResourceState, pOptimizedClearValue, pProtectedSession, riidResource) {
        result := ComCall(53, this, "ptr", pHeapProperties, "int", HeapFlags, "ptr", pDesc, "int", InitialResourceState, "ptr", pOptimizedClearValue, "ptr", pProtectedSession, "ptr", riidResource, "ptr*", &ppvResource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-createheap1
     */
    CreateHeap1(pDesc, pProtectedSession, riid) {
        result := ComCall(54, this, "ptr", pDesc, "ptr", pProtectedSession, "ptr", riid, "ptr*", &ppvHeap := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * *ppvResource* can be `nullptr`, to enable capability testing. When *ppvResource* is `nullptr`, no object is created, and **S_FALSE** is returned when *pDesc* is valid.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-createreservedresource1
     */
    CreateReservedResource1(pDesc, InitialState, pOptimizedClearValue, pProtectedSession, riid) {
        result := ComCall(55, this, "ptr", pDesc, "int", InitialState, "ptr", pOptimizedClearValue, "ptr", pProtectedSession, "ptr", riid, "ptr*", &ppvResource := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device4-getresourceallocationinfo1
     */
