 ...
 *       </div>
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nn-d3d12shader-id3d12libraryreflection
...
class ID3D12LibraryReflection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12libraryreflection-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12libraryreflection-getfunctionbyindex
     */
