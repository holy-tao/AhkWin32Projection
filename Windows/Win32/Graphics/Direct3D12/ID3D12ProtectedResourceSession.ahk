 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12protectedresourcesession
...
class ID3D12ProtectedResourceSession extends ID3D12ProtectedSession{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12protectedresourcesession-getdesc
     */
    GetDesc() {
