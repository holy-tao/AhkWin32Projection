...
class ID3D12Device6 extends ID3D12Device5{
     ...
     * @param {Pointer<BOOL>} pbFurtherMeasurementsDesired 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device6-setbackgroundprocessingmode
     */
    SetBackgroundProcessingMode(Mode, MeasurementsAction, hEventToSignalUponCompletion, pbFurtherMeasurementsDesired) {
        ...
        result := ComCall(65, this, "int", Mode, "int", MeasurementsAction, "ptr", hEventToSignalUponCompletion, "ptr", pbFurtherMeasurementsDesired, "HRESULT")
        return result
    }
}
