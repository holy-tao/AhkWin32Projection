 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nn-d3d12sdklayers-id3d12debug
...
class ID3D12Debug extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debug-enabledebuglayer
     */
    EnableDebugLayer() {
        ComCall(3, this)
    }
