 ...
 *       </div>
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nn-d3d12shader-id3d12functionreflection
...
class ID3D12FunctionReflection extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getconstantbufferbyindex
     */
     ...
     * 
     * A pointer to a <a href="https://docs.microsoft.com/windows/desktop/api/d3d12shader/nn-d3d12shader-id3d12shaderreflectionconstantbuffer">ID3D12ShaderReflectionConstantBuffer</a> interface that represents the constant buffer.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getconstantbufferbyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getresourcebindingdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getvariablebyname
     */
     ...
     * 
     * A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/d3d12shader/ns-d3d12shader-d3d12_shader_input_bind_desc">D3D12_SHADER_INPUT_BIND_DESC</a> structure that describes input binding of the resource.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getresourcebindingdescbyname
     */
     ...
     * @returns {ID3D12FunctionParameterReflection} Type: <b><a href="https://docs.microsoft.com/windows/desktop/api/d3d12shader/nn-d3d12shader-id3d12functionparameterreflection">ID3D12FunctionParameterReflection</a>*</b>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12functionreflection-getfunctionparameter
     */
