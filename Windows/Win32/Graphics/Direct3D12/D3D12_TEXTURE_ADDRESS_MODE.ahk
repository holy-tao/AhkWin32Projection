...
class D3D12_TEXTURE_ADDRESS_MODE extends Win32Enum {
     ...
     * Native name: D3D12_TEXTURE_ADDRESS_MODE_WRAP
     * @type {Integer (Int32)}
     */
    static WRAP => 1
     ...
     * Native name: D3D12_TEXTURE_ADDRESS_MODE_MIRROR
     * @type {Integer (Int32)}
     */
    static MIRROR => 2
     ...
     * Native name: D3D12_TEXTURE_ADDRESS_MODE_CLAMP
     * @type {Integer (Int32)}
     */
    static CLAMP => 3
     ...
     * Native name: D3D12_TEXTURE_ADDRESS_MODE_BORDER
     * @type {Integer (Int32)}
     */
    static BORDER => 4
     ...
     * Native name: D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE
     * @type {Integer (Int32)}
     */
