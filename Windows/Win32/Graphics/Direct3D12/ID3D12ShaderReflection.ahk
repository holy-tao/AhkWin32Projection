 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nn-d3d12shader-id3d12shaderreflection
...
class ID3D12ShaderReflection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getconstantbufferbyindex
     */
     ...
     * 
     * A pointer to a constant buffer (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d12shader/nn-d3d12shader-id3d12shaderreflectionconstantbuffer">ID3D12ShaderReflectionConstantBuffer Interface</a>).
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getconstantbufferbyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getresourcebindingdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getinputparameterdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getoutputparameterdesc
     */
     ...
     * 
     * A pointer to a shader-input-signature description. See <a href="https://docs.microsoft.com/windows/win32/api/d3d12shader/ns-d3d12shader-d3d12_signature_parameter_desc">D3D12_SIGNATURE_PARAMETER_DESC</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getpatchconstantparameterdesc
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getvariablebyname
     */
     ...
     * 
     * A pointer to an input-binding description. See <a href="https://docs.microsoft.com/windows/win32/api/d3d12shader/ns-d3d12shader-d3d12_shader_input_bind_desc">D3D12_SHADER_INPUT_BIND_DESC</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getresourcebindingdescbyname
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getmovinstructioncount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getmovcinstructioncount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getconversioninstructioncount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getbitwiseinstructioncount
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getgsinputprimitive
     */
    GetGSInputPrimitive() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-issamplefrequencyshader
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getnuminterfaceslots
     */
     ...
     * This method's interface is hosted in the out-of-box DLL D3DCompiler_xx.dll.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getminfeaturelevel
     */
    GetMinFeatureLevel() {
     ...
     * ```
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getthreadgroupsize
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflection-getrequiresflags
     */
    GetRequiresFlags() {
