 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12device9
...
class ID3D12Device9 extends ID3D12Device8{
     ...
     * @returns {Pointer<Pointer<Void>>} Type: \_COM\_Outptr\_opt\_ **void\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device9-createshadercachesession
     */
    CreateShaderCacheSession(pDesc, riid) {
        result := ComCall(73, this, "ptr", pDesc, "ptr", riid, "ptr*", &ppvSession := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device9-shadercachecontrol
     */
     ...
     * @returns {Pointer<Pointer<Void>>} Type: \_COM\_Outptr\_ **void\*\***
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device9-createcommandqueue1
     */
    CreateCommandQueue1(pDesc, CreatorID, riid) {
        result := ComCall(75, this, "ptr", pDesc, "ptr", CreatorID, "ptr", riid, "ptr*", &ppCommandQueue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
