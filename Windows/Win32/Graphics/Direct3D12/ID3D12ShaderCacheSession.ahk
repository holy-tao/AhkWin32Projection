 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12shadercachesession
...
class ID3D12ShaderCacheSession extends ID3D12DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12shadercachesession-findvalue
     */
    FindValue(pKey, KeySize, pValue, pValueSize) {
        pValueSizeMarshal := pValueSize is VarRef ? "uint*" : "ptr"

        result := ComCall(8, this, "ptr", pKey, "uint", KeySize, "ptr", pValue, pValueSizeMarshal, pValueSize, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12shadercachesession-storevalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12shadercachesession-setdeleteondestroy
     */
    SetDeleteOnDestroy() {
        ComCall(10, this)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12shadercachesession-getdesc
     */
    GetDesc() {
