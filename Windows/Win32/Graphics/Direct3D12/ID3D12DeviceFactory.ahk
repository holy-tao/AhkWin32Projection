...
class ID3D12DeviceFactory extends IUnknown{
    ...
    GetConfigurationInterface(clsid, iid, ppv) {
        result := ComCall(7, this, "ptr", clsid, "ptr", iid, "ptr", ppv, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pConfigurationStructSizes 
     * @returns {HRESULT} 
     */
    EnableExperimentalFeatures(NumFeatures, pIIDs, pConfigurationStructs, pConfigurationStructSizes) {
        result := ComCall(8, this, "uint", NumFeatures, "ptr", pIIDs, "ptr", pConfigurationStructs, "uint*", pConfigurationStructSizes, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IUnknown>} adapter 
    ...
    CreateDevice(adapter, FeatureLevel, riid, ppvDevice) {
        result := ComCall(9, this, "ptr", adapter, "int", FeatureLevel, "ptr", riid, "ptr", ppvDevice, "int")
        if(result != 0)
            throw OSError(result)
