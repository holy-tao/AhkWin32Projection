 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nn-d3d12sdklayers-id3d12debugcommandlist
...
class ID3D12DebugCommandList extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debugcommandlist-assertresourcestate
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debugcommandlist-setfeaturemask
     */
    SetFeatureMask(Mask) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debugcommandlist-getfeaturemask
     */
    GetFeatureMask() {
