 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12deviceremovedextendeddata
...
class ID3D12DeviceRemovedExtendedData extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12deviceremovedextendeddata-getautobreadcrumbsoutput
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12deviceremovedextendeddata-getpagefaultallocationoutput
     */
    GetPageFaultAllocationOutput() {
        pOutput := D3D12_DRED_PAGE_FAULT_OUTPUT()
        result := ComCall(4, this, "ptr", pOutput, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
