 ...
 */
class D3D12_SHADER_CACHE_FLAGS extends Win32BitflagEnum {

    /**
     * Specifies no flag.
     * Native name: D3D12_SHADER_CACHE_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_SHADER_CACHE_FLAG_DRIVER_VERSIONED
     * @type {Integer (Int32)}
     */
    static FLAG_DRIVER_VERSIONED => 1
     ...
     * Native name: D3D12_SHADER_CACHE_FLAG_USE_WORKING_DIR
     * @type {Integer (Int32)}
     */
    static FLAG_USE_WORKING_DIR => 2
}
