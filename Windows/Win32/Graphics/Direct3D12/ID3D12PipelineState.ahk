 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12pipelinestate
...
class ID3D12PipelineState extends ID3D12Pageable{
     ...
     * @returns {Pointer<ID3DBlob>} Type: <b>ID3DBlob**</b>
     * 
     * After this method returns, points to the cached blob representing the pipeline state.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinestate-getcachedblob
     */
    GetCachedBlob() {
        result := ComCall(8, this, "ptr*", &ppBlob := 0, "int")
        if(result != 0) {
