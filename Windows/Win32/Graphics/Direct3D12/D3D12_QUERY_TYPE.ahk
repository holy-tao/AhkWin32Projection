 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d12/ne-d3d12-d3d12_query_type
 * @namespace Windows.Win32.Graphics.Direct3D12
 */
class D3D12_QUERY_TYPE extends Win32Enum {

    /**
     * Indicates the query is for depth/stencil occlusion counts.
     * Native name: D3D12_QUERY_TYPE_OCCLUSION
     * @type {Integer (Int32)}
     */
    static OCCLUSION => 0
     ...
     * Native name: D3D12_QUERY_TYPE_BINARY_OCCLUSION
     * @type {Integer (Int32)}
     */
    static BINARY_OCCLUSION => 1

    /**
     * Indicates the query is for high definition GPU and CPU timestamps.
     * Native name: D3D12_QUERY_TYPE_TIMESTAMP
     * @type {Integer (Int32)}
     */
    static TIMESTAMP => 2
     ...
     * Native name: D3D12_QUERY_TYPE_PIPELINE_STATISTICS
     * @type {Integer (Int32)}
     */
    static PIPELINE_STATISTICS => 3
     ...
     * Native name: D3D12_QUERY_TYPE_SO_STATISTICS_STREAM0
     * @type {Integer (Int32)}
     */
    static SO_STATISTICS_STREAM0 => 4

    /**
     * Stream 1 output statistics.
     * Native name: D3D12_QUERY_TYPE_SO_STATISTICS_STREAM1
     * @type {Integer (Int32)}
     */
    static SO_STATISTICS_STREAM1 => 5

    /**
     * Stream 2 output statistics.
     * Native name: D3D12_QUERY_TYPE_SO_STATISTICS_STREAM2
     * @type {Integer (Int32)}
     */
    static SO_STATISTICS_STREAM2 => 6

    /**
     * Stream 3 output statistics.
     * Native name: D3D12_QUERY_TYPE_SO_STATISTICS_STREAM3
     * @type {Integer (Int32)}
     */
    static SO_STATISTICS_STREAM3 => 7
     ...
     * Native name: D3D12_QUERY_TYPE_VIDEO_DECODE_STATISTICS
     * @type {Integer (Int32)}
     */
    static VIDEO_DECODE_STATISTICS => 8

    /**
     * Native name: D3D12_QUERY_TYPE_PIPELINE_STATISTICS1
     * @type {Integer (Int32)}
     */
    static PIPELINE_STATISTICS1 => 10
}
