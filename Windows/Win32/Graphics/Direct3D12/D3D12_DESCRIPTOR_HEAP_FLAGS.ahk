 ...
 */
class D3D12_DESCRIPTOR_HEAP_FLAGS extends Win32BitflagEnum {

    /**
     * Indicates default usage of a heap.
     * Native name: D3D12_DESCRIPTOR_HEAP_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE
     * @type {Integer (Int32)}
     */
    static FLAG_SHADER_VISIBLE => 1
}
