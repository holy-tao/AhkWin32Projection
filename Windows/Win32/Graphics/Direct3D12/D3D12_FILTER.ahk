 ...
 */
export default struct D3D12_FILTER {
    value : Int32
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_MAG_MIP_POINT => 0

    /**
     * Use point sampling for minification and magnification; use linear interpolation for mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_MAG_POINT_MIP_LINEAR => 1

    /**
     * Use point sampling for minification; use linear interpolation for magnification; use point sampling for mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT => 4

    /**
     * Use point sampling for minification; use linear interpolation for magnification and mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_POINT_MAG_MIP_LINEAR => 5

    /**
     * Use linear interpolation for minification; use point sampling for magnification and mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_LINEAR_MAG_MIP_POINT => 16

    /**
     * Use linear interpolation for minification; use point sampling for magnification; use linear interpolation for mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR => 17

    /**
     * Use linear interpolation for minification and magnification; use point sampling for mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_MAG_LINEAR_MIP_POINT => 20

    /**
     * Use linear interpolation for minification, magnification, and mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_MAG_MIP_LINEAR => 21

    /**
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MIN_MAG_ANISOTROPIC_MIP_POINT => 84

    /**
     * Use anisotropic interpolation for minification, magnification, and mip-level sampling.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_ANISOTROPIC => 85

    /**
     * Use point sampling for minification, magnification, and mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_MAG_MIP_POINT => 128

    /**
     * Use point sampling for minification and magnification; use linear interpolation for mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_MAG_POINT_MIP_LINEAR => 129

    /**
     * Use point sampling for minification; use linear interpolation for magnification; use point sampling for mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_POINT_MAG_LINEAR_MIP_POINT => 132

    /**
     * Use point sampling for minification; use linear interpolation for magnification and mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_POINT_MAG_MIP_LINEAR => 133

    /**
     * Use linear interpolation for minification; use point sampling for magnification and mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_LINEAR_MAG_MIP_POINT => 144

    /**
     * Use linear interpolation for minification; use point sampling for magnification; use linear interpolation for mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_LINEAR_MAG_POINT_MIP_LINEAR => 145

    /**
     * Use linear interpolation for minification and magnification; use point sampling for mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_MAG_LINEAR_MIP_POINT => 148

    /**
     * Use linear interpolation for minification, magnification, and mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR => 149

    /**
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_MIN_MAG_ANISOTROPIC_MIP_POINT => 212

    /**
     * Use anisotropic interpolation for minification, magnification, and mip-level sampling. Compare the result to the comparison value.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_COMPARISON_ANISOTROPIC => 213
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_MAG_MIP_POINT => 256
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_MAG_POINT_MIP_LINEAR => 257

    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT</a> and instead of filtering them return the minimum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the minimum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT => 260
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_POINT_MAG_MIP_LINEAR => 261
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_MIP_POINT => 272
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR => 273
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_MAG_LINEAR_MIP_POINT => 276

    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_MAG_MIP_LINEAR</a> and instead of filtering them return the minimum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the minimum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_MAG_MIP_LINEAR => 277

    /**
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT => 340
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MINIMUM_ANISOTROPIC => 341
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_POINT => 384
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_MAG_POINT_MIP_LINEAR => 385

    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT</a> and instead of filtering them return the maximum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the maximum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT => 388
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_MIP_LINEAR => 389
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_MIP_POINT => 400
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR => 401
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_MAG_LINEAR_MIP_POINT => 404

    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_MAG_MIP_LINEAR</a> and instead of filtering them return the maximum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the maximum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_LINEAR => 405

    /**
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT => 468
     ...
     * @type {Integer (Int32)}
     */
    static D3D12_FILTER_MAXIMUM_ANISOTROPIC => 469
}
