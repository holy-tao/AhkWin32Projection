...
class D3D12_FILTER extends Win32Enum {
     ...
     * Native name: D3D12_FILTER_MIN_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_POINT_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_LINEAR_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MIN_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
    static MIN_MAG_MIP_LINEAR => 21

    /**
     * Native name: D3D12_FILTER_MIN_MAG_ANISOTROPIC_MIP_POINT
     * @type {Integer (Int32)}
     */
    static MIN_MAG_ANISOTROPIC_MIP_POINT => 84

    /**
     * Use anisotropic interpolation for minification, magnification, and mip-level sampling.
     * Native name: D3D12_FILTER_ANISOTROPIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_POINT_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_POINT_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_LINEAR_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_LINEAR_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_COMPARISON_MIN_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
    static COMPARISON_MIN_MAG_MIP_LINEAR => 149

    /**
     * Native name: D3D12_FILTER_COMPARISON_MIN_MAG_ANISOTROPIC_MIP_POINT
     * @type {Integer (Int32)}
     */
    static COMPARISON_MIN_MAG_ANISOTROPIC_MIP_POINT => 212

    /**
     * Use anisotropic interpolation for minification, magnification, and mip-level sampling. Compare the result to the comparison value.
     * Native name: D3D12_FILTER_COMPARISON_ANISOTROPIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_POINT_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MINIMUM_MIN_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
    static MINIMUM_MIN_MAG_MIP_LINEAR => 277

    /**
     * Native name: D3D12_FILTER_MINIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT
     * @type {Integer (Int32)}
     */
    static MINIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT => 340
     ...
     * Native name: D3D12_FILTER_MINIMUM_ANISOTROPIC
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
    ...
    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT</a> and instead of filtering them return the maximum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the maximum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * Native name: D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_POINT_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_MIP_POINT
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_LINEAR_MAG_POINT_MIP_LINEAR
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_FILTER_MAXIMUM_MIN_MAG_LINEAR_MIP_POINT
     * @type {Integer (Int32)}
     */
    ...
    /**
     * Fetch the same set of texels as <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter">D3D12_FILTER_MIN_MAG_MIP_LINEAR</a> and instead of filtering them return the maximum of the texels.  Texels that are weighted 0 during filtering aren't counted towards the maximum.  You can query support for this filter type from the <b>MinMaxFiltering</b> member in the <a href="https://docs.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_feature_data_d3d11_options1">D3D11_FEATURE_DATA_D3D11_OPTIONS1</a> structure.
     * Native name: D3D12_FILTER_MAXIMUM_MIN_MAG_MIP_LINEAR
     * @type {Integer (Int32)}
     */
    static MAXIMUM_MIN_MAG_MIP_LINEAR => 405

    /**
     * Native name: D3D12_FILTER_MAXIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT
     * @type {Integer (Int32)}
     */
    static MAXIMUM_MIN_MAG_ANISOTROPIC_MIP_POINT => 468
     ...
     * Native name: D3D12_FILTER_MAXIMUM_ANISOTROPIC
     * @type {Integer (Int32)}
     */
