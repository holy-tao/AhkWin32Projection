 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d12/ne-d3d12-d3d12_multiple_fence_wait_flags
...
class D3D12_MULTIPLE_FENCE_WAIT_FLAGS extends Win32BitflagEnum {
     ...
     * Native name: D3D12_MULTIPLE_FENCE_WAIT_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_MULTIPLE_FENCE_WAIT_FLAG_ANY
     * @type {Integer (Int32)}
     */
    static FLAG_ANY => 1
     ...
     * Native name: D3D12_MULTIPLE_FENCE_WAIT_FLAG_ALL
     * @type {Integer (Int32)}
     */
    static FLAG_ALL => 0
}
