 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12graphicscommandlist5
...
class ID3D12GraphicsCommandList5 extends ID3D12GraphicsCommandList4{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist5-rssetshadingrate
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist5-rssetshadingrateimage
     */
