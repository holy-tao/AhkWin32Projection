...
class ID3D12Compiler extends ID3D12CompilerFactoryChild{
     ...
     * @param {Pointer<Void>} ppCompilerStateObject 
     * @returns {HRESULT} 
     */
    CompileStateObject(pGroupKey, GroupVersion, pDesc, riid, ppCompilerStateObject) {
        result := ComCall(5, this, "ptr", pGroupKey, "uint", GroupVersion, "ptr", pDesc, "ptr", riid, "ptr", ppCompilerStateObject, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<ID3D12CompilerStateObject>} pCompilerStateObjectToGrowFrom 
     * @param {Pointer<Guid>} riid 
     * @param {Pointer<Void>} ppNewCompilerStateObject 
     * @returns {HRESULT} 
     */
    CompileAddToStateObject(pGroupKey, GroupVersion, pAddition, pCompilerStateObjectToGrowFrom, riid, ppNewCompilerStateObject) {
        result := ComCall(6, this, "ptr", pGroupKey, "uint", GroupVersion, "ptr", pAddition, "ptr", pCompilerStateObjectToGrowFrom, "ptr", riid, "ptr", ppNewCompilerStateObject, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetCacheSession(riid, ppCompilerCacheSession) {
        result := ComCall(7, this, "ptr", riid, "ptr", ppCompilerCacheSession, "int")
        if(result != 0)
            throw OSError(result)
