 ...
 * @version v4.0.30319
 */
class D3D12CompilerCacheSessionAllocationFunc extends IUnknown {
     ...
     */
    Invoke(SizeInBytes, pContext) {
        pContextMarshal := pContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", SizeInBytes, pContextMarshal, pContext, "ptr")
        return result
    }
}
