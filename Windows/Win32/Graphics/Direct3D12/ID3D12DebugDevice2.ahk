 ...
 */
export default struct ID3D12DebugDevice2 extends ID3D12DebugDevice {
    /**
     ...
     * used for ID3D12DebugDevice2 interfaces
    */
    struct Vtbl extends ID3D12DebugDevice.Vtbl {
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D12DebugDevice2.Vtbl()
        }
    ...
    Query(iid) {
        if (ID3D12DebugDevice2.IID.Equals(iid)) {
            return true
        }
