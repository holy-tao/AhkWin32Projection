 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12protectedsession
...
class ID3D12ProtectedSession extends ID3D12DeviceChild{
     ...
     * @returns {Pointer<Pointer<Void>>} A pointer to a memory block that receives a pointer to the fence for the given protected session.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12protectedsession-getstatusfence
     */
    GetStatusFence(riid) {
        result := ComCall(8, this, "ptr", riid, "ptr*", &ppFence := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12protectedsession-getsessionstatus
     */
    GetSessionStatus() {
