 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nn-d3d12shader-id3d12shaderreflectionconstantbuffer
...
class ID3D12ShaderReflectionConstantBuffer extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionconstantbuffer-getdesc
     */
    GetDesc(pDesc) {
     ...
     * 
     * A pointer to a shader-reflection variable interface (see <a href="https://docs.microsoft.com/windows/desktop/api/d3d12shader/nn-d3d12shader-id3d12shaderreflectionvariable">ID3D12ShaderReflectionVariable Interface</a>).
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionconstantbuffer-getvariablebyindex
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionconstantbuffer-getvariablebyname
     */
