 ...
 * 
  ...
  *             Those apps only need to call <a href="https://docs.microsoft.com/windows/win32/api/dxgi1_4/nf-dxgi1_4-idxgiadapter3-queryvideomemoryinfo">IDXGIAdapter3::QueryVideoMemoryInfo</a> for DXGI_MEMORY_SEGMENT_GROUP_LOCAL, 
  ...
  *             See <a href="https://docs.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12device-getcustomheapproperties">GetCustomHeapProperties</a> for more details.
  *           
  * 
  ...
  *             <a href="https://docs.microsoft.com/windows/win32/api/d3d12/nf-d3d12-id3d12resource-writetosubresource">WriteToSubresource</a> are more generally encouraged as more scenarios will just benefit from shared usage.
 ...
 * @version v4.0.30319
 */
class D3D12_FEATURE_DATA_ARCHITECTURE1 extends Win32Struct
{
    static sizeof => 20
