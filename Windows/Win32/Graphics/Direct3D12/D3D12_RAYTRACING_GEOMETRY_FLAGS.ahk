 ...
 * @see https://learn.microsoft.com/windows/win32/api/d3d12/ne-d3d12-d3d12_raytracing_geometry_flags
...
class D3D12_RAYTRACING_GEOMETRY_FLAGS extends Win32BitflagEnum {
     ...
     * Native name: D3D12_RAYTRACING_GEOMETRY_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_RAYTRACING_GEOMETRY_FLAG_OPAQUE
     * @type {Integer (Int32)}
     */
    static FLAG_OPAQUE => 1
     ...
     * Native name: D3D12_RAYTRACING_GEOMETRY_FLAG_NO_DUPLICATE_ANYHIT_INVOCATION
     * @type {Integer (Int32)}
     */
    static FLAG_NO_DUPLICATE_ANYHIT_INVOCATION => 2
}
