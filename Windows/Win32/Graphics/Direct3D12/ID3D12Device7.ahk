 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12device7
...
class ID3D12Device7 extends ID3D12Device6{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device7-addtostateobject
     */
    AddToStateObject(pAddition, pStateObjectToGrowFrom, riid) {
        result := ComCall(66, this, "ptr", pAddition, "ptr", pStateObjectToGrowFrom, "ptr", riid, "ptr*", &ppNewStateObject := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device7-createprotectedresourcesession1
     */
    CreateProtectedResourceSession1(pDesc, riid) {
        result := ComCall(67, this, "ptr", pDesc, "ptr", riid, "ptr*", &ppSession := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
