 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12device2
...
class ID3D12Device2 extends ID3D12Device1{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12device2-createpipelinestate
     */
    CreatePipelineState(pDesc, riid) {
        result := ComCall(47, this, "ptr", pDesc, "ptr", riid, "ptr*", &ppPipelineState := 0, "int")
        if(result != 0) {
