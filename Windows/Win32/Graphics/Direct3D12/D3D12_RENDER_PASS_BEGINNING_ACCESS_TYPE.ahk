...
class D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE extends Win32Enum {
     ...
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_DISCARD
     * @type {Integer (Int32)}
     */
    static DISCARD => 0
     ...
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE
     * @type {Integer (Int32)}
     */
    static PRESERVE => 1
     ...
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_CLEAR
     * @type {Integer (Int32)}
     */
    static CLEAR => 2
     ...
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_NO_ACCESS
     * @type {Integer (Int32)}
     */
    static NO_ACCESS => 3

    /**
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_RENDER
     * @type {Integer (Int32)}
     */
    static PRESERVE_LOCAL_RENDER => 4

    /**
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_SRV
     * @type {Integer (Int32)}
     */
    static PRESERVE_LOCAL_SRV => 5

    /**
     * Native name: D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_UAV
     * @type {Integer (Int32)}
     */
    static PRESERVE_LOCAL_UAV => 6
}
