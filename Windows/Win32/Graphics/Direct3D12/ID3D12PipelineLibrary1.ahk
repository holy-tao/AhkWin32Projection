 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12pipelinelibrary1
...
class ID3D12PipelineLibrary1 extends ID3D12PipelineLibrary{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary1-loadpipeline
     */
    LoadPipeline(pName, pDesc, riid) {
        pName := pName is String ? StrPtr(pName) : pName

        result := ComCall(13, this, "ptr", pName, "ptr", pDesc, "ptr", riid, "ptr*", &ppPipelineState := 0, "int")
        if(result != 0) {
