...
class ID3D12Resource extends ID3D12Pageable{
    ...
    Map(Subresource, pReadRange, ppData) {
        result := ComCall(8, this, "uint", Subresource, "ptr", pReadRange, "ptr", ppData, "int")
        if(result != 0)
    ...
    WriteToSubresource(DstSubresource, pDstBox, pSrcData, SrcRowPitch, SrcDepthPitch) {
        result := ComCall(12, this, "uint", DstSubresource, "ptr", pDstBox, "ptr", pSrcData, "uint", SrcRowPitch, "uint", SrcDepthPitch, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ReadFromSubresource(pDstData, DstRowPitch, DstDepthPitch, SrcSubresource, pSrcBox) {
        result := ComCall(13, this, "ptr", pDstData, "uint", DstRowPitch, "uint", DstDepthPitch, "uint", SrcSubresource, "ptr", pSrcBox, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<Int32>} pHeapFlags 
     * @returns {HRESULT} 
     */
    GetHeapProperties(pHeapProperties, pHeapFlags) {
        result := ComCall(14, this, "ptr", pHeapProperties, "int*", pHeapFlags, "int")
        if(result != 0)
            throw OSError(result)
