 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nn-d3d12shader-id3d12shaderreflectionvariable
...
class ID3D12ShaderReflectionVariable extends Win32ComInterface{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionvariable-getdesc
     */
    GetDesc() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionvariable-gettype
     */
    GetType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionvariable-getbuffer
     */
    GetBuffer() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12shader/nf-d3d12shader-id3d12shaderreflectionvariable-getinterfaceslot
     */
