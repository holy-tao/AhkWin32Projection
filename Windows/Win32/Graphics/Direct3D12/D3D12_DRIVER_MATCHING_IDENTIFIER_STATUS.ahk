...
class D3D12_DRIVER_MATCHING_IDENTIFIER_STATUS extends Win32Enum {
     ...
     * Native name: D3D12_DRIVER_MATCHING_IDENTIFIER_COMPATIBLE_WITH_DEVICE
     * @type {Integer (Int32)}
     */
    static COMPATIBLE_WITH_DEVICE => 0
     ...
     * Native name: D3D12_DRIVER_MATCHING_IDENTIFIER_UNSUPPORTED_TYPE
     * @type {Integer (Int32)}
     */
     ...
     * Native name: D3D12_DRIVER_MATCHING_IDENTIFIER_UNRECOGNIZED
     * @type {Integer (Int32)}
     */
    static UNRECOGNIZED => 2
     ...
     * Native name: D3D12_DRIVER_MATCHING_IDENTIFIER_INCOMPATIBLE_VERSION
     * @type {Integer (Int32)}
     */
    static INCOMPATIBLE_VERSION => 3
     ...
     * Native name: D3D12_DRIVER_MATCHING_IDENTIFIER_INCOMPATIBLE_TYPE
     * @type {Integer (Int32)}
     */
    static INCOMPATIBLE_TYPE => 4
}
