 ...
 */
export default struct ID3D12DebugCommandList3 extends ID3D12DebugCommandList2 {
    /**
     ...
     * used for ID3D12DebugCommandList3 interfaces
    */
    struct Vtbl extends ID3D12DebugCommandList2.Vtbl {
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := ID3D12DebugCommandList3.Vtbl()
        }
    ...
    Query(iid) {
        if (ID3D12DebugCommandList3.IID.Equals(iid)) {
            return true
        }
