 ...
 */
class D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAGS extends Win32BitflagEnum {

    /**
     * No options specified for the acceleration structure build.
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_NONE
     * @type {Integer (Int32)}
     */
    static FLAG_NONE => 0
     ...
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_UPDATE
     * @type {Integer (Int32)}
     */
    static FLAG_ALLOW_UPDATE => 1
     ...
     * <div> </div>
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_COMPACTION
     * @type {Integer (Int32)}
     */
    static FLAG_ALLOW_COMPACTION => 2
     ...
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PREFER_FAST_TRACE
     * @type {Integer (Int32)}
     */
    static FLAG_PREFER_FAST_TRACE => 4
     ...
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PREFER_FAST_BUILD
     * @type {Integer (Int32)}
     */
    static FLAG_PREFER_FAST_BUILD => 8
     ...
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_MINIMIZE_MEMORY
     * @type {Integer (Int32)}
     */
    static FLAG_MINIMIZE_MEMORY => 16
     ...
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_PERFORM_UPDATE
     * @type {Integer (Int32)}
     */
    static FLAG_PERFORM_UPDATE => 32

    /**
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_OMM_UPDATE
     * @type {Integer (Int32)}
     */
    static FLAG_ALLOW_OMM_UPDATE => 64

    /**
     * Native name: D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BUILD_FLAG_ALLOW_DISABLE_OMMS
     * @type {Integer (Int32)}
     */
    static FLAG_ALLOW_DISABLE_OMMS => 128
}
