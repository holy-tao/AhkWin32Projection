 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12graphicscommandlist1
...
class ID3D12GraphicsCommandList1 extends ID3D12GraphicsCommandList{
     ...
     * 
     * <a href="https://docs.microsoft.com/visualstudio/code-quality/annotating-function-parameters-and-return-values?view=vs-2015&preserve-view=true">SAL</a>: <c>_In_</c>
     * 
     ...
     * 
     * <a href="https://docs.microsoft.com/visualstudio/code-quality/annotating-function-parameters-and-return-values?view=vs-2015&preserve-view=true">SAL</a>: <c>_In_reads_(Dependencies)</c>
     * 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-atomiccopybufferuint
     */
     ...
     * @param {Pointer<ID3D12Resource>} ppDependentResources Type: <b>ID3D12Resource*</b>
     * 
     * <a href="https://docs.microsoft.com/visualstudio/code-quality/annotating-function-parameters-and-return-values">SAL</a>: <c>_In_reads_(Dependencies)</c>
     * 
     * An array of resources that contain the dependent elements of the data payload.
     * @param {Pointer<D3D12_SUBRESOURCE_RANGE_UINT64>} pDependentSubresourceRanges Type: <b>const <a href="https://docs.microsoft.com/windows/desktop/api/d3d12/ns-d3d12-d3d12_subresource_range_uint64">D3D12_SUBRESOURCE_RANGE_UINT64</a>*</b>
     * 
     ...
     * An array of subresource ranges that specify the dependent elements of the data payload. These elements are completely updated before the primary data element is itself atomically copied. This ensures that the entire operation is logically atomic; that is, the primary data element never refers to an incomplete data payload.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-atomiccopybufferuint64
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-omsetdepthbounds
     */
     ...
     * 
     * <a href="https://docs.microsoft.com/visualstudio/code-quality/annotating-function-parameters-and-return-values">SAL</a>: <c>_In_reads_(NumSamplesPerPixel*NumPixels)</c>
     * 
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-setsamplepositions
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-resolvesubresourceregion
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12graphicscommandlist1-setviewinstancemask
     */
