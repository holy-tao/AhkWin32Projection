 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nn-d3d12-id3d12pipelinelibrary
...
class ID3D12PipelineLibrary extends ID3D12DeviceChild{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary-storepipeline
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary-loadgraphicspipeline
     */
    LoadGraphicsPipeline(pName, pDesc, riid) {
        pName := pName is String ? StrPtr(pName) : pName

        result := ComCall(9, this, "ptr", pName, "ptr", pDesc, "ptr", riid, "ptr*", &ppPipelineState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * Specifies a pointer that will reference the returned PSO.
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary-loadcomputepipeline
     */
    LoadComputePipeline(pName, pDesc, riid) {
        pName := pName is String ? StrPtr(pName) : pName

        result := ComCall(10, this, "ptr", pName, "ptr", pDesc, "ptr", riid, "ptr*", &ppPipelineState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary-getserializedsize
     */
    GetSerializedSize() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12/nf-d3d12-id3d12pipelinelibrary-serialize
     */
    Serialize(DataSizeInBytes) {
        result := ComCall(12, this, "ptr", &pData := 0, "ptr", DataSizeInBytes, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
