 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nn-d3d12sdklayers-id3d12debug3
...
class ID3D12Debug3 extends ID3D12Debug{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debug3-setenablegpubasedvalidation
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debug3-setenablesynchronizedcommandqueuevalidation
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/d3d12sdklayers/nf-d3d12sdklayers-id3d12debug3-setgpubasedvalidationflags
     */
