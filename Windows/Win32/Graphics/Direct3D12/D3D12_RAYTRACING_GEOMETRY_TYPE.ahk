...
class D3D12_RAYTRACING_GEOMETRY_TYPE extends Win32Enum {
     ...
     * Native name: D3D12_RAYTRACING_GEOMETRY_TYPE_TRIANGLES
     * @type {Integer (Int32)}
     */
    static TRIANGLES => 0
     ...
     * Native name: D3D12_RAYTRACING_GEOMETRY_TYPE_PROCEDURAL_PRIMITIVE_AABBS
     * @type {Integer (Int32)}
     */
    static PROCEDURAL_PRIMITIVE_AABBS => 1

    /**
     * Native name: D3D12_RAYTRACING_GEOMETRY_TYPE_OMM_TRIANGLES
     * @type {Integer (Int32)}
     */
    static OMM_TRIANGLES => 2
}
