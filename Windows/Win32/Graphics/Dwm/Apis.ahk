...
;@region Methods
     ...
     * @param {HWND} hWnd_ A handle to the window procedure that received the message.
     * @param {Integer} msg_ The message.
     * @param {WPARAM} wParam_ Specifies additional message information. The content of this parameter depends on the value of the <i>msg</i> parameter.
     * @param {LPARAM} lParam_ Specifies additional message information. The content of this parameter depends on the value of the <i>msg</i> parameter.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmdefwindowproc
     * @since windows6.0.6000
     */
    static DwmDefWindowProc(hWnd_, msg_, wParam_, lParam_, plResult) {
        ...
        result := DllCall("dwmapi.dll\DwmDefWindowProc", "ptr", hWnd_, "uint", msg_, "ptr", wParam_, "ptr", lParam_, "ptr", plResult, "int")
        return result
    }
     ...
     * @param {HWND} hWnd_ The handle to the window on which the blur-behind data is applied.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmenableblurbehindwindow
     * @since windows6.0.6000
     */
    static DwmEnableBlurBehindWindow(hWnd_, pBlurBehind) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        result := DllCall("dwmapi.dll\DwmEnableBlurBehindWindow", "ptr", hWnd_, "ptr", pBlurBehind, "int")
        if(result != 0) {
     ...
     * <div> </div>
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmenablecomposition
     * @since windows6.0.6000
     */
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmenablemmcss
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hWnd_ The handle to the window in which the frame will be extended into the client area.
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmextendframeintoclientarea
     * @since windows6.0.6000
     */
    static DwmExtendFrameIntoClientArea(hWnd_, pMarInset) {
        hWnd_ := hWnd_ is Win32Handle ? NumGet(hWnd_, "ptr") : hWnd_

        result := DllCall("dwmapi.dll\DwmExtendFrameIntoClientArea", "ptr", hWnd_, "ptr", pMarInset, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetcolorizationcolor
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hwnd_ The handle to the window for which the composition timing information should be retrieved.
     *         
     *                         
     * 
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetcompositiontiminginfo
     * @since windows6.0.6000
     */
    static DwmGetCompositionTimingInfo(hwnd_, pTimingInfo) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmGetCompositionTimingInfo", "ptr", hwnd_, "ptr", pTimingInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ The handle to the window from which the attribute value is to be retrieved.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetwindowattribute
     * @since windows6.0.6000
     */
    static DwmGetWindowAttribute(hwnd_, dwAttribute, pvAttribute, cbAttribute) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmGetWindowAttribute", "ptr", hwnd_, "uint", dwAttribute, "ptr", pvAttribute, "uint", cbAttribute, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmiscompositionenabled
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hwnd_ The handle to the window for which the new duration is applied to the previous frame.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmmodifypreviousdxframeduration
     * @since windows6.0.6000
     */
    static DwmModifyPreviousDxFrameDuration(hwnd_, cRefreshes, fRelative) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmModifyPreviousDxFrameDuration", "ptr", hwnd_, "int", cRefreshes, "int", fRelative, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmquerythumbnailsourcesize
     * @since windows6.0.6000
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmregisterthumbnail
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hwnd_ The handle to the window that displays the presented frame.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmsetdxframeduration
     * @since windows6.0.6000
     */
    static DwmSetDxFrameDuration(hwnd_, cRefreshes) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmSetDxFrameDuration", "ptr", hwnd_, "int", cRefreshes, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ The handle to the window where the present parameters are applied.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmsetpresentparameters
     * @since windows6.0.6000
     */
    static DwmSetPresentParameters(hwnd_, pPresentParams) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmSetPresentParameters", "ptr", hwnd_, "ptr", pPresentParams, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ The handle to the window for which the attribute value is to be set.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmsetwindowattribute
     * @since windows6.0.6000
     */
    static DwmSetWindowAttribute(hwnd_, dwAttribute, pvAttribute, cbAttribute) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmSetWindowAttribute", "ptr", hwnd_, "uint", dwAttribute, "ptr", pvAttribute, "uint", cbAttribute, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmunregisterthumbnail
     * @since windows6.0.6000
     */
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmupdatethumbnailproperties
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hwnd_ A handle to the window or tab. This window must belong to the calling process.
     * @param {HBITMAP} hbmp A handle to the bitmap to represent the window that <i>hwnd</i> specifies.
     * @param {Integer} dwSITFlags 
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmseticonicthumbnail
     * @since windows6.1
     */
    static DwmSetIconicThumbnail(hwnd_, hbmp, dwSITFlags) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        hbmp := hbmp is Win32Handle ? NumGet(hbmp, "ptr") : hbmp

        result := DllCall("dwmapi.dll\DwmSetIconicThumbnail", "ptr", hwnd_, "ptr", hbmp, "uint", dwSITFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ A handle to the window. This window must belong to the calling process.
     * @param {HBITMAP} hbmp A handle to the bitmap to represent the window that <i>hwnd</i> specifies.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmseticoniclivepreviewbitmap
     * @since windows6.1
     */
    static DwmSetIconicLivePreviewBitmap(hwnd_, hbmp, pptClient, dwSITFlags) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_
        hbmp := hbmp is Win32Handle ? NumGet(hbmp, "ptr") : hbmp

        result := DllCall("dwmapi.dll\DwmSetIconicLivePreviewBitmap", "ptr", hwnd_, "ptr", hbmp, "ptr", pptClient, "uint", dwSITFlags, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ A handle to the window or tab whose bitmaps are being invalidated through this call. This window must belong to the calling process.
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwminvalidateiconicbitmaps
     * @since windows6.1
     */
    static DwmInvalidateIconicBitmaps(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmInvalidateIconicBitmaps", "ptr", hwnd_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ 
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmattachmilcontent
     * @since windows6.0.6000
     */
    static DwmAttachMilContent(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmAttachMilContent", "ptr", hwnd_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {HWND} hwnd_ 
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmdetachmilcontent
     * @since windows6.0.6000
     */
    static DwmDetachMilContent(hwnd_) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmDetachMilContent", "ptr", hwnd_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmflush
     * @since windows6.0.6000
     */
    static DwmFlush() {
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetgraphicsstreamtransformhint
     * @since windows6.0.6000
     */
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetgraphicsstreamclient
     * @since windows6.0.6000
     */
     ...
     * @returns {HRESULT} If this function succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgettransportattributes
     * @since windows6.0.6000
     */
     ...
     * @param {HWND} hwnd_ Handle to the window.
     * @param {Integer} target 
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmtransitionownedwindow
     * @since windows8.0
     */
    static DwmTransitionOwnedWindow(hwnd_, target) {
        hwnd_ := hwnd_ is Win32Handle ? NumGet(hwnd_, "ptr") : hwnd_

        result := DllCall("dwmapi.dll\DwmTransitionOwnedWindow", "ptr", hwnd_, "int", target, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmrendergesture
     * @since windows8.0
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmtethercontact
     * @since windows8.0
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmshowcontact
     * @since windows8.0
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/dwmapi/nf-dwmapi-dwmgetunmettabrequirements
