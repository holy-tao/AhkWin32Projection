 ...
 */
export default struct IWiaMiniDrvTransferCallback extends IUnknown {
    /**
     ...
     * used for IWiaMiniDrvTransferCallback interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWiaMiniDrvTransferCallback.Vtbl()
        }
    ...
    Query(iid) {
        if (IWiaMiniDrvTransferCallback.IID.Equals(iid)) {
            return true
        }
