 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiatransfercallback
...
class IWiaTransferCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiatransfercallback-transfercallback
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiatransfercallback-getnextstream
     */
    GetNextStream(lFlags, bstrItemName, bstrFullItemName) {
        ...
        result := ComCall(4, this, "int", lFlags, "ptr", bstrItemName, "ptr", bstrFullItemName, "ptr*", &ppDestination := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
