 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2
...
class IEnumWiaItem2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2-next
     */
    Next(cElt, pcEltFetched) {
        pcEltFetchedMarshal := pcEltFetched is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "uint", cElt, "ptr*", &ppIWiaItem2 := 0, pcEltFetchedMarshal, pcEltFetched, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2-skip
     */
    Skip(cElt) {
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-ienumwiaitem2-getcount
     */
    GetCount() {
