 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2
...
class IWiaItem2 extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-createchilditem
     */
    CreateChildItem(lItemFlags, lCreationFlags, bstrItemName) {
        ...
        result := ComCall(3, this, "int", lItemFlags, "int", lCreationFlags, "ptr", bstrItemName, "ptr*", &ppIWiaItem2 := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-deleteitem
     */
    DeleteItem(lFlags) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-enumchilditems
     */
    EnumChildItems(pCategoryGUID) {
        result := ComCall(5, this, "ptr", pCategoryGUID, "ptr*", &ppIEnumWiaItem2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-finditembyname
     */
    FindItemByName(lFlags, bstrFullItemName) {
        ...
        result := ComCall(6, this, "int", lFlags, "ptr", bstrFullItemName, "ptr*", &ppIWiaItem2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getitemcategory
     */
    GetItemCategory() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getitemtype
     */
    GetItemType() {
        result := ComCall(8, this, "int*", &pItemType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-devicedlg
     */
    DeviceDlg(lFlags, hwndParent, bstrFolderName, bstrFilename, plNumFiles, ppbstrFilePaths, ppItem) {
        ...
        result := ComCall(9, this, "int", lFlags, "ptr", hwndParent, "ptr", bstrFolderName, "ptr", bstrFilename, plNumFilesMarshal, plNumFiles, ppbstrFilePathsMarshal, ppbstrFilePaths, "ptr*", ppItem, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-devicecommand
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-enumdevicecapabilities
     */
    EnumDeviceCapabilities(lFlags) {
        result := ComCall(11, this, "int", lFlags, "ptr*", &ppIEnumWIA_DEV_CAPS := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-checkextension
     */
    CheckExtension(lFlags, bstrName, riidExtensionInterface, pbExtensionExists) {
        ...
        result := ComCall(12, this, "int", lFlags, "ptr", bstrName, "ptr", riidExtensionInterface, pbExtensionExistsMarshal, pbExtensionExists, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getextension
     */
    GetExtension(lFlags, bstrName, riidExtensionInterface, ppOut) {
        ...
        result := ComCall(13, this, "int", lFlags, "ptr", bstrName, "ptr", riidExtensionInterface, ppOutMarshal, ppOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getparentitem
     */
    GetParentItem() {
        result := ComCall(14, this, "ptr*", &ppIWiaItem2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getrootitem
     */
    GetRootItem() {
        result := ComCall(15, this, "ptr*", &ppIWiaItem2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-getpreviewcomponent
     */
    GetPreviewComponent(lFlags) {
        result := ComCall(16, this, "int", lFlags, "ptr*", &ppWiaPreview := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-enumregistereventinfo
     */
    EnumRegisterEventInfo(lFlags, pEventGUID) {
        result := ComCall(17, this, "int", lFlags, "ptr", pEventGUID, "ptr*", &ppIEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaitem2-diagnostic
     */
    Diagnostic(ulSize, pBuffer) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(18, this, "uint", ulSize, pBufferMarshal, pBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
