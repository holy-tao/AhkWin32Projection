...
class IWiaEventCallback extends IUnknown{
     ...
     * @param {Pointer<UInt32>} pulEventType 
    ...
    ImageEventCallback(pEventGUID, bstrEventDescription, bstrDeviceID, bstrDeviceDescription, dwDeviceType, bstrFullItemName, pulEventType, ulReserved) {
        ...
        result := ComCall(3, this, "ptr", pEventGUID, "ptr", bstrEventDescription, "ptr", bstrDeviceID, "ptr", bstrDeviceDescription, "uint", dwDeviceType, "ptr", bstrFullItemName, "uint*", pulEventType, "uint", ulReserved, "int")
        if(result != 0)
