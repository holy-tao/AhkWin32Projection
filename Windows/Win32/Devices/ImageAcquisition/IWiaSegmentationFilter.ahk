 ...
 */
export default struct IWiaSegmentationFilter extends IUnknown {
    /**
     ...
     * used for IWiaSegmentationFilter interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWiaSegmentationFilter.Vtbl()
        }
    ...
    Query(iid) {
        if (IWiaSegmentationFilter.IID.Equals(iid)) {
            return true
        }
