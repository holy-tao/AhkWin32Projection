 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaimagefilter
...
class IWiaImageFilter extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaimagefilter-initializefilter
     */
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaimagefilter-setnewcallback
     */
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaimagefilter-filterpreviewimage
     */
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaimagefilter-applyproperties
     */
