...
class IWiaDevMgr extends IUnknown{
    ...
    EnumDeviceInfo(lFlag, ppIEnum) {
        result := ComCall(3, this, "int", lFlag, "ptr", ppIEnum, "int")
        if(result != 0)
    ...
    CreateDevice(bstrDeviceID, ppWiaItemRoot) {
        ...
        result := ComCall(4, this, "ptr", bstrDeviceID, "ptr", ppWiaItemRoot, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<IWiaItem>} pItemRoot 
    ...
    RegisterEventCallbackInterface(lFlags, bstrDeviceID, pEventGUID, pIWiaEventCallback, pEventObject) {
        ...
        result := ComCall(9, this, "int", lFlags, "ptr", bstrDeviceID, "ptr", pEventGUID, "ptr", pIWiaEventCallback, "ptr", pEventObject, "int")
        if(result != 0)
            throw OSError(result)
