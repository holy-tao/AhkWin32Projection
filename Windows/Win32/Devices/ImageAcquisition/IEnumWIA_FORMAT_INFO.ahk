 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nn-wia_xp-ienumwia_format_info
...
class IEnumWIA_FORMAT_INFO extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_format_info-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_format_info-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_format_info-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_format_info-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_format_info-getcount
     */
    GetCount() {
