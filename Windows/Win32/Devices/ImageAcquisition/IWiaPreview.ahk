 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiapreview
...
class IWiaPreview extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiapreview-getnewpreview
     */
     ...
     * 
     * If this method succeeds, it returns **S\_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiapreview-updatepreview
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiapreview-detectregions
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiapreview-clear
     */
    Clear() {
