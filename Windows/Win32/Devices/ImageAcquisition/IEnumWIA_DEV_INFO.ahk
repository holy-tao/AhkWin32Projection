 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nn-wia_xp-ienumwia_dev_info
...
class IEnumWIA_DEV_INFO extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_info-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_info-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_info-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_info-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_info-getcount
     */
    GetCount() {
