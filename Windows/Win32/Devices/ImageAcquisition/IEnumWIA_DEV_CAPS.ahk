 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nn-wia_xp-ienumwia_dev_caps
...
class IEnumWIA_DEV_CAPS extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_caps-next
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_caps-skip
     */
    Skip(celt) {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_caps-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_caps-clone
     */
    Clone() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wia_xp/nf-wia_xp-ienumwia_dev_caps-getcount
     */
    GetCount() {
