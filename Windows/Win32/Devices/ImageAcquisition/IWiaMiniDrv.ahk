...
export default struct IWiaMiniDrv extends IUnknown {
    ...
    */
    ...
    drvInitializeWia(__MIDL__IWiaMiniDrv0000, __MIDL__IWiaMiniDrv0001, __MIDL__IWiaMiniDrv0002, __MIDL__IWiaMiniDrv0003, __MIDL__IWiaMiniDrv0004, __MIDL__IWiaMiniDrv0005, __MIDL__IWiaMiniDrv0006, __MIDL__IWiaMiniDrv0007, __MIDL__IWiaMiniDrv0008) {
        ...
        __MIDL__IWiaMiniDrv0000Marshal := __MIDL__IWiaMiniDrv0000 is VarRef ? "char*" : IntPtr
        __MIDL__IWiaMiniDrv0004Marshal := __MIDL__IWiaMiniDrv0004 == 0 ? IntPtr : "ptr"
        __MIDL__IWiaMiniDrv0005Marshal := __MIDL__IWiaMiniDrv0005 == 0 ? IntPtr : "ptr"
        __MIDL__IWiaMiniDrv0008Marshal := __MIDL__IWiaMiniDrv0008 is VarRef ? "int*" : IntPtr

        result := ComCall(3, this, __MIDL__IWiaMiniDrv0000Marshal, __MIDL__IWiaMiniDrv0000, Int32, __MIDL__IWiaMiniDrv0001, BSTR, __MIDL__IWiaMiniDrv0002, BSTR, __MIDL__IWiaMiniDrv0003, __MIDL__IWiaMiniDrv0004Marshal, __MIDL__IWiaMiniDrv0004, __MIDL__IWiaMiniDrv0005Marshal, __MIDL__IWiaMiniDrv0005, IWiaDrvItem.Ptr, __MIDL__IWiaMiniDrv0006, IUnknown.Ptr, __MIDL__IWiaMiniDrv0007, __MIDL__IWiaMiniDrv0008Marshal, __MIDL__IWiaMiniDrv0008, "HRESULT")
        return result
    }
    ...
    drvAcquireItemData(__MIDL__IWiaMiniDrv0009, __MIDL__IWiaMiniDrv0010, __MIDL__IWiaMiniDrv0011) {
        __MIDL__IWiaMiniDrv0009Marshal := __MIDL__IWiaMiniDrv0009 is VarRef ? "char*" : IntPtr
    ...
    drvInitItemProperties(__MIDL__IWiaMiniDrv0013, __MIDL__IWiaMiniDrv0014) {
        __MIDL__IWiaMiniDrv0013Marshal := __MIDL__IWiaMiniDrv0013 is VarRef ? "char*" : IntPtr
    ...
    drvValidateItemProperties(__MIDL__IWiaMiniDrv0016, __MIDL__IWiaMiniDrv0017, __MIDL__IWiaMiniDrv0018, __MIDL__IWiaMiniDrv0019) {
        __MIDL__IWiaMiniDrv0016Marshal := __MIDL__IWiaMiniDrv0016 is VarRef ? "char*" : IntPtr
    ...
    drvWriteItemProperties(__MIDL__IWiaMiniDrv0021, __MIDL__IWiaMiniDrv0022, __MIDL__IWiaMiniDrv0023) {
        __MIDL__IWiaMiniDrv0021Marshal := __MIDL__IWiaMiniDrv0021 is VarRef ? "char*" : IntPtr
    ...
    drvReadItemProperties(__MIDL__IWiaMiniDrv0025, __MIDL__IWiaMiniDrv0026, __MIDL__IWiaMiniDrv0027, __MIDL__IWiaMiniDrv0028) {
        __MIDL__IWiaMiniDrv0025Marshal := __MIDL__IWiaMiniDrv0025 is VarRef ? "char*" : IntPtr
    ...
    drvLockWiaDevice(__MIDL__IWiaMiniDrv0030, __MIDL__IWiaMiniDrv0031) {
        __MIDL__IWiaMiniDrv0030Marshal := __MIDL__IWiaMiniDrv0030 is VarRef ? "char*" : IntPtr
    ...
    drvUnLockWiaDevice(__MIDL__IWiaMiniDrv0033, __MIDL__IWiaMiniDrv0034) {
        __MIDL__IWiaMiniDrv0033Marshal := __MIDL__IWiaMiniDrv0033 is VarRef ? "char*" : IntPtr
    ...
    drvAnalyzeItem(__MIDL__IWiaMiniDrv0036, __MIDL__IWiaMiniDrv0037, __MIDL__IWiaMiniDrv0038) {
        __MIDL__IWiaMiniDrv0036Marshal := __MIDL__IWiaMiniDrv0036 is VarRef ? "char*" : IntPtr
        __MIDL__IWiaMiniDrv0038Marshal := __MIDL__IWiaMiniDrv0038 is VarRef ? "int*" : IntPtr
    ...
    drvGetDeviceErrorStr(__MIDL__IWiaMiniDrv0039, __MIDL__IWiaMiniDrv0040, __MIDL__IWiaMiniDrv0041, __MIDL__IWiaMiniDrv0042) {
        __MIDL__IWiaMiniDrv0041Marshal := __MIDL__IWiaMiniDrv0041 is VarRef ? "ptr*" : IntPtr
        __MIDL__IWiaMiniDrv0042Marshal := __MIDL__IWiaMiniDrv0042 is VarRef ? "int*" : IntPtr
    ...
    drvDeviceCommand(__MIDL__IWiaMiniDrv0043, __MIDL__IWiaMiniDrv0044, __MIDL__IWiaMiniDrv0045, __MIDL__IWiaMiniDrv0046, __MIDL__IWiaMiniDrv0047) {
        __MIDL__IWiaMiniDrv0043Marshal := __MIDL__IWiaMiniDrv0043 is VarRef ? "char*" : IntPtr
        __MIDL__IWiaMiniDrv0047Marshal := __MIDL__IWiaMiniDrv0047 is VarRef ? "int*" : IntPtr
    ...
    drvGetCapabilities(__MIDL__IWiaMiniDrv0048, __MIDL__IWiaMiniDrv0049, __MIDL__IWiaMiniDrv0050, __MIDL__IWiaMiniDrv0051, __MIDL__IWiaMiniDrv0052) {
        __MIDL__IWiaMiniDrv0048Marshal := __MIDL__IWiaMiniDrv0048 is VarRef ? "char*" : IntPtr
        __MIDL__IWiaMiniDrv0050Marshal := __MIDL__IWiaMiniDrv0050 is VarRef ? "int*" : IntPtr
        __MIDL__IWiaMiniDrv0051Marshal := __MIDL__IWiaMiniDrv0051 is VarRef ? "ptr*" : IntPtr
        __MIDL__IWiaMiniDrv0052Marshal := __MIDL__IWiaMiniDrv0052 is VarRef ? "int*" : IntPtr
    ...
    drvDeleteItem(__MIDL__IWiaMiniDrv0053, __MIDL__IWiaMiniDrv0054) {
        __MIDL__IWiaMiniDrv0053Marshal := __MIDL__IWiaMiniDrv0053 is VarRef ? "char*" : IntPtr
    ...
    drvFreeDrvItemContext(__MIDL__IWiaMiniDrv0056, __MIDL__IWiaMiniDrv0057) {
        __MIDL__IWiaMiniDrv0057Marshal := __MIDL__IWiaMiniDrv0057 is VarRef ? "char*" : IntPtr
    ...
    drvGetWiaFormatInfo(__MIDL__IWiaMiniDrv0059, __MIDL__IWiaMiniDrv0060, __MIDL__IWiaMiniDrv0061, __MIDL__IWiaMiniDrv0062, __MIDL__IWiaMiniDrv0063) {
        __MIDL__IWiaMiniDrv0059Marshal := __MIDL__IWiaMiniDrv0059 is VarRef ? "char*" : IntPtr
        __MIDL__IWiaMiniDrv0061Marshal := __MIDL__IWiaMiniDrv0061 is VarRef ? "int*" : IntPtr
        __MIDL__IWiaMiniDrv0062Marshal := __MIDL__IWiaMiniDrv0062 is VarRef ? "ptr*" : IntPtr
        __MIDL__IWiaMiniDrv0063Marshal := __MIDL__IWiaMiniDrv0063 is VarRef ? "int*" : IntPtr
    ...
    drvUnInitializeWia(__MIDL__IWiaMiniDrv0064) {
        __MIDL__IWiaMiniDrv0064Marshal := __MIDL__IWiaMiniDrv0064 is VarRef ? "char*" : IntPtr
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.drvInitializeWia := CallbackCreate(ObjBindMethod(implObj, "drvInitializeWia"), flags, 10)
        this.vtbl.drvAcquireItemData := CallbackCreate(ObjBindMethod(implObj, "drvAcquireItemData"), flags, 5)
        this.vtbl.drvInitItemProperties := CallbackCreate(ObjBindMethod(implObj, "drvInitItemProperties"), flags, 4)
        this.vtbl.drvValidateItemProperties := CallbackCreate(ObjBindMethod(implObj, "drvValidateItemProperties"), flags, 6)
        this.vtbl.drvWriteItemProperties := CallbackCreate(ObjBindMethod(implObj, "drvWriteItemProperties"), flags, 5)
        this.vtbl.drvReadItemProperties := CallbackCreate(ObjBindMethod(implObj, "drvReadItemProperties"), flags, 6)
        this.vtbl.drvLockWiaDevice := CallbackCreate(ObjBindMethod(implObj, "drvLockWiaDevice"), flags, 4)
        this.vtbl.drvUnLockWiaDevice := CallbackCreate(ObjBindMethod(implObj, "drvUnLockWiaDevice"), flags, 4)
        this.vtbl.drvAnalyzeItem := CallbackCreate(ObjBindMethod(implObj, "drvAnalyzeItem"), flags, 4)
        this.vtbl.drvGetDeviceErrorStr := CallbackCreate(ObjBindMethod(implObj, "drvGetDeviceErrorStr"), flags, 5)
        this.vtbl.drvDeviceCommand := CallbackCreate(ObjBindMethod(implObj, "drvDeviceCommand"), flags, 6)
        this.vtbl.drvGetCapabilities := CallbackCreate(ObjBindMethod(implObj, "drvGetCapabilities"), flags, 6)
        this.vtbl.drvDeleteItem := CallbackCreate(ObjBindMethod(implObj, "drvDeleteItem"), flags, 4)
        this.vtbl.drvFreeDrvItemContext := CallbackCreate(ObjBindMethod(implObj, "drvFreeDrvItemContext"), flags, 4)
        this.vtbl.drvGetWiaFormatInfo := CallbackCreate(ObjBindMethod(implObj, "drvGetWiaFormatInfo"), flags, 6)
        this.vtbl.drvNotifyPnpEvent := CallbackCreate(ObjBindMethod(implObj, "drvNotifyPnpEvent"), flags, 4)
        this.vtbl.drvUnInitializeWia := CallbackCreate(ObjBindMethod(implObj, "drvUnInitializeWia"), flags, 2)
    }
