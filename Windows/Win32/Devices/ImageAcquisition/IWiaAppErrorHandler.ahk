 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaapperrorhandler
...
class IWiaAppErrorHandler extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaapperrorhandler-getwindow
     */
    GetWindow() {
        phwnd := HWND()
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wia/-wia-iwiaapperrorhandler-reportstatus
     */
