 ...
 * </tr>
 * </table>
 * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nn-wiavideo-iwiavideo
...
class IWiaVideo extends IUnknown{
     ...
     * @returns {BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-get_previewvisible
     */
    get_PreviewVisible() {
        result := ComCall(3, this, "int*", &pbPreviewVisible := 0, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-put_previewvisible
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-get_imagesdirectory
     */
    get_ImagesDirectory() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-put_imagesdirectory
     */
    put_ImagesDirectory(bstrImageDirectory) {
        if(bstrImageDirectory is String) {
            pin := BSTR.Alloc(bstrImageDirectory)
            bstrImageDirectory := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-createvideobywiadevid
     */
    CreateVideoByWiaDevID(bstrWiaDeviceID, hwndParent, bStretchToFitParent, bAutoBeginPlayback) {
        if(bstrWiaDeviceID is String) {
            pin := BSTR.Alloc(bstrWiaDeviceID)
            bstrWiaDeviceID := pin.Value
        }
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-createvideobydevnum
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-createvideobyname
     */
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-destroyvideo
     */
    DestroyVideo() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-play
     */
    Play() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-pause
     */
    Pause() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-takepicture
     */
    TakePicture() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-resizevideo
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wiavideo/nf-wiavideo-iwiavideo-getcurrentstate
     */
    GetCurrentState() {
        result := ComCall(15, this, "int*", &pState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
