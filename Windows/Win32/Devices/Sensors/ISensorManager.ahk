 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nn-sensorsapi-isensormanager
...
class ISensorManager extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nf-sensorsapi-isensormanager-getsensorsbycategory
     */
    GetSensorsByCategory(sensorCategory) {
        result := ComCall(3, this, "ptr", sensorCategory, "ptr*", &ppSensorsFound := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nf-sensorsapi-isensormanager-getsensorsbytype
     */
    GetSensorsByType(sensorType) {
        result := ComCall(4, this, "ptr", sensorType, "ptr*", &ppSensorsFound := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nf-sensorsapi-isensormanager-getsensorbyid
     */
    GetSensorByID(sensorID) {
        result := ComCall(5, this, "ptr", sensorID, "ptr*", &ppSensor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nf-sensorsapi-isensormanager-seteventsink
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/sensorsapi/nf-sensorsapi-isensormanager-requestpermissions
     */
