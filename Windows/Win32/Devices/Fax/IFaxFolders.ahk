 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxfolders
...
class IFaxFolders extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxfolders-get_outgoingqueue
     */
    get_OutgoingQueue() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxfolders-get_incomingqueue
     */
    get_IncomingQueue() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxfolders-get_incomingarchive
     */
    get_IncomingArchive() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxfolders-get_outgoingarchive
     */
    get_OutgoingArchive() {
