...
export default struct IFaxDevice extends IDispatch {
    ...
    */
    ...
    put_RingsBeforeAnswer(lRingsBeforeAnswer) {
        result := ComCall(21, this, Int32, lRingsBeforeAnswer, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ProviderUniqueName := CallbackCreate(ObjBindMethod(implObj, "get_ProviderUniqueName"), flags, 2)
        this.vtbl.get_PoweredOff := CallbackCreate(ObjBindMethod(implObj, "get_PoweredOff"), flags, 2)
        this.vtbl.get_ReceivingNow := CallbackCreate(ObjBindMethod(implObj, "get_ReceivingNow"), flags, 2)
        this.vtbl.get_SendingNow := CallbackCreate(ObjBindMethod(implObj, "get_SendingNow"), flags, 2)
        this.vtbl.get_UsedRoutingMethods := CallbackCreate(ObjBindMethod(implObj, "get_UsedRoutingMethods"), flags, 2)
        ...
        this.vtbl.get_SendEnabled := CallbackCreate(ObjBindMethod(implObj, "get_SendEnabled"), flags, 2)
        this.vtbl.put_SendEnabled := CallbackCreate(ObjBindMethod(implObj, "put_SendEnabled"), flags, 2)
        this.vtbl.get_ReceiveMode := CallbackCreate(ObjBindMethod(implObj, "get_ReceiveMode"), flags, 2)
        this.vtbl.put_ReceiveMode := CallbackCreate(ObjBindMethod(implObj, "put_ReceiveMode"), flags, 2)
        this.vtbl.get_RingsBeforeAnswer := CallbackCreate(ObjBindMethod(implObj, "get_RingsBeforeAnswer"), flags, 2)
        this.vtbl.put_RingsBeforeAnswer := CallbackCreate(ObjBindMethod(implObj, "put_RingsBeforeAnswer"), flags, 2)
        this.vtbl.get_CSID := CallbackCreate(ObjBindMethod(implObj, "get_CSID"), flags, 2)
        this.vtbl.put_CSID := CallbackCreate(ObjBindMethod(implObj, "put_CSID"), flags, 2)
        ...
        this.vtbl.UseRoutingMethod := CallbackCreate(ObjBindMethod(implObj, "UseRoutingMethod"), flags, 3)
        this.vtbl.get_RingingNow := CallbackCreate(ObjBindMethod(implObj, "get_RingingNow"), flags, 2)
        this.vtbl.AnswerCall := CallbackCreate(ObjBindMethod(implObj, "AnswerCall"), flags, 1)
    }
