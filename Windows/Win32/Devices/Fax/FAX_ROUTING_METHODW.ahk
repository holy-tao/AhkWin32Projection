...
/**
 * The FAX_ROUTING_METHOD structure contains information about one fax routing method, as it pertains to one fax device. (Unicode)
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winfax/ns-winfax-fax_routing_methodw
 * @namespace Windows.Win32.Devices.Fax
 * @version v4.0.30319
 * @charset Unicode
 */
class FAX_ROUTING_METHODW extends Win32Struct
{
    static sizeof => 64
