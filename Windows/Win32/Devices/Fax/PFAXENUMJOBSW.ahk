 ...
 * @charset Unicode
 */
class PFAXENUMJOBSW extends IUnknown {
     ...
     */
    Invoke(FaxHandle, JobEntry, JobsReturned) {
        ...
        result := ComCall(3, this, "ptr", FaxHandle, JobEntryMarshal, JobEntry, JobsReturnedMarshal, JobsReturned, "int")
        return result
    }
}
