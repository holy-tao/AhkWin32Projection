 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxincomingmessage2
...
class IFaxIncomingMessage2 extends IFaxIncomingMessage{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_subject
     */
    get_Subject() {
        pbstrSubject := BSTR()
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_subject
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_sendername
     */
    get_SenderName() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_sendername
     */
    put_SenderName(bstrSenderName) {
        if(bstrSenderName is String) {
            pin := BSTR.Alloc(bstrSenderName)
            bstrSenderName := pin.Value
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_senderfaxnumber
     */
    get_SenderFaxNumber() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_senderfaxnumber
     */
    put_SenderFaxNumber(bstrSenderFaxNumber) {
        if(bstrSenderFaxNumber is String) {
            pin := BSTR.Alloc(bstrSenderFaxNumber)
            bstrSenderFaxNumber := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_hascoverpage
     */
    get_HasCoverPage() {
        result := ComCall(26, this, "short*", &pbHasCoverPage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_hascoverpage
     */
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_recipients
     */
    get_Recipients() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_recipients
     */
    put_Recipients(bstrRecipients) {
        if(bstrRecipients is String) {
            pin := BSTR.Alloc(bstrRecipients)
            bstrRecipients := pin.Value
        }
     ...
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_wasreassigned
     */
    get_WasReAssigned() {
        result := ComCall(30, this, "short*", &pbWasReAssigned := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * A change to this value is not committed to the server until <a href="https://docs.microsoft.com/previous-versions/windows/desktop/fax/-mfax-faxincomingmessage-save-vb">IFaxIncomingMessage2::Save</a> is called.
     * @returns {VARIANT_BOOL} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-get_read
     */
    get_Read() {
        result := ComCall(31, this, "short*", &pbRead := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-put_read
     */
    put_Read(bRead) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-reassign
     */
    ReAssign() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-save
     */
    Save() {
     ...
     * 
     * If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxincomingmessage2-refresh
     */
    Refresh() {
