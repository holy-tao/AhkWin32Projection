...
export default struct IFaxIncomingMessage2 extends IFaxIncomingMessage {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_SenderName := CallbackCreate(ObjBindMethod(implObj, "get_SenderName"), flags, 2)
        this.vtbl.put_SenderName := CallbackCreate(ObjBindMethod(implObj, "put_SenderName"), flags, 2)
        this.vtbl.get_SenderFaxNumber := CallbackCreate(ObjBindMethod(implObj, "get_SenderFaxNumber"), flags, 2)
        this.vtbl.put_SenderFaxNumber := CallbackCreate(ObjBindMethod(implObj, "put_SenderFaxNumber"), flags, 2)
        this.vtbl.get_HasCoverPage := CallbackCreate(ObjBindMethod(implObj, "get_HasCoverPage"), flags, 2)
        this.vtbl.put_HasCoverPage := CallbackCreate(ObjBindMethod(implObj, "put_HasCoverPage"), flags, 2)
        this.vtbl.get_Recipients := CallbackCreate(ObjBindMethod(implObj, "get_Recipients"), flags, 2)
        this.vtbl.put_Recipients := CallbackCreate(ObjBindMethod(implObj, "put_Recipients"), flags, 2)
        this.vtbl.get_WasReAssigned := CallbackCreate(ObjBindMethod(implObj, "get_WasReAssigned"), flags, 2)
        ...
        this.vtbl.ReAssign := CallbackCreate(ObjBindMethod(implObj, "ReAssign"), flags, 1)
