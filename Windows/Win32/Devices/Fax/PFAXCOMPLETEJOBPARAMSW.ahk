 ...
 * @charset Unicode
 */
class PFAXCOMPLETEJOBPARAMSW extends IUnknown {
     ...
     */
    Invoke(JobParams, CoverpageInfo) {
        JobParamsMarshal := JobParams is VarRef ? "ptr*" : "ptr"
        CoverpageInfoMarshal := CoverpageInfo is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, JobParamsMarshal, JobParams, CoverpageInfoMarshal, CoverpageInfo, "int")
        return result
    }
}
