 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxaccountincomingqueue
...
class IFaxAccountIncomingQueue extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountincomingqueue-getjobs
     */
    GetJobs() {
        result := ComCall(7, this, "ptr*", &pFaxIncomingJobs := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountincomingqueue-getjob
     */
    GetJob(bstrJobId) {
        ...
        result := ComCall(8, this, "ptr", bstrJobId, "ptr*", &pFaxIncomingJob := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
