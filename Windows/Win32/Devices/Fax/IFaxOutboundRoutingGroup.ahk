 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxoutboundroutinggroup
...
class IFaxOutboundRoutingGroup extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxoutboundroutinggroup-get_name
     */
    get_Name() {
        pbstrName := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxoutboundroutinggroup-get_status
     */
    get_Status() {
        result := ComCall(8, this, "int*", &pStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxoutboundroutinggroup-get_deviceids
     */
    get_DeviceIds() {
        result := ComCall(9, this, "ptr*", &pFaxDeviceIds := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
