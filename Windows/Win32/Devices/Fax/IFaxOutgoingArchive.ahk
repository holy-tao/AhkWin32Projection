...
export default struct IFaxOutgoingArchive extends IDispatch {
    ...
    */
     ...
     * @see https://learn.microsoft.com/windows/win32/api/faxcomex/nf-faxcomex-ifaxoutgoingarchive-getmessage
     */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ArchiveFolder := CallbackCreate(ObjBindMethod(implObj, "get_ArchiveFolder"), flags, 2)
        this.vtbl.put_ArchiveFolder := CallbackCreate(ObjBindMethod(implObj, "put_ArchiveFolder"), flags, 2)
        ...
        this.vtbl.get_AgeLimit := CallbackCreate(ObjBindMethod(implObj, "get_AgeLimit"), flags, 2)
        this.vtbl.put_AgeLimit := CallbackCreate(ObjBindMethod(implObj, "put_AgeLimit"), flags, 2)
