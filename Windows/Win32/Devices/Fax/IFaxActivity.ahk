 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxactivity
...
class IFaxActivity extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxactivity-get_incomingmessages
     */
    get_IncomingMessages() {
        result := ComCall(7, this, "int*", &plIncomingMessages := 0, "int")
        if(result != 0) {
     ...
     * To read this property, a user must have the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/faxcomex/ne-faxcomex-fax_access_rights_enum">farQUERY_CONFIG</a> access right.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxactivity-get_routingmessages
     */
    get_RoutingMessages() {
        result := ComCall(8, this, "int*", &plRoutingMessages := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * To read this property, a user must have the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/faxcomex/ne-faxcomex-fax_access_rights_enum">farQUERY_CONFIG</a> access right.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxactivity-get_outgoingmessages
     */
    get_OutgoingMessages() {
        result := ComCall(9, this, "int*", &plOutgoingMessages := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * To read this property, a user must have the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/faxcomex/ne-faxcomex-fax_access_rights_enum">farQUERY_CONFIG</a> access right.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxactivity-get_queuedmessages
     */
    get_QueuedMessages() {
        result := ComCall(10, this, "int*", &plQueuedMessages := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxactivity-refresh
     */
    Refresh() {
