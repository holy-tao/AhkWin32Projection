 ...
 * @charset Unicode
 */
export default struct PFAXCONNECTFAXSERVERW {
    value : IntPtr

    __value {
        set {
            if (value is PFAXCONNECTFAXSERVERW) {
    ...
    /**
     * A PFAXCONNECTFAXSERVERW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFAXCONNECTFAXSERVERW {
        /**
         * Creates a PFAXCONNECTFAXSERVERW pointer that invokes the given AHK function when called.
