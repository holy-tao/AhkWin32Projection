 ...
 * @charset ANSI
 */
class PFAXENUMROUTINGMETHODSA extends IUnknown {
     ...
     */
    Invoke(FaxPortHandle, RoutingMethod, MethodsReturned) {
        ...
        result := ComCall(3, this, "ptr", FaxPortHandle, RoutingMethodMarshal, RoutingMethod, MethodsReturnedMarshal, MethodsReturned, "int")
        return result
    }
}
