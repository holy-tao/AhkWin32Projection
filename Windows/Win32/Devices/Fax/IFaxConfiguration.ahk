...
export default struct IFaxConfiguration extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_UseArchive := CallbackCreate(ObjBindMethod(implObj, "get_UseArchive"), flags, 2)
        this.vtbl.put_UseArchive := CallbackCreate(ObjBindMethod(implObj, "put_UseArchive"), flags, 2)
        this.vtbl.get_ArchiveLocation := CallbackCreate(ObjBindMethod(implObj, "get_ArchiveLocation"), flags, 2)
        this.vtbl.put_ArchiveLocation := CallbackCreate(ObjBindMethod(implObj, "put_ArchiveLocation"), flags, 2)
        this.vtbl.get_SizeQuotaWarning := CallbackCreate(ObjBindMethod(implObj, "get_SizeQuotaWarning"), flags, 2)
        this.vtbl.put_SizeQuotaWarning := CallbackCreate(ObjBindMethod(implObj, "put_SizeQuotaWarning"), flags, 2)
        this.vtbl.get_HighQuotaWaterMark := CallbackCreate(ObjBindMethod(implObj, "get_HighQuotaWaterMark"), flags, 2)
        this.vtbl.put_HighQuotaWaterMark := CallbackCreate(ObjBindMethod(implObj, "put_HighQuotaWaterMark"), flags, 2)
        this.vtbl.get_LowQuotaWaterMark := CallbackCreate(ObjBindMethod(implObj, "get_LowQuotaWaterMark"), flags, 2)
        this.vtbl.put_LowQuotaWaterMark := CallbackCreate(ObjBindMethod(implObj, "put_LowQuotaWaterMark"), flags, 2)
        this.vtbl.get_ArchiveAgeLimit := CallbackCreate(ObjBindMethod(implObj, "get_ArchiveAgeLimit"), flags, 2)
        this.vtbl.put_ArchiveAgeLimit := CallbackCreate(ObjBindMethod(implObj, "put_ArchiveAgeLimit"), flags, 2)
        this.vtbl.get_ArchiveSizeLow := CallbackCreate(ObjBindMethod(implObj, "get_ArchiveSizeLow"), flags, 2)
        this.vtbl.get_ArchiveSizeHigh := CallbackCreate(ObjBindMethod(implObj, "get_ArchiveSizeHigh"), flags, 2)
        this.vtbl.get_OutgoingQueueBlocked := CallbackCreate(ObjBindMethod(implObj, "get_OutgoingQueueBlocked"), flags, 2)
        this.vtbl.put_OutgoingQueueBlocked := CallbackCreate(ObjBindMethod(implObj, "put_OutgoingQueueBlocked"), flags, 2)
        this.vtbl.get_OutgoingQueuePaused := CallbackCreate(ObjBindMethod(implObj, "get_OutgoingQueuePaused"), flags, 2)
        this.vtbl.put_OutgoingQueuePaused := CallbackCreate(ObjBindMethod(implObj, "put_OutgoingQueuePaused"), flags, 2)
        this.vtbl.get_AllowPersonalCoverPages := CallbackCreate(ObjBindMethod(implObj, "get_AllowPersonalCoverPages"), flags, 2)
        this.vtbl.put_AllowPersonalCoverPages := CallbackCreate(ObjBindMethod(implObj, "put_AllowPersonalCoverPages"), flags, 2)
        this.vtbl.get_UseDeviceTSID := CallbackCreate(ObjBindMethod(implObj, "get_UseDeviceTSID"), flags, 2)
        this.vtbl.put_UseDeviceTSID := CallbackCreate(ObjBindMethod(implObj, "put_UseDeviceTSID"), flags, 2)
        this.vtbl.get_Retries := CallbackCreate(ObjBindMethod(implObj, "get_Retries"), flags, 2)
        this.vtbl.put_Retries := CallbackCreate(ObjBindMethod(implObj, "put_Retries"), flags, 2)
        this.vtbl.get_RetryDelay := CallbackCreate(ObjBindMethod(implObj, "get_RetryDelay"), flags, 2)
        this.vtbl.put_RetryDelay := CallbackCreate(ObjBindMethod(implObj, "put_RetryDelay"), flags, 2)
        this.vtbl.get_DiscountRateStart := CallbackCreate(ObjBindMethod(implObj, "get_DiscountRateStart"), flags, 2)
        this.vtbl.put_DiscountRateStart := CallbackCreate(ObjBindMethod(implObj, "put_DiscountRateStart"), flags, 2)
        this.vtbl.get_DiscountRateEnd := CallbackCreate(ObjBindMethod(implObj, "get_DiscountRateEnd"), flags, 2)
        this.vtbl.put_DiscountRateEnd := CallbackCreate(ObjBindMethod(implObj, "put_DiscountRateEnd"), flags, 2)
        this.vtbl.get_OutgoingQueueAgeLimit := CallbackCreate(ObjBindMethod(implObj, "get_OutgoingQueueAgeLimit"), flags, 2)
        this.vtbl.put_OutgoingQueueAgeLimit := CallbackCreate(ObjBindMethod(implObj, "put_OutgoingQueueAgeLimit"), flags, 2)
        this.vtbl.get_Branding := CallbackCreate(ObjBindMethod(implObj, "get_Branding"), flags, 2)
        this.vtbl.put_Branding := CallbackCreate(ObjBindMethod(implObj, "put_Branding"), flags, 2)
        this.vtbl.get_IncomingQueueBlocked := CallbackCreate(ObjBindMethod(implObj, "get_IncomingQueueBlocked"), flags, 2)
        this.vtbl.put_IncomingQueueBlocked := CallbackCreate(ObjBindMethod(implObj, "put_IncomingQueueBlocked"), flags, 2)
        this.vtbl.get_AutoCreateAccountOnConnect := CallbackCreate(ObjBindMethod(implObj, "get_AutoCreateAccountOnConnect"), flags, 2)
        this.vtbl.put_AutoCreateAccountOnConnect := CallbackCreate(ObjBindMethod(implObj, "put_AutoCreateAccountOnConnect"), flags, 2)
        this.vtbl.get_IncomingFaxesArePublic := CallbackCreate(ObjBindMethod(implObj, "get_IncomingFaxesArePublic"), flags, 2)
        this.vtbl.put_IncomingFaxesArePublic := CallbackCreate(ObjBindMethod(implObj, "put_IncomingFaxesArePublic"), flags, 2)
