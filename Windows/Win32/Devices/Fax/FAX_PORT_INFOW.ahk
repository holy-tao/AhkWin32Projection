...
/**
 * The FAX_PORT_INFO structure describes one fax port. The data includes, among other items, a device identifier, the port's name and current status, and station identifiers. (Unicode)
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winfax/ns-winfax-fax_port_infow
 * @namespace Windows.Win32.Devices.Fax
 * @version v4.0.30319
 * @charset Unicode
 */
class FAX_PORT_INFOW extends Win32Struct
{
    static sizeof => 48
