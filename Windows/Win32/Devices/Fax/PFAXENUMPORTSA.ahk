 ...
 * @charset ANSI
 */
class PFAXENUMPORTSA extends IUnknown {
     ...
     */
    Invoke(FaxHandle, PortInfo, PortsReturned) {
        ...
        result := ComCall(3, this, "ptr", FaxHandle, PortInfoMarshal, PortInfo, PortsReturnedMarshal, PortsReturned, "int")
        return result
    }
}
