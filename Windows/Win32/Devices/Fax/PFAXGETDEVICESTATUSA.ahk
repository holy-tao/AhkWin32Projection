 ...
 * @charset ANSI
 */
class PFAXGETDEVICESTATUSA extends IUnknown {
     ...
     */
    Invoke(FaxPortHandle, DeviceStatus) {
        ...
        result := ComCall(3, this, "ptr", FaxPortHandle, DeviceStatusMarshal, DeviceStatus, "int")
        return result
    }
}
