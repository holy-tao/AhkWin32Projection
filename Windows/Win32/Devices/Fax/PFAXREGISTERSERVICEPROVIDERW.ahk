 ...
 * @version v4.0.30319
 */
class PFAXREGISTERSERVICEPROVIDERW extends IUnknown {
     ...
     */
    Invoke(DeviceProvider, FriendlyName, ImageName, TspName) {
        ...
        result := ComCall(3, this, "ptr", DeviceProvider, "ptr", FriendlyName, "ptr", ImageName, "ptr", TspName, "int")
        return result
    }
}
