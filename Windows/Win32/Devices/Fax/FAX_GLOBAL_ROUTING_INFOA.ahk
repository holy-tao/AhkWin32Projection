...
/**
 * The FAX_GLOBAL_ROUTING_INFO structure contains information about one fax routing method, as it pertains globally to the fax service.
 * @remarks
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winfax/ns-winfax-fax_global_routing_infoa
 * @namespace Windows.Win32.Devices.Fax
 * @version v4.0.30319
 * @charset ANSI
 */
class FAX_GLOBAL_ROUTING_INFOA extends Win32Struct
{
    static sizeof => 48
