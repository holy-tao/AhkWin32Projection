 ...
 * @charset Unicode
 */
class PFAXENABLEROUTINGMETHODW extends IUnknown {
     ...
     */
    Invoke(FaxPortHandle, RoutingGuid, Enabled) {
        ...
        result := ComCall(3, this, "ptr", FaxPortHandle, "ptr", RoutingGuid, "int", Enabled, "int")
        return result
    }
}
