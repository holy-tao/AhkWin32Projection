 ...
 * @charset ANSI
 */
class PFAXSTARTPRINTJOBA extends IUnknown {
     ...
     */
    Invoke(PrinterName, PrintInfo, FaxJobId, FaxContextInfo) {
        PrinterName := PrinterName is String ? StrPtr(PrinterName) : PrinterName

        FaxJobIdMarshal := FaxJobId is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", PrinterName, "ptr", PrintInfo, FaxJobIdMarshal, FaxJobId, "ptr", FaxContextInfo, "int")
        return result
    }
}
