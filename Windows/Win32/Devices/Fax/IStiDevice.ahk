...
class IStiDevice extends IUnknown{
    ...
    Initialize(hinst, pwszDeviceName, dwVersion, dwMode) {
        ...
        result := ComCall(3, this, "ptr", hinst, "ptr", pwszDeviceName, "uint", dwVersion, "uint", dwMode, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/sql/ocs/docs/relational-databases/native-client-odbc-error-messages/diagnostic-records-and-fields
     */
    Diagnostic(pBuffer) {
    ...
    Escape(EscapeFunction, lpInData, cbInDataSize, pOutData, dwOutDataSize) {
        result := ComCall(8, this, "uint", EscapeFunction, "ptr", lpInData, "uint", cbInDataSize, "ptr", pOutData, "uint", dwOutDataSize, "uint*", &pdwActualData := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     */
    GetLastError() {
        result := ComCall(9, this, "uint*", &pdwLastDeviceError := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    LockDevice(dwTimeOut) {
        result := ComCall(10, this, "uint", dwTimeOut, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    RawReadData(lpBuffer, lpdwNumberOfBytes, lpOverlapped) {
        ...
        result := ComCall(12, this, "ptr", lpBuffer, lpdwNumberOfBytesMarshal, lpdwNumberOfBytes, "ptr", lpOverlapped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    RawReadCommand(lpBuffer, lpdwNumberOfBytes, lpOverlapped) {
        ...
        result := ComCall(14, this, "ptr", lpBuffer, lpdwNumberOfBytesMarshal, lpdwNumberOfBytes, "ptr", lpOverlapped, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/activitycoordinator/nf-activitycoordinator-subscribeactivitycoordinatorpolicy
     */
    Subscribe(lpSubsribe) {
        result := ComCall(16, this, "ptr", lpSubsribe, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetLastErrorInfo() {
        ...
        result := ComCall(19, this, "ptr", pLastErrorInfo, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
