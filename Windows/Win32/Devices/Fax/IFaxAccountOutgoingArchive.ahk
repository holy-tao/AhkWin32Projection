 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxaccountoutgoingarchive
...
class IFaxAccountOutgoingArchive extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingarchive-get_sizelow
     */
    get_SizeLow() {
     ...
     * To read this property, a user must have the <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/faxcomex/ne-faxcomex-fax_access_rights_enum_2">far2QUERY_CONFIG</a> access right.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingarchive-get_sizehigh
     */
    get_SizeHigh() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingarchive-refresh
     */
    Refresh() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingarchive-getmessages
     */
    GetMessages(lPrefetchSize) {
        result := ComCall(10, this, "int", lPrefetchSize, "ptr*", &pFaxOutgoingMessageIterator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingarchive-getmessage
     */
    GetMessage(bstrMessageId) {
        ...
        result := ComCall(11, this, "ptr", bstrMessageId, "ptr*", &pFaxOutgoingMessage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
