 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxdeviceprovider
...
class IFaxDeviceProvider extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_friendlyname
     */
    get_FriendlyName() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_imagename
     */
    get_ImageName() {
        pbstrImageName := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_uniquename
     */
    get_UniqueName() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_tapiprovidername
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_majorversion
     */
    get_MajorVersion() {
        result := ComCall(11, this, "int*", &plMajorVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The standard format for version numbers is MajorVersion.MinorVersion.MajorBuild.MinorBuild.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_minorversion
     */
    get_MinorVersion() {
        result := ComCall(12, this, "int*", &plMinorVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_majorbuild
     */
    get_MajorBuild() {
        result := ComCall(13, this, "int*", &plMajorBuild := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The standard format for build numbers is MajorVersion.MinorVersion.MajorBuild.MinorBuild.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_minorbuild
     */
    get_MinorBuild() {
        result := ComCall(14, this, "int*", &plMinorBuild := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_debug
     */
    get_Debug() {
        result := ComCall(15, this, "short*", &pbDebug := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_status
     */
    get_Status() {
        result := ComCall(16, this, "int*", &pStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_initerrorcode
     */
    get_InitErrorCode() {
        result := ComCall(17, this, "int*", &plInitErrorCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxdeviceprovider-get_deviceids
     */
    get_DeviceIds() {
        pvDeviceIds := VARIANT()
