 ...
 * @charset Unicode
 */
class PFAXSENDDOCUMENTFORBROADCASTW extends IUnknown {
     ...
     */
    Invoke(FaxHandle, FileName, FaxJobId, FaxRecipientCallback, Context_) {
        ...
        result := ComCall(3, this, "ptr", FaxHandle, "ptr", FileName, FaxJobIdMarshal, FaxJobId, "ptr", FaxRecipientCallback, Context_Marshal, Context_, "int")
        return result
    }
}
