 ...
 */
export default struct IFaxDeviceIds extends IDispatch {
    /**
     ...
     * used for IFaxDeviceIds interfaces
    */
    ...
    _Query(iid) {
        if (IFaxDeviceIds.IID.Equals(iid)) {
            return true
        }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetOrder := CallbackCreate(ObjBindMethod(implObj, "SetOrder"), flags, 3)
    }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.SetOrder)
    }
}
