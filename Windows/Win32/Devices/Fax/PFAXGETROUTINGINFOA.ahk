 ...
 * @charset ANSI
 */
class PFAXGETROUTINGINFOA extends IUnknown {
     ...
     */
    Invoke(FaxPortHandle, RoutingGuid, RoutingInfoBuffer, RoutingInfoBufferSize) {
        ...
        result := ComCall(3, this, "ptr", FaxPortHandle, "ptr", RoutingGuid, RoutingInfoBufferMarshal, RoutingInfoBuffer, RoutingInfoBufferSizeMarshal, RoutingInfoBufferSize, "int")
        return result
    }
}
