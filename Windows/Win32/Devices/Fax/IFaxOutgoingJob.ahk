...
export default struct IFaxOutgoingJob extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_OriginalScheduledTime := CallbackCreate(ObjBindMethod(implObj, "get_OriginalScheduledTime"), flags, 2)
        ...
        this.vtbl.get_Recipient := CallbackCreate(ObjBindMethod(implObj, "get_Recipient"), flags, 2)
        ...
        this.vtbl.get_ExtendedStatusCode := CallbackCreate(ObjBindMethod(implObj, "get_ExtendedStatusCode"), flags, 2)
        this.vtbl.get_ExtendedStatus := CallbackCreate(ObjBindMethod(implObj, "get_ExtendedStatus"), flags, 2)
        this.vtbl.get_AvailableOperations := CallbackCreate(ObjBindMethod(implObj, "get_AvailableOperations"), flags, 2)
        this.vtbl.get_Retries := CallbackCreate(ObjBindMethod(implObj, "get_Retries"), flags, 2)
        this.vtbl.get_ScheduledTime := CallbackCreate(ObjBindMethod(implObj, "get_ScheduledTime"), flags, 2)
        ...
        this.vtbl.Restart := CallbackCreate(ObjBindMethod(implObj, "Restart"), flags, 1)
