 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxinboundroutingextension
...
class IFaxInboundRoutingExtension extends IDispatch{
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_friendlyname
     */
    get_FriendlyName() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_imagename
     */
    get_ImageName() {
        pbstrImageName := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_uniquename
     */
    get_UniqueName() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_majorversion
     */
    get_MajorVersion() {
        result := ComCall(10, this, "int*", &plMajorVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The standard format for build numbers is MajorVersion.MinorVersion.MajorBuild.MinorBuild.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_minorversion
     */
    get_MinorVersion() {
        result := ComCall(11, this, "int*", &plMinorVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The standard format for build numbers is MajorVersion.MinorVersion.MajorBuild.MinorBuild.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_majorbuild
     */
    get_MajorBuild() {
        result := ComCall(12, this, "int*", &plMajorBuild := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * The standard format for build numbers is MajorVersion.MinorVersion.MajorBuild.MinorBuild.
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_minorbuild
     */
    get_MinorBuild() {
        result := ComCall(13, this, "int*", &plMinorBuild := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_debug
     */
    get_Debug() {
        result := ComCall(14, this, "short*", &pbDebug := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_status
     */
    get_Status() {
        result := ComCall(15, this, "int*", &pStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_initerrorcode
     */
    get_InitErrorCode() {
        result := ComCall(16, this, "int*", &plInitErrorCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {VARIANT} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxinboundroutingextension-get_methods
     */
    get_Methods() {
        pvMethods := VARIANT()
