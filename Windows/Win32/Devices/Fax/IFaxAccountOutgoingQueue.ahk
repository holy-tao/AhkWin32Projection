 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxaccountoutgoingqueue
...
class IFaxAccountOutgoingQueue extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingqueue-getjobs
     */
    GetJobs() {
        result := ComCall(7, this, "ptr*", &pFaxOutgoingJobs := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxaccountoutgoingqueue-getjob
     */
    GetJob(bstrJobId) {
        ...
        result := ComCall(8, this, "ptr", bstrJobId, "ptr*", &pFaxOutgoingJob := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
