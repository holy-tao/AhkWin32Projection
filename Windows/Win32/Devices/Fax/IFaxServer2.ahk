 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxserver2
...
class IFaxServer2 extends IFaxServer{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxserver2-get_configuration
     */
    get_Configuration() {
        result := ComCall(33, this, "ptr*", &ppFaxConfiguration := 0, "int")
        if(result != 0) {
     ...
     * @returns {IFaxAccount} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxserver2-get_currentaccount
     */
    get_CurrentAccount() {
        result := ComCall(34, this, "ptr*", &ppCurrentAccount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxserver2-get_faxaccountset
     */
    get_FaxAccountSet() {
        result := ComCall(35, this, "ptr*", &ppFaxAccountSet := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxserver2-get_security2
     */
    get_Security2() {
        result := ComCall(36, this, "ptr*", &ppFaxSecurity2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
