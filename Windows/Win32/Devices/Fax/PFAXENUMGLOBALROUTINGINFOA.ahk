 ...
 * @charset ANSI
 */
class PFAXENUMGLOBALROUTINGINFOA extends IUnknown {
     ...
     */
    Invoke(FaxHandle, RoutingInfo, MethodsReturned) {
        ...
        result := ComCall(3, this, "ptr", FaxHandle, RoutingInfoMarshal, RoutingInfo, MethodsReturnedMarshal, MethodsReturned, "int")
        return result
    }
}
