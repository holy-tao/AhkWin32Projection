...
export default struct IFaxReceiptOptions extends IDispatch {
    ...
    */
    ...
    put_SMTPPort(lSMTPPort) {
        result := ComCall(12, this, Int32, lSMTPPort, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_SMTPPort := CallbackCreate(ObjBindMethod(implObj, "get_SMTPPort"), flags, 2)
        this.vtbl.put_SMTPPort := CallbackCreate(ObjBindMethod(implObj, "put_SMTPPort"), flags, 2)
        this.vtbl.get_SMTPSender := CallbackCreate(ObjBindMethod(implObj, "get_SMTPSender"), flags, 2)
        this.vtbl.put_SMTPSender := CallbackCreate(ObjBindMethod(implObj, "put_SMTPSender"), flags, 2)
        this.vtbl.get_SMTPUser := CallbackCreate(ObjBindMethod(implObj, "get_SMTPUser"), flags, 2)
        this.vtbl.put_SMTPUser := CallbackCreate(ObjBindMethod(implObj, "put_SMTPUser"), flags, 2)
        this.vtbl.get_AllowedReceipts := CallbackCreate(ObjBindMethod(implObj, "get_AllowedReceipts"), flags, 2)
        this.vtbl.put_AllowedReceipts := CallbackCreate(ObjBindMethod(implObj, "put_AllowedReceipts"), flags, 2)
        this.vtbl.get_SMTPPassword := CallbackCreate(ObjBindMethod(implObj, "get_SMTPPassword"), flags, 2)
        this.vtbl.put_SMTPPassword := CallbackCreate(ObjBindMethod(implObj, "put_SMTPPassword"), flags, 2)
        ...
        this.vtbl.get_UseForInboundRouting := CallbackCreate(ObjBindMethod(implObj, "get_UseForInboundRouting"), flags, 2)
        this.vtbl.put_UseForInboundRouting := CallbackCreate(ObjBindMethod(implObj, "put_UseForInboundRouting"), flags, 2)
    }
