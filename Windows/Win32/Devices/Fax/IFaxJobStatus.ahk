 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nn-faxcomex-ifaxjobstatus
...
class IFaxJobStatus extends IDispatch{
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_status
     */
    get_Status() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_pages
     */
    get_Pages() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_size
     */
    get_Size() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_currentpage
     */
    get_CurrentPage() {
        result := ComCall(10, this, "int*", &plCurrentPage := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_deviceid
     */
    get_DeviceId() {
        result := ComCall(11, this, "int*", &plDeviceId := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_csid
     */
    get_CSID() {
        pbstrCSID := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_tsid
     */
    get_TSID() {
        pbstrTSID := BSTR()
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_extendedstatuscode
     */
    get_ExtendedStatusCode() {
        result := ComCall(14, this, "int*", &pExtendedStatusCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_extendedstatus
     */
    get_ExtendedStatus() {
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_availableoperations
     */
    get_AvailableOperations() {
        result := ComCall(16, this, "int*", &pAvailableOperations := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_retries
     */
    get_Retries() {
        result := ComCall(17, this, "int*", &plRetries := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_jobtype
     */
    get_JobType() {
        result := ComCall(18, this, "int*", &pJobType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_scheduledtime
     */
    get_ScheduledTime() {
        result := ComCall(19, this, "double*", &pdateScheduledTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_transmissionstart
     */
     ...
     * @returns {Float} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_transmissionend
     */
    get_TransmissionEnd() {
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_callerid
     */
    get_CallerId() {
        pbstrCallerId := BSTR()
     ...
     * @returns {BSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/faxcomex/nf-faxcomex-ifaxjobstatus-get_routinginformation
     */
