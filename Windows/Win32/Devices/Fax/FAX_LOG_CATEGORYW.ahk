...
/**
 * The FAX_LOG_CATEGORY structure describes one logging category.
 * @remarks
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winfax/ns-winfax-fax_log_categoryw
 * @namespace Windows.Win32.Devices.Fax
 * @version v4.0.30319
 * @charset Unicode
 */
class FAX_LOG_CATEGORYW extends Win32Struct
{
    static sizeof => 16
