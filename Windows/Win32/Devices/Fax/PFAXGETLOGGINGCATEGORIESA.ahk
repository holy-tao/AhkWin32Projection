 ...
 * @charset ANSI
 */
class PFAXGETLOGGINGCATEGORIESA extends IUnknown {
     ...
     */
    Invoke(FaxHandle, Categories, NumberCategories) {
        ...
        result := ComCall(3, this, "ptr", FaxHandle, CategoriesMarshal, Categories, NumberCategoriesMarshal, NumberCategories, "int")
        return result
    }
}
