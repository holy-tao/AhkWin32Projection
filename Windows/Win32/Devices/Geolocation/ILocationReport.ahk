 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/locationapi/nn-locationapi-ilocationreport
...
class ILocationReport extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/locationapi/nf-locationapi-ilocationreport-getsensorid
     */
    GetSensorID() {
        pSensorID := Guid()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/locationapi/nf-locationapi-ilocationreport-gettimestamp
     */
    GetTimestamp() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/locationapi/nf-locationapi-ilocationreport-getvalue
     */
    GetValue(pKey) {
        pValue := PROPVARIANT()
