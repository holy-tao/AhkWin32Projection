    ...
    BasicData{
        get {
            if(!this.HasProp("__BasicData"))
                this.__BasicData := GNSS_FIXDATA_BASIC_2(this.ptr + 40)
    ...
    AccuracyData{
        get {
            if(!this.HasProp("__AccuracyData"))
                this.__AccuracyData := GNSS_FIXDATA_ACCURACY_2(this.ptr + 96)
    ...
    SatelliteData{
        get {
            if(!this.HasProp("__SatelliteData"))
                this.__SatelliteData := GNSS_FIXDATA_SATELLITE(this.ptr + 216)
