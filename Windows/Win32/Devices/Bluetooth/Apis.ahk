...
;@region Methods
     ...
     * @param {Pointer<HBLUETOOTH_RADIO_FIND>} hFind Enumeration handle to close, obtained with a previous call to the <a href="https://docs.microsoft.com/windows/desktop/api/bluetoothapis/nf-bluetoothapis-bluetoothfindfirstradio">BluetoothFindFirstRadio</a> function.
     ...
     * @param {Pointer<HANDLE>} hRadio A handle to a local Bluetooth radio, obtained by calling the <a href="https://docs.microsoft.com/windows/desktop/api/bluetoothapis/nf-bluetoothapis-bluetoothfindfirstradio">BluetoothFindFirstRadio</a> or similar functions, or the <b>SetupDiEnumerateDeviceInterfances</b> function.
     ...
     * @param {Pointer<HBLUETOOTH_DEVICE_FIND>} hFind Handle for the query obtained in a previous call to the <a href="https://docs.microsoft.com/windows/desktop/api/bluetoothapis/nf-bluetoothapis-bluetoothfindfirstdevice">BluetoothFindFirstDevice</a> function.
     ...
     * @param {Pointer<HBLUETOOTH_DEVICE_FIND>} hFind Handle for the query to be closed. Obtained in a previous call to the <a href="https://docs.microsoft.com/windows/desktop/api/bluetoothapis/nf-bluetoothapis-bluetoothfindfirstdevice">BluetoothFindFirstDevice</a> function.
     ...
     * @param {Pointer<HWND>} hwndParent A handle to the parent window of the property sheet.
     ...
     * </tr>
     * </table>
     * @param {Pointer<HWND>} hwndParent A window to be the parent of the Authentication wizard. If set to <b>NULL</b>, the wizard is removed from the desktop.
     * @param {Pointer<HANDLE>} hRadio A valid local radio handle, or <b>NULL</b>. If <b>NULL</b>, authentication is attempted on all local radios; if any radio succeeds, the function call succeeds.
     ...
     * @param {Pointer<HWND>} hwndParentIn The window to parent the authentication wizard. If <b>NULL</b>, the 
     * wizard will be parented off the desktop.
     * @param {Pointer<HANDLE>} hRadioIn A valid local radio handle or <b>NULL</b>. If <b>NULL</b>, then all radios will
     ...
     * @param {Pointer<HWND>} hwndParent A window to be the parent of the Authentication wizard. If set to <b>NULL</b>, the wizard is parented off the desktop.
     * @param {Pointer<HANDLE>} hRadio The valid local radio handle, or <b>NULL</b>. If <b>NULL</b>, authentication is attempted on all local radios; if any radio succeeds, the function call succeeds.
     ...
     * @param {Pointer<HANDLE>} hRadio A handle of the local Bluetooth radio.
     ...
     * @param {Pointer<HANDLE>} hRadio Handle of the local Bluetooth radio device. If <b>NULL</b>,   all local radios are searched for enabled services that match the radio address in <i>pbtdi</i>.
    ...
    static BluetoothEnumerateInstalledServices(hRadio, pbtdi, pcServiceInout, pGuidServices) {
        result := DllCall("BluetoothApis.dll\BluetoothEnumerateInstalledServices", "ptr", hRadio, "ptr", pbtdi, "ptr", pcServiceInout, "ptr", pGuidServices, "uint")
        return result
    }
     ...
     * @param {Pointer<HANDLE>} hRadio Valid local radio handle, or <b>NULL</b>. If <b>NULL</b>, discovery is modified on all local radios; if any radio is modified by the call, the function call succeeds.
     ...
     * @param {Pointer<HANDLE>} hRadio Valid local radio handle, or <b>NULL</b>. If <b>NULL</b>, discovery is determined for all local radios; if any radio is discoverable, the function call succeeds.
     ...
     * @param {Pointer<HANDLE>} hRadio Valid local radio handle for which to change whether incoming connections are enabled, or <b>NULL</b>. If <b>NULL</b>, the attempt to modify incoming connection acceptance iterates through all local radios; if any radio is modified by the call, the function call succeeds.
     ...
     * @param {Pointer<HANDLE>} hRadio Valid local radio handle, or <b>NULL</b>. If <b>NULL</b>, all local radios are checked for connectability; if any radio is connectable, the function call succeeds.
     ...
     * @param {Pointer<HANDLE>} hRadio Optional handle to the local radio handle, or <b>NULL</b>. If <b>NULL</b>, the function attempts to send an authentication response on all local radios.
     ...
     * @param {Pointer<PWSTR>} pszPasskey Pointer to a UNICODE zero-terminated string of the passkey response
     ...
     * @param {Pointer<HANDLE>} hRadioIn A handle of the Bluetooth radio device to specify local service information for.
     ...
     * @param {Pointer<Byte>} pSdpStream A pointer to a valid SDP stream.
     ...
     * @param {Pointer<Byte>} pContainerStream A pointer to valid SDP stream. The first element in the stream must be a sequence
     * or an alternative.
     ...
     * @param {Pointer<Byte>} pRecordStream Pointer to a valid record stream that is formatted as a single SDP record.
     ...
     * @param {Pointer<Byte>} pRecordStream A pointer to a valid record stream formatted as a single SDP record.
     ...
     * @param {Pointer<PWSTR>} pszString If not <b>NULL</b>, contains the converted string on output. When set to <b>NULL</b>, the <i>pcchStringLength</i> parameter is filled with the required number of characters, not bytes, to retrieve the converted string.
    ...
    static BluetoothSdpGetString(pRecordStream, cbRecordLength, pStringData, usStringOffset, pszString, pcchStringLength) {
        ...
        result := DllCall("BluetoothApis.dll\BluetoothSdpGetString", "ptr", pRecordStream, "uint", cbRecordLength, "ptr", pStringData, "ushort", usStringOffset, "ptr", pszString, "ptr", pcchStringLength, "uint")
        return result
    }
     ...
     * containing attribute ID (UINT16) plus attribute value (any SDP element type) pairs.
     * @param {Pointer<Byte>} pSDPStream Pointer to a valid record stream that is formatted as a single SDP record.
     ...
     * @param {Pointer<HANDLE>} hRadioIn A handle of the Bluetooth radio device to specify local service information for. If <b>NULL</b>, 
     ...
     * 
     * ```
     * @param {Pointer<HANDLE>} hDevice Handle to the Bluetooth device from which to obtain the list of primary services.
    ...
    static BluetoothGATTGetServices(hDevice, ServicesBufferCount, ServicesBuffer, ServicesBufferActual, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetServices", "ptr", hDevice, "ushort", ServicesBufferCount, "ptr", ServicesBuffer, "ptr", ServicesBufferActual, "uint", Flags, "int")
        return result
    }
     ...
     *      }
     * ```
     * @param {Pointer<HANDLE>} hDevice Handle to the Bluetooth device or parent service.
    ...
    static BluetoothGATTGetIncludedServices(hDevice, ParentService, IncludedServicesBufferCount, IncludedServicesBuffer, IncludedServicesBufferActual, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetIncludedServices", "ptr", hDevice, "ptr", ParentService, "ushort", IncludedServicesBufferCount, "ptr", IncludedServicesBuffer, "ptr", IncludedServicesBufferActual, "uint", Flags, "int")
        return result
    }
     ...
     *         }
     * ```
     * @param {Pointer<HANDLE>} hDevice Handle to the Bluetooth device or service.
    ...
    static BluetoothGATTGetCharacteristics(hDevice, Service, CharacteristicsBufferCount, CharacteristicsBuffer, CharacteristicsBufferActual, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetCharacteristics", "ptr", hDevice, "ptr", Service, "ushort", CharacteristicsBufferCount, "ptr", CharacteristicsBuffer, "ptr", CharacteristicsBufferActual, "uint", Flags, "int")
        return result
    }
     ...
     * 
     * ```
     * @param {Pointer<HANDLE>} hDevice Handle to the Bluetooth device or service.  If a service handle is passed, then the service must be the grandparent of the descriptor.
    ...
    static BluetoothGATTGetDescriptors(hDevice, Characteristic, DescriptorsBufferCount, DescriptorsBuffer, DescriptorsBufferActual, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetDescriptors", "ptr", hDevice, "ptr", Characteristic, "ushort", DescriptorsBufferCount, "ptr", DescriptorsBuffer, "ptr", DescriptorsBufferActual, "uint", Flags, "int")
        return result
    }
     ...
     * 
     * ```
     * @param {Pointer<HANDLE>} hDevice Handle to the service.
    ...
    static BluetoothGATTGetCharacteristicValue(hDevice, Characteristic, CharacteristicValueDataSize, CharacteristicValue, CharacteristicValueSizeRequired, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetCharacteristicValue", "ptr", hDevice, "ptr", Characteristic, "uint", CharacteristicValueDataSize, "ptr", CharacteristicValue, "ptr", CharacteristicValueSizeRequired, "uint", Flags, "int")
        return result
    }
    ...
    static BluetoothGATTGetDescriptorValue(hDevice, Descriptor, DescriptorValueDataSize, DescriptorValue, DescriptorValueSizeRequired, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTGetDescriptorValue", "ptr", hDevice, "ptr", Descriptor, "uint", DescriptorValueDataSize, "ptr", DescriptorValue, "ptr", DescriptorValueSizeRequired, "uint", Flags, "int")
        return result
    }
    ...
    static BluetoothGATTBeginReliableWrite(hDevice, ReliableWriteContext, Flags) {
        result := DllCall("BluetoothApis.dll\BluetoothGATTBeginReliableWrite", "ptr", hDevice, "ptr", ReliableWriteContext, "uint", Flags, "int")
        return result
    }
     ...
     * @param {Pointer<HANDLE>} hService Handle to the service.
