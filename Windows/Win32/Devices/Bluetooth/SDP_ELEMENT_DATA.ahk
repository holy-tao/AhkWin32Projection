 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/bluetoothapis/ns-bluetoothapis-sdp_element_data
        ...
        string{
            get {
                if(!this.HasProp("__string"))
                    this.__string := %this.__Class%._string(0, this)
        ...
        url{
            get {
                if(!this.HasProp("__url"))
                    this.__url := %this.__Class%._url(0, this)
                return this.__url
            }
        }
        ...
        sequence{
            get {
                if(!this.HasProp("__sequence"))
                    this.__sequence := %this.__Class%._sequence(0, this)
        ...
        alternative{
            get {
                if(!this.HasProp("__alternative"))
                    this.__alternative := %this.__Class%._alternative(0, this)
