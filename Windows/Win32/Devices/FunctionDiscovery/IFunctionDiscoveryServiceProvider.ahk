 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nn-functiondiscoveryprovider-ifunctiondiscoveryserviceprovider
...
class IFunctionDiscoveryServiceProvider extends IUnknown{
     ...
     * @returns {Pointer<Pointer<Void>>} The interface pointer requested in <i>riid</i>. Upon successful return, <i>*ppv</i> contains the requested interface pointer. Upon failure, <i>*ppv</i> contains <b>NULL</b>.
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-ifunctiondiscoveryserviceprovider-initialize
     */
    Initialize(pIFunctionInstance, riid) {
        result := ComCall(3, this, "ptr", pIFunctionInstance, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
