 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nn-functiondiscoveryapi-ifunctiondiscovery
...
class IFunctionDiscovery extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-getinstancecollection
     */
    GetInstanceCollection(pszCategory, pszSubCategory, fIncludeAllSubCategories) {
        ...
        result := ComCall(3, this, "ptr", pszCategory, "ptr", pszSubCategory, "int", fIncludeAllSubCategories, "ptr*", &ppIFunctionInstanceCollection := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-getinstance
     */
    GetInstance(pszFunctionInstanceIdentity) {
        ...
        result := ComCall(4, this, "ptr", pszFunctionInstanceIdentity, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-createinstancecollectionquery
     */
    CreateInstanceCollectionQuery(pszCategory, pszSubCategory, fIncludeAllSubCategories, pIFunctionDiscoveryNotification, pfdqcQueryContext) {
        ...
        result := ComCall(5, this, "ptr", pszCategory, "ptr", pszSubCategory, "int", fIncludeAllSubCategories, "ptr", pIFunctionDiscoveryNotification, pfdqcQueryContextMarshal, pfdqcQueryContext, "ptr*", &ppIFunctionInstanceCollectionQuery := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-createinstancequery
     */
    CreateInstanceQuery(pszFunctionInstanceIdentity, pIFunctionDiscoveryNotification, pfdqcQueryContext) {
        ...
        result := ComCall(6, this, "ptr", pszFunctionInstanceIdentity, "ptr", pIFunctionDiscoveryNotification, pfdqcQueryContextMarshal, pfdqcQueryContext, "ptr*", &ppIFunctionInstanceQuery := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-addinstance
     */
    AddInstance(enumSystemVisibility, pszCategory, pszSubCategory, pszCategoryIdentity) {
        ...
        result := ComCall(7, this, "int", enumSystemVisibility, "ptr", pszCategory, "ptr", pszSubCategory, "ptr", pszCategoryIdentity, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctiondiscovery-removeinstance
     */
