 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nn-functiondiscoveryprovider-iproviderproperties
...
class IProviderProperties extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderproperties-getcount
     */
    GetCount(pIFunctionInstance, iProviderInstanceContext) {
        result := ComCall(3, this, "ptr", pIFunctionInstance, "ptr", iProviderInstanceContext, "uint*", &pdwCount := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderproperties-getat
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderproperties-getvalue
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderproperties-setvalue
     */
