 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nn-functiondiscoveryapi-ifunctioninstancecollection
...
class IFunctionInstanceCollection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-getcount
     */
    GetCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-get
     */
    Get(pszInstanceIdentity, pdwIndex) {
        ...
        result := ComCall(4, this, "ptr", pszInstanceIdentity, pdwIndexMarshal, pdwIndex, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IFunctionInstance} A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/functiondiscoveryapi/nn-functiondiscoveryapi-ifunctioninstance">IFunctionInstance</a> interface pointer that receives the function instance.
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-item
     */
    Item(dwIndex) {
        result := ComCall(5, this, "uint", dwIndex, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-add
     */
    Add(pIFunctionInstance) {
        result := ComCall(6, this, "ptr", pIFunctionInstance, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {IFunctionInstance} A pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/functiondiscoveryapi/nn-functiondiscoveryapi-ifunctioninstance">IFunctionInstance</a> interface pointer that receives the function instance.
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-remove
     */
    Remove(dwIndex) {
        result := ComCall(7, this, "uint", dwIndex, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-delete
     */
    Delete(dwIndex) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancecollection-deleteall
     */
    DeleteAll() {
