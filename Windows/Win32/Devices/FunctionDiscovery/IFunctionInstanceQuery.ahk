 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nn-functiondiscoveryapi-ifunctioninstancequery
...
class IFunctionInstanceQuery extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryapi/nf-functiondiscoveryapi-ifunctioninstancequery-execute
     */
    Execute() {
        result := ComCall(3, this, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
