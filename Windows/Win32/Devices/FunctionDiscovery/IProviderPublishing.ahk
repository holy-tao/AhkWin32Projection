 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nn-functiondiscoveryprovider-iproviderpublishing
...
class IProviderPublishing extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderpublishing-createinstance
     */
    CreateInstance(enumVisibilityFlags, pszSubCategory, pszProviderInstanceIdentity) {
        ...
        result := ComCall(3, this, "int", enumVisibilityFlags, "ptr", pszSubCategory, "ptr", pszProviderInstanceIdentity, "ptr*", &ppIFunctionInstance := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/functiondiscoveryprovider/nf-functiondiscoveryprovider-iproviderpublishing-removeinstance
     */
