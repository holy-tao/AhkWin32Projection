 ...
 * @version v4.0.30319
 */
class PFN_DrvQueryTrueTypeOutline extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "uint", param2, "int", param3, "ptr", param4, "uint", param5, "ptr", param6, "int")
        return result
    }
}
