 ...
 * @version v4.0.30319
 */
class PFN_DrvQueryDeviceSupport extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ptr", param2, "uint", param3, "uint", param4, param5Marshal, param5, "uint", param6, param7Marshal, param7, "int")
        return result
    }
}
