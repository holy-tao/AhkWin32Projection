 ...
 * @version v4.0.30319
 */
class PFN_DrvLoadFontFile extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6) {
        ...
        result := ComCall(3, this, "uint", param0, param1Marshal, param1, param2Marshal, param2, param3Marshal, param3, "ptr", param4, "uint", param5, "uint", param6, "ptr")
        return result
    }
}
