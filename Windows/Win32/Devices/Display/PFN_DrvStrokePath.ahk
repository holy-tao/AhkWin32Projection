 ...
 * @version v4.0.30319
 */
class PFN_DrvStrokePath extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7) {
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ptr", param2, "ptr", param3, "ptr", param4, "ptr", param5, "ptr", param6, "uint", param7, "int")
        return result
    }
}
