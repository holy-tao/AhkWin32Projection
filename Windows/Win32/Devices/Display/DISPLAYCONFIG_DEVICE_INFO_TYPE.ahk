...
class DISPLAYCONFIG_DEVICE_INFO_TYPE extends Win32Enum {
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_SOURCE_NAME
     * @type {Integer (Int32)}
     */
    static GET_SOURCE_NAME => 1
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_TARGET_NAME
     * @type {Integer (Int32)}
     */
    static GET_TARGET_NAME => 2
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_TARGET_PREFERRED_MODE
     * @type {Integer (Int32)}
     */
    static GET_TARGET_PREFERRED_MODE => 3
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_ADAPTER_NAME
     * @type {Integer (Int32)}
     */
    static GET_ADAPTER_NAME => 4
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_TARGET_PERSISTENCE
     * @type {Integer (Int32)}
     */
    static SET_TARGET_PERSISTENCE => 5
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_TARGET_BASE_TYPE
     * @type {Integer (Int32)}
     */
    static GET_TARGET_BASE_TYPE => 6
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_SUPPORT_VIRTUAL_RESOLUTION
     * @type {Integer (Int32)}
     */
    static GET_SUPPORT_VIRTUAL_RESOLUTION => 7
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_SUPPORT_VIRTUAL_RESOLUTION
     * @type {Integer (Int32)}
     */
    static SET_SUPPORT_VIRTUAL_RESOLUTION => 8

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_ADVANCED_COLOR_INFO
     * @type {Integer (Int32)}
     */
    static GET_ADVANCED_COLOR_INFO => 9

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_ADVANCED_COLOR_STATE
     * @type {Integer (Int32)}
     */
    static SET_ADVANCED_COLOR_STATE => 10
     ...
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_SDR_WHITE_LEVEL
     * @type {Integer (Int32)}
     */
    static GET_SDR_WHITE_LEVEL => 11

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_MONITOR_SPECIALIZATION
     * @type {Integer (Int32)}
     */
    static GET_MONITOR_SPECIALIZATION => 12

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_MONITOR_SPECIALIZATION
     * @type {Integer (Int32)}
     */
    static SET_MONITOR_SPECIALIZATION => 13

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_RESERVED1
     * @type {Integer (Int32)}
     */
    static SET_RESERVED1 => 14

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_GET_ADVANCED_COLOR_INFO_2
     * @type {Integer (Int32)}
     */
    static GET_ADVANCED_COLOR_INFO_2 => 15

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_HDR_STATE
     * @type {Integer (Int32)}
     */
    static SET_HDR_STATE => 16

    /**
     * Native name: DISPLAYCONFIG_DEVICE_INFO_SET_WCG_STATE
     * @type {Integer (Int32)}
     */
    static SET_WCG_STATE => 17
}
