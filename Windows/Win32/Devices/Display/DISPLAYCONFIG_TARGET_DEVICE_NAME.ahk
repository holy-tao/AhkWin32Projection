 ...
 * 
  ...
  * 
  * 
 * @see https://docs.microsoft.com/windows/win32/api//wingdi/ns-wingdi-displayconfig_target_device_name
    ...
    flags{
        get {
            if(!this.HasProp("__flags"))
                this.__flags := DISPLAYCONFIG_TARGET_DEVICE_NAME_FLAGS(this.ptr + 24)
            return this.__flags
        }
    }
