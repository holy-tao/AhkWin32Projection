 ...
 * @version v4.0.30319
 */
class PFN_DrvGradientFill extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ptr", param2, "ptr", param3, "uint", param4, param5Marshal, param5, "uint", param6, "ptr", param7, "ptr", param8, "uint", param9, "int")
        return result
    }
}
