 ...
 * @version v4.0.30319
 */
class PFN_DrvIcmCreateColorTransform extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, param2Marshal, param2, "uint", param3, param4Marshal, param4, "uint", param5, param6Marshal, param6, "uint", param7, "uint", param8, "ptr")
