 ...
 * @version v4.0.30319
 */
class PFN_DrvQueryFontData extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "uint", param2, "uint", param3, "ptr", param4, param5Marshal, param5, "uint", param6, "int")
        return result
    }
}
