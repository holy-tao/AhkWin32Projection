 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-commit
...
class IViewHelper extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-getconnectedids
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-getactivetopology
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-setactivetopology
     */
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-setconfiguration
     */
    SetConfiguration(pIStream) {
        result := ComCall(7, this, "ptr", pIStream, "uint*", &pulStatus := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/cloneviewhelper/nf-cloneviewhelper-iviewhelper-getproceedonnewconfiguration
     */
