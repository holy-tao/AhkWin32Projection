 ...
 */
export default struct PFN_DrvStretchBlt {
    value : IntPtr

    __value {
        set {
            if (value is PFN_DrvStretchBlt) {
    ...
    Call(param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10) {
        result := DllCall(this.value, SURFOBJ.Ptr, param0, SURFOBJ.Ptr, param1, SURFOBJ.Ptr, param2, CLIPOBJ.Ptr, param3, XLATEOBJ.Ptr, param4, COLORADJUSTMENT.Ptr, param5, POINTL.Ptr, param6, RECTL.Ptr, param7, RECTL.Ptr, param8, POINTL.Ptr, param9, UInt32, param10, BOOL)
        return result
    }

    /**
     * A PFN_DrvStretchBlt that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFN_DrvStretchBlt {
        /**
         * Creates a PFN_DrvStretchBlt pointer that invokes the given AHK function when called.
         * @param {Func(SURFOBJ, SURFOBJ, SURFOBJ, CLIPOBJ, XLATEOBJ, COLORADJUSTMENT, POINTL, RECTL, RECTL, POINTL, UInt32) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 11)) {
