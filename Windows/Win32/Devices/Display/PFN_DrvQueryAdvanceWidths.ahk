 ...
 * @version v4.0.30319
 */
class PFN_DrvQueryAdvanceWidths extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5) {
        ...
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "uint", param2, param3Marshal, param3, param4Marshal, param4, "uint", param5, "int")
        return result
    }
}
