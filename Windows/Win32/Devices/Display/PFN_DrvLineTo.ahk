 ...
 * @version v4.0.30319
 */
class PFN_DrvLineTo extends IUnknown {
    ...
    Invoke(param0, param1, param2, param3, param4, param5, param6, param7, param8) {
        result := ComCall(3, this, "ptr", param0, "ptr", param1, "ptr", param2, "int", param3, "int", param4, "int", param5, "int", param6, "ptr", param7, "uint", param8, "int")
        return result
    }
}
