 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nn-upnp-iupnpdevicefindercallback
...
class IUPnPDeviceFinderCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpdevicefindercallback-deviceadded
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpdevicefindercallback-deviceremoved
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/upnp/nf-upnp-iupnpdevicefinder-createasyncfind">IUPnPDeviceFinder::CreateAsyncFind</a>.
     * @returns {HRESULT} The application should return S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpdevicefindercallback-searchcomplete
     */
