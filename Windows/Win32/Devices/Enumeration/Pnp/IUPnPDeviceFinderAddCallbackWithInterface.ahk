 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nn-upnp-iupnpdevicefinderaddcallbackwithinterface
...
class IUPnPDeviceFinderAddCallbackWithInterface extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpdevicefinderaddcallbackwithinterface-deviceaddedwithinterface
     */
    DeviceAddedWithInterface(lFindData, pDevice, pguidInterface) {
        result := ComCall(3, this, "int", lFindData, "ptr", pDevice, "ptr", pguidInterface, "int")
        if(result != 0) {
