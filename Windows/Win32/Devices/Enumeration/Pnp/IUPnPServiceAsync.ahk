 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nn-upnp-iupnpserviceasync
...
class IUPnPServiceAsync extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-begininvokeaction
     */
    BeginInvokeAction(bstrActionName, vInActionArgs, pAsyncResult) {
        if(bstrActionName is String) {
            pin := BSTR.Alloc(bstrActionName)
            bstrActionName := pin.Value
        }

        result := ComCall(3, this, "ptr", bstrActionName, "ptr", vInActionArgs, "ptr", pAsyncResult, "uint*", &pullRequestID := 0, "int")
        if(result != 0) {
     ...
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-endinvokeaction
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-beginquerystatevariable
     */
    BeginQueryStateVariable(bstrVariableName, pAsyncResult) {
        if(bstrVariableName is String) {
            pin := BSTR.Alloc(bstrVariableName)
            bstrVariableName := pin.Value
        }

        result := ComCall(5, this, "ptr", bstrVariableName, "ptr", pAsyncResult, "uint*", &pullRequestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div class="alert"><b>Note</b>  Some values can indicate that an error was received from a UPnP-certified device. For more information, see <a href="https://docs.microsoft.com/windows/desktop/UPnP/device-error-codes">Device Error Codes</a>.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-endquerystatevariable
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-beginsubscribetoevents
     */
    BeginSubscribeToEvents(pUnkCallback, pAsyncResult) {
        result := ComCall(7, this, "ptr", pUnkCallback, "ptr", pAsyncResult, "uint*", &pullRequestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <div class="alert"><b>Note</b>  Some values can indicate that an error was received from a UPnP-certified device. For more information, see <a href="https://docs.microsoft.com/windows/desktop/UPnP/device-error-codes">Device Error Codes</a>.</div>
     * <div> </div>
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-endsubscribetoevents
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-beginscpddownload
     */
    BeginSCPDDownload(pAsyncResult) {
        result := ComCall(9, this, "ptr", pAsyncResult, "uint*", &pullRequestID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-endscpddownload
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpserviceasync-cancelasyncoperation
     */
