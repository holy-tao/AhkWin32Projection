...
export default struct IUPnPDevice extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_IsRootDevice := CallbackCreate(ObjBindMethod(implObj, "get_IsRootDevice"), flags, 2)
        this.vtbl.get_RootDevice := CallbackCreate(ObjBindMethod(implObj, "get_RootDevice"), flags, 2)
        this.vtbl.get_ParentDevice := CallbackCreate(ObjBindMethod(implObj, "get_ParentDevice"), flags, 2)
        this.vtbl.get_HasChildren := CallbackCreate(ObjBindMethod(implObj, "get_HasChildren"), flags, 2)
        this.vtbl.get_Children := CallbackCreate(ObjBindMethod(implObj, "get_Children"), flags, 2)
        this.vtbl.get_UniqueDeviceName := CallbackCreate(ObjBindMethod(implObj, "get_UniqueDeviceName"), flags, 2)
        ...
        this.vtbl.get_PresentationURL := CallbackCreate(ObjBindMethod(implObj, "get_PresentationURL"), flags, 2)
        this.vtbl.get_ManufacturerName := CallbackCreate(ObjBindMethod(implObj, "get_ManufacturerName"), flags, 2)
        this.vtbl.get_ManufacturerURL := CallbackCreate(ObjBindMethod(implObj, "get_ManufacturerURL"), flags, 2)
        this.vtbl.get_ModelName := CallbackCreate(ObjBindMethod(implObj, "get_ModelName"), flags, 2)
        this.vtbl.get_ModelNumber := CallbackCreate(ObjBindMethod(implObj, "get_ModelNumber"), flags, 2)
        this.vtbl.get_Description := CallbackCreate(ObjBindMethod(implObj, "get_Description"), flags, 2)
        this.vtbl.get_ModelURL := CallbackCreate(ObjBindMethod(implObj, "get_ModelURL"), flags, 2)
        this.vtbl.get_UPC := CallbackCreate(ObjBindMethod(implObj, "get_UPC"), flags, 2)
        this.vtbl.get_SerialNumber := CallbackCreate(ObjBindMethod(implObj, "get_SerialNumber"), flags, 2)
        this.vtbl.IconURL := CallbackCreate(ObjBindMethod(implObj, "IconURL"), flags, 6)
