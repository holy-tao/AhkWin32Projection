 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nn-upnp-iupnpdevicedocumentaccessex
...
class IUPnPDeviceDocumentAccessEx extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpdevicedocumentaccessex-getdocument
     */
    GetDocument() {
        pbstrDocument := BSTR()
