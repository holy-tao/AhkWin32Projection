 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nn-upnp-iupnpservice
...
class IUPnPService extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-querystatevariable
     */
     ...
     * 
     * Free this parameter with <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/oleauto/nf-oleauto-variantclear">VariantClear</a>.
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-invokeaction
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-get_servicetypeidentifier
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-addcallback
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-get_id
     */
    get_Id() {
        pbstrId := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnp/nf-upnp-iupnpservice-get_lasttransportstatus
     */
    get_LastTransportStatus() {
        result := ComCall(12, this, "int*", &plValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
