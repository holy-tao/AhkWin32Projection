 ...
 */
export default struct IUPnPAddressFamilyControl extends IUnknown {
    /**
     ...
     * used for IUPnPAddressFamilyControl interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        SetAddressFamily : IntPtr
        GetAddressFamily : IntPtr
    }

    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IUPnPAddressFamilyControl.Vtbl()
        }
    ...
    Dispose() {
        ...
        CallbackFree(this.vtbl.GetAddressFamily)
    }
}
