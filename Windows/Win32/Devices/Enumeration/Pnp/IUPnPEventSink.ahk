 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/upnphost/nn-upnphost-iupnpeventsink
...
class IUPnPEventSink extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/upnphost/nf-upnphost-iupnpeventsink-onstatechanged
     */
    OnStateChanged(cChanges, rgdispidChanges) {
        rgdispidChangesMarshal := rgdispidChanges is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, "uint", cChanges, rgdispidChangesMarshal, rgdispidChanges, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If the method succeeds, the return value is S_OK. Otherwise, the method returns one of the COM error codes defined in WinError.h.
     * @see https://learn.microsoft.com/windows/win32/api//content/upnphost/nf-upnphost-iupnpeventsink-onstatechangedsafe
     */
