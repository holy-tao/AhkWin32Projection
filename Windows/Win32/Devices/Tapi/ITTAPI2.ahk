 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-ittapi2
...
class ITTAPI2 extends ITTAPI{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapi2-get_phones
     */
    get_Phones() {
        pPhones := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapi2-enumeratephones
     */
    EnumeratePhones() {
        result := ComCall(24, this, "ptr*", &ppEnumPhone := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapi2-createemptycollectionobject
     */
    CreateEmptyCollectionObject() {
        result := ComCall(25, this, "ptr*", &ppCollection := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
