 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itaddress
...
class ITAddress extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_state
     */
    get_State() {
        result := ComCall(7, this, "int*", &pAddressState := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_addressname
     */
    get_AddressName() {
        ppName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_serviceprovidername
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_tapiobject
     */
    get_TAPIObject() {
        result := ComCall(10, this, "ptr*", &ppTapiObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-createcall
     */
    CreateCall(pDestAddress, lAddressType, lMediaTypes) {
        ...
        result := ComCall(11, this, "ptr", pDestAddress, "int", lAddressType, "int", lMediaTypes, "ptr*", &ppCall := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_calls
     */
    get_Calls() {
        pVariant := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-enumeratecalls
     */
    EnumerateCalls() {
        result := ComCall(13, this, "ptr*", &ppCallEnum := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_dialableaddress
     */
    get_DialableAddress() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-createforwardinfoobject
     */
    CreateForwardInfoObject() {
        result := ComCall(15, this, "ptr*", &ppForwardInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-forward
     */
     ...
     * @returns {ITForwardInformation} Pointer to 
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itforwardinformation">ITForwardInformation</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_currentforwardinfo
     */
    get_CurrentForwardInfo() {
        result := ComCall(17, this, "ptr*", &ppForwardInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-put_messagewaiting
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_messagewaiting
     */
    get_MessageWaiting() {
        result := ComCall(19, this, "short*", &pfMessageWaiting := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-put_donotdisturb
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddress-get_donotdisturb
     */
    get_DoNotDisturb() {
        result := ComCall(21, this, "short*", &pfDoNotDisturb := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
