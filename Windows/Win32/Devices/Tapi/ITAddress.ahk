...
export default struct ITAddress extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_AddressName := CallbackCreate(ObjBindMethod(implObj, "get_AddressName"), flags, 2)
        this.vtbl.get_ServiceProviderName := CallbackCreate(ObjBindMethod(implObj, "get_ServiceProviderName"), flags, 2)
        ...
        this.vtbl.get_DialableAddress := CallbackCreate(ObjBindMethod(implObj, "get_DialableAddress"), flags, 2)
        this.vtbl.CreateForwardInfoObject := CallbackCreate(ObjBindMethod(implObj, "CreateForwardInfoObject"), flags, 2)
        this.vtbl.Forward := CallbackCreate(ObjBindMethod(implObj, "Forward"), flags, 3)
        this.vtbl.get_CurrentForwardInfo := CallbackCreate(ObjBindMethod(implObj, "get_CurrentForwardInfo"), flags, 2)
        this.vtbl.put_MessageWaiting := CallbackCreate(ObjBindMethod(implObj, "put_MessageWaiting"), flags, 2)
        this.vtbl.get_MessageWaiting := CallbackCreate(ObjBindMethod(implObj, "get_MessageWaiting"), flags, 2)
        this.vtbl.put_DoNotDisturb := CallbackCreate(ObjBindMethod(implObj, "put_DoNotDisturb"), flags, 2)
        this.vtbl.get_DoNotDisturb := CallbackCreate(ObjBindMethod(implObj, "get_DoNotDisturb"), flags, 2)
    }
