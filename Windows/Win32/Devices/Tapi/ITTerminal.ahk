 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itterminal
...
class ITTerminal extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_name
     */
    get_Name() {
        ppName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_state
     */
    get_State() {
        result := ComCall(8, this, "int*", &pTerminalState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_terminaltype
     */
    get_TerminalType() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_terminalclass
     */
    get_TerminalClass() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_mediatype
     */
    get_MediaType() {
        result := ComCall(11, this, "int*", &plMediaType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminal-get_direction
     */
    get_Direction() {
