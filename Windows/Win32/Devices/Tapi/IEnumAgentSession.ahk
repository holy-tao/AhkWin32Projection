...
/**
 * The IEnumAgentSession (tapi3.h) interface provides COM-standard enumeration methods for the ITAgentSession interface.
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nn-tapi3-ienumagentsession
...
class IEnumAgentSession extends IUnknown{
    ...
    /**
     * The IEnumAgentSession::Next method (tapi3.h) gets the next specified number of elements in the enumeration sequence.
     * @remarks
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-ienumagentsession-next
     */
    ...
    /**
     * The IEnumAgentSession::Reset method (tapi3.h) resets the enumeration sequence to the beginning.
     * @returns {HRESULT} This method can return one of these values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-ienumagentsession-reset
     */
    Reset() {
    ...
    /**
     * The IEnumAgentSession::Skip method (tapi3.h) skips over the next specified number of elements in the enumeration sequence.
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-ienumagentsession-skip
     */
    Skip(celt) {
    ...
    /**
     * The IEnumAgentSession::Clone method (tapi3.h) creates another enumerator that contains the same enumeration state as the current one.
     * @remarks
     * TAPI calls the <b>AddRef</b> method on the 
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-ienumagentsession-clone
     */
    Clone() {
