...
export default struct ITBasicCallControl extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.HandoffDirect := CallbackCreate(ObjBindMethod(implObj, "HandoffDirect"), flags, 2)
        this.vtbl.HandoffIndirect := CallbackCreate(ObjBindMethod(implObj, "HandoffIndirect"), flags, 2)
        this.vtbl.Conference := CallbackCreate(ObjBindMethod(implObj, "Conference"), flags, 3)
        this.vtbl.Transfer := CallbackCreate(ObjBindMethod(implObj, "Transfer"), flags, 3)
        this.vtbl.BlindTransfer := CallbackCreate(ObjBindMethod(implObj, "BlindTransfer"), flags, 2)
        this.vtbl.SwapHold := CallbackCreate(ObjBindMethod(implObj, "SwapHold"), flags, 2)
        this.vtbl.ParkDirect := CallbackCreate(ObjBindMethod(implObj, "ParkDirect"), flags, 2)
        this.vtbl.ParkIndirect := CallbackCreate(ObjBindMethod(implObj, "ParkIndirect"), flags, 2)
        this.vtbl.Unpark := CallbackCreate(ObjBindMethod(implObj, "Unpark"), flags, 1)
        this.vtbl.SetQOS := CallbackCreate(ObjBindMethod(implObj, "SetQOS"), flags, 3)
        this.vtbl.Pickup := CallbackCreate(ObjBindMethod(implObj, "Pickup"), flags, 2)
        this.vtbl.Dial := CallbackCreate(ObjBindMethod(implObj, "Dial"), flags, 2)
        this.vtbl.Finish := CallbackCreate(ObjBindMethod(implObj, "Finish"), flags, 2)
        this.vtbl.RemoveFromConference := CallbackCreate(ObjBindMethod(implObj, "RemoveFromConference"), flags, 1)
    }
