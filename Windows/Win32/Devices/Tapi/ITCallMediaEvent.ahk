 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itcallmediaevent
...
class ITCallMediaEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_call
     */
    get_Call() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_event
     */
    get_Event() {
        result := ComCall(8, this, "int*", &pCallMediaEvent := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_error
     */
    get_Error() {
        result := ComCall(9, this, "int*", &phrError := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_terminal
     */
    get_Terminal() {
        result := ComCall(10, this, "ptr*", &ppTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_stream
     */
    get_Stream() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallmediaevent-get_cause
     */
    get_Cause() {
        result := ComCall(12, this, "int*", &pCause := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
