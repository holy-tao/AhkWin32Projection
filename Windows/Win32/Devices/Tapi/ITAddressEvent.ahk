 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itaddressevent
...
class ITAddressEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressevent-get_address
     */
    get_Address() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressevent-get_event
     */
    get_Event() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressevent-get_terminal
     */
    get_Terminal() {
        result := ComCall(9, this, "ptr*", &ppTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
