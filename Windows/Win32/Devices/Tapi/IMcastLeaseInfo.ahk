 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nn-mdhcp-imcastleaseinfo
...
class IMcastLeaseInfo extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_requestid
     */
    get_RequestID() {
        ppRequestID := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_leasestarttime
     */
    get_LeaseStartTime() {
        result := ComCall(8, this, "double*", &pTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-put_leasestarttime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_leasestoptime
     */
    get_LeaseStopTime() {
        result := ComCall(10, this, "double*", &pTime := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-put_leasestoptime
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_addresscount
     */
    get_AddressCount() {
        result := ComCall(12, this, "int*", &pCount := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_serveraddress
     */
    get_ServerAddress() {
        ppAddress := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_ttl
     */
    get_TTL() {
        result := ComCall(14, this, "int*", &pTTL := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-get_addresses
     */
    get_Addresses() {
        pVariant := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/mdhcp/nf-mdhcp-imcastleaseinfo-enumerateaddresses
     */
    EnumerateAddresses() {
        result := ComCall(16, this, "ptr*", &ppEnumAddresses := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
