...
/**
 * The ITAgentSessionEvent interface (tapi3.h) contains methods that retrieve the description of agent session events.
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nn-tapi3-itagentsessionevent
...
class ITAgentSessionEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itagentsessionevent-get_session
     */
    get_Session() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itagentsessionevent-get_event
     */
    get_Event() {
