...
#Import ".\ITCallingCard.ahk" { ITCallingCard }
 ...
 */
export default struct IEnumCallingCard extends IUnknown {
    /**
     ...
     * used for IEnumCallingCard interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumCallingCard.Vtbl()
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/tapi3if/nf-tapi3if-ienumcallingcard-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/tapi3if/nf-tapi3if-ienumcallingcard-skip
     */
    Skip(celt) {
    ...
    Query(iid) {
        if (IEnumCallingCard.IID.Equals(iid)) {
            return true
        }
