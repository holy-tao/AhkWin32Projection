 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itphone
...
class ITPhone extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-open
     */
    Open(Privilege) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-close
     */
    Close() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_addresses
     */
    get_Addresses() {
        pAddresses := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-enumerateaddresses
     */
    EnumerateAddresses() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_phonecapslong
     */
    get_PhoneCapsLong(pclCap) {
        result := ComCall(11, this, "int", pclCap, "int*", &plCapability := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_phonecapsstring
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_terminals
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-enumerateterminals
     */
    EnumerateTerminals(pAddress) {
        result := ComCall(14, this, "ptr", pAddress, "ptr*", &ppEnumTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_buttonmode
     */
    get_ButtonMode(lButtonID) {
        result := ComCall(15, this, "int", lButtonID, "int*", &pButtonMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-phone_button_mode">PHONE_BUTTON_MODE</a> descriptor for the button's mode.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_buttonmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_buttonfunction
     */
    get_ButtonFunction(lButtonID) {
        result := ComCall(17, this, "int", lButtonID, "int*", &pButtonFunction := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-phone_button_function">PHONE_BUTTON_FUNCTION</a> descriptor for the button's function.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_buttonfunction
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/oleauto/nf-oleauto-sysallocstring">SysAllocString</a>. The <b>BSTR</b> argument should be deallocated by the client.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_buttontext
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_buttontext
     */
    put_ButtonText(lButtonID, bstrButtonText) {
        if(bstrButtonText is String) {
            pin := BSTR.Alloc(bstrButtonText)
            bstrButtonText := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_buttonstate
     */
    get_ButtonState(lButtonID) {
        result := ComCall(21, this, "int", lButtonID, "int*", &pButtonState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_hookswitchstate
     */
    get_HookSwitchState(HookSwitchDevice) {
        result := ComCall(22, this, "int", HookSwitchDevice, "int*", &pHookSwitchState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-phone_hook_switch_state">PHONE_HOOK_SWITCH_STATE</a> descriptor for the hookswitch status.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_hookswitchstate
     */
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_ringmode
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_ringmode
     */
    get_RingMode() {
        result := ComCall(25, this, "int*", &plRingMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_ringvolume
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_ringvolume
     */
    get_RingVolume() {
        result := ComCall(27, this, "int*", &plRingVolume := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} The 
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-phone_privilege">PHONE_PRIVILEGE</a> descriptor for the application's privilege status with respect to the phone device.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_privilege
     */
    get_Privilege() {
        result := ComCall(28, this, "int*", &pPrivilege := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-getphonecapsbuffer
     */
    GetPhoneCapsBuffer(pcbCaps, pdwSize, ppPhoneCapsBuffer) {
        pdwSizeMarshal := pdwSize is VarRef ? "uint*" : "ptr"
        ppPhoneCapsBufferMarshal := ppPhoneCapsBuffer is VarRef ? "ptr*" : "ptr"

        result := ComCall(29, this, "int", pcbCaps, pdwSizeMarshal, pdwSize, ppPhoneCapsBufferMarshal, ppPhoneCapsBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_phonecapsbuffer
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_lampmode
     */
    get_LampMode(lLampID) {
        result := ComCall(31, this, "int", lLampID, "int*", &pLampMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-phone_lamp_mode">PHONE_LAMP_MODE</a> descriptor for the phone's lamp status.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-put_lampmode
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/oleauto/nf-oleauto-sysallocstring">SysAllocString</a>. The <b>BSTR</b> argument should be deallocated by the client.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_display
     */
    get_Display() {
        pbstrDisplay := BSTR()
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-setdisplay
     */
    SetDisplay(lRow, lColumn, bstrDisplay) {
        if(bstrDisplay is String) {
            pin := BSTR.Alloc(bstrDisplay)
            bstrDisplay := pin.Value
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itcollection">ITCollection</a> of 
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itaddress">ITAddress</a> interface pointers.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-get_preferredaddresses
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-enumeratepreferredaddresses
     */
    EnumeratePreferredAddresses() {
        result := ComCall(36, this, "ptr*", &ppEnumAddress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-devicespecific
     */
    DeviceSpecific(pParams, dwSize) {
        pParamsMarshal := pParams is VarRef ? "char*" : "ptr"

        result := ComCall(37, this, pParamsMarshal, pParams, "uint", dwSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-devicespecificvariant
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itphone-negotiateextversion
     */
    NegotiateExtVersion(lLowVersion, lHighVersion) {
        result := ComCall(39, this, "int", lLowVersion, "int", lHighVersion, "int*", &plExtVersion := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
