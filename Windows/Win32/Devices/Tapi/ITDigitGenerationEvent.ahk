 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itdigitgenerationevent
...
class ITDigitGenerationEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitgenerationevent-get_call
     */
    get_Call() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitgenerationevent-get_generationtermination
     */
    get_GenerationTermination() {
        result := ComCall(8, this, "int*", &plGenerationTermination := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitgenerationevent-get_tickcount
     */
    get_TickCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitgenerationevent-get_callbackinstance
     */
