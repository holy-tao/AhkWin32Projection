 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itmediasupport
...
class ITMediaSupport extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itmediasupport-get_mediatypes
     */
    get_MediaTypes() {
        result := ComCall(7, this, "int*", &plMediaTypes := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itmediasupport-querymediatype
     */
    QueryMediaType(lMediaType) {
        result := ComCall(8, this, "int", lMediaType, "short*", &pfSupport := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
