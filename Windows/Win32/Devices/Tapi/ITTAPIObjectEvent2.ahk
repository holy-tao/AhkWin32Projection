 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-ittapiobjectevent2
...
class ITTAPIObjectEvent2 extends ITTAPIObjectEvent{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapiobjectevent2-get_phone
     */
    get_Phone() {
        result := ComCall(11, this, "ptr*", &ppPhone := 0, "int")
        if(result != 0) {
