 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itsubstreamcontrol
...
class ITSubStreamControl extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itsubstreamcontrol-createsubstream
     */
    CreateSubStream() {
        result := ComCall(7, this, "ptr*", &ppSubStream := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itsubstreamcontrol-removesubstream
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itsubstreamcontrol-enumeratesubstreams
     */
    EnumerateSubStreams() {
        result := ComCall(9, this, "ptr*", &ppEnumSubStream := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itsubstreamcontrol-get_substreams
     */
    get_SubStreams() {
        pVariant := VARIANT()
