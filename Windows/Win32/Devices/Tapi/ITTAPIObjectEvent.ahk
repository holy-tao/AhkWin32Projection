 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-ittapiobjectevent
...
class ITTAPIObjectEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapiobjectevent-get_tapiobject
     */
    get_TAPIObject() {
        result := ComCall(7, this, "ptr*", &ppTAPIObject := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapiobjectevent-get_event
     */
    get_Event() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapiobjectevent-get_address
     */
    get_Address() {
        result := ComCall(9, this, "ptr*", &ppAddress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ittapiobjectevent-get_callbackinstance
     */
