 ...
 */
export default struct IEnumQueue extends IUnknown {
    /**
     * The interface identifier for IEnumQueue
     * @type {Guid}
     */
    static IID := Guid("{5afc3158-4bcc-11d1-bf80-00805fc147d3}")
     ...
     * used for IEnumQueue interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumQueue.Vtbl()
        }
        super.__New(implObj, flags)
    }

    /**
     * The IEnumQueue::Next method (tapi3cc.h) gets the next specified number of elements in the enumeration sequence.
     * @remarks
     ...
     * @param {Pointer<ITQueue>} ppElements Pointer to 
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/tapi3cc/nf-tapi3cc-ienumqueue-next
     */
    ...
    /**
     * The IEnumQueue::Reset method (tapi3cc.h) resets the enumeration sequence to the beginning.
     * @returns {HRESULT} This method can return one of these values.
     * 
     * <table>
     * <tr>
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/tapi3cc/nf-tapi3cc-ienumqueue-reset
     */
    Reset() {
    ...
    /**
     * The IEnumQueue::Skip method (tapi3cc.h) skips over the next specified number of elements in the enumeration sequence.
    ...
    /**
     * The IEnumQueue::Clone method (tapi3cc.h) creates another enumerator that contains the same enumeration state as the current one.
     * @remarks
     * TAPI calls the <b>AddRef</b> method on the 
     ...
     * @returns {IEnumQueue} Pointer to new 
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3/nn-tapi3-ienumqueue">IEnumQueue</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api/tapi3cc/nf-tapi3cc-ienumqueue-clone
     */
    Clone() {
