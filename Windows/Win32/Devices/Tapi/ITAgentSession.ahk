...
export default struct ITAgentSession extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_ACDGroup := CallbackCreate(ObjBindMethod(implObj, "get_ACDGroup"), flags, 2)
        ...
        this.vtbl.get_SessionStartTime := CallbackCreate(ObjBindMethod(implObj, "get_SessionStartTime"), flags, 2)
        this.vtbl.get_SessionDuration := CallbackCreate(ObjBindMethod(implObj, "get_SessionDuration"), flags, 2)
        this.vtbl.get_NumberOfCalls := CallbackCreate(ObjBindMethod(implObj, "get_NumberOfCalls"), flags, 2)
        this.vtbl.get_TotalTalkTime := CallbackCreate(ObjBindMethod(implObj, "get_TotalTalkTime"), flags, 2)
        this.vtbl.get_AverageTalkTime := CallbackCreate(ObjBindMethod(implObj, "get_AverageTalkTime"), flags, 2)
        this.vtbl.get_TotalCallTime := CallbackCreate(ObjBindMethod(implObj, "get_TotalCallTime"), flags, 2)
        this.vtbl.get_AverageCallTime := CallbackCreate(ObjBindMethod(implObj, "get_AverageCallTime"), flags, 2)
        this.vtbl.get_TotalWrapUpTime := CallbackCreate(ObjBindMethod(implObj, "get_TotalWrapUpTime"), flags, 2)
        this.vtbl.get_AverageWrapUpTime := CallbackCreate(ObjBindMethod(implObj, "get_AverageWrapUpTime"), flags, 2)
        this.vtbl.get_ACDCallRate := CallbackCreate(ObjBindMethod(implObj, "get_ACDCallRate"), flags, 2)
        this.vtbl.get_LongestTimeToAnswer := CallbackCreate(ObjBindMethod(implObj, "get_LongestTimeToAnswer"), flags, 2)
        this.vtbl.get_AverageTimeToAnswer := CallbackCreate(ObjBindMethod(implObj, "get_AverageTimeToAnswer"), flags, 2)
    }
