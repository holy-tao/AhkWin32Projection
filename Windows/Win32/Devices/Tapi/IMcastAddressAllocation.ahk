...
class IMcastAddressAllocation extends IDispatch{
    ...
    EnumerateScopes(ppEnumMcastScope) {
        result := ComCall(8, this, "ptr", ppEnumMcastScope, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMcastScope>} pScope 
    ...
    RequestAddress(pScope, LeaseStartTime, LeaseStopTime, NumAddresses, ppLeaseResponse) {
        result := ComCall(9, this, "ptr", pScope, "double", LeaseStartTime, "double", LeaseStopTime, "int", NumAddresses, "ptr", ppLeaseResponse, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<IMcastLeaseInfo>} pRenewRequest 
     * @param {Pointer<IMcastLeaseInfo>} ppRenewResponse 
     * @returns {HRESULT} 
     */
    RenewAddress(lReserved, pRenewRequest, ppRenewResponse) {
        result := ComCall(10, this, "int", lReserved, "ptr", pRenewRequest, "ptr", ppRenewResponse, "int")
        if(result != 0)
            throw OSError(result)
    ...
    /**
     * 
     * @param {Pointer<IMcastLeaseInfo>} pReleaseRequest 
     * @returns {HRESULT} 
     */
    ...
    CreateLeaseInfo(LeaseStartTime, LeaseStopTime, dwNumAddresses, ppAddresses, pRequestID, pServerAddress, ppReleaseRequest) {
        ...
        result := ComCall(12, this, "double", LeaseStartTime, "double", LeaseStopTime, "uint", dwNumAddresses, "ptr", ppAddresses, "ptr", pRequestID, "ptr", pServerAddress, "ptr", ppReleaseRequest, "int")
        if(result != 0)
            throw OSError(result)
    ...
    CreateLeaseInfoFromVariant(LeaseStartTime, LeaseStopTime, vAddresses, pRequestID, pServerAddress, ppReleaseRequest) {
        ...
        result := ComCall(13, this, "double", LeaseStartTime, "double", LeaseStopTime, "ptr", vAddresses, "ptr", pRequestID, "ptr", pServerAddress, "ptr", ppReleaseRequest, "int")
        if(result != 0)
            throw OSError(result)
