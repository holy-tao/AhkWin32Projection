 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itfiletrack
...
class ITFileTrack extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-get_format
     */
    get_Format() {
        result := ComCall(7, this, "ptr*", &ppmt := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-put_format
     */
    put_Format(pmt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-get_controllingterminal
     */
    get_ControllingTerminal() {
        result := ComCall(9, this, "ptr*", &ppControllingTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-get_audioformatforscripting
     */
    get_AudioFormatForScripting() {
        result := ComCall(10, this, "ptr*", &ppAudioFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itscriptableaudioformat">ITScriptableAudioFormat</a> interface.
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-put_audioformatforscripting
     */
     ...
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-itscriptableaudioformat">ITScriptableAudioFormat</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itfiletrack-get_emptyaudioformatforscripting
     */
    get_EmptyAudioFormatForScripting() {
        result := ComCall(12, this, "ptr*", &ppAudioFormat := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
