 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itterminalsupport
...
class ITTerminalSupport extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-get_staticterminals
     */
    get_StaticTerminals() {
        pVariant := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-enumeratestaticterminals
     */
    EnumerateStaticTerminals() {
        result := ComCall(8, this, "ptr*", &ppTerminalEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-get_dynamicterminalclasses
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-enumeratedynamicterminalclasses
     */
    EnumerateDynamicTerminalClasses() {
        result := ComCall(10, this, "ptr*", &ppTerminalClassEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @param {Integer} Direction_ <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/ne-tapi3if-terminal_direction">TERMINAL_DIRECTION</a> descriptor of the terminal direction.
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-createterminal
     */
    CreateTerminal(pTerminalClass, lMediaType, Direction_) {
        if(pTerminalClass is String) {
            pin := BSTR.Alloc(pTerminalClass)
            pTerminalClass := pin.Value
        }

        result := ComCall(11, this, "ptr", pTerminalClass, "int", lMediaType, "int", Direction_, "ptr*", &ppTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport-getdefaultstaticterminal
     */
    GetDefaultStaticTerminal(lMediaType, Direction_) {
        result := ComCall(12, this, "int", lMediaType, "int", Direction_, "ptr*", &ppTerminal := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
