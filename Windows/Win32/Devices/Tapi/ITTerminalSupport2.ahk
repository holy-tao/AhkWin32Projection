 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itterminalsupport2
...
class ITTerminalSupport2 extends ITTerminalSupport{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport2-get_pluggablesuperclasses
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport2-enumeratepluggablesuperclasses
     */
    EnumeratePluggableSuperclasses() {
        result := ComCall(14, this, "ptr*", &ppSuperclassEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport2-get_pluggableterminalclasses
     */
    get_PluggableTerminalClasses(bstrTerminalSuperclass, lMediaType) {
        if(bstrTerminalSuperclass is String) {
            pin := BSTR.Alloc(bstrTerminalSuperclass)
            bstrTerminalSuperclass := pin.Value
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itterminalsupport2-enumeratepluggableterminalclasses
     */
    EnumeratePluggableTerminalClasses(iidTerminalSuperclass, lMediaType) {
        result := ComCall(16, this, "ptr", iidTerminalSuperclass, "int", lMediaType, "ptr*", &ppClassEnumerator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
