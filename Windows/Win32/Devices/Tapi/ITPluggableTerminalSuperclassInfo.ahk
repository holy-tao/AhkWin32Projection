 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itpluggableterminalsuperclassinfo
...
class ITPluggableTerminalSuperclassInfo extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itpluggableterminalsuperclassinfo-get_name
     */
    get_Name() {
        pName := BSTR()
     ...
     * <a href="https://docs.microsoft.com/previous-versions/windows/desktop/api/oleauto/nf-oleauto-sysallocstring">SysAllocString</a>. The <b>BSTR</b> argument should be deallocated by the client.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itpluggableterminalsuperclassinfo-get_clsid
     */
    get_CLSID() {
        pCLSID := BSTR()
