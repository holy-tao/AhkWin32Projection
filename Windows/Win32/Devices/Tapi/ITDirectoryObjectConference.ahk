...
export default struct ITDirectoryObjectConference extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_Originator := CallbackCreate(ObjBindMethod(implObj, "get_Originator"), flags, 2)
        this.vtbl.put_Originator := CallbackCreate(ObjBindMethod(implObj, "put_Originator"), flags, 2)
        this.vtbl.get_AdvertisingScope := CallbackCreate(ObjBindMethod(implObj, "get_AdvertisingScope"), flags, 2)
        this.vtbl.put_AdvertisingScope := CallbackCreate(ObjBindMethod(implObj, "put_AdvertisingScope"), flags, 2)
        ...
        this.vtbl.get_IsEncrypted := CallbackCreate(ObjBindMethod(implObj, "get_IsEncrypted"), flags, 2)
        this.vtbl.put_IsEncrypted := CallbackCreate(ObjBindMethod(implObj, "put_IsEncrypted"), flags, 2)
