 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itdigitsgatheredevent
...
class ITDigitsGatheredEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitsgatheredevent-get_call
     */
    get_Call() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitsgatheredevent-get_digits
     */
    get_Digits() {
        ppDigits := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitsgatheredevent-get_gathertermination
     */
    get_GatherTermination() {
        result := ComCall(9, this, "int*", &pGatherTermination := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitsgatheredevent-get_tickcount
     */
    get_TickCount() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itdigitsgatheredevent-get_callbackinstance
     */
