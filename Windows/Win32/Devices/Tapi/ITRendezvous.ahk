 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rend/nn-rend-itrendezvous
...
class ITRendezvous extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-itrendezvous-get_defaultdirectories
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-itrendezvous-enumeratedefaultdirectories
     */
    EnumerateDefaultDirectories() {
        result := ComCall(8, this, "ptr*", &ppEnumDirectory := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-itrendezvous-createdirectory
     */
    CreateDirectory(DirectoryType, pName) {
        ...
        result := ComCall(9, this, "int", DirectoryType, "ptr", pName, "ptr*", &ppDir := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-itrendezvous-createdirectoryobject
     */
    CreateDirectoryObject(DirectoryObjectType, pName) {
        ...
        result := ComCall(10, this, "int", DirectoryObjectType, "ptr", pName, "ptr*", &ppDirectoryObject := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
