 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itprivateevent
...
class ITPrivateEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itprivateevent-get_address
     */
    get_Address() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itprivateevent-get_call
     */
    get_Call() {
        result := ComCall(8, this, "ptr*", &ppCallInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itprivateevent-get_callhub
     */
    get_CallHub() {
        result := ComCall(9, this, "ptr*", &ppCallHub := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itprivateevent-get_eventcode
     */
    get_EventCode() {
        result := ComCall(10, this, "int*", &plEventCode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itprivateevent-get_eventinterface
     */
    get_EventInterface() {
        result := ComCall(11, this, "ptr*", &pEventInterface := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
