...
export default struct ITTAPI extends IDispatch {
    ...
    */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api/tapi3if/nf-tapi3if-ittapi-initialize
     */
    Initialize() {
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.RegisterCallNotifications := CallbackCreate(ObjBindMethod(implObj, "RegisterCallNotifications"), flags, 7)
        this.vtbl.UnregisterNotifications := CallbackCreate(ObjBindMethod(implObj, "UnregisterNotifications"), flags, 2)
        this.vtbl.get_CallHubs := CallbackCreate(ObjBindMethod(implObj, "get_CallHubs"), flags, 2)
        this.vtbl.EnumerateCallHubs := CallbackCreate(ObjBindMethod(implObj, "EnumerateCallHubs"), flags, 2)
        this.vtbl.SetCallHubTracking := CallbackCreate(ObjBindMethod(implObj, "SetCallHubTracking"), flags, 3)
        this.vtbl.EnumeratePrivateTAPIObjects := CallbackCreate(ObjBindMethod(implObj, "EnumeratePrivateTAPIObjects"), flags, 2)
        this.vtbl.get_PrivateTAPIObjects := CallbackCreate(ObjBindMethod(implObj, "get_PrivateTAPIObjects"), flags, 2)
        this.vtbl.RegisterRequestRecipient := CallbackCreate(ObjBindMethod(implObj, "RegisterRequestRecipient"), flags, 4)
        this.vtbl.SetAssistedTelephonyPriority := CallbackCreate(ObjBindMethod(implObj, "SetAssistedTelephonyPriority"), flags, 3)
        this.vtbl.SetApplicationPriority := CallbackCreate(ObjBindMethod(implObj, "SetApplicationPriority"), flags, 4)
