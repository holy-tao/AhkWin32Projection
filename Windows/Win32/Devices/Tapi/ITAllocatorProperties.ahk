...
/**
 * The ITAllocatorProperties interface (tapi3.h) exposes the buffer allocator properties of the Media Streaming Terminal (MST) to an end-user or server application.
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nn-tapi3-itallocatorproperties
...
class ITAllocatorProperties extends IUnknown{
    ...
    /**
     * The ITAllocatorProperties::SetAllocatorProperties (tapi3.h) method must be called before connection and will force the MSP to use these values during filter negotiation.
     * @remarks
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-setallocatorproperties
     */
    ...
    /**
     * The ITAllocatorProperties::GetAllocatorProperties (tapi3.h) method gets the values for the allocator properties after connection and provides the negotiated values.
     * @returns {ALLOCATOR_PROPERTIES} Pointer to current allocator values.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-getallocatorproperties
     */
    ...
    /**
     * The ITAllocatorProperties::SetAllocateBuffers (tapi3.h) method determines whether the current allocator buffers must be set.
     * @param {BOOL} bAllocBuffers Boolean indicator of whether allocator buffers must be set.
     * @returns {HRESULT} If the method succeeds, it returns S_OK. Otherwise, it returns an error value.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-setallocatebuffers
     */
    ...
    /**
     * The ITAllocatorProperties::GetAllocateBuffers (tapi3.h) method determines whether the current allocator buffers can be retrieved.
     * @returns {BOOL} Indicates whether allocator buffers have been set.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-getallocatebuffers
     */
    GetAllocateBuffers() {
        result := ComCall(6, this, "int*", &pbAllocBuffers := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    /**
     * The ITAllocatorProperties::SetBufferSize (tapi3.h) method sets the size of the allocator buffer.
     * @param {Integer} BufferSize Size of the allocator buffer.
     * @returns {HRESULT} If the method succeeds, it returns S_OK. Otherwise, it returns an error value.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-setbuffersize
     */
    ...
    /**
     * The ITAllocatorProperties::GetBufferSize (tapi3.h) method gets the size of the allocator buffer.
     * @returns {Integer} Size of current allocator buffer.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/nf-tapi3-itallocatorproperties-getbuffersize
     */
    GetBufferSize() {
        result := ComCall(8, this, "uint*", &pBufferSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
