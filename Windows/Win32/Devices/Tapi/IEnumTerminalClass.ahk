 ...
 * @see https://learn.microsoft.com/windows/win32/api/tapi3if/nn-tapi3if-ienumterminalclass
 * @namespace Windows.Win32.Devices.Tapi
 */
export default struct IEnumTerminalClass extends IUnknown {
    /**
     ...
     * used for IEnumTerminalClass interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IEnumTerminalClass.Vtbl()
        }
    ...
    Query(iid) {
        if (IEnumTerminalClass.IID.Equals(iid)) {
            return true
        }
