 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-ienumterminalclass
...
class IEnumTerminalClass extends IUnknown{
     ...
     * @returns {Guid} Pointer to list of elements returned.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ienumterminalclass-next
     */
    Next(celt, pceltFetched) {
        pceltFetchedMarshal := pceltFetched is VarRef ? "uint*" : "ptr"

        pElements := Guid()
        result := ComCall(3, this, "uint", celt, "ptr", pElements, pceltFetchedMarshal, pceltFetched, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ienumterminalclass-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ienumterminalclass-skip
     */
    Skip(celt) {
     ...
     * @returns {IEnumTerminalClass} Pointer to new 
     * <a href="https://docs.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-ienumterminalclass">IEnumTerminalClass</a> interface.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-ienumterminalclass-clone
     */
    Clone() {
