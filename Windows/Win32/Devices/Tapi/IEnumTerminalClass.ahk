...
class IEnumTerminalClass extends IUnknown{
     ...
     * @see https://docs.microsoft.com/windows/win32/api//tapi3if/nf-tapi3if-ienumterminalclass-next
     */
     ...
     * </tr>
     * </table>
     * @see https://docs.microsoft.com/windows/win32/api//tapi3if/nf-tapi3if-ienumterminalclass-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://docs.microsoft.com/windows/win32/api//tapi3if/nf-tapi3if-ienumterminalclass-skip
     */
    Skip(celt) {
     ...
     * @see https://docs.microsoft.com/windows/win32/api//tapi3if/nf-tapi3if-ienumterminalclass-clone
     */
    Clone() {
