...
/**
 * The AGENT_STATE enumeration (tapi3.h) is used by the ITAgent::put_State and ITAgent::get_State methods to describe the agent state.
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3/ne-tapi3-agent_state
