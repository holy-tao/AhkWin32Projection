 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itaddressdevicespecificevent
...
class ITAddressDeviceSpecificEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressdevicespecificevent-get_address
     */
    get_Address() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressdevicespecificevent-get_call
     */
    get_Call() {
        result := ComCall(8, this, "ptr*", &ppCall := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressdevicespecificevent-get_lparam1
     */
    get_lParam1() {
        result := ComCall(9, this, "int*", &pParam1 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Pointer to a <b>long</b> concerning information on the address device event.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressdevicespecificevent-get_lparam2
     */
    get_lParam2() {
        result := ComCall(10, this, "int*", &pParam2 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {Integer} Pointer to a <b>long</b> concerning information on the address device event.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itaddressdevicespecificevent-get_lparam3
     */
    get_lParam3() {
        result := ComCall(11, this, "int*", &pParam3 := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
