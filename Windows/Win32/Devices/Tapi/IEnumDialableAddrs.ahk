 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/rend/nn-rend-ienumdialableaddrs
...
class IEnumDialableAddrs extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-ienumdialableaddrs-next
     */
    Next(celt, pcFetched) {
        pcFetchedMarshal := pcFetched is VarRef ? "uint*" : "ptr"

        ppElements := BSTR()
        result := ComCall(3, this, "uint", celt, "ptr", ppElements, pcFetchedMarshal, pcFetched, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-ienumdialableaddrs-reset
     */
    Reset() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-ienumdialableaddrs-skip
     */
    Skip(celt) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/rend/nf-rend-ienumdialableaddrs-clone
     */
    Clone() {
