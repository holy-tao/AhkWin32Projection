 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itrequestevent
...
class ITRequestEvent extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_registrationinstance
     */
    get_RegistrationInstance() {
        result := ComCall(7, this, "int*", &plRegistrationInstance := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_requestmode
     */
    get_RequestMode() {
        result := ComCall(8, this, "int*", &plRequestMode := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_destaddress
     */
    get_DestAddress() {
        ppDestAddress := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_appname
     */
    get_AppName() {
        ppAppName := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_calledparty
     */
    get_CalledParty() {
        ppCalledParty := BSTR()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itrequestevent-get_comment
     */
    get_Comment() {
        ppComment := BSTR()
