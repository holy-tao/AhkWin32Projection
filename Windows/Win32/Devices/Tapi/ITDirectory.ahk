...
export default struct ITDirectory extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.get_DirectoryType := CallbackCreate(ObjBindMethod(implObj, "get_DirectoryType"), flags, 2)
        this.vtbl.get_DisplayName := CallbackCreate(ObjBindMethod(implObj, "get_DisplayName"), flags, 2)
        this.vtbl.get_IsDynamic := CallbackCreate(ObjBindMethod(implObj, "get_IsDynamic"), flags, 2)
        this.vtbl.get_DefaultObjectTTL := CallbackCreate(ObjBindMethod(implObj, "get_DefaultObjectTTL"), flags, 2)
        this.vtbl.put_DefaultObjectTTL := CallbackCreate(ObjBindMethod(implObj, "put_DefaultObjectTTL"), flags, 2)
        this.vtbl.EnableAutoRefresh := CallbackCreate(ObjBindMethod(implObj, "EnableAutoRefresh"), flags, 2)
        ...
        this.vtbl.AddDirectoryObject := CallbackCreate(ObjBindMethod(implObj, "AddDirectoryObject"), flags, 2)
        this.vtbl.ModifyDirectoryObject := CallbackCreate(ObjBindMethod(implObj, "ModifyDirectoryObject"), flags, 2)
        this.vtbl.RefreshDirectoryObject := CallbackCreate(ObjBindMethod(implObj, "RefreshDirectoryObject"), flags, 2)
        this.vtbl.DeleteDirectoryObject := CallbackCreate(ObjBindMethod(implObj, "DeleteDirectoryObject"), flags, 2)
        this.vtbl.get_DirectoryObjects := CallbackCreate(ObjBindMethod(implObj, "get_DirectoryObjects"), flags, 4)
        this.vtbl.EnumerateDirectoryObjects := CallbackCreate(ObjBindMethod(implObj, "EnumerateDirectoryObjects"), flags, 4)
    }
