 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itscriptableaudioformat
...
class ITScriptableAudioFormat extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_channels
     */
    get_Channels() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_channels
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/dd757713(v=vs.85)">WAVEFORMATEX</a> structure.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_samplespersec
     */
    get_SamplesPerSec() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_samplespersec
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/dd757713(v=vs.85)">WAVEFORMATEX</a> structure.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_avgbytespersec
     */
    get_AvgBytesPerSec() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_avgbytespersec
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/dd757713(v=vs.85)">WAVEFORMATEX</a> structure.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_blockalign
     */
    get_BlockAlign() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_blockalign
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/dd757713(v=vs.85)">WAVEFORMATEX</a> structure.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_bitspersample
     */
    get_BitsPerSample() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_bitspersample
     */
     ...
     * <a href="https://docs.microsoft.com/previous-versions/dd757713(v=vs.85)">WAVEFORMATEX</a> structure.
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-get_formattag
     */
    get_FormatTag() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itscriptableaudioformat-put_formattag
     */
