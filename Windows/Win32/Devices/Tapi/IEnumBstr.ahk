 ...
 */
export default struct IEnumBstr extends IUnknown {
    /**
    ...
    */
    ...
    Next(celt, pceltFetched) {
        ...
        ppStrings := BSTR.Owned()
        result := ComCall(3, this, UInt32, celt, BSTR.Ptr, ppStrings, pceltFetchedMarshal, pceltFetched, "HRESULT")
        return ppStrings
    }
