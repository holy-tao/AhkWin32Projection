...
export default struct ITAutomatedPhoneControl extends IDispatch {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.StartTone := CallbackCreate(ObjBindMethod(implObj, "StartTone"), flags, 3)
        this.vtbl.StopTone := CallbackCreate(ObjBindMethod(implObj, "StopTone"), flags, 1)
        this.vtbl.get_Tone := CallbackCreate(ObjBindMethod(implObj, "get_Tone"), flags, 2)
        this.vtbl.StartRinger := CallbackCreate(ObjBindMethod(implObj, "StartRinger"), flags, 3)
        this.vtbl.StopRinger := CallbackCreate(ObjBindMethod(implObj, "StopRinger"), flags, 1)
        this.vtbl.get_Ringer := CallbackCreate(ObjBindMethod(implObj, "get_Ringer"), flags, 2)
        this.vtbl.put_PhoneHandlingEnabled := CallbackCreate(ObjBindMethod(implObj, "put_PhoneHandlingEnabled"), flags, 2)
        this.vtbl.get_PhoneHandlingEnabled := CallbackCreate(ObjBindMethod(implObj, "get_PhoneHandlingEnabled"), flags, 2)
        this.vtbl.put_AutoEndOfNumberTimeout := CallbackCreate(ObjBindMethod(implObj, "put_AutoEndOfNumberTimeout"), flags, 2)
        this.vtbl.get_AutoEndOfNumberTimeout := CallbackCreate(ObjBindMethod(implObj, "get_AutoEndOfNumberTimeout"), flags, 2)
        this.vtbl.put_AutoDialtone := CallbackCreate(ObjBindMethod(implObj, "put_AutoDialtone"), flags, 2)
        this.vtbl.get_AutoDialtone := CallbackCreate(ObjBindMethod(implObj, "get_AutoDialtone"), flags, 2)
        this.vtbl.put_AutoStopTonesOnOnHook := CallbackCreate(ObjBindMethod(implObj, "put_AutoStopTonesOnOnHook"), flags, 2)
        this.vtbl.get_AutoStopTonesOnOnHook := CallbackCreate(ObjBindMethod(implObj, "get_AutoStopTonesOnOnHook"), flags, 2)
        this.vtbl.put_AutoStopRingOnOffHook := CallbackCreate(ObjBindMethod(implObj, "put_AutoStopRingOnOffHook"), flags, 2)
        this.vtbl.get_AutoStopRingOnOffHook := CallbackCreate(ObjBindMethod(implObj, "get_AutoStopRingOnOffHook"), flags, 2)
        this.vtbl.put_AutoKeypadTones := CallbackCreate(ObjBindMethod(implObj, "put_AutoKeypadTones"), flags, 2)
        this.vtbl.get_AutoKeypadTones := CallbackCreate(ObjBindMethod(implObj, "get_AutoKeypadTones"), flags, 2)
        this.vtbl.put_AutoKeypadTonesMinimumDuration := CallbackCreate(ObjBindMethod(implObj, "put_AutoKeypadTonesMinimumDuration"), flags, 2)
        this.vtbl.get_AutoKeypadTonesMinimumDuration := CallbackCreate(ObjBindMethod(implObj, "get_AutoKeypadTonesMinimumDuration"), flags, 2)
        this.vtbl.put_AutoVolumeControl := CallbackCreate(ObjBindMethod(implObj, "put_AutoVolumeControl"), flags, 2)
        this.vtbl.get_AutoVolumeControl := CallbackCreate(ObjBindMethod(implObj, "get_AutoVolumeControl"), flags, 2)
        this.vtbl.put_AutoVolumeControlStep := CallbackCreate(ObjBindMethod(implObj, "put_AutoVolumeControlStep"), flags, 2)
        this.vtbl.get_AutoVolumeControlStep := CallbackCreate(ObjBindMethod(implObj, "get_AutoVolumeControlStep"), flags, 2)
        this.vtbl.put_AutoVolumeControlRepeatDelay := CallbackCreate(ObjBindMethod(implObj, "put_AutoVolumeControlRepeatDelay"), flags, 2)
        this.vtbl.get_AutoVolumeControlRepeatDelay := CallbackCreate(ObjBindMethod(implObj, "get_AutoVolumeControlRepeatDelay"), flags, 2)
        this.vtbl.put_AutoVolumeControlRepeatPeriod := CallbackCreate(ObjBindMethod(implObj, "put_AutoVolumeControlRepeatPeriod"), flags, 2)
        this.vtbl.get_AutoVolumeControlRepeatPeriod := CallbackCreate(ObjBindMethod(implObj, "get_AutoVolumeControlRepeatPeriod"), flags, 2)
        this.vtbl.SelectCall := CallbackCreate(ObjBindMethod(implObj, "SelectCall"), flags, 3)
        this.vtbl.UnselectCall := CallbackCreate(ObjBindMethod(implObj, "UnselectCall"), flags, 2)
        this.vtbl.EnumerateSelectedCalls := CallbackCreate(ObjBindMethod(implObj, "EnumerateSelectedCalls"), flags, 2)
        this.vtbl.get_SelectedCalls := CallbackCreate(ObjBindMethod(implObj, "get_SelectedCalls"), flags, 2)
    }
