 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itcallhub
...
class ITCallHub extends IDispatch{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallhub-clear
     */
    Clear() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallhub-enumeratecalls
     */
    EnumerateCalls() {
        result := ComCall(8, this, "ptr*", &ppEnumCall := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallhub-get_calls
     */
    get_Calls() {
        pCalls := VARIANT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallhub-get_numcalls
     */
    get_NumCalls() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itcallhub-get_state
     */
    get_State() {
