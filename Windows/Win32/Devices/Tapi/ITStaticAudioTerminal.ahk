 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nn-tapi3if-itstaticaudioterminal
...
class ITStaticAudioTerminal extends IDispatch{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/tapi3if/nf-tapi3if-itstaticaudioterminal-get_waveid
     */
    get_WaveId() {
        result := ComCall(7, this, "int*", &plWaveId := 0, "int")
        if(result != 0) {
