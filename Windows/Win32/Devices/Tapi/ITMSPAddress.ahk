 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/msp/nn-msp-itmspaddress
...
class ITMSPAddress extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-initialize
     */
    Initialize(hEvent) {
        hEventMarshal := hEvent is VarRef ? "int*" : "ptr"

        result := ComCall(3, this, hEventMarshal, hEvent, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-shutdown
     */
    Shutdown() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-createmspcall
     */
    CreateMSPCall(hCall, dwReserved, dwMediaType, pOuterUnknown) {
        hCallMarshal := hCall is VarRef ? "int*" : "ptr"

        result := ComCall(5, this, hCallMarshal, hCall, "uint", dwReserved, "uint", dwMediaType, "ptr", pOuterUnknown, "ptr*", &ppStreamControl := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-shutdownmspcall
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-receivetspdata
     */
    ReceiveTSPData(pMSPCall, pBuffer, dwSize) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(7, this, "ptr", pMSPCall, pBufferMarshal, pBuffer, "uint", dwSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/msp/nf-msp-itmspaddress-getevent
     */
    GetEvent(pdwSize, pEventBuffer) {
        pdwSizeMarshal := pdwSize is VarRef ? "uint*" : "ptr"
        pEventBufferMarshal := pEventBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(8, this, pdwSizeMarshal, pdwSize, pEventBufferMarshal, pEventBuffer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
