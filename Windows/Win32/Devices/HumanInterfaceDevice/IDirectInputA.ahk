 ...
 * @charset ANSI
 */
export default struct IDirectInputA extends IUnknown {
    /**
     ...
     * used for IDirectInputA interfaces
    */
    ...
    CreateDevice(param0, param2) {
        ...
        return IDirectInputDeviceA(param1)
    }
    ...
    Query(iid) {
        if (IDirectInputA.IID.Equals(iid)) {
            return true
        }
