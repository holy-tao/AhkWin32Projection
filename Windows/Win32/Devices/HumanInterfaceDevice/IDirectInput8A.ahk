...
class IDirectInput8A extends IUnknown{
    ...
    EnumDevices(param0, param1, param2, param3) {
        result := ComCall(4, this, "uint", param0, "ptr", param1, "ptr", param2, "uint", param3, "int")
        if(result != 0)
            throw OSError(result)
    ...
    EnumDevicesBySemantics(param0, param1, param2, param3, param4) {
        result := ComCall(9, this, "ptr", param0, "ptr", param1, "ptr", param2, "ptr", param3, "uint", param4, "int")
        if(result != 0)
            throw OSError(result)
    ...
    ConfigureDevices(param0, param1, param2, param3) {
        result := ComCall(10, this, "ptr", param0, "ptr", param1, "uint", param2, "ptr", param3, "int")
        if(result != 0)
            throw OSError(result)
