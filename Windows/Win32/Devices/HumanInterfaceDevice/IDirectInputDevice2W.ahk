 ...
 * @charset Unicode
 */
export default struct IDirectInputDevice2W extends IDirectInputDeviceW {
    /**
     ...
     * used for IDirectInputDevice2W interfaces
    */
    struct Vtbl extends IDirectInputDeviceW.Vtbl {
        CreateEffect             : IntPtr
        EnumEffects              : IntPtr
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirectInputDevice2W.Vtbl()
        }
    ...
    Query(iid) {
        if (IDirectInputDevice2W.IID.Equals(iid)) {
            return true
        }
