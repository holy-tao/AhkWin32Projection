 ...
 * @version v4.0.30319
 */
class PHIDP_INSERT_SCANCODES extends IUnknown {
     ...
     */
    Invoke(Context_, NewScanCodes, Length) {
        Context_Marshal := Context_ is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, Context_Marshal, Context_, "ptr", NewScanCodes, "uint", Length, "char")
        return result
    }
}
