 ...
 * @charset Unicode
 */
export default struct IDirectInputDevice8W extends IUnknown {
    /**
     * The interface identifier for IDirectInputDevice8W
     * @type {Guid}
     */
    static IID := Guid("{54d41081-dc15-4833-a41b-748f73a38179}")
     ...
     * used for IDirectInputDevice8W interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IDirectInputDevice8W.Vtbl()
        }
     ...
     * @param {Pointer<LPDIENUMDEVICEOBJECTSCALLBACKW>} param0 
    ...
    GetObjectInfo(param0, param1, param2) {
        result := ComCall(14, this, DIDEVICEOBJECTINSTANCEW.Ptr, param0, UInt32, param1, UInt32, param2, "HRESULT")
        return result
    }
    ...
    GetDeviceInfo(param0) {
        result := ComCall(15, this, DIDEVICEINSTANCEW.Ptr, param0, "HRESULT")
        return result
    }
    ...
    GetEffectInfo(param0, param1) {
        result := ComCall(20, this, DIEFFECTINFOW.Ptr, param0, Guid.Ptr, param1, "HRESULT")
        return result
    }
    ...
    BuildActionMap(param0, param1, param2) {
        ...
        result := ComCall(29, this, DIACTIONFORMATW.Ptr, param0, "ptr", param1, UInt32, param2, "HRESULT")
        return result
    }
    ...
    SetActionMap(param0, param1, param2) {
        ...
        result := ComCall(30, this, DIACTIONFORMATW.Ptr, param0, "ptr", param1, UInt32, param2, "HRESULT")
        return result
    }
     ...
     */
    GetImageInfo(param0) {
        result := ComCall(31, this, DIDEVICEIMAGEINFOHEADERW.Ptr, param0, "HRESULT")
        return result
    }

    _Query(iid) {
        if (IDirectInputDevice8W.IID.Equals(iid)) {
            return true
        }
