...
class IDirectInputDevice8W extends IUnknown{
    ...
    EnumObjects(param0, param1, param2) {
        result := ComCall(4, this, "ptr", param0, "ptr", param1, "uint", param2, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetDeviceState(param0, param1) {
        result := ComCall(9, this, "uint", param0, "ptr", param1, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetDeviceData(param0, param1, param2, param3) {
        result := ComCall(10, this, "uint", param0, "ptr", param1, "uint*", param2, "uint", param3, "int")
        if(result != 0)
            throw OSError(result)
