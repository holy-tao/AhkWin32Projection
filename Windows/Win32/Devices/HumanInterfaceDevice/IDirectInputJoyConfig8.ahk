...
export default struct IDirectInputJoyConfig8 extends IUnknown {
    ...
    */
    ...
    SetTypeInfo(param0, param1, param2, param3) {
        ...
        result := ComCall(9, this, "ptr", param0, DIJOYTYPEINFO.Ptr, param1, UInt32, param2, "ptr", param3, "HRESULT")
        return result
    }
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.SetTypeInfo := CallbackCreate(ObjBindMethod(implObj, "SetTypeInfo"), flags, 5)
        ...
        this.vtbl.OpenAppStatusKey := CallbackCreate(ObjBindMethod(implObj, "OpenAppStatusKey"), flags, 2)
    }
