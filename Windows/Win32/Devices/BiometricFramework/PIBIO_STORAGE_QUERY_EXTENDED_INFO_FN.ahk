 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_storage_query_extended_info_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN) {
     ...
     * </table>
     */
    Call(Pipeline, StorageInfo, StorageInfoSize) {
        result := DllCall(this.value, WINBIO_PIPELINE.Ptr, Pipeline, IntPtr, StorageInfo, IntPtr, StorageInfoSize, "HRESULT")
        return result
    }

    /**
     * A PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN {
        /**
         * Creates a PIBIO_STORAGE_QUERY_EXTENDED_INFO_FN pointer that invokes the given AHK function when called.
