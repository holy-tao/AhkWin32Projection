        ...
        Verify{
            get {
                if(!this.HasProp("__Verify"))
                    this.__Verify := %this.__Class%._Verify(0, this)
        ...
        EnrollBegin{
            get {
                if(!this.HasProp("__EnrollBegin"))
                    this.__EnrollBegin := %this.__Class%._EnrollBegin(0, this)
        ...
        EnrollCapture{
            get {
                if(!this.HasProp("__EnrollCapture"))
                    this.__EnrollCapture := %this.__Class%._EnrollCapture(0, this)
        ...
        EnrollCommit{
            get {
                if(!this.HasProp("__EnrollCommit"))
                    this.__EnrollCommit := %this.__Class%._EnrollCommit(0, this)
        ...
        EnumEnrollments{
            get {
                if(!this.HasProp("__EnumEnrollments"))
                    this.__EnumEnrollments := %this.__Class%._EnumEnrollments(0, this)
        ...
        CaptureSample{
            get {
                if(!this.HasProp("__CaptureSample"))
                    this.__CaptureSample := %this.__Class%._CaptureSample(0, this)
        ...
        DeleteTemplate{
            get {
                if(!this.HasProp("__DeleteTemplate"))
                    this.__DeleteTemplate := %this.__Class%._DeleteTemplate(0, this)
        ...
        GetProperty{
            get {
                if(!this.HasProp("__GetProperty"))
                    this.__GetProperty := %this.__Class%._GetProperty(0, this)
        ...
        SetProperty{
            get {
                if(!this.HasProp("__SetProperty"))
                    this.__SetProperty := %this.__Class%._SetProperty(0, this)
        ...
        GetEvent{
            get {
                if(!this.HasProp("__GetEvent"))
                    this.__GetEvent := %this.__Class%._GetEvent(0, this)
        ...
        ControlUnit{
            get {
                if(!this.HasProp("__ControlUnit"))
                    this.__ControlUnit := %this.__Class%._ControlUnit(0, this)
        ...
        EnumServiceProviders{
            get {
                if(!this.HasProp("__EnumServiceProviders"))
                    this.__EnumServiceProviders := %this.__Class%._EnumServiceProviders(0, this)
        ...
        EnumBiometricUnits{
            get {
                if(!this.HasProp("__EnumBiometricUnits"))
                    this.__EnumBiometricUnits := %this.__Class%._EnumBiometricUnits(0, this)
        ...
        EnumDatabases{
            get {
                if(!this.HasProp("__EnumDatabases"))
                    this.__EnumDatabases := %this.__Class%._EnumDatabases(0, this)
        ...
        VerifyAndReleaseTicket{
            get {
                if(!this.HasProp("__VerifyAndReleaseTicket"))
                    this.__VerifyAndReleaseTicket := %this.__Class%._VerifyAndReleaseTicket(0, this)
        ...
        IdentifyAndReleaseTicket{
            get {
                if(!this.HasProp("__IdentifyAndReleaseTicket"))
                    this.__IdentifyAndReleaseTicket := %this.__Class%._IdentifyAndReleaseTicket(0, this)
        ...
        EnrollSelect{
            get {
                if(!this.HasProp("__EnrollSelect"))
                    this.__EnrollSelect := %this.__Class%._EnrollSelect(0, this)
        ...
        MonitorPresence{
            get {
                if(!this.HasProp("__MonitorPresence"))
                    this.__MonitorPresence := %this.__Class%._MonitorPresence(0, this)
        ...
        GetProtectionPolicy{
            get {
                if(!this.HasProp("__GetProtectionPolicy"))
                    this.__GetProtectionPolicy := %this.__Class%._GetProtectionPolicy(0, this)
        ...
        NotifyUnitStatusChange{
            get {
                if(!this.HasProp("__NotifyUnitStatusChange"))
                    this.__NotifyUnitStatusChange := %this.__Class%._NotifyUnitStatusChange(0, this)
    ...
    Parameters{
        get {
            if(!this.HasProp("__Parameters"))
                this.__Parameters := %this.__Class%._Parameters_e__Union(40, this)
