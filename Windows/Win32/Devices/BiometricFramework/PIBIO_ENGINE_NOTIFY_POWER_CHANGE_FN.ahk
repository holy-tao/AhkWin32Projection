 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_engine_notify_power_change_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN) {
    ...
    /**
     * A PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN {
        /**
         * Creates a PIBIO_ENGINE_NOTIFY_POWER_CHANGE_FN pointer that invokes the given AHK function when called.
