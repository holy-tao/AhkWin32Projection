 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio/nc-winbio-pwinbio_verify_callback
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PWINBIO_VERIFY_CALLBACK extends IUnknown {
     ...
     */
    Invoke(VerifyCallbackContext, OperationStatus, UnitId, Match, RejectDetail) {
        VerifyCallbackContextMarshal := VerifyCallbackContext is VarRef ? "ptr" : "ptr"

        ComCall(3, this, VerifyCallbackContextMarshal, VerifyCallbackContext, "int", OperationStatus, "uint", UnitId, "char", Match, "uint", RejectDetail)
    }
}
