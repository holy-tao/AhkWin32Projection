 ...
 * @since windows6.1
 */
export WinBioRemoveCredential(Identity, Type) {
    result := DllCall("winbio.dll\WinBioRemoveCredential", WINBIO_IDENTITY, Identity, WINBIO_CREDENTIAL_TYPE, Type, "HRESULT")
    return result
}
 ...
 * @since windows6.1
 */
export WinBioRemoveAllCredentials() {
 ...
 * @since windows6.1
 */
export WinBioRemoveAllDomainCredentials() {
 ...
 * @since windows6.1
 */
export WinBioGetCredentialState(Identity, Type) {
    result := DllCall("winbio.dll\WinBioGetCredentialState", WINBIO_IDENTITY, Identity, WINBIO_CREDENTIAL_TYPE, Type, "int*", &CredentialState := 0, "HRESULT")
 ...
 * @since windows10.0.10240
 */
export WinBioGetEnrolledFactors(AccountOwner) {
    result := DllCall("winbio.dll\WinBioGetEnrolledFactors", WINBIO_IDENTITY.Ptr, AccountOwner, "uint*", &EnrolledFactors := 0, "HRESULT")
