 ...
 */
export default struct PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN) {
    ...
    /**
     * A PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN {
        /**
         * Creates a PIBIO_STORAGE_UPDATE_RECORD_COMMIT_FN pointer that invokes the given AHK function when called.
