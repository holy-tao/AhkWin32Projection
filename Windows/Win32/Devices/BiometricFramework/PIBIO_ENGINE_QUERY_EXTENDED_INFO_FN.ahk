 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio_adapter/nc-winbio_adapter-pibio_engine_query_extended_info_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PIBIO_ENGINE_QUERY_EXTENDED_INFO_FN extends IUnknown {
     ...
     * @param {Pointer} EngineInfo 
     * @param {Pointer} EngineInfoSize 
     ...
     */
    Invoke(Pipeline, EngineInfo, EngineInfoSize) {
        result := ComCall(3, this, "ptr", Pipeline, "ptr", EngineInfo, "ptr", EngineInfoSize, "int")
        if(result != 0) {
