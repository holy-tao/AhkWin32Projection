    ...
    class _Specific extends Win32Struct {
            ...
            EnrollmentRequirements {
                get {
                    if(!this.HasProp("__EnrollmentRequirements"))
                        this.__EnrollmentRequirements := WINBIO_EXTENDED_ENGINE_INFO._Specific._FacialFeatures._EnrollmentRequirements(4, this)
        ...
        class _Fingerprint extends Win32Struct {
            ...
            EnrollmentRequirements {
                get {
                    if(!this.HasProp("__EnrollmentRequirements"))
                        this.__EnrollmentRequirements := WINBIO_EXTENDED_ENGINE_INFO._Specific._Fingerprint._EnrollmentRequirements(4, this)
                    return this.__EnrollmentRequirements
                }
            }
        }
        ...
        class _Iris extends Win32Struct {
            ...
            EnrollmentRequirements {
                get {
                    if(!this.HasProp("__EnrollmentRequirements"))
                        this.__EnrollmentRequirements := WINBIO_EXTENDED_ENGINE_INFO._Specific._Iris._EnrollmentRequirements(4, this)
                    return this.__EnrollmentRequirements
                }
            }
        }
        ...
        class _Voice extends Win32Struct {
            ...
            EnrollmentRequirements {
                get {
                    if(!this.HasProp("__EnrollmentRequirements"))
                        this.__EnrollmentRequirements := WINBIO_EXTENDED_ENGINE_INFO._Specific._Voice._EnrollmentRequirements(4, this)
                    return this.__EnrollmentRequirements
                }
            }
        }
        ...
        FacialFeatures {
            get {
                if(!this.HasProp("__FacialFeatures"))
                    this.__FacialFeatures := WINBIO_EXTENDED_ENGINE_INFO._Specific._FacialFeatures(0, this)
        ...
        Fingerprint {
            get {
                if(!this.HasProp("__Fingerprint"))
                    this.__Fingerprint := WINBIO_EXTENDED_ENGINE_INFO._Specific._Fingerprint(0, this)
        ...
        Iris {
            get {
                if(!this.HasProp("__Iris"))
                    this.__Iris := WINBIO_EXTENDED_ENGINE_INFO._Specific._Iris(0, this)
                return this.__Iris
            }
        }
        ...
        Voice {
            get {
                if(!this.HasProp("__Voice"))
                    this.__Voice := WINBIO_EXTENDED_ENGINE_INFO._Specific._Voice(0, this)
                return this.__Voice
            }
        }
    }
    ...
    Specific {
        get {
            if(!this.HasProp("__Specific"))
                this.__Specific := WINBIO_EXTENDED_ENGINE_INFO._Specific(8, this)
