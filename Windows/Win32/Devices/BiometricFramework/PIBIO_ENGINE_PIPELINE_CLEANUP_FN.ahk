 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_engine_pipeline_cleanup_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_ENGINE_PIPELINE_CLEANUP_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_ENGINE_PIPELINE_CLEANUP_FN) {
    ...
    /**
     * A PIBIO_ENGINE_PIPELINE_CLEANUP_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_ENGINE_PIPELINE_CLEANUP_FN {
        /**
         * Creates a PIBIO_ENGINE_PIPELINE_CLEANUP_FN pointer that invokes the given AHK function when called.
