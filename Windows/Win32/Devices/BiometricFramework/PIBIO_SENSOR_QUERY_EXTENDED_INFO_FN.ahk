 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio_adapter/nc-winbio_adapter-pibio_sensor_query_extended_info_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PIBIO_SENSOR_QUERY_EXTENDED_INFO_FN extends IUnknown {
     ...
     * @param {Pointer} SensorInfo 
     * @param {Pointer} SensorInfoSize 
     ...
     */
    Invoke(Pipeline, SensorInfo, SensorInfoSize) {
        result := ComCall(3, this, "ptr", Pipeline, "ptr", SensorInfo, "ptr", SensorInfoSize, "int")
        if(result != 0) {
