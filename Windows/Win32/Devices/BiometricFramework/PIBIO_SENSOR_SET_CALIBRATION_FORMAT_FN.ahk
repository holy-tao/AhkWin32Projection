 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio_adapter/nc-winbio_adapter-pibio_sensor_set_calibration_format_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PIBIO_SENSOR_SET_CALIBRATION_FORMAT_FN extends IUnknown {
     ...
     */
    Invoke(Pipeline, Format) {
        result := ComCall(3, this, "ptr", Pipeline, "ptr", Format, "int")
        if(result != 0) {
