...
export default struct PIBIO_ENGINE_PIPELINE_INIT_FN {
    ...
    /**
     * A PIBIO_ENGINE_PIPELINE_INIT_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_ENGINE_PIPELINE_INIT_FN {
        /**
         * Creates a PIBIO_ENGINE_PIPELINE_INIT_FN pointer that invokes the given AHK function when called.
