 ...
 * </ul>
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio/nc-winbio-pwinbio_enroll_capture_callback
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PWINBIO_ENROLL_CAPTURE_CALLBACK extends IUnknown {
     ...
     * @param {Pointer<Void>} EnrollCallbackContext 
     * @param {HRESULT} OperationStatus 
     * @param {Integer} RejectDetail 
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/ktop-src/tablet/invokeidispatch
     */
    Invoke(EnrollCallbackContext, OperationStatus, RejectDetail) {
        EnrollCallbackContextMarshal := EnrollCallbackContext is VarRef ? "ptr" : "ptr"

        ComCall(3, this, EnrollCallbackContextMarshal, EnrollCallbackContext, "int", OperationStatus, "uint", RejectDetail)
    }
}
