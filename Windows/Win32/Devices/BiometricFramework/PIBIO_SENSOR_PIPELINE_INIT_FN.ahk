 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_sensor_pipeline_init_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_SENSOR_PIPELINE_INIT_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_SENSOR_PIPELINE_INIT_FN) {
    ...
    /**
     * A PIBIO_SENSOR_PIPELINE_INIT_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_SENSOR_PIPELINE_INIT_FN {
        /**
         * Creates a PIBIO_SENSOR_PIPELINE_INIT_FN pointer that invokes the given AHK function when called.
