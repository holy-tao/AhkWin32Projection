 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winbio_adapter/nc-winbio_adapter-pibio_engine_set_enrollment_parameters_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 * @version v4.0.30319
 */
class PIBIO_ENGINE_SET_ENROLLMENT_PARAMETERS_FN extends IUnknown {
     ...
     * @param {Pointer<WINBIO_EXTENDED_ENROLLMENT_PARAMETERS>} Parameters 
     ...
     */
    Invoke(Pipeline, Parameters) {
        result := ComCall(3, this, "ptr", Pipeline, "ptr", Parameters, "int")
        if(result != 0) {
