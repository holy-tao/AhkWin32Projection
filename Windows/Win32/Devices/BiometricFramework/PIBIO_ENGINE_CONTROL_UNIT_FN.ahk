...
/**
 * Performs a vendor-defined control operation that does not require elevated privilege.E
 * @remarks
 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_engine_control_unit_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_ENGINE_CONTROL_UNIT_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_ENGINE_CONTROL_UNIT_FN) {
    ...
    /**
     * A PIBIO_ENGINE_CONTROL_UNIT_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_ENGINE_CONTROL_UNIT_FN {
        /**
         * Creates a PIBIO_ENGINE_CONTROL_UNIT_FN pointer that invokes the given AHK function when called.
