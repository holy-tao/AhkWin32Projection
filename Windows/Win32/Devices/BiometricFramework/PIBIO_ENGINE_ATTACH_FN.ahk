 ...
 * @see https://learn.microsoft.com/windows/win32/api/winbio_adapter/nc-winbio_adapter-pibio_engine_attach_fn
 * @namespace Windows.Win32.Devices.BiometricFramework
 */
export default struct PIBIO_ENGINE_ATTACH_FN {
    value : IntPtr

    __value {
        set {
            if (value is PIBIO_ENGINE_ATTACH_FN) {
     ...
     * </td>
     * <td width="60%">
     * The <b>EngineContext</b> member of the <a href="https://docs.microsoft.com/windows/desktop/api/winbio_adapter/ns-winbio_adapter-winbio_pipeline">WINBIO_PIPELINE</a> structure pointed to by the <i>Pipeline</i> argument is not <b>NULL</b> or the <b>EngineHandle</b> member is not set to <b>INVALID_HANDLE_VALUE</b>.
     * 
     * </td>
     * </tr>
     * </table>
    ...
    /**
     * A PIBIO_ENGINE_ATTACH_FN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PIBIO_ENGINE_ATTACH_FN {
        /**
         * Creates a PIBIO_ENGINE_ATTACH_FN pointer that invokes the given AHK function when called.
