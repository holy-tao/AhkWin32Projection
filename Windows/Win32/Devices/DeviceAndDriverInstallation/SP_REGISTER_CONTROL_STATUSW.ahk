 ...
 * @see https://learn.microsoft.com/windows/win32/api/setupapi/ns-setupapi-sp_register_control_statusw
 * @namespace Windows.Win32.Devices.DeviceAndDriverInstallation
 * @version v4.0.30319
 * @charset Unicode
 */
class SP_REGISTER_CONTROL_STATUSW extends Win32Struct
{
    static sizeof => 20
    ...
    FileName{
        get {
            if(!this.HasProp("__FileName"))
                this.__FileName := PWSTR(this.ptr + 4)
