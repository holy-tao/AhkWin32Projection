    ...
    SourceRootPath{
        get {
            if(!this.HasProp("__SourceRootPath"))
                this.__SourceRootPath := PSTR(this.ptr + 12)
    ...
    SourcePath{
        get {
            if(!this.HasProp("__SourcePath"))
                this.__SourcePath := PSTR(this.ptr + 20)
    ...
    SourceFilename{
        get {
            if(!this.HasProp("__SourceFilename"))
                this.__SourceFilename := PSTR(this.ptr + 28)
    ...
    SourceDescription{
        get {
            if(!this.HasProp("__SourceDescription"))
                this.__SourceDescription := PSTR(this.ptr + 36)
    ...
    SourceTagfile{
        get {
            if(!this.HasProp("__SourceTagfile"))
                this.__SourceTagfile := PSTR(this.ptr + 44)
    ...
    TargetDirectory{
        get {
            if(!this.HasProp("__TargetDirectory"))
                this.__TargetDirectory := PSTR(this.ptr + 52)
    ...
    TargetFilename{
        get {
            if(!this.HasProp("__TargetFilename"))
                this.__TargetFilename := PSTR(this.ptr + 60)
    ...
    SecurityDescriptor{
        get {
            if(!this.HasProp("__SecurityDescriptor"))
                this.__SecurityDescriptor := PSTR(this.ptr + 80)
