 ...
 * @see https://learn.microsoft.com/windows/win32/api/setupapi/nc-setupapi-psp_file_callback_w
 * @namespace Windows.Win32.Devices.DeviceAndDriverInstallation
 * @charset Unicode
 */
export default struct PSP_FILE_CALLBACK_W {
    value : IntPtr

    __value {
        set {
            if (value is PSP_FILE_CALLBACK_W) {
    ...
    /**
     * A PSP_FILE_CALLBACK_W that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSP_FILE_CALLBACK_W {
        /**
         * Creates a PSP_FILE_CALLBACK_W pointer that invokes the given AHK function when called.
