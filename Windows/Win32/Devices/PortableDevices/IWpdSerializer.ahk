 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iwpdserializer
...
class IWpdSerializer extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iwpdserializer-getiportabledevicevaluesfrombuffer
     */
    GetIPortableDeviceValuesFromBuffer(pBuffer, dwInputBufferLength) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, pBufferMarshal, pBuffer, "uint", dwInputBufferLength, "ptr*", &ppParams := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iwpdserializer-writeiportabledevicevaluestobuffer
     */
    WriteIPortableDeviceValuesToBuffer(dwOutputBufferLength, pResults, pBuffer, pdwBytesWritten) {
        ...
        result := ComCall(4, this, "uint", dwOutputBufferLength, "ptr", pResults, pBufferMarshal, pBuffer, pdwBytesWrittenMarshal, pdwBytesWritten, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iwpdserializer-getbufferfromiportabledevicevalues
     */
    GetBufferFromIPortableDeviceValues(pSource, ppBuffer, pdwBufferSize) {
        ...
        result := ComCall(5, this, "ptr", pSource, ppBufferMarshal, ppBuffer, pdwBufferSizeMarshal, pdwBufferSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iwpdserializer-getserializedsize
     */
    GetSerializedSize(pSource) {
        result := ComCall(6, this, "ptr", pSource, "uint*", &pdwSize := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
