 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-iportabledeviceservicemethodcallback
...
class IPortableDeviceServiceMethodCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledeviceservicemethodcallback-oncomplete
     */
    OnComplete(hrStatus, pResults) {
        result := ComCall(3, this, "int", hrStatus, "ptr", pResults, "int")
        if(result != 0) {
