 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues
...
class IPortableDeviceValues extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getcount
     */
    GetCount(pcelt) {
        pceltMarshal := pcelt is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, pceltMarshal, pcelt, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getat
     */
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setvalue
     */
    SetValue(key, pValue) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getvalue
     */
    GetValue(key) {
        pValue := PROPVARIANT()
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setstringvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getstringvalue
     */
    GetStringValue(key) {
        result := ComCall(8, this, "ptr", key, "ptr*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setunsignedintegervalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getunsignedintegervalue
     */
    GetUnsignedIntegerValue(key) {
        result := ComCall(10, this, "ptr", key, "uint*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setsignedintegervalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getsignedintegervalue
     */
    GetSignedIntegerValue(key) {
        result := ComCall(12, this, "ptr", key, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setunsignedlargeintegervalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getunsignedlargeintegervalue
     */
    GetUnsignedLargeIntegerValue(key) {
        result := ComCall(14, this, "ptr", key, "uint*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setsignedlargeintegervalue
     */
     ...
     * @param {Pointer<PROPERTYKEY>} key A **REFPROPERTYKEY** key that specifies the item to retrieve.
     * @returns {Integer} Pointer to the retrieved **ULONG** value.
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getsignedlargeintegervalue
     */
    GetSignedLargeIntegerValue(key) {
        result := ComCall(16, this, "ptr", key, "int64*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setfloatvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getfloatvalue
     */
    GetFloatValue(key) {
        result := ComCall(18, this, "ptr", key, "float*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-seterrorvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-geterrorvalue
     */
    GetErrorValue(key) {
        result := ComCall(20, this, "ptr", key, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setkeyvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getkeyvalue
     */
    GetKeyValue(key) {
        pValue := PROPERTYKEY()
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setboolvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getboolvalue
     */
    GetBoolValue(key) {
        result := ComCall(24, this, "ptr", key, "int*", &pValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setiunknownvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getiunknownvalue
     */
    GetIUnknownValue(key) {
        result := ComCall(26, this, "ptr", key, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setguidvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getguidvalue
     */
    GetGuidValue(key) {
        pValue := Guid()
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setbuffervalue
     */
    SetBufferValue(key, pValue, cbValue) {
        pValueMarshal := pValue is VarRef ? "char*" : "ptr"

        result := ComCall(29, this, "ptr", key, pValueMarshal, pValue, "uint", cbValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getbuffervalue
     */
    GetBufferValue(key, ppValue, pcbValue) {
        ppValueMarshal := ppValue is VarRef ? "ptr*" : "ptr"
        pcbValueMarshal := pcbValue is VarRef ? "uint*" : "ptr"

        result := ComCall(30, this, "ptr", key, ppValueMarshal, ppValue, pcbValueMarshal, pcbValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setiportabledevicevaluesvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getiportabledevicevaluesvalue
     */
    GetIPortableDeviceValuesValue(key) {
        result := ComCall(32, this, "ptr", key, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setiportabledevicepropvariantcollectionvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getiportabledevicepropvariantcollectionvalue
     */
    GetIPortableDevicePropVariantCollectionValue(key) {
        result := ComCall(34, this, "ptr", key, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setiportabledevicekeycollectionvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getiportabledevicekeycollectionvalue
     */
    GetIPortableDeviceKeyCollectionValue(key) {
        result := ComCall(36, this, "ptr", key, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-setiportabledevicevaluescollectionvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-getiportabledevicevaluescollectionvalue
     */
    GetIPortableDeviceValuesCollectionValue(key) {
        result := ComCall(38, this, "ptr", key, "ptr*", &ppValue := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-removevalue
     */
    RemoveValue(key) {
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-copyvaluesfrompropertystore
     */
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-copyvaluestopropertystore
     */
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicevalues-clear
     */
    Clear() {
