 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection
...
class IPortableDevicePropVariantCollection extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-getcount
     */
    GetCount(pcElems) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-getat
     */
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-add
     */
    Add(pValue) {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-gettype
     */
    GetType() {
        result := ComCall(6, this, "ushort*", &pvt := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-changetype
     */
    ChangeType(vt) {
     ...
     * |--------------------------------------------------------------------------------------|----------------------------------|
     * | <dl> <dt>**S\_OK**</dt> </dl> | The method succeeded.<br/> |
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-clear
     */
    Clear() {
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iportabledevicepropvariantcollection-removeat
     */
    RemoveAt(dwIndex) {
