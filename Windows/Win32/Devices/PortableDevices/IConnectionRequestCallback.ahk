 ...
 * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iconnectionrequestcallback
...
class IConnectionRequestCallback extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/wpd_sdk/iconnectionrequestcallback-oncomplete
     */
    OnComplete(hrStatus) {
