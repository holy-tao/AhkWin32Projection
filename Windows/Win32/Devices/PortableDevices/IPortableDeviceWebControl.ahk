 ...
 * <div> </div>
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-iportabledevicewebcontrol
...
class IPortableDeviceWebControl extends IDispatch{
     ...
     * @returns {Pointer<IDispatch>} Contains a pointer to the <b>IDispatch</b> implementation for the WPD Automation <a href="https://docs.microsoft.com/previous-versions/windows/desktop/wiaaut/-wiaaut-device">Device</a> object.
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicewebcontrol-getdevicefromid
     */
    GetDeviceFromId(deviceId) {
        if(deviceId is String) {
            pin := BSTR.Alloc(deviceId)
            deviceId := pin.Value
        }

        result := ComCall(7, this, "ptr", deviceId, "ptr*", &ppDevice := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicewebcontrol-getdevicefromidasync
     */
