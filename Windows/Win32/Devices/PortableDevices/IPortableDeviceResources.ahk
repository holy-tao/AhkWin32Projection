 ...
 */
export default struct IPortableDeviceResources extends IUnknown {
    /**
     ...
     * used for IPortableDeviceResources interfaces
    */
    struct Vtbl extends IUnknown.Vtbl {
        GetSupportedResources : IntPtr
        GetResourceAttributes : IntPtr
        GetStream             : IntPtr
        Delete                : IntPtr
        Cancel                : IntPtr
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IPortableDeviceResources.Vtbl()
        }
    ...
    GetResourceAttributes(pszObjectID, Key) {
        ...
        result := ComCall(4, this, "ptr", pszObjectID, PROPERTYKEY.Ptr, Key, "ptr*", &ppResourceAttributes := 0, "HRESULT")
    ...
    Dispose() {
        ...
        super.Dispose()
        CallbackFree(this.vtbl.GetSupportedResources)
        CallbackFree(this.vtbl.GetResourceAttributes)
