 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-iportabledevicecontent
...
class IPortableDeviceContent extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-enumobjects
     */
    EnumObjects(dwFlags, pszParentObjectID, pFilter) {
        ...
        result := ComCall(3, this, "uint", dwFlags, "ptr", pszParentObjectID, "ptr", pFilter, "ptr*", &ppEnum := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-properties
     */
    Properties() {
        result := ComCall(4, this, "ptr*", &ppProperties := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-transfer
     */
    Transfer() {
        result := ComCall(5, this, "ptr*", &ppResources := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-createobjectwithpropertiesonly
     */
    CreateObjectWithPropertiesOnly(pValues, ppszObjectID) {
        ppszObjectIDMarshal := ppszObjectID is VarRef ? "ptr*" : "ptr"

        result := ComCall(6, this, "ptr", pValues, ppszObjectIDMarshal, ppszObjectID, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-createobjectwithpropertiesanddata
     */
    CreateObjectWithPropertiesAndData(pValues, pdwOptimalWriteBufferSize, ppszCookie) {
        ...
        result := ComCall(7, this, "ptr", pValues, "ptr*", &ppData := 0, pdwOptimalWriteBufferSizeMarshal, pdwOptimalWriteBufferSize, ppszCookieMarshal, ppszCookie, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-delete
     */
    Delete(dwOptions, pObjectIDs, ppResults) {
        result := ComCall(8, this, "uint", dwOptions, "ptr", pObjectIDs, "ptr*", ppResults, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-getobjectidsfrompersistentuniqueids
     */
    GetObjectIDsFromPersistentUniqueIDs(pPersistentUniqueIDs) {
        result := ComCall(9, this, "ptr", pPersistentUniqueIDs, "ptr*", &ppObjectIDs := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-cancel
     */
    Cancel() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-move
     */
    Move(pObjectIDs, pszDestinationFolderObjectID, ppResults) {
        ...
        result := ComCall(11, this, "ptr", pObjectIDs, "ptr", pszDestinationFolderObjectID, "ptr*", ppResults, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicecontent-copy
     */
    Copy(pObjectIDs, pszDestinationFolderObjectID, ppResults) {
        pszDestinationFolderObjectID := pszDestinationFolderObjectID is String ? StrPtr(pszDestinationFolderObjectID) : pszDestinationFolderObjectID

        result := ComCall(12, this, "ptr", pObjectIDs, "ptr", pszDestinationFolderObjectID, "ptr*", ppResults, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
