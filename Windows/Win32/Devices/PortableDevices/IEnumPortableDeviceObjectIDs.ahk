 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-ienumportabledeviceobjectids
...
class IEnumPortableDeviceObjectIDs extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-ienumportabledeviceobjectids-next
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-ienumportabledeviceobjectids-skip
     */
    Skip(cObjects) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-ienumportabledeviceobjectids-reset
     */
    Reset() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-ienumportabledeviceobjectids-clone
     */
    Clone() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-ienumportabledeviceobjectids-cancel
     */
    Cancel() {
