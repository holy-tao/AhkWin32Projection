 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-iportabledeviceservicemanager
...
class IPortableDeviceServiceManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledeviceservicemanager-getdeviceservices
     */
    GetDeviceServices(pszPnPDeviceID, guidServiceCategory, pServices, pcServices) {
        ...
        result := ComCall(3, this, "ptr", pszPnPDeviceID, "ptr", guidServiceCategory, pServicesMarshal, pServices, pcServicesMarshal, pcServices, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledeviceservicemanager-getdeviceforservice
     */
    GetDeviceForService(pszPnPServiceID) {
        pszPnPServiceID := pszPnPServiceID is String ? StrPtr(pszPnPServiceID) : pszPnPServiceID

        result := ComCall(4, this, "ptr", pszPnPServiceID, "ptr*", &ppszPnPDeviceID := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
