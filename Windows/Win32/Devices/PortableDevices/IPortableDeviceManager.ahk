 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nn-portabledeviceapi-iportabledevicemanager
...
class IPortableDeviceManager extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getdevices
     */
    GetDevices(pPnPDeviceIDs, pcPnPDeviceIDs) {
        ...
        result := ComCall(3, this, pPnPDeviceIDsMarshal, pPnPDeviceIDs, pcPnPDeviceIDsMarshal, pcPnPDeviceIDs, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-refreshdevicelist
     */
    RefreshDeviceList() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getdevicefriendlyname
     */
    GetDeviceFriendlyName(pszPnPDeviceID, pDeviceFriendlyName, pcchDeviceFriendlyName) {
        ...
        result := ComCall(5, this, "ptr", pszPnPDeviceID, "ptr", pDeviceFriendlyName, pcchDeviceFriendlyNameMarshal, pcchDeviceFriendlyName, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getdevicedescription
     */
    GetDeviceDescription(pszPnPDeviceID, pDeviceDescription, pcchDeviceDescription) {
        ...
        result := ComCall(6, this, "ptr", pszPnPDeviceID, "ptr", pDeviceDescription, pcchDeviceDescriptionMarshal, pcchDeviceDescription, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getdevicemanufacturer
     */
    GetDeviceManufacturer(pszPnPDeviceID, pDeviceManufacturer, pcchDeviceManufacturer) {
        ...
        result := ComCall(7, this, "ptr", pszPnPDeviceID, "ptr", pDeviceManufacturer, pcchDeviceManufacturerMarshal, pcchDeviceManufacturer, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getdeviceproperty
     */
    GetDeviceProperty(pszPnPDeviceID, pszDevicePropertyName, pData, pcbData, pdwType) {
        ...
        result := ComCall(8, this, "ptr", pszPnPDeviceID, "ptr", pszDevicePropertyName, pDataMarshal, pData, pcbDataMarshal, pcbData, pdwTypeMarshal, pdwType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/portabledeviceapi/nf-portabledeviceapi-iportabledevicemanager-getprivatedevices
     */
    GetPrivateDevices(pPnPDeviceIDs, pcPnPDeviceIDs) {
        pPnPDeviceIDsMarshal := pPnPDeviceIDs is VarRef ? "ptr*" : "ptr"
        pcPnPDeviceIDsMarshal := pcPnPDeviceIDs is VarRef ? "uint*" : "ptr"

        result := ComCall(9, this, pPnPDeviceIDsMarshal, pPnPDeviceIDs, pcPnPDeviceIDsMarshal, pcPnPDeviceIDs, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
