 ...
 * @version v4.0.30319
 */
class alljoyn_authlistener_verifycredentials_ptr extends IUnknown {
     ...
     */
    Invoke(context_, authMechanism, peerName, credentials) {
        ...
        result := ComCall(3, this, context_Marshal, context_, "ptr", authMechanism, "ptr", peerName, "ptr", credentials, "int")
        return result
    }
}
