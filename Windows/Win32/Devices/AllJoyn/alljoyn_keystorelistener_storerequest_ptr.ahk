 ...
 */
export default struct alljoyn_keystorelistener_storerequest_ptr {
    value : IntPtr

    __value {
        set {
            if (value is alljoyn_keystorelistener_storerequest_ptr) {
    ...
    /**
     * A alljoyn_keystorelistener_storerequest_ptr that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends alljoyn_keystorelistener_storerequest_ptr {
        /**
         * Creates a alljoyn_keystorelistener_storerequest_ptr pointer that invokes the given AHK function when called.
