 ...
 */
export default struct alljoyn_observer_object_lost_ptr {
    value : IntPtr

    __value {
        set {
            if (value is alljoyn_observer_object_lost_ptr) {
    ...
    /**
     * A alljoyn_observer_object_lost_ptr that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends alljoyn_observer_object_lost_ptr {
        /**
         * Creates a alljoyn_observer_object_lost_ptr pointer that invokes the given AHK function when called.
