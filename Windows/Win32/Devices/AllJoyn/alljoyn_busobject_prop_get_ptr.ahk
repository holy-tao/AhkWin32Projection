 ...
 */
export default struct alljoyn_busobject_prop_get_ptr {
    value : IntPtr

    __value {
        set {
            if (value is alljoyn_busobject_prop_get_ptr) {
    ...
    /**
     * A alljoyn_busobject_prop_get_ptr that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends alljoyn_busobject_prop_get_ptr {
        /**
         * Creates a alljoyn_busobject_prop_get_ptr pointer that invokes the given AHK function when called.
