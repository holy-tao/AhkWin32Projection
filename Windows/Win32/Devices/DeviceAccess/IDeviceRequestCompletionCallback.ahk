 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/deviceaccess/nn-deviceaccess-idevicerequestcompletioncallback
...
class IDeviceRequestCompletionCallback extends IUnknown{
    ...
    Invoke(requestResult, bytesReturned) {
        result := ComCall(3, this, "int", requestResult, "uint", bytesReturned, "int")
        if(result != 0) {
