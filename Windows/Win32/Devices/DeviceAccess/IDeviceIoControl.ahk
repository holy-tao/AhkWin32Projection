 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/deviceaccess/nn-deviceaccess-ideviceiocontrol
...
class IDeviceIoControl extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/deviceaccess/nf-deviceaccess-ideviceiocontrol-deviceiocontrolsync
     */
    DeviceIoControlSync(ioControlCode, inputBuffer, inputBufferSize, outputBuffer, outputBufferSize, bytesReturned) {
        ...
        result := ComCall(3, this, "uint", ioControlCode, inputBufferMarshal, inputBuffer, "uint", inputBufferSize, outputBufferMarshal, outputBuffer, "uint", outputBufferSize, bytesReturnedMarshal, bytesReturned, "int")
        if(result != 0) {
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/deviceaccess/nf-deviceaccess-ideviceiocontrol-deviceiocontrolasync
     */
    DeviceIoControlAsync(ioControlCode, inputBuffer, inputBufferSize, outputBuffer, outputBufferSize, requestCompletionCallback, cancelContext) {
        ...
        result := ComCall(4, this, "uint", ioControlCode, inputBufferMarshal, inputBuffer, "uint", inputBufferSize, outputBufferMarshal, outputBuffer, "uint", outputBufferSize, "ptr", requestCompletionCallback, cancelContextMarshal, cancelContext, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/deviceaccess/nf-deviceaccess-ideviceiocontrol-canceloperation
     */
