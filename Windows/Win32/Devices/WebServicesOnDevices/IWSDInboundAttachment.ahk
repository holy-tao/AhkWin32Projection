 ...
 */
export default struct IWSDInboundAttachment extends IWSDAttachment {
    /**
     ...
     * used for IWSDInboundAttachment interfaces
    */
    ...
    __New(implObj := 0, flags := "") {
        if (NumGet(ObjGetDataPtr(this), 0, "ptr") == 0) {
            this.vtbl := IWSDInboundAttachment.Vtbl()
        }
    ...
    Query(iid) {
        if (IWSDInboundAttachment.IID.Equals(iid)) {
            return true
        }
