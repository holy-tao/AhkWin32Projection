 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nn-wsdattachment-iwsdinboundattachment
...
class IWSDInboundAttachment extends IWSDAttachment{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nf-wsdattachment-iwsdinboundattachment-read
     */
    Read(pBuffer, dwBytesToRead, pdwNumberOfBytesRead) {
        ...
        result := ComCall(3, this, pBufferMarshal, pBuffer, "uint", dwBytesToRead, pdwNumberOfBytesReadMarshal, pdwNumberOfBytesRead, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nf-wsdattachment-iwsdinboundattachment-close
     */
    Close() {
