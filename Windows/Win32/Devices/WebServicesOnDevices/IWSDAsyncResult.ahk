 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nn-wsdclient-iwsdasyncresult
...
class IWSDAsyncResult extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-setcallback
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-setwaithandle
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-hascompleted
     */
    HasCompleted() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-getasyncstate
     */
    GetAsyncState() {
        result := ComCall(6, this, "ptr*", &ppAsyncState := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-abort
     */
    Abort() {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-getevent
     */
    GetEvent() {
        pEvent := WSD_EVENT()
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdasyncresult-getendpointproxy
     */
    GetEndpointProxy() {
        result := ComCall(9, this, "ptr*", &ppEndpoint := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
