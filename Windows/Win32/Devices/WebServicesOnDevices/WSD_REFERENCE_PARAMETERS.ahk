 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdtypes/ns-wsdtypes-wsd_reference_parameters
 * @namespace Windows.Win32.Devices.WebServicesOnDevices
 * @version v4.0.30319
 */
class WSD_REFERENCE_PARAMETERS extends Win32Struct
{
    static sizeof => 8
