...
class IWSDDeviceHost extends IUnknown{
     ...
     * @param {Pointer<IWSDDeviceHostNotify>} pNotificationSink 
     * @returns {HRESULT} 
     */
     ...
     * @param {Pointer<IUnknown>} pService 
     * @returns {HRESULT} 
     */
    ...
    SignalEvent(pszServiceId, pBody, pOperation) {
        ...
        result := ComCall(14, this, "ptr", pszServiceId, "ptr", pBody, "ptr", pOperation, "int")
        if(result != 0)
            throw OSError(result)
