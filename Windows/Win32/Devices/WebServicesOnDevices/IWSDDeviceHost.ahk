 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nn-wsdhost-iwsddevicehost
...
class IWSDDeviceHost extends IUnknown{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-init
     */
    Init(pszLocalId, pContext, ppHostAddresses, dwHostAddressCount) {
        pszLocalId := pszLocalId is String ? StrPtr(pszLocalId) : pszLocalId

        result := ComCall(3, this, "ptr", pszLocalId, "ptr", pContext, "ptr*", ppHostAddresses, "uint", dwHostAddressCount, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-start
     */
    Start(ullInstanceId, pScopeList, pNotificationSink) {
        result := ComCall(4, this, "uint", ullInstanceId, "ptr", pScopeList, "ptr", pNotificationSink, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-stop
     */
    Stop() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-terminate
     */
    Terminate() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-registerporttype
     */
    RegisterPortType(pPortType) {
        result := ComCall(7, this, "ptr", pPortType, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-setmetadata
     */
    SetMetadata(pThisModelMetadata, pThisDeviceMetadata, pHostMetadata, pCustomMetadata) {
        result := ComCall(8, this, "ptr", pThisModelMetadata, "ptr", pThisDeviceMetadata, "ptr", pHostMetadata, "ptr", pCustomMetadata, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-registerservice
     */
    RegisterService(pszServiceId, pService) {
        pszServiceId := pszServiceId is String ? StrPtr(pszServiceId) : pszServiceId

        result := ComCall(9, this, "ptr", pszServiceId, "ptr", pService, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-retireservice
     */
    RetireService(pszServiceId) {
        pszServiceId := pszServiceId is String ? StrPtr(pszServiceId) : pszServiceId

        result := ComCall(10, this, "ptr", pszServiceId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-adddynamicservice
     */
    AddDynamicService(pszServiceId, pszEndpointAddress, pPortType, pPortName, pAny, pService) {
        ...
        result := ComCall(11, this, "ptr", pszServiceId, "ptr", pszEndpointAddress, "ptr", pPortType, "ptr", pPortName, "ptr", pAny, "ptr", pService, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-removedynamicservice
     */
    RemoveDynamicService(pszServiceId) {
        pszServiceId := pszServiceId is String ? StrPtr(pszServiceId) : pszServiceId

        result := ComCall(12, this, "ptr", pszServiceId, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-setservicediscoverable
     */
    SetServiceDiscoverable(pszServiceId, fDiscoverable) {
        pszServiceId := pszServiceId is String ? StrPtr(pszServiceId) : pszServiceId

        result := ComCall(13, this, "ptr", pszServiceId, "int", fDiscoverable, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdhost/nf-wsdhost-iwsddevicehost-signalevent
     */
    SignalEvent(pszServiceId, pBody, pOperation) {
        ...
        result := ComCall(14, this, "ptr", pszServiceId, pBodyMarshal, pBody, "ptr", pOperation, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
