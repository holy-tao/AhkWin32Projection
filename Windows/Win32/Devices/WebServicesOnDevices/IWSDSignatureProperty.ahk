...
class IWSDSignatureProperty extends IUnknown{
    ...
    IsMessageSigned(pbSigned) {
        result := ComCall(3, this, "ptr", pbSigned, "int")
        if(result != 0)
    ...
    IsMessageSignatureTrusted(pbSignatureTrusted) {
        result := ComCall(4, this, "ptr", pbSignatureTrusted, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pdwKeyInfoSize 
     * @returns {HRESULT} 
     */
    GetKeyInfo(pbKeyInfo, pdwKeyInfoSize) {
        result := ComCall(5, this, "ptr", pbKeyInfo, "uint*", pdwKeyInfoSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pdwSignatureSize 
     * @returns {HRESULT} 
     */
    GetSignature(pbSignature, pdwSignatureSize) {
        result := ComCall(6, this, "ptr", pbSignature, "uint*", pdwSignatureSize, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} pdwHashSize 
     * @returns {HRESULT} 
     */
    GetSignedInfoHash(pbSignedInfoHash, pdwHashSize) {
        result := ComCall(7, this, "ptr", pbSignedInfoHash, "uint*", pdwHashSize, "int")
        if(result != 0)
            throw OSError(result)
