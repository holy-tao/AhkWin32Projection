 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nn-wsdbase-iwsdsignatureproperty
...
class IWSDSignatureProperty extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsignatureproperty-ismessagesigned
     */
    IsMessageSigned() {
        result := ComCall(3, this, "int*", &pbSigned := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsignatureproperty-ismessagesignaturetrusted
     */
    IsMessageSignatureTrusted() {
        result := ComCall(4, this, "int*", &pbSignatureTrusted := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetKeyInfo(pbKeyInfo, pdwKeyInfoSize) {
        ...
        result := ComCall(5, this, "ptr", pbKeyInfo, pdwKeyInfoSizeMarshal, pdwKeyInfoSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsignatureproperty-getsignature
     */
    GetSignature(pbSignature, pdwSignatureSize) {
        pdwSignatureSizeMarshal := pdwSignatureSize is VarRef ? "uint*" : "ptr"

        result := ComCall(6, this, "ptr", pbSignature, pdwSignatureSizeMarshal, pdwSignatureSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsignatureproperty-getsignedinfohash
     */
    GetSignedInfoHash(pbSignedInfoHash, pdwHashSize) {
        pdwHashSizeMarshal := pdwHashSize is VarRef ? "uint*" : "ptr"

        result := ComCall(7, this, "ptr", pbSignedInfoHash, pdwHashSizeMarshal, pdwHashSize, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
