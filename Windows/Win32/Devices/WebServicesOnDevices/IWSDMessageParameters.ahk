 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nn-wsdbase-iwsdmessageparameters
...
class IWSDMessageParameters extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdmessageparameters-getlocaladdress
     */
    GetLocalAddress() {
        result := ComCall(3, this, "ptr*", &ppAddress := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdmessageparameters-setlocaladdress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdmessageparameters-getremoteaddress
     */
    GetRemoteAddress() {
        result := ComCall(5, this, "ptr*", &ppAddress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdmessageparameters-setremoteaddress
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdmessageparameters-getlowerparameters
     */
    GetLowerParameters() {
        result := ComCall(7, this, "ptr*", &ppTxParams := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
