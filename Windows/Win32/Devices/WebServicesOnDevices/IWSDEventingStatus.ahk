 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nn-wsdclient-iwsdeventingstatus
...
class IWSDEventingStatus extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdeventingstatus-subscriptionrenewed
     */
     ...
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdeventingstatus-subscriptionrenewalfailed
     */
     ...
     * @param {PWSTR} pszSubscriptionAction URI of the event action.
     * @returns {String} Nothing - always returns an empty string
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdclient/nf-wsdclient-iwsdeventingstatus-subscriptionended
     */
