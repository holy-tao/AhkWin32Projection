 ...
 */
export WSDCreateUdpMessageParameters() {
 ...
 * @since windows6.0.6000
 */
export WSDCreateHttpMessageParameters() {
 ...
 * @since windows6.0.6000
 */
export WSDCreateOutboundAttachment() {
 ...
 * @since windows6.0.6000
 */
export WSDXMLGetNameFromBuiltinNamespace(pszNamespace, pszName) {
 ...
 * @since windows6.0.6000
 */
export WSDCreateDiscoveryProvider(pContext) {
 ...
 * @since windows6.0.6000
 */
export WSDCreateDiscoveryPublisher(pContext) {
 ...
 * @since windows6.0.6000
 */
export WSDCreateDeviceProxy(pszDeviceId, pszLocalId, pContext) {
 ...
 * @since windows6.0.6000
 */
export WSDCreateDeviceProxyAdvanced(pszDeviceId, pDeviceAddress, pszLocalId, pContext) {
    pszDeviceId := pszDeviceId is String ? StrPtr(pszDeviceId) : pszDeviceId
    pszLocalId := pszLocalId is String ? StrPtr(pszLocalId) : pszLocalId
 ...
 * @since windows6.1
 */
export WSDCreateDeviceProxy2(pszDeviceId, pszLocalId, pContext, pConfigParams, dwConfigParamCount) {
    pszDeviceId := pszDeviceId is String ? StrPtr(pszDeviceId) : pszDeviceId
    pszLocalId := pszLocalId is String ? StrPtr(pszLocalId) : pszLocalId
 ...
 * @since windows6.0.6000
 */
export WSDCreateDeviceHost(pszLocalId, pContext) {
    pszLocalId := pszLocalId is String ? StrPtr(pszLocalId) : pszLocalId
 ...
 * @since windows6.0.6000
 */
export WSDXMLGetValueFromAny(pszNamespace, pszName, pAny) {
    pszNamespace := pszNamespace is String ? StrPtr(pszNamespace) : pszNamespace
    pszName := pszName is String ? StrPtr(pszName) : pszName

    result := DllCall("wsdapi.dll\WSDXMLGetValueFromAny", "ptr", pszNamespace, "ptr", pszName, WSDXML_ELEMENT.Ptr, pAny, PWSTR.Ptr, &ppszValue := 0, "HRESULT")
    return ppszValue
}
 ...
 * @since windows6.0.6000
 */
export WSDXMLAddSibling(pFirst, pSecond) {
    result := DllCall("wsdapi.dll\WSDXMLAddSibling", WSDXML_ELEMENT.Ptr, pFirst, WSDXML_ELEMENT.Ptr, pSecond, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export WSDXMLAddChild(pParent, pChild) {
    result := DllCall("wsdapi.dll\WSDXMLAddChild", WSDXML_ELEMENT.Ptr, pParent, WSDXML_ELEMENT.Ptr, pChild, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export WSDXMLCleanupElement(pAny) {
    result := DllCall("wsdapi.dll\WSDXMLCleanupElement", WSDXML_ELEMENT.Ptr, pAny, "HRESULT")
    return result
}
 ...
 * @since windows6.0.6000
 */
export WSDGenerateFault(pszCode, pszSubCode, pszReason, pszDetail, pContext) {
