 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsddisco/nn-wsddisco-iwsdiscoverypublishernotify
...
class IWSDiscoveryPublisherNotify extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsddisco/nf-wsddisco-iwsdiscoverypublishernotify-probehandler
     */
     ...
     * @param {IWSDMessageParameters} pMessageParameters Pointer to an <a href="https://docs.microsoft.com/windows/desktop/api/wsdbase/nn-wsdbase-iwsdmessageparameters">IWSDMessageParameters</a> interface that contains transport information associated with the received message.
     * @returns {HRESULT} The return value is not meaningful. An implementer should return S_OK.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsddisco/nf-wsddisco-iwsdiscoverypublishernotify-resolvehandler
     */
