 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nn-wsdbase-iwsdtransportaddress
...
class IWSDTransportAddress extends IWSDAddress{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdtransportaddress-getport
     */
    GetPort() {
        result := ComCall(5, this, "ushort*", &pwPort := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdtransportaddress-setport
     */
    SetPort(wPort) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdtransportaddress-gettransportaddress
     */
    GetTransportAddress() {
        result := ComCall(7, this, "ptr*", &ppszAddress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {PWSTR} String representation of the address object. Do not deallocate this pointer.
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdtransportaddress-gettransportaddressex
     */
    GetTransportAddressEx(fSafe) {
        result := ComCall(8, this, "int", fSafe, "ptr*", &ppszAddress := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdtransportaddress-settransportaddress
     */
