 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nn-wsdbase-iwsdudpaddress
...
class IWSDUdpAddress extends IWSDTransportAddress{
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-setsockaddr
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-getsockaddr
     */
    GetSockaddr() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-setexclusive
     */
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-getexclusive
     */
    GetExclusive() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-setmessagetype
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-getmessagetype
     */
    GetMessageType() {
        result := ComCall(15, this, "int*", &pMessageType := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-setttl
     */
    SetTTL(dwTTL) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-getttl
     */
    GetTTL() {
        result := ComCall(17, this, "uint*", &pdwTTL := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-setalias
     */
    SetAlias(pAlias) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdudpaddress-getalias
     */
    GetAlias() {
        pAlias := Guid()
