 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nn-wsdbase-iwsdsslclientcertificate
...
class IWSDSSLClientCertificate extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsslclientcertificate-getclientcertificate
     */
    GetClientCertificate() {
        result := ComCall(3, this, "ptr*", &ppCertContext := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdbase/nf-wsdbase-iwsdsslclientcertificate-getmappedaccesstoken
     */
    GetMappedAccessToken() {
        phToken := HANDLE()
        result := ComCall(4, this, "ptr", phToken, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
