 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdtypes/ns-wsdtypes-wsd_reference_properties
 * @namespace Windows.Win32.Devices.WebServicesOnDevices
 * @version v4.0.30319
 */
class WSD_REFERENCE_PROPERTIES extends Win32Struct
{
    static sizeof => 8
