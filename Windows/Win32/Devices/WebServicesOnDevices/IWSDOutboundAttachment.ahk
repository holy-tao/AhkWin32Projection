 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nn-wsdattachment-iwsdoutboundattachment
...
class IWSDOutboundAttachment extends IWSDAttachment{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nf-wsdattachment-iwsdoutboundattachment-write
     */
    Write(pBuffer, dwBytesToWrite) {
        pBufferMarshal := pBuffer is VarRef ? "char*" : "ptr"

        result := ComCall(3, this, pBufferMarshal, pBuffer, "uint", dwBytesToWrite, "uint*", &pdwNumberOfBytesWritten := 0, "int")
        if(result != 0) {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nf-wsdattachment-iwsdoutboundattachment-close
     */
    Close() {
     ...
     * </tr>
     * </table>
     * @see https://learn.microsoft.com/windows/win32/api//content/wsdattachment/nf-wsdattachment-iwsdoutboundattachment-abort
     */
    Abort() {
