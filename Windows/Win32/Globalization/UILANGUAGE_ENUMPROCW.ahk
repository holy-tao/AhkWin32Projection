 ...
 * @see https://learn.microsoft.com/windows/win32/api/winnls/nc-winnls-uilanguage_enumprocw
 * @namespace Windows.Win32.Globalization
 * @charset Unicode
 */
export default struct UILANGUAGE_ENUMPROCW {
    value : IntPtr

    __value {
        set {
            if (value is UILANGUAGE_ENUMPROCW) {
    ...
    /**
     * A UILANGUAGE_ENUMPROCW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends UILANGUAGE_ENUMPROCW {
        /**
         * Creates a UILANGUAGE_ENUMPROCW pointer that invokes the given AHK function when called.
         * @param {Func(PWSTR, IntPtr) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 2)) {
