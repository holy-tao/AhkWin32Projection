...
export default struct ISpellChecker extends IUnknown {
    ...
    */
    ...
    Implement(implObj, flags := "") {
        ...
        this.vtbl.Ignore := CallbackCreate(ObjBindMethod(implObj, "Ignore"), flags, 2)
        this.vtbl.AutoCorrect := CallbackCreate(ObjBindMethod(implObj, "AutoCorrect"), flags, 3)
        ...
        this.vtbl.add_SpellCheckerChanged := CallbackCreate(ObjBindMethod(implObj, "add_SpellCheckerChanged"), flags, 3)
        this.vtbl.remove_SpellCheckerChanged := CallbackCreate(ObjBindMethod(implObj, "remove_SpellCheckerChanged"), flags, 2)
