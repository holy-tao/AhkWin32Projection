...
class IMLangStringWStr extends IMLangString{
    ...
    SetWStr(lDestPos, lDestLen, pszSrc, cchSrc, pcchActual, plActualLen) {
        ...
        result := ComCall(7, this, "int", lDestPos, "int", lDestLen, "ptr", pszSrc, "int", cchSrc, pcchActualMarshal, pcchActual, plActualLenMarshal, plActualLen, "int")
        if(result != 0) {
    ...
    SetStrBufW(lDestPos, lDestLen, pSrcBuf, pcchActual, plActualLen) {
        ...
        result := ComCall(8, this, "int", lDestPos, "int", lDestLen, "ptr", pSrcBuf, pcchActualMarshal, pcchActual, plActualLenMarshal, plActualLen, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetWStr(lSrcPos, lSrcLen, pszDest, cchDest, pcchActual, plActualLen) {
        ...
        result := ComCall(9, this, "int", lSrcPos, "int", lSrcLen, "ptr", pszDest, "int", cchDest, pcchActualMarshal, pcchActual, plActualLenMarshal, plActualLen, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetStrBufW(lSrcPos, lSrcMaxLen, ppDestBuf, plDestLen) {
        ...
        result := ComCall(10, this, "int", lSrcPos, "int", lSrcMaxLen, "ptr*", ppDestBuf, plDestLenMarshal, plDestLen, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    LockWStr(lSrcPos, lSrcLen, lFlags, cchRequest, ppszDest, pcchDest, plDestLen) {
        ...
        result := ComCall(11, this, "int", lSrcPos, "int", lSrcLen, "int", lFlags, "int", cchRequest, ppszDestMarshal, ppszDest, pcchDestMarshal, pcchDest, plDestLenMarshal, plDestLen, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
