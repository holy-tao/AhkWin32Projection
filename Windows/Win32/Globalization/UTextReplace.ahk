 ...
 */
export default struct UTextReplace {
    value : IntPtr

    __value {
        set {
            if (value is UTextReplace) {
    ...
    /**
     * A UTextReplace that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends UTextReplace {
        /**
         * Creates a UTextReplace pointer that invokes the given AHK function when called.
