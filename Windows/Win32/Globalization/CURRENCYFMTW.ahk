 ...
 * 
  ...
  * 
 * @see https://docs.microsoft.com/windows/win32/api//winnls/ns-winnls-currencyfmtw
 * @namespace Windows.Win32.Globalization
 * @version v4.0.30319
 * @charset Unicode
 */
class CURRENCYFMTW extends Win32Struct
{
    static sizeof => 48
    ...
    lpDecimalSep{
        get {
            if(!this.HasProp("__lpDecimalSep"))
                this.__lpDecimalSep := PWSTR(this.ptr + 16)
    ...
    lpThousandSep{
        get {
            if(!this.HasProp("__lpThousandSep"))
                this.__lpThousandSep := PWSTR(this.ptr + 24)
    ...
    lpCurrencySymbol{
        get {
            if(!this.HasProp("__lpCurrencySymbol"))
                this.__lpCurrencySymbol := PWSTR(this.ptr + 40)
