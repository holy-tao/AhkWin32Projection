...
class IMLangStringAStr extends IMLangString{
    ...
    SetAStr(lDestPos, lDestLen, uCodePage, pszSrc, cchSrc, pcchActual, plActualLen) {
        result := ComCall(7, this, "int", lDestPos, "int", lDestLen, "uint", uCodePage, "ptr", pszSrc, "int", cchSrc, "int*", pcchActual, "int*", plActualLen, "int")
        if(result != 0)
     ...
     * @param {Integer} lDestLen 
     * @param {Integer} uCodePage 
     * @param {Pointer<IMLangStringBufA>} pSrcBuf 
     * @param {Pointer<Int32>} pcchActual 
     * @param {Pointer<Int32>} plActualLen 
     * @returns {HRESULT} 
     */
    SetStrBufA(lDestPos, lDestLen, uCodePage, pSrcBuf, pcchActual, plActualLen) {
        result := ComCall(8, this, "int", lDestPos, "int", lDestLen, "uint", uCodePage, "ptr", pSrcBuf, "int*", pcchActual, "int*", plActualLen, "int")
        if(result != 0)
            throw OSError(result)
    ...
    GetAStr(lSrcPos, lSrcLen, uCodePageIn, pszDest, cchDest, pcchActual, plActualLen) {
        ...
        result := ComCall(9, this, "int", lSrcPos, "int", lSrcLen, "uint", uCodePageIn, "uint*", puCodePageOut, "ptr", pszDest, "int", cchDest, "int*", pcchActual, "int*", plActualLen, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} puDestCodePage 
    ...
    GetStrBufA(lSrcPos, lSrcMaxLen, puDestCodePage, ppDestBuf, plDestLen) {
        result := ComCall(10, this, "int", lSrcPos, "int", lSrcMaxLen, "uint*", puDestCodePage, "ptr", ppDestBuf, "int*", plDestLen, "int")
        if(result != 0)
            throw OSError(result)
     ...
     * @param {Pointer<UInt32>} puCodePageOut 
    ...
    LockAStr(lSrcPos, lSrcLen, lFlags, uCodePageIn, cchRequest, puCodePageOut, ppszDest, pcchDest, plDestLen) {
        result := ComCall(11, this, "int", lSrcPos, "int", lSrcLen, "int", lFlags, "uint", uCodePageIn, "int", cchRequest, "uint*", puCodePageOut, "ptr", ppszDest, "int*", pcchDest, "int*", plDestLen, "int")
        if(result != 0)
            throw OSError(result)
