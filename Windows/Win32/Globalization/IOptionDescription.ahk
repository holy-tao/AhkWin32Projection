 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/spellcheck/nn-spellcheck-ioptiondescription
...
class IOptionDescription extends IUnknown{
     ...
     * @returns {PWSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/spellcheck/nf-spellcheck-ioptiondescription-get_id
     */
    get_Id() {
     ...
     * @returns {PWSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/spellcheck/nf-spellcheck-ioptiondescription-get_heading
     */
    get_Heading() {
     ...
     * @returns {PWSTR} 
     * @see https://learn.microsoft.com/windows/win32/api//content/spellcheck/nf-spellcheck-ioptiondescription-get_description
     */
    get_Description() {
     ...
     * @returns {IEnumString} 
     * @see https://learn.microsoft.com/windows/win32/api//content/spellcheck/nf-spellcheck-ioptiondescription-get_labels
     */
    get_Labels() {
