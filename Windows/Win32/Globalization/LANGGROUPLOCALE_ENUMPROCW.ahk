 ...
 * @see https://learn.microsoft.com/windows/win32/api/winnls/nc-winnls-langgrouplocale_enumprocw
 * @namespace Windows.Win32.Globalization
 * @charset Unicode
 */
export default struct LANGGROUPLOCALE_ENUMPROCW {
    value : IntPtr

    __value {
        set {
            if (value is LANGGROUPLOCALE_ENUMPROCW) {
    ...
    /**
     * A LANGGROUPLOCALE_ENUMPROCW that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends LANGGROUPLOCALE_ENUMPROCW {
        /**
         * Creates a LANGGROUPLOCALE_ENUMPROCW pointer that invokes the given AHK function when called.
         * @param {Func(UInt32, UInt32, PWSTR, IntPtr) => BOOL} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 4)) {
