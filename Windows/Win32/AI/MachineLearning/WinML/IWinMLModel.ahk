 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winml/nn-winml-iwinmlmodel
...
class IWinMLModel extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlmodel-getdescription
     */
    GetDescription() {
        result := ComCall(3, this, "ptr*", &ppDescription := 0, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlmodel-enumeratemetadata
     */
    EnumerateMetadata(Index, pKey, pValue) {
        pKeyMarshal := pKey is VarRef ? "ptr*" : "ptr"
        pValueMarshal := pValue is VarRef ? "ptr*" : "ptr"

        result := ComCall(4, this, "uint", Index, pKeyMarshal, pKey, pValueMarshal, pValue, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlmodel-enumeratemodelinputs
     */
    EnumerateModelInputs(Index) {
        result := ComCall(5, this, "uint", Index, "ptr*", &ppInputDescriptor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlmodel-enumeratemodeloutputs
     */
    EnumerateModelOutputs(Index) {
        result := ComCall(6, this, "uint", Index, "ptr*", &ppOutputDescriptor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
