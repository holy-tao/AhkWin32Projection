...
class IMLOperatorKernelFactory extends IUnknown{
    ...
    /**
     * 
     * @param {IMLOperatorKernelCreationContext} context_ 
     * @returns {Pointer<IMLOperatorKernel>} 
     */
    CreateKernel(context_) {
        result := ComCall(3, this, "ptr", context_, "ptr*", &kernel := 0, "int")
        if(result != 0) {
