 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/winml/nn-winml-iwinmlevaluationcontext
...
class IWinMLEvaluationContext extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlevaluationcontext-bindvalue
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlevaluationcontext-getvaluebyname
     */
    GetValueByName(Name) {
        Name := Name is String ? StrPtr(Name) : Name

        result := ComCall(4, this, "ptr", Name, "ptr*", &pDescriptor := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @returns {HRESULT} If this method succeeds, it returns <b>S_OK</b>. Otherwise, it returns an <b>HRESULT</b> error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/winml/nf-winml-iwinmlevaluationcontext-clear
     */
    Clear() {
