 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/directml/nn-directml-idmlobject
...
class IDMLObject extends IUnknown{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmlobject-getprivatedata
     */
    GetPrivateData(guid, dataSize, data) {
        dataSizeMarshal := dataSize is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, "ptr", guid, dataSizeMarshal, dataSize, "ptr", data, "int")
        if(result != 0) {
     ...
     * 
     * If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmlobject-setprivatedata
     */
     ...
     * 
     * If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmlobject-setprivatedatainterface
     */
     ...
     * 
     * If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmlobject-setname
     */
    SetName(name) {
