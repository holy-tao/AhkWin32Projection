 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/directml/nn-directml-idmloperatorinitializer
...
class IDMLOperatorInitializer extends IDMLDispatchable{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmloperatorinitializer-reset
     */
    Reset(operatorCount, operators) {
        result := ComCall(9, this, "uint", operatorCount, "ptr*", operators, "int")
        if(result != 0) {
