 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/windows/win32/api//content/directml/ns-directml-dml_element_wise_asinh_operator_desc
 * @namespace Windows.Win32.AI.MachineLearning.DirectML
 * @version v4.0.30319
 */
class DML_ELEMENT_WISE_ASINH_OPERATOR_DESC extends Win32Struct
{
    static sizeof => 24
