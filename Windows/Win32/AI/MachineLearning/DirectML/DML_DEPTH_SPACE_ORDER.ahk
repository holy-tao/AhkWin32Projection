...
class DML_DEPTH_SPACE_ORDER extends Win32Enum {
     ...
     * Native name: DML_DEPTH_SPACE_ORDER_DEPTH_COLUMN_ROW
     * @type {Integer (Int32)}
     */
    static DEPTH_COLUMN_ROW => 0
     ...
     * - **Space version**: [Batch, Channels, (Height, BlockHeight), (Width, BlockWidth)]
     * Native name: DML_DEPTH_SPACE_ORDER_COLUMN_ROW_DEPTH
     * @type {Integer (Int32)}
     */
    static COLUMN_ROW_DEPTH => 1
}
