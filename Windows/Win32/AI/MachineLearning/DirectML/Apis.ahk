 ...
 */
export DMLCreateDevice(d3d12Device, flags, riid) {
    result := DllCall("DirectML.dll\DMLCreateDevice", "ptr", d3d12Device, DML_CREATE_DEVICE_FLAGS, flags, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
 ...
 */
export DMLCreateDevice1(d3d12Device, flags, minimumFeatureLevel, riid) {
    result := DllCall("DirectML.dll\DMLCreateDevice1", "ptr", d3d12Device, DML_CREATE_DEVICE_FLAGS, flags, DML_FEATURE_LEVEL, minimumFeatureLevel, Guid.Ptr, riid, "ptr*", &ppv := 0, "HRESULT")
    return ppv
}
