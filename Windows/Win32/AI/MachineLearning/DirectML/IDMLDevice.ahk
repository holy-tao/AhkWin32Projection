 ...
 * @see https://learn.microsoft.com/windows/win32/api//content/directml/nn-directml-idmldevice
...
class IDMLDevice extends IDMLObject{
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-checkfeaturesupport
     */
    CheckFeatureSupport(feature, featureQueryDataSize, featureQueryData, featureSupportDataSize, featureSupportData) {
        result := ComCall(7, this, "int", feature, "uint", featureQueryDataSize, "ptr", featureQueryData, "uint", featureSupportDataSize, "ptr", featureSupportData, "int")
        if(result != 0) {
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-createoperator
     */
    CreateOperator(desc, riid) {
        result := ComCall(8, this, "ptr", desc, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-compileoperator
     */
    CompileOperator(op, flags, riid) {
        result := ComCall(9, this, "ptr", op, "int", flags, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-createoperatorinitializer
     */
    CreateOperatorInitializer(operatorCount, operators, riid) {
        result := ComCall(10, this, "uint", operatorCount, "ptr*", operators, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-createcommandrecorder
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-createbindingtable
     */
    CreateBindingTable(desc, riid) {
        result := ComCall(12, this, "ptr", desc, "ptr", riid, "ptr*", &ppv := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-evict
     */
    Evict(count, ppObjects) {
        result := ComCall(13, this, "uint", count, "ptr*", ppObjects, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * 
     * If this method succeeds, it returns **S_OK**. Otherwise, it returns an **HRESULT** error code.
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-makeresident
     */
    MakeResident(count, ppObjects) {
        result := ComCall(14, this, "uint", count, "ptr*", ppObjects, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-getdeviceremovedreason
     */
     ...
     * @see https://learn.microsoft.com/windows/win32/api//content/directml/nf-directml-idmldevice-getparentdevice
     */
