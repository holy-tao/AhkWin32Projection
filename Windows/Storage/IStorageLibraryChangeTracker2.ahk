...
class IStorageLibraryChangeTracker2 extends IInspectable{
    ...
    /**
     * The interface identifier for IStorageLibraryChangeTracker2
     * @type {Guid}
     */
    static IID => Guid("{cd051c3b-0f9f-42f9-8fb3-158d82e13821}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["EnableWithOptions", "Disable"]
     ...
     * @param {StorageLibraryChangeTrackerOptions} options 
