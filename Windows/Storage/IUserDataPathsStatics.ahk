...
class IUserDataPathsStatics extends IInspectable{
    ...
    /**
     * The interface identifier for IUserDataPathsStatics
     * @type {Guid}
     */
    static IID => Guid("{01b29def-e062-48a1-8b0c-f2c7a9ca56c0}")
