 ...
 */
class IAppDataPathsStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppDataPathsStatics
     * @type {Guid}
     */
    static IID => Guid("{d8eb2afe-a9d9-4b14-b999-e3921379d903}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetForUser", "GetDefault"]
