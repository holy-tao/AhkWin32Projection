...
class IKnownFoldersSavedPicturesStatics extends IInspectable{
    ...
    /**
     * The interface identifier for IKnownFoldersSavedPicturesStatics
     * @type {Guid}
     */
    static IID => Guid("{055c93ea-253d-467c-b6ca-a97da1e9a18d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_SavedPictures"]
