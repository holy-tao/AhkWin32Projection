...
class IVideoProperties extends IInspectable{
    ...
    /**
     * The interface identifier for IVideoProperties
     * @type {Guid}
     */
    static IID => Guid("{719ae507-68de-4db8-97de-49998c059f2f}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Rating", "put_Rating", "get_Keywords", "get_Width", "get_Height", "get_Duration", "get_Latitude", "get_Longitude", "get_Title", "put_Title", "get_Subtitle", "put_Subtitle", "get_Producers", "get_Publisher", "put_Publisher", "get_Writers", "get_Year", "put_Year", "get_Bitrate", "get_Directors", "get_Orientation"]
