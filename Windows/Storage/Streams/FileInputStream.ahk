 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.storage.streams.fileinputstream
 * @namespace Windows.Storage.Streams
 * @version WindowsRuntime 1.4
 */
class FileInputStream extends IInspectable {
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.storage.streams.fileinputstream.readasync
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.storage.streams.fileinputstream.close
     */
    Close() {
