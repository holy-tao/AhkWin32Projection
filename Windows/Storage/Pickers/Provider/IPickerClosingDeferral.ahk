 ...
 */
class IPickerClosingDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPickerClosingDeferral
     * @type {Guid}
     */
    static IID => Guid("{7af7f71e-1a67-4a31-ae80-e907708a619b}")
