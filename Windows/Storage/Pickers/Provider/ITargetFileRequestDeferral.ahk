 ...
 */
class ITargetFileRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITargetFileRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{4aee9d91-bf15-4da9-95f6-f6b7d558225b}")
