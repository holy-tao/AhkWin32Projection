...
#Include ..\..\Guid.ahk
#Include .\StorageLibraryChangeReader.ahk
...
class IStorageLibraryChangeTracker extends IInspectable{
    ...
    /**
     * The interface identifier for IStorageLibraryChangeTracker
     * @type {Guid}
     */
    static IID => Guid("{9e157316-6073-44f6-9681-7492d1286c90}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetChangeReader", "Enable", "Reset"]
    ...
    GetChangeReader() {
        ...
        return StorageLibraryChangeReader(value)
    }
