 ...
 */
class ICachedFileUpdaterUI extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICachedFileUpdaterUI
     * @type {Guid}
     */
    static IID => Guid("{9e6f41e6-baf2-4a97-b600-9333f5df80fd}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Title", "put_Title", "get_UpdateTarget", "add_FileUpdateRequested", "remove_FileUpdateRequested", "add_UIRequested", "remove_UIRequested", "get_UIStatus"]
