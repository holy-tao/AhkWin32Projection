 ...
 */
class IFileUpdateRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFileUpdateRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{ffcedb2b-8ade-44a5-bb00-164c4e72f13a}")
