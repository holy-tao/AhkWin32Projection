 ...
 */
class ISystemDataPathsStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISystemDataPathsStatics
     * @type {Guid}
     */
    static IID => Guid("{e0f96fd0-9920-4bca-b379-f96fdf7caad8}")
    ...
    GetDefault() {
        ...
        return SystemDataPaths(result_)
    }
}
