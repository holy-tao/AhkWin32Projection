 ...
 * @see https://learn.microsoft.com/uwp/api/windows.storage.search.commonfolderquery
 * @namespace Windows.Storage.Search
 * @version WindowsRuntime 1.4
 */
class CommonFolderQuery extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static GroupByPublishedYear => 107
