 ...
 * @see https://learn.microsoft.com/uwp/api/windows.storage.search.commonfilequery
 * @namespace Windows.Storage.Search
 * @version WindowsRuntime 1.4
 */
class CommonFileQuery extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static OrderByMusicProperties => 3
