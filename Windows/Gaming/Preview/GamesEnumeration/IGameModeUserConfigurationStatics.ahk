...
#Include ..\..\..\..\Guid.ahk
#Include .\GameModeUserConfiguration.ahk
 ...
 */
class IGameModeUserConfigurationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGameModeUserConfigurationStatics
     * @type {Guid}
     */
    static IID => Guid("{6e50d97c-66ea-478e-a4a1-f57c0e8d00e7}")
     ...
     */
    GetDefault() {
        result := ComCall(6, this, "ptr*", &userConfiguration := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return GameModeUserConfiguration(userConfiguration)
    }
}
