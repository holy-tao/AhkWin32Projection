 ...
 */
class IGameChatOverlayStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGameChatOverlayStatics
     * @type {Guid}
     */
    static IID => Guid("{89acf614-7867-49f7-9687-25d9dbf444d1}")
