 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument
 * @namespace Windows.Web.AtomPub
 * @version WindowsRuntime 1.4
 */
class ServiceDocument extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IServiceDocument
     ...
     * @type {Guid}
     */
    static IID => IServiceDocument.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.workspaces
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.nodenamespace
     * @type {HSTRING} 
     */
    NodeNamespace {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.nodevalue
     * @type {HSTRING} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.language
     * @type {HSTRING} 
     */
    Language {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.baseuri
     * @type {Uri} 
     */
    BaseUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.attributeextensions
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.elementextensions
...
;@region Instance Methods
     ...
     */
    get_Workspaces() {
        if (!this.HasProp("__IServiceDocument")) {
            if ((queryResult := this.QueryInterface(IServiceDocument.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IServiceDocument := IServiceDocument(outPtr)
        }

        return this.__IServiceDocument.get_Workspaces()
    }
     ...
     * @returns {XmlDocument} 
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.servicedocument.getxmldocument
     */
