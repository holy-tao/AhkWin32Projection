 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace
 * @namespace Windows.Web.AtomPub
 * @version WindowsRuntime 1.4
 */
class Workspace extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IWorkspace
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.title
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.collections
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.nodenamespace
     * @type {HSTRING} 
     */
    NodeNamespace {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.nodevalue
     * @type {HSTRING} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.language
     * @type {HSTRING} 
     */
    Language {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.baseuri
     * @type {Uri} 
     */
    BaseUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.attributeextensions
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.elementextensions
...
;@region Instance Methods
     ...
     */
    get_Title() {
        if (!this.HasProp("__IWorkspace")) {
            if ((queryResult := this.QueryInterface(IWorkspace.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IWorkspace := IWorkspace(outPtr)
        }

        return this.__IWorkspace.get_Title()
    }
    ...
    get_Collections() {
        ...
        return this.__IWorkspace.get_Collections()
    }
     ...
     * @param {Integer} format The format for the element. The only formats accepted by this method are Atom 1.0 and RSS 2.0.
     * @returns {XmlDocument} 
     * @see https://learn.microsoft.com/uwp/api/windows.web.atompub.workspace.getxmldocument
     */
