 ...
 */
class IHttpContentDispositionHeaderValue extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpContentDispositionHeaderValue
     * @type {Guid}
     */
    static IID => Guid("{f2a2eedc-2629-4b49-9908-96a168e9365e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_DispositionType", "put_DispositionType", "get_FileName", "put_FileName", "get_FileNameStar", "put_FileNameStar", "get_Name", "put_Name", "get_Parameters", "get_Size", "put_Size"]
