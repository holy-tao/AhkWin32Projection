 ...
 */
class IHttpContentCodingHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpContentCodingHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{7d221721-a6db-436e-8e83-91596192819c}")
