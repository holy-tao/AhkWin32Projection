 ...
 */
class IHttpLanguageRangeWithQualityHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpLanguageRangeWithQualityHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{885d5abd-4b4f-480a-89ce-8aedcee6e3a0}")
