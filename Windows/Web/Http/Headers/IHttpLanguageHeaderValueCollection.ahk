 ...
 */
class IHttpLanguageHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpLanguageHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{9ebd7ca3-8219-44f6-9902-8c56dfd3340c}")
