 ...
 */
class IHttpMediaTypeWithQualityHeaderValue extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpMediaTypeWithQualityHeaderValue
     * @type {Guid}
     */
    static IID => Guid("{188d5e32-76be-44a0-b1cd-2074bded2dde}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_CharSet", "put_CharSet", "get_MediaType", "put_MediaType", "get_Parameters", "get_Quality", "put_Quality"]
