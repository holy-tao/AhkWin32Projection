 ...
 */
class IHttpChallengeHeaderValueFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpChallengeHeaderValueFactory
     * @type {Guid}
     */
    static IID => Guid("{c452c451-d99c-40aa-9399-90eeb98fc613}")
    ...
    CreateFromScheme(scheme) {
        ...
        return HttpChallengeHeaderValue(value)
    }
