 ...
 */
class IHttpMediaTypeWithQualityHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpMediaTypeWithQualityHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{3c0c6b73-1342-4587-a056-18d02ff67165}")
