 ...
 */
class IHttpCredentialsHeaderValue extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpCredentialsHeaderValue
     * @type {Guid}
     */
    static IID => Guid("{c34cc3cb-542e-4177-a6c7-b674ce193fbf}")
