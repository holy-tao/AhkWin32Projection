 ...
 */
class IHttpMethodHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpMethodHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{43bc3ff4-6119-4adf-938c-34bfffcf92ed}")
