 ...
 */
class IHttpChallengeHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpChallengeHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{ca9e5f81-aee0-4353-a10b-e625babd64c2}")
