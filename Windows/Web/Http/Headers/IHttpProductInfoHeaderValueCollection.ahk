 ...
 */
class IHttpProductInfoHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpProductInfoHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{877df74a-d69b-44f8-ad4f-453af9c42ed0}")
