 ...
 */
class IHttpCookiePairHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpCookiePairHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{f3f44350-581e-4ecc-9f59-e507d04f06e6}")
