 ...
 */
class IHttpConnectionOptionHeaderValueCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpConnectionOptionHeaderValueCollection
     * @type {Guid}
     */
    static IID => Guid("{e4f56c1d-5142-4e00-8e0f-019509337629}")
