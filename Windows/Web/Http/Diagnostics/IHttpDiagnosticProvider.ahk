 ...
 */
class IHttpDiagnosticProvider extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHttpDiagnosticProvider
     * @type {Guid}
     */
    static IID => Guid("{bd811501-a056-4d39-b174-833b7b03b02c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Start", "Stop", "add_RequestSent", "remove_RequestSent", "add_ResponseReceived", "remove_ResponseReceived", "add_RequestResponseCompleted", "remove_RequestResponseCompleted"]
