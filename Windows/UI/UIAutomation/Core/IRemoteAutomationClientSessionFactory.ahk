...
class IRemoteAutomationClientSessionFactory extends IInspectable{
    ...
    /**
     * The interface identifier for IRemoteAutomationClientSessionFactory
     * @type {Guid}
     */
    static IID => Guid("{f250263d-6057-5373-a5a5-ed7265fe0376}")
    ...
    CreateInstance(name) {
        ...
        return RemoteAutomationClientSession(value)
    }
    ...
    CreateInstance2(name, sessionId) {
        ...
        result := ComCall(7, this, "ptr", name, "ptr", sessionId, "ptr*", &value := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
