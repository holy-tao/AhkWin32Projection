 ...
 */
class IWebUIActivationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebUIActivationStatics
     * @type {Guid}
     */
    static IID => Guid("{351b86bd-43b3-482b-85db-35d87b517ad9}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Activated", "remove_Activated", "add_Suspending", "remove_Suspending", "add_Resuming", "remove_Resuming", "add_Navigated", "remove_Navigated"]
