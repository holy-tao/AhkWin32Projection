 ...
 */
class IWebUIActivationStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebUIActivationStatics3
     * @type {Guid}
     */
    static IID => Guid("{91abb686-1af5-4445-b49f-9459f40fc8de}")
