...
#Include ..\..\ApplicationModel\Activation\IPrintTaskSettingsActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIPrintTaskSettingsActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs.configuration
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiprinttasksettingsactivatedeventargs.activatedoperation
