...
#Include ..\..\ApplicationModel\Activation\IAppointmentsProviderRemoveAppointmentActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIAppointmentsProviderRemoveAppointmentActivatedEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IAppointmentsProviderRemoveAppointmentActivatedEventArgs
     ...
     * @type {Guid}
     */
    static IID => IAppointmentsProviderRemoveAppointmentActivatedEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.removeappointmentoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderremoveappointmentactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
...
;@region Instance Methods
    ...
    get_RemoveAppointmentOperation() {
        if (!this.HasProp("__IAppointmentsProviderRemoveAppointmentActivatedEventArgs")) {
            if ((queryResult := this.QueryInterface(IAppointmentsProviderRemoveAppointmentActivatedEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IAppointmentsProviderRemoveAppointmentActivatedEventArgs := IAppointmentsProviderRemoveAppointmentActivatedEventArgs(outPtr)
        }

        return this.__IAppointmentsProviderRemoveAppointmentActivatedEventArgs.get_RemoveAppointmentOperation()
    }
