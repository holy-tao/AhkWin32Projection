 ...
 */
class IWebUINavigatedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebUINavigatedDeferral
     * @type {Guid}
     */
    static IID => Guid("{d804204d-831f-46e2-b432-3afce211f962}")
