...
#Include ..\..\ApplicationModel\Activation\IWebAccountProviderActivatedEventArgs.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIWebAccountProviderActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.operation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiwebaccountprovideractivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
