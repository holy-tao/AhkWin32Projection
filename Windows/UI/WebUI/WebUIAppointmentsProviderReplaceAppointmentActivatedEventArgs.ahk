...
#Include ..\..\ApplicationModel\Activation\IAppointmentsProviderReplaceAppointmentActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIAppointmentsProviderReplaceAppointmentActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.replaceappointmentoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsproviderreplaceappointmentactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
