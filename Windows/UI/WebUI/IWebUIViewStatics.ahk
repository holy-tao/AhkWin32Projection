 ...
 */
class IWebUIViewStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebUIViewStatics
     * @type {Guid}
     */
    static IID => Guid("{b591e668-8e59-44f9-8803-1b24c9149d30}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["CreateAsync", "CreateWithUriAsync"]
    ...
    CreateAsync() {
        ...
        return IAsyncOperation(WebUIView, operation)
    }
