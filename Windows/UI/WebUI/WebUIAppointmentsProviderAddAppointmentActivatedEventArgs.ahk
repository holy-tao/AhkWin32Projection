...
#Include ..\..\ApplicationModel\Activation\IAppointmentsProviderAddAppointmentActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIAppointmentsProviderAddAppointmentActivatedEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IAppointmentsProviderAddAppointmentActivatedEventArgs
     ...
     * @type {Guid}
     */
    static IID => IAppointmentsProviderAddAppointmentActivatedEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.addappointmentoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuiappointmentsprovideraddappointmentactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
...
;@region Instance Methods
    ...
    get_AddAppointmentOperation() {
        if (!this.HasProp("__IAppointmentsProviderAddAppointmentActivatedEventArgs")) {
            if ((queryResult := this.QueryInterface(IAppointmentsProviderAddAppointmentActivatedEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IAppointmentsProviderAddAppointmentActivatedEventArgs := IAppointmentsProviderAddAppointmentActivatedEventArgs(outPtr)
        }

        return this.__IAppointmentsProviderAddAppointmentActivatedEventArgs.get_AddAppointmentOperation()
    }
