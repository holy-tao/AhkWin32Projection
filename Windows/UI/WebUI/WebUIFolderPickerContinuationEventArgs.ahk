...
#Include ..\..\ApplicationModel\Activation\IFolderPickerContinuationEventArgs.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIFolderPickerContinuationEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IFolderPickerContinuationEventArgs
     ...
     * @type {Guid}
     */
    static IID => IFolderPickerContinuationEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.folder
     * @type {StorageFolder} 
     */
    Folder {
        get => this.get_Folder()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.continuationdata
     * @type {ValueSet} 
     */
    ContinuationData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifolderpickercontinuationeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
...
;@region Instance Methods
     ...
     */
    get_Folder() {
        if (!this.HasProp("__IFolderPickerContinuationEventArgs")) {
            if ((queryResult := this.QueryInterface(IFolderPickerContinuationEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IFolderPickerContinuationEventArgs := IFolderPickerContinuationEventArgs(outPtr)
        }

        return this.__IFolderPickerContinuationEventArgs.get_Folder()
    }
