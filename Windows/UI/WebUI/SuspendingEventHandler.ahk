 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.suspendingeventhandler
...
class SuspendingEventHandler extends IUnknown {
     ...
     * @type {Guid}
     */
    static IID => Guid("{509c429c-78e2-4883-abc8-8960dcde1b5c}")

    /**
     * The class identifier for SuspendingEventHandler
     * @type {Guid}
     */
    static CLSID => Guid("{509c429c-78e2-4883-abc8-8960dcde1b5c}")
