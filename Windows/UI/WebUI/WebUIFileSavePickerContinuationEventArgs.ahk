...
#Include ..\..\ApplicationModel\Activation\IFileSavePickerContinuationEventArgs.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs
 * @namespace Windows.UI.WebUI
 * @version WindowsRuntime 1.4
 */
class WebUIFileSavePickerContinuationEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.file
     * @type {StorageFile} 
     */
    File {
        get => this.get_File()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.continuationdata
     * @type {ValueSet} 
     */
    ContinuationData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.activatedoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.webui.webuifilesavepickercontinuationeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
