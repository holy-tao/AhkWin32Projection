 ...
 */
class ITaskbarManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITaskbarManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{db32ab74-de52-4fe6-b7b6-95ff9f8395df}")
