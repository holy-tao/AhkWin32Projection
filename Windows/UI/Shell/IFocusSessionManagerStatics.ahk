 ...
 */
class IFocusSessionManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFocusSessionManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{834df764-cb9a-5d0a-aa9f-73df4f249395}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetDefault", "get_IsSupported"]
    ...
    GetDefault() {
        ...
        return FocusSessionManager(result_)
    }
