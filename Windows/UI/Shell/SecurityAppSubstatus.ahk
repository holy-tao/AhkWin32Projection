 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.shell.securityappsubstatus
 * @namespace Windows.UI.Shell
 * @version WindowsRuntime 1.4
 */
class SecurityAppSubstatus extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static NoActionNeeded => 1

    /**
     * No description.
     * @type {Integer (Int32)}
     */
    static ActionRecommended => 2

    /**
     * No description.
     * @type {Integer (Int32)}
     */
    static ActionNeeded => 3
}
