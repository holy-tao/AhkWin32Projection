 ...
 */
class ISecurityAppManager extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISecurityAppManager
     * @type {Guid}
     */
    static IID => Guid("{96ac500c-aed4-561d-bde8-953520343a2d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Register", "Unregister", "UpdateState"]
     ...
     * @param {Uri} detailsUri 
     * @param {Boolean} registerPerUser 
     * @returns {Guid} 
    ...
    Register(kind, displayName, detailsUri, registerPerUser) {
        ...
        result_ := Guid()
        result := ComCall(6, this, "int", kind, "ptr", displayName, "ptr", detailsUri, "int", registerPerUser, "ptr", result_, "int")
        if(result != 0) {
    ...
    Unregister(kind, guidRegistration) {
        result := ComCall(7, this, "int", kind, "ptr", guidRegistration, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    UpdateState(kind, guidRegistration, state, substatus, detailsUri) {
        result := ComCall(8, this, "int", kind, "ptr", guidRegistration, "int", state, "int", substatus, "ptr", detailsUri, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
