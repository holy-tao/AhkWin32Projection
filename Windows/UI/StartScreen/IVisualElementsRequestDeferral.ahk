 ...
 */
class IVisualElementsRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVisualElementsRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{a1656eb0-0126-4357-8204-bd82bb2a046d}")
