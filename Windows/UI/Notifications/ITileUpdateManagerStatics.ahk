 ...
 */
class ITileUpdateManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITileUpdateManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{da159e5d-3ea9-4986-8d84-b09d5e12276d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["CreateTileUpdaterForApplication", "CreateTileUpdaterForApplicationWithId", "CreateTileUpdaterForSecondaryTile", "GetTemplateContent"]
