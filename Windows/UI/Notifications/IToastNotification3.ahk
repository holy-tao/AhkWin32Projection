...
class IToastNotification3 extends IInspectable{
    ...
    /**
     * The interface identifier for IToastNotification3
     * @type {Guid}
     */
    static IID => Guid("{31e8aed8-8141-4f99-bc0a-c4ed21297d77}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_NotificationMirroring", "put_NotificationMirroring", "get_RemoteId", "put_RemoteId"]
