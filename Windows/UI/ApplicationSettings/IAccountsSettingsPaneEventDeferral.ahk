 ...
 */
class IAccountsSettingsPaneEventDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccountsSettingsPaneEventDeferral
     * @type {Guid}
     */
    static IID => Guid("{cbf25d3f-e5ba-40ef-93da-65e096e5fb04}")
