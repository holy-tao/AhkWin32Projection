 ...
 */
class ISettingsPaneStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISettingsPaneStatics
     * @type {Guid}
     */
    static IID => Guid("{1c6a52c5-ff19-471b-ba6b-f8f35694ad9a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetForCurrentView", "Show", "get_Edge"]
