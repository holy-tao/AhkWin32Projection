 ...
 */
class IAccountsSettingsPaneStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccountsSettingsPaneStatics
     * @type {Guid}
     */
    static IID => Guid("{561f8b60-b0ec-4150-a8dc-208ee44b068a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetForCurrentView", "Show"]
    ...
    GetForCurrentView() {
        ...
        return AccountsSettingsPane(current)
    }
