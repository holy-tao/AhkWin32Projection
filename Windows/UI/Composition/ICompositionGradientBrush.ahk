...
#Include .\CompositionColorGradientStopCollection.ahk
 ...
 */
class ICompositionGradientBrush extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompositionGradientBrush
     * @type {Guid}
     */
    static IID => Guid("{1d9709e0-ffc6-4c0e-a9ab-34144d4c9098}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_AnchorPoint", "put_AnchorPoint", "get_CenterPoint", "put_CenterPoint", "get_ColorStops", "get_ExtendMode", "put_ExtendMode", "get_InterpolationSpace", "put_InterpolationSpace", "get_Offset", "put_Offset", "get_RotationAngle", "put_RotationAngle", "get_RotationAngleInDegrees", "put_RotationAngleInDegrees", "get_Scale", "put_Scale", "get_TransformMatrix", "put_TransformMatrix"]
    ...
    get_ColorStops() {
        ...
        return CompositionColorGradientStopCollection(value)
    }
