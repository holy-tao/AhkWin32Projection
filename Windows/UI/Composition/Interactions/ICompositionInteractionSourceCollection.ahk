 ...
 */
class ICompositionInteractionSourceCollection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompositionInteractionSourceCollection
     * @type {Guid}
     */
    static IID => Guid("{1b468e4b-a5bf-47d8-a547-3894155a158c}")
     ...
     * @param {ICompositionInteractionSource} value 
     * @returns {HRESULT} 
