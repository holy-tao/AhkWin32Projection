 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection
 * @namespace Windows.UI.Composition
 * @version WindowsRuntime 1.4
 */
class CompositionShapeCollection extends CompositionObject {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(CompositionShape, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{42d4219a-be1b-5091-8f1e-90270840fc2d}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.compositionshapecollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{1135adf5-db12-55e8-ae0f-bd8d914bd399}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(CompositionShape, outPtr)
        }
