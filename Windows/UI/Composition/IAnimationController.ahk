 ...
 */
class IAnimationController extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAnimationController
     * @type {Guid}
     */
    static IID => Guid("{c934efd2-0722-4f5f-a4e2-9510f3d43bf7}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_PlaybackRate", "put_PlaybackRate", "get_Progress", "put_Progress", "get_ProgressBehavior", "put_ProgressBehavior", "Pause", "Resume"]
