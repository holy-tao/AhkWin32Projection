 ...
 */
class IBounceVector2NaturalMotionAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBounceVector2NaturalMotionAnimation
     * @type {Guid}
     */
    static IID => Guid("{da344196-2154-4b3c-88aa-47361204eccd}")
