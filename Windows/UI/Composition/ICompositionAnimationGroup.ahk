 ...
 */
class ICompositionAnimationGroup extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompositionAnimationGroup
     * @type {Guid}
     */
    static IID => Guid("{5e7cc90c-cd14-4e07-8a55-c72527aabdac}")
     ...
     * @param {CompositionAnimation} value 
     * @returns {HRESULT} 
