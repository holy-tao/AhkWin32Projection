 ...
 */
class IBounceScalarNaturalMotionAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBounceScalarNaturalMotionAnimation
     * @type {Guid}
     */
    static IID => Guid("{baa30dcc-a633-4618-9b06-7f7c72c87cff}")
