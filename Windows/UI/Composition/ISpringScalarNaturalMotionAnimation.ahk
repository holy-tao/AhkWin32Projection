 ...
 */
class ISpringScalarNaturalMotionAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpringScalarNaturalMotionAnimation
     * @type {Guid}
     */
    static IID => Guid("{0572a95f-37f9-4fbe-b87b-5cd03a89501c}")
