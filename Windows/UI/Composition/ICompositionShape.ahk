 ...
 */
class ICompositionShape extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompositionShape
     * @type {Guid}
     */
    static IID => Guid("{b47ce2f7-9a88-42c4-9e87-2e500ca8688c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_CenterPoint", "put_CenterPoint", "get_Offset", "put_Offset", "get_RotationAngle", "put_RotationAngle", "get_RotationAngleInDegrees", "put_RotationAngleInDegrees", "get_Scale", "put_Scale", "get_TransformMatrix", "put_TransformMatrix"]
