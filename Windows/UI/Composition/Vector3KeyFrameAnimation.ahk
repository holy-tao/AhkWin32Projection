...
#Include .\IVector3KeyFrameAnimation.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.vector3keyframeanimation
 * @namespace Windows.UI.Composition
 * @version WindowsRuntime 1.4
 */
class Vector3KeyFrameAnimation extends KeyFrameAnimation {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IVector3KeyFrameAnimation
     ...
     * @type {Guid}
     */
    static IID => IVector3KeyFrameAnimation.IID
...
;@region Instance Methods
     ...
     * @param {Vector3} value The value of the key frame.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.composition.vector3keyframeanimation.insertkeyframe
     */
    InsertKeyFrame(normalizedProgressKey, value) {
        if (!this.HasProp("__IVector3KeyFrameAnimation")) {
            if ((queryResult := this.QueryInterface(IVector3KeyFrameAnimation.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector3KeyFrameAnimation := IVector3KeyFrameAnimation(outPtr)
        }

        return this.__IVector3KeyFrameAnimation.InsertKeyFrame(normalizedProgressKey, value)
    }
    ...
    InsertKeyFrameWithEasingFunction(normalizedProgressKey, value, easingFunction) {
        ...
        return this.__IVector3KeyFrameAnimation.InsertKeyFrameWithEasingFunction(normalizedProgressKey, value, easingFunction)
    }
