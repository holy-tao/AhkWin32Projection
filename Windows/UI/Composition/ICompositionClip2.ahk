 ...
 */
class ICompositionClip2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompositionClip2
     * @type {Guid}
     */
    static IID => Guid("{5893e069-3516-40e1-89e0-5ba924927235}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_AnchorPoint", "put_AnchorPoint", "get_CenterPoint", "put_CenterPoint", "get_Offset", "put_Offset", "get_RotationAngle", "put_RotationAngle", "get_RotationAngleInDegrees", "put_RotationAngleInDegrees", "get_Scale", "put_Scale", "get_TransformMatrix", "put_TransformMatrix"]
