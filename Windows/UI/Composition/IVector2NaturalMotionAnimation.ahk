 ...
 */
class IVector2NaturalMotionAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVector2NaturalMotionAnimation
     * @type {Guid}
     */
    static IID => Guid("{0f3e0b7d-e512-479d-a00c-77c93a30a395}")
    ...
    get_FinalValue() {
        ...
        return IReference((ptr) => IPropertyValue(ptr).GetVector2(), value)
    }
