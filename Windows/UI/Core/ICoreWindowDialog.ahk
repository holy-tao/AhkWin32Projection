 ...
 */
class ICoreWindowDialog extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICoreWindowDialog
     * @type {Guid}
     */
    static IID => Guid("{e7392ce0-c78d-427e-8b2c-01ff420c69d5}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Showing", "remove_Showing", "get_MaxSize", "get_MinSize", "get_Title", "put_Title", "get_IsInteractionDelayed", "put_IsInteractionDelayed", "get_Commands", "get_DefaultCommandIndex", "put_DefaultCommandIndex", "get_CancelCommandIndex", "put_CancelCommandIndex", "get_BackButtonCommand", "put_BackButtonCommand", "ShowAsync"]
     ...
     */
    ShowAsync() {
        result := ComCall(21, this, "ptr*", &asyncInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
