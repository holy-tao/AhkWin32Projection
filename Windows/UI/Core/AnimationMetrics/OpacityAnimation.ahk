 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation
 * @namespace Windows.UI.Core.AnimationMetrics
 * @version WindowsRuntime 1.4
 */
class OpacityAnimation extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IOpacityAnimation
     ...
     * @type {Guid}
     */
    static IID => IOpacityAnimation.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.initialopacity
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.finalopacity
     * @type {Float} 
     */
    FinalOpacity {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.type
     * @type {Integer} 
     */
    Type {
        get => this.get_Type()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.delay
     * @type {TimeSpan} 
     */
    Delay {
        get => this.get_Delay()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.duration
     * @type {TimeSpan} 
     */
    Duration {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.control1
     * @type {POINT} 
     */
    Control1 {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.opacityanimation.control2
     * @type {POINT} 
     */
    Control2 {
...
;@region Instance Methods
     ...
     */
    get_InitialOpacity() {
        if (!this.HasProp("__IOpacityAnimation")) {
            if ((queryResult := this.QueryInterface(IOpacityAnimation.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IOpacityAnimation := IOpacityAnimation(outPtr)
        }

        return this.__IOpacityAnimation.get_InitialOpacity()
    }
    ...
    get_FinalOpacity() {
        ...
        return this.__IOpacityAnimation.get_FinalOpacity()
    }
