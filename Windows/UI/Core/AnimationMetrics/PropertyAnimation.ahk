 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation
 * @namespace Windows.UI.Core.AnimationMetrics
 * @version WindowsRuntime 1.4
 */
class PropertyAnimation extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation.type
     * @type {Integer} 
     */
    Type {
        get => this.get_Type()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation.delay
     * @type {TimeSpan} 
     */
    Delay {
        get => this.get_Delay()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation.duration
     * @type {TimeSpan} 
     */
    Duration {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation.control1
     * @type {POINT} 
     */
    Control1 {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.core.animationmetrics.propertyanimation.control2
     * @type {POINT} 
     */
    Control2 {
