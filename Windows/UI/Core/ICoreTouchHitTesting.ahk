 ...
 */
class ICoreTouchHitTesting extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICoreTouchHitTesting
     * @type {Guid}
     */
    static IID => Guid("{b1d8a289-3acf-4124-9fa3-ea8aba353c21}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_TouchHitTesting", "remove_TouchHitTesting"]
