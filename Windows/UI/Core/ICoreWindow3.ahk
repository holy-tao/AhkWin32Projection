 ...
 */
class ICoreWindow3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICoreWindow3
     * @type {Guid}
     */
    static IID => Guid("{32c20dd8-faef-4375-a2ab-32640e4815c7}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_ClosestInteractiveBoundsRequested", "remove_ClosestInteractiveBoundsRequested", "GetCurrentKeyEventDeviceId"]
