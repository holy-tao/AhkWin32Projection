 ...
 */
class IRadialControllerScreenContactStartedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerScreenContactStartedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{206aa436-e651-11e5-bf62-2c27d7404e85}")
