 ...
 */
class IManipulationInertiaStartingEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IManipulationInertiaStartingEventArgs
     * @type {Guid}
     */
    static IID => Guid("{dd37a898-26bf-467a-9ce5-ccf3fb11371e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_PointerDeviceType", "get_Position", "get_Delta", "get_Cumulative", "get_Velocities"]
