 ...
 */
class IRadialControllerButtonReleasedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerButtonReleasedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{3d577eef-3cee-11e6-b535-001bdc06ab3b}")
