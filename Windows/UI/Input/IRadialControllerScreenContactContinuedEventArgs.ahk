 ...
 */
class IRadialControllerScreenContactContinuedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerScreenContactContinuedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{206aa437-e651-11e5-bf62-2c27d7404e85}")
