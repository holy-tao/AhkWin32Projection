 ...
 */
class IRadialController2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialController2
     * @type {Guid}
     */
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_ButtonPressed", "remove_ButtonPressed", "add_ButtonHolding", "remove_ButtonHolding", "add_ButtonReleased", "remove_ButtonReleased"]
