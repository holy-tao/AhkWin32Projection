 ...
 */
class IManipulationUpdatedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IManipulationUpdatedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{cb354ce5-abb8-4f9f-b3ce-8181aa61ad82}")
