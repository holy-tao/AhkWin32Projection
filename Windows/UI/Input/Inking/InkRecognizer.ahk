 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.input.inking.inkrecognizer
 * @namespace Windows.UI.Input.Inking
 * @version WindowsRuntime 1.4
 */
class InkRecognizer extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IInkRecognizer
...
;@region Instance Properties
     ...
     *    <tr><td>hr</td><td>Microsoftov hrvatski rukopisni prepoznavač</td><td>Croatian in all locations</td></tr>
     ...
     *    <tr><td>tn-ZA</td><td>Selemoga Mokwalo wa Letsogo sa Microsoft ka Setswana</td><td>Setswana in all locations</td></tr>
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.ui.input.inking.inkrecognizer.name
     * @type {HSTRING} 
     */
    Name {
        get => this.get_Name()
...
;@region Instance Methods
     ...
     */
    get_Name() {
        if (!this.HasProp("__IInkRecognizer")) {
            if ((queryResult := this.QueryInterface(IInkRecognizer.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IInkRecognizer := IInkRecognizer(outPtr)
        }

        return this.__IInkRecognizer.get_Name()
    }
