 ...
 */
class IPenAndInkSettingsStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPenAndInkSettingsStatics
     * @type {Guid}
     */
    static IID => Guid("{ed6dd036-5708-5c3c-96db-f2f552eab641}")
    ...
    GetDefault() {
        ...
        return PenAndInkSettings(result_)
    }
}
