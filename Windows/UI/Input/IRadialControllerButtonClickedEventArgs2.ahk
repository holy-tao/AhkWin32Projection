 ...
 */
class IRadialControllerButtonClickedEventArgs2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerButtonClickedEventArgs2
     * @type {Guid}
     */
    static IID => Guid("{3d577ef3-3cee-11e6-b535-001bdc06ab3b}")
