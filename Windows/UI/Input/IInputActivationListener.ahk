 ...
 */
class IInputActivationListener extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInputActivationListener
     * @type {Guid}
     */
    static IID => Guid("{5d6d4ed2-28c7-5ae3-aa74-c918a9f243ca}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_State", "add_InputActivationChanged", "remove_InputActivationChanged"]
