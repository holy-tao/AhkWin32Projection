 ...
 */
class ISpatialNavigationStartedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialNavigationStartedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{754a348a-fb64-4656-8ebd-9deecaafe475}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_InteractionSourceKind", "TryGetPointerPose", "get_IsNavigatingX", "get_IsNavigatingY", "get_IsNavigatingZ"]
