...
#Include .\ISpatialHoldStartedEventArgs.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialholdstartedeventargs
 * @namespace Windows.UI.Input.Spatial
 * @version WindowsRuntime 1.4
 */
class SpatialHoldStartedEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ISpatialHoldStartedEventArgs
     ...
     * @type {Guid}
     */
    static IID => ISpatialHoldStartedEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialholdstartedeventargs.interactionsourcekind
     * @type {Integer} 
     */
...
;@region Instance Methods
    ...
    get_InteractionSourceKind() {
        if (!this.HasProp("__ISpatialHoldStartedEventArgs")) {
            if ((queryResult := this.QueryInterface(ISpatialHoldStartedEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ISpatialHoldStartedEventArgs := ISpatialHoldStartedEventArgs(outPtr)
        }

        return this.__ISpatialHoldStartedEventArgs.get_InteractionSourceKind()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialholdstartedeventargs.trygetpointerpose
     */
    TryGetPointerPose(coordinateSystem) {
        ...
        return this.__ISpatialHoldStartedEventArgs.TryGetPointerPose(coordinateSystem)
    }
