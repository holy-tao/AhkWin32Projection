 ...
 */
class ISpatialTappedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialTappedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{296d83de-f444-4aa1-b2bf-9dc88d567da6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_InteractionSourceKind", "TryGetPointerPose", "get_TapCount"]
