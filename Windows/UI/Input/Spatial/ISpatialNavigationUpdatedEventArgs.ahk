 ...
 */
class ISpatialNavigationUpdatedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialNavigationUpdatedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{9b713fd7-839d-4a74-8732-45466fc044b5}")
