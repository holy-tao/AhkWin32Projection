...
#Include .\ISpatialManipulationStartedEventArgs.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialmanipulationstartedeventargs
 * @namespace Windows.UI.Input.Spatial
 * @version WindowsRuntime 1.4
 */
class SpatialManipulationStartedEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ISpatialManipulationStartedEventArgs
     ...
     * @type {Guid}
     */
    static IID => ISpatialManipulationStartedEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialmanipulationstartedeventargs.interactionsourcekind
     * @type {Integer} 
     */
...
;@region Instance Methods
    ...
    get_InteractionSourceKind() {
        if (!this.HasProp("__ISpatialManipulationStartedEventArgs")) {
            if ((queryResult := this.QueryInterface(ISpatialManipulationStartedEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ISpatialManipulationStartedEventArgs := ISpatialManipulationStartedEventArgs(outPtr)
        }

        return this.__ISpatialManipulationStartedEventArgs.get_InteractionSourceKind()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.input.spatial.spatialmanipulationstartedeventargs.trygetpointerpose
     */
    TryGetPointerPose(coordinateSystem) {
        ...
        return this.__ISpatialManipulationStartedEventArgs.TryGetPointerPose(coordinateSystem)
    }
