 ...
 */
class IRadialControllerButtonPressedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerButtonPressedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{3d577eed-4cee-11e6-b535-001bdc06ab3b}")
