 ...
 */
class ITouchpadGesturesController extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITouchpadGesturesController
     * @type {Guid}
     */
    static IID => Guid("{28c13cdd-e068-549f-89c6-1a440c6fc327}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Enabled", "put_Enabled", "get_SupportedGestures", "put_SupportedGestures", "add_PointerPressed", "remove_PointerPressed", "add_PointerMoved", "remove_PointerMoved", "add_PointerReleased", "remove_PointerReleased", "add_GlobalActionPerformed", "remove_GlobalActionPerformed"]
