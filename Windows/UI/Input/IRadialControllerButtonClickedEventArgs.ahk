 ...
 */
class IRadialControllerButtonClickedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRadialControllerButtonClickedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{206aa438-e651-11e5-bf62-2c27d7404e85}")
