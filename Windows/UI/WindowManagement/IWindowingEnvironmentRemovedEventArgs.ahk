 ...
 */
class IWindowingEnvironmentRemovedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWindowingEnvironmentRemovedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{2e5b5473-beff-5e53-9316-7e775fe568b3}")
