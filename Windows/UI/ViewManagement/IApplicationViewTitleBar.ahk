 ...
 */
class IApplicationViewTitleBar extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IApplicationViewTitleBar
     * @type {Guid}
     */
    static IID => Guid("{00924ac0-932b-4a6b-9c4b-dc38c82478ce}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_ForegroundColor", "get_ForegroundColor", "put_BackgroundColor", "get_BackgroundColor", "put_ButtonForegroundColor", "get_ButtonForegroundColor", "put_ButtonBackgroundColor", "get_ButtonBackgroundColor", "put_ButtonHoverForegroundColor", "get_ButtonHoverForegroundColor", "put_ButtonHoverBackgroundColor", "get_ButtonHoverBackgroundColor", "put_ButtonPressedForegroundColor", "get_ButtonPressedForegroundColor", "put_ButtonPressedBackgroundColor", "get_ButtonPressedBackgroundColor", "put_InactiveForegroundColor", "get_InactiveForegroundColor", "put_InactiveBackgroundColor", "get_InactiveBackgroundColor", "put_ButtonInactiveForegroundColor", "get_ButtonInactiveForegroundColor", "put_ButtonInactiveBackgroundColor", "get_ButtonInactiveBackgroundColor"]
