...
class IUISettings6 extends IInspectable{
    ...
    /**
     * The interface identifier for IUISettings6
     * @type {Guid}
     */
    static IID => Guid("{aef19bd7-fe31-5a04-ada4-469aaec6dfa9}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_AnimationsEnabledChanged", "remove_AnimationsEnabledChanged", "add_MessageDurationChanged", "remove_MessageDurationChanged"]
