 ...
 */
class ICoreInputView5 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICoreInputView5
     * @type {Guid}
     */
    static IID => Guid("{136316e0-c6d5-5c57-811e-1ad8a99ba6ab}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["IsKindSupported", "add_SupportedKindsChanged", "remove_SupportedKindsChanged", "add_PrimaryViewAnimationStarting", "remove_PrimaryViewAnimationStarting"]
