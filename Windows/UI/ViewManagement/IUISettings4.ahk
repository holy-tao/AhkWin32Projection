...
class IUISettings4 extends IInspectable{
    ...
    /**
     * The interface identifier for IUISettings4
     * @type {Guid}
     */
    static IID => Guid("{52bb3002-919b-4d6b-9b78-8dd66ff4b93b}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_AdvancedEffectsEnabled", "add_AdvancedEffectsEnabledChanged", "remove_AdvancedEffectsEnabledChanged"]
