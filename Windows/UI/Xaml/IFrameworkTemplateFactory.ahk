 ...
 */
class IFrameworkTemplateFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFrameworkTemplateFactory
     * @type {Guid}
     */
    static IID => Guid("{1a78a0a5-937d-46d4-832b-94ff14dab061}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return FrameworkTemplate(value)
    }
}
