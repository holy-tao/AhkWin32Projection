 ...
 */
class IVisualStateManagerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVisualStateManagerFactory
     * @type {Guid}
     */
    static IID => Guid("{85e598fd-a575-47b6-9e30-383cd08585f2}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return VisualStateManager(value)
    }
}
