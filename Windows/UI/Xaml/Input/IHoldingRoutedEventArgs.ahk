 ...
 */
class IHoldingRoutedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHoldingRoutedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{c246ff23-d80d-44de-8db9-0d815e269ac0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_PointerDeviceType", "get_HoldingState", "get_Handled", "put_Handled", "GetPosition"]
