 ...
 */
class IRightTappedRoutedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRightTappedRoutedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{6834869d-7bd5-4033-b237-172f79abe393}")
