...
#Include .\IFocusManagerGotFocusEventArgs.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.focusmanagergotfocuseventargs
 * @namespace Windows.UI.Xaml.Input
 * @version WindowsRuntime 1.4
 */
class FocusManagerGotFocusEventArgs extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IFocusManagerGotFocusEventArgs
     ...
     * @type {Guid}
     */
    static IID => IFocusManagerGotFocusEventArgs.IID
...
;@region Instance Properties
     ...
     * @remarks
     * We recommend using the [UIElement](../windows.ui.xaml/uielement.md) focus routed events instead of [FocusManager](focusmanager.md) events whenever possible.
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.focusmanagergotfocuseventargs.newfocusedelement
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.focusmanagergotfocuseventargs.correlationid
     * @type {Guid} 
     */
    CorrelationId {
...
;@region Instance Methods
    ...
    get_NewFocusedElement() {
        if (!this.HasProp("__IFocusManagerGotFocusEventArgs")) {
            if ((queryResult := this.QueryInterface(IFocusManagerGotFocusEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IFocusManagerGotFocusEventArgs := IFocusManagerGotFocusEventArgs(outPtr)
        }

        return this.__IFocusManagerGotFocusEventArgs.get_NewFocusedElement()
    }
    ...
    get_CorrelationId() {
        ...
        return this.__IFocusManagerGotFocusEventArgs.get_CorrelationId()
    }
