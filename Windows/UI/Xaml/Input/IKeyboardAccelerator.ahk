 ...
 */
class IKeyboardAccelerator extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IKeyboardAccelerator
     * @type {Guid}
     */
    static IID => Guid("{92e6181e-19ae-465a-9b3c-a71ee9ea7420}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Key", "put_Key", "get_Modifiers", "put_Modifiers", "get_IsEnabled", "put_IsEnabled", "get_ScopeOwner", "put_ScopeOwner", "add_Invoked", "remove_Invoked"]
