 ...
 */
class IDoubleTappedRoutedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDoubleTappedRoutedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{af404424-26df-44f4-8714-9359249b62d3}")
