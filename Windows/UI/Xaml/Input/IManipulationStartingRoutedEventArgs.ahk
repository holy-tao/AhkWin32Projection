 ...
 */
class IManipulationStartingRoutedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IManipulationStartingRoutedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{18d636b7-53a4-4c15-a498-f3a9ca212a42}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Mode", "put_Mode", "get_Container", "put_Container", "get_Pivot", "put_Pivot", "get_Handled", "put_Handled"]
