...
#Include .\IRightTappedRoutedEventArgs.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.righttappedroutedeventargs
 * @namespace Windows.UI.Xaml.Input
 * @version WindowsRuntime 1.4
 */
class RightTappedRoutedEventArgs extends RoutedEventArgs {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IRightTappedRoutedEventArgs
     ...
     * @type {Guid}
     */
    static IID => IRightTappedRoutedEventArgs.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.righttappedroutedeventargs.pointerdevicetype
     * @type {Integer} 
     */
    PointerDeviceType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.righttappedroutedeventargs.handled
     * @type {Boolean} 
     */
    Handled {
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Input.RightTappedRoutedEventArgs")
    ...
    get_PointerDeviceType() {
        if (!this.HasProp("__IRightTappedRoutedEventArgs")) {
            if ((queryResult := this.QueryInterface(IRightTappedRoutedEventArgs.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IRightTappedRoutedEventArgs := IRightTappedRoutedEventArgs(outPtr)
        }

        return this.__IRightTappedRoutedEventArgs.get_PointerDeviceType()
    }
    ...
    get_Handled() {
        ...
        return this.__IRightTappedRoutedEventArgs.get_Handled()
    }
    ...
    put_Handled(value) {
        ...
        return this.__IRightTappedRoutedEventArgs.put_Handled(value)
    }
     ...
     * @returns {POINT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.righttappedroutedeventargs.getposition
     */
    GetPosition(relativeTo) {
        ...
        return this.__IRightTappedRoutedEventArgs.GetPosition(relativeTo)
    }
