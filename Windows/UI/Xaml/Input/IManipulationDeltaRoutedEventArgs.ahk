 ...
 */
class IManipulationDeltaRoutedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IManipulationDeltaRoutedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{400d5794-4c6f-491d-82d6-3517109399c6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Container", "get_Position", "get_IsInertial", "get_Delta", "get_Cumulative", "get_Velocities", "get_Handled", "put_Handled", "get_PointerDeviceType", "Complete"]
