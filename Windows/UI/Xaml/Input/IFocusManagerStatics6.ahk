 ...
 */
class IFocusManagerStatics6 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFocusManagerStatics6
     * @type {Guid}
     */
    static IID => Guid("{3546a1b6-20bf-5007-929d-e6d32e16afe4}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_GotFocus", "remove_GotFocus", "add_LostFocus", "remove_LostFocus", "add_GettingFocus", "remove_GettingFocus", "add_LosingFocus", "remove_LosingFocus"]
