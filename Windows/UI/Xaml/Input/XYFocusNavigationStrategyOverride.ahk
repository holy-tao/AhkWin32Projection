 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.input.xyfocusnavigationstrategyoverride
 * @namespace Windows.UI.Xaml.Input
 * @version WindowsRuntime 1.4
 */
class XYFocusNavigationStrategyOverride extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static NavigationDirectionDistance => 3
