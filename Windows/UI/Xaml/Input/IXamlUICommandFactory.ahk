 ...
 */
class IXamlUICommandFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IXamlUICommandFactory
     * @type {Guid}
     */
    static IID => Guid("{1eec08c3-e061-5e10-9f2a-2baa840885c2}")
