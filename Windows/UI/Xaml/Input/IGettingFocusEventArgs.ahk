 ...
 */
class IGettingFocusEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGettingFocusEventArgs
     * @type {Guid}
     */
    static IID => Guid("{fa05b9ce-c67c-4be8-8fd4-c44d67877e0d}")
