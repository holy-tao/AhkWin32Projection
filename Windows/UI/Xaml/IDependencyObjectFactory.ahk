 ...
 */
class IDependencyObjectFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDependencyObjectFactory
     * @type {Guid}
     */
    static IID => Guid("{9a03af92-7d8a-4937-884f-ecf34fe02acb}")
