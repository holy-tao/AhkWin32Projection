 ...
 */
class IDragStartingEventArgs2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDragStartingEventArgs2
     * @type {Guid}
     */
    static IID => Guid("{d855e08e-44b6-4211-bd0b-7fddbb6e8231}")
