 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.leavingbackgroundeventhandler
...
class LeavingBackgroundEventHandler extends IUnknown {
     ...
     * @type {Guid}
     */
    static IID => Guid("{aaad5dad-4fc6-4aa4-b7cf-877e36ada4f6}")

    /**
     * The class identifier for LeavingBackgroundEventHandler
     * @type {Guid}
     */
    static CLSID => Guid("{aaad5dad-4fc6-4aa4-b7cf-877e36ada4f6}")
     ...
     * @param {LeavingBackgroundEventArgs} e 
