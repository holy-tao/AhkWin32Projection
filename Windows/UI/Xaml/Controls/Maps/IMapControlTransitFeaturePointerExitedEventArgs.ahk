 ...
 */
class IMapControlTransitFeaturePointerExitedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapControlTransitFeaturePointerExitedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{6a11258d-448d-44e7-bc69-d13d497154e9}")
