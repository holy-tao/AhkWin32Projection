 ...
 */
class IMapElementClickEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementClickEventArgs
     * @type {Guid}
     */
    static IID => Guid("{40168a11-d080-4519-99a1-3149fb8999d0}")
