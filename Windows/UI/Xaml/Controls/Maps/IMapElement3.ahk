 ...
 */
class IMapElement3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElement3
     * @type {Guid}
     */
    static IID => Guid("{13efbc59-45ed-48b4-93ad-e3f78f8cf218}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_MapStyleSheetEntry", "put_MapStyleSheetEntry", "get_MapStyleSheetEntryState", "put_MapStyleSheetEntryState", "get_Tag", "put_Tag"]
