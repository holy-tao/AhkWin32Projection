 ...
 */
class IMapElementsLayerPointerEnteredEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementsLayerPointerEnteredEventArgs
     * @type {Guid}
     */
    static IID => Guid("{757fc032-4694-4404-8c89-348b6b76c5e6}")
