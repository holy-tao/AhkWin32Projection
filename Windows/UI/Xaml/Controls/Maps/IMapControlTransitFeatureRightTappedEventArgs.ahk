 ...
 */
class IMapControlTransitFeatureRightTappedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapControlTransitFeatureRightTappedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{aea1cc49-a729-4eae-a59a-3ec9a125a028}")
