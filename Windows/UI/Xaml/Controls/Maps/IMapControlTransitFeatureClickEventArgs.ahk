 ...
 */
class IMapControlTransitFeatureClickEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapControlTransitFeatureClickEventArgs
     * @type {Guid}
     */
    static IID => Guid("{76179969-b765-4622-b08a-3072745a4541}")
