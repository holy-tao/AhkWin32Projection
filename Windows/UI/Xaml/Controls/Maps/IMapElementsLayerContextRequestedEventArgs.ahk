 ...
 */
class IMapElementsLayerContextRequestedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementsLayerContextRequestedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{da45d0b3-7a0e-4758-808b-3a637627eb0d}")
