 ...
 */
class IMapTileDataSourceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapTileDataSourceFactory
     * @type {Guid}
     */
    static IID => Guid("{a3920fbd-e446-4648-a74d-fd2c5d557c06}")
