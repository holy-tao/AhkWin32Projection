 ...
 */
class IMapControlBusinessLandmarkRightTappedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapControlBusinessLandmarkRightTappedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{59ab8ae7-f184-4ab1-b0b0-35c8bf0654b2}")
