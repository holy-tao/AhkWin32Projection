 ...
 */
class IMapElementsLayerClickEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementsLayerClickEventArgs
     * @type {Guid}
     */
    static IID => Guid("{2ca7cf66-af1b-4c05-8c85-f74ae3d4677f}")
