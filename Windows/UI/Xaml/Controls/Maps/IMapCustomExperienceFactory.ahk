 ...
 */
class IMapCustomExperienceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapCustomExperienceFactory
     * @type {Guid}
     */
    static IID => Guid("{7a403fb5-a1b1-4e7f-921e-3e6b8d8ebed6}")
