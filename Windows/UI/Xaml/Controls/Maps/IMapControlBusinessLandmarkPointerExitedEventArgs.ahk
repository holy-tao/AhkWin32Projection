 ...
 */
class IMapControlBusinessLandmarkPointerExitedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapControlBusinessLandmarkPointerExitedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{2bb52caf-f24a-46d0-b463-65f719731057}")
