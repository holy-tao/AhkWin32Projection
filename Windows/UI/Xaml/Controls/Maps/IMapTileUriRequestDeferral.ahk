 ...
 */
class IMapTileUriRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapTileUriRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{c117ade0-bf3e-4c51-8faa-4b593cf68eb2}")
