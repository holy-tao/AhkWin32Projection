 ...
 */
class IMapElementsLayerPointerExitedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementsLayerPointerExitedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{92f3c6ad-03ed-4c39-af20-2a07ee1ccea6}")
