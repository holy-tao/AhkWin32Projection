 ...
 */
class ICustomMapTileDataSourceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICustomMapTileDataSourceFactory
     * @type {Guid}
     */
    static IID => Guid("{c8477947-c955-4f22-9444-a1d8d744af11}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return CustomMapTileDataSource(value)
    }
}
