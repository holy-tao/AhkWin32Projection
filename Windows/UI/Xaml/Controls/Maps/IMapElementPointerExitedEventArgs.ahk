 ...
 */
class IMapElementPointerExitedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapElementPointerExitedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{c1a45af9-60c9-4679-9119-20abc75d931f}")
