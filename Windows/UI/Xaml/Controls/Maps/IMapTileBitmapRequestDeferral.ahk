 ...
 */
class IMapTileBitmapRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMapTileBitmapRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{fe370542-a4ac-4efa-9665-0490b0cafdd2}")
