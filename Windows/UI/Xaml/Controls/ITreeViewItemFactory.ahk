 ...
 */
class ITreeViewItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITreeViewItemFactory
     * @type {Guid}
     */
    static IID => Guid("{4ea32731-568d-4d0d-adfd-3d8dc5aa5d88}")
