 ...
 */
class IMenuFlyoutItemStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMenuFlyoutItemStatics3
     * @type {Guid}
     */
    static IID => Guid("{d83fd7c3-0aeb-4ef3-8270-8b9b95f2b298}")
