 ...
 */
class IPasswordBox5 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPasswordBox5
     * @type {Guid}
     */
    static IID => Guid("{f96c2753-e1d4-5142-86c2-7318bfbbc705}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_CanPasteClipboardContent", "get_SelectionFlyout", "put_SelectionFlyout", "get_Description", "put_Description", "PasteFromClipboard"]
