 ...
 */
class IWebView5 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebView5
     * @type {Guid}
     */
    static IID => Guid("{8c9884a6-2f3b-4a55-a463-8444c2095d00}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_XYFocusLeft", "put_XYFocusLeft", "get_XYFocusRight", "put_XYFocusRight", "get_XYFocusUp", "put_XYFocusUp", "get_XYFocusDown", "put_XYFocusDown"]
