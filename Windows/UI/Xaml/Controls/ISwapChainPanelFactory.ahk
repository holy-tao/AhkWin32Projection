 ...
 */
class ISwapChainPanelFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISwapChainPanelFactory
     * @type {Guid}
     */
    static IID => Guid("{f38f8d7f-1a48-49cb-86d2-10eaaaf6fd70}")
