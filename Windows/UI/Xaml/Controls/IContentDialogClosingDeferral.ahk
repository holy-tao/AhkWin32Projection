 ...
 */
class IContentDialogClosingDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContentDialogClosingDeferral
     * @type {Guid}
     */
    static IID => Guid("{215d4d11-7e30-4cb9-a710-5a4f9cca8b42}")
