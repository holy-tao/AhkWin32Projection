 ...
 */
class IRichTextBlockStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRichTextBlockStatics2
     * @type {Guid}
     */
    static IID => Guid("{0d6131e1-af29-48ce-8aaf-74ecc28bfbb0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_MaxLinesProperty", "get_TextLineBoundsProperty", "get_SelectionHighlightColorProperty", "get_OpticalMarginAlignmentProperty", "get_IsColorFontEnabledProperty", "get_TextReadingOrderProperty"]
