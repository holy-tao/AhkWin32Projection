 ...
 */
class IMediaTransportControlsFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaTransportControlsFactory
     * @type {Guid}
     */
    static IID => Guid("{1da2015a-a8e4-4c1b-88c9-0b183ecc62e3}")
