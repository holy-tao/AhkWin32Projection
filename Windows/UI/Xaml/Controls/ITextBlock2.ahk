 ...
 */
class ITextBlock2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextBlock2
     * @type {Guid}
     */
    static IID => Guid("{45206a4c-0a4e-4fbf-aee9-335d5a205f6e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_SelectionHighlightColor", "put_SelectionHighlightColor", "get_MaxLines", "put_MaxLines", "get_TextLineBounds", "put_TextLineBounds", "get_OpticalMarginAlignment", "put_OpticalMarginAlignment", "get_IsColorFontEnabled", "put_IsColorFontEnabled", "get_TextReadingOrder", "put_TextReadingOrder"]
