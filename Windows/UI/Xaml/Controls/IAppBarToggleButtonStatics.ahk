 ...
 */
class IAppBarToggleButtonStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBarToggleButtonStatics
     * @type {Guid}
     */
    static IID => Guid("{fe5aaf96-7929-4da1-aa67-cddf73a3e4b5}")
