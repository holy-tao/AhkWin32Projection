 ...
 */
class IRelativePanelFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRelativePanelFactory
     * @type {Guid}
     */
    static IID => Guid("{8460193c-361b-44ba-a17e-b84c9dcdc772}")
