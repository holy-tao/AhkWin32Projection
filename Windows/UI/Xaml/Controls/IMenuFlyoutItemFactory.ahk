 ...
 */
class IMenuFlyoutItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMenuFlyoutItemFactory
     * @type {Guid}
     */
    static IID => Guid("{c5aa39e2-44f3-455e-9c5b-62bb6afce3ad}")
