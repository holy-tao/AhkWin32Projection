 ...
 */
class IComboBox2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IComboBox2
     * @type {Guid}
     */
    static IID => Guid("{ea0cbf91-ca36-4fad-972a-2e53a6718b9f}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Header", "put_Header", "get_HeaderTemplate", "put_HeaderTemplate", "get_PlaceholderText", "put_PlaceholderText"]
