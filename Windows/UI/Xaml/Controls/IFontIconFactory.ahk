 ...
 */
class IFontIconFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFontIconFactory
     * @type {Guid}
     */
    static IID => Guid("{1c781b6b-37bf-4ddc-a1a8-1b77db3cf0ea}")
