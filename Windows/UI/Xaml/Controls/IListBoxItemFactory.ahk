 ...
 */
class IListBoxItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListBoxItemFactory
     * @type {Guid}
     */
    static IID => Guid("{4398b8d4-a3de-402c-b23d-190384b27ca8}")
