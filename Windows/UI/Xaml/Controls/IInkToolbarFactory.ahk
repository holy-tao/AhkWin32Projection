 ...
 */
class IInkToolbarFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInkToolbarFactory
     * @type {Guid}
     */
    static IID => Guid("{3947aa99-36b1-4374-ab5c-98bf07a4320b}")
