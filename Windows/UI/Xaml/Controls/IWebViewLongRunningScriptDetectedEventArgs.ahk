 ...
 */
class IWebViewLongRunningScriptDetectedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWebViewLongRunningScriptDetectedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{f3f020ab-a46c-42b0-9efe-69764d5cffa6}")
