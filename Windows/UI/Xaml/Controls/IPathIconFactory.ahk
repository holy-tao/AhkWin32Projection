 ...
 */
class IPathIconFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPathIconFactory
     * @type {Guid}
     */
    static IID => Guid("{af9d9652-9c5d-4a37-9e1a-044abeef792b}")
