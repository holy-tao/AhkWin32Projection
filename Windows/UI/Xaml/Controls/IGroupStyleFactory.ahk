 ...
 */
class IGroupStyleFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGroupStyleFactory
     * @type {Guid}
     */
    static IID => Guid("{56ff664f-e2d7-4f49-803d-c727cdf9372d}")
