 ...
 */
class IAppBarToggleButtonStatics4 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBarToggleButtonStatics4
     * @type {Guid}
     */
    static IID => Guid("{a478b984-e916-4137-bdbd-95bd46ff3ce6}")
