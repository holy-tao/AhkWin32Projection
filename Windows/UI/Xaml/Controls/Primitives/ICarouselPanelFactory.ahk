 ...
 */
class ICarouselPanelFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICarouselPanelFactory
     * @type {Guid}
     */
    static IID => Guid("{c1109404-9ae1-440e-a0dd-bbb6e2293cbe}")
