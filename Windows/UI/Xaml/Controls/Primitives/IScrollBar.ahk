 ...
 */
class IScrollBar extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IScrollBar
     * @type {Guid}
     */
    static IID => Guid("{f57ae6ca-d1a6-4b90-a4e9-54df1ba8d2ec}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Orientation", "put_Orientation", "get_ViewportSize", "put_ViewportSize", "get_IndicatorMode", "put_IndicatorMode", "add_Scroll", "remove_Scroll"]
