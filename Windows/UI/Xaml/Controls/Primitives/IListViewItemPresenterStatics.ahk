 ...
 */
class IListViewItemPresenterStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListViewItemPresenterStatics
     * @type {Guid}
     */
    static IID => Guid("{6504a55a-15dd-42fb-aa5d-2d8ce2e9c294}")
    ...
    ListViewItemPresenterHorizontalContentAlignmentProperty {
        get => this.get_ListViewItemPresenterHorizontalContentAlignmentProperty()
    }
    ...
    ListViewItemPresenterVerticalContentAlignmentProperty {
        get => this.get_ListViewItemPresenterVerticalContentAlignmentProperty()
    }
    ...
    ListViewItemPresenterPaddingProperty {
        get => this.get_ListViewItemPresenterPaddingProperty()
    }
     ...
     * @returns {DependencyProperty} 
     */
    get_ListViewItemPresenterPaddingProperty() {
