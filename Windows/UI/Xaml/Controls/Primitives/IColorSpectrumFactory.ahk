 ...
 */
class IColorSpectrumFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IColorSpectrumFactory
     * @type {Guid}
     */
    static IID => Guid("{90c7e61e-904d-42ab-b44f-e68dbf0cdee9}")
