 ...
 */
class IJumpListItemForegroundConverter extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IJumpListItemForegroundConverter
     * @type {Guid}
     */
    static IID => Guid("{1590ed38-c504-4796-a63a-5bfc9eefaae8}")
