 ...
 */
class IColorSpectrum extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IColorSpectrum
     * @type {Guid}
     */
    static IID => Guid("{ce46f271-f509-4f98-8288-e4942fb385df}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Color", "put_Color", "get_HsvColor", "put_HsvColor", "get_MinHue", "put_MinHue", "get_MaxHue", "put_MaxHue", "get_MinSaturation", "put_MinSaturation", "get_MaxSaturation", "put_MaxSaturation", "get_MinValue", "put_MinValue", "get_MaxValue", "put_MaxValue", "get_Shape", "put_Shape", "get_Components", "put_Components", "add_ColorChanged", "remove_ColorChanged"]
