 ...
 */
class IOrientedVirtualizingPanel extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IOrientedVirtualizingPanel
     * @type {Guid}
     */
    static IID => Guid("{f077b577-39bd-46ee-bdd7-0826beed71b8}")
