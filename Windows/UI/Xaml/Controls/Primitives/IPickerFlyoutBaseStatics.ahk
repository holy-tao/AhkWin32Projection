 ...
 */
class IPickerFlyoutBaseStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPickerFlyoutBaseStatics
     * @type {Guid}
     */
    static IID => Guid("{5a4d0ac5-89ae-40e5-a7f1-bb702355adf3}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_TitleProperty", "GetTitle", "SetTitle"]
