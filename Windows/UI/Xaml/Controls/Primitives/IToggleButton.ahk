 ...
 */
class IToggleButton extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IToggleButton
     * @type {Guid}
     */
    static IID => Guid("{589877fb-0fc7-4036-9d8b-127dfa75c16d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsChecked", "put_IsChecked", "get_IsThreeState", "put_IsThreeState", "add_Checked", "remove_Checked", "add_Unchecked", "remove_Unchecked", "add_Indeterminate", "remove_Indeterminate"]
