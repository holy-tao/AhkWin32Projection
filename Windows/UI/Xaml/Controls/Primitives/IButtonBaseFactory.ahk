 ...
 */
class IButtonBaseFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IButtonBaseFactory
     * @type {Guid}
     */
    static IID => Guid("{389b7c71-5220-42b2-9992-2690c1a6702f}")
