 ...
 */
class ISelectorItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISelectorItemFactory
     * @type {Guid}
     */
    static IID => Guid("{b9363945-c86a-4b1e-9440-1879378d5313}")
