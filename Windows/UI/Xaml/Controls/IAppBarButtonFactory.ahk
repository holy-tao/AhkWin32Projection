 ...
 */
class IAppBarButtonFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBarButtonFactory
     * @type {Guid}
     */
    static IID => Guid("{bdbb1bb6-cb2e-4276-abd6-7935130510e0}")
