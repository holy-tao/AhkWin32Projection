 ...
 */
class IGridViewFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGridViewFactory
     * @type {Guid}
     */
    static IID => Guid("{d9bcca89-09f9-4c6e-a83e-f199146f0e7d}")
