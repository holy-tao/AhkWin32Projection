 ...
 */
class IPasswordBoxStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPasswordBoxStatics2
     * @type {Guid}
     */
    static IID => Guid("{fc57935f-98fa-4066-b785-fa725ecde232}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_HeaderProperty", "get_HeaderTemplateProperty", "get_PlaceholderTextProperty", "get_SelectionHighlightColorProperty", "get_PreventKeyboardDisplayOnProgrammaticFocusProperty"]
