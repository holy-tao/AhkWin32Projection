 ...
 */
class IPersonPictureFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPersonPictureFactory
     * @type {Guid}
     */
    static IID => Guid("{4f18330d-0416-4b92-bfd3-bf5780b46ab2}")
