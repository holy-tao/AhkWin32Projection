 ...
 */
class IAutoSuggestBoxStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAutoSuggestBoxStatics3
     * @type {Guid}
     */
    static IID => Guid("{2cead2dd-c4d5-4ab2-8a13-afddcf067c86}")
