 ...
 */
class INavigationViewFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for INavigationViewFactory
     * @type {Guid}
     */
    static IID => Guid("{e50687c1-b7c2-4975-ad7a-5f4fe6a514c9}")
