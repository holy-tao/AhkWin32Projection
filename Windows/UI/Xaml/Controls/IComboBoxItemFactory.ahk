 ...
 */
class IComboBoxItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IComboBoxItemFactory
     * @type {Guid}
     */
    static IID => Guid("{8fffe867-d94c-4e87-8fc4-6ebcd63c5ac2}")
