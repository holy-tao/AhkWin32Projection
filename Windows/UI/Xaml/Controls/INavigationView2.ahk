 ...
 */
class INavigationView2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for INavigationView2
     * @type {Guid}
     */
    static IID => Guid("{2be49737-7c13-4c44-86c3-8b25e697a80e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsBackButtonVisible", "put_IsBackButtonVisible", "get_IsBackEnabled", "put_IsBackEnabled", "get_PaneTitle", "put_PaneTitle", "add_BackRequested", "remove_BackRequested", "add_PaneClosed", "remove_PaneClosed", "add_PaneClosing", "remove_PaneClosing", "add_PaneOpened", "remove_PaneOpened", "add_PaneOpening", "remove_PaneOpening"]
