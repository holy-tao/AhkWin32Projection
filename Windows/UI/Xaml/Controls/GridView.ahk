...
#Include .\IGridView.ahk
#Include .\IGridViewFactory.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.controls.gridview
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IGridView
...
;@region Static Methods
    ...
    static CreateInstance() {
        if (!GridView.HasProp("__IGridViewFactory")) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Controls.GridView")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, IGridViewFactory.IID)
            GridView.__IGridViewFactory := IGridViewFactory(factoryPtr)
        }

        return GridView.__IGridViewFactory.CreateInstance(0, Buffer(A_PtrSize))
    }
