 ...
 */
class IRatingControlFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRatingControlFactory
     * @type {Guid}
     */
    static IID => Guid("{18d81716-c542-4ccb-b347-5e62c5db782e}")
