 ...
 */
class IGroupStyleSelectorFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGroupStyleSelectorFactory
     * @type {Guid}
     */
    static IID => Guid("{bf570d33-b2f6-481f-a450-c80c291fb22d}")
