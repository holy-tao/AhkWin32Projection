 ...
 */
class ITextBox6 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextBox6
     * @type {Guid}
     */
    static IID => Guid("{41ff2d07-5085-4e52-a51c-f94b06cd558b}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_HorizontalTextAlignment", "put_HorizontalTextAlignment", "get_CharacterCasing", "put_CharacterCasing", "get_PlaceholderForeground", "put_PlaceholderForeground", "add_CopyingToClipboard", "remove_CopyingToClipboard", "add_CuttingToClipboard", "remove_CuttingToClipboard", "add_BeforeTextChanging", "remove_BeforeTextChanging"]
