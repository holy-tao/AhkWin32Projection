 ...
 */
class IRichEditBoxFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRichEditBoxFactory
     * @type {Guid}
     */
    static IID => Guid("{61a1df62-2806-41ed-88ed-ae21f47ab422}")
