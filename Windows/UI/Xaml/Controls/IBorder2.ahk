 ...
 */
class IBorder2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBorder2
     * @type {Guid}
     */
    static IID => Guid("{a1efbd9d-cb8b-56b5-878d-3a7f43bc9730}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_BackgroundSizing", "put_BackgroundSizing", "get_BackgroundTransition", "put_BackgroundTransition"]
