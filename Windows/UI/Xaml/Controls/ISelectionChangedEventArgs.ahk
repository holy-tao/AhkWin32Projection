 ...
 */
class ISelectionChangedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISelectionChangedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{c972d2dc-b609-4758-851e-a799c21de97d}")
