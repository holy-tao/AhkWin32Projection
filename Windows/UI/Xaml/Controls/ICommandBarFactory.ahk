 ...
 */
class ICommandBarFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICommandBarFactory
     * @type {Guid}
     */
    static IID => Guid("{67bdeb44-20e1-4177-ad44-f617b374e8e8}")
