 ...
 */
class IInkToolbarFlyoutItem extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInkToolbarFlyoutItem
     * @type {Guid}
     */
    static IID => Guid("{92b68786-37ee-4915-9e89-e187564a889a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Kind", "put_Kind", "get_IsChecked", "put_IsChecked", "add_Checked", "remove_Checked", "add_Unchecked", "remove_Unchecked"]
