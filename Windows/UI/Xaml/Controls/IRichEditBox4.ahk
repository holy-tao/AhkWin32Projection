 ...
 */
class IRichEditBox4 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRichEditBox4
     * @type {Guid}
     */
    static IID => Guid("{5caa8d35-c838-4bad-a07c-204183bb751f}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetLinguisticAlternativesAsync", "get_ClipboardCopyFormat", "put_ClipboardCopyFormat"]
