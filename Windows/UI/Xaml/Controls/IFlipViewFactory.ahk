 ...
 */
class IFlipViewFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFlipViewFactory
     * @type {Guid}
     */
    static IID => Guid("{f1dea9be-9ae8-4d4b-ab43-16d31e05f4f3}")
