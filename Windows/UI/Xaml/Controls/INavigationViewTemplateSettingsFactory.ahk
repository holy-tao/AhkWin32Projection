 ...
 */
class INavigationViewTemplateSettingsFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for INavigationViewTemplateSettingsFactory
     * @type {Guid}
     */
    static IID => Guid("{28a6a351-64bc-5b60-8f74-e9ee908a240e}")
