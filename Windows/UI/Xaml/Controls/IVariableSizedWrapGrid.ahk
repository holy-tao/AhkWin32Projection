 ...
 */
class IVariableSizedWrapGrid extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVariableSizedWrapGrid
     * @type {Guid}
     */
    static IID => Guid("{9ca507c7-23c9-4f01-b80f-be5c21eef474}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ItemHeight", "put_ItemHeight", "get_ItemWidth", "put_ItemWidth", "get_Orientation", "put_Orientation", "get_HorizontalChildrenAlignment", "put_HorizontalChildrenAlignment", "get_VerticalChildrenAlignment", "put_VerticalChildrenAlignment", "get_MaximumRowsOrColumns", "put_MaximumRowsOrColumns"]
