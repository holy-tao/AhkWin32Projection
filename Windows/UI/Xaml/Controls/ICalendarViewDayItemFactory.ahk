 ...
 */
class ICalendarViewDayItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICalendarViewDayItemFactory
     * @type {Guid}
     */
    static IID => Guid("{62112bdc-1d2f-4e44-9baf-1665749521f2}")
