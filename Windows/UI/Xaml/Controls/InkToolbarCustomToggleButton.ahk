...
#Include .\IInkToolbarCustomToggleButton.ahk
#Include .\IInkToolbarCustomToggleButtonFactory.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.controls.inktoolbarcustomtogglebutton
 * @namespace Windows.UI.Xaml.Controls
 * @version WindowsRuntime 1.4
 */
class InkToolbarCustomToggleButton extends InkToolbarToggleButton {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IInkToolbarCustomToggleButton
     ...
     * @type {Guid}
     */
    static IID => IInkToolbarCustomToggleButton.IID
...
;@region Static Methods
    /**
     * 
     * @returns {InkToolbarCustomToggleButton} 
     */
    static CreateInstance() {
        if (!InkToolbarCustomToggleButton.HasProp("__IInkToolbarCustomToggleButtonFactory")) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Controls.InkToolbarCustomToggleButton")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, IInkToolbarCustomToggleButtonFactory.IID)
            InkToolbarCustomToggleButton.__IInkToolbarCustomToggleButtonFactory := IInkToolbarCustomToggleButtonFactory(factoryPtr)
        }

        return InkToolbarCustomToggleButton.__IInkToolbarCustomToggleButtonFactory.CreateInstance(0, Buffer(A_PtrSize))
    }
