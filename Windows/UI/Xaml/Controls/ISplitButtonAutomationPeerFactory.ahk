...
#Include ..\..\..\..\Guid.ahk
#Include .\SplitButtonAutomationPeer.ahk
 ...
 */
class ISplitButtonAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISplitButtonAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{d63a2534-77dc-5361-8422-4ad8750f45f4}")
    ...
    CreateInstance(owner, baseInterface, innerInterface) {
        ...
        return SplitButtonAutomationPeer(value)
    }
}
