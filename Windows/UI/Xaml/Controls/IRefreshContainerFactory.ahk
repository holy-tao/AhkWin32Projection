 ...
 */
class IRefreshContainerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRefreshContainerFactory
     * @type {Guid}
     */
    static IID => Guid("{0a04777f-089e-4239-baeb-c4641484c37e}")
