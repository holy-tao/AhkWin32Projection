 ...
 */
class IInkToolbarFlyoutItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInkToolbarFlyoutItemFactory
     * @type {Guid}
     */
    static IID => Guid("{352e7b93-803b-4f0e-8c72-9dfc0329329f}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return InkToolbarFlyoutItem(value)
    }
}
