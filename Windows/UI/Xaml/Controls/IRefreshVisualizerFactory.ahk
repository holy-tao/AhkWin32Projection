 ...
 */
class IRefreshVisualizerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRefreshVisualizerFactory
     * @type {Guid}
     */
    static IID => Guid("{6f5c6132-6e09-4c10-824a-127d36672715}")
