 ...
 */
class IContentDialogButtonClickDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContentDialogButtonClickDeferral
     * @type {Guid}
     */
    static IID => Guid("{bd0d3637-19ce-4946-8e77-bd03fe8ebe03}")
