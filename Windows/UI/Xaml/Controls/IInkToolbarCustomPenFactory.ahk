 ...
 */
class IInkToolbarCustomPenFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInkToolbarCustomPenFactory
     * @type {Guid}
     */
    static IID => Guid("{d214d636-f1aa-4f48-bf2c-a926caae4c60}")
