 ...
 */
class IPasswordBox extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPasswordBox
     * @type {Guid}
     */
    static IID => Guid("{02b9aa11-0b47-4e7d-ad91-3a4168ed230d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Password", "put_Password", "get_PasswordChar", "put_PasswordChar", "get_IsPasswordRevealButtonEnabled", "put_IsPasswordRevealButtonEnabled", "get_MaxLength", "put_MaxLength", "add_PasswordChanged", "remove_PasswordChanged", "add_ContextMenuOpening", "remove_ContextMenuOpening", "SelectAll"]
