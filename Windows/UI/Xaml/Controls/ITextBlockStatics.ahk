 ...
 */
class ITextBlockStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextBlockStatics
     * @type {Guid}
     */
    static IID => Guid("{193ec042-a847-4552-b4e8-db36655b840a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_FontSizeProperty", "get_FontFamilyProperty", "get_FontWeightProperty", "get_FontStyleProperty", "get_FontStretchProperty", "get_CharacterSpacingProperty", "get_ForegroundProperty", "get_TextWrappingProperty", "get_TextTrimmingProperty", "get_TextAlignmentProperty", "get_TextProperty", "get_PaddingProperty", "get_LineHeightProperty", "get_LineStackingStrategyProperty", "get_IsTextSelectionEnabledProperty", "get_SelectedTextProperty"]
