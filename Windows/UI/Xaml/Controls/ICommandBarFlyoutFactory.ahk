 ...
 */
class ICommandBarFlyoutFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICommandBarFlyoutFactory
     * @type {Guid}
     */
    static IID => Guid("{dd6441b3-6df1-593d-b80c-daf5c1daee41}")
