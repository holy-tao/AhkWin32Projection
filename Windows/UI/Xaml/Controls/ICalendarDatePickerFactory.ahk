 ...
 */
class ICalendarDatePickerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICalendarDatePickerFactory
     * @type {Guid}
     */
    static IID => Guid("{107aad5d-38be-42af-a957-fc86a5cf1e9a}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return CalendarDatePicker(value)
    }
}
