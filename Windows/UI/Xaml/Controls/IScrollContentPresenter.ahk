 ...
 */
class IScrollContentPresenter extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IScrollContentPresenter
     * @type {Guid}
     */
    static IID => Guid("{5712ee2b-0eeb-46d3-aa31-5f6801b8de20}")
