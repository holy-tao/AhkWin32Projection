 ...
 */
class IPasswordBox2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPasswordBox2
     * @type {Guid}
     */
    static IID => Guid("{5ed738df-212f-4aeb-b5b8-2c219aec3c0c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Header", "put_Header", "get_HeaderTemplate", "put_HeaderTemplate", "get_PlaceholderText", "put_PlaceholderText", "get_SelectionHighlightColor", "put_SelectionHighlightColor", "get_PreventKeyboardDisplayOnProgrammaticFocus", "put_PreventKeyboardDisplayOnProgrammaticFocus", "add_Paste", "remove_Paste"]
