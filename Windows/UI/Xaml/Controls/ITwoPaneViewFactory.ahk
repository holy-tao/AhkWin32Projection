 ...
 */
class ITwoPaneViewFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITwoPaneViewFactory
     * @type {Guid}
     */
    static IID => Guid("{18ff792d-58b4-59ed-a051-51aceffbcca9}")
