 ...
 */
class ITreeViewItemTemplateSettingsFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITreeViewItemTemplateSettingsFactory
     * @type {Guid}
     */
    static IID => Guid("{11a1953b-31b7-4f40-8633-02fc614b518c}")
