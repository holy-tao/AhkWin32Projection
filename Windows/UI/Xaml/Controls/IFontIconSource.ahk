 ...
 */
class IFontIconSource extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFontIconSource
     * @type {Guid}
     */
    static IID => Guid("{2211ac9a-74e3-43ed-b61c-21afc7df4d10}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Glyph", "put_Glyph", "get_FontSize", "put_FontSize", "get_FontFamily", "put_FontFamily", "get_FontWeight", "put_FontWeight", "get_FontStyle", "put_FontStyle", "get_IsTextScaleFactorEnabled", "put_IsTextScaleFactorEnabled", "get_MirroredWhenRightToLeft", "put_MirroredWhenRightToLeft"]
