 ...
 */
class IParallaxViewFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IParallaxViewFactory
     * @type {Guid}
     */
    static IID => Guid("{e4eb9642-3e8e-5a26-94f2-9121d121b916}")
