 ...
 */
class IInkToolbarStencilButtonFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IInkToolbarStencilButtonFactory
     * @type {Guid}
     */
    static IID => Guid("{a20701d1-8a70-4d77-89d4-1730a3a58edf}")
