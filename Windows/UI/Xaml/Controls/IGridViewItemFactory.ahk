 ...
 */
class IGridViewItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGridViewItemFactory
     * @type {Guid}
     */
    static IID => Guid("{229b00af-3fa6-43e9-979d-07ea0d6280dc}")
