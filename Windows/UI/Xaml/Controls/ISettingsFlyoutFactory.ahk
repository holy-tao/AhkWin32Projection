 ...
 */
class ISettingsFlyoutFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISettingsFlyoutFactory
     * @type {Guid}
     */
    static IID => Guid("{480c7011-57aa-4db6-b6fd-ec676f6d414e}")
