 ...
 */
class IRichEditBox2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRichEditBox2
     * @type {Guid}
     */
    static IID => Guid("{bbea6ead-e805-47a4-bbe7-47e59b8f74a7}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Header", "put_Header", "get_HeaderTemplate", "put_HeaderTemplate", "get_PlaceholderText", "put_PlaceholderText", "get_SelectionHighlightColor", "put_SelectionHighlightColor", "get_PreventKeyboardDisplayOnProgrammaticFocus", "put_PreventKeyboardDisplayOnProgrammaticFocus", "get_IsColorFontEnabled", "put_IsColorFontEnabled", "add_Paste", "remove_Paste"]
