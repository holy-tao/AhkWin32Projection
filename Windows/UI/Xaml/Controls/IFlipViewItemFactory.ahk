 ...
 */
class IFlipViewItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFlipViewItemFactory
     * @type {Guid}
     */
    static IID => Guid("{f21d91fe-22a0-4412-a853-9d6a6e8f2aaf}")
