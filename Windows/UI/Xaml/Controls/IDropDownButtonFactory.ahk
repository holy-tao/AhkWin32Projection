 ...
 */
class IDropDownButtonFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDropDownButtonFactory
     * @type {Guid}
     */
    static IID => Guid("{0d9f8ab5-e70d-52bd-9ca0-36ceecaa642a}")
