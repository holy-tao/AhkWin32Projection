 ...
 */
class IItemsControlFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IItemsControlFactory
     * @type {Guid}
     */
    static IID => Guid("{f7bbc359-f8fd-471c-bcb2-2c74be8ebf8c}")
