 ...
 */
class IContentControlFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContentControlFactory
     * @type {Guid}
     */
    static IID => Guid("{ab017b19-196e-4ed5-a27f-55c58fb1673f}")
