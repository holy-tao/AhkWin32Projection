 ...
 */
class IMenuBarItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMenuBarItemFactory
     * @type {Guid}
     */
    static IID => Guid("{ecf86f62-c394-50e2-a568-17af8cf26874}")
