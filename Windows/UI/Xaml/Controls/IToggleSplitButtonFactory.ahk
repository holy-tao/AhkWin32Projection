 ...
 */
class IToggleSplitButtonFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IToggleSplitButtonFactory
     * @type {Guid}
     */
    static IID => Guid("{3fcf073b-e57c-573d-af38-d1b2ad387951}")
    ...
    CreateInstance(baseInterface, innerInterface) {
        ...
        return ToggleSplitButton(value)
    }
}
