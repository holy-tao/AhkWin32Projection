 ...
 */
class IGroupItemFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGroupItemFactory
     * @type {Guid}
     */
    static IID => Guid("{d9a1d53e-b1e0-4319-9808-7a9e887e13b0}")
