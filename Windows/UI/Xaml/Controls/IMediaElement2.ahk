 ...
 */
class IMediaElement2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaElement2
     * @type {Guid}
     */
    static IID => Guid("{fd53da65-b186-4654-bfdb-180ed26cad07}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_AreTransportControlsEnabled", "put_AreTransportControlsEnabled", "get_Stretch", "put_Stretch", "get_IsFullWindow", "put_IsFullWindow", "SetMediaStreamSource", "get_PlayToPreferredSourceUri", "put_PlayToPreferredSourceUri"]
    ...
    SetMediaStreamSource(source) {
        result := ComCall(12, this, "ptr", source, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
