 ...
 */
class IPathIconSourceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPathIconSourceFactory
     * @type {Guid}
     */
    static IID => Guid("{8f7f85b9-5247-4f3b-833f-e384bf7e9c84}")
