 ...
 */
class IFontIconSourceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFontIconSourceFactory
     * @type {Guid}
     */
    static IID => Guid("{8bdcf6bd-fc06-42b8-b30b-7505082ac38f}")
