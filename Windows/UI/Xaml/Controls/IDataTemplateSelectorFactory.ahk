 ...
 */
class IDataTemplateSelectorFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDataTemplateSelectorFactory
     * @type {Guid}
     */
    static IID => Guid("{511baad0-210a-457d-9521-433d2b11b7d2}")
