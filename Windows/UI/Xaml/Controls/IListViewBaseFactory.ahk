 ...
 */
class IListViewBaseFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListViewBaseFactory
     * @type {Guid}
     */
    static IID => Guid("{e67e6c7f-150f-46d0-a6ac-c5002bd9ca53}")
