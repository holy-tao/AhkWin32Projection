 ...
 */
class IMarkupExtensionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMarkupExtensionFactory
     * @type {Guid}
     */
    static IID => Guid("{65329c05-fb5a-4567-9d55-5cdfbada2739}")
