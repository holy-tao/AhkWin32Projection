 ...
 */
class IFrameworkElementFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFrameworkElementFactory
     * @type {Guid}
     */
    static IID => Guid("{deaee126-03ca-4966-b576-604cce93b5e8}")
