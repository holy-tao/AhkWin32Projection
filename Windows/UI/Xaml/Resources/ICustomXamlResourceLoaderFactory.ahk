 ...
 */
class ICustomXamlResourceLoaderFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICustomXamlResourceLoaderFactory
     * @type {Guid}
     */
    static IID => Guid("{5bfd7e49-7886-44f3-8ed3-6fec0463ed69}")
