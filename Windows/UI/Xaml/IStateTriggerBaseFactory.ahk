 ...
 */
class IStateTriggerBaseFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IStateTriggerBaseFactory
     * @type {Guid}
     */
    static IID => Guid("{970e2c4b-bfaf-47b0-be42-c1d711bb2e9f}")
