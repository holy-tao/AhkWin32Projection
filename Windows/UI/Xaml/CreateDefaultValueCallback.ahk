 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.createdefaultvaluecallback
 * @namespace Windows.UI.Xaml
 * @version WindowsRuntime 1.4
 */
class CreateDefaultValueCallback extends IUnknown {

    static sizeof => A_PtrSize
    /**
     * The interface identifier for CreateDefaultValueCallback
     * @type {Guid}
     */
    static IID => Guid("{d6ecb12c-15b5-4ec8-b95c-cdd208f08153}")

    /**
     * The class identifier for CreateDefaultValueCallback
     * @type {Guid}
     */
    static CLSID => Guid("{d6ecb12c-15b5-4ec8-b95c-cdd208f08153}")
     ...
     */
    Invoke() {
        result := ComCall(3, this, "ptr*", &result_ := 0, "int")
        if(result != 0) {
