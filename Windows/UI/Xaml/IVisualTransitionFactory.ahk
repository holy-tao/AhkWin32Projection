 ...
 */
class IVisualTransitionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVisualTransitionFactory
     * @type {Guid}
     */
    static IID => Guid("{ea75864f-d1e0-4dae-b429-89fc322724f4}")
