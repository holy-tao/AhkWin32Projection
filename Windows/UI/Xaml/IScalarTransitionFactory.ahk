 ...
 */
class IScalarTransitionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IScalarTransitionFactory
     * @type {Guid}
     */
    static IID => Guid("{c9b1e9ee-90da-5ddd-be64-3e47977ea280}")
