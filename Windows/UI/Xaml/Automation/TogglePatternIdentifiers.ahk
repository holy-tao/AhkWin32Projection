...
#Include .\ITogglePatternIdentifiers.ahk
#Include .\ITogglePatternIdentifiersStatics.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.automation.togglepatternidentifiers
 * @namespace Windows.UI.Xaml.Automation
 * @version WindowsRuntime 1.4
 */
class TogglePatternIdentifiers extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ITogglePatternIdentifiers
     ...
     * @type {Guid}
     */
    static IID => ITogglePatternIdentifiers.IID

    /**
     * Identifies the [ToggleState](togglestate.md) automation property.
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.automation.togglepatternidentifiers.togglestateproperty
     * @type {AutomationProperty} 
     */
    static ToggleStateProperty {
        get => TogglePatternIdentifiers.get_ToggleStateProperty()
    }
...
;@region Static Methods
     ...
     */
    static get_ToggleStateProperty() {
        if (!TogglePatternIdentifiers.HasProp("__ITogglePatternIdentifiersStatics")) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Automation.TogglePatternIdentifiers")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITogglePatternIdentifiersStatics.IID)
            TogglePatternIdentifiers.__ITogglePatternIdentifiersStatics := ITogglePatternIdentifiersStatics(factoryPtr)
        }

        return TogglePatternIdentifiers.__ITogglePatternIdentifiersStatics.get_ToggleStateProperty()
    }
