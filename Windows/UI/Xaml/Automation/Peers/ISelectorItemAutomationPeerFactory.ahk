 ...
 */
class ISelectorItemAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISelectorItemAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{66d7edfb-786d-4362-a964-ebfb21776c30}")
    ...
    CreateInstanceWithParentAndItem(item, parent, baseInterface, innerInterface) {
        ...
        return SelectorItemAutomationPeer(value)
    }
}
