...
#Include ..\..\..\..\..\Guid.ahk
#Include .\MediaElementAutomationPeer.ahk
 ...
 */
class IMediaElementAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaElementAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{b2ad3b28-7575-4173-9bc7-80367a164ed2}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return MediaElementAutomationPeer(value)
    }
}
