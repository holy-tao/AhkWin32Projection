 ...
 */
class IFrameworkElementAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFrameworkElementAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{0db9b8bc-b812-48e3-af1f-dbc57600c325}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return FrameworkElementAutomationPeer(value)
    }
}
