...
#Include ..\..\..\..\..\Guid.ahk
#Include .\ListViewHeaderItemAutomationPeer.ahk
 ...
 */
class IListViewHeaderItemAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListViewHeaderItemAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{07668694-2ca5-4be4-a8b9-592d48f76087}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ListViewHeaderItemAutomationPeer(value)
    }
}
