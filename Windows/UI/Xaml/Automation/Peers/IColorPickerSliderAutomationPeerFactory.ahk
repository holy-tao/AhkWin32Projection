...
#Include ..\..\..\..\..\Guid.ahk
#Include .\ColorPickerSliderAutomationPeer.ahk
 ...
 */
class IColorPickerSliderAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IColorPickerSliderAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{1a55c77e-9dd6-45a3-9042-b40200fea1a9}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ColorPickerSliderAutomationPeer(value)
    }
}
