...
#Include ..\..\..\..\..\Guid.ahk
#Include .\AppBarToggleButtonAutomationPeer.ahk
 ...
 */
class IAppBarToggleButtonAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBarToggleButtonAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{d6f9139d-02c1-4221-9591-7d4efeb74701}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return AppBarToggleButtonAutomationPeer(value)
    }
}
