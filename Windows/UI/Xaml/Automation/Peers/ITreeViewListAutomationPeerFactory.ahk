...
#Include ..\..\..\..\..\Guid.ahk
#Include .\TreeViewListAutomationPeer.ahk
 ...
 */
class ITreeViewListAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITreeViewListAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{00f597e2-f811-475a-bfe6-290fe707fa88}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return TreeViewListAutomationPeer(value)
    }
}
