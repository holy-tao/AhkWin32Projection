...
#Include ..\..\..\..\..\Guid.ahk
#Include .\CalendarDatePickerAutomationPeer.ahk
 ...
 */
class ICalendarDatePickerAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICalendarDatePickerAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{ab705dd2-d293-45bf-9f19-26f7603a5e9b}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return CalendarDatePickerAutomationPeer(value)
    }
}
