...
#Include ..\..\..\..\..\Guid.ahk
#Include .\MediaTransportControlsAutomationPeer.ahk
 ...
 */
class IMediaTransportControlsAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaTransportControlsAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{f41cb003-e103-4ab0-812a-a08fbdb570ce}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return MediaTransportControlsAutomationPeer(value)
    }
}
