...
#Include ..\..\..\..\..\Guid.ahk
#Include .\SettingsFlyoutAutomationPeer.ahk
 ...
 */
class ISettingsFlyoutAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISettingsFlyoutAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{f94762bd-8a14-40e4-94a7-3f33c922e945}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return SettingsFlyoutAutomationPeer(value)
    }
}
