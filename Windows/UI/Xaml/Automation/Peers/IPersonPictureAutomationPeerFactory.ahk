...
#Include ..\..\..\..\..\Guid.ahk
#Include .\PersonPictureAutomationPeer.ahk
 ...
 */
class IPersonPictureAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPersonPictureAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{a95f1f6d-2524-44a4-97fd-1181130100ad}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return PersonPictureAutomationPeer(value)
    }
}
