...
#Include ..\..\..\..\..\Guid.ahk
#Include .\ScrollBarAutomationPeer.ahk
 ...
 */
class IScrollBarAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IScrollBarAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{e1302110-afeb-4595-8e3d-edc0844a2b21}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ScrollBarAutomationPeer(value)
    }
}
