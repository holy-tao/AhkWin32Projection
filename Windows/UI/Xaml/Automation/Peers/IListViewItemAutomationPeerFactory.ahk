 ...
 */
class IListViewItemAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListViewItemAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{c47dfbc0-facc-4024-a73b-17ec4e662654}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ListViewItemAutomationPeer(value)
    }
}
