 ...
 */
class IAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{20c27545-a88b-43c8-bc24-cea9dafd04a3}")
