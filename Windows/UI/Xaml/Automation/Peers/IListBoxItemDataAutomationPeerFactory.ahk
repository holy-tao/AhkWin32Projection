...
#Include ..\..\..\..\..\Guid.ahk
#Include .\ListBoxItemDataAutomationPeer.ahk
 ...
 */
class IListBoxItemDataAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IListBoxItemDataAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{d7924e16-bd8d-4662-a995-20ff9a056093}")
    ...
    CreateInstanceWithParentAndItem(item, parent, baseInterface, innerInterface) {
        ...
        return ListBoxItemDataAutomationPeer(value)
    }
}
