 ...
 */
class IItemsControlAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IItemsControlAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{4038a259-2e1a-49ca-a533-c64f181577e6}")
