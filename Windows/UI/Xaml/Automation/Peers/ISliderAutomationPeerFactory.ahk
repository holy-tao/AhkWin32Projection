 ...
 */
class ISliderAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISliderAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{971b8056-9a7a-4df9-95fa-6f5c04c91cac}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return SliderAutomationPeer(value)
    }
}
