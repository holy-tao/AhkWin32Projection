 ...
 */
class IButtonBaseAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IButtonBaseAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{8a04091e-e6b2-4c60-a759-c13ca45165ed}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ButtonBaseAutomationPeer(value)
    }
}
