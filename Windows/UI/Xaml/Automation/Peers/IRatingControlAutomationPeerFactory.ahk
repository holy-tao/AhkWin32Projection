...
#Include ..\..\..\..\..\Guid.ahk
#Include .\RatingControlAutomationPeer.ahk
 ...
 */
class IRatingControlAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRatingControlAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{f179f272-9846-4632-8b9c-be6fa8d3c9bb}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return RatingControlAutomationPeer(value)
    }
}
