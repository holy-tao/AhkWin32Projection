...
#Include ..\..\..\..\..\Guid.ahk
#Include .\DatePickerAutomationPeer.ahk
 ...
 */
class IDatePickerAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDatePickerAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{e5667d19-9157-4436-9f4d-7fb99174b48e}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return DatePickerAutomationPeer(value)
    }
}
