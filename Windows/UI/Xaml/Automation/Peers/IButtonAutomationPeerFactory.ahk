 ...
 */
class IButtonAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IButtonAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{3fdb9f49-f4ab-4780-8644-03376299a175}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ButtonAutomationPeer(value)
    }
}
