...
#Include ..\..\..\..\..\Guid.ahk
#Include .\ToggleSwitchAutomationPeer.ahk
 ...
 */
class IToggleSwitchAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IToggleSwitchAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{31f933e3-fef8-4419-9df5-d9ef7196ea34}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return ToggleSwitchAutomationPeer(value)
    }
}
