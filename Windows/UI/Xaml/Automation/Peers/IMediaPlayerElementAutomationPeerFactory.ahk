...
#Include ..\..\..\..\..\Guid.ahk
#Include .\MediaPlayerElementAutomationPeer.ahk
 ...
 */
class IMediaPlayerElementAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaPlayerElementAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{08848077-82af-4d19-b170-282a9e0e7f37}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return MediaPlayerElementAutomationPeer(value)
    }
}
