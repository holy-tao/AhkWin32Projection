...
#Include ..\..\..\..\..\Guid.ahk
#Include .\AppBarAutomationPeer.ahk
 ...
 */
class IAppBarAutomationPeerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBarAutomationPeerFactory
     * @type {Guid}
     */
    static IID => Guid("{8360f4e2-e396-4517-af5d-f4cf34c54edf}")
    ...
    CreateInstanceWithOwner(owner, baseInterface, innerInterface) {
        ...
        return AppBarAutomationPeer(value)
    }
}
