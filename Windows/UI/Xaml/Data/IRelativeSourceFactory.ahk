 ...
 */
class IRelativeSourceFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRelativeSourceFactory
     * @type {Guid}
     */
    static IID => Guid("{ef8392cd-446e-4f93-aacb-9b1255577460}")
