 ...
 */
class IDragOperationDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDragOperationDeferral
     * @type {Guid}
     */
    static IID => Guid("{ba73ecba-1b73-4086-b3d3-c223beea1633}")
