 ...
 */
class IDependencyObjectCollectionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDependencyObjectCollectionFactory
     * @type {Guid}
     */
    static IID => Guid("{051e79ff-b3a8-49ee-b5af-ac8f68b649e4}")
