 ...
 */
class IRotateTransform extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRotateTransform
     * @type {Guid}
     */
    static IID => Guid("{688ea9b9-1e4e-4596-86e3-428b27334faf}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_CenterX", "put_CenterX", "get_CenterY", "put_CenterY", "get_Angle", "put_Angle"]
