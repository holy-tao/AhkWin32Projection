 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection
 * @namespace Windows.UI.Xaml.Media
 * @version WindowsRuntime 1.4
 */
class PathSegmentCollection extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.PathSegmentCollection")
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(PathSegment, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @param {Generic} value The value to set.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{11fdd506-b21d-564d-b6a8-ff991057b8f3}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.pathsegmentcollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{37e2cb21-b9c9-5006-bed7-4c328981b551}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(PathSegment, outPtr)
        }
