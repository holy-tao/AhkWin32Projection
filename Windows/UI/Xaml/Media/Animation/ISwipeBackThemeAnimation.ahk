 ...
 */
class ISwipeBackThemeAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISwipeBackThemeAnimation
     * @type {Guid}
     */
    static IID => Guid("{a38a4214-0bca-4d2d-95f7-ceba57fbaf60}")
