...
#Include .\ILinearPointKeyFrame.ahk
#Include ..\..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.linearpointkeyframe
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ILinearPointKeyFrame
     ...
     * @type {Guid}
     */
    static IID => ILinearPointKeyFrame.IID
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.Animation.LinearPointKeyFrame")
