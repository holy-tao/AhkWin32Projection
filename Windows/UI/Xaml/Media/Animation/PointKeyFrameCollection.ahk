 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection
 * @namespace Windows.UI.Xaml.Media.Animation
 * @version WindowsRuntime 1.4
 */
class PointKeyFrameCollection extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.Animation.PointKeyFrameCollection")
     ...
     * @param {Integer} index The integer index of the value to retrieve.
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(PointKeyFrame, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{b17e26de-9cd7-5456-bee0-49882a87f945}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.pointkeyframecollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{b8de4dc9-8c69-55f3-af58-040f1319649c}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(PointKeyFrame, outPtr)
        }
