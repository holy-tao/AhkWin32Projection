 ...
 */
class IColorAnimationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IColorAnimationStatics
     * @type {Guid}
     */
    static IID => Guid("{55eaf6e2-87e3-4f48-958f-855b2f9ea9ec}")
