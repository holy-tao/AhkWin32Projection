 ...
 */
class IDrillOutThemeAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDrillOutThemeAnimation
     * @type {Guid}
     */
    static IID => Guid("{d890ccdf-06d3-4f7e-8e4a-4fb76e256139}")
