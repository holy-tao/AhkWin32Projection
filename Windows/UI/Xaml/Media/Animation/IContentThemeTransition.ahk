 ...
 */
class IContentThemeTransition extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContentThemeTransition
     * @type {Guid}
     */
    static IID => Guid("{f66fc5c3-5915-437d-8e3b-adf8e7f0ab57}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_HorizontalOffset", "put_HorizontalOffset", "get_VerticalOffset", "put_VerticalOffset"]
