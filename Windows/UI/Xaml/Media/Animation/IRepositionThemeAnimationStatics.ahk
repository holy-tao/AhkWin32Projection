 ...
 */
class IRepositionThemeAnimationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRepositionThemeAnimationStatics
     * @type {Guid}
     */
    static IID => Guid("{4d92b1b1-860b-4bf9-a59d-1eb1ccbe8fe0}")
