 ...
 */
class IPointKeyFrameFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPointKeyFrameFactory
     * @type {Guid}
     */
    static IID => Guid("{cb214bdf-426a-4392-8355-c2ae52852623}")
