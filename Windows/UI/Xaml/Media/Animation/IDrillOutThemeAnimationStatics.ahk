 ...
 */
class IDrillOutThemeAnimationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDrillOutThemeAnimationStatics
     * @type {Guid}
     */
    static IID => Guid("{beb5db9b-2617-4888-80dd-72fa7bb6fac3}")
