 ...
 */
class IObjectKeyFrameFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IObjectKeyFrameFactory
     * @type {Guid}
     */
    static IID => Guid("{1626143e-3e6d-44d8-9b9a-04aea70f8492}")
