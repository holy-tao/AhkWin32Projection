 ...
 */
class IDoubleKeyFrameFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDoubleKeyFrameFactory
     * @type {Guid}
     */
    static IID => Guid("{ac97dec3-7538-40b9-b152-696f7fbf4722}")
