 ...
 */
class ISplitOpenThemeAnimationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISplitOpenThemeAnimationStatics
     * @type {Guid}
     */
    static IID => Guid("{8d4cfa89-3a91-458d-b0fb-4cad625cbf8d}")
