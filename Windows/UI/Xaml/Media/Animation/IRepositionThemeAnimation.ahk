 ...
 */
class IRepositionThemeAnimation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRepositionThemeAnimation
     * @type {Guid}
     */
    static IID => Guid("{ecda24e8-8945-4949-a1bf-62109965a7e9}")
