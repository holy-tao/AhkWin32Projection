 ...
 */
class IEasingDoubleKeyFrame extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEasingDoubleKeyFrame
     * @type {Guid}
     */
    static IID => Guid("{965adb8d-9a54-4108-b4ff-b5a5212cb338}")
