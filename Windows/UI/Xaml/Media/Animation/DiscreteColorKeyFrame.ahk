...
#Include .\IDiscreteColorKeyFrame.ahk
#Include ..\..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.discretecolorkeyframe
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IDiscreteColorKeyFrame
     ...
     * @type {Guid}
     */
    static IID => IDiscreteColorKeyFrame.IID
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.Animation.DiscreteColorKeyFrame")
