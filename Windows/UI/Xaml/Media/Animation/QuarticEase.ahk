 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.quarticease
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IQuarticEase
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.Animation.QuarticEase")
