 ...
 */
class INavigationTransitionInfoFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for INavigationTransitionInfoFactory
     * @type {Guid}
     */
    static IID => Guid("{edf4f8d5-af63-4fab-9d4a-87927f82dd6b}")
