...
#Include .\ILinearDoubleKeyFrame.ahk
#Include ..\..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.animation.lineardoublekeyframe
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ILinearDoubleKeyFrame
     ...
     * @type {Guid}
     */
    static IID => ILinearDoubleKeyFrame.IID
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.Animation.LinearDoubleKeyFrame")
