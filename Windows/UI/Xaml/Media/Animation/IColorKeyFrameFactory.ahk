 ...
 */
class IColorKeyFrameFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IColorKeyFrameFactory
     * @type {Guid}
     */
    static IID => Guid("{769bd88a-9cfb-4a7d-96c4-a1e7de6fdb4b}")
