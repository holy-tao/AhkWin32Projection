 ...
 */
class IRevealBrushFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRevealBrushFactory
     * @type {Guid}
     */
    static IID => Guid("{9d9379ce-e3a0-4aaf-be37-ea9d9dd43105}")
