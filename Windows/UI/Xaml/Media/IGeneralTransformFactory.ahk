 ...
 */
class IGeneralTransformFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGeneralTransformFactory
     * @type {Guid}
     */
    static IID => Guid("{7a25c930-29c4-4e31-b6f9-dedd52e4df1b}")
