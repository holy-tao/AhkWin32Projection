 ...
 */
class IAcrylicBrushFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAcrylicBrushFactory
     * @type {Guid}
     */
    static IID => Guid("{81a32568-f6cc-4013-8363-928ae23b7a61}")
