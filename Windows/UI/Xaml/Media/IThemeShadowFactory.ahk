 ...
 */
class IThemeShadowFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IThemeShadowFactory
     * @type {Guid}
     */
    static IID => Guid("{2e71465d-0f67-590e-831b-7e5e2a32b778}")
