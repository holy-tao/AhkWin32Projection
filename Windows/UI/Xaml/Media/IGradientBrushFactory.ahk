 ...
 */
class IGradientBrushFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGradientBrushFactory
     * @type {Guid}
     */
    static IID => Guid("{ed4779ca-45bd-4131-b625-be86e07c6112}")
