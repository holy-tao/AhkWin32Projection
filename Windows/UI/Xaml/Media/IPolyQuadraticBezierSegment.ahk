 ...
 */
class IPolyQuadraticBezierSegment extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPolyQuadraticBezierSegment
     * @type {Guid}
     */
    static IID => Guid("{dd5ced7d-e6db-4c96-b6a1-3fce96e987a6}")
