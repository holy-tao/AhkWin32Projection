 ...
 */
class IRenderTargetBitmapStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRenderTargetBitmapStatics
     * @type {Guid}
     */
    static IID => Guid("{f0a1efee-c131-4d40-9c47-f7d7cf2b077f}")
