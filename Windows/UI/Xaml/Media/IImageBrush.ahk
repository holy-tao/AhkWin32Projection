 ...
 */
class IImageBrush extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IImageBrush
     * @type {Guid}
     */
    static IID => Guid("{9fd11377-c12a-4493-bf7d-f3a8ad74b554}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ImageSource", "put_ImageSource", "add_ImageFailed", "remove_ImageFailed", "add_ImageOpened", "remove_ImageOpened"]
