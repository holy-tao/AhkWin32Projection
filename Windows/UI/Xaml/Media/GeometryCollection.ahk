 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection
 * @namespace Windows.UI.Xaml.Media
 * @version WindowsRuntime 1.4
 */
class GeometryCollection extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Media.GeometryCollection")
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(Geometry, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @param {Generic} value The value to set.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{84c6ac3a-8207-5599-9583-606ac2139ddd}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.media.geometrycollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{35340039-0dfc-52b4-8748-0d9a755db8a8}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(Geometry, outPtr)
        }
