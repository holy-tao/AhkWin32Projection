 ...
 */
class ITileBrushFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITileBrushFactory
     * @type {Guid}
     */
    static IID => Guid("{aa159f7c-ed6a-4fb3-b014-b5c7e379a4de}")
