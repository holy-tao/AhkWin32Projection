 ...
 */
class IResourceDictionaryFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IResourceDictionaryFactory
     * @type {Guid}
     */
    static IID => Guid("{ea3639b5-31b7-4271-92c9-7c9584a91c22}")
