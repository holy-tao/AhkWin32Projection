 ...
 */
class IUIElementWeakCollectionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUIElementWeakCollectionFactory
     * @type {Guid}
     */
    static IID => Guid("{57242561-188a-5304-8792-a43f35d90f99}")
