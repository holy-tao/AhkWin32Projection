 ...
 */
class IDispatcherTimer extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDispatcherTimer
     * @type {Guid}
     */
    static IID => Guid("{d160ce46-cd22-4f5f-8c97-40e61da3e2dc}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Interval", "put_Interval", "get_IsEnabled", "add_Tick", "remove_Tick", "Start", "Stop"]
