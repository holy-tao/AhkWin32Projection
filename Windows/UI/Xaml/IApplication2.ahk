 ...
 */
class IApplication2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IApplication2
     * @type {Guid}
     */
    static IID => Guid("{019104be-522a-5904-f52f-de72010429e0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_FocusVisualKind", "put_FocusVisualKind", "get_RequiresPointerMode", "put_RequiresPointerMode", "add_LeavingBackground", "remove_LeavingBackground", "add_EnteredBackground", "remove_EnteredBackground"]
