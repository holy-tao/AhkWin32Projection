 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection
 * @namespace Windows.UI.Xaml.Documents
 * @version WindowsRuntime 1.4
 */
class InlineCollection extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(Inline, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @param {Generic} value The value to set.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{92ec9252-8ee3-55d6-84b4-30b635077778}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.inlinecollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{e1d2b910-18c2-5906-8f8a-d62a63f93f18}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(Inline, outPtr)
        }
