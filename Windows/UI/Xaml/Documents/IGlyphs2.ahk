 ...
 */
class IGlyphs2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGlyphs2
     * @type {Guid}
     */
    static IID => Guid("{aa8bfe5c-3754-4bee-bbe1-4403ee9b86f0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsColorFontEnabled", "put_IsColorFontEnabled", "get_ColorFontPaletteIndex", "put_ColorFontPaletteIndex"]
