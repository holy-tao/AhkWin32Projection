...
#Include .\IContentLinkProviderCollection.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection
 * @namespace Windows.UI.Xaml.Documents
 * @version WindowsRuntime 1.4
 */
class ContentLinkProviderCollection extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IContentLinkProviderCollection
     ...
     * @type {Guid}
     */
    static IID => IContentLinkProviderCollection.IID
...
;@region Instance Properties
     ...
     * > [!IMPORTANT]
     * > This API supports content links. The Windows features that enable content links are not available in versions of Windows after Windows 10 version 1903. Content links for XAML text controls will not function in versions of Windows later than version 1903.
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.UI.Xaml.Documents.ContentLinkProviderCollection")
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.getat
     */
    GetAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IVector := IVector(ContentLinkProvider, outPtr)
        }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.getview
     */
    GetView() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.indexof
     */
    IndexOf(value, index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.setat
     */
    SetAt(index, value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @param {Generic} value The value to set.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.insertat
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.removeat
     */
    RemoveAt(index) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.append
     */
    Append(value) {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.removeatend
     */
    RemoveAtEnd() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * > This API supports content links. The Windows features that enable content links are not available in versions of Windows after Windows 10 version 1903. Content links for XAML text controls will not function in versions of Windows later than version 1903.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.clear
     */
    Clear() {
        if (!this.HasProp("__IVector")) {
            piid := Guid("{e69ef1b6-2eb1-5e9c-bc41-b94d396281e4}")
     ...
     * @returns {Integer} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.getmany
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.replaceall
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ui.xaml.documents.contentlinkprovidercollection.first
     */
    First() {
        if (!this.HasProp("__IIterable")) {
            piid := Guid("{193a81bb-d85c-5cd3-a130-a1d08eaaf4be}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IIterable := IIterable(ContentLinkProvider, outPtr)
        }
