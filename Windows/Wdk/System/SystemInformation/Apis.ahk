...
#Import ".\SYSTEM_INFORMATION_CLASS.ahk" { SYSTEM_INFORMATION_CLASS }
 ...
 * @param {SYSTEM_INFORMATION_CLASS} SystemInformationClass One of the values enumerated in SYSTEM_INFORMATION_CLASS, which indicate the
 * kind of system information to be retrieved. These include the following values.
 * @param {Pointer<Void>} _SystemInformation A pointer to a buffer that receives the requested information. The
...
export NtQuerySystemInformation(SystemInformationClass, _SystemInformation, SystemInformationLength, ReturnLength) {
    ...
    result := DllCall("ntdll.dll\NtQuerySystemInformation", SYSTEM_INFORMATION_CLASS, SystemInformationClass, _SystemInformationMarshal, _SystemInformation, "uint", SystemInformationLength, ReturnLengthMarshal, ReturnLength, NTSTATUS)
 ...
 * @param {SYSTEM_INFORMATION_CLASS} SystemInformationClass The type of system information to be retrieved. This parameter can be one of the following values from the **SYSTEM\_INFORMATION\_CLASS** enumeration type.
 * 
 * 
 ...
 * @param {Pointer<Void>} _SystemInformation A pointer to a buffer that receives the requested information. The size and structure of this information varies depending on the value of the *SystemInformationClass* parameter, as indicated in the following table.
 * 
 * 
...
export ZwQuerySystemInformation(SystemInformationClass, _SystemInformation, SystemInformationLength, ReturnLength) {
    ...
    result := DllCall("ntdll.dll\ZwQuerySystemInformation", SYSTEM_INFORMATION_CLASS, SystemInformationClass, _SystemInformationMarshal, _SystemInformation, "uint", SystemInformationLength, ReturnLengthMarshal, ReturnLength, NTSTATUS)
    NTSTATUS.ThrowIfError(result)
    return result
}
 ...
 * @remarks
 * This function has no associated import library. You must use the <a href="https://docs.microsoft.com/windows/desktop/api/libloaderapi/nf-libloaderapi-loadlibrarya">LoadLibrary</a> and <a href="https://docs.microsoft.com/windows/desktop/api/libloaderapi/nf-libloaderapi-getprocaddress">GetProcAddress</a> functions to dynamically link to Ntdll.dll.
 * @param {Pointer<Integer>} _SystemTime A pointer to a <a href="https://docs.microsoft.com/windows/win32/api/winnt/ns-winnt-large_integer-r1">LARGE_INTEGER</a> structure that receives the system time. This is a 64-bit value representing the number of 100-nanosecond intervals since January 1, 1601 (UTC).
