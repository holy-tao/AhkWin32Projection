 ...
 * @version v4.0.30319
 */
class PMAP_TRANSFER extends IUnknown {
    ...
    Invoke(DmaAdapter, Mdl_, MapRegisterBase, CurrentVa, Length, WriteToDevice) {
        ...
        result := ComCall(3, this, "ptr", DmaAdapter, "ptr", Mdl_, MapRegisterBaseMarshal, MapRegisterBase, CurrentVaMarshal, CurrentVa, LengthMarshal, Length, "char", WriteToDevice, "int64")
        return result
    }
}
