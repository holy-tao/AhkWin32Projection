 ...
 * @version v4.0.30319
 */
class PFN_IN_USE_PAGE_OFFLINE_NOTIFY extends IUnknown {
     ...
     */
    Invoke(Page, Flags, Poisoned, Context_) {
        Context_Marshal := Context_ is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "uint", Page, "char", Flags, "char", Poisoned, Context_Marshal, Context_, "char")
        return result
    }
}
