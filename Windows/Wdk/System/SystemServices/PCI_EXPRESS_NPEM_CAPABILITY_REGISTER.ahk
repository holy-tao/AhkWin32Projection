 ...
 * @version v4.0.30319
 */
class PCI_EXPRESS_NPEM_CAPABILITY_REGISTER extends Win32Struct
{
    static sizeof => 8
     ...
     */
    Rsvd {
        get => (this._bitfield >> 12) & 0xFFF
        set => this._bitfield := ((value & 0xFFF) << 12) | (this._bitfield & ~(0xFFF << 12))
    }
