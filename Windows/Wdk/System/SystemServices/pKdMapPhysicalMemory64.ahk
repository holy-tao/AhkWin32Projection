 ...
 * @version v4.0.30319
 */
class pKdMapPhysicalMemory64 extends IUnknown {
     ...
     */
    Invoke(PhysicalAddress, NumberPages, FlushCurrentTLB) {
        result := ComCall(3, this, "int64", PhysicalAddress, "uint", NumberPages, "char", FlushCurrentTLB, "ptr")
        return result
    }
}
