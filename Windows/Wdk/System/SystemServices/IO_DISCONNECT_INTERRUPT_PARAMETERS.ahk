 ...
 */
class IO_DISCONNECT_INTERRUPT_PARAMETERS extends Win32Struct {
    static sizeof => 16
    ...
    ConnectionContext {
        get {
            if(!this.HasProp("__ConnectionContext"))
                this.__ConnectionContext := IO_DISCONNECT_INTERRUPT_PARAMETERS._ConnectionContext_e__Union(8, this)
