 ...
 * @version v4.0.30319
 */
class RTL_AVL_MATCH_FUNCTION extends IUnknown {
     ...
     */
    Invoke(Table, UserData_, MatchData) {
        UserData_Marshal := UserData_ is VarRef ? "ptr" : "ptr"
        MatchDataMarshal := MatchData is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", Table, UserData_Marshal, UserData_, MatchDataMarshal, MatchData, "int")
        return result
    }
}
