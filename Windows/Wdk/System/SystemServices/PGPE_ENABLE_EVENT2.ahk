 ...
 */
export default struct PGPE_ENABLE_EVENT2 {
    value : IntPtr

    __value {
        set {
            if (value is PGPE_ENABLE_EVENT2) {
    ...
    /**
     * A PGPE_ENABLE_EVENT2 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PGPE_ENABLE_EVENT2 {
        /**
         * Creates a PGPE_ENABLE_EVENT2 pointer that invokes the given AHK function when called.
