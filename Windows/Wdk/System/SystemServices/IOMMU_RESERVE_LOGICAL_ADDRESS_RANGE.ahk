 ...
 * @version v4.0.30319
 */
class IOMMU_RESERVE_LOGICAL_ADDRESS_RANGE extends IUnknown {
     ...
     */
    Invoke(Domain, Size_, ExplicitLogicalAddress, MinLogicalAddress, MaxLogicalAddress, LogicalAddressToken) {
        ...
        result := ComCall(3, this, "ptr", Domain, "ptr", Size_, ExplicitLogicalAddressMarshal, ExplicitLogicalAddress, MinLogicalAddressMarshal, MinLogicalAddress, MaxLogicalAddressMarshal, MaxLogicalAddress, LogicalAddressTokenMarshal, LogicalAddressToken, "int")
        return result
    }
}
