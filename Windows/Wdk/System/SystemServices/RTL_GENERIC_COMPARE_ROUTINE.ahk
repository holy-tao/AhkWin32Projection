 ...
 * @version v4.0.30319
 */
class RTL_GENERIC_COMPARE_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Table, FirstStruct, SecondStruct) {
        FirstStructMarshal := FirstStruct is VarRef ? "ptr" : "ptr"
        SecondStructMarshal := SecondStruct is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", Table, FirstStructMarshal, FirstStruct, SecondStructMarshal, SecondStruct, "int")
        return result
    }
}
