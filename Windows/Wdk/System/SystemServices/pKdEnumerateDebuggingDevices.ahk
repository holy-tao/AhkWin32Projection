...
#Import ".\PDEBUG_DEVICE_FOUND_FUNCTION.ahk" { PDEBUG_DEVICE_FOUND_FUNCTION }
...
export default struct pKdEnumerateDebuggingDevices {
    ...
    struct From extends pKdEnumerateDebuggingDevices {
         ...
         * @param {Func("ptr", DEBUG_DEVICE_DESCRIPTOR, PDEBUG_DEVICE_FOUND_FUNCTION) => NTSTATUS} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 3)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 3 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , ["ptr", DEBUG_DEVICE_DESCRIPTOR.Ptr, PDEBUG_DEVICE_FOUND_FUNCTION, NTSTATUS])
        }
