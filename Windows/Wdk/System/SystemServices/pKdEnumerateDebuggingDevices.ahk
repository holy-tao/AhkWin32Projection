 ...
 * @version v4.0.30319
 */
class pKdEnumerateDebuggingDevices extends IUnknown {
     ...
     */
    Invoke(LoaderBlock, Device, Callback) {
        LoaderBlockMarshal := LoaderBlock is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, LoaderBlockMarshal, LoaderBlock, "ptr", Device, "ptr", Callback, "int")
        return result
    }
}
