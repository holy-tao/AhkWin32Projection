 ...
 * @version v4.0.30319
 */
class GET_VIRTUAL_DEVICE_LOCATION extends IUnknown {
     ...
     */
    Invoke(Context_, VirtualFunction, SegmentNumber, BusNumber, FunctionNumber) {
        ...
        result := ComCall(3, this, Context_Marshal, Context_, "ushort", VirtualFunction, SegmentNumberMarshal, SegmentNumber, BusNumberMarshal, BusNumber, FunctionNumberMarshal, FunctionNumber, "int")
        return result
    }
}
