 ...
 */
export default struct PSHED_PI_ENABLE_ERROR_SOURCE {
    value : IntPtr

    __value {
        set {
            if (value is PSHED_PI_ENABLE_ERROR_SOURCE) {
    ...
    /**
     * A PSHED_PI_ENABLE_ERROR_SOURCE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSHED_PI_ENABLE_ERROR_SOURCE {
        /**
         * Creates a PSHED_PI_ENABLE_ERROR_SOURCE pointer that invokes the given AHK function when called.
