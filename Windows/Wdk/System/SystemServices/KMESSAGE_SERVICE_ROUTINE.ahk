 ...
 * @version v4.0.30319
 */
class KMESSAGE_SERVICE_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Interrupt, ServiceContext, MessageID) {
        InterruptMarshal := Interrupt is VarRef ? "ptr*" : "ptr"
        ServiceContextMarshal := ServiceContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, InterruptMarshal, Interrupt, ServiceContextMarshal, ServiceContext, "uint", MessageID, "char")
        return result
    }
}
