 ...
 * @version v4.0.30319
 */
class PciPin2Line extends IUnknown {
     ...
     */
    Invoke(BusHandler, RootHandler, SlotNumber, PciData) {
        BusHandlerMarshal := BusHandler is VarRef ? "ptr*" : "ptr"
        RootHandlerMarshal := RootHandler is VarRef ? "ptr*" : "ptr"

        ComCall(3, this, BusHandlerMarshal, BusHandler, RootHandlerMarshal, RootHandler, "ptr", SlotNumber, "ptr", PciData)
    }
}
