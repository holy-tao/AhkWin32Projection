...
export default struct PGET_SCATTER_GATHER_LIST_EX {
    ...
    struct From extends PGET_SCATTER_GATHER_LIST_EX {
         ...
         * @param {Func(DMA_ADAPTER, DEVICE_OBJECT, "ptr", MDL, Int64, UInt32, UInt32, "ptr", "ptr", BOOLEAN, "ptr", "ptr", "ptr*") => NTSTATUS} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 13)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 13 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [DMA_ADAPTER.Ptr, DEVICE_OBJECT.Ptr, "ptr", MDL.Ptr, Int64, UInt32, UInt32, "ptr", "ptr", BOOLEAN, "ptr", "ptr", "ptr*", NTSTATUS])
        }
