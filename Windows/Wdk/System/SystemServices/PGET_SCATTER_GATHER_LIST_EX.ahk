 ...
 * @version v4.0.30319
 */
class PGET_SCATTER_GATHER_LIST_EX extends IUnknown {
     ...
     */
    Invoke(DmaAdapter, DeviceObject, DmaTransferContext, Mdl_, Offset, Length, Flags, ExecutionRoutine, Context_, WriteToDevice, DmaCompletionRoutine, CompletionContext, ScatterGatherList) {
