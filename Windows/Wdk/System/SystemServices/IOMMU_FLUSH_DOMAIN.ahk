 ...
 */
export default struct IOMMU_FLUSH_DOMAIN {
    value : IntPtr

    __value {
        set {
            if (value is IOMMU_FLUSH_DOMAIN) {
    ...
    /**
     * A IOMMU_FLUSH_DOMAIN that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends IOMMU_FLUSH_DOMAIN {
        /**
         * Creates a IOMMU_FLUSH_DOMAIN pointer that invokes the given AHK function when called.
