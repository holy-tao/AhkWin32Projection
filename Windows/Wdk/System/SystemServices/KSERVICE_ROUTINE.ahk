 ...
 * @version v4.0.30319
 */
class KSERVICE_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Interrupt, ServiceContext) {
        InterruptMarshal := Interrupt is VarRef ? "ptr*" : "ptr"
        ServiceContextMarshal := ServiceContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, InterruptMarshal, Interrupt, ServiceContextMarshal, ServiceContext, "char")
        return result
    }
}
