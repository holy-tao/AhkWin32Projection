 ...
 * @version v4.0.30319
 */
class pHalTranslateBusAddress extends IUnknown {
     ...
     */
    Invoke(InterfaceType, BusNumber, BusAddress, AddressSpace, TranslatedAddress) {
        AddressSpaceMarshal := AddressSpace is VarRef ? "uint*" : "ptr"
        TranslatedAddressMarshal := TranslatedAddress is VarRef ? "int64*" : "ptr"

        result := ComCall(3, this, "int", InterfaceType, "uint", BusNumber, "int64", BusAddress, AddressSpaceMarshal, AddressSpace, TranslatedAddressMarshal, TranslatedAddress, "char")
        return result
    }
}
