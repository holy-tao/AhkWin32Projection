 ...
 * @version v4.0.30319
 */
class TRANSLATE_BUS_ADDRESS extends IUnknown {
     ...
     */
    Invoke(Context_, BusAddress, Length, AddressSpace, TranslatedAddress) {
        ...
        result := ComCall(3, this, Context_Marshal, Context_, "int64", BusAddress, "uint", Length, AddressSpaceMarshal, AddressSpace, TranslatedAddressMarshal, TranslatedAddress, "char")
        return result
    }
}
