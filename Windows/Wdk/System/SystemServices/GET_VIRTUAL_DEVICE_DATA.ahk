 ...
 */
export default struct GET_VIRTUAL_DEVICE_DATA {
    value : IntPtr

    __value {
        set {
            if (value is GET_VIRTUAL_DEVICE_DATA) {
    ...
    /**
     * A GET_VIRTUAL_DEVICE_DATA that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends GET_VIRTUAL_DEVICE_DATA {
        /**
         * Creates a GET_VIRTUAL_DEVICE_DATA pointer that invokes the given AHK function when called.
