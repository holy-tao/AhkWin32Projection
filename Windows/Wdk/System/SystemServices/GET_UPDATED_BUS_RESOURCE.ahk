 ...
 * @version v4.0.30319
 */
class GET_UPDATED_BUS_RESOURCE extends IUnknown {
     ...
     */
    Invoke(Context_, UpdatedResourceList, UpdatedTranslatedResourceList) {
        ...
        result := ComCall(3, this, Context_Marshal, Context_, UpdatedResourceListMarshal, UpdatedResourceList, UpdatedTranslatedResourceListMarshal, UpdatedTranslatedResourceList, "int")
        return result
    }
}
