 ...
 * @version v4.0.30319
 */
class PTRANSLATE_RESOURCE_REQUIREMENTS_HANDLER extends IUnknown {
     ...
     */
    Invoke(Context_, Source, PhysicalDeviceObject, TargetCount, Target) {
        Context_Marshal := Context_ is VarRef ? "ptr" : "ptr"
        TargetCountMarshal := TargetCount is VarRef ? "uint*" : "ptr"
        TargetMarshal := Target is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, Context_Marshal, Context_, "ptr", Source, "ptr", PhysicalDeviceObject, TargetCountMarshal, TargetCount, TargetMarshal, Target, "int")
        return result
    }
}
