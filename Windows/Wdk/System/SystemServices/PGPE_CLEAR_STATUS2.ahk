 ...
 */
export default struct PGPE_CLEAR_STATUS2 {
    value : IntPtr

    __value {
        set {
            if (value is PGPE_CLEAR_STATUS2) {
    ...
    /**
     * A PGPE_CLEAR_STATUS2 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PGPE_CLEAR_STATUS2 {
        /**
         * Creates a PGPE_CLEAR_STATUS2 pointer that invokes the given AHK function when called.
