 ...
 */
export default struct pKdGetPciDataByOffset {
    value : IntPtr

    __value {
        set {
            if (value is pKdGetPciDataByOffset) {
    ...
    /**
     * A pKdGetPciDataByOffset that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends pKdGetPciDataByOffset {
        /**
         * Creates a pKdGetPciDataByOffset pointer that invokes the given AHK function when called.
