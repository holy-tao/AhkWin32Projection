 ...
 * @version v4.0.30319
 */
class DEVICE_QUERY_BUS_SPECIFIC_RESET_HANDLER extends IUnknown {
     ...
     */
    Invoke(InterfaceContext, ResetInfoCount, ResetInfoSupported) {
        InterfaceContextMarshal := InterfaceContext is VarRef ? "ptr" : "ptr"
        ResetInfoCountMarshal := ResetInfoCount is VarRef ? "uint*" : "ptr"

        result := ComCall(3, this, InterfaceContextMarshal, InterfaceContext, ResetInfoCountMarshal, ResetInfoCount, "ptr", ResetInfoSupported, "int")
        return result
    }
}
