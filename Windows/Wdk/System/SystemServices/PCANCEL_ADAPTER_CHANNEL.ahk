 ...
 * @version v4.0.30319
 */
class PCANCEL_ADAPTER_CHANNEL extends IUnknown {
     ...
     */
    Invoke(DmaAdapter, DeviceObject, DmaTransferContext) {
        DmaTransferContextMarshal := DmaTransferContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", DmaAdapter, "ptr", DeviceObject, DmaTransferContextMarshal, DmaTransferContext, "char")
        return result
    }
}
