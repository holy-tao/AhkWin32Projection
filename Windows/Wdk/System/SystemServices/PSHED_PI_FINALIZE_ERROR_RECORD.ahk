 ...
 */
export default struct PSHED_PI_FINALIZE_ERROR_RECORD {
    value : IntPtr

    __value {
        set {
            if (value is PSHED_PI_FINALIZE_ERROR_RECORD) {
    ...
    /**
     * A PSHED_PI_FINALIZE_ERROR_RECORD that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSHED_PI_FINALIZE_ERROR_RECORD {
        /**
         * Creates a PSHED_PI_FINALIZE_ERROR_RECORD pointer that invokes the given AHK function when called.
