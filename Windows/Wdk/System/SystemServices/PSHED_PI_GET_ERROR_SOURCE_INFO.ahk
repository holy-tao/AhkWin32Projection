 ...
 */
export default struct PSHED_PI_GET_ERROR_SOURCE_INFO {
    value : IntPtr

    __value {
        set {
            if (value is PSHED_PI_GET_ERROR_SOURCE_INFO) {
    ...
    /**
     * A PSHED_PI_GET_ERROR_SOURCE_INFO that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PSHED_PI_GET_ERROR_SOURCE_INFO {
        /**
         * Creates a PSHED_PI_GET_ERROR_SOURCE_INFO pointer that invokes the given AHK function when called.
