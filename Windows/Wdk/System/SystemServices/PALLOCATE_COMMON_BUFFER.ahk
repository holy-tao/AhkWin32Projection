 ...
 * @version v4.0.30319
 */
class PALLOCATE_COMMON_BUFFER extends IUnknown {
     ...
     */
    Invoke(DmaAdapter, Length, LogicalAddress, CacheEnabled) {
        LogicalAddressMarshal := LogicalAddress is VarRef ? "int64*" : "ptr"

        result := ComCall(3, this, "ptr", DmaAdapter, "uint", Length, LogicalAddressMarshal, LogicalAddress, "char", CacheEnabled, "ptr")
        return result
    }
}
