 ...
 */
export default struct PGPE_DISCONNECT_VECTOR2 {
    value : IntPtr

    __value {
        set {
            if (value is PGPE_DISCONNECT_VECTOR2) {
    ...
    /**
     * A PGPE_DISCONNECT_VECTOR2 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PGPE_DISCONNECT_VECTOR2 {
        /**
         * Creates a PGPE_DISCONNECT_VECTOR2 pointer that invokes the given AHK function when called.
