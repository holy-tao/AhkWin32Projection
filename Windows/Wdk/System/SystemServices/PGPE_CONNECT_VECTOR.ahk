...
export default struct PGPE_CONNECT_VECTOR {
    ...
    Call(param0, param1, param2, param3, param4, param5, param6) {
        ...
        result := DllCall(this.value, DEVICE_OBJECT.Ptr, param0, UInt32, param1, KINTERRUPT_MODE, param2, BOOLEAN, param3, "ptr", param4, param5Marshal, param5, param6Marshal, param6, NTSTATUS)
    ...
    struct From extends PGPE_CONNECT_VECTOR {
         ...
         * @param {Func(DEVICE_OBJECT, UInt32, KINTERRUPT_MODE, BOOLEAN, "ptr", "ptr", "ptr") => NTSTATUS} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 7)) {
                throw MethodError("Object of type " Type(fn) " is not callable with 7 parameters.", -1, fn)
            }
            this.value := CallbackCreate(fn, , [DEVICE_OBJECT.Ptr, UInt32, KINTERRUPT_MODE, BOOLEAN, "ptr", "ptr", "ptr", NTSTATUS])
        }
