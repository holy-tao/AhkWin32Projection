 ...
 * @version v4.0.30319
 */
class RTL_HEAP_COMMIT_ROUTINE extends IUnknown {
     ...
     */
    Invoke(Base, CommitAddress, CommitSize) {
        ...
        result := ComCall(3, this, BaseMarshal, Base, CommitAddressMarshal, CommitAddress, CommitSizeMarshal, CommitSize, "int")
        return result
    }
}
