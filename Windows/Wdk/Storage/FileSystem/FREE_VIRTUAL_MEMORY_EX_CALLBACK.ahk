 ...
 * @version v4.0.30319
 */
class FREE_VIRTUAL_MEMORY_EX_CALLBACK extends IUnknown {
     ...
     */
    Invoke(CallbackContext, ProcessHandle, BaseAddress, RegionSize, FreeType) {
        ...
        result := ComCall(3, this, "ptr", CallbackContext, "ptr", ProcessHandle, BaseAddressMarshal, BaseAddress, RegionSizeMarshal, RegionSize, "uint", FreeType, "int")
        return result
    }
}
