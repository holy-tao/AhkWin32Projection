 ...
 * @version v4.0.30319
 */
class QUERY_VIRTUAL_MEMORY_CALLBACK extends IUnknown {
     ...
     */
    Invoke(CallbackContext, ProcessHandle, BaseAddress, MemoryInformationClass, MemoryInformation, MemoryInformationLength, ReturnLength) {
        ...
        result := ComCall(3, this, "ptr", CallbackContext, "ptr", ProcessHandle, BaseAddressMarshal, BaseAddress, "int", MemoryInformationClass, "ptr", MemoryInformation, "ptr", MemoryInformationLength, ReturnLengthMarshal, ReturnLength, "int")
        return result
    }
}
