 ...
 * @version v4.0.30319
 */
class PFILTER_REPORT_CHANGE extends IUnknown {
     ...
     */
    Invoke(NotifyContext, FilterContext) {
        NotifyContextMarshal := NotifyContext is VarRef ? "ptr" : "ptr"
        FilterContextMarshal := FilterContext is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, NotifyContextMarshal, NotifyContext, FilterContextMarshal, FilterContext, "char")
        return result
    }
}
