 ...
 * @version v4.0.30319
 */
class PFLT_PRE_OPERATION_CALLBACK extends IUnknown {
     ...
     */
    Invoke(Data, FltObjects, CompletionContext) {
        CompletionContextMarshal := CompletionContext is VarRef ? "ptr*" : "ptr"

        result := ComCall(3, this, "ptr", Data, "ptr", FltObjects, CompletionContextMarshal, CompletionContext, "int")
        return result
    }
}
