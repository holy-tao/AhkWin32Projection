 ...
 */
export default struct PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO {
    value : IntPtr

    __value {
        set {
            if (value is PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO) {
    ...
    /**
     * A PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO {
        /**
         * Creates a PFLT_CALLBACK_DATA_QUEUE_REMOVE_IO pointer that invokes the given AHK function when called.
