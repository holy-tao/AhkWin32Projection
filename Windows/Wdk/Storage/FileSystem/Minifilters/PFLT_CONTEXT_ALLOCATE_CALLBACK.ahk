 ...
 * @version v4.0.30319
 */
class PFLT_CONTEXT_ALLOCATE_CALLBACK extends IUnknown {
     ...
     */
    Invoke(PoolType, Size_, ContextType) {
        result := ComCall(3, this, "int", PoolType, "ptr", Size_, "ushort", ContextType, "ptr")
        return result
    }
}
