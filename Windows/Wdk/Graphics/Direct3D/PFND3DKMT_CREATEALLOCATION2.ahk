 ...
 */
export default struct PFND3DKMT_CREATEALLOCATION2 {
    value : IntPtr

    __value {
        set {
            if (value is PFND3DKMT_CREATEALLOCATION2) {
    ...
    /**
     * A PFND3DKMT_CREATEALLOCATION2 that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFND3DKMT_CREATEALLOCATION2 {
        /**
         * Creates a PFND3DKMT_CREATEALLOCATION2 pointer that invokes the given AHK function when called.
