 ...
 * @version v4.0.30319
 */
class PDXGK_REMOVAL_NOTIFICATION extends IUnknown {
     ...
     */
    Invoke(GraphicsDeviceHandle, PrivateHandle) {
        GraphicsDeviceHandleMarshal := GraphicsDeviceHandle is VarRef ? "ptr" : "ptr"
        PrivateHandleMarshal := PrivateHandle is VarRef ? "ptr" : "ptr"

        ComCall(3, this, GraphicsDeviceHandleMarshal, GraphicsDeviceHandle, PrivateHandleMarshal, PrivateHandle)
    }
}
