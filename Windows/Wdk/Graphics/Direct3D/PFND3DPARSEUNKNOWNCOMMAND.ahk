 ...
 */
export default struct PFND3DPARSEUNKNOWNCOMMAND {
    value : IntPtr

    __value {
        set {
            if (value is PFND3DPARSEUNKNOWNCOMMAND) {
    ...
    /**
     * A PFND3DPARSEUNKNOWNCOMMAND that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PFND3DPARSEUNKNOWNCOMMAND {
        /**
         * Creates a PFND3DPARSEUNKNOWNCOMMAND pointer that invokes the given AHK function when called.
