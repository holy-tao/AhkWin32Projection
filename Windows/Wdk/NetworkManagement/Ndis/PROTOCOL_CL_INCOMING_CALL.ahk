 ...
 * @version v4.0.30319
 */
class PROTOCOL_CL_INCOMING_CALL extends IUnknown {
     ...
     */
    Invoke(ProtocolSapContext, ProtocolVcContext, CallParameters) {
        ...
        result := ComCall(3, this, ProtocolSapContextMarshal, ProtocolSapContext, ProtocolVcContextMarshal, ProtocolVcContext, "ptr", CallParameters, "int")
        return result
    }
}
