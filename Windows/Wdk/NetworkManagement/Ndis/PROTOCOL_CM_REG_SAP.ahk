 ...
 * @version v4.0.30319
 */
class PROTOCOL_CM_REG_SAP extends IUnknown {
     ...
     */
    Invoke(CallMgrAfContext, Sap, NdisSapHandle, CallMgrSapContext) {
        ...
        result := ComCall(3, this, CallMgrAfContextMarshal, CallMgrAfContext, "ptr", Sap, NdisSapHandleMarshal, NdisSapHandle, CallMgrSapContextMarshal, CallMgrSapContext, "int")
        return result
    }
}
