 ...
 * @version v4.0.30319
 */
class PROTOCOL_CO_CREATE_VC extends IUnknown {
     ...
     */
    Invoke(ProtocolAfContext, NdisVcHandle, ProtocolVcContext) {
        ...
        result := ComCall(3, this, ProtocolAfContextMarshal, ProtocolAfContext, NdisVcHandleMarshal, NdisVcHandle, ProtocolVcContextMarshal, ProtocolVcContext, "int")
        return result
    }
}
