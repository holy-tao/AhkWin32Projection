 ...
 * @version v4.0.30319
 */
class PROTOCOL_CM_CLOSE_CALL extends IUnknown {
     ...
     */
    Invoke(CallMgrVcContext, CallMgrPartyContext, CloseData, Size_) {
        ...
        result := ComCall(3, this, CallMgrVcContextMarshal, CallMgrVcContext, CallMgrPartyContextMarshal, CallMgrPartyContext, CloseDataMarshal, CloseData, "uint", Size_, "int")
        return result
    }
}
