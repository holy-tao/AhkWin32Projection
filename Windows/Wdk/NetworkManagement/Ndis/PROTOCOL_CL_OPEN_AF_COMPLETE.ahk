 ...
 * @version v4.0.30319
 */
class PROTOCOL_CL_OPEN_AF_COMPLETE extends IUnknown {
     ...
     */
    Invoke(Status_, ProtocolAfContext, NdisAfHandle) {
        ProtocolAfContextMarshal := ProtocolAfContext is VarRef ? "ptr" : "ptr"
        NdisAfHandleMarshal := NdisAfHandle is VarRef ? "ptr" : "ptr"

        ComCall(3, this, "int", Status_, ProtocolAfContextMarshal, ProtocolAfContext, NdisAfHandleMarshal, NdisAfHandle)
    }
}
