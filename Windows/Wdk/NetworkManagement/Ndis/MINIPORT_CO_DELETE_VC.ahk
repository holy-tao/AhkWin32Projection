 ...
 */
export default struct MINIPORT_CO_DELETE_VC {
    value : IntPtr

    __value {
        set {
            if (value is MINIPORT_CO_DELETE_VC) {
    ...
    /**
     * A MINIPORT_CO_DELETE_VC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MINIPORT_CO_DELETE_VC {
        /**
         * Creates a MINIPORT_CO_DELETE_VC pointer that invokes the given AHK function when called.
