 ...
 */
export default struct PROTOCOL_CL_MODIFY_CALL_QOS_COMPLETE {
    value : IntPtr

    __value {
        set {
            if (value is PROTOCOL_CL_MODIFY_CALL_QOS_COMPLETE) {
    ...
    /**
     * A PROTOCOL_CL_MODIFY_CALL_QOS_COMPLETE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROTOCOL_CL_MODIFY_CALL_QOS_COMPLETE {
        /**
         * Creates a PROTOCOL_CL_MODIFY_CALL_QOS_COMPLETE pointer that invokes the given AHK function when called.
