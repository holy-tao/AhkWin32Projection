 ...
 * @version v4.0.30319
 */
class PROTOCOL_CL_REGISTER_SAP_COMPLETE extends IUnknown {
     ...
     */
    Invoke(Status_, ProtocolSapContext, Sap, NdisSapHandle) {
        ProtocolSapContextMarshal := ProtocolSapContext is VarRef ? "ptr" : "ptr"
        NdisSapHandleMarshal := NdisSapHandle is VarRef ? "ptr" : "ptr"

        ComCall(3, this, "int", Status_, ProtocolSapContextMarshal, ProtocolSapContext, "ptr", Sap, NdisSapHandleMarshal, NdisSapHandle)
    }
}
