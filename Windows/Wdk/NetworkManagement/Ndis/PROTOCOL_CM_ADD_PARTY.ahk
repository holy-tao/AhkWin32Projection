 ...
 */
export default struct PROTOCOL_CM_ADD_PARTY {
    value : IntPtr

    __value {
        set {
            if (value is PROTOCOL_CM_ADD_PARTY) {
    ...
    /**
     * A PROTOCOL_CM_ADD_PARTY that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROTOCOL_CM_ADD_PARTY {
        /**
         * Creates a PROTOCOL_CM_ADD_PARTY pointer that invokes the given AHK function when called.
