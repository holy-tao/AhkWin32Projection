 ...
 * @version v4.0.30319
 */
class PROTOCOL_CL_ADD_PARTY_COMPLETE extends IUnknown {
     ...
     */
    Invoke(Status_, ProtocolPartyContext, NdisPartyHandle, CallParameters) {
        ...
        ComCall(3, this, "int", Status_, ProtocolPartyContextMarshal, ProtocolPartyContext, NdisPartyHandleMarshal, NdisPartyHandle, "ptr", CallParameters)
    }
}
