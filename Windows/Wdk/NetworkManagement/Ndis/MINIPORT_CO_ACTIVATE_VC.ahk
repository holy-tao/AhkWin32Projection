 ...
 */
export default struct MINIPORT_CO_ACTIVATE_VC {
    value : IntPtr

    __value {
        set {
            if (value is MINIPORT_CO_ACTIVATE_VC) {
    ...
    /**
     * A MINIPORT_CO_ACTIVATE_VC that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends MINIPORT_CO_ACTIVATE_VC {
        /**
         * Creates a MINIPORT_CO_ACTIVATE_VC pointer that invokes the given AHK function when called.
