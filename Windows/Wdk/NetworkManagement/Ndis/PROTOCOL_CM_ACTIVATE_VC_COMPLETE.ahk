 ...
 */
export default struct PROTOCOL_CM_ACTIVATE_VC_COMPLETE {
    value : IntPtr

    __value {
        set {
            if (value is PROTOCOL_CM_ACTIVATE_VC_COMPLETE) {
    ...
    /**
     * A PROTOCOL_CM_ACTIVATE_VC_COMPLETE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROTOCOL_CM_ACTIVATE_VC_COMPLETE {
        /**
         * Creates a PROTOCOL_CM_ACTIVATE_VC_COMPLETE pointer that invokes the given AHK function when called.
