 ...
 */
export default struct PROTOCOL_CL_INCOMING_DROP_PARTY {
    value : IntPtr

    __value {
        set {
            if (value is PROTOCOL_CL_INCOMING_DROP_PARTY) {
    ...
    /**
     * A PROTOCOL_CL_INCOMING_DROP_PARTY that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends PROTOCOL_CL_INCOMING_DROP_PARTY {
        /**
         * Creates a PROTOCOL_CL_INCOMING_DROP_PARTY pointer that invokes the given AHK function when called.
