 ...
 */
export default struct DRIVER_DISPATCH {
    value : IntPtr

    __value {
        set {
            if (value is DRIVER_DISPATCH) {
    ...
    /**
     * A DRIVER_DISPATCH that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends DRIVER_DISPATCH {
        /**
         * Creates a DRIVER_DISPATCH pointer that invokes the given AHK function when called.
