 ...
 */
export default struct FAST_IO_READ_COMPRESSED {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_READ_COMPRESSED) {
    ...
    /**
     * A FAST_IO_READ_COMPRESSED that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_READ_COMPRESSED {
        /**
         * Creates a FAST_IO_READ_COMPRESSED pointer that invokes the given AHK function when called.
