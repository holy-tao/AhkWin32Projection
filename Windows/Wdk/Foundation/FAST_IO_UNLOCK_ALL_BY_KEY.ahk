 ...
 * @version v4.0.30319
 */
class FAST_IO_UNLOCK_ALL_BY_KEY extends IUnknown {
     ...
     */
    Invoke(FileObject, ProcessId, Key, IoStatus, DeviceObject) {
        ProcessIdMarshal := ProcessId is VarRef ? "ptr" : "ptr"

        result := ComCall(3, this, "ptr", FileObject, ProcessIdMarshal, ProcessId, "uint", Key, "ptr", IoStatus, "ptr", DeviceObject, "char")
        return result
    }
}
