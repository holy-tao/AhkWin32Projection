 ...
 * @version v4.0.30319
 */
class FAST_IO_LOCK extends IUnknown {
     ...
     */
    Invoke(FileObject, FileOffset, Length, ProcessId, Key, FailImmediately, ExclusiveLock, IoStatus, DeviceObject) {
        ...
        result := ComCall(3, this, "ptr", FileObject, FileOffsetMarshal, FileOffset, LengthMarshal, Length, "ptr", ProcessId, "uint", Key, "char", FailImmediately, "char", ExclusiveLock, "ptr", IoStatus, "ptr", DeviceObject, "char")
        return result
    }
}
