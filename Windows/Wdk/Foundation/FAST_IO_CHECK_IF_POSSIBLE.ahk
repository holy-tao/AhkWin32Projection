 ...
 */
export default struct FAST_IO_CHECK_IF_POSSIBLE {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_CHECK_IF_POSSIBLE) {
     ...
     * @param {BOOLEAN} CheckForReadOperation 
    ...
    /**
     * A FAST_IO_CHECK_IF_POSSIBLE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_CHECK_IF_POSSIBLE {
        /**
         * Creates a FAST_IO_CHECK_IF_POSSIBLE pointer that invokes the given AHK function when called.
         * @param {Func(FILE_OBJECT, "int64*", UInt32, BOOLEAN, UInt32, BOOLEAN, IO_STATUS_BLOCK, DEVICE_OBJECT) => BOOLEAN} fn the function to invoke.
         */
        __New(fn) {
            if (!HasMethod(fn, , 8)) {
