 ...
 */
export default struct FAST_IO_MDL_READ_COMPLETE {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_MDL_READ_COMPLETE) {
    ...
    /**
     * A FAST_IO_MDL_READ_COMPLETE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_MDL_READ_COMPLETE {
        /**
         * Creates a FAST_IO_MDL_READ_COMPLETE pointer that invokes the given AHK function when called.
