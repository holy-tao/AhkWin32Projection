 ...
 * @version v4.0.30319
 */
class FAST_IO_MDL_READ_COMPLETE_COMPRESSED extends IUnknown {
     ...
     */
    Invoke(FileObject, MdlChain, DeviceObject) {
        result := ComCall(3, this, "ptr", FileObject, "ptr", MdlChain, "ptr", DeviceObject, "char")
        return result
    }
}
