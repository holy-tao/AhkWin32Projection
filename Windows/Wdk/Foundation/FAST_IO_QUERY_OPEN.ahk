 ...
 * @version v4.0.30319
 */
class FAST_IO_QUERY_OPEN extends IUnknown {
     ...
     */
    Invoke(Irp_, NetworkInformation, DeviceObject) {
        result := ComCall(3, this, "ptr", Irp_, "ptr", NetworkInformation, "ptr", DeviceObject, "char")
        return result
    }
}
