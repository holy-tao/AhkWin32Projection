 ...
 */
export default struct FAST_IO_RELEASE_FOR_CCFLUSH {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_RELEASE_FOR_CCFLUSH) {
    ...
    /**
     * A FAST_IO_RELEASE_FOR_CCFLUSH that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_RELEASE_FOR_CCFLUSH {
        /**
         * Creates a FAST_IO_RELEASE_FOR_CCFLUSH pointer that invokes the given AHK function when called.
