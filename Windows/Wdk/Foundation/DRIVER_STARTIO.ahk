 ...
 */
export default struct DRIVER_STARTIO {
    value : IntPtr

    __value {
        set {
            if (value is DRIVER_STARTIO) {
    ...
    /**
     * A DRIVER_STARTIO that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends DRIVER_STARTIO {
        /**
         * Creates a DRIVER_STARTIO pointer that invokes the given AHK function when called.
