 ...
 * @version v4.0.30319
 */
class FAST_IO_UNLOCK_SINGLE extends IUnknown {
     ...
     */
    Invoke(FileObject, FileOffset, Length, ProcessId, Key, IoStatus, DeviceObject) {
        ...
        result := ComCall(3, this, "ptr", FileObject, FileOffsetMarshal, FileOffset, LengthMarshal, Length, "ptr", ProcessId, "uint", Key, "ptr", IoStatus, "ptr", DeviceObject, "char")
        return result
    }
}
