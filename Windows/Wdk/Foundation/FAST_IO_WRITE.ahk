 ...
 */
export default struct FAST_IO_WRITE {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_WRITE) {
    ...
    /**
     * A FAST_IO_WRITE that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_WRITE {
        /**
         * Creates a FAST_IO_WRITE pointer that invokes the given AHK function when called.
