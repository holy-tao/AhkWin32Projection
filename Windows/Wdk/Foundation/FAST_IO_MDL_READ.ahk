 ...
 */
export default struct FAST_IO_MDL_READ {
    value : IntPtr

    __value {
        set {
            if (value is FAST_IO_MDL_READ) {
    ...
    /**
     * A FAST_IO_MDL_READ that invokes the given AHK function when called.
     * This callback is owned by the script and cleaned up automatically.
     */
    struct From extends FAST_IO_MDL_READ {
        /**
         * Creates a FAST_IO_MDL_READ pointer that invokes the given AHK function when called.
