 ...
 * @version v4.0.30319
 */
class FAST_IO_MDL_WRITE_COMPLETE_COMPRESSED extends IUnknown {
     ...
     */
    Invoke(FileObject, FileOffset, MdlChain, DeviceObject) {
        FileOffsetMarshal := FileOffset is VarRef ? "int64*" : "ptr"

        result := ComCall(3, this, "ptr", FileObject, FileOffsetMarshal, FileOffset, "ptr", MdlChain, "ptr", DeviceObject, "char")
        return result
    }
}
