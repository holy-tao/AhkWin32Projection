 ...
 * @version v4.0.30319
 */
class FAST_IO_UNLOCK_ALL extends IUnknown {
     ...
     */
    Invoke(FileObject, ProcessId, IoStatus, DeviceObject) {
        ProcessId := ProcessId is Win32Handle ? NumGet(ProcessId, "ptr") : ProcessId

        result := ComCall(3, this, "ptr", FileObject, "ptr", ProcessId, "ptr", IoStatus, "ptr", DeviceObject, "char")
        return result
    }
}
