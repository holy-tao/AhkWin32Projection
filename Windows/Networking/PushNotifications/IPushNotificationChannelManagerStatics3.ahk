 ...
 */
class IPushNotificationChannelManagerStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPushNotificationChannelManagerStatics3
     * @type {Guid}
     */
    static IID => Guid("{4701fefe-0ede-4a3f-ae78-bfa471496925}")
