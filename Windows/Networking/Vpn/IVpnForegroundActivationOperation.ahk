 ...
 */
class IVpnForegroundActivationOperation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVpnForegroundActivationOperation
     * @type {Guid}
     */
    static IID => Guid("{9e010d57-f17a-4bd5-9b6d-f984f1297d3c}")
