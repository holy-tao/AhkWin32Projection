 ...
 */
class ICellularApnContext extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICellularApnContext
     * @type {Guid}
     */
    static IID => Guid("{6fa529f4-effd-4542-9ab2-705bbf94943a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ProviderId", "put_ProviderId", "get_AccessPointName", "put_AccessPointName", "get_UserName", "put_UserName", "get_Password", "put_Password", "get_IsCompressionEnabled", "put_IsCompressionEnabled", "get_AuthenticationType", "put_AuthenticationType"]
