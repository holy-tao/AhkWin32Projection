 ...
 * @see https://learn.microsoft.com/uwp/api/windows.networking.hostnamesortoptions
 * @namespace Windows.Networking
 * @version WindowsRuntime 1.4
 */
class HostNameSortOptions extends Win32BitflagEnum{
     ...
     * @type {Integer (UInt32)}
     */
    static OptimizeForLongConnections => 2
}
