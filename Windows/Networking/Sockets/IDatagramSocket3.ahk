 ...
 */
class IDatagramSocket3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDatagramSocket3
     * @type {Guid}
     */
    static IID => Guid("{37544f09-ab92-4306-9ac1-0c381283d9c6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["CancelIOAsync", "EnableTransferOwnership", "EnableTransferOwnershipWithConnectedStandbyAction", "TransferOwnership", "TransferOwnershipWithContext", "TransferOwnershipWithContextAndKeepAliveTime"]
    ...
    TransferOwnershipWithContextAndKeepAliveTime(socketId, data, keepAliveTime) {
        ...
        result := ComCall(11, this, "ptr", socketId, "ptr", data, "ptr", keepAliveTime, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
