 ...
 */
class IDatagramSocketControl extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDatagramSocketControl
     * @type {Guid}
     */
    static IID => Guid("{52ac3f2e-349a-4135-bb58-b79b2647d390}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_QualityOfService", "put_QualityOfService", "get_OutboundUnicastHopLimit", "put_OutboundUnicastHopLimit"]
