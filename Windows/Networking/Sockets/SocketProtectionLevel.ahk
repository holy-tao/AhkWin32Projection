 ...
 * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.socketprotectionlevel
 * @namespace Windows.Networking.Sockets
 * @version WindowsRuntime 1.4
 */
class SocketProtectionLevel extends Win32Enum{

    /**
     * A plain socket with no encryption.
     * @type {Integer (Int32)}
     */
    static PlainSocket => 0
     ...
     * @type {Integer (Int32)}
     */
    static SslAllowNullEncryption => 2
     ...
     * @type {Integer (Int32)}
     */
    static BluetoothEncryptionAllowNullAuthentication => 3
     ...
     * @type {Integer (Int32)}
     */
    static BluetoothEncryptionWithAuthentication => 4
     ...
     * @type {Integer (Int32)}
     */
    static Ssl3AllowWeakEncryption => 5
