 ...
 */
class IServerMessageWebSocketInformation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IServerMessageWebSocketInformation
     * @type {Guid}
     */
    static IID => Guid("{fc32b45f-4448-5505-6cc9-09afa8915f5d}")
