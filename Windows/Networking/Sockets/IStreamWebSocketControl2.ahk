 ...
 */
class IStreamWebSocketControl2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IStreamWebSocketControl2
     * @type {Guid}
     */
    static IID => Guid("{215d9f7e-fa58-40da-9f11-a48dafe95037}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_DesiredUnsolicitedPongInterval", "put_DesiredUnsolicitedPongInterval", "get_ActualUnsolicitedPongInterval", "get_ClientCertificate", "put_ClientCertificate"]
