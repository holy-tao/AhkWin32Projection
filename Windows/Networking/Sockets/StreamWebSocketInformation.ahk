 ...
 * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation
 * @namespace Windows.Networking.Sockets
 * @version WindowsRuntime 1.4
 */
class StreamWebSocketInformation extends IInspectable {
...
;@region Instance Properties
    /**
     * Gets the IP address associated with a [StreamWebSocket](streamwebsocket.md) object.
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.localaddress
     * @type {HostName} 
     */
    LocalAddress {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.bandwidthstatistics
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.protocol
     * @type {HSTRING} 
     */
    Protocol {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.servercertificate
     * @type {Certificate} 
     */
    ServerCertificate {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.servercertificateerrorseverity
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.servercertificateerrors
     ...
     * 
     * By the time the list of intermediate certificates is available through this property, the SSL connection has already been established. If you wish to inspect the server certificates during the connection process in order to perform custom validation, you should register a handler for the [StreamWebSocket.ServerCustomValidationRequested](streamwebsocket_servercustomvalidationrequested.md) event, and perform your custom server validation in that handler, using the [WebSocketServerCustomValidationRequestedEventArgs](websocketservercustomvalidationrequestedeventargs.md) instance passed to your event handler to inspect the intermediate certificates.
     * @see https://learn.microsoft.com/uwp/api/windows.networking.sockets.streamwebsocketinformation.serverintermediatecertificates
