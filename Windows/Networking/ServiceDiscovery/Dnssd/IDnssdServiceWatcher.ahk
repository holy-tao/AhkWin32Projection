 ...
 */
class IDnssdServiceWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDnssdServiceWatcher
     * @type {Guid}
     */
    static IID => Guid("{cc34d9c1-db7d-4b69-983d-c6f83f205682}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "get_Status", "Start", "Stop"]
