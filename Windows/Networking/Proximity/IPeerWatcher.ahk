 ...
 */
class IPeerWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPeerWatcher
     * @type {Guid}
     */
    static IID => Guid("{3cee21f8-2fa6-4679-9691-03c94a420f34}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_Removed", "remove_Removed", "add_Updated", "remove_Updated", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "get_Status", "Start", "Stop"]
