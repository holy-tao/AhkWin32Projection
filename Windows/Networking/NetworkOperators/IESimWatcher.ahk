 ...
 */
class IESimWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IESimWatcher
     * @type {Guid}
     */
    static IID => Guid("{c1f84ceb-a28d-4fbf-9771-6e31b81ccf22}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Status", "Start", "Stop", "add_Added", "remove_Added", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Removed", "remove_Removed", "add_Stopped", "remove_Stopped", "add_Updated", "remove_Updated"]
