...
class INetworkOperatorTetheringManagerStatics4 extends IInspectable{
    ...
    /**
     * The interface identifier for INetworkOperatorTetheringManagerStatics4
     * @type {Guid}
     */
    static IID => Guid("{b3b9f9d0-ebff-46a4-a847-d663d8b0977e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["IsNoConnectionsTimeoutEnabled", "EnableNoConnectionsTimeout", "EnableNoConnectionsTimeoutAsync", "DisableNoConnectionsTimeout", "DisableNoConnectionsTimeoutAsync"]
