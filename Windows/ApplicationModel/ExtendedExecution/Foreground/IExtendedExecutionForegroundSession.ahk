 ...
 */
class IExtendedExecutionForegroundSession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IExtendedExecutionForegroundSession
     * @type {Guid}
     */
    static IID => Guid("{fbf440e1-9d10-4201-b01e-c83275296f2e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Description", "put_Description", "add_Revoked", "remove_Revoked", "RequestExtensionAsync", "get_Reason", "put_Reason"]
