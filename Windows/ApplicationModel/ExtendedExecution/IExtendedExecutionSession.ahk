 ...
 */
class IExtendedExecutionSession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IExtendedExecutionSession
     * @type {Guid}
     */
    static IID => Guid("{af908a2d-118b-48f1-9308-0c4fc41e200f}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Reason", "put_Reason", "get_Description", "put_Description", "get_PercentProgress", "put_PercentProgress", "add_Revoked", "remove_Revoked", "RequestExtensionAsync"]
