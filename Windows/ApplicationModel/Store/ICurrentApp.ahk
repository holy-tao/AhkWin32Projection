 ...
 */
class ICurrentApp extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICurrentApp
     * @type {Guid}
     */
    static IID => Guid("{d52dc065-da3f-4685-995e-9b482eb5e603}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_LicenseInformation", "get_LinkUri", "get_AppId", "RequestAppPurchaseAsync", "RequestProductPurchaseAsync", "LoadListingInformationAsync", "GetAppReceiptAsync", "GetProductReceiptAsync"]
