 ...
 */
class ICurrentAppSimulatorStaticsWithFiltering extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICurrentAppSimulatorStaticsWithFiltering
     * @type {Guid}
     */
    static IID => Guid("{617e70e2-f86f-4b54-9666-dde285092c68}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["LoadListingInformationByProductIdsAsync", "LoadListingInformationByKeywordsAsync"]
