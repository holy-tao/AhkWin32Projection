 ...
 */
class ICurrentAppSimulatorWithConsumables extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICurrentAppSimulatorWithConsumables
     * @type {Guid}
     */
    static IID => Guid("{4e51f0ab-20e7-4412-9b85-59bb78388667}")
