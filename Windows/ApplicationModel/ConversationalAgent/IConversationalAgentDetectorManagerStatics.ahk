...
#Include ..\..\..\Guid.ahk
#Include .\ConversationalAgentDetectorManager.ahk
 ...
 */
class IConversationalAgentDetectorManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IConversationalAgentDetectorManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{36a8d283-fa0e-5693-8489-0fb2f0ab40d3}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Default"]
    ...
    get_Default() {
        ...
        return ConversationalAgentDetectorManager(value)
    }
}
