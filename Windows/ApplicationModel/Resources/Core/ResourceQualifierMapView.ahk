 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview
 * @namespace Windows.ApplicationModel.Resources.Core
 * @version WindowsRuntime 1.4
 */
class ResourceQualifierMapView extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview.size
     * @type {Integer} 
     */
    Size {
        get => this.get_Size()
...
;@region Instance Methods
     ...
     * @returns {Generic} 
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview.lookup
     */
    Lookup(key) {
        if (!this.HasProp("__IMapView")) {
            piid := Guid("{ac7f26f2-feb7-5b2a-8ac4-345bc62caede}")
            if ((queryResult := this.QueryInterface(piid, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IMapView := IMapView((ptr) => HSTRING({ Value: ptr }), (ptr) => HSTRING({ Value: ptr }), outPtr)
        }
     ...
     * @param {Generic} key The key to locate in the map view.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview.haskey
     */
    HasKey(key) {
        if (!this.HasProp("__IMapView")) {
            piid := Guid("{ac7f26f2-feb7-5b2a-8ac4-345bc62caede}")
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview.split
     */
    Split(first, second) {
        if (!this.HasProp("__IMapView")) {
            piid := Guid("{ac7f26f2-feb7-5b2a-8ac4-345bc62caede}")
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.resources.core.resourcequalifiermapview.first
     */
    First() {
