 ...
 */
class IIncomingVoipPhoneCallOptions extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IIncomingVoipPhoneCallOptions
     * @type {Guid}
     */
    static IID => Guid("{4379fcd6-ddd0-5e9b-81d8-5110495764ae}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Context", "put_Context", "get_ContactName", "put_ContactName", "get_ContactNumber", "put_ContactNumber", "get_ContactImage", "put_ContactImage", "get_ServiceName", "put_ServiceName", "get_BrandingImage", "put_BrandingImage", "get_CallDetails", "put_CallDetails", "get_Ringtone", "put_Ringtone", "get_Media", "put_Media", "get_RingTimeout", "put_RingTimeout", "get_ContactRemoteId", "put_ContactRemoteId", "get_AssociatedDeviceIds"]
