 ...
 */
class IOutgoingVoipPhoneCallOptions extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IOutgoingVoipPhoneCallOptions
     * @type {Guid}
     */
    static IID => Guid("{d6c59b57-57be-524f-9dc1-f2c12e5d1bcc}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Context", "put_Context", "get_ContactName", "put_ContactName", "get_ServiceName", "put_ServiceName", "get_Media", "put_Media", "get_AssociatedDeviceIds"]
