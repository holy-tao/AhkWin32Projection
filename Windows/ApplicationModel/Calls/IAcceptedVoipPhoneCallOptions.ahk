 ...
 */
class IAcceptedVoipPhoneCallOptions extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAcceptedVoipPhoneCallOptions
     * @type {Guid}
     */
    static IID => Guid("{e519c726-b86f-5add-8ae2-0f46acd9232d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Context", "put_Context", "get_ContactName", "put_ContactName", "get_ContactNumber", "put_ContactNumber", "get_ServiceName", "put_ServiceName", "get_Media", "put_Media", "get_AssociatedDeviceIds"]
