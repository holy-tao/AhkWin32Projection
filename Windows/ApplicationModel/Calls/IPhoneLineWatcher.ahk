 ...
 */
class IPhoneLineWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPhoneLineWatcher
     * @type {Guid}
     */
    static IID => Guid("{8a45cd0a-6323-44e0-a6f6-9f21f64dc90a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Start", "Stop", "add_LineAdded", "remove_LineAdded", "add_LineRemoved", "remove_LineRemoved", "add_LineUpdated", "remove_LineUpdated", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "get_Status"]
