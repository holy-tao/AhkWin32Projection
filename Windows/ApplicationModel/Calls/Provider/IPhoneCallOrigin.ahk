 ...
 */
class IPhoneCallOrigin extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPhoneCallOrigin
     * @type {Guid}
     */
    static IID => Guid("{20613479-0ef9-4454-871c-afb66a14b6a5}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Category", "put_Category", "get_CategoryDescription", "put_CategoryDescription", "get_Location", "put_Location"]
