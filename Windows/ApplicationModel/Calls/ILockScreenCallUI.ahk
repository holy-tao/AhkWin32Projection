 ...
 */
class ILockScreenCallUI extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILockScreenCallUI
     * @type {Guid}
     */
    static IID => Guid("{c596fd8d-73c9-4a14-b021-ec1c50a3b727}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Dismiss", "add_EndRequested", "remove_EndRequested", "add_Closed", "remove_Closed", "get_CallTitle", "put_CallTitle"]
