 ...
 */
class IVoipCallCoordinatorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVoipCallCoordinatorStatics
     * @type {Guid}
     */
    static IID => Guid("{7f5d1f2b-e04a-4d10-b31a-a55c922cc2fb}")
     ...
     */
    GetDefault() {
        result := ComCall(6, this, "ptr*", &coordinator := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return VoipCallCoordinator(coordinator)
    }
}
