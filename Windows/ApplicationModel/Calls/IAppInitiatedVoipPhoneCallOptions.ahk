 ...
 */
class IAppInitiatedVoipPhoneCallOptions extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppInitiatedVoipPhoneCallOptions
     * @type {Guid}
     */
    static IID => Guid("{86bebf63-ff5a-57fd-84c6-2d2cf18302f8}")
