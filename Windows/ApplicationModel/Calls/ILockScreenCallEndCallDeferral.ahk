 ...
 */
class ILockScreenCallEndCallDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILockScreenCallEndCallDeferral
     * @type {Guid}
     */
    static IID => Guid("{2dd7ed0d-98ed-4041-9632-50ff812b773f}")
