 ...
 */
class IPackageExtensionPackageUpdatingEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPackageExtensionPackageUpdatingEventArgs
     * @type {Guid}
     */
    static IID => Guid("{27ae2ce1-a1d3-532e-8e7e-8b43782fce09}")
