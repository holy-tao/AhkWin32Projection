 ...
 */
class IPackageExtensionPackageInstalledEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPackageExtensionPackageInstalledEventArgs
     * @type {Guid}
     */
    static IID => Guid("{3c9b0067-083c-5fe3-bdfb-9feb156b4118}")
