 ...
 */
class IFullContactCardOptions extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFullContactCardOptions
     * @type {Guid}
     */
    static IID => Guid("{8744436c-5cf9-4683-bdca-a1fdebf8dbce}")
