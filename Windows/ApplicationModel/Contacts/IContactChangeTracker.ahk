...
#Include ..\..\..\Guid.ahk
#Include .\ContactChangeReader.ahk
 ...
 */
class IContactChangeTracker extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContactChangeTracker
     * @type {Guid}
     */
    static IID => Guid("{6e992952-309b-404d-9712-b37bd30278aa}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Enable", "GetChangeReader", "Reset"]
    ...
    GetChangeReader() {
        ...
        return ContactChangeReader(value)
    }
