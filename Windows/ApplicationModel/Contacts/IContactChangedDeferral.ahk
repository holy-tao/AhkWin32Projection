 ...
 */
class IContactChangedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContactChangedDeferral
     * @type {Guid}
     */
    static IID => Guid("{c5143ae8-1b03-46f8-b694-a523e83cfcb6}")
