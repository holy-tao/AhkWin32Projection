 ...
 */
class IContactJobInfo extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContactJobInfo
     * @type {Guid}
     */
    static IID => Guid("{6d117b4c-ce50-4b43-9e69-b18258ea5315}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_CompanyName", "put_CompanyName", "get_CompanyYomiName", "put_CompanyYomiName", "get_Department", "put_Department", "get_Title", "put_Title", "get_Manager", "put_Manager", "get_Office", "put_Office", "get_CompanyAddress", "put_CompanyAddress", "get_Description", "put_Description"]
