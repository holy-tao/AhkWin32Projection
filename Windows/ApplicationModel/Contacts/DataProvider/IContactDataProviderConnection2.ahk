 ...
 */
class IContactDataProviderConnection2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IContactDataProviderConnection2
     * @type {Guid}
     */
    static IID => Guid("{a1d327b0-196c-4bfd-8f0f-c68d67f249d3}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_CreateOrUpdateContactRequested", "remove_CreateOrUpdateContactRequested", "add_DeleteContactRequested", "remove_DeleteContactRequested"]
