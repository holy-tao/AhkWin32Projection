...
#Include ..\..\..\Guid.ahk
#Include .\PinnedContactManager.ahk
 ...
 */
class IPinnedContactManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPinnedContactManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{f65ccc7e-fdf9-486a-ace9-bc311d0ae7f0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetDefault", "GetForUser", "IsSupported"]
    ...
    GetDefault() {
        ...
        return PinnedContactManager(result_)
    }
