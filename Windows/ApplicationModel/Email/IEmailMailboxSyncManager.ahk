 ...
 */
class IEmailMailboxSyncManager extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEmailMailboxSyncManager
     * @type {Guid}
     */
    static IID => Guid("{517ac55a-3591-4b5d-85bc-c71dde862263}")
