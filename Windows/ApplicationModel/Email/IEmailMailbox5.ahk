 ...
 */
class IEmailMailbox5 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEmailMailbox5
     * @type {Guid}
     */
    static IID => Guid("{39967087-0092-49be-bd0e-5d4dc9d96d90}")
    ...
    GetChangeTracker(identity) {
        ...
        return EmailMailboxChangeTracker(result_)
    }
}
