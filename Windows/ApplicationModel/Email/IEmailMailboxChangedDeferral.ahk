 ...
 */
class IEmailMailboxChangedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEmailMailboxChangedDeferral
     * @type {Guid}
     */
    static IID => Guid("{779a74c1-97c5-4b54-b30d-306232623e6d}")
