...
#Include ..\..\..\Guid.ahk
#Include .\EmailMailboxChangeReader.ahk
 ...
 */
class IEmailMailboxChangeTracker extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEmailMailboxChangeTracker
     * @type {Guid}
     */
    static IID => Guid("{7ae48638-5166-42b7-8882-fd21c92bdd4b}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsTracking", "Enable", "GetChangeReader", "Reset"]
    ...
    GetChangeReader() {
        ...
        return EmailMailboxChangeReader(value)
    }
