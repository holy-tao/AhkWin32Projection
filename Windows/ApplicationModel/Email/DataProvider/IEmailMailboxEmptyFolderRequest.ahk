 ...
 */
class IEmailMailboxEmptyFolderRequest extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IEmailMailboxEmptyFolderRequest
     * @type {Guid}
     */
    static IID => Guid("{fe4b03ab-f86d-46d9-b4ce-bc8a6d9e9268}")
