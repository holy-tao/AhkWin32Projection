 ...
 */
class ILockScreenUnlockingDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILockScreenUnlockingDeferral
     * @type {Guid}
     */
    static IID => Guid("{7e7d1ad6-5203-43e7-9bd6-7c3947d1e3fe}")
