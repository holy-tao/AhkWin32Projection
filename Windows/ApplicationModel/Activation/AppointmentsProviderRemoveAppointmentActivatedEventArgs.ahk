...
#Include .\IAppointmentsProviderRemoveAppointmentActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class AppointmentsProviderRemoveAppointmentActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.removeappointmentoperation
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.appointmentsproviderremoveappointmentactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
