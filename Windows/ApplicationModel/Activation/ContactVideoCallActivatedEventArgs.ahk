...
#Include .\IContactVideoCallActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class ContactVideoCallActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.serviceid
     * @type {HSTRING} 
     */
    ServiceId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.serviceuserid
     * @type {HSTRING} 
     */
    ServiceUserId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.contact
     * @type {Contact} 
     */
    Contact {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactvideocallactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
