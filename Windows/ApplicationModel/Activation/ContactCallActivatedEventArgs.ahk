...
#Include .\IContactCallActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class ContactCallActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * 
     * For info about how to handle app activation through contact actions, see [Quickstart: Handling contact actions ](/previous-versions/windows/apps/dn518236(v=win.10)).
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.serviceid
     * @type {HSTRING} 
     */
    ServiceId {
     ...
     * 
     * For info about how to handle app activation through contact actions, see [Quickstart: Handling contact actions ](/previous-versions/windows/apps/dn518236(v=win.10)).
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.serviceuserid
     * @type {HSTRING} 
     */
    ServiceUserId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.contact
     * @type {Contact} 
     */
    Contact {
     ...
     * 
     * For info about how to handle app activation through contact actions, see [Quickstart: Handling contact actions ](/previous-versions/windows/apps/dn518236(v=win.10)).
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.verb
     * @type {HSTRING} 
     */
    Verb {
        get => this.get_Verb()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.contactcallactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
