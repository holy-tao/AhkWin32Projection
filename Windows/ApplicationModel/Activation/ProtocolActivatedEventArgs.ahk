 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class ProtocolActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.uri
     * @type {Uri} 
     */
    Uri {
        get => this.get_Uri()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.callerpackagefamilyname
     * @type {HSTRING} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.data
     * @type {ValueSet} 
     */
    Data {
        get => this.get_Data()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.currentlyshownapplicationviewid
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.viewswitcher
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.protocolactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
