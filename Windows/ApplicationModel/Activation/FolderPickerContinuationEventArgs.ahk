...
#Include .\IFolderPickerContinuationEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class FolderPickerContinuationEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.folder
     * @type {StorageFolder} 
     */
    Folder {
        get => this.get_Folder()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.continuationdata
     * @type {ValueSet} 
     */
    ContinuationData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.folderpickercontinuationeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
