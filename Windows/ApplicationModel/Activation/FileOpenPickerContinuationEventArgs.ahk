...
#Include .\IFileOpenPickerContinuationEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class FileOpenPickerContinuationEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.files
    ...
    /**
     * Gets a set of values populated by the app before a [FileOpenPicker](../windows.storage.pickers/fileopenpicker.md) operation that deactivates the app in order to provide context when the app is activated.
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.continuationdata
     * @type {ValueSet} 
     */
    ContinuationData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.fileopenpickercontinuationeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
