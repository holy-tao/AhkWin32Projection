...
#Include .\IStartupTaskActivatedEventArgs.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs
 * @namespace Windows.ApplicationModel.Activation
 * @version WindowsRuntime 1.4
 */
class StartupTaskActivatedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs.taskid
     * @type {HSTRING} 
     */
    TaskId {
        get => this.get_TaskId()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs.previousexecutionstate
     * @type {Integer} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs.splashscreen
     * @type {SplashScreen} 
     */
    SplashScreen {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.applicationmodel.activation.startuptaskactivatedeventargs.user
     * @type {User} 
     */
    User {
        get => this.get_User()
