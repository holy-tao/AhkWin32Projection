 ...
 */
class IDataPackagePropertySet extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDataPackagePropertySet
     * @type {Guid}
     */
    static IID => Guid("{cd1c93eb-4c4c-443a-a8d3-f5c241e91689}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Title", "put_Title", "get_Description", "put_Description", "get_Thumbnail", "put_Thumbnail", "get_FileTypes", "get_ApplicationName", "put_ApplicationName", "get_ApplicationListingUri", "put_ApplicationListingUri"]
