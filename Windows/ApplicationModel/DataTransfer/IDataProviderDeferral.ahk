 ...
 */
class IDataProviderDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDataProviderDeferral
     * @type {Guid}
     */
    static IID => Guid("{c2cf2373-2d26-43d9-b69d-dcb86d03f6da}")
