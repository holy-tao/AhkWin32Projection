...
#Include ..\..\..\Guid.ahk
#Include .\HolographicKeyboard.ahk
 ...
 */
class IHolographicKeyboardStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHolographicKeyboardStatics
     * @type {Guid}
     */
    static IID => Guid("{b676c624-63d7-58cf-b06b-08baa032a23f}")
    ...
    GetDefault() {
        ...
        return HolographicKeyboard(result_)
    }
}
