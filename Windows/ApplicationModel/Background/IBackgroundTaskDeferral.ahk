 ...
 */
class IBackgroundTaskDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBackgroundTaskDeferral
     * @type {Guid}
     */
    static IID => Guid("{93cc156d-af27-4dd3-846e-24ee40cadd25}")
