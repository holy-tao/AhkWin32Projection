...
#Include .\PushNotificationTrigger.ahk
 ...
 */
class IPushNotificationTriggerFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPushNotificationTriggerFactory
     * @type {Guid}
     */
    static IID => Guid("{6dd8ed1b-458e-4fc2-bc2e-d5664f77ed19}")
    ...
    Create(applicationId) {
        ...
        return PushNotificationTrigger(value)
    }
}
