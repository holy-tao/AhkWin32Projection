...
#Include .\GattServiceProviderTriggerResult.ahk
 ...
 */
class IGattServiceProviderTriggerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGattServiceProviderTriggerStatics
     * @type {Guid}
     */
    static IID => Guid("{b413a36a-e294-4591-a5a6-64891a828153}")
     ...
     */
    CreateAsync(triggerId, serviceUuid) {
        ...
        result := ComCall(6, this, "ptr", triggerId, "ptr", serviceUuid, "ptr*", &operation := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IAsyncOperation(GattServiceProviderTriggerResult, operation)
    }
}
