 ...
 */
class IAppointmentCalendarSyncManager extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppointmentCalendarSyncManager
     * @type {Guid}
     */
    static IID => Guid("{2b21b3a0-4aff-4392-bc5f-5645ffcffb17}")
