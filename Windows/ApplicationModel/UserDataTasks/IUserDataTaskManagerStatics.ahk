...
#Include ..\..\..\Guid.ahk
#Include .\UserDataTaskManager.ahk
 ...
 */
class IUserDataTaskManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUserDataTaskManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{b35539f8-c502-47fc-a81e-100883719d55}")
    ...
    GetDefault() {
        ...
        return UserDataTaskManager(result_)
    }
