 ...
 */
class IUserActivityChannelStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUserActivityChannelStatics
     * @type {Guid}
     */
    static IID => Guid("{c8c005ab-198d-4d80-abb2-c9775ec4a729}")
