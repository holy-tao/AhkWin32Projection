 ...
 */
class IUserActivityChannelStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUserActivityChannelStatics3
     * @type {Guid}
     */
    static IID => Guid("{53bc4ddb-bbdf-5984-802a-5305874e205c}")
