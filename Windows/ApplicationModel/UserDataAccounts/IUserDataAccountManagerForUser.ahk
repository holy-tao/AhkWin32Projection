 ...
 */
class IUserDataAccountManagerForUser extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUserDataAccountManagerForUser
     * @type {Guid}
     */
    static IID => Guid("{56a6e8db-db8f-41ab-a65f-8c5971aac982}")
