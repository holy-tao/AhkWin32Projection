 ...
 */
class IChatMessageAttachment extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IChatMessageAttachment
     * @type {Guid}
     */
    static IID => Guid("{c7c4fd74-bf63-58eb-508c-8b863ff16b67}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_DataStreamReference", "put_DataStreamReference", "get_GroupId", "put_GroupId", "get_MimeType", "put_MimeType", "get_Text", "put_Text"]
