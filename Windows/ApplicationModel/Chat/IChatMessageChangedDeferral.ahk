 ...
 */
class IChatMessageChangedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IChatMessageChangedDeferral
     * @type {Guid}
     */
    static IID => Guid("{fbc6b30c-788c-4dcc-ace7-6282382968cf}")
