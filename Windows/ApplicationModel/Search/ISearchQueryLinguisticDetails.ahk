 ...
 */
class ISearchQueryLinguisticDetails extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISearchQueryLinguisticDetails
     * @type {Guid}
     */
    static IID => Guid("{46a1205b-69c9-4745-b72f-a8a4fc8f24ae}")
