 ...
 */
class ISearchSuggestionsRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISearchSuggestionsRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{b71598a9-c065-456d-a845-1eccec5dc28b}")
