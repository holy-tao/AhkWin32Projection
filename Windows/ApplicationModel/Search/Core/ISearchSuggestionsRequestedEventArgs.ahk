...
#Include ..\SearchSuggestionsRequest.ahk
 ...
 */
class ISearchSuggestionsRequestedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISearchSuggestionsRequestedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{6fd519e5-9e7e-4ab4-8be3-c76b1bd4344a}")
