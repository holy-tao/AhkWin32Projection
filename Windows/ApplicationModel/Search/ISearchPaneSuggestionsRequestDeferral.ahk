 ...
 */
class ISearchPaneSuggestionsRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISearchPaneSuggestionsRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{a0d009f7-8748-4ee2-ad44-afa6be997c51}")
