 ...
 */
class IAppExtensionPackageUpdatedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppExtensionPackageUpdatedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{3a83c43f-797e-44b5-ba24-a4c8b5a543d7}")
