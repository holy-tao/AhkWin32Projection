...
#Include .\AudioPlaybackConnectionOpenResult.ahk
 ...
 */
class IAudioPlaybackConnection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAudioPlaybackConnection
     * @type {Guid}
     */
    static IID => Guid("{1a4c1dea-cafc-50e7-8718-ea3f81cbfa51}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Start", "StartAsync", "get_DeviceId", "get_State", "Open", "OpenAsync", "add_StateChanged", "remove_StateChanged"]
    ...
    Open() {
        ...
        return AudioPlaybackConnectionOpenResult(result_)
    }
    ...
    OpenAsync() {
        ...
        return IAsyncOperation(AudioPlaybackConnectionOpenResult, operation)
    }
