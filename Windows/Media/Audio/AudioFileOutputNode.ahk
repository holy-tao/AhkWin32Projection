...
#Include .\IAudioFileOutputNode.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode
 * @namespace Windows.Media.Audio
 * @version WindowsRuntime 1.4
 */
class AudioFileOutputNode extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IAudioFileOutputNode
     ...
     * @type {Guid}
     */
    static IID => IAudioFileOutputNode.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.file
     * @type {IStorageFile} 
     */
    File {
        get => this.get_File()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.fileencodingprofile
     * @type {MediaEncodingProfile} 
     */
    FileEncodingProfile {
        get => this.get_FileEncodingProfile()
    }
     ...
     * @remarks
     * To add an audio effect to the node, add an object that implements [IAudioEffectDefinition](../windows.media.effects/iaudioeffectdefinition.md) to the **EffectDefinitions** property. You can disable effects by passing a previously added effect definition to the [DisableEffectsByDefinition](audiofileoutputnode_disableeffectsbydefinition_730128310.md) method. Reenable a disabled effect by passing the definition to [EnableEffectsByDefinition](audiofileoutputnode_enableeffectsbydefinition_1376948293.md).
     * 
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.effectdefinitions
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.outgoinggain
     * @type {Float} 
     */
    OutgoingGain {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.encodingproperties
     ...
     * @remarks
     * You can stop all audio processing of a node by calling [Stop](audiofileoutputnode_stop_1201535524.md). Set **ConsumeInput** to false to mute the input of the node instead. This can be useful in scenarios such as when the node has an effect with a decay applied, such as delay or reverb. Setting **ConsumeInput** to false will stop the node from consuming audio data while allowing effects to continue processing.
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.consumeinput
     * @type {Boolean} 
     */
    ConsumeInput {
...
;@region Instance Methods
     ...
     */
    get_File() {
        if (!this.HasProp("__IAudioFileOutputNode")) {
            if ((queryResult := this.QueryInterface(IAudioFileOutputNode.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IAudioFileOutputNode := IAudioFileOutputNode(outPtr)
        }

        return this.__IAudioFileOutputNode.get_File()
    }
    ...
    get_FileEncodingProfile() {
        ...
        return this.__IAudioFileOutputNode.get_FileEncodingProfile()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.finalizeasync
     */
    FinalizeAsync() {
        if (!this.HasProp("__IAudioFileOutputNode")) {
            if ((queryResult := this.QueryInterface(IAudioFileOutputNode.IID, &outPtr := 0)) != 0)
        ...
        return this.__IAudioFileOutputNode.FinalizeAsync()
    }
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.start
     */
    Start() {
        if (!this.HasProp("__IAudioNode")) {
            if ((queryResult := this.QueryInterface(IAudioNode.IID, &outPtr := 0)) != 0)
     ...
     * @remarks
     * Calling this method causes [DiscardQueuedFrames](../windows.media.effects/ibasicaudioeffect_discardqueuedframes_1358903059.md) to be called on any audio effects applied to the [AudioFileOutputNode](audiofileoutputnode.md).
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.reset
     */
    Reset() {
        if (!this.HasProp("__IAudioNode")) {
            if ((queryResult := this.QueryInterface(IAudioNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.disableeffectsbydefinition
     */
    ...
    /**
     * Enables all effects in the [EffectDefinitions](audiofileoutputnode_effectdefinitions.md) list with the specified effect definition.
     * @remarks
     * Apply an audio effect to a node by adding an object that implements [IAudioEffectDefinition](../windows.media.effects/iaudioeffectdefinition.md) to the [EffectDefinitions](audiofileoutputnode_effectdefinitions.md) collection. Disable effects by calling [DisableEffectsByDefinition](audiofileoutputnode_disableeffectsbydefinition_730128310.md).
     * @param {IAudioEffectDefinition} definition The effect definition of the effects to enable.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.enableeffectsbydefinition
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiofileoutputnode.close
     */
    Close() {
