 ...
 */
class IMediaSourceAudioInputNode extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaSourceAudioInputNode
     * @type {Guid}
     */
    static IID => Guid("{99d8983b-a88a-4041-8e4f-ddbac0c91fd3}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_PlaybackSpeedFactor", "get_PlaybackSpeedFactor", "get_Position", "Seek", "get_StartTime", "put_StartTime", "get_EndTime", "put_EndTime", "get_LoopCount", "put_LoopCount", "get_Duration", "get_MediaSource", "add_MediaSourceCompleted", "remove_MediaSourceCompleted"]
