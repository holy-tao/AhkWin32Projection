 ...
 * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode
 * @namespace Windows.Media.Audio
 * @version WindowsRuntime 1.4
 */
class AudioSubmixNode extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IAudioInputNode
     ...
     * @type {Guid}
     */
    static IID => IAudioInputNode.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.outgoingconnections
     ...
     * @remarks
     * To add an audio effect to the node, add an object that implements [IAudioEffectDefinition](../windows.media.effects/iaudioeffectdefinition.md) to the **EffectDefinitions** property. You can disable effects by passing a previously added effect definition to the [DisableEffectsByDefinition](audiosubmixnode_disableeffectsbydefinition_730128310.md) method. Reenable a disabled effect by passing the definition to [EnableEffectsByDefinition](audiosubmixnode_enableeffectsbydefinition_1376948293.md).
     * 
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.effectdefinitions
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.outgoinggain
     * @type {Float} 
     */
    OutgoingGain {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.encodingproperties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.emitter
...
;@region Instance Methods
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.addoutgoingconnection
     */
     ...
     * @remarks
     * Add an outgoing connection by calling [AddOutgoingConnection](audiosubmixnode_addoutgoingconnection_702981438.md).
     * @param {IAudioNode} destination The audio node for which the outgoing connection is removed.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.removeoutgoingconnection
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.start
     */
    Start() {
        if (!this.HasProp("__IAudioNode")) {
            if ((queryResult := this.QueryInterface(IAudioNode.IID, &outPtr := 0)) != 0)
     ...
     * @remarks
     * Calling this method causes [DiscardQueuedFrames](../windows.media.effects/ibasicaudioeffect_discardqueuedframes_1358903059.md) to be called on any audio effects applied to the [AudioSubmixNode](audiosubmixnode.md).
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.reset
     */
    Reset() {
        if (!this.HasProp("__IAudioNode")) {
            if ((queryResult := this.QueryInterface(IAudioNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.disableeffectsbydefinition
     */
    ...
    /**
     * Enables all effects in the [EffectDefinitions](audiosubmixnode_effectdefinitions.md) list with the specified effect definition.
     * @remarks
     * Apply an audio effect to a node by adding an object that implements [IAudioEffectDefinition](../windows.media.effects/iaudioeffectdefinition.md) to the [EffectDefinitions](audiosubmixnode_effectdefinitions.md) collection. Disable effects by calling [DisableEffectsByDefinition](audiosubmixnode_disableeffectsbydefinition_730128310.md).
     * @param {IAudioEffectDefinition} definition The effect definition of the effects to enable.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.enableeffectsbydefinition
     */
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.audio.audiosubmixnode.close
     */
    Close() {
