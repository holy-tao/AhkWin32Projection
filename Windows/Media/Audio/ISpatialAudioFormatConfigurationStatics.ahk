...
#Include ..\..\..\Guid.ahk
#Include .\SpatialAudioFormatConfiguration.ahk
 ...
 */
class ISpatialAudioFormatConfigurationStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialAudioFormatConfigurationStatics
     * @type {Guid}
     */
    static IID => Guid("{2b5fef71-67c9-4e5f-a35b-41680711f8c7}")
    ...
    GetDefault() {
        ...
        return SpatialAudioFormatConfiguration(result_)
    }
}
