 ...
 */
class IAppBroadcastingUIStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBroadcastingUIStatics
     * @type {Guid}
     */
    static IID => Guid("{55a8a79d-23cb-4579-9c34-886fe02c045a}")
    ...
    GetDefault() {
        ...
        return AppBroadcastingUI(result_)
    }
