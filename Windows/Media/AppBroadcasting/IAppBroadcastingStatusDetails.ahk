 ...
 */
class IAppBroadcastingStatusDetails extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBroadcastingStatusDetails
     * @type {Guid}
     */
    static IID => Guid("{069dada4-b573-4e3c-8e19-1bafacd09713}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsAnyAppBroadcasting", "get_IsCaptureResourceUnavailable", "get_IsGameStreamInProgress", "get_IsGpuConstrained", "get_IsAppInactive", "get_IsBlockedForApp", "get_IsDisabledByUser", "get_IsDisabledBySystem"]
