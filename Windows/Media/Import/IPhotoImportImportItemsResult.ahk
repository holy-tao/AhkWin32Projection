 ...
 */
class IPhotoImportImportItemsResult extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPhotoImportImportItemsResult
     * @type {Guid}
     */
    static IID => Guid("{e4d4f478-d419-4443-a84e-f06a850c0b00}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Session", "get_HasSucceeded", "get_ImportedItems", "get_PhotosCount", "get_PhotosSizeInBytes", "get_VideosCount", "get_VideosSizeInBytes", "get_SidecarsCount", "get_SidecarsSizeInBytes", "get_SiblingsCount", "get_SiblingsSizeInBytes", "get_TotalCount", "get_TotalSizeInBytes", "DeleteImportedItemsFromSourceAsync"]
    ...
    DeleteImportedItemsFromSourceAsync() {
        ...
        return IAsyncOperationWithProgress(PhotoImportDeleteImportedItemsFromSourceResult, (ptr) => IPropertyValue(ptr).GetDouble(), result_)
    }
}
