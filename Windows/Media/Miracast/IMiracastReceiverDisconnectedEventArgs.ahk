 ...
 */
class IMiracastReceiverDisconnectedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMiracastReceiverDisconnectedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{d9a15e5e-5fee-57e6-b4b0-04727db93229}")
