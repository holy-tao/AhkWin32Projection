 ...
 */
class IMediaStreamSourceSampleRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaStreamSourceSampleRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{7895cc02-f982-43c8-9d16-c62d999319be}")
