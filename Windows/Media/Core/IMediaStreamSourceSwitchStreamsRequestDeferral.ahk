 ...
 */
class IMediaStreamSourceSwitchStreamsRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaStreamSourceSwitchStreamsRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{bee3d835-a505-4f9a-b943-2b8cb1b4bbd9}")
