 ...
 */
class ISpeechCue extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpeechCue
     * @type {Guid}
     */
    static IID => Guid("{aee254dc-1725-4bad-8043-a98499b017a2}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Text", "put_Text", "get_StartPositionInInput", "put_StartPositionInInput", "get_EndPositionInInput", "put_EndPositionInInput"]
