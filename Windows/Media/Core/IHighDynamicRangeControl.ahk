 ...
 */
class IHighDynamicRangeControl extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHighDynamicRangeControl
     * @type {Guid}
     */
    static IID => Guid("{55f1a7ae-d957-4dc9-9d1c-8553a82a7d99}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_Enabled", "get_Enabled"]
