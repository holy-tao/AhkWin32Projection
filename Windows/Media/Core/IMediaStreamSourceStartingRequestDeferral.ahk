 ...
 */
class IMediaStreamSourceStartingRequestDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaStreamSourceStartingRequestDeferral
     * @type {Guid}
     */
    static IID => Guid("{3f1356a5-6340-4dc4-9910-068ed9f598f8}")
