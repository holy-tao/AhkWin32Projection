 ...
 */
class IFaceDetectionEffect extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFaceDetectionEffect
     * @type {Guid}
     */
    static IID => Guid("{ae15ebd2-0542-42a9-bc90-f283a29f46c1}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_Enabled", "get_Enabled", "put_DesiredDetectionInterval", "get_DesiredDetectionInterval", "add_FaceDetected", "remove_FaceDetected"]
