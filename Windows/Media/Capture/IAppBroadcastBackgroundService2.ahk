 ...
 */
class IAppBroadcastBackgroundService2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppBroadcastBackgroundService2
     * @type {Guid}
     */
    static IID => Guid("{fc8ccbbf-5549-4b87-959f-23ca401fd473}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_BroadcastTitle", "get_BroadcastLanguage", "put_BroadcastLanguage", "get_BroadcastChannel", "put_BroadcastChannel", "add_BroadcastTitleChanged", "remove_BroadcastTitleChanged", "add_BroadcastLanguageChanged", "remove_BroadcastLanguageChanged", "add_BroadcastChannelChanged", "remove_BroadcastChannelChanged"]
