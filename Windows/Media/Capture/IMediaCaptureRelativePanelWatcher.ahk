...
class IMediaCaptureRelativePanelWatcher extends IInspectable{
    ...
    /**
     * The interface identifier for IMediaCaptureRelativePanelWatcher
     * @type {Guid}
     */
    static IID => Guid("{7d896566-04be-5b89-b30e-bd34a9f12db0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_RelativePanel", "add_Changed", "remove_Changed", "Start", "Stop"]
