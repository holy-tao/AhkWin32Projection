...
class ILowLagPhotoSequenceCapture extends IInspectable{
    ...
    /**
     * The interface identifier for ILowLagPhotoSequenceCapture
     * @type {Guid}
     */
    static IID => Guid("{7cc346bb-b9a9-4c91-8ffa-287e9c668669}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["StartAsync", "StopAsync", "FinishAsync", "add_PhotoCaptured", "remove_PhotoCaptured"]
