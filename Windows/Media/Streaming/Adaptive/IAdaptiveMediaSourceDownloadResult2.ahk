 ...
 */
class IAdaptiveMediaSourceDownloadResult2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAdaptiveMediaSourceDownloadResult2
     * @type {Guid}
     */
    static IID => Guid("{15552cb7-7b80-4ac4-8660-a4b97f7c70f0}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ResourceByteRangeOffset", "put_ResourceByteRangeOffset", "get_ResourceByteRangeLength", "put_ResourceByteRangeLength"]
