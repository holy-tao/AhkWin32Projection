 ...
 */
class IAdaptiveMediaSourceDownloadCompletedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAdaptiveMediaSourceDownloadCompletedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{19240dc3-5b37-4a1a-8970-d621cb6ca83b}")
