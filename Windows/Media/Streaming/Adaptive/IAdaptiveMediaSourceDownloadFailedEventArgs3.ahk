 ...
 */
class IAdaptiveMediaSourceDownloadFailedEventArgs3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAdaptiveMediaSourceDownloadFailedEventArgs3
     * @type {Guid}
     */
    static IID => Guid("{d0354549-1132-4a10-915a-c2211b5b9409}")
