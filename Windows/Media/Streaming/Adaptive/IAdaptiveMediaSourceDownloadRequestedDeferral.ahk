 ...
 */
class IAdaptiveMediaSourceDownloadRequestedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAdaptiveMediaSourceDownloadRequestedDeferral
     * @type {Guid}
     */
    static IID => Guid("{05c68f64-fa20-4dbd-9821-4bf4c9bf77ab}")
