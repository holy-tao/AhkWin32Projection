...
class ITimedMetadataEncodingProperties extends IInspectable{
    ...
    /**
     * The interface identifier for ITimedMetadataEncodingProperties
     * @type {Guid}
     */
    static IID => Guid("{51cd30d3-d690-4cfa-97f4-4a398e9db420}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["SetFormatUserData", "GetFormatUserData", "Copy"]
