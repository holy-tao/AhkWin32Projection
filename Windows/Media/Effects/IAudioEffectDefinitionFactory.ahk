...
#Include .\AudioEffectDefinition.ahk
 ...
 */
class IAudioEffectDefinitionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAudioEffectDefinitionFactory
     * @type {Guid}
     */
    static IID => Guid("{8e1da646-e705-45ed-8a2b-fc4e4f405a97}")
    ...
    Create(activatableClassId) {
        ...
        return AudioEffectDefinition(value)
    }
