...
#Include .\VideoCompositorDefinition.ahk
 ...
 */
class IVideoCompositorDefinitionFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IVideoCompositorDefinitionFactory
     * @type {Guid}
     */
    static IID => Guid("{4366fd10-68b8-4d52-89b6-02a968cca899}")
    ...
    Create(activatableClassId) {
        ...
        return VideoCompositorDefinition(value)
    }
