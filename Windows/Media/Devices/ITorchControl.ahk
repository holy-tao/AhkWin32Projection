...
class ITorchControl extends IInspectable{
    ...
    /**
     * The interface identifier for ITorchControl
     * @type {Guid}
     */
    static IID => Guid("{a6053665-8250-416c-919a-724296afa306}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Supported", "get_PowerSupported", "get_Enabled", "put_Enabled", "get_PowerPercent", "put_PowerPercent"]
