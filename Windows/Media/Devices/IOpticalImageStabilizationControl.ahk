...
class IOpticalImageStabilizationControl extends IInspectable{
    ...
    /**
     * The interface identifier for IOpticalImageStabilizationControl
     * @type {Guid}
     */
    static IID => Guid("{bfad9c1d-00bc-423b-8eb2-a0178ca94247}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Supported", "get_SupportedModes", "get_Mode", "put_Mode"]
