 ...
 * @remarks
 * This object is not instantiated directly. It is created by the [MediaDevice.DefaultAudioCaptureDeviceChanged](mediadevice_defaultaudiocapturedevicechanged.md) event and is returned as an argument to the [TypedEventHandler](../windows.foundation/typedeventhandler_2.md) delegate.
 * @see https://learn.microsoft.com/uwp/api/windows.media.devices.defaultaudiocapturedevicechangedeventargs
 * @namespace Windows.Media.Devices
 * @version WindowsRuntime 1.4
 */
class DefaultAudioCaptureDeviceChangedEventArgs extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.devices.defaultaudiocapturedevicechangedeventargs.id
     * @type {HSTRING} 
     */
    Id {
        get => this.get_Id()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.devices.defaultaudiocapturedevicechangedeventargs.role
     * @type {Integer} 
     */
    Role {
        get => this.get_Role()
