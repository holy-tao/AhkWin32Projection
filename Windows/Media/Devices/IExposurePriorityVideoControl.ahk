...
class IExposurePriorityVideoControl extends IInspectable{
    ...
    /**
     * The interface identifier for IExposurePriorityVideoControl
     * @type {Guid}
     */
    static IID => Guid("{2cb240a3-5168-4271-9ea5-47621a98a352}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Supported", "get_Enabled", "put_Enabled"]
