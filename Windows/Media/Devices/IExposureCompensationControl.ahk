...
class IExposureCompensationControl extends IInspectable{
    ...
    /**
     * The interface identifier for IExposureCompensationControl
     * @type {Guid}
     */
    static IID => Guid("{81c8e834-dcec-4011-a610-1f3847e64aca}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Supported", "get_Min", "get_Max", "get_Step", "get_Value", "SetValueAsync"]
     ...
     */
    SetValueAsync(value) {
        result := ComCall(11, this, "float", value, "ptr*", &asyncInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
