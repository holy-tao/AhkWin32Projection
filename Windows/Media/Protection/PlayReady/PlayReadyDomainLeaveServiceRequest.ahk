...
#Include .\IPlayReadyDomainLeaveServiceRequest.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest
 * @namespace Windows.Media.Protection.PlayReady
 * @version WindowsRuntime 1.4
 */
class PlayReadyDomainLeaveServiceRequest extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IPlayReadyDomainLeaveServiceRequest
     ...
     * @type {Guid}
     */
    static IID => IPlayReadyDomainLeaveServiceRequest.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.domainaccountid
     * @type {Guid} 
     */
    DomainAccountId {
     ...
     * @remarks
     * This property cannot be set after [BeginServiceRequest](playreadydomainleaveservicerequest_beginservicerequest_736222023.md) or [GenerateManualEnablingChallenge](playreadydomainleaveservicerequest_generatemanualenablingchallenge_1228062000.md) have been called.
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.domainserviceid
     * @type {Guid} 
     */
    DomainServiceId {
     ...
     * @remarks
     * The URI must be set through this property before calling [BeginServiceRequest](playreadydomainleaveservicerequest_beginservicerequest_736222023.md).
     * 
     * This property cannot be set after [BeginServiceRequest](playreadydomainleaveservicerequest_beginservicerequest_736222023.md) or [GenerateManualEnablingChallenge](playreadydomainleaveservicerequest_generatemanualenablingchallenge_1228062000.md) have been called.
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.uri
     * @type {Uri} 
     */
    Uri {
        get => this.get_Uri()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.responsecustomdata
     * @type {HSTRING} 
     */
    ResponseCustomData {
     ...
     * 
     * This property cannot be set after [BeginServiceRequest](playreadydomainleaveservicerequest_beginservicerequest_736222023.md) or [GenerateManualEnablingChallenge](playreadydomainleaveservicerequest_generatemanualenablingchallenge_1228062000.md) have been called.
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.challengecustomdata
     * @type {HSTRING} 
     */
    ChallengeCustomData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.protectionsystem
     * @type {Guid} 
     */
    ProtectionSystem {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.type
     * @type {Guid} 
     */
    Type {
        get => this.get_Type()
...
;@region Instance Methods
    /**
     * Initializes a new instance of the [PlayReadyDomainLeaveServiceRequest](playreadydomainleaveservicerequest.md) class.
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.Media.Protection.PlayReady.PlayReadyDomainLeaveServiceRequest")
     ...
     */
    get_DomainAccountId() {
        if (!this.HasProp("__IPlayReadyDomainLeaveServiceRequest")) {
            if ((queryResult := this.QueryInterface(IPlayReadyDomainLeaveServiceRequest.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPlayReadyDomainLeaveServiceRequest := IPlayReadyDomainLeaveServiceRequest(outPtr)
        }

        return this.__IPlayReadyDomainLeaveServiceRequest.get_DomainAccountId()
    }
    ...
    put_DomainAccountId(value) {
        ...
        return this.__IPlayReadyDomainLeaveServiceRequest.put_DomainAccountId(value)
    }
    ...
    get_DomainServiceId() {
        ...
        return this.__IPlayReadyDomainLeaveServiceRequest.get_DomainServiceId()
    }
    ...
    put_DomainServiceId(value) {
        ...
        return this.__IPlayReadyDomainLeaveServiceRequest.put_DomainServiceId(value)
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.beginservicerequest
     */
    BeginServiceRequest() {
        if (!this.HasProp("__IPlayReadyServiceRequest")) {
            if ((queryResult := this.QueryInterface(IPlayReadyServiceRequest.IID, &outPtr := 0)) != 0)
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.nextservicerequest
     */
    NextServiceRequest() {
        if (!this.HasProp("__IPlayReadyServiceRequest")) {
            if ((queryResult := this.QueryInterface(IPlayReadyServiceRequest.IID, &outPtr := 0)) != 0)
     ...
     * @remarks
     * Provides the caller the raw HTTP challenge and headers that they must send up to the server. When the response is received, it should be processed by calling the [ProcessManualEnablingResponse](playreadydomainleaveservicerequest_processmanualenablingresponse_559693975.md) method.
     * 
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.generatemanualenablingchallenge
     */
     ...
     * 
     * 
     * + S_OK—The enabling response was processed and there are no more service requests necessary. A following call to [NextServiceRequest](playreadydomainleaveservicerequest_nextservicerequest_1650210697.md) will return a **NULL** pointer.
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.media.protection.playready.playreadydomainleaveservicerequest.processmanualenablingresponse
     */
