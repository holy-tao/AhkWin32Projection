...
#Include .\IProtectionCapabilities.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.media.protection.protectioncapabilities
 * @namespace Windows.Media.Protection
 * @version WindowsRuntime 1.4
 */
class ProtectionCapabilities extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IProtectionCapabilities
     ...
     * @type {Guid}
     */
    static IID => IProtectionCapabilities.IID
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.Media.Protection.ProtectionCapabilities")
