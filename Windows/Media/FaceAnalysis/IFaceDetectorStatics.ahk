 ...
 */
class IFaceDetectorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IFaceDetectorStatics
     * @type {Guid}
     */
    static IID => Guid("{bc042d67-9047-33f6-881b-6746c1b218b8}")
    ...
    CreateAsync() {
        ...
        return IAsyncOperation(FaceDetector, returnValue)
    }
