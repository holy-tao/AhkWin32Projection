 ...
 */
class IMediaPlayerEffects extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaPlayerEffects
     * @type {Guid}
     */
    static IID => Guid("{85a1deda-cab6-4cc0-8be3-6035f4de2591}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["AddAudioEffect", "RemoveAllEffects"]
    ...
    AddAudioEffect(activatableClassId, effectOptional, configuration) {
        ...
        result := ComCall(6, this, "ptr", activatableClassId, "int", effectOptional, "ptr", configuration, "int")
        if(result != 0) {
