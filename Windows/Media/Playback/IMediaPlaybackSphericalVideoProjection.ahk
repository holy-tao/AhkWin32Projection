 ...
 */
class IMediaPlaybackSphericalVideoProjection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMediaPlaybackSphericalVideoProjection
     * @type {Guid}
     */
    static IID => Guid("{d405b37c-6f0e-4661-b8ee-d487ba9752d5}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsEnabled", "put_IsEnabled", "get_FrameFormat", "put_FrameFormat", "get_HorizontalFieldOfViewInDegrees", "put_HorizontalFieldOfViewInDegrees", "get_ViewOrientation", "put_ViewOrientation", "get_ProjectionMode", "put_ProjectionMode"]
