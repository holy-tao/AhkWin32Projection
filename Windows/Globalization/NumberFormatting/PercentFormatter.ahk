...
#Include .\IPercentFormatterFactory.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter
...
;@region Static Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.#ctor
     */
    static CreatePercentFormatter(languages, geographicRegion_) {
        if (!PercentFormatter.HasProp("__IPercentFormatterFactory")) {
            activatableClassId := HSTRING.Create("Windows.Globalization.NumberFormatting.PercentFormatter")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, IPercentFormatterFactory.IID)
            PercentFormatter.__IPercentFormatterFactory := IPercentFormatterFactory(factoryPtr)
        }

        return PercentFormatter.__IPercentFormatterFactory.CreatePercentFormatter(languages, geographicRegion_)
    }
...
;@region Instance Properties
     ...
     * 
     * Language tags support the Unicode extensions "ca-" and "nu-". (See [Unicode Key/Type Definitions](https://www.unicode.org/reports/tr35/#Key_Type_Definitions).) Note that these extensions can affect the numeral system used by [PercentFormatter(IIterable(String), String)](percentformatter_percentformatter_177128098.md) objects.
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.languages
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.geographicregion
     * @type {HSTRING} 
     */
    GeographicRegion {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.integerdigits
     * @type {Integer} 
     */
    IntegerDigits {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.fractiondigits
     * @type {Integer} 
     */
    FractionDigits {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.isgrouped
     * @type {Boolean} 
     */
    IsGrouped {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.isdecimalpointalwaysdisplayed
     * @type {Boolean} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.numeralsystem
     * @type {HSTRING} 
     */
    NumeralSystem {
     ...
     * 
     * Language tags support the Unicode extensions "ca-" and "nu-". (See [Unicode Key/Type Definitions](https://www.unicode.org/reports/tr35/#Key_Type_Definitions).) Note that these extensions can affect the numeral system used by [PercentFormatter(IIterable(String), String)](percentformatter_percentformatter_177128098.md) objects.
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.resolvedlanguage
     * @type {HSTRING} 
     */
    ResolvedLanguage {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.resolvedgeographicregion
     * @type {HSTRING} 
     */
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.significantdigits
     * @type {Integer} 
     */
    SignificantDigits {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.numberrounder
     * @type {INumberRounder} 
     */
    NumberRounder {
     ...
     * @remarks
     * You can set this property to specify that [PercentFormatter](percentformatter.md) display negative 0 as "-0". This enables the scenario where you wish to display "-0" when it represents the rounded value of some small negative value (such as -0.00001).
     * 
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.iszerosigned
     * @type {Boolean} 
     */
    IsZeroSigned {
...
;@region Instance Methods
    /**
     * Creates a [PercentFormatter](percentformatter.md) object and initializes it to default values.
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.Globalization.NumberFormatting.PercentFormatter")
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.format
     */
    FormatInt(value) {
     ...
     * @param {Integer} value The **Int64** value to be formatted.
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.formatint
     */
    FormatInt1(value) {
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.formatuint
     */
    FormatUInt1(value) {
        if (!this.HasProp("__INumberFormatter2")) {
            if ((queryResult := this.QueryInterface(INumberFormatter2.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.formatdouble
     */
    FormatDouble1(value) {
        if (!this.HasProp("__INumberFormatter2")) {
            if ((queryResult := this.QueryInterface(INumberFormatter2.IID, &outPtr := 0)) != 0)
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.parseint
     */
    ParseInt(text) {
     ...
     * @param {HSTRING} text The text to be parsed.
     * @returns {IReference<Integer>} 
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.parseuint
     */
    ParseUInt(text) {
        if (!this.HasProp("__INumberParser")) {
            if ((queryResult := this.QueryInterface(INumberParser.IID, &outPtr := 0)) != 0)
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.globalization.numberformatting.percentformatter.parsedouble
     */
    ParseDouble(text) {
        if (!this.HasProp("__INumberParser")) {
            if ((queryResult := this.QueryInterface(INumberParser.IID, &outPtr := 0)) != 0)
