 ...
 */
class ISpatialEntityWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialEntityWatcher
     * @type {Guid}
     */
    static IID => Guid("{b3b85fa0-6d5e-4bbc-805d-5fe5b9ba1959}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Status", "add_Added", "remove_Added", "add_Updated", "remove_Updated", "add_Removed", "remove_Removed", "add_EnumerationCompleted", "remove_EnumerationCompleted", "Start", "Stop"]
