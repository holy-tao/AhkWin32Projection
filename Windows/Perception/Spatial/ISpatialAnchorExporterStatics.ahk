...
#Include ..\..\..\Guid.ahk
#Include .\SpatialAnchorExporter.ahk
 ...
 */
class ISpatialAnchorExporterStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialAnchorExporterStatics
     * @type {Guid}
     */
    static IID => Guid("{ed2507b8-2475-439c-85ff-7fed341fdc88}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetDefault", "RequestAccessAsync"]
    ...
    GetDefault() {
        ...
        return SpatialAnchorExporter(value)
    }
