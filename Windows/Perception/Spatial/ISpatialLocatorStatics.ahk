 ...
 */
class ISpatialLocatorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpatialLocatorStatics
     * @type {Guid}
     */
    static IID => Guid("{b76e3340-a7c2-361b-bb82-56e93b89b1bb}")
