 ...
 */
class ITargetedContentContainerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITargetedContentContainerStatics
     * @type {Guid}
     */
    static IID => Guid("{5b47e7fb-2140-4c1f-a736-c59583f227d8}")
    ...
    GetAsync(contentId) {
        ...
        result := ComCall(6, this, "ptr", contentId, "ptr*", &asyncOperation := 0, "int")
        if(result != 0) {
