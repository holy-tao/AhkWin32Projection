 ...
 */
class IGuidanceTelemetryCollector extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGuidanceTelemetryCollector
     * @type {Guid}
     */
    static IID => Guid("{db1f8da5-b878-4d92-98dd-347d23d38262}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Enabled", "put_Enabled", "ClearLocalData", "get_SpeedTrigger", "put_SpeedTrigger", "get_UploadFrequency", "put_UploadFrequency"]
