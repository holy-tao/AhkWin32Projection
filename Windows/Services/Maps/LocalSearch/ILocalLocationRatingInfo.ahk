 ...
 */
class ILocalLocationRatingInfo extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILocalLocationRatingInfo
     * @type {Guid}
     */
    static IID => Guid("{cb1dab56-3354-4311-8bc0-a2d4d5eb806e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_AggregateRating", "get_RatingCount", "get_ProviderIdentifier"]
