 ...
 */
class ICortanaSettingsStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICortanaSettingsStatics
     * @type {Guid}
     */
    static IID => Guid("{8b2ccd7e-2ec0-446d-9285-33f07ce8ac04}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["IsSupported", "GetDefault"]
    ...
    GetDefault() {
        ...
        return CortanaSettings(result_)
    }
}
