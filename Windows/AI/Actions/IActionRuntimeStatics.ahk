 ...
 */
class IActionRuntimeStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IActionRuntimeStatics
     * @type {Guid}
     */
    static IID => Guid("{2c697aab-55f2-55aa-9d63-a73ec190cecd}")
