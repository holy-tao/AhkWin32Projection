 ...
 */
class IMcpServerRegistryStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMcpServerRegistryStatics
     * @type {Guid}
     */
    static IID => Guid("{4acf7fed-d300-55bc-9dde-9f433cdc903d}")
    ...
    GetDefault() {
        ...
        return McpServerRegistry(result_)
    }
}
