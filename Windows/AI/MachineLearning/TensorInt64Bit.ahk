...
#Include .\ITensorInt64Bit.ahk
#Include .\ITensor.ahk
#Include .\ILearningModelFeatureValue.ahk
#Include ..\..\Foundation\IMemoryBuffer.ahk
#Include ..\..\Foundation\IClosable.ahk
#Include .\ITensorInt64BitStatics2.ahk
#Include .\ITensorInt64BitStatics.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ITensorInt64Bit
     ...
     * @type {Guid}
     */
    static IID => ITensorInt64Bit.IID
...
;@region Static Methods
     ...
     * @returns {TensorInt64Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.createfromshapearrayanddataarray
     */
    static CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data) {
        if (!TensorInt64Bit.HasProp("__ITensorInt64BitStatics2")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorInt64Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorInt64BitStatics2.IID)
            TensorInt64Bit.__ITensorInt64BitStatics2 := ITensorInt64BitStatics2(factoryPtr)
        }

        return TensorInt64Bit.__ITensorInt64BitStatics2.CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data)
    }
     ...
     * @returns {TensorInt64Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.createfrombuffer
     */
    static CreateFromBuffer(shape_length, shape, buffer_) {
        ...
        return TensorInt64Bit.__ITensorInt64BitStatics2.CreateFromBuffer(shape_length, shape, buffer_)
    }
     ...
     * @returns {TensorInt64Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.create
     */
    static Create() {
        if (!TensorInt64Bit.HasProp("__ITensorInt64BitStatics")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorInt64Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorInt64BitStatics.IID)
            TensorInt64Bit.__ITensorInt64BitStatics := ITensorInt64BitStatics(factoryPtr)
        }

        return TensorInt64Bit.__ITensorInt64BitStatics.Create()
    }
    ...
    static Create2(shape_) {
        ...
        return TensorInt64Bit.__ITensorInt64BitStatics.Create2(shape_)
    }
     ...
     * @param {Pointer<Integer>} data The data to copy into the buffer.
     * @returns {TensorInt64Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.createfromarray
     */
    static CreateFromArray(shape_, data_length, data) {
        ...
        return TensorInt64Bit.__ITensorInt64BitStatics.CreateFromArray(shape_, data_length, data)
    }
     ...
     * @returns {TensorInt64Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.createfromiterable
     */
    static CreateFromIterable(shape_, data) {
        ...
        return TensorInt64Bit.__ITensorInt64BitStatics.CreateFromIterable(shape_, data)
    }
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.tensorkind
     * @type {Integer} 
     */
    TensorKind {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.shape
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.getasvectorview
     */
    GetAsVectorView() {
        if (!this.HasProp("__ITensorInt64Bit")) {
            if ((queryResult := this.QueryInterface(ITensorInt64Bit.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ITensorInt64Bit := ITensorInt64Bit(outPtr)
        }

        return this.__ITensorInt64Bit.GetAsVectorView()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.createreference
     */
    CreateReference() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint64bit.close
     */
    Close() {
