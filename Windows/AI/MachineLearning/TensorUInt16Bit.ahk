...
#Include .\ITensorUInt16Bit.ahk
#Include .\ITensor.ahk
#Include .\ILearningModelFeatureValue.ahk
#Include ..\..\Foundation\IMemoryBuffer.ahk
#Include ..\..\Foundation\IClosable.ahk
#Include .\ITensorUInt16BitStatics.ahk
#Include .\ITensorUInt16BitStatics2.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ITensorUInt16Bit
     ...
     * @type {Guid}
     */
    static IID => ITensorUInt16Bit.IID
...
;@region Static Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.create
     */
    static Create() {
        if (!TensorUInt16Bit.HasProp("__ITensorUInt16BitStatics")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorUInt16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorUInt16BitStatics.IID)
            TensorUInt16Bit.__ITensorUInt16BitStatics := ITensorUInt16BitStatics(factoryPtr)
        }

        return TensorUInt16Bit.__ITensorUInt16BitStatics.Create()
    }
    ...
    static Create2(shape_) {
        ...
        return TensorUInt16Bit.__ITensorUInt16BitStatics.Create2(shape_)
    }
     ...
     * @returns {TensorUInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.createfromarray
     */
    static CreateFromArray(shape_, data_length, data) {
        ...
        return TensorUInt16Bit.__ITensorUInt16BitStatics.CreateFromArray(shape_, data_length, data)
    }
     ...
     * @returns {TensorUInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.createfromiterable
     */
    static CreateFromIterable(shape_, data) {
        ...
        return TensorUInt16Bit.__ITensorUInt16BitStatics.CreateFromIterable(shape_, data)
    }
     ...
     * @param {Pointer<Integer>} data The data to copy into the buffer.
     * @returns {TensorUInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.createfromshapearrayanddataarray
     */
    static CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data) {
        if (!TensorUInt16Bit.HasProp("__ITensorUInt16BitStatics2")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorUInt16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorUInt16BitStatics2.IID)
            TensorUInt16Bit.__ITensorUInt16BitStatics2 := ITensorUInt16BitStatics2(factoryPtr)
        }

        return TensorUInt16Bit.__ITensorUInt16BitStatics2.CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data)
    }
     ...
     * @returns {TensorUInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.createfrombuffer
     */
    static CreateFromBuffer(shape_length, shape, buffer_) {
        ...
        return TensorUInt16Bit.__ITensorUInt16BitStatics2.CreateFromBuffer(shape_length, shape, buffer_)
    }
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.tensorkind
     * @type {Integer} 
     */
    TensorKind {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.shape
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.getasvectorview
     */
    GetAsVectorView() {
        if (!this.HasProp("__ITensorUInt16Bit")) {
            if ((queryResult := this.QueryInterface(ITensorUInt16Bit.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ITensorUInt16Bit := ITensorUInt16Bit(outPtr)
        }

        return this.__ITensorUInt16Bit.GetAsVectorView()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.createreference
     */
    CreateReference() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensoruint16bit.close
     */
    Close() {
