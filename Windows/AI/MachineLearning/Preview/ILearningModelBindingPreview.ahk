 ...
 */
class ILearningModelBindingPreview extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILearningModelBindingPreview
     * @type {Guid}
     */
    static IID => Guid("{93c901e8-6c78-4b4f-aec1-a6bb9e691624}")
    ...
    BindWithProperties(name, value, metadata) {
        ...
        result := ComCall(7, this, "ptr", name, "ptr", value, "ptr", metadata, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
