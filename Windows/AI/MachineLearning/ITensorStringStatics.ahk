...
class ITensorStringStatics extends IInspectable{
    ...
    /**
     * The interface identifier for ITensorStringStatics
     * @type {Guid}
     */
    static IID => Guid("{83623324-cf26-4f17-a2d4-20ef8d097d53}")
    ...
    CreateFromArray(shape_, data_length, data) {
        result := ComCall(8, this, "ptr", shape_, "uint", data_length, "ptr", data, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
