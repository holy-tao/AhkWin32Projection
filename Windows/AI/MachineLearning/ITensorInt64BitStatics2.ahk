...
class ITensorInt64BitStatics2 extends IInspectable{
    ...
    /**
     * The interface identifier for ITensorInt64BitStatics2
     * @type {Guid}
     */
    static IID => Guid("{6d3d9dcb-ff40-5ec2-89fe-084e2b6bc6db}")
    ...
    CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data) {
        ...
        dataMarshal := data is VarRef ? "int64*" : "ptr"
