...
#Include .\ITensorFloat16Bit.ahk
#Include .\ITensor.ahk
#Include .\ILearningModelFeatureValue.ahk
#Include ..\..\Foundation\IMemoryBuffer.ahk
#Include ..\..\Foundation\IClosable.ahk
#Include .\ITensorFloat16BitStatics2.ahk
#Include .\ITensorFloat16BitStatics.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ITensorFloat16Bit
     ...
     * @type {Guid}
     */
    static IID => ITensorFloat16Bit.IID
...
;@region Static Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.createfromshapearrayanddataarray
     */
    static CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data) {
        if (!TensorFloat16Bit.HasProp("__ITensorFloat16BitStatics2")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorFloat16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorFloat16BitStatics2.IID)
            TensorFloat16Bit.__ITensorFloat16BitStatics2 := ITensorFloat16BitStatics2(factoryPtr)
        }

        return TensorFloat16Bit.__ITensorFloat16BitStatics2.CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data)
    }
     ...
     * @returns {TensorFloat16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.createfrombuffer
     */
    static CreateFromBuffer(shape_length, shape, buffer_) {
        ...
        return TensorFloat16Bit.__ITensorFloat16BitStatics2.CreateFromBuffer(shape_length, shape, buffer_)
    }
     ...
     * @returns {TensorFloat16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.create
     */
    static Create() {
        if (!TensorFloat16Bit.HasProp("__ITensorFloat16BitStatics")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorFloat16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorFloat16BitStatics.IID)
            TensorFloat16Bit.__ITensorFloat16BitStatics := ITensorFloat16BitStatics(factoryPtr)
        }

        return TensorFloat16Bit.__ITensorFloat16BitStatics.Create()
    }
    ...
    static Create2(shape_) {
        ...
        return TensorFloat16Bit.__ITensorFloat16BitStatics.Create2(shape_)
    }
     ...
     * @param {Pointer<Float>} data The data to copy into the buffer.
     * @returns {TensorFloat16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.createfromarray
     */
    static CreateFromArray(shape_, data_length, data) {
        ...
        return TensorFloat16Bit.__ITensorFloat16BitStatics.CreateFromArray(shape_, data_length, data)
    }
     ...
     * @returns {TensorFloat16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.createfromiterable
     */
    static CreateFromIterable(shape_, data) {
        ...
        return TensorFloat16Bit.__ITensorFloat16BitStatics.CreateFromIterable(shape_, data)
    }
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.tensorkind
     * @type {Integer} 
     */
    TensorKind {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.shape
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.getasvectorview
     */
    GetAsVectorView() {
        if (!this.HasProp("__ITensorFloat16Bit")) {
            if ((queryResult := this.QueryInterface(ITensorFloat16Bit.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ITensorFloat16Bit := ITensorFloat16Bit(outPtr)
        }

        return this.__ITensorFloat16Bit.GetAsVectorView()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.createreference
     */
    CreateReference() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorfloat16bit.close
     */
    Close() {
