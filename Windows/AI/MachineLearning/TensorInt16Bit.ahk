...
#Include .\ITensorInt16Bit.ahk
#Include .\ITensor.ahk
#Include .\ILearningModelFeatureValue.ahk
#Include ..\..\Foundation\IMemoryBuffer.ahk
#Include ..\..\Foundation\IClosable.ahk
#Include .\ITensorInt16BitStatics.ahk
#Include .\ITensorInt16BitStatics2.ahk
#Include ..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => ITensorInt16Bit
     ...
     * @type {Guid}
     */
    static IID => ITensorInt16Bit.IID
...
;@region Static Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.create
     */
    static Create() {
        if (!TensorInt16Bit.HasProp("__ITensorInt16BitStatics")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorInt16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorInt16BitStatics.IID)
            TensorInt16Bit.__ITensorInt16BitStatics := ITensorInt16BitStatics(factoryPtr)
        }

        return TensorInt16Bit.__ITensorInt16BitStatics.Create()
    }
    ...
    static Create2(shape_) {
        ...
        return TensorInt16Bit.__ITensorInt16BitStatics.Create2(shape_)
    }
     ...
     * @returns {TensorInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.createfromarray
     */
    static CreateFromArray(shape_, data_length, data) {
        ...
        return TensorInt16Bit.__ITensorInt16BitStatics.CreateFromArray(shape_, data_length, data)
    }
     ...
     * @returns {TensorInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.createfromiterable
     */
    static CreateFromIterable(shape_, data) {
        ...
        return TensorInt16Bit.__ITensorInt16BitStatics.CreateFromIterable(shape_, data)
    }
     ...
     * @param {Pointer<Integer>} data The data to copy into the buffer.
     * @returns {TensorInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.createfromshapearrayanddataarray
     */
    static CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data) {
        if (!TensorInt16Bit.HasProp("__ITensorInt16BitStatics2")) {
            activatableClassId := HSTRING.Create("Windows.AI.MachineLearning.TensorInt16Bit")
            factoryPtr := WinRT.RoGetActivationFactory(activatableClassId, ITensorInt16BitStatics2.IID)
            TensorInt16Bit.__ITensorInt16BitStatics2 := ITensorInt16BitStatics2(factoryPtr)
        }

        return TensorInt16Bit.__ITensorInt16BitStatics2.CreateFromShapeArrayAndDataArray(shape_length, shape, data_length, data)
    }
     ...
     * @returns {TensorInt16Bit} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.createfrombuffer
     */
    static CreateFromBuffer(shape_length, shape, buffer_) {
        ...
        return TensorInt16Bit.__ITensorInt16BitStatics2.CreateFromBuffer(shape_length, shape, buffer_)
    }
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.tensorkind
     * @type {Integer} 
     */
    TensorKind {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.shape
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.getasvectorview
     */
    GetAsVectorView() {
        if (!this.HasProp("__ITensorInt16Bit")) {
            if ((queryResult := this.QueryInterface(ITensorInt16Bit.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__ITensorInt16Bit := ITensorInt16Bit(outPtr)
        }

        return this.__ITensorInt16Bit.GetAsVectorView()
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.createreference
     */
    CreateReference() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.ai.machinelearning.tensorint16bit.close
     */
    Close() {
