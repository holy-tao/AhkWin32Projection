...
#Include ..\..\..\Guid.ahk
#Include .\AppInstallerManager.ahk
 ...
 */
class IAppInstallerManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppInstallerManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{c95a6ed5-fc59-5336-9b2e-2b07c5e61434}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetDefault", "GetForSystem"]
    ...
    GetDefault() {
        ...
        return AppInstallerManager(result_)
    }
