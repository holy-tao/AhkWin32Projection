...
class IAddPackageOptions2 extends IInspectable{
    ...
    /**
     * The interface identifier for IAddPackageOptions2
     * @type {Guid}
     */
    static IID => Guid("{ee515828-bf33-40f7-84af-1b6fad2919d7}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ExpectedDigests", "get_LimitToExistingPackages", "put_LimitToExistingPackages"]
