 ...
 */
class IScanUpdateTaskResult extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IScanUpdateTaskResult
     * @type {Guid}
     */
    static IID => Guid("{24e9f302-a976-5148-b109-5100ac1a50ed}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Result", "get_ScanRecords"]
