 ...
 */
class IUpdateInstallerPlugin extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUpdateInstallerPlugin
     * @type {Guid}
     */
    static IID => Guid("{61122faa-0cd8-5a98-8938-5c1f88c632c6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Name", "get_FriendlyName", "get_Description", "get_Version", "get_IsUpdateRollbackSupported", "get_DefaultOptions", "CreateUpdateInstaller"]
     ...
     * @type {Boolean} 
     */
    IsUpdateRollbackSupported {
        get => this.get_IsUpdateRollbackSupported()
    }
     ...
     */
    CreateUpdateInstaller(clusterName, runId, options, updateServices) {
        ...
        result := ComCall(12, this, "ptr", clusterName, "ptr", runId, "ptr", options, "ptr", updateServices, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IUpdateInstaller(result_)
    }
}
