...
#Include .\IClusterNativeNodeOperations.ahk
 ...
 */
class IClusterNativeNodeOperationsPlugin extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IClusterNativeNodeOperationsPlugin
     * @type {Guid}
     */
    static IID => Guid("{5f7a457c-e9d3-5cec-a967-0da9d95fd6f4}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Name", "get_FriendlyName", "get_Description", "get_Version", "get_DefaultOptions", "CreateNodeOperations"]
     ...
     * @returns {IClusterNativeNodeOperations} 
     */
    CreateNodeOperations(clusterName, runId, options, updateServices) {
        ...
        return IClusterNativeNodeOperations(result_)
    }
}
