 ...
 */
class IRemoteSystemWatcher2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRemoteSystemWatcher2
     * @type {Guid}
     */
    static IID => Guid("{73436700-19ca-48f9-a4cd-780f7ad58c71}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_EnumerationCompleted", "remove_EnumerationCompleted", "add_ErrorOccurred", "remove_ErrorOccurred"]
