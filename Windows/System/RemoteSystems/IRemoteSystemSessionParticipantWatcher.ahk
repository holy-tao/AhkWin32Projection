 ...
 */
class IRemoteSystemSessionParticipantWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRemoteSystemSessionParticipantWatcher
     * @type {Guid}
     */
    static IID => Guid("{dcdd02cc-aa87-4d79-b6cc-4459b3e92075}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Start", "Stop", "get_Status", "add_Added", "remove_Added", "add_Removed", "remove_Removed", "add_EnumerationCompleted", "remove_EnumerationCompleted"]
