 ...
 */
class IRemoteSystemSessionWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRemoteSystemSessionWatcher
     * @type {Guid}
     */
    static IID => Guid("{8003e340-0c41-4a62-b6d7-bdbe2b19be2d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Start", "Stop", "get_Status", "add_Added", "remove_Added", "add_Updated", "remove_Updated", "add_Removed", "remove_Removed"]
