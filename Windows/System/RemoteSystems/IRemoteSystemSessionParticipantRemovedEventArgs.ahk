 ...
 */
class IRemoteSystemSessionParticipantRemovedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRemoteSystemSessionParticipantRemovedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{866ef088-de68-4abf-88a1-f90d16274192}")
