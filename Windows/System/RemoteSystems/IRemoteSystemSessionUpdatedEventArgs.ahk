 ...
 */
class IRemoteSystemSessionUpdatedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRemoteSystemSessionUpdatedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{16875069-231e-4c91-8ec8-b3a39d9e55a3}")
