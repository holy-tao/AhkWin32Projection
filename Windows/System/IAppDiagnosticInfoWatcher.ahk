 ...
 */
class IAppDiagnosticInfoWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppDiagnosticInfoWatcher
     * @type {Guid}
     */
    static IID => Guid("{75575070-01d3-489a-9325-52f9cc6ede0a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_Removed", "remove_Removed", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "get_Status", "Start", "Stop"]
