 ...
 */
class IUserAuthenticationStatusChangeDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUserAuthenticationStatusChangeDeferral
     * @type {Guid}
     */
    static IID => Guid("{88b59568-bb30-42fb-a270-e9902e40efa7}")
