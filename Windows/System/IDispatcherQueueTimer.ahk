 ...
 */
class IDispatcherQueueTimer extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDispatcherQueueTimer
     * @type {Guid}
     */
    static IID => Guid("{5feabb1d-a31c-4727-b1ac-37454649d56a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Interval", "put_Interval", "get_IsRunning", "get_IsRepeating", "put_IsRepeating", "Start", "Stop", "add_Tick", "remove_Tick"]
