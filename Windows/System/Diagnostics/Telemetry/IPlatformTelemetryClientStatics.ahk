...
#Include .\PlatformTelemetryRegistrationResult.ahk
 ...
 */
class IPlatformTelemetryClientStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPlatformTelemetryClientStatics
     * @type {Guid}
     */
    static IID => Guid("{9bf3f25d-d5c3-4eea-8dbe-9c8dbb0d9d8f}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Register", "RegisterWithSettings"]
    ...
    Register(id) {
        ...
        return PlatformTelemetryRegistrationResult(result_)
    }
     ...
     * @see https://learn.microsoft.com/windows/win32/ktop-src/NetMon2/register-parser
     */
    RegisterWithSettings(id, settings) {
        if(id is String) {
            pin := HSTRING.Create(id)
            id := pin.Value
        }
        ...
        result := ComCall(7, this, "ptr", id, "ptr", settings, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
