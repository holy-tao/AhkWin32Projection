 ...
 */
class IDevicePortalConnection extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IDevicePortalConnection
     * @type {Guid}
     */
    static IID => Guid("{0f447f51-1198-4da1-8d54-bdef393e09b6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Closed", "remove_Closed", "add_RequestReceived", "remove_RequestReceived"]
