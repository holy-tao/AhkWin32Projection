 ...
 */
class IAppResourceGroupInfoWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppResourceGroupInfoWatcher
     * @type {Guid}
     */
    static IID => Guid("{d9b0a0fd-6e5a-4c72-8b17-09fec4a212bd}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_Removed", "remove_Removed", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "add_ExecutionStateChanged", "remove_ExecutionStateChanged", "get_Status", "Start", "Stop"]
