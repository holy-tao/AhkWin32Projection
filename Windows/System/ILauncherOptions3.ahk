...
class ILauncherOptions3 extends IInspectable{
    ...
    /**
     * The interface identifier for ILauncherOptions3
     * @type {Guid}
     */
    static IID => Guid("{f0770655-4b63-4e3a-9107-4e687841923a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IgnoreAppUriHandlers", "put_IgnoreAppUriHandlers"]
