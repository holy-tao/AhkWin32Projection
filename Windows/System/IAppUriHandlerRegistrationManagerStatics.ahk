 ...
 */
class IAppUriHandlerRegistrationManagerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAppUriHandlerRegistrationManagerStatics
     * @type {Guid}
     */
    static IID => Guid("{d5cedd9f-5729-5b76-a1d4-0285f295c124}")
