 ...
 */
class II2cController extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for II2cController
     * @type {Guid}
     */
    static IID => Guid("{c48ab1b2-87a0-4166-8e3e-b4b8f97cd729}")
     ...
     * <div> </div>
     * @param {I2cConnectionSettings} settings 
     * @returns {I2cDevice} 
