 ...
 */
class IMagnetometerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMagnetometerStatics
     * @type {Guid}
     */
    static IID => Guid("{853c64cc-0698-4dda-a6df-9cb9cc4ab40a}")
