 ...
 */
class ICompassReading extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompassReading
     * @type {Guid}
     */
    static IID => Guid("{82911128-513d-4dc9-b781-5eedfbf02d0c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Timestamp", "get_HeadingMagneticNorth", "get_HeadingTrueNorth"]
