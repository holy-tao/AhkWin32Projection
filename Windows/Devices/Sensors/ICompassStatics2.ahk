 ...
 */
class ICompassStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompassStatics2
     * @type {Guid}
     */
    static IID => Guid("{0ace0ead-3baa-4990-9ce4-be0913754ed2}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(Compass, operation)
    }
}
