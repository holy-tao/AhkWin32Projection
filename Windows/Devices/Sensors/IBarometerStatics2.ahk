 ...
 */
class IBarometerStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarometerStatics2
     * @type {Guid}
     */
    static IID => Guid("{8fc6b1e7-95ff-44ac-878e-d65c8308c34c}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(Barometer, operation)
    }
