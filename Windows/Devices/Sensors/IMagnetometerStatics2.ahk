 ...
 */
class IMagnetometerStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMagnetometerStatics2
     * @type {Guid}
     */
    static IID => Guid("{2c0819f0-ffc6-4f89-a06f-18fa10792933}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(Magnetometer, operation)
    }
}
