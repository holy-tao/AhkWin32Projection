 ...
 */
class IAltimeterStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAltimeterStatics
     * @type {Guid}
     */
    static IID => Guid("{9eb4d7c3-e5ac-47ce-8eef-d3718168c01f}")
