 ...
 */
class IHumanPresenceSensorReadingUpdate extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IHumanPresenceSensorReadingUpdate
     * @type {Guid}
     */
    static IID => Guid("{42419c77-6d2f-55a0-9e01-c9cbe7b2d6df}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Timestamp", "put_Timestamp", "get_Presence", "put_Presence", "get_Engagement", "put_Engagement", "get_DistanceInMillimeters", "put_DistanceInMillimeters"]
