 ...
 */
class ISimpleOrientationSensorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISimpleOrientationSensorStatics
     * @type {Guid}
     */
    static IID => Guid("{72ed066f-70aa-40c6-9b1b-3433f7459b4e}")
    ...
    GetDefault() {
        ...
        return SimpleOrientationSensor(result_)
    }
}
