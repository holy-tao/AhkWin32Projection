 ...
 */
class IGyrometerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGyrometerStatics
     * @type {Guid}
     */
    static IID => Guid("{83b6e7c9-e49d-4b39-86e6-cd554be4c5c1}")
