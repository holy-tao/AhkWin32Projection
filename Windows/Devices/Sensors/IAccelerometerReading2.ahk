 ...
 */
class IAccelerometerReading2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccelerometerReading2
     * @type {Guid}
     */
    static IID => Guid("{0a864aa2-15ae-4a40-be55-db58d7de7389}")
