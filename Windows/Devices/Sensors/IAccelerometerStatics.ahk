 ...
 */
class IAccelerometerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccelerometerStatics
     * @type {Guid}
     */
    static IID => Guid("{a5e28b74-5a87-4a2d-becc-0f906ea061dd}")
