 ...
 */
class ICompassStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICompassStatics
     * @type {Guid}
     */
    static IID => Guid("{9abc97df-56ec-4c25-b54d-40a68bb5b269}")
