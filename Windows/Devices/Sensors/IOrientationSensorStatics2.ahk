 ...
 */
class IOrientationSensorStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IOrientationSensorStatics2
     * @type {Guid}
     */
    static IID => Guid("{59da0d0b-d40a-4c71-9276-8a272a0a6619}")
