 ...
 */
class IAccelerometerStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccelerometerStatics3
     * @type {Guid}
     */
    static IID => Guid("{9de218cf-455d-4cf3-8200-70e1410340f8}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(Accelerometer, operation)
    }
    ...
    GetDeviceSelector(readingType) {
        result_ := HSTRING()
        result := ComCall(7, this, "int", readingType, "ptr", result_, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
