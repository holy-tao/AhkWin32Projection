 ...
 */
class ILightSensorStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILightSensorStatics2
     * @type {Guid}
     */
    static IID => Guid("{0ec0a650-ddc6-40ab-ace3-ec3359d42c51}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(LightSensor, operation)
    }
}
