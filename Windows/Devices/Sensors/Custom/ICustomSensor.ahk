 ...
 */
class ICustomSensor extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICustomSensor
     * @type {Guid}
     */
    static IID => Guid("{a136f9ad-4034-4b4d-99dd-531aac649c09}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetCurrentReading", "get_MinimumReportInterval", "put_ReportInterval", "get_ReportInterval", "get_DeviceId", "add_ReadingChanged", "remove_ReadingChanged"]
