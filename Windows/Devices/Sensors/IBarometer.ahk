 ...
 */
class IBarometer extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarometer
     * @type {Guid}
     */
    static IID => Guid("{934475a8-78bf-452f-b017-f0209ce6dab4}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetCurrentReading", "get_DeviceId", "get_MinimumReportInterval", "put_ReportInterval", "get_ReportInterval", "add_ReadingChanged", "remove_ReadingChanged"]
