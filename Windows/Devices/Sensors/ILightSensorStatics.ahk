 ...
 */
class ILightSensorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILightSensorStatics
     * @type {Guid}
     */
    static IID => Guid("{45db8c84-c3a8-471e-9a53-6457fad87c0e}")
