 ...
 */
class IGyrometerStatics2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGyrometerStatics2
     * @type {Guid}
     */
    static IID => Guid("{ef83f7a1-d700-4204-9613-79c6b161df4e}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(Gyrometer, operation)
    }
}
