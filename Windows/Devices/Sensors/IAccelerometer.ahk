 ...
 */
class IAccelerometer extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAccelerometer
     * @type {Guid}
     */
    static IID => Guid("{df184548-2711-4da7-8098-4b82205d3c7d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetCurrentReading", "get_MinimumReportInterval", "put_ReportInterval", "get_ReportInterval", "add_ReadingChanged", "remove_ReadingChanged", "add_Shaken", "remove_Shaken"]
