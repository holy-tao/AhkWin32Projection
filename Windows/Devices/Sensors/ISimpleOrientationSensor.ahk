 ...
 */
class ISimpleOrientationSensor extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISimpleOrientationSensor
     * @type {Guid}
     */
    static IID => Guid("{5ff53856-214a-4dee-a3f9-616f1ab06ffd}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetCurrentOrientation", "add_OrientationChanged", "remove_OrientationChanged"]
