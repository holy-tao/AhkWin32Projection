 ...
 */
class IOrientationSensorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IOrientationSensorStatics
     * @type {Guid}
     */
    static IID => Guid("{10ef8712-fb4c-428a-898b-2765e409e669}")
