 ...
 */
class IImageScannerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IImageScannerStatics
     * @type {Guid}
     */
    static IID => Guid("{bc57e70e-d804-4477-9fb5-b911b5473897}")
    ...
    FromIdAsync(deviceId) {
        ...
        result := ComCall(6, this, "ptr", deviceId, "ptr*", &asyncInfo := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IAsyncOperation(ImageScanner, asyncInfo)
    }
