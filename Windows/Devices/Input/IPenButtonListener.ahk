 ...
 */
class IPenButtonListener extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPenButtonListener
     * @type {Guid}
     */
    static IID => Guid("{8245c376-1ee3-53f7-b1f7-8334a16f2815}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["IsSupported", "add_IsSupportedChanged", "remove_IsSupportedChanged", "add_TailButtonClicked", "remove_TailButtonClicked", "add_TailButtonDoubleClicked", "remove_TailButtonDoubleClicked", "add_TailButtonLongPressed", "remove_TailButtonLongPressed"]
