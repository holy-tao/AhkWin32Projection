 ...
 */
class IGazeDeviceWatcherPreview extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGazeDeviceWatcherPreview
     * @type {Guid}
     */
    static IID => Guid("{e79e7ee7-b389-11e7-b201-c8d3ffb75721}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_Removed", "remove_Removed", "add_Updated", "remove_Updated", "add_EnumerationCompleted", "remove_EnumerationCompleted", "Start", "Stop"]
