 ...
 */
class IGazeExitedPreviewEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGazeExitedPreviewEventArgs
     * @type {Guid}
     */
    static IID => Guid("{5d0af07e-7d83-40ef-9f0a-fbc1bbdcc5ac}")
