 ...
 */
class IPenButtonListenerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPenButtonListenerStatics
     * @type {Guid}
     */
    static IID => Guid("{19a8a584-862f-5f69-bfea-05f6584f133f}")
    ...
    GetDefault() {
        ...
        return PenButtonListener(result_)
    }
}
