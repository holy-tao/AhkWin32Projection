...
#Include ..\..\..\Guid.ahk
#Include .\WiFiDirectAdvertisement.ahk
 ...
 */
class IWiFiDirectAdvertisementPublisher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWiFiDirectAdvertisementPublisher
     * @type {Guid}
     */
    static IID => Guid("{b35a2d1a-9b1f-45d9-925a-694d66df68ef}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Advertisement", "get_Status", "add_StatusChanged", "remove_StatusChanged", "Start", "Stop"]
    ...
    get_Advertisement() {
        ...
        return WiFiDirectAdvertisement(value)
    }
