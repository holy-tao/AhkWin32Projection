 ...
 */
class IWiFiDirectConnectionRequest extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWiFiDirectConnectionRequest
     * @type {Guid}
     */
    static IID => Guid("{8eb99605-914f-49c3-a614-d18dc5b19b43}")
