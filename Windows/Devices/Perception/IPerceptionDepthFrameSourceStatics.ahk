 ...
 */
class IPerceptionDepthFrameSourceStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPerceptionDepthFrameSourceStatics
     * @type {Guid}
     */
    static IID => Guid("{5df3cca2-01f8-4a87-b859-d5e5b7e1de48}")
    ...
    CreateWatcher() {
        ...
        return PerceptionDepthFrameSourceWatcher(watcher)
    }
    ...
    FindAllAsync() {
        ...
        return IAsyncOperation(IVectorView.Call.Bind(IVectorView, PerceptionDepthFrameSource), result_)
    }
    ...
    FromIdAsync(id) {
        ...
        return IAsyncOperation(PerceptionDepthFrameSource, result_)
    }
