 ...
 */
class IPerceptionDepthFrameSourceWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPerceptionDepthFrameSourceWatcher
     * @type {Guid}
     */
    static IID => Guid("{780e96d1-8d02-4d2b-ada4-5ba624a0eb10}")
