 ...
 */
class IPerceptionDepthFrameSource extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPerceptionDepthFrameSource
     * @type {Guid}
     */
    static IID => Guid("{79d433d6-47fb-4df1-bfc9-f01d40bd9942}")
    ...
    OpenReader() {
        ...
        return PerceptionDepthFrameReader(result_)
    }
}
