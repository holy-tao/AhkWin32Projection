 ...
 */
class IPerceptionInfraredFrameSourceWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPerceptionInfraredFrameSourceWatcher
     * @type {Guid}
     */
    static IID => Guid("{383cff99-d70c-444d-a8b0-720c2e66fe3b}")
