 ...
 */
class IPerceptionDepthFrameReader extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPerceptionDepthFrameReader
     * @type {Guid}
     */
    static IID => Guid("{b1a3c09f-299b-4612-a4f7-270f25a096ec}")
