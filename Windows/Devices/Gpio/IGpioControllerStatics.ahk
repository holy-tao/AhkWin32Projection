 ...
 */
class IGpioControllerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGpioControllerStatics
     * @type {Guid}
     */
    static IID => Guid("{2ed6f42e-7af7-4116-9533-c43d99a1fb64}")
