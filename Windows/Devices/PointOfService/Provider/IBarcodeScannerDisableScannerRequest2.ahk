 ...
 */
class IBarcodeScannerDisableScannerRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerDisableScannerRequest2
     * @type {Guid}
     */
    static IID => Guid("{ccdfe625-65c3-4ccc-b457-f39c7a9ea60d}")
