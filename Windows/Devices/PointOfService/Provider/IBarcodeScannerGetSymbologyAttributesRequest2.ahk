 ...
 */
class IBarcodeScannerGetSymbologyAttributesRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerGetSymbologyAttributesRequest2
     * @type {Guid}
     */
    static IID => Guid("{6a6a2b13-75a8-49fb-b852-bfb93d760af7}")
