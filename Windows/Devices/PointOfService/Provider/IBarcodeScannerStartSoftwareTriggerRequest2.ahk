 ...
 */
class IBarcodeScannerStartSoftwareTriggerRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerStartSoftwareTriggerRequest2
     * @type {Guid}
     */
    static IID => Guid("{eb72a25c-6658-4765-a68e-327482653deb}")
