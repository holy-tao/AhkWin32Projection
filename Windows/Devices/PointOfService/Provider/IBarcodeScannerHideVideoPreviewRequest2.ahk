 ...
 */
class IBarcodeScannerHideVideoPreviewRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerHideVideoPreviewRequest2
     * @type {Guid}
     */
    static IID => Guid("{7e28435d-9814-431d-a2f2-d6248c5ad4b5}")
