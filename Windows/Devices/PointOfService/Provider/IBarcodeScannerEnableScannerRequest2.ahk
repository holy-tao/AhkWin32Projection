 ...
 */
class IBarcodeScannerEnableScannerRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerEnableScannerRequest2
     * @type {Guid}
     */
    static IID => Guid("{71a4f2a8-9905-41ac-9121-b645916a84a1}")
