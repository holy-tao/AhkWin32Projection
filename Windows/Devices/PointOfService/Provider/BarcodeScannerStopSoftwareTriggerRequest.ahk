...
#Include .\IBarcodeScannerStopSoftwareTriggerRequest.ahk
#Include .\IBarcodeScannerStopSoftwareTriggerRequest2.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * @see https://learn.microsoft.com/uwp/api/windows.devices.pointofservice.provider.barcodescannerstopsoftwaretriggerrequest
 * @namespace Windows.Devices.PointOfService.Provider
 * @version WindowsRuntime 1.4
 */
class BarcodeScannerStopSoftwareTriggerRequest extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IBarcodeScannerStopSoftwareTriggerRequest
     ...
     * @type {Guid}
     */
    static IID => IBarcodeScannerStopSoftwareTriggerRequest.IID
...
;@region Instance Methods
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.devices.pointofservice.provider.barcodescannerstopsoftwaretriggerrequest.reportcompletedasync
     */
    ReportCompletedAsync() {
        if (!this.HasProp("__IBarcodeScannerStopSoftwareTriggerRequest")) {
            if ((queryResult := this.QueryInterface(IBarcodeScannerStopSoftwareTriggerRequest.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IBarcodeScannerStopSoftwareTriggerRequest := IBarcodeScannerStopSoftwareTriggerRequest(outPtr)
        }

        return this.__IBarcodeScannerStopSoftwareTriggerRequest.ReportCompletedAsync()
    }
     ...
     * @returns {IAsyncAction} 
     * @see https://learn.microsoft.com/uwp/api/windows.devices.pointofservice.provider.barcodescannerstopsoftwaretriggerrequest.reportfailedasync
     */
    ReportFailedAsync() {
        if (!this.HasProp("__IBarcodeScannerStopSoftwareTriggerRequest")) {
            if ((queryResult := this.QueryInterface(IBarcodeScannerStopSoftwareTriggerRequest.IID, &outPtr := 0)) != 0)
        ...
        return this.__IBarcodeScannerStopSoftwareTriggerRequest.ReportFailedAsync()
    }
    ...
    ReportFailedWithFailedReasonAsync(reason) {
        if (!this.HasProp("__IBarcodeScannerStopSoftwareTriggerRequest2")) {
            if ((queryResult := this.QueryInterface(IBarcodeScannerStopSoftwareTriggerRequest2.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IBarcodeScannerStopSoftwareTriggerRequest2 := IBarcodeScannerStopSoftwareTriggerRequest2(outPtr)
        }

        return this.__IBarcodeScannerStopSoftwareTriggerRequest2.ReportFailedWithFailedReasonAsync(reason)
    }
    ...
    ReportFailedWithFailedReasonAndDescriptionAsync(reason, failedReasonDescription) {
        ...
        return this.__IBarcodeScannerStopSoftwareTriggerRequest2.ReportFailedWithFailedReasonAndDescriptionAsync(reason, failedReasonDescription)
    }
