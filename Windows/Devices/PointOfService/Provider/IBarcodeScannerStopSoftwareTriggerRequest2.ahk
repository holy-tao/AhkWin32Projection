 ...
 */
class IBarcodeScannerStopSoftwareTriggerRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerStopSoftwareTriggerRequest2
     * @type {Guid}
     */
    static IID => Guid("{cb57c5dd-fe50-49f8-a0b4-bdc230814da2}")
