 ...
 */
class IBarcodeScannerSetSymbologyAttributesRequest2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBarcodeScannerSetSymbologyAttributesRequest2
     * @type {Guid}
     */
    static IID => Guid("{dffbbfc1-dba8-4b77-be1e-b56cd72f65b3}")
