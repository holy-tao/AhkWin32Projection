 ...
 */
class IMagneticStripeReaderStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMagneticStripeReaderStatics
     * @type {Guid}
     */
    static IID => Guid("{c45fab4a-efd7-4760-a5ce-15b0e47e94eb}")
    ...
    GetDefaultAsync() {
        ...
        return IAsyncOperation(MagneticStripeReader, result_)
    }
