 ...
 */
class IPosPrinterStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPosPrinterStatics
     * @type {Guid}
     */
    static IID => Guid("{8ce0d4ea-132f-4cdf-a64a-2d0d7c96a85b}")
    ...
    GetDefaultAsync() {
        ...
        return IAsyncOperation(PosPrinter, result_)
    }
