 ...
 */
class ICashDrawerStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICashDrawerStatics
     * @type {Guid}
     */
    static IID => Guid("{dfa0955a-d437-4fff-b547-dda969a4f883}")
    ...
    GetDefaultAsync() {
        ...
        return IAsyncOperation(CashDrawer, result_)
    }
