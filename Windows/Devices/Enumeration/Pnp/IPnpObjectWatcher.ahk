 ...
 */
class IPnpObjectWatcher extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPnpObjectWatcher
     * @type {Guid}
     */
    static IID => Guid("{83c95ca8-4772-4a7a-aca8-e48c42a89c44}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Added", "remove_Added", "add_Updated", "remove_Updated", "add_Removed", "remove_Removed", "add_EnumerationCompleted", "remove_EnumerationCompleted", "add_Stopped", "remove_Stopped", "get_Status", "Start", "Stop"]
