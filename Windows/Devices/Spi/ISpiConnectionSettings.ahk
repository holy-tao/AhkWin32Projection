 ...
 */
class ISpiConnectionSettings extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISpiConnectionSettings
     * @type {Guid}
     */
    static IID => Guid("{5283a37f-f935-4b9f-a7a7-3a7890afa5ce}")
