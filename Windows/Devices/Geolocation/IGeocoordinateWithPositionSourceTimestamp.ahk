...
class IGeocoordinateWithPositionSourceTimestamp extends IInspectable{
    ...
    /**
     * The interface identifier for IGeocoordinateWithPositionSourceTimestamp
     * @type {Guid}
     */
    static IID => Guid("{8543fc02-c9f1-4610-afe0-8bc3a6a87036}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_PositionSourceTimestamp"]
