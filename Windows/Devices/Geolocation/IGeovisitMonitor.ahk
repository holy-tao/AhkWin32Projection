 ...
 */
class IGeovisitMonitor extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGeovisitMonitor
     * @type {Guid}
     */
    static IID => Guid("{80118aaf-5944-4591-83c1-396647f54f2c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_MonitoringScope", "Start", "Stop", "add_VisitStateChanged", "remove_VisitStateChanged"]
