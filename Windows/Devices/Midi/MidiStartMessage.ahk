 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.devices.midi.midistartmessage
 * @namespace Windows.Devices.Midi
 * @version WindowsRuntime 1.4
 */
class MidiStartMessage extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.devices.midi.midistartmessage.timestamp
     * @type {TimeSpan} 
     */
    Timestamp {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.devices.midi.midistartmessage.rawdata
     * @type {IBuffer} 
     */
    RawData {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.devices.midi.midistartmessage.type
     * @type {Integer} 
     */
    Type {
        get => this.get_Type()
...
;@region Instance Methods
    ...
    */
    __New(ptr := 0) {
        if(ptr == 0) {
            activatableClassId := HSTRING.Create("Windows.Devices.Midi.MidiStartMessage")
