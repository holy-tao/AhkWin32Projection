 ...
 */
class IMidiInPortStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IMidiInPortStatics
     * @type {Guid}
     */
    static IID => Guid("{44c439dc-67ff-4a6e-8bac-fdb6610cf296}")
    ...
    FromIdAsync(deviceId) {
        ...
        return IAsyncOperation(MidiInPort, value)
    }
