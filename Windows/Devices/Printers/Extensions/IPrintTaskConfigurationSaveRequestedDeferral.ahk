 ...
 */
class IPrintTaskConfigurationSaveRequestedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintTaskConfigurationSaveRequestedDeferral
     * @type {Guid}
     */
    static IID => Guid("{e959d568-f729-44a4-871d-bd0628696a33}")
