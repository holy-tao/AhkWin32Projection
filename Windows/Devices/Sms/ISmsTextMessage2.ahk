 ...
 */
class ISmsTextMessage2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISmsTextMessage2
     * @type {Guid}
     */
    static IID => Guid("{22a0d893-4555-4755-b5a1-e7fd84955f8d}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Timestamp", "get_To", "put_To", "get_From", "get_Body", "put_Body", "get_Encoding", "put_Encoding", "get_CallbackNumber", "put_CallbackNumber", "get_IsDeliveryNotificationEnabled", "put_IsDeliveryNotificationEnabled", "get_RetryAttemptCount", "put_RetryAttemptCount", "get_TeleserviceId", "get_ProtocolId"]
