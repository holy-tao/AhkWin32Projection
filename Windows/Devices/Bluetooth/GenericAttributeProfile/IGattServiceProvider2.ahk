 ...
 */
class IGattServiceProvider2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IGattServiceProvider2
     * @type {Guid}
     */
    static IID => Guid("{9ef531a9-cf12-59a3-a81c-362f4aabaacf}")
