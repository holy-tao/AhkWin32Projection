 ...
 */
class IBluetoothLEAdvertisementWatcher2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IBluetoothLEAdvertisementWatcher2
     * @type {Guid}
     */
    static IID => Guid("{01bf26bc-b164-5805-90a3-e8a7997ff225}")
