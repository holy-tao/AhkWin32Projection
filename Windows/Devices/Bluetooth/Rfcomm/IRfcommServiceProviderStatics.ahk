...
#Include .\RfcommServiceProvider.ahk
 ...
 */
class IRfcommServiceProviderStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IRfcommServiceProviderStatics
     * @type {Guid}
     */
    static IID => Guid("{98888303-69ca-413a-84f7-4344c7292997}")
     ...
     */
    CreateAsync(serviceId) {
        result := ComCall(6, this, "ptr", serviceId, "ptr*", &asyncOp := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }

        return IAsyncOperation(RfcommServiceProvider, asyncOp)
    }
}
