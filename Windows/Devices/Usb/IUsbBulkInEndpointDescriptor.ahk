 ...
 */
class IUsbBulkInEndpointDescriptor extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUsbBulkInEndpointDescriptor
     * @type {Guid}
     */
    static IID => Guid("{3c6e4846-06cf-42a9-9dc2-971c1b14b6e3}")
