 ...
 */
class IUsbConfigurationDescriptorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IUsbConfigurationDescriptorStatics
     * @type {Guid}
     */
    static IID => Guid("{424ced93-e740-40a1-92bd-da120ea04914}")
     ...
     * @param {Pointer<UsbConfigurationDescriptor>} parsed 
     * @returns {Boolean} 
     */
    ...
    Parse(descriptor) {
        ...
        return UsbConfigurationDescriptor(parsed)
    }
}
