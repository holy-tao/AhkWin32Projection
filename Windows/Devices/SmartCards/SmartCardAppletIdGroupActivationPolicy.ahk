 ...
 * @see https://learn.microsoft.com/uwp/api/windows.devices.smartcards.smartcardappletidgroupactivationpolicy
 * @namespace Windows.Devices.SmartCards
 * @version WindowsRuntime 1.4
 */
class SmartCardAppletIdGroupActivationPolicy extends Win32Enum{
