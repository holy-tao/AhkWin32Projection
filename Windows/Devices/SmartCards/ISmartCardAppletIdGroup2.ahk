 ...
 */
class ISmartCardAppletIdGroup2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISmartCardAppletIdGroup2
     * @type {Guid}
     */
    static IID => Guid("{6b0ef9dc-9956-4a62-8d4e-d37a68ebc3a6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Logo", "put_Logo", "get_Description", "put_Description", "get_Properties", "get_SecureUserAuthenticationRequired", "put_SecureUserAuthenticationRequired"]
