 ...
 */
class ISmartCardEmulator2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISmartCardEmulator2
     * @type {Guid}
     */
    static IID => Guid("{fe3fc0b8-8529-411a-807b-48edc2a0ab44}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_ApduReceived", "remove_ApduReceived", "add_ConnectionDeactivated", "remove_ConnectionDeactivated", "Start", "IsHostCardEmulationSupported"]
