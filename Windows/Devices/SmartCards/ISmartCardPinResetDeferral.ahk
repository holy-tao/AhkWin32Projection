 ...
 */
class ISmartCardPinResetDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISmartCardPinResetDeferral
     * @type {Guid}
     */
    static IID => Guid("{18c94aac-7805-4004-85e4-bbefac8f6884}")
