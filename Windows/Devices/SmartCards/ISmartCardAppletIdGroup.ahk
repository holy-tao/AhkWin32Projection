 ...
 */
class ISmartCardAppletIdGroup extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISmartCardAppletIdGroup
     * @type {Guid}
     */
    static IID => Guid("{7db165e6-6264-56f4-5e03-c86385395eb1}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_DisplayName", "put_DisplayName", "get_AppletIds", "get_SmartCardEmulationCategory", "put_SmartCardEmulationCategory", "get_SmartCardEmulationType", "put_SmartCardEmulationType", "get_AutomaticEnablement", "put_AutomaticEnablement"]
