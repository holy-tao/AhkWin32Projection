 ...
 */
class ILamp extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILamp
     * @type {Guid}
     */
    static IID => Guid("{047d5b9a-ea45-4b2b-b1a2-14dff00bde7b}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_DeviceId", "get_IsEnabled", "put_IsEnabled", "get_BrightnessLevel", "put_BrightnessLevel", "get_IsColorSettable", "get_Color", "put_Color", "add_AvailabilityChanged", "remove_AvailabilityChanged"]
    ...
    put_BrightnessLevel(value) {
        result := ComCall(10, this, "float", value, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
