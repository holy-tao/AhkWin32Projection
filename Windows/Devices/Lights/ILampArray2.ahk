 ...
 */
class ILampArray2 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILampArray2
     * @type {Guid}
     */
    static IID => Guid("{050c181f-60a8-4711-a1af-1b1b4c658ea2}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_IsAvailable", "add_AvailabilityChanged", "remove_AvailabilityChanged"]
