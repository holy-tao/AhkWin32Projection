 ...
 */
class ILampArrayBitmapEffectFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILampArrayBitmapEffectFactory
     * @type {Guid}
     */
    static IID => Guid("{13608090-e336-4c8f-9053-a92407ca7b1d}")
    ...
    CreateInstance(lampArray_, lampIndexes_length, lampIndexes) {
        ...
        return LampArrayBitmapEffect(value)
    }
}
