...
#Include ..\..\..\..\Guid.ahk
#Include .\LampArrayBlinkEffect.ahk
 ...
 */
class ILampArrayBlinkEffectFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILampArrayBlinkEffectFactory
     * @type {Guid}
     */
    static IID => Guid("{879f1d97-9f50-49b2-a56f-013aa08d55e0}")
    ...
    CreateInstance(lampArray_, lampIndexes_length, lampIndexes) {
        ...
        return LampArrayBlinkEffect(value)
    }
}
