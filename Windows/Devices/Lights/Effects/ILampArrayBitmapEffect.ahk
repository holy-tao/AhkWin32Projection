 ...
 */
class ILampArrayBitmapEffect extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILampArrayBitmapEffect
     * @type {Guid}
     */
    static IID => Guid("{3238e065-d877-4627-89e5-2a88f7052fa6}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Duration", "put_Duration", "get_StartDelay", "put_StartDelay", "get_UpdateInterval", "put_UpdateInterval", "get_SuggestedBitmapSize", "add_BitmapRequested", "remove_BitmapRequested"]
