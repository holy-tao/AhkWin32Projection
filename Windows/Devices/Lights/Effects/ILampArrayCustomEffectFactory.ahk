 ...
 */
class ILampArrayCustomEffectFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ILampArrayCustomEffectFactory
     * @type {Guid}
     */
    static IID => Guid("{68b4774d-63e5-4af0-a58b-3e535b94e8c9}")
    ...
    CreateInstance(lampArray_, lampIndexes_length, lampIndexes) {
        ...
        return LampArrayCustomEffect(value)
    }
}
