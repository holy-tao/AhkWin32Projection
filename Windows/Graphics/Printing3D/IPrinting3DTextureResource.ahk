 ...
 */
class IPrinting3DTextureResource extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrinting3DTextureResource
     * @type {Guid}
     */
    static IID => Guid("{a70df32d-6ab1-44ae-bc45-a27382c0d38c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_TextureData", "put_TextureData", "get_Name", "put_Name"]
