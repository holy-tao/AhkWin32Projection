 ...
 */
class IPrintTaskSourceRequestedDeferral extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintTaskSourceRequestedDeferral
     * @type {Guid}
     */
    static IID => Guid("{4a1560d1-6992-4d9d-8555-4ca4563fb166}")
