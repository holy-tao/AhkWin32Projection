...
#Include .\PrintWorkflowSourceContent.ahk
 ...
 */
class IPrintWorkflowSubmittedOperation extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowSubmittedOperation
     * @type {Guid}
     */
    static IID => Guid("{2e4e6216-3be1-5f0f-5c81-a5a2bd4eab0e}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["Complete", "get_Configuration", "get_XpsContent"]
    ...
    get_XpsContent() {
        ...
        return PrintWorkflowSourceContent(value)
    }
}
