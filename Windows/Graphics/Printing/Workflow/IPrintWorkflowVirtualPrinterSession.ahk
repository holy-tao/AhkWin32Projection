 ...
 */
class IPrintWorkflowVirtualPrinterSession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowVirtualPrinterSession
     * @type {Guid}
     */
    static IID => Guid("{aa3926f2-8485-5c27-a016-9d39e3ba2614}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Status", "get_Printer", "add_VirtualPrinterDataAvailable", "remove_VirtualPrinterDataAvailable", "Start"]
