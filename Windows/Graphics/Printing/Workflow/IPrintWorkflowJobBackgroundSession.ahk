 ...
 */
class IPrintWorkflowJobBackgroundSession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowJobBackgroundSession
     * @type {Guid}
     */
    static IID => Guid("{c5ec6ad8-20c9-5d51-8507-2734b46f96c5}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Status", "add_JobStarting", "remove_JobStarting", "add_PdlModificationRequested", "remove_PdlModificationRequested", "Start"]
