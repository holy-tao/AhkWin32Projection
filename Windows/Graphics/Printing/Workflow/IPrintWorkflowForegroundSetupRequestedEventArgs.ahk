 ...
 */
class IPrintWorkflowForegroundSetupRequestedEventArgs extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowForegroundSetupRequestedEventArgs
     * @type {Guid}
     */
    static IID => Guid("{bbe38247-9c1b-4dd3-9b2b-c80468d941b3}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["GetUserPrintTicketAsync", "get_Configuration", "GetDeferral"]
