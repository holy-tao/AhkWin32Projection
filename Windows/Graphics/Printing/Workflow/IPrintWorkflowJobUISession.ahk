 ...
 */
class IPrintWorkflowJobUISession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowJobUISession
     * @type {Guid}
     */
    static IID => Guid("{00c8736b-7637-5687-a302-0f664d2aac65}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Status", "add_PdlDataAvailable", "remove_PdlDataAvailable", "add_JobNotification", "remove_JobNotification", "Start"]
