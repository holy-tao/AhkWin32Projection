 ...
 */
class IPrintWorkflowBackgroundSession extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintWorkflowBackgroundSession
     * @type {Guid}
     */
    static IID => Guid("{5b7913ba-0c5e-528a-7458-86a46cbddc45}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_SetupRequested", "remove_SetupRequested", "add_Submitted", "remove_Submitted", "get_Status", "Start"]
    ...
    add_Submitted(submittedEventHandler) {
        token := EventRegistrationToken()
        result := ComCall(8, this, "ptr", submittedEventHandler, "ptr", token, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
