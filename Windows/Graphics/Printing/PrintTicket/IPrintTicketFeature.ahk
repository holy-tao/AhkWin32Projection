 ...
 */
class IPrintTicketFeature extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintTicketFeature
     * @type {Guid}
     */
    static IID => Guid("{e7607d6a-59f5-4103-8858-b97710963d39}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Name", "get_XmlNamespace", "get_XmlNode", "get_DisplayName", "GetOption", "get_Options", "GetSelectedOption", "SetSelectedOption", "get_SelectionType"]
    ...
    GetOption(name, xmlNamespace) {
        ...
        return PrintTicketOption(result_)
    }
    ...
    get_Options() {
        ...
        return IVectorView(PrintTicketOption, result_)
    }
    ...
    GetSelectedOption() {
        ...
        return PrintTicketOption(value)
    }

    /**
     * 
     * @param {PrintTicketOption} value 
     * @returns {HRESULT} 
     */
