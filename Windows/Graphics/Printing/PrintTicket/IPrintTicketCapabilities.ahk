...
#Include .\PrintTicketParameterDefinition.ahk
 ...
 */
class IPrintTicketCapabilities extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPrintTicketCapabilities
     * @type {Guid}
     */
    static IID => Guid("{8c45508b-bbdc-4256-a142-2fd615ecb416}")
    ...
    GetFeature(name, xmlNamespace) {
        ...
        result := ComCall(24, this, "ptr", name, "ptr", xmlNamespace, "ptr*", &result_ := 0, "int")
        if(result != 0) {
            throw OSError(A_LastError || result)
        }
    ...
    GetParameterDefinition(name, xmlNamespace) {
        ...
        return PrintTicketParameterDefinition(result_)
    }
}
