...
#Include .\IPrintMediaSizeOptionDetails.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * ```
 * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails
 * @namespace Windows.Graphics.Printing.OptionDetails
 * @version WindowsRuntime 1.4
 */
class PrintMediaSizeOptionDetails extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.optionid
     * @type {HSTRING} 
     */
    OptionId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.optiontype
     * @type {Integer} 
     */
    OptionType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.errortext
     * @type {HSTRING} 
     */
    ErrorText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.state
     * @type {Integer} 
     */
    State {
        get => this.get_State()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.value
     * @type {IInspectable} 
     */
    Value {
        get => this.get_Value()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.items
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.warningtext
     * @type {HSTRING} 
     */
    WarningText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.description
     * @type {HSTRING} 
     */
    Description {
...
;@region Instance Methods
     ...
     * @param {IInspectable} value Value for the media size option.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printmediasizeoptiondetails.trysetvalue
     */
    TrySetValue(value) {
        if (!this.HasProp("__IPrintOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintOptionDetails.IID, &outPtr := 0)) != 0)
    ...
    put_WarningText(value) {
        if (!this.HasProp("__IPrintMediaSizeOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintMediaSizeOptionDetails.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPrintMediaSizeOptionDetails := IPrintMediaSizeOptionDetails(outPtr)
        }

        return this.__IPrintMediaSizeOptionDetails.put_WarningText(value)
    }
    ...
    get_WarningText() {
        ...
        return this.__IPrintMediaSizeOptionDetails.get_WarningText()
    }
    ...
    put_Description(value) {
        ...
        return this.__IPrintMediaSizeOptionDetails.put_Description(value)
    }
    ...
    get_Description() {
        ...
        return this.__IPrintMediaSizeOptionDetails.get_Description()
    }
