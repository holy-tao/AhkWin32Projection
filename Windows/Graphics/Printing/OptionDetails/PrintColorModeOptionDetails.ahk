...
#Include .\IPrintColorModeOptionDetails.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * ```
 * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails
 * @namespace Windows.Graphics.Printing.OptionDetails
 * @version WindowsRuntime 1.4
 */
class PrintColorModeOptionDetails extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.optionid
     * @type {HSTRING} 
     */
    OptionId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.optiontype
     * @type {Integer} 
     */
    OptionType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.errortext
     * @type {HSTRING} 
     */
    ErrorText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.state
     * @type {Integer} 
     */
    State {
        get => this.get_State()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.value
     * @type {IInspectable} 
     */
    Value {
        get => this.get_Value()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.items
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.warningtext
     * @type {HSTRING} 
     */
    WarningText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.description
     * @type {HSTRING} 
     */
    Description {
...
;@region Instance Methods
     ...
     * @param {IInspectable} value Value for the print color mode option.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printcolormodeoptiondetails.trysetvalue
     */
    TrySetValue(value) {
        if (!this.HasProp("__IPrintOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintOptionDetails.IID, &outPtr := 0)) != 0)
    ...
    put_WarningText(value) {
        if (!this.HasProp("__IPrintColorModeOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintColorModeOptionDetails.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPrintColorModeOptionDetails := IPrintColorModeOptionDetails(outPtr)
        }

        return this.__IPrintColorModeOptionDetails.put_WarningText(value)
    }
    ...
    get_WarningText() {
        ...
        return this.__IPrintColorModeOptionDetails.get_WarningText()
    }
    ...
    put_Description(value) {
        ...
        return this.__IPrintColorModeOptionDetails.put_Description(value)
    }
    ...
    get_Description() {
        ...
        return this.__IPrintColorModeOptionDetails.get_Description()
    }
