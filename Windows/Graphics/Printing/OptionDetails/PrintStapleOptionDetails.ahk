...
#Include .\IPrintStapleOptionDetails.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * ```
 * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails
 * @namespace Windows.Graphics.Printing.OptionDetails
 * @version WindowsRuntime 1.4
 */
class PrintStapleOptionDetails extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.optionid
     * @type {HSTRING} 
     */
    OptionId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.optiontype
     * @type {Integer} 
     */
    OptionType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.errortext
     * @type {HSTRING} 
     */
    ErrorText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.state
     * @type {Integer} 
     */
    State {
        get => this.get_State()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.value
     * @type {IInspectable} 
     */
    Value {
        get => this.get_Value()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.items
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.warningtext
     * @type {HSTRING} 
     */
    WarningText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.description
     * @type {HSTRING} 
     */
    Description {
...
;@region Instance Methods
     ...
     * @param {IInspectable} value Value for the staple opiton.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printstapleoptiondetails.trysetvalue
     */
    TrySetValue(value) {
        if (!this.HasProp("__IPrintOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintOptionDetails.IID, &outPtr := 0)) != 0)
    ...
    put_WarningText(value) {
        if (!this.HasProp("__IPrintStapleOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintStapleOptionDetails.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPrintStapleOptionDetails := IPrintStapleOptionDetails(outPtr)
        }

        return this.__IPrintStapleOptionDetails.put_WarningText(value)
    }
    ...
    get_WarningText() {
        ...
        return this.__IPrintStapleOptionDetails.get_WarningText()
    }
    ...
    put_Description(value) {
        ...
        return this.__IPrintStapleOptionDetails.put_Description(value)
    }
    ...
    get_Description() {
        ...
        return this.__IPrintStapleOptionDetails.get_Description()
    }
