...
#Include .\IPrintHolePunchOptionDetails.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * ```
 * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails
 * @namespace Windows.Graphics.Printing.OptionDetails
 * @version WindowsRuntime 1.4
 */
class PrintHolePunchOptionDetails extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.optionid
     * @type {HSTRING} 
     */
    OptionId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.optiontype
     * @type {Integer} 
     */
    OptionType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.errortext
     * @type {HSTRING} 
     */
    ErrorText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.state
     * @type {Integer} 
     */
    State {
        get => this.get_State()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.value
     * @type {IInspectable} 
     */
    Value {
        get => this.get_Value()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.items
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.warningtext
     * @type {HSTRING} 
     */
    WarningText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.description
     * @type {HSTRING} 
     */
    Description {
...
;@region Instance Methods
     ...
     * @param {IInspectable} value Value for the hole punch option.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printholepunchoptiondetails.trysetvalue
     */
    TrySetValue(value) {
        if (!this.HasProp("__IPrintOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintOptionDetails.IID, &outPtr := 0)) != 0)
    ...
    put_WarningText(value) {
        if (!this.HasProp("__IPrintHolePunchOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintHolePunchOptionDetails.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPrintHolePunchOptionDetails := IPrintHolePunchOptionDetails(outPtr)
        }

        return this.__IPrintHolePunchOptionDetails.put_WarningText(value)
    }
    ...
    get_WarningText() {
        ...
        return this.__IPrintHolePunchOptionDetails.get_WarningText()
    }
    ...
    put_Description(value) {
        ...
        return this.__IPrintHolePunchOptionDetails.put_Description(value)
    }
    ...
    get_Description() {
        ...
        return this.__IPrintHolePunchOptionDetails.get_Description()
    }
