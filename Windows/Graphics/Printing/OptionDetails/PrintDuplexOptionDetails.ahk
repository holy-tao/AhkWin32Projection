...
#Include .\IPrintDuplexOptionDetails.ahk
#Include ..\..\..\..\Guid.ahk
 ...
 * ```
 * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails
 * @namespace Windows.Graphics.Printing.OptionDetails
 * @version WindowsRuntime 1.4
 */
class PrintDuplexOptionDetails extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.optionid
     * @type {HSTRING} 
     */
    OptionId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.optiontype
     * @type {Integer} 
     */
    OptionType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.errortext
     * @type {HSTRING} 
     */
    ErrorText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.state
     * @type {Integer} 
     */
    State {
        get => this.get_State()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.value
     * @type {IInspectable} 
     */
    Value {
        get => this.get_Value()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.items
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.warningtext
     * @type {HSTRING} 
     */
    WarningText {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.description
     * @type {HSTRING} 
     */
    Description {
...
;@region Instance Methods
     ...
     * @param {IInspectable} value Value for the duplex option.
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.graphics.printing.optiondetails.printduplexoptiondetails.trysetvalue
     */
    TrySetValue(value) {
        if (!this.HasProp("__IPrintOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintOptionDetails.IID, &outPtr := 0)) != 0)
    ...
    put_WarningText(value) {
        if (!this.HasProp("__IPrintDuplexOptionDetails")) {
            if ((queryResult := this.QueryInterface(IPrintDuplexOptionDetails.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IPrintDuplexOptionDetails := IPrintDuplexOptionDetails(outPtr)
        }

        return this.__IPrintDuplexOptionDetails.put_WarningText(value)
    }
    ...
    get_WarningText() {
        ...
        return this.__IPrintDuplexOptionDetails.get_WarningText()
    }
    ...
    put_Description(value) {
        ...
        return this.__IPrintDuplexOptionDetails.put_Description(value)
    }
    ...
    get_Description() {
        ...
        return this.__IPrintDuplexOptionDetails.get_Description()
    }
