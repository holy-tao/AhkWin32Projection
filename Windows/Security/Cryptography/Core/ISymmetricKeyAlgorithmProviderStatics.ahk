...
#Include .\SymmetricKeyAlgorithmProvider.ahk
 ...
 */
class ISymmetricKeyAlgorithmProviderStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ISymmetricKeyAlgorithmProviderStatics
     * @type {Guid}
     */
    static IID => Guid("{8d3b2326-1f37-491f-b60e-f5431b26b483}")
    ...
    OpenAlgorithm(algorithm) {
        ...
        return SymmetricKeyAlgorithmProvider(provider)
    }
}
