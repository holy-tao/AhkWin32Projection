...
#Include .\AsymmetricKeyAlgorithmProvider.ahk
 ...
 */
class IAsymmetricKeyAlgorithmProviderStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IAsymmetricKeyAlgorithmProviderStatics
     * @type {Guid}
     */
    static IID => Guid("{425bde18-a7f3-47a6-a8d2-c48d6033a65c}")
    ...
    OpenAlgorithm(algorithm) {
        ...
        return AsymmetricKeyAlgorithmProvider(provider)
    }
}
