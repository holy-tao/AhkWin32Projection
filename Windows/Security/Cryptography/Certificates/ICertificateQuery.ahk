 ...
 */
class ICertificateQuery extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICertificateQuery
     * @type {Guid}
     */
    static IID => Guid("{5b082a31-a728-4916-b5ee-ffcb8acf2417}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_EnhancedKeyUsages", "get_IssuerName", "put_IssuerName", "get_FriendlyName", "put_FriendlyName", "get_Thumbprint", "put_Thumbprint", "get_HardwareOnly", "put_HardwareOnly"]
