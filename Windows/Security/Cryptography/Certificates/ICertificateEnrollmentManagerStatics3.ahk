 ...
 */
class ICertificateEnrollmentManagerStatics3 extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ICertificateEnrollmentManagerStatics3
     * @type {Guid}
     */
    static IID => Guid("{fdec82be-617c-425a-b72d-398b26ac7264}")
