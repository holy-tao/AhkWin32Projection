 ...
 */
class IPfxImportParameters extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IPfxImportParameters
     * @type {Guid}
     */
    static IID => Guid("{680d3511-9a08-47c8-864a-2edd4d8eb46c}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Exportable", "put_Exportable", "get_KeyProtectionLevel", "put_KeyProtectionLevel", "get_InstallOptions", "put_InstallOptions", "get_FriendlyName", "put_FriendlyName", "get_KeyStorageProviderName", "put_KeyStorageProviderName", "get_ContainerNamePrefix", "put_ContainerNamePrefix", "get_ReaderName", "put_ReaderName"]
