...
#Include ..\..\..\..\Guid.ahk
#Include .\OnlineIdSystemAuthenticatorForUser.ahk
 ...
 */
class IOnlineIdSystemAuthenticatorStatics extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IOnlineIdSystemAuthenticatorStatics
     * @type {Guid}
     */
    static IID => Guid("{85047792-f634-41e3-96a4-5164e902c740}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_Default", "GetForUser"]
    ...
    get_Default() {
        ...
        return OnlineIdSystemAuthenticatorForUser(value)
    }
