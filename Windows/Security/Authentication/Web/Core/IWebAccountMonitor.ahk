...
class IWebAccountMonitor extends IInspectable{
    ...
    /**
     * The interface identifier for IWebAccountMonitor
     * @type {Guid}
     */
    static IID => Guid("{7445f5fd-aa9d-4619-8d5d-c138a4ede3e5}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_Updated", "remove_Updated", "add_Removed", "remove_Removed", "add_DefaultSignInAccountChanged", "remove_DefaultSignInAccountChanged"]
