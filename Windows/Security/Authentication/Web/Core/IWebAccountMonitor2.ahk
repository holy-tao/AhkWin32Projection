...
class IWebAccountMonitor2 extends IInspectable{
    ...
    /**
     * The interface identifier for IWebAccountMonitor2
     * @type {Guid}
     */
    static IID => Guid("{a7adc1f8-24b8-4f01-9ae5-24545e71233a}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["add_AccountPictureUpdated", "remove_AccountPictureUpdated"]
