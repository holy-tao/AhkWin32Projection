...
#Include .\IWebAccountProviderUIReportOperation.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation
 * @namespace Windows.Security.Authentication.Web.Provider
 * @version WindowsRuntime 1.4
 */
class WebAccountProviderRequestTokenOperation extends IInspectable {
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.providerrequest
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.providerresponses
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.cacheexpirationtime
     * @type {DateTime} 
     */
    CacheExpirationTime {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.kind
     * @type {Integer} 
     */
    Kind {
        get => this.get_Kind()
...
;@region Instance Methods
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.reportusercanceled
     */
    ReportUserCanceled() {
        if (!this.HasProp("__IWebAccountProviderUIReportOperation")) {
            if ((queryResult := this.QueryInterface(IWebAccountProviderUIReportOperation.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IWebAccountProviderUIReportOperation := IWebAccountProviderUIReportOperation(outPtr)
        }

        return this.__IWebAccountProviderUIReportOperation.ReportUserCanceled()
    }

    /**
     * Informs the activating app that the operation completed successfully.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.reportcompleted
     */
    ReportCompleted() {
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.security.authentication.web.provider.webaccountproviderrequesttokenoperation.reporterror
     */
    ReportError(value) {
        if (!this.HasProp("__IWebAccountProviderBaseReportOperation")) {
            if ((queryResult := this.QueryInterface(IWebAccountProviderBaseReportOperation.IID, &outPtr := 0)) != 0)
