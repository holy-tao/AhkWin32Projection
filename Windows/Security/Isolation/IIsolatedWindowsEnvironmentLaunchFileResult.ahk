 ...
 */
class IIsolatedWindowsEnvironmentLaunchFileResult extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IIsolatedWindowsEnvironmentLaunchFileResult
     * @type {Guid}
     */
    static IID => Guid("{685d4176-f6e0-4569-b1aa-215c0ff5b257}")
