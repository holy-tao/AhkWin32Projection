 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.security.enterprisedata.protectionpolicyrequestaccessbehavior
 * @namespace Windows.Security.EnterpriseData
 * @version WindowsRuntime 1.4
 */
class ProtectionPolicyRequestAccessBehavior extends Win32Enum{
     ...
     * @type {Integer (Int32)}
     */
    static TreatOverridePolicyAsBlock => 1
}
