 ...
 */
class IProtectionPolicyAuditInfo extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IProtectionPolicyAuditInfo
     * @type {Guid}
     */
    static IID => Guid("{425ab7e4-feb7-44fc-b3bb-c3c4d7ecbebb}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["put_Action", "get_Action", "put_DataDescription", "get_DataDescription", "put_SourceDescription", "get_SourceDescription", "put_TargetDescription", "get_TargetDescription"]
