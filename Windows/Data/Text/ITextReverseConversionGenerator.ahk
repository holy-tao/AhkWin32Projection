 ...
 */
class ITextReverseConversionGenerator extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextReverseConversionGenerator
     * @type {Guid}
     */
    static IID => Guid("{51e7f514-9c51-4d86-ae1b-b498fbad8313}")
     ...
     * @type {Array<String>}
     */
    static VTableNames => ["get_ResolvedLanguage", "get_LanguageAvailableButNotInstalled", "ConvertBackAsync"]
