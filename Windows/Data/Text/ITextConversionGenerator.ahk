 ...
 */
class ITextConversionGenerator extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextConversionGenerator
     * @type {Guid}
     */
    static IID => Guid("{03606a5e-2aa9-4ab6-af8b-a562b63a8992}")
