 ...
 */
class IWordsSegmenter extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for IWordsSegmenter
     * @type {Guid}
     */
    static IID => Guid("{86b4d4d1-b2fe-4e34-a81d-66640300454f}")
    ...
    GetTokens(text) {
        ...
        return IVectorView(WordSegment, result_)
    }
     ...
     * @param {HSTRING} text 
     * @param {Integer} startIndex 
     * @param {WordSegmentsTokenizingHandler} handler 
     * @returns {HRESULT} 
     */
