...
#Include .\TextPredictionGenerator.ahk
 ...
 */
class ITextPredictionGeneratorFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextPredictionGeneratorFactory
     * @type {Guid}
     */
    static IID => Guid("{7257b416-8ba2-4751-9d30-9d85435653a2}")
    ...
    Create(languageTag) {
        ...
        return TextPredictionGenerator(result_)
    }
}
