...
#Include .\TextConversionGenerator.ahk
 ...
 */
class ITextConversionGeneratorFactory extends IInspectable{

    static sizeof => A_PtrSize
    /**
     * The interface identifier for ITextConversionGeneratorFactory
     * @type {Guid}
     */
    static IID => Guid("{fcaa3781-3083-49ab-be15-56dfbbb74d6f}")
    ...
    Create(languageTag) {
        ...
        return TextConversionGenerator(result_)
    }
}
