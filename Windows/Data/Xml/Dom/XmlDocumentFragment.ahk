...
#Include .\IXmlDocumentFragment.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IXmlDocumentFragment
     ...
     * @type {Guid}
     */
    static IID => IXmlDocumentFragment.IID
...
;@region Instance Properties
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.nodevalue
     * @type {IInspectable} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.nodetype
     * @type {Integer} 
     */
    NodeType {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.parentnode
     * @type {IXmlNode} 
     */
    ParentNode {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.childnodes
     * @type {XmlNodeList} 
     */
    ChildNodes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.firstchild
     * @type {IXmlNode} 
     */
    FirstChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.lastchild
     * @type {IXmlNode} 
     */
    LastChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.previoussibling
     * @type {IXmlNode} 
     */
    PreviousSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.nextsibling
     * @type {IXmlNode} 
     */
    NextSibling {
     ...
     *    <tr><td>Notation</td><td>NULL</td></tr>
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.attributes
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.ownerdocument
     * @type {XmlDocument} 
     */
    OwnerDocument {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.namespaceuri
     * @type {IInspectable} 
     */
    NamespaceUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.localname
     * @type {IInspectable} 
     */
    LocalName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.prefix
     * @type {IInspectable} 
     */
    Prefix {
        get => this.get_Prefix()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.innertext
     * @type {HSTRING} 
     */
    InnerText {
...
;@region Instance Methods
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.haschildnodes
     */
    HasChildNodes() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.insertbefore
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.replacechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.removechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.appendchild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.clonenode
     */
    CloneNode(deep) {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.normalize
     */
    Normalize() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.getxml
     */
    GetXml() {
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.selectsinglenode
     */
     ...
     * @param {HSTRING} xpath Specifies an XPath expression.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.selectnodes
     */
    SelectNodes(xpath) {
        if (!this.HasProp("__IXmlNodeSelector")) {
            if ((queryResult := this.QueryInterface(IXmlNodeSelector.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.selectsinglenodens
     */
     ...
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumentfragment.selectnodesns
     */
