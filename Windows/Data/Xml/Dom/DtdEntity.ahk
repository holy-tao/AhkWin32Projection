 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity
 * @namespace Windows.Data.Xml.Dom
 * @version WindowsRuntime 1.4
 */
class DtdEntity extends IInspectable {
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IDtdEntity
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.publicid
     * @type {IInspectable} 
     */
    PublicId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.systemid
     * @type {IInspectable} 
     */
    SystemId {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.notationname
     * @type {IInspectable} 
     */
    NotationName {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.nodevalue
     * @type {IInspectable} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.nodetype
     * @type {Integer} 
     */
    NodeType {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.parentnode
     * @type {IXmlNode} 
     */
    ParentNode {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.childnodes
     * @type {XmlNodeList} 
     */
    ChildNodes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.firstchild
     * @type {IXmlNode} 
     */
    FirstChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.lastchild
     * @type {IXmlNode} 
     */
    LastChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.previoussibling
     * @type {IXmlNode} 
     */
    PreviousSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.nextsibling
     * @type {IXmlNode} 
     */
    NextSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.attributes
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.ownerdocument
     * @type {XmlDocument} 
     */
    OwnerDocument {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.namespaceuri
     * @type {IInspectable} 
     */
    NamespaceUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.localname
     * @type {IInspectable} 
     */
    LocalName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.prefix
     * @type {IInspectable} 
     */
    Prefix {
        get => this.get_Prefix()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.innertext
     * @type {HSTRING} 
     */
    InnerText {
...
;@region Instance Methods
     ...
     */
    get_PublicId() {
        if (!this.HasProp("__IDtdEntity")) {
            if ((queryResult := this.QueryInterface(IDtdEntity.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IDtdEntity := IDtdEntity(outPtr)
        }

        return this.__IDtdEntity.get_PublicId()
    }
    ...
    get_SystemId() {
        ...
        return this.__IDtdEntity.get_SystemId()
    }
    ...
    get_NotationName() {
        ...
        return this.__IDtdEntity.get_NotationName()
    }
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.haschildnodes
     */
    HasChildNodes() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.insertbefore
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.replacechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.removechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.appendchild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.clonenode
     */
    CloneNode(deep) {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.normalize
     */
    Normalize() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.getxml
     */
    GetXml() {
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.selectsinglenode
     */
     ...
     * @param {HSTRING} xpath Specifies an XPath expression.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.selectnodes
     */
    SelectNodes(xpath) {
        if (!this.HasProp("__IXmlNodeSelector")) {
            if ((queryResult := this.QueryInterface(IXmlNodeSelector.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.selectsinglenodens
     */
     ...
     * @param {IInspectable} namespaces Contains a string that specifies the namespaces to use in XPath expressions when it is necessary to define new namespaces externally. Namespaces are defined in the XML style, as a space-separated list of namespace declaration attributes. You can use this property to set the default namespace as well.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.dtdentity.selectnodesns
     */
