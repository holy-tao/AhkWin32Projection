 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IXmlDocumentType
     ...
     * @type {Guid}
     */
    static IID => IXmlDocumentType.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.name
     * @type {HSTRING} 
     */
    Name {
        get => this.get_Name()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.entities
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.notations
     * @type {XmlNamedNodeMap} 
     */
    Notations {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.nodevalue
     * @type {IInspectable} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.nodetype
     * @type {Integer} 
     */
    NodeType {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.parentnode
     * @type {IXmlNode} 
     */
    ParentNode {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.childnodes
     * @type {XmlNodeList} 
     */
    ChildNodes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.firstchild
     * @type {IXmlNode} 
     */
    FirstChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.lastchild
     * @type {IXmlNode} 
     */
    LastChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.previoussibling
     * @type {IXmlNode} 
     */
    PreviousSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.nextsibling
     * @type {IXmlNode} 
     */
    NextSibling {
     ...
     *    <tr><td>Notation</td><td>NULL</td></tr>
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.attributes
     * @type {XmlNamedNodeMap} 
     */
    Attributes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.ownerdocument
     * @type {XmlDocument} 
     */
    OwnerDocument {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.namespaceuri
     * @type {IInspectable} 
     */
    NamespaceUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.localname
     * @type {IInspectable} 
     */
    LocalName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.prefix
     * @type {IInspectable} 
     */
    Prefix {
        get => this.get_Prefix()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.innertext
     * @type {HSTRING} 
     */
    InnerText {
...
;@region Instance Methods
     ...
     */
    get_Name() {
        if (!this.HasProp("__IXmlDocumentType")) {
            if ((queryResult := this.QueryInterface(IXmlDocumentType.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IXmlDocumentType := IXmlDocumentType(outPtr)
        }

        return this.__IXmlDocumentType.get_Name()
    }
    ...
    get_Entities() {
        ...
        return this.__IXmlDocumentType.get_Entities()
    }
    ...
    get_Notations() {
        ...
        return this.__IXmlDocumentType.get_Notations()
    }
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.haschildnodes
     */
    HasChildNodes() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.insertbefore
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.replacechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.removechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.appendchild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.clonenode
     */
    CloneNode(deep) {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.normalize
     */
    Normalize() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.getxml
     */
    GetXml() {
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.selectsinglenode
     */
     ...
     * @param {HSTRING} xpath Specifies an XPath expression.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.selectnodes
     */
    SelectNodes(xpath) {
        if (!this.HasProp("__IXmlNodeSelector")) {
            if ((queryResult := this.QueryInterface(IXmlNodeSelector.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.selectsinglenodens
     */
     ...
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmldocumenttype.selectnodesns
     */
