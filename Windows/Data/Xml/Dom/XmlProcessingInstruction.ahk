...
#Include .\IXmlProcessingInstruction.ahk
 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IXmlProcessingInstruction
     ...
     * @type {Guid}
     */
    static IID => IXmlProcessingInstruction.IID
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.target
     * @type {HSTRING} 
     */
    Target {
        get => this.get_Target()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.data
     * @type {HSTRING} 
     */
    Data {
        get => this.get_Data()
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.nodevalue
     * @type {IInspectable} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.nodetype
     * @type {Integer} 
     */
    NodeType {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.parentnode
     * @type {IXmlNode} 
     */
    ParentNode {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.childnodes
     * @type {XmlNodeList} 
     */
    ChildNodes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.firstchild
     * @type {IXmlNode} 
     */
    FirstChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.lastchild
     * @type {IXmlNode} 
     */
    LastChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.previoussibling
     * @type {IXmlNode} 
     */
    PreviousSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.nextsibling
     * @type {IXmlNode} 
     */
    NextSibling {
     ...
     *    <tr><td>Notation</td><td>NULL</td></tr>
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.attributes
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.ownerdocument
     * @type {XmlDocument} 
     */
    OwnerDocument {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.namespaceuri
     * @type {IInspectable} 
     */
    NamespaceUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.localname
     * @type {IInspectable} 
     */
    LocalName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.prefix
     * @type {IInspectable} 
     */
    Prefix {
        get => this.get_Prefix()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.innertext
     * @type {HSTRING} 
     */
    InnerText {
...
;@region Instance Methods
     ...
     */
    get_Target() {
        if (!this.HasProp("__IXmlProcessingInstruction")) {
            if ((queryResult := this.QueryInterface(IXmlProcessingInstruction.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IXmlProcessingInstruction := IXmlProcessingInstruction(outPtr)
        }

        return this.__IXmlProcessingInstruction.get_Target()
    }
    ...
    get_Data() {
        ...
        return this.__IXmlProcessingInstruction.get_Data()
    }
    ...
    put_Data(value) {
        ...
        return this.__IXmlProcessingInstruction.put_Data(value)
    }
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.haschildnodes
     */
    HasChildNodes() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.insertbefore
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.replacechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.removechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.appendchild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.clonenode
     */
    CloneNode(deep) {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.normalize
     */
    Normalize() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.getxml
     */
    GetXml() {
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.selectsinglenode
     */
     ...
     * @param {HSTRING} xpath Specifies an XPath expression.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.selectnodes
     */
    SelectNodes(xpath) {
        if (!this.HasProp("__IXmlNodeSelector")) {
            if ((queryResult := this.QueryInterface(IXmlNodeSelector.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.selectsinglenodens
     */
     ...
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlprocessinginstruction.selectnodesns
     */
