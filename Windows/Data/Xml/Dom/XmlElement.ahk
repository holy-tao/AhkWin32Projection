 ...
 * @remarks
 * 
 * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement
...
;@region Static Properties
     ...
     * @type {Class}
     */
    static WinRTDefaultInterface => IXmlElement
...
;@region Instance Properties
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.tagname
     * @type {HSTRING} 
     */
    TagName {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.nodevalue
     * @type {IInspectable} 
     */
    NodeValue {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.nodetype
     * @type {Integer} 
     */
    NodeType {
     ...
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.nodename
     * @type {HSTRING} 
     */
    NodeName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.parentnode
     * @type {IXmlNode} 
     */
    ParentNode {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.childnodes
     * @type {XmlNodeList} 
     */
    ChildNodes {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.firstchild
     * @type {IXmlNode} 
     */
    FirstChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.lastchild
     * @type {IXmlNode} 
     */
    LastChild {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.previoussibling
     * @type {IXmlNode} 
     */
    PreviousSibling {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.nextsibling
     * @type {IXmlNode} 
     */
    NextSibling {
     ...
     *    <tr><td>Notation</td><td>NULL</td></tr>
     * </table>
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.attributes
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.ownerdocument
     * @type {XmlDocument} 
     */
    OwnerDocument {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.namespaceuri
     * @type {IInspectable} 
     */
    NamespaceUri {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.localname
     * @type {IInspectable} 
     */
    LocalName {
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.prefix
     * @type {IInspectable} 
     */
    Prefix {
        get => this.get_Prefix()
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.innertext
     * @type {HSTRING} 
     */
    InnerText {
...
;@region Instance Methods
     ...
     */
    get_TagName() {
        if (!this.HasProp("__IXmlElement")) {
            if ((queryResult := this.QueryInterface(IXmlElement.IID, &outPtr := 0)) != 0)
                throw OSError(queryResult)
            this.__IXmlElement := IXmlElement(outPtr)
        }

        return this.__IXmlElement.get_TagName()
    }

    /**
     * Returns the value of the attribute.
     * @param {HSTRING} attributeName The name of the required attribute.
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getattribute
     */
    GetAttribute(attributeName) {
        ...
        return this.__IXmlElement.GetAttribute(attributeName)
    }

    /**
     * Sets the value of the named attribute.
     * @param {HSTRING} attributeName The name of the required attribute.
     * @param {HSTRING} attributeValue The new value for the attribute.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.setattribute
     */
    SetAttribute(attributeName, attributeValue) {
        ...
        return this.__IXmlElement.SetAttribute(attributeName, attributeValue)
    }

    /**
     * Removes or replaces the named attribute.
     * @param {HSTRING} attributeName The name of the attribute to be removed.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.removeattribute
     */
    RemoveAttribute(attributeName) {
        ...
        return this.__IXmlElement.RemoveAttribute(attributeName)
    }
     ...
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getattributenode
     */
    GetAttributeNode(attributeName) {
        ...
        return this.__IXmlElement.GetAttributeNode(attributeName)
    }

    /**
     * Sets or updates the supplied attribute node on this element.
     * @param {XmlAttribute} newAttribute A pointer to the new attribute.
     * @returns {XmlAttribute} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.setattributenode
     */
    SetAttributeNode(newAttribute) {
        ...
        return this.__IXmlElement.SetAttributeNode(newAttribute)
    }

    /**
     * Removes the specified attribute from this element.
     * @param {XmlAttribute} attributeNode The attribute to be removed.
     * @returns {XmlAttribute} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.removeattributenode
     */
    RemoveAttributeNode(attributeNode) {
        ...
        return this.__IXmlElement.RemoveAttributeNode(attributeNode)
    }

    /**
     * Returns a list of all descendant elements that match the supplied name.
     * @param {HSTRING} tagName The tag of the required elements.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getelementsbytagname
     */
    GetElementsByTagName(tagName) {
        ...
        return this.__IXmlElement.GetElementsByTagName(tagName)
    }

    /**
     * Sets the value of the named attribute in the given namespace.
     * @param {IInspectable} namespaceUri The namespace of the attribute being set.
     * @param {HSTRING} qualifiedName The name of the attribute being set.
     * @param {HSTRING} value The new value for the attribute.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.setattributens
     */
    SetAttributeNS(namespaceUri, qualifiedName, value) {
        ...
        return this.__IXmlElement.SetAttributeNS(namespaceUri, qualifiedName, value)
    }

    /**
     * Returns the value of the attribute.
     * @param {IInspectable} namespaceUri The namespace of the attribute to get.
     * @param {HSTRING} localName The name of the attribute without the namespace prefix.
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getattributens
     */
    GetAttributeNS(namespaceUri, localName) {
        ...
        return this.__IXmlElement.GetAttributeNS(namespaceUri, localName)
    }

    /**
     * Removes the specified attribute from this element in the specified namespace.
     * @param {IInspectable} namespaceUri The namespace of attribute to be removed.
     * @param {HSTRING} localName The name of the attribute without the namespace prefix.
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.removeattributens
     */
    RemoveAttributeNS(namespaceUri, localName) {
        ...
        return this.__IXmlElement.RemoveAttributeNS(namespaceUri, localName)
    }
     ...
     * @param {XmlAttribute} newAttribute The node to add to the collection.
     * 
     * > [!NOTE]
     ...
     * @returns {XmlAttribute} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.setattributenodens
     */
    SetAttributeNodeNS(newAttribute) {
        ...
        return this.__IXmlElement.SetAttributeNodeNS(newAttribute)
    }
     ...
     * @param {HSTRING} localName The name of the attribute without the namespace prefix.
     * @returns {XmlAttribute} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getattributenodens
     */
    GetAttributeNodeNS(namespaceUri, localName) {
        ...
        return this.__IXmlElement.GetAttributeNodeNS(namespaceUri, localName)
    }
     ...
     * @returns {Boolean} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.haschildnodes
     */
    HasChildNodes() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.insertbefore
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.replacechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.removechild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.appendchild
     */
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.clonenode
     */
    CloneNode(deep) {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HRESULT} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.normalize
     */
    Normalize() {
        if (!this.HasProp("__IXmlNode")) {
            if ((queryResult := this.QueryInterface(IXmlNode.IID, &outPtr := 0)) != 0)
     ...
     * @returns {HSTRING} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.getxml
     */
    GetXml() {
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.selectsinglenode
     */
     ...
     * @param {HSTRING} xpath Specifies an XPath expression.
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.selectnodes
     */
    SelectNodes(xpath) {
        if (!this.HasProp("__IXmlNodeSelector")) {
            if ((queryResult := this.QueryInterface(IXmlNodeSelector.IID, &outPtr := 0)) != 0)
     ...
     * @returns {IXmlNode} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.selectsinglenodens
     */
     ...
     * @returns {XmlNodeList} 
     * @see https://learn.microsoft.com/uwp/api/windows.data.xml.dom.xmlelement.selectnodesns
     */
